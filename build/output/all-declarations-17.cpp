...
void extensionMethod_displayRuleVertically (const GALGAS_productionRuleListForGrammarAnalysis_2D_element inObject,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_currentNode_6924 = GALGAS_string ("P0start") ;
  GALGAS_rowList var_rowArray_6956 = GALGAS_rowList::constructor_emptyList (SOURCE_FILE ("production-rules-in-tex.galgas", 165)) ;
  const GALGAS_productionRuleListForGrammarAnalysis_2D_element temp_0 = inObject ;
  cEnumerator_range enumerator_7009 (GALGAS_range (GALGAS_uint ((uint32_t) 1U), temp_0.getter_mInstructionList (HERE).getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 166)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 166))), kENUMERATION_UP) ;
  while (enumerator_7009.hasCurrentObject ()) {
    ...
    var_rowArray_6956.addAssign_operation (temp_1  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 167)) ;
  ...
  temp_2.addAssign_operation (var_currentNode_6924, GALGAS_string ("[firstPoint] {}")  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 169)) ;
  var_rowArray_6956.addAssign_operation (temp_2  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 169)) ;
  GALGAS_string var_arrows_7111 = GALGAS_string::makeEmptyString () ;
  GALGAS_string var_arrowStyle_7137 = GALGAS_string ("--") ;
  GALGAS_uint var_unusedMaxUsedRowIndex_7172 = GALGAS_uint ((uint32_t) 0U) ;
  const GALGAS_productionRuleListForGrammarAnalysis_2D_element temp_3 = inObject ;
  GALGAS_uint var_row_7195 = temp_3.getter_mInstructionList (HERE).getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 173)) ;
  const GALGAS_productionRuleListForGrammarAnalysis_2D_element temp_4 = inObject ;
  cEnumerator_syntaxInstructionListForGrammarAnalysis enumerator_7273 (temp_4.getter_mInstructionList (HERE), kENUMERATION_UP) ;
  while (enumerator_7273.hasCurrentObject ()) {
    var_row_7195.decrement_operation (inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 175)) ;
    GALGAS_uint var_column_7302 = GALGAS_uint ((uint32_t) 1U) ;
    callExtensionMethod_tikzNodeForSyntaxInstruction ((const cPtr_abstractSyntaxInstructionForGrammarAnalysis *) enumerator_7273.current_mInstruction (HERE).ptr (), var_rowArray_6956, var_row_7195, var_column_7302, var_currentNode_6924, var_arrowStyle_7137, var_arrows_7111, var_unusedMaxUsedRowIndex_7172, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 177)) ;
    enumerator_7273.gotoNextObject () ;
  }
  GALGAS_string var_lastNodeName_7674 ;
  {
  extensionSetter_appendRow (var_rowArray_6956, GALGAS_string ("[lastPoint] {}"), var_row_7195, GALGAS_uint ((uint32_t) 2U), var_lastNodeName_7674, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 189)) ;
  }
  var_arrows_7111.plusAssign_operation(GALGAS_string ("  \\draw[->] (").add_operation (var_currentNode_6924, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 190)).add_operation (GALGAS_string (") -- ("), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 190)).add_operation (var_lastNodeName_7674, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 190)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 190)), inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 190)) ;
  const GALGAS_productionRuleListForGrammarAnalysis_2D_element temp_5 = inObject ;
  GALGAS_location var_loc_7784 = temp_5.getter_mLeftNonterminalSymbol (HERE).getter_location (HERE) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("\\ruleSubsection{").add_operation (function_escapeForTex (constinArgument_inSyntaxCompnentName, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 193)).add_operation (GALGAS_string ("}{"), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 194)).add_operation (function_escapeForTex (var_loc_7784.getter_file (inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 196)).getter_lastPathComponent (SOURCE_FILE ("production-rules-in-tex.galgas", 196)).getter_stringByDeletingPathExtension (SOURCE_FILE ("production-rules-in-tex.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 195)).add_operation (GALGAS_string ("}{"), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 196)).add_operation (function_escapeForTex (var_loc_7784.getter_line (inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 197)).getter_string (SOURCE_FILE ("production-rules-in-tex.galgas", 197)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 197)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 197)).add_operation (GALGAS_string ("}\n"
  ...
  cEnumerator_rowList enumerator_8217 (var_rowArray_6956, kENUMERATION_DOWN) ;
  while (enumerator_8217.hasCurrentObject ()) {
    ...
    cEnumerator__32_stringlist enumerator_8276 (enumerator_8217.current_columns (HERE), kENUMERATION_UP) ;
    while (enumerator_8276.hasCurrentObject ()) {
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        test_6 = GALGAS_bool (kIsEqual, enumerator_8276.current (HERE).getter_mValue_30_ (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_6) {
      ...
      if (kBoolFalse == test_6) {
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("\\node (").add_operation (enumerator_8276.current (HERE).getter_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 207)).add_operation (GALGAS_string (") "), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 207)).add_operation (enumerator_8276.current (HERE).getter_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 207)).add_operation (GALGAS_string ("; & "), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 207)), inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 207)) ;
      }
  ...
  ioArgument_ioGeneratedCode.plusAssign_operation(var_arrows_7111, inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 214)) ;
