...
static void categoryMethod_arrayTypeForGeneration_appendSpecificImplementation (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  if (object->mAttribute_mDimension.isValid ()) {
    uint32_t variant_43449 = object->mAttribute_mDimension.uintValue () ;
    bool loop_43449 = true ;
    while (loop_43449) {
      loop_43449 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension)).isValid () ;
      if (loop_43449) {
        loop_43449 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension)).boolValue () ;
      }
      if (loop_43449 && (0 == variant_43449)) {
        loop_43449 = false ;
...
static void categoryMethod_listmapTypeForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  cEnumerator_typedAttributeList enumerator_44164 (object->mAttribute_mAssociatedListTypedAttributeList, kEnumeration_up) ;
  while (enumerator_44164.hasCurrentObject ()) {
    categoryMethod_addHeaderFileName_31_ (enumerator_44164.current_mAttributeTypeProxy (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1162)) ;
    enumerator_44164.gotoNextObject () ;
  }
...
static void categoryMethod_mapTypeForGeneration_appendDeclaration_32_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  const cPtr_mapTypeForGeneration * object = (const cPtr_mapTypeForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_mapTypeForGeneration) ;
  cEnumerator_typedAttributeList enumerator_46950 (object->mAttribute_mTypedAttributeList, kEnumeration_up) ;
  while (enumerator_46950.hasCurrentObject ()) {
    categoryMethod_addHeaderFileName_31_ (enumerator_46950.current_mAttributeTypeProxy (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1243)) ;
    enumerator_46950.gotoNextObject () ;
  }
...
static void categoryMethod_uniqueMapTypeForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  cEnumerator_typedAttributeList enumerator_48148 (object->mAttribute_mTypedAttributeList, kEnumeration_up) ;
  while (enumerator_48148.hasCurrentObject ()) {
    categoryMethod_addHeaderFileName_31_ (enumerator_48148.current_mAttributeTypeProxy (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1280)) ;
    enumerator_48148.gotoNextObject () ;
  }
