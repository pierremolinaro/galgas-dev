...
static void extensionMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_templateInstructionSwitchBranchListForGeneration var_templateInstructionSwitchBranchList_66158 = GALGAS_templateInstructionSwitchBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.galgas", 1609)) ;
  GALGAS_stringset var_namedConstantSet_66193 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("templateAnalysis.galgas", 1610)) ;
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_66247 (object->mProperty_mTemplateInstructionSwitchBranchList, kENUMERATION_UP) ;
  while (enumerator_66247.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_66278 (enumerator_66247.current_mConstantList (HERE), kENUMERATION_UP) ;
    while (enumerator_66278.hasCurrentObject ()) {
      const enumGalgasBool test_2 = var_enumConstantMap_66013.getter_hasKey (enumerator_66278.current_mValue (HERE).getter_string (SOURCE_FILE ("templateAnalysis.galgas", 1613)) COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1613)).operator_not (SOURCE_FILE ("templateAnalysis.galgas", 1613)).boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (enumerator_66278.current_mValue (HERE).getter_location (SOURCE_FILE ("templateAnalysis.galgas", 1614)), GALGAS_string ("the '").add_operation (enumerator_66278.current_mValue (HERE).getter_string (SOURCE_FILE ("templateAnalysis.galgas", 1614)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)).add_operation (GALGAS_string ("' is not a contant of '@"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)).add_operation (var_switchExpression_65564.getter_mResultType (SOURCE_FILE ("templateAnalysis.galgas", 1614)).getter_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)).add_operation (GALGAS_string ("' enumeration type"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)), fixItArray3  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1614)) ;
      }
      const enumGalgasBool test_4 = var_namedConstantSet_66193.getter_hasKey (enumerator_66278.current_mValue (HERE).getter_string (SOURCE_FILE ("templateAnalysis.galgas", 1616)) COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1616)).boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (enumerator_66278.current_mValue (HERE).getter_location (SOURCE_FILE ("templateAnalysis.galgas", 1617)), GALGAS_string ("the '").add_operation (enumerator_66278.current_mValue (HERE).getter_string (SOURCE_FILE ("templateAnalysis.galgas", 1617)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1617)).add_operation (GALGAS_string ("' constant is already named in the switch instruction"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1617)), fixItArray5  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1617)) ;
      }
      var_namedConstantSet_66193.addAssign_operation (enumerator_66278.current_mValue (HERE).getter_string (SOURCE_FILE ("templateAnalysis.galgas", 1619))  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1619)) ;
      enumerator_66278.gotoNextObject () ;
    }
    GALGAS_templateInstructionListForGeneration var_instructionList_66722 = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.galgas", 1621)) ;
    {
    routine_templateInstructionListAnalysis (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, enumerator_66247.current_mInstructionList (HERE), var_instructionList_66722, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1622)) ;
    }
    var_templateInstructionSwitchBranchList_66158.addAssign_operation (enumerator_66247.current_mConstantList (HERE), var_instructionList_66722  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1629)) ;
    enumerator_66247.gotoNextObject () ;
  }
  GALGAS_stringset var_missingConstants_67093 = var_enumConstantMap_66013.getter_keySet (SOURCE_FILE ("templateAnalysis.galgas", 1632)).substract_operation (var_namedConstantSet_66193, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1632)) ;
  const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_missingConstants_67093.getter_count (SOURCE_FILE ("templateAnalysis.galgas", 1633)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_string var_m_67192 = GALGAS_string ("all constants should be named in a switch instruction; the following constants are missing:") ;
    cEnumerator_stringset enumerator_67319 (var_missingConstants_67093, kENUMERATION_UP) ;
    while (enumerator_67319.hasCurrentObject ()) {
      var_m_67192.plusAssign_operation(GALGAS_string ("\n"
        "  - '").add_operation (enumerator_67319.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1636)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1636)), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1636)) ;
      enumerator_67319.gotoNextObject () ;
    }
    TC_Array <C_FixItDescription> fixItArray7 ;
    inCompiler->emitSemanticError (object->mProperty_mSwitchExpressionEndLocation, var_m_67192, fixItArray7  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1638)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionSwitchForGeneration::constructor_new (var_switchExpression_65564, var_templateInstructionSwitchBranchList_66158  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1641))  COMMA_SOURCE_FILE ("templateAnalysis.galgas", 1641)) ;
}
...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lexicalAttributeListAST enumerator_21380 (constinArgument_inLexicalAttributeList, kENUMERATION_UP) ;
  while (enumerator_21380.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.getter_hasKey (enumerator_21380.current_mTypeName (HERE).getter_string (SOURCE_FILE ("lexiqueTypesForAST.galgas", 522)) COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 522)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lexicalTypeEnum var_lexicalType_21520 ;
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_21380.current_mTypeName (HERE), var_lexicalType_21520, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 523)) ;
      {
      ioArgument_ioLexicalAttributeMap.setter_insertKey (enumerator_21380.current_mName (HERE), var_lexicalType_21520, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 524)) ;
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_m_21608 = GALGAS_string::makeEmptyString () ;
      var_m_21608.plusAssign_operation(GALGAS_string ("the @").add_operation (enumerator_21380.current_mTypeName (HERE).getter_string (SOURCE_FILE ("lexiqueTypesForAST.galgas", 527)), inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 527)).add_operation (GALGAS_string (" type is not a valid lexical attribute type; are allowed:"), inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 527)), inCompiler  COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 527)) ;
      GALGAS_bool var_firstLoop_21728 = GALGAS_bool (true) ;
      cEnumerator_lexicalTypeMap enumerator_21768 (constinArgument_inLexicalTypeMap, kENUMERATION_UP) ;
      while (enumerator_21768.hasCurrentObject ()) {
        var_m_21608.plusAssign_operation(GALGAS_string (" @").add_operation (enumerator_21768.current_lkey (HERE).getter_string (SOURCE_FILE ("lexiqueTypesForAST.galgas", 530)), inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 530)), inCompiler  COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 530)) ;
        if (enumerator_21768.hasNextObject ()) {
          var_m_21608.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 532)) ;
        }
        enumerator_21768.gotoNextObject () ;
      }
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (enumerator_21380.current_mTypeName (HERE).getter_location (SOURCE_FILE ("lexiqueTypesForAST.galgas", 534)), var_m_21608, fixItArray1  COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 534)) ;
    }
...
static GALGAS_string extensionGetter_lexicalSelectInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mProperty_mDefaultInstructionList.getter_length (SOURCE_FILE ("lexiqueGeneration.galgas", 305)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void extensionMethod_lexicalTagInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_lexicalTagInstructionAST) ;
  {
  ioArgument_ioTagMap.setter_insertKey (object->mProperty_mLexicalTagName, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 652)) ;
  }
}
...
static void extensionMethod_lexicalErrorInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_lexicalErrorInstructionAST) ;
  {
  ioArgument_ioLexiqueAnalysisContext.mProperty_mLexicalMessageMap.setter_setMMessageIsUsedForKey (GALGAS_bool (true), object->mProperty_mErrorMessageName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 661)) ;
  }
}
...
static void extensionMethod_lexicalWarningInstructionAST_checkLexicalInstruction (const cPtr_lexicalInstructionAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_lexicalWarningInstructionAST) ;
  {
  ioArgument_ioLexiqueAnalysisContext.mProperty_mLexicalMessageMap.setter_setMMessageIsUsedForKey (GALGAS_bool (true), object->mProperty_mWarningMessageName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 669)) ;
  }
}
...
static void extensionMethod_lexicalImplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  const cPtr_lexicalImplicitRuleAST * object = (const cPtr_lexicalImplicitRuleAST *) inObject ;
  macroValidSharedObject (object, cPtr_lexicalImplicitRuleAST) ;
  GALGAS_lexicalExplicitTokenListMap joker_31920 ; // Joker input parameter
  GALGAS_tokenSortedlist joker_31923 ; // Joker input parameter
  GALGAS_bool joker_31926 ; // Joker input parameter
  ioArgument_ioLexiqueAnalysisContext.getter_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCompilation.galgas", 683)).method_searchKey (object->mProperty_mListName, joker_31920, joker_31923, joker_31926, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 683)) ;
}
...
static void extensionMethod_lexicalExplicitRuleAST_checkLexicalRule (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  const cPtr_lexicalExplicitRuleAST * object = (const cPtr_lexicalExplicitRuleAST *) inObject ;
  macroValidSharedObject (object, cPtr_lexicalExplicitRuleAST) ;
  callExtensionMethod_checkLexicalExpression ((const cPtr_lexicalExpressionAST *) object->mProperty_mLexicalRuleExpression.ptr (), ioArgument_ioLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 690)) ;
  GALGAS_lexicalTagMap var_tagMap_32255 = GALGAS_lexicalTagMap::constructor_emptyMap (SOURCE_FILE ("lexiqueCompilation.galgas", 691)) ;
  cEnumerator_lexicalInstructionListAST enumerator_32311 (object->mProperty_mInstructionList, kENUMERATION_UP) ;
  while (enumerator_32311.hasCurrentObject ()) {
    callExtensionMethod_checkLexicalInstruction ((const cPtr_lexicalInstructionAST *) enumerator_32311.current_mInstruction (HERE).ptr (), ioArgument_ioLexiqueAnalysisContext, var_tagMap_32255, inCompiler COMMA_SOURCE_FILE ("lexiqueCompilation.galgas", 693)) ;
