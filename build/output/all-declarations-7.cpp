...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_declaration_5F_with_5F_private_i4_ (const GALGAS_bool constinArgument_inIsPrivate,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_7187 = var_onceQualifier_7132.getter_location (SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 130)) ;
      inCompiler->emitSemanticError (location_7187, GALGAS_string ("the only attribute allowed here is '%once'")  COMMA_SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 130)) ;
  ...
  if (kBoolTrue == test_1) {
    GALGAS_location location_7512 = var_functionName_7324.getter_location (SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 138)) ;
    inCompiler->emitSemanticError (location_7512, GALGAS_string ("an 'once' function should has no argument")  COMMA_SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 138)) ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_syntax_5F_directed_5F_translation_5F_result_i8_ (GALGAS_abstractGrammarInstructionSyntaxDirectedTranslationResult & outArgument_outResult,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_12583 = var_selector_12541.getter_location (SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 260)) ;
    inCompiler->emitSemanticError (location_12583, GALGAS_string ("the selector should be '\?'")  COMMA_SOURCE_FILE ("galgas3InstructionsSyntax.galgas", 260)) ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i16_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_4029 = var_terminator_3973.getter_location (SOURCE_FILE ("instruction-cast.galgas", 105)) ;
      inCompiler->emitSemanticError (location_4029, GALGAS_string ("the terminator attribute should be '%cast'")  COMMA_SOURCE_FILE ("instruction-cast.galgas", 105)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_for_5F_instruction_5F_element_i22_ (GALGAS_forInstructionEnumeratedObjectElementListAST & ioArgument_ioElementList,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_3582 = var_count_3518.getter_location (SOURCE_FILE ("instruction-for.galgas", 88)) ;
    inCompiler->emitSemanticError (location_3582, GALGAS_string ("this value should be > 0")  COMMA_SOURCE_FILE ("instruction-for.galgas", 88)) ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i27_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_8351 = var_terminator_8296.getter_location (SOURCE_FILE ("instruction-for.galgas", 251)) ;
      inCompiler->emitSemanticError (location_8351, GALGAS_string ("the terminator attribute should be '%for'")  COMMA_SOURCE_FILE ("instruction-for.galgas", 251)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i32_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_2102 = var_terminator_2048.getter_location (SOURCE_FILE ("instruction-if.galgas", 57)) ;
      inCompiler->emitSemanticError (location_2102, GALGAS_string ("the terminator attribute should be '%if'")  COMMA_SOURCE_FILE ("instruction-if.galgas", 57)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i37_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_1899 = var_terminator_1843.getter_location (SOURCE_FILE ("instruction-loop.galgas", 49)) ;
      inCompiler->emitSemanticError (location_1899, GALGAS_string ("the terminator attribute should be '%loop'")  COMMA_SOURCE_FILE ("instruction-loop.galgas", 49)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i41_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_2) {
      GALGAS_location location_4176 = var_terminator_4119.getter_location (SOURCE_FILE ("instruction-match.galgas", 115)) ;
      inCompiler->emitSemanticError (location_4176, GALGAS_string ("the terminator attribute should be '%match'")  COMMA_SOURCE_FILE ("instruction-match.galgas", 115)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i51_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_1355 = var_selector_1309.getter_location (SOURCE_FILE ("instruction-setter-call.galgas", 34)) ;
    inCompiler->emitSemanticError (location_1355, GALGAS_string ("an empty selector '!\?' is required here")  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 34)) ;
  }
  ...
  while (repeatFlag_1) {
    ...
    case 2: {
      ...
      GALGAS_lstring var_structAttribute_1583 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_mReceiverStructAttributes_1486.addAssign_operation (var_structAttribute_1583  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 42)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  GALGAS_lstring var_typeNameForCasting_1675 ;
  switch (select_galgas_33_InstructionsSyntax_54 (inCompiler)) {
  case 1: {
    var_typeNameForCasting_1675 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("instruction-setter-call.galgas", 46)) ;
  } break ;
  case 2: {
    ...
    var_typeNameForCasting_1675 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mSetterName_1824 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_actualParameterListAST var_actualParameterList_1901 ;
  nt_actual_5F_parameter_5F_list_ (var_actualParameterList_1901, inCompiler) ;
  ...
  outArgument_outInstruction = GALGAS_setterCallInstructionAST::constructor_new (var_instructionLocation_1269, var_mReceiverName_1452, var_mReceiverStructAttributes_1486, var_typeNameForCasting_1675, var_mSetterName_1824, var_actualParameterList_1901  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 54)) ;
}
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i52_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  GALGAS_location var_instructionLocation_2360 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 69)) ;
  GALGAS_lstring var_selector_2400 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selector_2400.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_2446 = var_selector_2400.getter_location (SOURCE_FILE ("instruction-setter-call.galgas", 72)) ;
    inCompiler->emitSemanticError (location_2446, GALGAS_string ("an empty selector '!\?' is required here")  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 72)) ;
  }
  ...
  GALGAS_lstring var_mSetterName_2552 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_actualParameterListAST var_actualParameterList_2629 ;
  nt_actual_5F_parameter_5F_list_ (var_actualParameterList_2629, inCompiler) ;
  ...
  outArgument_outInstruction = GALGAS_selfSetterCallInstructionAST::constructor_new (var_instructionLocation_2360, var_mSetterName_2552, var_actualParameterList_2629  COMMA_SOURCE_FILE ("instruction-setter-call.galgas", 78)) ;
}
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i53_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_3) {
      GALGAS_location location_3135 = var_terminator_3077.getter_location (SOURCE_FILE ("instruction-switch.galgas", 92)) ;
      inCompiler->emitSemanticError (location_3135, GALGAS_string ("the terminator attribute should be '%switch'")  COMMA_SOURCE_FILE ("instruction-switch.galgas", 92)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i57_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 1: {
    ...
    case 2: {
      ...
      if (kBoolTrue == test_0) {
        GALGAS_location location_2827 = var_searchMethodNameForErrorSignaling_2290.getter_location (SOURCE_FILE ("instruction-with.galgas", 76)) ;
        inCompiler->emitSemanticError (location_2827, GALGAS_string ("no 'else' branch if error on search is enabled")  COMMA_SOURCE_FILE ("instruction-with.galgas", 76)) ;
      }
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_3458 = var_selector_3408.getter_location (SOURCE_FILE ("instruction-with.galgas", 95)) ;
      inCompiler->emitSemanticError (location_3458, GALGAS_string ("an empty selector '!\?' is required here")  COMMA_SOURCE_FILE ("instruction-with.galgas", 95)) ;
    }
    ...
    case 2: {
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_searchMethodNameForErrorSignaling_3858.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4432 = var_searchMethodNameForErrorSignaling_3858.getter_location (SOURCE_FILE ("instruction-with.galgas", 123)) ;
        inCompiler->emitSemanticError (location_4432, GALGAS_string ("no 'else' branch if error on search is enabled")  COMMA_SOURCE_FILE ("instruction-with.galgas", 123)) ;
      }
  ...
  case 2: {
    ...
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_terminator_5156.mAttribute_string.objectCompare (GALGAS_string ("with"))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5212 = var_terminator_5156.getter_location (SOURCE_FILE ("instruction-with.galgas", 147)) ;
      inCompiler->emitSemanticError (location_5212, GALGAS_string ("the terminator attribute should be '%with'")  COMMA_SOURCE_FILE ("instruction-with.galgas", 147)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_i6_ (GALGAS_galgas_33_DeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_externTypeGetterList var_externTypeGetterList_3087 = GALGAS_externTypeGetterList::constructor_emptyList (SOURCE_FILE ("type-extern.galgas", 83)) ;
  GALGAS_externTypeModifierList var_externTypeModifierList_3123 = GALGAS_externTypeModifierList::constructor_emptyList (SOURCE_FILE ("type-extern.galgas", 84)) ;
  GALGAS_externTypeMethodList var_externTypeMethodList_3189 = GALGAS_externTypeMethodList::constructor_emptyList (SOURCE_FILE ("type-extern.galgas", 85)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    ...
    case 2: {
      ...
      GALGAS_lstring var_constructorName_3315 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_typeNameFormalParameterNameList var_argumentTypeList_3342 = GALGAS_typeNameFormalParameterNameList::constructor_emptyList (SOURCE_FILE ("type-extern.galgas", 90)) ;
      bool repeatFlag_3 = true ;
      while (repeatFlag_3) {
        switch (select_galgas_33_DeclarationsSyntax_21 (inCompiler)) {
        case 2: {
          GALGAS_lstring var_selector_3439 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          GALGAS_lstring var_argumentTypeName_3491 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          GALGAS_lstring var_argumentName_3540 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          var_argumentTypeList_3342.addAssign_operation (var_selector_3439, var_argumentTypeName_3491, var_argumentName_3540  COMMA_SOURCE_FILE ("type-extern.galgas", 96)) ;
        } break ;
        default:
          repeatFlag_3 = false ;
          break ;
      ...
      GALGAS_lstring var_resultTypeName_3679 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_externTypeConstructorList_3000.addAssign_operation (var_constructorName_3315, var_resultTypeName_3679, var_argumentTypeList_3342  COMMA_SOURCE_FILE ("type-extern.galgas", 100)) ;
    } break ;
    case 3: {
      ...
      GALGAS_lstring var_getterName_3859 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_typeNameFormalParameterNameList var_argumentTypeList_3886 = GALGAS_typeNameFormalParameterNameList::constructor_emptyList (SOURCE_FILE ("type-extern.galgas", 107)) ;
      bool repeatFlag_4 = true ;
      while (repeatFlag_4) {
        switch (select_galgas_33_DeclarationsSyntax_22 (inCompiler)) {
        case 2: {
          GALGAS_lstring var_selector_3983 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          GALGAS_lstring var_argumentTypeName_4035 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          GALGAS_lstring var_argumentName_4084 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          var_argumentTypeList_3886.addAssign_operation (var_selector_3983, var_argumentTypeName_4035, var_argumentName_4084  COMMA_SOURCE_FILE ("type-extern.galgas", 113)) ;
        } break ;
        default:
          repeatFlag_4 = false ;
          break ;
      ...
      GALGAS_lstring var_resultTypeName_4223 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_externTypeGetterList_3087.addAssign_operation (var_getterName_3859, var_resultTypeName_4223, var_argumentTypeList_3886  COMMA_SOURCE_FILE ("type-extern.galgas", 117)) ;
    } break ;
    case 4: {
      ...
      GALGAS_lstring var_setterName_4393 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_formalParameterListAST var_formalParameterList_4472 ;
      nt_formal_5F_parameter_5F_list_ (var_formalParameterList_4472, inCompiler) ;
      var_externTypeModifierList_3123.addAssign_operation (var_setterName_4393, var_formalParameterList_4472  COMMA_SOURCE_FILE ("type-extern.galgas", 125)) ;
    } break ;
    case 5: {
      ...
      GALGAS_lstring var_methodName_4623 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_formalParameterListAST var_formalParameterList_4702 ;
      nt_formal_5F_parameter_5F_list_ (var_formalParameterList_4702, inCompiler) ;
      var_externTypeMethodList_3189.addAssign_operation (var_methodName_4623, var_formalParameterList_4702, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-extern.galgas", 135))  COMMA_SOURCE_FILE ("type-extern.galgas", 132)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i9_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_2) {
      GALGAS_location location_9054 = var_endRepeat_9001.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 237)) ;
      inCompiler->emitSemanticError (location_9054, GALGAS_string ("the attribute should be '%repeat'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 237)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i11_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_3) {
      GALGAS_location location_10652 = var_endSelect_10599.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 289)) ;
      inCompiler->emitSemanticError (location_10652, GALGAS_string ("the attribute should be '%select'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 289)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i12_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      if (kBoolTrue == test_1) {
        GALGAS_location location_11272 = var_selector_11226.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 308)) ;
        inCompiler->emitSemanticError (location_11272, GALGAS_string ("the selector should be '!'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 308)) ;
      }
    ...
    case 3: {
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_selector_11589.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_location location_11635 = var_selector_11589.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 316)) ;
        inCompiler->emitSemanticError (location_11635, GALGAS_string ("the selector should be '!\?'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 316)) ;
      }
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_function_5F_call_5F_or_5F_attribute_i18_ (const GALGAS_lstring constinArgument_inIdf,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      if (kBoolTrue == test_1) {
        GALGAS_location location_14408 = var_selector_14362.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 389)) ;
        inCompiler->emitSemanticError (location_14408, GALGAS_string ("the selector should be '!'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 389)) ;
      }
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_style_5F_declaration_i35_ (GALGAS_lexicalStyleListAST & ioArgument_ioLexicalStyleList,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location location_21818 = var_styleIdentifier_21749.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 606)) ;
    inCompiler->emitSemanticError (location_21818, GALGAS_string ("for compatibility with latex formatting, a style name should not contain '_' character")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 606)) ;
  }
  const enumGalgasBool test_1 = var_styleIdentifier_21749.mAttribute_string.getter_containsCharacterInRange (GALGAS_char (TO_UNICODE (48)), GALGAS_char (TO_UNICODE (57)) COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 608)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_22012 = var_styleIdentifier_21749.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 609)) ;
    inCompiler->emitSemanticError (location_22012, GALGAS_string ("for compatibility with latex formatting, a style name should not contain any digit")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 609)) ;
  }
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 1: {
        ...
        if (kBoolTrue == test_1) {
          GALGAS_location location_22733 = var_selector_22683.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 630)) ;
          inCompiler->emitSemanticError (location_22733, GALGAS_string ("the selector should be '\?!'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 630)) ;
        }
      ...
      case 2: {
        ...
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_selector_22891.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_22941 = var_selector_22891.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 636)) ;
          inCompiler->emitSemanticError (location_22941, GALGAS_string ("the selector should be '\?'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 636)) ;
        }
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_extern_5F_function_5F_declaration_i37_ (GALGAS_externFunctionListAST & ioArgument_ioExternFunctionList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      if (kBoolTrue == test_1) {
        GALGAS_location location_24035 = var_selector_23989.getter_location (SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 670)) ;
        inCompiler->emitSemanticError (location_24035, GALGAS_string ("the selector should be '\?'")  COMMA_SOURCE_FILE ("galgas3LexiqueComponentSyntax.galgas", 670)) ;
      }
          ...
          case 2: {
            ...
            while (repeatFlag_3) {
              ...
              case 3: {
                ...
                if (kBoolTrue == test_4) {
                  GALGAS_location location_3972 = var_leadingStrip_3908.getter_location (SOURCE_FILE ("galgas3GuiComponentSyntax.galgas", 79)) ;
                  inCompiler->emitSemanticError (location_3972, GALGAS_string ("leading strip should be < 15")  COMMA_SOURCE_FILE ("galgas3GuiComponentSyntax.galgas", 79)) ;
                }
                ...
                const enumGalgasBool test_5 = GALGAS_bool (kIsSupOrEqual, var_endingStrip_4111.mAttribute_uint.objectCompare (GALGAS_uint ((uint32_t) 15U))).boolEnum () ;
                if (kBoolTrue == test_5) {
                  GALGAS_location location_4174 = var_endingStrip_4111.getter_location (SOURCE_FILE ("galgas3GuiComponentSyntax.galgas", 84)) ;
                  inCompiler->emitSemanticError (location_4174, GALGAS_string ("tail strip should be < 15")  COMMA_SOURCE_FILE ("galgas3GuiComponentSyntax.galgas", 84)) ;
                }
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_declaration_i0_ (GALGAS_galgas_33_DeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_3749 = var_featureName_3691.getter_location (SOURCE_FILE ("galgas3SyntaxComponentSyntax.galgas", 60)) ;
      inCompiler->emitSemanticError (location_3749, GALGAS_string ("only 'feature translate' can be declared here")  COMMA_SOURCE_FILE ("galgas3SyntaxComponentSyntax.galgas", 60)) ;
    }
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i8_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_1613 = var_terminator_1555.getter_location (SOURCE_FILE ("instruction-repeat.galgas", 39)) ;
      inCompiler->emitSemanticError (location_1613, GALGAS_string ("the terminator attribute should be '%repeat'")  COMMA_SOURCE_FILE ("instruction-repeat.galgas", 39)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i9_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_1479 = var_terminator_1421.getter_location (SOURCE_FILE ("instruction-select.galgas", 37)) ;
      inCompiler->emitSemanticError (location_1479, GALGAS_string ("the terminator attribute should be '%select'")  COMMA_SOURCE_FILE ("instruction-select.galgas", 37)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i11_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_1590 = var_terminator_1533.getter_location (SOURCE_FILE ("instruction-parse-loop.galgas", 40)) ;
      inCompiler->emitSemanticError (location_1590, GALGAS_string ("the terminator attribute should be '%parse'")  COMMA_SOURCE_FILE ("instruction-parse-loop.galgas", 40)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i12_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_1483 = var_terminator_1426.getter_location (SOURCE_FILE ("instruction-parse-rewind.galgas", 37)) ;
      inCompiler->emitSemanticError (location_1483, GALGAS_string ("the terminator attribute should be '%parse'")  COMMA_SOURCE_FILE ("instruction-parse-rewind.galgas", 37)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i15_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_2933 = var_terminator_2876.getter_location (SOURCE_FILE ("instruction-parse-when.galgas", 73)) ;
      inCompiler->emitSemanticError (location_2933, GALGAS_string ("the terminator attribute should be '%parse'")  COMMA_SOURCE_FILE ("instruction-parse-when.galgas", 73)) ;
    }
  } break ;
  default:
    break ;
