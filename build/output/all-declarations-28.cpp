...
void routine_generateExtensionMethodNew_3F__26__3F__3F__3F__21_ (const GALGAS_unifiedTypeMapEntry constinArgument_inReceiverType,
  ...
  if (GALGAS_uint::class_func_max (SOURCE_FILE ("semanticGeneration.galgas", 662)).isValid ()) {
    ...
    while (loop_27462) {
      ...
      if (loop_27462) {
        ...
        enumGalgasBool test_0 = kBoolTrue ;
        if (kBoolTrue == test_0) {
          test_0 = extensionGetter_definition (var_baseType_27405, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 663)).readProperty_superType ().getter_null (SOURCE_FILE ("semanticGeneration.galgas", 663)).operator_not (SOURCE_FILE ("semanticGeneration.galgas", 663)).boolEnum () ;
          if (kBoolTrue == test_0) {
            enumGalgasBool test_1 = kBoolTrue ;
            if (kBoolTrue == test_1) {
  ...
  cEnumerator_formalParameterListForGeneration enumerator_28028 (constinArgument_inFormalArgumentList, EnumerationOrder::up) ;
  while (enumerator_28028.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName (enumerator_28028.current_mFormalArgumentType (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 676)) ;
  ...
  GALGAS_uint var_colRef_28294 = outArgument_outGeneratedCode.getter_currentColumn (SOURCE_FILE ("semanticGeneration.galgas", 680)) ;
  cEnumerator_formalParameterListForGeneration enumerator_28399 (constinArgument_inFormalArgumentList, EnumerationOrder::up) ;
  while (enumerator_28399.hasCurrentObject ()) {
    switch (enumerator_28399.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
    case GALGAS_formalArgumentPassingModeAST::Enumeration::invalid:
      break ;
    case GALGAS_formalArgumentPassingModeAST::Enumeration::enum_argumentConstantIn:
      {
        outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("const GALGAS_").add_operation (extensionGetter_identifierRepresentation (enumerator_28399.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 685)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 685)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 685)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 685)) ;
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::Enumeration::enum_argumentInOut:
      {
    ...
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = var_unusedVariableCppNameSet_26685.getter_hasKey (enumerator_28399.current_mFormalArgumentCppName (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 693)).boolEnum () ;
      if (kBoolTrue == test_2) {
        outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("/* ").add_operation (enumerator_28399.current_mFormalArgumentCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 694)).add_operation (GALGAS_string (" */"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 694)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 694)) ;
      }
    }
    if (kBoolFalse == test_2) {
      outArgument_outGeneratedCode.plusAssign_operation(enumerator_28399.current_mFormalArgumentCppName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 696)) ;
    }
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 698)) ;
    {
    outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_28294, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 699)) ;
    }
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_28294, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 709)) ;
  }
...
GALGAS_string filewrapperTemplate_typeGenerationTemplate_unifiedClassBodyForType (Compiler * inCompiler,
  ...
  const enumGalgasBool test_7 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_plusEqualOperatorWithExpression (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 66)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 66)).boolEnum () ;
  switch (test_7) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_8 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_minusEqualOperatorWithExpression (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 73)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 73)).boolEnum () ;
  switch (test_8) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_9 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_mulEqualOperatorWithExpression (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 80)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 80)).boolEnum () ;
  switch (test_9) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_10 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_divEqualOperatorWithExpression (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 87)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 87)).boolEnum () ;
  switch (test_10) {
  case kBoolTrue : {
  ...
  case kBoolTrue : {
    ...
    columnMarker = result.currentColumn () ;
    GALGAS_uint index_5189_IDX (0) ;
    if (in_ADD_5F_ASSIGN_5F_ARGUMENT_5F_LIST.isValid ()) {
      cEnumerator_functionSignature enumerator_5189 (in_ADD_5F_ASSIGN_5F_ARGUMENT_5F_LIST, EnumerationOrder::up) ;
      while (enumerator_5189.hasCurrentObject ()) {
        result.appendString ("const class GALGAS_") ;
        result.appendString (extensionGetter_identifierRepresentation (enumerator_5189.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 98)).stringValue ()) ;
        result.appendString (" & inOperand") ;
        result.appendString (index_5189_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 98)).stringValue ()) ;
        if (enumerator_5189.hasNextObject ()) {
          result.appendString (",\n") ;
          result.appendSpacesUntilColumn (columnMarker) ;
        }
        index_5189_IDX.increment () ;
        enumerator_5189.gotoNextObject () ;
      }
    }
    const enumGalgasBool test_12 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_plusEqualOperatorWithFieldListNeedsCompilerArg (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 101)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 101)).boolEnum () ;
    switch (test_12) {
    case kBoolTrue : {
      result.appendString (",\n") ;
      result.appendSpacesUntilColumn (columnMarker) ;
  ...
  const enumGalgasBool test_13 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixAndOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 108)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 108)).boolEnum () ;
  switch (test_13) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_14 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixOrOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 114)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 114)).boolEnum () ;
  switch (test_14) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- | operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_15 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixXorOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 120)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 120)).boolEnum () ;
  switch (test_15) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- ^ operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_16 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_prefixNotOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 126)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 126)).boolEnum () ;
  switch (test_16) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_17 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_prefixTildeOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 131)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 131)).boolEnum () ;
  switch (test_17) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- ~ operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_18 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixAddOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 136)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 136)).boolEnum () ;
  switch (test_18) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- + operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_19 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixAddOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 143)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 143)).boolEnum () ;
  switch (test_19) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- &+ operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_20 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixSubOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 148)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 148)).boolEnum () ;
  switch (test_20) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- &- operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_21 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixSubOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 153)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 153)).boolEnum () ;
  switch (test_21) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- - operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_22 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixMulOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 160)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 160)).boolEnum () ;
  switch (test_22) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- * operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_23 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixMulOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 167)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 167)).boolEnum () ;
  switch (test_23) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- &* operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_24 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixDivOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 172)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 172)).boolEnum () ;
  switch (test_24) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- / operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_25 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixDivOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 179)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 179)).boolEnum () ;
  switch (test_25) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- &/ operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_26 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_infixModOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 184)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 184)).boolEnum () ;
  switch (test_26) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_27 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_prefixMinusOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 191)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 191)).boolEnum () ;
  switch (test_27) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_28 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_prefixMinusOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 197)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 197)).boolEnum () ;
  switch (test_28) {
  case kBoolTrue : {
    result.appendString ("//--------------------------------- prefix &- operator\n  public: VIRTUAL_IN_DEBUG GALGAS_") ;
    result.appendString (in_TYPE_5F_IDENTIFIER.stringValue ()) ;
  ...
  const enumGalgasBool test_29 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_incDecOperator (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 202)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 202)).boolEnum () ;
  switch (test_29) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_30 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_incDecOperatorNoOVF (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 209)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 209)).boolEnum () ;
  switch (test_30) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_31 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_generateDescriptionGetterUtilityMethod (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 214)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 214)).boolEnum () ;
  switch (test_31) {
  case kBoolTrue : {
  ...
  if (in_MODIFIER_5F_MAP.isValid ()) {
    cEnumerator_setterMap enumerator_11582 (in_MODIFIER_5F_MAP, EnumerationOrder::up) ;
    while (enumerator_11582.hasCurrentObject ()) {
      const enumGalgasBool test_33 = GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mKind (HERE).objectCompare (GALGAS_methodKind::class_func_definedAsMember (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 231)))).boolEnum () ;
      switch (test_33) {
      case kBoolTrue : {
        const enumGalgasBool test_34 = GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mErrorMessage (HERE).objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualAbstract (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)))).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasicFinal (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 232)).boolEnum () ;
        switch (test_34) {
        case kBoolTrue : {
          result.appendString ("  public: VIRTUAL_IN_DEBUG void setter_") ;
          result.appendString (enumerator_11582.current_lkey (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 233)).stringValue ()) ;
          result.appendString (" (") ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_12030_IDX (0) ;
          if (enumerator_11582.current_mParameterList (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_12030 (enumerator_11582.current_mParameterList (HERE), EnumerationOrder::up) ;
            while (enumerator_12030.hasCurrentObject ()) {
              const enumGalgasBool test_35 = GALGAS_bool (ComparisonKind::equal, enumerator_12030.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentConstantIn (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 235)))).boolEnum () ;
              switch (test_35) {
              case kBoolTrue : {
                result.appendString ("class GALGAS_") ;
                result.appendString (extensionGetter_identifierRepresentation (enumerator_12030.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 236)).stringValue ()) ;
                result.appendString (" constinArgument") ;
                result.appendString (index_12030_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 236)).stringValue ()) ;
                } break ;
              case kBoolFalse : {
                const enumGalgasBool test_36 = GALGAS_bool (ComparisonKind::equal, enumerator_12030.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentInOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 237)))).boolEnum () ;
                switch (test_36) {
                case kBoolTrue : {
                  result.appendString ("class GALGAS_") ;
                  result.appendString (extensionGetter_identifierRepresentation (enumerator_12030.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 238)).stringValue ()) ;
                  result.appendString (" & ioArgument") ;
                  result.appendString (index_12030_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 238)).stringValue ()) ;
                  } break ;
                case kBoolFalse : {
                  const enumGalgasBool test_37 = GALGAS_bool (ComparisonKind::equal, enumerator_12030.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 239)))).boolEnum () ;
                  switch (test_37) {
                  case kBoolTrue : {
                    result.appendString ("class GALGAS_") ;
                    result.appendString (extensionGetter_identifierRepresentation (enumerator_12030.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 240)).stringValue ()) ;
                    result.appendString (" & outArgument") ;
                    result.appendString (index_12030_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 240)).stringValue ()) ;
                    } break ;
                  case kBoolFalse : {
                    result.appendString ("class GALGAS_") ;
                    result.appendString (extensionGetter_identifierRepresentation (enumerator_12030.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 242)).stringValue ()) ;
                    result.appendString (" inArgument") ;
                    result.appendString (index_12030_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 242)).stringValue ()) ;
                    } break ;
                  default :
                    break ;
                  }
              ...
              if (enumerator_12030.hasNextObject ()) {
                result.appendString (",\n") ;
                result.appendSpacesUntilColumn (columnMarker) ;
              }
              index_12030_IDX.increment () ;
              enumerator_12030.gotoNextObject () ;
            }
          }
          const enumGalgasBool test_38 = GALGAS_bool (ComparisonKind::equal, enumerator_11582.current_mParameterList (HERE).getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 246)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
          switch (test_38) {
          case kBoolTrue : {
            const enumGalgasBool test_39 = enumerator_11582.current_mHasCompilerArgument (HERE).boolEnum () ;
            switch (test_39) {
            case kBoolTrue : {
              result.appendString ("Compiler * inCompiler\n") ;
              result.appendSpacesUntilColumn (columnMarker) ;
          ...
          case kBoolFalse : {
            const enumGalgasBool test_40 = enumerator_11582.current_mHasCompilerArgument (HERE).boolEnum () ;
            switch (test_40) {
            case kBoolTrue : {
              result.appendString (",\n") ;
              result.appendSpacesUntilColumn (columnMarker) ;
  ...
  result.appendString ("\n//--------------------------------- Instance Methods\n") ;
  GALGAS_uint index_13425_ (0) ;
  if (in_INSTANCE_5F_METHOD_5F_MAP.isValid ()) {
    cEnumerator_instanceMethodMap enumerator_13425 (in_INSTANCE_5F_METHOD_5F_MAP, EnumerationOrder::up) ;
    while (enumerator_13425.hasCurrentObject ()) {
      const enumGalgasBool test_41 = GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mKind (HERE).objectCompare (GALGAS_methodKind::class_func_definedAsMember (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 269)))).boolEnum () ;
      switch (test_41) {
      case kBoolTrue : {
        const enumGalgasBool test_42 = GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mErrorMessage (HERE).objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualAbstract (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)))).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasicFinal (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 270)).boolEnum () ;
        switch (test_42) {
        case kBoolTrue : {
          result.appendString ("  public: VIRTUAL_IN_DEBUG void method_") ;
          result.appendString (enumerator_13425.current_lkey (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 271)).stringValue ()) ;
          result.appendString (" (") ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_13873_IDX (0) ;
          if (enumerator_13425.current_mParameterList (HERE).isValid ()) {
            cEnumerator_formalParameterSignature enumerator_13873 (enumerator_13425.current_mParameterList (HERE), EnumerationOrder::up) ;
            while (enumerator_13873.hasCurrentObject ()) {
              const enumGalgasBool test_43 = GALGAS_bool (ComparisonKind::equal, enumerator_13873.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentConstantIn (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 273)))).boolEnum () ;
              switch (test_43) {
              case kBoolTrue : {
                result.appendString ("class GALGAS_") ;
                result.appendString (extensionGetter_identifierRepresentation (enumerator_13873.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 274)).stringValue ()) ;
                result.appendString (" constinArgument") ;
                result.appendString (index_13873_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 274)).stringValue ()) ;
                } break ;
              case kBoolFalse : {
                const enumGalgasBool test_44 = GALGAS_bool (ComparisonKind::equal, enumerator_13873.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentInOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 275)))).boolEnum () ;
                switch (test_44) {
                case kBoolTrue : {
                  result.appendString ("class GALGAS_") ;
                  result.appendString (extensionGetter_identifierRepresentation (enumerator_13873.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 276)).stringValue ()) ;
                  result.appendString (" & ioArgument") ;
                  result.appendString (index_13873_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 276)).stringValue ()) ;
                  } break ;
                case kBoolFalse : {
                  const enumGalgasBool test_45 = GALGAS_bool (ComparisonKind::equal, enumerator_13873.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 277)))).boolEnum () ;
                  switch (test_45) {
                  case kBoolTrue : {
                    result.appendString ("class GALGAS_") ;
                    result.appendString (extensionGetter_identifierRepresentation (enumerator_13873.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 278)).stringValue ()) ;
                    result.appendString (" & outArgument") ;
                    result.appendString (index_13873_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 278)).stringValue ()) ;
                    } break ;
                  case kBoolFalse : {
                    result.appendString ("class GALGAS_") ;
                    result.appendString (extensionGetter_identifierRepresentation (enumerator_13873.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 280)).stringValue ()) ;
                    result.appendString (" inArgument") ;
                    result.appendString (index_13873_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 280)).stringValue ()) ;
                    } break ;
                  default :
                    break ;
                  }
              ...
              if (enumerator_13873.hasNextObject ()) {
                result.appendString (",\n") ;
                result.appendSpacesUntilColumn (columnMarker) ;
              }
              index_13873_IDX.increment () ;
              enumerator_13873.gotoNextObject () ;
            }
          }
          const enumGalgasBool test_46 = GALGAS_bool (ComparisonKind::equal, enumerator_13425.current_mParameterList (HERE).getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 284)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
          switch (test_46) {
          case kBoolTrue : {
            const enumGalgasBool test_47 = enumerator_13425.current_mHasCompilerArgument (HERE).boolEnum () ;
            switch (test_47) {
            case kBoolTrue : {
              result.appendString ("Compiler * inCompiler\n") ;
              result.appendSpacesUntilColumn (columnMarker) ;
          ...
          case kBoolFalse : {
            const enumGalgasBool test_48 = enumerator_13425.current_mHasCompilerArgument (HERE).boolEnum () ;
            switch (test_48) {
            case kBoolTrue : {
              result.appendString (",\n") ;
              result.appendSpacesUntilColumn (columnMarker) ;
  ...
  if (in_CLASS_5F_METHOD_5F_MAP.isValid ()) {
    cEnumerator_classMethodMap enumerator_15215 (in_CLASS_5F_METHOD_5F_MAP, EnumerationOrder::up) ;
    while (enumerator_15215.hasCurrentObject ()) {
      result.appendString ("  public: static void class_method_") ;
      result.appendString (enumerator_15215.current_lkey (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 306)).stringValue ()) ;
      result.appendString (" (") ;
      columnMarker = result.currentColumn () ;
      GALGAS_uint index_15416_IDX (0) ;
      if (enumerator_15215.current_mParameterList (HERE).isValid ()) {
        cEnumerator_formalParameterSignature enumerator_15416 (enumerator_15215.current_mParameterList (HERE), EnumerationOrder::up) ;
        while (enumerator_15416.hasCurrentObject ()) {
          const enumGalgasBool test_49 = GALGAS_bool (ComparisonKind::equal, enumerator_15416.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentConstantIn (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 308)))).boolEnum () ;
          switch (test_49) {
          case kBoolTrue : {
            result.appendString ("class GALGAS_") ;
            result.appendString (extensionGetter_identifierRepresentation (enumerator_15416.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 309)).stringValue ()) ;
            result.appendString (" constinArgument") ;
            result.appendString (index_15416_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 309)).stringValue ()) ;
            } break ;
          case kBoolFalse : {
            const enumGalgasBool test_50 = GALGAS_bool (ComparisonKind::equal, enumerator_15416.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentInOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 310)))).boolEnum () ;
            switch (test_50) {
            case kBoolTrue : {
              result.appendString ("class GALGAS_") ;
              result.appendString (extensionGetter_identifierRepresentation (enumerator_15416.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 311)).stringValue ()) ;
              result.appendString (" & ioArgument") ;
              result.appendString (index_15416_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 311)).stringValue ()) ;
              } break ;
            case kBoolFalse : {
              const enumGalgasBool test_51 = GALGAS_bool (ComparisonKind::equal, enumerator_15416.current_mFormalArgumentPassingMode (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::class_func_argumentOut (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 312)))).boolEnum () ;
              switch (test_51) {
              case kBoolTrue : {
                result.appendString ("class GALGAS_") ;
                result.appendString (extensionGetter_identifierRepresentation (enumerator_15416.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 313)).stringValue ()) ;
                result.appendString (" & outArgument") ;
                result.appendString (index_15416_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 313)).stringValue ()) ;
                } break ;
              case kBoolFalse : {
                result.appendString ("class GALGAS_") ;
                result.appendString (extensionGetter_identifierRepresentation (enumerator_15416.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 315)).stringValue ()) ;
                result.appendString (" inArgument") ;
                result.appendString (index_15416_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 315)).stringValue ()) ;
                } break ;
              default :
                break ;
              }
          ...
          if (enumerator_15416.hasNextObject ()) {
            result.appendString (",\n") ;
            result.appendSpacesUntilColumn (columnMarker) ;
          }
          index_15416_IDX.increment () ;
          enumerator_15416.gotoNextObject () ;
        }
      }
      const enumGalgasBool test_52 = GALGAS_bool (ComparisonKind::equal, enumerator_15215.current_mParameterList (HERE).getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 319)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
      switch (test_52) {
      case kBoolTrue : {
        const enumGalgasBool test_53 = enumerator_15215.current_mHasCompilerArgument (HERE).boolEnum () ;
        switch (test_53) {
        case kBoolTrue : {
          result.appendString ("Compiler * inCompiler\n") ;
          result.appendSpacesUntilColumn (columnMarker) ;
      ...
      case kBoolFalse : {
        const enumGalgasBool test_54 = enumerator_15215.current_mHasCompilerArgument (HERE).boolEnum () ;
        switch (test_54) {
        case kBoolTrue : {
          result.appendString (",\n") ;
          result.appendSpacesUntilColumn (columnMarker) ;
  ...
  result.appendString ("\n//--------------------------------- Getters\n") ;
  GALGAS_uint index_16668_ (0) ;
  if (in_GETTER_5F_MAP.isValid ()) {
    cEnumerator_getterMap enumerator_16668 (in_GETTER_5F_MAP, EnumerationOrder::up) ;
    while (enumerator_16668.hasCurrentObject ()) {
      const enumGalgasBool test_55 = GALGAS_bool (ComparisonKind::equal, enumerator_16668.current_mGetterNameThatObsoletesInvokationName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      switch (test_55) {
      case kBoolTrue : {
        switch (enumerator_16668.current_mKind (HERE).enumValue ()) {
        ...
        case GALGAS_methodKind::Enumeration::enum_definedAsMember :
          {
            const enumGalgasBool test_56 = GALGAS_bool (ComparisonKind::equal, enumerator_16668.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualAbstract (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 344)))).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_16668.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 344)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 344)).operator_or (GALGAS_bool (ComparisonKind::equal, enumerator_16668.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasicFinal (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 344)))) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 344)).boolEnum () ;
            switch (test_56) {
            case kBoolTrue : {
              result.appendString ("  public: VIRTUAL_IN_DEBUG class GALGAS_") ;
              result.appendString (extensionGetter_identifierRepresentation (enumerator_16668.current_mReturnedType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 345)).stringValue ()) ;
              result.appendString (" getter_") ;
              result.appendString (enumerator_16668.current_lkey (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 345)).stringValue ()) ;
              result.appendString (" (") ;
              columnMarker = result.currentColumn () ;
              GALGAS_uint index_17194_IDX (0) ;
              if (enumerator_16668.current_mArgumentTypeList (HERE).isValid ()) {
                cEnumerator_functionSignature enumerator_17194 (enumerator_16668.current_mArgumentTypeList (HERE), EnumerationOrder::up) ;
                while (enumerator_17194.hasCurrentObject ()) {
                  result.appendString ("const class GALGAS_") ;
                  result.appendString (extensionGetter_identifierRepresentation (enumerator_17194.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 347)).stringValue ()) ;
                  result.appendString (" & constinOperand") ;
                  result.appendString (index_17194_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 347)).stringValue ()) ;
                  if (enumerator_17194.hasNextObject ()) {
                    result.appendString (",\n") ;
                    result.appendSpacesUntilColumn (columnMarker) ;
                  }
                  index_17194_IDX.increment () ;
                  enumerator_17194.gotoNextObject () ;
                }
              }
              const enumGalgasBool test_57 = GALGAS_bool (ComparisonKind::equal, enumerator_16668.current_mArgumentTypeList (HERE).getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 350)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              switch (test_57) {
              case kBoolTrue : {
                const enumGalgasBool test_58 = enumerator_16668.current_mHasCompilerArgument (HERE).boolEnum () ;
                switch (test_58) {
                case kBoolTrue : {
                  result.appendString ("Compiler * inCompiler\n") ;
                  result.appendSpacesUntilColumn (columnMarker) ;
              ...
              case kBoolFalse : {
                const enumGalgasBool test_59 = enumerator_16668.current_mHasCompilerArgument (HERE).boolEnum () ;
                switch (test_59) {
                case kBoolTrue : {
                  result.appendString (",\n") ;
                  result.appendSpacesUntilColumn (columnMarker) ;
  ...
  if (in_READ_5F_SUBSCRIPT_5F_MAP.isValid ()) {
    cEnumerator_subscriptMap enumerator_17915 (in_READ_5F_SUBSCRIPT_5F_MAP, EnumerationOrder::up) ;
    while (enumerator_17915.hasCurrentObject ()) {
      result.appendString ("  public: VIRTUAL_IN_DEBUG class GALGAS_") ;
      result.appendString (extensionGetter_identifierRepresentation (enumerator_17915.current_valueType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 373)).stringValue ()) ;
      result.appendString (" readSubscript_") ;
      result.appendString (enumerator_17915.current_lkey (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 374)).stringValue ()) ;
      result.appendString (" (") ;
      columnMarker = result.currentColumn () ;
      GALGAS_uint index_18143_IDX (0) ;
      if (enumerator_17915.current_argumentTypeList (HERE).isValid ()) {
        cEnumerator_functionSignature enumerator_18143 (enumerator_17915.current_argumentTypeList (HERE), EnumerationOrder::up) ;
        while (enumerator_18143.hasCurrentObject ()) {
          result.appendString ("const class GALGAS_") ;
          result.appendString (extensionGetter_identifierRepresentation (enumerator_18143.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 376)).stringValue ()) ;
          result.appendString (" & in") ;
          result.appendString (index_18143_IDX.getter_string (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 376)).stringValue ()) ;
          result.appendString (",\n") ;
          result.appendSpacesUntilColumn (columnMarker) ;
          index_18143_IDX.increment () ;
  ...
  const enumGalgasBool test_60 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_generateEnumerationHelperMethods (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 385)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 385)).boolEnum () ;
  switch (test_60) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_61 = in_SUPPORTED_5F_OPERATORS.getter_contains (GALGAS_typeFeatures::class_func_supportWithAccessor (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 391)) COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 391)).boolEnum () ;
  switch (test_61) {
  case kBoolTrue : {
  ...
  case kBoolTrue : {
    ...
    result.appendString (extensionGetter_identifierRepresentation (in_ENUMERATED_5F_OBJECT_5F_TYPE, inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 399)).stringValue ()) ;
  ...
  const enumGalgasBool test_63 = GALGAS_bool (ComparisonKind::greaterThan, in_ENUMERATION_5F_DESCRIPTOR_5F_LIST.getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 404)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
  switch (test_63) {
  case kBoolTrue : {
  ...
  const enumGalgasBool test_64 = GALGAS_bool (ComparisonKind::greaterThan, in_ENUMERATION_5F_DESCRIPTOR_5F_LIST.getter_count (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 411)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
  switch (test_64) {
  case kBoolTrue : {
    ...
    GALGAS_uint index_20247_ (0) ;
    if (in_ENUMERATION_5F_DESCRIPTOR_5F_LIST.isValid ()) {
      cEnumerator_enumerationDescriptorList enumerator_20247 (in_ENUMERATION_5F_DESCRIPTOR_5F_LIST, EnumerationOrder::up) ;
      while (enumerator_20247.hasCurrentObject ()) {
        result.appendString ("  public: class GALGAS_") ;
        result.appendString (extensionGetter_identifierRepresentation (enumerator_20247.current_mEnumeratedType (HERE), inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 422)).stringValue ()) ;
        result.appendString (" current_") ;
        result.appendString (enumerator_20247.current_mEnumerationName (HERE).getter_identifierRepresentation (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 422)).stringValue ()) ;
        result.appendString (" (LOCATION_ARGS) const ;\n") ;
        index_20247_.increment () ;
        enumerator_20247.gotoNextObject () ;
      }
    }
    const enumGalgasBool test_65 = in_ENUMERATED_5F_OBJECT_5F_TYPE.getter_null (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 424)).operator_not (SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 424)).boolEnum () ;
    switch (test_65) {
    case kBoolTrue : {
      result.appendString ("//--- Current element access\n  public: class GALGAS_") ;
      result.appendString (extensionGetter_identifierRepresentation (in_ENUMERATED_5F_OBJECT_5F_TYPE, inCompiler COMMA_SOURCE_FILE ("unified-class-body-for-type.h.galgasTemplate", 426)).stringValue ()) ;
...
GALGAS_string filewrapperTemplate_typeGenerationTemplate_genericTypeImplementation (Compiler * inCompiler,
  ...
  result.appendString ("\",\n                       ") ;
  result.appendSpacesUntilColumn (columnMarker) ;
  const enumGalgasBool test_0 = in_SUPER_5F_TYPE_5F_INDEX.getter_null (SOURCE_FILE ("generic-type.cpp.galgasTemplate", 8)).boolEnum () ;
  switch (test_0) {
  case kBoolTrue : {
...
GALGAS_string cPtr_semanticTypeForGeneration::getter_appendTypeGenericImplementation (Compiler * inCompiler
  ...
  GALGAS_unifiedTypeDefinition var_selfTypeDefinition_40819 = extensionGetter_definition (temp_0.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1007)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (ComparisonKind::equal, var_selfTypeDefinition_40819.readProperty_typeKind ().objectCompare (GALGAS_typeKindEnum::class_func_packageType (SOURCE_FILE ("semanticGeneration.galgas", 1008)))).boolEnum () ;
    if (kBoolTrue == test_1) {
...
void routine_recursivlyEnumerateRegularFile_3F__3F__26__26__26__26_ (const GALGAS_wrapperFileMap constinArgument_inFilewrapperFileMap,
  ...
  cEnumerator_wrapperFileMap enumerator_47772 (constinArgument_inFilewrapperFileMap, EnumerationOrder::up) ;
  while (enumerator_47772.hasCurrentObject ()) {
    ...
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_47772.current_mIsTextFile (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        ioArgument_ioRegularTextContentIndexStringList.addAssign_operation (enumerator_47772.current_mWrapperFileIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1194))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1194)) ;
      }
    }
    if (kBoolFalse == test_0) {
      ioArgument_ioRegularBinaryContentIndexStringList.addAssign_operation (enumerator_47772.current_mWrapperFileIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1196))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1196)) ;
    }
    enumerator_47772.gotoNextObject () ;
  }
  cEnumerator_wrapperDirectoryMap enumerator_48135 (constinArgument_inFilewrapperDirectoryMap, EnumerationOrder::up) ;
  while (enumerator_48135.hasCurrentObject ()) {
    {
    routine_recursivlyEnumerateRegularFile_3F__3F__26__26__26__26_ (enumerator_48135.current_mRegularFileMap (HERE), enumerator_48135.current_mDirectoryMap (HERE), ioArgument_ioRegularFileIndexStringList, ioArgument_ioDirectoryIndexStringList, ioArgument_ioRegularTextContentIndexStringList, ioArgument_ioRegularBinaryContentIndexStringList, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1200)) ;
    }
...
void cPtr_filewrapperDeclarationForGeneration::method_appendDeclaration_31_ (GALGAS_stringset & /* ioArgument_ioInclusionSet */,
                                                                             ...
                                                                             Compiler * inCompiler
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist var_regularFileIndexStringList_48666 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
  GALGAS_stringlist var_regularBinaryContentIndexStringList_48716 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
  GALGAS_stringlist var_regularTextContentIndexStringList_48775 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
  GALGAS_stringlist var_directoryIndexStringList_48832 = GALGAS_stringlist::init (inCompiler COMMA_HERE) ;
  {
  const GALGAS_filewrapperDeclarationForGeneration temp_0 = this ;
  const GALGAS_filewrapperDeclarationForGeneration temp_1 = this ;
  routine_recursivlyEnumerateRegularFile_3F__3F__26__26__26__26_ (temp_0.readProperty_mFilewrapperFileMap (), temp_1.readProperty_mFilewrapperDirectoryMap (), var_regularFileIndexStringList_48666, var_directoryIndexStringList_48832, var_regularTextContentIndexStringList_48775, var_regularBinaryContentIndexStringList_48716, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1220)) ;
  }
  const GALGAS_filewrapperDeclarationForGeneration temp_2 = this ;
  outArgument_outHeader = GALGAS_string (filewrapperTemplate_semanticComponentGenerationTemplate_filewrapperDeclaration (inCompiler, var_regularFileIndexStringList_48666, var_directoryIndexStringList_48832, var_regularTextContentIndexStringList_48775, var_regularBinaryContentIndexStringList_48716, temp_2.readProperty_mFilewrapperName () COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1228))) ;
  const GALGAS_filewrapperDeclarationForGeneration temp_3 = this ;
  cEnumerator_filewrapperTemplateListForGeneration enumerator_49482 (temp_3.readProperty_mFilewrapperTemplateListForGeneration (), EnumerationOrder::up) ;
  while (enumerator_49482.hasCurrentObject ()) {
    const GALGAS_filewrapperDeclarationForGeneration temp_4 = this ;
    outArgument_outHeader.plusAssign_operation(GALGAS_string (filewrapperTemplate_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inCompiler, temp_4.readProperty_mFilewrapperName (), enumerator_49482.current_mFilewrapperTemplateName (HERE), enumerator_49482.current_mFilewrapperTemplateFormalInputParameters (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1237))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1237)) ;
...
void routine_generateWrapperContents_3F__3F__3F__3F__3F__26_ (const GALGAS_string constinArgument_inFilewrapperName,
                                                              ...
                                                              Compiler * inCompiler
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_wrapperFileMap enumerator_50205 (constinArgument_inFilewrapperRegularFileMap, EnumerationOrder::up) ;
  while (enumerator_50205.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_50205.current_mIsTextFile (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_contents_50292 = GALGAS_string::class_func_stringWithContentsOfFile (enumerator_50205.current_mAbsoluteFilePath (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1257)) ;
        ioArgument_ioImplementation.plusAssign_operation(GALGAS_string ("//--- File '").add_operation (constinArgument_inFilewrapperDirectory, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1258)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1258)).add_operation (enumerator_50205.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1258)).add_operation (GALGAS_string ("'\n\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1258)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1258)) ;
        ...
        ioArgument_ioImplementation.plusAssign_operation(enumerator_50205.current_mWrapperFileIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1260)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1260)) ;
        ...
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (ComparisonKind::greaterThan, var_contents_50292.getter_count (SOURCE_FILE ("semanticGeneration.galgas", 1264)).objectCompare (GALGAS_uint (uint32_t (100U)))).boolEnum () ;
          if (kBoolTrue == test_1) {
            GALGAS_stringlist var_components_50744 = var_contents_50292.getter_componentsSeparatedByString (GALGAS_string ("\n") COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1265)) ;
            GALGAS_string var_lastLine_50837 ;
            {
            var_components_50744.setter_popLast (var_lastLine_50837, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1266)) ;
            }
            cEnumerator_stringlist enumerator_50860 (var_components_50744, EnumerationOrder::up) ;
            const bool bool_2 = true ;
            if (enumerator_50860.hasCurrentObject () && bool_2) {
              ioArgument_ioImplementation.plusAssign_operation(GALGAS_string ("\n  "), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1269)) ;
              while (enumerator_50860.hasCurrentObject () && bool_2) {
                GALGAS_string var_s_50956 = enumerator_50860.current_mValue (HERE).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1271)) ;
                ioArgument_ioImplementation.plusAssign_operation(var_s_50956.getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("semanticGeneration.galgas", 1272)).add_operation (GALGAS_string ("\n  "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1272)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1272)) ;
                enumerator_50860.gotoNextObject () ;
              }
            }
            enumGalgasBool test_3 = kBoolTrue ;
            if (kBoolTrue == test_3) {
              test_3 = GALGAS_bool (ComparisonKind::greaterThan, var_lastLine_50837.getter_count (SOURCE_FILE ("semanticGeneration.galgas", 1274)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
              if (kBoolTrue == test_3) {
                ioArgument_ioImplementation.plusAssign_operation(var_lastLine_50837.getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("semanticGeneration.galgas", 1275)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1275)) ;
              }
            }
          }
        }
        if (kBoolFalse == test_1) {
          ioArgument_ioImplementation.plusAssign_operation(var_contents_50292.getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("semanticGeneration.galgas", 1278)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1278)) ;
        }
        ioArgument_ioImplementation.plusAssign_operation(GALGAS_string (" ;\n\nconst cRegularFileWrapper gWrapperFile_"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1280)) ;
        ioArgument_ioImplementation.plusAssign_operation(enumerator_50205.current_mWrapperFileIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1281)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1281)) ;
        ...
        ioArgument_ioImplementation.plusAssign_operation(enumerator_50205.current_lkey (HERE).readProperty_string ().getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("semanticGeneration.galgas", 1285)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1285)) ;
        ioArgument_ioImplementation.plusAssign_operation(GALGAS_string (",\n  "), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1286)) ;
        ioArgument_ioImplementation.plusAssign_operation(enumerator_50205.current_lkey (HERE).readProperty_string ().getter_pathExtension (SOURCE_FILE ("semanticGeneration.galgas", 1287)).getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("semanticGeneration.galgas", 1287)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1287)) ;
        ioArgument_ioImplementation.plusAssign_operation(GALGAS_string (",\n  true, // Text file\n "), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1288)) ;
        ioArgument_ioImplementation.plusAssign_operation(var_contents_50292.getter_count (SOURCE_FILE ("semanticGeneration.galgas", 1289)).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1289)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1289)) ;
        ...
        ioArgument_ioImplementation.plusAssign_operation(enumerator_50205.current_mWrapperFileIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1291)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1291)) ;
  ...
  cEnumerator_wrapperDirectoryMap enumerator_54369 (constinArgument_inFilewrapperDirectoryMap, EnumerationOrder::up) ;
  while (enumerator_54369.hasCurrentObject ()) {
    ioArgument_ioImplementation.plusAssign_operation(GALGAS_string ("  & gWrapperDirectory_").add_operation (enumerator_54369.current_mWrapperDirectoryIndex (HERE).getter_string (SOURCE_FILE ("semanticGeneration.galgas", 1339)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1339)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1339)).add_operation (constinArgument_inFilewrapperName.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 1339)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1339)).add_operation (GALGAS_string (",\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1339)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1339)) ;
    enumerator_54369.gotoNextObject () ;
  }
...
void cPtr_filewrapperDeclarationForGeneration::method_appendSpecificImplementation (const GALGAS_unifiedTypeMap /* constinArgument_inTypeMap */,
  ...
  GALGAS_string var_filewrapperImplementation_55726 = GALGAS_string::makeEmptyString () ;
  {
  const GALGAS_filewrapperDeclarationForGeneration temp_1 = this ;
  const GALGAS_filewrapperDeclarationForGeneration temp_2 = this ;
  const GALGAS_filewrapperDeclarationForGeneration temp_3 = this ;
  routine_generateWrapperContents_3F__3F__3F__3F__3F__26_ (temp_1.readProperty_mFilewrapperName (), GALGAS_string::makeEmptyString (), GALGAS_uint (uint32_t (0U)), temp_2.readProperty_mFilewrapperFileMap (), temp_3.readProperty_mFilewrapperDirectoryMap (), var_filewrapperImplementation_55726, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1363)) ;
  }
  const GALGAS_filewrapperDeclarationForGeneration temp_4 = this ;
  outArgument_outImplementation = GALGAS_string (filewrapperTemplate_semanticComponentGenerationTemplate_filewrapperImplementation (inCompiler, temp_4.readProperty_mFilewrapperName (), var_filewrapperImplementation_55726 COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1371))) ;
  const GALGAS_filewrapperDeclarationForGeneration temp_5 = this ;
  cEnumerator_filewrapperTemplateListForGeneration enumerator_56186 (temp_5.readProperty_mFilewrapperTemplateListForGeneration (), EnumerationOrder::up) ;
  while (enumerator_56186.hasCurrentObject ()) {
    GALGAS_string var_generatedCodeForInstructionList_56339 = GALGAS_string::makeEmptyString () ;
    GALGAS_uint var_temporaryVariableIndex_56390 = GALGAS_uint (uint32_t (0U)) ;
    GALGAS_stringset var_unusedVariableCppNameSet_56436 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
    var_unusedVariableCppNameSet_56436.addAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1381))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1381)) ;
    cEnumerator_formalInputParameterListForGeneration enumerator_56556 (enumerator_56186.current_mFilewrapperTemplateFormalInputParameters (HERE), EnumerationOrder::up) ;
    while (enumerator_56556.hasCurrentObject ()) {
      var_unusedVariableCppNameSet_56436.addAssign_operation (enumerator_56556.current_mFormalArgumentCppName (HERE)  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1383)) ;
      enumerator_56556.gotoNextObject () ;
    }
    GALGAS_bool var_useColumnMarker_56687 = GALGAS_bool (false) ;
    {
    routine_templateCodeGenerationForListInstruction_3F__26__26__26__26__26_ (enumerator_56186.current_mTemplateInstructionListForGeneration (HERE), var_generatedCodeForInstructionList_56339, ioArgument_ioInclusionSet, var_temporaryVariableIndex_56390, var_unusedVariableCppNameSet_56436, var_useColumnMarker_56687, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1386)) ;
    }
    const GALGAS_filewrapperDeclarationForGeneration temp_6 = this ;
    outArgument_outImplementation.plusAssign_operation(GALGAS_string (filewrapperTemplate_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inCompiler, temp_6.readProperty_mFilewrapperName (), enumerator_56186.current_mFilewrapperTemplateName (HERE), enumerator_56186.current_mFilewrapperTemplateFormalInputParameters (HERE), var_unusedVariableCppNameSet_56436, var_useColumnMarker_56687, var_generatedCodeForInstructionList_56339 COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1395))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1395)) ;
    enumerator_56186.gotoNextObject () ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
GALGAS_string cPtr_primitiveTypeForGeneration::getter_appendPrimitiveTypeDeclaration (Compiler * inCompiler
  ...
  GALGAS_unifiedTypeDefinition var_selfTypeDefinition_58179 = extensionGetter_definition (temp_1.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1425)) ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      ...
      result_result.plusAssign_operation(GALGAS_string (filewrapperTemplate_typeGenerationTemplate_unifiedClassBodyForPackage (inCompiler, var_selfTypeDefinition_58179.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_4.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1429)), var_selfTypeDefinition_58179.readProperty_classFunctionMap (), var_selfTypeDefinition_58179.readProperty_classMethodMap () COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1427))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1427)) ;
    }
  }
  if (kBoolFalse == test_2) {
    const GALGAS_primitiveTypeForGeneration temp_5 = this ;
    result_result.plusAssign_operation(GALGAS_string (filewrapperTemplate_typeGenerationTemplate_unifiedClassBodyForType (inCompiler, var_selfTypeDefinition_58179.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_5.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1436)), var_selfTypeDefinition_58179.readProperty_isConcrete (), var_selfTypeDefinition_58179.readProperty_initializerMap (), var_selfTypeDefinition_58179.readProperty_classFunctionMap (), var_selfTypeDefinition_58179.readProperty_getterMap (), var_selfTypeDefinition_58179.readProperty_setterMap (), var_selfTypeDefinition_58179.readProperty_instanceMethodMap (), var_selfTypeDefinition_58179.readProperty_classMethodMap (), var_selfTypeDefinition_58179.readProperty_readSubscriptMap (), var_selfTypeDefinition_58179.readProperty_enumerationDescriptorList (), var_selfTypeDefinition_58179.readProperty_features (), var_selfTypeDefinition_58179.readProperty_addAssignOperatorArguments (), var_selfTypeDefinition_58179.readProperty_typeForEnumeratedElement (), var_selfTypeDefinition_58179.readProperty_supportCollectionValue () COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1434))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1434)) ;
  }
//---
  return result_result ;
}
...
void routine_generatePredefinedTypeFiles_3F__3F__26__26__26_ (const GALGAS_string constinArgument_inDirectory,
                                                              ...
                                                              Compiler * inCompiler
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_generatedCode_60006 = GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1470))) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_60107 (constinArgument_inSemanticDeclarationListForGeneration, EnumerationOrder::up) ;
  while (enumerator_60107.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_60107.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1472)).boolEnum () ;
      if (kBoolTrue == test_0) {
        callExtensionMethod_appendPrimitiveTypePreDeclaration ((cPtr_semanticDeclarationForGeneration *) enumerator_60107.current_mDeclaration (HERE).ptr (), var_generatedCode_60006, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1473)) ;
      }
    }
    enumerator_60107.gotoNextObject () ;
  }
  var_generatedCode_60006.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1476)) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_60324 (constinArgument_inSemanticDeclarationListForGeneration, EnumerationOrder::up) ;
  while (enumerator_60324.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_60324.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1478)).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generatedCode_60006.plusAssign_operation(callExtensionGetter_appendPrimitiveTypeDeclaration ((const cPtr_semanticDeclarationForGeneration *) enumerator_60324.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1479)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1479)) ;
      }
    }
    enumerator_60324.gotoNextObject () ;
  }
  cEnumerator_semanticDeclarationListForGeneration enumerator_60515 (constinArgument_inSemanticDeclarationListForGeneration, EnumerationOrder::up) ;
  while (enumerator_60515.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_60515.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1483)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_stringset joker_60653 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        GALGAS_string var_code_60678 ;
        callExtensionMethod_appendDeclaration_31_ ((cPtr_semanticDeclarationForGeneration *) enumerator_60515.current_mDeclaration (HERE).ptr (), joker_60653, var_code_60678, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1484)) ;
        var_generatedCode_60006.plusAssign_operation(var_code_60678, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1485)) ;
      }
    }
    enumerator_60515.gotoNextObject () ;
  }
  var_generatedCode_60006.plusAssign_operation(GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_predefinedTypeSeparation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1488))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1488)) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_60826 (constinArgument_inSemanticDeclarationListForGeneration, EnumerationOrder::up) ;
  while (enumerator_60826.hasCurrentObject ()) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_60826.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1490)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_stringset joker_60977 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        GALGAS_string var_headerString_32__61002 ;
        callExtensionMethod_appendDeclaration_32_ ((cPtr_semanticDeclarationForGeneration *) enumerator_60826.current_mDeclaration (HERE).ptr (), constinArgument_inDirectory, joker_60977, var_headerString_32__61002, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1491)) ;
        var_generatedCode_60006.plusAssign_operation(var_headerString_32__61002, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1492)) ;
      }
    }
    enumerator_60826.gotoNextObject () ;
  }
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    ...
    if (kBoolTrue == test_4) {
      ...
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inDirectory, GALGAS_string ("all-predefined-types.h"), GALGAS_string ("//"), GALGAS_string::makeEmptyString (), GALGAS_string ("\n\n"), var_generatedCode_60006, GALGAS_string ("\n\n"), GALGAS_string::makeEmptyString (), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1498)) ;
      }
    }
  }
  var_generatedCode_60006 = GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_predefinedTypesImplementation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1511))) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_61768 (constinArgument_inSemanticDeclarationListForGeneration, EnumerationOrder::up) ;
  while (enumerator_61768.hasCurrentObject ()) {
    enumGalgasBool test_5 = kBoolTrue ;
    if (kBoolTrue == test_5) {
      test_5 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_61768.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1513)).boolEnum () ;
      if (kBoolTrue == test_5) {
        var_generatedCode_60006.plusAssign_operation(callExtensionGetter_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_61768.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1514)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1514)) ;
        GALGAS_stringset joker_61991 = GALGAS_stringset::init (inCompiler COMMA_HERE) ;
        GALGAS_string var_code_62016 ;
        callExtensionMethod_appendSpecificImplementation ((cPtr_semanticDeclarationForGeneration *) enumerator_61768.current_mDeclaration (HERE).ptr (), GALGAS_unifiedTypeMap::init (inCompiler COMMA_HERE), joker_61991, var_code_62016, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1515)) ;
        var_generatedCode_60006.plusAssign_operation(var_code_62016, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1516)) ;
      }
    }
