...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_parentDirectory_4001 = constinArgument_inSourceFile.mAttribute_string.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 66)).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 66)) ;
  ...
  GALGAS_stringlist var_candidateProjectFiles_4123 = var_parentDirectory_4001.getter_regularFilesWithExtensions (GALGAS_bool (false), temp_0 COMMA_SOURCE_FILE ("galgas_prgm.galgas", 67)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_candidateProjectFiles_4123.getter_length (SOURCE_FILE ("galgas_prgm.galgas", 68)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    ...
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_candidateProjectFiles_4123.getter_length (SOURCE_FILE ("galgas_prgm.galgas", 70)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s_4379 = GALGAS_string ("several project files in source file parent directory:") ;
      cEnumerator_stringlist enumerator_4474 (var_candidateProjectFiles_4123, kEnumeration_up) ;
      while (enumerator_4474.hasCurrentObject ()) {
        var_s_4379.plusAssign_operation(GALGAS_string ("\n"
          "  - ").add_operation (enumerator_4474.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 73)), inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 73)) ;
      ...
      inCompiler->emitSemanticError (location_4, var_s_4379  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 75)) ;
    }else if (kBoolFalse == test_3) {
      GALGAS_string var_projectFilePath_4572 = var_parentDirectory_4001.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 77)).add_operation (var_candidateProjectFiles_4123.getter_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 77)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 77)) ;
      {
      routine_parseAndAnalyzeProject (GALGAS_lstring::constructor_new (var_projectFilePath_4572, constinArgument_inSourceFile.mAttribute_location  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 78)), constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 78)) ;
      }
    }
  }
}
...
static void routine_programRule_5F__31_ (const GALGAS_lstring constinArgument_inSourceFile,
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_templateInstructionListAST joker_5525 ; // Joker input parameter
  cGrammar_templateGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, joker_5525  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 92)) ;
}
