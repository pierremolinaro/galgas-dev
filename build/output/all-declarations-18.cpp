...
typeComparisonResult cPtr_poisonInstructionAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_poisonInstructionAST * p = (const cPtr_poisonInstructionAST *) inOperandPtr ;
  macroValidSharedObject (p, cPtr_poisonInstructionAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mInstructionLocation.objectCompare (p->mAttribute_mInstructionLocation) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_poisonInstructionAST::objectCompare (const GALGAS_poisonInstructionAST & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const int32_t mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const int32_t operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_poisonInstructionAST::GALGAS_poisonInstructionAST (void) :
GALGAS_semanticInstructionAST () {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_poisonInstructionAST GALGAS_poisonInstructionAST::constructor_default (LOCATION_ARGS) {
  return GALGAS_poisonInstructionAST::constructor_new (GALGAS_location::constructor_nowhere (HERE),
                                                       GALGAS_lstringlist::constructor_emptyList (HERE),
                                                       GALGAS_lstringlist::constructor_emptyList (HERE)
                                                       COMMA_THERE) ;
}
...
GALGAS_poisonInstructionAST::GALGAS_poisonInstructionAST (const cPtr_poisonInstructionAST * inSourcePtr) :
GALGAS_semanticInstructionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_poisonInstructionAST) ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_poisonInstructionAST GALGAS_poisonInstructionAST::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                          const GALGAS_lstringlist & inAttribute_mPoisonVariableList,
                                                                          const GALGAS_lstringlist & inAttribute_mAffectedVariableList
                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_poisonInstructionAST result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mPoisonVariableList.isValid () && inAttribute_mAffectedVariableList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_poisonInstructionAST (inAttribute_mInstructionLocation, inAttribute_mPoisonVariableList, inAttribute_mAffectedVariableList COMMA_THERE)) ;
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_poisonInstructionAST::getter_mPoisonVariableList (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
    const cPtr_poisonInstructionAST * p = (const cPtr_poisonInstructionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_poisonInstructionAST) ;
...
GALGAS_lstringlist cPtr_poisonInstructionAST::getter_mPoisonVariableList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPoisonVariableList ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_lstringlist GALGAS_poisonInstructionAST::getter_mAffectedVariableList (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
    const cPtr_poisonInstructionAST * p = (const cPtr_poisonInstructionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_poisonInstructionAST) ;
...
GALGAS_lstringlist cPtr_poisonInstructionAST::getter_mAffectedVariableList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAffectedVariableList ;
}

//---------------------------------------------------------------------------------------------------------------------*
//                                    Pointer class for @poisonInstructionAST class                                    *
//---------------------------------------------------------------------------------------------------------------------*

cPtr_poisonInstructionAST::cPtr_poisonInstructionAST (const GALGAS_location & in_mInstructionLocation,
                                                      const GALGAS_lstringlist & in_mPoisonVariableList,
                                                      const GALGAS_lstringlist & in_mAffectedVariableList
                                                      COMMA_LOCATION_ARGS) :
cPtr_semanticInstructionAST (in_mInstructionLocation COMMA_THERE),
...
const C_galgas_type_descriptor * cPtr_poisonInstructionAST::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_poisonInstructionAST ;
}

void cPtr_poisonInstructionAST::description (C_String & ioString,
                                             const int32_t inIndentation) const {
  ioString << "[@poisonInstructionAST:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
acPtr_class * cPtr_poisonInstructionAST::duplicate (LOCATION_ARGS) const {
  acPtr_class * ptr = NULL ;
  macroMyNew (ptr, cPtr_poisonInstructionAST (mAttribute_mInstructionLocation, mAttribute_mPoisonVariableList, mAttribute_mAffectedVariableList COMMA_THERE)) ;
  return ptr ;
}
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                             @poisonInstructionAST type                                              *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_poisonInstructionAST ("poisonInstructionAST",
                                             & kTypeDescriptor_GALGAS_semanticInstructionAST) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_poisonInstructionAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_poisonInstructionAST ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_poisonInstructionAST::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_poisonInstructionAST (*this)) ;
  }
  return result ;
}
...
GALGAS_poisonInstructionAST GALGAS_poisonInstructionAST::extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_poisonInstructionAST result ;
  const GALGAS_poisonInstructionAST * p = (const GALGAS_poisonInstructionAST *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_poisonInstructionAST *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("poisonInstructionAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_templateExpressionAST GALGAS_templateCategoryTemplateCallAST::getter_mExpressionValue (UNUSED_LOCATION_ARGS) const {
  GALGAS_templateExpressionAST result ;
  if (NULL != mObjectPtr) {
...
GALGAS_templateExpressionAST cPtr_templateCategoryTemplateCallAST::getter_mExpressionValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExpressionValue ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_lstring GALGAS_templateCategoryTemplateCallAST::getter_mTemplateName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_templateCategoryTemplateCallAST * p = (const cPtr_templateCategoryTemplateCallAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_templateCategoryTemplateCallAST) ;
...
GALGAS_lstring cPtr_templateCategoryTemplateCallAST::getter_mTemplateName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTemplateName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_templateExpressionListAST GALGAS_templateCategoryTemplateCallAST::getter_mOutExpressionList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_templateExpressionListAST cPtr_templateCategoryTemplateCallAST::getter_mOutExpressionList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_lstring GALGAS_templateClassToTypeOperandAST::getter_mTypeName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstring cPtr_templateClassToTypeOperandAST::getter_mTypeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTypeName ;
}
...
GALGAS_lstring GALGAS_templateFileWrapperWithStaticPathAST::getter_mFileWrapperName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstring cPtr_templateFileWrapperWithStaticPathAST::getter_mFileWrapperName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFileWrapperName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_uint GALGAS_templateFileWrapperWithStaticPathAST::getter_mFileIndex (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_templateFileWrapperWithStaticPathAST * p = (const cPtr_templateFileWrapperWithStaticPathAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_templateFileWrapperWithStaticPathAST) ;
...
GALGAS_uint cPtr_templateFileWrapperWithStaticPathAST::getter_mFileIndex (UNUSED_LOCATION_ARGS) const {
...
GALGAS_location GALGAS_templateIfThenElseExpressionAST::getter_mOperatorLocation (UNUSED_LOCATION_ARGS) const {
  GALGAS_location result ;
  if (NULL != mObjectPtr) {
...
GALGAS_location cPtr_templateIfThenElseExpressionAST::getter_mOperatorLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOperatorLocation ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_templateExpressionAST GALGAS_templateIfThenElseExpressionAST::getter_mIfExpression (UNUSED_LOCATION_ARGS) const {
  GALGAS_templateExpressionAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_templateIfThenElseExpressionAST * p = (const cPtr_templateIfThenElseExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_templateIfThenElseExpressionAST) ;
...
GALGAS_templateExpressionAST cPtr_templateIfThenElseExpressionAST::getter_mIfExpression (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIfExpression ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_templateExpressionAST GALGAS_templateIfThenElseExpressionAST::getter_mThenExpression (UNUSED_LOCATION_ARGS) const {
  GALGAS_templateExpressionAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_templateIfThenElseExpressionAST * p = (const cPtr_templateIfThenElseExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_templateIfThenElseExpressionAST) ;
...
GALGAS_templateExpressionAST cPtr_templateIfThenElseExpressionAST::getter_mThenExpression (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mThenExpression ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_templateExpressionAST GALGAS_templateIfThenElseExpressionAST::getter_mElseExpression (UNUSED_LOCATION_ARGS) const {
  GALGAS_templateExpressionAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_templateIfThenElseExpressionAST * p = (const cPtr_templateIfThenElseExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_templateIfThenElseExpressionAST) ;
...
GALGAS_templateExpressionAST cPtr_templateIfThenElseExpressionAST::getter_mElseExpression (UNUSED_LOCATION_ARGS) const {
