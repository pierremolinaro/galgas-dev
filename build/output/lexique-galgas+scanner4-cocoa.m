...
static const C_cocoa_lexique_table_entry ktable_for_galgasScanner_34__attributeKeyWordList [39] = {
  ...
  {"noArgumentLabel", galgasScanner4_1__25_noArgumentLabel},
...
static NSInteger search_into_galgasScanner_34__attributeKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_galgasScanner_34__attributeKeyWordList, 39) ;
}
...
static const C_cocoa_lexique_table_entry ktable_for_galgasScanner_34__galgasKeyWordList [82] = {
...
static NSInteger search_into_galgasScanner_34__galgasKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_galgasScanner_34__galgasKeyWordList, 82) ;
}
...
- (BOOL) internalParseLexicalTokenForLexicalColoring {
  ...
  if (scanningOk && ([self testForCharWithFunction: isUnicodeLetter])) {
    ...
    mTokenCode = galgasScanner4_1__A7__A7_ ;
  }else if (scanningOk && [self testForInputString:@"||" advance:YES]) {
...
- (NSUInteger) styleIndexForTerminal: (NSInteger) inTerminal {
  static const NSUInteger kTerminalSymbolStyles [191] = {0,
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [191] = {NO,
    ...
    YES /* galgasScanner4_1__25_noArgumentLabel */,
