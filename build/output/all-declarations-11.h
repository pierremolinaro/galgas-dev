...
//--- 'parse' label
  public : virtual void nt_JSON_5F_text_parse (C_Lexique_jsonScanner * inCompiler) ;

//----------- '' label
  public : virtual void nt_JSON_5F_text_ (GALGAS_jsonValue & outArgument0,
                                          C_Lexique_jsonScanner * inCompiler) ;

//--- Start symbol
  public : static void _performSourceFileParsing_ (C_Compiler * inCompiler,
                                                   GALGAS_lstring inFileName,
                                                   GALGAS_jsonValue & outArgument0
                                                   COMMA_LOCATION_ARGS) ;
...
//------------------------------------- 'array' non terminal
//--- 'parse' label
  public : virtual void nt_array_parse (C_Lexique_jsonScanner * inCompiler) ;

//----------- '' label
  public : virtual void nt_array_ (GALGAS_jsonArrayValue & outArgument0,
                                   C_Lexique_jsonScanner * inCompiler) ;

//------------------------------------- 'object' non terminal
//--- 'parse' label
  public : virtual void nt_object_parse (C_Lexique_jsonScanner * inCompiler) ;

//----------- '' label
  public : virtual void nt_object_ (GALGAS_jsonObjectValue & outArgument0,
                                    C_Lexique_jsonScanner * inCompiler) ;

//------------------------------------- 'value' non terminal
//--- 'parse' label
  public : virtual void nt_value_parse (C_Lexique_jsonScanner * inCompiler) ;

//----------- '' label
  public : virtual void nt_value_ (GALGAS_jsonValue & outArgument0,
                                   C_Lexique_jsonScanner * inCompiler) ;

  public : virtual int32_t select_jsonSyntax_0 (C_Lexique_jsonScanner *) ;

  public : virtual int32_t select_jsonSyntax_1 (C_Lexique_jsonScanner *) ;

  public : virtual int32_t select_jsonSyntax_2 (C_Lexique_jsonScanner *) ;
} ;
