...
let galgasScanner4_1__25_searchMethodAndGetter : UInt16 = 141
...
class SWIFT_Lexique_galgasScanner4 : SWIFT_Lexique {
  ...
  func styleIndexFor (token inTokenIndex : UInt16) -> UInt8 {
    let kTerminalSymbolStyles : [UInt8] = [
      ...
      11, // 130 : galgasScanner4_1__25_MacOS
      11, // 131 : galgasScanner4_1__25_MacSwiftApp
      11, // 132 : galgasScanner4_1__25_MacOSDeployment
      ...
      11, // 141 : galgasScanner4_1__25_searchMethodAndGetter
  ...
  func atomicSelectionFor (token inTokenIndex : UInt16) -> Bool {
    let kTerminalAtomicSelection : [Bool] = [
      ...
      true, // 141 : galgasScanner4_1__25_searchMethodAndGetter
