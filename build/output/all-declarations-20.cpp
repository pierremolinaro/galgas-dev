...
void extensionMethod_generateAtPath (const GGS_XcodeProjectDescriptor inObject,
  ...
  GGS_string var_projectCoreFile_18683 = constinArgument_inPath.add_operation (GGS_string ("/project.pbxproj"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectGeneration.galgas", 479)) ;
  GalgasBool test_23 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_23) {
    GGS_bool test_24 = var_projectCoreFile_18683.getter_fileExists (SOURCE_FILE ("XcodeProjectGeneration.galgas", 480)).operator_not (SOURCE_FILE ("XcodeProjectGeneration.galgas", 480)) ;
    ...
    if (GalgasBool::boolTrue != test_25.boolEnum ()) {
      test_25 = GGS_bool (ComparisonKind::notEqual, GGS_string::class_func_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectGeneration.galgas", 480)).objectCompare (var_contents_17961)) ;
    }
    test_23 = test_25.boolEnum () ;
    if (GalgasBool::boolTrue == test_23) {
      GGS_bool joker_18942 ; // Joker input parameter
      var_contents_17961.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_18942, inCompiler COMMA_SOURCE_FILE ("XcodeProjectGeneration.galgas", 481)) ;
      var_contents_17961.method_makeDirectoryAndWriteToFile (var_projectCoreFile_18683, inCompiler COMMA_SOURCE_FILE ("XcodeProjectGeneration.galgas", 482)) ;
    }
  }
}
