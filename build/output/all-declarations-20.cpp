...
//--------------------------------------------------------------------------------------------------
// @plusPlusEqualElementsInstructionAST reference class
//--------------------------------------------------------------------------------------------------

ComparisonResult GGS_plusPlusEqualElementsInstructionAST::objectCompare (const GGS_plusPlusEqualElementsInstructionAST & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GGS_plusPlusEqualElementsInstructionAST::GGS_plusPlusEqualElementsInstructionAST (void) :
GGS_semanticInstructionAST () {
}

//--- Synthetized initializer ----------------------------------------------------------------------

GGS_plusPlusEqualElementsInstructionAST GGS_plusPlusEqualElementsInstructionAST::
init_21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                          const GGS_bool & in_mPrefixedBySelf,
                          const GGS_lstring & in_mReceiverName,
                          const GGS_lstringlist & in_mStructAttributeList,
                          ...
                          Compiler * inCompiler
                          COMMA_LOCATION_ARGS) {
  cPtr_plusPlusEqualElementsInstructionAST * object = nullptr ;
  macroMyNew (object, cPtr_plusPlusEqualElementsInstructionAST (inCompiler COMMA_THERE)) ;
  object->plusPlusEqualElementsInstructionAST_init_21__21__21__21__21_ (in_mInstructionLocation, in_mPrefixedBySelf, in_mReceiverName, in_mStructAttributeList, in_mExpression, inCompiler) ;
  const GGS_plusPlusEqualElementsInstructionAST result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
void cPtr_plusPlusEqualElementsInstructionAST::
plusPlusEqualElementsInstructionAST_init_21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                              const GGS_bool & in_mPrefixedBySelf,
                                                              const GGS_lstring & in_mReceiverName,
                                                              const GGS_lstringlist & in_mStructAttributeList,
                                                              const GGS_semanticExpressionAST & in_mExpression,
...
GGS_plusPlusEqualElementsInstructionAST::GGS_plusPlusEqualElementsInstructionAST (const cPtr_plusPlusEqualElementsInstructionAST * inSourcePtr) :
GGS_semanticInstructionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_plusPlusEqualElementsInstructionAST) ;
}
//--------------------------------------------------------------------------------------------------

GGS_plusPlusEqualElementsInstructionAST GGS_plusPlusEqualElementsInstructionAST::class_func_new (const GGS_location & in_mInstructionLocation,
                                                                                                 const GGS_bool & in_mPrefixedBySelf,
                                                                                                 const GGS_lstring & in_mReceiverName,
                                                                                                 const GGS_lstringlist & in_mStructAttributeList,
                                                                                                 const GGS_semanticExpressionAST & in_mExpression,
                                                                                                 Compiler * inCompiler
                                                                                                 COMMA_LOCATION_ARGS) {
  GGS_plusPlusEqualElementsInstructionAST result ;
  macroMyNew (result.mObjectPtr, cPtr_plusPlusEqualElementsInstructionAST (in_mInstructionLocation, in_mPrefixedBySelf, in_mReceiverName, in_mStructAttributeList, in_mExpression,  inCompiler COMMA_THERE)) ;
  return result ;
}

//--------------------------------------------------------------------------------------------------

GGS_bool GGS_plusPlusEqualElementsInstructionAST::readProperty_mPrefixedBySelf (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_bool () ;
  }else{
    cPtr_plusPlusEqualElementsInstructionAST * p = (cPtr_plusPlusEqualElementsInstructionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_plusPlusEqualElementsInstructionAST) ;
    return p->mProperty_mPrefixedBySelf ;
  }
}
...
GGS_lstring GGS_plusPlusEqualElementsInstructionAST::readProperty_mReceiverName (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
    cPtr_plusPlusEqualElementsInstructionAST * p = (cPtr_plusPlusEqualElementsInstructionAST *) mObjectPtr ;
...
GGS_lstringlist GGS_plusPlusEqualElementsInstructionAST::readProperty_mStructAttributeList (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstringlist () ;
  }else{
    cPtr_plusPlusEqualElementsInstructionAST * p = (cPtr_plusPlusEqualElementsInstructionAST *) mObjectPtr ;
...
GGS_semanticExpressionAST GGS_plusPlusEqualElementsInstructionAST::readProperty_mExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionAST () ;
  }else{
    cPtr_plusPlusEqualElementsInstructionAST * p = (cPtr_plusPlusEqualElementsInstructionAST *) mObjectPtr ;
...
//--------------------------------------------------------------------------------------------------
//Pointer class for @plusPlusEqualElementsInstructionAST class
//--------------------------------------------------------------------------------------------------

cPtr_plusPlusEqualElementsInstructionAST::cPtr_plusPlusEqualElementsInstructionAST (Compiler * inCompiler COMMA_LOCATION_ARGS) :
cPtr_semanticInstructionAST (inCompiler COMMA_THERE),
mProperty_mPrefixedBySelf (),
mProperty_mReceiverName (),
mProperty_mStructAttributeList (),
...
cPtr_plusPlusEqualElementsInstructionAST::cPtr_plusPlusEqualElementsInstructionAST (const GGS_location & in_mInstructionLocation,
                                                                                    const GGS_bool & in_mPrefixedBySelf,
                                                                                    const GGS_lstring & in_mReceiverName,
                                                                                    const GGS_lstringlist & in_mStructAttributeList,
                                                                                    const GGS_semanticExpressionAST & in_mExpression,
...
const C_galgas_type_descriptor * cPtr_plusPlusEqualElementsInstructionAST::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_plusPlusEqualElementsInstructionAST ;
}

void cPtr_plusPlusEqualElementsInstructionAST::description (String & ioString,
                                                            const int32_t inIndentation) const {
  ioString.appendCString ("[@plusPlusEqualElementsInstructionAST:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendCString (", ") ;
  mProperty_mPrefixedBySelf.description (ioString, inIndentation+1) ;
  ioString.appendCString (", ") ;
...
acPtr_class * cPtr_plusPlusEqualElementsInstructionAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  acPtr_class * ptr = nullptr ;
  macroMyNew (ptr, cPtr_plusPlusEqualElementsInstructionAST (mProperty_mInstructionLocation, mProperty_mPrefixedBySelf, mProperty_mReceiverName, mProperty_mStructAttributeList, mProperty_mExpression, inCompiler COMMA_THERE)) ;
  return ptr ;
}
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  void cPtr_plusPlusEqualElementsInstructionAST::printNonNullClassInstanceProperties (void) const {
    cPtr_semanticInstructionAST::printNonNullClassInstanceProperties () ;
    mProperty_mPrefixedBySelf.printNonNullClassInstanceProperties ("mPrefixedBySelf") ;
    mProperty_mReceiverName.printNonNullClassInstanceProperties ("mReceiverName") ;
    mProperty_mStructAttributeList.printNonNullClassInstanceProperties ("mStructAttributeList") ;
...
//--------------------------------------------------------------------------------------------------
//     @plusPlusEqualElementsInstructionAST generic code implementation
//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor kTypeDescriptor_GALGAS_plusPlusEqualElementsInstructionAST ("plusPlusEqualElementsInstructionAST",
                                                                                           & kTypeDescriptor_GALGAS_semanticInstructionAST) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GGS_plusPlusEqualElementsInstructionAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_plusPlusEqualElementsInstructionAST ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_plusPlusEqualElementsInstructionAST::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_plusPlusEqualElementsInstructionAST (*this)) ;
  }
  return result ;
}
...
GGS_plusPlusEqualElementsInstructionAST GGS_plusPlusEqualElementsInstructionAST::extractObject (const GGS_object & inObject,
                                                                                                Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) {
  GGS_plusPlusEqualElementsInstructionAST result ;
  const GGS_plusPlusEqualElementsInstructionAST * p = (const GGS_plusPlusEqualElementsInstructionAST *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_plusPlusEqualElementsInstructionAST *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("plusPlusEqualElementsInstructionAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void extensionMethod_generateInstruction (const GGS_ifTestListForGeneration inObject,
  ...
  ioArgument_ioTemporaryVariableIndex.plusAssign_operation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 349)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string ("GalgasBool ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 350)).add_operation (GGS_string (" = GalgasBool::boolTrue ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 350)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 350)) ;
  ...
  while (enumerator_13994.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string ("if (GalgasBool::boolTrue == ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 352)).add_operation (GGS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 352)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 352)) ;
    {
    ...
    case GGS_ifTestForGeneration::Enumeration::enum_optionalExp:
      {
        ...
        ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string ("const GGS_").add_operation (var_targetTypeName_15424, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 390)).add_operation (GGS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 390)).add_operation (extractedValue_15377_targetVarCppName_0, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 390)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 390)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string (" = ").add_operation (var_cppVarName_15657, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 391)).add_operation (GGS_string (".unwrappedValue () ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 391)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 391)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string ("if (!").add_operation (var_cppVarName_15657, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 392)).add_operation (GGS_string (".isValuated ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 392)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 392)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GGS_string ("  ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 393)).add_operation (GGS_string (" = GalgasBool::boolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 393)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 393)) ;
...
ComparisonResult GGS_readAccessWithInstructionAST::objectCompare (const GGS_readAccessWithInstructionAST & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GGS_readAccessWithInstructionAST::GGS_readAccessWithInstructionAST (void) :
GGS_semanticInstructionAST () {
}
...
init_21__21__21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
  ...
  const GGS_readAccessWithInstructionAST result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
readAccessWithInstructionAST_init_21__21__21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                                               const GGS_lstring & in_mPrefix,
                                                                               const GGS_semanticExpressionAST & in_mReceiverExpression,
                                                                               const GGS_location & in_mEndOfReceiverExpression,
                                                                               const GGS_semanticExpressionAST & in_mKeyExpression,
...
GGS_readAccessWithInstructionAST::GGS_readAccessWithInstructionAST (const cPtr_readAccessWithInstructionAST * inSourcePtr) :
GGS_semanticInstructionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_readAccessWithInstructionAST) ;
}
//--------------------------------------------------------------------------------------------------

GGS_readAccessWithInstructionAST GGS_readAccessWithInstructionAST::class_func_new (const GGS_location & in_mInstructionLocation,
                                                                                   const GGS_lstring & in_mPrefix,
                                                                                   const GGS_semanticExpressionAST & in_mReceiverExpression,
                                                                                   const GGS_location & in_mEndOfReceiverExpression,
                                                                                   const GGS_semanticExpressionAST & in_mKeyExpression,
...
GGS_lstring GGS_readAccessWithInstructionAST::readProperty_mPrefix (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
...
GGS_semanticExpressionAST GGS_readAccessWithInstructionAST::readProperty_mReceiverExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionAST () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readAccessWithInstructionAST::readProperty_mEndOfReceiverExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticExpressionAST GGS_readAccessWithInstructionAST::readProperty_mKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionAST () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readAccessWithInstructionAST::readProperty_mEndOfKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_lstring GGS_readAccessWithInstructionAST::readProperty_mSearchMethodNameForErrorSignaling (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticInstructionListAST GGS_readAccessWithInstructionAST::readProperty_mDoBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListAST () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readAccessWithInstructionAST::readProperty_mEndOf_5F_do_5F_instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticInstructionListAST GGS_readAccessWithInstructionAST::readProperty_mElseBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListAST () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readAccessWithInstructionAST::readProperty_mEndOf_5F_else_5F_instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readAccessWithInstructionAST * p = (cPtr_readAccessWithInstructionAST *) mObjectPtr ;
...
cPtr_readAccessWithInstructionAST::cPtr_readAccessWithInstructionAST (const GGS_location & in_mInstructionLocation,
                                                                      const GGS_lstring & in_mPrefix,
                                                                      const GGS_semanticExpressionAST & in_mReceiverExpression,
                                                                      const GGS_location & in_mEndOfReceiverExpression,
                                                                      const GGS_semanticExpressionAST & in_mKeyExpression,
...
acPtr_class * cPtr_readAccessWithInstructionAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  acPtr_class * ptr = nullptr ;
  macroMyNew (ptr, cPtr_readAccessWithInstructionAST (mProperty_mInstructionLocation, mProperty_mPrefix, mProperty_mReceiverExpression, mProperty_mEndOfReceiverExpression, mProperty_mKeyExpression, mProperty_mEndOfKeyExpression, mProperty_mSearchMethodNameForErrorSignaling, mProperty_mDoBranchInstructions, mProperty_mEndOf_5F_do_5F_instructions, mProperty_mElseBranchInstructions, mProperty_mEndOf_5F_else_5F_instructions, inCompiler COMMA_THERE)) ;
  return ptr ;
}
...
const C_galgas_type_descriptor * GGS_readAccessWithInstructionAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_readAccessWithInstructionAST ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_readAccessWithInstructionAST::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_readAccessWithInstructionAST (*this)) ;
  }
  return result ;
}
...
GGS_readAccessWithInstructionAST GGS_readAccessWithInstructionAST::extractObject (const GGS_object & inObject,
                                                                                  Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) {
  GGS_readAccessWithInstructionAST result ;
  const GGS_readAccessWithInstructionAST * p = (const GGS_readAccessWithInstructionAST *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_readAccessWithInstructionAST *> (p)) {
      result = *p ;
    }else{
...
ComparisonResult GGS_readWriteAccessWithInstructionAST::objectCompare (const GGS_readWriteAccessWithInstructionAST & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GGS_readWriteAccessWithInstructionAST::GGS_readWriteAccessWithInstructionAST (void) :
GGS_semanticInstructionAST () {
}
...
init_21__21__21__21__21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                          const GGS_lstring & in_mPrefix,
                                                          const GGS_lstring & in_mReceiverName,
  ...
  const GGS_readWriteAccessWithInstructionAST result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
readWriteAccessWithInstructionAST_init_21__21__21__21__21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                                                            const GGS_lstring & in_mPrefix,
                                                                                            const GGS_lstring & in_mReceiverName,
                                                                                            const GGS_bool & in_mReceiverIsPrefixedBySelf,
                                                                                            const GGS_lstringlist & in_mFieldList,
...
GGS_readWriteAccessWithInstructionAST::GGS_readWriteAccessWithInstructionAST (const cPtr_readWriteAccessWithInstructionAST * inSourcePtr) :
GGS_semanticInstructionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_readWriteAccessWithInstructionAST) ;
}
//--------------------------------------------------------------------------------------------------

GGS_readWriteAccessWithInstructionAST GGS_readWriteAccessWithInstructionAST::class_func_new (const GGS_location & in_mInstructionLocation,
                                                                                             const GGS_lstring & in_mPrefix,
                                                                                             const GGS_lstring & in_mReceiverName,
                                                                                             const GGS_bool & in_mReceiverIsPrefixedBySelf,
                                                                                             const GGS_lstringlist & in_mFieldList,
...
GGS_lstring GGS_readWriteAccessWithInstructionAST::readProperty_mPrefix (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
...
GGS_lstring GGS_readWriteAccessWithInstructionAST::readProperty_mReceiverName (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_bool GGS_readWriteAccessWithInstructionAST::readProperty_mReceiverIsPrefixedBySelf (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_bool () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_lstringlist GGS_readWriteAccessWithInstructionAST::readProperty_mFieldList (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstringlist () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readWriteAccessWithInstructionAST::readProperty_mEndOfReceiverExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticExpressionAST GGS_readWriteAccessWithInstructionAST::readProperty_mKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionAST () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readWriteAccessWithInstructionAST::readProperty_mEndOfKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_lstring GGS_readWriteAccessWithInstructionAST::readProperty_mSearchMethodNameForErrorSignaling (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstring () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticInstructionListAST GGS_readWriteAccessWithInstructionAST::readProperty_m_5F_do_5F_Instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListAST () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readWriteAccessWithInstructionAST::readProperty_mEndOf_5F_do_5F_instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_semanticInstructionListAST GGS_readWriteAccessWithInstructionAST::readProperty_m_5F_else_5F_Instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListAST () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
GGS_location GGS_readWriteAccessWithInstructionAST::readProperty_mEndOf_5F_else_5F_instructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
    cPtr_readWriteAccessWithInstructionAST * p = (cPtr_readWriteAccessWithInstructionAST *) mObjectPtr ;
...
cPtr_readWriteAccessWithInstructionAST::cPtr_readWriteAccessWithInstructionAST (const GGS_location & in_mInstructionLocation,
                                                                                const GGS_lstring & in_mPrefix,
                                                                                const GGS_lstring & in_mReceiverName,
                                                                                const GGS_bool & in_mReceiverIsPrefixedBySelf,
                                                                                const GGS_lstringlist & in_mFieldList,
...
const C_galgas_type_descriptor * GGS_readWriteAccessWithInstructionAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_readWriteAccessWithInstructionAST ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_readWriteAccessWithInstructionAST::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_readWriteAccessWithInstructionAST (*this)) ;
  }
  return result ;
}
...
GGS_readWriteAccessWithInstructionAST GGS_readWriteAccessWithInstructionAST::extractObject (const GGS_object & inObject,
                                                                                            Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) {
  GGS_readWriteAccessWithInstructionAST result ;
  const GGS_readWriteAccessWithInstructionAST * p = (const GGS_readWriteAccessWithInstructionAST *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_readWriteAccessWithInstructionAST *> (p)) {
      result = *p ;
    }else{
...
ComparisonResult GGS_readOnlyWithInstructionForGeneration::objectCompare (const GGS_readOnlyWithInstructionForGeneration & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GGS_readOnlyWithInstructionForGeneration::GGS_readOnlyWithInstructionForGeneration (void) :
GGS_semanticInstructionForGeneration () {
}
...
init_21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
  ...
  const GGS_readOnlyWithInstructionForGeneration result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
readOnlyWithInstructionForGeneration_init_21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                                       const GGS_semanticExpressionForGeneration & in_mReceiverExpression,
                                                                       const GGS_string & in_mObjectArrayCppName,
                                                                       const GGS_semanticExpressionForGeneration & in_mKeyExpression,
                                                                       const GGS_string & in_mSearchMethodNameForErrorSignaling,
...
GGS_readOnlyWithInstructionForGeneration::GGS_readOnlyWithInstructionForGeneration (const cPtr_readOnlyWithInstructionForGeneration * inSourcePtr) :
GGS_semanticInstructionForGeneration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_readOnlyWithInstructionForGeneration) ;
}
//--------------------------------------------------------------------------------------------------

GGS_readOnlyWithInstructionForGeneration GGS_readOnlyWithInstructionForGeneration::class_func_new (const GGS_location & in_mInstructionLocation,
                                                                                                   const GGS_semanticExpressionForGeneration & in_mReceiverExpression,
                                                                                                   const GGS_string & in_mObjectArrayCppName,
                                                                                                   const GGS_semanticExpressionForGeneration & in_mKeyExpression,
                                                                                                   const GGS_string & in_mSearchMethodNameForErrorSignaling,
  ...
  macroMyNew (result.mObjectPtr, cPtr_readOnlyWithInstructionForGeneration (in_mInstructionLocation, in_mReceiverExpression, in_mObjectArrayCppName, in_mKeyExpression, in_mSearchMethodNameForErrorSignaling, in_mDoBranchInstructions, in_mElseBranchInstructions,  inCompiler COMMA_THERE)) ;
  return result ;
}

//--------------------------------------------------------------------------------------------------

GGS_location GGS_readOnlyWithInstructionForGeneration::readProperty_mInstructionLocation (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
...
GGS_semanticExpressionForGeneration GGS_readOnlyWithInstructionForGeneration::readProperty_mReceiverExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionForGeneration () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
GGS_string GGS_readOnlyWithInstructionForGeneration::readProperty_mObjectArrayCppName (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_string () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticExpressionForGeneration GGS_readOnlyWithInstructionForGeneration::readProperty_mKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionForGeneration () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
GGS_string GGS_readOnlyWithInstructionForGeneration::readProperty_mSearchMethodNameForErrorSignaling (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_string () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticInstructionListForGeneration GGS_readOnlyWithInstructionForGeneration::readProperty_mDoBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListForGeneration () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticInstructionListForGeneration GGS_readOnlyWithInstructionForGeneration::readProperty_mElseBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListForGeneration () ;
  }else{
    cPtr_readOnlyWithInstructionForGeneration * p = (cPtr_readOnlyWithInstructionForGeneration *) mObjectPtr ;
...
cPtr_readOnlyWithInstructionForGeneration::cPtr_readOnlyWithInstructionForGeneration (const GGS_location & in_mInstructionLocation,
                                                                                      const GGS_semanticExpressionForGeneration & in_mReceiverExpression,
                                                                                      const GGS_string & in_mObjectArrayCppName,
                                                                                      const GGS_semanticExpressionForGeneration & in_mKeyExpression,
                                                                                      const GGS_string & in_mSearchMethodNameForErrorSignaling,
...
acPtr_class * cPtr_readOnlyWithInstructionForGeneration::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  acPtr_class * ptr = nullptr ;
  macroMyNew (ptr, cPtr_readOnlyWithInstructionForGeneration (mProperty_mInstructionLocation, mProperty_mReceiverExpression, mProperty_mObjectArrayCppName, mProperty_mKeyExpression, mProperty_mSearchMethodNameForErrorSignaling, mProperty_mDoBranchInstructions, mProperty_mElseBranchInstructions, inCompiler COMMA_THERE)) ;
  return ptr ;
}
...
const C_galgas_type_descriptor * GGS_readOnlyWithInstructionForGeneration::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_readOnlyWithInstructionForGeneration ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_readOnlyWithInstructionForGeneration::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_readOnlyWithInstructionForGeneration (*this)) ;
  }
  return result ;
}
...
GGS_readOnlyWithInstructionForGeneration GGS_readOnlyWithInstructionForGeneration::extractObject (const GGS_object & inObject,
                                                                                                  Compiler * inCompiler
                                                                                                  COMMA_LOCATION_ARGS) {
  GGS_readOnlyWithInstructionForGeneration result ;
  const GGS_readOnlyWithInstructionForGeneration * p = (const GGS_readOnlyWithInstructionForGeneration *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_readOnlyWithInstructionForGeneration *> (p)) {
      result = *p ;
    }else{
...
ComparisonResult GGS_readWriteWithInstructionForGeneration::objectCompare (const GGS_readWriteWithInstructionForGeneration & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    const size_t myObjectPtr = size_t (mObjectPtr) ;
    const size_t operandObjectPtr = size_t (inOperand.mObjectPtr) ;
...
GGS_readWriteWithInstructionForGeneration::GGS_readWriteWithInstructionForGeneration (void) :
GGS_semanticInstructionForGeneration () {
}
...
init_21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
  ...
  const GGS_readWriteWithInstructionForGeneration result (object) ;
  macroDetachSharedObject (object) ;
  return result ;
}
...
readWriteWithInstructionForGeneration_init_21__21__21__21__21__21__21__21__21_ (const GGS_location & in_mInstructionLocation,
                                                                                const GGS_string & in_mReceiverVariableCppName,
                                                                                const GGS_unifiedTypeMapEntry & in_mReceiverType,
                                                                                const GGS_lstringlist & in_mStructAttributeList,
                                                                                const GGS_string & in_mObjectArrayCppName,
...
GGS_readWriteWithInstructionForGeneration::GGS_readWriteWithInstructionForGeneration (const cPtr_readWriteWithInstructionForGeneration * inSourcePtr) :
GGS_semanticInstructionForGeneration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_readWriteWithInstructionForGeneration) ;
}
//--------------------------------------------------------------------------------------------------

GGS_readWriteWithInstructionForGeneration GGS_readWriteWithInstructionForGeneration::class_func_new (const GGS_location & in_mInstructionLocation,
                                                                                                     const GGS_string & in_mReceiverVariableCppName,
                                                                                                     const GGS_unifiedTypeMapEntry & in_mReceiverType,
                                                                                                     const GGS_lstringlist & in_mStructAttributeList,
                                                                                                     const GGS_string & in_mObjectArrayCppName,
  ...
  macroMyNew (result.mObjectPtr, cPtr_readWriteWithInstructionForGeneration (in_mInstructionLocation, in_mReceiverVariableCppName, in_mReceiverType, in_mStructAttributeList, in_mObjectArrayCppName, in_mKeyExpression, in_mSearchMethodNameForErrorSignaling, in_mDoBranchInstructions, in_mElseBranchInstructions,  inCompiler COMMA_THERE)) ;
  return result ;
}

//--------------------------------------------------------------------------------------------------

GGS_location GGS_readWriteWithInstructionForGeneration::readProperty_mInstructionLocation (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_location () ;
  }else{
...
GGS_string GGS_readWriteWithInstructionForGeneration::readProperty_mReceiverVariableCppName (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_string () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_unifiedTypeMapEntry GGS_readWriteWithInstructionForGeneration::readProperty_mReceiverType (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_unifiedTypeMapEntry () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_lstringlist GGS_readWriteWithInstructionForGeneration::readProperty_mStructAttributeList (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_lstringlist () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_string GGS_readWriteWithInstructionForGeneration::readProperty_mObjectArrayCppName (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_string () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticExpressionForGeneration GGS_readWriteWithInstructionForGeneration::readProperty_mKeyExpression (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticExpressionForGeneration () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_string GGS_readWriteWithInstructionForGeneration::readProperty_mSearchMethodNameForErrorSignaling (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_string () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticInstructionListForGeneration GGS_readWriteWithInstructionForGeneration::readProperty_mDoBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListForGeneration () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
GGS_semanticInstructionListForGeneration GGS_readWriteWithInstructionForGeneration::readProperty_mElseBranchInstructions (void) const {
  if (nullptr == mObjectPtr) {
    return GGS_semanticInstructionListForGeneration () ;
  }else{
    cPtr_readWriteWithInstructionForGeneration * p = (cPtr_readWriteWithInstructionForGeneration *) mObjectPtr ;
...
cPtr_readWriteWithInstructionForGeneration::cPtr_readWriteWithInstructionForGeneration (const GGS_location & in_mInstructionLocation,
                                                                                        const GGS_string & in_mReceiverVariableCppName,
                                                                                        const GGS_unifiedTypeMapEntry & in_mReceiverType,
                                                                                        const GGS_lstringlist & in_mStructAttributeList,
                                                                                        const GGS_string & in_mObjectArrayCppName,
...
acPtr_class * cPtr_readWriteWithInstructionForGeneration::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  acPtr_class * ptr = nullptr ;
  macroMyNew (ptr, cPtr_readWriteWithInstructionForGeneration (mProperty_mInstructionLocation, mProperty_mReceiverVariableCppName, mProperty_mReceiverType, mProperty_mStructAttributeList, mProperty_mObjectArrayCppName, mProperty_mKeyExpression, mProperty_mSearchMethodNameForErrorSignaling, mProperty_mDoBranchInstructions, mProperty_mElseBranchInstructions, inCompiler COMMA_THERE)) ;
  return ptr ;
}
...
const C_galgas_type_descriptor * GGS_readWriteWithInstructionForGeneration::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_readWriteWithInstructionForGeneration ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_readWriteWithInstructionForGeneration::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_readWriteWithInstructionForGeneration (*this)) ;
  }
  return result ;
}
...
GGS_readWriteWithInstructionForGeneration GGS_readWriteWithInstructionForGeneration::extractObject (const GGS_object & inObject,
                                                                                                    Compiler * inCompiler
                                                                                                    COMMA_LOCATION_ARGS) {
  GGS_readWriteWithInstructionForGeneration result ;
  const GGS_readWriteWithInstructionForGeneration * p = (const GGS_readWriteWithInstructionForGeneration *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_readWriteWithInstructionForGeneration *> (p)) {
      result = *p ;
    }else{
