...
void extensionSetter_addGroupWithFiles (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mProperty_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs_9282  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 291)) ;
}
...
void extensionMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
  ...
  if (kBoolTrue == test_22) {
    ...
    if (kBoolTrue != test_24.boolEnum ()) {
      test_24 = GALGAS_bool (kIsNotEqual, GALGAS_string::constructor_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 463)).objectCompare (var_contents_17644)) ;
    }
    test_22 = test_24.boolEnum () ;
    if (kBoolTrue == test_22) {
      GALGAS_bool joker_18596 ; // Joker input parameter
      var_contents_17644.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_18596, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 464)) ;
      var_contents_17644.method_makeDirectoryAndWriteToFile (var_projectCoreFile_18346, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 465)) ;
    }
  }
}
...
mProperty_mPropertyQualifiedTypeAST (),
...
mProperty_mPropertyQualifiedTypeAST (inOperand1),
...
GALGAS_propertyInCollectionListAST_2D_element GALGAS_propertyInCollectionListAST_2D_element::constructor_new (const GALGAS_bool & in_isConstant,
  ...
  if (in_isConstant.isValid () && in_mPropertyQualifiedTypeAST.isValid () && in_mPropertyName.isValid () && in_mIsPublic.isValid () && in_mAttributeList.isValid () && in_mInitialization.isValid ()) {
    result = GALGAS_propertyInCollectionListAST_2D_element (in_isConstant, in_mPropertyQualifiedTypeAST, in_mPropertyName, in_mIsPublic, in_mAttributeList, in_mInitialization) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_propertyInCollectionListAST_2D_element::objectCompare (const GALGAS_propertyInCollectionListAST_2D_element & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mProperty_mPropertyQualifiedTypeAST.objectCompare (inOperand.mProperty_mPropertyQualifiedTypeAST) ;
  }
  if (result == kOperandEqual) {
...
bool GALGAS_propertyInCollectionListAST_2D_element::isValid (void) const {
  return mProperty_isConstant.isValid () && mProperty_mPropertyQualifiedTypeAST.isValid () && mProperty_mPropertyName.isValid () && mProperty_mIsPublic.isValid () && mProperty_mAttributeList.isValid () && mProperty_mInitialization.isValid () ;
}
...
void GALGAS_propertyInCollectionListAST_2D_element::drop (void) {
  ...
  mProperty_mPropertyQualifiedTypeAST.drop () ;
...
void GALGAS_propertyInCollectionListAST_2D_element::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    ioString << ", " ;
    mProperty_mPropertyQualifiedTypeAST.description (ioString, inIndentation+1) ;
    ioString << ", " ;
...
GALGAS_getterMap_2D_element GALGAS_getterMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
  ...
  if (in_lkey.isValid () && in_mKind.isValid () && in_mArgumentTypeList.isValid () && in_mDeclarationLocation.isValid () && in_mHasCompilerArgument.isValid () && in_mReturnedType.isValid () && in_mQualifier.isValid () && in_mErrorMessage.isValid ()) {
    result = GALGAS_getterMap_2D_element (in_lkey, in_mKind, in_mArgumentTypeList, in_mDeclarationLocation, in_mHasCompilerArgument, in_mReturnedType, in_mQualifier, in_mErrorMessage) ;
  }
  return result ;
}
...
GALGAS_typedPropertyList_2D_element GALGAS_typedPropertyList_2D_element::constructor_new (const GALGAS_unifiedTypeMapEntry & in_mPropertyTypeEntry,
  ...
  if (in_mPropertyTypeEntry.isValid () && in_mPropertyName.isValid () && in_mHasSetter.isValid () && in_mHasSelector.isValid ()) {
    result = GALGAS_typedPropertyList_2D_element (in_mPropertyTypeEntry, in_mPropertyName, in_mHasSetter, in_mHasSelector) ;
  }
  return result ;
}
...
GALGAS_propertyMap_2D_element GALGAS_propertyMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
  ...
  if (in_lkey.isValid () && in_mIsPublic.isValid () && in_mIsConstant.isValid () && in_mPropertyType.isValid ()) {
    result = GALGAS_propertyMap_2D_element (in_lkey, in_mIsPublic, in_mIsConstant, in_mPropertyType) ;
  }
  return result ;
}
...
GALGAS_lexiqueComponentMapForSemanticAnalysis_2D_element GALGAS_lexiqueComponentMapForSemanticAnalysis_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
  ...
  if (in_lkey.isValid () && in_mIsTemplate.isValid () && in_mTerminalMap.isValid () && in_mIndexingListAST.isValid () && in_mIndexingDirectory.isValid () && in_mTerminalListAST.isValid () && in_mLexicalAttributeListAST.isValid () && in_mLexicalStyleListAST.isValid () && in_mLexicalListDeclarationListAST.isValid ()) {
    result = GALGAS_lexiqueComponentMapForSemanticAnalysis_2D_element (in_lkey, in_mIsTemplate, in_mTerminalMap, in_mIndexingListAST, in_mIndexingDirectory, in_mTerminalListAST, in_mLexicalAttributeListAST, in_mLexicalStyleListAST, in_mLexicalListDeclarationListAST) ;
  }
  return result ;
}
