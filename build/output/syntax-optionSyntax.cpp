...
void cParser_optionSyntax::rule_optionSyntax_option_5F_component_5F_start_5F_symbol_i0_ (GALGAS_optionComponentAST & outArgument_outOptionComponentRoot,
  ...
  GALGAS_commandLineOptionListAST var_mOptions = GALGAS_commandLineOptionListAST::constructor_emptyList (SOURCE_FILE ("optionSyntax.galgas", 31)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_optionSyntax_0 (inCompiler)) {
    case 2: {
      C_String syntaxDirectedTranslationResult_1858 ;
      nt_option_ (var_mOptions, syntaxDirectedTranslationResult_1858, inCompiler) ;
      ioSyntaxDirectedTranslationResult << syntaxDirectedTranslationResult_1858 ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioSyntaxDirectedTranslationResult << inCompiler->preceedingSeparatorString () ;
  ioSyntaxDirectedTranslationResult << inCompiler->tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_SOURCE_FILE ("optionSyntax.galgas", 36)) ;
...
void cParser_optionSyntax::rule_optionSyntax_option_5F_component_5F_start_5F_symbol_i0_parse (C_String & ioSyntaxDirectedTranslationResult,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      C_String syntaxDirectedTranslationResult_1858 ;
      nt_option_parse (syntaxDirectedTranslationResult_1858, inCompiler) ;
      ioSyntaxDirectedTranslationResult << syntaxDirectedTranslationResult_1858 ;
    } break ;
    default:
      repeatFlag_0 = false ;
