...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_16706 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  while (enumerator_16706.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").add_operation (function_getPBXFileReferenceKey (enumerator_16706.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)).add_operation (GALGAS_string (" /* "), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)).add_operation (enumerator_16706.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 381)).reader_mFileName (SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 381)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)).add_operation (GALGAS_string (" */,\n"), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 381))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.galgas", 380)) ;
