...
ComparisonResult GGS_IndexingSyntaxInstruction_2E_weak::objectCompare (const GGS_IndexingSyntaxInstruction_2E_weak & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    cPtr_weakReference_proxy * myPtr = mProxyPtr ;
    const size_t myObjectPtr = size_t (myPtr) ;
...
GGS_IndexingSyntaxInstruction_2E_weak::GGS_IndexingSyntaxInstruction_2E_weak (void) :
GGS_syntaxInstructionAST_2E_weak () {
}

//--------------------------------------------------------------------------------------------------

GGS_IndexingSyntaxInstruction_2E_weak & GGS_IndexingSyntaxInstruction_2E_weak::operator = (const GGS_IndexingSyntaxInstruction & inSource) {
  cPtr_weakReference_proxy * proxyPtr = nullptr ;
  acStrongPtr_class * p = (acStrongPtr_class *) inSource.ptr () ;
  if (p != nullptr) {
    proxyPtr = p->getProxy () ;
...
GGS_IndexingSyntaxInstruction_2E_weak::GGS_IndexingSyntaxInstruction_2E_weak (const GGS_IndexingSyntaxInstruction & inSource) :
GGS_syntaxInstructionAST_2E_weak (inSource) {
}
...
GGS_IndexingSyntaxInstruction_2E_weak GGS_IndexingSyntaxInstruction_2E_weak::class_func_nil (LOCATION_ARGS) {
...
GGS_IndexingSyntaxInstruction GGS_IndexingSyntaxInstruction_2E_weak::bang_IndexingSyntaxInstruction_2E_weak (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  ...
  if (mProxyPtr != nullptr) {
    ...
    if (strongPtr == nullptr) {
      ...
      macroValidSharedObject (strongPtr, cPtr_IndexingSyntaxInstruction) ;
      result = GGS_IndexingSyntaxInstruction ((cPtr_IndexingSyntaxInstruction *) strongPtr) ;
    }
  }
  return result ;
}
...
//--------------------------------------------------------------------------------------------------
//
//     @IndexingSyntaxInstruction.weak generic code implementation
//
//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingSyntaxInstruction_2E_weak ("IndexingSyntaxInstruction.weak",
                                                                                         & kTypeDescriptor_GALGAS_syntaxInstructionAST_2E_weak) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GGS_IndexingSyntaxInstruction_2E_weak::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_IndexingSyntaxInstruction_2E_weak ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_IndexingSyntaxInstruction_2E_weak::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_IndexingSyntaxInstruction_2E_weak (*this)) ;
  }
  return result ;
}
...
GGS_IndexingSyntaxInstruction_2E_weak GGS_IndexingSyntaxInstruction_2E_weak::extractObject (const GGS_object & inObject,
                                                                                            Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) {
  GGS_IndexingSyntaxInstruction_2E_weak result ;
  const GGS_IndexingSyntaxInstruction_2E_weak * p = (const GGS_IndexingSyntaxInstruction_2E_weak *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_IndexingSyntaxInstruction_2E_weak *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("IndexingSyntaxInstruction.weak", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
ComparisonResult GGS_IndexingInstructionForGeneration_2E_weak::objectCompare (const GGS_IndexingInstructionForGeneration_2E_weak & inOperand) const {
  ComparisonResult result = ComparisonResult::invalid ;
  if (isValid () && inOperand.isValid ()) {
    cPtr_weakReference_proxy * myPtr = mProxyPtr ;
    const size_t myObjectPtr = size_t (myPtr) ;
...
GGS_IndexingInstructionForGeneration_2E_weak::GGS_IndexingInstructionForGeneration_2E_weak (void) :
GGS_syntaxInstructionForGeneration_2E_weak () {
}

//--------------------------------------------------------------------------------------------------

GGS_IndexingInstructionForGeneration_2E_weak & GGS_IndexingInstructionForGeneration_2E_weak::operator = (const GGS_IndexingInstructionForGeneration & inSource) {
  cPtr_weakReference_proxy * proxyPtr = nullptr ;
  acStrongPtr_class * p = (acStrongPtr_class *) inSource.ptr () ;
  if (p != nullptr) {
    proxyPtr = p->getProxy () ;
...
GGS_IndexingInstructionForGeneration_2E_weak::GGS_IndexingInstructionForGeneration_2E_weak (const GGS_IndexingInstructionForGeneration & inSource) :
GGS_syntaxInstructionForGeneration_2E_weak (inSource) {
}
...
GGS_IndexingInstructionForGeneration_2E_weak GGS_IndexingInstructionForGeneration_2E_weak::class_func_nil (LOCATION_ARGS) {
...
GGS_IndexingInstructionForGeneration GGS_IndexingInstructionForGeneration_2E_weak::bang_IndexingInstructionForGeneration_2E_weak (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  ...
  if (mProxyPtr != nullptr) {
    ...
    if (strongPtr == nullptr) {
      ...
      macroValidSharedObject (strongPtr, cPtr_IndexingInstructionForGeneration) ;
      result = GGS_IndexingInstructionForGeneration ((cPtr_IndexingInstructionForGeneration *) strongPtr) ;
    }
  }
  return result ;
}
...
//--------------------------------------------------------------------------------------------------
//
//     @IndexingInstructionForGeneration.weak generic code implementation
//
//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingInstructionForGeneration_2E_weak ("IndexingInstructionForGeneration.weak",
                                                                                                & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration_2E_weak) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GGS_IndexingInstructionForGeneration_2E_weak::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_IndexingInstructionForGeneration_2E_weak ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GGS_IndexingInstructionForGeneration_2E_weak::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GGS_IndexingInstructionForGeneration_2E_weak (*this)) ;
  }
  return result ;
}
...
GGS_IndexingInstructionForGeneration_2E_weak GGS_IndexingInstructionForGeneration_2E_weak::extractObject (const GGS_object & inObject,
                                                                                                          Compiler * inCompiler
                                                                                                          COMMA_LOCATION_ARGS) {
  GGS_IndexingInstructionForGeneration_2E_weak result ;
  const GGS_IndexingInstructionForGeneration_2E_weak * p = (const GGS_IndexingInstructionForGeneration_2E_weak *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GGS_IndexingInstructionForGeneration_2E_weak *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("IndexingInstructionForGeneration.weak", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
