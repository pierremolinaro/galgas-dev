...
void GALGAS_structFieldAccessExpressionAST::setter_setMOperatorLocation (GALGAS_location inValue
                                                                         COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    insulate (THERE) ;
...
void cPtr_structFieldAccessExpressionAST::setter_setMOperatorLocation (GALGAS_location inValue
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
...
void GALGAS_structFieldAccessExpressionAST::setter_setMExpression (GALGAS_semanticExpressionAST inValue
                                                                   COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    insulate (THERE) ;
    cPtr_structFieldAccessExpressionAST * p = (cPtr_structFieldAccessExpressionAST *) mObjectPtr ;
...
void cPtr_structFieldAccessExpressionAST::setter_setMExpression (GALGAS_semanticExpressionAST inValue
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
...
void GALGAS_structFieldAccessExpressionAST::setter_setMStructFieldName (GALGAS_lstring inValue
                                                                        COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    insulate (THERE) ;
    cPtr_structFieldAccessExpressionAST * p = (cPtr_structFieldAccessExpressionAST *) mObjectPtr ;
...
void cPtr_structFieldAccessExpressionAST::setter_setMStructFieldName (GALGAS_lstring inValue
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_unifiedTypeMap_2D_proxy extensionGetter_baseType (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.galgas", 357)).isValid ()) {
    uint32_t variant_17521 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.galgas", 357)).uintValue () ;
    bool loop_17521 = true ;
    while (loop_17521) {
      loop_17521 = result_outBaseType.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 357)).getter_isNull (SOURCE_FILE ("semanticsTypes.galgas", 357)).operator_not (SOURCE_FILE ("semanticsTypes.galgas", 357)).isValid () ;
      if (loop_17521) {
        loop_17521 = result_outBaseType.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 357)).getter_isNull (SOURCE_FILE ("semanticsTypes.galgas", 357)).operator_not (SOURCE_FILE ("semanticsTypes.galgas", 357)).boolValue () ;
      }
      if (loop_17521 && (0 == variant_17521)) {
        loop_17521 = false ;
...
void extensionMethod_addHeaderFileName (const GALGAS_unifiedTypeMap_2D_proxy inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    test_0 = temp_1.getter_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 365)).operator_not (SOURCE_FILE ("semanticsTypes.galgas", 365)).operator_and (GALGAS_bool (kIsNotEqual, temp_2.getter_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 365)).objectCompare (GALGAS_headerKind::constructor_noHeader (SOURCE_FILE ("semanticsTypes.galgas", 365)))) COMMA_SOURCE_FILE ("semanticsTypes.galgas", 365)).boolEnum () ;
    if (kBoolTrue == test_0) {
...
void extensionMethod_addHeaderFileName_31_ (const GALGAS_unifiedTypeMap_2D_proxy inObject,
  ...
  if (kBoolTrue == test_0) {
    const GALGAS_unifiedTypeMap_2D_proxy temp_1 = inObject ;
    test_0 = temp_1.getter_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 373)).operator_not (SOURCE_FILE ("semanticsTypes.galgas", 373)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_unifiedTypeMap_2D_proxy temp_2 = inObject ;
      switch (temp_2.getter_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 374)).enumValue ()) {
      ...
      case GALGAS_headerKind::kEnum_oneHeader:
        {
          const GALGAS_unifiedTypeMap_2D_proxy temp_3 = inObject ;
          ioArgument_ioInclusions.addAssign_operation (temp_3.getter_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 377))  COMMA_SOURCE_FILE ("semanticsTypes.galgas", 377)) ;
        }
        break ;
      case GALGAS_headerKind::kEnum_twoHeaders:
        {
          const GALGAS_unifiedTypeMap_2D_proxy temp_4 = inObject ;
          ioArgument_ioInclusions.addAssign_operation (temp_4.getter_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 379)).add_operation (GALGAS_string ("-1"), inCompiler COMMA_SOURCE_FILE ("semanticsTypes.galgas", 379))  COMMA_SOURCE_FILE ("semanticsTypes.galgas", 379)) ;
        }
        break ;
      }
    }
