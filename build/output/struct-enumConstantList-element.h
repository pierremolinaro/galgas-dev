...
//--------------------------------- Public data members
  ...
  public : GALGAS_lstringlist mAttribute_mAssociatedValueTypeList ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_lstringlist reader_mAssociatedValueTypeList (LOCATION_ARGS) const ;
