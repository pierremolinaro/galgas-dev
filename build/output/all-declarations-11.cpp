...
GGS_readAccessWithInstructionAST GGS_readAccessWithInstructionAST_2E_weak::unwrappedValue (void) const {
...
GGS_readWriteAccessWithInstructionAST GGS_readWriteAccessWithInstructionAST_2E_weak::unwrappedValue (void) const {
...
GGS_readOnlyWithInstructionForGeneration GGS_readOnlyWithInstructionForGeneration_2E_weak::unwrappedValue (void) const {
...
GGS_readWriteWithInstructionForGeneration GGS_readWriteWithInstructionForGeneration_2E_weak::unwrappedValue (void) const {
...
void GGS_genericExtensionMethodListMapDictionary::setter_setMListForKey (GGS_lstringlist inPropertyValue,
                                                                         ...
                                                                         COMMA_LOCATION_ARGS) {
  if (isValid () && inKey.isValid ()) {
    OptionalSharedRef <SharedGenericMapNode <GGS_string, GGS_genericExtensionMethodListMapDictionary_2E_element>> modifiedNode = nodeForKey (inKey) ;
...
void GGS_descendantClassListMapDictionary::setter_setTypeListForKey (GGS_unifiedTypeMapEntryList inPropertyValue,
                                                                     ...
                                                                     COMMA_LOCATION_ARGS) {
  if (isValid () && inKey.isValid ()) {
    OptionalSharedRef <SharedGenericMapNode <GGS_string, GGS_descendantClassListMapDictionary_2E_element>> modifiedNode = nodeForKey (inKey) ;
    if (modifiedNode.isNil ()) { // Not found
    //--- Build error message
