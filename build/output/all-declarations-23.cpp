...
static void extensionMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  const GALGAS_listmapDeclarationAST temp_1 = object ;
  GALGAS_lstring var_key_2856 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mListmapTypeName (HERE).getter_string (SOURCE_FILE ("type-listmap.galgas", 69)), inCompiler COMMA_SOURCE_FILE ("type-listmap.galgas", 69)), temp_1.getter_mListmapTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-listmap.galgas", 69)) ;
  {
  const GALGAS_listmapDeclarationAST temp_2 = object ;
...
static void extensionMethod_dictDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  const GALGAS_dictDeclarationAST temp_0 = object ;
  GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntryFromString (ioArgument_ioSemanticContext.mProperty_mTypeMap, temp_0.getter_mKeyTypeName (HERE).getter_string (SOURCE_FILE ("type-dict.galgas", 110)), var_keyTypeIndex_5027 COMMA_SOURCE_FILE ("type-dict.galgas", 110)) ;
  }
  ...
  while (enumerator_5227.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_3) {
          ...
          if (kBoolTrue == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticError (enumerator_5227.current_mValue (HERE).getter_location (SOURCE_FILE ("type-dict.galgas", 118)), GALGAS_string ("duplicated attribute"), fixItArray4  COMMA_SOURCE_FILE ("type-dict.galgas", 118)) ;
          }
        }
    ...
    if (kBoolFalse == test_2) {
      ...
      inCompiler->emitSemanticError (enumerator_5227.current_mValue (HERE).getter_location (SOURCE_FILE ("type-dict.galgas", 122)), GALGAS_string ("unknown attribute"), fixItArray5  COMMA_SOURCE_FILE ("type-dict.galgas", 122)) ;
    }
        ...
        if (kBoolTrue == test_0) {
          ...
          if (kBoolTrue == test_1) {
            ...
            if (kBoolTrue == test_1) {
              ...
              inCompiler->emitSemanticError (inArgument_inString.getter_location (SOURCE_FILE ("type-dict.galgas", 323)), GALGAS_string ("only '%K' and '%%' escape sequences are allowed in this error message"), fixItArray2  COMMA_SOURCE_FILE ("type-dict.galgas", 323)) ;
            }
          }
        }
      }
      ...
      if (kBoolTrue == test_0) {
        ...
        if (kBoolTrue == test_0) {
          ...
          if (kBoolTrue == test_1) {
            ...
            if (kBoolTrue == test_1) {
              TC_Array <C_FixItDescription> fixItArray2 ;
              inCompiler->emitSemanticError (inArgument_inString.getter_location (SOURCE_FILE ("type-dict.galgas", 340)), GALGAS_string ("only '%K', '%L' and '%%' escape sequences are allowed in this error message"), fixItArray2  COMMA_SOURCE_FILE ("type-dict.galgas", 340)) ;
            }
          }
        }
      }
  ...
  while (enumerator_15110.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_4) {
        ...
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (enumerator_15110.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("type-dict.galgas", 391)), var_m_15647, fixItArray5  COMMA_SOURCE_FILE ("type-dict.galgas", 391)) ;
      }
    }
    {
  ...
  while (enumerator_9532.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_3) {
          ...
          if (kBoolTrue == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticError (enumerator_9532.current_mValue (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 250)), GALGAS_string ("duplicated attribute"), fixItArray4  COMMA_SOURCE_FILE ("type-map.galgas", 250)) ;
          }
        }
    ...
    if (kBoolFalse == test_2) {
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_5) {
          ...
          if (kBoolTrue == test_6) {
            ...
            if (kBoolTrue == test_6) {
              TC_Array <C_FixItDescription> fixItArray7 ;
              inCompiler->emitSemanticError (enumerator_9532.current_mValue (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 255)), GALGAS_string ("duplicated attribute"), fixItArray7  COMMA_SOURCE_FILE ("type-map.galgas", 255)) ;
            }
          }
      ...
      if (kBoolFalse == test_5) {
        ...
        inCompiler->emitSemanticError (enumerator_9532.current_mValue (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 259)), GALGAS_string ("unknown attribute"), fixItArray8  COMMA_SOURCE_FILE ("type-map.galgas", 259)) ;
      }
    }
        ...
        if (kBoolTrue == test_20) {
          ...
          if (kBoolTrue == test_21) {
            ...
            if (kBoolTrue == test_21) {
              ...
              inCompiler->emitSemanticWarning (enumerator_13583.current_mValue (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 380)), GALGAS_string ("%selector useless, map has %selectors attributes"), fixItArray23  COMMA_SOURCE_FILE ("type-map.galgas", 380)) ;
            }
          }
        }
      }
  ...
  while (enumerator_14865.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_34) {
      ...
      if (kBoolTrue == test_34) {
        ...
        inCompiler->emitSemanticError (enumerator_14865.current_mInsertMethodName (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 407)), GALGAS_string ("the '").add_operation (enumerator_14865.current_mInsertMethodName (HERE).getter_string (SOURCE_FILE ("type-map.galgas", 407)), inCompiler COMMA_SOURCE_FILE ("type-map.galgas", 407)).add_operation (GALGAS_string ("' insert method is already declared"), inCompiler COMMA_SOURCE_FILE ("type-map.galgas", 407)), fixItArray35  COMMA_SOURCE_FILE ("type-map.galgas", 407)) ;
      }
    }
  ...
  while (enumerator_15328.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_37) {
      ...
      if (kBoolTrue == test_37) {
        ...
        inCompiler->emitSemanticError (enumerator_15328.current_mMethodName (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 422)), GALGAS_string ("the '").add_operation (enumerator_15328.current_mMethodName (HERE).getter_string (SOURCE_FILE ("type-map.galgas", 422)), inCompiler COMMA_SOURCE_FILE ("type-map.galgas", 422)).add_operation (GALGAS_string ("' method is already declared as an insert setter or a remove setter"), inCompiler COMMA_SOURCE_FILE ("type-map.galgas", 422)), fixItArray38  COMMA_SOURCE_FILE ("type-map.galgas", 422)) ;
      }
    }
  ...
  while (enumerator_22015.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_7) {
      ...
      if (kBoolTrue == test_7) {
        ...
        TC_Array <C_FixItDescription> fixItArray8 ;
        inCompiler->emitSemanticError (enumerator_22015.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("type-map.galgas", 618)), var_m_22552, fixItArray8  COMMA_SOURCE_FILE ("type-map.galgas", 618)) ;
      }
    }
    {
...
static void extensionMethod_mapEntryDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_1201 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mMapEntryTypeName (HERE).getter_string (SOURCE_FILE ("type-map-entry.galgas", 20)), inCompiler COMMA_SOURCE_FILE ("type-map-entry.galgas", 20)), temp_1.getter_mMapEntryTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-map-entry.galgas", 20)) ;
  {
...
static void extensionMethod_sharedMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_28334.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (enumerator_28334.current_mAttributeName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 768)), GALGAS_string ("only %shadow attribute is allowed here"), fixItArray5  COMMA_SOURCE_FILE ("type-shared-map.galgas", 768)) ;
      }
    }
    if (kBoolFalse == test_4) {
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        ...
        if (kBoolTrue == test_6) {
          TC_Array <C_FixItDescription> fixItArray7 ;
          inCompiler->emitSemanticError (enumerator_28334.current_mAttributeName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 770)), GALGAS_string ("duplicated attribute"), fixItArray7  COMMA_SOURCE_FILE ("type-shared-map.galgas", 770)) ;
        }
      }
    ...
    if (kBoolTrue == test_11) {
      ...
      if (kBoolTrue == test_11) {
        ...
        if (kBoolTrue == test_13) {
          ...
          if (kBoolTrue == test_13) {
            TC_Array <C_FixItDescription> fixItArray14 ;
            inCompiler->emitSemanticError (enumerator_28890.current_mInsertMethodName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 782)), GALGAS_string ("the '").add_operation (enumerator_28890.current_mInsertMethodName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 782)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 782)).add_operation (GALGAS_string ("' insert method should name an automaton state"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 782)), fixItArray14  COMMA_SOURCE_FILE ("type-shared-map.galgas", 782)) ;
          }
        }
    ...
    if (kBoolFalse == test_11) {
      ...
      if (kBoolTrue == test_15) {
        ...
        if (kBoolTrue == test_15) {
          ...
          inCompiler->emitSemanticError (enumerator_28890.current_mInsertMethodName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 787)), GALGAS_string ("the '").add_operation (enumerator_28890.current_mInsertMethodName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 787)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 787)).add_operation (GALGAS_string ("' insert method should not name an automaton state"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 787)), fixItArray16  COMMA_SOURCE_FILE ("type-shared-map.galgas", 787)) ;
        }
      }
    }
      ...
      if (kBoolTrue == test_18) {
        ...
        if (kBoolTrue == test_20) {
          ...
          if (kBoolTrue == test_20) {
            ...
            inCompiler->emitSemanticError (enumerator_29502.current_mSearchMethodName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 795)), GALGAS_string ("the '").add_operation (enumerator_29502.current_mSearchMethodName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 795)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 795)).add_operation (GALGAS_string ("' search method should name an automaton action"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 795)), fixItArray21  COMMA_SOURCE_FILE ("type-shared-map.galgas", 795)) ;
          }
        }
    ...
    if (kBoolFalse == test_18) {
      ...
      if (kBoolTrue == test_23) {
        ...
        if (kBoolTrue == test_23) {
          ...
          inCompiler->emitSemanticError (enumerator_29502.current_mSearchMethodName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 800)), GALGAS_string ("the '").add_operation (enumerator_29502.current_mSearchMethodName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 800)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 800)).add_operation (GALGAS_string ("' search method should not name an automaton action"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 800)), fixItArray24  COMMA_SOURCE_FILE ("type-shared-map.galgas", 800)) ;
        }
      }
    }
    ...
    while (enumerator_30952.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_28) {
        ...
        if (kBoolTrue == test_28) {
          ...
          inCompiler->emitSemanticError (enumerator_30952.current_mActionName (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 822)), GALGAS_string ("the '").add_operation (enumerator_30952.current_mActionName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 822)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 822)).add_operation (GALGAS_string ("' action is already used for this state"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 822)), fixItArray29  COMMA_SOURCE_FILE ("type-shared-map.galgas", 822)) ;
        }
      }
    ...
    while (enumerator_34613.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_43) {
        ...
        if (kBoolTrue == test_43) {
          ...
          inCompiler->emitSemanticWarning (enumerator_34613.current_mRightState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 915)), GALGAS_string ("the '").add_operation (var_association_34843, inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 915)).add_operation (GALGAS_string ("' association is useless"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 915)), fixItArray44  COMMA_SOURCE_FILE ("type-shared-map.galgas", 915)) ;
        }
      }
      enumGalgasBool test_45 = kBoolTrue ;
      if (kBoolTrue == test_45) {
        ...
        if (kBoolTrue == test_45) {
          ...
          inCompiler->emitSemanticError (enumerator_34613.current_mRightState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 918)), GALGAS_string ("the '").add_operation (var_association_34843, inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 919)).add_operation (GALGAS_string ("' association is already defined"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 919)), fixItArray46  COMMA_SOURCE_FILE ("type-shared-map.galgas", 918)) ;
        }
      }
        ...
        if (kBoolTrue == test_47) {
          ...
          if (kBoolTrue == test_48) {
            ...
            if (kBoolTrue == test_48) {
              ...
              inCompiler->emitSemanticError (enumerator_34613.current_mResultingState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 927)), GALGAS_string ("the '").add_operation (enumerator_34613.current_mResultingState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 928)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 928)).add_operation (GALGAS_string ("' state is not reachable from '"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 928)).add_operation (enumerator_34613.current_mLeftState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 928)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 928)).add_operation (GALGAS_string ("' state"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 928)), fixItArray49  COMMA_SOURCE_FILE ("type-shared-map.galgas", 927)) ;
            }
          }
        }
      }
    ...
    while (enumerator_36707.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_52) {
        ...
        if (kBoolTrue == test_52) {
          ...
          inCompiler->emitSemanticError (enumerator_36707.current_mRightState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 957)), GALGAS_string ("the '").add_operation (enumerator_36707.current_mLeftState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 958)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 958)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 958)).add_operation (enumerator_36707.current_mRightState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 958)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 958)).add_operation (GALGAS_string ("' combinaison is useless"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 958)), fixItArray53  COMMA_SOURCE_FILE ("type-shared-map.galgas", 957)) ;
        }
      }
      ...
      if (kBoolTrue == test_54) {
        ...
        if (kBoolTrue == test_54) {
          ...
          inCompiler->emitSemanticError (enumerator_36707.current_mRightState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 961)), GALGAS_string ("the '").add_operation (enumerator_36707.current_mLeftState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 962)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 962)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 962)).add_operation (enumerator_36707.current_mRightState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 962)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 962)).add_operation (GALGAS_string ("' combinaison is already defined"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 962)), fixItArray55  COMMA_SOURCE_FILE ("type-shared-map.galgas", 961)) ;
        }
      }
      ...
      if (kBoolTrue == test_56) {
        ...
        if (kBoolTrue == test_56) {
          ...
          inCompiler->emitSemanticError (enumerator_36707.current_mResultingState (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 969)), GALGAS_string ("the '").add_operation (enumerator_36707.current_mResultingState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 970)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 970)).add_operation (GALGAS_string ("' state cannot be reached from the '"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 970)).add_operation (enumerator_36707.current_mResultingState (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 970)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 970)).add_operation (GALGAS_string ("' state"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 970)), fixItArray57  COMMA_SOURCE_FILE ("type-shared-map.galgas", 969)) ;
        }
      }
      {
          ...
          if (kBoolTrue == test_64) {
            ...
            if (kBoolTrue == test_65) {
              ...
              if (kBoolTrue == test_65) {
                ...
                inCompiler->emitSemanticError (enumerator_39992.current (HERE).getter_mErrorMessage (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 1038)), GALGAS_string ("only '%K', '%L' and '%%' escape sequences are allowed in an insert error message"), fixItArray66  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1038)) ;
              }
            }
          }
        }
          ...
          if (kBoolTrue == test_67) {
            ...
            if (kBoolTrue == test_68) {
              ...
              if (kBoolTrue == test_68) {
                ...
                inCompiler->emitSemanticError (enumerator_39992.current (HERE).getter_mErrorMessage (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 1051)), GALGAS_string ("only '%K', '%L' and '%%' escape sequences are allowed in a shadow error message"), fixItArray69  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1051)) ;
              }
            }
          }
        }
          ...
          if (kBoolTrue == test_73) {
            ...
            if (kBoolTrue == test_74) {
              ...
              if (kBoolTrue == test_74) {
                ...
                inCompiler->emitSemanticError (enumerator_41509.current (HERE).getter_mErrorMessage (HERE).getter_location (SOURCE_FILE ("type-shared-map.galgas", 1073)), GALGAS_string ("only '%K' and '%%' escape sequences are allowed in a search error message"), fixItArray75  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1073)) ;
              }
            }
          }
        }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("shared map ").add_operation (temp_76.getter_mMapTypeName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1081)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1081)), GALGAS_sharedMapTypeForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.getter_mTypeMap (HERE), temp_77.getter_mMapTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1083)), var_typedAttributeList_39286, temp_78.getter_mInsertMethodList (HERE), temp_79.getter_mSearchMethodList (HERE), var_mapAutomatonStateMap_30143, var_mapAutomatonActionMap_29456, var_mapStateSortedList_30656, var_mapOverrideList_34219, var_shadowBehaviour_28255, var_shadowMessage_28288  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1082))  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1080)) ;
  const GALGAS_sharedMapDeclarationAST temp_80 = object ;
  GALGAS_string var_graphFile_42932 = constinArgument_inProductDirectory.add_operation (GALGAS_string ("/../helpers/shared-map-"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1096)).add_operation (temp_80.getter_mMapTypeName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1096)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1096)).add_operation (GALGAS_string (".dot"), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1096)) ;
  ...
  if (kBoolTrue == test_81) {
    ...
    if (kBoolTrue == test_81) {
      ...
      while (enumerator_43158.hasCurrentObject ()) {
        var_theGraph_43106.plusAssign_operation(GALGAS_string ("\"").add_operation (enumerator_43158.current_lkey (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1100)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1100)).add_operation (GALGAS_string ("\" [label=\""), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1100)).add_operation (enumerator_43158.current_lkey (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1100)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1100)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1100)), inCompiler  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1100)) ;
      ...
      while (enumerator_43673.hasCurrentObject ()) {
        ...
        while (enumerator_43764.hasCurrentObject ()) {
          var_theGraph_43106.plusAssign_operation(GALGAS_string ("\"").add_operation (enumerator_43673.current_mStateName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1117)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)).add_operation (GALGAS_string ("\" -> \""), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)).add_operation (enumerator_43764.current_mTargetStateName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1117)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)).add_operation (GALGAS_string ("\" [label=\""), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)).add_operation (enumerator_43764.current_mActionName (HERE).getter_string (SOURCE_FILE ("type-shared-map.galgas", 1117)), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)), inCompiler  COMMA_SOURCE_FILE ("type-shared-map.galgas", 1117)) ;
...
static void extensionMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_3293 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mSortedListTypeName (HERE).getter_string (SOURCE_FILE ("type-sorted-list.galgas", 84)), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 84)), temp_1.getter_mSortedListTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-sorted-list.galgas", 84)) ;
  {
  ...
  while (enumerator_3465.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.setter_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_3465.current_mPropertyTypeName (HERE).getter_string (SOURCE_FILE ("type-sorted-list.galgas", 87)), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 87)), enumerator_3465.current_mPropertyTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-sorted-list.galgas", 87)) COMMA_SOURCE_FILE ("type-sorted-list.galgas", 87)) ;
    }
  ...
  while (enumerator_11182.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      ...
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (enumerator_11182.current_mSortedAttributeName (HERE).getter_location (SOURCE_FILE ("type-sorted-list.galgas", 292)), GALGAS_string ("the '").add_operation (enumerator_11182.current_mSortedAttributeName (HERE).getter_string (SOURCE_FILE ("type-sorted-list.galgas", 292)), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 292)).add_operation (GALGAS_string ("' is already used for sorting"), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 292)), fixItArray6  COMMA_SOURCE_FILE ("type-sorted-list.galgas", 292)) ;
      }
    }
...
static void extensionMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_2105 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mStructTypeName (HERE).getter_string (SOURCE_FILE ("type-struct.galgas", 50)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 50)), temp_1.getter_mStructTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-struct.galgas", 50)) ;
  {
  ...
  while (enumerator_2269.hasCurrentObject ()) {
    GALGAS_lstring var_propertyKey_2324 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_2269.current_mPropertyTypeName (HERE).getter_string (SOURCE_FILE ("type-struct.galgas", 53)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 53)), enumerator_2269.current_mPropertyTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-struct.galgas", 53)) ;
    {
...
static void extensionMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_getterMap var_getterMap_5191 ;
  {
  routine_commonGetterMapForAllTypes (ioArgument_ioSemanticContext.mProperty_mTypeMap, var_getterMap_5191, inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 114)) ;
  }
  cEnumerator_typedPropertyList enumerator_5306 (var_typedPropertyList_4132, kENUMERATION_UP) ;
  while (enumerator_5306.hasCurrentObject ()) {
    {
    routine_enterBaseFinalGetterWithoutArgument (var_getterMap_5191, ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_5306.current_mPropertyName (HERE).getter_string (HERE), enumerator_5306.current_mPropertyTypeEntry (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 120)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 116)) ;
    }
    enumerator_5306.gotoNextObject () ;
  }
  GALGAS_setterMap var_setterMap_5602 = GALGAS_setterMap::constructor_emptyMap (SOURCE_FILE ("type-struct.galgas", 125)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap_5672 = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("type-struct.galgas", 127)) ;
  {
  const GALGAS_structDeclarationAST temp_4 = object ;
  routine_addExtensions (constinArgument_inExtensionMethodMapForBuildingContext, constinArgument_inExtensionGetterMapForBuildingContext, constinArgument_inExtensionSetterMapForBuildingContext, ioArgument_ioSemanticContext, temp_4.getter_mStructTypeName (HERE), var_getterMap_5191, var_setterMap_5602, var_instanceMethodMap_5672, GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 129)) ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_enumeratedType_6063 ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    ...
    if (kBoolTrue == test_5) {
      var_enumeratedType_6063 = GALGAS_unifiedTypeMap_2D_entry::constructor_null (SOURCE_FILE ("type-struct.galgas", 143)) ;
    }
  }
  if (kBoolFalse == test_5) {
    {
    const GALGAS_structDeclarationAST temp_7 = object ;
    GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntryFromString (ioArgument_ioSemanticContext.mProperty_mTypeMap, temp_7.getter_mEnumeratedElementTypeName (HERE), var_enumeratedType_6063 COMMA_SOURCE_FILE ("type-struct.galgas", 145)) ;
    }
  }
  GALGAS_string var_defaultConstructorName_6394 = GALGAS_string ("default") ;
  cEnumerator_typedPropertyList enumerator_6438 (var_typedPropertyList_4132, kENUMERATION_UP) ;
  bool bool_8 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName_6394.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
  if (enumerator_6438.hasCurrentObject () && bool_8) {
    while (enumerator_6438.hasCurrentObject () && bool_8) {
      enumGalgasBool test_9 = kBoolTrue ;
      if (kBoolTrue == test_9) {
        test_9 = GALGAS_bool (kIsEqual, enumerator_6438.current_mPropertyTypeEntry (HERE).getter_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 154)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_6438.current_mPropertyTypeEntry (HERE).getter_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 154)).operator_not (SOURCE_FILE ("type-struct.galgas", 154)) COMMA_SOURCE_FILE ("type-struct.galgas", 154)).boolEnum () ;
        if (kBoolTrue == test_9) {
          var_defaultConstructorName_6394 = GALGAS_string::makeEmptyString () ;
        }
      }
      enumerator_6438.gotoNextObject () ;
      if (enumerator_6438.hasCurrentObject ()) {
        bool_8 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName_6394.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ...
  ioArgument_ioSemanticContext.mProperty_mTypeMap.setter_insertKey (temp_10.getter_mStructTypeName (HERE), temp_11.getter_mIsPredefined (HERE), GALGAS_bool (true), GALGAS_unifiedTypeMap_2D_entry::constructor_null (SOURCE_FILE ("type-struct.galgas", 163)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("type-struct.galgas", 164)), GALGAS_bool (false), var_typedPropertyList_4132, var_propertyMap_3984, var_typedPropertyList_4132, var_constructorMap_4026, var_getterMap_5191, var_setterMap_5602, var_instanceMethodMap_5672, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("type-struct.galgas", 173)), var_optionalMethodMap_3763, GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 175)), GALGAS_operators::constructor_generateDescriptionGetterUtilityMethod (SOURCE_FILE ("type-struct.galgas", 176)).operator_or (GALGAS_operators::constructor_isComparable (SOURCE_FILE ("type-struct.galgas", 176)) COMMA_SOURCE_FILE ("type-struct.galgas", 176)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 177)), GALGAS_constantIndexMap::constructor_emptyMap (SOURCE_FILE ("type-struct.galgas", 178)), GALGAS_enumConstantList::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 179)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 180)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 181)), GALGAS_bool (false), var_enumeratedType_6063, var_defaultConstructorName_6394, GALGAS_string ("struct-").add_operation (temp_12.getter_mStructTypeName (HERE).getter_string (HERE).getter_fileNameRepresentation (SOURCE_FILE ("type-struct.galgas", 185)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 185)), GALGAS_headerKind::constructor_oneHeader (SOURCE_FILE ("type-struct.galgas", 186)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 159)) ;
  }
}
...
static void extensionMethod_structDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_structDeclarationAST) ;
  const GALGAS_structDeclarationAST temp_0 = object ;
  GALGAS_lstring var_structNameForUsefulness_8529 = function_typeNameForUsefulEntitiesGraph (temp_0.getter_mStructTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 212)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_structNameForUsefulness_8529, var_structNameForUsefulness_8529, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 213)) ;
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_structDeclarationAST temp_2 = object ;
  ...
  GALGAS_typedPropertyList var_typedPropertyList_8877 = GALGAS_typedPropertyList::constructor_emptyList (SOURCE_FILE ("type-struct.galgas", 218)) ;
  GALGAS_propertyIndexMap var_propertyMap_8918 = GALGAS_propertyIndexMap::constructor_emptyMap (SOURCE_FILE ("type-struct.galgas", 219)) ;
  ...
  while (enumerator_8981.hasCurrentObject ()) {
    GALGAS_lstring var_propertyTypeNameForUsefulness_9054 = function_typeNameForUsefulEntitiesGraph (enumerator_8981.current_mPropertyTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 221)) ;
    {
    ioArgument_ioUsefulEntitiesGraph.setter_addEdge (var_structNameForUsefulness_8529, var_propertyTypeNameForUsefulness_9054 COMMA_SOURCE_FILE ("type-struct.galgas", 222)) ;
    }
    GALGAS_unifiedTypeMap_2D_entry var_t_9212 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.getter_mTypeMap (HERE), enumerator_8981.current_mPropertyTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 223)) ;
    ...
    while (enumerator_9339.hasCurrentObject ()) {
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        test_6 = GALGAS_bool (kIsNotEqual, enumerator_9339.current_mValue (HERE).getter_string (HERE).objectCompare (function_selectorFeatureForNewConstructor (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 226)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          TC_Array <C_FixItDescription> fixItArray7 ;
    ...
    var_typedPropertyList_8877.addAssign_operation (var_t_9212, enumerator_8981.current_mPropertyName (HERE), var_hasSetter_9734, var_hasSelector_9315  COMMA_SOURCE_FILE ("type-struct.galgas", 235)) ;
    enumGalgasBool test_10 = kBoolTrue ;
    if (kBoolTrue == test_10) {
      test_10 = function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 240)).getter_hasKey (enumerator_8981.current_mPropertyName (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("type-struct.galgas", 240)).boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_string var_m_9933 = GALGAS_string ("an property cannot be named:") ;
        cEnumerator_stringset enumerator_10007 (function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 242)), kENUMERATION_UP) ;
        while (enumerator_10007.hasCurrentObject ()) {
          var_m_9933.plusAssign_operation(GALGAS_string (" ").add_operation (enumerator_10007.current (HERE), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 243)), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 243)) ;
          enumerator_10007.gotoNextObject () ;
        }
        var_m_9933.plusAssign_operation(GALGAS_string ("; theses names are reserved"), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 245)) ;
        TC_Array <C_FixItDescription> fixItArray11 ;
        inCompiler->emitSemanticError (enumerator_8981.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("type-struct.galgas", 246)), var_m_9933, fixItArray11  COMMA_SOURCE_FILE ("type-struct.galgas", 246)) ;
      }
    }
    {
    var_propertyMap_8918.setter_insertKey (enumerator_8981.current_mPropertyName (HERE), var_t_9212, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 248)) ;
    }
    enumerator_8981.gotoNextObject () ;
  }
  const GALGAS_structDeclarationAST temp_12 = object ;
  const GALGAS_structDeclarationAST temp_13 = object ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("struct ").add_operation (temp_12.getter_mStructTypeName (HERE).getter_string (SOURCE_FILE ("type-struct.galgas", 251)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 251)), GALGAS_structTypeForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.getter_mTypeMap (HERE), temp_13.getter_mStructTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 253)), var_typedPropertyList_8877  COMMA_SOURCE_FILE ("type-struct.galgas", 252))  COMMA_SOURCE_FILE ("type-struct.galgas", 250)) ;
}
...
static void extensionMethod_structTypeForGeneration_appendDeclaration_31_ (const cPtr_semanticDeclarationForGeneration * inObject,
  ...
  cEnumerator_typedPropertyList enumerator_11656 (temp_0.getter_mTypedPropertyList (HERE), kENUMERATION_UP) ;
  while (enumerator_11656.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName_31_ (enumerator_11656.current_mPropertyTypeEntry (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 291)) ;
...
static void extensionMethod_abstractExtensionGetterAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_3151, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_4.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-abstract-getter.galgas", 70)), inCompiler COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 70)), temp_5.getter_mTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 70)) COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 70)) ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
...
static void extensionMethod_abstractExtensionSetterAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_2380, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_4.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-abstract-setter.galgas", 50)), inCompiler COMMA_SOURCE_FILE ("extension-abstract-setter.galgas", 50)), temp_5.getter_mTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("extension-abstract-setter.galgas", 50)) COMMA_SOURCE_FILE ("extension-abstract-setter.galgas", 50)) ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
...
static void extensionMethod_extensionGetterAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_3539, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_4.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-getter.galgas", 78)), inCompiler COMMA_SOURCE_FILE ("extension-getter.galgas", 78)), temp_5.getter_mTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("extension-getter.galgas", 78)) COMMA_SOURCE_FILE ("extension-getter.galgas", 78)) ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
...
static void extensionMethod_extensionGetterAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_extensionGetterAST temp_0 = object ;
  const GALGAS_extensionGetterAST temp_1 = object ;
  GALGAS_lstring var_nameForUsefulness_5674 = function_getterNameForUsefulEntitiesGraph (temp_0.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-getter.galgas", 120)), temp_1.getter_mExtensionGetterName (HERE), inCompiler COMMA_SOURCE_FILE ("extension-getter.galgas", 120)) ;
  {
...
static void extensionMethod_extensionMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_3091, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_4.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-method.galgas", 66)), inCompiler COMMA_SOURCE_FILE ("extension-method.galgas", 66)), temp_5.getter_mTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("extension-method.galgas", 66)) COMMA_SOURCE_FILE ("extension-method.galgas", 66)) ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
...
static void extensionMethod_extensionMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_extensionMethodAST temp_0 = object ;
  const GALGAS_extensionMethodAST temp_1 = object ;
  GALGAS_lstring var_nameForUsefulness_5178 = function_methodNameForUsefulEntitiesGraph (temp_0.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-method.galgas", 107)), temp_1.getter_mExtensionMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("extension-method.galgas", 107)) ;
  {
...
static void extensionMethod_extensionSetterAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_3110, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_4.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-setter.galgas", 65)), inCompiler COMMA_SOURCE_FILE ("extension-setter.galgas", 65)), temp_5.getter_mTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("extension-setter.galgas", 65)) COMMA_SOURCE_FILE ("extension-setter.galgas", 65)) ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
...
static void extensionMethod_extensionSetterAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_extensionSetterAST temp_0 = object ;
  const GALGAS_extensionSetterAST temp_1 = object ;
  GALGAS_lstring var_nameForUsefulness_5195 = function_setterNameForUsefulEntitiesGraph (temp_0.getter_mTypeName (HERE).getter_string (SOURCE_FILE ("extension-setter.galgas", 106)), temp_1.getter_mExtensionSetterName (HERE), inCompiler COMMA_SOURCE_FILE ("extension-setter.galgas", 106)) ;
  {
...
static void extensionMethod_overridingAbstractExtensionMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_11) {
    ...
    if (kBoolTrue == test_11) {
      ...
      inCompiler->emitSemanticError (temp_12.getter_mOverridingExtensionMethodName (HERE).getter_location (SOURCE_FILE ("extension-overriding-abstract-method.galgas", 122)), GALGAS_string ("this getter is not declared by a super class"), fixItArray13  COMMA_SOURCE_FILE ("extension-overriding-abstract-method.galgas", 122)) ;
    }
  }
