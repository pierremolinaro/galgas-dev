...
void routine_generatePredefinedTypeFiles (const GALGAS_string constinArgument_inDirectory,
                                          ...
                                          C_Compiler * inCompiler
                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_generatedCode_68468 = GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1652))) ;
  ...
  while (enumerator_68597.hasCurrentObject ()) {
    const enumGalgasBool test_0 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_68597.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1654)).boolEnum () ;
    if (kBoolTrue == test_0) {
      callExtensionMethod_appendPrimitiveTypePreDeclaration ((const cPtr_semanticDeclarationForGeneration *) enumerator_68597.current_mDeclaration (HERE).ptr (), var_generatedCode_68468, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1655)) ;
    }
    enumerator_68597.gotoNextObject () ;
  }
  var_generatedCode_68468.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1658)) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_68800 (constinArgument_inSemanticDeclarationListForGeneration, kENUMERATION_UP) ;
  while (enumerator_68800.hasCurrentObject ()) {
    const enumGalgasBool test_1 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_68800.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1660)).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_generatedCode_68468.plusAssign_operation(callExtensionGetter_appendPrimitiveTypeDeclaration ((const cPtr_semanticDeclarationForGeneration *) enumerator_68800.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1661)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1661)) ;
    }
    enumerator_68800.gotoNextObject () ;
  }
  cEnumerator_semanticDeclarationListForGeneration enumerator_68977 (constinArgument_inSemanticDeclarationListForGeneration, kENUMERATION_UP) ;
  while (enumerator_68977.hasCurrentObject ()) {
    const enumGalgasBool test_2 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_68977.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1665)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_stringset joker_69062 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 1666)) ;
      GALGAS_string var_code_69081 ;
      callExtensionMethod_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_68977.current_mDeclaration (HERE).ptr (), joker_69062, var_code_69081, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1666)) ;
      var_generatedCode_68468.plusAssign_operation(var_code_69081, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1667)) ;
    }
    enumerator_68977.gotoNextObject () ;
  }
  var_generatedCode_68468.plusAssign_operation(GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_predefinedTypeSeparation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1670))), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1670)) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_69266 (constinArgument_inSemanticDeclarationListForGeneration, kENUMERATION_UP) ;
  while (enumerator_69266.hasCurrentObject ()) {
    const enumGalgasBool test_3 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_69266.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1672)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_stringset joker_69364 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 1673)) ;
      GALGAS_string var_headerString_32__69392 ;
      callExtensionMethod_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_69266.current_mDeclaration (HERE).ptr (), constinArgument_inDirectory, joker_69364, var_headerString_32__69392, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1673)) ;
      var_generatedCode_68468.plusAssign_operation(var_headerString_32__69392, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1674)) ;
    }
    enumerator_69266.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_4) {
    ...
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inDirectory, GALGAS_string ("all-predefined-types.h"), GALGAS_string ("//"), GALGAS_string::makeEmptyString (), GALGAS_string ("\n"
      "\n"), var_generatedCode_68468, GALGAS_string ("\n"
      "\n"), GALGAS_string ("#endif\n"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1680)) ;
    }
  }
  var_generatedCode_68468 = GALGAS_string (filewrapperTemplate_predefinedTypeGenerationTemplate_predefinedTypesImplementation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1693))) ;
  cEnumerator_semanticDeclarationListForGeneration enumerator_70194 (constinArgument_inSemanticDeclarationListForGeneration, kENUMERATION_UP) ;
  while (enumerator_70194.hasCurrentObject ()) {
    const enumGalgasBool test_5 = callExtensionGetter_isPredefined ((const cPtr_semanticDeclarationForGeneration *) enumerator_70194.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1695)).boolEnum () ;
    if (kBoolTrue == test_5) {
      var_generatedCode_68468.plusAssign_operation(callExtensionGetter_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_70194.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1696)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1696)) ;
      GALGAS_stringset joker_70385 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 1697)) ;
      GALGAS_string var_code_70404 ;
      callExtensionMethod_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_70194.current_mDeclaration (HERE).ptr (), GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("semanticGeneration.galgas", 1697)), joker_70385, var_code_70404, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1697)) ;
      var_generatedCode_68468.plusAssign_operation(var_code_70404, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 1698)) ;
    }
    enumerator_70194.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      while (enumerator_15050.hasCurrentObject () && enumerator_15084.hasCurrentObject ()) {
        ...
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_15084.current_mFormalSelector (HERE).getter_string (HERE).objectCompare (enumerator_15050.current_mActualSelector (HERE).getter_string (HERE))).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_string temp_5 ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_15084.current_mFormalSelector (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
...
static void extensionMethod_selfIncDecNoOVFInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_selfObjectCppName_8007 = constinArgument_inAnalysisContext.getter_mSelfObjectCppName (HERE) ;
    var_selfTypeProxy_7979 = constinArgument_inAnalysisContext.getter_mSelfTypeProxy (HERE) ;
  }
...
static void extensionMethod_selfIncDecInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_selfObjectCppName_9372 = constinArgument_inAnalysisContext.getter_mSelfObjectCppName (HERE) ;
    var_selfTypeProxy_9344 = constinArgument_inAnalysisContext.getter_mSelfTypeProxy (HERE) ;
  }
...
static void extensionMethod_selfMinusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_selfObjectCppName_10769 = constinArgument_inAnalysisContext.getter_mSelfObjectCppName (HERE) ;
    var_selfTypeProxy_10741 = constinArgument_inAnalysisContext.getter_mSelfTypeProxy (HERE) ;
  }
...
static void extensionMethod_selfMulEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_selfObjectCppName_12571 = constinArgument_inAnalysisContext.getter_mSelfObjectCppName (HERE) ;
    var_selfTypeProxy_12543 = constinArgument_inAnalysisContext.getter_mSelfTypeProxy (HERE) ;
  }
...
static void extensionMethod_selfDivEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_selfObjectCppName_14369 = constinArgument_inAnalysisContext.getter_mSelfObjectCppName (HERE) ;
    var_selfTypeProxy_14341 = constinArgument_inAnalysisContext.getter_mSelfTypeProxy (HERE) ;
  }
...
static void extensionMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_9444.hasCurrentObject ()) {
    var_localConstantList_9367.addAssign_operation (enumerator_9444.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (enumerator_9444.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("instruction-with.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 252)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 252)), GALGAS_bool (true), var_objectArrayCppName_8920.add_operation (GALGAS_string ("->mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 254)).add_operation (enumerator_9444.current_mAttributeName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 254)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 254))  COMMA_SOURCE_FILE ("instruction-with.galgas", 250)) ;
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readOnlyWithInstructionForGeneration::constructor_new (object->mProperty_mInstructionLocation, var_receiverExpression_8065, var_objectArrayCppName_8920, var_keyExpression_8864, object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE), var_do_5F_instructionList_10351, var_else_5F_instructionList_10718  COMMA_SOURCE_FILE ("instruction-with.galgas", 287))  COMMA_SOURCE_FILE ("instruction-with.galgas", 287)) ;
}
...
static void extensionMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_7) {
    ...
    if (enumerator_13312.hasCurrentObject () && bool_8) {
      while (enumerator_13312.hasCurrentObject () && bool_8) {
        var_found_13256 = GALGAS_bool (kIsEqual, enumerator_13312.current_mSearchMethodName (HERE).getter_string (HERE).objectCompare (object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE))) ;
  ...
  while (enumerator_13840.hasCurrentObject ()) {
    var_localInitializedVariableList_13783.addAssign_operation (enumerator_13840.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (enumerator_13840.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("instruction-with.galgas", 363)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 363)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 363)), var_objectArrayCppName_12326.add_operation (GALGAS_string ("->mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 364)).add_operation (enumerator_13840.current_mAttributeName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 364)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 364))  COMMA_SOURCE_FILE ("instruction-with.galgas", 361)) ;
  ...
  temp_11.addAssign_operation (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.getter_mSemanticContext (HERE).getter_mTypeMap (HERE), GALGAS_string ("lstring").getter_nowhere (SOURCE_FILE ("instruction-with.galgas", 367)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 367)), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (GALGAS_string ("lkey"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 368)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 368)), GALGAS_bool (true), var_objectArrayCppName_12326.add_operation (GALGAS_string ("->mProperty_lkey"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 370))  COMMA_SOURCE_FILE ("instruction-with.galgas", 370)) ;
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readWriteWithInstructionForGeneration::constructor_new (object->mProperty_mInstructionLocation, var_receiverVariableCppName_12572, var_targetType_12531, object->mProperty_mFieldList, var_objectArrayCppName_12326, var_keyExpression_11791, object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE), var_do_5F_instructionList_14701, var_else_5F_instructionList_14783  COMMA_SOURCE_FILE ("instruction-with.galgas", 398))  COMMA_SOURCE_FILE ("instruction-with.galgas", 398)) ;
}
