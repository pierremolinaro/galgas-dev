...
static void extensionMethod_errorInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mReceiverExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_16437, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 402)) ;
  GALGAS_string var_messageCppVarName_16639 ;
  callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mErrorExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_messageCppVarName_16639, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 410)) ;
  GALGAS_string var_fixItArrayCppName_16887 ;
  extensionMethod_generateFixIt (object->mAttribute_mFixitListForGeneration, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, constinArgument_inGenerateSyntaxDirectedTranslationString, ioArgument_ioGeneratedCode, var_fixItArrayCppName_16887, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 418)) ;
  {
  ...
  cEnumerator_stringlist enumerator_17269 (object->mAttribute_mBuiltVariableCppNameList, kENUMERATION_UP) ;
...
static void extensionMethod_forInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_24809 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
  ...
  cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_25082 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
  ...
  GALGAS_bool var_whileExpressionIsAllwaysTrue_25413 = callExtensionGetter_isTrueExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), inCompiler COMMA_SOURCE_FILE ("instruction-for.galgas", 661)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVar_26050, inCompiler COMMA_SOURCE_FILE ("instruction-for.galgas", 673)) ;
    ...
    cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_26365 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_26838 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_27289 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    if (kBoolTrue == test_4) {
      ...
      cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_27653 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
      ...
      callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mWhileExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_whileVar_27832, inCompiler COMMA_SOURCE_FILE ("instruction-for.galgas", 720)) ;
    ...
    if (kBoolTrue == test_5) {
      ...
      cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_28314 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_29464 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    if (kBoolTrue == test_7) {
      ...
      cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_30075 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
    ...
    cEnumerator_forInstructionEnumeratedObjectListForGeneration enumerator_30631 (object->mAttribute_mEnumeratedObjectList, kENUMERATION_UP) ;
...
static void extensionMethod_nonterminalCallInstruction_analyzeSyntaxInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  constinArgument_inNonterminalMap.method_searchKey (object->mAttribute_mNonterminalName, var_labelMap_4045, inCompiler COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 90)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    var_labelMap_4045.method_searchKey (object->mAttribute_mLabelName, joker_4189, var_signature_4084, joker_4203, inCompiler COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 95)) ;
  }
  GALGAS_actualParameterListForGeneration var_actualParameterListForGeneration_4600 ;
  {
  routine_analyzeRoutineArguments (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, object->mAttribute_mNonterminalName, GALGAS_string ("'<").add_operation (object->mAttribute_mNonterminalName.getter_string (SOURCE_FILE ("instruction-non-terminal.galgas", 103)), inCompiler COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 103)).add_operation (GALGAS_string (">' nonterminal declaration"), inCompiler COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 103)), var_signature_4084, object->mAttribute_mActualParameterList, ioArgument_ioVariableMap, ioArgument_ioInstructionListForGeneration, var_actualParameterListForGeneration_4600, inCompiler  COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 98)) ;
  }
  callExtensionMethod_analyzeSDT ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult.ptr (), constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 111)) ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_nonterminalInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName.getter_string (SOURCE_FILE ("instruction-non-terminal.galgas", 119)), object->mAttribute_mLabelName.getter_string (SOURCE_FILE ("instruction-non-terminal.galgas", 120)), var_actualParameterListForGeneration_4600, object->mAttribute_mGrammarInstructionSyntaxDirectedTranslationResult  COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 117))  COMMA_SOURCE_FILE ("instruction-non-terminal.galgas", 117)) ;
}
