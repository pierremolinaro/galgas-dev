...
static void extensionMethod_incDecNoOVFInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_6811.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap_6835 = var_targetType_6648.getter_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("instruction-inc-dec.galgas", 200)) ;
          ...
          if (kBoolTrue == test_7) {
            ...
            if (kBoolTrue == test_9) {
              ...
              while (enumerator_7212.hasCurrentObject () && enumerator_7247.hasCurrentObject ()) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_7247.current_mExtractedValueTypeName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_7212.current_mType (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 189)).objectCompare (enumerator_7247.current_mExtractedValueTypeName (HERE).getter_string (HERE))).boolEnum () ;
                ...
                const enumGalgasBool test_16 = var_firstConstant_5980.operator_and (GALGAS_bool (kIsNotEqual, enumerator_7247.current_mExtractedValueName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("instruction-switch.galgas", 193)).boolEnum () ;
...
static void extensionMethod_switchInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_11331.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_type_11697 = GALGAS_string ("const cEnumAssociatedValues_").add_operation (object->mProperty_mEnumType.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 295)), inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 295)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 295)).add_operation (enumerator_11331.current_mSwitchConstantList (HERE).getter_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 296)).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 296)).add_operation (GALGAS_string (" *"), inCompiler COMMA_SOURCE_FILE ("instruction-switch.galgas", 296)) ;
...
static void extensionMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  while (enumerator_9438.hasCurrentObject ()) {
    var_localConstantList_9361.addAssign_operation (enumerator_9438.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (enumerator_9438.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("instruction-with.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 252)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 252)), GALGAS_bool (true), var_objectArrayCppName_8920.add_operation (GALGAS_string ("->mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 254)).add_operation (enumerator_9438.current_mAttributeName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 254)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 254))  COMMA_SOURCE_FILE ("instruction-with.galgas", 250)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList_10345 ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, var_localConstantList_9361, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 267)), object->mProperty_mDoBranchInstructions, object->mProperty_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList_10345, inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 262)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList_10712 ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 278)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 279)), object->mProperty_mElseBranchInstructions, object->mProperty_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList_10712, inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 274)) ;
  }
  {
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readOnlyWithInstructionForGeneration::constructor_new (object->mProperty_mInstructionLocation, var_receiverExpression_8065, var_objectArrayCppName_8920, var_keyExpression_8864, object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE), var_do_5F_instructionList_10345, var_else_5F_instructionList_10712  COMMA_SOURCE_FILE ("instruction-with.galgas", 287))  COMMA_SOURCE_FILE ("instruction-with.galgas", 287)) ;
}
...
static void extensionMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_keyExpression_11785.getter_mResultType (SOURCE_FILE ("instruction-with.galgas", 316)).getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 316)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mEndOfKeyExpression, GALGAS_string ("the key type is '@").add_operation (var_keyExpression_11785.getter_mResultType (SOURCE_FILE ("instruction-with.galgas", 317)).getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 317)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 317)).add_operation (GALGAS_string ("', it should be '@string'"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 317)), fixItArray2  COMMA_SOURCE_FILE ("instruction-with.galgas", 317)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_keyExpression_11785.getter_mResultType (SOURCE_FILE ("instruction-with.galgas", 319)).getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 319)).objectCompare (GALGAS_string ("lstring"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (object->mProperty_mEndOfKeyExpression, GALGAS_string ("the key type is '@").add_operation (var_keyExpression_11785.getter_mResultType (SOURCE_FILE ("instruction-with.galgas", 320)).getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 320)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 320)).add_operation (GALGAS_string ("', it should be '@lstring'"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 320)), fixItArray4  COMMA_SOURCE_FILE ("instruction-with.galgas", 320)) ;
    }
  }
  GALGAS_string var_objectArrayCppName_12320 = GALGAS_string ("objectArray_").add_operation (object->mProperty_mInstructionLocation.getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 323)).getter_string (SOURCE_FILE ("instruction-with.galgas", 323)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 323)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_targetType_12525 ;
  GALGAS_string var_receiverVariableCppName_12566 ;
  {
  GALGAS_string joker_12572 ; // Joker input parameter
  ioArgument_ioVariableMap.setter_searchForReadWriteAccess (object->mProperty_mReceiverName, var_targetType_12525, var_receiverVariableCppName_12566, joker_12572, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 325)) ;
  }
  cEnumerator_lstringlist enumerator_12600 (object->mProperty_mFieldList, kENUMERATION_UP) ;
  while (enumerator_12600.hasCurrentObject ()) {
    GALGAS_attributeMap var_attributeMap_12624 = var_targetType_12525.getter_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 332)) ;
    var_attributeMap_12624.method_searchKey (enumerator_12600.current_mValue (HERE), var_targetType_12525, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 333)) ;
    enumerator_12600.gotoNextObject () ;
  }
  const enumGalgasBool test_5 = var_targetType_12525.getter_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 339)).getter_supportWithAccessor (SOURCE_FILE ("instruction-with.galgas", 339)).operator_not (SOURCE_FILE ("instruction-with.galgas", 339)).boolEnum () ;
  if (kBoolTrue == test_5) {
    TC_Array <C_FixItDescription> fixItArray6 ;
    inCompiler->emitSemanticError (object->mProperty_mEndOfReceiverExpression, GALGAS_string ("the '@").add_operation (var_targetType_12525.getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 340)).add_operation (GALGAS_string ("' type cannot be used in a 'with' instruction"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 340)), fixItArray6  COMMA_SOURCE_FILE ("instruction-with.galgas", 340)) ;
  }
  ...
  if (kBoolTrue == test_7) {
    GALGAS_bool var_found_13059 = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_13115 (var_targetType_12525.getter_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 345)), kENUMERATION_UP) ;
    bool bool_8 = var_found_13059.operator_not (SOURCE_FILE ("instruction-with.galgas", 345)).isValidAndTrue () ;
    if (enumerator_13115.hasCurrentObject () && bool_8) {
      while (enumerator_13115.hasCurrentObject () && bool_8) {
        var_found_13059 = GALGAS_bool (kIsEqual, enumerator_13115.current_mSearchMethodName (HERE).getter_string (HERE).objectCompare (object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE))) ;
        enumerator_13115.gotoNextObject () ;
        if (enumerator_13115.hasCurrentObject ()) {
          bool_8 = var_found_13059.operator_not (SOURCE_FILE ("instruction-with.galgas", 345)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_9 = var_found_13059.operator_not (SOURCE_FILE ("instruction-with.galgas", 348)).boolEnum () ;
    if (kBoolTrue == test_9) {
      TC_Array <C_FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (object->mProperty_mSearchMethodNameForErrorSignaling.getter_location (SOURCE_FILE ("instruction-with.galgas", 349)), GALGAS_string ("there is no '").add_operation (object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (SOURCE_FILE ("instruction-with.galgas", 349)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 349)).add_operation (GALGAS_string ("' search method declared in the '@"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 349)).add_operation (var_targetType_12525.getter_key (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 349)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 349)).add_operation (GALGAS_string ("' map"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 349)), fixItArray10  COMMA_SOURCE_FILE ("instruction-with.galgas", 349)) ;
    }
  }
  {
  ioArgument_ioVariableMap.setter_openOverrideForSelectBlock (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 353)) ;
  }
  GALGAS_localInitializedVariableList var_localInitializedVariableList_13586 = GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 355)) ;
  cEnumerator_typedPropertyList enumerator_13643 (var_targetType_12525.getter_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 356)), kENUMERATION_UP) ;
  while (enumerator_13643.hasCurrentObject ()) {
    var_localInitializedVariableList_13586.addAssign_operation (enumerator_13643.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (enumerator_13643.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("instruction-with.galgas", 359)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 359)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 359)), var_objectArrayCppName_12320.add_operation (GALGAS_string ("->mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 360)).add_operation (enumerator_13643.current_mAttributeName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 360)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 360))  COMMA_SOURCE_FILE ("instruction-with.galgas", 357)) ;
  ...
  temp_11.addAssign_operation (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.getter_mSemanticContext (HERE).getter_mTypeMap (HERE), GALGAS_string ("lstring").getter_nowhere (SOURCE_FILE ("instruction-with.galgas", 363)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 363)), GALGAS_lstring::constructor_new (object->mProperty_mPrefix.getter_string (HERE).add_operation (GALGAS_string ("lkey"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 364)), object->mProperty_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("instruction-with.galgas", 364)), GALGAS_bool (true), var_objectArrayCppName_12320.add_operation (GALGAS_string ("->mProperty_lkey"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 366))  COMMA_SOURCE_FILE ("instruction-with.galgas", 366)) ;
  GALGAS_localConstantList var_localConstantList_13907 = temp_11 ;
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList_14504 ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, var_localConstantList_13907, var_localInitializedVariableList_13586, object->mProperty_m_5F_do_5F_Instructions, object->mProperty_mEndOf_5F_do_5F_instructions, ioArgument_ioVariableMap, var_do_5F_instructionList_14504, inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 368)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList_14586 ;
  {
  routine_analyzeSemanticInstructionList (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 385)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("instruction-with.galgas", 386)), object->mProperty_m_5F_else_5F_Instructions, object->mProperty_mEndOf_5F_else_5F_instructions, ioArgument_ioVariableMap, var_else_5F_instructionList_14586, inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 381)) ;
  }
  {
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_readWriteWithInstructionForGeneration::constructor_new (object->mProperty_mInstructionLocation, var_receiverVariableCppName_12566, var_targetType_12525, object->mProperty_mFieldList, var_objectArrayCppName_12320, var_keyExpression_11785, object->mProperty_mSearchMethodNameForErrorSignaling.getter_string (HERE), var_do_5F_instructionList_14504, var_else_5F_instructionList_14586  COMMA_SOURCE_FILE ("instruction-with.galgas", 394))  COMMA_SOURCE_FILE ("instruction-with.galgas", 394)) ;
}
...
static void extensionMethod_readOnlyWithInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_receiverVarCppName_17295 ;
  callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mProperty_mReceiverExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverVarCppName_17295, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 445)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_receiverType_17315 = object->mProperty_mReceiverExpression.getter_mResultType (SOURCE_FILE ("instruction-with.galgas", 446)) ;
  GALGAS_string var_keyVarCppName_17526 ;
  callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mProperty_mKeyExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_keyVarCppName_17526, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 448)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("const cMapElement_").add_operation (var_receiverType_17315.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 450)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 450)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 450)).add_operation (object->mProperty_mObjectArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 451)).add_operation (GALGAS_string (" = (const cMapElement_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 451)).add_operation (var_receiverType_17315.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 451)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 451)).add_operation (GALGAS_string (" *) "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 451)).add_operation (var_receiverVarCppName_17295, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 452)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 452)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 450)) ;
  ...
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("readAccessForWithInstruction (").add_operation (var_keyVarCppName_17526, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 454)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 454)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 454)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("performSearch (").add_operation (var_keyVarCppName_17526, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 456)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 456)).add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 457)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 457)).add_operation (GALGAS_string (", kSearchErrorMessage_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 457)).add_operation (var_receiverType_17315.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 458)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 458)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 458)).add_operation (object->mProperty_mSearchMethodNameForErrorSignaling, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 458)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 458)).add_operation (extensionGetter_commaSourceFile (object->mProperty_mInstructionLocation, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 459)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 459)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 459)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 456)) ;
    {
...
static void extensionMethod_readWriteWithInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_string var_receiverCppName_19502 = object->mProperty_mReceiverVariableCppName ;
  cEnumerator_lstringlist enumerator_19562 (object->mProperty_mStructAttributeList, kENUMERATION_UP) ;
  while (enumerator_19562.hasCurrentObject ()) {
    var_receiverCppName_19502.plusAssign_operation(GALGAS_string (".mProperty_").add_operation (enumerator_19562.current_mValue (HERE).getter_string (SOURCE_FILE ("instruction-with.galgas", 496)).getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 496)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 496)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 496)) ;
    enumerator_19562.gotoNextObject () ;
  }
  GALGAS_string var_keyVarCppName_19828 ;
  callExtensionMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mProperty_mKeyExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_keyVarCppName_19828, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 499)) ;
  {
  ...
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("cMapElement_").add_operation (object->mProperty_mReceiverType.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 503)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 503)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 503)).add_operation (object->mProperty_mObjectArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 504)).add_operation (GALGAS_string (" = (cMapElement_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 504)).add_operation (object->mProperty_mReceiverType.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 504)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 504)).add_operation (GALGAS_string (" *) "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 504)).add_operation (var_receiverCppName_19502, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 505)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 505)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 503)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mProperty_mSearchMethodNameForErrorSignaling.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("readWriteAccessForWithInstruction (").add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 507)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 507)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 507)).add_operation (var_keyVarCppName_19828, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 507)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 507)) ;
  }else if (kBoolFalse == test_0) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("readWriteAccessForWithInstructionWithErrorMessage (").add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 509)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 509)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 509)).add_operation (var_keyVarCppName_19828, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 509)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 509)) ;
...
static void extensionMethod_terminalCheckInstructionForGeneration_generateInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_10971.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 249)).add_operation (GALGAS_string ("->enterIndexing (C_Lexique_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 249)).add_operation (object->mProperty_mLexiqueIdentifier, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 250)).add_operation (GALGAS_string ("::kIndexing_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 250)).add_operation (enumerator_10971.current_mValue_30_ (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 250)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 250)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 250)).add_operation (enumerator_10971.current_mValue_31_ (HERE).getter_string (HERE).getter_utf_38_Representation (SOURCE_FILE ("instruction-terminal.galgas", 251)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 251)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 251)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 249)) ;
    enumerator_10971.gotoNextObject () ;
  }
  callExtensionMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mProperty_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->preceedingSeparatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 254)) ;
  callExtensionMethod_generateCode ((const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) object->mProperty_mGrammarInstructionSyntaxDirectedTranslationToken.ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 260)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 267)) COMMA_SOURCE_FILE ("instruction-terminal.galgas", 267)) ;
  }
  ioArgument_ioGeneratedCode.plusAssign_operation(function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 268)).add_operation (GALGAS_string ("->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 268)).add_operation (object->mProperty_mLexiqueIdentifier, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 268)).add_operation (GALGAS_string ("::kToken_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 269)).add_operation (object->mProperty_mTerminalName.getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 269)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 269)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 269)).add_operation (extensionGetter_commaSourceFile (object->mProperty_mInstructionLocation, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 270)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 270)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 268)) ;
}
...
void routine_parseAndAnalyzeProject (const GALGAS_lstring constinArgument_inProjectSourceFile,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_application::constructor_verboseOutput (SOURCE_FILE ("galgas_prgm.galgas", 128)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("*** Parsing project files\n")  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 129)) ;
  }
  GALGAS_galgas_33_ProjectComponentAST var_projectComponentAST_7606 ;
  var_projectComponentAST_7606.drop () ;
  cGrammar_galgas_33_ProjectGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inProjectSourceFile, var_projectComponentAST_7606  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 131)) ;
  ...
  if (kBoolTrue == test_1) {
    {
    routine_compileProject (constinArgument_inProjectSourceFile, constinArgument_inSourceToAnalyze, var_projectComponentAST_7606, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 133)) ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 135)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_cppCompilationTarget_7812 = GALGAS_string (gOption_galgas_5F_cli_5F_options_cppCompile.getter_value ()) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_cppCompilationTarget_7812.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        const enumGalgasBool test_4 = GALGAS_application::constructor_verboseOutput (SOURCE_FILE ("galgas_prgm.galgas", 138)).boolEnum () ;
        if (kBoolTrue == test_4) {
          inCompiler->printMessage (GALGAS_string ("*** Perform C++ compilation\n")  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 139)) ;
        }
        GALGAS_string var_buildFile_8027 = constinArgument_inProjectSourceFile.getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 141)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 141)).add_operation (var_cppCompilationTarget_7812, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 141)).add_operation (GALGAS_string ("/build.py"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 141)) ;
        const enumGalgasBool test_5 = var_buildFile_8027.getter_fileExists (SOURCE_FILE ("galgas_prgm.galgas", 142)).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_sint var_resultCode_8192 = GALGAS_string ("python ").add_operation (var_buildFile_8027, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 143)).getter_system (SOURCE_FILE ("galgas_prgm.galgas", 143)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_resultCode_8192.objectCompare (GALGAS_sint ((int32_t) 0L))).boolEnum () ;
          if (kBoolTrue == test_6) {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticError (GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgas_prgm.galgas", 145)).getter_location (SOURCE_FILE ("galgas_prgm.galgas", 145)), GALGAS_string ("Running '").add_operation (var_buildFile_8027, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 145)).add_operation (GALGAS_string ("' returns "), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 145)).add_operation (var_resultCode_8192.getter_string (SOURCE_FILE ("galgas_prgm.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 145)), fixItArray7  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 145)) ;
          }
        }else if (kBoolFalse == test_5) {
          TC_Array <C_FixItDescription> fixItArray8 ;
          inCompiler->emitSemanticError (GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgas_prgm.galgas", 148)).getter_location (SOURCE_FILE ("galgas_prgm.galgas", 148)), GALGAS_string ("Cannot perform C++ compilation of '").add_operation (var_cppCompilationTarget_7812, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 148)).add_operation (GALGAS_string ("' : the '"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 148)).add_operation (var_buildFile_8027, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 149)).add_operation (GALGAS_string ("' file does not exist"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 149)), fixItArray8  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 148)) ;
        }
      }
    }
  }
...
void routine_compileProject (const GALGAS_lstring constinArgument_inProjectSourceFile,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_galgas_33_DeclarationAST var_declarationAST_8885 = GALGAS_galgas_33_DeclarationAST::constructor_default (SOURCE_FILE ("galgas_prgm.galgas", 163)) ;
  cEnumerator_lstringlist enumerator_8949 (constinArgument_inProjectComponentAST.getter_mProjectSourceList (HERE), kENUMERATION_UP) ;
  while (enumerator_8949.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_8949.current_mValue (HERE).getter_string (HERE).getter_pathExtension (SOURCE_FILE ("galgas_prgm.galgas", 165)).objectCompare (GALGAS_string ("galgas"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteSourcePath_9028 = enumerator_8949.current_mValue (HERE).getter_string (HERE).getter_absolutePathFromPath (constinArgument_inProjectSourceFile.getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 166)) COMMA_SOURCE_FILE ("galgas_prgm.galgas", 166)) ;
      cGrammar_galgas_33_Grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absoluteSourcePath_9028, enumerator_8949.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 167)), var_declarationAST_8885  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 167)) ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (enumerator_8949.current_mValue (HERE).getter_location (SOURCE_FILE ("galgas_prgm.galgas", 169)), GALGAS_string ("only \".galgas\" extension is allowed here"), fixItArray1  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 169)) ;
    }
    enumerator_8949.gotoNextObject () ;
  }
  GALGAS_stringlist var_handCodedLinkAppFileList_9405 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 173)) ;
  GALGAS_stringlist var_handCodedSourceAppFileList_9451 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 174)) ;
  GALGAS_stringlist var_handCodedSourceToolFileList_9498 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 175)) ;
  GALGAS_stringlist var_frameworkToolFileList_9539 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 176)) ;
  GALGAS_stringset var_handCodedSourceDirectorySet_9585 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.galgas", 177)) ;
  cEnumerator_galgas_33_QualifiedFeatureList enumerator_9646 (constinArgument_inProjectComponentAST.getter_mQualifiedFeatureList (HERE), kENUMERATION_UP) ;
  while (enumerator_9646.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("tool-source").objectCompare (enumerator_9646.current_mFeatureName (HERE).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 179)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_handCodedSourceToolFileList_9498.addAssign_operation (enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 180)) ;
      GALGAS_string var_directory_9770 = enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 181)) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_directory_9770.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_handCodedSourceDirectorySet_9585.addAssign_operation (GALGAS_string ("../")  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 183)) ;
      }else if (kBoolFalse == test_3) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_directory_9770.getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 184)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          var_handCodedSourceDirectorySet_9585.addAssign_operation (GALGAS_string ("../").add_operation (var_directory_9770, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 185))  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 185)) ;
        }else if (kBoolFalse == test_4) {
          var_handCodedSourceDirectorySet_9585.addAssign_operation (var_directory_9770  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 187)) ;
        }
      }
    }else if (kBoolFalse == test_2) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_9646.current_mFeatureName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("tool-framework"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        var_frameworkToolFileList_9539.addAssign_operation (enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE).getter_lastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 190))  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 190)) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_9646.current_mFeatureName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("app-source"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          var_handCodedSourceAppFileList_9451.addAssign_operation (enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 192)) ;
          GALGAS_string var_directory_10333 = enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 193)) ;
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_directory_10333.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_handCodedSourceDirectorySet_9585.addAssign_operation (GALGAS_string ("../")  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 195)) ;
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_directory_10333.getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 196)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet_9585.addAssign_operation (GALGAS_string ("../").add_operation (var_directory_10333, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 197))  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 197)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet_9585.addAssign_operation (var_directory_10333  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 199)) ;
            }
          }
        }else if (kBoolFalse == test_6) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_9646.current_mFeatureName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("app-link"))).boolEnum () ;
          if (kBoolTrue == test_9) {
            var_handCodedLinkAppFileList_9405.addAssign_operation (enumerator_9646.current_mFeatureValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 202)) ;
          }
        }
      }
    }
  ...
  {
  routine_groupSyntaxComponentsGalgas_33_ (var_declarationAST_8885.getter_mSyntaxComponentList (HERE), var_declarationAST_8885.getter_mSyntaxExtensions (HERE), var_declarationAST_8885.mProperty_mDeclarationList, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 218)) ;
  }
  GALGAS_usefulEntitiesGraph var_usefulEntitiesGraph_12043 = GALGAS_usefulEntitiesGraph::constructor_emptyGraph (SOURCE_FILE ("galgas_prgm.galgas", 224)) ;
  GALGAS_lstringlist var_usefulnessRootEntities_12095 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 225)) ;
  GALGAS_string var_buildDirectory_12121 = constinArgument_inProjectSourceFile.getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 226)).add_operation (GALGAS_string ("/build"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 226)) ;
  GALGAS_string var_productDirectory_12213 = var_buildDirectory_12121.add_operation (GALGAS_string ("/output"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 227)) ;
  GALGAS_stringlist var_appProductFileList_12275 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 228)) ;
  GALGAS_semanticContext var_semanticContext_12315 = GALGAS_semanticContext::constructor_default (SOURCE_FILE ("galgas_prgm.galgas", 229)) ;
  GALGAS_semanticDeclarationListForGeneration var_semanticDeclarationSortedListForGeneration_12409 ;
  const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 231)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_10) {
    {
    routine_compileSemanticDeclarationsGalgas_33_ (var_usefulnessRootEntities_12095, var_usefulEntitiesGraph_12043, var_productDirectory_12213, constinArgument_inProjectComponentAST.getter_mEndOfSourceFile (HERE), var_declarationAST_8885.getter_mDeclarationList (HERE), var_semanticContext_12315, var_semanticDeclarationSortedListForGeneration_12409, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 232)) ;
    }
  }else if (kBoolFalse == test_10) {
    var_semanticDeclarationSortedListForGeneration_12409 = GALGAS_semanticDeclarationListForGeneration::constructor_emptyList (SOURCE_FILE ("galgas_prgm.galgas", 242)) ;
  }
  GALGAS_optionComponentMapForGeneration var_optionComponentMapForGeneration_12920 ;
  const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 246)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_11) {
    {
    routine_compileAllGuiComponentFromASTGalgas_33_ (var_declarationAST_8885.getter_mGUIComponentList (HERE), var_semanticContext_12315, var_optionComponentMapForGeneration_12920, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 247)) ;
    }
  }else if (kBoolFalse == test_11) {
    var_optionComponentMapForGeneration_12920 = GALGAS_optionComponentMapForGeneration::constructor_emptyMap (SOURCE_FILE ("galgas_prgm.galgas", 253)) ;
  }
  const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 256)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_12) {
    GALGAS_string var_projectVersionString_13283 = constinArgument_inProjectComponentAST.getter_mMajorVersion (HERE).getter_uint (SOURCE_FILE ("galgas_prgm.galgas", 257)).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 257)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 257)).add_operation (constinArgument_inProjectComponentAST.getter_mMinorVersion (HERE).getter_uint (SOURCE_FILE ("galgas_prgm.galgas", 258)).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 258)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 258)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 258)).add_operation (constinArgument_inProjectComponentAST.getter_mRevisionVersion (HERE).getter_uint (SOURCE_FILE ("galgas_prgm.galgas", 259)).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 259)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 259)) ;
    GALGAS_programComponentForGeneration var_programComponentForGeneration_13805 ;
    {
    routine_compileProgramComponentGalgas_33_ (var_usefulnessRootEntities_12095, var_usefulEntitiesGraph_12043, var_declarationAST_8885.getter_mPrologueDeclarationList (HERE), var_declarationAST_8885.getter_mSourceRuleList (HERE), var_declarationAST_8885.getter_mEpilogueDeclarationList (HERE), var_semanticContext_12315, var_projectVersionString_13283, var_programComponentForGeneration_13805, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 260)) ;
    }
    var_semanticDeclarationSortedListForGeneration_12409.addAssign_operation (GALGAS_string ("zprogram"), var_programComponentForGeneration_13805  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 270)) ;
  }
  {
  routine_checkUsefulEntities (var_usefulEntitiesGraph_12043, var_usefulnessRootEntities_12095, var_productDirectory_12213, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 276)) ;
  }
  GALGAS_string var_typeDumpFilePath_14172 = constinArgument_inProjectSourceFile.getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 278)).add_operation (GALGAS_string ("/build/helpers/"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 278)).add_operation (constinArgument_inProjectSourceFile.getter_string (HERE).getter_lastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 279)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 279)).add_operation (GALGAS_string (".html"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 279)) ;
  const enumGalgasBool test_13 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.getter_value ()).boolEnum () ;
  if (kBoolTrue == test_13) {
    GALGAS_stringset var_firstLetterSet_14409 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.galgas", 281)) ;
    cEnumerator_unifiedTypeMap enumerator_14453 (var_semanticContext_12315.getter_mTypeMap (HERE), kENUMERATION_UP) ;
    while (enumerator_14453.hasCurrentObject ()) {
      var_firstLetterSet_14409.addAssign_operation (enumerator_14453.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 283)).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 283))  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 283)) ;
      enumerator_14453.gotoNextObject () ;
    }
    GALGAS_string var_tableOfTypeString_14561 = GALGAS_string::makeEmptyString () ;
    GALGAS_char var_currentFirstLetter_14595 = GALGAS_char (TO_UNICODE (32)) ;
    cEnumerator_unifiedTypeMap enumerator_14646 (var_semanticContext_12315.getter_mTypeMap (HERE), kENUMERATION_UP) ;
    while (enumerator_14646.hasCurrentObject ()) {
      const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter_14595.objectCompare (enumerator_14646.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 288)))).boolEnum () ;
      if (kBoolTrue == test_14) {
        var_currentFirstLetter_14595 = enumerator_14646.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 289)) ;
        var_tableOfTypeString_14561.plusAssign_operation(GALGAS_string ("<br><a name=\"").add_operation (var_currentFirstLetter_14595.getter_uint (SOURCE_FILE ("galgas_prgm.galgas", 290)).getter_string (SOURCE_FILE ("galgas_prgm.galgas", 290)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 290)).add_operation (GALGAS_string ("\"><b>"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 290)).add_operation (var_currentFirstLetter_14595.getter_string (SOURCE_FILE ("galgas_prgm.galgas", 290)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 290)).add_operation (GALGAS_string ("</b></a><br>"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 290)), inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 290)) ;
      }
      var_tableOfTypeString_14561.plusAssign_operation(function_linkForType (enumerator_14646.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 292)).add_operation (GALGAS_string ("<br>"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 292)), inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 292)) ;
      enumerator_14646.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString_15024 = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFile.getter_string (HERE).getter_lastPathComponent (SOURCE_FILE ("galgas_prgm.galgas", 295)), var_semanticContext_12315.getter_mTypeMap (HERE), var_firstLetterSet_14409, var_tableOfTypeString_14561 COMMA_SOURCE_FILE ("galgas_prgm.galgas", 294))) ;
    GALGAS_bool joker_15280 ; // Joker input parameter
    var_typeDumpString_15024.method_writeToFileWhenDifferentContents (var_typeDumpFilePath_14172, joker_15280, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 300)) ;
  }else if (kBoolFalse == test_13) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath_14172, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 302)) ;
    }
  }
  const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 305)))).operator_and (GALGAS_bool (kIsEqual, constinArgument_inSourceToAnalyze.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("galgas_prgm.galgas", 305)).boolEnum () ;
  if (kBoolTrue == test_15) {
    {
    routine_performGalgas_33_ProjectGlobalCheckings (var_semanticContext_12315, var_declarationAST_8885.getter_mDeclarationList (HERE), inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 306)) ;
    }
  }
  const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.galgas", 312)))).operator_and (GALGAS_bool (kIsEqual, constinArgument_inSourceToAnalyze.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("galgas_prgm.galgas", 312)).boolEnum () ;
  if (kBoolTrue == test_16) {
    {
    routine_projectGeneration (var_semanticContext_12315.getter_mTypeMap (HERE), var_buildDirectory_12121, var_optionComponentMapForGeneration_12920, var_appProductFileList_12275, var_semanticDeclarationSortedListForGeneration_12409, var_declarationAST_8885.getter_mSourceRuleList (HERE), constinArgument_inProjectComponentAST, constinArgument_inProjectSourceFile.getter_string (HERE), var_handCodedSourceDirectorySet_9585, var_handCodedSourceToolFileList_9498, var_frameworkToolFileList_9539, var_handCodedSourceAppFileList_9451, var_handCodedLinkAppFileList_9405, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 313)) ;
    }
  }
}
