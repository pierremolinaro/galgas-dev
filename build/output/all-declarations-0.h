...
//----------------------------------------------------------------------------------------------------------------------
//
//LEXIQUE galgasTemplateScannerNew
//
//----------------------------------------------------------------------------------------------------------------------
...
class cTokenFor_galgasTemplateScannerNew : public cToken {
  public: C_BigInt mLexicalAttribute_bigintValue ;
  public: utf32 mLexicalAttribute_charValue ;
  public: double mLexicalAttribute_floatValue ;
  public: C_String mLexicalAttribute_identifierString ;
  ...
  public: cTokenFor_galgasTemplateScannerNew (void) ;
} ;
...
class C_Lexique_galgasTemplateScannerNew : public C_Lexique {
//--- Constructors
  public: C_Lexique_galgasTemplateScannerNew (C_Compiler * inCallerCompiler,
                       const C_String & inSourceFileName
                       COMMA_LOCATION_ARGS) ;
...
//    C_SharedObject::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected: virtual ~ C_Lexique_galgasTemplateScannerNew (void) {}
  #endif
...
//--- Parse lexical token
  protected: void internalParseLexicalToken (cTokenFor_galgasTemplateScannerNew & token) ;
  protected: virtual bool parseLexicalToken (void) override ;
...
//--- Enter Token
  protected: void enterToken (cTokenFor_galgasTemplateScannerNew & ioToken) ;
