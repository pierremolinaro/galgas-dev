...
//--------------------------------- GALGAS constructors
  ...
  public: static class GALGAS_typeKindEnum constructor_otherType (LOCATION_ARGS) ;

  public: static class GALGAS_typeKindEnum constructor_packageType (LOCATION_ARGS) ;
