...
//--------------------------------- Getters
  public: VIRTUAL_IN_DEBUG class GALGAS_lexicalFunctionExpressionAST getter_mLeftOperand (C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) const ;

  public: VIRTUAL_IN_DEBUG class GALGAS_lexicalFunctionExpressionAST getter_mRightOperand (C_Compiler * inCompiler
                                                                                           COMMA_LOCATION_ARGS) const ;
