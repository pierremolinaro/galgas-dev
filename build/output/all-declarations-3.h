...
//--- Rule declarations
  ...
  protected : void rule_expressionSyntax_primary_i39_ (GALGAS_semanticExpressionAST & outArgument0,
                                                       C_String & ioSyntaxDirectedTranslationResult,
                                                       C_Lexique_galgas_32_Scanner * inLexique) ;

  protected : void rule_expressionSyntax_primary_i39_parse (C_String & ioSyntaxDirectedTranslationResult,
                                                            C_Lexique_galgas_32_Scanner * inLexique) ;

  protected : void rule_expressionSyntax_primary_i39_indexing (C_Lexique_galgas_32_Scanner * inLexique) ;
