...
void GGS_insertMethodMap::insertOrReplace (const GGS_insertMethodMap_2E_element & inElement
  ...
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <GGS_GenericMapNode <GGS_insertMethodMap_2E_element>> unusedExistingNode ;
...
void GGS_insertMethodMap::makeNewEmptyMapWithMapToOverride (const GGS_insertMethodMap & inOverridenMap
  ...
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <GGS_GenericMapRoot <GGS_insertMethodMap_2E_element>>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}
...
void GGS_searchMethodMap::insertOrReplace (const GGS_searchMethodMap_2E_element & inElement
  ...
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <GGS_GenericMapNode <GGS_searchMethodMap_2E_element>> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void GGS_searchMethodMap::makeNewEmptyMapWithMapToOverride (const GGS_searchMethodMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <GGS_GenericMapRoot <GGS_searchMethodMap_2E_element>>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}
...
void GGS_equatableExtensionMap::insertOrReplace (const GGS_equatableExtensionMap_2E_element & inElement
  ...
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <GGS_GenericMapNode <GGS_equatableExtensionMap_2E_element>> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void GGS_equatableExtensionMap::makeNewEmptyMapWithMapToOverride (const GGS_equatableExtensionMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <GGS_GenericMapRoot <GGS_equatableExtensionMap_2E_element>>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}
