...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_filewrapper_5F_text_5F_files_i3_ (GGS_lstringlist & outArgument_outFilewrapperTextFileExtensionList,
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      outArgument_outFilewrapperTextFileExtensionList.addAssignOperation (var_pathExtension_5050  COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 110)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_filewrapper_5F_binary_5F_files_i4_ (GGS_lstringlist & outArgument_outFilewrapperBinaryFileExtensionList,
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      outArgument_outFilewrapperBinaryFileExtensionList.addAssignOperation (var_pathExtension_5491  COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 127)) ;
    ...
    if (select_galgas_33_DeclarationsSyntax_5 (inCompiler) == 2) {
      ...
      while (repeatFlag_1) {
        ...
        case 2: {
          ...
          var_filewrapperTemplateFormalInputParameters_6111.addAssignOperation (var_selector_6209, var_typeName_6271, var_argumentName_6443, var_isUnused_6298  COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 159)) ;
        } break ;
        case 3: {
          inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3F_ COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 161)) ;
          GGS_lstring var_selector_6588 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 162)) ;
          ...
          var_filewrapperTemplateFormalInputParameters_6111.addAssignOperation (var_selector_6588, var_typeName_6660, var_argumentName_6832, var_isUnused_6687  COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 172)) ;
        } break ;
        default:
          repeatFlag_1 = false ;
          break ;
      ...
      outArgument_outFilewrapperTemplateList.addAssignOperation (var_mFilewrapperTemplateName_5992, var_mFilewrapperTemplatePath_6039, var_filewrapperTemplateFormalInputParameters_6111  COMMA_SOURCE_FILE ("galgasDeclarationsSyntax.galgas", 174)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i7_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_13 (inCompiler) == 2) {
      ...
      var_typeName_1434 = function_makeEmbeddedTypeLName (var_typeName_1434, var_t_1531, inCompiler COMMA_SOURCE_FILE ("extension-method.galgas", 31)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  GGS_location var_endOfMethodLocation_1860 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-method.galgas", 37)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i8_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_14 (inCompiler) == 2) {
      ...
      var_typeName_2403 = function_makeEmbeddedTypeLName (var_typeName_2403, var_t_2465, inCompiler COMMA_SOURCE_FILE ("extension-method.galgas", 58)) ;
  ...
  GGS_location var_endOfMethodLocation_2832 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-method.galgas", 65)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i9_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_15 (inCompiler) == 2) {
      ...
      var_typeName_1446 = function_makeEmbeddedTypeLName (var_typeName_1446, var_t_1541, inCompiler COMMA_SOURCE_FILE ("extension-initializer.galgas", 31)) ;
  ...
  GGS_location var_endOfMethodLocation_1828 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-initializer.galgas", 39)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i10_ (const GGS_lstring constinArgument_inClassName,
                                                                                                                    GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                    Lexique_galgasScanner_33_ * inCompiler) {
  ...
  GGS_location var_endOfMethodLocation_2520 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-initializer.galgas", 58)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i11_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_16 (inCompiler) == 2) {
      ...
      var_typeName_1449 = function_makeEmbeddedTypeLName (var_typeName_1449, var_t_1554, inCompiler COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 32)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i12_ (const GGS_lstring constinArgument_inTypeName,
                                                                                                                    GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                    Lexique_galgasScanner_33_ * inCompiler) {
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_abstract COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 56)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_getter COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 57)) ;
  GGS_lstring var_typeName_2542 = constinArgument_inTypeName ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_18 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2E_ COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 61)) ;
      GGS_lstring var_t_2614 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__40_type COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 62)) ;
      var_typeName_2542 = function_makeEmbeddedTypeLName (var_typeName_2542, var_t_2614, inCompiler COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 63)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2D__3E_ COMMA_SOURCE_FILE ("extension-abstract-getter.galgas", 72)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i13_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    ...
    var_theExtension_1539 = GGS_equatableComparableExtension::class_func_equatable (SOURCE_FILE ("extension-equatable-comparable.galgas", 31)) ;
  } break ;
  case 2: {
    ...
    var_theExtension_1539 = GGS_equatableComparableExtension::class_func_comparable (SOURCE_FILE ("extension-equatable-comparable.galgas", 34)) ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_equatableExtensionAST::init_21_isPredefined_21__21_ (GGS_bool (false), var_typeName_1446, var_theExtension_1539, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("extension-equatable-comparable.galgas", 36)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i14_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_21 (inCompiler) == 2) {
      ...
      var_typeName_1577 = function_makeEmbeddedTypeLName (var_typeName_1577, var_t_1690, inCompiler COMMA_SOURCE_FILE ("extension-overriding-abstract-setter.galgas", 35)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i15_ (const GGS_lstring constinArgument_inTypeName,
                                                                                                                    GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                    Lexique_galgasScanner_33_ * inCompiler) {
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_22 (inCompiler) == 2) {
      ...
      var_typeName_2392 = function_makeEmbeddedTypeLName (var_typeName_2392, var_t_2454, inCompiler COMMA_SOURCE_FILE ("extension-overriding-abstract-setter.galgas", 57)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i16_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_23 (inCompiler) == 2) {
      ...
      var_typeName_2293 = function_makeEmbeddedTypeLName (var_typeName_2293, var_t_2398, inCompiler COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 48)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  case 2: {
    var_resultVariableName_2911 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 63)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ...
  GGS_location var_endOfInstructionList_3150 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 67)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i17_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_26 (inCompiler) == 2) {
      ...
      var_typeName_3742 = function_makeEmbeddedTypeLName (var_typeName_3742, var_t_3804, inCompiler COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 90)) ;
  ...
  case 2: {
    var_resultVariableName_4327 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 106)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ...
  GGS_location var_endOfInstructionList_4594 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-getter.galgas", 110)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i18_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_29 (inCompiler) == 2) {
      ...
      var_typeName_2103 = function_makeEmbeddedTypeLName (var_typeName_2103, var_t_2200, inCompiler COMMA_SOURCE_FILE ("extension-setter.galgas", 45)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  GGS_location var_endOfSetterLocation_2539 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-setter.galgas", 51)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i19_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_30 (inCompiler) == 2) {
      ...
      var_typeName_3027 = function_makeEmbeddedTypeLName (var_typeName_3027, var_t_3089, inCompiler COMMA_SOURCE_FILE ("extension-setter.galgas", 71)) ;
  ...
  GGS_location var_endOfSetterLocation_3466 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-setter.galgas", 78)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i20_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_31 (inCompiler) == 2) {
      ...
      var_typeName_2038 = function_makeEmbeddedTypeLName (var_typeName_2038, var_t_2151, inCompiler COMMA_SOURCE_FILE ("extension-overriding-abstract-method.galgas", 45)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i22_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_32 (inCompiler) == 2) {
      ...
      var_typeName_1562 = function_makeEmbeddedTypeLName (var_typeName_1562, var_t_1667, inCompiler COMMA_SOURCE_FILE ("extension-abstract-method.galgas", 34)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_abstractExtensionMethodAST::init_21_isPredefined_21__21__21_ (GGS_bool (false), var_typeName_1562, var_methodName_1776, var_formalParameterList_1886, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("extension-abstract-method.galgas", 38)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i23_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_33 (inCompiler) == 2) {
      ...
      var_typeName_2336 = function_makeEmbeddedTypeLName (var_typeName_2336, var_t_2398, inCompiler COMMA_SOURCE_FILE ("extension-abstract-method.galgas", 55)) ;
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_abstractExtensionMethodAST::init_21_isPredefined_21__21__21_ (GGS_bool (false), var_typeName_2336, var_methodName_2517, var_formalParameterList_2627, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("extension-abstract-method.galgas", 60)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i24_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_34 (inCompiler) == 2) {
      ...
      var_typeName_1547 = function_makeEmbeddedTypeLName (var_typeName_1547, var_t_1644, inCompiler COMMA_SOURCE_FILE ("extension-getter.galgas", 33)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  case 2: {
    var_resultVariableName_2149 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-getter.galgas", 48)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ...
  GGS_location var_endOfInstructionList_2416 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-getter.galgas", 52)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i25_ (const GGS_lstring constinArgument_inTypeName,
  ...
  case 2: {
    var_resultVariableName_3402 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-getter.galgas", 83)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ...
  GGS_location var_endOfInstructionList_3669 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-getter.galgas", 87)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i26_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_39 (inCompiler) == 2) {
      ...
      var_typeName_1562 = function_makeEmbeddedTypeLName (var_typeName_1562, var_t_1677, inCompiler COMMA_SOURCE_FILE ("extension-overriding-method.galgas", 34)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  GGS_location var_endOfMethodLocation_2014 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-method.galgas", 40)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i27_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_40 (inCompiler) == 2) {
      ...
      var_typeName_2548 = function_makeEmbeddedTypeLName (var_typeName_2548, var_t_2610, inCompiler COMMA_SOURCE_FILE ("extension-overriding-method.galgas", 61)) ;
  ...
  GGS_location var_endOfMethodLocation_2995 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-method.galgas", 68)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i28_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_abstractExtensionSetterAST::init_21_isPredefined_21__21__21_ (GGS_bool (false), var_className_1571, var_setterName_1658, var_formalParameterList_1768, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("extension-abstract-setter.galgas", 32)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i30_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_41 (inCompiler) == 2) {
      ...
      var_typeName_2158 = function_makeEmbeddedTypeLName (var_typeName_2158, var_t_2273, inCompiler COMMA_SOURCE_FILE ("extension-overriding-setter.galgas", 46)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  GGS_location var_endOfSetterLocation_2620 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-setter.galgas", 52)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i31_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_42 (inCompiler) == 2) {
      ...
      var_typeName_3167 = function_makeEmbeddedTypeLName (var_typeName_3167, var_t_3229, inCompiler COMMA_SOURCE_FILE ("extension-overriding-setter.galgas", 74)) ;
  ...
  GGS_location var_endOfSetterLocation_3614 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("extension-overriding-setter.galgas", 81)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i32_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_43 (inCompiler) == 2) {
      ...
      var_typeName_2111 = function_makeEmbeddedTypeLName (var_typeName_2111, var_t_2224, inCompiler COMMA_SOURCE_FILE ("extension-overriding-abstract-getter.galgas", 46)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_method_5F_declaration_5F_ggs_33__i33_ (const GGS_lstring constinArgument_inTypeName,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_45 (inCompiler) == 2) {
      ...
      var_typeName_3181 = function_makeEmbeddedTypeLName (var_typeName_3181, var_t_3243, inCompiler COMMA_SOURCE_FILE ("extension-overriding-abstract-getter.galgas", 76)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i34_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_mapDeclarationAST::init_21_isPredefined_21__21__21__21__21__21__21__21__21_equatable (GGS_bool (false), var_mapTypeName_1553, var_propertyList_1755, var_mInsertSetterList_1810, var_mSearchMethodList_1882, var_searchSubscriptListAST_2121, var_mRemoveSetterList_1934, var_replaceMethodList_1986, var_insertOrReplaceDeclarationListAST_2053, var_isEquatable_1631, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 63)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_search_5F_method_5F_declaration_i35_ (GGS_mapAccessorListAST & ioArgument_ioMapSearchMethodListAST,
  ...
  ioArgument_ioMapSearchMethodListAST.addAssignOperation (var_methodName_3334, var_errorMessage_3398  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 84)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_search_5F_subscript_5F_declaration_i36_ (GGS_mapAccessorListAST & ioArgument_ioMapSearchSubscriptListAST,
  ...
  ioArgument_ioMapSearchSubscriptListAST.addAssignOperation (var_methodName_3742, var_errorMessage_3806  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 94)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_remove_5F_setter_5F_declaration_i37_ (GGS_mapAccessorListAST & ioArgument_ioMapRemoveMethodListAST,
  ...
  ioArgument_ioMapRemoveMethodListAST.addAssignOperation (var_mMethodName_4137, var_mErrorMessage_4204  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 105)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_replace_5F_setter_5F_declaration_i38_ (GGS_mapAccessorListAST & ioArgument_ioMapReplaceMethodListAST,
  ...
  ioArgument_ioMapReplaceMethodListAST.addAssignOperation (var_mMethodName_4516, var_mErrorMessage_4583  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 116)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_map_5F_insert_5F_setter_5F_declaration_i40_ (GGS_insertSetterListAST & ioArgument_ioMapMethodList,
  ...
  case 1: {
    var_mShadowErrorMessage_5303 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 138)), inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
  ...
  ioArgument_ioMapMethodList.addAssignOperation (var_mMethodName_5205, var_mErrorMessage_5272, var_mShadowErrorMessage_5303  COMMA_SOURCE_FILE ("declaration-type-map.galgas", 143)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_property_5F_declaration_5F_ggs_33__i42_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_initialization_3422 = GGS_propertyInCollectionInitializationAST::class_func_none (SOURCE_FILE ("declaration-property.galgas", 84)) ;
  ...
  case 2: {
    ...
    var_initialization_3422 = GGS_propertyInCollectionInitializationAST::class_func_none (SOURCE_FILE ("declaration-property.galgas", 88)) ;
  ...
  case 3: {
    ...
    var_initialization_3422 = GGS_propertyInCollectionInitializationAST::class_func_some (var_expression_3661  COMMA_SOURCE_FILE ("declaration-property.galgas", 93)) ;
    var_selectorAttribute_3357 = GGS_bool (false) ;
  } break ;
  default:
    break ;
  }
  GGS_lstring var_propertyWeakTypeName_3775 = function_makeWeakTypeLName (var_propertyTypeName_3291, inCompiler COMMA_SOURCE_FILE ("declaration-property.galgas", 96)) ;
  ioArgument_ioAttributeInCollectionList.addAssignOperation (GGS_propertyMutability::class_func_weakProperty (SOURCE_FILE ("declaration-property.galgas", 102)), var_propertyWeakTypeName_3775, var_propertyName_3330, var_accessControl_3081, var_selectorAttribute_3357, var_initialization_3422  COMMA_SOURCE_FILE ("declaration-property.galgas", 101)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i43_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  if (GalgasBool::boolTrue == test_6) {
    test_6 = GGS_bool (ComparisonKind::equal, var_propertyList_2489.getter_count (SOURCE_FILE ("declaration-type-list.galgas", 64)).objectCompare (GGS_uint (uint32_t (0U)))).boolEnum () ;
    if (GalgasBool::boolTrue == test_6) {
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_cpp_5F_predeclaration_i47_ (GGS_string & outArgument_outCppPredeclarationCode,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_59 (inCompiler) == 2) {
      ...
      outArgument_outCppPredeclarationCode.plusAssignOperation(var_cppPredeclarationCodeElement_2913.readProperty_string (), inCompiler  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 67)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_cpp_5F_classdeclaration_i48_ (GGS_string & outArgument_outCppClassCode,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_60 (inCompiler) == 2) {
      ...
      outArgument_outCppClassCode.plusAssignOperation(var_cppPredeclarationCodeElement_3288.readProperty_string (), inCompiler  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 80)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_constructor_5F_ggs_33__i49_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      var_argumentTypeList_3733.addAssignOperation (var_selector_3801, var_argumentTypeName_3861, var_argumentName_3911  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 97)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3F_ COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 99)) ;
      GGS_lstring var_selector_4022 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 100)) ;
      ...
      var_argumentTypeList_3733.addAssignOperation (var_selector_4022, var_argumentTypeName_4092, var_argumentName_4142  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 103)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioExternTypeConstructorList.addAssignOperation (var_argumentTypeList_3733  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 106)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_getter_5F_ggs_33__i50_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      var_argumentTypeList_4647.addAssignOperation (var_selector_4936, var_argumentTypeName_5006, var_argumentName_5056  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 127)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioExternTypeGetterList.addAssignOperation (var_getterName_4595, var_resultTypeName_5212, var_argumentTypeList_4647  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 131)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_setter_5F_ggs_33__i51_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioExternTypeSetterList.addAssignOperation (var_setterName_5606, var_formalParameterList_5673  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 141)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_externtype_5F_method_5F_ggs_33__i52_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioExternTypeMethodList.addAssignOperation (var_methodName_6059, var_formalParameterList_6126, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 151))  COMMA_SOURCE_FILE ("declaration-type-extern.galgas", 151)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i53_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      var_slotList_1750.addAssignOperation (var_slotName_1823  COMMA_SOURCE_FILE ("declaration-type-boolset.galgas", 42)) ;
    } break ;
    case 3: {
  ...
  GalgasBool test_1 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_1) {
    test_1 = GGS_bool (ComparisonKind::equal, var_slotList_1750.getter_count (SOURCE_FILE ("declaration-type-boolset.galgas", 47)).objectCompare (GGS_uint (uint32_t (0U)))).boolEnum () ;
    if (GalgasBool::boolTrue == test_1) {
      GenericArray <FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (var_boolsetTypeName_1557.readProperty_location (), GGS_string ("a boolset type must define at least one case constant"), fixItArray2  COMMA_SOURCE_FILE ("declaration-type-boolset.galgas", 48)) ;
    }
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_boolsetDeclarationAST::init_21_isPredefined_21__21__21_isEquatable (GGS_bool (false), var_boolsetTypeName_1557, var_slotList_1750, var_isEquatable_1613, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-boolset.galgas", 50)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i54_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_superClassName_2059 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-type-class.galgas", 54)) ;
  } break ;
  case 2: {
  ...
  if (GalgasBool::boolTrue == test_2) {
    ...
    temp_1 = function_makeWeakTypeLName (var_superClassName_2059, inCompiler COMMA_SOURCE_FILE ("declaration-type-class.galgas", 92)) ;
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_weakReferenceDeclarationAST::init_21_isPredefined_21__21__21__21_ (GGS_bool (false), var_className_2007, function_makeWeakTypeLName (var_className_2007, inCompiler COMMA_SOURCE_FILE ("declaration-type-class.galgas", 89)), temp_1, var_generateInSeparateFile_2253, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-class.galgas", 86)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_type_5F_definition_5F_ggs_33__i55_ (GGS_galgasDeclarationAST & /* ioArgument_ioDeclarations */,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_69 (inCompiler) == 2) {
      ...
      outArgument_outTypeName = function_makeEmbeddedTypeLName (outArgument_outTypeName, var_typeName_5455, inCompiler COMMA_SOURCE_FILE ("declaration-type-alias-and-type-declaration.galgas", 123)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_type_5F_definition_5F_ggs_33__i57_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    GenericArray <FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (var_t_6306.readProperty_location (), GGS_string ("not handled yet"), fixItArray1  COMMA_SOURCE_FILE ("declaration-type-alias-and-type-declaration.galgas", 147)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_type_5F_definition_5F_ggs_33__i58_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  {
  extensionSetter_getOptionalTypeName (ioArgument_ioDeclarations, outArgument_outTypeName, var_unwrappedTypeName_6683, GGS_bool (false), inCompiler COMMA_SOURCE_FILE ("declaration-type-alias-and-type-declaration.galgas", 161)) ;
  }
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i60_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_sortedListDeclarationAST::init_21_isPredefined_21__21__21__21_equatable (GGS_bool (false), var_sortedListTypeName_1551, var_attributeList_1796, var_sortDescriptorList_1969, var_isEquatable_1643, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-sorted-list.galgas", 51)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_sortedlist_5F_sort_5F_descriptor_i61_ (GGS_sortedListSortDescriptorListAST & ioArgument_ioSortedListSortDescriptorList,
  ...
  ioArgument_ioSortedListSortDescriptorList.addAssignOperation (var_mSortedAttributeName_2565, var_mAscending_2600  COMMA_SOURCE_FILE ("declaration-type-sorted-list.galgas", 72)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i62_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_comparison_1510 = GGS_structComparison::class_func_none (SOURCE_FILE ("declaration-type-struct.galgas", 29)) ;
  } break ;
  case 2: {
    ...
    var_comparison_1510 = GGS_structComparison::class_func_comparable (SOURCE_FILE ("declaration-type-struct.galgas", 32)) ;
  } break ;
  case 3: {
    ...
    var_comparison_1510 = GGS_structComparison::class_func_equatable (SOURCE_FILE ("declaration-type-struct.galgas", 35)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i63_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_DeclarationsSyntax_78 (inCompiler) == 2) {
      ...
      var_graphInsertModifierList_1698.addAssignOperation (var_insertName_1821, var_errorMessage_1893  COMMA_SOURCE_FILE ("declaration-type-graph.galgas", 41)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("declaration-type-graph.galgas", 43)) ;
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_graphDeclarationAST::init_21_isPredefined_21__21__21_ (GGS_bool (false), var_graphTypeName_1555, var_associatedListTypeName_1651, var_graphInsertModifierList_1698, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-graph.galgas", 44)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i64_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_structComparison var_comparison_1608 = GGS_structComparison::class_func_none (SOURCE_FILE ("declaration-type-enum.galgas", 29)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case GGS_structComparison::Enumeration::enum_none:
        {
          var_comparison_1608 = GGS_structComparison::class_func_comparable (SOURCE_FILE ("declaration-type-enum.galgas", 35)) ;
        }
        break ;
    ...
    case 3: {
      ...
      case GGS_structComparison::Enumeration::enum_none:
        {
          var_comparison_1608 = GGS_structComparison::class_func_equatable (SOURCE_FILE ("declaration-type-enum.galgas", 45)) ;
        }
        break ;
      case GGS_structComparison::Enumeration::enum_equatable:
        {
    ...
    case 2: {
      ...
      case 2: {
        ...
        while (repeatFlag_6) {
          ...
          {
          var_associatedValueTypeList_2367.setter_append (GGS_associatedValue::init_21__21__21_ (var_weakQualifier_2466, var_associatedValueType_2665, var_associatedValueName_2713, inCompiler COMMA_HERE), inCompiler COMMA_SOURCE_FILE ("declaration-type-enum.galgas", 72)) ;
          }
      ...
      var_constantList_2248.addAssignOperation (var_constantName_2325, var_associatedValueTypeList_2367  COMMA_SOURCE_FILE ("declaration-type-enum.galgas", 77)) ;
    } break ;
    case 3: {
  ...
  if (GalgasBool::boolTrue == test_7) {
    test_7 = GGS_bool (ComparisonKind::equal, var_constantList_2248.getter_count (SOURCE_FILE ("declaration-type-enum.galgas", 82)).objectCompare (GGS_uint (uint32_t (0U)))).boolEnum () ;
    if (GalgasBool::boolTrue == test_7) {
      GenericArray <FixItDescription> fixItArray8 ;
      inCompiler->emitSemanticError (var_enumTypeName_1545.readProperty_location (), GGS_string ("an enumerated type must define at least one case constant"), fixItArray8  COMMA_SOURCE_FILE ("declaration-type-enum.galgas", 83)) ;
    }
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_enumDeclarationAST::init_21_isPredefined_21__21__21_comparison (GGS_bool (false), var_enumTypeName_1545, var_constantList_2248, var_comparison_1608, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-type-enum.galgas", 85)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_indexing_5F_declaration_5F_ggs_33__i2_ (GGS_indexingListAST & ioArgument_ioIndexingListAST,
  ...
  ioArgument_ioIndexingListAST.addAssignOperation (var_indexName_6526, var_indexComment_6605  COMMA_SOURCE_FILE ("lexique-component.galgas", 162)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_message_5F_declaration_5F_ggs_33__i3_ (GGS_lexicalMessageDeclarationListAST & ioArgument_ioLexicalMessageDeclarationList,
  ...
  ioArgument_ioLexicalMessageDeclarationList.addAssignOperation (var_messageName_6936, var_messageValue_6985  COMMA_SOURCE_FILE ("lexique-component.galgas", 173)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_implicit_5F_rule_5F_ggs_33__i4_ (GGS_lexicalRuleListAST & ioArgument_ioLexicalImplicitRuleList,
  ...
  ioArgument_ioLexicalImplicitRuleList.addAssignOperation (GGS_lexicalImplicitRuleAST::init_21_ (var_listName_7310, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-component.galgas", 182)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_explicit_5F_rule_5F_ggs_33__i5_ (GGS_lexicalRuleListAST & ioArgument_ioLexicalExplicitRuleList,
  ...
  ioArgument_ioLexicalExplicitRuleList.addAssignOperation (GGS_lexicalExplicitRuleAST::init_21__21_ (var_lexicalRuleExpression_7645, var_instructionList_7710, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-component.galgas", 197)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i6_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (var_instruction_8170  COMMA_SOURCE_FILE ("lexique-component.galgas", 205)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_repeat_5F_while_5F_branch_i7_ (GGS_lexicalWhileBranchListAST & ioArgument_ioLexicalWhileBranchList,
  ...
  ioArgument_ioLexicalWhileBranchList.addAssignOperation (var_whileExpression_8476, var_whileInstructionList_8535  COMMA_SOURCE_FILE ("lexique-component.galgas", 219)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_output_5F_effective_5F_argument_i10_ (GGS_lexicalRoutineOrFunctionFormalInputArgumentAST & outArgument_outEffectiveArgument,
                                                                                                                                      Lexique_galgasScanner_33_ * inCompiler) {
  outArgument_outEffectiveArgument.drop () ; // Release 'out' argument
  GGS_location var_currentLocation_9609 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 239)) ;
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      if (select_galgas_33_LexiqueComponentSyntax_5 (inCompiler) == 2) {
        ...
        var_functionActualArgumentList_10135.addAssignOperation (var_arg_10302  COMMA_SOURCE_FILE ("lexique-component.galgas", 257)) ;
      }else{
        repeatFlag_0 = false ;
      }
    }
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_list_5F_declaration_5F_ggs_33__i18_ (GGS_lexicalListDeclarationListAST & ioArgument_ioLexicalListDeclarationList,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_LexiqueComponentSyntax_8 (inCompiler) == 2) {
      ...
      var_sentAttributeList_12606.addAssignOperation (var_selector_12675, var_sentAttribute_12708  COMMA_SOURCE_FILE ("lexique-component.galgas", 329)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  case 2: {
    var_theStyle_12799 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 336)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ...
  ioArgument_ioLexicalListDeclarationList.addAssignOperation (var_name_12564, var_theStyle_12799, var_errorMessage_13007, var_sentAttributeList_12606, var_entryList_13036  COMMA_SOURCE_FILE ("lexique-component.galgas", 348)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_list_5F_entry_i19_ (GGS_lexicalListEntryListAST & ioArgument_ioLexicalListEntryList,
  ...
  ioArgument_ioLexicalListEntryList.addAssignOperation (var_entrySpelling_13474, var_terminalSpelling_13729, var_nonAtomicSelection_13530, var_isTemplateEndMark_13496  COMMA_SOURCE_FILE ("lexique-component.galgas", 372)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_attribute_5F_declaration_5F_ggs_33__i20_ (GGS_lexicalAttributeListAST & ioArgument_ioLexicalAttributeList,
  ...
  ioArgument_ioLexicalAttributeList.addAssignOperation (var_typeName_14258, var_name_14298  COMMA_SOURCE_FILE ("lexique-component.galgas", 384)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_terminal_5F_declaration_5F_ggs_33__i21_ (GGS_terminalDeclarationListAST & ioArgument_ioTerminalDeclarationList,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_LexiqueComponentSyntax_13 (inCompiler) == 2) {
      ...
      GGS_lstring var_selector_14717 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 395)) ;
      ...
      var_sentAttributeList_14624.addAssignOperation (var_selector_14717, var_sentAttribute_14760  COMMA_SOURCE_FILE ("lexique-component.galgas", 397)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  GGS_lstring var_theStyle_14851 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("lexique-component.galgas", 399)) ;
  ...
  ioArgument_ioTerminalDeclarationList.addAssignOperation (var_name_14582, var_sentAttributeList_14624, var_errorMessage_15336, var_theStyle_14851, var_nonAtomicSelection_14909, var_templateEndMark_14944  COMMA_SOURCE_FILE ("lexique-component.galgas", 418)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_style_5F_declaration_5F_ggs_33__i22_ (GGS_lexicalStyleListAST & ioArgument_ioLexicalStyleList,
  ...
  GalgasBool test_0 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_0) {
    test_0 = var_styleIdentifier_15771.readProperty_string ().getter_containsCharacter (GGS_char (utf32 (95)) COMMA_SOURCE_FILE ("lexique-component.galgas", 432)).boolEnum () ;
    if (GalgasBool::boolTrue == test_0) {
      GenericArray <FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_styleIdentifier_15771.readProperty_location (), GGS_string ("for compatibility with latex formatting, a style name should not contain '_' character"), fixItArray1  COMMA_SOURCE_FILE ("lexique-component.galgas", 433)) ;
    }
  }
  GalgasBool test_2 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_2) {
    test_2 = var_styleIdentifier_15771.readProperty_string ().getter_containsCharacterInRange (GGS_char (utf32 (48)), GGS_char (utf32 (57)) COMMA_SOURCE_FILE ("lexique-component.galgas", 435)).boolEnum () ;
    if (GalgasBool::boolTrue == test_2) {
      GenericArray <FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (var_styleIdentifier_15771.readProperty_location (), GGS_string ("for compatibility with latex formatting, a style name should not contain any digit"), fixItArray3  COMMA_SOURCE_FILE ("lexique-component.galgas", 436)) ;
    }
  }
  ...
  ioArgument_ioLexicalStyleList.addAssignOperation (var_styleIdentifier_15771, var_comment_16211  COMMA_SOURCE_FILE ("lexique-component.galgas", 440)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i23_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalRewindInstructionAST::init_21__21_ (var_tagName_1927, var_terminalName_1970, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-rewind.galgas", 41)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i24_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalTagInstructionAST::init_21_ (var_tagName_1884, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-tag.galgas", 38)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i25_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalWarningInstructionAST::init_21_ (var_warningMessageName_1896, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-warning.galgas", 38)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i26_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      GGS_location var_passingModeLocation_3128 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 68)) ;
      ...
      var_actualArgumentList_3054.addAssignOperation (GGS_lexicalFormalInputArgumentAST::init_21__21_ (var_passingModeLocation_3128, var_arg_3260, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 70)) ;
    } break ;
    case 3: {
      ...
      GGS_location var_passingModeLocation_3383 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 73)) ;
      ...
      var_actualArgumentList_3054.addAssignOperation (var_arg_3477  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 76)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 2: {
    ...
    while (repeatFlag_1) {
      ...
      var_errorMessageList_3623.addAssignOperation (var_errorMessageName_3726  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 84)) ;
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalRoutineCallInstructionAST::init_21__21__21_ (var_actionName_2994, var_actualArgumentList_3054, var_errorMessageList_3623, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-routine-call.galgas", 90)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i27_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalDropInstructionAST::init_21_ (var_terminalName_1886, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-drop.galgas", 38)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i28_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    var_lexicalWhileBranchList_1997.addAssignOperation (var_selectExpression_2104, var_selectInstructionList_2168  COMMA_SOURCE_FILE ("lexique-instruction-select.galgas", 48)) ;
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalSelectInstructionAST::init_21__21_ (var_lexicalWhileBranchList_1997, var_defaultInstructionList_2425, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-select.galgas", 58)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i29_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalErrorInstructionAST::init_21_ (var_errorMessageName_1890, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-error.galgas", 38)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_instruction_i30_ (GGS_lexicalInstructionListAST & ioArgument_ioInstructionList,
  ...
  GGS_location var_location_2067 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lexique-instruction-repeat.galgas", 40)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_lexicalRepeatInstructionAST::init_21__21__21_ (var_repeatedInstructionList_2029, var_lexicalWhileBranchList_2211, var_location_2067, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("lexique-instruction-repeat.galgas", 51)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_lexical_5F_send_5F_instruction_i31_ (GGS_lexicalInstructionAST & outArgument_outInstruction,
  ...
  while (repeatFlag_0) {
    ...
    var_lexicalSendSearchList_1987.addAssignOperation (var_attributeName_2072, var_searchListName_2130  COMMA_SOURCE_FILE ("lexique-instruction-structured-send.galgas", 43)) ;
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_template_5F_delimitor_5F_ggs_33__i35_ (GGS_templateDelimitorListAST & ioArgument_ioTemplateDelimitorList,
  ...
  ioArgument_ioTemplateDelimitorList.addAssignOperation (var_startString_2953, var_nonAtomicSelection_2973, var_templateEndMark_3008, var_preserved_3040, var_endString_3608  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 94)) ;
}
...
void cParser_galgas_33_LexiqueComponentSyntax::rule_galgas_33_LexiqueComponentSyntax_template_5F_replacement_5F_ggs_33__i36_ (GGS_templateReplacementListAST & ioArgument_ioTemplateReplacement,
  ...
  case 2: {
    ...
    var_replacementFunction_4074 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 117)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioTemplateReplacement.addAssignOperation (var_matchString_4010, var_replacementString_4039, var_replacementFunction_4074  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 119)) ;
}
...
void cParser_galgas_33_OptionComponentSyntax::rule_galgas_33_OptionComponentSyntax_declaration_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_optionComponentDeclarationAST::init_21_isPredefined_21__21_ (GGS_bool (false), var_optionComponentName_1574, var_options_1636, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("optionCompilation.galgas", 38)) ;
}
...
void cParser_galgas_33_OptionComponentSyntax::rule_galgas_33_OptionComponentSyntax_option_5F_declaration_5F_ggs_33__i1_ (GGS_commandLineOptionListAST & ioArgument_ioCommandLineOptionList,
  ...
  GGS_lstring var_defaultValue_2343 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("optionCompilation.galgas", 56)), inCompiler COMMA_HERE) ;
  GGS_optionDefaultValueEnumAST var_optionDefaultValueKind_2424 ;
  switch (select_galgas_33_OptionComponentSyntax_1 (inCompiler)) {
  case 1: {
    var_optionDefaultValueKind_2424 = GGS_optionDefaultValueEnumAST::class_func_noDefaultValue (SOURCE_FILE ("optionCompilation.galgas", 59)) ;
  } break ;
  case 2: {
    ...
    case 1: {
      ...
      var_optionDefaultValueKind_2424 = GGS_optionDefaultValueEnumAST::class_func_stringDefaultValue (SOURCE_FILE ("optionCompilation.galgas", 64)) ;
    } break ;
    case 2: {
      ...
      var_defaultValue_2343 = GGS_lstring::init_21__21_ (var_v_2663.readProperty_bigint ().getter_string (SOURCE_FILE ("optionCompilation.galgas", 67)), var_v_2663.readProperty_location (), inCompiler COMMA_HERE) ;
      var_optionDefaultValueKind_2424 = GGS_optionDefaultValueEnumAST::class_func_unsignedDefaultValue (SOURCE_FILE ("optionCompilation.galgas", 68)) ;
    } break ;
    default:
      break ;
    }
  ...
  ioArgument_ioCommandLineOptionList.addAssignOperation (var_mOptionTypeName_2097, var_mOptionInternalName_2144, var_mOptionInvocationLetter_2197, var_mOptionInvocationString_2258, var_mOptionComment_2320, var_defaultValue_2343, var_optionDefaultValueKind_2424  COMMA_SOURCE_FILE ("optionCompilation.galgas", 71)) ;
}
...
void cParser_galgas_33_GuiComponentSyntax::rule_galgas_33_GuiComponentSyntax_declaration_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      var_projectExtensionList_4892.addAssignOperation (var_fileExtension_4978, var_indexingPathSuffix_5042  COMMA_SOURCE_FILE ("guiCompilation.galgas", 136)) ;
    } break ;
    case 3: {
  ...
  ioArgument_ioDeclarations.mProperty_mGUIComponentList.addAssignOperation (var_mGUIName_4676, var_importedOptionList_4714, var_simpleGlobalAttributes_4774, var_withLexiqueList_4831, var_projectExtensionList_4892  COMMA_SOURCE_FILE ("guiCompilation.galgas", 146)) ;
}
...
void cParser_galgas_33_GuiComponentSyntax::rule_galgas_33_GuiComponentSyntax_gui_5F_with_5F_lexique_5F_declaration_i1_ (GGS_withLexiqueListAST & ioArgument_ioWithLexiqueList,
    ...
    case 2: {
      ...
      while (repeatFlag_1) {
        ...
        case 3: {
          ...
          GalgasBool test_2 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_2) {
            test_2 = GGS_bool (ComparisonKind::greaterOrEqual, var_leadingStrip_6411.readProperty_bigint ().objectCompare (GGS_bigint ("15", inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 186)))).boolEnum () ;
            if (GalgasBool::boolTrue == test_2) {
              GenericArray <FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (var_leadingStrip_6411.readProperty_location (), GGS_string ("leading strip should be < 15"), fixItArray3  COMMA_SOURCE_FILE ("guiCompilation.galgas", 187)) ;
            }
          }
          ...
          GalgasBool test_4 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_4) {
            test_4 = GGS_bool (ComparisonKind::greaterOrEqual, var_endingStrip_6588.readProperty_bigint ().objectCompare (GGS_bigint ("15", inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 191)))).boolEnum () ;
            if (GalgasBool::boolTrue == test_4) {
              GenericArray <FixItDescription> fixItArray5 ;
              inCompiler->emitSemanticError (var_endingStrip_6588.readProperty_location (), GGS_string ("tail strip should be < 15"), fixItArray5  COMMA_SOURCE_FILE ("guiCompilation.galgas", 192)) ;
            }
          }
          var_displayFlags_6218 = var_leadingStrip_6411.readProperty_bigint ().left_shift_operation (GGS_bigint ("4", inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("guiCompilation.galgas", 194)).operator_or (var_endingStrip_6588.readProperty_bigint () COMMA_SOURCE_FILE ("guiCompilation.galgas", 194)).getter_uint (inCompiler COMMA_SOURCE_FILE ("guiCompilation.galgas", 194)) ;
          inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__29_ COMMA_SOURCE_FILE ("guiCompilation.galgas", 195)) ;
        } break ;
        default:
          break ;
        }
        var_terminalList_6121.addAssignOperation (var_terminal_6191, var_displayFlags_6218  COMMA_SOURCE_FILE ("guiCompilation.galgas", 197)) ;
      ...
      var_labels_5790.addAssignOperation (var_displayStyle_5982, var_terminalList_6121, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 201))  COMMA_SOURCE_FILE ("guiCompilation.galgas", 201)) ;
    } break ;
    case 3: {
      ...
      GGS_lstring var_value_7053 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 206)), inCompiler COMMA_HERE) ;
      bool repeatFlag_6 = true ;
      while (repeatFlag_6) {
        ...
        var_value_7053 = GGS_lstring::init_21__21_ (var_value_7053.readProperty_string ().add_operation (var_v_7138.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("guiCompilation.galgas", 209)), var_v_7138.readProperty_location (), inCompiler COMMA_HERE) ;
        if (select_galgas_33_GuiComponentSyntax_5 (inCompiler) == 2) {
        }else{
          repeatFlag_6 = false ;
        }
      }
      var_compoundAttributes_5898.addAssignOperation (var_key_6993, var_name_7028, var_value_7053  COMMA_SOURCE_FILE ("guiCompilation.galgas", 212)) ;
    } break ;
    case 4: {
      ...
      var_simpleAttributes_5838.addAssignOperation (var_name_7315, var_value_7361  COMMA_SOURCE_FILE ("guiCompilation.galgas", 217)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioWithLexiqueList.addAssignOperation (var_lexiqueReference_5748, var_labels_5790, var_simpleAttributes_5838, var_compoundAttributes_5898  COMMA_SOURCE_FILE ("guiCompilation.galgas", 220)) ;
}
...
void cParser_galgas_33_GuiComponentSyntax::rule_galgas_33_GuiComponentSyntax_gui_5F_with_5F_option_5F_declaration_i2_ (GGS_lstringlist & ioArgument_ioImportedOptionList,
  ...
  ioArgument_ioImportedOptionList.addAssignOperation (var_optionReference_7751  COMMA_SOURCE_FILE ("guiCompilation.galgas", 229)) ;
}
...
void cParser_galgas_33_GuiComponentSyntax::rule_galgas_33_GuiComponentSyntax_gui_5F_attributes_i3_ (GGS_guiSimpleAttributeListAST & ioArgument_ioSimpleGlobalAttributes,
  ...
  GGS_lstring var_mValue_8053 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("guiCompilation.galgas", 237)), inCompiler COMMA_HERE) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    var_mValue_8053 = GGS_lstring::init_21__21_ (var_mValue_8053.readProperty_string ().add_operation (var_value_8126.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("guiCompilation.galgas", 240)), var_value_8126.readProperty_location (), inCompiler COMMA_HERE) ;
    if (select_galgas_33_GuiComponentSyntax_6 (inCompiler) == 2) {
    }else{
      repeatFlag_0 = false ;
    }
  }
  ioArgument_ioSimpleGlobalAttributes.addAssignOperation (var_mKey_8032, var_mValue_8053  COMMA_SOURCE_FILE ("guiCompilation.galgas", 243)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_declaration_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_importedLexiqueReference_2656 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 51)) ;
  } break ;
  case 2: {
  ...
  ioArgument_ioDeclarations.mProperty_mSyntaxComponentList.addAssignOperation (var_syntaxComponentName_2594, var_importedLexiqueReference_2656, var_nonterminalDeclarationList_3035, var_ruleList_3106, var_hasTranslateFeature_2858  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 77)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_declaration_5F_ggs_33__i1_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  {
  extensionSetter_insertKey (ioArgument_ioDeclarations.mProperty_mSyntaxExtensions, var_syntaxComponentName_3896.readProperty_string (), var_syntaxComponentName_3896, var_nonterminalDeclarationList_3961, var_ruleList_4032, inCompiler COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 105)) ;
  }
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_nonterminal_5F_declaration_i2_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                   ...
                                                                                                                   Lexique_galgasScanner_33_ * inCompiler) {
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_rule COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 119)) ;
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3C_non_5F_terminal_3E_ COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 120)) ;
  ...
  var_labels_4983.addAssignOperation (GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 123)), inCompiler COMMA_HERE), var_firstBranchFormalParameters_5052, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 123))  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 123)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    if (select_galgas_33_SyntaxComponentSyntax_4 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_label COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 126)) ;
      GGS_lstring var_labelName_5213 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 127)) ;
      ...
      var_labels_4983.addAssignOperation (var_labelName_5213, var_formalParameters_5305, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 129))  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 129)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ioArgument_ioNonterminalDeclarationList.addAssignOperation (var_mNonterminalName_4909, var_labels_4983  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 131)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_rule_5F_label_i3_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_endOfArguments_5977 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 142)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7B_ COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 143)) ;
  ...
  ioArgument_ioLabelList.addAssignOperation (constinArgument_inLabelName, var_formalParameters_5952, var_endOfArguments_5977, var_mSyntaxInstructionList_6097, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 150))  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 145)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 151)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_rule_5F_declaration_i4_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                      ...
                                                                                                                      Lexique_galgasScanner_33_ * inCompiler) {
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_rule COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 157)) ;
  GGS_lstring var_mNonterminalName_6523 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->enterIndexing (Lexique_galgasScanner_33_::kIndexing_ruleDefinition, "") ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3C_non_5F_terminal_3E_ COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 158)) ;
  GGS_lstring var_labelName_6572 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 159)), inCompiler COMMA_HERE) ;
  ...
  while (repeatFlag_0) {
    ...
    if (select_galgas_33_SyntaxComponentSyntax_5 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_label COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 164)) ;
      var_labelName_6572 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 165)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ioArgument_ioRuleList.addAssignOperation (var_mNonterminalName_6523, var_mLabelList_6623  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 167)) ;
}
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      case 1: {
        ...
        outArgument_outSyntaxInstructionList.addAssignOperation (var_instruction_7457  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 184)) ;
      } break ;
      case 2: {
        ...
        outArgument_outSyntaxInstructionList.addAssignOperation (var_instruction_7589  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 187)) ;
      } break ;
      default:
        break ;
      }
      if (select_galgas_33_SyntaxComponentSyntax_7 (inCompiler) == 2) {
        ...
        case 1: {
          inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3B_ COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 191)) ;
        } break ;
        case 2: {
          GGS_string var_separator_7730 = GGS_string::class_func_separatorString (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 193)) ;
          GalgasBool test_1 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_1) {
            test_1 = var_separator_7730.getter_containsCharacter (GGS_char (utf32 (10)) COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 194)).operator_not (SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 194)).boolEnum () ;
            if (GalgasBool::boolTrue == test_1) {
              GenericArray <FixItDescription> fixItArray2 ;
              inCompiler->emitSemanticError (GGS_location::class_func_separator (inCompiler  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 195)), GGS_string ("instructions on same line should be separated by ';'"), fixItArray2  COMMA_SOURCE_FILE ("galgasSyntaxComponentSyntax.galgas", 195)) ;
            }
          }
        } break ;
        default:
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_5F_ggs_33__i6_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_instructionLocation_1506 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 27)) ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_terminal_5F_instruction_5F_indexing_i10_ (GGS__32_lstringlist & outArgument_outIndexNameList,
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      case 1: {
        var_postfixName_3225 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("instruction-terminal.galgas", 61)) ;
      } break ;
      case 2: {
      ...
      outArgument_outIndexNameList.addAssignOperation (var_indexName_3163, var_postfixName_3225  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 65)) ;
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_declaration_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_hasIndexing_1956 = GGS_lbool::init_21__21_ (GGS_bool (false), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 37)), inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
    var_hasIndexing_1956 = GGS_lbool::init_21__21_ (GGS_bool (true), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 39)), inCompiler COMMA_HERE) ;
  ...
  while (repeatFlag_0) {
    ...
    var_syntaxComponents_2468.addAssignOperation (var_syntaxComponent_2550  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 59)) ;
  ...
  nt_grammar_5F_start_5F_symbol_5F_label_5F_ggs_33__ (ioArgument_ioDeclarations, GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 65)), inCompiler COMMA_HERE), var_mLabelList_2727, inCompiler) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
  ...
  while (repeatFlag_2) {
    if (select_galgas_33_GrammarComponentSyntax_4 (inCompiler) == 2) {
      ...
      var_mUnusedNonterminalList_3080.addAssignOperation (var_nonterminalSymbolName_3194  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 78)) ;
    }else{
      repeatFlag_2 = false ;
    }
  }
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 81)) ;
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_galgas_33_GrammarComponentAST::init_21_isPredefined_21__21__21__21__21__21__21__21_ (GGS_bool (false), var_hasIndexing_1956, var_mGrammarName_2159, var_mGrammarClass_2237, var_syntaxComponents_2468, var_mStartSymbol_2683, var_mLabelList_2727, var_mUnusedNonterminalList_3080, var_hasTranslateFeature_2291, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 82)) ;
}
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_grammar_5F_start_5F_symbol_5F_label_5F_ggs_33__i1_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    if (select_galgas_33_GrammarComponentSyntax_5 (inCompiler) == 2) {
      ...
      GalgasBool test_1 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_1) {
        test_1 = var_argumentNameSet_3949.getter_hasKey (var_argumentName_4109.readProperty_string () COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 104)).boolEnum () ;
        if (GalgasBool::boolTrue == test_1) {
          GenericArray <FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (var_argumentName_4109.readProperty_location (), GGS_string ("there is already an argument named '").add_operation (var_argumentName_4109.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 105)).add_operation (GGS_string ("'"), inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 105)), fixItArray2  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 105)) ;
        }
      }
      var_argumentNameSet_3949.plusPlusAssignOperation (var_argumentName_4109.readProperty_string ()  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 107)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ioArgument_ioLabelList.addAssignOperation (constinArgument_inLabelName, var_mFormalParameterList_4003, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 109))  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 109)) ;
}
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_label_5F_formal_5F_parameter_5F_ggs_33__i2_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    var_selector_4786 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 122)) ;
  } break ;
  default:
    break ;
  }
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssignOperation (var_selector_4786, GGS_formalArgumentPassingModeAST::class_func_argumentConstantIn (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 136)), var_mTypeName_4981, outArgument_outArgumentName, GGS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 134)) ;
}
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_label_5F_formal_5F_parameter_5F_ggs_33__i3_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    var_selector_5572 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 152)) ;
  } break ;
  default:
    break ;
  }
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssignOperation (var_selector_5572, GGS_formalArgumentPassingModeAST::class_func_argumentVarIn (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 163)), var_mTypeName_5739, outArgument_outArgumentName, GGS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 161)) ;
}
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_label_5F_formal_5F_parameter_5F_ggs_33__i4_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    var_selector_6354 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 179)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_GrammarComponentSyntax::rule_galgas_33_GrammarComponentSyntax_label_5F_formal_5F_parameter_5F_ggs_33__i5_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    var_selector_7129 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 205)) ;
  } break ;
  default:
    break ;
  }
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssignOperation (var_selector_7129, GGS_formalArgumentPassingModeAST::class_func_argumentOut (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 211)), var_mTypeName_7286, outArgument_outArgumentName, GGS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 209)) ;
}
...
void cParser_galgas_33_ProgramDeclarations::rule_galgas_33_ProgramDeclarations_declaration_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_endOfPrologue_2173 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 40)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 41)) ;
  ioArgument_ioDeclarations.mProperty_mPrologueDeclarationList.addAssignOperation (var_prologueInstructionList_2139, var_endOfPrologue_2173  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 42)) ;
}
...
void cParser_galgas_33_ProgramDeclarations::rule_galgas_33_ProgramDeclarations_declaration_5F_ggs_33__i1_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_endOfPrologue_2750 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 55)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 56)) ;
  ioArgument_ioDeclarations.mProperty_mEpilogueDeclarationList.addAssignOperation (var_prologueInstructionList_2718, var_endOfPrologue_2750  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 57)) ;
}
...
void cParser_galgas_33_ProgramDeclarations::rule_galgas_33_ProgramDeclarations_declaration_5F_ggs_33__i2_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_referenceGrammar_3366 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasProgramDeclarations.galgas", 75)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_grammar COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 77)) ;
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3F_selector_3A_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 81)) ;
  GalgasBool test_0 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_0) {
    ...
    if (GalgasBool::boolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (var_selector_3540.readProperty_location (), GGS_string ("the selector should be '\?sourceFilePath:'"), fixItArray1  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 83)) ;
    }
  }
  ...
  case 2: {
    ...
    if (GalgasBool::boolTrue == test_2) {
      ...
      if (GalgasBool::boolTrue == test_2) {
        GenericArray <FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (var_typeName_3744.readProperty_location (), GGS_string ("the only type allowed here is '@lstring'"), fixItArray3  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 89)) ;
      }
    }
  } break ;
  default:
  ...
  GGS_location var_endOfInstructionList_4176 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 103)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 104)) ;
  ioArgument_ioDeclarations.mProperty_mSourceRuleList.addAssignOperation (var_mSourceFileExtension_3243, var_mSourceFileHelp_3307, var_mSourceFileVariableName_4024, var_isUnused_3898, var_referenceGrammar_3366, var_mInstructionList_4151, var_endOfInstructionList_4176  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 105)) ;
}
...
class CollectionElement_templateDelimitorListAST : public CollectionElement {
  public: GGS_templateDelimitorListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElement_templateDelimitorListAST (const GGS_lstring & in_mStartString,
                                                      ...
                                                      COMMA_LOCATION_ARGS) ;
  public: CollectionElement_templateDelimitorListAST (const GGS_templateDelimitorListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_templateDelimitorListAST::CollectionElement_templateDelimitorListAST (const GGS_lstring & in_mStartString,
                                                                                        const GGS_bool & in_nonAtomicSelection,
                                                                                        const GGS_bool & in_mTemplateEndMark,
                                                                                        const GGS_bool & in_mPreserved,
                                                                                        const GGS_lstring & in_mEndString
...
CollectionElement_templateDelimitorListAST::CollectionElement_templateDelimitorListAST (const GGS_templateDelimitorListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_templateDelimitorListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_templateDelimitorListAST::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_templateDelimitorListAST (mObject.mProperty_mStartString, mObject.mProperty_nonAtomicSelection, mObject.mProperty_mTemplateEndMark, mObject.mProperty_mPreserved, mObject.mProperty_mEndString COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    ...
    CollectionElement_templateDelimitorListAST * p = (CollectionElement_templateDelimitorListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_templateDelimitorListAST) ;
...
void GGS_templateDelimitorListAST::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                              ...
                                                              const GGS_lstring & in_mEndString
                                                              COMMA_LOCATION_ARGS) {
  CollectionElement_templateDelimitorListAST * p = nullptr ;
  macroMyNew (p, CollectionElement_templateDelimitorListAST (in_mStartString, in_nonAtomicSelection, in_mTemplateEndMark, in_mPreserved, in_mEndString COMMA_THERE)) ;
...
class CollectionElement_templateReplacementListAST : public CollectionElement {
  public: GGS_templateReplacementListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElement_templateReplacementListAST (const GGS_lstring & in_mMatchString,
                                                        const GGS_lstring & in_mReplacementString,
                                                        const GGS_lstring & in_mReplacementFunction
                                                        COMMA_LOCATION_ARGS) ;
  public: CollectionElement_templateReplacementListAST (const GGS_templateReplacementListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_templateReplacementListAST::CollectionElement_templateReplacementListAST (const GGS_lstring & in_mMatchString,
                                                                                            const GGS_lstring & in_mReplacementString,
                                                                                            const GGS_lstring & in_mReplacementFunction
                                                                                            COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_templateReplacementListAST::CollectionElement_templateReplacementListAST (const GGS_templateReplacementListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_templateReplacementListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_templateReplacementListAST::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_templateReplacementListAST (mObject.mProperty_mMatchString, mObject.mProperty_mReplacementString, mObject.mProperty_mReplacementFunction COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_templateReplacementListAST * p = (CollectionElement_templateReplacementListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_templateReplacementListAST) ;
...
void GGS_templateReplacementListAST::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                ...
                                                                const GGS_lstring & in_mReplacementFunction
                                                                COMMA_LOCATION_ARGS) {
  CollectionElement_templateReplacementListAST * p = nullptr ;
  macroMyNew (p, CollectionElement_templateReplacementListAST (in_mMatchString, in_mReplacementString, in_mReplacementFunction COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
GGS_unifiedTypeMapEntry extensionGetter_typeMapEntryOrNullForLKey (const GGS_unifiedTypeMap & inObject,
  ...
  if (GalgasBool::boolFalse == test_0) {
    ...
    if (GalgasBool::boolTrue == test_1) {
      ...
      if (GalgasBool::boolTrue == test_1) {
        result_result = GGS_unifiedTypeMapEntry::class_func_element (var_node_3677.readProperty_mElement ()  COMMA_SOURCE_FILE ("unified-type-map.galgas", 89)) ;
      }
    }
    if (GalgasBool::boolFalse == test_1) {
...
void extensionSetter_insertType (GGS_unifiedTypeMap & ioObject,
      ...
      case GGS_typeDefinition::Enumeration::enum_unsolved:
        {
          ...
          var_e_4184.setProperty_mDefinition (GGS_typeDefinition::class_func_solved (constinArgument_inTypeDefinition  COMMA_SOURCE_FILE ("unified-type-map.galgas", 104))) ;
        }
        break ;
      }
    }
  ...
  if (GalgasBool::boolFalse == test_0) {
    GGS_unifiedTypeMapElementClass var_newElement_4295 = GGS_unifiedTypeMapElementClass::init_21_ (GGS_typeDefinition::class_func_solved (constinArgument_inTypeDefinition  COMMA_SOURCE_FILE ("unified-type-map.galgas", 107)), inCompiler COMMA_HERE) ;
    {
    ioObject.setter_internalInsertKey (constinArgument_inTypeName, var_newElement_4295, inCompiler COMMA_SOURCE_FILE ("unified-type-map.galgas", 108)) ;
    }
  }
}
...
GGS_unifiedTypeDefinition extensionGetter_definition (const GGS_unifiedTypeMapEntry & inObject,
  ...
  case GGS_unifiedTypeMapEntry::Enumeration::enum_null:
    {
      GenericArray <FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (GGS_location::class_func_nowhere (SOURCE_FILE ("unified-type-map.galgas", 182)), GGS_string ("null type"), fixItArray1  COMMA_SOURCE_FILE ("unified-type-map.galgas", 182)) ;
      result_result.drop () ; // Release error dropped variable
    }
    break ;
  case GGS_unifiedTypeMapEntry::Enumeration::enum_element:
    {
      ...
      if (GalgasBool::boolTrue == test_2) {
        ...
        if (GalgasBool::boolTrue == test_2) {
          ...
          case GGS_typeDefinition::Enumeration::enum_unsolved:
            {
              GenericArray <FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (GGS_location::class_func_nowhere (SOURCE_FILE ("unified-type-map.galgas", 187)), GGS_string ("unsolved type"), fixItArray3  COMMA_SOURCE_FILE ("unified-type-map.galgas", 187)) ;
              result_result.drop () ; // Release error dropped variable
            }
            break ;
          case GGS_typeDefinition::Enumeration::enum_solved:
      ...
      if (GalgasBool::boolFalse == test_2) {
        GenericArray <FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (GGS_location::class_func_nowhere (SOURCE_FILE ("unified-type-map.galgas", 192)), GGS_string ("nil type"), fixItArray4  COMMA_SOURCE_FILE ("unified-type-map.galgas", 192)) ;
        result_result.drop () ; // Release error dropped variable
      }
    }
    break ;
...
GGS_unifiedTypeMapEntry extensionGetter_baseType (const GGS_unifiedTypeMapEntry & inObject,
  ...
  while (loop_7846) {
    GalgasBool test_1 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_1) {
      test_1 = extensionGetter_definition (result_outBaseType, inCompiler COMMA_SOURCE_FILE ("unified-type-map.galgas", 213)).readProperty_superType ().getter_isNull (SOURCE_FILE ("unified-type-map.galgas", 213)).operator_not (SOURCE_FILE ("unified-type-map.galgas", 213)).boolEnum () ;
...
void extensionMethod_addHeaderFileName (const GGS_unifiedTypeMapEntry inObject,
                                        ...
                                        COMMA_UNUSED_LOCATION_ARGS) {
  const GGS_unifiedTypeMapEntry temp_0 = inObject ;
  GGS_unifiedTypeDefinition var_typeDefinition_8133 = extensionGetter_definition (temp_0, inCompiler COMMA_SOURCE_FILE ("unified-type-map.galgas", 221)) ;
  GalgasBool test_1 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_1) {
    test_1 = var_typeDefinition_8133.readProperty_isPredefined ().operator_not (SOURCE_FILE ("unified-type-map.galgas", 222)).operator_and (GGS_bool (ComparisonKind::notEqual, var_typeDefinition_8133.readProperty_headerKind ().objectCompare (GGS_headerKind::class_func_noHeader (SOURCE_FILE ("unified-type-map.galgas", 222)))) COMMA_SOURCE_FILE ("unified-type-map.galgas", 222)).boolEnum () ;
    if (GalgasBool::boolTrue == test_1) {
      ioArgument_ioInclusions.plusPlusAssignOperation (var_typeDefinition_8133.readProperty_headerFileName ()  COMMA_SOURCE_FILE ("unified-type-map.galgas", 223)) ;
    }
  }
}
...
void extensionMethod_addHeaderFileName_31_ (const GGS_unifiedTypeMapEntry inObject,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  const GGS_unifiedTypeMapEntry temp_0 = inObject ;
  GGS_unifiedTypeDefinition var_typeDefinition_8485 = extensionGetter_definition (temp_0, inCompiler COMMA_SOURCE_FILE ("unified-type-map.galgas", 230)) ;
  GalgasBool test_1 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_1) {
    test_1 = var_typeDefinition_8485.readProperty_isPredefined ().operator_not (SOURCE_FILE ("unified-type-map.galgas", 231)).boolEnum () ;
    if (GalgasBool::boolTrue == test_1) {
      ...
      case GGS_headerKind::Enumeration::enum_oneHeader:
        {
          ioArgument_ioInclusions.plusPlusAssignOperation (var_typeDefinition_8485.readProperty_headerFileName ()  COMMA_SOURCE_FILE ("unified-type-map.galgas", 235)) ;
        }
        break ;
      case GGS_headerKind::Enumeration::enum_twoHeaders:
        {
          ioArgument_ioInclusions.plusPlusAssignOperation (var_typeDefinition_8485.readProperty_headerFileName ().add_operation (GGS_string ("-1"), inCompiler COMMA_SOURCE_FILE ("unified-type-map.galgas", 237))  COMMA_SOURCE_FILE ("unified-type-map.galgas", 237)) ;
        }
        break ;
      }
    }
...
class CollectionElement_programListForGeneration : public CollectionElement {
  public: GGS_programListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElement_programListForGeneration (const GGS_semanticDeclarationForGeneration & in_mDeclaration
                                                      COMMA_LOCATION_ARGS) ;
  public: CollectionElement_programListForGeneration (const GGS_programListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_programListForGeneration::CollectionElement_programListForGeneration (const GGS_semanticDeclarationForGeneration & in_mDeclaration
                                                                                        COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_programListForGeneration::CollectionElement_programListForGeneration (const GGS_programListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_programListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_programListForGeneration::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_programListForGeneration (mObject.mProperty_mDeclaration COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_programListForGeneration * p = (CollectionElement_programListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_programListForGeneration) ;
...
void GGS_programListForGeneration::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                              ...
                                                              COMMA_LOCATION_ARGS) {
  CollectionElement_programListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElement_programListForGeneration (in_mDeclaration COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_localConstantList : public CollectionElement {
  public: GGS_localConstantList_2E_element mObject ;

//--- Class functions
  public: CollectionElement_localConstantList (const GGS_unifiedTypeMapEntry & in_mType,
                                               const GGS_lstring & in_mName,
                                               const GGS_bool & in_mNoWarningIfUnused,
                                               const GGS_string & in_mCppName
                                               COMMA_LOCATION_ARGS) ;
  public: CollectionElement_localConstantList (const GGS_localConstantList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_localConstantList::CollectionElement_localConstantList (const GGS_unifiedTypeMapEntry & in_mType,
                                                                          const GGS_lstring & in_mName,
                                                                          const GGS_bool & in_mNoWarningIfUnused,
                                                                          const GGS_string & in_mCppName
                                                                          COMMA_LOCATION_ARGS) :
...
CollectionElement_localConstantList::CollectionElement_localConstantList (const GGS_localConstantList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_localConstantList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_localConstantList::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_localConstantList (mObject.mProperty_mType, mObject.mProperty_mName, mObject.mProperty_mNoWarningIfUnused, mObject.mProperty_mCppName COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_localConstantList * p = (CollectionElement_localConstantList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_localConstantList) ;
...
void GGS_localConstantList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                       ...
                                                       const GGS_string & in_mCppName
                                                       COMMA_LOCATION_ARGS) {
  CollectionElement_localConstantList * p = nullptr ;
  macroMyNew (p, CollectionElement_localConstantList (in_mType, in_mName, in_mNoWarningIfUnused, in_mCppName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_localInitializedVariableList : public CollectionElement {
  public: GGS_localInitializedVariableList_2E_element mObject ;

//--- Class functions
  public: CollectionElement_localInitializedVariableList (const GGS_unifiedTypeMapEntry & in_mType,
                                                          const GGS_lstring & in_mName,
                                                          const GGS_string & in_mCppName
                                                          COMMA_LOCATION_ARGS) ;
  public: CollectionElement_localInitializedVariableList (const GGS_localInitializedVariableList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_localInitializedVariableList::CollectionElement_localInitializedVariableList (const GGS_unifiedTypeMapEntry & in_mType,
                                                                                                const GGS_lstring & in_mName,
                                                                                                const GGS_string & in_mCppName
                                                                                                COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_localInitializedVariableList::CollectionElement_localInitializedVariableList (const GGS_localInitializedVariableList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_localInitializedVariableList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_localInitializedVariableList::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_localInitializedVariableList (mObject.mProperty_mType, mObject.mProperty_mName, mObject.mProperty_mCppName COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_localInitializedVariableList * p = (CollectionElement_localInitializedVariableList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_localInitializedVariableList) ;
...
void GGS_localInitializedVariableList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                  ...
                                                                  const GGS_string & in_mCppName
                                                                  COMMA_LOCATION_ARGS) {
  CollectionElement_localInitializedVariableList * p = nullptr ;
  macroMyNew (p, CollectionElement_localInitializedVariableList (in_mType, in_mName, in_mCppName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
