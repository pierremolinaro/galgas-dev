...
class MapRootFor_constantIndexMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_constantIndexMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_constantIndexMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_constantIndexMap_2E_element>> sortedInfoArray (void) {
  ...
  private: OptionalSharedRef <MapNodeFor_constantIndexMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_constantIndexMap_2E_element & inInfo,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_constantIndexMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
  ...
  friend class MapFor_constantIndexMap ;
...
MapFor_constantIndexMap::MapFor_constantIndexMap (void) :
mSharedRoot () {
}
...
MapFor_constantIndexMap::MapFor_constantIndexMap (const MapFor_constantIndexMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_constantIndexMap & MapFor_constantIndexMap::operator = (const MapFor_constantIndexMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_constantIndexMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_constantIndexMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_constantIndexMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_constantIndexMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_constantIndexMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_constantIndexMap>::make (THERE) ;
...
void MapFor_constantIndexMap::insertOrReplace (const GGS_constantIndexMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_constantIndexMap> unusedExistingNode ;
...
void MapFor_constantIndexMap::performInsert (const GGS_constantIndexMap_2E_element & inElement,
  ...
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_constantIndexMap> existingNode ;
...
MapFor_constantIndexMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
...
bool MapFor_constantIndexMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
...
bool MapFor_constantIndexMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
...
MapFor_constantIndexMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_constantIndexMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_constantIndexMap_2E_element> () ;
    }else{
...
OptionalSharedRef <MapNodeFor_constantIndexMap>
MapFor_constantIndexMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_constantIndexMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_constantIndexMap::count (void) const  {
...
MapFor_constantIndexMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
...
GGS_lstringlist MapFor_constantIndexMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
...
void MapFor_constantIndexMap::makeNewEmptyMapWithMapToOverride (const MapFor_constantIndexMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_constantIndexMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_constantIndexMap::getOverridenMap (MapFor_constantIndexMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
...
uint32_t MapFor_constantIndexMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
...
GGS_stringset MapFor_constantIndexMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
...
void MapFor_constantIndexMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
...
void GGS_constantIndexMap::setter_setMIndexForKey (GGS_uint inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_constantIndexMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
...
class MapFor_internalRoutineMap ;
...
class MapRootFor_internalRoutineMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_internalRoutineMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_internalRoutineMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_internalRoutineMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_internalRoutineMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_internalRoutineMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_internalRoutineMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_internalRoutineMap ;
...
MapFor_internalRoutineMap::MapFor_internalRoutineMap (void) :
mSharedRoot () {
}
...
MapFor_internalRoutineMap::MapFor_internalRoutineMap (const MapFor_internalRoutineMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_internalRoutineMap & MapFor_internalRoutineMap::operator = (const MapFor_internalRoutineMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_internalRoutineMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_internalRoutineMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_internalRoutineMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_internalRoutineMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_internalRoutineMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_internalRoutineMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_internalRoutineMap::insertOrReplace (const GGS_internalRoutineMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_internalRoutineMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_internalRoutineMap::performInsert (const GGS_internalRoutineMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_internalRoutineMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_internalRoutineMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_internalRoutineMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_internalRoutineMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_internalRoutineMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_internalRoutineMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_internalRoutineMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_internalRoutineMap>
MapFor_internalRoutineMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_internalRoutineMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_internalRoutineMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_internalRoutineMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_internalRoutineMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_internalRoutineMap::makeNewEmptyMapWithMapToOverride (const MapFor_internalRoutineMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_internalRoutineMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_internalRoutineMap::getOverridenMap (MapFor_internalRoutineMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_internalRoutineMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_internalRoutineMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_internalRoutineMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_internalRoutineMap::setter_setMArgumentMapForKey (GGS_routineArgumentMap inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_internalRoutineMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapFor_routineArgumentMap ;
...
class MapRootFor_routineArgumentMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_routineArgumentMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_routineArgumentMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_routineArgumentMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_routineArgumentMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_routineArgumentMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_routineArgumentMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_routineArgumentMap ;
...
MapFor_routineArgumentMap::MapFor_routineArgumentMap (void) :
mSharedRoot () {
}
...
MapFor_routineArgumentMap::MapFor_routineArgumentMap (const MapFor_routineArgumentMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_routineArgumentMap & MapFor_routineArgumentMap::operator = (const MapFor_routineArgumentMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_routineArgumentMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_routineArgumentMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_routineArgumentMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_routineArgumentMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_routineArgumentMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_routineArgumentMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_routineArgumentMap::insertOrReplace (const GGS_routineArgumentMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_routineArgumentMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_routineArgumentMap::performInsert (const GGS_routineArgumentMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_routineArgumentMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_routineArgumentMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_routineArgumentMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_routineArgumentMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_routineArgumentMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_routineArgumentMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_routineArgumentMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_routineArgumentMap>
MapFor_routineArgumentMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_routineArgumentMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_routineArgumentMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_routineArgumentMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_routineArgumentMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_routineArgumentMap::makeNewEmptyMapWithMapToOverride (const MapFor_routineArgumentMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_routineArgumentMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_routineArgumentMap::getOverridenMap (MapFor_routineArgumentMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_routineArgumentMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_routineArgumentMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_routineArgumentMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_routineArgumentMap::setter_setMRoutineSignatureForKey (GGS_formalParameterSignature inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_routineArgumentMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapRootFor_grammarLabelMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_grammarLabelMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_grammarLabelMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_grammarLabelMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_grammarLabelMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_grammarLabelMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_grammarLabelMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_grammarLabelMap ;
...
MapFor_grammarLabelMap::MapFor_grammarLabelMap (void) :
mSharedRoot () {
}
...
MapFor_grammarLabelMap::MapFor_grammarLabelMap (const MapFor_grammarLabelMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_grammarLabelMap & MapFor_grammarLabelMap::operator = (const MapFor_grammarLabelMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_grammarLabelMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarLabelMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarLabelMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_grammarLabelMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarLabelMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_grammarLabelMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_grammarLabelMap::insertOrReplace (const GGS_grammarLabelMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_grammarLabelMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_grammarLabelMap::performInsert (const GGS_grammarLabelMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_grammarLabelMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_grammarLabelMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_grammarLabelMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_grammarLabelMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_grammarLabelMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_grammarLabelMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_grammarLabelMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_grammarLabelMap>
MapFor_grammarLabelMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_grammarLabelMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_grammarLabelMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_grammarLabelMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_grammarLabelMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_grammarLabelMap::makeNewEmptyMapWithMapToOverride (const MapFor_grammarLabelMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_grammarLabelMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarLabelMap::getOverridenMap (MapFor_grammarLabelMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_grammarLabelMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_grammarLabelMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_grammarLabelMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_grammarLabelMap::setter_setMLabelSignatureForKey (GGS_formalParameterSignature inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_grammarLabelMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapRootFor_grammarMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_grammarMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_grammarMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_grammarMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_grammarMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_grammarMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_grammarMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_grammarMap ;
...
MapFor_grammarMap::MapFor_grammarMap (void) :
mSharedRoot () {
}
...
MapFor_grammarMap::MapFor_grammarMap (const MapFor_grammarMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_grammarMap & MapFor_grammarMap::operator = (const MapFor_grammarMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_grammarMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_grammarMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_grammarMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_grammarMap::insertOrReplace (const GGS_grammarMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_grammarMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_grammarMap::performInsert (const GGS_grammarMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_grammarMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_grammarMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_grammarMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_grammarMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_grammarMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_grammarMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_grammarMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_grammarMap>
MapFor_grammarMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_grammarMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_grammarMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_grammarMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_grammarMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_grammarMap::makeNewEmptyMapWithMapToOverride (const MapFor_grammarMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_grammarMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_grammarMap::getOverridenMap (MapFor_grammarMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_grammarMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_grammarMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_grammarMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_grammarMap::setter_setMLabelMapForKey (GGS_grammarLabelMap inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_grammarMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapRootFor_functionMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_functionMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_functionMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_functionMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_functionMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_functionMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_functionMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_functionMap ;
...
MapFor_functionMap::MapFor_functionMap (void) :
mSharedRoot () {
}
...
MapFor_functionMap::MapFor_functionMap (const MapFor_functionMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_functionMap & MapFor_functionMap::operator = (const MapFor_functionMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_functionMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_functionMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_functionMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_functionMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_functionMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_functionMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_functionMap::insertOrReplace (const GGS_functionMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_functionMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_functionMap::performInsert (const GGS_functionMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_functionMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_functionMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_functionMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_functionMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_functionMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_functionMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_functionMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_functionMap>
MapFor_functionMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_functionMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_functionMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_functionMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_functionMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_functionMap::makeNewEmptyMapWithMapToOverride (const MapFor_functionMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_functionMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_functionMap::getOverridenMap (MapFor_functionMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_functionMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_functionMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_functionMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_functionMap::setter_setMFunctionSignatureForKey (GGS_functionSignature inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_functionMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapRootFor_wrapperFileMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_wrapperFileMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_wrapperFileMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_wrapperFileMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_wrapperFileMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_wrapperFileMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_wrapperFileMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_wrapperFileMap ;
...
MapFor_wrapperFileMap::MapFor_wrapperFileMap (void) :
mSharedRoot () {
}
...
MapFor_wrapperFileMap::MapFor_wrapperFileMap (const MapFor_wrapperFileMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_wrapperFileMap & MapFor_wrapperFileMap::operator = (const MapFor_wrapperFileMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_wrapperFileMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperFileMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperFileMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_wrapperFileMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperFileMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_wrapperFileMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_wrapperFileMap::insertOrReplace (const GGS_wrapperFileMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_wrapperFileMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_wrapperFileMap::performInsert (const GGS_wrapperFileMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_wrapperFileMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_wrapperFileMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_wrapperFileMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_wrapperFileMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_wrapperFileMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_wrapperFileMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_wrapperFileMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_wrapperFileMap>
MapFor_wrapperFileMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_wrapperFileMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_wrapperFileMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_wrapperFileMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_wrapperFileMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_wrapperFileMap::makeNewEmptyMapWithMapToOverride (const MapFor_wrapperFileMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_wrapperFileMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperFileMap::getOverridenMap (MapFor_wrapperFileMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_wrapperFileMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_wrapperFileMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_wrapperFileMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_wrapperFileMap::setter_setMAbsoluteFilePathForKey (GGS_string inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_wrapperFileMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapFor_wrapperDirectoryMap ;
...
class MapRootFor_wrapperDirectoryMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_wrapperDirectoryMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_wrapperDirectoryMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_wrapperDirectoryMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_wrapperDirectoryMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_wrapperDirectoryMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_wrapperDirectoryMap ;
...
MapFor_wrapperDirectoryMap::MapFor_wrapperDirectoryMap (void) :
mSharedRoot () {
}
...
MapFor_wrapperDirectoryMap::MapFor_wrapperDirectoryMap (const MapFor_wrapperDirectoryMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_wrapperDirectoryMap & MapFor_wrapperDirectoryMap::operator = (const MapFor_wrapperDirectoryMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_wrapperDirectoryMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperDirectoryMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperDirectoryMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_wrapperDirectoryMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperDirectoryMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_wrapperDirectoryMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_wrapperDirectoryMap::insertOrReplace (const GGS_wrapperDirectoryMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_wrapperDirectoryMap::performInsert (const GGS_wrapperDirectoryMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_wrapperDirectoryMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_wrapperDirectoryMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_wrapperDirectoryMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_wrapperDirectoryMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_wrapperDirectoryMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_wrapperDirectoryMap>
MapFor_wrapperDirectoryMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_wrapperDirectoryMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_wrapperDirectoryMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_wrapperDirectoryMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_wrapperDirectoryMap::makeNewEmptyMapWithMapToOverride (const MapFor_wrapperDirectoryMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_wrapperDirectoryMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_wrapperDirectoryMap::getOverridenMap (MapFor_wrapperDirectoryMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_wrapperDirectoryMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_wrapperDirectoryMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_wrapperDirectoryMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_wrapperDirectoryMap::setter_setMRegularFileMapForKey (GGS_wrapperFileMap inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_wrapperDirectoryMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapFor_filewrapperTemplateMap ;
...
class MapRootFor_filewrapperTemplateMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_filewrapperTemplateMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_filewrapperTemplateMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_filewrapperTemplateMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_filewrapperTemplateMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_filewrapperTemplateMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
  ...
  friend class MapFor_filewrapperTemplateMap ;
...
MapFor_filewrapperTemplateMap::MapFor_filewrapperTemplateMap (void) :
mSharedRoot () {
}
...
MapFor_filewrapperTemplateMap::MapFor_filewrapperTemplateMap (const MapFor_filewrapperTemplateMap & inSource) :
mSharedRoot (inSource.mSharedRoot) {
}

//--------------------------------------------------------------------------------------------------

MapFor_filewrapperTemplateMap & MapFor_filewrapperTemplateMap::operator = (const MapFor_filewrapperTemplateMap & inSource) {
  mSharedRoot = inSource.mSharedRoot ;
  return * this ;
}
...
bool MapFor_filewrapperTemplateMap::isValid (void) const {
  return mSharedRoot.isNotNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_filewrapperTemplateMap::drop (void)  {
  mSharedRoot.setToNil () ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_filewrapperTemplateMap::build (LOCATION_ARGS) {
  mSharedRoot = OptionalSharedRef <MapRootFor_filewrapperTemplateMap>::make (THERE) ;
}

//--------------------------------------------------------------------------------------------------

void MapFor_filewrapperTemplateMap::insulate (LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    mSharedRoot->invalidateCacheSortedArray () ;
    if (!mSharedRoot->isUniquelyReferenced ()) {
      auto p = OptionalSharedRef <MapRootFor_filewrapperTemplateMap>::make (THERE) ;
      mSharedRoot->duplicateTo (p COMMA_THERE) ;
      mSharedRoot = p ;
    }
  }
...
void MapFor_filewrapperTemplateMap::insertOrReplace (const GGS_filewrapperTemplateMap_2E_element & inElement
                                                 COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> unusedExistingNode ;
    const bool allowReplacing = true ;
    mSharedRoot->insertOrReplaceInfo (inElement, allowReplacing, unusedExistingNode COMMA_THERE) ;
  }
}
...
void MapFor_filewrapperTemplateMap::performInsert (const GGS_filewrapperTemplateMap_2E_element & inElement,
                                 const char * inInsertErrorMessage,
                                 const char * inShadowErrorMessage,
                                 Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.mProperty_lkey.isValid ()) {
    insulate (THERE) ;
    OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> existingNode ;
    const bool allowReplacing = false ;
    mSharedRoot->insertOrReplaceInfo (
      inElement,
      allowReplacing,
...
MapFor_filewrapperTemplateMap::removeAndReturnRemovedInfo (const String & inKey
                                                       COMMA_LOCATION_ARGS) {
  if (mSharedRoot.isNotNil ()) {
    insulate (THERE) ;
    return mSharedRoot->removeAndReturnRemovedInfo (inKey) ;
...
bool MapFor_filewrapperTemplateMap::contains (const String & inKey) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, 0) ;
  }
...
bool MapFor_filewrapperTemplateMap::containsAtLevel (const String & inKey, const uint32_t inLevel) const {
  bool result = false ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->hasKey (inKey, inLevel) ;
  }
...
MapFor_filewrapperTemplateMap::infoForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    const OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> node = mSharedRoot->searchNode (inKey) ;
    if (node.isNil ()) {
      return SharedGenericPtrWithValueSemantics <GGS_filewrapperTemplateMap_2E_element> () ;
    }else{
      return node->mSharedInfo ;
...
OptionalSharedRef <MapNodeFor_filewrapperTemplateMap>
MapFor_filewrapperTemplateMap::nodeForKey (const String & inKey) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->searchNode (inKey) ;
  }else{
    return OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> () ;
  }
}

//--------------------------------------------------------------------------------------------------

int32_t MapFor_filewrapperTemplateMap::count (void) const  {
  if (mSharedRoot.isNil ()) {
    return 0 ;
  }else{
    return mSharedRoot->count () ;
...
MapFor_filewrapperTemplateMap::sortedInfoArray (void) const {
  if (mSharedRoot.isNotNil ()) {
    return mSharedRoot->sortedInfoArray () ;
  }else{
...
GGS_lstringlist MapFor_filewrapperTemplateMap::keyList (Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) const {
  GGS_lstringlist result ;
  if (isValid ()) {
    result = GGS_lstringlist::init (inCompiler COMMA_THERE) ;
...
void MapFor_filewrapperTemplateMap::makeNewEmptyMapWithMapToOverride (const MapFor_filewrapperTemplateMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) {
  if (inOverridenMap.isValid ()) {
    mSharedRoot = OptionalSharedRef <MapRootFor_filewrapperTemplateMap>::make (inOverridenMap.mSharedRoot COMMA_THERE) ;
  }
}

//--------------------------------------------------------------------------------------------------

void MapFor_filewrapperTemplateMap::getOverridenMap (MapFor_filewrapperTemplateMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const {
  if (isValid ()) {
    ioResult.mSharedRoot = mSharedRoot->mOverriddenRoot ;
...
uint32_t MapFor_filewrapperTemplateMap::levels (void) const {
  uint32_t result = 0 ;
  if (mSharedRoot.isNotNil ()) {
    result = mSharedRoot->levels () ;
  }
...
GGS_stringset MapFor_filewrapperTemplateMap::getter_keySet (Compiler * inCompiler
                                                       COMMA_LOCATION_ARGS) const {
  GGS_stringset result ;
  if (isValid ()) {
    result = GGS_stringset::init (inCompiler COMMA_THERE) ;
...
void MapFor_filewrapperTemplateMap::findNearestKey (const String & inKey,
                                  TC_UniqueArray <String> & outNearestKeyArray) const {
  mSharedRoot->findNearestKey (inKey, outNearestKeyArray) ;
}
...
void GGS_filewrapperTemplateMap::setter_setMTemplateSignatureForKey (GGS_functionSignature inValue,
  ...
  if (isValid () && inKey.isValid ()) {
    insulate (THERE) ;
    const String key = inKey.stringValue () ;
    OptionalSharedRef <MapNodeFor_filewrapperTemplateMap> node = nodeForKey (key) ;
    if (node.isNil ()) {
      String message = "cannot write property in map: the '" ;
      message.appendString (key) ;
      message.appendCString ("' key does not exist") ;
...
class MapRootFor_filewrapperMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_filewrapperMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_filewrapperMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_filewrapperMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_filewrapperMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_filewrapperMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_filewrapperMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
...
class MapRootFor_optionComponentMapForSemanticAnalysis final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_optionComponentMapForSemanticAnalysis> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_optionComponentMapForSemanticAnalysis> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_optionComponentMapForSemanticAnalysis_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_optionComponentMapForSemanticAnalysis> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_optionComponentMapForSemanticAnalysis_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_optionComponentMapForSemanticAnalysis_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
...
class MapRootFor_lexiqueComponentMapForSemanticAnalysis final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_lexiqueComponentMapForSemanticAnalysis> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_lexiqueComponentMapForSemanticAnalysis> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_lexiqueComponentMapForSemanticAnalysis_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_lexiqueComponentMapForSemanticAnalysis> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_lexiqueComponentMapForSemanticAnalysis_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_lexiqueComponentMapForSemanticAnalysis_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
...
class MapRootFor_syntaxComponentMap final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_syntaxComponentMap> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_syntaxComponentMap> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_syntaxComponentMap_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_syntaxComponentMap> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_syntaxComponentMap_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_syntaxComponentMap_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
...
class MapRootFor_extensionInitializerMapForType final : public SharedObject {
  ...
  private: OptionalSharedRef <MapRootFor_extensionInitializerMapForType> mOverriddenRoot ;
  ...
  private: void duplicateTo (OptionalSharedRef <MapRootFor_extensionInitializerMapForType> & outNewRoot
                             COMMA_UNUSED_LOCATION_ARGS) {
    if (mRootNode.isNotNil ()) { // Do not duplicate mCacheSortedArray
  ...
  private: TC_Array <SharedGenericPtrWithValueSemantics <GGS_extensionInitializerMapForType_2E_element>> sortedInfoArray (void) {
    if (mCacheSortedArrayIsValid) {
      return mCacheSortedArray ;
    }else{
  ...
  private: OptionalSharedRef <MapNodeFor_extensionInitializerMapForType> searchNode (const String & inKey) const {
  ...
  private: void insertOrReplaceInfo (const GGS_extensionInitializerMapForType_2E_element & inInfo,
                                     const bool inAllowReplacing,
  ...
  private: SharedGenericPtrWithValueSemantics <GGS_extensionInitializerMapForType_2E_element> removeAndReturnRemovedInfo (const String & inKey) {
    macroUniqueSharedObject (this) ;
    bool ioBranchHasBeenRemoved ;
    auto removedEntry = internalRemoveEntry (inKey, mRootNode, ioBranchHasBeenRemoved) ;
