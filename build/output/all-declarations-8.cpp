...
void extensionMethod_tikzNodeForSyntaxInstruction (const GALGAS_syntaxInstructionListForGrammarAnalysis inObject,
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, temp_0.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 230)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_string var_nodeName_9993 ;
    {
    extensionSetter_append (ioArgument_ioRowList, GALGAS_string ("[point] {}"), constinArgument_inRow, ioArgument_ioColumn, var_nodeName_9993, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 231)) ;
    }
    ioArgument_ioArrows.plusAssign_operation(GALGAS_string ("  \\draw (").add_operation (ioArgument_ioCurrentNode, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)).add_operation (GALGAS_string (") "), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)).add_operation (ioArgument_ioArrowShape, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)).add_operation (var_nodeName_9993, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)), inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 237)) ;
    ioArgument_ioCurrentNode = var_nodeName_9993 ;
    ioArgument_ioArrowShape = GALGAS_string ("--") ;
    ioArgument_ioColumn.increment_operation (inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 240)) ;
  }else if (kBoolFalse == test_1) {
    const GALGAS_syntaxInstructionListForGrammarAnalysis temp_2 = inObject ;
    cEnumerator_syntaxInstructionListForGrammarAnalysis enumerator_10200 (temp_2, kENUMERATION_UP) ;
    while (enumerator_10200.hasCurrentObject ()) {
      callExtensionMethod_tikzNodeForSyntaxInstruction ((const cPtr_abstractSyntaxInstructionForGrammarAnalysis *) enumerator_10200.current_mInstruction (HERE).ptr (), ioArgument_ioRowList, constinArgument_inRow, ioArgument_ioColumn, ioArgument_ioCurrentNode, ioArgument_ioArrowShape, ioArgument_ioArrows, ioArgument_ioMaxUsedRowIndex, constinArgument_inDebug, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 243)) ;
...
void extensionSetter_append (GALGAS_rowList & ioObject,
  ...
  GALGAS_uint var_length_10993 = temp_0.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 272)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsInfOrEqual, var_length_10993.objectCompare (constinArgument_inRow)).boolEnum () ;
  if (kBoolTrue == test_1) {
    cEnumerator_range enumerator_11065 (GALGAS_range (var_length_10993, constinArgument_inRow.substract_operation (var_length_10993, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 274)).add_operation (GALGAS_uint (1), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 274))), kENUMERATION_UP) ;
    while (enumerator_11065.hasCurrentObject ()) {
      ioObject.addAssign_operation (GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("production-rules-in-tex.galgas", 275))  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 275)) ;
      enumerator_11065.gotoNextObject () ;
    }
  }
  const GALGAS_rowList temp_2 = ioObject ;
  GALGAS__32_stringlist var_cols_11124 = temp_2.getter_columnsAtIndex (constinArgument_inRow, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 279)) ;
  const enumGalgasBool test_3 = GALGAS_bool (kIsInfOrEqual, var_cols_11124.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 281)).objectCompare (constinArgument_inColumn)).boolEnum () ;
  if (kBoolTrue == test_3) {
    cEnumerator_range enumerator_11259 (GALGAS_range (var_cols_11124.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 282)), constinArgument_inColumn.substract_operation (var_cols_11124.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 282)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 282)).add_operation (GALGAS_uint (1), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 282))), kENUMERATION_UP) ;
    while (enumerator_11259.hasCurrentObject ()) {
      var_cols_11124.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 283)) ;
      enumerator_11259.gotoNextObject () ;
    }
  }
  outArgument_outNodeName = GALGAS_string ("p").add_operation (constinArgument_inRow.getter_string (SOURCE_FILE ("production-rules-in-tex.galgas", 287)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 287)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 287)).add_operation (var_cols_11124.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 287)).getter_string (SOURCE_FILE ("production-rules-in-tex.galgas", 287)), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 287)) ;
  var_cols_11124.addAssign_operation (outArgument_outNodeName, constinArgument_inNodeDefinition  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 288)) ;
  {
  ioObject.setter_setColumnsAtIndex (var_cols_11124, constinArgument_inRow, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 290)) ;
  }
}
...
GALGAS_bool extensionGetter_displayVertically (const GALGAS_syntaxInstructionListForGrammarAnalysis & inObject,
  ...
  const GALGAS_syntaxInstructionListForGrammarAnalysis temp_0 = inObject ;
  result_result = GALGAS_bool (kIsStrictSup, temp_0.getter_length (SOURCE_FILE ("production-rules-in-tex.galgas", 562)).objectCompare (GALGAS_uint ((uint32_t) 4U))) ;
  const GALGAS_syntaxInstructionListForGrammarAnalysis temp_1 = inObject ;
  cEnumerator_syntaxInstructionListForGrammarAnalysis enumerator_20513 (temp_1, kENUMERATION_UP) ;
  bool bool_2 = result_result.isValidAndTrue () ;
  if (enumerator_20513.hasCurrentObject () && bool_2) {
    while (enumerator_20513.hasCurrentObject () && bool_2) {
      result_result = callExtensionGetter_isLinear ((const cPtr_abstractSyntaxInstructionForGrammarAnalysis *) enumerator_20513.current_mInstruction (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 564)) ;
      enumerator_20513.gotoNextObject () ;
      if (enumerator_20513.hasCurrentObject ()) {
...
bool C_Lexique_galgas_33_Scanner::galgasUnicodeLetter (void) {
  return testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z')) ;
}
...
void cParser_galgas_33_ExpressionSyntax::rule_galgas_33_ExpressionSyntax_factor_i12_ (GALGAS_semanticExpressionAST & outArgument_outExpression,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      outArgument_outExpression = GALGAS_structFieldAccessExpressionAST::constructor_new (var_structFieldName_18200.mProperty_location, outArgument_outExpression, var_structFieldName_18200  COMMA_SOURCE_FILE ("galgas3ExpressionSyntax.galgas", 359)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_galgas_33_ExpressionSyntax::rule_galgas_33_ExpressionSyntax_primary_i18_ (GALGAS_semanticExpressionAST & outArgument_outExpression,
  ...
  while (repeatFlag_0) {
    ...
    var_literalStringList_22662.addAssign_operation (var_literalString_22710.mProperty_string  COMMA_SOURCE_FILE ("galgas3ExpressionSyntax.galgas", 429)) ;
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 2: {
        ...
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_selector_4402.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_3) {
          ...
          if (var_n_4579.isValid ()) {
            ...
            while (loop_4791) {
              ...
              if (loop_4791) {
                variant_4791 -- ;
                outArgument_outActualParameterList.addAssign_operation (GALGAS_inputJokerActualParameterAST::constructor_new (var_selector_4402.mProperty_location, var_n_4579  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.galgas", 95))  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.galgas", 95)) ;
    ...
    case 6: {
      ...
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_selector_5832.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_6) {
      ...
      if (kBoolTrue == test_8) {
        ...
        if (var_n_5881.isValid ()) {
          ...
          while (loop_6081) {
            ...
            if (loop_6081) {
              variant_6081 -- ;
              outArgument_outActualParameterList.addAssign_operation (GALGAS_outputInputJokerParameterAST::constructor_new (var_selector_5832.mProperty_location, var_n_5881  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.galgas", 142))  COMMA_SOURCE_FILE ("galgas3ParameterArgumentSyntax.galgas", 142)) ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_declaration_5F_with_5F_private_i4_ (const GALGAS_bool constinArgument_inIsPrivate,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_attribute_7156.mProperty_string.objectCompare (GALGAS_string ("once"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        ...
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_attribute_7156.mProperty_string.objectCompare (GALGAS_string ("usefull"))).boolEnum () ;
        if (kBoolTrue == test_4) {
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_syntax_5F_directed_5F_translation_5F_result_i8_ (GALGAS_abstractGrammarInstructionSyntaxDirectedTranslationResult & outArgument_outResult,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selector_13040.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i13_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_terminator_3423.mProperty_string.objectCompare (GALGAS_string ("cast"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i25_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_terminator_8253.mProperty_string.objectCompare (GALGAS_string ("for"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i32_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_terminator_2084.mProperty_string.objectCompare (GALGAS_string ("if"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i37_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_terminator_1844.mProperty_string.objectCompare (GALGAS_string ("loop"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i41_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_terminator_4039.mProperty_string.objectCompare (GALGAS_string ("match"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray3 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i51_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selector_1309.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i52_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selector_2387.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i53_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_terminator_2210.mProperty_string.objectCompare (GALGAS_string ("switch"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_i58_ (GALGAS_semanticInstructionAST & outArgument_outInstruction,
  ...
  case 2: {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_terminator_2292.mProperty_string.objectCompare (GALGAS_string ("with"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_with_5F_instruction_5F_core_i59_ (const GALGAS_location constinArgument_inInstructionLocation,
  ...
  case 2: {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_searchMethodNameForErrorSignaling_2977.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_with_5F_instruction_5F_core_i60_ (const GALGAS_location constinArgument_inInstructionLocation,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_selector_4400.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
  ...
  case 2: {
    ...
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_searchMethodNameForErrorSignaling_4815.mProperty_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      TC_Array <C_FixItDescription> fixItArray4 ;
