...
void cPtr_ifInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
  ...
  GALGAS_string var_testVar_32617 = GALGAS_string ("test_").add_operation (ioArgument_ioTemporaryVariableIndex.getter_string (SOURCE_FILE ("instruction-if.galgas", 831)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 831)) ;
  ...
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("enumGalgasBool ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 833)).add_operation (GALGAS_string (" = kBoolTrue ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 833)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 833)) ;
  const GALGAS_ifInstructionForGeneration temp_0 = this ;
  cEnumerator_ifTestListForGeneration enumerator_32780 (temp_0.readProperty_mExpressions (), EnumerationOrder::up) ;
  while (enumerator_32780.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolTrue == ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 835)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 835)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 835)) ;
    {
    ...
    switch (enumerator_32780.current_mExpression (HERE).enumValue ()) {
    case GALGAS_ifTestForGeneration::kNotBuilt:
      break ;
    case GALGAS_ifTestForGeneration::kEnum_regular:
      {
        const cEnumAssociatedValues_ifTestForGeneration_regular * extractPtr_33209 = (const cEnumAssociatedValues_ifTestForGeneration_regular *) (enumerator_32780.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_32961_exp = extractPtr_33209->mAssociatedValue0 ;
        GALGAS_string var_cppVarName_33134 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_32961_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_33134, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 839)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(var_testVar_32617.add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 846)).add_operation (var_cppVarName_33134, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 846)).add_operation (GALGAS_string (".boolEnum () ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 846)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 846)) ;
      }
      break ;
    case GALGAS_ifTestForGeneration::kEnum_letExp:
      {
        const cEnumAssociatedValues_ifTestForGeneration_letExp * extractPtr_33954 = (const cEnumAssociatedValues_ifTestForGeneration_letExp *) (enumerator_32780.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_string extractedValue_33245_targetVarCppName = extractPtr_33954->mAssociatedValue0 ;
        const GALGAS_semanticExpressionForGeneration extractedValue_33262_exp = extractPtr_33954->mAssociatedValue1 ;
        const GALGAS_unifiedTypeMapEntry extractedValue_33266_targetType = extractPtr_33954->mAssociatedValue2 ;
        const GALGAS_unifiedTypeMapEntry extractedValue_33277_testType = extractPtr_33954->mAssociatedValue3 ;
        GALGAS_string var_targetTypeName_33299 = extensionGetter_identifierRepresentation (extractedValue_33266_targetType, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 848)) ;
        GALGAS_string var_testTypeName_33364 = extensionGetter_identifierRepresentation (extractedValue_33277_testType, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 849)) ;
        GALGAS_string var_cppVarName_33581 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_33262_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_33581, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 850)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (var_targetTypeName_33299, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 857)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 857)).add_operation (extractedValue_33245_targetVarCppName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 857)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 857)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (" (dynamic_cast <const cPtr_").add_operation (var_testTypeName_33364, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)).add_operation (GALGAS_string (" *> ("), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)).add_operation (var_cppVarName_33581, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)).add_operation (GALGAS_string (".ptr ())) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 858)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (nullptr == ").add_operation (extractedValue_33245_targetVarCppName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 859)).add_operation (GALGAS_string (".ptr ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 859)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 859)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 860)).add_operation (GALGAS_string (" = kBoolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 860)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 860)) ;
    ...
    case GALGAS_ifTestForGeneration::kEnum_optionalMethodCall:
      {
        const cEnumAssociatedValues_ifTestForGeneration_optionalMethodCall * extractPtr_35691 = (const cEnumAssociatedValues_ifTestForGeneration_optionalMethodCall *) (enumerator_32780.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_33989_receiverExpression = extractPtr_35691->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_34008_optionalMethodName = extractPtr_35691->mAssociatedValue1 ;
        const GALGAS_optionalMethodActualArgumentListForGeneration extractedValue_34027_parameters = extractPtr_35691->mAssociatedValue2 ;
        GALGAS_string var_cppVarName_34222 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_33989_receiverExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_34222, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 863)) ;
        GALGAS_stringlist temp_1 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 870)) ;
        GALGAS_stringlist var_actualParameterNameList_34263 = temp_1 ;
        cEnumerator_optionalMethodActualArgumentListForGeneration enumerator_34304 (extractedValue_34027_parameters, EnumerationOrder::up) ;
        while (enumerator_34304.hasCurrentObject ()) {
          switch (enumerator_34304.current_mParameter (HERE).enumValue ()) {
          ...
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualOutput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualOutput * extractPtr_34661 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualOutput *) (enumerator_34304.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_semanticExpressionForGeneration extractedValue_34384_expression = extractPtr_34661->mAssociatedValue0 ;
              GALGAS_string var_argumentCppName_34595 ;
              callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_34384_expression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_argumentCppName_34595, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 874)) ;
              var_actualParameterNameList_34263.addAssign_operation (var_argumentCppName_34595  COMMA_SOURCE_FILE ("instruction-if.galgas", 881)) ;
            }
            break ;
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualLetInput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualLetInput * extractPtr_34882 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualLetInput *) (enumerator_34304.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_string extractedValue_34706_typeName = extractPtr_34882->mAssociatedValue0 ;
              const GALGAS_string extractedValue_34715_constantName = extractPtr_34882->mAssociatedValue1 ;
              var_actualParameterNameList_34263.addAssign_operation (extractedValue_34715_constantName  COMMA_SOURCE_FILE ("instruction-if.galgas", 883)) ;
              ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (extractedValue_34706_typeName.getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 884)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 884)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 884)).add_operation (extractedValue_34715_constantName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 884)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 884)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 884)) ;
            }
            break ;
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualVarInput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualVarInput * extractPtr_35094 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualVarInput *) (enumerator_34304.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_string extractedValue_34918_typeName = extractPtr_35094->mAssociatedValue0 ;
              const GALGAS_string extractedValue_34927_variableName = extractPtr_35094->mAssociatedValue1 ;
              var_actualParameterNameList_34263.addAssign_operation (extractedValue_34927_variableName  COMMA_SOURCE_FILE ("instruction-if.galgas", 886)) ;
              ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (extractedValue_34918_typeName.getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 887)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 887)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 887)).add_operation (extractedValue_34927_variableName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 887)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 887)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 887)) ;
            }
            break ;
          }
          enumerator_34304.gotoNextObject () ;
        }
        GALGAS_string var_boolResultName_35133 = GALGAS_string ("optionalResult").add_operation (extractedValue_34008_optionalMethodName.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 890)).getter_string (SOURCE_FILE ("instruction-if.galgas", 890)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 890)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("const bool ").add_operation (var_boolResultName_35133, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 891)).add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 891)).add_operation (var_cppVarName_34222, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 891)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 891)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".optional_").add_operation (extractedValue_34008_optionalMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 892)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 892)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 892)) ;
        cEnumerator_stringlist enumerator_35363 (var_actualParameterNameList_34263, EnumerationOrder::up) ;
        while (enumerator_35363.hasCurrentObject ()) {
          ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_35363.current_mValue (HERE), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 895)) ;
          if (enumerator_35363.hasNextObject ()) {
        ...
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (!").add_operation (var_boolResultName_35133, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 900)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 900)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 900)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 901)).add_operation (GALGAS_string (" = kBoolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 901)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 901)) ;
  ...
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolTrue == ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 906)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 906)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 906)) ;
  {
  ...
  cEnumerator_ifTestListForGeneration enumerator_36042 (temp_3.readProperty_mExpressions (), EnumerationOrder::up) ;
  ...
  if (kBoolTrue == test_4) {
    ...
    if (kBoolTrue == test_4) {
      ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolFalse == ").add_operation (var_testVar_32617, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 922)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 922)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 922)) ;
      {
...
void cPtr_readWriteAccessWithInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  GALGAS_semanticInstructionListForGeneration var_do_5F_instructionList_24593 ;
  {
  ...
  routine_analyzeSemanticInstructionList_3F__26__3F__26__3F_localConstantList_3F_localInitializedVariableListWarnsIfNotMutated_3F_localInitializedVariableListNoWarnsIfNotMutated_3F__3F__26__21_ (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, var_localConstantList_23881, temp_46, var_localInitializedVariableList_23501, temp_47.readProperty_m_5F_do_5F_Instructions (), temp_48.readProperty_mEndOf_5F_do_5F_instructions (), ioArgument_ioVariableMap, var_do_5F_instructionList_24593, inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 596)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList_25005 ;
  {
...
void cPtr_readOnlyWithInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
                                                                            ...
                                                                            Compiler * inCompiler
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_receiverVarCppName_27552 ;
  const GALGAS_readOnlyWithInstructionForGeneration temp_0 = this ;
  callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) temp_0.readProperty_mReceiverExpression ().ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverVarCppName_27552, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 677)) ;
  const GALGAS_readOnlyWithInstructionForGeneration temp_1 = this ;
  GALGAS_unifiedTypeMapEntry var_receiverType_27581 = temp_1.readProperty_mReceiverExpression ().readProperty_mResultType () ;
  GALGAS_string var_keyVarCppName_27819 ;
  const GALGAS_readOnlyWithInstructionForGeneration temp_2 = this ;
  callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) temp_2.readProperty_mKeyExpression ().ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_keyVarCppName_27819, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 686)) ;
  const GALGAS_readOnlyWithInstructionForGeneration temp_3 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("const cMapElement_").add_operation (extensionGetter_identifierRepresentation (var_receiverType_27581, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 694)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 694)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 694)).add_operation (temp_3.readProperty_mObjectArrayCppName (), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 695)).add_operation (GALGAS_string (" = (const cMapElement_"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 695)).add_operation (extensionGetter_identifierRepresentation (var_receiverType_27581, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 696)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 696)).add_operation (GALGAS_string (" *) "), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 696)).add_operation (var_receiverVarCppName_27552, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 697)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 697)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 694)) ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    ...
    if (kBoolTrue == test_4) {
      ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("readAccessForWithInstruction (").add_operation (var_keyVarCppName_27819, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 699)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 699)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 699)) ;
    }
  }
  if (kBoolFalse == test_4) {
...
void cPtr_readWriteWithInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
  ...
  GALGAS_string var_receiverCppName_29902 = temp_0.readProperty_mReceiverVariableCppName () ;
  const GALGAS_readWriteWithInstructionForGeneration temp_1 = this ;
  cEnumerator_lstringlist enumerator_29957 (temp_1.readProperty_mStructAttributeList (), EnumerationOrder::up) ;
  while (enumerator_29957.hasCurrentObject ()) {
    var_receiverCppName_29902.plusAssign_operation(GALGAS_string (".mProperty_").add_operation (enumerator_29957.current_mValue (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-with.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 744)), inCompiler  COMMA_SOURCE_FILE ("instruction-with.galgas", 744)) ;
    enumerator_29957.gotoNextObject () ;
  }
  GALGAS_string var_keyVarCppName_30269 ;
  const GALGAS_readWriteWithInstructionForGeneration temp_2 = this ;
  callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) temp_2.readProperty_mKeyExpression ().ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_keyVarCppName_30269, inCompiler COMMA_SOURCE_FILE ("instruction-with.galgas", 747)) ;
  {
...
void cPtr_selectInstructionForGrammarAnalysis::method_tikzNodeForSyntaxInstruction (GALGAS_rowList & ioArgument_ioRowList,
  ...
  GALGAS_string var_startNodeName_13018 ;
  {
  extensionSetter_appendRow (ioArgument_ioRowList, GALGAS_string ("[point] §[]"), constinArgument_inRow, ioArgument_ioColumn, var_startNodeName_13018, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 366)) ;
  }
  ...
  GALGAS_branchListForGrammarAnalysis var_branches_13078 = temp_2.readProperty_mSelectBranchList () ;
  GALGAS_syntaxInstructionListForGrammarAnalysis var_brancheZero_13181 ;
  {
  var_branches_13078.setter_popFirst (var_brancheZero_13181, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 370)) ;
  }
  GALGAS_uint var_branchZeroColumn_13200 = ioArgument_ioColumn ;
  GALGAS_uint var_maxUsedRowIndex_13234 = constinArgument_inRow ;
  extensionMethod_tikzNodeForSyntaxInstruction (var_brancheZero_13181, ioArgument_ioRowList, constinArgument_inRow, var_branchZeroColumn_13200, ioArgument_ioCurrentNode, ioArgument_ioArrowShape, ioArgument_ioArrows, var_maxUsedRowIndex_13234, constinArgument_inDebug, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 373)) ;
  GALGAS_uint var_endColumn_13495 = var_branchZeroColumn_13200 ;
  GALGAS_stringlist temp_3 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 385)) ;
  GALGAS_stringlist var_endingNodes_13572 = temp_3 ;
  cEnumerator_branchListForGrammarAnalysis enumerator_13606 (var_branches_13078, EnumerationOrder::up) ;
  while (enumerator_13606.hasCurrentObject ()) {
    var_maxUsedRowIndex_13234.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 387)) ;
    GALGAS_uint var_branchColumn_13651 = ioArgument_ioColumn ;
    GALGAS_string var_currentNode_13683 = var_startNodeName_13018 ;
    GALGAS_string var_arrowStyle_13719 = GALGAS_string ("|-") ;
    extensionMethod_tikzNodeForSyntaxInstruction (enumerator_13606.current (HERE).readProperty_mSyntaxInstructionList (), ioArgument_ioRowList, var_maxUsedRowIndex_13234, var_branchColumn_13651, var_currentNode_13683, var_arrowStyle_13719, ioArgument_ioArrows, var_maxUsedRowIndex_13234, constinArgument_inDebug, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 391)) ;
    var_endingNodes_13572.addAssign_operation (var_currentNode_13683  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 401)) ;
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = GALGAS_bool (ComparisonKind::lowerThan, var_endColumn_13495.objectCompare (var_branchColumn_13651)).boolEnum () ;
      if (kBoolTrue == test_4) {
        var_endColumn_13495 = var_branchColumn_13651 ;
      }
    }
    enumerator_13606.gotoNextObject () ;
  }
  ioArgument_ioColumn = var_endColumn_13495 ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = GALGAS_bool (ComparisonKind::lowerThan, ioArgument_ioMaxUsedRowIndex.objectCompare (var_maxUsedRowIndex_13234)).boolEnum () ;
    if (kBoolTrue == test_5) {
      ioArgument_ioMaxUsedRowIndex = var_maxUsedRowIndex_13234 ;
    }
  }
  GALGAS_string var_endNodeName_14355 ;
  {
  extensionSetter_appendRow (ioArgument_ioRowList, GALGAS_string ("[point] §[]"), constinArgument_inRow, ioArgument_ioColumn, var_endNodeName_14355, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 411)) ;
  }
...
void cPtr_repeatInstructionForGrammarAnalysis::method_tikzNodeForSyntaxInstruction (GALGAS_rowList & ioArgument_ioRowList,
  ...
  GALGAS_string var_returnNodeName_16018 ;
  {
  extensionSetter_appendRow (ioArgument_ioRowList, GALGAS_string ("[point] §[]"), constinArgument_inRow, ioArgument_ioColumn, var_returnNodeName_16018, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 460)) ;
  }
  ...
  GALGAS_branchListForGrammarAnalysis var_branches_16079 = temp_2.readProperty_mRepeatBranchList () ;
  GALGAS_syntaxInstructionListForGrammarAnalysis var_brancheZero_16182 ;
  {
  var_branches_16079.setter_popFirst (var_brancheZero_16182, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 464)) ;
  }
  GALGAS_uint var_maxUsedRowIndex_16201 = constinArgument_inRow ;
  extensionMethod_tikzNodeForSyntaxInstruction (var_brancheZero_16182, ioArgument_ioRowList, constinArgument_inRow, ioArgument_ioColumn, ioArgument_ioCurrentNode, ioArgument_ioArrowShape, ioArgument_ioArrows, var_maxUsedRowIndex_16201, constinArgument_inDebug, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 466)) ;
  GALGAS_uint var_endColumn_16454 = ioArgument_ioColumn ;
  GALGAS_string var_startNodeName_16595 ;
  {
  extensionSetter_appendRow (ioArgument_ioRowList, GALGAS_string ("[point] §[]"), constinArgument_inRow, ioArgument_ioColumn, var_startNodeName_16595, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 478)) ;
  }
  ...
  GALGAS_bool var_oneEmptyBranch_16697 = GALGAS_bool (ComparisonKind::equal, var_branches_16079.getter_count (SOURCE_FILE ("production-rules-in-tex.galgas", 481)).objectCompare (GALGAS_uint (uint32_t (1U)))) ;
  enumGalgasBool test_3 = kBoolTrue ;
  if (kBoolTrue == test_3) {
    test_3 = var_oneEmptyBranch_16697.boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_syntaxInstructionListForGrammarAnalysis var_firstBranch_16786 ;
      var_branches_16079.method_first (var_firstBranch_16786, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 483)) ;
      var_oneEmptyBranch_16697 = GALGAS_bool (ComparisonKind::equal, var_firstBranch_16786.getter_count (SOURCE_FILE ("production-rules-in-tex.galgas", 484)).objectCompare (GALGAS_uint (uint32_t (0U)))) ;
    }
  }
  GALGAS_stringlist temp_4 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 487)) ;
  GALGAS_stringlist var_endingNodes_16889 = temp_4 ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = var_oneEmptyBranch_16697.boolEnum () ;
    if (kBoolTrue == test_5) {
      var_endingNodes_16889.addAssign_operation (var_startNodeName_16595  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 489)) ;
    }
  }
  if (kBoolFalse == test_5) {
    GALGAS_uint var_nextBranchUsedRowIndex_16981 = constinArgument_inRow ;
    cEnumerator_branchListForGrammarAnalysis enumerator_17030 (var_branches_16079, EnumerationOrder::up) ;
    while (enumerator_17030.hasCurrentObject ()) {
      var_nextBranchUsedRowIndex_16981.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 493)) ;
      GALGAS_uint var_branchColumn_17086 = ioArgument_ioColumn ;
      GALGAS_string var_currentNode_17120 = var_startNodeName_16595 ;
      GALGAS_string var_arrowStyle_17158 = GALGAS_string ("|-") ;
      extensionMethod_tikzNodeForSyntaxInstruction (enumerator_17030.current (HERE).readProperty_mSyntaxInstructionList (), ioArgument_ioRowList, var_nextBranchUsedRowIndex_16981, var_branchColumn_17086, var_currentNode_17120, var_arrowStyle_17158, ioArgument_ioArrows, var_nextBranchUsedRowIndex_16981, constinArgument_inDebug, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 497)) ;
      var_endingNodes_16889.addAssign_operation (var_currentNode_17120  COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 507)) ;
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        test_6 = GALGAS_bool (ComparisonKind::lowerThan, var_endColumn_16454.objectCompare (var_branchColumn_17086)).boolEnum () ;
        if (kBoolTrue == test_6) {
          var_endColumn_16454 = var_branchColumn_17086 ;
        }
      }
      enumerator_17030.gotoNextObject () ;
    }
    ioArgument_ioColumn = var_endColumn_16454 ;
    ioArgument_ioMaxUsedRowIndex = var_nextBranchUsedRowIndex_16981 ;
  }
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    test_7 = GALGAS_bool (ComparisonKind::lowerThan, ioArgument_ioMaxUsedRowIndex.objectCompare (var_maxUsedRowIndex_16201)).boolEnum () ;
    if (kBoolTrue == test_7) {
      ioArgument_ioMaxUsedRowIndex = var_maxUsedRowIndex_16201 ;
    }
  }
  ...
  GALGAS_string var_returnUpperNodeName_17993 ;
  {
  extensionSetter_appendRow (ioArgument_ioRowList, GALGAS_string ("[point] §[]"), ioArgument_ioMaxUsedRowIndex, ioArgument_ioColumn, var_returnUpperNodeName_17993, inCompiler COMMA_SOURCE_FILE ("production-rules-in-tex.galgas", 521)) ;
  }
...
void routine_compileProgramRulesGalgas_33__26__26__3F__26__3F__26_ (GALGAS_lstringlist & ioArgument_ioUsefulnessRootEntities,
  ...
  while (enumerator_4776.hasCurrentObject ()) {
    ...
    GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration_5592 ;
    GALGAS_formalParameterListForGeneration var_routineSignature_5640 ;
    {
...
void routine_compileAfterClauseGalgas_33__26__26__3F__26__3F__26_ (GALGAS_lstringlist & ioArgument_ioUsefulnessRootEntities,
                                                                   ...
                                                                   Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_usefulnessName_6652 = function_afterNameForUsefulEntitiesGraph (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 156)), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 156)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_usefulnessName_6652, var_usefulnessName_6652, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 157)) ;
  }
  ioArgument_ioUsefulnessRootEntities.addAssign_operation (var_usefulnessName_6652  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 158)) ;
  ...
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration_6898 = temp_0 ;
  cEnumerator_prologueEpilogueList enumerator_6965 (constinArgument_inEpilogueList, EnumerationOrder::up) ;
  while (enumerator_6965.hasCurrentObject ()) {
    GALGAS_semanticInstructionListForGeneration var_blockSemanticInstructionListForGeneration_7516 ;
    {
    ...
    GALGAS_formalParameterListForGeneration joker_7564 ; // Joker input parameter
    routine_analyzeRoutineBody_3F__26__3F__26__3F__3F_nonMutablePropertyList_3F_mutablePropertyList_3F__3F__21__21_ (var_usefulnessName_6652, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, temp_1, temp_2, temp_3, enumerator_6965.current_mInstructionList (HERE), enumerator_6965.current_mEndOfInstructionList (HERE), var_blockSemanticInstructionListForGeneration_7516, joker_7564, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 162)) ;
    }
    var_semanticInstructionListForGeneration_6898.addAssign_operation (GALGAS_semanticBlockInstructionForGeneration::init_21_ (var_blockSemanticInstructionListForGeneration_7516, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 176)) ;
  ...
  ioArgument_ioDecoratedDeclarationListForGeneration.addAssign_operation (GALGAS_routineImplementationForGeneration::init_21_generateHeader_21_implementationCppFileName_21_routineMangledName_21__21__21_ (GALGAS_bool (false), GALGAS_string ("proc-after"), GALGAS_string ("after"), temp_4, GALGAS_bool (true), var_semanticInstructionListForGeneration_6898, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 179)) ;
}
...
void routine_compileProgramComponentGalgas_33__26__26__3F__3F__3F__3F__26__3F__21_ (GALGAS_lstringlist & ioArgument_ioUsefulnessRootEntities,
  ...
  GALGAS_programListForGeneration var_decoratedDeclarationListForGeneration_9153 = temp_0 ;
  {
  routine_compileBeforeClauseGalgas_33__26__26__3F__26__3F__26_ (ioArgument_ioUsefulnessRootEntities, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_8794, ioArgument_ioTypeMap, constinArgument_inPrologueList, var_decoratedDeclarationListForGeneration_9153, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 217)) ;
  }
  {
  routine_compileAfterClauseGalgas_33__26__26__3F__26__3F__26_ (ioArgument_ioUsefulnessRootEntities, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_8794, ioArgument_ioTypeMap, constinArgument_inEpilogueList, var_decoratedDeclarationListForGeneration_9153, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 226)) ;
  }
  {
  routine_compileProgramRulesGalgas_33__26__26__3F__26__3F__26_ (ioArgument_ioUsefulnessRootEntities, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_8794, ioArgument_ioTypeMap, constinArgument_inProgramRules, var_decoratedDeclarationListForGeneration_9153, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 235)) ;
  }
  GALGAS_stringset temp_1 = GALGAS_stringset::init (inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 244)) ;
  GALGAS_stringset var_inclusionSet_9900 = temp_1 ;
  GALGAS_string var_beforeAfterRulesString_9925 = GALGAS_string::makeEmptyString () ;
  cEnumerator_programListForGeneration enumerator_9960 (var_decoratedDeclarationListForGeneration_9153, EnumerationOrder::up) ;
  while (enumerator_9960.hasCurrentObject ()) {
    var_beforeAfterRulesString_9925.plusAssign_operation(callExtensionGetter_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_9960.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 247)), inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 247)) ;
    GALGAS_string var_code_10181 ;
    callExtensionMethod_appendSpecificImplementation ((cPtr_semanticDeclarationForGeneration *) enumerator_9960.current_mDeclaration (HERE).ptr (), ioArgument_ioTypeMap, var_inclusionSet_9900, var_code_10181, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 248)) ;
    var_beforeAfterRulesString_9925.plusAssign_operation(var_code_10181, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 249)) ;
    enumerator_9960.gotoNextObject () ;
  }
  cEnumerator_programRuleList enumerator_10263 (constinArgument_inProgramRules, EnumerationOrder::up) ;
  while (enumerator_10263.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (ComparisonKind::notEqual, enumerator_10263.current_mReferenceGrammar (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_inclusionSet_9900.addAssign_operation (GALGAS_string ("grammar-").add_operation (enumerator_10263.current_mReferenceGrammar (HERE).readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("programComponentCompilation.galgas", 253)), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 253))  COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 253)) ;
      }
    }
  ...
  GALGAS_string var_cppContents_10429 = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (inCompiler, GALGAS_string ("program"), temp_3, var_beforeAfterRulesString_9925, constinArgument_inProgramRules, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("programComponentCompilation.galgas", 256))) ;
  outArgument_outProgramComponentForGeneration = GALGAS_programComponentForGeneration::init_21_generateHeader_21_implementationCppFileName_21__21_ (GALGAS_bool (false), GALGAS_string ("program"), var_inclusionSet_9900, var_cppContents_10429, inCompiler COMMA_HERE) ;
}
...
void routine_parseAndAnalyzeProject_3F__3F_galgas_34__3F_ (const GALGAS_lstring constinArgument_inProjectSourceFile,
  ...
  GALGAS_galgas_33_ProjectComponentAST var_projectComponentAST_6700 ;
  var_projectComponentAST_6700.drop () ;
  cGrammar_galgas_33_ProjectGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inProjectSourceFile, var_projectComponentAST_6700  COMMA_SOURCE_FILE ("galgasProgram.galgas", 166)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      {
      routine_compileProject_3F__3F__3F_galgas_34__3F_ (constinArgument_inProjectSourceFile, constinArgument_inSourceToAnalyze, constinArgument_inGalgas_34_, var_projectComponentAST_6700, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 168)) ;
      }
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_string var_cppCompilationTarget_6949 = GALGAS_string (gOption_galgas_5F_cli_5F_options_cppCompile.readProperty_value ()) ;
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = GALGAS_bool (ComparisonKind::notEqual, var_cppCompilationTarget_6949.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_3) {
              enumGalgasBool test_4 = kBoolTrue ;
              if (kBoolTrue == test_4) {
              ...
              GALGAS_string var_buildFile_7176 = constinArgument_inProjectSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 176)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 176)).add_operation (var_cppCompilationTarget_6949, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 176)).add_operation (GALGAS_string ("/build.py"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 176)) ;
              enumGalgasBool test_5 = kBoolTrue ;
              if (kBoolTrue == test_5) {
                test_5 = var_buildFile_7176.getter_fileExists (SOURCE_FILE ("galgasProgram.galgas", 177)).boolEnum () ;
                if (kBoolTrue == test_5) {
                  GALGAS_sint var_resultCode_7340 = GALGAS_string ("python ").add_operation (var_buildFile_7176, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 178)).getter_system (SOURCE_FILE ("galgasProgram.galgas", 178)) ;
                  enumGalgasBool test_6 = kBoolTrue ;
                  if (kBoolTrue == test_6) {
                    test_6 = GALGAS_bool (ComparisonKind::notEqual, var_resultCode_7340.objectCompare (GALGAS_sint (int32_t (0L)))).boolEnum () ;
                    if (kBoolTrue == test_6) {
                      TC_Array <FixItDescription> fixItArray7 ;
                      inCompiler->emitSemanticError (GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasProgram.galgas", 180)).readProperty_location (), GALGAS_string ("Running '").add_operation (var_buildFile_7176, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 180)).add_operation (GALGAS_string ("' returns "), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 180)).add_operation (var_resultCode_7340.getter_string (SOURCE_FILE ("galgasProgram.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 180)), fixItArray7  COMMA_SOURCE_FILE ("galgasProgram.galgas", 180)) ;
                    }
                  }
                }
              }
              if (kBoolFalse == test_5) {
                TC_Array <FixItDescription> fixItArray8 ;
                inCompiler->emitSemanticError (GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasProgram.galgas", 183)).readProperty_location (), GALGAS_string ("Cannot perform C++ compilation of '").add_operation (var_cppCompilationTarget_6949, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 183)).add_operation (GALGAS_string ("' : the '"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 183)).add_operation (var_buildFile_7176, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 184)).add_operation (GALGAS_string ("' file does not exist"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 184)), fixItArray8  COMMA_SOURCE_FILE ("galgasProgram.galgas", 183)) ;
              }
            }
          }
        }
...
void routine_compileProject_3F__3F__3F_galgas_34__3F_ (const GALGAS_lstring constinArgument_inProjectSourceFile,
                                                       ...
                                                       Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_galgasDeclarationAST var_declarationAST_8117 = GALGAS_galgasDeclarationAST::init (inCompiler COMMA_HERE) ;
  cGrammar_galgas_34_Grammar::_performSourceStringParsing_ (inCompiler, GALGAS_filewrapper (gWrapperDirectory_0_typeGenerationTemplate).getter_textFileContentsAtPath (GALGAS_string ("galgas-predefined-types.ggs"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 201)), GALGAS_string ("GALGAS predefined types"), var_declarationAST_8117  COMMA_SOURCE_FILE ("galgasProgram.galgas", 200)) ;
  cEnumerator_lstringlist enumerator_8434 (constinArgument_inProjectComponentAST.readProperty_mProjectSourceList (), EnumerationOrder::up) ;
  while (enumerator_8434.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::equal, enumerator_8434.current_mValue (HERE).readProperty_string ().getter_pathExtension (SOURCE_FILE ("galgasProgram.galgas", 205)).objectCompare (GALGAS_string ("galgas"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_absoluteSourcePath_8546 = enumerator_8434.current_mValue (HERE).readProperty_string ().getter_absolutePathFromPath (constinArgument_inProjectSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 206)) COMMA_SOURCE_FILE ("galgasProgram.galgas", 206)) ;
        cGrammar_galgas_33_Grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::init_21__21_ (var_absoluteSourcePath_8546, enumerator_8434.current_mValue (HERE).readProperty_location (), inCompiler COMMA_HERE), var_declarationAST_8117  COMMA_SOURCE_FILE ("galgasProgram.galgas", 207)) ;
      }
    }
    if (kBoolFalse == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (ComparisonKind::equal, enumerator_8434.current_mValue (HERE).readProperty_string ().getter_pathExtension (SOURCE_FILE ("galgasProgram.galgas", 208)).objectCompare (GALGAS_string ("ggs"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_string var_absoluteSourcePath_8810 = enumerator_8434.current_mValue (HERE).readProperty_string ().getter_absolutePathFromPath (constinArgument_inProjectSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 209)) COMMA_SOURCE_FILE ("galgasProgram.galgas", 209)) ;
          cGrammar_galgas_34_Grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::init_21__21_ (var_absoluteSourcePath_8810, enumerator_8434.current_mValue (HERE).readProperty_location (), inCompiler COMMA_HERE), var_declarationAST_8117  COMMA_SOURCE_FILE ("galgasProgram.galgas", 210)) ;
        }
      }
      if (kBoolFalse == test_1) {
        TC_Array <FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_8434.current_mValue (HERE).readProperty_location (), GALGAS_string ("only \".galgas\" or \".ggs\" extensions are allowed here"), fixItArray2  COMMA_SOURCE_FILE ("galgasProgram.galgas", 212)) ;
      }
    }
  ...
  GALGAS_stringlist var_handCodedLinkToolFileList_10034 = temp_3 ;
  GALGAS_stringlist temp_4 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 236)) ;
  GALGAS_stringlist var_handCodedLinkAppFileList_10084 = temp_4 ;
  GALGAS_stringlist temp_5 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 237)) ;
  GALGAS_stringlist var_handCodedSourceAppFileList_10133 = temp_5 ;
  GALGAS_stringlist temp_6 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 238)) ;
  GALGAS_stringlist var_handCodedSourceToolFileList_10184 = temp_6 ;
  GALGAS_stringlist temp_7 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 239)) ;
  GALGAS_stringlist var_frameworkToolFileList_10236 = temp_7 ;
  GALGAS_stringset temp_8 = GALGAS_stringset::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 240)) ;
  GALGAS_stringset var_handCodedSourceDirectorySet_10281 = temp_8 ;
  cEnumerator_galgas_33_QualifiedFeatureList enumerator_10334 (constinArgument_inProjectComponentAST.readProperty_mQualifiedFeatureList (), EnumerationOrder::up) ;
  while (enumerator_10334.hasCurrentObject ()) {
    enumGalgasBool test_9 = kBoolTrue ;
    if (kBoolTrue == test_9) {
      test_9 = GALGAS_bool (ComparisonKind::equal, GALGAS_string ("tool-source").objectCompare (enumerator_10334.current_mFeatureName (HERE).readProperty_string ())).boolEnum () ;
      if (kBoolTrue == test_9) {
        var_handCodedSourceToolFileList_10184.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 243)) ;
        GALGAS_string var_directory_10507 = enumerator_10334.current_mFeatureValue (HERE).readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 244)) ;
        enumGalgasBool test_10 = kBoolTrue ;
        if (kBoolTrue == test_10) {
          test_10 = GALGAS_bool (ComparisonKind::equal, var_directory_10507.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_10) {
            var_handCodedSourceDirectorySet_10281.addAssign_operation (GALGAS_string ("../")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 246)) ;
          }
        }
        if (kBoolFalse == test_10) {
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = GALGAS_bool (ComparisonKind::notEqual, var_directory_10507.getter_characterAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 247)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
            if (kBoolTrue == test_11) {
              var_handCodedSourceDirectorySet_10281.addAssign_operation (GALGAS_string ("../").add_operation (var_directory_10507, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 248))  COMMA_SOURCE_FILE ("galgasProgram.galgas", 248)) ;
            }
          }
          if (kBoolFalse == test_11) {
            var_handCodedSourceDirectorySet_10281.addAssign_operation (var_directory_10507  COMMA_SOURCE_FILE ("galgasProgram.galgas", 250)) ;
          }
        }
      }
    }
    if (kBoolFalse == test_9) {
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("tool-include"))).boolEnum () ;
        if (kBoolTrue == test_12) {
          var_handCodedSourceDirectorySet_10281.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 253)) ;
        }
      }
      if (kBoolFalse == test_12) {
        enumGalgasBool test_13 = kBoolTrue ;
        if (kBoolTrue == test_13) {
          test_13 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("tool-framework"))).boolEnum () ;
          if (kBoolTrue == test_13) {
            var_frameworkToolFileList_10236.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 255))  COMMA_SOURCE_FILE ("galgasProgram.galgas", 255)) ;
          }
        }
        if (kBoolFalse == test_13) {
          enumGalgasBool test_14 = kBoolTrue ;
          if (kBoolTrue == test_14) {
            test_14 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("app-source"))).boolEnum () ;
            if (kBoolTrue == test_14) {
              var_handCodedSourceAppFileList_10133.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 257)) ;
              GALGAS_string var_directory_11168 = enumerator_10334.current_mFeatureValue (HERE).readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 258)) ;
              enumGalgasBool test_15 = kBoolTrue ;
              if (kBoolTrue == test_15) {
                test_15 = GALGAS_bool (ComparisonKind::equal, var_directory_11168.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_15) {
                  var_handCodedSourceDirectorySet_10281.addAssign_operation (GALGAS_string ("../")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 260)) ;
                }
              }
              if (kBoolFalse == test_15) {
                enumGalgasBool test_16 = kBoolTrue ;
                if (kBoolTrue == test_16) {
                  test_16 = GALGAS_bool (ComparisonKind::notEqual, var_directory_11168.getter_characterAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 261)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
                  if (kBoolTrue == test_16) {
                    var_handCodedSourceDirectorySet_10281.addAssign_operation (GALGAS_string ("../").add_operation (var_directory_11168, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 262))  COMMA_SOURCE_FILE ("galgasProgram.galgas", 262)) ;
                  }
                }
                if (kBoolFalse == test_16) {
                  var_handCodedSourceDirectorySet_10281.addAssign_operation (var_directory_11168  COMMA_SOURCE_FILE ("galgasProgram.galgas", 264)) ;
                }
              }
            }
          }
          if (kBoolFalse == test_14) {
            enumGalgasBool test_17 = kBoolTrue ;
            if (kBoolTrue == test_17) {
              test_17 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("tool-link"))).boolEnum () ;
              if (kBoolTrue == test_17) {
                var_handCodedLinkToolFileList_10034.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 267)) ;
              }
            }
            if (kBoolFalse == test_17) {
              enumGalgasBool test_18 = kBoolTrue ;
              if (kBoolTrue == test_18) {
                test_18 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("app-link"))).boolEnum () ;
                if (kBoolTrue == test_18) {
                  var_handCodedLinkAppFileList_10084.addAssign_operation (enumerator_10334.current_mFeatureValue (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 269)) ;
                }
              }
              if (kBoolFalse == test_18) {
                enumGalgasBool test_19 = kBoolTrue ;
                if (kBoolTrue == test_19) {
                  test_19 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("libpmAtPath"))).boolEnum () ;
                  if (kBoolTrue == test_19) {
                  }
                }
                if (kBoolFalse == test_19) {
                  enumGalgasBool test_20 = kBoolTrue ;
                  if (kBoolTrue == test_20) {
                    test_20 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("applicationBundleBase"))).boolEnum () ;
                    if (kBoolTrue == test_20) {
                    }
                  }
                  if (kBoolFalse == test_20) {
                    enumGalgasBool test_21 = kBoolTrue ;
                    if (kBoolTrue == test_21) {
                      test_21 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("macCodeSign"))).boolEnum () ;
                      if (kBoolTrue == test_21) {
                      }
                    }
                    if (kBoolFalse == test_21) {
                      enumGalgasBool test_22 = kBoolTrue ;
                      if (kBoolTrue == test_22) {
                        test_22 = GALGAS_bool (ComparisonKind::equal, enumerator_10334.current_mFeatureName (HERE).readProperty_string ().objectCompare (GALGAS_string ("MacOSDeployment"))).boolEnum () ;
                        if (kBoolTrue == test_22) {
                        }
                      }
                      if (kBoolFalse == test_22) {
                        TC_Array <FixItDescription> fixItArray23 ;
                        inCompiler->emitSemanticError (enumerator_10334.current_mFeatureName (HERE).readProperty_location (), GALGAS_string ("unknown feature"), fixItArray23  COMMA_SOURCE_FILE ("galgasProgram.galgas", 275)) ;
                      }
                    }
                  }
                }
  ...
  {
  routine_groupSyntaxComponentsGalgas_33__3F__3F__26_ (var_declarationAST_8117.readProperty_mSyntaxComponentList (), var_declarationAST_8117.readProperty_mSyntaxExtensions (), var_declarationAST_8117.mProperty_mDeclarationList, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 288)) ;
  }
  GALGAS_usefulEntitiesGraph var_usefulEntitiesGraph_12902 = GALGAS_usefulEntitiesGraph::init (inCompiler COMMA_HERE) ;
  GALGAS_string var_buildDirectoryName_12962 ;
  enumGalgasBool test_24 = kBoolTrue ;
  if (kBoolTrue == test_24) {
    test_24 = constinArgument_inGalgas_34_.boolEnum () ;
    if (kBoolTrue == test_24) {
      var_buildDirectoryName_12962 = constinArgument_inProjectSourceFile.readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 297)).getter_stringByReplacingStringByString (GALGAS_string ("."), GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 297)).add_operation (GALGAS_string ("-build"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 297)) ;
    }
  }
  if (kBoolFalse == test_24) {
    var_buildDirectoryName_12962 = GALGAS_string ("build") ;
  }
  GALGAS_string var_absoluteBuildDirectory_13173 = constinArgument_inProjectSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 301)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 301)).add_operation (var_buildDirectoryName_12962, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 301)) ;
  GALGAS_string var_productDirectory_13287 = var_absoluteBuildDirectory_13173.add_operation (GALGAS_string ("/output"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 302)) ;
  GALGAS_stringlist temp_25 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 303)) ;
  GALGAS_stringlist var_appProductFileList_13359 = temp_25 ;
  GALGAS_semanticContext var_semanticContext_13407 ;
  GALGAS_unifiedTypeMap var_typeMap_13445 ;
  GALGAS_semanticDeclarationListForGeneration var_semanticDeclarationSortedListForGeneration_13497 ;
  GALGAS_lstringlist temp_26 = GALGAS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 307)) ;
  GALGAS_lstringlist var_usefulnessRootEntities_13559 = temp_26 ;
  enumGalgasBool test_27 = kBoolTrue ;
  if (kBoolTrue == test_27) {
    ...
    if (kBoolTrue == test_27) {
      {
      routine_compileSemanticDeclarationsGalgas_26__26__3F_galgas_34__3F__3F__3F__21__21__21_ (var_usefulnessRootEntities_13559, var_usefulEntitiesGraph_12902, constinArgument_inGalgas_34_, var_productDirectory_13287, constinArgument_inProjectComponentAST.readProperty_mEndOfSourceFile (), var_declarationAST_8117.readProperty_mDeclarationList (), var_semanticContext_13407, var_typeMap_13445, var_semanticDeclarationSortedListForGeneration_13497, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 309)) ;
      }
    }
  }
  if (kBoolFalse == test_27) {
    ...
    var_semanticDeclarationSortedListForGeneration_13497 = temp_28 ;
    var_semanticContext_13407 = GALGAS_semanticContext::init_21_galgas_34_ (constinArgument_inGalgas_34_, inCompiler COMMA_HERE) ;
    GALGAS_unifiedTypeMap temp_29 = GALGAS_unifiedTypeMap::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 323)) ;
    var_typeMap_13445 = temp_29 ;
  }
  GALGAS_optionComponentMapForGeneration var_optionComponentMapForGeneration_14191 ;
  ...
  if (kBoolTrue == test_30) {
    ...
    if (kBoolTrue == test_30) {
      {
      routine_compileAllGuiComponentFromASTGalgas_33__3F__3F__21_ (var_declarationAST_8117.readProperty_mGUIComponentList (), var_semanticContext_13407, var_optionComponentMapForGeneration_14191, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 328)) ;
      }
    }
  }
  if (kBoolFalse == test_30) {
    ...
    var_optionComponentMapForGeneration_14191 = temp_31 ;
  }
  enumGalgasBool test_32 = kBoolTrue ;
  if (kBoolTrue == test_32) {
    ...
    if (kBoolTrue == test_32) {
      GALGAS_string var_projectVersionString_14566 = constinArgument_inProjectComponentAST.readProperty_mMajorVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas", 338)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 338)).add_operation (constinArgument_inProjectComponentAST.readProperty_mMinorVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas", 339)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 339)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 339)).add_operation (constinArgument_inProjectComponentAST.readProperty_mRevisionVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 340)) ;
      GALGAS_programComponentForGeneration var_programComponentForGeneration_15095 ;
      {
      routine_compileProgramComponentGalgas_33__26__26__3F__3F__3F__3F__26__3F__21_ (var_usefulnessRootEntities_13559, var_usefulEntitiesGraph_12902, var_declarationAST_8117.readProperty_mPrologueDeclarationList (), var_declarationAST_8117.readProperty_mSourceRuleList (), var_declarationAST_8117.readProperty_mEpilogueDeclarationList (), var_semanticContext_13407, var_typeMap_13445, var_projectVersionString_14566, var_programComponentForGeneration_15095, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 341)) ;
      }
      var_semanticDeclarationSortedListForGeneration_13497.addAssign_operation (GALGAS_string ("zprogram"), var_programComponentForGeneration_15095  COMMA_SOURCE_FILE ("galgasProgram.galgas", 352)) ;
    }
  }
  {
  routine_checkUsefulEntities_3F__3F__3F_ (var_usefulEntitiesGraph_12902, var_usefulnessRootEntities_13559, var_productDirectory_13287, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 355)) ;
  }
  GALGAS_string var_typeDumpFilePath_15488 = var_productDirectory_13287.add_operation (GALGAS_string ("/../helpers/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 357)).add_operation (constinArgument_inProjectSourceFile.readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 357)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 357)).add_operation (GALGAS_string (".html"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 357)) ;
  enumGalgasBool test_33 = kBoolTrue ;
  if (kBoolTrue == test_33) {
    ...
    if (kBoolTrue == test_33) {
      ...
      GALGAS_stringset var_firstLetterSet_15679 = temp_34 ;
      cEnumerator_unifiedTypeMap enumerator_15714 (var_typeMap_13445, EnumerationOrder::up) ;
      while (enumerator_15714.hasCurrentObject ()) {
        var_firstLetterSet_15679.addAssign_operation (enumerator_15714.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 361)).getter_string (SOURCE_FILE ("galgasProgram.galgas", 361))  COMMA_SOURCE_FILE ("galgasProgram.galgas", 361)) ;
        enumerator_15714.gotoNextObject () ;
      }
      GALGAS_string var_tableOfTypeString_15822 = GALGAS_string::makeEmptyString () ;
      GALGAS_char var_currentFirstLetter_15859 = GALGAS_char (TO_UNICODE (32)) ;
      cEnumerator_unifiedTypeMap enumerator_15903 (var_typeMap_13445, EnumerationOrder::up) ;
      while (enumerator_15903.hasCurrentObject ()) {
        enumGalgasBool test_35 = kBoolTrue ;
        if (kBoolTrue == test_35) {
          test_35 = GALGAS_bool (ComparisonKind::notEqual, var_currentFirstLetter_15859.objectCompare (enumerator_15903.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 366)))).boolEnum () ;
          if (kBoolTrue == test_35) {
            var_currentFirstLetter_15859 = enumerator_15903.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GALGAS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 367)) ;
            var_tableOfTypeString_15822.plusAssign_operation(GALGAS_string ("<br><a name=\"").add_operation (var_currentFirstLetter_15859.getter_uint (SOURCE_FILE ("galgasProgram.galgas", 368)).getter_string (SOURCE_FILE ("galgasProgram.galgas", 368)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 368)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 368)) ;
            var_tableOfTypeString_15822.plusAssign_operation(GALGAS_string ("\"><b>").add_operation (var_currentFirstLetter_15859.getter_string (SOURCE_FILE ("galgasProgram.galgas", 369)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 369)).add_operation (GALGAS_string ("</b></a><br>"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 369)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 369)) ;
          }
        }
        var_tableOfTypeString_15822.plusAssign_operation(function_linkForType (enumerator_15903.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 371)).add_operation (GALGAS_string ("<br>"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 371)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 371)) ;
        enumerator_15903.gotoNextObject () ;
      }
      GALGAS_string var_typeDumpString_16307 = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFile.readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas", 374)), var_typeMap_13445, var_firstLetterSet_15679, var_tableOfTypeString_15822 COMMA_SOURCE_FILE ("galgasProgram.galgas", 373))) ;
      GALGAS_bool joker_16559 ; // Joker input parameter
      var_typeDumpString_16307.method_writeToFileWhenDifferentContents (var_typeDumpFilePath_15488, joker_16559, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 379)) ;
    }
  }
  if (kBoolFalse == test_33) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath_15488, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 381)) ;
    }
  }
  enumGalgasBool test_36 = kBoolTrue ;
  if (kBoolTrue == test_36) {
    ...
    if (kBoolTrue == test_36) {
      {
      routine_performGalgas_33_ProjectGlobalCheckings_26__3F_ (var_typeMap_13445, var_declarationAST_8117.readProperty_mDeclarationList (), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 385)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_37) {
    ...
    if (kBoolTrue == test_37) {
      {
      routine_projectGeneration_3F__3F_absoluteBuildDir_3F_buildDirName_3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F_ (var_typeMap_13445, var_absoluteBuildDirectory_13173, var_buildDirectoryName_12962, var_optionComponentMapForGeneration_14191, var_appProductFileList_13359, var_semanticDeclarationSortedListForGeneration_13497, var_declarationAST_8117.readProperty_mSourceRuleList (), constinArgument_inProjectComponentAST, constinArgument_inProjectSourceFile.readProperty_string (), var_handCodedSourceDirectorySet_10281, var_handCodedSourceToolFileList_10184, var_frameworkToolFileList_10236, var_handCodedSourceAppFileList_10133, var_handCodedLinkAppFileList_10084, var_handCodedLinkToolFileList_10034, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 392)) ;
      }
    }
  }
}
...
void routine_projectGeneration_3F__3F_absoluteBuildDir_3F_buildDirName_3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F__3F_ (const GALGAS_unifiedTypeMap constinArgument_inTypeMap,
                                                                                                                        ...
                                                                                                                        Compiler * inCompiler
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist var_appProductFileList_18560 = constinArgument_inAppProductFileList ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_stringset var_allProductFileSet_18752 = temp_1 ;
  GALGAS_string var_userHeadersDir_18862 = constinArgument_inAbsoluteBuildDirectory.add_operation (GALGAS_string ("/user-headers"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 442)) ;
  var_userHeadersDir_18862.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 443)) ;
  GALGAS_bool var_quietOutputByDefault_19019 = GALGAS_stringset::class_func_setWithLStringList (constinArgument_inProjectComponentAST.readProperty_mGenerationFeatureList ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 445)).getter_hasKey (GALGAS_string ("quietOutputByDefault") COMMA_SOURCE_FILE ("galgasProgram.galgas", 445)) ;
  GALGAS_string var_productDirectory_19219 = constinArgument_inAbsoluteBuildDirectory.add_operation (GALGAS_string ("/output"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 447)) ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      {
      routine_generateAllGuiComponentsGalgas_33__3F__3F__3F__26__26_ (constinArgument_inOptionComponentMapForGeneration, var_productDirectory_19219, var_quietOutputByDefault_19019, var_appProductFileList_18560, var_allProductFileSet_18752, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 452)) ;
      }
    }
  }
  GALGAS_stringlist temp_3 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 462)) ;
  GALGAS_stringlist var_toolCppFileList_19744 = temp_3 ;
  GALGAS_stringlist temp_4 = GALGAS_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 463)) ;
  GALGAS_stringlist var_toolHeaderFileList_19784 = temp_4 ;
  {
  routine_generatePredefinedTypeFiles_3F__3F__26__26__26_ (var_productDirectory_19219, constinArgument_inSemanticDeclarationSortedListForGeneration, var_toolHeaderFileList_19784, var_toolCppFileList_19744, var_allProductFileSet_18752, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 464)) ;
  }
  {
  routine_generateSemanticDeclarationsGalgas_33__3F__3F__3F__26__26__26__26_ (constinArgument_inTypeMap, var_productDirectory_19219, constinArgument_inSemanticDeclarationSortedListForGeneration, var_appProductFileList_18560, var_toolCppFileList_19744, var_toolHeaderFileList_19784, var_allProductFileSet_18752, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas", 471)) ;
  }
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    ...
    if (kBoolTrue == test_5) {
      ...
      GALGAS_stringset var_handledExtensionSet_20353 = temp_6 ;
      cEnumerator_programRuleList enumerator_20419 (constinArgument_inSourceRuleList, EnumerationOrder::up) ;
      while (enumerator_20419.hasCurrentObject ()) {
        var_handledExtensionSet_20353.addAssign_operation (enumerator_20419.current_mSourceFileExtension (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas", 485)) ;
        enumerator_20419.gotoNextObject () ;
      }
      GALGAS_stringset temp_7 = GALGAS_stringset::init (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 488)) ;
      GALGAS_stringset var_ignoredFeatureSet_20565 = temp_7 ;
      var_ignoredFeatureSet_20565.addAssign_operation (GALGAS_string ("tool-framework")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 489)) ;
      var_ignoredFeatureSet_20565.addAssign_operation (GALGAS_string ("tool-source")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 490)) ;
      var_ignoredFeatureSet_20565.addAssign_operation (GALGAS_string ("tool-link")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 491)) ;
      var_ignoredFeatureSet_20565.addAssign_operation (GALGAS_string ("app-source")  COMMA_SOURCE_FILE ("galgasProgram.galgas", 492)) ;
      ...
      GALGAS_projectQualifiedFeatureMap var_projectQualifiedFeatureMap_20785 = temp_8 ;
      cEnumerator_galgas_33_QualifiedFeatureList enumerator_20840 (constinArgument_inProjectComponentAST.readProperty_mQualifiedFeatureList (), EnumerationOrder::up) ;
      while (enumerator_20840.hasCurrentObject ()) {
        enumGalgasBool test_9 = kBoolTrue ;
        if (kBoolTrue == test_9) {
          test_9 = var_ignoredFeatureSet_20565.getter_hasKey (enumerator_20840.current_mFeatureName (HERE).readProperty_string () COMMA_SOURCE_FILE ("galgasProgram.galgas", 495)).operator_not (SOURCE_FILE ("galgasProgram.galgas", 495)).boolEnum () ;
          if (kBoolTrue == test_9) {
            {
            var_projectQualifiedFeatureMap_20785.setter_insertKey (enumerator_20840.current_mFeatureName (HERE), enumerator_20840.current_mFeatureValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 496)) ;
            }
          }
        }
  ...
  if (kBoolTrue == test_10) {
    ...
    if (kBoolTrue == test_10) {
      ...
      GALGAS_stringset var_allActualFileSet_22071 = temp_11 ;
      cEnumerator_stringlist enumerator_22103 (var_productDirectory_19219.getter_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE ("galgasProgram.galgas", 528)), EnumerationOrder::up) ;
      while (enumerator_22103.hasCurrentObject ()) {
        var_allActualFileSet_22071.addAssign_operation (enumerator_22103.current_mValue (HERE)  COMMA_SOURCE_FILE ("galgasProgram.galgas", 529)) ;
        enumerator_22103.gotoNextObject () ;
      }
      GALGAS_stringset var_uselessFileSet_22206 = var_allActualFileSet_22071.substract_operation (var_allProductFileSet_18752, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 531)) ;
      cEnumerator_stringset enumerator_22269 (var_uselessFileSet_22206, EnumerationOrder::up) ;
      while (enumerator_22269.hasCurrentObject ()) {
        {
        GALGAS_string::class_method_deleteFile (var_productDirectory_19219.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 533)).add_operation (enumerator_22269.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 533)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas", 533)) ;
        }
        enumerator_22269.gotoNextObject () ;
      }
    }
  }
}
