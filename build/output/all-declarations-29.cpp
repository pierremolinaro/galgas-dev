...
void routine_updateGalgasTargets (const GALGAS_string constinArgument_inAbsoluteBuildDirectory,
  ...
  if (kBoolTrue == test_30) {
    ...
    if (kBoolTrue == test_30) {
      ...
      temp_54.addAssign_operation (GALGAS_string ("C_String.cpp")  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1083)) ;
      temp_54.addAssign_operation (GALGAS_string ("C_String.h")  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1084)) ;
    ...
    //--- Display error and warnings count
      if (verboseOptionOn || (totalWarningCount () > 0) || (totalErrorCount () > 0)) {
        ...
        if (totalWarningCount () == 0) {
          ...
          message += cStringWithSigned (totalWarningCount ()) ;
          message += " warnings" ;
        }
        message += ", " ;
        if (totalErrorCount () == 0) {
          ...
          message += cStringWithSigned (totalErrorCount ()) ;
          message += " errors" ;
        }
        message += ".\n" ;
