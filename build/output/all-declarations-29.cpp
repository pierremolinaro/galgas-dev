  ...
  if (kBoolTrue == test_59) {
    ...
    if (kBoolTrue == test_59) {
      ...
      if (kBoolTrue == test_94) {
        ...
        if (kBoolTrue == test_94) {
          GALGAS_stringlist var_components_56668 = var_macCodeSign_16767.readProperty_string ().getter_componentsSeparatedByString (GALGAS_string (":") COMMA_SOURCE_FILE ("galgas3TargetGeneration.galgas", 1425)) ;
          ...
          if (kBoolTrue == test_95) {
            ...
            if (kBoolTrue == test_95) {
              ...
              inCompiler->emitSemanticError (var_macCodeSign_16767.readProperty_location (), GALGAS_string ("the %macCodeSign attribute associated string should be \"key:value\""), fixItArray96  COMMA_SOURCE_FILE ("galgas3TargetGeneration.galgas", 1427)) ;
            }
          }
          if (kBoolFalse == test_95) {
            ...
            if (kBoolFalse == test_97) {
              ...
              if (kBoolFalse == test_98) {
                ...
                inCompiler->emitSemanticError (var_macCodeSign_16767.readProperty_location (), GALGAS_string ("the %macCodeSign attribute string is \"key:value\", but key should be 'MacDeveloper' or 'Certificate'"), fixItArray99  COMMA_SOURCE_FILE ("galgas3TargetGeneration.galgas", 1434)) ;
              }
            }
          }
        }
