...
class CollectionElement_importedLexiqueList : public CollectionElement {
  public: GGS_importedLexiqueList_2E_element mObject ;

//--- Class functions
  public: CollectionElement_importedLexiqueList (const GGS_string & in_mLexiqueClassName,
                                                 ...
                                                 COMMA_LOCATION_ARGS) ;
  public: CollectionElement_importedLexiqueList (const GGS_importedLexiqueList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_importedLexiqueList::CollectionElement_importedLexiqueList (const GGS_string & in_mLexiqueClassName,
                                                                              const GGS_uint & in_mIndex,
                                                                              const GGS_string & in_mBlockComment,
                                                                              const GGS_string & in_mTitle,
                                                                              const GGS_textMacroList & in_mTextMacroList,
...
CollectionElement_importedLexiqueList::CollectionElement_importedLexiqueList (const GGS_importedLexiqueList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_importedLexiqueList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_importedLexiqueList::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_importedLexiqueList (mObject.mProperty_mLexiqueClassName, mObject.mProperty_mIndex, mObject.mProperty_mBlockComment, mObject.mProperty_mTitle, mObject.mProperty_mTextMacroList, mObject.mProperty_mLabels, mObject.mProperty_mLexicalStyleList COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    ...
    CollectionElement_importedLexiqueList * p = (CollectionElement_importedLexiqueList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_importedLexiqueList) ;
...
void GGS_importedLexiqueList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                         ...
                                                         const GGS_lexicalStyleListAST & in_mLexicalStyleList
                                                         COMMA_LOCATION_ARGS) {
  CollectionElement_importedLexiqueList * p = nullptr ;
  macroMyNew (p, CollectionElement_importedLexiqueList (in_mLexiqueClassName, in_mIndex, in_mBlockComment, in_mTitle, in_mTextMacroList, in_mLabels, in_mLexicalStyleList COMMA_THERE)) ;
...
class CollectionElement_lexicalStyleListAST : public CollectionElement {
  public: GGS_lexicalStyleListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElement_lexicalStyleListAST (const GGS_lstring & in_mName,
                                                 const GGS_lstring & in_mComment
                                                 COMMA_LOCATION_ARGS) ;
  public: CollectionElement_lexicalStyleListAST (const GGS_lexicalStyleListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_lexicalStyleListAST::CollectionElement_lexicalStyleListAST (const GGS_lstring & in_mName,
                                                                              const GGS_lstring & in_mComment
                                                                              COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_lexicalStyleListAST::CollectionElement_lexicalStyleListAST (const GGS_lexicalStyleListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_lexicalStyleListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_lexicalStyleListAST::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_lexicalStyleListAST (mObject.mProperty_mName, mObject.mProperty_mComment COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_lexicalStyleListAST * p = (CollectionElement_lexicalStyleListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_lexicalStyleListAST) ;
...
void GGS_lexicalStyleListAST::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                         ...
                                                         const GGS_lstring & in_mComment
                                                         COMMA_LOCATION_ARGS) {
  CollectionElement_lexicalStyleListAST * p = nullptr ;
  macroMyNew (p, CollectionElement_lexicalStyleListAST (in_mName, in_mComment COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_projectIndexingDescriptorList : public CollectionElement {
  public: GGS_projectIndexingDescriptorList_2E_element mObject ;

//--- Class functions
  public: CollectionElement_projectIndexingDescriptorList (const GGS_lstring & in_mProjectFileExtension,
                                                           const GGS_lstring & in_indexingPathSuffix
                                                           COMMA_LOCATION_ARGS) ;
  public: CollectionElement_projectIndexingDescriptorList (const GGS_projectIndexingDescriptorList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_projectIndexingDescriptorList::CollectionElement_projectIndexingDescriptorList (const GGS_lstring & in_mProjectFileExtension,
                                                                                                  const GGS_lstring & in_indexingPathSuffix
                                                                                                  COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_projectIndexingDescriptorList::CollectionElement_projectIndexingDescriptorList (const GGS_projectIndexingDescriptorList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_projectIndexingDescriptorList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_projectIndexingDescriptorList::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_projectIndexingDescriptorList (mObject.mProperty_mProjectFileExtension, mObject.mProperty_indexingPathSuffix COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_projectIndexingDescriptorList * p = (CollectionElement_projectIndexingDescriptorList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_projectIndexingDescriptorList) ;
...
void GGS_projectIndexingDescriptorList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                   ...
                                                                   const GGS_lstring & in_indexingPathSuffix
                                                                   COMMA_LOCATION_ARGS) {
  CollectionElement_projectIndexingDescriptorList * p = nullptr ;
  macroMyNew (p, CollectionElement_projectIndexingDescriptorList (in_mProjectFileExtension, in_indexingPathSuffix COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_commandLineOptionListAST : public CollectionElement {
  public: GGS_commandLineOptionListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElement_commandLineOptionListAST (const GGS_lstring & in_mOptionTypeName,
                                                      ...
                                                      COMMA_LOCATION_ARGS) ;
  public: CollectionElement_commandLineOptionListAST (const GGS_commandLineOptionListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_commandLineOptionListAST::CollectionElement_commandLineOptionListAST (const GGS_lstring & in_mOptionTypeName,
                                                                                        const GGS_lstring & in_mOptionInternalName,
                                                                                        const GGS_lchar & in_mOptionInvocationLetter,
                                                                                        const GGS_lstring & in_mOptionInvocationString,
                                                                                        const GGS_lstring & in_mOptionComment,
...
CollectionElement_commandLineOptionListAST::CollectionElement_commandLineOptionListAST (const GGS_commandLineOptionListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_commandLineOptionListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_commandLineOptionListAST::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_commandLineOptionListAST (mObject.mProperty_mOptionTypeName, mObject.mProperty_mOptionInternalName, mObject.mProperty_mOptionInvocationLetter, mObject.mProperty_mOptionInvocationString, mObject.mProperty_mOptionComment, mObject.mProperty_mOptionDefaultValue, mObject.mProperty_mOptionDefaultValueKind COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_commandLineOptionListAST * p = (CollectionElement_commandLineOptionListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_commandLineOptionListAST) ;
...
void GGS_commandLineOptionListAST::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                              ...
                                                              const GGS_optionDefaultValueEnumAST & in_mOptionDefaultValueKind
                                                              COMMA_LOCATION_ARGS) {
  CollectionElement_commandLineOptionListAST * p = nullptr ;
  macroMyNew (p, CollectionElement_commandLineOptionListAST (in_mOptionTypeName, in_mOptionInternalName, in_mOptionInvocationLetter, in_mOptionInvocationString, in_mOptionComment, in_mOptionDefaultValue, in_mOptionDefaultValueKind COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_listOfSemanticInstructionListForGeneration : public CollectionElement {
  public: GGS_listOfSemanticInstructionListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElement_listOfSemanticInstructionListForGeneration (const GGS_semanticInstructionListForGeneration & in_mInstructionList,
                                                                        const GGS_location & in_mEndOfInstructionList
                                                                        COMMA_LOCATION_ARGS) ;
  public: CollectionElement_listOfSemanticInstructionListForGeneration (const GGS_listOfSemanticInstructionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_listOfSemanticInstructionListForGeneration::CollectionElement_listOfSemanticInstructionListForGeneration (const GGS_semanticInstructionListForGeneration & in_mInstructionList,
                                                                                                                            const GGS_location & in_mEndOfInstructionList
                                                                                                                            COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_listOfSemanticInstructionListForGeneration::CollectionElement_listOfSemanticInstructionListForGeneration (const GGS_listOfSemanticInstructionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_listOfSemanticInstructionListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_listOfSemanticInstructionListForGeneration::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_listOfSemanticInstructionListForGeneration (mObject.mProperty_mInstructionList, mObject.mProperty_mEndOfInstructionList COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_listOfSemanticInstructionListForGeneration * p = (CollectionElement_listOfSemanticInstructionListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_listOfSemanticInstructionListForGeneration) ;
...
void GGS_listOfSemanticInstructionListForGeneration::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                                ...
                                                                                const GGS_location & in_mEndOfInstructionList
                                                                                COMMA_LOCATION_ARGS) {
  CollectionElement_listOfSemanticInstructionListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElement_listOfSemanticInstructionListForGeneration (in_mInstructionList, in_mEndOfInstructionList COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElement_terminalCheckAssignementList : public CollectionElement {
  public: GGS_terminalCheckAssignementList_2E_element mObject ;

//--- Class functions
  public: CollectionElement_terminalCheckAssignementList (const GGS_string & in_mTypeName,
                                                          const GGS_string & in_mTargetVarCppName,
                                                          const GGS_string & in_mSourceLexicalAttributeName
                                                          COMMA_LOCATION_ARGS) ;
  public: CollectionElement_terminalCheckAssignementList (const GGS_terminalCheckAssignementList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElement_terminalCheckAssignementList::CollectionElement_terminalCheckAssignementList (const GGS_string & in_mTypeName,
                                                                                                const GGS_string & in_mTargetVarCppName,
                                                                                                const GGS_string & in_mSourceLexicalAttributeName
                                                                                                COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
CollectionElement_terminalCheckAssignementList::CollectionElement_terminalCheckAssignementList (const GGS_terminalCheckAssignementList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElement (THERE),
...
bool CollectionElement_terminalCheckAssignementList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElement * CollectionElement_terminalCheckAssignementList::copy (void) {
  CollectionElement * result = nullptr ;
  macroMyNew (result, CollectionElement_terminalCheckAssignementList (mObject.mProperty_mTypeName, mObject.mProperty_mTargetVarCppName, mObject.mProperty_mSourceLexicalAttributeName COMMA_HERE)) ;
  return result ;
}
...
mArray () {
  ...
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const capCollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElement_terminalCheckAssignementList * p = (CollectionElement_terminalCheckAssignementList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElement_terminalCheckAssignementList) ;
...
void GGS_terminalCheckAssignementList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                                  ...
                                                                  const GGS_string & in_mSourceLexicalAttributeName
                                                                  COMMA_LOCATION_ARGS) {
  CollectionElement_terminalCheckAssignementList * p = nullptr ;
  macroMyNew (p, CollectionElement_terminalCheckAssignementList (in_mTypeName, in_mTargetVarCppName, in_mSourceLexicalAttributeName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
AbstractPtrClass * cPtr_nonterminalInstructionForGeneration::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_5F_list_5F_ggs_33__i0_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    GGS_location var_instructionLocation_3906 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 80)) ;
    ...
    GGS_location var_endOf_5F_else_5F_branch_4125 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 84)) ;
    ...
    GGS_location var_endOf_5F_then_5F_branch_4264 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 87)) ;
    ...
    outArgument_outInstructionsList.addAssignOperation (var_instruction_4309  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 96)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_function_5F_declaration_5F_ggs_33__i2_ (const GGS_bool constinArgument_inIsOnce,
  ...
  case 2: {
    var_resultVariableName_6197 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 143)), inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_function_5F_declaration_5F_ggs_33__i3_ (const GGS_bool constinArgument_inIsOnce,
  ...
  if (GalgasBool::boolTrue == test_0) {
    test_0 = constinArgument_inIsOnce.boolEnum () ;
    if (GalgasBool::boolTrue == test_0) {
      test_0 = GGS_bool (ComparisonKind::greaterThan, var_formalInputParameterList_7700.getter_count (SOURCE_FILE ("galgasInstructionsSyntax.galgas", 183)).objectCompare (GGS_uint (uint32_t (0U)))).boolEnum () ;
      if (GalgasBool::boolTrue == test_0) {
        GenericArray <FixItDescription> fixItArray1 ;
  ...
  GGS_lstring var_resultVariableName_7956 = GGS_lstring::init_21__21_ (GGS_string ("result"), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 188)), inCompiler COMMA_HERE) ;
  ...
  GGS_location var_endOfFunctionInstructionList_8112 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 192)) ;
  GalgasBool test_2 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_2) {
    test_2 = constinArgument_inIsOnce.boolEnum () ;
    if (GalgasBool::boolTrue == test_2) {
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_declaration_5F_ggs_33__i5_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssignOperation (GGS_externFunctionDeclarationAST::init_21_isPredefined_21__21__21__21_usefullFunc (GGS_bool (false), var_mActionName_10134, var_formalInputParameterList_10236, var_resultTypeName_10328, var_isUsefull_9932, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasInstructionsSyntax.galgas", 264)) ;
}
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_issue_5F_fixit_i23_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      case 2: {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_remove COMMA_SOURCE_FILE ("instruction-error.galgas", 61)) ;
        GalgasBool test_1 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_1) {
          ...
          if (GalgasBool::boolTrue == test_1) {
            GenericArray <FixItDescription> fixItArray2 ;
            fixItArray2.appendObject (FixItDescription (EnumFixItKind::fixItRemove, "")) ;
            inCompiler->emitSemanticWarning (GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 63)), GGS_string ("duplicated action"), fixItArray2  COMMA_SOURCE_FILE ("instruction-error.galgas", 63)) ;
          }
        }
        if (GalgasBool::boolFalse == test_1) {
          outArgument_outFixitListAST.addAssignOperation (GGS_fixitElementAST::class_func_fixItRemove (SOURCE_FILE ("instruction-error.galgas", 65))  COMMA_SOURCE_FILE ("instruction-error.galgas", 65)) ;
          var_hasFixItRemove_2642 = GGS_bool (true) ;
        }
      } break ;
      case 3: {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_replace COMMA_SOURCE_FILE ("instruction-error.galgas", 69)) ;
        GGS_location var_errorLocation_2939 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 70)) ;
        ...
        outArgument_outFixitListAST.addAssignOperation (GGS_fixitElementAST::class_func_fixItReplace (var_expression_3041, var_errorLocation_2939  COMMA_SOURCE_FILE ("instruction-error.galgas", 72))  COMMA_SOURCE_FILE ("instruction-error.galgas", 72)) ;
      } break ;
      case 4: {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_insert COMMA_SOURCE_FILE ("instruction-error.galgas", 74)) ;
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_after COMMA_SOURCE_FILE ("instruction-error.galgas", 74)) ;
        GGS_location var_errorLocation_3192 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 75)) ;
        ...
        outArgument_outFixitListAST.addAssignOperation (GGS_fixitElementAST::class_func_fixItInsertAfter (var_expression_3294, var_errorLocation_3192  COMMA_SOURCE_FILE ("instruction-error.galgas", 77))  COMMA_SOURCE_FILE ("instruction-error.galgas", 77)) ;
      } break ;
      case 5: {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_insert COMMA_SOURCE_FILE ("instruction-error.galgas", 79)) ;
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_before COMMA_SOURCE_FILE ("instruction-error.galgas", 79)) ;
        GGS_location var_errorLocation_3450 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 80)) ;
        ...
        outArgument_outFixitListAST.addAssignOperation (GGS_fixitElementAST::class_func_fixItInsertBefore (var_expression_3552, var_errorLocation_3450  COMMA_SOURCE_FILE ("instruction-error.galgas", 82))  COMMA_SOURCE_FILE ("instruction-error.galgas", 82)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_5F_ggs_33__i24_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                      ...
                                                                                                                      Lexique_galgasScanner_33_ * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_error COMMA_SOURCE_FILE ("instruction-error.galgas", 91)) ;
  GGS_location var_instructionLocation_3957 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 92)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__28_ COMMA_SOURCE_FILE ("instruction-error.galgas", 93)) ;
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__3A_ COMMA_SOURCE_FILE ("instruction-error.galgas", 95)) ;
  ...
  case 2: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_spoil COMMA_SOURCE_FILE ("instruction-error.galgas", 100)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GGS_lstring var_builtVariableName_4296 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("instruction-error.galgas", 102)) ;
      var_mBuiltVariableList_4189.addAssignOperation (var_builtVariableName_4296  COMMA_SOURCE_FILE ("instruction-error.galgas", 103)) ;
      if (select_galgas_33_InstructionsSyntax_30 (inCompiler) == 2) {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2C_ COMMA_SOURCE_FILE ("instruction-error.galgas", 105)) ;
      }else{
        repeatFlag_0 = false ;
      }
    }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_for_5F_instruction_5F_element_i39_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_typeName_4713 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("instruction-for.galgas", 103)) ;
  } break ;
  case 2: {
  ...
  case 1: {
    ...
    ioArgument_ioElementList.addAssignOperation (var_typeName_4713, GGS_bool (true), GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-for.galgas", 109))  COMMA_SOURCE_FILE ("instruction-for.galgas", 109)) ;
  } break ;
  case 2: {
    ...
    ioArgument_ioElementList.addAssignOperation (var_typeName_4713, var_isUnused_4924, var_constantName_5064  COMMA_SOURCE_FILE ("instruction-for.galgas", 119)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_for_5F_instruction_5F_enumerated_5F_object_i40_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_location_5613 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 133)) ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_for_5F_instruction_5F_enumerated_5F_object_i41_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  case 1: {
    var_typeName_6187 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("instruction-for.galgas", 150)) ;
  } break ;
  case 2: {
  ...
  case 1: {
    ...
    var_enumerationVariable_6323 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-for.galgas", 157)) ;
  } break ;
  case 2: {
  ...
  outArgument_outEnumeratedObject = GGS_enumeratedCollectionVarInExpAST::init_21__21__21__21_ (var_typeName_6187, var_enumerationVariable_6323, var_enumeratedExpression_6531, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 167)), inCompiler COMMA_HERE) ;
}
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_5F_ggs_33__i42_ (GGS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GGS_location var_instructionLocation_6992 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 176)) ;
  ...
  while (repeatFlag_0) {
    ...
    var_mEnumeratedObjectList_7037.addAssignOperation (var_ascending_7130, var_enumeratedObject_7332  COMMA_SOURCE_FILE ("instruction-for.galgas", 187)) ;
  ...
  case 1: {
    var_mWhileExpression_7468 = GGS_trueExpressionAST::init_21_ (GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 193)), inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
  ...
  GGS_location var_endof_5F_while_5F_expression_7655 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 198)) ;
  ...
  GGS_location var_endof_5F_before_5F_branch_7945 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 206)) ;
  ...
  case 1: {
    var_indexVariableName_8008 = GGS_lstring::init_21__21_ (GGS_string::makeEmptyString (), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 210)), inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
  ...
  GGS_location var_endof_5F_do_5F_branch_8254 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 217)) ;
  ...
  GGS_location var_endof_5F_between_5F_branch_8541 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 225)) ;
  ...
  GGS_location var_endof_5F_after_5F_branch_8825 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 233)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_end COMMA_SOURCE_FILE ("instruction-for.galgas", 234)) ;
  GGS_location var_endof_5F_foreach_5F_instruction_8879 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for.galgas", 235)) ;
