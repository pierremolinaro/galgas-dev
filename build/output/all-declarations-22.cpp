...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalRoutineMessageMap (HERE).isValid ()) {
    ...
    while (enumerator_724.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_0) {
        ...
        GALGAS_uint index_870_ (0) ;
        if (enumerator_724.current_mLexicalRoutineFormalArgumentList (HERE).isValid ()) {
          cEnumerator_lexicalRoutineFormalArgumentList enumerator_870 (enumerator_724.current_mLexicalRoutineFormalArgumentList (HERE), kENUMERATION_UP) ;
          while (enumerator_870.hasCurrentObject ()) {
            result << ",\n"
              "                " ;
            result << extensionGetter_cppConstInFormalArgument (enumerator_870.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 17)).stringValue () ;
            result << extensionGetter_cppTypeName (enumerator_870.current_mLexicalFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 18)).stringValue () ;
            result << extensionGetter_cppReferenceInFormalArgument (enumerator_870.current_mLexicalFormalArgumentMode (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 19)).stringValue () ;
            result << " " ;
            result << enumerator_870.current_mArgumentNameForComment (HERE).stringValue () ;
            index_870_.increment () ;
            enumerator_870.gotoNextObject () ;
          }
        }
        GALGAS_uint index_1217_ (0) ;
        if (enumerator_724.current_mErrorMessageList (HERE).isValid ()) {
          cEnumerator_stringlist enumerator_1217 (enumerator_724.current_mErrorMessageList (HERE), kENUMERATION_UP) ;
          while (enumerator_1217.hasCurrentObject ()) {
            result << ",\n"
              "                const char * " ;
            result << enumerator_1217.current_mValue (HERE).stringValue () ;
            index_1217_.increment () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalFunctionMap (HERE).isValid ()) {
    cEnumerator_lexicalFunctionMap enumerator_1711 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalFunctionMap (HERE), kENUMERATION_UP) ;
    while (enumerator_1711.hasCurrentObject ()) {
      const enumGalgasBool test_1 = enumerator_1711.current_mIsExtern (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "\n" ;
        result << extensionGetter_cppTypeName (enumerator_1711.current_mReturnedLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 35)).stringValue () ;
        result << " scanner_function_" ;
        result << enumerator_1711.current_lkey (HERE).getter_string (HERE).stringValue () ;
        result << " (C_Lexique & inLexique" ;
        GALGAS_uint index_1874_ (0) ;
        if (enumerator_1711.current_mLexicalTypeList (HERE).isValid ()) {
          cEnumerator_lexicalFunctionFormalArgumentList enumerator_1874 (enumerator_1711.current_mLexicalTypeList (HERE), kENUMERATION_UP) ;
          while (enumerator_1874.hasCurrentObject ()) {
            result << ",\n"
              "                const " ;
            result << extensionGetter_cppTypeName (enumerator_1874.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 37)).stringValue () ;
            result << " " ;
            result << enumerator_1874.current_mArgumentNameForComment (HERE).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_2466 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE), kENUMERATION_UP) ;
    while (enumerator_2466.hasCurrentObject ()) {
      result << "  public: " ;
      result << extensionGetter_cppTypeName (enumerator_2466.current_mLexicalType (HERE), inCompiler COMMA_SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 50)).stringValue () ;
      result << " mLexicalAttribute_" ;
      result << enumerator_2466.current_lkey (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_header_template_zone_2.new.h.galgasTemplate", 50)).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (C_Compiler * inCompiler,
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
    cEnumerator_terminalList enumerator_117 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
    while (enumerator_117.hasCurrentObject ()) {
      result << ",\n"
        "   kToken_" ;
      result << enumerator_117.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_header_template_zone_3.new.h.galgasTemplate", 5)).stringValue () ;
  ...
  if (in_DELIMITOR_5F_LIST_5F_LIST.isValid ()) {
    ...
    while (enumerator_242.hasCurrentObject ()) {
      result << "\n"
        "//--- Key words table '" ;
      result << enumerator_242.current_mName (HERE).getter_string (HERE).stringValue () ;
      result << "'\n"
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_499 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE), kENUMERATION_UP) ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_758 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE), kENUMERATION_UP) ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (C_Compiler * inCompiler,
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_3203.hasCurrentObject ()) {
      ...
      result << enumerator_3203.current_mTerminalName (HERE).getter_string (HERE).stringValue () ;
      result << "$' :\n"
        "static const char * gSyntaxErrorMessage_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "_" ;
      result << enumerator_3203.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 69)).stringValue () ;
      result << " = " ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_4189.hasCurrentObject ()) {
      ...
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << "_" ;
      result << enumerator_4189.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 81)).stringValue () ;
  ...
  if (in_LEXICAL_5F_TOKEN_5F_LIST_5F_MAP.isValid ()) {
    ...
    while (enumerator_5082.hasCurrentObject ()) {
      result << "//----------------------------------------------------------------------------------------------------------------------\n"
        "//             Key words table '" ;
      result << enumerator_5082.current_lkey (HERE).getter_string (HERE).stringValue () ;
      result << "'      \n"
        "//----------------------------------------------------------------------------------------------------------------------\n"
        "\n"
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_7113.hasCurrentObject ()) {
      result << "    case kToken_" ;
      result << enumerator_7113.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 132)).stringValue () ;
      result << ":\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n"
        "      s.appendCString (" ;
      result << enumerator_7113.current_mTerminalName (HERE).getter_string (HERE).getter_utf_38_Representation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 134)).stringValue () ;
      result << ") ;\n"
        "      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;\n" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTemplateDelimitorList (HERE).isValid ()) {
    cEnumerator_templateDelimitorList enumerator_8328 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTemplateDelimitorList (HERE), kENUMERATION_UP) ;
  ...
  if (in_TEMPLATE_5F_REPLACEMENT_5F_LIST.isValid ()) {
    ...
    while (enumerator_9322.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_4) {
        ...
        result << enumerator_9322.current_mReplacementFunction (HERE).getter_string (HERE).stringValue () ;
      }
      result << ", true)" ;
  ...
  if (kBoolTrue == test_5) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
      cEnumerator_terminalList enumerator_10415 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
      ...
      while (enumerator_10415.hasCurrentObject ()) {
        ...
        result << " /* " ;
        result << enumerator_10415.current_mTerminalName (HERE).getter_string (HERE).stringValue () ;
        result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
    cEnumerator_terminalList enumerator_19674 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
  ...
  if (in_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_21966.hasCurrentObject ()) {
      ...
      result << "_1_" ;
      result << enumerator_21966.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_implementation-galgas3.cpp.galgasTemplate", 412)).stringValue () ;
      result << " */" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalRoutineMessageMap (HERE).isValid ()) {
    cEnumerator_lexicalRoutineMap enumerator_439 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalRoutineMessageMap (HERE), kENUMERATION_UP) ;
    while (enumerator_439.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_0) {
        ...
        result << enumerator_439.current_lkey (HERE).getter_string (HERE).stringValue () ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalFunctionMap (HERE).isValid ()) {
    cEnumerator_lexicalFunctionMap enumerator_1347 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalFunctionMap (HERE), kENUMERATION_UP) ;
    while (enumerator_1347.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_1) {
        ...
        result << enumerator_1347.current_lkey (HERE).getter_string (HERE).stringValue () ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
        result << "BOOL * ioScanningOk" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
    cEnumerator_terminalList enumerator_2090 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
    while (enumerator_2090.hasCurrentObject ()) {
      result << ",\n"
        "  " ;
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_2090.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_header_template_zone_2.h.galgasTemplate", 48)).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE).isValid ()) {
    cEnumerator_lexicalAttributeMap enumerator_3172 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalAttributeMap (HERE), kENUMERATION_UP) ;
    while (enumerator_3172.hasCurrentObject ()) {
      ...
      result << " mLexicalAttribute_" ;
      result << enumerator_3172.current_lkey (HERE).getter_string (HERE).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (C_Compiler * inCompiler,
  ...
  if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
    ...
    while (enumerator_2091.hasCurrentObject ()) {
      result << "    mLexicalAttribute_" ;
      result << enumerator_2091.current_lkey (HERE).getter_string (HERE).stringValue () ;
      result << " = " ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTemplateDelimitorList (HERE).isValid ()) {
      cEnumerator_templateDelimitorList enumerator_2540 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTemplateDelimitorList (HERE), kENUMERATION_UP) ;
  ...
  if (kBoolTrue == test_6) {
    ...
    if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
      cEnumerator_terminalList enumerator_5217 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
      ...
      while (enumerator_5217.hasCurrentObject ()) {
        ...
        result << " /* " ;
        result << enumerator_5217.current_mTerminalName (HERE).getter_string (HERE).stringValue () ;
        result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalTokenListMap (HERE).isValid ()) {
    cEnumerator_lexicalExplicitTokenListMapMap enumerator_5425 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mLexicalTokenListMap (HERE), kENUMERATION_UP) ;
    while (enumerator_5425.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_7) {
        result << "//----------------------------------------------------------------------------------------------------------------------\n"
          "//\n"
          "//             Key words table '" ;
        result << enumerator_5425.current_lkey (HERE).getter_string (HERE).stringValue () ;
        result << "'      \n"
          "//\n"
          "//----------------------------------------------------------------------------------------------------------------------\n"
          "\n"
  ...
  if (kBoolTrue == test_8) {
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_8424.hasCurrentObject ()) {
        ...
        result << "mLexicalAttribute_" ;
        result << enumerator_8424.current_lkey (HERE).getter_string (HERE).stringValue () ;
    ...
    if (in_LEXICAL_5F_ATTRIBUTE_5F_MAP.isValid ()) {
      ...
      while (enumerator_9261.hasCurrentObject ()) {
        ...
        result << "mLexicalAttribute_" ;
        result << enumerator_9261.current_lkey (HERE).getter_string (HERE).stringValue () ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
    cEnumerator_terminalList enumerator_11799 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
    while (enumerator_11799.hasCurrentObject ()) {
      ...
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_11799.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 271)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE).isValid ()) {
    cEnumerator_terminalList enumerator_12561 (in_LEXIQUE_5F_ANALYSIS_5F_CONTEXT.getter_mTerminalList (HERE), kENUMERATION_UP) ;
    while (enumerator_12561.hasCurrentObject ()) {
      ...
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "_1_" ;
      result << enumerator_12561.current_mTerminalName (HERE).getter_string (HERE).getter_identifierRepresentation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 285)).stringValue () ;
      result << " */" ;
  ...
  if (in_LEXICAL_5F_STYLE_5F_LIST.isValid ()) {
    ...
    while (enumerator_13404.hasCurrentObject ()) {
      result << ",\n"
        "      @" ;
      result << enumerator_13404.current_mComment (HERE).getter_string (HERE).getter_utf_38_Representation (SOURCE_FILE ("lexique_cocoa_implementation.m.galgasTemplate", 302)).stringValue () ;
  ...
  if (in_LEXICAL_5F_STYLE_5F_LIST.isValid ()) {
    ...
    while (enumerator_14200.hasCurrentObject ()) {
      ...
      result << in_LEXIQUE_5F_CLASS_5F_NAME.stringValue () ;
      result << "-" ;
      result << enumerator_14200.current_mName (HERE).getter_string (HERE).stringValue () ;
      result << "\"" ;
...
GALGAS_string filewrapperTemplate_guiGenerationTemplates_gui_5F_implementation (C_Compiler * inCompiler,
  ...
  if (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_138 (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mNibAndClassList (HERE).isValid ()) {
    cEnumerator_stringlist enumerator_264 (in_GUI_5F_CONTEXT.getter_mNibAndClassList (HERE), kENUMERATION_UP) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (in_GUI_5F_CONTEXT.getter_mNibAndClassList (HERE).isValid ()) {
      cEnumerator_stringlist enumerator_1104 (in_GUI_5F_CONTEXT.getter_mNibAndClassList (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mImportedOptionComponentList (HERE).isValid ()) {
    cEnumerator_stringlist enumerator_1770 (in_GUI_5F_CONTEXT.getter_mImportedOptionComponentList (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mImportedOptionComponentList (HERE).isValid ()) {
    cEnumerator_stringlist enumerator_2252 (in_GUI_5F_CONTEXT.getter_mImportedOptionComponentList (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_3106 (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mExtensionMap (HERE).isValid ()) {
    cEnumerator_extensionMap enumerator_7798 (in_GUI_5F_CONTEXT.getter_mExtensionMap (HERE), kENUMERATION_UP) ;
  ...
  if (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE).isValid ()) {
    cEnumerator_importedLexiqueList enumerator_8243 (in_GUI_5F_CONTEXT.getter_mWithLexiqueList (HERE), kENUMERATION_UP) ;
...
static void extensionMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_2038 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mArrayTypeName (HERE).getter_string (SOURCE_FILE ("type-array.galgas", 46)), inCompiler COMMA_SOURCE_FILE ("type-array.galgas", 46)), temp_1.getter_mArrayTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-array.galgas", 46)) ;
  {
...
static void extensionMethod_boolsetDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_1974 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mBoolsetTypeName (HERE).getter_string (SOURCE_FILE ("type-boolset.galgas", 48)), inCompiler COMMA_SOURCE_FILE ("type-boolset.galgas", 48)), temp_1.getter_mBoolsetTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-boolset.galgas", 48)) ;
  {
...
static void extensionMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_4227 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mClassTypeName (HERE).getter_string (SOURCE_FILE ("type-class.galgas", 116)), inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 116)), temp_1.getter_mClassTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-class.galgas", 116)) ;
  {
  ...
  while (enumerator_4574.hasCurrentObject ()) {
    ...
    ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_4227, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_4574.current_mPropertyTypeName (HERE).getter_string (SOURCE_FILE ("type-class.galgas", 125)), inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 125)), temp_8.getter_mSuperClassName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-class.galgas", 125)) COMMA_SOURCE_FILE ("type-class.galgas", 125)) ;
    }
...
static void extensionMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_8488.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_13) {
          ...
          if (kBoolTrue == test_14) {
            ...
            if (kBoolTrue == test_14) {
              ...
              inCompiler->emitSemanticError (enumerator_8671.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 240)), GALGAS_string ("duplicated attribute"), fixItArray15  COMMA_SOURCE_FILE ("type-class.galgas", 240)) ;
            }
          }
    ...
    if (kBoolTrue == test_18) {
      ...
      if (kBoolTrue == test_18) {
        TC_Array <C_FixItDescription> fixItArray19 ;
        inCompiler->emitSemanticError (enumerator_8488.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 256)), GALGAS_string ("'").add_operation (enumerator_8488.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("type-class.galgas", 256)), inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 256)).add_operation (GALGAS_string ("' is the name of a prefefined or a user defined getter"), inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 256)), fixItArray19  COMMA_SOURCE_FILE ("type-class.galgas", 256)) ;
      }
    }
    ...
    while (enumerator_10155.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_24) {
        ...
        if (kBoolTrue == test_24) {
          ...
          inCompiler->emitSemanticWarning (enumerator_10155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 283)), GALGAS_string ("'%nogetter' is obsolete and has no effect"), fixItArray25  COMMA_SOURCE_FILE ("type-class.galgas", 283)) ;
        }
      }
      if (kBoolFalse == test_24) {
        ...
        if (kBoolTrue == test_26) {
          ...
          if (kBoolTrue == test_26) {
            ...
            inCompiler->emitSemanticWarning (enumerator_10155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 285)), GALGAS_string ("'%setter' is obsolete and has no effect"), fixItArray27  COMMA_SOURCE_FILE ("type-class.galgas", 285)) ;
          }
        }
...
static void extensionMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
        ...
        if (kBoolTrue == test_23) {
          ...
          while (enumerator_15927.hasCurrentObject ()) {
              ...
              if (kBoolTrue == test_26) {
                ...
                if (kBoolTrue == test_27) {
                  ...
                  if (kBoolTrue == test_27) {
                    ...
                    inCompiler->emitSemanticError (enumerator_15927.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 424)), GALGAS_string ("the 'generatedInSeparateFile' is already named"), fixItArray28  COMMA_SOURCE_FILE ("type-class.galgas", 424)) ;
                  }
                }
            ...
            if (kBoolFalse == test_26) {
              ...
              inCompiler->emitSemanticError (enumerator_15927.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 428)), GALGAS_string ("only the 'generatedInSeparateFile' attribute is allowed here"), fixItArray29  COMMA_SOURCE_FILE ("type-class.galgas", 428)) ;
            }
    ...
    if (kBoolTrue == test_30) {
      ...
      if (kBoolTrue == test_30) {
        ...
        while (enumerator_16466.hasCurrentObject ()) {
          ...
          inCompiler->emitSemanticError (enumerator_16466.current_mValue (HERE).getter_location (SOURCE_FILE ("type-class.galgas", 436)), GALGAS_string ("a class that has a super class does not accept any feature"), fixItArray33  COMMA_SOURCE_FILE ("type-class.galgas", 436)) ;
  ...
  const GALGAS_classDeclarationAST temp_37 = object ;
  const GALGAS_classDeclarationAST temp_38 = object ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("class ").add_operation (temp_36.getter_mClassTypeName (HERE).getter_string (SOURCE_FILE ("type-class.galgas", 465)), inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 465)), GALGAS_classTypeForGeneration::constructor_new (var_selfType_14623, temp_37.getter_mIsAbstract (HERE), temp_38.getter_mIsReference (HERE), var_superClassEntry_14752, var_allAttributeList_15747, var_typedAttributeList_16671, var_selfType_14623.getter_mGenerateHeaderInSeparateFile (inCompiler COMMA_SOURCE_FILE ("type-class.galgas", 473))  COMMA_SOURCE_FILE ("type-class.galgas", 466))  COMMA_SOURCE_FILE ("type-class.galgas", 464)) ;
}
...
static void extensionMethod_weakReferenceDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_1648, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_7.getter_mClassTypeName (HERE).getter_string (SOURCE_FILE ("type-weak-reference.galgas", 40)), inCompiler COMMA_SOURCE_FILE ("type-weak-reference.galgas", 40)), temp_8.getter_mClassTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 40)) COMMA_SOURCE_FILE ("type-weak-reference.galgas", 38)) ;
  }
}
...
static void extensionMethod_weakReferenceDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_4794.hasCurrentObject ()) {
    TC_Array <C_FixItDescription> fixItArray13 ;
    inCompiler->emitSemanticError (enumerator_4794.current_lkey (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 118)), GALGAS_string ("a weak referencev does not support extension"), fixItArray13  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 118)) ;
  ...
  while (enumerator_4896.hasCurrentObject ()) {
    ...
    inCompiler->emitSemanticError (enumerator_4896.current_lkey (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 121)), GALGAS_string ("a weak referencev does not support extension"), fixItArray14  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 121)) ;
  ...
  while (enumerator_4998.hasCurrentObject ()) {
    TC_Array <C_FixItDescription> fixItArray15 ;
    inCompiler->emitSemanticError (enumerator_4998.current_lkey (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 124)), GALGAS_string ("a weak reference does not support extension"), fixItArray15  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 124)) ;
...
static void extensionMethod_weakReferenceDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
      ...
      if (kBoolTrue == test_10) {
        ...
        if (kBoolTrue == test_10) {
          ...
          while (enumerator_7963.hasCurrentObject ()) {
            ...
            if (kBoolTrue == test_13) {
              ...
              if (kBoolTrue == test_13) {
                ...
                if (kBoolTrue == test_14) {
                  ...
                  if (kBoolTrue == test_14) {
                    TC_Array <C_FixItDescription> fixItArray15 ;
                    inCompiler->emitSemanticError (enumerator_7963.current_mValue (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 196)), GALGAS_string ("the 'generatedInSeparateFile' is already named"), fixItArray15  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 196)) ;
                  }
                }
            ...
            if (kBoolFalse == test_13) {
              TC_Array <C_FixItDescription> fixItArray16 ;
              inCompiler->emitSemanticError (enumerator_7963.current_mValue (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 200)), GALGAS_string ("only the 'generatedInSeparateFile' attribute is allowed here"), fixItArray16  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 200)) ;
            }
    ...
    if (kBoolTrue == test_17) {
      ...
      if (kBoolTrue == test_17) {
        ...
        while (enumerator_8502.hasCurrentObject ()) {
          TC_Array <C_FixItDescription> fixItArray20 ;
          inCompiler->emitSemanticError (enumerator_8502.current_mValue (HERE).getter_location (SOURCE_FILE ("type-weak-reference.galgas", 208)), GALGAS_string ("a class that has a super class does not accept any feature"), fixItArray20  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 208)) ;
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("weak reference ").add_operation (temp_24.getter_mWeakReferenceTypeName (HERE).getter_string (SOURCE_FILE ("type-weak-reference.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("type-weak-reference.galgas", 239)), GALGAS_weakReferenceTypeForGeneration::constructor_new (var_selfType_7238, var_referenceClassType_9370, var_superClassEntry_7375, var_allAttributeList_7783, var_typedAttributeList_8707, var_selfType_7238.getter_mGenerateHeaderInSeparateFile (inCompiler COMMA_SOURCE_FILE ("type-weak-reference.galgas", 246))  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 240))  COMMA_SOURCE_FILE ("type-weak-reference.galgas", 238)) ;
}
    ...
    while (enumerator_3092.hasCurrentObject () && bool_4) {
      ...
      if (enumerator_3194.hasCurrentObject () && bool_5) {
        while (enumerator_3194.hasCurrentObject () && bool_5) {
          GALGAS_lstring var_propertyKey_3281 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_3194.current_mValue_30_ (HERE).getter_string (SOURCE_FILE ("type-enum.galgas", 81)), inCompiler COMMA_SOURCE_FILE ("type-enum.galgas", 81)), enumerator_3194.current_mValue_30_ (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-enum.galgas", 81)) ;
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
    ...
    if (kBoolTrue == test_8) {
      ...
      while (enumerator_3643.hasCurrentObject ()) {
        ...
        while (enumerator_3690.hasCurrentObject ()) {
          GALGAS_lstring var_propertyKey_3752 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_3690.current_mValue_30_ (HERE).getter_string (SOURCE_FILE ("type-enum.galgas", 94)), inCompiler COMMA_SOURCE_FILE ("type-enum.galgas", 94)), enumerator_3690.current_mValue_30_ (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-enum.galgas", 94)) ;
          enumGalgasBool test_10 = kBoolTrue ;
          if (kBoolTrue == test_10) {
  ...
  if (kBoolTrue == test_7) {
    ...
    if (kBoolTrue == test_7) {
      ...
      if (kBoolFalse == test_10) {
        ...
        TC_Array <C_FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (temp_12.getter_mDefaultConstantName (HERE).getter_location (SOURCE_FILE ("type-enum.galgas", 205)), GALGAS_string ("the default constant should have no associated values"), fixItArray13  COMMA_SOURCE_FILE ("type-enum.galgas", 205)) ;
      }
    }
  }
  {
...
static void extensionMethod_enumDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_10205.hasCurrentObject ()) {
    ...
    while (enumerator_10402.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_10402.current_mValue_31_ (HERE).getter_location (SOURCE_FILE ("type-enum.galgas", 269)), GALGAS_string ("duplicated name"), fixItArray3  COMMA_SOURCE_FILE ("type-enum.galgas", 269)) ;
        }
      }
  ...
  const GALGAS_enumDeclarationAST temp_5 = object ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("enum ").add_operation (temp_5.getter_mEnumTypeName (HERE).getter_string (SOURCE_FILE ("type-enum.galgas", 279)), inCompiler COMMA_SOURCE_FILE ("type-enum.galgas", 279)), GALGAS_enumTypeForGeneration::constructor_new (var_selfType_11127, var_enumConstantListForGeneration_10108  COMMA_SOURCE_FILE ("type-enum.galgas", 280))  COMMA_SOURCE_FILE ("type-enum.galgas", 278)) ;
}
...
static void extensionMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_7520 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mExternTypeName (HERE).getter_string (SOURCE_FILE ("type-extern.galgas", 190)), inCompiler COMMA_SOURCE_FILE ("type-extern.galgas", 190)), temp_1.getter_mExternTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-extern.galgas", 190)) ;
  {
...
static void extensionMethod_externTypeDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_externTypeDeclarationAST temp_4 = object ;
  const GALGAS_externTypeDeclarationAST temp_5 = object ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("extern type ").add_operation (temp_1.getter_mExternTypeName (HERE).getter_string (SOURCE_FILE ("type-extern.galgas", 341)), inCompiler COMMA_SOURCE_FILE ("type-extern.galgas", 341)), GALGAS_externTypeDeclarationForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.getter_mTypeMap (HERE), temp_2.getter_mExternTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("type-extern.galgas", 343)), temp_3.getter_mExternTypeName (HERE).getter_string (HERE), temp_4.getter_mCppPreDeclarationCode (HERE), temp_5.getter_mCppClassCode (HERE)  COMMA_SOURCE_FILE ("type-extern.galgas", 342))  COMMA_SOURCE_FILE ("type-extern.galgas", 340)) ;
}
...
static void extensionMethod_graphDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_16010.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_12) {
      ...
      if (kBoolTrue == test_12) {
        TC_Array <C_FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (enumerator_16010.current_mInsertModifierName (HERE).getter_location (SOURCE_FILE ("type-graph.galgas", 458)), GALGAS_string ("the '").add_operation (enumerator_16010.current_mInsertModifierName (HERE).getter_string (SOURCE_FILE ("type-graph.galgas", 458)), inCompiler COMMA_SOURCE_FILE ("type-graph.galgas", 458)).add_operation (GALGAS_string ("' setter name is reserved for a graph type"), inCompiler COMMA_SOURCE_FILE ("type-graph.galgas", 458)), fixItArray13  COMMA_SOURCE_FILE ("type-graph.galgas", 458)) ;
      }
    }
    {
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("graph ").add_operation (temp_14.getter_mGraphTypeName (HERE).getter_string (SOURCE_FILE ("type-graph.galgas", 464)), inCompiler COMMA_SOURCE_FILE ("type-graph.galgas", 464)), GALGAS_graphDeclarationForGeneration::constructor_new (var_graphTypeEntry_15240, var_associatedListTypeEntry_15355, var_associatedListElementTypeEntry_15486, temp_15.getter_mInsertModifierList (HERE)  COMMA_SOURCE_FILE ("type-graph.galgas", 465))  COMMA_SOURCE_FILE ("type-graph.galgas", 463)) ;
}
...
static void extensionMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_key_2041 = GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (temp_0.getter_mListTypeName (HERE).getter_string (SOURCE_FILE ("type-list.galgas", 49)), inCompiler COMMA_SOURCE_FILE ("type-list.galgas", 49)), temp_1.getter_mListTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-list.galgas", 49)) ;
  {
  ...
  while (enumerator_2201.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.setter_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_2201.current_mPropertyTypeName (HERE).getter_string (SOURCE_FILE ("type-list.galgas", 52)), inCompiler COMMA_SOURCE_FILE ("type-list.galgas", 52)), enumerator_2201.current_mPropertyTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-list.galgas", 52)) COMMA_SOURCE_FILE ("type-list.galgas", 52)) ;
    }
  ...
  while (enumerator_3129.hasCurrentObject ()) {
    ...
    while (enumerator_3309.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticWarning (enumerator_3309.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 73)), GALGAS_string ("'%setter' is obsolete and has no effect"), fixItArray2  COMMA_SOURCE_FILE ("type-list.galgas", 73)) ;
        }
      }
      if (kBoolFalse == test_1) {
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          ...
          if (kBoolTrue == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticWarning (enumerator_3309.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 75)), GALGAS_string ("'%nogetter' is obsolete and has no effect"), fixItArray4  COMMA_SOURCE_FILE ("type-list.galgas", 75)) ;
          }
        }
        if (kBoolFalse == test_3) {
          enumGalgasBool test_5 = kBoolTrue ;
            ...
            if (kBoolTrue == test_5) {
              ...
              if (kBoolTrue == test_6) {
                ...
                if (kBoolTrue == test_6) {
                  ...
                  inCompiler->emitSemanticError (enumerator_3309.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 78)), GALGAS_string ("the '%selector' attribute is already named"), fixItArray7  COMMA_SOURCE_FILE ("type-list.galgas", 78)) ;
                }
              }
          ...
          if (kBoolFalse == test_5) {
            ...
            inCompiler->emitSemanticError (enumerator_3309.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 82)), GALGAS_string ("only '%selector' attribute is allowed here"), fixItArray8  COMMA_SOURCE_FILE ("type-list.galgas", 82)) ;
          }
        }
      }
...
static void extensionMethod_listDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_13310.hasCurrentObject ()) {
    ...
    while (enumerator_13683.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_4) {
        ...
        if (kBoolTrue == test_4) {
          TC_Array <C_FixItDescription> fixItArray5 ;
          inCompiler->emitSemanticWarning (enumerator_13683.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 365)), GALGAS_string ("obsolete attribute: setter is implicitly generated for a public property"), fixItArray5  COMMA_SOURCE_FILE ("type-list.galgas", 365)) ;
        }
      }
      if (kBoolFalse == test_4) {
        enumGalgasBool test_6 = kBoolTrue ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_6) {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticWarning (enumerator_13683.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 367)), GALGAS_string ("obsolete attribute: use 'private' qualifier"), fixItArray7  COMMA_SOURCE_FILE ("type-list.galgas", 367)) ;
          }
        }
        if (kBoolFalse == test_6) {
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            ...
            if (kBoolTrue == test_8) {
              ...
              if (kBoolTrue == test_9) {
                ...
                if (kBoolTrue == test_9) {
                  TC_Array <C_FixItDescription> fixItArray10 ;
                  inCompiler->emitSemanticError (enumerator_13683.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 370)), GALGAS_string ("the '%selector' attribute is already named"), fixItArray10  COMMA_SOURCE_FILE ("type-list.galgas", 370)) ;
                }
              }
          ...
          if (kBoolFalse == test_8) {
            ...
            inCompiler->emitSemanticError (enumerator_13683.current_mValue (HERE).getter_location (SOURCE_FILE ("type-list.galgas", 374)), GALGAS_string ("only '%selector' attribut is allowed here"), fixItArray11  COMMA_SOURCE_FILE ("type-list.galgas", 374)) ;
          }
        }
      }
  ...
  const GALGAS_listDeclarationAST temp_15 = object ;
  const GALGAS_listDeclarationAST temp_16 = object ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("list type ").add_operation (temp_14.getter_mListTypeName (HERE).getter_string (SOURCE_FILE ("type-list.galgas", 389)), inCompiler COMMA_SOURCE_FILE ("type-list.galgas", 389)), GALGAS_listTypeForGeneration::constructor_new (var_selfType_14455, GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.getter_mTypeMap (HERE), GALGAS_lstring::constructor_new (temp_15.getter_mListTypeName (HERE).getter_string (HERE).add_operation (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("type-list.galgas", 392)), inCompiler COMMA_SOURCE_FILE ("type-list.galgas", 392)), temp_16.getter_mListTypeName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("type-list.galgas", 392)), inCompiler  COMMA_SOURCE_FILE ("type-list.galgas", 392)), var_typedAttributeList_13197  COMMA_SOURCE_FILE ("type-list.galgas", 390))  COMMA_SOURCE_FILE ("type-list.galgas", 388)) ;
}
