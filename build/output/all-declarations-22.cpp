...
void cPtr_templateLexiqueComponentAST::method_semanticAnalysis (GALGAS_lstringlist & /* ioArgument_ioUsefulnessRootEntities */,
  ...
  if (kBoolTrue == test_32) {
    ...
    if (kBoolTrue == test_32) {
      ...
      GALGAS_string var_headerContents_20770 = GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_headerZone_32_ (inCompiler, temp_33.readProperty_mLexiqueComponentName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("template-lexique-component.galgas", 454)), var_lexiqueAnalysisContext_13663, temp_34.readProperty_mTemplateDelimitorList () COMMA_SOURCE_FILE ("template-lexique-component.galgas", 453))) ;
      const GALGAS_templateLexiqueComponentAST temp_35 = this ;
      const GALGAS_templateLexiqueComponentAST temp_36 = this ;
      var_headerContents_20770.plusAssign_operation(GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_headerZone_33_ (inCompiler, temp_35.readProperty_mLexiqueComponentName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("template-lexique-component.galgas", 459)), temp_36.readProperty_mLexicalListDeclarationList (), var_lexiqueAnalysisContext_13663, GALGAS_indexingListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 462)) COMMA_SOURCE_FILE ("template-lexique-component.galgas", 458))), inCompiler  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 458)) ;
      ...
      GALGAS_string var_cppContents_21302 = GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_implementationZone_32_Galgas_33_ (inCompiler, temp_37.readProperty_mLexiqueComponentName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("template-lexique-component.galgas", 467)), var_lexiqueAnalysisContext_13663.readProperty_mLexicalAttributeMap (), var_lexiqueAnalysisContext_13663.readProperty_mLexicalMessageMap (), var_lexiqueAnalysisContext_13663.readProperty_mTerminalList (), var_lexiqueAnalysisContext_13663.readProperty_mLexicalTokenListMap (), var_lexiqueAnalysisContext_13663.readProperty_mUnicodeStringToGenerate (), temp_38.readProperty_mLexicalRuleList (), var_lexiqueAnalysisContext_13663, GALGAS_string::makeEmptyString (), temp_39.readProperty_mTemplateDelimitorList (), temp_40.readProperty_mLexiqueComponentName ().readProperty_string (), temp_41.readProperty_mTemplateReplacementList (), temp_42.readProperty_mLexicalStyleList () COMMA_SOURCE_FILE ("template-lexique-component.galgas", 466))) ;
      const GALGAS_templateLexiqueComponentAST temp_43 = this ;
      GALGAS_string var_cocoaHeader_21989 = GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, temp_43.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexiqueAnalysisContext_13663 COMMA_SOURCE_FILE ("template-lexique-component.galgas", 482))) ;
      const GALGAS_templateLexiqueComponentAST temp_44 = this ;
      var_cocoaHeader_21989.plusAssign_operation(GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, temp_44.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexiqueAnalysisContext_13663 COMMA_SOURCE_FILE ("template-lexique-component.galgas", 486))), inCompiler  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 486)) ;
      ...
      GALGAS_string var_cocoaImplementation_22350 = GALGAS_string (filewrapperTemplate_templateLexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, GALGAS_string ("lexique-").add_operation (temp_45.readProperty_mLexiqueComponentName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("template-lexique-component.galgas", 492)), inCompiler COMMA_SOURCE_FILE ("template-lexique-component.galgas", 492)).add_operation (GALGAS_string ("-cocoa"), inCompiler COMMA_SOURCE_FILE ("template-lexique-component.galgas", 492)), temp_46.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexiqueAnalysisContext_13663.readProperty_mLexicalAttributeMap (), var_lexiqueAnalysisContext_13663.readProperty_mLexicalMessageMap (), var_lexiqueAnalysisContext_13663.readProperty_mTerminalList (), var_lexiqueAnalysisContext_13663.readProperty_mUnicodeStringToGenerate (), temp_47.readProperty_mLexicalRuleList (), var_lexiqueAnalysisContext_13663, temp_48.readProperty_mTemplateReplacementList (), GALGAS_string::makeEmptyString (), GALGAS_indexingListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 502)), temp_49.readProperty_mLexicalStyleList (), temp_50.readProperty_mTemplateDelimitorList () COMMA_SOURCE_FILE ("template-lexique-component.galgas", 491))) ;
      const GALGAS_templateLexiqueComponentAST temp_51 = this ;
      const GALGAS_templateLexiqueComponentAST temp_52 = this ;
      ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_lexiqueDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("lexique-").add_operation (temp_51.readProperty_mLexiqueComponentName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("template-lexique-component.galgas", 511)), inCompiler COMMA_SOURCE_FILE ("template-lexique-component.galgas", 511)), temp_52.readProperty_mLexiqueComponentName ().readProperty_string (), var_headerContents_20770, var_cppContents_21302, var_cocoaHeader_21989, var_cocoaImplementation_22350  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 509))  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 507)) ;
    }
  }
}
//----------------------------------------------------------------------------------------------------------------------
