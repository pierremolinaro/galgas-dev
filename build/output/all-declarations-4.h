...
class GALGAS_syntaxExtensions : public AC_GALGAS_listmap_new {
//--------------------------------- Default constructor
...
class GALGAS_formalParameterSignature : public AC_GALGAS_list_new {
//--------------------------------- Default constructor
  public : GALGAS_formalParameterSignature (const bool inIsValid = false) ;
