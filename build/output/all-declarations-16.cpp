//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                           File 'all-declarations-16.cpp'                                            *
//                                             Generated by version 2.7.0                                              *
//                                           august 9th, 2014, at 16h43'25"                                            *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_assignmentInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_12346 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
    while (enumerator_12346.hasCurrentObject ()) {
      ...
      var_attributeMap.method_searchKey (enumerator_12346.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 283)) ;
...
static void categoryMethod_errorInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_17874 (object->mAttribute_mBuiltVariableList, kEnumeration_up) ;
  while (enumerator_17874.hasCurrentObject ()) {
    GALGAS_string var_varCppName ;
    {
    GALGAS_unifiedTypeMapProxy joker_17952_0 ; // Joker input parameter
    GALGAS_string joker_17967_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForWriteAccess (enumerator_17874.current_mValue (HERE), joker_17952_0, var_varCppName, joker_17967_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 413)) ;
    }
...
static void categoryMethod_outputInputActualParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  {
  GALGAS_string joker_23128_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mOutputInputActualParameterName, var_parameterType, var_variableCppName, joker_23128_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 533)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_23239 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_23239.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_23239.current_mValue (HERE), var_parameterType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 537)) ;
...
static void categoryMethod_inputActualExistingVariableParameterAST_checkAgainstFormalArgument (const cPtr_actualParameterAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_25453_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mInputActualParameterName, var_parameterType, var_targetVariableCppName, joker_25453_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 578)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType)).boolEnum () ;
  if (kBoolTrue == test_5) {
...
static void categoryMethod_routineCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_35089 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_35089.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_35089.current_mType (HERE), enumerator_35089.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 796))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 796)) ;
    enumerator_35089.gotoNextObject () ;
  }
...
static void categoryMethod_typeMethodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_36484 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_36484.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_36484.current_mType (HERE), enumerator_36484.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 831))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 831)) ;
...
static void categoryMethod_methodCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_location joker_37561_0 ; // Joker input parameter
  GALGAS_methodQualifier joker_37585_0 ; // Joker input parameter
  var_receiverExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 860)).reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 860)).method_searchKey (object->mAttribute_mMethodName, var_kind, var_routineSignature, joker_37561_0, var_hasCompilerArgument, joker_37585_0, var_errorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 860)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 880)).isValid ()) {
      uint32_t variant_38245 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 880)).uintValue () ;
      bool loop_38245 = true ;
      while (loop_38245) {
        loop_38245 = var_searching.isValid () ;
        if (loop_38245) {
          loop_38245 = var_searching.boolValue () ;
        }
        if (loop_38245 && (0 == variant_38245)) {
          loop_38245 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_38637 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_38637.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_38637.current_mType (HERE), enumerator_38637.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 894))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 894)) ;
    enumerator_38637.gotoNextObject () ;
  }
...
static void categoryMethod_modifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_40348 (object->mAttribute_mReceiverStructAttributes, kEnumeration_up) ;
  while (enumerator_40348.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_40348.current_mValue (HERE), var_receiverType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 943)) ;
  ...
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_40714_0 ; // Joker input parameter
  var_receiverType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 950)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_40714_0, var_modifierErrorMessage, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 950)) ;
  ...
  if (kBoolTrue == test_2) {
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 970)).isValid ()) {
      uint32_t variant_41383 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 970)).uintValue () ;
      bool loop_41383 = true ;
      while (loop_41383) {
        loop_41383 = var_searching.isValid () ;
        if (loop_41383) {
          loop_41383 = var_searching.boolValue () ;
        }
        if (loop_41383 && (0 == variant_41383)) {
          loop_41383 = false ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_41771 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_41771.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_41771.current_mType (HERE), enumerator_41771.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 984))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 984)) ;
    enumerator_41771.gotoNextObject () ;
  }
...
static void categoryMethod_selfModifierCallInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_methodKind var_kind ;
  GALGAS_methodQualifier joker_43127_0 ; // Joker input parameter
  GALGAS_string joker_43130_0 ; // Joker input parameter
  var_selfTypeProxy.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1019)).method_searchKey (object->mAttribute_mModifierName, var_kind, var_routineSignature, var_hasCompilerArgument, joker_43127_0, joker_43130_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1019)) ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_43613 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_43613.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_43613.current_mType (HERE), enumerator_43613.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1034))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1034)) ;
...
static void categoryMethod_concatInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_45284 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_45284.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_45284.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1082)) ;
    enumerator_45284.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_expression ;
...
static void categoryMethod_plusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_48562 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_48562.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_48562.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1166)) ;
    enumerator_48562.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_49532 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_49567 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_49532.hasCurrentObject () && enumerator_49567.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_49532.current_mExpression (HERE).ptr (), enumerator_49567.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1182)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_49567.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_49532.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_string temp_3 ;
          const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_49567.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_4) {
            temp_3 = GALGAS_string (":") ;
          }else if (kBoolFalse == test_4) {
            temp_3 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_5 (enumerator_49532.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the selector should be '!").add_operation (enumerator_49567.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1189)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1189)).add_operation (temp_3, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1189)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1189))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1189)) ;
        }
        {
        routine_checkAssignmentTypes (enumerator_49567.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1191)), enumerator_49532.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1191)) ;
        }
        ...
        enumerator_49567.gotoNextObject () ;
      }
...
static void categoryMethod_plusEqualExpressionInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_51014 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_51014.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_51014.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1218)) ;
...
static void categoryMethod_selfPlusEqualElementsInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_actualOutputExpressionList enumerator_53571 (object->mAttribute_mExpressions, kEnumeration_up) ;
      cEnumerator_functionSignature enumerator_53606 (var_addAssignOperatorArguments, kEnumeration_up) ;
      while (enumerator_53571.hasCurrentObject () && enumerator_53606.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_exp ;
        callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_53571.current_mExpression (HERE).ptr (), enumerator_53606.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1273)) ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_53606.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_53571.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_string temp_4 ;
          const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_53606.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_5) {
            temp_4 = enumerator_53606.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1280)) ;
          }else if (kBoolFalse == test_5) {
            temp_4 = GALGAS_string::makeEmptyString () ;
          }
          GALGAS_location location_6 (enumerator_53571.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        {
        routine_checkAssignmentTypes (enumerator_53606.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1282)), enumerator_53571.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1282)) ;
        }
        ...
        enumerator_53606.gotoNextObject () ;
      }
...
static void categoryMethod_incrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_56462_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_56462_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1344)) ;
  }
  cEnumerator_lstringlist enumerator_56498 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_56498.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_56498.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1347)) ;
    enumerator_56498.gotoNextObject () ;
  }
...
static void categoryMethod_decrementInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_targetVariableCppName ;
  {
  GALGAS_string joker_58764_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_targetVariableCppName, joker_58764_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1399)) ;
  }
  cEnumerator_lstringlist enumerator_58800 (object->mAttribute_mStructAttributeList, kEnumeration_up) ;
  while (enumerator_58800.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_58800.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1402)) ;
    enumerator_58800.gotoNextObject () ;
  }
...
static void categoryMethod_logInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_logListAST enumerator_61827 (object->mAttribute_mLogList, kEnumeration_up) ;
  while (enumerator_61827.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_61827.current_mLogExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1480)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1479)) ;
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_logInstructionForGeneration::constructor_new (enumerator_61827.current_mLogMessage (HERE), var_expression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1486))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1486)) ;
    enumerator_61827.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_dropInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_62638 (object->mAttribute_mDropList, kEnumeration_up) ;
  while (enumerator_62638.hasCurrentObject ()) {
    GALGAS_string var_variableCppName ;
    GALGAS_unifiedTypeMapProxy var_t ;
    {
    GALGAS_string joker_62765_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForDropAccess (enumerator_62638.current_mValue (HERE), var_t, var_variableCppName, joker_62765_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1502)) ;
    }
    ...
    enumerator_62638.gotoNextObject () ;
  }
...
static void categoryMethod_enumeratedCollectionImplicitVarInExpAST_analyzeEnumeration (const cPtr_abstractEnumeratedCollectionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_69319 (var_enumerationDescriptorList, kEnumeration_up) ;
  while (enumerator_69319.hasCurrentObject ()) {
    ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_69319.current_mEnumeratedType (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.add_operation (enumerator_69319.current_mEnumerationName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1679)), object->mAttribute_mEndOfEnumerationExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1679)), outArgument_outEnumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1680)).add_operation (enumerator_69319.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1680)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1680)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1680))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1677)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_5) {
          ...
          cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_72055 (object->mAttribute_mElementList, kEnumeration_up) ;
          cEnumerator_enumerationDescriptorList enumerator_72089 (var_enumerationDescriptorList, kEnumeration_up) ;
          while (enumerator_72055.hasCurrentObject () && enumerator_72089.hasCurrentObject ()) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_72055.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1731)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_72055.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_72055.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1733)) ;
                const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_72089.current_mEnumeratedType (HERE))).boolEnum () ;
                if (kBoolTrue == test_10) {
                  GALGAS_location location_11 (enumerator_72055.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_11, GALGAS_string ("incorrect '@").add_operation (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)).add_operation (GALGAS_string ("' type: '@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)).add_operation (enumerator_72089.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)).add_operation (GALGAS_string ("' type required here"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1735)) ;
                }
              }
              ioArgument_ioLocalConstantListForDoBranch.addAssign_operation (enumerator_72089.current_mEnumeratedType (HERE), enumerator_72055.current_mConstantName (HERE), outArgument_outEnumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1738)).add_operation (enumerator_72089.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1738)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1738)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1738))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1738)) ;
            }
            enumerator_72055.gotoNextObject () ;
...
static void categoryMethod_forInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_forInstructionEnumeratedObjectListAST enumerator_76108 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_76108.hasCurrentObject ()) {
    GALGAS_string var_enumeratorCppName ;
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeEnumeration ((const cPtr_abstractEnumeratedCollectionAST *) enumerator_76108.current_mEnumeratedCollection (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_localConstantListForDoBranch, var_enumeratorCppName, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1828)) ;
    GALGAS_string temp_0 ;
    const enumGalgasBool test_1 = enumerator_76108.current_mAscending (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
    ...
    enumerator_76108.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_localInitializedVariableList enumerator_76658 (var_localConstantListForDoBranch, kEnumeration_up) ;
  while (enumerator_76658.hasCurrentObject ()) {
    {
    ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_76658.current_mName (HERE), enumerator_76658.current_mType (HERE), enumerator_76658.current_mCppName (HERE), enumerator_76658.current_mCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1846)) ;
    }
    enumerator_76658.gotoNextObject () ;
  }
...
static void categoryMethod_foreachInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_foreachInstructionEnumeratedObjectListAST enumerator_80371 (object->mAttribute_mEnumeratedObjectList, kEnumeration_up) ;
  while (enumerator_80371.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_enumerationExpression ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_80371.current_mEnumeratedExpression (HERE).ptr (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1958)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_enumerationExpression, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1957)) ;
    GALGAS_string var_enumerationOrder = enumerator_80371.current_mEnumerationOrder (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1964)) ;
    GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").add_operation (enumerator_80371.current_mEndOfEnumerationExpression (HERE).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1965)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1965)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1965)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        cEnumerator_stringlist enumerator_81400 (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1976)).reader_mEnumeratorVariants (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1976)), kEnumeration_up) ;
        bool bool_2 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1976)).isValidAndTrue () ;
        if (enumerator_81400.hasCurrentObject () && bool_2) {
          while (enumerator_81400.hasCurrentObject () && bool_2) {
            var_found = GALGAS_bool (kIsEqual, var_enumerationOrder.objectCompare (enumerator_81400.current_mValue (HERE))) ;
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  \\").add_operation (enumerator_81400.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1978))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1978)) ;
            enumerator_81400.gotoNextObject () ;
            if (enumerator_81400.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_80371.current_mEnumerationOrder (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_enumerationDescriptorList enumerator_81874 (var_currentTypedAttributeList, kEnumeration_up) ;
        while (enumerator_81874.hasCurrentObject ()) {
          {
          ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (GALGAS_lstring::constructor_new (enumerator_80371.current_mPrefix (HERE).mAttribute_string.add_operation (enumerator_81874.current_mEnumerationName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1989)), enumerator_80371.current_mEndOfEnumerationExpression (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1989)), enumerator_81874.current_mEnumeratedType (HERE), var_enumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1991)).add_operation (enumerator_81874.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1991)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1991)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1991)), var_enumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1992)).add_operation (enumerator_81874.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1992)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1992)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1992)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1988)) ;
          }
          enumerator_81874.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = enumerator_80371.current_mEndsWithEllipsis (HERE).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1995)).operator_and (GALGAS_bool (kIsNotEqual, enumerator_80371.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1995)).objectCompare (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1995)))) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 1995)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_9) {
            ...
            inCompiler->emitSemanticError (enumerator_80371.current_mEndOfElementList (HERE), GALGAS_string ("the '@").add_operation (var_enumerationExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2004)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2004)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2004)).add_operation (GALGAS_string ("' type requires "), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2004)).add_operation (var_enumerationDescriptorList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2005)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2005)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2004)).add_operation (GALGAS_string (" argument"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2005)).add_operation (temp_10, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2005)).add_operation (GALGAS_string (" or less for enumeration: this list provides "), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2006)).add_operation (enumerator_80371.current_mElementList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2008)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2008)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2007))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2003)) ;
          }else if (kBoolFalse == test_9) {
            cEnumerator_foreachInstructionEnumeratedObjectElementListAST enumerator_83216 (enumerator_80371.current_mElementList (HERE), kEnumeration_up) ;
            cEnumerator_enumerationDescriptorList enumerator_83250 (var_enumerationDescriptorList, kEnumeration_up) ;
            while (enumerator_83216.hasCurrentObject () && enumerator_83250.hasCurrentObject ()) {
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_83216.current_mConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2011)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_83216.current_mTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_13) {
                  GALGAS_unifiedTypeMapProxy var_foundType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_83216.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2013)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, var_foundType.objectCompare (enumerator_83250.current_mEnumeratedType (HERE))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    GALGAS_location location_15 (enumerator_83216.current_mTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_15, GALGAS_string ("incorrect '@").add_operation (var_foundType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)).add_operation (GALGAS_string ("' type: '@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)).add_operation (enumerator_83250.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)).add_operation (GALGAS_string ("' type required here"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2015)) ;
                  }
                }
                {
                ioArgument_ioVariableMap.modifier_insertUsedLocalConstant (enumerator_83216.current_mConstantName (HERE), enumerator_83250.current_mEnumeratedType (HERE), var_enumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2021)).add_operation (enumerator_83250.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2021)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2021)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2021)), var_enumeratorCppName.add_operation (GALGAS_string (".current_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2022)).add_operation (enumerator_83250.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2022)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2022)).add_operation (GALGAS_string (" (HERE)"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2022)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2018)) ;
                }
              }
              enumerator_83216.gotoNextObject () ;
              enumerator_83250.gotoNextObject () ;
            }
          }
        }
      }
    ...
    enumerator_80371.gotoNextObject () ;
  }
  GALGAS_semanticExpressionForGeneration var_uncheckedWhileExpression ;
...
static void categoryMethod_structuredCastInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_castInstructionBranchListAST enumerator_89058 (object->mAttribute_mCastInstructionBranchList, kEnumeration_up) ;
  while (enumerator_89058.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_89058.current_mTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2173)) ;
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2177)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2177)).isValid ()) {
      uint32_t variant_89335 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2177)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2177)).uintValue () ;
      bool loop_89335 = true ;
      while (loop_89335) {
        loop_89335 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).isValid () ;
        if (loop_89335) {
          loop_89335 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2178)).boolValue () ;
        }
        if (loop_89335 && (0 == variant_89335)) {
          loop_89335 = false ;
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_89058.current_mConstantVarName (HERE).mAttribute_string.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2189)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_localConstantName = GALGAS_string ("cast_").add_operation (enumerator_89058.current_mConstantVarName (HERE).reader_location (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)).add_operation (enumerator_89058.current_mConstantVarName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2190)) ;
      var_localConstantList.addAssign_operation (var_type, enumerator_89058.current_mConstantVarName (HERE), GALGAS_bool (true), var_localConstantName  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2191)) ;
    }else if (kBoolFalse == test_2) {
      var_localConstantName = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2204)), enumerator_89058.current_mInstructionList (HERE), enumerator_89058.current_mEndOfInstructions (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2201)) ;
    }
    var_castBranchList.addAssign_operation (enumerator_89058.current_mTypeComparisonKind (HERE), var_type, var_localConstantName, var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2210)) ;
    enumerator_89058.gotoNextObject () ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList ;
  {
...
static void categoryMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeGrammarInstructionSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  {
  GALGAS_string joker_93181_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForWriteAccess (object->mAttribute_mActualParameterName, var_type, var_cppName, joker_93181_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2275)) ;
  }
...
static void categoryMethod_grammarInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_bool joker_96632_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (object->mAttribute_mGrammarComponentName, var_grammarLabelMap, joker_96632_0, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2338)) ;
  ...
  cEnumerator_unifiedTypeMapProxyAndLocalVariableList enumerator_98595 (var_localVariableDeclarationList, kEnumeration_up) ;
  while (enumerator_98595.hasCurrentObject ()) {
    ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::constructor_new (enumerator_98595.current_mType (HERE), enumerator_98595.current_mLocalVariableName (HERE)  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2390))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2390)) ;
    enumerator_98595.gotoNextObject () ;
  }
...
static void categoryMethod_readAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_100305 (var_receiverType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2437)), kEnumeration_up) ;
    bool bool_1 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2437)).isValidAndTrue () ;
    if (enumerator_100305.hasCurrentObject () && bool_1) {
      while (enumerator_100305.hasCurrentObject () && bool_1) {
        var_found = GALGAS_bool (kIsEqual, enumerator_100305.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_100305.gotoNextObject () ;
        if (enumerator_100305.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_101426 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2461)), kEnumeration_up) ;
  while (enumerator_101426.hasCurrentObject ()) {
    var_localConstantList.addAssign_operation (enumerator_101426.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.add_operation (enumerator_101426.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2464)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2464)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2464)), GALGAS_bool (true), var_objectArrayCppName.add_operation (GALGAS_string ("->mAttribute_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2466)).add_operation (enumerator_101426.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2466)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2466))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2462)) ;
    enumerator_101426.gotoNextObject () ;
  }
...
static void categoryMethod_readWriteAccessWithInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  GALGAS_string var_receiverVariableCppName ;
  {
  GALGAS_string joker_104234_0 ; // Joker input parameter
  ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (object->mAttribute_mReceiverName, var_targetType, var_receiverVariableCppName, joker_104234_0, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2529)) ;
  }
  cEnumerator_lstringlist enumerator_104263 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_104263.hasCurrentObject ()) {
    ...
    var_attributeMap.method_searchKey (enumerator_104263.current_mValue (HERE), var_targetType, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2537)) ;
    enumerator_104263.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_4) {
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_mapSearchMethodListAST enumerator_104767 (var_targetType.reader_mMapSearchMethodList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2546)), kEnumeration_up) ;
    bool bool_5 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2546)).isValidAndTrue () ;
    if (enumerator_104767.hasCurrentObject () && bool_5) {
      while (enumerator_104767.hasCurrentObject () && bool_5) {
        var_found = GALGAS_bool (kIsEqual, enumerator_104767.current_mSearchMethodName (HERE).mAttribute_string.objectCompare (object->mAttribute_mSearchMethodNameForErrorSignaling.mAttribute_string)) ;
        enumerator_104767.gotoNextObject () ;
        if (enumerator_104767.hasCurrentObject ()) {
  ...
  cEnumerator_typedAttributeList enumerator_105296 (var_targetType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2557)), kEnumeration_up) ;
  while (enumerator_105296.hasCurrentObject ()) {
    var_localInitializedVariableList.addAssign_operation (enumerator_105296.current_mAttributeTypeProxy (HERE), GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.mAttribute_string.add_operation (enumerator_105296.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2560)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2560)), object->mAttribute_mEndOfReceiverExpression  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2560)), var_objectArrayCppName.add_operation (GALGAS_string ("->mAttribute_"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2561)).add_operation (enumerator_105296.current_mAttributeName (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2561)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2561))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2558)) ;
    enumerator_105296.gotoNextObject () ;
  }
...
static void categoryMethod_switchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_switchBranchesAST enumerator_108116 (object->mAttribute_mBranches, kEnumeration_up) ;
  while (enumerator_108116.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_108154 (enumerator_108116.current_mSwitchConstantList (HERE), kEnumeration_up) ;
    while (enumerator_108154.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantStringSet.reader_hasKey (enumerator_108154.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2632)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2632)).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_constantsNamedInSwitchInstruction.reader_hasKey (enumerator_108154.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2633)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2633)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_location location_3 (enumerator_108154.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").add_operation (enumerator_108154.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2635)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2635)).add_operation (GALGAS_string ("' constant is already named in this switch instruction"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2635))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2634)) ;
        }
        var_constantsNamedInSwitchInstruction.addAssign_operation (enumerator_108154.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2637))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2637)) ;
      }else if (kBoolFalse == test_1) {
        GALGAS_location location_4 (enumerator_108154.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("'").add_operation (enumerator_108154.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)).add_operation (GALGAS_string ("' is not a constant of '@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)).add_operation (var_switchExpression.reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640)).add_operation (GALGAS_string ("' enumeration type"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2640))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2639)) ;
      }
      enumerator_108154.gotoNextObject () ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2646)), GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2647)), enumerator_108116.current_mInstructions (HERE), enumerator_108116.current_mEndOfBranch (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2644)) ;
    }
    var_switchBranchesForGeneration.addAssign_operation (enumerator_108116.current_mSwitchConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2653)) ;
    enumerator_108116.gotoNextObject () ;
  }
  {
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_109294 (var_forgottenConstants, kEnumeration_up) ;
    while (enumerator_109294.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "  - ").add_operation (enumerator_109294.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2661))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2661)) ;
      enumerator_109294.gotoNextObject () ;
    }
...
static void categoryMethod_matchInstructionAST_analyzeSemanticInstruction (const cPtr_semanticInstructionAST * inObject,
  ...
  cEnumerator_matchInstructionBranchListAST enumerator_110983 (object->mAttribute_mMatchInstructionBranchList, kEnumeration_up) ;
  while (enumerator_110983.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2705)).objectCompare (enumerator_110983.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2705)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_semanticExpressionListForGeneration enumerator_111226 (var_expressionList, kEnumeration_up) ;
      cEnumerator_matchEntryListAST enumerator_111250 (enumerator_110983.current_mMatchEntryList (HERE), kEnumeration_up) ;
      while (enumerator_111226.hasCurrentObject () && enumerator_111250.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = enumerator_111226.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2707)) ;
        ...
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = enumerator_111250.current_mIsType (HERE).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_unifiedTypeMapProxy var_namedType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_111250.current_mTypeNameOrEnumerationConstantName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2710)) ;
            GALGAS_unifiedTypeMapProxy var_t = var_type ;
            ...
            if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2713)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2713)).isValid ()) {
              uint32_t variant_111627 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2713)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2713)).uintValue () ;
              bool loop_111627 = true ;
              while (loop_111627) {
                loop_111627 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).isValid () ;
                if (loop_111627) {
                  loop_111627 = var_found.operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).reader_isNull (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).operator_not (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)) COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2714)).boolValue () ;
                }
                if (loop_111627 && (0 == variant_111627)) {
                  loop_111627 = false ;
            ...
            if (kBoolTrue == test_4) {
              GALGAS_location location_5 (enumerator_111250.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_5, GALGAS_string ("the '@").add_operation (enumerator_111250.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720)).add_operation (GALGAS_string ("' is not a descendant of the '@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720)).add_operation (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720)).add_operation (GALGAS_string ("' type of the cast expression"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2720))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2719)) ;
            }else if (kBoolFalse == test_4) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, enumerator_111250.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2721)).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2721)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_6) {
                var_localConstantList.addAssign_operation (var_t, enumerator_111250.current_mLocalConstantName (HERE), GALGAS_bool (false), GALGAS_string ("match_instruction_constant_name")  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2722)) ;
              }
            }
          }else if (kBoolFalse == test_3) {
            GALGAS_location location_7 (enumerator_111250.current_mTypeNameOrEnumerationConstantName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("a type that inherits from '@").add_operation (enumerator_111226.current_mExpression (HERE).reader_mType (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2726)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2726)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2726)).add_operation (GALGAS_string ("' class is expected here"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2726))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2725)) ;
          }
          var_matchListForGeneration.addAssign_operation (GALGAS_bool (true), enumerator_111250.current_mTypeNameOrEnumerationConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2728)), enumerator_111250.current_mLocalConstantName (HERE).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2728))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2728)) ;
        }else if (kBoolFalse == test_2) {
        ...
        enumerator_111226.gotoNextObject () ;
        enumerator_111250.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_1) {
      inCompiler->emitSemanticError (enumerator_110983.current_mEndOfMatchEntryList (HERE), GALGAS_string ("this match list should contain ").add_operation (var_expressionList.reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2747)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2747)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2747)).add_operation (GALGAS_string (" elements, but it acually contains "), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2747)).add_operation (enumerator_110983.current_mMatchEntryList (HERE).reader_length (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2748)).reader_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2748)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2747))  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2746)) ;
    }
    GALGAS_semanticInstructionListForGeneration var_instructionList ;
    {
    routine_analyzeSemanticInstructionList (constinArgument_inAnalysisContext, var_localConstantList, GALGAS_localInitializedVariableList::constructor_emptyList (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2755)), enumerator_110983.current_mMatchBranchInstructionList (HERE), enumerator_110983.current_mEndOf_5F_instructionList (HERE), ioArgument_ioVariableMap, var_instructionList, inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 2752)) ;
    }
    ...
    enumerator_110983.gotoNextObject () ;
  }
...
static void categoryMethod_enumDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_15312 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_15312.hasCurrentObject ()) {
    var_constantList.addAssign_operation (enumerator_15312.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 338))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 338)) ;
    {
    var_constantMap.modifier_insertKey (enumerator_15312.current_mValue (HERE), var_constantMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 339)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 339)) ;
    }
    enumerator_15312.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("enum ").add_operation (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 343)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 343)), GALGAS_enumTypeForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 345)), var_constantList  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 344)), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 342)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_16812_3 ; // Joker input parameter
  GALGAS_bool joker_16812_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_16812_1 ; // Joker input parameter
  GALGAS_bool joker_16856_0 ; // Joker input parameter
  ...
  GALGAS_functionSignature joker_16914_10 ; // Joker input parameter
  ...
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_16812_3, joker_16812_2, joker_16812_1, var_typeKindEnum, joker_16856_0, var_listTypeAttributeList, joker_16914_20, joker_16914_19, joker_16914_18, joker_16914_17, joker_16914_16, joker_16914_15, joker_16914_14, joker_16914_13, joker_16914_12, joker_16914_11, joker_16914_10, joker_16914_9, joker_16914_8, joker_16914_7, joker_16914_6, joker_16914_5, joker_16914_4, joker_16914_3, joker_16914_2, joker_16914_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 375)) ;
...
static void categoryMethod_mapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_20196 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_20196.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_20196.current_mAttributeTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 471)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_20196.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 474)) ;
    const enumGalgasBool test_0 = function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 479)).reader_hasKey (enumerator_20196.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 479)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_m = GALGAS_string ("an attribute cannot be named:") ;
      cEnumerator_stringset enumerator_20591 (function_forbiddenKeysForMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 481)), kEnumeration_up) ;
      while (enumerator_20591.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" ").add_operation (enumerator_20591.current (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 482))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 482)) ;
        enumerator_20591.gotoNextObject () ;
      }
      var_m.dotAssign_operation (GALGAS_string ("; theses names are reserved")  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 484)) ;
      GALGAS_location location_1 (enumerator_20196.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, var_m  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 485)) ;
    }
    {
    var_attributeMap.modifier_insertKey (enumerator_20196.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 487)) ;
    }
  ...
  cEnumerator_insertMethodListAST enumerator_20869 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_20869.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_20869.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 492)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_20869.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 493)) ;
    }
    {
    routine_check_5F_K_5F_L_5F_escapeCharacters (enumerator_20869.current_mShadowErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 494)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_21145 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_21145.hasCurrentObject ()) {
    {
    var_searchMethodMap.modifier_insertKey (enumerator_21145.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 499)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_21145.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 500)) ;
    }
    enumerator_21145.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_21312 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_21312.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_21312.current_mMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 504)) ;
    }
    {
    routine_check_5F_K_5F_escapeCharacters (enumerator_21312.current_mErrorMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 505)) ;
    }
    enumerator_21312.gotoNextObject () ;
  }
  cEnumerator_insertOrReplaceDeclarationListAST enumerator_21532 (object->mAttribute_mInsertOrReplaceDeclarationListAST, kEnumeration_up) ;
  GALGAS_uint index_21490 ((uint32_t) 0) ;
  while (enumerator_21532.hasCurrentObject ()) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, index_21490.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticWarning (enumerator_21532.current_mInsertOrReplaceDeclarationLocation (HERE), GALGAS_string ("the 'insertOrReplace' modifier is already declared")  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 510)) ;
    }
    enumerator_21532.gotoNextObject () ;
    index_21490.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 508)) ;
  }
...
static void categoryMethod_uniqueMapDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_insertMethodListAST enumerator_23461 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_23461.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_23461.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 553)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_23461.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").add_operation (enumerator_23461.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 554)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 554)).add_operation (GALGAS_string ("' insert method should name an automaton state"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 554))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 554)) ;
      }else if (kBoolFalse == test_1) {
        var_initialStateSet.addAssign_operation (enumerator_23461.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 556))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 556)) ;
      }
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_23461.current_mInitialStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 558)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_23461.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").add_operation (enumerator_23461.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 559)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 559)).add_operation (GALGAS_string ("' insert method should not name an automaton state"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 559))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 559)) ;
      }
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_24044 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_24044.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_5) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_24044.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 566)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_24044.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").add_operation (enumerator_24044.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 567)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 567)).add_operation (GALGAS_string ("' search method should name an automaton action"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 567))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 567)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = var_mapAutomatonActionMap.reader_hasKey (enumerator_24044.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 568)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 568)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 568)).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
          var_mapAutomatonActionMap.modifier_insertKey (enumerator_24044.current_mActionName (HERE), var_mapAutomatonActionMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 570)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 570)) ;
          }
        }
      }
    }else if (kBoolFalse == test_5) {
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_24044.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 574)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_24044.current_mSearchMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").add_operation (enumerator_24044.current_mSearchMethodName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 575)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 575)).add_operation (GALGAS_string ("' search method should not name an automaton action"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 575))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 575)) ;
      }
    }
  ...
  cEnumerator_mapStateList enumerator_24837 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_24837.hasCurrentObject ()) {
    {
    var_mapAutomatonStateMap.modifier_insertKey (enumerator_24837.current_mStateName (HERE), var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 581)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 581)) ;
    }
    enumerator_24837.gotoNextObject () ;
  }
  cEnumerator_mapStateList enumerator_24954 (object->mAttribute_mMapStateList, kEnumeration_up) ;
  while (enumerator_24954.hasCurrentObject ()) {
    cEnumerator_mapStateTransitionList enumerator_24988 (enumerator_24954.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_24988.hasCurrentObject ()) {
      GALGAS_uint joker_25049_0 ; // Joker input parameter
      var_mapAutomatonStateMap.method_searchKey (enumerator_24988.current_mTargetStateName (HERE), joker_25049_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 585)) ;
  ...
  while (enumerator_25262.hasCurrentObject ()) {
    ...
    cEnumerator_mapStateTransitionList enumerator_25436 (enumerator_25262.current_mTransitionList (HERE), kEnumeration_up) ;
    while (enumerator_25436.hasCurrentObject ()) {
      GALGAS_uint var_actionIndex ;
      var_mapAutomatonActionMap.method_searchKey (enumerator_25436.current_mActionName (HERE), var_actionIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 596)) ;
      const enumGalgasBool test_11 = var_actionsForCurrentState.reader_hasKey (enumerator_25436.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 597)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 597)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_25436.current_mActionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").add_operation (enumerator_25436.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 598)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 598)).add_operation (GALGAS_string ("' action is already used for this state"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 598))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 598)) ;
      }
      var_actionsForCurrentState.addAssign_operation (enumerator_25436.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 600))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 600)) ;
      GALGAS_uint var_targetStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_25436.current_mTargetStateName (HERE), var_targetStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 602)) ;
      var_mapStateTransitionSortedList.addAssign_operation (var_actionIndex, enumerator_25436.current_mActionName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 605)), var_targetStateIndex, enumerator_25436.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 607)), enumerator_25436.current_mTransitionMessageKind (HERE), enumerator_25436.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 609))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 603)) ;
      enumerator_25436.gotoNextObject () ;
    }
    GALGAS_uint var_stateIndex ;
    var_mapAutomatonStateMap.method_searchKey (enumerator_25262.current_mStateName (HERE), var_stateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 612)) ;
    var_mapStateSortedList.addAssign_operation (var_stateIndex, enumerator_25262.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 615)), enumerator_25262.current_mStateMessageKind (HERE), enumerator_25262.current_mStateMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 617)), var_mapStateTransitionSortedList  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 613)) ;
    ...
    if (kBoolTrue == test_13) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_26490 (var_missingActions, kEnumeration_up) ;
      while (enumerator_26490.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").add_operation (enumerator_26490.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 623)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 623))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 623)) ;
      ...
      GALGAS_location location_14 (enumerator_25262.current_mStateName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.galgas", 632)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 632)).isValid ()) {
    uint32_t variant_26791 = object->mAttribute_mMapStateList.reader_length (SOURCE_FILE ("semanticAnalysis.galgas", 632)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 632)).uintValue () ;
    bool loop_26791 = true ;
    while (loop_26791) {
      loop_26791 = var_progress.isValid () ;
      if (loop_26791) {
        loop_26791 = var_progress.boolValue () ;
      }
      if (loop_26791 && (0 == variant_26791)) {
        loop_26791 = false ;
      ...
      if (loop_26791) {
        ...
        cEnumerator_mapStateList enumerator_26888 (object->mAttribute_mMapStateList, kEnumeration_up) ;
        while (enumerator_26888.hasCurrentObject ()) {
          const enumGalgasBool test_15 = var_accessibleStates.reader_hasKey (enumerator_26888.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 635)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 635)).boolEnum () ;
          if (kBoolTrue == test_15) {
            cEnumerator_mapStateTransitionList enumerator_26987 (enumerator_26888.current_mTransitionList (HERE), kEnumeration_up) ;
            while (enumerator_26987.hasCurrentObject ()) {
              const enumGalgasBool test_16 = var_accessibleStates.reader_hasKey (enumerator_26987.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 637)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 637)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 637)).boolEnum () ;
              if (kBoolTrue == test_16) {
                var_accessibleStates.addAssign_operation (enumerator_26987.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 638))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 638)) ;
                var_progress = GALGAS_bool (true) ;
              }
              enumerator_26987.gotoNextObject () ;
            }
          }
          enumerator_26888.gotoNextObject () ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_17) {
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_stringset enumerator_27368 (var_uselessStates, kEnumeration_up) ;
    while (enumerator_27368.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("'").add_operation (enumerator_27368.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 649)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 649))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 649)) ;
      if (enumerator_27368.hasNextObject ()) {
  ...
  cEnumerator_mapAutomatonStateMap enumerator_27736 (var_mapAutomatonStateMap, kEnumeration_up) ;
  while (enumerator_27736.hasCurrentObject ()) {
    ...
    var_reachableStates.addAssign_operation (enumerator_27736.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 660))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 660)) ;
    GALGAS_bool var_progress = GALGAS_bool (true) ;
    if (var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 662)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 662)).isValid ()) {
      uint32_t variant_27859 = var_mapAutomatonStateMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 662)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 662)).uintValue () ;
      bool loop_27859 = true ;
      while (loop_27859) {
        loop_27859 = var_progress.isValid () ;
        if (loop_27859) {
          loop_27859 = var_progress.boolValue () ;
        }
        if (loop_27859 && (0 == variant_27859)) {
          loop_27859 = false ;
        ...
        if (loop_27859) {
          variant_27859 -- ;
          var_progress = GALGAS_bool (false) ;
          cEnumerator_mapStateList enumerator_27966 (object->mAttribute_mMapStateList, kEnumeration_up) ;
          while (enumerator_27966.hasCurrentObject ()) {
            const enumGalgasBool test_18 = var_reachableStates.reader_hasKey (enumerator_27966.current_mStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 665)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 665)).boolEnum () ;
            if (kBoolTrue == test_18) {
              cEnumerator_mapStateTransitionList enumerator_28068 (enumerator_27966.current_mTransitionList (HERE), kEnumeration_up) ;
              while (enumerator_28068.hasCurrentObject ()) {
                const enumGalgasBool test_19 = var_reachableStates.reader_hasKey (enumerator_28068.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 667)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 667)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 667)).boolEnum () ;
                if (kBoolTrue == test_19) {
                  var_reachableStates.addAssign_operation (enumerator_28068.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 668))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 668)) ;
                  var_accessibilityGraph.addAssign_operation (enumerator_27736.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 669)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 669)).add_operation (enumerator_28068.current_mTargetStateName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 669)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 669))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 669)) ;
                  var_progress = GALGAS_bool (true) ;
                }
    ...
    cEnumerator_stringset enumerator_28413 (var_reachableStates, kEnumeration_up) ;
    while (enumerator_28413.hasCurrentObject ()) {
      const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_27736.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 677)).objectCompare (enumerator_28413.current_key (HERE))).boolEnum () ;
      if (kBoolTrue == test_20) {
        var_neededAssociations.addAssign_operation (enumerator_27736.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 678)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 678)).add_operation (enumerator_28413.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 678))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 678)) ;
      }
      enumerator_28413.gotoNextObject () ;
    }
  ...
  cEnumerator_mapOverrideBlockListAST enumerator_28627 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
  while (enumerator_28627.hasCurrentObject ()) {
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_28887 (enumerator_28627.current_mMapOverrideBlockDescriptor_31_AST (HERE), kEnumeration_up) ;
    while (enumerator_28887.hasCurrentObject ()) {
      GALGAS_uint var_startStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_28887.current_mLeftState (HERE), var_startStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 690)) ;
      GALGAS_uint var_currentStateNameIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_28887.current_mRightState (HERE), var_currentStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 692)) ;
      GALGAS_string var_association = enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 693)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 693)).add_operation (enumerator_28887.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 693)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 693)) ;
      ...
      if (kBoolTrue == test_21) {
        GALGAS_location location_22 (enumerator_28887.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_23) {
        GALGAS_location location_24 (enumerator_28887.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_28887.current_mResultingState (HERE), var_finalStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 703)) ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 704)).objectCompare (enumerator_28887.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 704)))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_neededCombinaisons.addAssign_operation (enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 705)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 705)).add_operation (enumerator_28887.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 705)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 705))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 705)) ;
        var_neededCombinaisons.addAssign_operation (enumerator_28887.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 706)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 706)).add_operation (enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 706)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 706))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 706)) ;
        const enumGalgasBool test_26 = var_accessibilityGraph.reader_hasKey (enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 707)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 707)).add_operation (enumerator_28887.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 707)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 707)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 707)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 707)).boolEnum () ;
        if (kBoolTrue == test_26) {
          GALGAS_location location_27 (enumerator_28887.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_27, GALGAS_string ("the '").add_operation (enumerator_28887.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 709)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 709)).add_operation (GALGAS_string ("' state is not reachable from '"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 709)).add_operation (enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 709)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 709)).add_operation (GALGAS_string ("' state"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 709))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 708)) ;
        }
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_28887.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 712)) ;
      }
      var_branchBehaviourSortedListForMapOverride_31_.addAssign_operation (var_startStateNameIndex, enumerator_28887.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 715)), var_currentStateNameIndex, enumerator_28887.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 717)), var_finalStateNameIndex, enumerator_28887.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 719)), enumerator_28887.current_mMessageKind (HERE), enumerator_28887.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 721))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 713)) ;
    ...
    if (kBoolTrue == test_28) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_30665 (var_forgottenAssociations, kEnumeration_up) ;
      while (enumerator_30665.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").add_operation (enumerator_30665.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 727))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 727)) ;
    ...
    cEnumerator_mapOverrideBlockDescriptorAST enumerator_31029 (enumerator_28627.current_mMapOverrideBlockDescriptor_32_AST (HERE), kEnumeration_up) ;
    while (enumerator_31029.hasCurrentObject ()) {
      GALGAS_uint var_leftStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_31029.current_mLeftState (HERE), var_leftStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 735)) ;
      GALGAS_uint var_rightStateIndex ;
      var_mapAutomatonStateMap.method_searchKey (enumerator_31029.current_mRightState (HERE), var_rightStateIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 737)) ;
      GALGAS_string var_combinaison = enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 738)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 738)).add_operation (enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 738)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 738)) ;
      ...
      if (kBoolTrue == test_29) {
        GALGAS_location location_30 (enumerator_31029.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_30, GALGAS_string ("the '").add_operation (enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 741)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 741)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 741)).add_operation (enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 741)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 741)).add_operation (GALGAS_string ("' combinaison is useless"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 741))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 740)) ;
      }
      ...
      if (kBoolTrue == test_31) {
        GALGAS_location location_32 (enumerator_31029.current_mRightState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_32, GALGAS_string ("the '").add_operation (enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 745)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 745)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 745)).add_operation (enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 745)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 745)).add_operation (GALGAS_string ("' combinaison is already defined"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 745))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 744)) ;
      }
      ...
      var_mapAutomatonStateMap.method_searchKey (enumerator_31029.current_mResultingState (HERE), var_resultingStateNameIndex, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 749)) ;
      const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 750)).objectCompare (enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 750)))).operator_and (GALGAS_bool (kIsNotEqual, enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 751)).objectCompare (enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 751)))) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 750)).operator_and (var_accessibilityGraph.reader_hasKey (enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 752)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 752)).add_operation (enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 752)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 752)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 752)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 752)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 751)).boolEnum () ;
      if (kBoolTrue == test_33) {
        GALGAS_location location_34 (enumerator_31029.current_mResultingState (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_34, GALGAS_string ("the '").add_operation (enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 754)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 754)).add_operation (GALGAS_string ("' state cannot be reached from the '"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 754)).add_operation (enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 754)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 754)).add_operation (GALGAS_string ("' state"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 754))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 753)) ;
      }
      {
      routine_check_5F_K_5F_escapeCharacters (enumerator_31029.current_mTransitionMessage (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 756)) ;
      }
      const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_31029.current_mMessageKind (HERE).objectCompare (GALGAS_mapAutomatonMessageKind::constructor_noMessage (SOURCE_FILE ("semanticAnalysis.galgas", 757)))).boolEnum () ;
      if (kBoolTrue == test_35) {
        var_definedCombinaisons.addAssign_operation (enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 758)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 758)).add_operation (enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 758)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 758))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 758)) ;
        var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_rightStateIndex, enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 761)), var_leftStateIndex, enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 763)), var_resultingStateNameIndex, enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 765)), enumerator_31029.current_mMessageKind (HERE), enumerator_31029.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 767))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 759)) ;
      }
      var_branchBehaviourSortedListForMapOverride_32_.addAssign_operation (var_leftStateIndex, enumerator_31029.current_mLeftState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 771)), var_rightStateIndex, enumerator_31029.current_mRightState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 773)), var_resultingStateNameIndex, enumerator_31029.current_mResultingState (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 775)), enumerator_31029.current_mMessageKind (HERE), enumerator_31029.current_mTransitionMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 777))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 769)) ;
      enumerator_31029.gotoNextObject () ;
    }
    ...
    if (kBoolTrue == test_36) {
      ...
      if (kBoolTrue == test_37) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_33273 (var_forgottenCombinaisons, kEnumeration_up) ;
        while (enumerator_33273.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_33273.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 784))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 784)) ;
    ...
    var_mapOverrideList.addAssign_operation (enumerator_28627.current_mOverrideBlockName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 790)), var_branchBehaviourSortedListForMapOverride_31_, var_branchBehaviourSortedListForMapOverride_32_  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 789)) ;
  ...
  cEnumerator_attributeInCollectionListAST enumerator_33763 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_33763.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_33763.current_mAttributeTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 798)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_t, enumerator_33763.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 801)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_33763.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 806)) ;
    }
  ...
  cEnumerator_insertMethodListAST enumerator_34169 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_34169.hasCurrentObject ()) {
    {
    var_insertMethodMap.modifier_insertKey (enumerator_34169.current_mInsertMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 811)) ;
    }
    cEnumerator_stringlist enumerator_34363 (enumerator_34169.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 813)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 813)), kEnumeration_up) ;
    while (enumerator_34363.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_34363.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 814)) ;
      {
      GALGAS_string joker_34476_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_34476_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 815)) ;
      }
      cEnumerator_stringlist enumerator_34509 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_34509.hasCurrentObject ()) {
        const enumGalgasBool test_38 = GALGAS_bool (kIsStrictSup, enumerator_34509.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.galgas", 817)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_38) {
          GALGAS_char var_c = enumerator_34509.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 818)) ;
          ...
          if (kBoolTrue == test_39) {
            GALGAS_location location_40 (enumerator_34169.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_34509.gotoNextObject () ;
      }
      enumerator_34363.gotoNextObject () ;
    }
    cEnumerator_stringlist enumerator_34954 (enumerator_34169.current_mShadowErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 826)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 826)), kEnumeration_up) ;
    while (enumerator_34954.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_34954.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 827)) ;
      {
      GALGAS_string joker_35067_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35067_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 828)) ;
      }
      cEnumerator_stringlist enumerator_35100 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35100.hasCurrentObject ()) {
        const enumGalgasBool test_41 = GALGAS_bool (kIsStrictSup, enumerator_35100.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.galgas", 830)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_41) {
          GALGAS_char var_c = enumerator_35100.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 831)) ;
          ...
          if (kBoolTrue == test_42) {
            GALGAS_location location_43 (enumerator_34169.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_34954.gotoNextObject () ;
    }
    enumerator_34169.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_35507 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_35507.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_35507.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 843)) ;
      }
    }else if (kBoolFalse == test_44) {
      {
      var_searchMethodMap.modifier_insertKey (enumerator_35507.current_mSearchMethodName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 845)) ;
      }
    }
    cEnumerator_stringlist enumerator_35815 (enumerator_35507.current_mErrorMessage (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 848)).reader_componentsSeparatedByString (GALGAS_string ("%%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 848)), kEnumeration_up) ;
    while (enumerator_35815.hasCurrentObject ()) {
      GALGAS_stringlist var_explodedArray = enumerator_35815.current_mValue (HERE).reader_componentsSeparatedByString (GALGAS_string ("%") COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 849)) ;
      {
      GALGAS_string joker_35928_0 ; // Joker input parameter
      var_explodedArray.modifier_popFirst (joker_35928_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 850)) ;
      }
      cEnumerator_stringlist enumerator_35961 (var_explodedArray, kEnumeration_up) ;
      while (enumerator_35961.hasCurrentObject ()) {
        const enumGalgasBool test_45 = GALGAS_bool (kIsStrictSup, enumerator_35961.current_mValue (HERE).reader_length (SOURCE_FILE ("semanticAnalysis.galgas", 852)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_45) {
          GALGAS_char var_c = enumerator_35961.current_mValue (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 853)) ;
          const enumGalgasBool test_46 = GALGAS_bool (kIsNotEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (75)))).boolEnum () ;
          if (kBoolTrue == test_46) {
            GALGAS_location location_47 (enumerator_35507.current_mErrorMessage (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_35961.gotoNextObject () ;
      }
      enumerator_35815.gotoNextObject () ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_37472_7 ; // Joker input parameter
  GALGAS_bool joker_37472_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_37472_5 ; // Joker input parameter
  GALGAS_typeKindEnum joker_37472_4 ; // Joker input parameter
  GALGAS_bool joker_37472_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_37472_2 ; // Joker input parameter
  GALGAS_attributeMap joker_37472_1 ; // Joker input parameter
  GALGAS_constructorMap joker_37531_11 ; // Joker input parameter
  GALGAS_readerMap joker_37531_10 ; // Joker input parameter
  GALGAS_modifierMap joker_37531_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_37531_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_37531_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_37531_6 ; // Joker input parameter
  GALGAS_stringlist joker_37531_5 ; // Joker input parameter
  GALGAS_uint joker_37531_4 ; // Joker input parameter
  GALGAS_functionSignature joker_37531_3 ; // Joker input parameter
  GALGAS_stringset joker_37531_2 ; // Joker input parameter
  GALGAS_lstringlist joker_37531_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_37590_6 ; // Joker input parameter
  GALGAS_bool joker_37590_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_37590_4 ; // Joker input parameter
  GALGAS_string joker_37590_3 ; // Joker input parameter
  GALGAS_string joker_37590_2 ; // Joker input parameter
  GALGAS_headerKind joker_37590_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_37472_7, joker_37472_6, joker_37472_5, joker_37472_4, joker_37472_3, joker_37472_2, joker_37472_1, var_listTypeAttributeList, joker_37531_11, joker_37531_10, joker_37531_9, joker_37531_8, joker_37531_7, joker_37531_6, joker_37531_5, joker_37531_4, joker_37531_3, joker_37531_2, joker_37531_1, var_searchMethodList, joker_37590_6, joker_37590_5, joker_37590_4, joker_37590_3, joker_37590_2, joker_37590_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 894)) ;
...
static void categoryMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_43242 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_43242.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_43242.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_43242.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1030)), enumerator_43242.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1031)), enumerator_43242.current_mFormalArgumentName (HERE), enumerator_43242.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1028)) ;
    enumerator_43242.gotoNextObject () ;
  }
...
static void categoryMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_44263 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_44263.hasCurrentObject ()) {
    var_formalArgumentList.addAssign_operation (enumerator_44263.current_mFormalSelector (HERE), enumerator_44263.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_44263.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1057)), enumerator_44263.current_mFormalArgumentName (HERE), enumerator_44263.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1059))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1054)) ;
    enumerator_44263.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_46952 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_46952.hasCurrentObject ()) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_46952.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1129)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          const enumGalgasBool test_3 = var_generatedInSeparateFileFeature.boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_46952.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_5 (enumerator_46952.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_lstringlist enumerator_47579 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
      while (enumerator_47579.hasCurrentObject ()) {
        GALGAS_location location_7 (enumerator_47579.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        enumerator_47579.gotoNextObject () ;
      }
    }
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_47849 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_47849.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_47849.current_mAttributeTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1152)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_48030 (enumerator_47849.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_48030.hasCurrentObject ()) {
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_48030.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1156)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        const enumGalgasBool test_9 = var_hasSetter.boolEnum () ;
        if (kBoolTrue == test_9) {
          GALGAS_location location_10 (enumerator_48030.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_48030.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1161)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_11) {
          const enumGalgasBool test_12 = var_hasGetter.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1162)).boolEnum () ;
          if (kBoolTrue == test_12) {
            GALGAS_location location_13 (enumerator_48030.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          GALGAS_location location_14 (enumerator_48030.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_48030.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_t, enumerator_47849.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1170)) ;
    var_allAttributeList.addAssign_operation (var_t, enumerator_47849.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1175)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_47849.current_mAttributeName (HERE), var_t, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1180)) ;
    }
    enumerator_47849.gotoNextObject () ;
  }
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1185)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1185)).isValid ()) {
    uint32_t variant_48880 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1185)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1185)).uintValue () ;
    bool loop_48880 = true ;
    while (loop_48880) {
      loop_48880 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1186)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1186)).isValid () ;
      if (loop_48880) {
        loop_48880 = var_t.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1186)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1186)).boolValue () ;
      }
      if (loop_48880 && (0 == variant_48880)) {
        loop_48880 = false ;
...
static void categoryMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_formalInputParameterListForGeneration joker_54915_0 ; // Joker input parameter
  routine_analyzeFunctionBody (var_analysisContext, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1341)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1342)), GALGAS_string::makeEmptyString (), object->mAttribute_mFunctionInstructionList, object->mAttribute_mResultVariableName, object->mAttribute_mResultTypeName, object->mAttribute_mEndOfFunctionInstructionList, joker_54915_0, var_returnType, var_resultVariableCppName, var_semanticInstructionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1339)) ;
  }
...
static void categoryMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring joker_56074_0 ; // Joker input parameter
  GALGAS_lstringlist joker_56081_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_56178_2 ; // Joker input parameter
  GALGAS_bool joker_56178_1 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_56074_0, joker_56081_0, var_wrapperFileMap, var_wrapperDirectoryMap, joker_56178_2, joker_56178_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1377)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_filewrapperTemplateListAST enumerator_56802 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
    while (enumerator_56802.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_56802.current_mFilewrapperTemplatePath (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1398)).reader_firstCharacterOrNul (SOURCE_FILE ("semanticAnalysis.galgas", 1398)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_56802.current_mFilewrapperTemplatePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      cEnumerator_formalTemplateInputParameterListAST enumerator_57599 (enumerator_56802.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
      while (enumerator_57599.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_57599.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1409)) ;
        GALGAS_string var_cppVarName = GALGAS_string ("in_").add_operation (enumerator_57599.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1410)).reader_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1410)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1410)) ;
        {
        var_templateVariableMap.modifier_insertKey (enumerator_57599.current_mFormalArgumentName (HERE), var_type, var_cppVarName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1411)) ;
        }
        var_filewrapperTemplateFormalInputParameters.addAssign_operation (enumerator_57599.current_mFormalTemplateSelector (HERE), var_type, var_cppVarName, enumerator_57599.current_mFormalArgumentName (HERE), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1412)) ;
        enumerator_57599.gotoNextObject () ;
      }
      ...
      enumerator_56802.gotoNextObject () ;
    }
...
static void categoryMethod_abstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_60121 (object->mAttribute_mAbstractCategoryMethodFormalParameterList, kEnumeration_up) ;
  while (enumerator_60121.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_60121.current_mFormalSelector (HERE), enumerator_60121.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_60121.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1462)), enumerator_60121.current_mFormalArgumentName (HERE), enumerator_60121.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1464))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1459)) ;
...
static void categoryMethod_overridingCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1555)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1555)).isValid ()) {
    uint32_t variant_63848 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1555)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1555)).uintValue () ;
    bool loop_63848 = true ;
    while (loop_63848) {
      loop_63848 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1556)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1556)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1556)).isValid () ;
      if (loop_63848) {
        loop_63848 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1556)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1556)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1556)).boolValue () ;
      }
      if (loop_63848 && (0 == variant_63848)) {
        loop_63848 = false ;
      ...
      if (loop_63848) {
        ...
        if (kBoolTrue == test_2) {
          ...
          GALGAS_methodKind joker_64154_0 ; // Joker input parameter
          GALGAS_bool joker_64207_0 ; // Joker input parameter
          GALGAS_string joker_64221_0 ; // Joker input parameter
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1559)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_64154_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_64207_0, var_qualifier, joker_64221_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1559)) ;
...
static void categoryMethod_overridingAbstractCategoryMethodAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1636)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1636)).isValid ()) {
    uint32_t variant_67254 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1636)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1636)).uintValue () ;
    bool loop_67254 = true ;
    while (loop_67254) {
      loop_67254 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1637)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1637)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1637)).isValid () ;
      if (loop_67254) {
        loop_67254 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1637)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1637)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1637)).boolValue () ;
      }
      if (loop_67254 && (0 == variant_67254)) {
        loop_67254 = false ;
      ...
      if (loop_67254) {
        ...
        if (kBoolTrue == test_4) {
          ...
          var_superType.reader_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)).method_searchKey (object->mAttribute_mOverridingCategoryMethodName, joker_67560_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_67613_0, var_qualifier, joker_67627_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)) ;
...
static void categoryMethod_abstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_69502 (object->mAttribute_mAbstractCategoryModifierFormalParameterList, kEnumeration_up) ;
  while (enumerator_69502.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_69502.current_mFormalSelector (HERE), enumerator_69502.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_69502.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1690)), enumerator_69502.current_mFormalArgumentName (HERE), enumerator_69502.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1692))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1687)) ;
...
static void categoryMethod_overridingCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1780)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1780)).isValid ()) {
    uint32_t variant_73057 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1780)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1780)).uintValue () ;
    bool loop_73057 = true ;
    while (loop_73057) {
      loop_73057 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1781)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1781)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1781)).isValid () ;
      if (loop_73057) {
        loop_73057 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1781)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1781)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1781)).boolValue () ;
      }
      if (loop_73057 && (0 == variant_73057)) {
        loop_73057 = false ;
      ...
      if (loop_73057) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_73355_0 ; // Joker input parameter
          GALGAS_bool joker_73378_0 ; // Joker input parameter
          GALGAS_string joker_73392_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1784)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_73355_0, var_inheritedSignature, joker_73378_0, var_qualifier, joker_73392_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1784)) ;
...
static void categoryMethod_overridingAbstractCategoryModifierAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1858)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1858)).isValid ()) {
    uint32_t variant_76255 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 1858)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1858)).uintValue () ;
    bool loop_76255 = true ;
    while (loop_76255) {
      loop_76255 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1859)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1859)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1859)).isValid () ;
      if (loop_76255) {
        loop_76255 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 1859)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1859)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1859)).boolValue () ;
      }
      if (loop_76255 && (0 == variant_76255)) {
        loop_76255 = false ;
      ...
      if (loop_76255) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_76553_0 ; // Joker input parameter
          GALGAS_bool joker_76576_0 ; // Joker input parameter
          GALGAS_string joker_76590_0 ; // Joker input parameter
          var_superType.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1862)).method_searchKey (object->mAttribute_mOverridingCategoryModifierName, joker_76553_0, var_inheritedSignature, joker_76576_0, var_qualifier, joker_76590_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1862)) ;
...
static void categoryMethod_abstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_78469 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
  while (enumerator_78469.hasCurrentObject ()) {
    var_formalParameterListForGeneration.addAssign_operation (enumerator_78469.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_78469.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1911)), enumerator_78469.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 1912)), enumerator_78469.current_mFormalArgumentName (HERE), enumerator_78469.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1909)) ;
    enumerator_78469.gotoNextObject () ;
  }
...
static void categoryMethod_overridingCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 2015)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2015)).isValid ()) {
    uint32_t variant_82542 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 2015)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2015)).uintValue () ;
    bool loop_82542 = true ;
    while (loop_82542) {
      loop_82542 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 2016)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 2016)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2016)).isValid () ;
      if (loop_82542) {
        loop_82542 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 2016)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 2016)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2016)).boolValue () ;
      }
      if (loop_82542 && (0 == variant_82542)) {
        loop_82542 = false ;
      ...
      if (loop_82542) {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_82815_0 ; // Joker input parameter
          GALGAS_bool joker_82892_0 ; // Joker input parameter
          GALGAS_string joker_82972_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2018)).method_searchKey (object->mAttribute_mOverridingCategoryReaderName, joker_82815_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_82892_0, var_inheritedReturnType, var_qualifier, joker_82972_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2018)) ;
...
static void categoryMethod_overridingAbstractCategoryReaderAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 2111)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2111)).isValid ()) {
    uint32_t variant_86325 = constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticAnalysis.galgas", 2111)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2111)).uintValue () ;
    bool loop_86325 = true ;
    while (loop_86325) {
      loop_86325 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 2112)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 2112)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2112)).isValid () ;
      if (loop_86325) {
        loop_86325 = var_superType.reader_isNull (SOURCE_FILE ("semanticAnalysis.galgas", 2112)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 2112)).operator_and (GALGAS_bool (kIsEqual, var_baseTypeName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2112)).boolValue () ;
      }
      if (loop_86325 && (0 == variant_86325)) {
        loop_86325 = false ;
      ...
      if (loop_86325) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_methodQualifier var_qualifier ;
          GALGAS_methodKind joker_86627_0 ; // Joker input parameter
          GALGAS_bool joker_86704_0 ; // Joker input parameter
          GALGAS_string joker_86763_0 ; // Joker input parameter
          var_superType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2115)).method_searchKey (object->mAttribute_mAbstractCategoryReaderName, joker_86627_0, var_inheritedSignature, var_inheritedDeclarationLocation, joker_86704_0, var_inheritedReturnType, var_qualifier, joker_86763_0, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2115)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_formalInputParameterListAST enumerator_87258 (object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, kEnumeration_up) ;
    while (enumerator_87258.hasCurrentObject ()) {
      var_formalParameterListForGeneration.addAssign_operation (enumerator_87258.current_mFormalSelector (HERE), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_87258.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2140)), enumerator_87258.current_mFormalArgumentName (HERE).reader_string (SOURCE_FILE ("semanticAnalysis.galgas", 2141)), enumerator_87258.current_mFormalArgumentName (HERE), enumerator_87258.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 2138)) ;
      enumerator_87258.gotoNextObject () ;
    }
    {
