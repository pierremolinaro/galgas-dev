...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_declaration_i0_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_lexique COMMA_SOURCE_FILE ("lexique-component.galgas", 737)) ;
  GALGAS_lstring var_lexiqueComponentName_26954 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 739)) ;
  GALGAS_lstring var_indexingDirectory_27014 ;
  switch (select_galgas_34_LexiqueComponentSyntax_0 (inCompiler)) {
  case 1: {
    var_indexingDirectory_27014 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("lexique-component.galgas", 743)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_indexing COMMA_SOURCE_FILE ("lexique-component.galgas", 745)) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_in COMMA_SOURCE_FILE ("lexique-component.galgas", 746)) ;
    var_indexingDirectory_27014 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 747)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7B_ COMMA_SOURCE_FILE ("lexique-component.galgas", 749)) ;
  GALGAS_templateDelimitorListAST var_templateDelimitorList_27234 = GALGAS_templateDelimitorListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 751)) ;
  GALGAS_templateReplacementListAST var_templateReplacementList_27299 = GALGAS_templateReplacementListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 752)) ;
  GALGAS_lexicalAttributeListAST var_lexicalAttributeList_27358 = GALGAS_lexicalAttributeListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 753)) ;
  GALGAS_lexicalStyleListAST var_lexicalStyleList_27409 = GALGAS_lexicalStyleListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 754)) ;
  GALGAS_terminalDeclarationListAST var_terminalDeclarationList_27474 = GALGAS_terminalDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 755)) ;
  GALGAS_lexicalMessageDeclarationListAST var_lexicalMessageDeclarationList_27551 = GALGAS_lexicalMessageDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 756)) ;
  GALGAS_lexicalListDeclarationListAST var_lexicalListDeclarationList_27622 = GALGAS_lexicalListDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 757)) ;
  GALGAS_lexicalRuleListAST var_lexicalRuleList_27671 = GALGAS_lexicalRuleListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 758)) ;
  GALGAS_externRoutineListAST var_externRoutineList_27724 = GALGAS_externRoutineListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 759)) ;
  GALGAS_externFunctionListAST var_externFunctionList_27779 = GALGAS_externFunctionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 760)) ;
  GALGAS_indexingListAST var_indexingListAST_27825 = GALGAS_indexingListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 761)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_1 (inCompiler)) {
    case 2: {
      nt_extern_5F_routine_5F_declaration_ (var_externRoutineList_27724, inCompiler) ;
    } break ;
    case 3: {
      nt_extern_5F_function_5F_declaration_ (var_externFunctionList_27779, inCompiler) ;
    } break ;
    case 4: {
      nt_template_5F_delimitor_ (var_templateDelimitorList_27234, inCompiler) ;
    } break ;
    case 5: {
      nt_template_5F_replacement_ (var_templateReplacementList_27299, inCompiler) ;
    } break ;
    case 6: {
      nt_lexical_5F_attribute_5F_declaration_ (var_lexicalAttributeList_27358, inCompiler) ;
    } break ;
    case 7: {
      nt_style_5F_declaration_ (var_lexicalStyleList_27409, inCompiler) ;
    } break ;
    case 8: {
      nt_terminal_5F_declaration_ (var_terminalDeclarationList_27474, inCompiler) ;
    } break ;
    case 9: {
      nt_lexical_5F_list_5F_declaration_ (var_lexicalListDeclarationList_27622, inCompiler) ;
    } break ;
    case 10: {
      nt_lexical_5F_explicit_5F_rule_ (var_lexicalRuleList_27671, inCompiler) ;
    } break ;
    case 11: {
      nt_lexical_5F_implicit_5F_rule_ (var_lexicalRuleList_27671, inCompiler) ;
    } break ;
    case 12: {
      nt_lexical_5F_message_5F_declaration_ (var_lexicalMessageDeclarationList_27551, inCompiler) ;
    } break ;
    case 13: {
      nt_lexical_5F_indexing_5F_declaration_ (var_indexingListAST_27825, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("lexique-component.galgas", 791)) ;
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssign_operation (GALGAS_lexiqueComponentAST::constructor_new (GALGAS_bool (false), var_lexiqueComponentName_26954, GALGAS_bool (false), var_templateDelimitorList_27234, var_templateReplacementList_27299, var_lexicalAttributeList_27358, var_lexicalStyleList_27409, var_terminalDeclarationList_27474, var_lexicalMessageDeclarationList_27551, var_lexicalListDeclarationList_27622, var_lexicalRuleList_27671, var_externRoutineList_27724, var_externFunctionList_27779, var_indexingListAST_27825, var_indexingDirectory_27014  COMMA_SOURCE_FILE ("lexique-component.galgas", 792))  COMMA_SOURCE_FILE ("lexique-component.galgas", 792)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_declaration_i1_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_template COMMA_SOURCE_FILE ("lexique-component.galgas", 815)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_lexique COMMA_SOURCE_FILE ("lexique-component.galgas", 816)) ;
  GALGAS_lstring var_lexiqueComponentName_29615 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 818)) ;
  GALGAS_lstring var_indexingDirectory_29675 ;
  switch (select_galgas_34_LexiqueComponentSyntax_2 (inCompiler)) {
  case 1: {
    var_indexingDirectory_29675 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("lexique-component.galgas", 822)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_indexing COMMA_SOURCE_FILE ("lexique-component.galgas", 824)) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_in COMMA_SOURCE_FILE ("lexique-component.galgas", 825)) ;
    var_indexingDirectory_29675 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 826)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7B_ COMMA_SOURCE_FILE ("lexique-component.galgas", 828)) ;
  GALGAS_templateDelimitorListAST var_templateDelimitorList_29895 = GALGAS_templateDelimitorListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 830)) ;
  GALGAS_templateReplacementListAST var_templateReplacementList_29960 = GALGAS_templateReplacementListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 831)) ;
  GALGAS_lexicalAttributeListAST var_lexicalAttributeList_30019 = GALGAS_lexicalAttributeListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 832)) ;
  GALGAS_lexicalStyleListAST var_lexicalStyleList_30070 = GALGAS_lexicalStyleListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 833)) ;
  GALGAS_terminalDeclarationListAST var_terminalDeclarationList_30135 = GALGAS_terminalDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 834)) ;
  GALGAS_lexicalMessageDeclarationListAST var_lexicalMessageDeclarationList_30212 = GALGAS_lexicalMessageDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 835)) ;
  GALGAS_lexicalListDeclarationListAST var_lexicalListDeclarationList_30283 = GALGAS_lexicalListDeclarationListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 836)) ;
  GALGAS_lexicalRuleListAST var_lexicalRuleList_30332 = GALGAS_lexicalRuleListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 837)) ;
  GALGAS_externRoutineListAST var_externRoutineList_30385 = GALGAS_externRoutineListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 838)) ;
  GALGAS_externFunctionListAST var_externFunctionList_30440 = GALGAS_externFunctionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 839)) ;
  GALGAS_indexingListAST var_indexingListAST_30486 = GALGAS_indexingListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 840)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_3 (inCompiler)) {
    case 2: {
      nt_extern_5F_routine_5F_declaration_ (var_externRoutineList_30385, inCompiler) ;
    } break ;
    case 3: {
      nt_extern_5F_function_5F_declaration_ (var_externFunctionList_30440, inCompiler) ;
    } break ;
    case 4: {
      nt_template_5F_delimitor_ (var_templateDelimitorList_29895, inCompiler) ;
    } break ;
    case 5: {
      nt_template_5F_replacement_ (var_templateReplacementList_29960, inCompiler) ;
    } break ;
    case 6: {
      nt_lexical_5F_attribute_5F_declaration_ (var_lexicalAttributeList_30019, inCompiler) ;
    } break ;
    case 7: {
      nt_style_5F_declaration_ (var_lexicalStyleList_30070, inCompiler) ;
    } break ;
    case 8: {
      nt_terminal_5F_declaration_ (var_terminalDeclarationList_30135, inCompiler) ;
    } break ;
    case 9: {
      nt_lexical_5F_list_5F_declaration_ (var_lexicalListDeclarationList_30283, inCompiler) ;
    } break ;
    case 10: {
      nt_lexical_5F_explicit_5F_rule_ (var_lexicalRuleList_30332, inCompiler) ;
    } break ;
    case 11: {
      nt_lexical_5F_implicit_5F_rule_ (var_lexicalRuleList_30332, inCompiler) ;
    } break ;
    case 12: {
      nt_lexical_5F_message_5F_declaration_ (var_lexicalMessageDeclarationList_30212, inCompiler) ;
    } break ;
    case 13: {
      nt_lexical_5F_indexing_5F_declaration_ (var_indexingListAST_30486, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("lexique-component.galgas", 870)) ;
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssign_operation (GALGAS_lexiqueComponentAST::constructor_new (GALGAS_bool (false), var_lexiqueComponentName_29615, GALGAS_bool (true), var_templateDelimitorList_29895, var_templateReplacementList_29960, var_lexicalAttributeList_30019, var_lexicalStyleList_30070, var_terminalDeclarationList_30135, var_lexicalMessageDeclarationList_30212, var_lexicalListDeclarationList_30283, var_lexicalRuleList_30332, var_externRoutineList_30385, var_externFunctionList_30440, var_indexingListAST_30486, var_indexingDirectory_29675  COMMA_SOURCE_FILE ("lexique-component.galgas", 871))  COMMA_SOURCE_FILE ("lexique-component.galgas", 871)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_indexing_5F_declaration_i2_ (GALGAS_indexingListAST & ioArgument_ioIndexingListAST,
                                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_indexing COMMA_SOURCE_FILE ("lexique-component.galgas", 894)) ;
  GALGAS_lstring var_indexName_32235 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->enterIndexing (C_Lexique_galgas_33_Scanner::kIndexing_indexingNameDefinition, "") ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 895)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 896)) ;
  GALGAS_lstring var_indexComment_32317 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 897)) ;
  ioArgument_ioIndexingListAST.addAssign_operation (var_indexName_32235, var_indexComment_32317  COMMA_SOURCE_FILE ("lexique-component.galgas", 898)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_template_5F_delimitor_i3_ (GALGAS_templateDelimitorListAST & ioArgument_ioTemplateDelimitorList,
                                                                                                                C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_template COMMA_SOURCE_FILE ("lexique-component.galgas", 904)) ;
  GALGAS_lstring var_startString_32632 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 905)) ;
  GALGAS_lstringlist var_optionList_32651 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 906)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_4 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_optionName_32734 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__25_attribute COMMA_SOURCE_FILE ("lexique-component.galgas", 909)) ;
      var_optionList_32651.addAssign_operation (var_optionName_32734  COMMA_SOURCE_FILE ("lexique-component.galgas", 910)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2E__2E__2E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 912)) ;
  GALGAS_lstring var_endString_32823 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 913)) ;
  ioArgument_ioTemplateDelimitorList.addAssign_operation (var_startString_32632, var_optionList_32651, var_endString_32823  COMMA_SOURCE_FILE ("lexique-component.galgas", 914)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_template_5F_replacement_i4_ (GALGAS_templateReplacementListAST & ioArgument_ioTemplateReplacement,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_replace COMMA_SOURCE_FILE ("lexique-component.galgas", 920)) ;
  GALGAS_lstring var_matchString_33156 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 921)) ;
  GALGAS_lstring var_replacementString_33191 ;
  GALGAS_lstring var_replacementFunction_33228 ;
  switch (select_galgas_34_LexiqueComponentSyntax_5 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2E__2E__2E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 925)) ;
    var_replacementString_33191 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 926)) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 927)) ;
    var_replacementFunction_33228 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 928)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2D__3E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 930)) ;
    var_replacementString_33191 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 931)) ;
    var_replacementFunction_33228 = GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 932))  COMMA_SOURCE_FILE ("lexique-component.galgas", 932)) ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioTemplateReplacement.addAssign_operation (var_matchString_33156, var_replacementString_33191, var_replacementFunction_33228  COMMA_SOURCE_FILE ("lexique-component.galgas", 934)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_message_5F_declaration_i5_ (GALGAS_lexicalMessageDeclarationListAST & ioArgument_ioLexicalMessageDeclarationList,
                                                                                                                            C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_message COMMA_SOURCE_FILE ("lexique-component.galgas", 941)) ;
  GALGAS_lstring var_messageName_33839 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 942)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 943)) ;
  GALGAS_lstring var_messageValue_33889 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 944)) ;
  ioArgument_ioLexicalMessageDeclarationList.addAssign_operation (var_messageName_33839, var_messageValue_33889  COMMA_SOURCE_FILE ("lexique-component.galgas", 945)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_implicit_5F_rule_i6_ (GALGAS_lexicalRuleListAST & ioArgument_ioLexicalImplicitRuleList,
                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_rule COMMA_SOURCE_FILE ("lexique-component.galgas", 951)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_list COMMA_SOURCE_FILE ("lexique-component.galgas", 952)) ;
  GALGAS_lstring var_listName_34225 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 953)) ;
  ioArgument_ioLexicalImplicitRuleList.addAssign_operation (GALGAS_lexicalImplicitRuleAST::constructor_new (var_listName_34225  COMMA_SOURCE_FILE ("lexique-component.galgas", 954))  COMMA_SOURCE_FILE ("lexique-component.galgas", 954)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_explicit_5F_rule_i7_ (GALGAS_lexicalRuleListAST & ioArgument_ioLexicalExplicitRuleList,
                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_rule COMMA_SOURCE_FILE ("lexique-component.galgas", 960)) ;
  GALGAS_lexicalExpressionAST var_lexicalRuleExpression_34592 ;
  nt_lexical_5F_expression_ (var_lexicalRuleExpression_34592, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7B_ COMMA_SOURCE_FILE ("lexique-component.galgas", 962)) ;
  GALGAS_lexicalInstructionListAST var_instructionList_34651 = GALGAS_lexicalInstructionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 963)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_6 (inCompiler)) {
    case 2: {
      nt_lexical_5F_instruction_ (var_instructionList_34651, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("lexique-component.galgas", 968)) ;
  ioArgument_ioLexicalExplicitRuleList.addAssign_operation (GALGAS_lexicalExplicitRuleAST::constructor_new (var_lexicalRuleExpression_34592, var_instructionList_34651  COMMA_SOURCE_FILE ("lexique-component.galgas", 969))  COMMA_SOURCE_FILE ("lexique-component.galgas", 969)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i8_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                 C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_send COMMA_SOURCE_FILE ("lexique-component.galgas", 975)) ;
  GALGAS_lexicalInstructionAST var_instruction_35130 ;
  nt_lexical_5F_send_5F_instruction_ (var_instruction_35130, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (var_instruction_35130  COMMA_SOURCE_FILE ("lexique-component.galgas", 977)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_send_5F_instruction_i9_ (GALGAS_lexicalInstructionAST & outArgument_outInstruction,
                                                                                                                         C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_lstring var_sentTerminal_35416 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 983)) ;
  outArgument_outInstruction = GALGAS_lexicalSimpleSendInstructionAST::constructor_new (var_sentTerminal_35416  COMMA_SOURCE_FILE ("lexique-component.galgas", 984)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_send_5F_instruction_i10_ (GALGAS_lexicalInstructionAST & outArgument_outInstruction,
                                                                                                                          C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_lexicalSendSearchListAST var_lexicalSendSearchList_35748 = GALGAS_lexicalSendSearchListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 990)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_search COMMA_SOURCE_FILE ("lexique-component.galgas", 991)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_attributeName_35824 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 993)) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_in COMMA_SOURCE_FILE ("lexique-component.galgas", 994)) ;
    GALGAS_lstring var_searchListName_35883 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 995)) ;
    var_lexicalSendSearchList_35748.addAssign_operation (var_attributeName_35824, var_searchListName_35883  COMMA_SOURCE_FILE ("lexique-component.galgas", 996)) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_default COMMA_SOURCE_FILE ("lexique-component.galgas", 997)) ;
    switch (select_galgas_34_LexiqueComponentSyntax_7 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_search COMMA_SOURCE_FILE ("lexique-component.galgas", 999)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lexicalSendDefaultActionAST var_lexicalSendDefaultAction_36056 ;
  switch (select_galgas_34_LexiqueComponentSyntax_8 (inCompiler)) {
  case 1: {
    GALGAS_lstring var_defaultSentTerminal_36122 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1003)) ;
    var_lexicalSendDefaultAction_36056 = GALGAS_lexicalSendTerminalByDefaultAST::constructor_new (var_defaultSentTerminal_36122  COMMA_SOURCE_FILE ("lexique-component.galgas", 1004)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1006)) ;
    GALGAS_lstring var_defaultErrorMessageName_36293 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1007)) ;
    var_lexicalSendDefaultAction_36056 = GALGAS_lexicalErrorByDefaultAST::constructor_new (var_defaultErrorMessageName_36293  COMMA_SOURCE_FILE ("lexique-component.galgas", 1008)) ;
  } break ;
  default:
    break ;
  }
  outArgument_outInstruction = GALGAS_lexicalStructuredSendInstructionAST::constructor_new (var_lexicalSendSearchList_35748, var_lexicalSendDefaultAction_36056  COMMA_SOURCE_FILE ("lexique-component.galgas", 1010)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i11_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_repeat COMMA_SOURCE_FILE ("lexique-component.galgas", 1019)) ;
  GALGAS_lexicalInstructionListAST var_repeatedInstructionList_36799 = GALGAS_lexicalInstructionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1020)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_9 (inCompiler)) {
    case 2: {
      nt_lexical_5F_instruction_ (var_repeatedInstructionList_36799, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lexicalWhileBranchListAST var_lexicalWhileBranchList_36945 = GALGAS_lexicalWhileBranchListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1025)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    nt_repeat_5F_while_5F_branch_ (var_lexicalWhileBranchList_36945, inCompiler) ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_end COMMA_SOURCE_FILE ("lexique-component.galgas", 1030)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalRepeatInstructionAST::constructor_new (var_repeatedInstructionList_36799, var_lexicalWhileBranchList_36945  COMMA_SOURCE_FILE ("lexique-component.galgas", 1031))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1031)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_repeat_5F_while_5F_branch_i12_ (GALGAS_lexicalWhileBranchListAST & ioArgument_ioLexicalWhileBranchList,
                                                                                                                     C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_while COMMA_SOURCE_FILE ("lexique-component.galgas", 1040)) ;
  GALGAS_lexicalExpressionAST var_whileExpression_37462 ;
  nt_lexical_5F_expression_ (var_whileExpression_37462, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1042)) ;
  GALGAS_lexicalInstructionListAST var_whileInstructionList_37526 = GALGAS_lexicalInstructionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1043)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_11 (inCompiler)) {
    case 2: {
      nt_lexical_5F_instruction_ (var_whileInstructionList_37526, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioLexicalWhileBranchList.addAssign_operation (var_whileExpression_37462, var_whileInstructionList_37526  COMMA_SOURCE_FILE ("lexique-component.galgas", 1048)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i13_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_select COMMA_SOURCE_FILE ("lexique-component.galgas", 1054)) ;
  GALGAS_lexicalSelectBranchListAST var_lexicalWhileBranchList_37959 = GALGAS_lexicalSelectBranchListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1055)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_case COMMA_SOURCE_FILE ("lexique-component.galgas", 1057)) ;
    GALGAS_lexicalExpressionAST var_selectExpression_38059 ;
    nt_lexical_5F_expression_ (var_selectExpression_38059, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1059)) ;
    GALGAS_lexicalInstructionListAST var_selectInstructionList_38128 = GALGAS_lexicalInstructionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1060)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      switch (select_galgas_34_LexiqueComponentSyntax_13 (inCompiler)) {
      case 2: {
        nt_lexical_5F_instruction_ (var_selectInstructionList_38128, inCompiler) ;
      } break ;
      default:
        repeatFlag_1 = false ;
        break ;
    ...
    var_lexicalWhileBranchList_37959.addAssign_operation (var_selectExpression_38059, var_selectInstructionList_38128  COMMA_SOURCE_FILE ("lexique-component.galgas", 1065)) ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_default COMMA_SOURCE_FILE ("lexique-component.galgas", 1068)) ;
  GALGAS_lexicalInstructionListAST var_defaultInstructionList_38385 = GALGAS_lexicalInstructionListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1069)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    switch (select_galgas_34_LexiqueComponentSyntax_14 (inCompiler)) {
    case 2: {
      nt_lexical_5F_instruction_ (var_defaultInstructionList_38385, inCompiler) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_end COMMA_SOURCE_FILE ("lexique-component.galgas", 1074)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalSelectInstructionAST::constructor_new (var_lexicalWhileBranchList_37959, var_defaultInstructionList_38385  COMMA_SOURCE_FILE ("lexique-component.galgas", 1075))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1075)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i14_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  GALGAS_lstring var_actionName_38856 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1084)) ;
  GALGAS_lexicalRoutineCallActualArgumentListAST var_actualArgumentList_38924 = GALGAS_lexicalRoutineCallActualArgumentListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1085)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__28_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1086)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_15 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_38982 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__21_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1089)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsNotEqual, var_selector_38982.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("!")) ;
          inCompiler->emitSemanticError (var_selector_38982.readProperty_location (), GALGAS_string ("the selector should be '!'"), fixItArray2  COMMA_SOURCE_FILE ("lexique-component.galgas", 1091)) ;
        }
      }
      GALGAS_location var_passingModeLocation_39134 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 1093)) ;
      GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST var_arg_39250 ;
      nt_lexical_5F_output_5F_effective_5F_argument_ (var_arg_39250, inCompiler) ;
      var_actualArgumentList_38924.addAssign_operation (GALGAS_lexicalFormalInputArgumentAST::constructor_new (var_passingModeLocation_39134, var_arg_39250  COMMA_SOURCE_FILE ("lexique-component.galgas", 1095))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1095)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_39377 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__21__3F_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1097)) ;
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsNotEqual, var_selector_39377.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          appendFixItActions (fixItArray4, kFixItReplace, GALGAS_string ("!\?")) ;
          inCompiler->emitSemanticError (var_selector_39377.readProperty_location (), GALGAS_string ("the selector should be '!\?'"), fixItArray4  COMMA_SOURCE_FILE ("lexique-component.galgas", 1099)) ;
        }
      }
      GALGAS_location var_passingModeLocation_39531 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 1101)) ;
      GALGAS_lstring var_attributeName_39595 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1102)) ;
      GALGAS_lexicalAttributeInputOutputArgumentAST var_arg_39609 = GALGAS_lexicalAttributeInputOutputArgumentAST::constructor_new (var_passingModeLocation_39531, var_attributeName_39595  COMMA_SOURCE_FILE ("lexique-component.galgas", 1103)) ;
      var_actualArgumentList_38924.addAssign_operation (var_arg_39609  COMMA_SOURCE_FILE ("lexique-component.galgas", 1104)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lstringlist var_errorMessageList_39771 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1106)) ;
  switch (select_galgas_34_LexiqueComponentSyntax_16 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1109)) ;
    bool repeatFlag_5 = true ;
    while (repeatFlag_5) {
      GALGAS_lstring var_errorMessageName_39873 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1111)) ;
      var_errorMessageList_39771.addAssign_operation (var_errorMessageName_39873  COMMA_SOURCE_FILE ("lexique-component.galgas", 1112)) ;
      switch (select_galgas_34_LexiqueComponentSyntax_17 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2C_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1114)) ;
      } break ;
      default:
        repeatFlag_5 = false ;
        break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__29_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1117)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalRoutineInstructionAST::constructor_new (var_actionName_38856, var_actualArgumentList_38924, var_errorMessageList_39771  COMMA_SOURCE_FILE ("lexique-component.galgas", 1118))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1118)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_output_5F_effective_5F_argument_i15_ (GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST & outArgument_outEffectiveArgument,
  ...
  GALGAS_lchar var_character_40377 = inCompiler->synthetizedAttribute_charValue () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__27_char_27_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1127)) ;
  outArgument_outEffectiveArgument = GALGAS_lexicalCharacterInputArgumentAST::constructor_new (var_character_40377  COMMA_SOURCE_FILE ("lexique-component.galgas", 1128)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_output_5F_effective_5F_argument_i16_ (GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST & outArgument_outEffectiveArgument,
                                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outEffectiveArgument.drop () ; // Release 'out' argument
  GALGAS_lbigint var_unsignedValue_40729 = inCompiler->synthetizedAttribute_bigintValue () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_uint_33__32_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1134)) ;
  outArgument_outEffectiveArgument = GALGAS_lexicalUnsignedInputArgumentAST::constructor_new (var_unsignedValue_40729  COMMA_SOURCE_FILE ("lexique-component.galgas", 1135)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_output_5F_effective_5F_argument_i17_ (GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST & outArgument_outEffectiveArgument,
                                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outEffectiveArgument.drop () ; // Release 'out' argument
  GALGAS_location var_currentLocation_41076 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 1141)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2A_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1142)) ;
  outArgument_outEffectiveArgument = GALGAS_lexicalCurrentCharacterInputArgumentAST::constructor_new (var_currentLocation_41076  COMMA_SOURCE_FILE ("lexique-component.galgas", 1143)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_output_5F_effective_5F_argument_i18_ (GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST & outArgument_outEffectiveArgument,
                                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outEffectiveArgument.drop () ; // Release 'out' argument
  GALGAS_lstring var_idf_41460 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1149)) ;
  switch (select_galgas_34_LexiqueComponentSyntax_18 (inCompiler)) {
  case 1: {
    outArgument_outEffectiveArgument = GALGAS_lexicalAttributeInputArgumentAST::constructor_new (var_idf_41460  COMMA_SOURCE_FILE ("lexique-component.galgas", 1151)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__28_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1153)) ;
    GALGAS_lexicalFunctionCallActualArgumentListAST var_functionActualArgumentList_41641 = GALGAS_lexicalFunctionCallActualArgumentListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1154)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      switch (select_galgas_34_LexiqueComponentSyntax_19 (inCompiler)) {
      case 2: {
        GALGAS_lstring var_selector_41697 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__21_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1157)) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsNotEqual, var_selector_41697.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_1) {
            TC_Array <C_FixItDescription> fixItArray2 ;
            appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("!")) ;
            inCompiler->emitSemanticError (var_selector_41697.readProperty_location (), GALGAS_string ("the selector should be '!'"), fixItArray2  COMMA_SOURCE_FILE ("lexique-component.galgas", 1159)) ;
          }
        }
        GALGAS_lexicalRoutineOrFunctionFormalInputArgumentAST var_arg_41926 ;
        nt_lexical_5F_output_5F_effective_5F_argument_ (var_arg_41926, inCompiler) ;
        var_functionActualArgumentList_41641.addAssign_operation (var_arg_41926  COMMA_SOURCE_FILE ("lexique-component.galgas", 1162)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
    ...
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__29_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1164)) ;
    outArgument_outEffectiveArgument = GALGAS_lexicalFunctionInputArgumentAST::constructor_new (var_idf_41460, var_functionActualArgumentList_41641  COMMA_SOURCE_FILE ("lexique-component.galgas", 1165)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i19_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1172)) ;
  GALGAS_lstring var_errorMessageName_42354 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1173)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalErrorInstructionAST::constructor_new (var_errorMessageName_42354  COMMA_SOURCE_FILE ("lexique-component.galgas", 1174))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1174)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i20_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_warning COMMA_SOURCE_FILE ("lexique-component.galgas", 1180)) ;
  GALGAS_lstring var_warningMessageName_42692 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1181)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalWarningInstructionAST::constructor_new (var_warningMessageName_42692  COMMA_SOURCE_FILE ("lexique-component.galgas", 1182))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1182)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i21_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_drop COMMA_SOURCE_FILE ("lexique-component.galgas", 1188)) ;
  GALGAS_lstring var_terminalName_43027 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1189)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalDropInstructionAST::constructor_new (var_terminalName_43027  COMMA_SOURCE_FILE ("lexique-component.galgas", 1190))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1190)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i22_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_tag COMMA_SOURCE_FILE ("lexique-component.galgas", 1196)) ;
  GALGAS_lstring var_tagName_43345 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1197)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalTagInstructionAST::constructor_new (var_tagName_43345  COMMA_SOURCE_FILE ("lexique-component.galgas", 1198))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1198)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i23_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_rewind COMMA_SOURCE_FILE ("lexique-component.galgas", 1204)) ;
  GALGAS_lstring var_tagName_43660 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1205)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_send COMMA_SOURCE_FILE ("lexique-component.galgas", 1206)) ;
  GALGAS_lstring var_terminalName_43708 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1207)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalRewindInstructionAST::constructor_new (var_tagName_43660, var_terminalName_43708  COMMA_SOURCE_FILE ("lexique-component.galgas", 1208))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1208)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_instruction_i24_ (GALGAS_lexicalInstructionListAST & ioArgument_ioInstructionList,
                                                                                                                  C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_log COMMA_SOURCE_FILE ("lexique-component.galgas", 1214)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_lexicalLogInstructionAST::constructor_new (SOURCE_FILE ("lexique-component.galgas", 1215))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1215)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_term_i26_ (GALGAS_lexicalExpressionAST & outArgument_outExpression,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7C_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1230)) ;
      GALGAS_lexicalExpressionAST var_rightExpression_44590 ;
      nt_lexical_5F_factor_ (var_rightExpression_44590, inCompiler) ;
      outArgument_outExpression = GALGAS_lexicalOrExpressionAST::constructor_new (outArgument_outExpression, var_rightExpression_44590  COMMA_SOURCE_FILE ("lexique-component.galgas", 1232)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_factor_i27_ (GALGAS_lexicalExpressionAST & outArgument_outExpression,
                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_string_44898 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1239)) ;
  outArgument_outExpression = GALGAS_lexicalStringMatchAST::constructor_new (var_string_44898  COMMA_SOURCE_FILE ("lexique-component.galgas", 1240)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_factor_i28_ (GALGAS_lexicalExpressionAST & outArgument_outExpression,
                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1246)) ;
  GALGAS_lstring var_string_45180 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1247)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1248)) ;
  GALGAS_lstring var_errorMessage_45227 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1249)) ;
  outArgument_outExpression = GALGAS_lexicalStringNotMatchAST::constructor_new (var_string_45180, var_errorMessage_45227  COMMA_SOURCE_FILE ("lexique-component.galgas", 1250)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_factor_i29_ (GALGAS_lexicalExpressionAST & outArgument_outExpression,
                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lchar var_character_45526 = inCompiler->synthetizedAttribute_charValue () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__27_char_27_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1256)) ;
  switch (select_galgas_34_LexiqueComponentSyntax_21 (inCompiler)) {
  case 1: {
    outArgument_outExpression = GALGAS_lexicalCharacterMatchAST::constructor_new (var_character_45526  COMMA_SOURCE_FILE ("lexique-component.galgas", 1258)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2D__3E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1260)) ;
    GALGAS_lchar var_upperBound_45658 = inCompiler->synthetizedAttribute_charValue () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__27_char_27_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1261)) ;
    outArgument_outExpression = GALGAS_lexicalCharacterIntervalMatchAST::constructor_new (var_character_45526, var_upperBound_45658  COMMA_SOURCE_FILE ("lexique-component.galgas", 1262)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_factor_i30_ (GALGAS_lexicalExpressionAST & outArgument_outExpression,
                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_characterSet_45985 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1269)) ;
  outArgument_outExpression = GALGAS_lexicalCharacterSetMatchAST::constructor_new (var_characterSet_45985  COMMA_SOURCE_FILE ("lexique-component.galgas", 1270)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_list_5F_declaration_i31_ (GALGAS_lexicalListDeclarationListAST & ioArgument_ioLexicalListDeclarationList,
                                                                                                                          C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_list COMMA_SOURCE_FILE ("lexique-component.galgas", 1276)) ;
  GALGAS_lstring var_name_46317 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1277)) ;
  GALGAS_sentLexicalAttributeListAST var_sentAttributeList_46372 = GALGAS_sentLexicalAttributeListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1278)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_22 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_46422 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__21_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1281)) ;
      GALGAS_lstring var_sentAttribute_46460 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1282)) ;
      var_sentAttributeList_46372.addAssign_operation (var_selector_46422, var_sentAttribute_46460  COMMA_SOURCE_FILE ("lexique-component.galgas", 1283)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lstring var_theStyle_46546 ;
  switch (select_galgas_34_LexiqueComponentSyntax_23 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_style COMMA_SOURCE_FILE ("lexique-component.galgas", 1287)) ;
    var_theStyle_46546 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1288)) ;
  } break ;
  case 2: {
    var_theStyle_46546 = GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 1290))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1290)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1292)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_message COMMA_SOURCE_FILE ("lexique-component.galgas", 1293)) ;
  GALGAS_lstring var_errorMessage_46763 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1294)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7B_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1295)) ;
  GALGAS_lexicalListEntryListAST var_entryList_46789 = GALGAS_lexicalListEntryListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1296)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    nt_lexical_5F_list_5F_entry_ (var_entryList_46789, inCompiler) ;
    switch (select_galgas_34_LexiqueComponentSyntax_24 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2C_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1300)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1302)) ;
  ioArgument_ioLexicalListDeclarationList.addAssign_operation (var_name_46317, var_theStyle_46546, var_errorMessage_46763, var_sentAttributeList_46372, var_entryList_46789  COMMA_SOURCE_FILE ("lexique-component.galgas", 1303)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_list_5F_entry_i32_ (GALGAS_lexicalListEntryListAST & ioArgument_ioLexicalListEntryList,
                                                                                                                    C_Lexique_galgas_33_Scanner * inCompiler) {
  GALGAS_lstring var_entrySpelling_47251 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1309)) ;
  GALGAS_lstringlist var_optionList_47283 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1310)) ;
  switch (select_galgas_34_LexiqueComponentSyntax_25 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    GALGAS_lstring var_optionName_47350 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__25_attribute COMMA_SOURCE_FILE ("lexique-component.galgas", 1313)) ;
    var_optionList_47283.addAssign_operation (var_optionName_47350  COMMA_SOURCE_FILE ("lexique-component.galgas", 1314)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_terminalSpelling_47424 ;
  switch (select_galgas_34_LexiqueComponentSyntax_26 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2D__3E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1318)) ;
    var_terminalSpelling_47424 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1319)) ;
  } break ;
  case 2: {
    var_terminalSpelling_47424 = var_entrySpelling_47251 ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioLexicalListEntryList.addAssign_operation (var_entrySpelling_47251, var_terminalSpelling_47424, var_optionList_47283  COMMA_SOURCE_FILE ("lexique-component.galgas", 1323)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_lexical_5F_attribute_5F_declaration_i33_ (GALGAS_lexicalAttributeListAST & ioArgument_ioLexicalAttributeList,
                                                                                                                               C_Lexique_galgas_33_Scanner * inCompiler) {
  GALGAS_lstring var_typeName_47868 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__40_type COMMA_SOURCE_FILE ("lexique-component.galgas", 1329)) ;
  GALGAS_lstring var_name_47904 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1330)) ;
  ioArgument_ioLexicalAttributeList.addAssign_operation (var_typeName_47868, var_name_47904  COMMA_SOURCE_FILE ("lexique-component.galgas", 1331)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_terminal_5F_declaration_i34_ (GALGAS_terminalDeclarationListAST & ioArgument_ioTerminalDeclarationList,
                                                                                                                   C_Lexique_galgas_33_Scanner * inCompiler) {
  GALGAS_lstring var_name_48203 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->enterIndexing (C_Lexique_galgas_33_Scanner::kIndexing_terminalDeclaration, "") ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__24_terminal_24_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1337)) ;
  GALGAS_sentLexicalAttributeListAST var_sentAttributeList_48258 = GALGAS_sentLexicalAttributeListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1338)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_27 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_48337 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__21_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1341)) ;
      GALGAS_lstring var_sentAttribute_48375 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1342)) ;
      var_sentAttributeList_48258.addAssign_operation (var_selector_48337, var_sentAttribute_48375  COMMA_SOURCE_FILE ("lexique-component.galgas", 1343)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lstring var_theStyle_48461 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("lexique-component.galgas", 1345)) ;
  GALGAS_lstringlist var_optionList_48534 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1346)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_galgas_34_LexiqueComponentSyntax_28 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_style COMMA_SOURCE_FILE ("lexique-component.galgas", 1349)) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, var_theStyle_48461.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lexique-component.galgas", 1351)), GALGAS_string ("duplicated style reference"), fixItArray3  COMMA_SOURCE_FILE ("lexique-component.galgas", 1351)) ;
        }
      }
      var_theStyle_48461 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1353)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_optionName_48764 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__25_attribute COMMA_SOURCE_FILE ("lexique-component.galgas", 1355)) ;
      var_optionList_48534.addAssign_operation (var_optionName_48764  COMMA_SOURCE_FILE ("lexique-component.galgas", 1356)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1358)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_message COMMA_SOURCE_FILE ("lexique-component.galgas", 1359)) ;
  GALGAS_lstring var_errorMessage_48872 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1360)) ;
  ioArgument_ioTerminalDeclarationList.addAssign_operation (var_name_48203, var_sentAttributeList_48258, var_errorMessage_48872, var_theStyle_48461, var_optionList_48534  COMMA_SOURCE_FILE ("lexique-component.galgas", 1361)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_style_5F_declaration_i35_ (GALGAS_lexicalStyleListAST & ioArgument_ioLexicalStyleList,
                                                                                                                C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_style COMMA_SOURCE_FILE ("lexique-component.galgas", 1367)) ;
  GALGAS_lstring var_styleIdentifier_49223 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1368)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = var_styleIdentifier_49223.readProperty_string ().getter_containsCharacter (GALGAS_char (TO_UNICODE (95)) COMMA_SOURCE_FILE ("lexique-component.galgas", 1369)).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_styleIdentifier_49223.readProperty_location (), GALGAS_string ("for compatibility with latex formatting, a style name should not contain '_' character"), fixItArray1  COMMA_SOURCE_FILE ("lexique-component.galgas", 1370)) ;
    }
  }
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    test_2 = var_styleIdentifier_49223.readProperty_string ().getter_containsCharacterInRange (GALGAS_char (TO_UNICODE (48)), GALGAS_char (TO_UNICODE (57)) COMMA_SOURCE_FILE ("lexique-component.galgas", 1372)).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (var_styleIdentifier_49223.readProperty_location (), GALGAS_string ("for compatibility with latex formatting, a style name should not contain any digit"), fixItArray3  COMMA_SOURCE_FILE ("lexique-component.galgas", 1373)) ;
    }
  }
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2D__3E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1375)) ;
  GALGAS_lstring var_comment_49653 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__22_string_22_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1376)) ;
  ioArgument_ioLexicalStyleList.addAssign_operation (var_styleIdentifier_49223, var_comment_49653  COMMA_SOURCE_FILE ("lexique-component.galgas", 1377)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_extern_5F_routine_5F_declaration_i36_ (GALGAS_externRoutineListAST & ioArgument_ioExternRoutineList,
                                                                                                                            C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_extern COMMA_SOURCE_FILE ("lexique-component.galgas", 1383)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_proc COMMA_SOURCE_FILE ("lexique-component.galgas", 1384)) ;
  GALGAS_lstring var_routineName_49981 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1385)) ;
  GALGAS_lexicalExternRoutineFormalArgumentListAST var_lexicalRoutineFormalArgumentList_50022 = GALGAS_lexicalExternRoutineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1386)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_29 (inCompiler)) {
    case 2: {
      GALGAS_lexicalArgumentModeAST var_lexicalArgumentMode_50145 ;
      switch (select_galgas_34_LexiqueComponentSyntax_30 (inCompiler)) {
      case 1: {
        GALGAS_lstring var_selector_50185 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3F__21_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1391)) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsNotEqual, var_selector_50185.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_1) {
            TC_Array <C_FixItDescription> fixItArray2 ;
            appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("\?!")) ;
            inCompiler->emitSemanticError (var_selector_50185.readProperty_location (), GALGAS_string ("the selector should be '\?!'"), fixItArray2  COMMA_SOURCE_FILE ("lexique-component.galgas", 1393)) ;
          }
        }
        var_lexicalArgumentMode_50145 = GALGAS_lexicalArgumentModeAST::constructor_lexicalInputOutputMode (SOURCE_FILE ("lexique-component.galgas", 1395)) ;
      } break ;
      case 2: {
        GALGAS_lstring var_selector_50428 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3F_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1397)) ;
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          test_3 = GALGAS_bool (kIsNotEqual, var_selector_50428.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            appendFixItActions (fixItArray4, kFixItReplace, GALGAS_string ("\?")) ;
            inCompiler->emitSemanticError (var_selector_50428.readProperty_location (), GALGAS_string ("the selector should be '\?'"), fixItArray4  COMMA_SOURCE_FILE ("lexique-component.galgas", 1399)) ;
          }
        }
        var_lexicalArgumentMode_50145 = GALGAS_lexicalArgumentModeAST::constructor_lexicalInputMode (SOURCE_FILE ("lexique-component.galgas", 1401)) ;
      } break ;
      default:
        break ;
      }
      GALGAS_lstring var_lexicalTypeName_50683 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__40_type COMMA_SOURCE_FILE ("lexique-component.galgas", 1403)) ;
      GALGAS_lstring var_formalArgumentName_50735 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1404)) ;
      var_lexicalRoutineFormalArgumentList_50022.addAssign_operation (var_lexicalArgumentMode_50145, var_lexicalTypeName_50683, var_formalArgumentName_50735  COMMA_SOURCE_FILE ("lexique-component.galgas", 1405)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_stringlist var_errorMessageList_50880 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1407)) ;
  switch (select_galgas_34_LexiqueComponentSyntax_31 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_error COMMA_SOURCE_FILE ("lexique-component.galgas", 1410)) ;
    bool repeatFlag_5 = true ;
    while (repeatFlag_5) {
      GALGAS_lstring var_errorMessageName_50982 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1412)) ;
      var_errorMessageList_50880.addAssign_operation (var_errorMessageName_50982.readProperty_string ()  COMMA_SOURCE_FILE ("lexique-component.galgas", 1413)) ;
      switch (select_galgas_34_LexiqueComponentSyntax_32 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2C_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1415)) ;
      } break ;
      default:
        repeatFlag_5 = false ;
        break ;
  ...
  ioArgument_ioExternRoutineList.addAssign_operation (var_routineName_49981, var_lexicalRoutineFormalArgumentList_50022, var_errorMessageList_50880  COMMA_SOURCE_FILE ("lexique-component.galgas", 1418)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_extern_5F_function_5F_declaration_i37_ (GALGAS_externFunctionListAST & ioArgument_ioExternFunctionList,
                                                                                                                             C_Lexique_galgas_33_Scanner * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_extern COMMA_SOURCE_FILE ("lexique-component.galgas", 1424)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_func COMMA_SOURCE_FILE ("lexique-component.galgas", 1425)) ;
  GALGAS_lstring var_functionName_51449 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1426)) ;
  GALGAS_lexicalExternFunctionFormalArgumentListAST var_lexicalFunctionFormalArgumentList_51491 = GALGAS_lexicalExternFunctionFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("lexique-component.galgas", 1427)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_33 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_51585 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3F_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1430)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsNotEqual, var_selector_51585.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("\?")) ;
          inCompiler->emitSemanticError (var_selector_51585.readProperty_location (), GALGAS_string ("the selector should be '\?'"), fixItArray2  COMMA_SOURCE_FILE ("lexique-component.galgas", 1432)) ;
        }
      }
      GALGAS_lstring var_lexicalTypeName_51752 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__40_type COMMA_SOURCE_FILE ("lexique-component.galgas", 1434)) ;
      GALGAS_lstring var_formalArgumentName_51804 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken_identifier COMMA_SOURCE_FILE ("lexique-component.galgas", 1435)) ;
      var_lexicalFunctionFormalArgumentList_51491.addAssign_operation (var_lexicalTypeName_51752, var_formalArgumentName_51804  COMMA_SOURCE_FILE ("lexique-component.galgas", 1436)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__2D__3E_ COMMA_SOURCE_FILE ("lexique-component.galgas", 1438)) ;
  GALGAS_lstring var_returnedTypeName_51944 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__40_type COMMA_SOURCE_FILE ("lexique-component.galgas", 1439)) ;
  ioArgument_ioExternFunctionList.addAssign_operation (var_functionName_51449, var_lexicalFunctionFormalArgumentList_51491, var_returnedTypeName_51944  COMMA_SOURCE_FILE ("lexique-component.galgas", 1440)) ;
}
...
void cParser_galgas_34_LexiqueComponentSyntax::rule_galgas_34_LexiqueComponentSyntax_declaration_i38_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_lstring var_lexiqueComponentName_5073 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_lexiqueSuperComponentName_5138 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_templateDelimitorListAST var_templateDelimitorList_5228 = GALGAS_templateDelimitorListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 125)) ;
  GALGAS_templateReplacementListAST var_templateReplacementList_5293 = GALGAS_templateReplacementListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 126)) ;
  GALGAS_lexicalAttributeListAST var_lexicalAttributeList_5352 = GALGAS_lexicalAttributeListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 127)) ;
  GALGAS_lexicalStyleListAST var_lexicalStyleList_5403 = GALGAS_lexicalStyleListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 128)) ;
  GALGAS_terminalDeclarationListAST var_terminalDeclarationList_5468 = GALGAS_terminalDeclarationListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 129)) ;
  GALGAS_lexicalMessageDeclarationListAST var_lexicalMessageDeclarationList_5545 = GALGAS_lexicalMessageDeclarationListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 130)) ;
  GALGAS_lexicalListDeclarationListAST var_lexicalListDeclarationList_5616 = GALGAS_lexicalListDeclarationListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 131)) ;
  GALGAS_lexicalRuleListAST var_lexicalRuleList_5665 = GALGAS_lexicalRuleListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 132)) ;
  GALGAS_externRoutineListAST var_externRoutineList_5718 = GALGAS_externRoutineListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 133)) ;
  GALGAS_externFunctionListAST var_externFunctionList_5773 = GALGAS_externFunctionListAST::constructor_emptyList (SOURCE_FILE ("template-lexique-component.galgas", 134)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_galgas_34_LexiqueComponentSyntax_34 (inCompiler)) {
    case 2: {
      nt_template_5F_delimitor_ (var_templateDelimitorList_5228, inCompiler) ;
    } break ;
    case 3: {
      nt_template_5F_replacement_ (var_templateReplacementList_5293, inCompiler) ;
    } break ;
    case 4: {
      nt_extern_5F_routine_5F_declaration_ (var_externRoutineList_5718, inCompiler) ;
    } break ;
    case 5: {
      nt_extern_5F_function_5F_declaration_ (var_externFunctionList_5773, inCompiler) ;
    } break ;
    case 6: {
      nt_lexical_5F_attribute_5F_declaration_ (var_lexicalAttributeList_5352, inCompiler) ;
    } break ;
    case 7: {
      nt_style_5F_declaration_ (var_lexicalStyleList_5403, inCompiler) ;
    } break ;
    case 8: {
      nt_terminal_5F_declaration_ (var_terminalDeclarationList_5468, inCompiler) ;
    } break ;
    case 9: {
      nt_lexical_5F_list_5F_declaration_ (var_lexicalListDeclarationList_5616, inCompiler) ;
    } break ;
    case 10: {
      nt_lexical_5F_explicit_5F_rule_ (var_lexicalRuleList_5665, inCompiler) ;
    } break ;
    case 11: {
      nt_lexical_5F_implicit_5F_rule_ (var_lexicalRuleList_5665, inCompiler) ;
    } break ;
    case 12: {
      nt_lexical_5F_message_5F_declaration_ (var_lexicalMessageDeclarationList_5545, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssign_operation (GALGAS_templateLexiqueComponentAST::constructor_new (GALGAS_bool (false), var_lexiqueComponentName_5073, var_lexiqueSuperComponentName_5138, var_templateDelimitorList_5228, var_templateReplacementList_5293, var_lexicalAttributeList_5352, var_lexicalStyleList_5403, var_terminalDeclarationList_5468, var_lexicalMessageDeclarationList_5545, var_lexicalListDeclarationList_5616, var_lexicalRuleList_5665, var_externRoutineList_5718, var_externFunctionList_5773  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 164))  COMMA_SOURCE_FILE ("template-lexique-component.galgas", 164)) ;
}
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_declaration_i0_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_4) {
    ...
    case 2: {
      ...
      var_mUnusedNonterminalList_8021.addAssign_operation (var_nonterminalSymbolName_8134  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 239)) ;
    } break ;
    default:
      repeatFlag_4 = false ;
      break ;
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_grammar_5F_start_5F_symbol_5F_label_i1_ (const GALGAS_lstring constinArgument_inLabelName,
                                                                                                                              ...
                                                                                                                              C_Lexique_galgas_33_Scanner * inCompiler) {
  GALGAS_stringset var_argumentNameSet_8800 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 259)) ;
  GALGAS_formalParameterListAST var_formalParameterList_8857 = GALGAS_formalParameterListAST::constructor_emptyList (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 260)) ;
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_argumentName_8940 ;
      nt_label_5F_formal_5F_parameter_ (var_argumentName_8940, var_formalParameterList_8857, inCompiler) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = var_argumentNameSet_8800.getter_hasKey (var_argumentName_8940.readProperty_string () COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 265)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (var_argumentName_8940.readProperty_location (), GALGAS_string ("there is already an argument named '").add_operation (var_argumentName_8940.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 266)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 266)), fixItArray2  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 266)) ;
        }
      }
      var_argumentNameSet_8800.addAssign_operation (var_argumentName_8940.readProperty_string ()  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 268)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioLabelList.addAssign_operation (constinArgument_inLabelName, var_formalParameterList_8857, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 271))  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 271)) ;
}
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_label_5F_formal_5F_parameter_i2_ (GALGAS_lstring & outArgument_outArgumentName,
  ...
  GALGAS_lstring var_selector_9523 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mTypeName_9559 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssign_operation (var_selector_9523, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 288)), var_mTypeName_9559, outArgument_outArgumentName, GALGAS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 286)) ;
}
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_label_5F_formal_5F_parameter_i3_ (GALGAS_lstring & outArgument_outArgumentName,
                                                                                                                       ...
                                                                                                                       C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outArgumentName.drop () ; // Release 'out' argument
  GALGAS_lstring var_selector_10077 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mTypeName_10123 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssign_operation (var_selector_10077, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 309)), var_mTypeName_10123, outArgument_outArgumentName, GALGAS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 307)) ;
}
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_label_5F_formal_5F_parameter_i4_ (GALGAS_lstring & outArgument_outArgumentName,
                                                                                                                       ...
                                                                                                                       C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outArgumentName.drop () ; // Release 'out' argument
  GALGAS_lstring var_selector_10650 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mTypeName_10686 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssign_operation (var_selector_10650, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 329)), var_mTypeName_10686, outArgument_outArgumentName, GALGAS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 327)) ;
}
...
void cParser_galgas_34_GrammarComponentSyntax::rule_galgas_34_GrammarComponentSyntax_label_5F_formal_5F_parameter_i5_ (GALGAS_lstring & outArgument_outArgumentName,
                                                                                                                       ...
                                                                                                                       C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outArgumentName.drop () ; // Release 'out' argument
  GALGAS_lstring var_selector_11207 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mTypeName_11243 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioStartSymbolLabelFormalParameterList.addAssign_operation (var_selector_11207, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 345)), var_mTypeName_11243, outArgument_outArgumentName, GALGAS_bool (false)  COMMA_SOURCE_FILE ("galgasGrammarComponentSyntax.galgas", 343)) ;
}
...
void cParser_galgas_34_ProgramDeclarations::rule_galgas_34_ProgramDeclarations_declaration_i0_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_semanticInstructionListAST var_prologueInstructionList_5123 ;
  nt_semantic_5F_instruction_5F_list_ (var_prologueInstructionList_5123, inCompiler) ;
  GALGAS_location var_endOfPrologue_5145 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 128)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 129)) ;
  ioArgument_ioDeclarations.mProperty_mPrologueDeclarationList.addAssign_operation (var_prologueInstructionList_5123, var_endOfPrologue_5145  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 130)) ;
}
...
void cParser_galgas_34_ProgramDeclarations::rule_galgas_34_ProgramDeclarations_declaration_i1_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_semanticInstructionListAST var_prologueInstructionList_5735 ;
  nt_semantic_5F_instruction_5F_list_ (var_prologueInstructionList_5735, inCompiler) ;
  GALGAS_location var_endOfPrologue_5757 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 143)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 144)) ;
  ioArgument_ioDeclarations.mProperty_mEpilogueDeclarationList.addAssign_operation (var_prologueInstructionList_5735, var_endOfPrologue_5757  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 145)) ;
}
...
void cParser_galgas_34_ProgramDeclarations::rule_galgas_34_ProgramDeclarations_declaration_i2_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_lstring var_mSourceFileExtension_6310 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_mSourceFileHelp_6369 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_referenceGrammar_6428 ;
  switch (select_galgas_34_ProgramDeclarations_0 (inCompiler)) {
  case 1: {
    var_referenceGrammar_6428 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasProgramDeclarations.galgas", 164)) ;
  } break ;
  case 2: {
    ...
    var_referenceGrammar_6428 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_selector_6586 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__3F_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 170)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_selector_6586.readProperty_string ().objectCompare (GALGAS_string ("sourceFilePath"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      appendFixItActions (fixItArray1, kFixItReplace, GALGAS_string ("\?sourceFilePath:")) ;
      inCompiler->emitSemanticError (var_selector_6586.readProperty_location (), GALGAS_string ("the selector should be '\?sourceFilePath:'"), fixItArray1  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 172)) ;
    }
  }
  ...
  case 2: {
    GALGAS_lstring var_typeName_6792 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsNotEqual, var_typeName_6792.readProperty_string ().objectCompare (GALGAS_string ("lstring"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (var_typeName_6792.readProperty_location (), GALGAS_string ("the only type allowed here is '@lstring'"), fixItArray3  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 178)) ;
      }
    }
  } break ;
  default:
  ...
  GALGAS_bool var_isUnused_6944 ;
  switch (select_galgas_34_ProgramDeclarations_2 (inCompiler)) {
  case 1: {
    var_isUnused_6944 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_isUnused_6944 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_mSourceFileVariableName_7085 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_semanticInstructionListAST var_mInstructionList_7182 ;
  nt_semantic_5F_instruction_5F_list_ (var_mInstructionList_7182, inCompiler) ;
  GALGAS_location var_endOfInstructionList_7211 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 192)) ;
  inCompiler->acceptTerminal (C_Lexique_galgas_33_Scanner::kToken__7D_ COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 193)) ;
  ioArgument_ioDeclarations.mProperty_mSourceRuleList.addAssign_operation (var_mSourceFileExtension_6310, var_mSourceFileHelp_6369, var_mSourceFileVariableName_7085, var_isUnused_6944, var_referenceGrammar_6428, var_mInstructionList_7182, var_endOfInstructionList_7211  COMMA_SOURCE_FILE ("galgasProgramDeclarations.galgas", 194)) ;
}
