...
void routine_parseAndAnalyzeProject_3F__3F_galgas_34__3F_ (const GGS_lstring constinArgument_inProjectSourceFilePath,
  ...
  cGrammar_galgas_33_ProjectGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inProjectSourceFilePath, constinArgument_inProjectSourceFilePath, var_projectComponentAST_6749  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 166)) ;
  GalgasBool test_1 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_1) {
    ...
    if (GalgasBool::boolTrue == test_1) {
      {
      routine_compileProject_3F__3F__3F_galgas_34__3F_ (constinArgument_inProjectSourceFilePath, constinArgument_inSourceToAnalyze, constinArgument_inGalgas_34_, var_projectComponentAST_6749, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 168)) ;
      }
      GalgasBool test_2 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_2) {
        ...
        if (GalgasBool::boolTrue == test_2) {
          ...
          if (GalgasBool::boolTrue == test_3) {
            ...
            if (GalgasBool::boolTrue == test_3) {
              ...
              GGS_string var_buildFile_7234 = constinArgument_inProjectSourceFilePath.readProperty_string ().getter_deletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 176)).add_operation (GGS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 176)).add_operation (var_cppCompilationTarget_7007, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 176)).add_operation (GGS_string ("/build.py"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 176)) ;
              GalgasBool test_5 = GalgasBool::boolTrue ;
              if (GalgasBool::boolTrue == test_5) {
                test_5 = var_buildFile_7234.getter_fileExists (SOURCE_FILE ("galgasProgram.galgas3", 177)).boolEnum () ;
                if (GalgasBool::boolTrue == test_5) {
                  GGS_sint var_resultCode_7397 = GGS_string ("python ").add_operation (var_buildFile_7234, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 178)).getter_system (SOURCE_FILE ("galgasProgram.galgas3", 178)) ;
                  GalgasBool test_6 = GalgasBool::boolTrue ;
                  if (GalgasBool::boolTrue == test_6) {
                    test_6 = GGS_bool (ComparisonKind::notEqual, var_resultCode_7397.objectCompare (GGS_sint (int32_t (0L)))).boolEnum () ;
                    if (GalgasBool::boolTrue == test_6) {
                      GenericArray <FixItDescription> fixItArray7 ;
                      inCompiler->emitSemanticError (GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("galgasProgram.galgas3", 180)).readProperty_location (), GGS_string ("Running '").add_operation (var_buildFile_7234, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 180)).add_operation (GGS_string ("' returns "), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 180)).add_operation (var_resultCode_7397.getter_string (SOURCE_FILE ("galgasProgram.galgas3", 180)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 180)), fixItArray7  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 180)) ;
                    }
                  }
                }
              }
...
void routine_compileProject_3F__3F__3F_galgas_34__3F_ (const GGS_lstring constinArgument_inProjectSourceFile,
                                                       ...
                                                       Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GGS_galgasDeclarationAST var_declarationAST_8176 = GGS_galgasDeclarationAST::init (inCompiler COMMA_HERE) ;
  cGrammar_galgas_34_Grammar::_performSourceStringParsing_ (inCompiler, GGS_filewrapper (gWrapperDirectory_0_typeGenerationTemplate).getter_textFileContentsAtPath (GGS_string ("galgas-predefined-entities.txt"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 200)), GGS_string ("GALGAS predefined types"), var_declarationAST_8176  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 199)) ;
  GGS_string var_sourcesDir_8443 = constinArgument_inProjectSourceFile.readProperty_string ().getter_deletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 203)).add_operation (GGS_string ("/sources"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 203)) ;
  UpEnumerator_stringlist enumerator_8529 (constinArgument_inProjectComponentAST.readProperty_mProjectSourceList ()) ;
  while (enumerator_8529.hasCurrentObject ()) {
    GalgasBool test_0 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_0) {
      test_0 = GGS_bool (ComparisonKind::equal, enumerator_8529.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("galgasProgram.galgas3", 205)).objectCompare (GGS_string ("galgas3"))).boolEnum () ;
      if (GalgasBool::boolTrue == test_0) {
        GGS_string var_absoluteSourcePath_8640 = enumerator_8529.current_mValue (HERE).getter_absolutePathFromPath (var_sourcesDir_8443 COMMA_SOURCE_FILE ("galgasProgram.galgas3", 206)) ;
        cGrammar_galgas_33_Grammar::_performSourceFileParsing_ (inCompiler, GGS_lstring::init_21__21_ (var_absoluteSourcePath_8640, GGS_location::class_func_nowhere (SOURCE_FILE ("galgasProgram.galgas3", 207)), inCompiler COMMA_HERE), var_declarationAST_8176  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 207)) ;
      }
    }
    if (GalgasBool::boolFalse == test_0) {
      GalgasBool test_1 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_1) {
        test_1 = GGS_bool (ComparisonKind::equal, enumerator_8529.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("galgasProgram.galgas3", 208)).objectCompare (GGS_string ("ggs"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_1) {
          GGS_string var_absoluteSourcePath_8850 = enumerator_8529.current_mValue (HERE).getter_absolutePathFromPath (var_sourcesDir_8443 COMMA_SOURCE_FILE ("galgasProgram.galgas3", 209)) ;
          cGrammar_galgas_34_Grammar::_performSourceFileParsing_ (inCompiler, GGS_lstring::init_21__21_ (var_absoluteSourcePath_8850, GGS_location::class_func_nowhere (SOURCE_FILE ("galgasProgram.galgas3", 210)), inCompiler COMMA_HERE), var_declarationAST_8176  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 210)) ;
        }
      }
    }
    enumerator_8529.gotoNextObject () ;
  }
  GGS_stringlist var_handCodedLinkToolFileList_9097 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  GGS_stringlist var_handCodedSourceToolFileList_9200 = constinArgument_inProjectComponentAST.readProperty_mToolCppSourceList () ;
  GGS_stringlist var_frameworkToolFileList_9289 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  GGS_stringset var_handCodedSourceDirectorySet_9334 = GGS_stringset::init (inCompiler COMMA_HERE) ;
  UpEnumerator__5B_galgasQualifiedFeature_5D_ enumerator_9407 (constinArgument_inProjectComponentAST.readProperty_mQualifiedFeatureList ()) ;
  while (enumerator_9407.hasCurrentObject ()) {
    GalgasBool test_2 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_2) {
      test_2 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("tool-include"))).boolEnum () ;
      if (GalgasBool::boolTrue == test_2) {
        var_handCodedSourceDirectorySet_9334.plusPlusAssignOperation (enumerator_9407.current (HERE).readProperty_featureValue ().readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 221)) ;
      }
    }
    if (GalgasBool::boolFalse == test_2) {
      GalgasBool test_3 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_3) {
        test_3 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("tool-framework"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_3) {
          var_frameworkToolFileList_9289.addAssignOperation (enumerator_9407.current (HERE).readProperty_featureValue ().readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 223))  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 223)) ;
        }
      }
      if (GalgasBool::boolFalse == test_3) {
        GalgasBool test_4 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_4) {
          test_4 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("tool-link"))).boolEnum () ;
          if (GalgasBool::boolTrue == test_4) {
            var_handCodedLinkToolFileList_9097.addAssignOperation (enumerator_9407.current (HERE).readProperty_featureValue ().readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 225)) ;
          }
        }
        if (GalgasBool::boolFalse == test_4) {
          GalgasBool test_5 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_5) {
            test_5 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("libpmAtPath"))).boolEnum () ;
            if (GalgasBool::boolTrue == test_5) {
            }
          }
          if (GalgasBool::boolFalse == test_5) {
            GalgasBool test_6 = GalgasBool::boolTrue ;
            if (GalgasBool::boolTrue == test_6) {
              test_6 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("applicationBundleBase"))).boolEnum () ;
              if (GalgasBool::boolTrue == test_6) {
              }
            }
            if (GalgasBool::boolFalse == test_6) {
              GalgasBool test_7 = GalgasBool::boolTrue ;
              if (GalgasBool::boolTrue == test_7) {
                test_7 = GGS_bool (ComparisonKind::equal, enumerator_9407.current (HERE).readProperty_featureName ().readProperty_string ().objectCompare (GGS_string ("macCodeSign"))).boolEnum () ;
                if (GalgasBool::boolTrue == test_7) {
                }
              }
              if (GalgasBool::boolFalse == test_7) {
                GenericArray <FixItDescription> fixItArray8 ;
                inCompiler->emitSemanticError (enumerator_9407.current (HERE).readProperty_featureName ().readProperty_location (), GGS_string ("unknown feature"), fixItArray8  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 230)) ;
              }
            }
          }
        }
  ...
  {
  routine_groupSyntaxComponentsGalgas_33__3F__3F__26_ (var_declarationAST_8176.readProperty_mSyntaxComponentList (), var_declarationAST_8176.readProperty_mSyntaxExtensions (), var_declarationAST_8176.mProperty_mDeclarationList, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 243)) ;
  }
  GGS_usefulEntitiesGraph var_usefulEntitiesGraph_10988 = GGS_usefulEntitiesGraph::init (inCompiler COMMA_HERE) ;
  GGS_string var_buildDirectoryName_11048 = GGS_string ("build") ;
  GGS_string var_absoluteBuildDirectory_11083 = constinArgument_inProjectSourceFile.readProperty_string ().getter_deletingLastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 251)).add_operation (GGS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 251)).add_operation (var_buildDirectoryName_11048, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 251)) ;
  GGS_string var_productDirectory_11194 = var_absoluteBuildDirectory_11083.add_operation (GGS_string ("/output"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 252)) ;
  GGS_stringlist var_appProductFileList_11266 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  GGS_semanticContext var_semanticContext_11314 ;
  GGS_unifiedTypeMap var_typeMap_11352 ;
  GGS_semanticDeclarationListForGeneration var_semanticDeclarationSortedListForGeneration_11404 ;
  GGS_lstringlist var_usefulnessRootEntities_11466 = GGS_lstringlist::init (inCompiler COMMA_HERE) ;
  GalgasBool test_9 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_9) {
    ...
    if (GalgasBool::boolTrue == test_9) {
      {
      routine_compileSemanticDeclarationsGalgas_26__26__3F_galgas_34__3F__3F__3F__21__21__21_ (var_usefulnessRootEntities_11466, var_usefulEntitiesGraph_10988, constinArgument_inGalgas_34_, var_productDirectory_11194, constinArgument_inProjectComponentAST.readProperty_mEndOfSourceFile (), var_declarationAST_8176, var_semanticContext_11314, var_typeMap_11352, var_semanticDeclarationSortedListForGeneration_11404, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 259)) ;
      }
    }
  }
  if (GalgasBool::boolFalse == test_9) {
    var_semanticDeclarationSortedListForGeneration_11404 = GGS_semanticDeclarationListForGeneration::init (inCompiler COMMA_HERE) ;
    var_semanticContext_11314 = GGS_semanticContext::init_21_galgas_34_ (constinArgument_inGalgas_34_, inCompiler COMMA_HERE) ;
    var_typeMap_11352 = GGS_unifiedTypeMap::init (inCompiler COMMA_HERE) ;
  }
  GGS_optionComponentMapForGeneration var_optionComponentMapForGeneration_12081 ;
  GalgasBool test_10 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_10) {
    ...
    if (GalgasBool::boolTrue == test_10) {
      {
      routine_compileAllGuiComponentFromASTGalgas_33__3F__3F__21_ (var_declarationAST_8176.readProperty_mGUIComponentList (), var_semanticContext_11314, var_optionComponentMapForGeneration_12081, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 278)) ;
      }
    }
  }
  if (GalgasBool::boolFalse == test_10) {
    var_optionComponentMapForGeneration_12081 = GGS_optionComponentMapForGeneration::init (inCompiler COMMA_HERE) ;
  }
  GalgasBool test_11 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_11) {
    ...
    if (GalgasBool::boolTrue == test_11) {
      GGS_string var_projectVersionString_12456 = constinArgument_inProjectComponentAST.readProperty_mMajorVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas3", 288)).add_operation (GGS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 288)).add_operation (constinArgument_inProjectComponentAST.readProperty_mMinorVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas3", 289)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 289)).add_operation (GGS_string ("."), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 289)).add_operation (constinArgument_inProjectComponentAST.readProperty_mRevisionVersion ().readProperty_bigint ().getter_string (SOURCE_FILE ("galgasProgram.galgas3", 290)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 290)) ;
      GGS_programComponentForGeneration var_programComponentForGeneration_12983 ;
      {
      routine_compileProgramComponentGalgas_33__26__26__3F__3F__3F__3F__26__3F__21_ (var_usefulnessRootEntities_11466, var_usefulEntitiesGraph_10988, var_declarationAST_8176.readProperty_mPrologueDeclarationList (), var_declarationAST_8176.readProperty_mSourceRuleList (), var_declarationAST_8176.readProperty_mEpilogueDeclarationList (), var_semanticContext_11314, var_typeMap_11352, var_projectVersionString_12456, var_programComponentForGeneration_12983, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 291)) ;
      }
      var_semanticDeclarationSortedListForGeneration_11404.addAssignOperation (GGS_string ("zprogram"), var_programComponentForGeneration_12983  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 302)) ;
    }
  }
  {
  routine_checkUsefulEntities_3F__3F__3F_ (var_usefulEntitiesGraph_10988, var_usefulnessRootEntities_11466, var_productDirectory_11194, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 305)) ;
  }
  GGS_string var_typeDumpFilePath_13376 = var_productDirectory_11194.add_operation (GGS_string ("/../helpers/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 307)).add_operation (constinArgument_inProjectSourceFile.readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 307)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 307)).add_operation (GGS_string (".html"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 307)) ;
  GalgasBool test_12 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_12) {
    test_12 = GGS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.readProperty_value ()).boolEnum () ;
    if (GalgasBool::boolTrue == test_12) {
      GGS_stringset var_firstLetterSet_13572 = GGS_stringset::init (inCompiler COMMA_HERE) ;
      UpEnumerator_unifiedTypeMap enumerator_13607 (var_typeMap_11352) ;
      while (enumerator_13607.hasCurrentObject ()) {
        var_firstLetterSet_13572.plusPlusAssignOperation (enumerator_13607.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GGS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 311)).getter_string (SOURCE_FILE ("galgasProgram.galgas3", 311))  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 311)) ;
        enumerator_13607.gotoNextObject () ;
      }
      GGS_string var_tableOfTypeString_13713 = GGS_string::makeEmptyString () ;
      GGS_char var_currentFirstLetter_13750 = GGS_char (utf32 (32)) ;
      UpEnumerator_unifiedTypeMap enumerator_13794 (var_typeMap_11352) ;
      while (enumerator_13794.hasCurrentObject ()) {
        GalgasBool test_13 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_13) {
          test_13 = GGS_bool (ComparisonKind::notEqual, var_currentFirstLetter_13750.objectCompare (enumerator_13794.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GGS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 316)))).boolEnum () ;
          if (GalgasBool::boolTrue == test_13) {
            var_currentFirstLetter_13750 = enumerator_13794.current_lkey (HERE).readProperty_string ().getter_characterAtIndex (GGS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 317)) ;
            var_tableOfTypeString_13713.plusAssignOperation(GGS_string ("<br><a name=\"").add_operation (var_currentFirstLetter_13750.getter_uint (SOURCE_FILE ("galgasProgram.galgas3", 318)).getter_string (SOURCE_FILE ("galgasProgram.galgas3", 318)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 318)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 318)) ;
            var_tableOfTypeString_13713.plusAssignOperation(GGS_string ("\"><b>").add_operation (var_currentFirstLetter_13750.getter_string (SOURCE_FILE ("galgasProgram.galgas3", 319)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 319)).add_operation (GGS_string ("</b></a><br>"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 319)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 319)) ;
          }
        }
        var_tableOfTypeString_13713.plusAssignOperation(function_linkForType (enumerator_13794.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 321)).add_operation (GGS_string ("<br>"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 321)), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 321)) ;
        enumerator_13794.gotoNextObject () ;
      }
      GGS_string var_typeDumpString_14196 = GGS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFile.readProperty_string ().getter_lastPathComponent (SOURCE_FILE ("galgasProgram.galgas3", 324)), var_typeMap_11352, var_firstLetterSet_13572, var_tableOfTypeString_13713 COMMA_SOURCE_FILE ("galgasProgram.galgas3", 323))) ;
      GGS_bool joker_14453 ; // Joker input parameter
      var_typeDumpString_14196.method_writeToFileWhenDifferentContents (var_typeDumpFilePath_13376, joker_14453, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 329)) ;
    }
  }
  if (GalgasBool::boolFalse == test_12) {
    {
    GGS_string::class_method_deleteFileIfExists (var_typeDumpFilePath_13376, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 331)) ;
    }
  }
  GalgasBool test_14 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_14) {
    ...
    if (GalgasBool::boolTrue == test_14) {
      {
      routine_performGalgas_33_ProjectGlobalCheckings_26__3F_ (var_typeMap_11352, var_declarationAST_8176.readProperty_mDeclarationList (), inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 335)) ;
      }
    }
  }
  GalgasBool test_15 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_15) {
    ...
    if (GalgasBool::boolTrue == test_15) {
      {
      routine_projectGeneration_3F__3F_absoluteBuildDir_3F_buildDirName_3F__3F__3F__3F__3F__3F__3F__3F__3F__3F_ (var_typeMap_11352, var_absoluteBuildDirectory_11083, var_buildDirectoryName_11048, var_optionComponentMapForGeneration_12081, var_appProductFileList_11266, var_semanticDeclarationSortedListForGeneration_11404, var_declarationAST_8176.readProperty_mSourceRuleList (), constinArgument_inProjectComponentAST, constinArgument_inProjectSourceFile.readProperty_string (), GGS_string ("../sources/tool-sources"), var_handCodedSourceToolFileList_9200, var_frameworkToolFileList_9289, var_handCodedLinkToolFileList_9097, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 342)) ;
      }
    }
  }
}
...
void routine_projectGeneration_3F__3F_absoluteBuildDir_3F_buildDirName_3F__3F__3F__3F__3F__3F__3F__3F__3F__3F_ (const GGS_unifiedTypeMap constinArgument_inTypeMap,
                                                                                                                ...
                                                                                                                Compiler * inCompiler
                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_stringlist var_appProductFileList_16448 = constinArgument_inAppProductFileList ;
  GalgasBool test_0 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_0) {
  ...
  GGS_stringset var_allProductFileSet_16640 = GGS_stringset::init (inCompiler COMMA_HERE) ;
  GGS_string var_userHeadersDir_16750 = constinArgument_inAbsoluteBuildDirectory.add_operation (GGS_string ("/user-headers"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 388)) ;
  var_userHeadersDir_16750.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 389)) ;
  GGS_bool var_quietOutputByDefault_16907 = GGS_stringset::class_func_setWithLStringList (constinArgument_inProjectComponentAST.readProperty_mGenerationFeatureList ()  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 391)).getter_hasKey (GGS_string ("quietOutputByDefault") COMMA_SOURCE_FILE ("galgasProgram.galgas3", 391)) ;
  GGS_string var_productDirectory_17107 = constinArgument_inAbsoluteBuildDirectory.add_operation (GGS_string ("/output"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 393)) ;
  GGS_stringlist var_swiftAppProductFileList_17181 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  GalgasBool test_1 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_1) {
    ...
    if (GalgasBool::boolTrue == test_1) {
      {
      routine_generateAllGuiComponentsGalgas_33__3F__3F__3F__26_swift (constinArgument_inOptionComponentMapForGeneration, var_productDirectory_17107, var_quietOutputByDefault_16907, var_swiftAppProductFileList_17181, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 396)) ;
      }
    }
  }
  GGS_stringlist var_toolCppFileList_17544 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  GGS_stringlist var_toolHeaderFileList_17584 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  {
  routine_generatePredefinedTypeFiles_3F__3F__26__26__26_ (var_productDirectory_17107, constinArgument_inSemanticDeclarationSortedListForGeneration, var_toolHeaderFileList_17584, var_toolCppFileList_17544, var_allProductFileSet_16640, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 408)) ;
  }
  {
  routine_generateSemanticDeclarationsGalgas_33__3F__3F__3F__26_swift_26__26__26_ (constinArgument_inTypeMap, var_productDirectory_17107, constinArgument_inSemanticDeclarationSortedListForGeneration, var_swiftAppProductFileList_17181, var_toolCppFileList_17544, var_toolHeaderFileList_17584, var_allProductFileSet_16640, inCompiler  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 415)) ;
  }
  GalgasBool test_2 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_2) {
    ...
    if (GalgasBool::boolTrue == test_2) {
      GGS_stringset var_handledExtensionSet_18166 = GGS_stringset::init (inCompiler COMMA_HERE) ;
      UpEnumerator_programRuleList enumerator_18232 (constinArgument_inSourceRuleList) ;
      while (enumerator_18232.hasCurrentObject ()) {
        var_handledExtensionSet_18166.plusPlusAssignOperation (enumerator_18232.current_mSourceFileExtension (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 429)) ;
        enumerator_18232.gotoNextObject () ;
      }
      GGS_stringset var_ignoredFeatureSet_18379 = GGS_stringset::init (inCompiler COMMA_HERE) ;
      var_ignoredFeatureSet_18379.plusPlusAssignOperation (GGS_string ("tool-framework")  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 433)) ;
      var_ignoredFeatureSet_18379.plusPlusAssignOperation (GGS_string ("tool-source")  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 434)) ;
      var_ignoredFeatureSet_18379.plusPlusAssignOperation (GGS_string ("tool-link")  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 435)) ;
      GGS_projectQualifiedFeatureMap var_projectQualifiedFeatureMap_18560 = GGS_projectQualifiedFeatureMap::init (inCompiler COMMA_HERE) ;
      UpEnumerator__5B_galgasQualifiedFeature_5D_ enumerator_18634 (constinArgument_inProjectComponentAST.readProperty_mQualifiedFeatureList ()) ;
      while (enumerator_18634.hasCurrentObject ()) {
        GalgasBool test_3 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_3) {
          test_3 = var_ignoredFeatureSet_18379.getter_hasKey (enumerator_18634.current (HERE).readProperty_featureName ().readProperty_string () COMMA_SOURCE_FILE ("galgasProgram.galgas3", 438)).operator_not (SOURCE_FILE ("galgasProgram.galgas3", 438)).boolEnum () ;
          if (GalgasBool::boolTrue == test_3) {
            {
            var_projectQualifiedFeatureMap_18560.setter_insertKey (enumerator_18634.current (HERE).readProperty_featureName (), enumerator_18634.current (HERE).readProperty_featureValue (), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 439)) ;
            }
          }
        }
  ...
  if (GalgasBool::boolTrue == test_4) {
    ...
    if (GalgasBool::boolTrue == test_4) {
      GGS_stringset var_allActualFileSet_19864 = GGS_stringset::init (inCompiler COMMA_HERE) ;
      UpEnumerator_stringlist enumerator_19970 (var_productDirectory_17107.getter_regularFiles (GGS_bool (false) COMMA_SOURCE_FILE ("galgasProgram.galgas3", 472))) ;
      while (enumerator_19970.hasCurrentObject ()) {
        var_allActualFileSet_19864.plusPlusAssignOperation (enumerator_19970.current_mValue (HERE)  COMMA_SOURCE_FILE ("galgasProgram.galgas3", 473)) ;
        enumerator_19970.gotoNextObject () ;
      }
      GGS_stringset var_uselessFileSet_20073 = var_allActualFileSet_19864.substract_operation (var_allProductFileSet_16640, inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 475)) ;
      UpEnumerator_stringset enumerator_20136 (var_uselessFileSet_20073) ;
      while (enumerator_20136.hasCurrentObject ()) {
        {
        GGS_string::class_method_deleteFile (var_productDirectory_17107.add_operation (GGS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 477)).add_operation (enumerator_20136.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 477)), inCompiler COMMA_SOURCE_FILE ("galgasProgram.galgas3", 477)) ;
        }
        enumerator_20136.gotoNextObject () ;
      }
    }
  }
}
