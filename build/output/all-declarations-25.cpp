...
void cPtr_templateInstructionIfForGeneration::method_templateCodeGeneration (GGS_string & ioArgument_ioGeneratedCode,
  ...
  #else
    cEnumerator_templateInstructionIfBranchListForGeneration enumerator_7565 (temp_2.readProperty_mTemplateInstructionIfBranchList (), EnumerationOrder::Up) ;
  #endif
...
void cPtr_templateInstructionForeachForGeneration::method_templateCodeGeneration (GGS_string & ioArgument_ioGeneratedCode,
  ...
  GGS_string temp_7 ;
  const GalgasBool test_8 = temp_6.readProperty_mIsAscending ().boolEnum () ;
  if (GalgasBool::boolTrue == test_8) {
