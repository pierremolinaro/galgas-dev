...
void cPtr_lexiqueComponentAST::method_semanticAnalysis (GALGAS_lstringlist & /* ioArgument_ioUsefulnessRootEntities */,
  ...
  if (kBoolTrue == test_39) {
    ...
    if (kBoolTrue == test_39) {
      ...
      GALGAS_string var_cocoaHeader_42079 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, temp_52.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexiqueAnalysisContext_33976 COMMA_SOURCE_FILE ("lexique-component.galgas", 1068))) ;
      ...
      GALGAS_string var_cocoaImplementation_42271 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, GALGAS_string ("lexique-").add_operation (temp_53.readProperty_mLexiqueComponentName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("lexique-component.galgas", 1074)), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 1074)).add_operation (GALGAS_string ("-cocoa"), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 1074)), temp_54.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexiqueAnalysisContext_33976.readProperty_mLexicalAttributeMap (), var_lexiqueAnalysisContext_33976.readProperty_mLexicalMessageMap (), var_lexiqueAnalysisContext_33976.readProperty_mTerminalList (), var_lexiqueAnalysisContext_33976.readProperty_mUnicodeStringToGenerate (), temp_55.readProperty_mLexicalRuleListAST (), var_lexiqueAnalysisContext_33976, temp_56.readProperty_mTemplateReplacementListAST (), temp_57.readProperty_mIndexingDirectoryAST ().readProperty_string (), temp_58.readProperty_mIndexingListAST (), temp_59.readProperty_mLexicalStyleListAST (), temp_60.readProperty_mTemplateDelimitorListAST () COMMA_SOURCE_FILE ("lexique-component.galgas", 1073))) ;
      const GALGAS_lexiqueComponentAST temp_61 = this ;
      const GALGAS_lexiqueComponentAST temp_62 = this ;
      ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_lexiqueDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("lexique-").add_operation (temp_61.readProperty_mLexiqueComponentName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("lexique-component.galgas", 1093)), inCompiler COMMA_SOURCE_FILE ("lexique-component.galgas", 1093)), temp_62.readProperty_mLexiqueComponentName ().readProperty_string (), var_headerContents_41036, var_cppContents_41340, var_cocoaHeader_42079, var_cocoaImplementation_42271  COMMA_SOURCE_FILE ("lexique-component.galgas", 1091))  COMMA_SOURCE_FILE ("lexique-component.galgas", 1089)) ;
    }
  }
}
