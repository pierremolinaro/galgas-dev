...
void extensionSetter_insertKey (GALGAS_routineMap & ioObject,
                                ...
                                const GALGAS_bool constinArgument_inIsInternal,
                                Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioObject.mProperty_mInternalRoutineMap.setter_insertKey (constinArgument_inRoutineName, constinArgument_inRoutineSignature, constinArgument_inIsInternal, inCompiler COMMA_SOURCE_FILE ("routineMap.galgas", 45)) ;
  }
}
