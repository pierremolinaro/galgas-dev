...
void extensionSetter_addToolTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  GALGAS_string var_buildPhaseRef_5107 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildPhaseRef_5107, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 127)) ;
  }
  {
  ...
  GALGAS_string var_buildConfigurationListRef_5202 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildConfigurationListRef_5202, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 129)) ;
  }
  GALGAS_string var_buildConfigurationRef_5264 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildConfigurationRef_5264, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 130)) ;
  }
  GALGAS_string var_frameworkBuildRef_5322 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_frameworkBuildRef_5322, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 131)) ;
  }
  ioObject.mProperty_mToolTargetList.addAssign_operation (outArgument_outTargetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef_5107, var_buildConfigurationListRef_5202, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef_5264, constinArgument_inToolFrameworksFileRefList, var_frameworkBuildRef_5322  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 132)) ;
}
...
void extensionSetter_addAppTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  GALGAS_string var_buildPhaseRef_6385 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildPhaseRef_6385, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 159)) ;
  }
  GALGAS_string var_targetRef_6435 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_targetRef_6435, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 160)) ;
  }
  GALGAS_string var_buildConfigurationListRef_6481 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildConfigurationListRef_6481, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 161)) ;
  }
  GALGAS_string var_buildConfigurationRef_6543 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_buildConfigurationRef_6543, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 162)) ;
  }
  GALGAS_string var_frameworkBuildRef_6601 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_frameworkBuildRef_6601, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 163)) ;
  }
  GALGAS_string var_resourceBuildRef_6655 ;
  {
  extensionSetter_getReferenceKey (ioObject, var_resourceBuildRef_6655, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 164)) ;
  }
  GALGAS__32_stringlist var_dependentTargets_6692 = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 165)) ;
  cEnumerator_stringlist enumerator_6721 (constinArgument_inDependentTargetRefList, kENUMERATION_UP) ;
  while (enumerator_6721.hasCurrentObject ()) {
    GALGAS_string var_dependencyBuildRef_6794 ;
    {
    extensionSetter_getReferenceKey (ioObject, var_dependencyBuildRef_6794, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 167)) ;
    }
    var_dependentTargets_6692.addAssign_operation (var_dependencyBuildRef_6794, enumerator_6721.current_mValue (HERE)  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 168)) ;
    enumerator_6721.gotoNextObject () ;
  }
  GALGAS_stringlist var_resourceFileBuildRefs_6887 = constinArgument_inResourceFileBuildRefs ;
  cEnumerator__32_stringlist enumerator_6946 (constinArgument_inProductCopyList, kENUMERATION_UP) ;
  while (enumerator_6946.hasCurrentObject ()) {
    GALGAS_string var_buildRef_7051 ;
    {
    extensionSetter_addBuildFile (ioObject, enumerator_6946.current_mValue_30_ (HERE), enumerator_6946.current_mValue_31_ (HERE), var_buildRef_7051, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 172)) ;
    }
    var_resourceFileBuildRefs_6887.addAssign_operation (var_buildRef_7051  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 173)) ;
    enumerator_6946.gotoNextObject () ;
  }
  ioObject.mProperty_mAppTargetList.addAssign_operation (var_targetRef_6435, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef_6385, var_buildConfigurationListRef_6481, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef_6543, constinArgument_inFrameworksFileRefList, var_frameworkBuildRef_6601, var_dependentTargets_6692, var_resourceBuildRef_6655, var_resourceFileBuildRefs_6887  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 175)) ;
}
...
void extensionSetter_addGroupWithFiles (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  GALGAS_stringlist var_childrenRefs_9285 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 237)) ;
  cEnumerator_stringset enumerator_9310 (constinArgument_inFileNames, kENUMERATION_UP) ;
  while (enumerator_9310.hasCurrentObject ()) {
    enumGalgasBool test_6 = kBoolTrue ;
    if (kBoolTrue == test_6) {
      test_6 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 239)).objectCompare (GALGAS_string ("c"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_string var_cFileRef_9424 ;
        {
        extensionSetter_addCFile (ioObject, enumerator_9310.current_key (HERE), var_cFileRef_9424, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 240)) ;
        }
        var_childrenRefs_9285.addAssign_operation (var_cFileRef_9424  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 241)) ;
        GALGAS_string var_buildRef_9545 ;
        {
        extensionSetter_addBuildFile (ioObject, var_cFileRef_9424, enumerator_9310.current_key (HERE), var_buildRef_9545, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 242)) ;
        }
        ioArgument_ioCFileBuildRefs.addAssign_operation (var_buildRef_9545  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 243)) ;
      }
    }
    if (kBoolFalse == test_6) {
      enumGalgasBool test_7 = kBoolTrue ;
      if (kBoolTrue == test_7) {
        test_7 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 244)).objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_string var_cppFileRef_9691 ;
          {
          extensionSetter_addCppFile (ioObject, enumerator_9310.current_key (HERE), var_cppFileRef_9691, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 245)) ;
          }
          var_childrenRefs_9285.addAssign_operation (var_cppFileRef_9691  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 246)) ;
          GALGAS_string var_buildRef_9818 ;
          {
          extensionSetter_addBuildFile (ioObject, var_cppFileRef_9691, enumerator_9310.current_key (HERE), var_buildRef_9818, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 247)) ;
          }
          ioArgument_ioCppFileBuildRefs.addAssign_operation (var_buildRef_9818  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 248)) ;
        }
      }
      if (kBoolFalse == test_7) {
        enumGalgasBool test_8 = kBoolTrue ;
        if (kBoolTrue == test_8) {
          test_8 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 249)).objectCompare (GALGAS_string ("h"))).boolEnum () ;
          if (kBoolTrue == test_8) {
            GALGAS_string var_headerFileRef_9967 ;
            {
            extensionSetter_addHeaderFile (ioObject, enumerator_9310.current_key (HERE), var_headerFileRef_9967, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 250)) ;
            }
            var_childrenRefs_9285.addAssign_operation (var_headerFileRef_9967  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 251)) ;
          }
        }
        if (kBoolFalse == test_8) {
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 252)).objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              GALGAS_string var_m_5F_FileRef_10115 ;
              {
              extensionSetter_addMFile (ioObject, enumerator_9310.current_key (HERE), var_m_5F_FileRef_10115, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 253)) ;
              }
              GALGAS_string var_buildRef_10206 ;
              {
              extensionSetter_addBuildFile (ioObject, var_m_5F_FileRef_10115, enumerator_9310.current_key (HERE), var_buildRef_10206, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 254)) ;
              }
              var_childrenRefs_9285.addAssign_operation (var_m_5F_FileRef_10115  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 255)) ;
              ioArgument_ioMFileBuildRefs.addAssign_operation (var_buildRef_10206  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 256)) ;
            }
          }
          if (kBoolFalse == test_9) {
            enumGalgasBool test_10 = kBoolTrue ;
            if (kBoolTrue == test_10) {
              test_10 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 257)).objectCompare (GALGAS_string ("mm"))).boolEnum () ;
              if (kBoolTrue == test_10) {
                GALGAS_string var_m_5F_FileRef_10383 ;
                {
                extensionSetter_addMMFile (ioObject, enumerator_9310.current_key (HERE), var_m_5F_FileRef_10383, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 258)) ;
                }
                GALGAS_string var_buildRef_10474 ;
                {
                extensionSetter_addBuildFile (ioObject, var_m_5F_FileRef_10383, enumerator_9310.current_key (HERE), var_buildRef_10474, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 259)) ;
                }
                var_childrenRefs_9285.addAssign_operation (var_m_5F_FileRef_10383  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 260)) ;
                ioArgument_ioMMFileBuildRefs.addAssign_operation (var_buildRef_10474  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 261)) ;
              }
            }
            if (kBoolFalse == test_10) {
              enumGalgasBool test_11 = kBoolTrue ;
              if (kBoolTrue == test_11) {
                test_11 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 262)).objectCompare (GALGAS_string ("framework"))).boolEnum () ;
                if (kBoolTrue == test_11) {
                  GALGAS_string var_framework_5F_FileRef_10666 ;
                  {
                  extensionSetter_addFrameworkFile (ioObject, enumerator_9310.current_key (HERE), var_framework_5F_FileRef_10666, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 263)) ;
                  }
                  GALGAS_string var_buildRef_10773 ;
                  {
                  extensionSetter_addBuildFile (ioObject, var_framework_5F_FileRef_10666, enumerator_9310.current_key (HERE), var_buildRef_10773, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 264)) ;
                  }
                  var_childrenRefs_9285.addAssign_operation (var_framework_5F_FileRef_10666  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 265)) ;
                  ioArgument_ioFrameWorkFileBuildRefs.addAssign_operation (var_buildRef_10773  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 266)) ;
                }
              }
              if (kBoolFalse == test_11) {
                enumGalgasBool test_12 = kBoolTrue ;
                if (kBoolTrue == test_12) {
                  test_12 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 267)).objectCompare (GALGAS_string ("plist"))).boolEnum () ;
                  if (kBoolTrue == test_12) {
                    GALGAS_string var_resource_5F_FileRef_10976 ;
                    {
                    extensionSetter_addInfoPlistFile (ioObject, enumerator_9310.current_key (HERE), var_resource_5F_FileRef_10976, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 268)) ;
                    }
                    var_childrenRefs_9285.addAssign_operation (var_resource_5F_FileRef_10976  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 269)) ;
                  }
                }
                if (kBoolFalse == test_12) {
                  enumGalgasBool test_13 = kBoolTrue ;
                  if (kBoolTrue == test_13) {
                    test_13 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 270)).objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                    if (kBoolTrue == test_13) {
                      GALGAS_string var_resource_5F_FileRef_11134 ;
                      {
                      extensionSetter_addXIBFile (ioObject, enumerator_9310.current_key (HERE), var_resource_5F_FileRef_11134, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 271)) ;
                      }
                      var_childrenRefs_9285.addAssign_operation (var_resource_5F_FileRef_11134  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 272)) ;
                      GALGAS_string var_buildRef_11279 ;
                      {
                      extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11134, enumerator_9310.current_key (HERE), var_buildRef_11279, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 273)) ;
                      }
                      ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_11279  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 274)) ;
                    }
                  }
                  if (kBoolFalse == test_13) {
                    enumGalgasBool test_14 = kBoolTrue ;
                    if (kBoolTrue == test_14) {
                      test_14 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 275)).objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        GALGAS_string var_resource_5F_FileRef_11435 ;
                        {
                        extensionSetter_addTIFF_5F_file (ioObject, enumerator_9310.current_key (HERE), var_resource_5F_FileRef_11435, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 276)) ;
                        }
                        var_childrenRefs_9285.addAssign_operation (var_resource_5F_FileRef_11435  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 277)) ;
                        GALGAS_string var_buildRef_11580 ;
                        {
                        extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11435, enumerator_9310.current_key (HERE), var_buildRef_11580, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 278)) ;
                        }
                        ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_11580  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 279)) ;
                      }
                    }
                    if (kBoolFalse == test_14) {
                      enumGalgasBool test_15 = kBoolTrue ;
                      if (kBoolTrue == test_15) {
                        test_15 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 280)).objectCompare (GALGAS_string ("icns"))).boolEnum () ;
                        if (kBoolTrue == test_15) {
                          GALGAS_string var_resource_5F_FileRef_11736 ;
                          {
                          extensionSetter_addICNS_5F_file (ioObject, enumerator_9310.current_key (HERE), var_resource_5F_FileRef_11736, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 281)) ;
                          }
                          var_childrenRefs_9285.addAssign_operation (var_resource_5F_FileRef_11736  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 282)) ;
                          GALGAS_string var_buildRef_11881 ;
                          {
                          extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11736, enumerator_9310.current_key (HERE), var_buildRef_11881, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 283)) ;
                          }
                          ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_11881  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 284)) ;
                        }
                      }
                      if (kBoolFalse == test_15) {
                        enumGalgasBool test_16 = kBoolTrue ;
                        if (kBoolTrue == test_16) {
                          test_16 = GALGAS_bool (kIsEqual, enumerator_9310.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 285)).objectCompare (GALGAS_string ("swift"))).boolEnum () ;
                          if (kBoolTrue == test_16) {
                          }
                        }
                        if (kBoolFalse == test_16) {
                          TC_Array <C_FixItDescription> fixItArray17 ;
                          inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 288)), GALGAS_string ("unhandled extension for file '").add_operation (enumerator_9310.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 288)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 288)), fixItArray17  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 288)) ;
                        }
                      }
                    }
                  }
  ...
  ioObject.mProperty_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs_9285  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 291)) ;
}
...
void extensionSetter_placeGroupAsMainGroup (GALGAS_XcodeProjectDescriptor & ioObject,
                                            ...
                                            C_Compiler * /* inCompiler */
                                            COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mProperty_mMainGroupChildrenRefs.addAssign_operation (constinArgument_inGroupRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 298)) ;
}
...
void extensionSetter_addSettingsToDefaultConfiguration (GALGAS_XcodeProjectDescriptor & ioObject,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mProperty_mDefaultConfigurationSettingList.plusAssign_operation(constinArgument_inSettingList, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 305)) ;
}
...
void extensionSetter_getReferenceKey (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      ioObject.mProperty_mProjectObjectReference = temp_2.readProperty_mSequenceNumber ().getter_string (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 365)).getter_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 365)).getter_rightSubString (GALGAS_uint (uint32_t (24U)) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 365)) ;
      ioObject.mProperty_mSequenceNumber.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 366)) ;
    }
  }
  const GALGAS_XcodeProjectDescriptor temp_3 = ioObject ;
  outArgument_outRef = temp_3.readProperty_mSequenceNumber ().getter_string (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 368)).getter_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 368)).getter_rightSubString (GALGAS_uint (uint32_t (24U)) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 368)) ;
  ioObject.mProperty_mSequenceNumber.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 369)) ;
}
...
GALGAS_templateExpressionListAST_2D_element GALGAS_templateExpressionListAST_2D_element::constructor_new (const GALGAS_lstring & in_mActualSelector,
...
GALGAS_templateInstructionIfBranchListForGeneration_2D_element GALGAS_templateInstructionIfBranchListForGeneration_2D_element::constructor_new (const GALGAS_semanticExpressionForGeneration & in_mExpression,
...
GALGAS_templateVariableMap_2D_element GALGAS_templateVariableMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_templateReplacementListAST_2D_element GALGAS_templateReplacementListAST_2D_element::constructor_new (const GALGAS_lstring & in_mMatchString,
...
GALGAS_lexicalMessageDeclarationListAST_2D_element GALGAS_lexicalMessageDeclarationListAST_2D_element::constructor_new (const GALGAS_lstring & in_mMessageName,
...
GALGAS_lexicalAttributeListAST_2D_element GALGAS_lexicalAttributeListAST_2D_element::constructor_new (const GALGAS_lstring & in_mTypeName,
...
GALGAS_lexicalStyleListAST_2D_element GALGAS_lexicalStyleListAST_2D_element::constructor_new (const GALGAS_lstring & in_mName,
...
GALGAS_terminalDeclarationListAST_2D_element GALGAS_terminalDeclarationListAST_2D_element::constructor_new (const GALGAS_lstring & in_mName,
...
GALGAS_sentLexicalAttributeListAST_2D_element GALGAS_sentLexicalAttributeListAST_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
...
GALGAS_lexicalListDeclarationListAST_2D_element GALGAS_lexicalListDeclarationListAST_2D_element::constructor_new (const GALGAS_lstring & in_mName,
                                                                                                                  const GALGAS_lstring & in_mStyle,
                                                                                                                  const GALGAS_lstring & in_mSyntaxErrorMessage,
                                                                                                                  const GALGAS_sentLexicalAttributeListAST & in_mSentAttributeList,
...
GALGAS_lexicalSendSearchListAST_2D_element GALGAS_lexicalSendSearchListAST_2D_element::constructor_new (const GALGAS_lstring & in_mAttributeName,
...
GALGAS_indexingListAST_2D_element GALGAS_indexingListAST_2D_element::constructor_new (const GALGAS_lstring & in_mIndexName,
...
GALGAS_lexicalSentValueList_2D_element GALGAS_lexicalSentValueList_2D_element::constructor_new (const GALGAS_lstring & in_mLexicalFormalSelector,
...
GALGAS_terminalMap_2D_element GALGAS_terminalMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_lexicalTypeMap_2D_element GALGAS_lexicalTypeMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                    const GALGAS_lexicalTypeEnum & in_mLexicalType 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_lexicalAttributeMap_2D_element GALGAS_lexicalAttributeMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                              const GALGAS_lexicalTypeEnum & in_mLexicalType 
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_lexicalExplicitTokenListMapMap_2D_element GALGAS_lexicalExplicitTokenListMapMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_lexicalMessageMap_2D_element GALGAS_lexicalMessageMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_lexicalRoutineMap_2D_element GALGAS_lexicalRoutineMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_lexicalFunctionMap_2D_element GALGAS_lexicalFunctionMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_templateDelimitorList_2D_element GALGAS_templateDelimitorList_2D_element::constructor_new (const GALGAS_lstring & in_mStartString,
                                                                                                  const GALGAS_lstring & in_mEndString,
...
GALGAS_styleMap_2D_element GALGAS_styleMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                        const GALGAS_lstring & in_mComment,
                                                                        const GALGAS_uint & in_mStyleIndex 
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_lexicalTagMap_2D_element GALGAS_lexicalTagMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_commandLineOptionListAST_2D_element GALGAS_commandLineOptionListAST_2D_element::constructor_new (const GALGAS_lstring & in_mOptionTypeName,
...
GALGAS_commandLineOptionMap_2D_element GALGAS_commandLineOptionMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_guiSimpleAttributeListAST_2D_element GALGAS_guiSimpleAttributeListAST_2D_element::constructor_new (const GALGAS_lstring & in_mKey,
...
GALGAS_guiCompoundAttributeListAST_2D_element GALGAS_guiCompoundAttributeListAST_2D_element::constructor_new (const GALGAS_lstring & in_mKey,
                                                                                                              const GALGAS_lstring & in_mAttributeName,
                                                                                                              const GALGAS_lstring & in_mValue 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_terminalLabelListAST_2D_element GALGAS_terminalLabelListAST_2D_element::constructor_new (const GALGAS_lstring & in_mTerminal,
...
GALGAS_withLexiqueListAST_2D_element GALGAS_withLexiqueListAST_2D_element::constructor_new (const GALGAS_lstring & in_mLexiqueFileName,
...
GALGAS_extensionMap_2D_element GALGAS_extensionMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_projectIndexingDescriptorList_2D_element GALGAS_projectIndexingDescriptorList_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_projectIndexingDescriptorList_2D_element (GALGAS_lstring::constructor_default (HERE),
                                                          GALGAS_lstring::constructor_default (HERE)) ;
}

//----------------------------------------------------------------------------------------------------------------------

GALGAS_projectIndexingDescriptorList_2D_element GALGAS_projectIndexingDescriptorList_2D_element::constructor_new (const GALGAS_lstring & in_mProjectFileExtension,
...
typeComparisonResult GALGAS_projectIndexingDescriptorList_2D_element::objectCompare (const GALGAS_projectIndexingDescriptorList_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_projectIndexingDescriptorList_2D_element ("projectIndexingDescriptorList-element",
                                                                 nullptr) ;
...
GALGAS_galgasGUIComponentListAST_2D_element GALGAS_galgasGUIComponentListAST_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_galgasGUIComponentListAST_2D_element (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_galgasGUIComponentListAST_2D_element GALGAS_galgasGUIComponentListAST_2D_element::constructor_new (const GALGAS_lstring & in_mGUIComponentName,
...
typeComparisonResult GALGAS_galgasGUIComponentListAST_2D_element::objectCompare (const GALGAS_galgasGUIComponentListAST_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_galgasGUIComponentListAST_2D_element ("galgasGUIComponentListAST-element",
                                                             nullptr) ;
...
GALGAS_optionComponentMapForGeneration_2D_element GALGAS_optionComponentMapForGeneration_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_enumConstantList_2D_element GALGAS_enumConstantList_2D_element::constructor_new (const GALGAS_lstring & in_mConstantName,
...
GALGAS_typeNameFormalParameterNameList_2D_element GALGAS_typeNameFormalParameterNameList_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
...
GALGAS_externTypeConstructorList_2D_element GALGAS_externTypeConstructorList_2D_element::constructor_new (const GALGAS_lstring & in_mConstructorName,
...
GALGAS_externTypeGetterList_2D_element GALGAS_externTypeGetterList_2D_element::constructor_new (const GALGAS_lstring & in_mGetterName,
                                                                                                const GALGAS_lstring & in_mResultTypeName,
                                                                                                const GALGAS_typeNameFormalParameterNameList & in_mParameterList 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_externTypeSetterList_2D_element GALGAS_externTypeSetterList_2D_element::constructor_new (const GALGAS_lstring & in_mSetterName,
...
GALGAS_externTypeMethodList_2D_element GALGAS_externTypeMethodList_2D_element::constructor_new (const GALGAS_lstring & in_mMethodName,
                                                                                                const GALGAS_formalParameterListAST & in_mFormalParameterList,
...
GALGAS_graphInsertModifierList_2D_element GALGAS_graphInsertModifierList_2D_element::constructor_new (const GALGAS_lstring & in_mInsertModifierName,
...
GALGAS_insertMethodListAST_2D_element GALGAS_insertMethodListAST_2D_element::constructor_new (const GALGAS_lstring & in_mInsertMethodName,
...
GALGAS_mapRemoveMethodListAST_2D_element GALGAS_mapRemoveMethodListAST_2D_element::constructor_new (const GALGAS_lstring & in_mMethodName,
                                                                                                    const GALGAS_lstring & in_mErrorMessage 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_insertMethodMap_2D_element GALGAS_insertMethodMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_searchMethodMap_2D_element GALGAS_searchMethodMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_sortedListSortDescriptorListAST_2D_element GALGAS_sortedListSortDescriptorListAST_2D_element::constructor_new (const GALGAS_lstring & in_mSortedAttributeName,
...
GALGAS_formalParameterListAST_2D_element GALGAS_formalParameterListAST_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
...
GALGAS_formalInputParameterListAST_2D_element GALGAS_formalInputParameterListAST_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
                                                                                                              const GALGAS_lstring & in_mFormalArgumentTypeName,
                                                                                                              const GALGAS_lstring & in_mFormalArgumentName,
                                                                                                              const GALGAS_bool & in_mIsUnused,
...
GALGAS_actualInputParameterListAST_2D_element GALGAS_actualInputParameterListAST_2D_element::constructor_new (const GALGAS_lstring & in_mActualSelector,
...
GALGAS_formalTemplateInputParameterListAST_2D_element GALGAS_formalTemplateInputParameterListAST_2D_element::constructor_new (const GALGAS_lstring & in_mFormalTemplateSelector,
                                                                                                                              const GALGAS_lstring & in_mFormalArgumentTypeName,
                                                                                                                              const GALGAS_lstring & in_mFormalArgumentName,
                                                                                                                              const GALGAS_bool & in_mIsUnused 
                                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_filewrapperTemplateListAST_2D_element GALGAS_filewrapperTemplateListAST_2D_element::constructor_new (const GALGAS_lstring & in_mFilewrapperTemplateName,
...
GALGAS_nonTerminalLabelListAST_2D_element GALGAS_nonTerminalLabelListAST_2D_element::constructor_new (const GALGAS_lstring & in_mLabelName,
...
GALGAS_nonterminalDeclarationListAST_2D_element GALGAS_nonterminalDeclarationListAST_2D_element::constructor_new (const GALGAS_lstring & in_mNonterminalName,
...
GALGAS_syntaxRuleLabelListAST_2D_element GALGAS_syntaxRuleLabelListAST_2D_element::constructor_new (const GALGAS_lstring & in_mLabelName,
...
GALGAS_syntaxRuleListAST_2D_element GALGAS_syntaxRuleListAST_2D_element::constructor_new (const GALGAS_lstring & in_mNonterminalName,
...
GALGAS_galgas_33_SyntaxComponentListAST_2D_element GALGAS_galgas_33_SyntaxComponentListAST_2D_element::constructor_new (const GALGAS_lstring & in_mSyntaxComponentName,
...
GALGAS_galgas_33_SyntaxExtensionListAST_2D_element GALGAS_galgas_33_SyntaxExtensionListAST_2D_element::constructor_new (const GALGAS_lstring & in_mSyntaxComponentName,
                                                                                                                        const GALGAS_nonterminalDeclarationListAST & in_mNonterminalDeclarationList,
                                                                                                                        const GALGAS_syntaxRuleListAST & in_mRuleList 
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_programRuleList_2D_element GALGAS_programRuleList_2D_element::constructor_new (const GALGAS_lstring & in_mSourceFileExtension,
...
GALGAS_functionSignature_2D_element GALGAS_functionSignature_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
...
GALGAS_optionalMethodSignature_2D_element GALGAS_optionalMethodSignature_2D_element::constructor_new (const GALGAS_bool & in_mInputArgument,
...
GALGAS_optionalMethodMap_2D_element GALGAS_optionalMethodMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_getterMap_2D_element GALGAS_getterMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_formalParameterSignature_2D_element GALGAS_formalParameterSignature_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
                                                                                                        const GALGAS_unifiedTypeMapEntry & in_mFormalArgumentType,
                                                                                                        const GALGAS_formalArgumentPassingModeAST & in_mFormalArgumentPassingMode,
                                                                                                        const GALGAS_string & in_mFormalArgumentName 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_setterMap_2D_element GALGAS_setterMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                          const GALGAS_methodKind & in_mKind,
...
GALGAS_instanceMethodMap_2D_element GALGAS_instanceMethodMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                          const GALGAS_methodKind & in_mKind,
                                                                                          const GALGAS_formalParameterSignature & in_mParameterList,
                                                                                          const GALGAS_location & in_mDeclarationLocation,
                                                                                          const GALGAS_bool & in_mHasCompilerArgument,
...
GALGAS_classMethodMap_2D_element GALGAS_classMethodMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                    const GALGAS_formalParameterSignature & in_mParameterList,
                                                                                    const GALGAS_bool & in_mHasCompilerArgument 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_constantIndexMap_2D_element GALGAS_constantIndexMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                        const GALGAS_uint & in_mIndex,
...
GALGAS_grammarLabelMap_2D_element GALGAS_grammarLabelMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_grammarMap_2D_element GALGAS_grammarMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_routineMap_2D_element GALGAS_routineMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
  ...
  if (in_lkey.isValid () && in_mRoutineSignature.isValid () && in_mIsInternal.isValid ()) {
    result = GALGAS_routineMap_2D_element (in_lkey, in_mRoutineSignature, in_mIsInternal) ;
  }
  return result ;
}
...
GALGAS_functionMap_2D_element GALGAS_functionMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_wrapperFileMap_2D_element GALGAS_wrapperFileMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_wrapperDirectoryMap_2D_element GALGAS_wrapperDirectoryMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_filewrapperTemplateMap_2D_element GALGAS_filewrapperTemplateMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_filewrapperMap_2D_element GALGAS_filewrapperMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_optionComponentMapForSemanticAnalysis_2D_element GALGAS_optionComponentMapForSemanticAnalysis_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_lexiqueComponentMapForSemanticAnalysis_2D_element GALGAS_lexiqueComponentMapForSemanticAnalysis_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_syntaxComponentMap_2D_element GALGAS_syntaxComponentMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_extensionMethodMapForType_2D_element GALGAS_extensionMethodMapForType_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                                          const GALGAS_formalParameterListAST & in_mFormalParameterList,
                                                                                                          const GALGAS_methodQualifier & in_mQualifier 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_extensionMethodMapForBuildingContext_2D_element GALGAS_extensionMethodMapForBuildingContext_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_extensionSetterMapForType_2D_element GALGAS_extensionSetterMapForType_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                                          const GALGAS_formalParameterListAST & in_mFormalParameterList 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_extensionSetterMapForBuildingContext_2D_element GALGAS_extensionSetterMapForBuildingContext_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_extensionGetterMapForType_2D_element GALGAS_extensionGetterMapForType_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
                                                                                                          const GALGAS_lstring & in_mResultTypeName,
...
GALGAS_extensionGetterMapForBuildingContext_2D_element GALGAS_extensionGetterMapForBuildingContext_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_wrapperExtensionMap_2D_element GALGAS_wrapperExtensionMap_2D_element::constructor_new (const GALGAS_lstring & in_lkey 
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_semanticExpressionListForGeneration_2D_element GALGAS_semanticExpressionListForGeneration_2D_element::constructor_new (const GALGAS_semanticExpressionForGeneration & in_mExpression 
                                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_formalParameterListForGeneration_2D_element GALGAS_formalParameterListForGeneration_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
                                                                                                                        const GALGAS_formalArgumentPassingModeAST & in_mFormalArgumentPassingMode,
                                                                                                                        const GALGAS_unifiedTypeMapEntry & in_mFormalArgumentType,
                                                                                                                        const GALGAS_lstring & in_mFormalArgumentName,
...
GALGAS_formalInputParameterListForGeneration_2D_element GALGAS_formalInputParameterListForGeneration_2D_element::constructor_new (const GALGAS_lstring & in_mFormalSelector,
                                                                                                                                  const GALGAS_unifiedTypeMapEntry & in_mFormalArgumentType,
                                                                                                                                  const GALGAS_string & in_mFormalArgumentCppName,
                                                                                                                                  const GALGAS_lstring & in_mFormalArgumentName,
                                                                                                                                  const GALGAS_bool & in_mIsConstant 
...
GALGAS_signatureForGrammarAnalysis_2D_element GALGAS_signatureForGrammarAnalysis_2D_element::constructor_new (const GALGAS_formalArgumentPassingModeAST & in_mFormalArgumentPassingModeForGrammarAnalysis,
...
GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis_2D_element GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_nonTerminalSymbolMapForGrammarAnalysis_2D_element GALGAS_nonTerminalSymbolMapForGrammarAnalysis_2D_element::constructor_new (const GALGAS_lstring & in_lkey,
...
GALGAS_localConstantList_2D_element GALGAS_localConstantList_2D_element::constructor_new (const GALGAS_unifiedTypeMapEntry & in_mType,
                                                                                          const GALGAS_lstring & in_mName,
...
GALGAS_localInitializedVariableList_2D_element GALGAS_localInitializedVariableList_2D_element::constructor_new (const GALGAS_unifiedTypeMapEntry & in_mType,
                                                                                                                const GALGAS_lstring & in_mName,
                                                                                                                const GALGAS_string & in_mCppName 
                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
