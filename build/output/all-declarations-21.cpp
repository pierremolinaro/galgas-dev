...
void extensionSetter_addAppTarget (GGS_XcodeProjectDescriptor & ioObject,
  ...
  cEnumerator_stringlist enumerator_6977 (constinArgument_inDependentTargetRefList, EnumerationOrder::up) ;
  while (enumerator_6977.hasCurrentObject ()) {
    GGS_string var_dependencyBuildRef_7050 ;
    {
    extensionSetter_getReferenceKey (ioObject, var_dependencyBuildRef_7050, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 178)) ;
    }
    var_dependentTargets_6947.addAssign_operation (var_dependencyBuildRef_7050, enumerator_6977.current_mValue (HERE)  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 179)) ;
    enumerator_6977.gotoNextObject () ;
  }
  GGS_stringlist var_resourceFileBuildRefs_7143 = constinArgument_inResourceFileBuildRefs ;
  cEnumerator__32_stringlist enumerator_7202 (constinArgument_inProductCopyList, EnumerationOrder::up) ;
  while (enumerator_7202.hasCurrentObject ()) {
    GGS_string var_buildRef_7307 ;
    {
    extensionSetter_addBuildFile (ioObject, enumerator_7202.current_mValue_30_ (HERE), enumerator_7202.current_mValue_31_ (HERE), var_buildRef_7307, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 183)) ;
    }
    var_resourceFileBuildRefs_7143.addAssign_operation (var_buildRef_7307  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 184)) ;
    enumerator_7202.gotoNextObject () ;
  }
  ioObject.mProperty_mAppTargetList.addAssign_operation (var_targetRef_6690, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef_6640, var_buildConfigurationListRef_6736, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef_6798, constinArgument_inFrameworksFileRefList, var_frameworkBuildRef_6856, var_dependentTargets_6947, var_resourceBuildRef_6910, var_resourceFileBuildRefs_7143  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 186)) ;
}
...
void extensionSetter_addGroupWithFiles (GGS_XcodeProjectDescriptor & ioObject,
  ...
  GGS_stringlist var_childrenRefs_9498 = GGS_stringlist::init (inCompiler COMMA_HERE) ;
  cEnumerator_stringset enumerator_9524 (constinArgument_inFileNames, EnumerationOrder::up) ;
  while (enumerator_9524.hasCurrentObject ()) {
    enumGalgasBool test_6 = kBoolTrue ;
    if (kBoolTrue == test_6) {
      test_6 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 250)).objectCompare (GGS_string ("c"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        GGS_string var_cFileRef_9638 ;
        {
        extensionSetter_addCFile (ioObject, enumerator_9524.current_key (HERE), var_cFileRef_9638, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 251)) ;
        }
        var_childrenRefs_9498.addAssign_operation (var_cFileRef_9638  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 252)) ;
        GGS_string var_buildRef_9759 ;
        {
        extensionSetter_addBuildFile (ioObject, var_cFileRef_9638, enumerator_9524.current_key (HERE), var_buildRef_9759, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 253)) ;
        }
        ioArgument_ioCFileBuildRefs.addAssign_operation (var_buildRef_9759  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 254)) ;
      }
    }
    if (kBoolFalse == test_6) {
      enumGalgasBool test_7 = kBoolTrue ;
      if (kBoolTrue == test_7) {
        test_7 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 255)).objectCompare (GGS_string ("cpp"))).boolEnum () ;
        if (kBoolTrue == test_7) {
          GGS_string var_cppFileRef_9905 ;
          {
          extensionSetter_addCppFile (ioObject, enumerator_9524.current_key (HERE), var_cppFileRef_9905, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 256)) ;
          }
          var_childrenRefs_9498.addAssign_operation (var_cppFileRef_9905  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 257)) ;
          GGS_string var_buildRef_10032 ;
          {
          extensionSetter_addBuildFile (ioObject, var_cppFileRef_9905, enumerator_9524.current_key (HERE), var_buildRef_10032, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 258)) ;
          }
          ioArgument_ioCppFileBuildRefs.addAssign_operation (var_buildRef_10032  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 259)) ;
        }
      }
      if (kBoolFalse == test_7) {
        enumGalgasBool test_8 = kBoolTrue ;
        if (kBoolTrue == test_8) {
          test_8 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 260)).objectCompare (GGS_string ("h"))).boolEnum () ;
          if (kBoolTrue == test_8) {
            GGS_string var_headerFileRef_10181 ;
            {
            extensionSetter_addHeaderFile (ioObject, enumerator_9524.current_key (HERE), var_headerFileRef_10181, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 261)) ;
            }
            var_childrenRefs_9498.addAssign_operation (var_headerFileRef_10181  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 262)) ;
          }
        }
        if (kBoolFalse == test_8) {
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 263)).objectCompare (GGS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              GGS_string var_m_5F_FileRef_10329 ;
              {
              extensionSetter_addMFile (ioObject, enumerator_9524.current_key (HERE), var_m_5F_FileRef_10329, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 264)) ;
              }
              GGS_string var_buildRef_10420 ;
              {
              extensionSetter_addBuildFile (ioObject, var_m_5F_FileRef_10329, enumerator_9524.current_key (HERE), var_buildRef_10420, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 265)) ;
              }
              var_childrenRefs_9498.addAssign_operation (var_m_5F_FileRef_10329  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 266)) ;
              ioArgument_ioMFileBuildRefs.addAssign_operation (var_buildRef_10420  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 267)) ;
            }
          }
          if (kBoolFalse == test_9) {
            enumGalgasBool test_10 = kBoolTrue ;
            if (kBoolTrue == test_10) {
              test_10 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 268)).objectCompare (GGS_string ("mm"))).boolEnum () ;
              if (kBoolTrue == test_10) {
                GGS_string var_m_5F_FileRef_10597 ;
                {
                extensionSetter_addMMFile (ioObject, enumerator_9524.current_key (HERE), var_m_5F_FileRef_10597, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 269)) ;
                }
                GGS_string var_buildRef_10688 ;
                {
                extensionSetter_addBuildFile (ioObject, var_m_5F_FileRef_10597, enumerator_9524.current_key (HERE), var_buildRef_10688, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 270)) ;
                }
                var_childrenRefs_9498.addAssign_operation (var_m_5F_FileRef_10597  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 271)) ;
                ioArgument_ioMMFileBuildRefs.addAssign_operation (var_buildRef_10688  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 272)) ;
              }
            }
            if (kBoolFalse == test_10) {
              enumGalgasBool test_11 = kBoolTrue ;
              if (kBoolTrue == test_11) {
                test_11 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 273)).objectCompare (GGS_string ("framework"))).boolEnum () ;
                if (kBoolTrue == test_11) {
                  GGS_string var_framework_5F_FileRef_10880 ;
                  {
                  extensionSetter_addFrameworkFile (ioObject, enumerator_9524.current_key (HERE), var_framework_5F_FileRef_10880, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 274)) ;
                  }
                  GGS_string var_buildRef_10987 ;
                  {
                  extensionSetter_addBuildFile (ioObject, var_framework_5F_FileRef_10880, enumerator_9524.current_key (HERE), var_buildRef_10987, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 275)) ;
                  }
                  var_childrenRefs_9498.addAssign_operation (var_framework_5F_FileRef_10880  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 276)) ;
                  ioArgument_ioFrameWorkFileBuildRefs.addAssign_operation (var_buildRef_10987  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 277)) ;
                }
              }
              if (kBoolFalse == test_11) {
                enumGalgasBool test_12 = kBoolTrue ;
                if (kBoolTrue == test_12) {
                  test_12 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 278)).objectCompare (GGS_string ("plist"))).boolEnum () ;
                  if (kBoolTrue == test_12) {
                    GGS_string var_resource_5F_FileRef_11190 ;
                    {
                    extensionSetter_addInfoPlistFile (ioObject, enumerator_9524.current_key (HERE), var_resource_5F_FileRef_11190, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 279)) ;
                    }
                    var_childrenRefs_9498.addAssign_operation (var_resource_5F_FileRef_11190  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 280)) ;
                  }
                }
                if (kBoolFalse == test_12) {
                  enumGalgasBool test_13 = kBoolTrue ;
                  if (kBoolTrue == test_13) {
                    test_13 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 281)).objectCompare (GGS_string ("xib"))).boolEnum () ;
                    if (kBoolTrue == test_13) {
                      GGS_string var_resource_5F_FileRef_11348 ;
                      {
                      extensionSetter_addXIBFile (ioObject, enumerator_9524.current_key (HERE), var_resource_5F_FileRef_11348, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 282)) ;
                      }
                      var_childrenRefs_9498.addAssign_operation (var_resource_5F_FileRef_11348  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 283)) ;
                      GGS_string var_buildRef_11493 ;
                      {
                      extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11348, enumerator_9524.current_key (HERE), var_buildRef_11493, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 284)) ;
                      }
                      ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_11493  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 285)) ;
                    }
                  }
                  if (kBoolFalse == test_13) {
                    enumGalgasBool test_14 = kBoolTrue ;
                    if (kBoolTrue == test_14) {
                      test_14 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 286)).objectCompare (GGS_string ("tiff"))).boolEnum () ;
                      if (kBoolTrue == test_14) {
                        GGS_string var_resource_5F_FileRef_11649 ;
                        {
                        extensionSetter_addTIFF_5F_file (ioObject, enumerator_9524.current_key (HERE), var_resource_5F_FileRef_11649, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 287)) ;
                        }
                        var_childrenRefs_9498.addAssign_operation (var_resource_5F_FileRef_11649  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 288)) ;
                        GGS_string var_buildRef_11794 ;
                        {
                        extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11649, enumerator_9524.current_key (HERE), var_buildRef_11794, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 289)) ;
                        }
                        ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_11794  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 290)) ;
                      }
                    }
                    if (kBoolFalse == test_14) {
                      enumGalgasBool test_15 = kBoolTrue ;
                      if (kBoolTrue == test_15) {
                        test_15 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 291)).objectCompare (GGS_string ("icns"))).boolEnum () ;
                        if (kBoolTrue == test_15) {
                          GGS_string var_resource_5F_FileRef_11950 ;
                          {
                          extensionSetter_addICNS_5F_file (ioObject, enumerator_9524.current_key (HERE), var_resource_5F_FileRef_11950, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 292)) ;
                          }
                          var_childrenRefs_9498.addAssign_operation (var_resource_5F_FileRef_11950  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 293)) ;
                          GGS_string var_buildRef_12095 ;
                          {
                          extensionSetter_addBuildFile (ioObject, var_resource_5F_FileRef_11950, enumerator_9524.current_key (HERE), var_buildRef_12095, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 294)) ;
                          }
                          ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef_12095  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 295)) ;
                        }
                      }
                      if (kBoolFalse == test_15) {
                        enumGalgasBool test_16 = kBoolTrue ;
                        if (kBoolTrue == test_16) {
                          test_16 = GGS_bool (ComparisonKind::equal, enumerator_9524.current_key (HERE).getter_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 296)).objectCompare (GGS_string ("swift"))).boolEnum () ;
                          if (kBoolTrue == test_16) {
                          }
                        }
                        if (kBoolFalse == test_16) {
                          TC_Array <FixItDescription> fixItArray17 ;
                          inCompiler->emitSemanticError (GGS_location::class_func_nowhere (SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 299)), GGS_string ("unhandled extension for file '").add_operation (enumerator_9524.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 299)).add_operation (GGS_string ("'"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 299)), fixItArray17  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 299)) ;
                        }
                      }
                    }
                  }
    ...
    enumerator_9524.gotoNextObject () ;
  }
  ioObject.mProperty_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs_9498  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 302)) ;
}
...
void extensionMethod_generateAtPath (const GGS_XcodeProjectDescriptor inObject,
  ...
  if (kBoolTrue == test_22) {
    ...
    if (kBoolTrue != test_24.boolEnum ()) {
      test_24 = GGS_bool (ComparisonKind::notEqual, GGS_string::class_func_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 474)).objectCompare (var_contents_17778)) ;
    }
    test_22 = test_24.boolEnum () ;
    if (kBoolTrue == test_22) {
      GGS_bool joker_18736 ; // Joker input parameter
      var_contents_17778.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_18736, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 475)) ;
      var_contents_17778.method_makeDirectoryAndWriteToFile (var_projectCoreFile_18473, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.galgas", 476)) ;
    }
  }
}
