...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  GALGAS_uint var_currentDirectoryIndex_31398 = ioArgument_ioWrapperDirectoryIndex ;
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 658)) ;
  GALGAS_stringlist var_files_31503 = constinArgument_inAbsoluteSourcePath.getter_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 660)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 661)) ;
  cEnumerator_stringlist enumerator_31614 (var_files_31503, kEnumeration_up) ;
  while (enumerator_31614.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.getter_hasKey (enumerator_31614.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 663)) COMMA_SOURCE_FILE ("semanticContext.galgas", 663)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath_31716 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 664)).add_operation (enumerator_31614.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 664)) ;
      {
      outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_31614.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 666))  COMMA_SOURCE_FILE ("semanticContext.galgas", 666)), var_absoluteFilePath_31716, GALGAS_bool (true), var_currentDirectoryIndex_31398, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 665)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 672)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.getter_hasKey (enumerator_31614.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 673)) COMMA_SOURCE_FILE ("semanticContext.galgas", 673)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath_32090 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 674)).add_operation (enumerator_31614.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 674)) ;
        {
        outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_31614.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 676))  COMMA_SOURCE_FILE ("semanticContext.galgas", 676)), var_absoluteFilePath_32090, GALGAS_bool (false), var_currentDirectoryIndex_31398, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 675)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 682)) ;
      }
    }
    enumerator_31614.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories_32439 = constinArgument_inAbsoluteSourcePath.getter_directories (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 686)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 687)) ;
  cEnumerator_stringlist enumerator_32565 (var_directories_32439, kEnumeration_up) ;
  while (enumerator_32565.hasCurrentObject ()) {
    GALGAS_wrapperFileMap var_internalWrapperFileMap_32611 ;
    GALGAS_wrapperDirectoryMap var_internalWrapperDirectoryMap_32664 ;
    GALGAS_uint var_theDirectoryIndex_32692 = ioArgument_ioWrapperDirectoryIndex ;
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 693)).add_operation (enumerator_32565.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 693)), constinArgument_inPathInWrapper.add_operation (enumerator_32565.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 694)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 694)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap_32611, var_internalWrapperDirectoryMap_32664, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 692)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_32565.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 703))  COMMA_SOURCE_FILE ("semanticContext.galgas", 703)), var_internalWrapperFileMap_32611, var_internalWrapperDirectoryMap_32664, var_theDirectoryIndex_32692, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 702)) ;
    }
    enumerator_32565.gotoNextObject () ;
  }
}
...
void routine_analyzeConstructorInvocation (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  if (kBoolTrue == test_0) {
    outArgument_outConstructorType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, constinArgument_inTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 894)) ;
  }
  const enumGalgasBool test_1 = outArgument_outConstructorType.getter_isNull (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 896)).boolEnum () ;
  if (kBoolTrue == test_1) {
    TC_Array <C_FixItDescription> fixItArray2 ;
    inCompiler->emitSemanticError (constinArgument_inTypeName.getter_location (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 897)), GALGAS_string ("cannot infer type"), fixItArray2  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 897)) ;
    ...
    GALGAS_constructorMap var_constructorMap_52629 = outArgument_outConstructorType.getter_mConstructorMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 900)) ;
    GALGAS_functionSignature var_constructorFormalArgumentTypeList_52750 ;
    const cMapElement_constructorMap * objectArray_52759 = (const cMapElement_constructorMap *) var_constructorMap_52629.readAccessForWithInstruction (constinArgument_inConstructorName.getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 903))) ;
    if (NULL != objectArray_52759) {
        macroValidSharedObject (objectArray_52759, cMapElement_constructorMap) ;
      var_constructorFormalArgumentTypeList_52750 = objectArray_52759->mAttribute_mArgumentTypeList ;
      outArgument_outHasCompilerArgument = objectArray_52759->mAttribute_mHasCompilerArgument ;
      outArgument_outReturnedType = objectArray_52759->mAttribute_mReturnedType ;
    }else{
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_constructorMap_52629.getter_count (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 908)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (constinArgument_inConstructorName.getter_location (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 909)), GALGAS_string ("the '@").add_operation (outArgument_outConstructorType.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 910)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 910)).add_operation (GALGAS_string ("' type does not define any constructor"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 910)), fixItArray4  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 909)) ;
        var_constructorFormalArgumentTypeList_52750.drop () ; // Release error dropped variable
        outArgument_outHasCompilerArgument.drop () ; // Release error dropped variable
        outArgument_outReturnedType.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_3) {
        GALGAS_string var_s_53243 = GALGAS_string::makeEmptyString () ;
        cEnumerator_constructorMap enumerator_53281 (var_constructorMap_52629, kEnumeration_up) ;
        while (enumerator_53281.hasCurrentObject ()) {
          var_s_53243.plusAssign_operation(GALGAS_string ("\n"
            "  - ").add_operation (enumerator_53281.current_lkey (HERE).getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 915)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 915)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 915)) ;
          cEnumerator_functionSignature enumerator_53353 (enumerator_53281.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_53353.hasCurrentObject ()) {
            GALGAS_string temp_5 ;
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_53353.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              temp_5 = enumerator_53353.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)) ;
            }else if (kBoolFalse == test_6) {
              temp_5 = GALGAS_string::makeEmptyString () ;
            }
            var_s_53243.plusAssign_operation(GALGAS_string (" \?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)).add_operation (enumerator_53353.current_mFormalArgumentType (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 917)) ;
            enumerator_53353.gotoNextObject () ;
          }
          var_s_53243.plusAssign_operation(GALGAS_string (" -> @").add_operation (enumerator_53281.current_mReturnedType (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 919)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 919)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 919)) ;
          enumerator_53281.gotoNextObject () ;
        }
        GALGAS_string temp_7 ;
        const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_constructorMap_52629.getter_count (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 923)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
        if (kBoolTrue == test_8) {
        ...
        inCompiler->emitSemanticError (constinArgument_inConstructorName.getter_location (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 921)), GALGAS_string ("the '@").add_operation (constinArgument_inTypeName.getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)).add_operation (GALGAS_string ("' type does not define the '"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)).add_operation (constinArgument_inConstructorName.getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)).add_operation (GALGAS_string ("' constructor; "), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)).add_operation (temp_7, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 922)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 923)).add_operation (var_s_53243, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 924)), fixItArray9  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 921)) ;
        var_constructorFormalArgumentTypeList_52750.drop () ; // Release error dropped variable
        outArgument_outHasCompilerArgument.drop () ; // Release error dropped variable
        outArgument_outReturnedType.drop () ; // Release error dropped variable
      }
    }
    const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, constinArgument_inConstuctorEffectiveParameterExpressions.getter_length (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 929)).objectCompare (var_constructorFormalArgumentTypeList_52750.getter_length (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 929)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      TC_Array <C_FixItDescription> fixItArray11 ;
      inCompiler->emitSemanticError (constinArgument_inConstructorName.getter_location (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 930)), GALGAS_string ("calling the '").add_operation (constinArgument_inConstructorName.getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)).add_operation (GALGAS_string ("' constructor of '@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)).add_operation (constinArgument_inTypeName.getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)).add_operation (GALGAS_string ("' requires "), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)).add_operation (var_constructorFormalArgumentTypeList_52750.getter_length (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 932)).getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 932)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 931)).add_operation (GALGAS_string (" parameter(s), while this call has "), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 932)).add_operation (constinArgument_inConstuctorEffectiveParameterExpressions.getter_length (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 933)).getter_string (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 933)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 932)).add_operation (GALGAS_string (" parameter(s)"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 933)), fixItArray11  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 930)) ;
    }
    outArgument_outConstructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 935)) ;
    cEnumerator_actualOutputExpressionList enumerator_54488 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_54529 (var_constructorFormalArgumentTypeList_52750, kEnumeration_up) ;
    while (enumerator_54488.hasCurrentObject () && enumerator_54529.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp_54773 ;
      callExtensionMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_54488.current_mExpression (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, enumerator_54529.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp_54773, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 937)) ;
      {
      routine_checkAssignmentTypeWithImplicitGetterCall (enumerator_54529.current_mFormalArgumentType (HERE), var_exp_54773.getter_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 945)), enumerator_54488.current_mEndOfExpressionLocation (HERE), var_exp_54773, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 945)) ;
      }
      outArgument_outConstructorEffectiveParameterList.addAssign_operation (var_exp_54773  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 946)) ;
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_54529.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_54488.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_12) {
        GALGAS_string temp_13 ;
        const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_54529.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_14) {
          temp_13 = enumerator_54529.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 949)) ;
        }else if (kBoolFalse == test_14) {
          temp_13 = GALGAS_string::makeEmptyString () ;
        }
        TC_Array <C_FixItDescription> fixItArray15 ;
        inCompiler->emitSemanticError (enumerator_54488.current_mActualSelector (HERE).getter_location (SOURCE_FILE ("semanticExpressionAnalysis.galgas", 948)), GALGAS_string ("the selector should be '!").add_operation (temp_13, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 949)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 949)), fixItArray15  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.galgas", 948)) ;
      }
      enumerator_54488.gotoNextObject () ;
      enumerator_54529.gotoNextObject () ;
    }
  }
}
    ...
    if (kBoolTrue == test_1) {
      ...
      if (NULL != objectArray_31097) {
        ...
        if (kBoolTrue == test_12) {
          ...
          GALGAS_string var_s_32188 = GALGAS_string::makeEmptyString () ;
          cEnumerator_getterMap enumerator_32239 (var_expressionType_29830.getter_mGetterMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 667)), kEnumeration_up) ;
          while (enumerator_32239.hasCurrentObject ()) {
            var_s_32188.plusAssign_operation(GALGAS_string ("\n"
              "  - ").add_operation (enumerator_32239.current_lkey (HERE).getter_string (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 668)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 668)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 668)) ;
            cEnumerator_functionSignature enumerator_32311 (enumerator_32239.current_mArgumentTypeList (HERE), kEnumeration_up) ;
            while (enumerator_32311.hasCurrentObject ()) {
              GALGAS_string temp_14 ;
              const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_32311.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_15) {
                temp_14 = enumerator_32311.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)) ;
              }else if (kBoolFalse == test_15) {
                temp_14 = GALGAS_string::makeEmptyString () ;
              }
              var_s_32188.plusAssign_operation(GALGAS_string (" \?").add_operation (temp_14, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)).add_operation (enumerator_32311.current_mFormalArgumentType (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 670)) ;
              enumerator_32311.gotoNextObject () ;
            }
            var_s_32188.plusAssign_operation(GALGAS_string (" -> @").add_operation (enumerator_32239.current_mReturnedType (HERE).getter_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 672)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 672)), inCompiler  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 672)) ;
            enumerator_32239.gotoNextObject () ;
          }
          GALGAS_string temp_16 ;
          const enumGalgasBool test_17 = GALGAS_bool (kIsStrictSup, var_expressionType_29830.getter_mGetterMap (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 676)).getter_count (SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 676)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
          if (kBoolTrue == test_17) {
            temp_16 = GALGAS_string ("getters are") ;
          }else if (kBoolFalse == test_17) {
            temp_16 = GALGAS_string ("getter is") ;
          }
          TC_Array <C_FixItDescription> fixItArray18 ;
          inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("the expression type is not '@bool', but '@").add_operation (var_expressionType_29830.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 675)), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 675)).add_operation (GALGAS_string ("', and this type does not define the 'bool' getter; available "), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 675)).add_operation (temp_16, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 675)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 676)).add_operation (var_s_32188, inCompiler COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 677)), fixItArray18  COMMA_SOURCE_FILE ("semanticInstructionsAnalysis.galgas", 674)) ;
          outArgument_outExpression.drop () ; // Release error dropped variable
        }
      }
    }
...
void routine_buildLocalVariableMapAndSignature (const GALGAS_semanticContext constinArgument_inSemanticContext,
  ...
  outArgument_outRoutineSignature = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 144)) ;
  cEnumerator_formalParameterListAST enumerator_9111 (constinArgument_inRoutineSignatureAST, kEnumeration_up) ;
  while (enumerator_9111.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_proxy var_type_9127 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_9111.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 146)) ;
    GALGAS_string var_formalArgumentCppName_9250 ;
    switch (enumerator_9111.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
    case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn:
      {
        var_formalArgumentCppName_9250 = GALGAS_string ("inArgument_").add_operation (enumerator_9111.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 150)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 150)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 150)) ;
        const enumGalgasBool test_0 = enumerator_9111.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioVariableMap.setter_insertInputFormalArgumentDeclaredAsUnused (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 152)) ;
          }
        }else if (kBoolFalse == test_0) {
          {
          ioArgument_ioVariableMap.setter_insertInputFormalArgument (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 154)) ;
          }
        }
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut:
      {
        var_formalArgumentCppName_9250 = GALGAS_string ("outArgument_").add_operation (enumerator_9111.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 157)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 157)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 157)) ;
        {
        ioArgument_ioVariableMap.setter_insertOutputFormalArgument (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 158)) ;
        }
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut:
      {
        var_formalArgumentCppName_9250 = GALGAS_string ("ioArgument_").add_operation (enumerator_9111.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 160)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 160)) ;
        const enumGalgasBool test_1 = enumerator_9111.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_1) {
          {
          ioArgument_ioVariableMap.setter_insertInputOutputFormalArgumentDeclaredAsUnused (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 162)) ;
          }
        }else if (kBoolFalse == test_1) {
          {
          ioArgument_ioVariableMap.setter_insertInputOutputFormalArgument (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 164)) ;
          }
        }
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn:
      {
        var_formalArgumentCppName_9250 = GALGAS_string ("constinArgument_").add_operation (enumerator_9111.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 167)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 167)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 167)) ;
        const enumGalgasBool test_2 = enumerator_9111.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          ioArgument_ioVariableMap.setter_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 169)) ;
          }
        }else if (kBoolFalse == test_2) {
          {
          ioArgument_ioVariableMap.setter_insertConstantInputFormalArgument (enumerator_9111.current_mFormalArgumentName (HERE), var_type_9127, var_formalArgumentCppName_9250, var_formalArgumentCppName_9250, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 171)) ;
          }
        }
      }
      break ;
    }
    outArgument_outRoutineSignature.addAssign_operation (enumerator_9111.current_mFormalSelector (HERE), enumerator_9111.current_mFormalArgumentPassingMode (HERE), var_type_9127, enumerator_9111.current_mFormalArgumentName (HERE), var_formalArgumentCppName_9250  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 174)) ;
...
void routine_analyzeRoutineBody (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outRoutineSignature.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap_11811 = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 194)) ;
  cEnumerator_localConstantList enumerator_11897 (constinArgument_inLocalConstantList, kEnumeration_up) ;
  while (enumerator_11897.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_11897.current_mNoWarningIfUnused (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_variableMap_11811.setter_insertUsedLocalConstant (enumerator_11897.current_mName (HERE), enumerator_11897.current_mType (HERE), enumerator_11897.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 198)) ;
      }
    }else if (kBoolFalse == test_0) {
      {
      var_variableMap_11811.setter_insertLocalConstant (enumerator_11897.current_mName (HERE), enumerator_11897.current_mType (HERE), enumerator_11897.current_mCppName (HERE), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 200)) ;
      }
    }
    enumerator_11897.gotoNextObject () ;
  }
  cEnumerator_typedPropertyList enumerator_12252 (constinArgument_inNonMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_12252.hasCurrentObject ()) {
    {
    var_variableMap_11811.setter_insertNonMutableAttribute (enumerator_12252.current_mAttributeName (HERE), enumerator_12252.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.add_operation (GALGAS_string ("mAttribute_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 208)).add_operation (enumerator_12252.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 208)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 208)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 208)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 205)) ;
    }
    enumerator_12252.gotoNextObject () ;
  }
  cEnumerator_typedPropertyList enumerator_12589 (constinArgument_inMutableTypedAttributeList, kEnumeration_up) ;
  while (enumerator_12589.hasCurrentObject ()) {
    {
    var_variableMap_11811.setter_insertMutableAttribute (enumerator_12589.current_mAttributeName (HERE), enumerator_12589.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.add_operation (GALGAS_string ("mAttribute_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 217)).add_operation (enumerator_12589.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 217)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 217)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 217)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 214)) ;
    }
    enumerator_12589.gotoNextObject () ;
  }
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inRoutineSignatureAST, var_variableMap_11811, outArgument_outRoutineSignature, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 222)) ;
  }
  outArgument_outSemanticInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 229)) ;
  cEnumerator_semanticInstructionListAST enumerator_13177 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_13177.hasCurrentObject ()) {
    callExtensionMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_13177.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap_11811, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 231)) ;
    enumerator_13177.gotoNextObject () ;
  }
  var_variableMap_11811.method_checkAutomatonStates (constinArgument_inEndOfMethodLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 240)) ;
}
...
void routine_analyzeFunctionBody (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outSemanticInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap_18623 = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 377)) ;
  cEnumerator_typedPropertyList enumerator_18712 (constinArgument_inTypedAttributeList, kEnumeration_up) ;
  while (enumerator_18712.hasCurrentObject ()) {
    {
    var_variableMap_18623.setter_insertNonMutableAttribute (enumerator_18712.current_mAttributeName (HERE), enumerator_18712.current_mAttributeTypeProxy (HERE), constinArgument_inAttributeVariableNamePrefix.add_operation (GALGAS_string ("mAttribute_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 383)).add_operation (enumerator_18712.current_mAttributeName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 383)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 383)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 383)), constinArgument_inAnalysisContext.mAttribute_mSelfObjectCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 380)) ;
    }
    enumerator_18712.gotoNextObject () ;
  }
  outArgument_outSignatureForGeneration = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 388)) ;
  cEnumerator_formalInputParameterListAST enumerator_19110 (constinArgument_inFunctionSignature, kEnumeration_up) ;
  while (enumerator_19110.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_proxy var_parameterType_19135 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, enumerator_19110.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 390)) ;
    const enumGalgasBool test_0 = enumerator_19110.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_cppName_19291 = GALGAS_string ("constinArgument_").add_operation (enumerator_19110.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 392)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 392)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 392)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (enumerator_19110.current_mFormalSelector (HERE), var_parameterType_19135, var_cppName_19291, enumerator_19110.current_mFormalArgumentName (HERE), enumerator_19110.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 393)) ;
      const enumGalgasBool test_1 = enumerator_19110.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        var_variableMap_18623.setter_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_19110.current_mFormalArgumentName (HERE), var_parameterType_19135, var_cppName_19291, var_cppName_19291, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 400)) ;
        }
      }else if (kBoolFalse == test_1) {
        {
        var_variableMap_18623.setter_insertConstantInputFormalArgument (enumerator_19110.current_mFormalArgumentName (HERE), var_parameterType_19135, var_cppName_19291, var_cppName_19291, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 402)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_cppName_19840 = GALGAS_string ("inArgument_").add_operation (enumerator_19110.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 405)).getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 405)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 405)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (enumerator_19110.current_mFormalSelector (HERE), var_parameterType_19135, var_cppName_19840, enumerator_19110.current_mFormalArgumentName (HERE), enumerator_19110.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 406)) ;
      const enumGalgasBool test_2 = enumerator_19110.current_mIsUnused (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_variableMap_18623.setter_insertInputFormalArgumentDeclaredAsUnused (enumerator_19110.current_mFormalArgumentName (HERE), var_parameterType_19135, var_cppName_19840, var_cppName_19840, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 413)) ;
        }
      }else if (kBoolFalse == test_2) {
        {
        var_variableMap_18623.setter_insertInputFormalArgument (enumerator_19110.current_mFormalArgumentName (HERE), var_parameterType_19135, var_cppName_19840, var_cppName_19840, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 415)) ;
        }
      }
    }
    enumerator_19110.gotoNextObject () ;
  }
  outArgument_outReturnedType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, constinArgument_inResultTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 420)) ;
  outArgument_outResultVariableCppName = GALGAS_string ("result_").add_operation (constinArgument_inReturnVariableName.mAttribute_string.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 421)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 421)) ;
  {
  var_variableMap_18623.setter_insertOutputFormalArgument (constinArgument_inReturnVariableName, outArgument_outReturnedType, outArgument_outResultVariableCppName, outArgument_outResultVariableCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 422)) ;
  }
  outArgument_outSemanticInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 424)) ;
  cEnumerator_semanticInstructionListAST enumerator_20869 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_20869.hasCurrentObject ()) {
    callExtensionMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_20869.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap_18623, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 426)) ;
    enumerator_20869.gotoNextObject () ;
  }
  var_variableMap_18623.method_checkAutomatonStates (constinArgument_inEndOfFunctionLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 435)) ;
}
...
GALGAS_predefinedTypes function_buildPredefinedTypes (const GALGAS_semanticContext & constinArgument_inSemanticContext,
  ...
  result_outPredefinedTypes = GALGAS_predefinedTypes::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("location"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1215))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1215)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1215)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("bool"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1216))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1216)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1216)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("char"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1217))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1217)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1217)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("string"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1218))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1218)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1218)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1219))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1219)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1219)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1220))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1220)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1220)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("uint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1221))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1221)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1221)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("sint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1222))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1222)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1222)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("double"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1223))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1223)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1223)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lbool"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1224))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1224)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1224)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lchar"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1225))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1225)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1225)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lstring"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1226))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1226)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1226)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1227))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1227)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1227)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1228))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1228)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1228)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("luint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1229))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1229)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1229)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lsint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1230))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1230)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1230)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("ldouble"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1231))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1231)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1231)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("stringlist"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1232))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1232)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1232)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("lbigint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1233))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1233)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1233)), GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("bigint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1234))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1234)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1234))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1214)) ;
//---
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_60527 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction (constinArgument_inNonTerminalName.getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1326))) ;
  if (NULL != objectArray_60527) {
      macroValidSharedObject (objectArray_60527, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet_60633 = objectArray_60527->mAttribute_mLabelMap.getter_keySet (SOURCE_FILE ("semanticAnalysis.galgas", 1327)) ;
    GALGAS_stringset var_reDeclarationLabelSet_60695 = constinArgument_inNonterminalLabelMap.getter_keySet (SOURCE_FILE ("semanticAnalysis.galgas", 1328)) ;
    GALGAS_stringset var_missingLabelSet_60763 = var_firstDeclarationLabelSet_60633.substract_operation (var_reDeclarationLabelSet_60695, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1329)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_missingLabelSet_60763.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1330)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_s_60870 = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_60907 (var_missingLabelSet_60763, kEnumeration_up) ;
      while (enumerator_60907.hasCurrentObject ()) {
        var_s_60870.plusAssign_operation(GALGAS_string ("\n"
          "-  ").add_operation (enumerator_60907.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1333)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1333)) ;
        enumerator_60907.gotoNextObject () ;
      }
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inNonTerminalName.getter_location (SOURCE_FILE ("semanticAnalysis.galgas", 1335)), GALGAS_string ("the '").add_operation (constinArgument_inNonTerminalName.getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1336)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1336)).add_operation (GALGAS_string ("' nonterminal is redeclared without the following label(s):"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1336)).add_operation (var_s_60870, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1336)), fixItArray1  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1335)) ;
    }
    GALGAS_stringset var_newLabelSet_61120 = var_reDeclarationLabelSet_60695.substract_operation (var_firstDeclarationLabelSet_60633, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1338)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_newLabelSet_61120.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1339)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s_61223 = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_61256 (var_newLabelSet_61120, kEnumeration_up) ;
      while (enumerator_61256.hasCurrentObject ()) {
        var_s_61223.plusAssign_operation(GALGAS_string ("\n"
          "-  ").add_operation (enumerator_61256.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1342)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1342)) ;
        enumerator_61256.gotoNextObject () ;
      }
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (constinArgument_inNonTerminalName.getter_location (SOURCE_FILE ("semanticAnalysis.galgas", 1344)), GALGAS_string ("the '").add_operation (constinArgument_inNonTerminalName.getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1345)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1345)).add_operation (GALGAS_string ("' nonterminal is redeclared with the new label(s):"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1345)).add_operation (var_s_61223, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1345)), fixItArray3  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1344)) ;
    }
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_missingLabelSet_60763.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1347)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet_61120.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1347)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1347)).boolEnum () ;
    if (kBoolTrue == test_4) {
      cEnumerator_nonterminalLabelMap enumerator_61531 (objectArray_60527->mAttribute_mLabelMap, kEnumeration_up) ;
      cEnumerator_nonterminalLabelMap enumerator_61565 (constinArgument_inNonterminalLabelMap, kEnumeration_up) ;
      while (enumerator_61531.hasCurrentObject () && enumerator_61565.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_newSignature_61615 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1349)) ;
        cEnumerator_formalParameterSignature enumerator_61653 (enumerator_61565.current_mSignature (HERE), kEnumeration_up) ;
        while (enumerator_61653.hasCurrentObject ()) {
          var_newSignature_61615.addAssign_operation (enumerator_61653.current_mFormalSelector (HERE), enumerator_61653.current_mFormalArgumentType (HERE), enumerator_61653.current_mFormalArgumentPassingMode (HERE), enumerator_61653.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1351)) ;
          enumerator_61653.gotoNextObject () ;
        }
        {
        routine_checkMethodSignatures (enumerator_61531.current (HERE).mAttribute_mSignatureForGeneration, enumerator_61531.current (HERE).mAttribute_mEndOfArgumentLocation, var_newSignature_61615, enumerator_61565.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1353)) ;
        }
        enumerator_61531.gotoNextObject () ;
        enumerator_61565.gotoNextObject () ;
      }
    }
  }else{
    {
    ioArgument_ioNonterminalDeclarationMap.setter_insertKey (constinArgument_inNonTerminalName, constinArgument_inNonterminalLabelMap, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1362)) ;
    }
  }
}
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  outArgument_outNonterminalDeclarationMap = GALGAS_nonterminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1372)) ;
  cEnumerator_nonterminalDeclarationListAST enumerator_62542 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_62542.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap_62573 = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1375)) ;
    cEnumerator_nonTerminalLabelListAST enumerator_62628 (enumerator_62542.current_mLabels (HERE), kEnumeration_up) ;
    while (enumerator_62628.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_62664 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1377)) ;
      GALGAS_formalParameterSignature var_signature_62722 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1378)) ;
      cEnumerator_formalParameterListAST enumerator_62788 (enumerator_62628.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_62788.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_t_62805 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_62788.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1380)) ;
        var_signatureForGeneration_62664.addAssign_operation (enumerator_62788.current_mFormalSelector (HERE), enumerator_62788.current_mFormalArgumentPassingMode (HERE), var_t_62805, enumerator_62788.current_mFormalArgumentName (HERE), enumerator_62788.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1381))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1381)) ;
        var_signature_62722.addAssign_operation (enumerator_62788.current_mFormalSelector (HERE), var_t_62805, enumerator_62788.current_mFormalArgumentPassingMode (HERE), enumerator_62788.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1382)) ;
        enumerator_62788.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap_62573.setter_insertKey (enumerator_62628.current_mLabelName (HERE), var_signatureForGeneration_62664, var_signature_62722, enumerator_62628.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1384)) ;
      }
      enumerator_62628.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_62542.current_mNonterminalName (HERE), var_nonterminalLabelMap_62573, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1386)) ;
    }
...
void routine_analyzeSyntaxInstructionList (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  {
  ioArgument_ioVariableMap.setter_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1728)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_80528 (constinArgument_inSyntaxInstructionListAST, kEnumeration_up) ;
  while (enumerator_80528.hasCurrentObject ()) {
    callExtensionMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_80528.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1731)) ;
    enumerator_80528.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.setter_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1747)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_variableMap var_variableMap_82327 = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1773)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inFormalArguments, var_variableMap_82327, outArgument_outSignatureForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1774)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1781)) ;
  cEnumerator_formalParameterListForGeneration enumerator_82602 (outArgument_outSignatureForGeneration, kEnumeration_up) ;
  while (enumerator_82602.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_82602.current_mFormalSelector (HERE), enumerator_82602.current_mFormalArgumentType (HERE), enumerator_82602.current_mFormalArgumentPassingMode (HERE), enumerator_82602.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1783)) ;
    enumerator_82602.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1786)) ;
  GALGAS_stringlist var_localVariableCppNameList_82883 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1787)) ;
  cEnumerator_syntaxInstructionList enumerator_82935 (constinArgument_inSyntaxInstructionList, kEnumeration_up) ;
  while (enumerator_82935.hasCurrentObject ()) {
    callExtensionMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_82935.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap_82327, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1789)) ;
    enumerator_82935.gotoNextObject () ;
  }
  var_variableMap_82327.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1805)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_lstring constinArgument_inSyntaxComponentUsefulnessName,
  ...
  GALGAS_nonterminalMap var_nonterminalMap_84744 ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap_84744, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1830)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_84825 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_84825.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap_84873 = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1837)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_84903 (enumerator_84825.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_84903.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_84969 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1839)) ;
      GALGAS_formalParameterSignature var_signature_85016 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1840)) ;
      cEnumerator_formalParameterListAST enumerator_85054 (enumerator_84903.current_mFormalArguments (HERE), kEnumeration_up) ;
      while (enumerator_85054.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_type_85074 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_85054.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1842)) ;
        var_signatureForGeneration_84969.addAssign_operation (enumerator_85054.current_mFormalSelector (HERE), enumerator_85054.current_mFormalArgumentPassingMode (HERE), var_type_85074, enumerator_85054.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").add_operation (enumerator_85054.current_mFormalArgumentName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1848)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1848))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1843)) ;
        var_signature_85016.addAssign_operation (enumerator_85054.current_mFormalSelector (HERE), var_type_85074, enumerator_85054.current_mFormalArgumentPassingMode (HERE), enumerator_85054.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1849)) ;
        enumerator_85054.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap_84873.setter_insertKey (enumerator_84903.current_mLabelName (HERE), var_signatureForGeneration_84969, var_signature_85016, enumerator_84903.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1851)) ;
      }
      enumerator_84903.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_84825.current_mNonterminalName (HERE), var_nonterminalLabelMap_84873, var_nonterminalMap_84744, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1853)) ;
    }
    enumerator_84825.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext_85740 = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.galgas", 1859)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticAnalysis.galgas", 1861))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1856)) ;
  GALGAS_uint var_selectMethodCount_85928 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList_85975 = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1865)) ;
  GALGAS_uint var_newRuleIndex_86001 = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_86028 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_86028.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList_86486 = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1875)) ;
    GALGAS_uint var_localSelectMethodCount_86524 = var_selectMethodCount_85928 ;
    GALGAS_nonterminalLabelMap joker_86594 ; // Joker input parameter
    var_nonterminalMap_84744.method_searchKey (enumerator_86028.current_mNonterminalName (HERE), joker_86594, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1877)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_86621 (enumerator_86028.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_86621.hasCurrentObject ()) {
      var_localSelectMethodCount_86524 = var_selectMethodCount_85928 ;
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_86736 ;
      GALGAS_formalParameterSignature var_signature_86778 ;
      GALGAS_semanticInstructionListForGeneration var_instructionListForGeneration_86851 ;
      {
      routine_semanticAnalysisOfRuleLabel (constinArgument_inSyntaxComponentUsefulnessName, ioArgument_ioUsefulEntitiesGraph, enumerator_86621.current_mFormalArguments (HERE), enumerator_86621.current_mSyntaxInstructionList (HERE), var_analysisContext_85740, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1891)), var_nonterminalMap_84744, constinArgument_inSyntaxComponentName, enumerator_86621.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount_86524, var_signatureForGeneration_86736, var_signature_86778, var_instructionListForGeneration_86851, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1883)) ;
      }
      var_ruleLabelImplementationList_86486.addAssign_operation (enumerator_86621.current_mLabelName (HERE), var_signatureForGeneration_86736, var_signature_86778, enumerator_86621.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration_86851  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1901)) ;
      enumerator_86621.gotoNextObject () ;
    }
    var_selectMethodCount_85928 = var_localSelectMethodCount_86524 ;
    GALGAS_nonterminalLabelMap joker_87670 ; // Joker input parameter
    var_nonterminalMap_84744.method_searchKey (enumerator_86028.current_mNonterminalName (HERE), joker_87670, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1909)) ;
    var_ruleDeclarationList_85975.addAssign_operation (enumerator_86028.current_mNonterminalName (HERE).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1911)), var_newRuleIndex_86001, var_ruleLabelImplementationList_86486  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1910)) ;
    var_newRuleIndex_86001.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1914)) ;
    enumerator_86028.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inSyntaxComponentName, constinArgument_inLexiqueName, var_nonterminalMap_84744, var_ruleDeclarationList_85975, var_selectMethodCount_85928, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1917)) ;
}
...
void routine_generateFunction (const GALGAS_string constinArgument_inFunctionCppRepresentationName,
  ...
  GALGAS_stringset var_unusedVariableCppNameSet_15650 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 357)) ;
  var_unusedVariableCppNameSet_15650.addAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 358))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 358)) ;
  cEnumerator_formalInputParameterListForGeneration enumerator_15817 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_15817.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName (enumerator_15817.current_mFormalArgumentType (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 361)) ;
    var_unusedVariableCppNameSet_15650.addAssign_operation (enumerator_15817.current_mFormalArgumentCppName (HERE)  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 362)) ;
    enumerator_15817.gotoNextObject () ;
  }
  GALGAS_uint var_temporaryVariableIndex_15993 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_string var_routineBody_16019 = GALGAS_string::makeEmptyString () ;
  {
  var_routineBody_16019.setter_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 367)) ;
  }
  cEnumerator_semanticInstructionListForGeneration enumerator_16090 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_16090.hasCurrentObject ()) {
    callExtensionMethod_generateInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_16090.current_mInstruction (HERE).ptr (), ioArgument_ioInclusionSet, var_temporaryVariableIndex_15993, var_unusedVariableCppNameSet_15650, GALGAS_bool (false), var_routineBody_16019, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 369)) ;
    enumerator_16090.gotoNextObject () ;
  }
  {
  var_routineBody_16019.setter_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 376)) ;
  }
  ...
  GALGAS_uint var_colRef_16580 = outArgument_outGeneratedCode.getter_currentColumn (SOURCE_FILE ("semanticGeneration.galgas", 383)) ;
  cEnumerator_formalInputParameterListForGeneration enumerator_16653 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_16653.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_16653.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("const GALGAS_").add_operation (enumerator_16653.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 387)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 387)).add_operation (GALGAS_string (" & "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 387)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 387)) ;
    }else if (kBoolFalse == test_1) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (enumerator_16653.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 389)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 389)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 389)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 389)) ;
    }
    const enumGalgasBool test_2 = var_unusedVariableCppNameSet_15650.getter_hasKey (enumerator_16653.current_mFormalArgumentCppName (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 391)).boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("/* ").add_operation (enumerator_16653.current_mFormalArgumentCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 392)).add_operation (GALGAS_string (" */"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 392)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 392)) ;
    }else if (kBoolFalse == test_2) {
      outArgument_outGeneratedCode.plusAssign_operation(enumerator_16653.current_mFormalArgumentCppName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 394)) ;
    }
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 396)) ;
    {
    outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_16580, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 397)) ;
    }
  ...
  const enumGalgasBool test_3 = var_unusedVariableCppNameSet_15650.getter_hasKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 401)) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 401)).boolEnum () ;
  if (kBoolTrue == test_3) {
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_16580, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 407)) ;
  }
  ...
  outArgument_outGeneratedCode.plusAssign_operation(var_routineBody_16019, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 414)) ;
...
void routine_generateExtensionSetter (const GALGAS_string constinArgument_inClassName,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outGeneratedCode.drop () ; // Release 'out' argument
  GALGAS_stringset var_unusedVariableCppNameSet_18944 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 437)) ;
  var_unusedVariableCppNameSet_18944.addAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 438))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 438)) ;
  var_unusedVariableCppNameSet_18944.addAssign_operation (GALGAS_string ("object")  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 439)) ;
  cEnumerator_formalParameterListForGeneration enumerator_19082 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_19082.hasCurrentObject ()) {
    var_unusedVariableCppNameSet_18944.addAssign_operation (enumerator_19082.current_mFormalArgumentCppName (HERE)  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 441)) ;
    enumerator_19082.gotoNextObject () ;
  }
  GALGAS_uint var_temporaryVariableIndex_19195 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_string var_routineBody_19217 = GALGAS_string::makeEmptyString () ;
  {
  var_routineBody_19217.setter_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 446)) ;
  }
  cEnumerator_semanticInstructionListForGeneration enumerator_19288 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_19288.hasCurrentObject ()) {
    callExtensionMethod_generateInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_19288.current_mInstruction (HERE).ptr (), ioArgument_ioInclusionSet, var_temporaryVariableIndex_19195, var_unusedVariableCppNameSet_18944, GALGAS_bool (false), var_routineBody_19217, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 448)) ;
    enumerator_19288.gotoNextObject () ;
  }
  {
  var_routineBody_19217.setter_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 456)) ;
  }
  ...
  GALGAS_uint var_colRef_19729 = outArgument_outGeneratedCode.getter_currentColumn (SOURCE_FILE ("semanticGeneration.galgas", 459)) ;
  ...
  GALGAS_bool var_currentObjectIsUnused_20009 = var_unusedVariableCppNameSet_18944.getter_hasKey (GALGAS_string ("object") COMMA_SOURCE_FILE ("semanticGeneration.galgas", 465)) ;
  const enumGalgasBool test_1 = var_currentObjectIsUnused_20009.boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  cEnumerator_formalParameterListForGeneration enumerator_20214 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_20214.hasCurrentObject ()) {
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 473)) ;
    {
    outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_19729, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 474)) ;
    }
    switch (enumerator_20214.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
    case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn:
      {
        outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("const GALGAS_").add_operation (enumerator_20214.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 477)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 477)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 477)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 477)) ;
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut:
      {
        outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (enumerator_20214.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 479)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 479)).add_operation (GALGAS_string (" & "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 479)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 479)) ;
      }
      break ;
    case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut:
      {
    ...
    const enumGalgasBool test_2 = var_unusedVariableCppNameSet_18944.getter_hasKey (enumerator_20214.current_mFormalArgumentCppName (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 485)).boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("/* ").add_operation (enumerator_20214.current_mFormalArgumentCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 486)).add_operation (GALGAS_string (" */"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 486)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 486)) ;
    }else if (kBoolFalse == test_2) {
      outArgument_outGeneratedCode.plusAssign_operation(enumerator_20214.current_mFormalArgumentCppName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 488)) ;
    }
    enumerator_20214.gotoNextObject () ;
  }
  outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 492)) ;
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_19729, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 493)) ;
  }
  ...
  const enumGalgasBool test_3 = var_unusedVariableCppNameSet_18944.getter_hasKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 495)) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 495)).boolEnum () ;
  if (kBoolTrue == test_3) {
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_19729, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 501)) ;
  }
  ...
  const enumGalgasBool test_4 = var_currentObjectIsUnused_20009.operator_not (SOURCE_FILE ("semanticGeneration.galgas", 505)).boolEnum () ;
  if (kBoolTrue == test_4) {
  ...
  outArgument_outGeneratedCode.plusAssign_operation(var_routineBody_19217, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 513)) ;
...
void routine_generateExtensionMethod (const GALGAS_unifiedTypeMap_2D_proxy constinArgument_inReceiverType,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outGeneratedCode.drop () ; // Release 'out' argument
  GALGAS_string var_className_22989 = constinArgument_inReceiverType.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 532)) ;
  GALGAS_stringset var_unusedVariableCppNameSet_23074 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 534)) ;
  var_unusedVariableCppNameSet_23074.addAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 535))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 535)) ;
  var_unusedVariableCppNameSet_23074.addAssign_operation (GALGAS_string ("object")  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 536)) ;
  cEnumerator_formalParameterListForGeneration enumerator_23212 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_23212.hasCurrentObject ()) {
    var_unusedVariableCppNameSet_23074.addAssign_operation (enumerator_23212.current_mFormalArgumentCppName (HERE)  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 538)) ;
    enumerator_23212.gotoNextObject () ;
  }
  GALGAS_uint var_temporaryVariableIndex_23327 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_string var_routineBody_23353 = GALGAS_string::makeEmptyString () ;
  {
  var_routineBody_23353.setter_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 543)) ;
  }
  cEnumerator_semanticInstructionListForGeneration enumerator_23424 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_23424.hasCurrentObject ()) {
    callExtensionMethod_generateInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_23424.current_mInstruction (HERE).ptr (), ioArgument_ioInclusionSet, var_temporaryVariableIndex_23327, var_unusedVariableCppNameSet_23074, GALGAS_bool (false), var_routineBody_23353, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 545)) ;
    enumerator_23424.gotoNextObject () ;
  }
  {
  var_routineBody_23353.setter_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 553)) ;
  }
  GALGAS_unifiedTypeMap_2D_proxy var_baseType_23735 = constinArgument_inReceiverType ;
  GALGAS_bool var_searching_23770 = GALGAS_bool (true) ;
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticGeneration.galgas", 557)).isValid ()) {
    uint32_t variant_23784 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticGeneration.galgas", 557)).uintValue () ;
    bool loop_23784 = true ;
    while (loop_23784) {
      loop_23784 = var_searching_23770.isValid () ;
      if (loop_23784) {
        loop_23784 = var_searching_23770.boolValue () ;
      }
      ...
      if (loop_23784) {
        variant_23784 -- ;
        const enumGalgasBool test_0 = var_baseType_23735.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 558)).getter_isNull (SOURCE_FILE ("semanticGeneration.galgas", 558)).operator_not (SOURCE_FILE ("semanticGeneration.galgas", 558)).boolEnum () ;
        if (kBoolTrue == test_0) {
          const enumGalgasBool test_1 = var_baseType_23735.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 559)).getter_mInstanceMethodMap (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 559)).getter_hasKey (constinArgument_inMethodName COMMA_SOURCE_FILE ("semanticGeneration.galgas", 559)).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_baseType_23735 = var_baseType_23735.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 560)) ;
          }else if (kBoolFalse == test_1) {
            var_searching_23770 = GALGAS_bool (false) ;
          }
        }else if (kBoolFalse == test_0) {
          var_searching_23770 = GALGAS_bool (false) ;
        }
  ...
  cEnumerator_formalParameterListForGeneration enumerator_24236 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_24236.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName (enumerator_24236.current_mFormalArgumentType (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 571)) ;
    enumerator_24236.gotoNextObject () ;
  }
  outArgument_outGeneratedCode = GALGAS_string ("static void extensionMethod_").add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 574)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 574)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 574)).add_operation (constinArgument_inMethodName.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 574)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 574)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 574)) ;
  GALGAS_uint var_colRef_24492 = outArgument_outGeneratedCode.getter_currentColumn (SOURCE_FILE ("semanticGeneration.galgas", 575)) ;
  ...
  if (kBoolTrue == test_2) {
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("const cPtr_").add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 577)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 577)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 577)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 577)) ;
  }else if (kBoolFalse == test_2) {
  ...
  GALGAS_bool var_currentObjectIsUnused_24782 = var_unusedVariableCppNameSet_23074.getter_hasKey (GALGAS_string ("object") COMMA_SOURCE_FILE ("semanticGeneration.galgas", 581)) ;
  const enumGalgasBool test_3 = var_currentObjectIsUnused_24782.boolEnum () ;
  if (kBoolTrue == test_3) {
  ...
  cEnumerator_formalParameterListForGeneration enumerator_24987 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_24987.hasCurrentObject ()) {
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 589)) ;
    {
    outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_24492, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 590)) ;
    }
    ...
    const enumGalgasBool test_4 = var_unusedVariableCppNameSet_23074.getter_hasKey (enumerator_24987.current_mFormalArgumentCppName (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 601)).boolEnum () ;
    if (kBoolTrue == test_4) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("/* ").add_operation (enumerator_24987.current_mFormalArgumentCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 602)).add_operation (GALGAS_string (" */"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 602)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 602)) ;
    }else if (kBoolFalse == test_4) {
      outArgument_outGeneratedCode.plusAssign_operation(enumerator_24987.current_mFormalArgumentCppName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 604)) ;
    }
    enumerator_24987.gotoNextObject () ;
  }
  outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 608)) ;
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_24492, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 609)) ;
  }
  ...
  const enumGalgasBool test_5 = var_unusedVariableCppNameSet_23074.getter_hasKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 611)) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 611)).boolEnum () ;
  if (kBoolTrue == test_5) {
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_24492, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 617)) ;
  }
  ...
  const enumGalgasBool test_6 = var_currentObjectIsUnused_24782.operator_not (SOURCE_FILE ("semanticGeneration.galgas", 621)).boolEnum () ;
  if (kBoolTrue == test_6) {
    ...
    if (kBoolTrue == test_7) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  const cPtr_").add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 623)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 623)).add_operation (GALGAS_string (" * object = inObject ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 623)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 623)) ;
    }else if (kBoolFalse == test_7) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  const cPtr_").add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 625)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 625)).add_operation (GALGAS_string (" * object = (const cPtr_"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 625)).add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 625)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 625)).add_operation (GALGAS_string (" *) inObject ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 625)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 625)) ;
    }
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  macroValidSharedObject (object, cPtr_").add_operation (var_className_22989.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 627)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 627)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 627)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 627)) ;
  }
  outArgument_outGeneratedCode.plusAssign_operation(var_routineBody_23353, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 629)) ;
...
void routine_generateExtensionGetter (const GALGAS_unifiedTypeMap_2D_proxy constinArgument_inReceiverType,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outGeneratedCode.drop () ; // Release 'out' argument
  GALGAS_string var_className_27925 = constinArgument_inReceiverType.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 651)) ;
  GALGAS_stringset var_unusedVariableCppNameSet_28010 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticGeneration.galgas", 653)) ;
  var_unusedVariableCppNameSet_28010.addAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 654))  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 654)) ;
  var_unusedVariableCppNameSet_28010.addAssign_operation (GALGAS_string ("object")  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 655)) ;
  cEnumerator_formalInputParameterListForGeneration enumerator_28148 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_28148.hasCurrentObject ()) {
    var_unusedVariableCppNameSet_28010.addAssign_operation (enumerator_28148.current_mFormalArgumentCppName (HERE)  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 657)) ;
    enumerator_28148.gotoNextObject () ;
  }
  GALGAS_uint var_temporaryVariableIndex_28263 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_string var_routineBody_28289 = GALGAS_string::makeEmptyString () ;
  {
  var_routineBody_28289.setter_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 662)) ;
  }
  cEnumerator_semanticInstructionListForGeneration enumerator_28360 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_28360.hasCurrentObject ()) {
    callExtensionMethod_generateInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_28360.current_mInstruction (HERE).ptr (), ioArgument_ioInclusionSet, var_temporaryVariableIndex_28263, var_unusedVariableCppNameSet_28010, GALGAS_bool (false), var_routineBody_28289, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 664)) ;
    enumerator_28360.gotoNextObject () ;
  }
  {
  var_routineBody_28289.setter_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 672)) ;
  }
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_baseType_28725 = constinArgument_inReceiverType ;
  GALGAS_bool var_searching_28760 = GALGAS_bool (true) ;
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticGeneration.galgas", 677)).isValid ()) {
    uint32_t variant_28774 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticGeneration.galgas", 677)).uintValue () ;
    bool loop_28774 = true ;
    while (loop_28774) {
      loop_28774 = var_searching_28760.isValid () ;
      if (loop_28774) {
        loop_28774 = var_searching_28760.boolValue () ;
      }
      ...
      if (loop_28774) {
        variant_28774 -- ;
        const enumGalgasBool test_0 = var_baseType_28725.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 678)).getter_isNull (SOURCE_FILE ("semanticGeneration.galgas", 678)).operator_not (SOURCE_FILE ("semanticGeneration.galgas", 678)).boolEnum () ;
        if (kBoolTrue == test_0) {
          const enumGalgasBool test_1 = var_baseType_28725.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 679)).getter_mGetterMap (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 679)).getter_hasKey (constinArgument_inGetterName COMMA_SOURCE_FILE ("semanticGeneration.galgas", 679)).boolEnum () ;
          if (kBoolTrue == test_1) {
            var_baseType_28725 = var_baseType_28725.getter_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 680)) ;
          }else if (kBoolFalse == test_1) {
            var_searching_28760 = GALGAS_bool (false) ;
          }
        }else if (kBoolFalse == test_0) {
          var_searching_28760 = GALGAS_bool (false) ;
        }
  ...
  cEnumerator_formalInputParameterListForGeneration enumerator_29218 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_29218.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName (enumerator_29218.current_mFormalArgumentType (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 691)) ;
  ...
  GALGAS_bool var_currentObjectIsUnused_29838 = var_unusedVariableCppNameSet_28010.getter_hasKey (GALGAS_string ("object") COMMA_SOURCE_FILE ("semanticGeneration.galgas", 702)) ;
  const enumGalgasBool test_3 = var_currentObjectIsUnused_29838.boolEnum () ;
  if (kBoolTrue == test_3) {
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_29548, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 709)) ;
  }
  cEnumerator_formalInputParameterListForGeneration enumerator_30126 (constinArgument_inFormalArgumentList, kEnumeration_up) ;
  while (enumerator_30126.hasCurrentObject ()) {
    const enumGalgasBool test_4 = enumerator_30126.current_mIsConstant (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("const GALGAS_").add_operation (enumerator_30126.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 713)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 713)).add_operation (GALGAS_string (" & "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 713)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 713)) ;
    }else if (kBoolFalse == test_4) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (enumerator_30126.current_mFormalArgumentType (HERE).getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 715)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 715)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 715)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 715)) ;
    }
    const enumGalgasBool test_5 = var_unusedVariableCppNameSet_28010.getter_hasKey (enumerator_30126.current_mFormalArgumentCppName (HERE) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 717)).boolEnum () ;
    if (kBoolTrue == test_5) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("/* ").add_operation (enumerator_30126.current_mFormalArgumentCppName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 718)).add_operation (GALGAS_string (" */"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 718)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 718)) ;
    }else if (kBoolFalse == test_5) {
      outArgument_outGeneratedCode.plusAssign_operation(enumerator_30126.current_mFormalArgumentCppName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 720)) ;
    }
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 722)) ;
    {
    outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_29548, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 723)) ;
    }
    enumerator_30126.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_6 = var_unusedVariableCppNameSet_28010.getter_hasKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 727)) COMMA_SOURCE_FILE ("semanticGeneration.galgas", 727)).boolEnum () ;
  if (kBoolTrue == test_6) {
  ...
  {
  outArgument_outGeneratedCode.setter_appendSpacesUntilColumn (var_colRef_29548, inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 733)) ;
  }
  ...
  const enumGalgasBool test_7 = var_currentObjectIsUnused_29838.operator_not (SOURCE_FILE ("semanticGeneration.galgas", 740)).boolEnum () ;
  if (kBoolTrue == test_7) {
    ...
    if (kBoolTrue == test_8) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  const cPtr_").add_operation (var_className_27925.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 742)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 742)).add_operation (GALGAS_string (" * object = inObject ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 742)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 742)) ;
    }else if (kBoolFalse == test_8) {
      outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  const cPtr_").add_operation (var_className_27925.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 744)).add_operation (GALGAS_string (" * object = (const cPtr_"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 744)).add_operation (var_className_27925.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 744)).add_operation (GALGAS_string (" *) inObject ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 744)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 744)) ;
    }
    outArgument_outGeneratedCode.plusAssign_operation(GALGAS_string ("  macroValidSharedObject (object, cPtr_").add_operation (var_className_27925.getter_identifierRepresentation (SOURCE_FILE ("semanticGeneration.galgas", 746)), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 746)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticGeneration.galgas", 746)), inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 746)) ;
  }
  outArgument_outGeneratedCode.plusAssign_operation(var_routineBody_28289, inCompiler  COMMA_SOURCE_FILE ("semanticGeneration.galgas", 748)) ;
