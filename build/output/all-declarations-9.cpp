...
void cPtr_structuredCastInstructionAST::description (String & ioString,
  ...
  ioString.appendString ("[@structuredCastInstructionAST:") ;
...
void cPtr_plusEqualnstructionForGeneration::description (String & ioString,
                                                         const int32_t inIndentation) const {
  ioString.appendString ("[@plusEqualnstructionForGeneration:") ;
...
void cPtr_dropInstructionAST::description (String & ioString,
                                           const int32_t inIndentation) const {
  ioString.appendString ("[@dropInstructionAST:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
...
void GALGAS_fixitElementAST::method_fixItReplace (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItReplace) {
    ...
    String s ;
    s.appendString ("method @fixitElementAST fixItReplace invoked with an invalid enum value") ;
...
void GALGAS_fixitElementAST::method_fixItInsertAfter (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItInsertAfter) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @fixitElementAST fixItInsertAfter invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_fixitElementAST::method_fixItInsertBefore (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItInsertBefore) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @fixitElementAST fixItInsertBefore invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_fixitElementAST::description (String & ioString,
                                          const int32_t inIndentation) const {
  ioString.appendString ("<enum @fixitElementAST: ") ;
  ioString.appendString (gEnumNameArrayFor_fixitElementAST [mEnum]) ;
...
void cPtr_errorInstructionAST::description (String & ioString,
                                            const int32_t inIndentation) const {
  ioString.appendString ("[@errorInstructionAST:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
...
void extensionMethod_enterFixItListInSemanticContext (const GALGAS_fixitListAST inObject,
  ...
  cEnumerator_fixitListAST enumerator_8032 (temp_0, kENUMERATION_UP) ;
  while (enumerator_8032.hasCurrentObject ()) {
    switch (enumerator_8032.current_mElement (HERE).enumValue ()) {
    ...
    case GALGAS_fixitElementAST::kEnum_fixItReplace:
      {
        const cEnumAssociatedValues_fixitElementAST_fixItReplace * extractPtr_8204 = (const cEnumAssociatedValues_fixitElementAST_fixItReplace *) (enumerator_8032.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_8140_exp = extractPtr_8204->mAssociatedValue0 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8140_exp.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 220)) ;
      }
      break ;
    case GALGAS_fixitElementAST::kEnum_fixItInsertBefore:
      {
        const cEnumAssociatedValues_fixitElementAST_fixItInsertBefore * extractPtr_8321 = (const cEnumAssociatedValues_fixitElementAST_fixItInsertBefore *) (enumerator_8032.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_8257_exp = extractPtr_8321->mAssociatedValue0 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8257_exp.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 222)) ;
      }
      break ;
    case GALGAS_fixitElementAST::kEnum_fixItInsertAfter:
      {
        const cEnumAssociatedValues_fixitElementAST_fixItInsertAfter * extractPtr_8437 = (const cEnumAssociatedValues_fixitElementAST_fixItInsertAfter *) (enumerator_8032.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_8373_exp = extractPtr_8437->mAssociatedValue0 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8373_exp.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 224)) ;
      }
      break ;
    }
...
void GALGAS_fixitElementForGeneration::method_fixItReplace (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItReplace) {
    outAssociatedValue0.drop () ;
    String s ;
    s.appendString ("method @fixitElementForGeneration fixItReplace invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_fixitElementForGeneration::method_fixItInsertBefore (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItInsertBefore) {
    outAssociatedValue0.drop () ;
    String s ;
    s.appendString ("method @fixitElementForGeneration fixItInsertBefore invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_fixitElementForGeneration::method_fixItInsertAfter (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_fixItInsertAfter) {
    outAssociatedValue0.drop () ;
    String s ;
    s.appendString ("method @fixitElementForGeneration fixItInsertAfter invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_fixitElementForGeneration::description (String & ioString,
                                                    const int32_t inIndentation) const {
  ioString.appendString ("<enum @fixitElementForGeneration: ") ;
  ioString.appendString (gEnumNameArrayFor_fixitElementForGeneration [mEnum]) ;
  mAssociatedValues.description (ioString, inIndentation) ;
  ioString.appendString (">") ;
}
...
void extensionMethod_generateFixIt (const GALGAS_fixitListForGeneration inObject,
  ...
  outArgument_outFixItArrayCppName = GALGAS_string ("fixItArray").add_operation (ioArgument_ioTemporaryVariableIndex.getter_string (SOURCE_FILE ("instruction-error.galgas", 414)), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 414)) ;
  ioArgument_ioTemporaryVariableIndex.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 415)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("TC_Array <C_FixItDescription> ").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 416)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 416)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 416)) ;
  const GALGAS_fixitListForGeneration temp_0 = inObject ;
  cEnumerator_fixitListForGeneration enumerator_16160 (temp_0, kENUMERATION_UP) ;
  while (enumerator_16160.hasCurrentObject ()) {
    switch (enumerator_16160.current_mElement (HERE).enumValue ()) {
    case GALGAS_fixitElementForGeneration::kNotBuilt:
      break ;
    case GALGAS_fixitElementForGeneration::kEnum_fixItRemove:
      {
        ioArgument_ioGeneratedCode.plusAssign_operation(outArgument_outFixItArrayCppName.add_operation (GALGAS_string (".appendObject (C_FixItDescription (kFixItRemove, \"\")) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 420)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 420)) ;
      }
      break ;
    case GALGAS_fixitElementForGeneration::kEnum_fixItReplace:
      {
        const cEnumAssociatedValues_fixitElementForGeneration_fixItReplace * extractPtr_16706 = (const cEnumAssociatedValues_fixitElementForGeneration_fixItReplace *) (enumerator_16160.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_16390_exp = extractPtr_16706->mAssociatedValue0 ;
        GALGAS_string var_receiverCppVarName_16563 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_16390_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_16563, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 422)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 429)).add_operation (GALGAS_string (", kFixItReplace, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 429)).add_operation (var_receiverCppVarName_16563, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 429)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 429)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 429)) ;
      }
      break ;
    case GALGAS_fixitElementForGeneration::kEnum_fixItInsertBefore:
      {
        const cEnumAssociatedValues_fixitElementForGeneration_fixItInsertBefore * extractPtr_17096 = (const cEnumAssociatedValues_fixitElementForGeneration_fixItInsertBefore *) (enumerator_16160.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_16775_exp = extractPtr_17096->mAssociatedValue0 ;
        GALGAS_string var_receiverCppVarName_16948 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_16775_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_16948, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 431)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 438)).add_operation (GALGAS_string (", kFixItInsertBefore, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 438)).add_operation (var_receiverCppVarName_16948, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 438)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 438)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 438)) ;
      }
      break ;
    case GALGAS_fixitElementForGeneration::kEnum_fixItInsertAfter:
      {
        const cEnumAssociatedValues_fixitElementForGeneration_fixItInsertAfter * extractPtr_17484 = (const cEnumAssociatedValues_fixitElementForGeneration_fixItInsertAfter *) (enumerator_16160.current_mElement (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_17164_exp = extractPtr_17484->mAssociatedValue0 ;
        GALGAS_string var_receiverCppVarName_17337 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_17164_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_17337, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 440)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 447)).add_operation (GALGAS_string (", kFixItInsertAfter, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 447)).add_operation (var_receiverCppVarName_17337, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 447)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 447)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 447)) ;
      }
      break ;
    }
...
void cPtr_enumeratedCollectionCstListInExpAST::description (String & ioString,
                                                            const int32_t inIndentation) const {
  ioString.appendString ("[@enumeratedCollectionCstListInExpAST:") ;
...
void cPtr_grammarInstructionSyntaxDirectedTranslationResultNone::description (String & ioString,
                                                                              const int32_t /* inIndentation */) const {
  ioString.appendString ("[@grammarInstructionSyntaxDirectedTranslationResultNone]") ;
}
...
void cPtr_grammarInstructionSyntaxDirectedTranslationDropResult::description (String & ioString,
                                                                              const int32_t inIndentation) const {
  ioString.appendString ("[@grammarInstructionSyntaxDirectedTranslationDropResult:") ;
...
void GALGAS_incDecKind::description (String & ioString,
                                     const int32_t /* inIndentation */) const {
  ioString.appendString ("<enum @incDecKind: ") ;
  ioString.appendString (gEnumNameArrayFor_incDecKind [mEnum]) ;
  ioString.appendString (">") ;
}
...
void cPtr_selfIncDecInstructionAST::description (String & ioString,
                                                 const int32_t inIndentation) const {
  ioString.appendString ("[@selfIncDecInstructionAST:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
...
void cPtr_selfIncDecNoOVFInstructionAST::description (String & ioString,
                                                      const int32_t inIndentation) const {
  ioString.appendString ("[@selfIncDecNoOVFInstructionAST:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
  mProperty_mKind.description (ioString, inIndentation+1) ;
  ioString.appendString ("]") ;
...
void cPtr_incDecInstructionForGeneration::description (String & ioString,
                                                       const int32_t inIndentation) const {
  ioString.appendString ("[@incDecInstructionForGeneration:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
  mProperty_mReceiverCppName.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
...
void cPtr_incDecNoOVFInstructionForGeneration::description (String & ioString,
                                                            const int32_t inIndentation) const {
  ioString.appendString ("[@incDecNoOVFInstructionForGeneration:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
  mProperty_mReceiverCppName.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
...
void GALGAS_ifExpressionKind::method_regularExp (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_regularExp) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @ifExpressionKind regularExp invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifExpressionKind::method_letExp (GALGAS_lstring & outAssociatedValue0,
  ...
  if (mEnum != kEnum_letExp) {
    ...
    String s ;
    s.appendString ("method @ifExpressionKind letExp invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifExpressionKind::method_optionalMethodCall (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_optionalMethodCall) {
    ...
    outAssociatedValue2.drop () ;
    String s ;
    s.appendString ("method @ifExpressionKind optionalMethodCall invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifExpressionKind::description (String & ioString,
                                           const int32_t inIndentation) const {
  ioString.appendString ("<enum @ifExpressionKind: ") ;
  ioString.appendString (gEnumNameArrayFor_ifExpressionKind [mEnum]) ;
  mAssociatedValues.description (ioString, inIndentation) ;
  ioString.appendString (">") ;
}
...
void GALGAS_optionalMethodActualArgument::method_actualOutput (GALGAS_semanticExpressionAST & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualOutput) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgument actualOutput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgument::method_actualLetInput (GALGAS_lstring & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualLetInput) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgument actualLetInput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgument::method_actualVarInput (GALGAS_lstring & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualVarInput) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgument actualVarInput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgument::method_actualInputJoker (GALGAS_bool & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualInputJoker) {
    ...
    outAssociatedValue2.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgument actualInputJoker invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgument::description (String & ioString,
                                                       const int32_t inIndentation) const {
  ioString.appendString ("<enum @optionalMethodActualArgument: ") ;
  ioString.appendString (gEnumNameArrayFor_optionalMethodActualArgument [mEnum]) ;
  mAssociatedValues.description (ioString, inIndentation) ;
  ioString.appendString (">") ;
}
...
void cCollectionElement_optionalMethodActualArgumentList::description (String & ioString, const int32_t inIndentation) const {
  ...
  ioString.appendNewLine () ;
  ioString.appendStringMultiple ("| ", inIndentation) ;
  ioString.appendString ("mActualArgument" ":") ;
...
void GALGAS_ifTestForGeneration::method_regular (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_regular) {
    outAssociatedValue0.drop () ;
    String s ;
    s.appendString ("method @ifTestForGeneration regular invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifTestForGeneration::method_letExp (GALGAS_string & outAssociatedValue0,
  ...
  if (mEnum != kEnum_letExp) {
    ...
    outAssociatedValue3.drop () ;
    String s ;
    s.appendString ("method @ifTestForGeneration letExp invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifTestForGeneration::method_optionalMethodCall (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_optionalMethodCall) {
    ...
    outAssociatedValue2.drop () ;
    String s ;
    s.appendString ("method @ifTestForGeneration optionalMethodCall invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_ifTestForGeneration::description (String & ioString,
                                              const int32_t inIndentation) const {
  ioString.appendString ("<enum @ifTestForGeneration: ") ;
  ioString.appendString (gEnumNameArrayFor_ifTestForGeneration [mEnum]) ;
  mAssociatedValues.description (ioString, inIndentation) ;
  ioString.appendString (">") ;
}
...
void GALGAS_optionalMethodActualArgumentForGeneration::method_actualOutput (GALGAS_semanticExpressionForGeneration & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualOutput) {
    outAssociatedValue0.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgumentForGeneration actualOutput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgumentForGeneration::method_actualLetInput (GALGAS_string & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualLetInput) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgumentForGeneration actualLetInput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgumentForGeneration::method_actualVarInput (GALGAS_string & outAssociatedValue0,
  ...
  if (mEnum != kEnum_actualVarInput) {
    ...
    outAssociatedValue1.drop () ;
    String s ;
    s.appendString ("method @optionalMethodActualArgumentForGeneration actualVarInput invoked with an invalid enum value") ;
    inCompiler->onTheFlyRunTimeError (s COMMA_THERE) ;
  }else{
...
void GALGAS_optionalMethodActualArgumentForGeneration::description (String & ioString,
                                                                    const int32_t inIndentation) const {
  ioString.appendString ("<enum @optionalMethodActualArgumentForGeneration: ") ;
  ioString.appendString (gEnumNameArrayFor_optionalMethodActualArgumentForGeneration [mEnum]) ;
  mAssociatedValues.description (ioString, inIndentation) ;
  ioString.appendString (">") ;
}
...
void cPtr_ifInstructionForGeneration::description (String & ioString,
                                                   const int32_t inIndentation) const {
  ioString.appendString ("[@ifInstructionForGeneration:") ;
  mProperty_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
  mProperty_mExpressions.description (ioString, inIndentation+1) ;
  ioString.appendString (", ") ;
