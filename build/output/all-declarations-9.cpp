...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
  ...
  while (enumerator_21979.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (enumerator_21979.current_mTypeName (HERE).getter_location (SOURCE_FILE ("lexiqueTypesForAST.galgas", 548)), var_m_22207, fixItArray1  COMMA_SOURCE_FILE ("lexiqueTypesForAST.galgas", 548)) ;
    }
