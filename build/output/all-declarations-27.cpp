...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1539)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInVar temp_1 = object ;
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (temp_1.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature"), fixItArray2  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1540)) ;
    }
  }
  GALGAS_unifiedTypeMap_2D_entry var_type_72978 ;
  {
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInVar temp_3 = object ;
  GALGAS_string joker_72980 ; // Joker input parameter
  GALGAS_string joker_72983 ; // Joker input parameter
  ioArgument_ioVariableMap.setter_searchForWriteAccess (temp_3.readProperty_mActualParameterName (), var_type_72978, joker_72980, joker_72983, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1542)) ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_73004 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mStringType () ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = GALGAS_bool (kIsNotEqual, var_expectedType_73004.objectCompare (var_type_72978)).boolEnum () ;
    if (kBoolTrue == test_4) {
      ...
      inCompiler->emitSemanticError (temp_5.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_6.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1546)).add_operation (GALGAS_string ("' parameter has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1546)).add_operation (var_type_72978.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1546)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1546)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1546)).add_operation (var_expectedType_73004.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1547)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1547)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1547)), fixItArray7  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1545)) ;
    }
  }
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1557)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar temp_1 = object ;
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (temp_1.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature"), fixItArray2  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1558)) ;
    }
  }
  ...
  GALGAS_string var_cppName_73840 = GALGAS_string ("var_").add_operation (temp_3.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1560)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1560)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1560)).add_operation (temp_4.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1560)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1560)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1560)) ;
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar temp_5 = object ;
  GALGAS_unifiedTypeMap_2D_entry var_type_73974 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), temp_5.readProperty_mActualParameterTypeName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1561)) ;
  {
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar temp_6 = object ;
  ioArgument_ioVariableMap.setter_insertDefinedLocalVariable (temp_6.readProperty_mActualParameterName (), var_type_73974, var_cppName_73840, var_cppName_73840, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1562)) ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_74203 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mStringType () ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    test_7 = GALGAS_bool (kIsNotEqual, var_expectedType_74203.objectCompare (var_type_73974)).boolEnum () ;
    if (kBoolTrue == test_7) {
      ...
      inCompiler->emitSemanticError (temp_8.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_9.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1566)).add_operation (GALGAS_string ("' parameter has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1566)).add_operation (var_type_73974.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1566)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1566)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1566)).add_operation (var_expectedType_74203.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1567)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1567)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1567)), fixItArray10  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1565)) ;
    }
  }
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1577)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst temp_1 = object ;
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (temp_1.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the ':>' construct requires the grammar to be declared with 'translate' feature"), fixItArray2  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1578)) ;
    }
  }
  ...
  GALGAS_string var_cppName_75032 = GALGAS_string ("var_").add_operation (temp_3.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1580)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1580)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1580)).add_operation (temp_4.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1580)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1580)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1580)) ;
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst temp_5 = object ;
  GALGAS_unifiedTypeMap_2D_entry var_type_75166 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), temp_5.readProperty_mActualParameterTypeName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1581)) ;
  {
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst temp_6 = object ;
  ioArgument_ioVariableMap.setter_insertLocalConstant (temp_6.readProperty_mActualParameterName (), var_type_75166, var_cppName_75032, var_cppName_75032, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1582)) ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_75388 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mStringType () ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    test_7 = GALGAS_bool (kIsNotEqual, var_expectedType_75388.objectCompare (var_type_75166)).boolEnum () ;
    if (kBoolTrue == test_7) {
      ...
      TC_Array <C_FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (temp_8.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_9.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1586)).add_operation (GALGAS_string ("' parameter has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1586)).add_operation (var_type_75166.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1586)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1586)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1586)).add_operation (var_expectedType_75388.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1587)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1587)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1587)), fixItArray10  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1585)) ;
    }
  }
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultNone_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * /* inObject */,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ioArgument_ioGeneratedCode.plusAssign_operation(function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1607)).add_operation (GALGAS_string (" << "), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1607)).add_operation (constinArgument_inAccessMethodName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1607)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1607)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1607)) ;
      {
      ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1608)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1608)) ;
      }
    }
  }
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInVar temp_1 = object ;
  GALGAS_string var_cppName_77496 = GALGAS_string ("var_").add_operation (temp_0.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1628)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1628)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1628)).add_operation (temp_1.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1628)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1628)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1628)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(var_cppName_77496.add_operation (GALGAS_string (" = GALGAS_string ("), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1629)).add_operation (constinArgument_inAccessMethodName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1629)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1629)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1629)) ;
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredVar temp_1 = object ;
  GALGAS_string var_cppName_78111 = GALGAS_string ("var_").add_operation (temp_0.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1639)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1639)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1639)).add_operation (temp_1.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1639)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1639)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1639)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_string ").add_operation (var_cppName_78111, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)).add_operation (constinArgument_inAccessMethodName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1640)) ;
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst_generateCode (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  const GALGAS_grammarInstructionSyntaxDirectedTranslationResultInDeclaredConst temp_1 = object ;
  GALGAS_string var_cppName_78731 = GALGAS_string ("var_").add_operation (temp_0.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1650)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1650)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1650)).add_operation (temp_1.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1650)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1650)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1650)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("const GALGAS_string ").add_operation (var_cppName_78731, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1651)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1651)).add_operation (constinArgument_inAccessMethodName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1651)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1651)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1651)) ;
}
...
void routine_analyzeSyntaxInstructionList (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1671)) ;
  {
  ioArgument_ioVariableMap.setter_openBranch (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1673)) ;
  }
  cEnumerator_syntaxInstructionList enumerator_79847 (constinArgument_inSyntaxInstructionListAST, kENUMERATION_UP) ;
  while (enumerator_79847.hasCurrentObject ()) {
    callExtensionMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_79847.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, ioArgument_ioVariableMap, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1676)) ;
    enumerator_79847.gotoNextObject () ;
  }
  {
  ioArgument_ioVariableMap.setter_closeBranch (constinArgument_inEndOfBranchLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1692)) ;
  }
}
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_localVarManager var_variableMap_81449 = GALGAS_localVarManager::constructor_emptySharedMap (SOURCE_FILE ("semanticAnalysis.galgas", 1719)) ;
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.readProperty_mSemanticContext (), constinArgument_inFormalArguments, var_variableMap_81449, outArgument_outSignatureForGeneration, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1720)) ;
  }
  outArgument_outSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1727)) ;
  cEnumerator_formalParameterListForGeneration enumerator_81773 (outArgument_outSignatureForGeneration, kENUMERATION_UP) ;
  while (enumerator_81773.hasCurrentObject ()) {
    outArgument_outSignature.addAssign_operation (enumerator_81773.current_mFormalSelector (HERE), enumerator_81773.current_mFormalArgumentType (HERE), enumerator_81773.current_mFormalArgumentPassingMode (HERE), enumerator_81773.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1729)) ;
    enumerator_81773.gotoNextObject () ;
  }
  outArgument_outInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1732)) ;
  GALGAS_stringlist var_localVariableCppNameList_82077 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1733)) ;
  cEnumerator_syntaxInstructionList enumerator_82113 (constinArgument_inSyntaxInstructionList, kENUMERATION_UP) ;
  while (enumerator_82113.hasCurrentObject ()) {
    callExtensionMethod_analyzeSyntaxInstruction ((const cPtr_syntaxInstructionAST *) enumerator_82113.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, constinArgument_inHasTranslateFeature, constinArgument_inTerminalMap, constinArgument_inLexiqueName, constinArgument_inNonterminalMap, constinArgument_inComponentName, constinArgument_inIndexNameSet, outArgument_outInstructionListForGeneration, var_variableMap_81449, ioArgument_ioSelectMethodCount, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1735)) ;
    enumerator_82113.gotoNextObject () ;
  }
  var_variableMap_81449.method_checkAutomatonStates (constinArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1751)) ;
}
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_lstring constinArgument_inSyntaxComponentUsefulnessName,
  ...
  GALGAS_nonterminalMap var_nonterminalMap_83798 ;
  {
  routine_buildNonterminalDeclarationsMap (constinArgument_inNonterminalDeclarationList, constinArgument_inSemanticContext, var_nonterminalMap_83798, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1776)) ;
  }
  cEnumerator_syntaxRuleListAST enumerator_83891 (constinArgument_inRuleList, kENUMERATION_UP) ;
  while (enumerator_83891.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap_83958 = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1783)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_84027 (enumerator_83891.current_mLabelList (HERE), kENUMERATION_UP) ;
    while (enumerator_84027.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_84112 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1785)) ;
      GALGAS_formalParameterSignature var_signature_84163 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1786)) ;
      cEnumerator_formalParameterListAST enumerator_84268 (enumerator_84027.current_mFormalArguments (HERE), kENUMERATION_UP) ;
      while (enumerator_84268.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_entry var_type_84309 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_84268.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1788)) ;
        var_signatureForGeneration_84112.addAssign_operation (enumerator_84268.current_mFormalSelector (HERE), enumerator_84268.current_mFormalArgumentPassingMode (HERE), var_type_84309, enumerator_84268.current_mFormalArgumentName (HERE), GALGAS_string ("argument_").add_operation (enumerator_84268.current_mFormalArgumentName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1794))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1789)) ;
        var_signature_84163.addAssign_operation (enumerator_84268.current_mFormalSelector (HERE), var_type_84309, enumerator_84268.current_mFormalArgumentPassingMode (HERE), enumerator_84268.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1795)) ;
        enumerator_84268.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap_83958.setter_insertKey (enumerator_84027.current_mLabelName (HERE), var_signatureForGeneration_84112, var_signature_84163, enumerator_84027.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1797)) ;
      }
      enumerator_84027.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_83891.current_mNonterminalName (HERE), var_nonterminalLabelMap_83958, var_nonterminalMap_83798, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1799)) ;
    }
    enumerator_83891.gotoNextObject () ;
  }
  GALGAS_analysisContext var_analysisContext_84975 = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_string::makeEmptyString (), GALGAS_selfAvailability::constructor_none (SOURCE_FILE ("semanticAnalysis.galgas", 1806)), GALGAS_string::makeEmptyString (), GALGAS_bool (false)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1802)) ;
  GALGAS_uint var_selectMethodCount_85217 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_ruleDeclarationList var_ruleDeclarationList_85268 = GALGAS_ruleDeclarationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1812)) ;
  GALGAS_uint var_newRuleIndex_85298 = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_syntaxRuleListAST enumerator_85337 (constinArgument_inRuleList, kENUMERATION_UP) ;
  while (enumerator_85337.hasCurrentObject ()) {
    GALGAS_ruleLabelImplementationList var_ruleLabelImplementationList_85427 = GALGAS_ruleLabelImplementationList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1816)) ;
    GALGAS_uint var_localSelectMethodCount_85469 = var_selectMethodCount_85217 ;
    GALGAS_nonterminalLabelMap joker_85539 ; // Joker input parameter
    var_nonterminalMap_83798.method_searchKey (enumerator_85337.current_mNonterminalName (HERE), joker_85539, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1818)) ;
    cEnumerator_syntaxRuleLabelListAST enumerator_85646 (enumerator_85337.current_mLabelList (HERE), kENUMERATION_UP) ;
    while (enumerator_85646.hasCurrentObject ()) {
      var_localSelectMethodCount_85469 = var_selectMethodCount_85217 ;
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_85780 ;
      GALGAS_formalParameterSignature var_signature_85826 ;
      GALGAS_semanticInstructionListForGeneration var_instructionListForGeneration_85903 ;
      {
      routine_semanticAnalysisOfRuleLabel (constinArgument_inSyntaxComponentUsefulnessName, ioArgument_ioUsefulEntitiesGraph, enumerator_85646.current_mFormalArguments (HERE), enumerator_85646.current_mSyntaxInstructionList (HERE), var_analysisContext_84975, constinArgument_inTerminalMap, constinArgument_inHasTranslateFeature, constinArgument_inLexiqueName.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1832)), var_nonterminalMap_83798, constinArgument_inSyntaxComponentName, enumerator_85646.current_mEndOfInstructionList (HERE), constinArgument_inIndexNameSet, var_localSelectMethodCount_85469, var_signatureForGeneration_85780, var_signature_85826, var_instructionListForGeneration_85903, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1824)) ;
      }
      var_ruleLabelImplementationList_85427.addAssign_operation (enumerator_85646.current_mLabelName (HERE), var_signatureForGeneration_85780, var_signature_85826, enumerator_85646.current_mEndOfArgumentLocation (HERE), var_instructionListForGeneration_85903  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1842)) ;
      enumerator_85646.gotoNextObject () ;
    }
    var_selectMethodCount_85217 = var_localSelectMethodCount_85469 ;
    GALGAS_nonterminalLabelMap joker_86722 ; // Joker input parameter
    var_nonterminalMap_83798.method_searchKey (enumerator_85337.current_mNonterminalName (HERE), joker_86722, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1850)) ;
    var_ruleDeclarationList_85268.addAssign_operation (enumerator_85337.current_mNonterminalName (HERE).readProperty_string (), var_newRuleIndex_85298, var_ruleLabelImplementationList_85427  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1851)) ;
    var_newRuleIndex_85298.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1855)) ;
    enumerator_85337.gotoNextObject () ;
  }
  outArgument_outSyntaxDeclarationForGeneration = GALGAS_syntaxDeclarationForGeneration::constructor_new (constinArgument_inSyntaxComponentName, constinArgument_inLexiqueName, var_nonterminalMap_83798, var_ruleDeclarationList_85268, var_selectMethodCount_85217, constinArgument_inHasIndexing, constinArgument_inHasTranslateFeature  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1858)) ;
}
