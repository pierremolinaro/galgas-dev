...
void cPtr_sortedListTypeForGeneration::method_appendDeclaration_31_ (GALGAS_stringset & /* ioArgument_ioInclusionSet */,
  ...
  GALGAS_unifiedTypeDefinition var_selfTypeDefinition_17935 = extensionGetter_definition (temp_0.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 462)) ;
  const GALGAS_sortedListTypeForGeneration temp_1 = this ;
  const GALGAS_sortedListTypeForGeneration temp_2 = this ;
  outArgument_outHeader = GALGAS_string (filewrapperTemplate_sortedListGenerationTemplate_sortedlistTypeHeader_31_ (inCompiler, var_selfTypeDefinition_17935.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_1.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 465)), temp_2.readProperty_mTypedAttributeList () COMMA_SOURCE_FILE ("type-sorted-list.galgas", 463))) ;
  const GALGAS_sortedListTypeForGeneration temp_3 = this ;
  outArgument_outHeader.plusAssign_operation(GALGAS_string (filewrapperTemplate_typeGenerationTemplate_unifiedClassBodyForType (inCompiler, var_selfTypeDefinition_17935.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_3.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 470)), var_selfTypeDefinition_17935.readProperty_isConcrete (), var_selfTypeDefinition_17935.readProperty_initializerMap (), var_selfTypeDefinition_17935.readProperty_classFunctionMap (), var_selfTypeDefinition_17935.readProperty_getterMap (), var_selfTypeDefinition_17935.readProperty_setterMap (), var_selfTypeDefinition_17935.readProperty_instanceMethodMap (), var_selfTypeDefinition_17935.readProperty_classMethodMap (), var_selfTypeDefinition_17935.readProperty_optionalMethodMap (), var_selfTypeDefinition_17935.readProperty_readSubscriptMap (), var_selfTypeDefinition_17935.readProperty_enumerationDescriptorList (), var_selfTypeDefinition_17935.readProperty_features (), var_selfTypeDefinition_17935.readProperty_addAssignOperatorArguments (), var_selfTypeDefinition_17935.readProperty_typeForEnumeratedElement (), var_selfTypeDefinition_17935.readProperty_supportCollectionValue () COMMA_SOURCE_FILE ("type-sorted-list.galgas", 468))), inCompiler  COMMA_SOURCE_FILE ("type-sorted-list.galgas", 468)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_sortedListTypeForGeneration::method_appendSpecificImplementation (const GALGAS_unifiedTypeMap /* constinArgument_inTypeMap */,
                                                                            ...
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_sortedListTypeForGeneration temp_0 = this ;
  cEnumerator_typedPropertyList enumerator_19253 (temp_0.readProperty_mTypedAttributeList (), EnumerationOrder::up) ;
  while (enumerator_19253.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName (enumerator_19253.current_typeEntry (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 495)) ;
    enumerator_19253.gotoNextObject () ;
  }
  const GALGAS_sortedListTypeForGeneration temp_1 = this ;
  extensionMethod_addHeaderFileName (temp_1.readProperty_mListElementTypeIndex (), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 497)) ;
  const GALGAS_sortedListTypeForGeneration temp_2 = this ;
  extensionMethod_addHeaderFileName (temp_2.readProperty_mSelfTypeEntry (), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 498)) ;
  const GALGAS_sortedListTypeForGeneration temp_3 = this ;
  GALGAS_unifiedTypeDefinition var_t_19468 = extensionGetter_definition (temp_3.readProperty_mListElementTypeIndex (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 499)) ;
  ...
  outArgument_outImplementation = GALGAS_string (filewrapperTemplate_sortedListGenerationTemplate_sortedlistTypeSpecificImplementation (inCompiler, extensionGetter_identifierRepresentation (temp_4.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 501)), temp_5.readProperty_mTypedAttributeList (), temp_6.readProperty_mSortDescriptorList (), var_t_19468.readProperty_typeName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("type-sorted-list.galgas", 504)), extensionGetter_generateCppObjectComparison (var_t_19468.readProperty_features (), inCompiler COMMA_SOURCE_FILE ("type-sorted-list.galgas", 505)) COMMA_SOURCE_FILE ("type-sorted-list.galgas", 500))) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_structDeclarationAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionInitializerForBuildingContext constinArgument_inExtensionInitializerMapForBuildingContext,
  ...
  GALGAS_unifiedTypeDefinition var_typeDefinition_9027 = GALGAS_unifiedTypeDefinition::init_21_typeName_21_isPredefined_21_isConcrete_21_superType_21_typeKind_21_supportCollectionValue_21_allTypedPropertyList_21_propertyMap_21_currentTypedPropertyList_21_initializerMap_21_classFunctionMap_21_getterMap_21_setterMap_21_instanceMethodMap_21_classMethodMap_21_unwrappedType_21_optionalMethodMap_21_readSubscriptMap_21_enumerationDescriptorList_21_features_21_addAssignOperatorArguments_21_mapSearchMethodList_21_generateHeaderInSeparateFile_21_typeForEnumeratedElement_21_headerFileName_21_headerKind (temp_12.readProperty_structTypeName (), temp_13.readProperty_isPredefined (), GALGAS_bool (true), GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("type-struct.galgas", 243)), GALGAS_typeKindEnum::class_func_structType (SOURCE_FILE ("type-struct.galgas", 244)), GALGAS_bool (false), var_typedPropertyList_6376, var_propertyMap_6224, var_typedPropertyList_6376, var_initializerMap_7619, var_classFunctionMap_6267, var_getterMap_7528, var_setterMap_7580, var_instanceMethodMap_7666, GALGAS_classMethodMap::init (inCompiler COMMA_HERE), GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("type-struct.galgas", 255)), var_optionalMethodMap_6026, GALGAS_subscriptMap::init (inCompiler COMMA_HERE), GALGAS_enumerationDescriptorList::init (inCompiler COMMA_HERE), var_features_8117, GALGAS_functionSignature::init (inCompiler COMMA_HERE), GALGAS_mapSearchMethodListAST::init (inCompiler COMMA_HERE), GALGAS_bool (false), var_enumeratedType_8797, GALGAS_string ("struct-").add_operation (temp_14.readProperty_structTypeName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("type-struct.galgas", 264)), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 264)), GALGAS_headerKind::class_func_oneHeader (SOURCE_FILE ("type-struct.galgas", 265)), inCompiler COMMA_HERE) ;
  {
  extensionSetter_insertType (ioArgument_ioTypeMap, var_typeDefinition_9027.readProperty_typeName (), var_typeDefinition_9027, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 267)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_structDeclarationAST::method_semanticAnalysis (GALGAS_lstringlist & /* ioArgument_ioUsefulnessRootEntities */,
                                                         ...
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_structDeclarationAST temp_0 = this ;
  GALGAS_lstring var_structNameForUsefulness_10751 = function_typeNameForUsefulEntitiesGraph (temp_0.readProperty_structTypeName (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 281)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_structNameForUsefulness_10751, var_structNameForUsefulness_10751, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 282)) ;
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_structDeclarationAST temp_2 = this ;
    test_1 = GALGAS_bool (ComparisonKind::equal, temp_2.readProperty_mStructurePropertyListAST ().getter_count (SOURCE_FILE ("type-struct.galgas", 284)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      const GALGAS_structDeclarationAST temp_3 = this ;
      TC_Array <FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (temp_3.readProperty_structTypeName ().readProperty_location (), GALGAS_string ("a structure cannot be empty: it must have at least one property"), fixItArray4  COMMA_SOURCE_FILE ("type-struct.galgas", 285)) ;
    }
  }
  GALGAS_typedPropertyList var_typedPropertyList_11116 = GALGAS_typedPropertyList::init (inCompiler COMMA_HERE) ;
  GALGAS_typedPropertyList var_constructorArgumentList_11166 = GALGAS_typedPropertyList::init (inCompiler COMMA_HERE) ;
  GALGAS_propertyIndexMap var_propertyMap_11221 = GALGAS_propertyIndexMap::init (inCompiler COMMA_HERE) ;
  const GALGAS_structDeclarationAST temp_5 = this ;
  cEnumerator_propertyInCollectionListAST enumerator_11263 (temp_5.readProperty_mStructurePropertyListAST (), EnumerationOrder::up) ;
  while (enumerator_11263.hasCurrentObject ()) {
    GALGAS_lstring var_propertyTypeNameForUsefulness_11302 = function_typeNameForUsefulEntitiesGraph (enumerator_11263.current (HERE).readProperty_typeName (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 291)) ;
    {
    ioArgument_ioUsefulEntitiesGraph.setter_addEdge (var_structNameForUsefulness_10751, var_propertyTypeNameForUsefulness_11302 COMMA_SOURCE_FILE ("type-struct.galgas", 292)) ;
    }
    GALGAS_unifiedTypeMapEntry var_t_11492 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, enumerator_11263.current (HERE).readProperty_typeName (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 293)) ;
    enumGalgasBool test_6 = kBoolTrue ;
    if (kBoolTrue == test_6) {
      test_6 = function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 294)).getter_hasKey (enumerator_11263.current (HERE).readProperty_name ().readProperty_string () COMMA_SOURCE_FILE ("type-struct.galgas", 294)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_string var_m_11638 = GALGAS_string ("an property cannot be named:") ;
        cEnumerator_stringset enumerator_11714 (function_forbiddenKeysForStruct (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 296)), EnumerationOrder::up) ;
        while (enumerator_11714.hasCurrentObject ()) {
          var_m_11638.plusAssign_operation(GALGAS_string (" ").add_operation (enumerator_11714.current (HERE), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 297)), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 297)) ;
          enumerator_11714.gotoNextObject () ;
        }
        var_m_11638.plusAssign_operation(GALGAS_string ("; theses names are reserved"), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 299)) ;
        TC_Array <FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (enumerator_11263.current (HERE).readProperty_name ().readProperty_location (), var_m_11638, fixItArray7  COMMA_SOURCE_FILE ("type-struct.galgas", 300)) ;
      }
    }
    {
    var_propertyMap_11221.setter_insertKey (enumerator_11263.current (HERE).readProperty_name (), var_t_11492, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 302)) ;
    }
    switch (enumerator_11263.current (HERE).readProperty_initialization ().enumValue ()) {
    case GALGAS_propertyInCollectionInitializationAST::kNotBuilt:
      break ;
    case GALGAS_propertyInCollectionInitializationAST::kEnum_none:
      {
        var_constructorArgumentList_11166.addAssign_operation (var_t_11492, enumerator_11263.current (HERE).readProperty_name (), enumerator_11263.current (HERE).readProperty_initialization (), enumerator_11263.current (HERE).readProperty_isConstant ().operator_not (SOURCE_FILE ("type-struct.galgas", 309)), enumerator_11263.current (HERE).readProperty_hasSelector ()  COMMA_SOURCE_FILE ("type-struct.galgas", 305)) ;
      }
      break ;
    ...
    var_typedPropertyList_11116.addAssign_operation (var_t_11492, enumerator_11263.current (HERE).readProperty_name (), enumerator_11263.current (HERE).readProperty_initialization (), enumerator_11263.current (HERE).readProperty_isConstant ().operator_not (SOURCE_FILE ("type-struct.galgas", 317)), enumerator_11263.current (HERE).readProperty_hasSelector ()  COMMA_SOURCE_FILE ("type-struct.galgas", 313)) ;
    const GALGAS_structDeclarationAST temp_8 = this ;
    switch (temp_8.readProperty_comparison ().enumValue ()) {
    case GALGAS_structComparison::kNotBuilt:
      break ;
    ...
    case GALGAS_structComparison::kEnum_equatable:
      {
        GALGAS_typeFeatures var_propertyFeatures_12464 = extensionGetter_definition (var_t_11492, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 323)).readProperty_features () ;
        enumGalgasBool test_9 = kBoolTrue ;
        if (kBoolTrue == test_9) {
          test_9 = var_propertyFeatures_12464.getter_equatable (SOURCE_FILE ("type-struct.galgas", 324)).operator_not (SOURCE_FILE ("type-struct.galgas", 324)).operator_and (var_propertyFeatures_12464.getter_comparable (SOURCE_FILE ("type-struct.galgas", 324)).operator_not (SOURCE_FILE ("type-struct.galgas", 324)) COMMA_SOURCE_FILE ("type-struct.galgas", 324)).operator_and (var_propertyFeatures_12464.getter_referenceEquatable (SOURCE_FILE ("type-struct.galgas", 324)).operator_not (SOURCE_FILE ("type-struct.galgas", 324)) COMMA_SOURCE_FILE ("type-struct.galgas", 324)).boolEnum () ;
          if (kBoolTrue == test_9) {
            TC_Array <FixItDescription> fixItArray10 ;
            inCompiler->emitSemanticError (enumerator_11263.current (HERE).readProperty_name ().readProperty_location (), GALGAS_string ("the structure is not equatable, because '").add_operation (enumerator_11263.current (HERE).readProperty_name ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 326)).add_operation (GALGAS_string ("' is not"), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 326)), fixItArray10  COMMA_SOURCE_FILE ("type-struct.galgas", 325)) ;
          }
        }
      }
      break ;
    case GALGAS_structComparison::kEnum_comparable:
      {
        ...
        if (kBoolTrue == test_11) {
          test_11 = extensionGetter_definition (var_t_11492, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 329)).readProperty_features ().getter_comparable (SOURCE_FILE ("type-struct.galgas", 329)).operator_not (SOURCE_FILE ("type-struct.galgas", 329)).boolEnum () ;
          if (kBoolTrue == test_11) {
            TC_Array <FixItDescription> fixItArray12 ;
            inCompiler->emitSemanticError (enumerator_11263.current (HERE).readProperty_name ().readProperty_location (), GALGAS_string ("the structure is not comparable, because '").add_operation (enumerator_11263.current (HERE).readProperty_name ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 331)).add_operation (GALGAS_string ("' is not"), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 331)), fixItArray12  COMMA_SOURCE_FILE ("type-struct.galgas", 330)) ;
          }
        }
      }
      break ;
  ...
  GALGAS_stringset var_unusedVariableCppNameSet_13244 ;
  GALGAS_string var_initializationCode_13280 ;
  const GALGAS_structDeclarationAST temp_13 = this ;
  extensionMethod_buildPropertyInitializationCode (temp_13.readProperty_mStructurePropertyListAST (), var_structNameForUsefulness_10751, constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, ioArgument_ioUsefulEntitiesGraph, ioArgument_ioTypeMap, var_unusedVariableCppNameSet_13244, var_initializationCode_13280, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 336)) ;
  GALGAS_bool var_constructorNeedsCompilerVar_13320 = var_unusedVariableCppNameSet_13244.getter_hasKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 346)) COMMA_SOURCE_FILE ("type-struct.galgas", 346)).operator_not (SOURCE_FILE ("type-struct.galgas", 346)) ;
  const GALGAS_structDeclarationAST temp_14 = this ;
  GALGAS_unifiedTypeMapEntry var_structType_13416 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, temp_14.readProperty_structTypeName (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 347)) ;
  const GALGAS_structDeclarationAST temp_15 = this ;
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("struct ").add_operation (temp_15.readProperty_structTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 349)), GALGAS_structTypeForGeneration::init_21__21__21__21__21__21_ (var_structType_13416, var_typedPropertyList_11116, var_constructorArgumentList_11166, var_initializationCode_13280, var_constructorNeedsCompilerVar_13320, extensionGetter_definition (var_structType_13416, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 356)).readProperty_features ().getter_generateSynthetizedInitializer (SOURCE_FILE ("type-struct.galgas", 356)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("type-struct.galgas", 348)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_structTypeForGeneration::method_appendDeclaration_31_ (GALGAS_stringset & ioArgument_ioInclusionSet,
  ...
  cEnumerator_typedPropertyList enumerator_14689 (temp_0.readProperty_mTypedPropertyList (), EnumerationOrder::up) ;
  while (enumerator_14689.hasCurrentObject ()) {
    extensionMethod_addHeaderFileName_31_ (enumerator_14689.current_typeEntry (HERE), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 379)) ;
    enumerator_14689.gotoNextObject () ;
  }
  const GALGAS_structTypeForGeneration temp_1 = this ;
  GALGAS_unifiedTypeDefinition var_selfTypeDefinition_14784 = extensionGetter_definition (temp_1.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 381)) ;
  const GALGAS_structTypeForGeneration temp_2 = this ;
  const GALGAS_structTypeForGeneration temp_3 = this ;
  outArgument_outHeader = GALGAS_string (filewrapperTemplate_structureGenerationTemplate_structTypeHeader_31_ (inCompiler, var_selfTypeDefinition_14784.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_2.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 384)), temp_3.readProperty_mTypedPropertyList () COMMA_SOURCE_FILE ("type-struct.galgas", 382))) ;
  const GALGAS_structTypeForGeneration temp_4 = this ;
  outArgument_outHeader.plusAssign_operation(GALGAS_string (filewrapperTemplate_typeGenerationTemplate_unifiedClassBodyForType (inCompiler, var_selfTypeDefinition_14784.readProperty_typeName ().readProperty_string (), extensionGetter_identifierRepresentation (temp_4.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 389)), var_selfTypeDefinition_14784.readProperty_isConcrete (), var_selfTypeDefinition_14784.readProperty_initializerMap (), var_selfTypeDefinition_14784.readProperty_classFunctionMap (), var_selfTypeDefinition_14784.readProperty_getterMap (), var_selfTypeDefinition_14784.readProperty_setterMap (), var_selfTypeDefinition_14784.readProperty_instanceMethodMap (), var_selfTypeDefinition_14784.readProperty_classMethodMap (), var_selfTypeDefinition_14784.readProperty_optionalMethodMap (), var_selfTypeDefinition_14784.readProperty_readSubscriptMap (), var_selfTypeDefinition_14784.readProperty_enumerationDescriptorList (), var_selfTypeDefinition_14784.readProperty_features (), var_selfTypeDefinition_14784.readProperty_addAssignOperatorArguments (), var_selfTypeDefinition_14784.readProperty_typeForEnumeratedElement (), var_selfTypeDefinition_14784.readProperty_supportCollectionValue () COMMA_SOURCE_FILE ("type-struct.galgas", 387))), inCompiler  COMMA_SOURCE_FILE ("type-struct.galgas", 387)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_structTypeForGeneration::method_appendSpecificImplementation (const GALGAS_unifiedTypeMap /* constinArgument_inTypeMap */,
  ...
  const GALGAS_structTypeForGeneration temp_1 = this ;
  GALGAS_unifiedTypeDefinition var_selfTypeDefinition_16161 = extensionGetter_definition (temp_1.readProperty_mSelfTypeEntry (), inCompiler COMMA_SOURCE_FILE ("type-struct.galgas", 415)) ;
  const GALGAS_structTypeForGeneration temp_2 = this ;
  const GALGAS_structTypeForGeneration temp_3 = this ;
  const GALGAS_structTypeForGeneration temp_4 = this ;
...
void cPtr_outputInputSelfParameterAST::method_checkAgainstFormalArgument (const GALGAS_lstring /* constinArgument_inUsefulnessCallerEntityName */,
  ...
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    GALGAS_unifiedTypeMapEntry var_selfType_20468 ;
    GALGAS_selfMutability var_selfMutability_20498 ;
    const bool optionalResult20447 = constinArgument_inAnalysisContext.readProperty_selfAvailability ().optional_available (var_selfType_20468, var_selfMutability_20498) ;
    if (!optionalResult20447) {
      test_9 = kBoolFalse ;
    }
    if (kBoolTrue == test_9) {
      enumGalgasBool test_10 = kBoolTrue ;
      if (kBoolTrue == test_10) {
        test_10 = extensionGetter_selfIsMutable (var_selfMutability_20498, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 428)).operator_not (SOURCE_FILE ("actual-parameters.galgas", 428)).boolEnum () ;
        if (kBoolTrue == test_10) {
      ...
      enumGalgasBool test_13 = kBoolTrue ;
      if (kBoolTrue == test_13) {
        test_13 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_selfType_20468)).boolEnum () ;
        if (kBoolTrue == test_13) {
          const GALGAS_outputInputSelfParameterAST temp_14 = this ;
          TC_Array <FixItDescription> fixItArray15 ;
          inCompiler->emitSemanticError (temp_14.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_selfType_20468, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 434)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 434)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 434)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 436)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 435)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 436)), fixItArray15  COMMA_SOURCE_FILE ("actual-parameters.galgas", 433)) ;
        }
      }
...
void cPtr_inputActualExistingVariableParameterAST::method_checkAgainstFormalArgument (const GALGAS_lstring /* constinArgument_inUsefulnessCallerEntityName */,
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_23817 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 500)) ;
        const GALGAS_inputActualExistingVariableParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_23817) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_23817, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 501)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 501)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 501)) ;
      }
    }
  }
  GALGAS_unifiedTypeMapEntry var_parameterType_24244 ;
  GALGAS_string var_targetVariableCppName_24269 ;
  {
  const GALGAS_inputActualExistingVariableParameterAST temp_9 = this ;
  GALGAS_string joker_24297 ; // Joker input parameter
  extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, temp_9.readProperty_mInputActualParameterName (), var_parameterType_24244, var_targetVariableCppName_24269, joker_24297, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 504)) ;
  }
  enumGalgasBool test_10 = kBoolTrue ;
  if (kBoolTrue == test_10) {
    test_10 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType_24244)).boolEnum () ;
    if (kBoolTrue == test_10) {
      const GALGAS_inputActualExistingVariableParameterAST temp_11 = this ;
      TC_Array <FixItDescription> fixItArray12 ;
      inCompiler->emitSemanticError (temp_11.readProperty_mInputActualParameterName ().readProperty_location (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_parameterType_24244, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 513)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 513)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 513)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 514)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 514)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 514)), fixItArray12  COMMA_SOURCE_FILE ("actual-parameters.galgas", 512)) ;
    }
  }
  enumGalgasBool test_13 = kBoolTrue ;
  if (kBoolTrue == test_13) {
  ...
  GALGAS__32_stringlist var_poisonedVarCppNameList_25021 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
  const GALGAS_inputActualExistingVariableParameterAST temp_18 = this ;
  cEnumerator_lstringlist enumerator_25058 (temp_18.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
  while (enumerator_25058.hasCurrentObject ()) {
    GALGAS_string var_targetVariableCppName_25184 ;
    GALGAS_string var_nameForCheckingFormalParameterUsing_25219 ;
    {
    GALGAS_unifiedTypeMapEntry joker_25168 ; // Joker input parameter
    extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_25058.current_mValue (HERE), joker_25168, var_targetVariableCppName_25184, var_nameForCheckingFormalParameterUsing_25219, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 525)) ;
    }
    var_poisonedVarCppNameList_25021.addAssign_operation (var_targetVariableCppName_25184, var_nameForCheckingFormalParameterUsing_25219  COMMA_SOURCE_FILE ("actual-parameters.galgas", 531)) ;
    enumerator_25058.gotoNextObject () ;
  }
  ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputActualParameterForGeneration::init_21__21__21_ (var_parameterType_24244, var_targetVariableCppName_24269, var_poisonedVarCppNameList_25021, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 533)) ;
}
//--------------------------------------------------------------------------------------------------
//
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_28007 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 592)) ;
        const GALGAS_inputActualSelfPropertyParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_28007) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_28007, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 593)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 593)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 593)) ;
      }
    }
  }
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    GALGAS_unifiedTypeMapEntry var_selfType_28266 ;
    GALGAS_selfMutability var_selfMutability_28296 ;
    const bool optionalResult28245 = constinArgument_inAnalysisContext.readProperty_selfAvailability ().optional_available (var_selfType_28266, var_selfMutability_28296) ;
    if (!optionalResult28245) {
      test_9 = kBoolFalse ;
    }
    if (kBoolTrue == test_9) {
      enumGalgasBool test_10 = kBoolTrue ;
      if (kBoolTrue == test_10) {
        test_10 = extensionGetter_propertiesAreMutable (var_selfMutability_28296, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 597)).operator_not (SOURCE_FILE ("actual-parameters.galgas", 597)).boolEnum () ;
        if (kBoolTrue == test_10) {
      ...
      GALGAS_propertyMap var_propertyMap_28480 = extensionGetter_definition (var_selfType_28266, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 600)).readProperty_propertyMap () ;
      GALGAS_unifiedTypeMapEntry var_parameterType_28601 ;
      const GALGAS_inputActualSelfPropertyParameterAST temp_13 = this ;
      GALGAS_AccessControl joker_28592_2 ; // Joker input parameter
      GALGAS_bool joker_28592_1 ; // Joker input parameter
      var_propertyMap_28480.method_searchKey (temp_13.readProperty_mInputActualSelfPropertyName (), joker_28592_2, joker_28592_1, var_parameterType_28601, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 601)) ;
      const GALGAS_inputActualSelfPropertyParameterAST temp_14 = this ;
      GALGAS_string var_targetVariableCppName_28626 = constinArgument_inAnalysisContext.readProperty_selfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 602)).add_operation (temp_14.readProperty_mInputActualSelfPropertyName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("actual-parameters.galgas", 603)), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 603)) ;
      enumGalgasBool test_15 = kBoolTrue ;
      if (kBoolTrue == test_15) {
        test_15 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType_28601)).boolEnum () ;
        if (kBoolTrue == test_15) {
          const GALGAS_inputActualSelfPropertyParameterAST temp_16 = this ;
          TC_Array <FixItDescription> fixItArray17 ;
          inCompiler->emitSemanticError (temp_16.readProperty_mInputActualSelfPropertyName ().readProperty_location (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_parameterType_28601, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 607)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 607)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 607)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 608)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 608)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 608)), fixItArray17  COMMA_SOURCE_FILE ("actual-parameters.galgas", 606)) ;
        }
      }
      GALGAS__32_stringlist var_poisonedVarCppNameList_29211 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
      const GALGAS_inputActualSelfPropertyParameterAST temp_18 = this ;
      cEnumerator_lstringlist enumerator_29250 (temp_18.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
      while (enumerator_29250.hasCurrentObject ()) {
        GALGAS_string var_targetVariableCppName_29384 ;
        GALGAS_string var_nameForCheckingFormalParameterUsing_29421 ;
        {
        GALGAS_unifiedTypeMapEntry joker_29366 ; // Joker input parameter
        extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_29250.current_mValue (HERE), joker_29366, var_targetVariableCppName_29384, var_nameForCheckingFormalParameterUsing_29421, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 613)) ;
        }
        var_poisonedVarCppNameList_29211.addAssign_operation (var_targetVariableCppName_29384, var_nameForCheckingFormalParameterUsing_29421  COMMA_SOURCE_FILE ("actual-parameters.galgas", 619)) ;
        enumerator_29250.gotoNextObject () ;
      }
      ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputActualParameterForGeneration::init_21__21__21_ (var_parameterType_28601, var_targetVariableCppName_28626, var_poisonedVarCppNameList_29211, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 621)) ;
    }
  }
  if (kBoolFalse == test_9) {
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_32308 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 684)) ;
        const GALGAS_inputActualSelfParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_32308) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_32308, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 685)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 685)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 685)) ;
      }
    }
  }
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    GALGAS_unifiedTypeMapEntry var_selfType_32567 ;
    GALGAS_selfMutability var_selfMutability_32597 ;
    const bool optionalResult32546 = constinArgument_inAnalysisContext.readProperty_selfAvailability ().optional_available (var_selfType_32567, var_selfMutability_32597) ;
    if (!optionalResult32546) {
      test_9 = kBoolFalse ;
    }
    if (kBoolTrue == test_9) {
      enumGalgasBool test_10 = kBoolTrue ;
      if (kBoolTrue == test_10) {
        test_10 = extensionGetter_selfIsMutable (var_selfMutability_32597, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 689)).operator_not (SOURCE_FILE ("actual-parameters.galgas", 689)).boolEnum () ;
        if (kBoolTrue == test_10) {
      ...
      GALGAS_string var_targetVariableCppName_32907 = constinArgument_inAnalysisContext.readProperty_selfObjectCppName () ;
      enumGalgasBool test_13 = kBoolTrue ;
      if (kBoolTrue == test_13) {
        test_13 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_selfType_32567)).boolEnum () ;
        if (kBoolTrue == test_13) {
          const GALGAS_inputActualSelfParameterAST temp_14 = this ;
          TC_Array <FixItDescription> fixItArray15 ;
          inCompiler->emitSemanticError (temp_14.readProperty_mSelfLocation (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_selfType_32567, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 699)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 699)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 699)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 701)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 700)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 701)), fixItArray15  COMMA_SOURCE_FILE ("actual-parameters.galgas", 698)) ;
        }
      }
      GALGAS__32_stringlist var_poisonedVarCppNameList_33454 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
      const GALGAS_inputActualSelfParameterAST temp_16 = this ;
      cEnumerator_lstringlist enumerator_33493 (temp_16.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
      while (enumerator_33493.hasCurrentObject ()) {
        GALGAS_string var_targetVariableCppName_33627 ;
        GALGAS_string var_nameForCheckingFormalParameterUsing_33664 ;
        {
        GALGAS_unifiedTypeMapEntry joker_33609 ; // Joker input parameter
        extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_33493.current_mValue (HERE), joker_33609, var_targetVariableCppName_33627, var_nameForCheckingFormalParameterUsing_33664, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 706)) ;
        }
        var_poisonedVarCppNameList_33454.addAssign_operation (var_targetVariableCppName_33627, var_nameForCheckingFormalParameterUsing_33664  COMMA_SOURCE_FILE ("actual-parameters.galgas", 712)) ;
        enumerator_33493.gotoNextObject () ;
      }
      ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputActualParameterForGeneration::init_21__21__21_ (var_selfType_32567, var_targetVariableCppName_32907, var_poisonedVarCppNameList_33454, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 714)) ;
    }
  }
  if (kBoolFalse == test_9) {
...
void cPtr_inputActualNewVariableParameterAST::method_checkAgainstFormalArgument (const GALGAS_lstring /* constinArgument_inUsefulnessCallerEntityName */,
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_36617 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 780)) ;
        const GALGAS_inputActualNewVariableParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_36617) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_36617, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 781)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 781)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 781)) ;
      }
    }
  }
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_unifiedTypeMapEntry var_parameterType_36905 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, temp_11.readProperty_mInputOptionalActualTypeName (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 785)) ;
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType_36905)).boolEnum () ;
        if (kBoolTrue == test_12) {
          const GALGAS_inputActualNewVariableParameterAST temp_13 = this ;
          TC_Array <FixItDescription> fixItArray14 ;
          inCompiler->emitSemanticError (temp_13.readProperty_mInputActualParameterName ().readProperty_location (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_parameterType_36905, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 788)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 788)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 788)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 790)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 789)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 790)), fixItArray14  COMMA_SOURCE_FILE ("actual-parameters.galgas", 787)) ;
        }
      }
    }
  }
  ...
  GALGAS_string var_targetVariableCppName_37373 = GALGAS_string ("var_").add_operation (temp_15.readProperty_mInputActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("actual-parameters.galgas", 794)), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 794)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 794)).add_operation (temp_16.readProperty_mInputActualParameterName ().readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 794)).getter_string (SOURCE_FILE ("actual-parameters.galgas", 794)), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 794)) ;
  {
  const GALGAS_inputActualNewVariableParameterAST temp_17 = this ;
  extensionSetter_insertInitializedLocalVariable (ioArgument_ioVariableMap, temp_17.readProperty_mInputActualParameterName (), GALGAS_bool (true), constinArgument_inFormalArgumentType, var_targetVariableCppName_37373, var_targetVariableCppName_37373, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 795)) ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::init_21__21_ (constinArgument_inFormalArgumentType, var_targetVariableCppName_37373, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 803)) ;
  enumGalgasBool test_18 = kBoolTrue ;
  if (kBoolTrue == test_18) {
  ...
  GALGAS__32_stringlist var_poisonedVarCppNameList_38303 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
  const GALGAS_inputActualNewVariableParameterAST temp_23 = this ;
  cEnumerator_lstringlist enumerator_38340 (temp_23.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
  while (enumerator_38340.hasCurrentObject ()) {
    GALGAS_string var_targetVariableCppName_38466 ;
    GALGAS_string var_nameForCheckingFormalParameterUsing_38501 ;
    {
    GALGAS_unifiedTypeMapEntry joker_38450 ; // Joker input parameter
    extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_38340.current_mValue (HERE), joker_38450, var_targetVariableCppName_38466, var_nameForCheckingFormalParameterUsing_38501, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 815)) ;
    }
    var_poisonedVarCppNameList_38303.addAssign_operation (var_targetVariableCppName_38466, var_nameForCheckingFormalParameterUsing_38501  COMMA_SOURCE_FILE ("actual-parameters.galgas", 821)) ;
    enumerator_38340.gotoNextObject () ;
  }
  ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputActualParameterForGeneration::init_21__21__21_ (constinArgument_inFormalArgumentType, var_targetVariableCppName_37373, var_poisonedVarCppNameList_38303, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 823)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_inputActualNewConstantParameterAST::method_checkAgainstFormalArgument (const GALGAS_lstring /* constinArgument_inUsefulnessCallerEntityName */,
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_41426 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 886)) ;
        const GALGAS_inputActualNewConstantParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_41426) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_41426, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 887)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 887)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 887)) ;
      }
    }
  }
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_unifiedTypeMapEntry var_parameterType_41714 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, temp_11.readProperty_mInputOptionalActualTypeName (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 891)) ;
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = GALGAS_bool (ComparisonKind::notEqual, constinArgument_inFormalArgumentType.objectCompare (var_parameterType_41714)).boolEnum () ;
        if (kBoolTrue == test_12) {
          const GALGAS_inputActualNewConstantParameterAST temp_13 = this ;
          TC_Array <FixItDescription> fixItArray14 ;
          inCompiler->emitSemanticError (temp_13.readProperty_mInputActualParameterName ().readProperty_location (), GALGAS_string ("the parameter object has the '@").add_operation (extensionGetter_definition (var_parameterType_41714, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 894)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 894)).add_operation (GALGAS_string ("', it should be the same as the corresponding formal argument: '@"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 894)).add_operation (extensionGetter_definition (constinArgument_inFormalArgumentType, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 895)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 895)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 895)), fixItArray14  COMMA_SOURCE_FILE ("actual-parameters.galgas", 893)) ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_17) {
    ...
    if (kBoolTrue == test_17) {
      ...
      extensionSetter_insertUsedLocalConstant (ioArgument_ioVariableMap, temp_19.readProperty_mInputActualParameterName (), constinArgument_inFormalArgumentType, var_targetVariableCppName_42174, var_targetVariableCppName_42174, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 901)) ;
      }
    }
  }
  if (kBoolFalse == test_17) {
    ...
    extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, temp_20.readProperty_mInputActualParameterName (), constinArgument_inFormalArgumentType, var_targetVariableCppName_42174, var_targetVariableCppName_42174, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 908)) ;
    }
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_localVariableDeclarationForGeneration::init_21__21_ (constinArgument_inFormalArgumentType, var_targetVariableCppName_42174, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 916)) ;
  ...
  GALGAS__32_stringlist var_poisonedVarCppNameList_43327 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
  const GALGAS_inputActualNewConstantParameterAST temp_26 = this ;
  cEnumerator_lstringlist enumerator_43364 (temp_26.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
  while (enumerator_43364.hasCurrentObject ()) {
    GALGAS_string var_targetVariableCppName_43490 ;
    GALGAS_string var_nameForCheckingFormalParameterUsing_43525 ;
    {
    GALGAS_unifiedTypeMapEntry joker_43474 ; // Joker input parameter
    extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_43364.current_mValue (HERE), joker_43474, var_targetVariableCppName_43490, var_nameForCheckingFormalParameterUsing_43525, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 929)) ;
    }
    var_poisonedVarCppNameList_43327.addAssign_operation (var_targetVariableCppName_43490, var_nameForCheckingFormalParameterUsing_43525  COMMA_SOURCE_FILE ("actual-parameters.galgas", 935)) ;
    enumerator_43364.gotoNextObject () ;
  }
  ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputActualParameterForGeneration::init_21__21__21_ (constinArgument_inFormalArgumentType, var_targetVariableCppName_42174, var_poisonedVarCppNameList_43327, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 937)) ;
}
//--------------------------------------------------------------------------------------------------
//
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_3) {
        ...
        GALGAS_string var_s_46309 = GALGAS_string ("\?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 995)) ;
        const GALGAS_inputSingleJokerActualParameterAST temp_7 = this ;
        TC_Array <FixItDescription> fixItArray8 ;
        appendFixItActions (fixItArray8, kFixItReplace, var_s_46309) ;
        inCompiler->emitSemanticError (temp_7.readProperty_mActualSelector ().readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_46309, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 996)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 996)), fixItArray8  COMMA_SOURCE_FILE ("actual-parameters.galgas", 996)) ;
      }
    }
    if (kBoolFalse == test_3) {
      const GALGAS_inputSingleJokerActualParameterAST temp_9 = this ;
      GALGAS_string var_cppVarName_46510 = GALGAS_string ("joker_").add_operation (temp_9.readProperty_mActualSelector ().readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 998)).getter_string (SOURCE_FILE ("actual-parameters.galgas", 998)), inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 998)) ;
      GALGAS__32_stringlist var_poisonedVarCppNameList_46643 = GALGAS__32_stringlist::init (inCompiler COMMA_HERE) ;
      const GALGAS_inputSingleJokerActualParameterAST temp_10 = this ;
      cEnumerator_lstringlist enumerator_46682 (temp_10.readProperty_mPoisonedVarNameList (), EnumerationOrder::up) ;
      while (enumerator_46682.hasCurrentObject ()) {
        GALGAS_string var_targetVariableCppName_46816 ;
        GALGAS_string var_nameForCheckingFormalParameterUsing_46853 ;
        {
        GALGAS_unifiedTypeMapEntry joker_46798 ; // Joker input parameter
        extensionSetter_searchForWriteAccess (ioArgument_ioVariableMap, enumerator_46682.current_mValue (HERE), joker_46798, var_targetVariableCppName_46816, var_nameForCheckingFormalParameterUsing_46853, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 1002)) ;
        }
        var_poisonedVarCppNameList_46643.addAssign_operation (var_targetVariableCppName_46816, var_nameForCheckingFormalParameterUsing_46853  COMMA_SOURCE_FILE ("actual-parameters.galgas", 1008)) ;
        enumerator_46682.gotoNextObject () ;
      }
      ioArgument_ioActualParameterListForGeneration.addAssign_operation (GALGAS_inputJokerParameterForGeneration::init_21__21__21_ (constinArgument_inFormalArgumentType, var_cppVarName_46510, var_poisonedVarCppNameList_46643, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("actual-parameters.galgas", 1010)) ;
    }
  }
}
//--------------------------------------------------------------------------------------------------
...
GALGAS_string cPtr_filewrapperDeclarationAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("filewrapper @").add_operation (temp_0.readProperty_mFilewrapperName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 364)) ;
//---
  return result_result ;
}
...
GALGAS_string cPtr_optionComponentDeclarationAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("option ").add_operation (temp_0.readProperty_mOptionComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 371)) ;
//---
  return result_result ;
}
...
GALGAS_string cPtr_graphDeclarationAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("graph @").add_operation (temp_0.readProperty_mGraphTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 378)) ;
//---
  return result_result ;
}
...
GALGAS_string cPtr_onceFunctionDeclarationAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("once function ").add_operation (temp_0.readProperty_mFunctionName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 385)) ;
//---
  return result_result ;
}
...
GALGAS_string cPtr_externFunctionDeclarationAST::getter_keyRepresentation (Compiler * inCompiler
  ...
  result_result = GALGAS_string ("extern function ").add_operation (temp_0.readProperty_mFunctionName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 391)) ;
//---
  return result_result ;
}
...
void routine_addExtensions_3F__3F__3F__3F__26__26__3F__3F_isClass_26__26__26__26__3F_acceptSetters (const GALGAS_extensionInitializerForBuildingContext constinArgument_inExtensionInitializerMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_extensionGetterMapForType var_extensionGetterMapForType_16794 ;
      constinArgument_inExtensionGetterMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionGetterMapForType_16794, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 416)) ;
      cEnumerator_extensionGetterMapForType enumerator_16877 (var_extensionGetterMapForType_16794, EnumerationOrder::up) ;
      while (enumerator_16877.hasCurrentObject ()) {
        GALGAS_functionSignature var_formalArgumentList_16949 = GALGAS_functionSignature::init (inCompiler COMMA_HERE) ;
        cEnumerator_formalInputParameterListAST enumerator_17006 (enumerator_16877.current_mInputFormalParameterList (HERE), EnumerationOrder::up) ;
        while (enumerator_17006.hasCurrentObject ()) {
          GALGAS_unifiedTypeMapEntry var_typeIndex_17116 ;
          {
          extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_17006.current (HERE).readProperty_mFormalArgumentTypeName (), var_typeIndex_17116, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 420)) ;
          }
          var_formalArgumentList_16949.addAssign_operation (enumerator_17006.current (HERE).readProperty_mFormalSelector (), var_typeIndex_17116, enumerator_17006.current (HERE).readProperty_mFormalArgumentName ().readProperty_string (), enumerator_17006.current (HERE).readProperty_mIsConstant ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 421)) ;
          enumerator_17006.gotoNextObject () ;
        }
        GALGAS_unifiedTypeMapEntry var_returnedType_17387 ;
        {
        extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_16877.current_mResultTypeName (HERE), var_returnedType_17387, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 427)) ;
        }
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (ComparisonKind::equal, enumerator_16877.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualOverriding (SOURCE_FILE ("semanticContext.galgas", 428)))).boolEnum () ;
          if (kBoolTrue == test_1) {
            enumGalgasBool test_2 = kBoolTrue ;
            if (kBoolTrue == test_2) {
              test_2 = ioArgument_ioGetterMap.getter_hasKey (enumerator_16877.current_lkey (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 429)).boolEnum () ;
              if (kBoolTrue == test_2) {
                {
                ioArgument_ioGetterMap.setter_setMQualifierForKey (GALGAS_methodQualifier::class_func_isVirtualOverriding (SOURCE_FILE ("semanticContext.galgas", 430)), enumerator_16877.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 430)) ;
                }
              }
            }
          }
        ...
        if (kBoolFalse == test_1) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = GALGAS_bool (ComparisonKind::equal, enumerator_16877.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualOverridingAbstract (SOURCE_FILE ("semanticContext.galgas", 432)))).boolEnum () ;
            if (kBoolTrue == test_3) {
              enumGalgasBool test_4 = kBoolTrue ;
              if (kBoolTrue == test_4) {
                test_4 = ioArgument_ioGetterMap.getter_hasKey (enumerator_16877.current_lkey (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 433)).boolEnum () ;
                if (kBoolTrue == test_4) {
                  {
                  ioArgument_ioGetterMap.setter_setMQualifierForKey (GALGAS_methodQualifier::class_func_isVirtualOverridingAbstract (SOURCE_FILE ("semanticContext.galgas", 434)), enumerator_16877.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 434)) ;
                  }
                }
              }
            }
          ...
          if (kBoolFalse == test_3) {
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              test_5 = constinArgument_inIsClass.operator_and (GALGAS_bool (ComparisonKind::equal, enumerator_16877.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("semanticContext.galgas", 436)))) COMMA_SOURCE_FILE ("semanticContext.galgas", 436)).boolEnum () ;
              if (kBoolTrue == test_5) {
                {
                ioArgument_ioGetterMap.setter_insertKey (enumerator_16877.current_lkey (HERE), GALGAS_methodKind::class_func_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 439)), var_formalArgumentList_16949, enumerator_16877.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), var_returnedType_17387, GALGAS_methodQualifier::class_func_isVirtual (SOURCE_FILE ("semanticContext.galgas", 444)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 437)) ;
                }
              }
            }
            if (kBoolFalse == test_5) {
              {
              ioArgument_ioGetterMap.setter_insertKey (enumerator_16877.current_lkey (HERE), GALGAS_methodKind::class_func_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 450)), var_formalArgumentList_16949, enumerator_16877.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), var_returnedType_17387, enumerator_16877.current_mQualifier (HERE), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 448)) ;
              }
            }
          }
        }
  ...
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
    test_6 = constinArgument_inExtensionMethodMapForBuildingContext.getter_hasKey (constinArgument_inTypeName.readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 462)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_extensionMethodMapForType var_extensionMethodMapForType_18602 ;
      constinArgument_inExtensionMethodMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionMethodMapForType_18602, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 463)) ;
      cEnumerator_extensionMethodMapForType enumerator_18664 (var_extensionMethodMapForType_18602, EnumerationOrder::up) ;
      while (enumerator_18664.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_formalArgumentList_18717 = GALGAS_formalParameterSignature::init (inCompiler COMMA_HERE) ;
        cEnumerator_formalParameterListAST enumerator_18790 (enumerator_18664.current_mFormalParameterList (HERE), EnumerationOrder::up) ;
        while (enumerator_18790.hasCurrentObject ()) {
          GALGAS_unifiedTypeMapEntry var_typeIndex_18926 ;
          {
          extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_18790.current (HERE).readProperty_mFormalArgumentTypeName (), var_typeIndex_18926, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 467)) ;
          }
          var_formalArgumentList_18717.addAssign_operation (enumerator_18790.current (HERE).readProperty_mFormalSelector (), var_typeIndex_18926, enumerator_18790.current (HERE).readProperty_mFormalArgumentPassingMode (), enumerator_18790.current (HERE).readProperty_mFormalArgumentName ().readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 471)) ;
          enumerator_18790.gotoNextObject () ;
        }
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
          test_7 = GALGAS_bool (ComparisonKind::equal, enumerator_18664.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualOverriding (SOURCE_FILE ("semanticContext.galgas", 477)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            enumGalgasBool test_8 = kBoolTrue ;
            if (kBoolTrue == test_8) {
              test_8 = ioArgument_ioInstanceMethodMap.getter_hasKey (enumerator_18664.current_lkey (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 478)).boolEnum () ;
              if (kBoolTrue == test_8) {
                {
                ioArgument_ioInstanceMethodMap.setter_setMQualifierForKey (GALGAS_methodQualifier::class_func_isVirtualOverriding (SOURCE_FILE ("semanticContext.galgas", 479)), enumerator_18664.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 479)) ;
                }
              }
            }
          }
        ...
        if (kBoolFalse == test_7) {
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = GALGAS_bool (ComparisonKind::equal, enumerator_18664.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isVirtualOverridingAbstract (SOURCE_FILE ("semanticContext.galgas", 481)))).boolEnum () ;
            if (kBoolTrue == test_9) {
              enumGalgasBool test_10 = kBoolTrue ;
              if (kBoolTrue == test_10) {
                test_10 = ioArgument_ioInstanceMethodMap.getter_hasKey (enumerator_18664.current_lkey (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 482)).boolEnum () ;
                if (kBoolTrue == test_10) {
                  {
                  ioArgument_ioInstanceMethodMap.setter_setMQualifierForKey (GALGAS_methodQualifier::class_func_isVirtualOverridingAbstract (SOURCE_FILE ("semanticContext.galgas", 483)), enumerator_18664.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 483)) ;
                  }
                }
              }
            }
          ...
          if (kBoolFalse == test_9) {
            enumGalgasBool test_11 = kBoolTrue ;
            if (kBoolTrue == test_11) {
              test_11 = constinArgument_inIsClass.operator_and (GALGAS_bool (ComparisonKind::equal, enumerator_18664.current_mQualifier (HERE).objectCompare (GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("semanticContext.galgas", 485)))) COMMA_SOURCE_FILE ("semanticContext.galgas", 485)).boolEnum () ;
              if (kBoolTrue == test_11) {
                {
                ioArgument_ioInstanceMethodMap.setter_insertKey (enumerator_18664.current_lkey (HERE), GALGAS_methodKind::class_func_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 488)), var_formalArgumentList_18717, enumerator_18664.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), GALGAS_methodQualifier::class_func_isVirtual (SOURCE_FILE ("semanticContext.galgas", 492)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 486)) ;
                }
              }
            }
            if (kBoolFalse == test_11) {
              {
              ioArgument_ioInstanceMethodMap.setter_insertKey (enumerator_18664.current_lkey (HERE), GALGAS_methodKind::class_func_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 498)), var_formalArgumentList_18717, enumerator_18664.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), enumerator_18664.current_mQualifier (HERE), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 496)) ;
              }
            }
          }
        }
  ...
  enumGalgasBool test_12 = kBoolTrue ;
  if (kBoolTrue == test_12) {
    test_12 = constinArgument_inExtensionSetterMapForBuildingContext.getter_hasKey (constinArgument_inTypeName.readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 509)).boolEnum () ;
    if (kBoolTrue == test_12) {
      GALGAS_extensionSetterMapForType var_extensionSetterMapForType_20284 ;
      constinArgument_inExtensionSetterMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionSetterMapForType_20284, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 510)) ;
      cEnumerator_extensionSetterMapForType enumerator_20325 (var_extensionSetterMapForType_20284, EnumerationOrder::up) ;
      while (enumerator_20325.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_formalArgumentList_20415 = GALGAS_formalParameterSignature::init (inCompiler COMMA_HERE) ;
        cEnumerator_formalParameterListAST enumerator_20462 (enumerator_20325.current_mFormalParameterList (HERE), EnumerationOrder::up) ;
        while (enumerator_20462.hasCurrentObject ()) {
          GALGAS_unifiedTypeMapEntry var_typeIndex_20558 ;
          {
          extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_20462.current (HERE).readProperty_mFormalArgumentTypeName (), var_typeIndex_20558, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 514)) ;
          }
          var_formalArgumentList_20415.addAssign_operation (enumerator_20462.current (HERE).readProperty_mFormalSelector (), var_typeIndex_20558, enumerator_20462.current (HERE).readProperty_mFormalArgumentPassingMode (), enumerator_20462.current (HERE).readProperty_mFormalArgumentName ().readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 515)) ;
          enumerator_20462.gotoNextObject () ;
        }
        {
        ioArgument_ioSetterMap.setter_insertKey (enumerator_20325.current_lkey (HERE), GALGAS_methodKind::class_func_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 523)), var_formalArgumentList_20415, GALGAS_bool (true), GALGAS_methodQualifier::class_func_isBasic (SOURCE_FILE ("semanticContext.galgas", 526)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 521)) ;
        }
        enumGalgasBool test_13 = kBoolTrue ;
        if (kBoolTrue == test_13) {
          test_13 = constinArgument_inAcceptSetters.operator_not (SOURCE_FILE ("semanticContext.galgas", 529)).boolEnum () ;
          if (kBoolTrue == test_13) {
            TC_Array <FixItDescription> fixItArray14 ;
            inCompiler->emitSemanticError (enumerator_20325.current_lkey (HERE).readProperty_location (), GALGAS_string ("a refclass does not accept any setter; use method instead"), fixItArray14  COMMA_SOURCE_FILE ("semanticContext.galgas", 530)) ;
          }
        }
  ...
  enumGalgasBool test_15 = kBoolTrue ;
  if (kBoolTrue == test_15) {
    test_15 = constinArgument_inExtensionInitializerMapForBuildingContext.getter_hasKey (constinArgument_inTypeName.readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 535)).boolEnum () ;
    if (kBoolTrue == test_15) {
      GALGAS_extensionInitializerMapForType var_initializerMapForType_21310 ;
      constinArgument_inExtensionInitializerMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_initializerMapForType_21310, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 536)) ;
      cEnumerator_extensionInitializerMapForType enumerator_21347 (var_initializerMapForType_21310, EnumerationOrder::up) ;
      while (enumerator_21347.hasCurrentObject ()) {
        GALGAS_functionSignature var_formalArgumentList_21426 = GALGAS_functionSignature::init (inCompiler COMMA_HERE) ;
        cEnumerator_formalInputParameterListAST enumerator_21522 (enumerator_21347.current_mFormalParameterList (HERE), EnumerationOrder::up) ;
        while (enumerator_21522.hasCurrentObject ()) {
          GALGAS_unifiedTypeMapEntry var_typeIndex_21622 ;
          {
          extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_21522.current_mFormalArgumentTypeName (HERE), var_typeIndex_21622, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 540)) ;
          }
          var_formalArgumentList_21426.addAssign_operation (enumerator_21522.current_mFormalSelector (HERE), var_typeIndex_21622, enumerator_21522.current_mFormalArgumentName (HERE).readProperty_string (), enumerator_21522.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticContext.galgas", 541)) ;
          enumerator_21522.gotoNextObject () ;
        }
        {
        ioArgument_ioInitializerMap.setter_insertKey (enumerator_21347.current_lkey (HERE), var_formalArgumentList_21426, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 551)) ;
        }
...
void routine_recursivelyEnumerateDirectories_3F__3F__3F__3F__21__21__26__26_ (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  GALGAS_uint var_currentDirectoryIndex_23772 = ioArgument_ioWrapperDirectoryIndex ;
  ioArgument_ioWrapperDirectoryIndex.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 595)) ;
  GALGAS_stringlist var_files_23899 = constinArgument_inAbsoluteSourcePath.getter_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 597)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::init (inCompiler COMMA_HERE) ;
  cEnumerator_stringlist enumerator_23982 (var_files_23899, EnumerationOrder::up) ;
  while (enumerator_23982.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = constinArgument_inTextFileExtensionMap.getter_hasKey (enumerator_23982.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 600)) COMMA_SOURCE_FILE ("semanticContext.galgas", 600)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_absoluteFilePath_24088 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 601)).add_operation (enumerator_23982.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 601)) ;
        {
        outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::init_21__21_ (enumerator_23982.current_mValue (HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 603)), inCompiler COMMA_HERE), var_absoluteFilePath_24088, GALGAS_bool (true), var_currentDirectoryIndex_23772, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 602)) ;
        }
        ioArgument_ioWrapperFileIndex.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 609)) ;
      }
    }
    if (kBoolFalse == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = constinArgument_inBinaryFileExtensionMap.getter_hasKey (enumerator_23982.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 610)) COMMA_SOURCE_FILE ("semanticContext.galgas", 610)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_string var_absoluteFilePath_24464 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 611)).add_operation (enumerator_23982.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 611)) ;
          {
          outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::init_21__21_ (enumerator_23982.current_mValue (HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 613)), inCompiler COMMA_HERE), var_absoluteFilePath_24464, GALGAS_bool (false), var_currentDirectoryIndex_23772, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 612)) ;
          }
          ioArgument_ioWrapperFileIndex.plusAssign_operation(GALGAS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 619)) ;
        }
      }
    }
    enumerator_23982.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories_24820 = constinArgument_inAbsoluteSourcePath.getter_directories (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 623)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::init (inCompiler COMMA_HERE) ;
  cEnumerator_stringlist enumerator_24913 (var_directories_24820, EnumerationOrder::up) ;
  while (enumerator_24913.hasCurrentObject ()) {
    GALGAS_uint var_theDirectoryIndex_24953 = ioArgument_ioWrapperDirectoryIndex ;
    GALGAS_wrapperFileMap var_internalWrapperFileMap_25189 ;
    GALGAS_wrapperDirectoryMap var_internalWrapperDirectoryMap_25223 ;
    {
    routine_recursivelyEnumerateDirectories_3F__3F__3F__3F__21__21__26__26_ (constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 628)).add_operation (enumerator_24913.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 628)), constinArgument_inPathInWrapper.add_operation (enumerator_24913.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 629)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 629)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap_25189, var_internalWrapperDirectoryMap_25223, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 627)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.setter_insertKey (GALGAS_lstring::init_21__21_ (enumerator_24913.current_mValue (HERE), GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 638)), inCompiler COMMA_HERE), var_internalWrapperFileMap_25189, var_internalWrapperDirectoryMap_25223, var_theDirectoryIndex_24953, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 637)) ;
    }
...
void cPtr_filewrapperDeclarationAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionInitializerForBuildingContext /* constinArgument_inExtensionInitializerMapForBuildingContext */,
                                                                               ...
                                                                               Compiler * inCompiler
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap_26197 = GALGAS_filewrapperTemplateMap::init (inCompiler COMMA_HERE) ;
  const GALGAS_filewrapperDeclarationAST temp_0 = this ;
  cEnumerator_filewrapperTemplateListAST enumerator_26282 (temp_0.readProperty_mFilewrapperTemplateList (), EnumerationOrder::up) ;
  while (enumerator_26282.hasCurrentObject ()) {
    GALGAS_functionSignature var_templateSignature_26388 = GALGAS_functionSignature::init (inCompiler COMMA_HERE) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_26488 (enumerator_26282.current_mFilewrapperTemplateFormalInputParameters (HERE), EnumerationOrder::up) ;
    while (enumerator_26488.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapEntry var_parameterTypeIndex_26608 ;
      {
      extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_26488.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_26608, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 661)) ;
      }
      var_templateSignature_26388.addAssign_operation (enumerator_26488.current_mFormalTemplateSelector (HERE), var_parameterTypeIndex_26608, enumerator_26488.current_mFormalArgumentName (HERE).readProperty_string (), enumerator_26488.current_mIsUnused (HERE)  COMMA_SOURCE_FILE ("semanticContext.galgas", 662)) ;
      enumerator_26488.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap_26197.setter_insertKey (enumerator_26282.current_mFilewrapperTemplateName (HERE), var_templateSignature_26388, enumerator_26282.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 664)) ;
    }
    enumerator_26282.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap_26951 = GALGAS_wrapperExtensionMap::init (inCompiler COMMA_HERE) ;
  const GALGAS_filewrapperDeclarationAST temp_1 = this ;
  cEnumerator_lstringlist enumerator_26980 (temp_1.readProperty_mFilewrapperTextFileExtensionList (), EnumerationOrder::up) ;
  while (enumerator_26980.hasCurrentObject ()) {
    {
    var_textExtensionMap_26951.setter_insertKey (enumerator_26980.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 673)) ;
    }
    enumerator_26980.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap_27146 = GALGAS_wrapperExtensionMap::init (inCompiler COMMA_HERE) ;
  const GALGAS_filewrapperDeclarationAST temp_2 = this ;
  cEnumerator_lstringlist enumerator_27181 (temp_2.readProperty_mFilewrapperBinaryFileExtensionList (), EnumerationOrder::up) ;
  while (enumerator_27181.hasCurrentObject ()) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = var_textExtensionMap_26951.getter_hasKey (enumerator_27181.current_mValue (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 678)).boolEnum () ;
      if (kBoolTrue == test_3) {
        TC_Array <FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (enumerator_27181.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_27181.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 679)).add_operation (GALGAS_string ("' extension is already used for text files"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 679)), fixItArray4  COMMA_SOURCE_FILE ("semanticContext.galgas", 679)) ;
      }
    }
    if (kBoolFalse == test_3) {
      {
      var_binaryFileExtensionMap_27146.setter_insertKey (enumerator_27181.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 681)) ;
      }
    }
    enumerator_27181.gotoNextObject () ;
  }
  GALGAS_wrapperFileMap var_regularRootFileMap_27499 ;
  GALGAS_wrapperDirectoryMap var_wrapperDirectoryMap_27545 ;
  GALGAS_string var_absoluteSourcePath_27579 ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    const GALGAS_filewrapperDeclarationAST temp_6 = this ;
    test_5 = GALGAS_bool (ComparisonKind::equal, temp_6.readProperty_mFilewrapperPath ().readProperty_string ().getter_firstCharacterOrNul (SOURCE_FILE ("semanticContext.galgas", 688)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_5) {
      const GALGAS_filewrapperDeclarationAST temp_7 = this ;
      var_absoluteSourcePath_27579 = temp_7.readProperty_mFilewrapperPath ().readProperty_string () ;
    }
  }
  if (kBoolFalse == test_5) {
    const GALGAS_filewrapperDeclarationAST temp_8 = this ;
    const GALGAS_filewrapperDeclarationAST temp_9 = this ;
    var_absoluteSourcePath_27579 = temp_8.readProperty_mSourceFileAbsolutePath ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("semanticContext.galgas", 691)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 691)).add_operation (temp_9.readProperty_mFilewrapperPath ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 691)) ;
  }
  enumGalgasBool test_10 = kBoolTrue ;
  if (kBoolTrue == test_10) {
    test_10 = var_absoluteSourcePath_27579.getter_directoryExists (SOURCE_FILE ("semanticContext.galgas", 693)).operator_not (SOURCE_FILE ("semanticContext.galgas", 693)).boolEnum () ;
    if (kBoolTrue == test_10) {
      const GALGAS_filewrapperDeclarationAST temp_11 = this ;
      TC_Array <FixItDescription> fixItArray12 ;
      inCompiler->emitSemanticError (temp_11.readProperty_mFilewrapperPath ().readProperty_location (), GALGAS_string ("The '").add_operation (var_absoluteSourcePath_27579, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 694)).add_operation (GALGAS_string ("' directory does not exist"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 694)), fixItArray12  COMMA_SOURCE_FILE ("semanticContext.galgas", 694)) ;
      var_regularRootFileMap_27499.drop () ; // Release error dropped variable
      var_wrapperDirectoryMap_27545.drop () ; // Release error dropped variable
    }
  }
  if (kBoolFalse == test_10) {
    GALGAS_uint var_wrapperFileIndex_28095 = GALGAS_uint (uint32_t (0U)) ;
    GALGAS_uint var_wrapperDirectoryIndex_28130 = GALGAS_uint (uint32_t (0U)) ;
    {
    routine_recursivelyEnumerateDirectories_3F__3F__3F__3F__21__21__26__26_ (var_absoluteSourcePath_27579, GALGAS_string ("/"), var_textExtensionMap_26951, var_binaryFileExtensionMap_27146, var_regularRootFileMap_27499, var_wrapperDirectoryMap_27545, var_wrapperFileIndex_28095, var_wrapperDirectoryIndex_28130, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 700)) ;
    }
  }
  {
...
void cPtr_externFunctionDeclarationAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionInitializerForBuildingContext /* constinArgument_inExtensionInitializerMapForBuildingContext */,
                                                                                  ...
                                                                                  Compiler * inCompiler
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_functionSignature var_functionSignature_29388 = GALGAS_functionSignature::init (inCompiler COMMA_HERE) ;
  const GALGAS_externFunctionDeclarationAST temp_0 = this ;
  cEnumerator_formalInputParameterListAST enumerator_29481 (temp_0.readProperty_mFormalArgumentList (), EnumerationOrder::up) ;
  while (enumerator_29481.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapEntry var_parameterTypeIndex_29582 ;
    {
    extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_29481.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_29582, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 735)) ;
    }
    var_functionSignature_29388.addAssign_operation (enumerator_29481.current_mFormalSelector (HERE), var_parameterTypeIndex_29582, enumerator_29481.current_mFormalArgumentTypeName (HERE).readProperty_string (), enumerator_29481.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticContext.galgas", 736)) ;
    enumerator_29481.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapEntry var_resultTypeIndex_29784 ;
  {
  const GALGAS_externFunctionDeclarationAST temp_1 = this ;
  extensionSetter_makeEntry (ioArgument_ioTypeMap, temp_1.readProperty_mResultTypeName (), var_resultTypeIndex_29784, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 739)) ;
  }
  {
  const GALGAS_externFunctionDeclarationAST temp_2 = this ;
  ioArgument_ioSemanticContext.mProperty_mFunctionMap.setter_insertKey (temp_2.readProperty_mFunctionName (), var_functionSignature_29388, var_resultTypeIndex_29784, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 741)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_onceFunctionDeclarationAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionInitializerForBuildingContext /* constinArgument_inExtensionInitializerMapForBuildingContext */,
                                                                                ...
                                                                                Compiler * inCompiler
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapEntry var_resultTypeIndex_30727 ;
  {
  const GALGAS_onceFunctionDeclarationAST temp_0 = this ;
  extensionSetter_makeEntry (ioArgument_ioTypeMap, temp_0.readProperty_mResultTypeName (), var_resultTypeIndex_30727, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 759)) ;
  }
  {
  const GALGAS_onceFunctionDeclarationAST temp_1 = this ;
  const GALGAS_onceFunctionDeclarationAST temp_2 = this ;
  ioArgument_ioSemanticContext.mProperty_mFunctionMap.setter_insertKey (temp_1.readProperty_mFunctionName (), GALGAS_functionSignature::init (inCompiler COMMA_HERE), var_resultTypeIndex_30727, temp_2.readProperty_mIsInternal (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 761)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_galgas_33_GrammarComponentAST::method_enterDeclarationInSemanticContext (const GALGAS_extensionInitializerForBuildingContext /* constinArgument_inExtensionInitializerMapForBuildingContext */,
                                                                                   ...
                                                                                   Compiler * inCompiler
                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_grammarLabelMap var_grammarLabelMap_32472 = GALGAS_grammarLabelMap::init (inCompiler COMMA_HERE) ;
  const GALGAS_galgas_33_GrammarComponentAST temp_0 = this ;
  cEnumerator_nonTerminalLabelListAST enumerator_32531 (temp_0.readProperty_mStartSymbolLabelList (), EnumerationOrder::up) ;
  while (enumerator_32531.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_formalArgumentList_32626 = GALGAS_formalParameterSignature::init (inCompiler COMMA_HERE) ;
    cEnumerator_formalParameterListAST enumerator_32746 (enumerator_32531.current_mFormalArgumentList (HERE), EnumerationOrder::up) ;
    while (enumerator_32746.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapEntry var_argumentType_32835 ;
      {
      extensionSetter_makeEntry (ioArgument_ioTypeMap, enumerator_32746.current_mFormalArgumentTypeName (HERE), var_argumentType_32835, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 799)) ;
      }
      var_formalArgumentList_32626.addAssign_operation (enumerator_32746.current_mFormalSelector (HERE), var_argumentType_32835, enumerator_32746.current_mFormalArgumentPassingMode (HERE), enumerator_32746.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 800)) ;
      enumerator_32746.gotoNextObject () ;
    }
    {
    var_grammarLabelMap_32472.setter_insertKey (enumerator_32531.current_mLabelName (HERE), var_formalArgumentList_32626, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 806)) ;
    }
    enumerator_32531.gotoNextObject () ;
  }
  {
  ...
  ioArgument_ioSemanticContext.mProperty_grammarMap.setter_insertGrammar (temp_1.readProperty_mGrammarComponentName (), var_grammarLabelMap_32472, temp_2.readProperty_mHasIndexing ().readProperty_bool (), temp_3.readProperty_mHasTranslateFeature (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 812)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_galgas_33_GrammarComponentAST::method_enterDeclarationInGraph (GALGAS_semanticTypePrecedenceGraph & ioArgument_ioSemanticTypePrecedenceGraph,
  ...
  const GALGAS_galgas_33_GrammarComponentAST temp_0 = this ;
  const GALGAS_galgas_33_GrammarComponentAST temp_1 = this ;
  GALGAS_lstring var_key_35122 = GALGAS_lstring::init_21__21_ (GALGAS_string ("grammar ").add_operation (temp_0.readProperty_mGrammarComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 853)), temp_1.readProperty_mGrammarComponentName ().readProperty_location (), inCompiler COMMA_HERE) ;
  {
  const GALGAS_galgas_33_GrammarComponentAST temp_2 = this ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_35122, temp_2, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 854)) ;
  }
  const GALGAS_galgas_33_GrammarComponentAST temp_3 = this ;
  cEnumerator_lstringlist enumerator_35279 (temp_3.readProperty_mSyntaxComponents (), EnumerationOrder::up) ;
  while (enumerator_35279.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_35122, GALGAS_lstring::init_21__21_ (GALGAS_string ("syntax ").add_operation (enumerator_35279.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 856)), enumerator_35279.current_mValue (HERE).readProperty_location (), inCompiler COMMA_HERE) COMMA_SOURCE_FILE ("semanticContext.galgas", 856)) ;
    }
    enumerator_35279.gotoNextObject () ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_galgas_33_SyntaxComponentAST::method_enterDeclarationInGraph (GALGAS_semanticTypePrecedenceGraph & ioArgument_ioSemanticTypePrecedenceGraph,
  ...
  const GALGAS_galgas_33_SyntaxComponentAST temp_0 = this ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_1 = this ;
  GALGAS_lstring var_key_36077 = GALGAS_lstring::init_21__21_ (GALGAS_string ("syntax ").add_operation (temp_0.readProperty_mSyntaxComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 869)), temp_1.readProperty_mSyntaxComponentName ().readProperty_location (), inCompiler COMMA_HERE) ;
  {
  const GALGAS_galgas_33_SyntaxComponentAST temp_2 = this ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_36077, temp_2, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 870)) ;
  }
  {
  const GALGAS_galgas_33_SyntaxComponentAST temp_3 = this ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_4 = this ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_36077, GALGAS_lstring::init_21__21_ (GALGAS_string ("lexique ").add_operation (temp_3.readProperty_mLexiqueName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 871)), temp_4.readProperty_mLexiqueName ().readProperty_location (), inCompiler COMMA_HERE) COMMA_SOURCE_FILE ("semanticContext.galgas", 871)) ;
  }
  const GALGAS_galgas_33_SyntaxComponentAST temp_5 = this ;
  cEnumerator_syntaxRuleListAST enumerator_36354 (temp_5.readProperty_mRuleList (), EnumerationOrder::up) ;
  while (enumerator_36354.hasCurrentObject ()) {
    cEnumerator_syntaxRuleLabelListAST enumerator_36419 (enumerator_36354.current_mLabelList (HERE), EnumerationOrder::up) ;
    while (enumerator_36419.hasCurrentObject ()) {
      cEnumerator_formalParameterListAST enumerator_36505 (enumerator_36419.current_mFormalArguments (HERE), EnumerationOrder::up) ;
      while (enumerator_36505.hasCurrentObject ()) {
        switch (enumerator_36505.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
        case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
          break ;
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentVarIn:
          {
            {
            ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_36077, GALGAS_lstring::init_21__21_ (GALGAS_string ("@").add_operation (enumerator_36505.current_mFormalArgumentTypeName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 876)), enumerator_36505.current_mFormalArgumentTypeName (HERE).readProperty_location (), inCompiler COMMA_HERE) COMMA_SOURCE_FILE ("semanticContext.galgas", 876)) ;
            }
          }
          break ;
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut:
        ...
        enumerator_36505.gotoNextObject () ;
      }
      enumerator_36419.gotoNextObject () ;
    }
...
void cPtr_externFunctionDeclarationAST::method_enterDeclarationInGraph (GALGAS_semanticTypePrecedenceGraph & /* ioArgument_ioSemanticTypePrecedenceGraph */,
                                                                        ...
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_externFunctionDeclarationAST temp_0 = this ;
  ioArgument_ioExtensionOverrideDefinitionList.addAssign_operation (temp_0  COMMA_SOURCE_FILE ("semanticContext.galgas", 893)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_onceFunctionDeclarationAST::method_enterDeclarationInGraph (GALGAS_semanticTypePrecedenceGraph & /* ioArgument_ioSemanticTypePrecedenceGraph */,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_onceFunctionDeclarationAST temp_0 = this ;
  ioArgument_ioExtensionOverrideDefinitionList.addAssign_operation (temp_0  COMMA_SOURCE_FILE ("semanticContext.galgas", 905)) ;
}
//--------------------------------------------------------------------------------------------------
//
