...
GALGAS_typeFeatures cPtr_typePredefinedTypeAST::getter_getSupportedOperatorFlags (Compiler */* inCompiler */
                                                                                  COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_typeFeatures result_result ; // Returned variable
  result_result = GALGAS_typeFeatures::class_func_generateDescriptionGetterUtilityMethod (SOURCE_FILE ("predefinedType-type.galgas", 75)).operator_or (GALGAS_typeFeatures::class_func_isEquatable (SOURCE_FILE ("predefinedType-type.galgas", 75)) COMMA_SOURCE_FILE ("predefinedType-type.galgas", 75)) ;
//---
  return result_result ;
}
