...
void cPtr_minusEqualExpressionInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  GALGAS_unifiedTypeMapEntry var_targetType_17547 ;
  GALGAS_string var_targetVariableCppName_17572 ;
  GALGAS_string var_nameForCheckingFormalParameterUsing_17608 ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_2) {
        GALGAS_unifiedTypeMapEntry var_selfType_17735 ;
        GALGAS_bool var_selfIsMutable_17758 ;
        GALGAS_bool var_mutableProperties_17796 ;
        const bool optionalResult17714 = constinArgument_inAnalysisContext.readProperty_selfType ().optional_available (var_selfType_17735, var_selfIsMutable_17758, var_mutableProperties_17796) ;
        if (!optionalResult17714) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_selfIsMutable_17758.operator_not (SOURCE_FILE ("instruction-concat.galgas", 446)).boolEnum () ;
            if (kBoolTrue == test_3) {
              const GALGAS_minusEqualExpressionInstructionAST temp_4 = this ;
              TC_Array <C_FixItDescription> fixItArray5 ;
              inCompiler->emitSemanticError (temp_4.readProperty_mInstructionLocation (), GALGAS_string ("'self' not mutable in this context"), fixItArray5  COMMA_SOURCE_FILE ("instruction-concat.galgas", 447)) ;
            }
          }
          GALGAS_propertyMap var_propertyMap_17951 = extensionGetter_definition (var_selfType_17735, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 449)).readProperty_mPropertyMap () ;
          GALGAS_bool var_isConstant_18057 ;
          const GALGAS_minusEqualExpressionInstructionAST temp_6 = this ;
          GALGAS_AccessControl joker_18049 ; // Joker input parameter
          var_propertyMap_17951.method_searchKey (temp_6.readProperty_mReceiverName (), joker_18049, var_isConstant_18057, var_targetType_17547, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 450)) ;
          var_nameForCheckingFormalParameterUsing_17608 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName () ;
          const GALGAS_minusEqualExpressionInstructionAST temp_7 = this ;
          var_targetVariableCppName_17572 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 452)).add_operation (temp_7.readProperty_mReceiverName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-concat.galgas", 453)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 453)) ;
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = var_isConstant_18057.boolEnum () ;
            if (kBoolTrue == test_8) {
              const GALGAS_minusEqualExpressionInstructionAST temp_9 = this ;
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (temp_9.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray10  COMMA_SOURCE_FILE ("instruction-concat.galgas", 455)) ;
            }
          }
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = var_mutableProperties_17796.operator_not (SOURCE_FILE ("instruction-concat.galgas", 457)).boolEnum () ;
            if (kBoolTrue == test_11) {
              const GALGAS_minusEqualExpressionInstructionAST temp_12 = this ;
              TC_Array <C_FixItDescription> fixItArray13 ;
              inCompiler->emitSemanticError (temp_12.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("the property is not mutable in this context"), fixItArray13  COMMA_SOURCE_FILE ("instruction-concat.galgas", 458)) ;
            }
          }
        }
      }
      if (kBoolFalse == test_2) {
        ...
        inCompiler->emitSemanticError (temp_14.readProperty_mInstructionLocation (), GALGAS_string ("'self' not available in this context"), fixItArray15  COMMA_SOURCE_FILE ("instruction-concat.galgas", 461)) ;
        var_targetType_17547.drop () ; // Release error dropped variable
        var_targetVariableCppName_17572.drop () ; // Release error dropped variable
        var_nameForCheckingFormalParameterUsing_17608.drop () ; // Release error dropped variable
      }
    }
  }
  if (kBoolFalse == test_0) {
    ...
    extensionSetter_searchForReadWriteAccess (ioArgument_ioVariableMap, temp_16.readProperty_mReceiverName (), var_targetType_17547, var_targetVariableCppName_17572, var_nameForCheckingFormalParameterUsing_17608, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 465)) ;
    }
  }
  const GALGAS_minusEqualExpressionInstructionAST temp_17 = this ;
  cEnumerator_lstringlist enumerator_18929 (temp_17.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_18929.hasCurrentObject ()) {
    GALGAS_propertyMap var_propertyMap_18976 = extensionGetter_definition (var_targetType_17547, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 473)).readProperty_mPropertyMap () ;
    GALGAS_AccessControl var_accessControl_19066 ;
    GALGAS_bool var_isConstant_19085 ;
    var_propertyMap_18976.method_searchKey (enumerator_18929.current_mValue (HERE), var_accessControl_19066, var_isConstant_19085, var_targetType_17547, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 474)) ;
    extensionMethod_checkSetAccess (var_accessControl_19066, constinArgument_inAnalysisContext.readProperty_selfType (), enumerator_18929.current_mValue (HERE).readProperty_location (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 475)) ;
    enumGalgasBool test_18 = kBoolTrue ;
    if (kBoolTrue == test_18) {
      test_18 = var_isConstant_19085.boolEnum () ;
      if (kBoolTrue == test_18) {
        TC_Array <C_FixItDescription> fixItArray19 ;
        inCompiler->emitSemanticError (enumerator_18929.current_mValue (HERE).readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray19  COMMA_SOURCE_FILE ("instruction-concat.galgas", 480)) ;
      }
    }
    enumerator_18929.gotoNextObject () ;
  }
  enumGalgasBool test_20 = kBoolTrue ;
  if (kBoolTrue == test_20) {
    test_20 = extensionGetter_definition (var_targetType_17547, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 484)).readProperty_mHandledOperatorFlags ().getter_minusEqualOperatorWithExpression (SOURCE_FILE ("instruction-concat.galgas", 484)).operator_not (SOURCE_FILE ("instruction-concat.galgas", 484)).boolEnum () ;
    if (kBoolTrue == test_20) {
      const GALGAS_minusEqualExpressionInstructionAST temp_21 = this ;
      TC_Array <C_FixItDescription> fixItArray22 ;
      inCompiler->emitSemanticError (temp_21.readProperty_mInstructionLocation (), GALGAS_string ("the target object has the '@").add_operation (extensionGetter_definition (var_targetType_17547, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 486)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 486)).add_operation (GALGAS_string ("' type, but this type does not support the '-=' operator"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 486)), fixItArray22  COMMA_SOURCE_FILE ("instruction-concat.galgas", 485)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_expression_20004 ;
  const GALGAS_minusEqualExpressionInstructionAST temp_23 = this ;
  callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) temp_23.readProperty_mExpression ().ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, var_targetType_17547, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_expression_20004, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 489)) ;
  {
  const GALGAS_minusEqualExpressionInstructionAST temp_24 = this ;
  routine_checkAssignmentTypeWithImplicitGetterCall_3F__3F__3F__26_ (var_targetType_17547, var_expression_20004.readProperty_mResultType (), temp_24.readProperty_mInstructionLocation (), var_expression_20004, inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 499)) ;
  }
  const GALGAS_minusEqualExpressionInstructionAST temp_25 = this ;
  const GALGAS_minusEqualExpressionInstructionAST temp_26 = this ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_opEqualInstructionForGeneration::class_func_new (temp_25.readProperty_mInstructionLocation (), var_targetType_17547, var_targetVariableCppName_17572, var_nameForCheckingFormalParameterUsing_17608, temp_26.readProperty_mStructAttributeList (), var_expression_20004, GALGAS_string ("minusAssign_operation")  COMMA_SOURCE_FILE ("instruction-concat.galgas", 501))  COMMA_SOURCE_FILE ("instruction-concat.galgas", 501)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_mulEqualExpressionInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
                                                                               ...
                                                                               Compiler * inCompiler
                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapEntry var_targetType_21062 ;
  GALGAS_string var_targetVariableCppName_21087 ;
  GALGAS_string var_nameForCheckingFormalParameterUsing_21123 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        GALGAS_unifiedTypeMapEntry var_selfType_21250 ;
        GALGAS_bool var_selfIsMutable_21273 ;
        GALGAS_bool var_mutableProperties_21311 ;
        const bool optionalResult21229 = constinArgument_inAnalysisContext.readProperty_selfType ().optional_available (var_selfType_21250, var_selfIsMutable_21273, var_mutableProperties_21311) ;
        if (!optionalResult21229) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_selfIsMutable_21273.operator_not (SOURCE_FILE ("instruction-concat.galgas", 528)).boolEnum () ;
            if (kBoolTrue == test_3) {
              const GALGAS_mulEqualExpressionInstructionAST temp_4 = this ;
              TC_Array <C_FixItDescription> fixItArray5 ;
              inCompiler->emitSemanticError (temp_4.readProperty_mInstructionLocation (), GALGAS_string ("'self' not mutable in this context"), fixItArray5  COMMA_SOURCE_FILE ("instruction-concat.galgas", 529)) ;
            }
          }
          GALGAS_propertyMap var_propertyMap_21466 = extensionGetter_definition (var_selfType_21250, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 531)).readProperty_mPropertyMap () ;
          ...
          var_propertyMap_21466.method_searchKey (temp_6.readProperty_mReceiverName (), joker_21564, var_isConstant_21572, var_targetType_21062, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 532)) ;
          var_nameForCheckingFormalParameterUsing_21123 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName () ;
          const GALGAS_mulEqualExpressionInstructionAST temp_7 = this ;
          var_targetVariableCppName_21087 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 534)).add_operation (temp_7.readProperty_mReceiverName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-concat.galgas", 535)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 535)) ;
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = var_isConstant_21572.boolEnum () ;
            if (kBoolTrue == test_8) {
              const GALGAS_mulEqualExpressionInstructionAST temp_9 = this ;
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (temp_9.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray10  COMMA_SOURCE_FILE ("instruction-concat.galgas", 537)) ;
            }
          }
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = var_mutableProperties_21311.operator_not (SOURCE_FILE ("instruction-concat.galgas", 539)).boolEnum () ;
            if (kBoolTrue == test_11) {
              const GALGAS_mulEqualExpressionInstructionAST temp_12 = this ;
              TC_Array <C_FixItDescription> fixItArray13 ;
              inCompiler->emitSemanticError (temp_12.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("the property is not mutable in this context"), fixItArray13  COMMA_SOURCE_FILE ("instruction-concat.galgas", 540)) ;
            }
          }
        }
      }
      if (kBoolFalse == test_2) {
        ...
        TC_Array <C_FixItDescription> fixItArray15 ;
        inCompiler->emitSemanticError (temp_14.readProperty_mInstructionLocation (), GALGAS_string ("'self' not available in this context"), fixItArray15  COMMA_SOURCE_FILE ("instruction-concat.galgas", 543)) ;
        var_targetType_21062.drop () ; // Release error dropped variable
        var_targetVariableCppName_21087.drop () ; // Release error dropped variable
        var_nameForCheckingFormalParameterUsing_21123.drop () ; // Release error dropped variable
      }
    }
  }
  if (kBoolFalse == test_0) {
    ...
    extensionSetter_searchForReadWriteAccess (ioArgument_ioVariableMap, temp_16.readProperty_mReceiverName (), var_targetType_21062, var_targetVariableCppName_21087, var_nameForCheckingFormalParameterUsing_21123, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 547)) ;
    }
  }
  const GALGAS_mulEqualExpressionInstructionAST temp_17 = this ;
  cEnumerator_lstringlist enumerator_22471 (temp_17.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_22471.hasCurrentObject ()) {
    GALGAS_propertyMap var_propertyMap_22518 = extensionGetter_definition (var_targetType_21062, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 556)).readProperty_mPropertyMap () ;
    GALGAS_AccessControl var_accessControl_22608 ;
    GALGAS_bool var_isConstant_22627 ;
    var_propertyMap_22518.method_searchKey (enumerator_22471.current_mValue (HERE), var_accessControl_22608, var_isConstant_22627, var_targetType_21062, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 557)) ;
    extensionMethod_checkSetAccess (var_accessControl_22608, constinArgument_inAnalysisContext.readProperty_selfType (), enumerator_22471.current_mValue (HERE).readProperty_location (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 558)) ;
    enumGalgasBool test_18 = kBoolTrue ;
    if (kBoolTrue == test_18) {
      test_18 = var_isConstant_22627.boolEnum () ;
      if (kBoolTrue == test_18) {
        TC_Array <C_FixItDescription> fixItArray19 ;
        inCompiler->emitSemanticError (enumerator_22471.current_mValue (HERE).readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray19  COMMA_SOURCE_FILE ("instruction-concat.galgas", 563)) ;
      }
    }
  ...
  enumGalgasBool test_20 = kBoolTrue ;
  if (kBoolTrue == test_20) {
    test_20 = extensionGetter_definition (var_targetType_21062, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 567)).readProperty_mHandledOperatorFlags ().getter_mulEqualOperatorWithExpression (SOURCE_FILE ("instruction-concat.galgas", 567)).boolEnum () ;
    if (kBoolTrue == test_20) {
      const GALGAS_mulEqualExpressionInstructionAST temp_21 = this ;
      TC_Array <C_FixItDescription> fixItArray22 ;
      inCompiler->emitSemanticError (temp_21.readProperty_mInstructionLocation (), GALGAS_string ("the target object has the '@").add_operation (extensionGetter_definition (var_targetType_21062, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 569)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 569)).add_operation (GALGAS_string ("' type, but this type does not support the '*=' operator"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 569)), fixItArray22  COMMA_SOURCE_FILE ("instruction-concat.galgas", 568)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_expression_23540 ;
  const GALGAS_mulEqualExpressionInstructionAST temp_23 = this ;
  callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) temp_23.readProperty_mExpression ().ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, var_targetType_21062, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_expression_23540, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 572)) ;
  {
  const GALGAS_mulEqualExpressionInstructionAST temp_24 = this ;
  routine_checkAssignmentTypeWithImplicitGetterCall_3F__3F__3F__26_ (var_targetType_21062, var_expression_23540.readProperty_mResultType (), temp_24.readProperty_mInstructionLocation (), var_expression_23540, inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 582)) ;
  }
  const GALGAS_mulEqualExpressionInstructionAST temp_25 = this ;
  const GALGAS_mulEqualExpressionInstructionAST temp_26 = this ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_opEqualInstructionForGeneration::class_func_new (temp_25.readProperty_mInstructionLocation (), var_targetType_21062, var_targetVariableCppName_21087, var_nameForCheckingFormalParameterUsing_21123, temp_26.readProperty_mStructAttributeList (), var_expression_23540, GALGAS_string ("mulAssign_operation")  COMMA_SOURCE_FILE ("instruction-concat.galgas", 584))  COMMA_SOURCE_FILE ("instruction-concat.galgas", 584)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_divEqualExpressionInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  GALGAS_string var_targetVariableCppName_24621 ;
  GALGAS_string var_nameForCheckingFormalParameterUsing_24657 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        GALGAS_unifiedTypeMapEntry var_selfType_24784 ;
        GALGAS_bool var_selfIsMutable_24807 ;
        GALGAS_bool var_mutableProperties_24845 ;
        const bool optionalResult24763 = constinArgument_inAnalysisContext.readProperty_selfType ().optional_available (var_selfType_24784, var_selfIsMutable_24807, var_mutableProperties_24845) ;
        if (!optionalResult24763) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_selfIsMutable_24807.operator_not (SOURCE_FILE ("instruction-concat.galgas", 611)).boolEnum () ;
            if (kBoolTrue == test_3) {
              const GALGAS_divEqualExpressionInstructionAST temp_4 = this ;
              TC_Array <C_FixItDescription> fixItArray5 ;
              inCompiler->emitSemanticError (temp_4.readProperty_mInstructionLocation (), GALGAS_string ("'self' not mutable in this context"), fixItArray5  COMMA_SOURCE_FILE ("instruction-concat.galgas", 612)) ;
            }
          }
          GALGAS_propertyMap var_propertyMap_25000 = extensionGetter_definition (var_selfType_24784, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 614)).readProperty_mPropertyMap () ;
          GALGAS_bool var_isConstant_25106 ;
          const GALGAS_divEqualExpressionInstructionAST temp_6 = this ;
          GALGAS_AccessControl joker_25098 ; // Joker input parameter
          var_propertyMap_25000.method_searchKey (temp_6.readProperty_mReceiverName (), joker_25098, var_isConstant_25106, var_targetType_24596, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 615)) ;
          var_nameForCheckingFormalParameterUsing_24657 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName () ;
          const GALGAS_divEqualExpressionInstructionAST temp_7 = this ;
          var_targetVariableCppName_24621 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 617)).add_operation (temp_7.readProperty_mReceiverName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-concat.galgas", 618)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 618)) ;
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = var_isConstant_25106.boolEnum () ;
            if (kBoolTrue == test_8) {
              const GALGAS_divEqualExpressionInstructionAST temp_9 = this ;
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (temp_9.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray10  COMMA_SOURCE_FILE ("instruction-concat.galgas", 620)) ;
            }
          }
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = var_mutableProperties_24845.operator_not (SOURCE_FILE ("instruction-concat.galgas", 622)).boolEnum () ;
            if (kBoolTrue == test_11) {
              const GALGAS_divEqualExpressionInstructionAST temp_12 = this ;
              TC_Array <C_FixItDescription> fixItArray13 ;
              inCompiler->emitSemanticError (temp_12.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("the property is not mutable in this context"), fixItArray13  COMMA_SOURCE_FILE ("instruction-concat.galgas", 623)) ;
            }
          }
        }
      }
      if (kBoolFalse == test_2) {
        ...
        TC_Array <C_FixItDescription> fixItArray15 ;
        inCompiler->emitSemanticError (temp_14.readProperty_mInstructionLocation (), GALGAS_string ("'self' not available in this context"), fixItArray15  COMMA_SOURCE_FILE ("instruction-concat.galgas", 626)) ;
        var_targetType_24596.drop () ; // Release error dropped variable
        var_targetVariableCppName_24621.drop () ; // Release error dropped variable
        var_nameForCheckingFormalParameterUsing_24657.drop () ; // Release error dropped variable
      }
    }
  }
  if (kBoolFalse == test_0) {
    ...
    extensionSetter_searchForReadWriteAccess (ioArgument_ioVariableMap, temp_16.readProperty_mReceiverName (), var_targetType_24596, var_targetVariableCppName_24621, var_nameForCheckingFormalParameterUsing_24657, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 630)) ;
    }
  }
  const GALGAS_divEqualExpressionInstructionAST temp_17 = this ;
  cEnumerator_lstringlist enumerator_26005 (temp_17.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_26005.hasCurrentObject ()) {
    GALGAS_propertyMap var_propertyMap_26052 = extensionGetter_definition (var_targetType_24596, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 639)).readProperty_mPropertyMap () ;
    GALGAS_AccessControl var_accessControl_26142 ;
    GALGAS_bool var_isConstant_26161 ;
    var_propertyMap_26052.method_searchKey (enumerator_26005.current_mValue (HERE), var_accessControl_26142, var_isConstant_26161, var_targetType_24596, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 640)) ;
    extensionMethod_checkSetAccess (var_accessControl_26142, constinArgument_inAnalysisContext.readProperty_selfType (), enumerator_26005.current_mValue (HERE).readProperty_location (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 641)) ;
    enumGalgasBool test_18 = kBoolTrue ;
    if (kBoolTrue == test_18) {
      test_18 = var_isConstant_26161.boolEnum () ;
      if (kBoolTrue == test_18) {
        const GALGAS_divEqualExpressionInstructionAST temp_19 = this ;
        TC_Array <C_FixItDescription> fixItArray20 ;
        inCompiler->emitSemanticError (temp_19.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray20  COMMA_SOURCE_FILE ("instruction-concat.galgas", 646)) ;
      }
    }
    enumerator_26005.gotoNextObject () ;
  }
  enumGalgasBool test_21 = kBoolTrue ;
  if (kBoolTrue == test_21) {
    test_21 = extensionGetter_definition (var_targetType_24596, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 650)).readProperty_mHandledOperatorFlags ().getter_divEqualOperatorWithExpression (SOURCE_FILE ("instruction-concat.galgas", 650)).boolEnum () ;
    if (kBoolTrue == test_21) {
      const GALGAS_divEqualExpressionInstructionAST temp_22 = this ;
      TC_Array <C_FixItDescription> fixItArray23 ;
      inCompiler->emitSemanticError (temp_22.readProperty_mInstructionLocation (), GALGAS_string ("the target object has the '@").add_operation (extensionGetter_definition (var_targetType_24596, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 652)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 652)).add_operation (GALGAS_string ("' type, but this type does not support the '/=' operator"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 652)), fixItArray23  COMMA_SOURCE_FILE ("instruction-concat.galgas", 651)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_expression_27087 ;
  const GALGAS_divEqualExpressionInstructionAST temp_24 = this ;
  callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) temp_24.readProperty_mExpression ().ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, var_targetType_24596, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_expression_27087, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 655)) ;
  {
  const GALGAS_divEqualExpressionInstructionAST temp_25 = this ;
  routine_checkAssignmentTypeWithImplicitGetterCall_3F__3F__3F__26_ (var_targetType_24596, var_expression_27087.readProperty_mResultType (), temp_25.readProperty_mInstructionLocation (), var_expression_27087, inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 665)) ;
  }
  const GALGAS_divEqualExpressionInstructionAST temp_26 = this ;
  const GALGAS_divEqualExpressionInstructionAST temp_27 = this ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_opEqualInstructionForGeneration::class_func_new (temp_26.readProperty_mInstructionLocation (), var_targetType_24596, var_targetVariableCppName_24621, var_nameForCheckingFormalParameterUsing_24657, temp_27.readProperty_mStructAttributeList (), var_expression_27087, GALGAS_string ("divAssign_operation")  COMMA_SOURCE_FILE ("instruction-concat.galgas", 667))  COMMA_SOURCE_FILE ("instruction-concat.galgas", 667)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_plusEqualElementsInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
                                                                              ...
                                                                              Compiler * inCompiler
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapEntry var_targetType_28136 ;
  GALGAS_string var_targetVariableCppName_28161 ;
  GALGAS_string var_nameForCheckingFormalParameterUsing_28197 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        GALGAS_unifiedTypeMapEntry var_selfType_28324 ;
        GALGAS_bool var_unused_0_28343 ;
        GALGAS_bool var_mutableProperties_28369 ;
        const bool optionalResult28303 = constinArgument_inAnalysisContext.readProperty_selfType ().optional_available (var_selfType_28324, var_unused_0_28343, var_mutableProperties_28369) ;
        if (!optionalResult28303) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_mutableProperties_28369.operator_not (SOURCE_FILE ("instruction-concat.galgas", 694)).boolEnum () ;
            if (kBoolTrue == test_3) {
              const GALGAS_plusEqualElementsInstructionAST temp_4 = this ;
              TC_Array <C_FixItDescription> fixItArray5 ;
              inCompiler->emitSemanticError (temp_4.readProperty_mInstructionLocation (), GALGAS_string ("'self' not mutable in this context"), fixItArray5  COMMA_SOURCE_FILE ("instruction-concat.galgas", 695)) ;
            }
          }
          GALGAS_propertyMap var_propertyMap_28528 = extensionGetter_definition (var_selfType_28324, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 697)).readProperty_mPropertyMap () ;
          GALGAS_bool var_isConstant_28634 ;
          const GALGAS_plusEqualElementsInstructionAST temp_6 = this ;
          GALGAS_AccessControl joker_28626 ; // Joker input parameter
          var_propertyMap_28528.method_searchKey (temp_6.readProperty_mReceiverName (), joker_28626, var_isConstant_28634, var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 698)) ;
          var_nameForCheckingFormalParameterUsing_28197 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName () ;
          const GALGAS_plusEqualElementsInstructionAST temp_7 = this ;
          var_targetVariableCppName_28161 = constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 700)).add_operation (temp_7.readProperty_mReceiverName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-concat.galgas", 701)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 701)) ;
          enumGalgasBool test_8 = kBoolTrue ;
          if (kBoolTrue == test_8) {
            test_8 = var_isConstant_28634.boolEnum () ;
            if (kBoolTrue == test_8) {
              const GALGAS_plusEqualElementsInstructionAST temp_9 = this ;
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (temp_9.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray10  COMMA_SOURCE_FILE ("instruction-concat.galgas", 703)) ;
            }
          }
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            test_11 = var_mutableProperties_28369.operator_not (SOURCE_FILE ("instruction-concat.galgas", 705)).boolEnum () ;
            if (kBoolTrue == test_11) {
              const GALGAS_plusEqualElementsInstructionAST temp_12 = this ;
              TC_Array <C_FixItDescription> fixItArray13 ;
              inCompiler->emitSemanticError (temp_12.readProperty_mReceiverName ().readProperty_location (), GALGAS_string ("the property cannot be mutated in this context"), fixItArray13  COMMA_SOURCE_FILE ("instruction-concat.galgas", 706)) ;
            }
          }
        }
      }
      if (kBoolFalse == test_2) {
        ...
        TC_Array <C_FixItDescription> fixItArray15 ;
        inCompiler->emitSemanticError (temp_14.readProperty_mInstructionLocation (), GALGAS_string ("'self' not available in this context"), fixItArray15  COMMA_SOURCE_FILE ("instruction-concat.galgas", 709)) ;
        var_targetType_28136.drop () ; // Release error dropped variable
        var_targetVariableCppName_28161.drop () ; // Release error dropped variable
        var_nameForCheckingFormalParameterUsing_28197.drop () ; // Release error dropped variable
      }
    }
  }
  if (kBoolFalse == test_0) {
    ...
    extensionSetter_searchForReadWriteAccess (ioArgument_ioVariableMap, temp_16.readProperty_mReceiverName (), var_targetType_28136, var_targetVariableCppName_28161, var_nameForCheckingFormalParameterUsing_28197, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 713)) ;
    }
  }
  const GALGAS_plusEqualElementsInstructionAST temp_17 = this ;
  cEnumerator_lstringlist enumerator_29536 (temp_17.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_29536.hasCurrentObject ()) {
    GALGAS_propertyMap var_propertyMap_29583 = extensionGetter_definition (var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 722)).readProperty_mPropertyMap () ;
    GALGAS_AccessControl var_accessControl_29714 ;
    GALGAS_bool var_isConstant_29733 ;
    var_propertyMap_29583.method_searchKey (enumerator_29536.current_mValue (HERE), var_accessControl_29714, var_isConstant_29733, var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 724)) ;
    extensionMethod_checkSetAccess (var_accessControl_29714, constinArgument_inAnalysisContext.readProperty_selfType (), enumerator_29536.current_mValue (HERE).readProperty_location (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 725)) ;
    enumGalgasBool test_18 = kBoolTrue ;
    if (kBoolTrue == test_18) {
      test_18 = var_isConstant_29733.boolEnum () ;
      if (kBoolTrue == test_18) {
        TC_Array <C_FixItDescription> fixItArray19 ;
        inCompiler->emitSemanticError (enumerator_29536.current_mValue (HERE).readProperty_location (), GALGAS_string ("a constant property cannot be modified"), fixItArray19  COMMA_SOURCE_FILE ("instruction-concat.galgas", 737)) ;
      }
    }
    enumerator_29536.gotoNextObject () ;
  }
  GALGAS_functionSignature var_addAssignOperatorArguments_30355 = extensionGetter_definition (var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 741)).readProperty_mAddAssignOperatorArguments () ;
  enumGalgasBool test_20 = kBoolTrue ;
  if (kBoolTrue == test_20) {
    test_20 = GALGAS_bool (kIsEqual, var_addAssignOperatorArguments_30355.getter_count (SOURCE_FILE ("instruction-concat.galgas", 742)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_20) {
      const GALGAS_plusEqualElementsInstructionAST temp_21 = this ;
      TC_Array <C_FixItDescription> fixItArray22 ;
      inCompiler->emitSemanticError (temp_21.readProperty_mInstructionLocation (), GALGAS_string ("the target object has the '@").add_operation (extensionGetter_definition (var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 744)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 744)).add_operation (GALGAS_string ("' type, but this type does not support the '+=' operator"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 744)), fixItArray22  COMMA_SOURCE_FILE ("instruction-concat.galgas", 743)) ;
    }
  }
  if (kBoolFalse == test_20) {
    ...
    if (kBoolTrue == test_23) {
      ...
      test_23 = GALGAS_bool (kIsNotEqual, temp_24.readProperty_mExpressions ().getter_count (SOURCE_FILE ("instruction-concat.galgas", 746)).objectCompare (var_addAssignOperatorArguments_30355.getter_count (SOURCE_FILE ("instruction-concat.galgas", 746)))).boolEnum () ;
      if (kBoolTrue == test_23) {
        ...
        inCompiler->emitSemanticError (temp_25.readProperty_mInstructionLocation (), GALGAS_string ("calling the '+=' operator on an '@").add_operation (extensionGetter_definition (var_targetType_28136, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 748)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 748)).add_operation (GALGAS_string ("' object requires "), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 748)).add_operation (var_addAssignOperatorArguments_30355.getter_count (SOURCE_FILE ("instruction-concat.galgas", 749)).getter_string (SOURCE_FILE ("instruction-concat.galgas", 749)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 748)).add_operation (GALGAS_string (" parameter(s), while this invocation has "), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 749)).add_operation (temp_26.readProperty_mExpressions ().getter_count (SOURCE_FILE ("instruction-concat.galgas", 750)).getter_string (SOURCE_FILE ("instruction-concat.galgas", 750)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 749)).add_operation (GALGAS_string (" parameter(s)"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 750)), fixItArray27  COMMA_SOURCE_FILE ("instruction-concat.galgas", 747)) ;
      }
    }
    if (kBoolFalse == test_23) {
      GALGAS_semanticExpressionListForGeneration var_effectiveParameterList_31167 = GALGAS_semanticExpressionListForGeneration::class_func_emptyList (SOURCE_FILE ("instruction-concat.galgas", 752)) ;
      const GALGAS_plusEqualElementsInstructionAST temp_28 = this ;
      cEnumerator_actualOutputExpressionList enumerator_31232 (temp_28.readProperty_mExpressions (), kENUMERATION_UP) ;
      cEnumerator_functionSignature enumerator_31317 (var_addAssignOperatorArguments_30355, kENUMERATION_UP) ;
      while (enumerator_31232.hasCurrentObject () && enumerator_31317.hasCurrentObject ()) {
        GALGAS_semanticExpressionForGeneration var_expression_31625 ;
        callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) enumerator_31232.current_mExpression (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, enumerator_31317.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_expression_31625, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 754)) ;
        enumGalgasBool test_29 = kBoolTrue ;
        if (kBoolTrue == test_29) {
          test_29 = GALGAS_bool (kIsNotEqual, enumerator_31317.current_mFormalSelector (HERE).readProperty_string ().objectCompare (enumerator_31232.current_mActualSelector (HERE).readProperty_string ())).boolEnum () ;
          if (kBoolTrue == test_29) {
            GALGAS_string temp_30 ;
            const enumGalgasBool test_31 = GALGAS_bool (kIsNotEqual, enumerator_31317.current_mFormalSelector (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_31) {
              temp_30 = enumerator_31317.current_mFormalSelector (HERE).readProperty_string ().add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 764)) ;
            }else if (kBoolFalse == test_31) {
              temp_30 = GALGAS_string::makeEmptyString () ;
            }
            GALGAS_string var_s_31727 = GALGAS_string ("!").add_operation (temp_30, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 764)) ;
            TC_Array <C_FixItDescription> fixItArray32 ;
            appendFixItActions (fixItArray32, kFixItReplace, var_s_31727) ;
            inCompiler->emitSemanticError (enumerator_31232.current_mActualSelector (HERE).readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_31727, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 765)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 765)), fixItArray32  COMMA_SOURCE_FILE ("instruction-concat.galgas", 765)) ;
          }
        }
        {
        routine_checkAssignmentTypeWithImplicitGetterCall_3F__3F__3F__26_ (enumerator_31317.current_mFormalArgumentType (HERE), var_expression_31625.readProperty_mResultType (), enumerator_31232.current_mEndOfExpressionLocation (HERE), var_expression_31625, inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 769)) ;
        }
        var_effectiveParameterList_31167.addAssign_operation (var_expression_31625  COMMA_SOURCE_FILE ("instruction-concat.galgas", 770)) ;
        enumerator_31232.gotoNextObject () ;
        enumerator_31317.gotoNextObject () ;
      }
      const GALGAS_plusEqualElementsInstructionAST temp_33 = this ;
      const GALGAS_plusEqualElementsInstructionAST temp_34 = this ;
      ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_plusEqualnstructionForGeneration::class_func_new (var_targetVariableCppName_28161, var_targetType_28136, var_nameForCheckingFormalParameterUsing_28197, temp_33.readProperty_mInstructionLocation (), temp_34.readProperty_mStructAttributeList (), var_effectiveParameterList_31167  COMMA_SOURCE_FILE ("instruction-concat.galgas", 773))  COMMA_SOURCE_FILE ("instruction-concat.galgas", 773)) ;
    }
  }
}
//--------------------------------------------------------------------------------------------------
...
void cPtr_plusEqualnstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
  ...
  GALGAS_stringlist var_parameterList_33660 = GALGAS_stringlist::class_func_emptyList (SOURCE_FILE ("instruction-concat.galgas", 806)) ;
  const GALGAS_plusEqualnstructionForGeneration temp_1 = this ;
  cEnumerator_semanticExpressionListForGeneration enumerator_33698 (temp_1.readProperty_mExpressionList (), kENUMERATION_UP) ;
  while (enumerator_33698.hasCurrentObject ()) {
    GALGAS_string var_parameter_33908 ;
    callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) enumerator_33698.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter_33908, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 808)) ;
    var_parameterList_33660.addAssign_operation (var_parameter_33908  COMMA_SOURCE_FILE ("instruction-concat.galgas", 815)) ;
    enumerator_33698.gotoNextObject () ;
  }
  {
  const GALGAS_plusEqualnstructionForGeneration temp_2 = this ;
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (temp_2.readProperty_mNameForCheckingFormalParameterUsing () COMMA_SOURCE_FILE ("instruction-concat.galgas", 818)) ;
  }
  const GALGAS_plusEqualnstructionForGeneration temp_3 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(temp_3.readProperty_mReceiverCppName (), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 819)) ;
  const GALGAS_plusEqualnstructionForGeneration temp_4 = this ;
  cEnumerator_lstringlist enumerator_34112 (temp_4.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_34112.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".mProperty_").add_operation (enumerator_34112.current_mValue (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-concat.galgas", 821)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 821)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 821)) ;
    enumerator_34112.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".addAssign_operation ("), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 824)) ;
  {
  const GALGAS_plusEqualnstructionForGeneration temp_5 = this ;
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (temp_5.readProperty_mReceiverCppName () COMMA_SOURCE_FILE ("instruction-concat.galgas", 825)) ;
  }
  cEnumerator_stringlist enumerator_34392 (var_parameterList_33660, kENUMERATION_UP) ;
  while (enumerator_34392.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_34392.current_mValue (HERE), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 827)) ;
    if (enumerator_34392.hasNextObject ()) {
      ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 828)) ;
    }
    enumerator_34392.gotoNextObject () ;
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
    const GALGAS_plusEqualnstructionForGeneration temp_7 = this ;
    test_6 = extensionGetter_definition (temp_7.readProperty_mTargetType (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 830)).readProperty_mHandledOperatorFlags ().getter_plusEqualOperatorWithFieldListNeedsCompilerArg (SOURCE_FILE ("instruction-concat.galgas", 830)).boolEnum () ;
    if (kBoolTrue == test_6) {
      ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (", ").add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 831)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 831)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 831)) ;
      {
      ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 832)) COMMA_SOURCE_FILE ("instruction-concat.galgas", 832)) ;
      }
    }
  }
  const GALGAS_plusEqualnstructionForGeneration temp_8 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_commaSourceFile (temp_8.readProperty_mInstructionLocation (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 834)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 834)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 834)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 834)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_opEqualInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
  ...
  extensionMethod_addHeaderFileName (temp_0.readProperty_mTargetType (), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 857)) ;
  GALGAS_string var_sourceVar_35974 ;
  const GALGAS_opEqualInstructionForGeneration temp_1 = this ;
  callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) temp_1.readProperty_mSourceExpression ().ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar_35974, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 858)) ;
  {
  const GALGAS_opEqualInstructionForGeneration temp_2 = this ;
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (temp_2.readProperty_mNameForCheckingFormalParameterUsing () COMMA_SOURCE_FILE ("instruction-concat.galgas", 865)) ;
  }
  const GALGAS_opEqualInstructionForGeneration temp_3 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(temp_3.readProperty_mTargetVariableCppName (), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 866)) ;
  const GALGAS_opEqualInstructionForGeneration temp_4 = this ;
  cEnumerator_lstringlist enumerator_36130 (temp_4.readProperty_mStructAttributeList (), kENUMERATION_UP) ;
  while (enumerator_36130.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".mProperty_").add_operation (enumerator_36130.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 868)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 868)) ;
    enumerator_36130.gotoNextObject () ;
  }
  const GALGAS_opEqualInstructionForGeneration temp_5 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".").add_operation (temp_5.readProperty_mGeneratedMethod (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 870)).add_operation (GALGAS_string ("("), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 870)).add_operation (var_sourceVar_35974, inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 870)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 870)) ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (", ").add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 871)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 871)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 871)) ;
  const GALGAS_opEqualInstructionForGeneration temp_6 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_commaSourceFile (temp_6.readProperty_mInstructionLocation (), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 872)), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 872)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 872)), inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 872)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 873)) COMMA_SOURCE_FILE ("instruction-concat.galgas", 873)) ;
  }
  {
  const GALGAS_opEqualInstructionForGeneration temp_7 = this ;
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (temp_7.readProperty_mTargetVariableCppName () COMMA_SOURCE_FILE ("instruction-concat.galgas", 874)) ;
  }
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_ifInstructionAST::method_enterInstructionInSemanticContext (GALGAS_unifiedTypeMap & ioArgument_ioTypeMap,
  ...
  cEnumerator_ifExpressionList enumerator_13886 (temp_0.readProperty_mExpressions (), kENUMERATION_UP) ;
  while (enumerator_13886.hasCurrentObject ()) {
    switch (enumerator_13886.current_mExpression (HERE).enumValue ()) {
    case GALGAS_ifExpressionKind::kNotBuilt:
      break ;
    case GALGAS_ifExpressionKind::kEnum_regularExp:
      {
        const cEnumAssociatedValues_ifExpressionKind_regularExp * extractPtr_14027 = (const cEnumAssociatedValues_ifExpressionKind_regularExp *) (enumerator_13886.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_13965_exp = extractPtr_14027->mAssociatedValue0 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_13965_exp.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 374)) ;
      }
      break ;
    case GALGAS_ifExpressionKind::kEnum_letExp:
      {
        const cEnumAssociatedValues_ifExpressionKind_letExp * extractPtr_14173 = (const cEnumAssociatedValues_ifExpressionKind_letExp *) (enumerator_13886.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_14048_exp = extractPtr_14173->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_14063_typeName = extractPtr_14173->mAssociatedValue3 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_14048_exp.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 376)) ;
        {
        GALGAS_unifiedTypeMapEntry joker_14171 ; // Joker input parameter
        extensionSetter_makeEntry (ioArgument_ioTypeMap, extractedValue_14063_typeName, joker_14171, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 377)) ;
        }
      }
      break ;
    case GALGAS_ifExpressionKind::kEnum_optionalMethodCall:
      {
        const cEnumAssociatedValues_ifExpressionKind_optionalMethodCall * extractPtr_14613 = (const cEnumAssociatedValues_ifExpressionKind_optionalMethodCall *) (enumerator_13886.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_14204_receiverExpression = extractPtr_14613->mAssociatedValue0 ;
        const GALGAS_optionalMethodActualArgumentList extractedValue_14225_parameters = extractPtr_14613->mAssociatedValue2 ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_14204_receiverExpression.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 379)) ;
        cEnumerator_optionalMethodActualArgumentList enumerator_14324 (extractedValue_14225_parameters, kENUMERATION_UP) ;
        while (enumerator_14324.hasCurrentObject ()) {
          switch (enumerator_14324.current_mActualArgument (HERE).enumValue ()) {
          case GALGAS_optionalMethodActualArgument::kNotBuilt:
            break ;
          case GALGAS_optionalMethodActualArgument::kEnum_actualOutput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgument_actualOutput * extractPtr_14486 = (const cEnumAssociatedValues_optionalMethodActualArgument_actualOutput *) (enumerator_14324.current_mActualArgument (HERE).unsafePointer ()) ;
              const GALGAS_semanticExpressionAST extractedValue_14404_expression = extractPtr_14486->mAssociatedValue0 ;
              callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_14404_expression.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 383)) ;
            }
            break ;
...
void cPtr_ifInstructionAST::method_analyzeSemanticInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
                                                               ...
                                                               Compiler * inCompiler
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ifTestListForGeneration var_testListForGeneration_16106 = GALGAS_ifTestListForGeneration::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 430)) ;
  const GALGAS_ifInstructionAST temp_0 = this ;
  cEnumerator_ifExpressionList enumerator_16140 (temp_0.readProperty_mExpressions (), kENUMERATION_UP) ;
  while (enumerator_16140.hasCurrentObject ()) {
    switch (enumerator_16140.current_mExpression (HERE).enumValue ()) {
    case GALGAS_ifExpressionKind::kNotBuilt:
      break ;
    case GALGAS_ifExpressionKind::kEnum_regularExp:
      {
        const cEnumAssociatedValues_ifExpressionKind_regularExp * extractPtr_16788 = (const cEnumAssociatedValues_ifExpressionKind_regularExp *) (enumerator_16140.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_16219_exp = extractPtr_16788->mAssociatedValue0 ;
        GALGAS_semanticExpressionForGeneration var_analyzed_5F_if_5F_expression_16447 ;
        callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) extractedValue_16219_exp.ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-if.galgas", 437)), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_analyzed_5F_if_5F_expression_16447, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 434)) ;
        GALGAS_semanticExpressionForGeneration var_if_5F_expression_16619 ;
        {
        const GALGAS_ifInstructionAST temp_1 = this ;
        routine_checkExpressionIsBoolean_3F__3F__3F__21_ (constinArgument_inAnalysisContext, temp_1.readProperty_mEndOf_5F_if_5F_instruction (), var_analyzed_5F_if_5F_expression_16447, var_if_5F_expression_16619, inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 443)) ;
        }
        var_testListForGeneration_16106.addAssign_operation (GALGAS_ifTestForGeneration::class_func_regular (var_if_5F_expression_16619  COMMA_SOURCE_FILE ("instruction-if.galgas", 449))  COMMA_SOURCE_FILE ("instruction-if.galgas", 449)) ;
        {
    ...
    case GALGAS_ifExpressionKind::kEnum_letExp:
      {
        const cEnumAssociatedValues_ifExpressionKind_letExp * extractPtr_20374 = (const cEnumAssociatedValues_ifExpressionKind_letExp *) (enumerator_16140.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_16807_constantName = extractPtr_20374->mAssociatedValue0 ;
        const GALGAS_semanticExpressionAST extractedValue_16820_exp = extractPtr_20374->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_16835_typeName = extractPtr_20374->mAssociatedValue3 ;
        GALGAS_semanticExpressionForGeneration var_analyzedExpression_17068 ;
        callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) extractedValue_16820_exp.ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-if.galgas", 456)), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_analyzedExpression_17068, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 453)) ;
        GALGAS_unifiedTypeMapEntry var_castType_17135 = GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-if.galgas", 463)) ;
        GALGAS_unifiedTypeMapEntry var_testType_17182 = GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-if.galgas", 464)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = extensionGetter_definition (var_analyzedExpression_17068.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 466)).readProperty_mTypeKindEnum ().getter_isClassType (SOURCE_FILE ("instruction-if.galgas", 466)).boolEnum () ;
          if (kBoolTrue == test_2) {
            enumGalgasBool test_3 = kBoolTrue ;
            if (kBoolTrue == test_3) {
              test_3 = GALGAS_bool (kIsEqual, extractedValue_16835_typeName.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_3) {
                TC_Array <C_FixItDescription> fixItArray4 ;
                inCompiler->emitSemanticError (extractedValue_16835_typeName.readProperty_location (), GALGAS_string ("on a class object, the 'as' clause is required"), fixItArray4  COMMA_SOURCE_FILE ("instruction-if.galgas", 468)) ;
                var_castType_17135.drop () ; // Release error dropped variable
                var_testType_17182.drop () ; // Release error dropped variable
              }
            }
            if (kBoolFalse == test_3) {
              var_castType_17135 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, extractedValue_16835_typeName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 470)) ;
              var_testType_17182 = var_castType_17135 ;
              GALGAS_unifiedTypeMapEntry var_t_17686 = var_castType_17135 ;
              GALGAS_bool var_found_17719 = GALGAS_bool (kIsEqual, var_t_17686.objectCompare (var_analyzedExpression_17068.readProperty_mResultType ())) ;
              if (ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-if.galgas", 475)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 475)).isValid ()) {
                uint32_t variant_17773 = ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-if.galgas", 475)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 475)).uintValue () ;
                bool loop_17773 = true ;
                while (loop_17773) {
                  loop_17773 = var_found_17719.operator_not (SOURCE_FILE ("instruction-if.galgas", 476)).operator_and (extensionGetter_definition (var_t_17686, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 476)).readProperty_mSuperType ().getter_isNull (SOURCE_FILE ("instruction-if.galgas", 476)).operator_not (SOURCE_FILE ("instruction-if.galgas", 476)) COMMA_SOURCE_FILE ("instruction-if.galgas", 476)).isValid () ;
                  if (loop_17773) {
                    loop_17773 = var_found_17719.operator_not (SOURCE_FILE ("instruction-if.galgas", 476)).operator_and (extensionGetter_definition (var_t_17686, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 476)).readProperty_mSuperType ().getter_isNull (SOURCE_FILE ("instruction-if.galgas", 476)).operator_not (SOURCE_FILE ("instruction-if.galgas", 476)) COMMA_SOURCE_FILE ("instruction-if.galgas", 476)).boolValue () ;
                  }
                  if (loop_17773 && (0 == variant_17773)) {
                    loop_17773 = false ;
                    inCompiler->loopRunTimeVariantError (SOURCE_FILE ("instruction-if.galgas", 475)) ;
                  }
                  if (loop_17773) {
                    variant_17773 -- ;
                    var_t_17686 = extensionGetter_definition (var_t_17686, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 477)).readProperty_mSuperType () ;
                    var_found_17719 = GALGAS_bool (kIsEqual, var_t_17686.objectCompare (var_analyzedExpression_17068.readProperty_mResultType ())) ;
                  }
                }
              }
              enumGalgasBool test_5 = kBoolTrue ;
              if (kBoolTrue == test_5) {
                test_5 = var_found_17719.operator_not (SOURCE_FILE ("instruction-if.galgas", 480)).boolEnum () ;
                if (kBoolTrue == test_5) {
                  TC_Array <C_FixItDescription> fixItArray6 ;
                  inCompiler->emitSemanticError (extractedValue_16835_typeName.readProperty_location (), GALGAS_string ("the '@").add_operation (extractedValue_16835_typeName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 482)).add_operation (GALGAS_string ("' type is not a descendant of the '@"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 482)).add_operation (extensionGetter_definition (var_analyzedExpression_17068.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 482)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 482)).add_operation (GALGAS_string ("' type of the cast expression"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 482)), fixItArray6  COMMA_SOURCE_FILE ("instruction-if.galgas", 481)) ;
                }
              }
            }
          }
        ...
        if (kBoolFalse == test_2) {
          enumGalgasBool test_7 = kBoolTrue ;
          if (kBoolTrue == test_7) {
            GALGAS_unifiedTypeMapEntry var_classType_18366 ;
            const bool optionalResult18328 = extensionGetter_definition (var_analyzedExpression_17068.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 486)).readProperty_mTypeKindEnum ().optional_weakReferenceType (var_classType_18366) ;
            if (!optionalResult18328) {
              test_7 = kBoolFalse ;
            }
            if (kBoolTrue == test_7) {
              enumGalgasBool test_8 = kBoolTrue ;
              if (kBoolTrue == test_8) {
                test_8 = GALGAS_bool (kIsEqual, extractedValue_16835_typeName.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_8) {
                  var_castType_17135 = var_classType_18366 ;
                }
              }
              if (kBoolFalse == test_8) {
                var_castType_17135 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, extractedValue_16835_typeName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 490)) ;
              }
              var_testType_17182 = var_castType_17135 ;
              GALGAS_unifiedTypeMapEntry var_t_18600 = var_castType_17135 ;
              GALGAS_bool var_found_18631 = GALGAS_bool (kIsEqual, var_t_18600.objectCompare (var_analyzedExpression_17068.readProperty_mResultType ())) ;
              enumGalgasBool test_9 = kBoolTrue ;
              if (kBoolTrue == test_9) {
                test_9 = var_found_18631.boolEnum () ;
                if (kBoolTrue == test_9) {
                  extensionGetter_definition (var_castType_17135, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 496)).readProperty_mTypeKindEnum ().method_weakReferenceType (var_testType_17182, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 496)) ;
                }
              }
              if (kBoolFalse == test_9) {
                enumGalgasBool test_10 = kBoolTrue ;
                if (kBoolTrue == test_10) {
                  test_10 = GALGAS_bool (kIsEqual, var_t_18600.objectCompare (var_classType_18366)).boolEnum () ;
                  if (kBoolTrue == test_10) {
                    var_found_18631 = GALGAS_bool (true) ;
                  }
                }
              }
              if (ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-if.galgas", 500)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 500)).isValid ()) {
                uint32_t variant_18865 = ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-if.galgas", 500)).add_operation (GALGAS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 500)).uintValue () ;
                bool loop_18865 = true ;
                while (loop_18865) {
                  loop_18865 = var_found_18631.operator_not (SOURCE_FILE ("instruction-if.galgas", 501)).operator_and (extensionGetter_definition (var_t_18600, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 501)).readProperty_mSuperType ().getter_isNull (SOURCE_FILE ("instruction-if.galgas", 501)).operator_not (SOURCE_FILE ("instruction-if.galgas", 501)) COMMA_SOURCE_FILE ("instruction-if.galgas", 501)).isValid () ;
                  if (loop_18865) {
                  ...
                  if (loop_18865 && (0 == variant_18865)) {
                    loop_18865 = false ;
                    inCompiler->loopRunTimeVariantError (SOURCE_FILE ("instruction-if.galgas", 500)) ;
                  }
                  if (loop_18865) {
                    variant_18865 -- ;
                    var_t_18600 = extensionGetter_definition (var_t_18600, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 502)).readProperty_mSuperType () ;
                    enumGalgasBool test_11 = kBoolTrue ;
                    if (kBoolTrue == test_11) {
                      test_11 = GALGAS_bool (kIsEqual, var_t_18600.objectCompare (var_analyzedExpression_17068.readProperty_mResultType ())).boolEnum () ;
                      if (kBoolTrue == test_11) {
                        var_found_18631 = GALGAS_bool (true) ;
                        extensionGetter_definition (var_castType_17135, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 505)).readProperty_mTypeKindEnum ().method_weakReferenceType (var_testType_17182, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 505)) ;
                      }
                    }
                    if (kBoolFalse == test_11) {
                      enumGalgasBool test_12 = kBoolTrue ;
                      if (kBoolTrue == test_12) {
                        test_12 = GALGAS_bool (kIsEqual, var_t_18600.objectCompare (var_classType_18366)).boolEnum () ;
                        if (kBoolTrue == test_12) {
                          var_found_18631 = GALGAS_bool (true) ;
                        }
                      }
              ...
              if (kBoolTrue == test_13) {
                test_13 = var_found_18631.operator_not (SOURCE_FILE ("instruction-if.galgas", 510)).boolEnum () ;
                if (kBoolTrue == test_13) {
                  TC_Array <C_FixItDescription> fixItArray14 ;
                  inCompiler->emitSemanticError (extractedValue_16835_typeName.readProperty_location (), GALGAS_string ("the '@").add_operation (extensionGetter_definition (var_castType_17135, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)).add_operation (GALGAS_string ("' type is not compatible with the '@"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)).add_operation (extensionGetter_definition (var_analyzedExpression_17068.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 512)), fixItArray14  COMMA_SOURCE_FILE ("instruction-if.galgas", 511)) ;
                }
              }
            }
          }
          if (kBoolFalse == test_7) {
            TC_Array <C_FixItDescription> fixItArray15 ;
            inCompiler->emitSemanticError (var_analyzedExpression_17068.readProperty_mLocation (), GALGAS_string ("expression should be a class instance, or a weak reference: it is an @").add_operation (extensionGetter_definition (var_analyzedExpression_17068.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 516)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 515)).add_operation (GALGAS_string (" instance"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 516)), fixItArray15  COMMA_SOURCE_FILE ("instruction-if.galgas", 515)) ;
          }
        }
        {
        ...
        GALGAS_string var_targetVariableCppName_19824 = GALGAS_string ("var_").add_operation (extractedValue_16807_constantName.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 520)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 520)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 520)).add_operation (extractedValue_16807_constantName.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 521)).getter_string (SOURCE_FILE ("instruction-if.galgas", 521)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 521)) ;
        enumGalgasBool test_16 = kBoolTrue ;
        if (kBoolTrue == test_16) {
          test_16 = GALGAS_bool (kIsNotEqual, extractedValue_16807_constantName.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_16) {
            {
            extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, extractedValue_16807_constantName, var_castType_17135, var_targetVariableCppName_19824, var_targetVariableCppName_19824, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 523)) ;
            }
          }
        }
        var_testListForGeneration_16106.addAssign_operation (GALGAS_ifTestForGeneration::class_func_letExp (var_targetVariableCppName_19824, var_analyzedExpression_17068, var_castType_17135, var_testType_17182  COMMA_SOURCE_FILE ("instruction-if.galgas", 530))  COMMA_SOURCE_FILE ("instruction-if.galgas", 530)) ;
      }
      break ;
    case GALGAS_ifExpressionKind::kEnum_optionalMethodCall:
      {
        const cEnumAssociatedValues_ifExpressionKind_optionalMethodCall * extractPtr_20791 = (const cEnumAssociatedValues_ifExpressionKind_optionalMethodCall *) (enumerator_16140.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionAST extractedValue_20405_receiverExpression = extractPtr_20791->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_20424_optionalMethodName = extractPtr_20791->mAssociatedValue1 ;
        const GALGAS_optionalMethodActualArgumentList extractedValue_20443_parameters = extractPtr_20791->mAssociatedValue2 ;
        {
        routine_analyzeOptionalMethodCall_3F__26__3F__26__26__3F_receiverExp_3F_optionalMethodName_3F_parameters_26_ (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, extractedValue_20405_receiverExpression, extractedValue_20424_optionalMethodName, extractedValue_20443_parameters, var_testListForGeneration_16106, inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 537)) ;
        }
      }
      break ;
    }
  ...
  GALGAS_semanticInstructionListForGeneration var_then_5F_instructionList_21174 ;
  {
  const GALGAS_ifInstructionAST temp_17 = this ;
  routine_analyzeSemanticInstructionListWithoutBranch_3F__26__3F__26__3F_localConstantList_3F_localInitializedVariableListWarnsIfNotMutated_3F_localInitializedVariableListNoWarnsIfNotMutated_3F__26__21_ (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, GALGAS_localConstantList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 556)), GALGAS_localInitializedVariableList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 557)), GALGAS_localInitializedVariableList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 558)), temp_17.readProperty_m_5F_then_5F_instructionList (), ioArgument_ioVariableMap, var_then_5F_instructionList_21174, inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 551)) ;
  }
  const GALGAS_ifInstructionAST temp_18 = this ;
  GALGAS_ifExpressionList var_expressions_21205 = temp_18.readProperty_mExpressions () ;
  {
  GALGAS_ifExpressionKind joker_21262 ; // Joker input parameter
  var_expressions_21205.setter_popLast (joker_21262, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 564)) ;
  }
  cEnumerator_ifExpressionList enumerator_21273 (var_expressions_21205, kENUMERATION_UP) ;
  while (enumerator_21273.hasCurrentObject ()) {
    {
    const GALGAS_ifInstructionAST temp_19 = this ;
    extensionSetter_closeBranch (ioArgument_ioVariableMap, temp_19.readProperty_mEndOf_5F_then_5F_branch (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 566)) ;
    }
    {
    const GALGAS_ifInstructionAST temp_20 = this ;
    extensionSetter_closeOverride (ioArgument_ioVariableMap, temp_20.readProperty_mEndOf_5F_then_5F_branch (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 567)) ;
    }
    enumerator_21273.gotoNextObject () ;
  }
  {
  const GALGAS_ifInstructionAST temp_21 = this ;
  extensionSetter_closeBranch (ioArgument_ioVariableMap, temp_21.readProperty_mEndOf_5F_then_5F_branch (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 569)) ;
  }
  GALGAS_semanticInstructionListForGeneration var_else_5F_instructionList_21863 ;
  {
  const GALGAS_ifInstructionAST temp_22 = this ;
  const GALGAS_ifInstructionAST temp_23 = this ;
  routine_analyzeSemanticInstructionList_3F__26__3F__26__3F_localConstantList_3F_localInitializedVariableListWarnsIfNotMutated_3F_localInitializedVariableListNoWarnsIfNotMutated_3F__3F__26__21_ (constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, GALGAS_localConstantList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 576)), GALGAS_localInitializedVariableList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 577)), GALGAS_localInitializedVariableList::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 578)), temp_22.readProperty_m_5F_else_5F_instructionList (), temp_23.readProperty_mEndOf_5F_if_5F_instruction (), ioArgument_ioVariableMap, var_else_5F_instructionList_21863, inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 571)) ;
  }
  {
  const GALGAS_ifInstructionAST temp_24 = this ;
  extensionSetter_closeOverride (ioArgument_ioVariableMap, temp_24.readProperty_mEndOf_5F_if_5F_instruction (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 584)) ;
  }
  const GALGAS_ifInstructionAST temp_25 = this ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_ifInstructionForGeneration::class_func_new (temp_25.readProperty_mEndOf_5F_then_5F_branch (), var_testListForGeneration_16106, var_then_5F_instructionList_21174, var_else_5F_instructionList_21863  COMMA_SOURCE_FILE ("instruction-if.galgas", 586))  COMMA_SOURCE_FILE ("instruction-if.galgas", 586)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void routine_analyzeOptionalMethodCall_3F__26__3F__26__26__3F_receiverExp_3F_optionalMethodName_3F_parameters_26_ (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  GALGAS_unifiedTypeMapEntry var_receiverType_23650 = var_receiverExpression_23493.readProperty_mResultType () ;
  GALGAS_optionalMethodMap var_optionalMethodMap_23721 = extensionGetter_definition (var_receiverType_23650, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 621)).readProperty_mOptionalMethodMap () ;
  GALGAS_optionalMethodSignature var_optionalMethodSignature_23845 ;
  const cMapElement_optionalMethodMap * objectArray_23871 = (const cMapElement_optionalMethodMap *) var_optionalMethodMap_23721.readAccessForWithInstruction (constinArgument_inOptionalMethodName.readProperty_string ()) ;
  if (nullptr != objectArray_23871) {
      macroValidSharedObject (objectArray_23871, cMapElement_optionalMethodMap) ;
    var_optionalMethodSignature_23845 = objectArray_23871->mProperty_mArgumentTypeList ;
  }else{
    GALGAS_string var_s_23991 = GALGAS_string ("this optional method is not defined; available optional methods:") ;
    cEnumerator_optionalMethodMap enumerator_24076 (var_optionalMethodMap_23721, kENUMERATION_UP) ;
    while (enumerator_24076.hasCurrentObject ()) {
      var_s_23991.plusAssign_operation(GALGAS_string ("\n  - ").add_operation (enumerator_24076.current_lkey (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 629)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 629)) ;
      enumerator_24076.gotoNextObject () ;
    }
    TC_Array <C_FixItDescription> fixItArray0 ;
    inCompiler->emitSemanticError (constinArgument_inOptionalMethodName.readProperty_location (), var_s_23991, fixItArray0  COMMA_SOURCE_FILE ("instruction-if.galgas", 631)) ;
    var_optionalMethodSignature_23845.drop () ; // Release error dropped variable
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inActualParameters.getter_count (SOURCE_FILE ("instruction-if.galgas", 634)).objectCompare (var_optionalMethodSignature_23845.getter_count (SOURCE_FILE ("instruction-if.galgas", 634)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (constinArgument_inOptionalMethodName.readProperty_location (), GALGAS_string ("calling the '").add_operation (constinArgument_inOptionalMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).add_operation (GALGAS_string ("' optional method of '@"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).add_operation (extensionGetter_definition (var_receiverType_23650, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).add_operation (GALGAS_string ("' requires "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).add_operation (var_optionalMethodSignature_23845.getter_count (SOURCE_FILE ("instruction-if.galgas", 637)).getter_string (SOURCE_FILE ("instruction-if.galgas", 636)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 636)).add_operation (GALGAS_string (" parameter(s), while this call has "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 637)).add_operation (constinArgument_inActualParameters.getter_count (SOURCE_FILE ("instruction-if.galgas", 638)).getter_string (SOURCE_FILE ("instruction-if.galgas", 637)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 637)).add_operation (GALGAS_string (" parameter(s)"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 638)), fixItArray2  COMMA_SOURCE_FILE ("instruction-if.galgas", 635)) ;
    }
  }
  if (kBoolFalse == test_1) {
    GALGAS_optionalMethodActualArgumentListForGeneration var_actualParameterList_24701 = GALGAS_optionalMethodActualArgumentListForGeneration::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 640)) ;
    cEnumerator_optionalMethodActualArgumentList enumerator_24750 (constinArgument_inActualParameters, kENUMERATION_UP) ;
    cEnumerator_optionalMethodSignature enumerator_24827 (var_optionalMethodSignature_23845, kENUMERATION_UP) ;
    while (enumerator_24750.hasCurrentObject () && enumerator_24827.hasCurrentObject ()) {
      switch (enumerator_24750.current_mActualArgument (HERE).enumValue ()) {
      case GALGAS_optionalMethodActualArgument::kNotBuilt:
        break ;
      case GALGAS_optionalMethodActualArgument::kEnum_actualOutput:
        {
          const cEnumAssociatedValues_optionalMethodActualArgument_actualOutput * extractPtr_25662 = (const cEnumAssociatedValues_optionalMethodActualArgument_actualOutput *) (enumerator_24750.current_mActualArgument (HERE).unsafePointer ()) ;
          const GALGAS_semanticExpressionAST extractedValue_24914_expression = extractPtr_25662->mAssociatedValue0 ;
          const GALGAS_location extractedValue_24925_location = extractPtr_25662->mAssociatedValue1 ;
          GALGAS_semanticExpressionForGeneration var_exp_25215 ;
          callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) extractedValue_24914_expression.ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, enumerator_24827.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_exp_25215, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 645)) ;
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (enumerator_24750.current_mSelector (HERE).readProperty_string ())).boolEnum () ;
            if (kBoolTrue == test_3) {
              GALGAS_string temp_4 ;
              const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_5) {
                temp_4 = enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 655)) ;
              }else if (kBoolFalse == test_5) {
                temp_4 = GALGAS_string::makeEmptyString () ;
              }
              GALGAS_string var_s_25314 = GALGAS_string ("!").add_operation (temp_4, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 655)) ;
              TC_Array <C_FixItDescription> fixItArray6 ;
              appendFixItActions (fixItArray6, kFixItReplace, var_s_25314) ;
              inCompiler->emitSemanticError (enumerator_24750.current_mSelector (HERE).readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_25314, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 656)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 656)), fixItArray6  COMMA_SOURCE_FILE ("instruction-if.galgas", 656)) ;
            }
          }
          {
          routine_checkAssignmentTypeWithImplicitGetterCall_3F__3F__3F__26_ (enumerator_24827.current_mFormalArgumentType (HERE), var_exp_25215.readProperty_mResultType (), extractedValue_24925_location, var_exp_25215, inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 658)) ;
          }
          var_actualParameterList_24701.addAssign_operation (GALGAS_optionalMethodActualArgumentForGeneration::class_func_actualOutput (var_exp_25215  COMMA_SOURCE_FILE ("instruction-if.galgas", 659))  COMMA_SOURCE_FILE ("instruction-if.galgas", 659)) ;
        }
        break ;
      case GALGAS_optionalMethodActualArgument::kEnum_actualLetInput:
        {
          const cEnumAssociatedValues_optionalMethodActualArgument_actualLetInput * extractPtr_26805 = (const cEnumAssociatedValues_optionalMethodActualArgument_actualLetInput *) (enumerator_24750.current_mActualArgument (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_25700_actualTypeName = extractPtr_26805->mAssociatedValue0 ;
          const GALGAS_lstring extractedValue_25724_constantName = extractPtr_26805->mAssociatedValue1 ;
          enumGalgasBool test_7 = kBoolTrue ;
          if (kBoolTrue == test_7) {
            GALGAS_bool test_8 = GALGAS_bool (kIsNotEqual, extractedValue_25700_actualTypeName.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
            if (kBoolTrue == test_8.boolEnum ()) {
              test_8 = GALGAS_bool (kIsNotEqual, extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 661)).readProperty_mTypeName ().readProperty_string ().objectCompare (extractedValue_25700_actualTypeName.readProperty_string ())) ;
            }
            test_7 = test_8.boolEnum () ;
            if (kBoolTrue == test_7) {
              TC_Array <C_FixItDescription> fixItArray9 ;
              appendFixItActions (fixItArray9, kFixItReplace, GALGAS_string ("@").add_operation (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 664)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 664))) ;
              inCompiler->emitSemanticError (extractedValue_25700_actualTypeName.readProperty_location (), GALGAS_string ("the '@").add_operation (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 663)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 663)).add_operation (GALGAS_string ("' type name is required here"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 663)), fixItArray9  COMMA_SOURCE_FILE ("instruction-if.galgas", 662)) ;
            }
          }
          GALGAS_string var_targetVariableCppName_26086 = GALGAS_string ("var_").add_operation (extractedValue_25724_constantName.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 666)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 666)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 666)).add_operation (extractedValue_25724_constantName.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 667)).getter_string (SOURCE_FILE ("instruction-if.galgas", 667)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 667)) ;
          {
          extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, extractedValue_25724_constantName, enumerator_24827.current_mFormalArgumentType (HERE), var_targetVariableCppName_26086, var_targetVariableCppName_26086, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 668)) ;
          }
          var_actualParameterList_24701.addAssign_operation (GALGAS_optionalMethodActualArgumentForGeneration::class_func_actualLetInput (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 674)).readProperty_mTypeName ().readProperty_string (), var_targetVariableCppName_26086  COMMA_SOURCE_FILE ("instruction-if.galgas", 674))  COMMA_SOURCE_FILE ("instruction-if.galgas", 674)) ;
          enumGalgasBool test_10 = kBoolTrue ;
          if (kBoolTrue == test_10) {
            test_10 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (enumerator_24750.current_mSelector (HERE).readProperty_string ())).boolEnum () ;
            if (kBoolTrue == test_10) {
              GALGAS_string temp_11 ;
              const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_12) {
                temp_11 = enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 676)) ;
              }else if (kBoolFalse == test_12) {
                temp_11 = GALGAS_string::makeEmptyString () ;
              }
              GALGAS_string var_s_26621 = GALGAS_string ("\?").add_operation (temp_11, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 676)) ;
              TC_Array <C_FixItDescription> fixItArray13 ;
              appendFixItActions (fixItArray13, kFixItReplace, var_s_26621) ;
              inCompiler->emitSemanticError (enumerator_24750.current_mSelector (HERE).readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_26621, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 677)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 677)), fixItArray13  COMMA_SOURCE_FILE ("instruction-if.galgas", 677)) ;
            }
          }
        }
        break ;
      case GALGAS_optionalMethodActualArgument::kEnum_actualVarInput:
        {
          const cEnumAssociatedValues_optionalMethodActualArgument_actualVarInput * extractPtr_27986 = (const cEnumAssociatedValues_optionalMethodActualArgument_actualVarInput *) (enumerator_24750.current_mActualArgument (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_26845_actualTypeName = extractPtr_27986->mAssociatedValue0 ;
          const GALGAS_lstring extractedValue_26869_variableName = extractPtr_27986->mAssociatedValue1 ;
          enumGalgasBool test_14 = kBoolTrue ;
          if (kBoolTrue == test_14) {
            GALGAS_bool test_15 = GALGAS_bool (kIsNotEqual, extractedValue_26845_actualTypeName.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())) ;
            if (kBoolTrue == test_15.boolEnum ()) {
              test_15 = GALGAS_bool (kIsNotEqual, extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 680)).readProperty_mTypeName ().readProperty_string ().objectCompare (extractedValue_26845_actualTypeName.readProperty_string ())) ;
            }
            test_14 = test_15.boolEnum () ;
            if (kBoolTrue == test_14) {
              TC_Array <C_FixItDescription> fixItArray16 ;
              appendFixItActions (fixItArray16, kFixItReplace, GALGAS_string ("@").add_operation (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 683)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 683))) ;
              inCompiler->emitSemanticError (extractedValue_26845_actualTypeName.readProperty_location (), GALGAS_string ("the '@").add_operation (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 682)).readProperty_mTypeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 682)).add_operation (GALGAS_string ("' type name is required here"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 682)), fixItArray16  COMMA_SOURCE_FILE ("instruction-if.galgas", 681)) ;
            }
          }
          GALGAS_string var_targetVariableCppName_27232 = GALGAS_string ("var_").add_operation (extractedValue_26869_variableName.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 685)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 685)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 685)).add_operation (extractedValue_26869_variableName.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 686)).getter_string (SOURCE_FILE ("instruction-if.galgas", 686)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 686)) ;
          {
          extensionSetter_insertInitializedLocalVariable (ioArgument_ioVariableMap, extractedValue_26869_variableName, GALGAS_bool (true), enumerator_24827.current_mFormalArgumentType (HERE), var_targetVariableCppName_27232, var_targetVariableCppName_27232, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 687)) ;
          }
          var_actualParameterList_24701.addAssign_operation (GALGAS_optionalMethodActualArgumentForGeneration::class_func_actualVarInput (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 694)).readProperty_mTypeName ().readProperty_string (), var_targetVariableCppName_27232  COMMA_SOURCE_FILE ("instruction-if.galgas", 694))  COMMA_SOURCE_FILE ("instruction-if.galgas", 694)) ;
          enumGalgasBool test_17 = kBoolTrue ;
          if (kBoolTrue == test_17) {
            test_17 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (enumerator_24750.current_mSelector (HERE).readProperty_string ())).boolEnum () ;
            if (kBoolTrue == test_17) {
              GALGAS_string temp_18 ;
              const enumGalgasBool test_19 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_19) {
                temp_18 = enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 696)) ;
              }else if (kBoolFalse == test_19) {
                temp_18 = GALGAS_string::makeEmptyString () ;
              }
              GALGAS_string var_s_27802 = GALGAS_string ("\?").add_operation (temp_18, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 696)) ;
              TC_Array <C_FixItDescription> fixItArray20 ;
              appendFixItActions (fixItArray20, kFixItReplace, var_s_27802) ;
              inCompiler->emitSemanticError (enumerator_24750.current_mSelector (HERE).readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_27802, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 697)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 697)), fixItArray20  COMMA_SOURCE_FILE ("instruction-if.galgas", 697)) ;
            }
          }
        }
        break ;
      case GALGAS_optionalMethodActualArgument::kEnum_actualInputJoker:
        {
          const cEnumAssociatedValues_optionalMethodActualArgument_actualInputJoker * extractPtr_28570 = (const cEnumAssociatedValues_optionalMethodActualArgument_actualInputJoker *) (enumerator_24750.current_mActualArgument (HERE).unsafePointer ()) ;
          const GALGAS_bool extractedValue_28019_checkSelector = extractPtr_28570->mAssociatedValue0 ;
          const GALGAS_location extractedValue_28033_location = extractPtr_28570->mAssociatedValue1 ;
          const GALGAS_uint extractedValue_28042_idx = extractPtr_28570->mAssociatedValue2 ;
          GALGAS_string var_targetVariableCppName_28061 = GALGAS_string ("var_unused_").add_operation (extractedValue_28042_idx.getter_string (SOURCE_FILE ("instruction-if.galgas", 700)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 700)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 700)).add_operation (extractedValue_28033_location.getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 700)).getter_string (SOURCE_FILE ("instruction-if.galgas", 700)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 700)) ;
          var_actualParameterList_24701.addAssign_operation (GALGAS_optionalMethodActualArgumentForGeneration::class_func_actualVarInput (extensionGetter_definition (enumerator_24827.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 701)).readProperty_mTypeName ().readProperty_string (), var_targetVariableCppName_28061  COMMA_SOURCE_FILE ("instruction-if.galgas", 701))  COMMA_SOURCE_FILE ("instruction-if.galgas", 701)) ;
          enumGalgasBool test_21 = kBoolTrue ;
          if (kBoolTrue == test_21) {
            GALGAS_bool test_22 = extractedValue_28019_checkSelector ;
            if (kBoolTrue == test_22.boolEnum ()) {
              test_22 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (enumerator_24750.current_mSelector (HERE).readProperty_string ())) ;
            }
            test_21 = test_22.boolEnum () ;
            if (kBoolTrue == test_21) {
              GALGAS_string temp_23 ;
              const enumGalgasBool test_24 = GALGAS_bool (kIsNotEqual, enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_24) {
                temp_23 = enumerator_24827.current_mFormalSelector (HERE).readProperty_string ().add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 703)) ;
              }else if (kBoolFalse == test_24) {
                temp_23 = GALGAS_string::makeEmptyString () ;
              }
              GALGAS_string var_s_28386 = GALGAS_string ("\?").add_operation (temp_23, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 703)) ;
              TC_Array <C_FixItDescription> fixItArray25 ;
              appendFixItActions (fixItArray25, kFixItReplace, var_s_28386) ;
              inCompiler->emitSemanticError (enumerator_24750.current_mSelector (HERE).readProperty_location (), GALGAS_string ("the selector should be '").add_operation (var_s_28386, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 704)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 704)), fixItArray25  COMMA_SOURCE_FILE ("instruction-if.galgas", 704)) ;
            }
          }
        }
        break ;
      }
      enumerator_24750.gotoNextObject () ;
      enumerator_24827.gotoNextObject () ;
    }
    ioArgument_ioTestListForGeneration.addAssign_operation (GALGAS_ifTestForGeneration::class_func_optionalMethodCall (var_receiverExpression_23493, constinArgument_inOptionalMethodName, var_actualParameterList_24701  COMMA_SOURCE_FILE ("instruction-if.galgas", 708))  COMMA_SOURCE_FILE ("instruction-if.galgas", 708)) ;
  }
}
...
void cPtr_ifInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
                                                                  ...
                                                                  Compiler * inCompiler
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_testVar_31647 = GALGAS_string ("test_").add_operation (ioArgument_ioTemporaryVariableIndex.getter_string (SOURCE_FILE ("instruction-if.galgas", 788)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 788)) ;
  ...
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("enumGalgasBool ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 790)).add_operation (GALGAS_string (" = kBoolTrue ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 790)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 790)) ;
  const GALGAS_ifInstructionForGeneration temp_0 = this ;
  cEnumerator_ifTestListForGeneration enumerator_31810 (temp_0.readProperty_mExpressions (), kENUMERATION_UP) ;
  while (enumerator_31810.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolTrue == ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 792)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 792)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 792)) ;
    {
    ...
    switch (enumerator_31810.current_mExpression (HERE).enumValue ()) {
    case GALGAS_ifTestForGeneration::kNotBuilt:
      break ;
    case GALGAS_ifTestForGeneration::kEnum_regular:
      {
        const cEnumAssociatedValues_ifTestForGeneration_regular * extractPtr_32239 = (const cEnumAssociatedValues_ifTestForGeneration_regular *) (enumerator_31810.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_31991_exp = extractPtr_32239->mAssociatedValue0 ;
        GALGAS_string var_cppVarName_32164 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_31991_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_32164, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 796)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(var_testVar_31647.add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 803)).add_operation (var_cppVarName_32164, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 803)).add_operation (GALGAS_string (".boolEnum () ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 803)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 803)) ;
      }
      break ;
    case GALGAS_ifTestForGeneration::kEnum_letExp:
      {
        const cEnumAssociatedValues_ifTestForGeneration_letExp * extractPtr_32984 = (const cEnumAssociatedValues_ifTestForGeneration_letExp *) (enumerator_31810.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_string extractedValue_32275_targetVarCppName = extractPtr_32984->mAssociatedValue0 ;
        const GALGAS_semanticExpressionForGeneration extractedValue_32292_exp = extractPtr_32984->mAssociatedValue1 ;
        const GALGAS_unifiedTypeMapEntry extractedValue_32296_targetType = extractPtr_32984->mAssociatedValue2 ;
        const GALGAS_unifiedTypeMapEntry extractedValue_32307_testType = extractPtr_32984->mAssociatedValue3 ;
        GALGAS_string var_targetTypeName_32329 = extensionGetter_identifierRepresentation (extractedValue_32296_targetType, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 805)) ;
        GALGAS_string var_testTypeName_32394 = extensionGetter_identifierRepresentation (extractedValue_32307_testType, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 806)) ;
        GALGAS_string var_cppVarName_32611 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_32292_exp.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_32611, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 807)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (var_targetTypeName_32329, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 814)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 814)).add_operation (extractedValue_32275_targetVarCppName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 814)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 814)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (" (dynamic_cast <const cPtr_").add_operation (var_testTypeName_32394, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 815)).add_operation (GALGAS_string (" *> ("), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 815)).add_operation (var_cppVarName_32611, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 815)).add_operation (GALGAS_string (".ptr ())) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 815)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 815)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (nullptr == ").add_operation (extractedValue_32275_targetVarCppName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 816)).add_operation (GALGAS_string (".ptr ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 816)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 816)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 817)).add_operation (GALGAS_string (" = kBoolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 817)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 817)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("}\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 818)) ;
      }
      break ;
    case GALGAS_ifTestForGeneration::kEnum_optionalMethodCall:
      {
        const cEnumAssociatedValues_ifTestForGeneration_optionalMethodCall * extractPtr_34720 = (const cEnumAssociatedValues_ifTestForGeneration_optionalMethodCall *) (enumerator_31810.current_mExpression (HERE).unsafePointer ()) ;
        const GALGAS_semanticExpressionForGeneration extractedValue_33019_receiverExpression = extractPtr_34720->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_33038_optionalMethodName = extractPtr_34720->mAssociatedValue1 ;
        const GALGAS_optionalMethodActualArgumentListForGeneration extractedValue_33057_parameters = extractPtr_34720->mAssociatedValue2 ;
        GALGAS_string var_cppVarName_33252 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_33019_receiverExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_33252, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 820)) ;
        GALGAS_stringlist var_actualParameterNameList_33293 = GALGAS_stringlist::class_func_emptyList (SOURCE_FILE ("instruction-if.galgas", 827)) ;
        cEnumerator_optionalMethodActualArgumentListForGeneration enumerator_33333 (extractedValue_33057_parameters, kENUMERATION_UP) ;
        while (enumerator_33333.hasCurrentObject ()) {
          switch (enumerator_33333.current_mParameter (HERE).enumValue ()) {
          ...
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualOutput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualOutput * extractPtr_33690 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualOutput *) (enumerator_33333.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_semanticExpressionForGeneration extractedValue_33413_expression = extractPtr_33690->mAssociatedValue0 ;
              GALGAS_string var_argumentCppName_33624 ;
              callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_33413_expression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_argumentCppName_33624, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 831)) ;
              var_actualParameterNameList_33293.addAssign_operation (var_argumentCppName_33624  COMMA_SOURCE_FILE ("instruction-if.galgas", 838)) ;
            }
            break ;
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualLetInput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualLetInput * extractPtr_33911 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualLetInput *) (enumerator_33333.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_string extractedValue_33735_typeName = extractPtr_33911->mAssociatedValue0 ;
              const GALGAS_string extractedValue_33744_constantName = extractPtr_33911->mAssociatedValue1 ;
              var_actualParameterNameList_33293.addAssign_operation (extractedValue_33744_constantName  COMMA_SOURCE_FILE ("instruction-if.galgas", 840)) ;
              ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (extractedValue_33735_typeName.getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 841)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 841)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 841)).add_operation (extractedValue_33744_constantName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 841)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 841)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 841)) ;
            }
            break ;
          case GALGAS_optionalMethodActualArgumentForGeneration::kEnum_actualVarInput:
            {
              const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualVarInput * extractPtr_34123 = (const cEnumAssociatedValues_optionalMethodActualArgumentForGeneration_actualVarInput *) (enumerator_33333.current_mParameter (HERE).unsafePointer ()) ;
              const GALGAS_string extractedValue_33947_typeName = extractPtr_34123->mAssociatedValue0 ;
              const GALGAS_string extractedValue_33956_variableName = extractPtr_34123->mAssociatedValue1 ;
              var_actualParameterNameList_33293.addAssign_operation (extractedValue_33956_variableName  COMMA_SOURCE_FILE ("instruction-if.galgas", 843)) ;
              ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (extractedValue_33947_typeName.getter_identifierRepresentation (SOURCE_FILE ("instruction-if.galgas", 844)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 844)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 844)).add_operation (extractedValue_33956_variableName, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 844)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 844)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 844)) ;
            }
            break ;
          }
          enumerator_33333.gotoNextObject () ;
        }
        GALGAS_string var_boolResultName_34162 = GALGAS_string ("optionalResult").add_operation (extractedValue_33038_optionalMethodName.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 847)).getter_string (SOURCE_FILE ("instruction-if.galgas", 847)), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 847)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("const bool ").add_operation (var_boolResultName_34162, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 848)).add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 848)).add_operation (var_cppVarName_33252, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 848)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 848)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (".optional_").add_operation (extractedValue_33038_optionalMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 849)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 849)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 849)) ;
        cEnumerator_stringlist enumerator_34392 (var_actualParameterNameList_33293, kENUMERATION_UP) ;
        while (enumerator_34392.hasCurrentObject ()) {
          ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_34392.current_mValue (HERE), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 852)) ;
          if (enumerator_34392.hasNextObject ()) {
        ...
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (!").add_operation (var_boolResultName_34162, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 857)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 857)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 857)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)).add_operation (GALGAS_string (" = kBoolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 858)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 858)) ;
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("}\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 859)) ;
      }
      break ;
    }
    enumerator_31810.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolTrue == ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 863)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 863)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 863)) ;
  {
  ...
  cEnumerator_ifTestListForGeneration enumerator_35071 (temp_2.readProperty_mExpressions (), kENUMERATION_UP) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    if (kBoolTrue == test_3) {
      ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (kBoolFalse == ").add_operation (var_testVar_31647, inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 879)).add_operation (GALGAS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-if.galgas", 879)), inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 879)) ;
      {
...
void cPtr_terminalCheckInstruction::method_transformInstruction (GALGAS_terminalSymbolsMapForGrammarAnalysis & ioArgument_ioActuallyUsedTerminalSymbolMap,
                                                                 ...
                                                                 Compiler * inCompiler
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint var_terminalSymbolIndex_7242 ;
  const GALGAS_terminalCheckInstruction temp_0 = this ;
  const cMapElement_terminalSymbolsMapForGrammarAnalysis * objectArray_7266 = (const cMapElement_terminalSymbolsMapForGrammarAnalysis *) ioArgument_ioActuallyUsedTerminalSymbolMap.readAccessForWithInstruction (temp_0.readProperty_mTerminalName ().readProperty_string ()) ;
  if (nullptr != objectArray_7266) {
      macroValidSharedObject (objectArray_7266, cMapElement_terminalSymbolsMapForGrammarAnalysis) ;
    var_terminalSymbolIndex_7242 = objectArray_7266->mProperty_mTerminalIndex ;
  }else{
    var_terminalSymbolIndex_7242 = ioArgument_ioActuallyUsedTerminalSymbolMap.getter_count (SOURCE_FILE ("instruction-terminal.galgas", 158)) ;
    {
    const GALGAS_terminalCheckInstruction temp_1 = this ;
    ioArgument_ioActuallyUsedTerminalSymbolMap.setter_insertKey (temp_1.readProperty_mTerminalName (), var_terminalSymbolIndex_7242, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 159)) ;
    }
  }
  const GALGAS_terminalCheckInstruction temp_2 = this ;
  const GALGAS_terminalCheckInstruction temp_3 = this ;
  ioArgument_ioSyntaxInstructionList.addAssign_operation (GALGAS_terminalInstructionForGrammarAnalysis::class_func_new (temp_2.readProperty_mInstructionLocation (), temp_3.readProperty_mTerminalName (), var_terminalSymbolIndex_7242  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 161))  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 161)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_terminalCheckInstruction::method_analyzeSyntaxInstruction (const GALGAS_lstring /* constinArgument_inUsefulnessCallerEntityName */,
                                                                     ...
                                                                     Compiler * inCompiler
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalSentValueList var_sentAttributeList_8565 ;
  const GALGAS_terminalCheckInstruction temp_0 = this ;
  constinArgument_inTerminalMap.method_searchKey (temp_0.readProperty_mTerminalName (), var_sentAttributeList_8565, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 184)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_terminalCheckInstruction temp_2 = this ;
    test_1 = GALGAS_bool (kIsNotEqual, temp_2.readProperty_mActualInputParameterList ().getter_count (SOURCE_FILE ("instruction-terminal.galgas", 186)).objectCompare (var_sentAttributeList_8565.getter_count (SOURCE_FILE ("instruction-terminal.galgas", 186)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      const GALGAS_terminalCheckInstruction temp_3 = this ;
      const GALGAS_terminalCheckInstruction temp_4 = this ;
      GALGAS_string temp_5 ;
      const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_sentAttributeList_8565.getter_count (SOURCE_FILE ("instruction-terminal.galgas", 189)).objectCompare (GALGAS_uint (uint32_t (1U)))).boolEnum () ;
      if (kBoolTrue == test_6) {
  ...
  while (enumerator_9197.hasCurrentObject () && enumerator_9295.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_13) {
      ...
      if (kBoolTrue == test_13) {
        ...
        TC_Array <C_FixItDescription> fixItArray16 ;
        inCompiler->emitSemanticError (enumerator_9197.current_mActualSelector (HERE).readProperty_location (), GALGAS_string ("the actual selector should be '\?").add_operation (enumerator_9295.current_mLexicalFormalSelector (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 206)).add_operation (temp_14, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 206)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 206)), fixItArray16  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 206)) ;
        TC_Array <C_FixItDescription> fixItArray17 ;
        inCompiler->emitSemanticWarning (enumerator_9295.current_mLexicalFormalSelector (HERE).readProperty_location (), GALGAS_string ("the formal selector is declared here"), fixItArray17  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 207)) ;
      }
    }
  ...
  cEnumerator__32_lstringlist enumerator_9901 (temp_18.readProperty_mIndexingKeyList (), kENUMERATION_UP) ;
  while (enumerator_9901.hasCurrentObject ()) {
    enumGalgasBool test_19 = kBoolTrue ;
    if (kBoolTrue == test_19) {
      test_19 = constinArgument_inIndexNameSet.getter_hasKey (enumerator_9901.current_mValue_30_ (HERE).readProperty_string () COMMA_SOURCE_FILE ("instruction-terminal.galgas", 212)).operator_not (SOURCE_FILE ("instruction-terminal.galgas", 212)).boolEnum () ;
      if (kBoolTrue == test_19) {
        TC_Array <C_FixItDescription> fixItArray20 ;
        appendFixItActions (fixItArray20, kFixItReplace, constinArgument_inIndexNameSet) ;
        inCompiler->emitSemanticError (enumerator_9901.current_mValue_30_ (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_9901.current_mValue_30_ (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 213)).add_operation (GALGAS_string ("' indexing name is not declared by the lexique"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 213)), fixItArray20  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 213)) ;
      }
    }
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_terminalCheckInstructionForGeneration::class_func_new (temp_23.readProperty_mInstructionLocation (), temp_24.readProperty_mTerminalName (), constinArgument_inLexiqueName, var_terminalCheckAssignementList_9108, temp_25.readProperty_mIndexingKeyList (), temp_26.readProperty_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor (), temp_27.readProperty_mGrammarInstructionSyntaxDirectedTranslationToken ()  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 230))  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 230)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_terminalCheckInstructionForGeneration::method_appendSyntaxSignature (const GALGAS_string /* constinArgument_inPosfix */,
  ...
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_terminalCheckInstructionForGeneration::class_func_new (temp_0.readProperty_mInstructionLocation (), temp_1.readProperty_mTerminalName (), temp_2.readProperty_mLexiqueIdentifier (), GALGAS_terminalCheckAssignementList::class_func_emptyList (SOURCE_FILE ("instruction-terminal.galgas", 270)), temp_3.readProperty_mIndexingKeyList (), GALGAS_grammarInstructionSyntaxDirectedTranslationResultNone::class_func_new (SOURCE_FILE ("instruction-terminal.galgas", 272)), GALGAS_grammarInstructionSyntaxDirectedTranslationResultNone::class_func_new (SOURCE_FILE ("instruction-terminal.galgas", 273))  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 266))  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 266)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
GALGAS_bool cPtr_terminalCheckInstructionForGeneration::getter_compareInstructionSyntaxSignature (const GALGAS_semanticInstructionForGeneration constinArgument_inTestedInstruction,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    GALGAS_terminalCheckInstructionForGeneration var_si_13095 (dynamic_cast <const cPtr_terminalCheckInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) ;
    if (nullptr == var_si_13095.ptr ()) {
      test_0 = kBoolFalse ;
    }
    if (kBoolTrue == test_0) {
      const GALGAS_terminalCheckInstructionForGeneration temp_1 = this ;
      result_result = GALGAS_bool (kIsEqual, temp_1.readProperty_mTerminalName ().readProperty_string ().objectCompare (var_si_13095.readProperty_mTerminalName ().readProperty_string ())) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = result_result.operator_not (SOURCE_FILE ("instruction-terminal.galgas", 285)).boolEnum () ;
        if (kBoolTrue == test_2) {
          const GALGAS_terminalCheckInstructionForGeneration temp_3 = this ;
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (var_si_13095.readProperty_mInstructionLocation (), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").add_operation (temp_3.readProperty_mTerminalName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 287)).add_operation (GALGAS_string ("$' terminal check"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 287)), fixItArray4  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 286)) ;
        }
      }
    }
  }
  if (kBoolFalse == test_0) {
    enumGalgasBool test_5 = kBoolTrue ;
    if (kBoolTrue == test_5) {
      GALGAS_syntaxInstructionForGeneration var_si_13435 (dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) ;
      if (nullptr == var_si_13435.ptr ()) {
        test_5 = kBoolFalse ;
      }
      if (kBoolTrue == test_5) {
        const GALGAS_terminalCheckInstructionForGeneration temp_6 = this ;
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (var_si_13435.readProperty_mInstructionLocation (), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").add_operation (temp_6.readProperty_mTerminalName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 291)).add_operation (GALGAS_string ("$' terminal check"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 291)), fixItArray7  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 290)) ;
        result_result = GALGAS_bool (false) ;
      }
    }
    if (kBoolFalse == test_5) {
      ...
      TC_Array <C_FixItDescription> fixItArray9 ;
      inCompiler->emitSemanticError (temp_8.readProperty_mInstructionLocation (), GALGAS_string ("internal error"), fixItArray9  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 294)) ;
      result_result = GALGAS_bool (false) ;
    }
  }
  enumGalgasBool test_10 = kBoolTrue ;
  if (kBoolTrue == test_10) {
    test_10 = result_result.operator_not (SOURCE_FILE ("instruction-terminal.galgas", 297)).boolEnum () ;
    if (kBoolTrue == test_10) {
      const GALGAS_terminalCheckInstructionForGeneration temp_11 = this ;
      TC_Array <C_FixItDescription> fixItArray12 ;
      inCompiler->emitSemanticError (temp_11.readProperty_mInstructionLocation (), GALGAS_string ("reference syntax instruction is here"), fixItArray12  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 298)) ;
    }
  }
//---
  return result_result ;
...
void cPtr_terminalCheckInstructionForGeneration::method_generateInstruction (GALGAS_stringset & /* ioArgument_ioInclusionSet */,
                                                                             ...
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_terminalCheckInstructionForGeneration temp_0 = this ;
  cEnumerator_terminalCheckAssignementList enumerator_14475 (temp_0.readProperty_mTerminalCheckAssignementList (), kENUMERATION_UP) ;
  while (enumerator_14475.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, enumerator_14475.current_mTypeName (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("GALGAS_").add_operation (enumerator_14475.current_mTypeName (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 316)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 316)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 316)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 316)) ;
      }
    }
    ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_14475.current_mTargetVarCppName (HERE).add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 319)).add_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 319)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 319)).add_operation (GALGAS_string ("->synthetizedAttribute_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 319)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 319)) ;
    ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_14475.current_mSourceLexicalAttributeName (HERE).getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 320)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 320)) ;
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (" () ;\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 321)) ;
    enumerator_14475.gotoNextObject () ;
  }
  const GALGAS_terminalCheckInstructionForGeneration temp_2 = this ;
  cEnumerator__32_lstringlist enumerator_14914 (temp_2.readProperty_mIndexingKeyList (), kENUMERATION_UP) ;
  while (enumerator_14914.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssign_operation(function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 325)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 325)) ;
    const GALGAS_terminalCheckInstructionForGeneration temp_3 = this ;
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("->enterIndexing (Lexique_").add_operation (temp_3.readProperty_mLexiqueIdentifier (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 326)).add_operation (GALGAS_string ("::kIndexing_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 326)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 326)) ;
    ioArgument_ioGeneratedCode.plusAssign_operation(enumerator_14914.current_mValue_30_ (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 327)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 327)) ;
    ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string (", ").add_operation (enumerator_14914.current_mValue_31_ (HERE).readProperty_string ().getter_utf_38_RepresentationEscapingQuestionMark (SOURCE_FILE ("instruction-terminal.galgas", 328)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 328)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 328)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 328)) ;
    enumerator_14914.gotoNextObject () ;
  }
  const GALGAS_terminalCheckInstructionForGeneration temp_4 = this ;
  callExtensionMethod_generateCode ((cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) temp_4.readProperty_mGrammarInstructionSyntaxDirectedTranslationPreceedingDelimitor ().ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->separatorString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 331)) ;
  const GALGAS_terminalCheckInstructionForGeneration temp_5 = this ;
  callExtensionMethod_generateCode ((cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult *) temp_5.readProperty_mGrammarInstructionSyntaxDirectedTranslationToken ().ptr (), constinArgument_inGenerateSyntaxDirectedTranslationString, GALGAS_string ("inCompiler->tokenString ()"), ioArgument_ioUnusedVariableCppNameSet, ioArgument_ioGeneratedCode, inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 337)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 344)) COMMA_SOURCE_FILE ("instruction-terminal.galgas", 344)) ;
  }
  ioArgument_ioGeneratedCode.plusAssign_operation(function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 345)).add_operation (GALGAS_string ("->acceptTerminal (Lexique_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 345)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 345)) ;
  const GALGAS_terminalCheckInstructionForGeneration temp_6 = this ;
  const GALGAS_terminalCheckInstructionForGeneration temp_7 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(temp_6.readProperty_mLexiqueIdentifier ().add_operation (GALGAS_string ("::kToken_"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 346)).add_operation (temp_7.readProperty_mTerminalName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-terminal.galgas", 346)), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 346)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 346)) ;
  const GALGAS_terminalCheckInstructionForGeneration temp_8 = this ;
  ioArgument_ioGeneratedCode.plusAssign_operation(extensionGetter_commaSourceFile (temp_8.readProperty_mInstructionLocation (), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 347)).add_operation (GALGAS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-terminal.galgas", 347)), inCompiler  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 347)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_syntaxSendInstruction::method_analyzeSyntaxInstruction (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("instruction-syntax-send.galgas", 99)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_syntaxSendInstruction temp_1 = this ;
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (temp_1.readProperty_mInstructionLocation (), GALGAS_string ("'send' instruction is only allowed when syntax componant has 'translate' feature"), fixItArray2  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 100)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_expression_5092 ;
  const GALGAS_syntaxSendInstruction temp_3 = this ;
  callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) temp_3.readProperty_mExpression ().ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, GALGAS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-syntax-send.galgas", 106)), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_expression_5092, inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 103)) ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = GALGAS_bool (kIsNotEqual, var_expression_5092.readProperty_mResultType ().objectCompare (constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mStringType ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const GALGAS_syntaxSendInstruction temp_5 = this ;
      TC_Array <C_FixItDescription> fixItArray6 ;
      inCompiler->emitSemanticError (temp_5.readProperty_mInstructionLocation (), GALGAS_string ("'send' expresion should be an @string expression"), fixItArray6  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 114)) ;
    }
  }
  const GALGAS_syntaxSendInstruction temp_7 = this ;
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_syntaxSendInstructionForGeneration::class_func_new (temp_7.readProperty_mInstructionLocation (), var_expression_5092  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 117))  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 117)) ;
}
//--------------------------------------------------------------------------------------------------
//
...
void cPtr_syntaxSendInstructionForGeneration::method_generateInstruction (GALGAS_stringset & ioArgument_ioInclusionSet,
                                                                          ...
                                                                          Compiler * inCompiler
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_sourceVar_6516 ;
  const GALGAS_syntaxSendInstructionForGeneration temp_0 = this ;
  callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) temp_0.readProperty_mExpression ().ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_sourceVar_6516, inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 142)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.setter_removeKey (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 144)) COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 144)) ;
  }
  ioArgument_ioGeneratedCode.plusAssign_operation(GALGAS_string ("if (").add_operation (var_sourceVar_6516, inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 145)).add_operation (GALGAS_string (".isValid ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 145)).add_operation (GALGAS_string ("  "), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 145)).add_operation (function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)).add_operation (GALGAS_string (".addString ("), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)).add_operation (var_sourceVar_6516, inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)).add_operation (GALGAS_string (".stringValue ()) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)).add_operation (GALGAS_string ("}\n"), inCompiler COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 146)), inCompiler  COMMA_SOURCE_FILE ("instruction-syntax-send.galgas", 145)) ;
}
//--------------------------------------------------------------------------------------------------
//
