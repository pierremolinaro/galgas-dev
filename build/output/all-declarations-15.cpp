...
GALGAS_enumConstantListForGeneration GALGAS_enumTypeForGeneration_2D_weak::getter_mConstantList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_enumConstantListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_enumTypeForGeneration * objectPtr = (cPtr_enumTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_enumTypeForGeneration) ;
...
void GALGAS_enumTypeForGeneration_2D_weak::setter_setMConstantList (const GALGAS_enumConstantListForGeneration inValue,
                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_enumTypeForGeneration * objectPtr = (cPtr_enumTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_enumTypeForGeneration) ;
...
GALGAS_lstring GALGAS_externTypeDeclarationAST_2D_weak::getter_mExternTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mExternTypeName ;
    }
  }
  return result ;
}
...
GALGAS_string GALGAS_externTypeDeclarationAST_2D_weak::getter_mCppPreDeclarationCode (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mCppPreDeclarationCode ;
    }
  }
  return result ;
}
...
GALGAS_string GALGAS_externTypeDeclarationAST_2D_weak::getter_mCppClassCode (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mCppClassCode ;
    }
  }
  return result ;
}
...
GALGAS_externTypeConstructorList GALGAS_externTypeDeclarationAST_2D_weak::getter_mExternTypeConstructorList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_externTypeConstructorList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mExternTypeConstructorList ;
    }
  }
  return result ;
}
...
GALGAS_externTypeGetterList GALGAS_externTypeDeclarationAST_2D_weak::getter_mExternTypeGetterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_externTypeGetterList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mExternTypeGetterList ;
    }
  }
  return result ;
}
...
GALGAS_externTypeSetterList GALGAS_externTypeDeclarationAST_2D_weak::getter_mExternTypeSetterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_externTypeSetterList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mExternTypeSetterList ;
    }
  }
  return result ;
}
...
GALGAS_externTypeMethodList GALGAS_externTypeDeclarationAST_2D_weak::getter_mExternTypeMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_externTypeMethodList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      result = objectPtr->mProperty_mExternTypeMethodList ;
    }
  }
  return result ;
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMExternTypeName (const GALGAS_lstring inValue,
                                                                         C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mExternTypeName = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMCppPreDeclarationCode (const GALGAS_string inValue,
                                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mCppPreDeclarationCode = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMCppClassCode (const GALGAS_string inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mCppClassCode = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMExternTypeConstructorList (const GALGAS_externTypeConstructorList inValue,
                                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mExternTypeConstructorList = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMExternTypeGetterList (const GALGAS_externTypeGetterList inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mExternTypeGetterList = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMExternTypeSetterList (const GALGAS_externTypeSetterList inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mExternTypeSetterList = inValue ;
    }
  }
}
...
void GALGAS_externTypeDeclarationAST_2D_weak::setter_setMExternTypeMethodList (const GALGAS_externTypeMethodList inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationAST * objectPtr = (cPtr_externTypeDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationAST) ;
      objectPtr->mProperty_mExternTypeMethodList = inValue ;
    }
  }
}
...
GALGAS_string GALGAS_externTypeDeclarationForGeneration_2D_weak::getter_mExternTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationForGeneration) ;
      result = objectPtr->mProperty_mExternTypeName ;
    }
  }
  return result ;
...
GALGAS_string GALGAS_externTypeDeclarationForGeneration_2D_weak::getter_mCppPreDeclarationCode (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
...
GALGAS_string GALGAS_externTypeDeclarationForGeneration_2D_weak::getter_mCppClassCode (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
...
void GALGAS_externTypeDeclarationForGeneration_2D_weak::setter_setMExternTypeName (const GALGAS_string inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_externTypeDeclarationForGeneration) ;
...
void GALGAS_externTypeDeclarationForGeneration_2D_weak::setter_setMCppPreDeclarationCode (const GALGAS_string inValue,
                                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
...
void GALGAS_externTypeDeclarationForGeneration_2D_weak::setter_setMCppClassCode (const GALGAS_string inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_externTypeDeclarationForGeneration * objectPtr = (cPtr_externTypeDeclarationForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_graphDeclarationAST_2D_weak::getter_mGraphTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      result = objectPtr->mProperty_mGraphTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_graphDeclarationAST_2D_weak::getter_mAssociatedListTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      result = objectPtr->mProperty_mAssociatedListTypeName ;
    }
  }
  return result ;
}
...
GALGAS_graphInsertModifierList GALGAS_graphDeclarationAST_2D_weak::getter_mInsertModifierList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_graphInsertModifierList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      result = objectPtr->mProperty_mInsertModifierList ;
    }
  }
  return result ;
}
...
void GALGAS_graphDeclarationAST_2D_weak::setter_setMGraphTypeName (const GALGAS_lstring inValue,
                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      objectPtr->mProperty_mGraphTypeName = inValue ;
    }
  }
}
...
void GALGAS_graphDeclarationAST_2D_weak::setter_setMAssociatedListTypeName (const GALGAS_lstring inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      objectPtr->mProperty_mAssociatedListTypeName = inValue ;
    }
  }
}
...
void GALGAS_graphDeclarationAST_2D_weak::setter_setMInsertModifierList (const GALGAS_graphInsertModifierList inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationAST * objectPtr = (cPtr_graphDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationAST) ;
      objectPtr->mProperty_mInsertModifierList = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_graphDeclarationForGeneration_2D_weak::getter_mAssociatedListTypeEntry (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationForGeneration) ;
      result = objectPtr->mProperty_mAssociatedListTypeEntry ;
    }
  }
  return result ;
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_graphDeclarationForGeneration_2D_weak::getter_mAssociatedListElementTypeEntry (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationForGeneration) ;
      result = objectPtr->mProperty_mAssociatedListElementTypeEntry ;
    }
  }
  return result ;
}
...
GALGAS_graphInsertModifierList GALGAS_graphDeclarationForGeneration_2D_weak::getter_mInsertModifierList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_graphInsertModifierList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
...
void GALGAS_graphDeclarationForGeneration_2D_weak::setter_setMAssociatedListTypeEntry (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationForGeneration) ;
      objectPtr->mProperty_mAssociatedListTypeEntry = inValue ;
    }
  }
}
...
void GALGAS_graphDeclarationForGeneration_2D_weak::setter_setMAssociatedListElementTypeEntry (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                              C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_graphDeclarationForGeneration) ;
      objectPtr->mProperty_mAssociatedListElementTypeEntry = inValue ;
    }
  }
}
...
void GALGAS_graphDeclarationForGeneration_2D_weak::setter_setMInsertModifierList (const GALGAS_graphInsertModifierList inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_graphDeclarationForGeneration * objectPtr = (cPtr_graphDeclarationForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_listDeclarationAST_2D_weak::getter_mListTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listDeclarationAST * objectPtr = (cPtr_listDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listDeclarationAST) ;
      result = objectPtr->mProperty_mListTypeName ;
    }
  }
  return result ;
}
...
GALGAS_propertyInCollectionListAST GALGAS_listDeclarationAST_2D_weak::getter_mPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listDeclarationAST * objectPtr = (cPtr_listDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_listDeclarationAST_2D_weak::setter_setMListTypeName (const GALGAS_lstring inValue,
                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listDeclarationAST * objectPtr = (cPtr_listDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listDeclarationAST) ;
      objectPtr->mProperty_mListTypeName = inValue ;
    }
  }
}
...
void GALGAS_listDeclarationAST_2D_weak::setter_setMPropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listDeclarationAST * objectPtr = (cPtr_listDeclarationAST *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_listTypeForGeneration_2D_weak::getter_mListElementTypeIndex (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listTypeForGeneration * objectPtr = (cPtr_listTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listTypeForGeneration) ;
      result = objectPtr->mProperty_mListElementTypeIndex ;
    }
  }
  return result ;
}
...
GALGAS_typedPropertyList GALGAS_listTypeForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listTypeForGeneration * objectPtr = (cPtr_listTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_listTypeForGeneration_2D_weak::setter_setMListElementTypeIndex (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listTypeForGeneration * objectPtr = (cPtr_listTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listTypeForGeneration) ;
      objectPtr->mProperty_mListElementTypeIndex = inValue ;
    }
  }
}
...
void GALGAS_listTypeForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listTypeForGeneration * objectPtr = (cPtr_listTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_listmapDeclarationAST_2D_weak::getter_mListmapTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listmapDeclarationAST * objectPtr = (cPtr_listmapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listmapDeclarationAST) ;
      result = objectPtr->mProperty_mListmapTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_listmapDeclarationAST_2D_weak::getter_mAssociatedListTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listmapDeclarationAST * objectPtr = (cPtr_listmapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_listmapDeclarationAST_2D_weak::setter_setMListmapTypeName (const GALGAS_lstring inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listmapDeclarationAST * objectPtr = (cPtr_listmapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listmapDeclarationAST) ;
      objectPtr->mProperty_mListmapTypeName = inValue ;
    }
  }
}
...
void GALGAS_listmapDeclarationAST_2D_weak::setter_setMAssociatedListTypeName (const GALGAS_lstring inValue,
                                                                              C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listmapDeclarationAST * objectPtr = (cPtr_listmapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_listmapTypeForGeneration_2D_weak::getter_mAssociatedListTypeIndex (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      result = objectPtr->mProperty_mAssociatedListTypeIndex ;
    }
  }
  return result ;
}
...
GALGAS_typedPropertyList GALGAS_listmapTypeForGeneration_2D_weak::getter_mAssociatedListTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      result = objectPtr->mProperty_mAssociatedListTypedAttributeList ;
    }
  }
  return result ;
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_listmapTypeForGeneration_2D_weak::getter_mAssociatedListMapElementTypeIndex (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      result = objectPtr->mProperty_mAssociatedListMapElementTypeIndex ;
    }
  }
  return result ;
}
...
void GALGAS_listmapTypeForGeneration_2D_weak::setter_setMAssociatedListTypeIndex (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      objectPtr->mProperty_mAssociatedListTypeIndex = inValue ;
    }
  }
}
...
void GALGAS_listmapTypeForGeneration_2D_weak::setter_setMAssociatedListTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                                           C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      objectPtr->mProperty_mAssociatedListTypedAttributeList = inValue ;
    }
  }
}
...
void GALGAS_listmapTypeForGeneration_2D_weak::setter_setMAssociatedListMapElementTypeIndex (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_listmapTypeForGeneration * objectPtr = (cPtr_listmapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_listmapTypeForGeneration) ;
      objectPtr->mProperty_mAssociatedListMapElementTypeIndex = inValue ;
    }
  }
}
...
GALGAS_lstring GALGAS_dictDeclarationAST_2D_weak::getter_mDictTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      result = objectPtr->mProperty_mDictTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_dictDeclarationAST_2D_weak::getter_mKeyTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      result = objectPtr->mProperty_mKeyTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_dictDeclarationAST_2D_weak::getter_mAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      result = objectPtr->mProperty_mAttributeList ;
    }
  }
  return result ;
}
...
GALGAS_propertyInCollectionListAST GALGAS_dictDeclarationAST_2D_weak::getter_mPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_dictDeclarationAST_2D_weak::setter_setMDictTypeName (const GALGAS_lstring inValue,
                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      objectPtr->mProperty_mDictTypeName = inValue ;
    }
  }
}
...
void GALGAS_dictDeclarationAST_2D_weak::setter_setMKeyTypeName (const GALGAS_lstring inValue,
                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      objectPtr->mProperty_mKeyTypeName = inValue ;
    }
  }
}
...
void GALGAS_dictDeclarationAST_2D_weak::setter_setMAttributeList (const GALGAS_lstringlist inValue,
                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_dictDeclarationAST) ;
      objectPtr->mProperty_mAttributeList = inValue ;
    }
  }
}
...
void GALGAS_dictDeclarationAST_2D_weak::setter_setMPropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictDeclarationAST * objectPtr = (cPtr_dictDeclarationAST *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_dictTypeForGeneration_2D_weak::getter_mElementTypeEntry (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_dictTypeForGeneration) ;
...
GALGAS_lstring GALGAS_dictTypeForGeneration_2D_weak::getter_mDictTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_typedPropertyList GALGAS_dictTypeForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_dictTypeForGeneration_2D_weak::getter_mKeyTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_dictTypeForGeneration_2D_weak::setter_setMElementTypeEntry (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_dictTypeForGeneration) ;
...
void GALGAS_dictTypeForGeneration_2D_weak::setter_setMDictTypeName (const GALGAS_lstring inValue,
                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_dictTypeForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_dictTypeForGeneration_2D_weak::setter_setMKeyTypeName (const GALGAS_lstring inValue,
                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_dictTypeForGeneration * objectPtr = (cPtr_dictTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_mapDeclarationAST_2D_weak::getter_mMapTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      result = objectPtr->mProperty_mMapTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_mapDeclarationAST_2D_weak::getter_mAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_propertyInCollectionListAST GALGAS_mapDeclarationAST_2D_weak::getter_mPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_insertMethodListAST GALGAS_mapDeclarationAST_2D_weak::getter_mInsertMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_insertMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      result = objectPtr->mProperty_mInsertMethodList ;
    }
  }
  return result ;
}
...
GALGAS_mapSearchMethodListAST GALGAS_mapDeclarationAST_2D_weak::getter_mSearchMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapSearchMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      result = objectPtr->mProperty_mSearchMethodList ;
    }
  }
  return result ;
}
...
GALGAS_mapRemoveMethodListAST GALGAS_mapDeclarationAST_2D_weak::getter_mRemoveMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapRemoveMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      result = objectPtr->mProperty_mRemoveMethodList ;
    }
  }
  return result ;
}
...
GALGAS_insertOrReplaceDeclarationListAST GALGAS_mapDeclarationAST_2D_weak::getter_mInsertOrReplaceDeclarationListAST (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_insertOrReplaceDeclarationListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      result = objectPtr->mProperty_mInsertOrReplaceDeclarationListAST ;
    }
  }
  return result ;
}
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMMapTypeName (const GALGAS_lstring inValue,
                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      objectPtr->mProperty_mMapTypeName = inValue ;
    }
  }
}
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMAttributeList (const GALGAS_lstringlist inValue,
                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMPropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMInsertMethodList (const GALGAS_insertMethodListAST inValue,
                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      objectPtr->mProperty_mInsertMethodList = inValue ;
    }
  }
}
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMSearchMethodList (const GALGAS_mapSearchMethodListAST inValue,
                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      objectPtr->mProperty_mSearchMethodList = inValue ;
    }
  }
}
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMRemoveMethodList (const GALGAS_mapRemoveMethodListAST inValue,
                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      objectPtr->mProperty_mRemoveMethodList = inValue ;
    }
  }
}
...
void GALGAS_mapDeclarationAST_2D_weak::setter_setMInsertOrReplaceDeclarationListAST (const GALGAS_insertOrReplaceDeclarationListAST inValue,
                                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapDeclarationAST * objectPtr = (cPtr_mapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapDeclarationAST) ;
      objectPtr->mProperty_mInsertOrReplaceDeclarationListAST = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_mapTypeForGeneration_2D_weak::getter_mElementTypeEntry (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
      result = objectPtr->mProperty_mElementTypeEntry ;
    }
  }
  return result ;
...
GALGAS_lstring GALGAS_mapTypeForGeneration_2D_weak::getter_mMapTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_typedPropertyList GALGAS_mapTypeForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_insertMethodListAST GALGAS_mapTypeForGeneration_2D_weak::getter_mInsertMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_insertMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_mapSearchMethodListAST GALGAS_mapTypeForGeneration_2D_weak::getter_mSearchMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapSearchMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_mapRemoveMethodListAST GALGAS_mapTypeForGeneration_2D_weak::getter_mRemoveMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapRemoveMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_bool GALGAS_mapTypeForGeneration_2D_weak::getter_mHasInsertOrReplaceModifier (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
      result = objectPtr->mProperty_mHasInsertOrReplaceModifier ;
    }
  }
  return result ;
}
...
GALGAS_bool GALGAS_mapTypeForGeneration_2D_weak::getter_mActivateSuggestions (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
      result = objectPtr->mProperty_mActivateSuggestions ;
    }
  }
  return result ;
}
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMElementTypeEntry (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMMapTypeName (const GALGAS_lstring inValue,
                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                         C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMInsertMethodList (const GALGAS_insertMethodListAST inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMSearchMethodList (const GALGAS_mapSearchMethodListAST inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMRemoveMethodList (const GALGAS_mapRemoveMethodListAST inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMHasInsertOrReplaceModifier (const GALGAS_bool inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
      objectPtr->mProperty_mHasInsertOrReplaceModifier = inValue ;
    }
  }
}
...
void GALGAS_mapTypeForGeneration_2D_weak::setter_setMActivateSuggestions (const GALGAS_bool inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapTypeForGeneration * objectPtr = (cPtr_mapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapTypeForGeneration) ;
      objectPtr->mProperty_mActivateSuggestions = inValue ;
    }
  }
}
...
GALGAS_lstring GALGAS_mapEntryDeclarationAST_2D_weak::getter_mMapEntryTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapEntryDeclarationAST * objectPtr = (cPtr_mapEntryDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapEntryDeclarationAST) ;
      result = objectPtr->mProperty_mMapEntryTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_mapEntryDeclarationAST_2D_weak::getter_mAssociatedMapTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapEntryDeclarationAST * objectPtr = (cPtr_mapEntryDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapEntryDeclarationAST) ;
      result = objectPtr->mProperty_mAssociatedMapTypeName ;
    }
  }
  return result ;
}
...
void GALGAS_mapEntryDeclarationAST_2D_weak::setter_setMMapEntryTypeName (const GALGAS_lstring inValue,
                                                                         C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapEntryDeclarationAST * objectPtr = (cPtr_mapEntryDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapEntryDeclarationAST) ;
      objectPtr->mProperty_mMapEntryTypeName = inValue ;
    }
  }
}
...
void GALGAS_mapEntryDeclarationAST_2D_weak::setter_setMAssociatedMapTypeName (const GALGAS_lstring inValue,
                                                                              C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapEntryDeclarationAST * objectPtr = (cPtr_mapEntryDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapEntryDeclarationAST) ;
      objectPtr->mProperty_mAssociatedMapTypeName = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_mapEntryTypeForGeneration_2D_weak::getter_mAssociatedMapTypeEntry (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapEntryTypeForGeneration) ;
      result = objectPtr->mProperty_mAssociatedMapTypeEntry ;
    }
  }
  return result ;
}
...
GALGAS_typedPropertyList GALGAS_mapEntryTypeForGeneration_2D_weak::getter_mAssociatedMapTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapEntryTypeForGeneration) ;
      result = objectPtr->mProperty_mAssociatedMapTypedAttributeList ;
    }
  }
  return result ;
}
...
GALGAS_mapSearchMethodListAST GALGAS_mapEntryTypeForGeneration_2D_weak::getter_mSearchMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapSearchMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_mapEntryTypeForGeneration_2D_weak::setter_setMAssociatedMapTypeEntry (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_mapEntryTypeForGeneration) ;
      objectPtr->mProperty_mAssociatedMapTypeEntry = inValue ;
    }
  }
}
...
void GALGAS_mapEntryTypeForGeneration_2D_weak::setter_setMAssociatedMapTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                                           C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_mapEntryTypeForGeneration) ;
      objectPtr->mProperty_mAssociatedMapTypedAttributeList = inValue ;
    }
  }
}
...
void GALGAS_mapEntryTypeForGeneration_2D_weak::setter_setMSearchMethodList (const GALGAS_mapSearchMethodListAST inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_mapEntryTypeForGeneration * objectPtr = (cPtr_mapEntryTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_sharedMapDeclarationAST_2D_weak::getter_mMapTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      result = objectPtr->mProperty_mMapTypeName ;
    }
  }
  return result ;
...
GALGAS_lstringlist GALGAS_sharedMapDeclarationAST_2D_weak::getter_mAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_propertyInCollectionListAST GALGAS_sharedMapDeclarationAST_2D_weak::getter_mPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_insertMethodListAST GALGAS_sharedMapDeclarationAST_2D_weak::getter_mInsertMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_insertMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_mapSearchMethodListAST GALGAS_sharedMapDeclarationAST_2D_weak::getter_mSearchMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapSearchMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
GALGAS_mapStateList GALGAS_sharedMapDeclarationAST_2D_weak::getter_mMapStateList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapStateList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      result = objectPtr->mProperty_mMapStateList ;
    }
  }
  return result ;
}
...
GALGAS_mapOverrideBlockListAST GALGAS_sharedMapDeclarationAST_2D_weak::getter_mMapOverrideBlockListAST (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapOverrideBlockListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      result = objectPtr->mProperty_mMapOverrideBlockListAST ;
    }
  }
  return result ;
}
...
GALGAS_sharedMapAttributeListAST GALGAS_sharedMapDeclarationAST_2D_weak::getter_mSharedMapAttributeListAST (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_sharedMapAttributeListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      result = objectPtr->mProperty_mSharedMapAttributeListAST ;
    }
  }
  return result ;
}
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMMapTypeName (const GALGAS_lstring inValue,
                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMAttributeList (const GALGAS_lstringlist inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMPropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                      C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMInsertMethodList (const GALGAS_insertMethodListAST inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMSearchMethodList (const GALGAS_mapSearchMethodListAST inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMMapStateList (const GALGAS_mapStateList inValue,
                                                                      C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      objectPtr->mProperty_mMapStateList = inValue ;
    }
  }
}
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMMapOverrideBlockListAST (const GALGAS_mapOverrideBlockListAST inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      objectPtr->mProperty_mMapOverrideBlockListAST = inValue ;
    }
  }
}
...
void GALGAS_sharedMapDeclarationAST_2D_weak::setter_setMSharedMapAttributeListAST (const GALGAS_sharedMapAttributeListAST inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapDeclarationAST * objectPtr = (cPtr_sharedMapDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapDeclarationAST) ;
      objectPtr->mProperty_mSharedMapAttributeListAST = inValue ;
    }
  }
}
...
GALGAS_typedPropertyList GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mTypedAttributeList ;
    }
  }
  return result ;
...
GALGAS_insertMethodListAST GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mInsertMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_insertMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_mapSearchMethodListAST GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mSearchMethodList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapSearchMethodListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_mapAutomatonStateMap GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mMapAutomatonStateMap (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapAutomatonStateMap result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mMapAutomatonStateMap ;
    }
  }
  return result ;
}
...
GALGAS_mapAutomatonActionMap GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mMapAutomatonActionMap (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapAutomatonActionMap result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mMapAutomatonActionMap ;
    }
  }
  return result ;
}
...
GALGAS_mapStateSortedList GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mMapStateSortedList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapStateSortedList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mMapStateSortedList ;
    }
  }
  return result ;
}
...
GALGAS_mapOverrideList GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mMapOverrideList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapOverrideList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mMapOverrideList ;
    }
  }
  return result ;
}
...
GALGAS_mapAutomatonMessageKind GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mShadowBehaviour (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_mapAutomatonMessageKind result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mShadowBehaviour ;
    }
  }
  return result ;
}
...
GALGAS_string GALGAS_sharedMapTypeForGeneration_2D_weak::getter_mShadowMessage (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      result = objectPtr->mProperty_mShadowMessage ;
    }
  }
  return result ;
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMInsertMethodList (const GALGAS_insertMethodListAST inValue,
                                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMSearchMethodList (const GALGAS_mapSearchMethodListAST inValue,
                                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMMapAutomatonStateMap (const GALGAS_mapAutomatonStateMap inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mMapAutomatonStateMap = inValue ;
    }
  }
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMMapAutomatonActionMap (const GALGAS_mapAutomatonActionMap inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mMapAutomatonActionMap = inValue ;
    }
  }
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMMapStateSortedList (const GALGAS_mapStateSortedList inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mMapStateSortedList = inValue ;
    }
  }
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMMapOverrideList (const GALGAS_mapOverrideList inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mMapOverrideList = inValue ;
    }
  }
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMShadowBehaviour (const GALGAS_mapAutomatonMessageKind inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mShadowBehaviour = inValue ;
    }
  }
}
...
void GALGAS_sharedMapTypeForGeneration_2D_weak::setter_setMShadowMessage (const GALGAS_string inValue,
                                                                          C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sharedMapTypeForGeneration * objectPtr = (cPtr_sharedMapTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sharedMapTypeForGeneration) ;
      objectPtr->mProperty_mShadowMessage = inValue ;
    }
  }
}
...
GALGAS_lstring GALGAS_sortedListDeclarationAST_2D_weak::getter_mSortedListTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sortedListDeclarationAST) ;
      result = objectPtr->mProperty_mSortedListTypeName ;
    }
  }
  return result ;
}
...
GALGAS_propertyInCollectionListAST GALGAS_sortedListDeclarationAST_2D_weak::getter_mPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
...
GALGAS_sortedListSortDescriptorListAST GALGAS_sortedListDeclarationAST_2D_weak::getter_mSortDescriptorList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_sortedListSortDescriptorListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sortedListDeclarationAST) ;
      result = objectPtr->mProperty_mSortDescriptorList ;
    }
  }
  return result ;
}
...
void GALGAS_sortedListDeclarationAST_2D_weak::setter_setMSortedListTypeName (const GALGAS_lstring inValue,
                                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sortedListDeclarationAST) ;
      objectPtr->mProperty_mSortedListTypeName = inValue ;
    }
  }
}
...
void GALGAS_sortedListDeclarationAST_2D_weak::setter_setMPropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
...
void GALGAS_sortedListDeclarationAST_2D_weak::setter_setMSortDescriptorList (const GALGAS_sortedListSortDescriptorListAST inValue,
                                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListDeclarationAST * objectPtr = (cPtr_sortedListDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_sortedListDeclarationAST) ;
      objectPtr->mProperty_mSortDescriptorList = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_sortedListTypeForGeneration_2D_weak::getter_mListElementTypeIndex (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sortedListTypeForGeneration) ;
      result = objectPtr->mProperty_mListElementTypeIndex ;
    }
  }
  return result ;
...
GALGAS_typedPropertyList GALGAS_sortedListTypeForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_sortDescriptorListForGeneration GALGAS_sortedListTypeForGeneration_2D_weak::getter_mSortDescriptorList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_sortDescriptorListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_sortedListTypeForGeneration_2D_weak::setter_setMListElementTypeIndex (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_sortedListTypeForGeneration) ;
...
void GALGAS_sortedListTypeForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
...
void GALGAS_sortedListTypeForGeneration_2D_weak::setter_setMSortDescriptorList (const GALGAS_sortDescriptorListForGeneration inValue,
                                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_sortedListTypeForGeneration * objectPtr = (cPtr_sortedListTypeForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_structDeclarationAST_2D_weak::getter_mStructTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      result = objectPtr->mProperty_mStructTypeName ;
    }
  }
  return result ;
}
...
GALGAS_propertyInCollectionListAST GALGAS_structDeclarationAST_2D_weak::getter_mStructurePropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_propertyInCollectionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      result = objectPtr->mProperty_mStructurePropertyList ;
    }
  }
  return result ;
}
...
GALGAS_string GALGAS_structDeclarationAST_2D_weak::getter_mEnumeratedElementTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      result = objectPtr->mProperty_mEnumeratedElementTypeName ;
    }
  }
  return result ;
}
...
void GALGAS_structDeclarationAST_2D_weak::setter_setMStructTypeName (const GALGAS_lstring inValue,
                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      objectPtr->mProperty_mStructTypeName = inValue ;
    }
  }
}
...
void GALGAS_structDeclarationAST_2D_weak::setter_setMStructurePropertyList (const GALGAS_propertyInCollectionListAST inValue,
                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      objectPtr->mProperty_mStructurePropertyList = inValue ;
    }
  }
}
...
void GALGAS_structDeclarationAST_2D_weak::setter_setMEnumeratedElementTypeName (const GALGAS_string inValue,
                                                                                C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_structDeclarationAST * objectPtr = (cPtr_structDeclarationAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_structDeclarationAST) ;
      objectPtr->mProperty_mEnumeratedElementTypeName = inValue ;
    }
  }
}
...
GALGAS_typedPropertyList GALGAS_structTypeForGeneration_2D_weak::getter_mTypedPropertyList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_structTypeForGeneration * objectPtr = (cPtr_structTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_structTypeForGeneration) ;
      result = objectPtr->mProperty_mTypedPropertyList ;
    }
  }
  return result ;
}
...
void GALGAS_structTypeForGeneration_2D_weak::setter_setMTypedPropertyList (const GALGAS_typedPropertyList inValue,
                                                                           C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_structTypeForGeneration * objectPtr = (cPtr_structTypeForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_structTypeForGeneration) ;
      objectPtr->mProperty_mTypedPropertyList = inValue ;
    }
  }
}
...
GALGAS_lstring GALGAS_abstractExtensionGetterAST_2D_weak::getter_mTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterAST) ;
...
GALGAS_lstring GALGAS_abstractExtensionGetterAST_2D_weak::getter_mAbstractExtensionGetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
GALGAS_formalInputParameterListAST GALGAS_abstractExtensionGetterAST_2D_weak::getter_mAbstractExtensionGetterFormalInputParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalInputParameterListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_abstractExtensionGetterAST_2D_weak::getter_mAbstractExtensionGetterReturnedTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionGetterAST_2D_weak::setter_setMTypeName (const GALGAS_lstring inValue,
                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterAST) ;
...
void GALGAS_abstractExtensionGetterAST_2D_weak::setter_setMAbstractExtensionGetterName (const GALGAS_lstring inValue,
                                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionGetterAST_2D_weak::setter_setMAbstractExtensionGetterFormalInputParameterList (const GALGAS_formalInputParameterListAST inValue,
                                                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionGetterAST_2D_weak::setter_setMAbstractExtensionGetterReturnedTypeName (const GALGAS_lstring inValue,
                                                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterAST * objectPtr = (cPtr_abstractExtensionGetterAST *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_abstractExtensionGetterForGeneration_2D_weak::getter_mReceiverType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterForGeneration) ;
...
GALGAS_string GALGAS_abstractExtensionGetterForGeneration_2D_weak::getter_mAbstractExtensionGetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_abstractExtensionGetterForGeneration_2D_weak::getter_mResultType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_formalInputParameterListForGeneration GALGAS_abstractExtensionGetterForGeneration_2D_weak::getter_mAbstractExtensionGetterFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalInputParameterListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterForGeneration) ;
      result = objectPtr->mProperty_mAbstractExtensionGetterFormalParameterList ;
    }
  }
  return result ;
}
...
void GALGAS_abstractExtensionGetterForGeneration_2D_weak::setter_setMReceiverType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterForGeneration) ;
...
void GALGAS_abstractExtensionGetterForGeneration_2D_weak::setter_setMAbstractExtensionGetterName (const GALGAS_string inValue,
                                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionGetterForGeneration_2D_weak::setter_setMResultType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionGetterForGeneration_2D_weak::setter_setMAbstractExtensionGetterFormalParameterList (const GALGAS_formalInputParameterListForGeneration inValue,
                                                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionGetterForGeneration * objectPtr = (cPtr_abstractExtensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionGetterForGeneration) ;
      objectPtr->mProperty_mAbstractExtensionGetterFormalParameterList = inValue ;
    }
  }
}
...
GALGAS_lstring GALGAS_abstractExtensionMethodAST_2D_weak::getter_mTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
      result = objectPtr->mProperty_mTypeName ;
    }
  }
  return result ;
...
GALGAS_lstring GALGAS_abstractExtensionMethodAST_2D_weak::getter_mAbstractExtensionMethodName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
      result = objectPtr->mProperty_mAbstractExtensionMethodName ;
    }
  }
  return result ;
}
...
GALGAS_formalParameterListAST GALGAS_abstractExtensionMethodAST_2D_weak::getter_mAbstractExtensionMethodFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalParameterListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
      result = objectPtr->mProperty_mAbstractExtensionMethodFormalParameterList ;
    }
  }
  return result ;
}
...
void GALGAS_abstractExtensionMethodAST_2D_weak::setter_setMTypeName (const GALGAS_lstring inValue,
                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
...
void GALGAS_abstractExtensionMethodAST_2D_weak::setter_setMAbstractExtensionMethodName (const GALGAS_lstring inValue,
                                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
      objectPtr->mProperty_mAbstractExtensionMethodName = inValue ;
    }
  }
}
...
void GALGAS_abstractExtensionMethodAST_2D_weak::setter_setMAbstractExtensionMethodFormalParameterList (const GALGAS_formalParameterListAST inValue,
                                                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodAST * objectPtr = (cPtr_abstractExtensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodAST) ;
      objectPtr->mProperty_mAbstractExtensionMethodFormalParameterList = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_abstractExtensionMethodForGeneration_2D_weak::getter_mReceiverType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodForGeneration) ;
      result = objectPtr->mProperty_mReceiverType ;
    }
  }
  return result ;
...
GALGAS_string GALGAS_abstractExtensionMethodForGeneration_2D_weak::getter_mAbstractExtensionMethodName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
...
GALGAS_formalParameterListForGeneration GALGAS_abstractExtensionMethodForGeneration_2D_weak::getter_mAbstractExtensionMethodFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalParameterListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionMethodForGeneration_2D_weak::setter_setMReceiverType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionMethodForGeneration) ;
...
void GALGAS_abstractExtensionMethodForGeneration_2D_weak::setter_setMAbstractExtensionMethodName (const GALGAS_string inValue,
                                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionMethodForGeneration_2D_weak::setter_setMAbstractExtensionMethodFormalParameterList (const GALGAS_formalParameterListForGeneration inValue,
                                                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionMethodForGeneration * objectPtr = (cPtr_abstractExtensionMethodForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_abstractExtensionSetterAST_2D_weak::getter_mTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
      result = objectPtr->mProperty_mTypeName ;
    }
  }
  return result ;
...
GALGAS_lstring GALGAS_abstractExtensionSetterAST_2D_weak::getter_mAbstractExtensionSetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
      result = objectPtr->mProperty_mAbstractExtensionSetterName ;
    }
  }
  return result ;
}
...
GALGAS_formalParameterListAST GALGAS_abstractExtensionSetterAST_2D_weak::getter_mAbstractExtensionSetterFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalParameterListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
      result = objectPtr->mProperty_mAbstractExtensionSetterFormalParameterList ;
    }
  }
  return result ;
}
...
void GALGAS_abstractExtensionSetterAST_2D_weak::setter_setMTypeName (const GALGAS_lstring inValue,
                                                                     C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
...
void GALGAS_abstractExtensionSetterAST_2D_weak::setter_setMAbstractExtensionSetterName (const GALGAS_lstring inValue,
                                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
      objectPtr->mProperty_mAbstractExtensionSetterName = inValue ;
    }
  }
}
...
void GALGAS_abstractExtensionSetterAST_2D_weak::setter_setMAbstractExtensionSetterFormalParameterList (const GALGAS_formalParameterListAST inValue,
                                                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterAST * objectPtr = (cPtr_abstractExtensionSetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterAST) ;
      objectPtr->mProperty_mAbstractExtensionSetterFormalParameterList = inValue ;
    }
  }
}
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_abstractExtensionSetterForGeneration_2D_weak::getter_mReceiverType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterForGeneration) ;
      result = objectPtr->mProperty_mReceiverType ;
    }
  }
  return result ;
...
GALGAS_string GALGAS_abstractExtensionSetterForGeneration_2D_weak::getter_mAbstractExtensionSetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
...
GALGAS_formalParameterListForGeneration GALGAS_abstractExtensionSetterForGeneration_2D_weak::getter_mAbstractExtensionSetterFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalParameterListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionSetterForGeneration_2D_weak::setter_setMReceiverType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_abstractExtensionSetterForGeneration) ;
...
void GALGAS_abstractExtensionSetterForGeneration_2D_weak::setter_setMAbstractExtensionSetterName (const GALGAS_string inValue,
                                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_abstractExtensionSetterForGeneration_2D_weak::setter_setMAbstractExtensionSetterFormalParameterList (const GALGAS_formalParameterListForGeneration inValue,
                                                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_abstractExtensionSetterForGeneration * objectPtr = (cPtr_abstractExtensionSetterForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_extensionGetterAST_2D_weak::getter_mTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mTypeName ;
    }
  }
  return result ;
...
GALGAS_lstring GALGAS_extensionGetterAST_2D_weak::getter_mExtensionGetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mExtensionGetterName ;
    }
  }
  return result ;
}
...
GALGAS_formalInputParameterListAST GALGAS_extensionGetterAST_2D_weak::getter_mExtensionGetterFormalInputParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalInputParameterListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mExtensionGetterFormalInputParameterList ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_extensionGetterAST_2D_weak::getter_mExtensionGetterReturnedTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mExtensionGetterReturnedTypeName ;
    }
  }
  return result ;
}
...
GALGAS_lstring GALGAS_extensionGetterAST_2D_weak::getter_mExtensionGetterReturnedVariableName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mExtensionGetterReturnedVariableName ;
    }
  }
  return result ;
}
...
GALGAS_semanticInstructionListAST GALGAS_extensionGetterAST_2D_weak::getter_mExtensionGetterInstructionList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_semanticInstructionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      result = objectPtr->mProperty_mExtensionGetterInstructionList ;
    }
  }
  return result ;
}
...
GALGAS_location GALGAS_extensionGetterAST_2D_weak::getter_mEndOfReaderLocation (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_location result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMTypeName (const GALGAS_lstring inValue,
                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMExtensionGetterName (const GALGAS_lstring inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      objectPtr->mProperty_mExtensionGetterName = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMExtensionGetterFormalInputParameterList (const GALGAS_formalInputParameterListAST inValue,
                                                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      objectPtr->mProperty_mExtensionGetterFormalInputParameterList = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMExtensionGetterReturnedTypeName (const GALGAS_lstring inValue,
                                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      objectPtr->mProperty_mExtensionGetterReturnedTypeName = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMExtensionGetterReturnedVariableName (const GALGAS_lstring inValue,
                                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      objectPtr->mProperty_mExtensionGetterReturnedVariableName = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMExtensionGetterInstructionList (const GALGAS_semanticInstructionListAST inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterAST) ;
      objectPtr->mProperty_mExtensionGetterInstructionList = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterAST_2D_weak::setter_setMEndOfReaderLocation (const GALGAS_location inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterAST * objectPtr = (cPtr_extensionGetterAST *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_extensionGetterForGeneration_2D_weak::getter_mReceiverType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionGetterForGeneration) ;
      result = objectPtr->mProperty_mReceiverType ;
    }
  }
  return result ;
...
GALGAS_string GALGAS_extensionGetterForGeneration_2D_weak::getter_mExtensionGetterName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_bool GALGAS_extensionGetterForGeneration_2D_weak::getter_mImplementedAsFunction (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_unifiedTypeMap_2D_entry GALGAS_extensionGetterForGeneration_2D_weak::getter_mResultType (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_entry result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_string GALGAS_extensionGetterForGeneration_2D_weak::getter_mResultVarCppName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_formalInputParameterListForGeneration GALGAS_extensionGetterForGeneration_2D_weak::getter_mExtensionGetterFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalInputParameterListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterForGeneration) ;
      result = objectPtr->mProperty_mExtensionGetterFormalParameterList ;
    }
  }
  return result ;
}
...
GALGAS_typedPropertyList GALGAS_extensionGetterForGeneration_2D_weak::getter_mTypedAttributeList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_typedPropertyList result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_semanticInstructionListForGeneration GALGAS_extensionGetterForGeneration_2D_weak::getter_mSemanticInstructionListForGeneration (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_semanticInstructionListForGeneration result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMReceiverType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                           C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionGetterForGeneration) ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMExtensionGetterName (const GALGAS_string inValue,
                                                                                  C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMImplementedAsFunction (const GALGAS_bool inValue,
                                                                                    C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMResultType (const GALGAS_unifiedTypeMap_2D_entry inValue,
                                                                         C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMResultVarCppName (const GALGAS_string inValue,
                                                                               C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMExtensionGetterFormalParameterList (const GALGAS_formalInputParameterListForGeneration inValue,
                                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionGetterForGeneration) ;
      objectPtr->mProperty_mExtensionGetterFormalParameterList = inValue ;
    }
  }
}
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMTypedAttributeList (const GALGAS_typedPropertyList inValue,
                                                                                 C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
void GALGAS_extensionGetterForGeneration_2D_weak::setter_setMSemanticInstructionListForGeneration (const GALGAS_semanticInstructionListForGeneration inValue,
                                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionGetterForGeneration * objectPtr = (cPtr_extensionGetterForGeneration *) ptr->strongObject () ;
...
GALGAS_lstring GALGAS_extensionMethodAST_2D_weak::getter_mTypeName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionMethodAST) ;
      result = objectPtr->mProperty_mTypeName ;
    }
  }
  return result ;
...
GALGAS_lstring GALGAS_extensionMethodAST_2D_weak::getter_mExtensionMethodName (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
...
GALGAS_formalParameterListAST GALGAS_extensionMethodAST_2D_weak::getter_mExtensionMethodFormalParameterList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_formalParameterListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
...
GALGAS_semanticInstructionListAST GALGAS_extensionMethodAST_2D_weak::getter_mExtensionMethodInstructionList (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_semanticInstructionListAST result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionMethodAST) ;
      result = objectPtr->mProperty_mExtensionMethodInstructionList ;
    }
  }
  return result ;
}
...
GALGAS_location GALGAS_extensionMethodAST_2D_weak::getter_mEndOfMethodLocation (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_location result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
...
void GALGAS_extensionMethodAST_2D_weak::setter_setMTypeName (const GALGAS_lstring inValue,
                                                             C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_extensionMethodAST) ;
...
void GALGAS_extensionMethodAST_2D_weak::setter_setMExtensionMethodName (const GALGAS_lstring inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
...
void GALGAS_extensionMethodAST_2D_weak::setter_setMExtensionMethodFormalParameterList (const GALGAS_formalParameterListAST inValue,
                                                                                       C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
...
void GALGAS_extensionMethodAST_2D_weak::setter_setMExtensionMethodInstructionList (const GALGAS_semanticInstructionListAST inValue,
                                                                                   C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      ...
      macroValidSharedObject (objectPtr, cPtr_extensionMethodAST) ;
      objectPtr->mProperty_mExtensionMethodInstructionList = inValue ;
    }
  }
}
...
void GALGAS_extensionMethodAST_2D_weak::setter_setMEndOfMethodLocation (const GALGAS_location inValue,
                                                                        C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_extensionMethodAST * objectPtr = (cPtr_extensionMethodAST *) ptr->strongObject () ;
