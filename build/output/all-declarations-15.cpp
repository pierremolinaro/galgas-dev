...
GALGAS_jsonObjectValue_2D_element::GALGAS_jsonObjectValue_2D_element (void) :
mProperty_mKey (),
mProperty_mValue () {
}
...
GALGAS_jsonObjectValue_2D_element::GALGAS_jsonObjectValue_2D_element (const GALGAS_string & inOperand0,
...
GALGAS_jsonObjectValue_2D_element GALGAS_jsonObjectValue_2D_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                      const GALGAS_jsonValue & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_jsonObjectValue_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_jsonObjectValue_2D_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_jsonObjectValue_2D_element::objectCompare (const GALGAS_jsonObjectValue_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_jsonObjectValue_2D_element::isValid (void) const {
  return mProperty_mKey.isValid () && mProperty_mValue.isValid () ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_jsonObjectValue_2D_element::drop (void) {
  mProperty_mKey.drop () ;
...
void GALGAS_jsonObjectValue_2D_element::description (C_String & ioString,
                                                     const int32_t inIndentation) const {
  ioString << "<struct @jsonObjectValue-element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
...
GALGAS_string GALGAS_jsonObjectValue_2D_element::getter_mKey (UNUSED_LOCATION_ARGS) const {
  return mProperty_mKey ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_jsonValue GALGAS_jsonObjectValue_2D_element::getter_mValue (UNUSED_LOCATION_ARGS) const {
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                            @jsonObjectValue-element type                                            *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_jsonObjectValue_2D_element ("jsonObjectValue-element",
                                                   NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_jsonObjectValue_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_jsonObjectValue_2D_element ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_jsonObjectValue_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_jsonObjectValue_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_jsonObjectValue_2D_element GALGAS_jsonObjectValue_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_jsonObjectValue_2D_element result ;
  const GALGAS_jsonObjectValue_2D_element * p = (const GALGAS_jsonObjectValue_2D_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_jsonObjectValue_2D_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_jsonArrayValue_2D_element::GALGAS_jsonArrayValue_2D_element (void) :
mProperty_mValue () {
}
...
GALGAS_jsonArrayValue_2D_element::GALGAS_jsonArrayValue_2D_element (const GALGAS_jsonValue & inOperand0) :
mProperty_mValue (inOperand0) {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_jsonArrayValue_2D_element GALGAS_jsonArrayValue_2D_element::constructor_new (const GALGAS_jsonValue & inOperand0 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_jsonArrayValue_2D_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_jsonArrayValue_2D_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_jsonArrayValue_2D_element::objectCompare (const GALGAS_jsonArrayValue_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mProperty_mValue.objectCompare (inOperand.mProperty_mValue) ;
  }
...
bool GALGAS_jsonArrayValue_2D_element::isValid (void) const {
  return mProperty_mValue.isValid () ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_jsonArrayValue_2D_element::drop (void) {
  mProperty_mValue.drop () ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_jsonArrayValue_2D_element::description (C_String & ioString,
                                                    const int32_t inIndentation) const {
  ioString << "<struct @jsonArrayValue-element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
    mProperty_mValue.description (ioString, inIndentation+1) ;
...
GALGAS_jsonValue GALGAS_jsonArrayValue_2D_element::getter_mValue (UNUSED_LOCATION_ARGS) const {
  return mProperty_mValue ;
}
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                            @jsonArrayValue-element type                                             *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_jsonArrayValue_2D_element ("jsonArrayValue-element",
                                                  NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_jsonArrayValue_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_jsonArrayValue_2D_element ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_jsonArrayValue_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_jsonArrayValue_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_jsonArrayValue_2D_element GALGAS_jsonArrayValue_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_jsonArrayValue_2D_element result ;
  const GALGAS_jsonArrayValue_2D_element * p = (const GALGAS_jsonArrayValue_2D_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_jsonArrayValue_2D_element *> (p)) {
      result = *p ;
    }else{
