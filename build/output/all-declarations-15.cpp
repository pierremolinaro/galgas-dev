...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44432 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44432.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44432.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.galgas", 1004)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44432.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.galgas", 1007)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44432.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1008))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1008)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.galgas", 1009)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.galgas", 1009)), enumerator_44432.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.galgas", 1009)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.galgas", 1010)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.galgas", 1010)), enumerator_44432.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.galgas", 1010)) ;
    enumerator_44432.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45164 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45164.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45164.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1014)) COMMA_SOURCE_FILE ("semanticContext.galgas", 1014)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45164.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").add_operation (enumerator_45164.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1015)), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1015)).add_operation (GALGAS_string ("' insert method is already declared"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1015))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1015)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45164.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.galgas", 1019)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 1022)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.galgas", 1017)) ;
      }
    }
    enumerator_45164.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_46943 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_46943.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_46943.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.galgas", 1057)), var_removeMethodFormalArgumentList, enumerator_46943.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.galgas", 1059)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 1061)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1055)) ;
      }
      enumerator_46943.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47262 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47262.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47262.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.galgas", 1069)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 1072)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1067)) ;
      }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_49137 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49137.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").add_operation (enumerator_49137.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.galgas", 1116)), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1116)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 1116))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1116)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.galgas", 1117)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 1118)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 1120)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1115)) ;
      }
      enumerator_49137.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49541 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49541.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49541.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1127)).add_operation (GALGAS_string ("ForKey"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1127)), enumerator_49541.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.galgas", 1127))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1127)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49541.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.galgas", 1129)) ;
    }
    {
    ...
    enumerator_49541.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_50202 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50202.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").add_operation (enumerator_50202.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1143)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.galgas", 1143)), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1143)).add_operation (GALGAS_string ("ForKey"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1143)), enumerator_50202.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.galgas", 1143))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1143)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50202.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.galgas", 1144)) ;
    }
    ...
    enumerator_50202.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_52797_3 ; // Joker input parameter
  GALGAS_bool joker_52797_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_52797_1 ; // Joker input parameter
  GALGAS_bool joker_52841_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_52841_2 ; // Joker input parameter
  GALGAS_attributeMap joker_52841_1 ; // Joker input parameter
  GALGAS_constructorMap joker_52900_11 ; // Joker input parameter
  GALGAS_readerMap joker_52900_10 ; // Joker input parameter
  GALGAS_modifierMap joker_52900_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_52900_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_52900_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_52900_6 ; // Joker input parameter
  GALGAS_stringlist joker_52900_5 ; // Joker input parameter
  GALGAS_uint joker_52900_4 ; // Joker input parameter
  GALGAS_functionSignature joker_52900_3 ; // Joker input parameter
  GALGAS_stringset joker_52900_2 ; // Joker input parameter
  GALGAS_lstringlist joker_52900_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_52959_6 ; // Joker input parameter
  GALGAS_bool joker_52959_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_52959_4 ; // Joker input parameter
  GALGAS_string joker_52959_3 ; // Joker input parameter
  GALGAS_string joker_52959_2 ; // Joker input parameter
  GALGAS_headerKind joker_52959_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_52797_3, joker_52797_2, joker_52797_1, var_typeKindEnum, joker_52841_3, joker_52841_2, joker_52841_1, var_mapTypedAttributeList, joker_52900_11, joker_52900_10, joker_52900_9, joker_52900_8, joker_52900_7, joker_52900_6, joker_52900_5, joker_52900_4, joker_52900_3, joker_52900_2, joker_52900_1, var_searchMethodList, joker_52959_6, joker_52959_5, joker_52959_4, joker_52959_3, joker_52959_2, joker_52959_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1208)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_55627 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_55627.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_55627.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1266)) ;
    }
    enumerator_55627.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_56590 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_56590.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_56590.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.galgas", 1283)) COMMA_SOURCE_FILE ("semanticContext.galgas", 1283)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_56724 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE ("semanticContext.galgas", 1285)), kEnumeration_up) ;
      while (enumerator_56724.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").add_operation (enumerator_56724.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1286)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1286))  COMMA_SOURCE_FILE ("semanticContext.galgas", 1286)) ;
        if (enumerator_56724.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticContext.galgas", 1287)) ;
        }
        enumerator_56724.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_56590.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_56590.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.galgas", 1294)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 1295)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 1296)), GALGAS_bool (true), enumerator_56590.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 1299)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 1292)) ;
      }
    }
