...
//--------------------------------------------------------------------------------------------------
//
// Phase 1: @IndexingSyntaxInstruction reference class
//
//--------------------------------------------------------------------------------------------------

class GGS_IndexingSyntaxInstruction : public GGS_syntaxInstructionAST {
//--------------------------------- Default constructor
  public: GGS_IndexingSyntaxInstruction (void) ;

//--------------------------------- Constructor from pointer
  public: GGS_IndexingSyntaxInstruction (const class cPtr_IndexingSyntaxInstruction * inSourcePtr) ;

//--------------------------------- Property access
  public: class GGS_lstring readProperty_mIndexName (void) const ;
...
//--------------------------------- Initializers
  public: static GGS_IndexingSyntaxInstruction init_21__21__21_ (const class GGS_location & inOperand0,
                                                                 const class GGS_lstring & inOperand1,
                                                                 const class GGS_semanticExpressionAST & inOperand2,
                                                                 Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Object extraction
  public: static GGS_IndexingSyntaxInstruction extractObject (const GGS_object & inObject,
                                                              Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS class functions
  public: static class GGS_IndexingSyntaxInstruction class_func_new (const class GGS_location & inOperand0,
                                                                     const class GGS_lstring & inOperand1,
                                                                     const class GGS_semanticExpressionAST & inOperand2,
                                                                     class Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Comparison
  public: ComparisonResult objectCompare (const GGS_IndexingSyntaxInstruction & inOperand) const ;
...
} ; // End of GGS_IndexingSyntaxInstruction class


//--------------------------------------------------------------------------------------------------

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingSyntaxInstruction ;

//--------------------------------------------------------------------------------------------------
//
// Phase 2: pointer class for @IndexingSyntaxInstruction class
//
//--------------------------------------------------------------------------------------------------

class cPtr_IndexingSyntaxInstruction : public cPtr_syntaxInstructionAST {
...
//--------------------------------- Initializers
  public: void IndexingSyntaxInstruction_init_21__21__21_ (const class GGS_location & inOperand0,
                                                           const class GGS_lstring & inOperand1,
                                                           const class GGS_semanticExpressionAST & inOperand2,
                                                           Compiler * inCompiler) ;
...
//--- Default constructor
  public: cPtr_IndexingSyntaxInstruction (Compiler * inCompiler COMMA_LOCATION_ARGS) ;

//--- Constructor
  public: cPtr_IndexingSyntaxInstruction (const GGS_location & in_mInstructionLocation,
...
//--------------------------------------------------------------------------------------------------
//
// Phase 1: @IndexingSyntaxInstruction_2E_weak weak reference class
//
//--------------------------------------------------------------------------------------------------

class GGS_IndexingSyntaxInstruction_2E_weak : public GGS_syntaxInstructionAST_2E_weak {
//--------------------------------- Default constructor
  public: GGS_IndexingSyntaxInstruction_2E_weak (void) ;

//--------------------------------- Constructor and assignment from strong reference
  public: GGS_IndexingSyntaxInstruction_2E_weak (const class GGS_IndexingSyntaxInstruction & inSource) ;

  public: GGS_IndexingSyntaxInstruction_2E_weak & operator = (const class GGS_IndexingSyntaxInstruction & inSource) ;

//--------------------------------- Constructor and assignment from optional reference

//--------------------------------- nil initializer
  public: inline static GGS_IndexingSyntaxInstruction_2E_weak init_nil (void) {
    GGS_IndexingSyntaxInstruction_2E_weak result ;
    macroMyNew (result.mProxyPtr, cPtr_weakReference_proxy (HERE)) ;
    return result ;
  }

//--------------------------------- Bang operator
  public: GGS_IndexingSyntaxInstruction bang_IndexingSyntaxInstruction_2E_weak (Compiler * inCompiler COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Unwrapped value
  public: inline GGS_IndexingSyntaxInstruction unwrappedValue (void) const {
    GGS_IndexingSyntaxInstruction result ;
    if (isValid ()) {
      const cPtr_IndexingSyntaxInstruction * p = (cPtr_IndexingSyntaxInstruction *) ptr () ;
      if (nullptr != p) {
        result = GGS_IndexingSyntaxInstruction (p) ;
      }
    }
    return result ;
  }
...
//--------------------------------- Object extraction
  public: static GGS_IndexingSyntaxInstruction_2E_weak extractObject (const GGS_object & inObject,
                                                                      Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS class functions
  public: static class GGS_IndexingSyntaxInstruction_2E_weak class_func_nil (LOCATION_ARGS) ;

//--------------------------------- Comparison
  public: ComparisonResult objectCompare (const GGS_IndexingSyntaxInstruction_2E_weak & inOperand) const ;
...
} ; // End of GGS_IndexingSyntaxInstruction_2E_weak class


//--------------------------------------------------------------------------------------------------

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingSyntaxInstruction_2E_weak ;

//--------------------------------------------------------------------------------------------------
//
// Phase 1: @IndexingInstructionForGeneration reference class
//
//--------------------------------------------------------------------------------------------------

class GGS_IndexingInstructionForGeneration : public GGS_syntaxInstructionForGeneration {
//--------------------------------- Default constructor
  public: GGS_IndexingInstructionForGeneration (void) ;

//--------------------------------- Constructor from pointer
  public: GGS_IndexingInstructionForGeneration (const class cPtr_IndexingInstructionForGeneration * inSourcePtr) ;

//--------------------------------- Property access
  public: class GGS_string readProperty_mIndexName (void) const ;
...
//--------------------------------- Initializers
  public: static GGS_IndexingInstructionForGeneration init_21__21__21__21_ (const class GGS_location & inOperand0,
                                                                            const class GGS_string & inOperand1,
                                                                            const class GGS_semanticExpressionForGeneration & inOperand2,
                                                                            const class GGS_string & inOperand3,
                                                                            Compiler * inCompiler
...
//--------------------------------- Object extraction
  public: static GGS_IndexingInstructionForGeneration extractObject (const GGS_object & inObject,
                                                                     Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS class functions
  public: static class GGS_IndexingInstructionForGeneration class_func_new (const class GGS_location & inOperand0,
                                                                            const class GGS_string & inOperand1,
                                                                            const class GGS_semanticExpressionForGeneration & inOperand2,
                                                                            const class GGS_string & inOperand3,
                                                                            class Compiler * inCompiler
...
//--------------------------------- Comparison
  public: ComparisonResult objectCompare (const GGS_IndexingInstructionForGeneration & inOperand) const ;
...
} ; // End of GGS_IndexingInstructionForGeneration class


//--------------------------------------------------------------------------------------------------

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingInstructionForGeneration ;

//--------------------------------------------------------------------------------------------------
//
// Phase 2: pointer class for @IndexingInstructionForGeneration class
//
//--------------------------------------------------------------------------------------------------

class cPtr_IndexingInstructionForGeneration : public cPtr_syntaxInstructionForGeneration {
...
//--------------------------------- Initializers
  public: void IndexingInstructionForGeneration_init_21__21__21__21_ (const class GGS_location & inOperand0,
                                                                      const class GGS_string & inOperand1,
                                                                      const class GGS_semanticExpressionForGeneration & inOperand2,
                                                                      const class GGS_string & inOperand3,
                                                                      Compiler * inCompiler) ;
...
//--- Properties
  public: GGS_string mProperty_mIndexName ;
  public: GGS_semanticExpressionForGeneration mProperty_mExpression ;
  public: GGS_string mProperty_mLexiqueIdentifier ;


//--- Default constructor
  public: cPtr_IndexingInstructionForGeneration (Compiler * inCompiler COMMA_LOCATION_ARGS) ;

//--- Constructor
  public: cPtr_IndexingInstructionForGeneration (const GGS_location & in_mInstructionLocation,
                                                 const GGS_string & in_mIndexName,
                                                 const GGS_semanticExpressionForGeneration & in_mExpression,
                                                 const GGS_string & in_mLexiqueIdentifier,
                                                 Compiler * inCompiler
                                                 COMMA_LOCATION_ARGS) ;
...
//--------------------------------------------------------------------------------------------------
//
// Phase 1: @IndexingInstructionForGeneration_2E_weak weak reference class
//
//--------------------------------------------------------------------------------------------------

class GGS_IndexingInstructionForGeneration_2E_weak : public GGS_syntaxInstructionForGeneration_2E_weak {
//--------------------------------- Default constructor
  public: GGS_IndexingInstructionForGeneration_2E_weak (void) ;

//--------------------------------- Constructor and assignment from strong reference
  public: GGS_IndexingInstructionForGeneration_2E_weak (const class GGS_IndexingInstructionForGeneration & inSource) ;

  public: GGS_IndexingInstructionForGeneration_2E_weak & operator = (const class GGS_IndexingInstructionForGeneration & inSource) ;

//--------------------------------- Constructor and assignment from optional reference

//--------------------------------- nil initializer
  public: inline static GGS_IndexingInstructionForGeneration_2E_weak init_nil (void) {
    GGS_IndexingInstructionForGeneration_2E_weak result ;
    macroMyNew (result.mProxyPtr, cPtr_weakReference_proxy (HERE)) ;
    return result ;
  }

//--------------------------------- Bang operator
  public: GGS_IndexingInstructionForGeneration bang_IndexingInstructionForGeneration_2E_weak (Compiler * inCompiler COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Unwrapped value
  public: inline GGS_IndexingInstructionForGeneration unwrappedValue (void) const {
    GGS_IndexingInstructionForGeneration result ;
    if (isValid ()) {
      const cPtr_IndexingInstructionForGeneration * p = (cPtr_IndexingInstructionForGeneration *) ptr () ;
      if (nullptr != p) {
        result = GGS_IndexingInstructionForGeneration (p) ;
      }
    }
    return result ;
  }
...
//--------------------------------- Object extraction
  public: static GGS_IndexingInstructionForGeneration_2E_weak extractObject (const GGS_object & inObject,
                                                                             Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS class functions
  public: static class GGS_IndexingInstructionForGeneration_2E_weak class_func_nil (LOCATION_ARGS) ;

//--------------------------------- Comparison
  public: ComparisonResult objectCompare (const GGS_IndexingInstructionForGeneration_2E_weak & inOperand) const ;
...
} ; // End of GGS_IndexingInstructionForGeneration_2E_weak class


//--------------------------------------------------------------------------------------------------

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_IndexingInstructionForGeneration_2E_weak ;
