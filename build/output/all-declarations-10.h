...
class MapFor_propertyIndexMap : public AC_GALGAS_root {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  private: OptionalSharedRef <MapRootFor_propertyIndexMap > mSharedRoot ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Default constructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_propertyIndexMap (void) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Destructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: virtual ~ MapFor_propertyIndexMap (void) ;
  ...
  public: MapFor_propertyIndexMap (const MapFor_propertyIndexMap & inSource) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_propertyIndexMap & operator = (const MapFor_propertyIndexMap & inSource) ;
  ...
  protected: OptionalSharedRef <class MapNodeFor_propertyIndexMap> nodeForKey (const String & inKey) const ;
  ...
  protected: void makeNewEmptyMapWithMapToOverride (const MapFor_propertyIndexMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

/*  protected: MapRootFor_propertyIndexMap getOverridenMap (void) const {
    MapRootFor_propertyIndexMap result ;
    if (isValid ()) {
  ...
  protected: void getOverridenMap (class MapFor_propertyIndexMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const ;
...
class GGS_propertyIndexMap : public MapFor_propertyIndexMap {
//--------------------------------- Default constructor
...
class MapFor_nonterminalLabelMap : public AC_GALGAS_root {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  private: OptionalSharedRef <MapRootFor_nonterminalLabelMap > mSharedRoot ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Default constructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_nonterminalLabelMap (void) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Destructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: virtual ~ MapFor_nonterminalLabelMap (void) ;
  ...
  public: MapFor_nonterminalLabelMap (const MapFor_nonterminalLabelMap & inSource) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_nonterminalLabelMap & operator = (const MapFor_nonterminalLabelMap & inSource) ;
  ...
  protected: OptionalSharedRef <class MapNodeFor_nonterminalLabelMap> nodeForKey (const String & inKey) const ;
  ...
  protected: void makeNewEmptyMapWithMapToOverride (const MapFor_nonterminalLabelMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

/*  protected: MapRootFor_nonterminalLabelMap getOverridenMap (void) const {
    MapRootFor_nonterminalLabelMap result ;
    if (isValid ()) {
      result = mSharedRoot->mOverriddenRoot ;
    }
    return result ;
  ...
  protected: void getOverridenMap (class MapFor_nonterminalLabelMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const ;
...
class GGS_nonterminalLabelMap : public MapFor_nonterminalLabelMap {
//--------------------------------- Default constructor
...
class MapFor_nonterminalMap : public AC_GALGAS_root {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  private: OptionalSharedRef <MapRootFor_nonterminalMap > mSharedRoot ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Default constructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_nonterminalMap (void) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Destructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: virtual ~ MapFor_nonterminalMap (void) ;
  ...
  public: MapFor_nonterminalMap (const MapFor_nonterminalMap & inSource) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_nonterminalMap & operator = (const MapFor_nonterminalMap & inSource) ;
  ...
  protected: OptionalSharedRef <class MapNodeFor_nonterminalMap> nodeForKey (const String & inKey) const ;
  ...
  protected: void makeNewEmptyMapWithMapToOverride (const MapFor_nonterminalMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

/*  protected: MapRootFor_nonterminalMap getOverridenMap (void) const {
    MapRootFor_nonterminalMap result ;
    if (isValid ()) {
      result = mSharedRoot->mOverriddenRoot ;
    }
    return result ;
  ...
  protected: void getOverridenMap (class MapFor_nonterminalMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const ;
...
class GGS_nonterminalMap : public MapFor_nonterminalMap {
//--------------------------------- Default constructor
...
class MapRootFor_uselessEntityLocationMap ;

//--------------------------------------------------------------------------------------------------
//  MapFor_uselessEntityLocationMap
//--------------------------------------------------------------------------------------------------

class MapFor_uselessEntityLocationMap : public AC_GALGAS_root {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  private: OptionalSharedRef <MapRootFor_uselessEntityLocationMap > mSharedRoot ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Default constructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_uselessEntityLocationMap (void) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  //   Destructor
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: virtual ~ MapFor_uselessEntityLocationMap (void) ;
  ...
  public: MapFor_uselessEntityLocationMap (const MapFor_uselessEntityLocationMap & inSource) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: MapFor_uselessEntityLocationMap & operator = (const MapFor_uselessEntityLocationMap & inSource) ;
  ...
  protected: OptionalSharedRef <class MapNodeFor_uselessEntityLocationMap> nodeForKey (const String & inKey) const ;
  ...
  protected: void makeNewEmptyMapWithMapToOverride (const MapFor_uselessEntityLocationMap & inOverridenMap
                                                    COMMA_LOCATION_ARGS) ;

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

/*  protected: MapRootFor_uselessEntityLocationMap getOverridenMap (void) const {
    MapRootFor_uselessEntityLocationMap result ;
    if (isValid ()) {
      result = mSharedRoot->mOverriddenRoot ;
    }
    return result ;
  ...
  protected: void getOverridenMap (class MapFor_uselessEntityLocationMap & ioResult,
                                   Compiler * inCompiler
                                   COMMA_LOCATION_ARGS) const ;
...
class GGS_uselessEntityLocationMap : public MapFor_uselessEntityLocationMap {
//--------------------------------- Default constructor
