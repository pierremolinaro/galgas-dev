...
//--- 'parse' label
  public: virtual void nt_replace_5F_declaration_parse (Lexique_galgasScanner_34_ * inCompiler) ;

//--- indexing
  public: virtual void nt_replace_5F_declaration_indexing (Lexique_galgasScanner_34_ * inCompiler) ;
