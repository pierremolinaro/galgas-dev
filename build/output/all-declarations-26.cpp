...
void routine_addExtensions (const GALGAS_extensionMethodMapForBuildingContext constinArgument_inExtensionMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_extensionGetterMapForType var_extensionGetterMapForType_19416 ;
      constinArgument_inExtensionGetterMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionGetterMapForType_19416, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 423)) ;
      cEnumerator_extensionGetterMapForType enumerator_19473 (var_extensionGetterMapForType_19416, kENUMERATION_UP) ;
      while (enumerator_19473.hasCurrentObject ()) {
        GALGAS_functionSignature var_formalArgumentList_19554 = GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 425)) ;
        cEnumerator_formalInputParameterListAST enumerator_19634 (enumerator_19473.current_mInputFormalParameterList (HERE), kENUMERATION_UP) ;
        while (enumerator_19634.hasCurrentObject ()) {
          GALGAS_unifiedTypeMap_2D_entry var_typeIndex_19777 ;
          {
          GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_19634.current_mFormalArgumentTypeName (HERE), var_typeIndex_19777 COMMA_SOURCE_FILE ("semanticContext.galgas", 427)) ;
          }
          var_formalArgumentList_19554.addAssign_operation (enumerator_19634.current_mFormalSelector (HERE), var_typeIndex_19777, enumerator_19634.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 428)) ;
          enumerator_19634.gotoNextObject () ;
        }
        GALGAS_unifiedTypeMap_2D_entry var_returnedType_19977 ;
        {
        GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_19473.current_mResultTypeName (HERE), var_returnedType_19977 COMMA_SOURCE_FILE ("semanticContext.galgas", 430)) ;
        }
        {
        ioArgument_ioGetterMap.setter_insertKey (enumerator_19473.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 433)), var_formalArgumentList_19554, enumerator_19473.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), var_returnedType_19977, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 438)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 431)) ;
        }
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_extensionMethodMapForType var_extensionMethodMapForType_20420 ;
      constinArgument_inExtensionMethodMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionMethodMapForType_20420, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 446)) ;
      cEnumerator_extensionMethodMapForType enumerator_20549 (var_extensionMethodMapForType_20420, kENUMERATION_UP) ;
      while (enumerator_20549.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_formalArgumentList_20611 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 448)) ;
        cEnumerator_formalParameterListAST enumerator_20741 (enumerator_20549.current_mFormalParameterList (HERE), kENUMERATION_UP) ;
        while (enumerator_20741.hasCurrentObject ()) {
          GALGAS_unifiedTypeMap_2D_entry var_typeIndex_20931 ;
          {
          GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_20741.current_mFormalArgumentTypeName (HERE), var_typeIndex_20931 COMMA_SOURCE_FILE ("semanticContext.galgas", 450)) ;
          }
          var_formalArgumentList_20611.addAssign_operation (enumerator_20741.current_mFormalSelector (HERE), var_typeIndex_20931, enumerator_20741.current_mFormalArgumentPassingMode (HERE), enumerator_20741.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 455)) ;
          enumerator_20741.gotoNextObject () ;
        }
        {
        ioArgument_ioInstanceMethodMap.setter_insertKey (enumerator_20549.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 459)), var_formalArgumentList_20611, enumerator_20549.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 463)), GALGAS_instanceMethodMutability::constructor_constantMethod (SOURCE_FILE ("semanticContext.galgas", 464)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 457)) ;
        }
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      GALGAS_extensionSetterMapForType var_extensionSetterMapForType_21518 ;
      constinArgument_inExtensionSetterMapForBuildingContext.method_searchKey (constinArgument_inTypeName, var_extensionSetterMapForType_21518, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 472)) ;
      cEnumerator_extensionSetterMapForType enumerator_21647 (var_extensionSetterMapForType_21518, kENUMERATION_UP) ;
      while (enumerator_21647.hasCurrentObject ()) {
        GALGAS_formalParameterSignature var_formalArgumentList_21735 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 474)) ;
        cEnumerator_formalParameterListAST enumerator_21840 (enumerator_21647.current_mFormalParameterList (HERE), kENUMERATION_UP) ;
        while (enumerator_21840.hasCurrentObject ()) {
          GALGAS_unifiedTypeMap_2D_entry var_typeIndex_21978 ;
          {
          GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_21840.current_mFormalArgumentTypeName (HERE), var_typeIndex_21978 COMMA_SOURCE_FILE ("semanticContext.galgas", 476)) ;
          }
          var_formalArgumentList_21735.addAssign_operation (enumerator_21840.current_mFormalSelector (HERE), var_typeIndex_21978, enumerator_21840.current_mFormalArgumentPassingMode (HERE), enumerator_21840.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 477)) ;
          enumerator_21840.gotoNextObject () ;
        }
        {
        ioArgument_ioSetterMap.setter_insertKey (enumerator_21647.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 481)), var_formalArgumentList_21735, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 484)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 479)) ;
        }
        {
        ioArgument_ioInstanceMethodMap.setter_insertKey (enumerator_21647.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsExtension (SOURCE_FILE ("semanticContext.galgas", 489)), var_formalArgumentList_21735, enumerator_21647.current_lkey (HERE).readProperty_location (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.galgas", 493)), GALGAS_instanceMethodMutability::constructor_mutatingMethod (SOURCE_FILE ("semanticContext.galgas", 494)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 487)) ;
        }
        ...
        if (kBoolTrue == test_3) {
          ...
          if (kBoolTrue == test_3) {
            ...
            inCompiler->emitSemanticError (enumerator_21647.current_lkey (HERE).readProperty_location (), GALGAS_string ("a refclass does not accept any setter; use method instead"), fixItArray4  COMMA_SOURCE_FILE ("semanticContext.galgas", 498)) ;
          }
        }
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  GALGAS_uint var_currentDirectoryIndex_25187 = ioArgument_ioWrapperDirectoryIndex ;
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 563)) ;
  GALGAS_stringlist var_files_25296 = constinArgument_inAbsoluteSourcePath.getter_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 565)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 566)) ;
  cEnumerator_stringlist enumerator_25380 (var_files_25296, kENUMERATION_UP) ;
  while (enumerator_25380.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = constinArgument_inTextFileExtensionMap.getter_hasKey (enumerator_25380.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 568)) COMMA_SOURCE_FILE ("semanticContext.galgas", 568)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_absoluteFilePath_25496 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 569)).add_operation (enumerator_25380.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 569)) ;
        {
        outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_25380.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 571))  COMMA_SOURCE_FILE ("semanticContext.galgas", 571)), var_absoluteFilePath_25496, GALGAS_bool (true), var_currentDirectoryIndex_25187, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 570)) ;
        }
    ...
    if (kBoolFalse == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = constinArgument_inBinaryFileExtensionMap.getter_hasKey (enumerator_25380.current_mValue (HERE).getter_pathExtension (SOURCE_FILE ("semanticContext.galgas", 578)) COMMA_SOURCE_FILE ("semanticContext.galgas", 578)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_string var_absoluteFilePath_25874 = constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 579)).add_operation (enumerator_25380.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 579)) ;
          {
          outArgument_outWrapperFileMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_25380.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 581))  COMMA_SOURCE_FILE ("semanticContext.galgas", 581)), var_absoluteFilePath_25874, GALGAS_bool (false), var_currentDirectoryIndex_25187, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 580)) ;
          }
  ...
  GALGAS_stringlist var_directories_26227 = constinArgument_inAbsoluteSourcePath.getter_directories (GALGAS_bool (false) COMMA_SOURCE_FILE ("semanticContext.galgas", 591)) ;
  ...
  cEnumerator_stringlist enumerator_26315 (var_directories_26227, kENUMERATION_UP) ;
  while (enumerator_26315.hasCurrentObject ()) {
    GALGAS_wrapperFileMap var_internalWrapperFileMap_26381 ;
    GALGAS_wrapperDirectoryMap var_internalWrapperDirectoryMap_26438 ;
    GALGAS_uint var_theDirectoryIndex_26470 = ioArgument_ioWrapperDirectoryIndex ;
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 598)).add_operation (enumerator_26315.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 598)), constinArgument_inPathInWrapper.add_operation (enumerator_26315.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 599)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 599)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap_26381, var_internalWrapperDirectoryMap_26438, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 597)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.setter_insertKey (GALGAS_lstring::constructor_new (enumerator_26315.current_mValue (HERE), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 608))  COMMA_SOURCE_FILE ("semanticContext.galgas", 608)), var_internalWrapperFileMap_26381, var_internalWrapperDirectoryMap_26438, var_theDirectoryIndex_26470, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 607)) ;
    }
...
static void extensionMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap_27568 = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 625)) ;
  const GALGAS_filewrapperDeclarationAST temp_0 = object ;
  cEnumerator_filewrapperTemplateListAST enumerator_27672 (temp_0.readProperty_mFilewrapperTemplateList (), kENUMERATION_UP) ;
  while (enumerator_27672.hasCurrentObject ()) {
    GALGAS_functionSignature var_templateSignature_27754 = GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 627)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_27838 (enumerator_27672.current_mFilewrapperTemplateFormalInputParameters (HERE), kENUMERATION_UP) ;
    while (enumerator_27838.hasCurrentObject ()) {
      GALGAS_unifiedTypeMap_2D_entry var_parameterTypeIndex_28004 ;
      {
      GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_27838.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_28004 COMMA_SOURCE_FILE ("semanticContext.galgas", 629)) ;
      }
      var_templateSignature_27754.addAssign_operation (enumerator_27838.current_mFormalTemplateSelector (HERE), var_parameterTypeIndex_28004, enumerator_27838.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 630)) ;
      enumerator_27838.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap_27568.setter_insertKey (enumerator_27672.current_mFilewrapperTemplateName (HERE), var_templateSignature_27754, enumerator_27672.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 632)) ;
    }
    enumerator_27672.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap_28333 = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 639)) ;
  const GALGAS_filewrapperDeclarationAST temp_1 = object ;
  cEnumerator_lstringlist enumerator_28352 (temp_1.readProperty_mFilewrapperTextFileExtensionList (), kENUMERATION_UP) ;
  while (enumerator_28352.hasCurrentObject ()) {
    {
    var_textExtensionMap_28333.setter_insertKey (enumerator_28352.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 641)) ;
    }
    enumerator_28352.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap_28534 = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 644)) ;
  const GALGAS_filewrapperDeclarationAST temp_2 = object ;
  cEnumerator_lstringlist enumerator_28553 (temp_2.readProperty_mFilewrapperBinaryFileExtensionList (), kENUMERATION_UP) ;
  while (enumerator_28553.hasCurrentObject ()) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = var_textExtensionMap_28333.getter_hasKey (enumerator_28553.current_mValue (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticContext.galgas", 646)).boolEnum () ;
      if (kBoolTrue == test_3) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (enumerator_28553.current_mValue (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_28553.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 647)).add_operation (GALGAS_string ("' extension is already used for text files"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 647)), fixItArray4  COMMA_SOURCE_FILE ("semanticContext.galgas", 647)) ;
      }
    }
    if (kBoolFalse == test_3) {
      {
      var_binaryFileExtensionMap_28534.setter_insertKey (enumerator_28553.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 649)) ;
      }
    }
    enumerator_28553.gotoNextObject () ;
  }
  GALGAS_wrapperFileMap var_regularRootFileMap_28883 ;
  GALGAS_wrapperDirectoryMap var_wrapperDirectoryMap_28930 ;
  GALGAS_string var_absoluteSourcePath_28963 ;
  ...
  if (kBoolTrue == test_5) {
    ...
    if (kBoolTrue == test_5) {
      ...
      var_absoluteSourcePath_28963 = temp_7.readProperty_mFilewrapperPath ().readProperty_string () ;
    }
  }
  if (kBoolFalse == test_5) {
    const GALGAS_filewrapperDeclarationAST temp_8 = object ;
    const GALGAS_filewrapperDeclarationAST temp_9 = object ;
    var_absoluteSourcePath_28963 = temp_8.readProperty_mSourceFileAbsolutePath ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("semanticContext.galgas", 659)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 659)).add_operation (temp_9.readProperty_mFilewrapperPath ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 659)) ;
  }
  enumGalgasBool test_10 = kBoolTrue ;
  if (kBoolTrue == test_10) {
    test_10 = var_absoluteSourcePath_28963.getter_directoryExists (SOURCE_FILE ("semanticContext.galgas", 661)).operator_not (SOURCE_FILE ("semanticContext.galgas", 661)).boolEnum () ;
    if (kBoolTrue == test_10) {
      const GALGAS_filewrapperDeclarationAST temp_11 = object ;
      TC_Array <C_FixItDescription> fixItArray12 ;
      inCompiler->emitSemanticError (temp_11.readProperty_mFilewrapperPath ().readProperty_location (), GALGAS_string ("The '").add_operation (var_absoluteSourcePath_28963, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 662)).add_operation (GALGAS_string ("' directory does not exist"), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 662)), fixItArray12  COMMA_SOURCE_FILE ("semanticContext.galgas", 662)) ;
      var_regularRootFileMap_28883.drop () ; // Release error dropped variable
      var_wrapperDirectoryMap_28930.drop () ; // Release error dropped variable
    }
  }
  if (kBoolFalse == test_10) {
    GALGAS_uint var_wrapperFileIndex_29478 = GALGAS_uint ((uint32_t) 0U) ;
    GALGAS_uint var_wrapperDirectoryIndex_29518 = GALGAS_uint ((uint32_t) 0U) ;
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath_28963, GALGAS_string ("/"), var_textExtensionMap_28333, var_binaryFileExtensionMap_28534, var_regularRootFileMap_28883, var_wrapperDirectoryMap_28930, var_wrapperFileIndex_29478, var_wrapperDirectoryIndex_29518, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 668)) ;
    }
  }
  {
...
static void extensionMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature_30587 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 699)) ;
  const GALGAS_externRoutineDeclarationAST temp_0 = object ;
  cEnumerator_formalParameterListAST enumerator_30713 (temp_0.readProperty_mFormalArgumentList (), kENUMERATION_UP) ;
  while (enumerator_30713.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_entry var_parameterTypeIndex_30860 ;
    {
    GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_30713.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_30860 COMMA_SOURCE_FILE ("semanticContext.galgas", 701)) ;
    }
    var_routineSignature_30587.addAssign_operation (enumerator_30713.current_mFormalSelector (HERE), var_parameterTypeIndex_30860, enumerator_30713.current_mFormalArgumentPassingMode (HERE), enumerator_30713.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 702)) ;
  ...
  ioArgument_ioSemanticContext.mProperty_mRoutineMap.setter_insertKey (temp_1.readProperty_mRoutineName (), var_routineSignature_30587, temp_2.readProperty_mIsInternal (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 705)) ;
  }
}
...
static void extensionMethod_procDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_formalParameterSignature var_routineSignature_31676 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 720)) ;
  const GALGAS_procDeclarationAST temp_0 = object ;
  cEnumerator_formalParameterListAST enumerator_31802 (temp_0.readProperty_mFormalArgumentList (), kENUMERATION_UP) ;
  while (enumerator_31802.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_entry var_parameterTypeIndex_31949 ;
    {
    GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_31802.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_31949 COMMA_SOURCE_FILE ("semanticContext.galgas", 722)) ;
    }
    var_routineSignature_31676.addAssign_operation (enumerator_31802.current_mFormalSelector (HERE), var_parameterTypeIndex_31949, enumerator_31802.current_mFormalArgumentPassingMode (HERE), enumerator_31802.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 723)) ;
  ...
  ioArgument_ioSemanticContext.mProperty_mRoutineMap.setter_insertKey (temp_2.readProperty_mRoutineName (), var_routineSignature_31676, temp_3.readProperty_mIsInternal (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 728)) ;
  }
}
...
static void extensionMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_functionSignature var_functionSignature_32950 = GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 743)) ;
  const GALGAS_externFunctionDeclarationAST temp_0 = object ;
  cEnumerator_formalInputParameterListAST enumerator_33026 (temp_0.readProperty_mFormalArgumentList (), kENUMERATION_UP) ;
  while (enumerator_33026.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_entry var_parameterTypeIndex_33173 ;
    {
    GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_33026.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex_33173 COMMA_SOURCE_FILE ("semanticContext.galgas", 745)) ;
    }
    var_functionSignature_32950.addAssign_operation (enumerator_33026.current_mFormalSelector (HERE), var_parameterTypeIndex_33173, enumerator_33026.current_mFormalArgumentTypeName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 746)) ;
    enumerator_33026.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_resultTypeIndex_33398 ;
  {
  const GALGAS_externFunctionDeclarationAST temp_1 = object ;
  GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, temp_1.readProperty_mResultTypeName (), var_resultTypeIndex_33398 COMMA_SOURCE_FILE ("semanticContext.galgas", 749)) ;
  }
  {
  const GALGAS_externFunctionDeclarationAST temp_2 = object ;
  ioArgument_ioSemanticContext.mProperty_mFunctionMap.setter_insertKey (temp_2.readProperty_mFunctionName (), var_functionSignature_32950, var_resultTypeIndex_33398, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 751)) ;
  }
}
...
static void extensionMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_onceFunctionDeclarationAST * object = (const cPtr_onceFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_onceFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMap_2D_entry var_resultTypeIndex_34233 ;
  {
  const GALGAS_onceFunctionDeclarationAST temp_0 = object ;
  GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, temp_0.readProperty_mResultTypeName (), var_resultTypeIndex_34233 COMMA_SOURCE_FILE ("semanticContext.galgas", 767)) ;
  }
  {
  const GALGAS_onceFunctionDeclarationAST temp_1 = object ;
  const GALGAS_onceFunctionDeclarationAST temp_2 = object ;
  ioArgument_ioSemanticContext.mProperty_mFunctionMap.setter_insertKey (temp_1.readProperty_mFunctionName (), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 769)), var_resultTypeIndex_34233, temp_2.readProperty_mIsInternal (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 769)) ;
  }
}
...
static void extensionMethod_galgas_33_GrammarComponentAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_galgas_33_GrammarComponentAST * object = (const cPtr_galgas_33_GrammarComponentAST *) inObject ;
  macroValidSharedObject (object, cPtr_galgas_33_GrammarComponentAST) ;
  GALGAS_grammarLabelMap var_grammarLabelMap_35677 = GALGAS_grammarLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 798)) ;
  const GALGAS_galgas_33_GrammarComponentAST temp_0 = object ;
  cEnumerator_nonTerminalLabelListAST enumerator_35722 (temp_0.readProperty_mStartSymbolLabelList (), kENUMERATION_UP) ;
  while (enumerator_35722.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_formalArgumentList_35834 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 801)) ;
    cEnumerator_formalParameterListAST enumerator_35937 (enumerator_35722.current_mFormalArgumentList (HERE), kENUMERATION_UP) ;
    while (enumerator_35937.hasCurrentObject ()) {
      GALGAS_unifiedTypeMap_2D_entry var_argumentType_36075 ;
      {
      GALGAS_unifiedTypeMap_2D_entry::class_method_makeEntry (ioArgument_ioSemanticContext.mProperty_mTypeMap, enumerator_35937.current_mFormalArgumentTypeName (HERE), var_argumentType_36075 COMMA_SOURCE_FILE ("semanticContext.galgas", 803)) ;
      }
      var_formalArgumentList_35834.addAssign_operation (enumerator_35937.current_mFormalSelector (HERE), var_argumentType_36075, enumerator_35937.current_mFormalArgumentPassingMode (HERE), enumerator_35937.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 804)) ;
      enumerator_35937.gotoNextObject () ;
    }
    {
    var_grammarLabelMap_35677.setter_insertKey (enumerator_35722.current_mLabelName (HERE), var_formalArgumentList_35834, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 810)) ;
    }
  ...
  ioArgument_ioSemanticContext.mProperty_mGrammarMap.setter_insertGrammar (temp_1.readProperty_mGrammarComponentName (), var_grammarLabelMap_35677, temp_2.readProperty_mHasIndexing ().readProperty_bool (), temp_3.readProperty_mHasTranslateFeature (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 816)) ;
  }
}
...
static void extensionMethod_lexiqueComponentAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_lexiqueComponentAST * object = (const cPtr_lexiqueComponentAST *) inObject ;
  macroValidSharedObject (object, cPtr_lexiqueComponentAST) ;
  GALGAS_lexicalTypeMap var_lexicalTypeMap_37125 = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 832)) ;
  GALGAS_lexicalAttributeMap var_lexicalAttributeMap_37197 = GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 833)) ;
  {
  const GALGAS_lexiqueComponentAST temp_0 = object ;
  routine_buildLexicalAttributeMap (var_lexicalTypeMap_37125, temp_0.readProperty_mLexicalAttributeList (), var_lexicalAttributeMap_37197, inCompiler  COMMA_SOURCE_FILE ("semanticContext.galgas", 834)) ;
  }
  GALGAS_terminalMap var_terminalMap_37383 = GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.galgas", 840)) ;
  const GALGAS_lexiqueComponentAST temp_1 = object ;
  cEnumerator_terminalDeclarationListAST enumerator_37426 (temp_1.readProperty_mTerminalDeclarationList (), kENUMERATION_UP) ;
  while (enumerator_37426.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList_37488 = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 842)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_37554 (enumerator_37426.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_37554.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_37628 ;
      var_lexicalAttributeMap_37197.method_searchKey (enumerator_37554.current_mAttributeName (HERE), var_attributeLexicalType_37628, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 845)) ;
      var_argumentTypeList_37488.addAssign_operation (enumerator_37554.current_mFormalSelector (HERE), enumerator_37554.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_37628  COMMA_SOURCE_FILE ("semanticContext.galgas", 846)) ;
      enumerator_37554.gotoNextObject () ;
    }
    {
    var_terminalMap_37383.setter_insertKey (enumerator_37426.current_mName (HERE), var_argumentTypeList_37488, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 848)) ;
    }
    enumerator_37426.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_2 = object ;
  cEnumerator_lexicalListDeclarationListAST enumerator_37909 (temp_2.readProperty_mLexicalListDeclarationList (), kENUMERATION_UP) ;
  while (enumerator_37909.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList_37974 = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticContext.galgas", 852)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_38040 (enumerator_37909.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_38040.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_38114 ;
      var_lexicalAttributeMap_37197.method_searchKey (enumerator_38040.current_mAttributeName (HERE), var_attributeLexicalType_38114, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 855)) ;
      var_argumentTypeList_37974.addAssign_operation (enumerator_38040.current_mFormalSelector (HERE), enumerator_38040.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_38114  COMMA_SOURCE_FILE ("semanticContext.galgas", 856)) ;
      enumerator_38040.gotoNextObject () ;
    }
    cEnumerator_lexicalListEntryListAST enumerator_38317 (enumerator_37909.current_mEntryList (HERE), kENUMERATION_UP) ;
    while (enumerator_38317.hasCurrentObject ()) {
      {
      var_terminalMap_37383.setter_insertKey (enumerator_38317.current_mTerminalSpelling (HERE), var_argumentTypeList_37974, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 859)) ;
      }
      enumerator_38317.gotoNextObject () ;
    }
    enumerator_37909.gotoNextObject () ;
  }
  {
  ...
  ioArgument_ioSemanticContext.mProperty_mLexiqueComponentMapForSemanticAnalysis.setter_insertKey (temp_3.readProperty_mLexiqueComponentName (), var_terminalMap_37383, temp_4.readProperty_mIndexingListAST (), temp_5.readProperty_mIndexingDirectory (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 863)) ;
  }
}
...
static void extensionMethod_galgas_33_GrammarComponentAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_galgas_33_GrammarComponentAST temp_0 = object ;
  const GALGAS_galgas_33_GrammarComponentAST temp_1 = object ;
  GALGAS_lstring var_key_40520 = GALGAS_lstring::constructor_new (GALGAS_string ("grammar ").add_operation (temp_0.readProperty_mGrammarComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 902)), temp_1.readProperty_mGrammarComponentName ().readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 902)) ;
  {
  const GALGAS_galgas_33_GrammarComponentAST temp_2 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_40520, temp_2, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 903)) ;
  }
  const GALGAS_galgas_33_GrammarComponentAST temp_3 = object ;
  cEnumerator_lstringlist enumerator_40679 (temp_3.readProperty_mSyntaxComponents (), kENUMERATION_UP) ;
  while (enumerator_40679.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_40520, GALGAS_lstring::constructor_new (GALGAS_string ("syntax ").add_operation (enumerator_40679.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 905)), enumerator_40679.current_mValue (HERE).readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 905)) COMMA_SOURCE_FILE ("semanticContext.galgas", 905)) ;
    }
    enumerator_40679.gotoNextObject () ;
  }
}
...
static void extensionMethod_galgas_33_SyntaxComponentAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_galgas_33_SyntaxComponentAST temp_0 = object ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_1 = object ;
  GALGAS_lstring var_key_41413 = GALGAS_lstring::constructor_new (GALGAS_string ("syntax ").add_operation (temp_0.readProperty_mSyntaxComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 917)), temp_1.readProperty_mSyntaxComponentName ().readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 917)) ;
  {
  const GALGAS_galgas_33_SyntaxComponentAST temp_2 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_41413, temp_2, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 918)) ;
  }
  {
  const GALGAS_galgas_33_SyntaxComponentAST temp_3 = object ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_4 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_41413, GALGAS_lstring::constructor_new (GALGAS_string ("lexique ").add_operation (temp_3.readProperty_mLexiqueName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 919)), temp_4.readProperty_mLexiqueName ().readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 919)) COMMA_SOURCE_FILE ("semanticContext.galgas", 919)) ;
  }
  const GALGAS_galgas_33_SyntaxComponentAST temp_5 = object ;
  cEnumerator_syntaxRuleListAST enumerator_41705 (temp_5.readProperty_mRuleList (), kENUMERATION_UP) ;
  while (enumerator_41705.hasCurrentObject ()) {
    cEnumerator_syntaxRuleLabelListAST enumerator_41761 (enumerator_41705.current_mLabelList (HERE), kENUMERATION_UP) ;
    while (enumerator_41761.hasCurrentObject ()) {
      cEnumerator_formalParameterListAST enumerator_41847 (enumerator_41761.current_mFormalArguments (HERE), kENUMERATION_UP) ;
      while (enumerator_41847.hasCurrentObject ()) {
        switch (enumerator_41847.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
        case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
          break ;
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn:
          {
            {
            ioArgument_ioSemanticTypePrecedenceGraph.setter_addEdge (var_key_41413, GALGAS_lstring::constructor_new (GALGAS_string ("@").add_operation (enumerator_41847.current_mFormalArgumentTypeName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 924)), enumerator_41847.current_mFormalArgumentTypeName (HERE).readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 924)) COMMA_SOURCE_FILE ("semanticContext.galgas", 924)) ;
            }
          }
          break ;
        ...
        enumerator_41847.gotoNextObject () ;
      }
...
static void extensionMethod_lexiqueComponentAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const GALGAS_lexiqueComponentAST temp_0 = object ;
  const GALGAS_lexiqueComponentAST temp_1 = object ;
  GALGAS_lstring var_key_42769 = GALGAS_lstring::constructor_new (GALGAS_string ("lexique ").add_operation (temp_0.readProperty_mLexiqueComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 940)), temp_1.readProperty_mLexiqueComponentName ().readProperty_location ()  COMMA_SOURCE_FILE ("semanticContext.galgas", 940)) ;
  {
  const GALGAS_lexiqueComponentAST temp_2 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.setter_addNode (var_key_42769, temp_2, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 941)) ;
  }
}
...
void routine_analyzeRoutineBody (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outRoutineSignature.drop () ; // Release 'out' argument
  GALGAS_localVarManager var_variableMap_10733 = GALGAS_localVarManager::constructor_emptySharedMap (SOURCE_FILE ("semanticAnalysis.galgas", 184)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inAnalysisContext.readProperty_requiresSelfForAccessingProperty ().operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 187)).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_typedPropertyList enumerator_10990 (constinArgument_inNonMutableTypedAttributeList, kENUMERATION_UP) ;
      while (enumerator_10990.hasCurrentObject ()) {
        {
        var_variableMap_10733.setter_insertNonMutableProperty (enumerator_10990.current_mPropertyName (HERE), enumerator_10990.current_mPropertyTypeEntry (HERE), constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 192)).add_operation (enumerator_10990.current_mPropertyName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 192)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 192)), constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 189)) ;
        }
  ...
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = constinArgument_inAnalysisContext.readProperty_requiresSelfForAccessingProperty ().operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 199)).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_typedPropertyList enumerator_11551 (constinArgument_inMutableTypedAttributeList, kENUMERATION_UP) ;
      while (enumerator_11551.hasCurrentObject ()) {
        {
        var_variableMap_10733.setter_insertMutableProperty (enumerator_11551.current_mPropertyName (HERE), enumerator_11551.current_mPropertyTypeEntry (HERE), constinArgument_inAnalysisContext.readProperty_mSelfObjectCppPrefixForAccessingProperty ().add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 204)).add_operation (enumerator_11551.current_mPropertyName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 204)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 204)), constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 201)) ;
        }
  ...
  {
  routine_buildLocalVariableMapAndSignature (constinArgument_inAnalysisContext.readProperty_mSemanticContext (), constinArgument_inRoutineSignatureAST, var_variableMap_10733, outArgument_outRoutineSignature, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 210)) ;
  }
  ...
  cEnumerator_semanticInstructionListAST enumerator_12196 (constinArgument_inInstructionList, kENUMERATION_UP) ;
  while (enumerator_12196.hasCurrentObject ()) {
    callExtensionMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_12196.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap_10733, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 219)) ;
    enumerator_12196.gotoNextObject () ;
  }
  var_variableMap_10733.method_checkAutomatonStates (constinArgument_inEndOfMethodLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 228)) ;
}
...
static void extensionMethod_externFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  const GALGAS_externFunctionDeclarationAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_13054 = function_functionNameForUsefulEntitiesGraph (temp_0.readProperty_mFunctionName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 242)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_13054, var_nameForUsefulness_13054, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 243)) ;
  }
  GALGAS_formalInputParameterListForGeneration var_formalArgumentList_13217 = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 245)) ;
  const GALGAS_externFunctionDeclarationAST temp_1 = object ;
  cEnumerator_formalInputParameterListAST enumerator_13341 (temp_1.readProperty_mFormalArgumentList (), kENUMERATION_UP) ;
  while (enumerator_13341.hasCurrentObject ()) {
    var_formalArgumentList_13217.addAssign_operation (enumerator_13341.current_mFormalSelector (HERE), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_13341.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 249)), enumerator_13341.current_mFormalArgumentName (HERE).readProperty_string (), enumerator_13341.current_mFormalArgumentName (HERE), enumerator_13341.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 247)) ;
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("extern func ").add_operation (temp_2.readProperty_mFunctionName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 255)), GALGAS_functionPrototypeDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("func-").add_operation (temp_3.readProperty_mFunctionName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 258)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 258)), temp_4.readProperty_mFunctionName ().readProperty_string (), var_formalArgumentList_13217, GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), temp_5.readProperty_mResultTypeName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 261))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 256))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 254)) ;
}
...
static void extensionMethod_externRoutineDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  const GALGAS_externRoutineDeclarationAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_14542 = function_procedureNameForUsefulEntitiesGraph (temp_0.readProperty_mRoutineName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 275)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_14542, var_nameForUsefulness_14542, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 276)) ;
  }
  GALGAS_formalParameterListForGeneration var_formalArgumentList_14705 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 278)) ;
  const GALGAS_externRoutineDeclarationAST temp_1 = object ;
  cEnumerator_formalParameterListAST enumerator_14839 (temp_1.readProperty_mFormalArgumentList (), kENUMERATION_UP) ;
  while (enumerator_14839.hasCurrentObject ()) {
    var_formalArgumentList_14705.addAssign_operation (enumerator_14839.current_mFormalSelector (HERE), enumerator_14839.current_mFormalArgumentPassingMode (HERE), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_14839.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 283)), enumerator_14839.current_mFormalArgumentName (HERE), enumerator_14839.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 280)) ;
...
static void extensionMethod_procDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_procDeclarationAST) ;
  const GALGAS_procDeclarationAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_15944 = function_procedureNameForUsefulEntitiesGraph (temp_0.readProperty_mRoutineName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 307)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_15944, var_nameForUsefulness_15944, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 308)) ;
  }
  GALGAS_formalParameterListForGeneration var_formalArgumentList_16124 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 310)) ;
  GALGAS_semanticInstructionListForGeneration var_instructionList_16222 ;
  GALGAS_analysisContext var_analysisContext_16244 = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_string::makeEmptyString (), GALGAS_selfAvailability::constructor_none (SOURCE_FILE ("semanticAnalysis.galgas", 316)), GALGAS_string::makeEmptyString (), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 312)) ;
  {
  const GALGAS_procDeclarationAST temp_1 = object ;
  const GALGAS_procDeclarationAST temp_2 = object ;
  const GALGAS_procDeclarationAST temp_3 = object ;
  routine_analyzeRoutineBody (var_nameForUsefulness_15944, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_16244, temp_1.readProperty_mFormalArgumentList (), GALGAS_typedPropertyList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 325)), GALGAS_typedPropertyList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 326)), temp_2.readProperty_mRoutineInstructionList (), temp_3.readProperty_mEndOfRoutineInstructionList (), var_instructionList_16222, var_formalArgumentList_16124, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 320)) ;
  }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("proc ").add_operation (temp_4.readProperty_mRoutineName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 334)), GALGAS_routineImplementationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("proc-").add_operation (temp_5.readProperty_mRoutineName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 337)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 337)), temp_6.readProperty_mRoutineName ().readProperty_string (), var_formalArgumentList_16124, GALGAS_bool (false), var_instructionList_16222  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 335))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 333)) ;
}
...
void routine_analyzeFunctionBody (const GALGAS_lstring constinArgument_inUsefulnessCallerEntityName,
  ...
  outArgument_outSemanticInstructionListForGeneration.drop () ; // Release 'out' argument
  GALGAS_localVarManager var_variableMap_17981 = GALGAS_localVarManager::constructor_emptySharedMap (SOURCE_FILE ("semanticAnalysis.galgas", 363)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inAnalysisContext.readProperty_requiresSelfForAccessingProperty ().operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 366)).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_typedPropertyList enumerator_18226 (constinArgument_inTypedAttributeList, kENUMERATION_UP) ;
      while (enumerator_18226.hasCurrentObject ()) {
        {
        var_variableMap_17981.setter_insertNonMutableProperty (enumerator_18226.current_mPropertyName (HERE), enumerator_18226.current_mPropertyTypeEntry (HERE), constinArgument_inAttributeVariableNamePrefix.add_operation (GALGAS_string ("mProperty_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 371)).add_operation (enumerator_18226.current_mPropertyName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 371)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 371)), constinArgument_inAnalysisContext.readProperty_mSelfObjectCppName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 368)) ;
        }
        enumerator_18226.gotoNextObject () ;
      }
    }
  }
  outArgument_outSignatureForGeneration = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 377)) ;
  cEnumerator_formalInputParameterListAST enumerator_18712 (constinArgument_inFunctionSignature, kENUMERATION_UP) ;
  while (enumerator_18712.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_entry var_parameterType_18761 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), enumerator_18712.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 379)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = enumerator_18712.current_mIsConstant (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_cppName_18917 = GALGAS_string ("constinArgument_").add_operation (enumerator_18712.current_mFormalArgumentName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 381)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 381)) ;
        outArgument_outSignatureForGeneration.addAssign_operation (enumerator_18712.current_mFormalSelector (HERE), var_parameterType_18761, var_cppName_18917, enumerator_18712.current_mFormalArgumentName (HERE), enumerator_18712.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 382)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = enumerator_18712.current_mIsUnused (HERE).boolEnum () ;
          if (kBoolTrue == test_2) {
            {
            var_variableMap_17981.setter_insertConstantInputFormalArgumentDeclaredAsUnused (enumerator_18712.current_mFormalArgumentName (HERE), var_parameterType_18761, var_cppName_18917, var_cppName_18917, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 389)) ;
            }
          }
        }
        if (kBoolFalse == test_2) {
          {
          var_variableMap_17981.setter_insertConstantInputFormalArgument (enumerator_18712.current_mFormalArgumentName (HERE), var_parameterType_18761, var_cppName_18917, var_cppName_18917, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 391)) ;
          }
        }
      }
    }
    if (kBoolFalse == test_1) {
      GALGAS_string var_cppName_19464 = GALGAS_string ("inArgument_").add_operation (enumerator_18712.current_mFormalArgumentName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 394)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 394)) ;
      outArgument_outSignatureForGeneration.addAssign_operation (enumerator_18712.current_mFormalSelector (HERE), var_parameterType_18761, var_cppName_19464, enumerator_18712.current_mFormalArgumentName (HERE), enumerator_18712.current_mIsConstant (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 395)) ;
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = enumerator_18712.current_mIsUnused (HERE).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          var_variableMap_17981.setter_insertInputFormalArgumentDeclaredAsUnused (enumerator_18712.current_mFormalArgumentName (HERE), var_parameterType_18761, var_cppName_19464, var_cppName_19464, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 402)) ;
          }
        }
      }
      if (kBoolFalse == test_3) {
        {
        var_variableMap_17981.setter_insertInputFormalArgument (enumerator_18712.current_mFormalArgumentName (HERE), var_parameterType_18761, var_cppName_19464, var_cppName_19464, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 404)) ;
        }
      }
    }
    enumerator_18712.gotoNextObject () ;
  }
  outArgument_outReturnedType = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), constinArgument_inResultTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 409)) ;
  outArgument_outResultVariableCppName = GALGAS_string ("result_").add_operation (constinArgument_inReturnVariableName.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 410)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 410)) ;
  {
  var_variableMap_17981.setter_insertOutputFormalArgument (constinArgument_inReturnVariableName, outArgument_outReturnedType, outArgument_outResultVariableCppName, outArgument_outResultVariableCppName, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 411)) ;
  }
  outArgument_outSemanticInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 413)) ;
  cEnumerator_semanticInstructionListAST enumerator_20474 (constinArgument_inInstructionList, kENUMERATION_UP) ;
  while (enumerator_20474.hasCurrentObject ()) {
    callExtensionMethod_analyzeSemanticInstruction ((const cPtr_semanticInstructionAST *) enumerator_20474.current_mInstruction (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, outArgument_outSemanticInstructionListForGeneration, var_variableMap_17981, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 415)) ;
    enumerator_20474.gotoNextObject () ;
  }
  var_variableMap_17981.method_checkAutomatonStates (constinArgument_inEndOfFunctionLocation, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 424)) ;
}
...
static void extensionMethod_functionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_lstring var_nameForUsefulness_21314 = function_functionNameForUsefulEntitiesGraph (temp_0.readProperty_mFunctionName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 438)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_21314, var_nameForUsefulness_21314, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 439)) ;
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      ioArgument_ioUsefulnessRootEntities.addAssign_operation (var_nameForUsefulness_21314  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 441)) ;
    }
  }
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration_21640 ;
  GALGAS_formalInputParameterListForGeneration var_formalInputParameterList_21710 ;
  GALGAS_unifiedTypeMap_2D_entry var_returnType_21749 ;
  GALGAS_string var_resultVariableCppName_21785 ;
  GALGAS_analysisContext var_analysisContext_21807 = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_string::makeEmptyString (), GALGAS_selfAvailability::constructor_none (SOURCE_FILE ("semanticAnalysis.galgas", 452)), GALGAS_string::makeEmptyString (), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 448)) ;
  {
  ...
  routine_analyzeFunctionBody (var_nameForUsefulness_21314, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_21807, temp_3.readProperty_mFormalArgumentList (), GALGAS_typedPropertyList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 461)), GALGAS_string::makeEmptyString (), temp_4.readProperty_mFunctionInstructionList (), temp_5.readProperty_mResultVariableName (), temp_6.readProperty_mResultTypeName (), temp_7.readProperty_mEndOfFunctionInstructionList (), var_formalInputParameterList_21710, var_returnType_21749, var_resultVariableCppName_21785, var_semanticInstructionListForGeneration_21640, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 456)) ;
  }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("function ").add_operation (temp_8.readProperty_mFunctionName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 474)), GALGAS_functionImplementationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("func-").add_operation (temp_9.readProperty_mFunctionName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 477)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 477)), temp_10.readProperty_mFunctionName ().readProperty_string (), var_formalInputParameterList_21710, var_returnType_21749, var_resultVariableCppName_21785, var_semanticInstructionListForGeneration_21640  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 475))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 473)) ;
}
...
static void extensionMethod_onceFunctionDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_onceFunctionDeclarationAST) ;
  const GALGAS_onceFunctionDeclarationAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_23350 = function_functionNameForUsefulEntitiesGraph (temp_0.readProperty_mFunctionName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 497)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_23350, var_nameForUsefulness_23350, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 498)) ;
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_onceFunctionDeclarationAST temp_2 = object ;
    test_1 = temp_2.readProperty_mIsUsefull ().boolEnum () ;
    if (kBoolTrue == test_1) {
      ioArgument_ioUsefulnessRootEntities.addAssign_operation (var_nameForUsefulness_23350  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 500)) ;
    }
  }
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration_23676 ;
  GALGAS_unifiedTypeMap_2D_entry var_returnType_23715 ;
  GALGAS_string var_resultVariableCppName_23751 ;
  GALGAS_analysisContext var_analysisContext_23773 = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, GALGAS_string::makeEmptyString (), GALGAS_selfAvailability::constructor_none (SOURCE_FILE ("semanticAnalysis.galgas", 510)), GALGAS_string::makeEmptyString (), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 506)) ;
  {
  ...
  GALGAS_formalInputParameterListForGeneration joker_24274 ; // Joker input parameter
  routine_analyzeFunctionBody (var_nameForUsefulness_23350, ioArgument_ioUsefulEntitiesGraph, var_analysisContext_23773, GALGAS_formalInputParameterListAST::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 518)), GALGAS_typedPropertyList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 519)), GALGAS_string::makeEmptyString (), temp_3.readProperty_mFunctionInstructionList (), temp_4.readProperty_mResultVariableName (), temp_5.readProperty_mResultTypeName (), temp_6.readProperty_mEndOfFunctionInstructionList (), joker_24274, var_returnType_23715, var_resultVariableCppName_23751, var_semanticInstructionListForGeneration_23676, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 514)) ;
  }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("once function ").add_operation (temp_7.readProperty_mFunctionName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 532)), GALGAS_onceFunctionDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("func-").add_operation (temp_8.readProperty_mFunctionName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 535)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 535)), temp_9.readProperty_mFunctionName ().readProperty_string (), var_returnType_23715, var_resultVariableCppName_23751, var_semanticInstructionListForGeneration_23676  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 533))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 531)) ;
}
...
static void extensionMethod_filewrapperDeclarationAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_filewrapperDeclarationAST) ;
  const GALGAS_filewrapperDeclarationAST temp_0 = object ;
  GALGAS_lstring var_filewrapperNameForUsefulness_25614 = function_filewrapperNameForUsefulEntitiesGraph (temp_0.readProperty_mFilewrapperName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 557)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_filewrapperNameForUsefulness_25614, var_filewrapperNameForUsefulness_25614, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 558)) ;
  }
  GALGAS_wrapperFileMap var_wrapperFileMap_25933 ;
  GALGAS_wrapperDirectoryMap var_wrapperDirectoryMap_25983 ;
  const GALGAS_filewrapperDeclarationAST temp_1 = object ;
  GALGAS_lstring joker_25885 ; // Joker input parameter
  GALGAS_lstringlist joker_25892 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_25989_2 ; // Joker input parameter
  GALGAS_bool joker_25989_1 ; // Joker input parameter
  constinArgument_inSemanticContext.readProperty_mFilewrapperMap ().method_searchKey (temp_1.readProperty_mFilewrapperName (), joker_25885, joker_25892, var_wrapperFileMap_25933, var_wrapperDirectoryMap_25983, joker_25989_2, joker_25989_1, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 560)) ;
  GALGAS_string var_absoluteSourcePath_26053 ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    const GALGAS_filewrapperDeclarationAST temp_3 = object ;
    test_2 = GALGAS_bool (kIsEqual, temp_3.readProperty_mFilewrapperPath ().readProperty_string ().getter_firstCharacterOrNul (SOURCE_FILE ("semanticAnalysis.galgas", 570)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      const GALGAS_filewrapperDeclarationAST temp_4 = object ;
      var_absoluteSourcePath_26053 = temp_4.readProperty_mFilewrapperPath ().readProperty_string () ;
    }
  }
  if (kBoolFalse == test_2) {
    const GALGAS_filewrapperDeclarationAST temp_5 = object ;
    const GALGAS_filewrapperDeclarationAST temp_6 = object ;
    var_absoluteSourcePath_26053 = temp_5.readProperty_mSourceFileAbsolutePath ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("semanticAnalysis.galgas", 573)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 573)).add_operation (temp_6.readProperty_mFilewrapperPath ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 573)) ;
  }
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    test_7 = var_absoluteSourcePath_26053.getter_directoryExists (SOURCE_FILE ("semanticAnalysis.galgas", 575)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 575)).boolEnum () ;
    if (kBoolTrue == test_7) {
      const GALGAS_filewrapperDeclarationAST temp_8 = object ;
      TC_Array <C_FixItDescription> fixItArray9 ;
      inCompiler->emitSemanticError (temp_8.readProperty_mFilewrapperPath ().readProperty_location (), GALGAS_string ("The '").add_operation (var_absoluteSourcePath_26053, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 576)).add_operation (GALGAS_string ("' directory does not exist"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 576)), fixItArray9  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 576)) ;
    }
  }
  if (kBoolFalse == test_7) {
    GALGAS_filewrapperTemplateListForGeneration var_filewrapperTemplateListForGeneration_26587 = GALGAS_filewrapperTemplateListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 579)) ;
    const GALGAS_filewrapperDeclarationAST temp_10 = object ;
    cEnumerator_filewrapperTemplateListAST enumerator_26693 (temp_10.readProperty_mFilewrapperTemplateList (), kENUMERATION_UP) ;
    while (enumerator_26693.hasCurrentObject ()) {
      const GALGAS_filewrapperDeclarationAST temp_11 = object ;
      GALGAS_lstring var_filewrapperTemplateNameForUsefulness_26777 = function_filewrapperTemplateNameForUsefulEntitiesGraph (temp_11.readProperty_mFilewrapperName (), enumerator_26693.current_mFilewrapperTemplateName (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 581)) ;
      {
      ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_filewrapperTemplateNameForUsefulness_26777, var_filewrapperTemplateNameForUsefulness_26777, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 585)) ;
      }
      {
      ioArgument_ioUsefulEntitiesGraph.setter_addEdge (var_filewrapperTemplateNameForUsefulness_26777, var_filewrapperNameForUsefulness_25614 COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 586)) ;
      }
      enumGalgasBool test_12 = kBoolTrue ;
      if (kBoolTrue == test_12) {
        test_12 = GALGAS_bool (kIsEqual, enumerator_26693.current_mFilewrapperTemplatePath (HERE).readProperty_string ().getter_firstCharacterOrNul (SOURCE_FILE ("semanticAnalysis.galgas", 587)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
        if (kBoolTrue == test_12) {
          TC_Array <C_FixItDescription> fixItArray13 ;
          inCompiler->emitSemanticError (enumerator_26693.current_mFilewrapperTemplatePath (HERE).readProperty_location (), GALGAS_string ("the path should not begin with a '/'; it is relative to filewrapper path '").add_operation (var_absoluteSourcePath_26053, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 589)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 589)), fixItArray13  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 588)) ;
        }
      }
      GALGAS_string var_absoluteTemplatePath_27394 = var_absoluteSourcePath_26053.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 591)).add_operation (enumerator_26693.current_mFilewrapperTemplatePath (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 591)) ;
      GALGAS_templateInstructionListAST var_resultingInstructionList_27643 ;
      var_resultingInstructionList_27643.drop () ;
      cGrammar_templateGrammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absoluteTemplatePath_27394, enumerator_26693.current_mFilewrapperTemplatePath (HERE).readProperty_location ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 593)), var_resultingInstructionList_27643  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 593)) ;
      GALGAS_templateVariableMap var_templateVariableMap_27731 = GALGAS_templateVariableMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 596)) ;
      GALGAS_formalInputParameterListForGeneration var_filewrapperTemplateFormalInputParameters_27826 = GALGAS_formalInputParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 597)) ;
      cEnumerator_formalTemplateInputParameterListAST enumerator_27912 (enumerator_26693.current_mFilewrapperTemplateFormalInputParameters (HERE), kENUMERATION_UP) ;
      while (enumerator_27912.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_entry var_type_27978 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_27912.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 599)) ;
        GALGAS_string var_cppVarName_28096 = GALGAS_string ("in_").add_operation (enumerator_27912.current_mFormalArgumentName (HERE).readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 600)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 600)) ;
        {
        var_templateVariableMap_27731.setter_insertKey (enumerator_27912.current_mFormalArgumentName (HERE), var_type_27978, var_cppVarName_28096, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 601)) ;
        }
        var_filewrapperTemplateFormalInputParameters_27826.addAssign_operation (enumerator_27912.current_mFormalTemplateSelector (HERE), var_type_27978, var_cppVarName_28096, enumerator_27912.current_mFormalArgumentName (HERE), GALGAS_bool (true)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 602)) ;
        enumerator_27912.gotoNextObject () ;
      }
      GALGAS_templateInstructionListForGeneration var_templateInstructionListForGeneration_28446 = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 605)) ;
      GALGAS_templateAnalysisContext var_templateAnalysisContext_28522 = GALGAS_templateAnalysisContext::constructor_new (constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_templateVariableMap_27731  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 606)) ;
      {
      routine_templateInstructionListAnalysis (var_filewrapperNameForUsefulness_25614, ioArgument_ioUsefulEntitiesGraph, var_templateAnalysisContext_28522, var_resultingInstructionList_27643, var_templateInstructionListForGeneration_28446, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 610)) ;
      }
      var_filewrapperTemplateListForGeneration_26587.addAssign_operation (enumerator_26693.current_mFilewrapperTemplateName (HERE).readProperty_string (), var_filewrapperTemplateFormalInputParameters_27826, var_templateInstructionListForGeneration_28446  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 618)) ;
    ...
    ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string ("filewrapper ").add_operation (temp_14.readProperty_mFilewrapperName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 625)), GALGAS_filewrapperDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("filewrapper-").add_operation (temp_15.readProperty_mFilewrapperName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 628)), temp_16.readProperty_mFilewrapperName ().readProperty_string (), temp_17.readProperty_mFilewrapperPath ().readProperty_string (), var_wrapperFileMap_25933, var_wrapperDirectoryMap_25983, var_filewrapperTemplateListForGeneration_26587  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 626))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 624)) ;
  }
}
...
static void extensionMethod_galgas_33_SyntaxComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_galgas_33_SyntaxComponentAST) ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_30103 = function_syntaxNameForUsefulEntitiesGraph (temp_0.readProperty_mSyntaxComponentName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 649)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_30103, var_nameForUsefulness_30103, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 650)) ;
  }
  GALGAS_terminalMap var_terminalMap_30429 ;
  GALGAS_indexingListAST var_indexingListAST_30471 ;
  GALGAS_lstring var_indexingDirectory_30507 ;
  const GALGAS_galgas_33_SyntaxComponentAST temp_1 = object ;
  constinArgument_inSemanticContext.readProperty_mLexiqueComponentMapForSemanticAnalysis ().method_searchKey (temp_1.readProperty_mLexiqueName (), var_terminalMap_30429, var_indexingListAST_30471, var_indexingDirectory_30507, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 652)) ;
  GALGAS_stringset var_indexNameSet_30603 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 659)) ;
  cEnumerator_indexingListAST enumerator_30628 (var_indexingListAST_30471, kENUMERATION_UP) ;
  while (enumerator_30628.hasCurrentObject ()) {
    var_indexNameSet_30603.addAssign_operation (enumerator_30628.current_mIndexName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 661)) ;
    enumerator_30628.gotoNextObject () ;
  }
  GALGAS_bool var_hasIndexing_30720 = var_indexingDirectory_30507.readProperty_location ().getter_isNowhere (SOURCE_FILE ("semanticAnalysis.galgas", 663)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 663)) ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("semanticAnalysis.galgas", 665)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      const GALGAS_galgas_33_SyntaxComponentAST temp_3 = object ;
      GALGAS_string var_lexiqueName_30884 = temp_3.readProperty_mLexiqueName ().readProperty_string () ;
      GALGAS_syntaxDeclarationForGeneration var_syntaxDeclarationForGeneration_31342 ;
      {
      const GALGAS_galgas_33_SyntaxComponentAST temp_4 = object ;
      const GALGAS_galgas_33_SyntaxComponentAST temp_5 = object ;
      const GALGAS_galgas_33_SyntaxComponentAST temp_6 = object ;
      const GALGAS_galgas_33_SyntaxComponentAST temp_7 = object ;
      routine_semanticAnalysisOfSyntaxComponent (var_nameForUsefulness_30103, ioArgument_ioUsefulEntitiesGraph, temp_4.readProperty_mNonterminalDeclarationList (), temp_5.readProperty_mRuleList (), temp_6.readProperty_mSyntaxComponentName ().readProperty_string (), var_lexiqueName_30884, constinArgument_inSemanticContext, constinArgument_inPredefinedTypes, var_terminalMap_30429, var_indexNameSet_30603, var_hasIndexing_30720, temp_7.readProperty_mHasTranslateFeature (), var_syntaxDeclarationForGeneration_31342, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 667)) ;
      }
      ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), var_syntaxDeclarationForGeneration_31342  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 682)) ;
    }
  }
}
...
static void extensionMethod_galgas_33_GrammarComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_application::constructor_verboseOutput (SOURCE_FILE ("semanticAnalysis.galgas", 699)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_galgas_33_GrammarComponentAST temp_1 = object ;
      inCompiler->printMessage (GALGAS_string ("*** Analyzing '").add_operation (temp_1.readProperty_mGrammarComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 700)).add_operation (GALGAS_string ("' grammar\n"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 700))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 700)) ;
    }
  }
  const GALGAS_galgas_33_GrammarComponentAST temp_2 = object ;
  GALGAS_lstring var_grammarNameForUsefulness_32126 = function_grammarNameForUsefulEntitiesGraph (temp_2.readProperty_mGrammarComponentName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 703)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_grammarNameForUsefulness_32126, var_grammarNameForUsefulness_32126, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 704)) ;
  }
  GALGAS_terminalSymbolsMapForGrammarAnalysis var_actuallyUsedTerminalSymbolMap_32438 = GALGAS_terminalSymbolsMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 706)) ;
  GALGAS_nonTerminalSymbolMapForGrammarAnalysis var_nonTerminalMapForGrammarAnalysis_32522 = GALGAS_nonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 707)) ;
  GALGAS_lstring var_lexiqueComponentName_32562 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("semanticAnalysis.galgas", 708)) ;
  GALGAS_syntaxComponentListForGrammarAnalysis var_syntaxComponentListForGrammarAnalysis_32690 = GALGAS_syntaxComponentListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 709)) ;
  GALGAS_nonTerminalToAddList var_nonTerminalToAddList_32744 = GALGAS_nonTerminalToAddList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 710)) ;
  GALGAS_uint var_addedNonTerminalCount_32783 = GALGAS_uint ((uint32_t) 0U) ;
  const GALGAS_galgas_33_GrammarComponentAST temp_3 = object ;
  cEnumerator_lstringlist enumerator_32814 (temp_3.readProperty_mSyntaxComponents (), kENUMERATION_UP) ;
  while (enumerator_32814.hasCurrentObject ()) {
    GALGAS_lstring var_syntaxNameForUsefulness_32876 = function_syntaxNameForUsefulEntitiesGraph (enumerator_32814.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 713)) ;
    {
    ioArgument_ioUsefulEntitiesGraph.setter_addEdge (var_grammarNameForUsefulness_32126, var_syntaxNameForUsefulness_32876 COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 714)) ;
    }
    GALGAS_uint var_addedNonTerminalCountRef_33062 = var_addedNonTerminalCount_32783 ;
    GALGAS_lstring var_lexiqueName_33217 ;
    GALGAS_nonterminalDeclarationListAST var_nonterminalDeclarationList_33286 ;
    GALGAS_syntaxRuleListAST var_ruleList_33325 ;
    GALGAS_bool var_hasTranslateFeature_33362 ;
    constinArgument_inSemanticContext.readProperty_mSyntaxComponentMapForSemanticAnalysis ().method_searchKey (enumerator_32814.current_mValue (HERE), var_lexiqueName_33217, var_nonterminalDeclarationList_33286, var_ruleList_33325, var_hasTranslateFeature_33362, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 716)) ;
    GALGAS_lstring var_lexiqueNameForUsefulness_33401 = function_lexiqueNameForUsefulEntitiesGraph (var_lexiqueName_33217, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 723)) ;
    {
    ioArgument_ioUsefulEntitiesGraph.setter_addEdge (var_grammarNameForUsefulness_32126, var_lexiqueNameForUsefulness_33401 COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 724)) ;
    }
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      const GALGAS_galgas_33_GrammarComponentAST temp_5 = object ;
      test_4 = temp_5.readProperty_mHasTranslateFeature ().operator_and (var_hasTranslateFeature_33362.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 726)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 726)).boolEnum () ;
      if (kBoolTrue == test_4) {
        const GALGAS_galgas_33_GrammarComponentAST temp_6 = object ;
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (enumerator_32814.current_mValue (HERE).readProperty_location (), GALGAS_string ("as '").add_operation (temp_6.readProperty_mGrammarComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 727)).add_operation (GALGAS_string ("' grammar declares 'translate' feature, this syntax component should do so"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 727)), fixItArray7  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 727)) ;
      }
    }
    if (kBoolFalse == test_4) {
      ...
      if (kBoolTrue == test_8) {
        ...
        test_8 = var_hasTranslateFeature_33362.operator_and (temp_9.readProperty_mHasTranslateFeature ().operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 728)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 728)).boolEnum () ;
        if (kBoolTrue == test_8) {
          const GALGAS_galgas_33_GrammarComponentAST temp_10 = object ;
          TC_Array <C_FixItDescription> fixItArray11 ;
          inCompiler->emitSemanticError (temp_10.readProperty_mGrammarComponentName ().readProperty_location (), GALGAS_string ("as '").add_operation (enumerator_32814.current_mValue (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 729)).add_operation (GALGAS_string ("' syntax component declares 'translate' feature, this grammar should do so"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 729)), fixItArray11  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 729)) ;
        }
      }
    }
    enumGalgasBool test_12 = kBoolTrue ;
    if (kBoolTrue == test_12) {
      test_12 = GALGAS_bool (kIsEqual, var_lexiqueComponentName_32562.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_12) {
        var_lexiqueComponentName_32562 = var_lexiqueName_33217 ;
      }
    }
    if (kBoolFalse == test_12) {
      enumGalgasBool test_13 = kBoolTrue ;
      if (kBoolTrue == test_13) {
        test_13 = GALGAS_bool (kIsNotEqual, var_lexiqueName_33217.readProperty_string ().objectCompare (var_lexiqueComponentName_32562.readProperty_string ())).boolEnum () ;
        if (kBoolTrue == test_13) {
          TC_Array <C_FixItDescription> fixItArray14 ;
          inCompiler->emitSemanticError (enumerator_32814.current_mValue (HERE).readProperty_location (), GALGAS_string ("this syntax component uses '").add_operation (var_lexiqueName_33217.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 735)).add_operation (GALGAS_string ("' lexique component, but the first syntax component uses the '"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 736)).add_operation (var_lexiqueComponentName_32562.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 736)).add_operation (GALGAS_string ("' lexique component (they should be the same)"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 737)), fixItArray14  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 735)) ;
        }
      }
    }
    {
    routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis_32522, var_nonterminalDeclarationList_33286, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 740)) ;
    }
    {
    routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis_32522, var_ruleList_33325, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 745)) ;
    }
    {
    routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis_32522, enumerator_32814.current_mValue (HERE), var_ruleList_33325, var_actuallyUsedTerminalSymbolMap_32438, var_syntaxComponentListForGrammarAnalysis_32690, var_addedNonTerminalCount_32783, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 750)) ;
    }
    GALGAS_uint var_i_35023 = GALGAS_uint ((uint32_t) 0U) ;
    if (var_addedNonTerminalCount_32783.isValid ()) {
      uint32_t variant_35036 = var_addedNonTerminalCount_32783.uintValue () ;
      bool loop_35036 = true ;
      while (loop_35036) {
        loop_35036 = GALGAS_bool (kIsStrictInf, var_i_35023.objectCompare (var_addedNonTerminalCount_32783.substract_operation (var_addedNonTerminalCountRef_33062, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 759)))).isValid () ;
        if (loop_35036) {
          loop_35036 = GALGAS_bool (kIsStrictInf, var_i_35023.objectCompare (var_addedNonTerminalCount_32783.substract_operation (var_addedNonTerminalCountRef_33062, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 759)))).boolValue () ;
        }
        if (loop_35036 && (0 == variant_35036)) {
          loop_35036 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticAnalysis.galgas", 759)) ;
        }
        if (loop_35036) {
          variant_35036 -- ;
          var_nonTerminalToAddList_32744.addAssign_operation (enumerator_32814.current_mValue (HERE).readProperty_string (), var_i_35023  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 760)) ;
          var_i_35023.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 761)) ;
        }
      }
    }
    enumerator_32814.gotoNextObject () ;
  }
  GALGAS_stringset var_lexiqueComponentSet_35336 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 765)) ;
  GALGAS_lstring var_inIndexingDirectory_35556 ;
  GALGAS_terminalMap joker_35444 ; // Joker input parameter
  GALGAS_indexingListAST joker_35480 ; // Joker input parameter
  constinArgument_inSemanticContext.readProperty_mLexiqueComponentMapForSemanticAnalysis ().method_searchKey (var_lexiqueComponentName_32562, joker_35444, joker_35480, var_inIndexingDirectory_35556, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 766)) ;
  GALGAS_bool var_hasIndexing_35584 = var_inIndexingDirectory_35556.readProperty_location ().getter_isNowhere (SOURCE_FILE ("semanticAnalysis.galgas", 772)).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 772)) ;
  enumGalgasBool test_15 = kBoolTrue ;
  if (kBoolTrue == test_15) {
    const GALGAS_galgas_33_GrammarComponentAST temp_16 = object ;
    test_15 = var_hasIndexing_35584.operator_and (temp_16.readProperty_mHasIndexing ().readProperty_bool ().operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 773)) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 773)).boolEnum () ;
    if (kBoolTrue == test_15) {
      const GALGAS_galgas_33_GrammarComponentAST temp_17 = object ;
      TC_Array <C_FixItDescription> fixItArray18 ;
      inCompiler->emitSemanticError (temp_17.readProperty_mGrammarComponentName ().readProperty_location (), GALGAS_string ("the grammar does not enable indexing, but the '").add_operation (var_lexiqueComponentName_32562.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 774)).add_operation (GALGAS_string ("' does"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 774)), fixItArray18  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 774)) ;
    }
  }
  if (kBoolFalse == test_15) {
    ...
    if (kBoolTrue == test_19) {
      ...
      test_19 = var_hasIndexing_35584.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 775)).operator_and (temp_20.readProperty_mHasIndexing ().readProperty_bool () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 775)).boolEnum () ;
      if (kBoolTrue == test_19) {
        const GALGAS_galgas_33_GrammarComponentAST temp_21 = object ;
        TC_Array <C_FixItDescription> fixItArray22 ;
        inCompiler->emitSemanticError (temp_21.readProperty_mHasIndexing ().readProperty_location (), GALGAS_string ("the grammar enables indexing, but the '").add_operation (var_lexiqueComponentName_32562.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 776)).add_operation (GALGAS_string ("' does not"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 776)), fixItArray22  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 776)) ;
      }
    }
  }
  GALGAS_uint var_startSymbolIndex_36191 ;
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap_36263 ;
  const GALGAS_galgas_33_GrammarComponentAST temp_23 = object ;
  var_nonTerminalMapForGrammarAnalysis_32522.method_searchKey (temp_23.readProperty_mStartSymbolName (), var_startSymbolIndex_36191, var_startSymbolAltMap_36263, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 780)) ;
  {
  ...
  routine_checkLabelMap (temp_24.readProperty_mStartSymbolName ().readProperty_location (), temp_25.readProperty_mStartSymbolLabelList (), var_nonTerminalMapForGrammarAnalysis_32522.getter_locationForKey (temp_26.readProperty_mStartSymbolName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 789)), var_startSymbolAltMap_36263, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 786)) ;
  }
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar_36662 = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 793)) ;
  const GALGAS_galgas_33_GrammarComponentAST temp_27 = object ;
  cEnumerator_lstringlist enumerator_36681 (temp_27.readProperty_mUnusedNonterminalList (), kENUMERATION_UP) ;
  while (enumerator_36681.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex_36800 ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_36802 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis_32522.method_searchKey (enumerator_36681.current_mValue (HERE), var_nonterminalIndex_36800, joker_36802, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 795)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar_36662.setter_insertKey (enumerator_36681.current_mValue (HERE), var_nonterminalIndex_36800, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 796)) ;
    }
    enumerator_36681.gotoNextObject () ;
  }
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis_37086 = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE ("semanticAnalysis.galgas", 799)) ;
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_37153 (var_nonTerminalMapForGrammarAnalysis_32522, kENUMERATION_UP) ;
  while (enumerator_37153.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis_37086.addAssign_operation (enumerator_37153.current_lkey (HERE), enumerator_37153.current_mNonTerminalIndex (HERE), enumerator_37153.current_mNonterminalSymbolParametersMap (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 801)) ;
  ...
  if (kBoolTrue == test_28) {
    ...
    if (kBoolTrue == test_28) {
      ...
      routine_emitProductionRulesInTexFile (constinArgument_inProductDirectory, temp_29.readProperty_mGrammarComponentName ().readProperty_string (), var_nonTerminalMapForGrammarAnalysis_32522, var_syntaxComponentListForGrammarAnalysis_32690, temp_30.readProperty_mStartSymbolName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 805)) ;
      }
    }
  }
  GALGAS_stringset var_implementationFileHeader_38011 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 816)) ;
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_38070 (var_nonTerminalMapForGrammarAnalysis_32522, kENUMERATION_UP) ;
  while (enumerator_38070.hasCurrentObject ()) {
    cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_38106 (enumerator_38070.current (HERE).readProperty_mNonterminalSymbolParametersMap (), kENUMERATION_UP) ;
    while (enumerator_38106.hasCurrentObject ()) {
      cEnumerator_signatureForGrammarAnalysis enumerator_38247 (enumerator_38106.current_mFormalParametersList (HERE), kENUMERATION_UP) ;
      while (enumerator_38247.hasCurrentObject ()) {
        switch (enumerator_38247.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).enumValue ()) {
        case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
          break ;
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn:
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn:
          {
            GALGAS_unifiedTypeMap_2D_entry var_t_38398 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_38247.current_mGalgasTypeNameForGrammarAnalysis (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 822)) ;
            extensionMethod_addHeaderFileName (var_t_38398, var_implementationFileHeader_38011, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 823)) ;
          }
          break ;
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut:
        case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut:
      ...
      enumerator_38106.gotoNextObject () ;
    }
  ...
  if (kBoolTrue == test_31) {
    ...
    if (kBoolTrue == test_31) {
      var_implementationFileHeader_38011 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 830)) ;
    }
  }
  const GALGAS_galgas_33_GrammarComponentAST temp_32 = object ;
  GALGAS_string var_HTMLFilePath_38831 = constinArgument_inProductDirectory.add_operation (GALGAS_string ("/../helpers/"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 833)).add_operation (temp_32.readProperty_mGrammarComponentName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 833)).add_operation (GALGAS_string (".html"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 833)) ;
  GALGAS_string var_grammarCppFile_39389 ;
  GALGAS_string var_grammarHTMLHelperContents_39432 ;
  {
  ...
  if (kBoolTrue == test_37) {
    temp_36 = function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 846)) ;
  }else if (kBoolFalse == test_37) {
    temp_36 = GALGAS_string::makeEmptyString () ;
  }
  routine_grammarAnalysisAndGeneration (GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 835)), temp_33.readProperty_mGrammarComponentName (), temp_34.readProperty_mGrammarClass (), var_startSymbolIndex_36191, var_lexiqueComponentName_32562.readProperty_string (), var_actuallyUsedTerminalSymbolMap_32438, var_syntaxComponentListForGrammarAnalysis_32690, var_unusedNonTerminalSymbolsForGrammar_36662, var_HTMLFilePath_38831, var_nonTerminalSymbolSortedListForGrammarAnalysis_37086, var_hasIndexing_35584, temp_36, var_grammarCppFile_39389, var_grammarHTMLHelperContents_39432, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 834)) ;
  }
  enumGalgasBool test_38 = kBoolTrue ;
  if (kBoolTrue == test_38) {
    test_38 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.readProperty_value ()).boolEnum () ;
    if (kBoolTrue == test_38) {
      var_HTMLFilePath_38831.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("semanticAnalysis.galgas", 852)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 852)) ;
      GALGAS_bool joker_39745 ; // Joker input parameter
      var_grammarHTMLHelperContents_39432.method_writeToFileWhenDifferentContents (var_HTMLFilePath_38831, joker_39745, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 853)) ;
    }
  }
  if (kBoolFalse == test_38) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_HTMLFilePath_38831, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 855)) ;
    }
  }
  ...
  ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_grammarForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("grammar-").add_operation (temp_39.readProperty_mGrammarComponentName ().readProperty_string ().getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 862)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 862)), temp_40.readProperty_mGrammarComponentName ().readProperty_string (), var_lexiqueComponentName_32562.readProperty_string (), var_nonTerminalMapForGrammarAnalysis_32522, var_nonTerminalToAddList_32744, var_hasIndexing_35584, temp_41.readProperty_mSyntaxComponents (), temp_42.readProperty_mStartSymbolName ().readProperty_string (), temp_43.readProperty_mHasTranslateFeature (), var_grammarCppFile_39389  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 860))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 858)) ;
}
...
static void extensionMethod_lexiqueComponentAST_semanticAnalysis (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_lexiqueComponentAST) ;
  const GALGAS_lexiqueComponentAST temp_0 = object ;
  GALGAS_lstring var_nameForUsefulness_40839 = function_lexiqueNameForUsefulEntitiesGraph (temp_0.readProperty_mLexiqueComponentName (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 885)) ;
  {
  ioArgument_ioUsefulEntitiesGraph.setter_addNode (var_nameForUsefulness_40839, var_nameForUsefulness_40839, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 886)) ;
  }
  GALGAS_lexicalTypeMap var_lexicalTypeMap_41089 = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 888)) ;
  GALGAS_lexicalRoutineMap var_lexicalRoutineMap_41224 ;
  {
  routine_buildLexicalRoutineMap (var_lexicalRoutineMap_41224, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 891)) ;
  }
  const GALGAS_lexiqueComponentAST temp_1 = object ;
  cEnumerator_externRoutineListAST enumerator_41405 (temp_1.readProperty_mExternRoutineList (), kENUMERATION_UP) ;
  while (enumerator_41405.hasCurrentObject ()) {
    GALGAS_lexicalRoutineFormalArgumentList var_lexicalRoutineFormalArgumentList_41477 = GALGAS_lexicalRoutineFormalArgumentList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 894)) ;
    cEnumerator_lexicalExternRoutineFormalArgumentListAST enumerator_41574 (enumerator_41405.current_mLexicalRoutineFormalArgumentList (HERE), kENUMERATION_UP) ;
    while (enumerator_41574.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType_41668 ;
      var_lexicalTypeMap_41089.method_searchKey (enumerator_41574.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType_41668, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 897)) ;
      var_lexicalRoutineFormalArgumentList_41477.addAssign_operation (enumerator_41574.current_mPassingMode (HERE), var_lexicalFormalArgumentType_41668, enumerator_41574.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 898)) ;
      enumerator_41574.gotoNextObject () ;
    }
    {
    var_lexicalRoutineMap_41224.setter_insertKey (enumerator_41405.current_mRoutineName (HERE), var_lexicalRoutineFormalArgumentList_41477, enumerator_41405.current_mErrorMessageList (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 900)) ;
    }
    enumerator_41405.gotoNextObject () ;
  }
  GALGAS_lexicalFunctionMap var_lexicalFunctionMap_42093 ;
  {
  routine_buildLexicalFunctionMap (var_lexicalFunctionMap_42093, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 904)) ;
  }
  const GALGAS_lexiqueComponentAST temp_2 = object ;
  cEnumerator_externFunctionListAST enumerator_42279 (temp_2.readProperty_mExternFunctionList (), kENUMERATION_UP) ;
  while (enumerator_42279.hasCurrentObject ()) {
    GALGAS_lexicalFunctionFormalArgumentList var_lexicalFunctionFormalArgumentList_42388 = GALGAS_lexicalFunctionFormalArgumentList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 907)) ;
    cEnumerator_lexicalExternFunctionFormalArgumentListAST enumerator_42439 (enumerator_42279.current_mLexicalFunctionFormalArgumentList (HERE), kENUMERATION_UP) ;
    while (enumerator_42439.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_lexicalFormalArgumentType_42534 ;
      var_lexicalTypeMap_41089.method_searchKey (enumerator_42439.current_mLexicalTypeName (HERE), var_lexicalFormalArgumentType_42534, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 910)) ;
      var_lexicalFunctionFormalArgumentList_42388.addAssign_operation (var_lexicalFormalArgumentType_42534, enumerator_42439.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 911)) ;
      enumerator_42439.gotoNextObject () ;
    }
    GALGAS_lexicalTypeEnum var_returnedArgumentType_42764 ;
    var_lexicalTypeMap_41089.method_searchKey (enumerator_42279.current_mReturnedTypeName (HERE), var_returnedArgumentType_42764, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 914)) ;
    {
    var_lexicalFunctionMap_42093.setter_insertKey (enumerator_42279.current_mFunctionName (HERE), var_lexicalFunctionFormalArgumentList_42388, var_returnedArgumentType_42764, GALGAS_string::makeEmptyString (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 915)) ;
    }
    enumerator_42279.gotoNextObject () ;
  }
  GALGAS_stringset var_unicodeTestFunctions_43120 ;
  {
  const GALGAS_lexiqueComponentAST temp_3 = object ;
  routine_lexicalUnicodeTestFunctionAnalysis (temp_3.readProperty_mLexicalFunctionListAST (), var_unicodeTestFunctions_43120, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 918)) ;
  }
  const GALGAS_lexiqueComponentAST temp_4 = object ;
  GALGAS_lexiqueAnalysisContext var_lexiqueAnalysisContext_43215 = GALGAS_lexiqueAnalysisContext::constructor_new (temp_4.readProperty_mLexiqueComponentName ().readProperty_string (), var_lexicalRoutineMap_41224, var_lexicalFunctionMap_42093, GALGAS_lexicalMessageMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 924)), GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 925)), GALGAS_terminalList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 926)), GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 927)), GALGAS_lexicalExplicitTokenListMapMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 928)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 929)), GALGAS_templateDelimitorList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 930)), GALGAS_styleMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 931)), var_unicodeTestFunctions_43120  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 920)) ;
  GALGAS_uint var_styleIndex_43610 = GALGAS_uint ((uint32_t) 1U) ;
  const GALGAS_lexiqueComponentAST temp_5 = object ;
  cEnumerator_lexicalStyleListAST enumerator_43636 (temp_5.readProperty_mLexicalStyleList (), kENUMERATION_UP) ;
  while (enumerator_43636.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext_43215.mProperty_mStyleMap.setter_insertKey (enumerator_43636.current_mName (HERE), enumerator_43636.current_mComment (HERE), var_styleIndex_43610, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 937)) ;
    }
    var_styleIndex_43610.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 938)) ;
    enumerator_43636.gotoNextObject () ;
  }
  {
  const GALGAS_lexiqueComponentAST temp_6 = object ;
  routine_buildLexicalAttributeMap (var_lexicalTypeMap_41089, temp_6.readProperty_mLexicalAttributeList (), var_lexiqueAnalysisContext_43215.mProperty_mLexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 941)) ;
  }
  const GALGAS_lexiqueComponentAST temp_7 = object ;
  cEnumerator_terminalDeclarationListAST enumerator_44102 (temp_7.readProperty_mTerminalDeclarationList (), kENUMERATION_UP) ;
  while (enumerator_44102.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex_44172 = GALGAS_uint ((uint32_t) 0U) ;
    enumGalgasBool test_8 = kBoolTrue ;
    if (kBoolTrue == test_8) {
      test_8 = GALGAS_bool (kIsStrictSup, enumerator_44102.current_mStyle (HERE).readProperty_string ().getter_length (SOURCE_FILE ("semanticAnalysis.galgas", 949)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_8) {
        GALGAS_lstring joker_44275 ; // Joker input parameter
        var_lexiqueAnalysisContext_43215.readProperty_mStyleMap ().method_searchKey (enumerator_44102.current_mStyle (HERE), joker_44275, var_terminalStyleIndex_44172, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 950)) ;
      }
    }
    GALGAS_lexicalSentValueList var_argumentTypeList_44330 = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 952)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_44396 (enumerator_44102.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_44396.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_44470 ;
      var_lexiqueAnalysisContext_43215.readProperty_mLexicalAttributeMap ().method_searchKey (enumerator_44396.current_mAttributeName (HERE), var_attributeLexicalType_44470, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 955)) ;
      var_argumentTypeList_44330.addAssign_operation (enumerator_44396.current_mFormalSelector (HERE), enumerator_44396.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_44470  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 956)) ;
      enumerator_44396.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext_43215.mProperty_mTerminalMap.setter_insertKey (enumerator_44102.current_mName (HERE), var_argumentTypeList_44330, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 958)) ;
    }
    GALGAS_bool var_isEndOfTemplateMark_44773 = GALGAS_bool (false) ;
    GALGAS_bool var_atomicSelection_44805 = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_44828 (enumerator_44102.current_mOptionList (HERE), kENUMERATION_UP) ;
    while (enumerator_44828.hasCurrentObject ()) {
      enumGalgasBool test_9 = kBoolTrue ;
      if (kBoolTrue == test_9) {
        test_9 = GALGAS_bool (kIsEqual, enumerator_44828.current_mValue (HERE).readProperty_string ().objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          enumGalgasBool test_10 = kBoolTrue ;
          if (kBoolTrue == test_10) {
            test_10 = var_atomicSelection_44805.boolEnum () ;
            if (kBoolTrue == test_10) {
              var_atomicSelection_44805 = GALGAS_bool (false) ;
            }
          }
          if (kBoolFalse == test_10) {
            TC_Array <C_FixItDescription> fixItArray11 ;
            inCompiler->emitSemanticError (enumerator_44828.current_mValue (HERE).readProperty_location (), GALGAS_string ("the 'nonAtomicSelection' attribute is already set"), fixItArray11  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 966)) ;
          }
        }
      }
      if (kBoolFalse == test_9) {
        enumGalgasBool test_12 = kBoolTrue ;
        if (kBoolTrue == test_12) {
          test_12 = GALGAS_bool (kIsNotEqual, enumerator_44828.current_mValue (HERE).readProperty_string ().objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
          if (kBoolTrue == test_12) {
            TC_Array <C_FixItDescription> fixItArray13 ;
            inCompiler->emitSemanticError (enumerator_44828.current_mValue (HERE).readProperty_location (), GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' attributes are allowed here"), fixItArray13  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 969)) ;
          }
        }
        if (kBoolFalse == test_12) {
          enumGalgasBool test_14 = kBoolTrue ;
          if (kBoolTrue == test_14) {
            test_14 = var_isEndOfTemplateMark_44773.boolEnum () ;
            if (kBoolTrue == test_14) {
              TC_Array <C_FixItDescription> fixItArray15 ;
              inCompiler->emitSemanticError (enumerator_44828.current_mValue (HERE).readProperty_location (), GALGAS_string ("the 'templateEndMark' attribute is already set"), fixItArray15  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 971)) ;
            }
          }
          if (kBoolFalse == test_14) {
            var_isEndOfTemplateMark_44773 = GALGAS_bool (true) ;
          }
        }
      }
      enumerator_44828.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext_43215.mProperty_mTerminalList.addAssign_operation (enumerator_44102.current_mName (HERE), var_argumentTypeList_44330, enumerator_44102.current_mSyntaxErrorMessage (HERE).readProperty_string (), var_isEndOfTemplateMark_44773, var_atomicSelection_44805, var_terminalStyleIndex_44172  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 976)) ;
    enumerator_44102.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_16 = object ;
  cEnumerator_lexicalListDeclarationListAST enumerator_45659 (temp_16.readProperty_mLexicalListDeclarationList (), kENUMERATION_UP) ;
  while (enumerator_45659.hasCurrentObject ()) {
    GALGAS_uint var_terminalStyleIndex_45732 = GALGAS_uint ((uint32_t) 0U) ;
    enumGalgasBool test_17 = kBoolTrue ;
    if (kBoolTrue == test_17) {
      test_17 = GALGAS_bool (kIsStrictSup, enumerator_45659.current_mStyle (HERE).readProperty_string ().getter_length (SOURCE_FILE ("semanticAnalysis.galgas", 986)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_17) {
        GALGAS_lstring joker_45835 ; // Joker input parameter
        var_lexiqueAnalysisContext_43215.readProperty_mStyleMap ().method_searchKey (enumerator_45659.current_mStyle (HERE), joker_45835, var_terminalStyleIndex_45732, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 987)) ;
      }
    }
    GALGAS_lexicalSentValueList var_argumentTypeList_45890 = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 989)) ;
    cEnumerator_sentLexicalAttributeListAST enumerator_45956 (enumerator_45659.current_mSentAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_45956.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType_46030 ;
      var_lexiqueAnalysisContext_43215.readProperty_mLexicalAttributeMap ().method_searchKey (enumerator_45956.current_mAttributeName (HERE), var_attributeLexicalType_46030, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 992)) ;
      var_argumentTypeList_45890.addAssign_operation (enumerator_45956.current_mFormalSelector (HERE), enumerator_45956.current_mAttributeName (HERE).readProperty_string (), var_attributeLexicalType_46030  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 993)) ;
      enumerator_45956.gotoNextObject () ;
    }
    GALGAS_lexicalExplicitTokenListMap var_lexicalTokenListMap_46283 = GALGAS_lexicalExplicitTokenListMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 995)) ;
    GALGAS_tokenSortedlist var_tokenSortedlist_46312 = GALGAS_tokenSortedlist::constructor_emptySortedList (SOURCE_FILE ("semanticAnalysis.galgas", 996)) ;
    cEnumerator_lexicalListEntryListAST enumerator_46390 (enumerator_45659.current_mEntryList (HERE), kENUMERATION_UP) ;
    while (enumerator_46390.hasCurrentObject ()) {
      GALGAS_string var_syntaxErrorMessage_46445 = enumerator_45659.current_mSyntaxErrorMessage (HERE).readProperty_string ().getter_stringByReplacingStringByString (GALGAS_string ("%K"), enumerator_46390.current_mTerminalSpelling (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 998)) ;
      GALGAS_bool var_isEndOfTemplateMark_46570 = GALGAS_bool (false) ;
      GALGAS_bool var_atomicSelection_46604 = GALGAS_bool (true) ;
      cEnumerator_lstringlist enumerator_46629 (enumerator_46390.current_mAttributeList (HERE), kENUMERATION_UP) ;
      while (enumerator_46629.hasCurrentObject ()) {
        enumGalgasBool test_18 = kBoolTrue ;
        if (kBoolTrue == test_18) {
          test_18 = GALGAS_bool (kIsEqual, enumerator_46629.current_mValue (HERE).readProperty_string ().objectCompare (GALGAS_string ("nonAtomicSelection"))).boolEnum () ;
          if (kBoolTrue == test_18) {
            enumGalgasBool test_19 = kBoolTrue ;
            if (kBoolTrue == test_19) {
              test_19 = var_atomicSelection_46604.boolEnum () ;
              if (kBoolTrue == test_19) {
                var_atomicSelection_46604 = GALGAS_bool (false) ;
              }
            }
            if (kBoolFalse == test_19) {
              TC_Array <C_FixItDescription> fixItArray20 ;
              inCompiler->emitSemanticError (enumerator_46629.current_mValue (HERE).readProperty_location (), GALGAS_string ("the 'nonAtomicSelection' attribute is already set"), fixItArray20  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1006)) ;
            }
          }
        }
        if (kBoolFalse == test_18) {
          enumGalgasBool test_21 = kBoolTrue ;
          if (kBoolTrue == test_21) {
            test_21 = GALGAS_bool (kIsNotEqual, enumerator_46629.current_mValue (HERE).readProperty_string ().objectCompare (GALGAS_string ("templateEndMark"))).boolEnum () ;
            if (kBoolTrue == test_21) {
              TC_Array <C_FixItDescription> fixItArray22 ;
              inCompiler->emitSemanticError (enumerator_46629.current_mValue (HERE).readProperty_location (), GALGAS_string ("only the 'templateEndMark' and 'nonAtomicSelection' attributes are allowed here"), fixItArray22  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1009)) ;
            }
          }
          if (kBoolFalse == test_21) {
            enumGalgasBool test_23 = kBoolTrue ;
            if (kBoolTrue == test_23) {
              test_23 = var_isEndOfTemplateMark_46570.boolEnum () ;
              if (kBoolTrue == test_23) {
                TC_Array <C_FixItDescription> fixItArray24 ;
                inCompiler->emitSemanticError (enumerator_46629.current_mValue (HERE).readProperty_location (), GALGAS_string ("the 'templateEndMark' attribute is already set"), fixItArray24  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1011)) ;
              }
            }
            if (kBoolFalse == test_23) {
              var_isEndOfTemplateMark_46570 = GALGAS_bool (true) ;
            }
          }
        }
        enumerator_46629.gotoNextObject () ;
      }
      var_lexiqueAnalysisContext_43215.mProperty_mTerminalList.addAssign_operation (enumerator_46390.current_mTerminalSpelling (HERE), var_argumentTypeList_45890, var_syntaxErrorMessage_46445, var_isEndOfTemplateMark_46570, var_atomicSelection_46604, var_terminalStyleIndex_45732  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1016)) ;
      {
      var_lexiqueAnalysisContext_43215.mProperty_mTerminalMap.setter_insertKey (enumerator_46390.current_mTerminalSpelling (HERE), var_argumentTypeList_45890, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1023)) ;
      }
      {
      var_lexicalTokenListMap_46283.setter_insertKey (enumerator_46390.current_mEntrySpelling (HERE), enumerator_46390.current_mTerminalSpelling (HERE), enumerator_46390.current_mAttributeList (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1024)) ;
      }
      var_tokenSortedlist_46312.addAssign_operation (enumerator_46390.current_mEntrySpelling (HERE).readProperty_string ().getter_length (SOURCE_FILE ("semanticAnalysis.galgas", 1025)), enumerator_46390.current_mEntrySpelling (HERE).readProperty_string (), enumerator_46390.current_mTerminalSpelling (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1025)) ;
      var_lexiqueAnalysisContext_43215.mProperty_mUnicodeStringToGenerate.addAssign_operation (enumerator_46390.current_mEntrySpelling (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1026)) ;
      enumerator_46390.gotoNextObject () ;
    }
    {
    var_lexiqueAnalysisContext_43215.mProperty_mLexicalTokenListMap.setter_insertKey (enumerator_45659.current_mName (HERE), var_lexicalTokenListMap_46283, var_tokenSortedlist_46312, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1028)) ;
    }
    enumerator_45659.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_25 = object ;
  cEnumerator_lexicalMessageDeclarationListAST enumerator_48024 (temp_25.readProperty_mLexicalMessageDeclarationList (), kENUMERATION_UP) ;
  while (enumerator_48024.hasCurrentObject ()) {
    {
    var_lexiqueAnalysisContext_43215.mProperty_mLexicalMessageMap.setter_insertKey (enumerator_48024.current_mMessageName (HERE), enumerator_48024.current_mMessageValue (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1032)) ;
    }
    enumerator_48024.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_26 = object ;
  cEnumerator_lexicalRuleListAST enumerator_48242 (temp_26.readProperty_mLexicalRuleList (), kENUMERATION_UP) ;
  while (enumerator_48242.hasCurrentObject ()) {
    callExtensionMethod_checkLexicalRule ((const cPtr_abstractLexicalRuleAST *) enumerator_48242.current_mLexicalRule (HERE).ptr (), var_lexiqueAnalysisContext_43215, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1036)) ;
    enumerator_48242.gotoNextObject () ;
  }
  cEnumerator_lexicalMessageMap enumerator_48433 (var_lexiqueAnalysisContext_43215.readProperty_mLexicalMessageMap (), kENUMERATION_UP) ;
  while (enumerator_48433.hasCurrentObject ()) {
    enumGalgasBool test_27 = kBoolTrue ;
    if (kBoolTrue == test_27) {
      test_27 = enumerator_48433.current_mMessageIsUsed (HERE).operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1040)).boolEnum () ;
      if (kBoolTrue == test_27) {
        TC_Array <C_FixItDescription> fixItArray28 ;
        inCompiler->emitSemanticWarning (enumerator_48433.current_lkey (HERE).readProperty_location (), GALGAS_string ("unused message"), fixItArray28  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1041)) ;
      }
    }
    enumerator_48433.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_29 = object ;
  cEnumerator_metamodelTemplateDelimitorListAST enumerator_48667 (temp_29.readProperty_mTemplateDelimitorList (), kENUMERATION_UP) ;
  while (enumerator_48667.hasCurrentObject ()) {
    var_lexiqueAnalysisContext_43215.mProperty_mUnicodeStringToGenerate.addAssign_operation (enumerator_48667.current_mStartString (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1046)) ;
    var_lexiqueAnalysisContext_43215.mProperty_mUnicodeStringToGenerate.addAssign_operation (enumerator_48667.current_mEndString (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1047)) ;
    GALGAS_bool var_preservesStartDelimiter_48881 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_48904 (enumerator_48667.current_mOptionList (HERE), kENUMERATION_UP) ;
    while (enumerator_48904.hasCurrentObject ()) {
      enumGalgasBool test_30 = kBoolTrue ;
      if (kBoolTrue == test_30) {
        test_30 = GALGAS_bool (kIsNotEqual, enumerator_48904.current_mValue (HERE).readProperty_string ().objectCompare (GALGAS_string ("preserved"))).boolEnum () ;
        if (kBoolTrue == test_30) {
          TC_Array <C_FixItDescription> fixItArray31 ;
          inCompiler->emitSemanticError (enumerator_48904.current_mValue (HERE).readProperty_location (), GALGAS_string ("only the 'preserved' attribute is allowed here"), fixItArray31  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1051)) ;
        }
      }
      if (kBoolFalse == test_30) {
        enumGalgasBool test_32 = kBoolTrue ;
        if (kBoolTrue == test_32) {
          test_32 = var_preservesStartDelimiter_48881.boolEnum () ;
          if (kBoolTrue == test_32) {
            TC_Array <C_FixItDescription> fixItArray33 ;
            inCompiler->emitSemanticError (enumerator_48904.current_mValue (HERE).readProperty_location (), GALGAS_string ("the 'preserved' attribute is already set"), fixItArray33  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1053)) ;
          }
        }
        if (kBoolFalse == test_32) {
          var_preservesStartDelimiter_48881 = GALGAS_bool (true) ;
        }
      }
      enumerator_48904.gotoNextObject () ;
    }
    var_lexiqueAnalysisContext_43215.mProperty_mTemplateDelimitorList.addAssign_operation (enumerator_48667.current_mStartString (HERE), enumerator_48667.current_mEndString (HERE), var_preservesStartDelimiter_48881  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1058)) ;
    enumerator_48667.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_34) {
    ...
    if (kBoolTrue == test_34) {
      ...
      cEnumerator_indexingListAST enumerator_49449 (temp_36.readProperty_mIndexingListAST (), kENUMERATION_UP) ;
      while (enumerator_49449.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray37 ;
        inCompiler->emitSemanticError (enumerator_49449.current_mIndexName (HERE).readProperty_location (), GALGAS_string ("indexing declaration requires one 'indexing in \"path\";' declaration"), fixItArray37  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1063)) ;
        enumerator_49449.gotoNextObject () ;
      }
    }
  }
  GALGAS_stringset var_indexNameSet_49619 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticAnalysis.galgas", 1066)) ;
  const GALGAS_lexiqueComponentAST temp_38 = object ;
  cEnumerator_indexingListAST enumerator_49644 (temp_38.readProperty_mIndexingListAST (), kENUMERATION_UP) ;
  while (enumerator_49644.hasCurrentObject ()) {
    enumGalgasBool test_39 = kBoolTrue ;
    if (kBoolTrue == test_39) {
      test_39 = var_indexNameSet_49619.getter_hasKey (enumerator_49644.current_mIndexName (HERE).readProperty_string () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1068)).boolEnum () ;
      if (kBoolTrue == test_39) {
        TC_Array <C_FixItDescription> fixItArray40 ;
        inCompiler->emitSemanticError (enumerator_49644.current_mIndexName (HERE).readProperty_location (), GALGAS_string ("the '").add_operation (enumerator_49644.current_mIndexName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1069)).add_operation (GALGAS_string ("' index is already declared"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1069)), fixItArray40  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1069)) ;
      }
    }
    var_indexNameSet_49619.addAssign_operation (enumerator_49644.current_mIndexName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1071)) ;
    enumerator_49644.gotoNextObject () ;
  }
  const GALGAS_lexiqueComponentAST temp_41 = object ;
  cEnumerator_templateReplacementListAST enumerator_49961 (temp_41.readProperty_mTemplateReplacementList (), kENUMERATION_UP) ;
  while (enumerator_49961.hasCurrentObject ()) {
    var_lexiqueAnalysisContext_43215.mProperty_mUnicodeStringToGenerate.addAssign_operation (enumerator_49961.current_mMatchString (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1075)) ;
    var_lexiqueAnalysisContext_43215.mProperty_mUnicodeStringToGenerate.addAssign_operation (enumerator_49961.current_mReplacementString (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1076)) ;
  ...
  if (kBoolTrue == test_42) {
    ...
    if (kBoolTrue == test_42) {
      ...
      GALGAS_string var_lexiqueClassName_50327 = temp_43.readProperty_mLexiqueComponentName ().readProperty_string () ;
      const GALGAS_lexiqueComponentAST temp_44 = object ;
      GALGAS_string var_headerContents_50400 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_32_ (inCompiler, var_lexiqueClassName_50327.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1084)), var_lexiqueAnalysisContext_43215, temp_44.readProperty_mTemplateDelimitorList () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1083))) ;
      ...
      var_headerContents_50400.plusAssign_operation(GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newHeaderZone_33_ (inCompiler, var_lexiqueClassName_50327.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1089)), temp_45.readProperty_mLexicalListDeclarationList (), var_lexiqueAnalysisContext_43215, temp_46.readProperty_mIndexingListAST (), temp_47.readProperty_mLexicalFunctionListAST () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1088))), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1088)) ;
      ...
      GALGAS_string var_cppContents_50882 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_newImplementationZone_32_Galgas_33_ (inCompiler, var_lexiqueClassName_50327.getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1097)), var_lexiqueAnalysisContext_43215.readProperty_mLexicalAttributeMap (), var_lexiqueAnalysisContext_43215.readProperty_mLexicalMessageMap (), var_lexiqueAnalysisContext_43215.readProperty_mTerminalList (), var_lexiqueAnalysisContext_43215.readProperty_mLexicalTokenListMap (), var_lexiqueAnalysisContext_43215.readProperty_mUnicodeStringToGenerate (), temp_48.readProperty_mLexicalRuleList (), var_lexiqueAnalysisContext_43215, temp_49.readProperty_mIndexingDirectory ().readProperty_string (), temp_50.readProperty_mTemplateDelimitorList (), var_lexiqueClassName_50327, temp_51.readProperty_mTemplateReplacementList (), temp_52.readProperty_mLexicalStyleList (), temp_53.readProperty_mLexicalFunctionListAST () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1096))) ;
      const GALGAS_lexiqueComponentAST temp_54 = object ;
      GALGAS_string var_cocoaHeader_51561 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_32_ (inCompiler, var_lexiqueClassName_50327, var_lexiqueAnalysisContext_43215, temp_54.readProperty_mLexicalFunctionListAST () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1113))) ;
      var_cocoaHeader_51561.plusAssign_operation(GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaHeaderZone_33_ (inCompiler, var_lexiqueClassName_50327, var_lexiqueAnalysisContext_43215 COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1118))), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1118)) ;
      ...
      GALGAS_string var_cocoaImplementation_51917 = GALGAS_string (filewrapperTemplate_lexiqueGenerationTemplates_cocoaImplementationZone_32_ (inCompiler, GALGAS_string ("lexique-").add_operation (var_lexiqueClassName_50327.getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1124)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1124)).add_operation (GALGAS_string ("-cocoa"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1124)), var_lexiqueClassName_50327, var_lexiqueAnalysisContext_43215.readProperty_mLexicalAttributeMap (), var_lexiqueAnalysisContext_43215.readProperty_mLexicalMessageMap (), var_lexiqueAnalysisContext_43215.readProperty_mTerminalList (), var_lexiqueAnalysisContext_43215.readProperty_mUnicodeStringToGenerate (), temp_55.readProperty_mLexicalRuleList (), var_lexiqueAnalysisContext_43215, temp_56.readProperty_mTemplateReplacementList (), temp_57.readProperty_mIndexingDirectory ().readProperty_string (), temp_58.readProperty_mIndexingListAST (), temp_59.readProperty_mLexicalStyleList (), temp_60.readProperty_mTemplateDelimitorList (), temp_61.readProperty_mLexicalFunctionListAST () COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1123))) ;
      ioArgument_ioSemanticDeclarationListForGeneration.addAssign_operation (GALGAS_string::makeEmptyString (), GALGAS_lexiqueDeclarationForGeneration::constructor_new (GALGAS_bool (true), GALGAS_string ("lexique-").add_operation (var_lexiqueClassName_50327.getter_fileNameRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1144)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1144)), var_lexiqueClassName_50327, var_headerContents_50400, var_cppContents_50882, var_cocoaHeader_51561, var_cocoaImplementation_51917  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1142))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1140)) ;
    }
  }
}
...
GALGAS_predefinedTypes function_buildPredefinedTypes (const GALGAS_semanticContext & constinArgument_inSemanticContext,
  ...
  result_outPredefinedTypes = GALGAS_predefinedTypes::constructor_new (GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("location"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1162))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1162)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1162)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("bool"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1163))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1163)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1163)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("char"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1164))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1164)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1164)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("string"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1165))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1165)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1165)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("uint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1166))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1166)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1166)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("sint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1167))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1167)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1167)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("uint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1168))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1168)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1168)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("sint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1169))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1169)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1169)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("double"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1170))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1170)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1170)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lbool"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1171))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1171)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1171)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lchar"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1172))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1172)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1172)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lstring"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1173))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1173)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1173)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("luint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1174))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1174)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1174)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lsint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1175))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1175)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1175)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("luint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1176))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1176)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1176)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lsint64"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1177))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1177)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1177)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("ldouble"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1178))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1178)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1178)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("stringlist"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1179))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1179)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1179)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lbigint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1180))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1180)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1180)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("bigint"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1181))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1181)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1181)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("stringset"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1182))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1182)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1182)), GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), GALGAS_lstring::constructor_new (GALGAS_string ("lstringlist"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1183))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1183)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1183))  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1161)) ;
//---
...
void routine_enterNonterminalNonTerminalInMapAndCheck (const GALGAS_lstring constinArgument_inNonTerminalName,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cMapElement_nonterminalMap * objectArray_59468 = (const cMapElement_nonterminalMap *) ioArgument_ioNonterminalDeclarationMap.readAccessForWithInstruction (constinArgument_inNonTerminalName.readProperty_string ()) ;
  if (NULL != objectArray_59468) {
      macroValidSharedObject (objectArray_59468, cMapElement_nonterminalMap) ;
    GALGAS_stringset var_firstDeclarationLabelSet_59572 = objectArray_59468->mProperty_mLabelMap.getter_keySet (SOURCE_FILE ("semanticAnalysis.galgas", 1272)) ;
    GALGAS_stringset var_reDeclarationLabelSet_59634 = constinArgument_inNonterminalLabelMap.getter_keySet (SOURCE_FILE ("semanticAnalysis.galgas", 1273)) ;
    GALGAS_stringset var_missingLabelSet_59702 = var_firstDeclarationLabelSet_59572.substract_operation (var_reDeclarationLabelSet_59634, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1274)) ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (kIsStrictSup, var_missingLabelSet_59702.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1275)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_s_59813 = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_59833 (var_missingLabelSet_59702, kENUMERATION_UP) ;
        while (enumerator_59833.hasCurrentObject ()) {
          var_s_59813.plusAssign_operation(GALGAS_string ("\n"
            "-  ").add_operation (enumerator_59833.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1278)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1278)) ;
          enumerator_59833.gotoNextObject () ;
        }
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (constinArgument_inNonTerminalName.readProperty_location (), GALGAS_string ("the '").add_operation (constinArgument_inNonTerminalName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1281)).add_operation (GALGAS_string ("' nonterminal is redeclared without the following label(s):"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1281)).add_operation (var_s_59813, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1281)), fixItArray1  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1280)) ;
      }
    }
    GALGAS_stringset var_newLabelSet_60066 = var_reDeclarationLabelSet_59634.substract_operation (var_firstDeclarationLabelSet_59572, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1283)) ;
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsStrictSup, var_newLabelSet_60066.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1284)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_string var_s_60165 = GALGAS_string::makeEmptyString () ;
        cEnumerator_stringset enumerator_60185 (var_newLabelSet_60066, kENUMERATION_UP) ;
        while (enumerator_60185.hasCurrentObject ()) {
          var_s_60165.plusAssign_operation(GALGAS_string ("\n"
            "-  ").add_operation (enumerator_60185.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1287)), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1287)) ;
          enumerator_60185.gotoNextObject () ;
        }
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (constinArgument_inNonTerminalName.readProperty_location (), GALGAS_string ("the '").add_operation (constinArgument_inNonTerminalName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1290)).add_operation (GALGAS_string ("' nonterminal is redeclared with the new label(s):"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1290)).add_operation (var_s_60165, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1290)), fixItArray3  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1289)) ;
      }
    }
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = GALGAS_bool (kIsEqual, var_missingLabelSet_59702.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1292)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_newLabelSet_60066.getter_count (SOURCE_FILE ("semanticAnalysis.galgas", 1292)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1292)).boolEnum () ;
      if (kBoolTrue == test_4) {
        cEnumerator_nonterminalLabelMap enumerator_60476 (objectArray_59468->mProperty_mLabelMap, kENUMERATION_UP) ;
        cEnumerator_nonterminalLabelMap enumerator_60524 (constinArgument_inNonterminalLabelMap, kENUMERATION_UP) ;
        while (enumerator_60476.hasCurrentObject () && enumerator_60524.hasCurrentObject ()) {
          GALGAS_formalParameterSignature var_newSignature_60604 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1294)) ;
          cEnumerator_formalParameterSignature enumerator_60705 (enumerator_60524.current_mSignature (HERE), kENUMERATION_UP) ;
          while (enumerator_60705.hasCurrentObject ()) {
            var_newSignature_60604.addAssign_operation (enumerator_60705.current_mFormalSelector (HERE), enumerator_60705.current_mFormalArgumentType (HERE), enumerator_60705.current_mFormalArgumentPassingMode (HERE), enumerator_60705.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1296)) ;
            enumerator_60705.gotoNextObject () ;
          }
          {
          routine_checkMethodSignatures (enumerator_60476.current (HERE).readProperty_mSignatureForGeneration (), enumerator_60476.current (HERE).readProperty_mEndOfArgumentLocation (), var_newSignature_60604, enumerator_60524.current_mEndOfArgumentLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1298)) ;
          }
          enumerator_60476.gotoNextObject () ;
          enumerator_60524.gotoNextObject () ;
        }
      }
    }
  }else{
...
void routine_buildNonterminalDeclarationsMap (const GALGAS_nonterminalDeclarationListAST constinArgument_inNonterminalDeclarationList,
  ...
  cEnumerator_nonterminalDeclarationListAST enumerator_61597 (constinArgument_inNonterminalDeclarationList, kENUMERATION_UP) ;
  while (enumerator_61597.hasCurrentObject ()) {
    GALGAS_nonterminalLabelMap var_nonterminalLabelMap_61661 = GALGAS_nonterminalLabelMap::constructor_emptyMap (SOURCE_FILE ("semanticAnalysis.galgas", 1320)) ;
    cEnumerator_nonTerminalLabelListAST enumerator_61749 (enumerator_61597.current_mLabels (HERE), kENUMERATION_UP) ;
    while (enumerator_61749.hasCurrentObject ()) {
      GALGAS_formalParameterListForGeneration var_signatureForGeneration_61797 = GALGAS_formalParameterListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1322)) ;
      GALGAS_formalParameterSignature var_signature_61855 = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticAnalysis.galgas", 1323)) ;
      cEnumerator_formalParameterListAST enumerator_61985 (enumerator_61749.current_mFormalArgumentList (HERE), kENUMERATION_UP) ;
      while (enumerator_61985.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_entry var_t_62026 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inSemanticContext.readProperty_mTypeMap (), enumerator_61985.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1325)) ;
        var_signatureForGeneration_61797.addAssign_operation (enumerator_61985.current_mFormalSelector (HERE), enumerator_61985.current_mFormalArgumentPassingMode (HERE), var_t_62026, enumerator_61985.current_mFormalArgumentName (HERE), enumerator_61985.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1326)) ;
        var_signature_61855.addAssign_operation (enumerator_61985.current_mFormalSelector (HERE), var_t_62026, enumerator_61985.current_mFormalArgumentPassingMode (HERE), enumerator_61985.current_mFormalArgumentName (HERE).readProperty_string ()  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1327)) ;
        enumerator_61985.gotoNextObject () ;
      }
      {
      var_nonterminalLabelMap_61661.setter_insertKey (enumerator_61749.current_mLabelName (HERE), var_signatureForGeneration_61797, var_signature_61855, enumerator_61749.current_mEndOfArgumentLocation (HERE), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1329)) ;
      }
      enumerator_61749.gotoNextObject () ;
    }
    {
    routine_enterNonterminalNonTerminalInMapAndCheck (enumerator_61597.current_mNonterminalName (HERE), var_nonterminalLabelMap_61661, outArgument_outNonterminalDeclarationMap, inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1331)) ;
    }
    enumerator_61597.gotoNextObject () ;
  }
}
...
static void extensionMethod_inputParameterVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_entry var_type_65869 ;
  GALGAS_string var_cppName_65890 ;
  {
  const GALGAS_inputParameterVariable temp_0 = object ;
  GALGAS_string joker_65892 ; // Joker input parameter
  ioArgument_ioVariableMap.setter_searchForWriteAccess (temp_0.readProperty_mActualParameterName (), var_type_65869, var_cppName_65890, joker_65892, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1407)) ;
  }
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_65935 ;
  switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  case GALGAS_lexicalTypeEnum::kNotBuilt:
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_string:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLStringType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_char:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLCharType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint_36__34_:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint_36__34_:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_double:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLDoubleType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_bigint:
    {
      var_expectedType_65935 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLBigIntType () ;
    }
    break ;
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsNotEqual, var_expectedType_65935.objectCompare (var_type_65869)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const GALGAS_inputParameterVariable temp_2 = object ;
      const GALGAS_inputParameterVariable temp_3 = object ;
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (temp_2.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_3.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1421)).add_operation (GALGAS_string ("' parameter has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1421)).add_operation (var_type_65869.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1421)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1421)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1421)).add_operation (var_expectedType_65935.getter_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1422)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1422)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1422)), fixItArray4  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1420)) ;
    }
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (GALGAS_string::makeEmptyString (), var_cppName_65890, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1424)) ;
}
...
static void extensionMethod_inputParameterDeclaredVariable_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_67553 ;
  switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  case GALGAS_lexicalTypeEnum::kNotBuilt:
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_string:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLStringType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_char:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLCharType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint_36__34_:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint_36__34_:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_double:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLDoubleType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_bigint:
    {
      var_expectedType_67553 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLBigIntType () ;
    }
    break ;
  }
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_unifiedTypeMap_2D_entry var_type_68415 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), temp_2.readProperty_mActualParameterTypeName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1452)) ;
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsNotEqual, var_expectedType_67553.objectCompare (var_type_68415)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_inputParameterDeclaredVariable temp_4 = object ;
          const GALGAS_inputParameterDeclaredVariable temp_5 = object ;
          TC_Array <C_FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (temp_4.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_5.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1455)).add_operation (GALGAS_string ("' formal argument has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1455)).add_operation (var_type_68415.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1455)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1455)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1455)).add_operation (var_expectedType_67553.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1456)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1456)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1456)), fixItArray6  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1454)) ;
        }
      }
    }
  }
  ...
  GALGAS_string var_cppName_68819 = GALGAS_string ("var_").add_operation (temp_7.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1460)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1460)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1460)).add_operation (temp_8.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1460)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1460)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1460)) ;
  {
  const GALGAS_inputParameterDeclaredVariable temp_9 = object ;
  ioArgument_ioVariableMap.setter_insertDefinedLocalVariable (temp_9.readProperty_mActualParameterName (), var_expectedType_67553, var_cppName_68819, var_cppName_68819, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1461)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType_67553.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1463)), var_cppName_68819, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1462)) ;
}
...
static void extensionMethod_inputParameterDeclaredConstant_analyzeInputParameter (const cPtr_abstractInputParameter * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_entry var_expectedType_69632 ;
  switch (constinArgument_inRequiredLexicalType.enumValue ()) {
  case GALGAS_lexicalTypeEnum::kNotBuilt:
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_string:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLStringType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_char:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLCharType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_uint_36__34_:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLUInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSIntType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_sint_36__34_:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLSInt_36__34_Type () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_double:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLDoubleType () ;
    }
    break ;
  case GALGAS_lexicalTypeEnum::kEnum_lexicalType_5F_bigint:
    {
      var_expectedType_69632 = constinArgument_inAnalysisContext.readProperty_mPredefinedTypes ().readProperty_mLBigIntType () ;
    }
    break ;
  }
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_unifiedTypeMap_2D_entry var_type_70494 = GALGAS_unifiedTypeMap_2D_entry::constructor_searchKey (constinArgument_inAnalysisContext.readProperty_mSemanticContext ().readProperty_mTypeMap (), temp_2.readProperty_mActualParameterTypeName (), inCompiler  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1490)) ;
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsNotEqual, var_expectedType_69632.objectCompare (var_type_70494)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_inputParameterDeclaredConstant temp_4 = object ;
          const GALGAS_inputParameterDeclaredConstant temp_5 = object ;
          TC_Array <C_FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (temp_4.readProperty_mActualParameterName ().readProperty_location (), GALGAS_string ("the '").add_operation (temp_5.readProperty_mActualParameterName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1493)).add_operation (GALGAS_string ("' formal argument has the '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1493)).add_operation (var_type_70494.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1493)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1493)).add_operation (GALGAS_string (", bit an '@"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1493)).add_operation (var_expectedType_69632.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1494)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1494)).add_operation (GALGAS_string ("' parameter is required here"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1494)), fixItArray6  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1492)) ;
        }
      }
    }
  }
  ...
  GALGAS_string var_cppName_70898 = GALGAS_string ("var_").add_operation (temp_7.readProperty_mActualParameterName ().readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("semanticAnalysis.galgas", 1498)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1498)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1498)).add_operation (temp_8.readProperty_mActualParameterName ().readProperty_location ().getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1498)).getter_string (SOURCE_FILE ("semanticAnalysis.galgas", 1498)), inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1498)) ;
  {
  const GALGAS_inputParameterDeclaredConstant temp_9 = object ;
  ioArgument_ioVariableMap.setter_insertLocalConstant (temp_9.readProperty_mActualParameterName (), var_expectedType_69632, var_cppName_70898, var_cppName_70898, inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1499)) ;
  }
  ioArgument_ioTerminalCheckAssignementList.addAssign_operation (var_expectedType_69632.getter_key (inCompiler COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1502)), var_cppName_70898, constinArgument_inLexicalAttributeName  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1501)) ;
}
...
static void extensionMethod_grammarInstructionSyntaxDirectedTranslationDropResult_analyzeSDT (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_inHasTranslateFeature.operator_not (SOURCE_FILE ("semanticAnalysis.galgas", 1528)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_grammarInstructionSyntaxDirectedTranslationDropResult temp_1 = object ;
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (temp_1.readProperty_mLocation (), GALGAS_string ("the ':>' construct requires the syntax component to be declared with 'translate' feature"), fixItArray2  COMMA_SOURCE_FILE ("semanticAnalysis.galgas", 1529)) ;
    }
  }
}
