...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_5F_ggs_33__i17_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                      ...
                                                                                                                      Lexique_galgasScanner_33_ * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_self COMMA_SOURCE_FILE ("instruction-concat.galgas", 206)) ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2E_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 207)) ;
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_semantic_5F_instruction_5F_beginning_5F_with_5F_identifier_i18_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
                                                                                                                                              ...
                                                                                                                                              Lexique_galgasScanner_33_ * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_lstring var_receiverName_9636 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("instruction-concat.galgas", 216)) ;
  GALGAS_location var_instructionLocation_9657 = GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 217)) ;
  GALGAS_lstringlist var_propertyList_9715 = GALGAS_lstringlist::init (inCompiler COMMA_HERE) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    if (select_galgas_33_InstructionsSyntax_22 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2E_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 221)) ;
      GALGAS_lstring var_attributeName_9788 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("instruction-concat.galgas", 222)) ;
      var_propertyList_9715.addAssign_operation (var_attributeName_9788  COMMA_SOURCE_FILE ("instruction-concat.galgas", 223)) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
  ...
  case 1: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2D__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 226)) ;
    GALGAS_semanticExpressionAST var_expression_9938 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_9938, inCompiler) ;
    outArgument_outInstruction = GALGAS_minusEqualExpressionInstructionAST::init_21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, var_expression_9938, inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2B__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 236)) ;
    switch (select_galgas_33_InstructionsSyntax_24 (inCompiler)) {
    case 1: {
      GALGAS_actualOutputArgumentList var_expressionList_10263 ;
      nt_non_5F_empty_5F_output_5F_expression_5F_list_5F_ggs_33__ (ioArgument_ioDeclarations, var_expressionList_10263, inCompiler) ;
      outArgument_outInstruction = GALGAS_plusEqualElementsInstructionAST::init_21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, var_expressionList_10263, inCompiler COMMA_HERE) ;
    } break ;
    case 2: {
      GALGAS_semanticExpressionAST var_expression_10560 ;
      nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_10560, inCompiler) ;
      outArgument_outInstruction = GALGAS_plusEqualExpressionInstructionAST::init_21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, var_expression_10560, inCompiler COMMA_HERE) ;
    } break ;
    default:
      break ;
    }
  ...
  case 3: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2A__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 257)) ;
    GALGAS_semanticExpressionAST var_expression_10868 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_10868, inCompiler) ;
    outArgument_outInstruction = GALGAS_mulEqualExpressionInstructionAST::init_21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, var_expression_10868, inCompiler COMMA_HERE) ;
  } break ;
  case 4: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__26__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 267)) ;
    GALGAS_semanticExpressionAST var_expression_11151 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_11151, inCompiler) ;
    outArgument_outInstruction = GALGAS_andEqualExpressionInstructionAST::init_21__21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, GALGAS_opAssignmentOperator::class_func_andAssign (SOURCE_FILE ("instruction-concat.galgas", 274)), var_expression_11151, inCompiler COMMA_HERE) ;
  } break ;
  case 5: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7C__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 278)) ;
    GALGAS_semanticExpressionAST var_expression_11454 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_11454, inCompiler) ;
    outArgument_outInstruction = GALGAS_andEqualExpressionInstructionAST::init_21__21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, GALGAS_opAssignmentOperator::class_func_orAssign (SOURCE_FILE ("instruction-concat.galgas", 285)), var_expression_11454, inCompiler COMMA_HERE) ;
  } break ;
  case 6: {
    inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__2F__3D_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 289)) ;
    GALGAS_semanticExpressionAST var_expression_11756 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_11756, inCompiler) ;
    outArgument_outInstruction = GALGAS_divEqualExpressionInstructionAST::init_21__21__21__21__21_ (var_instructionLocation_9657, constinArgument_inHasSelfPrefix, var_receiverName_9636, var_propertyList_9715, var_expression_11756, inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
...
void cParser_galgas_33_InstructionsSyntax::rule_galgas_33_InstructionsSyntax_non_5F_empty_5F_output_5F_expression_5F_list_5F_ggs_33__i19_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_selector_12302 ;
    switch (select_galgas_33_InstructionsSyntax_26 (inCompiler)) {
    case 1: {
      var_selector_12302 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 309)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__21_ COMMA_SOURCE_FILE ("instruction-concat.galgas", 311)) ;
      var_selector_12302 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-concat.galgas", 312)) ;
    } break ;
    default:
      break ;
    }
    GALGAS_semanticExpressionAST var_expression_12484 ;
    nt_expression_5F_ggs_33__ (ioArgument_ioDeclarations, var_expression_12484, inCompiler) ;
    outArgument_outExpressionList.addAssign_operation (var_selector_12302, var_expression_12484, GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-concat.galgas", 315))  COMMA_SOURCE_FILE ("instruction-concat.galgas", 315)) ;
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i9_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_case COMMA_SOURCE_FILE ("type-boolset.galgas", 42)) ;
      GALGAS_lstring var_slotName_2021 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("type-boolset.galgas", 43)) ;
      var_slotList_1949.addAssign_operation (var_slotName_2021  COMMA_SOURCE_FILE ("type-boolset.galgas", 44)) ;
    } break ;
    case 3: {
      nt_method_5F_declaration_5F_ggs_33__ (var_boolsetTypeName_1878, ioArgument_ioDeclarations, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("type-boolset.galgas", 48)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (ComparisonKind::equal, var_slotList_1949.getter_count (SOURCE_FILE ("type-boolset.galgas", 49)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (var_boolsetTypeName_1878.readProperty_location (), GALGAS_string ("a boolset type must define at least one case constant"), fixItArray2  COMMA_SOURCE_FILE ("type-boolset.galgas", 50)) ;
    }
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssign_operation (GALGAS_boolsetDeclarationAST::init_21_isPredefined_21__21_ (GALGAS_bool (false), var_boolsetTypeName_1878, var_slotList_1949, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("type-boolset.galgas", 52)) ;
}
...
void cParser_galgas_33_DeclarationsSyntax::rule_galgas_33_DeclarationsSyntax_declaration_5F_ggs_33__i11_ (GALGAS_galgasDeclarationAST & ioArgument_ioDeclarations,
  ...
  GALGAS_structComparison var_comparison_1582 = GALGAS_structComparison::class_func_none (SOURCE_FILE ("type-enum.galgas", 29)) ;
  GALGAS_bool var_testGetters_1609 = GALGAS_bool (false) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case GALGAS_structComparison::Enumeration::enum_none:
        {
          var_comparison_1582 = GALGAS_structComparison::class_func_comparable (SOURCE_FILE ("type-enum.galgas", 36)) ;
        }
        break ;
      case GALGAS_structComparison::Enumeration::enum_comparable:
        {
          TC_Array <FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-enum.galgas", 38)), GALGAS_string ("duplicated attribute"), fixItArray1  COMMA_SOURCE_FILE ("type-enum.galgas", 38)) ;
        }
        break ;
      case GALGAS_structComparison::Enumeration::enum_equatable:
        {
          TC_Array <FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-enum.galgas", 40)), GALGAS_string ("%comparable and %equatable are mutually exclusive"), fixItArray2  COMMA_SOURCE_FILE ("type-enum.galgas", 40)) ;
        }
        break ;
      }
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__25_equatable COMMA_SOURCE_FILE ("type-enum.galgas", 43)) ;
      switch (var_comparison_1582.enumValue ()) {
      case GALGAS_structComparison::Enumeration::invalid:
        break ;
      case GALGAS_structComparison::Enumeration::enum_none:
        {
          var_comparison_1582 = GALGAS_structComparison::class_func_equatable (SOURCE_FILE ("type-enum.galgas", 46)) ;
        }
        break ;
      case GALGAS_structComparison::Enumeration::enum_equatable:
        {
          TC_Array <FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-enum.galgas", 48)), GALGAS_string ("duplicated attribute"), fixItArray3  COMMA_SOURCE_FILE ("type-enum.galgas", 48)) ;
        }
        break ;
      case GALGAS_structComparison::Enumeration::enum_comparable:
        {
          TC_Array <FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-enum.galgas", 50)), GALGAS_string ("%comparable and %equatable are mutually exclusive"), fixItArray4  COMMA_SOURCE_FILE ("type-enum.galgas", 50)) ;
        }
        break ;
      }
    } break ;
    case 4: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__25_testGetters COMMA_SOURCE_FILE ("type-enum.galgas", 53)) ;
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = var_testGetters_1609.boolEnum () ;
        if (kBoolTrue == test_5) {
          TC_Array <FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (GALGAS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-enum.galgas", 55)), GALGAS_string ("duplicated attribute"), fixItArray6  COMMA_SOURCE_FILE ("type-enum.galgas", 55)) ;
        }
      }
      var_testGetters_1609 = GALGAS_bool (true) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7B_ COMMA_SOURCE_FILE ("type-enum.galgas", 59)) ;
  GALGAS_enumConstantList var_constantList_2379 = GALGAS_enumConstantList::init (inCompiler COMMA_HERE) ;
  bool repeatFlag_7 = true ;
  while (repeatFlag_7) {
    switch (select_galgas_33_DeclarationsSyntax_18 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_case COMMA_SOURCE_FILE ("type-enum.galgas", 63)) ;
      GALGAS_lstring var_constantName_2455 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("type-enum.galgas", 64)) ;
      GALGAS__32_lstringlist var_associatedValueTypeList_2492 = GALGAS__32_lstringlist::init (inCompiler COMMA_HERE) ;
      switch (select_galgas_33_DeclarationsSyntax_19 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__28_ COMMA_SOURCE_FILE ("type-enum.galgas", 68)) ;
        bool repeatFlag_8 = true ;
        while (repeatFlag_8) {
          GALGAS_lstring var_associatedValueType_2625 ;
          nt_type_5F_definition_5F_ggs_33__ (ioArgument_ioDeclarations, var_associatedValueType_2625, inCompiler) ;
          GALGAS_lstring var_associatedValueName_2673 = inCompiler->synthetizedAttribute_tokenString () ;
          inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken_identifier COMMA_SOURCE_FILE ("type-enum.galgas", 71)) ;
          var_associatedValueTypeList_2492.addAssign_operation (var_associatedValueType_2625, var_associatedValueName_2673  COMMA_SOURCE_FILE ("type-enum.galgas", 72)) ;
          if (select_galgas_33_DeclarationsSyntax_20 (inCompiler) == 2) {
          }else{
            repeatFlag_8 = false ;
          }
        }
        inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__29_ COMMA_SOURCE_FILE ("type-enum.galgas", 75)) ;
      } break ;
      default:
        break ;
      }
      var_constantList_2379.addAssign_operation (var_constantName_2455, var_associatedValueTypeList_2492  COMMA_SOURCE_FILE ("type-enum.galgas", 77)) ;
    } break ;
    case 3: {
  ...
  inCompiler->acceptTerminal (Lexique_galgasScanner_33_::kToken__7D_ COMMA_SOURCE_FILE ("type-enum.galgas", 81)) ;
  enumGalgasBool test_9 = kBoolTrue ;
  if (kBoolTrue == test_9) {
    test_9 = GALGAS_bool (ComparisonKind::equal, var_constantList_2379.getter_count (SOURCE_FILE ("type-enum.galgas", 82)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_9) {
      TC_Array <FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (var_enumTypeName_1519.readProperty_location (), GALGAS_string ("an enumerated type must define at least one case constant"), fixItArray10  COMMA_SOURCE_FILE ("type-enum.galgas", 83)) ;
    }
  }
  ioArgument_ioDeclarations.mProperty_mDeclarationList.addAssign_operation (GALGAS_enumDeclarationAST::init_21_isPredefined_21__21__21_comparison_21_testGetters (GALGAS_bool (false), var_enumTypeName_1519, var_constantList_2379, var_comparison_1582, var_testGetters_1609, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("type-enum.galgas", 85)) ;
}
