...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_terminal_5F_instruction_5F_indexing_i10_ (GGS__32_lstringlist & outArgument_outIndexNameList,
  ...
  case 2: {
    ...
    while (repeatFlag_0) {
      ...
      GGS_lstring var_postfixName_3213 ;
      switch (select_galgas_33_SyntaxComponentSyntax_17 (inCompiler)) {
      case 1: {
        var_postfixName_3213 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("instruction-terminal.galgas", 61)) ;
      } break ;
      case 2: {
        var_postfixName_3213 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outIndexNameList.addAssign_operation (var_indexName_3151, var_postfixName_3213  COMMA_SOURCE_FILE ("instruction-terminal.galgas", 65)) ;
