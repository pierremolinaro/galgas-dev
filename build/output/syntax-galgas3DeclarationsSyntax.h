//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                     File 'syntax-galgas3DeclarationsSyntax.h'                                       *
...
#include "syntax-galgas3DeclarationsSyntax.h"
...
//--- Non terminal declarations
  ...
  protected : virtual void nt_declaration_5F_with_5F_local_ (const class GALGAS_bool constinArgument0,
                                                             class GALGAS_galgas_33_DeclarationAST & ioArgument1,
                                                             class C_Lexique_galgas_33_Scanner * inLexique) = 0 ;

  protected : virtual void nt_declaration_5F_with_5F_local_parse (class C_Lexique_galgas_33_Scanner * inLexique) = 0 ;

  protected : virtual void nt_declaration_5F_with_5F_local_indexing (class C_Lexique_galgas_33_Scanner * inLexique) = 0 ;
...
//--- Rule declarations
  ...
  protected : void rule_galgas_33_DeclarationsSyntax_declaration_5F_with_5F_local_i13_ (const GALGAS_bool constinArgument0,
                                                                                        GALGAS_galgas_33_DeclarationAST & ioArgument1,
                                                                                        C_Lexique_galgas_33_Scanner * inLexique) ;

  protected : void rule_galgas_33_DeclarationsSyntax_declaration_5F_with_5F_local_i13_parse (C_Lexique_galgas_33_Scanner * inLexique) ;

  protected : void rule_galgas_33_DeclarationsSyntax_declaration_5F_with_5F_local_i13_indexing (C_Lexique_galgas_33_Scanner * inLexique) ;
