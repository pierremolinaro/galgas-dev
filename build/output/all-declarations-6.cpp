...
void cMapElement_internalRoutineMap::description (String & ioString, const int32_t inIndentation) const {
  ...
  ioString.addString ("mArgumentMap" ":") ;
  mProperty_mArgumentMap.description (ioString, inIndentation) ;
}

//--------------------------------------------------------------------------------------------------

typeComparisonResult cMapElement_internalRoutineMap::compare (const cCollectionElement * inOperand) const {
...
GALGAS_internalRoutineMap GALGAS_internalRoutineMap::constructor_emptyMap (LOCATION_ARGS) {
...
GALGAS_internalRoutineMap GALGAS_internalRoutineMap::constructor_mapWithMapToOverride (const GALGAS_internalRoutineMap & inMapToOverride
                                                                                       COMMA_LOCATION_ARGS) {
  GALGAS_internalRoutineMap result ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_internalRoutineMap ("internalRoutineMap",
                                           nullptr) ;
...
void cMapElement_routineArgumentMap::description (String & ioString, const int32_t inIndentation) const {
  ...
  ioString.addNL () ;
  ioString.addStringMultiple ("| ", inIndentation) ;
  ioString.addString ("mIsFilePrivate" ":") ;
  mProperty_mIsFilePrivate.description (ioString, inIndentation) ;
}

//--------------------------------------------------------------------------------------------------

typeComparisonResult cMapElement_routineArgumentMap::compare (const cCollectionElement * inOperand) const {
...
GALGAS_routineArgumentMap GALGAS_routineArgumentMap::constructor_emptyMap (LOCATION_ARGS) {
  GALGAS_routineArgumentMap result ;
  result.makeNewEmptyMap (THERE) ;
  return result ;
}
...
GALGAS_routineArgumentMap GALGAS_routineArgumentMap::constructor_mapWithMapToOverride (const GALGAS_routineArgumentMap & inMapToOverride
                                                                                       COMMA_LOCATION_ARGS) {
  GALGAS_routineArgumentMap result ;
  result.makeNewEmptyMapWithMapToOverride (inMapToOverride COMMA_THERE) ;
  return result ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_routineArgumentMap ("routineArgumentMap",
                                           nullptr) ;
...
typeComparisonResult cCollectionElement_acceptableParameterList::compare (const cCollectionElement * inOperand) const {
...
GALGAS_acceptableParameterList GALGAS_acceptableParameterList::constructor_emptyList (UNUSED_LOCATION_ARGS) {
  return GALGAS_acceptableParameterList (capCollectionElementArray ()) ;
}

//--------------------------------------------------------------------------------------------------

GALGAS_acceptableParameterList GALGAS_acceptableParameterList::constructor_listWithValue (const GALGAS_formalParameterSignature & inOperand0,
...
GALGAS_acceptableParameterList GALGAS_acceptableParameterList::getter_subListWithRange (const GALGAS_range & inRange,
                                                                                        Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) const {
  GALGAS_acceptableParameterList result = GALGAS_acceptableParameterList::constructor_emptyList (THERE) ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_acceptableParameterList ("acceptableParameterList",
                                                nullptr) ;
...
void extensionMethod_enterInstructionListInSemanticContext (const GALGAS_semanticInstructionListAST inObject,
  ...
  cEnumerator_semanticInstructionListAST enumerator_2684 (temp_0, kENUMERATION_UP) ;
  while (enumerator_2684.hasCurrentObject ()) {
    callExtensionMethod_enterInstructionInSemanticContext ((cPtr_semanticInstructionAST *) enumerator_2684.current_mInstruction (HERE).ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("semanticContext.galgas", 58)) ;
...
void cPtr_outputInputActualParameterForGeneration::description (String & ioString,
                                                                const int32_t inIndentation) const {
  ioString.addString ("[@outputInputActualParameterForGeneration:") ;
...
void cPtr_inputJokerParameterForGeneration::description (String & ioString,
                                                         const int32_t inIndentation) const {
  ioString.addString ("[@inputJokerParameterForGeneration:") ;
  mProperty_mFormalArgumentType.description (ioString, inIndentation+1) ;
  ioString.addString (", ") ;
...
void cCollectionElement_actualParameterListForGeneration::description (String & ioString, const int32_t inIndentation) const {
  ioString.addNL () ;
  ioString.addStringMultiple ("| ", inIndentation) ;
  ioString.addString ("mActualParameter" ":") ;
...
void cPtr_semanticBlockInstructionForGeneration::description (String & ioString,
                                                              const int32_t inIndentation) const {
  ioString.addString ("[@semanticBlockInstructionForGeneration:") ;
