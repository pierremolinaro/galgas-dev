...
class CollectionElementPtr_actualParameterListAST : public CollectionElementPtr {
  public: GGS_actualParameterListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_actualParameterListAST (const GGS_actualParameterAST & in_mActualParameter
                                                       COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_actualParameterListAST (const GGS_actualParameterListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_actualParameterListAST::CollectionElementPtr_actualParameterListAST (const GGS_actualParameterAST & in_mActualParameter
                                                                                          COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_actualParameterListAST::CollectionElementPtr_actualParameterListAST (const GGS_actualParameterListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_actualParameterListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_actualParameterListAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_actualParameterListAST (mObject.mProperty_mActualParameter COMMA_HERE)) ;
  return result ;
}
...
GGS_actualParameterListAST::GGS_actualParameterListAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_actualParameterListAST * p = (CollectionElementPtr_actualParameterListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_actualParameterListAST) ;
...
void GGS_actualParameterListAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                            const GGS_actualParameterAST & in_mActualParameter
                                                            COMMA_LOCATION_ARGS) {
  CollectionElementPtr_actualParameterListAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_actualParameterListAST (in_mActualParameter COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_actualParameterListForGeneration : public CollectionElementPtr {
  public: GGS_actualParameterListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_actualParameterListForGeneration (const GGS_actualParameterForGeneration & in_mActualParameter
                                                                 COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_actualParameterListForGeneration (const GGS_actualParameterListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_actualParameterListForGeneration::CollectionElementPtr_actualParameterListForGeneration (const GGS_actualParameterForGeneration & in_mActualParameter
                                                                                                              COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mActualParameter) {
}
...
CollectionElementPtr_actualParameterListForGeneration::CollectionElementPtr_actualParameterListForGeneration (const GGS_actualParameterListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (inElement.mProperty_mActualParameter) {
}
...
bool CollectionElementPtr_actualParameterListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_actualParameterListForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_actualParameterListForGeneration (mObject.mProperty_mActualParameter COMMA_HERE)) ;
  return result ;
}
...
GGS_actualParameterListForGeneration::GGS_actualParameterListForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_actualParameterListForGeneration * p = (CollectionElementPtr_actualParameterListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_actualParameterListForGeneration) ;
...
void GGS_actualParameterListForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                      const GGS_actualParameterForGeneration & in_mActualParameter
                                                                      COMMA_LOCATION_ARGS) {
  CollectionElementPtr_actualParameterListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_actualParameterListForGeneration (in_mActualParameter COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_actualOutputArgumentList : public CollectionElementPtr {
  public: GGS_actualOutputArgumentList_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_actualOutputArgumentList (const GGS_lstring & in_mActualSelector,
                                                         const GGS_semanticExpressionAST & in_mExpression,
                                                         const GGS_location & in_mEndOfExpressionLocation
                                                         COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_actualOutputArgumentList (const GGS_actualOutputArgumentList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_actualOutputArgumentList::CollectionElementPtr_actualOutputArgumentList (const GGS_lstring & in_mActualSelector,
                                                                                              const GGS_semanticExpressionAST & in_mExpression,
                                                                                              const GGS_location & in_mEndOfExpressionLocation
                                                                                              COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_actualOutputArgumentList::CollectionElementPtr_actualOutputArgumentList (const GGS_actualOutputArgumentList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_actualOutputArgumentList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_actualOutputArgumentList::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_actualOutputArgumentList (mObject.mProperty_mActualSelector, mObject.mProperty_mExpression, mObject.mProperty_mEndOfExpressionLocation COMMA_HERE)) ;
  return result ;
}
...
GGS_actualOutputArgumentList::GGS_actualOutputArgumentList (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_actualOutputArgumentList * p = (CollectionElementPtr_actualOutputArgumentList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_actualOutputArgumentList) ;
...
void GGS_actualOutputArgumentList::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                              const GGS_lstring & in_mActualSelector,
                                                              const GGS_semanticExpressionAST & in_mExpression,
                                                              const GGS_location & in_mEndOfExpressionLocation
                                                              COMMA_LOCATION_ARGS) {
  CollectionElementPtr_actualOutputArgumentList * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_actualOutputArgumentList (in_mActualSelector, in_mExpression, in_mEndOfExpressionLocation COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_semanticExpressionListForGeneration : public CollectionElementPtr {
  public: GGS_semanticExpressionListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_semanticExpressionListForGeneration (const GGS_semanticExpressionForGeneration & in_mExpression
                                                                    COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_semanticExpressionListForGeneration (const GGS_semanticExpressionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_semanticExpressionListForGeneration::CollectionElementPtr_semanticExpressionListForGeneration (const GGS_semanticExpressionForGeneration & in_mExpression
                                                                                                                    COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_semanticExpressionListForGeneration::CollectionElementPtr_semanticExpressionListForGeneration (const GGS_semanticExpressionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_semanticExpressionListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_semanticExpressionListForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_semanticExpressionListForGeneration (mObject.mProperty_mExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_semanticExpressionListForGeneration::GGS_semanticExpressionListForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_semanticExpressionListForGeneration * p = (CollectionElementPtr_semanticExpressionListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_semanticExpressionListForGeneration) ;
...
void GGS_semanticExpressionListForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                         const GGS_semanticExpressionForGeneration & in_mExpression
                                                                         COMMA_LOCATION_ARGS) {
  CollectionElementPtr_semanticExpressionListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_semanticExpressionListForGeneration (in_mExpression COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_fixitListAST : public CollectionElementPtr {
  public: GGS_fixitListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_fixitListAST (const GGS_fixitElementAST & in_mElement
                                             COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_fixitListAST (const GGS_fixitListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_fixitListAST::CollectionElementPtr_fixitListAST (const GGS_fixitElementAST & in_mElement
                                                                      COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mElement) {
}
...
CollectionElementPtr_fixitListAST::CollectionElementPtr_fixitListAST (const GGS_fixitListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_fixitListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_fixitListAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_fixitListAST (mObject.mProperty_mElement COMMA_HERE)) ;
  return result ;
}
...
GGS_fixitListAST::GGS_fixitListAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_fixitListAST * p = (CollectionElementPtr_fixitListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_fixitListAST) ;
...
void GGS_fixitListAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                  const GGS_fixitElementAST & in_mElement
                                                  COMMA_LOCATION_ARGS) {
  CollectionElementPtr_fixitListAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_fixitListAST (in_mElement COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_fixitListForGeneration : public CollectionElementPtr {
  public: GGS_fixitListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_fixitListForGeneration (const GGS_fixitElementForGeneration & in_mElement
                                                       COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_fixitListForGeneration (const GGS_fixitListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_fixitListForGeneration::CollectionElementPtr_fixitListForGeneration (const GGS_fixitElementForGeneration & in_mElement
                                                                                          COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mElement) {
}
...
CollectionElementPtr_fixitListForGeneration::CollectionElementPtr_fixitListForGeneration (const GGS_fixitListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (inElement.mProperty_mElement) {
}
...
bool CollectionElementPtr_fixitListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_fixitListForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_fixitListForGeneration (mObject.mProperty_mElement COMMA_HERE)) ;
  return result ;
}
...
GGS_fixitListForGeneration::GGS_fixitListForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_fixitListForGeneration * p = (CollectionElementPtr_fixitListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_fixitListForGeneration) ;
...
void GGS_fixitListForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                            const GGS_fixitElementForGeneration & in_mElement
                                                            COMMA_LOCATION_ARGS) {
  CollectionElementPtr_fixitListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_fixitListForGeneration (in_mElement COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_logListAST : public CollectionElementPtr {
  public: GGS_logListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_logListAST (const GGS_lstring & in_mLogMessage,
                                           const GGS_semanticExpressionAST & in_mLogExpression
                                           COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_logListAST (const GGS_logListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_logListAST::CollectionElementPtr_logListAST (const GGS_lstring & in_mLogMessage,
                                                                  const GGS_semanticExpressionAST & in_mLogExpression
                                                                  COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_logListAST::CollectionElementPtr_logListAST (const GGS_logListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_logListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_logListAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_logListAST (mObject.mProperty_mLogMessage, mObject.mProperty_mLogExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_logListAST::GGS_logListAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_logListAST * p = (CollectionElementPtr_logListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_logListAST) ;
...
void GGS_logListAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                const GGS_lstring & in_mLogMessage,
                                                const GGS_semanticExpressionAST & in_mLogExpression
                                                COMMA_LOCATION_ARGS) {
  CollectionElementPtr_logListAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_logListAST (in_mLogMessage, in_mLogExpression COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_CommaSeparatedExpressionList : public CollectionElementPtr {
  public: GGS_CommaSeparatedExpressionList_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_CommaSeparatedExpressionList (const GGS_ifExpressionKind & in_mExpression
                                                             COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_CommaSeparatedExpressionList (const GGS_CommaSeparatedExpressionList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_CommaSeparatedExpressionList::CollectionElementPtr_CommaSeparatedExpressionList (const GGS_ifExpressionKind & in_mExpression
                                                                                                      COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mExpression) {
}
...
CollectionElementPtr_CommaSeparatedExpressionList::CollectionElementPtr_CommaSeparatedExpressionList (const GGS_CommaSeparatedExpressionList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (inElement.mProperty_mExpression) {
}
...
bool CollectionElementPtr_CommaSeparatedExpressionList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_CommaSeparatedExpressionList::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_CommaSeparatedExpressionList (mObject.mProperty_mExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_CommaSeparatedExpressionList::GGS_CommaSeparatedExpressionList (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_CommaSeparatedExpressionList * p = (CollectionElementPtr_CommaSeparatedExpressionList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_CommaSeparatedExpressionList) ;
...
void GGS_CommaSeparatedExpressionList::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                  const GGS_ifExpressionKind & in_mExpression
                                                                  COMMA_LOCATION_ARGS) {
  CollectionElementPtr_CommaSeparatedExpressionList * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_CommaSeparatedExpressionList (in_mExpression COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_semanticInstructionListAST : public CollectionElementPtr {
  public: GGS_semanticInstructionListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_semanticInstructionListAST (const GGS_semanticInstructionAST & in_mInstruction
                                                           COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_semanticInstructionListAST (const GGS_semanticInstructionListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_semanticInstructionListAST::CollectionElementPtr_semanticInstructionListAST (const GGS_semanticInstructionAST & in_mInstruction
                                                                                                  COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_semanticInstructionListAST::CollectionElementPtr_semanticInstructionListAST (const GGS_semanticInstructionListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_semanticInstructionListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_semanticInstructionListAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_semanticInstructionListAST (mObject.mProperty_mInstruction COMMA_HERE)) ;
  return result ;
}
...
GGS_semanticInstructionListAST::GGS_semanticInstructionListAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_semanticInstructionListAST * p = (CollectionElementPtr_semanticInstructionListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_semanticInstructionListAST) ;
...
void GGS_semanticInstructionListAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                const GGS_semanticInstructionAST & in_mInstruction
                                                                COMMA_LOCATION_ARGS) {
  CollectionElementPtr_semanticInstructionListAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_semanticInstructionListAST (in_mInstruction COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_ifTestListForGeneration : public CollectionElementPtr {
  public: GGS_ifTestListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_ifTestListForGeneration (const GGS_ifTestForGeneration & in_mExpression
                                                        COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_ifTestListForGeneration (const GGS_ifTestListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_ifTestListForGeneration::CollectionElementPtr_ifTestListForGeneration (const GGS_ifTestForGeneration & in_mExpression
                                                                                            COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mExpression) {
}
...
CollectionElementPtr_ifTestListForGeneration::CollectionElementPtr_ifTestListForGeneration (const GGS_ifTestListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (inElement.mProperty_mExpression) {
}
...
bool CollectionElementPtr_ifTestListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_ifTestListForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_ifTestListForGeneration (mObject.mProperty_mExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_ifTestListForGeneration::GGS_ifTestListForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_ifTestListForGeneration * p = (CollectionElementPtr_ifTestListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_ifTestListForGeneration) ;
...
void GGS_ifTestListForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                             const GGS_ifTestForGeneration & in_mExpression
                                                             COMMA_LOCATION_ARGS) {
  CollectionElementPtr_ifTestListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_ifTestListForGeneration (in_mExpression COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_semanticInstructionListForGeneration : public CollectionElementPtr {
  public: GGS_semanticInstructionListForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_semanticInstructionListForGeneration (const GGS_semanticInstructionForGeneration & in_mInstruction
                                                                     COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_semanticInstructionListForGeneration (const GGS_semanticInstructionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_semanticInstructionListForGeneration::CollectionElementPtr_semanticInstructionListForGeneration (const GGS_semanticInstructionForGeneration & in_mInstruction
                                                                                                                      COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (in_mInstruction) {
}
...
CollectionElementPtr_semanticInstructionListForGeneration::CollectionElementPtr_semanticInstructionListForGeneration (const GGS_semanticInstructionListForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
mObject (inElement.mProperty_mInstruction) {
}
...
bool CollectionElementPtr_semanticInstructionListForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_semanticInstructionListForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_semanticInstructionListForGeneration (mObject.mProperty_mInstruction COMMA_HERE)) ;
  return result ;
}
...
GGS_semanticInstructionListForGeneration::GGS_semanticInstructionListForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_semanticInstructionListForGeneration * p = (CollectionElementPtr_semanticInstructionListForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_semanticInstructionListForGeneration) ;
...
void GGS_semanticInstructionListForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                          const GGS_semanticInstructionForGeneration & in_mInstruction
                                                                          COMMA_LOCATION_ARGS) {
  CollectionElementPtr_semanticInstructionListForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_semanticInstructionListForGeneration (in_mInstruction COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_switchExtractedValuesListAST : public CollectionElementPtr {
  public: GGS_switchExtractedValuesListAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_switchExtractedValuesListAST (const GGS_lstring & in_mExtractedValueTypeName,
                                                             const GGS_lstring & in_mExtractedValueName,
                                                             const GGS_bool & in_mMarkedAsUnused
                                                             COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_switchExtractedValuesListAST (const GGS_switchExtractedValuesListAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_switchExtractedValuesListAST::CollectionElementPtr_switchExtractedValuesListAST (const GGS_lstring & in_mExtractedValueTypeName,
                                                                                                      const GGS_lstring & in_mExtractedValueName,
                                                                                                      const GGS_bool & in_mMarkedAsUnused
                                                                                                      COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_switchExtractedValuesListAST::CollectionElementPtr_switchExtractedValuesListAST (const GGS_switchExtractedValuesListAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_switchExtractedValuesListAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_switchExtractedValuesListAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_switchExtractedValuesListAST (mObject.mProperty_mExtractedValueTypeName, mObject.mProperty_mExtractedValueName, mObject.mProperty_mMarkedAsUnused COMMA_HERE)) ;
  return result ;
}
...
GGS_switchExtractedValuesListAST::GGS_switchExtractedValuesListAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_switchExtractedValuesListAST * p = (CollectionElementPtr_switchExtractedValuesListAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_switchExtractedValuesListAST) ;
...
void GGS_switchExtractedValuesListAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                  const GGS_lstring & in_mExtractedValueTypeName,
                                                                  const GGS_lstring & in_mExtractedValueName,
                                                                  const GGS_bool & in_mMarkedAsUnused
                                                                  COMMA_LOCATION_ARGS) {
  CollectionElementPtr_switchExtractedValuesListAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_switchExtractedValuesListAST (in_mExtractedValueTypeName, in_mExtractedValueName, in_mMarkedAsUnused COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_switchBranchesAST : public CollectionElementPtr {
  public: GGS_switchBranchesAST_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_switchBranchesAST (const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                  ...
                                                  COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_switchBranchesAST (const GGS_switchBranchesAST_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_switchBranchesAST::CollectionElementPtr_switchBranchesAST (const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                                                const GGS_switchExtractedValuesListAST & in_mAssociatedValuesExtraction,
                                                                                const GGS_semanticInstructionListAST & in_mInstructions,
                                                                                const GGS_location & in_mEndOfBranch
                                                                                COMMA_LOCATION_ARGS) :
...
CollectionElementPtr_switchBranchesAST::CollectionElementPtr_switchBranchesAST (const GGS_switchBranchesAST_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_switchBranchesAST::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_switchBranchesAST::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_switchBranchesAST (mObject.mProperty_mSwitchConstantList, mObject.mProperty_mAssociatedValuesExtraction, mObject.mProperty_mInstructions, mObject.mProperty_mEndOfBranch COMMA_HERE)) ;
  return result ;
}
...
GGS_switchBranchesAST::GGS_switchBranchesAST (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_switchBranchesAST * p = (CollectionElementPtr_switchBranchesAST *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_switchBranchesAST) ;
...
void GGS_switchBranchesAST::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                       const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                       const GGS_switchExtractedValuesListAST & in_mAssociatedValuesExtraction,
                                                       const GGS_semanticInstructionListAST & in_mInstructions,
                                                       const GGS_location & in_mEndOfBranch
                                                       COMMA_LOCATION_ARGS) {
  CollectionElementPtr_switchBranchesAST * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_switchBranchesAST (in_mSwitchConstantList, in_mAssociatedValuesExtraction, in_mInstructions, in_mEndOfBranch COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_extractedAssociatedValuesForGeneration : public CollectionElementPtr {
  public: GGS_extractedAssociatedValuesForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_extractedAssociatedValuesForGeneration (const GGS_unifiedTypeMapEntry & in_mType,
                                                                       const GGS_string & in_mCppName,
                                                                       const GGS_string & in_name
                                                                       COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_extractedAssociatedValuesForGeneration (const GGS_extractedAssociatedValuesForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_extractedAssociatedValuesForGeneration::CollectionElementPtr_extractedAssociatedValuesForGeneration (const GGS_unifiedTypeMapEntry & in_mType,
                                                                                                                          const GGS_string & in_mCppName,
                                                                                                                          const GGS_string & in_name
                                                                                                                          COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
CollectionElementPtr_extractedAssociatedValuesForGeneration::CollectionElementPtr_extractedAssociatedValuesForGeneration (const GGS_extractedAssociatedValuesForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_extractedAssociatedValuesForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_extractedAssociatedValuesForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_extractedAssociatedValuesForGeneration (mObject.mProperty_mType, mObject.mProperty_mCppName, mObject.mProperty_name COMMA_HERE)) ;
  return result ;
}
...
GGS_extractedAssociatedValuesForGeneration::GGS_extractedAssociatedValuesForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_extractedAssociatedValuesForGeneration * p = (CollectionElementPtr_extractedAssociatedValuesForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_extractedAssociatedValuesForGeneration) ;
...
void GGS_extractedAssociatedValuesForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                            const GGS_unifiedTypeMapEntry & in_mType,
                                                                            const GGS_string & in_mCppName,
                                                                            const GGS_string & in_name
                                                                            COMMA_LOCATION_ARGS) {
  CollectionElementPtr_extractedAssociatedValuesForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_extractedAssociatedValuesForGeneration (in_mType, in_mCppName, in_name COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
class CollectionElementPtr_switchBranchesForGeneration : public CollectionElementPtr {
  public: GGS_switchBranchesForGeneration_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_switchBranchesForGeneration (const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                            ...
                                                            COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_switchBranchesForGeneration (const GGS_switchBranchesForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_switchBranchesForGeneration::CollectionElementPtr_switchBranchesForGeneration (const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                                                                    const GGS_extractedAssociatedValuesForGeneration & in_mExtractedAssociatedValuesForGeneration,
                                                                                                    const GGS_uint & in_mEndOfBranchLocationIndex,
                                                                                                    const GGS_semanticInstructionListForGeneration & in_mInstructions
                                                                                                    COMMA_LOCATION_ARGS) :
...
CollectionElementPtr_switchBranchesForGeneration::CollectionElementPtr_switchBranchesForGeneration (const GGS_switchBranchesForGeneration_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_switchBranchesForGeneration::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_switchBranchesForGeneration::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_switchBranchesForGeneration (mObject.mProperty_mSwitchConstantList, mObject.mProperty_mExtractedAssociatedValuesForGeneration, mObject.mProperty_mEndOfBranchLocationIndex, mObject.mProperty_mInstructions COMMA_HERE)) ;
  return result ;
}
...
GGS_switchBranchesForGeneration::GGS_switchBranchesForGeneration (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_switchBranchesForGeneration * p = (CollectionElementPtr_switchBranchesForGeneration *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_switchBranchesForGeneration) ;
...
void GGS_switchBranchesForGeneration::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                                 const GGS__5B_lstring_5D_ & in_mSwitchConstantList,
                                                                 const GGS_extractedAssociatedValuesForGeneration & in_mExtractedAssociatedValuesForGeneration,
                                                                 const GGS_uint & in_mEndOfBranchLocationIndex,
                                                                 const GGS_semanticInstructionListForGeneration & in_mInstructions
                                                                 COMMA_LOCATION_ARGS) {
  CollectionElementPtr_switchBranchesForGeneration * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_switchBranchesForGeneration (in_mSwitchConstantList, in_mExtractedAssociatedValuesForGeneration, in_mEndOfBranchLocationIndex, in_mInstructions COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void extensionMethod_enterFixItListInSemanticContext (const GGS_fixitListAST inObject,
  ...
  UpEnumerator_fixitListAST enumerator_8081 (temp_0) ;
  while (enumerator_8081.hasCurrentObject ()) {
    switch (enumerator_8081.current_mElement (HERE).enumValue ()) {
    ...
    case GGS_fixitElementAST::Enumeration::enum_fixItReplace:
      {
        GGS_semanticExpressionAST extractedValue_8189_exp_0 ;
        GGS_location extractedValue_8193__1 ;
        enumerator_8081.current_mElement (HERE).getAssociatedValuesFor_fixItReplace (extractedValue_8189_exp_0, extractedValue_8193__1) ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8189_exp_0.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 220)) ;
      }
      break ;
    case GGS_fixitElementAST::Enumeration::enum_fixItInsertBefore:
      {
        GGS_semanticExpressionAST extractedValue_8306_exp_0 ;
        GGS_location extractedValue_8310__1 ;
        enumerator_8081.current_mElement (HERE).getAssociatedValuesFor_fixItInsertBefore (extractedValue_8306_exp_0, extractedValue_8310__1) ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8306_exp_0.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 222)) ;
      }
      break ;
    case GGS_fixitElementAST::Enumeration::enum_fixItInsertAfter:
      {
        GGS_semanticExpressionAST extractedValue_8422_exp_0 ;
        GGS_location extractedValue_8426__1 ;
        enumerator_8081.current_mElement (HERE).getAssociatedValuesFor_fixItInsertAfter (extractedValue_8422_exp_0, extractedValue_8426__1) ;
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_8422_exp_0.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 224)) ;
      }
      break ;
    }
...
void extensionMethod_generateFixIt (const GGS_fixitListForGeneration inObject,
  ...
  outArgument_outFixItArrayCppName = GGS_string ("fixItArray").add_operation (ioArgument_ioTemporaryVariableIndex.getter_string (SOURCE_FILE ("instruction-error.galgas", 413)), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 413)) ;
  ioArgument_ioTemporaryVariableIndex.plusAssignOperation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 414)) ;
  ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("GenericArray <FixItDescription> ").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 415)).add_operation (GGS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 415)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 415)) ;
  const GGS_fixitListForGeneration temp_0 = inObject ;
  UpEnumerator_fixitListForGeneration enumerator_16379 (temp_0) ;
  while (enumerator_16379.hasCurrentObject ()) {
    switch (enumerator_16379.current_mElement (HERE).enumValue ()) {
    case GGS_fixitElementForGeneration::Enumeration::invalid:
      break ;
    case GGS_fixitElementForGeneration::Enumeration::enum_fixItRemove:
      {
        ioArgument_ioGeneratedCode.plusAssignOperation(outArgument_outFixItArrayCppName.add_operation (GGS_string (".appendObject (FixItDescription (EnumFixItKind::fixItRemove, \"\")) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 419)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 419)) ;
      }
      break ;
    case GGS_fixitElementForGeneration::Enumeration::enum_fixItReplace:
      {
        GGS_semanticExpressionForGeneration extractedValue_16621_exp_0 ;
        enumerator_16379.current_mElement (HERE).getAssociatedValuesFor_fixItReplace (extractedValue_16621_exp_0) ;
        GGS_string var_receiverCppVarName_16794 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_16621_exp_0.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_16794, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 421)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 428)).add_operation (GGS_string (", EnumFixItKind::fixItReplace, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 428)).add_operation (var_receiverCppVarName_16794, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 428)).add_operation (GGS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 428)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 428)) ;
      }
      break ;
    case GGS_fixitElementForGeneration::Enumeration::enum_fixItInsertBefore:
      {
        GGS_semanticExpressionForGeneration extractedValue_17020_exp_0 ;
        enumerator_16379.current_mElement (HERE).getAssociatedValuesFor_fixItInsertBefore (extractedValue_17020_exp_0) ;
        GGS_string var_receiverCppVarName_17193 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_17020_exp_0.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_17193, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 430)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 437)).add_operation (GGS_string (", EnumFixItKind::fixItInsertBefore, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 437)).add_operation (var_receiverCppVarName_17193, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 437)).add_operation (GGS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 437)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 437)) ;
      }
      break ;
    case GGS_fixitElementForGeneration::Enumeration::enum_fixItInsertAfter:
      {
        GGS_semanticExpressionForGeneration extractedValue_17423_exp_0 ;
        enumerator_16379.current_mElement (HERE).getAssociatedValuesFor_fixItInsertAfter (extractedValue_17423_exp_0) ;
        GGS_string var_receiverCppVarName_17596 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_17423_exp_0.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverCppVarName_17596, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 439)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("appendFixItActions (").add_operation (outArgument_outFixItArrayCppName, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 446)).add_operation (GGS_string (", EnumFixItKind::fixItInsertAfter, "), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 446)).add_operation (var_receiverCppVarName_17596, inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 446)).add_operation (GGS_string (") ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-error.galgas", 446)), inCompiler  COMMA_SOURCE_FILE ("instruction-error.galgas", 446)) ;
      }
      break ;
    }
    ...
    case GGS_ifExpressionKind::Enumeration::enum_regularExp:
      {
        ...
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_5751_exp_0.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 168)) ;
      }
      break ;
    case GGS_ifExpressionKind::Enumeration::enum_letVarExp:
      {
        ...
        callExtensionMethod_enterExpressionInSemanticContext ((cPtr_semanticExpressionAST *) extractedValue_5844_exp_2.ptr (), ioArgument_ioTypeMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 170)) ;
        {
        GGS_unifiedTypeMapEntry joker_5971 ; // Joker input parameter
        extensionSetter_makeEntry (ioArgument_ioTypeMap, extractedValue_5859_typeName_4, joker_5971, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 171)) ;
        }
      }
      break ;
    }
...
void extensionMethod_analyzeSemanticExpressionList (const GGS_CommaSeparatedExpressionList inObject,
  ...
  const GGS_CommaSeparatedExpressionList temp_0 = inObject ;
  UpEnumerator_CommaSeparatedExpressionList enumerator_6627 (temp_0) ;
  while (enumerator_6627.hasCurrentObject ()) {
    switch (enumerator_6627.current_mExpression (HERE).enumValue ()) {
    case GGS_ifExpressionKind::Enumeration::invalid:
      break ;
    case GGS_ifExpressionKind::Enumeration::enum_regularExp:
      {
        GGS_semanticExpressionAST extractedValue_6697_exp_0 ;
        GGS_location extractedValue_6701_endOfExpression_1 ;
        enumerator_6627.current_mExpression (HERE).getAssociatedValuesFor_regularExp (extractedValue_6697_exp_0, extractedValue_6701_endOfExpression_1) ;
        GGS_semanticExpressionForGeneration var_analyzed_5F_if_5F_expression_6985 ;
        callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) extractedValue_6697_exp_0.ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, GGS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 191)), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_analyzed_5F_if_5F_expression_6985, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 188)) ;
        GGS_semanticExpressionForGeneration var_if_5F_expression_7158 ;
        {
        routine_checkExpressionIsBoolean_3F__3F__3F__21_ (constinArgument_inAnalysisContext, extractedValue_6701_endOfExpression_1, var_analyzed_5F_if_5F_expression_6985, var_if_5F_expression_7158, inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 197)) ;
        }
        outArgument_outTestListForGeneration.addAssignOperation (GGS_ifTestForGeneration::class_func_regular (var_if_5F_expression_7158  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 203))  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 203)) ;
        {
    ...
    case GGS_ifExpressionKind::Enumeration::enum_letVarExp:
      {
        GGS_lstring extractedValue_7362_varName_0 ;
        GGS_bool extractedValue_7370_isConstant_1 ;
        GGS_semanticExpressionAST extractedValue_7381_exp_2 ;
        GGS_location extractedValue_7385__3 ;
        GGS_lstring extractedValue_7396_typeName_4 ;
        enumerator_6627.current_mExpression (HERE).getAssociatedValuesFor_letVarExp (extractedValue_7362_varName_0, extractedValue_7370_isConstant_1, extractedValue_7381_exp_2, extractedValue_7385__3, extractedValue_7396_typeName_4) ;
        GGS_semanticExpressionForGeneration var_analyzedExpression_7673 ;
        callExtensionMethod_analyzeSemanticExpression ((cPtr_semanticExpressionAST *) extractedValue_7381_exp_2.ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, GGS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 210)), constinArgument_inAnalysisContext, ioArgument_ioTypeMap, ioArgument_ioVariableMap, var_analyzedExpression_7673, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 207)) ;
        GGS_unifiedTypeMapEntry var_castType_7714 = GGS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 216)) ;
        GGS_unifiedTypeMapEntry var_testType_7763 = GGS_unifiedTypeMapEntry::class_func_null (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 217)) ;
        GGS_unifiedTypeMapEntry var_unwrappedType_7850 = extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 219)).readProperty_unwrappedType () ;
        GalgasBool test_1 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_1) {
          test_1 = var_unwrappedType_7850.getter_isNull (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 220)).operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 220)).boolEnum () ;
          if (GalgasBool::boolTrue == test_1) {
            {
            ...
            GGS_string var_targetVariableCppName_8072 = GGS_string ("var_").add_operation (extractedValue_7362_varName_0.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 223)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 223)).add_operation (GGS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 223)).add_operation (extractedValue_7362_varName_0.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 224)).getter_string (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 224)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 224)) ;
            GalgasBool test_2 = GalgasBool::boolTrue ;
            if (GalgasBool::boolTrue == test_2) {
              test_2 = GGS_bool (ComparisonKind::notEqual, extractedValue_7362_varName_0.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
              if (GalgasBool::boolTrue == test_2) {
                GalgasBool test_3 = GalgasBool::boolTrue ;
                if (GalgasBool::boolTrue == test_3) {
                  test_3 = extractedValue_7370_isConstant_1.boolEnum () ;
                  if (GalgasBool::boolTrue == test_3) {
                    {
                    extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, extractedValue_7362_varName_0, var_unwrappedType_7850, var_targetVariableCppName_8072, var_targetVariableCppName_8072, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 227)) ;
                    }
                  }
                }
                if (GalgasBool::boolFalse == test_3) {
                  {
                  extensionSetter_insertInitializedLocalVariable (ioArgument_ioVariableMap, extractedValue_7362_varName_0, GGS_bool (true), var_unwrappedType_7850, var_targetVariableCppName_8072, var_targetVariableCppName_8072, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 234)) ;
                  }
                }
              }
            }
            var_castType_7714 = var_unwrappedType_7850 ;
            var_testType_7763 = var_analyzedExpression_7673.readProperty_mResultType () ;
            outArgument_outTestListForGeneration.addAssignOperation (GGS_ifTestForGeneration::class_func_optionalExp (var_targetVariableCppName_8072, extractedValue_7370_isConstant_1, var_analyzedExpression_7673, var_unwrappedType_7850  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 245))  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 245)) ;
          }
        }
        if (GalgasBool::boolFalse == test_1) {
          GalgasBool test_4 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_4) {
            test_4 = extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 252)).readProperty_typeKind ().getter_isClassType (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 252)).boolEnum () ;
            if (GalgasBool::boolTrue == test_4) {
              GalgasBool test_5 = GalgasBool::boolTrue ;
              if (GalgasBool::boolTrue == test_5) {
                test_5 = GGS_bool (ComparisonKind::equal, extractedValue_7396_typeName_4.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
                if (GalgasBool::boolTrue == test_5) {
                  GenericArray <FixItDescription> fixItArray6 ;
                  inCompiler->emitSemanticError (extractedValue_7396_typeName_4.readProperty_location (), GGS_string ("on a class object, the 'as' clause is required"), fixItArray6  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 254)) ;
                  var_castType_7714.drop () ; // Release error dropped variable
                  var_testType_7763.drop () ; // Release error dropped variable
                }
              }
              if (GalgasBool::boolFalse == test_5) {
                var_castType_7714 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, extractedValue_7396_typeName_4, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 256)) ;
                var_testType_7763 = var_castType_7714 ;
                GGS_unifiedTypeMapEntry var_t_9592 = var_castType_7714 ;
                GGS_bool var_found_9627 = GGS_bool (ComparisonKind::equal, var_t_9592.objectCompare (var_analyzedExpression_7673.readProperty_mResultType ())) ;
                if (ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 261)).add_operation (GGS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 261)).isValid ()) {
                  uint32_t variant_9683 = ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 261)).add_operation (GGS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 261)).uintValue () ;
                  bool loop_9683 = true ;
                  while (loop_9683) {
                    loop_9683 = var_found_9627.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).operator_and (extensionGetter_definition (var_t_9592, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).readProperty_superType ().getter_isNull (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)) COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).isValid () ;
                    if (loop_9683) {
                      loop_9683 = var_found_9627.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).operator_and (extensionGetter_definition (var_t_9592, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).readProperty_superType ().getter_isNull (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)) COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 262)).boolValue () ;
                    }
                    ...
                    if (loop_9683) {
                      variant_9683 -= 1 ;
                      var_t_9592 = extensionGetter_definition (var_t_9592, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 263)).readProperty_superType () ;
                      var_found_9627 = GGS_bool (ComparisonKind::equal, var_t_9592.objectCompare (var_analyzedExpression_7673.readProperty_mResultType ())) ;
                    }
                  }
                }
                GalgasBool test_7 = GalgasBool::boolTrue ;
                if (GalgasBool::boolTrue == test_7) {
                  test_7 = var_found_9627.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 266)).boolEnum () ;
                  if (GalgasBool::boolTrue == test_7) {
                    GenericArray <FixItDescription> fixItArray8 ;
                    inCompiler->emitSemanticError (extractedValue_7396_typeName_4.readProperty_location (), GGS_string ("the '@").add_operation (extractedValue_7396_typeName_4.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 268)).add_operation (GGS_string ("' type is not a descendant of the '@"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 268)).add_operation (extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 269)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 268)).add_operation (GGS_string ("' type of the cast expression"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 269)), fixItArray8  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 267)) ;
                  }
                }
              }
              {
              extensionSetter_openOverrideForSelectBlock (ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 274)) ;
              }
              {
              extensionSetter_openBranch (ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 275)) ;
              }
              GGS_string var_targetVariableCppName_10307 = GGS_string ("var_").add_operation (extractedValue_7362_varName_0.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 276)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 276)).add_operation (GGS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 276)).add_operation (extractedValue_7362_varName_0.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 277)).getter_string (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 277)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 277)) ;
              GalgasBool test_9 = GalgasBool::boolTrue ;
              if (GalgasBool::boolTrue == test_9) {
                test_9 = GGS_bool (ComparisonKind::notEqual, extractedValue_7362_varName_0.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
                if (GalgasBool::boolTrue == test_9) {
                  GalgasBool test_10 = GalgasBool::boolTrue ;
                  if (GalgasBool::boolTrue == test_10) {
                    test_10 = extractedValue_7370_isConstant_1.boolEnum () ;
                    if (GalgasBool::boolTrue == test_10) {
                      {
                      extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, extractedValue_7362_varName_0, var_castType_7714, var_targetVariableCppName_10307, var_targetVariableCppName_10307, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 280)) ;
                      }
                    }
                  }
                  if (GalgasBool::boolFalse == test_10) {
                    {
                    extensionSetter_insertInitializedLocalVariable (ioArgument_ioVariableMap, extractedValue_7362_varName_0, GGS_bool (true), var_castType_7714, var_targetVariableCppName_10307, var_targetVariableCppName_10307, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 287)) ;
                    }
                  }
                }
              }
              outArgument_outTestListForGeneration.addAssignOperation (GGS_ifTestForGeneration::class_func_letVarExp (var_targetVariableCppName_10307, var_analyzedExpression_7673, var_castType_7714, var_testType_7763  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 296))  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 296)) ;
            }
          }
          if (GalgasBool::boolFalse == test_4) {
            GalgasBool test_11 = GalgasBool::boolTrue ;
            if (GalgasBool::boolTrue == test_11) {
              const GGS_typeKindEnum_2E_weakReferenceType var_weakRefType_11251 = extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 302)).readProperty_typeKind ().getter_getWeakReferenceType (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 302)).unwrappedValue () ;
              if (!extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 302)).readProperty_typeKind ().getter_getWeakReferenceType (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 302)).isValuated ()) {
                test_11 = GalgasBool::boolFalse ;
              }
              if (GalgasBool::boolTrue == test_11) {
                GalgasBool test_12 = GalgasBool::boolTrue ;
                if (GalgasBool::boolTrue == test_12) {
                  test_12 = GGS_bool (ComparisonKind::equal, extractedValue_7396_typeName_4.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
                  if (GalgasBool::boolTrue == test_12) {
                    var_castType_7714 = var_weakRefType_11251.readProperty_referenceType () ;
                  }
                }
                if (GalgasBool::boolFalse == test_12) {
                  var_castType_7714 = extensionGetter_typeMapEntryForLKey (ioArgument_ioTypeMap, extractedValue_7396_typeName_4, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 306)) ;
                }
                var_testType_7763 = var_castType_7714 ;
                GGS_unifiedTypeMapEntry var_t_11590 = var_castType_7714 ;
                GGS_bool var_found_11623 = GGS_bool (ComparisonKind::equal, var_t_11590.objectCompare (var_analyzedExpression_7673.readProperty_mResultType ())) ;
                GalgasBool test_13 = GalgasBool::boolTrue ;
                if (GalgasBool::boolTrue == test_13) {
                  test_13 = var_found_11623.boolEnum () ;
                  if (GalgasBool::boolTrue == test_13) {
                    extensionGetter_definition (var_castType_7714, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 312)).readProperty_typeKind ().method_extractWeakReferenceType (var_castType_7714, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 312)) ;
                  }
                }
                if (GalgasBool::boolFalse == test_13) {
                  GalgasBool test_14 = GalgasBool::boolTrue ;
                  if (GalgasBool::boolTrue == test_14) {
                    test_14 = GGS_bool (ComparisonKind::equal, var_t_11590.objectCompare (var_weakRefType_11251.readProperty_referenceType ())).boolEnum () ;
                    if (GalgasBool::boolTrue == test_14) {
                      var_found_11623 = GGS_bool (true) ;
                    }
                  }
                }
                if (ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 316)).add_operation (GGS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 316)).isValid ()) {
                  uint32_t variant_11885 = ioArgument_ioTypeMap.getter_count (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 316)).add_operation (GGS_uint (uint32_t (1U)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 316)).uintValue () ;
                  bool loop_11885 = true ;
                  while (loop_11885) {
                    loop_11885 = var_found_11623.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).operator_and (extensionGetter_definition (var_t_11590, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).readProperty_superType ().getter_isNull (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)) COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).isValid () ;
                    if (loop_11885) {
                      loop_11885 = var_found_11623.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).operator_and (extensionGetter_definition (var_t_11590, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).readProperty_superType ().getter_isNull (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)) COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 317)).boolValue () ;
                    }
                    if (loop_11885 && (0 == variant_11885)) {
                      loop_11885 = false ;
                      inCompiler->loopRunTimeVariantError (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 316)) ;
                    }
                    if (loop_11885) {
                      variant_11885 -= 1 ;
                      var_t_11590 = extensionGetter_definition (var_t_11590, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 318)).readProperty_superType () ;
                      GalgasBool test_15 = GalgasBool::boolTrue ;
                      if (GalgasBool::boolTrue == test_15) {
                        test_15 = GGS_bool (ComparisonKind::equal, var_t_11590.objectCompare (var_analyzedExpression_7673.readProperty_mResultType ())).boolEnum () ;
                        if (GalgasBool::boolTrue == test_15) {
                          var_found_11623 = GGS_bool (true) ;
                          extensionGetter_definition (var_castType_7714, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 321)).readProperty_typeKind ().method_extractWeakReferenceType (var_castType_7714, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 321)) ;
                        }
                      }
                      if (GalgasBool::boolFalse == test_15) {
                        GalgasBool test_16 = GalgasBool::boolTrue ;
                        if (GalgasBool::boolTrue == test_16) {
                          test_16 = GGS_bool (ComparisonKind::equal, var_t_11590.objectCompare (var_weakRefType_11251.readProperty_referenceType ())).boolEnum () ;
                          if (GalgasBool::boolTrue == test_16) {
                            var_found_11623 = GGS_bool (true) ;
                          }
                        }
                ...
                if (GalgasBool::boolTrue == test_17) {
                  test_17 = var_found_11623.operator_not (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 326)).boolEnum () ;
                  if (GalgasBool::boolTrue == test_17) {
                    GenericArray <FixItDescription> fixItArray18 ;
                    inCompiler->emitSemanticError (extractedValue_7396_typeName_4.readProperty_location (), GGS_string ("the '@").add_operation (extensionGetter_definition (var_castType_7714, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 328)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 328)).add_operation (GGS_string ("' type is not compatible with the '@"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 328)).add_operation (extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 330)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 329)).add_operation (GGS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 330)), fixItArray18  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 327)) ;
                  }
                }
                {
                extensionSetter_openOverrideForSelectBlock (ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 333)) ;
                }
                {
                extensionSetter_openBranch (ioArgument_ioVariableMap, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 334)) ;
                }
                GGS_string var_targetVariableCppName_12696 = GGS_string ("var_").add_operation (extractedValue_7362_varName_0.readProperty_string ().getter_identifierRepresentation (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 335)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 335)).add_operation (GGS_string ("_"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 335)).add_operation (extractedValue_7362_varName_0.readProperty_location ().getter_startLocationIndex (inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 336)).getter_string (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 336)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 336)) ;
                GalgasBool test_19 = GalgasBool::boolTrue ;
                if (GalgasBool::boolTrue == test_19) {
                  test_19 = GGS_bool (ComparisonKind::notEqual, extractedValue_7362_varName_0.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
                  if (GalgasBool::boolTrue == test_19) {
                    GalgasBool test_20 = GalgasBool::boolTrue ;
                    if (GalgasBool::boolTrue == test_20) {
                      test_20 = extractedValue_7370_isConstant_1.boolEnum () ;
                      if (GalgasBool::boolTrue == test_20) {
                        {
                        extensionSetter_insertInitializedLocalConstant (ioArgument_ioVariableMap, extractedValue_7362_varName_0, var_castType_7714, var_targetVariableCppName_12696, var_targetVariableCppName_12696, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 339)) ;
                        }
                      }
                    }
                    if (GalgasBool::boolFalse == test_20) {
                      {
                      extensionSetter_insertInitializedLocalVariable (ioArgument_ioVariableMap, extractedValue_7362_varName_0, GGS_bool (true), var_castType_7714, var_targetVariableCppName_12696, var_targetVariableCppName_12696, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 346)) ;
                      }
                    }
                  }
                }
                outArgument_outTestListForGeneration.addAssignOperation (GGS_ifTestForGeneration::class_func_letVarExp (var_targetVariableCppName_12696, var_analyzedExpression_7673, var_castType_7714, var_testType_7763  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 355))  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 355)) ;
              }
            }
            if (GalgasBool::boolFalse == test_11) {
              GenericArray <FixItDescription> fixItArray21 ;
              inCompiler->emitSemanticError (var_analyzedExpression_7673.readProperty_mLocation (), GGS_string ("expression should be a class instance, or a weak reference: it is an @").add_operation (extensionGetter_definition (var_analyzedExpression_7673.readProperty_mResultType (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 364)).readProperty_typeName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 363)).add_operation (GGS_string (" instance"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 364)), fixItArray21  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 362)) ;
            }
          }
        }
      }
...
void extensionMethod_generateInstruction (const GGS_ifTestListForGeneration inObject,
  ...
  outArgument_outTestVar = GGS_string ("test_").add_operation (ioArgument_ioTemporaryVariableIndex.getter_string (SOURCE_FILE ("instruction-comma-separated-expression.galgas", 407)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 407)) ;
  ioArgument_ioTemporaryVariableIndex.plusAssignOperation(GGS_uint (uint32_t (1U)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 408)) ;
  ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("GalgasBool ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 409)).add_operation (GGS_string (" = GalgasBool::boolTrue ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 409)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 409)) ;
  ...
  while (enumerator_15603.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("if (GalgasBool::boolTrue == ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 411)).add_operation (GGS_string (") {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 411)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 411)) ;
    {
    ioArgument_ioGeneratedCode.setter_incIndentation (GGS_uint (uint32_t (2U)), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 412)) ;
    }
    ...
    case GGS_ifTestForGeneration::Enumeration::enum_regular:
      {
        ...
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_15793_exp_0.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_15978, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 415)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(outArgument_outTestVar.add_operation (GGS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 422)).add_operation (var_cppVarName_15978, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 422)).add_operation (GGS_string (".boolEnum () ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 422)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 422)) ;
      }
      break ;
    case GGS_ifTestForGeneration::Enumeration::enum_letVarExp:
      {
        ...
        extensionMethod_addHeaderFileName (extractedValue_16122_targetType_2, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 424)) ;
        extensionMethod_addHeaderFileName (extractedValue_16133_testType_3, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 425)) ;
        GGS_string var_targetTypeName_16267 = extensionGetter_identifierRepresentation (extractedValue_16122_targetType_2, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 426)) ;
        GGS_string var_testTypeName_16332 = extensionGetter_identifierRepresentation (extractedValue_16133_testType_3, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 427)) ;
        GGS_string var_cppVarName_16559 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_16118_exp_1.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_16559, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 428)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("GGS_").add_operation (var_targetTypeName_16267, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 435)).add_operation (GGS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 435)).add_operation (extractedValue_16101_targetVarCppName_0, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 435)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 435)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string (" (dynamic_cast <const cPtr_").add_operation (var_testTypeName_16332, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 436)).add_operation (GGS_string (" *> ("), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 436)).add_operation (var_cppVarName_16559, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 436)).add_operation (GGS_string (".ptr ())) ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 436)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 436)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("if (nullptr == ").add_operation (extractedValue_16101_targetVarCppName_0, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 437)).add_operation (GGS_string (".ptr ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 437)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 437)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("  ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 438)).add_operation (GGS_string (" = GalgasBool::boolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 438)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 438)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("}\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 439)) ;
      }
      break ;
    case GGS_ifTestForGeneration::Enumeration::enum_optionalExp:
      {
        ...
        GGS_string var_targetTypeName_17043 = extensionGetter_identifierRepresentation (extractedValue_17017_targetType_3, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 441)) ;
        GGS_string var_cppVarName_17274 ;
        callExtensionMethod_generateExpression ((cPtr_semanticExpressionForGeneration *) extractedValue_17013_exp_2.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_cppVarName_17274, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 442)) ;
        GalgasBool test_1 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_1) {
          test_1 = extractedValue_17002_isConstant_1.boolEnum () ;
          if (GalgasBool::boolTrue == test_1) {
            ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("const "), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 450)) ;
          }
        }
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("GGS_").add_operation (var_targetTypeName_17043, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 452)).add_operation (GGS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 452)).add_operation (extractedValue_16985_targetVarCppName_0, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 452)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 452)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string (" = ").add_operation (var_cppVarName_17274, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 453)).add_operation (GGS_string (".unwrappedValue () ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 453)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 453)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("if (!").add_operation (var_cppVarName_17274, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 454)).add_operation (GGS_string (".isValuated ()) {\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 454)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 454)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("  ").add_operation (outArgument_outTestVar, inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 455)).add_operation (GGS_string (" = GalgasBool::boolFalse ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 455)), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 455)) ;
        ioArgument_ioGeneratedCode.plusAssignOperation(GGS_string ("}\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-comma-separated-expression.galgas", 456)) ;
      }
      break ;
    }
...
AbstractPtrClass * cPtr_grammarInstructionSyntaxDirectedTranslationResultNone::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_grammarInstructionSyntaxDirectedTranslationDropResult::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
