  ...
  case GGS_xcodeProject::Enumeration::enum_swiftApp:
    {
      ...
      GGS_string var_libpmGroupRef_61428 ;
      {
      extensionSetter_addGroup (var_xcodeProject_28676, GGS_string ("libpm"), GGS_string ("../").add_operation (constinArgument_inBuildDirectoryName, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1381)).add_operation (GGS_string ("/libpm"), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1381)), var_libpmReferenceGroupList_37410, var_libpmGroupRef_61428, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1381)) ;
      }
      {
      extensionSetter_placeGroupAsMainGroup (var_xcodeProject_28676, var_libpmGroupRef_61428, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1382)) ;
      }
      GGS_string var_resourcesGroupRef_61983 ;
      {
      ...
      if (GalgasBool::boolTrue == test_72) {
        ...
        if (GalgasBool::boolTrue == test_72) {
          ...
          var_codeSigningSettingList_63418 = temp_73 ;
        }
      }
      if (GalgasBool::boolFalse == test_72) {
        GGS_stringlist var_components_63563 = var_macCodeSign_19649.readProperty_string ().getter_componentsSeparatedByString (GGS_string (":") COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1436)) ;
        GalgasBool test_74 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_74) {
          test_74 = GGS_bool (ComparisonKind::notEqual, var_components_63563.getter_count (SOURCE_FILE ("galgasTargetGeneration.galgas", 1437)).objectCompare (GGS_uint (uint32_t (2U)))).boolEnum () ;
          if (GalgasBool::boolTrue == test_74) {
            ...
            var_codeSigningSettingList_63418.drop () ; // Release error dropped variable
          }
        }
        if (GalgasBool::boolFalse == test_74) {
          GalgasBool test_76 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_76) {
            test_76 = GGS_bool (ComparisonKind::equal, var_components_63563.getter_mValueAtIndex (GGS_uint (uint32_t (0U)), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1439)).objectCompare (GGS_string ("MacDeveloper"))).boolEnum () ;
            if (GalgasBool::boolTrue == test_76) {
      ...
      GGS_stringlist var_settingList_64442 = temp_81.add_operation (var_codeSigningSettingList_63418, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1456)) ;
      ...
      if (GalgasBool::boolTrue == test_82) {
        ...
        if (GalgasBool::boolTrue == test_82) {
          GGS_string var_s_64805 = GGS_string ("OTHER_LDFLAGS=(") ;
          UpEnumerator_stringlist enumerator_64838 (constinArgument_inHandCodedLinkToolFileList) ;
          while (enumerator_64838.hasCurrentObject ()) {
            var_s_64805.plusAssignOperation(GGS_string ("\"").add_operation (enumerator_64838.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1460)).add_operation (GGS_string ("\""), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1460)), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1460)) ;
            enumerator_64838.gotoNextObject () ;
            if (enumerator_64838.hasCurrentObject ()) {
              var_s_64805.plusAssignOperation(GGS_string (","), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1461)) ;
            }
          }
          var_s_64805.plusAssignOperation(GGS_string (")"), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1463)) ;
          var_settingList_64442.addAssignOperation (var_s_64805  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1464)) ;
        }
      }
      GGS_string var_releaseTargetRef_65315 ;
      GGS_string var_releaseProductFileRef_65358 ;
      {
      extensionSetter_addToolTarget (var_xcodeProject_28676, constinArgument_inTargetName.add_operation (GGS_string (" tool"), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1467)), constinArgument_inTargetName, var_buildCFileRefListForTool_34756.add_operation (var_buildCppFileRefListForTool_34807, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1469)).add_operation (var_mm_5F_FileRefList_34900, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1469)), var_toolFrameworksFileRefList_35840, var_settingList_64442, var_releaseTargetRef_65315, var_releaseProductFileRef_65358, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1466)) ;
      }
      ...
      var_settingList_64442 = temp_83.add_operation (var_codeSigningSettingList_63418, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1482)) ;
      ...
      if (GalgasBool::boolTrue == test_84) {
        ...
        if (GalgasBool::boolTrue == test_84) {
          GGS_string var_s_65814 = GGS_string ("OTHER_LDFLAGS=(") ;
          UpEnumerator_stringlist enumerator_65847 (constinArgument_inHandCodedLinkToolFileList) ;
          while (enumerator_65847.hasCurrentObject ()) {
            var_s_65814.plusAssignOperation(GGS_string ("\"").add_operation (enumerator_65847.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1486)).add_operation (GGS_string ("\""), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1486)), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1486)) ;
            enumerator_65847.gotoNextObject () ;
            if (enumerator_65847.hasCurrentObject ()) {
              var_s_65814.plusAssignOperation(GGS_string (","), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1487)) ;
            }
          }
          var_s_65814.plusAssignOperation(GGS_string (")"), inCompiler  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1489)) ;
          var_settingList_64442.addAssignOperation (var_s_65814  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1490)) ;
        }
      }
      GGS_string var_debugTargetRef_66339 ;
      GGS_string var_debugProductFileRef_66380 ;
      {
      extensionSetter_addToolTarget (var_xcodeProject_28676, constinArgument_inTargetName.add_operation (GGS_string (" tool debug"), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1493)), constinArgument_inTargetName.add_operation (GGS_string ("-debug"), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1494)), var_buildCFileRefListForTool_34756.add_operation (var_buildCppFileRefListForTool_34807, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1495)).add_operation (var_mm_5F_FileRefList_34900, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1495)), var_toolFrameworksFileRefList_35840, var_settingList_64442, var_debugTargetRef_66339, var_debugProductFileRef_66380, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1492)) ;
      }
      ...
      GGS_stringlist var_cocoaConfigurationSettingList_66451 = temp_85.add_operation (var_codeSigningSettingList_63418, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1505)) ;
      {
      GGS_string temp_86 ;
      ...
      temp_92.plusPlusAssignOperation (GGS_stringlist_2E_element::init_21_ (var_releaseTargetRef_65315, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1519)) ;
      temp_92.plusPlusAssignOperation (GGS_stringlist_2E_element::init_21_ (var_debugTargetRef_66339, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1519)) ;
      GGS__32_stringlist temp_93 = GGS__32_stringlist::init (inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1520)) ;
      temp_93.plusPlusAssignOperation (GGS__32_stringlist_2E_element::init_21__21_ (var_releaseProductFileRef_65358, constinArgument_inTargetName, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1520)) ;
      temp_93.plusPlusAssignOperation (GGS__32_stringlist_2E_element::init_21__21_ (var_debugProductFileRef_66380, constinArgument_inTargetName.add_operation (GGS_string ("-debug"), inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1520)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1520)) ;
      GGS_string joker_67473 ; // Joker input parameter
      extensionSetter_addAppTarget (var_xcodeProject_28676, temp_86, temp_88, temp_90, var_frameworksFileRefList_34985.add_operation (var_appFrameworksFileRefList_34043, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1516)), var_resourceFileBuildRefs_35033.add_operation (var_resource_5F_handCodedResourceFileRefForAppList_33273, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1517)), var_cocoaConfigurationSettingList_66451, temp_92, temp_93, joker_67473, inCompiler COMMA_SOURCE_FILE ("galgasTargetGeneration.galgas", 1506)) ;
      }
