...
void extensionMethod_analyzeRoutineArguments (const GGS_actualParameterListAST inObject,
  ...
  if (GalgasBool::boolFalse == test_0) {
    ...
    GGS_stringset var_exclusiveVariableSet_2806 = GGS_stringset::init (inCompiler COMMA_HERE) ;
    const GGS_actualParameterListAST temp_9 = inObject ;
    UpEnumerator_formalParameterSignature enumerator_2861 (constinArgument_inRoutineSignature) ;
    UpEnumerator_actualParameterListAST enumerator_2882 (temp_9) ;
    while (enumerator_2861.hasCurrentObject () && enumerator_2882.hasCurrentObject ()) {
      callExtensionMethod_checkAgainstFormalArgument ((cPtr_actualParameterAST *) enumerator_2882.current_mActualParameter (HERE).ptr (), constinArgument_inUsefulnessCallerEntityName, ioArgument_ioUsefulEntitiesGraph, constinArgument_inAnalysisContext, ioArgument_ioTypeMap, enumerator_2861.current (HERE).readProperty_mFormalSelector (), enumerator_2861.current (HERE).readProperty_mFormalArgumentType (), enumerator_2861.current (HERE).readProperty_mFormalArgumentPassingMode (), ioArgument_ioVariableMap, outArgument_outActualParameterListForGeneration, var_exclusiveVariableSet_2806, ioArgument_ioInstructionListForGeneration, inCompiler COMMA_SOURCE_FILE ("actual-parameters.galgas", 49)) ;
