...
static void routine_programRule_5F__31__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_stringlist enumerator_36451 (var_candidateProjectFiles, kEnumeration_up) ;
      while (enumerator_36451.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").add_operation (enumerator_36451.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.galgas", 860))  COMMA_SOURCE_FILE ("galgas_prgm.galgas", 860)) ;
        enumerator_36451.gotoNextObject () ;
      }
