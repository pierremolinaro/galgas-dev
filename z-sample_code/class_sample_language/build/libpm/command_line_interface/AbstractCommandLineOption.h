...
class AbstractCommandLineOption {
//--- Constructor
  public: AbstractCommandLineOption (const char * inDomainName,
...
//--- Virtual destructor
  public: virtual ~ AbstractCommandLineOption (void) ;

//--- No Copy
  private: AbstractCommandLineOption (const AbstractCommandLineOption &) = delete ;
  private: AbstractCommandLineOption & operator = (const AbstractCommandLineOption &) = delete ;
