...
//--------------------------------- Properties
  public: GGS_declarationAST mProperty_mDeclaration ;
  public: inline GGS_declarationAST readProperty_mDeclaration (void) const {
...
//--------------------------------- Property setters
  public: inline void setter_setMDeclaration (const GGS_declarationAST & inValue COMMA_UNUSED_LOCATION_ARGS) {
...
//--------------------------------- Native constructor
  public: GGS_declarationListAST_2E_element (const GGS_declarationAST & in_mDeclaration) ;
...
//--------------------------------- Initializers
  public: static GGS_declarationListAST_2E_element init_21_ (const class GGS_declarationAST & inOperand0,
                                                             Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS class functions
  public: static class GGS_declarationListAST_2E_element class_func_new (const class GGS_declarationAST & inOperand0,
