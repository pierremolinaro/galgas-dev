...
struct SettingViewFor_LR1_grammar_lexique : View {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  @AppStorage("FontFor_LR1_grammar_lexique")
  private var mFont = CustomFont (nsFont: NSFont.monospacedSystemFont (ofSize: 13.0, weight: .regular))

  @AppStorage("LineHeightFor_LR1_grammar_lexique")
  private var mLineHeight : Int = 12

  @AppStorage("ColorFor_LR1_grammar_lexique")
  private var mDefaultColor : Color = .black


  @AppStorage("ColorFor_LR1_grammar_lexique_lexical_error")
  private var mColorFor_lexical_error : Color = .red

  @AppStorage("BoldFor_LR1_grammar_lexique_lexical_error")
  private var mBoldFor_lexical_error : Bool = false

  @AppStorage("ItalicFor_LR1_grammar_lexique_lexical_error")
  private var mItalicFor_lexical_error : Bool = false

  @AppStorage("ColorFor_LR1_grammar_lexique_template")
  private var mColorFor_template : Color = .gray

  @AppStorage("BoldFor_LR1_grammar_lexique_template")
  private var mBoldFor_template : Bool = false

  @AppStorage("ItalicFor_LR1_grammar_lexique_template")
...
class ScannerFor_LR1_grammar_lexique : AbstractScanner {
  ...
  final override func popUpDefinitionList () -> [[UInt16]] {
    return gPopUpData_LR1_grammar_lexique
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override func blockComment () -> String? {
    return gBlockComment_LR1_grammar_lexique
  }
  ...
  func lexiqueIdentifier () -> String {
    return LR1_grammar_lexique_lexiqueIdentifier ()
  }
  ...
  func styleIndexFor (token inTokenIndex : UInt16) -> UInt8 {
    let kTerminalSymbolStyles : [UInt8] = [
      0, // Default
      0, // 1 : LR1_grammar_lexique_1_c
      0, // 2 : LR1_grammar_lexique_1_d
      1, // 3 : LR1_grammar_lexique_2_ERROR
      2  // 4 : LR1_grammar_lexique_2_TEMPLATE
    ]
  ...
  func atomicSelectionFor (token inTokenIndex : UInt16) -> Bool {
    let kTerminalAtomicSelection : [Bool] = [
      false, // Default
      true, // 1 : LR1_grammar_lexique_1_c
      true, // 2 : LR1_grammar_lexique_1_d
      false, // 3 : LR1_grammar_lexique_2_ERROR
      false  // 4 : LR1_grammar_lexique_2_TEMPLATE
    ]
  ...
  func styleNameFor (styleIndex inIndex : UInt8) -> String {
    return LR1_grammar_lexique_styleNameFor (styleIndex: inIndex)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  func styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
    return LR1_grammar_lexique_styleIdentifierFor (styleIndex: inIndex)
  }
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  func updateTokenStyleArrays (_ ioStyleDidChange : inout Bool) {
    ...
    if let s = ud.string (forKey: "FontFor_LR1_grammar_lexique"), let v = CustomFont (rawValue: s) {
      if self.mFont != v {
        self.mFont = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "LineHeightFor_LR1_grammar_lexique"), let v = Int (s) {
      if self.mLineHeight != v {
        self.mLineHeight = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LR1_grammar_lexique"), let v = Color (rawValue: s) {
      if self.mDefaultColor != v {
        self.mDefaultColor = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LR1_grammar_lexique_lexical_error"), let v = Color (rawValue: s) {
      if self.mColorFor_lexical_error != v {
        self.mColorFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_LR1_grammar_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "BoldFor_LR1_grammar_lexique_lexical_error")
      if self.mBoldFor_lexical_error != v {
        self.mBoldFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_LR1_grammar_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "ItalicFor_LR1_grammar_lexique_lexical_error")
      if self.mItalicFor_lexical_error != v {
        self.mItalicFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LR1_grammar_lexique_template"), let v = Color (rawValue: s) {
      if self.mColorFor_template != v {
        self.mColorFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_LR1_grammar_lexique_template") != nil {
      let v = ud.bool (forKey: "BoldFor_LR1_grammar_lexique_template")
      if self.mBoldFor_template != v {
        self.mBoldFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_LR1_grammar_lexique_template") != nil {
      let v = ud.bool (forKey: "ItalicFor_LR1_grammar_lexique_template")
  ...
  func parseLexicalTokenForLexicalColoring () -> LexicalToken {
    ...
    if scanningOk && (self.testForInputChar (99)) {
      tokenCode = LR1_grammar_lexique_1_c
    }else if scanningOk && (self.testForInputChar (100)) {
      tokenCode = LR1_grammar_lexique_1_d
    }else if scanningOk && (self.testForInputFromChar (1, toChar:32)) {
    }else if self.testForInputChar (0) { // End of source text ?
      tokenCode = LR1_grammar_lexique_1_ ; // Empty string code
    }else{ // Unknown input character
      tokenCode = LR1_grammar_lexique_2_TEMPLATE
      self.advance ()
    }
    return LexicalToken (
...
func LR1_grammar_lexique_lexiqueIdentifier () -> String {
  return "LR1_grammar_lexique"
}

//--------------------------------------------------------------------------------------------------

func LR1_grammar_lexique_styleNameFor (styleIndex inIndex : UInt8) -> String {
...
func LR1_grammar_lexique_styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
  let kStyleArray : [String] = [
    "LR1_grammar_lexique", // 0
    "LR1_grammar_lexique.ERROR", // 1
    "LR1_grammar_lexique.TEMPLATE" // 2
  ]
  return kStyleArray [Int (inIndex)]
}
...
let LR1_grammar_lexique_1_ : UInt16 = 0
let LR1_grammar_lexique_1_c : UInt16 = 1
let LR1_grammar_lexique_1_d : UInt16 = 2
let LR1_grammar_lexique_2_ERROR : UInt16 = 3
let LR1_grammar_lexique_2_TEMPLATE : UInt16 = 4
