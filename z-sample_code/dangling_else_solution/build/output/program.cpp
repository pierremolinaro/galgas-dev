...
static const char * kSourceFileHelpMessages [] = {
  "an '.dangling_else_solution' source file",
  nullptr
} ;    
...
static void routine_programRule_5F__30_ (const GGS_lstring constinArgument_inSourceFile,
                                         Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  cGrammar_dangling_5F_else_5F_solution_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile  COMMA_SOURCE_FILE ("dangling_else_solution_program.galgas", 10)) ;
}
      ...
      for (int32_t i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension == "dangling_else_solution") {
          ...
          case kExecutionModeLexicalAnalysisOnly :
            cGrammar_dangling_5F_else_5F_solution_5F_grammar::performOnlyLexicalAnalysis (commonCompiler, sourceFilesArray (i COMMA_HERE)) ;
            break ;
          case kExecutionModeSyntaxAnalysisOnly :
            cGrammar_dangling_5F_else_5F_solution_5F_grammar::performOnlySyntaxAnalysis (commonCompiler, sourceFilesArray (i COMMA_HERE)) ;
            break ;
          case kExecutionModeIndexing :
            cGrammar_dangling_5F_else_5F_solution_5F_grammar::performIndexing (commonCompiler, sourceFilesArray (i COMMA_HERE)) ;
            break ;
