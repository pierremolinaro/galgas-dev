...
struct SettingViewFor_dangling_else_solution_lexique : View {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  @AppStorage("FontFor_dangling_else_solution_lexique")
  private var mFont = CustomFont (nsFont: NSFont.monospacedSystemFont (ofSize: 13.0, weight: .regular))

  @AppStorage("LineHeightFor_dangling_else_solution_lexique")
  private var mLineHeight : Int = 12

  @AppStorage("ColorFor_dangling_else_solution_lexique")
  private var mDefaultColor : Color = .black


  @AppStorage("ColorFor_dangling_else_solution_lexique_lexical_error")
  private var mColorFor_lexical_error : Color = .red

  @AppStorage("BoldFor_dangling_else_solution_lexique_lexical_error")
  private var mBoldFor_lexical_error : Bool = false

  @AppStorage("ItalicFor_dangling_else_solution_lexique_lexical_error")
  private var mItalicFor_lexical_error : Bool = false

  @AppStorage("ColorFor_dangling_else_solution_lexique_template")
  private var mColorFor_template : Color = .gray

  @AppStorage("BoldFor_dangling_else_solution_lexique_template")
  private var mBoldFor_template : Bool = false

  @AppStorage("ItalicFor_dangling_else_solution_lexique_template")
...
class ScannerFor_dangling_else_solution_lexique : AbstractScanner {
  ...
  final override func popUpDefinitionList () -> [[UInt16]] {
    return gPopUpData_dangling_else_solution_lexique
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override func blockComment () -> String? {
    return gBlockComment_dangling_else_solution_lexique
  }
  ...
  func lexiqueIdentifier () -> String {
    return dangling_else_solution_lexique_lexiqueIdentifier ()
  }
  ...
  func styleIndexFor (token inTokenIndex : UInt16) -> UInt8 {
    let kTerminalSymbolStyles : [UInt8] = [
      0, // Default
      0, // 1 : dangling_else_solution_lexique_1_id
      0, // 2 : dangling_else_solution_lexique_1_I
      0, // 3 : dangling_else_solution_lexique_1_E
      0, // 4 : dangling_else_solution_lexique_1_O
      0, // 5 : dangling_else_solution_lexique_1__2B_
      0, // 6 : dangling_else_solution_lexique_1__2A_
      0, // 7 : dangling_else_solution_lexique_1__28_
      0, // 8 : dangling_else_solution_lexique_1__29_
      1, // 9 : dangling_else_solution_lexique_2_ERROR
      2  // 10 : dangling_else_solution_lexique_2_TEMPLATE
    ]
  ...
  func atomicSelectionFor (token inTokenIndex : UInt16) -> Bool {
    let kTerminalAtomicSelection : [Bool] = [
      false, // Default
      true, // 1 : dangling_else_solution_lexique_1_id
      true, // 2 : dangling_else_solution_lexique_1_I
      true, // 3 : dangling_else_solution_lexique_1_E
      true, // 4 : dangling_else_solution_lexique_1_O
      true, // 5 : dangling_else_solution_lexique_1__2B_
      true, // 6 : dangling_else_solution_lexique_1__2A_
      true, // 7 : dangling_else_solution_lexique_1__28_
      true, // 8 : dangling_else_solution_lexique_1__29_
      false, // 9 : dangling_else_solution_lexique_2_ERROR
      false  // 10 : dangling_else_solution_lexique_2_TEMPLATE
    ]
  ...
  func styleNameFor (styleIndex inIndex : UInt8) -> String {
    return dangling_else_solution_lexique_styleNameFor (styleIndex: inIndex)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  func styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
    return dangling_else_solution_lexique_styleIdentifierFor (styleIndex: inIndex)
  }
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  func updateTokenStyleArrays (_ ioStyleDidChange : inout Bool) {
    ...
    if let s = ud.string (forKey: "FontFor_dangling_else_solution_lexique"), let v = CustomFont (rawValue: s) {
      if self.mFont != v {
        self.mFont = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "LineHeightFor_dangling_else_solution_lexique"), let v = Int (s) {
      if self.mLineHeight != v {
        self.mLineHeight = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_dangling_else_solution_lexique"), let v = Color (rawValue: s) {
      if self.mDefaultColor != v {
        self.mDefaultColor = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_dangling_else_solution_lexique_lexical_error"), let v = Color (rawValue: s) {
      if self.mColorFor_lexical_error != v {
        self.mColorFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_dangling_else_solution_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "BoldFor_dangling_else_solution_lexique_lexical_error")
      if self.mBoldFor_lexical_error != v {
        self.mBoldFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_dangling_else_solution_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "ItalicFor_dangling_else_solution_lexique_lexical_error")
      if self.mItalicFor_lexical_error != v {
        self.mItalicFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_dangling_else_solution_lexique_template"), let v = Color (rawValue: s) {
      if self.mColorFor_template != v {
        self.mColorFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_dangling_else_solution_lexique_template") != nil {
      let v = ud.bool (forKey: "BoldFor_dangling_else_solution_lexique_template")
      if self.mBoldFor_template != v {
        self.mBoldFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_dangling_else_solution_lexique_template") != nil {
      let v = ud.bool (forKey: "ItalicFor_dangling_else_solution_lexique_template")
  ...
  func parseLexicalTokenForLexicalColoring () -> LexicalToken {
    ...
    if scanningOk && self.testForInputString ("O", advance: true) {
      tokenCode = dangling_else_solution_lexique_1_O
    }else if scanningOk && self.testForInputString ("I", advance: true) {
      tokenCode = dangling_else_solution_lexique_1_I
    }else if scanningOk && self.testForInputString ("E", advance: true) {
      tokenCode = dangling_else_solution_lexique_1_E
      ...
      if (tokenCode == 0) {
        tokenCode = search_into_dangling_5F_else_5F_solution_5F_lexique_keyWordList (mLexicalAttribute_identifierString) ;
      }
      if tokenCode == 0 {
        tokenCode = dangling_else_solution_lexique_1_id ;
      }
    }else if scanningOk && self.testForInputString ("+", advance: true) {
      tokenCode = dangling_else_solution_lexique_1__2B_
    }else if scanningOk && self.testForInputString ("*", advance: true) {
      tokenCode = dangling_else_solution_lexique_1__2A_
    }else if scanningOk && self.testForInputString (")", advance: true) {
      tokenCode = dangling_else_solution_lexique_1__29_
    }else if scanningOk && self.testForInputString ("(", advance: true) {
      tokenCode = dangling_else_solution_lexique_1__28_
    }else if scanningOk && (self.testForInputFromChar (1, toChar:32)) {
    }else if self.testForInputChar (0) { // End of source text ?
      tokenCode = dangling_else_solution_lexique_1_ ; // Empty string code
    }else{ // Unknown input character
      tokenCode = dangling_else_solution_lexique_2_TEMPLATE
      self.advance ()
    }
    return LexicalToken (
...
fileprivate let kDictionary_dangling_5F_else_5F_solution_5F_lexique_keyWordList : [String : UInt16] = [
  "E" : dangling_else_solution_lexique_1_E,
  "I" : dangling_else_solution_lexique_1_I,
  "O" : dangling_else_solution_lexique_1_O
]

fileprivate func search_into_dangling_5F_else_5F_solution_5F_lexique_keyWordList (_ inSearchedString : String) -> UInt16 {
  return kDictionary_dangling_5F_else_5F_solution_5F_lexique_keyWordList [inSearchedString, default: dangling_else_solution_lexique_1_]
}
...
func dangling_else_solution_lexique_lexiqueIdentifier () -> String {
  return "dangling_else_solution_lexique"
}

//--------------------------------------------------------------------------------------------------

func dangling_else_solution_lexique_styleNameFor (styleIndex inIndex : UInt8) -> String {
...
func dangling_else_solution_lexique_styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
  let kStyleArray : [String] = [
    "dangling_else_solution_lexique", // 0
    "dangling_else_solution_lexique.ERROR", // 1
    "dangling_else_solution_lexique.TEMPLATE" // 2
  ]
  return kStyleArray [Int (inIndex)]
}
...
let dangling_else_solution_lexique_1_ : UInt16 = 0
let dangling_else_solution_lexique_1_id : UInt16 = 1
let dangling_else_solution_lexique_1_I : UInt16 = 2
let dangling_else_solution_lexique_1_E : UInt16 = 3
let dangling_else_solution_lexique_1_O : UInt16 = 4
let dangling_else_solution_lexique_1__2B_ : UInt16 = 5
let dangling_else_solution_lexique_1__2A_ : UInt16 = 6
let dangling_else_solution_lexique_1__28_ : UInt16 = 7
let dangling_else_solution_lexique_1__29_ : UInt16 = 8
let dangling_else_solution_lexique_2_ERROR : UInt16 = 9
let dangling_else_solution_lexique_2_TEMPLATE : UInt16 = 10
