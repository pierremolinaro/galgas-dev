...
#----------------- Assignment language
# $DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/assignment_language/+asl.galgas4project &&
...
#----------------- LOGO
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/logo/+logo.galgas4project &&
...
#----------------- LBB
# $DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/lbb/+lbb.galgas4project &&
# /usr/bin/python3 ${DIR}/lbb/makefile-unix/build.py &&
#----------------- class_sample_language
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/class_sample_language/+class_sample_language.galgas4project &&
...
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/dangling_else_solution/+dangling_else_solution.galgas4project &&
/usr/bin/python3 ${DIR}/dangling_else_solution/makefile-unix/build.py &&
#----------------- SLR_expression
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/SLR_expression/+SLR_expression.galgas4project &&
/usr/bin/python3 ${DIR}/SLR_expression/makefile-unix/build.py &&
#----------------- LL1_expression
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/LL1_expression/+LL1_expression.galgas4project &&
/usr/bin/python3 ${DIR}/LL1_expression/makefile-unix/build.py &&
#----------------- LR1_grammar
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/LR1_grammar/+LR1_grammar.galgas4project &&
/usr/bin/python3 ${DIR}/LR1_grammar/makefile-unix/build.py &&
#----------------- XML Parsing
$DIR/../makefile-unix/galgas --generate-many-cpp-files --Werror ${DIR}/xml_parsing/+xml_parsing.galgas4project &&
