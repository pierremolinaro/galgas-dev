...
static const char * kSourceFileHelpMessages [] = {
  "an XML text file with the .XMLParsing extension",
  nullptr
} ;    
...
static void routine_before (Compiler * inCompiler
                            COMMA_UNUSED_LOCATION_ARGS) {
  {
    ...
    if (GalgasBool::boolTrue == test_0) {
      test_0 = GGS_bool (gOption_xml_5F_parsing_5F_options_dumpUnicode.readProperty_value ()).boolEnum () ;
      if (GalgasBool::boolTrue == test_0) {
        {
        routine_listUnicodeCharacterProperties (inCompiler  COMMA_SOURCE_FILE ("xml_parsing_program.galgas", 7)) ;
        }
      }
    }
  }
...
static void routine_programRule_5F__30_ (const GGS_lstring constinArgument_inSourceFile,
                                         Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GGS_xmlNodeList var_rootNodes_320 ;
  var_rootNodes_320.drop () ;
  cGrammar_xml_5F_parsing_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_rootNodes_320, GGS_bool (true), GGS_bool (false), GGS_bool (true)  COMMA_SOURCE_FILE ("xml_parsing_program.galgas", 15)) ;
  var_rootNodes_320.log ("rootNodes"  COMMA_SOURCE_FILE ("xml_parsing_program.galgas", 21)) ;
  {
  routine_logXMLNodes_3F_ (var_rootNodes_320, inCompiler  COMMA_SOURCE_FILE ("xml_parsing_program.galgas", 22)) ;
  }
}
