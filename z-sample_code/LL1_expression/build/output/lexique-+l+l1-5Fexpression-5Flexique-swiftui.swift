...
struct SettingViewFor_LL1_expression_lexique : View {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  @AppStorage("FontFor_LL1_expression_lexique")
  private var mFont = CustomFont (nsFont: NSFont.monospacedSystemFont (ofSize: 13.0, weight: .regular))

  @AppStorage("LineHeightFor_LL1_expression_lexique")
  private var mLineHeight : Int = 12

  @AppStorage("ColorFor_LL1_expression_lexique")
  private var mDefaultColor : Color = .black


  @AppStorage("ColorFor_LL1_expression_lexique_lexical_error")
  private var mColorFor_lexical_error : Color = .red

  @AppStorage("BoldFor_LL1_expression_lexique_lexical_error")
  private var mBoldFor_lexical_error : Bool = false

  @AppStorage("ItalicFor_LL1_expression_lexique_lexical_error")
  private var mItalicFor_lexical_error : Bool = false

  @AppStorage("ColorFor_LL1_expression_lexique_template")
  private var mColorFor_template : Color = .gray

  @AppStorage("BoldFor_LL1_expression_lexique_template")
  private var mBoldFor_template : Bool = false

  @AppStorage("ItalicFor_LL1_expression_lexique_template")
...
class ScannerFor_LL1_expression_lexique : AbstractScanner {
  ...
  final override func popUpDefinitionList () -> [[UInt16]] {
    return gPopUpData_LL1_expression_lexique
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  final override func blockComment () -> String? {
    return gBlockComment_LL1_expression_lexique
  }
  ...
  private var mLexicalAttribute_number : UInt32 = 0

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  func lexiqueIdentifier () -> String {
    return LL1_expression_lexique_lexiqueIdentifier ()
  }
  ...
  func styleIndexFor (token inTokenIndex : UInt16) -> UInt8 {
    let kTerminalSymbolStyles : [UInt8] = [
      0, // Default
      0, // 1 : LL1_expression_lexique_1_number
      0, // 2 : LL1_expression_lexique_1__2B_
      0, // 3 : LL1_expression_lexique_1__2A_
      0, // 4 : LL1_expression_lexique_1__29_
      0, // 5 : LL1_expression_lexique_1__28_
      1, // 6 : LL1_expression_lexique_2_ERROR
      2  // 7 : LL1_expression_lexique_2_TEMPLATE
    ]
  ...
  func atomicSelectionFor (token inTokenIndex : UInt16) -> Bool {
    let kTerminalAtomicSelection : [Bool] = [
      false, // Default
      true, // 1 : LL1_expression_lexique_1_number
      true, // 2 : LL1_expression_lexique_1__2B_
      true, // 3 : LL1_expression_lexique_1__2A_
      true, // 4 : LL1_expression_lexique_1__29_
      true, // 5 : LL1_expression_lexique_1__28_
      false, // 6 : LL1_expression_lexique_2_ERROR
      false  // 7 : LL1_expression_lexique_2_TEMPLATE
    ]
  ...
  func styleNameFor (styleIndex inIndex : UInt8) -> String {
    return LL1_expression_lexique_styleNameFor (styleIndex: inIndex)
  }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  func styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
    return LL1_expression_lexique_styleIdentifierFor (styleIndex: inIndex)
  }
 ...
 // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  func updateTokenStyleArrays (_ ioStyleDidChange : inout Bool) {
    ...
    if let s = ud.string (forKey: "FontFor_LL1_expression_lexique"), let v = CustomFont (rawValue: s) {
      if self.mFont != v {
        self.mFont = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "LineHeightFor_LL1_expression_lexique"), let v = Int (s) {
      if self.mLineHeight != v {
        self.mLineHeight = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LL1_expression_lexique"), let v = Color (rawValue: s) {
      if self.mDefaultColor != v {
        self.mDefaultColor = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LL1_expression_lexique_lexical_error"), let v = Color (rawValue: s) {
      if self.mColorFor_lexical_error != v {
        self.mColorFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_LL1_expression_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "BoldFor_LL1_expression_lexique_lexical_error")
      if self.mBoldFor_lexical_error != v {
        self.mBoldFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_LL1_expression_lexique_lexical_error") != nil {
      let v = ud.bool (forKey: "ItalicFor_LL1_expression_lexique_lexical_error")
      if self.mItalicFor_lexical_error != v {
        self.mItalicFor_lexical_error = v
        ioStyleDidChange = true
      }
    }
    if let s = ud.string (forKey: "ColorFor_LL1_expression_lexique_template"), let v = Color (rawValue: s) {
      if self.mColorFor_template != v {
        self.mColorFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "BoldFor_LL1_expression_lexique_template") != nil {
      let v = ud.bool (forKey: "BoldFor_LL1_expression_lexique_template")
      if self.mBoldFor_template != v {
        self.mBoldFor_template = v
        ioStyleDidChange = true
      }
    }
    if ud.string (forKey: "ItalicFor_LL1_expression_lexique_template") != nil {
      let v = ud.bool (forKey: "ItalicFor_LL1_expression_lexique_template")
  ...
  func parseLexicalTokenForLexicalColoring () -> LexicalToken {
    var loop = true
    var scanningOk = true
    self.mLexicalAttribute_number = 0
    var tokenCode : UInt16 = 0
    let startLocation = self.currentLocation
    if scanningOk && self.testForInputString ("+", advance: true) {
      tokenCode = LL1_expression_lexique_1__2B_
    }else if scanningOk && self.testForInputString ("*", advance: true) {
      tokenCode = LL1_expression_lexique_1__2A_
    }else if scanningOk && self.testForInputString (")", advance: true) {
      tokenCode = LL1_expression_lexique_1__29_
    }else if scanningOk && self.testForInputString ("(", advance: true) {
      tokenCode = LL1_expression_lexique_1__28_
    }else if scanningOk && (self.testForInputFromChar (48, toChar:57)) {
      scanner_cocoa_routine_enterDigitIntoUInt (&scanningOk, self.previousChar, &self.mLexicalAttribute_number)
      ...
      loop = true
      tokenCode = LL1_expression_lexique_1_number
    }else if self.testForInputChar (0) { // End of source text ?
      tokenCode = LL1_expression_lexique_1_ ; // Empty string code
    }else{ // Unknown input character
      tokenCode = LL1_expression_lexique_2_TEMPLATE
      self.advance ()
    }
    return LexicalToken (
...
func LL1_expression_lexique_lexiqueIdentifier () -> String {
  return "LL1_expression_lexique"
}

//--------------------------------------------------------------------------------------------------

func LL1_expression_lexique_styleNameFor (styleIndex inIndex : UInt8) -> String {
...
func LL1_expression_lexique_styleIdentifierFor (styleIndex inIndex : UInt8) -> String {
  let kStyleArray : [String] = [
    "LL1_expression_lexique", // 0
    "LL1_expression_lexique.ERROR", // 1
    "LL1_expression_lexique.TEMPLATE" // 2
  ]
  return kStyleArray [Int (inIndex)]
}
...
let LL1_expression_lexique_1_ : UInt16 = 0
let LL1_expression_lexique_1_number : UInt16 = 1
let LL1_expression_lexique_1__2B_ : UInt16 = 2
let LL1_expression_lexique_1__2A_ : UInt16 = 3
let LL1_expression_lexique_1__29_ : UInt16 = 4
let LL1_expression_lexique_1__28_ : UInt16 = 5
let LL1_expression_lexique_2_ERROR : UInt16 = 6
let LL1_expression_lexique_2_TEMPLATE : UInt16 = 7
