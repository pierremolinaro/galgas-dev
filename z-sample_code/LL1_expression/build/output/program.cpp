...
static void routine_programRule_5F__30_ (const GGS_lstring constinArgument_inSourceFile,
                                         Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  String syntaxDirectedTranslationResult_131 ;
  cGrammar_LL_31__5F_expression_5F_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_131, constinArgument_inSourceFile  COMMA_SOURCE_FILE ("LL1_expression_program.galgas", 9)) ;
  const GGS_string var_s_189 (syntaxDirectedTranslationResult_131) ;
  var_s_189.log ("s"  COMMA_SOURCE_FILE ("LL1_expression_program.galgas", 10)) ;
}
