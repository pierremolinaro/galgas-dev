...
public final class MultipleBooleanBindingController : EBObservablePropertyController {
  ...
  init (_ inExpression : EBMultipleBindingBooleanExpression, _ inAction : @escaping () -> Void) {
...
public enum MultipleBindingBooleanOperation {
  case or
  case and
  case xor
}
...
public enum MultipleBindingIntegerOperation {
  case eq
  case ne
  case lt
  case le
...
@MainActor public indirect enum EBMultipleBindingBooleanExpression {
...
@MainActor public enum EBMultipleBindingIntegerExpression {
