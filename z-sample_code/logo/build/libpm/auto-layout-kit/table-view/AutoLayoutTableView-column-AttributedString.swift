...
public extension AutoLayoutTableView {

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  func addColumn_AttributedString (
    valueGetterDelegate inGetterDelegate : @escaping (_ inRow : Int) -> NSAttributedString?,
    valueSetterDelegate inSetterDelegate : ((_ inRow : Int, _ inNewValue : NSAttributedString) -> Void)? = nil,
