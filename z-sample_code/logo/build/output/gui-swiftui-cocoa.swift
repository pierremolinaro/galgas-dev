...
extension UTType {
  nonisolated static let logo = UTType (exportedAs: Bundle.main.bundleIdentifier! + ".logo")
}

//--------------------------------------------------------------------------------------------------

extension ProjectDocument {
  static let readableContentTypes : [UTType] = [.logo]
}
...
let projectFileExtensions = Set (["logo"])
...
@MainActor func scannerFor (extension inExtension : String) -> AbstractScanner? {
  ...
  if fileExtension == "logo" {
    result = ScannerFor_logo_lexique ()
  }
  return result
}
  ...
  @ViewBuilder var body : some View {
    NavigationSplitView {
      List(selection: self.$mSelection) {
        ...
        Text ("Source").tag (SidebarItem.logo_lexique_0)
      }
      .toolbar (removing: .sidebarToggle)
    } detail: {
      switch self.mSelection {
        case .commandLineOptions : OptionView ()
        case .logo_lexique_0 : SettingViewFor_logo_lexique ()
      }
    }
  }
...
//--------------------------------------------------------------------------------------------------
//   Popup list data for 'logo_lexique' lexique
//--------------------------------------------------------------------------------------------------

let gPopUpData_logo_lexique : [[UInt16]] = [

]

//--------------------------------------------------------------------------------------------------
//   Block Comment for 'logo_lexique' lexique
//--------------------------------------------------------------------------------------------------

let gBlockComment_logo_lexique : String? = "#"
