#ifndef class_2D_pen_2B_down_DEFINED
#define class_2D_pen_2B_down_DEFINED

//----------------------------------------------------------------------------------------------------------------------

#include "class-pen+down-1.h"

//----------------------------------------------------------------------------------------------------------------------

//--------------------------------------------------------------------------------------------------
// Phase 2: pointer class for @penDown class
//--------------------------------------------------------------------------------------------------
...
//--------------------------------- Initializers
  public: void penDown_init (Compiler * inCompiler) ;
...
//--- Constructor
  public: cPtr_penDown (Compiler * inCompiler
                        COMMA_LOCATION_ARGS) ;
