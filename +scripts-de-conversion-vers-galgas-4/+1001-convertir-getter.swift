...
class CorrigerAccoladeOuvrante : Correcteur {
...
class CorrigerIdfAuLieuDePoint : Correcteur {
...
//----------------------------------------------------------------------------------------
  ...
  func traduire (projetGALGAS inCheminFichierGALGAS : String) -> (Bool, Int) {
    let correcteurs : [Correcteur] = [CorrigerAccoladeOuvrante (), CorrigerIdfAuLieuDePoint ()]
