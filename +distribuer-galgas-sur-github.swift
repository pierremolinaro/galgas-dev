...
let CHANGES : [String] = [
  ...
  "Adaptation du makefile Unix pour Cygwin"
]
let NEWS : [String] = [
]
...
//-------------------- Vérifier les programmes d'exemple
  runCommand (DISTRIBUTION_DIR + "/galgas-dev-master/sample_code/+build-all-unix.command", [])
...
//-------------------- Créer l'archive de l'executable osx (release et debug)
  fm.changeCurrentDirectoryPath (DISTRIBUTION_DIR + "/galgas-dev-master/makefile-unix")
  runCommand ("/usr/bin/python3", ["build.py"])
  runCommand ("/usr/bin/bzip2", ["-9", "galgas"])
  runCommand ("/usr/bin/bzip2", ["-9", "galgas-debug"])
  fm.changeCurrentDirectoryPath (DISTRIBUTION_DIR)
  runCommand ("/bin/mv", [DISTRIBUTION_DIR + "/galgas-dev-master/makefile-unix/galgas.bz2", cliToolsDir + "/galgas.osx.bz2"])
  runCommand ("/bin/mv", [DISTRIBUTION_DIR + "/galgas-dev-master/makefile-unix/galgas-debug.bz2", cliToolsDir + "/galgas-debug.osx.bz2"])
  runCommand ("/bin/rm", ["-fr", "galgas-dev-master/makefile-unix"])
