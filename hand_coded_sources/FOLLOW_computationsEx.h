...
#ifndef FOLLOW_COMPUTATIONS_ROUTINES_EX_DEFINED
#define FOLLOW_COMPUTATIONS_ROUTINES_EX_DEFINED
...
void
FOLLOW_computations (const cPureBNFproductionsListEx & inPureBNFproductions,
