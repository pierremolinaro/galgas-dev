...
#include "useful_symbols_computationsEx.h"
...
static void
computeUsefulSymbols (const cPureBNFproductionsListEx & inPureBNFproductions,
...
//--- Traverse all productions for getting direct accessibility
  ...
  for (PMSInt32 i=0 ; i<inPureBNFproductions.length () ; i++) {
    const cProductionEx & p = inPureBNFproductions (i COMMA_HERE) ;
