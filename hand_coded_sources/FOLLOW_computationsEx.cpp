...
#include "FOLLOW_computationsEx.h"
...
static void
computeFOLLOWsets (const cPureBNFproductionsListEx & inProductionRules,
...
//--- Build the directFollower and lastOfProduction sets
  for (PMSInt32 ip=0 ; ip<inProductionRules.length () ; ip++) {
    const cProductionEx & p = inProductionRules (ip COMMA_HERE) ;
