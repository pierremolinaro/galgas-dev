...
cVocabularyEx::cVocabularyEx (void) :
mStringsArray (),
...
PMSInt32 cVocabularyEx::getEmptyStringTerminalSymbolIndex (void) const {
  return mTerminalSymbolsCount - 1 ;
}

//---------------------------------------------------------------------------*

C_String cVocabularyEx::getSymbol (const PMSInt32 inSymbolIndex
...
PMSInt32 cVocabularyEx::getStartSymbol (void) const {
  return mStartSymbol ;
}

//---------------------------------------------------------------------------*

PMSInt32 cVocabularyEx::getTerminalSymbolsCount (void) const {
  return mTerminalSymbolsCount ;
}

//---------------------------------------------------------------------------*

PMSInt32 cVocabularyEx::getAllSymbolsCount (void) const {
  return mStringsArray.count () ;
}

//---------------------------------------------------------------------------*

PMSInt32 cVocabularyEx::getNonTerminalSymbolsCount (void) const {
  return mStringsArray.count () - mTerminalSymbolsCount ;
}

//---------------------------------------------------------------------------*

void cVocabularyEx::addNonTerminalSymbol (const char * inPrefix,
...
void cVocabularyEx::addAugmentedSymbol (void) {
...
bool cVocabularyEx::needToGenerateChoice (const PMSInt32 inSymbolIndex
                                        COMMA_LOCATION_ARGS) const {
...
void cVocabularyEx::printInFile (AC_OutputStream & inHTMLfile,
