...
static bool
createTreewalkingFile (const C_String & inCreatedProjectPathName) {
  const C_String projectName = inCreatedProjectPathName.lastPathComponent () ;
  const C_String fileName = inCreatedProjectPathName + "/galgas_sources/" + projectName + "_treewalking.ggs" ;
  C_TextFileWrite f (fileName COMMA_GALGAS_CREATOR COMMA_HERE) ; 
...
createCompileAllFile (const C_String & inCreatedProjectPathName,
  ...
  if (inProjectStyle == kMDAproject) {
    f << "compile \"" << projectName << "_metamodel.ggs\" ;\n"
         "compile \"" << projectName << "_treewalking.ggs\" ;\n" ;
  }
...
createCommonMakefileFile (const C_String & inCreatedProjectPathName,
  ...
  if (inProjectStyle == kMDAproject) {
    f << "SOURCES += " << projectName << "_metamodel.cpp\n"
         "SOURCES += " << projectName << "_treewalking.cpp\n" ;
  }
...
createCodeBlockProjectFile (const C_String & inCreatedProjectPathName,
  ...
  if (inProjectStyle == kMDAproject) {
    f << "        <Unit filename=\"..\\galgas_sources\\GALGAS_OUTPUT\\" << projectName << "_metamodel.cpp\">\n"
         ...
         "            <Option target=\"" << debugTarget << "\"/>\n"
         "        </Unit>\n"
         "        <Unit filename=\"..\\galgas_sources\\GALGAS_OUTPUT\\" << projectName << "_treewalking.cpp\">\n"
         "            <Option compilerVar=\"CC\"/>\n"
         "            <Option target=\"" << releaseTarget << "\"/>\n"
         "            <Option target=\"" << debugTarget << "\"/>\n"
         "        </Unit>\n" ;
  ...
  f << "        <Unit filename=\"..\\galgas_sources\\GALGAS_OUTPUT\\" << projectName << "_options.cpp\">\n"
       ...
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
       "        <Unit filename=\"" << inLIBPMpath << "\\galgas\\C_galgas_io.cpp\">\n"
       "            <Option compilerVar=\"CC\"/>\n"
       "            <Option target=\"" << releaseTarget << "\"/>\n"
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
       ...
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
       "        <Unit filename=\"" << inLIBPMpath << "\\galgas\\AC_galgas_mapindex.cpp\">\n"
       "            <Option compilerVar=\"CC\"/>\n"
       "            <Option target=\"" << releaseTarget << "\"/>\n"
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
       "        <Unit filename=\"" << inLIBPMpath << "\\galgas\\GGS_binaryset.cpp\">\n"
       "            <Option compilerVar=\"CC\"/>\n"
       "            <Option target=\"" << releaseTarget << "\"/>\n"
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
       "        <Unit filename=\"" << inLIBPMpath << "\\galgas\\AC_galgas_domain.cpp\">\n"
       "            <Option compilerVar=\"CC\"/>\n"
       "            <Option target=\"" << releaseTarget << "\"/>\n"
       "            <Option target=\"" << debugTarget << "\"/>\n"
       "        </Unit>\n"
...
//--- Create file
  ...
  f << "// !$*UTF8*$!\n"
       ...
       "                CFA7ADD7058DB5DF009AC1FE /* predefined_types.cpp in Sources */ = {isa = PBXBuildFile; fileRef = CF86361A0586289600B23462 /* predefined_types.cpp */; };\n"
 ...
 if (inProjectStyle == kMDAproject) {
   f << "                CFD286CF0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp in Sources */ = {isa = PBXBuildFile; fileRef = CFD286CB0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp */; };\n"
        "                CFD286D00A3C969A0066AF65 /* " << projectName << "_treewalking.h in Headers */ = {isa = PBXBuildFile; fileRef = CFD286CC0A3C969A0066AF65 /* " << projectName << "_treewalking.h */; };\n"
        ...
        "                CFD286D30A3C969A0066AF65 /* " << projectName << "_treewalking.cpp in Sources */ = {isa = PBXBuildFile; fileRef = CFD286CB0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp */; };\n"
        "                CFD286D40A3C969A0066AF65 /* " << projectName << "_treewalking.h in Headers */ = {isa = PBXBuildFile; fileRef = CFD286CC0A3C969A0066AF65 /* " << projectName << "_treewalking.h */; };\n"
 ...
 if (inProjectStyle == kMDAproject) {
   f << "                CFD286CB0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp */ = {isa = PBXFileReference; fileEncoding = 5; lastKnownFileType = sourcecode.cpp.cpp; path = " << projectName << "_treewalking.cpp; sourceTree = \"<group>\"; };\n"
        "                CFD286CC0A3C969A0066AF65 /* " << projectName << "_treewalking.h */ = {isa = PBXFileReference; fileEncoding = 5; lastKnownFileType = sourcecode.c.h; path = " << projectName << "_treewalking.h; sourceTree = \"<group>\"; };\n"
  ...
  f << "                CF512D7A092B3023008F7E87 /* C_BDD_Descriptor.cpp */ = {isa = PBXFileReference; fileEncoding = 5; lastKnownFileType = sourcecode.cpp.cpp; path = C_BDD_Descriptor.cpp; sourceTree = \"<group>\"; };\n"
       ...
       "                        sourceTree = \"<group>\";\n"
       "                };\n"
       "                CF3FF14005878B33000D2F8C /* collections */ = {\n"
       "                        isa = PBXGroup;\n"
       "                        children = (\n"
       ...
       "                        children = (\n" ;
 if (inProjectStyle == kMDAproject) {
     f << "                                CFD286CB0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp */,\n"
          "                                CFD286CC0A3C969A0066AF65 /* " << projectName << "_treewalking.h */,\n"
 ...
 f <<  "                                CFD284AB0A3C41EC0066AF65 /* " << projectName << "_cocoa.mm */,\n"
  ...
  if (inProjectStyle == kMDAproject) {
    f << "                                CFD286D00A3C969A0066AF65 /* " << projectName << "_treewalking.h in Headers */,\n"
  ...
  if (inProjectStyle == kMDAproject) {
    f << "                                CFD286D40A3C969A0066AF65 /* " << projectName << "_treewalking.h in Headers */,\n"
  ...
  if (inProjectStyle == kMDAproject) {
    f << "                                CFD286CF0A3C969A0066AF65 /* " << projectName << "_treewalking.cpp in Sources */,\n"
  ...
  if (inProjectStyle == kMDAproject) {
    f << "                                CFD286D30A3C969A0066AF65 /* " << projectName << "_treewalking.cpp in Sources */,\n"
...
//    }
  ...
  //--- Create GALGAS sources
    ...
    if (ok && (inProjectStyle == kMDAproject)) {
      ok = createTreewalkingFile (inCreatedProjectPathName) ;
    }
    if (ok) {
