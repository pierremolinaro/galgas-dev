...
createCodeBlockProjectFile (const C_String & inCreatedProjectPathName,
  ...
  f << "		<Unit filename=\"..\\..\\libpm\\galgas\\C_galgas_terminal_io.cpp\">\n"
       ...
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       "		<Unit filename=\"..\\..\\libpm\\galgas\\GGS_uint64.cpp\">\n"
       "			<Option compilerVar=\"CC\"/>\n"
       "			<Option target=\"" << releaseTarget << "\"/>\n"
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       ...
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       "		<Unit filename=\"..\\..\\libpm\\galgas\\GGS_sint64.cpp\">\n"
       "			<Option compilerVar=\"CC\"/>\n"
       "			<Option target=\"" << releaseTarget << "\"/>\n"
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       ...
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       "		<Unit filename=\"..\\..\\libpm\\galgas\\GGS_luint64.cpp\">\n"
       "			<Option compilerVar=\"CC\"/>\n"
       "			<Option target=\"" << releaseTarget << "\"/>\n"
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       ...
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
       "		<Unit filename=\"..\\..\\libpm\\galgas\\GGS_lsint64.cpp\">\n"
       "			<Option compilerVar=\"CC\"/>\n"
       "			<Option target=\"" << releaseTarget << "\"/>\n"
       "			<Option target=\"" << debugTarget << "\"/>\n"
       "		</Unit>\n"
...
//    }
  ...
  //--- Xcode Project
    ...
    if (ok) {
      ok = createXCodeProjectFile (inCreatedProjectPathName, inProjectStyle) ;
    }
	}
