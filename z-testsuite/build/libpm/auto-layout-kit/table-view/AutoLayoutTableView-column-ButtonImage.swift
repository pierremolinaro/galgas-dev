...
extension AutoLayoutTableView {
  ...
  public final func addColumn_ButtonImage (
    valueGetterDelegate inGetterDelegate : @escaping (_ inRow : Int) -> NSImage?,
    valueSetterDelegate inSetterDelegate : ((_ inRow : Int, _ inNewValue : NSImage) -> Void)? = nil,
    actionDelegate inActionDelegate : @escaping (_ inRow : Int) -> Void,
    sortDelegate inSortDelegate : ((_ inAscending : Bool) -> Void)? = nil,
