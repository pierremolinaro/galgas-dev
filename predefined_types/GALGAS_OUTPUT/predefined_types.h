...
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_LSTRINGLIST & inOperand) const ;
  public : GGS_bool operator != (const GGS_LSTRINGLIST & inOperand) const ;
//--- Constructor 'emptyList'
  public : static GGS_LSTRINGLIST constructor_emptyList (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_LSTRINGLIST constructor_listWithValue (C_Lexique & _inLexique,
