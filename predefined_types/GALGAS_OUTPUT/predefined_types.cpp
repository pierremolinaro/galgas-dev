...
_operator_isEqual (const GGS_UINT64LIST & inOperand) const {
...
GGS_bool GGS_UINT64LIST::
_operator_isNotEqual (const GGS_UINT64LIST & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_STRINGLIST & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_STRINGLIST::
_operator_isNotEqual (const GGS_STRINGLIST & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
...
_operator_isEqual (const GGS_LSTRINGLIST & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
GGS_bool GGS_LSTRINGLIST::
_operator_isNotEqual (const GGS_LSTRINGLIST & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), ! isEqualToList (inOperand)) ;
}
