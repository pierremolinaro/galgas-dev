...
isEqualToObject (C_Compiler & _inLexique,
  ...
  if (! equal) {
    ...
    equal = mValue._operator_isEqual (_inLexique, _p->mValue THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_UINT64LIST & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_UINT64LIST::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_UINT64LIST & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_STRINGLIST & inOperand
                   COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), isEqualToList (_inLexique, inOperand THERE)) ;
}
...
GGS_bool GGS_STRINGLIST::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_STRINGLIST & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_LSTRINGLIST & inOperand
                   COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), isEqualToList (_inLexique, inOperand THERE)) ;
}
...
GGS_bool GGS_LSTRINGLIST::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_LSTRINGLIST & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
