...
//--------------------------------- List Enumerator
  ...
  public : const GGS_uint   * _mValue (void) const ;
  } ;
...
//--------------------------------- List Enumerator
  ...
  public : const GGS_uint64   * _mValue (void) const ;
  } ;
...
//--------------------------------- List Enumerator
  ...
  public : const GGS_string  * _mValue (void) const ;
  } ;
...
//--------------------------------- List Enumerator
  ...
  public : const GGS_lstring   * _mValue (void) const ;
  } ;
