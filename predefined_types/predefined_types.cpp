...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_string2list ("string2list", false, NULL) ;
...
const C_galgas_type_descriptorEX * GGS_string2list::typeDescriptor (void) const {
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_string3list ("string3list", false, NULL) ;
...
const C_galgas_type_descriptorEX * GGS_string3list::typeDescriptor (void) const {
