...
\newenvironment{galgas}{%
  ...
  {\medskip\begin{siderules}\zeroEspaceAvantPonctuation{\tt{\input{temp.ggs.tex}}}\end{siderules}}
}
\makeatother
...
\newenvironment{galgasbox}{%
  ...
  \endgroup
  \immediate\write18{galgas -q --mode=latex:Galgas temp.ggs}
  {\singlespacing\begin{boxrules}\zeroEspaceAvantPonctuation{\tt{\input{temp.ggs.tex}}}\end{boxrules}}
}
\makeatother
