...
static void categoryMethod_stringsetPredefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  outArgument_outModifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (73)), GALGAS_formalParameterSignature::constructor_listWithValue (var_stringType, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (76)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (72)) ;
...
static GALGAS_uint categoryReader_applicationPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_objectPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (106)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_charPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_boolPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (154)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_doublePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringsetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (186)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)).operator_or (function_generateCopyConstructorAndAssignmentOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_binarysetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (199)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (199)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) COMMA_SOURCE_FILE_AT_LINE (200)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_typePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_dataPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (216)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_functionPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_locationPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (233)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_filewrapperPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
//---
  return result_uint ;
}
...
static void categoryMethod_stringsetPredefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (251)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (252)) ;
}
//---------------------------------------------------------------------------*
