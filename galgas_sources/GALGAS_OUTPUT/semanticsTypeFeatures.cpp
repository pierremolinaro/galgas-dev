...
//                    november 14th, 2010, at 21h22'43"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static GALGAS_uint categoryReader_applicationPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (81)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_objectPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (97)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_charPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (106)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_boolPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).operator_or (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_doublePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringsetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_or (function_generateCopyConstructorAndAssignmentOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (181)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_binarysetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (189)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_typePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (199)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_dataPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (207)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) COMMA_SOURCE_FILE_AT_LINE (208)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_functionPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_locationPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (224)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_filewrapperPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (232)) ;
//---
  return result_uint ;
}
...
static void categoryMethod_stringsetPredefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (242)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (243)) ;
}
//---------------------------------------------------------------------------*
