...
static GALGAS_uint categoryReader_doublePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_outFlags ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outFlags = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) COMMA_SOURCE_FILE_AT_LINE (177)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)) ;
//---
  return result_outFlags ;
}
