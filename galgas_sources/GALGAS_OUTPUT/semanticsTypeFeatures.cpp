...
//                    november 20th, 2010, at 18h41'12"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static void categoryMethod_stringsetPredefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (34)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (35)) ;
  //-------- @addAssignInstructionForGeneration
  outArgument_outEnumerationList.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (36)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_dataPredefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("uint"), var_uintTypeIndex COMMA_SOURCE_FILE_AT_LINE (46)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (47)) ;
  //-------- @addAssignInstructionForGeneration
  outArgument_outEnumerationList.addAssign_operation (var_uintTypeIndex, GALGAS_string ("data") COMMA_SOURCE_FILE_AT_LINE (48)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_stringsetPredefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("string"), var_stringType COMMA_SOURCE_FILE_AT_LINE (62)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (63)) ;
  { //-------- @modifierCallInstructionForGeneration
  outArgument_outModifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (65)), GALGAS_formalParameterSignature::constructor_listWithValue (var_stringType, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (68)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (64)) ;
...
static GALGAS_uint categoryReader_applicationPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_charPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (107)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_boolPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sintPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_uint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (149)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (149)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) COMMA_SOURCE_FILE_AT_LINE (149)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_sint_36__34_PredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (157)) COMMA_SOURCE_FILE_AT_LINE (157)).operator_or (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) COMMA_SOURCE_FILE_AT_LINE (158)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) COMMA_SOURCE_FILE_AT_LINE (159)).operator_or (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (160)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_doublePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_or (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_or (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_stringsetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (178)).operator_or (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (181)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (181)).operator_or (function_generateCopyConstructorAndAssignmentOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_binarysetPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)).operator_or (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_or (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)).operator_or (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)).operator_or (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)).operator_or (function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_typePredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_dataPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (208)).operator_or (function_generateEnumerationHelperMethods (inCompiler COMMA_SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (209)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint categoryReader_functionPredefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (217)) ;
//---
  return result_uint ;
}
...
static void categoryMethod_stringsetPredefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioUnifiedTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (243)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (244)) ;
}
//---------------------------------------------------------------------------*
