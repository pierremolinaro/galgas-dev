...
cCollectionElement_guiSimpleAttributeListAST * GALGAS_guiSimpleAttributeListAST::makeElement (const GALGAS_lstring & in_mKey,
                                                                                              const GALGAS_lstring & in_mValue
                                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_guiSimpleAttributeListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_guiSimpleAttributeListAST (in_mKey,
...
GALGAS_guiSimpleAttributeListAST GALGAS_guiSimpleAttributeListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
...
void GALGAS_guiSimpleAttributeListAST::modifier_setMKeyAtIndex (GALGAS_lstring inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_guiSimpleAttributeListAST * p = (cCollectionElement_guiSimpleAttributeListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guiSimpleAttributeListAST) ;
...
void GALGAS_guiSimpleAttributeListAST::modifier_setMValueAtIndex (GALGAS_lstring inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_guiSimpleAttributeListAST * p = (cCollectionElement_guiSimpleAttributeListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
cCollectionElement_guiCompoundAttributeListAST * GALGAS_guiCompoundAttributeListAST::makeElement (const GALGAS_lstring & in_mKey,
                                                                                                  const GALGAS_lstring & in_mAttributeName,
                                                                                                  const GALGAS_lstring & in_mValue
                                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_guiCompoundAttributeListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_guiCompoundAttributeListAST (in_mKey,
                                                                                                  in_mAttributeName,
                                                                                                  in_mValue COMMA_THERE)) ;
  return result ;
}
...
GALGAS_guiCompoundAttributeListAST GALGAS_guiCompoundAttributeListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                                const GALGAS_uint & inLength,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) const {
...
void GALGAS_guiCompoundAttributeListAST::modifier_setMKeyAtIndex (GALGAS_lstring inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_guiCompoundAttributeListAST * p = (cCollectionElement_guiCompoundAttributeListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guiCompoundAttributeListAST) ;
    p->mAttribute_mKey = inOperand ;
  }
...
void GALGAS_guiCompoundAttributeListAST::modifier_setMAttributeNameAtIndex (GALGAS_lstring inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_guiCompoundAttributeListAST * p = (cCollectionElement_guiCompoundAttributeListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_guiCompoundAttributeListAST::modifier_setMValueAtIndex (GALGAS_lstring inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_guiCompoundAttributeListAST * p = (cCollectionElement_guiCompoundAttributeListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
cCollectionElement_guiLabelListAST * GALGAS_guiLabelListAST::makeElement (const GALGAS_lstringlist & in_mTerminalList,
                                                                          const GALGAS_location & in_mLocation
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_guiLabelListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_guiLabelListAST (in_mTerminalList,
...
GALGAS_guiLabelListAST GALGAS_guiLabelListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                        const GALGAS_uint & inLength,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
...
void GALGAS_guiLabelListAST::modifier_setMTerminalListAtIndex (GALGAS_lstringlist inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_guiLabelListAST * p = (cCollectionElement_guiLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guiLabelListAST) ;
    p->mAttribute_mTerminalList = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_guiLabelListAST::modifier_setMLocationAtIndex (GALGAS_location inOperand,
                                                           GALGAS_uint inIndex,
                                                           C_Compiler * inCompiler
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_guiLabelListAST * p = (cCollectionElement_guiLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guiLabelListAST) ;
    p->mAttribute_mLocation = inOperand ;
  }
}
...
GALGAS_lstringlist GALGAS_guiLabelListAST::reader_mTerminalListAtIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guiLabelListAST * p = (cCollectionElement_guiLabelListAST *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guiLabelListAST) ;
    result = p->mAttribute_mTerminalList ;
  }
  return result ;
}
...
cCollectionElement_withLexiqueListAST * GALGAS_withLexiqueListAST::makeElement (const GALGAS_lstring & in_mLexiqueFileName,
                                                                                const GALGAS_guiLabelListAST & in_mLabels,
                                                                                const GALGAS_guiSimpleAttributeListAST & in_mSimpleAttributes,
                                                                                const GALGAS_guiCompoundAttributeListAST & in_mCompoundAttributes
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_withLexiqueListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_withLexiqueListAST (in_mLexiqueFileName,
                                                                                in_mLabels,
...
GALGAS_withLexiqueListAST GALGAS_withLexiqueListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                              const GALGAS_uint & inLength,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
...
void GALGAS_withLexiqueListAST::modifier_setMLexiqueFileNameAtIndex (GALGAS_lstring inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_withLexiqueListAST * p = (cCollectionElement_withLexiqueListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    p->mAttribute_mLexiqueFileName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_withLexiqueListAST::modifier_setMLabelsAtIndex (GALGAS_guiLabelListAST inOperand,
                                                            GALGAS_uint inIndex,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_withLexiqueListAST * p = (cCollectionElement_withLexiqueListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_withLexiqueListAST::modifier_setMSimpleAttributesAtIndex (GALGAS_guiSimpleAttributeListAST inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_withLexiqueListAST * p = (cCollectionElement_withLexiqueListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    p->mAttribute_mSimpleAttributes = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_withLexiqueListAST::modifier_setMCompoundAttributesAtIndex (GALGAS_guiCompoundAttributeListAST inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_withLexiqueListAST * p = (cCollectionElement_withLexiqueListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    p->mAttribute_mCompoundAttributes = inOperand ;
  }
}
...
GALGAS_lstring GALGAS_withLexiqueListAST::reader_mLexiqueFileNameAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    result = p->mAttribute_mLexiqueFileName ;
  }
  return result ;
}
...
GALGAS_guiSimpleAttributeListAST GALGAS_withLexiqueListAST::reader_mSimpleAttributesAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    result = p->mAttribute_mSimpleAttributes ;
  }
  return result ;
}
...
GALGAS_guiCompoundAttributeListAST GALGAS_withLexiqueListAST::reader_mCompoundAttributesAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_withLexiqueListAST) ;
    result = p->mAttribute_mCompoundAttributes ;
  }
  return result ;
}
...
/* GALGAS_guiComponentAST::GALGAS_guiComponentAST (const GALGAS_guiComponentAST & inSource) :
//mAttribute_mGUIName (inSource.mAttribute_mGUIName),
//mAttribute_mGUIClass (inSource.mAttribute_mGUIClass),
//mAttribute_mImportedOptionList (inSource.mAttribute_mImportedOptionList),
//mAttribute_mGlobalSimpleAttributeList (inSource.mAttribute_mGlobalSimpleAttributeList),
