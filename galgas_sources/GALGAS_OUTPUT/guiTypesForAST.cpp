...
class cCollectionElement_guiSimpleAttributeListAST : public cCollectionElement {
  public : GALGAS_guiSimpleAttributeListAST_3A_element mObject ;
...
GALGAS_guiSimpleAttributeListAST_3A_element cEnumerator_guiSimpleAttributeListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_guiCompoundAttributeListAST : public cCollectionElement {
  public : GALGAS_guiCompoundAttributeListAST_3A_element mObject ;
...
GALGAS_guiCompoundAttributeListAST_3A_element cEnumerator_guiCompoundAttributeListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_guiLabelListAST : public cCollectionElement {
  public : GALGAS_guiLabelListAST_3A_element mObject ;
...
cCollectionElement_guiLabelListAST::cCollectionElement_guiLabelListAST (const GALGAS_lstringlist & in_mTerminalList,
                                                                        ...
                                                                        COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mTerminalList, in_mLocation) {
}
...
cCollectionElement * cCollectionElement_guiLabelListAST::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_guiLabelListAST (mObject.mAttribute_mTerminalList, mObject.mAttribute_mLocation COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_guiLabelListAST::modifier_popFirst (GALGAS_lstringlist & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mObject.mAttribute_mTerminalList ;
    outOperand1 = p->mObject.mAttribute_mLocation ;
  }
}
...
GALGAS_guiLabelListAST_3A_element cEnumerator_guiLabelListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_withLexiqueListAST : public cCollectionElement {
  public : GALGAS_withLexiqueListAST_3A_element mObject ;
...
GALGAS_withLexiqueListAST_3A_element cEnumerator_withLexiqueListAST::current (LOCATION_ARGS) const {
