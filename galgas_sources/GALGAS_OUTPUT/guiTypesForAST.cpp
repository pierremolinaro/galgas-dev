...
void GALGAS_terminalLabelListAST::modifier_prependValue (GALGAS_lstring inOperand0,
...
GALGAS_terminalLabelListAST_2E_element cEnumerator_terminalLabelListAST::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_terminalLabelListAST) ;
  return p->mObject ;
}
...
void GALGAS_guiLabelListAST::modifier_prependValue (GALGAS_uint inOperand0,
                                                    GALGAS_terminalLabelListAST inOperand1,
