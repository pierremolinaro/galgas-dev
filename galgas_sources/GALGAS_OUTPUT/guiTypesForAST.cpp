...
GALGAS_guiLabelListAST_2E_element::GALGAS_guiLabelListAST_2E_element (const GALGAS_lstringlist & inOperand0,
                                                                      const GALGAS_location & inOperand1) :
...
GALGAS_guiLabelListAST_2E_element GALGAS_guiLabelListAST_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_guiLabelListAST_2E_element (GALGAS_lstringlist::constructor_emptyList (HERE),
                                            GALGAS_location::constructor_nowhere (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_guiLabelListAST_2E_element GALGAS_guiLabelListAST_2E_element::constructor_new (const GALGAS_lstringlist & inOperand0,
                                                                                      const GALGAS_location & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_guiLabelListAST_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_guiLabelListAST_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_guiLabelListAST_2E_element::reader_mTerminalList (UNUSED_LOCATION_ARGS) const {
