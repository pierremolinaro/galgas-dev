...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_semanticDeclarationList COMMA_SOURCE_FILE_AT_LINE (138)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticsComponentRoot.reader_mEndOfSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (143)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (141)) ;
  GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
  ::routine_performSemanticAnalysis (inLexique,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (148)) ;
  const GGS_bool cond_7339 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (153))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_7339.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_typeGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (155)), var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (156)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (156))) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_7041 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_7041 = NULL ;
      while (((operand_7041 = enumerator_7041.nextObject ()))) {
        macroValidPointer (operand_7041) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_7041->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7041->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (159)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
  const GGS_bool cond_8008 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (172))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8008.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_typeGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_7602 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_7602 = NULL ;
      while (((operand_7602 = enumerator_7602.nextObject ()))) {
        macroValidPointer (operand_7602) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_7602->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7602->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (177)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_7602->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7602->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (178)))) ;
      }
    }
