...
template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << ".h\"\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_554 (var_cas_IMPORTED_COMPONENT_LIST, true) ;
    const GGS_stringlist::cElement * operand_554 = NULL ;
    while (((operand_554 = enumerator_554.nextObject ()))) {
      macroValidPointer (operand_554) ;
      result << "#include \"" ;
      result << operand_554->mValue ;
      result << ".h\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13308 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13308.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_semanticFileGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (320))) ;
    {
      ...
      while (((operand_13010 = enumerator_13010.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13010->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13010->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (323)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (327))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (325)) ;
  }
  const GGS_bool cond_14012 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (336))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14012.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (338)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13612 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13612 = NULL ;
      while (((operand_13612 = enumerator_13612.nextObject ()))) {
        macroValidPointer (operand_13612) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13612->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13612->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (342)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13612->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13612->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (343)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (347))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
