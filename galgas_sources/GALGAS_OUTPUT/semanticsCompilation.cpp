...
//                    september 24th, 2010, at 21h16'34"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13236 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13236.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_13940 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (336))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13940.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13540 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13540 = NULL ;
      while (((operand_13540 = enumerator_13540.nextObject ()))) {
        macroValidPointer (operand_13540) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13540->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13540->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (342)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13540->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13540->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (343)))) ;
      }
    }
