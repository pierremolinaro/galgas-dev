...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8672 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8672.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8374 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8374 = NULL ;
      while (((operand_8374 = enumerator_8374.nextObject ()))) {
        macroValidPointer (operand_8374) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8374->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8374->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (193)))) ;
      }
    }
  ...
  const GGS_bool cond_9343 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (206))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9343.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8943 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_8943 = NULL ;
      while (((operand_8943 = enumerator_8943.nextObject ()))) {
        macroValidPointer (operand_8943) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_8943->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8943->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (211)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_8943->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8943->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (212)))) ;
      }
    }
