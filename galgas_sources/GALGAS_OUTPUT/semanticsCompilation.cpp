...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (160)) ;
  var_cas_outSemanticContext = GGS_semanticContext::constructor_new (_inLexique, var_cas_typeMap COMMA_HERE) ;
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_7558 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_7558 = NULL ;
    while (((operand_7558 = (GGS_semanticDeclarationList::cElement *) enumerator_7558.nextObject ()))) {
      macroValidPointer (operand_7558) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_8276 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_8276 = NULL ;
    while (((operand_8276 = (GGS_lstringlist::cElement *) enumerator_8276.nextObject ()))) {
      macroValidPointer (operand_8276) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_8276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_8276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_8276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_8276->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (190)), operand_8276->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_HERE) ;
          ...
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList)._operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (195))) ;
          ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (195)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
  GGS_stringset  var_cas_parsedFileSet ;
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (_inLexique, var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_HERE) ;
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (223)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (227)) ;
  #ifdef DEBUG_TRACE_ENABLED
