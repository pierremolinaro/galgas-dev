...
//                    september 24th, 2010, at 15h21'34"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_14149 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14149.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_implementationIncludeList) ;
    {
      ...
      while (((operand_13749 = enumerator_13749.nextObject ()))) {
        ...
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13749->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13749->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13749->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13749->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
      }
    }
