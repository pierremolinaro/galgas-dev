...
template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << ".h\"\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_603 (var_cas_IMPORTED_COMPONENT_LIST, true) ;
    const GGS_stringlist::cElement * operand_603 = NULL ;
    while (((operand_603 = enumerator_603.nextObject ()))) {
      macroValidPointer (operand_603) ;
      result << "#include \"" ;
      result << operand_603->mValue ;
      result << ".h\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
