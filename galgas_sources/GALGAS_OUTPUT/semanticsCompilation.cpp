...
//                    september 15th, 2008, at 20h41'42"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__listmapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listmapDeclaration * operand_12612,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12612 != NULL) {
    GGS_typeMapIndex  var_cas_associatedListTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_12612->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (285)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listmapGalgasType ::constructor_new (_inLexique, operand_12612->mListmapTypeName, var_cas_associatedListTypeIndex COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_12612->mListmapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (291)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_13610 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_13610 = NULL ;
    while (((operand_13610 = enumerator_13610.nextObject ()))) {
      macroValidPointer (operand_13610) ;
      const GGS_semanticDeclaration  _temp_13649 = operand_13610->mSemanticDeclaration ;
      if (_temp_13649._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_13649._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13649 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (312)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (317)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_13993 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13993 = NULL ;
        while (((operand_13993 = enumerator_13993.nextObject ()))) {
          macroValidPointer (operand_13993) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13993->mValue) ;
        }
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_14287 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_14287 = NULL ;
        while (((operand_14287 = enumerator_14287.nextObject ()))) {
          macroValidPointer (operand_14287) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_14287->mValue) ;
        }
      }
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_14659 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)), true) ;
      const GGS_typeMap::cElement * operand_14659 = NULL ;
      while (((operand_14659 = enumerator_14659.nextObject ()))) {
        macroValidPointer (operand_14659) ;
        const GGS_ACGalgasType  _temp_14728 = operand_14659->mInfo.mType ;
        if (_temp_14728._isBuilt ()) {
          _temp_14728 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (355))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_15659 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
    if (_temp_15659._isBuilt ()) {
      _temp_15659 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (356)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_16279 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_16279 = NULL ;
    while (((operand_16279 = enumerator_16279.nextObject ()))) {
      macroValidPointer (operand_16279) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_16279->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_16279->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (374))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_16279->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (375)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_16279->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (378)), operand_16279->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (379)) COMMA_HERE) ;
