...
void routine_parseSemanticComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_17055 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (387)).reader_hasKey (var_cas_basename) ;
  if (cond_17055.isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  temp_17005 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (388)) ;
    if (temp_17005.isBuilt ()) {
      temp_17005 (HERE)->method_searchKey (inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (388)) ;
    }
  }else if (cond_17055.isBuiltAndFalse ()) {
    ...
    var_cas_ioParsedComponentStruct.mParsedSemanticsComponentMap.modifier_insertKey (inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (391)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_17625 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_17625 = NULL ;
    while (((operand_17625 = enumerator_17625.nextObject ()))) {
      macroValidPointer (operand_17625) ;
      const GGS_bool cond_18554 = (var_cas_ioParsedFileSet.reader_hasKey (operand_17625->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (405)))).operator_not () ;
      if (cond_18554.isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet.addAssign_operation (operand_17625->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (406))) ;
        GGS_string var_cas_extension = operand_17625->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407)).reader_pathExtension () ;
        const GGS_bool cond_18541 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
        if (cond_18541.isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath = GGS_lstring ::constructor_new (inLexique, operand_17625->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inDirectory), operand_17625->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (411)) COMMA_HERE) ;
          GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
          ::routine_parseSemanticComponent (inLexique,  var_cas_filePath,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (414)) ;
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList).operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (419)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (419))) ;
          ::routine_recursivelyImportSemanticComponent (inLexique,  var_cas_ioParsedComponentStruct,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (inLexique COMMA_SOURCE_FILE_AT_LINE (424)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (420)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  #endif
  GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (441)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  GGS_lstring  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (448)) ;
  const GGS_bool cond_19440 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (449))).operator_isNotEqual (var_cas_basename) ;
  if (cond_19440.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (451)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (453)) ;
  }
  GGS_semanticDeclarationList  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (456)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (456)) ;
  GGS_stringset  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457))) ;
  ::routine_recursivelyImportSemanticComponent (inLexique,  var_cas_ioParsedComponentStruct,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (inLexique COMMA_SOURCE_FILE_AT_LINE (462)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent () COMMA_SOURCE_FILE_AT_LINE (458)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticsComponentRoot.reader_mEndOfSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (467)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (467)) ;
  #ifdef DEBUG_TRACE_ENABLED
