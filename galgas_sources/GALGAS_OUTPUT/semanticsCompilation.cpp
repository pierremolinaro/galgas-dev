...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  if (cond_15290.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_14987 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
    if (cond_14987.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_15279 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
      if (cond_15279.isBuiltAndTrue ()) {
        GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (344)))).operator_concat (GGS_string (" undefined types:")) ;
        {
  ...
  if (cond_15664.isBuiltAndTrue ()) {
    {
      ...
      while (((operand_15529 = enumerator_15529.nextObject ()))) {
        ...
        if (temp_15598.isBuilt ()) {
          temp_15598 (HERE)->method_checkTypeCrossReferences (inLexique, var_cas_outSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357)).reader_count () COMMA_SOURCE_FILE_AT_LINE (357)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_16579 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (375)).reader_hasKey (var_cas_basename) ;
...
void routine_recursivelyImportSemanticComponent (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_17149 = enumerator_17149.nextObject ()))) {
      ...
      const GGS_bool cond_18078 = (var_cas_ioParsedFileSet.reader_hasKey (operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)))).operator_not () ;
      if (cond_18078.isBuiltAndTrue ()) {
        ...
        GGS_string var_cas_extension = operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (395)).reader_pathExtension () ;
        const GGS_bool cond_18065 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
        if (cond_18065.isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath = GGS_lstring ::constructor_new (inLexique, operand_17149->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inDirectory), operand_17149->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (399)) COMMA_HERE) ;
