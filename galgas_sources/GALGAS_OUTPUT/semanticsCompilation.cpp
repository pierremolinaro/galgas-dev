...
category_method__mapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapDeclaration * operand_5824,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_7812 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_7812 = NULL ;
    while (((operand_7812 = (GGS_semanticDeclarationList::cElement *) enumerator_7812.nextObject ()))) {
      macroValidPointer (operand_7812) ;
      const GGS_semanticDeclaration  _temp_7867 = operand_7812->mSemanticDeclaration ;
      if (_temp_7867._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (& gClassInfoFor__semanticDeclaration ) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_7867 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (179)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (196))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_8767 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
    if (_temp_8767._isBuilt ()) {
      _temp_8767 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (197)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_9376 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_9376 = NULL ;
    while (((operand_9376 = (GGS_lstringlist::cElement *) enumerator_9376.nextObject ()))) {
      macroValidPointer (operand_9376) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_9376->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_9376->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_9376->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_9376->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (219)), operand_9376->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_HERE) ;
