...
static void
category_method__mapindexDeclaration__enterType (C_Compiler &,
...
static void
category_method__enumDeclaration__enterType (C_Compiler &,
                                const cPtr_enumDeclaration * operand_6224,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
static void
category_method__filewrapperDeclaration__enterType (C_Compiler &,
                                const cPtr_filewrapperDeclaration * operand_6405,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6405 != NULL) {
  }
}
...
static void
category_method__sortedListDeclaration__enterType (C_Compiler &,
                                const cPtr_sortedListDeclaration * operand_6585,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6585 != NULL) {
  }
}
...
static void
category_method__structDeclaration__enterType (C_Compiler &,
                                const cPtr_structDeclaration * operand_6761,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6761 != NULL) {
  }
}
...
static void
category_method__listDeclaration__enterType (C_Compiler &,
                                const cPtr_listDeclaration * operand_6935,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
static void
category_method__classDeclaration__enterType (C_Compiler &,
                                const cPtr_classDeclaration * operand_7110,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
static void
category_method__externRoutineDeclaration__enterType (C_Compiler &,
                                const cPtr_externRoutineDeclaration * operand_7293,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7293 != NULL) {
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_7818 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_7818 = NULL ;
    while (((operand_7818 = (GGS_semanticDeclarationList::cElement *) enumerator_7818.nextObject ()))) {
      macroValidPointer (operand_7818) ;
      const GGS_semanticDeclaration  _temp_7873 = operand_7818->mSemanticDeclaration ;
      if (_temp_7873._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_7873._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_7873 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (179)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (196))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_8773 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
    if (_temp_8773._isBuilt ()) {
      _temp_8773 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (197)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_9382 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_9382 = NULL ;
    while (((operand_9382 = (GGS_lstringlist::cElement *) enumerator_9382.nextObject ()))) {
      macroValidPointer (operand_9382) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_9382->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_9382->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_9382->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_9382->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (219)), operand_9382->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_HERE) ;
