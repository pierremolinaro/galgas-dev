...
void routine_compileSemanticsComponent (C_CompilerEx & inLexique,
  ...
  const GGS_bool cond_13718 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (320))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13718.isBuiltAndTrue ()) {
    ...
    }
    {
      ...
      while (((operand_13400 = enumerator_13400.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_13400->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13400->mDeclaration.getPtr (), var_cas_inOutputDirectory COMMA_SOURCE_FILE_AT_LINE (330)))) ;
      }
    }
  ...
  const GGS_bool cond_14555 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (343))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14555.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_14022 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_14022 = NULL ;
      while (((operand_14022 = enumerator_14022.nextObject ()))) {
        macroValidPointer (operand_14022) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_14022->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14022->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (350)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_14022->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14022->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (352)))) ;
      }
    }
