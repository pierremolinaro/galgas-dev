...
//                    september 24th, 2010, at 15h47'23"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13301 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13301.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_semanticFileGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (320))) ;
    {
      ...
      while (((operand_12938 = enumerator_12938.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12938->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12938->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (323)))) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_12938->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12938->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (324)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (328))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (326)) ;
  }
  const GGS_bool cond_14005 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (337))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14005.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (339)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13605 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13605 = NULL ;
      while (((operand_13605 = enumerator_13605.nextObject ()))) {
        macroValidPointer (operand_13605) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13605->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13605->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (343)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13605->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13605->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (344)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (348))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
