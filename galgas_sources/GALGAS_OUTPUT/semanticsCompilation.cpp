...
enterCategoryMethod__semanticInstruction__semanticAnalysis (typeCategoryMethod__semanticInstruction__semanticAnalysis inRoutine,
                     const PMSInt32 inClassID) {
  gDispatchTableForMethod__semanticInstruction__semanticAnalysis.forceObjectAtIndex (inClassID, inRoutine, NULL COMMA_HERE) ;
}
...
findCategoryMethod__semanticInstruction__semanticAnalysis (AC_galgasClassRunTimeInformationEX * inClassPtr) {
  ...
  if (result == NULL) {
    ...
    if (superClassPtr != NULL) {
      ...
      gDispatchTableForMethod__semanticInstruction__semanticAnalysis.forceObjectAtIndex (inClassPtr->slotID (), result, NULL COMMA_HERE) ;
    }
  }
  return result ;
}
...
static void epilogueRoutineFor_semanticsCompilation (void) {
  ...
  gDispatchTableForMethod__semanticInstruction__semanticAnalysis.free () ;
