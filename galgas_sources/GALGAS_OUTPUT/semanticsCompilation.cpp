...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13452 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_14240 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (339))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14240.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13756 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13756 = NULL ;
      while (((operand_13756 = enumerator_13756.nextObject ()))) {
        macroValidPointer (operand_13756) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_13756->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13756->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (345)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13756->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13756->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13756->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13756->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (351))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
