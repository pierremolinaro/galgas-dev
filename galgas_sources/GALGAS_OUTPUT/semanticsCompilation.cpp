...
category_method__mapindexDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapindexDeclaration * operand_6424,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6424 != NULL) {
    GGS_typeMapIndex  var_cas_mapTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_6424->mMapTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_mapTypeIndex COMMA_SOURCE_FILE_AT_LINE (117)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_mapindexType ::constructor_new (_inLexique, operand_6424->mMapIndexTypeName, var_cas_mapTypeIndex, operand_6424->mSearchMethodName COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_6424->mMapIndexTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
}
...
category_method__enumDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_enumDeclaration * operand_6957,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6957 != NULL) {
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_7094 (operand_6957->mConstructorConstantList, true) ;
      const GGS_lstringlist::cElement * operand_7094 = NULL ;
      while (((operand_7094 = enumerator_7094.nextObject ()))) {
        macroValidPointer (operand_7094) ;
        var_cas_enumConstructorMap.modifier_insertKey (_inLexique, operand_7094->mValue COMMA_SOURCE_FILE_AT_LINE (135)) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_enumType ::constructor_new (_inLexique, operand_6957->mEnumTypeName, var_cas_enumConstructorMap COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_6957->mEnumTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
}
...
category_method__filewrapperDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_filewrapperDeclaration * operand_7495,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7495 != NULL) {
...
category_method__sortedListDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_sortedListDeclaration * operand_7735,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7735 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_7863 (operand_7735->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_7863 = NULL ;
      while (((operand_7863 = enumerator_7863.nextObject ()))) {
        macroValidPointer (operand_7863) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_7863->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (162)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_7863->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_7735->mSortedListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_7735->mSortedListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (170)) ;
  }
}
...
category_method__structDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_structDeclaration * operand_8421,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8421 != NULL) {
    ...
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_8549 (operand_8421->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_8549 = NULL ;
      while (((operand_8549 = enumerator_8549.nextObject ()))) {
        macroValidPointer (operand_8549) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_8549->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (182)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_8549->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_structGalgasType ::constructor_new (_inLexique, operand_8421->mStructTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_8421->mStructTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (190)) ;
  }
}
...
category_method__listDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listDeclaration * operand_9099,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9099 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_9227 (operand_9099->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_9227 = NULL ;
      while (((operand_9227 = enumerator_9227.nextObject ()))) {
        macroValidPointer (operand_9227) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9227->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (202)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_9227->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_9099->mListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9099->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
}
...
category_method__classDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_classDeclaration * operand_9772,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9772 != NULL) {
    GGS_typeMapIndex  var_cas_superClassIndex ;
    if (((operand_9772->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_typeMapIndex ::constructor_null (_inLexique COMMA_HERE) ;
    }else{
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9772->mSuperClassName, var_cas_ioSemanticContext.mTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (223)) ;
      GGS_typeMapIndex  var_cas_classIndex ;
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9772->mClassTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (226)) ;
      var_cas_ioSemanticContext.mDescendantClassListMap._addAssign_operation (operand_9772->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)), var_cas_classIndex) ;
    }
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_10422 (operand_9772->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_10422 = NULL ;
      while (((operand_10422 = enumerator_10422.nextObject ()))) {
        macroValidPointer (operand_10422) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_10422->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (233)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_10422->mAttributeName) ;
      }
    }
    GGS_classMethodList  var_cas_methodList ;
    var_cas_methodList = GGS_classMethodList ::constructor_emptyList () ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_classGalgasType ::constructor_new (_inLexique, operand_9772->mIsAbstract, operand_9772->mClassTypeName, var_cas_superClassIndex, var_cas_attributeList, var_cas_methodList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9772->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (246)) ;
  }
}
...
category_method__externRoutineDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_externRoutineDeclaration * operand_11096,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11096 != NULL) {
    ...
    {
      GGS_formalParameterList::cEnumerator enumerator_11256 (operand_11096->mFormalParameterList, true) ;
      const GGS_formalParameterList::cElement * operand_11256 = NULL ;
      while (((operand_11256 = enumerator_11256.nextObject ()))) {
        ...
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_11256->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (258)) ;
        var_cas_routineSignature._addAssign_operation (var_cas_parameterTypeIndex, operand_11256->mFormalParameterName, operand_11256->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (_inLexique, operand_11096->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
}
...
category_method__listmapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listmapDeclaration * operand_11790,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11790 != NULL) {
    GGS_typeMapIndex  var_cas_associatedListTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_11790->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (271)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listmapGalgasType ::constructor_new (_inLexique, operand_11790->mListmapTypeName, var_cas_associatedListTypeIndex COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_11790->mListmapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (277)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (287)) ;
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_12740 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_12740 = NULL ;
    while (((operand_12740 = enumerator_12740.nextObject ()))) {
      macroValidPointer (operand_12740) ;
      const GGS_semanticDeclaration  _temp_12795 = operand_12740->mSemanticDeclaration ;
      if (_temp_12795._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_12795._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_12795 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (297)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_undefinedClasses = var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)).reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (302)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = GGS_string (true, "there is 1 undefined type:") ;
      {
        GGS_stringlist::cEnumerator enumerator_13132 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13132 = NULL ;
        while (((operand_13132 = enumerator_13132.nextObject ()))) {
          macroValidPointer (operand_13132) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13132->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (307)) ;
    }else if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = ((GGS_string (true, "there are "))._operator_concat (var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (309)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (309))))._operator_concat (GGS_string (true, " undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_13413 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13413 = NULL ;
        while (((operand_13413 = enumerator_13413.nextObject ()))) {
          macroValidPointer (operand_13413) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13413->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (313)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_13787 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (321)), true) ;
      const GGS_typeMap::cElement * operand_13787 = NULL ;
      while (((operand_13787 = enumerator_13787.nextObject ()))) {
        macroValidPointer (operand_13787) ;
        const GGS_ACGalgasType  _temp_13833 = operand_13787->mInfo.mType ;
        if (_temp_13833._isBuilt ()) {
          _temp_13833 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)) COMMA_SOURCE_FILE_AT_LINE (322)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (338)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (340))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_14779 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
    if (_temp_14779._isBuilt ()) {
      _temp_14779 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (341)) ;
    }
  }else{
    ...
    var_cas_ioParsedComponentStruct.mParsedSemanticsComponentMap.modifier_insertKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (344)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_15388 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_15388 = NULL ;
    while (((operand_15388 = enumerator_15388.nextObject ()))) {
      macroValidPointer (operand_15388) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_15388->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_15388->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_15388->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_15388->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (363)), operand_15388->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (364)) COMMA_HERE) ;
          GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
          ::routine_parseSemanticComponent (_inLexique,  var_cas_filePath,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (366)) ;
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList)._operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
          ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (377)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (372)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  #endif
  GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (_inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (393)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (400)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (400)) ;
  GGS_lstring  var_cas_componentName ;
  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (402)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (404))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (405)) ;
  }
  GGS_semanticDeclarationList  var_cas_semanticDeclarationList ;
  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (409)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (409)) ;
  GGS_stringset  var_cas_parsedFileSet ;
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))) ;
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (415)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (410)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (419)) ;
  #ifdef DEBUG_TRACE_ENABLED
