...
void routine_buildGrammarComponentMapForSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_8684 = enumerator_8684.nextObject ()))) {
      ...
      {
        GGS_nonTerminalLabelListAST::cEnumerator enumerator_8786 (operand_8684->mGrammarComponentAST.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (216)), true) ;
        const GGS_nonTerminalLabelListAST::cElement * operand_8786 = NULL ;
