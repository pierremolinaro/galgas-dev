...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  const GGS_bool cond_15290 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_15290.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_14987 = (var_cas_undefinedClasses.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (337))).operator_isEqual (GGS_uint (1U)) ;
    if (cond_14987.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_15279 = (var_cas_undefinedClasses.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (343))).operator_strictSup (GGS_uint (1U)) ;
  ...
  const GGS_bool cond_15664 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_15664.isBuiltAndTrue ()) {
    {
...
void routine_parseSemanticComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_16579 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (375)).reader_hasKey (inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (375)) ;
  if (cond_16579.isBuiltAndTrue ()) {
  ...
  }else if (cond_16579.isBuiltAndFalse ()) {
...
void routine_recursivelyImportSemanticComponent (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_17149 = enumerator_17149.nextObject ()))) {
      ...
      const GGS_bool cond_18078 = (var_cas_ioParsedFileSet.reader_hasKey (inLexique, operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)) COMMA_SOURCE_FILE_AT_LINE (393))).operator_not () ;
      if (cond_18078.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_18065 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
        if (cond_18065.isBuiltAndTrue ()) {
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_18964 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (437))).operator_isNotEqual (var_cas_basename) ;
  if (cond_18964.isBuiltAndTrue ()) {
