...
static void prologueRoutineFor_semanticsCompilation (void) {
 enterCategoryMethod (category_method__semanticDeclaration__enterType, GGS_semanticDeclaration::kClassID) ;
 enterCategoryMethod ((typeCategoryMethod__semanticDeclaration__enterType) category_method__mapDeclaration__enterType, GGS_mapDeclaration::kClassID) ;
}
