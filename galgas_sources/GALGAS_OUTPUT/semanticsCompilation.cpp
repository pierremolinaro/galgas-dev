...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_7508 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (155))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_7508.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_7210 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_7210 = NULL ;
      while (((operand_7210 = enumerator_7210.nextObject ()))) {
        macroValidPointer (operand_7210) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_7210->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7210->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (161)))) ;
      }
    }
  ...
  const GGS_bool cond_8171 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8171.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_7771 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_7771 = NULL ;
      while (((operand_7771 = enumerator_7771.nextObject ()))) {
        macroValidPointer (operand_7771) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_7771->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7771->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (179)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_7771->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_7771->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (180)))) ;
      }
    }
