...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_typeMap, GGS_routineMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_descendantClassListMap::constructor_emptyMap ()) ;
  {
    ...
    while (((operand_14480 = enumerator_14480.nextObject ()))) {
      ...
      const GGS_semanticDeclaration  _temp_14519 = operand_14480->mSemanticDeclaration ;
      if (_temp_14519.isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_14519._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (inLexique, _temp_14519 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (332)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_undefinedClasses.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (337))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (344)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (344)))).operator_concat (GGS_string (" undefined types:")) ;
      {
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    {
      ...
      while (((operand_15529 = enumerator_15529.nextObject ()))) {
        ...
        const GGS_ACGalgasType  _temp_15598 = operand_15529->mInfo.mType ;
        if (_temp_15598.isBuilt ()) {
          _temp_15598 (HERE)->method_checkTypeCrossReferences (inLexique, var_cas_outSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357)).reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (375)).reader_hasKey (inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (375))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_16529 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ;
    if (_temp_16529.isBuilt ()) {
      _temp_16529 (HERE)->method_searchKey (inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }
  }else{
  ...
  #endif
  {
    ...
    while (((operand_17149 = enumerator_17149.nextObject ()))) {
      ...
      if (((var_cas_ioParsedFileSet.reader_hasKey (inLexique, operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (393)) COMMA_SOURCE_FILE_AT_LINE (393))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (394))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_17149->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (395)).reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (395)) ;
        if (((var_cas_extension).operator_isEqual (GGS_string ("gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (inLexique, operand_17149->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (398)), operand_17149->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (399)) COMMA_HERE) ;
