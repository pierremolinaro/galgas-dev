...
category_method__mapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapDeclaration * operand_6531,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6531 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_6659 (operand_6531->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_6659 = NULL ;
      while (((operand_6659 = enumerator_6659.nextObject ()))) {
        macroValidPointer (operand_6659) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_6659->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (113)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_6659->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_mapType ::constructor_new (_inLexique, operand_6531->mMapTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_6531->mMapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
}
...
category_method__mapindexDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapindexDeclaration * operand_7198,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7198 != NULL) {
    GGS_typeMapIndex  var_cas_mapTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_7198->mMapTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_mapTypeIndex COMMA_SOURCE_FILE_AT_LINE (131)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_mapindexType ::constructor_new (_inLexique, operand_7198->mMapIndexTypeName, var_cas_mapTypeIndex, operand_7198->mSearchMethodName COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_7198->mMapIndexTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
}
...
category_method__enumDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_enumDeclaration * operand_7731,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7731 != NULL) {
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_7868 (operand_7731->mConstructorConstantList, true) ;
      const GGS_lstringlist::cElement * operand_7868 = NULL ;
      while (((operand_7868 = enumerator_7868.nextObject ()))) {
        macroValidPointer (operand_7868) ;
        var_cas_enumConstructorMap.modifier_insertKey (_inLexique, operand_7868->mValue COMMA_SOURCE_FILE_AT_LINE (149)) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_enumType ::constructor_new (_inLexique, operand_7731->mEnumTypeName, var_cas_enumConstructorMap COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_7731->mEnumTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (156)) ;
  }
}
...
category_method__filewrapperDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_filewrapperDeclaration * operand_8269,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__sortedListDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_sortedListDeclaration * operand_8545,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8545 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_8673 (operand_8545->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_8673 = NULL ;
      while (((operand_8673 = enumerator_8673.nextObject ()))) {
        macroValidPointer (operand_8673) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_8673->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (176)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_8673->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_8545->mSortedListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_8545->mSortedListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (184)) ;
  }
}
...
category_method__structDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_structDeclaration * operand_9231,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9231 != NULL) {
    ...
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_9359 (operand_9231->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_9359 = NULL ;
      while (((operand_9359 = enumerator_9359.nextObject ()))) {
        macroValidPointer (operand_9359) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9359->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (196)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_9359->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_structGalgasType ::constructor_new (_inLexique, operand_9231->mStructTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9231->mStructTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
}
...
category_method__listDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listDeclaration * operand_9909,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9909 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_10037 (operand_9909->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_10037 = NULL ;
      while (((operand_10037 = enumerator_10037.nextObject ()))) {
        macroValidPointer (operand_10037) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_10037->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (216)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_10037->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_9909->mListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9909->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (224)) ;
  }
}
...
category_method__classDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_classDeclaration * operand_10582,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10582 != NULL) {
    GGS_typeMapIndex  var_cas_superClassIndex ;
    if (((operand_10582->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (234)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_typeMapIndex ::constructor_null (_inLexique COMMA_HERE) ;
    }else{
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_10582->mSuperClassName, var_cas_ioSemanticContext.mTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (237)) ;
      GGS_typeMapIndex  var_cas_classIndex ;
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_10582->mClassTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (240)) ;
      var_cas_ioSemanticContext.mDescendantClassListMap._addAssign_operation (operand_10582->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)), var_cas_classIndex) ;
    }
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_11232 (operand_10582->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_11232 = NULL ;
      while (((operand_11232 = enumerator_11232.nextObject ()))) {
        macroValidPointer (operand_11232) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_11232->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (247)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_11232->mAttributeName) ;
      }
    }
    GGS_classMethodList  var_cas_methodList ;
    var_cas_methodList = GGS_classMethodList ::constructor_emptyList () ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_classGalgasType ::constructor_new (_inLexique, operand_10582->mIsAbstract, operand_10582->mClassTypeName, var_cas_superClassIndex, var_cas_attributeList, var_cas_methodList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_10582->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (260)) ;
  }
}
...
category_method__externRoutineDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_externRoutineDeclaration * operand_11906,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11906 != NULL) {
    ...
    {
      GGS_formalParameterList::cEnumerator enumerator_12066 (operand_11906->mFormalParameterList, true) ;
      const GGS_formalParameterList::cElement * operand_12066 = NULL ;
      while (((operand_12066 = enumerator_12066.nextObject ()))) {
        ...
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_12066->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (272)) ;
        var_cas_routineSignature._addAssign_operation (var_cas_parameterTypeIndex, operand_12066->mFormalParameterName, operand_12066->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (_inLexique, operand_11906->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (276)) ;
  }
}
...
category_method__listmapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listmapDeclaration * operand_12600,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12600 != NULL) {
    GGS_typeMapIndex  var_cas_associatedListTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_12600->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (285)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listmapGalgasType ::constructor_new (_inLexique, operand_12600->mListmapTypeName, var_cas_associatedListTypeIndex COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_12600->mListmapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (291)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (301)) ;
  var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_typeMap, GGS_routineMap ::constructor_emptyMap (_inLexique COMMA_HERE), GGS_descendantClassListMap::constructor_emptyMap ()) ;
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_13550 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_13550 = NULL ;
    while (((operand_13550 = enumerator_13550.nextObject ()))) {
      macroValidPointer (operand_13550) ;
      const GGS_semanticDeclaration  _temp_13605 = operand_13550->mSemanticDeclaration ;
      if (_temp_13605._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_13605._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13605 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (311)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_undefinedClasses = var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)).reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)) ;
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = GGS_string (true, "there is 1 undefined type:") ;
      {
        GGS_stringlist::cEnumerator enumerator_13942 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13942 = NULL ;
        while (((operand_13942 = enumerator_13942.nextObject ()))) {
          macroValidPointer (operand_13942) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13942->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (321)) ;
    }else if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = ((GGS_string (true, "there are "))._operator_concat (var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323))))._operator_concat (GGS_string (true, " undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_14223 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_14223 = NULL ;
        while (((operand_14223 = enumerator_14223.nextObject ()))) {
          macroValidPointer (operand_14223) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_14223->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (327)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_14597 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)), true) ;
      const GGS_typeMap::cElement * operand_14597 = NULL ;
      while (((operand_14597 = enumerator_14597.nextObject ()))) {
        macroValidPointer (operand_14597) ;
        const GGS_ACGalgasType  _temp_14643 = operand_14597->mInfo.mType ;
        if (_temp_14643._isBuilt ()) {
          _temp_14643 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)) ;
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (354))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_15589 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)) ;
    if (_temp_15589._isBuilt ()) {
      _temp_15589 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (355)) ;
    }
  }else{
    ...
    var_cas_ioParsedComponentStruct.mParsedSemanticsComponentMap.modifier_insertKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (358)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_16198 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_16198 = NULL ;
    while (((operand_16198 = enumerator_16198.nextObject ()))) {
      macroValidPointer (operand_16198) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_16198->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_16198->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_16198->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (374)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (374)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_16198->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (377)), operand_16198->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_HERE) ;
          GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
          ::routine_parseSemanticComponent (_inLexique,  var_cas_filePath,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (380)) ;
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList)._operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (386)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (386))) ;
          ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (391)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (386)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  #endif
  GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (_inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (407)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)) ;
  GGS_lstring  var_cas_componentName ;
  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (415)) ;
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (418))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (419)) ;
  }
  GGS_semanticDeclarationList  var_cas_semanticDeclarationList ;
  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (423)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (423)) ;
  GGS_stringset  var_cas_parsedFileSet ;
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (424))) ;
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (429)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (430)) COMMA_SOURCE_FILE_AT_LINE (424)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (433)) ;
  #ifdef DEBUG_TRACE_ENABLED
