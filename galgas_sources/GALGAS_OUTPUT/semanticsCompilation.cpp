...
void routine_recursivelyImportSemanticComponent (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_4374 = enumerator_4374.nextObject ()))) {
      ...
      const GGS_bool cond_6221 = (var_cas_ioParsedFileSet.reader_hasKey (var_cas_filePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)))).operator_not () ;
      if (cond_6221.isBuiltAndTrue ()) {
        ...
        if (cond_4873.isBuiltAndTrue ()) {
          ...
          if (cond_5238.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_6208 = (var_cas_extension).operator_isEqual (GGS_string ("gSemantics")) ;
            if (cond_6208.isBuiltAndTrue ()) {
              ...
              var_cas_ioSemanticDeclarationList.dotAssign_operation (var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (118)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (118))) ;
...
void routine_buildOptionComponentMapForSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_6610 (var_cas_inOptionComponentFileNameList, true) ;
    const GGS_lstringlist::cElement * operand_6610 = NULL ;
    while (((operand_6610 = enumerator_6610.nextObject ()))) {
      ...
      ::routine_parseOptionComponent (inLexique,  operand_6610->mValue,  var_cas_ioParsedComponentStruct,  var_cas_optionComponentName,  var_cas_boolOptionMap,  var_cas_uintOptionMap,  var_cas_stringOptionMap COMMA_SOURCE_FILE_AT_LINE (148)) ;
  ...
  {
    GGS_string2list::cEnumerator enumerator_7295 (var_cas_optionNameList, true) ;
    const GGS_string2list::cElement * operand_7295 = NULL ;
    while (((operand_7295 = enumerator_7295.nextObject ()))) {
      macroValidPointer (operand_7295) ;
      const GGS_bool cond_7634 = (operand_7295->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
      if (cond_7634.isBuiltAndTrue ()) {
        var_cas_boolOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7295->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (169)), GGS_system ::constructor_boolOptionInvocationLetter (operand_7295->mValue0, operand_7295->mValue1), GGS_system ::constructor_boolOptionInvocationString (operand_7295->mValue0, operand_7295->mValue1), GGS_system ::constructor_boolOptionCommentString (operand_7295->mValue0, operand_7295->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (168)) ;
      }
    }
  }
  ...
  {
    GGS_string2list::cEnumerator enumerator_7788 (var_cas_optionNameList, true) ;
    const GGS_string2list::cElement * operand_7788 = NULL ;
    while (((operand_7788 = enumerator_7788.nextObject ()))) {
      macroValidPointer (operand_7788) ;
      const GGS_bool cond_8127 = (operand_7788->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
      if (cond_8127.isBuiltAndTrue ()) {
        var_cas_uintOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7788->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (183)), GGS_system ::constructor_uintOptionInvocationLetter (operand_7788->mValue0, operand_7788->mValue1), GGS_system ::constructor_uintOptionInvocationString (operand_7788->mValue0, operand_7788->mValue1), GGS_system ::constructor_uintOptionCommentString (operand_7788->mValue0, operand_7788->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }
    }
  }
  ...
  {
    GGS_string2list::cEnumerator enumerator_8285 (var_cas_optionNameList, true) ;
    const GGS_string2list::cElement * operand_8285 = NULL ;
    while (((operand_8285 = enumerator_8285.nextObject ()))) {
      macroValidPointer (operand_8285) ;
      const GGS_bool cond_8632 = (operand_8285->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
      if (cond_8632.isBuiltAndTrue ()) {
        var_cas_stringOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_8285->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (197)), GGS_system ::constructor_stringOptionInvocationLetter (operand_8285->mValue0, operand_8285->mValue1), GGS_system ::constructor_stringOptionInvocationString (operand_8285->mValue0, operand_8285->mValue1), GGS_system ::constructor_stringOptionCommentString (operand_8285->mValue0, operand_8285->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (196)) ;
      }
    }
  }
...
void routine_buildGrammarComponentMapForSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_grammarComponentASTList::cEnumerator enumerator_9157 (var_cas_inGrammarComponentASTList, true) ;
    const GGS_grammarComponentASTList::cElement * operand_9157 = NULL ;
    while (((operand_9157 = enumerator_9157.nextObject ()))) {
      ...
      {
        GGS_nonTerminalLabelListAST::cEnumerator enumerator_9259 (operand_9157->mGrammarComponentAST.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (224)), true) ;
        const GGS_nonTerminalLabelListAST::cElement * operand_9259 = NULL ;
        while (((operand_9259 = enumerator_9259.nextObject ()))) {
          macroValidPointer (operand_9259) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_9431 (operand_9259->mFormalArgumentList, true) ;
            ...
            while (((operand_9431 = enumerator_9431.nextObject ()))) {
              ...
              var_cas_formalArgumentList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_9431->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (229)), operand_9431->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_grammarLabelMap.modifier_insertKey (inLexique, operand_9259->mLabelName, var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (233)) ;
        }
      }
      var_cas_ioSemanticContext.mGrammarMap.modifier_insertKey (inLexique, operand_9157->mGrammarComponentAST.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (240)), var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (239)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_10775 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263))).operator_isNotEqual (var_cas_basename) ;
  if (cond_10775.isBuiltAndTrue ()) {
  ...
  GGS_semanticDeclarationListAST  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (270)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
  ...
  ::routine_performSemanticAnalysis (inLexique,  var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (311)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (311)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (310)) ;
  const GGS_bool cond_13517 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13517.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13010 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13010 = NULL ;
      while (((operand_13010 = enumerator_13010.nextObject ()))) {
        macroValidPointer (operand_13010) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_13010->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13010->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (323)))) ;
      }
    }
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13154 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13154 = NULL ;
      while (((operand_13154 = enumerator_13154.nextObject ()))) {
        macroValidPointer (operand_13154) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13154->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13154->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (326)))) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_13154->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13154->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (327)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (331))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (329)) ;
  }
  const GGS_bool cond_14305 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14305.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13821 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13821 = NULL ;
      while (((operand_13821 = enumerator_13821.nextObject ()))) {
        macroValidPointer (operand_13821) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_13821->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13821->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13821->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13821->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13821->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13821->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (348)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
