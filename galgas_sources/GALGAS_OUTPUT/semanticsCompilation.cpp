...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  ::routine_buildSemanticContext (inLexique,  var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293)),  var_cas_semanticDeclarationListWithPredefinedTypes,  var_cas_semanticsComponentRoot.reader_mEndOfSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (295)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (292)) ;
  ::routine_buildOptionComponentMapForSemanticAnalysis (inLexique,  var_cas_optionComponentFileNameList,  var_cas_ioParsedComponentStruct,  var_cas_semanticContext.mOptionComponentMapForSemanticAnalysis COMMA_SOURCE_FILE_AT_LINE (299)) ;
  ::routine_buildGrammarComponentMapForSemanticAnalysis (inLexique,  var_cas_grammarComponentASTList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (305)) ;
  GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
  ::routine_performSemanticAnalysis (inLexique,  var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (312)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (311)) ;
  const GGS_bool cond_13393 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (317))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13393.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_semanticFileGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (319)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (321))) ;
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12965 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_12965 = NULL ;
      while (((operand_12965 = enumerator_12965.nextObject ()))) {
        macroValidPointer (operand_12965) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_12965->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12965->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (324)))) ;
      }
    }
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13094 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13094 = NULL ;
      while (((operand_13094 = enumerator_13094.nextObject ()))) {
        macroValidPointer (operand_13094) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_13094->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13094->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (327)))) ;
      }
    }
  ...
  const GGS_bool cond_14097 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14097.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13697 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13697 = NULL ;
      while (((operand_13697 = enumerator_13697.nextObject ()))) {
        macroValidPointer (operand_13697) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13697->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13697->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13697->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13697->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
      }
    }
