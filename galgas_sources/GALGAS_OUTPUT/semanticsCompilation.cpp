...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_7735 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_7735 = NULL ;
    while (((operand_7735 = (GGS_semanticDeclarationList::cElement *) enumerator_7735.nextObject ()))) {
      macroValidPointer (operand_7735) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_8453 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_8453 = NULL ;
    while (((operand_8453 = (GGS_lstringlist::cElement *) enumerator_8453.nextObject ()))) {
      macroValidPointer (operand_8453) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_8453->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_8453->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_8453->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_8453->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (198)), operand_8453->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_HERE) ;
          ...
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList)._operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (203))) ;
          ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (207)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (203)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (228)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (230))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (231)) ;
  }
  GGS_semanticDeclarationList  var_cas_semanticDeclarationList ;
  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
  GGS_stringset  var_cas_parsedFileSet ;
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (_inLexique, var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (236)) COMMA_HERE) ;
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (240)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (236)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (244)) ;
  #ifdef DEBUG_TRACE_ENABLED
