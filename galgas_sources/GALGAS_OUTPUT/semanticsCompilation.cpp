...
category_method__mapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapDeclaration * operand_5831,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5831 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@mapDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
}
...
category_method__mapindexDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_mapindexDeclaration * operand_6050,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6050 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@mapindexDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
}
...
category_method__enumDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_enumDeclaration * operand_6270,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6270 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@enumDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
}
...
category_method__filewrapperDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_filewrapperDeclaration * operand_6493,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6493 != NULL) {
...
category_method__sortedListDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_sortedListDeclaration * operand_6722,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6722 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@sortedListDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
}
...
category_method__structDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_structDeclaration * operand_6946,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6946 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@structDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
}
...
category_method__listDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listDeclaration * operand_7164,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7164 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@listDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
}
...
category_method__classDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_classDeclaration * operand_7381,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7381 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@classDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
}
...
category_method__externRoutineDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_externRoutineDeclaration * operand_7607,
                                GGS_semanticContext & /* var_cas_ioSemanticContext */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7607 != NULL) {
    _inLexique.printMessage (GGS_string (true, "@externRoutineDeclaration.enterType\n") COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_8183 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_8183 = NULL ;
    while (((operand_8183 = (GGS_semanticDeclarationList::cElement *) enumerator_8183.nextObject ()))) {
      macroValidPointer (operand_8183) ;
      const GGS_semanticDeclaration  _temp_8238 = operand_8183->mSemanticDeclaration ;
      if (_temp_8238._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_8238._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_8238 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (179)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (196))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_9138 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
    if (_temp_9138._isBuilt ()) {
      _temp_9138 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (197)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_9747 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_9747 = NULL ;
    while (((operand_9747 = (GGS_lstringlist::cElement *) enumerator_9747.nextObject ()))) {
      macroValidPointer (operand_9747) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_9747->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_9747->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_9747->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_9747->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (219)), operand_9747->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_HERE) ;
