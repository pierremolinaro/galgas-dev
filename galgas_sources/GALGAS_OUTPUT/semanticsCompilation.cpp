...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (303)) ;
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_13607 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_13607 = NULL ;
    while (((operand_13607 = enumerator_13607.nextObject ()))) {
      macroValidPointer (operand_13607) ;
      const GGS_semanticDeclaration  _temp_13646 = operand_13607->mSemanticDeclaration ;
      if (_temp_13646._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_13646._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13646 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (312)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_undefinedClasses = var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)).reader_unsolvedIndexKeyStringList (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (317)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = GGS_string (true, "there is 1 undefined type:") ;
      {
        GGS_stringlist::cEnumerator enumerator_13990 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13990 = NULL ;
        while (((operand_13990 = enumerator_13990.nextObject ()))) {
          macroValidPointer (operand_13990) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13990->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (323)) ;
    }else if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage ;
      var_cas_errorMessage = ((GGS_string (true, "there are "))._operator_concat (var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (324)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (324))))._operator_concat (GGS_string (true, " undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_14284 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_14284 = NULL ;
        while (((operand_14284 = enumerator_14284.nextObject ()))) {
          macroValidPointer (operand_14284) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_14284->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (329)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_14656 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)), true) ;
      const GGS_typeMap::cElement * operand_14656 = NULL ;
      while (((operand_14656 = enumerator_14656.nextObject ()))) {
        macroValidPointer (operand_14656) ;
        const GGS_ACGalgasType  _temp_14725 = operand_14656->mInfo.mType ;
        if (_temp_14725._isBuilt ()) {
          _temp_14725 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)) ;
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (355))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_15656 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
    if (_temp_15656._isBuilt ()) {
      _temp_15656 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (356)) ;
    }
  }else{
    ...
    var_cas_ioParsedComponentStruct.mParsedSemanticsComponentMap.modifier_insertKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (359)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_16276 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_16276 = NULL ;
    while (((operand_16276 = enumerator_16276.nextObject ()))) {
      macroValidPointer (operand_16276) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_16276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_16276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (374))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_16276->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (375)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_16276->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (378)), operand_16276->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (379)) COMMA_HERE) ;
          GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
          ::routine_parseSemanticComponent (_inLexique,  var_cas_filePath,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (382)) ;
          var_cas_ioSemanticDeclarationList = (var_cas_ioSemanticDeclarationList)._operator_concat (var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (387)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (387))) ;
          ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_ioSemanticDeclarationList,  var_cas_ioParsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (392)),  var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (388)) ;
        }
      }
    }
  }
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  #endif
  GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (_inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (409)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (415)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (415)) ;
  GGS_lstring  var_cas_componentName ;
  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) ;
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (417)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (419))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (421)) ;
  }
  GGS_semanticDeclarationList  var_cas_semanticDeclarationList ;
  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)) ;
  GGS_stringset  var_cas_parsedFileSet ;
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (425))) ;
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (430)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (426)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticsComponentRoot.reader_mEndOfSourceFile (_inLexique COMMA_SOURCE_FILE_AT_LINE (435)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (435)) ;
  #ifdef DEBUG_TRACE_ENABLED
