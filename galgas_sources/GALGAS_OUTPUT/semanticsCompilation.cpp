...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13405 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (317))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13405.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_12977 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_12977 = NULL ;
      while (((operand_12977 = enumerator_12977.nextObject ()))) {
        macroValidPointer (operand_12977) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_12977->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12977->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (324)))) ;
      }
    }
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_13106 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_13106 = NULL ;
      while (((operand_13106 = enumerator_13106.nextObject ()))) {
        macroValidPointer (operand_13106) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_13106->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13106->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (327)))) ;
      }
    }
  ...
  const GGS_bool cond_14109 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14109.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_13709 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_13709 = NULL ;
      while (((operand_13709 = enumerator_13709.nextObject ()))) {
        macroValidPointer (operand_13709) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13709->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13709->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13709->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13709->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
      }
    }
