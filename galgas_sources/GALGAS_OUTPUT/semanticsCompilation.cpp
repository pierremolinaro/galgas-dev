...
//                    september 22th, 2010, at 20h51'2"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13445 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13445.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_semanticFileGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (320))) ;
    {
      ...
      while (((operand_12938 = enumerator_12938.nextObject ()))) {
        ...
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_12938->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12938->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (323)))) ;
      }
    }
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13082 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13082 = NULL ;
      while (((operand_13082 = enumerator_13082.nextObject ()))) {
        macroValidPointer (operand_13082) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13082->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13082->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (326)))) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_13082->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13082->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (327)))) ;
      }
    }
  ...
  const GGS_bool cond_14233 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14233.isBuiltAndTrue ()) {
    ...
    {
      GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13749 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationListForGeneration::cElement * operand_13749 = NULL ;
      while (((operand_13749 = enumerator_13749.nextObject ()))) {
        macroValidPointer (operand_13749) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_13749->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13749->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13749->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13749->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13749->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13749->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (348)))) ;
      }
    }
