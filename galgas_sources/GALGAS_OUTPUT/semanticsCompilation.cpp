  ...
  if (cond_14240.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (341)), var_cas_implementationIncludeList) ;
    {
      ...
      while (((operand_13756 = enumerator_13756.nextObject ()))) {
        ...
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13756->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13756->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (346)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13756->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13756->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (347)))) ;
      }
    }
