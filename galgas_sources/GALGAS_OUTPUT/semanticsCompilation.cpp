...
category_method__sortedListDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_sortedListDeclaration * operand_7691,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7691 != NULL) {
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_7819 (operand_7691->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_7819 = NULL ;
      while (((operand_7819 = (GGS_attributeInCollectionList::cElement *) enumerator_7819.nextObject ()))) {
        macroValidPointer (operand_7819) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_7819->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (162)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_7819->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_7691->mSortedListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_7691->mSortedListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (170)) ;
  }
}
...
category_method__structDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_structDeclaration * operand_8366,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8366 != NULL) {
    ...
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_8494 (operand_8366->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_8494 = NULL ;
      while (((operand_8494 = (GGS_attributeInCollectionList::cElement *) enumerator_8494.nextObject ()))) {
        macroValidPointer (operand_8494) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_8494->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (182)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_8494->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_structGalgasType ::constructor_new (_inLexique, operand_8366->mStructTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_8366->mStructTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (190)) ;
  }
}
...
category_method__listDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listDeclaration * operand_9033,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9033 != NULL) {
    ...
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_9161 (operand_9033->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_9161 = NULL ;
      while (((operand_9161 = (GGS_attributeInCollectionList::cElement *) enumerator_9161.nextObject ()))) {
        macroValidPointer (operand_9161) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9161->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (202)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_9161->mAttributeName) ;
      }
    }
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listGalgasType ::constructor_new (_inLexique, operand_9033->mListTypeName, var_cas_attributeList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9033->mListTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
}
...
category_method__classDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_classDeclaration * operand_9695,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9695 != NULL) {
    GGS_typeMapIndex  var_cas_superClassIndex ;
    if (((operand_9695->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_typeMapIndex ::constructor_null (_inLexique COMMA_HERE) ;
    }else{
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9695->mSuperClassName, var_cas_ioSemanticContext.mTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (223)) ;
      GGS_typeMapIndex  var_cas_classIndex ;
      GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_9695->mClassTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (226)) ;
      var_cas_ioSemanticContext.mDescendantClassListMap._addAssign_operation (operand_9695->mSuperClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)), var_cas_classIndex) ;
    }
    GGS_attributeList  var_cas_attributeList ;
    var_cas_attributeList = GGS_attributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionList::cEnumerator enumerator_10345 (operand_9695->mAttributeList, true) ;
      const GGS_attributeInCollectionList::cElement * operand_10345 = NULL ;
      while (((operand_10345 = (GGS_attributeInCollectionList::cElement *) enumerator_10345.nextObject ()))) {
        macroValidPointer (operand_10345) ;
        GGS_typeMapIndex  var_cas_attributeTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_10345->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (233)) ;
        var_cas_attributeList._addAssign_operation (var_cas_attributeTypeIndex, operand_10345->mAttributeName) ;
      }
    }
    GGS_classMethodList  var_cas_methodList ;
    var_cas_methodList = GGS_classMethodList ::constructor_emptyList () ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_classGalgasType ::constructor_new (_inLexique, operand_9695->mIsAbstract, operand_9695->mClassTypeName, var_cas_superClassIndex, var_cas_attributeList, var_cas_methodList COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_9695->mClassTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (246)) ;
  }
}
...
category_method__externRoutineDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_externRoutineDeclaration * operand_11008,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11008 != NULL) {
    GGS_signature  var_cas_routineSignature ;
    var_cas_routineSignature = GGS_signature ::constructor_emptyList () ;
    {
      GGS_formalParameterList::cEnumerator enumerator_11168 (operand_11008->mFormalParameterList, true) ;
      const GGS_formalParameterList::cElement * operand_11168 = NULL ;
      while (((operand_11168 = (GGS_formalParameterList::cElement *) enumerator_11168.nextObject ()))) {
        macroValidPointer (operand_11168) ;
        GGS_typeMapIndex  var_cas_parameterTypeIndex ;
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_11168->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (258)) ;
        var_cas_routineSignature._addAssign_operation (var_cas_parameterTypeIndex, operand_11168->mFormalParameterName, operand_11168->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (_inLexique, operand_11008->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
}
...
category_method__listmapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listmapDeclaration * operand_11691,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11691 != NULL) {
    GGS_typeMapIndex  var_cas_associatedListTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_11691->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (271)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listmapGalgasType ::constructor_new (_inLexique, operand_11691->mListmapTypeName, var_cas_associatedListTypeIndex COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_11691->mListmapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (277)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_12630 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_12630 = NULL ;
    while (((operand_12630 = (GGS_semanticDeclarationList::cElement *) enumerator_12630.nextObject ()))) {
      macroValidPointer (operand_12630) ;
      const GGS_semanticDeclaration  _temp_12685 = operand_12630->mSemanticDeclaration ;
      if (_temp_12685._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_12685._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_12685 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (297)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (302)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_13022 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13022 = NULL ;
        while (((operand_13022 = (GGS_stringlist::cElement *) enumerator_13022.nextObject ()))) {
          macroValidPointer (operand_13022) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13022->mValue) ;
        }
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_13303 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13303 = NULL ;
        while (((operand_13303 = (GGS_stringlist::cElement *) enumerator_13303.nextObject ()))) {
          macroValidPointer (operand_13303) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13303->mValue) ;
        }
      }
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_13677 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (321)), true) ;
      const GGS_typeMap::cElement * operand_13677 = NULL ;
      while (((operand_13677 = (GGS_typeMap::cElement *) enumerator_13677.nextObject ()))) {
        macroValidPointer (operand_13677) ;
        const GGS_ACGalgasType  _temp_13723 = operand_13677->mInfo.mType ;
        if (_temp_13723._isBuilt ()) {
          _temp_13723 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)) COMMA_SOURCE_FILE_AT_LINE (322)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (340))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_14669 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
    if (_temp_14669._isBuilt ()) {
      _temp_14669 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (341)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_15278 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_15278 = NULL ;
    while (((operand_15278 = (GGS_lstringlist::cElement *) enumerator_15278.nextObject ()))) {
      macroValidPointer (operand_15278) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_15278->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_15278->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_15278->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_15278->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (363)), operand_15278->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (364)) COMMA_HERE) ;
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (_inLexique, var_cas_inSourceFile.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_HERE) ;
