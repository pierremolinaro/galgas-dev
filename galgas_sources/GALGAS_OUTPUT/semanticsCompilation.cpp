...
void routine_buildOptionComponentMapForSemanticAnalysis (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8989 = (var_cas_ioOptionComponentMapForSemanticAnalysis.reader_hasKey (GGS_string ("galgas_cli_options"))).operator_not () ;
  if (cond_8989.isBuiltAndTrue ()) {
    GGS_string2list  var_cas_optionNameList = GGS_system ::constructor_boolOptionNameList () ;
    GGS_commandLineOptionMap  var_cas_boolOptionMap = GGS_commandLineOptionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
    {
      GGS_string2list::cEnumerator enumerator_7362 (var_cas_optionNameList, true) ;
      const GGS_string2list::cElement * operand_7362 = NULL ;
      while (((operand_7362 = enumerator_7362.nextObject ()))) {
        macroValidPointer (operand_7362) ;
        const GGS_bool cond_7719 = (operand_7362->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
        if (cond_7719.isBuiltAndTrue ()) {
          var_cas_boolOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7362->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (170)), GGS_system ::constructor_boolOptionInvocationLetter (operand_7362->mValue0, operand_7362->mValue1), GGS_system ::constructor_boolOptionInvocationString (operand_7362->mValue0, operand_7362->mValue1), GGS_system ::constructor_boolOptionCommentString (operand_7362->mValue0, operand_7362->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (169)) ;
        }
      }
    }
    var_cas_optionNameList = GGS_system ::constructor_uintOptionNameList () ;
    GGS_commandLineOptionMap  var_cas_uintOptionMap = GGS_commandLineOptionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
    {
      GGS_string2list::cEnumerator enumerator_7883 (var_cas_optionNameList, true) ;
      const GGS_string2list::cElement * operand_7883 = NULL ;
      while (((operand_7883 = enumerator_7883.nextObject ()))) {
        macroValidPointer (operand_7883) ;
        const GGS_bool cond_8240 = (operand_7883->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
        if (cond_8240.isBuiltAndTrue ()) {
          var_cas_uintOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_7883->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (184)), GGS_system ::constructor_uintOptionInvocationLetter (operand_7883->mValue0, operand_7883->mValue1), GGS_system ::constructor_uintOptionInvocationString (operand_7883->mValue0, operand_7883->mValue1), GGS_system ::constructor_uintOptionCommentString (operand_7883->mValue0, operand_7883->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (183)) ;
        }
      }
    }
    var_cas_optionNameList = GGS_system ::constructor_stringOptionNameList () ;
    GGS_commandLineOptionMap  var_cas_stringOptionMap = GGS_commandLineOptionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
    {
      GGS_string2list::cEnumerator enumerator_8408 (var_cas_optionNameList, true) ;
      const GGS_string2list::cElement * operand_8408 = NULL ;
      while (((operand_8408 = enumerator_8408.nextObject ()))) {
        macroValidPointer (operand_8408) ;
        const GGS_bool cond_8773 = (operand_8408->mValue0).operator_isEqual (GGS_string ("galgas_cli_options")) ;
        if (cond_8773.isBuiltAndTrue ()) {
          var_cas_stringOptionMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_8408->mValue1, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (198)), GGS_system ::constructor_stringOptionInvocationLetter (operand_8408->mValue0, operand_8408->mValue1), GGS_system ::constructor_stringOptionInvocationString (operand_8408->mValue0, operand_8408->mValue1), GGS_system ::constructor_stringOptionCommentString (operand_8408->mValue0, operand_8408->mValue1), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (197)) ;
        }
      }
    }
    var_cas_ioOptionComponentMapForSemanticAnalysis.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (208)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap COMMA_SOURCE_FILE_AT_LINE (207)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildGrammarComponentMapForSemanticAnalysis (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_grammarComponentASTList::cEnumerator enumerator_9325 (var_cas_inGrammarComponentASTList, true) ;
    const GGS_grammarComponentASTList::cElement * operand_9325 = NULL ;
    while (((operand_9325 = enumerator_9325.nextObject ()))) {
      macroValidPointer (operand_9325) ;
      GGS_grammarLabelMap  var_cas_grammarLabelMap = GGS_grammarLabelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
      {
        GGS_nonTerminalLabelListAST::cEnumerator enumerator_9427 (operand_9325->mGrammarComponentAST.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (226)), true) ;
        const GGS_nonTerminalLabelListAST::cElement * operand_9427 = NULL ;
        while (((operand_9427 = enumerator_9427.nextObject ()))) {
          ...
          {
            GGS_formalParameterListAST::cEnumerator enumerator_9599 (operand_9427->mFormalArgumentList, true) ;
            const GGS_formalParameterListAST::cElement * operand_9599 = NULL ;
            while (((operand_9599 = enumerator_9599.nextObject ()))) {
              macroValidPointer (operand_9599) ;
              var_cas_formalArgumentList.addAssign_operation (GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_9599->mFormalArgumentTypeName COMMA_SOURCE_FILE_AT_LINE (231)), operand_9599->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_grammarLabelMap.modifier_insertKey (inLexique, operand_9427->mLabelName, var_cas_formalArgumentList COMMA_SOURCE_FILE_AT_LINE (235)) ;
        }
      }
      var_cas_ioSemanticContext.mGrammarMap.modifier_insertKey (inLexique, operand_9325->mGrammarComponentAST.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (242)), var_cas_grammarLabelMap COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileSemanticsComponent (C_Compiler & inLexique,
  ...
  #endif
  GGS_semanticsComponentAST  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (257)) ;
  ...
  const GGS_lstring  var_cas_componentName = var_cas_semanticsComponentRoot.reader_mSemanticsComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
  const GGS_bool cond_10943 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isNotEqual (var_cas_basename) ;
  if (cond_10943.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (269)) ;
  }
  GGS_semanticDeclarationListAST  var_cas_semanticDeclarationList = var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) ;
  GGS_stringset  var_cas_parsedFileSet = GGS_stringset ::constructor_setWithString (var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273))) ;
  ...
  ::routine_recursivelyImportSemanticComponent (inLexique,  var_cas_ioParsedComponentStruct,  var_cas_optionComponentFileNameList,  var_cas_grammarComponentASTList,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_headerIncludeList,  var_cas_implementationIncludeList,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (inLexique COMMA_SOURCE_FILE_AT_LINE (286)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent () COMMA_SOURCE_FILE_AT_LINE (278)) ;
  GGS_semanticDeclarationListAST  var_cas_semanticDeclarationListWithPredefinedTypes = var_cas_semanticDeclarationList ;
  ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_semanticDeclarationListWithPredefinedTypes COMMA_SOURCE_FILE_AT_LINE (291)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (295)),  var_cas_semanticDeclarationListWithPredefinedTypes,  var_cas_semanticsComponentRoot.reader_mEndOfSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (297)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (294)) ;
  ::routine_buildOptionComponentMapForSemanticAnalysis (inLexique,  var_cas_optionComponentFileNameList,  var_cas_ioParsedComponentStruct,  var_cas_semanticContext.mOptionComponentMapForSemanticAnalysis COMMA_SOURCE_FILE_AT_LINE (301)) ;
  ::routine_buildGrammarComponentMapForSemanticAnalysis (inLexique,  var_cas_grammarComponentASTList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (307)) ;
  GGS_semanticDeclarationSortedListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
  ::routine_performSemanticAnalysis (inLexique,  var_cas_semanticsComponentRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (314)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (313)) ;
  const GGS_bool cond_13597 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (319))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13597.isBuiltAndTrue ()) {
    GGS_string var_cas_headerString = template_filewrapper_semanticFileGenerationTemplate_semanticFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (321)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (323))) ;
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_13169 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_13169 = NULL ;
      while (((operand_13169 = enumerator_13169.nextObject ()))) {
        macroValidPointer (operand_13169) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_13169->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13169->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (326)))) ;
      }
    }
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_13298 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_13298 = NULL ;
      while (((operand_13298 = enumerator_13298.nextObject ()))) {
        macroValidPointer (operand_13298) ;
        var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_13298->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13298->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (329)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (333))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_headerString, GGS_string ("\n"
      "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (331)) ;
  }
  const GGS_bool cond_14301 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (342))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_14301.isBuiltAndTrue ()) {
    GGS_string var_cas_implementationString = template_filewrapper_semanticFileGenerationTemplate_semanticFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (344)), var_cas_implementationIncludeList) ;
    {
      GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_13901 (var_cas_decoratedDeclarationListForGeneration, true) ;
      const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_13901 = NULL ;
      while (((operand_13901 = enumerator_13901.nextObject ()))) {
        macroValidPointer (operand_13901) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13901->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13901->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (348)))) ;
        var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13901->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13901->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (349)))) ;
      }
    }
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (353))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
