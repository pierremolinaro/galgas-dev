...
category_method__externRoutineDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_externRoutineDeclaration * operand_11915,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11915 != NULL) {
    GGS_signature  var_cas_routineSignature ;
    var_cas_routineSignature = GGS_signature ::constructor_emptyList () ;
    {
      GGS_formalParameterList::cEnumerator enumerator_12087 (operand_11915->mFormalParameterList, true) ;
      const GGS_formalParameterList::cElement * operand_12087 = NULL ;
      while (((operand_12087 = enumerator_12087.nextObject ()))) {
        ...
        GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_12087->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (272)) ;
        var_cas_routineSignature._addAssign_operation (var_cas_parameterTypeIndex, operand_12087->mFormalParameterName, operand_12087->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (_inLexique, operand_11915->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (276)) ;
  }
}
...
category_method__listmapDeclaration__enterType (C_Compiler & _inLexique,
                                const cPtr_listmapDeclaration * operand_12609,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12609 != NULL) {
    GGS_typeMapIndex  var_cas_associatedListTypeIndex ;
    GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, operand_12609->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (285)) ;
    GGS_ACGalgasType  var_cas_t ;
    var_cas_t = GGS_listmapGalgasType ::constructor_new (_inLexique, operand_12609->mListmapTypeName, var_cas_associatedListTypeIndex COMMA_HERE) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (_inLexique, operand_12609->mListmapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (291)) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & _inLexique,
  ...
  ::routine_constructBuiltinTypeMap (_inLexique,  var_cas_typeMap COMMA_SOURCE_FILE_AT_LINE (302)) ;
  ...
  {
    GGS_semanticDeclarationList::cEnumerator enumerator_13576 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationList::cElement * operand_13576 = NULL ;
    while (((operand_13576 = enumerator_13576.nextObject ()))) {
      macroValidPointer (operand_13576) ;
      const GGS_semanticDeclaration  _temp_13615 = operand_13576->mSemanticDeclaration ;
      if (_temp_13615._isBuilt ()) {
        typeCategoryMethod__semanticDeclaration__enterType _method = findCategoryMethod__semanticDeclaration__enterType (_temp_13615._galgasObjectRunTimeInfo ()) ;
        if (_method != NULL) {
          _method (_inLexique, _temp_13615 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (311)) ;
        }
      }
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_undefinedClasses.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (316)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_13959 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_13959 = NULL ;
        while (((operand_13959 = enumerator_13959.nextObject ()))) {
          macroValidPointer (operand_13959) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_13959->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (322)) ;
      ...
      {
        GGS_stringlist::cEnumerator enumerator_14240 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_14240 = NULL ;
        while (((operand_14240 = enumerator_14240.nextObject ()))) {
          macroValidPointer (operand_14240) ;
          var_cas_errorMessage.writeString ("\n"
            "-  @") ;
          var_cas_errorMessage._dotAssign_operation (operand_14240->mValue) ;
        }
      }
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (328)) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    {
      GGS_typeMap::cEnumerator enumerator_14599 (var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)), true) ;
      const GGS_typeMap::cElement * operand_14599 = NULL ;
      while (((operand_14599 = enumerator_14599.nextObject ()))) {
        macroValidPointer (operand_14599) ;
        const GGS_ACGalgasType  _temp_14668 = operand_14599->mInfo.mType ;
        if (_temp_14668._isBuilt ()) {
          _temp_14668 (HERE)->method_checkTypeCrossReferences (_inLexique, var_cas_outSemanticContext.reader_mTypeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)) ;
        }
      }
    }
  }
...
void routine_parseSemanticComponent (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)).reader_hasKey (_inLexique, var_cas_basename COMMA_SOURCE_FILE_AT_LINE (354))).isBuiltAndTrue ()) {
    const GGS_parsedSemanticsComponentMap  _temp_15599 = var_cas_ioParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (355)) ;
    if (_temp_15599._isBuilt ()) {
      _temp_15599 (HERE)->method_searchKey (_inLexique, var_cas_basenameKey, var_cas_outSemanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (355)) ;
    }
  }else{
...
void routine_recursivelyImportSemanticComponent (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_lstringlist::cEnumerator enumerator_16219 (var_cas_inListOfFilesToParse, true) ;
    const GGS_lstringlist::cElement * operand_16219 = NULL ;
    while (((operand_16219 = enumerator_16219.nextObject ()))) {
      macroValidPointer (operand_16219) ;
      if (((var_cas_ioParsedFileSet.reader_hasKey (_inLexique, operand_16219->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_ioParsedFileSet._addAssign_operation (operand_16219->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373))) ;
        GGS_string var_cas_extension ;
        var_cas_extension = operand_16219->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (374)).reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (374)) ;
        if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_filePath ;
          var_cas_filePath = GGS_lstring ::constructor_new (_inLexique, operand_16219->mValue.ggs_string ().reader_absolutePathFromPath (_inLexique, var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (377)), operand_16219->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_HERE) ;
          GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
          ::routine_parseSemanticComponent (_inLexique,  var_cas_filePath,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (381)) ;
...
void routine_compileSemanticsComponent (C_Compiler & _inLexique,
  ...
  #endif
  GGS_semanticsComponentRoot  var_cas_semanticsComponentRoot ;
  ::routine_parseSemanticComponent (_inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_semanticsComponentRoot COMMA_SOURCE_FILE_AT_LINE (408)) ;
  GGS_string var_cas_basename ;
  ...
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (418))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (420)) ;
  }
  ...
  ::routine_recursivelyImportSemanticComponent (_inLexique,  var_cas_ioParsedComponentStruct,  var_cas_semanticDeclarationList,  var_cas_parsedFileSet,  var_cas_semanticsComponentRoot.reader_mImportedComponentFileNameList (_inLexique COMMA_SOURCE_FILE_AT_LINE (429)),  var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (430)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (434)) ;
  #ifdef DEBUG_TRACE_ENABLED
