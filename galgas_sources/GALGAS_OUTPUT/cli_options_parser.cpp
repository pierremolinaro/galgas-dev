      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))))._operator_concat (GGS_string (true, "' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (106)))._operator_isEqual (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
            ...
            var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only @bool, @uint or @string types can be used here") COMMA_SOURCE_FILE_AT_LINE (114)) ;
          }
      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (243))))._operator_concat (GGS_string (true, "' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (244)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)))._operator_isEqual (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          ...
          }else if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)))._operator_isEqual (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          ...
          }else if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)))._operator_isEqual (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            ...
            var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only @bool, @uint or @string types can be used here") COMMA_SOURCE_FILE_AT_LINE (252)) ;
          }
