...
pr_galgas_component_cli_options_parser_63_24_ (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (140)) SOURCE_FILE_AT_LINE (140))).isBuiltAndTrue ()) {
            ...
            var_cas_boolOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (143)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (144))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
            var_cas_uintOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (145)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (146))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            var_cas_stringOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (147)) ;
          }else{
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_option) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioOptionsComponentsMap.method_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (157)) ;
...
pr_galgas_component_cli_options_parser_63_24_importOptions (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (313)) SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
            ...
            var_cas_boolOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (316)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (317))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
            var_cas_uintOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (318)) ;
          }else if (((var_cas_typeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (319))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            var_cas_stringOptionsMap.method_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (320)) ;
          }else{
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_option) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioOptionsComponentsMap.method_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (329)) ;
}
