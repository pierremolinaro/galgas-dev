...
pr_galgas_component_cli_options_parser_72_24_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_cli_options_parser_0 (lexique_var_)) {
        case 2 : {
          ...
          if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
            if ((var_cas_uintOptionsMap.reader_hasKey (var_cas_typeName.reader_value ())).isBuiltAndTrue ()) {
              ...
              if (var_cas_boolOptionsMap.isBuilt ()) {
            ...
            if ((var_cas_boolOptionsMap.reader_hasKey (var_cas_typeName.reader_value ())).isBuiltAndTrue ()) {
                var_cas_typeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "the '")) + (var_cas_typeName.reader_value ()))) + (GGS_string (true, "' command line option has been already declared")))) ;
            }else{
              if (var_cas_uintOptionsMap.isBuilt ()) {
  ...
  if (var_cas_ioOptionsComponentsMap.isBuilt ()) {
    var_cas_ioOptionsComponentsMap ()->methode_insertKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap) ;
  }
