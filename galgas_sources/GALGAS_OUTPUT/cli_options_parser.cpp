      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_cli_options_parser_1 (_inLexique)) {
            case 1 : {
              var_cas_defaultValue = GGS_uint (true, 0) ;
            ...
            case 2 : {
              ...
              if (((var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (105))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @bool option (allways false by default)") SOURCE_FILE_AT_LINE (107)) ;
              }else if (((var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (107))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @string option (allways false by default)") SOURCE_FILE_AT_LINE (109)) ;
              }
              GGS_luint  var_cas_v ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) ;
              var_cas_v.defineAttribute (_inLexique.uint32value, _inLexique) ;
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (115)) SOURCE_FILE_AT_LINE (115))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (116))))) + (GGS_string (true, "' command line option has been already declared"))) SOURCE_FILE_AT_LINE (117)) ;
      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_cli_options_parser_1 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_typeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (280))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @bool option (allways false by default)") SOURCE_FILE_AT_LINE (282)) ;
              }
              GGS_luint  var_cas_v ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) ;
              var_cas_v.defineAttribute (_inLexique.uint32value, _inLexique) ;
          ...
          if ((var_cas_optionNameSet.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (288)) SOURCE_FILE_AT_LINE (288))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (289))))) + (GGS_string (true, "' command line option has been already declared"))) SOURCE_FILE_AT_LINE (290)) ;
