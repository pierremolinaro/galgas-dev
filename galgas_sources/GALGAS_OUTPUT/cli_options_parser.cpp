...
pr_galgas_component_cli_options_parser_63_24_ (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_cli_options_parser_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_cli_options_parser_1 (_inLexique)) {
            case 1 : {
              ...
              if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticWarning (_inLexique, GGS_string (true, "No default value for this option, 0 will be used") SOURCE_FILE_AT_LINE (101)) ;
              }
              } break ;
            case 2 : {
              ...
              if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @bool option (allways false by default)") SOURCE_FILE_AT_LINE (106)) ;
              }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @string option (allways false by default)") SOURCE_FILE_AT_LINE (108)) ;
              }
              GGS_luint  var_cas_v ;
          ...
          if ((var_cas_optionNameSet.reader_hasKey (var_cas_optionName.reader_value ())).isBuiltAndTrue ()) {
              var_cas_optionName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_optionName.reader_value ()))) + (GGS_string (true, "' command line option has been already declared"))) SOURCE_FILE_AT_LINE (116)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
            var_cas_boolOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (118)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
            var_cas_uintOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (120)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            var_cas_stringOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (122)) ;
          }else{
              var_cas_typeName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "only @bool, @uint or @string types can be used here") SOURCE_FILE_AT_LINE (124)) ;
          }
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_option) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioOptionsComponentsMap.methode_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (132)) ;
...
pr_galgas_component_cli_options_parser_63_24_importOptions (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_cli_options_parser_1 (_inLexique)) {
            case 1 : {
              var_cas_defaultValue = GGS_uint (true, 0UL) ;
              if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticWarning (_inLexique, GGS_string (true, "No default value for this option, 0 will be used") SOURCE_FILE_AT_LINE (276)) ;
              }
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_default) ;
              if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "'default' construct is not allowed for a @bool option (allways false by default)") SOURCE_FILE_AT_LINE (281)) ;
              }
              GGS_luint  var_cas_v ;
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) ;
              var_cas_v.defineAttribute (_inLexique.ulongValue, _inLexique) ;
          ...
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          if ((var_cas_optionNameSet.reader_hasKey (var_cas_optionName.reader_value ())).isBuiltAndTrue ()) {
              var_cas_optionName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_optionName.reader_value ()))) + (GGS_string (true, "' command line option has been already declared"))) SOURCE_FILE_AT_LINE (289)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
            var_cas_boolOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (291)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
            var_cas_uintOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (293)) ;
          }else if (((var_cas_typeName.reader_value ()) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
            var_cas_stringOptionsMap.methode_insertKey (_inLexique, var_cas_optionName, var_cas_optionChar, var_cas_optionString, var_cas_optionComment, var_cas_defaultValue SOURCE_FILE_AT_LINE (295)) ;
          }else{
              var_cas_typeName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "only @bool, @uint or @string types can be used here") SOURCE_FILE_AT_LINE (297)) ;
          }
          var_cas_optionNameSet.addAssign_operation (var_cas_typeName.reader_value ()) ;
          } break ;
        default :
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_option) ;
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  var_cas_ioOptionsComponentsMap.methode_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (304)) ;
}
