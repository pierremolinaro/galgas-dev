...
void cli_options_parser::rule_cli_5F_options_5F_parser_galgas_5F_component_i0_importOptions (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  GGS_M_cli_options  var_cas_boolOptionsMap = GGS_M_cli_options ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
  GGS_M_cli_options  var_cas_uintOptionsMap = GGS_M_cli_options ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
  GGS_M_cli_options  var_cas_stringOptionsMap = GGS_M_cli_options ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
