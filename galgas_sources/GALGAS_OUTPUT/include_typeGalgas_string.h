...
#ifndef typeGalgas_string_DEFINED
#define typeGalgas_string_DEFINED
...
class GGG_typeGalgas_string : public GGG_AC_galgasType {
  private : typedef GGG_AC_galgasType inherited ;
  public : GGG_typeGalgas_string (LOCATION_ARGS) ;
} ;
