...
//--- Message 0
static const utf32 gErrorMessage_0 [] = {UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('c'), UNICODE_NEW ('i'), UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW (' '), UNICODE_NEW ('n'), UNICODE_NEW ('u'), UNICODE_NEW ('m'), UNICODE_NEW ('b'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW (' '), UNICODE_NEW ('t'), UNICODE_NEW ('o'), UNICODE_NEW ('o'), UNICODE_NEW (' '), UNICODE_NEW ('l'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW ('g'), UNICODE_NEW ('e'), UNICODE_NEW (0)} ;
//--- Message 1
static const utf32 gErrorMessage_1 [] = {UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('v'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW ('i'), UNICODE_NEW ('d'), UNICODE_NEW (' '), UNICODE_NEW ('f'), UNICODE_NEW ('l'), UNICODE_NEW ('o'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW (' '), UNICODE_NEW ('n'), UNICODE_NEW ('u'), UNICODE_NEW ('m'), UNICODE_NEW ('b'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW (0)} ;
//--- Message 2
static const utf32 gErrorMessage_2 [] = {UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('n'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW (' '), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (0)} ;
...
static const utf32 kEntry_0_forTable_galgasKeyWordList [] = {UNICODE_NEW ('d'), UNICODE_NEW ('o'), UNICODE_NEW (0)}; 

static const utf32 kEntry_1_forTable_galgasKeyWordList [] = {UNICODE_NEW ('i'), UNICODE_NEW ('f'), UNICODE_NEW (0)}; 

static const utf32 kEntry_2_forTable_galgasKeyWordList [] = {UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_3_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_4_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_5_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_6_forTable_galgasKeyWordList [] = {UNICODE_NEW ('g'), UNICODE_NEW ('u'), UNICODE_NEW ('i'), UNICODE_NEW (0)}; 

static const utf32 kEntry_7_forTable_galgasKeyWordList [] = {UNICODE_NEW ('l'), UNICODE_NEW ('o'), UNICODE_NEW ('g'), UNICODE_NEW (0)}; 

static const utf32 kEntry_8_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('p'), UNICODE_NEW (0)}; 

static const utf32 kEntry_9_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('o'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_10_forTable_galgasKeyWordList [] = {UNICODE_NEW ('n'), UNICODE_NEW ('o'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_11_forTable_galgasKeyWordList [] = {UNICODE_NEW ('t'), UNICODE_NEW ('a'), UNICODE_NEW ('g'), UNICODE_NEW (0)}; 

static const utf32 kEntry_12_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW ('l'), UNICODE_NEW (0)}; 

static const utf32 kEntry_13_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('a'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_14_forTable_galgasKeyWordList [] = {UNICODE_NEW ('d'), UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('p'), UNICODE_NEW (0)}; 

static const utf32 kEntry_15_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_16_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('u'), UNICODE_NEW ('m'), UNICODE_NEW (0)}; 

static const utf32 kEntry_17_forTable_galgasKeyWordList [] = {UNICODE_NEW ('h'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_18_forTable_galgasKeyWordList [] = {UNICODE_NEW ('l'), UNICODE_NEW ('i'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_19_forTable_galgasKeyWordList [] = {UNICODE_NEW ('l'), UNICODE_NEW ('o'), UNICODE_NEW ('o'), UNICODE_NEW ('p'), UNICODE_NEW (0)}; 

static const utf32 kEntry_20_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW ('c'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_21_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('o'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_22_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('u'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_23_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW ('f'), UNICODE_NEW (0)}; 

static const utf32 kEntry_24_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_25_forTable_galgasKeyWordList [] = {UNICODE_NEW ('t'), UNICODE_NEW ('h'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_26_forTable_galgasKeyWordList [] = {UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('u'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_27_forTable_galgasKeyWordList [] = {UNICODE_NEW ('w'), UNICODE_NEW ('h'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_28_forTable_galgasKeyWordList [] = {UNICODE_NEW ('b'), UNICODE_NEW ('l'), UNICODE_NEW ('o'), UNICODE_NEW ('c'), UNICODE_NEW ('k'), UNICODE_NEW (0)}; 

static const utf32 kEntry_29_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('l'), UNICODE_NEW ('a'), UNICODE_NEW ('s'), UNICODE_NEW ('s'), UNICODE_NEW (0)}; 

static const utf32 kEntry_30_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_31_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW ('s'), UNICODE_NEW ('i'), UNICODE_NEW ('f'), UNICODE_NEW (0)}; 

static const utf32 kEntry_32_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_33_forTable_galgasKeyWordList [] = {UNICODE_NEW ('f'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_34_forTable_galgasKeyWordList [] = {UNICODE_NEW ('l'), UNICODE_NEW ('a'), UNICODE_NEW ('b'), UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW (0)}; 

static const utf32 kEntry_35_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('c'), UNICODE_NEW ('h'), UNICODE_NEW (0)}; 

static const utf32 kEntry_36_forTable_galgasKeyWordList [] = {UNICODE_NEW ('p'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_37_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_38_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('y'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_39_forTable_galgasKeyWordList [] = {UNICODE_NEW ('w'), UNICODE_NEW ('h'), UNICODE_NEW ('i'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_40_forTable_galgasKeyWordList [] = {UNICODE_NEW ('d'), UNICODE_NEW ('o'), UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_41_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('t'), UNICODE_NEW ('y'), UNICODE_NEW (0)}; 

static const utf32 kEntry_42_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('x'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_43_forTable_galgasKeyWordList [] = {UNICODE_NEW ('i'), UNICODE_NEW ('m'), UNICODE_NEW ('p'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_44_forTable_galgasKeyWordList [] = {UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_45_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('e'), UNICODE_NEW ('t'), UNICODE_NEW ('h'), UNICODE_NEW ('o'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_46_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('p'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_47_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('a'), UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_48_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('m'), UNICODE_NEW ('o'), UNICODE_NEW ('v'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_49_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('p'), UNICODE_NEW ('e'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_50_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('w'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_51_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW ('c'), UNICODE_NEW ('h'), UNICODE_NEW (0)}; 

static const utf32 kEntry_52_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_53_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('u'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_54_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('w'), UNICODE_NEW ('i'), UNICODE_NEW ('t'), UNICODE_NEW ('c'), UNICODE_NEW ('h'), UNICODE_NEW (0)}; 

static const utf32 kEntry_55_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('y'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW ('a'), UNICODE_NEW ('x'), UNICODE_NEW (0)}; 

static const utf32 kEntry_56_forTable_galgasKeyWordList [] = {UNICODE_NEW ('u'), UNICODE_NEW ('n'), UNICODE_NEW ('u'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('d'), UNICODE_NEW (0)}; 

static const utf32 kEntry_57_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('o'), UNICODE_NEW ('m'), UNICODE_NEW ('p'), UNICODE_NEW ('i'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_58_forTable_galgasKeyWordList [] = {UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('f'), UNICODE_NEW ('a'), UNICODE_NEW ('u'), UNICODE_NEW ('l'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_59_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('x'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('d'), UNICODE_NEW ('s'), UNICODE_NEW (0)}; 

static const utf32 kEntry_60_forTable_galgasKeyWordList [] = {UNICODE_NEW ('e'), UNICODE_NEW ('x'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_61_forTable_galgasKeyWordList [] = {UNICODE_NEW ('f'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('a'), UNICODE_NEW ('c'), UNICODE_NEW ('h'), UNICODE_NEW (0)}; 

static const utf32 kEntry_62_forTable_galgasKeyWordList [] = {UNICODE_NEW ('g'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('m'), UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_63_forTable_galgasKeyWordList [] = {UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW ('x'), UNICODE_NEW ('i'), UNICODE_NEW ('q'), UNICODE_NEW ('u'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_64_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('e'), UNICODE_NEW ('s'), UNICODE_NEW ('s'), UNICODE_NEW ('a'), UNICODE_NEW ('g'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_65_forTable_galgasKeyWordList [] = {UNICODE_NEW ('p'), UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('g'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('m'), UNICODE_NEW (0)}; 

static const utf32 kEntry_66_forTable_galgasKeyWordList [] = {UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('u'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_67_forTable_galgasKeyWordList [] = {UNICODE_NEW ('w'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW ('n'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('g'), UNICODE_NEW (0)}; 

static const utf32 kEntry_68_forTable_galgasKeyWordList [] = {UNICODE_NEW ('a'), UNICODE_NEW ('b'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_69_forTable_galgasKeyWordList [] = {UNICODE_NEW ('i'), UNICODE_NEW ('m'), UNICODE_NEW ('p'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW ('t'), UNICODE_NEW ('_'), UNICODE_NEW ('_'), UNICODE_NEW (0)}; 

static const utf32 kEntry_70_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('p'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('x'), UNICODE_NEW (0)}; 

static const utf32 kEntry_71_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('o'), UNICODE_NEW ('d'), UNICODE_NEW ('i'), UNICODE_NEW ('f'), UNICODE_NEW ('i'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_72_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('p'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_73_forTable_galgasKeyWordList [] = {UNICODE_NEW ('o'), UNICODE_NEW ('v'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('r'), UNICODE_NEW ('i'), UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_74_forTable_galgasKeyWordList [] = {UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('m'), UNICODE_NEW ('p'), UNICODE_NEW ('l'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW (0)}; 

static const utf32 kEntry_75_forTable_galgasKeyWordList [] = {UNICODE_NEW ('m'), UNICODE_NEW ('e'), UNICODE_NEW ('t'), UNICODE_NEW ('a'), UNICODE_NEW ('m'), UNICODE_NEW ('o'), UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('l'), UNICODE_NEW (0)}; 

static const utf32 kEntry_76_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('c'), UNICODE_NEW ('s'), UNICODE_NEW (0)}; 

static const utf32 kEntry_77_forTable_galgasKeyWordList [] = {UNICODE_NEW ('s'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('d'), UNICODE_NEW ('l'), UNICODE_NEW ('i'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW (0)}; 

static const utf32 kEntry_78_forTable_galgasKeyWordList [] = {UNICODE_NEW ('c'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('u'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_79_forTable_galgasKeyWordList [] = {UNICODE_NEW ('d'), UNICODE_NEW ('e'), UNICODE_NEW ('s'), UNICODE_NEW ('c'), UNICODE_NEW ('r'), UNICODE_NEW ('i'), UNICODE_NEW ('p'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW (0)}; 

static const utf32 kEntry_80_forTable_galgasKeyWordList [] = {UNICODE_NEW ('f'), UNICODE_NEW ('i'), UNICODE_NEW ('l'), UNICODE_NEW ('e'), UNICODE_NEW ('w'), UNICODE_NEW ('r'), UNICODE_NEW ('a'), UNICODE_NEW ('p'), UNICODE_NEW ('p'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW (0)}; 

static const utf32 kEntry_81_forTable_galgasKeyWordList [] = {UNICODE_NEW ('n'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW ('r'), UNICODE_NEW ('m'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW (0)}; 

static const utf32 kEntry_82_forTable_galgasKeyWordList [] = {UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('e'), UNICODE_NEW ('w'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW ('k'), UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('g'), UNICODE_NEW (0)}; 
...
static const utf32 kEntry_0_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('!'), UNICODE_NEW (0)}; 

static const utf32 kEntry_1_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('&'), UNICODE_NEW (0)}; 

static const utf32 kEntry_2_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('('), UNICODE_NEW (0)}; 

static const utf32 kEntry_3_forTable_galgasDelimitorsList [] = {UNICODE_NEW (')'), UNICODE_NEW (0)}; 

static const utf32 kEntry_4_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('*'), UNICODE_NEW (0)}; 

static const utf32 kEntry_5_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('+'), UNICODE_NEW (0)}; 

static const utf32 kEntry_6_forTable_galgasDelimitorsList [] = {UNICODE_NEW (','), UNICODE_NEW (0)}; 

static const utf32 kEntry_7_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('-'), UNICODE_NEW (0)}; 

static const utf32 kEntry_8_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('/'), UNICODE_NEW (0)}; 

static const utf32 kEntry_9_forTable_galgasDelimitorsList [] = {UNICODE_NEW (':'), UNICODE_NEW (0)}; 

static const utf32 kEntry_10_forTable_galgasDelimitorsList [] = {UNICODE_NEW (';'), UNICODE_NEW (0)}; 

static const utf32 kEntry_11_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_12_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('\?'), UNICODE_NEW (0)}; 

static const utf32 kEntry_13_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('['), UNICODE_NEW (0)}; 

static const utf32 kEntry_14_forTable_galgasDelimitorsList [] = {UNICODE_NEW (']'), UNICODE_NEW (0)}; 

static const utf32 kEntry_15_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('^'), UNICODE_NEW (0)}; 

static const utf32 kEntry_16_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('{'), UNICODE_NEW (0)}; 

static const utf32 kEntry_17_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('|'), UNICODE_NEW (0)}; 

static const utf32 kEntry_18_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('}'), UNICODE_NEW (0)}; 

static const utf32 kEntry_19_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('~'), UNICODE_NEW (0)}; 

static const utf32 kEntry_20_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('!'), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_21_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('!'), UNICODE_NEW ('\?'), UNICODE_NEW (0)}; 

static const utf32 kEntry_22_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('+'), UNICODE_NEW ('+'), UNICODE_NEW (0)}; 

static const utf32 kEntry_23_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('+'), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_24_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('+'), UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_25_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('-'), UNICODE_NEW ('-'), UNICODE_NEW (0)}; 

static const utf32 kEntry_26_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('-'), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_27_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('-'), UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_28_forTable_galgasDelimitorsList [] = {UNICODE_NEW (':'), UNICODE_NEW (':'), UNICODE_NEW (0)}; 

static const utf32 kEntry_29_forTable_galgasDelimitorsList [] = {UNICODE_NEW (':'), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_30_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('<'), UNICODE_NEW ('-'), UNICODE_NEW (0)}; 

static const utf32 kEntry_31_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('='), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_32_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('>'), UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_33_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('>'), UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_34_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('\?'), UNICODE_NEW ('!'), UNICODE_NEW (0)}; 

static const utf32 kEntry_35_forTable_galgasDelimitorsList [] = {UNICODE_NEW ('\?'), UNICODE_NEW ('\?'), UNICODE_NEW (0)}; 
...
parseLexicalToken (void) {
  ...
  while ((_token._mTokenCode < 0) && (UNICODE_ACCESS (mCurrentChar) != '\0')) {
    ...
    if ((_mMatchedTemplateDelimiterIndex >= 0) && (UNICODE_ACCESS (mCurrentChar) != '\0')) {
      ...
      try{
        if (testForInputCharRange (UNICODE_NEW ('a'), UNICODE_NEW ('z')) ||
            testForInputCharRange (UNICODE_NEW ('A'), UNICODE_NEW ('Z'))) {
          do {
            ...
            if (testForInputCharRange (UNICODE_NEW ('a'), UNICODE_NEW ('z')) ||
                ...
                testForInputCharRange (UNICODE_NEW ('0'), UNICODE_NEW ('9'))) {
            }else{
              loop_ = false ;
            }
          }while (loop_) ;
          ...
          _enterToken (_token) ;
        }else if (testForInputCharRange (UNICODE_NEW ('0'), UNICODE_NEW ('9'))) {
          scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          do {
            if (testForInputCharRange (UNICODE_NEW ('0'), UNICODE_NEW ('9'))) {
              scanner_action_enterCharacterIntoString (_token.tokenString, previousChar ()) ;
          ...
          do {
            if (testForInputCharRange (UNICODE_NEW (1), UNICODE_NEW ('\t')) ||
                testForInputChar (UNICODE_NEW ('\v')) ||
                testForInputChar (UNICODE_NEW ('\f')) ||
                testForInputCharRange (UNICODE_NEW (14), UNICODE_NEW (255))) {
            }else{
              loop_ = false ;
            }
          }while (loop_) ;
          loop_ = true ;
        }else if (testForInputCharRange (UNICODE_NEW (1), UNICODE_NEW (' '))) {
