...
//                    february 24th, 2010, at 18h37'25"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_lsint * C_Lexique_galgasTemplateScanner::synthetizedAttribute_sint_33__32_value (void) const {
  ...
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_sint * value = GALGAS_sint::constructor_new (ptr->mLexicalAttribute_sint_33__32_value COMMA_HERE) ;
...
GALGAS_lsint_36__34_ * C_Lexique_galgasTemplateScanner::synthetizedAttribute_sint_36__34_value (void) const {
  ...
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_sint_36__34_ * value = GALGAS_sint_36__34_::constructor_new (ptr->mLexicalAttribute_sint_36__34_value COMMA_HERE) ;
...
GALGAS_luint * C_Lexique_galgasTemplateScanner::synthetizedAttribute_uint_33__32_value (void) const {
  ...
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_uint * value = GALGAS_uint::constructor_new (ptr->mLexicalAttribute_uint_33__32_value COMMA_HERE) ;
...
GALGAS_luint_36__34_ * C_Lexique_galgasTemplateScanner::synthetizedAttribute_uint_36__34_value (void) const {
  ...
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_uint_36__34_ * value = GALGAS_uint_36__34_::constructor_new (ptr->mLexicalAttribute_uint_36__34_value COMMA_HERE) ;
