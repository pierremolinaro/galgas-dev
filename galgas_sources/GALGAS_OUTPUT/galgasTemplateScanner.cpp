...
//                    december 20th, 2011, at 17h53'49"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
//--- Syntax error message for terminal '$pragma$' :
static const utf32 gSyntaxErrorMessage_pragma [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Unicode string for '$pragma$'
static const utf32 kUnicodeString_pragma [] = {
  TO_UNICODE ('p'),
  TO_UNICODE ('r'),
  TO_UNICODE ('a'),
  TO_UNICODE ('g'),
...
static const C_unicode_lexique_table_entry ktable_for_galgasKeyWordList [ktable_size_galgasKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_pragma, 6, C_Lexique_galgasTemplateScanner::kToken_pragma),
...
static const bool kEndOfScriptInTemplateArray [146] = {
  false /* identifier */,
  false /* type_name */,
...
GALGAS_stringlist C_Lexique_galgasTemplateScanner::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("pragma") COMMA_THERE) ;
