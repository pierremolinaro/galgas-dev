...
void C_Lexique_galgasTemplateScanner::appendTerminalMessageToSyntaxErrorMessage (const PMSInt16 inTerminalIndex,
  ...
  static const utf32 * syntaxErrorMessageArray [148] = {kEndOfSourceLexicalErrorMessage,
...
static const PMSInt32 ktable_size_galgasKeyWordList = 92 ;
...
static const bool kEndOfScriptInTemplateArray [147] = {
  false /* identifier */,
  false /* type_name */,
...
GALGAS_stringlist C_Lexique_galgasTemplateScanner::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("extract") COMMA_THERE) ;
