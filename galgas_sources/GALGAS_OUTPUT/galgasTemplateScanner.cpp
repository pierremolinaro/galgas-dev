...
GALGASap_lchar C_Lexique_galgasTemplateScanner::synthetizedAttribute_charValue (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_char value (GALGAS_char::constructor_new (ptr->mLexicalAttribute_charValue COMMA_HERE)) ;
  GALGASap_lchar result (GALGAS_lchar::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_ldouble C_Lexique_galgasTemplateScanner::synthetizedAttribute_floatValue (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_double value (GALGAS_double::constructor_new (ptr->mLexicalAttribute_floatValue COMMA_HERE)) ;
  GALGASap_ldouble result (GALGAS_ldouble::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_lstring C_Lexique_galgasTemplateScanner::synthetizedAttribute_identifierString (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_string value (GALGAS_string::constructor_new (ptr->mLexicalAttribute_identifierString COMMA_HERE)) ;
  GALGASap_lstring result (GALGAS_lstring::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_lsint C_Lexique_galgasTemplateScanner::synthetizedAttribute_sint_33__32_value (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_sint value (GALGAS_sint::constructor_new (ptr->mLexicalAttribute_sint_33__32_value COMMA_HERE)) ;
  GALGASap_lsint result (GALGAS_lsint::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_lsint_36__34_ C_Lexique_galgasTemplateScanner::synthetizedAttribute_sint_36__34_value (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_sint_36__34_ value (GALGAS_sint_36__34_::constructor_new (ptr->mLexicalAttribute_sint_36__34_value COMMA_HERE)) ;
  GALGASap_lsint_36__34_ result (GALGAS_lsint_36__34_::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_lstring C_Lexique_galgasTemplateScanner::synthetizedAttribute_tokenString (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_string value (GALGAS_string::constructor_new (ptr->mLexicalAttribute_tokenString COMMA_HERE)) ;
  GALGASap_lstring result (GALGAS_lstring::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}
...
GALGASap_luint C_Lexique_galgasTemplateScanner::synthetizedAttribute_uint_33__32_value (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_uint value (GALGAS_uint::constructor_new (ptr->mLexicalAttribute_uint_33__32_value COMMA_HERE)) ;
  GALGASap_luint result (GALGAS_luint::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GALGASap_luint_36__34_ C_Lexique_galgasTemplateScanner::synthetizedAttribute_uint_36__34_value (void) const {
  cTokenFor_galgasTemplateScanner * ptr = (cTokenFor_galgasTemplateScanner *) mCurrentTokenPtr ;
  macroValidObject (ptr, cTokenFor_galgasTemplateScanner) ;
  GALGASap_location currentLocation (GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE)) ;
  GALGASap_uint_36__34_ value (GALGAS_uint_36__34_::constructor_new (ptr->mLexicalAttribute_uint_36__34_value COMMA_HERE)) ;
  GALGASap_luint_36__34_ result (GALGAS_luint_36__34_::constructor_new (value, currentLocation COMMA_HERE)) ;
  return result ;
}
