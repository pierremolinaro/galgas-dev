...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [138] = {"end of source",
  ...
  if (_p == NULL) {
    ...
    case  galgasTemplateScanner_1__2E_2E_2E:
      s << '$'
        ...
        << '$' ;
      break;
    case  galgasTemplateScanner_1_type_5Fname:
      s << '$'
        << "type_name"
        << '$' ;
    s << ' ' ;
    s.writeCstringConstant (_p->tokenString) ;
      break;
    case  galgasTemplateScanner_1_literal_5Fchar:
      s << '$'
        << "literal_char"
        << '$' ;
    s << ' ' ;
    s.writeCcharConstant (_p->charValue) ;
      break;
    case  galgasTemplateScanner_1_terminal:
      s << '$'
        << "terminal"
        << '$' ;
    s << ' ' ;
    ...
    case  galgasTemplateScanner_1__3C_3C:
      s << '$'
        ...
        << '$' ;
      break;
    case  galgasTemplateScanner_1_non_5Fterminal_5Fsymbol:
      s << '$'
        << "non_terminal_symbol"
        << '$' ;
    s << ' ' ;
    s.writeCstringConstant (_p->tokenString) ;
      break;
    case  galgasTemplateScanner_1_literal_5Fstring:
      s << '$'
        << "literal_string"
        << '$' ;
    s << ' ' ;
    ...
    if ((_mMatchedTemplateDelimiterIndex >= 0) && (mCurrentChar != '\0')) {
      ...
      try{
        if (testForInputChar ('a', 'z') ||
          ...
          _token._mTokenCode = galgasTemplateScanner_1_type_5Fname ;
          _enterToken (_token) ;
        }else if (testForInputChar ('\'')) {
          if (testForInputChar ('\\')) {
          ...
          if (testForInputChar ('\'')) {
            _token._mTokenCode = galgasTemplateScanner_1_literal_5Fchar ;
            _enterToken (_token) ;
          }else{
            lexicalError (gErrorMessage_4 COMMA_LINE_AND_SOURCE_FILE) ;
          }
          ...
          _token._mTokenCode = galgasTemplateScanner_1_terminal ;
          _enterToken (_token) ;
          ...
          if (testForInputChar ('=')) {
            ...
            loop_ = true ;
            if (testForInputChar ('>')) {
              _token._mTokenCode = galgasTemplateScanner_1_non_5Fterminal_5Fsymbol ;
              _enterToken (_token) ;
            }else{
          ...
          loop_ = true ;
          if (testForInputChar ('\"')) {
            _token._mTokenCode = galgasTemplateScanner_1_literal_5Fstring ;
            _enterToken (_token) ;
          }else{
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [138] = {0,
    ...
    9 /* galgasTemplateScanner_1_type_5Fname */,
    7 /* galgasTemplateScanner_1_literal_5Fchar */,
    3 /* galgasTemplateScanner_1_terminal */,
    ...
    4 /* galgasTemplateScanner_1_non_5Fterminal_5Fsymbol */,
    8 /* galgasTemplateScanner_1_literal_5Fstring */,
