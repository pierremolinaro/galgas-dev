...
static const templateDelimiterStruct kTemplateReplacementArray [1] = {
...
//--- Unicode string for '+>'
static const utf32 kUnicodeString__3E__2B_ [] = {
  TO_UNICODE ('+'),
  TO_UNICODE ('>'),
  TO_UNICODE (0)
} ; 
...
//--- Unicode string for '<-'
static const utf32 kUnicodeString__2D__3C_ [] = {
  TO_UNICODE ('<'),
  TO_UNICODE ('-'),
  TO_UNICODE (0)
} ; 
...
static const utf32 kUnicodeString_SL [] = {
  TO_UNICODE ('L'),
  TO_UNICODE ('S'),
  TO_UNICODE (0)
} ; 
  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    while ((mMatchedTemplateDelimiterIndex < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
      ...
      while (replacementIndex >= 0) {
        replacementIndex = findTemplateDelimiterIndex (kTemplateReplacementArray, 1) ;
    ...
    if ((mMatchedTemplateDelimiterIndex >= 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
      ...
      try{
        if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
          ...
          enterToken (token) ;
        }else if (testForInputUTF32String (kUnicodeString__3E__2B_, 2, true)) {
          ...
          enterToken (token) ;
        }else if (testForInputUTF32String (kUnicodeString__2D__3C_, 2, true)) {
