      ...
      try{
        if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) ||
          ...
          if (testForInputUTF32Char (TO_UNICODE ('S')) ||
            ...
            ::scanner_routine_convertDecimalStringIntoSInt (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_sint32value, gLexicalMessage_1, gLexicalMessage_3) ;
            ...
            ::scanner_routine_convertDecimalStringIntoSInt64 (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_sint64value, gLexicalMessage_1, gLexicalMessage_3) ;
            token.mTokenCode = galgasTemplateScanner_1_signed_5F_literal_5F_integer_36__34_ ;
            enterToken (token) ;
          }else if (testForInputUTF32Char (TO_UNICODE ('L'))) {
            ::scanner_routine_convertDecimalStringIntoUInt64 (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_uint64value, gLexicalMessage_1, gLexicalMessage_3) ;
            ...
            mLoop = true ;
            ::scanner_routine_convertStringToDouble (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_floatValue, gLexicalMessage_2) ;
            token.mTokenCode = galgasTemplateScanner_1_literal_5F_double ;
            enterToken (token) ;
          }else{
            ::scanner_routine_convertDecimalStringIntoUInt (*this, token.mLexicalAttribute_tokenString, token.mLexicalAttribute_uint32value, gLexicalMessage_1, gLexicalMessage_3) ;
...
const char * galgasTemplateScanner::getStyleName (const sint32 inIndex) {
  const char * kStylesArray [9] = {"Default style", "Keywords", "Delimiters", "Non Terminal Symbols", "Integer Constants", "Floating Point Constants", "Type Names (@...)", "Comments", NULL} ;
...
const char * galgasTemplateScanner::getStyleIdentifier (const sint32 inIndex) {
  const char * kStylesArray [9] = {"", "keywordsStyle", "delimitersStyle", "nonTerminalStyle", "integerStyle", "float_csts", "typeNameStyle", "commentStyle", NULL} ;
  return (inIndex < 8) ? kStylesArray [inIndex] : NULL ;
} ;
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [141] = {0,
    ...
    6 /* galgasTemplateScanner_1_type_5F_name */,
    ...
    7 /* galgasTemplateScanner_1_comment */
  } ;
