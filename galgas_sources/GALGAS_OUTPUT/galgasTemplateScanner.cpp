...
static const utf32 gLexicalMessage_incorrectVariantNameError [] = {
  TO_UNICODE ('i'),
  TO_UNICODE ('n'),
  TO_UNICODE (' '),
  TO_UNICODE ('a'),
...
//--- Syntax error message for terminal '$variant$' :
static const utf32 gSyntaxErrorMessage_variant [] = {
  TO_UNICODE ('a'),
  TO_UNICODE (' '),
  TO_UNICODE ('v'),
  TO_UNICODE ('a'),
...
//--- Syntax error message for terminal '$reverse$' :
static const utf32 gSyntaxErrorMessage_reverse [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void C_Lexique_galgasTemplateScanner::appendTerminalMessageToSyntaxErrorMessage (const int16_t inTerminalIndex,
                                           C_String & outSyntaxErrorMessage) {
  static const utf32 * syntaxErrorMessageArray [149] = {kEndOfSourceLexicalErrorMessage,
...
//--- Unicode string for '$reverse$'
static const utf32 kUnicodeString_reverse [] = {
  TO_UNICODE ('r'),
  TO_UNICODE ('e'),
  TO_UNICODE ('v'),
  TO_UNICODE ('e'),
...
static const int32_t ktable_size_galgasDelimitorsList = 38 ;
...
static const int32_t ktable_size_galgasKeyWordList = 93 ;
...
static const C_unicode_lexique_table_entry ktable_for_galgasKeyWordList [ktable_size_galgasKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_reverse, 7, C_Lexique_galgasTemplateScanner::kToken_reverse),
...
static const bool kEndOfScriptInTemplateArray [148] = {
  false /* identifier */,
  false /* type_name */,
    ...
    try{
        if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z'))) {
          ...
          if (testForInputUTF32CharRange (TO_UNICODE ('a'), TO_UNICODE ('z')) || testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('Z')) || testForInputUTF32Char (TO_UNICODE ('_')) || testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
            ...
            lexicalError (gLexicalMessage_incorrectVariantNameError COMMA_LINE_AND_SOURCE_FILE) ;
          }
          token.mTokenCode = kToken_variant ;
          enterToken (token) ;
        }else if (testForInputUTF32Char (TO_UNICODE ('\''))) {
          if (testForInputUTF32Char (TO_UNICODE ('\\'))) {
...
GALGAS_stringlist C_Lexique_galgasTemplateScanner::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string (".=") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("...") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("variant") COMMA_THERE) ;
  ...
  result.addAssign_operation (GALGAS_string ("mapproxy") COMMA_THERE) ;
  ...
  result.addAssign_operation (GALGAS_string ("reverse") COMMA_THERE) ;
