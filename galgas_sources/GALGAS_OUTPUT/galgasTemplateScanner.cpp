...
//--- Syntax error message for terminal '$this$' :
static const utf32 gSyntaxErrorMessage_this [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
static const utf32 kUnicodeString_this [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('i'),
  TO_UNICODE ('s'),
...
static const C_unicode_lexique_table_entry ktable_for_galgasKeyWordList [ktable_size_galgasKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_this, 4, C_Lexique_galgasTemplateScanner::kToken_this),
