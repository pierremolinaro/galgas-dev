...
void GALGAS_templateExpressionListAST::modifier_insertAtIndex (const GALGAS_templateExpressionAST inOperand0,
                                                               const GALGAS_location inOperand1,
                                                               const GALGAS_uint inInsertionIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
...
void GALGAS_templateExpressionListAST::modifier_removeAtIndex (GALGAS_templateExpressionAST & outOperand0,
...
void routine_enterTemplateString (GALGAS_templateInstructionListAST & ioArgument_outResultingInstructionList,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_s = GALGAS_string::constructor_retrieveAndResetTemplateString (inCompiler  COMMA_SOURCE_FILE ("templateTypesForAST.gSemantics", 456)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_s.reader_length (SOURCE_FILE ("templateTypesForAST.gSemantics", 457)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_outResultingInstructionList.addAssign_operation (GALGAS_templateInstructionStringAST::constructor_new (var_s  COMMA_SOURCE_FILE ("templateTypesForAST.gSemantics", 458))  COMMA_SOURCE_FILE ("templateTypesForAST.gSemantics", 458)) ;
  }
}
...
GALGAS_templateExpressionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_templateConcatOperationAST) ;
}
...
GALGAS_templateConcatOperationAST GALGAS_templateConcatOperationAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_templateConcatOperationAST *> (p)) {
      ...
      inCompiler->castError ("templateConcatOperationAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_templateExpressionListAST_2D_element::GALGAS_templateExpressionListAST_2D_element (const GALGAS_templateExpressionAST & inOperand0,
                                                                                          const GALGAS_location & inOperand1) :
...
GALGAS_templateExpressionListAST_2D_element GALGAS_templateExpressionListAST_2D_element::constructor_new (const GALGAS_templateExpressionAST & inOperand0,
                                                                                                          const GALGAS_location & inOperand1 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_templateExpressionListAST_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_templateExpressionListAST_2D_element (inOperand0, inOperand1) ;
  }
  return result ;
}
