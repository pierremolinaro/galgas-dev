...
cPtr__AC_galgas_class * cPtr_parseWhenInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseWhenInstruction (mInstructionLocation, mWhenExpression, mEndOfWhenExpression, mWhenInstructionList, mElseInstructionList COMMA_HERE)) ;
  return result ;
}
