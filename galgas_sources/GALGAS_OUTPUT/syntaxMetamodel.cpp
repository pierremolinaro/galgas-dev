...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mWhenExpression.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mParseDoBranchList.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@whenBranchList", inIndentation COMMA_THERE) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@parseWhenInstruction:"
           << mStartLocation.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mWhenBranchList.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
