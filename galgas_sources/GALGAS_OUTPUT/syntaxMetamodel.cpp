...
class cCollectionElement_syntaxInstructionList : public cCollectionElement {
  public : GALGAS_syntaxInstructionList_3A_element mObject ;
...
GALGAS_syntaxInstructionList_3A_element cEnumerator_syntaxInstructionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_nonTerminalLabelListAST : public cCollectionElement {
  public : GALGAS_nonTerminalLabelListAST_3A_element mObject ;
...
GALGAS_nonTerminalLabelListAST_3A_element cEnumerator_nonTerminalLabelListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_nonterminalDeclarationListAST : public cCollectionElement {
  public : GALGAS_nonterminalDeclarationListAST_3A_element mObject ;
...
GALGAS_nonterminalDeclarationListAST_3A_element cEnumerator_nonterminalDeclarationListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_syntaxRuleLabelListAST : public cCollectionElement {
  public : GALGAS_syntaxRuleLabelListAST_3A_element mObject ;
...
GALGAS_syntaxRuleLabelListAST_3A_element cEnumerator_syntaxRuleLabelListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_syntaxRuleListAST : public cCollectionElement {
  public : GALGAS_syntaxRuleListAST_3A_element mObject ;
...
GALGAS_syntaxRuleListAST_3A_element cEnumerator_syntaxRuleListAST::current (LOCATION_ARGS) const {
...
class cCollectionElement_listOfSyntaxInstructionList : public cCollectionElement {
  public : GALGAS_listOfSyntaxInstructionList_3A_element mObject ;
...
GALGAS_listOfSyntaxInstructionList_3A_element cEnumerator_listOfSyntaxInstructionList::current (LOCATION_ARGS) const {
...
GALGAS_syntaxInstructionList_3A_element::GALGAS_syntaxInstructionList_3A_element (void) :
...
GALGAS_syntaxInstructionList_3A_element::GALGAS_syntaxInstructionList_3A_element (const GALGAS_syntaxInstructionAST & inOperand0) :
mAttribute_mInstruction (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_syntaxInstructionList_3A_element & GALGAS_syntaxInstructionList_3A_element::operator = (const GALGAS_syntaxInstructionList_3A_element & inOperand) {
...
GALGAS_syntaxInstructionList_3A_element GALGAS_syntaxInstructionList_3A_element::constructor_new (const GALGAS_syntaxInstructionAST & inOperand0 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_syntaxInstructionList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_syntaxInstructionList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxInstructionList_3A_element::objectCompare (const GALGAS_syntaxInstructionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_syntaxInstructionList_3A_element::isValid (void) const {
  return mAttribute_mInstruction.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_syntaxInstructionList_3A_element::drop (void) {
  mAttribute_mInstruction.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_syntaxInstructionList_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_syntaxInstructionAST GALGAS_syntaxInstructionList_3A_element::reader_mInstruction (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxInstructionList_3A_element ("syntaxInstructionList:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_syntaxInstructionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_syntaxInstructionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_syntaxInstructionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_syntaxInstructionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_syntaxInstructionList_3A_element GALGAS_syntaxInstructionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_syntaxInstructionList_3A_element result ;
  const GALGAS_syntaxInstructionList_3A_element * p = (const GALGAS_syntaxInstructionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxInstructionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "syntaxInstructionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_nonTerminalLabelListAST_3A_element::GALGAS_nonTerminalLabelListAST_3A_element (void) :
...
GALGAS_nonTerminalLabelListAST_3A_element::GALGAS_nonTerminalLabelListAST_3A_element (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_formalParameterListAST & inOperand1,
                                                                                      const GALGAS_location & inOperand2) :
...
/* GALGAS_nonTerminalLabelListAST_3A_element & GALGAS_nonTerminalLabelListAST_3A_element::operator = (const GALGAS_nonTerminalLabelListAST_3A_element & inOperand) {
  mAttribute_mLabelName = inOperand.mAttribute_mLabelName ;
  mAttribute_mFormalArgumentList = inOperand.mAttribute_mFormalArgumentList ;
...
GALGAS_nonTerminalLabelListAST_3A_element GALGAS_nonTerminalLabelListAST_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                      const GALGAS_formalParameterListAST & inOperand1,
                                                                                                      const GALGAS_location & inOperand2 
                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonTerminalLabelListAST_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_nonTerminalLabelListAST_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonTerminalLabelListAST_3A_element::objectCompare (const GALGAS_nonTerminalLabelListAST_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_nonTerminalLabelListAST_3A_element::isValid (void) const {
  return mAttribute_mLabelName.isValid () && mAttribute_mFormalArgumentList.isValid () && mAttribute_mEndOfArgumentLocation.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_nonTerminalLabelListAST_3A_element::drop (void) {
...
void GALGAS_nonTerminalLabelListAST_3A_element::description (C_String & ioString,
                                                             const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_nonTerminalLabelListAST_3A_element::reader_mLabelName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLabelName ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListAST GALGAS_nonTerminalLabelListAST_3A_element::reader_mFormalArgumentList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFormalArgumentList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_nonTerminalLabelListAST_3A_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonTerminalLabelListAST_3A_element ("nonTerminalLabelListAST:element",
                                                           NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_nonTerminalLabelListAST_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_nonTerminalLabelListAST_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_nonTerminalLabelListAST_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_nonTerminalLabelListAST_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_nonTerminalLabelListAST_3A_element GALGAS_nonTerminalLabelListAST_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                    C_Compiler * inCompiler,
                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_nonTerminalLabelListAST_3A_element result ;
  const GALGAS_nonTerminalLabelListAST_3A_element * p = (const GALGAS_nonTerminalLabelListAST_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonTerminalLabelListAST_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "nonTerminalLabelListAST:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_nonterminalDeclarationListAST_3A_element::GALGAS_nonterminalDeclarationListAST_3A_element (void) :
...
GALGAS_nonterminalDeclarationListAST_3A_element::GALGAS_nonterminalDeclarationListAST_3A_element (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_nonTerminalLabelListAST & inOperand1) :
...
/* GALGAS_nonterminalDeclarationListAST_3A_element & GALGAS_nonterminalDeclarationListAST_3A_element::operator = (const GALGAS_nonterminalDeclarationListAST_3A_element & inOperand) {
...
GALGAS_nonterminalDeclarationListAST_3A_element GALGAS_nonterminalDeclarationListAST_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                                  const GALGAS_nonTerminalLabelListAST & inOperand1 
                                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonterminalDeclarationListAST_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_nonterminalDeclarationListAST_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonterminalDeclarationListAST_3A_element::objectCompare (const GALGAS_nonterminalDeclarationListAST_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_nonterminalDeclarationListAST_3A_element::isValid (void) const {
  return mAttribute_mNonterminalName.isValid () && mAttribute_mLabels.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_nonterminalDeclarationListAST_3A_element::drop (void) {
...
void GALGAS_nonterminalDeclarationListAST_3A_element::description (C_String & ioString,
                                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_nonterminalDeclarationListAST_3A_element::reader_mNonterminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNonterminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_nonTerminalLabelListAST GALGAS_nonterminalDeclarationListAST_3A_element::reader_mLabels (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonterminalDeclarationListAST_3A_element ("nonterminalDeclarationListAST:element",
                                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_nonterminalDeclarationListAST_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_nonterminalDeclarationListAST_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_nonterminalDeclarationListAST_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_nonterminalDeclarationListAST_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_nonterminalDeclarationListAST_3A_element GALGAS_nonterminalDeclarationListAST_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                C_Compiler * inCompiler,
                                                                                                                const GALGAS_location & inErrorLocation
                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_nonterminalDeclarationListAST_3A_element result ;
  const GALGAS_nonterminalDeclarationListAST_3A_element * p = (const GALGAS_nonterminalDeclarationListAST_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonterminalDeclarationListAST_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "nonterminalDeclarationListAST:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_syntaxRuleLabelListAST_3A_element::GALGAS_syntaxRuleLabelListAST_3A_element (void) :
mAttribute_mLabelName (),
...
GALGAS_syntaxRuleLabelListAST_3A_element::GALGAS_syntaxRuleLabelListAST_3A_element (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_formalParameterListAST & inOperand1,
                                                                                    const GALGAS_location & inOperand2,
                                                                                    const GALGAS_syntaxInstructionList & inOperand3,
                                                                                    const GALGAS_location & inOperand4) :
...
/* GALGAS_syntaxRuleLabelListAST_3A_element & GALGAS_syntaxRuleLabelListAST_3A_element::operator = (const GALGAS_syntaxRuleLabelListAST_3A_element & inOperand) {
  mAttribute_mLabelName = inOperand.mAttribute_mLabelName ;
  mAttribute_mFormalArguments = inOperand.mAttribute_mFormalArguments ;
  mAttribute_mEndOfArgumentLocation = inOperand.mAttribute_mEndOfArgumentLocation ;
  mAttribute_mSyntaxInstructionList = inOperand.mAttribute_mSyntaxInstructionList ;
...
GALGAS_syntaxRuleLabelListAST_3A_element GALGAS_syntaxRuleLabelListAST_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                    const GALGAS_formalParameterListAST & inOperand1,
                                                                                                    const GALGAS_location & inOperand2,
                                                                                                    const GALGAS_syntaxInstructionList & inOperand3,
                                                                                                    const GALGAS_location & inOperand4 
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_syntaxRuleLabelListAST_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_syntaxRuleLabelListAST_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxRuleLabelListAST_3A_element::objectCompare (const GALGAS_syntaxRuleLabelListAST_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mLabelName.objectCompare (inOperand.mAttribute_mLabelName) ;
  }
...
bool GALGAS_syntaxRuleLabelListAST_3A_element::isValid (void) const {
...
void GALGAS_syntaxRuleLabelListAST_3A_element::drop (void) {
  mAttribute_mLabelName.drop () ;
...
void GALGAS_syntaxRuleLabelListAST_3A_element::description (C_String & ioString,
                                                            const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_syntaxRuleLabelListAST_3A_element::reader_mLabelName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLabelName ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListAST GALGAS_syntaxRuleLabelListAST_3A_element::reader_mFormalArguments (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFormalArguments ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_syntaxRuleLabelListAST_3A_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfArgumentLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxInstructionList GALGAS_syntaxRuleLabelListAST_3A_element::reader_mSyntaxInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSyntaxInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_syntaxRuleLabelListAST_3A_element::reader_mEndOfInstructionList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxRuleLabelListAST_3A_element ("syntaxRuleLabelListAST:element",
                                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_syntaxRuleLabelListAST_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_syntaxRuleLabelListAST_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_syntaxRuleLabelListAST_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_syntaxRuleLabelListAST_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_syntaxRuleLabelListAST_3A_element GALGAS_syntaxRuleLabelListAST_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                  C_Compiler * inCompiler,
                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_syntaxRuleLabelListAST_3A_element result ;
  const GALGAS_syntaxRuleLabelListAST_3A_element * p = (const GALGAS_syntaxRuleLabelListAST_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxRuleLabelListAST_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "syntaxRuleLabelListAST:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_syntaxRuleListAST_3A_element::GALGAS_syntaxRuleListAST_3A_element (void) :
mAttribute_mNonterminalName (),
...
GALGAS_syntaxRuleListAST_3A_element::GALGAS_syntaxRuleListAST_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_syntaxRuleLabelListAST & inOperand1) :
mAttribute_mNonterminalName (inOperand0),
...
/* GALGAS_syntaxRuleListAST_3A_element & GALGAS_syntaxRuleListAST_3A_element::operator = (const GALGAS_syntaxRuleListAST_3A_element & inOperand) {
  mAttribute_mNonterminalName = inOperand.mAttribute_mNonterminalName ;
  mAttribute_mLabelList = inOperand.mAttribute_mLabelList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_syntaxRuleListAST_3A_element GALGAS_syntaxRuleListAST_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_syntaxRuleLabelListAST & inOperand1 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_syntaxRuleListAST_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_syntaxRuleListAST_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxRuleListAST_3A_element::objectCompare (const GALGAS_syntaxRuleListAST_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mNonterminalName.objectCompare (inOperand.mAttribute_mNonterminalName) ;
  }
...
bool GALGAS_syntaxRuleListAST_3A_element::isValid (void) const {
  return mAttribute_mNonterminalName.isValid () && mAttribute_mLabelList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_syntaxRuleListAST_3A_element::drop (void) {
  mAttribute_mNonterminalName.drop () ;
...
void GALGAS_syntaxRuleListAST_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_syntaxRuleListAST_3A_element::reader_mNonterminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNonterminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxRuleLabelListAST GALGAS_syntaxRuleListAST_3A_element::reader_mLabelList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxRuleListAST_3A_element ("syntaxRuleListAST:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_syntaxRuleListAST_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_syntaxRuleListAST_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_syntaxRuleListAST_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_syntaxRuleListAST_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_syntaxRuleListAST_3A_element GALGAS_syntaxRuleListAST_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_syntaxRuleListAST_3A_element result ;
  const GALGAS_syntaxRuleListAST_3A_element * p = (const GALGAS_syntaxRuleListAST_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxRuleListAST_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "syntaxRuleListAST:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_listOfSyntaxInstructionList_3A_element::GALGAS_listOfSyntaxInstructionList_3A_element (void) :
mAttribute_mSyntaxInstructionList (),
...
GALGAS_listOfSyntaxInstructionList_3A_element::GALGAS_listOfSyntaxInstructionList_3A_element (const GALGAS_syntaxInstructionList & inOperand0,
                                                                                              const GALGAS_location & inOperand1) :
...
/* GALGAS_listOfSyntaxInstructionList_3A_element & GALGAS_listOfSyntaxInstructionList_3A_element::operator = (const GALGAS_listOfSyntaxInstructionList_3A_element & inOperand) {
  mAttribute_mSyntaxInstructionList = inOperand.mAttribute_mSyntaxInstructionList ;
  mAttribute_mEndOf_5F_instructions = inOperand.mAttribute_mEndOf_5F_instructions ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_listOfSyntaxInstructionList_3A_element GALGAS_listOfSyntaxInstructionList_3A_element::constructor_new (const GALGAS_syntaxInstructionList & inOperand0,
                                                                                                              const GALGAS_location & inOperand1 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_listOfSyntaxInstructionList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_listOfSyntaxInstructionList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_listOfSyntaxInstructionList_3A_element::objectCompare (const GALGAS_listOfSyntaxInstructionList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mSyntaxInstructionList.objectCompare (inOperand.mAttribute_mSyntaxInstructionList) ;
  }
...
bool GALGAS_listOfSyntaxInstructionList_3A_element::isValid (void) const {
  return mAttribute_mSyntaxInstructionList.isValid () && mAttribute_mEndOf_5F_instructions.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_listOfSyntaxInstructionList_3A_element::drop (void) {
  mAttribute_mSyntaxInstructionList.drop () ;
...
void GALGAS_listOfSyntaxInstructionList_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_syntaxInstructionList GALGAS_listOfSyntaxInstructionList_3A_element::reader_mSyntaxInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSyntaxInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_listOfSyntaxInstructionList_3A_element::reader_mEndOf_5F_instructions (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_listOfSyntaxInstructionList_3A_element ("listOfSyntaxInstructionList:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_listOfSyntaxInstructionList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_listOfSyntaxInstructionList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_listOfSyntaxInstructionList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_listOfSyntaxInstructionList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_listOfSyntaxInstructionList_3A_element GALGAS_listOfSyntaxInstructionList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_listOfSyntaxInstructionList_3A_element result ;
  const GALGAS_listOfSyntaxInstructionList_3A_element * p = (const GALGAS_listOfSyntaxInstructionList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_listOfSyntaxInstructionList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "listOfSyntaxInstructionList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
