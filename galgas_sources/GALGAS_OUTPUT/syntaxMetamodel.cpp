...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mSyntaxComponentName ;
    _out_1 = _p->mNonterminalDeclarations ;
    _out_2 = _p->mRules ;
  }else{
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_nonterminalDeclaration (mNonterminalName, mFormalParameters, mReturnedEntityName COMMA_HERE)) ;
  return _p ;
}
...
GGS_formalParameters  GGS_nonterminalDeclaration::
reader_mFormalParameters (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_nonterminalDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_nonterminalDeclaration *) mPointer)->mFormalParameters ;
  }
  return result ;
}
...
reader_mReturnedEntityName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_nonterminalDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_nonterminalDeclaration *) mPointer)->mReturnedEntityName ;
  }
  return result ;
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_syntaxRule (mNonterminalName, mFormalParameters, mReturnedEntityName, mReturnedVariableName, mSyntaxInstructionList COMMA_HERE)) ;
  return _p ;
}
...
GGS_formalParameters  GGS_syntaxRule::
reader_mFormalParameters (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_formalParameters   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_syntaxRule *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_syntaxRule *) mPointer)->mFormalParameters ;
  }
  return result ;
}
...
reader_mReturnedEntityName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_syntaxRule *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_syntaxRule *) mPointer)->mReturnedEntityName ;
  }
  return result ;
}
...
reader_mReturnedVariableName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_syntaxRule *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_syntaxRule *) mPointer)->mReturnedVariableName ;
  }
  return result ;
}
...
GGS_syntaxInstructions  GGS_syntaxRule::
reader_mSyntaxInstructionList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_syntaxRule *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_syntaxRule *) mPointer)->mSyntaxInstructionList ;
  }
  return result ;
}
...
mReturnedValueTargetVariableName (argument_2),
mReturnedValueIsAssigned (argument_3) {
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_nonterminalCallInstruction (mNonterminalName, mActualParameterList, mReturnedValueTargetVariableName, mReturnedValueIsAssigned COMMA_HERE)) ;
  return _p ;
}
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_lstring  p_2 = p->mReturnedValueTargetVariableName ;
          GGS_bool p_3 = p->mReturnedValueIsAssigned ;
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_2 = _p->mReturnedValueTargetVariableName ;
    _out_3 = _p->mReturnedValueIsAssigned ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mTerminalName ;
    _out_1 = _p->mReturnedValueTargetVariableNames ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_repeatInstructionList::
_addAssign_operation (const GGS_syntaxInstructions & argument_0,
                                const GGS_syntaxInstructionsList & argument_1) {
  if (_isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (argument_0,
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mRepeatedInstructionList ;
    _out_1 = _p->mRepeatBranchList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_selectInstructionList::
_addAssign_operation (const GGS_syntaxInstructionsList & argument_0) {
  if (_isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (argument_0) ;
  }
