...
GALGAS_syntaxComponentAST GALGAS_syntaxComponentAST::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_syntaxComponentAST (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7) ;
  }
  return result ;
}
...
bool GALGAS_syntaxComponentAST::isValid (void) const {
  return mAttribute_mSyntaxComponentName.isValid () && mAttribute_mImportedLexiqueFilePath.isValid () && mAttribute_mImportedComponentFileNameList.isValid () && mAttribute_mNonterminalDeclarationList.isValid () && mAttribute_mRuleList.isValid () && mAttribute_mSemanticDeclarationList.isValid () && mAttribute_mEndOfSourceFile.isValid () && mAttribute_mHasTranslateFeature.isValid () ;
}
...
GALGAS_bool GALGAS_syntaxComponentAST::reader_mHasTranslateFeature (UNUSED_LOCATION_ARGS) const {
...
GALGAS_syntaxComponentAST GALGAS_syntaxComponentAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxComponentAST *> (p)) {
      ...
      inCompiler->castError ("syntaxComponentAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
