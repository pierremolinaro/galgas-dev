...
GALGAS_nonterminalCallInstruction GALGAS_nonterminalCallInstruction::constructor_default (LOCATION_ARGS) {
  return GALGAS_nonterminalCallInstruction::constructor_new (GALGAS_location::constructor_nowhere (HERE),
...
GALGAS_terminalCheckInstruction GALGAS_terminalCheckInstruction::constructor_default (LOCATION_ARGS) {
  return GALGAS_terminalCheckInstruction::constructor_new (GALGAS_location::constructor_nowhere (HERE),
                                                           GALGAS_lstring::constructor_default (HERE),
                                                           GALGAS_actualInputParameterListAST::constructor_emptyList (HERE),
...
GALGAS_syntaxComponentAST GALGAS_syntaxComponentAST::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_syntaxComponentAST (GALGAS_lstring::constructor_default (HERE),
                                    GALGAS_lstring::constructor_default (HERE),
                                    GALGAS_lstringlist::constructor_emptyList (HERE),
...
GALGAS_syntaxInstructionList_2E_element GALGAS_syntaxInstructionList_2E_element::constructor_new (const GALGAS_syntaxInstructionAST & inOperand0 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_syntaxInstructionList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_syntaxInstructionList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxInstructionList_2E_element::objectCompare (const GALGAS_syntaxInstructionList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
GALGAS_syntaxInstructionAST GALGAS_syntaxInstructionList_2E_element::reader_mInstruction (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxInstructionList_2E_element ("syntaxInstructionList.element",
                                                         NULL) ;
...
GALGAS_syntaxInstructionList_2E_element GALGAS_syntaxInstructionList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxInstructionList_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_nonTerminalLabelListAST_2E_element GALGAS_nonTerminalLabelListAST_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_nonTerminalLabelListAST_2E_element (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_nonTerminalLabelListAST_2E_element GALGAS_nonTerminalLabelListAST_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                      const GALGAS_formalParameterListAST & inOperand1,
                                                                                                      const GALGAS_location & inOperand2 
                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonTerminalLabelListAST_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_nonTerminalLabelListAST_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonTerminalLabelListAST_2E_element::objectCompare (const GALGAS_nonTerminalLabelListAST_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
GALGAS_lstring GALGAS_nonTerminalLabelListAST_2E_element::reader_mLabelName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLabelName ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListAST GALGAS_nonTerminalLabelListAST_2E_element::reader_mFormalArgumentList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFormalArgumentList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_nonTerminalLabelListAST_2E_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonTerminalLabelListAST_2E_element ("nonTerminalLabelListAST.element",
                                                           NULL) ;
...
GALGAS_nonTerminalLabelListAST_2E_element GALGAS_nonTerminalLabelListAST_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonTerminalLabelListAST_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_nonterminalDeclarationListAST_2E_element GALGAS_nonterminalDeclarationListAST_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_nonterminalDeclarationListAST_2E_element (GALGAS_lstring::constructor_default (HERE),
                                                          GALGAS_nonTerminalLabelListAST::constructor_emptyList (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_nonterminalDeclarationListAST_2E_element GALGAS_nonterminalDeclarationListAST_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                                  const GALGAS_nonTerminalLabelListAST & inOperand1 
                                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_nonterminalDeclarationListAST_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_nonterminalDeclarationListAST_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_nonterminalDeclarationListAST_2E_element::objectCompare (const GALGAS_nonterminalDeclarationListAST_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
GALGAS_lstring GALGAS_nonterminalDeclarationListAST_2E_element::reader_mNonterminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNonterminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_nonTerminalLabelListAST GALGAS_nonterminalDeclarationListAST_2E_element::reader_mLabels (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_nonterminalDeclarationListAST_2E_element ("nonterminalDeclarationListAST.element",
                                                                 NULL) ;
...
GALGAS_nonterminalDeclarationListAST_2E_element GALGAS_nonterminalDeclarationListAST_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_nonterminalDeclarationListAST_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_syntaxRuleLabelListAST_2E_element GALGAS_syntaxRuleLabelListAST_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_syntaxRuleLabelListAST_2E_element (GALGAS_lstring::constructor_default (HERE),
                                                   GALGAS_formalParameterListAST::constructor_emptyList (HERE),
                                                   GALGAS_location::constructor_nowhere (HERE),
                                                   GALGAS_syntaxInstructionList::constructor_emptyList (HERE),
                                                   GALGAS_location::constructor_nowhere (HERE)) ;
...
GALGAS_syntaxRuleLabelListAST_2E_element GALGAS_syntaxRuleLabelListAST_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                    const GALGAS_formalParameterListAST & inOperand1,
                                                                                                    const GALGAS_location & inOperand2,
                                                                                                    const GALGAS_syntaxInstructionList & inOperand3,
                                                                                                    const GALGAS_location & inOperand4 
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_syntaxRuleLabelListAST_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxRuleLabelListAST_2E_element::objectCompare (const GALGAS_syntaxRuleLabelListAST_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mLabelName.objectCompare (inOperand.mAttribute_mLabelName) ;
  }
...
GALGAS_lstring GALGAS_syntaxRuleLabelListAST_2E_element::reader_mLabelName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLabelName ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterListAST GALGAS_syntaxRuleLabelListAST_2E_element::reader_mFormalArguments (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFormalArguments ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_syntaxRuleLabelListAST_2E_element::reader_mEndOfArgumentLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfArgumentLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxInstructionList GALGAS_syntaxRuleLabelListAST_2E_element::reader_mSyntaxInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSyntaxInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_syntaxRuleLabelListAST_2E_element::reader_mEndOfInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfInstructionList ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxRuleLabelListAST_2E_element ("syntaxRuleLabelListAST.element",
                                                          NULL) ;
...
GALGAS_syntaxRuleLabelListAST_2E_element GALGAS_syntaxRuleLabelListAST_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxRuleLabelListAST_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_syntaxRuleListAST_2E_element GALGAS_syntaxRuleListAST_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_syntaxRuleListAST_2E_element (GALGAS_lstring::constructor_default (HERE),
                                              GALGAS_syntaxRuleLabelListAST::constructor_emptyList (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxRuleListAST_2E_element GALGAS_syntaxRuleListAST_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_syntaxRuleLabelListAST & inOperand1 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_syntaxRuleListAST_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_syntaxRuleListAST_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_syntaxRuleListAST_2E_element::objectCompare (const GALGAS_syntaxRuleListAST_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mNonterminalName.objectCompare (inOperand.mAttribute_mNonterminalName) ;
  }
...
GALGAS_lstring GALGAS_syntaxRuleListAST_2E_element::reader_mNonterminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNonterminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_syntaxRuleLabelListAST GALGAS_syntaxRuleListAST_2E_element::reader_mLabelList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_syntaxRuleListAST_2E_element ("syntaxRuleListAST.element",
                                                     NULL) ;
...
GALGAS_syntaxRuleListAST_2E_element GALGAS_syntaxRuleListAST_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_syntaxRuleListAST_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_listOfSyntaxInstructionList_2E_element GALGAS_listOfSyntaxInstructionList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_listOfSyntaxInstructionList_2E_element (GALGAS_syntaxInstructionList::constructor_emptyList (HERE),
                                                        GALGAS_location::constructor_nowhere (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_listOfSyntaxInstructionList_2E_element GALGAS_listOfSyntaxInstructionList_2E_element::constructor_new (const GALGAS_syntaxInstructionList & inOperand0,
                                                                                                              const GALGAS_location & inOperand1 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_listOfSyntaxInstructionList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_listOfSyntaxInstructionList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_listOfSyntaxInstructionList_2E_element::objectCompare (const GALGAS_listOfSyntaxInstructionList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mSyntaxInstructionList.objectCompare (inOperand.mAttribute_mSyntaxInstructionList) ;
  }
...
GALGAS_syntaxInstructionList GALGAS_listOfSyntaxInstructionList_2E_element::reader_mSyntaxInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSyntaxInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_listOfSyntaxInstructionList_2E_element::reader_mEndOf_5F_instructions (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_listOfSyntaxInstructionList_2E_element ("listOfSyntaxInstructionList.element",
                                                               NULL) ;
...
GALGAS_listOfSyntaxInstructionList_2E_element GALGAS_listOfSyntaxInstructionList_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_listOfSyntaxInstructionList_2E_element *> (p)) {
      result = *p ;
    }else{
