...
GGS_syntaxInstructionList::GGS_syntaxInstructionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_nonTerminalLabelList::GGS_nonTerminalLabelList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_nonterminalDeclarationList::GGS_nonterminalDeclarationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_syntaxRuleLabelList::GGS_syntaxRuleLabelList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_syntaxRuleList::GGS_syntaxRuleList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_listOfSyntaxInstructionList::GGS_listOfSyntaxInstructionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
