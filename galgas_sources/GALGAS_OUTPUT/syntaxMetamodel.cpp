      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_formalParameterListAST  p_1 = p->mFormalParameters ;
...
GGS_formalParameterListAST  GGS_nonTerminalLabelList::
...
/* const */ GGS_formalParameterListAST  & GGS_nonTerminalLabelList::cEnumerator::_mFormalParameters (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_formalParameterListAST  GGS_syntaxRuleLabelList::
reader_mFormalParametersAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_formalParameterListAST  result ;
  if (isBuilt () && inIndex.isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
...
/* const */ GGS_formalParameterListAST  & GGS_syntaxRuleLabelList::cEnumerator::_mFormalParameters (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mFormalParameters ;
}
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_semanticExpressionAST  p_0 = p->mWhenExpression ;
...
GGS_semanticExpressionAST  GGS_whenBranchList::
...
/* const */ GGS_semanticExpressionAST  & GGS_whenBranchList::cEnumerator::_mWhenExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_semanticDeclarationStructAST GGS_syntaxComponentRoot::
