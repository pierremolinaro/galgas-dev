...
internalSubListWithRange (GGS_nonTerminalLabelList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mLabelName, ptr->mFormalArgumentList) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
/* const */ GGS_formalParameterListAST  & GGS_nonTerminalLabelList::cEnumerator::_mFormalArgumentList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
