...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_nonterminalCallInstruction) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_terminalCheckInstruction) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_repeatInstruction) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_selectInstruction) ;
...
cPtr_parseRewindInstruction::
cPtr_parseRewindInstruction (const GGS_location & argument_0,
                                const GGS_listOfSyntaxInstructionList & argument_1,
                                const GGS_location & argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_syntaxInstructionAST (argument_0 COMMA_THERE),
mParseRewindBranchList (argument_1),
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_parseRewindInstruction * GGS_parseRewindInstruction::
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_parseRewindInstruction) ;
...
bool cPtr_parseRewindInstruction::
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_parseRewindInstruction * ptr = dynamic_cast <const cPtr_parseRewindInstruction *> (inOperand) ;
    macroValidPointer (ptr) ;
    equal = mInstructionLocation.operator_isEqual (ptr->mInstructionLocation).boolValue ()
         && mParseRewindBranchList.operator_isEqual (ptr->mParseRewindBranchList).boolValue ()
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@parseRewindInstruction:"
           << mInstructionLocation.reader_description (inIndentation + 1)
           << mParseRewindBranchList.reader_description (inIndentation + 1)
...
const char * cPtr_parseRewindInstruction::
instanceMessage (void) const {
  return "" ;
}
...
C_galgas_class_inspector _gInspectorFor_parseRewindInstruction (& typeid (cPtr_parseRewindInstruction), & typeid (cPtr_syntaxInstructionAST), "") ;

//---------------------------------------------------------------------------*

AC_galgasClassRunTimeInformationEX * cPtr_parseRewindInstruction::galgasRTTI (void) const {
  return & gClassInfoFor__parseRewindInstruction ;
}

//---------------------------------------------------------------------------*

cPtr__AC_galgas_class * cPtr_parseRewindInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseRewindInstruction (mInstructionLocation, mParseRewindBranchList, mEndOfParseDoInstruction COMMA_HERE)) ;
  return result ;
}
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_parseRewindInstruction ("parseRewindInstruction", true, & kTypeDescriptor_GGS_syntaxInstructionAST) ;

//---------------------------------------------------------------------------*

GGS_parseRewindInstruction::
GGS_parseRewindInstruction (const cPtr__AC_galgas_class * inPointer) {
  macroAssignSharedObject (mPointer, (cPtr__AC_galgas_class *) inPointer) ;
}
...
GGS_parseRewindInstruction::
GGS_parseRewindInstruction (cPtr__AC_galgas_class & inObject) {
  macroAssignSharedObject (mPointer, & inObject) ;
}
...
castFrom (C_CompilerEx & inLexique,
  ...
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
      ? (dynamic_cast <cPtr_parseRewindInstruction *> (inPointer) != NULL)
      : (typeid (cPtr_parseRewindInstruction) == typeid (*inPointer)) ;
    if (ok) {
      result = GGS_parseRewindInstruction (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
                                       & typeid (cPtr_parseRewindInstruction),
                                       inUseKindOfClass,
                                       inPointer->instanceMessage ()
                                       COMMA_THERE) ;
    }
...
constructor_new (C_CompilerEx & /* inLexique */,
                 ...
                 const GGS_location & argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_parseRewindInstruction result ;
  macroMyNew (result.mPointer, cPtr_parseRewindInstruction (argument_0,
                                argument_1,
                                argument_2 COMMA_THERE)) ;
  return result ;
}
...
reader_mParseRewindBranchList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_parseRewindInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_parseRewindInstruction *) mPointer)->mParseRewindBranchList ;
  }
  return result ;
}
...
reader_mEndOfParseDoInstruction (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_parseRewindInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_parseRewindInstruction *) mPointer)->mEndOfParseDoInstruction ;
  }
  return result ;
}
...
const char * GGS_parseRewindInstruction::actualTypeName (void) const {
  return "parseRewindInstruction" ;
}

//---------------------------------------------------------------------------*

C_galgasClassRunTimeInformationEX gClassInfoFor__parseRewindInstruction ("parseRewindInstruction", gClassInfoFor__syntaxInstructionAST, & kTypeDescriptor_GGS_parseRewindInstruction) ;

//---------------------------------------------------------------------------*

GGS_object GGS_parseRewindInstruction::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_parseRewindInstruction * p = NULL ;
    macroMyNew (p, GGS_parseRewindInstruction (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_parseRewindInstruction GGS_parseRewindInstruction::castFromObject (C_CompilerEx & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_parseRewindInstruction * p = dynamic_cast <const GGS_parseRewindInstruction *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_parseRewindInstruction, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_parseRewindInstruction::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_parseRewindInstruction ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_parseLoopInstruction) ;
...
mEndOfWhenInstructionList (argument_4),
mElseInstructionList (argument_5),
mEndOfElseInstructionList (argument_6) {
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_parseWhenInstruction) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mInstructionLocation.operator_isEqual (ptr->mInstructionLocation).boolValue ()
         ...
         && mEndOfWhenInstructionList.operator_isEqual (ptr->mEndOfWhenInstructionList).boolValue ()
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@parseWhenInstruction:"
           ...
           << mEndOfWhenInstructionList.reader_description (inIndentation + 1)
...
cPtr__AC_galgas_class * cPtr_parseWhenInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseWhenInstruction (mInstructionLocation, mWhenExpression, mEndOfWhenExpression, mWhenInstructionList, mEndOfWhenInstructionList, mElseInstructionList, mEndOfElseInstructionList COMMA_HERE)) ;
  return result ;
}
...
reader_mEndOfWhenInstructionList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_parseWhenInstruction *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_parseWhenInstruction *) mPointer)->mEndOfWhenInstructionList ;
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidSharedObjectThere (mPointer, cPtr_blockInstruction) ;
...
constructor_new (const GGS_lstring & argument_0,
  ...
  result.mSemanticDeclarationList = argument_5 ;
