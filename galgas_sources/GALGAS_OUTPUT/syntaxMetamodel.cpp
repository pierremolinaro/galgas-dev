...
typeComparisonResult GALGAS_terminalCheckInstruction::objectCompare (const GALGAS_terminalCheckInstruction & inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = p->mAttribute_mIndexingKey.objectCompare (q->mAttribute_mIndexingKey) ;
  }
  return result ;
}
...
GALGAS_terminalCheckInstruction GALGAS_terminalCheckInstruction::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                                  ...
                                                                                  const GALGAS_lstring & inAttribute_mIndexingKey
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_terminalCheckInstruction result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mTerminalName.isValid () && inAttribute_mActualInputParameterList.isValid () && inAttribute_mIndexingKey.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_terminalCheckInstruction (inAttribute_mInstructionLocation, inAttribute_mTerminalName, inAttribute_mActualInputParameterList, inAttribute_mIndexingKey COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_terminalCheckInstruction::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_terminalCheckInstruction (p->mAttribute_mInstructionLocation, p->mAttribute_mTerminalName, p->mAttribute_mActualInputParameterList, p->mAttribute_mIndexingKey COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
GALGAS_lstring GALGAS_terminalCheckInstruction::reader_mIndexingKey (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_terminalCheckInstruction * p = (const cPtr_terminalCheckInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_terminalCheckInstruction) ;
    result = p->mAttribute_mIndexingKey ;
  }
  return result ;
}
...
mAttribute_mIndexingKey (in_mIndexingKey) {
}
...
void cPtr_terminalCheckInstruction::description (C_String & ioString,
  ...
  ioString << ", " ;
  mAttribute_mIndexingKey.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
