...
cCollectionElement_syntaxInstructionList * GALGAS_syntaxInstructionList::makeElement (const GALGAS_syntaxInstructionAST & in_mInstruction
                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxInstructionList * result = NULL ;
  macroMyNew (result, cCollectionElement_syntaxInstructionList (in_mInstruction COMMA_THERE)) ;
  return result ;
}
...
GALGAS_syntaxInstructionList GALGAS_syntaxInstructionList::reader_subListWithRange (const GALGAS_uint & inIndex,
...
void GALGAS_syntaxInstructionList::modifier_setMInstructionAtIndex (GALGAS_syntaxInstructionAST inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxInstructionList * p = (cCollectionElement_syntaxInstructionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxInstructionList) ;
...
GALGAS_syntaxInstructionAST GALGAS_syntaxInstructionList::reader_mInstructionAtIndex (const GALGAS_uint & inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
...
cCollectionElement_nonTerminalLabelListAST * GALGAS_nonTerminalLabelListAST::makeElement (const GALGAS_lstring & in_mLabelName,
                                                                                          const GALGAS_formalParameterListAST & in_mFormalArgumentList,
                                                                                          const GALGAS_location & in_mEndOfArgumentLocation
                                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_nonTerminalLabelListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_nonTerminalLabelListAST (in_mLabelName,
...
GALGAS_nonTerminalLabelListAST GALGAS_nonTerminalLabelListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                        const GALGAS_uint & inLength,
                                                                                        C_Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) const {
...
void GALGAS_nonTerminalLabelListAST::modifier_setMLabelNameAtIndex (GALGAS_lstring inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_nonTerminalLabelListAST) ;
...
void GALGAS_nonTerminalLabelListAST::modifier_setMFormalArgumentListAtIndex (GALGAS_formalParameterListAST inOperand,
                                                                             GALGAS_uint inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_nonTerminalLabelListAST) ;
    p->mAttribute_mFormalArgumentList = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_nonTerminalLabelListAST::modifier_setMEndOfArgumentLocationAtIndex (GALGAS_location inOperand,
                                                                                GALGAS_uint inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_nonTerminalLabelListAST::reader_mLabelNameAtIndex (const GALGAS_uint & inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) attributes.ptr () ;
...
GALGAS_formalParameterListAST GALGAS_nonTerminalLabelListAST::reader_mFormalArgumentListAtIndex (const GALGAS_uint & inIndex,
                                                                                                 C_Compiler * inCompiler
                                                                                                 COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) attributes.ptr () ;
...
GALGAS_location GALGAS_nonTerminalLabelListAST::reader_mEndOfArgumentLocationAtIndex (const GALGAS_uint & inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonTerminalLabelListAST * p = (cCollectionElement_nonTerminalLabelListAST *) attributes.ptr () ;
...
bool cCollectionElement_nonterminalDeclarationListAST::isValid (void) const {
  return mAttribute_mNonterminalName.isValid () && mAttribute_mLabels.isValid () && mAttribute_mHasParseLabel.isValid () ;
}
...
cCollectionElement * cCollectionElement_nonterminalDeclarationListAST::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_nonterminalDeclarationListAST (mAttribute_mNonterminalName, mAttribute_mLabels, mAttribute_mHasParseLabel COMMA_HERE)) ;
  return result ;
}
...
GALGAS_nonterminalDeclarationListAST GALGAS_nonterminalDeclarationListAST::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_nonterminalDeclarationListAST (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    result.addObject (attributes) ;
...
cCollectionElement_nonterminalDeclarationListAST * GALGAS_nonterminalDeclarationListAST::makeElement (const GALGAS_lstring & in_mNonterminalName,
                                                                                                      const GALGAS_nonTerminalLabelListAST & in_mLabels,
                                                                                                      const GALGAS_bool & in_mHasParseLabel
                                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_nonterminalDeclarationListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_nonterminalDeclarationListAST (in_mNonterminalName,
                                                                                                      in_mLabels,
...
void GALGAS_nonterminalDeclarationListAST::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand2 = p->mAttribute_mHasParseLabel ;
  }
}
...
GALGAS_nonterminalDeclarationListAST GALGAS_nonterminalDeclarationListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                                    const GALGAS_uint & inLength,
                                                                                                    C_Compiler * inCompiler
                                                                                                    COMMA_LOCATION_ARGS) const {
...
void GALGAS_nonterminalDeclarationListAST::modifier_setMNonterminalNameAtIndex (GALGAS_lstring inOperand,
                                                                                GALGAS_uint inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_nonterminalDeclarationListAST) ;
...
void GALGAS_nonterminalDeclarationListAST::modifier_setMLabelsAtIndex (GALGAS_nonTerminalLabelListAST inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_nonterminalDeclarationListAST::modifier_setMHasParseLabelAtIndex (GALGAS_bool inOperand,
                                                                              GALGAS_uint inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_nonterminalDeclarationListAST::reader_mNonterminalNameAtIndex (const GALGAS_uint & inIndex,
                                                                                     C_Compiler * inCompiler
                                                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) attributes.ptr () ;
...
GALGAS_nonTerminalLabelListAST GALGAS_nonterminalDeclarationListAST::reader_mLabelsAtIndex (const GALGAS_uint & inIndex,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) attributes.ptr () ;
...
GALGAS_bool GALGAS_nonterminalDeclarationListAST::reader_mHasParseLabelAtIndex (const GALGAS_uint & inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_nonterminalDeclarationListAST * p = (cCollectionElement_nonterminalDeclarationListAST *) attributes.ptr () ;
...
GALGAS_bool cEnumerator_nonterminalDeclarationListAST::current_mHasParseLabel (LOCATION_ARGS) const {
  const cCollectionElement_nonterminalDeclarationListAST * p = (const cCollectionElement_nonterminalDeclarationListAST *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_nonterminalDeclarationListAST) ;
...
cCollectionElement_syntaxRuleLabelListAST * GALGAS_syntaxRuleLabelListAST::makeElement (const GALGAS_lstring & in_mLabelName,
                                                                                        const GALGAS_formalParameterListAST & in_mFormalArguments,
                                                                                        const GALGAS_location & in_mEndOfArgumentLocation,
                                                                                        const GALGAS_syntaxInstructionList & in_mSyntaxInstructionList,
                                                                                        const GALGAS_location & in_mEndOfInstructionList
                                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_syntaxRuleLabelListAST (in_mLabelName,
                                                                                        in_mFormalArguments,
...
GALGAS_syntaxRuleLabelListAST GALGAS_syntaxRuleLabelListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                      const GALGAS_uint & inLength,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
...
void GALGAS_syntaxRuleLabelListAST::modifier_setMLabelNameAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleLabelListAST) ;
    p->mAttribute_mLabelName = inOperand ;
  }
...
void GALGAS_syntaxRuleLabelListAST::modifier_setMFormalArgumentsAtIndex (GALGAS_formalParameterListAST inOperand,
                                                                         GALGAS_uint inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleLabelListAST) ;
    p->mAttribute_mFormalArguments = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_syntaxRuleLabelListAST::modifier_setMEndOfArgumentLocationAtIndex (GALGAS_location inOperand,
                                                                               GALGAS_uint inIndex,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_syntaxRuleLabelListAST::modifier_setMSyntaxInstructionListAtIndex (GALGAS_syntaxInstructionList inOperand,
                                                                               GALGAS_uint inIndex,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_syntaxRuleLabelListAST::modifier_setMEndOfInstructionListAtIndex (GALGAS_location inOperand,
                                                                              GALGAS_uint inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_syntaxRuleLabelListAST::reader_mLabelNameAtIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) attributes.ptr () ;
...
GALGAS_formalParameterListAST GALGAS_syntaxRuleLabelListAST::reader_mFormalArgumentsAtIndex (const GALGAS_uint & inIndex,
                                                                                             C_Compiler * inCompiler
                                                                                             COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleLabelListAST) ;
    result = p->mAttribute_mFormalArguments ;
  }
  return result ;
}
...
GALGAS_location GALGAS_syntaxRuleLabelListAST::reader_mEndOfArgumentLocationAtIndex (const GALGAS_uint & inIndex,
                                                                                     C_Compiler * inCompiler
                                                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) attributes.ptr () ;
...
GALGAS_syntaxInstructionList GALGAS_syntaxRuleLabelListAST::reader_mSyntaxInstructionListAtIndex (const GALGAS_uint & inIndex,
                                                                                                  C_Compiler * inCompiler
                                                                                                  COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) attributes.ptr () ;
...
GALGAS_location GALGAS_syntaxRuleLabelListAST::reader_mEndOfInstructionListAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleLabelListAST * p = (cCollectionElement_syntaxRuleLabelListAST *) attributes.ptr () ;
...
cCollectionElement_syntaxRuleListAST * GALGAS_syntaxRuleListAST::makeElement (const GALGAS_lstring & in_mNonterminalName,
                                                                              const GALGAS_syntaxRuleLabelListAST & in_mLabelList
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleListAST * result = NULL ;
  macroMyNew (result, cCollectionElement_syntaxRuleListAST (in_mNonterminalName,
...
GALGAS_syntaxRuleListAST GALGAS_syntaxRuleListAST::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                            const GALGAS_uint & inLength,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) const {
...
void GALGAS_syntaxRuleListAST::modifier_setMNonterminalNameAtIndex (GALGAS_lstring inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleListAST * p = (cCollectionElement_syntaxRuleListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleListAST) ;
    p->mAttribute_mNonterminalName = inOperand ;
  }
...
void GALGAS_syntaxRuleListAST::modifier_setMLabelListAtIndex (GALGAS_syntaxRuleLabelListAST inOperand,
                                                              GALGAS_uint inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxRuleListAST * p = (cCollectionElement_syntaxRuleListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleListAST) ;
    p->mAttribute_mLabelList = inOperand ;
  }
}
...
GALGAS_lstring GALGAS_syntaxRuleListAST::reader_mNonterminalNameAtIndex (const GALGAS_uint & inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleListAST * p = (cCollectionElement_syntaxRuleListAST *) attributes.ptr () ;
...
GALGAS_syntaxRuleLabelListAST GALGAS_syntaxRuleListAST::reader_mLabelListAtIndex (const GALGAS_uint & inIndex,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_syntaxRuleListAST * p = (cCollectionElement_syntaxRuleListAST *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_syntaxRuleListAST) ;
    result = p->mAttribute_mLabelList ;
  }
  return result ;
}
...
cCollectionElement_listOfSyntaxInstructionList * GALGAS_listOfSyntaxInstructionList::makeElement (const GALGAS_syntaxInstructionList & in_mSyntaxInstructionList,
                                                                                                  const GALGAS_location & in_mEndOf_5F_instructions
                                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_listOfSyntaxInstructionList * result = NULL ;
  macroMyNew (result, cCollectionElement_listOfSyntaxInstructionList (in_mSyntaxInstructionList,
...
GALGAS_listOfSyntaxInstructionList GALGAS_listOfSyntaxInstructionList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                                const GALGAS_uint & inLength,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) const {
...
void GALGAS_listOfSyntaxInstructionList::modifier_setMSyntaxInstructionListAtIndex (GALGAS_syntaxInstructionList inOperand,
                                                                                    GALGAS_uint inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_listOfSyntaxInstructionList * p = (cCollectionElement_listOfSyntaxInstructionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_listOfSyntaxInstructionList) ;
    p->mAttribute_mSyntaxInstructionList = inOperand ;
  }
...
void GALGAS_listOfSyntaxInstructionList::modifier_setMEndOf_5F_instructionsAtIndex (GALGAS_location inOperand,
                                                                                    GALGAS_uint inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_listOfSyntaxInstructionList * p = (cCollectionElement_listOfSyntaxInstructionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_listOfSyntaxInstructionList) ;
    p->mAttribute_mEndOf_5F_instructions = inOperand ;
  }
}
...
GALGAS_syntaxInstructionList GALGAS_listOfSyntaxInstructionList::reader_mSyntaxInstructionListAtIndex (const GALGAS_uint & inIndex,
                                                                                                       C_Compiler * inCompiler
                                                                                                       COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_listOfSyntaxInstructionList * p = (cCollectionElement_listOfSyntaxInstructionList *) attributes.ptr () ;
...
GALGAS_location GALGAS_listOfSyntaxInstructionList::reader_mEndOf_5F_instructionsAtIndex (const GALGAS_uint & inIndex,
                                                                                          C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_listOfSyntaxInstructionList * p = (cCollectionElement_listOfSyntaxInstructionList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_listOfSyntaxInstructionList) ;
    result = p->mAttribute_mEndOf_5F_instructions ;
  }
  return result ;
}
...
/* GALGAS_syntaxComponentAST::GALGAS_syntaxComponentAST (const GALGAS_syntaxComponentAST & inSource) :
//mAttribute_mSyntaxComponentName (inSource.mAttribute_mSyntaxComponentName),
//mAttribute_mImportedLexiqueFilePath (inSource.mAttribute_mImportedLexiqueFilePath),
//mAttribute_mImportedComponentFileNameList (inSource.mAttribute_mImportedComponentFileNameList),
//mAttribute_mNonterminalDeclarationList (inSource.mAttribute_mNonterminalDeclarationList),
//mAttribute_mRuleList (inSource.mAttribute_mRuleList),
...
enumComparisonResult GALGAS_blockInstruction::objectCompare (const GALGAS_blockInstruction & inOperand) const {
  enumComparisonResult result = GALGAS_syntaxInstructionAST::objectCompare (inOperand) ;
  const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_blockInstruction) ;
  const cPtr_blockInstruction * q = (const cPtr_blockInstruction *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_blockInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mReceiverVariable.objectCompare (q->mAttribute_mReceiverVariable) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mBlockMethodName.objectCompare (q->mAttribute_mBlockMethodName) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mPrologActualParameterList.objectCompare (q->mAttribute_mPrologActualParameterList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mInstructionList.objectCompare (q->mAttribute_mInstructionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEpilogActualParameterList.objectCompare (q->mAttribute_mEpilogActualParameterList) ;
  }
  return result ;
}
...
GALGAS_blockInstruction::GALGAS_blockInstruction (void) :
GALGAS_syntaxInstructionAST () {
}

//---------------------------------------------------------------------------*

GALGAS_blockInstruction::GALGAS_blockInstruction (const cPtr_blockInstruction * inSourcePtr) :
GALGAS_syntaxInstructionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_blockInstruction) ;
}

//---------------------------------------------------------------------------*

GALGAS_blockInstruction GALGAS_blockInstruction::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
                                                                  const GALGAS_lstring & inAttribute_mReceiverVariable,
                                                                  const GALGAS_lstring & inAttribute_mBlockMethodName,
                                                                  const GALGAS_actualParameterListAST & inAttribute_mPrologActualParameterList,
                                                                  const GALGAS_syntaxInstructionList & inAttribute_mInstructionList,
                                                                  const GALGAS_actualParameterListAST & inAttribute_mEpilogActualParameterList
                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_blockInstruction result ;
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mReceiverVariable.isValid () && inAttribute_mBlockMethodName.isValid () && inAttribute_mPrologActualParameterList.isValid () && inAttribute_mInstructionList.isValid () && inAttribute_mEpilogActualParameterList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_blockInstruction (inAttribute_mInstructionLocation, inAttribute_mReceiverVariable, inAttribute_mBlockMethodName, inAttribute_mPrologActualParameterList, inAttribute_mInstructionList, inAttribute_mEpilogActualParameterList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_blockInstruction::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_blockInstruction * p = (cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_blockInstruction) ;
    cPtr_blockInstruction * r = NULL ;
    macroMyNew (r, cPtr_blockInstruction (p->mAttribute_mInstructionLocation, p->mAttribute_mReceiverVariable, p->mAttribute_mBlockMethodName, p->mAttribute_mPrologActualParameterList, p->mAttribute_mInstructionList, p->mAttribute_mEpilogActualParameterList COMMA_THERE)) ;
...
GALGAS_lstring GALGAS_blockInstruction::reader_mReceiverVariable (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_blockInstruction) ;
    result = p->mAttribute_mReceiverVariable ;
  }
  return result ;
}
...
GALGAS_lstring GALGAS_blockInstruction::reader_mBlockMethodName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_blockInstruction) ;
    result = p->mAttribute_mBlockMethodName ;
  }
  return result ;
}
...
GALGAS_actualParameterListAST GALGAS_blockInstruction::reader_mPrologActualParameterList (UNUSED_LOCATION_ARGS) const {
  GALGAS_actualParameterListAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_blockInstruction) ;
    result = p->mAttribute_mPrologActualParameterList ;
  }
  return result ;
}
...
GALGAS_syntaxInstructionList GALGAS_blockInstruction::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  GALGAS_syntaxInstructionList result ;
  if (NULL != mObjectPtr) {
    const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_blockInstruction) ;
...
GALGAS_actualParameterListAST GALGAS_blockInstruction::reader_mEpilogActualParameterList (UNUSED_LOCATION_ARGS) const {
  GALGAS_actualParameterListAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_blockInstruction * p = (const cPtr_blockInstruction *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_blockInstruction) ;
    result = p->mAttribute_mEpilogActualParameterList ;
  }
  return result ;
}
...
cPtr_blockInstruction::cPtr_blockInstruction (const GALGAS_location & in_mInstructionLocation,
...
mAttribute_mReceiverVariable (in_mReceiverVariable),
mAttribute_mBlockMethodName (in_mBlockMethodName),
mAttribute_mPrologActualParameterList (in_mPrologActualParameterList),
mAttribute_mInstructionList (in_mInstructionList),
mAttribute_mEpilogActualParameterList (in_mEpilogActualParameterList) {
}

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * cPtr_blockInstruction::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_blockInstruction ;
}

void cPtr_blockInstruction::description (C_String & ioString,
                                         const PMSInt32 inIndentation) const {
  ioString << "[@blockInstruction:" ;
  mAttribute_mInstructionLocation.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mReceiverVariable.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mBlockMethodName.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mPrologActualParameterList.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mInstructionList.description (ioString, inIndentation+1) ;
  ioString << ", " ;
  mAttribute_mEpilogActualParameterList.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                          @blockInstruction type                           *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_blockInstruction ("blockInstruction",
                                         & kTypeDescriptor_GALGAS_syntaxInstructionAST) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_blockInstruction::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_blockInstruction ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_blockInstruction::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_blockInstruction (*this)) ;
  }
  return result ;
}
...
GALGAS_blockInstruction GALGAS_blockInstruction::extractObject (const GALGAS_object & inObject,
                                                                C_Compiler * inCompiler,
                                                                const GALGAS_location & inErrorLocation
                                                                COMMA_LOCATION_ARGS) {
  GALGAS_blockInstruction result ;
  const GALGAS_blockInstruction * p = (const GALGAS_blockInstruction *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_blockInstruction *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "blockInstruction", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
enumComparisonResult GALGAS_nonterminalCallInstruction::objectCompare (const GALGAS_nonterminalCallInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_nonterminalCallInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mNonterminalName.objectCompare (q->mAttribute_mNonterminalName) ;
  }
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_parseLoopInstruction::objectCompare (const GALGAS_parseLoopInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_parseLoopInstruction) ;
  if (kOperandEqual == result) {
  ...
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOfWhileExpression.objectCompare (q->mAttribute_mEndOfWhileExpression) ;
  }
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_parseRewindInstruction::objectCompare (const GALGAS_parseRewindInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_parseRewindInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mParseRewindBranchList.objectCompare (q->mAttribute_mParseRewindBranchList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOfParseDoInstruction.objectCompare (q->mAttribute_mEndOfParseDoInstruction) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_parseWhenInstruction::objectCompare (const GALGAS_parseWhenInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_parseWhenInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mWhenExpression.objectCompare (q->mAttribute_mWhenExpression) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOfWhenExpression.objectCompare (q->mAttribute_mEndOfWhenExpression) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mWhenInstructionList.objectCompare (q->mAttribute_mWhenInstructionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOfWhenInstructionList.objectCompare (q->mAttribute_mEndOfWhenInstructionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mElseInstructionList.objectCompare (q->mAttribute_mElseInstructionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOfElseInstructionList.objectCompare (q->mAttribute_mEndOfElseInstructionList) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_repeatInstruction::objectCompare (const GALGAS_repeatInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_repeatInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mRepeatedInstructionList.objectCompare (q->mAttribute_mRepeatedInstructionList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch.objectCompare (q->mAttribute_mEndOf_5F_repeated_5F_instructions_5F_branch) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mRepeatBranchList.objectCompare (q->mAttribute_mRepeatBranchList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOf_5F_repeat_5F_instruction.objectCompare (q->mAttribute_mEndOf_5F_repeat_5F_instruction) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_selectInstruction::objectCompare (const GALGAS_selectInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_selectInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mSelectBranchList.objectCompare (q->mAttribute_mSelectBranchList) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mEndOf_5F_select_5F_instruction.objectCompare (q->mAttribute_mEndOf_5F_select_5F_instruction) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_terminalCheckInstruction::objectCompare (const GALGAS_terminalCheckInstruction & inOperand) const {
  ...
  macroNullOrValidSharedObject (q, const cPtr_terminalCheckInstruction) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mTerminalName.objectCompare (q->mAttribute_mTerminalName) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_mActualInputParameterList.objectCompare (q->mAttribute_mActualInputParameterList) ;
  }
  return result ;
}
...
GALGAS_terminalCheckInstruction GALGAS_terminalCheckInstruction::constructor_new (const GALGAS_location & inAttribute_mInstructionLocation,
  ...
  if (inAttribute_mInstructionLocation.isValid () && inAttribute_mTerminalName.isValid () && inAttribute_mActualInputParameterList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_terminalCheckInstruction (inAttribute_mInstructionLocation, inAttribute_mTerminalName, inAttribute_mActualInputParameterList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_terminalCheckInstruction::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_terminalCheckInstruction (p->mAttribute_mInstructionLocation, p->mAttribute_mTerminalName, p->mAttribute_mActualInputParameterList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
