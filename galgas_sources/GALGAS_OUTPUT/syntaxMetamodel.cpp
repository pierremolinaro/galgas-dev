...
cPtr__AC_galgas_class * cPtr_repeatInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_repeatInstruction (mInstructionLocation, mRepeatedInstructionList, mRepeatBranchList COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_selectInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_selectInstruction (mInstructionLocation, mSelectBranchList COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_parseDoInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseDoInstruction (mInstructionLocation, mParseDoBranchList COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_parseLoopInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseLoopInstruction (mInstructionLocation, mVariantExpression, mWhileExpression, mDoInstructionList COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_parseWhenInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_parseWhenInstruction (mInstructionLocation, mWhenBranchList, mElseInstructionList COMMA_HERE)) ;
  return result ;
}
