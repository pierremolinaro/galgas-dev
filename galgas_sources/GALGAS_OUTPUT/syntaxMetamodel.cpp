...
internalSubListWithRange (GGS_nonTerminalLabelList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mLabelName, _p->mFormalParameters) ;
      _p = _p->nextObject () ;
    }
  }
}
...
internalSubListWithRange (GGS_syntaxRuleLabelList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mLabelName, _p->mFormalParameters, _p->mSyntaxInstructionList) ;
      _p = _p->nextObject () ;
    }
  }
}
...
const sint32 GGS_nonterminalCallInstruction::kClassID = GGS_nonterminalCallInstruction::getClassID ("GGS_nonterminalCallInstruction") ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mTerminalName._operator_isEqual (_p->mTerminalName).boolValue ()
         && mActualInputParameterList._operator_isEqual (_p->mActualInputParameterList).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@terminalCheckInstruction:"
           ...
           << mActualInputParameterList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const sint32 GGS_terminalCheckInstruction::kClassID = GGS_terminalCheckInstruction::getClassID ("GGS_terminalCheckInstruction") ;
...
const sint32 GGS_repeatInstruction::kClassID = GGS_repeatInstruction::getClassID ("GGS_repeatInstruction") ;
...
const sint32 GGS_selectInstruction::kClassID = GGS_selectInstruction::getClassID ("GGS_selectInstruction") ;
...
const sint32 GGS_parseDoInstruction::kClassID = GGS_parseDoInstruction::getClassID ("GGS_parseDoInstruction") ;
...
const sint32 GGS_blockInstruction::kClassID = GGS_blockInstruction::getClassID ("GGS_blockInstruction") ;
...
sint32 GGS_syntaxComponentRoot::gClassIDCounter = -1 ;

//---------------------------------------------------------------------------*

sint32 GGS_syntaxComponentRoot::getClassID (const char * /* inClassName */) {
...
const sint32 GGS_syntaxComponentRoot::kClassID = GGS_syntaxComponentRoot::getClassID ("GGS_syntaxComponentRoot") ;
