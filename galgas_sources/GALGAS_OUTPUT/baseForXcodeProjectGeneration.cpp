...
void routine_enterProjectDefaultSettings (C_CompilerEx &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_45006 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_45006 = NULL ;
    while (((operand_45006 = enumerator_45006.nextObject ()))) {
      macroValidPointer (operand_45006) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_45006->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
...
void routine_buildXcodeProjectString (C_CompilerEx & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48471 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_48471 = enumerator_48471.nextObject () ;
    if ((operand_48471 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_48471 ;
      do{
        macroValidPointer (operand_48471) ;
        if (operand_48471->mFile.isBuilt ()) {
          operand_48471->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1121)) ;
        }
        operand_48471 = enumerator_48471.nextObject () ;
        _foreach_loop_48471 = ((operand_48471 != NULL)) ;
        if (_foreach_loop_48471) {
        }
      }while (_foreach_loop_48471) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_48739 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_48739 = enumerator_48739.nextObject () ;
    if ((operand_48739 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_48739 ;
      do{
        macroValidPointer (operand_48739) ;
        if (operand_48739->mInfo.mFileReference.isBuilt ()) {
          operand_48739->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1127)) ;
        }
        operand_48739 = enumerator_48739.nextObject () ;
        _foreach_loop_48739 = ((operand_48739 != NULL)) ;
        if (_foreach_loop_48739) {
        }
      }while (_foreach_loop_48739) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49029 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49029 = enumerator_49029.nextObject () ;
    if ((operand_49029 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49029 ;
      do{
        macroValidPointer (operand_49029) ;
        if (operand_49029->mBuildPhase.isBuilt ()) {
          operand_49029->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1133)) ;
        }
        operand_49029 = enumerator_49029.nextObject () ;
        _foreach_loop_49029 = ((operand_49029 != NULL)) ;
        if (_foreach_loop_49029) {
        }
      }while (_foreach_loop_49029) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_49377 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_49377 = NULL ;
    while (((operand_49377 = enumerator_49377.nextObject ()))) {
      macroValidPointer (operand_49377) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_49377->mGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1139)) COMMA_SOURCE_FILE_AT_LINE (1139))) ;
      const GGS_bool cond_49607 = (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1140))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_49607.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1141))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_49715 (operand_49377->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1146)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_49715 = NULL ;
        while (((operand_49715 = enumerator_49715.nextObject ()))) {
          macroValidPointer (operand_49715) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_49715->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_49715->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_50166 = (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1150))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50166.isBuiltAndTrue ()) {
        const GGS_bool cond_50074 = (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1151)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50074.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1152))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50074.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_49377->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1154))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_50288 = (operand_49377->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50288.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_49377->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1158))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_50472 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1165)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_50472 = enumerator_50472.nextObject () ;
    if ((operand_50472 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_50472 ;
      do{
        macroValidPointer (operand_50472) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50472->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50472->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_50472->mTargetConfiguration.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1170)) COMMA_SOURCE_FILE_AT_LINE (1170))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_50472->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_50948 (operand_50472->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_50948 = NULL ;
          while (((operand_50948 = enumerator_50948.nextObject ()))) {
            macroValidPointer (operand_50948) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_50948->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        if (operand_50472->mProduct.isBuilt ()) {
          operand_50472->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1175)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51245 (operand_50472->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_51245 = NULL ;
          while (((operand_51245 = enumerator_51245.nextObject ()))) {
            macroValidPointer (operand_51245) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51245->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50472->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_50472->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_50472->mProduct.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_50472 = enumerator_50472.nextObject () ;
        _foreach_loop_50472 = ((operand_50472 != NULL)) ;
        if (_foreach_loop_50472) {
        }
      }while (_foreach_loop_50472) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_52382 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_52382 = NULL ;
    while (((operand_52382 = enumerator_52382.nextObject ()))) {
      macroValidPointer (operand_52382) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_52382->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_52382->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_52648 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_52648 = enumerator_52648.nextObject () ;
    if ((operand_52648 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_52648 ;
      do{
        macroValidPointer (operand_52648) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_52648->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1215)) COMMA_SOURCE_FILE_AT_LINE (1215))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_52648->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1216))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53054 (operand_52648->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53054 = NULL ;
          while (((operand_53054 = enumerator_53054.nextObject ()))) {
            macroValidPointer (operand_53054) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53054->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1221)) COMMA_SOURCE_FILE_AT_LINE (1221))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_52648 = enumerator_52648.nextObject () ;
        _foreach_loop_52648 = ((operand_52648 != NULL)) ;
        if (_foreach_loop_52648) {
        }
      }while (_foreach_loop_52648) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_53435 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1229)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_53435 = enumerator_53435.nextObject () ;
    if ((operand_53435 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_53435 ;
      do{
        macroValidPointer (operand_53435) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53435->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1232)) COMMA_SOURCE_FILE_AT_LINE (1232))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53435->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1233))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53835 (operand_53435->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53835 = NULL ;
          while (((operand_53835 = enumerator_53835.nextObject ()))) {
            macroValidPointer (operand_53835) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53835->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1238)) COMMA_SOURCE_FILE_AT_LINE (1238))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53435 = enumerator_53435.nextObject () ;
        _foreach_loop_53435 = ((operand_53435 != NULL)) ;
        if (_foreach_loop_53435) {
        }
      }while (_foreach_loop_53435) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_54213 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1246)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_54213 = enumerator_54213.nextObject () ;
    if ((operand_54213 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_54213 ;
      do{
        macroValidPointer (operand_54213) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_54213->mDependency.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1249)) COMMA_SOURCE_FILE_AT_LINE (1249))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_54213->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1252))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_54213 = enumerator_54213.nextObject () ;
        _foreach_loop_54213 = ((operand_54213 != NULL)) ;
        if (_foreach_loop_54213) {
        }
      }while (_foreach_loop_54213) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_54702 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_54702 = enumerator_54702.nextObject () ;
    if ((operand_54702 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_54702 ;
      do{
        macroValidPointer (operand_54702) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54702->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54702->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54702->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_54702->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_54702 = enumerator_54702.nextObject () ;
        _foreach_loop_54702 = ((operand_54702 != NULL)) ;
        if (_foreach_loop_54702) {
        }
      }while (_foreach_loop_54702) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55253 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55253 = enumerator_55253.nextObject () ;
    if ((operand_55253 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_55253 ;
      do{
        macroValidPointer (operand_55253) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_55253->mBuildConfig.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1275)) COMMA_SOURCE_FILE_AT_LINE (1275))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_55580 (operand_55253->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1278)), true) ;
          const GGS_stringlist::cElement * operand_55580 = NULL ;
          while (((operand_55580 = enumerator_55580.nextObject ()))) {
            macroValidPointer (operand_55580) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_55580->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_55253 = enumerator_55253.nextObject () ;
        _foreach_loop_55253 = ((operand_55253 != NULL)) ;
        if (_foreach_loop_55253) {
        }
      }while (_foreach_loop_55253) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55883 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1287)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55883 = enumerator_55883.nextObject () ;
    if ((operand_55883 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_55883 ;
      do{
        macroValidPointer (operand_55883) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_55883->mBuildConfig.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)) COMMA_SOURCE_FILE_AT_LINE (1290))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_55883->mBuildConfig.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)) COMMA_SOURCE_FILE_AT_LINE (1294))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_55883 = enumerator_55883.nextObject () ;
        _foreach_loop_55883 = ((operand_55883 != NULL)) ;
        if (_foreach_loop_55883) {
        }
      }while (_foreach_loop_55883) ;
...
void routine_generateXCodeFile (C_CompilerEx & inLexique,
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_defaultProjectConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1318)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1319)), var_cas_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1317)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1322)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_defaultProjectConfiguration) ;
  ::routine_enter_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_ioXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)) COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)), GGS_string (""), GGS_string (""), var_cas_ioXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1333)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_projectName,  function_getPBXFileReferenceKey (inLexique, var_cas_mainGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1341)),  function_getPBXFileReferenceKey (inLexique, var_cas_defaultProjectConfiguration.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1342)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  const GGS_bool cond_59056 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1345))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_59056.isBuiltAndTrue ()) {
    if (var_cas_in_xcodeproj_filePath.isBuilt ()) {
      var_cas_in_xcodeproj_filePath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)) ;
    }
    GGS_bool var_cas_written ;
    if (var_cas_fileNewContents.isBuilt ()) {
      var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1350)) ;
    }
    const GGS_string var_cas_pbxprojFilePath = (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")) ;
    const GGS_bool cond_59045 = (var_cas_written).operator_or ((var_cas_pbxprojFilePath.reader_fileExists ()).operator_not ()) ;
    if (cond_59045.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58687_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_pbxprojFilePath, automatic_var_58687_0 COMMA_SOURCE_FILE_AT_LINE (1353)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58906 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58906 = NULL ;
        while (((operand_58906 = enumerator_58906.nextObject ()))) {
          macroValidPointer (operand_58906) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58906->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1358)) ;
        }
      }
    }
  }
