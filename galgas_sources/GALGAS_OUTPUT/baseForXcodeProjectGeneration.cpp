...
GGS_Xcode_PBXFileReference_gifFile (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
void cPtr_Xcode_PBXBuildFile::computeOnce10001 (C_Compiler & inLexique) const {
  _mOnce10001isComputed = true ;
  PBXBuildFileKey.drop () ;
  PBXBuildFileKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (221)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (221)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXBuildFile::reader_PBXBuildFileKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce10001isComputed) {
    computeOnce10001 (inLexique) ;
  }
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation ((*this) /* self */.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (225))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mSourceFile.reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (225))) ;
  var_cas_outString.appendCString (" */ "
  "= {isa = PBXBuildFile; fileRef = ") ;
  var_cas_outString.dotAssign_operation (mSourceFile.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (226))) ;
...
void cPtr_Xcode_PBXSourcesBuildPhase::computeOnce11077 (C_Compiler & inLexique) const {
  _mOnce11077isComputed = true ;
  PBXSourcesBuildPhaseKey.drop () ;
  PBXSourcesBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (248)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (248)) ;
}
...
GGS_string cPtr_Xcode_PBXSourcesBuildPhase::reader_PBXSourcesBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce11077isComputed) {
    computeOnce11077 (inLexique) ;
  }
...
void cPtr_Xcode_PBXResourcesBuildPhase::computeOnce11903 (C_Compiler & inLexique) const {
  _mOnce11903isComputed = true ;
  PBXResourcesBuildPhaseKey.drop () ;
  PBXResourcesBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (269)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (269)) ;
}
...
GGS_string cPtr_Xcode_PBXResourcesBuildPhase::reader_PBXResourcesBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce11903isComputed) {
    computeOnce11903 (inLexique) ;
  }
...
void cPtr_Xcode_PBXFrameworksBuildPhase::computeOnce12742 (C_Compiler & inLexique) const {
  _mOnce12742isComputed = true ;
  PBXFrameworksBuildPhaseKey.drop () ;
  PBXFrameworksBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (290)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (290)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (290)) ;
}
...
GGS_string cPtr_Xcode_PBXFrameworksBuildPhase::reader_PBXFrameworksBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce12742isComputed) {
    computeOnce12742 (inLexique) ;
  }
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation ((*this) /* self */.reader_PBXFrameworksBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (294))) ;
  var_cas_outString.appendCString (" /* Frameworks */ = {\n"
  "\t\t\tisa = PBXFrameworksBuildPhase;\n"
  "\t\t\tbuildActionMask = 2147483647;\n"
  "\t\t\tfiles = (\n") ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_13022 (mFileReferenceList, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_13022 = NULL ;
    while (((operand_13022 = enumerator_13022.nextObject ()))) {
      macroValidPointer (operand_13022) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_13022->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (299))) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_13022->mFile.reader_mSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (300)).reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
...
void cPtr_Xcode_PBXGroup::computeOnce14093 (C_Compiler & inLexique) const {
  _mOnce14093isComputed = true ;
  PBXGroupKey.drop () ;
  PBXGroupKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (326)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (326)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXGroup::reader_PBXGroupKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14093isComputed) {
    computeOnce14093 (inLexique) ;
  }
  return PBXGroupKey ;
}
...
_mOnce14825isComputed (false),
configurationKey (),
_mOnce14965isComputed (false),
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce14825 (C_Compiler & inLexique) const {
  _mOnce14825isComputed = true ;
  configurationKey.drop () ;
  configurationKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (346)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (346)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (346)) ;
}

//---------------------------------------------------------------------------*

void cPtr_Xcode_XCBuildConfiguration::computeOnce14965 (C_Compiler & inLexique) const {
  _mOnce14965isComputed = true ;
  XCBuildConfigurationKey.drop () ;
  XCBuildConfigurationKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (350)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (350)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (350)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_XCBuildConfiguration::reader_configurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14825isComputed) {
    computeOnce14825 (inLexique) ;
  }
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_XCBuildConfigurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14965isComputed) {
    computeOnce14965 (inLexique) ;
  }
...
void cPtr_Xcode_targetDependencyDescription::computeOnce16441 (C_Compiler & inLexique) const {
  _mOnce16441isComputed = true ;
  PBXTargetDependencyKey.drop () ;
  PBXTargetDependencyKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (387)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (387)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (387)) ;
}
...
GGS_string cPtr_Xcode_targetDependencyDescription::reader_PBXTargetDependencyKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce16441isComputed) {
    computeOnce16441 (inLexique) ;
  }
...
void routine_enter_group (C_Compiler & inLexique,
  ...
  var_cas_ioDescription.mMainGroupChildrenList._addAssign_operation (var_cas_group.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), var_cas_inGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_subgroup (C_Compiler & inLexique,
  ...
  var_cas_ioDescription.mProjectGroupList._addAssign_operation (var_cas_group) ;
  var_cas_ioSuperGroupContentsKeyList._addAssign_operation (var_cas_group.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), var_cas_inSubGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_cpp_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (522)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_h_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (535)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_pch_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (548)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_m_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_mm_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (574)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (575)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_gif_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (587)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (588)), var_cas_inFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_tiff_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (600)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (601)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_png_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (613)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (614)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_plist_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (626)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (627)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_framework_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (639)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (640)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_icns_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (652)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (653)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_file_in_group (C_Compiler & inLexique,
  ...
  var_cas_extension = var_cas_inFileName.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (663)) ;
  if (((var_cas_extension).operator_isEqual (GGS_string ("cpp"))).isBuiltAndTrue ()) {
    ::routine_enter_cpp_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (665)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("h"))).isBuiltAndTrue ()) {
    ::routine_enter_h_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (667)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("pch"))).isBuiltAndTrue ()) {
    ::routine_enter_pch_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("m"))).isBuiltAndTrue ()) {
    ::routine_enter_m_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (671)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("mm"))).isBuiltAndTrue ()) {
    ::routine_enter_mm_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (673)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("tiff"))).isBuiltAndTrue ()) {
    ::routine_enter_tiff_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (675)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("gif"))).isBuiltAndTrue ()) {
    ::routine_enter_gif_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (677)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("png"))).isBuiltAndTrue ()) {
    ::routine_enter_png_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (679)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("plist"))).isBuiltAndTrue ()) {
    ::routine_enter_plist_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (681)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("framework"))).isBuiltAndTrue ()) {
    ::routine_enter_framework_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (683)) ;
  }else if (((var_cas_extension).operator_isEqual (GGS_string ("icns"))).isBuiltAndTrue ()) {
    ::routine_enter_icns_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }else{
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot enter '")).operator_concat (var_cas_inFileName)).operator_concat (GGS_string ("' file : unknown extension")) COMMA_SOURCE_FILE_AT_LINE (688)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_in_group (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_28776 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_28776 = NULL ;
    while (((operand_28776 = enumerator_28776.nextObject ()))) {
      macroValidPointer (operand_28776) ;
      ::routine_enter_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  operand_28776->mValue,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (699)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_nib_in_group (C_Compiler & inLexique,
  ...
  var_cas_ref = GGS_Xcode_PBXFileReference_nibFile ::constructor_new (inLexique, var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (712)), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_nib_fileName) COMMA_HERE) ;
  GGS_lstring  var_cas_key ;
  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_nib_fileName, GGS_location (inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (716)) ;
  GGS_string var_cas_PBXVariantGroupKey ;
  var_cas_PBXVariantGroupKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (717)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (717)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (717)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list._addAssign_operation (var_cas_PBXVariantGroupKey, var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (720)), var_cas_in_nib_fileName) ;
...
void routine_enter_file_for_sources_build_phase (C_Compiler & inLexique,
  ...
  const GGS_Xcode_PBXFileReference_map  temp_30113 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (735)) ;
  if (temp_30113.isBuilt ()) {
    temp_30113 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (735)) ;
  }
...
void routine_enter_file_list_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_30566 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_30566 = NULL ;
    while (((operand_30566 = enumerator_30566.nextObject ()))) {
      macroValidPointer (operand_30566) ;
      ::routine_enter_file_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  operand_30566->mValue,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (749)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_30996 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_30996 = NULL ;
    while (((operand_30996 = enumerator_30996.nextObject ()))) {
      macroValidPointer (operand_30996) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_30996->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_31142 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (767)) ;
      if (temp_31142.isBuilt ()) {
        temp_31142 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (767)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_31636 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_31636 = NULL ;
    while (((operand_31636 = enumerator_31636.nextObject ()))) {
      macroValidPointer (operand_31636) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_31636->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_31782 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (784)) ;
      if (temp_31782.isBuilt ()) {
        temp_31782 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (784)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
...
void routine_add_tool_target (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (862)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (864)), var_cas_inTargetName) ;
  ...
  var_cas_buildPhases = GGS_stringlist ::constructor_listWithValue (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (870))) ;
  if (((var_cas_inFrameworkKeyList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (872))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_buildPhases._addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (878))) ;
  }
  ...
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (889)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (889)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (889)) ;
...
void routine_add_app_target (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_projectNameKey ;
  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (921)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (923)), var_cas_inTargetName) ;
  ...
  var_cas_buildPhases._addAssign_operation (var_cas_resourcesBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (930))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase ;
  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list._addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases._addAssign_operation (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (937))) ;
  GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase ;
  ...
  var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list._addAssign_operation (var_cas_frameworksBuildPhase) ;
  var_cas_buildPhases._addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (944))) ;
  if (((var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    var_cas_inTargetSettings._addAssign_operation (GGS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings._addAssign_operation (((GGS_string ("GCC_PREFIX_HEADER = \"")).operator_concat (var_cas_inPrecompiledHeaderPath)).operator_concat (GGS_string ("\";"))) ;
  }
  ...
  {
    GGS_stringlist::cEnumerator enumerator_39131 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_39131 = NULL ;
    while (((operand_39131 = enumerator_39131.nextObject ()))) {
      macroValidPointer (operand_39131) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d ;
      var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, operand_39131->mValue COMMA_HERE) ;
      var_cas_targetDependencyKeyList._addAssign_operation (var_cas_d.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (960))) ;
  ...
  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_inTargetSettings COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList._addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (966)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (966)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (966)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_40195 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_40195 = NULL ;
    while (((operand_40195 = enumerator_40195.nextObject ()))) {
      macroValidPointer (operand_40195) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_40195->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_rootObjectKey = GGS_string ("project").reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (1039)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (1039)) ;
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_43660 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_43660 = enumerator_43660.nextObject () ;
    if ((operand_43660 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_43660 ;
      do{
        macroValidPointer (operand_43660) ;
        const GGS_Xcode_PBXBuildFile  temp_43795 = operand_43660->mFile ;
        if (temp_43795.isBuilt ()) {
          temp_43795 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        }
        operand_43660 = enumerator_43660.nextObject () ;
        _foreach_loop_43660 = ((operand_43660 != NULL)) ;
        if (_foreach_loop_43660) {
        }
      }while (_foreach_loop_43660) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_43928 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1055)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_43928 = enumerator_43928.nextObject () ;
    if ((operand_43928 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_43928 ;
      do{
        macroValidPointer (operand_43928) ;
        const GGS_Xcode_PBXFileReference_abstract  temp_44076 = operand_43928->mInfo.mFileReference ;
        if (temp_44076.isBuilt ()) {
          temp_44076 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1057)) ;
        }
        operand_43928 = enumerator_43928.nextObject () ;
        _foreach_loop_43928 = ((operand_43928 != NULL)) ;
        if (_foreach_loop_43928) {
        }
      }while (_foreach_loop_43928) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_44218 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_44218 = enumerator_44218.nextObject () ;
    if ((operand_44218 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_44218 ;
      do{
        macroValidPointer (operand_44218) ;
        const GGS_Xcode_PBXFrameworksBuildPhase  temp_44382 = operand_44218->mBuildPhase ;
        if (temp_44382.isBuilt ()) {
          temp_44382 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1063)) ;
        }
        operand_44218 = enumerator_44218.nextObject () ;
        _foreach_loop_44218 = ((operand_44218 != NULL)) ;
        if (_foreach_loop_44218) {
        }
      }while (_foreach_loop_44218) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_44566 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_44566 = NULL ;
    while (((operand_44566 = enumerator_44566.nextObject ()))) {
      macroValidPointer (operand_44566) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (operand_44566->mGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1069))) ;
      if (((operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1070))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1071))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_44874 (operand_44566->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_44874 = NULL ;
        while (((operand_44874 = enumerator_44874.nextObject ()))) {
          macroValidPointer (operand_44874) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_44874->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_44874->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      if (((operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1080))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        if (((operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)).reader_componentsSeparatedByString (inLexique, GGS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1081)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1081))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1082))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else{
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_44566->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1084))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      if (((operand_44566->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1087))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_44566->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1088))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_45631 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1095)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_45631 = enumerator_45631.nextObject () ;
    if ((operand_45631 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_45631 ;
      do{
        macroValidPointer (operand_45631) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_45631->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_45631->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (operand_45631->mTargetConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_45631->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46088 (operand_45631->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_46088 = NULL ;
          while (((operand_46088 = enumerator_46088.nextObject ()))) {
            macroValidPointer (operand_46088) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_46088->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        const GGS_Xcode_productFileReference  temp_46217 = operand_45631->mProduct ;
        if (temp_46217.isBuilt ()) {
          temp_46217 (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1105)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46385 (operand_45631->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_46385 = NULL ;
          while (((operand_46385 = enumerator_46385.nextObject ()))) {
            macroValidPointer (operand_46385) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_46385->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_45631->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_45631->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (operand_45631->mProduct.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1117))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_45631 = enumerator_45631.nextObject () ;
        _foreach_loop_45631 = ((operand_45631 != NULL)) ;
        if (_foreach_loop_45631) {
        }
      }while (_foreach_loop_45631) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_47500 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_47500 = NULL ;
    while (((operand_47500 = enumerator_47500.nextObject ()))) {
      macroValidPointer (operand_47500) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_47500->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_47500->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_47766 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_47766 = enumerator_47766.nextObject () ;
    if ((operand_47766 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_47766 ;
      do{
        macroValidPointer (operand_47766) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_47766->mBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_47766->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1146))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48156 (operand_47766->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_48156 = NULL ;
          while (((operand_48156 = enumerator_48156.nextObject ()))) {
            macroValidPointer (operand_48156) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_48156->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1151))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_47766 = enumerator_47766.nextObject () ;
        _foreach_loop_47766 = ((operand_47766 != NULL)) ;
        if (_foreach_loop_47766) {
        }
      }while (_foreach_loop_47766) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_48511 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_48511 = enumerator_48511.nextObject () ;
    if ((operand_48511 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_48511 ;
      do{
        macroValidPointer (operand_48511) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_48511->mBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1162))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_48511->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1163))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48893 (operand_48511->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1167)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_48893 = NULL ;
          while (((operand_48893 = enumerator_48893.nextObject ()))) {
            macroValidPointer (operand_48893) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_48893->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1168))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_48511 = enumerator_48511.nextObject () ;
        _foreach_loop_48511 = ((operand_48511 != NULL)) ;
        if (_foreach_loop_48511) {
        }
      }while (_foreach_loop_48511) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_49245 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1176)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_49245 = enumerator_49245.nextObject () ;
    if ((operand_49245 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_49245 ;
      do{
        macroValidPointer (operand_49245) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49245->mDependency.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1179))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_49245->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1182))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_49245 = enumerator_49245.nextObject () ;
        _foreach_loop_49245 = ((operand_49245 != NULL)) ;
        if (_foreach_loop_49245) {
        }
      }while (_foreach_loop_49245) ;
  ...
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_49793 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1190)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_49793 = enumerator_49793.nextObject () ;
    if ((operand_49793 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_49793 ;
      do{
        macroValidPointer (operand_49793) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49793->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49793->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49793->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_49793->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_49793 = enumerator_49793.nextObject () ;
        _foreach_loop_49793 = ((operand_49793 != NULL)) ;
        if (_foreach_loop_49793) {
        }
      }while (_foreach_loop_49793) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_50344 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_50344 = enumerator_50344.nextObject () ;
    if ((operand_50344 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_50344 ;
      do{
        macroValidPointer (operand_50344) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50344->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1208))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_50645 (operand_50344->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1211)), true) ;
          const GGS_stringlist::cElement * operand_50645 = NULL ;
          while (((operand_50645 = enumerator_50645.nextObject ()))) {
            macroValidPointer (operand_50645) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_50645->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_50344 = enumerator_50344.nextObject () ;
        _foreach_loop_50344 = ((operand_50344 != NULL)) ;
        if (_foreach_loop_50344) {
        }
      }while (_foreach_loop_50344) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_50948 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_50948 = enumerator_50948.nextObject () ;
    if ((operand_50948 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_50948 ;
      do{
        macroValidPointer (operand_50948) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50948->mBuildConfig.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1223))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50948->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1227))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_50948 = enumerator_50948.nextObject () ;
        _foreach_loop_50948 = ((operand_50948 != NULL)) ;
        if (_foreach_loop_50948) {
        }
      }while (_foreach_loop_50948) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)) ;
  ...
  ::routine_enter_group (inLexique,  var_cas_inXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_inXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)) COMMA_SOURCE_FILE_AT_LINE (1253)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup ;
  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, GGS_string (""), GGS_string (""), var_cas_inXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)) COMMA_HERE) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_inXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1267)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1264)) ;
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    const GGS_string temp_52982 = var_cas_in_xcodeproj_filePath ;
    if (temp_52982.isBuilt ()) {
      temp_52982 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1273)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string temp_53104 = var_cas_fileNewContents ;
    if (temp_53104.isBuilt ()) {
      temp_53104 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    }
    if (((var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))).operator_not ())).isBuiltAndTrue ()) {
      GGS_bool automatic_var_0 ;
      const GGS_string temp_53254 = var_cas_fileNewContents ;
      if (temp_53254.isBuilt ()) {
        temp_53254 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      }
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files ;
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1282)) ;
      {
        GGS_stringlist::cEnumerator enumerator_53554 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_53554 = NULL ;
        while (((operand_53554 = enumerator_53554.nextObject ()))) {
          macroValidPointer (operand_53554) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_53554->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        }
      }
    }
  }
