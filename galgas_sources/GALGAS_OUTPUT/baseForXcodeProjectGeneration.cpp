...
void routine_enter_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_pathExtension = constinArgument_inFileName.reader_pathExtension (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 750)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("pch"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        ...
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          ...
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("mm"))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
            ...
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
              ...
              const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("gif"))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
                ...
                const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("png"))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
                  ...
                  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                    ...
                    const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("plist"))).boolEnum () ;
                    if (kBoolTrue == test_9) {
                      {
                      ...
                      const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
                      if (kBoolTrue == test_10) {
                        ...
                        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("icns"))).boolEnum () ;
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34468 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34468.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34468.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 788)) ;
    }
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37646 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37646.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37646.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 868)) ;
    }
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38076 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_38076.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38076.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 884)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38814 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38814.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38814.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 902)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  cEnumerator_stringlist enumerator_46225 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_46225.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)), enumerator_46225.current_mValue (HERE) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)) ;
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47730 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47730.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47730.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)).operator_concat (GALGAS_string ("\",\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)) ;
    enumerator_47730.gotoNextObject () ;
  }
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_51139 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_51139.hasCurrentObject () && bool_0) {
    ...
    while (enumerator_51139.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_51139.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1167)) ;
      enumerator_51139.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51407 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51407.hasCurrentObject () && bool_1) {
    ...
    while (enumerator_51407.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51407.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1173)) ;
      enumerator_51407.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51709 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51709.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51709.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51709.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1179)) ;
      enumerator_51709.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_52045 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1184)), kEnumeration_up) ;
  while (enumerator_52045.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_52045.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)).operator_concat (GALGAS_string (" */")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)) ;
    }
    ...
    cEnumerator_XcodeObjectReferenceList enumerator_52369 (enumerator_52045.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1192)), kEnumeration_up) ;
    while (enumerator_52369.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52369.current_mRefString (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (enumerator_52369.current_mComment (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)) ;
      enumerator_52369.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_length (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_52045.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_52045.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_52045.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)) ;
    }
    ...
    enumerator_52045.gotoNextObject () ;
  }
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_53138 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_53138.hasCurrentObject () && bool_7) {
    ...
    while (enumerator_53138.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_53138.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (enumerator_53138.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1215)).operator_concat (function_getPBXFileReferenceKey (enumerator_53138.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (enumerator_53138.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\" */;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)) ;
      cEnumerator_stringlist enumerator_53580 (enumerator_53138.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53580.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53580.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)) ;
        enumerator_53580.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_53138.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1221)) ;
      ...
      cEnumerator_stringlist enumerator_53887 (enumerator_53138.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53887.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53887.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)).operator_concat (GALGAS_string (" /*  */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)) ;
        enumerator_53887.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)).operator_concat (enumerator_53138.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (enumerator_53138.current_mProductInstallPath (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (enumerator_53138.current_mProductName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (function_getPBXFileReferenceKey (enumerator_53138.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (var_productExtension  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)) ;
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_55066 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1251)), kEnumeration_up) ;
  while (enumerator_55066.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_55066.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (enumerator_55066.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)) ;
    enumerator_55066.gotoNextObject () ;
  }
  ...
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55349 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55349.hasCurrentObject () && bool_8) {
    ...
    while (enumerator_55349.hasCurrentObject () && bool_8) {
      ...
      enumerator_55349.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_56142 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_56142.hasCurrentObject () && bool_9) {
    ...
    while (enumerator_56142.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56142.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (enumerator_56142.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1280)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1281))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56524 (enumerator_56142.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1283)), kEnumeration_up) ;
      while (enumerator_56524.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56524.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)) ;
        enumerator_56524.gotoNextObject () ;
      }
      ...
      enumerator_56142.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56923 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56923.hasCurrentObject () && bool_10) {
  ...
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57827 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57827.hasCurrentObject () && bool_11) {
  ...
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58326 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58326.hasCurrentObject () && bool_12) {
  ...
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58879 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58879.hasCurrentObject () && bool_13) {
    ...
    while (enumerator_58879.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58879.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string (" /* Default */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1341))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)) ;
      cEnumerator_stringlist enumerator_59183 (enumerator_58879.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1343)), kEnumeration_up) ;
      while (enumerator_59183.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_59183.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)) ;
        enumerator_59183.gotoNextObject () ;
      }
      ...
      enumerator_58879.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59513 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1352)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59513.hasCurrentObject () && bool_14) {
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_62281 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_62281, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1418)) ;
      ...
      cEnumerator_stringlist enumerator_62502 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62502.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)).operator_concat (enumerator_62502.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)) ;
        {
        ...
        enumerator_62502.gotoNextObject () ;
      }
    }
  }
}
