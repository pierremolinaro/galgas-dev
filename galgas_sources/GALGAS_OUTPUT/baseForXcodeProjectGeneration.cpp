...
GALGAS_string function_getPBXFileReferenceKey (const GALGAS_uint & constinArgument_inSequenceNumber,
  ...
  result_outResult = constinArgument_inSequenceNumber.reader_string (SOURCE_FILE_AT_LINE (36)).reader_md_35_ (SOURCE_FILE_AT_LINE (36)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (36)) ;
//---
...
void routine_initXcodeProjectDescription (GALGAS_XcodeProjectDescription & outArgument_outDescription,
  ...
  outArgument_outDescription = GALGAS_XcodeProjectDescription::constructor_new (GALGAS_Xcode_5F_PBXFileReference_5F_map::constructor_emptyMap (SOURCE_FILE_AT_LINE (504)), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (505)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (506)), GALGAS_Xcode_5F_PBXGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (507)), GALGAS_Xcode_5F_PBXNativeTarget_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (508)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (509)), GALGAS_Xcode_5F_XCBuildConfiguration_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (510)), GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (511)), GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (512)), GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (513)), GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (514)), GALGAS_Xcode_5F_targetDependencyDescription_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (515)), GALGAS_Xcode_5F_PBXVariantGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (516)), GALGAS_uint ((uint32_t) 0U) COMMA_SOURCE_FILE_AT_LINE (503)) ;
}
...
void routine_enter_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (534)), constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (533)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (540)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (541)), inCompiler COMMA_SOURCE_FILE_AT_LINE (541)), constinArgument_inGroupName COMMA_SOURCE_FILE_AT_LINE (541)) ;
}
...
void routine_enter_5F_subgroup (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                C_Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (558)), constinArgument_inSubGroupName, constinArgument_inSubGroupPath, constinArgument_inSubGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (557)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (563)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (564)) ;
  ioArgument_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (565)), inCompiler COMMA_SOURCE_FILE_AT_LINE (565)), constinArgument_inSubGroupName COMMA_SOURCE_FILE_AT_LINE (565)) ;
}
...
void routine_append_5F_cpp_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                          ...
                                          C_Compiler * /* inCompiler */
                                          COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".cpp") COMMA_SOURCE_FILE_AT_LINE (571)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)) ;
}
...
void routine_append_5F_m_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                        ...
                                        C_Compiler * /* inCompiler */
                                        COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (578)) COMMA_SOURCE_FILE_AT_LINE (578)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
}
...
void routine_append_5F_mm_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                         ...
                                         C_Compiler * /* inCompiler */
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".mm") COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_SOURCE_FILE_AT_LINE (585)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)) ;
}
...
void routine_enter_5F_cpp_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (596)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (597)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (597)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (600)), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (600)) ;
}
...
void routine_enter_5F_h_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (610)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (611)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (611)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (612)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (614)), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (614)) ;
}
...
void routine_enter_5F_pch_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (624)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (625)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (625)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (626)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (628)), inCompiler COMMA_SOURCE_FILE_AT_LINE (628)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (628)) ;
}
...
void routine_enter_5F_m_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (638)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (639)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (639)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (640)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (642)), inCompiler COMMA_SOURCE_FILE_AT_LINE (642)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (642)) ;
}
...
void routine_enter_5F_mm_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (652)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (653)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (653)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (654)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (655)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (656)), inCompiler COMMA_SOURCE_FILE_AT_LINE (656)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (656)) ;
}
...
void routine_enter_5F_gif_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (666)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_gifFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_gifFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (667)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (667)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (670)), inCompiler COMMA_SOURCE_FILE_AT_LINE (670)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (670)) ;
}
...
void routine_enter_5F_tiff_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (680)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (681)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (681)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (682)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (684)), inCompiler COMMA_SOURCE_FILE_AT_LINE (684)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (684)) ;
}
...
void routine_enter_5F_png_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (694)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pngFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pngFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (695)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (695)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (696)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (697)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (698)), inCompiler COMMA_SOURCE_FILE_AT_LINE (698)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (698)) ;
}
...
void routine_enter_5F_plist_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (708)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_plistFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (709)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (709)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (711)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (712)), inCompiler COMMA_SOURCE_FILE_AT_LINE (712)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (712)) ;
}
...
void routine_enter_5F_framework_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (722)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (723)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (723)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (724)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (726)), inCompiler COMMA_SOURCE_FILE_AT_LINE (726)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (726)) ;
}
...
void routine_enter_5F_icns_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (736)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (737)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (737)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (738)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (740)), inCompiler COMMA_SOURCE_FILE_AT_LINE (740)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (740)) ;
}
...
void routine_enter_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_extension = constinArgument_inFileName.reader_pathExtension (SOURCE_FILE_AT_LINE (750)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_enter_5F_cpp_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (752)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      routine_enter_5F_h_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (754)) ;
      }
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("pch"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_enter_5F_pch_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (756)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          routine_enter_5F_m_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (758)) ;
          }
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
            routine_enter_5F_mm_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (760)) ;
            }
          }else if (kBoolFalse == test_4) {
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
              routine_enter_5F_tiff_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
              }
            }else if (kBoolFalse == test_5) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("gif"))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
                routine_enter_5F_gif_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
                }
              }else if (kBoolFalse == test_6) {
                const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("png"))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
                  routine_enter_5F_png_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (766)) ;
                  }
                }else if (kBoolFalse == test_7) {
                  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                    routine_enter_5F_xib_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("."), constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (768)) ;
                    }
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34314 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34314.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34314.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) ;
    }
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (808)).reader_string (SOURCE_FILE_AT_LINE (808)).reader_md_35_ (SOURCE_FILE_AT_LINE (808)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (808)) ;
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (834)).reader_string (SOURCE_FILE_AT_LINE (834)).reader_md_35_ (SOURCE_FILE_AT_LINE (834)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (834)) ;
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37484 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37484.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37484.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (868)) ;
    }
    enumerator_37484.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37920 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37920.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37920.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (884)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ...
    enumerator_37920.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38658 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38658.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38658.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (902)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (940)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (965)).reader_string (SOURCE_FILE_AT_LINE (965)).reader_md_35_ (SOURCE_FILE_AT_LINE (965)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (965)) ;
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_Xcode_5F_PBXCopyBuildPhase var_copyBuildPhase = GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1039)), GALGAS_string::makeEmptyString (), GALGAS_uint ((uint32_t) 1U), GALGAS_string ("Contents/Library/LaunchServices"), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_listWithValue (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1043)) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  ...
  cEnumerator_stringlist enumerator_46037 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_46037.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1063)), enumerator_46037.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    ...
    enumerator_46037.gotoNextObject () ;
  }
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1070)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1071)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1071)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1069)) ;
  ...
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1077)).reader_string (SOURCE_FILE_AT_LINE (1077)).reader_md_35_ (SOURCE_FILE_AT_LINE (1077)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (1077)) ;
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47538 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47538.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47538.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1102)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1102)) COMMA_SOURCE_FILE_AT_LINE (1102)) ;
  ...
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_DEPRECATED_FUNCTIONS = NO;") COMMA_SOURCE_FILE_AT_LINE (1118)) ;
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50953 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_50953.hasCurrentObject () && bool_0) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    while (enumerator_50953.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50953.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  ...
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51221 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51221.hasCurrentObject () && bool_1) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    while (enumerator_51221.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51221.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      enumerator_51221.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1174)) ;
  }
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51523 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51523.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51523.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51523.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      enumerator_51523.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51859 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1184)), kEnumeration_up) ;
  while (enumerator_51859.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51859.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1185)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    }
    ...
    cEnumerator_XcodeObjectReferenceList enumerator_52179 (enumerator_51859.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1192)), kEnumeration_up) ;
    while (enumerator_52179.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52179.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (enumerator_52179.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      enumerator_52179.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1197)).reader_length (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51859.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51859.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51859.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)) ;
    }
    ...
    enumerator_51859.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXGroup section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1209)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52948 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_52948.hasCurrentObject () && bool_7) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    while (enumerator_52948.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52948.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (enumerator_52948.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (function_getPBXFileReferenceKey (enumerator_52948.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1216)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (enumerator_52948.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
      cEnumerator_stringlist enumerator_53386 (enumerator_52948.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53386.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53386.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
        enumerator_53386.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52948.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1221)) ;
      ...
      cEnumerator_stringlist enumerator_53683 (enumerator_52948.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53683.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53683.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1227)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        enumerator_53683.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1229)).operator_concat (enumerator_52948.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (enumerator_52948.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (enumerator_52948.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (function_getPBXFileReferenceKey (enumerator_52948.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1233)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
      enumerator_52948.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54858 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1251)), kEnumeration_up) ;
  while (enumerator_54858.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54858.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (enumerator_54858.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
    enumerator_54858.gotoNextObject () ;
  }
  ...
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55141 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55141.hasCurrentObject () && bool_8) {
    ...
    while (enumerator_55141.hasCurrentObject () && bool_8) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55141.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1261)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (enumerator_55141.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55523 (enumerator_55141.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1266)), kEnumeration_up) ;
      while (enumerator_55523.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55523.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)) ;
        enumerator_55523.gotoNextObject () ;
      }
  ...
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55926 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_55926.hasCurrentObject () && bool_9) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    while (enumerator_55926.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55926.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1278)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (enumerator_55926.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1281)) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56304 (enumerator_55926.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1283)), kEnumeration_up) ;
      while (enumerator_56304.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56304.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)) ;
        enumerator_56304.gotoNextObject () ;
      }
      ...
      enumerator_55926.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1289)) ;
  }
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56699 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56699.hasCurrentObject () && bool_10) {
    ...
    while (enumerator_56699.hasCurrentObject () && bool_10) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56699.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1295)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (enumerator_56699.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE_AT_LINE (1299)) COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (enumerator_56699.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE_AT_LINE (1300)).reader_string (SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57204 (enumerator_56699.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1302)), kEnumeration_up) ;
      while (enumerator_57204.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57204.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)) ;
        enumerator_57204.gotoNextObject () ;
      }
      ...
      enumerator_56699.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57595 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57595.hasCurrentObject () && bool_11) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    while (enumerator_57595.hasCurrentObject () && bool_11) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57595.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1314)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1314)) COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1316)).operator_concat (enumerator_57595.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  ...
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58090 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58090.hasCurrentObject () && bool_12) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1323)) ;
    while (enumerator_58090.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58090.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (enumerator_58090.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (enumerator_58090.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (enumerator_58090.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1332)) COMMA_SOURCE_FILE_AT_LINE (1325)) ;
      enumerator_58090.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58643 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58643.hasCurrentObject () && bool_13) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
    while (enumerator_58643.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58643.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1340)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
      cEnumerator_stringlist enumerator_58943 (enumerator_58643.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1343)), kEnumeration_up) ;
      while (enumerator_58943.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58943.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1344)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
        enumerator_58943.gotoNextObject () ;
      }
  ...
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59273 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1352)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59273.hasCurrentObject () && bool_14) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    while (enumerator_59273.hasCurrentObject () && bool_14) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59273.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1355)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1358)).operator_concat (function_getPBXFileReferenceKey (enumerator_59273.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1359)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1362)) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      enumerator_59273.gotoNextObject () ;
    }
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_62025_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_62025_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      ...
      cEnumerator_stringlist enumerator_62246 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62246.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1422)).operator_concat (enumerator_62246.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
        {
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
        }
        enumerator_62246.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.mach-o.executable\"; includeInIndex = 0; path = ") COMMA_SOURCE_FILE_AT_LINE (62)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n") COMMA_SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (62)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_Application_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (81)) COMMA_SOURCE_FILE_AT_LINE (81)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.wrapper.application\"; includeInIndex = 0; path = ") COMMA_SOURCE_FILE_AT_LINE (81)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (82)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n") COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (81)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_cppSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; name = ") COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (96)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (94)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_hSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; name = ") COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (110)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pchSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (122)) COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (122)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.pch; name = ") COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (124)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (122)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (136)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.obj; name = ") COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (138)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (136)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mmSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (150)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (151)) COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.objcpp; name = ") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (152)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (152)) COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_gifFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.gif; name = ") COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (166)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (164)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_tiffFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (178)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.tiff; name = ") COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (180)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (178)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pngFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.png; name = ") COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (194)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (206)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.plist; name = ") COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (208)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (208)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (206)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_frameworkFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.framework; name = ") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (222)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (223)) COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (223)) COMMA_SOURCE_FILE_AT_LINE (220)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_icnsFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (234)) COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.icns; name = ") COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (236)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (236)) COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (234)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_xibFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.xib; name = ") COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (251)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (249)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistStringFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = text.plist.strings; name = ") COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (266)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (264)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXBuildFile_buildXcodeProject (const cPtr_Xcode_5F_PBXBuildFile * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (object->mAttribute_mSourceFile.reader_mFileName (SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string (" */ ") COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string ("= {isa = PBXBuildFile; fileRef = ") COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSourceFile.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (294)), inCompiler COMMA_SOURCE_FILE_AT_LINE (294)) COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string (" ; settings = {ATTRIBUTES = (); }; };\n") COMMA_SOURCE_FILE_AT_LINE (294)) COMMA_SOURCE_FILE_AT_LINE (293)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string (" /* Frameworks */ = {\n") COMMA_SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string ("\t\t\tisa = PBXFrameworksBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (375)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (375)) ;
  ...
  while (enumerator_17037.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17037.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (380)), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) COMMA_SOURCE_FILE_AT_LINE (380)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (380)).operator_concat (enumerator_17037.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE_AT_LINE (381)).reader_mFileName (SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (380)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (380)) ;
    enumerator_17037.gotoNextObject () ;
  }
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
}
//-----------------------------------------------------------------------------*
