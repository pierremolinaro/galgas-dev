...
void routine_buildXcodeProjectString (C_Compiler & _inLexique,
  ...
  var_cas_outString.appendCString ("/* Begin PBXGroup section */\n") ;
  {
    ...
    while (((operand_43444 = enumerator_43444.nextObject ()))) {
      ...
      if (((operand_43444->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1044)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
      ...
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      if (((operand_43444->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1054)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        if (((operand_43444->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)).reader_componentsSeparatedByString (_inLexique, GGS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1055)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
      ...
      if (((operand_43444->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (1061)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_written).isBuiltAndTrue ()) {
      ...
      if (_temp_52091.isBuilt ()) {
        _temp_52091 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string ("/project.pbxproj")), automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1252)) ;
      }
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      ...
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1256)) ;
      {
        ...
        while (((operand_52391 = enumerator_52391.nextObject ()))) {
          ...
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string ("/")))._operator_concat (operand_52391->mValue) ;
