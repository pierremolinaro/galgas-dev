...
//                    november 12th, 2009, at 19h16'53"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_enter_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_extension = var_cas_inFileName.reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (675)) ;
...
void routine_enter_xib_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_xibFile  var_cas_ref = GGS_Xcode_PBXFileReference_xibFile ::constructor_new (inLexique, var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (724)), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_xib_fileName) COMMA_HERE) ;
  ...
  GGS_string var_cas_PBXVariantGroupKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (729)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (729)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (729)) ;
...
void routine_enter_plist_strings_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_plistStringFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistStringFile ::constructor_new (inLexique, var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_plist_string_fileName) COMMA_HERE) ;
  ...
  GGS_string var_cas_PBXVariantGroupKey = GGS_uint ::constructor_sequenceNumber (inLexique COMMA_HERE).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (752)).reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (752)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (752)) ;
...
void routine_add_tool_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_37123 = (var_cas_inFrameworkKeyList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (907))).operator_strictSup (GGS_uint (0U)) ;
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_rootObjectKey = GGS_string ("project").reader_md5 (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)).reader_rightSubString (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (1074)) ;
  ...
  var_cas_outString.appendCString ("/* Begin PBXGroup section */\n") ;
  {
    ...
    while (((operand_46011 = enumerator_46011.nextObject ()))) {
      ...
      if (cond_46770.isBuiltAndTrue ()) {
        const GGS_bool cond_46678 = (operand_46011->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1116)).reader_componentsSeparatedByString (inLexique, GGS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1116)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1116))).operator_strictSup (GGS_uint (1U)) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (1280)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (1280)) ;
  ...
  if (cond_55071.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_54679 = (var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (1309))).operator_not ()) ;
    ...
    if (cond_55060.isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1314)) ;
      {
