...
GALGAS_string function_getPBXFileReferenceKey (const GALGAS_uint & constinArgument_inSequenceNumber,
  ...
  result_outResult = constinArgument_inSequenceNumber.reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 36)).reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 36)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 36)) ;
//---
...
static GALGAS_object functionWithGenericHeader_getPBXFileReferenceKey (C_Compiler * inCompiler,
  ...
  const GALGAS_uint operand0 = GALGAS_uint::extractObject (inEffectiveParameterArray.objectAtIndex (0 COMMA_HERE),
                                                           inCompiler
                                                           COMMA_THERE) ;
  return function_getPBXFileReferenceKey (operand0,
                                          inCompiler
...
class cCollectionElement_Xcode_5F_PBXCopyBuildPhase_5F_list : public cCollectionElement {
  public : GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element mObject ;
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list::current (LOCATION_ARGS) const {
...
void routine_initXcodeProjectDescription (GALGAS_XcodeProjectDescription & outArgument_outDescription,
  ...
  outArgument_outDescription = GALGAS_XcodeProjectDescription::constructor_new (GALGAS_Xcode_5F_PBXFileReference_5F_map::constructor_emptyMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 504)), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 505)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 506)), GALGAS_Xcode_5F_PBXGroup_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 507)), GALGAS_Xcode_5F_PBXNativeTarget_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 508)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 509)), GALGAS_Xcode_5F_XCBuildConfiguration_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 510)), GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 511)), GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 512)), GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 513)), GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 514)), GALGAS_Xcode_5F_targetDependencyDescription_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 515)), GALGAS_Xcode_5F_PBXVariantGroup_5F_list::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 516)), GALGAS_uint ((uint32_t) 0U)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 503)) ;
}
...
void routine_enter_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 534)), constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inGroupContentsKeyList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 533)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 539)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 540)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 541)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 541)), constinArgument_inGroupName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 541)) ;
}
...
void routine_enter_5F_subgroup (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                C_Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 558)), constinArgument_inSubGroupName, constinArgument_inSubGroupPath, constinArgument_inSubGroupContentsKeyList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 557)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 563)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 564)) ;
  ioArgument_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 565)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 565)), constinArgument_inSubGroupName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 565)) ;
}
...
void routine_append_5F_cpp_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                          ...
                                          C_Compiler * /* inCompiler */
                                          COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 571))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 571)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 572))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 572)) ;
}
...
void routine_append_5F_m_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                        ...
                                        C_Compiler * /* inCompiler */
                                        COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".m")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 578))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 578)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 579))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 579)) ;
}
...
void routine_append_5F_mm_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                         ...
                                         C_Compiler * /* inCompiler */
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".mm")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 585))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 585)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 586))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 586)) ;
}
...
void routine_enter_5F_cpp_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 596)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 597)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 597)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 598)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 599)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 600)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 600)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 600)) ;
}
...
void routine_enter_5F_h_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 610)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 611)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 611)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 612)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 613)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 614)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 614)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 614)) ;
}
...
void routine_enter_5F_pch_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 624)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 625)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 625)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 626)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 627)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 628)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 628)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 628)) ;
}
...
void routine_enter_5F_m_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 638)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 639)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 639)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 640)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 641)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 642)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 642)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 642)) ;
}
...
void routine_enter_5F_mm_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 652)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 653)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 653)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 654)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 655)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 656)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 656)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 656)) ;
}
...
void routine_enter_5F_gif_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 666)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_gifFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_gifFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 667)), constinArgument_inFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 667)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 668)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 669)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 670)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 670)), constinArgument_inFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 670)) ;
}
...
void routine_enter_5F_tiff_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 680)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 681)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 681)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 682)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 683)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 684)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 684)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 684)) ;
}
...
void routine_enter_5F_png_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 694)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pngFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pngFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 695)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 695)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 696)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 697)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 698)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 698)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 698)) ;
}
...
void routine_enter_5F_plist_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 708)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_plistFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 709)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 709)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 710)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 711)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 712)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 712)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 712)) ;
}
...
void routine_enter_5F_framework_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 722)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 723)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 723)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 724)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 725)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 726)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 726)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 726)) ;
}
...
void routine_enter_5F_icns_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 736)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 737)), constinArgument_inCppFile COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 737)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 738)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 739)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 740)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 740)), constinArgument_inCppFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 740)) ;
}
...
void routine_enter_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_extension = constinArgument_inFileName.reader_pathExtension (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 750)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_enter_5F_cpp_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 752)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      routine_enter_5F_h_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 754)) ;
      }
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("pch"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_enter_5F_pch_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 756)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          routine_enter_5F_m_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 758)) ;
          }
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
            routine_enter_5F_mm_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 760)) ;
            }
          }else if (kBoolFalse == test_4) {
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
              routine_enter_5F_tiff_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 762)) ;
              }
            }else if (kBoolFalse == test_5) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("gif"))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
                routine_enter_5F_gif_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 764)) ;
                }
              }else if (kBoolFalse == test_6) {
                const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("png"))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
                  routine_enter_5F_png_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 766)) ;
                  }
                }else if (kBoolFalse == test_7) {
                  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                    routine_enter_5F_xib_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("."), constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 768)) ;
                    }
                  }else if (kBoolFalse == test_8) {
                    const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("plist"))).boolEnum () ;
                    if (kBoolTrue == test_9) {
                      {
                      routine_enter_5F_plist_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 770)) ;
                      }
                    }else if (kBoolFalse == test_9) {
                      const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
                      if (kBoolTrue == test_10) {
                        {
                        routine_enter_5F_framework_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 772)) ;
                        }
                      }else if (kBoolFalse == test_10) {
                        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("icns"))).boolEnum () ;
                        if (kBoolTrue == test_11) {
                          {
                          routine_enter_5F_icns_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 774)) ;
                          }
                        }else if (kBoolFalse == test_11) {
                          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("cannot enter '").operator_concat (constinArgument_inFileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 776)).operator_concat (GALGAS_string ("' file : unknown extension")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 776))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 776)) ;
                        }
                      }
                    }
                  }
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34248 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34248.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34248.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 788)) ;
    }
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  const GALGAS_string constinArgument_in_5F_lproj_5F_dir,
                                                  const GALGAS_string constinArgument_in_5F_xib_5F_fileName,
                                                  GALGAS_XcodeObjectReferenceList & ioArgument_ioFileListForGroup,
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXFileReference_5F_xibFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_xibFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 801)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 802)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 803)).operator_concat (constinArgument_in_5F_xib_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 803)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 800)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 805)) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_xib_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 806)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 807)) ;
  }
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 808)).reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 808)).reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 808)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 808)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 809)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 812)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 812)), constinArgument_in_5F_xib_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 810)) ;
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_xib_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 815)) ;
}
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 827)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 828)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 829)).operator_concat (constinArgument_in_5F_plist_5F_string_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 829)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 826)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 831)) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_plist_5F_string_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 832)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 833)) ;
  }
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 834)).reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 834)).reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 834)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 834)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 835)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 838)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 838)), constinArgument_in_5F_plist_5F_string_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 836)) ;
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_plist_5F_string_5F_fileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 841)) ;
}
...
void routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                ...
                                                                C_Compiler * inCompiler
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 851)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
  ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 853)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 853)) ;
  GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 854)), var_ref COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 854)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 855)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 856)) ;
  ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 857)) ;
}
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37418 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37418.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37418.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 868)) ;
    }
    enumerator_37418.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37848 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37848.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37848.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 884)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 886)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 886)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 887)), var_ref COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 887)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 888)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 889)) ;
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 890)) ;
    enumerator_37848.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38586 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38586.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38586.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 902)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 904)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 904)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 905)), var_ref COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 905)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 906)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 907)) ;
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 908)) ;
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 925)), constinArgument_inProductFileName COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 925)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 926)) ;
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 927)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 928)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 930)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 930)), constinArgument_inTargetName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 930)) ;
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 933)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 932)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 937)) ;
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_listWithValue (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 938)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 938)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 938)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 940)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 942)), GALGAS_string ("Frameworks"), constinArgument_inFrameworkKeyList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 941)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 946)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 947)) ;
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 948)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 948))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 948)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 951)) ;
  ...
  if (kBoolTrue == test_1) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 953)) ;
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 954)).operator_concat (GALGAS_string ("\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 954))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 954)) ;
  }
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 956)).operator_concat (GALGAS_string ("\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 956))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 956)) ;
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 958)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 959)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 959)), inArgument_inTargetSettings COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 957)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 962)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 963)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 964)) ;
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 965)).reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 965)).reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 965)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 965)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 966)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mTargetList.addAssign_operation (outArgument_outTargetKey, constinArgument_inTargetName, var_toolTargetBuildConfiguration, GALGAS_string ("$(HOME)/bin"), constinArgument_inProductFileName, var_toolFileReference, var_buildPhases, constinArgument_inDirectDependencyList  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 967)) ;
}
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                   ...
                                   const GALGAS_stringlist constinArgument_inDirectDependencyList,
                                   const GALGAS_string constinArgument_inFileToCopyInWrapperLaunchServices,
                                   GALGAS_string & outArgument_outTargetKey,
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outTargetKey.drop () ; // Release 'out' argument
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 995)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_Application var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_Application::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 997)), constinArgument_inProductFileName COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 997)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 998)) ;
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 999)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1000)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1002)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1002)), constinArgument_inTargetName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1002)) ;
  GALGAS_Xcode_5F_PBXResourcesBuildPhase var_resourcesBuildPhase = GALGAS_Xcode_5F_PBXResourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1005)), GALGAS_string ("Resources"), constinArgument_inResourcesToCompileList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1004)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1009)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXResourcesBuildPhase_5F_list.addAssign_operation (var_resourcesBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1010)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_resourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1011)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1011))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1011)) ;
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1014)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1013)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1018)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1019)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1020)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1020))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1020)) ;
  GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1023)), GALGAS_string ("Frameworks"), constinArgument_inFrameworksToCompileList COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1022)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1027)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1028)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1029)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1029))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1029)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inFileToCopyInWrapperLaunchServices.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1033)).method_searchKey (constinArgument_inFileToCopyInWrapperLaunchServices.reader_nowhere (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1033)), var_ref, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1033)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1035)), var_ref COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1035)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1036)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1037)) ;
    GALGAS_Xcode_5F_PBXCopyBuildPhase var_copyBuildPhase = GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1039)), GALGAS_string::makeEmptyString (), GALGAS_uint ((uint32_t) 1U), GALGAS_string ("Contents/Library/LaunchServices"), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_listWithValue (var_build_5F_file  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1043)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1038)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1045)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXCopyBuildPhase_5F_list.addAssign_operation (var_copyBuildPhase  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1046)) ;
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_copyBuildPhase.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1047)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1047))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1047)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inPrecompiledHeaderPath.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1051)) ;
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1052)).operator_concat (GALGAS_string ("\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1052))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1052)) ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, constinArgument_inInfoPListFile.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_2) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("INFOPLIST_FILE = \"").operator_concat (constinArgument_inInfoPListFile  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1055)).operator_concat (GALGAS_string ("\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1055))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1055)) ;
  }
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1057)) ;
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PROTOTYPE_CONVERSION = NO;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1058)) ;
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1059)).operator_concat (GALGAS_string ("\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1059))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1059)) ;
  GALGAS_stringlist var_targetDependencyKeyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1061)) ;
  cEnumerator_stringlist enumerator_45965 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_45965.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)), enumerator_45965.current_mValue (HERE) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1064)) ;
    var_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_d.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1065)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1065))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1065)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mDependencyList.addAssign_operation (var_d  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1066)) ;
    enumerator_45965.gotoNextObject () ;
  }
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1070)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1071)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1071)), inArgument_inTargetSettings COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1069)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1074)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1075)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1076)) ;
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1077)).reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1077)).reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1077)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1077)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1078)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mTargetList.addAssign_operation (outArgument_outTargetKey, constinArgument_inTargetName, var_toolTargetBuildConfiguration, GALGAS_string ("$(HOME)/bin"), constinArgument_inProductFileName, var_toolFileReference, var_buildPhases, var_targetDependencyKeyList  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1079)) ;
}
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47466 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47466.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47466.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)).operator_concat (GALGAS_string ("\",\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)) ;
    enumerator_47466.gotoNextObject () ;
  }
  outArgument_outProjectDefaultSettings = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1104)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ALWAYS_SEARCH_USER_PATHS = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1105)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ARCHS = \"$(ARCHS_STANDARD_64_BIT)\";")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1106)) ;
  const enumGalgasBool test_0 = constinArgument_inUsesARC.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_ENABLE_OBJC_ARC = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1108)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1110)) ;
  }
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1112)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1113)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1114)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1115)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_WARNINGS_AS_ERRORS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1116)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_64_TO_32_BIT_CONVERSION = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1117)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_DEPRECATED_FUNCTIONS = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1118)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1119)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_WARN_SUSPICIOUS_IMPLICIT_CONVERSION = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1120)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_NEWLINE = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1121)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_PROTOTYPES = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1122)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_RETURN_TYPE = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1123)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_CHECK_SWITCH_STATEMENTS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1124)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1125)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1126)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INHIBIT_ALL_WARNINGS = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1127)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1128)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_MISSING_PARENTHESES = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1129)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1130)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PEDANTIC = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1131)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SHADOW = NO;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1132)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SIGN_COMPARE = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1133)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1134)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNINITIALIZED_AUTOS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1135)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNKNOWN_PRAGMAS = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1136)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_FUNCTION = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1137)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_LABEL = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1138)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1139)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VALUE = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1140)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VARIABLE = YES;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1141)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("HEADER_SEARCH_PATHS = (\n").operator_concat (var_pathString  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1142)).operator_concat (GALGAS_string ("\t\t\t\t);")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1142))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1142)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("SDKROOT = ").operator_concat (constinArgument_inSDK  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1143)).operator_concat (GALGAS_string (" ;")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1143))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1143)) ;
}
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1155)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1155)) ;
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1157)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1158)).operator_concat (GALGAS_string ("\tclasses = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1159)).operator_concat (GALGAS_string ("\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1160)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1161)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1162)) ;
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50875 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_50875.hasCurrentObject () && bool_0) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1166)) ;
    while (enumerator_50875.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50875.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1167)) ;
      enumerator_50875.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXBuildFile section */\n"
      "\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1168)) ;
  }
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51143 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51143.hasCurrentObject () && bool_1) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1172)) ;
    while (enumerator_51143.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51143.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1173)) ;
      enumerator_51143.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1174)) ;
  }
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51445 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51445.hasCurrentObject () && bool_2) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFrameworksBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1178)) ;
    while (enumerator_51445.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51445.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1179)) ;
      enumerator_51445.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFrameworksBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1180)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXGroup section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1183)) ;
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51781 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1184)), kEnumeration_up) ;
  while (enumerator_51781.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51781.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)).operator_concat (GALGAS_string (" */")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)) ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1189)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1190))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1189)) ;
    cEnumerator_XcodeObjectReferenceList enumerator_52101 (enumerator_51781.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1192)), kEnumeration_up) ;
    while (enumerator_52101.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52101.current_mRefString (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (enumerator_52101.current_mComment (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)) ;
      enumerator_52101.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_length (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51781.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51781.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51781.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)) ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n").operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1206))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1206)) ;
    enumerator_51781.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXGroup section */\n"
    "\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1209)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52870 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_52870.hasCurrentObject () && bool_7) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1212)) ;
    while (enumerator_52870.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52870.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (enumerator_52870.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1215)).operator_concat (function_getPBXFileReferenceKey (enumerator_52870.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (enumerator_52870.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\" */;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)) ;
      cEnumerator_stringlist enumerator_53308 (enumerator_52870.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53308.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53308.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)) ;
        enumerator_53308.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52870.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1221)) ;
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1222)).operator_concat (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1223)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1224))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1222)) ;
      cEnumerator_stringlist enumerator_53605 (enumerator_52870.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53605.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53605.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)).operator_concat (GALGAS_string (" /*  */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)) ;
        enumerator_53605.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)).operator_concat (enumerator_52870.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (enumerator_52870.current_mProductInstallPath (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (enumerator_52870.current_mProductName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (function_getPBXFileReferenceKey (enumerator_52870.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (var_productExtension  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)) ;
      enumerator_52870.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1237)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1240)).operator_concat (var_rootObjectKey  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1241)).operator_concat (GALGAS_string (" /* Project object */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1241)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1241)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1242)).operator_concat (constinArgument_inProjectDefaultConfigurationKey  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1243)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1243)).operator_concat (constinArgument_inProjectName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1244)).operator_concat (GALGAS_string ("\" */;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1244)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1244)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1245)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1246)).operator_concat (constinArgument_inMainGroupKey  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1247)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1247)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1247)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1248)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1249))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1240)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54780 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1251)), kEnumeration_up) ;
  while (enumerator_54780.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54780.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (enumerator_54780.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)) ;
    enumerator_54780.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1254)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1255))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1254)) ;
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55063 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55063.hasCurrentObject () && bool_8) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXResourcesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1259)) ;
    while (enumerator_55063.hasCurrentObject () && bool_8) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55063.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1261)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1261))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1261)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1261)).operator_concat (enumerator_55063.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1262))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1262)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1262)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1262)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1263)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1264))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1261)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55445 (enumerator_55063.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1266)), kEnumeration_up) ;
      while (enumerator_55445.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55445.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1267)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1267))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1267)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1267))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1267)) ;
        enumerator_55445.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1269)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1270))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1269)) ;
      enumerator_55063.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXResourcesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1272)) ;
  }
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55848 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_55848.hasCurrentObject () && bool_9) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1276)) ;
    while (enumerator_55848.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55848.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (enumerator_55848.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1280)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1281))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56226 (enumerator_55848.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1283)), kEnumeration_up) ;
      while (enumerator_56226.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56226.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)) ;
        enumerator_56226.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1286)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1287))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1286)) ;
      enumerator_55848.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1289)) ;
  }
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56621 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56621.hasCurrentObject () && bool_10) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXCopyFilesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1293)) ;
    while (enumerator_56621.hasCurrentObject () && bool_10) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56621.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1295)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1295))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1295)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1295)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1296)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1297)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1298)).operator_concat (enumerator_56621.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1299))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1299)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1299)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1299)).operator_concat (enumerator_56621.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1300)).reader_string (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1300))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1300)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1300)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1300))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1295)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57126 (enumerator_56621.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1302)), kEnumeration_up) ;
      while (enumerator_57126.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57126.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1303)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1303))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1303)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1303))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1303)) ;
        enumerator_57126.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1305)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1306))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1305)) ;
      enumerator_56621.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1308)) ;
  }
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57517 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57517.hasCurrentObject () && bool_11) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1312)) ;
    while (enumerator_57517.hasCurrentObject () && bool_11) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57517.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1314)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1314))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1314)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1314)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1315)).operator_concat (GALGAS_string ("\t\t\ttarget = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1316)).operator_concat (enumerator_57517.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1317))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1317)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1317)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1317))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1314)) ;
      enumerator_57517.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1319)) ;
  }
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58012 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58012.hasCurrentObject () && bool_12) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1323)) ;
    while (enumerator_58012.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58012.current_mPBXVariantKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)).operator_concat (enumerator_58012.current_mName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1327)).operator_concat (GALGAS_string ("\t\t\t\t")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1328)).operator_concat (enumerator_58012.current_mPBXFileReferenceKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string ("\t\t\tname = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1330)).operator_concat (enumerator_58012.current_mName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1332))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)) ;
      enumerator_58012.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1334)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58565 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58565.hasCurrentObject () && bool_13) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1338)) ;
    while (enumerator_58565.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58565.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string (" /* Default */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1341))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)) ;
      cEnumerator_stringlist enumerator_58865 (enumerator_58565.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1343)), kEnumeration_up) ;
      while (enumerator_58865.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58865.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)) ;
        enumerator_58865.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1346)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1347))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1346)) ;
      enumerator_58565.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCBuildConfiguration section */\n"
      "\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1349)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59195 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1352)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59195.hasCurrentObject () && bool_14) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1353)) ;
    while (enumerator_59195.hasCurrentObject () && bool_14) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59195.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355)).operator_concat (constinArgument_inProjectName  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355)).operator_concat (GALGAS_string ("\" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1356)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1356)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1357)).operator_concat (GALGAS_string ("\t\t\t\t")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1358)).operator_concat (function_getPBXFileReferenceKey (enumerator_59195.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1359)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1359))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1359)).operator_concat (GALGAS_string (" /* Default */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1359)).operator_concat (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1359)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1360)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1361)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1362))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1355)) ;
      enumerator_59195.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCConfigurationList section */\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1364)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1367)).operator_concat (var_rootObjectKey  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1368)).operator_concat (GALGAS_string (" /* Project object */;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1368)).operator_concat (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1368))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1367)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                C_Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectName = constinArgument_in_5F_xcodeproj_5F_filePath.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1380)).reader_stringByDeletingPathExtension (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1380)) ;
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1383)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1384)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1384)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1382)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1387)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1388)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_defaultProjectConfiguration  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1389)) ;
  {
  routine_enter_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("Products"), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mProductGroupChildrenList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1395)), inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1391)) ;
  }
  GALGAS_Xcode_5F_PBXGroup var_mainGroup = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1398)), GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mMainGroupChildrenList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1398)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1398)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1399)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_mainGroup  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1400)) ;
  GALGAS_string var_fileNewContents ;
  {
  routine_buildXcodeProjectString (ioArgument_ioXcodeProjectDescription, var_projectName, function_getPBXFileReferenceKey (var_mainGroup.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1406)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1406)), function_getPBXFileReferenceKey (var_defaultProjectConfiguration.reader_mSequenceNumber_32_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1407)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1407)), var_fileNewContents, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1403)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1410)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    constinArgument_in_5F_xcodeproj_5F_filePath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1412)) ;
    GALGAS_bool var_written ;
    var_fileNewContents.method_writeToFileWhenDifferentContents (constinArgument_inReferenceFilePath, var_written, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1415)) ;
    GALGAS_string var_pbxprojFilePath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/project.pbxproj")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1416)) ;
    const enumGalgasBool test_1 = var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1417)).operator_not (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1417)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1417)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_61947_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_61947_0, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1418)) ;
      GALGAS_stringlist var_pbxuser_5F_files = constinArgument_in_5F_xcodeproj_5F_filePath.reader_regularFilesWithExtensions (GALGAS_bool (false), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("pbxuser")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1420)) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1420)) ;
      cEnumerator_stringlist enumerator_62168 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62168.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)).operator_concat (enumerator_62168.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)) ;
        {
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1423)) ;
        }
...
void GALGAS_Xcode_5F_PBXCopyBuildPhase::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_Xcode_5F_PBXCopyBuildPhase * p = (cPtr_Xcode_5F_PBXCopyBuildPhase *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_Xcode_5F_PBXCopyBuildPhase) ;
    cPtr_Xcode_5F_PBXCopyBuildPhase * r = NULL ;
    macroMyNew (r, cPtr_Xcode_5F_PBXCopyBuildPhase (p->mAttribute_mSequenceNumber, p->mAttribute_mNameForComment, p->mAttribute_mDestinationSubfolder, p->mAttribute_mDestinationPath, p->mAttribute_mFileReferenceList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 62))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 62)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.mach-o.executable\"; includeInIndex = 0; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 62)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 64))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 63)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 64))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 62)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_Application_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 81))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 81)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.wrapper.application\"; includeInIndex = 0; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 81)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 83))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 82)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 83))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 81)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_cppSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 94))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 94)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 94)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 95))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 95)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 95)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 96)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 96))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 95)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 96)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 97))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 96)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 97))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 94)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_hSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 108))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 108)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 108)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 109))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 109)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 109)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 110)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 110))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 109)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 110)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 111))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 110)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 111))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 108)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pchSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 122))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 122)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 122)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 123))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 123)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.pch; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 123)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 124)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 124))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 123)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 124)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 125))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 124)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 125))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 122)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 136))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 136)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 136)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 137))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 137)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.obj; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 137)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 138)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 138))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 137)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 138)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 139))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 138)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 139))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 136)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mmSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 150))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 150)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 150)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 151))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 151)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.objcpp; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 151)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 152)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 152))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 151)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 152)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 153))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 152)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 153))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 150)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_gifFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 164))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 164)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 164)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 165))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 165)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.gif; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 165)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 166)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 166))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 165)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 166)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 167))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 166)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 167))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 164)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_tiffFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 178))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 178)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 178)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 179))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 179)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.tiff; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 179)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 180)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 180))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 179)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 180)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 181))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 180)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 181))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 178)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pngFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 192))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 192)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 192)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 193))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 193)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.png; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 193)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 194)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 194))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 193)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 194)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 195))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 194)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 195))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 192)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 206))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 206)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 206)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 207))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 207)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.plist; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 207)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 208)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 208))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 207)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 208)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 209))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 208)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 209))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 206)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_frameworkFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 220))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 220)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 220)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 221))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 221)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.framework; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 221)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 222)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 222))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 221)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 222)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 223))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 222)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 223))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 220)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_icnsFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 234))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 234)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 234)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 235))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 235)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.icns; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 235)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 236)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 236))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 235)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 236)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 237))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 236)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 237))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 234)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_xibFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 249))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 249)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 249)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 250))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 250)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.xib; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 250)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 251)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 251))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 250)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 251)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 252))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 251)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 252))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 249)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistStringFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 264))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 264)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 264)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 265))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 265)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = text.plist.strings; name = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 265)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 266)).reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 266))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 265)).operator_concat (GALGAS_string ("; path = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 266)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 267))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 266)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 267))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 264)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXBuildFile_buildXcodeProject (const cPtr_Xcode_5F_PBXBuildFile * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)).operator_concat (object->mAttribute_mSourceFile.reader_mFileName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)).operator_concat (GALGAS_string (" */ ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)).operator_concat (GALGAS_string ("= {isa = PBXBuildFile; fileRef = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)).operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSourceFile.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 294)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 294))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 294)).operator_concat (GALGAS_string (" ; settings = {ATTRIBUTES = (); }; };\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 294))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 293)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 375))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 375)).operator_concat (GALGAS_string (" /* Frameworks */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 375)).operator_concat (GALGAS_string ("\t\t\tisa = PBXFrameworksBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 375)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 376)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 377))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 375)) ;
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_17037 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  while (enumerator_17037.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17037.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (enumerator_17037.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381)).reader_mFileName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)) ;
    enumerator_17037.gotoNextObject () ;
  }
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 383)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 384))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 383)) ;
}
//-----------------------------------------------------------------------------*
...
GALGAS_XcodeObjectReferenceList_2E_element GALGAS_XcodeObjectReferenceList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_XcodeObjectReferenceList_2E_element (GALGAS_string::constructor_default (HERE),
                                                     GALGAS_string::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list_2E_element (GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list_2E_element (GALGAS_Xcode_5F_PBXResourcesBuildPhase::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element (void) :
mAttribute_mBuildPhase () {
}
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element (const GALGAS_Xcode_5F_PBXCopyBuildPhase & inOperand0) :
mAttribute_mBuildPhase (inOperand0) {
}

//-----------------------------------------------------------------------------*

GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element (GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_default (HERE)) ;
}

//-----------------------------------------------------------------------------*

GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::constructor_new (const GALGAS_Xcode_5F_PBXCopyBuildPhase & inOperand0 
                                                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::objectCompare (const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mBuildPhase.objectCompare (inOperand.mAttribute_mBuildPhase) ;
  }
...
bool GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::isValid (void) const {
  return mAttribute_mBuildPhase.isValid () ;
}

//-----------------------------------------------------------------------------*

void GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::drop (void) {
  mAttribute_mBuildPhase.drop () ;
}

//-----------------------------------------------------------------------------*

void GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::description (C_String & ioString,
                                                                        const int32_t inIndentation) const {
...
GALGAS_Xcode_5F_PBXCopyBuildPhase GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::reader_mBuildPhase (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBuildPhase ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element ("Xcode_PBXCopyBuildPhase_list.element",
                                                                      NULL) ;

//-----------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element ;
}

//-----------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                                                          C_Compiler * inCompiler
                                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element result ;
  const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element * p = (const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list_2E_element (GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_PBXGroup_5F_list_2E_element GALGAS_Xcode_5F_PBXGroup_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXGroup_5F_list_2E_element (GALGAS_Xcode_5F_PBXGroup::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_XCBuildConfiguration_5F_list_2E_element GALGAS_Xcode_5F_XCBuildConfiguration_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_XCBuildConfiguration_5F_list_2E_element (GALGAS_Xcode_5F_XCBuildConfiguration::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_targetDependencyDescription_5F_list_2E_element GALGAS_Xcode_5F_targetDependencyDescription_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_targetDependencyDescription_5F_list_2E_element (GALGAS_Xcode_5F_targetDependencyDescription::constructor_default (HERE)) ;
}
...
GALGAS_Xcode_5F_PBXVariantGroup_5F_list_2E_element GALGAS_Xcode_5F_PBXVariantGroup_5F_list_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_Xcode_5F_PBXVariantGroup_5F_list_2E_element (GALGAS_string::constructor_default (HERE),
                                                             GALGAS_string::constructor_default (HERE),
                                                             GALGAS_string::constructor_default (HERE)) ;
}
