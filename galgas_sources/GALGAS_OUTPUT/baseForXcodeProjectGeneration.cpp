...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (1283)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (1283)) ;
  ...
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, GGS_string (""), GGS_string (""), var_cas_inXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_HERE) ;
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1317)) ;
      {
        ...
        while (((operand_54999 = enumerator_54999.nextObject ()))) {
          ...
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_54999->mValue) ;
