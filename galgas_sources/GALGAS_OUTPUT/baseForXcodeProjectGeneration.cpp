...
void routine_enter_file_for_sources_build_phase (C_Compiler & inLexique,
  ...
  const GGS_Xcode_PBXFileReference_map  temp_29001 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (709)) ;
  if (temp_29001.isBuilt ()) {
    temp_29001 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (709)) ;
  }
...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_29884 = enumerator_29884.nextObject ()))) {
      ...
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_30030 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (741)) ;
      if (temp_30030.isBuilt ()) {
        temp_30030 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (741)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_30524 = enumerator_30524.nextObject ()))) {
      ...
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_30670 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (758)) ;
      if (temp_30670.isBuilt ()) {
        temp_30670 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (758)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
    ...
    "\n")) ;
  {
    ...
    if ((operand_42549 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXBuildFile  temp_42684 = operand_42549->mFile ;
        if (temp_42684.isBuilt ()) {
          temp_42684 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1025)) ;
        }
  ...
  }
  {
    ...
    if ((operand_42817 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXFileReference_abstract  temp_42965 = operand_42817->mInfo.mFileReference ;
        if (temp_42965.isBuilt ()) {
          temp_42965 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1031)) ;
        }
  ...
  }
  {
    ...
    if ((operand_43107 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXFrameworksBuildPhase  temp_43271 = operand_43107->mBuildPhase ;
        if (temp_43271.isBuilt ()) {
          temp_43271 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1037)) ;
        }
    ...
    "\n") ;
  {
    ...
    if ((operand_44520 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_productFileReference  temp_45106 = operand_44520->mProduct ;
        if (temp_45106.isBuilt ()) {
          temp_45106 (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1079)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    const GGS_string temp_51871 = var_cas_in_xcodeproj_filePath ;
    if (temp_51871.isBuilt ()) {
      temp_51871 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string temp_51993 = var_cas_fileNewContents ;
    if (temp_51993.isBuilt ()) {
      temp_51993 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1250)) ;
    }
    if (((var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (1251))).operator_not ())).isBuiltAndTrue ()) {
      ...
      const GGS_string temp_52143 = var_cas_fileNewContents ;
      if (temp_52143.isBuilt ()) {
        temp_52143 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1252)) ;
      }
    }
