...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58937 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1373))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_58937.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_58926 = (var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists ()).operator_not ()) ;
    if (cond_58926.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58568_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_58568_0 COMMA_SOURCE_FILE_AT_LINE (1380)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58787 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58787 = NULL ;
        while (((operand_58787 = enumerator_58787.nextObject ()))) {
          macroValidPointer (operand_58787) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58787->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1385)) ;
        }
      }
    }
  }
