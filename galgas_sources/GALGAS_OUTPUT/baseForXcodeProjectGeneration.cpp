...
GGS_Xcode_PBXFileReference_xibFile (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
GGS_Xcode_PBXFileReference_plistStringFile (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
