...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    const elementOf_GGS_XcodeObjectReferenceList * _p = dynamic_cast <const elementOf_GGS_XcodeObjectReferenceList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mRefString._operator_isEqual (_p->mRefString).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-" ;
  ioString << mRefString.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_operator_concat (const GGS_XcodeObjectReferenceList & inOperand) const {
...
internalSubListWithRange (GGS_XcodeObjectReferenceList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mRefString, _p->mComment) ;
      _p = _p->nextObject () ;
    }
  }
}
...
reader_description (C_Compiler & _inLexique
  ...
  return _description (_inLexique, "@XcodeObjectReferenceList", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_string & GGS_XcodeObjectReferenceList::cEnumerator::_mRefString (LOCATION_ARGS) const {
  ...
  return ((cElement *) mCurrentEnumeratedObject)->mRefString ;
}
...
void cPtr_Xcode_PBXFileReference_abstract::computeOnce1204 (C_Compiler & _inLexique) const {
  _mOnce1204isComputed = true ;
  PBXFileReferenceKey._drop () ;
  PBXFileReferenceKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (26)) ;
}
...
GGS_string cPtr_Xcode_PBXFileReference_abstract::reader_PBXFileReferenceKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce1204isComputed) {
    computeOnce1204 (_inLexique) ;
  }
...
void cPtr_Xcode_PBXBuildFile::computeOnce9485 (C_Compiler & _inLexique) const {
  _mOnce9485isComputed = true ;
  PBXBuildFileKey._drop () ;
  PBXBuildFileKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (210)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXBuildFile::reader_PBXBuildFileKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce9485isComputed) {
    computeOnce9485 (_inLexique) ;
  }
...
void cPtr_Xcode_PBXSourcesBuildPhase::computeOnce10559 (C_Compiler & _inLexique) const {
  _mOnce10559isComputed = true ;
  PBXSourcesBuildPhaseKey._drop () ;
  PBXSourcesBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (237)) ;
}
...
GGS_string cPtr_Xcode_PBXSourcesBuildPhase::reader_PBXSourcesBuildPhaseKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce10559isComputed) {
    computeOnce10559 (_inLexique) ;
  }
...
void cPtr_Xcode_PBXResourcesBuildPhase::computeOnce11383 (C_Compiler & _inLexique) const {
  _mOnce11383isComputed = true ;
  PBXResourcesBuildPhaseKey._drop () ;
  PBXResourcesBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (258)) ;
}
...
GGS_string cPtr_Xcode_PBXResourcesBuildPhase::reader_PBXResourcesBuildPhaseKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce11383isComputed) {
    computeOnce11383 (_inLexique) ;
  }
...
void cPtr_Xcode_PBXFrameworksBuildPhase::computeOnce12222 (C_Compiler & _inLexique) const {
  _mOnce12222isComputed = true ;
  PBXFrameworksBuildPhaseKey._drop () ;
  PBXFrameworksBuildPhaseKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (279)) ;
}
...
GGS_string cPtr_Xcode_PBXFrameworksBuildPhase::reader_PBXFrameworksBuildPhaseKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce12222isComputed) {
    computeOnce12222 (_inLexique) ;
  }
...
method_buildXcodeProject (C_Compiler & _inLexique,
  ...
  "\t\t\tfiles = (\n") ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_12502 (mFileReferenceList, true) ;
...
void cPtr_Xcode_PBXGroup::computeOnce13570 (C_Compiler & _inLexique) const {
  _mOnce13570isComputed = true ;
  PBXGroupKey._drop () ;
  PBXGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (315)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXGroup::reader_PBXGroupKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce13570isComputed) {
    computeOnce13570 (_inLexique) ;
  }
  return PBXGroupKey ;
}
...
_mOnce14301isComputed (false),
configurationKey (),
_mOnce14441isComputed (false),
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce14301 (C_Compiler & _inLexique) const {
  _mOnce14301isComputed = true ;
  configurationKey._drop () ;
  configurationKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (335)) ;
}

//---------------------------------------------------------------------------*

void cPtr_Xcode_XCBuildConfiguration::computeOnce14441 (C_Compiler & _inLexique) const {
  _mOnce14441isComputed = true ;
  XCBuildConfigurationKey._drop () ;
  XCBuildConfigurationKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (339)) ;
}
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_configurationKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14301isComputed) {
    computeOnce14301 (_inLexique) ;
  }
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_XCBuildConfigurationKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14441isComputed) {
    computeOnce14441 (_inLexique) ;
  }
...
void cPtr_Xcode_targetDependencyDescription::computeOnce15916 (C_Compiler & _inLexique) const {
  _mOnce15916isComputed = true ;
  PBXTargetDependencyKey._drop () ;
  PBXTargetDependencyKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (376)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (376)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (376)) ;
}
...
GGS_string cPtr_Xcode_targetDependencyDescription::reader_PBXTargetDependencyKey (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce15916isComputed) {
    computeOnce15916 (_inLexique) ;
  }
...
void routine_enter_group (C_Compiler & _inLexique,
  ...
  var_cas_ioDescription.mMainGroupChildrenList._addAssign_operation (var_cas_group.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)), var_cas_inGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_subgroup (C_Compiler & _inLexique,
  ...
  var_cas_ioDescription.mProjectGroupList._addAssign_operation (var_cas_group) ;
  var_cas_ioSuperGroupContentsKeyList._addAssign_operation (var_cas_group.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (478)), var_cas_inSubGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_cpp_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (511)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (512)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_h_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (524)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (525)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_pch_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (537)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (538)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_m_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (550)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (551)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_mm_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (563)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (564)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_tiff_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (576)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (577)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_png_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (589)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (590)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_plist_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (602)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (603)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_framework_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (615)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (616)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_icns_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (628)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (629)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_file_in_group (C_Compiler & _inLexique,
                                GGS_XcodeProjectDescription & var_cas_ioXcodeProjectDescription,
  ...
  var_cas_extension = var_cas_inFileName.reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (639)) ;
  if (((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp"))).isBuiltAndTrue ()) {
    ::routine_enter_cpp_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (641)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "h"))).isBuiltAndTrue ()) {
    ::routine_enter_h_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (643)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "pch"))).isBuiltAndTrue ()) {
    ::routine_enter_pch_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (645)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "m"))).isBuiltAndTrue ()) {
    ::routine_enter_m_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (647)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "mm"))).isBuiltAndTrue ()) {
    ::routine_enter_mm_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (649)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "tiff"))).isBuiltAndTrue ()) {
    ::routine_enter_tiff_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (651)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "png"))).isBuiltAndTrue ()) {
    ::routine_enter_png_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (653)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "plist"))).isBuiltAndTrue ()) {
    ::routine_enter_plist_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (655)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "framework"))).isBuiltAndTrue ()) {
    ::routine_enter_framework_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (657)) ;
  }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "icns"))).isBuiltAndTrue ()) {
    ::routine_enter_icns_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (659)) ;
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "cannot enter '"))._operator_concat (var_cas_inFileName))._operator_concat (GGS_string (true, "' file : unknown extension")) COMMA_SOURCE_FILE_AT_LINE (662)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_in_group (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_27654 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_27654 = NULL ;
    while (((operand_27654 = enumerator_27654.nextObject ()))) {
      macroValidPointer (operand_27654) ;
      ::routine_enter_file_in_group (_inLexique,  var_cas_ioXcodeProjectDescription,  operand_27654->mValue,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (673)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_nib_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ref = GGS_Xcode_PBXFileReference_nibFile ::constructor_new (_inLexique, var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (686)), ((var_cas_in_lproj_dir)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_in_nib_fileName) COMMA_HERE) ;
  GGS_lstring  var_cas_key ;
  var_cas_key = GGS_lstring ::constructor_new (_inLexique, var_cas_in_nib_fileName, GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (690)) ;
  GGS_string var_cas_PBXVariantGroupKey ;
  var_cas_PBXVariantGroupKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (691)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (691)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list._addAssign_operation (var_cas_PBXVariantGroupKey, var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (694)), var_cas_in_nib_fileName) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_PBXVariantGroupKey, var_cas_in_nib_fileName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_sources_build_phase (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_28876 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_28876 = NULL ;
    while (((operand_28876 = enumerator_28876.nextObject ()))) {
      macroValidPointer (operand_28876) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (_inLexique, operand_28876->mValue, GGS_location (_inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  _temp_29022 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (710)) ;
      if (_temp_29022._isBuilt ()) {
        _temp_29022 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (710)) ;
      }
...
void routine_enter_files_for_resources_build_phase (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_29495 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_29495 = NULL ;
    while (((operand_29495 = enumerator_29495.nextObject ()))) {
      macroValidPointer (operand_29495) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (_inLexique, operand_29495->mValue, GGS_location (_inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  _temp_29641 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (727)) ;
      if (_temp_29641._isBuilt ()) {
        _temp_29641 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (727)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (_inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_30135 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_30135 = NULL ;
    while (((operand_30135 = enumerator_30135.nextObject ()))) {
      macroValidPointer (operand_30135) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (_inLexique, operand_30135->mValue, GGS_location (_inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  _temp_30281 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (744)) ;
      if (_temp_30281._isBuilt ()) {
        _temp_30281 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (744)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file ;
      var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (_inLexique, var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList._addAssign_operation (var_cas_build_file) ;
...
void routine_add_tool_target (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (765)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (767)), var_cas_inTargetName) ;
  ...
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (780)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (780)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (780)) ;
  var_cas_ioXcodeProjectDescription.mTargetList._addAssign_operation (var_cas_outTargetKey, var_cas_inTargetName, var_cas_toolTargetBuildConfiguration, GGS_string (true, "$(HOME)/bin"), var_cas_inProductFileName, var_cas_toolFileReference, GGS_stringlist ::constructor_listWithValue (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (788))), var_cas_inDirectDependencyList) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_app_target (C_Compiler & _inLexique,
  ...
  GGS_lstring  var_cas_projectNameKey ;
  var_cas_projectNameKey = GGS_lstring ::constructor_new (_inLexique, var_cas_inProductFileName, GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (812)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (814)), var_cas_inTargetName) ;
  ...
  var_cas_buildPhases._addAssign_operation (var_cas_resourcesBuildPhase.reader_PBXResourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (821))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase ;
  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (_inLexique, GGS_string (true, "Sources"), var_cas_inSourcesToCompileKeyList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list._addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases._addAssign_operation (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (828))) ;
  ...
  var_cas_buildPhases._addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (835))) ;
  if (((var_cas_inPrecompiledHeaderPath)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    var_cas_inTargetSettings._addAssign_operation (GGS_string (true, "GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings._addAssign_operation (((GGS_string (true, "GCC_PREFIX_HEADER = \""))._operator_concat (var_cas_inPrecompiledHeaderPath))._operator_concat (GGS_string (true, "\";"))) ;
  }
  ...
  {
    GGS_stringlist::cEnumerator enumerator_34871 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_34871 = NULL ;
    while (((operand_34871 = enumerator_34871.nextObject ()))) {
      macroValidPointer (operand_34871) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d ;
      var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (_inLexique, operand_34871->mValue COMMA_HERE) ;
      var_cas_targetDependencyKeyList._addAssign_operation (var_cas_d.reader_PBXTargetDependencyKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (851))) ;
  ...
  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (_inLexique, var_cas_inTargetSettings COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList._addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (857)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (857)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (857)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
  ...
  var_cas_pathString = GGS_string (true, "") ;
  {
    GGS_stringlist::cEnumerator enumerator_35935 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_35935 = NULL ;
    while (((operand_35935 = enumerator_35935.nextObject ()))) {
      macroValidPointer (operand_35935) ;
      var_cas_pathString.writeString ("\t\t\t\t\t") ;
      var_cas_pathString._dotAssign_operation (operand_35935->mValue) ;
      var_cas_pathString.writeString (",\n") ;
    }
  }
  var_cas_outProjectDefaultSettings = GGS_stringlist ::constructor_emptyList () ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "ALWAYS_SEARCH_USER_PATHS = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "ARCHS = (\n"
    "\t\t\t\t\tppc,\n"
    "\t\t\t\t\ti386,\n"
    "\t\t\t\t);")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_DEBUGGING_SYMBOLS = default;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_GENERATE_DEBUGGING_SYMBOLS = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_THREADSAFE_STATICS = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_TREAT_NONCONFORMANT_CODE_ERRORS_AS_WARNINGS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_TREAT_WARNINGS_AS_ERRORS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_64_TO_32_BIT_CONVERSION = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_ABOUT_MISSING_NEWLINE = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_ABOUT_MISSING_PROTOTYPES = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_ABOUT_RETURN_TYPE = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_CHECK_SWITCH_STATEMENTS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_EFFECTIVE_CPLUSPLUS_VIOLATIONS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_INHIBIT_ALL_WARNINGS = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_MISSING_PARENTHESES = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_PEDANTIC = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_PROTOTYPE_CONVERSION = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_SHADOW = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_SIGN_COMPARE = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNINITIALIZED_AUTOS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNKNOWN_PRAGMAS = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNUSED_FUNCTION = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNUSED_LABEL = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNUSED_PARAMETER = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNUSED_VALUE = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "GCC_WARN_UNUSED_VARIABLE = YES;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (((GGS_string (true, "HEADER_SEARCH_PATHS = (\n"))._operator_concat (var_cas_pathString))._operator_concat (GGS_string (true, "\t\t\t\t);"))) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "PREBINDING = NO;")) ;
  var_cas_outProjectDefaultSettings._addAssign_operation (GGS_string (true, "SDKROOT = /Developer/SDKs/MacOSX10.4u.sdk;")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildXcodeProjectString (C_Compiler & _inLexique,
  ...
  var_cas_rootObjectKey = GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (930)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (930)) ;
  var_cas_outString = ((((((GGS_string (true, "// !$*UTF8*$!\n"))._operator_concat (GGS_string (true, "{\n")))._operator_concat (GGS_string (true, "\tarchiveVersion = 1;\n")))._operator_concat (GGS_string (true, "\tclasses = {\n")))._operator_concat (GGS_string (true, "\t};\n")))._operator_concat (GGS_string (true, "\tobjectVersion = 42;\n")))._operator_concat (GGS_string (true, "\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_39397 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (_inLexique COMMA_SOURCE_FILE_AT_LINE (940)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_39397 = enumerator_39397.nextObject () ;
    if ((operand_39397 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_39397 ;
      do{
        macroValidPointer (operand_39397) ;
        const GGS_Xcode_PBXBuildFile  _temp_39532 = operand_39397->mFile ;
        if (_temp_39532._isBuilt ()) {
          _temp_39532 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (942)) ;
        }
        operand_39397 = enumerator_39397.nextObject () ;
        _foreach_loop_39397 = ((operand_39397 != NULL)) ;
        if (_foreach_loop_39397) {
        }
      }while (_foreach_loop_39397) ;
      var_cas_outString.writeString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_39665 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (946)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_39665 = enumerator_39665.nextObject () ;
    if ((operand_39665 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_39665 ;
      do{
        macroValidPointer (operand_39665) ;
        const GGS_Xcode_PBXFileReference_abstract  _temp_39813 = operand_39665->mInfo.mFileReference ;
        if (_temp_39813._isBuilt ()) {
          _temp_39813 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (948)) ;
        }
        operand_39665 = enumerator_39665.nextObject () ;
        _foreach_loop_39665 = ((operand_39665 != NULL)) ;
        if (_foreach_loop_39665) {
        }
      }while (_foreach_loop_39665) ;
      var_cas_outString.writeString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_39955 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (952)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_39955 = enumerator_39955.nextObject () ;
    if ((operand_39955 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_39955 ;
      do{
        macroValidPointer (operand_39955) ;
        const GGS_Xcode_PBXFrameworksBuildPhase  _temp_40119 = operand_39955->mBuildPhase ;
        if (_temp_40119._isBuilt ()) {
          _temp_40119 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (954)) ;
        }
        operand_39955 = enumerator_39955.nextObject () ;
        _foreach_loop_39955 = ((operand_39955 != NULL)) ;
        if (_foreach_loop_39955) {
        }
      }while (_foreach_loop_39955) ;
      var_cas_outString.writeString ("/* End PBXFrameworksBuildPhase section */\n") ;
    }
  }
  var_cas_outString.writeString ("/* Begin PBXGroup section */\n") ;
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_40303 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (959)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_40303 = NULL ;
    while (((operand_40303 = enumerator_40303.nextObject ()))) {
      macroValidPointer (operand_40303) ;
      var_cas_outString.writeString ("\t\t") ;
      var_cas_outString._dotAssign_operation (operand_40303->mGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (960))) ;
      if (((operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (961)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_outString.writeString (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (962))) ;
        var_cas_outString.writeString (" */") ;
      }
      var_cas_outString.writeString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_40611 (operand_40303->mGroup.reader_mChildrenGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (967)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_40611 = NULL ;
        while (((operand_40611 = enumerator_40611.nextObject ()))) {
          macroValidPointer (operand_40611) ;
          var_cas_outString.writeString ("\t\t\t\t") ;
          var_cas_outString._dotAssign_operation (operand_40611->mRefString) ;
          var_cas_outString.writeString (" /* ") ;
          var_cas_outString._dotAssign_operation (operand_40611->mComment) ;
          var_cas_outString.writeString (" */,\n") ;
        }
      }
      var_cas_outString.writeString ("\t\t\t);\n") ;
      if (((operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (971)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        if (((operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)).reader_componentsSeparatedByString (_inLexique, GGS_string (true, " ") COMMA_SOURCE_FILE_AT_LINE (972)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (972)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
          var_cas_outString.writeString ("\t\t\tname = \"") ;
          var_cas_outString._dotAssign_operation (operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (973))) ;
          var_cas_outString.writeString ("\";\n") ;
        }else{
          var_cas_outString.writeString ("\t\t\tname = ") ;
          var_cas_outString._dotAssign_operation (operand_40303->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (975))) ;
          var_cas_outString.writeString (";\n") ;
        }
      }
      if (((operand_40303->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (978)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_outString.writeString ("\t\t\tpath = \"") ;
        var_cas_outString._dotAssign_operation (operand_40303->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (979))) ;
        var_cas_outString.writeString ("\";\n") ;
      }
      var_cas_outString.writeString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.writeString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_41368 (var_cas_inXcodeProjectDescription.reader_mTargetList (_inLexique COMMA_SOURCE_FILE_AT_LINE (986)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_41368 = enumerator_41368.nextObject () ;
    if ((operand_41368 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_41368 ;
      do{
        macroValidPointer (operand_41368) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_41368->mTargetKey) ;
        var_cas_outString.writeString (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_41368->mTargetName) ;
        var_cas_outString.writeString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString._dotAssign_operation (operand_41368->mTargetConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (991))) ;
        var_cas_outString.writeString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString._dotAssign_operation (operand_41368->mTargetName) ;
        var_cas_outString.writeString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_41825 (operand_41368->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_41825 = NULL ;
          while (((operand_41825 = enumerator_41825.nextObject ()))) {
            macroValidPointer (operand_41825) ;
            var_cas_outString.writeString ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_41825->mValue) ;
            var_cas_outString.writeString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        const GGS_Xcode_productFileReference  _temp_41954 = operand_41368->mProduct ;
        if (_temp_41954._isBuilt ()) {
          _temp_41954 (HERE)->method_productExtension (_inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (996)) ;
        }
        var_cas_outString.writeString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_42122 (operand_41368->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_42122 = NULL ;
          while (((operand_42122 = enumerator_42122.nextObject ()))) {
            macroValidPointer (operand_42122) ;
            var_cas_outString.writeString ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_42122->mValue) ;
            var_cas_outString.writeString (" /*  */,\n") ;
          }
        }
        var_cas_outString.writeString ("\t\t\t);\n"
        ...
        var_cas_outString.writeString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString._dotAssign_operation (operand_41368->mProductInstallPath) ;
        var_cas_outString.writeString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString._dotAssign_operation (operand_41368->mProductName) ;
        var_cas_outString.writeString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString._dotAssign_operation (operand_41368->mProduct.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1008))) ;
        var_cas_outString.writeString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString._dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.writeString ("\";\n"
        "\t\t};\n") ;
        operand_41368 = enumerator_41368.nextObject () ;
        _foreach_loop_41368 = ((operand_41368 != NULL)) ;
        if (_foreach_loop_41368) {
        }
      }while (_foreach_loop_41368) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_43237 (var_cas_inXcodeProjectDescription.reader_mTargetList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1026)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_43237 = NULL ;
    while (((operand_43237 = enumerator_43237.nextObject ()))) {
      macroValidPointer (operand_43237) ;
      var_cas_outString.writeString ("\t\t\t\t") ;
      var_cas_outString._dotAssign_operation (operand_43237->mTargetKey) ;
      var_cas_outString.writeString (" /* ") ;
      var_cas_outString._dotAssign_operation (operand_43237->mTargetName) ;
      var_cas_outString.writeString (" */,\n") ;
    }
  }
  var_cas_outString.writeString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_43503 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1033)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_43503 = enumerator_43503.nextObject () ;
    if ((operand_43503 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_43503 ;
      do{
        macroValidPointer (operand_43503) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_43503->mBuildPhase.reader_PBXResourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1036))) ;
        var_cas_outString.writeString (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_43503->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (1037))) ;
        var_cas_outString.writeString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_43893 (operand_43503->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1041)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_43893 = NULL ;
          while (((operand_43893 = enumerator_43893.nextObject ()))) {
            macroValidPointer (operand_43893) ;
            var_cas_outString.writeString ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_43893->mFile.reader_PBXBuildFileKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1042))) ;
            var_cas_outString.writeString (" ,\n") ;
          }
        }
        var_cas_outString.writeString ("\t\t\t);\n"
        ...
        _foreach_loop_43503 = ((operand_43503 != NULL)) ;
        if (_foreach_loop_43503) {
        }
      }while (_foreach_loop_43503) ;
      var_cas_outString.writeString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_44248 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1050)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_44248 = enumerator_44248.nextObject () ;
    if ((operand_44248 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_44248 ;
      do{
        macroValidPointer (operand_44248) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_44248->mBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1053))) ;
        var_cas_outString.writeString (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_44248->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (1054))) ;
        var_cas_outString.writeString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_44630 (operand_44248->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1058)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_44630 = NULL ;
          while (((operand_44630 = enumerator_44630.nextObject ()))) {
            macroValidPointer (operand_44630) ;
            var_cas_outString.writeString ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_44630->mFile.reader_PBXBuildFileKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1059))) ;
            var_cas_outString.writeString (" ,\n") ;
          }
        }
        var_cas_outString.writeString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_44248 = enumerator_44248.nextObject () ;
        _foreach_loop_44248 = ((operand_44248 != NULL)) ;
        if (_foreach_loop_44248) {
        }
      }while (_foreach_loop_44248) ;
      var_cas_outString.writeString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_44982 (var_cas_inXcodeProjectDescription.reader_mDependencyList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1067)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_44982 = enumerator_44982.nextObject () ;
    if ((operand_44982 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_44982 ;
      do{
        macroValidPointer (operand_44982) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_44982->mDependency.reader_PBXTargetDependencyKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1070))) ;
        var_cas_outString.writeString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString._dotAssign_operation (operand_44982->mDependency.reader_mDependencyTarget (_inLexique COMMA_SOURCE_FILE_AT_LINE (1073))) ;
        var_cas_outString.writeString (" ;\n"
        "\t\t};\n") ;
        operand_44982 = enumerator_44982.nextObject () ;
        _foreach_loop_44982 = ((operand_44982 != NULL)) ;
        if (_foreach_loop_44982) {
        }
      }while (_foreach_loop_44982) ;
  ...
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_45530 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1081)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_45530 = enumerator_45530.nextObject () ;
    if ((operand_45530 != NULL)) {
      var_cas_outString.writeString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_45530 ;
      do{
        macroValidPointer (operand_45530) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_45530->mPBXVariantKey) ;
        var_cas_outString.writeString (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_45530->mName) ;
        var_cas_outString.writeString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString._dotAssign_operation (operand_45530->mPBXFileReferenceKey) ;
        var_cas_outString.writeString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString._dotAssign_operation (operand_45530->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_45530 = enumerator_45530.nextObject () ;
        _foreach_loop_45530 = ((operand_45530 != NULL)) ;
        if (_foreach_loop_45530) {
        }
      }while (_foreach_loop_45530) ;
      var_cas_outString.writeString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_46081 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1096)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_46081 = enumerator_46081.nextObject () ;
    if ((operand_46081 != NULL)) {
      var_cas_outString.writeString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_46081 ;
      do{
        macroValidPointer (operand_46081) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_46081->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1099))) ;
        var_cas_outString.writeString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46382 (operand_46081->mBuildConfig.reader_mSettings (_inLexique COMMA_SOURCE_FILE_AT_LINE (1102)), true) ;
          const GGS_stringlist::cElement * operand_46382 = NULL ;
          while (((operand_46382 = enumerator_46382.nextObject ()))) {
            macroValidPointer (operand_46382) ;
            var_cas_outString.writeString ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_46382->mValue) ;
            var_cas_outString.writeString ("\n") ;
          }
        }
        var_cas_outString.writeString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_46081 = enumerator_46081.nextObject () ;
        _foreach_loop_46081 = ((operand_46081 != NULL)) ;
        if (_foreach_loop_46081) {
        }
      }while (_foreach_loop_46081) ;
      var_cas_outString.writeString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_46685 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1111)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_46685 = enumerator_46685.nextObject () ;
    if ((operand_46685 != NULL)) {
      var_cas_outString.writeString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_46685 ;
      do{
        macroValidPointer (operand_46685) ;
        var_cas_outString.writeString ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_46685->mBuildConfig.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1114))) ;
        var_cas_outString.writeString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString._dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.writeString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString._dotAssign_operation (operand_46685->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1118))) ;
        var_cas_outString.writeString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_46685 = enumerator_46685.nextObject () ;
        _foreach_loop_46685 = ((operand_46685 != NULL)) ;
        if (_foreach_loop_46685) {
        }
      }while (_foreach_loop_46685) ;
...
void routine_generateXCodeFile (C_Compiler & _inLexique,
                                ...
                                const GGS_stringlist   var_cas_inProjectDefaultSettings COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_generateXCodeFile at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_string var_cas_projectName ;
  var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1138)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (1138)) ;
  ...
  ::routine_enter_group (_inLexique,  var_cas_inXcodeProjectDescription,  GGS_string (true, "Products"),  GGS_string (true, ""),  var_cas_inXcodeProjectDescription.reader_mProductGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1147)) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup ;
  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, ""), GGS_string (true, ""), var_cas_inXcodeProjectDescription.reader_mMainGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1150)) COMMA_HERE) ;
  ...
  ::routine_buildXcodeProjectString (_inLexique,  var_cas_inXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1157)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1158)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1154)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    const GGS_string _temp_48687 = var_cas_in_xcodeproj_filePath ;
    if (_temp_48687._isBuilt ()) {
      _temp_48687 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1163)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string _temp_48809 = var_cas_fileNewContents ;
    if (_temp_48809._isBuilt ()) {
      _temp_48809 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/project.pbxproj")), var_cas_written COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files ;
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1169)) ;
      {
        GGS_stringlist::cEnumerator enumerator_49102 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_49102 = NULL ;
        while (((operand_49102 = enumerator_49102.nextObject ()))) {
          macroValidPointer (operand_49102) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_49102->mValue) ;
          GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1172)) ;
        }
      }
    }
  }
