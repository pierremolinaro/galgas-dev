...
void routine_add_tool_target (C_Compiler & _inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (779)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (781)), var_cas_inTargetName) ;
  ...
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (794)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (794)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (794)) ;
  var_cas_ioXcodeProjectDescription.mTargetList._addAssign_operation (var_cas_outTargetKey, var_cas_inTargetName, var_cas_toolTargetBuildConfiguration, GGS_string (true, "$(HOME)/bin"), var_cas_inProductFileName, var_cas_toolFileReference, GGS_stringlist ::constructor_listWithValue (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (802))), var_cas_inDirectDependencyList) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_app_target (C_Compiler & _inLexique,
  ...
  GGS_lstring  var_cas_projectNameKey ;
  var_cas_projectNameKey = GGS_lstring ::constructor_new (_inLexique, var_cas_inProductFileName, GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (_inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (826)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (828)), var_cas_inTargetName) ;
  ...
  var_cas_buildPhases._addAssign_operation (var_cas_resourcesBuildPhase.reader_PBXResourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (835))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase ;
  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (_inLexique, GGS_string (true, "Sources"), var_cas_inSourcesToCompileKeyList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list._addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases._addAssign_operation (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (842))) ;
  ...
  var_cas_buildPhases._addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (849))) ;
  if (((var_cas_inPrecompiledHeaderPath)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    var_cas_inTargetSettings._addAssign_operation (GGS_string (true, "GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings._addAssign_operation (((GGS_string (true, "GCC_PREFIX_HEADER = \""))._operator_concat (var_cas_inPrecompiledHeaderPath))._operator_concat (GGS_string (true, "\";"))) ;
  }
  ...
  {
    GGS_stringlist::cEnumerator enumerator_35249 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_35249 = NULL ;
    while (((operand_35249 = enumerator_35249.nextObject ()))) {
      macroValidPointer (operand_35249) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d ;
      var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (_inLexique, operand_35249->mValue COMMA_HERE) ;
      var_cas_targetDependencyKeyList._addAssign_operation (var_cas_d.reader_PBXTargetDependencyKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (865))) ;
  ...
  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (_inLexique, var_cas_inTargetSettings COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList._addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (871)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (871)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (871)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_36313 (var_cas_inHeaderSearchPathList, true) ;
...
void routine_buildXcodeProjectString (C_Compiler & _inLexique,
  ...
  var_cas_rootObjectKey = GGS_string (true, "project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (944)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (944)) ;
  var_cas_outString = ((((((GGS_string (true, "// !$*UTF8*$!\n"))._operator_concat (GGS_string (true, "{\n")))._operator_concat (GGS_string (true, "\tarchiveVersion = 1;\n")))._operator_concat (GGS_string (true, "\tclasses = {\n")))._operator_concat (GGS_string (true, "\t};\n")))._operator_concat (GGS_string (true, "\tobjectVersion = 42;\n")))._operator_concat (GGS_string (true, "\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_39779 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (_inLexique COMMA_SOURCE_FILE_AT_LINE (954)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_39779 = enumerator_39779.nextObject () ;
    if ((operand_39779 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_39779 ;
      do{
        macroValidPointer (operand_39779) ;
        const GGS_Xcode_PBXBuildFile  _temp_39914 = operand_39779->mFile ;
        if (_temp_39914._isBuilt ()) {
          _temp_39914 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (956)) ;
        }
        operand_39779 = enumerator_39779.nextObject () ;
        _foreach_loop_39779 = ((operand_39779 != NULL)) ;
        if (_foreach_loop_39779) {
        }
      }while (_foreach_loop_39779) ;
      var_cas_outString.appendCstring ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_40047 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (960)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_40047 = enumerator_40047.nextObject () ;
    if ((operand_40047 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_40047 ;
      do{
        macroValidPointer (operand_40047) ;
        const GGS_Xcode_PBXFileReference_abstract  _temp_40195 = operand_40047->mInfo.mFileReference ;
        if (_temp_40195._isBuilt ()) {
          _temp_40195 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (962)) ;
        }
        operand_40047 = enumerator_40047.nextObject () ;
        _foreach_loop_40047 = ((operand_40047 != NULL)) ;
        if (_foreach_loop_40047) {
        }
      }while (_foreach_loop_40047) ;
      var_cas_outString.appendCstring ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_40337 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (966)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_40337 = enumerator_40337.nextObject () ;
    if ((operand_40337 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_40337 ;
      do{
        macroValidPointer (operand_40337) ;
        const GGS_Xcode_PBXFrameworksBuildPhase  _temp_40501 = operand_40337->mBuildPhase ;
        if (_temp_40501._isBuilt ()) {
          _temp_40501 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (968)) ;
        }
        operand_40337 = enumerator_40337.nextObject () ;
        _foreach_loop_40337 = ((operand_40337 != NULL)) ;
        if (_foreach_loop_40337) {
        }
      }while (_foreach_loop_40337) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_40685 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (973)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_40685 = NULL ;
    while (((operand_40685 = enumerator_40685.nextObject ()))) {
      macroValidPointer (operand_40685) ;
      var_cas_outString.appendCstring ("\t\t") ;
      var_cas_outString._dotAssign_operation (operand_40685->mGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (974))) ;
      if (((operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (975)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCstring (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (976))) ;
        var_cas_outString.appendCstring (" */") ;
      }
      var_cas_outString.appendCstring (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_40993 (operand_40685->mGroup.reader_mChildrenGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (981)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_40993 = NULL ;
        while (((operand_40993 = enumerator_40993.nextObject ()))) {
          macroValidPointer (operand_40993) ;
          var_cas_outString.appendCstring ("\t\t\t\t") ;
          var_cas_outString._dotAssign_operation (operand_40993->mRefString) ;
          var_cas_outString.appendCstring (" /* ") ;
          var_cas_outString._dotAssign_operation (operand_40993->mComment) ;
          var_cas_outString.appendCstring (" */,\n") ;
        }
      }
      var_cas_outString.appendCstring ("\t\t\t);\n") ;
      if (((operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (985)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        if (((operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (986)).reader_componentsSeparatedByString (_inLexique, GGS_string (true, " ") COMMA_SOURCE_FILE_AT_LINE (986)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (986)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
          var_cas_outString.appendCstring ("\t\t\tname = \"") ;
          var_cas_outString._dotAssign_operation (operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (987))) ;
          var_cas_outString.appendCstring ("\";\n") ;
        }else{
          var_cas_outString.appendCstring ("\t\t\tname = ") ;
          var_cas_outString._dotAssign_operation (operand_40685->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (989))) ;
          var_cas_outString.appendCstring (";\n") ;
        }
      }
      if (((operand_40685->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (992)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCstring ("\t\t\tpath = \"") ;
        var_cas_outString._dotAssign_operation (operand_40685->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (993))) ;
        var_cas_outString.appendCstring ("\";\n") ;
      }
      var_cas_outString.appendCstring ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCstring ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_41750 (var_cas_inXcodeProjectDescription.reader_mTargetList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1000)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_41750 = enumerator_41750.nextObject () ;
    if ((operand_41750 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_41750 ;
      do{
        macroValidPointer (operand_41750) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_41750->mTargetKey) ;
        var_cas_outString.appendCstring (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_41750->mTargetName) ;
        var_cas_outString.appendCstring (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString._dotAssign_operation (operand_41750->mTargetConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1005))) ;
        var_cas_outString.appendCstring (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString._dotAssign_operation (operand_41750->mTargetName) ;
        var_cas_outString.appendCstring ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_42207 (operand_41750->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_42207 = NULL ;
          while (((operand_42207 = enumerator_42207.nextObject ()))) {
            macroValidPointer (operand_42207) ;
            var_cas_outString.appendCstring ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_42207->mValue) ;
            var_cas_outString.appendCstring (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        const GGS_Xcode_productFileReference  _temp_42336 = operand_41750->mProduct ;
        if (_temp_42336._isBuilt ()) {
          _temp_42336 (HERE)->method_productExtension (_inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1010)) ;
        }
        var_cas_outString.appendCstring ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_42504 (operand_41750->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_42504 = NULL ;
          while (((operand_42504 = enumerator_42504.nextObject ()))) {
            macroValidPointer (operand_42504) ;
            var_cas_outString.appendCstring ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_42504->mValue) ;
            var_cas_outString.appendCstring (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCstring ("\t\t\t);\n"
        ...
        var_cas_outString.appendCstring ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString._dotAssign_operation (operand_41750->mProductInstallPath) ;
        var_cas_outString.appendCstring ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString._dotAssign_operation (operand_41750->mProductName) ;
        var_cas_outString.appendCstring ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString._dotAssign_operation (operand_41750->mProduct.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1022))) ;
        var_cas_outString.appendCstring (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString._dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCstring ("\";\n"
        "\t\t};\n") ;
        operand_41750 = enumerator_41750.nextObject () ;
        _foreach_loop_41750 = ((operand_41750 != NULL)) ;
        if (_foreach_loop_41750) {
        }
      }while (_foreach_loop_41750) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_43619 (var_cas_inXcodeProjectDescription.reader_mTargetList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1040)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_43619 = NULL ;
    while (((operand_43619 = enumerator_43619.nextObject ()))) {
      macroValidPointer (operand_43619) ;
      var_cas_outString.appendCstring ("\t\t\t\t") ;
      var_cas_outString._dotAssign_operation (operand_43619->mTargetKey) ;
      var_cas_outString.appendCstring (" /* ") ;
      var_cas_outString._dotAssign_operation (operand_43619->mTargetName) ;
      var_cas_outString.appendCstring (" */,\n") ;
    }
  }
  var_cas_outString.appendCstring ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_43885 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1047)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_43885 = enumerator_43885.nextObject () ;
    if ((operand_43885 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_43885 ;
      do{
        macroValidPointer (operand_43885) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_43885->mBuildPhase.reader_PBXResourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1050))) ;
        var_cas_outString.appendCstring (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_43885->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (1051))) ;
        var_cas_outString.appendCstring (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_44275 (operand_43885->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_44275 = NULL ;
          while (((operand_44275 = enumerator_44275.nextObject ()))) {
            macroValidPointer (operand_44275) ;
            var_cas_outString.appendCstring ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_44275->mFile.reader_PBXBuildFileKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1056))) ;
            var_cas_outString.appendCstring (" ,\n") ;
          }
        }
        var_cas_outString.appendCstring ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_43885 = enumerator_43885.nextObject () ;
        _foreach_loop_43885 = ((operand_43885 != NULL)) ;
        if (_foreach_loop_43885) {
        }
      }while (_foreach_loop_43885) ;
      var_cas_outString.appendCstring ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_44630 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1064)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_44630 = enumerator_44630.nextObject () ;
    if ((operand_44630 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_44630 ;
      do{
        macroValidPointer (operand_44630) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_44630->mBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1067))) ;
        var_cas_outString.appendCstring (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_44630->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (1068))) ;
        var_cas_outString.appendCstring (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_45012 (operand_44630->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1072)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_45012 = NULL ;
          while (((operand_45012 = enumerator_45012.nextObject ()))) {
            macroValidPointer (operand_45012) ;
            var_cas_outString.appendCstring ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_45012->mFile.reader_PBXBuildFileKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1073))) ;
            var_cas_outString.appendCstring (" ,\n") ;
          }
        }
        var_cas_outString.appendCstring ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_44630 = enumerator_44630.nextObject () ;
        _foreach_loop_44630 = ((operand_44630 != NULL)) ;
        if (_foreach_loop_44630) {
        }
      }while (_foreach_loop_44630) ;
      var_cas_outString.appendCstring ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_45364 (var_cas_inXcodeProjectDescription.reader_mDependencyList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1081)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_45364 = enumerator_45364.nextObject () ;
    if ((operand_45364 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_45364 ;
      do{
        macroValidPointer (operand_45364) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_45364->mDependency.reader_PBXTargetDependencyKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1084))) ;
        var_cas_outString.appendCstring (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString._dotAssign_operation (operand_45364->mDependency.reader_mDependencyTarget (_inLexique COMMA_SOURCE_FILE_AT_LINE (1087))) ;
        var_cas_outString.appendCstring (" ;\n"
        "\t\t};\n") ;
        operand_45364 = enumerator_45364.nextObject () ;
        _foreach_loop_45364 = ((operand_45364 != NULL)) ;
        if (_foreach_loop_45364) {
        }
      }while (_foreach_loop_45364) ;
  ...
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_45912 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (_inLexique COMMA_SOURCE_FILE_AT_LINE (1095)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_45912 = enumerator_45912.nextObject () ;
    if ((operand_45912 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_45912 ;
      do{
        macroValidPointer (operand_45912) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_45912->mPBXVariantKey) ;
        var_cas_outString.appendCstring (" /* ") ;
        var_cas_outString._dotAssign_operation (operand_45912->mName) ;
        var_cas_outString.appendCstring (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString._dotAssign_operation (operand_45912->mPBXFileReferenceKey) ;
        var_cas_outString.appendCstring (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString._dotAssign_operation (operand_45912->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_45912 = enumerator_45912.nextObject () ;
        _foreach_loop_45912 = ((operand_45912 != NULL)) ;
        if (_foreach_loop_45912) {
        }
      }while (_foreach_loop_45912) ;
      var_cas_outString.appendCstring ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_46463 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1110)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_46463 = enumerator_46463.nextObject () ;
    if ((operand_46463 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_46463 ;
      do{
        macroValidPointer (operand_46463) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_46463->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1113))) ;
        var_cas_outString.appendCstring (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46764 (operand_46463->mBuildConfig.reader_mSettings (_inLexique COMMA_SOURCE_FILE_AT_LINE (1116)), true) ;
          const GGS_stringlist::cElement * operand_46764 = NULL ;
          while (((operand_46764 = enumerator_46764.nextObject ()))) {
            macroValidPointer (operand_46764) ;
            var_cas_outString.appendCstring ("\t\t\t\t") ;
            var_cas_outString._dotAssign_operation (operand_46764->mValue) ;
            var_cas_outString.appendCstring ("\n") ;
          }
        }
        var_cas_outString.appendCstring ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_46463 = enumerator_46463.nextObject () ;
        _foreach_loop_46463 = ((operand_46463 != NULL)) ;
        if (_foreach_loop_46463) {
        }
      }while (_foreach_loop_46463) ;
      var_cas_outString.appendCstring ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_47067 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_47067 = enumerator_47067.nextObject () ;
    if ((operand_47067 != NULL)) {
      var_cas_outString.appendCstring ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_47067 ;
      do{
        macroValidPointer (operand_47067) ;
        var_cas_outString.appendCstring ("\t\t") ;
        var_cas_outString._dotAssign_operation (operand_47067->mBuildConfig.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1128))) ;
        var_cas_outString.appendCstring (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString._dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCstring ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString._dotAssign_operation (operand_47067->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1132))) ;
        var_cas_outString.appendCstring (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_47067 = enumerator_47067.nextObject () ;
        _foreach_loop_47067 = ((operand_47067 != NULL)) ;
        if (_foreach_loop_47067) {
        }
      }while (_foreach_loop_47067) ;
...
void routine_generateXCodeFile (C_Compiler & _inLexique,
  ...
  var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1152)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  ...
  ::routine_enter_group (_inLexique,  var_cas_inXcodeProjectDescription,  GGS_string (true, "Products"),  GGS_string (true, ""),  var_cas_inXcodeProjectDescription.reader_mProductGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1161)) COMMA_SOURCE_FILE_AT_LINE (1157)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup ;
  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, ""), GGS_string (true, ""), var_cas_inXcodeProjectDescription.reader_mMainGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1164)) COMMA_HERE) ;
  ...
  ::routine_buildXcodeProjectString (_inLexique,  var_cas_inXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1171)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1172)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1168)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    const GGS_string _temp_49069 = var_cas_in_xcodeproj_filePath ;
    if (_temp_49069._isBuilt ()) {
      _temp_49069 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1177)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string _temp_49191 = var_cas_fileNewContents ;
    if (_temp_49191._isBuilt ()) {
      _temp_49191 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/project.pbxproj")), var_cas_written COMMA_SOURCE_FILE_AT_LINE (1180)) ;
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files ;
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1183)) ;
      {
        GGS_stringlist::cEnumerator enumerator_49484 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_49484 = NULL ;
        while (((operand_49484 = enumerator_49484.nextObject ()))) {
          macroValidPointer (operand_49484) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_49484->mValue) ;
          GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1186)) ;
        }
      }
    }
  }
