...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34327 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34327.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34327.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (789)) ;
    }
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37497 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37497.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37497.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
    }
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37933 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37933.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37933.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (885)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38671 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38671.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38671.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (903)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ...
    enumerator_38671.gotoNextObject () ;
  }
}
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  cEnumerator_stringlist enumerator_46050 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_46050.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1064)), enumerator_46050.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
    ...
    enumerator_46050.gotoNextObject () ;
  }
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47551 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47551.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47551.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1103)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1103)) COMMA_SOURCE_FILE_AT_LINE (1103)) ;
    enumerator_47551.gotoNextObject () ;
  }
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n") COMMA_SOURCE_FILE_AT_LINE (1157)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1158)).operator_concat (GALGAS_string ("\tclasses = {\n") COMMA_SOURCE_FILE_AT_LINE (1159)).operator_concat (GALGAS_string ("\t};\n") COMMA_SOURCE_FILE_AT_LINE (1160)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n") COMMA_SOURCE_FILE_AT_LINE (1161)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1162)) ;
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50888 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_50888.hasCurrentObject () && bool_0) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    while (enumerator_50888.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50888.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
      enumerator_50888.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXBuildFile section */\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (1168)) ;
  }
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51156 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51156.hasCurrentObject () && bool_1) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    while (enumerator_51156.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51156.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      enumerator_51156.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1174)) ;
  }
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51458 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51458.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51458.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51458.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      enumerator_51458.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51794 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1184)), kEnumeration_up) ;
  while (enumerator_51794.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51794.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1185)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1190)) COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    cEnumerator_XcodeObjectReferenceList enumerator_52114 (enumerator_51794.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1192)), kEnumeration_up) ;
    while (enumerator_52114.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52114.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (enumerator_52114.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      enumerator_52114.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1197)).reader_length (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51794.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51794.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)) ;
    }
    ...
    enumerator_51794.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXGroup section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1209)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52883 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_52883.hasCurrentObject () && bool_7) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    while (enumerator_52883.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52883.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (enumerator_52883.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (function_getPBXFileReferenceKey (enumerator_52883.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1216)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (enumerator_52883.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
      cEnumerator_stringlist enumerator_53321 (enumerator_52883.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53321.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53321.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
        enumerator_53321.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52883.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1221)) ;
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1222)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1223)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1224)) COMMA_SOURCE_FILE_AT_LINE (1222)) ;
      cEnumerator_stringlist enumerator_53618 (enumerator_52883.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53618.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53618.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1227)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        enumerator_53618.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1229)).operator_concat (enumerator_52883.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (enumerator_52883.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (enumerator_52883.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (function_getPBXFileReferenceKey (enumerator_52883.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1233)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
      enumerator_52883.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1237)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1240)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1246)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1249)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54793 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1251)), kEnumeration_up) ;
  while (enumerator_54793.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54793.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (enumerator_54793.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
    enumerator_54793.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1254)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1255)) COMMA_SOURCE_FILE_AT_LINE (1254)) ;
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55076 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55076.hasCurrentObject () && bool_8) {
    ...
    while (enumerator_55076.hasCurrentObject () && bool_8) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55076.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1261)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (enumerator_55076.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55458 (enumerator_55076.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1266)), kEnumeration_up) ;
      while (enumerator_55458.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55458.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)) ;
        enumerator_55458.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1269)) ;
      enumerator_55076.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXResourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1272)) ;
  }
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55861 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_55861.hasCurrentObject () && bool_9) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    while (enumerator_55861.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55861.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1278)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (enumerator_55861.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1281)) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56239 (enumerator_55861.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1283)), kEnumeration_up) ;
      while (enumerator_56239.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56239.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)) ;
        enumerator_56239.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1286)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1287)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
  ...
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56634 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56634.hasCurrentObject () && bool_10) {
    ...
    while (enumerator_56634.hasCurrentObject () && bool_10) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56634.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1295)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (enumerator_56634.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE_AT_LINE (1299)) COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (enumerator_56634.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE_AT_LINE (1300)).reader_string (SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57139 (enumerator_56634.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1302)), kEnumeration_up) ;
      while (enumerator_57139.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57139.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)) ;
        enumerator_57139.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1305)) ;
      enumerator_56634.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57530 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57530.hasCurrentObject () && bool_11) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    while (enumerator_57530.hasCurrentObject () && bool_11) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57530.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1314)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1314)) COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1316)).operator_concat (enumerator_57530.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1314)) ;
      enumerator_57530.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1319)) ;
  }
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58025 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58025.hasCurrentObject () && bool_12) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1323)) ;
    while (enumerator_58025.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58025.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (enumerator_58025.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (enumerator_58025.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (enumerator_58025.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1332)) COMMA_SOURCE_FILE_AT_LINE (1325)) ;
      enumerator_58025.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58578 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58578.hasCurrentObject () && bool_13) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
    while (enumerator_58578.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58578.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1340)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
      cEnumerator_stringlist enumerator_58878 (enumerator_58578.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1343)), kEnumeration_up) ;
      while (enumerator_58878.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58878.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1344)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
        enumerator_58878.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1346)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1347)) COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      enumerator_58578.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCBuildConfiguration section */\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (1349)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59208 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1352)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59208.hasCurrentObject () && bool_14) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    while (enumerator_59208.hasCurrentObject () && bool_14) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59208.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1355)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1358)).operator_concat (function_getPBXFileReferenceKey (enumerator_59208.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1359)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1362)) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      enumerator_59208.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1364)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1367)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1368)) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_61960_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_61960_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      ...
      cEnumerator_stringlist enumerator_62181 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62181.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1422)).operator_concat (enumerator_62181.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
        {
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
        }
        enumerator_62181.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_cppSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; name = ") COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (97)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (95)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pchSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.pch; name = ") COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (125)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (123)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.obj; name = ") COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (139)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (137)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mmSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (152)) COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.objcpp; name = ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (153)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (151)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_gifFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.gif; name = ") COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (167)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_tiffFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.tiff; name = ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (181)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (181)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (181)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (179)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pngFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.png; name = ") COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (195)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (196)) COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (196)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (208)) COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.plist; name = ") COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (209)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_frameworkFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.framework; name = ") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (223)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (223)) COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_icnsFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (236)) COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.icns; name = ") COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (237)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (235)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_xibFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.xib; name = ") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (252)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (250)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (" /* Frameworks */ = {\n") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("\t\t\tisa = PBXFrameworksBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_17050 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  while (enumerator_17050.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17050.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (381)), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (enumerator_17050.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE_AT_LINE (382)).reader_mFileName (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (381)) ;
    enumerator_17050.gotoNextObject () ;
  }
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (384)) ;
}
//---------------------------------------------------------------------------*
