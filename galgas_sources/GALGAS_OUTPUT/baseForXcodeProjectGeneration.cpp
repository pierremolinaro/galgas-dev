...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34386 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34386.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34386.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 788)) ;
    }
    enumerator_34386.gotoNextObject () ;
  }
}
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37564 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37564.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37564.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 868)) ;
    }
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37994 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37994.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37994.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 884)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38732 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38732.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38732.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 902)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ...
    enumerator_38732.gotoNextObject () ;
  }
}
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  cEnumerator_stringlist enumerator_46143 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_46143.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)), enumerator_46143.current_mValue (HERE) COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1063)) ;
    ...
    enumerator_46143.gotoNextObject () ;
  }
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47648 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47648.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47648.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)).operator_concat (GALGAS_string ("\",\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1102)) ;
    enumerator_47648.gotoNextObject () ;
  }
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_51057 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_51057.hasCurrentObject () && bool_0) {
    ...
    while (enumerator_51057.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_51057.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1167)) ;
  ...
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51325 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51325.hasCurrentObject () && bool_1) {
    ...
    while (enumerator_51325.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51325.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1173)) ;
  ...
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51627 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51627.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51627.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51627.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1179)) ;
      enumerator_51627.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51963 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1184)), kEnumeration_up) ;
  while (enumerator_51963.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51963.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)).operator_concat (GALGAS_string (" */")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1187)) ;
    }
    ...
    cEnumerator_XcodeObjectReferenceList enumerator_52287 (enumerator_51963.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1192)), kEnumeration_up) ;
    while (enumerator_52287.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52287.current_mRefString (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (enumerator_52287.current_mComment (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1193)) ;
      enumerator_52287.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).reader_length (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1197)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51963.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51963.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51963.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1204)) ;
    }
    ...
    enumerator_51963.gotoNextObject () ;
  }
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_53056 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_53056.hasCurrentObject () && bool_7) {
    ...
    while (enumerator_53056.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_53056.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (enumerator_53056.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1215)).operator_concat (function_getPBXFileReferenceKey (enumerator_53056.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (enumerator_53056.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\" */;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1214)) ;
      cEnumerator_stringlist enumerator_53498 (enumerator_53056.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53498.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53498.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1219)) ;
        enumerator_53498.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_53056.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1221)) ;
      ...
      cEnumerator_stringlist enumerator_53795 (enumerator_53056.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53795.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53795.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)).operator_concat (GALGAS_string (" /*  */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1227)) ;
        enumerator_53795.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)).operator_concat (enumerator_53056.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1230)).operator_concat (enumerator_53056.current_mProductInstallPath (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1231)).operator_concat (enumerator_53056.current_mProductName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1232)).operator_concat (function_getPBXFileReferenceKey (enumerator_53056.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1233)).operator_concat (var_productExtension  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1234))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1229)) ;
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54974 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1251)), kEnumeration_up) ;
  while (enumerator_54974.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54974.current_mTargetKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (enumerator_54974.current_mTargetName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1252)) ;
  ...
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55257 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55257.hasCurrentObject () && bool_8) {
  ...
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_56050 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_56050.hasCurrentObject () && bool_9) {
    ...
    while (enumerator_56050.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56050.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)).operator_concat (enumerator_56050.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1279)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1280)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1281))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56432 (enumerator_56050.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1283)), kEnumeration_up) ;
      while (enumerator_56432.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56432.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1284)) ;
        enumerator_56432.gotoNextObject () ;
      }
      ...
      enumerator_56050.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56831 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56831.hasCurrentObject () && bool_10) {
  ...
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57735 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57735.hasCurrentObject () && bool_11) {
  ...
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58234 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58234.hasCurrentObject () && bool_12) {
    ...
    while (enumerator_58234.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58234.current_mPBXVariantKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)).operator_concat (enumerator_58234.current_mName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string (" */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1326)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1327)).operator_concat (GALGAS_string ("\t\t\t\t")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1328)).operator_concat (enumerator_58234.current_mPBXFileReferenceKey (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string (" ,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string ("\t\t\t);\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1329)).operator_concat (GALGAS_string ("\t\t\tname = ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1330)).operator_concat (enumerator_58234.current_mName (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string (";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1331)).operator_concat (GALGAS_string ("\t\t};\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1332))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1325)) ;
      enumerator_58234.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58787 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58787.hasCurrentObject () && bool_13) {
    ...
    while (enumerator_58787.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58787.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string (" /* Default */ = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1341))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1340)) ;
      cEnumerator_stringlist enumerator_59091 (enumerator_58787.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1343)), kEnumeration_up) ;
      while (enumerator_59091.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_59091.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)).operator_concat (GALGAS_string ("\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1344)) ;
      ...
      enumerator_58787.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59421 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1352)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59421.hasCurrentObject () && bool_14) {
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_62189_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_62189_0, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1418)) ;
      ...
      cEnumerator_stringlist enumerator_62410 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62410.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)).operator_concat (enumerator_62410.current_mValue (HERE)  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1422)) ;
        {
        ...
        enumerator_62410.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_17119 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  while (enumerator_17119.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17119.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)), inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (GALGAS_string (" /* ")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (enumerator_17119.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381)).reader_mFileName (SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)).operator_concat (GALGAS_string (" */,\n")  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 381))  COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 380)) ;
