...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58791 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_58791.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_58780 = (var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists ()).operator_not ()) ;
    if (cond_58780.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58641 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58641 = NULL ;
        while (((operand_58641 = enumerator_58641.nextObject ()))) {
          macroValidPointer (operand_58641) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58641->mValue) ;
