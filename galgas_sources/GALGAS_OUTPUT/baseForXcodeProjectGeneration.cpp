...
//                    september 26th, 2008, at 23h16'18"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
cPtr_Xcode_rootObject (const GGS_string& argument_0,
                                ...
                                const GGS_Xcode_PBXFileReference_map & argument_7,
...
mPBXFileReference_map (argument_7),
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mProjectName._operator_isEqual (_p->mProjectName).boolValue ()
         ...
         && mPBXFileReference_map._operator_isEqual (_p->mPBXFileReference_map).boolValue ()
...
method_build (C_Compiler & _inLexique,
  ...
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_7966 (mPBXBuildFile_list, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_7966 = NULL ;
    while (((operand_7966 = enumerator_7966.nextObject ()))) {
      macroValidPointer (operand_7966) ;
      const GGS_Xcode_PBXBuildFile  _temp_8000 = operand_7966->mFile ;
      if (_temp_8000._isBuilt ()) {
        _temp_8000 (HERE)->method_buildXcodeProject (_inLexique, var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
    }
  }
  ...
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_8210 (mPBXFileReference_map, true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_8210 = NULL ;
    while (((operand_8210 = enumerator_8210.nextObject ()))) {
      macroValidPointer (operand_8210) ;
      const GGS_Xcode_PBXFileReference_abstract  _temp_8253 = operand_8210->mInfo.mFileReference ;
      if (_temp_8253._isBuilt ()) {
        _temp_8253 (HERE)->method_buildXcodeProject (_inLexique, var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (210)) ;
      }
    }
  }
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_8438 (mGroupList, true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_8438 = NULL ;
    while (((operand_8438 = enumerator_8438.nextObject ()))) {
      macroValidPointer (operand_8438) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_8438->mGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (216))) ;
      var_cas_ioString.writeString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_8581 (operand_8438->mGroup.reader_mChildrenGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)), true) ;
        const GGS_stringlist::cElement * operand_8581 = NULL ;
        while (((operand_8581 = enumerator_8581.nextObject ()))) {
          macroValidPointer (operand_8581) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_8581->mValue) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n") ;
      if (((operand_8438->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (223)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_ioString.writeString ("\t\t\tname = \"") ;
        var_cas_ioString._dotAssign_operation (operand_8438->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (224))) ;
        var_cas_ioString.writeString ("\";\n") ;
      }
      if (((operand_8438->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        var_cas_ioString.writeString ("\t\t\tpath = \"") ;
        var_cas_ioString._dotAssign_operation (operand_8438->mGroup.reader_mGroupPath (_inLexique COMMA_SOURCE_FILE_AT_LINE (227))) ;
        var_cas_ioString.writeString ("\";\n") ;
      }
      var_cas_ioString.writeString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_9219 (mTargetList, true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_9219 = NULL ;
    while (((operand_9219 = enumerator_9219.nextObject ()))) {
      macroValidPointer (operand_9219) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mTargetName) ;
      var_cas_ioString.writeString (" */ = {\n"
      "\t\t\tisa = PBXNativeTarget;\n"
      "\t\t\tbuildConfigurationList = ") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mTargetConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (238))) ;
      var_cas_ioString.writeString (" /* Build configuration list for PBXNativeTarget \"") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mTargetName) ;
      var_cas_ioString.writeString ("\" */;\n"
      "\t\t\tbuildPhases = (\n") ;
      {
        GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_9578 (operand_9219->mBuildPhaseList, true) ;
        const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_9578 = NULL ;
        while (((operand_9578 = enumerator_9578.nextObject ()))) {
          macroValidPointer (operand_9578) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_9578->mBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (241))) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n"
      ...
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductInstallPath = \"") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mProductInstallPath) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductName = \"") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mProductName) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t\tproductReference = ") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mProduct.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (251))) ;
      var_cas_ioString.writeString (" ;\n"
      "\t\t\tproductType = \"com.apple.product-type.") ;
      var_cas_ioString._dotAssign_operation (operand_9219->mProduct.reader_toolProductExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
      var_cas_ioString.writeString ("\";\n"
      "\t\t};\n") ;
    }
  }
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_10875 (mTargetList, true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_10875 = NULL ;
    while (((operand_10875 = enumerator_10875.nextObject ()))) {
      macroValidPointer (operand_10875) ;
      var_cas_ioString.writeString ("\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_10875->mTargetKey) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_10875->mTargetName) ;
      var_cas_ioString.writeString (" */,\n") ;
    }
  }
  var_cas_ioString.writeString ("\t\t\t);\n"
  ...
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_11196 (mPBXSourcesBuildPhase_list, true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_11196 = NULL ;
    while (((operand_11196 = enumerator_11196.nextObject ()))) {
      macroValidPointer (operand_11196) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_11196->mBuildPhase.reader_PBXSourcesBuildPhaseKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (277))) ;
      var_cas_ioString.writeString (" /* ") ;
      var_cas_ioString._dotAssign_operation (operand_11196->mBuildPhase.reader_mNameForComment (_inLexique COMMA_SOURCE_FILE_AT_LINE (278))) ;
      var_cas_ioString.writeString (" */ = {\n"
      "\t\t\tisa = PBXSourcesBuildPhase;\n"
      "\t\t\tbuildActionMask = 2147483647;\n"
      "\t\t\tfiles = (\n") ;
      {
        GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_11465 (operand_11196->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (282)), true) ;
        const GGS_Xcode_PBXBuildFile_list::cElement * operand_11465 = NULL ;
        while (((operand_11465 = enumerator_11465.nextObject ()))) {
          macroValidPointer (operand_11465) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_11465->mFile.reader_PBXBuildFileKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (283))) ;
          var_cas_ioString.writeString (" ,\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t);\n"
  ...
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_11910 (mBuildConfigurationList, true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_11910 = NULL ;
    while (((operand_11910 = enumerator_11910.nextObject ()))) {
      macroValidPointer (operand_11910) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_11910->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (293))) ;
      var_cas_ioString.writeString (" /* Default */ = {\n"
      "\t\t\tisa = XCBuildConfiguration;\n"
      "\t\t\tbuildSettings = {\n") ;
      {
        GGS_stringlist::cEnumerator enumerator_12097 (operand_11910->mBuildConfig.reader_mSettings (_inLexique COMMA_SOURCE_FILE_AT_LINE (296)), true) ;
        const GGS_stringlist::cElement * operand_12097 = NULL ;
        while (((operand_12097 = enumerator_12097.nextObject ()))) {
          macroValidPointer (operand_12097) ;
          var_cas_ioString.writeString ("\t\t\t\t") ;
          var_cas_ioString._dotAssign_operation (operand_12097->mValue) ;
          var_cas_ioString.writeString ("\n") ;
        }
      }
      var_cas_ioString.writeString ("\t\t\t};\n"
  ...
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_12491 (mBuildConfigurationList, true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_12491 = NULL ;
    while (((operand_12491 = enumerator_12491.nextObject ()))) {
      macroValidPointer (operand_12491) ;
      var_cas_ioString.writeString ("\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_12491->mBuildConfig.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (307))) ;
      var_cas_ioString.writeString (" /* Build configuration list */ = {\n"
      "\t\t\tisa = XCConfigurationList;\n"
      "\t\t\tbuildConfigurations = (\n"
      "\t\t\t\t") ;
      var_cas_ioString._dotAssign_operation (operand_12491->mBuildConfig.reader_configurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (310))) ;
      var_cas_ioString.writeString (" /* Default */,\n"
      "\t\t\t);\n"
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@Xcode_rootObject:"
           ...
           << mPBXFileReference_map.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
GGS_Xcode_PBXFileReference_map  GGS_Xcode_rootObject::
reader_mPBXFileReference_map (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_Xcode_PBXFileReference_map   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_Xcode_rootObject *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_Xcode_rootObject *) mPointer)->mPBXFileReference_map ;
  }
  return result ;
}
...
void routine_enter_source_files_for_build_phase (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_13452 (var_cas_in_cpp_fileList, true) ;
    const GGS_stringlist::cElement * operand_13452 = NULL ;
    while (((operand_13452 = enumerator_13452.nextObject ()))) {
      macroValidPointer (operand_13452) ;
      GGS_lstring  var_cas_key ;
      var_cas_key = GGS_lstring ::constructor_new (_inLexique, operand_13452->mValue, GGS_location (_inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  _temp_13571 = var_cas_inFileReferenceMap ;
      if (_temp_13571._isBuilt ()) {
        _temp_13571 (HERE)->method_searchKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (335)) ;
      }
...
void routine_enter_cpp_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (358)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (359))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_h_file_in_group (C_Compiler & _inLexique,
  ...
  var_cas_ioFileReferenceMap.modifier_insertKey (_inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (371)) ;
  var_cas_ioFileListForGroup._addAssign_operation (var_cas_ref.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_in_group (C_Compiler & _inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_15093 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_15093 = NULL ;
    while (((operand_15093 = enumerator_15093.nextObject ()))) {
      macroValidPointer (operand_15093) ;
      GGS_string var_cas_extension ;
      var_cas_extension = operand_15093->mValue.reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (383)) ;
      if (((var_cas_extension)._operator_isEqual (GGS_string (true, "cpp"))).isBuiltAndTrue ()) {
        ::routine_enter_cpp_file_in_group (_inLexique,  operand_15093->mValue,  var_cas_ioFileReferenceMap,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (385)) ;
      }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "h"))).isBuiltAndTrue ()) {
        ::routine_enter_h_file_in_group (_inLexique,  operand_15093->mValue,  var_cas_ioFileReferenceMap,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (387)) ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "cannot enter '"))._operator_concat (operand_15093->mValue))._operator_concat (GGS_string (true, "' file : unknown extension")) COMMA_SOURCE_FILE_AT_LINE (390)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_target (C_Compiler & _inLexique,
                                ...
                                GGS_Xcode_PBXFileReference_map  & var_cas_ioPBXFileReference_map,
                                GGS_Xcode_PBXSourcesBuildPhase_list  & var_cas_ioPBXSourcesBuildPhase_list,
                                GGS_Xcode_XCBuildConfiguration_list  & var_cas_ioBuildConfigurationList,
                                GGS_Xcode_PBXNativeTarget_list  & var_cas_ioTargetList COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
  ...
  var_cas_ioPBXFileReference_map.modifier_insertKey (_inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (408)) ;
  var_cas_ioProductGroupChildrenList._addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))) ;
  ...
  var_cas_ioTargetList._addAssign_operation (GGS_uint ::constructor_sequenceNumber (_inLexique COMMA_HERE).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)).reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (421)), var_cas_inTargetName, var_cas_toolTargetBuildConfiguration, GGS_string (true, "$(HOME)/bin"), var_cas_inProductFileName, var_cas_toolFileReference, GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_listWithValue (var_cas_compileSourcesForToolTargetBuildPhase)) ;
  #ifdef DEBUG_TRACE_ENABLED
