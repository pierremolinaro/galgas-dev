...
GALGAS_string function_getPBXFileReferenceKey (const GALGAS_uint & constinArgument_inSequenceNumber,
  ...
  result_outResult = constinArgument_inSequenceNumber.reader_string (SOURCE_FILE_AT_LINE (37)).reader_md_35_ (SOURCE_FILE_AT_LINE (37)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (37)) ;
//---
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (809)).reader_string (SOURCE_FILE_AT_LINE (809)).reader_md_35_ (SOURCE_FILE_AT_LINE (809)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (809)) ;
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (835)).reader_string (SOURCE_FILE_AT_LINE (835)).reader_md_35_ (SOURCE_FILE_AT_LINE (835)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (835)) ;
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (941)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (959)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (960)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (958)) ;
  ...
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (966)).reader_string (SOURCE_FILE_AT_LINE (966)).reader_md_35_ (SOURCE_FILE_AT_LINE (966)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (966)) ;
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_Xcode_5F_PBXCopyBuildPhase var_copyBuildPhase = GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1040)), GALGAS_string::makeEmptyString (), GALGAS_uint ((uint32_t) 1U), GALGAS_string ("Contents/Library/LaunchServices"), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_listWithValue (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1039)) ;
  ...
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1071)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1072)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1072)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1070)) ;
  ...
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1078)).reader_string (SOURCE_FILE_AT_LINE (1078)).reader_md_35_ (SOURCE_FILE_AT_LINE (1078)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (1078)) ;
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1155)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (1155)) ;
  ...
  while (enumerator_51794.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51794.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1197)).reader_length (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1383)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1384)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1384)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1382)) ;
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1410)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
