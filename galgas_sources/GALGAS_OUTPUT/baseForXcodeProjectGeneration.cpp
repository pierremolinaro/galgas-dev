...
//                    september 23th, 2012, at 14h8'41"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_36450 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36450.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_36450.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (846)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_36880 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36880.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_36880.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (862)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ...
    enumerator_36880.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_37618 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37618.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37618.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (880)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ...
    enumerator_37618.gotoNextObject () ;
  }
}
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (918)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_44021 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44021.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1021)), enumerator_44021.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1021)) ;
    //-------- @incrementInstructionForGeneration
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_45524 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45524.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_45524.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    enumerator_45524.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outProjectDefaultSettings = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1062)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ALWAYS_SEARCH_USER_PATHS = NO;") COMMA_SOURCE_FILE_AT_LINE (1063)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ARCHS = \"$(ARCHS_STANDARD_64_BIT)\";") COMMA_SOURCE_FILE_AT_LINE (1064)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inUsesARC.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_ENABLE_OBJC_ARC = YES;") COMMA_SOURCE_FILE_AT_LINE (1066)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;") COMMA_SOURCE_FILE_AT_LINE (1068)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;") COMMA_SOURCE_FILE_AT_LINE (1070)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1071)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;") COMMA_SOURCE_FILE_AT_LINE (1072)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1073)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_WARNINGS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1074)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_64_TO_32_BIT_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1075)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;") COMMA_SOURCE_FILE_AT_LINE (1076)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_NEWLINE = YES;") COMMA_SOURCE_FILE_AT_LINE (1077)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_PROTOTYPES = YES;") COMMA_SOURCE_FILE_AT_LINE (1078)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_RETURN_TYPE = YES;") COMMA_SOURCE_FILE_AT_LINE (1079)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_CHECK_SWITCH_STATEMENTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1080)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;") COMMA_SOURCE_FILE_AT_LINE (1082)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INHIBIT_ALL_WARNINGS = NO;") COMMA_SOURCE_FILE_AT_LINE (1083)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;") COMMA_SOURCE_FILE_AT_LINE (1084)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_MISSING_PARENTHESES = YES;") COMMA_SOURCE_FILE_AT_LINE (1085)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;") COMMA_SOURCE_FILE_AT_LINE (1086)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PEDANTIC = NO;") COMMA_SOURCE_FILE_AT_LINE (1087)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SHADOW = NO;") COMMA_SOURCE_FILE_AT_LINE (1088)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SIGN_COMPARE = YES;") COMMA_SOURCE_FILE_AT_LINE (1089)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;") COMMA_SOURCE_FILE_AT_LINE (1090)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNINITIALIZED_AUTOS = YES;") COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNKNOWN_PRAGMAS = YES;") COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_FUNCTION = YES;") COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_LABEL = YES;") COMMA_SOURCE_FILE_AT_LINE (1094)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = YES;") COMMA_SOURCE_FILE_AT_LINE (1095)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VALUE = YES;") COMMA_SOURCE_FILE_AT_LINE (1096)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VARIABLE = YES;") COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("HEADER_SEARCH_PATHS = (\n").operator_concat (var_pathString COMMA_SOURCE_FILE_AT_LINE (1098)).operator_concat (GALGAS_string ("\t\t\t\t);") COMMA_SOURCE_FILE_AT_LINE (1098)) COMMA_SOURCE_FILE_AT_LINE (1098)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("SDKROOT = ").operator_concat (constinArgument_inSDK COMMA_SOURCE_FILE_AT_LINE (1099)).operator_concat (GALGAS_string (" ;") COMMA_SOURCE_FILE_AT_LINE (1099)) COMMA_SOURCE_FILE_AT_LINE (1099)) ;
}
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1111)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1111)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n") COMMA_SOURCE_FILE_AT_LINE (1114)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1115)).operator_concat (GALGAS_string ("\tclasses = {\n") COMMA_SOURCE_FILE_AT_LINE (1116)).operator_concat (GALGAS_string ("\t};\n") COMMA_SOURCE_FILE_AT_LINE (1117)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n") COMMA_SOURCE_FILE_AT_LINE (1118)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1119)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_48774 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1121)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_48774.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1122)) ;
    while (enumerator_48774.hasCurrentObject () && bool_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_48774.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_48774.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_49042 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1127)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_1 = true ;
  if (enumerator_49042.hasCurrentObject () && bool_1) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1128)) ;
    while (enumerator_49042.hasCurrentObject () && bool_1) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_49042.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1129)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_49042.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1130)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_49344 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1133)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_2 = true ;
  if (enumerator_49344.hasCurrentObject () && bool_2) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_49344.hasCurrentObject () && bool_2) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_49344.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1135)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_49344.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_49674 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1140)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49674.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_49674.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1141)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1141)) COMMA_SOURCE_FILE_AT_LINE (1141)) COMMA_SOURCE_FILE_AT_LINE (1141)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1142)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1146)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1147)) COMMA_SOURCE_FILE_AT_LINE (1145)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_XcodeObjectReferenceList enumerator_49994 (enumerator_49674.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1148)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_49994.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_49994.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1149)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1149)).operator_concat (enumerator_49994.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1149)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1149)) COMMA_SOURCE_FILE_AT_LINE (1149)) ;
      enumerator_49994.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1151)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1152)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1153)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1153)).reader_length (SOURCE_FILE_AT_LINE (1153)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1154)) COMMA_SOURCE_FILE_AT_LINE (1154)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1154)) COMMA_SOURCE_FILE_AT_LINE (1154)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_49674.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1156)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_49674.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1159)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_49674.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1163)) COMMA_SOURCE_FILE_AT_LINE (1162)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_50769 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1167)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_7 = true ;
  if (enumerator_50769.hasCurrentObject () && bool_7) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    while (enumerator_50769.hasCurrentObject () && bool_7) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_50769.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1170)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1170)).operator_concat (enumerator_50769.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1170)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1170)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1171)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (function_getPBXFileReferenceKey (enumerator_50769.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1172)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1172)) COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (enumerator_50769.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1173)) COMMA_SOURCE_FILE_AT_LINE (1170)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_51201 (enumerator_50769.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51201.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_51201.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1175)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1175)) COMMA_SOURCE_FILE_AT_LINE (1175)) ;
        enumerator_51201.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_productExtension ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_50769.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1177)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1179)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1180)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1181)) COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_51498 (enumerator_50769.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51498.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_51498.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1183)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1183)) COMMA_SOURCE_FILE_AT_LINE (1183)) ;
        enumerator_51498.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (enumerator_50769.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (enumerator_50769.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (enumerator_50769.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (function_getPBXFileReferenceKey (enumerator_50769.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1189)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1189)) COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
      enumerator_50769.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1193)) ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1197)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1197)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1197)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1198)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1202)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1203)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1203)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1203)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1196)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52673 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1207)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_52673.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52673.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1208)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1208)).operator_concat (enumerator_52673.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1208)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1208)) ;
    enumerator_52673.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1211)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1212)) COMMA_SOURCE_FILE_AT_LINE (1210)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_52962 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1214)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_8 = true ;
  if (enumerator_52962.hasCurrentObject () && bool_8) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_52962.hasCurrentObject () && bool_8) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_52962.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1217)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) COMMA_SOURCE_FILE_AT_LINE (1217)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (enumerator_52962.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1218)) COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1221)) COMMA_SOURCE_FILE_AT_LINE (1217)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_53338 (enumerator_52962.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1222)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_53338.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_53338.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1223)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1223)) COMMA_SOURCE_FILE_AT_LINE (1223)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1223)) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
        enumerator_53338.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1226)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1225)) ;
      enumerator_52962.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXResourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1228)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_53747 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1231)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_9 = true ;
  if (enumerator_53747.hasCurrentObject () && bool_9) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1232)) ;
    while (enumerator_53747.hasCurrentObject () && bool_9) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_53747.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1234)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (enumerator_53747.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1236)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1237)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1238)) COMMA_SOURCE_FILE_AT_LINE (1234)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_54119 (enumerator_53747.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1239)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54119.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_54119.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1240)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1240)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
        enumerator_54119.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1244)) COMMA_SOURCE_FILE_AT_LINE (1242)) ;
      enumerator_53747.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1245)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_54514 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1248)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_10 = true ;
  if (enumerator_54514.hasCurrentObject () && bool_10) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1249)) ;
    while (enumerator_54514.hasCurrentObject () && bool_10) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_54514.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1251)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1251)) COMMA_SOURCE_FILE_AT_LINE (1251)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1253)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1254)).operator_concat (enumerator_54514.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1254)) COMMA_SOURCE_FILE_AT_LINE (1254)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1254)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1255)) COMMA_SOURCE_FILE_AT_LINE (1251)) ;
      enumerator_54514.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1256)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_55009 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1259)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_11 = true ;
  if (enumerator_55009.hasCurrentObject () && bool_11) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1260)) ;
    while (enumerator_55009.hasCurrentObject () && bool_11) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_55009.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (enumerator_55009.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1265)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (enumerator_55009.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (enumerator_55009.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      enumerator_55009.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1271)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_55562 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1274)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_12 = true ;
  if (enumerator_55562.hasCurrentObject () && bool_12) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1275)) ;
    while (enumerator_55562.hasCurrentObject () && bool_12) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55562.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1277)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_55856 (enumerator_55562.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1280)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_55856.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_55856.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1281)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1281)) COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        enumerator_55856.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1284)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1285)) COMMA_SOURCE_FILE_AT_LINE (1283)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_56192 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1289)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_13 = true ;
  if (enumerator_56192.hasCurrentObject () && bool_13) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1290)) ;
    while (enumerator_56192.hasCurrentObject () && bool_13) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56192.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1292)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1292)) COMMA_SOURCE_FILE_AT_LINE (1292)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1292)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1293)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1293)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1294)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (function_getPBXFileReferenceKey (enumerator_56192.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1296)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1292)) ;
  ...
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1304)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_projectName = constinArgument_in_5F_xcodeproj_5F_filePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (1317)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (1317)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1320)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1321)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1321)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1319)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1324)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1325)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_defaultProjectConfiguration COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enter_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("Products"), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mProductGroupChildrenList (SOURCE_FILE_AT_LINE (1332)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1328)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXGroup var_mainGroup = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1335)), GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mMainGroupChildrenList (SOURCE_FILE_AT_LINE (1335)) COMMA_SOURCE_FILE_AT_LINE (1335)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_mainGroup COMMA_SOURCE_FILE_AT_LINE (1337)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_string var_fileNewContents ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildXcodeProjectString (ioArgument_ioXcodeProjectDescription, var_projectName, function_getPBXFileReferenceKey (var_mainGroup.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1343)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)), function_getPBXFileReferenceKey (var_defaultProjectConfiguration.reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1344)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1344)), var_fileNewContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1347)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_in_5F_xcodeproj_5F_filePath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (1349)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_written ;
    //-------- @methodCallInstructionForGeneration
    var_fileNewContents.method_writeToFileWhenDifferentContents (constinArgument_inReferenceFilePath, var_written, inCompiler COMMA_SOURCE_FILE_AT_LINE (1352)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_pbxprojFilePath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/project.pbxproj") COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE_AT_LINE (1354)).operator_not (SOURCE_FILE_AT_LINE (1354)) COMMA_SOURCE_FILE_AT_LINE (1354)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_58936_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_58936_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_pbxuser_5F_files = constinArgument_in_5F_xcodeproj_5F_filePath.reader_regularFilesWithExtensions (GALGAS_bool (false), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("pbxuser") COMMA_SOURCE_FILE_AT_LINE (1357)) COMMA_SOURCE_FILE_AT_LINE (1357)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_59159 (var_pbxuser_5F_files, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_59159.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (enumerator_59159.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1359)) ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1360)) ;
        } //-------- @routineCallInstructionForGeneration
        enumerator_59159.gotoNextObject () ;
      }
    }
  }
}
