...
void cPtr_Xcode_PBXBuildFile::computeOnce10652 (C_Compiler & inLexique) const {
  _mOnce10652isComputed = true ;
...
GGS_string cPtr_Xcode_PBXBuildFile::reader_PBXBuildFileKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce10652isComputed) {
    computeOnce10652 (inLexique) ;
  }
...
void cPtr_Xcode_PBXSourcesBuildPhase::computeOnce11751 (C_Compiler & inLexique) const {
  _mOnce11751isComputed = true ;
...
GGS_string cPtr_Xcode_PBXSourcesBuildPhase::reader_PBXSourcesBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce11751isComputed) {
    computeOnce11751 (inLexique) ;
  }
...
void cPtr_Xcode_PBXResourcesBuildPhase::computeOnce12596 (C_Compiler & inLexique) const {
  _mOnce12596isComputed = true ;
...
GGS_string cPtr_Xcode_PBXResourcesBuildPhase::reader_PBXResourcesBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce12596isComputed) {
    computeOnce12596 (inLexique) ;
  }
...
void cPtr_Xcode_PBXFrameworksBuildPhase::computeOnce13454 (C_Compiler & inLexique) const {
  _mOnce13454isComputed = true ;
...
GGS_string cPtr_Xcode_PBXFrameworksBuildPhase::reader_PBXFrameworksBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce13454isComputed) {
    computeOnce13454 (inLexique) ;
  }
...
method_buildXcodeProject (C_Compiler & inLexique,
  ...
  "\t\t\tfiles = (\n") ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_13738 (mFileReferenceList, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_13738 = NULL ;
    while (((operand_13738 = enumerator_13738.nextObject ()))) {
      macroValidPointer (operand_13738) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_13738->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (316))) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_13738->mFile.reader_mSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (317)).reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (317))) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
...
void cPtr_Xcode_PBXGroup::computeOnce14828 (C_Compiler & inLexique) const {
  _mOnce14828isComputed = true ;
  PBXGroupKey.drop () ;
...
GGS_string cPtr_Xcode_PBXGroup::reader_PBXGroupKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14828isComputed) {
    computeOnce14828 (inLexique) ;
  }
  return PBXGroupKey ;
}
...
_mOnce15608isComputed (false),
configurationKey (),
_mOnce15742isComputed (false),
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce15608 (C_Compiler & inLexique) const {
  _mOnce15608isComputed = true ;
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce15742 (C_Compiler & inLexique) const {
  _mOnce15742isComputed = true ;
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_configurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce15608isComputed) {
    computeOnce15608 (inLexique) ;
  }
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_XCBuildConfigurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce15742isComputed) {
    computeOnce15742 (inLexique) ;
  }
...
void cPtr_Xcode_targetDependencyDescription::computeOnce17237 (C_Compiler & inLexique) const {
  _mOnce17237isComputed = true ;
...
GGS_string cPtr_Xcode_targetDependencyDescription::reader_PBXTargetDependencyKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce17237isComputed) {
    computeOnce17237 (inLexique) ;
  }
...
void routine_enter_file_in_group (C_Compiler & inLexique,
  ...
  const GGS_bool cond_29315 = (var_cas_extension).operator_isEqual (GGS_string ("cpp")) ;
  if (cond_29315.isBuiltAndTrue ()) {
  ...
  }else if (cond_29315.isBuiltAndFalse ()) {
    const GGS_bool cond_29434 = (var_cas_extension).operator_isEqual (GGS_string ("h")) ;
    if (cond_29434.isBuiltAndTrue ()) {
    ...
    }else if (cond_29434.isBuiltAndFalse ()) {
      const GGS_bool cond_29557 = (var_cas_extension).operator_isEqual (GGS_string ("pch")) ;
      if (cond_29557.isBuiltAndTrue ()) {
      ...
      }else if (cond_29557.isBuiltAndFalse ()) {
        const GGS_bool cond_29676 = (var_cas_extension).operator_isEqual (GGS_string ("m")) ;
        if (cond_29676.isBuiltAndTrue ()) {
        ...
        }else if (cond_29676.isBuiltAndFalse ()) {
          const GGS_bool cond_29797 = (var_cas_extension).operator_isEqual (GGS_string ("mm")) ;
          if (cond_29797.isBuiltAndTrue ()) {
          ...
          }else if (cond_29797.isBuiltAndFalse ()) {
            const GGS_bool cond_29922 = (var_cas_extension).operator_isEqual (GGS_string ("tiff")) ;
            if (cond_29922.isBuiltAndTrue ()) {
            ...
            }else if (cond_29922.isBuiltAndFalse ()) {
              const GGS_bool cond_30045 = (var_cas_extension).operator_isEqual (GGS_string ("gif")) ;
              if (cond_30045.isBuiltAndTrue ()) {
              ...
              }else if (cond_30045.isBuiltAndFalse ()) {
                const GGS_bool cond_30168 = (var_cas_extension).operator_isEqual (GGS_string ("png")) ;
                if (cond_30168.isBuiltAndTrue ()) {
                ...
                }else if (cond_30168.isBuiltAndFalse ()) {
                  const GGS_bool cond_30295 = (var_cas_extension).operator_isEqual (GGS_string ("plist")) ;
                  if (cond_30295.isBuiltAndTrue ()) {
                  ...
                  }else if (cond_30295.isBuiltAndFalse ()) {
                    const GGS_bool cond_30430 = (var_cas_extension).operator_isEqual (GGS_string ("framework")) ;
                    if (cond_30430.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_30430.isBuiltAndFalse ()) {
                      const GGS_bool cond_30554 = (var_cas_extension).operator_isEqual (GGS_string ("icns")) ;
                      if (cond_30554.isBuiltAndTrue ()) {
                      ...
                      }else if (cond_30554.isBuiltAndFalse ()) {
...
void routine_enter_files_in_group (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_30922 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_30922 = NULL ;
    while (((operand_30922 = enumerator_30922.nextObject ()))) {
      macroValidPointer (operand_30922) ;
      ::routine_enter_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  operand_30922->mValue,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (737)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_file_for_sources_build_phase (C_Compiler & inLexique,
  ...
  const GGS_Xcode_PBXFileReference_map  temp_33494 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (802)) ;
  if (temp_33494.isBuilt ()) {
    temp_33494 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (802)) ;
  }
...
void routine_enter_file_list_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34043 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34043 = NULL ;
    while (((operand_34043 = enumerator_34043.nextObject ()))) {
      macroValidPointer (operand_34043) ;
      ::routine_enter_file_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  operand_34043->mValue,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (817)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34473 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34473 = NULL ;
    while (((operand_34473 = enumerator_34473.nextObject ()))) {
      macroValidPointer (operand_34473) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34473->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (833)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_34619 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)) ;
      if (temp_34619.isBuilt ()) {
        temp_34619 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (835)) ;
      }
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_35211 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_35211 = NULL ;
    while (((operand_35211 = enumerator_35211.nextObject ()))) {
      macroValidPointer (operand_35211) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_35211->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (851)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_35357 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (853)) ;
      if (temp_35357.isBuilt ()) {
        temp_35357 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (853)) ;
      }
...
void routine_add_tool_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_39657 = (var_cas_inFrameworkKeyList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_39657.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_39950 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_39950.isBuiltAndTrue ()) {
...
void routine_add_app_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_43356 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43356.isBuiltAndTrue ()) {
    var_cas_inTargetSettings.addAssign_operation (GGS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings.addAssign_operation (((GGS_string ("GCC_PREFIX_HEADER = \"")).operator_concat (var_cas_inPrecompiledHeaderPath)).operator_concat (GGS_string ("\";"))) ;
  }
  const GGS_bool cond_43475 = (var_cas_inInfoPListFile).operator_isNotEqual (GGS_string ("")) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_43790 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_43790 = NULL ;
    while (((operand_43790 = enumerator_43790.nextObject ()))) {
      macroValidPointer (operand_43790) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)), operand_43790->mValue COMMA_SOURCE_FILE_AT_LINE (1048)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_45234 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_45234 = NULL ;
    while (((operand_45234 = enumerator_45234.nextObject ()))) {
      macroValidPointer (operand_45234) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_45234->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48765 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_48765 = enumerator_48765.nextObject () ;
    if ((operand_48765 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_48765 ;
      do{
        macroValidPointer (operand_48765) ;
        if (operand_48765->mFile.isBuilt ()) {
          operand_48765->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1149)) ;
        }
        operand_48765 = enumerator_48765.nextObject () ;
        _foreach_loop_48765 = ((operand_48765 != NULL)) ;
        if (_foreach_loop_48765) {
        }
      }while (_foreach_loop_48765) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_49033 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_49033 = enumerator_49033.nextObject () ;
    if ((operand_49033 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_49033 ;
      do{
        macroValidPointer (operand_49033) ;
        if (operand_49033->mInfo.mFileReference.isBuilt ()) {
          operand_49033->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1155)) ;
        }
        operand_49033 = enumerator_49033.nextObject () ;
        _foreach_loop_49033 = ((operand_49033 != NULL)) ;
        if (_foreach_loop_49033) {
        }
      }while (_foreach_loop_49033) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49323 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49323 = enumerator_49323.nextObject () ;
    if ((operand_49323 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49323 ;
      do{
        macroValidPointer (operand_49323) ;
        if (operand_49323->mBuildPhase.isBuilt ()) {
          operand_49323->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1161)) ;
        }
        operand_49323 = enumerator_49323.nextObject () ;
        _foreach_loop_49323 = ((operand_49323 != NULL)) ;
        if (_foreach_loop_49323) {
        }
      }while (_foreach_loop_49323) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_49671 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1166)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_49671 = NULL ;
    while (((operand_49671 = enumerator_49671.nextObject ()))) {
      macroValidPointer (operand_49671) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (operand_49671->mGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1167))) ;
      const GGS_bool cond_49871 = (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1168))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_49871.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1169))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_49979 (operand_49671->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_49979 = NULL ;
        while (((operand_49979 = enumerator_49979.nextObject ()))) {
          macroValidPointer (operand_49979) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_49979->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_49979->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_50430 = (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1178))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50430.isBuiltAndTrue ()) {
        const GGS_bool cond_50338 = (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50338.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1180))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50338.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_49671->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1182))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_50552 = (operand_49671->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1185))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50552.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_49671->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1186))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_50736 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1193)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_50736 = enumerator_50736.nextObject () ;
    if ((operand_50736 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_50736 ;
      do{
        macroValidPointer (operand_50736) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50736->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50736->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (operand_50736->mTargetConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1198))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_50736->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51193 (operand_50736->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_51193 = NULL ;
          while (((operand_51193 = enumerator_51193.nextObject ()))) {
            macroValidPointer (operand_51193) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51193->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        if (operand_50736->mProduct.isBuilt ()) {
          operand_50736->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1203)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51490 (operand_50736->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_51490 = NULL ;
          while (((operand_51490 = enumerator_51490.nextObject ()))) {
            macroValidPointer (operand_51490) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51490->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50736->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_50736->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (operand_50736->mProduct.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1215))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_50736 = enumerator_50736.nextObject () ;
        _foreach_loop_50736 = ((operand_50736 != NULL)) ;
        if (_foreach_loop_50736) {
        }
      }while (_foreach_loop_50736) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_52605 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1233)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_52605 = NULL ;
    while (((operand_52605 = enumerator_52605.nextObject ()))) {
      macroValidPointer (operand_52605) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_52605->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_52605->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_52871 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_52871 = enumerator_52871.nextObject () ;
    if ((operand_52871 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_52871 ;
      do{
        macroValidPointer (operand_52871) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_52871->mBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1243))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_52871->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1244))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53261 (operand_52871->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53261 = NULL ;
          while (((operand_53261 = enumerator_53261.nextObject ()))) {
            macroValidPointer (operand_53261) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53261->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1249))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_52871 = enumerator_52871.nextObject () ;
        _foreach_loop_52871 = ((operand_52871 != NULL)) ;
        if (_foreach_loop_52871) {
        }
      }while (_foreach_loop_52871) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_53616 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_53616 = enumerator_53616.nextObject () ;
    if ((operand_53616 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_53616 ;
      do{
        macroValidPointer (operand_53616) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_53616->mBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1260))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53616->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1261))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53998 (operand_53616->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1265)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53998 = NULL ;
          while (((operand_53998 = enumerator_53998.nextObject ()))) {
            macroValidPointer (operand_53998) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53998->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1266))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53616 = enumerator_53616.nextObject () ;
        _foreach_loop_53616 = ((operand_53616 != NULL)) ;
        if (_foreach_loop_53616) {
        }
      }while (_foreach_loop_53616) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_54350 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_54350 = enumerator_54350.nextObject () ;
    if ((operand_54350 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_54350 ;
      do{
        macroValidPointer (operand_54350) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54350->mDependency.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_54350->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1280))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_54350 = enumerator_54350.nextObject () ;
        _foreach_loop_54350 = ((operand_54350 != NULL)) ;
        if (_foreach_loop_54350) {
        }
      }while (_foreach_loop_54350) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_54820 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_54820 = enumerator_54820.nextObject () ;
    if ((operand_54820 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_54820 ;
      do{
        macroValidPointer (operand_54820) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54820->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54820->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54820->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_54820->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_54820 = enumerator_54820.nextObject () ;
        _foreach_loop_54820 = ((operand_54820 != NULL)) ;
        if (_foreach_loop_54820) {
        }
      }while (_foreach_loop_54820) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55371 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1300)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55371 = enumerator_55371.nextObject () ;
    if ((operand_55371 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_55371 ;
      do{
        macroValidPointer (operand_55371) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55371->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1303))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_55672 (operand_55371->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)), true) ;
          const GGS_stringlist::cElement * operand_55672 = NULL ;
          while (((operand_55672 = enumerator_55672.nextObject ()))) {
            macroValidPointer (operand_55672) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_55672->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_55371 = enumerator_55371.nextObject () ;
        _foreach_loop_55371 = ((operand_55371 != NULL)) ;
        if (_foreach_loop_55371) {
        }
      }while (_foreach_loop_55371) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55975 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1315)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55975 = enumerator_55975.nextObject () ;
    if ((operand_55975 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_55975 ;
      do{
        macroValidPointer (operand_55975) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55975->mBuildConfig.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1318))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55975->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1322))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_55975 = enumerator_55975.nextObject () ;
        _foreach_loop_55975 = ((operand_55975 != NULL)) ;
        if (_foreach_loop_55975) {
        }
      }while (_foreach_loop_55975) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_defaultProjectConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1347)), var_cas_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1345)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_defaultProjectConfiguration) ;
  ::routine_enter_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_ioXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) COMMA_SOURCE_FILE_AT_LINE (1354)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1361)), GGS_string (""), GGS_string (""), var_cas_ioXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1361)) COMMA_SOURCE_FILE_AT_LINE (1361)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1369)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1366)) ;
  const GGS_bool cond_59054 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1373))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_59054.isBuiltAndTrue ()) {
    if (var_cas_in_xcodeproj_filePath.isBuilt ()) {
      var_cas_in_xcodeproj_filePath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)) ;
    }
    GGS_bool var_cas_written ;
    if (var_cas_fileNewContents.isBuilt ()) {
      var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1378)) ;
    }
    const GGS_string var_cas_pbxprojFilePath = (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")) ;
    const GGS_bool cond_59043 = (var_cas_written).operator_or ((var_cas_pbxprojFilePath.reader_fileExists ()).operator_not ()) ;
    if (cond_59043.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58685_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_pbxprojFilePath, automatic_var_58685_0 COMMA_SOURCE_FILE_AT_LINE (1381)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58904 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58904 = NULL ;
        while (((operand_58904 = enumerator_58904.nextObject ()))) {
          macroValidPointer (operand_58904) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58904->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1386)) ;
        }
      }
    }
  }
