...
//                    september 22th, 2012, at 22h39'12"                     *
//                                                                           *
//---------------------------------------------------------------------------*
                  ...
                  if (kBoolTrue == test_8) {
                    ...
                    if (kBoolTrue == test_9) {
                      ...
                      if (kBoolTrue == test_10) {
                        ...
                        //-------- @ifInstructionForGeneration
                        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                        if (kBoolTrue == test_11) {
                          { //-------- @routineCallInstructionForGeneration
                          routine_enter_5F_xib_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("."), constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (754)) ;
                          } //-------- @routineCallInstructionForGeneration
                        }else if (kBoolFalse == test_11) {
                          //-------- @errorInstructionForGeneration
                          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("cannot enter '").operator_concat (constinArgument_inFileName COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string ("' file : unknown extension") COMMA_SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)) ;
                        }
                      }
                    }
                  }
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  cEnumerator_stringlist enumerator_33408 (constinArgument_inFileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33408.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_33408.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (768)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_33408.gotoNextObject () ;
  }
}
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_xibFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_xibFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (781)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (782)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (783)).operator_concat (constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (783)) COMMA_SOURCE_FILE_AT_LINE (780)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_xib_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (786)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (787)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (788)).reader_string (SOURCE_FILE_AT_LINE (788)).reader_md_35_ (SOURCE_FILE_AT_LINE (788)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (788)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (789)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (792)), inCompiler COMMA_SOURCE_FILE_AT_LINE (792)), constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (790)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (795)) ;
}
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                       ...
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (807)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (808)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (806)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_plist_5F_string_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (812)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (813)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (814)).reader_string (SOURCE_FILE_AT_LINE (814)).reader_md_35_ (SOURCE_FILE_AT_LINE (814)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (814)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (815)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (818)), inCompiler COMMA_SOURCE_FILE_AT_LINE (818)), constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (816)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (821)) ;
}
...
void routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (831)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
  //-------- @methodCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (833)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (833)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (834)), var_ref COMMA_SOURCE_FILE_AT_LINE (834)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (836)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (837)) ;
}
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_36578 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36578.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_36578.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (848)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_37008 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37008.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37008.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (864)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (866)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (866)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (867)), var_ref COMMA_SOURCE_FILE_AT_LINE (867)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (868)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (869)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (870)) ;
    enumerator_37008.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_37746 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37746.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37746.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (882)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (884)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (884)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (885)), var_ref COMMA_SOURCE_FILE_AT_LINE (885)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (886)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (887)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (888)) ;
    enumerator_37746.gotoNextObject () ;
  }
}
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (905)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (905)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (907)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (910)), inCompiler COMMA_SOURCE_FILE_AT_LINE (910)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (910)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (913)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (912)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (917)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_listWithValue (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (918)), inCompiler COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (918)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (920)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (922)), GALGAS_string ("Frameworks"), constinArgument_inFrameworkKeyList COMMA_SOURCE_FILE_AT_LINE (921)) ;
    //-------- @incrementInstructionForGeneration
    ...
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (927)) ;
    //-------- @plusEqualnstructionForGeneration
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (928)), inCompiler COMMA_SOURCE_FILE_AT_LINE (928)) COMMA_SOURCE_FILE_AT_LINE (928)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (931)) ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (933)) ;
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (934)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (934)) COMMA_SOURCE_FILE_AT_LINE (934)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (936)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (936)) COMMA_SOURCE_FILE_AT_LINE (936)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (938)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (939)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (939)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (937)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (943)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (944)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (945)).reader_string (SOURCE_FILE_AT_LINE (945)).reader_md_35_ (SOURCE_FILE_AT_LINE (945)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (945)) ;
  //-------- @incrementInstructionForGeneration
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  outArgument_outTargetKey.drop () ; // Release 'out' argument
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (974)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_Application var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_Application::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (976)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (976)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (977)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (978)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (979)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (981)), inCompiler COMMA_SOURCE_FILE_AT_LINE (981)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (981)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXResourcesBuildPhase var_resourcesBuildPhase = GALGAS_Xcode_5F_PBXResourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (984)), GALGAS_string ("Resources"), constinArgument_inResourcesToCompileList COMMA_SOURCE_FILE_AT_LINE (983)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXResourcesBuildPhase_5F_list.addAssign_operation (var_resourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (989)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_resourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (990)), inCompiler COMMA_SOURCE_FILE_AT_LINE (990)) COMMA_SOURCE_FILE_AT_LINE (990)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (993)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (992)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (998)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (999)), inCompiler COMMA_SOURCE_FILE_AT_LINE (999)) COMMA_SOURCE_FILE_AT_LINE (999)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1002)), GALGAS_string ("Frameworks"), constinArgument_inFrameworksToCompileList COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1008)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1008)) COMMA_SOURCE_FILE_AT_LINE (1008)) ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1011)) ;
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (1012)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("INFOPLIST_FILE = \"").operator_concat (constinArgument_inInfoPListFile COMMA_SOURCE_FILE_AT_LINE (1015)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1015)) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = NO;") COMMA_SOURCE_FILE_AT_LINE (1017)) ;
  //-------- @plusEqualnstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (1019)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1019)) COMMA_SOURCE_FILE_AT_LINE (1019)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_targetDependencyKeyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1021)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_44149 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44149.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1023)), enumerator_44149.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1023)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1024)) ;
    //-------- @plusEqualnstructionForGeneration
    var_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_d.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1025)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1025)) COMMA_SOURCE_FILE_AT_LINE (1025)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mDependencyList.addAssign_operation (var_d COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    enumerator_44149.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1030)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1031)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1031)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (1036)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1037)).reader_string (SOURCE_FILE_AT_LINE (1037)).reader_md_35_ (SOURCE_FILE_AT_LINE (1037)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1037)) ;
  //-------- @incrementInstructionForGeneration
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_45652 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45652.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_45652.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1062)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_45652.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outProjectDefaultSettings = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1064)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ALWAYS_SEARCH_USER_PATHS = NO;") COMMA_SOURCE_FILE_AT_LINE (1065)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ARCHS = \"$(ARCHS_STANDARD_64_BIT)\";") COMMA_SOURCE_FILE_AT_LINE (1066)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inUsesARC.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_ENABLE_OBJC_ARC = YES;") COMMA_SOURCE_FILE_AT_LINE (1068)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;") COMMA_SOURCE_FILE_AT_LINE (1070)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;") COMMA_SOURCE_FILE_AT_LINE (1072)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1073)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;") COMMA_SOURCE_FILE_AT_LINE (1074)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1075)) ;
  //-------- @plusEqualnstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1083)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;") COMMA_SOURCE_FILE_AT_LINE (1084)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INHIBIT_ALL_WARNINGS = NO;") COMMA_SOURCE_FILE_AT_LINE (1085)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;") COMMA_SOURCE_FILE_AT_LINE (1086)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_MISSING_PARENTHESES = YES;") COMMA_SOURCE_FILE_AT_LINE (1087)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;") COMMA_SOURCE_FILE_AT_LINE (1088)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PEDANTIC = NO;") COMMA_SOURCE_FILE_AT_LINE (1089)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SHADOW = NO;") COMMA_SOURCE_FILE_AT_LINE (1090)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SIGN_COMPARE = YES;") COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;") COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNINITIALIZED_AUTOS = YES;") COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNKNOWN_PRAGMAS = YES;") COMMA_SOURCE_FILE_AT_LINE (1094)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_FUNCTION = YES;") COMMA_SOURCE_FILE_AT_LINE (1095)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_LABEL = YES;") COMMA_SOURCE_FILE_AT_LINE (1096)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = YES;") COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VALUE = YES;") COMMA_SOURCE_FILE_AT_LINE (1098)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VARIABLE = YES;") COMMA_SOURCE_FILE_AT_LINE (1099)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("HEADER_SEARCH_PATHS = (\n").operator_concat (var_pathString COMMA_SOURCE_FILE_AT_LINE (1100)).operator_concat (GALGAS_string ("\t\t\t\t);") COMMA_SOURCE_FILE_AT_LINE (1100)) COMMA_SOURCE_FILE_AT_LINE (1100)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("SDKROOT = ").operator_concat (constinArgument_inSDK COMMA_SOURCE_FILE_AT_LINE (1101)).operator_concat (GALGAS_string (" ;") COMMA_SOURCE_FILE_AT_LINE (1101)) COMMA_SOURCE_FILE_AT_LINE (1101)) ;
}
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1113)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1113)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n") COMMA_SOURCE_FILE_AT_LINE (1116)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1117)).operator_concat (GALGAS_string ("\tclasses = {\n") COMMA_SOURCE_FILE_AT_LINE (1118)).operator_concat (GALGAS_string ("\t};\n") COMMA_SOURCE_FILE_AT_LINE (1119)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n") COMMA_SOURCE_FILE_AT_LINE (1120)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1121)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_48902 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1123)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_48902.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1124)) ;
    while (enumerator_48902.hasCurrentObject () && bool_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_48902.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1125)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_48902.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_49170 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1129)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_1 = true ;
  if (enumerator_49170.hasCurrentObject () && bool_1) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1130)) ;
    while (enumerator_49170.hasCurrentObject () && bool_1) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_49170.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1131)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_49170.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_49472 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1135)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_2 = true ;
  if (enumerator_49472.hasCurrentObject () && bool_2) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_49472.hasCurrentObject () && bool_2) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_49472.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_49472.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_49802 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1142)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49802.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_49802.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1143)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1144)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1145)) COMMA_SOURCE_FILE_AT_LINE (1145)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1145)) COMMA_SOURCE_FILE_AT_LINE (1145)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1148)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1149)) COMMA_SOURCE_FILE_AT_LINE (1147)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_XcodeObjectReferenceList enumerator_50122 (enumerator_49802.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1150)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50122.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_50122.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1151)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1151)).operator_concat (enumerator_50122.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1151)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1151)) COMMA_SOURCE_FILE_AT_LINE (1151)) ;
      enumerator_50122.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1153)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1154)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1155)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1155)).reader_length (SOURCE_FILE_AT_LINE (1155)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1156)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_49802.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1158)) COMMA_SOURCE_FILE_AT_LINE (1158)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1158)) COMMA_SOURCE_FILE_AT_LINE (1158)) ;
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_49802.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1161)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_49802.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1162)) COMMA_SOURCE_FILE_AT_LINE (1162)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1162)) COMMA_SOURCE_FILE_AT_LINE (1162)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1165)) COMMA_SOURCE_FILE_AT_LINE (1164)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_50897 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1169)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_7 = true ;
  if (enumerator_50897.hasCurrentObject () && bool_7) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1170)) ;
    while (enumerator_50897.hasCurrentObject () && bool_7) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_50897.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (enumerator_50897.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1173)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (function_getPBXFileReferenceKey (enumerator_50897.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1174)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (enumerator_50897.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1174)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1175)) COMMA_SOURCE_FILE_AT_LINE (1172)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_51329 (enumerator_50897.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51329.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_51329.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1177)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1177)) COMMA_SOURCE_FILE_AT_LINE (1177)) ;
        enumerator_51329.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_productExtension ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_50897.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1181)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1182)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1183)) COMMA_SOURCE_FILE_AT_LINE (1180)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_51626 (enumerator_50897.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51626.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_51626.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1185)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
        enumerator_51626.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (enumerator_50897.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (enumerator_50897.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (enumerator_50897.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1191)).operator_concat (function_getPBXFileReferenceKey (enumerator_50897.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1191)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1191)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1191)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1192)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1192)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1192)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
  ...
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1202)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1202)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1202)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1203)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1206)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1207)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52801 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1209)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_52801.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52801.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1210)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1210)).operator_concat (enumerator_52801.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1210)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1210)) COMMA_SOURCE_FILE_AT_LINE (1210)) ;
    enumerator_52801.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1213)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1214)) COMMA_SOURCE_FILE_AT_LINE (1212)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_53090 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1216)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_8 = true ;
  if (enumerator_53090.hasCurrentObject () && bool_8) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_53090.hasCurrentObject () && bool_8) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_53090.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1219)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (enumerator_53090.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1221)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1222)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1223)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_53466 (enumerator_53090.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1224)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_53466.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_53466.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1225)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1225)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1225)) ;
        enumerator_53466.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1228)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1229)) COMMA_SOURCE_FILE_AT_LINE (1227)) ;
      enumerator_53090.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXResourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1230)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_53875 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1233)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_9 = true ;
  if (enumerator_53875.hasCurrentObject () && bool_9) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1234)) ;
    while (enumerator_53875.hasCurrentObject () && bool_9) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_53875.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1236)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1236)) COMMA_SOURCE_FILE_AT_LINE (1236)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1237)).operator_concat (enumerator_53875.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1237)) COMMA_SOURCE_FILE_AT_LINE (1237)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1237)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1238)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1239)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1236)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_54247 (enumerator_53875.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1241)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54247.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_54247.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1242)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1242)) ;
        enumerator_54247.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1246)) COMMA_SOURCE_FILE_AT_LINE (1244)) ;
      enumerator_53875.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1247)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_54642 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1250)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_10 = true ;
  if (enumerator_54642.hasCurrentObject () && bool_10) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1251)) ;
    while (enumerator_54642.hasCurrentObject () && bool_10) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_54642.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1253)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1253)) COMMA_SOURCE_FILE_AT_LINE (1253)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1254)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (enumerator_54642.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1256)) COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1257)) COMMA_SOURCE_FILE_AT_LINE (1253)) ;
      enumerator_54642.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1258)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_55137 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1261)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_11 = true ;
  if (enumerator_55137.hasCurrentObject () && bool_11) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1262)) ;
    while (enumerator_55137.hasCurrentObject () && bool_11) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_55137.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1265)).operator_concat (enumerator_55137.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1265)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1265)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (enumerator_55137.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (enumerator_55137.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1271)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1272)) COMMA_SOURCE_FILE_AT_LINE (1264)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_55690 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1276)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_12 = true ;
  if (enumerator_55690.hasCurrentObject () && bool_12) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    while (enumerator_55690.hasCurrentObject () && bool_12) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55690.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1279)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1281)) COMMA_SOURCE_FILE_AT_LINE (1279)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_55984 (enumerator_55690.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1282)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_55984.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_55984.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1283)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1283)) COMMA_SOURCE_FILE_AT_LINE (1283)) ;
        enumerator_55984.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1286)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1287)) COMMA_SOURCE_FILE_AT_LINE (1285)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_56320 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1291)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_13 = true ;
  if (enumerator_56320.hasCurrentObject () && bool_13) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1292)) ;
    while (enumerator_56320.hasCurrentObject () && bool_13) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56320.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1294)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1294)) COMMA_SOURCE_FILE_AT_LINE (1294)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1294)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (function_getPBXFileReferenceKey (enumerator_56320.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1298)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1298)) COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1301)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1302)) COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  ...
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1307)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1307)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1307)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1308)) COMMA_SOURCE_FILE_AT_LINE (1306)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_projectName = constinArgument_in_5F_xcodeproj_5F_filePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (1319)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (1319)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1322)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1323)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1323)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1321)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1327)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_defaultProjectConfiguration COMMA_SOURCE_FILE_AT_LINE (1328)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enter_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("Products"), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mProductGroupChildrenList (SOURCE_FILE_AT_LINE (1334)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1330)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXGroup var_mainGroup = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1337)), GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mMainGroupChildrenList (SOURCE_FILE_AT_LINE (1337)) COMMA_SOURCE_FILE_AT_LINE (1337)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_mainGroup COMMA_SOURCE_FILE_AT_LINE (1339)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_string var_fileNewContents ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildXcodeProjectString (ioArgument_ioXcodeProjectDescription, var_projectName, function_getPBXFileReferenceKey (var_mainGroup.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1345)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)), function_getPBXFileReferenceKey (var_defaultProjectConfiguration.reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1346)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1346)), var_fileNewContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (1342)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1349)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_in_5F_xcodeproj_5F_filePath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_written ;
    //-------- @methodCallInstructionForGeneration
    var_fileNewContents.method_writeToFileWhenDifferentContents (constinArgument_inReferenceFilePath, var_written, inCompiler COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_pbxprojFilePath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/project.pbxproj") COMMA_SOURCE_FILE_AT_LINE (1355)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE_AT_LINE (1356)).operator_not (SOURCE_FILE_AT_LINE (1356)) COMMA_SOURCE_FILE_AT_LINE (1356)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_59064_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_59064_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1357)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_pbxuser_5F_files = constinArgument_in_5F_xcodeproj_5F_filePath.reader_regularFilesWithExtensions (GALGAS_bool (false), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("pbxuser") COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_59287 (var_pbxuser_5F_files, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_59287.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (enumerator_59287.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1361)) ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1362)) ;
        } //-------- @routineCallInstructionForGeneration
