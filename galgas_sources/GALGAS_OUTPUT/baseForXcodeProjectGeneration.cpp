...
void routine_buildXcodeProjectString (C_Compiler & _inLexique,
    ...
    "\n")) ;
  {
    ...
    if ((operand_39775 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXBuildFile  _temp_39910 = operand_39775->mFile ;
        if (_temp_39910._isBuilt ()) {
          _temp_39910 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (956)) ;
        }
        operand_39775 = enumerator_39775.nextObject () ;
        _foreach_loop_39775 = ((operand_39775 != NULL)) ;
  ...
  }
  {
    ...
    if ((operand_40043 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXFileReference_abstract  _temp_40191 = operand_40043->mInfo.mFileReference ;
        if (_temp_40191._isBuilt ()) {
          _temp_40191 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (962)) ;
        }
        operand_40043 = enumerator_40043.nextObject () ;
        _foreach_loop_40043 = ((operand_40043 != NULL)) ;
  ...
  }
  {
    ...
    if ((operand_40333 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXFrameworksBuildPhase  _temp_40497 = operand_40333->mBuildPhase ;
        if (_temp_40497._isBuilt ()) {
          _temp_40497 (HERE)->method_buildXcodeProject (_inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (968)) ;
        }
        operand_40333 = enumerator_40333.nextObject () ;
        _foreach_loop_40333 = ((operand_40333 != NULL)) ;
  ...
  var_cas_outString.appendCstring ("/* Begin PBXGroup section */\n") ;
  {
    ...
    while (((operand_40681 = enumerator_40681.nextObject ()))) {
      ...
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_40989 (operand_40681->mGroup.reader_mChildrenGroupList (_inLexique COMMA_SOURCE_FILE_AT_LINE (981)), true) ;
    ...
    "\n") ;
  {
    ...
    if ((operand_41746 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_productFileReference  _temp_42332 = operand_41746->mProduct ;
        ...
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_42500 (operand_41746->mDependencyKeyList, true) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_43615 (var_cas_inXcodeProjectDescription.reader_mTargetList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1040)), true) ;
    ...
    "\n") ;
  {
    ...
    if ((operand_43881 != NULL)) {
      ...
      do{
        ...
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_44271 (operand_43881->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)), true) ;
        ...
        _foreach_loop_43881 = ((operand_43881 != NULL)) ;
  ...
  }
  {
    ...
    if ((operand_44626 != NULL)) {
      ...
      do{
        ...
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_45008 (operand_44626->mBuildPhase.reader_mFileReferenceList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1072)), true) ;
        ...
        _foreach_loop_44626 = ((operand_44626 != NULL)) ;
  ...
  GGS_string var_cas_mName ;
  {
    ...
    if ((operand_45908 != NULL)) {
      ...
      do{
        ...
        _foreach_loop_45908 = ((operand_45908 != NULL)) ;
  ...
  }
  {
    ...
    if ((operand_46459 != NULL)) {
      ...
      do{
        ...
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46760 (operand_46459->mBuildConfig.reader_mSettings (_inLexique COMMA_SOURCE_FILE_AT_LINE (1116)), true) ;
        ...
        _foreach_loop_46459 = ((operand_46459 != NULL)) ;
  ...
  }
  {
    ...
    if ((operand_47063 != NULL)) {
      ...
      do{
        ...
        "\t\t};\n") ;
        operand_47063 = enumerator_47063.nextObject () ;
        _foreach_loop_47063 = ((operand_47063 != NULL)) ;
...
void routine_generateXCodeFile (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    const GGS_string _temp_49065 = var_cas_in_xcodeproj_filePath ;
    if (_temp_49065._isBuilt ()) {
      _temp_49065 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1177)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string _temp_49187 = var_cas_fileNewContents ;
    if (_temp_49187._isBuilt ()) {
      _temp_49187 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/project.pbxproj")), var_cas_written COMMA_SOURCE_FILE_AT_LINE (1180)) ;
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_49480 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_49480 = NULL ;
        while (((operand_49480 = enumerator_49480.nextObject ()))) {
          macroValidPointer (operand_49480) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_49480->mValue) ;
