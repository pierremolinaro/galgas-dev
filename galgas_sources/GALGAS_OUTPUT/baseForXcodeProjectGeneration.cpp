...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_DEPRECATED_FUNCTIONS = NO;") COMMA_SOURCE_FILE_AT_LINE (1119)) ;
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1156)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE_AT_LINE (1156)) ;
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50966 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1166)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_50966.hasCurrentObject () && bool_0) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1167)) ;
    while (enumerator_50966.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50966.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1168)) ;
      enumerator_50966.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXBuildFile section */\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (1169)) ;
  }
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51234 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1172)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51234.hasCurrentObject () && bool_1) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    while (enumerator_51234.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51234.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
      enumerator_51234.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1175)) ;
  }
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51536 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1178)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51536.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51536.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51536.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1180)) ;
      enumerator_51536.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51872 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1185)), kEnumeration_up) ;
  while (enumerator_51872.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51872.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1186)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)) COMMA_SOURCE_FILE_AT_LINE (1186)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1187)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1188)) COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1188)) COMMA_SOURCE_FILE_AT_LINE (1188)) ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1190)) ;
    cEnumerator_XcodeObjectReferenceList enumerator_52192 (enumerator_51872.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1193)), kEnumeration_up) ;
    while (enumerator_52192.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52192.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1194)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1194)).operator_concat (enumerator_52192.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1194)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1194)) COMMA_SOURCE_FILE_AT_LINE (1194)) ;
      enumerator_52192.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1196)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1198)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1198)).reader_length (SOURCE_FILE_AT_LINE (1198)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1199)) COMMA_SOURCE_FILE_AT_LINE (1199)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1199)) COMMA_SOURCE_FILE_AT_LINE (1199)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51872.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1201)) COMMA_SOURCE_FILE_AT_LINE (1201)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1201)) COMMA_SOURCE_FILE_AT_LINE (1201)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51872.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1204)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51872.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1205)) COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1205)) COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    }
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52961 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1212)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_52961.hasCurrentObject () && bool_7) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1213)) ;
    while (enumerator_52961.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52961.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (enumerator_52961.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (function_getPBXFileReferenceKey (enumerator_52961.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1217)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) COMMA_SOURCE_FILE_AT_LINE (1217)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1217)).operator_concat (enumerator_52961.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1217)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1217)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1217)) COMMA_SOURCE_FILE_AT_LINE (1215)) ;
      cEnumerator_stringlist enumerator_53399 (enumerator_52961.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53399.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53399.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)) ;
        enumerator_53399.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52961.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1222)) ;
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1223)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1224)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
      cEnumerator_stringlist enumerator_53696 (enumerator_52961.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53696.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53696.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1228)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1228)) COMMA_SOURCE_FILE_AT_LINE (1228)) ;
        enumerator_53696.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (enumerator_52961.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (enumerator_52961.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (enumerator_52961.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (function_getPBXFileReferenceKey (enumerator_52961.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1234)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1230)) ;
      enumerator_52961.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1238)) ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1246)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1250)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54871 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1252)), kEnumeration_up) ;
  while (enumerator_54871.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54871.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1253)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1253)).operator_concat (enumerator_54871.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1253)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1253)) COMMA_SOURCE_FILE_AT_LINE (1253)) ;
    enumerator_54871.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1256)) COMMA_SOURCE_FILE_AT_LINE (1255)) ;
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55154 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1259)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55154.hasCurrentObject () && bool_8) {
    ...
    while (enumerator_55154.hasCurrentObject () && bool_8) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55154.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1262)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (enumerator_55154.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1263)) COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1265)) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55536 (enumerator_55154.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1267)), kEnumeration_up) ;
      while (enumerator_55536.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55536.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1268)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1268)) ;
        enumerator_55536.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1271)) COMMA_SOURCE_FILE_AT_LINE (1270)) ;
      enumerator_55154.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXResourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1273)) ;
  }
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55939 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1276)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_55939.hasCurrentObject () && bool_9) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    while (enumerator_55939.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55939.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1279)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (enumerator_55939.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1280)) COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1281)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1279)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56317 (enumerator_55939.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1284)), kEnumeration_up) ;
      while (enumerator_56317.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56317.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1285)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1285)) COMMA_SOURCE_FILE_AT_LINE (1285)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1285)) COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        enumerator_56317.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1287)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1288)) COMMA_SOURCE_FILE_AT_LINE (1287)) ;
      enumerator_55939.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1290)) ;
  }
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56712 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1293)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56712.hasCurrentObject () && bool_10) {
    ...
    while (enumerator_56712.hasCurrentObject () && bool_10) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56712.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1296)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (enumerator_56712.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (enumerator_56712.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE_AT_LINE (1301)).reader_string (SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1301)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1301)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1296)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57217 (enumerator_56712.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1303)), kEnumeration_up) ;
      while (enumerator_57217.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57217.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1304)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1304)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1304)) ;
        enumerator_57217.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1306)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1307)) COMMA_SOURCE_FILE_AT_LINE (1306)) ;
      enumerator_56712.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1309)) ;
  }
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57608 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1312)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57608.hasCurrentObject () && bool_11) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1313)) ;
    while (enumerator_57608.hasCurrentObject () && bool_11) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57608.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1315)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1315)) COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1316)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (enumerator_57608.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1318)) COMMA_SOURCE_FILE_AT_LINE (1318)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1318)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1318)) COMMA_SOURCE_FILE_AT_LINE (1315)) ;
      enumerator_57608.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  }
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58103 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1323)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58103.hasCurrentObject () && bool_12) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1324)) ;
    while (enumerator_58103.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58103.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (enumerator_58103.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (enumerator_58103.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (enumerator_58103.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1326)) ;
      enumerator_58103.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1335)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58656 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1338)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58656.hasCurrentObject () && bool_13) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1339)) ;
    while (enumerator_58656.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58656.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1341)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1341)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1341)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1341)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1341)) ;
      cEnumerator_stringlist enumerator_58956 (enumerator_58656.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1344)), kEnumeration_up) ;
      while (enumerator_58956.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58956.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1345)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
        enumerator_58956.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1347)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1347)) ;
      enumerator_58656.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCBuildConfiguration section */\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (1350)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59286 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1353)), kEnumeration_up) ;
  const bool bool_14 = true ;
  if (enumerator_59286.hasCurrentObject () && bool_14) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    while (enumerator_59286.hasCurrentObject () && bool_14) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59286.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1356)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1356)) COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1358)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (function_getPBXFileReferenceKey (enumerator_59286.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1360)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1360)) COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1363)) COMMA_SOURCE_FILE_AT_LINE (1356)) ;
  ...
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1369)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1369)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1369)) COMMA_SOURCE_FILE_AT_LINE (1368)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1384)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1385)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1385)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1383)) ;
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1411)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_62038_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_62038_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      ...
      cEnumerator_stringlist enumerator_62259 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62259.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1423)).operator_concat (enumerator_62259.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1423)) ;
        {
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1424)) ;
        }
        enumerator_62259.gotoNextObject () ;
      }
    }
  }
}
