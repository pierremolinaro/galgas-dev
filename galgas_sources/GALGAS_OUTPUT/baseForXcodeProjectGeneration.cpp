...
//                    november 13th, 2008, at 20h23'32"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generateXCodeFile (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_string _temp_42756 = var_cas_fileNewContents ;
    if (_temp_42756._isBuilt ()) {
      _temp_42756 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/project.pbxproj")), var_cas_written COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files ;
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      {
        GGS_stringlist::cEnumerator enumerator_43049 (var_cas_pbxuser_files, true) ;
        ...
        while (((operand_43049 = enumerator_43049.nextObject ()))) {
          ...
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_43049->mValue) ;
          GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1074)) ;
        }
      }
    }
  }
