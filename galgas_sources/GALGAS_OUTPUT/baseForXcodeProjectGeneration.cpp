...
void routine_enter_xib_in_group (C_Compiler & inLexique,
  ...
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), var_cas_in_xib_fileName) ;
...
void routine_enter_plist_strings_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_plistStringFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistStringFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (775)), var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_plist_string_fileName) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (779)) ;
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (781)) ;
  GGS_string var_cas_PBXVariantGroupKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (782)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (782)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (783)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, var_cas_ref.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), var_cas_in_plist_string_fileName) ;
...
void routine_enter_file_for_sources_build_phase (C_Compiler & inLexique,
  ...
  const GGS_Xcode_PBXFileReference_map  temp_33342 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (801)) ;
  if (temp_33342.isBuilt ()) {
    temp_33342 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (801)) ;
  }
  GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (802)), var_cas_ref COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (803)) ;
...
void routine_enter_file_list_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_33889 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_33889 = NULL ;
    while (((operand_33889 = enumerator_33889.nextObject ()))) {
      macroValidPointer (operand_33889) ;
      ::routine_enter_file_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  operand_33889->mValue,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (816)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34319 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34319 = NULL ;
    while (((operand_34319 = enumerator_34319.nextObject ()))) {
      macroValidPointer (operand_34319) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34319->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_34465 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (834)) ;
      if (temp_34465.isBuilt ()) {
        temp_34465 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (834)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (836)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_35055 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_35055 = NULL ;
    while (((operand_35055 = enumerator_35055.nextObject ()))) {
      macroValidPointer (operand_35055) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_35055->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_35201 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (852)) ;
      if (temp_35201.isBuilt ()) {
        temp_35201 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (852)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), var_cas_ref COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (854)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_add_tool_target (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_CompiledMachOExecutable  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_CompiledMachOExecutable ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (929)), var_cas_inProductFileName COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (930)) ;
  ...
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (932)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (934)), var_cas_inTargetName) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (937)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (941)) ;
  GGS_stringlist  var_cas_buildPhases = GGS_stringlist ::constructor_listWithValue (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
  const GGS_bool cond_39487 = (var_cas_inFrameworkKeyList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_39487.isBuiltAndTrue ()) {
    GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (946)), GGS_string ("Frameworks"), var_cas_inFrameworkKeyList COMMA_HERE) ;
    var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (950)) ;
    var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
    var_cas_buildPhases.addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (952))) ;
  }
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  const GGS_bool cond_39779 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_39779.isBuiltAndTrue ()) {
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (962)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (963)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (963)), var_cas_inTargetSettings COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (966)) ;
  ...
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (969)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (969)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (970)) ;
...
void routine_add_app_target (C_Compiler & inLexique,
  ...
  GGS_Xcode_PBXFileReference_Application  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_Application ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1000)), var_cas_inProductFileName COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  GGS_lstring  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (var_cas_toolFileReference.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1005)), var_cas_inTargetName) ;
  GGS_Xcode_PBXResourcesBuildPhase  var_cas_resourcesBuildPhase = GGS_Xcode_PBXResourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1008)), GGS_string ("Resources"), var_cas_inResourcesToCompileList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  var_cas_ioXcodeProjectDescription.mPBXResourcesBuildPhase_list.addAssign_operation (var_cas_resourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (var_cas_resourcesBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1014))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1017)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (var_cas_compileSourcesBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1023))) ;
  GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1026)), GGS_string ("Frameworks"), var_cas_inFrameworksToCompileList COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1030)) ;
  var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (var_cas_frameworksBuildPhase.reader_PBXFrameworksBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1032))) ;
  const GGS_bool cond_43171 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43171.isBuiltAndTrue ()) {
    var_cas_inTargetSettings.addAssign_operation (GGS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings.addAssign_operation (((GGS_string ("GCC_PREFIX_HEADER = \"")).operator_concat (var_cas_inPrecompiledHeaderPath)).operator_concat (GGS_string ("\";"))) ;
  }
  const GGS_bool cond_43290 = (var_cas_inInfoPListFile).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43290.isBuiltAndTrue ()) {
  ...
  {
    GGS_stringlist::cEnumerator enumerator_43605 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_43605 = NULL ;
    while (((operand_43605 = enumerator_43605.nextObject ()))) {
      macroValidPointer (operand_43605) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1047)), operand_43605->mValue COMMA_HERE) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)) ;
      var_cas_targetDependencyKeyList.addAssign_operation (var_cas_d.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1049))) ;
      var_cas_ioXcodeProjectDescription.mDependencyList.addAssign_operation (var_cas_d) ;
    }
  }
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1054)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1055)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1055)), var_cas_inTargetSettings COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1062)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_45042 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_45042 = NULL ;
    while (((operand_45042 = enumerator_45042.nextObject ()))) {
      macroValidPointer (operand_45042) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_45042->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48507 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_48507 = enumerator_48507.nextObject () ;
    if ((operand_48507 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_48507 ;
      do{
        macroValidPointer (operand_48507) ;
        const GGS_Xcode_PBXBuildFile  temp_48642 = operand_48507->mFile ;
        if (temp_48642.isBuilt ()) {
          temp_48642 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1147)) ;
        }
        operand_48507 = enumerator_48507.nextObject () ;
        _foreach_loop_48507 = ((operand_48507 != NULL)) ;
        if (_foreach_loop_48507) {
        }
      }while (_foreach_loop_48507) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_48775 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1151)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_48775 = enumerator_48775.nextObject () ;
    if ((operand_48775 != NULL)) {
      ...
      do{
        ...
        const GGS_Xcode_PBXFileReference_abstract  temp_48923 = operand_48775->mInfo.mFileReference ;
        if (temp_48923.isBuilt ()) {
          temp_48923 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1153)) ;
        }
  ...
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49065 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1157)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49065 = enumerator_49065.nextObject () ;
    if ((operand_49065 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49065 ;
      do{
        macroValidPointer (operand_49065) ;
        const GGS_Xcode_PBXFrameworksBuildPhase  temp_49229 = operand_49065->mBuildPhase ;
        if (temp_49229.isBuilt ()) {
          temp_49229 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1159)) ;
        }
        operand_49065 = enumerator_49065.nextObject () ;
        _foreach_loop_49065 = ((operand_49065 != NULL)) ;
        if (_foreach_loop_49065) {
        }
      }while (_foreach_loop_49065) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_49413 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_49413 = NULL ;
    while (((operand_49413 = enumerator_49413.nextObject ()))) {
      macroValidPointer (operand_49413) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (operand_49413->mGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1165))) ;
      const GGS_bool cond_49613 = (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_49613.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1167))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_49721 (operand_49413->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1172)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_49721 = NULL ;
        while (((operand_49721 = enumerator_49721.nextObject ()))) {
          macroValidPointer (operand_49721) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_49721->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_49721->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_50172 = (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1176))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50172.isBuiltAndTrue ()) {
        const GGS_bool cond_50080 = (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1177)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50080.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1178))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50080.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_49413->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1180))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_50294 = (operand_49413->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1183))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50294.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_49413->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1184))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_50478 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1191)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_50478 = enumerator_50478.nextObject () ;
    if ((operand_50478 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_50478 ;
      do{
        macroValidPointer (operand_50478) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50478->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50478->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (operand_50478->mTargetConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1196))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_50478->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_50935 (operand_50478->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_50935 = NULL ;
          while (((operand_50935 = enumerator_50935.nextObject ()))) {
            macroValidPointer (operand_50935) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_50935->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        const GGS_Xcode_productFileReference  temp_51064 = operand_50478->mProduct ;
        if (temp_51064.isBuilt ()) {
          temp_51064 (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1201)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51232 (operand_50478->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_51232 = NULL ;
          while (((operand_51232 = enumerator_51232.nextObject ()))) {
            macroValidPointer (operand_51232) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51232->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50478->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_50478->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (operand_50478->mProduct.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1213))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_50478 = enumerator_50478.nextObject () ;
        _foreach_loop_50478 = ((operand_50478 != NULL)) ;
        if (_foreach_loop_50478) {
        }
      }while (_foreach_loop_50478) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_52347 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1231)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_52347 = NULL ;
    while (((operand_52347 = enumerator_52347.nextObject ()))) {
      macroValidPointer (operand_52347) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_52347->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_52347->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_52613 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1238)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_52613 = enumerator_52613.nextObject () ;
    if ((operand_52613 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_52613 ;
      do{
        macroValidPointer (operand_52613) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_52613->mBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1241))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_52613->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1242))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53003 (operand_52613->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1246)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53003 = NULL ;
          while (((operand_53003 = enumerator_53003.nextObject ()))) {
            macroValidPointer (operand_53003) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53003->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1247))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_52613 = enumerator_52613.nextObject () ;
        _foreach_loop_52613 = ((operand_52613 != NULL)) ;
        if (_foreach_loop_52613) {
        }
      }while (_foreach_loop_52613) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_53358 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1255)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_53358 = enumerator_53358.nextObject () ;
    if ((operand_53358 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_53358 ;
      do{
        macroValidPointer (operand_53358) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_53358->mBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1258))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53358->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1259))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53740 (operand_53358->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1263)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53740 = NULL ;
          while (((operand_53740 = enumerator_53740.nextObject ()))) {
            macroValidPointer (operand_53740) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53740->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53358 = enumerator_53358.nextObject () ;
        _foreach_loop_53358 = ((operand_53358 != NULL)) ;
        if (_foreach_loop_53358) {
        }
      }while (_foreach_loop_53358) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_54092 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_54092 = enumerator_54092.nextObject () ;
    if ((operand_54092 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_54092 ;
      do{
        macroValidPointer (operand_54092) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54092->mDependency.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1275))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_54092->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1278))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_54092 = enumerator_54092.nextObject () ;
        _foreach_loop_54092 = ((operand_54092 != NULL)) ;
        if (_foreach_loop_54092) {
        }
      }while (_foreach_loop_54092) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_54562 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1283)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_54562 = enumerator_54562.nextObject () ;
    if ((operand_54562 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_54562 ;
      do{
        macroValidPointer (operand_54562) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54562->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54562->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54562->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_54562->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_54562 = enumerator_54562.nextObject () ;
        _foreach_loop_54562 = ((operand_54562 != NULL)) ;
        if (_foreach_loop_54562) {
        }
      }while (_foreach_loop_54562) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55113 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1298)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55113 = enumerator_55113.nextObject () ;
    if ((operand_55113 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_55113 ;
      do{
        macroValidPointer (operand_55113) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55113->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1301))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_55414 (operand_55113->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1304)), true) ;
          const GGS_stringlist::cElement * operand_55414 = NULL ;
          while (((operand_55414 = enumerator_55414.nextObject ()))) {
            macroValidPointer (operand_55414) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_55414->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_55113 = enumerator_55113.nextObject () ;
        _foreach_loop_55113 = ((operand_55113 != NULL)) ;
        if (_foreach_loop_55113) {
        }
      }while (_foreach_loop_55113) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55717 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1313)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55717 = enumerator_55717.nextObject () ;
    if ((operand_55717 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_55717 ;
      do{
        macroValidPointer (operand_55717) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55717->mBuildConfig.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1316))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55717->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1320))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_55717 = enumerator_55717.nextObject () ;
        _foreach_loop_55717 = ((operand_55717 != NULL)) ;
        if (_foreach_loop_55717) {
        }
      }while (_foreach_loop_55717) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_defaultProjectConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1344)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1345)), var_cas_inProjectDefaultSettings COMMA_HERE) ;
  ...
  ::routine_enter_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_ioXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)) COMMA_SOURCE_FILE_AT_LINE (1352)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)), GGS_string (""), GGS_string (""), var_cas_ioXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_HERE) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1368)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1364)) ;
  const GGS_bool cond_58775 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_58775.isBuiltAndTrue ()) {
    const GGS_string temp_58053 = var_cas_in_xcodeproj_filePath ;
    if (temp_58053.isBuilt ()) {
      temp_58053 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string temp_58175 = var_cas_fileNewContents ;
    if (temp_58175.isBuilt ()) {
      temp_58175 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1376)) ;
    }
    const GGS_bool cond_58383 = (var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists ()).operator_not ()) ;
    if (cond_58383.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58373_0 ;
      const GGS_string temp_58325 = var_cas_fileNewContents ;
      if (temp_58325.isBuilt ()) {
        temp_58325 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_58373_0 COMMA_SOURCE_FILE_AT_LINE (1378)) ;
      }
    }
    const GGS_bool cond_58764 = var_cas_written ;
    if (cond_58764.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58625 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58625 = NULL ;
        while (((operand_58625 = enumerator_58625.nextObject ()))) {
          macroValidPointer (operand_58625) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58625->mValue) ;
