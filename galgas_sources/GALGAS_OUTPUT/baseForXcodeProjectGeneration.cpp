...
void routine_buildXcodeProjectString (C_Compiler & _inLexique,
  ...
  var_cas_rootObjectKey = GGS_string ("project").reader_md5 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1013)).reader_rightSubString (_inLexique, GGS_uint (true, 24U) COMMA_SOURCE_FILE_AT_LINE (1013)) ;
  ...
  var_cas_outString.appendCString ("/* Begin PBXGroup section */\n") ;
  {
    ...
    while (((operand_43444 = enumerator_43444.nextObject ()))) {
      ...
      if (((operand_43444->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1054)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        if (((operand_43444->mGroup.reader_mGroupName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)).reader_componentsSeparatedByString (_inLexique, GGS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1055)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1055)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
...
void routine_generateXCodeFile (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_written).isBuiltAndTrue ()) {
      ...
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string ("pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1256)) ;
      {
