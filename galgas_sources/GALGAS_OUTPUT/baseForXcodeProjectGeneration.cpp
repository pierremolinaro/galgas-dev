...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_62229 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_62229, inCompiler COMMA_SOURCE_FILE ("baseForXcodeProjectGeneration.gSemantics", 1418)) ;
