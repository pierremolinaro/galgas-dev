...
void routine_generateXCodeFile (C_Compiler & _inLexique,
  ...
  var_cas_projectName = var_cas_in_xcodeproj_filePath.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (1221)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (1221)) ;
  ...
  ::routine_enter_group (_inLexique,  var_cas_inXcodeProjectDescription,  GGS_string (true, "Products"),  GGS_string (true, ""),  var_cas_inXcodeProjectDescription.reader_mProductGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1230)) COMMA_SOURCE_FILE_AT_LINE (1226)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup ;
  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (_inLexique, GGS_string (true, ""), GGS_string (true, ""), var_cas_inXcodeProjectDescription.reader_mMainGroupChildrenList (_inLexique COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_HERE) ;
  ...
  ::routine_buildXcodeProjectString (_inLexique,  var_cas_inXcodeProjectDescription,  var_cas_projectName,  var_cas_mainGroup.reader_PBXGroupKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1240)),  var_cas_defaultProjectConfiguration.reader_XCBuildConfigurationKey (_inLexique COMMA_SOURCE_FILE_AT_LINE (1241)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1237)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    const GGS_string _temp_51828 = var_cas_in_xcodeproj_filePath ;
    if (_temp_51828._isBuilt ()) {
      _temp_51828 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (1246)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string _temp_51950 = var_cas_fileNewContents ;
    if (_temp_51950._isBuilt ()) {
      _temp_51950 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, (var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/project.pbxproj")), var_cas_written COMMA_SOURCE_FILE_AT_LINE (1249)) ;
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      GGS_stringlist  var_cas_pbxuser_files ;
      var_cas_pbxuser_files = var_cas_in_xcodeproj_filePath.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxuser")) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
      {
        GGS_stringlist::cEnumerator enumerator_52243 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_52243 = NULL ;
        while (((operand_52243 = enumerator_52243.nextObject ()))) {
          macroValidPointer (operand_52243) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_52243->mValue) ;
          GGS_string::class_method_deleteFile (_inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1255)) ;
        }
      }
    }
  }
