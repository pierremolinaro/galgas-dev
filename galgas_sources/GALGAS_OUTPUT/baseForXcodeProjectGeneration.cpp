...
//---------------------------------------------------------------------------*
//                                                                           *
//           Implementation of function "getPBXFileReferenceKey"             *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_string function_getPBXFileReferenceKey (C_Compiler & inLexique,
                                const GGS_uint   var_cas_inSequenceNumber COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_getPBXFileReferenceKey at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_string var_cas_outResult ;
  var_cas_outResult = var_cas_inSequenceNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (35)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_getPBXFileReferenceKey\n") ;
  #endif
...
static GGS_object functionForGenericCall_getPBXFileReferenceKey (C_Compiler & inLexique,
                           const GGS_objectlist & inEffectiveParameterArray,
                           const GGS_location & inErrorLocation
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  arg_0 = GGS_uint ::castFromObject (inLexique, inEffectiveParameterArray.reader_mValueAtIndex (inLexique, GGS_uint (0) COMMA_THERE), inErrorLocation COMMA_THERE) ;
  const GGS_string result = function_getPBXFileReferenceKey (inLexique,
                            arg_0
                            COMMA_THERE) ;
...
kArgumentTypeList_getPBXFileReferenceKey [1] = {& kTypeDescriptor_GGS_uint } ;

const C_galgas_function_descriptorEX
kFunction_descriptor_getPBXFileReferenceKey ("getPBXFileReferenceKey",
                              functionForGenericCall_getPBXFileReferenceKey,
                              & kTypeDescriptor_GGS_string,
                              1,
                              kArgumentTypeList_getPBXFileReferenceKey) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
  ...
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (50))) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (65))) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (79))) ;
  var_cas_outString.appendCString (" /* ") ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (90))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (101))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (112))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (123))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (134))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (145))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (156))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (167))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (178))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (189))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (201))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (213))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mFileName.reader_lastPathComponent ()) ;
...
GGS_Xcode_PBXFileReference_map GGS_Xcode_PBXFileReference_map::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_Xcode_PBXFileReference_abstract & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_Xcode_PBXFileReference_map result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (240))) ;
  var_cas_outString.appendCString (" /* ") ;
  var_cas_outString.dotAssign_operation (mSourceFile.reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (240))) ;
  var_cas_outString.appendCString (" */ "
  "= {isa = PBXBuildFile; fileRef = ") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSourceFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (241))) ;
...
void cPtr_Xcode_PBXResourcesBuildPhase::computeOnce12653 (C_Compiler & inLexique) const {
  _mOnce12653isComputed = true ;
  PBXResourcesBuildPhaseKey.drop () ;
  PBXResourcesBuildPhaseKey = mSequenceNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}
...
GGS_string cPtr_Xcode_PBXResourcesBuildPhase::reader_PBXResourcesBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce12653isComputed) {
    computeOnce12653 (inLexique) ;
  }
...
void cPtr_Xcode_PBXFrameworksBuildPhase::computeOnce13511 (C_Compiler & inLexique) const {
  _mOnce13511isComputed = true ;
  PBXFrameworksBuildPhaseKey.drop () ;
  PBXFrameworksBuildPhaseKey = mSequenceNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (304)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}
...
GGS_string cPtr_Xcode_PBXFrameworksBuildPhase::reader_PBXFrameworksBuildPhaseKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce13511isComputed) {
    computeOnce13511 (inLexique) ;
  }
...
method_buildXcodeProject (C_Compiler & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (308))) ;
  var_cas_outString.appendCString (" /* Frameworks */ = {\n"
  "\t\t\tisa = PBXFrameworksBuildPhase;\n"
  "\t\t\tbuildActionMask = 2147483647;\n"
  "\t\t\tfiles = (\n") ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_13799 (mFileReferenceList, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_13799 = NULL ;
    while (((operand_13799 = enumerator_13799.nextObject ()))) {
      macroValidPointer (operand_13799) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_13799->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313))) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_13799->mFile.reader_mSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (314)).reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (314))) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
...
void cPtr_Xcode_PBXGroup::computeOnce14915 (C_Compiler & inLexique) const {
  _mOnce14915isComputed = true ;
  PBXGroupKey.drop () ;
  PBXGroupKey = mSequenceNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (341)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_PBXGroup::reader_PBXGroupKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce14915isComputed) {
    computeOnce14915 (inLexique) ;
  }
  return PBXGroupKey ;
}
...
_mOnce15695isComputed (false),
configurationKey (),
_mOnce15829isComputed (false),
...
void cPtr_Xcode_XCBuildConfiguration::computeOnce15695 (C_Compiler & inLexique) const {
  _mOnce15695isComputed = true ;
  configurationKey.drop () ;
  configurationKey = mSequenceNumber1.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (363)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}

//---------------------------------------------------------------------------*

void cPtr_Xcode_XCBuildConfiguration::computeOnce15829 (C_Compiler & inLexique) const {
  _mOnce15829isComputed = true ;
  XCBuildConfigurationKey.drop () ;
  XCBuildConfigurationKey = mSequenceNumber2.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (367)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}

//---------------------------------------------------------------------------*

GGS_string cPtr_Xcode_XCBuildConfiguration::reader_configurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce15695isComputed) {
    computeOnce15695 (inLexique) ;
  }
...
GGS_string cPtr_Xcode_XCBuildConfiguration::reader_XCBuildConfigurationKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce15829isComputed) {
    computeOnce15829 (inLexique) ;
  }
...
void cPtr_Xcode_targetDependencyDescription::computeOnce17324 (C_Compiler & inLexique) const {
  _mOnce17324isComputed = true ;
  PBXTargetDependencyKey.drop () ;
  PBXTargetDependencyKey = mSequenceNumber.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (405)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
}
...
GGS_string cPtr_Xcode_targetDependencyDescription::reader_PBXTargetDependencyKey (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) const {
  if (! _mOnce17324isComputed) {
    computeOnce17324 (inLexique) ;
  }
...
void routine_initXcodeProjectDescription (C_Compiler & inLexique,
                                GGS_XcodeProjectDescription & var_cas_outDescription
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_initXcodeProjectDescription at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_outDescription = GGS_XcodeProjectDescription::constructor_new (GGS_Xcode_PBXFileReference_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (453)), GGS_Xcode_PBXBuildFile_list ::constructor_emptyList (), GGS_XcodeObjectReferenceList ::constructor_emptyList (), GGS_Xcode_PBXGroup_list ::constructor_emptyList (), GGS_Xcode_PBXNativeTarget_list ::constructor_emptyList (), GGS_XcodeObjectReferenceList ::constructor_emptyList (), GGS_Xcode_XCBuildConfiguration_list ::constructor_emptyList (), GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_emptyList (), GGS_Xcode_PBXFrameworksBuildPhase_list ::constructor_emptyList (), GGS_Xcode_PBXResourcesBuildPhase_list ::constructor_emptyList (), GGS_Xcode_targetDependencyDescription_list ::constructor_emptyList (), GGS_Xcode_PBXVariantGroup_list ::constructor_emptyList (), GGS_uint (0U)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_group (C_Compiler & inLexique,
                                ...
                                const GGS_XcodeObjectReferenceList   var_cas_inGroupContentsKeyList
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_enter_group at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_Xcode_PBXGroup  var_cas_group = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), var_cas_inGroupName, var_cas_inGroupPath, var_cas_inGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (481)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (487)) ;
  var_cas_ioXcodeProjectDescription.mProjectGroupList.addAssign_operation (var_cas_group) ;
  var_cas_ioXcodeProjectDescription.mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_group.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) COMMA_SOURCE_FILE_AT_LINE (489)), var_cas_inGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_subgroup (C_Compiler & inLexique,
                                ...
                                GGS_XcodeObjectReferenceList  & var_cas_ioSuperGroupContentsKeyList
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_enter_subgroup at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_Xcode_PBXGroup  var_cas_group = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), var_cas_inSubGroupName, var_cas_inSubGroupPath, var_cas_inSubGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (505)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
  var_cas_ioXcodeProjectDescription.mProjectGroupList.addAssign_operation (var_cas_group) ;
  var_cas_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_group.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (513)) COMMA_SOURCE_FILE_AT_LINE (513)), var_cas_inSubGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_cpp_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (544)) ;
  GGS_Xcode_PBXFileReference_cppSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_cppSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (545)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (546)) ;
  ...
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (548)) COMMA_SOURCE_FILE_AT_LINE (548)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_h_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (558)) ;
  GGS_Xcode_PBXFileReference_hSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_hSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (559)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (559)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (561)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) COMMA_SOURCE_FILE_AT_LINE (562)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_pch_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (572)) ;
  GGS_Xcode_PBXFileReference_pchSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_pchSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (573)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (574)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (575)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (576)) COMMA_SOURCE_FILE_AT_LINE (576)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_m_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (586)) ;
  GGS_Xcode_PBXFileReference_mSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_mSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (587)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (589)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (590)) COMMA_SOURCE_FILE_AT_LINE (590)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_mm_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (600)) ;
  GGS_Xcode_PBXFileReference_mmSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_mmSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (601)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (601)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (603)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) COMMA_SOURCE_FILE_AT_LINE (604)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_gif_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (614)) ;
  GGS_Xcode_PBXFileReference_gifFile  var_cas_ref = GGS_Xcode_PBXFileReference_gifFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (615)), var_cas_inFile COMMA_SOURCE_FILE_AT_LINE (615)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (616)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (617)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (618)) COMMA_SOURCE_FILE_AT_LINE (618)), var_cas_inFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_tiff_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (628)) ;
  GGS_Xcode_PBXFileReference_tiffFile  var_cas_ref = GGS_Xcode_PBXFileReference_tiffFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (629)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (629)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (630)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (631)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (632)) COMMA_SOURCE_FILE_AT_LINE (632)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_png_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (642)) ;
  GGS_Xcode_PBXFileReference_pngFile  var_cas_ref = GGS_Xcode_PBXFileReference_pngFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (643)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (643)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (644)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (645)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (646)) COMMA_SOURCE_FILE_AT_LINE (646)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_plist_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (656)) ;
  GGS_Xcode_PBXFileReference_plistFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (657)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (657)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (658)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (659)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (660)) COMMA_SOURCE_FILE_AT_LINE (660)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_framework_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (670)) ;
  GGS_Xcode_PBXFileReference_frameworkFile  var_cas_ref = GGS_Xcode_PBXFileReference_frameworkFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (671)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (671)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (672)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (673)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_icns_file_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (684)) ;
  GGS_Xcode_PBXFileReference_icnsFile  var_cas_ref = GGS_Xcode_PBXFileReference_icnsFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (685)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (685)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (686)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (687)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_file_in_group (C_Compiler & inLexique,
  ...
  const GGS_bool cond_29704 = (var_cas_extension).operator_isEqual (GGS_string ("cpp")) ;
  if (cond_29704.isBuiltAndTrue ()) {
    ::routine_enter_cpp_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (700)) ;
  }else if (cond_29704.isBuiltAndFalse ()) {
    const GGS_bool cond_29823 = (var_cas_extension).operator_isEqual (GGS_string ("h")) ;
    if (cond_29823.isBuiltAndTrue ()) {
      ::routine_enter_h_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (702)) ;
    }else if (cond_29823.isBuiltAndFalse ()) {
      const GGS_bool cond_29946 = (var_cas_extension).operator_isEqual (GGS_string ("pch")) ;
      if (cond_29946.isBuiltAndTrue ()) {
        ::routine_enter_pch_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (704)) ;
      }else if (cond_29946.isBuiltAndFalse ()) {
        const GGS_bool cond_30065 = (var_cas_extension).operator_isEqual (GGS_string ("m")) ;
        if (cond_30065.isBuiltAndTrue ()) {
          ::routine_enter_m_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (706)) ;
        }else if (cond_30065.isBuiltAndFalse ()) {
          const GGS_bool cond_30186 = (var_cas_extension).operator_isEqual (GGS_string ("mm")) ;
          if (cond_30186.isBuiltAndTrue ()) {
            ::routine_enter_mm_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (708)) ;
          }else if (cond_30186.isBuiltAndFalse ()) {
            const GGS_bool cond_30311 = (var_cas_extension).operator_isEqual (GGS_string ("tiff")) ;
            if (cond_30311.isBuiltAndTrue ()) {
              ::routine_enter_tiff_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (710)) ;
            }else if (cond_30311.isBuiltAndFalse ()) {
              const GGS_bool cond_30434 = (var_cas_extension).operator_isEqual (GGS_string ("gif")) ;
              if (cond_30434.isBuiltAndTrue ()) {
                ::routine_enter_gif_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (712)) ;
              }else if (cond_30434.isBuiltAndFalse ()) {
                const GGS_bool cond_30557 = (var_cas_extension).operator_isEqual (GGS_string ("png")) ;
                if (cond_30557.isBuiltAndTrue ()) {
                  ::routine_enter_png_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (714)) ;
                }else if (cond_30557.isBuiltAndFalse ()) {
                  const GGS_bool cond_30684 = (var_cas_extension).operator_isEqual (GGS_string ("plist")) ;
                  if (cond_30684.isBuiltAndTrue ()) {
                    ::routine_enter_plist_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (716)) ;
                  }else if (cond_30684.isBuiltAndFalse ()) {
                    const GGS_bool cond_30819 = (var_cas_extension).operator_isEqual (GGS_string ("framework")) ;
                    if (cond_30819.isBuiltAndTrue ()) {
                      ::routine_enter_framework_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (718)) ;
                    }else if (cond_30819.isBuiltAndFalse ()) {
                      const GGS_bool cond_30943 = (var_cas_extension).operator_isEqual (GGS_string ("icns")) ;
                      if (cond_30943.isBuiltAndTrue ()) {
                        ::routine_enter_icns_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (720)) ;
                      }else if (cond_30943.isBuiltAndFalse ()) {
                        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot enter '")).operator_concat (var_cas_inFileName)).operator_concat (GGS_string ("' file : unknown extension")) COMMA_SOURCE_FILE_AT_LINE (723)) ;
                      }
                    }
                  }
                }
...
void routine_enter_files_in_group (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_31311 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_31311 = NULL ;
    while (((operand_31311 = enumerator_31311.nextObject ()))) {
      macroValidPointer (operand_31311) ;
      ::routine_enter_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  operand_31311->mValue,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (734)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_xib_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_xibFile  var_cas_ref = GGS_Xcode_PBXFileReference_xibFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_xib_fileName) COMMA_SOURCE_FILE_AT_LINE (746)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (751)) ;
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_xib_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (752)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (753)) ;
  GGS_string var_cas_PBXVariantGroupKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (754)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (754)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (755)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)), var_cas_in_xib_fileName) ;
...
void routine_enter_plist_strings_in_group (C_Compiler & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_plistStringFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistStringFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (773)), var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_plist_string_fileName) COMMA_SOURCE_FILE_AT_LINE (772)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (777)) ;
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_plist_string_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (778)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (779)) ;
  GGS_string var_cas_PBXVariantGroupKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (780)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (780)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (781)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (784)) COMMA_SOURCE_FILE_AT_LINE (784)), var_cas_in_plist_string_fileName) ;
...
void routine_enter_file_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (797)) ;
  GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
  const GGS_Xcode_PBXFileReference_map  temp_33927 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (799)) ;
  if (temp_33927.isBuilt ()) {
    temp_33927 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (799)) ;
  }
  GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (800)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (800)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (801)) ;
...
void routine_enter_file_list_for_sources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34476 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34476 = NULL ;
    while (((operand_34476 = enumerator_34476.nextObject ()))) {
      macroValidPointer (operand_34476) ;
      ::routine_enter_file_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  operand_34476->mValue,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (814)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34906 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34906 = NULL ;
    while (((operand_34906 = enumerator_34906.nextObject ()))) {
      macroValidPointer (operand_34906) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34906->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (830)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_35052 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (832)) ;
      if (temp_35052.isBuilt ()) {
        temp_35052 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (832)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (833)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (833)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (834)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_35644 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_35644 = NULL ;
    while (((operand_35644 = enumerator_35644.nextObject ()))) {
      macroValidPointer (operand_35644) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_35644->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (848)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_35790 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (850)) ;
      if (temp_35790.isBuilt ()) {
        temp_35790 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (850)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (851)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (851)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (852)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_add_tool_target (C_Compiler & inLexique,
                                ...
                                GGS_string & var_cas_outTargetKey
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_add_tool_target at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_Xcode_PBXFileReference_CompiledMachOExecutable  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_CompiledMachOExecutable ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (927)), var_cas_inProductFileName COMMA_SOURCE_FILE_AT_LINE (927)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (928)) ;
  GGS_lstring  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (929)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (930)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_toolFileReference.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (932)) COMMA_SOURCE_FILE_AT_LINE (932)), var_cas_inTargetName) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (935)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (934)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (939)) ;
  GGS_stringlist  var_cas_buildPhases = GGS_stringlist ::constructor_listWithValue (function_getPBXFileReferenceKey (inLexique, var_cas_compileSourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (940)) COMMA_SOURCE_FILE_AT_LINE (940))) ;
  const GGS_bool cond_40167 = (var_cas_inFrameworkKeyList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_40167.isBuiltAndTrue ()) {
    GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (944)), GGS_string ("Frameworks"), var_cas_inFrameworkKeyList COMMA_SOURCE_FILE_AT_LINE (943)) ;
    var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (948)) ;
    var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
    var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_frameworksBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950))) ;
  }
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  const GGS_bool cond_40460 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_40460.isBuiltAndTrue ()) {
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (960)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (961)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (961)), var_cas_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (959)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (964)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (965)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (967)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (967)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
...
void routine_add_app_target (C_Compiler & inLexique,
  ...
  GGS_Xcode_PBXFileReference_Application  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_Application ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (998)), var_cas_inProductFileName COMMA_SOURCE_FILE_AT_LINE (998)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (999)) ;
  GGS_lstring  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_toolFileReference.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)) COMMA_SOURCE_FILE_AT_LINE (1003)), var_cas_inTargetName) ;
  GGS_Xcode_PBXResourcesBuildPhase  var_cas_resourcesBuildPhase = GGS_Xcode_PBXResourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1006)), GGS_string ("Resources"), var_cas_inResourcesToCompileList COMMA_SOURCE_FILE_AT_LINE (1005)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  var_cas_ioXcodeProjectDescription.mPBXResourcesBuildPhase_list.addAssign_operation (var_cas_resourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_resourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1015)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_compileSourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1021)) COMMA_SOURCE_FILE_AT_LINE (1021))) ;
  GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1024)), GGS_string ("Frameworks"), var_cas_inFrameworksToCompileList COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_frameworksBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1030)) COMMA_SOURCE_FILE_AT_LINE (1030))) ;
  const GGS_bool cond_43937 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43937.isBuiltAndTrue ()) {
    var_cas_inTargetSettings.addAssign_operation (GGS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings.addAssign_operation (((GGS_string ("GCC_PREFIX_HEADER = \"")).operator_concat (var_cas_inPrecompiledHeaderPath)).operator_concat (GGS_string ("\";"))) ;
  }
  const GGS_bool cond_44056 = (var_cas_inInfoPListFile).operator_isNotEqual (GGS_string ("")) ;
  if (cond_44056.isBuiltAndTrue ()) {
  ...
  {
    GGS_stringlist::cEnumerator enumerator_44371 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_44371 = NULL ;
    while (((operand_44371 = enumerator_44371.nextObject ()))) {
      macroValidPointer (operand_44371) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1045)), operand_44371->mValue COMMA_SOURCE_FILE_AT_LINE (1045)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1046)) ;
      var_cas_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_d.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1047)) COMMA_SOURCE_FILE_AT_LINE (1047))) ;
      var_cas_ioXcodeProjectDescription.mDependencyList.addAssign_operation (var_cas_d) ;
    }
  }
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1053)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1053)), var_cas_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1057)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
...
void routine_enterProjectDefaultSettings (C_Compiler &,
                                ...
                                GGS_stringlist  & var_cas_outProjectDefaultSettings
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
  ...
  {
    GGS_stringlist::cEnumerator enumerator_45834 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_45834 = NULL ;
    while (((operand_45834 = enumerator_45834.nextObject ()))) {
      macroValidPointer (operand_45834) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_45834->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_49365 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1144)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_49365 = enumerator_49365.nextObject () ;
    if ((operand_49365 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_49365 ;
      do{
        macroValidPointer (operand_49365) ;
        if (operand_49365->mFile.isBuilt ()) {
          operand_49365->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1146)) ;
        }
        operand_49365 = enumerator_49365.nextObject () ;
        _foreach_loop_49365 = ((operand_49365 != NULL)) ;
        if (_foreach_loop_49365) {
        }
      }while (_foreach_loop_49365) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_49633 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_49633 = enumerator_49633.nextObject () ;
    if ((operand_49633 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_49633 ;
      do{
        macroValidPointer (operand_49633) ;
        if (operand_49633->mInfo.mFileReference.isBuilt ()) {
          operand_49633->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1152)) ;
        }
        operand_49633 = enumerator_49633.nextObject () ;
        _foreach_loop_49633 = ((operand_49633 != NULL)) ;
        if (_foreach_loop_49633) {
        }
      }while (_foreach_loop_49633) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49923 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49923 = enumerator_49923.nextObject () ;
    if ((operand_49923 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49923 ;
      do{
        macroValidPointer (operand_49923) ;
        if (operand_49923->mBuildPhase.isBuilt ()) {
          operand_49923->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1158)) ;
        }
        operand_49923 = enumerator_49923.nextObject () ;
        _foreach_loop_49923 = ((operand_49923 != NULL)) ;
        if (_foreach_loop_49923) {
        }
      }while (_foreach_loop_49923) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_50271 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1163)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_50271 = NULL ;
    while (((operand_50271 = enumerator_50271.nextObject ()))) {
      macroValidPointer (operand_50271) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_50271->mGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)) COMMA_SOURCE_FILE_AT_LINE (1164))) ;
      const GGS_bool cond_50501 = (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1165))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50501.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_50609 (operand_50271->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1171)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_50609 = NULL ;
        while (((operand_50609 = enumerator_50609.nextObject ()))) {
          macroValidPointer (operand_50609) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_50609->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_50609->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_51060 = (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1175))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_51060.isBuiltAndTrue ()) {
        const GGS_bool cond_50968 = (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1176)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50968.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1177))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50968.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_50271->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1179))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_51182 = (operand_50271->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1182))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_51182.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50271->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1183))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_51366 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1190)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_51366 = enumerator_51366.nextObject () ;
    if ((operand_51366 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_51366 ;
      do{
        macroValidPointer (operand_51366) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_51366->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_51366->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_51366->mTargetConfiguration.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1195)) COMMA_SOURCE_FILE_AT_LINE (1195))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_51366->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51843 (operand_51366->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_51843 = NULL ;
          while (((operand_51843 = enumerator_51843.nextObject ()))) {
            macroValidPointer (operand_51843) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51843->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        if (operand_51366->mProduct.isBuilt ()) {
          operand_51366->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1200)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_52140 (operand_51366->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_52140 = NULL ;
          while (((operand_52140 = enumerator_52140.nextObject ()))) {
            macroValidPointer (operand_52140) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_52140->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_51366->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_51366->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_51366->mProduct.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)) COMMA_SOURCE_FILE_AT_LINE (1212))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_51366 = enumerator_51366.nextObject () ;
        _foreach_loop_51366 = ((operand_51366 != NULL)) ;
        if (_foreach_loop_51366) {
        }
      }while (_foreach_loop_51366) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_53277 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1230)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_53277 = NULL ;
    while (((operand_53277 = enumerator_53277.nextObject ()))) {
      macroValidPointer (operand_53277) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_53277->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_53277->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_53543 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_53543 = enumerator_53543.nextObject () ;
    if ((operand_53543 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_53543 ;
      do{
        macroValidPointer (operand_53543) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53543->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1240))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53543->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1241))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53949 (operand_53543->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53949 = NULL ;
          while (((operand_53949 = enumerator_53949.nextObject ()))) {
            macroValidPointer (operand_53949) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53949->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1246)) COMMA_SOURCE_FILE_AT_LINE (1246))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53543 = enumerator_53543.nextObject () ;
        _foreach_loop_53543 = ((operand_53543 != NULL)) ;
        if (_foreach_loop_53543) {
        }
      }while (_foreach_loop_53543) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_54330 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_54330 = enumerator_54330.nextObject () ;
    if ((operand_54330 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_54330 ;
      do{
        macroValidPointer (operand_54330) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_54330->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)) COMMA_SOURCE_FILE_AT_LINE (1257))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54330->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1258))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_54730 (operand_54330->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1262)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_54730 = NULL ;
          while (((operand_54730 = enumerator_54730.nextObject ()))) {
            macroValidPointer (operand_54730) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_54730->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1263)) COMMA_SOURCE_FILE_AT_LINE (1263))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_54330 = enumerator_54330.nextObject () ;
        _foreach_loop_54330 = ((operand_54330 != NULL)) ;
        if (_foreach_loop_54330) {
        }
      }while (_foreach_loop_54330) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_55108 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1271)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_55108 = enumerator_55108.nextObject () ;
    if ((operand_55108 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_55108 ;
      do{
        macroValidPointer (operand_55108) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_55108->mDependency.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)) COMMA_SOURCE_FILE_AT_LINE (1274))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_55108->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_55108 = enumerator_55108.nextObject () ;
        _foreach_loop_55108 = ((operand_55108 != NULL)) ;
        if (_foreach_loop_55108) {
        }
      }while (_foreach_loop_55108) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_55597 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1282)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_55597 = enumerator_55597.nextObject () ;
    if ((operand_55597 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_55597 ;
      do{
        macroValidPointer (operand_55597) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55597->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_55597->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55597->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_55597->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_55597 = enumerator_55597.nextObject () ;
        _foreach_loop_55597 = ((operand_55597 != NULL)) ;
        if (_foreach_loop_55597) {
        }
      }while (_foreach_loop_55597) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_56148 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_56148 = enumerator_56148.nextObject () ;
    if ((operand_56148 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_56148 ;
      do{
        macroValidPointer (operand_56148) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_56148->mBuildConfig.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_56475 (operand_56148->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)), true) ;
          const GGS_stringlist::cElement * operand_56475 = NULL ;
          while (((operand_56475 = enumerator_56475.nextObject ()))) {
            macroValidPointer (operand_56475) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_56475->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_56148 = enumerator_56148.nextObject () ;
        _foreach_loop_56148 = ((operand_56148 != NULL)) ;
        if (_foreach_loop_56148) {
        }
      }while (_foreach_loop_56148) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_56778 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_56778 = enumerator_56778.nextObject () ;
    if ((operand_56778 != NULL)) {
      ...
      do{
        ...
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_56778->mBuildConfig.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1315)) COMMA_SOURCE_FILE_AT_LINE (1315))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_56778->mBuildConfig.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)) COMMA_SOURCE_FILE_AT_LINE (1319))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_defaultProjectConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1343)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1344)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1344)), var_cas_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1342)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_defaultProjectConfiguration) ;
  ::routine_enter_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_ioXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1351)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)), GGS_string (""), GGS_string (""), var_cas_ioXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) COMMA_SOURCE_FILE_AT_LINE (1358)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_projectName,  function_getPBXFileReferenceKey (inLexique, var_cas_mainGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1366)) COMMA_SOURCE_FILE_AT_LINE (1366)),  function_getPBXFileReferenceKey (inLexique, var_cas_defaultProjectConfiguration.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)) COMMA_SOURCE_FILE_AT_LINE (1367)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1363)) ;
  const GGS_bool cond_59951 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1370))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_59951.isBuiltAndTrue ()) {
    if (var_cas_in_xcodeproj_filePath.isBuilt ()) {
      var_cas_in_xcodeproj_filePath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)) ;
    }
    GGS_bool var_cas_written ;
    if (var_cas_fileNewContents.isBuilt ()) {
      var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1375)) ;
    }
    const GGS_string var_cas_pbxprojFilePath = (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")) ;
    const GGS_bool cond_59940 = (var_cas_written).operator_or ((var_cas_pbxprojFilePath.reader_fileExists ()).operator_not ()) ;
    if (cond_59940.isBuiltAndTrue ()) {
      GGS_bool automatic_var_59582_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_pbxprojFilePath, automatic_var_59582_0 COMMA_SOURCE_FILE_AT_LINE (1378)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_59801 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_59801 = NULL ;
        while (((operand_59801 = enumerator_59801.nextObject ()))) {
          macroValidPointer (operand_59801) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_59801->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1383)) ;
        }
      }
    }
  }
