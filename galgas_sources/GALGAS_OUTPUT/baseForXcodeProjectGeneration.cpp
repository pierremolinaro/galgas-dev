...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_43661 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_43661 = enumerator_43661.nextObject () ;
    if ((operand_43661 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_43661 ;
      do{
        macroValidPointer (operand_43661) ;
        const GGS_Xcode_PBXBuildFile  temp_43796 = operand_43661->mFile ;
        if (temp_43796.isBuilt ()) {
          temp_43796 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        }
        operand_43661 = enumerator_43661.nextObject () ;
        _foreach_loop_43661 = ((operand_43661 != NULL)) ;
        if (_foreach_loop_43661) {
        }
      }while (_foreach_loop_43661) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_43929 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1055)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_43929 = enumerator_43929.nextObject () ;
    if ((operand_43929 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_43929 ;
      do{
        macroValidPointer (operand_43929) ;
        const GGS_Xcode_PBXFileReference_abstract  temp_44077 = operand_43929->mInfo.mFileReference ;
        if (temp_44077.isBuilt ()) {
          temp_44077 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1057)) ;
        }
        operand_43929 = enumerator_43929.nextObject () ;
        _foreach_loop_43929 = ((operand_43929 != NULL)) ;
        if (_foreach_loop_43929) {
        }
      }while (_foreach_loop_43929) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_44219 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_44219 = enumerator_44219.nextObject () ;
    if ((operand_44219 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_44219 ;
      do{
        macroValidPointer (operand_44219) ;
        const GGS_Xcode_PBXFrameworksBuildPhase  temp_44383 = operand_44219->mBuildPhase ;
        if (temp_44383.isBuilt ()) {
          temp_44383 (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1063)) ;
        }
        operand_44219 = enumerator_44219.nextObject () ;
        _foreach_loop_44219 = ((operand_44219 != NULL)) ;
        if (_foreach_loop_44219) {
        }
      }while (_foreach_loop_44219) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_44567 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_44567 = NULL ;
    while (((operand_44567 = enumerator_44567.nextObject ()))) {
      macroValidPointer (operand_44567) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (operand_44567->mGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1069))) ;
      if (((operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1070))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1071))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_44875 (operand_44567->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_44875 = NULL ;
        while (((operand_44875 = enumerator_44875.nextObject ()))) {
          macroValidPointer (operand_44875) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_44875->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_44875->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      if (((operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1080))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        if (((operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)).reader_componentsSeparatedByString (inLexique, GGS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1081)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1081))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1082))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else{
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_44567->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1084))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      if (((operand_44567->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1087))).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_44567->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1088))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_45632 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1095)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_45632 = enumerator_45632.nextObject () ;
    if ((operand_45632 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_45632 ;
      do{
        macroValidPointer (operand_45632) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_45632->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_45632->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (operand_45632->mTargetConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_45632->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46089 (operand_45632->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_46089 = NULL ;
          while (((operand_46089 = enumerator_46089.nextObject ()))) {
            macroValidPointer (operand_46089) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_46089->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        const GGS_Xcode_productFileReference  temp_46218 = operand_45632->mProduct ;
        if (temp_46218.isBuilt ()) {
          temp_46218 (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1105)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_46386 (operand_45632->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_46386 = NULL ;
          while (((operand_46386 = enumerator_46386.nextObject ()))) {
            macroValidPointer (operand_46386) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_46386->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_45632->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_45632->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (operand_45632->mProduct.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1117))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_45632 = enumerator_45632.nextObject () ;
        _foreach_loop_45632 = ((operand_45632 != NULL)) ;
        if (_foreach_loop_45632) {
        }
      }while (_foreach_loop_45632) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_47501 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_47501 = NULL ;
    while (((operand_47501 = enumerator_47501.nextObject ()))) {
      macroValidPointer (operand_47501) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_47501->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_47501->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_47767 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_47767 = enumerator_47767.nextObject () ;
    if ((operand_47767 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_47767 ;
      do{
        macroValidPointer (operand_47767) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_47767->mBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_47767->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1146))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48157 (operand_47767->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_48157 = NULL ;
          while (((operand_48157 = enumerator_48157.nextObject ()))) {
            macroValidPointer (operand_48157) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_48157->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1151))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_47767 = enumerator_47767.nextObject () ;
        _foreach_loop_47767 = ((operand_47767 != NULL)) ;
        if (_foreach_loop_47767) {
        }
      }while (_foreach_loop_47767) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_48512 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_48512 = enumerator_48512.nextObject () ;
    if ((operand_48512 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_48512 ;
      do{
        macroValidPointer (operand_48512) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_48512->mBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1162))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_48512->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1163))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48894 (operand_48512->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1167)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_48894 = NULL ;
          while (((operand_48894 = enumerator_48894.nextObject ()))) {
            macroValidPointer (operand_48894) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_48894->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1168))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_48512 = enumerator_48512.nextObject () ;
        _foreach_loop_48512 = ((operand_48512 != NULL)) ;
        if (_foreach_loop_48512) {
        }
      }while (_foreach_loop_48512) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_49246 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1176)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_49246 = enumerator_49246.nextObject () ;
    if ((operand_49246 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_49246 ;
      do{
        macroValidPointer (operand_49246) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49246->mDependency.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1179))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_49246->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1182))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_49246 = enumerator_49246.nextObject () ;
        _foreach_loop_49246 = ((operand_49246 != NULL)) ;
        if (_foreach_loop_49246) {
        }
      }while (_foreach_loop_49246) ;
  ...
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_49794 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1190)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_49794 = enumerator_49794.nextObject () ;
    if ((operand_49794 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_49794 ;
      do{
        macroValidPointer (operand_49794) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49794->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49794->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_49794->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_49794->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_49794 = enumerator_49794.nextObject () ;
        _foreach_loop_49794 = ((operand_49794 != NULL)) ;
        if (_foreach_loop_49794) {
        }
      }while (_foreach_loop_49794) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_50345 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_50345 = enumerator_50345.nextObject () ;
    if ((operand_50345 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_50345 ;
      do{
        macroValidPointer (operand_50345) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50345->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1208))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_50646 (operand_50345->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1211)), true) ;
          const GGS_stringlist::cElement * operand_50646 = NULL ;
          while (((operand_50646 = enumerator_50646.nextObject ()))) {
            macroValidPointer (operand_50646) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_50646->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_50345 = enumerator_50345.nextObject () ;
        _foreach_loop_50345 = ((operand_50345 != NULL)) ;
        if (_foreach_loop_50345) {
        }
      }while (_foreach_loop_50345) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_50949 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_50949 = enumerator_50949.nextObject () ;
    if ((operand_50949 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_50949 ;
      do{
        macroValidPointer (operand_50949) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50949->mBuildConfig.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1223))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50949->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1227))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_50949 = enumerator_50949.nextObject () ;
        _foreach_loop_50949 = ((operand_50949 != NULL)) ;
        if (_foreach_loop_50949) {
        }
      }while (_foreach_loop_50949) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    const GGS_string temp_52983 = var_cas_in_xcodeproj_filePath ;
    if (temp_52983.isBuilt ()) {
      temp_52983 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1273)) ;
    }
    GGS_bool var_cas_written ;
    const GGS_string temp_53105 = var_cas_fileNewContents ;
    if (temp_53105.isBuilt ()) {
      temp_53105 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    }
    if (((var_cas_written).operator_or ((var_cas_in_xcodeproj_filePath.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))).operator_not ())).isBuiltAndTrue ()) {
      ...
      const GGS_string temp_53255 = var_cas_fileNewContents ;
      if (temp_53255.isBuilt ()) {
        temp_53255 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      }
    }
    if ((var_cas_written).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_53555 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_53555 = NULL ;
        while (((operand_53555 = enumerator_53555.nextObject ()))) {
          macroValidPointer (operand_53555) ;
          GGS_string var_cas_fullPath ;
          var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_53555->mValue) ;
