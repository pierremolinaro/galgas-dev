...
//                    september 27th, 2010, at 13h53'59"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_buildXcodeProjectString (C_Compiler & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48697 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1147)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_48697 = enumerator_48697.nextObject () ;
    if ((operand_48697 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_48697 ;
      do{
        macroValidPointer (operand_48697) ;
        if (operand_48697->mFile.isBuilt ()) {
          operand_48697->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1149)) ;
        }
        operand_48697 = enumerator_48697.nextObject () ;
        _foreach_loop_48697 = ((operand_48697 != NULL)) ;
        if (_foreach_loop_48697) {
        }
      }while (_foreach_loop_48697) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_48965 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_48965 = enumerator_48965.nextObject () ;
    if ((operand_48965 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_48965 ;
      do{
        macroValidPointer (operand_48965) ;
        if (operand_48965->mInfo.mFileReference.isBuilt ()) {
          operand_48965->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1155)) ;
        }
        operand_48965 = enumerator_48965.nextObject () ;
        _foreach_loop_48965 = ((operand_48965 != NULL)) ;
        if (_foreach_loop_48965) {
        }
      }while (_foreach_loop_48965) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49255 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49255 = enumerator_49255.nextObject () ;
    if ((operand_49255 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49255 ;
      do{
        macroValidPointer (operand_49255) ;
        if (operand_49255->mBuildPhase.isBuilt ()) {
          operand_49255->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1161)) ;
        }
        operand_49255 = enumerator_49255.nextObject () ;
        _foreach_loop_49255 = ((operand_49255 != NULL)) ;
        if (_foreach_loop_49255) {
        }
      }while (_foreach_loop_49255) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_49603 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1166)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_49603 = NULL ;
    while (((operand_49603 = enumerator_49603.nextObject ()))) {
      macroValidPointer (operand_49603) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (operand_49603->mGroup.reader_PBXGroupKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1167))) ;
      const GGS_bool cond_49803 = (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1168))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_49803.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1169))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_49911 (operand_49603->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_49911 = NULL ;
        while (((operand_49911 = enumerator_49911.nextObject ()))) {
          macroValidPointer (operand_49911) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_49911->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_49911->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_50362 = (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1178))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50362.isBuiltAndTrue ()) {
        const GGS_bool cond_50270 = (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50270.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1180))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50270.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_49603->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1182))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_50484 = (operand_49603->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1185))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50484.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_49603->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1186))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_50668 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1193)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_50668 = enumerator_50668.nextObject () ;
    if ((operand_50668 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_50668 ;
      do{
        macroValidPointer (operand_50668) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50668->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50668->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (operand_50668->mTargetConfiguration.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1198))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_50668->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51125 (operand_50668->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_51125 = NULL ;
          while (((operand_51125 = enumerator_51125.nextObject ()))) {
            macroValidPointer (operand_51125) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51125->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        if (operand_50668->mProduct.isBuilt ()) {
          operand_50668->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1203)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51422 (operand_50668->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_51422 = NULL ;
          while (((operand_51422 = enumerator_51422.nextObject ()))) {
            macroValidPointer (operand_51422) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51422->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50668->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_50668->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (operand_50668->mProduct.reader_PBXFileReferenceKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1215))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_50668 = enumerator_50668.nextObject () ;
        _foreach_loop_50668 = ((operand_50668 != NULL)) ;
        if (_foreach_loop_50668) {
        }
      }while (_foreach_loop_50668) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_52537 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1233)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_52537 = NULL ;
    while (((operand_52537 = enumerator_52537.nextObject ()))) {
      macroValidPointer (operand_52537) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_52537->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_52537->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_52803 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_52803 = enumerator_52803.nextObject () ;
    if ((operand_52803 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_52803 ;
      do{
        macroValidPointer (operand_52803) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_52803->mBuildPhase.reader_PBXResourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1243))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_52803->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1244))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53193 (operand_52803->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53193 = NULL ;
          while (((operand_53193 = enumerator_53193.nextObject ()))) {
            macroValidPointer (operand_53193) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53193->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1249))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_52803 = enumerator_52803.nextObject () ;
        _foreach_loop_52803 = ((operand_52803 != NULL)) ;
        if (_foreach_loop_52803) {
        }
      }while (_foreach_loop_52803) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_53548 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_53548 = enumerator_53548.nextObject () ;
    if ((operand_53548 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_53548 ;
      do{
        macroValidPointer (operand_53548) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_53548->mBuildPhase.reader_PBXSourcesBuildPhaseKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1260))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53548->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1261))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53930 (operand_53548->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1265)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53930 = NULL ;
          while (((operand_53930 = enumerator_53930.nextObject ()))) {
            macroValidPointer (operand_53930) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_53930->mFile.reader_PBXBuildFileKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1266))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53548 = enumerator_53548.nextObject () ;
        _foreach_loop_53548 = ((operand_53548 != NULL)) ;
        if (_foreach_loop_53548) {
        }
      }while (_foreach_loop_53548) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_54282 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_54282 = enumerator_54282.nextObject () ;
    if ((operand_54282 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_54282 ;
      do{
        macroValidPointer (operand_54282) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54282->mDependency.reader_PBXTargetDependencyKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1277))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_54282->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1280))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_54282 = enumerator_54282.nextObject () ;
        _foreach_loop_54282 = ((operand_54282 != NULL)) ;
        if (_foreach_loop_54282) {
        }
      }while (_foreach_loop_54282) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_54752 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_54752 = enumerator_54752.nextObject () ;
    if ((operand_54752 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_54752 ;
      do{
        macroValidPointer (operand_54752) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54752->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54752->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54752->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_54752->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_54752 = enumerator_54752.nextObject () ;
        _foreach_loop_54752 = ((operand_54752 != NULL)) ;
        if (_foreach_loop_54752) {
        }
      }while (_foreach_loop_54752) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55303 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1300)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55303 = enumerator_55303.nextObject () ;
    if ((operand_55303 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_55303 ;
      do{
        macroValidPointer (operand_55303) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55303->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1303))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_55604 (operand_55303->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)), true) ;
          const GGS_stringlist::cElement * operand_55604 = NULL ;
          while (((operand_55604 = enumerator_55604.nextObject ()))) {
            macroValidPointer (operand_55604) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_55604->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_55303 = enumerator_55303.nextObject () ;
        _foreach_loop_55303 = ((operand_55303 != NULL)) ;
        if (_foreach_loop_55303) {
        }
      }while (_foreach_loop_55303) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55907 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1315)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55907 = enumerator_55907.nextObject () ;
    if ((operand_55907 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_55907 ;
      do{
        macroValidPointer (operand_55907) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55907->mBuildConfig.reader_XCBuildConfigurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1318))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_55907->mBuildConfig.reader_configurationKey (inLexique COMMA_SOURCE_FILE_AT_LINE (1322))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_55907 = enumerator_55907.nextObject () ;
        _foreach_loop_55907 = ((operand_55907 != NULL)) ;
        if (_foreach_loop_55907) {
        }
      }while (_foreach_loop_55907) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58986 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1373))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_58986.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_58975 = (var_cas_written).operator_or ((var_cas_pbxprojFilePath.reader_fileExists ()).operator_not ()) ;
    if (cond_58975.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58617_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_pbxprojFilePath, automatic_var_58617_0 COMMA_SOURCE_FILE_AT_LINE (1381)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_58836 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_58836 = NULL ;
        while (((operand_58836 = enumerator_58836.nextObject ()))) {
          macroValidPointer (operand_58836) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_58836->mValue) ;
