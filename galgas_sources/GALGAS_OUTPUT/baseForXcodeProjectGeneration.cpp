...
GGS_string function_getPBXFileReferenceKey (C_CompilerEx & inLexique,
...
static GGS_object functionForGenericCall_getPBXFileReferenceKey (C_CompilerEx & inLexique,
...
void GGS_Xcode_PBXFileReference_map::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
GGS_Xcode_PBXFileReference_map GGS_Xcode_PBXFileReference_map::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
...
method_buildXcodeProject (C_CompilerEx & inLexique,
                                GGS_string& var_cas_outString COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_outString.appendCString ("\t\t") ;
  var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, mSequenceNumber COMMA_SOURCE_FILE_AT_LINE (300))) ;
  var_cas_outString.appendCString (" /* Frameworks */ = {\n"
  "\t\t\tisa = PBXFrameworksBuildPhase;\n"
  "\t\t\tbuildActionMask = 2147483647;\n"
  "\t\t\tfiles = (\n") ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_13511 (mFileReferenceList, true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_13511 = NULL ;
    while (((operand_13511 = enumerator_13511.nextObject ()))) {
      macroValidPointer (operand_13511) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_13511->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305))) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_13511->mFile.reader_mSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (306)).reader_mFileName (inLexique COMMA_SOURCE_FILE_AT_LINE (306))) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
...
void routine_initXcodeProjectDescription (C_CompilerEx & inLexique,
  ...
  #endif
  var_cas_outDescription = GGS_XcodeProjectDescription::constructor_new (GGS_Xcode_PBXFileReference_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (429)), GGS_Xcode_PBXBuildFile_list ::constructor_emptyList (), GGS_XcodeObjectReferenceList ::constructor_emptyList (), GGS_Xcode_PBXGroup_list ::constructor_emptyList (), GGS_Xcode_PBXNativeTarget_list ::constructor_emptyList (), GGS_XcodeObjectReferenceList ::constructor_emptyList (), GGS_Xcode_XCBuildConfiguration_list ::constructor_emptyList (), GGS_Xcode_PBXSourcesBuildPhase_list ::constructor_emptyList (), GGS_Xcode_PBXFrameworksBuildPhase_list ::constructor_emptyList (), GGS_Xcode_PBXResourcesBuildPhase_list ::constructor_emptyList (), GGS_Xcode_targetDependencyDescription_list ::constructor_emptyList (), GGS_Xcode_PBXVariantGroup_list ::constructor_emptyList (), GGS_uint (0U)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_Xcode_PBXGroup  var_cas_group = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (458)), var_cas_inGroupName, var_cas_inGroupPath, var_cas_inGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (457)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (463)) ;
  var_cas_ioXcodeProjectDescription.mProjectGroupList.addAssign_operation (var_cas_group) ;
  var_cas_ioXcodeProjectDescription.mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_group.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (465)) COMMA_SOURCE_FILE_AT_LINE (465)), var_cas_inGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_subgroup (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_Xcode_PBXGroup  var_cas_group = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), var_cas_inSubGroupName, var_cas_inSubGroupPath, var_cas_inSubGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (481)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (487)) ;
  var_cas_ioXcodeProjectDescription.mProjectGroupList.addAssign_operation (var_cas_group) ;
  var_cas_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_group.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) COMMA_SOURCE_FILE_AT_LINE (489)), var_cas_inSubGroupName) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_cpp_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (520)) ;
  GGS_Xcode_PBXFileReference_cppSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_cppSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (521)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (522)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (523)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_h_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (534)) ;
  GGS_Xcode_PBXFileReference_hSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_hSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (535)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (536)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (537)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) COMMA_SOURCE_FILE_AT_LINE (538)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_pch_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (548)) ;
  GGS_Xcode_PBXFileReference_pchSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_pchSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (549)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (550)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (551)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (552)) COMMA_SOURCE_FILE_AT_LINE (552)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_m_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (562)) ;
  GGS_Xcode_PBXFileReference_mSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_mSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (563)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (563)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (565)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_mm_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (576)) ;
  GGS_Xcode_PBXFileReference_mmSourceFile  var_cas_ref = GGS_Xcode_PBXFileReference_mmSourceFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (577)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (577)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (579)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_gif_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (590)) ;
  GGS_Xcode_PBXFileReference_gifFile  var_cas_ref = GGS_Xcode_PBXFileReference_gifFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), var_cas_inFile COMMA_SOURCE_FILE_AT_LINE (591)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (592)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (593)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (594)) COMMA_SOURCE_FILE_AT_LINE (594)), var_cas_inFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_tiff_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (604)) ;
  GGS_Xcode_PBXFileReference_tiffFile  var_cas_ref = GGS_Xcode_PBXFileReference_tiffFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (605)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (605)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (606)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (607)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (608)) COMMA_SOURCE_FILE_AT_LINE (608)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_png_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (618)) ;
  GGS_Xcode_PBXFileReference_pngFile  var_cas_ref = GGS_Xcode_PBXFileReference_pngFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (619)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (619)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (620)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (621)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (622)) COMMA_SOURCE_FILE_AT_LINE (622)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_plist_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (632)) ;
  GGS_Xcode_PBXFileReference_plistFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (633)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (633)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (634)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (635)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_framework_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (646)) ;
  GGS_Xcode_PBXFileReference_frameworkFile  var_cas_ref = GGS_Xcode_PBXFileReference_frameworkFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (647)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (647)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (648)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (649)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_icns_file_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inCppFile, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (660)) ;
  GGS_Xcode_PBXFileReference_icnsFile  var_cas_ref = GGS_Xcode_PBXFileReference_icnsFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (661)), var_cas_inCppFile COMMA_SOURCE_FILE_AT_LINE (661)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (662)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (663)) ;
  var_cas_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (664)) COMMA_SOURCE_FILE_AT_LINE (664)), var_cas_inCppFile) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_file_in_group (C_CompilerEx & inLexique,
  ...
  const GGS_bool cond_28898 = (var_cas_extension).operator_isEqual (GGS_string ("cpp")) ;
  if (cond_28898.isBuiltAndTrue ()) {
    ::routine_enter_cpp_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (676)) ;
  }else if (cond_28898.isBuiltAndFalse ()) {
    const GGS_bool cond_29017 = (var_cas_extension).operator_isEqual (GGS_string ("h")) ;
    if (cond_29017.isBuiltAndTrue ()) {
      ::routine_enter_h_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (678)) ;
    }else if (cond_29017.isBuiltAndFalse ()) {
      const GGS_bool cond_29140 = (var_cas_extension).operator_isEqual (GGS_string ("pch")) ;
      if (cond_29140.isBuiltAndTrue ()) {
        ::routine_enter_pch_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (680)) ;
      }else if (cond_29140.isBuiltAndFalse ()) {
        const GGS_bool cond_29259 = (var_cas_extension).operator_isEqual (GGS_string ("m")) ;
        if (cond_29259.isBuiltAndTrue ()) {
          ::routine_enter_m_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (682)) ;
        }else if (cond_29259.isBuiltAndFalse ()) {
          const GGS_bool cond_29380 = (var_cas_extension).operator_isEqual (GGS_string ("mm")) ;
          if (cond_29380.isBuiltAndTrue ()) {
            ::routine_enter_mm_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (684)) ;
          }else if (cond_29380.isBuiltAndFalse ()) {
            const GGS_bool cond_29505 = (var_cas_extension).operator_isEqual (GGS_string ("tiff")) ;
            if (cond_29505.isBuiltAndTrue ()) {
              ::routine_enter_tiff_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (686)) ;
            }else if (cond_29505.isBuiltAndFalse ()) {
              const GGS_bool cond_29628 = (var_cas_extension).operator_isEqual (GGS_string ("gif")) ;
              if (cond_29628.isBuiltAndTrue ()) {
                ::routine_enter_gif_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (688)) ;
              }else if (cond_29628.isBuiltAndFalse ()) {
                const GGS_bool cond_29751 = (var_cas_extension).operator_isEqual (GGS_string ("png")) ;
                if (cond_29751.isBuiltAndTrue ()) {
                  ::routine_enter_png_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (690)) ;
                }else if (cond_29751.isBuiltAndFalse ()) {
                  const GGS_bool cond_29878 = (var_cas_extension).operator_isEqual (GGS_string ("plist")) ;
                  if (cond_29878.isBuiltAndTrue ()) {
                    ::routine_enter_plist_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (692)) ;
                  }else if (cond_29878.isBuiltAndFalse ()) {
                    const GGS_bool cond_30013 = (var_cas_extension).operator_isEqual (GGS_string ("framework")) ;
                    if (cond_30013.isBuiltAndTrue ()) {
                      ::routine_enter_framework_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (694)) ;
                    }else if (cond_30013.isBuiltAndFalse ()) {
                      const GGS_bool cond_30137 = (var_cas_extension).operator_isEqual (GGS_string ("icns")) ;
                      if (cond_30137.isBuiltAndTrue ()) {
                        ::routine_enter_icns_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_inFileName,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (696)) ;
                      }else if (cond_30137.isBuiltAndFalse ()) {
                        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("cannot enter '")).operator_concat (var_cas_inFileName)).operator_concat (GGS_string ("' file : unknown extension")) COMMA_SOURCE_FILE_AT_LINE (699)) ;
                      }
                    }
                  }
                }
...
void routine_enter_files_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_30505 (var_cas_inFileList, true) ;
    const GGS_stringlist::cElement * operand_30505 = NULL ;
    while (((operand_30505 = enumerator_30505.nextObject ()))) {
      macroValidPointer (operand_30505) ;
      ::routine_enter_file_in_group (inLexique,  var_cas_ioXcodeProjectDescription,  operand_30505->mValue,  var_cas_ioFileListForGroup COMMA_SOURCE_FILE_AT_LINE (710)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_xib_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_xibFile  var_cas_ref = GGS_Xcode_PBXFileReference_xibFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (723)), var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_xib_fileName) COMMA_SOURCE_FILE_AT_LINE (722)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (727)) ;
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_xib_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (728)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (729)) ;
  GGS_string var_cas_PBXVariantGroupKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (730)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (730)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (731)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)), var_cas_in_xib_fileName) ;
...
void routine_enter_plist_strings_in_group (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_plistStringFile  var_cas_ref = GGS_Xcode_PBXFileReference_plistStringFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (749)), var_cas_in_lproj_dir.reader_stringByDeletingPathExtension (), ((var_cas_in_lproj_dir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_in_plist_string_fileName) COMMA_SOURCE_FILE_AT_LINE (748)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (753)) ;
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_plist_string_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (754)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (755)) ;
  GGS_string var_cas_PBXVariantGroupKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (756)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (756)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (757)) ;
  var_cas_ioXcodeProjectDescription.mPBXVariantGroup_list.addAssign_operation (var_cas_PBXVariantGroupKey, function_getPBXFileReferenceKey (inLexique, var_cas_ref.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)), var_cas_in_plist_string_fileName) ;
...
void routine_enter_file_for_sources_build_phase (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_in_fileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (773)) ;
  GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
  const GGS_Xcode_PBXFileReference_map  temp_33121 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (775)) ;
  if (temp_33121.isBuilt ()) {
    temp_33121 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (775)) ;
  }
  GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (776)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (776)) ;
...
void routine_enter_file_list_for_sources_build_phase (C_CompilerEx & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_33670 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_33670 = NULL ;
    while (((operand_33670 = enumerator_33670.nextObject ()))) {
      macroValidPointer (operand_33670) ;
      ::routine_enter_file_for_sources_build_phase (inLexique,  var_cas_ioXcodeProjectDescription,  operand_33670->mValue,  var_cas_ioBuildPhaseList COMMA_SOURCE_FILE_AT_LINE (790)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_enter_files_for_resources_build_phase (C_CompilerEx & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34100 (var_cas_in_fileList, true) ;
    const GGS_stringlist::cElement * operand_34100 = NULL ;
    while (((operand_34100 = enumerator_34100.nextObject ()))) {
      macroValidPointer (operand_34100) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34100->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (806)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_34246 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (808)) ;
      if (temp_34246.isBuilt ()) {
        temp_34246 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (808)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (809)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (810)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_enter_files_for_frameworks_build_phase (C_CompilerEx & inLexique,
  ...
  #endif
  {
    GGS_stringlist::cEnumerator enumerator_34838 (var_cas_in_framework_fileList, true) ;
    const GGS_stringlist::cElement * operand_34838 = NULL ;
    while (((operand_34838 = enumerator_34838.nextObject ()))) {
      macroValidPointer (operand_34838) ;
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34838->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (824)) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
      const GGS_Xcode_PBXFileReference_map  temp_34984 = var_cas_ioXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (826)) ;
      if (temp_34984.isBuilt ()) {
        temp_34984 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_ref COMMA_SOURCE_FILE_AT_LINE (826)) ;
      }
      GGS_Xcode_PBXBuildFile  var_cas_build_file = GGS_Xcode_PBXBuildFile ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), var_cas_ref COMMA_SOURCE_FILE_AT_LINE (827)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (828)) ;
      var_cas_ioXcodeProjectDescription.mAllBuildFileList.addAssign_operation (var_cas_build_file) ;
      var_cas_ioBuildPhaseList.addAssign_operation (var_cas_build_file) ;
    }
  }
...
void routine_add_tool_target (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_Xcode_PBXFileReference_CompiledMachOExecutable  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_CompiledMachOExecutable ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (903)), var_cas_inProductFileName COMMA_SOURCE_FILE_AT_LINE (903)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (904)) ;
  GGS_lstring  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (905)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (906)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_toolFileReference.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (908)) COMMA_SOURCE_FILE_AT_LINE (908)), var_cas_inTargetName) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (911)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (910)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (915)) ;
  GGS_stringlist  var_cas_buildPhases = GGS_stringlist ::constructor_listWithValue (function_getPBXFileReferenceKey (inLexique, var_cas_compileSourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (916)) COMMA_SOURCE_FILE_AT_LINE (916))) ;
  const GGS_bool cond_39339 = (var_cas_inFrameworkKeyList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_39339.isBuiltAndTrue ()) {
    GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (920)), GGS_string ("Frameworks"), var_cas_inFrameworkKeyList COMMA_SOURCE_FILE_AT_LINE (919)) ;
    var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (924)) ;
    var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
    var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_frameworksBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926))) ;
  }
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  const GGS_bool cond_39632 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_39632.isBuiltAndTrue ()) {
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (936)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (937)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (937)), var_cas_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (935)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (940)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (941)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (943)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (943)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (944)) ;
...
void routine_add_app_target (C_CompilerEx & inLexique,
  ...
  GGS_Xcode_PBXFileReference_Application  var_cas_toolFileReference = GGS_Xcode_PBXFileReference_Application ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (974)), var_cas_inProductFileName COMMA_SOURCE_FILE_AT_LINE (974)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (975)) ;
  GGS_lstring  var_cas_projectNameKey = GGS_lstring ::constructor_new (inLexique, var_cas_inProductFileName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (976)) ;
  var_cas_ioXcodeProjectDescription.mFileReferenceMap.modifier_insertKey (inLexique, var_cas_projectNameKey, var_cas_toolFileReference COMMA_SOURCE_FILE_AT_LINE (977)) ;
  var_cas_ioXcodeProjectDescription.mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_toolFileReference.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (979)) COMMA_SOURCE_FILE_AT_LINE (979)), var_cas_inTargetName) ;
  GGS_Xcode_PBXResourcesBuildPhase  var_cas_resourcesBuildPhase = GGS_Xcode_PBXResourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (982)), GGS_string ("Resources"), var_cas_inResourcesToCompileList COMMA_SOURCE_FILE_AT_LINE (981)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (986)) ;
  var_cas_ioXcodeProjectDescription.mPBXResourcesBuildPhase_list.addAssign_operation (var_cas_resourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_resourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (988)) COMMA_SOURCE_FILE_AT_LINE (988))) ;
  GGS_Xcode_PBXSourcesBuildPhase  var_cas_compileSourcesBuildPhase = GGS_Xcode_PBXSourcesBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (991)), GGS_string ("Sources"), var_cas_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (990)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (995)) ;
  var_cas_ioXcodeProjectDescription.mPBXSourcesBuildPhase_list.addAssign_operation (var_cas_compileSourcesBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_compileSourcesBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) COMMA_SOURCE_FILE_AT_LINE (997))) ;
  GGS_Xcode_PBXFrameworksBuildPhase  var_cas_frameworksBuildPhase = GGS_Xcode_PBXFrameworksBuildPhase ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1000)), GGS_string ("Frameworks"), var_cas_inFrameworksToCompileList COMMA_SOURCE_FILE_AT_LINE (999)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1004)) ;
  var_cas_ioXcodeProjectDescription.mPBXFrameworksBuildPhase_list.addAssign_operation (var_cas_frameworksBuildPhase) ;
  var_cas_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_frameworksBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1006)) COMMA_SOURCE_FILE_AT_LINE (1006))) ;
  const GGS_bool cond_43109 = (var_cas_inPrecompiledHeaderPath).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43109.isBuiltAndTrue ()) {
    var_cas_inTargetSettings.addAssign_operation (GGS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;")) ;
    var_cas_inTargetSettings.addAssign_operation (((GGS_string ("GCC_PREFIX_HEADER = \"")).operator_concat (var_cas_inPrecompiledHeaderPath)).operator_concat (GGS_string ("\";"))) ;
  }
  const GGS_bool cond_43228 = (var_cas_inInfoPListFile).operator_isNotEqual (GGS_string ("")) ;
  if (cond_43228.isBuiltAndTrue ()) {
  ...
  {
    GGS_stringlist::cEnumerator enumerator_43543 (var_cas_inDirectDependencyList, true) ;
    const GGS_stringlist::cElement * operand_43543 = NULL ;
    while (((operand_43543 = enumerator_43543.nextObject ()))) {
      macroValidPointer (operand_43543) ;
      GGS_Xcode_targetDependencyDescription  var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1021)), operand_43543->mValue COMMA_SOURCE_FILE_AT_LINE (1021)) ;
      var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)) ;
      var_cas_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (inLexique, var_cas_d.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1023)) COMMA_SOURCE_FILE_AT_LINE (1023))) ;
      var_cas_ioXcodeProjectDescription.mDependencyList.addAssign_operation (var_cas_d) ;
    }
  }
  GGS_Xcode_XCBuildConfiguration  var_cas_toolTargetBuildConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1028)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1029)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1029)), var_cas_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1027)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1032)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_toolTargetBuildConfiguration) ;
  var_cas_outTargetKey = var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1035)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1035)).reader_md5 ().reader_rightSubString (GGS_uint (24U)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1036)) ;
...
void routine_enterProjectDefaultSettings (C_CompilerEx &,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_45041 (var_cas_inHeaderSearchPathList, true) ;
    const GGS_stringlist::cElement * operand_45041 = NULL ;
    while (((operand_45041 = enumerator_45041.nextObject ()))) {
      macroValidPointer (operand_45041) ;
      var_cas_pathString.appendCString ("\t\t\t\t\t\"") ;
      var_cas_pathString.dotAssign_operation (operand_45041->mValue) ;
      var_cas_pathString.appendCString ("\",\n") ;
    }
  }
  ...
  GGS_string var_cas_s = GGS_string ("ARCHS = (") ;
  {
    GGS_stringlist::cEnumerator enumerator_45295 (var_cas_inArchitectureList, true) ;
    const GGS_stringlist::cElement * operand_45295 = NULL ;
    while (((operand_45295 = enumerator_45295.nextObject ()))) {
      macroValidPointer (operand_45295) ;
      var_cas_s.appendCString ("\n"
        "\t\t\t\t\t") ;
      var_cas_s.dotAssign_operation (operand_45295->mValue) ;
      var_cas_s.appendCString (",") ;
    }
  }
  var_cas_s.appendCString ("\n"
    "\t\t\t\t);") ;
  var_cas_outProjectDefaultSettings.addAssign_operation (var_cas_s) ;
...
void routine_buildXcodeProjectString (C_CompilerEx & inLexique,
  ...
  var_cas_outString = ((((((GGS_string ("// !$*UTF8*$!\n")).operator_concat (GGS_string ("{\n"))).operator_concat (GGS_string ("\tarchiveVersion = 1;\n"))).operator_concat (GGS_string ("\tclasses = {\n"))).operator_concat (GGS_string ("\t};\n"))).operator_concat (GGS_string ("\tobjectVersion = 42;\n"))).operator_concat (GGS_string ("\tobjects = {\n"
    "\n")) ;
  {
    GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_48686 (var_cas_inXcodeProjectDescription.reader_mAllBuildFileList (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)), true) ;
    const GGS_Xcode_PBXBuildFile_list::cElement * operand_48686 = enumerator_48686.nextObject () ;
    if ((operand_48686 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXBuildFile section */\n") ;
      bool _foreach_loop_48686 ;
      do{
        macroValidPointer (operand_48686) ;
        if (operand_48686->mFile.isBuilt ()) {
          operand_48686->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1128)) ;
        }
        operand_48686 = enumerator_48686.nextObject () ;
        _foreach_loop_48686 = ((operand_48686 != NULL)) ;
        if (_foreach_loop_48686) {
        }
      }while (_foreach_loop_48686) ;
      var_cas_outString.appendCString ("/* End PBXBuildFile section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_PBXFileReference_map::cEnumerator enumerator_48954 (var_cas_inXcodeProjectDescription.reader_mFileReferenceMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)), true) ;
    const GGS_Xcode_PBXFileReference_map::cElement * operand_48954 = enumerator_48954.nextObject () ;
    if ((operand_48954 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFileReference section */\n") ;
      bool _foreach_loop_48954 ;
      do{
        macroValidPointer (operand_48954) ;
        if (operand_48954->mInfo.mFileReference.isBuilt ()) {
          operand_48954->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1134)) ;
        }
        operand_48954 = enumerator_48954.nextObject () ;
        _foreach_loop_48954 = ((operand_48954 != NULL)) ;
        if (_foreach_loop_48954) {
        }
      }while (_foreach_loop_48954) ;
      var_cas_outString.appendCString ("/* End PBXFileReference section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXFrameworksBuildPhase_list::cEnumerator enumerator_49244 (var_cas_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), true) ;
    const GGS_Xcode_PBXFrameworksBuildPhase_list::cElement * operand_49244 = enumerator_49244.nextObject () ;
    if ((operand_49244 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXFrameworksBuildPhase section */\n") ;
      bool _foreach_loop_49244 ;
      do{
        macroValidPointer (operand_49244) ;
        if (operand_49244->mBuildPhase.isBuilt ()) {
          operand_49244->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1140)) ;
        }
        operand_49244 = enumerator_49244.nextObject () ;
        _foreach_loop_49244 = ((operand_49244 != NULL)) ;
        if (_foreach_loop_49244) {
        }
      }while (_foreach_loop_49244) ;
  ...
  {
    GGS_Xcode_PBXGroup_list::cEnumerator enumerator_49592 (var_cas_inXcodeProjectDescription.reader_mProjectGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)), true) ;
    const GGS_Xcode_PBXGroup_list::cElement * operand_49592 = NULL ;
    while (((operand_49592 = enumerator_49592.nextObject ()))) {
      macroValidPointer (operand_49592) ;
      var_cas_outString.appendCString ("\t\t") ;
      var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_49592->mGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1146)) COMMA_SOURCE_FILE_AT_LINE (1146))) ;
      const GGS_bool cond_49822 = (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1147))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_49822.isBuiltAndTrue ()) {
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1148))) ;
        var_cas_outString.appendCString (" */") ;
      }
      var_cas_outString.appendCString (" = {\n"
      "\t\t\tisa = PBXGroup;\n"
      "\t\t\tchildren = (\n") ;
      {
        GGS_XcodeObjectReferenceList::cEnumerator enumerator_49930 (operand_49592->mGroup.reader_mChildrenGroupList (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)), true) ;
        const GGS_XcodeObjectReferenceList::cElement * operand_49930 = NULL ;
        while (((operand_49930 = enumerator_49930.nextObject ()))) {
          macroValidPointer (operand_49930) ;
          var_cas_outString.appendCString ("\t\t\t\t") ;
          var_cas_outString.dotAssign_operation (operand_49930->mRefString) ;
          var_cas_outString.appendCString (" /* ") ;
          var_cas_outString.dotAssign_operation (operand_49930->mComment) ;
          var_cas_outString.appendCString (" */,\n") ;
        }
      }
      var_cas_outString.appendCString ("\t\t\t);\n") ;
      const GGS_bool cond_50381 = (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50381.isBuiltAndTrue ()) {
        const GGS_bool cond_50289 = (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1158)).reader_componentsSeparatedByString (GGS_string (" ")).reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_50289.isBuiltAndTrue ()) {
          var_cas_outString.appendCString ("\t\t\tname = \"") ;
          var_cas_outString.dotAssign_operation (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1159))) ;
          var_cas_outString.appendCString ("\";\n") ;
        }else if (cond_50289.isBuiltAndFalse ()) {
          var_cas_outString.appendCString ("\t\t\tname = ") ;
          var_cas_outString.dotAssign_operation (operand_49592->mGroup.reader_mGroupName (inLexique COMMA_SOURCE_FILE_AT_LINE (1161))) ;
          var_cas_outString.appendCString (";\n") ;
        }
      }
      const GGS_bool cond_50503 = (operand_49592->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1164))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_50503.isBuiltAndTrue ()) {
        var_cas_outString.appendCString ("\t\t\tpath = \"") ;
        var_cas_outString.dotAssign_operation (operand_49592->mGroup.reader_mGroupPath (inLexique COMMA_SOURCE_FILE_AT_LINE (1165))) ;
        var_cas_outString.appendCString ("\";\n") ;
      }
      var_cas_outString.appendCString ("\t\t\tsourceTree = \"<group>\";\n"
      "\t\t};\n") ;
  ...
  var_cas_outString.appendCString ("/* End PBXGroup section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_50687 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1172)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_50687 = enumerator_50687.nextObject () ;
    if ((operand_50687 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXNativeTarget section */\n") ;
      bool _foreach_loop_50687 ;
      do{
        macroValidPointer (operand_50687) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_50687->mTargetKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_50687->mTargetName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXNativeTarget;\n"
        "\t\t\tbuildConfigurationList = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_50687->mTargetConfiguration.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1177)) COMMA_SOURCE_FILE_AT_LINE (1177))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXNativeTarget \"") ;
        var_cas_outString.dotAssign_operation (operand_50687->mTargetName) ;
        var_cas_outString.appendCString ("\" */;\n"
        "\t\t\tbuildPhases = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51163 (operand_50687->mBuildPhaseKeyList, true) ;
          const GGS_stringlist::cElement * operand_51163 = NULL ;
          while (((operand_51163 = enumerator_51163.nextObject ()))) {
            macroValidPointer (operand_51163) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51163->mValue) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        GGS_string var_cas_productExtension ;
        if (operand_50687->mProduct.isBuilt ()) {
          operand_50687->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1182)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
        "\t\t\tdependencies = (\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_51460 (operand_50687->mDependencyKeyList, true) ;
          const GGS_stringlist::cElement * operand_51460 = NULL ;
          while (((operand_51460 = enumerator_51460.nextObject ()))) {
            macroValidPointer (operand_51460) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_51460->mValue) ;
            var_cas_outString.appendCString (" /*  */,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        ...
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductInstallPath = \"") ;
        var_cas_outString.dotAssign_operation (operand_50687->mProductInstallPath) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductName = \"") ;
        var_cas_outString.dotAssign_operation (operand_50687->mProductName) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t\tproductReference = ") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_50687->mProduct.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1194)) COMMA_SOURCE_FILE_AT_LINE (1194))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t\tproductType = \"com.apple.product-type.") ;
        var_cas_outString.dotAssign_operation (var_cas_productExtension) ;
        var_cas_outString.appendCString ("\";\n"
        "\t\t};\n") ;
        operand_50687 = enumerator_50687.nextObject () ;
        _foreach_loop_50687 = ((operand_50687 != NULL)) ;
        if (_foreach_loop_50687) {
        }
      }while (_foreach_loop_50687) ;
  ...
  "\t\t\ttargets = (\n") ;
  {
    GGS_Xcode_PBXNativeTarget_list::cEnumerator enumerator_52597 (var_cas_inXcodeProjectDescription.reader_mTargetList (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)), true) ;
    const GGS_Xcode_PBXNativeTarget_list::cElement * operand_52597 = NULL ;
    while (((operand_52597 = enumerator_52597.nextObject ()))) {
      macroValidPointer (operand_52597) ;
      var_cas_outString.appendCString ("\t\t\t\t") ;
      var_cas_outString.dotAssign_operation (operand_52597->mTargetKey) ;
      var_cas_outString.appendCString (" /* ") ;
      var_cas_outString.dotAssign_operation (operand_52597->mTargetName) ;
      var_cas_outString.appendCString (" */,\n") ;
    }
  }
  var_cas_outString.appendCString ("\t\t\t);\n"
  ...
  "/* End PBXProject section */\n"
    "\n") ;
  {
    GGS_Xcode_PBXResourcesBuildPhase_list::cEnumerator enumerator_52863 (var_cas_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1219)), true) ;
    const GGS_Xcode_PBXResourcesBuildPhase_list::cElement * operand_52863 = enumerator_52863.nextObject () ;
    if ((operand_52863 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXResourcesBuildPhase section */\n") ;
      bool _foreach_loop_52863 ;
      do{
        macroValidPointer (operand_52863) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_52863->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1222)) COMMA_SOURCE_FILE_AT_LINE (1222))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_52863->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1223))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXResourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_53269 (operand_52863->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1227)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_53269 = NULL ;
          while (((operand_53269 = enumerator_53269.nextObject ()))) {
            macroValidPointer (operand_53269) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53269->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1228)) COMMA_SOURCE_FILE_AT_LINE (1228))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_52863 = enumerator_52863.nextObject () ;
        _foreach_loop_52863 = ((operand_52863 != NULL)) ;
        if (_foreach_loop_52863) {
        }
      }while (_foreach_loop_52863) ;
      var_cas_outString.appendCString ("/* End PBXResourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXSourcesBuildPhase_list::cEnumerator enumerator_53650 (var_cas_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1236)), true) ;
    const GGS_Xcode_PBXSourcesBuildPhase_list::cElement * operand_53650 = enumerator_53650.nextObject () ;
    if ((operand_53650 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXSourcesBuildPhase section */\n") ;
      bool _foreach_loop_53650 ;
      do{
        macroValidPointer (operand_53650) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_53650->mBuildPhase.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)) COMMA_SOURCE_FILE_AT_LINE (1239))) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_53650->mBuildPhase.reader_mNameForComment (inLexique COMMA_SOURCE_FILE_AT_LINE (1240))) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXSourcesBuildPhase;\n"
        "\t\t\tbuildActionMask = 2147483647;\n"
        "\t\t\tfiles = (\n") ;
        {
          GGS_Xcode_PBXBuildFile_list::cEnumerator enumerator_54050 (operand_53650->mBuildPhase.reader_mFileReferenceList (inLexique COMMA_SOURCE_FILE_AT_LINE (1244)), true) ;
          const GGS_Xcode_PBXBuildFile_list::cElement * operand_54050 = NULL ;
          while (((operand_54050 = enumerator_54050.nextObject ()))) {
            macroValidPointer (operand_54050) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_54050->mFile.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1245))) ;
            var_cas_outString.appendCString (" ,\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\trunOnlyForDeploymentPostprocessing = 0;\n"
        "\t\t};\n") ;
        operand_53650 = enumerator_53650.nextObject () ;
        _foreach_loop_53650 = ((operand_53650 != NULL)) ;
        if (_foreach_loop_53650) {
        }
      }while (_foreach_loop_53650) ;
      var_cas_outString.appendCString ("/* End PBXSourcesBuildPhase section */\n") ;
    }
  }
  {
    GGS_Xcode_targetDependencyDescription_list::cEnumerator enumerator_54428 (var_cas_inXcodeProjectDescription.reader_mDependencyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)), true) ;
    const GGS_Xcode_targetDependencyDescription_list::cElement * operand_54428 = enumerator_54428.nextObject () ;
    if ((operand_54428 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXTargetDependency section */\n") ;
      bool _foreach_loop_54428 ;
      do{
        macroValidPointer (operand_54428) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_54428->mDependency.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1256)) COMMA_SOURCE_FILE_AT_LINE (1256))) ;
        var_cas_outString.appendCString (" /* PBXTargetDependency */ = {\n"
        "\t\t\tisa = PBXTargetDependency;\n"
        "\t\t\ttarget = ") ;
        var_cas_outString.dotAssign_operation (operand_54428->mDependency.reader_mDependencyTarget (inLexique COMMA_SOURCE_FILE_AT_LINE (1259))) ;
        var_cas_outString.appendCString (" ;\n"
        "\t\t};\n") ;
        operand_54428 = enumerator_54428.nextObject () ;
        _foreach_loop_54428 = ((operand_54428 != NULL)) ;
        if (_foreach_loop_54428) {
        }
      }while (_foreach_loop_54428) ;
      var_cas_outString.appendCString ("/* End PBXTargetDependency section */\n") ;
    }
  }
  {
    GGS_Xcode_PBXVariantGroup_list::cEnumerator enumerator_54917 (var_cas_inXcodeProjectDescription.reader_mPBXVariantGroup_list (inLexique COMMA_SOURCE_FILE_AT_LINE (1264)), true) ;
    const GGS_Xcode_PBXVariantGroup_list::cElement * operand_54917 = enumerator_54917.nextObject () ;
    if ((operand_54917 != NULL)) {
      var_cas_outString.appendCString ("/* Begin PBXVariantGroup section */\n") ;
      bool _foreach_loop_54917 ;
      do{
        macroValidPointer (operand_54917) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54917->mPBXVariantKey) ;
        var_cas_outString.appendCString (" /* ") ;
        var_cas_outString.dotAssign_operation (operand_54917->mName) ;
        var_cas_outString.appendCString (" */ = {\n"
        "\t\t\tisa = PBXVariantGroup;\n"
        "\t\t\tchildren = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (operand_54917->mPBXFileReferenceKey) ;
        var_cas_outString.appendCString (" ,\n"
        "\t\t\t);\n"
        "\t\t\tname = ") ;
        var_cas_outString.dotAssign_operation (operand_54917->mName) ;
        ...
        "\t\t\tsourceTree = \"<group>\";\n"
        "\t\t};\n") ;
        operand_54917 = enumerator_54917.nextObject () ;
        _foreach_loop_54917 = ((operand_54917 != NULL)) ;
        if (_foreach_loop_54917) {
        }
      }while (_foreach_loop_54917) ;
      var_cas_outString.appendCString ("/* End PBXVariantGroup section */\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_55468 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1279)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_55468 = enumerator_55468.nextObject () ;
    if ((operand_55468 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCBuildConfiguration section */\n") ;
      bool _foreach_loop_55468 ;
      do{
        macroValidPointer (operand_55468) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_55468->mBuildConfig.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1282))) ;
        var_cas_outString.appendCString (" /* Default */ = {\n"
        "\t\t\tisa = XCBuildConfiguration;\n"
        "\t\t\tbuildSettings = {\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_55795 (operand_55468->mBuildConfig.reader_mSettings (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), true) ;
          const GGS_stringlist::cElement * operand_55795 = NULL ;
          while (((operand_55795 = enumerator_55795.nextObject ()))) {
            macroValidPointer (operand_55795) ;
            var_cas_outString.appendCString ("\t\t\t\t") ;
            var_cas_outString.dotAssign_operation (operand_55795->mValue) ;
            var_cas_outString.appendCString ("\n") ;
          }
        }
        var_cas_outString.appendCString ("\t\t\t};\n"
        "\t\t\tname = Default;\n"
        "\t\t};\n") ;
        operand_55468 = enumerator_55468.nextObject () ;
        _foreach_loop_55468 = ((operand_55468 != NULL)) ;
        if (_foreach_loop_55468) {
        }
      }while (_foreach_loop_55468) ;
      var_cas_outString.appendCString ("/* End XCBuildConfiguration section */\n"
        "\n") ;
    }
  }
  {
    GGS_Xcode_XCBuildConfiguration_list::cEnumerator enumerator_56098 (var_cas_inXcodeProjectDescription.reader_mBuildConfigurationList (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)), true) ;
    const GGS_Xcode_XCBuildConfiguration_list::cElement * operand_56098 = enumerator_56098.nextObject () ;
    if ((operand_56098 != NULL)) {
      var_cas_outString.appendCString ("/* Begin XCConfigurationList section */\n") ;
      bool _foreach_loop_56098 ;
      do{
        macroValidPointer (operand_56098) ;
        var_cas_outString.appendCString ("\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_56098->mBuildConfig.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)) COMMA_SOURCE_FILE_AT_LINE (1297))) ;
        var_cas_outString.appendCString (" /* Build configuration list for PBXProject \"") ;
        var_cas_outString.dotAssign_operation (var_cas_inProjectName) ;
        var_cas_outString.appendCString ("\" */ = {\n"
        ...
        "\t\t\tbuildConfigurations = (\n"
        "\t\t\t\t") ;
        var_cas_outString.dotAssign_operation (function_getPBXFileReferenceKey (inLexique, operand_56098->mBuildConfig.reader_mSequenceNumber1 (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1301))) ;
        var_cas_outString.appendCString (" /* Default */,\n"
        "\t\t\t);\n"
        "\t\t\tdefaultConfigurationIsVisible = 0;\n"
        "\t\t\tdefaultConfigurationName = Default;\n"
        "\t\t};\n") ;
        operand_56098 = enumerator_56098.nextObject () ;
        _foreach_loop_56098 = ((operand_56098 != NULL)) ;
        if (_foreach_loop_56098) {
        }
      }while (_foreach_loop_56098) ;
...
void routine_generateXCodeFile (C_CompilerEx & inLexique,
  ...
  GGS_Xcode_XCBuildConfiguration  var_cas_defaultProjectConfiguration = GGS_Xcode_XCBuildConfiguration ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1325)), var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1326)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1326)), var_cas_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1324)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1329)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)) ;
  var_cas_ioXcodeProjectDescription.mBuildConfigurationList.addAssign_operation (var_cas_defaultProjectConfiguration) ;
  ::routine_enter_group (inLexique,  var_cas_ioXcodeProjectDescription,  GGS_string ("Products"),  GGS_string (""),  var_cas_ioXcodeProjectDescription.reader_mProductGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1337)) COMMA_SOURCE_FILE_AT_LINE (1333)) ;
  GGS_Xcode_PBXGroup  var_cas_mainGroup = GGS_Xcode_PBXGroup ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)), GGS_string (""), GGS_string (""), var_cas_ioXcodeProjectDescription.reader_mMainGroupChildrenList (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
  var_cas_ioXcodeProjectDescription.mSequenceNumber.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)) ;
  ...
  ::routine_buildXcodeProjectString (inLexique,  var_cas_ioXcodeProjectDescription,  var_cas_projectName,  function_getPBXFileReferenceKey (inLexique, var_cas_mainGroup.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1348)),  function_getPBXFileReferenceKey (inLexique, var_cas_defaultProjectConfiguration.reader_mSequenceNumber2 (inLexique COMMA_SOURCE_FILE_AT_LINE (1349)) COMMA_SOURCE_FILE_AT_LINE (1349)),  var_cas_fileNewContents COMMA_SOURCE_FILE_AT_LINE (1345)) ;
  const GGS_bool cond_59271 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1352))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_59271.isBuiltAndTrue ()) {
    if (var_cas_in_xcodeproj_filePath.isBuilt ()) {
      var_cas_in_xcodeproj_filePath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    }
    GGS_bool var_cas_written ;
    if (var_cas_fileNewContents.isBuilt ()) {
      var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    }
    const GGS_string var_cas_pbxprojFilePath = (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")) ;
    const GGS_bool cond_59260 = (var_cas_written).operator_or ((var_cas_pbxprojFilePath.reader_fileExists ()).operator_not ()) ;
    if (cond_59260.isBuiltAndTrue ()) {
      GGS_bool automatic_var_58902_0 ;
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_pbxprojFilePath, automatic_var_58902_0 COMMA_SOURCE_FILE_AT_LINE (1360)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_59121 (var_cas_pbxuser_files, true) ;
        const GGS_stringlist::cElement * operand_59121 = NULL ;
        while (((operand_59121 = enumerator_59121.nextObject ()))) {
          macroValidPointer (operand_59121) ;
          GGS_string var_cas_fullPath = ((var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/"))).operator_concat (operand_59121->mValue) ;
          GGS_string::class_method_deleteFile (inLexique, var_cas_fullPath COMMA_SOURCE_FILE_AT_LINE (1365)) ;
        }
      }
    }
  }
