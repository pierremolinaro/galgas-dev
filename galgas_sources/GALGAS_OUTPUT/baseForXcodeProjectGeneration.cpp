...
void cCollectionElement_Xcode_5F_PBXCopyBuildPhase_5F_list::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mBuildPhase" ":" ;
  mObject.mAttribute_mBuildPhase.description (ioString, inIndentation) ;
...
void GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::modifier_prependValue (GALGAS_Xcode_5F_PBXCopyBuildPhase inOperand0
                                                                       COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_Xcode_5F_PBXCopyBuildPhase_5F_list (inOperand0 COMMA_THERE)) ;
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_Xcode_5F_PBXCopyBuildPhase_5F_list) ;
  return p->mObject ;
}
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "Xcode_PBXCopyBuildPhase_list", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void routine_initXcodeProjectDescription (GALGAS_XcodeProjectDescription & outArgument_outDescription,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDescription = GALGAS_XcodeProjectDescription::constructor_new (GALGAS_Xcode_5F_PBXFileReference_5F_map::constructor_emptyMap (SOURCE_FILE_AT_LINE (506)), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (507)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (508)), GALGAS_Xcode_5F_PBXGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (509)), GALGAS_Xcode_5F_PBXNativeTarget_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (510)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (511)), GALGAS_Xcode_5F_XCBuildConfiguration_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (512)), GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (513)), GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (514)), GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (515)), GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (516)), GALGAS_Xcode_5F_targetDependencyDescription_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (517)), GALGAS_Xcode_5F_PBXVariantGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (518)), GALGAS_uint ((PMUInt32) 0U) COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
...
void routine_enter_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (536)), constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (535)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (542)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (543)), inCompiler COMMA_SOURCE_FILE_AT_LINE (543)), constinArgument_inGroupName COMMA_SOURCE_FILE_AT_LINE (543)) ;
}
...
void routine_enter_5F_subgroup (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (560)), constinArgument_inSubGroupName, constinArgument_inSubGroupPath, constinArgument_inSubGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (559)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (566)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (567)), inCompiler COMMA_SOURCE_FILE_AT_LINE (567)), constinArgument_inSubGroupName COMMA_SOURCE_FILE_AT_LINE (567)) ;
}
...
void routine_append_5F_cpp_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                          ...
                                          COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".cpp") COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
}
...
void routine_append_5F_m_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                        ...
                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_SOURCE_FILE_AT_LINE (581)) ;
}
...
void routine_append_5F_mm_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                         ...
                                         COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".mm") COMMA_SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)) ;
}
...
void routine_enter_5F_cpp_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (598)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (599)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (599)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (602)), inCompiler COMMA_SOURCE_FILE_AT_LINE (602)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (602)) ;
}
...
void routine_enter_5F_h_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (612)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (613)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (613)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (615)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (616)), inCompiler COMMA_SOURCE_FILE_AT_LINE (616)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (616)) ;
}
...
void routine_enter_5F_pch_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (626)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (627)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (627)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (630)), inCompiler COMMA_SOURCE_FILE_AT_LINE (630)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (630)) ;
}
...
void routine_enter_5F_m_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (640)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (641)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (641)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (643)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (644)), inCompiler COMMA_SOURCE_FILE_AT_LINE (644)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (644)) ;
}
...
void routine_enter_5F_mm_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                 ...
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (654)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (655)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (655)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (656)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (657)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (658)), inCompiler COMMA_SOURCE_FILE_AT_LINE (658)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (658)) ;
}
...
void routine_enter_5F_gif_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (668)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_gifFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_gifFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (669)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (669)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (672)), inCompiler COMMA_SOURCE_FILE_AT_LINE (672)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (672)) ;
}
...
void routine_enter_5F_tiff_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (682)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (683)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (683)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (684)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (686)), inCompiler COMMA_SOURCE_FILE_AT_LINE (686)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (686)) ;
}
...
void routine_enter_5F_png_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (696)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_pngFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pngFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (697)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (697)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (698)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (699)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (700)), inCompiler COMMA_SOURCE_FILE_AT_LINE (700)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (700)) ;
}
...
void routine_enter_5F_plist_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                    ...
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (710)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_plistFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (711)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (711)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (713)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (714)), inCompiler COMMA_SOURCE_FILE_AT_LINE (714)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (714)) ;
}
...
void routine_enter_5F_framework_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (724)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (725)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (725)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (726)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (727)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (728)), inCompiler COMMA_SOURCE_FILE_AT_LINE (728)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (728)) ;
}
...
void routine_enter_5F_icns_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (738)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (739)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (739)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (741)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (742)), inCompiler COMMA_SOURCE_FILE_AT_LINE (742)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (742)) ;
}
...
void routine_enter_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_string var_extension = constinArgument_inFileName.reader_pathExtension (SOURCE_FILE_AT_LINE (752)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    routine_enter_5F_cpp_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (754)) ;
    } //-------- @routineCallInstructionForGeneration
    ...
    if (kBoolTrue == test_1) {
      { //-------- @routineCallInstructionForGeneration
      routine_enter_5F_h_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (756)) ;
      } //-------- @routineCallInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        { //-------- @routineCallInstructionForGeneration
        routine_enter_5F_pch_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (758)) ;
        } //-------- @routineCallInstructionForGeneration
        ...
        if (kBoolTrue == test_3) {
          { //-------- @routineCallInstructionForGeneration
          routine_enter_5F_m_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (760)) ;
          } //-------- @routineCallInstructionForGeneration
          ...
          if (kBoolTrue == test_4) {
            { //-------- @routineCallInstructionForGeneration
            routine_enter_5F_mm_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
            } //-------- @routineCallInstructionForGeneration
            ...
            if (kBoolTrue == test_5) {
              { //-------- @routineCallInstructionForGeneration
              routine_enter_5F_tiff_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
              } //-------- @routineCallInstructionForGeneration
              ...
              if (kBoolTrue == test_6) {
                { //-------- @routineCallInstructionForGeneration
                routine_enter_5F_gif_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (766)) ;
                } //-------- @routineCallInstructionForGeneration
                ...
                if (kBoolTrue == test_7) {
                  { //-------- @routineCallInstructionForGeneration
                  routine_enter_5F_png_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (768)) ;
                  } //-------- @routineCallInstructionForGeneration
                  ...
                  if (kBoolTrue == test_8) {
                    { //-------- @routineCallInstructionForGeneration
                    routine_enter_5F_xib_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("."), constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (770)) ;
                    } //-------- @routineCallInstructionForGeneration
                    ...
                    if (kBoolTrue == test_9) {
                      { //-------- @routineCallInstructionForGeneration
                      routine_enter_5F_plist_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (772)) ;
                      } //-------- @routineCallInstructionForGeneration
                      ...
                      if (kBoolTrue == test_10) {
                        { //-------- @routineCallInstructionForGeneration
                        routine_enter_5F_framework_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (774)) ;
                        } //-------- @routineCallInstructionForGeneration
                        ...
                        if (kBoolTrue == test_11) {
                          { //-------- @routineCallInstructionForGeneration
                          routine_enter_5F_icns_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (776)) ;
                          } //-------- @routineCallInstructionForGeneration
                        }else if (kBoolFalse == test_11) {
                          //-------- @errorInstructionForGeneration
                          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("cannot enter '").operator_concat (constinArgument_inFileName COMMA_SOURCE_FILE_AT_LINE (778)).operator_concat (GALGAS_string ("' file : unknown extension") COMMA_SOURCE_FILE_AT_LINE (778)) COMMA_SOURCE_FILE_AT_LINE (778)) ;
                        }
                      }
                    }
                  }
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  cEnumerator_stringlist enumerator_34331 (constinArgument_inFileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34331.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34331.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (790)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_34331.gotoNextObject () ;
  }
}
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_xibFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_xibFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (803)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (804)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (805)).operator_concat (constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (802)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (807)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_xib_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (808)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (809)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (810)).reader_string (SOURCE_FILE_AT_LINE (810)).reader_md_35_ (SOURCE_FILE_AT_LINE (810)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (810)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (814)), inCompiler COMMA_SOURCE_FILE_AT_LINE (814)), constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (812)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (817)) ;
}
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                       ...
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (829)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (830)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (828)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_plist_5F_string_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (834)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (836)).reader_string (SOURCE_FILE_AT_LINE (836)).reader_md_35_ (SOURCE_FILE_AT_LINE (836)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (836)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (840)), inCompiler COMMA_SOURCE_FILE_AT_LINE (840)), constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (838)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (843)) ;
}
...
void routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (853)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
  //-------- @methodCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (855)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (855)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (856)), var_ref COMMA_SOURCE_FILE_AT_LINE (856)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (858)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (859)) ;
}
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_37501 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37501.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37501.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (870)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_37501.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_37937 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37937.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37937.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (886)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (888)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (889)), var_ref COMMA_SOURCE_FILE_AT_LINE (889)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (890)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (891)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (892)) ;
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_38675 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38675.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38675.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (904)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (906)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (906)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (907)), var_ref COMMA_SOURCE_FILE_AT_LINE (907)) ;
    //-------- @incrementInstructionForGeneration
    ...
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (909)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (910)) ;
    enumerator_38675.gotoNextObject () ;
  }
}
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (927)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (927)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (929)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (930)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (932)), inCompiler COMMA_SOURCE_FILE_AT_LINE (932)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (932)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (935)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (934)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_listWithValue (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (940)), inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) COMMA_SOURCE_FILE_AT_LINE (940)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (942)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (944)), GALGAS_string ("Frameworks"), constinArgument_inFrameworkKeyList COMMA_SOURCE_FILE_AT_LINE (943)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (948)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (949)) ;
    //-------- @plusEqualnstructionForGeneration
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (950)), inCompiler COMMA_SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (953)) ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (955)) ;
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (956)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (956)) COMMA_SOURCE_FILE_AT_LINE (956)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (958)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (958)) COMMA_SOURCE_FILE_AT_LINE (958)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (960)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (961)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (961)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (959)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (964)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (966)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (967)).reader_string (SOURCE_FILE_AT_LINE (967)).reader_md_35_ (SOURCE_FILE_AT_LINE (967)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (967)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (968)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mTargetList.addAssign_operation (outArgument_outTargetKey, constinArgument_inTargetName, var_toolTargetBuildConfiguration, GALGAS_string ("$(HOME)/bin"), constinArgument_inProductFileName, var_toolFileReference, var_buildPhases, constinArgument_inDirectDependencyList COMMA_SOURCE_FILE_AT_LINE (969)) ;
}
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  outArgument_outTargetKey.drop () ; // Release 'out' argument
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (997)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFileReference_5F_Application var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_Application::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (999)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (999)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (1002)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1004)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1004)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (1004)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXResourcesBuildPhase var_resourcesBuildPhase = GALGAS_Xcode_5F_PBXResourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1007)), GALGAS_string ("Resources"), constinArgument_inResourcesToCompileList COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1011)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXResourcesBuildPhase_5F_list.addAssign_operation (var_resourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_resourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1013)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) COMMA_SOURCE_FILE_AT_LINE (1013)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1016)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1022)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) COMMA_SOURCE_FILE_AT_LINE (1022)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1025)), GALGAS_string ("Frameworks"), constinArgument_inFrameworksToCompileList COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (1030)) ;
  //-------- @plusEqualnstructionForGeneration
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1031)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1031)) COMMA_SOURCE_FILE_AT_LINE (1031)) ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    //-------- @methodCallInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1035)).method_searchKey (constinArgument_inFileToCopyInWrapperLaunchServices.reader_nowhere (SOURCE_FILE_AT_LINE (1035)), var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1037)), var_ref COMMA_SOURCE_FILE_AT_LINE (1037)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1038)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1039)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_PBXCopyBuildPhase var_copyBuildPhase = GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1041)), GALGAS_string::makeEmptyString (), GALGAS_uint ((PMUInt32) 1U), GALGAS_string ("Contents/Library/LaunchServices"), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_listWithValue (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1045)) COMMA_SOURCE_FILE_AT_LINE (1040)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1047)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXCopyBuildPhase_5F_list.addAssign_operation (var_copyBuildPhase COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    //-------- @plusEqualnstructionForGeneration
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_copyBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1049)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1049)) COMMA_SOURCE_FILE_AT_LINE (1049)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inPrecompiledHeaderPath.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (1054)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)) ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @plusEqualnstructionForGeneration
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("INFOPLIST_FILE = \"").operator_concat (constinArgument_inInfoPListFile COMMA_SOURCE_FILE_AT_LINE (1057)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1057)) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = NO;") COMMA_SOURCE_FILE_AT_LINE (1059)) ;
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PROTOTYPE_CONVERSION = NO;\n") COMMA_SOURCE_FILE_AT_LINE (1060)) ;
  //-------- @plusEqualnstructionForGeneration
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (1061)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1061)) COMMA_SOURCE_FILE_AT_LINE (1061)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_targetDependencyKeyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1063)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_46054 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46054.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1065)), enumerator_46054.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
    //-------- @incrementInstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    //-------- @plusEqualnstructionForGeneration
    var_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_d.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1067)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioXcodeProjectDescription.mAttribute_mDependencyList.addAssign_operation (var_d COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    enumerator_46054.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1072)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1073)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1071)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1076)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1077)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (1078)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1079)).reader_string (SOURCE_FILE_AT_LINE (1079)).reader_md_35_ (SOURCE_FILE_AT_LINE (1079)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1079)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1080)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mTargetList.addAssign_operation (outArgument_outTargetKey, constinArgument_inTargetName, var_toolTargetBuildConfiguration, GALGAS_string ("$(HOME)/bin"), constinArgument_inProductFileName, var_toolFileReference, var_buildPhases, var_targetDependencyKeyList COMMA_SOURCE_FILE_AT_LINE (1081)) ;
}
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_47557 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47557.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47557.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1104)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1104)) COMMA_SOURCE_FILE_AT_LINE (1104)) ;
    enumerator_47557.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outProjectDefaultSettings = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1106)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ALWAYS_SEARCH_USER_PATHS = NO;") COMMA_SOURCE_FILE_AT_LINE (1107)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ARCHS = \"$(ARCHS_STANDARD_64_BIT)\";") COMMA_SOURCE_FILE_AT_LINE (1108)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inUsesARC.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_ENABLE_OBJC_ARC = YES;") COMMA_SOURCE_FILE_AT_LINE (1110)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @plusEqualnstructionForGeneration
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;") COMMA_SOURCE_FILE_AT_LINE (1112)) ;
  }
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;") COMMA_SOURCE_FILE_AT_LINE (1114)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1115)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;") COMMA_SOURCE_FILE_AT_LINE (1116)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1117)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_WARNINGS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1118)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_64_TO_32_BIT_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1119)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;") COMMA_SOURCE_FILE_AT_LINE (1120)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_NEWLINE = YES;") COMMA_SOURCE_FILE_AT_LINE (1121)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_PROTOTYPES = YES;") COMMA_SOURCE_FILE_AT_LINE (1122)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_RETURN_TYPE = YES;") COMMA_SOURCE_FILE_AT_LINE (1123)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_CHECK_SWITCH_STATEMENTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1124)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1125)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;") COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INHIBIT_ALL_WARNINGS = NO;") COMMA_SOURCE_FILE_AT_LINE (1127)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;") COMMA_SOURCE_FILE_AT_LINE (1128)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_MISSING_PARENTHESES = YES;") COMMA_SOURCE_FILE_AT_LINE (1129)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;") COMMA_SOURCE_FILE_AT_LINE (1130)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PEDANTIC = NO;") COMMA_SOURCE_FILE_AT_LINE (1131)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SHADOW = NO;") COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SIGN_COMPARE = YES;") COMMA_SOURCE_FILE_AT_LINE (1133)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;") COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNINITIALIZED_AUTOS = YES;") COMMA_SOURCE_FILE_AT_LINE (1135)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNKNOWN_PRAGMAS = YES;") COMMA_SOURCE_FILE_AT_LINE (1136)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_FUNCTION = YES;") COMMA_SOURCE_FILE_AT_LINE (1137)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_LABEL = YES;") COMMA_SOURCE_FILE_AT_LINE (1138)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = YES;") COMMA_SOURCE_FILE_AT_LINE (1139)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VALUE = YES;") COMMA_SOURCE_FILE_AT_LINE (1140)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VARIABLE = YES;") COMMA_SOURCE_FILE_AT_LINE (1141)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("HEADER_SEARCH_PATHS = (\n").operator_concat (var_pathString COMMA_SOURCE_FILE_AT_LINE (1142)).operator_concat (GALGAS_string ("\t\t\t\t);") COMMA_SOURCE_FILE_AT_LINE (1142)) COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("SDKROOT = ").operator_concat (constinArgument_inSDK COMMA_SOURCE_FILE_AT_LINE (1143)).operator_concat (GALGAS_string (" ;") COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
}
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1155)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1155)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n") COMMA_SOURCE_FILE_AT_LINE (1158)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1159)).operator_concat (GALGAS_string ("\tclasses = {\n") COMMA_SOURCE_FILE_AT_LINE (1160)).operator_concat (GALGAS_string ("\t};\n") COMMA_SOURCE_FILE_AT_LINE (1161)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n") COMMA_SOURCE_FILE_AT_LINE (1162)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1163)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50813 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1165)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_50813.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    while (enumerator_50813.hasCurrentObject () && bool_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50813.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_50813.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51081 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1171)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_1 = true ;
  if (enumerator_51081.hasCurrentObject () && bool_1) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    while (enumerator_51081.hasCurrentObject () && bool_1) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51081.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_51081.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1174)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51383 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1177)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_2 = true ;
  if (enumerator_51383.hasCurrentObject () && bool_2) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_51383.hasCurrentObject () && bool_2) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51383.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_51383.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51713 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1184)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51713.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51713.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1185)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1190)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_XcodeObjectReferenceList enumerator_52033 (enumerator_51713.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1192)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52033.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52033.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (enumerator_52033.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      enumerator_52033.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1197)).reader_length (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51713.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51713.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51713.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1207)) COMMA_SOURCE_FILE_AT_LINE (1206)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52808 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1211)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_7 = true ;
  if (enumerator_52808.hasCurrentObject () && bool_7) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    while (enumerator_52808.hasCurrentObject () && bool_7) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52808.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (enumerator_52808.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (function_getPBXFileReferenceKey (enumerator_52808.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1216)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (enumerator_52808.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1217)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_53240 (enumerator_52808.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_53240.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53240.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
        enumerator_53240.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_productExtension ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52808.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1221)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1223)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1224)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1222)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_53537 (enumerator_52808.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_53537.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53537.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1227)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        enumerator_53537.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (enumerator_52808.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (enumerator_52808.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (enumerator_52808.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (function_getPBXFileReferenceKey (enumerator_52808.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1233)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
      enumerator_52808.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1237)) ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1243)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1245)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1246)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1247)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1250)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54712 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1251)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_54712.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54712.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (enumerator_54712.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
    enumerator_54712.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1256)) COMMA_SOURCE_FILE_AT_LINE (1254)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55001 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1258)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_8 = true ;
  if (enumerator_55001.hasCurrentObject () && bool_8) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_55001.hasCurrentObject () && bool_8) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55001.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1261)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (enumerator_55001.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1265)) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55377 (enumerator_55001.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1266)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_55377.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55377.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)) ;
        enumerator_55377.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1271)) COMMA_SOURCE_FILE_AT_LINE (1269)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55786 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1275)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_9 = true ;
  if (enumerator_55786.hasCurrentObject () && bool_9) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    while (enumerator_55786.hasCurrentObject () && bool_9) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55786.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1278)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (enumerator_55786.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1281)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56158 (enumerator_55786.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1283)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_56158.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56158.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)) ;
      ...
      enumerator_55786.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1289)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56559 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1292)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_10 = true ;
  if (enumerator_56559.hasCurrentObject () && bool_10) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_56559.hasCurrentObject () && bool_10) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56559.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1295)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (enumerator_56559.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE_AT_LINE (1299)) COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (enumerator_56559.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE_AT_LINE (1300)).reader_string (SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57058 (enumerator_56559.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1302)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_57058.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57058.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)) ;
        enumerator_57058.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1306)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1307)) COMMA_SOURCE_FILE_AT_LINE (1305)) ;
      enumerator_56559.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57455 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1311)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_11 = true ;
  if (enumerator_57455.hasCurrentObject () && bool_11) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    while (enumerator_57455.hasCurrentObject () && bool_11) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57455.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1314)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1314)) COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1316)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (enumerator_57455.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1318)) COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_57950 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1322)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_12 = true ;
  if (enumerator_57950.hasCurrentObject () && bool_12) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1323)) ;
    while (enumerator_57950.hasCurrentObject () && bool_12) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_57950.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (enumerator_57950.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (enumerator_57950.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (enumerator_57950.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1325)) ;
      enumerator_57950.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58503 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1337)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_13 = true ;
  if (enumerator_58503.hasCurrentObject () && bool_13) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
    while (enumerator_58503.hasCurrentObject () && bool_13) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58503.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1340)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1341)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_58797 (enumerator_58503.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1343)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_58797.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58797.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1344)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
        enumerator_58797.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1347)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      enumerator_58503.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59133 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1352)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_14 = true ;
  if (enumerator_59133.hasCurrentObject () && bool_14) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    while (enumerator_59133.hasCurrentObject () && bool_14) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59133.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1355)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1355)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1358)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (function_getPBXFileReferenceKey (enumerator_59133.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1359)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1360)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1363)) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
  ...
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1369)) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_projectName = constinArgument_in_5F_xcodeproj_5F_filePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (1380)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (1380)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1383)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1384)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1384)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1382)) ;
  //-------- @incrementInstructionForGeneration
  ...
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1388)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_defaultProjectConfiguration COMMA_SOURCE_FILE_AT_LINE (1389)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enter_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("Products"), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mProductGroupChildrenList (SOURCE_FILE_AT_LINE (1395)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1391)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXGroup var_mainGroup = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1398)), GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mMainGroupChildrenList (SOURCE_FILE_AT_LINE (1398)) COMMA_SOURCE_FILE_AT_LINE (1398)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1399)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_mainGroup COMMA_SOURCE_FILE_AT_LINE (1400)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_string var_fileNewContents ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildXcodeProjectString (ioArgument_ioXcodeProjectDescription, var_projectName, function_getPBXFileReferenceKey (var_mainGroup.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1406)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1406)), function_getPBXFileReferenceKey (var_defaultProjectConfiguration.reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1407)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1407)), var_fileNewContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (1403)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1410)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_in_5F_xcodeproj_5F_filePath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_written ;
    //-------- @methodCallInstructionForGeneration
    var_fileNewContents.method_writeToFileWhenDifferentContents (constinArgument_inReferenceFilePath, var_written, inCompiler COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_pbxprojFilePath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/project.pbxproj") COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE_AT_LINE (1417)).operator_not (SOURCE_FILE_AT_LINE (1417)) COMMA_SOURCE_FILE_AT_LINE (1417)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_61877_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_61877_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_pbxuser_5F_files = constinArgument_in_5F_xcodeproj_5F_filePath.reader_regularFilesWithExtensions (GALGAS_bool (false), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("pbxuser") COMMA_SOURCE_FILE_AT_LINE (1420)) COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_62100 (var_pbxuser_5F_files, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_62100.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1422)).operator_concat (enumerator_62100.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
        } //-------- @routineCallInstructionForGeneration
        enumerator_62100.gotoNextObject () ;
      }
    }
  }
}
...
typeComparisonResult cPtr_Xcode_5F_PBXCopyBuildPhase::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_Xcode_5F_PBXCopyBuildPhase) ;
  if (kOperandEqual == result) {
    result = mAttribute_mSequenceNumber.objectCompare (p->mAttribute_mSequenceNumber) ;
  }
  if (kOperandEqual == result) {
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_Xcode_5F_PBXCopyBuildPhase) ;
}
...
GALGAS_Xcode_5F_PBXCopyBuildPhase GALGAS_Xcode_5F_PBXCopyBuildPhase::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_Xcode_5F_PBXCopyBuildPhase *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "Xcode_PBXCopyBuildPhase", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  //-------- @concatInstructionForGeneration
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string (" /* Frameworks */ = {\n") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string ("\t\t\tisa = PBXFrameworksBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (378)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (379)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (380)) COMMA_SOURCE_FILE_AT_LINE (377)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_17054 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17054.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17054.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (382)), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (enumerator_17054.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE_AT_LINE (383)).reader_mFileName (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (382)) ;
    enumerator_17054.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (386)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (387)) COMMA_SOURCE_FILE_AT_LINE (385)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "Xcode_PBXCopyBuildPhase_list.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
