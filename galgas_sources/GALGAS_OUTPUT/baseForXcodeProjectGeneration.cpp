...
void routine_enter_files_for_resources_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_34405 = enumerator_34405.nextObject ()))) {
      ...
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_34405->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
...
void routine_enter_files_for_frameworks_build_phase (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_35143 = enumerator_35143.nextObject ()))) {
      ...
      GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, operand_35143->mValue, GGS_location (inLexique) COMMA_HERE) ;
      GGS_Xcode_PBXFileReference_abstract  var_cas_ref ;
...
void routine_add_app_target (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_targetDependencyKeyList = GGS_stringlist ::constructor_emptyList () ;
  {
    ...
    while (((operand_43722 = enumerator_43722.nextObject ()))) {
      ...
      GGS_Xcode_targetDependencyDescription  var_cas_d = GGS_Xcode_targetDependencyDescription ::constructor_new (inLexique, var_cas_ioXcodeProjectDescription.reader_mSequenceNumber (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)), operand_43722->mValue COMMA_HERE) ;
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58871 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
