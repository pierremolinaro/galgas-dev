...
//                    november 29th, 2010, at 14h22'17"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (974)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  while (enumerator_51823.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_3 (GALGAS_bool (kIsNotEqual, enumerator_51823.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1203)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
    if (test_3.isValidAndTrue ()) {
      //-------- @appendInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_4 (GALGAS_bool (kIsNotEqual, enumerator_51823.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1213)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
    if (test_4.isValidAndTrue ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_5 (GALGAS_bool (kIsStrictSup, enumerator_51823.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1214)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1214)).reader_length (SOURCE_FILE_AT_LINE (1214)).objectCompare (GALGAS_uint ((PMUInt32) 1U)))) ;
      if (test_5.isValidAndTrue ()) {
        //-------- @appendInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, enumerator_51823.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1220)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
    if (test_6.isValidAndTrue ()) {
      //-------- @appendInstructionForGeneration
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (1408)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE_AT_LINE (1415)).operator_not (SOURCE_FILE_AT_LINE (1415)) COMMA_SOURCE_FILE_AT_LINE (1415))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @methodCallInstructionForGeneration
