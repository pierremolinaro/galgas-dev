...
GALGAS_string function_getPBXFileReferenceKey (const GALGAS_uint & constinArgument_inSequenceNumber,
  ...
  result_outResult = constinArgument_inSequenceNumber.reader_string (SOURCE_FILE_AT_LINE (37)).reader_md_35_ (SOURCE_FILE_AT_LINE (37)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (37)) ;
//---
...
void routine_initXcodeProjectDescription (GALGAS_XcodeProjectDescription & outArgument_outDescription,
  ...
  outArgument_outDescription = GALGAS_XcodeProjectDescription::constructor_new (GALGAS_Xcode_5F_PBXFileReference_5F_map::constructor_emptyMap (SOURCE_FILE_AT_LINE (505)), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (506)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (507)), GALGAS_Xcode_5F_PBXGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (508)), GALGAS_Xcode_5F_PBXNativeTarget_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (509)), GALGAS_XcodeObjectReferenceList::constructor_emptyList (SOURCE_FILE_AT_LINE (510)), GALGAS_Xcode_5F_XCBuildConfiguration_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (511)), GALGAS_Xcode_5F_PBXSourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (512)), GALGAS_Xcode_5F_PBXFrameworksBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (513)), GALGAS_Xcode_5F_PBXResourcesBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (514)), GALGAS_Xcode_5F_PBXCopyBuildPhase_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (515)), GALGAS_Xcode_5F_targetDependencyDescription_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (516)), GALGAS_Xcode_5F_PBXVariantGroup_5F_list::constructor_emptyList (SOURCE_FILE_AT_LINE (517)), GALGAS_uint ((PMUInt32) 0U) COMMA_SOURCE_FILE_AT_LINE (504)) ;
}
...
void routine_enter_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (535)), constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (534)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (540)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (541)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mMainGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (542)), inCompiler COMMA_SOURCE_FILE_AT_LINE (542)), constinArgument_inGroupName COMMA_SOURCE_FILE_AT_LINE (542)) ;
}
...
void routine_enter_5F_subgroup (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                C_Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXGroup var_group = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (559)), constinArgument_inSubGroupName, constinArgument_inSubGroupPath, constinArgument_inSubGroupContentsKeyList COMMA_SOURCE_FILE_AT_LINE (558)) ;
  ...
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_group COMMA_SOURCE_FILE_AT_LINE (565)) ;
  ioArgument_ioSuperGroupContentsKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_group.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (566)), inCompiler COMMA_SOURCE_FILE_AT_LINE (566)), constinArgument_inSubGroupName COMMA_SOURCE_FILE_AT_LINE (566)) ;
}
...
void routine_append_5F_cpp_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                          ...
                                          C_Compiler * /* inCompiler */
                                          COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".cpp") COMMA_SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) ;
}
...
void routine_append_5F_m_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                        ...
                                        C_Compiler * /* inCompiler */
                                        COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)) ;
}
...
void routine_append_5F_mm_5F_h_5F_files (GALGAS_stringlist & ioArgument_ioList,
                                         ...
                                         C_Compiler * /* inCompiler */
                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".mm") COMMA_SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)) ;
  ioArgument_ioList.addAssign_operation (inArgument_inBaseName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (587)) ;
}
...
void routine_enter_5F_cpp_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (597)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_cppSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (598)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (598)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (601)), inCompiler COMMA_SOURCE_FILE_AT_LINE (601)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (601)) ;
}
...
void routine_enter_5F_h_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (611)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_hSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (612)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (612)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (615)), inCompiler COMMA_SOURCE_FILE_AT_LINE (615)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (615)) ;
}
...
void routine_enter_5F_pch_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (625)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pchSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (626)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (626)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (629)), inCompiler COMMA_SOURCE_FILE_AT_LINE (629)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (629)) ;
}
...
void routine_enter_5F_m_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (639)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (640)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (640)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (643)), inCompiler COMMA_SOURCE_FILE_AT_LINE (643)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (643)) ;
}
...
void routine_enter_5F_mm_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (653)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_mmSourceFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (654)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (654)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (655)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (656)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (657)), inCompiler COMMA_SOURCE_FILE_AT_LINE (657)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (657)) ;
}
...
void routine_enter_5F_gif_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (667)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_gifFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_gifFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (668)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (668)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (671)), inCompiler COMMA_SOURCE_FILE_AT_LINE (671)), constinArgument_inFile COMMA_SOURCE_FILE_AT_LINE (671)) ;
}
...
void routine_enter_5F_tiff_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (681)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_tiffFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (682)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (682)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (684)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (685)), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (685)) ;
}
...
void routine_enter_5F_png_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (695)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_pngFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_pngFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (696)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (696)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (697)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (698)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (699)), inCompiler COMMA_SOURCE_FILE_AT_LINE (699)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (699)) ;
}
...
void routine_enter_5F_plist_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (709)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_plistFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (710)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (710)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (711)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (713)), inCompiler COMMA_SOURCE_FILE_AT_LINE (713)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (713)) ;
}
...
void routine_enter_5F_framework_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (723)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_frameworkFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (724)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (724)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (726)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (727)), inCompiler COMMA_SOURCE_FILE_AT_LINE (727)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (727)) ;
}
...
void routine_enter_5F_icns_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_inCppFile, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (737)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_icnsFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (738)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (738)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
  }
  ioArgument_ioFileListForGroup.addAssign_operation (function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (741)), inCompiler COMMA_SOURCE_FILE_AT_LINE (741)), constinArgument_inCppFile COMMA_SOURCE_FILE_AT_LINE (741)) ;
}
...
void routine_enter_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_extension = constinArgument_inFileName.reader_pathExtension (SOURCE_FILE_AT_LINE (751)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_enter_5F_cpp_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (753)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      routine_enter_5F_h_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) ;
      }
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("pch"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_enter_5F_pch_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (757)) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          routine_enter_5F_m_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
          }
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
            routine_enter_5F_mm_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) ;
            }
          }else if (kBoolFalse == test_4) {
            const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
              routine_enter_5F_tiff_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
              }
            }else if (kBoolFalse == test_5) {
              const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("gif"))).boolEnum () ;
              if (kBoolTrue == test_6) {
                {
                routine_enter_5F_gif_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (765)) ;
                }
              }else if (kBoolFalse == test_6) {
                const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("png"))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  {
                  routine_enter_5F_png_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (767)) ;
                  }
                }else if (kBoolFalse == test_7) {
                  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    {
                    routine_enter_5F_xib_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("."), constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (769)) ;
                    }
                  }else if (kBoolFalse == test_8) {
                    const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("plist"))).boolEnum () ;
                    if (kBoolTrue == test_9) {
                      {
                      routine_enter_5F_plist_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (771)) ;
                      }
                    }else if (kBoolFalse == test_9) {
                      const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
                      if (kBoolTrue == test_10) {
                        {
                        routine_enter_5F_framework_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (773)) ;
                        }
                      }else if (kBoolFalse == test_10) {
                        const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("icns"))).boolEnum () ;
                        if (kBoolTrue == test_11) {
                          {
                          routine_enter_5F_icns_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, constinArgument_inFileName, ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (775)) ;
                          }
                        }else if (kBoolFalse == test_11) {
                          inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("cannot enter '").operator_concat (constinArgument_inFileName COMMA_SOURCE_FILE_AT_LINE (777)).operator_concat (GALGAS_string ("' file : unknown extension") COMMA_SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) ;
                        }
                      }
                    }
                  }
...
void routine_enter_5F_files_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_34330 (constinArgument_inFileList, kEnumeration_up) ;
  while (enumerator_34330.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_in_5F_group (ioArgument_ioXcodeProjectDescription, enumerator_34330.current_mValue (HERE), ioArgument_ioFileListForGroup, inCompiler COMMA_SOURCE_FILE_AT_LINE (789)) ;
    }
    enumerator_34330.gotoNextObject () ;
  }
}
...
void routine_enter_5F_xib_5F_file_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXFileReference_5F_xibFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_xibFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (802)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (803)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (804)).operator_concat (constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (804)) COMMA_SOURCE_FILE_AT_LINE (801)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (806)) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_xib_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (807)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (808)) ;
  }
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (809)).reader_string (SOURCE_FILE_AT_LINE (809)).reader_md_35_ (SOURCE_FILE_AT_LINE (809)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (809)) ;
  ...
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (813)), inCompiler COMMA_SOURCE_FILE_AT_LINE (813)), constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (811)) ;
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_xib_5F_fileName COMMA_SOURCE_FILE_AT_LINE (816)) ;
}
...
void routine_enter_5F_plist_5F_strings_5F_in_5F_group (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile var_ref = GALGAS_Xcode_5F_PBXFileReference_5F_plistStringFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (828)), constinArgument_in_5F_lproj_5F_dir.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (829)), constinArgument_in_5F_lproj_5F_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (830)).operator_concat (constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (830)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_plist_5F_string_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (833)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
  }
  GALGAS_string var_PBXVariantGroupKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (835)).reader_string (SOURCE_FILE_AT_LINE (835)).reader_md_35_ (SOURCE_FILE_AT_LINE (835)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (835)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXVariantGroup_5F_list.addAssign_operation (var_PBXVariantGroupKey, function_getPBXFileReferenceKey (var_ref.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (839)), inCompiler COMMA_SOURCE_FILE_AT_LINE (839)), constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (837)) ;
  ioArgument_ioFileListForGroup.addAssign_operation (var_PBXVariantGroupKey, constinArgument_in_5F_plist_5F_string_5F_fileName COMMA_SOURCE_FILE_AT_LINE (842)) ;
}
...
void routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                ...
                                                                C_Compiler * inCompiler
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (constinArgument_in_5F_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (852)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
  ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (854)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) ;
  GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (855)), var_ref COMMA_SOURCE_FILE_AT_LINE (855)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (856)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (857)) ;
  ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (858)) ;
}
...
void routine_enter_5F_file_5F_list_5F_for_5F_sources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                        ...
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37500 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37500.hasCurrentObject ()) {
    {
    routine_enter_5F_file_5F_for_5F_sources_5F_build_5F_phase (ioArgument_ioXcodeProjectDescription, enumerator_37500.current_mValue (HERE), ioArgument_ioBuildPhaseList, inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
    }
...
void routine_enter_5F_files_5F_for_5F_resources_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                   ...
                                                                   C_Compiler * inCompiler
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_37936 (constinArgument_in_5F_fileList, kEnumeration_up) ;
  while (enumerator_37936.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_37936.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (885)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (887)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (887)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (888)), var_ref COMMA_SOURCE_FILE_AT_LINE (888)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (890)) ;
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (891)) ;
    enumerator_37936.gotoNextObject () ;
  }
}
...
void routine_enter_5F_files_5F_for_5F_frameworks_5F_build_5F_phase (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_stringlist enumerator_38674 (constinArgument_in_5F_framework_5F_fileList, kEnumeration_up) ;
  while (enumerator_38674.hasCurrentObject ()) {
    GALGAS_lstring var_key = GALGAS_lstring::constructor_new (enumerator_38674.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (903)) ;
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (905)).method_searchKey (var_key, var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (905)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (906)), var_ref COMMA_SOURCE_FILE_AT_LINE (906)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (907)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (908)) ;
    ioArgument_ioBuildPhaseList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (909)) ;
    enumerator_38674.gotoNextObject () ;
  }
}
...
void routine_add_5F_tool_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (926)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (926)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (927)) ;
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (928)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (929)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (931)), inCompiler COMMA_SOURCE_FILE_AT_LINE (931)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (931)) ;
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (934)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (933)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (938)) ;
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_listWithValue (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (939)), inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) COMMA_SOURCE_FILE_AT_LINE (939)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inFrameworkKeyList.reader_length (SOURCE_FILE_AT_LINE (941)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (943)), GALGAS_string ("Frameworks"), constinArgument_inFrameworkKeyList COMMA_SOURCE_FILE_AT_LINE (942)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (947)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (948)) ;
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (949)), inCompiler COMMA_SOURCE_FILE_AT_LINE (949)) COMMA_SOURCE_FILE_AT_LINE (949)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (952)) ;
  ...
  if (kBoolTrue == test_1) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (954)) ;
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (955)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (955)) COMMA_SOURCE_FILE_AT_LINE (955)) ;
  }
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (957)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)) ;
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (959)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (960)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (958)) ;
  ...
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (965)) ;
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (966)).reader_string (SOURCE_FILE_AT_LINE (966)).reader_md_35_ (SOURCE_FILE_AT_LINE (966)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (966)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (967)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mTargetList.addAssign_operation (outArgument_outTargetKey, constinArgument_inTargetName, var_toolTargetBuildConfiguration, GALGAS_string ("$(HOME)/bin"), constinArgument_inProductFileName, var_toolFileReference, var_buildPhases, constinArgument_inDirectDependencyList COMMA_SOURCE_FILE_AT_LINE (968)) ;
}
...
void routine_add_5F_app_5F_target (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                   ...
                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outTargetKey.drop () ; // Release 'out' argument
  GALGAS_stringlist var_buildPhases = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (996)) ;
  GALGAS_Xcode_5F_PBXFileReference_5F_Application var_toolFileReference = GALGAS_Xcode_5F_PBXFileReference_5F_Application::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (998)), constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (998)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (999)) ;
  GALGAS_lstring var_projectNameKey = GALGAS_lstring::constructor_new (constinArgument_inProductFileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  {
  ioArgument_ioXcodeProjectDescription.mAttribute_mFileReferenceMap.modifier_insertKey (var_projectNameKey, var_toolFileReference, inCompiler COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  }
  ioArgument_ioXcodeProjectDescription.mAttribute_mProductGroupChildrenList.addAssign_operation (function_getPBXFileReferenceKey (var_toolFileReference.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1003)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1003)), constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  GALGAS_Xcode_5F_PBXResourcesBuildPhase var_resourcesBuildPhase = GALGAS_Xcode_5F_PBXResourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1006)), GALGAS_string ("Resources"), constinArgument_inResourcesToCompileList COMMA_SOURCE_FILE_AT_LINE (1005)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXResourcesBuildPhase_5F_list.addAssign_operation (var_resourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (1011)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_resourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1012)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1012)) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  GALGAS_Xcode_5F_PBXSourcesBuildPhase var_compileSourcesBuildPhase = GALGAS_Xcode_5F_PBXSourcesBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1015)), GALGAS_string ("Sources"), constinArgument_inSourcesToCompileKeyList COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1019)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXSourcesBuildPhase_5F_list.addAssign_operation (var_compileSourcesBuildPhase COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_compileSourcesBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1021)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1021)) COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  GALGAS_Xcode_5F_PBXFrameworksBuildPhase var_frameworksBuildPhase = GALGAS_Xcode_5F_PBXFrameworksBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1024)), GALGAS_string ("Frameworks"), constinArgument_inFrameworksToCompileList COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mPBXFrameworksBuildPhase_5F_list.addAssign_operation (var_frameworksBuildPhase COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_frameworksBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1030)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1030)) COMMA_SOURCE_FILE_AT_LINE (1030)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_Xcode_5F_PBXFileReference_5F_abstract var_ref ;
    ioArgument_ioXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1034)).method_searchKey (constinArgument_inFileToCopyInWrapperLaunchServices.reader_nowhere (SOURCE_FILE_AT_LINE (1034)), var_ref, inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)) ;
    GALGAS_Xcode_5F_PBXBuildFile var_build_5F_file = GALGAS_Xcode_5F_PBXBuildFile::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1036)), var_ref COMMA_SOURCE_FILE_AT_LINE (1036)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1037)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mAllBuildFileList.addAssign_operation (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1038)) ;
    GALGAS_Xcode_5F_PBXCopyBuildPhase var_copyBuildPhase = GALGAS_Xcode_5F_PBXCopyBuildPhase::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1040)), GALGAS_string::makeEmptyString (), GALGAS_uint ((PMUInt32) 1U), GALGAS_string ("Contents/Library/LaunchServices"), GALGAS_Xcode_5F_PBXBuildFile_5F_list::constructor_listWithValue (var_build_5F_file COMMA_SOURCE_FILE_AT_LINE (1044)) COMMA_SOURCE_FILE_AT_LINE (1039)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1046)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mPBXCopyBuildPhase_5F_list.addAssign_operation (var_copyBuildPhase COMMA_SOURCE_FILE_AT_LINE (1047)) ;
    var_buildPhases.addAssign_operation (function_getPBXFileReferenceKey (var_copyBuildPhase.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1048)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1048)) COMMA_SOURCE_FILE_AT_LINE (1048)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inPrecompiledHeaderPath.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_PREFIX_HEADER = \"").operator_concat (constinArgument_inPrecompiledHeaderPath COMMA_SOURCE_FILE_AT_LINE (1053)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1053)) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
  }
  ...
  if (kBoolTrue == test_2) {
    inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("INFOPLIST_FILE = \"").operator_concat (constinArgument_inInfoPListFile COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  }
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = NO;") COMMA_SOURCE_FILE_AT_LINE (1058)) ;
  ...
  inArgument_inTargetSettings.addAssign_operation (GALGAS_string ("PRODUCT_NAME = \"").operator_concat (constinArgument_inProductFileName COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (GALGAS_string ("\";") COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
  GALGAS_stringlist var_targetDependencyKeyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1062)) ;
  cEnumerator_stringlist enumerator_46053 (constinArgument_inDirectDependencyList, kEnumeration_up) ;
  while (enumerator_46053.hasCurrentObject ()) {
    GALGAS_Xcode_5F_targetDependencyDescription var_d = GALGAS_Xcode_5F_targetDependencyDescription::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1064)), enumerator_46053.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1065)) ;
    var_targetDependencyKeyList.addAssign_operation (function_getPBXFileReferenceKey (var_d.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1066)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1066)) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    ioArgument_ioXcodeProjectDescription.mAttribute_mDependencyList.addAssign_operation (var_d COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    enumerator_46053.gotoNextObject () ;
  }
  GALGAS_Xcode_5F_XCBuildConfiguration var_toolTargetBuildConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1071)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1072)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1072)), inArgument_inTargetSettings COMMA_SOURCE_FILE_AT_LINE (1070)) ;
  ...
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_toolTargetBuildConfiguration COMMA_SOURCE_FILE_AT_LINE (1077)) ;
  outArgument_outTargetKey = ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1078)).reader_string (SOURCE_FILE_AT_LINE (1078)).reader_md_35_ (SOURCE_FILE_AT_LINE (1078)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1078)) ;
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1079)) ;
...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  cEnumerator_stringlist enumerator_47556 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  while (enumerator_47556.hasCurrentObject ()) {
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47556.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1103)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1103)) COMMA_SOURCE_FILE_AT_LINE (1103)) ;
    enumerator_47556.gotoNextObject () ;
  }
  outArgument_outProjectDefaultSettings = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1105)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ALWAYS_SEARCH_USER_PATHS = NO;") COMMA_SOURCE_FILE_AT_LINE (1106)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("ARCHS = \"$(ARCHS_STANDARD_64_BIT)\";") COMMA_SOURCE_FILE_AT_LINE (1107)) ;
  const enumGalgasBool test_0 = constinArgument_inUsesARC.boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_ENABLE_OBJC_ARC = YES;") COMMA_SOURCE_FILE_AT_LINE (1109)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;") COMMA_SOURCE_FILE_AT_LINE (1111)) ;
  }
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;") COMMA_SOURCE_FILE_AT_LINE (1113)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1114)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;") COMMA_SOURCE_FILE_AT_LINE (1115)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1116)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_WARNINGS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1117)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_64_TO_32_BIT_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1118)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;") COMMA_SOURCE_FILE_AT_LINE (1119)) ;
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("CLANG_WARN_SUSPICIOUS_IMPLICIT_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1120)) ;
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_50897 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1165)), kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_50897.hasCurrentObject () && bool_0) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    while (enumerator_50897.hasCurrentObject () && bool_0) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_50897.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  ...
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51165 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1171)), kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_51165.hasCurrentObject () && bool_1) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    while (enumerator_51165.hasCurrentObject () && bool_1) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51165.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
  ...
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_51467 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1177)), kEnumeration_up) ;
  const bool bool_2 = true ;
  if (enumerator_51467.hasCurrentObject () && bool_2) {
    ...
    while (enumerator_51467.hasCurrentObject () && bool_2) {
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_51467.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      enumerator_51467.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_51797 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1184)), kEnumeration_up) ;
  while (enumerator_51797.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_51797.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1185)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1186)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    }
    ...
    cEnumerator_XcodeObjectReferenceList enumerator_52117 (enumerator_51797.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1192)), kEnumeration_up) ;
    while (enumerator_52117.hasCurrentObject ()) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52117.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (enumerator_52117.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      enumerator_52117.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1197)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1197)).reader_length (SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1198)) ;
      }else if (kBoolFalse == test_5) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_51797.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1200)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_51797.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1203)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_51797.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1204)) COMMA_SOURCE_FILE_AT_LINE (1204)) ;
    }
    ...
    enumerator_51797.gotoNextObject () ;
  }
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXGroup section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1209)) ;
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_52892 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1211)), kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_52892.hasCurrentObject () && bool_7) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    while (enumerator_52892.hasCurrentObject () && bool_7) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_52892.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (enumerator_52892.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1214)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (function_getPBXFileReferenceKey (enumerator_52892.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1216)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (enumerator_52892.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1216)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1217)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
      cEnumerator_stringlist enumerator_53324 (enumerator_52892.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53324.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53324.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1219)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
        enumerator_53324.gotoNextObject () ;
      }
      GALGAS_string var_productExtension ;
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_52892.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1221)) ;
      ...
      cEnumerator_stringlist enumerator_53621 (enumerator_52892.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      while (enumerator_53621.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_53621.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1227)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1227)) COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        enumerator_53621.gotoNextObject () ;
      }
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (enumerator_52892.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (enumerator_52892.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1231)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (enumerator_52892.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1232)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (function_getPBXFileReferenceKey (enumerator_52892.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1233)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1233)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
      enumerator_52892.gotoNextObject () ;
    }
  ...
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_54796 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1251)), kEnumeration_up) ;
  while (enumerator_54796.hasCurrentObject ()) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54796.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (enumerator_54796.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
  ...
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55085 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1258)), kEnumeration_up) ;
  const bool bool_8 = true ;
  if (enumerator_55085.hasCurrentObject () && bool_8) {
    ...
    while (enumerator_55085.hasCurrentObject () && bool_8) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55085.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1261)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) COMMA_SOURCE_FILE_AT_LINE (1261)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (enumerator_55085.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1263)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1265)) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_55461 (enumerator_55085.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1266)), kEnumeration_up) ;
      while (enumerator_55461.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55461.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1267)) ;
        enumerator_55461.gotoNextObject () ;
      }
  ...
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_55870 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1275)), kEnumeration_up) ;
  const bool bool_9 = true ;
  if (enumerator_55870.hasCurrentObject () && bool_9) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    while (enumerator_55870.hasCurrentObject () && bool_9) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55870.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1278)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (enumerator_55870.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1279)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1281)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56242 (enumerator_55870.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1283)), kEnumeration_up) ;
      while (enumerator_56242.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56242.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1284)) COMMA_SOURCE_FILE_AT_LINE (1284)) ;
        enumerator_56242.gotoNextObject () ;
      }
  ...
  cEnumerator_Xcode_5F_PBXCopyBuildPhase_5F_list enumerator_56643 (constinArgument_inXcodeProjectDescription.reader_mPBXCopyBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1292)), kEnumeration_up) ;
  const bool bool_10 = true ;
  if (enumerator_56643.hasCurrentObject () && bool_10) {
    ...
    while (enumerator_56643.hasCurrentObject () && bool_10) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56643.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1295)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string (" /* Copy Files */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1296)).operator_concat (GALGAS_string ("\t\t\tisa = PBXCopyFilesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1297)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("\t\t\tdstPath = \"") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (enumerator_56643.current_mBuildPhase (HERE).reader_mDestinationPath (SOURCE_FILE_AT_LINE (1299)) COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1299)).operator_concat (GALGAS_string ("\t\t\tdstSubfolderSpec = ") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (enumerator_56643.current_mBuildPhase (HERE).reader_mDestinationSubfolder (SOURCE_FILE_AT_LINE (1300)).reader_string (SOURCE_FILE_AT_LINE (1300)) COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1300)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57142 (enumerator_56643.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1302)), kEnumeration_up) ;
      while (enumerator_57142.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57142.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)) ;
        enumerator_57142.gotoNextObject () ;
      }
      ...
      enumerator_56643.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXCopyFilesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57539 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1311)), kEnumeration_up) ;
  const bool bool_11 = true ;
  if (enumerator_57539.hasCurrentObject () && bool_11) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    while (enumerator_57539.hasCurrentObject () && bool_11) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57539.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1314)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1314)) COMMA_SOURCE_FILE_AT_LINE (1314)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1316)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (enumerator_57539.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1317)) COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1317)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1318)) COMMA_SOURCE_FILE_AT_LINE (1314)) ;
      enumerator_57539.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1319)) ;
  }
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_58034 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1322)), kEnumeration_up) ;
  const bool bool_12 = true ;
  if (enumerator_58034.hasCurrentObject () && bool_12) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1323)) ;
    while (enumerator_58034.hasCurrentObject () && bool_12) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_58034.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1325)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (enumerator_58034.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1326)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1327)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (enumerator_58034.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1329)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1330)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (enumerator_58034.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1325)) ;
      enumerator_58034.gotoNextObject () ;
    }
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  }
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58587 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1337)), kEnumeration_up) ;
  const bool bool_13 = true ;
  if (enumerator_58587.hasCurrentObject () && bool_13) {
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
    while (enumerator_58587.hasCurrentObject () && bool_13) {
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58587.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1340)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1341)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
      cEnumerator_stringlist enumerator_58881 (enumerator_58587.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1343)), kEnumeration_up) ;
      while (enumerator_58881.hasCurrentObject ()) {
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58881.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1344)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      GALGAS_bool joker_61961_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_61961_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      ...
      cEnumerator_stringlist enumerator_62184 (var_pbxuser_5F_files, kEnumeration_up) ;
      while (enumerator_62184.hasCurrentObject ()) {
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1422)).operator_concat (enumerator_62184.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
        {
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_CompiledMachOExecutable_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.mach-o.executable\"; includeInIndex = 0; path = ") COMMA_SOURCE_FILE_AT_LINE (64)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (65)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n") COMMA_SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (63)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_Application_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) COMMA_SOURCE_FILE_AT_LINE (82)).operator_concat (GALGAS_string (" = {isa = PBXFileReference; explicitFileType = \"compiled.wrapper.application\"; includeInIndex = 0; path = ") COMMA_SOURCE_FILE_AT_LINE (83)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string ("; sourceTree = BUILT_PRODUCTS_DIR; };\n") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (82)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_cppSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; name = ") COMMA_SOURCE_FILE_AT_LINE (96)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (97)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (97)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (95)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_hSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; name = ") COMMA_SOURCE_FILE_AT_LINE (110)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (111)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (111)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (109)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pchSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.pch; name = ") COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (125)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (125)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (123)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.obj; name = ") COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (139)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (139)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (137)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_mmSourceFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (152)) COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.objcpp; name = ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (153)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (154)) COMMA_SOURCE_FILE_AT_LINE (151)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_gifFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.gif; name = ") COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (167)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_tiffFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.tiff; name = ") COMMA_SOURCE_FILE_AT_LINE (180)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (181)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (181)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (181)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (179)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_pngFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.png; name = ") COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (195)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (196)) COMMA_SOURCE_FILE_AT_LINE (196)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (196)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (208)) COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = text.plist; name = ") COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (209)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (207)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_frameworkFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.framework; name = ") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (223)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (223)) COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (224)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_icnsFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (236)) COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = image.icns; name = ") COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (237)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (object->mAttribute_mFileName.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (238)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (235)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_xibFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = wrapper.xib; name = ") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (252)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (252)) COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (250)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFileReference_5F_plistStringFile_buildXcodeProject (const cPtr_Xcode_5F_PBXFileReference_5F_abstract * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (GALGAS_string (" */ = {isa = PBXFileReference; lastKnownFileType = text.plist.strings; name = ") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (object->mAttribute_mFileName.reader_lastPathComponent (SOURCE_FILE_AT_LINE (267)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (GALGAS_string ("; path = ") COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (object->mAttribute_mFilePath.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (268)).operator_concat (GALGAS_string ("; sourceTree = \"<group>\"; };\n") COMMA_SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (265)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXBuildFile_buildXcodeProject (const cPtr_Xcode_5F_PBXBuildFile * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (294)) COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (object->mAttribute_mSourceFile.reader_mFileName (SOURCE_FILE_AT_LINE (294)) COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string (" */ ") COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string ("= {isa = PBXBuildFile; fileRef = ") COMMA_SOURCE_FILE_AT_LINE (295)).operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSourceFile.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (295)), inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) COMMA_SOURCE_FILE_AT_LINE (295)).operator_concat (GALGAS_string (" ; settings = {ATTRIBUTES = (); }; };\n") COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (294)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_Xcode_5F_PBXFrameworksBuildPhase_buildXcodeProject (const cPtr_Xcode_5F_PBXFrameworksBuildPhase * inObject,
  ...
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (object->mAttribute_mSequenceNumber, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string (" /* Frameworks */ = {\n") COMMA_SOURCE_FILE_AT_LINE (376)).operator_concat (GALGAS_string ("\t\t\tisa = PBXFrameworksBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (378)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (379)) COMMA_SOURCE_FILE_AT_LINE (376)) ;
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_17053 (object->mAttribute_mFileReferenceList, kEnumeration_up) ;
  while (enumerator_17053.hasCurrentObject ()) {
    ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_17053.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (381)), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (enumerator_17053.current_mFile (HERE).reader_mSourceFile (SOURCE_FILE_AT_LINE (382)).reader_mFileName (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (381)) ;
    enumerator_17053.gotoNextObject () ;
  }
  ioArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (385)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (384)) ;
}
//---------------------------------------------------------------------------*
