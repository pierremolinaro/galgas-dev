...
void routine_enterProjectDefaultSettings (const GALGAS_stringlist constinArgument_inHeaderSearchPathList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_47836 (constinArgument_inHeaderSearchPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47836.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_pathString.dotAssign_operation (GALGAS_string ("\t\t\t\t\t\"").operator_concat (enumerator_47836.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1116)).operator_concat (GALGAS_string ("\",\n") COMMA_SOURCE_FILE_AT_LINE (1116)) COMMA_SOURCE_FILE_AT_LINE (1116)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inArchitectureList.reader_length (SOURCE_FILE_AT_LINE (1121)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    var_s.dotAssign_operation (constinArgument_inArchitectureList.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1122)) COMMA_SOURCE_FILE_AT_LINE (1122)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @concatInstructionForGeneration
    var_s.dotAssign_operation (GALGAS_string ("(") COMMA_SOURCE_FILE_AT_LINE (1124)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_48203 (constinArgument_inArchitectureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_48203.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "\t\t\t\t\t").operator_concat (enumerator_48203.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1126)).operator_concat (GALGAS_string (",") COMMA_SOURCE_FILE_AT_LINE (1126)) COMMA_SOURCE_FILE_AT_LINE (1126)) ;
      enumerator_48203.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    var_s.dotAssign_operation (GALGAS_string ("\n"
  ...
  //-------- @concatInstructionForGeneration
  var_s.dotAssign_operation (GALGAS_string (";") COMMA_SOURCE_FILE_AT_LINE (1130)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (var_s COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_DEBUGGING_SYMBOLS = default;") COMMA_SOURCE_FILE_AT_LINE (1133)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_ENABLE_OBJC_GC = required;") COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_GENERATE_DEBUGGING_SYMBOLS = NO;") COMMA_SOURCE_FILE_AT_LINE (1135)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_PRECOMPILE_PREFIX_HEADER = YES;") COMMA_SOURCE_FILE_AT_LINE (1136)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_THREADSAFE_STATICS = NO;") COMMA_SOURCE_FILE_AT_LINE (1137)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_IMPLICIT_FUNCTION_DECLARATIONS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1138)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_NONCONFORMANT_CODE_ERRORS_AS_WARNINGS = YES;") COMMA_SOURCE_FILE_AT_LINE (1139)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_TREAT_WARNINGS_AS_ERRORS = YES;") COMMA_SOURCE_FILE_AT_LINE (1140)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_64_TO_32_BIT_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1141)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_INVALID_OFFSETOF_MACRO = YES;") COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_NEWLINE = YES;") COMMA_SOURCE_FILE_AT_LINE (1143)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_MISSING_PROTOTYPES = YES;") COMMA_SOURCE_FILE_AT_LINE (1144)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_ABOUT_RETURN_TYPE = YES;") COMMA_SOURCE_FILE_AT_LINE (1145)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_CHECK_SWITCH_STATEMENTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1146)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_EFFECTIVE_CPLUSPLUS_VIOLATIONS = YES;") COMMA_SOURCE_FILE_AT_LINE (1147)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_FOUR_CHARACTER_CONSTANTS = YES;") COMMA_SOURCE_FILE_AT_LINE (1148)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS = YES;") COMMA_SOURCE_FILE_AT_LINE (1149)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INHIBIT_ALL_WARNINGS = NO;") COMMA_SOURCE_FILE_AT_LINE (1150)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED = YES;") COMMA_SOURCE_FILE_AT_LINE (1151)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_MISSING_PARENTHESES = YES;") COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_NON_VIRTUAL_DESTRUCTOR = YES;") COMMA_SOURCE_FILE_AT_LINE (1153)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PEDANTIC = NO;") COMMA_SOURCE_FILE_AT_LINE (1154)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_PROTOTYPE_CONVERSION = YES;") COMMA_SOURCE_FILE_AT_LINE (1155)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SHADOW = NO;") COMMA_SOURCE_FILE_AT_LINE (1156)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_SIGN_COMPARE = YES;") COMMA_SOURCE_FILE_AT_LINE (1157)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_TYPECHECK_CALLS_TO_PRINTF = YES;") COMMA_SOURCE_FILE_AT_LINE (1158)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNINITIALIZED_AUTOS = YES;") COMMA_SOURCE_FILE_AT_LINE (1159)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNKNOWN_PRAGMAS = YES;") COMMA_SOURCE_FILE_AT_LINE (1160)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_FUNCTION = YES;") COMMA_SOURCE_FILE_AT_LINE (1161)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_LABEL = YES;") COMMA_SOURCE_FILE_AT_LINE (1162)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_PARAMETER = YES;") COMMA_SOURCE_FILE_AT_LINE (1163)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VALUE = YES;") COMMA_SOURCE_FILE_AT_LINE (1164)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("GCC_WARN_UNUSED_VARIABLE = YES;") COMMA_SOURCE_FILE_AT_LINE (1165)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("HEADER_SEARCH_PATHS = (\n").operator_concat (var_pathString COMMA_SOURCE_FILE_AT_LINE (1166)).operator_concat (GALGAS_string ("\t\t\t\t);") COMMA_SOURCE_FILE_AT_LINE (1166)) COMMA_SOURCE_FILE_AT_LINE (1166)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("PREBINDING = NO;") COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outProjectDefaultSettings.addAssign_operation (GALGAS_string ("SDKROOT = ").operator_concat (constinArgument_inSDK COMMA_SOURCE_FILE_AT_LINE (1168)).operator_concat (GALGAS_string (" ;") COMMA_SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1168)) ;
}
...
void routine_buildXcodeProjectString (const GALGAS_XcodeProjectDescription constinArgument_inXcodeProjectDescription,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_rootObjectKey = GALGAS_string ("project").reader_md_35_ (SOURCE_FILE_AT_LINE (1180)).reader_rightSubString (GALGAS_uint ((PMUInt32) 24U) COMMA_SOURCE_FILE_AT_LINE (1180)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outString = GALGAS_string ("// !$*UTF8*$!\n").operator_concat (GALGAS_string ("{\n") COMMA_SOURCE_FILE_AT_LINE (1183)).operator_concat (GALGAS_string ("\tarchiveVersion = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string ("\tclasses = {\n") COMMA_SOURCE_FILE_AT_LINE (1185)).operator_concat (GALGAS_string ("\t};\n") COMMA_SOURCE_FILE_AT_LINE (1186)).operator_concat (GALGAS_string ("\tobjectVersion = 42;\n") COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("\tobjects = {\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1188)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_51671 (constinArgument_inXcodeProjectDescription.reader_mAllBuildFileList (SOURCE_FILE_AT_LINE (1190)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_51671.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXBuildFile section */\n") COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    while (enumerator_51671.hasCurrentObject () && bool_0) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXBuildFile *) enumerator_51671.current_mFile (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1192)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFileReference_5F_map enumerator_51939 (constinArgument_inXcodeProjectDescription.reader_mFileReferenceMap (SOURCE_FILE_AT_LINE (1196)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_1 = true ;
  if (enumerator_51939.hasCurrentObject () && bool_1) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1197)) ;
    while (enumerator_51939.hasCurrentObject () && bool_1) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFileReference_5F_abstract *) enumerator_51939.current_mFileReference (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1198)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_51939.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXFileReference section */\n") COMMA_SOURCE_FILE_AT_LINE (1199)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXFrameworksBuildPhase_5F_list enumerator_52241 (constinArgument_inXcodeProjectDescription.reader_mPBXFrameworksBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1202)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_2 = true ;
  if (enumerator_52241.hasCurrentObject () && bool_2) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_52241.hasCurrentObject () && bool_2) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_buildXcodeProject ((const cPtr_Xcode_5F_PBXFrameworksBuildPhase *) enumerator_52241.current_mBuildPhase (HERE).ptr (), outArgument_outString, inCompiler COMMA_SOURCE_FILE_AT_LINE (1204)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXGroup_5F_list enumerator_52571 (constinArgument_inXcodeProjectDescription.reader_mProjectGroupList (SOURCE_FILE_AT_LINE (1209)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_52571.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_52571.current_mGroup (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1210)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1210)) COMMA_SOURCE_FILE_AT_LINE (1210)) COMMA_SOURCE_FILE_AT_LINE (1210)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1211)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string (" /* ").operator_concat (enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1212)) COMMA_SOURCE_FILE_AT_LINE (1212)).operator_concat (GALGAS_string (" */") COMMA_SOURCE_FILE_AT_LINE (1212)) COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string (" = {\n").operator_concat (GALGAS_string ("\t\t\tisa = PBXGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1215)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1216)) COMMA_SOURCE_FILE_AT_LINE (1214)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_XcodeObjectReferenceList enumerator_52891 (enumerator_52571.current_mGroup (HERE).reader_mChildrenGroupList (SOURCE_FILE_AT_LINE (1217)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52891.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_52891.current_mRefString (HERE) COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (enumerator_52891.current_mComment (HERE) COMMA_SOURCE_FILE_AT_LINE (1218)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1218)) COMMA_SOURCE_FILE_AT_LINE (1218)) ;
      enumerator_52891.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1220)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1221)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1222)).reader_componentsSeparatedByString (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (1222)).reader_length (SOURCE_FILE_AT_LINE (1222)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = \"").operator_concat (enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1223)) COMMA_SOURCE_FILE_AT_LINE (1223)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1223)) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tname = ").operator_concat (enumerator_52571.current_mGroup (HERE).reader_mGroupName (SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1225)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1225)) ;
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_52571.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1228)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tpath = \"").operator_concat (enumerator_52571.current_mGroup (HERE).reader_mGroupPath (SOURCE_FILE_AT_LINE (1229)) COMMA_SOURCE_FILE_AT_LINE (1229)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1229)) COMMA_SOURCE_FILE_AT_LINE (1229)) ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1232)) COMMA_SOURCE_FILE_AT_LINE (1231)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_53666 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1236)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_7 = true ;
  if (enumerator_53666.hasCurrentObject () && bool_7) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1237)) ;
    while (enumerator_53666.hasCurrentObject () && bool_7) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_53666.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1239)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1239)).operator_concat (enumerator_53666.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1239)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1239)).operator_concat (GALGAS_string ("\t\t\tisa = PBXNativeTarget;\n") COMMA_SOURCE_FILE_AT_LINE (1240)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (function_getPBXFileReferenceKey (enumerator_53666.current_mTargetConfiguration (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1241)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1241)) COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string (" /* Build configuration list for PBXNativeTarget \"") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (enumerator_53666.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1241)).operator_concat (GALGAS_string ("\t\t\tbuildPhases = (\n") COMMA_SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1239)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_54098 (enumerator_53666.current_mBuildPhaseKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54098.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54098.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1244)) COMMA_SOURCE_FILE_AT_LINE (1244)) ;
        enumerator_54098.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_productExtension ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_productExtension ((const cPtr_Xcode_5F_productFileReference *) enumerator_53666.current_mProduct (HERE).ptr (), var_productExtension, inCompiler COMMA_SOURCE_FILE_AT_LINE (1246)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tbuildRules = (\n") COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1249)).operator_concat (GALGAS_string ("\t\t\tdependencies = (\n") COMMA_SOURCE_FILE_AT_LINE (1250)) COMMA_SOURCE_FILE_AT_LINE (1247)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_54395 (enumerator_53666.current_mDependencyKeyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54395.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_54395.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1252)).operator_concat (GALGAS_string (" /*  */,\n") COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1252)) ;
        enumerator_54395.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\tname = \"") COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (enumerator_53666.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1255)).operator_concat (GALGAS_string ("\t\t\tproductInstallPath = \"") COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (enumerator_53666.current_mProductInstallPath (HERE) COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1256)).operator_concat (GALGAS_string ("\t\t\tproductName = \"") COMMA_SOURCE_FILE_AT_LINE (1257)).operator_concat (enumerator_53666.current_mProductName (HERE) COMMA_SOURCE_FILE_AT_LINE (1257)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1257)).operator_concat (GALGAS_string ("\t\t\tproductReference = ") COMMA_SOURCE_FILE_AT_LINE (1258)).operator_concat (function_getPBXFileReferenceKey (enumerator_53666.current_mProduct (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1258)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1258)) COMMA_SOURCE_FILE_AT_LINE (1258)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1258)).operator_concat (GALGAS_string ("\t\t\tproductType = \"com.apple.product-type.") COMMA_SOURCE_FILE_AT_LINE (1259)).operator_concat (var_productExtension COMMA_SOURCE_FILE_AT_LINE (1259)).operator_concat (GALGAS_string ("\";\n") COMMA_SOURCE_FILE_AT_LINE (1259)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1260)) COMMA_SOURCE_FILE_AT_LINE (1254)) ;
      enumerator_53666.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXNativeTarget section */\n") COMMA_SOURCE_FILE_AT_LINE (1262)) ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXProject section */\n").operator_concat (GALGAS_string ("\t\t") COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string (" /* Project object */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string ("\t\t\tisa = PBXProject;\n") COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurationList = ") COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (constinArgument_inProjectDefaultConfigurationKey COMMA_SOURCE_FILE_AT_LINE (1268)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (GALGAS_string ("\" */;\n") COMMA_SOURCE_FILE_AT_LINE (1269)).operator_concat (GALGAS_string ("\t\t\tcompatibilityVersion = \"Xcode 2.4\";\n") COMMA_SOURCE_FILE_AT_LINE (1270)).operator_concat (GALGAS_string ("\t\t\thasScannedForEncodings = 1;\n") COMMA_SOURCE_FILE_AT_LINE (1271)).operator_concat (GALGAS_string ("\t\t\tmainGroup = ") COMMA_SOURCE_FILE_AT_LINE (1272)).operator_concat (constinArgument_inMainGroupKey COMMA_SOURCE_FILE_AT_LINE (1272)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1272)).operator_concat (GALGAS_string ("\t\t\tprojectDirPath = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1273)).operator_concat (GALGAS_string ("\t\t\tprojectRoot = \"\";\n") COMMA_SOURCE_FILE_AT_LINE (1274)).operator_concat (GALGAS_string ("\t\t\ttargets = (\n") COMMA_SOURCE_FILE_AT_LINE (1275)) COMMA_SOURCE_FILE_AT_LINE (1265)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXNativeTarget_5F_list enumerator_55570 (constinArgument_inXcodeProjectDescription.reader_mTargetList (SOURCE_FILE_AT_LINE (1276)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_55570.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_55570.current_mTargetKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (enumerator_55570.current_mTargetName (HERE) COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (GALGAS_string (" */,\n") COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    enumerator_55570.gotoNextObject () ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string ("/* End PBXProject section */\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (1281)) COMMA_SOURCE_FILE_AT_LINE (1279)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXResourcesBuildPhase_5F_list enumerator_55859 (constinArgument_inXcodeProjectDescription.reader_mPBXResourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1283)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_8 = true ;
  if (enumerator_55859.hasCurrentObject () && bool_8) {
    //-------- @concatInstructionForGeneration
    ...
    while (enumerator_55859.hasCurrentObject () && bool_8) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_55859.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1286)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1287)).operator_concat (enumerator_55859.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1287)) COMMA_SOURCE_FILE_AT_LINE (1287)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1287)).operator_concat (GALGAS_string ("\t\t\tisa = PBXResourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1288)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1289)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1290)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_56235 (enumerator_55859.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1291)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_56235.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56235.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1292)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1292)) COMMA_SOURCE_FILE_AT_LINE (1292)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1292)) COMMA_SOURCE_FILE_AT_LINE (1292)) ;
        enumerator_56235.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1295)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1296)) COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXSourcesBuildPhase_5F_list enumerator_56644 (constinArgument_inXcodeProjectDescription.reader_mPBXSourcesBuildPhase_5F_list (SOURCE_FILE_AT_LINE (1300)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_9 = true ;
  if (enumerator_56644.hasCurrentObject () && bool_9) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1301)) ;
    while (enumerator_56644.hasCurrentObject () && bool_9) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_56644.current_mBuildPhase (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1304)).operator_concat (enumerator_56644.current_mBuildPhase (HERE).reader_mNameForComment (SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1304)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1304)).operator_concat (GALGAS_string ("\t\t\tisa = PBXSourcesBuildPhase;\n") COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (GALGAS_string ("\t\t\tbuildActionMask = 2147483647;\n") COMMA_SOURCE_FILE_AT_LINE (1306)).operator_concat (GALGAS_string ("\t\t\tfiles = (\n") COMMA_SOURCE_FILE_AT_LINE (1307)) COMMA_SOURCE_FILE_AT_LINE (1303)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_Xcode_5F_PBXBuildFile_5F_list enumerator_57016 (enumerator_56644.current_mBuildPhase (HERE).reader_mFileReferenceList (SOURCE_FILE_AT_LINE (1308)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_57016.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57016.current_mFile (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1309)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1309)) COMMA_SOURCE_FILE_AT_LINE (1309)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1309)) COMMA_SOURCE_FILE_AT_LINE (1309)) ;
        enumerator_57016.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t);\n").operator_concat (GALGAS_string ("\t\t\trunOnlyForDeploymentPostprocessing = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1312)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1313)) COMMA_SOURCE_FILE_AT_LINE (1311)) ;
      enumerator_56644.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXSourcesBuildPhase section */\n") COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_targetDependencyDescription_5F_list enumerator_57411 (constinArgument_inXcodeProjectDescription.reader_mDependencyList (SOURCE_FILE_AT_LINE (1317)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_10 = true ;
  if (enumerator_57411.hasCurrentObject () && bool_10) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXTargetDependency section */\n") COMMA_SOURCE_FILE_AT_LINE (1318)) ;
    while (enumerator_57411.hasCurrentObject () && bool_10) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_57411.current_mDependency (HERE).reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1320)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1320)) COMMA_SOURCE_FILE_AT_LINE (1320)).operator_concat (GALGAS_string (" /* PBXTargetDependency */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1321)).operator_concat (GALGAS_string ("\t\t\tisa = PBXTargetDependency;\n") COMMA_SOURCE_FILE_AT_LINE (1322)).operator_concat (GALGAS_string ("\t\t\ttarget = ") COMMA_SOURCE_FILE_AT_LINE (1323)).operator_concat (enumerator_57411.current_mDependency (HERE).reader_mDependencyTarget (SOURCE_FILE_AT_LINE (1323)) COMMA_SOURCE_FILE_AT_LINE (1323)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (1323)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1324)) COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_PBXVariantGroup_5F_list enumerator_57906 (constinArgument_inXcodeProjectDescription.reader_mPBXVariantGroup_5F_list (SOURCE_FILE_AT_LINE (1328)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_11 = true ;
  if (enumerator_57906.hasCurrentObject () && bool_11) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1329)) ;
    while (enumerator_57906.hasCurrentObject () && bool_11) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (enumerator_57906.current_mPBXVariantKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1331)).operator_concat (GALGAS_string (" /* ") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (enumerator_57906.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string (" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1332)).operator_concat (GALGAS_string ("\t\t\tisa = PBXVariantGroup;\n") COMMA_SOURCE_FILE_AT_LINE (1333)).operator_concat (GALGAS_string ("\t\t\tchildren = (\n") COMMA_SOURCE_FILE_AT_LINE (1334)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1335)).operator_concat (enumerator_57906.current_mPBXFileReferenceKey (HERE) COMMA_SOURCE_FILE_AT_LINE (1335)).operator_concat (GALGAS_string (" ,\n") COMMA_SOURCE_FILE_AT_LINE (1335)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1336)).operator_concat (GALGAS_string ("\t\t\tname = ") COMMA_SOURCE_FILE_AT_LINE (1337)).operator_concat (enumerator_57906.current_mName (HERE) COMMA_SOURCE_FILE_AT_LINE (1337)).operator_concat (GALGAS_string (";\n") COMMA_SOURCE_FILE_AT_LINE (1337)).operator_concat (GALGAS_string ("\t\t\tsourceTree = \"<group>\";\n") COMMA_SOURCE_FILE_AT_LINE (1338)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1331)) ;
      enumerator_57906.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End PBXVariantGroup section */\n") COMMA_SOURCE_FILE_AT_LINE (1340)) ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_58459 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1343)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_12 = true ;
  if (enumerator_58459.hasCurrentObject () && bool_12) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCBuildConfiguration section */\n") COMMA_SOURCE_FILE_AT_LINE (1344)) ;
    while (enumerator_58459.hasCurrentObject () && bool_12) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_58459.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1346)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1346)) COMMA_SOURCE_FILE_AT_LINE (1346)).operator_concat (GALGAS_string (" /* Default */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1346)).operator_concat (GALGAS_string ("\t\t\tisa = XCBuildConfiguration;\n") COMMA_SOURCE_FILE_AT_LINE (1347)).operator_concat (GALGAS_string ("\t\t\tbuildSettings = {\n") COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_58753 (enumerator_58459.current_mBuildConfig (HERE).reader_mSettings (SOURCE_FILE_AT_LINE (1349)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_58753.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t\t").operator_concat (enumerator_58753.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1350)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (1350)) COMMA_SOURCE_FILE_AT_LINE (1350)) ;
        enumerator_58753.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t\t};\n").operator_concat (GALGAS_string ("\t\t\tname = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1353)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1354)) COMMA_SOURCE_FILE_AT_LINE (1352)) ;
      enumerator_58459.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_Xcode_5F_XCBuildConfiguration_5F_list enumerator_59089 (constinArgument_inXcodeProjectDescription.reader_mBuildConfigurationList (SOURCE_FILE_AT_LINE (1358)), kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_13 = true ;
  if (enumerator_59089.hasCurrentObject () && bool_13) {
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* Begin XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    while (enumerator_59089.hasCurrentObject () && bool_13) {
      //-------- @concatInstructionForGeneration
      outArgument_outString.dotAssign_operation (GALGAS_string ("\t\t").operator_concat (function_getPBXFileReferenceKey (enumerator_59089.current_mBuildConfig (HERE).reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1361)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1361)) COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (GALGAS_string (" /* Build configuration list for PBXProject \"") COMMA_SOURCE_FILE_AT_LINE (1361)).operator_concat (constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string ("\" */ = {\n") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (GALGAS_string ("\t\t\tisa = XCConfigurationList;\n") COMMA_SOURCE_FILE_AT_LINE (1363)).operator_concat (GALGAS_string ("\t\t\tbuildConfigurations = (\n") COMMA_SOURCE_FILE_AT_LINE (1364)).operator_concat (GALGAS_string ("\t\t\t\t") COMMA_SOURCE_FILE_AT_LINE (1365)).operator_concat (function_getPBXFileReferenceKey (enumerator_59089.current_mBuildConfig (HERE).reader_mSequenceNumber_31_ (SOURCE_FILE_AT_LINE (1365)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1365)) COMMA_SOURCE_FILE_AT_LINE (1365)).operator_concat (GALGAS_string (" /* Default */,\n") COMMA_SOURCE_FILE_AT_LINE (1365)).operator_concat (GALGAS_string ("\t\t\t);\n") COMMA_SOURCE_FILE_AT_LINE (1366)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationIsVisible = 0;\n") COMMA_SOURCE_FILE_AT_LINE (1367)).operator_concat (GALGAS_string ("\t\t\tdefaultConfigurationName = Default;\n") COMMA_SOURCE_FILE_AT_LINE (1368)).operator_concat (GALGAS_string ("\t\t};\n") COMMA_SOURCE_FILE_AT_LINE (1369)) COMMA_SOURCE_FILE_AT_LINE (1361)) ;
      enumerator_59089.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    outArgument_outString.dotAssign_operation (GALGAS_string ("/* End XCConfigurationList section */\n") COMMA_SOURCE_FILE_AT_LINE (1370)) ;
  }
  //-------- @concatInstructionForGeneration
  outArgument_outString.dotAssign_operation (GALGAS_string ("\t};\n").operator_concat (GALGAS_string ("\trootObject = ") COMMA_SOURCE_FILE_AT_LINE (1374)).operator_concat (var_rootObjectKey COMMA_SOURCE_FILE_AT_LINE (1374)).operator_concat (GALGAS_string (" /* Project object */;\n") COMMA_SOURCE_FILE_AT_LINE (1374)).operator_concat (GALGAS_string ("}\n") COMMA_SOURCE_FILE_AT_LINE (1375)) COMMA_SOURCE_FILE_AT_LINE (1373)) ;
}
...
void routine_generateXCodeFile (GALGAS_XcodeProjectDescription & ioArgument_ioXcodeProjectDescription,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_projectName = constinArgument_in_5F_xcodeproj_5F_filePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (1386)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (1386)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_XCBuildConfiguration var_defaultProjectConfiguration = GALGAS_Xcode_5F_XCBuildConfiguration::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1389)), ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1390)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1390)), constinArgument_inProjectDefaultSettings COMMA_SOURCE_FILE_AT_LINE (1388)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1393)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1394)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mBuildConfigurationList.addAssign_operation (var_defaultProjectConfiguration COMMA_SOURCE_FILE_AT_LINE (1395)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enter_5F_group (ioArgument_ioXcodeProjectDescription, GALGAS_string ("Products"), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mProductGroupChildrenList (SOURCE_FILE_AT_LINE (1401)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1397)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_Xcode_5F_PBXGroup var_mainGroup = GALGAS_Xcode_5F_PBXGroup::constructor_new (ioArgument_ioXcodeProjectDescription.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1404)), GALGAS_string::makeEmptyString (), GALGAS_string::makeEmptyString (), ioArgument_ioXcodeProjectDescription.reader_mMainGroupChildrenList (SOURCE_FILE_AT_LINE (1404)) COMMA_SOURCE_FILE_AT_LINE (1404)) ;
  //-------- @incrementInstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mSequenceNumber.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioXcodeProjectDescription.mAttribute_mProjectGroupList.addAssign_operation (var_mainGroup COMMA_SOURCE_FILE_AT_LINE (1406)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_string var_fileNewContents ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildXcodeProjectString (ioArgument_ioXcodeProjectDescription, var_projectName, function_getPBXFileReferenceKey (var_mainGroup.reader_mSequenceNumber (SOURCE_FILE_AT_LINE (1412)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)), function_getPBXFileReferenceKey (var_defaultProjectConfiguration.reader_mSequenceNumber_32_ (SOURCE_FILE_AT_LINE (1413)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1413)), var_fileNewContents, inCompiler COMMA_SOURCE_FILE_AT_LINE (1409)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1416)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_in_5F_xcodeproj_5F_filePath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_written ;
    //-------- @methodCallInstructionForGeneration
    var_fileNewContents.method_writeToFileWhenDifferentContents (constinArgument_inReferenceFilePath, var_written, inCompiler COMMA_SOURCE_FILE_AT_LINE (1421)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_pbxprojFilePath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/project.pbxproj") COMMA_SOURCE_FILE_AT_LINE (1422)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_written.operator_or (var_pbxprojFilePath.reader_fileExists (SOURCE_FILE_AT_LINE (1423)).operator_not (SOURCE_FILE_AT_LINE (1423)) COMMA_SOURCE_FILE_AT_LINE (1423)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_61833_0 ; // Joker input parameter
      var_fileNewContents.method_writeToFileWhenDifferentContents (var_pbxprojFilePath, joker_61833_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1424)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_stringlist var_pbxuser_5F_files = constinArgument_in_5F_xcodeproj_5F_filePath.reader_regularFilesWithExtensions (GALGAS_bool (false), GALGAS_stringlist::constructor_listWithValue (GALGAS_string ("pbxuser") COMMA_SOURCE_FILE_AT_LINE (1426)) COMMA_SOURCE_FILE_AT_LINE (1426)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_62056 (var_pbxuser_5F_files, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_62056.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_fullPath = constinArgument_in_5F_xcodeproj_5F_filePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1428)).operator_concat (enumerator_62056.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1428)) ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_string::class_method_deleteFile (var_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (1429)) ;
        } //-------- @routineCallInstructionForGeneration
        enumerator_62056.gotoNextObject () ;
      }
    }
  }
}
