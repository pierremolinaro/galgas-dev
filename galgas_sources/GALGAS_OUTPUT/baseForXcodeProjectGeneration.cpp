    ...
    "\n")) ;
  {
    ...
    if ((operand_48631 != NULL)) {
      ...
      do{
        ...
        if (operand_48631->mFile.isBuilt ()) {
          operand_48631->mFile (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1148)) ;
        }
  ...
  }
  {
    ...
    if ((operand_48899 != NULL)) {
      ...
      do{
        ...
        if (operand_48899->mInfo.mFileReference.isBuilt ()) {
          operand_48899->mInfo.mFileReference (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1154)) ;
        }
  ...
  }
  {
    ...
    if ((operand_49189 != NULL)) {
      ...
      do{
        ...
        if (operand_49189->mBuildPhase.isBuilt ()) {
          operand_49189->mBuildPhase (HERE)->method_buildXcodeProject (inLexique, var_cas_outString COMMA_SOURCE_FILE_AT_LINE (1160)) ;
        }
    ...
    "\n") ;
  {
    ...
    if ((operand_50602 != NULL)) {
      ...
      do{
        ...
        if (operand_50602->mProduct.isBuilt ()) {
          operand_50602->mProduct (HERE)->method_productExtension (inLexique, var_cas_productExtension COMMA_SOURCE_FILE_AT_LINE (1202)) ;
        }
        var_cas_outString.appendCString ("\t\t\t);\n"
        "\t\t\tbuildRules = (\n"
        "\t\t\t);\n"
...
void routine_generateXCodeFile (C_Compiler & inLexique,
  ...
  if (cond_58871.isBuiltAndTrue ()) {
    if (var_cas_in_xcodeproj_filePath.isBuilt ()) {
      var_cas_in_xcodeproj_filePath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (1374)) ;
    }
    GGS_bool var_cas_written ;
    if (var_cas_fileNewContents.isBuilt ()) {
      var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_inReferenceFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (1377)) ;
    }
    ...
    if (cond_58860.isBuiltAndTrue ()) {
      ...
      if (var_cas_fileNewContents.isBuilt ()) {
        var_cas_fileNewContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_in_xcodeproj_filePath).operator_concat (GGS_string ("/project.pbxproj")), automatic_var_58502_0 COMMA_SOURCE_FILE_AT_LINE (1379)) ;
      }
