...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG GALGAS_unifiedTypeMapProxy reader_mAttributeTypeIndexForKey (const class GALGAS_string & constinOperand0,
                                                                                         C_Compiler * inCompiler
                                                                                         COMMA_LOCATION_ARGS) const ;
...
class GALGAS_stringset function_forbiddenKeysForStruct (C_Compiler * inCompiler
                                                        COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG GALGAS_uint reader_mIndexForKey (const class GALGAS_string & constinOperand0,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) const ;
...
class GALGAS_stringset function_forbiddenKeysForMap (C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) ;
