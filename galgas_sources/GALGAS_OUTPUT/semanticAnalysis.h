...
class GGS_filewrapperRegularFileMap ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     Map '@filewrapperRegularFileMap'                      *
//                                                                           *
//---------------------------------------------------------------------------*

class elementOf_GGS_filewrapperRegularFileMap ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_filewrapperRegularFileMap ;

//---------------------------------------------------------------------------*

class GGS_filewrapperRegularFileMap : public AC_GGS_map {
//--- Element Class
  public : typedef elementOf_GGS_filewrapperRegularFileMap cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_filewrapperRegularFileMap & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_filewrapperRegularFileMap & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_filewrapperRegularFileMap castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_filewrapperRegularFileMap * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_filewrapperRegularFileMap * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_filewrapperRegularFileMap constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;

//--- 'mapWithKeyAndValue' constructor
  public : static GGS_filewrapperRegularFileMap constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey
,
                                             const GGS_uint & inValue0,
...
//--- Internal method for searching for an element
  protected : void searchElement (C_Compiler & inLexique,
                                  ...
                                  COMMA_LOCATION_ARGS) const ;
  public : virtual GGS_string reader_description (const PMSInt32 inIndentation = 0) const ;
  public : static GGS_filewrapperRegularFileMap constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_filewrapperRegularFileMap & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_filewrapperRegularFileMap reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Map Enumerator
  public : class cEnumerator : public cAbstractMapEnumerator {
  //--- Constructors
    public : inline cEnumerator (const GGS_filewrapperRegularFileMap & inMap,
                                 const bool inAscending) :
    cAbstractMapEnumerator (inMap, inAscending) {
    }
    public : inline cEnumerator (const GGS_filewrapperRegularFileMap & inMap) :
...
void routine_recursivelyEnumerateDirectories (C_Compiler &,
                                ...
                                GGS_uint  &,
                                GGS_uint  &,
                                GGS_filewrapperRegularFileMap  & COMMA_LOCATION_ARGS) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//               Element of map '@filewrapperRegularFileMap'                 *
//                                                                           *
//---------------------------------------------------------------------------*
...
class e_filewrapperRegularFileMap {
  ...
  public : e_filewrapperRegularFileMap (void) ;
} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_filewrapperRegularFileMap : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_filewrapperRegularFileMap (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_filewrapperRegularFileMap & inInfo,
                                     const PMUInt32 inInitialState = 0) ;
//--- Get pointers
  public : inline elementOf_GGS_filewrapperRegularFileMap * nextObject (void) const { return (elementOf_GGS_filewrapperRegularFileMap *) mNextItem ; }
  public : inline elementOf_GGS_filewrapperRegularFileMap * infObject (void) const { return (elementOf_GGS_filewrapperRegularFileMap *) mInfPtr ; }
  public : inline elementOf_GGS_filewrapperRegularFileMap * supObject (void) const { return (elementOf_GGS_filewrapperRegularFileMap *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_filewrapperRegularFileMap mInfo ;
//--- Method for 'description' reader
  public : void appendForMapDescription (const PMSInt32 inElementIndex,
                                         C_String & ioString,
                                         const PMSInt32 inIndentation) const ;
