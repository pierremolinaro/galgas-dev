    ...
    case 4 : {
      ...
      switch (select_expressionModelBuilder_12 (_inLexique)) {
        case 1 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          var_cas_expression = GGS_filewrapperInExpression::constructor_new (_inLexique, var_cas_filewrapperName, var_cas_filePath COMMA_HERE) ;
          } break ;
        case 2 : {
          ...
          GGS_outExpressionList  var_cas_expressionList ;
          var_cas_expressionList = nt_output_expression_list_ (_inLexique) ;
          var_cas_expression = GGS_filewrapperTemplateInExpression::constructor_new (_inLexique, var_cas_filewrapperName, var_cas_filewrapperTemplateName, var_cas_expressionList COMMA_HERE) ;
          } break ;
        default :
          break ;
      }
