...
void expressionModelBuilder::
pr_factor_expressionModelBuilder_588_13_ (galgas_scanner & inLexique,
                                GGS_semanticExpression  &var_cas_outExpression) {
...
void expressionModelBuilder::
pr_factor_expressionModelBuilder_608_13_ (galgas_scanner & inLexique,
                                GGS_semanticExpression  &var_cas_outExpression) {
...
void expressionModelBuilder::
pr_output_expression_list_expressionModelBuilder_622_29_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_expressionModelBuilder_14 (inLexique)) {
        case 2 : {
