...
GGS_semanticExpression expressionModelBuilder::
expressionModelBuilder::
pr_factor_expressionModelBuilder_281_6_ (galgas_scanner & _inLexique) {
  GGS_semanticExpression  var_cas_expression ;
...
GGS_semanticExpression expressionModelBuilder::
expressionModelBuilder::
pr_factor_expressionModelBuilder_320_6_ (galgas_scanner & _inLexique) {
  GGS_semanticExpression  var_cas_expression ;
  GGS_location  var_cas_operatorLocation ;
  var_cas_operatorLocation = GGS_location (_inLexique) ;
...
GGS_semanticExpression expressionModelBuilder::
expressionModelBuilder::
pr_factor_expressionModelBuilder_333_6_ (galgas_scanner & _inLexique) {
  GGS_semanticExpression  var_cas_expression ;
  GGS_location  var_cas_operatorLocation ;
  var_cas_operatorLocation = GGS_location (_inLexique) ;
...
GGS_semanticExpression expressionModelBuilder::
expressionModelBuilder::
pr_factor_expressionModelBuilder_346_6_ (galgas_scanner & _inLexique) {
  GGS_semanticExpression  var_cas_expression ;
  GGS_location  var_cas_operatorLocation ;
  var_cas_operatorLocation = GGS_location (_inLexique) ;
