...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  GGS_uint _variant_16671 = var_cas_inTypeCount ;
  GGS_bool _condition_16671 (_variant_16671._isBuilt (), true) ;
  while (_condition_16671.isBuiltAndTrue ()) {
    _condition_16671 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_16671.isBuiltAndTrue ()) {
      if (_variant_16671.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (368)) ;
        _condition_16671 = GGS_bool (true, false) ;
      }else{
        _variant_16671._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superClassIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))).isBuiltAndTrue ()) {
          ...
          const GGS_typeMapIndex  _temp_15636 = var_cas_superClassIndex ;
          if (_temp_15636._isBuilt ()) {
            _temp_15636 (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (345)) ;
          }
          ...
          { const GGS_ACGalgasType _var_16346 = var_cas_t ; // CAST instruction
            if (_var_16346.getPtr () != NULL) {
              macroValidPointer (_var_16346.getPtr ()) ;
              if (dynamic_cast <cPtr_classGalgasType *> (_var_16346.getPtr ()) != NULL) {
                const GGS_classGalgasType var_cas_kClassType (_var_16346.getPtr ()) ;
...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_19186 = var_cas_inTypeCount ;
  GGS_bool _condition_19186 (_variant_19186._isBuilt (), true) ;
  while (_condition_19186.isBuiltAndTrue ()) {
    _condition_19186 = ((var_cas_superEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (403)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_19186.isBuiltAndTrue ()) {
      if (_variant_19186.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (431)) ;
        _condition_19186 = GGS_bool (true, false) ;
      }else{
        _variant_19186._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superEntityIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (404))).isBuiltAndTrue ()) {
          ...
          GGS_ACGalgasType  var_cas_t ;
          const GGS_typeMapIndex  _temp_18127 = var_cas_superEntityIndex ;
          if (_temp_18127._isBuilt ()) {
            _temp_18127 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (408)) ;
          }
          ...
          { const GGS_ACGalgasType _var_18853 = var_cas_t ; // CAST instruction
            if (_var_18853.getPtr () != NULL) {
              macroValidPointer (_var_18853.getPtr ()) ;
              if (dynamic_cast <cPtr_entityGalgasType *> (_var_18853.getPtr ()) != NULL) {
                const GGS_entityGalgasType var_cas_kClassType (_var_18853.getPtr ()) ;
...
method_getInheritedAttributeList (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_20315 = GGS_uint::constructor_max (_inLexique COMMA_HERE) ;
  GGS_bool _condition_20315 (_variant_20315._isBuilt (), true) ;
  while (_condition_20315.isBuiltAndTrue ()) {
    _condition_20315 = (var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)))._operator_and (var_cas_ok) ;
    if (_condition_20315.isBuiltAndTrue ()) {
      if (_variant_20315.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (464)) ;
        _condition_20315 = GGS_bool (true, false) ;
      }else{
        _variant_20315._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        const GGS_typeMapIndex  _temp_19862 = var_cas_entityIndex ;
        if (_temp_19862._isBuilt ()) {
          _temp_19862 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (454)) ;
        }
        { const GGS_ACGalgasType _var_20298 = var_cas_superType ; // CAST instruction
          if (_var_20298.getPtr () != NULL) {
            macroValidPointer (_var_20298.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_20298.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_20298.getPtr ()) ;
...
method_getAllAttributeList (C_Compiler & _inLexique,
  ...
  const GGS_entityGalgasType  _temp_20454 = (*this) ;
  if (_temp_20454._isBuilt ()) {
    _temp_20454 (HERE)->method_getInheritedAttributeList (_inLexique, var_cas_outAllPropertyList COMMA_SOURCE_FILE_AT_LINE (473)) ;
  }
...
method_enterInSortedList (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_21434 = var_cas_inTypeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (487)) ;
  GGS_bool _condition_21434 (_variant_21434._isBuilt (), true) ;
  while (_condition_21434.isBuiltAndTrue ()) {
    _condition_21434 = (var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (488)))._operator_and (var_cas_ok) ;
    if (_condition_21434.isBuiltAndTrue ()) {
      if (_variant_21434.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (501)) ;
        _condition_21434 = GGS_bool (true, false) ;
      }else{
        _variant_21434._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        const GGS_typeMapIndex  _temp_20999 = var_cas_entityIndex ;
        if (_temp_20999._isBuilt ()) {
          _temp_20999 (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (491)) ;
        }
        ...
        { const GGS_ACGalgasType _var_21417 = var_cas_superType ; // CAST instruction
          if (_var_21417.getPtr () != NULL) {
            macroValidPointer (_var_21417.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_21417.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_21417.getPtr ()) ;
...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  const GGS_entityGalgasType  _temp_21975 = (*this) ;
  if (_temp_21975._isBuilt ()) {
    _temp_21975 (HERE)->method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (525)) ;
  }
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_attributeList::cEnumerator enumerator_22594 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_22594 = NULL ;
    while (((operand_22594 = (GGS_attributeList::cElement *) enumerator_22594.nextObject ()))) {
      macroValidPointer (operand_22594) ;
      var_cas_ioGeneratedUserZone3.writeString (",\n"
        ""
      "                                const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_22594->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (540))) ;
  ...
  "//--- Readers\n"
    "") ;
  GGS_attributeList::cEnumerator enumerator_23334 (var_cas_allAttributeList, true) ;
  const GGS_attributeList::cElement * operand_23334 = NULL ;
  while (((operand_23334 = (GGS_attributeList::cElement *) enumerator_23334.nextObject ()))) {
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedUserZone3 COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  const GGS_entityGalgasType  _temp_25887 = (*this) ;
  if (_temp_25887._isBuilt ()) {
    _temp_25887 (HERE)->method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
  ...
  "//--- Attributes\n"
    "") ;
  GGS_attributeList::cEnumerator enumerator_26328 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_26328 = NULL ;
  while (((operand_26328 = (GGS_attributeList::cElement *) enumerator_26328.nextObject ()))) {
    macroValidPointer (operand_26328) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26328->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (613))) ;
    var_cas_ioGeneratedUserZone3.writeString (" ") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26328->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" ;\n"
      "") ;
  }
  enumerator_26328.reset () ;
  var_cas_ioGeneratedUserZone3.writeString ("\n"
    ""
  "//--- Constructor\n"
    ""
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (619)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_26779 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_26779 = NULL ;
    while (((operand_26779 = (GGS_attributeList::cElement *) enumerator_26779.nextObject ()))) {
      macroValidPointer (operand_26779) ;
      ...
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26779->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (628))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
...
method_generateImplementation (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedCode COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  const GGS_entityGalgasType  _temp_28543 = (*this) ;
  if (_temp_28543._isBuilt ()) {
    _temp_28543 (HERE)->method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (665)) ;
  }
  GGS_attributeList  var_cas_inheritedAttributeList ;
  const GGS_entityGalgasType  _temp_28639 = (*this) ;
  if (_temp_28639._isBuilt ()) {
    _temp_28639 (HERE)->method_getInheritedAttributeList (_inLexique, var_cas_inheritedAttributeList COMMA_SOURCE_FILE_AT_LINE (667)) ;
  }
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (671)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_28993 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_28993 = NULL ;
    while (((operand_28993 = (GGS_attributeList::cElement *) enumerator_28993.nextObject ()))) {
      macroValidPointer (operand_28993) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.writeString (",\n"
          ""
        "                                ") ;
      ...
      var_cas_ioGeneratedCode._dotAssign_operation (operand_28993->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))) ;
  ...
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (687))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_inheritedAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (689)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_n ;
      var_cas_n = GGS_uint (true, 0U) ;
      GGS_attributeList::cEnumerator enumerator_29697 (var_cas_inheritedAttributeList, true) ;
      const GGS_attributeList::cElement * operand_29697 = NULL ;
      while (((operand_29697 = (GGS_attributeList::cElement *) enumerator_29697.nextObject ()))) {
        macroValidPointer (operand_29697) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n"
            ""
          "                                ") ;
  ...
  GGS_attributeList::cEnumerator enumerator_30193 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_30193 = NULL ;
  while (((operand_30193 = (GGS_attributeList::cElement *) enumerator_30193.nextObject ()))) {
    macroValidPointer (operand_30193) ;
    var_cas_ioGeneratedCode.writeString (",\n"
      "") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_30193->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (argument_") ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (718)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_attributeList::cEnumerator enumerator_30875 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_30875 = NULL ;
    while (((operand_30875 = (GGS_attributeList::cElement *) enumerator_30875.nextObject ()))) {
      macroValidPointer (operand_30875) ;
      ...
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30875->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString ("._operator_isEqual (_p->") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30875->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString (").boolValue ()") ;
    }
    enumerator_30875.reset () ;
    var_cas_ioGeneratedCode.writeString (" ;\n"
      ""
    "  }\n"
      "") ;
  ...
  GGS_bool var_cas_firstLoop ;
  var_cas_firstLoop = GGS_bool (true, true) ;
  GGS_attributeList::cEnumerator enumerator_32231 (var_cas_allAttributeList, true) ;
  const GGS_attributeList::cElement * operand_32231 = NULL ;
  while (((operand_32231 = (GGS_attributeList::cElement *) enumerator_32231.nextObject ()))) {
    macroValidPointer (operand_32231) ;
    if ((var_cas_firstLoop).isBuiltAndTrue ()) {
      var_cas_firstLoop = GGS_bool (true, false) ;
    }else{
    ...
    "  ioString << \"|-\" ;\n"
      ""
    "  ioString << ") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_32231->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (".reader_description  (_inLexique COMMA_THERE, inIndentation) ;\n"
      "") ;
  }
  enumerator_32231.reset () ;
  var_cas_ioGeneratedCode.writeString ("}\n"
    "\n"
    "") ;
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_37105 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_37105 = NULL ;
    while (((operand_37105 = (GGS_attributeList::cElement *) enumerator_37105.nextObject ()))) {
      macroValidPointer (operand_37105) ;
      var_cas_ioGeneratedCode.writeString (",\n"
        "                                "
      "const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_37105->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (871))) ;
      var_cas_ioGeneratedCode.writeString (" & argument_") ;
    ...
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (879)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      var_cas_n = GGS_uint (true, 0U) ;
      GGS_attributeList::cEnumerator enumerator_37696 (var_cas_allAttributeList, true) ;
      const GGS_attributeList::cElement * operand_37696 = NULL ;
      while (((operand_37696 = (GGS_attributeList::cElement *) enumerator_37696.nextObject ()))) {
        macroValidPointer (operand_37696) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n"
            "                                ") ;
        }
  ...
  GGS_attributeList::cEnumerator enumerator_38130 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_38130 = NULL ;
  while (((operand_38130 = (GGS_attributeList::cElement *) enumerator_38130.nextObject ()))) {
    macroValidPointer (operand_38130) ;
    var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
    var_cas_ioGeneratedCode.writeString ("GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38130->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (899))) ;
    var_cas_ioGeneratedCode.writeString (" GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
    var_cas_ioGeneratedCode.writeString ("::\n"
      ""
    "reader_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38130->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {\n"
      ""
    "  GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38130->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (901))) ;
    var_cas_ioGeneratedCode.writeString (" result ;\n"
      ""
    "  if (mPointer != NULL) {\n"
      ""
