...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  var_cas_classPath = mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (329)) ;
  GGS_stringset  var_cas_superClassSet ;
  var_cas_superClassSet = GGS_stringset::constructor_setWithString (_inLexique, mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_HERE) ;
  ...
  GGS_uint _variant_16583 = var_cas_inTypeCount ;
  GGS_bool _condition_16583 (_variant_16583._isBuilt (), true) ;
  while (_condition_16583.isBuiltAndTrue ()) {
    _condition_16583 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_16583.isBuiltAndTrue ()) {
      if (_variant_16583.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (364)) ;
        _condition_16583 = GGS_bool (true, false) ;
      }else{
        _variant_16583._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superClassIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (336))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_superClassName ;
          GGS_ACGalgasType  var_cas_t ;
          if (var_cas_superClassIndex._isBuilt ()) {
            var_cas_superClassIndex (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (340)) ;
          }
          var_cas_circularityError = var_cas_superClassSet.reader_hasKey (_inLexique, var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)) ;
          var_cas_superClassSet._addAssign_operation (var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (343))) ;
          var_cas_classPath.writeString (".") ;
          var_cas_classPath._dotAssign_operation (var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (344))) ;
          GGS_typeMapIndex  var_cas_superSuperClassIndex ;
          { const GGS_ACGalgasType _var_16258 = var_cas_t ; // CAST instruction
            if (_var_16258.getPtr () != NULL) {
              macroValidPointer (_var_16258.getPtr ()) ;
              if (dynamic_cast <cPtr_classGalgasType *> (_var_16258.getPtr ()) != NULL) {
                const GGS_classGalgasType var_cas_kClassType (_var_16258.getPtr ()) ;
                var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
              }else{
                mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (355)) ;
          ...
          var_cas_superClassName = var_cas_superClassIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) ;
          mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " does not exist")) COMMA_SOURCE_FILE_AT_LINE (363)) ;
        }
      }
    }
  }
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "inheritance circularity for class '"))._operator_concat (mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (369))))._operator_concat (GGS_string (true, "': ")))._operator_concat (var_cas_classPath.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "."), GGS_string (true, " extends ") COMMA_SOURCE_FILE_AT_LINE (370))) COMMA_SOURCE_FILE_AT_LINE (371)) ;
  }
}
...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  var_cas_entityPath = mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (391)) ;
  GGS_stringset  var_cas_superEntitySet ;
  var_cas_superEntitySet = GGS_stringset::constructor_setWithString (_inLexique, mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (392)) COMMA_HERE) ;
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_19064 = var_cas_inTypeCount ;
  GGS_bool _condition_19064 (_variant_19064._isBuilt (), true) ;
  while (_condition_19064.isBuiltAndTrue ()) {
    _condition_19064 = ((var_cas_superEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (397)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_19064.isBuiltAndTrue ()) {
      if (_variant_19064.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (426)) ;
        _condition_19064 = GGS_bool (true, false) ;
      }else{
        _variant_19064._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superEntityIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (398))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_superEntityName ;
          GGS_ACGalgasType  var_cas_t ;
          if (var_cas_superEntityIndex._isBuilt ()) {
            var_cas_superEntityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (402)) ;
          }
          var_cas_circularityError = var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)) ;
          var_cas_superEntitySet._addAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (405))) ;
          var_cas_entityPath.writeString (".") ;
          var_cas_entityPath._dotAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (406))) ;
          GGS_typeMapIndex  var_cas_superSuperEntityIndex ;
          { const GGS_ACGalgasType _var_18731 = var_cas_t ; // CAST instruction
            if (_var_18731.getPtr () != NULL) {
              macroValidPointer (_var_18731.getPtr ()) ;
              if (dynamic_cast <cPtr_entityGalgasType *> (_var_18731.getPtr ()) != NULL) {
                const GGS_entityGalgasType var_cas_kClassType (_var_18731.getPtr ()) ;
                var_cas_superSuperEntityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (411)) ;
              }else{
                mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (417)) ;
          ...
          var_cas_superEntityName = var_cas_superEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (421)) ;
          mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " does not exist")) COMMA_SOURCE_FILE_AT_LINE (425)) ;
        }
      }
    }
  }
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "inheritance circularity for entity '"))._operator_concat (mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (431))))._operator_concat (GGS_string (true, "': ")))._operator_concat (var_cas_entityPath.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "."), GGS_string (true, " extends ") COMMA_SOURCE_FILE_AT_LINE (432))) COMMA_SOURCE_FILE_AT_LINE (433)) ;
  }
}
...
method_enterInSortedList (C_Compiler & _inLexique,
  ...
  var_cas_sortDescriptor = mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (443)) ;
  GGS_typeMapIndex  var_cas_entityIndex ;
  var_cas_entityIndex = mSuperEntityIndex ;
  GGS_uint _variant_20145 = var_cas_inTypeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (445)) ;
  GGS_bool _condition_20145 (_variant_20145._isBuilt (), true) ;
  while (_condition_20145.isBuiltAndTrue ()) {
    _condition_20145 = var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (446)) ;
    if (_condition_20145.isBuiltAndTrue ()) {
      if (_variant_20145.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (459)) ;
        _condition_20145 = GGS_bool (true, false) ;
      }else{
        _variant_20145._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        if (var_cas_entityIndex._isBuilt ()) {
          var_cas_entityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (449)) ;
        }
        var_cas_sortDescriptor = ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (450)))._operator_concat (GGS_string (true, ".")))._operator_concat (var_cas_sortDescriptor) ;
        { const GGS_ACGalgasType _var_20128 = var_cas_superType ; // CAST instruction
          if (_var_20128.getPtr () != NULL) {
            macroValidPointer (_var_20128.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_20128.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_20128.getPtr ()) ;
              var_cas_entityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (453)) ;
            }else{
              mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (458)) ;
            }
          }
        }
      }
...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (483))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (mSuperEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (484))) ;
  }else{
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_21189 = mPropertyList ;
    const GGS_attributeList::element_type * operand_21189 = _var_21189.firstObject () ;
    while ((operand_21189 != NULL)) {
      macroValidPointer (operand_21189) ;
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_21189->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (495))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (496))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (497)) ;
      operand_21189 = operand_21189->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) ;\n\n") ;
  }
  ...
  "//--- Readers\n") ;
  const GGS_attributeList _var_21893 = mPropertyList ;
  const GGS_attributeList::element_type * operand_21893 = _var_21893.firstObject () ;
  while ((operand_21893 != NULL)) {
    macroValidPointer (operand_21893) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_21893->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (510))) ;
    var_cas_ioGeneratedUserZone3.writeString (" reader_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_21893->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;\n") ;
    operand_21893 = operand_21893->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- operator ()\n"
  "  #ifndef DO_NOT_GENERATE_CHECKINGS\n"
  ...
  GGS_uint  var_cas_n ;
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_23077 = mPropertyList ;
  const GGS_attributeList::element_type * operand_23077 = _var_23077.firstObject () ;
  while ((operand_23077 != NULL)) {
    macroValidPointer (operand_23077) ;
    var_cas_ioGeneratedUserZone3.writeString (",\n"
    "                                const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23077->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (532))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (533))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
    operand_23077 = operand_23077->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "                                COMMA_LOCATION_ARGS) ;\n\n"
  "//--- Get first object\n"
  ...
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_24413 = mPropertyList ;
  const GGS_attributeList::element_type * operand_24413 = _var_24413.firstObject () ;
  while ((operand_24413 != NULL)) {
    macroValidPointer (operand_24413) ;
    var_cas_ioGeneratedUserZone3.writeString (",\n"
    "                                const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_24413->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (559))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (560))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (561)) ;
    operand_24413 = operand_24413->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "                                COMMA_LOCATION_ARGS) ;\n\n"
  "//--- Internal Methods\n"
  ...
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_24861 = mPropertyList ;
  const GGS_attributeList::element_type * operand_24861 = _var_24861.firstObject () ;
  while ((operand_24861 != NULL)) {
    ...
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_24861->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (573))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (574))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (576)) ;
    operand_24861 = operand_24861->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString (") ;\n\n"
  "  protected : void _internalPrependValues (") ;
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_25292 = mPropertyList ;
  const GGS_attributeList::element_type * operand_25292 = _var_25292.firstObject () ;
  while ((operand_25292 != NULL)) {
    macroValidPointer (operand_25292) ;
    if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                ") ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_25292->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (586))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (587))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
    operand_25292 = operand_25292->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString (") ;\n\n"
  "//--- List Insulation\n"
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
  ...
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" : public ") ;
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (611))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("cPtr_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (mSuperEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (612))) ;
  }else{
    var_cas_ioGeneratedUserZone3.writeString (" C_GGS_MetamodelEntity") ;
  }
  var_cas_ioGeneratedUserZone3.writeString (" {\n"
  "//--- Attributes\n") ;
  const GGS_attributeList _var_26646 = mPropertyList ;
  const GGS_attributeList::element_type * operand_26646 = _var_26646.firstObject () ;
  while ((operand_26646 != NULL)) {
    macroValidPointer (operand_26646) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26646->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (619))) ;
    var_cas_ioGeneratedUserZone3.writeString (" ") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26646->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" ;\n") ;
    operand_26646 = operand_26646->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- Constructor\n"
  "  public : cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" (") ;
  if (((mPropertyList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (625)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("LOCATION_ARGS") ;
  }else{
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_27093 = mPropertyList ;
    const GGS_attributeList::element_type * operand_27093 = _var_27093.firstObject () ;
    while ((operand_27093 != NULL)) {
      macroValidPointer (operand_27093) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedUserZone3.writeString (",\n"
        "                                ") ;
      }
      var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_27093->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (634))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (636)) ;
      operand_27093 = operand_27093->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS") ;
  }
...
void routine_constructBuiltinTypeMap (C_Compiler & _inLexique,
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), GGS_stringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (761)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), GGS_charGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (762)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), GGS_boolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (763)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), GGS_uintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (764)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), GGS_sintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (765)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), GGS_uint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (766)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), GGS_sint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (767)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), GGS_doubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (768)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), GGS_lstringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (769)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), GGS_lcharGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (770)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), GGS_lboolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (771)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), GGS_luintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (772)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), GGS_lsintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (773)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), GGS_luint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (774)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), GGS_lsint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (775)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), GGS_ldoubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (776)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), GGS_binarysetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (777)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), GGS_stringsetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (778)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), GGS_locationGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (779)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (783)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_lstringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (786)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_stringIndex COMMA_SOURCE_FILE_AT_LINE (790)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_stringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_stringlist, var_cas_stringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (793)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_uint64Index COMMA_SOURCE_FILE_AT_LINE (797)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_uint64list, GGS_listGalgasType::constructor_new (_inLexique, var_cas_uint64list, var_cas_uint64Attribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (800)) ;
  #ifdef DEBUG_TRACE_ENABLED
