...
method_generateImplementation (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_first ;
  var_cas_first = GGS_bool (true, true) ;
  const GGS_attributeList _var_32208 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_32208 = _var_32208.firstObject () ;
  while ((operand_32208 != NULL)) {
    macroValidPointer (operand_32208) ;
    if ((var_cas_first).isBuiltAndTrue ()) {
      var_cas_first = GGS_bool (true, false) ;
    }else{
    ...
    "  ioString << \"|-\" ;\n"
    "  ioString << ") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_32208->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (".reader_description  (_inLexique COMMA_THERE, inIndentation) ;\n") ;
    operand_32208 = operand_32208->nextObject () ;
  }
  var_cas_ioGeneratedCode.writeString ("}\n\n") ;
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_37073 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_37073 = _var_37073.firstObject () ;
    while ((operand_37073 != NULL)) {
      macroValidPointer (operand_37073) ;
      var_cas_ioGeneratedCode.writeString (",\n                                "
      "const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_37073->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (871))) ;
      var_cas_ioGeneratedCode.writeString (" & argument_") ;
      ...
      operand_37073 = operand_37073->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString ("\n                                "
    "COMMA_LOCATION_ARGS) {\n"
    "  GGS_") ;
    ...
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (879)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_37663 = var_cas_allAttributeList ;
      const GGS_attributeList::element_type * operand_37663 = _var_37663.firstObject () ;
      while ((operand_37663 != NULL)) {
        macroValidPointer (operand_37663) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n                                ") ;
        }
        var_cas_ioGeneratedCode.writeString ("argument_") ;
        ...
        operand_37663 = operand_37663->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n                                "
      "COMMA_THERE)) ;\n") ;
    }
  ...
  const GGS_attributeList _var_38096 = mPropertyList ;
  const GGS_attributeList::element_type * operand_38096 = _var_38096.firstObject () ;
  while ((operand_38096 != NULL)) {
    macroValidPointer (operand_38096) ;
    var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
    var_cas_ioGeneratedCode.writeString ("GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38096->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (899))) ;
    var_cas_ioGeneratedCode.writeString (" GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
    var_cas_ioGeneratedCode.writeString ("::\n"
    "reader_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38096->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {\n"
    "  GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38096->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (901))) ;
    var_cas_ioGeneratedCode.writeString (" result ;\n"
    "  if (mPointer != NULL) {\n"
    "    macroValidPointer (mPointer) ;\n"
    ...
    "  return result ;\n"
    "}\n\n") ;
    operand_38096 = operand_38096->nextObject () ;
  }
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
