...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_locationGalgasType) {
    ...
    registerSingleton (& gSingleton_locationGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_stringGalgasType) {
    ...
    registerSingleton (& gSingleton_stringGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_charGalgasType) {
    ...
    registerSingleton (& gSingleton_charGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_boolGalgasType) {
    ...
    registerSingleton (& gSingleton_boolGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_uintGalgasType) {
    ...
    registerSingleton (& gSingleton_uintGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_sintGalgasType) {
    ...
    registerSingleton (& gSingleton_sintGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_uint64GalgasType) {
    ...
    registerSingleton (& gSingleton_uint64GalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_sint64GalgasType) {
    ...
    registerSingleton (& gSingleton_sint64GalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_doubleGalgasType) {
    ...
    registerSingleton (& gSingleton_doubleGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lstringGalgasType) {
    ...
    registerSingleton (& gSingleton_lstringGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lcharGalgasType) {
    ...
    registerSingleton (& gSingleton_lcharGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lboolGalgasType) {
    ...
    registerSingleton (& gSingleton_lboolGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_luintGalgasType) {
    ...
    registerSingleton (& gSingleton_luintGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lsintGalgasType) {
    ...
    registerSingleton (& gSingleton_lsintGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_luint64GalgasType) {
    ...
    registerSingleton (& gSingleton_luint64GalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lsint64GalgasType) {
    ...
    registerSingleton (& gSingleton_lsint64GalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_ldoubleGalgasType) {
    ...
    registerSingleton (& gSingleton_ldoubleGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_stringsetGalgasType) {
    ...
    registerSingleton (& gSingleton_stringsetGalgasType) ;
  }
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_binarysetGalgasType) {
    ...
    registerSingleton (& gSingleton_binarysetGalgasType) ;
  }
...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_22594 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_22594 = _var_22594.firstObject () ;
    while ((operand_22594 != NULL)) {
      ...
      operand_22594 = operand_22594->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) ;\n\n") ;
  }
  ...
  "//--- Readers\n") ;
  const GGS_attributeList _var_23333 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_23333 = _var_23333.firstObject () ;
  while ((operand_23333 != NULL)) {
    ...
    operand_23333 = operand_23333->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- operator ()\n"
  "  #ifndef DO_NOT_GENERATE_CHECKINGS\n"
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
  ...
  var_cas_ioGeneratedUserZone3.writeString (" {\n"
  "//--- Attributes\n") ;
  const GGS_attributeList _var_26326 = mPropertyList ;
  const GGS_attributeList::element_type * operand_26326 = _var_26326.firstObject () ;
  while ((operand_26326 != NULL)) {
    ...
    var_cas_ioGeneratedUserZone3.writeString (" ;\n") ;
    operand_26326 = operand_26326->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- Constructor\n"
  "  public : cPtr_") ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (619)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_26776 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_26776 = _var_26776.firstObject () ;
    while ((operand_26776 != NULL)) {
      ...
      operand_26776 = operand_26776->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS") ;
  }
...
method_generateImplementation (C_Compiler & _inLexique,
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (671)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_28989 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_28989 = _var_28989.firstObject () ;
  ...
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (687))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_inheritedAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (689)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_n ;
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_29692 = var_cas_inheritedAttributeList ;
      const GGS_attributeList::element_type * operand_29692 = _var_29692.firstObject () ;
      while ((operand_29692 != NULL)) {
        ...
        operand_29692 = operand_29692->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n"
      "                                COMMA_THERE)") ;
    }
  ...
  const GGS_attributeList _var_30187 = mPropertyList ;
  const GGS_attributeList::element_type * operand_30187 = _var_30187.firstObject () ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (718)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_30864 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_30864 = _var_30864.firstObject () ;
    while ((operand_30864 != NULL)) {
      ...
      operand_30864 = operand_30864->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString (" ;\n"
    "  }\n") ;
  }
  ...
  GGS_bool var_cas_first ;
  var_cas_first = GGS_bool (true, true) ;
  const GGS_attributeList _var_32207 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_32207 = _var_32207.firstObject () ;
  while ((operand_32207 != NULL)) {
    ...
    operand_32207 = operand_32207->nextObject () ;
  }
  var_cas_ioGeneratedCode.writeString ("}\n\n") ;
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_37072 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_37072 = _var_37072.firstObject () ;
    while ((operand_37072 != NULL)) {
      ...
      operand_37072 = operand_37072->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString ("\n                                "
    "COMMA_LOCATION_ARGS) {\n"
    "  GGS_") ;
    ...
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (879)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_37662 = var_cas_allAttributeList ;
      const GGS_attributeList::element_type * operand_37662 = _var_37662.firstObject () ;
      while ((operand_37662 != NULL)) {
        ...
        operand_37662 = operand_37662->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n                                "
      "COMMA_THERE)) ;\n") ;
    }
  ...
  const GGS_attributeList _var_38095 = mPropertyList ;
  const GGS_attributeList::element_type * operand_38095 = _var_38095.firstObject () ;
  while ((operand_38095 != NULL)) {
    ...
    "  return result ;\n"
    "}\n\n") ;
    operand_38095 = operand_38095->nextObject () ;
  }
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
