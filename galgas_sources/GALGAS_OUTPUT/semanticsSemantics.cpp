...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_19187 = var_cas_inTypeCount ;
  GGS_bool _condition_19187 (_variant_19187._isBuilt (), true) ;
  while (_condition_19187.isBuiltAndTrue ()) {
    _condition_19187 = ((var_cas_superEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (403)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_19187.isBuiltAndTrue ()) {
      if (_variant_19187.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (432)) ;
        _condition_19187 = GGS_bool (true, false) ;
      }else{
        _variant_19187._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superEntityIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (404))).isBuiltAndTrue ()) {
          ...
          if (var_cas_superEntityIndex._isBuilt ()) {
            var_cas_superEntityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (408)) ;
          }
...
method_getInheritedAttributeList (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_20316 = GGS_uint::constructor_max (_inLexique COMMA_HERE) ;
  GGS_bool _condition_20316 (_variant_20316._isBuilt (), true) ;
  while (_condition_20316.isBuiltAndTrue ()) {
    _condition_20316 = (var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)))._operator_and (var_cas_ok) ;
    if (_condition_20316.isBuiltAndTrue ()) {
      if (_variant_20316.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (465)) ;
        _condition_20316 = GGS_bool (true, false) ;
      }else{
        _variant_20316._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        if (var_cas_entityIndex._isBuilt ()) {
          var_cas_entityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (454)) ;
        }
        { const GGS_ACGalgasType _var_20299 = var_cas_superType ; // CAST instruction
          if (_var_20299.getPtr () != NULL) {
            macroValidPointer (_var_20299.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_20299.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_20299.getPtr ()) ;
              ...
              mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (463)) ;
              var_cas_ok = GGS_bool (true, false) ;
            }
          }
        }
...
method_getAllAttributeList (C_Compiler & _inLexique,
  ...
  method_getInheritedAttributeList (_inLexique, var_cas_outAllPropertyList COMMA_SOURCE_FILE_AT_LINE (473)) ;
...
method_enterInSortedList (C_Compiler & _inLexique,
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_21435 = var_cas_inTypeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (487)) ;
  GGS_bool _condition_21435 (_variant_21435._isBuilt (), true) ;
  while (_condition_21435.isBuiltAndTrue ()) {
    _condition_21435 = (var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (488)))._operator_and (var_cas_ok) ;
    if (_condition_21435.isBuiltAndTrue ()) {
      if (_variant_21435.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (502)) ;
        _condition_21435 = GGS_bool (true, false) ;
      }else{
        _variant_21435._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        if (var_cas_entityIndex._isBuilt ()) {
          var_cas_entityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (491)) ;
        }
        ...
        { const GGS_ACGalgasType _var_21418 = var_cas_superType ; // CAST instruction
          if (_var_21418.getPtr () != NULL) {
            macroValidPointer (_var_21418.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_21418.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_21418.getPtr ()) ;
              var_cas_entityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (495)) ;
            }else{
              mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (500)) ;
              var_cas_ok = GGS_bool (true, false) ;
            }
          }
        }
...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (525)) ;
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_22595 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_22595 = _var_22595.firstObject () ;
    while ((operand_22595 != NULL)) {
      macroValidPointer (operand_22595) ;
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_22595->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (540))) ;
      ...
      operand_22595 = operand_22595->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) ;\n\n") ;
  }
  ...
  "//--- Readers\n") ;
  const GGS_attributeList _var_23334 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_23334 = _var_23334.firstObject () ;
  while ((operand_23334 != NULL)) {
    macroValidPointer (operand_23334) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23334->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (555))) ;
    var_cas_ioGeneratedUserZone3.writeString (" reader_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23334->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;\n") ;
    operand_23334 = operand_23334->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- operator ()\n"
  "  #ifndef DO_NOT_GENERATE_CHECKINGS\n"
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedUserZone3 COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (602)) ;
  ...
  var_cas_ioGeneratedUserZone3.writeString (" {\n"
  "//--- Attributes\n") ;
  const GGS_attributeList _var_26327 = mPropertyList ;
  const GGS_attributeList::element_type * operand_26327 = _var_26327.firstObject () ;
  while ((operand_26327 != NULL)) {
    macroValidPointer (operand_26327) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26327->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (613))) ;
    var_cas_ioGeneratedUserZone3.writeString (" ") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26327->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" ;\n") ;
    operand_26327 = operand_26327->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- Constructor\n"
  "  public : cPtr_") ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (619)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_26777 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_26777 = _var_26777.firstObject () ;
    while ((operand_26777 != NULL)) {
      macroValidPointer (operand_26777) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedUserZone3.writeString (",\n"
        "                                ") ;
      }
      var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26777->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (628))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
      ...
      operand_26777 = operand_26777->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS") ;
  }
...
method_generateImplementation (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedCode COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (665)) ;
  GGS_attributeList  var_cas_inheritedAttributeList ;
  method_getInheritedAttributeList (_inLexique, var_cas_inheritedAttributeList COMMA_SOURCE_FILE_AT_LINE (667)) ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (671)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_28990 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_28990 = _var_28990.firstObject () ;
    while ((operand_28990 != NULL)) {
      macroValidPointer (operand_28990) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.writeString (",\n"
        "                                ") ;
      }
      var_cas_ioGeneratedCode.writeString ("const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_28990->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))) ;
      ...
      operand_28990 = operand_28990->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) :\n") ;
  }
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (687))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_inheritedAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (689)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_n ;
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_29693 = var_cas_inheritedAttributeList ;
      const GGS_attributeList::element_type * operand_29693 = _var_29693.firstObject () ;
      while ((operand_29693 != NULL)) {
        macroValidPointer (operand_29693) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n"
          "                                ") ;
        }
        ...
        operand_29693 = operand_29693->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n"
      "                                COMMA_THERE)") ;
    }
  ...
  const GGS_attributeList _var_30188 = mPropertyList ;
  const GGS_attributeList::element_type * operand_30188 = _var_30188.firstObject () ;
  while ((operand_30188 != NULL)) {
    macroValidPointer (operand_30188) ;
    var_cas_ioGeneratedCode.writeString (",\n") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_30188->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (argument_") ;
    ...
    operand_30188 = operand_30188->nextObject () ;
  }
  var_cas_ioGeneratedCode.writeString (" {\n"
  "}\n\n") ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (718)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_30865 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_30865 = _var_30865.firstObject () ;
    while ((operand_30865 != NULL)) {
      macroValidPointer (operand_30865) ;
      ...
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30865->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString ("._operator_isEqual (_p->") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30865->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString (").boolValue ()") ;
      operand_30865 = operand_30865->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString (" ;\n"
    "  }\n") ;
  }
  ...
  GGS_bool var_cas_first ;
  var_cas_first = GGS_bool (true, true) ;
  const GGS_attributeList _var_31799 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_31799 = _var_31799.firstObject () ;
  while ((operand_31799 != NULL)) {
    macroValidPointer (operand_31799) ;
    if ((var_cas_first).isBuiltAndTrue ()) {
      var_cas_first = GGS_bool (true, false) ;
    }else{
    ...
    "  ioString << \"|-\" ;\n"
    "  ioString << ") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_31799->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (".reader_description  (_inLexique COMMA_THERE, inIndentation) ;\n") ;
    operand_31799 = operand_31799->nextObject () ;
  }
  var_cas_ioGeneratedCode.writeString ("}\n\n") ;
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
  ...
  "  sint32 result = ") ;
  var_cas_ioGeneratedCode._dotAssign_operation (mEntityIndexInMetamodel.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (776))) ;
  var_cas_ioGeneratedCode.writeString (" ;\n"
  "  if (inLevel > 0) {\n"
  "    result = -1 ;\n"
  "  }\n"
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_36664 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_36664 = _var_36664.firstObject () ;
    while ((operand_36664 != NULL)) {
      macroValidPointer (operand_36664) ;
      var_cas_ioGeneratedCode.writeString (",\n                                "
      "const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_36664->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (861))) ;
      var_cas_ioGeneratedCode.writeString (" & argument_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (862))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (863)) ;
      operand_36664 = operand_36664->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString ("\n                                "
    "COMMA_LOCATION_ARGS) {\n"
    "  GGS_") ;
    ...
    var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
    var_cas_ioGeneratedCode.writeString (" (") ;
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (869)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedCode.writeString ("THERE)) ;") ;
    }else{
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_37254 = var_cas_allAttributeList ;
      const GGS_attributeList::element_type * operand_37254 = _var_37254.firstObject () ;
      while ((operand_37254 != NULL)) {
        macroValidPointer (operand_37254) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n                                ") ;
        }
        var_cas_ioGeneratedCode.writeString ("argument_") ;
        var_cas_ioGeneratedCode._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (877))) ;
        var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (878)) ;
        operand_37254 = operand_37254->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n                                "
      "COMMA_THERE)) ;\n") ;
    }
  ...
  const GGS_attributeList _var_37687 = mPropertyList ;
  const GGS_attributeList::element_type * operand_37687 = _var_37687.firstObject () ;
  while ((operand_37687 != NULL)) {
    macroValidPointer (operand_37687) ;
    var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
    var_cas_ioGeneratedCode.writeString ("GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_37687->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (889))) ;
    var_cas_ioGeneratedCode.writeString (" GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
    var_cas_ioGeneratedCode.writeString ("::\n"
    "reader_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_37687->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {\n"
    "  GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_37687->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (891))) ;
    var_cas_ioGeneratedCode.writeString (" result ;\n"
    "  if (mPointer != NULL) {\n"
    "    macroValidPointer (mPointer) ;\n"
    ...
    "  return result ;\n"
    "}\n\n") ;
    operand_37687 = operand_37687->nextObject () ;
  }
  var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
...
void routine_constructBuiltinTypeMap (C_Compiler & _inLexique,
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), GGS_stringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1002)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), GGS_charGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), GGS_boolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1004)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), GGS_uintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1005)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), GGS_sintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), GGS_uint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), GGS_sint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1008)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), GGS_doubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1009)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), GGS_lstringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), GGS_lcharGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1011)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), GGS_lboolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), GGS_luintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1013)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), GGS_lsintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), GGS_luint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), GGS_lsint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1016)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), GGS_ldoubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1017)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), GGS_binarysetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1018)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), GGS_stringsetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1019)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), GGS_locationGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_lstringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1027)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_stringIndex COMMA_SOURCE_FILE_AT_LINE (1031)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_stringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_stringlist, var_cas_stringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1034)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_uint64Index COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_uint64list, GGS_listGalgasType::constructor_new (_inLexique, var_cas_uint64list, var_cas_uint64Attribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1041)) ;
  #ifdef DEBUG_TRACE_ENABLED
