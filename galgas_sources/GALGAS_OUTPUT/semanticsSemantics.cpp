...
modifier_readAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable cannot be read, it has no value") COMMA_SOURCE_FILE_AT_LINE (65)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableUsed ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable cannot be read, it is dropped") COMMA_SOURCE_FILE_AT_LINE (67)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localConstantDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local constant cannot be read, it has no value") COMMA_SOURCE_FILE_AT_LINE (69)) ;
    break ;
  case enum_localConstantDefined:
    mValue = enum_localContantUsed ;
    break ;
  ...
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the input parameter cannot be read, it is dropped") COMMA_SOURCE_FILE_AT_LINE (75)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
    break ;
...
modifier_readWriteAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable cannot be modified, has no value") COMMA_SOURCE_FILE_AT_LINE (84)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableUsed ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable cannot be modified, it is dropped") COMMA_SOURCE_FILE_AT_LINE (86)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localContantUsed ;
  ...
  case enum_inputFormalParameterDefined:
    mValue = enum_inputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the input parameter cannot be modified, has no value") COMMA_SOURCE_FILE_AT_LINE (92)) ;
    break ;
  case enum_inputFormalParameterUsed:
    mValue = enum_inputFormalParameterUsed ;
    break ;
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the input parameter cannot be modified, it is dropped") COMMA_SOURCE_FILE_AT_LINE (94)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
...
modifier_dropAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    ...
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable cannot be dropped, has no value") COMMA_SOURCE_FILE_AT_LINE (103)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableDropped ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableDropped ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the local variable is already dropped") COMMA_SOURCE_FILE_AT_LINE (105)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localContantUsed ;
  ...
  case enum_inputFormalParameterDefined:
    mValue = enum_inputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the input parameter cannot be dropped, has no value") COMMA_SOURCE_FILE_AT_LINE (111)) ;
    break ;
  case enum_inputFormalParameterUsed:
  ...
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDropped ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the input parameter is already dropped") COMMA_SOURCE_FILE_AT_LINE (113)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
...
operator_endOfRepeatedBranch (C_Compiler & _inLexique,
  ...
  if ((mValue > 0) && (inOperand.mValue > 0)) {
    ...
    if (error != 0) {
      switch (error) {
      case 1:
        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "error 1") COMMA_SOURCE_FILE_AT_LINE (121)) ;
      break ;
      case 2:
...
void GGS_typeMap::
modifier_setMTypeForKey (C_Compiler & inLexique,                        const GGS_ACGalgasType & inValue,
...
GGS_typeList::cElement * GGS_typeList::
...
GGS_signature::cElement * GGS_signature::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_attributeList::cElement * GGS_attributeList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
GGS_classMethodList::cElement * GGS_classMethodList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  var_cas_superClassSet = GGS_stringset ::constructor_setWithString (_inLexique, mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (503)) COMMA_HERE) ;
  ...
  GGS_uint _variant_26654 = var_cas_inTypeCount ;
  GGS_bool _condition_26654 (_variant_26654._isBuilt (), true) ;
  while (_condition_26654.isBuiltAndTrue ()) {
    _condition_26654 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_26654.isBuiltAndTrue ()) {
      if (_variant_26654.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (528)) ;
        _condition_26654 = GGS_bool (true, false) ;
      }else{
        _variant_26654._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superClassName ;
        GGS_ACGalgasType  var_cas_t ;
        const GGS_typeMapIndex  _temp_25907 = var_cas_superClassIndex ;
        if (_temp_25907._isBuilt ()) {
          _temp_25907 (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (512)) ;
        }
        ...
        { const GGS_ACGalgasType _var_26589 = var_cas_t ; // CAST instruction
          if (_var_26589.getPtr () != NULL) {
            macroValidPointer (_var_26589.getPtr ()) ;
            if (dynamic_cast <cPtr_classGalgasType *> (_var_26589.getPtr ()) != NULL) {
              const GGS_classGalgasType var_cas_kClassType (_var_26589.getPtr ()) ;
              var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (521)) ;
            }else{
              mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (526)) ;
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_28101 = mAssociatedListTypeIndex ;
  if (_temp_28101._isBuilt ()) {
    _temp_28101 (HERE)->method_searchKey (_inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (565)) ;
  }
  { const GGS_ACGalgasType _var_28372 = var_cas_t ; // CAST instruction
    if (_var_28372.getPtr () != NULL) {
      macroValidPointer (_var_28372.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_28372.getPtr ()) != NULL) {
      }else{
...
GGS_sortDescriptorList::cElement * GGS_sortDescriptorList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_30787 = mIndexOfMapType ;
  if (_temp_30787._isBuilt ()) {
    _temp_30787 (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (632)) ;
  }
  { const GGS_ACGalgasType _var_31043 = var_cas_t ; // CAST instruction
    if (_var_31043.getPtr () != NULL) {
      macroValidPointer (_var_31043.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_31043.getPtr ()) != NULL) {
      }else{
...
void GGS_routineMap::
modifier_setMRoutineSignatureForKey (C_Compiler & inLexique,                        const GGS_signature & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
GGS_classIndexList::cElement * GGS_classIndexList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    list map '@descendantClassListMap'                     *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_descendantClassListMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
object (GGS_classIndexList::constructor_emptyList ()) {
}

//---------------------------------------------------------------------------*

GGS_string GGS_descendantClassListMap::cElement::
...
GGS_descendantClassListMap::cNode * GGS_descendantClassListMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
...
GGS_descendantClassListMap::cNode * GGS_descendantClassListMap::cElement::_nodeClone (void) {
...
GGS_string GGS_descendantClassListMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@descendantClassListMap", inIndentation COMMA_THERE) ;
}
...
_addAssign_operation (const GGS_string & inKey,
  ...
  if (_isBuilt () && inKey._isBuilt () && inAttribute0._isBuilt ()) {
    ...
    node->object._addAssign_operation (inAttribute0) ;
  }
}
...
void GGS_semanticContext::_drop_operation (void) {
  ...
  mRoutineMap._drop_operation () ;
  mDescendantClassListMap._drop_operation () ;
}
...
constructor_new (const GGS_typeMap & argument_0,
  ...
  result.mDescendantClassListMap = argument_2 ;
  return result ;
}
