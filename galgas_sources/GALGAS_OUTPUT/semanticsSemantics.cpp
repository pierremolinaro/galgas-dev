...
internalSubListWithRange (GGS_typeList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mType) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
internalSubListWithRange (GGS_signature & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mAttributeTypeIndex, ptr->mFormalArgumentName, ptr->mFormalArgumentPassingMode) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
internalSubListWithRange (GGS_attributeList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mAttributeTypeIndex, ptr->mAttributeName) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
internalSubListWithRange (GGS_classMethodList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mMethodName, ptr->mMethodSignature) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  var_cas_classPath = mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (502)) ;
  GGS_stringset  var_cas_superClassSet ;
  var_cas_superClassSet = GGS_stringset ::constructor_setWithString (mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (503))) ;
    ...
    if (_condition_26713.isBuiltAndTrue ()) {
      if (_variant_26713.uintValue () == 0) {
        ...
        if (_temp_25968.isBuilt ()) {
          _temp_25968 (HERE)->method_searchKey (inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (512)) ;
        }
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  if (_temp_28230.isBuilt ()) {
    _temp_28230 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (565)) ;
  }
...
internalSubListWithRange (GGS_sortDescriptorList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mAttributeName, ptr->mAscending) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  if (_temp_31069.isBuilt ()) {
    _temp_31069 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (632)) ;
  }
...
internalSubListWithRange (GGS_classIndexList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mClassMapindex) ;
      ptr = ptr->nextObject () ;
    }
  }
}
