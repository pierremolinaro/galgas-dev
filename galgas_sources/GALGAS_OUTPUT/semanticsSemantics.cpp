...
constructor_new (C_Compiler & /* inLexique */
  ...
  macroMyNew (result.mPointer, cPtr_locationGalgasType (THERE)) ;
  return result ;
}
...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  GGS_uint _variant_16672 = var_cas_inTypeCount ;
  GGS_bool _condition_16672 (_variant_16672._isBuilt (), true) ;
  while (_condition_16672.isBuiltAndTrue ()) {
    _condition_16672 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_16672.isBuiltAndTrue ()) {
      if (_variant_16672.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (369)) ;
        _condition_16672 = GGS_bool (true, false) ;
      }else{
        _variant_16672._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superClassIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))).isBuiltAndTrue ()) {
          ...
          if (var_cas_superClassIndex._isBuilt ()) {
            var_cas_superClassIndex (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (345)) ;
          }
          ...
          { const GGS_ACGalgasType _var_16347 = var_cas_t ; // CAST instruction
            if (_var_16347.getPtr () != NULL) {
              macroValidPointer (_var_16347.getPtr ()) ;
              if (dynamic_cast <cPtr_classGalgasType *> (_var_16347.getPtr ()) != NULL) {
                const GGS_classGalgasType var_cas_kClassType (_var_16347.getPtr ()) ;
                var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
              }else{
                mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (360)) ;
          ...
          mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " does not exist")) COMMA_SOURCE_FILE_AT_LINE (368)) ;
        }
      }
    }
  }
...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  var_cas_entityPath = mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (396)) ;
  GGS_stringset  var_cas_superEntitySet ;
  var_cas_superEntitySet = GGS_stringset::constructor_setWithString (_inLexique, mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_HERE) ;
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_19153 = var_cas_inTypeCount ;
  GGS_bool _condition_19153 (_variant_19153._isBuilt (), true) ;
  while (_condition_19153.isBuiltAndTrue ()) {
    _condition_19153 = ((var_cas_superEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (402)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_19153.isBuiltAndTrue ()) {
      if (_variant_19153.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (431)) ;
        _condition_19153 = GGS_bool (true, false) ;
      }else{
        _variant_19153._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superEntityIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (403))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_superEntityName ;
          GGS_ACGalgasType  var_cas_t ;
          if (var_cas_superEntityIndex._isBuilt ()) {
            var_cas_superEntityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (407)) ;
          }
          var_cas_circularityError = var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (409)) ;
          var_cas_superEntitySet._addAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))) ;
          var_cas_entityPath.writeString (".") ;
          var_cas_entityPath._dotAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (411))) ;
          GGS_typeMapIndex  var_cas_superSuperEntityIndex ;
          { const GGS_ACGalgasType _var_18820 = var_cas_t ; // CAST instruction
            if (_var_18820.getPtr () != NULL) {
              macroValidPointer (_var_18820.getPtr ()) ;
              if (dynamic_cast <cPtr_entityGalgasType *> (_var_18820.getPtr ()) != NULL) {
                const GGS_entityGalgasType var_cas_kClassType (_var_18820.getPtr ()) ;
                var_cas_superSuperEntityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) ;
              }else{
          ...
          var_cas_superEntityName = var_cas_superEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (426)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (426)) ;
  ...
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "inheritance circularity for entity '"))._operator_concat (mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (436))))._operator_concat (GGS_string (true, "': ")))._operator_concat (var_cas_entityPath.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "."), GGS_string (true, " extends ") COMMA_SOURCE_FILE_AT_LINE (437))) COMMA_SOURCE_FILE_AT_LINE (438)) ;
  }
}
...
method_getAllAttributeList (C_Compiler & _inLexique,
  ...
  method_getInheritedAttributeList (_inLexique, var_cas_outAllPropertyList COMMA_SOURCE_FILE_AT_LINE (472)) ;
...
method_enterInSortedList (C_Compiler & _inLexique,
  ...
  var_cas_sortDescriptor = mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (483)) ;
  GGS_typeMapIndex  var_cas_entityIndex ;
  var_cas_entityIndex = mSuperEntityIndex ;
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_21419 = var_cas_inTypeMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (486)) ;
  GGS_bool _condition_21419 (_variant_21419._isBuilt (), true) ;
  while (_condition_21419.isBuiltAndTrue ()) {
    _condition_21419 = (var_cas_entityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (487)))._operator_and (var_cas_ok) ;
    if (_condition_21419.isBuiltAndTrue ()) {
      if (_variant_21419.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (501)) ;
        _condition_21419 = GGS_bool (true, false) ;
      }else{
        _variant_21419._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superEntityName ;
        GGS_ACGalgasType  var_cas_superType ;
        if (var_cas_entityIndex._isBuilt ()) {
          var_cas_entityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_superType COMMA_SOURCE_FILE_AT_LINE (490)) ;
        }
        var_cas_sortDescriptor = ((var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (491)))._operator_concat (GGS_string (true, ".")))._operator_concat (var_cas_sortDescriptor) ;
        { const GGS_ACGalgasType _var_21402 = var_cas_superType ; // CAST instruction
          if (_var_21402.getPtr () != NULL) {
            macroValidPointer (_var_21402.getPtr ()) ;
            if (dynamic_cast <cPtr_entityGalgasType *> (_var_21402.getPtr ()) != NULL) {
              const GGS_entityGalgasType var_cas_kClassType (_var_21402.getPtr ()) ;
              var_cas_entityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (494)) ;
            }else{
...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  var_cas_allAttributeList = mPropertyList ;
  ...
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (527))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (mSuperEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (528))) ;
  }else{
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    const GGS_attributeList _var_22597 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_22597 = _var_22597.firstObject () ;
    while ((operand_22597 != NULL)) {
      macroValidPointer (operand_22597) ;
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_22597->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (539))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (540))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
      operand_22597 = operand_22597->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) ;\n\n") ;
  }
  ...
  "//--- Readers\n") ;
  const GGS_attributeList _var_23336 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_23336 = _var_23336.firstObject () ;
  while ((operand_23336 != NULL)) {
    macroValidPointer (operand_23336) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23336->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (554))) ;
    var_cas_ioGeneratedUserZone3.writeString (" reader_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23336->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;\n") ;
    operand_23336 = operand_23336->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- operator ()\n"
  "  #ifndef DO_NOT_GENERATE_CHECKINGS\n"
  ...
  var_cas_ioGeneratedUserZone3.writeString ("class GGS__list_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" : public AC_galgas_list {\n"
  "  public : typedef cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" element_type ;\n"
  ...
  "  public : static GGS__list_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" constructor_listWithValue (C_Compiler & _inLexique") ;
  GGS_uint  var_cas_n ;
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_24565 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_24565 = _var_24565.firstObject () ;
  while ((operand_24565 != NULL)) {
    macroValidPointer (operand_24565) ;
    var_cas_ioGeneratedUserZone3.writeString (",\n"
    "                                const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_24565->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (576))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (577))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
    operand_24565 = operand_24565->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "                                COMMA_LOCATION_ARGS) ;\n\n"
  "//--- Get first object\n"
  ...
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_25958 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_25958 = _var_25958.firstObject () ;
  while ((operand_25958 != NULL)) {
    macroValidPointer (operand_25958) ;
    var_cas_ioGeneratedUserZone3.writeString (",\n"
    "                                const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_25958->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (603))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (604))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (605)) ;
    operand_25958 = operand_25958->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "                                COMMA_LOCATION_ARGS) ;\n\n"
  "//--- Internal Methods\n"
  ...
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_26431 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_26431 = _var_26431.firstObject () ;
  while ((operand_26431 != NULL)) {
    macroValidPointer (operand_26431) ;
    if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                ") ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26431->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (617))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (618))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (619)) ;
    operand_26431 = operand_26431->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString (") ;\n\n"
  "  protected : void _internalPrependValues (") ;
  var_cas_n = GGS_uint (true, 0U) ;
  const GGS_attributeList _var_26884 = var_cas_allAttributeList ;
  const GGS_attributeList::element_type * operand_26884 = _var_26884.firstObject () ;
  while ((operand_26884 != NULL)) {
    macroValidPointer (operand_26884) ;
    if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedUserZone3.writeString (",\n"
      "                                ") ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26884->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (629))) ;
    var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (630))) ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (631)) ;
    operand_26884 = operand_26884->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString (") ;\n\n"
  "//--- List Insulation\n"
  ...
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" & inOperand) ;\n"
  "} ;\n\n") ;
}
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
  ...
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" : public ") ;
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (655))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("cPtr_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (mSuperEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (656))) ;
  }else{
    var_cas_ioGeneratedUserZone3.writeString (" C_GGS_MetamodelEntity") ;
  }
  var_cas_ioGeneratedUserZone3.writeString (" {\n"
  "//--- Attributes\n") ;
  _inLexique.printMessage (C_String ("LOGGING mPropertyList: ") + mPropertyList.reader_description (_inLexique COMMA_HERE) + "\n" COMMA_SOURCE_FILE_AT_LINE (662)) ;
  const GGS_attributeList _var_28402 = mPropertyList ;
  const GGS_attributeList::element_type * operand_28402 = _var_28402.firstObject () ;
  while ((operand_28402 != NULL)) {
    macroValidPointer (operand_28402) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_28402->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (664))) ;
    var_cas_ioGeneratedUserZone3.writeString (" ") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_28402->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" ;\n") ;
    operand_28402 = operand_28402->nextObject () ;
  }
  var_cas_ioGeneratedUserZone3.writeString ("\n"
  "//--- Constructor\n"
  "  public : cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" (") ;
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (670)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedUserZone3.writeString ("LOCATION_ARGS") ;
  }else{
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_28852 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_28852 = _var_28852.firstObject () ;
    while ((operand_28852 != NULL)) {
      macroValidPointer (operand_28852) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedUserZone3.writeString (",\n"
        "                                ") ;
      }
      var_cas_ioGeneratedUserZone3.writeString ("const GGS_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_28852->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (679))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
      var_cas_ioGeneratedUserZone3._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (681)) ;
      operand_28852 = operand_28852->nextObject () ;
    }
    var_cas_ioGeneratedUserZone3.writeString ("\n"
    "                                COMMA_LOCATION_ARGS") ;
  }
  ...
  "  public : inline cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" * nextObject (void) const {\n"
  "    return (cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" *) internalNextItem () ;\n"
  "  }\n\n"
  "//--- Access to previous\n"
  "  public : inline cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" * previousObject (void) const {\n"
  "    return (cPtr_") ;
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" *) internalPreviousItem () ;\n"
  "  }\n\n"
  "//--- Element comparison\n"
  ...
  var_cas_ioGeneratedUserZone3._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedUserZone3.writeString (" * _cloneObject (void) const ;\n\n"
...
method_generateImplementation (C_Compiler & _inLexique,
  ...
  var_cas_inheritedAttributeList = GGS_attributeList::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
  var_cas_ioGeneratedCode.writeString (" (") ;
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (731)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedCode.writeString ("LOCATION_ARGS) :\n") ;
  }else{
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    const GGS_attributeList _var_31629 = var_cas_allAttributeList ;
    const GGS_attributeList::element_type * operand_31629 = _var_31629.firstObject () ;
    while ((operand_31629 != NULL)) {
      macroValidPointer (operand_31629) ;
      if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_ioGeneratedCode.writeString (",\n"
        "                                ") ;
      }
      var_cas_ioGeneratedCode.writeString ("const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_31629->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (740))) ;
      var_cas_ioGeneratedCode.writeString (" & argument_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (741))) ;
      var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (742)) ;
      operand_31629 = operand_31629->nextObject () ;
    }
    var_cas_ioGeneratedCode.writeString ("\n"
    "                                COMMA_LOCATION_ARGS) :\n") ;
  }
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (747))).isBuiltAndTrue ()) {
    var_cas_ioGeneratedCode.writeString ("cPtr_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (mSuperEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (748))) ;
    var_cas_ioGeneratedCode.writeString (" (") ;
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (749)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      var_cas_ioGeneratedCode.writeString ("THERE)") ;
    }else{
      GGS_uint  var_cas_n ;
      var_cas_n = GGS_uint (true, 0U) ;
      const GGS_attributeList _var_32326 = var_cas_allAttributeList ;
      const GGS_attributeList::element_type * operand_32326 = _var_32326.firstObject () ;
      while ((operand_32326 != NULL)) {
        ...
        var_cas_ioGeneratedCode.writeString ("argument_") ;
        var_cas_ioGeneratedCode._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (758))) ;
        var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (759)) ;
        operand_32326 = operand_32326->nextObject () ;
      }
      var_cas_ioGeneratedCode.writeString ("\n"
      "                                COMMA_THERE)") ;
    }
  }else{
    var_cas_ioGeneratedCode.writeString ("C_GGS_MetamodelEntity (THERE)") ;
  }
  GGS_uint  var_cas_n ;
  var_cas_n = var_cas_inheritedAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (767)) ;
  const GGS_attributeList _var_32825 = mPropertyList ;
  const GGS_attributeList::element_type * operand_32825 = _var_32825.firstObject () ;
  while ((operand_32825 != NULL)) {
    macroValidPointer (operand_32825) ;
    var_cas_ioGeneratedCode.writeString (",\n") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_32825->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (argument_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (769))) ;
    var_cas_ioGeneratedCode.writeString (")") ;
    var_cas_n._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (770)) ;
    operand_32825 = operand_32825->nextObject () ;
  }
  var_cas_ioGeneratedCode.writeString (" {\n"
  "}\n\n") ;
...
void routine_constructBuiltinTypeMap (C_Compiler & _inLexique,
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), GGS_stringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (864)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), GGS_charGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (865)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), GGS_boolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (866)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), GGS_uintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (867)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), GGS_sintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (868)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), GGS_uint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (869)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), GGS_sint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (870)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), GGS_doubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (871)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), GGS_lstringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (872)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), GGS_lcharGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (873)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), GGS_lboolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (874)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), GGS_luintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (875)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), GGS_lsintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (876)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), GGS_luint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (877)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), GGS_lsint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (878)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), GGS_ldoubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (879)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), GGS_binarysetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (880)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), GGS_stringsetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (881)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), GGS_locationGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (882)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (886)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_lstringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (889)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_stringIndex COMMA_SOURCE_FILE_AT_LINE (893)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_stringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_stringlist, var_cas_stringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (896)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_uint64Index COMMA_SOURCE_FILE_AT_LINE (900)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_uint64list, GGS_listGalgasType::constructor_new (_inLexique, var_cas_uint64list, var_cas_uint64Attribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (903)) ;
  #ifdef DEBUG_TRACE_ENABLED
