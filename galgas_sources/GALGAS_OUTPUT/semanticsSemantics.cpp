...
method_generateDeclaration_1_inHeader (C_Compiler & _inLexique,
  ...
  "//--- Readers\n"
    "") ;
  GGS_attributeList::cEnumerator enumerator_23333 (var_cas_allAttributeList, true) ;
  const GGS_attributeList::cElement * operand_23333 = NULL ;
  while (((operand_23333 = (GGS_attributeList::cElement *) enumerator_23333.nextObject ()))) {
    macroValidPointer (operand_23333) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23333->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (555))) ;
    var_cas_ioGeneratedUserZone3.writeString (" reader_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_23333->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;\n"
      "") ;
  }
  enumerator_23333.reset () ;
  var_cas_ioGeneratedUserZone3.writeString ("\n"
    ""
  "//--- operator ()\n"
    ""
...
method_generateDeclaration_2_inHeader (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedUserZone3 COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  const GGS_entityGalgasType  _temp_25885 = (*this) ;
  if (_temp_25885._isBuilt ()) {
    _temp_25885 (HERE)->method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
  ...
  "//--- Attributes\n"
    "") ;
  GGS_attributeList::cEnumerator enumerator_26326 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_26326 = NULL ;
  while (((operand_26326 = (GGS_attributeList::cElement *) enumerator_26326.nextObject ()))) {
    macroValidPointer (operand_26326) ;
    var_cas_ioGeneratedUserZone3.writeString ("  public : GGS_") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26326->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (613))) ;
    var_cas_ioGeneratedUserZone3.writeString (" ") ;
    var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26326->mAttributeName) ;
    var_cas_ioGeneratedUserZone3.writeString (" ;\n"
      "") ;
  }
  enumerator_26326.reset () ;
  var_cas_ioGeneratedUserZone3.writeString ("\n"
    ""
  "//--- Constructor\n"
    ""
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (619)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_26776 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_26776 = NULL ;
    while (((operand_26776 = (GGS_attributeList::cElement *) enumerator_26776.nextObject ()))) {
      ...
      var_cas_ioGeneratedUserZone3._dotAssign_operation (operand_26776->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (628))) ;
      var_cas_ioGeneratedUserZone3.writeString (" & argument_") ;
...
method_generateImplementation (C_Compiler & _inLexique,
                                GGS_string& var_cas_ioGeneratedCode COMMA_UNUSED_LOCATION_ARGS) {
  GGS_attributeList  var_cas_allAttributeList ;
  const GGS_entityGalgasType  _temp_28539 = (*this) ;
  if (_temp_28539._isBuilt ()) {
    _temp_28539 (HERE)->method_getAllAttributeList (_inLexique, var_cas_allAttributeList COMMA_SOURCE_FILE_AT_LINE (665)) ;
  }
  GGS_attributeList  var_cas_inheritedAttributeList ;
  const GGS_entityGalgasType  _temp_28635 = (*this) ;
  if (_temp_28635._isBuilt ()) {
    _temp_28635 (HERE)->method_getInheritedAttributeList (_inLexique, var_cas_inheritedAttributeList COMMA_SOURCE_FILE_AT_LINE (667)) ;
  }
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (671)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_28989 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_28989 = NULL ;
    while (((operand_28989 = (GGS_attributeList::cElement *) enumerator_28989.nextObject ()))) {
      ...
      var_cas_ioGeneratedCode._dotAssign_operation (operand_28989->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (680))) ;
  ...
  if ((mSuperEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (687))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_inheritedAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (689)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      GGS_uint  var_cas_n ;
      var_cas_n = GGS_uint (true, 0U) ;
      GGS_attributeList::cEnumerator enumerator_29692 (var_cas_inheritedAttributeList, true) ;
      const GGS_attributeList::cElement * operand_29692 = NULL ;
      while (((operand_29692 = (GGS_attributeList::cElement *) enumerator_29692.nextObject ()))) {
        macroValidPointer (operand_29692) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n"
            ""
          "                                ") ;
  ...
  GGS_attributeList::cEnumerator enumerator_30187 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_30187 = NULL ;
  while (((operand_30187 = (GGS_attributeList::cElement *) enumerator_30187.nextObject ()))) {
    macroValidPointer (operand_30187) ;
    var_cas_ioGeneratedCode.writeString (",\n"
      "") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_30187->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (argument_") ;
  ...
  if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (718)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_attributeList::cEnumerator enumerator_30864 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_30864 = NULL ;
    while (((operand_30864 = (GGS_attributeList::cElement *) enumerator_30864.nextObject ()))) {
      macroValidPointer (operand_30864) ;
      ...
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30864->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString ("._operator_isEqual (_p->") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_30864->mAttributeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (730))) ;
      var_cas_ioGeneratedCode.writeString (").boolValue ()") ;
    }
    enumerator_30864.reset () ;
    var_cas_ioGeneratedCode.writeString (" ;\n"
      ""
    "  }\n"
      "") ;
  ...
  if (((mIsAbstract)._operator_not ()).isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_n ;
    var_cas_n = GGS_uint (true, 0U) ;
    GGS_attributeList::cEnumerator enumerator_37072 (var_cas_allAttributeList, true) ;
    const GGS_attributeList::cElement * operand_37072 = NULL ;
    while (((operand_37072 = (GGS_attributeList::cElement *) enumerator_37072.nextObject ()))) {
      macroValidPointer (operand_37072) ;
      var_cas_ioGeneratedCode.writeString (",\n"
        "                                "
      "const GGS_") ;
      var_cas_ioGeneratedCode._dotAssign_operation (operand_37072->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (871))) ;
      var_cas_ioGeneratedCode.writeString (" & argument_") ;
    ...
    if (((var_cas_allAttributeList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (879)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      var_cas_n = GGS_uint (true, 0U) ;
      GGS_attributeList::cEnumerator enumerator_37662 (var_cas_allAttributeList, true) ;
      const GGS_attributeList::cElement * operand_37662 = NULL ;
      while (((operand_37662 = (GGS_attributeList::cElement *) enumerator_37662.nextObject ()))) {
        macroValidPointer (operand_37662) ;
        if (((var_cas_n)._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_ioGeneratedCode.writeString (",\n"
            "                                ") ;
        }
  ...
  GGS_attributeList::cEnumerator enumerator_38095 (mPropertyList, true) ;
  const GGS_attributeList::cElement * operand_38095 = NULL ;
  while (((operand_38095 = (GGS_attributeList::cElement *) enumerator_38095.nextObject ()))) {
    macroValidPointer (operand_38095) ;
    var_cas_ioGeneratedCode._dotAssign_operation (GGS_string::constructor_CppLineComment (_inLexique COMMA_HERE)) ;
    var_cas_ioGeneratedCode.writeString ("GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38095->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (899))) ;
    var_cas_ioGeneratedCode.writeString (" GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (mEntityName) ;
    var_cas_ioGeneratedCode.writeString ("::\n"
      ""
    "reader_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38095->mAttributeName) ;
    var_cas_ioGeneratedCode.writeString (" (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {\n"
      ""
    "  GGS_") ;
    var_cas_ioGeneratedCode._dotAssign_operation (operand_38095->mAttributeTypeIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (901))) ;
    var_cas_ioGeneratedCode.writeString (" result ;\n"
      ""
    "  if (mPointer != NULL) {\n"
      ""
