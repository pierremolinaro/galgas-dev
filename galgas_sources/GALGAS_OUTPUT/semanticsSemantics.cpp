...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_28644 = mAssociatedListTypeIndex ;
  if (_temp_28644._isBuilt ()) {
    _temp_28644 (HERE)->method_searchKey (_inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (584)) ;
  }
  { const GGS_ACGalgasType _var_28913 = var_cas_t ; // CAST instruction
    if (_var_28913.getPtr () != NULL) {
      macroValidPointer (_var_28913.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_28913.getPtr ()) != NULL) {
      }else{
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_31330 = mIndexOfMapType ;
  if (_temp_31330._isBuilt ()) {
    _temp_31330 (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (651)) ;
  }
  { const GGS_ACGalgasType _var_31584 = var_cas_t ; // CAST instruction
    if (_var_31584.getPtr () != NULL) {
      macroValidPointer (_var_31584.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_31584.getPtr ()) != NULL) {
      }else{
