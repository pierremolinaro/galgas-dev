...
AC_galgasClassRunTimeInformation * cPtr_entityGalgasType::galgasRTTI (void) const {
  return & gClassInfoFor__entityGalgasType ;
}
...
AC_galgasClassRunTimeInformation * cPtr_multipleReferenceGalgasType::galgasRTTI (void) const {
  return & gClassInfoFor__multipleReferenceGalgasType ;
}
