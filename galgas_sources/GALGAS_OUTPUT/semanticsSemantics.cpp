...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  var_cas_classPath = mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) ;
  GGS_stringset  var_cas_superClassSet ;
  var_cas_superClassSet = GGS_stringset::constructor_setWithString (_inLexique, mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_HERE) ;
  ...
  GGS_uint _variant_15183 = var_cas_inTypeCount ;
  GGS_bool _condition_15183 (_variant_15183._isBuilt (), true) ;
  while (_condition_15183.isBuiltAndTrue ()) {
    _condition_15183 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (289)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_15183.isBuiltAndTrue ()) {
      if (_variant_15183.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (318)) ;
        _condition_15183 = GGS_bool (true, false) ;
      }else{
        _variant_15183._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superClassIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (290))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_superClassName ;
          GGS_ACGalgasType  var_cas_t ;
          if (var_cas_superClassIndex._isBuilt ()) {
            var_cas_superClassIndex (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (294)) ;
          }
          var_cas_circularityError = var_cas_superClassSet.reader_hasKey (_inLexique, var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) ;
          var_cas_superClassSet._addAssign_operation (var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))) ;
          var_cas_classPath.writeString (".") ;
          var_cas_classPath._dotAssign_operation (var_cas_superClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (298))) ;
          GGS_typeMapIndex  var_cas_superSuperClassIndex ;
          { const GGS_ACGalgasType _var_14858 = var_cas_t ; // CAST instruction
            if (_var_14858.getPtr () != NULL) {
              macroValidPointer (_var_14858.getPtr ()) ;
              if (dynamic_cast <cPtr_classGalgasType *> (_var_14858.getPtr ()) != NULL) {
                const GGS_classGalgasType var_cas_kClassType (_var_14858.getPtr ()) ;
                var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (303)) ;
              }else{
                mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (309)) ;
          ...
          var_cas_superClassName = var_cas_superClassIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (313)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (313)) ;
          mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (true, " does not exist")) COMMA_SOURCE_FILE_AT_LINE (317)) ;
        }
      }
    }
  }
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "inheritance circularity for class '"))._operator_concat (mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323))))._operator_concat (GGS_string (true, "': ")))._operator_concat (var_cas_classPath.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "."), GGS_string (true, " extends ") COMMA_SOURCE_FILE_AT_LINE (324))) COMMA_SOURCE_FILE_AT_LINE (325)) ;
  }
}
...
method_checkNoCircularity (C_Compiler & _inLexique,
  ...
  var_cas_entityPath = mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (343)) ;
  GGS_stringset  var_cas_superEntitySet ;
  var_cas_superEntitySet = GGS_stringset::constructor_setWithString (_inLexique, mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_HERE) ;
  ...
  GGS_bool var_cas_ok ;
  var_cas_ok = GGS_bool (true, true) ;
  GGS_uint _variant_17638 = var_cas_inTypeCount ;
  GGS_bool _condition_17638 (_variant_17638._isBuilt (), true) ;
  while (_condition_17638.isBuiltAndTrue ()) {
    _condition_17638 = ((var_cas_superEntityIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (349)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_17638.isBuiltAndTrue ()) {
      if (_variant_17638.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (378)) ;
        _condition_17638 = GGS_bool (true, false) ;
      }else{
        _variant_17638._decrement_operation (_inLexique COMMA_HERE) ;
        if ((var_cas_superEntityIndex.reader_isSolved (_inLexique COMMA_SOURCE_FILE_AT_LINE (350))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_superEntityName ;
          GGS_ACGalgasType  var_cas_t ;
          if (var_cas_superEntityIndex._isBuilt ()) {
            var_cas_superEntityIndex (HERE)->method_searchKey (_inLexique, var_cas_superEntityName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (354)) ;
          }
          var_cas_circularityError = var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
          var_cas_superEntitySet._addAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (357))) ;
          var_cas_entityPath.writeString (".") ;
          var_cas_entityPath._dotAssign_operation (var_cas_superEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (358))) ;
          GGS_typeMapIndex  var_cas_superSuperEntityIndex ;
          { const GGS_ACGalgasType _var_17305 = var_cas_t ; // CAST instruction
            if (_var_17305.getPtr () != NULL) {
              macroValidPointer (_var_17305.getPtr ()) ;
              if (dynamic_cast <cPtr_entityGalgasType *> (_var_17305.getPtr ()) != NULL) {
                const GGS_entityGalgasType var_cas_kClassType (_var_17305.getPtr ()) ;
                var_cas_superSuperEntityIndex = var_cas_kClassType.reader_mSuperEntityIndex (_inLexique COMMA_SOURCE_FILE_AT_LINE (363)) ;
              }else{
                mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " is not a class")) COMMA_SOURCE_FILE_AT_LINE (369)) ;
          ...
          var_cas_superEntityName = var_cas_superEntityIndex.reader_key (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)) ;
          mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity inherits from @"))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, ", but @")))._operator_concat (var_cas_superEntityName))._operator_concat (GGS_string (true, " does not exist")) COMMA_SOURCE_FILE_AT_LINE (377)) ;
        }
      }
    }
  }
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "inheritance circularity for entity '"))._operator_concat (mEntityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (383))))._operator_concat (GGS_string (true, "': ")))._operator_concat (var_cas_entityPath.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "."), GGS_string (true, " extends ") COMMA_SOURCE_FILE_AT_LINE (384))) COMMA_SOURCE_FILE_AT_LINE (385)) ;
  }
}
...
void routine_constructBuiltinTypeMap (C_Compiler & _inLexique,
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), GGS_stringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (456)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "char"), GGS_location (_inLexique) COMMA_HERE), GGS_charGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (457)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "bool"), GGS_location (_inLexique) COMMA_HERE), GGS_boolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (458)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint"), GGS_location (_inLexique) COMMA_HERE), GGS_uintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (459)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint"), GGS_location (_inLexique) COMMA_HERE), GGS_sintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (460)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), GGS_uint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (461)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "sint64"), GGS_location (_inLexique) COMMA_HERE), GGS_sint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (462)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "double"), GGS_location (_inLexique) COMMA_HERE), GGS_doubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (463)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), GGS_lstringGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (464)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lchar"), GGS_location (_inLexique) COMMA_HERE), GGS_lcharGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (465)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lbool"), GGS_location (_inLexique) COMMA_HERE), GGS_lboolGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (466)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint"), GGS_location (_inLexique) COMMA_HERE), GGS_luintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (467)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint"), GGS_location (_inLexique) COMMA_HERE), GGS_lsintGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (468)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "luint64"), GGS_location (_inLexique) COMMA_HERE), GGS_luint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (469)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lsint64"), GGS_location (_inLexique) COMMA_HERE), GGS_lsint64GalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (470)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "ldouble"), GGS_location (_inLexique) COMMA_HERE), GGS_ldoubleGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (471)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "binaryset"), GGS_location (_inLexique) COMMA_HERE), GGS_binarysetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (472)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "stringset"), GGS_location (_inLexique) COMMA_HERE), GGS_stringsetGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (473)) ;
  var_cas_outTypeMap.modifier_insertKey (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "location"), GGS_location (_inLexique) COMMA_HERE), GGS_locationGalgasType::constructor_new (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (474)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "lstring"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (478)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_lstringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (481)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "string"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_stringIndex COMMA_SOURCE_FILE_AT_LINE (485)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_stringlist, GGS_listGalgasType::constructor_new (_inLexique, var_cas_stringlist, var_cas_stringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (488)) ;
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, "uint64"), GGS_location (_inLexique) COMMA_HERE), var_cas_outTypeMap, var_cas_uint64Index COMMA_SOURCE_FILE_AT_LINE (492)) ;
  ...
  var_cas_outTypeMap.modifier_insertKey (_inLexique, var_cas_uint64list, GGS_listGalgasType::constructor_new (_inLexique, var_cas_uint64list, var_cas_uint64Attribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (495)) ;
  #ifdef DEBUG_TRACE_ENABLED
