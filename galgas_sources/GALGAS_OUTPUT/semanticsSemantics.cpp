...
modifier_writeAccess (C_Compiler & _inLexique,
  ...
  case enum_localConstantDefined:
    mValue = enum_localConstantDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local constant cannot be written, it is is already defined") COMMA_SOURCE_FILE_AT_LINE (52)) ;
    break ;
  case enum_localContantUsed:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local constant cannot be written, it is is already defined") COMMA_SOURCE_FILE_AT_LINE (54)) ;
    break ;
  ...
  case enum_constantInputFormalParameterDefined:
    ...
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be written, it is a constant") COMMA_SOURCE_FILE_AT_LINE (59)) ;
    break ;
  case enum_constantInputFormalParameterUsed:
    mValue = enum_constantInputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be written, it is a constant") COMMA_SOURCE_FILE_AT_LINE (60)) ;
    break ;
  default : break ;
  }
}
...
modifier_readAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable cannot be read, it has no value") COMMA_SOURCE_FILE_AT_LINE (66)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableUsed ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable cannot be read, it is dropped") COMMA_SOURCE_FILE_AT_LINE (69)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localConstantDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local constant cannot be read, it has no value") COMMA_SOURCE_FILE_AT_LINE (70)) ;
    break ;
  case enum_localConstantDefined:
    mValue = enum_localContantUsed ;
    break ;
  ...
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be read, it is dropped") COMMA_SOURCE_FILE_AT_LINE (77)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
    break ;
...
modifier_readWriteAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable cannot be modified, has no value") COMMA_SOURCE_FILE_AT_LINE (85)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableUsed ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable cannot be modified, it is dropped") COMMA_SOURCE_FILE_AT_LINE (88)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be modified") COMMA_SOURCE_FILE_AT_LINE (89)) ;
    break ;
  case enum_localConstantDefined:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be modified") COMMA_SOURCE_FILE_AT_LINE (90)) ;
    break ;
  case enum_localContantUsed:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be modified") COMMA_SOURCE_FILE_AT_LINE (92)) ;
    break ;
  case enum_inputFormalParameterDefined:
    mValue = enum_inputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be modified, has no value") COMMA_SOURCE_FILE_AT_LINE (93)) ;
    break ;
  case enum_inputFormalParameterUsed:
    mValue = enum_inputFormalParameterUsed ;
    break ;
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDefined ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be modified, it is dropped") COMMA_SOURCE_FILE_AT_LINE (96)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an input parameter cannot be modified") COMMA_SOURCE_FILE_AT_LINE (97)) ;
    break ;
  case enum_constantInputFormalParameterUsed:
    mValue = enum_constantInputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("an input parameter cannot be modified") COMMA_SOURCE_FILE_AT_LINE (98)) ;
    break ;
  default : break ;
  }
}
...
modifier_dropAccess (C_Compiler & _inLexique,
  ...
  case enum_localVariableDeclared:
    ...
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable cannot be dropped, has no value") COMMA_SOURCE_FILE_AT_LINE (104)) ;
    break ;
  case enum_localVariableUsed:
    mValue = enum_localVariableDropped ;
    break ;
  case enum_localVariableDropped:
    mValue = enum_localVariableDropped ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the local variable is already dropped") COMMA_SOURCE_FILE_AT_LINE (107)) ;
    break ;
  case enum_localConstantDeclared:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be dropped") COMMA_SOURCE_FILE_AT_LINE (108)) ;
    break ;
  case enum_localConstantDefined:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be dropped") COMMA_SOURCE_FILE_AT_LINE (109)) ;
    break ;
  case enum_localContantUsed:
    mValue = enum_localContantUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a local constant cannot be dropped") COMMA_SOURCE_FILE_AT_LINE (111)) ;
    break ;
  case enum_inputFormalParameterDefined:
    mValue = enum_inputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter cannot be dropped, has no value") COMMA_SOURCE_FILE_AT_LINE (112)) ;
    break ;
  case enum_inputFormalParameterUsed:
  ...
  case enum_inputFormalParameterDropped:
    mValue = enum_inputFormalParameterDropped ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the input parameter is already dropped") COMMA_SOURCE_FILE_AT_LINE (115)) ;
    break ;
  case enum_constantInputFormalParameterDefined:
    mValue = enum_constantInputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a constant input parameter cannot be dropped") COMMA_SOURCE_FILE_AT_LINE (116)) ;
    break ;
  case enum_constantInputFormalParameterUsed:
    mValue = enum_constantInputFormalParameterUsed ;
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("a constant input parameter cannot be dropped") COMMA_SOURCE_FILE_AT_LINE (117)) ;
    break ;
  default : break ;
  }
}
...
operator_endOfRepeatedBranch (C_Compiler & _inLexique,
  ...
  if ((mValue > 0) && (inOperand.mValue > 0)) {
    ...
    if (error != 0) {
      switch (error) {
      case 1:
        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("error 1") COMMA_SOURCE_FILE_AT_LINE (122)) ;
      break ;
      case 2:
        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("warning 1") COMMA_SOURCE_FILE_AT_LINE (122)) ;
      break ;
      default: // error == -1
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  var_cas_circularityError = GGS_bool (false) ;
  GGS_bool var_cas_ok ;
  ...
  while (_condition_26713.isBuiltAndTrue ()) {
    _condition_26713 = ((var_cas_superClassIndex.reader_isRegular (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)))._operator_and (var_cas_ok))._operator_and ((var_cas_circularityError)._operator_not ()) ;
    if (_condition_26713.isBuiltAndTrue ()) {
      if (_variant_26713.uintValue () == 0) {
        ...
        _variant_26713._decrement_operation (_inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superClassName ;
        GGS_ACGalgasType  var_cas_t ;
        const GGS_typeMapIndex  _temp_25968 = var_cas_superClassIndex ;
        if (_temp_25968.isBuilt ()) {
          _temp_25968 (HERE)->method_searchKey (_inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (512)) ;
        }
        ...
        { const GGS_ACGalgasType _var_26650 = var_cas_t ; // CAST instruction
          if (_var_26650.getPtr () != NULL) {
            ...
            if (dynamic_cast <cPtr_classGalgasType *> (_var_26650.getPtr ()) != NULL) {
              ...
              mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("this class inherits from @"))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (", but @")))._operator_concat (var_cas_superClassName))._operator_concat (GGS_string (" is not a class")) COMMA_SOURCE_FILE_AT_LINE (527)) ;
  ...
  if ((var_cas_circularityError).isBuiltAndTrue ()) {
    mClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string ("inheritance circularity for class '"))._operator_concat (mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (534))))._operator_concat (GGS_string ("': ")))._operator_concat (var_cas_classPath.reader_stringByReplacingStringByString (_inLexique, GGS_string ("."), GGS_string (" extends ") COMMA_SOURCE_FILE_AT_LINE (535))) COMMA_SOURCE_FILE_AT_LINE (536)) ;
  }
}
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_28230 = mAssociatedListTypeIndex ;
  if (_temp_28230.isBuilt ()) {
    _temp_28230 (HERE)->method_searchKey (_inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (565)) ;
  }
...
method_checkTypeCrossReferences (C_Compiler & _inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  _temp_31069 = mIndexOfMapType ;
  if (_temp_31069.isBuilt ()) {
    _temp_31069 (HERE)->method_searchKey (_inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (632)) ;
  }
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mRoutineSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mFunctionSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mResultTypeIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
