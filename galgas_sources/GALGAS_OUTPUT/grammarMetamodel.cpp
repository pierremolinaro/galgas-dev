...
uint32 cPtr_startSymbolLabelFormalParameter::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_grammarLabel::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_grammarComponentRoot::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
