...
void GGS__list_startSymbolLabelFormalParameter::
_addAssign_operation (const GGS_startSymbolLabelFormalParameter & inObject) {
   _insulateList () ;
...
void GGS__list_grammarLabel::
_addAssign_operation (const GGS_grammarLabel & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_grammarComponentRoot::
_addAssign_operation (const GGS_grammarComponentRoot & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
