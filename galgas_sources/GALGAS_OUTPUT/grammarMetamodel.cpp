...
mAttribute_mStartSymbolHasParseLabel (),
...
//mAttribute_mStartSymbolHasParseLabel (inSource.mAttribute_mStartSymbolHasParseLabel),
...
mAttribute_mStartSymbolHasParseLabel (inOperand6),
mAttribute_mUnusedNonterminalList (inOperand7),
mAttribute_mEndOfSourceText (inOperand8) {
}
...
/* GALGAS_grammarComponentAST & GALGAS_grammarComponentAST::operator = (const GALGAS_grammarComponentAST & inOperand) {
  ...
  mAttribute_mStartSymbolHasParseLabel = inOperand.mAttribute_mStartSymbolHasParseLabel ;
...
GALGAS_grammarComponentAST GALGAS_grammarComponentAST::constructor_new (const GALGAS_lbool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid ()) {
    result = GALGAS_grammarComponentAST (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_grammarComponentAST::objectCompare (const GALGAS_grammarComponentAST & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mAttribute_mStartSymbolHasParseLabel.objectCompare (inOperand.mAttribute_mStartSymbolHasParseLabel) ;
  }
  if (result == kOperandEqual) {
...
bool GALGAS_grammarComponentAST::isValid (void) const {
  return mAttribute_mHasIndexing.isValid () && mAttribute_mGrammarName.isValid () && mAttribute_mGrammarClass.isValid () && mAttribute_mSyntaxComponents.isValid () && mAttribute_mStartSymbolName.isValid () && mAttribute_mStartSymbolLabelList.isValid () && mAttribute_mStartSymbolHasParseLabel.isValid () && mAttribute_mUnusedNonterminalList.isValid () && mAttribute_mEndOfSourceText.isValid () ;
}
...
void GALGAS_grammarComponentAST::drop (void) {
  ...
  mAttribute_mStartSymbolHasParseLabel.drop () ;
...
GALGAS_bool GALGAS_grammarComponentAST::reader_mStartSymbolHasParseLabel (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStartSymbolHasParseLabel ;
}
