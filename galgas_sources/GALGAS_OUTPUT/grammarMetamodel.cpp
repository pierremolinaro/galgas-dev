...
cPtr__AC_galgas_class * cPtr_grammarComponentRoot::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_grammarComponentRoot (mGrammarName, mGrammarClass, mSyntaxComponents, mStartSymbolName, mStartSymbolLabelList, mUnusedNonterminalList, mEndOfSourceText COMMA_HERE)) ;
  return result ;
}
