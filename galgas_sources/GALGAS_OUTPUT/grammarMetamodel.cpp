...
GGS_startSymbolLabelFormalParameterList::GGS_startSymbolLabelFormalParameterList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_grammarLabelList::GGS_grammarLabelList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
