...
uint32 cPtr_startSymbolLabelFormalParameter::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_startSymbolLabelFormalParameter::_metamodelClassID (void) const {
  return 0 ;
}
...
uint32 cPtr_grammarLabel::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_grammarLabel::_metamodelClassID (void) const {
  return 1 ;
}
...
uint32 cPtr_grammarComponentRoot::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_grammarComponentRoot::_metamodelClassID (void) const {
  return 2 ;
}
