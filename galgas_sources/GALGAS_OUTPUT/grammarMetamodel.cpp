...
/* const */ GGS_startSymbolLabelFormalParameterList  & GGS_grammarLabelList::cEnumerator::_mFormalParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mFormalParameterList ;
}
...
mStartSymbol (argument_3),
mLabelList (argument_4),
mUnusedNonterminalList (argument_5) {
}
...
cPtr__AC_galgas_class * cPtr_grammarComponentRoot::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_grammarComponentRoot (mGrammarName, mGrammarClass, mSyntaxComponents, mStartSymbol, mLabelList, mUnusedNonterminalList COMMA_HERE)) ;
  return result ;
}
