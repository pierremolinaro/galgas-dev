...
mAttribute_mHasTranslateFeature (inOperand8) {
}

//-----------------------------------------------------------------------------*

GALGAS_grammarComponentAST GALGAS_grammarComponentAST::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_grammarComponentAST (GALGAS_lbool::constructor_default (HERE),
...
GALGAS_bool GALGAS_grammarComponentAST::reader_mHasTranslateFeature (UNUSED_LOCATION_ARGS) const {
...
GALGAS_grammarComponentAST GALGAS_grammarComponentAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_grammarComponentAST *> (p)) {
      ...
      inCompiler->castError ("grammarComponentAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
