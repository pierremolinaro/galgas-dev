...
class GALGAS_string function_generateRoutineBody (const class GALGAS_bool & constinArgument0,
...
void routine_generateInstructionList (const class GALGAS_bool constinArgument0,
                                      const class GALGAS_semanticInstructionListForGeneration constinArgument1,
