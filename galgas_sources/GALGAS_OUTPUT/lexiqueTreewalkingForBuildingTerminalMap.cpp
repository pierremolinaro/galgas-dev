...
_treewalking_routine_lexicalAttribute (C_Compiler & _inLexique,
  ...
  if ((var_cas_inAllowedLexicalTypeNameSet.reader_hasKey (_inLexique, _currentObject->mTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)) COMMA_SOURCE_FILE_AT_LINE (53))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::cEnumerator enumerator_2995 (var_cas_inAllowedLexicalTypeNameSet, true) ;
    const GGS_stringset::cElement * operand_2995 = NULL ;
    while (((operand_2995 = (GGS_stringset::cElement *) enumerator_2995.nextObject ()))) {
      ...
      var_cas_m.writeString (" @") ;
      var_cas_m._dotAssign_operation (operand_2995->mKey) ;
    }
    enumerator_2995.reset () ;
...
_treewalking_routine_terminalDeclaration (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::cEnumerator enumerator_3471 (_currentObject->mSentAttributeList, true) ;
  const GGS_lstringlist::cElement * operand_3471 = NULL ;
  while (((operand_3471 = (GGS_lstringlist::cElement *) enumerator_3471.nextObject ()))) {
    macroValidPointer (operand_3471) ;
    GGS_string var_cas_attributeTypeName ;
    const GGS_lexicalAttributeMap  _temp_3577 = var_cas_inLexicalAttributeMap ;
    if (_temp_3577._isBuilt ()) {
      _temp_3577 (HERE)->method_searchKey (_inLexique, operand_3471->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (80)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
  }
  enumerator_3471.reset () ;
...
_treewalking_routine_lexicalListDeclaration (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_argumentTypeList ;
  var_cas_argumentTypeList = GGS_stringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_lstringlist::cEnumerator enumerator_3998 (_currentObject->mSentAttributeList, true) ;
  const GGS_lstringlist::cElement * operand_3998 = NULL ;
  while (((operand_3998 = (GGS_lstringlist::cElement *) enumerator_3998.nextObject ()))) {
    macroValidPointer (operand_3998) ;
    GGS_string var_cas_attributeTypeName ;
    const GGS_lexicalAttributeMap  _temp_4104 = var_cas_inLexicalAttributeMap ;
    if (_temp_4104._isBuilt ()) {
      _temp_4104 (HERE)->method_searchKey (_inLexique, operand_3998->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (95)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
  }
  enumerator_3998.reset () ;
  macroValidPointer (_currentObject) ;
