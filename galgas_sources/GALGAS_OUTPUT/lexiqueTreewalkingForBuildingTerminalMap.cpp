...
_treewalking_routine_lexicalAttribute (C_Compiler & _inLexique,
  ...
  if ((var_cas_inAllowedLexicalTypeNameSet.reader_hasKey (_inLexique, _currentObject->mTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::element_type * operand_2948 = var_cas_inAllowedLexicalTypeNameSet.firstObject () ;
    while ((operand_2948 != NULL)) {
      macroValidPointer (operand_2948) ;
      ...
      var_cas_m.writeString (" @") ;
      var_cas_m._dotAssign_operation (operand_2948->mKey) ;
      operand_2948 = operand_2948->nextObject () ;
    }
...
_treewalking_routine_terminalDeclaration (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::element_type * operand_3415 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3415 != NULL)) {
    macroValidPointer (operand_3415) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3415->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (79)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3415 = operand_3415->nextObject () ;
  }
...
_treewalking_routine_lexicalListDeclaration (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_argumentTypeList ;
  var_cas_argumentTypeList = GGS_stringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_lstringlist::element_type * operand_3942 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3942 != NULL)) {
    macroValidPointer (operand_3942) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3942->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (94)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3942 = operand_3942->nextObject () ;
  }
  macroValidPointer (_currentObject) ;
