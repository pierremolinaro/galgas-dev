...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "lexiqueTreewalkingForBuildingTerminalMap.ggs", line
...
static const uint32 _kSize_lexique_metamodel = 8 ;

static void * _kDispatcherFor_lexique_metamodel [_kSize_lexique_metamodel] = {
  (void *) _treewalking_routine_lexiqueComponentRoot, // #0 @lexiqueComponentRoot, defined in 'lexique_metamodel' metamodel
  NULL,
  NULL,
  (void *) _treewalking_routine_lexicalAttribute, // #3 @lexicalAttribute, defined in 'lexique_metamodel' metamodel
  NULL,
  (void *) _treewalking_routine_terminalDeclaration, // #5 @terminalDeclaration, defined in 'lexique_metamodel' metamodel
  (void *) _treewalking_routine_lexicalListDeclaration, // #6 @lexicalListDeclaration, defined in 'lexique_metamodel' metamodel
  (void *) _treewalking_routine_lexicalListEntry, // #7 @lexicalListEntry, defined in 'lexique_metamodel' metamodel
} ;
...
_treewalking_routine_lexicalAttribute (C_Compiler & _inLexique,
  ...
  if ((var_cas_inAllowedLexicalTypeNameSet.reader_hasKey (_inLexique, _currentObject->mTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::element_type * operand_2950 = var_cas_inAllowedLexicalTypeNameSet.firstObject () ;
    while ((operand_2950 != NULL)) {
      macroValidPointer (operand_2950) ;
      ...
      var_cas_m.writeString (" @") ;
      var_cas_m._dotAssign_operation (operand_2950->mKey) ;
      operand_2950 = operand_2950->nextObject () ;
    }
...
_treewalking_routine_terminalDeclaration (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::element_type * operand_3417 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3417 != NULL)) {
    macroValidPointer (operand_3417) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3417->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (79)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3417 = operand_3417->nextObject () ;
  }
...
_treewalking_routine_lexicalListDeclaration (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_argumentTypeList ;
  var_cas_argumentTypeList = GGS_stringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_lstringlist::element_type * operand_3944 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3944 != NULL)) {
    macroValidPointer (operand_3944) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3944->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (94)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3944 = operand_3944->nextObject () ;
  }
  macroValidPointer (_currentObject) ;
...
static void _build_dispacher_tree (void) {
  _gDispatcherTree.enterTable (_metamodel_index_for_lexique_metamodel (),
                                _kSize_lexique_metamodel,
                                _kDispatcherFor_lexique_metamodel
                                COMMA_HERE) ;
}
