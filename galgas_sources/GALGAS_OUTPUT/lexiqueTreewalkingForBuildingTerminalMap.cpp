...
_treewalking_routine_lexiqueComponentRoot (C_Compiler & _inLexique,
  ...
  { GGS__list_lexicalAttribute::element_type * _ptr = _currentObject->mLexicalAttributeList.firstObject () ;
    while (_ptr != NULL) {
  ...
  macroValidPointer (_currentObject) ;
  { GGS__list_terminalDeclaration::element_type * _ptr = _currentObject->mTerminalDeclarationList.firstObject () ;
    while (_ptr != NULL) {
  ...
  macroValidPointer (_currentObject) ;
  { GGS__list_lexicalListDeclaration::element_type * _ptr = _currentObject->mLexicalListDeclarationList.firstObject () ;
    while (_ptr != NULL) {
...
_treewalking_routine_lexicalListDeclaration (C_Compiler & _inLexique,
  ...
  macroValidPointer (_currentObject) ;
  { GGS__list_lexicalListEntry::element_type * _ptr = _currentObject->mEntryList.firstObject () ;
    while (_ptr != NULL) {
