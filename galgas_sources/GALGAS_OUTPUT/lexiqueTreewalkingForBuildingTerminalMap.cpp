...
static const uint32 _kSize_lexiqueMetamodel = 8 ;

static void * _kDispatcherFor_lexiqueMetamodel [_kSize_lexiqueMetamodel] = {
  (void *) _treewalking_routine_lexiqueComponentRoot, // #0 @lexiqueComponentRoot, defined in 'lexiqueMetamodel' metamodel
  NULL,
  NULL,
  (void *) _treewalking_routine_lexicalAttribute, // #3 @lexicalAttribute, defined in 'lexiqueMetamodel' metamodel
  NULL,
  (void *) _treewalking_routine_terminalDeclaration, // #5 @terminalDeclaration, defined in 'lexiqueMetamodel' metamodel
  (void *) _treewalking_routine_lexicalListDeclaration, // #6 @lexicalListDeclaration, defined in 'lexiqueMetamodel' metamodel
  (void *) _treewalking_routine_lexicalListEntry, // #7 @lexicalListEntry, defined in 'lexiqueMetamodel' metamodel
} ;
...
_treewalking_routine_lexicalAttribute (C_Compiler & _inLexique,
  ...
  if ((var_cas_inAllowedLexicalTypeNameSet.reader_hasKey (_inLexique, _currentObject->mTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
    ...
    GGS_stringset::element_type * operand_2955 = var_cas_inAllowedLexicalTypeNameSet.firstObject () ;
    while ((operand_2955 != NULL)) {
      macroValidPointer (operand_2955) ;
      ...
      var_cas_m.writeString (" @") ;
      var_cas_m._dotAssign_operation (operand_2955->mKey) ;
      operand_2955 = operand_2955->nextObject () ;
    }
...
_treewalking_routine_terminalDeclaration (C_Compiler & _inLexique,
  ...
  GGS_lstringlist::element_type * operand_3422 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3422 != NULL)) {
    macroValidPointer (operand_3422) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3422->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (79)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3422 = operand_3422->nextObject () ;
  }
...
_treewalking_routine_lexicalListDeclaration (C_Compiler & _inLexique,
  ...
  GGS_stringlist  var_cas_argumentTypeList ;
  var_cas_argumentTypeList = GGS_stringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_lstringlist::element_type * operand_3949 = _currentObject->mSentAttributeList.firstObject () ;
  while ((operand_3949 != NULL)) {
    macroValidPointer (operand_3949) ;
    GGS_string var_cas_attributeTypeName ;
    if (var_cas_inLexicalAttributeMap._isBuilt ()) {
      var_cas_inLexicalAttributeMap (HERE)->method_searchKey (_inLexique, operand_3949->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (94)) ;
    }
    var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
    operand_3949 = operand_3949->nextObject () ;
  }
  macroValidPointer (_currentObject) ;
