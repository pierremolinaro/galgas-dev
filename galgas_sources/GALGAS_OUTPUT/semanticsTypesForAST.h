...
class GALGAS_selfReaderCallExpressionAST ;
...
class GALGAS_selfMethodCallInstructionAST ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    @selfReaderCallExpressionAST class                     *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_selfReaderCallExpressionAST ;

//---------------------------------------------------------------------------*

class GALGAS_selfReaderCallExpressionAST : public GALGAS_semanticExpressionAST {
//--- Constructor
  public : GALGAS_selfReaderCallExpressionAST (void) ;

//---
  public : inline const cPtr_selfReaderCallExpressionAST * ptr (void) const { return (const cPtr_selfReaderCallExpressionAST *) mObjectPtr ; }
  public : inline cPtr_selfReaderCallExpressionAST * ptr (void) { return (cPtr_selfReaderCallExpressionAST *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_selfReaderCallExpressionAST (const cPtr_selfReaderCallExpressionAST * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_selfReaderCallExpressionAST extractObject (const GALGAS_object & inObject,
                                                                    C_Compiler * inCompiler,
                                                                    const GALGAS_location & inErrorLocation
                                                                    COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_selfReaderCallExpressionAST constructor_new (const GALGAS_location & inOperand0,
                                                                      const GALGAS_lstring & inOperand1,
                                                                      const GALGAS_semanticExpressionListAST & inOperand2
                                                                      COMMA_LOCATION_ARGS) ;

//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_selfReaderCallExpressionAST & inOperand) const ;
...
} ; // End of GALGAS_selfReaderCallExpressionAST class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_selfReaderCallExpressionAST ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    @selfMethodCallInstructionAST class                    *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_selfMethodCallInstructionAST ;

//---------------------------------------------------------------------------*

class GALGAS_selfMethodCallInstructionAST : public GALGAS_semanticInstructionAST {
//--- Constructor
  public : GALGAS_selfMethodCallInstructionAST (void) ;

//---
  public : inline const cPtr_selfMethodCallInstructionAST * ptr (void) const { return (const cPtr_selfMethodCallInstructionAST *) mObjectPtr ; }
  public : inline cPtr_selfMethodCallInstructionAST * ptr (void) { return (cPtr_selfMethodCallInstructionAST *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_selfMethodCallInstructionAST (const cPtr_selfMethodCallInstructionAST * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_selfMethodCallInstructionAST extractObject (const GALGAS_object & inObject,
                                                                     C_Compiler * inCompiler,
                                                                     const GALGAS_location & inErrorLocation
                                                                     COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_selfMethodCallInstructionAST constructor_new (const GALGAS_location & inOperand0,
                                                                       const GALGAS_lstring & inOperand1,
                                                                       const GALGAS_actualParameterListAST & inOperand2
                                                                       COMMA_LOCATION_ARGS) ;

//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_selfMethodCallInstructionAST & inOperand) const ;
...
} ; // End of GALGAS_selfMethodCallInstructionAST class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_selfMethodCallInstructionAST ;
...
class cPtr_selfReaderCallExpressionAST : public cPtr_semanticExpressionAST {
...
//--- Constructor
  public : cPtr_selfReaderCallExpressionAST (const GALGAS_location & in_mLocation,
                                             const GALGAS_lstring & in_mReaderName,
                                             const GALGAS_semanticExpressionListAST & in_mExpressions
                                             COMMA_LOCATION_ARGS) ;
//--- Description
...
class cPtr_selfMethodCallInstructionAST : public cPtr_semanticInstructionAST {
...
//--- Constructor
  public : cPtr_selfMethodCallInstructionAST (const GALGAS_location & in_mInstructionLocation,
                                              const GALGAS_lstring & in_mMethodName,
                                              const GALGAS_actualParameterListAST & in_mActualParameterList
                                              COMMA_LOCATION_ARGS) ;
//--- Description
