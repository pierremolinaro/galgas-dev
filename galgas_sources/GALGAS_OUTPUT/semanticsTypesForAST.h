...
//--- Enumerator
  ...
  //--- Associated object accessor
    public : const GGS_abstracMultiMethodListAST & _mList (LOCATION_ARGS) const ;
  } ;
//--- Introspection
  public : virtual const C_galgas_type_descriptorEX * typeDescriptor (void) const ;
...
//--- Enumerator
  ...
  //--- Contructor
    public : cEnumerator (const GGS_multiMethodListMapAST & inListMap,
                          const bool inAscending) ;
  //--- Associated object accessor
    public : const GGS_multiMethodListAST & _mList (LOCATION_ARGS) const ;
  } ;
//--- Introspection
  public : virtual const C_galgas_type_descriptorEX * typeDescriptor (void) const ;
...
//--- Enumerator
  ...
  //--- Contructor
    public : cEnumerator (const GGS_overridingMultiMethodListMapAST & inListMap,
                          const bool inAscending) ;
  //--- Associated object accessor
    public : const GGS_overridingMultiMethodListAST & _mList (LOCATION_ARGS) const ;
  } ;
//--- Introspection
  public : virtual const C_galgas_type_descriptorEX * typeDescriptor (void) const ;
