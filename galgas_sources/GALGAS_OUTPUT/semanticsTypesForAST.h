...
class GGS_extractObjectInExpressionAST ;
class cPtr_extractObjectInExpressionAST ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//             GALGAS class 'GGS_extractObjectInExpressionAST'               *
//                                                                           *
//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_extractObjectInExpressionAST ;

//---------------------------------------------------------------------------*

class GGS_extractObjectInExpressionAST : public GGS_semanticExpressionAST {
//--- Default constructor
  public : inline GGS_extractObjectInExpressionAST (void) :
  GGS_semanticExpressionAST () {}

//--- Pointer assignment constructor
  public : GGS_extractObjectInExpressionAST (const cPtr__AC_galgas_class * inPointer) ;

//--- Object assignment constructor
  public : GGS_extractObjectInExpressionAST (cPtr__AC_galgas_class & inObject) ;

//--- castFrom class method (implements cast expression)
  public : static GGS_extractObjectInExpressionAST
  castFrom (C_Compiler & inLexique,
             cPtr__AC_galgas_class * inPointer,
             const bool inUseKindOfClass,
             const GGS_location & inErrorLocation
...
//--- 'new' constructor
  public : static GGS_extractObjectInExpressionAST constructor_new (C_Compiler & inLexique,
                                const GGS_semanticExpressionAST & argument_0,
                                const GGS_location & argument_1,
                                const GGS_lstring & argument_2
                                COMMA_LOCATION_ARGS) ;
...
//--- getPtr
  public : inline cPtr_extractObjectInExpressionAST * getPtr (void) const {
    return (cPtr_extractObjectInExpressionAST *) mPointer ;
  }
...
//--- operator ()
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : cPtr_extractObjectInExpressionAST * operator () (LOCATION_ARGS) const ;
  #else
    public : inline cPtr_extractObjectInExpressionAST * operator () (LOCATION_ARGS) const {
      return (cPtr_extractObjectInExpressionAST *) mPointer ;
    }
  #endif
...
//--- Introspection
  ...
  public : static GGS_extractObjectInExpressionAST castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
extern C_galgasClassRunTimeInformationEX gClassInfoFor__extractObjectInExpressionAST ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//            abstract class 'cPtr_extractObjectInExpressionAST'             *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_extractObjectInExpressionAST : public cPtr_semanticExpressionAST {
  private : typedef cPtr_semanticExpressionAST inherited ;
//--- Constructor
  public : cPtr_extractObjectInExpressionAST (const GGS_semanticExpressionAST & ,
                                const GGS_location & ,
                                const GGS_lstring & 
                                COMMA_LOCATION_ARGS) ;
