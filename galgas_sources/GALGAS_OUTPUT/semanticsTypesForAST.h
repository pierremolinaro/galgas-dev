...
//--- Readers
  public : GGS_lstring  reader_mTypeName (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_lstring  reader_mOverridingCategoryMethodMethodName (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
...
//--- Attributes
  public : GGS_lstring  mTypeName ;
  public : GGS_lstring  mOverridingCategoryMethodMethodName ;
