...
class cocoa_parser {
  ...
  protected : void pr_galgas_component_cocoa_parser_89_23_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cocoa_parser_89_23_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cocoa_parser_89_23_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;

  protected : void pr_galgas_component_cocoa_parser_89_23_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_EXsemanticContext &,
                                GGS_stringset  &) ;

  protected : void pr_galgas_component_cocoa_parser_89_23_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_EXsemanticContext &) ;
