...
bool cCollectionElement_programRuleList::isValid (void) const {
  return mAttribute_mSourceFileExtension.isValid () && mAttribute_mSourceFileHelp.isValid () && mAttribute_mSourceFileVariableName.isValid () && mAttribute_mSourceFileVariableNameIsUnused.isValid () && mAttribute_mInstructionList.isValid () && mAttribute_mEndOfInstructionList.isValid () ;
}
...
cCollectionElement * cCollectionElement_programRuleList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_programRuleList (mAttribute_mSourceFileExtension, mAttribute_mSourceFileHelp, mAttribute_mSourceFileVariableName, mAttribute_mSourceFileVariableNameIsUnused, mAttribute_mInstructionList, mAttribute_mEndOfInstructionList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_programRuleList GALGAS_programRuleList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    ...
    macroMyNew (p, cCollectionElement_programRuleList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
...
cCollectionElement_programRuleList * GALGAS_programRuleList::makeElement (const GALGAS_lstring & in_mSourceFileExtension,
                                                                          const GALGAS_lstring & in_mSourceFileHelp,
                                                                          const GALGAS_lstring & in_mSourceFileVariableName,
                                                                          const GALGAS_bool & in_mSourceFileVariableNameIsUnused,
                                                                          const GALGAS_semanticInstructionListAST & in_mInstructionList,
                                                                          const GALGAS_location & in_mEndOfInstructionList
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_programRuleList * result = NULL ;
  macroMyNew (result, cCollectionElement_programRuleList (in_mSourceFileExtension,
                                                                          in_mSourceFileHelp,
...
void GALGAS_programRuleList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand5 = p->mAttribute_mEndOfInstructionList ;
  }
}
