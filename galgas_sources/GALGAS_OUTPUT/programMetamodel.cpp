...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_programComponentRoot) ;
...
GGS_semanticInstructionListAST  GGS_programComponentRoot::
...
GGS_semanticDeclarationStructAST GGS_programComponentRoot::
