...
class cCollectionElement_prologueEpilogueList : public cCollectionElement {
  public : GALGAS_prologueEpilogueList_3A_element mObject ;
...
GALGAS_prologueEpilogueList_3A_element cEnumerator_prologueEpilogueList::current (LOCATION_ARGS) const {
...
class cCollectionElement_programRuleList : public cCollectionElement {
  public : GALGAS_programRuleList_3A_element mObject ;
...
GALGAS_programRuleList_3A_element cEnumerator_programRuleList::current (LOCATION_ARGS) const {
...
GALGAS_prologueEpilogueList_3A_element::GALGAS_prologueEpilogueList_3A_element (void) :
...
GALGAS_prologueEpilogueList_3A_element::GALGAS_prologueEpilogueList_3A_element (const GALGAS_semanticInstructionListAST & inOperand0,
                                                                                const GALGAS_location & inOperand1) :
...
/* GALGAS_prologueEpilogueList_3A_element & GALGAS_prologueEpilogueList_3A_element::operator = (const GALGAS_prologueEpilogueList_3A_element & inOperand) {
  mAttribute_mInstructionList = inOperand.mAttribute_mInstructionList ;
  mAttribute_mEndOfInstructionList = inOperand.mAttribute_mEndOfInstructionList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_prologueEpilogueList_3A_element GALGAS_prologueEpilogueList_3A_element::constructor_new (const GALGAS_semanticInstructionListAST & inOperand0,
                                                                                                const GALGAS_location & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_prologueEpilogueList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_prologueEpilogueList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_prologueEpilogueList_3A_element::objectCompare (const GALGAS_prologueEpilogueList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_prologueEpilogueList_3A_element::isValid (void) const {
  return mAttribute_mInstructionList.isValid () && mAttribute_mEndOfInstructionList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_prologueEpilogueList_3A_element::drop (void) {
...
void GALGAS_prologueEpilogueList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_semanticInstructionListAST GALGAS_prologueEpilogueList_3A_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_prologueEpilogueList_3A_element::reader_mEndOfInstructionList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_prologueEpilogueList_3A_element ("prologueEpilogueList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_prologueEpilogueList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_prologueEpilogueList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_prologueEpilogueList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_prologueEpilogueList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_prologueEpilogueList_3A_element GALGAS_prologueEpilogueList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_prologueEpilogueList_3A_element result ;
  const GALGAS_prologueEpilogueList_3A_element * p = (const GALGAS_prologueEpilogueList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_prologueEpilogueList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_programRuleList_3A_element::GALGAS_programRuleList_3A_element (void) :
...
GALGAS_programRuleList_3A_element::GALGAS_programRuleList_3A_element (const GALGAS_lstring & inOperand0,
                                                                      const GALGAS_lstring & inOperand1,
                                                                      const GALGAS_lstring & inOperand2,
                                                                      const GALGAS_bool & inOperand3,
                                                                      const GALGAS_lstring & inOperand4,
...
/* GALGAS_programRuleList_3A_element & GALGAS_programRuleList_3A_element::operator = (const GALGAS_programRuleList_3A_element & inOperand) {
  mAttribute_mSourceFileExtension = inOperand.mAttribute_mSourceFileExtension ;
  mAttribute_mSourceFileHelp = inOperand.mAttribute_mSourceFileHelp ;
  mAttribute_mSourceFileVariableName = inOperand.mAttribute_mSourceFileVariableName ;
  mAttribute_mSourceFileVariableNameIsUnused = inOperand.mAttribute_mSourceFileVariableNameIsUnused ;
  mAttribute_mIndexingGrammar = inOperand.mAttribute_mIndexingGrammar ;
  mAttribute_mInstructionList = inOperand.mAttribute_mInstructionList ;
  mAttribute_mEndOfInstructionList = inOperand.mAttribute_mEndOfInstructionList ;
  return *this ;
} */
...
GALGAS_programRuleList_3A_element GALGAS_programRuleList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_lstring & inOperand1,
                                                                                      const GALGAS_lstring & inOperand2,
                                                                                      const GALGAS_bool & inOperand3,
                                                                                      const GALGAS_lstring & inOperand4,
                                                                                      ...
                                                                                      const GALGAS_location & inOperand6 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_programRuleList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_programRuleList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_programRuleList_3A_element::objectCompare (const GALGAS_programRuleList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_programRuleList_3A_element::isValid (void) const {
...
void GALGAS_programRuleList_3A_element::drop (void) {
...
void GALGAS_programRuleList_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_programRuleList_3A_element::reader_mSourceFileExtension (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFileExtension ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_programRuleList_3A_element::reader_mSourceFileHelp (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFileHelp ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_programRuleList_3A_element::reader_mSourceFileVariableName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFileVariableName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_programRuleList_3A_element::reader_mSourceFileVariableNameIsUnused (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceFileVariableNameIsUnused ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_programRuleList_3A_element::reader_mIndexingGrammar (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndexingGrammar ;
}

//---------------------------------------------------------------------------*

GALGAS_semanticInstructionListAST GALGAS_programRuleList_3A_element::reader_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInstructionList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_programRuleList_3A_element::reader_mEndOfInstructionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndOfInstructionList ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_programRuleList_3A_element ("programRuleList:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_programRuleList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_programRuleList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_programRuleList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_programRuleList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_programRuleList_3A_element GALGAS_programRuleList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_programRuleList_3A_element result ;
  const GALGAS_programRuleList_3A_element * p = (const GALGAS_programRuleList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_programRuleList_3A_element *> (p)) {
      result = *p ;
    }else{
