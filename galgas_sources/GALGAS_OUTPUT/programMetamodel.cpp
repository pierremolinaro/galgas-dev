...
GALGAS_programComponentAST GALGAS_programComponentAST::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_programComponentAST (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
bool GALGAS_programComponentAST::isValid (void) const {
  return mAttribute_mProgramComponentName.isValid () && mAttribute_mImportedComponentFileNameList.isValid () && mAttribute_mPrologueList.isValid () && mAttribute_mEpilogueList.isValid () && mAttribute_mProgramRules.isValid () && mAttribute_mSemanticDeclarationList.isValid () && mAttribute_mEndOfSourceFile.isValid () ;
}
...
GALGAS_prologueEpilogueList_2E_element GALGAS_prologueEpilogueList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_prologueEpilogueList_2E_element (GALGAS_semanticInstructionListAST::constructor_emptyList (HERE),
                                                 GALGAS_location::constructor_nowhere (HERE)) ;
}
...
GALGAS_programRuleList_2E_element GALGAS_programRuleList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_programRuleList_2E_element (GALGAS_lstring::constructor_default (HERE),
