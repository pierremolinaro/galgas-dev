...
extern const C_galgas_function_descriptorEX kFunction_descriptor_selfMarkName ;
...
//--- Override 'selectBlock'
  public : void modifier_openOverrideForSelectBlock (C_CompilerEx & inLexique
                                COMMA_LOCATION_ARGS) ;

//--- Override 'repeatBlock'
  public : void modifier_openOverrideForRepeatBlock (C_CompilerEx & inLexique
                                COMMA_LOCATION_ARGS) ;

  public : void modifier_closeBranch (C_CompilerEx & inCompiler,
                                    const GGS_location & inErrorLocation
                                    COMMA_LOCATION_ARGS) ;
...
extern const C_galgas_function_descriptorEX kFunction_descriptor_checkReaderImplementationInSuperClasses ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Declarations for 'analysisContext' struct                  *
//                                                                           *
//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_analysisContext ;

//---------------------------------------------------------------------------*

class GGS_analysisContext : public GGS__root {
//--- Default constructor
...
//--- Support for method call handling in GALGAS
  public : inline const GGS_analysisContext * operator () (UNUSED_LOCATION_ARGS) const { return this ; }
  public : inline GGS_analysisContext * operator () (UNUSED_LOCATION_ARGS) { return this ; }

//--- Comparison
  public : GGS_bool operator_isEqual (const GGS_analysisContext & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_analysisContext & inOperand) const ;
...
//--- Galgas 'new' destructor
  public : static GGS_analysisContext constructor_new (const GGS_semanticContext& argument_0,
...
//--- Attributes
  ...
  public : GGS_unifiedTypeMapProxy  mSelfTypeProxy ;
  public : GGS_string mSelfObjectCppPointer ;
} ;
