...
void optionSyntax::rule_optionSyntax_option_5F_component_5F_start_5F_symbol_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outOptionComponentRoot = GGS_optionComponentAST ::constructor_new (inLexique, var_cas_mOptionComponentName, var_cas_mOptions COMMA_SOURCE_FILE_AT_LINE (48)) ;
}
...
void optionSyntax::rule_optionSyntax_option_i1_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
  GGS_lstring  var_cas_defaultValue = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (65)) ;
  GGS_optionDefaultValueEnumAST var_cas_optionDefaultValueKind ;
  switch (select_optionSyntax_1 (inLexique)) {
    case 1 : {
      var_cas_optionDefaultValueKind = GGS_optionDefaultValueEnumAST::constructor_noDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
      } break ;
    case 2 : {
      ...
      switch (select_optionSyntax_2 (inLexique)) {
        case 1 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
          var_cas_optionDefaultValueKind = GGS_optionDefaultValueEnumAST::constructor_stringDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (73)) ;
          } break ;
        case 2 : {
          GGS_luint  var_cas_v ;
          ...
          var_cas_optionDefaultValueKind = GGS_optionDefaultValueEnumAST::constructor_unsignedDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
          } break ;
        default :
          break ;
      }
