...
pr_factor_templateExpressionParser_1265_13_ (galgasTemplateScanner & inLexique,
  ...
  switch (select_templateExpressionParser_5 (inLexique)) {
    case 1 : {
      ...
      var_cas_classType = GGS_typeGalgasClassType::castFrom (inLexique, var_cas_expressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1288)) ;
