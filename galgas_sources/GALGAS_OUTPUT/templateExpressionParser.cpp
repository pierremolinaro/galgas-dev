...
void templateExpressionParser::rule_templateExpressionParser_factor_i20_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  switch (select_templateExpressionParser_7 (inLexique)) {
    case 1 : {
      ...
      GGS_typeListeAttributsSemantiques  var_cas_formalAttributeList = GGS_typeListeAttributsSemantiques ::constructor_emptyList () ;
      {
        ...
        while (((operand_57693 = enumerator_57693.nextObject ()))) {
          ...
          var_cas_formalAttributeList.addAssign_operation (operand_57693->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
        }
      }
    ...
    case 3 : {
      ...
      const GGS_M_filewrappers  temp_59558 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)) ;
      if (temp_59558.isBuilt ()) {
        temp_59558 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1489)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_templateName ;
      inLexique.assignFromAttribute_tokenString (var_cas_templateName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques  var_cas_formalAttributeList ;
      const GGS_filewrapperTemplateMapEX  temp_59794 = var_cas_templateMap ;
      if (temp_59794.isBuilt ()) {
        temp_59794 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1496)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList, var_cas_inSemanticContext, var_cas_formalAttributeList, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inTemplateVariableMap) ;
    ...
    case 5 : {
      ...
      switch (select_templateExpressionParser_8 (inLexique)) {
        case 1 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
          const GGS_bool cond_61877 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1566))).operator_isEqual (GGS_string ("value")) ;
          if (cond_61877.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_61877.isBuiltAndFalse ()) {
            const GGS_bool cond_61974 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1568))).operator_isEqual (GGS_string ("char")) ;
            if (cond_61974.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_61974.isBuiltAndFalse ()) {
              const GGS_bool cond_62075 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1570))).operator_isEqual (GGS_string ("string")) ;
              if (cond_62075.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_62075.isBuiltAndFalse ()) {
                const GGS_bool cond_62176 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1572))).operator_isEqual (GGS_string ("comment")) ;
                if (cond_62176.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_62176.isBuiltAndFalse ()) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  temp_62628 = var_cas_inOptionsComponentsMapForUse ;
          if (temp_62628.isBuilt ()) {
            temp_62628 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1583)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__2E_) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
          const GGS_bool cond_63400 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1587))).operator_isEqual (GGS_string ("value")) ;
          if (cond_63400.isBuiltAndTrue ()) {
            const GGS_bool cond_62970 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1588))) ;
            if (cond_62970.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_62970.isBuiltAndFalse ()) {
              const GGS_bool cond_63086 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1590))) ;
              if (cond_63086.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_63086.isBuiltAndFalse ()) {
                const GGS_bool cond_63205 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1592))) ;
                if (cond_63205.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_63205.isBuiltAndFalse ()) {
          ...
          }else if (cond_63400.isBuiltAndFalse ()) {
            const GGS_bool cond_63497 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1598))).operator_isEqual (GGS_string ("char")) ;
            if (cond_63497.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_63497.isBuiltAndFalse ()) {
              const GGS_bool cond_63598 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1600))).operator_isEqual (GGS_string ("string")) ;
              if (cond_63598.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_63598.isBuiltAndFalse ()) {
                const GGS_bool cond_63699 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1602))).operator_isEqual (GGS_string ("comment")) ;
                if (cond_63699.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_63699.isBuiltAndFalse ()) {
...
void templateExpressionParser::rule_templateExpressionParser_factor_i21_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_64928 = var_cas_inEntitiesMap ;
  if (temp_64928.isBuilt ()) {
    temp_64928 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1633)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_65507 = var_cas_entite ; // CAST instruction
    if (_var_65507.getPtr () != NULL) {
      macroValidPointer (_var_65507.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_65507.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_65507.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_65507.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_65507.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_65675 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_65675 = NULL ;
    while (((operand_65675 = enumerator_65675.nextObject ()))) {
      macroValidPointer (operand_65675) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_65675->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__5B_) COMMA_HERE) ;
...
void templateExpressionParser::rule_templateExpressionParser_read_5F_access_i22_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
  const GGS_templateVariableMap  temp_66678 = var_cas_inTemplateVariableMap ;
  if (temp_66678.isBuilt ()) {
    temp_66678 (HERE)->method_searchKey (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1682)) ;
  }
}
...
void templateExpressionParser::rule_templateExpressionParser_output_5F_expression_5F_list_i23_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  const GGS_bool cond_68183 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_68183.isBuiltAndTrue ()) {
  ...
  }else if (cond_68183.isBuiltAndFalse ()) {
    const GGS_bool cond_68323 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_68323.isBuiltAndTrue ()) {
    ...
    }else if (cond_68323.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_68358 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_68358 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_68378 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_68378 = NULL ;
        while (((operand_68358 = enumerator_68358.nextObject ()))
            && ((operand_68378 = enumerator_68378.nextObject ()))) {
          macroValidPointer (operand_68358) ;
          macroValidPointer (operand_68378) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_68358->mAttributType,  operand_68378->mType,  operand_68378->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        }
      }
    }
  }
