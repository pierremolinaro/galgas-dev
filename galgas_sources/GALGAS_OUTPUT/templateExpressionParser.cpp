...
pr_factor_templateExpressionParser_1402_13_ (galgasTemplateScanner & inLexique,
  ...
  switch (select_templateExpressionParser_7 (inLexique)) {
    ...
    case 3 : {
      ...
      const GGS_M_filewrappers  temp_59569 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)) ;
      if (temp_59569.isBuilt ()) {
        temp_59569 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1489)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_templateName ;
      inLexique.assignFromAttribute_tokenString (var_cas_templateName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
      GGS_typeListeAttributsSemantiques  var_cas_formalAttributeList ;
      const GGS_filewrapperTemplateMap  temp_59805 = var_cas_templateMap ;
      if (temp_59805.isBuilt ()) {
        temp_59805 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1496)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_inSemanticContext, var_cas_formalAttributeList, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inTemplateVariableMap) ;
    ...
    case 5 : {
      ...
      switch (select_templateExpressionParser_8 (inLexique)) {
        case 1 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
          const GGS_bool cond_61888 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1566))).operator_isEqual (GGS_string ("value")) ;
          if (cond_61888.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_61888.isBuiltAndFalse ()) {
            const GGS_bool cond_61985 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1568))).operator_isEqual (GGS_string ("char")) ;
            if (cond_61985.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_61985.isBuiltAndFalse ()) {
              const GGS_bool cond_62086 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1570))).operator_isEqual (GGS_string ("string")) ;
              if (cond_62086.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_62086.isBuiltAndFalse ()) {
                const GGS_bool cond_62187 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1572))).operator_isEqual (GGS_string ("comment")) ;
                if (cond_62187.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_62187.isBuiltAndFalse ()) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  temp_62640 = var_cas_inOptionsComponentsMapForUse ;
          if (temp_62640.isBuilt ()) {
            temp_62640 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1583)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__2E_) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
          const GGS_bool cond_63413 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1587))).operator_isEqual (GGS_string ("value")) ;
          if (cond_63413.isBuiltAndTrue ()) {
            const GGS_bool cond_62982 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1588))) ;
            if (cond_62982.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_62982.isBuiltAndFalse ()) {
              const GGS_bool cond_63098 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1590))) ;
              if (cond_63098.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_63098.isBuiltAndFalse ()) {
                const GGS_bool cond_63217 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1592))) ;
                if (cond_63217.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_63217.isBuiltAndFalse ()) {
          ...
          }else if (cond_63413.isBuiltAndFalse ()) {
            const GGS_bool cond_63510 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1598))).operator_isEqual (GGS_string ("char")) ;
            if (cond_63510.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_63510.isBuiltAndFalse ()) {
              const GGS_bool cond_63611 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1600))).operator_isEqual (GGS_string ("string")) ;
              if (cond_63611.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
              }else if (cond_63611.isBuiltAndFalse ()) {
                const GGS_bool cond_63712 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1602))).operator_isEqual (GGS_string ("comment")) ;
                if (cond_63712.isBuiltAndTrue ()) {
                  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
                }else if (cond_63712.isBuiltAndFalse ()) {
...
pr_factor_templateExpressionParser_1620_13_ (galgasTemplateScanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_64942 = var_cas_inEntitiesMap ;
  if (temp_64942.isBuilt ()) {
    temp_64942 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1633)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_65522 = var_cas_entite ; // CAST instruction
    if (_var_65522.getPtr () != NULL) {
      macroValidPointer (_var_65522.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_65522.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_65522.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_65522.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_65522.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_65690 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_65690 = NULL ;
    while (((operand_65690 = enumerator_65690.nextObject ()))) {
      macroValidPointer (operand_65690) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_65690->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1__5B_) COMMA_HERE) ;
...
pr_read_access_templateExpressionParser_1675_18_ (galgasTemplateScanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgasTemplateScanner::galgasTemplateScanner_1_identifier) COMMA_HERE) ;
  const GGS_templateVariableMap  temp_66693 = var_cas_inTemplateVariableMap ;
  if (temp_66693.isBuilt ()) {
    temp_66693 (HERE)->method_searchKey (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1682)) ;
  }
}
...
pr_output_expression_list_templateExpressionParser_1691_29_ (galgasTemplateScanner & inLexique,
  ...
  const GGS_bool cond_68198 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_68198.isBuiltAndTrue ()) {
  ...
  }else if (cond_68198.isBuiltAndFalse ()) {
    const GGS_bool cond_68338 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_68338.isBuiltAndTrue ()) {
    ...
    }else if (cond_68338.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_68373 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_68373 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_68393 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_68393 = NULL ;
        while (((operand_68373 = enumerator_68373.nextObject ()))
            && ((operand_68393 = enumerator_68393.nextObject ()))) {
          macroValidPointer (operand_68373) ;
          macroValidPointer (operand_68393) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_68373->mAttributType,  operand_68393->mType,  operand_68393->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        }
      }
    }
  }
