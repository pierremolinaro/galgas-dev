...
//                    september 13th, 2008, at 16h41'16"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
static uint16 kPopUpListData_7 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_19 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_20 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_39 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_43 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_50 [] = {140, 0} ;
...
static uint16 kPopUpListData_67 [] = {140, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_73 [] = {98, 0} ;

//---------------------------------------------------------------------------*

static const uint16 * kPopUpListData [143] = {
  NULL,
  NULL,
  NULL,
  NULL,
