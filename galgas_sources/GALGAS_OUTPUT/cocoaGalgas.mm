...
static uint16 kPopUpListData_5 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_17 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_18 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_35 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_38 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_46 [] = {131, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_60 [] = {1, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_61 [] = {131, 0} ;

//---------------------------------------------------------------------------*

static uint16 kPopUpListData_67 [] = {89, 0} ;

//---------------------------------------------------------------------------*

static const uint16 * kPopUpListData [134] = {
  NULL,
  NULL,
  NULL,
  kPopUpListData_2,
