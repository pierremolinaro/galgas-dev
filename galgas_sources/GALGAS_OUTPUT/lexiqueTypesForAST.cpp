...
GALGAS_lstringlist GALGAS_terminalDeclarationListAST_2D_element::reader_mSentAttributeList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_lstringlist GALGAS_lexicalListDeclarationListAST_2D_element::reader_mSentAttributeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSentAttributeList ;
}
...
GALGAS_lexicalExternRoutineFormalArgumentListAST_2D_element GALGAS_lexicalExternRoutineFormalArgumentListAST_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexicalExternRoutineFormalArgumentListAST_2D_element (GALGAS_lexicalArgumentModeAST::constructor_lexicalInputMode (HERE),
                                                                      GALGAS_lstring::constructor_default (HERE),
                                                                      GALGAS_lstring::constructor_default (HERE)) ;
}
...
GALGAS_lexicalSentValueList_2D_element::GALGAS_lexicalSentValueList_2D_element (const GALGAS_string & inOperand0,
                                                                                const GALGAS_lexicalTypeEnum & inOperand1) :
...
GALGAS_lexicalSentValueList_2D_element GALGAS_lexicalSentValueList_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexicalSentValueList_2D_element (GALGAS_string::constructor_default (HERE),
                                                 GALGAS_lexicalTypeEnum::constructor_lexicalType_5F_string (HERE)) ;
}

//-----------------------------------------------------------------------------*

GALGAS_lexicalSentValueList_2D_element GALGAS_lexicalSentValueList_2D_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                const GALGAS_lexicalTypeEnum & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalSentValueList_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_lexicalSentValueList_2D_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
GALGAS_lexicalTypeMap_2D_element GALGAS_lexicalTypeMap_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexicalTypeMap_2D_element (GALGAS_lstring::constructor_default (HERE),
                                           GALGAS_lexicalTypeEnum::constructor_lexicalType_5F_string (HERE)) ;
}
...
GALGAS_lexicalAttributeMap_2D_element GALGAS_lexicalAttributeMap_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexicalAttributeMap_2D_element (GALGAS_lstring::constructor_default (HERE),
                                                GALGAS_lexicalTypeEnum::constructor_lexicalType_5F_string (HERE)) ;
}
