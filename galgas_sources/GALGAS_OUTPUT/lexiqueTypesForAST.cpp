...
void routine_buildLexicalAttributeMap (const GALGAS_lexicalTypeMap constinArgument_inLexicalTypeMap,
  ...
  while (enumerator_18039.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inLexicalTypeMap.reader_hasKey (enumerator_18039.current_mTypeName (HERE).reader_string (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 502)) COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 502)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_lexicalTypeEnum var_lexicalType ;
      constinArgument_inLexicalTypeMap.method_searchKey (enumerator_18039.current_mTypeName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 504)) ;
      {
      ioArgument_ioLexicalAttributeMap.modifier_insertKey (enumerator_18039.current_mName (HERE), var_lexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 505)) ;
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_string var_m = GALGAS_string::makeEmptyString () ;
      var_m.dotAssign_operation (GALGAS_string ("the @").operator_concat (enumerator_18039.current_mTypeName (HERE).reader_string (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 508))  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 508)).operator_concat (GALGAS_string (" type is not a valid lexical attribute type; are allowed:")  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 508))  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 508)) ;
      ...
      while (enumerator_18453.hasCurrentObject ()) {
        var_m.dotAssign_operation (GALGAS_string (" @").operator_concat (enumerator_18453.current_lkey (HERE).reader_string (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 511))  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 511))  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 511)) ;
        if (enumerator_18453.hasNextObject ()) {
          var_m.dotAssign_operation (GALGAS_string (",")  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 513)) ;
        }
      ...
      inCompiler->emitSemanticError (location_1, var_m  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 515)) ;
    }
...
void routine_buildTerminalMap (const GALGAS_galgas_33_LexiqueComponentListAST_2E_element constinArgument_inLexiqueComponentRoot,
  ...
  GALGAS_lexicalTypeMap var_lexicalTypeMap = function_buildLexicalTypeMap (inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 527)) ;
  GALGAS_lexicalAttributeMap var_lexicalAttributeMap = GALGAS_lexicalAttributeMap::constructor_emptyMap (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 528)) ;
  {
  routine_buildLexicalAttributeMap (var_lexicalTypeMap, constinArgument_inLexiqueComponentRoot.reader_mLexicalAttributeList (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 531)), var_lexicalAttributeMap, inCompiler  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 529)) ;
  }
  outArgument_outTerminalMap = GALGAS_terminalMap::constructor_emptyMap (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 535)) ;
  cEnumerator_terminalDeclarationListAST enumerator_19277 (constinArgument_inLexiqueComponentRoot.reader_mTerminalDeclarationList (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 536)), kEnumeration_up) ;
  while (enumerator_19277.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 537)) ;
    ...
    while (enumerator_19368.hasCurrentObject ()) {
      ...
      var_lexicalAttributeMap.method_searchKey (enumerator_19368.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 540)) ;
      var_argumentTypeList.addAssign_operation (enumerator_19368.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 541)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 541)) ;
      enumerator_19368.gotoNextObject () ;
    }
    {
    outArgument_outTerminalMap.modifier_insertKey (enumerator_19277.current_mName (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 543)) ;
    }
    enumerator_19277.gotoNextObject () ;
  }
  cEnumerator_lexicalListDeclarationListAST enumerator_19716 (constinArgument_inLexiqueComponentRoot.reader_mLexicalListDeclarationList (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 546)), kEnumeration_up) ;
  while (enumerator_19716.hasCurrentObject ()) {
    GALGAS_lexicalSentValueList var_argumentTypeList = GALGAS_lexicalSentValueList::constructor_emptyList (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 547)) ;
    ...
    while (enumerator_19807.hasCurrentObject ()) {
      GALGAS_lexicalTypeEnum var_attributeLexicalType ;
      var_lexicalAttributeMap.method_searchKey (enumerator_19807.current_mValue (HERE), var_attributeLexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 550)) ;
      var_argumentTypeList.addAssign_operation (enumerator_19807.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 551)), var_attributeLexicalType  COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 551)) ;
    ...
    while (enumerator_20034.hasCurrentObject ()) {
      {
      outArgument_outTerminalMap.modifier_insertKey (enumerator_20034.current_mTerminalSpelling (HERE), var_argumentTypeList, inCompiler COMMA_SOURCE_FILE ("lexiqueTypesForAST.gSemantics", 554)) ;
      }
