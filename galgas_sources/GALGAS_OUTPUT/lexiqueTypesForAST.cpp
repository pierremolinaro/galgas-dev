...
void GALGAS_indexingListAST::modifier_setMIndexNameAtIndex (GALGAS_lstring inOperand,
                                                            GALGAS_uint inIndex,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_indexingListAST * p = (cCollectionElement_indexingListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_indexingListAST) ;
    p->mAttribute_mIndexName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_indexingListAST::modifier_setMIndexCommentAtIndex (GALGAS_lstring inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_indexingListAST * p = (cCollectionElement_indexingListAST *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_indexingListAST) ;
    p->mAttribute_mIndexComment = inOperand ;
  }
}
...
GALGAS_lstring GALGAS_indexingListAST::reader_mIndexNameAtIndex (const GALGAS_uint & inIndex,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_indexingListAST * p = (cCollectionElement_indexingListAST *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_indexingListAST) ;
    result = p->mAttribute_mIndexName ;
  }
  return result ;
}
...
GALGAS_lstring GALGAS_indexingListAST::reader_mIndexCommentAtIndex (const GALGAS_uint & inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_indexingListAST * p = (cCollectionElement_indexingListAST *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_indexingListAST) ;
    result = p->mAttribute_mIndexComment ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_lexiqueComponentAST::objectCompare (const GALGAS_lexiqueComponentAST & inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = p->mAttribute_mIndexingListAST.objectCompare (q->mAttribute_mIndexingListAST) ;
  }
  return result ;
}
