...
GALGAS_lexiqueComponentAST GALGAS_lexiqueComponentAST::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_lexiqueComponentAST (GALGAS_lstring::constructor_default (HERE),
