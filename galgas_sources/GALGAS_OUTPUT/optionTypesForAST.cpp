...
class cCollectionElement_commandLineOptionListAST : public cCollectionElement {
  public : GALGAS_commandLineOptionListAST_3A_element mObject ;
...
GALGAS_commandLineOptionListAST_3A_element cEnumerator_commandLineOptionListAST::current (LOCATION_ARGS) const {
...
GALGAS_commandLineOptionListAST_3A_element::GALGAS_commandLineOptionListAST_3A_element (void) :
...
GALGAS_commandLineOptionListAST_3A_element::GALGAS_commandLineOptionListAST_3A_element (const GALGAS_lstring & inOperand0,
                                                                                        const GALGAS_lstring & inOperand1,
                                                                                        const GALGAS_lchar & inOperand2,
                                                                                        const GALGAS_lstring & inOperand3,
                                                                                        const GALGAS_lstring & inOperand4,
...
/* GALGAS_commandLineOptionListAST_3A_element & GALGAS_commandLineOptionListAST_3A_element::operator = (const GALGAS_commandLineOptionListAST_3A_element & inOperand) {
  mAttribute_mOptionTypeName = inOperand.mAttribute_mOptionTypeName ;
  mAttribute_mOptionInternalName = inOperand.mAttribute_mOptionInternalName ;
  mAttribute_mOptionInvocationLetter = inOperand.mAttribute_mOptionInvocationLetter ;
  mAttribute_mOptionInvocationString = inOperand.mAttribute_mOptionInvocationString ;
  mAttribute_mOptionComment = inOperand.mAttribute_mOptionComment ;
  mAttribute_mOptionDefaultValue = inOperand.mAttribute_mOptionDefaultValue ;
  mAttribute_mOptionDefaultValueKind = inOperand.mAttribute_mOptionDefaultValueKind ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_commandLineOptionListAST_3A_element GALGAS_commandLineOptionListAST_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_lstring & inOperand1,
                                                                                                        const GALGAS_lchar & inOperand2,
                                                                                                        const GALGAS_lstring & inOperand3,
                                                                                                        const GALGAS_lstring & inOperand4,
                                                                                                        ...
                                                                                                        const GALGAS_optionDefaultValueEnumAST & inOperand6 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_commandLineOptionListAST_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_commandLineOptionListAST_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_commandLineOptionListAST_3A_element::objectCompare (const GALGAS_commandLineOptionListAST_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_commandLineOptionListAST_3A_element::isValid (void) const {
...
void GALGAS_commandLineOptionListAST_3A_element::drop (void) {
...
void GALGAS_commandLineOptionListAST_3A_element::description (C_String & ioString,
                                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_commandLineOptionListAST_3A_element::reader_mOptionTypeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionTypeName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_commandLineOptionListAST_3A_element::reader_mOptionInternalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionInternalName ;
}

//---------------------------------------------------------------------------*

GALGAS_lchar GALGAS_commandLineOptionListAST_3A_element::reader_mOptionInvocationLetter (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionInvocationLetter ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_commandLineOptionListAST_3A_element::reader_mOptionInvocationString (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionInvocationString ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_commandLineOptionListAST_3A_element::reader_mOptionComment (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionComment ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_commandLineOptionListAST_3A_element::reader_mOptionDefaultValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionDefaultValue ;
}

//---------------------------------------------------------------------------*

GALGAS_optionDefaultValueEnumAST GALGAS_commandLineOptionListAST_3A_element::reader_mOptionDefaultValueKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_commandLineOptionListAST_3A_element ("commandLineOptionListAST:element",
                                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_commandLineOptionListAST_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_commandLineOptionListAST_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_commandLineOptionListAST_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_commandLineOptionListAST_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_commandLineOptionListAST_3A_element GALGAS_commandLineOptionListAST_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_commandLineOptionListAST_3A_element result ;
  const GALGAS_commandLineOptionListAST_3A_element * p = (const GALGAS_commandLineOptionListAST_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_commandLineOptionListAST_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "commandLineOptionListAST:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
