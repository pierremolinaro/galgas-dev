//---------------------------------------------------------------------------*
//                                                                           *
//                       File 'semanticsTypesEX.cpp'                         *
//                 Generated by version GALGAS_BETA_VERSION                  *
//                      march 14th, 2010, at 19h12'13"                       *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "semanticsTypesEX.gSemantics", line
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_ACGalgasType) ;
...
GGS_typeMapIndex GGS_typeMapIndex::constructor_searchKey (C_Compiler & inLexique,
  ...
  result.mKey = inKey ;
  inMap.searchIndex (inLexique, inKey, GGS_typeMap::kSearchMessage_searchKey, result.mIndex COMMA_THERE) ;
...
GGS_ACGalgasType  GGS_typeMapIndex::reader_mType (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_ACGalgasType  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
compareForSorting (const cSortedListElement * inOperand) const {
  ...
  PMSInt32 result = mSortString.genericObjectCompare (operand->mSortString) ;
  return result ;
}
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_formalArgumentPassingModeAST p_2 = p->mFormalArgumentPassingMode ;
...
GGS_formalArgumentPassingModeAST GGS_signature::
...
/* const */ GGS_formalArgumentPassingModeAST & GGS_signature::cEnumerator::_mFormalArgumentPassingMode (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_primitiveGalgasType) ;
...
GGS_primitiveGalgasType GGS_primitiveGalgasType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_primitiveGalgasType result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_dataGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_dataGalgasType) {
    ...
    macroRetainObject (gSingleton_dataGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_dataGalgasType) ;
  return result ;
}
...
GGS_dataGalgasType GGS_dataGalgasType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_dataGalgasType result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_typeGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_typeGalgasType) {
    ...
    macroRetainObject (gSingleton_typeGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_typeGalgasType) ;
  return result ;
}
...
GGS_typeGalgasType GGS_typeGalgasType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_typeGalgasType result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_objectGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_objectGalgasType) {
    ...
    macroRetainObject (gSingleton_objectGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_objectGalgasType) ;
  return result ;
}
...
GGS_objectGalgasType GGS_objectGalgasType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_objectGalgasType result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_functionGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_functionGalgasType) {
    ...
    macroRetainObject (gSingleton_functionGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_functionGalgasType) ;
  return result ;
}
...
GGS_functionGalgasType GGS_functionGalgasType::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_functionGalgasType result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_locationGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_locationGalgasType) {
    ...
    macroRetainObject (gSingleton_locationGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_locationGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_stringGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_stringGalgasType) {
    ...
    macroRetainObject (gSingleton_stringGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_stringGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_charGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_charGalgasType) {
    ...
    macroRetainObject (gSingleton_charGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_charGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_boolGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_boolGalgasType) {
    ...
    macroRetainObject (gSingleton_boolGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_boolGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_uintGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_uintGalgasType) {
    ...
    macroRetainObject (gSingleton_uintGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_uintGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_sintGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_sintGalgasType) {
    ...
    macroRetainObject (gSingleton_sintGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_sintGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_uint64GalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_uint64GalgasType) {
    ...
    macroRetainObject (gSingleton_uint64GalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_uint64GalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_sint64GalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_sint64GalgasType) {
    ...
    macroRetainObject (gSingleton_sint64GalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_sint64GalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_doubleGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_doubleGalgasType) {
    ...
    macroRetainObject (gSingleton_doubleGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_doubleGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_lstringGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lstringGalgasType) {
    ...
    macroRetainObject (gSingleton_lstringGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_lstringGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_lcharGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lcharGalgasType) {
    ...
    macroRetainObject (gSingleton_lcharGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_lcharGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_lboolGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lboolGalgasType) {
    ...
    macroRetainObject (gSingleton_lboolGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_lboolGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_luintGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_luintGalgasType) {
    ...
    macroRetainObject (gSingleton_luintGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_luintGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_lsintGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lsintGalgasType) {
    ...
    macroRetainObject (gSingleton_lsintGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_lsintGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_luint64GalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_luint64GalgasType) {
    ...
    macroRetainObject (gSingleton_luint64GalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_luint64GalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_lsint64GalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_lsint64GalgasType) {
    ...
    macroRetainObject (gSingleton_lsint64GalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_lsint64GalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_ldoubleGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_ldoubleGalgasType) {
    ...
    macroRetainObject (gSingleton_ldoubleGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_ldoubleGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_stringsetGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_stringsetGalgasType) {
    ...
    macroRetainObject (gSingleton_stringsetGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_stringsetGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_binarysetGalgasType) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_binarysetGalgasType) {
    ...
    macroRetainObject (gSingleton_binarysetGalgasType) ;
  }
  macroAssignObject (result.mPointer, gSingleton_binarysetGalgasType) ;
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_classGalgasType) ;
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  var_cas_inTypeCount COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_classPath = mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
  GGS_stringset  var_cas_superClassSet = GGS_stringset ::constructor_setWithString (mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342))) ;
  ...
  GGS_uint _variant_17700 = var_cas_inTypeCount ;
  GGS_bool _condition_17700 (_variant_17700.isBuilt (), true) ;
  while (_condition_17700.isBuiltAndTrue ()) {
    _condition_17700 = ((var_cas_superClassIndex.reader_isRegular (inLexique COMMA_SOURCE_FILE_AT_LINE (347))).operator_and (var_cas_ok)).operator_and ((var_cas_circularityError).operator_not ()) ;
    if (_condition_17700.isBuiltAndTrue ()) {
      if (_variant_17700.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (367)) ;
        _condition_17700 = GGS_bool (false) ;
      }else{
        _variant_17700.decrement_operation (inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superClassName = var_cas_superClassIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
        GGS_ACGalgasType  var_cas_t = var_cas_superClassIndex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
        var_cas_circularityError = var_cas_superClassSet.reader_hasKey (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))) ;
        var_cas_superClassSet.addAssign_operation (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (353))) ;
        var_cas_classPath.appendCString (".") ;
        var_cas_classPath.dotAssign_operation (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
        GGS_typeMapIndex  var_cas_superSuperClassIndex ;
        { const GGS_ACGalgasType _var_17637 = var_cas_t ; // CAST instruction
          if (_var_17637.getPtr () != NULL) {
            macroValidPointer (_var_17637.getPtr ()) ;
            if (dynamic_cast <cPtr_classGalgasType *> (_var_17637.getPtr ()) != NULL) {
              const GGS_classGalgasType var_cas_kClassType (_var_17637.getPtr ()) ;
              var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (359)) ;
            }else{
              mClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this class inherits from @")).operator_concat (var_cas_superClassName)).operator_concat (GGS_string (", but @"))).operator_concat (var_cas_superClassName)).operator_concat (GGS_string (" is not a class")) COMMA_SOURCE_FILE_AT_LINE (365)) ;
  ...
  const GGS_bool cond_17947 = var_cas_circularityError ;
  if (cond_17947.isBuiltAndTrue ()) {
    mClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("inheritance circularity for class '")).operator_concat (mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (372)))).operator_concat (GGS_string ("': "))).operator_concat (var_cas_classPath.reader_stringByReplacingStringByString (inLexique, GGS_string ("."), GGS_string (" extends ") COMMA_SOURCE_FILE_AT_LINE (373))) COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_listGalgasType) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_listmapGalgasType) ;
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  /* var_cas_inTypeCount */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring  var_cas_listTypeName = mAssociatedListTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
  GGS_ACGalgasType  var_cas_t = mAssociatedListTypeIndex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (402)) ;
  { const GGS_ACGalgasType _var_19462 = var_cas_t ; // CAST instruction
    if (_var_19462.getPtr () != NULL) {
      macroValidPointer (_var_19462.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_19462.getPtr ()) != NULL) {
      }else{
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_structGalgasType) ;
...
e_indexAttributeMap::e_indexAttributeMap (void) :
mAttributeIndex () {
}

//---------------------------------------------------------------------------*
//                                                                           *
//                      class map '@indexAttributeMap'                       *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptorEX kTypeDescriptor_GGS_indexAttributeMap ("indexAttributeMap", false, NULL) ;

//---------------------------------------------------------------------------*

elementOf_GGS_indexAttributeMap::
elementOf_GGS_indexAttributeMap (const GGS_lstring & inKey,
              const PMSInt32 inIndex,
...
void elementOf_GGS_indexAttributeMap::
appendForMapDescription (const PMSInt32 inElementIndex,
                         C_String & ioString,
                         const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mAttributeIndex.reader_description (inIndentation + 1) ;
}

//---------------------------------------------------------------------------*

bool elementOf_GGS_indexAttributeMap::
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_indexAttributeMap * ptr = dynamic_cast <const elementOf_GGS_indexAttributeMap *> (inOperand) ;
  macroValidPointer (ptr) ;
  return (mInfo.mAttributeIndex.operator_isEqual (ptr->mInfo.mAttributeIndex)).boolValue () ;
}

//---------------------------------------------------------------------------*

AC_galgas_map_element * GGS_indexAttributeMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_indexAttributeMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  e_indexAttributeMap * info = (e_indexAttributeMap *) inInfo ;
  macroMyNew (p, cElement (inKey, nextIndex (), * info)) ;
  return p ;
}
...
GGS_indexAttributeMap GGS_indexAttributeMap::
constructor_emptyMap (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
  GGS_indexAttributeMap result ;
  macroMyNew (result.mSharedMapRoot, cMapRoot) ;
  return result ;
}
...
GGS_bool GGS_indexAttributeMap::
operator_isEqual (const GGS_indexAttributeMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), isEqualToMap (inOperand)) ;
}
...
GGS_bool GGS_indexAttributeMap::
operator_isNotEqual (const GGS_indexAttributeMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToMap (inOperand)) ;
}
...
insertElement (C_Compiler & inLexique,
  ...
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    insulateMap () ;
    e_indexAttributeMap info  ;
    info.mAttributeIndex = inParameter0 ;
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, elementID, existingKeyLocation) ;
    if (elementID < 0) {
      emitInsertMapSemanticErrorMessage (inLexique, inKey, inErrorMessage, existingKeyLocation COMMA_THERE) ;
...
searchElement (C_Compiler & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mAttributeIndex ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (PMUInt32) node->mID), inKey) ;
    }
  }
...
const utf32 GGS_indexAttributeMap::kSearchMessage_searchKey [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
const utf32 GGS_indexAttributeMap::kInsertMessage_insertKey [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
constructor_mapWithMapToOverride (C_Compiler & /* inLexique */,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GGS_indexAttributeMap result ; // Not Built
  if (inMapToOverride.mSharedMapRoot != NULL) {
    macroValidPointer (inMapToOverride.mSharedMapRoot) ;
    macroMyNew (result.mSharedMapRoot, cMapRoot) ;
    result.mSharedMapRoot->mNextMap = inMapToOverride.mSharedMapRoot ;
...
GGS_string GGS_indexAttributeMap::
reader_description (const PMSInt32 inIndentation) const {
  C_String s ;
  s << "<map @indexAttributeMap " ;
  if (isBuilt ()) {
    s.appendSigned (count ()) ;
    s << " object" << ((count () > 1) ? "s " : " ") ;
    cMapRoot * mapRoot = mSharedMapRoot ;
...
/* const */ GGS_uint  & GGS_indexAttributeMap::cEnumerator::_mAttributeIndex (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mAttributeIndex ;
}

//---------------------------------------------------------------------------*

GGS_object GGS_indexAttributeMap::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_indexAttributeMap * p = NULL ;
    macroMyNew (p, GGS_indexAttributeMap (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_indexAttributeMap GGS_indexAttributeMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_indexAttributeMap result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_indexAttributeMap * p = dynamic_cast <const GGS_indexAttributeMap *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_indexAttributeMap, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_indexAttributeMap::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_indexAttributeMap ;
}
...
GGS_uint  GGS_sortDescriptorList::
...
/* const */ GGS_uint  & GGS_sortDescriptorList::cEnumerator::_mAttributeIndex (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
/* const */ GGS_bool & GGS_sortDescriptorList::cEnumerator::_mAscendingOrder (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_sortedlistGalgasType) ;
...
GGS_mapMethodMap GGS_mapMethodMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_mapMethodMap result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_mapType) ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_mapindexType) ;
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  /* var_cas_inTypeCount */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring  var_cas_mapTypeName = mIndexOfMapType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (484)) ;
  GGS_ACGalgasType  var_cas_t = mIndexOfMapType.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (485)) ;
  { const GGS_ACGalgasType _var_22811 = var_cas_t ; // CAST instruction
    if (_var_22811.getPtr () != NULL) {
      macroValidPointer (_var_22811.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_22811.getPtr ()) != NULL) {
      }else{
...
cPtr__AC_galgas_class * cPtr_mapindexType::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_mapindexType (mMapIndexTypeName, mIndexOfMapType COMMA_HERE)) ;
  return result ;
}
...
GGS_enumMessageMap GGS_enumMessageMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_enumMessageMap result ;
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_enumType) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Implementation of routine "addTypeListEX"                  *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_addTypeListEX (C_Compiler & inLexique,
                                const GGS_string  var_cas_inElementTypeName,
                                GGS_typeMap  & var_cas_ioTypeMap COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addTypeListEX at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_attributeList  var_cas_lstringAttribute = GGS_attributeList ::constructor_emptyList () ;
  GGS_typeMapIndex  var_cas_lstringIndex ;
  GGS_typeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inElementTypeName, GGS_location (inLexique) COMMA_HERE), var_cas_ioTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (536)) ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (inLexique, var_cas_lstringlist, GGS_listGalgasType ::constructor_new (inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (539)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_addTypeListEX\n") ;
  #endif
}
...
GGS_typeMap  function_constructPrimitiveTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_typeMap  var_cas_outTypeMap ;
    ...
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_HERE), GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (547)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_HERE), GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (548)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_HERE), GGS_boolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (549)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_HERE), GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (550)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint"), GGS_location (inLexique) COMMA_HERE), GGS_sintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (551)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64"), GGS_location (inLexique) COMMA_HERE), GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (552)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint64"), GGS_location (inLexique) COMMA_HERE), GGS_sint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (553)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("double"), GGS_location (inLexique) COMMA_HERE), GGS_doubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (554)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_HERE), GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (555)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_HERE), GGS_lcharGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (556)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_HERE), GGS_lboolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (557)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_HERE), GGS_luintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (558)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_HERE), GGS_lsintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (559)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_HERE), GGS_luint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (560)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_HERE), GGS_lsint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (561)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_HERE), GGS_ldoubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (562)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("binaryset"), GGS_location (inLexique) COMMA_HERE), GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (563)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringset"), GGS_location (inLexique) COMMA_HERE), GGS_stringsetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_HERE), GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (565)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("data"), GGS_location (inLexique) COMMA_HERE), GGS_dataGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (566)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("type"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (567)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("function"), GGS_location (inLexique) COMMA_HERE), GGS_functionGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (568)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("object"), GGS_location (inLexique) COMMA_HERE), GGS_objectGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (569)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_constructPrimitiveTypeMap (C_Compiler & inLexique,
...
GGS_typeMap  function_constructBuiltinTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_constructBuiltinTypeMap) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_constructBuiltinTypeMap at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_typeMap  var_cas_outTypeMap ;
    var_cas_outTypeMap = function_constructPrimitiveTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (575)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("lstring"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (577)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("string"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (579)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("type"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (581)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("uint64"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (583)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("luint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (585)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("uint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (587)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("function"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (589)) ;
    ::routine_addTypeListEX (inLexique,  GGS_string ("object"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (591)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_constructBuiltinTypeMap (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (609)) ;
    const GGS_typeMap  temp_28802 = var_cas_typeMap ;
    if (temp_28802.isBuilt ()) {
      temp_28802 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (610)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_lstringlist_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_stringlist_type) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_build_stringlist_type at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (616)) ;
    const GGS_typeMap  temp_29073 = var_cas_typeMap ;
    if (temp_29073.isBuilt ()) {
      temp_29073 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (617)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_stringlist_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_uint64list_type) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_build_uint64list_type at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (623)) ;
    const GGS_typeMap  temp_29343 = var_cas_typeMap ;
    if (temp_29343.isBuilt ()) {
      temp_29343 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (624)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_uint64list_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_typelist_type) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_build_typelist_type at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (630)) ;
    const GGS_typeMap  temp_29611 = var_cas_typeMap ;
    if (temp_29611.isBuilt ()) {
      temp_29611 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (631)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_typelist_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_objectlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_objectlist_type) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_build_objectlist_type at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (637)) ;
    const GGS_typeMap  temp_29879 = var_cas_typeMap ;
    if (temp_29879.isBuilt ()) {
      temp_29879 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("objectlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (638)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_objectlist_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_functionlist_type) {
    #ifdef DEBUG_TRACE_ENABLED
      printf ("ENTER function_build_functionlist_type at %s:%d\n", __FILE__, __LINE__) ;
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (644)) ;
    const GGS_typeMap  temp_30151 = var_cas_typeMap ;
    if (temp_30151.isBuilt ()) {
      temp_30151 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (645)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_build_functionlist_type (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
static void epilogueRoutineFor_semanticsTypesEX (void) {
  macroReleaseObject (gSingleton_dataGalgasType) ;
  macroReleaseObject (gSingleton_typeGalgasType) ;
  macroReleaseObject (gSingleton_objectGalgasType) ;
  macroReleaseObject (gSingleton_functionGalgasType) ;
  macroReleaseObject (gSingleton_locationGalgasType) ;
  macroReleaseObject (gSingleton_stringGalgasType) ;
  macroReleaseObject (gSingleton_charGalgasType) ;
  macroReleaseObject (gSingleton_boolGalgasType) ;
  macroReleaseObject (gSingleton_uintGalgasType) ;
  macroReleaseObject (gSingleton_sintGalgasType) ;
  macroReleaseObject (gSingleton_uint64GalgasType) ;
  macroReleaseObject (gSingleton_sint64GalgasType) ;
  macroReleaseObject (gSingleton_doubleGalgasType) ;
  macroReleaseObject (gSingleton_lstringGalgasType) ;
  macroReleaseObject (gSingleton_lcharGalgasType) ;
  macroReleaseObject (gSingleton_lboolGalgasType) ;
  macroReleaseObject (gSingleton_luintGalgasType) ;
  macroReleaseObject (gSingleton_lsintGalgasType) ;
  macroReleaseObject (gSingleton_luint64GalgasType) ;
  macroReleaseObject (gSingleton_lsint64GalgasType) ;
  macroReleaseObject (gSingleton_ldoubleGalgasType) ;
  macroReleaseObject (gSingleton_stringsetGalgasType) ;
  macroReleaseObject (gSingleton_binarysetGalgasType) ;
...
C_PrologueEpilogue prologueEpilogueObjectFor_semanticsTypesEX (NULL, epilogueRoutineFor_semanticsTypesEX) ;
