...
GGS_typeMap  function_constructBuiltinTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_typeMap  var_cas_outTypeMap ;
    ...
    ::routine_addTypeList (inLexique,  GGS_string ("lstring"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (577)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("string"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (579)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("type"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (581)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint64"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (583)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("luint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (585)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (587)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("function"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (589)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("object"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (591)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_28784 = var_cas_typeMap ;
    if (temp_28784.isBuilt ()) {
      temp_28784 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (610)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29055 = var_cas_typeMap ;
    if (temp_29055.isBuilt ()) {
      temp_29055 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (617)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29325 = var_cas_typeMap ;
    if (temp_29325.isBuilt ()) {
      temp_29325 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (624)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29593 = var_cas_typeMap ;
    if (temp_29593.isBuilt ()) {
      temp_29593 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (631)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_objectlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29861 = var_cas_typeMap ;
    if (temp_29861.isBuilt ()) {
      temp_29861 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("objectlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (638)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_30133 = var_cas_typeMap ;
    if (temp_30133.isBuilt ()) {
      temp_30133 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (645)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
