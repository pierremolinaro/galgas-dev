...
void routine_recursivlyEnumerateRegularFile (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_23724 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_23724 = NULL ;
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_23865 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_23865 = NULL ;
while (((operand_23865 = enumerator_23865.nextObject ()))) {
  macroValidPointer (operand_23865) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_23865->mInfo.mRegularFileMap,  operand_23865->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (638)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_24172
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24172 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_24172->mFilewrapperFileMap,  operand_24172->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (650)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_24172->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_24596 (operand_24172->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_24596 = NULL ;
while (((operand_24596 = enumerator_24596.nextObject ()))) {
  macroValidPointer (operand_24596) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_24172->mFilewrapperName, operand_24596->mFilewrapperTemplateName, operand_24596->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_24990
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24990 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_24990->mTypeName, operand_24990->mAbstractCategoryMethodName, operand_24990->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_25371
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25371 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_25371->mTypeName, operand_25371->mCategoryMethodName, operand_25371->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_26036
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26036 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_26229
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26229 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_26229->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (703)), operand_26229->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), operand_26229->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_26566
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26566 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_26566->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (713)), operand_26566->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), ((operand_26566->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (715))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_26566->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (715)))), operand_26566->mTypedAttributeList, operand_26566->mAllTypedAttributeList, operand_26566->mIsAbstract, operand_26566->mAbstractMethodList, operand_26566->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_27481
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_27707
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27707 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_27707->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), operand_27707->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (740)), operand_27707->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (741)), operand_27707->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (742))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_28438
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_28660
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28660 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_28660->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_28660->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_28660->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_29089
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29089 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_29089->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29089->mTypedAttributeList, operand_29089->mInsertMethodList, operand_29089->mSearchMethodList, operand_29089->mRemoveMethodList, operand_29089->mHasInsertOrReplaceModifier, operand_29089->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_29574
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29574 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_29574->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_29574->mTypedAttributeList, operand_29574->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_29961
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29961 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_29961->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), operand_29961->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (796)), operand_29961->mConstantList, operand_29961->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_30359
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30359 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_30359->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (806)), operand_30359->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (807)), operand_30359->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_30359->mAssociatedMapTypedAttributeList, operand_30359->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_30834
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30834 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_30834->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (818)), operand_30834->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), ((operand_30834->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (820))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_30834->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (820)))), operand_30834->mTypedAttributeList, operand_30834->mAllTypedAttributeList, operand_30834->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_30834->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_30834->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (823)) COMMA_SOURCE_FILE_AT_LINE (823)), operand_30834->mIsAbstract, operand_30834->mAbstractMethodList, operand_30834->mMethodList, operand_30834->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_31524
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31524 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_31524->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), operand_31524->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (836)), operand_31524->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_31904
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31904 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_31904->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (845)), operand_31904->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (846)), operand_31904->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_32295
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32295 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_32295->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_32295->mRoutineName.reader_identifierRepresentation ()), operand_32295->mFormalArgumentList, operand_32295->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (856))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_32932
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32932 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_32932->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_32932->mFunctionName.reader_identifierRepresentation ()), operand_32932->mFormalArgumentList, operand_32932->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32932->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (878)), operand_32932->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (873)), operand_32932->mFormalArgumentList, operand_32932->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (883))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_33584
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_33584 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_33584->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_33584->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_33584->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_33584->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (897)), operand_33584->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (892)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_33584->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (902))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_34300
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_34300 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_34300->mTypeName, operand_34300->mAbstractCategoryMethodName, operand_34300->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_35421 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_35421 = NULL ;
while (((operand_35421 = enumerator_35421.nextObject ()))) {
  macroValidPointer (operand_35421) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_35421->mFormalArgumentCppName) ;
}
}
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_string var_cas_routineBody = GGS_string ("") ;
...
{
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_35651 (var_cas_inInstructionList, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_35651 = NULL ;
while (((operand_35651 = enumerator_35651.nextObject ()))) {
  macroValidPointer (operand_35651) ;
{ typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_35651->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35651->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (942)) ;
  }
}
}
}
...
const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
const GGS_bool cond_36173 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_36173.isBuiltAndTrue ()) {
...
var_cas_outGeneratedCode.appendCString (" * ") ;
}else if (cond_36173.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
...
const GGS_bool cond_36451 = var_cas_currentObjectIsUnused ;
if (cond_36451.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
}else if (cond_36451.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("inObject") ;
}
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_36535 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_36535 = NULL ;
while (((operand_36535 = enumerator_36535.nextObject ()))) {
  macroValidPointer (operand_36535) ;
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (962)) ;
switch (operand_36535->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (965))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (967))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (969))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (971))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::kNotBuilt:
...
const GGS_bool cond_37313 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_36535->mFormalArgumentCppName) ;
if (cond_37313.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentCppName) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_37313.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (operand_36535->mFormalArgumentCppName) ;
}
}
}
...
const GGS_bool cond_37675 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (983))) ;
if (cond_37675.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (984))) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_37675.isBuiltAndFalse ()) {
...
var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
var_cas_outGeneratedCode.appendCString (") {\n") ;
const GGS_bool cond_38436 = (var_cas_currentObjectIsUnused).operator_not () ;
if (cond_38436.isBuiltAndTrue ()) {
const GGS_bool cond_38122 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_38122.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
}else if (cond_38122.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_38679
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38679 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_38679->mTypeName, GGS_string (""), operand_38679->mCategoryMethodName, operand_38679->mCategoryMethodFormalParameterList, operand_38679->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1009)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_38679->mTypeName, operand_38679->mCategoryMethodName, operand_38679->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_39303
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39303 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_39303->mTypeName, operand_39303->mBaseTypeName, operand_39303->mCategoryMethodName, operand_39303->mCategoryMethodFormalParameterList, operand_39303->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1027)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_39303->mTypeName, operand_39303->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_40155 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_40155 = NULL ;
while (((operand_40155 = enumerator_40155.nextObject ()))) {
  macroValidPointer (operand_40155) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_40155->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1053)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_40155->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_40155->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1056))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_40155->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1059))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_40155->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_40155->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_40155->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1063))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_40997 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_40997 = NULL ;
while (((operand_40997 = enumerator_40997.nextObject ()))) {
  macroValidPointer (operand_40997) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_40997->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)),  operand_40997->mInfo.mWrapperDirectoryIndex,  operand_40997->mInfo.mRegularFileMap,  operand_40997->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1068)) ;
}
}
...
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1081)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1081))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_41585 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_41585 = NULL ;
...
var_cas_ioImplementation.dotAssign_operation (operand_41585->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1091)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1091))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_42196 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_42196 = NULL ;
while (((operand_42196 = enumerator_42196.nextObject ()))) {
  macroValidPointer (operand_42196) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_42196->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1093))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1102))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1104))) ;
var_cas_ioImplementation.appendCString (",\n"
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_43311
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43311 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_43311->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_43311->mFilewrapperFileMap,  operand_43311->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1113)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_43311->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_43770 (operand_43311->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_43770 = NULL ;
while (((operand_43770 = enumerator_43770.nextObject ()))) {
  macroValidPointer (operand_43770) ;
...
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_43770->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1133)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_43311->mFilewrapperName, operand_43770->mFilewrapperTemplateName, operand_43770->mFilewrapperTemplateFormalInputParameters, (var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)))).operator_not (), var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
