...
template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeHeader (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateCppConstructorWithCurrentAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (54)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      ...
      result << " (" ;
      columnMarker = result.currentColumn () ;
      GGS_typedAttributeList::cEnumerator enumerator_2376 (var_cas_CURRENT_TYPE_ATTRIBUTE_LIST, true) ;
      const GGS_typedAttributeList::cElement * operand_2376 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_2376 = enumerator_2376.nextObject ()))) {
      macroValidPointer (operand_2376) ;
      result << "GALGASap_" ;
      result << operand_2376->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (58)) ;
      result << " & inAttribute_" ;
      result << operand_2376->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
      if (enumerator_2376.hasNextObject ()) {
        result << ",\n" ;
        result.appendSpacesUntilColumn (columnMarker) ;
      }
...
result << " constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_nativeAttributeList::cEnumerator enumerator_3453 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_3453 = NULL ;
while (((operand_3453 = enumerator_3453.nextObject ()))) {
macroValidPointer (operand_3453) ;
result << "const " ;
result << operand_3453->mCppClassName ;
if (operand_3453->mIsPointer.boolValue ()) {
  result << " *" ;
}else {
}
if (operand_3453->mUseReferenceForConstructor.boolValue ()) {
  result << " &" ;
}else {
}
result << " inOperand_" ;
result << operand_3453->mAttributeName ;
if (enumerator_3453.hasNextObject ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
GGS_constructorMap::cEnumerator enumerator_3986 (var_cas_CONSTRUCTOR_MAP, true) ;
const GGS_constructorMap::cElement * operand_3986 = NULL ;
while (((operand_3986 = enumerator_3986.nextObject ()))) {
macroValidPointer (operand_3986) ;
result << "  public : static GALGASap_" ;
result << operand_3986->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
result << " constructor_" ;
result << operand_3986->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_4153 (operand_3986->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_4153 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4153 = enumerator_4153.nextObject ()))) {
macroValidPointer (operand_4153) ;
result << "GALGASap_" ;
result << operand_4153->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
result << " & inOperand" ;
...
if ((operand_3986->mInfo.mHasCompilerArgument).operator_and ((operand_3986->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U))).boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
}else if (operand_3986->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
}else if ((operand_3986->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_modifierMap::cEnumerator enumerator_5297 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_5297 = NULL ;
while (((operand_5297 = enumerator_5297.nextObject ()))) {
macroValidPointer (operand_5297) ;
if ((operand_5297->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).boolValue ()) {
result << "  friend void modifierCall_" ;
result << operand_5297->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_5490 (operand_5297->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_5490 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5490 = enumerator_5490.nextObject ()))) {
macroValidPointer (operand_5490) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_5490->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (135))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5490->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
}else if ((operand_5490->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (137))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5490->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (138)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (138)) ;
}else if ((operand_5490->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5490->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
}else {
result << "GALGASap_" ;
result << operand_5490->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
result << " inArgument" ;
...
if (operand_5297->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_6505 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_6505 = NULL ;
while (((operand_6505 = enumerator_6505.nextObject ()))) {
macroValidPointer (operand_6505) ;
if ((operand_6505->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (159))).boolValue ()) {
result << "  protected : void modifier_" ;
result << operand_6505->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_6663 (operand_6505->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6663 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6663 = enumerator_6663.nextObject ()))) {
macroValidPointer (operand_6663) ;
if ((operand_6663->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).boolValue ()) {
result << "GALGASap_" ;
result << operand_6663->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
}else if ((operand_6663->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (164))).boolValue ()) {
result << "GALGASap_" ;
result << operand_6663->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
}else if ((operand_6663->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (166))).boolValue ()) {
result << "GALGASap_" ;
result << operand_6663->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
}else {
result << "GALGASap_" ;
result << operand_6663->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
result << " inArgument" ;
...
if ((operand_6505->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6505->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_7930 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_7930 = NULL ;
while (((operand_7930 = enumerator_7930.nextObject ()))) {
macroValidPointer (operand_7930) ;
if ((operand_7930->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (195))).boolValue ()) {
result << "  protected : virtual void method_" ;
result << operand_7930->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8094 (operand_7930->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8094 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8094 = enumerator_8094.nextObject ()))) {
macroValidPointer (operand_8094) ;
if ((operand_8094->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8094->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
}else if ((operand_8094->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8094->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
}else if ((operand_8094->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8094->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
}else {
result << "GALGASap_" ;
result << operand_8094->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
}
if (enumerator_8094.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_7930->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7930->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if (((operand_7930->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (225)))).operator_or ((operand_7930->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (225)))).boolValue ()) {
result << "= 0 " ;
}else {
}
result << ";\n"
...
GGS_instanceMethodMap::cEnumerator enumerator_9519 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_9519 = NULL ;
while (((operand_9519 = enumerator_9519.nextObject ()))) {
macroValidPointer (operand_9519) ;
if (((operand_9519->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (234)))).operator_or ((operand_9519->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (234)))).boolValue ()) {
result << "  friend void instanceMethodCall_" ;
result << operand_9519->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_9766 (operand_9519->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9766 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9766 = enumerator_9766.nextObject ()))) {
macroValidPointer (operand_9766) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_9766->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (238))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9766->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
}else if ((operand_9766->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (240))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9766->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
}else if ((operand_9766->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (242))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9766->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
}else {
result << "GALGASap_" ;
result << operand_9766->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " inArgument" ;
...
if (operand_9519->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Class Methods\n" ;
GGS_classMethodMap::cEnumerator enumerator_10794 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_10794 = NULL ;
while (((operand_10794 = enumerator_10794.nextObject ()))) {
macroValidPointer (operand_10794) ;
result << "  public : static void class_method_" ;
result << operand_10794->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10901 (operand_10794->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10901 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10901 = enumerator_10901.nextObject ()))) {
macroValidPointer (operand_10901) ;
if ((operand_10901->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (264))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10901->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
}else if ((operand_10901->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (266))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10901->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
}else if ((operand_10901->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10901->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
}else {
result << "GALGASap_" ;
result << operand_10901->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
}
if (enumerator_10901.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10794->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10794->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_12087 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_12087 = NULL ;
while (((operand_12087 = enumerator_12087.nextObject ()))) {
macroValidPointer (operand_12087) ;
if ((operand_12087->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (296))).boolValue ()) {
result << "  protected : virtual GALGASap_" ;
result << operand_12087->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (297)) ;
result << " reader_" ;
result << operand_12087->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12312 (operand_12087->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_12312 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12312 = enumerator_12312.nextObject ()))) {
macroValidPointer (operand_12312) ;
result << "GALGASap_" ;
result << operand_12312->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (299)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (299)) ;
if (enumerator_12312.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_12087->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_12087->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if ((operand_12087->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
GGS_readerMap::cEnumerator enumerator_13030 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_13030 = NULL ;
while (((operand_13030 = enumerator_13030.nextObject ()))) {
macroValidPointer (operand_13030) ;
if ((operand_13030->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (325))).boolValue ()) {
result << "  friend GALGASap_" ;
result << operand_13030->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
result << " readerCall_" ;
result << operand_13030->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_13287 (operand_13030->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_13287 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_13287->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (329)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_13030->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_18868 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_18868 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_18868->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (459)) ;
result << " inOperand" ;
...
GGS_nativeAttributeList::cEnumerator enumerator_19868 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_19868 = NULL ;
while (((operand_19868 = enumerator_19868.nextObject ()))) {
macroValidPointer (operand_19868) ;
result << "  private : " ;
if (operand_19868->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_19868->mCppClassName ;
result << " " ;
if (operand_19868->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_19868->mAttributeName ;
result << " ;\n" ;
if ((operand_19868->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_19868->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_20255 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20255 = NULL ;
while (((operand_20255 = enumerator_20255.nextObject ()))) {
macroValidPointer (operand_20255) ;
result << "  public : GALGASap_" ;
result << operand_20255->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) ;
result << " mAttribute_" ;
result << operand_20255->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
GGS_withAccessorMap::cEnumerator enumerator_21234 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21234 = NULL ;
while (((operand_21234 = enumerator_21234.nextObject ()))) {
macroValidPointer (operand_21234) ;
result << "  friend cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_21234->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21234->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_22009 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22009 = NULL ;
while (((operand_22009 = enumerator_22009.nextObject ()))) {
macroValidPointer (operand_22009) ;
result << "    public : GALGASap_" ;
result << operand_22009->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) ;
result << " attribute_" ;
result << operand_22009->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22311 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22311 = NULL ;
while (((operand_22311 = enumerator_22311.nextObject ()))) {
macroValidPointer (operand_22311) ;
if ((operand_22311->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (538))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22311->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (539)) ;
result << " readerCall_" ;
result << operand_22311->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22559 (operand_22311->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22559 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22559 = enumerator_22559.nextObject ()))) {
macroValidPointer (operand_22559) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22559->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (542)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (542)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22311->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_22960 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_22960 = NULL ;
while (((operand_22960 = enumerator_22960.nextObject ()))) {
macroValidPointer (operand_22960) ;
if ((operand_22960->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (556))).boolValue ()) {
result << "  void modifierCall_" ;
result << operand_22960->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23146 (operand_22960->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23146 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23146 = enumerator_23146.nextObject ()))) {
macroValidPointer (operand_23146) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23146->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (560))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23146->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (561)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (561)) ;
}else if ((operand_23146->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (562))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23146->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (563)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (563)) ;
}else if ((operand_23146->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23146->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (565)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)) ;
}else {
result << "GALGASap_" ;
result << operand_23146->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (567)) ;
result << " inArgument" ;
...
if (operand_22960->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24186 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24186 = NULL ;
while (((operand_24186 = enumerator_24186.nextObject ()))) {
macroValidPointer (operand_24186) ;
if (((operand_24186->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (583)))).operator_or ((operand_24186->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (583)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24186->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24424 (operand_24186->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24424 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24424 = enumerator_24424.nextObject ()))) {
macroValidPointer (operand_24424) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24424->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (587))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24424->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
}else if ((operand_24424->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (589))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24424->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (590)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (590)) ;
}else if ((operand_24424->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (591))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24424->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (592)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (592)) ;
}else {
result << "GALGASap_" ;
result << operand_24424->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (594)) ;
result << " inArgument" ;
...
if (operand_24186->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25498 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25498 = NULL ;
while (((operand_25498 = enumerator_25498.nextObject ()))) {
macroValidPointer (operand_25498) ;
result << "cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_25498->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25498->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (612)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_26010 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_26010 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_26010->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (621)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (621)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
result << "\n" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (626)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- .= operator\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (633)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- << and >> shift operators\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " left_shift_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (643)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_and (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (650)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- | operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_or (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (657)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ^ operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_xor (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (664)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_not (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (670)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ~ operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_tilde (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (676)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- . (concat) operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_concat (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (683)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- + operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " add_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (691)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- - operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " substract_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (699)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- * operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " multiply_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (707)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- / operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " divide_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (715)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- mod operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " modulo_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (723)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- unary - operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_unary_minus (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (730)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ++, -- operators\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_new (" ;
GGS_typedAttributeList::cEnumerator enumerator_5196 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5196 = NULL ;
while (((operand_5196 = enumerator_5196.nextObject ()))) {
macroValidPointer (operand_5196) ;
result << "ioObject.ptr (HERE)->mAttribute_" ;
result << operand_5196->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_5196.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5411 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5411 = NULL ;
while (((operand_5411 = enumerator_5411.nextObject ()))) {
macroValidPointer (operand_5411) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5411->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5411->mSignature, operand_5411->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (142)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5832 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5832->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5832->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5832->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
...
GGS_typedAttributeList::cEnumerator enumerator_6240 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6240 = NULL ;
while (((operand_6240 = enumerator_6240.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6240->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_6240->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  mAttribute_" ;
result << operand_6240->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "}\n"
  "\n" ;
}
...
result << var_cas_FUNCTION_NAME.reader_identifierRepresentation () ;
result << " [" ;
result << var_cas_FORMAL_ARGUMENT_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (13)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (13)) ;
result << "] = {\n" ;
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_846 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_846 = NULL ;
while (((operand_846 = enumerator_846.nextObject ()))) {
macroValidPointer (operand_846) ;
result << "  & kTypeDescriptor_GALGAS_" ;
result << operand_846->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
result << ",\n" ;
}
result << "  NULL\n"
  "} ;\n"
...
result << ",\n"
  "                                                          " ;
result << var_cas_FORMAL_ARGUMENT_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (28)) ;
result << ",\n"
  "                                                          functionArgs_" ;
result << var_cas_FUNCTION_NAME.reader_identifierRepresentation () ;
result << ",\n"
  ...
  "  if (ok) {\n" ;
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_2046 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_2046 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2046 = enumerator_2046.nextObject ()))) {
macroValidPointer (operand_2046) ;
result << "    GALGASap_" ;
result << operand_2046->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
result << " operand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
...
result << var_cas_FUNCTION_NAME.reader_identifierRepresentation () ;
result << " (" ;
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_2347 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_2347 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_14492
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14492 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_14704
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14704 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_14704->mRoutineName, operand_14704->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_15030
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15030 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15030->mFunctionName, operand_15030->mFormalArgumentList, operand_15030->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (377))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_15397
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15397 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15397->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_15397->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (387))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_15784
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15784 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeHeader (inLexique, operand_15784->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (395)), operand_15784->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (396)), operand_15784->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (397)), operand_15784->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (398)), operand_15784->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (399)), operand_15784->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (400)), operand_15784->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (401)), operand_15784->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (402)), operand_15784->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (403)), operand_15784->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (404)), operand_15784->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (405)), operand_15784->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (406)), operand_15784->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_15784->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (408)), operand_15784->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (409)), operand_15784->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (410)), operand_15784->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (411)), operand_15784->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (412)), operand_15784->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (413))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_16739
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16739 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_genericTypeHeader (inLexique, operand_16739->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (421)), operand_16739->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (422))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17395
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_17608
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17608 != NULL) {
const GGS_bool cond_17699 = (operand_17608->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (439))).operator_isEqual (GGS_string ("object")) ;
if (cond_17699.isBuiltAndTrue ()) {
var_cas_outHeader = GGS_string ("") ;
}else if (cond_17699.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (inLexique, operand_17608->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (443)), operand_17608->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (444)), operand_17608->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (445)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (445)), operand_17608->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (446)), operand_17608->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (447))) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_18500
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18500 != NULL) {
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_18732
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18732 != NULL) {
const GGS_bool cond_18839 = (operand_18732->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (465))).operator_isEqual (GGS_string ("object")) ;
if (cond_18839.isBuiltAndTrue ()) {
var_cas_outImplementation = GGS_string ("") ;
}else if (cond_18839.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassImplementation (inLexique, operand_18732->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_18732->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_18732->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (471)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_18732->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_18732->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (473))) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_19729
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19729 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_19955
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19955 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeImplementation (inLexique, operand_19955->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_19955->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_19955->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_19955->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_19955->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_19955->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_19955->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_19955->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_19955->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_19955->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_19955->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (503)), operand_19955->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (504)), operand_19955->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (505)), operand_19955->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), operand_19955->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (507))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_20789
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20789 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_genericTypeImplementation (inLexique, operand_20789->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (516)), operand_20789->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_20789->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_21492
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21492 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_21716
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21716 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_21716->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_21716->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (537)), operand_21716->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_21716->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), operand_21716->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (540))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_22222
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22222 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_22222->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_22222->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_22594
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22594 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_22594->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (557)), operand_22594->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (558)), operand_22594->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_23036
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23036 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_23036->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_23036->mTypedAttributeList, operand_23036->mInsertMethodList, operand_23036->mSearchMethodList, operand_23036->mRemoveMethodList, operand_23036->mHasInsertOrReplaceModifier, operand_23036->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_23534
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23534 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_23534->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (581)), operand_23534->mTypedAttributeList, operand_23534->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_23936
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23936 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_23936->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_23936->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_23936->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_24329
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24329 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_24329->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (601)), operand_24329->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (602)), operand_24329->mConstantList, operand_24329->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_24740
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24740 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_24740->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (612)), operand_24740->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (613)), operand_24740->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (614)), operand_24740->mAssociatedMapTypedAttributeList, operand_24740->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_25228
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25228 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_25228->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (624)), operand_25228->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), ((operand_25228->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (626))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_25228->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (626)))), operand_25228->mTypedAttributeList, operand_25228->mAllTypedAttributeList, operand_25228->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_25228->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_25228->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)), operand_25228->mIsAbstract, operand_25228->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_25899
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25899 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_25899->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_25899->mRoutineName.reader_identifierRepresentation ()), operand_25899->mFormalArgumentList, operand_25899->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (640))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_26536
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26536 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_26536->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_26536->mFunctionName.reader_identifierRepresentation ()), operand_26536->mFormalArgumentList, operand_26536->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_26536->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (662)), operand_26536->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (657)), operand_26536->mFormalArgumentList, operand_26536->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (666))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_27159
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27159 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_27159->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_27159->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_27159->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_27159->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (680)), operand_27159->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (675)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_27159->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (684))) ;
  }
  return var_cas_outImplementation ;
}
