...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_22223 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22223 = NULL ;
while (((operand_22223 = enumerator_22223.nextObject ()))) {
macroValidPointer (operand_22223) ;
result << "    public : GALGAS_" ;
result << operand_22223->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) ;
result << " * attribute_" ;
result << operand_22223->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_3939 = GGS_uint (2U) ;
if (indentation_3939.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_3939.uintValue ()) ;
}
...
result << " COMMA_THERE) ;\n"
  "if (NULL != attributes) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3596 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3596 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3596 = enumerator_3596.nextObject ()))) {
macroValidPointer (operand_3596) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << " = (GALGAS_" ;
result << operand_3596->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
result << ", GALGAS_" ;
result << operand_3596->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_3979 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_3979 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3979->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4217->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_5085 = GGS_uint (2U) ;
if (indentation_5085.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_5085.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_3979->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (94)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) ;
result << "] = " ;
result << operand_3979->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "cRootObjectArray attributes ;\n"
  "    performRemove (inKey, attributes, inCompiler, kRemoveErrorMessage COMMA_THERE) ;\n"
  "if (attributes.count () != 0) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4743 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4743 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4743 = enumerator_4743.nextObject ()))) {
macroValidPointer (operand_4743) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << " = (GALGAS_" ;
result << operand_4743->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << " *) attributes.objectAtIndex (" ;
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (99)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << " COMMA_HERE) ;\n"
  "  macroValidObject (outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
result << ", GALGAS_" ;
result << operand_4743->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5336 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5336 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5336->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) ;
result << " * inArgument" ;
...
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5613 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5613 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5613 = enumerator_5613.nextObject ()))) {
macroValidPointer (operand_5613) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_5765 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5765 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5765 = enumerator_5765.nextObject ()))) {
macroValidPointer (operand_5765) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5765->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5765->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                                               " ;
...
result << operand_5765->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
result << ") ;\n"
  "  return (GALGAS_" ;
result << operand_5765->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
result << " *) result ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_6542 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6542 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6542->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6542->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_withAccessorMap::cEnumerator enumerator_7518 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_7518 = NULL ;
while (((operand_7518 = enumerator_7518.nextObject ()))) {
macroValidPointer (operand_7518) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_7518->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7518->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
result << " * inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_7518->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
