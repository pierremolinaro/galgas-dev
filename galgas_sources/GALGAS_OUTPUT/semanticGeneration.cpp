...
if ((operand_4974->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (127))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_4974->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
}else if ((operand_4974->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (129))).boolValue ()) {
result << "GALGAS_" ;
result << operand_4974->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
}else if ((operand_4974->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).boolValue ()) {
result << "GALGAS_" ;
result << operand_4974->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
}else {
result << "GALGAS_" ;
result << operand_4974->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
result << " * inArgument" ;
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_6162 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_6162 = NULL ;
while (((operand_6162 = enumerator_6162.nextObject ()))) {
macroValidPointer (operand_6162) ;
if ((operand_6162->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (159))).boolValue ()) {
result << "  protected : virtual void method_" ;
result << operand_6162->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_6325 (operand_6162->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6325 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6325 = enumerator_6325.nextObject ()))) {
macroValidPointer (operand_6325) ;
if ((operand_6325->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_6325->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
}else if ((operand_6325->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (164))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6325->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
}else if ((operand_6325->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (166))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6325->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
}else {
result << "GALGAS_" ;
result << operand_6325->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
}
if (enumerator_6325.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_6162->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6162->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") const " ;
if (((operand_6162->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (189)))).operator_or ((operand_6162->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (189)))).boolValue ()) {
result << "= 0 " ;
}else {
}
result << ";\n"
...
GGS_instanceMethodMap::cEnumerator enumerator_7740 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_7740 = NULL ;
while (((operand_7740 = enumerator_7740.nextObject ()))) {
macroValidPointer (operand_7740) ;
if (((operand_7740->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (198)))).operator_or ((operand_7740->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (198)))).boolValue ()) {
result << "  friend void instanceMethodCall_" ;
result << operand_7740->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_7986 (operand_7740->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7986 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7986 = enumerator_7986.nextObject ()))) {
macroValidPointer (operand_7986) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_7986->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_7986->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
}else if ((operand_7986->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7986->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
}else if ((operand_7986->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (206))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7986->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
}else {
result << "GALGAS_" ;
result << operand_7986->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
result << " * inArgument" ;
...
if (operand_7740->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Class Methods\n" ;
GGS_classMethodMap::cEnumerator enumerator_8998 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_8998 = NULL ;
while (((operand_8998 = enumerator_8998.nextObject ()))) {
macroValidPointer (operand_8998) ;
result << "  public : static void class_method_" ;
result << operand_8998->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9104 (operand_8998->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9104 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9104 = enumerator_9104.nextObject ()))) {
macroValidPointer (operand_9104) ;
if ((operand_9104->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_9104->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
}else if ((operand_9104->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (230))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9104->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
}else if ((operand_9104->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (232))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9104->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
}else {
result << "GALGAS_" ;
result << operand_9104->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
}
if (enumerator_9104.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8998->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8998->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_10274 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_10274 = NULL ;
while (((operand_10274 = enumerator_10274.nextObject ()))) {
macroValidPointer (operand_10274) ;
if (((operand_10274->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).operator_and ((operand_10274->mInfo.mImplicitConversionReader).operator_isEqual (GGS_string (""))).boolValue ()) {
result << "  protected : virtual GALGAS_" ;
result << operand_10274->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
result << " * reader_" ;
result << operand_10274->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_10536 (operand_10274->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_10536 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10536 = enumerator_10536.nextObject ()))) {
macroValidPointer (operand_10536) ;
result << "const GALGAS_" ;
result << operand_10536->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
if (enumerator_10536.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10274->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10274->mInfo.mHasLexiqueArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") const" ;
if ((operand_10274->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (280))).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_16753 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_16753 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_16753->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_17126 (var_cas_MINUS_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_17126 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_17126->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (418)) ;
result << " * inOperand" ;
...
result << "\n"
  ...
  "\n"
  "//--------------------------------- Private data member\n" ;
GGS_nativeAttributeList::cEnumerator enumerator_18206 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_18206 = NULL ;
while (((operand_18206 = enumerator_18206.nextObject ()))) {
macroValidPointer (operand_18206) ;
result << "  private : " ;
if (operand_18206->mIsPointer.boolValue ()) {
result << "const " ;
}else {
}
result << operand_18206->mCppClassName ;
result << " " ;
if (operand_18206->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_18206->mAttributeName ;
result << " ;\n" ;
if ((operand_18206->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_18206->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_18597 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_18597 = NULL ;
while (((operand_18597 = enumerator_18597.nextObject ()))) {
macroValidPointer (operand_18597) ;
result << "  protected : GALGAS_" ;
result << operand_18597->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (449)) ;
result << " * mAttribute_" ;
result << operand_18597->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_18831 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_18831 = NULL ;
while (((operand_18831 = enumerator_18831.nextObject ()))) {
macroValidPointer (operand_18831) ;
result << "  friend void modifierCall_" ;
result << operand_18831->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_18968 (operand_18831->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18968 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18968 = enumerator_18968.nextObject ()))) {
macroValidPointer (operand_18968) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_18968->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (457))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_18968->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
}else if ((operand_18968->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (459))).boolValue ()) {
result << "GALGAS_" ;
result << operand_18968->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
}else if ((operand_18968->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (461))).boolValue ()) {
result << "GALGAS_" ;
result << operand_18968->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (462)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (462)) ;
}else {
result << "GALGAS_" ;
result << operand_18968->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (464)) ;
result << " * inArgument" ;
...
if (operand_18831->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_readerMap::cEnumerator enumerator_19944 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_19944 = NULL ;
while (((operand_19944 = enumerator_19944.nextObject ()))) {
macroValidPointer (operand_19944) ;
if ((operand_19944->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (477))).boolValue ()) {
result << "  friend GALGAS_" ;
result << operand_19944->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (478)) ;
result << " * readerCall_" ;
result << operand_19944->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_20204 (operand_19944->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_20204 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20204 = enumerator_20204.nextObject ()))) {
macroValidPointer (operand_20204) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_20204->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_19944->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_21628 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_21628 = NULL ;
while (((operand_21628 = enumerator_21628.nextObject ()))) {
macroValidPointer (operand_21628) ;
result << "    public : const GALGAS_" ;
result << operand_21628->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (516)) ;
result << " * attribute_" ;
result << operand_21628->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
if (((operand_3824->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (100)))).operator_or ((operand_3824->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (100)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_4150 (operand_3824->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_4150 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4150 = enumerator_4150.nextObject ()))) {
macroValidPointer (operand_4150) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_4150->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (105))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_4150->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
}else if ((operand_4150->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (107))).boolValue ()) {
result << "GALGAS_" ;
result << operand_4150->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
}else if ((operand_4150->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (109))).boolValue ()) {
result << "GALGAS_" ;
result << operand_4150->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
}else {
result << "GALGAS_" ;
result << operand_4150->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
result << " * inArgument" ;
...
result << operand_3824->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_5231 (operand_3824->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_5231 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5231 = enumerator_5231.nextObject ()))) {
macroValidPointer (operand_5231) ;
if ((operand_5231->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (126))).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
}else if ((operand_5231->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
}else if ((operand_5231->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (130))).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_5231.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
GGS_readerMap::cEnumerator enumerator_6151 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_6151 = NULL ;
while (((operand_6151 = enumerator_6151.nextObject ()))) {
macroValidPointer (operand_6151) ;
if ((operand_6151->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (158))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_6151->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " * readerCall_" ;
result << operand_6151->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6493 (operand_6151->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6493 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6493 = enumerator_6493.nextObject ()))) {
macroValidPointer (operand_6493) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const GALGAS_" ;
result << operand_6493->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " * inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_6151->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << ") {\n"
  "  GALGAS_" ;
result << operand_6151->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (171)) ;
result << " * result = NULL ;\n"
  "  if (inObject != NULL) {\n" ;
if ((operand_6151->mInfo.mImplicitConversionReader).operator_isEqual (GGS_string ("")).boolValue ()) {
result << "    result = inObject->reader_" ;
result << operand_6151->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7056 (operand_6151->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_7056 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7056 = enumerator_7056.nextObject ()))) {
macroValidPointer (operand_7056) ;
result << "inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
if (enumerator_7056.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_6151->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_6151->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
...
result << operand_6151->mInfo.mImplicitConversionReader.reader_identifierRepresentation () ;
result << " (THERE)" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7644 (operand_6151->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_7644 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7644 = enumerator_7644.nextObject ()))) {
macroValidPointer (operand_7644) ;
result << ", inOperand_" ;
...
result << "*\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_8200 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8200 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8200 = enumerator_8200.nextObject ()))) {
macroValidPointer (operand_8200) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const GALGAS_" ;
result << operand_8200->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::cEnumerator::attribute_" ;
result << operand_8200->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const GALGAS_" ;
result << operand_8200->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
...
result << operand_8200->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
...
template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (C_Compiler & inLexique,
                                ...
                                const GGS_mapMethodListAST & var_cas_SEARCH_METHOD_LIST,
                                const GGS_mapMethodListAST & var_cas_REMOVE_METHOD_LIST,
...
GGS_mapMethodListAST::cEnumerator enumerator_2082 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapMethodListAST::cElement * operand_2082 = NULL ;
...
GGS_mapMethodListAST::cEnumerator enumerator_3195 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapMethodListAST::cElement * operand_3195 = NULL ;
...
GGS_mapMethodListAST::cEnumerator enumerator_2174 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapMethodListAST::cElement * operand_2174 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if ((operand_5030->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (119))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_5030->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " * /* inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " */" ;
}else if ((operand_5030->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5030->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " * & /* ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " */" ;
}else if ((operand_5030->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (123))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5030->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " * & /* outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " */" ;
}else {
result << "GALGAS_" ;
result << operand_5030->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
result << " * /* inArgument" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_6904
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_7101
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7101 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_unifiedTypeHeader (inLexique, operand_7101->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (167)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167)), operand_7101->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (168)), operand_7101->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (169)), operand_7101->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (170)), operand_7101->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (171)), operand_7101->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (172)), operand_7101->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (173)), operand_7101->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (174)), operand_7101->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (175)), operand_7101->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (176)), operand_7101->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (177)), operand_7101->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (178)), operand_7101->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (179)), operand_7101->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (180)), operand_7101->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (181)), operand_7101->mTypeIndex.reader_mMinusAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (182)), operand_7101->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (183)), operand_7101->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (184)), operand_7101->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_8065
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_8065 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_genericTypeHeader (inLexique, operand_8065->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (193)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_8065->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_9897
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9897 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_9897->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237)), operand_9897->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), operand_9897->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (239))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_10596
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10596 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_10820
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10820 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_10820->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), operand_10820->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), operand_10820->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (259)), operand_10820->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (260)), operand_10820->mTypeIndex.reader_mMinusAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (261)), operand_10820->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (262))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_11361
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11361 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_11361->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (270)), operand_11361->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_11720
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11720 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_11720->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (279)), operand_11720->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (280)), operand_11720->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_12149
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12149 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_12149->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (289)), operand_12149->mTypedAttributeList, operand_12149->mInsertMethodList, operand_12149->mSearchMethodList, operand_12149->mRemoveMethodList, operand_12149->mHasInsertOrReplaceModifier) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_12612
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12612 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_12612->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (302)), operand_12612->mTypedAttributeList, operand_12612->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_13001
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13001 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_13001->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (312)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (312)), operand_13001->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (313)), operand_13001->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_13390
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13390 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_13390->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (322)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (322)), operand_13390->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (323)), operand_13390->mConstantList, operand_13390->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_13797
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13797 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_13797->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (333)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (333)), operand_13797->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (334)), operand_13797->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (335)), operand_13797->mAssociatedMapTypedAttributeList, operand_13797->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_14281
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14281 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_14281->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (345)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (345)), operand_14281->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (346)), ((operand_14281->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (347))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_14281->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (347)))), operand_14281->mTypedAttributeList, operand_14281->mAllTypedAttributeList, operand_14281->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_14281->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_14281->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)), operand_14281->mIsAbstract, operand_14281->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
