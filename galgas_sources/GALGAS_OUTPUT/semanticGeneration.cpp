...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_18963 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_18963 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18963 = enumerator_18963.nextObject ()))) {
macroValidPointer (operand_18963) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_18963->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
result << " inOperand" ;
...
GGS_nativeAttributeList::cEnumerator enumerator_19959 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_19959 = NULL ;
while (((operand_19959 = enumerator_19959.nextObject ()))) {
macroValidPointer (operand_19959) ;
result << "  private : " ;
if (operand_19959->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_19959->mCppClassName ;
result << " " ;
if (operand_19959->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_19959->mAttributeName ;
result << " ;\n" ;
if ((operand_19959->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_19959->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_20346 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20346 = NULL ;
while (((operand_20346 = enumerator_20346.nextObject ()))) {
macroValidPointer (operand_20346) ;
result << "  public : GALGASap_" ;
result << operand_20346->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
result << " mAttribute_" ;
result << operand_20346->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
GGS_withAccessorMap::cEnumerator enumerator_21325 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21325 = NULL ;
while (((operand_21325 = enumerator_21325.nextObject ()))) {
macroValidPointer (operand_21325) ;
result << "  friend cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_21325->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21325->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_22100 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22100 = NULL ;
while (((operand_22100 = enumerator_22100.nextObject ()))) {
macroValidPointer (operand_22100) ;
result << "    public : GALGASap_" ;
result << operand_22100->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (526)) ;
result << " attribute_" ;
result << operand_22100->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22402 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22402 = NULL ;
while (((operand_22402 = enumerator_22402.nextObject ()))) {
macroValidPointer (operand_22402) ;
if ((operand_22402->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (537))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22402->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
result << " readerCall_" ;
result << operand_22402->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22650 (operand_22402->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22650 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22650->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22402->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_23051 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_23051 = NULL ;
while (((operand_23051 = enumerator_23051.nextObject ()))) {
macroValidPointer (operand_23051) ;
if ((operand_23051->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (555))).boolValue ()) {
result << "  void modifierCall_" ;
result << operand_23051->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23237 (operand_23051->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23237 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23237 = enumerator_23237.nextObject ()))) {
macroValidPointer (operand_23237) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23237->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (559))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23237->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
}else if ((operand_23237->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (561))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23237->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
}else if ((operand_23237->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (563))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23237->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
}else {
result << "GALGASap_" ;
result << operand_23237->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (566)) ;
result << " inArgument" ;
...
if (operand_23051->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24277 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24277 = NULL ;
while (((operand_24277 = enumerator_24277.nextObject ()))) {
macroValidPointer (operand_24277) ;
if (((operand_24277->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).operator_or ((operand_24277->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24277->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24515 (operand_24277->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24515 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24515 = enumerator_24515.nextObject ()))) {
macroValidPointer (operand_24515) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24515->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (586))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24515->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
}else if ((operand_24515->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (588))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24515->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
}else if ((operand_24515->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (590))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24515->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
}else {
result << "GALGASap_" ;
result << operand_24515->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (593)) ;
result << " inArgument" ;
...
if (operand_24277->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25589 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25589 = NULL ;
while (((operand_25589 = enumerator_25589.nextObject ()))) {
macroValidPointer (operand_25589) ;
result << "cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_25589->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25589->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_26101->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (620)) ;
result << " inOperand" ;
...
result << "::insulate (ioResult COMMA_THERE) ;\n"
  ...
  "  }\n"
  "}\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8322 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8322 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8322 = enumerator_8322.nextObject ()))) {
macroValidPointer (operand_8322) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_8322->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_8322->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_uint inIndex,\n"
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9016 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9016 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_9016->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_9016->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_uint & inIndex,\n"
  "                                              " ;
