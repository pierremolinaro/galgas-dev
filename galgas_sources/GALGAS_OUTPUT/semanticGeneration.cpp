...
if ((((operand_11606->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (271)))).operator_or ((operand_11606->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (271))))).operator_or ((operand_11606->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (271)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << operand_11606->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) ;
result << " reader_" ;
result << operand_11606->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11931 (operand_11606->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_11931 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11931 = enumerator_11931.nextObject ()))) {
macroValidPointer (operand_11931) ;
result << "const GALGAS_" ;
result << operand_11931->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (274)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (274)) ;
if (enumerator_11931.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (298)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_13111 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13111 = NULL ;
while (((operand_13111 = enumerator_13111.nextObject ()))) {
macroValidPointer (operand_13111) ;
result << "  public : VIRTUAL_IN_DEBUG cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * readWriteAccessForWithInstruction_" ;
result << operand_13111->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_13111->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (309)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14187 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14187 = NULL ;
while (((operand_14187 = enumerator_14187.nextObject ()))) {
macroValidPointer (operand_14187) ;
result << "  public : GALGAS_" ;
result << operand_14187->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) ;
result << " current_" ;
result << operand_14187->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14649 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14649 = NULL ;
while (((operand_14649 = enumerator_14649.nextObject ()))) {
macroValidPointer (operand_14649) ;
result << "cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_14649->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14649->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (346)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17126
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17126 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_17339
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17339 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_17339->mRoutineName, operand_17339->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_17666
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17666 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_17666->mFunctionName, operand_17666->mFormalArgumentList, operand_17666->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (467))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_18034
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18034 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_18034->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_18034->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (477))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_18419
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18419 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_18419->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_18419->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), ((operand_18419->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (487))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_18419->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (487)))), operand_18419->mAllTypedAttributeList, operand_18419->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18419->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_18419->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_18419->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18419->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18419->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18419->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18419->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_18419->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18419->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_18419->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_18419->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_18419->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (503)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_19364
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19364 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_19364->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (511)), operand_19364->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (512)), operand_19364->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19364->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (516)), operand_19364->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_19364->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19364->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19364->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19364->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19364->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_19364->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19364->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_19364->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_19364->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_19364->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (527)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_20205
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20205 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_20205->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), operand_20205->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_20205->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20205->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (540)), operand_20205->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (541)), operand_20205->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20205->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20205->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20205->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20205->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20205->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20205->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20205->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), operand_20205->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (550)), operand_20205->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (551)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_21047
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21047 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_21047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (559)), operand_21047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)), operand_21047->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), operand_21047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_21047->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_21047->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_21047->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (568)), operand_21047->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_21047->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (570)), operand_21047->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), operand_21047->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21047->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), operand_21047->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (574)), operand_21047->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (575)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_21893
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21893 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_21893->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), operand_21893->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (584)), operand_21893->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21893->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (588)), operand_21893->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_21893->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_21893->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_21893->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_21893->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), operand_21893->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (594)), operand_21893->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_21893->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (596)), operand_21893->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (597)), operand_21893->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (598)), operand_21893->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (599)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_22739
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_22739 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_22739->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (607)), operand_22739->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (608)), operand_22739->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_22739->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (612)), operand_22739->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (613)), operand_22739->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (614)), operand_22739->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (615)), operand_22739->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (616)), operand_22739->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (617)), operand_22739->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (618)), operand_22739->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (619)), operand_22739->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (620)), operand_22739->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (621)), operand_22739->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (622)), operand_22739->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (623)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_23759 (var_cas_inFilewrapperFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_23759 = NULL ;
while (((operand_23759 = enumerator_23759.nextObject ()))) {
  macroValidPointer (operand_23759) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (635))) ;
}
}
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_23907 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_23907 = NULL ;
while (((operand_23907 = enumerator_23907.nextObject ()))) {
  macroValidPointer (operand_23907) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_23907->mRegularFileSortedList,  operand_23907->mDirectorySortedList,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (638)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_24228
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24228 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_24228->mFilewrapperFileSortedList,  operand_24228->mFilewrapperDirectorySortedList,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (650)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_24228->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_24666 (operand_24228->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_24666 = NULL ;
while (((operand_24666 = enumerator_24666.nextObject ()))) {
  macroValidPointer (operand_24666) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_24228->mFilewrapperName, operand_24666->mFilewrapperTemplateName, operand_24666->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_25060
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25060 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_25060->mTypeName, operand_25060->mAbstractCategoryMethodName, operand_25060->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_25441
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25441 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_25441->mTypeName, operand_25441->mCategoryMethodName, operand_25441->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_26106
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26106 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_26299
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26299 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_26299->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (703)), operand_26299->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), operand_26299->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_26636
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26636 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_26636->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (713)), operand_26636->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), ((operand_26636->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (715))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_26636->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (715)))), operand_26636->mTypedAttributeList, operand_26636->mAllTypedAttributeList, operand_26636->mIsAbstract, operand_26636->mAbstractMethodList, operand_26636->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_27551
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_27777
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27777 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_27777->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), operand_27777->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (740)), operand_27777->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (741)), operand_27777->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (742))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_28508
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28508 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_28730
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28730 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_28730->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_28730->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_28730->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_29159
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29159 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_29159->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29159->mTypedAttributeList, operand_29159->mInsertMethodList, operand_29159->mSearchMethodList, operand_29159->mRemoveMethodList, operand_29159->mHasInsertOrReplaceModifier, operand_29159->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_29644
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29644 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_29644->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_29644->mTypedAttributeList, operand_29644->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_30031
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30031 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_30031->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), operand_30031->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (796)), operand_30031->mConstantList, operand_30031->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_30429
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30429 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_30429->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (806)), operand_30429->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (807)), operand_30429->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_30429->mAssociatedMapTypedAttributeList, operand_30429->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_30904
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30904 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_30904->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (818)), operand_30904->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), ((operand_30904->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (820))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_30904->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (820)))), operand_30904->mTypedAttributeList, operand_30904->mAllTypedAttributeList, operand_30904->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_30904->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_30904->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (823)) COMMA_SOURCE_FILE_AT_LINE (823)), operand_30904->mIsAbstract, operand_30904->mAbstractMethodList, operand_30904->mMethodList, operand_30904->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_31594
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31594 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_31594->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), operand_31594->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (836)), operand_31594->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_31974
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31974 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_31974->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (845)), operand_31974->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (846)), operand_31974->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_32365
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32365 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_32365->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_32365->mRoutineName.reader_identifierRepresentation ()), operand_32365->mFormalArgumentList, operand_32365->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (856))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_33002
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_33002 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_33002->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_33002->mFunctionName.reader_identifierRepresentation ()), operand_33002->mFormalArgumentList, operand_33002->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_33002->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (878)), operand_33002->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (873)), operand_33002->mFormalArgumentList, operand_33002->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (883))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_33654
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_33654 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_33654->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_33654->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_33654->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_33654->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (897)), operand_33654->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (892)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_33654->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (902))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_34370
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_34370 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_34370->mTypeName, operand_34370->mAbstractCategoryMethodName, operand_34370->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
GGS_string function_generateCategoryMethod (C_Compiler & inLexique,
  ...
  GGS_string var_cas_outGeneratedCode ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (932))) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (933))) ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_35491 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_35491 = NULL ;
while (((operand_35491 = enumerator_35491.nextObject ()))) {
  macroValidPointer (operand_35491) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_35491->mFormalArgumentCppName) ;
}
}
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_string var_cas_routineBody = GGS_string ("") ;
var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (940)) ;
{
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_35721 (var_cas_inInstructionList, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_35721 = NULL ;
while (((operand_35721 = enumerator_35721.nextObject ()))) {
  macroValidPointer (operand_35721) ;
{ typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_35721->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_35721->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (942)) ;
  }
}
}
}
var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (944)) ;
...
const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
const GGS_bool cond_36243 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_36243.isBuiltAndTrue ()) {
...
var_cas_outGeneratedCode.appendCString (" * ") ;
}else if (cond_36243.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inBaseClassName.reader_identifierRepresentation ()) ;
var_cas_outGeneratedCode.appendCString (" * ") ;
}
const GGS_bool var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (953))) ;
const GGS_bool cond_36521 = var_cas_currentObjectIsUnused ;
if (cond_36521.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
}else if (cond_36521.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("inObject") ;
}
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_36605 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_36605 = NULL ;
while (((operand_36605 = enumerator_36605.nextObject ()))) {
  macroValidPointer (operand_36605) ;
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (962)) ;
switch (operand_36605->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (965))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (967))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (969))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (971))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::kNotBuilt:
...
const GGS_bool cond_37383 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_36605->mFormalArgumentCppName) ;
if (cond_37383.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentCppName) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_37383.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (operand_36605->mFormalArgumentCppName) ;
}
}
}
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (981)) ;
var_cas_outGeneratedCode.appendCString ("C_Compiler * ") ;
const GGS_bool cond_37745 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (983))) ;
if (cond_37745.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (984))) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_37745.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (986))) ;
}
var_cas_outGeneratedCode.appendCString ("\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (989)) ;
var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
var_cas_outGeneratedCode.appendCString (") {\n") ;
const GGS_bool cond_38506 = (var_cas_currentObjectIsUnused).operator_not () ;
if (cond_38506.isBuiltAndTrue ()) {
const GGS_bool cond_38192 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_38192.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
}else if (cond_38192.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_38749
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38749 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_38749->mTypeName, GGS_string (""), operand_38749->mCategoryMethodName, operand_38749->mCategoryMethodFormalParameterList, operand_38749->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1009)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_38749->mTypeName, operand_38749->mCategoryMethodName, operand_38749->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_39373
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39373 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_39373->mTypeName, operand_39373->mBaseTypeName, operand_39373->mCategoryMethodName, operand_39373->mCategoryMethodFormalParameterList, operand_39373->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1027)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_39373->mTypeName, operand_39373->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_40260 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_40260 = NULL ;
while (((operand_40260 = enumerator_40260.nextObject ()))) {
  macroValidPointer (operand_40260) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_40260->mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1053)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_40260->mRegularFileName) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_40260->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1056))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_40260->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1059))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_40260->mRegularFileName.reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_40260->mRegularFileName.reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_40260->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1063))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_41145 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_41145 = NULL ;
while (((operand_41145 = enumerator_41145.nextObject ()))) {
  macroValidPointer (operand_41145) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_41145->mDirectoryName,  operand_41145->mWrapperDirectoryIndex,  operand_41145->mRegularFileSortedList,  operand_41145->mDirectorySortedList,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1068)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1080))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1081)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1081))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileSortedList::cEnumerator enumerator_41763 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_41763 = NULL ;
while (((operand_41763 = enumerator_41763.nextObject ()))) {
  macroValidPointer (operand_41763) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_41763->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1090))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1091)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1091))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_42389 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_42389 = NULL ;
while (((operand_42389 = enumerator_42389.nextObject ()))) {
  macroValidPointer (operand_42389) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_42389->mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1093))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1099))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1102))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1103))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1104))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllDirectories_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105))) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
  "\n") ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_43520
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43520 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_43520->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_43520->mFilewrapperFileSortedList,  operand_43520->mFilewrapperDirectorySortedList,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1113)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_43520->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_43993 (operand_43520->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_43993 = NULL ;
while (((operand_43993 = enumerator_43993.nextObject ()))) {
  macroValidPointer (operand_43993) ;
GGS_string var_cas_generatedCodeForInstructionList = GGS_string ("") ;
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1131))) ;
GGS_bool var_cas_useColumnMarker = GGS_bool (false) ;
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_43993->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1133)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_43520->mFilewrapperName, operand_43993->mFilewrapperTemplateName, operand_43993->mFilewrapperTemplateFormalInputParameters, (var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)))).operator_not (), var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
