...
template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << " *) mPtr ;\n"
      ...
      "  #endif\n"
      "\n"
      "//--- Construction from pointer (its retain count should be 1)\n"
      "  public : GALGASap_" ;
    result << var_cas_TYPE_IDENTIFIER ;
    result << " (GALGAS_" ;
    result << var_cas_TYPE_IDENTIFIER ;
    result << " * inSourcePtr) ;\n"
      "\n"
      "//--- Assignment from pointer (its retain count should be 1)\n"
      "  public : GALGASap_" ;
    result << var_cas_TYPE_IDENTIFIER ;
...
template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassImplementation (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << " * inSourcePtr) {\n"
      "  macroReleaseObject (mPtr) ;\n"
      "  mPtr = inSourcePtr ;\n"
      "  macroValidObject (mPtr, GALGASap_root) ;\n"
      "  MF_Assert (mPtr->retainCount () == 1, \"mPtr->retainCount = %lld != 1\", mPtr->retainCount (), 0) ;\n"
      "  return *this ;\n"
      "}\n"
      "\n" ;
  }
...
result << "  private : " ;
if (operand_19902->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
...
GGS_typedAttributeList::cEnumerator enumerator_20289 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20289 = NULL ;
while (((operand_20289 = enumerator_20289.nextObject ()))) {
macroValidPointer (operand_20289) ;
result << "  public : GALGAS_" ;
result << operand_20289->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
result << " * mAttribute_" ;
result << operand_20289->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
GGS_withAccessorMap::cEnumerator enumerator_21264 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21264 = NULL ;
while (((operand_21264 = enumerator_21264.nextObject ()))) {
macroValidPointer (operand_21264) ;
result << "  friend cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_21264->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_21264->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)) ;
result << " * inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_21942 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_21942 = NULL ;
while (((operand_21942 = enumerator_21942.nextObject ()))) {
macroValidPointer (operand_21942) ;
result << "    public : GALGAS_" ;
result << operand_21942->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (523)) ;
result << " * attribute_" ;
result << operand_21942->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << ") ;\n"
  ...
  "  }\n"
  "//---\n" ;
GGS_formalParameterSignature::cEnumerator enumerator_8248 (operand_5563->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8248 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8248 = enumerator_8248.nextObject ()))) {
macroValidPointer (operand_8248) ;
if ((operand_8248->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).boolValue ()) {
result << "  macroReleaseObject (constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << ") ; // Release 'const in' argument\n" ;
}else if ((operand_8248->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).boolValue ()) {
result << "  macroReleaseObject (inArgument" ;
...
GGS_readerMap::cEnumerator enumerator_8715 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_8715 = NULL ;
while (((operand_8715 = enumerator_8715.nextObject ()))) {
macroValidPointer (operand_8715) ;
if ((operand_8715->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (213))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_8715->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
result << " * readerCall_" ;
result << operand_8715->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_9052 (operand_8715->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_9052 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_COL ;
result << "GALGAS_" ;
result << operand_9052->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << " * inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_8715->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << ") {\n"
  "  GALGAS_" ;
result << operand_8715->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
result << " * result = NULL ;\n"
  "  if (inObject != NULL) {\n"
  "    result = inObject->reader_" ;
result << operand_8715->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_9561 (operand_8715->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_9561 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9561 = enumerator_9561.nextObject ()))) {
macroValidPointer (operand_9561) ;
result << "inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
if (enumerator_9561.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_8715->mInfo.mArgumentTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_8715->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
...
result << ") ;\n"
  "  }\n"
  "//---\n" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_9992 (operand_8715->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_9992 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9992 = enumerator_9992.nextObject ()))) {
macroValidPointer (operand_9992) ;
...
result << "*\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_10466 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_10466 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10466 = enumerator_10466.nextObject ()))) {
macroValidPointer (operand_10466) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_10466->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::cEnumerator::attribute_" ;
result << operand_10466->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) {\n"
  "  GALGAS_" ;
result << operand_10466->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
...
result << operand_10466->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
...
result << " * source = ioObject ;\n"
  ...
  "}\n"
  "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_1545 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_1545 = NULL ;
while (((operand_1545 = enumerator_1545.nextObject ()))) {
macroValidPointer (operand_1545) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_1545->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_1783 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1783 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1783 = enumerator_1783.nextObject ()))) {
macroValidPointer (operand_1783) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_1783->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (44)) ;
result << " * inArgument" ;
...
result << "} ;\n" ;
const GGS_uint indentation_2554 = GGS_uint (2U) ;
if (indentation_2554.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_2554.uintValue ()) ;
}
result << "const utf32 kInsertErrorMessage [" ;
result << operand_1545->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (54)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (54)) ;
result << "] = " ;
result << operand_1545->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "const utf32 kShadowErrorMessage [" ;
result << operand_1545->mShadowErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (55)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
result << "] = " ;
result << operand_1545->mShadowErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_2593 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_2593 = NULL ;
while (((operand_2593 = enumerator_2593.nextObject ()))) {
macroValidPointer (operand_2593) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "static const utf32 kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_2593->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_2593->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (63)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (63)) ;
result << "] = " ;
result << operand_2593->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_3108 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3108 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_3108->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
result << " * & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_3894 = GGS_uint (2U) ;
if (indentation_3894.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_3894.uintValue ()) ;
}
...
result << " COMMA_THERE) ;\n"
  "if (NULL != attributes) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3551 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3551 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3551 = enumerator_3551.nextObject ()))) {
macroValidPointer (operand_3551) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
result << " = (GALGAS_" ;
result << operand_3551->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << ", GALGAS_" ;
result << operand_3551->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_3934 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_3934 = NULL ;
while (((operand_3934 = enumerator_3934.nextObject ()))) {
macroValidPointer (operand_3934) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3934->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4172 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4172 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4172->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_5040 = GGS_uint (2U) ;
if (indentation_5040.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_5040.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_3934->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (93)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) ;
result << "] = " ;
result << operand_3934->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "cRootObjectArray attributes ;\n"
  "    performRemove (inKey, attributes, inCompiler, kRemoveErrorMessage COMMA_THERE) ;\n"
  "if (attributes.count () != 0) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4698 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4698 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = (GALGAS_" ;
result << operand_4698->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
result << " *) attributes.objectAtIndex (" ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << ", GALGAS_" ;
result << operand_4698->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5291->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
result << " * inArgument" ;
...
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5568 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5568 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
GGS_typedAttributeList::cEnumerator enumerator_5720 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5720 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5720->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5720->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                                               " ;
...
result << operand_5720->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
result << ") ;\n"
  "  return (GALGAS_" ;
result << operand_5720->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
result << " *) result ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_6497 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6497 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6497 = enumerator_6497.nextObject ()))) {
macroValidPointer (operand_6497) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6497->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6497->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_withAccessorMap::cEnumerator enumerator_7473 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_7473 = NULL ;
...
result << operand_7473->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7473->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ;
result << " * inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_7473->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_14771
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_14983
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14983 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_14983->mRoutineName, operand_14983->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_15309
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15309 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15309->mFunctionName, operand_15309->mFormalArgumentList, operand_15309->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (379))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_15665
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15665 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeHeader (inLexique, operand_15665->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (387)), operand_15665->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)), operand_15665->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (389)), operand_15665->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (390)), operand_15665->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (391)), operand_15665->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (392)), operand_15665->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (393)), operand_15665->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (394)), operand_15665->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (395)), operand_15665->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (396)), operand_15665->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (397)), operand_15665->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (398)), operand_15665->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (399)), operand_15665->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (400)), operand_15665->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (401)), operand_15665->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (402)), operand_15665->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (403)), operand_15665->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (404)), operand_15665->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (405))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_16620
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16620 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_genericTypeHeader (inLexique, operand_16620->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (413)), operand_16620->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (414))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17276
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17276 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_17489
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17489 != NULL) {
const GGS_bool cond_17578 = (operand_17489->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (431))).operator_isEqual (GGS_string ("root")) ;
if (cond_17578.isBuiltAndTrue ()) {
var_cas_outHeader = GGS_string ("") ;
}else if (cond_17578.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (inLexique, operand_17489->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (435)), operand_17489->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (436)), operand_17489->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (437)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (437))) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_18296
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_18528
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18528 != NULL) {
const GGS_bool cond_18633 = (operand_18528->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (455))).operator_isEqual (GGS_string ("root")) ;
if (cond_18633.isBuiltAndTrue ()) {
var_cas_outImplementation = GGS_string ("") ;
}else if (cond_18633.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassImplementation (inLexique, operand_18528->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (459)), operand_18528->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (460)), operand_18528->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (461)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (461))) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_19440
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_19666
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19666 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeImplementation (inLexique, operand_19666->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (481)), operand_19666->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), operand_19666->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), operand_19666->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (484)), operand_19666->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_19666->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), operand_19666->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (487)), operand_19666->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), operand_19666->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), operand_19666->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_19666->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_19666->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_19666->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_19666->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_19666->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (495))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_20500
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20500 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_genericTypeImplementation (inLexique, operand_20500->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (504)), operand_20500->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (505)), operand_20500->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (506))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_21203
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21203 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_21427
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21427 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_21427->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_21427->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_21427->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_21427->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_21427->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (528))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_21933
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21933 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_21933->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_21933->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_22305
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22305 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_22305->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_22305->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_22305->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_22747
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22747 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_22747->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (555)), operand_22747->mTypedAttributeList, operand_22747->mInsertMethodList, operand_22747->mSearchMethodList, operand_22747->mRemoveMethodList, operand_22747->mHasInsertOrReplaceModifier, operand_22747->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_23245
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23245 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_23245->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_23245->mTypedAttributeList, operand_23245->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_23647
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23647 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_23647->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (579)), operand_23647->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (580)), operand_23647->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_24040
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24040 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_24040->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_24040->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_24040->mConstantList, operand_24040->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_24451
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24451 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_24451->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (600)), operand_24451->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (601)), operand_24451->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (602)), operand_24451->mAssociatedMapTypedAttributeList, operand_24451->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_24939
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24939 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_24939->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (612)), operand_24939->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (613)), ((operand_24939->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (614))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_24939->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (614)))), operand_24939->mTypedAttributeList, operand_24939->mAllTypedAttributeList, operand_24939->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_24939->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_24939->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (617)) COMMA_SOURCE_FILE_AT_LINE (617)), operand_24939->mIsAbstract, operand_24939->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_25610
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25610 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_25610->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_25610->mRoutineName.reader_identifierRepresentation ()), operand_25610->mFormalArgumentList, operand_25610->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (628))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_26232
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26232 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_26232->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_26232->mFunctionName.reader_identifierRepresentation ()), operand_26232->mFormalArgumentList, operand_26232->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_26232->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (650)), operand_26232->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (645))) ;
  }
  return var_cas_outImplementation ;
}
