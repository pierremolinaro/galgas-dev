...
GGS_string function_generateProcedure (C_Compiler & inLexique,
  ...
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (49)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_2671 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_2671 = NULL ;
    while (((operand_2671 = enumerator_2671.nextObject ()))) {
      macroValidPointer (operand_2671) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_2671->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_2671->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (51)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (53)) ;
  ...
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_3008 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_3008 = NULL ;
    while (((operand_3008 = enumerator_3008.nextObject ()))) {
      macroValidPointer (operand_3008) ;
      switch (operand_3008->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        {
        var_cas_outGeneratedCode.appendCString ("GALGASap_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (61))) ;
      ...
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGASap_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (63))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGASap_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (65))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        {
        var_cas_outGeneratedCode.appendCString ("GALGASap_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (67))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      ...
      const GGS_bool cond_3697 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_3008->mFormalArgumentCppName) ;
      if (cond_3697.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_3697.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_3008->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (75)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_4074 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (79))) ;
  if (cond_4074.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (80))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_4074.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
  }
  const GGS_bool cond_4314 = var_cas_inGenerateLocationArgs ;
  if (cond_4314.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("\n") ;
    var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (86)) ;
    var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
  }
  var_cas_outGeneratedCode.appendCString (")") ;
  const GGS_bool cond_4417 = var_cas_inProcedureIsConst ;
  if (cond_4417.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString (" const") ;
  }
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  {
      GGS_uint var_cas_IDX (true, 0) ;
    GGS_formalParameterListForGeneration::cEnumerator enumerator_4513 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_4513 = NULL ;
    while (((operand_4513 = enumerator_4513.nextObject ()))) {
      macroValidPointer (operand_4513) ;
      switch (operand_4513->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("  ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_4513->mFormalArgumentCppName) ;
...
GGS_string function_generateFunction (C_Compiler & inLexique,
  ...
  GGS_string var_cas_outGeneratedCode ;
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (125))) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_5825 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_5825 = NULL ;
    while (((operand_5825 = enumerator_5825.nextObject ()))) {
      macroValidPointer (operand_5825) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_5825->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_6055 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_6055 = NULL ;
    while (((operand_6055 = enumerator_6055.nextObject ()))) {
      macroValidPointer (operand_6055) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_6055->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_6055->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (135)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (137)) ;
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_6470 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_6470 = NULL ;
    while (((operand_6470 = enumerator_6470.nextObject ()))) {
      macroValidPointer (operand_6470) ;
      var_cas_outGeneratedCode.appendCString ("GALGASap_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_6470->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (144))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_6714 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_6470->mFormalArgumentCppName) ;
      if (cond_6714.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_6470->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_6714.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_6470->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (151)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_7091 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (155))) ;
  if (cond_7091.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (156))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_7091.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (158))) ;
  }
  var_cas_outGeneratedCode.appendCString ("\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (161)) ;
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS)") ;
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  var_cas_outGeneratedCode.appendCString ("  GALGASap_") ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_4806 = GGS_uint (2U) ;
if (indentation_4806.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_4806.uintValue ()) ;
}
...
GGS_typedAttributeList::cEnumerator enumerator_4464 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4464 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4464 = enumerator_4464.nextObject ()))) {
macroValidPointer (operand_4464) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (95)) ;
result << " = (GALGAS_" ;
result << operand_4464->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (95)) ;
result << " *) attributes.objectAtIndex (" ;
...
result << ", GALGAS_" ;
result << operand_4464->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_5057 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5057 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5057 = enumerator_5057.nextObject ()))) {
macroValidPointer (operand_5057) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5057->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
result << " * inArgument" ;
...
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (110)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5334 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5334 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5334 = enumerator_5334.nextObject ()))) {
macroValidPointer (operand_5334) ;
result << ", inArgument" ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5486->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (121)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (124)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_6064 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6064 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6064->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_string inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_6064->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (134)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_withAccessorMap::cEnumerator enumerator_7056 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_7056 = NULL ;
...
result << operand_7056->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_7056->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_7056->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (155))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_13894
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_13894 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_14106
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14106 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_14106->mRoutineName, operand_14106->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_14432
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14432 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_14432->mFunctionName, operand_14432->mFormalArgumentList, operand_14432->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (362))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_14788
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14788 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeHeader (inLexique, operand_14788->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (370)), operand_14788->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (371)), operand_14788->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (372)), operand_14788->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (373)), operand_14788->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (374)), operand_14788->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (375)), operand_14788->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (376)), operand_14788->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (377)), operand_14788->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (378)), operand_14788->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (379)), operand_14788->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (380)), operand_14788->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (381)), operand_14788->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (382)), operand_14788->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (383)), operand_14788->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (384)), operand_14788->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (385)), operand_14788->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (386)), operand_14788->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (387)), operand_14788->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (388))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_15743
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15743 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_genericTypeHeader (inLexique, operand_15743->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (396)), operand_15743->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (397))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_16399
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_16612
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16612 != NULL) {
const GGS_bool cond_16701 = (operand_16612->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (414))).operator_isEqual (GGS_string ("root")) ;
if (cond_16701.isBuiltAndTrue ()) {
var_cas_outHeader = GGS_string ("") ;
}else if (cond_16701.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (inLexique, operand_16612->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (418)), operand_16612->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (419)), operand_16612->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (420)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (420))) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17419
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_17419 != NULL) {
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_17651
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_17651 != NULL) {
const GGS_bool cond_17756 = (operand_17651->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (438))).operator_isEqual (GGS_string ("root")) ;
if (cond_17756.isBuiltAndTrue ()) {
var_cas_outImplementation = GGS_string ("") ;
}else if (cond_17756.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassImplementation (inLexique, operand_17651->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (442)), operand_17651->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (443)), operand_17651->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (444)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (444))) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_18563
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18563 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_18789
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18789 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeImplementation (inLexique, operand_18789->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (464)), operand_18789->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (465)), operand_18789->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_18789->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_18789->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (468)), operand_18789->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_18789->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_18789->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_18789->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_18789->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_18789->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_18789->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_18789->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_18789->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_18789->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_19623
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19623 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_genericTypeImplementation (inLexique, operand_19623->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (487)), operand_19623->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), operand_19623->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (489))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_20326
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_20550
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20550 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_20550->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (507)), operand_20550->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (508)), operand_20550->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), operand_20550->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), operand_20550->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (511))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_21056
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21056 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_21056->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_21056->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_21428
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21428 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_21428->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (528)), operand_21428->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (529)), operand_21428->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_21870
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21870 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_21870->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_21870->mTypedAttributeList, operand_21870->mInsertMethodList, operand_21870->mSearchMethodList, operand_21870->mRemoveMethodList, operand_21870->mHasInsertOrReplaceModifier, operand_21870->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_22368
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22368 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_22368->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (552)), operand_22368->mTypedAttributeList, operand_22368->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_22770
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22770 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_22770->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), operand_22770->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (563)), operand_22770->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_23163
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23163 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_23163->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_23163->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), operand_23163->mConstantList, operand_23163->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_23574
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23574 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_23574->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), operand_23574->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (584)), operand_23574->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (585)), operand_23574->mAssociatedMapTypedAttributeList, operand_23574->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_24062
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24062 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_24062->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_24062->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (596)), ((operand_24062->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (597))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_24062->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (597)))), operand_24062->mTypedAttributeList, operand_24062->mAllTypedAttributeList, operand_24062->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_24062->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_24062->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)), operand_24062->mIsAbstract, operand_24062->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_24733
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24733 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_24733->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_24733->mRoutineName.reader_identifierRepresentation ()), operand_24733->mFormalArgumentList, operand_24733->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (611))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_25317
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25317 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_25317->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_25317->mFunctionName.reader_identifierRepresentation ()), operand_25317->mFormalArgumentList, operand_25317->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_25317->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (632)), operand_25317->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (627))) ;
  }
  return var_cas_outImplementation ;
}
