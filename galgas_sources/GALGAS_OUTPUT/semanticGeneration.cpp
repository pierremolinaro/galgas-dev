...
result << "//---------------------------------------------------------------------------*\n"
  ...
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_first_5F_method (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_5004 (operand_4830->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_5004 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5004 = enumerator_5004.nextObject ()))) {
macroValidPointer (operand_5004) ;
if ((operand_5004->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (119))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_5004->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " * /* inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " */" ;
}else if ((operand_5004->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5004->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " * & /* ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " */" ;
}else if ((operand_5004->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (123))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5004->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " * & /* outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " */" ;
}else {
result << "GALGAS_" ;
result << operand_5004->mFormalParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
result << " * /* inArgument" ;
