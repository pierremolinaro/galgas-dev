...
GGS_nativeAttributeList::cEnumerator enumerator_19968 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_19968 = NULL ;
while (((operand_19968 = enumerator_19968.nextObject ()))) {
macroValidPointer (operand_19968) ;
result << "  private : " ;
if (operand_19968->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_19968->mCppClassName ;
result << " " ;
if (operand_19968->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_19968->mAttributeName ;
result << " ;\n" ;
if ((operand_19968->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_19968->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_20355 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20355 = NULL ;
while (((operand_20355 = enumerator_20355.nextObject ()))) {
macroValidPointer (operand_20355) ;
result << "  public : GALGASap_" ;
result << operand_20355->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
result << " mAttribute_" ;
result << operand_20355->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
GGS_withAccessorMap::cEnumerator enumerator_21334 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21334 = NULL ;
while (((operand_21334 = enumerator_21334.nextObject ()))) {
macroValidPointer (operand_21334) ;
result << "  friend cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_21334->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21334->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_22109 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22109 = NULL ;
while (((operand_22109 = enumerator_22109.nextObject ()))) {
macroValidPointer (operand_22109) ;
result << "    public : GALGASap_" ;
result << operand_22109->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (526)) ;
result << " attribute_" ;
result << operand_22109->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22411 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22411 = NULL ;
while (((operand_22411 = enumerator_22411.nextObject ()))) {
macroValidPointer (operand_22411) ;
if ((operand_22411->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (537))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22411->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
result << " readerCall_" ;
result << operand_22411->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22659 (operand_22411->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22659 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22659 = enumerator_22659.nextObject ()))) {
macroValidPointer (operand_22659) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22659->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22411->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_23060 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_23060 = NULL ;
while (((operand_23060 = enumerator_23060.nextObject ()))) {
macroValidPointer (operand_23060) ;
if ((operand_23060->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (555))).boolValue ()) {
result << "  void modifierCall_" ;
result << operand_23060->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23246 (operand_23060->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23246 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23246 = enumerator_23246.nextObject ()))) {
macroValidPointer (operand_23246) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23246->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (559))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23246->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
}else if ((operand_23246->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (561))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23246->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
}else if ((operand_23246->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (563))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23246->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
}else {
result << "GALGASap_" ;
result << operand_23246->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (566)) ;
result << " inArgument" ;
...
if (operand_23060->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24286 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24286 = NULL ;
while (((operand_24286 = enumerator_24286.nextObject ()))) {
macroValidPointer (operand_24286) ;
if (((operand_24286->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).operator_or ((operand_24286->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24286->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24524 (operand_24286->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24524 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24524 = enumerator_24524.nextObject ()))) {
macroValidPointer (operand_24524) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24524->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (586))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24524->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
}else if ((operand_24524->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (588))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24524->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
}else if ((operand_24524->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (590))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24524->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
}else {
result << "GALGASap_" ;
result << operand_24524->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (593)) ;
result << " inArgument" ;
...
if (operand_24286->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25598 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25598 = NULL ;
...
result << operand_25598->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25598->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_typedAttributeList::cEnumerator enumerator_2250 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2250 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2250 = enumerator_2250.nextObject ()))) {
macroValidPointer (operand_2250) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_2250->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
result << " inOperand" ;
...
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_2604 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2604 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2604 = enumerator_2604.nextObject ()))) {
macroValidPointer (operand_2604) ;
result << "    attributeArray.addObject (inOperand" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_2934 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2934 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2934 = enumerator_2934.nextObject ()))) {
macroValidPointer (operand_2934) ;
result << "GALGASap_" ;
result << operand_2934->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
if (enumerator_2934.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_3143 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3143 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3143 = enumerator_3143.nextObject ()))) {
macroValidPointer (operand_3143) ;
result << "inOperand" ;
...
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3348 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3348 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3665 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3665 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3665 = enumerator_3665.nextObject ()))) {
macroValidPointer (operand_3665) ;
result << "GALGASap_" ;
result << operand_3665->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ;
result << " & outOperand" ;
...
GGS_typedAttributeList::cEnumerator enumerator_4002 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4002 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4268 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4268 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4268 = enumerator_4268.nextObject ()))) {
macroValidPointer (operand_4268) ;
result << "GALGASap_" ;
result << operand_4268->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) ;
result << " & outOperand" ;
...
GGS_typedAttributeList::cEnumerator enumerator_4604 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4604 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4604 = enumerator_4604.nextObject ()))) {
macroValidPointer (operand_4604) ;
result << "  outOperand" ;
...
GGS_typedAttributeList::cEnumerator enumerator_5196 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5457 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5457 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5457 = enumerator_5457.nextObject ()))) {
macroValidPointer (operand_5457) ;
result << "GALGASap_" ;
result << operand_5457->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_typedAttributeList::cEnumerator enumerator_5786 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5786 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "::insulate (ioResult COMMA_THERE) ;\n"
  ...
  "  }\n"
  "}\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8349 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8349 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8349 = enumerator_8349.nextObject ()))) {
macroValidPointer (operand_8349) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_8349->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_8349->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_uint inIndex,\n"
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9043 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9043 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9043 = enumerator_9043.nextObject ()))) {
macroValidPointer (operand_9043) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_9043->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_9043->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_uint & inIndex,\n"
  "                                              " ;
