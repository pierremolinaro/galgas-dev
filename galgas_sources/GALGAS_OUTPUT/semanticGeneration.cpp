...
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5070->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5070->mSignature, operand_5070->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (135)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5447 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5447 = NULL ;
while (((operand_5447 = enumerator_5447.nextObject ()))) {
macroValidPointer (operand_5447) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5447->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5447->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5447->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
