...
GGS_typedAttributeList::cEnumerator enumerator_1234 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1234 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1234 = enumerator_1234.nextObject ()))) {
macroValidPointer (operand_1234) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_1234->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
result << " * inArgument" ;
...
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (35)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (35)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_1523 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1523 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1523 = enumerator_1523.nextObject ()))) {
macroValidPointer (operand_1523) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_1675 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1675 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_1675->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_1675->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string * inKey,\n"
  "                                               " ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (49)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
result << " COMMA_THERE) ;\n"
  "  macroNullOrValidObject (result, GALGAS_" ;
result << operand_1675->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
result << ") ;\n"
  "  return (GALGAS_" ;
result << operand_1675->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
result << " *) result ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_2464 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2464 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2464 = enumerator_2464.nextObject ()))) {
macroValidPointer (operand_2464) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_2464->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string * inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_2464->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (58)) ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (61)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_6074
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_6074 != NULL) {
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_6271
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_6271 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_unifiedTypeHeader (inLexique, operand_6271->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (144)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144)), operand_6271->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)), operand_6271->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (146)), operand_6271->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (147)), operand_6271->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (148)), operand_6271->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (149)), operand_6271->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (150)), operand_6271->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (151)), operand_6271->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (152)), operand_6271->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (153)), operand_6271->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (154)), operand_6271->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (155)), operand_6271->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (156)), operand_6271->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (157)), operand_6271->mTypeIndex.reader_mMinusAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (158)), operand_6271->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), operand_6271->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (160)), operand_6271->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (161))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_7188
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7188 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_genericTypeHeader (inLexique, operand_7188->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (169)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)), operand_7188->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (170))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_7916
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_7916 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_8142
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_8142 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_unifiedTypeImplementation (inLexique, operand_8142->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), operand_8142->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (190)), operand_8142->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (191)), operand_8142->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), operand_8142->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_8142->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (194)), operand_8142->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), operand_8142->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), operand_8142->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (197)), operand_8142->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), operand_8142->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), operand_8142->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (200)), operand_8142->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (201)), operand_8142->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), operand_8142->mTypeIndex.reader_mMinusAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (203)), operand_8142->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (204))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_9020
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9020 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_9020->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (213)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213)), operand_9020->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)), operand_9020->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_9719
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9719 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_9943
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9943 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_9943->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)), operand_9943->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (234)), operand_9943->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (235)), operand_9943->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (236)), operand_9943->mTypeIndex.reader_mMinusAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (237)), operand_9943->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (238))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_10484
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10484 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_10484->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (246)), operand_10484->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_10843
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10843 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_10843->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (255)), operand_10843->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (256)), operand_10843->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_11272
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11272 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_11272->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), operand_11272->mTypedAttributeList, operand_11272->mHasInsertOrReplaceModifier) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_11666
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11666 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_11666->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (275)), operand_11666->mTypedAttributeList, operand_11666->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_12055
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12055 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_12055->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285)), operand_12055->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (286)), operand_12055->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_12444
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12444 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_12444->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (295)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (295)), operand_12444->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (296)), operand_12444->mConstantList, operand_12444->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
