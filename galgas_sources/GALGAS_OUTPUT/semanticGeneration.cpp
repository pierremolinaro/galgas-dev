...
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_16103->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (416)), operand_16103->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (417)), ((operand_16103->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (418))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_16103->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (418)))), operand_16103->mAllTypedAttributeList, operand_16103->mIsAbstract) ;
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_17048
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17048 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_17048->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (442)), operand_17048->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (443)), operand_17048->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17048->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (447)), operand_17048->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (448)), operand_17048->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (449)), operand_17048->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (450)), operand_17048->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (451)), operand_17048->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (452)), operand_17048->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (453)), operand_17048->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (454)), operand_17048->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (455)), operand_17048->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), operand_17048->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), operand_17048->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (458)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_17889
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17889 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_17889->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_17889->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_17889->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17889->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_17889->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_17889->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_17889->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_17889->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_17889->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_17889->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_17889->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (478)), operand_17889->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (479)), operand_17889->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (480)), operand_17889->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (481)), operand_17889->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (482)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_18731
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18731 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_18731->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_18731->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_18731->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18731->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18731->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18731->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18731->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_18731->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18731->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_18731->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_18731->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_18731->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (503)), operand_18731->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (504)), operand_18731->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (505)), operand_18731->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (506)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_19577
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19577 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_19577->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (514)), operand_19577->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (515)), operand_19577->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19577->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19577->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19577->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19577->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_19577->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19577->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_19577->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_19577->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_19577->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_19577->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (528)), operand_19577->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (529)), operand_19577->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (530)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_20423
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20423 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_20423->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_20423->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), operand_20423->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20423->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20423->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20423->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20423->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20423->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20423->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20423->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), operand_20423->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (550)), operand_20423->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (551)), operand_20423->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (552)), operand_20423->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), operand_20423->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (554)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_21571
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21571 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_21764
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21764 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_21764->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21764->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), operand_21764->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_22101
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_22101 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_22101->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (582)), operand_22101->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), ((operand_22101->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (584))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_22101->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (584)))), operand_22101->mTypedAttributeList, operand_22101->mAllTypedAttributeList, operand_22101->mIsAbstract, operand_22101->mAbstractMethodList, operand_22101->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23016
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23016 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_23242
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23242 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_23242->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (608)), operand_23242->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (609)), operand_23242->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (610)), operand_23242->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (611))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23973
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23973 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_24195
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24195 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_24195->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), operand_24195->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (631)), operand_24195->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_24624
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24624 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_24624->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (640)), operand_24624->mTypedAttributeList, operand_24624->mInsertMethodList, operand_24624->mSearchMethodList, operand_24624->mRemoveMethodList, operand_24624->mHasInsertOrReplaceModifier, operand_24624->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_25109
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25109 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_25109->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (654)), operand_25109->mTypedAttributeList, operand_25109->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_25496
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25496 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_25496->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (664)), operand_25496->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (665)), operand_25496->mConstantList, operand_25496->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_25894
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25894 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_25894->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (675)), operand_25894->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (676)), operand_25894->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (677)), operand_25894->mAssociatedMapTypedAttributeList, operand_25894->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_26369
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26369 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_26369->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (687)), operand_26369->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (688)), ((operand_26369->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (689))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_26369->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (689)))), operand_26369->mTypedAttributeList, operand_26369->mAllTypedAttributeList, operand_26369->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_26369->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_26369->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)), operand_26369->mIsAbstract, operand_26369->mAbstractMethodList, operand_26369->mMethodList, operand_26369->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_27059
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27059 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_27059->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), operand_27059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (705)), operand_27059->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_27439
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27439 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_27439->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), operand_27439->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (715)), operand_27439->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_27830
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27830 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_27830->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_27830->mRoutineName.reader_identifierRepresentation ()), operand_27830->mFormalArgumentList, operand_27830->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (725))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_28467
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28467 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_28467->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_28467->mFunctionName.reader_identifierRepresentation ()), operand_28467->mFormalArgumentList, operand_28467->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_28467->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), operand_28467->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (742)), operand_28467->mFormalArgumentList, operand_28467->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (751))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_29090
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29090 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_29090->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_29090->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_29090->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_29090->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (765)), operand_29090->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (760)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_29090->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (769))) ;
  }
  return var_cas_outImplementation ;
}
