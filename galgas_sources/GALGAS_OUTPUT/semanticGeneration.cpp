...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_923 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_923->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (26)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
...
result << "COMMA_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_923->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (28)) ;
result << " result ;\n"
  "  const cMapElement_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
result << operand_923->mAttributeName.ggs_string ().reader_utf8Representation () ;
result << " COMMA_THERE) ;\n"
  "  if (NULL != p) {\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_1839 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_1839 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1839 = enumerator_1839.nextObject ()))) {
macroValidPointer (operand_1839) ;
result << "//---------------------------------------------------------------------------*\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_" ;
result << operand_1839->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
