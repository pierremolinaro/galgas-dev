...
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_7214 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_7214 = NULL ;
while (((operand_7214 = enumerator_7214.nextObject ()))) {
  macroValidPointer (operand_7214) ;
switch (operand_7214->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_unusedVariableCppNameSet.addAssign_operation ((GGS_string ("inArgument_")).operator_concat (operand_7214->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ())) ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_unusedVariableCppNameSet.addAssign_operation ((GGS_string ("ioArgument_")).operator_concat (operand_7214->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ())) ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_unusedVariableCppNameSet.addAssign_operation ((GGS_string ("outArgument_")).operator_concat (operand_7214->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ())) ;
  }
  break ;
...
var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (190)) ;
{
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_7953 (var_cas_inInstructionList, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_7953 = NULL ;
while (((operand_7953 = enumerator_7953.nextObject ()))) {
  macroValidPointer (operand_7953) ;
{ typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_7953->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_7953->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (192)) ;
  }
}
}
}
var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (194)) ;
...
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_8480 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_8480 = NULL ;
while (((operand_8480 = enumerator_8480.nextObject ()))) {
  macroValidPointer (operand_8480) ;
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (206)) ;
switch (operand_8480->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_8480->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209))) ;
var_cas_outGeneratedCode.appendCString (" * const inArgument_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_8480->mFormalArgumentName.ggs_string ().reader_identifierRepresentation ()) ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_8480->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
...
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_8480->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
...
case GGS_formalArgumentPassingModeAST::enum_argumentIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_8480->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
...
var_cas_outGeneratedCode.appendCString ("\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (219)) ;
...
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_9653 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_9653 = NULL ;
while (((operand_9653 = enumerator_9653.nextObject ()))) {
  macroValidPointer (operand_9653) ;
const GGS_bool cond_9889 = (operand_9653->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (225))) ;
if (cond_9889.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("  macroReleaseObject (inArgument_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_9653->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (226))) ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_10408
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_10408 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_10620
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_10620 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_routineDeclaration (inLexique, operand_10620->mRoutineName, operand_10620->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_10917
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_10917 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_unifiedTypeHeader (inLexique, operand_10917->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (255)), operand_10917->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (256)), operand_10917->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), operand_10917->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), operand_10917->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (259)), operand_10917->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (260)), operand_10917->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (261)), operand_10917->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (262)), operand_10917->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (263)), operand_10917->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (264)), operand_10917->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), operand_10917->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (266)), operand_10917->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (267)), operand_10917->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (268)), operand_10917->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (269)), operand_10917->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (270)), operand_10917->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (271)), operand_10917->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (272))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_11824
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_11824 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_genericTypeHeader (inLexique, operand_11824->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (280)), operand_11824->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (281))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_12543
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12543 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_12769
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12769 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_unifiedTypeImplementation (inLexique, operand_12769->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_12769->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (301)), operand_12769->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (302)), operand_12769->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (303)), operand_12769->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (304)), operand_12769->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (305)), operand_12769->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (306)), operand_12769->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (307)), operand_12769->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (308)), operand_12769->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (309)), operand_12769->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), operand_12769->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (311)), operand_12769->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (312)), operand_12769->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (313)), operand_12769->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (314))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_13590
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13590 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_13590->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (323)), operand_13590->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (324)), operand_13590->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (325))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_14280
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14280 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_14504
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14504 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_14504->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (343)), operand_14504->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (344)), operand_14504->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (345)), operand_14504->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (346)), operand_14504->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (347))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_14997
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14997 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_14997->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (355)), operand_14997->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_15356
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_15356 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_15356->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (364)), operand_15356->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (365)), operand_15356->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_15785
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_15785 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_15785->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (374)), operand_15785->mTypedAttributeList, operand_15785->mInsertMethodList, operand_15785->mSearchMethodList, operand_15785->mRemoveMethodList, operand_15785->mHasInsertOrReplaceModifier) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_16248
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_16248 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_16248->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (387)), operand_16248->mTypedAttributeList, operand_16248->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_16637
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_16637 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_16637->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (397)), operand_16637->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (398)), operand_16637->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_17017
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_17017 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_17017->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (407)), operand_17017->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (408)), operand_17017->mConstantList, operand_17017->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_17415
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_17415 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_17415->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (418)), operand_17415->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (419)), operand_17415->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (420)), operand_17415->mAssociatedMapTypedAttributeList, operand_17415->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17890
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_17890 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_17890->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (430)), operand_17890->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (431)), ((operand_17890->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (432))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_17890->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (432)))), operand_17890->mTypedAttributeList, operand_17890->mAllTypedAttributeList, operand_17890->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_17890->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_17890->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)), operand_17890->mIsAbstract, operand_17890->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_18548
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_18548 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_routineImplementation (inLexique, operand_18548->mRoutineName, function_generateRoutine (inLexique, operand_18548->mRoutineName, operand_18548->mFormalArgumentList, operand_18548->mRoutineInstructionList COMMA_SOURCE_FILE_AT_LINE (446))) ;
  }
  return var_cas_outImplementation ;
}
