...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (145)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_6759 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_6759 = NULL ;
while (((operand_6759 = enumerator_6759.nextObject ()))) {
macroValidPointer (operand_6759) ;
if ((((operand_6759->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (155)))).operator_or ((operand_6759->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (155))))).operator_or ((operand_6759->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (155)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG void modifier_" ;
result << operand_6759->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7027 (operand_6759->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7027 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7027 = enumerator_7027.nextObject ()))) {
macroValidPointer (operand_7027) ;
if ((operand_7027->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (158))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7027->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
  result << " constinArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
}else if ((operand_7027->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (160))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7027->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
  result << " & ioArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
}else if ((operand_7027->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7027->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
  result << " & outArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
}else {
  result << "GALGAS_" ;
  result << operand_7027->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
  result << " inArgument" ;
...
if ((operand_6759->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6759->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8286 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8286 = NULL ;
while (((operand_8286 = enumerator_8286.nextObject ()))) {
macroValidPointer (operand_8286) ;
if ((((operand_8286->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).operator_or ((operand_8286->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (191))))).operator_or ((operand_8286->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG void method_" ;
result << operand_8286->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8552 (operand_8286->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8552 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8552 = enumerator_8552.nextObject ()))) {
macroValidPointer (operand_8552) ;
if ((operand_8552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
}else if ((operand_8552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (196))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
}else if ((operand_8552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
}else {
result << "GALGAS_" ;
result << operand_8552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
}
if (enumerator_8552.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8286->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8286->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
GGS_classMethodMap::cEnumerator enumerator_9810 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_9810 = NULL ;
while (((operand_9810 = enumerator_9810.nextObject ()))) {
macroValidPointer (operand_9810) ;
result << "  public : static void class_method_" ;
result << operand_9810->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9917 (operand_9810->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9917 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9917 = enumerator_9917.nextObject ()))) {
macroValidPointer (operand_9917) ;
if ((operand_9917->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9917->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
}else if ((operand_9917->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (230))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9917->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
}else if ((operand_9917->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (232))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9917->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
}else {
result << "GALGAS_" ;
result << operand_9917->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
}
if (enumerator_9917.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9810->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9810->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_11095 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_11095 = NULL ;
while (((operand_11095 = enumerator_11095.nextObject ()))) {
macroValidPointer (operand_11095) ;
if ((((operand_11095->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).operator_or ((operand_11095->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (260))))).operator_or ((operand_11095->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (260)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << operand_11095->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
result << " reader_" ;
result << operand_11095->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11420 (operand_11095->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_11420 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11420 = enumerator_11420.nextObject ()))) {
macroValidPointer (operand_11420) ;
result << "const GALGAS_" ;
result << operand_11420->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
if (enumerator_11420.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11095->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11095->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
GGS_withAccessorMap::cEnumerator enumerator_12600 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_12600 = NULL ;
while (((operand_12600 = enumerator_12600.nextObject ()))) {
macroValidPointer (operand_12600) ;
result << "  public : VIRTUAL_IN_DEBUG cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * readWriteAccessForWithInstruction_" ;
result << operand_12600->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_12600->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_13676 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_13676 = NULL ;
while (((operand_13676 = enumerator_13676.nextObject ()))) {
macroValidPointer (operand_13676) ;
result << "  public : GALGAS_" ;
result << operand_13676->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (320)) ;
result << " current_" ;
result << operand_13676->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14138 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14138 = NULL ;
...
result << operand_14138->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14138->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (335)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << ":\" ;\n"
  ...
  "    ioString << \" not built\" ;\n"
  "  }else{\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4901 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4901 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4901 = enumerator_4901.nextObject ()))) {
macroValidPointer (operand_4901) ;
result << "    mAttribute_" ;
result << operand_4901->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation+1) ;\n" ;
if (enumerator_4901.hasNextObject ()) {
result << "    ioString << \", \" ;\n" ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "  }\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5121 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5121 = NULL ;
while (((operand_5121 = enumerator_5121.nextObject ()))) {
macroValidPointer (operand_5121) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5121->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5121->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
