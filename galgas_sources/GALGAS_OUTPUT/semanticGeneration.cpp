...
template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " (const GALGASap_object & inSource) ;\n"
      "\n" ;
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateCppConstructorWithNativeAttributeListInAutoPointerClass (inLexique COMMA_SOURCE_FILE_AT_LINE (35)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- C++ constructor (with native attributes)\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
      result << " (" ;
      columnMarker = result.currentColumn () ;
      GGS_nativeAttributeList::cEnumerator enumerator_1751 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
      const GGS_nativeAttributeList::cElement * operand_1751 = NULL ;
      while (((operand_1751 = enumerator_1751.nextObject ()))) {
        macroValidPointer (operand_1751) ;
        result << "const " ;
        result << operand_1751->mCppClassName ;
        if (operand_1751->mIsPointer.boolValue ()) {
          result << " *" ;
        }else {
        }
        if (operand_1751->mUseReferenceForConstructor.boolValue ()) {
          result << " &" ;
        }else {
        }
        result << " inOperand_" ;
        result << operand_1751->mAttributeName ;
        if (enumerator_1751.hasNextObject ()) {
          result << ",\n" ;
    ...
    if ((var_cas_TYPE_IDENTIFIER).operator_isEqual (GGS_string ("bool")).boolValue ()) {
      ...
      result << "//--------------------------------- Comparison constructor\n"
        "  public : GALGASap_uint readerCall_length (LOCATION_ARGS) ;\n"
        "\n" ;
      ...
      result << "//--------------------------------- Comparison constructor\n"
        "  public : GALGASap_bool readerCall_hasKey (GALGASap_string & inKey COMMA_LOCATION_ARGS) ;\n"
        "  public : GALGASap_uint readerCall_count (LOCATION_ARGS) ;\n"
        "  public : GALGASap_stringset readerCall_allKeys (LOCATION_ARGS) ;\n"
        "  public : GALGASap_lstringlist readerCall_allKeyList (LOCATION_ARGS) ;\n"
        "  public : GALGASap_location readerCall_locationForKey (GALGASap_string & inKey, C_Compiler * inCompiler COMMA_LOCATION_ARGS) ;\n"
        "\n" ;
    }else {
    }
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (77)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (85)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- .= operator\n"
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (91)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- & operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
      result << " operator_and (" ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (97)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- | operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
      result << " operator_or (" ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (103)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- ^ operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
      result << " operator_xor (" ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (109)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- & operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (114)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- ~ operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (119)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (125)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- + operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (132)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- - operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (139)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- * operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (146)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- / operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (153)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- mod operator\n"
        "  public : GALGASap_" ;
      result << var_cas_TYPE_IDENTIFIER ;
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (160)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
    ...
    if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (166)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
      result << "//--------------------------------- ++, -- operators\n"
    ...
    if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      columnMarker = result.currentColumn () ;
      GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7495 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
      const GGS_unifiedTypeMapProxyList::cElement * operand_7495 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_7495 = enumerator_7495.nextObject ()))) {
      macroValidPointer (operand_7495) ;
      result << "GALGASap_" ;
      result << operand_7495->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) ;
      result << " inOperand" ;
...
GGS_readerMap::cEnumerator enumerator_7747 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_7747 = NULL ;
while (((operand_7747 = enumerator_7747.nextObject ()))) {
  macroValidPointer (operand_7747) ;
  if (((operand_7747->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).operator_or ((operand_7747->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).boolValue ()) {
    result << "public : GALGASap_" ;
    result << operand_7747->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
    result << " readerCall_" ;
    result << operand_7747->mKey.ggs_string ().reader_identifierRepresentation () ;
    result << " (" ;
    columnMarker = result.currentColumn () ;
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_8011 (operand_7747->mInfo.mArgumentTypeList, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_8011 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_8011 = enumerator_8011.nextObject ()))) {
    macroValidPointer (operand_8011) ;
    result << "GALGASap_" ;
    result << operand_8011->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
...
if ((operand_7747->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
...
}else if (operand_7747->mInfo.mHasCompilerArgument.boolValue ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  result << "C_Compiler * inCompiler\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--- Construction from pointer\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " (GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "//--------------------------------- Reader invocation declaration\n" ;
GGS_readerMap::cEnumerator enumerator_5952 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_5952 = NULL ;
while (((operand_5952 = enumerator_5952.nextObject ()))) {
macroValidPointer (operand_5952) ;
if (((operand_5952->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (148)))).operator_or ((operand_5952->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (148)))).boolValue ()) {
result << "public : GALGASap_" ;
result << operand_5952->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << " readerCall_" ;
result << operand_5952->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6216 (operand_5952->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6216 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6216 = enumerator_6216.nextObject ()))) {
macroValidPointer (operand_6216) ;
result << "GALGASap_" ;
result << operand_6216->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
if (enumerator_6216.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_5952->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_5952->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_5952->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((operand_5291->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).boolValue ()) {
...
if ((operand_6499->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (159))).boolValue ()) {
...
if ((operand_7924->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (195))).boolValue ()) {
...
result << ") " ;
if (((operand_7924->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (225)))).operator_or ((operand_7924->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (225)))).boolValue ()) {
result << "= 0 " ;
}else {
}
result << ";\n"
...
if (((operand_9513->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (234)))).operator_or ((operand_9513->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (234)))).boolValue ()) {
...
if (((operand_12081->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (296)))).operator_and ((operand_12081->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (296)))).boolValue ()) {
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12358 (operand_12081->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_12358 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12358 = enumerator_12358.nextObject ()))) {
macroValidPointer (operand_12358) ;
result << "GALGASap_" ;
result << operand_12358->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (299)) ;
result << " & constinOperand" ;
...
result << ") " ;
if ((operand_12081->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (316))).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
if (((((var_cas_SUPPORTED_OPERATORS).operator_and ((function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (323))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (323))))).operator_isNotEqual (GGS_uint (0U))).operator_or ((var_cas_MODIFIER_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)))).operator_or ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U))).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (331)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
GGS_nativeAttributeList::cEnumerator enumerator_13897 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_13897 = NULL ;
while (((operand_13897 = enumerator_13897.nextObject ()))) {
macroValidPointer (operand_13897) ;
result << "  private : " ;
if (operand_13897->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_13897->mCppClassName ;
result << " " ;
if (operand_13897->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_13897->mAttributeName ;
result << " ;\n" ;
if ((operand_13897->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if ((operand_13897->mIsConst).operator_not ().boolValue ()) {
...
result << operand_13897->mGetterName ;
result << " (void) { return " ;
result << operand_13897->mAttributeName ;
result << " ; }\n" ;
}else {
...
GGS_typedAttributeList::cEnumerator enumerator_14426 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14426 = NULL ;
while (((operand_14426 = enumerator_14426.nextObject ()))) {
macroValidPointer (operand_14426) ;
result << "  public : GALGASap_" ;
result << operand_14426->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
result << " mAttribute_" ;
result << operand_14426->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (353)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (360)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_15458 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_15458 = NULL ;
while (((operand_15458 = enumerator_15458.nextObject ()))) {
macroValidPointer (operand_15458) ;
result << "  friend capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_15458->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_15458->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (372)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_16237 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_16237 = NULL ;
while (((operand_16237 = enumerator_16237.nextObject ()))) {
macroValidPointer (operand_16237) ;
result << "    public : GALGASap_" ;
result << operand_16237->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)) ;
result << " attribute_" ;
result << operand_16237->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_modifierMap::cEnumerator enumerator_16568 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_16568 = NULL ;
while (((operand_16568 = enumerator_16568.nextObject ()))) {
macroValidPointer (operand_16568) ;
if ((operand_16568->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (402))).boolValue ()) {
result << "void modifierCall_" ;
result << operand_16568->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_16752 (operand_16568->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_16752 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_16752 = enumerator_16752.nextObject ()))) {
macroValidPointer (operand_16752) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_16752->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (406))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16752->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (407)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407)) ;
}else if ((operand_16752->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (408))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16752->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (409)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (409)) ;
}else if ((operand_16752->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (410))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16752->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (411)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (411)) ;
}else {
result << "GALGASap_" ;
result << operand_16752->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) ;
result << " inArgument" ;
...
if (operand_16568->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_17792 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_17792 = NULL ;
while (((operand_17792 = enumerator_17792.nextObject ()))) {
macroValidPointer (operand_17792) ;
if (((operand_17792->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (429)))).operator_or ((operand_17792->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (429)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_17792->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_18030 (operand_17792->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18030 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18030 = enumerator_18030.nextObject ()))) {
macroValidPointer (operand_18030) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_18030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (433))).boolValue ()) {
result << "GALGASap_" ;
result << operand_18030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (434)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (434)) ;
}else if ((operand_18030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (435))).boolValue ()) {
result << "GALGASap_" ;
result << operand_18030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (436)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (436)) ;
}else if ((operand_18030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (437))).boolValue ()) {
result << "GALGASap_" ;
result << operand_18030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (438)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (438)) ;
}else {
result << "GALGASap_" ;
result << operand_18030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (440)) ;
result << " inArgument" ;
...
if (operand_17792->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_19104 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_19104 = NULL ;
while (((operand_19104 = enumerator_19104.nextObject ()))) {
macroValidPointer (operand_19104) ;
result << "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_19104->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_19104->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
if (((operand_5029->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (129)))).operator_or ((operand_5029->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (129)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << "//---------------------------------------------------------------------------*\n"
  "//" ;
result << ((((GGS_string ("@")).operator_concat (var_cas_TYPE_NAME)).operator_concat (GGS_string (" "))).operator_concat (var_cas_TYPE_KIND.reader_kind (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).operator_concat (GGS_string (" enumeration")).reader_stringByLeftAndRightPadding (GGS_uint (75U), GGS_char (TO_UNICODE (' '))) ;
result << "*\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_8169 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8169 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8169 = enumerator_8169.nextObject ()))) {
macroValidPointer (operand_8169) ;
result << ",\n"
  "attribute_" ;
result << operand_8169->mEnumerationName.reader_identifierRepresentation () ;
result << " ()" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_8771 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8771 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8771 = enumerator_8771.nextObject ()))) {
macroValidPointer (operand_8771) ;
result << "  attribute_" ;
result << operand_8771->mEnumerationName.reader_identifierRepresentation () ;
result << " = p->mAttribute_" ;
result << operand_8771->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "::addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7288 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7288 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7288 = enumerator_7288.nextObject ()))) {
macroValidPointer (operand_7288) ;
result << "GALGASap_" ;
result << operand_7288->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
if (enumerator_7288.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "    GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::insulate (*this COMMA_HERE) ;\n"
  "    cCollectionElement * p = NULL ;\n"
  "    macroMyNew (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7658 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7658 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7658 = enumerator_7658.nextObject ()))) {
macroValidPointer (operand_7658) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
if (enumerator_7658.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8970 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8970 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8970 = enumerator_8970.nextObject ()))) {
macroValidPointer (operand_8970) ;
result << "GALGASap_" ;
result << operand_8970->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9424 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9424 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9424 = enumerator_9424.nextObject ()))) {
macroValidPointer (operand_9424) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9602 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9602 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9602 = enumerator_9602.nextObject ()))) {
macroValidPointer (operand_9602) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (238)) ;
result << " = p->mAttribute_" ;
result << operand_9602->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9904 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9904 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9904 = enumerator_9904.nextObject ()))) {
macroValidPointer (operand_9904) ;
result << "GALGASap_" ;
result << operand_9904->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10358 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10358 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10358 = enumerator_10358.nextObject ()))) {
macroValidPointer (operand_10358) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10536 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10536 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_10536->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10833 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10833 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10833 = enumerator_10833.nextObject ()))) {
macroValidPointer (operand_10833) ;
result << "GALGASap_" ;
result << operand_10833->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11284 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11284 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11284 = enumerator_11284.nextObject ()))) {
macroValidPointer (operand_11284) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11462 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11462 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11462 = enumerator_11462.nextObject ()))) {
macroValidPointer (operand_11462) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) ;
result << " = p->mAttribute_" ;
result << operand_11462->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_11759 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11759 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11759 = enumerator_11759.nextObject ()))) {
macroValidPointer (operand_11759) ;
result << "GALGASap_" ;
result << operand_11759->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (297)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (297)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12210 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12210 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12210 = enumerator_12210.nextObject ()))) {
macroValidPointer (operand_12210) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12388 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12388 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12388 = enumerator_12388.nextObject ()))) {
macroValidPointer (operand_12388) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) ;
result << " = p->mAttribute_" ;
result << operand_12388->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << " & inOperand2) {\n"
  "   enumComparisonResult result = kOperandEqual ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3666 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3666 = NULL ;
while (((operand_3666 = enumerator_3666.nextObject ()))) {
macroValidPointer (operand_3666) ;
result << "  if (result == kOperandEqual) {\n"
  "    result = GALGAS_" ;
result << operand_3666->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
result << "::objectCompare (inOperand1.mAttribute_" ;
result << operand_3666->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "::isValid (void) const {\n"
  "  return " ;
GGS_typedAttributeList::cEnumerator enumerator_4163 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4163 = NULL ;
while (((operand_4163 = enumerator_4163.nextObject ()))) {
macroValidPointer (operand_4163) ;
result << "mAttribute_" ;
result << operand_4163->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
if (enumerator_4163.hasNextObject ()) {
result << " && " ;
}
}
result << " ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::drop (void) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4437 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4815 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4815 = NULL ;
while (((operand_4815 = enumerator_4815.nextObject ()))) {
macroValidPointer (operand_4815) ;
result << "mAttribute_" ;
result << operand_4815->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
