...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_13365 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_13365.isBuiltAndTrue ()) {
...
::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (276)) ;
GGS_string var_cas_generatedCode = template_filewrapper_builtinTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (283)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (283))) ;
{
GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12336 (var_cas_decoratedDeclarationListForGeneration, true) ;
const GGS_semanticDeclarationListForGeneration::cElement * operand_12336 = NULL ;
while (((operand_12336 = enumerator_12336.nextObject ()))) {
  macroValidPointer (operand_12336) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12336->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12336->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
}
}
const GGS_bool cond_12703 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12703.isBuiltAndTrue ()) {
...
{
GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12895 (var_cas_decoratedDeclarationListForGeneration, true) ;
const GGS_semanticDeclarationListForGeneration::cElement * operand_12895 = NULL ;
while (((operand_12895 = enumerator_12895.nextObject ()))) {
  macroValidPointer (operand_12895) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12895->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12895->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (302)))) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12895->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12895->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (303)))) ;
}
}
const GGS_bool cond_13341 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).operator_isEqual (GGS_uint (0U)) ;
if (cond_13341.isBuiltAndTrue ()) {
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_generatedCode, GGS_string ("\n"
  "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (306)) ;
}
}
}
  #ifdef DEBUG_TRACE_ENABLED
