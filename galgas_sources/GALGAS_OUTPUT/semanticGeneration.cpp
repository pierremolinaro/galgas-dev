...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4116 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4116 = NULL ;
while (((operand_4116 = enumerator_4116.nextObject ()))) {
macroValidPointer (operand_4116) ;
result << "p->mAttribute_" ;
result << operand_4116->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_4370 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_4370 = NULL ;
while (((operand_4370 = enumerator_4370.nextObject ()))) {
macroValidPointer (operand_4370) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_4370->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_4370->mSignature, operand_4370->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (104)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_4784 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4784 = NULL ;
while (((operand_4784 = enumerator_4784.nextObject ()))) {
macroValidPointer (operand_4784) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_4784->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_4784->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_4784->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (118)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    const cPtr_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_5480 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5480 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_5480->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_5480->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_5480->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
}
GGS_instanceMethodMap::cEnumerator enumerator_6147 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_6147 = NULL ;
while (((operand_6147 = enumerator_6147.nextObject ()))) {
macroValidPointer (operand_6147) ;
if ((operand_6147->mInfo.mIsCategory).operator_not ().boolValue ()) {
if ((((operand_6147->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (142)))).operator_or ((operand_6147->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (142))))).operator_or ((operand_6147->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (142)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_" ;
result << operand_6147->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_6535 (operand_6147->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6535 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6535 = enumerator_6535.nextObject ()))) {
macroValidPointer (operand_6535) ;
if ((operand_6535->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (146))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
}else if ((operand_6535->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
}else if ((operand_6535->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (150))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
}else {
result << "GALGAS_" ;
result << operand_6535->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
}
...
if ((operand_6147->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6147->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << operand_6147->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_8037 (operand_6147->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8037 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8037 = enumerator_8037.nextObject ()))) {
macroValidPointer (operand_8037) ;
if ((operand_8037->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
result << ", " ;
}else if ((operand_8037->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (180))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
result << ", " ;
}else if ((operand_8037->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).boolValue ()) {
result << "outArgument" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8998 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8998 = NULL ;
while (((operand_8998 = enumerator_8998.nextObject ()))) {
macroValidPointer (operand_8998) ;
result << "const GALGAS_" ;
result << operand_8998->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " & in_" ;
result << operand_8998->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_8998.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
...
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_9399 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9399 = NULL ;
while (((operand_9399 = enumerator_9399.nextObject ()))) {
macroValidPointer (operand_9399) ;
result << "in_" ;
result << operand_9399->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_9399.hasNextObject ()) {
result << ", " ;
}
}
...
result << ")" ;
GGS_typedAttributeList::cEnumerator enumerator_9617 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9617 = NULL ;
while (((operand_9617 = enumerator_9617.nextObject ()))) {
macroValidPointer (operand_9617) ;
result << ",\n"
  "mAttribute_" ;
result << operand_9617->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_9617->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_NAME ;
result << ":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10525 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10525 = NULL ;
while (((operand_10525 = enumerator_10525.nextObject ()))) {
macroValidPointer (operand_10525) ;
result << "  mAttribute_" ;
result << operand_10525->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation+1) ;\n" ;
if (enumerator_10525.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \"]\" ;\n"
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_16108
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_16321
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16321 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_16321->mRoutineName, operand_16321->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_16648
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16648 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16648->mFunctionName, operand_16648->mFormalArgumentList, operand_16648->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (438))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_17016
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17016 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_17016->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_17016->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (448))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17401
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17401 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_17401->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), operand_17401->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), ((operand_17401->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (458))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_17401->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)))), operand_17401->mAllTypedAttributeList, operand_17401->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17401->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (463)), operand_17401->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (464)), operand_17401->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (465)), operand_17401->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_17401->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_17401->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (468)), operand_17401->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_17401->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_17401->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_17401->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_17401->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_17401->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (474)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_18346
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18346 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_18346->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), operand_18346->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), operand_18346->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18346->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (487)), operand_18346->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), operand_18346->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), operand_18346->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_18346->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_18346->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_18346->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_18346->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18346->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18346->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18346->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18346->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (498)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_19187
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19187 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_19187->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), operand_19187->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (507)), operand_19187->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19187->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (511)), operand_19187->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (512)), operand_19187->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (513)), operand_19187->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (514)), operand_19187->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (515)), operand_19187->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (516)), operand_19187->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_19187->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19187->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19187->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19187->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19187->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (522)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_20029
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20029 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_20029->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (530)), operand_20029->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), operand_20029->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20029->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), operand_20029->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_20029->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (537)), operand_20029->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_20029->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), operand_20029->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (540)), operand_20029->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (541)), operand_20029->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20029->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20029->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20029->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20029->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (546)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_20875
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20875 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_20875->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (554)), operand_20875->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (555)), operand_20875->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20875->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (559)), operand_20875->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)), operand_20875->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (561)), operand_20875->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), operand_20875->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (563)), operand_20875->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), operand_20875->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_20875->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_20875->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_20875->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (568)), operand_20875->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_20875->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (570)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_21721
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21721 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_21721->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (578)), operand_21721->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (579)), operand_21721->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21721->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), operand_21721->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (584)), operand_21721->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (585)), operand_21721->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (586)), operand_21721->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), operand_21721->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (588)), operand_21721->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_21721->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_21721->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_21721->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_21721->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), operand_21721->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (594)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_22741 (var_cas_inFilewrapperFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_22741 = NULL ;
while (((operand_22741 = enumerator_22741.nextObject ()))) {
  macroValidPointer (operand_22741) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (606))) ;
}
}
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_22889 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_22889 = NULL ;
while (((operand_22889 = enumerator_22889.nextObject ()))) {
  macroValidPointer (operand_22889) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_22889->mRegularFileSortedList,  operand_22889->mDirectorySortedList,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (609)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_23210
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23210 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_23210->mFilewrapperFileSortedList,  operand_23210->mFilewrapperDirectorySortedList,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (621)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_23210->mFilewrapperName) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_23740
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23740 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_23740->mTypeName, operand_23740->mAbstractCategoryMethodName, operand_23740->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_24121
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24121 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_24121->mTypeName, operand_24121->mCategoryMethodName, operand_24121->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_24786
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24786 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_24979
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24979 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_24979->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (666)), operand_24979->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (667)), operand_24979->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_25316
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25316 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_25316->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (676)), operand_25316->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (677)), ((operand_25316->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (678))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_25316->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (678)))), operand_25316->mTypedAttributeList, operand_25316->mAllTypedAttributeList, operand_25316->mIsAbstract, operand_25316->mAbstractMethodList, operand_25316->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_26231
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26231 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_26457
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26457 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_26457->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (702)), operand_26457->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (703)), operand_26457->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), operand_26457->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (705))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_27188
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27188 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_27410
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27410 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_27410->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (724)), operand_27410->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (725)), operand_27410->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_27839
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27839 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_27839->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), operand_27839->mTypedAttributeList, operand_27839->mInsertMethodList, operand_27839->mSearchMethodList, operand_27839->mRemoveMethodList, operand_27839->mHasInsertOrReplaceModifier, operand_27839->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_28324
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28324 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_28324->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (748)), operand_28324->mTypedAttributeList, operand_28324->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_28711
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28711 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_28711->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (758)), operand_28711->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (759)), operand_28711->mConstantList, operand_28711->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_29109
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29109 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_29109->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (769)), operand_29109->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (770)), operand_29109->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29109->mAssociatedMapTypedAttributeList, operand_29109->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_29584
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29584 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_29584->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), operand_29584->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), ((operand_29584->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (783))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_29584->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (783)))), operand_29584->mTypedAttributeList, operand_29584->mAllTypedAttributeList, operand_29584->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_29584->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_29584->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)), operand_29584->mIsAbstract, operand_29584->mAbstractMethodList, operand_29584->mMethodList, operand_29584->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_30274
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30274 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_30274->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (798)), operand_30274->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (799)), operand_30274->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_30654
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30654 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_30654->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_30654->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), operand_30654->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_31045
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31045 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_31045->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_31045->mRoutineName.reader_identifierRepresentation ()), operand_31045->mFormalArgumentList, operand_31045->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (819))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_31682
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31682 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_31682->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_31682->mFunctionName.reader_identifierRepresentation ()), operand_31682->mFormalArgumentList, operand_31682->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_31682->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (841)), operand_31682->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (836)), operand_31682->mFormalArgumentList, operand_31682->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (845))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_32305
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32305 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_32305->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_32305->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32305->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32305->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (859)), operand_32305->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (854)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32305->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (863))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_32989
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32989 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_32989->mTypeName, operand_32989->mAbstractCategoryMethodName, operand_32989->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
GGS_string function_generateCategoryMethod (C_Compiler & inLexique,
  ...
  GGS_string var_cas_outGeneratedCode ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (894))) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (895))) ;
{
GGS_typedAttributeList::cEnumerator enumerator_34155 (var_cas_inTypedAttributeList, true) ;
const GGS_typedAttributeList::cElement * operand_34155 = NULL ;
while (((operand_34155 = enumerator_34155.nextObject ()))) {
  macroValidPointer (operand_34155) ;
const GGS_bool cond_34306 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_34306.isBuiltAndTrue ()) {
var_cas_unusedVariableCppNameSet.addAssign_operation ((GGS_string ("inObject->mAttribute_")).operator_concat (operand_34155->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
}else if (cond_34306.isBuiltAndFalse ()) {
var_cas_unusedVariableCppNameSet.addAssign_operation ((GGS_string ("object->mAttribute_")).operator_concat (operand_34155->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
}
}
}
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_34469 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_34469 = NULL ;
while (((operand_34469 = enumerator_34469.nextObject ()))) {
  macroValidPointer (operand_34469) ;
const GGS_bool cond_34626 = (operand_34469->mFormalArgumentPassingMode).operator_isNotEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (904))) ;
if (cond_34626.isBuiltAndTrue ()) {
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_34469->mFormalArgumentCppName) ;
}
}
}
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_string var_cas_routineBody = GGS_string ("") ;
var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (911)) ;
{
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_34800 (var_cas_inInstructionList, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_34800 = NULL ;
while (((operand_34800 = enumerator_34800.nextObject ()))) {
  macroValidPointer (operand_34800) ;
{ typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_34800->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34800->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (913)) ;
  }
}
}
}
var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (915)) ;
...
const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
const GGS_bool cond_35322 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_35322.isBuiltAndTrue ()) {
...
var_cas_outGeneratedCode.appendCString (" * ") ;
}else if (cond_35322.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inBaseClassName.reader_identifierRepresentation ()) ;
var_cas_outGeneratedCode.appendCString (" * ") ;
}
GGS_bool var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (924))) ;
{
GGS_typedAttributeList::cEnumerator enumerator_35542 (var_cas_inTypedAttributeList, true) ;
const GGS_typedAttributeList::cElement * operand_35542 = NULL ;
while (((operand_35542 = enumerator_35542.nextObject ()))
    && (var_cas_currentObjectIsUnused.isBuiltAndTrue ())) {
  macroValidPointer (operand_35542) ;
const GGS_bool cond_35752 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_35752.isBuiltAndTrue ()) {
var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey ((GGS_string ("inObject->mAttribute_")).operator_concat (operand_35542->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
}else if (cond_35752.isBuiltAndFalse ()) {
var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey ((GGS_string ("object->mAttribute_")).operator_concat (operand_35542->mAttributeName.ggs_string ().reader_identifierRepresentation ())) ;
}
}
}
const GGS_bool cond_35997 = var_cas_currentObjectIsUnused ;
if (cond_35997.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
}else if (cond_35997.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("inObject") ;
}
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_36081 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_36081 = NULL ;
while (((operand_36081 = enumerator_36081.nextObject ()))) {
  macroValidPointer (operand_36081) ;
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (940)) ;
switch (operand_36081->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (943))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (945))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (947))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::kNotBuilt:
...
const GGS_bool cond_36859 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_36081->mFormalArgumentCppName) ;
if (cond_36859.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentCppName) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_36859.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (operand_36081->mFormalArgumentCppName) ;
}
}
}
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (959)) ;
var_cas_outGeneratedCode.appendCString ("C_Compiler * ") ;
const GGS_bool cond_37221 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (961))) ;
if (cond_37221.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (962))) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_37221.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (964))) ;
}
var_cas_outGeneratedCode.appendCString ("\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (967)) ;
var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
var_cas_outGeneratedCode.appendCString (") {\n") ;
{
  GGS_uint var_cas_IDX (true, 0) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_37508 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_37508 = NULL ;
while (((operand_37508 = enumerator_37508.nextObject ()))) {
  macroValidPointer (operand_37508) ;
switch (operand_37508->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("  ") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_37508->mFormalArgumentCppName) ;
var_cas_outGeneratedCode.appendCString (".drop () ; // Release 'out' argument\n") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
...
const GGS_bool cond_38162 = ((var_cas_inBaseClassName).operator_isNotEqual (GGS_string (""))).operator_and ((var_cas_currentObjectIsUnused).operator_not ()) ;
if (cond_38162.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_38405
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38405 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_38405->mTypeName, GGS_string (""), operand_38405->mCategoryMethodName, operand_38405->mCategoryMethodFormalParameterList, operand_38405->mTypedAttributeList, operand_38405->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (991)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_38405->mTypeName, operand_38405->mCategoryMethodName, operand_38405->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_39054
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39054 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_39054->mTypeName, operand_39054->mBaseTypeName, operand_39054->mCategoryMethodName, operand_39054->mCategoryMethodFormalParameterList, operand_39054->mTypedAttributeList, operand_39054->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1010)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_39054->mTypeName, operand_39054->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_39966 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_39966 = NULL ;
while (((operand_39966 = enumerator_39966.nextObject ()))) {
  macroValidPointer (operand_39966) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_39966->mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1037)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_39966->mRegularFileName) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_39966->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1040))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_39966->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1043))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_39966->mRegularFileName.reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_39966->mRegularFileName.reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_39966->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1047))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_40851 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_40851 = NULL ;
while (((operand_40851 = enumerator_40851.nextObject ()))) {
  macroValidPointer (operand_40851) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_40851->mDirectoryName,  operand_40851->mWrapperDirectoryIndex,  operand_40851->mRegularFileSortedList,  operand_40851->mDirectorySortedList,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1052)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1064))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1065)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1065))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileSortedList::cEnumerator enumerator_41469 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_41469 = NULL ;
...
var_cas_ioImplementation.dotAssign_operation (operand_41469->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1067))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1075)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1075))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_42095 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_42095 = NULL ;
while (((operand_42095 = enumerator_42095.nextObject ()))) {
  macroValidPointer (operand_42095) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_42095->mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1077))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1086))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1087))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1088))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllDirectories_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1089))) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
  "\n") ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_43226
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43226 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_43226->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_43226->mFilewrapperFileSortedList,  operand_43226->mFilewrapperDirectorySortedList,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1097)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_43226->mFilewrapperName, var_cas_filewrapperImplementation) ;
  }
  return var_cas_outImplementation ;
}
