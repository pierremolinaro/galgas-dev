...
//                    september 26th, 2010, at 19h42'21"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
  ...
  columnMarker = result.currentColumn () ;
  GGS_unifiedTypeMapProxyList::cEnumerator enumerator_2118 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
  const GGS_unifiedTypeMapProxyList::cElement * operand_2118 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2118 = enumerator_2118.nextObject ()))) {
  macroValidPointer (operand_2118) ;
  result << "const GALGAS_" ;
  result << operand_2118->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (48)) ;
  result << " & inOperand" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (55)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_and (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (61)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- | operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_or (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (67)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ^ operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_xor (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (73)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- not operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (78)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ~ operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (83)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (89)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- + operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (96)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- - operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (103)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- * operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (110)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- / operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (117)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- mod operator\n"
  "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (124)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (130)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ++, -- operators\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (137)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (144)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_6907 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_6907 = NULL ;
while (((operand_6907 = enumerator_6907.nextObject ()))) {
macroValidPointer (operand_6907) ;
if ((((operand_6907->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (155)))).operator_or ((operand_6907->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (155))))).operator_or ((operand_6907->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (155)))).boolValue ()) {
result << "  public :" ;
if ((operand_6907->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (157))).boolValue ()) {
  result << " VIRTUAL_IN_DEBUG " ;
}else {
  result << " virtual " ;
}
result << "void modifier_" ;
result << operand_6907->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7287 (operand_6907->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7287 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7287 = enumerator_7287.nextObject ()))) {
macroValidPointer (operand_7287) ;
if ((operand_7287->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (164))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7287->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
  result << " constinArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
}else if ((operand_7287->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (166))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7287->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
  result << " & ioArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
}else if ((operand_7287->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (168))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7287->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
  result << " & outArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
}else {
  result << "GALGAS_" ;
  result << operand_7287->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (171)) ;
  result << " inArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (171)) ;
}
if (enumerator_7287.hasNextObject ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_6907->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6907->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8546 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8546 = NULL ;
while (((operand_8546 = enumerator_8546.nextObject ()))) {
macroValidPointer (operand_8546) ;
if ((((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (197)))).operator_or ((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (197))))).operator_or ((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (197)))).boolValue ()) {
result << "  public :" ;
if ((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).boolValue ()) {
result << " VIRTUAL_IN_DEBUG " ;
}else {
result << " virtual " ;
}
result << "void method_" ;
result << operand_8546->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8924 (operand_8546->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8924 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8924 = enumerator_8924.nextObject ()))) {
macroValidPointer (operand_8924) ;
if ((operand_8924->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (206))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8924->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
}else if ((operand_8924->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8924->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
}else if ((operand_8924->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (210))).boolValue ()) {
result << "GALGAS_" ;
result << operand_8924->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
}else {
result << "GALGAS_" ;
result << operand_8924->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) ;
result << " inArgument" ;
...
if ((operand_8546->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8546->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if (((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (233)))).operator_or ((operand_8546->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (233)))).boolValue ()) {
result << "= 0 " ;
}else {
}
result << ";\n"
...
GGS_classMethodMap::cEnumerator enumerator_10323 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_10323 = NULL ;
while (((operand_10323 = enumerator_10323.nextObject ()))) {
macroValidPointer (operand_10323) ;
result << "  public : static void class_method_" ;
result << operand_10323->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10430 (operand_10323->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10430 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10430 = enumerator_10430.nextObject ()))) {
macroValidPointer (operand_10430) ;
if ((operand_10430->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10430->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
}else if ((operand_10430->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (246))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10430->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
}else if ((operand_10430->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (248))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10430->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
}else {
result << "GALGAS_" ;
result << operand_10430->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
}
if (enumerator_10430.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10323->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10323->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_11608 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_11608 = NULL ;
while (((operand_11608 = enumerator_11608.nextObject ()))) {
macroValidPointer (operand_11608) ;
if ((((operand_11608->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (276)))).operator_or ((operand_11608->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (276))))).operator_or ((operand_11608->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (276)))).boolValue ()) {
result << "  public :" ;
if ((operand_11608->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (278))).boolValue ()) {
result << " VIRTUAL_IN_DEBUG " ;
}else {
result << " virtual " ;
}
result << "GALGAS_" ;
result << operand_11608->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (283)) ;
result << " reader_" ;
result << operand_11608->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12045 (operand_11608->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_12045 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12045 = enumerator_12045.nextObject ()))) {
macroValidPointer (operand_12045) ;
result << "const GALGAS_" ;
result << operand_12045->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
if (enumerator_12045.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11608->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11608->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (309)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (316)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_13629 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13629 = NULL ;
while (((operand_13629 = enumerator_13629.nextObject ()))) {
macroValidPointer (operand_13629) ;
result << "  friend cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_13629->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_13629->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (328)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14728 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14728 = NULL ;
while (((operand_14728 = enumerator_14728.nextObject ()))) {
macroValidPointer (operand_14728) ;
result << "  public : GALGAS_" ;
result << operand_14728->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
result << " current_" ;
result << operand_14728->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_15190 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_15190 = NULL ;
while (((operand_15190 = enumerator_15190.nextObject ()))) {
macroValidPointer (operand_15190) ;
result << "cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_15190->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_15190->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (365)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4423 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4423 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4423 = enumerator_4423.nextObject ()))) {
macroValidPointer (operand_4423) ;
result << "const GALGAS_" ;
result << operand_4423->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
if (enumerator_4423.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4918 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4918 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4918 = enumerator_4918.nextObject ()))) {
macroValidPointer (operand_4918) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
if (enumerator_4918.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5278 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "const GALGAS_" ;
result << operand_5278->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
if (enumerator_5278.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_5490 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5490 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5693 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5693 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6030 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6030 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6030 = enumerator_6030.nextObject ()))) {
macroValidPointer (operand_6030) ;
result << "GALGAS_" ;
result << operand_6030->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
if (enumerator_6030.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_6240 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6445 (var_cas_ATTRIBUTE_LIST, true) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6790 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6790 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6790 = enumerator_6790.nextObject ()))) {
macroValidPointer (operand_6790) ;
result << "GALGAS_" ;
result << operand_6790->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
result << " & outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7399 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7399 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7399 = enumerator_7399.nextObject ()))) {
macroValidPointer (operand_7399) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
result << " = p->mAttribute_" ;
result << operand_7399->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7697 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7697 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7697 = enumerator_7697.nextObject ()))) {
macroValidPointer (operand_7697) ;
result << "GALGAS_" ;
result << operand_7697->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8127 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8127 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8305 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8305 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_8305->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_first (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8599 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8599 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8599 = enumerator_8599.nextObject ()))) {
macroValidPointer (operand_8599) ;
result << "GALGAS_" ;
result << operand_8599->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9022 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9022 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9200 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9200 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_9200->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9493 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9493 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9493 = enumerator_9493.nextObject ()))) {
macroValidPointer (operand_9493) ;
result << "GALGAS_" ;
result << operand_9493->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9915 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9915 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9915 = enumerator_9915.nextObject ()))) {
...
result << " = p->mAttribute_" ;
result << operand_10093->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12094 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12094 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12094 = enumerator_12094.nextObject ()))) {
macroValidPointer (operand_12094) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_12094->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_12094->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_12094->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inOperand ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13036 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13036 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_13036->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_13036->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_uint & inIndex,\n"
  "                                              " ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGAS_" ;
result << operand_13036->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "] = {\n"
  "    \"\"" ;
GGS_enumMessageAssociationSortedListForGeneration::cEnumerator enumerator_879 (operand_590->mMessageAssociationList, true) ;
const GGS_enumMessageAssociationSortedListForGeneration::cElement * operand_879 = NULL ;
while (((operand_879 = enumerator_879.nextObject ()))) {
macroValidPointer (operand_879) ;
result << ",\n"
  "  " ;
result << operand_879->mMessage.reader_utf8Representation () ;
}
result << "\n"
  "} ;\n"
  "\n"
...
result << "] = {\n"
  "  \"(not built)\"" ;
GGS_stringlist::cEnumerator enumerator_1628 (var_cas_CONSTANT_LIST, true) ;
const GGS_stringlist::cElement * operand_1628 = NULL ;
while (((operand_1628 = enumerator_1628.nextObject ()))) {
macroValidPointer (operand_1628) ;
result << ",\n"
  "  " ;
result << operand_1628->mValue.reader_utf8Representation () ;
}
result << "\n"
  "} ;\n"
  "\n"
...
result << " & inOperand2) {\n"
  ...
  "    if (inOperand1.mEnum < (PMSInt32) inOperand2.mEnum) {\n"
  "      result = kFirstOperandLowerThanSecond ;\n"
  "    }else if (inOperand1.mEnum > (PMSInt32) inOperand2.mEnum) {\n"
