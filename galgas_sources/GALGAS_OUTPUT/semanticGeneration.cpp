...
result << "} ;\n"
  "  performInsert (attributes, inCompiler, " ;
result << operand_1016->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
}
...
columnMarker = result.currentColumn () ;
result << "const GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_2014 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2014 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2014 = enumerator_2014.nextObject ()))) {
macroValidPointer (operand_2014) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_2014->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  const GALGAS_root * attributes [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (53)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_2303 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2303 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2303 = enumerator_2303.nextObject ()))) {
macroValidPointer (operand_2303) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_2455 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2455 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2455 = enumerator_2455.nextObject ()))) {
macroValidPointer (operand_2455) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_2455->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_2455->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string * inKey,\n"
  "                                               " ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (67)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
result << " COMMA_THERE) ;\n"
  "  macroNullOrValidObject (result, GALGAS_" ;
result << operand_2455->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
result << ") ;\n"
  "  return (GALGAS_" ;
result << operand_2455->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
result << " *) result ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_3244 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3244 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_3244->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string * inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_3244->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (79)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
