...
GGS_modifierMap::cEnumerator enumerator_23088 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_23088 = NULL ;
while (((operand_23088 = enumerator_23088.nextObject ()))) {
macroValidPointer (operand_23088) ;
if ((operand_23088->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (555))).boolValue ()) {
result << "  void modifierCall_" ;
result << operand_23088->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23274 (operand_23088->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23274 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23274 = enumerator_23274.nextObject ()))) {
macroValidPointer (operand_23274) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23274->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (559))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23274->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
}else if ((operand_23274->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (561))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23274->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
}else if ((operand_23274->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (563))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23274->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
}else {
result << "GALGASap_" ;
result << operand_23274->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (566)) ;
result << " inArgument" ;
...
if (operand_23088->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24314 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24314 = NULL ;
while (((operand_24314 = enumerator_24314.nextObject ()))) {
macroValidPointer (operand_24314) ;
if (((operand_24314->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).operator_or ((operand_24314->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24314->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24552 (operand_24314->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24552 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24552 = enumerator_24552.nextObject ()))) {
macroValidPointer (operand_24552) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (586))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
}else if ((operand_24552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (588))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
}else if ((operand_24552->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (590))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
}else {
result << "GALGASap_" ;
result << operand_24552->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (593)) ;
result << " inArgument" ;
...
if (operand_24314->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25626 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25626 = NULL ;
while (((operand_25626 = enumerator_25626.nextObject ()))) {
macroValidPointer (operand_25626) ;
result << "cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_25626->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25626->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
