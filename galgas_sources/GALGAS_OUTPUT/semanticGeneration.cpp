...
result << "//--------------------------------- Abstract method for comparing two sorted list elements\n"
  "  protected : virtual PMSInt32 compareSortedListElements (GALGASap_object & inLeftAttributeList [],\n"
  "                                                          GALGASap_object & inRightAttributeList []) const ;\n"
  "\n" ;
}else {
}
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_21162 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21162 = NULL ;
...
result << operand_21162->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21162->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_21937 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_21937 = NULL ;
while (((operand_21937 = enumerator_21937.nextObject ()))) {
macroValidPointer (operand_21937) ;
result << "    public : GALGASap_" ;
result << operand_21937->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (526)) ;
result << " attribute_" ;
result << operand_21937->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22239 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22239 = NULL ;
while (((operand_22239 = enumerator_22239.nextObject ()))) {
macroValidPointer (operand_22239) ;
if ((operand_22239->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (537))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22239->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
result << " readerCall_" ;
result << operand_22239->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22487 (operand_22239->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22487 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22487 = enumerator_22487.nextObject ()))) {
macroValidPointer (operand_22487) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22487->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (541)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22239->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_22888 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_22888 = NULL ;
while (((operand_22888 = enumerator_22888.nextObject ()))) {
macroValidPointer (operand_22888) ;
if ((operand_22888->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (555))).boolValue ()) {
result << "  void modifierCall_" ;
result << operand_22888->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23074 (operand_22888->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23074 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23074 = enumerator_23074.nextObject ()))) {
macroValidPointer (operand_23074) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23074->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (559))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23074->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (560)) ;
}else if ((operand_23074->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (561))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23074->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
}else if ((operand_23074->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (563))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23074->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)) ;
}else {
result << "GALGASap_" ;
result << operand_23074->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (566)) ;
result << " inArgument" ;
...
if (operand_22888->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24114 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24114 = NULL ;
while (((operand_24114 = enumerator_24114.nextObject ()))) {
macroValidPointer (operand_24114) ;
if (((operand_24114->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).operator_or ((operand_24114->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24114->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24352 (operand_24114->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24352 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24352 = enumerator_24352.nextObject ()))) {
macroValidPointer (operand_24352) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24352->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (586))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24352->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
}else if ((operand_24352->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (588))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24352->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589)) ;
}else if ((operand_24352->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (590))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24352->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
}else {
result << "GALGASap_" ;
result << operand_24352->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (593)) ;
result << " inArgument" ;
...
if (operand_24114->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25426 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25426 = NULL ;
while (((operand_25426 = enumerator_25426.nextObject ()))) {
macroValidPointer (operand_25426) ;
result << "cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_25426->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25426->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_25938 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_25938 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25938->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (620)) ;
result << " inOperand" ;
...
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_2038 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2038 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2038 = enumerator_2038.nextObject ()))) {
macroValidPointer (operand_2038) ;
result << ", inArgument" ;
...
result << "} ;\n" ;
const GGS_uint indentation_2501 = GGS_uint (2U) ;
if (indentation_2501.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_2501.uintValue ()) ;
}
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_2540 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_2540 = NULL ;
while (((operand_2540 = enumerator_2540.nextObject ()))) {
macroValidPointer (operand_2540) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "static const utf32 kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_2540->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_2540->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (61)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
result << "] = " ;
result << operand_2540->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_3055 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3055 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_3055->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_3662 = GGS_uint (2U) ;
if (indentation_3662.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_3662.uintValue ()) ;
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_3702 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_3702 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3702->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_3940->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_4635 = GGS_uint (2U) ;
if (indentation_4635.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_4635.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_3702->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (90)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
result << "] = " ;
result << operand_3702->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "cRootObjectArray attributes ;\n"
  "  performRemove (inKey, attributes, inCompiler, kRemoveErrorMessage COMMA_THERE) ;\n"
  "if (attributes.count () != 0) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4472 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4472 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4472 = enumerator_4472.nextObject ()))) {
macroValidPointer (operand_4472) ;
result << "  outArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_4886 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4886 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4886 = enumerator_4886.nextObject ()))) {
macroValidPointer (operand_4886) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4886->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
result << " * inArgument" ;
...
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5165 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5165 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
GGS_typedAttributeList::cEnumerator enumerator_5317 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5317 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5317 = enumerator_5317.nextObject ()))) {
macroValidPointer (operand_5317) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5317->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5317->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
...
GGS_typedAttributeList::cEnumerator enumerator_5895 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5895 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5895 = enumerator_5895.nextObject ()))) {
macroValidPointer (operand_5895) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_5895->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_string inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_5895->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
...
GGS_withAccessorMap::cEnumerator enumerator_6548 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_6548 = NULL ;
...
result << operand_6548->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_6548->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_6548->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
columnMarker = result.currentColumn () ;
result << "GALGAS_object * inLeftAttributeList [],\n"
  "                                                " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_object * inRightAttributeList []) const {\n"
  "  PMSInt32 result = 0 ;\n" ;
...
GGS_typedAttributeList::cEnumerator enumerator_1808 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1808 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1808 = enumerator_1808.nextObject ()))) {
macroValidPointer (operand_1808) ;
result << "GALGAS_" ;
result << operand_1808->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (44)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (44)) ;
if (enumerator_1808.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL0 ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if (enumerator_2182.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_typedAttributeList::cEnumerator enumerator_2491 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2491 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_2491->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (63)) ;
result << " * inOperand" ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_2848 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2848 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_2848.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4139 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4139 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4139 = enumerator_4139.nextObject ()))) {
macroValidPointer (operand_4139) ;
result << "GALGAS_" ;
result << operand_4139->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
result << " * & outOperand" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4362 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4362 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4362 = enumerator_4362.nextObject ()))) {
macroValidPointer (operand_4362) ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_4605 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4605 = NULL ;
while (((operand_4605 = enumerator_4605.nextObject ()))) {
macroValidPointer (operand_4605) ;
result << "NULL" ;
...
GGS_typedAttributeList::cEnumerator enumerator_4749 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4749 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4749 = enumerator_4749.nextObject ()))) {
macroValidPointer (operand_4749) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " = (GALGAS_" ;
result << operand_4749->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << "] ;\n"
...
result << ", GALGAS_" ;
result << operand_4749->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5197 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5197 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5197 = enumerator_5197.nextObject ()))) {
macroValidPointer (operand_5197) ;
result << "GALGAS_" ;
result << operand_5197->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
result << " * & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5420 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5420 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_5663 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5663 = NULL ;
while (((operand_5663 = enumerator_5663.nextObject ()))) {
macroValidPointer (operand_5663) ;
result << "NULL" ;
if (enumerator_5663.hasNextObject ()) {
result << ", " ;
}
}
result << "} ;\n"
  "  removeGreatestObject (attributeArray, inCompiler COMMA_THERE) ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5807 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5807 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5807 = enumerator_5807.nextObject ()))) {
macroValidPointer (operand_5807) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << " = (GALGAS_" ;
result << operand_5807->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << "] ;\n"
  "  macroNullOrValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_5807->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6250 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6250 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6250 = enumerator_6250.nextObject ()))) {
macroValidPointer (operand_6250) ;
result << "GALGAS_" ;
result << operand_6250->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
result << " * & outOperand" ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_6706 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6706 = NULL ;
...
GGS_typedAttributeList::cEnumerator enumerator_6855 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6855 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6855 = enumerator_6855.nextObject ()))) {
macroValidPointer (operand_6855) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << " = (GALGAS_" ;
result << operand_6855->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << "] ;\n"
  "  macroNullOrValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_6855->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7298 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7298 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7298 = enumerator_7298.nextObject ()))) {
macroValidPointer (operand_7298) ;
result << "GALGAS_" ;
result << operand_7298->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
result << " * & outOperand" ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_7754 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7754 = NULL ;
while (((operand_7754 = enumerator_7754.nextObject ()))) {
macroValidPointer (operand_7754) ;
result << "NULL" ;
if (enumerator_7754.hasNextObject ()) {
result << ", " ;
}
}
result << "} ;\n"
  "  greatestObjectAttributeList (attributeArray, inCompiler COMMA_THERE) ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7903 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7903 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7903 = enumerator_7903.nextObject ()))) {
macroValidPointer (operand_7903) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
result << " = (GALGAS_" ;
result << operand_7903->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
result << "] ;\n"
  "  macroNullOrValidObjectThere (outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
result << ", GALGAS_" ;
result << operand_7903->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5078 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5078 = NULL ;
while (((operand_5078 = enumerator_5078.nextObject ()))) {
macroValidPointer (operand_5078) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5078->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5078->mSignature, operand_5078->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (135)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5499 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5499 = NULL ;
while (((operand_5499 = enumerator_5499.nextObject ()))) {
macroValidPointer (operand_5499) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5499->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5499->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5499->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
