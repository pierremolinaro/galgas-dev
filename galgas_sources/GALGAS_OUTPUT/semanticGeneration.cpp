...
result << " : public C_SharedObject {\n"
  "//--- Attributes\n" ;
GGS_typedAttributeList::cEnumerator enumerator_512 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_512 = NULL ;
while (((operand_512 = enumerator_512.nextObject ()))) {
macroValidPointer (operand_512) ;
result << "  protected : GALGAS_" ;
result << operand_512->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (11)) ;
result << " mAttribute_" ;
result << operand_512->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "//--- Constructor\n"
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_759 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_759 = NULL ;
while (((operand_759 = enumerator_759.nextObject ()))) {
macroValidPointer (operand_759) ;
result << "const GALGAS_" ;
result << operand_759->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (17)) ;
result << " & in_" ;
result << operand_759->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_759.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << ") ;\n" ;
GGS_abstractMethodDefinitionListForGeneration::cEnumerator enumerator_1055 (var_cas_ABSTRACT_METHOD_LIST, true) ;
const GGS_abstractMethodDefinitionListForGeneration::cElement * operand_1055 = NULL ;
while (((operand_1055 = enumerator_1055.nextObject ()))) {
macroValidPointer (operand_1055) ;
result << "//--- Abstract method " ;
result << operand_1055->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (28)) ;
result << "\n"
  "  private : virtual void method_" ;
result << operand_1055->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_1213 (operand_1055->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_1213 = NULL ;
while (((operand_1213 = enumerator_1213.nextObject ()))) {
macroValidPointer (operand_1213) ;
if ((operand_1213->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (31))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_1213->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
result << " & " ;
}else if ((operand_1213->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (33))).boolValue ()) {
result << "GALGAS_" ;
result << operand_1213->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (34)) ;
result << " & " ;
}else if ((operand_1213->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (35))).boolValue ()) {
result << "GALGAS_" ;
result << operand_1213->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
result << " & " ;
}else if ((operand_1213->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (37))).boolValue ()) {
result << "GALGAS_" ;
result << operand_1213->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
result << " " ;
}else {
}
result << operand_1213->mFormalArgumentCppName ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
result << "C_Compiler * inCompiler\n" ;
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_2028 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_2028 = NULL ;
while (((operand_2028 = enumerator_2028.nextObject ()))) {
macroValidPointer (operand_2028) ;
result << "//--- Concrete method " ;
result << operand_2028->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
result << "\n"
  "  private : virtual void method_" ;
result << operand_2028->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_2186 (operand_2028->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_2186 = NULL ;
while (((operand_2186 = enumerator_2186.nextObject ()))) {
macroValidPointer (operand_2186) ;
if ((operand_2186->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_2186->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
result << " & " ;
}else if ((operand_2186->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (52))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2186->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
result << " & " ;
}else if ((operand_2186->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (54))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2186->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
result << " & " ;
}else if ((operand_2186->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (56))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2186->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
result << " " ;
}else {
}
result << operand_2186->mFormalArgumentCppName ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
result << "C_Compiler * inCompiler\n" ;
...
result << " (void) ;\n"
  "\n"
  "//--- Constructor for reverse polymorphic assignement\n"
  "  public : GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " (const GALGAS_" ;
...
GGS_typedAttributeList::cEnumerator enumerator_1711 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1711 = NULL ;
while (((operand_1711 = enumerator_1711.nextObject ()))) {
macroValidPointer (operand_1711) ;
result << "  if (kOperandEqual == result) {\n"
  "    result = mObjectPtr->mAttribute_" ;
result << operand_1711->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3038 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3038 = NULL ;
while (((operand_3038 = enumerator_3038.nextObject ()))) {
macroValidPointer (operand_3038) ;
result << "const GALGAS_" ;
result << operand_3038->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
result << " & inAttribute_" ;
result << operand_3038->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3038.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << " result ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_3399 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3399 = NULL ;
while (((operand_3399 = enumerator_3399.nextObject ()))) {
macroValidPointer (operand_3399) ;
result << "inAttribute_" ;
result << operand_3399->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
if (enumerator_3399.hasNextObject ()) {
result << " && " ;
}
}
result << ") {\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_3615 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3615 = NULL ;
while (((operand_3615 = enumerator_3615.nextObject ()))) {
macroValidPointer (operand_3615) ;
result << "inAttribute_" ;
result << operand_3615->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3615.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
result << "const PMSInt32 /* inIndentation */) const {\n"
  ...
  "           << typeDescriptor ()->mGalgasTypeName\n"
  "           << \":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4175 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4175 = NULL ;
while (((operand_4175 = enumerator_4175.nextObject ()))) {
macroValidPointer (operand_4175) ;
result << "//  mAttribute_" ;
result << operand_4175->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "->description (ioString, inIndentation + 1) ;\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4785 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4785 = NULL ;
while (((operand_4785 = enumerator_4785.nextObject ()))) {
macroValidPointer (operand_4785) ;
result << "mObjectPtr->mAttribute_" ;
result << operand_4785->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_4785.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5048 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5048 = NULL ;
while (((operand_5048 = enumerator_5048.nextObject ()))) {
macroValidPointer (operand_5048) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5048->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5048->mSignature, operand_5048->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (133)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5463 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5463 = NULL ;
while (((operand_5463 = enumerator_5463.nextObject ()))) {
macroValidPointer (operand_5463) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5463->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5463->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_5463->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    result = mObjectPtr->mAttribute_" ;
result << operand_5463->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_6011 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6011 = NULL ;
while (((operand_6011 = enumerator_6011.nextObject ()))) {
macroValidPointer (operand_6011) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6011->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_6011->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
  "    mObjectPtr->mAttribute_" ;
result << operand_6011->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6857 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6857 = NULL ;
while (((operand_6857 = enumerator_6857.nextObject ()))) {
macroValidPointer (operand_6857) ;
result << "const GALGAS_" ;
result << operand_6857->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
result << " & in_" ;
result << operand_6857->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_6857.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_7179 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7179 = NULL ;
while (((operand_7179 = enumerator_7179.nextObject ()))) {
macroValidPointer (operand_7179) ;
result << ",\n"
  "mAttribute_" ;
result << operand_7179->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_7179->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " *) ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_893 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_893 = NULL ;
while (((operand_893 = enumerator_893.nextObject ()))) {
macroValidPointer (operand_893) ;
result << "  if (kOperandEqual == result) {\n"
  "    result = p->mAttribute_" ;
result << operand_893->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1835 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1835 = NULL ;
while (((operand_1835 = enumerator_1835.nextObject ()))) {
macroValidPointer (operand_1835) ;
result << "const GALGAS_" ;
result << operand_1835->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (41)) ;
result << " & constinAttribute_" ;
result << operand_1835->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_2196 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2196 = NULL ;
while (((operand_2196 = enumerator_2196.nextObject ()))) {
macroValidPointer (operand_2196) ;
result << "constinAttribute_" ;
result << operand_2196->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_2196.hasNextObject ()) {
result << ", " ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_2422 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2422 = NULL ;
while (((operand_2422 = enumerator_2422.nextObject ()))) {
macroValidPointer (operand_2422) ;
result << ",\n"
  "mAttribute_" ;
result << operand_2422->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (constinAttribute_" ;
result << operand_2422->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3616 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3616 = NULL ;
while (((operand_3616 = enumerator_3616.nextObject ()))) {
macroValidPointer (operand_3616) ;
result << "const GALGAS_" ;
result << operand_3616->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
result << " & inAttribute_" ;
result << operand_3616->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3616.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4193 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4193 = NULL ;
while (((operand_4193 = enumerator_4193.nextObject ()))) {
macroValidPointer (operand_4193) ;
result << "inAttribute_" ;
result << operand_4193->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_4193.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
result << "const PMSInt32 /* inIndentation */) const {\n"
  ...
  "           << typeDescriptor ()->mGalgasTypeName\n"
  "           << \":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4753 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4753 = NULL ;
while (((operand_4753 = enumerator_4753.nextObject ()))) {
macroValidPointer (operand_4753) ;
result << "//  mAttribute_" ;
result << operand_4753->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "->description (ioString, inIndentation + 1) ;\n" ;
if (enumerator_4753.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \">\" ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5680 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5680 = NULL ;
while (((operand_5680 = enumerator_5680.nextObject ()))) {
macroValidPointer (operand_5680) ;
result << "p->mAttribute_" ;
result << operand_5680->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_5680.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5934 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5934 = NULL ;
while (((operand_5934 = enumerator_5934.nextObject ()))) {
macroValidPointer (operand_5934) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5934->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5934->mSignature, operand_5934->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (153)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_6348 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6348 = NULL ;
while (((operand_6348 = enumerator_6348.nextObject ()))) {
macroValidPointer (operand_6348) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_6348->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_6348->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_6348->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    const cPtr_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_7046 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7046 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_7046->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_7046->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
...
result << " *) ;\n"
  "    p->mAttribute_" ;
result << operand_7046->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8024 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8024 = NULL ;
while (((operand_8024 = enumerator_8024.nextObject ()))) {
macroValidPointer (operand_8024) ;
result << "const GALGAS_" ;
result << operand_8024->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
result << " & in_" ;
result << operand_8024->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_8024.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_8361 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8361 = NULL ;
while (((operand_8361 = enumerator_8361.nextObject ()))) {
macroValidPointer (operand_8361) ;
result << "in_" ;
result << operand_8361->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_8361.hasNextObject ()) {
result << ", " ;
}
}
if ((var_cas_INHERITED_ATTRIBUTE_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << ")" ;
GGS_typedAttributeList::cEnumerator enumerator_8579 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8579 = NULL ;
while (((operand_8579 = enumerator_8579.nextObject ()))) {
macroValidPointer (operand_8579) ;
result << ",\n"
  "mAttribute_" ;
result << operand_8579->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_8579->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_15989
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15989 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_16202
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16202 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_16202->mRoutineName, operand_16202->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_16529
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16529 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16529->mFunctionName, operand_16529->mFormalArgumentList, operand_16529->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (430))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_16897
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16897 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16897->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_16897->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (440))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17282
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17282 != NULL) {
const GGS_bool cond_17542 = operand_17282->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (447)) ;
if (cond_17542.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader1 (inLexique, operand_17282->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (449)), operand_17282->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (450)), operand_17282->mAllTypedAttributeList, operand_17282->mIsAbstract) ;
}else if (cond_17542.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader1 (inLexique, operand_17282->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), operand_17282->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), operand_17282->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)), operand_17282->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (459)), operand_17282->mAllTypedAttributeList, operand_17282->mIsAbstract) ;
}
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17282->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (465)), operand_17282->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_17282->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_17282->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (468)), operand_17282->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_17282->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_17282->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_17282->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_17282->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_17282->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_17282->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_17282->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (476)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_18503
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18503 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_18503->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (484)), operand_18503->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_18503->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18503->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), operand_18503->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_18503->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_18503->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_18503->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_18503->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18503->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18503->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18503->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18503->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_18503->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18503->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (500)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_19344
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19344 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_19344->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (508)), operand_19344->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), operand_19344->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19344->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (513)), operand_19344->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (514)), operand_19344->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (515)), operand_19344->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (516)), operand_19344->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_19344->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19344->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19344->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19344->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19344->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_19344->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19344->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (524)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_20186
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20186 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_20186->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), operand_20186->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (533)), operand_20186->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20186->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (537)), operand_20186->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_20186->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), operand_20186->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (540)), operand_20186->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (541)), operand_20186->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20186->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20186->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20186->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20186->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20186->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20186->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (548)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_21032
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21032 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_21032->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), operand_21032->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (557)), operand_21032->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21032->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (561)), operand_21032->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), operand_21032->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (563)), operand_21032->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), operand_21032->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_21032->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_21032->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_21032->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (568)), operand_21032->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_21032->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (570)), operand_21032->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), operand_21032->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (572)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_21878
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21878 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_21878->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (580)), operand_21878->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (581)), operand_21878->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21878->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (585)), operand_21878->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (586)), operand_21878->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), operand_21878->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (588)), operand_21878->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_21878->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_21878->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_21878->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_21878->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), operand_21878->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (594)), operand_21878->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_21878->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (596)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23026
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_23219
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23219 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_23219->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (614)), operand_23219->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (615)), operand_23219->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_23556
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23556 != NULL) {
const GGS_bool cond_23843 = operand_23556->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (623)) ;
if (cond_23843.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader2 (inLexique, operand_23556->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), operand_23556->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (626)), operand_23556->mAllTypedAttributeList, operand_23556->mAbstractMethodList, operand_23556->mMethodList) ;
}else if (cond_23843.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader2 (inLexique, operand_23556->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (633)), operand_23556->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (634)), operand_23556->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (635)), operand_23556->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (636)), operand_23556->mTypedAttributeList, operand_23556->mAllTypedAttributeList, operand_23556->mIsAbstract, operand_23556->mAbstractMethodList, operand_23556->mMethodList) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_24780
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_25006
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25006 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_25006->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (661)), operand_25006->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (662)), operand_25006->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (663))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_25697
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_25919
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25919 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_listmapTypeSpecificImplementation (inLexique, operand_25919->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (682)), operand_25919->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (683)), operand_25919->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_26350
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26350 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_26350->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (692)), operand_26350->mTypedAttributeList, operand_26350->mInsertMethodList, operand_26350->mSearchMethodList, operand_26350->mRemoveMethodList, operand_26350->mHasInsertOrReplaceModifier, operand_26350->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_26835
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26835 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_26835->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (706)), operand_26835->mTypedAttributeList, operand_26835->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_27222
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27222 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_27222->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (716)), operand_27222->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (717)), operand_27222->mConstantList, operand_27222->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_27620
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27620 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapProxyTypeSpecificImplementation (inLexique, operand_27620->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (727)), operand_27620->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), operand_27620->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_27620->mAssociatedMapTypedAttributeList, operand_27620->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_28097
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28097 != NULL) {
const GGS_bool cond_28577 = operand_28097->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (738)) ;
if (cond_28577.isBuiltAndTrue ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_rootClassTypeSpecificImplementation (inLexique, operand_28097->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (740)), operand_28097->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (741)), operand_28097->mTypedAttributeList, operand_28097->mAllTypedAttributeList, operand_28097->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28097->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28097->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)), operand_28097->mIsAbstract, operand_28097->mAbstractMethodList, operand_28097->mMethodList) ;
}else if (cond_28577.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_inheritedClassTypeSpecificImplementation (inLexique, operand_28097->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (751)), operand_28097->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (752)), operand_28097->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (753)), operand_28097->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_28097->mTypedAttributeList, operand_28097->mAllTypedAttributeList, operand_28097->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28097->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28097->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (757)), operand_28097->mIsAbstract, operand_28097->mAbstractMethodList, operand_28097->mMethodList) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_29259
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29259 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_29259->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (769)), operand_29259->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (770)), operand_29259->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_29639
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29639 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_29639->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (779)), operand_29639->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (780)), operand_29639->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_30030
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30030 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_30030->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_30030->mRoutineName.reader_identifierRepresentation ()), operand_30030->mFormalArgumentList, operand_30030->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (790))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_30667
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30667 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_30667->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_30667->mFunctionName.reader_identifierRepresentation ()), operand_30667->mFormalArgumentList, operand_30667->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_30667->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (812)), operand_30667->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (807)), operand_30667->mFormalArgumentList, operand_30667->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (816))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_31290
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31290 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_31290->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_31290->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31290->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_31290->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (830)), operand_31290->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (825)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31290->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (834))) ;
  }
  return var_cas_outImplementation ;
}
