...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5376 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5376 = NULL ;
while (((operand_5376 = enumerator_5376.nextObject ()))) {
macroValidPointer (operand_5376) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_" ;
result << operand_5376->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_5576 (operand_5376->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_5576 = NULL ;
while (((operand_5576 = enumerator_5576.nextObject ()))) {
macroValidPointer (operand_5576) ;
if ((operand_5576->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (139))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5576->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
result << " * const inArgument_" ;
result << operand_5576->mFormalArgumentName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}else if ((operand_5576->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (141))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5576->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
result << " * & ioArgument_" ;
result << operand_5576->mFormalArgumentName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}else if ((operand_5576->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (143))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5576->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) ;
result << " * & outArgument_" ;
result << operand_5576->mFormalArgumentName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "GALGAS_" ;
result << operand_5576->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (146)) ;
result << " * inArgument_" ;
result << operand_5576->mFormalArgumentName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if (operand_5376->mUsesCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
}else {
result << "C_Compiler * /* inCompiler */\n" ;
}
...
GGS_formalParameterListForGeneration::cEnumerator enumerator_6668 (operand_5376->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_6668 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6668 = enumerator_6668.nextObject ()))) {
macroValidPointer (operand_6668) ;
if ((operand_6668->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (157))).boolValue ()) {
result << "  macroRetainObject (inArgument_" ;
result << operand_6668->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
...
result << function_generateRoutineBody (inLexique, operand_5376->mInstructionList COMMA_SOURCE_FILE_AT_LINE (162)) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_7021 (operand_5376->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_7021 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7021 = enumerator_7021.nextObject ()))) {
macroValidPointer (operand_7021) ;
if ((operand_7021->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (165))).boolValue ()) {
result << "  macroReleaseObject (inArgument_" ;
result << operand_7021->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
...
GGS_typedAttributeList::cEnumerator enumerator_7311 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7311 = NULL ;
while (((operand_7311 = enumerator_7311.nextObject ()))) {
macroValidPointer (operand_7311) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_7311->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_7311->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
