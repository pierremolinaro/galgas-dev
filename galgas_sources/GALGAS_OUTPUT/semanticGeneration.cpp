...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_13364 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_13364.isBuiltAndTrue ()) {
...
{
GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12335 (var_cas_decoratedDeclarationListForGeneration, true) ;
const GGS_semanticDeclarationListForGeneration::cElement * operand_12335 = NULL ;
while (((operand_12335 = enumerator_12335.nextObject ()))) {
  macroValidPointer (operand_12335) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12335->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12335->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
}
}
const GGS_bool cond_12702 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12702.isBuiltAndTrue ()) {
...
{
GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12894 (var_cas_decoratedDeclarationListForGeneration, true) ;
const GGS_semanticDeclarationListForGeneration::cElement * operand_12894 = NULL ;
while (((operand_12894 = enumerator_12894.nextObject ()))) {
  macroValidPointer (operand_12894) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12894->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12894->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (302)))) ;
var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12894->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12894->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (303)))) ;
}
}
const GGS_bool cond_13340 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).operator_isEqual (GGS_uint (0U)) ;
