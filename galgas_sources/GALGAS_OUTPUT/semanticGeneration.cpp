...
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_1574 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1574 = NULL ;
while (((operand_1574 = enumerator_1574.nextObject ()))) {
macroValidPointer (operand_1574) ;
result << "inAttribute_" ;
result << operand_1574->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1574.hasNextObject ()) {
result << ", " ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_1795 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1795 = NULL ;
while (((operand_1795 = enumerator_1795.nextObject ()))) {
macroValidPointer (operand_1795) ;
result << ",\n"
  "mAttribute_" ;
result << operand_1795->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (NULL)" ;
}
result << " {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_1928 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1928 = NULL ;
while (((operand_1928 = enumerator_1928.nextObject ()))) {
macroValidPointer (operand_1928) ;
result << "  macroAssignObject (mAttribute_" ;
result << operand_1928->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ", (GALGAS_" ;
result << operand_1928->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
result << " *) inAttribute_" ;
result << operand_1928->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ") ;\n" ;
}
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3247 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3247 = NULL ;
while (((operand_3247 = enumerator_3247.nextObject ()))) {
macroValidPointer (operand_3247) ;
result << "const GALGAS_" ;
result << operand_3247->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (73)) ;
result << " * inAttribute_" ;
result << operand_3247->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
result << "C_Compiler * /* inCompiler */\n" ;
...
result << " * result = NULL ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_3548 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3548 = NULL ;
while (((operand_3548 = enumerator_3548.nextObject ()))) {
macroValidPointer (operand_3548) ;
result << "(NULL != inAttribute_" ;
result << operand_3548->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_3754 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3754 = NULL ;
while (((operand_3754 = enumerator_3754.nextObject ()))) {
macroValidPointer (operand_3754) ;
result << "inAttribute_" ;
result << operand_3754->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "const PMSInt32 inIndentation) const {\n"
  ...
  "           << typeDescriptor ()->mGalgasTypeName\n"
  "           << \":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4304 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4304 = NULL ;
while (((operand_4304 = enumerator_4304.nextObject ()))) {
macroValidPointer (operand_4304) ;
result << "  mAttribute_" ;
result << operand_4304->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "->description (ioString, inIndentation + 1) ;\n" ;
if (enumerator_4304.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \">\" ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (void) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4686 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4686 = NULL ;
while (((operand_4686 = enumerator_4686.nextObject ()))) {
macroValidPointer (operand_4686) ;
result << "  macroReleaseObject (mAttribute_" ;
result << operand_4686->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ") ;\n" ;
}
result << "}\n"
  "\n" ;
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_4830 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_4830 = NULL ;
while (((operand_4830 = enumerator_4830.nextObject ()))) {
macroValidPointer (operand_4830) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_" ;
result << operand_4830->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_5030 (operand_4830->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_5030 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5030 = enumerator_5030.nextObject ()))) {
macroValidPointer (operand_5030) ;
if ((operand_5030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (119))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_5030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " * /* inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
result << " */" ;
}else if ((operand_5030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " * & /* ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (122)) ;
result << " */" ;
}else if ((operand_5030->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (123))).boolValue ()) {
result << "GALGAS_" ;
result << operand_5030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " * & /* outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " */" ;
}else {
result << "GALGAS_" ;
result << operand_5030->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
result << " * /* inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_5923 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5923 = NULL ;
while (((operand_5923 = enumerator_5923.nextObject ()))) {
macroValidPointer (operand_5923) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5923->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5923->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
...
result << operand_513->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (10)) ;
}else if ((operand_513->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (11))).boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_513->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
result << " * & ioArgument_" ;
result << operand_513->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
}else if ((operand_513->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (13))).boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_513->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
result << " * & outArgument_" ;
result << operand_513->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
}else {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_513->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
result << " * inArgument_" ;
result << operand_513->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_1442 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_1442 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1442 = enumerator_1442.nextObject ()))) {
macroValidPointer (operand_1442) ;
if ((operand_1442->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (24))).boolValue ()) {
result << "macroRetainObject (inArgument_" ;
result << operand_1442->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ;
result << ") ;\n" ;
}else {
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << function_generateRoutineBody (inLexique, var_cas_ROUTINE_INSTRUCTION_LIST COMMA_SOURCE_FILE_AT_LINE (29)) ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_1771 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_1771 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1771 = enumerator_1771.nextObject ()))) {
macroValidPointer (operand_1771) ;
if ((operand_1771->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (32))).boolValue ()) {
result << "macroReleaseObject (inArgument_" ;
result << operand_1771->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (33)) ;
result << ") ;\n" ;
}else {
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_7051
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_7263
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7263 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_routineDeclaration (inLexique, operand_7263->mRoutineName, operand_7263->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_7560
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7560 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_unifiedTypeHeader (inLexique, operand_7560->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (185)), operand_7560->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), operand_7560->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (187)), operand_7560->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (188)), operand_7560->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), operand_7560->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (190)), operand_7560->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (191)), operand_7560->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), operand_7560->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_7560->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (194)), operand_7560->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), operand_7560->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), operand_7560->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (197)), operand_7560->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), operand_7560->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), operand_7560->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (200)), operand_7560->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (201)), operand_7560->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (202))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_8467
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_8467 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_genericTypeHeader (inLexique, operand_8467->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (210)), operand_8467->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_9186
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9186 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_9412
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_9412 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_unifiedTypeImplementation (inLexique, operand_9412->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (230)), operand_9412->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)), operand_9412->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (232)), operand_9412->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (233)), operand_9412->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (234)), operand_9412->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (235)), operand_9412->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (236)), operand_9412->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (237)), operand_9412->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), operand_9412->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (239)), operand_9412->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (240)), operand_9412->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (241)), operand_9412->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (242)), operand_9412->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (243)), operand_9412->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (244))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_10233
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10233 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_10233->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), operand_10233->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), operand_10233->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_10923
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_10923 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_11147
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11147 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_11147->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (273)), operand_11147->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (274)), operand_11147->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (275)), operand_11147->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (276)), operand_11147->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (277))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_11640
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11640 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_11640->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (285)), operand_11640->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_11999
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_11999 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_11999->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (294)), operand_11999->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (295)), operand_11999->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_12428
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12428 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_12428->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (304)), operand_12428->mTypedAttributeList, operand_12428->mInsertMethodList, operand_12428->mSearchMethodList, operand_12428->mRemoveMethodList, operand_12428->mHasInsertOrReplaceModifier) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_12891
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_12891 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_12891->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (317)), operand_12891->mTypedAttributeList, operand_12891->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_13280
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13280 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_13280->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (327)), operand_13280->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (328)), operand_13280->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_13660
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_13660 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_13660->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (337)), operand_13660->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (338)), operand_13660->mConstantList, operand_13660->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_14058
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14058 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_14058->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (348)), operand_14058->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (349)), operand_14058->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (350)), operand_14058->mAssociatedMapTypedAttributeList, operand_14058->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_14533
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_14533 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_14533->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (360)), operand_14533->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (361)), ((operand_14533->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (362))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_14533->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (362)))), operand_14533->mTypedAttributeList, operand_14533->mAllTypedAttributeList, operand_14533->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_14533->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_14533->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (365)) COMMA_SOURCE_FILE_AT_LINE (365)), operand_14533->mIsAbstract, operand_14533->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_15191
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_15191 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_routineImplementation (inLexique, operand_15191->mRoutineName, operand_15191->mFormalArgumentList, operand_15191->mRoutineInstructionList) ;
  }
  return var_cas_outImplementation ;
}
