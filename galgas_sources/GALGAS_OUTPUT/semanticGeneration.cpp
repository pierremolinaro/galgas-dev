...
if (operand_10274->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_16755 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_16755 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_16755 = enumerator_16755.nextObject ()))) {
macroValidPointer (operand_16755) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_16755->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_17128 (var_cas_MINUS_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_17128 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_17128 = enumerator_17128.nextObject ()))) {
macroValidPointer (operand_17128) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_17128->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (418)) ;
result << " * inOperand" ;
...
result << "\n"
  ...
  "\n"
  "//--------------------------------- Private data member\n" ;
GGS_nativeAttributeList::cEnumerator enumerator_18208 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_18208 = NULL ;
while (((operand_18208 = enumerator_18208.nextObject ()))) {
macroValidPointer (operand_18208) ;
result << "  private : " ;
if (operand_18208->mIsPointer.boolValue ()) {
result << "const " ;
}else {
}
result << operand_18208->mCppClassName ;
result << " " ;
if (operand_18208->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_18208->mAttributeName ;
result << " ;\n" ;
if ((operand_18208->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_18208->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_18599 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_18599 = NULL ;
while (((operand_18599 = enumerator_18599.nextObject ()))) {
macroValidPointer (operand_18599) ;
result << "  protected : GALGAS_" ;
result << operand_18599->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (449)) ;
result << " * mAttribute_" ;
result << operand_18599->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_18833 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_18833 = NULL ;
while (((operand_18833 = enumerator_18833.nextObject ()))) {
macroValidPointer (operand_18833) ;
result << "  friend void modifierCall_" ;
result << operand_18833->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_18970 (operand_18833->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18970 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18970 = enumerator_18970.nextObject ()))) {
macroValidPointer (operand_18970) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_18970->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (457))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_18970->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
}else if ((operand_18970->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (459))).boolValue ()) {
result << "GALGAS_" ;
result << operand_18970->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
}else if ((operand_18970->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (461))).boolValue ()) {
result << "GALGAS_" ;
result << operand_18970->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (462)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (462)) ;
}else {
result << "GALGAS_" ;
result << operand_18970->mParameterType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (464)) ;
result << " * inArgument" ;
...
if (operand_18833->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_readerMap::cEnumerator enumerator_19946 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_19946 = NULL ;
while (((operand_19946 = enumerator_19946.nextObject ()))) {
macroValidPointer (operand_19946) ;
if ((operand_19946->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (477))).boolValue ()) {
result << "  friend GALGAS_" ;
result << operand_19946->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (478)) ;
result << " * readerCall_" ;
result << operand_19946->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_20206 (operand_19946->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_20206 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20206 = enumerator_20206.nextObject ()))) {
macroValidPointer (operand_20206) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_20206->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_19946->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_21631 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_21631 = NULL ;
while (((operand_21631 = enumerator_21631.nextObject ()))) {
macroValidPointer (operand_21631) ;
result << "    public : const GALGAS_" ;
result << operand_21631->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (516)) ;
result << " * attribute_" ;
result << operand_21631->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
if (operand_6151->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_6151->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7057 (operand_6151->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_7057 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7057 = enumerator_7057.nextObject ()))) {
macroValidPointer (operand_7057) ;
result << "inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
if (enumerator_7057.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << " (THERE)" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7647 (operand_6151->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_7647 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7647 = enumerator_7647.nextObject ()))) {
macroValidPointer (operand_7647) ;
result << ", inOperand_" ;
...
result << "*\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_8204 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8204 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const GALGAS_" ;
result << operand_8204->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::cEnumerator::attribute_" ;
result << operand_8204->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const GALGAS_" ;
result << operand_8204->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
...
result << operand_8204->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
