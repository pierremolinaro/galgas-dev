...
result << operand_1839->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (46)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
result << "] = " ;
result << operand_1839->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "    result.internalMakeRegularProxyBySearchingKey (inMap, inKey, kSearchErrorMessage, inCompiler COMMA_THERE) ;\n"
  "  }\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_5062 = GGS_uint (2U) ;
if (indentation_5062.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_5062.uintValue ()) ;
}
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_5101 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_5101 = NULL ;
while (((operand_5101 = enumerator_5101.nextObject ()))) {
macroValidPointer (operand_5101) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "static const utf32 kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5101->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_5101->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (131)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
result << "] = " ;
result << operand_5101->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5614 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5614 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5614 = enumerator_5614.nextObject ()))) {
macroValidPointer (operand_5614) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5614->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) const {\n" ;
const GGS_uint indentation_6406 = GGS_uint (2U) ;
if (indentation_6406.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6406.uintValue ()) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_6242 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6242 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_6242->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_6446 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_6446 = NULL ;
while (((operand_6446 = enumerator_6446.nextObject ()))) {
macroValidPointer (operand_6446) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_6446->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_6682 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6682 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6682 = enumerator_6682.nextObject ()))) {
macroValidPointer (operand_6682) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6682->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (157)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_7541 = GGS_uint (2U) ;
if (indentation_7541.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_7541.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_6446->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (162)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
result << "] = " ;
result << operand_6446->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7377 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7377 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_7377->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7786 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7786 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7786 = enumerator_7786.nextObject ()))) {
macroValidPointer (operand_7786) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7786->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_8086 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8086 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8086 = enumerator_8086.nextObject ()))) {
macroValidPointer (operand_8086) ;
result << ", inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_8366->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_8366->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_8366->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_9365 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9365 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9365 = enumerator_9365.nextObject ()))) {
macroValidPointer (operand_9365) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_9365->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_9365->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_9365->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_10305 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_10305 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_10305->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_10305->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_10305->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (232))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << "::current_lkey (void) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11886 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11886 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11886 = enumerator_11886.nextObject ()))) {
macroValidPointer (operand_11886) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11886->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11886->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
...
result << ".forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;\n"
  "    }\n"
  "    result = f (inObject, " ;
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_3106 (var_cas_FORMAL_ARGUMENT_LIST, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_3106 = NULL ;
while (((operand_3106 = enumerator_3106.nextObject ()))) {
macroValidPointer (operand_3106) ;
result << "constin_" ;
result << operand_3106->mFormalArgumentName.ggs_string ().reader_identifierRepresentation () ;
result << ", " ;
}
result << "inCompiler COMMA_THERE) ;\n"
  "  }\n"
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_26939
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26939 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_27152
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27152 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_27152->mRoutineName, operand_27152->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_27479
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27479 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27479->mFunctionName, operand_27479->mFormalArgumentList, operand_27479->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (703))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_27847
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27847 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27847->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_27847->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (713))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_28232
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28232 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_28232->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (721)), operand_28232->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (722)), ((operand_28232->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (723))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_28232->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (723)))), operand_28232->mAllTypedAttributeList, operand_28232->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_28232->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), operand_28232->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_28232->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (730)), operand_28232->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (731)), operand_28232->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (732)), operand_28232->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (733)), operand_28232->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), operand_28232->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (735)), operand_28232->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (736)), operand_28232->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), operand_28232->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (738)), operand_28232->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (739)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_29177
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29177 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_29177->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), operand_29177->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (748)), operand_29177->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_29177->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (752)), operand_29177->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (753)), operand_29177->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_29177->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (755)), operand_29177->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (756)), operand_29177->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (757)), operand_29177->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (758)), operand_29177->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (759)), operand_29177->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_29177->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_29177->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_29177->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (763)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_30018
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30018 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_30018->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_30018->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (772)), operand_30018->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30018->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (776)), operand_30018->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (777)), operand_30018->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (778)), operand_30018->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (779)), operand_30018->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (780)), operand_30018->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), operand_30018->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), operand_30018->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), operand_30018->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (784)), operand_30018->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_30018->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), operand_30018->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (787)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_30860
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30860 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_30860->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), operand_30860->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (796)), operand_30860->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30860->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (800)), operand_30860->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), operand_30860->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (802)), operand_30860->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (803)), operand_30860->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (804)), operand_30860->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (805)), operand_30860->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (806)), operand_30860->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (807)), operand_30860->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_30860->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), operand_30860->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), operand_30860->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (811)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_31706
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31706 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_31706->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), operand_31706->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), operand_31706->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31706->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (824)), operand_31706->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), operand_31706->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (826)), operand_31706->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), operand_31706->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (828)), operand_31706->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (829)), operand_31706->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (830)), operand_31706->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (831)), operand_31706->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (832)), operand_31706->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (833)), operand_31706->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (834)), operand_31706->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_32552
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_32552 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_32552->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (843)), operand_32552->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), operand_32552->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_32552->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (848)), operand_32552->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), operand_32552->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_32552->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (851)), operand_32552->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (852)), operand_32552->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), operand_32552->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (854)), operand_32552->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (855)), operand_32552->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (856)), operand_32552->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (857)), operand_32552->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (858)), operand_32552->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (859)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapProxyTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_33390
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_33390 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapProxyTypeHeader1 (inLexique, operand_33390->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), operand_33390->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (868))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_33390->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (871)), operand_33390->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (872)), operand_33390->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (873)), operand_33390->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (874)), operand_33390->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (875)), operand_33390->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (876)), operand_33390->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (877)), operand_33390->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (878)), operand_33390->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (879)), operand_33390->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (880)), operand_33390->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (881)), operand_33390->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (882)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_34361 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_34361 = NULL ;
while (((operand_34361 = enumerator_34361.nextObject ()))) {
  macroValidPointer (operand_34361) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (894))) ;
}
}
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_34502 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_34502 = NULL ;
while (((operand_34502 = enumerator_34502.nextObject ()))) {
  macroValidPointer (operand_34502) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_34502->mInfo.mRegularFileMap,  operand_34502->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (897)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_34809
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34809 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_34809->mFilewrapperFileMap,  operand_34809->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (909)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_34809->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_35233 (operand_34809->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_35233 = NULL ;
while (((operand_35233 = enumerator_35233.nextObject ()))) {
  macroValidPointer (operand_35233) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_34809->mFilewrapperName, operand_35233->mFilewrapperTemplateName, operand_35233->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_35627
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35627 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_35627->mTypeName, operand_35627->mAbstractCategoryMethodName, operand_35627->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_36008
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36008 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_36008->mTypeName, operand_36008->mCategoryMethodName, operand_36008->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_36373
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36373 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderDeclaration (inLexique, operand_36373->mTypeName, operand_36373->mAbstractCategoryReaderName, operand_36373->mAbstractCategoryReaderFormalParameterList, operand_36373->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_36771
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36771 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderDeclaration (inLexique, operand_36771->mTypeName, operand_36771->mCategoryReaderName, operand_36771->mCategoryReaderFormalParameterList, operand_36771->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_37453,
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_37684,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37684 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_37684->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (988)), operand_37684->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (989)), operand_37684->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_38059,
                                const GGS_string  var_cas_inOutputDirectory
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_38059 != NULL) {
const GGS_bool cond_39255 = operand_38059->mGenerateHeaderInSeparateFile ;
if (cond_39255.isBuiltAndTrue ()) {
const GGS_string var_cas_part1 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_38059->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), operand_38059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)), ((operand_38059->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1003))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38059->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)))), operand_38059->mTypedAttributeList, operand_38059->mAllTypedAttributeList, operand_38059->mIsAbstract, operand_38059->mAbstractMethodList, operand_38059->mMethodList) ;
const GGS_string var_cas_part2 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_38059->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1011)), operand_38059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)), ((operand_38059->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1013))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38059->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1013)))), operand_38059->mTypedAttributeList, operand_38059->mAllTypedAttributeList, operand_38059->mIsAbstract, operand_38059->mAbstractMethodList, operand_38059->mMethodList) ;
const GGS_string var_cas_headerFileName = ((GGS_string ("separateHeaderFor_")).operator_concat (operand_38059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1020)))).operator_concat (GGS_string (".h")) ;
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, var_cas_headerFileName, GGS_string ("//"), GGS_string ("\n"
  ...
  "\n"), var_cas_part2 COMMA_SOURCE_FILE_AT_LINE (1021)) ;
var_cas_outHeader = ((GGS_string ("#include \"")).operator_concat (var_cas_headerFileName)).operator_concat (GGS_string ("\"\n"
  "\n")) ;
}else if (cond_39255.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_38059->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)), operand_38059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1034)), ((operand_38059->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1035))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38059->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1035)))), operand_38059->mTypedAttributeList, operand_38059->mAllTypedAttributeList, operand_38059->mIsAbstract, operand_38059->mAbstractMethodList, operand_38059->mMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_38059->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1043)), operand_38059->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1044)), ((operand_38059->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1045))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38059->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1045)))), operand_38059->mTypedAttributeList, operand_38059->mAllTypedAttributeList, operand_38059->mIsAbstract, operand_38059->mAbstractMethodList, operand_38059->mMethodList)) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_40545
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40545 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_CompilerEx & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_40771
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40771 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_40771->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)), operand_40771->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)), operand_40771->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1072)), operand_40771->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1073))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_41502
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41502 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_41724
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41724 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_41724->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1093)), operand_41724->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1094)), operand_41724->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_42225
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42225 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_42225->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1104)), operand_42225->mTypedAttributeList, operand_42225->mInsertMethodList, operand_42225->mSearchMethodList, operand_42225->mRemoveMethodList, operand_42225->mHasInsertOrReplaceModifier, operand_42225->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_42778
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42778 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_42778->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)), operand_42778->mTypedAttributeList, operand_42778->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_43241
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43241 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_43241->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), operand_43241->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)), operand_43241->mConstantList, operand_43241->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_43708
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43708 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_43708->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)), operand_43708->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)), operand_43708->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1144)), operand_43708->mAssociatedMapTypedAttributeList, operand_43708->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_44256
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44256 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_44256->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)), operand_44256->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)), ((operand_44256->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_44256->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1157)))), operand_44256->mTypedAttributeList, operand_44256->mAllTypedAttributeList, operand_44256->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_44256->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_44256->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)), operand_44256->mIsAbstract, operand_44256->mAbstractMethodList, operand_44256->mMethodList, operand_44256->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_45016
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45016 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_45016->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1173)), operand_45016->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)), operand_45016->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_45467
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45467 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_45467->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1184)), operand_45467->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), operand_45467->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_45927
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45927 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_45927->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_45927->mRoutineName.reader_identifierRepresentation ()), operand_45927->mFormalArgumentList, operand_45927->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1196))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_46646
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46646 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_46646->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_46646->mFunctionName.reader_identifierRepresentation ()), operand_46646->mFormalArgumentList, operand_46646->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_46646->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1219)), operand_46646->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1214)), operand_46646->mFormalArgumentList, operand_46646->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1224))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_47381
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47381 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_47381->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_47381->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_47381->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_47381->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)), operand_47381->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1234)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_47381->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1244))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_48176
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48176 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_48176->mTypeName, operand_48176->mAbstractCategoryMethodName, operand_48176->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_48669
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48669 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_48669->mTypeName, GGS_string (""), operand_48669->mCategoryMethodName, operand_48669->mCategoryMethodFormalParameterList, operand_48669->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1263)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_48669->mTypeName, operand_48669->mCategoryMethodName, operand_48669->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_49368
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49368 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_49368->mTypeName, operand_49368->mBaseTypeName, operand_49368->mCategoryMethodName, operand_49368->mCategoryMethodFormalParameterList, operand_49368->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1282)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_49368->mTypeName, operand_49368->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_50056
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50056 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderImplementation (inLexique, operand_50056->mTypeName, operand_50056->mAbstractCategoryReaderName, operand_50056->mAbstractCategoryReaderFormalParameterList, operand_50056->mResultType) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_50566
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50566 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_50566->mTypeName, GGS_string (""), operand_50566->mCategoryReaderName, operand_50566->mCategoryReaderFormalParameterList, operand_50566->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_50566->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)), operand_50566->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1312)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderImplementation (inLexique, operand_50566->mTypeName, operand_50566->mCategoryReaderName, operand_50566->mCategoryReaderFormalParameterList, operand_50566->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overrideCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overrideCategoryReaderForGeneration * operand_51340
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51340 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_51340->mTypeName, operand_51340->mBaseTypeName, operand_51340->mOverridingCategoryReaderName, operand_51340->mOverridingCategoryReaderFormalParameterList, operand_51340->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_51340->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1342)), operand_51340->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1335)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryReaderImplementation (inLexique, operand_51340->mTypeName, operand_51340->mOverridingCategoryReaderName, operand_51340->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_52382 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_52382 = NULL ;
while (((operand_52382 = enumerator_52382.nextObject ()))) {
  macroValidPointer (operand_52382) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_52382->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1365)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_52382->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_52382->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1368))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_52382->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1371))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_52382->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_52382->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_52382->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1375))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_53224 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_53224 = NULL ;
while (((operand_53224 = enumerator_53224.nextObject ()))) {
  macroValidPointer (operand_53224) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_53224->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)),  operand_53224->mInfo.mWrapperDirectoryIndex,  operand_53224->mInfo.mRegularFileMap,  operand_53224->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1380)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1392))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1393)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1393))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_53812 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_53812 = NULL ;
while (((operand_53812 = enumerator_53812.nextObject ()))) {
  macroValidPointer (operand_53812) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_53812->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1395))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1403)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1403))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_54423 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_54423 = NULL ;
...
var_cas_ioImplementation.dotAssign_operation (operand_54423->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1411))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1415))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416))) ;
var_cas_ioImplementation.appendCString (",\n"
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_55538
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_55538 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_55538->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_55538->mFilewrapperFileMap,  operand_55538->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1425)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_55538->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_55997 (operand_55538->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_55997 = NULL ;
while (((operand_55997 = enumerator_55997.nextObject ()))) {
  macroValidPointer (operand_55997) ;
GGS_string var_cas_generatedCodeForInstructionList = GGS_string ("") ;
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1443))) ;
GGS_bool var_cas_useColumnMarker = GGS_bool (false) ;
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_55997->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1445)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_55538->mFilewrapperName, operand_55997->mFilewrapperTemplateName, operand_55997->mFilewrapperTemplateFormalInputParameters, (var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1457)))).operator_not (), var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
