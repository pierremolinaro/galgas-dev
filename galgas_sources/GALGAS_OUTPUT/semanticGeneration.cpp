...
//                    september 24th, 2010, at 13h36'32"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_7445 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_7445 = NULL ;
while (((operand_7445 = enumerator_7445.nextObject ()))) {
macroValidPointer (operand_7445) ;
if ((operand_7445->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (176))).boolValue ()) {
result << "  protected : void modifier_" ;
result << operand_7445->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7603 (operand_7445->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7603 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7603 = enumerator_7603.nextObject ()))) {
macroValidPointer (operand_7603) ;
if ((operand_7603->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (179))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7603->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) ;
}else if ((operand_7603->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (181))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7603->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (182)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182)) ;
}else if ((operand_7603->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (183))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7603->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
}else {
result << "GALGAS_" ;
result << operand_7603->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
result << " inArgument" ;
...
if ((operand_7445->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7445->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8862 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8862 = NULL ;
while (((operand_8862 = enumerator_8862.nextObject ()))) {
macroValidPointer (operand_8862) ;
if ((operand_8862->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (212))).boolValue ()) {
result << "  protected : virtual void method_" ;
result << operand_8862->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9026 (operand_8862->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9026 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9026 = enumerator_9026.nextObject ()))) {
macroValidPointer (operand_9026) ;
if ((operand_9026->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9026->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
}else if ((operand_9026->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9026->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
}else if ((operand_9026->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9026->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
}else {
result << "GALGAS_" ;
result << operand_9026->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " inArgument" ;
...
if ((operand_8862->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8862->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if (((operand_8862->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (242)))).operator_or ((operand_8862->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (242)))).boolValue ()) {
result << "= 0 " ;
}else {
}
result << ";\n"
...
GGS_classMethodMap::cEnumerator enumerator_10425 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_10425 = NULL ;
while (((operand_10425 = enumerator_10425.nextObject ()))) {
macroValidPointer (operand_10425) ;
result << "  public : static void class_method_" ;
result << operand_10425->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10532 (operand_10425->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10532 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10532 = enumerator_10532.nextObject ()))) {
macroValidPointer (operand_10532) ;
if ((operand_10532->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (253))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10532->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
}else if ((operand_10532->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (255))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10532->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (256)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (256)) ;
}else if ((operand_10532->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (257))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10532->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
}else {
result << "GALGAS_" ;
result << operand_10532->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
}
if (enumerator_10532.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10425->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10425->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_11710 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_11710 = NULL ;
while (((operand_11710 = enumerator_11710.nextObject ()))) {
macroValidPointer (operand_11710) ;
if (((operand_11710->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (285)))).operator_and ((operand_11710->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (285)))).boolValue ()) {
result << "  protected : virtual GALGAS_" ;
result << operand_11710->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
result << " reader_" ;
result << operand_11710->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11985 (operand_11710->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_11985 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11985 = enumerator_11985.nextObject ()))) {
macroValidPointer (operand_11985) ;
result << "const GALGAS_" ;
result << operand_11985->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) ;
if (enumerator_11985.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11710->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11710->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if ((operand_11710->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).boolValue ()) {
result << " = 0" ;
}else {
}
result << " const ;\n"
...
GGS_withAccessorMap::cEnumerator enumerator_13648 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13648 = NULL ;
...
result << operand_13648->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_13648->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (335)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14425 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14425 = NULL ;
while (((operand_14425 = enumerator_14425.nextObject ()))) {
macroValidPointer (operand_14425) ;
result << "    public : GALGAS_" ;
result << operand_14425->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (351)) ;
result << " attribute_" ;
result << operand_14425->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14930 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14930 = NULL ;
while (((operand_14930 = enumerator_14930.nextObject ()))) {
macroValidPointer (operand_14930) ;
result << "cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_14930->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14930->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (369)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17855
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_18067
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18067 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_18067->mRoutineName, operand_18067->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_18393
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18393 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_18393->mFunctionName, operand_18393->mFormalArgumentList, operand_18393->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (455))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_18760
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18760 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_18760->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_18760->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_19147
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19147 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplateEX_unifiedTypeHeader (inLexique, operand_19147->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_19147->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_19147->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_19147->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_19147->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_19147->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (478)), operand_19147->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (479)), operand_19147->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (480)), operand_19147->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (481)), operand_19147->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), operand_19147->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), operand_19147->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (484)), operand_19147->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_19147->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), operand_19147->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (487)), operand_19147->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), operand_19147->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), operand_19147->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_19147->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (491))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_20091
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20091 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplateEX_genericTypeHeader (inLexique, operand_20091->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_20091->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (500))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_20736
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20736 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_20949
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20949 != NULL) {
const GGS_bool cond_21041 = (operand_20949->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (517))).operator_isEqual (GGS_string ("object")) ;
if (cond_21041.isBuiltAndTrue ()) {
var_cas_outHeader = GGS_string ("") ;
}else if (cond_21041.isBuiltAndFalse ()) {
const GGS_bool cond_21925 = ((operand_20949->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (519))).operator_and (function_autoBoxing (inLexique COMMA_SOURCE_FILE_AT_LINE (519)))).operator_isNotEqual (GGS_uint (0U)) ;
if (cond_21925.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplateEX_autoBoxingClassHeader (inLexique, operand_20949->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_20949->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_20949->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_20949->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_20949->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_20949->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_20949->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_20949->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (528)), operand_20949->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (529)), operand_20949->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (530)), operand_20949->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), operand_20949->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), operand_20949->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (533)), operand_20949->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (534)), operand_20949->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), operand_20949->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_20949->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (537)), operand_20949->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_20949->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (539))) ;
}else if (cond_21925.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplateEX_autoPointerClassHeader (inLexique, operand_20949->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20949->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20949->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20949->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20949->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20949->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20949->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), operand_20949->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (550)), operand_20949->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (551)), operand_20949->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (552)), operand_20949->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), operand_20949->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (554)), operand_20949->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (555)), operand_20949->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), operand_20949->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (557)), operand_20949->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (558)), operand_20949->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (559)), operand_20949->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (560)), operand_20949->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (561))) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__semanticDeclarationForGeneration__appendSpecificDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23223
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23223 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendSpecificDeclaration (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_23423
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23423 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplateEX_mapTypeSpecificDeclaration (inLexique, operand_23423->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (580)), operand_23423->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_24084
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_24316
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24316 != NULL) {
const GGS_bool cond_24424 = (operand_24316->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (599))).operator_isEqual (GGS_string ("object")) ;
if (cond_24424.isBuiltAndTrue ()) {
var_cas_outImplementation = GGS_string ("") ;
}else if (cond_24424.isBuiltAndFalse ()) {
const GGS_bool cond_24837 = ((operand_24316->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (601))).operator_and (function_autoBoxing (inLexique COMMA_SOURCE_FILE_AT_LINE (601)))).operator_isEqual (GGS_uint (0U)) ;
if (cond_24837.isBuiltAndTrue ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_autoPointerClassImplementation (inLexique, operand_24316->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (603)), operand_24316->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (604)), operand_24316->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (605)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (605)), operand_24316->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (606)), operand_24316->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (607)), operand_24316->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (608))) ;
}else if (cond_24837.isBuiltAndFalse ()) {
var_cas_outImplementation = GGS_string ("") ;
}
}
  }
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_25434
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25434 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_25660
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25660 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_unifiedTypeImplementation (inLexique, operand_25660->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), operand_25660->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (631)), operand_25660->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (632)), operand_25660->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (633)), operand_25660->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (634)), operand_25660->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (635)), operand_25660->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (636)), operand_25660->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (637)), operand_25660->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (638)), operand_25660->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (639)), operand_25660->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (640)), operand_25660->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (641)), operand_25660->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (642)), operand_25660->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (643)), operand_25660->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (644))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_26483
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26483 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_genericTypeImplementation (inLexique, operand_26483->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (653)), operand_26483->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (654)), operand_26483->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (655))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_27175
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_27399
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27399 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_predefinedTypeSpecificImplementation (inLexique, operand_27399->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (673)), operand_27399->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (674)), operand_27399->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (675)), operand_27399->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (676)), operand_27399->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (677))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_27894
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27894 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_27894->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (685)), operand_27894->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_28253
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28253 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_listmapTypeSpecificImplementation (inLexique, operand_28253->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (694)), operand_28253->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (695)), operand_28253->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_28684
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28684 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapTypeSpecificImplementation (inLexique, operand_28684->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), operand_28684->mTypedAttributeList, operand_28684->mInsertMethodList, operand_28684->mSearchMethodList, operand_28684->mRemoveMethodList, operand_28684->mHasInsertOrReplaceModifier, operand_28684->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_29171
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29171 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_sortedlistTypeSpecificImplementation (inLexique, operand_29171->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (718)), operand_29171->mTypedAttributeList, operand_29171->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_29562
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29562 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_29562->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), operand_29562->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_29562->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_29942
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29942 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_enumTypeSpecificImplementation (inLexique, operand_29942->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (738)), operand_29942->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), operand_29942->mConstantList, operand_29942->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_30342
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30342 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapProxyTypeSpecificImplementation (inLexique, operand_30342->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (749)), operand_30342->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (750)), operand_30342->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (751)), operand_30342->mAssociatedMapTypedAttributeList, operand_30342->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_30819
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30819 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_classTypeSpecificImplementation (inLexique, operand_30819->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_30819->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), ((operand_30819->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (763))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_30819->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (763)))), operand_30819->mTypedAttributeList, operand_30819->mAllTypedAttributeList, operand_30819->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_30819->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_30819->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (766)), operand_30819->mIsAbstract, operand_30819->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_31479
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31479 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_31479->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_31479->mRoutineName.reader_identifierRepresentation ()), operand_31479->mFormalArgumentList, operand_31479->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (777))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_32116
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32116 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_32116->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_32116->mFunctionName.reader_identifierRepresentation ()), operand_32116->mFormalArgumentList, operand_32116->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32116->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (799)), operand_32116->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (794)), operand_32116->mFormalArgumentList, operand_32116->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (803))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_32739
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32739 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_32739->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_32739->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32739->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32739->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (817)), operand_32739->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (812)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32739->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (821))) ;
  }
  return var_cas_outImplementation ;
}
