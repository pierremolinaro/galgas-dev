...
//                    november 10th, 2010, at 16h45'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3894->mInsertMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4136 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4136 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4136 = enumerator_4136.nextObject ()))) {
macroValidPointer (operand_4136) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4136->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
result << " inArgument" ;
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_4978 = GGS_uint (2U) ;
if (indentation_4978.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_4978.uintValue ()) ;
}
result << "const char * kInsertErrorMessage = " ;
result << operand_3894->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "const char * kShadowErrorMessage = " ;
result << operand_3894->mShadowErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_5017 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_5017 = NULL ;
while (((operand_5017 = enumerator_5017.nextObject ()))) {
macroValidPointer (operand_5017) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5017->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_5017->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5494 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5494 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5494 = enumerator_5494.nextObject ()))) {
macroValidPointer (operand_5494) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5494->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) const {\n" ;
const GGS_uint indentation_6351 = GGS_uint (2U) ;
if (indentation_6351.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6351.uintValue ()) ;
}
result << "const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " *) performSearch (inKey, inCompiler, kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5017->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " COMMA_THERE) ;\n"
  "if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5990 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5990 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5990 = enumerator_5990.nextObject ()))) {
macroValidPointer (operand_5990) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_6187 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6187 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6187 = enumerator_6187.nextObject ()))) {
macroValidPointer (operand_6187) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << " = p->mAttribute_" ;
result << operand_6187->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_6391 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_6391 = NULL ;
while (((operand_6391 = enumerator_6391.nextObject ()))) {
macroValidPointer (operand_6391) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_6391->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_6627 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6627 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6627 = enumerator_6627.nextObject ()))) {
macroValidPointer (operand_6627) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6627->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_7445 = GGS_uint (2U) ;
if (indentation_7445.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_7445.uintValue ()) ;
}
result << "const char * kRemoveErrorMessage = " ;
result << operand_6391->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7281 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7281 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7281 = enumerator_7281.nextObject ()))) {
macroValidPointer (operand_7281) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
result << " = p->mAttribute_" ;
result << operand_7281->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7690 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7690 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7690 = enumerator_7690.nextObject ()))) {
macroValidPointer (operand_7690) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7690->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7990 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7990 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
GGS_typedAttributeList::cEnumerator enumerator_8270 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8270 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8270 = enumerator_8270.nextObject ()))) {
macroValidPointer (operand_8270) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_8270->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_8270->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string & inKey,\n"
  "                                               " ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_8270->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_9269 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9269 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9269 = enumerator_9269.nextObject ()))) {
macroValidPointer (operand_9269) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_9269->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_9269->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_9269->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_10209 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_10209 = NULL ;
while (((operand_10209 = enumerator_10209.nextObject ()))) {
macroValidPointer (operand_10209) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_10209->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_10209->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_10209->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << "::current_lkey (void) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11790 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11790 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11790 = enumerator_11790.nextObject ()))) {
macroValidPointer (operand_11790) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11790->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11790->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_27123
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_27336
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27336 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_27336->mRoutineName, operand_27336->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_27663
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27663 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27663->mFunctionName, operand_27663->mFormalArgumentList, operand_27663->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (710))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_28031
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28031 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_28031->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_28031->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (720))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_28416
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28416 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_28416->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), operand_28416->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), ((operand_28416->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (730))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_28416->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (730)))), operand_28416->mAllTypedAttributeList, operand_28416->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_28416->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (735)), operand_28416->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (736)), operand_28416->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), operand_28416->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (738)), operand_28416->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), operand_28416->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (740)), operand_28416->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (741)), operand_28416->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (742)), operand_28416->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (743)), operand_28416->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (744)), operand_28416->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (745)), operand_28416->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (746)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_29361
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29361 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_29361->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_29361->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (755)), operand_29361->mTypedAttributeList, operand_29361->mSearchMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_29361->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_29361->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_29361->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_29361->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (763)), operand_29361->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), operand_29361->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (765)), operand_29361->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (766)), operand_29361->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (767)), operand_29361->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), operand_29361->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (769)), operand_29361->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (770)), operand_29361->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (771)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_30225
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30225 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_30225->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (779)), operand_30225->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (780)), operand_30225->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30225->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (784)), operand_30225->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_30225->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), operand_30225->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), operand_30225->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (788)), operand_30225->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (789)), operand_30225->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (790)), operand_30225->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (791)), operand_30225->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (792)), operand_30225->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (793)), operand_30225->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (794)), operand_30225->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (795)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_31067
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31067 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_31067->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (803)), operand_31067->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (804)), operand_31067->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31067->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_31067->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), operand_31067->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), operand_31067->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), operand_31067->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (812)), operand_31067->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (813)), operand_31067->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (814)), operand_31067->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (815)), operand_31067->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (816)), operand_31067->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (817)), operand_31067->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (818)), operand_31067->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (819)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listmapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_31910
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31910 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listmapTypeHeader1 (inLexique, operand_31910->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), operand_31910->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (828))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31910->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (831)), operand_31910->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (832)), operand_31910->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (833)), operand_31910->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (834)), operand_31910->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), operand_31910->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (836)), operand_31910->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (837)), operand_31910->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (838)), operand_31910->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (839)), operand_31910->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (840)), operand_31910->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (841)), operand_31910->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (842)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_32734
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_32734 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_32734->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_32734->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (851)), operand_32734->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_32734->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (855)), operand_32734->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (856)), operand_32734->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (857)), operand_32734->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (858)), operand_32734->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (859)), operand_32734->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (860)), operand_32734->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (861)), operand_32734->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (862)), operand_32734->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (863)), operand_32734->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (864)), operand_32734->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (865)), operand_32734->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (866)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_33580
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_33580 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_33580->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (874)), operand_33580->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (875)), operand_33580->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_33580->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (879)), operand_33580->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (880)), operand_33580->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (881)), operand_33580->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (882)), operand_33580->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (883)), operand_33580->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (884)), operand_33580->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (885)), operand_33580->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (886)), operand_33580->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (887)), operand_33580->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (888)), operand_33580->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (889)), operand_33580->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (890)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapProxyTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_34418
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34418 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapProxyTypeHeader1 (inLexique, operand_34418->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (898)), operand_34418->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (899))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_34418->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (902)), operand_34418->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (903)), operand_34418->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (904)), operand_34418->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (905)), operand_34418->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (906)), operand_34418->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (907)), operand_34418->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (908)), operand_34418->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (909)), operand_34418->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (910)), operand_34418->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (911)), operand_34418->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (912)), operand_34418->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (913)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_35389 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_35389 = NULL ;
while (((operand_35389 = enumerator_35389.nextObject ()))) {
  macroValidPointer (operand_35389) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (925))) ;
}
}
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_35530 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_35530 = NULL ;
while (((operand_35530 = enumerator_35530.nextObject ()))) {
  macroValidPointer (operand_35530) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_35530->mInfo.mRegularFileMap,  operand_35530->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (928)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_35837
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35837 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_35837->mFilewrapperFileMap,  operand_35837->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (940)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_35837->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_36261 (operand_35837->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_36261 = NULL ;
while (((operand_36261 = enumerator_36261.nextObject ()))) {
  macroValidPointer (operand_36261) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_35837->mFilewrapperName, operand_36261->mFilewrapperTemplateName, operand_36261->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_36655
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36655 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_36655->mTypeName, operand_36655->mAbstractCategoryMethodName, operand_36655->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_37036
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37036 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_37036->mTypeName, operand_37036->mCategoryMethodName, operand_37036->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_37401
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37401 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderDeclaration (inLexique, operand_37401->mTypeName, operand_37401->mAbstractCategoryReaderName, operand_37401->mAbstractCategoryReaderFormalParameterList, operand_37401->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_37799
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37799 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderDeclaration (inLexique, operand_37799->mTypeName, operand_37799->mCategoryReaderName, operand_37799->mCategoryReaderFormalParameterList, operand_37799->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_38481,
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_38712,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_38712 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_38712->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)), operand_38712->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1020)), operand_38712->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_39087,
                                const GGS_string  var_cas_inOutputDirectory
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_39087 != NULL) {
const GGS_bool cond_40283 = operand_39087->mGenerateHeaderInSeparateFile ;
if (cond_40283.isBuiltAndTrue ()) {
const GGS_string var_cas_part1 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_39087->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1032)), operand_39087->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)), ((operand_39087->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1034))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_39087->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1034)))), operand_39087->mTypedAttributeList, operand_39087->mAllTypedAttributeList, operand_39087->mIsAbstract, operand_39087->mAbstractMethodList, operand_39087->mMethodList) ;
const GGS_string var_cas_part2 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_39087->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)), operand_39087->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1043)), ((operand_39087->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1044))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_39087->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1044)))), operand_39087->mTypedAttributeList, operand_39087->mAllTypedAttributeList, operand_39087->mIsAbstract, operand_39087->mAbstractMethodList, operand_39087->mMethodList) ;
const GGS_string var_cas_headerFileName = ((GGS_string ("separateHeaderFor_")).operator_concat (operand_39087->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1051)))).operator_concat (GGS_string (".h")) ;
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, var_cas_headerFileName, GGS_string ("//"), GGS_string ("\n"
  ...
  "\n"), var_cas_part2 COMMA_SOURCE_FILE_AT_LINE (1052)) ;
var_cas_outHeader = ((GGS_string ("#include \"")).operator_concat (var_cas_headerFileName)).operator_concat (GGS_string ("\"\n"
  "\n")) ;
}else if (cond_40283.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_39087->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1064)), operand_39087->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1065)), ((operand_39087->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1066))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_39087->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)))), operand_39087->mTypedAttributeList, operand_39087->mAllTypedAttributeList, operand_39087->mIsAbstract, operand_39087->mAbstractMethodList, operand_39087->mMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_39087->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)), operand_39087->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1075)), ((operand_39087->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1076))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_39087->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)))), operand_39087->mTypedAttributeList, operand_39087->mAllTypedAttributeList, operand_39087->mIsAbstract, operand_39087->mAbstractMethodList, operand_39087->mMethodList)) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_41573
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41573 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_CompilerEx & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_41799
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41799 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_41799->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)), operand_41799->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1102)), operand_41799->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)), operand_41799->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1104))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_42530
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42530 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_42752
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42752 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_42752->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1124)), operand_42752->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)), operand_42752->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_43253
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43253 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_43253->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)), operand_43253->mTypedAttributeList, operand_43253->mInsertMethodList, operand_43253->mSearchMethodList, operand_43253->mRemoveMethodList, operand_43253->mHasInsertOrReplaceModifier, operand_43253->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_43806
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43806 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_43806->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), operand_43806->mTypedAttributeList, operand_43806->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_44269
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44269 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_44269->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1161)), operand_44269->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1162)), operand_44269->mConstantList, operand_44269->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_44736
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44736 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_44736->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1173)), operand_44736->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)), operand_44736->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1175)), operand_44736->mAssociatedMapTypedAttributeList, operand_44736->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_45284
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45284 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_45284->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1186)), operand_45284->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)), ((operand_45284->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1188))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_45284->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1188)))), operand_45284->mTypedAttributeList, operand_45284->mAllTypedAttributeList, operand_45284->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_45284->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_45284->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1191)), operand_45284->mIsAbstract, operand_45284->mAbstractMethodList, operand_45284->mMethodList, operand_45284->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_46044
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46044 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_46044->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1204)), operand_46044->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)), operand_46044->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_46495
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46495 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_46495->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1215)), operand_46495->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1216)), operand_46495->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_46955
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46955 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_46955->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_46955->mRoutineName.reader_identifierRepresentation ()), operand_46955->mFormalArgumentList, operand_46955->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1227))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_47674
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47674 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_47674->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_47674->mFunctionName.reader_identifierRepresentation ()), operand_47674->mFormalArgumentList, operand_47674->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_47674->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1250)), operand_47674->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1245)), operand_47674->mFormalArgumentList, operand_47674->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1255))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_48409
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48409 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_48409->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_48409->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_48409->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_48409->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1270)), operand_48409->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1265)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_48409->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1275))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_49204
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49204 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_49204->mTypeName, operand_49204->mAbstractCategoryMethodName, operand_49204->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_49697
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49697 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_49697->mTypeName, GGS_string (""), operand_49697->mCategoryMethodName, operand_49697->mCategoryMethodFormalParameterList, operand_49697->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1294)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_49697->mTypeName, operand_49697->mCategoryMethodName, operand_49697->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_50396
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50396 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_50396->mTypeName, operand_50396->mBaseTypeName, operand_50396->mCategoryMethodName, operand_50396->mCategoryMethodFormalParameterList, operand_50396->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1313)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_50396->mTypeName, operand_50396->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_51084
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51084 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderImplementation (inLexique, operand_51084->mTypeName, operand_51084->mAbstractCategoryReaderName, operand_51084->mAbstractCategoryReaderFormalParameterList, operand_51084->mResultType) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_51594
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51594 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_51594->mTypeName, GGS_string (""), operand_51594->mCategoryReaderName, operand_51594->mCategoryReaderFormalParameterList, operand_51594->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_51594->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)), operand_51594->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1343)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderImplementation (inLexique, operand_51594->mTypeName, operand_51594->mCategoryReaderName, operand_51594->mCategoryReaderFormalParameterList, operand_51594->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overrideCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overrideCategoryReaderForGeneration * operand_52368
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_52368 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_52368->mTypeName, operand_52368->mBaseTypeName, operand_52368->mOverridingCategoryReaderName, operand_52368->mOverridingCategoryReaderFormalParameterList, operand_52368->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_52368->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)), operand_52368->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1366)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryReaderImplementation (inLexique, operand_52368->mTypeName, operand_52368->mOverridingCategoryReaderName, operand_52368->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_53410 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_53410 = NULL ;
while (((operand_53410 = enumerator_53410.nextObject ()))) {
  macroValidPointer (operand_53410) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_53410->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1396)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_53410->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_53410->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1399))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_53410->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_53410->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_53410->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_53410->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1406))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_54252 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_54252 = NULL ;
while (((operand_54252 = enumerator_54252.nextObject ()))) {
  macroValidPointer (operand_54252) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_54252->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)),  operand_54252->mInfo.mWrapperDirectoryIndex,  operand_54252->mInfo.mRegularFileMap,  operand_54252->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1411)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1423))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1424)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1424))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_54840 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_54840 = NULL ;
while (((operand_54840 = enumerator_54840.nextObject ()))) {
  macroValidPointer (operand_54840) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_54840->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1426))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1433))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1434)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_55451 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_55451 = NULL ;
...
var_cas_ioImplementation.dotAssign_operation (operand_55451->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1436))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1442))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1445))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1446))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1447))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllDirectories_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1448))) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
  "\n") ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_56566
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_56566 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_56566->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_56566->mFilewrapperFileMap,  operand_56566->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1456)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_56566->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_57025 (operand_56566->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_57025 = NULL ;
while (((operand_57025 = enumerator_57025.nextObject ()))) {
  macroValidPointer (operand_57025) ;
GGS_string var_cas_generatedCodeForInstructionList = GGS_string ("") ;
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1474))) ;
{
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_57330 (operand_57025->mFilewrapperTemplateFormalInputParameters, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_57330 = NULL ;
while (((operand_57330 = enumerator_57330.nextObject ()))) {
  macroValidPointer (operand_57330) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_57330->mFormalArgumentCppName) ;
}
}
GGS_bool var_cas_useColumnMarker = GGS_bool (false) ;
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_57025->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1479)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_56566->mFilewrapperName, operand_57025->mFilewrapperTemplateName, operand_57025->mFilewrapperTemplateFormalInputParameters, var_cas_unusedVariableCppNameSet, var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
