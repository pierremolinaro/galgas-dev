...
result << " & inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_22044 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22044 = NULL ;
while (((operand_22044 = enumerator_22044.nextObject ()))) {
macroValidPointer (operand_22044) ;
result << "    public : GALGASap_" ;
result << operand_22044->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (523)) ;
result << " attribute_" ;
result << operand_22044->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22353 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22353 = NULL ;
while (((operand_22353 = enumerator_22353.nextObject ()))) {
macroValidPointer (operand_22353) ;
if ((operand_22353->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (534))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22353->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (535)) ;
result << " readerCall_" ;
result << operand_22353->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22601 (operand_22353->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22601 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22601 = enumerator_22601.nextObject ()))) {
macroValidPointer (operand_22601) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22601->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22353->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
