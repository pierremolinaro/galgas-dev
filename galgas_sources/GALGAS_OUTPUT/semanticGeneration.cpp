...
if (operand_5415->mUsesCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
}else {
result << "C_Compiler * /* inCompiler */\n" ;
}
...
GGS_formalParameterListForGeneration::cEnumerator enumerator_6707 (operand_5415->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_6707 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6707 = enumerator_6707.nextObject ()))) {
macroValidPointer (operand_6707) ;
if ((operand_6707->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (157))).boolValue ()) {
result << "  macroRetainObject (inArgument_" ;
result << operand_6707->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
...
GGS_formalParameterListForGeneration::cEnumerator enumerator_7060 (operand_5415->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_7060 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7060 = enumerator_7060.nextObject ()))) {
macroValidPointer (operand_7060) ;
if ((operand_7060->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (165))).boolValue ()) {
result << "  macroReleaseObject (inArgument_" ;
result << operand_7060->mFormalArgumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
...
GGS_typedAttributeList::cEnumerator enumerator_7350 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7350 = NULL ;
while (((operand_7350 = enumerator_7350.nextObject ()))) {
macroValidPointer (operand_7350) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_7350->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_7350->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
