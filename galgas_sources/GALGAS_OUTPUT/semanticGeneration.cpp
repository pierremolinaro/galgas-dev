...
result << "//--------------------------------- unary - operator\n"
  "  public : static GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " GALGASap_operator_unary_minus (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inOperand,\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_18943 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_18943 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18943 = enumerator_18943.nextObject ()))) {
macroValidPointer (operand_18943) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_18943->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
result << " inOperand" ;
...
GGS_nativeAttributeList::cEnumerator enumerator_19967 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_19967 = NULL ;
while (((operand_19967 = enumerator_19967.nextObject ()))) {
macroValidPointer (operand_19967) ;
result << "  private : " ;
if (operand_19967->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_19967->mCppClassName ;
result << " " ;
if (operand_19967->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_19967->mAttributeName ;
result << " ;\n" ;
if ((operand_19967->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_19967->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_20354 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20354 = NULL ;
while (((operand_20354 = enumerator_20354.nextObject ()))) {
macroValidPointer (operand_20354) ;
result << "  public : GALGASap_" ;
result << operand_20354->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
result << " mAttribute_" ;
result << operand_20354->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
GGS_withAccessorMap::cEnumerator enumerator_21333 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21333 = NULL ;
while (((operand_21333 = enumerator_21333.nextObject ()))) {
macroValidPointer (operand_21333) ;
result << "  friend cRootObjectArray * readWriteAccessForWithInstruction_" ;
result << operand_21333->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21333->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << " & inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_22015 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22015 = NULL ;
while (((operand_22015 = enumerator_22015.nextObject ()))) {
macroValidPointer (operand_22015) ;
result << "    public : GALGASap_" ;
result << operand_22015->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (523)) ;
result << " attribute_" ;
result << operand_22015->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << "*\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_9065 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_9065 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9065 = enumerator_9065.nextObject ()))) {
macroValidPointer (operand_9065) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_9065->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::cEnumerator::attribute_" ;
result << operand_9065->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) {\n"
  "  return GALGASap_" ;
result << operand_9065->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
result << " (directAccess (" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_typedAttributeList::cEnumerator enumerator_1845 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1845 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1845 = enumerator_1845.nextObject ()))) {
macroValidPointer (operand_1845) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_1845->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
result << " inOperand" ;
...
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_2199 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2199 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2199 = enumerator_2199.nextObject ()))) {
macroValidPointer (operand_2199) ;
result << "    attributeArray.addObject (inOperand" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_2529 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2529 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2529 = enumerator_2529.nextObject ()))) {
macroValidPointer (operand_2529) ;
result << "GALGASap_" ;
result << operand_2529->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
if (enumerator_2529.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_2738 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2738 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2738 = enumerator_2738.nextObject ()))) {
macroValidPointer (operand_2738) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (70)) ;
result << ".isValid ()" ;
if (enumerator_2738.hasNextObject ()) {
result << " && " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_2943 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2943 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3260 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3260 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3260 = enumerator_3260.nextObject ()))) {
macroValidPointer (operand_3260) ;
result << "GALGASap_" ;
result << operand_3260->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
result << " & outOperand" ;
...
result << "] = {" ;
GGS_typedAttributeList::cEnumerator enumerator_3545 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3545 = NULL ;
while (((operand_3545 = enumerator_3545.nextObject ()))) {
macroValidPointer (operand_3545) ;
result << "NULL" ;
...
GGS_typedAttributeList::cEnumerator enumerator_3683 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3683 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3683 = enumerator_3683.nextObject ()))) {
macroValidPointer (operand_3683) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
result << " = (GALGAS_" ;
result << operand_3683->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4010 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4010 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4010 = enumerator_4010.nextObject ()))) {
macroValidPointer (operand_4010) ;
result << "GALGASap_" ;
result << operand_4010->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (105)) ;
result << " & outOperand" ;
...
result << "NULL" ;
if (enumerator_4295.hasNextObject ()) {
result << ", " ;
}
}
result << "} ;\n"
  "  removeLastObject (attributeArray, inCompiler COMMA_THERE) ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4432 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4432 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4432 = enumerator_4432.nextObject ()))) {
macroValidPointer (operand_4432) ;
result << "  outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
result << " = (GALGAS_" ;
result << operand_4432->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
result << "] ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "GALGASap_" ;
result << operand_4755->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
result << " & outOperand" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
  "  cRootObjectArray * attributeArrayPtr = readFirst (inCompiler COMMA_THERE) ;\n"
  "  if (NULL == attributeArrayPtr) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5073 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5073 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5073 = enumerator_5073.nextObject ()))) {
macroValidPointer (operand_5073) ;
result << "    outOperand" ;
...
result << "  }else{\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5186 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
result << " = attributeArrayPtr->objectAtIndex (" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
result << " COMMA_HERE) ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5482 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5482 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5482 = enumerator_5482.nextObject ()))) {
macroValidPointer (operand_5482) ;
result << "GALGASap_" ;
result << operand_5482->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (146)) ;
result << " & outOperand" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
  "  cRootObjectArray * attributeArrayPtr = readLast (inCompiler COMMA_THERE) ;\n"
  "  if (NULL == attributeArrayPtr) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5799 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5799 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5799 = enumerator_5799.nextObject ()))) {
macroValidPointer (operand_5799) ;
result << "    outOperand" ;
...
result << "  }else{\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5912 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5912 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "::insulate (ioResult COMMA_THERE) ;\n"
  ...
  "  }\n"
  "}\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8471 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8471 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8471 = enumerator_8471.nextObject ()))) {
macroValidPointer (operand_8471) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_8471->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_8471->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_uint inIndex,\n"
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9165 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9165 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_9165->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (234)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_9165->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_uint & inIndex,\n"
  "                                              " ;
...
GGS_typedAttributeList::cEnumerator enumerator_706 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_706 = NULL ;
while (((operand_706 = enumerator_706.nextObject ()))) {
macroValidPointer (operand_706) ;
result << "  if (0 == result) {\n"
  "    result = GALGAS_" ;
result << operand_706->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
result << "::objectCompare (inOperand1.ptr (HERE)->mAttribute_" ;
result << operand_706->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1237 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1237 = NULL ;
while (((operand_1237 = enumerator_1237.nextObject ()))) {
macroValidPointer (operand_1237) ;
result << "GALGASap_" ;
result << operand_1237->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ;
result << " & constinAttribute_" ;
result << operand_1237->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1237.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_1594 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1594 = NULL ;
while (((operand_1594 = enumerator_1594.nextObject ()))) {
macroValidPointer (operand_1594) ;
result << "constinAttribute_" ;
result << operand_1594->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1594.hasNextObject ()) {
result << ", " ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_1820 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1820 = NULL ;
while (((operand_1820 = enumerator_1820.nextObject ()))) {
macroValidPointer (operand_1820) ;
result << ",\n"
  "mAttribute_" ;
result << operand_1820->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (constinAttribute_" ;
result << operand_1820->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3010 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3010 = NULL ;
while (((operand_3010 = enumerator_3010.nextObject ()))) {
macroValidPointer (operand_3010) ;
result << "GALGASap_" ;
result << operand_3010->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
result << " & inAttribute_" ;
result << operand_3010->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " * result = NULL ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_3376 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3376 = NULL ;
while (((operand_3376 = enumerator_3376.nextObject ()))) {
macroValidPointer (operand_3376) ;
result << "inAttribute_" ;
result << operand_3376->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
if (enumerator_3376.hasNextObject ()) {
result << " && " ;
}
}
result << ") {\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_3583 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3583 = NULL ;
while (((operand_3583 = enumerator_3583.nextObject ()))) {
macroValidPointer (operand_3583) ;
result << "inAttribute_" ;
result << operand_3583->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "const PMSInt32 /* inIndentation */) {\n"
  ...
  "           << typeDescriptor ()->mGalgasTypeName\n"
  "           << \":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4137 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4137 = NULL ;
while (((operand_4137 = enumerator_4137.nextObject ()))) {
macroValidPointer (operand_4137) ;
result << "//  mAttribute_" ;
result << operand_4137->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "->description (ioString, inIndentation + 1) ;\n" ;
if (enumerator_4137.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \">\" ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_4857 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_4857 = NULL ;
while (((operand_4857 = enumerator_4857.nextObject ()))) {
macroValidPointer (operand_4857) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_4857->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_4857->mSignature, operand_4857->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (127)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5278 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5278 = NULL ;
while (((operand_5278 = enumerator_5278.nextObject ()))) {
macroValidPointer (operand_5278) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5278->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5278->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5278->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
