...
if ((operand_6547->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (146))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6547->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
}else if ((operand_6547->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6547->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (149)) ;
}else if ((operand_6547->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (150))).boolValue ()) {
result << "GALGAS_" ;
result << operand_6547->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
}else {
result << "GALGAS_" ;
result << operand_6547->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
}
...
result << operand_6159->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_8049 (operand_6159->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8049 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8049 = enumerator_8049.nextObject ()))) {
macroValidPointer (operand_8049) ;
if ((operand_8049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (178))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
result << ", " ;
}else if ((operand_8049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (180))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
result << ", " ;
}else if ((operand_8049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).boolValue ()) {
result << "outArgument" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9010 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9010 = NULL ;
while (((operand_9010 = enumerator_9010.nextObject ()))) {
macroValidPointer (operand_9010) ;
result << "const GALGAS_" ;
result << operand_9010->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " & in_" ;
result << operand_9010->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_9010.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_9411 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9411 = NULL ;
while (((operand_9411 = enumerator_9411.nextObject ()))) {
macroValidPointer (operand_9411) ;
result << "in_" ;
result << operand_9411->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << ")" ;
GGS_typedAttributeList::cEnumerator enumerator_9629 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9629 = NULL ;
while (((operand_9629 = enumerator_9629.nextObject ()))) {
macroValidPointer (operand_9629) ;
result << ",\n"
  "mAttribute_" ;
result << operand_9629->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_9629->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_NAME ;
result << ":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10537 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10537 = NULL ;
while (((operand_10537 = enumerator_10537.nextObject ()))) {
macroValidPointer (operand_10537) ;
result << "  mAttribute_" ;
result << operand_10537->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation+1) ;\n" ;
if (enumerator_10537.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \"]\" ;\n"
