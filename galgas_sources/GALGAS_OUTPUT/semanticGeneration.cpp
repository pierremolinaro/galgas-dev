...
//                    september 30th, 2010, at 14h3'50"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14519 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14519 = NULL ;
while (((operand_14519 = enumerator_14519.nextObject ()))) {
macroValidPointer (operand_14519) ;
result << "  public : GALGAS_" ;
result << operand_14519->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (347)) ;
result << " current_" ;
result << operand_14519->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14981 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14981 = NULL ;
...
result << operand_14981->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14981->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_14522 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14522 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14522 = enumerator_14522.nextObject ()))) {
macroValidPointer (operand_14522) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_14522->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (380)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_14522->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1954 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1954 = NULL ;
while (((operand_1954 = enumerator_1954.nextObject ()))) {
macroValidPointer (operand_1954) ;
result << "const GALGAS_" ;
result << operand_1954->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
result << " & in_" ;
result << operand_1954->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_2188 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2188 = NULL ;
while (((operand_2188 = enumerator_2188.nextObject ()))) {
macroValidPointer (operand_2188) ;
result << ",\n"
  "mAttribute_" ;
result << operand_2188->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_2188->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << "::isValid (void) const {\n"
  "  return " ;
GGS_typedAttributeList::cEnumerator enumerator_2516 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2516 = NULL ;
while (((operand_2516 = enumerator_2516.nextObject ()))) {
macroValidPointer (operand_2516) ;
result << "mAttribute_" ;
result << operand_2516->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_2923 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2923 = NULL ;
while (((operand_2923 = enumerator_2923.nextObject ()))) {
macroValidPointer (operand_2923) ;
result << "mAttribute_" ;
result << operand_2923->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_2923.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_HERE)) ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " *) inOperand ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3850 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3850 = NULL ;
while (((operand_3850 = enumerator_3850.nextObject ()))) {
macroValidPointer (operand_3850) ;
result << "    if (kOperandEqual == result) {\n"
  "      result = mAttribute_" ;
result << operand_3850->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".objectCompare (operand->mAttribute_" ;
result << operand_3850->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ") ;\n"
  "    }\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_sortDescriptorListForGeneration::cEnumerator enumerator_4761 (var_cas_SORT_ATTRIBUTE_LIST, true) ;
const GGS_sortDescriptorListForGeneration::cElement * operand_4761 = NULL ;
while (((operand_4761 = enumerator_4761.nextObject ()))) {
macroValidPointer (operand_4761) ;
result << "  if (result == kOperandEqual) {\n"
  "    result = " ;
if (operand_4761->mAscendingOrder.boolValue ()) {
result << "mAttribute_" ;
result << operand_4761->mAttributeName.reader_identifierRepresentation () ;
result << ".objectCompare (operand->mAttribute_" ;
result << operand_4761->mAttributeName.reader_identifierRepresentation () ;
result << ")" ;
}else {
...
result << "const GALGAS_" ;
result << operand_5703->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " & inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6070 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6070 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6070 = enumerator_6070.nextObject ()))) {
macroValidPointer (operand_6070) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
if (enumerator_6070.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "::addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6469 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6469 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6469 = enumerator_6469.nextObject ()))) {
macroValidPointer (operand_6469) ;
result << "const GALGAS_" ;
result << operand_6469->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
if (enumerator_6469.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6784 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6784 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6784 = enumerator_6784.nextObject ()))) {
macroValidPointer (operand_6784) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
if (enumerator_6784.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "GALGAS_" ;
result << operand_7954->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8584 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8584 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8584 = enumerator_8584.nextObject ()))) {
macroValidPointer (operand_8584) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
result << " = p->mAttribute_" ;
result << operand_8584->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8886 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8886 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8886 = enumerator_8886.nextObject ()))) {
macroValidPointer (operand_8886) ;
result << "GALGAS_" ;
result << operand_8886->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9338 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9338 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9338 = enumerator_9338.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9516 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9516 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9516 = enumerator_9516.nextObject ()))) {
macroValidPointer (operand_9516) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) ;
result << " = p->mAttribute_" ;
result << operand_9516->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9813 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9813 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9813 = enumerator_9813.nextObject ()))) {
macroValidPointer (operand_9813) ;
result << "GALGAS_" ;
result << operand_9813->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10268 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10268 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10446 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10446 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10446 = enumerator_10446.nextObject ()))) {
macroValidPointer (operand_10446) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (280)) ;
result << " = p->mAttribute_" ;
result << operand_10446->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10743 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10743 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10743 = enumerator_10743.nextObject ()))) {
macroValidPointer (operand_10743) ;
result << "GALGAS_" ;
result << operand_10743->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (289)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11198 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11198 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11376 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11376 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_11376->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11904->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (320)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11904->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
