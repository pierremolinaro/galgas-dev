...
template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      columnMarker = result.currentColumn () ;
      GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7857 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
      const GGS_unifiedTypeMapProxyList::cElement * operand_7857 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_7857 = enumerator_7857.nextObject ()))) {
      macroValidPointer (operand_7857) ;
      result << "GALGASap_" ;
      result << operand_7857->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
      result << " inOperand" ;
      result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
      if (enumerator_7857.hasNextObject ()) {
        result << ",\n" ;
        result.appendSpacesUntilColumn (columnMarker) ;
      }
...
GGS_readerMap::cEnumerator enumerator_8109 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_8109 = NULL ;
while (((operand_8109 = enumerator_8109.nextObject ()))) {
  macroValidPointer (operand_8109) ;
  if (((operand_8109->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).operator_or ((operand_8109->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).boolValue ()) {
    result << "public : VIRTUAL_IN_DEBUG GALGASap_" ;
    result << operand_8109->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
    result << " readerCall_" ;
    result << operand_8109->mKey.ggs_string ().reader_identifierRepresentation () ;
    result << " (" ;
    columnMarker = result.currentColumn () ;
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_8390 (operand_8109->mInfo.mArgumentTypeList, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_8390 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_8390 = enumerator_8390.nextObject ()))) {
    macroValidPointer (operand_8390) ;
    result << "GALGASap_" ;
    result << operand_8390->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
    result << " & constinOperand" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
    if (enumerator_8390.hasNextObject ()) {
      result << ",\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
    }
    var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8109->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
  if (operand_8109->mInfo.mHasCompilerArgument.boolValue ()) {
    result << "C_Compiler * inCompiler\n" ;
    result.appendSpacesUntilColumn (columnMarker) ;
    result << "COMMA_LOCATION_ARGS" ;
  }else {
...
}else if (operand_8109->mInfo.mHasCompilerArgument.boolValue ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  result << "C_Compiler * inCompiler\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_9265 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_9265 = NULL ;
while (((operand_9265 = enumerator_9265.nextObject ()))) {
macroValidPointer (operand_9265) ;
if ((operand_9265->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void modifierCall_" ;
result << operand_9265->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9435 (operand_9265->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9435 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9435 = enumerator_9435.nextObject ()))) {
macroValidPointer (operand_9435) ;
if ((operand_9435->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9435->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
  result << " inArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
}else if ((operand_9435->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9435->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
  result << " & ioArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
}else if ((operand_9435->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (230))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9435->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
  result << " & outArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
}else {
  result << "GALGASap_" ;
  result << operand_9435->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
  result << " inArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
}
if (enumerator_9435.hasNextObject ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9265->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9265->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_9265->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_instanceMethodMap::cEnumerator enumerator_10661 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_10661 = NULL ;
while (((operand_10661 = enumerator_10661.nextObject ()))) {
macroValidPointer (operand_10661) ;
if (((operand_10661->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (254)))).operator_or ((operand_10661->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (254)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void instanceMethodCall_" ;
result << operand_10661->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10887 (operand_10661->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10887 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10887 = enumerator_10887.nextObject ()))) {
macroValidPointer (operand_10887) ;
if ((operand_10887->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (257))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10887->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
}else if ((operand_10887->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (259))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10887->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
}else if ((operand_10887->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (261))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10887->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
}else {
result << "GALGASap_" ;
result << operand_10887->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
}
if (enumerator_10887.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10661->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10661->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_10661->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--------------------------------- Reader invocation declaration\n" ;
GGS_readerMap::cEnumerator enumerator_6429 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_6429 = NULL ;
while (((operand_6429 = enumerator_6429.nextObject ()))) {
macroValidPointer (operand_6429) ;
if (((operand_6429->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (162)))).operator_or ((operand_6429->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (162)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG GALGASap_" ;
result << operand_6429->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " readerCall_" ;
result << operand_6429->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6710 (operand_6429->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6710 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6710 = enumerator_6710.nextObject ()))) {
macroValidPointer (operand_6710) ;
result << "GALGASap_" ;
result << operand_6710->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
result << " & constinOperand" ;
...
if ((operand_6429->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
...
}else if (operand_6429->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_7306 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_7306 = NULL ;
while (((operand_7306 = enumerator_7306.nextObject ()))) {
macroValidPointer (operand_7306) ;
if ((operand_7306->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void modifierCall_" ;
result << operand_7306->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7476 (operand_7306->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7476 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7476 = enumerator_7476.nextObject ()))) {
macroValidPointer (operand_7476) ;
if ((operand_7476->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (189))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7476->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
}else if ((operand_7476->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7476->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
}else if ((operand_7476->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (193))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7476->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
}else {
result << "GALGASap_" ;
result << operand_7476->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
}
...
if ((operand_7306->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7306->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_7306->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8702 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8702 = NULL ;
while (((operand_8702 = enumerator_8702.nextObject ()))) {
macroValidPointer (operand_8702) ;
if (((operand_8702->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).operator_or ((operand_8702->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void instanceMethodCall_" ;
result << operand_8702->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8928 (operand_8702->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8928 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8928 = enumerator_8928.nextObject ()))) {
macroValidPointer (operand_8928) ;
if ((operand_8928->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (220))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8928->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
}else if ((operand_8928->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8928->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
}else if ((operand_8928->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (224))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8928->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
}else {
result << "GALGASap_" ;
result << operand_8928->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
}
if (enumerator_8928.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8702->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8702->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_8702->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
