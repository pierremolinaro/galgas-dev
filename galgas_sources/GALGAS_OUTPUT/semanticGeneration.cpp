...
GGS_mapSearchMethodListAST::cEnumerator enumerator_1833 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_1833 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_1833 = enumerator_1833.nextObject ()))) {
macroValidPointer (operand_1833) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_" ;
result << operand_1833->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
result << operand_1833->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (46)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
result << "] = " ;
result << operand_1833->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_26927
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_27140
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27140 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_27140->mRoutineName, operand_27140->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_27467
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27467 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27467->mFunctionName, operand_27467->mFormalArgumentList, operand_27467->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (703))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_27835
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27835 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27835->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_27835->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (713))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_28220
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28220 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_28220->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (721)), operand_28220->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (722)), ((operand_28220->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (723))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_28220->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (723)))), operand_28220->mAllTypedAttributeList, operand_28220->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_28220->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), operand_28220->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_28220->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (730)), operand_28220->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (731)), operand_28220->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (732)), operand_28220->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (733)), operand_28220->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), operand_28220->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (735)), operand_28220->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (736)), operand_28220->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), operand_28220->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (738)), operand_28220->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (739)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_29165
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29165 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_29165->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), operand_29165->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (748)), operand_29165->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_29165->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (752)), operand_29165->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (753)), operand_29165->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_29165->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (755)), operand_29165->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (756)), operand_29165->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (757)), operand_29165->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (758)), operand_29165->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (759)), operand_29165->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_29165->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_29165->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_29165->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (763)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_30006
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30006 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_30006->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_30006->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (772)), operand_30006->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30006->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (776)), operand_30006->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (777)), operand_30006->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (778)), operand_30006->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (779)), operand_30006->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (780)), operand_30006->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), operand_30006->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), operand_30006->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), operand_30006->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (784)), operand_30006->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_30006->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), operand_30006->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (787)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_30848
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30848 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_30848->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), operand_30848->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (796)), operand_30848->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30848->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (800)), operand_30848->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), operand_30848->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (802)), operand_30848->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (803)), operand_30848->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (804)), operand_30848->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (805)), operand_30848->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (806)), operand_30848->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (807)), operand_30848->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_30848->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), operand_30848->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), operand_30848->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (811)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_31694
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31694 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_31694->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), operand_31694->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), operand_31694->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31694->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (824)), operand_31694->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), operand_31694->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (826)), operand_31694->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), operand_31694->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (828)), operand_31694->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (829)), operand_31694->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (830)), operand_31694->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (831)), operand_31694->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (832)), operand_31694->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (833)), operand_31694->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (834)), operand_31694->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_32540
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_32540 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_32540->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (843)), operand_32540->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), operand_32540->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_32540->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (848)), operand_32540->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), operand_32540->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_32540->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (851)), operand_32540->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (852)), operand_32540->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), operand_32540->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (854)), operand_32540->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (855)), operand_32540->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (856)), operand_32540->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (857)), operand_32540->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (858)), operand_32540->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (859)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapProxyTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_33378
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_33378 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapProxyTypeHeader1 (inLexique, operand_33378->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), operand_33378->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (868))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_33378->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (871)), operand_33378->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (872)), operand_33378->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (873)), operand_33378->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (874)), operand_33378->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (875)), operand_33378->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (876)), operand_33378->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (877)), operand_33378->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (878)), operand_33378->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (879)), operand_33378->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (880)), operand_33378->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (881)), operand_33378->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (882)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_34349 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_34349 = NULL ;
while (((operand_34349 = enumerator_34349.nextObject ()))) {
  macroValidPointer (operand_34349) ;
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_34490 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_34490 = NULL ;
while (((operand_34490 = enumerator_34490.nextObject ()))) {
  macroValidPointer (operand_34490) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_34490->mInfo.mRegularFileMap,  operand_34490->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (897)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_34797
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34797 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_34797->mFilewrapperFileMap,  operand_34797->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (909)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_34797->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_35221 (operand_34797->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_35221 = NULL ;
while (((operand_35221 = enumerator_35221.nextObject ()))) {
  macroValidPointer (operand_35221) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_34797->mFilewrapperName, operand_35221->mFilewrapperTemplateName, operand_35221->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_35615
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35615 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_35615->mTypeName, operand_35615->mAbstractCategoryMethodName, operand_35615->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_35996
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35996 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_35996->mTypeName, operand_35996->mCategoryMethodName, operand_35996->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_36361
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36361 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderDeclaration (inLexique, operand_36361->mTypeName, operand_36361->mAbstractCategoryReaderName, operand_36361->mAbstractCategoryReaderFormalParameterList, operand_36361->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_36759
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36759 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderDeclaration (inLexique, operand_36759->mTypeName, operand_36759->mCategoryReaderName, operand_36759->mCategoryReaderFormalParameterList, operand_36759->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_37441,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37441 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_37672,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_37672 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_37672->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (988)), operand_37672->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (989)), operand_37672->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_38047,
                                const GGS_string  var_cas_inOutputDirectory
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_38047 != NULL) {
const GGS_bool cond_39243 = operand_38047->mGenerateHeaderInSeparateFile ;
if (cond_39243.isBuiltAndTrue ()) {
const GGS_string var_cas_part1 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_38047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), operand_38047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)), ((operand_38047->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1003))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38047->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)))), operand_38047->mTypedAttributeList, operand_38047->mAllTypedAttributeList, operand_38047->mIsAbstract, operand_38047->mAbstractMethodList, operand_38047->mMethodList) ;
const GGS_string var_cas_part2 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_38047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1011)), operand_38047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)), ((operand_38047->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1013))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38047->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1013)))), operand_38047->mTypedAttributeList, operand_38047->mAllTypedAttributeList, operand_38047->mIsAbstract, operand_38047->mAbstractMethodList, operand_38047->mMethodList) ;
const GGS_string var_cas_headerFileName = ((GGS_string ("separateHeaderFor_")).operator_concat (operand_38047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1020)))).operator_concat (GGS_string (".h")) ;
...
var_cas_outHeader = ((GGS_string ("#include \"")).operator_concat (var_cas_headerFileName)).operator_concat (GGS_string ("\"\n"
  "\n")) ;
}else if (cond_39243.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_38047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)), operand_38047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1034)), ((operand_38047->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1035))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38047->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1035)))), operand_38047->mTypedAttributeList, operand_38047->mAllTypedAttributeList, operand_38047->mIsAbstract, operand_38047->mAbstractMethodList, operand_38047->mMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_38047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1043)), operand_38047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1044)), ((operand_38047->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1045))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_38047->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1045)))), operand_38047->mTypedAttributeList, operand_38047->mAllTypedAttributeList, operand_38047->mIsAbstract, operand_38047->mAbstractMethodList, operand_38047->mMethodList)) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_40533
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40533 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_CompilerEx & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_40759
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40759 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_40759->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)), operand_40759->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)), operand_40759->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1072)), operand_40759->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1073))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_41490
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41490 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_41712
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41712 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_41712->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1093)), operand_41712->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1094)), operand_41712->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_42213
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42213 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_42213->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1104)), operand_42213->mTypedAttributeList, operand_42213->mInsertMethodList, operand_42213->mSearchMethodList, operand_42213->mRemoveMethodList, operand_42213->mHasInsertOrReplaceModifier, operand_42213->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_42766
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42766 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_42766->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)), operand_42766->mTypedAttributeList, operand_42766->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_43229
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43229 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_43229->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), operand_43229->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)), operand_43229->mConstantList, operand_43229->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_43696
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43696 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_43696->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1142)), operand_43696->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)), operand_43696->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1144)), operand_43696->mAssociatedMapTypedAttributeList, operand_43696->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_44244
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44244 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_44244->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)), operand_44244->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)), ((operand_44244->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1157))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_44244->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1157)))), operand_44244->mTypedAttributeList, operand_44244->mAllTypedAttributeList, operand_44244->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_44244->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_44244->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)), operand_44244->mIsAbstract, operand_44244->mAbstractMethodList, operand_44244->mMethodList, operand_44244->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_45004
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45004 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_45004->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1173)), operand_45004->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)), operand_45004->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_45455
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45455 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_45455->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1184)), operand_45455->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), operand_45455->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_45915
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45915 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_45915->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_45915->mRoutineName.reader_identifierRepresentation ()), operand_45915->mFormalArgumentList, operand_45915->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1196))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_46634
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46634 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_46634->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_46634->mFunctionName.reader_identifierRepresentation ()), operand_46634->mFormalArgumentList, operand_46634->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_46634->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1219)), operand_46634->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1214)), operand_46634->mFormalArgumentList, operand_46634->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1224))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_47369
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47369 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_47369->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_47369->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_47369->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_47369->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)), operand_47369->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1234)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_47369->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1244))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_48164
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48164 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_48164->mTypeName, operand_48164->mAbstractCategoryMethodName, operand_48164->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_48657
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48657 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_48657->mTypeName, GGS_string (""), operand_48657->mCategoryMethodName, operand_48657->mCategoryMethodFormalParameterList, operand_48657->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1263)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_48657->mTypeName, operand_48657->mCategoryMethodName, operand_48657->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_49356
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49356 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_49356->mTypeName, operand_49356->mBaseTypeName, operand_49356->mCategoryMethodName, operand_49356->mCategoryMethodFormalParameterList, operand_49356->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1282)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_49356->mTypeName, operand_49356->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_50044
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50044 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderImplementation (inLexique, operand_50044->mTypeName, operand_50044->mAbstractCategoryReaderName, operand_50044->mAbstractCategoryReaderFormalParameterList, operand_50044->mResultType) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_50554
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50554 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_50554->mTypeName, GGS_string (""), operand_50554->mCategoryReaderName, operand_50554->mCategoryReaderFormalParameterList, operand_50554->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_50554->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)), operand_50554->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1312)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderImplementation (inLexique, operand_50554->mTypeName, operand_50554->mCategoryReaderName, operand_50554->mCategoryReaderFormalParameterList, operand_50554->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overrideCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overrideCategoryReaderForGeneration * operand_51328
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51328 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_51328->mTypeName, operand_51328->mBaseTypeName, operand_51328->mOverridingCategoryReaderName, operand_51328->mOverridingCategoryReaderFormalParameterList, operand_51328->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_51328->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1342)), operand_51328->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1335)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryReaderImplementation (inLexique, operand_51328->mTypeName, operand_51328->mOverridingCategoryReaderName, operand_51328->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_52370 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_52370 = NULL ;
while (((operand_52370 = enumerator_52370.nextObject ()))) {
  macroValidPointer (operand_52370) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_52370->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1365)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_52370->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_52370->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1368))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_52370->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1371))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_52370->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_52370->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_52370->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1375))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_53212 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_53212 = NULL ;
while (((operand_53212 = enumerator_53212.nextObject ()))) {
  macroValidPointer (operand_53212) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_53212->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)),  operand_53212->mInfo.mWrapperDirectoryIndex,  operand_53212->mInfo.mRegularFileMap,  operand_53212->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1380)) ;
}
}
...
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_53800 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_53800 = NULL ;
while (((operand_53800 = enumerator_53800.nextObject ()))) {
  macroValidPointer (operand_53800) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_53800->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1395))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_54411 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_54411 = NULL ;
while (((operand_54411 = enumerator_54411.nextObject ()))) {
  macroValidPointer (operand_54411) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_54411->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_55526
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_55526 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_55526->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_55526->mFilewrapperFileMap,  operand_55526->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1425)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_55526->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_55985 (operand_55526->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_55985 = NULL ;
while (((operand_55985 = enumerator_55985.nextObject ()))) {
  macroValidPointer (operand_55985) ;
...
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_55985->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1445)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_55526->mFilewrapperName, operand_55985->mFilewrapperTemplateName, operand_55985->mFilewrapperTemplateFormalInputParameters, (var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1457)))).operator_not (), var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
