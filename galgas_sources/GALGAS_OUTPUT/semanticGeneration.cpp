...
result << "  public : GALGAS_" ;
result << operand_633->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (15)) ;
result << " mAttribute_" ;
...
GGS_typedAttributeList::cEnumerator enumerator_908 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_908 = NULL ;
while (((operand_908 = enumerator_908.nextObject ()))) {
macroValidPointer (operand_908) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_908->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (21)) ;
result << " & in_" ;
result << operand_908->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
}
result << "\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
