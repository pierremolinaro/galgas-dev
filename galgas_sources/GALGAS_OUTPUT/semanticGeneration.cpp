...
result << "::current_key (void) const {\n"
  ...
  "  return p->mAttribute_lkey.mAttribute_string ;\n"
  "}\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << " result ;\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapAutomatonStateMap::cEnumerator enumerator_4138 (var_cas_MAP_AUTOMATON_STATE_MAP, true) ;
const GGS_mapAutomatonStateMap::cElement * operand_4138 = NULL ;
while (((operand_4138 = enumerator_4138.nextObject ()))) {
macroValidPointer (operand_4138) ;
result << "static const PMUInt32 kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_4138->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_4138->mInfo.mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
result << " ;\n" ;
}
result << "\n"
  "//---------------------------------------------------------------------------*\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapAutomatonActionMap::cEnumerator enumerator_4549 (var_cas_MAP_AUTOMATON_ACTION_MAP, true) ;
const GGS_mapAutomatonActionMap::cElement * operand_4549 = NULL ;
while (((operand_4549 = enumerator_4549.nextObject ()))) {
macroValidPointer (operand_4549) ;
result << "static const PMUInt32 kMapAction_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_4549->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_4549->mInfo.mActionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
result << " ;\n" ;
}
result << "\n"
  "//---------------------------------------------------------------------------*\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapStateSortedList::cEnumerator enumerator_4976 (var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST, true) ;
const GGS_mapStateSortedList::cElement * operand_4976 = NULL ;
if (enumerator_4976.hasCurrentObject ()) {
result << "static const cMapAutomatonTransition kMapTransitions_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " [" ;
result << var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
result << " * " ;
result << var_cas_MAP_AUTOMATON_ACTION_MAP.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
result << "] = {\n" ;
while (((operand_4976 = enumerator_4976.nextObject ()))) {
macroValidPointer (operand_4976) ;
result << "// State '" ;
result << operand_4976->mStateName ;
result << "', index " ;
result << operand_4976->mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << " \n" ;
GGS_mapStateTransitionSortedList::cEnumerator enumerator_5271 (operand_4976->mTransitionList, true) ;
const GGS_mapStateTransitionSortedList::cElement * operand_5271 = NULL ;
while (((operand_5271 = enumerator_5271.nextObject ()))) {
macroValidPointer (operand_5271) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5271->mTargetStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_5271->mTargetStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
result << " */, " ;
switch (operand_5271->mTransitionMessageKind.enumValue ()) {
...
result << ", " ;
result << operand_5271->mTransitionMessage.reader_utf8Representation () ;
result << "}, // for action '" ;
result << operand_5271->mActionName ;
result << "', (index " ;
result << operand_5271->mActionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << ")\n" ;
}
}
result << "} ;\n" ;
...
result << "\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapStateSortedList::cEnumerator enumerator_6073 (var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST, true) ;
const GGS_mapStateSortedList::cElement * operand_6073 = NULL ;
if (enumerator_6073.hasCurrentObject ()) {
result << "static const cMapAutomatonFinalIssue kMapAutomatonFinalIssue_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " [" ;
result << var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
result << "] = {\n" ;
while (((operand_6073 = enumerator_6073.nextObject ()))) {
macroValidPointer (operand_6073) ;
result << "  {" ;
switch (operand_6073->mStateMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_6073->mStateMessage.reader_utf8Representation () ;
result << "},// state '" ;
result << operand_6073->mStateName ;
result << "' (index " ;
result << operand_6073->mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << ")\n" ;
}
result << "} ;\n" ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
  "  closeBranch (inErrorLocation, kMapAutomatonFinalIssue_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << ", inCompiler COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
...
GGS_mapOverrideList::cEnumerator enumerator_7581 (var_cas_MAP_OVERRIDE_LIST, true) ;
const GGS_mapOverrideList::cElement * operand_7581 = NULL ;
while (((operand_7581 = enumerator_7581.nextObject ()))) {
macroValidPointer (operand_7581) ;
result << "//---------------------------------------------------------------------------*\n"
  "//" ;
result << ((GGS_string ("map override '")).operator_concat (operand_7581->mOverrideName)).operator_concat (GGS_string ("'")).reader_stringByLeftAndRightPadding (GGS_uint (75U), GGS_char (TO_UNICODE (' '))) ;
result << "*\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_7581->mOverrideName.reader_identifierRepresentation () ;
result << " [" ;
result << operand_7581->mBranchBehaviourSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << "] = {\n" ;
GGS_branchBehaviourSortedListForMapOverride::cEnumerator enumerator_8127 (operand_7581->mBranchBehaviourSortedListForMapOverride, true) ;
const GGS_branchBehaviourSortedListForMapOverride::cElement * operand_8127 = NULL ;
while (((operand_8127 = enumerator_8127.nextObject ()))) {
macroValidPointer (operand_8127) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8127->mStartStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8127->mStartStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8127->mCurrentStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8127->mCurrentStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (208)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8127->mFinalStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8127->mFinalStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
result << " */, " ;
switch (operand_8127->mBehaviourMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_8127->mBehaviourMessage.reader_utf8Representation () ;
result << "},\n" ;
}
result << "} ;\n"
  "\n"
...
result << operand_7581->mOverrideName.reader_identifierRepresentation () ;
result << " [" ;
result << operand_7581->mBranchCombinationSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
result << "] = {\n" ;
GGS_branchBehaviourSortedListForMapOverride::cEnumerator enumerator_9177 (operand_7581->mBranchCombinationSortedListForMapOverride, true) ;
const GGS_branchBehaviourSortedListForMapOverride::cElement * operand_9177 = NULL ;
while (((operand_9177 = enumerator_9177.nextObject ()))) {
macroValidPointer (operand_9177) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9177->mStartStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9177->mStartStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9177->mCurrentStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9177->mCurrentStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9177->mFinalStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9177->mFinalStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
result << " */, " ;
switch (operand_9177->mBehaviourMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_9177->mBehaviourMessage.reader_utf8Representation () ;
result << "},\n" ;
}
result << "} ;\n"
  "\n"
...
result << operand_7581->mOverrideName.reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << operand_7581->mOverrideName.reader_identifierRepresentation () ;
result << ", " ;
result << operand_7581->mBranchBehaviourSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
result << ",\n"
...
result << operand_7581->mOverrideName.reader_identifierRepresentation () ;
result << ", " ;
result << operand_7581->mBranchCombinationSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (252)) ;
result << ",\n"
  "                " ;
result << operand_7581->mOverrideName.reader_utf8Representation () ;
result << ",\n"
  "                inCompiler\n"
  "                COMMA_THERE) ;\n"
  "}\n"
...
result << "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_10716 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_10716 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_10716->mInsertMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_10958 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10958 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_10958->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_11297 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11297 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11297 = enumerator_11297.nextObject ()))) {
macroValidPointer (operand_11297) ;
result << ", inArgument" ;
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_12053 = GGS_uint (2U) ;
if (indentation_12053.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_12053.uintValue ()) ;
}
result << "const char * kInsertErrorMessage = " ;
result << operand_10716->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "const char * kShadowErrorMessage = " ;
result << operand_10716->mShadowErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n" ;
if ((operand_10716->mInitialStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (280))).operator_isEqual (GGS_string ("")).boolValue ()) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_10716->mInitialStateName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_12092 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_12092 = NULL ;
while (((operand_12092 = enumerator_12092.nextObject ()))) {
macroValidPointer (operand_12092) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_12092->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_12092->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::" ;
if ((operand_12092->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (294))).operator_isEqual (GGS_string ("")).boolValue ()) {
result << "method_" ;
}else {
result << "modifier_" ;
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_12660 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12660 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12660 = enumerator_12660.nextObject ()))) {
macroValidPointer (operand_12660) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_12660->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) " ;
if ((operand_12092->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).operator_isEqual (GGS_string ("")).boolValue ()) {
result << "const " ;
}else {
}
result << "{\n" ;
const GGS_uint indentation_13868 = GGS_uint (2U) ;
if (indentation_13868.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_13868.uintValue ()) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "inCompiler,\n" ;
if ((operand_12092->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (312))).operator_isNotEqual (GGS_string ("")).boolValue ()) {
result.appendSpacesUntilColumn (columnMarker) ;
result << "kMapAction_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_12092->mActionName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (315)) ;
result << ",\n" ;
}else {
}
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "COMMA_THERE) ;\n"
  "if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13507 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13507 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13507 = enumerator_13507.nextObject ()))) {
macroValidPointer (operand_13507) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (321)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13704 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13704 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13704 = enumerator_13704.nextObject ()))) {
macroValidPointer (operand_13704) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
result << " = p->mAttribute_" ;
result << operand_13704->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_13908 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_13908 = NULL ;
while (((operand_13908 = enumerator_13908.nextObject ()))) {
macroValidPointer (operand_13908) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_13908->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_14144 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14144 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14144 = enumerator_14144.nextObject ()))) {
macroValidPointer (operand_14144) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14144->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
result << ",\n"
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_14962 = GGS_uint (2U) ;
if (indentation_14962.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_14962.uintValue ()) ;
}
result << "const char * kRemoveErrorMessage = " ;
result << operand_13908->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_14798 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14798 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14798 = enumerator_14798.nextObject ()))) {
macroValidPointer (operand_14798) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
result << " = p->mAttribute_" ;
result << operand_14798->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_15207 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_15207 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15207 = enumerator_15207.nextObject ()))) {
macroValidPointer (operand_15207) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_15207->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (361)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_15507 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_15507 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15507 = enumerator_15507.nextObject ()))) {
macroValidPointer (operand_15507) ;
result << ", inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (367)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
result << " COMMA_HERE)) ;\n"
...
GGS_typedAttributeList::cEnumerator enumerator_15787 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_15787 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15787 = enumerator_15787.nextObject ()))) {
macroValidPointer (operand_15787) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_15787->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (379)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_15787->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string & inKey,\n"
  "                                               " ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_15787->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (384)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_16786 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_16786 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_16786->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_16786->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (395)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_16786->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_17726 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_17726 = NULL ;
while (((operand_17726 = enumerator_17726.nextObject ()))) {
macroValidPointer (operand_17726) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_17726->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_17726->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (411)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_17726->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (413))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << "::current_lkey (void) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_19307 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_19307 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_19307 = enumerator_19307.nextObject ()))) {
macroValidPointer (operand_19307) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_19307->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (441)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_19307->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
