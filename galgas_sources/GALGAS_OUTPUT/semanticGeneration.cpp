...
GGS_string function_generateFunction (C_Compiler & inLexique,
  ...
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (136))) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_6210 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_6210 = NULL ;
    while (((operand_6210 = enumerator_6210.nextObject ()))) {
      macroValidPointer (operand_6210) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_6210->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_6440 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_6440 = NULL ;
    while (((operand_6440 = enumerator_6440.nextObject ()))) {
      macroValidPointer (operand_6440) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_6440->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_6440->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  const GGS_bool cond_6688 = var_cas_inIsStatic ;
  if (cond_6688.isBuiltAndTrue ()) {
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_6921 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_6921 = NULL ;
    while (((operand_6921 = enumerator_6921.nextObject ()))) {
      macroValidPointer (operand_6921) ;
      var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_6921->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (158))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_7169 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_6921->mFormalArgumentCppName) ;
      if (cond_7169.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_6921->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_7169.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_6921->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (165)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_7546 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (169))) ;
  if (cond_7546.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (170))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_7546.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (172))) ;
  }
  var_cas_outGeneratedCode.appendCString ("\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (175)) ;
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS)") ;
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  var_cas_outGeneratedCode.appendCString ("  GALGAS_") ;
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inResultTypeName.reader_identifierRepresentation ()) ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_16477
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_16690
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16690 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_16690->mRoutineName, operand_16690->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_17017->mFunctionName, operand_17017->mFormalArgumentList, operand_17017->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (450))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_17385
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17385 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_17385->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_17385->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (460))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17770
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17770 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_17770->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (468)), operand_17770->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), ((operand_17770->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (470))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_17770->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (470)))), operand_17770->mAllTypedAttributeList, operand_17770->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17770->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_17770->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_17770->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_17770->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (478)), operand_17770->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (479)), operand_17770->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (480)), operand_17770->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (481)), operand_17770->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), operand_17770->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), operand_17770->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (484)), operand_17770->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_17770->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (486)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_18715
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18715 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_18715->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18715->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18715->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18715->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18715->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_18715->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_18715->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_18715->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (503)), operand_18715->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (504)), operand_18715->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (505)), operand_18715->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), operand_18715->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (507)), operand_18715->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (508)), operand_18715->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), operand_18715->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (510)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_19556
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19556 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_19556->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19556->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19556->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19556->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19556->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_19556->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_19556->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_19556->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_19556->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (528)), operand_19556->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (529)), operand_19556->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (530)), operand_19556->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), operand_19556->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), operand_19556->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (533)), operand_19556->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (534)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_20398
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20398 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_20398->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20398->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20398->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20398->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20398->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20398->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), operand_20398->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (550)), operand_20398->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (551)), operand_20398->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (552)), operand_20398->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), operand_20398->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (554)), operand_20398->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (555)), operand_20398->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), operand_20398->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (557)), operand_20398->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (558)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_21244
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21244 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_21244->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_21244->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_21244->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21244->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), operand_21244->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21244->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), operand_21244->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (574)), operand_21244->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (575)), operand_21244->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (576)), operand_21244->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (577)), operand_21244->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (578)), operand_21244->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (579)), operand_21244->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (580)), operand_21244->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (581)), operand_21244->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (582)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_22090
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_22090 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_22090->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_22090->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_22090->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_22090->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_22090->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (596)), operand_22090->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (597)), operand_22090->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (598)), operand_22090->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (599)), operand_22090->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (600)), operand_22090->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (601)), operand_22090->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (602)), operand_22090->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (603)), operand_22090->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (604)), operand_22090->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (605)), operand_22090->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (606)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_23110 (var_cas_inFilewrapperFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_23110 = NULL ;
while (((operand_23110 = enumerator_23110.nextObject ()))) {
  macroValidPointer (operand_23110) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (618))) ;
}
}
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_23258 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_23258 = NULL ;
while (((operand_23258 = enumerator_23258.nextObject ()))) {
  macroValidPointer (operand_23258) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_23258->mRegularFileSortedList,  operand_23258->mDirectorySortedList,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (621)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_23579
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23579 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_23579->mFilewrapperFileSortedList,  operand_23579->mFilewrapperDirectorySortedList,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (633)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_23579->mFilewrapperName) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_24109
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24109 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_24109->mTypeName, operand_24109->mAbstractCategoryMethodName, operand_24109->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_24490
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_24490 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_24490->mTypeName, operand_24490->mCategoryMethodName, operand_24490->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_25155
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_25348
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25348 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_25348->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (678)), operand_25348->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (679)), operand_25348->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_25685
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_25685 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_25685->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (688)), operand_25685->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (689)), ((operand_25685->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (690))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_25685->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (690)))), operand_25685->mTypedAttributeList, operand_25685->mAllTypedAttributeList, operand_25685->mIsAbstract, operand_25685->mAbstractMethodList, operand_25685->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_26600
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26600 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_26826
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26826 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_26826->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), operand_26826->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (715)), operand_26826->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (716)), operand_26826->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (717))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_27557
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_27779
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27779 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_27779->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (736)), operand_27779->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), operand_27779->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_28208
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28208 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_28208->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (746)), operand_28208->mTypedAttributeList, operand_28208->mInsertMethodList, operand_28208->mSearchMethodList, operand_28208->mRemoveMethodList, operand_28208->mHasInsertOrReplaceModifier, operand_28208->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_28693
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28693 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_28693->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_28693->mTypedAttributeList, operand_28693->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_29080
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29080 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_29080->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (770)), operand_29080->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29080->mConstantList, operand_29080->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_29478
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29478 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_29478->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), operand_29478->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), operand_29478->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), operand_29478->mAssociatedMapTypedAttributeList, operand_29478->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_29953
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29953 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_29953->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (793)), operand_29953->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (794)), ((operand_29953->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (795))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_29953->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (795)))), operand_29953->mTypedAttributeList, operand_29953->mAllTypedAttributeList, operand_29953->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_29953->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_29953->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (798)) COMMA_SOURCE_FILE_AT_LINE (798)), operand_29953->mIsAbstract, operand_29953->mAbstractMethodList, operand_29953->mMethodList, operand_29953->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_30643
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30643 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_30643->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), operand_30643->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), operand_30643->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_31023
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31023 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_31023->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), operand_31023->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (821)), operand_31023->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_31414
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31414 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_31414->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_31414->mRoutineName.reader_identifierRepresentation ()), operand_31414->mFormalArgumentList, operand_31414->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (831))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_32051
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32051 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_32051->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_32051->mFunctionName.reader_identifierRepresentation ()), operand_32051->mFormalArgumentList, operand_32051->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32051->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (853)), operand_32051->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (848)), operand_32051->mFormalArgumentList, operand_32051->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (858))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_32703
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_32703 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_32703->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_32703->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32703->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_32703->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (872)), operand_32703->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (867)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_32703->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (877))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_33419
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_33419 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_33419->mTypeName, operand_33419->mAbstractCategoryMethodName, operand_33419->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
GGS_string function_generateCategoryMethod (C_Compiler & inLexique,
  ...
  GGS_string var_cas_outGeneratedCode ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (907))) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (908))) ;
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_34540 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_34540 = NULL ;
while (((operand_34540 = enumerator_34540.nextObject ()))) {
  macroValidPointer (operand_34540) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_34540->mFormalArgumentCppName) ;
}
}
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_string var_cas_routineBody = GGS_string ("") ;
var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (915)) ;
{
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_34770 (var_cas_inInstructionList, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_34770 = NULL ;
while (((operand_34770 = enumerator_34770.nextObject ()))) {
  macroValidPointer (operand_34770) ;
{ typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_34770->mInstruction.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, operand_34770->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (917)) ;
  }
}
}
}
var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (919)) ;
...
const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
const GGS_bool cond_35292 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
...
const GGS_bool var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (928))) ;
const GGS_bool cond_35570 = var_cas_currentObjectIsUnused ;
if (cond_35570.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
}else if (cond_35570.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("inObject") ;
}
{
GGS_formalParameterListForGeneration::cEnumerator enumerator_35654 (var_cas_inFormalArgumentList, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_35654 = NULL ;
while (((operand_35654 = enumerator_35654.nextObject ()))) {
  macroValidPointer (operand_35654) ;
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (937)) ;
switch (operand_35654->mFormalArgumentPassingMode.enumValue ()) {
case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
  {
var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (940))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentOut:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (944))) ;
var_cas_outGeneratedCode.appendCString (" & ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::enum_argumentIn:
  {
var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (946))) ;
var_cas_outGeneratedCode.appendCString (" ") ;
  }
  break ;
case GGS_formalArgumentPassingModeAST::kNotBuilt:
...
const GGS_bool cond_36432 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_35654->mFormalArgumentCppName) ;
if (cond_36432.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentCppName) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_36432.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (operand_35654->mFormalArgumentCppName) ;
}
}
}
var_cas_outGeneratedCode.appendCString (",\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (956)) ;
var_cas_outGeneratedCode.appendCString ("C_Compiler * ") ;
const GGS_bool cond_36794 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (958))) ;
if (cond_36794.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("/* ") ;
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (959))) ;
var_cas_outGeneratedCode.appendCString (" */") ;
}else if (cond_36794.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (961))) ;
}
var_cas_outGeneratedCode.appendCString ("\n") ;
var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (964)) ;
var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
var_cas_outGeneratedCode.appendCString (") {\n") ;
const GGS_bool cond_37555 = (var_cas_currentObjectIsUnused).operator_not () ;
if (cond_37555.isBuiltAndTrue ()) {
const GGS_bool cond_37241 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
if (cond_37241.isBuiltAndTrue ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
}else if (cond_37241.isBuiltAndFalse ()) {
var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_37798
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_37798 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_37798->mTypeName, GGS_string (""), operand_37798->mCategoryMethodName, operand_37798->mCategoryMethodFormalParameterList, operand_37798->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (984)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_37798->mTypeName, operand_37798->mCategoryMethodName, operand_37798->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_38422
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38422 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_38422->mTypeName, operand_38422->mBaseTypeName, operand_38422->mCategoryMethodName, operand_38422->mCategoryMethodFormalParameterList, operand_38422->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1002)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_38422->mTypeName, operand_38422->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileSortedList::cEnumerator enumerator_39309 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_39309 = NULL ;
while (((operand_39309 = enumerator_39309.nextObject ()))) {
  macroValidPointer (operand_39309) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_39309->mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1028)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_39309->mRegularFileName) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_39309->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1031))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_39309->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1034))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_39309->mRegularFileName.reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_39309->mRegularFileName.reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_39309->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1038))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_40194 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_40194 = NULL ;
while (((operand_40194 = enumerator_40194.nextObject ()))) {
  macroValidPointer (operand_40194) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_40194->mDirectoryName,  operand_40194->mWrapperDirectoryIndex,  operand_40194->mRegularFileSortedList,  operand_40194->mDirectorySortedList,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1043)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1055))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1056)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1056))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileSortedList::cEnumerator enumerator_40812 (var_cas_inFilewrapperRegularFileSortedList, true) ;
const GGS_wrapperFileSortedList::cElement * operand_40812 = NULL ;
while (((operand_40812 = enumerator_40812.nextObject ()))) {
  macroValidPointer (operand_40812) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_40812->mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1058))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1065))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1066)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectorySortedList::cEnumerator enumerator_41438 (var_cas_inFilewrapperDirectorySortedList, true) ;
const GGS_wrapperDirectorySortedList::cElement * operand_41438 = NULL ;
while (((operand_41438 = enumerator_41438.nextObject ()))) {
  macroValidPointer (operand_41438) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_41438->mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1068))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileSortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1077))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1078))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectorySortedList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1079))) ;
var_cas_ioImplementation.appendCString (",\n"
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_42569
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42569 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_42569->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_42569->mFilewrapperFileSortedList,  operand_42569->mFilewrapperDirectorySortedList,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1088)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_42569->mFilewrapperName, var_cas_filewrapperImplementation) ;
  }
  return var_cas_outImplementation ;
}
