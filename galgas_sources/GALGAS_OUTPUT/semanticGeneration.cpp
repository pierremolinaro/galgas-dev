...
result << ") ;\n"
  "\n" ;
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenerateTypeDescriptorMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (12)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_2022 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_2022 = NULL ;
while (((operand_2022 = enumerator_2022.nextObject ()))) {
macroValidPointer (operand_2022) ;
result << "//--- Concrete method " ;
result << operand_2022->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
result << "\n"
  "  private : virtual void method_" ;
result << operand_2022->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterListForGeneration::cEnumerator enumerator_2180 (operand_2022->mSignature, true) ;
const GGS_formalParameterListForGeneration::cElement * operand_2180 = NULL ;
while (((operand_2180 = enumerator_2180.nextObject ()))) {
macroValidPointer (operand_2180) ;
if ((operand_2180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).boolValue ()) {
result << "const GALGAS_" ;
result << operand_2180->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
result << " " ;
}else if ((operand_2180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (52))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2180->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
result << " & " ;
}else if ((operand_2180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (54))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2180->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
result << " & " ;
}else if ((operand_2180->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (56))).boolValue ()) {
result << "GALGAS_" ;
result << operand_2180->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
result << " " ;
}else {
}
result << operand_2180->mFormalArgumentCppName ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
result << "C_Compiler * inCompiler\n" ;
...
template_filewrapper_typeGenerationTemplate_rootClassTypeSpecificImplementation (C_Compiler & inLexique,
  ...
  const bool isBuilt = var_cas_TYPE_NAME.isBuilt ()
    ...
    && var_cas_INSTANCE_METHOD_MAP.isBuilt () ;
  if (isBuilt) {
result << "const C_galgas_type_descriptor * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::typeDescriptor (void) const {\n"
...
GGS_typedAttributeList::cEnumerator enumerator_3428 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3428 = NULL ;
while (((operand_3428 = enumerator_3428.nextObject ()))) {
macroValidPointer (operand_3428) ;
result << "  if (kOperandEqual == result) {\n"
  "    result = mObjectPtr->mAttribute_" ;
result << operand_3428->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4386 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4386 = NULL ;
while (((operand_4386 = enumerator_4386.nextObject ()))) {
macroValidPointer (operand_4386) ;
result << "const GALGAS_" ;
result << operand_4386->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " & inAttribute_" ;
result << operand_4386->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " result ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_4747 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4747 = NULL ;
while (((operand_4747 = enumerator_4747.nextObject ()))) {
macroValidPointer (operand_4747) ;
result << "inAttribute_" ;
result << operand_4747->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4963 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4963 = NULL ;
while (((operand_4963 = enumerator_4963.nextObject ()))) {
macroValidPointer (operand_4963) ;
result << "inAttribute_" ;
result << operand_4963->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_4963.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5538 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
...
if (enumerator_5538.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5801 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5801 = NULL ;
while (((operand_5801 = enumerator_5801.nextObject ()))) {
macroValidPointer (operand_5801) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5801->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5801->mSignature, operand_5801->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (171)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_6216 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6216 = NULL ;
while (((operand_6216 = enumerator_6216.nextObject ()))) {
macroValidPointer (operand_6216) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_6216->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_6216->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_6216->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    result = mObjectPtr->mAttribute_" ;
result << operand_6216->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_6764 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6764->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_6764->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
  "    mObjectPtr->mAttribute_" ;
result << operand_6764->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
}
GGS_instanceMethodMap::cEnumerator enumerator_7301 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_7301 = NULL ;
while (((operand_7301 = enumerator_7301.nextObject ()))) {
macroValidPointer (operand_7301) ;
if ((((operand_7301->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (205)))).operator_or ((operand_7301->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (205))))).operator_or ((operand_7301->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (205)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_" ;
result << operand_7301->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7655 (operand_7301->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7655 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7655 = enumerator_7655.nextObject ()))) {
macroValidPointer (operand_7655) ;
if ((operand_7655->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7655->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ;
}else if ((operand_7655->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (211))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7655->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (212)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (212)) ;
}else if ((operand_7655->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (213))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7655->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
}else {
result << "GALGAS_" ;
result << operand_7655->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
}
if (enumerator_7655.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_7301->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7301->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << operand_7301->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_8941 (operand_7301->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8941 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8941 = enumerator_8941.nextObject ()))) {
macroValidPointer (operand_8941) ;
if ((operand_8941->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (239))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
result << ", " ;
}else if ((operand_8941->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (241))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) ;
result << ", " ;
}else if ((operand_8941->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (243))).boolValue ()) {
result << "outArgument" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9865 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9865 = NULL ;
while (((operand_9865 = enumerator_9865.nextObject ()))) {
macroValidPointer (operand_9865) ;
result << "const GALGAS_" ;
result << operand_9865->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
result << " & in_" ;
result << operand_9865->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << ") :\n"
  "cPtr_class (THERE)" ;
GGS_typedAttributeList::cEnumerator enumerator_10183 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10183 = NULL ;
while (((operand_10183 = enumerator_10183.nextObject ()))) {
macroValidPointer (operand_10183) ;
result << ",\n"
  "mAttribute_" ;
result << operand_10183->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_10183->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_NAME ;
result << ":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11178 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11178 = NULL ;
while (((operand_11178 = enumerator_11178.nextObject ()))) {
macroValidPointer (operand_11178) ;
result << "  mAttribute_" ;
result << operand_11178->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation+1) ;\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_1303 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_2541 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2541 = NULL ;
while (((operand_2541 = enumerator_2541.nextObject ()))) {
macroValidPointer (operand_2541) ;
result << "const GALGAS_" ;
result << operand_2541->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
result << " & constinAttribute_" ;
result << operand_2541->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_2541.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_2902 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2902 = NULL ;
while (((operand_2902 = enumerator_2902.nextObject ()))) {
macroValidPointer (operand_2902) ;
result << "constinAttribute_" ;
result << operand_2902->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_2902.hasNextObject ()) {
result << ", " ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_3128 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3953 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3953 = NULL ;
while (((operand_3953 = enumerator_3953.nextObject ()))) {
macroValidPointer (operand_3953) ;
result << "const GALGAS_" ;
result << operand_3953->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
result << " & inAttribute_" ;
result << operand_3953->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3953.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << " result ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_4314 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4314 = NULL ;
while (((operand_4314 = enumerator_4314.nextObject ()))) {
macroValidPointer (operand_4314) ;
result << "inAttribute_" ;
result << operand_4314->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
if (enumerator_4314.hasNextObject ()) {
result << " && " ;
}
}
result << ") {\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4530 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
...
result << "inAttribute_" ;
result << operand_4530->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5402 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5402 = NULL ;
while (((operand_5402 = enumerator_5402.nextObject ()))) {
macroValidPointer (operand_5402) ;
result << "p->mAttribute_" ;
result << operand_5402->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_5402.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5656 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5656 = NULL ;
while (((operand_5656 = enumerator_5656.nextObject ()))) {
macroValidPointer (operand_5656) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5656->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5656->mSignature, operand_5656->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (150)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_6070 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_6070->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_6070->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_6070->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    const cPtr_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_6766 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6766 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6766->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_6766->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_6766->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
}
GGS_instanceMethodMap::cEnumerator enumerator_7433 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_7433 = NULL ;
while (((operand_7433 = enumerator_7433.nextObject ()))) {
macroValidPointer (operand_7433) ;
if ((((operand_7433->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).operator_or ((operand_7433->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (187))))).operator_or ((operand_7433->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (187)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::method_" ;
result << operand_7433->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7787 (operand_7433->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7787 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7787 = enumerator_7787.nextObject ()))) {
macroValidPointer (operand_7787) ;
if ((operand_7787->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7787->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
}else if ((operand_7787->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (193))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7787->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
}else if ((operand_7787->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (195))).boolValue ()) {
result << "GALGAS_" ;
result << operand_7787->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
}else {
result << "GALGAS_" ;
result << operand_7787->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ;
}
...
if ((operand_7433->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7433->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << operand_7433->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_9225 (operand_7433->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9225 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9225 = enumerator_9225.nextObject ()))) {
macroValidPointer (operand_9225) ;
if ((operand_9225->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
result << ", " ;
}else if ((operand_9225->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
result << ", " ;
}else if ((operand_9225->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (227))).boolValue ()) {
result << "outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ;
result << ", " ;
}else {
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10149 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10149 = NULL ;
while (((operand_10149 = enumerator_10149.nextObject ()))) {
macroValidPointer (operand_10149) ;
result << "const GALGAS_" ;
result << operand_10149->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " & in_" ;
result << operand_10149->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_10149.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_10486 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
...
result << ")" ;
GGS_typedAttributeList::cEnumerator enumerator_10704 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10704 = NULL ;
while (((operand_10704 = enumerator_10704.nextObject ()))) {
macroValidPointer (operand_10704) ;
result << ",\n"
  "mAttribute_" ;
result << operand_10704->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_10704->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_NAME ;
result << ":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11699 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11699 = NULL ;
while (((operand_11699 = enumerator_11699.nextObject ()))) {
macroValidPointer (operand_11699) ;
result << "  mAttribute_" ;
result << operand_11699->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation+1) ;\n" ;
if (enumerator_11699.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \"]\" ;\n"
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_16129
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16129 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_16342
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16342 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_16342->mRoutineName, operand_16342->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_16669
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16669 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16669->mFunctionName, operand_16669->mFormalArgumentList, operand_16669->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (434))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_17037
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17037 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_17037->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_17037->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (444))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17422
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17422 != NULL) {
const GGS_bool cond_17682 = operand_17422->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (451)) ;
if (cond_17682.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader1 (inLexique, operand_17422->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (453)), operand_17422->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (454)), operand_17422->mAllTypedAttributeList, operand_17422->mIsAbstract) ;
}else if (cond_17682.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader1 (inLexique, operand_17422->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (460)), operand_17422->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (461)), operand_17422->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (462)), operand_17422->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (463)), operand_17422->mAllTypedAttributeList, operand_17422->mIsAbstract) ;
}
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17422->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_17422->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_17422->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_17422->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_17422->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_17422->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_17422->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_17422->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_17422->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_17422->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (478)), operand_17422->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (479)), operand_17422->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (480)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_18643
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18643 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_18643->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), operand_18643->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (489)), operand_18643->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18643->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_18643->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18643->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18643->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18643->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18643->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_18643->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18643->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_18643->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_18643->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_18643->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (503)), operand_18643->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (504)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_19484
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19484 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_19484->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (512)), operand_19484->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (513)), operand_19484->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19484->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_19484->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19484->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19484->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19484->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19484->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_19484->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19484->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_19484->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_19484->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_19484->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_19484->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (528)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_20326
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20326 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_20326->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (536)), operand_20326->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (537)), operand_20326->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20326->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (541)), operand_20326->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20326->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20326->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20326->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20326->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20326->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20326->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20326->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (549)), operand_20326->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (550)), operand_20326->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (551)), operand_20326->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (552)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_21172
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21172 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_21172->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (560)), operand_21172->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (561)), operand_21172->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21172->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_21172->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_21172->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_21172->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (568)), operand_21172->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_21172->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (570)), operand_21172->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), operand_21172->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21172->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (573)), operand_21172->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (574)), operand_21172->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (575)), operand_21172->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (576)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_22018
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_22018 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_22018->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (584)), operand_22018->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (585)), operand_22018->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_22018->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_22018->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_22018->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_22018->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_22018->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), operand_22018->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (594)), operand_22018->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_22018->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (596)), operand_22018->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (597)), operand_22018->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (598)), operand_22018->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (599)), operand_22018->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (600)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23166
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_23359
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23359 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_23359->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (618)), operand_23359->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (619)), operand_23359->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_23696
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23696 != NULL) {
const GGS_bool cond_24002 = operand_23696->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (627)) ;
if (cond_24002.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader2 (inLexique, operand_23696->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (629)), operand_23696->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), operand_23696->mAllTypedAttributeList, operand_23696->mAbstractMethodList, operand_23696->mMethodList, operand_23696->mIsAbstract) ;
}else if (cond_24002.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader2 (inLexique, operand_23696->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (638)), operand_23696->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (639)), operand_23696->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (640)), operand_23696->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (641)), operand_23696->mTypedAttributeList, operand_23696->mAllTypedAttributeList, operand_23696->mIsAbstract, operand_23696->mAbstractMethodList, operand_23696->mMethodList) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_24939
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_25165
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25165 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_25165->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (666)), operand_25165->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (667)), operand_25165->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (668)), operand_25165->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (669))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_25896
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25896 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_26118
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26118 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_listmapTypeSpecificImplementation (inLexique, operand_26118->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (688)), operand_26118->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (689)), operand_26118->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_26549
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26549 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_26549->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (698)), operand_26549->mTypedAttributeList, operand_26549->mInsertMethodList, operand_26549->mSearchMethodList, operand_26549->mRemoveMethodList, operand_26549->mHasInsertOrReplaceModifier, operand_26549->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_27034
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27034 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_27034->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (712)), operand_27034->mTypedAttributeList, operand_27034->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_27421
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27421 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_27421->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (722)), operand_27421->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (723)), operand_27421->mConstantList, operand_27421->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_27819
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27819 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapProxyTypeSpecificImplementation (inLexique, operand_27819->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (733)), operand_27819->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), operand_27819->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (735)), operand_27819->mAssociatedMapTypedAttributeList, operand_27819->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_28296
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28296 != NULL) {
const GGS_bool cond_28802 = operand_28296->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (744)) ;
if (cond_28802.isBuiltAndTrue ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_rootClassTypeSpecificImplementation (inLexique, operand_28296->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (746)), operand_28296->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (747)), operand_28296->mTypedAttributeList, operand_28296->mAllTypedAttributeList, operand_28296->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28296->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28296->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (750)) COMMA_SOURCE_FILE_AT_LINE (750)), operand_28296->mIsAbstract, operand_28296->mAbstractMethodList, operand_28296->mMethodList, operand_28296->mInstanceMethodMap) ;
}else if (cond_28802.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_inheritedClassTypeSpecificImplementation (inLexique, operand_28296->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (758)), operand_28296->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (759)), operand_28296->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_28296->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_28296->mTypedAttributeList, operand_28296->mAllTypedAttributeList, operand_28296->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28296->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28296->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)), operand_28296->mIsAbstract, operand_28296->mAbstractMethodList, operand_28296->mMethodList, operand_28296->mInstanceMethodMap) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_29510
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29510 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_29510->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (777)), operand_29510->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (778)), operand_29510->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_29890
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29890 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_29890->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), operand_29890->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (788)), operand_29890->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_30281
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30281 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_30281->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_30281->mRoutineName.reader_identifierRepresentation ()), operand_30281->mFormalArgumentList, operand_30281->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (798))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_30918
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30918 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_30918->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_30918->mFunctionName.reader_identifierRepresentation ()), operand_30918->mFormalArgumentList, operand_30918->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_30918->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), operand_30918->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (815)), operand_30918->mFormalArgumentList, operand_30918->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (824))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_31541
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31541 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_31541->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_31541->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31541->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_31541->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (838)), operand_31541->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (833)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31541->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (842))) ;
  }
  return var_cas_outImplementation ;
}
