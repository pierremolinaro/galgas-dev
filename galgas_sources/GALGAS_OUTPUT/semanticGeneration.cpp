...
GGS_withAccessorMap::cEnumerator enumerator_21545 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21545 = NULL ;
...
result << operand_21545->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_21545->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (514)) ;
result << " * inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_22219 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22219 = NULL ;
while (((operand_22219 = enumerator_22219.nextObject ()))) {
macroValidPointer (operand_22219) ;
result << "    public : GALGAS_" ;
result << operand_22219->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) ;
result << " * attribute_" ;
result << operand_22219->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << " * source = ioObject ;\n"
  ...
  "}\n"
  "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_1590 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_1590 = NULL ;
while (((operand_1590 = enumerator_1590.nextObject ()))) {
macroValidPointer (operand_1590) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_1590->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_1828 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1828 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_1828->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (45)) ;
result << " * inArgument" ;
...
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (49)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_2136 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2136 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2136 = enumerator_2136.nextObject ()))) {
macroValidPointer (operand_2136) ;
result << ", inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "} ;\n" ;
const GGS_uint indentation_2599 = GGS_uint (2U) ;
if (indentation_2599.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_2599.uintValue ()) ;
}
result << "const utf32 kInsertErrorMessage [" ;
result << operand_1590->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (55)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
result << "] = " ;
result << operand_1590->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "const utf32 kShadowErrorMessage [" ;
result << operand_1590->mShadowErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (56)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (56)) ;
result << "] = " ;
result << operand_1590->mShadowErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_2638 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_2638 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_2638->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_2638->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (64)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
result << "] = " ;
result << operand_2638->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_3153 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3153 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3153 = enumerator_3153.nextObject ()))) {
macroValidPointer (operand_3153) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_3153->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
result << " * & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_3909 = GGS_uint (2U) ;
if (indentation_3909.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_3909.uintValue ()) ;
}
...
result << " COMMA_THERE) ;\n"
  "if (NULL != attributes) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3592 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3592 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3592 = enumerator_3592.nextObject ()))) {
macroValidPointer (operand_3592) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << " = (GALGAS_" ;
result << operand_3592->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << " *) attributes [" ;
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << "] ;\n"
  "  macroValidObject (outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
result << ", GALGAS_" ;
result << operand_3592->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_3949 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_3949 = NULL ;
while (((operand_3949 = enumerator_3949.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3949->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4187 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4187 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4187 = enumerator_4187.nextObject ()))) {
macroValidPointer (operand_4187) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4187->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_5053 = GGS_uint (2U) ;
if (indentation_5053.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_5053.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_3949->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (94)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) ;
result << "] = " ;
result << operand_3949->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "GALGAS_root ** attributes = performRemove (inKey, inCompiler, kRemoveErrorMessage COMMA_THERE) ;\n"
  "if (NULL != attributes) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4689 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4689 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4689 = enumerator_4689.nextObject ()))) {
macroValidPointer (operand_4689) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
result << " = (GALGAS_" ;
result << operand_4689->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
result << " *) attributes [" ;
...
result << ", GALGAS_" ;
result << operand_4689->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring * inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5304 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5304 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5304 = enumerator_5304.nextObject ()))) {
macroValidPointer (operand_5304) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5304->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) ;
result << " * inArgument" ;
...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  GALGAS_root * attributes [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (114)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5581 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5581 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5581 = enumerator_5581.nextObject ()))) {
macroValidPointer (operand_5581) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_5733 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5733 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5733 = enumerator_5733.nextObject ()))) {
macroValidPointer (operand_5733) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5733->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5733->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                                               " ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (128)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
result << " COMMA_THERE) ;\n"
  "  macroNullOrValidObject (result, GALGAS_" ;
result << operand_5733->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
result << ") ;\n"
  "  return (GALGAS_" ;
result << operand_5733->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
result << " *) result ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_typedAttributeList::cEnumerator enumerator_6510 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6510 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6510 = enumerator_6510.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6510->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_string * inKey,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6510->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
...
result << var_cas_IDX.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (140)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
result << " COMMA_THERE) ;\n"
  "}\n"
  "\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_withAccessorMap::cEnumerator enumerator_7486 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_7486 = NULL ;
...
result << operand_7486->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7486->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
result << " * inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_7486->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (161))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
