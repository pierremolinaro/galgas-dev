...
if (((((var_cas_SUPPORTED_OPERATORS).operator_and ((function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (208))))).operator_isNotEqual (GGS_uint (0U))).operator_or ((var_cas_MODIFIER_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)))).operator_or ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U))).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (323)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
GGS_nativeAttributeList::cEnumerator enumerator_13546 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_13546 = NULL ;
while (((operand_13546 = enumerator_13546.nextObject ()))) {
macroValidPointer (operand_13546) ;
result << "  private : " ;
if (operand_13546->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_13546->mCppClassName ;
result << " " ;
if (operand_13546->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_13546->mAttributeName ;
result << " ;\n" ;
if ((operand_13546->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if ((operand_13546->mIsConst).operator_not ().boolValue ()) {
...
result << operand_13546->mGetterName ;
result << " (void) { return " ;
result << operand_13546->mAttributeName ;
result << " ; }\n" ;
}else {
...
GGS_typedAttributeList::cEnumerator enumerator_14075 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
...
result << "  public : GALGASap_" ;
result << operand_14075->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (342)) ;
result << " mAttribute_" ;
result << operand_14075->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (345)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (352)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_15107 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_15107 = NULL ;
while (((operand_15107 = enumerator_15107.nextObject ()))) {
macroValidPointer (operand_15107) ;
result << "  friend capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_15107->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_15107->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (364)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_15886 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_15886 = NULL ;
while (((operand_15886 = enumerator_15886.nextObject ()))) {
macroValidPointer (operand_15886) ;
result << "    public : GALGASap_" ;
result << operand_15886->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (380)) ;
result << " attribute_" ;
result << operand_15886->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_modifierMap::cEnumerator enumerator_16217 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_16217 = NULL ;
while (((operand_16217 = enumerator_16217.nextObject ()))) {
macroValidPointer (operand_16217) ;
if ((operand_16217->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (394))).boolValue ()) {
result << "void modifierCall_" ;
result << operand_16217->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_16401 (operand_16217->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_16401 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_16401 = enumerator_16401.nextObject ()))) {
macroValidPointer (operand_16401) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_16401->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (398))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16401->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (399)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (399)) ;
}else if ((operand_16401->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (400))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16401->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (401)) ;
}else if ((operand_16401->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (402))).boolValue ()) {
result << "GALGASap_" ;
result << operand_16401->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (403)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (403)) ;
}else {
result << "GALGASap_" ;
result << operand_16401->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (405)) ;
result << " inArgument" ;
...
if (operand_16217->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_17441 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_17441 = NULL ;
while (((operand_17441 = enumerator_17441.nextObject ()))) {
macroValidPointer (operand_17441) ;
if (((operand_17441->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (421)))).operator_or ((operand_17441->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (421)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_17441->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_17679 (operand_17441->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_17679 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_17679 = enumerator_17679.nextObject ()))) {
macroValidPointer (operand_17679) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_17679->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (425))).boolValue ()) {
result << "GALGASap_" ;
result << operand_17679->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (426)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (426)) ;
}else if ((operand_17679->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (427))).boolValue ()) {
result << "GALGASap_" ;
result << operand_17679->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (428)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (428)) ;
}else if ((operand_17679->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (429))).boolValue ()) {
result << "GALGASap_" ;
result << operand_17679->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (430)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (430)) ;
}else {
result << "GALGASap_" ;
result << operand_17679->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (432)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (432)) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_17441->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_18753 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_18753 = NULL ;
while (((operand_18753 = enumerator_18753.nextObject ()))) {
macroValidPointer (operand_18753) ;
result << "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_18753->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_18753->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (450)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << "//---\n"
  "  if (ioResult.isValid ()) {\n"
  "    ioResult.insulate (THERE) ;\n"
  "    ioResult.ptr (HERE)->modifier_" ;
result << operand_2341->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_4049 (operand_2341->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_4049 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4049 = enumerator_4049.nextObject ()))) {
macroValidPointer (operand_4049) ;
if ((operand_4049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (97))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
}else if ((operand_4049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (99))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
}else if ((operand_4049->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (101))).boolValue ()) {
result << "outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
}else {
result << "inArgument" ;
...
if (enumerator_4049.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
GGS_instanceMethodMap::cEnumerator enumerator_4996 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_4996 = NULL ;
while (((operand_4996 = enumerator_4996.nextObject ()))) {
macroValidPointer (operand_4996) ;
if (((operand_4996->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (129)))).operator_or ((operand_4996->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (129)))).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void instanceMethodCall_" ;
result << operand_4996->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_5323 (operand_4996->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_5323 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5323 = enumerator_5323.nextObject ()))) {
macroValidPointer (operand_5323) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_5323->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (134))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5323->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
}else if ((operand_5323->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (136))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5323->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
}else if ((operand_5323->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (138))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5323->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
}else {
result << "GALGASap_" ;
result << operand_5323->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << " inArgument" ;
...
if (operand_4996->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << ") {\n"
  "//--- Release 'output' arguments\n" ;
GGS_formalParameterSignature::cEnumerator enumerator_6316 (operand_4996->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6316 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6316 = enumerator_6316.nextObject ()))) {
macroValidPointer (operand_6316) ;
if ((operand_6316->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (153))).boolValue ()) {
result << "  outArgument" ;
...
result << operand_4996->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_6650 (operand_4996->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6650 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6650 = enumerator_6650.nextObject ()))) {
macroValidPointer (operand_6650) ;
if ((operand_6650->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (161))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
}else if ((operand_6650->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
}else if ((operand_6650->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (165))).boolValue ()) {
result << "outArgument" ;
...
if ((operand_4996->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_4996->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_8136 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8136 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8136 = enumerator_8136.nextObject ()))) {
macroValidPointer (operand_8136) ;
result << ",\n"
  "attribute_" ;
result << operand_8136->mEnumerationName.reader_identifierRepresentation () ;
result << " ()" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_8738 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8738 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8738 = enumerator_8738.nextObject ()))) {
macroValidPointer (operand_8738) ;
result << "  attribute_" ;
result << operand_8738->mEnumerationName.reader_identifierRepresentation () ;
result << " = p->mAttribute_" ;
result << operand_8738->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5935 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5935 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5935 = enumerator_5935.nextObject ()))) {
macroValidPointer (operand_5935) ;
result << "GALGASap_" ;
result << operand_5935->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (157)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (157)) ;
if (enumerator_5935.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6266 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6266 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6266 = enumerator_6266.nextObject ()))) {
macroValidPointer (operand_6266) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
if (enumerator_6266.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6615 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6615 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6615 = enumerator_6615.nextObject ()))) {
macroValidPointer (operand_6615) ;
result << "GALGASap_" ;
result << operand_6615->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) ;
result << " inOperand" ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_6817 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6817 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6817 = enumerator_6817.nextObject ()))) {
macroValidPointer (operand_6817) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
result << ".isValid ()" ;
if (enumerator_6817.hasNextObject ()) {
result << " && " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7039 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7039 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_7039.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7384 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7384 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7384 = enumerator_7384.nextObject ()))) {
macroValidPointer (operand_7384) ;
result << "GALGASap_" ;
result << operand_7384->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7817 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7817 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7995 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7995 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7995 = enumerator_7995.nextObject ()))) {
macroValidPointer (operand_7995) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
result << " = p->mAttribute_" ;
result << operand_7995->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8293 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8293 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8293 = enumerator_8293.nextObject ()))) {
macroValidPointer (operand_8293) ;
result << "GALGASap_" ;
result << operand_8293->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8725 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8725 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8725 = enumerator_8725.nextObject ()))) {
macroValidPointer (operand_8725) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8903 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8903 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8903 = enumerator_8903.nextObject ()))) {
macroValidPointer (operand_8903) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
result << " = p->mAttribute_" ;
result << operand_8903->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_first (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9197 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9197 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9197 = enumerator_9197.nextObject ()))) {
macroValidPointer (operand_9197) ;
result << "GALGASap_" ;
result << operand_9197->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (255)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9622 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9622 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9622 = enumerator_9622.nextObject ()))) {
macroValidPointer (operand_9622) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9800 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9800 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " = p->mAttribute_" ;
result << operand_9800->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10093 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10093 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10093 = enumerator_10093.nextObject ()))) {
macroValidPointer (operand_10093) ;
result << "GALGASap_" ;
result << operand_10093->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (280)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10517 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10517 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10517 = enumerator_10517.nextObject ()))) {
macroValidPointer (operand_10517) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10695 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10695 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_10695->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "  }\n"
  "}\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13049 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13049 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13049 = enumerator_13049.nextObject ()))) {
macroValidPointer (operand_13049) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_13049->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_13049->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (358)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_uint inIndex,\n"
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_13049->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inOperand ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13995 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13995 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13995 = enumerator_13995.nextObject ()))) {
macroValidPointer (operand_13995) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_13995->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (373)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_13995->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_uint & inIndex,\n"
  "                                              " ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGASap_" ;
result << operand_13995->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (378)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "::constructor_emptyMap (THERE) ;\n"
  ...
  "}\n"
  "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_4502 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_4502 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_4502->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4740 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4740 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4740 = enumerator_4740.nextObject ()))) {
macroValidPointer (operand_4740) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_4740->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (114)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5095 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5095 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5095 = enumerator_5095.nextObject ()))) {
macroValidPointer (operand_5095) ;
result << ", inArgument" ;
...
result << " COMMA_HERE)) ;\n"
  "  capCollectionElement attributes (p) ;\n" ;
const GGS_uint indentation_5616 = GGS_uint (2U) ;
if (indentation_5616.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_5616.uintValue ()) ;
}
result << "const utf32 kInsertErrorMessage [" ;
result << operand_4502->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (126)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
result << "] = " ;
result << operand_4502->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "const utf32 kShadowErrorMessage [" ;
result << operand_4502->mShadowErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (127)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
result << "] = " ;
result << operand_4502->mShadowErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_5655 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_5655 = NULL ;
while (((operand_5655 = enumerator_5655.nextObject ()))) {
macroValidPointer (operand_5655) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "static const utf32 kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5655->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_5655->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (135)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << "] = " ;
result << operand_5655->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_6170 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6170 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_6170->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_6963 = GGS_uint (2U) ;
if (indentation_6963.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6963.uintValue ()) ;
}
...
result << " = p->mAttribute_" ;
result << operand_6799->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_7003 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_7003 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_7003->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7241 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7241 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7241 = enumerator_7241.nextObject ()))) {
macroValidPointer (operand_7241) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_7241->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_8117 = GGS_uint (2U) ;
if (indentation_8117.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_8117.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_7003->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (166)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
result << "] = " ;
result << operand_7003->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7953 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7953 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7953 = enumerator_7953.nextObject ()))) {
macroValidPointer (operand_7953) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (173)) ;
result << " = p->mAttribute_" ;
result << operand_7953->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_8368 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8368 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8368 = enumerator_8368.nextObject ()))) {
macroValidPointer (operand_8368) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_8368->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
result << " * inArgument" ;
...
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_8647 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8647 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
GGS_typedAttributeList::cEnumerator enumerator_8799 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8799 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8799 = enumerator_8799.nextObject ()))) {
macroValidPointer (operand_8799) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_8799->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_8799->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGASap_" ;
result << operand_8799->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_9797 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9797 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9797 = enumerator_9797.nextObject ()))) {
macroValidPointer (operand_9797) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_9797->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_9797->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_9797->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_10701 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_10701 = NULL ;
while (((operand_10701 = enumerator_10701.nextObject ()))) {
macroValidPointer (operand_10701) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_10701->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_10701->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_10701->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
GGS_typedAttributeList::cEnumerator enumerator_6429 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6429 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6429 = enumerator_6429.nextObject ()))) {
macroValidPointer (operand_6429) ;
result << "GALGASap_" ;
result << operand_6429->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (154)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154)) ;
if (enumerator_6429.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL0 ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6821 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6821 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6821 = enumerator_6821.nextObject ()))) {
macroValidPointer (operand_6821) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
...
result << "::addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7181 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7181 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7181 = enumerator_7181.nextObject ()))) {
macroValidPointer (operand_7181) ;
result << "GALGASap_" ;
result << operand_7181->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
result << " inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7512 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7512 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7512 = enumerator_7512.nextObject ()))) {
macroValidPointer (operand_7512) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
if (enumerator_7512.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8785 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8785 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8785 = enumerator_8785.nextObject ()))) {
macroValidPointer (operand_8785) ;
result << "GALGASap_" ;
result << operand_8785->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9239 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9239 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9239 = enumerator_9239.nextObject ()))) {
macroValidPointer (operand_9239) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9417 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9417 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_9417->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9719 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9719 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9719 = enumerator_9719.nextObject ()))) {
macroValidPointer (operand_9719) ;
result << "GALGASap_" ;
result << operand_9719->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10648 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10648 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10648 = enumerator_10648.nextObject ()))) {
macroValidPointer (operand_10648) ;
result << "GALGASap_" ;
result << operand_10648->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11099 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11099 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11099 = enumerator_11099.nextObject ()))) {
macroValidPointer (operand_11099) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11277 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11277 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_11277->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_11574 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11574 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11574 = enumerator_11574.nextObject ()))) {
macroValidPointer (operand_11574) ;
result << "GALGASap_" ;
result << operand_11574->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12025 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12025 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12025 = enumerator_12025.nextObject ()))) {
macroValidPointer (operand_12025) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12203 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12203 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12203 = enumerator_12203.nextObject ()))) {
macroValidPointer (operand_12203) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (312)) ;
result << " = p->mAttribute_" ;
result << operand_12203->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_new (" ;
GGS_typedAttributeList::cEnumerator enumerator_5178 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5178 = NULL ;
while (((operand_5178 = enumerator_5178.nextObject ()))) {
macroValidPointer (operand_5178) ;
result << "ptr (HERE)->mAttribute_" ;
result << operand_5178->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_5178.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE) ;\n"
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5381 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5381 = NULL ;
while (((operand_5381 = enumerator_5381.nextObject ()))) {
macroValidPointer (operand_5381) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5381->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5381->mSignature, operand_5381->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (137)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5802 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5802 = NULL ;
while (((operand_5802 = enumerator_5802.nextObject ()))) {
macroValidPointer (operand_5802) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5802->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5802->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5802->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
...
GGS_typedAttributeList::cEnumerator enumerator_6210 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6210 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6210->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_6210->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  mAttribute_" ;
result << operand_6210->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "}\n"
  "\n" ;
}
