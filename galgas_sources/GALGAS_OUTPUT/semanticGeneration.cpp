...
template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
      ...
      columnMarker = result.currentColumn () ;
      GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7738 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
      const GGS_unifiedTypeMapProxyList::cElement * operand_7738 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_7738 = enumerator_7738.nextObject ()))) {
      macroValidPointer (operand_7738) ;
      result << "GALGASap_" ;
      result << operand_7738->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
      result << " inOperand" ;
...
GGS_readerMap::cEnumerator enumerator_7990 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_7990 = NULL ;
while (((operand_7990 = enumerator_7990.nextObject ()))) {
  macroValidPointer (operand_7990) ;
  if (((operand_7990->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).operator_or ((operand_7990->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (193)))).boolValue ()) {
    result << "public : GALGASap_" ;
    result << operand_7990->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
    result << " readerCall_" ;
    result << operand_7990->mKey.ggs_string ().reader_identifierRepresentation () ;
    result << " (" ;
    columnMarker = result.currentColumn () ;
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_8254 (operand_7990->mInfo.mArgumentTypeList, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_8254 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_8254 = enumerator_8254.nextObject ()))) {
    macroValidPointer (operand_8254) ;
    result << "GALGASap_" ;
    result << operand_8254->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
    result << " & constinOperand" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
    if (enumerator_8254.hasNextObject ()) {
      result << ",\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
    }
    var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_7990->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
  if (operand_7990->mInfo.mHasCompilerArgument.boolValue ()) {
    result << "C_Compiler * inCompiler\n" ;
    result.appendSpacesUntilColumn (columnMarker) ;
    result << "COMMA_LOCATION_ARGS" ;
  }else {
...
}else if (operand_7990->mInfo.mHasCompilerArgument.boolValue ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  result << "C_Compiler * inCompiler\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
...
if (((((var_cas_SUPPORTED_OPERATORS).operator_and ((function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (214))))).operator_isNotEqual (GGS_uint (0U))).operator_or ((var_cas_MODIFIER_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)))).operator_or ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U))).boolValue ()) {
...
GGS_modifierMap::cEnumerator enumerator_9129 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_9129 = NULL ;
while (((operand_9129 = enumerator_9129.nextObject ()))) {
macroValidPointer (operand_9129) ;
if ((operand_9129->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).boolValue ()) {
result << "public : void modifierCall_" ;
result << operand_9129->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9282 (operand_9129->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9282 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9282 = enumerator_9282.nextObject ()))) {
macroValidPointer (operand_9282) ;
if ((operand_9282->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9282->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
  result << " inArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
}else if ((operand_9282->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9282->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
  result << " & ioArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
}else if ((operand_9282->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (230))).boolValue ()) {
  result << "GALGASap_" ;
  result << operand_9282->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
  result << " & outArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
}else {
  result << "GALGASap_" ;
  result << operand_9282->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
  result << " inArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
}
if (enumerator_9282.hasNextObject ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9129->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9129->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_9129->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1539 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1539 = NULL ;
while (((operand_1539 = enumerator_1539.nextObject ()))) {
macroValidPointer (operand_1539) ;
result << "GALGASap_" ;
result << operand_1539->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
result << " & in_" ;
result << operand_1539->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << ") ;\n" ;
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (47)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- << and >> shift operators\n"
  "public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " left_shift_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (55)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- .= operator\n"
  "public : void dotAssign_operation (GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inOperand\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (61)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_and (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (67)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- | operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_or (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (73)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ^ operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_xor (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (79)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_not (LOCATION_ARGS) ;\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (84)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ~ operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_tilde (LOCATION_ARGS) ;\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (89)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- . (concat) operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_concat (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (95)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- + operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " add_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (102)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- - operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " substract_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (109)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- * operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " multiply_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (116)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- / operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " divide_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (123)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- mod operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " modulo_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (130)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- unary - operator\n"
  "  public : GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_unary_minus (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (136)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ++, -- operators\n"
  "  public : void increment_operation (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler\n" ;
...
result << "//--------------------------------- += operator\n"
  "  public : void addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6025 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6025 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6025 = enumerator_6025.nextObject ()))) {
macroValidPointer (operand_6025) ;
result << "GALGASap_" ;
result << operand_6025->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << " inOperand" ;
...
result << "//--------------------------------- Reader invocation declaration\n" ;
GGS_readerMap::cEnumerator enumerator_6277 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_6277 = NULL ;
while (((operand_6277 = enumerator_6277.nextObject ()))) {
macroValidPointer (operand_6277) ;
if (((operand_6277->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (157)))).operator_or ((operand_6277->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (157)))).boolValue ()) {
result << "public : GALGASap_" ;
result << operand_6277->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
result << " readerCall_" ;
result << operand_6277->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6541 (operand_6277->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6541 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6541 = enumerator_6541.nextObject ()))) {
macroValidPointer (operand_6541) ;
result << "GALGASap_" ;
result << operand_6541->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " & constinOperand" ;
...
if ((operand_6277->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6277->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_6277->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_7137 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_7137 = NULL ;
while (((operand_7137 = enumerator_7137.nextObject ()))) {
macroValidPointer (operand_7137) ;
if ((operand_7137->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (181))).boolValue ()) {
result << "public : void modifierCall_" ;
result << operand_7137->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7290 (operand_7137->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7290 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7290 = enumerator_7290.nextObject ()))) {
macroValidPointer (operand_7290) ;
if ((operand_7290->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7290->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
}else if ((operand_7290->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7290->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
}else if ((operand_7290->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (188))).boolValue ()) {
result << "GALGASap_" ;
result << operand_7290->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
}else {
result << "GALGASap_" ;
result << operand_7290->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
result << " inArgument" ;
...
if ((operand_7137->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7137->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_7137->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_instanceMethodMap::cEnumerator enumerator_8295 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8295 = NULL ;
while (((operand_8295 = enumerator_8295.nextObject ()))) {
macroValidPointer (operand_8295) ;
if (((operand_8295->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (208)))).operator_or ((operand_8295->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (208)))).boolValue ()) {
result << "  friend void instanceMethodCall_" ;
result << operand_8295->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_8542 (operand_8295->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8542 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8542 = enumerator_8542.nextObject ()))) {
macroValidPointer (operand_8542) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_8542->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (212))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8542->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) ;
}else if ((operand_8542->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8542->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
}else if ((operand_8542->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8542->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
}else {
result << "GALGASap_" ;
result << operand_8542->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
result << " inArgument" ;
...
if (operand_8295->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Class Methods\n" ;
GGS_classMethodMap::cEnumerator enumerator_9570 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_9570 = NULL ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9677 (operand_9570->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_9677 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9677 = enumerator_9677.nextObject ()))) {
macroValidPointer (operand_9677) ;
if ((operand_9677->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (238))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9677->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
}else if ((operand_9677->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (240))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9677->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
}else if ((operand_9677->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (242))).boolValue ()) {
result << "GALGASap_" ;
result << operand_9677->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
}else {
result << "GALGASap_" ;
result << operand_9677->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
}
if (enumerator_9677.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9570->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_10863 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_10863 = NULL ;
while (((operand_10863 = enumerator_10863.nextObject ()))) {
macroValidPointer (operand_10863) ;
if (((operand_10863->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (270)))).operator_and ((operand_10863->mInfo.mQualifier).operator_isNotEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (270)))).boolValue ()) {
result << "  protected : virtual GALGASap_" ;
result << operand_10863->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " reader_" ;
result << operand_10863->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11140 (operand_10863->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_11140 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11140 = enumerator_11140.nextObject ()))) {
macroValidPointer (operand_11140) ;
result << "GALGASap_" ;
result << operand_11140->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (273)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273)) ;
if (enumerator_11140.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10863->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10863->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") " ;
if ((operand_10863->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (290))).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (297)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
GGS_nativeAttributeList::cEnumerator enumerator_12328 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_12328 = NULL ;
while (((operand_12328 = enumerator_12328.nextObject ()))) {
macroValidPointer (operand_12328) ;
result << "  private : " ;
if (operand_12328->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_12328->mCppClassName ;
result << " " ;
if (operand_12328->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_12328->mAttributeName ;
result << " ;\n" ;
if ((operand_12328->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if ((operand_12328->mIsConst).operator_not ().boolValue ()) {
...
result << operand_12328->mGetterName ;
result << " (void) { return " ;
result << operand_12328->mAttributeName ;
result << " ; }\n" ;
}else {
...
GGS_typedAttributeList::cEnumerator enumerator_12857 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12857 = NULL ;
while (((operand_12857 = enumerator_12857.nextObject ()))) {
macroValidPointer (operand_12857) ;
result << "  public : GALGASap_" ;
result << operand_12857->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) ;
result << " mAttribute_" ;
result << operand_12857->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (319)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (326)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_13889 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13889 = NULL ;
while (((operand_13889 = enumerator_13889.nextObject ()))) {
macroValidPointer (operand_13889) ;
result << "  friend capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_13889->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_13889->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14668 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14668 = NULL ;
while (((operand_14668 = enumerator_14668.nextObject ()))) {
macroValidPointer (operand_14668) ;
result << "    public : GALGASap_" ;
result << operand_14668->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
result << " attribute_" ;
result << operand_14668->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << " ;\n"
  ...
  "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_15003 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_15003 = NULL ;
while (((operand_15003 = enumerator_15003.nextObject ()))) {
macroValidPointer (operand_15003) ;
if (((operand_15003->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (368)))).operator_or ((operand_15003->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (368)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_15003->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_15241 (operand_15003->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_15241 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15241 = enumerator_15241.nextObject ()))) {
macroValidPointer (operand_15241) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_15241->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (372))).boolValue ()) {
result << "GALGASap_" ;
result << operand_15241->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (373)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (373)) ;
}else if ((operand_15241->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (374))).boolValue ()) {
result << "GALGASap_" ;
result << operand_15241->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
}else if ((operand_15241->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (376))).boolValue ()) {
result << "GALGASap_" ;
result << operand_15241->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (377)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (377)) ;
}else {
result << "GALGASap_" ;
result << operand_15241->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (379)) ;
result << " inArgument" ;
...
if (operand_15003->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_16315 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_16315 = NULL ;
while (((operand_16315 = enumerator_16315.nextObject ()))) {
macroValidPointer (operand_16315) ;
result << "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_16315->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_16315->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (397)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_5491 (operand_5164->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_5491 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5491 = enumerator_5491.nextObject ()))) {
macroValidPointer (operand_5491) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_5491->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5491->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
}else if ((operand_5491->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5491->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
}else if ((operand_5491->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (144))).boolValue ()) {
result << "GALGASap_" ;
result << operand_5491->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
}else {
result << "GALGASap_" ;
result << operand_5491->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
result << " inArgument" ;
...
result << ") {\n"
  "//--- Release 'output' arguments\n" ;
GGS_formalParameterSignature::cEnumerator enumerator_6484 (operand_5164->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6484 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6484 = enumerator_6484.nextObject ()))) {
macroValidPointer (operand_6484) ;
if ((operand_6484->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (159))).boolValue ()) {
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << ".drop () ;\n" ;
}else {
...
result << operand_5164->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_6818 (operand_5164->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6818 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6818 = enumerator_6818.nextObject ()))) {
macroValidPointer (operand_6818) ;
if ((operand_6818->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).boolValue ()) {
result << "constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
}else if ((operand_6818->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (169))).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
}else if ((operand_6818->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (171))).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_6818.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "//---------------------------------------------------------------------------*\n"
  "//" ;
result << ((((GGS_string ("@")).operator_concat (var_cas_TYPE_NAME)).operator_concat (GGS_string (" "))).operator_concat (var_cas_TYPE_KIND.reader_kind (inLexique COMMA_SOURCE_FILE_AT_LINE (199)))).operator_concat (GGS_string (" enumeration")).reader_stringByLeftAndRightPadding (GGS_uint (75U), GGS_char (TO_UNICODE (' '))) ;
result << "*\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_8304 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8304 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8304 = enumerator_8304.nextObject ()))) {
macroValidPointer (operand_8304) ;
result << ",\n"
  "attribute_" ;
result << operand_8304->mEnumerationName.reader_identifierRepresentation () ;
result << " ()" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_enumerationDescriptorList::cEnumerator enumerator_8906 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_8906 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8906 = enumerator_8906.nextObject ()))) {
macroValidPointer (operand_8906) ;
result << "  attribute_" ;
result << operand_8906->mEnumerationName.reader_identifierRepresentation () ;
result << " = p->mAttribute_" ;
result << operand_8906->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
