...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_1508 = GGS_uint (2U) ;
if (indentation_1508.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_1508.uintValue ()) ;
}
GGS_semanticInstructionListForGeneration::cEnumerator enumerator_1433 (var_cas_ROUTINE_INSTRUCTION_LIST, true) ;
const GGS_semanticInstructionListForGeneration::cElement * operand_1433 = NULL ;
while (((operand_1433 = enumerator_1433.nextObject ()))) {
macroValidPointer (operand_1433) ;
result << (findCategoryReader__semanticInstructionForGeneration__generateInstruction (operand_1433->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_1433->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (24))) ;
}
 ;
if (indentation_1508.isBuilt ()) {
  result.incIndentation (- ((PMSInt32) indentation_1508.uintValue ())) ;
