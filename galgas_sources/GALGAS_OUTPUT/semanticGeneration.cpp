...
//                    september 27th, 2010, at 17h35'19"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
result << "const GALGAS_" ;
result << operand_5219->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " & inOperand" ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_5431 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5431 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5431 = enumerator_5431.nextObject ()))) {
macroValidPointer (operand_5431) ;
result << " && inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5634 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5634 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_5634.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_5971 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5971 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5971 = enumerator_5971.nextObject ()))) {
macroValidPointer (operand_5971) ;
result << "GALGAS_" ;
result << operand_5971->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_6181 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6181 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6386 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6386 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_6386.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6731 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6731 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6731 = enumerator_6731.nextObject ()))) {
macroValidPointer (operand_6731) ;
result << "GALGAS_" ;
result << operand_6731->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7162 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7162 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7340 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7340 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_7340->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7638 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7638 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7638 = enumerator_7638.nextObject ()))) {
macroValidPointer (operand_7638) ;
result << "GALGAS_" ;
result << operand_7638->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8068 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8068 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8068 = enumerator_8068.nextObject ()))) {
macroValidPointer (operand_8068) ;
result << "    outOperand" ;
...
result << "::method_first (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8540 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8540 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8540 = enumerator_8540.nextObject ()))) {
macroValidPointer (operand_8540) ;
result << "GALGAS_" ;
result << operand_8540->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8969 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8969 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8969 = enumerator_8969.nextObject ()))) {
macroValidPointer (operand_8969) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9147 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9147 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9147 = enumerator_9147.nextObject ()))) {
macroValidPointer (operand_9147) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
result << " = p->mAttribute_" ;
result << operand_9147->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9440 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9440 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9440 = enumerator_9440.nextObject ()))) {
macroValidPointer (operand_9440) ;
result << "GALGAS_" ;
result << operand_9440->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9868 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9868 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9868 = enumerator_9868.nextObject ()))) {
macroValidPointer (operand_9868) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10046 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10046 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_10046->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12047 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12047 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_12047->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_12047->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_12047->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inOperand ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12989 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12989 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_12989->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_12989->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_uint & inIndex,\n"
  "                                              " ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGAS_" ;
result << operand_12989->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
