...
if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
  ...
  columnMarker = result.currentColumn () ;
  GGS_unifiedTypeMapProxyList::cEnumerator enumerator_9693 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
  const GGS_unifiedTypeMapProxyList::cElement * operand_9693 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9693 = enumerator_9693.nextObject ()))) {
  macroValidPointer (operand_9693) ;
  result << "const GALGASap_" ;
  result << operand_9693->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
  result << " inOperand" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
  if (enumerator_9693.hasNextObject ()) {
    result << ",\n" ;
    result.appendSpacesUntilColumn (columnMarker) ;
  }
  var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
GGS_readerMap::cEnumerator enumerator_9951 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_9951 = NULL ;
while (((operand_9951 = enumerator_9951.nextObject ()))) {
macroValidPointer (operand_9951) ;
if (((operand_9951->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (231)))).operator_or ((operand_9951->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (231)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG GALGASap_" ;
result << operand_9951->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ;
result << " readerCall_" ;
result << operand_9951->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_10234 (operand_9951->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_10234 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10234 = enumerator_10234.nextObject ()))) {
macroValidPointer (operand_10234) ;
result << "const GALGASap_" ;
result << operand_10234->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (234)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (234)) ;
if (enumerator_10234.hasNextObject ()) {
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9951->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9951->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_9951->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_11121 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_11121 = NULL ;
while (((operand_11121 = enumerator_11121.nextObject ()))) {
macroValidPointer (operand_11121) ;
if ((operand_11121->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (261))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void modifierCall_" ;
result << operand_11121->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_11291 (operand_11121->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_11291 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11291 = enumerator_11291.nextObject ()))) {
macroValidPointer (operand_11291) ;
if ((operand_11291->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (264))).boolValue ()) {
result << "GALGASap_" ;
result << operand_11291->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
}else if ((operand_11291->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (266))).boolValue ()) {
result << "GALGASap_" ;
result << operand_11291->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
}else if ((operand_11291->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).boolValue ()) {
result << "GALGASap_" ;
result << operand_11291->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)) ;
}else {
result << "GALGASap_" ;
result << operand_11291->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
}
if (enumerator_11291.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11121->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11121->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_11121->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_instanceMethodMap::cEnumerator enumerator_12517 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_12517 = NULL ;
while (((operand_12517 = enumerator_12517.nextObject ()))) {
macroValidPointer (operand_12517) ;
if (((operand_12517->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (292)))).operator_or ((operand_12517->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (292)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void instanceMethodCall_" ;
result << operand_12517->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_12743 (operand_12517->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_12743 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12743 = enumerator_12743.nextObject ()))) {
macroValidPointer (operand_12743) ;
if ((operand_12743->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (295))).boolValue ()) {
result << "GALGASap_" ;
result << operand_12743->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) ;
}else if ((operand_12743->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (297))).boolValue ()) {
result << "GALGASap_" ;
result << operand_12743->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298)) ;
}else if ((operand_12743->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (299))).boolValue ()) {
result << "GALGASap_" ;
result << operand_12743->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (300)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (300)) ;
}else {
result << "GALGASap_" ;
result << operand_12743->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) ;
}
if (enumerator_12743.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_12517->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_12517->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_12517->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_8562 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_8562 = NULL ;
while (((operand_8562 = enumerator_8562.nextObject ()))) {
macroValidPointer (operand_8562) ;
if ((operand_8562->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (212))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void modifierCall_" ;
result << operand_8562->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8732 (operand_8562->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8732 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8732 = enumerator_8732.nextObject ()))) {
macroValidPointer (operand_8732) ;
if ((operand_8732->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8732->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
}else if ((operand_8732->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8732->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
}else if ((operand_8732->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8732->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
}else {
result << "GALGASap_" ;
result << operand_8732->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
}
if (enumerator_8732.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8562->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8562->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_8562->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_9958 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_9958 = NULL ;
while (((operand_9958 = enumerator_9958.nextObject ()))) {
macroValidPointer (operand_9958) ;
if (((operand_9958->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (243)))).operator_or ((operand_9958->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (243)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void instanceMethodCall_" ;
result << operand_9958->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10184 (operand_9958->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10184 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10184 = enumerator_10184.nextObject ()))) {
macroValidPointer (operand_10184) ;
if ((operand_10184->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (246))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10184->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
}else if ((operand_10184->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (248))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10184->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
}else if ((operand_10184->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (250))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10184->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
}else {
result << "GALGASap_" ;
result << operand_10184->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (253)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (253)) ;
}
if (enumerator_10184.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9958->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9958->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_9958->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << var_cas_TYPE_NAME ;
result << ":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3134 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3134 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3134 = enumerator_3134.nextObject ()))) {
macroValidPointer (operand_3134) ;
result << "  mAttribute_" ;
result << operand_3134->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".ptr (HERE)->description (ioString, inIndentation  + 1) ;\n" ;
if (enumerator_3134.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << "  ioString << \">\" ;\n"
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3362 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3362 = NULL ;
while (((operand_3362 = enumerator_3362.nextObject ()))) {
macroValidPointer (operand_3362) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_3362->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
result << " GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::readerCall_" ;
result << operand_3362->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " & inOperand2) {\n"
  "   enumComparisonResult result = kOperandEqual ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4078 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4078 = NULL ;
while (((operand_4078 = enumerator_4078.nextObject ()))) {
macroValidPointer (operand_4078) ;
result << "  if (result == kOperandEqual) {\n"
  "    result = GALGASap_" ;
result << operand_4078->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
result << "::objectCompare (inOperand1.mAttribute_" ;
result << operand_4078->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "mAttribute_" ;
result << operand_4577->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::drop (void) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4851 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4851 = NULL ;
while (((operand_4851 = enumerator_4851.nextObject ()))) {
macroValidPointer (operand_4851) ;
result << "  mAttribute_" ;
result << operand_4851->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".drop () ;\n" ;
}
result << "}\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (const GALGASap_object & inSource) :\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5143 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5143 = NULL ;
while (((operand_5143 = enumerator_5143.nextObject ()))) {
macroValidPointer (operand_5143) ;
result << "mAttribute_" ;
result << operand_5143->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ()" ;
if (enumerator_5143.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " *) object ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5498 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5498 = NULL ;
while (((operand_5498 = enumerator_5498.nextObject ()))) {
macroValidPointer (operand_5498) ;
result << "    mAttribute_" ;
result << operand_5498->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = p->mAttribute_" ;
result << operand_5498->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5946 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5946 = NULL ;
while (((operand_5946 = enumerator_5946.nextObject ()))) {
macroValidPointer (operand_5946) ;
result << "mAttribute_" ;
result << operand_5946->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_2166 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_2166 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_" ;
result << operand_2166->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
const GGS_uint indentation_3225 = GGS_uint (4U) ;
if (indentation_3225.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_3225.uintValue ()) ;
}
result << "macroMyNew (result, GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " (THERE)) ;\n"
  "const utf32 kSearchErrorMessage [" ;
result << operand_2166->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (53)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
result << "] = " ;
result << operand_2166->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
