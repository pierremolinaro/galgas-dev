...
result << "//--------------------------------- += operator\n"
  "  public : void addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_6925 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_6925 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6925 = enumerator_6925.nextObject ()))) {
macroValidPointer (operand_6925) ;
result << "GALGASap_" ;
result << operand_6925->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (173)) ;
result << " inOperand" ;
...
result << "//--------------------------------- Reader invocation declaration\n" ;
GGS_readerMap::cEnumerator enumerator_7511 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_7511 = NULL ;
while (((operand_7511 = enumerator_7511.nextObject ()))) {
macroValidPointer (operand_7511) ;
if (((operand_7511->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (188)))).operator_or ((operand_7511->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (188)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG GALGASap_" ;
result << operand_7511->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (189)) ;
result << " readerCall_" ;
result << operand_7511->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7792 (operand_7511->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_7792 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7792 = enumerator_7792.nextObject ()))) {
macroValidPointer (operand_7792) ;
result << "GALGASap_" ;
result << operand_7792->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
result << " & constinOperand" ;
...
if ((operand_7511->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7511->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_7511->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "//--------------------------------- Modifier invocation\n" ;
GGS_modifierMap::cEnumerator enumerator_8388 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_8388 = NULL ;
while (((operand_8388 = enumerator_8388.nextObject ()))) {
macroValidPointer (operand_8388) ;
if ((operand_8388->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (212))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void modifierCall_" ;
result << operand_8388->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8558 (operand_8388->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8558 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8558 = enumerator_8558.nextObject ()))) {
macroValidPointer (operand_8558) ;
if ((operand_8558->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8558->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
}else if ((operand_8558->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8558->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
}else if ((operand_8558->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8558->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
}else {
result << "GALGASap_" ;
result << operand_8558->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
}
...
if ((operand_8388->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8388->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_8388->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_9784 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_9784 = NULL ;
while (((operand_9784 = enumerator_9784.nextObject ()))) {
macroValidPointer (operand_9784) ;
if (((operand_9784->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (243)))).operator_or ((operand_9784->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (243)))).boolValue ()) {
result << "public : VIRTUAL_IN_DEBUG void instanceMethodCall_" ;
result << operand_9784->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10010 (operand_9784->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10010 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10010 = enumerator_10010.nextObject ()))) {
macroValidPointer (operand_10010) ;
if ((operand_10010->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (246))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10010->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
}else if ((operand_10010->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (248))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10010->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
}else if ((operand_10010->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (250))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10010->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) ;
}else {
result << "GALGASap_" ;
result << operand_10010->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (253)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (253)) ;
}
if (enumerator_10010.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_9784->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_9784->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_9784->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
