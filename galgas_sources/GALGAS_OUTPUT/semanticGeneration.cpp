...
//                    september 28th, 2010, at 20h46'50"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n"
  "//--- Virtual method for comparing elements\n"
  "  public : virtual enumComparisonResult compare (const cSortedListElement * inOperand) ;\n"
  "\n"
  "//--- Virtual method that checks that all attributes are valid\n"
  "  public : virtual bool isValid (void) const ;\n"
  "\n"
  ...
  "  public : virtual enumComparisonResult compareForSorting (const cSortedListElement * inOperand) ;\n"
  "} ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1948 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "const GALGAS_" ;
result << operand_1948->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
result << " & in_" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_2917 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2917 = NULL ;
while (((operand_2917 = enumerator_2917.nextObject ()))) {
macroValidPointer (operand_2917) ;
result << "mAttribute_" ;
result << operand_2917->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_2917.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_HERE)) ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::description (C_String & /* ioString */, const PMSInt32 /* inIndentation */) const {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3290 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3290 = NULL ;
while (((operand_3290 = enumerator_3290.nextObject ()))) {
macroValidPointer (operand_3290) ;
result << "// mAttribute_" ;
result << operand_3290->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".description (ioString, inIndentation) ;\n" ;
}
result << "}\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::compare (const cSortedListElement * inOperand) {\n"
  "  cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << " *) inOperand ;\n"
  "  enumComparisonResult result = kOperandEqual ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3783 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3783 = NULL ;
while (((operand_3783 = enumerator_3783.nextObject ()))) {
macroValidPointer (operand_3783) ;
result << "  if (kOperandEqual == result) {\n"
  "    result = GALGAS_" ;
result << operand_3783->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
result << "::objectCompare (mAttribute_" ;
result << operand_3783->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
result << "] = {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4318 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4318 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4318 = enumerator_4318.nextObject ()))) {
macroValidPointer (operand_4318) ;
result << "  & kTypeDescriptor_GALGAS_" ;
result << operand_4318->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
if (enumerator_4318.hasNextObject ()) {
result << ",\n" ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " * p1 = (const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " *) inLeftAttributeList.ptrNoVerif () ;\n"
  "  macroValidObject (p1, const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n"
  "  const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p2 = (const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " *) inRightAttributeList.ptrNoVerif () ;\n"
  "  macroValidObject (p2, const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_sortDescriptorListForGeneration::cEnumerator enumerator_5478 (var_cas_SORT_ATTRIBUTE_LIST, true) ;
const GGS_sortDescriptorListForGeneration::cElement * operand_5478 = NULL ;
while (((operand_5478 = enumerator_5478.nextObject ()))) {
macroValidPointer (operand_5478) ;
result << "  if (result == kOperandEqual) {\n"
  "    result = " ;
if (operand_5478->mAscendingOrder.boolValue ()) {
}else {
result << "complementComparison " ;
}
result << "(GALGAS_" ;
result << operand_5478->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
result << "::objectCompare (p1->mAttribute_" ;
result << operand_5478->mAttributeName.reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_6707 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6707 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6707 = enumerator_6707.nextObject ()))) {
macroValidPointer (operand_6707) ;
result << "GALGAS_" ;
result << operand_6707->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
if (enumerator_6707.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL0 ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "::addAssign_operation (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7426 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7426 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7426 = enumerator_7426.nextObject ()))) {
macroValidPointer (operand_7426) ;
result << "const GALGAS_" ;
result << operand_7426->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
if (enumerator_7426.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7761 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7761 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7761 = enumerator_7761.nextObject ()))) {
macroValidPointer (operand_7761) ;
result << "inOperand" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9013 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9013 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9013 = enumerator_9013.nextObject ()))) {
macroValidPointer (operand_9013) ;
result << "GALGAS_" ;
result << operand_9013->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9465 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9465 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9465 = enumerator_9465.nextObject ()))) {
macroValidPointer (operand_9465) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9643 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9643 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_9643->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9945 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9945 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9945 = enumerator_9945.nextObject ()))) {
macroValidPointer (operand_9945) ;
result << "GALGAS_" ;
result << operand_9945->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (252)) ;
result << " & outOperand" ;
...
result << " = p->mAttribute_" ;
result << operand_10575->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10872 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10872 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10872 = enumerator_10872.nextObject ()))) {
macroValidPointer (operand_10872) ;
result << "GALGAS_" ;
result << operand_10872->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11321 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11321 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11321 = enumerator_11321.nextObject ()))) {
macroValidPointer (operand_11321) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11499 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11499 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_11499->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_11796 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11796 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11796 = enumerator_11796.nextObject ()))) {
macroValidPointer (operand_11796) ;
result << "GALGAS_" ;
result << operand_11796->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12245 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12245 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12245 = enumerator_12245.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12423 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12423 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12423 = enumerator_12423.nextObject ()))) {
macroValidPointer (operand_12423) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318)) ;
result << " = p->mAttribute_" ;
result << operand_12423->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_15383
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15383 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_15595
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15595 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_15595->mRoutineName, operand_15595->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_15921
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15921 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15921->mFunctionName, operand_15921->mFormalArgumentList, operand_15921->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (406))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_16288
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16288 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16288->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_16288->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (416))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_16673
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16673 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader (inLexique, operand_16673->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (424)), operand_16673->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (425)), operand_16673->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_16673->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (429)), operand_16673->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (430)), operand_16673->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (431)), operand_16673->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (432)), operand_16673->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (433)), operand_16673->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (434)), operand_16673->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (435)), operand_16673->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (436)), operand_16673->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (437)), operand_16673->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (438)), operand_16673->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (439)), operand_16673->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (440)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_17513
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17513 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader (inLexique, operand_17513->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (448)), operand_17513->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (449)), operand_17513->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17513->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (453)), operand_17513->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (454)), operand_17513->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (455)), operand_17513->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), operand_17513->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), operand_17513->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (458)), operand_17513->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (459)), operand_17513->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (460)), operand_17513->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (461)), operand_17513->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (462)), operand_17513->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (463)), operand_17513->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (464)))) ;
  }
  return var_cas_outHeader ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Category reader '@sortedListTypeForGeneration.appendDeclaration'      *
//                                                                           *
//---------------------------------------------------------------------------*

static GGS_string
category_reader__sortedListTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_18357
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18357 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader (inLexique, operand_18357->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_18357->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_18357->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18357->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (477)), operand_18357->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (478)), operand_18357->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (479)), operand_18357->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (480)), operand_18357->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (481)), operand_18357->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (482)), operand_18357->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), operand_18357->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (484)), operand_18357->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_18357->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), operand_18357->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (487)), operand_18357->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (488)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_19201
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19201 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader (inLexique, operand_19201->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_19201->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_19201->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19201->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (501)), operand_19201->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), operand_19201->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (503)), operand_19201->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (504)), operand_19201->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (505)), operand_19201->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), operand_19201->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (507)), operand_19201->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (508)), operand_19201->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), operand_19201->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), operand_19201->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (511)), operand_19201->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (512)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_20439
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20439 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_20665
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20665 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_20665->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), operand_20665->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), operand_20665->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (533))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_21356
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21356 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_21578
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21578 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_listmapTypeSpecificImplementation (inLexique, operand_21578->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (552)), operand_21578->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), operand_21578->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_22009
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22009 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapTypeSpecificImplementation (inLexique, operand_22009->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), operand_22009->mTypedAttributeList, operand_22009->mInsertMethodList, operand_22009->mSearchMethodList, operand_22009->mRemoveMethodList, operand_22009->mHasInsertOrReplaceModifier, operand_22009->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_22496
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22496 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_22496->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (576)), operand_22496->mTypedAttributeList, operand_22496->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_22883
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22883 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_22883->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (586)), operand_22883->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), operand_22883->mConstantList, operand_22883->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_23281
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23281 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapProxyTypeSpecificImplementation (inLexique, operand_23281->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (597)), operand_23281->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (598)), operand_23281->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (599)), operand_23281->mAssociatedMapTypedAttributeList, operand_23281->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_23758
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23758 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_classTypeSpecificImplementation (inLexique, operand_23758->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (609)), operand_23758->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (610)), ((operand_23758->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (611))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_23758->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (611)))), operand_23758->mTypedAttributeList, operand_23758->mAllTypedAttributeList, operand_23758->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_23758->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_23758->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)), operand_23758->mIsAbstract, operand_23758->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_24407
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24407 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_24407->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (624)), operand_24407->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), operand_24407->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_24787
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24787 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_24787->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (634)), operand_24787->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (635)), operand_24787->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_25178
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25178 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_25178->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_25178->mRoutineName.reader_identifierRepresentation ()), operand_25178->mFormalArgumentList, operand_25178->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (645))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_25815
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25815 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_25815->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_25815->mFunctionName.reader_identifierRepresentation ()), operand_25815->mFormalArgumentList, operand_25815->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_25815->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (667)), operand_25815->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (662)), operand_25815->mFormalArgumentList, operand_25815->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (671))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_26438
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26438 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_26438->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_26438->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_26438->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_26438->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (685)), operand_26438->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (680)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_26438->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (689))) ;
  }
  return var_cas_outImplementation ;
}
...
static void prologueRoutineFor_semanticGeneration (void) {
  ...
  enterCategoryReader__semanticDeclarationForGeneration__appendDeclaration ((typeCategoryReader__semanticDeclarationForGeneration__appendDeclaration) category_reader__sortedListTypeForGeneration__appendDeclaration, gClassInfoFor__sortedListTypeForGeneration.slotID ()) ;
