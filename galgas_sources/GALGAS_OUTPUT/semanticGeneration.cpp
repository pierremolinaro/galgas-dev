...
GGS_string function_generateProcedure (C_Compiler & inLexique,
  ...
  const GGS_bool cond_5304 = var_cas_inGenerateResetTemplateString ;
...
GGS_string function_generateFunction (C_Compiler & inLexique,
  ...
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_6340 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_6340 = NULL ;
    while (((operand_6340 = enumerator_6340.nextObject ()))) {
      macroValidPointer (operand_6340) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_6340->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  ...
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_6570 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_6570 = NULL ;
    while (((operand_6570 = enumerator_6570.nextObject ()))) {
      macroValidPointer (operand_6570) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_6570->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_6570->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (148)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (150)) ;
  const GGS_bool cond_6818 = var_cas_inIsStatic ;
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_7051 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_7051 = NULL ;
    while (((operand_7051 = enumerator_7051.nextObject ()))) {
      macroValidPointer (operand_7051) ;
      var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_7051->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_7299 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_7051->mFormalArgumentCppName) ;
      if (cond_7299.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_7051->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_7299.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_7051->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
  ...
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_7676 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (171))) ;
  if (cond_7676.isBuiltAndTrue ()) {
    ...
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_7676.isBuiltAndFalse ()) {
...
GGS_string function_generateCategoryMethod (C_Compiler & inLexique,
  ...
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_9216 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_9216 = NULL ;
    while (((operand_9216 = enumerator_9216.nextObject ()))) {
      macroValidPointer (operand_9216) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_9216->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  ...
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_9446 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_9446 = NULL ;
    while (((operand_9446 = enumerator_9446.nextObject ()))) {
      macroValidPointer (operand_9446) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_9446->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_9446->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (218)) ;
        }
      }
    }
  }
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  const GGS_bool cond_9968 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
  if (cond_9968.isBuiltAndTrue ()) {
    ...
    var_cas_outGeneratedCode.appendCString (" * ") ;
  }else if (cond_9968.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
  ...
  const GGS_bool cond_10246 = var_cas_currentObjectIsUnused ;
  if (cond_10246.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
  }else if (cond_10246.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("inObject") ;
  }
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_10330 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_10330 = NULL ;
    while (((operand_10330 = enumerator_10330.nextObject ()))) {
      ...
      switch (operand_10330->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        {
        var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (241))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (243))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::kNotBuilt:
      ...
      const GGS_bool cond_11108 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_10330->mFormalArgumentCppName) ;
      if (cond_11108.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_11108.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_10330->mFormalArgumentCppName) ;
      }
    }
  }
  ...
  const GGS_bool cond_11470 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
  if (cond_11470.isBuiltAndTrue ()) {
    ...
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_11470.isBuiltAndFalse ()) {
  ...
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
  var_cas_outGeneratedCode.appendCString (") {\n") ;
  const GGS_bool cond_12231 = (var_cas_currentObjectIsUnused).operator_not () ;
  if (cond_12231.isBuiltAndTrue ()) {
    const GGS_bool cond_11917 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
    if (cond_11917.isBuiltAndTrue ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
    }else if (cond_11917.isBuiltAndFalse ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
GGS_string function_generateCategoryReader (C_Compiler & inLexique,
  ...
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_13313 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_13313 = NULL ;
    while (((operand_13313 = enumerator_13313.nextObject ()))) {
      macroValidPointer (operand_13313) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_13313->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  ...
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_13543 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_13543 = NULL ;
    while (((operand_13543 = enumerator_13543.nextObject ()))) {
      macroValidPointer (operand_13543) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_13543->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_13543->mInstruction (HERE), var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (312)) ;
        }
      }
    }
  }
  ...
  var_cas_outGeneratedCode.appendCString (" (") ;
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  const GGS_bool cond_14141 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
  if (cond_14141.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
    var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
    var_cas_outGeneratedCode.appendCString (" * ") ;
  }else if (cond_14141.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
    var_cas_outGeneratedCode.dotAssign_operation (var_cas_inBaseClassName.reader_identifierRepresentation ()) ;
    var_cas_outGeneratedCode.appendCString (" * ") ;
  }
  ...
  const GGS_bool cond_14419 = var_cas_currentObjectIsUnused ;
  if (cond_14419.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
  }else if (cond_14419.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("inObject") ;
  }
  var_cas_outGeneratedCode.appendCString (",\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (331)) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_14590 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_14590 = NULL ;
    while (((operand_14590 = enumerator_14590.nextObject ()))) {
      macroValidPointer (operand_14590) ;
      var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_14590->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (334))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_14838 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_14590->mFormalArgumentCppName) ;
      if (cond_14838.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_14590->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_14838.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_14590->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
  ...
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_15215 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (345))) ;
  if (cond_15215.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (346))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_15215.isBuiltAndFalse ()) {
  ...
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inResultVariableCppName) ;
  var_cas_outGeneratedCode.appendCString (" ; // Returned variable\n") ;
  const GGS_bool cond_16171 = (var_cas_currentObjectIsUnused).operator_not () ;
  if (cond_16171.isBuiltAndTrue ()) {
    const GGS_bool cond_15857 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
    if (cond_15857.isBuiltAndTrue ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
    }else if (cond_15857.isBuiltAndFalse ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = (const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
if ((var_cas_ADD_ASSIGN_ARGUMENT_LIST.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
  ...
  columnMarker = result.currentColumn () ;
  GGS_unifiedTypeMapProxyList::cEnumerator enumerator_2573 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
  const GGS_unifiedTypeMapProxyList::cElement * operand_2573 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2573 = enumerator_2573.nextObject ()))) {
  macroValidPointer (operand_2573) ;
  result << "const GALGAS_" ;
  result << operand_2573->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (59)) ;
  result << " & inOperand" ;
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_7182 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_7182 = NULL ;
while (((operand_7182 = enumerator_7182.nextObject ()))) {
macroValidPointer (operand_7182) ;
if ((((operand_7182->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (164)))).operator_or ((operand_7182->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (164))))).operator_or ((operand_7182->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (164)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG void modifier_" ;
result << operand_7182->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_7459 (operand_7182->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_7459 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7459 = enumerator_7459.nextObject ()))) {
macroValidPointer (operand_7459) ;
if ((operand_7459->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7459->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
  result << " constinArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) ;
}else if ((operand_7459->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (169))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7459->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
  result << " & ioArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
}else if ((operand_7459->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (171))).boolValue ()) {
  result << "GALGAS_" ;
  result << operand_7459->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
  result << " & outArgument" ;
  result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
}else {
  result << "GALGAS_" ;
  result << operand_7459->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
  result << " inArgument" ;
...
if ((operand_7182->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7182->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8718 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8718 = NULL ;
while (((operand_8718 = enumerator_8718.nextObject ()))) {
macroValidPointer (operand_8718) ;
if ((operand_8718->mInfo.mIsCategory).operator_not ().boolValue ()) {
if ((((operand_8718->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))).operator_or ((operand_8718->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (201))))).operator_or ((operand_8718->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (201)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG void method_" ;
result << operand_8718->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_9025 (operand_8718->mInfo.mParameterList, true) ;
...
if ((operand_9025->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9025->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
}else if ((operand_9025->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (206))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9025->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)) ;
}else if ((operand_9025->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).boolValue ()) {
result << "GALGAS_" ;
result << operand_9025->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
}else {
result << "GALGAS_" ;
result << operand_9025->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ;
result << " inArgument" ;
...
if ((operand_8718->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8718->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
GGS_classMethodMap::cEnumerator enumerator_10348 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_10348 = NULL ;
while (((operand_10348 = enumerator_10348.nextObject ()))) {
macroValidPointer (operand_10348) ;
result << "  public : static void class_method_" ;
result << operand_10348->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10464 (operand_10348->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10464 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10464 = enumerator_10464.nextObject ()))) {
macroValidPointer (operand_10464) ;
if ((operand_10464->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (239))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10464->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ;
}else if ((operand_10464->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (241))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10464->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) ;
}else if ((operand_10464->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (243))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10464->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
}else {
result << "GALGAS_" ;
result << operand_10464->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
}
if (enumerator_10464.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10348->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10348->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_11642 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_11642 = NULL ;
while (((operand_11642 = enumerator_11642.nextObject ()))) {
macroValidPointer (operand_11642) ;
if ((operand_11642->mInfo.mIsCategory).operator_not ().boolValue ()) {
if ((((operand_11642->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))).operator_or ((operand_11642->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (272))))).operator_or ((operand_11642->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))).boolValue ()) {
result << "  public : VIRTUAL_IN_DEBUG GALGAS_" ;
result << operand_11642->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (273)) ;
result << " reader_" ;
result << operand_11642->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12010 (operand_11642->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_12010 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12010 = enumerator_12010.nextObject ()))) {
macroValidPointer (operand_12010) ;
result << "const GALGAS_" ;
result << operand_12010->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (275)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (275)) ;
if (enumerator_12010.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11642->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11642->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
GGS_withAccessorMap::cEnumerator enumerator_13233 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13233 = NULL ;
while (((operand_13233 = enumerator_13233.nextObject ()))) {
macroValidPointer (operand_13233) ;
result << "  public : VIRTUAL_IN_DEBUG cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * readWriteAccessForWithInstruction_" ;
result << operand_13233->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (310)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_13233->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (311)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14318 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14318 = NULL ;
while (((operand_14318 = enumerator_14318.nextObject ()))) {
macroValidPointer (operand_14318) ;
result << "  public : GALGAS_" ;
result << operand_14318->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (333)) ;
result << " current_" ;
result << operand_14318->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14780 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14780 = NULL ;
while (((operand_14780 = enumerator_14780.nextObject ()))) {
macroValidPointer (operand_14780) ;
result << "cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_14780->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (346)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14780->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_26380
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26380 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_26593
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26593 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_26593->mRoutineName, operand_26593->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_26920
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_26920 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_26920->mFunctionName, operand_26920->mFormalArgumentList, operand_26920->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (685))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_27288
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27288 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_27288->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_27288->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (695))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_27673
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_27673 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_27673->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (703)), operand_27673->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), ((operand_27673->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (705))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_27673->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (705)))), operand_27673->mAllTypedAttributeList, operand_27673->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_27673->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (710)), operand_27673->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (711)), operand_27673->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (712)), operand_27673->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (713)), operand_27673->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), operand_27673->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (715)), operand_27673->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (716)), operand_27673->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (717)), operand_27673->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (718)), operand_27673->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (719)), operand_27673->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (720)), operand_27673->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (721)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_28618
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28618 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_28618->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_28618->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (730)), operand_28618->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_28618->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), operand_28618->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (735)), operand_28618->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (736)), operand_28618->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), operand_28618->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (738)), operand_28618->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), operand_28618->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (740)), operand_28618->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (741)), operand_28618->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (742)), operand_28618->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (743)), operand_28618->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (744)), operand_28618->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (745)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_29459
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29459 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_29459->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (753)), operand_29459->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_29459->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_29459->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (758)), operand_29459->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (759)), operand_29459->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_29459->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), operand_29459->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (762)), operand_29459->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (763)), operand_29459->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), operand_29459->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (765)), operand_29459->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (766)), operand_29459->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (767)), operand_29459->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), operand_29459->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (769)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_30301
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30301 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_30301->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (777)), operand_30301->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (778)), operand_30301->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30301->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), operand_30301->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), operand_30301->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (784)), operand_30301->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), operand_30301->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), operand_30301->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), operand_30301->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (788)), operand_30301->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (789)), operand_30301->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (790)), operand_30301->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (791)), operand_30301->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (792)), operand_30301->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (793)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_31147
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31147 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_31147->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), operand_31147->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (802)), operand_31147->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31147->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (806)), operand_31147->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (807)), operand_31147->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), operand_31147->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (809)), operand_31147->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (810)), operand_31147->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), operand_31147->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (812)), operand_31147->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (813)), operand_31147->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (814)), operand_31147->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (815)), operand_31147->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (816)), operand_31147->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (817)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_31993
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31993 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_31993->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), operand_31993->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (826)), operand_31993->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31993->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (830)), operand_31993->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (831)), operand_31993->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (832)), operand_31993->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (833)), operand_31993->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (834)), operand_31993->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), operand_31993->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (836)), operand_31993->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (837)), operand_31993->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (838)), operand_31993->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (839)), operand_31993->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (840)), operand_31993->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (841)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_32978 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_32978 = NULL ;
while (((operand_32978 = enumerator_32978.nextObject ()))) {
  macroValidPointer (operand_32978) ;
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_33119 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_33119 = NULL ;
while (((operand_33119 = enumerator_33119.nextObject ()))) {
  macroValidPointer (operand_33119) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_33119->mInfo.mRegularFileMap,  operand_33119->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (856)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_33426
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_33426 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_33426->mFilewrapperFileMap,  operand_33426->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (868)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_33426->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_33850 (operand_33426->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_33850 = NULL ;
while (((operand_33850 = enumerator_33850.nextObject ()))) {
  macroValidPointer (operand_33850) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_33426->mFilewrapperName, operand_33850->mFilewrapperTemplateName, operand_33850->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_34244
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34244 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_34244->mTypeName, operand_34244->mAbstractCategoryMethodName, operand_34244->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_34625
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34625 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_34625->mTypeName, operand_34625->mCategoryMethodName, operand_34625->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_34990
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34990 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderDeclaration (inLexique, operand_34990->mTypeName, operand_34990->mAbstractCategoryReaderName, operand_34990->mAbstractCategoryReaderFormalParameterList, operand_34990->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryReaderForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_35388
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35388 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderDeclaration (inLexique, operand_35388->mTypeName, operand_35388->mCategoryReaderName, operand_35388->mCategoryReaderFormalParameterList, operand_35388->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_36070
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36070 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_36263
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36263 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_36263->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (943)), operand_36263->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (944)), operand_36263->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_36600
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36600 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2 (inLexique, operand_36600->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (953)), operand_36600->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (954)), ((operand_36600->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (955))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_36600->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (955)))), operand_36600->mTypedAttributeList, operand_36600->mAllTypedAttributeList, operand_36600->mIsAbstract, operand_36600->mAbstractMethodList, operand_36600->mMethodList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_37515
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_37515 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_37741
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_37741 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_37741->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (979)), operand_37741->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (980)), operand_37741->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (981)), operand_37741->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (982))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_38472
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38472 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_38694
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_38694 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_38694->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), operand_38694->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1002)), operand_38694->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_39123
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39123 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_39123->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1011)), operand_39123->mTypedAttributeList, operand_39123->mInsertMethodList, operand_39123->mSearchMethodList, operand_39123->mRemoveMethodList, operand_39123->mHasInsertOrReplaceModifier, operand_39123->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_39608
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39608 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_39608->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1025)), operand_39608->mTypedAttributeList, operand_39608->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_39995
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_39995 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_39995->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1035)), operand_39995->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1036)), operand_39995->mConstantList, operand_39995->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_40393
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40393 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_40393->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1046)), operand_40393->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1047)), operand_40393->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)), operand_40393->mAssociatedMapTypedAttributeList, operand_40393->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_40868
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_40868 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_40868->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)), operand_40868->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)), ((operand_40868->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1060))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_40868->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1060)))), operand_40868->mTypedAttributeList, operand_40868->mAllTypedAttributeList, operand_40868->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_40868->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_40868->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1063)) COMMA_SOURCE_FILE_AT_LINE (1063)), operand_40868->mIsAbstract, operand_40868->mAbstractMethodList, operand_40868->mMethodList, operand_40868->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_41558
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41558 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_41558->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1075)), operand_41558->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)), operand_41558->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_41938
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_41938 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_41938->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1085)), operand_41938->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1086)), operand_41938->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_42329
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42329 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_42329->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_42329->mRoutineName.reader_identifierRepresentation ()), operand_42329->mFormalArgumentList, operand_42329->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1096))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_42966
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_42966 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_42966->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_42966->mFunctionName.reader_identifierRepresentation ()), operand_42966->mFormalArgumentList, operand_42966->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_42966->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1118)), operand_42966->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1113)), operand_42966->mFormalArgumentList, operand_42966->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1123))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_43618
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_43618 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_43618->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_43618->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_43618->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_43618->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1137)), operand_43618->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1132)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_43618->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1142))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_44334
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44334 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_44334->mTypeName, operand_44334->mAbstractCategoryMethodName, operand_44334->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_44744
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44744 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_44744->mTypeName, GGS_string (""), operand_44744->mCategoryMethodName, operand_44744->mCategoryMethodFormalParameterList, operand_44744->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1159)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_44744->mTypeName, operand_44744->mCategoryMethodName, operand_44744->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_45368
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45368 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_45368->mTypeName, operand_45368->mBaseTypeName, operand_45368->mCategoryMethodName, operand_45368->mCategoryMethodFormalParameterList, operand_45368->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1177)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_45368->mTypeName, operand_45368->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_45971
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45971 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderImplementation (inLexique, operand_45971->mTypeName, operand_45971->mAbstractCategoryReaderName, operand_45971->mAbstractCategoryReaderFormalParameterList, operand_45971->mResultType) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryReaderForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_46398
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46398 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_46398->mTypeName, GGS_string (""), operand_46398->mCategoryReaderName, operand_46398->mCategoryReaderFormalParameterList, operand_46398->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_46398->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1212)), operand_46398->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1205)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderImplementation (inLexique, operand_46398->mTypeName, operand_46398->mCategoryReaderName, operand_46398->mCategoryReaderFormalParameterList, operand_46398->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overrideCategoryReaderForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_overrideCategoryReaderForGeneration * operand_47097
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47097 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_47097->mTypeName, operand_47097->mBaseTypeName, operand_47097->mOverridingCategoryReaderName, operand_47097->mOverridingCategoryReaderFormalParameterList, operand_47097->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_47097->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1234)), operand_47097->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1227)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryReaderImplementation (inLexique, operand_47097->mTypeName, operand_47097->mOverridingCategoryReaderName, operand_47097->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_Compiler & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_48056 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_48056 = NULL ;
while (((operand_48056 = enumerator_48056.nextObject ()))) {
  macroValidPointer (operand_48056) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_48056->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1257)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_48056->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_48056->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1260))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_48056->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1263))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_48056->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_48056->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_48056->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1267))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_48898 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_48898 = NULL ;
while (((operand_48898 = enumerator_48898.nextObject ()))) {
  macroValidPointer (operand_48898) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_48898->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)),  operand_48898->mInfo.mWrapperDirectoryIndex,  operand_48898->mInfo.mRegularFileMap,  operand_48898->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1272)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1284))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1285)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1285))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_49486 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_49486 = NULL ;
while (((operand_49486 = enumerator_49486.nextObject ()))) {
  macroValidPointer (operand_49486) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_49486->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1287))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1294))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1295)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1295))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_50097 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_50097 = NULL ;
while (((operand_50097 = enumerator_50097.nextObject ()))) {
  macroValidPointer (operand_50097) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_50097->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1297))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1303))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1306))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1307))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1308))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllDirectories_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1309))) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
  "\n") ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_51212
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51212 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_51212->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_51212->mFilewrapperFileMap,  operand_51212->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1317)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_51212->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_51671 (operand_51212->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_51671 = NULL ;
while (((operand_51671 = enumerator_51671.nextObject ()))) {
  macroValidPointer (operand_51671) ;
GGS_string var_cas_generatedCodeForInstructionList = GGS_string ("") ;
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1335))) ;
GGS_bool var_cas_useColumnMarker = GGS_bool (false) ;
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_51671->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1337)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_51212->mFilewrapperName, operand_51671->mFilewrapperTemplateName, operand_51671->mFilewrapperTemplateFormalInputParameters, (var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1349)))).operator_not (), var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
