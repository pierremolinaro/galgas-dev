...
GGS_typedAttributeList::cEnumerator enumerator_2837 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3795 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
...
result << "const GALGAS_" ;
result << operand_3795->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
result << " & inAttribute_" ;
result << operand_3795->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3795.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << " result ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_4156 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4156 = NULL ;
while (((operand_4156 = enumerator_4156.nextObject ()))) {
macroValidPointer (operand_4156) ;
result << "inAttribute_" ;
result << operand_4156->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
if (enumerator_4156.hasNextObject ()) {
result << " && " ;
}
}
result << ") {\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4372 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4372 = NULL ;
while (((operand_4372 = enumerator_4372.nextObject ()))) {
macroValidPointer (operand_4372) ;
result << "inAttribute_" ;
result << operand_4372->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4947 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4947 = NULL ;
while (((operand_4947 = enumerator_4947.nextObject ()))) {
macroValidPointer (operand_4947) ;
result << "mObjectPtr->mAttribute_" ;
result << operand_4947->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5210 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5210 = NULL ;
while (((operand_5210 = enumerator_5210.nextObject ()))) {
macroValidPointer (operand_5210) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("cPtr_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5210->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5210->mSignature, operand_5210->mInstructionList, GGS_bool (true), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (152)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5625 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5625 = NULL ;
while (((operand_5625 = enumerator_5625.nextObject ()))) {
macroValidPointer (operand_5625) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_5625->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5625->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_5625->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
result << " result ;\n"
  "  if (NULL != mObjectPtr) {\n"
  "    result = mObjectPtr->mAttribute_" ;
result << operand_5625->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_6173 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6173 = NULL ;
while (((operand_6173 = enumerator_6173.nextObject ()))) {
macroValidPointer (operand_6173) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6173->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_6173->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (NULL != mObjectPtr) {\n"
  "    mObjectPtr->mAttribute_" ;
result << operand_6173->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7019 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7019 = NULL ;
while (((operand_7019 = enumerator_7019.nextObject ()))) {
macroValidPointer (operand_7019) ;
result << "const GALGAS_" ;
result << operand_7019->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
result << " & in_" ;
result << operand_7019->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << ") :\n"
  "cPtr_class (THERE)" ;
GGS_typedAttributeList::cEnumerator enumerator_7337 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7337 = NULL ;
while (((operand_7337 = enumerator_7337.nextObject ()))) {
macroValidPointer (operand_7337) ;
result << ",\n"
  "mAttribute_" ;
result << operand_7337->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_7337->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7502 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7502 = NULL ;
while (((operand_7502 = enumerator_7502.nextObject ()))) {
macroValidPointer (operand_7502) ;
result << "const GALGAS_" ;
result << operand_7502->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ;
result << " & in_" ;
result << operand_7502->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7839 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7839 = NULL ;
while (((operand_7839 = enumerator_7839.nextObject ()))) {
macroValidPointer (operand_7839) ;
result << "in_" ;
result << operand_7839->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << ")" ;
GGS_typedAttributeList::cEnumerator enumerator_8057 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8057 = NULL ;
while (((operand_8057 = enumerator_8057.nextObject ()))) {
macroValidPointer (operand_8057) ;
result << ",\n"
  "mAttribute_" ;
result << operand_8057->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_8057->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_16012
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_16225
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16225 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_16225->mRoutineName, operand_16225->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_16552
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16552 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16552->mFunctionName, operand_16552->mFormalArgumentList, operand_16552->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (431))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_16920
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16920 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_16920->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_16920->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (441))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_17305
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17305 != NULL) {
const GGS_bool cond_17565 = operand_17305->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (448)) ;
if (cond_17565.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader1 (inLexique, operand_17305->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (450)), operand_17305->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (451)), operand_17305->mAllTypedAttributeList, operand_17305->mIsAbstract) ;
}else if (cond_17565.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader1 (inLexique, operand_17305->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), operand_17305->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)), operand_17305->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (459)), operand_17305->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (460)), operand_17305->mAllTypedAttributeList, operand_17305->mIsAbstract) ;
}
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_17305->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_17305->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_17305->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (468)), operand_17305->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), operand_17305->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)), operand_17305->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (471)), operand_17305->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (472)), operand_17305->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (473)), operand_17305->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (474)), operand_17305->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (475)), operand_17305->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (476)), operand_17305->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (477)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_18526
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18526 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_18526->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), operand_18526->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), operand_18526->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_18526->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_18526->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_18526->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_18526->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), operand_18526->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), operand_18526->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), operand_18526->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_18526->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_18526->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_18526->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_18526->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_18526->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_19367
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_19367 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_19367->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (509)), operand_19367->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), operand_19367->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_19367->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (514)), operand_19367->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (515)), operand_19367->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (516)), operand_19367->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (517)), operand_19367->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (518)), operand_19367->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (519)), operand_19367->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)), operand_19367->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_19367->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_19367->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_19367->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_19367->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (525)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_20209
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_20209 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_20209->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (533)), operand_20209->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (534)), operand_20209->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_20209->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (538)), operand_20209->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (539)), operand_20209->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (540)), operand_20209->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (541)), operand_20209->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), operand_20209->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (543)), operand_20209->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_20209->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_20209->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (546)), operand_20209->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (547)), operand_20209->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), operand_20209->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (549)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_21055
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21055 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_21055->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (557)), operand_21055->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (558)), operand_21055->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21055->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (562)), operand_21055->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (563)), operand_21055->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), operand_21055->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_21055->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_21055->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_21055->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (568)), operand_21055->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (569)), operand_21055->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (570)), operand_21055->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), operand_21055->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (572)), operand_21055->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (573)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_21901
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_21901 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_21901->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (581)), operand_21901->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (582)), operand_21901->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_21901->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (586)), operand_21901->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), operand_21901->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (588)), operand_21901->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (589)), operand_21901->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), operand_21901->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (591)), operand_21901->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), operand_21901->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), operand_21901->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (594)), operand_21901->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_21901->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (596)), operand_21901->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (597)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_23049
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_23242
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23242 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_23242->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (615)), operand_23242->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (616)), operand_23242->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_23579
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_23579 != NULL) {
const GGS_bool cond_23885 = operand_23579->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (624)) ;
if (cond_23885.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_rootClassTypeHeader2 (inLexique, operand_23579->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (626)), operand_23579->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (627)), operand_23579->mAllTypedAttributeList, operand_23579->mAbstractMethodList, operand_23579->mMethodList, operand_23579->mIsAbstract) ;
}else if (cond_23885.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_inheritedClassTypeHeader2 (inLexique, operand_23579->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (635)), operand_23579->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (636)), operand_23579->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (637)), operand_23579->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (638)), operand_23579->mTypedAttributeList, operand_23579->mAllTypedAttributeList, operand_23579->mIsAbstract, operand_23579->mAbstractMethodList, operand_23579->mMethodList) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_24822
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24822 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_25048
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25048 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_25048->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (663)), operand_25048->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (664)), operand_25048->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (665))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_25739
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_25961
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25961 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_listmapTypeSpecificImplementation (inLexique, operand_25961->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (684)), operand_25961->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (685)), operand_25961->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_26392
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26392 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_26392->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (694)), operand_26392->mTypedAttributeList, operand_26392->mInsertMethodList, operand_26392->mSearchMethodList, operand_26392->mRemoveMethodList, operand_26392->mHasInsertOrReplaceModifier, operand_26392->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_26877
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26877 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_26877->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (708)), operand_26877->mTypedAttributeList, operand_26877->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_27264
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27264 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_27264->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (718)), operand_27264->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (719)), operand_27264->mConstantList, operand_27264->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_27662
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27662 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplateEX_mapProxyTypeSpecificImplementation (inLexique, operand_27662->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (729)), operand_27662->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (730)), operand_27662->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (731)), operand_27662->mAssociatedMapTypedAttributeList, operand_27662->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_28139
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28139 != NULL) {
const GGS_bool cond_28619 = operand_28139->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (740)) ;
if (cond_28619.isBuiltAndTrue ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_rootClassTypeSpecificImplementation (inLexique, operand_28139->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (742)), operand_28139->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (743)), operand_28139->mTypedAttributeList, operand_28139->mAllTypedAttributeList, operand_28139->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28139->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28139->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)), operand_28139->mIsAbstract, operand_28139->mAbstractMethodList, operand_28139->mMethodList) ;
}else if (cond_28619.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_inheritedClassTypeSpecificImplementation (inLexique, operand_28139->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (753)), operand_28139->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (754)), operand_28139->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (755)), operand_28139->mBaseClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (756)), operand_28139->mTypedAttributeList, operand_28139->mAllTypedAttributeList, operand_28139->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_28139->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_28139->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (759)) COMMA_SOURCE_FILE_AT_LINE (759)), operand_28139->mIsAbstract, operand_28139->mAbstractMethodList, operand_28139->mMethodList) ;
}
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_29301
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29301 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_29301->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29301->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (772)), operand_29301->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_29681
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_29681 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_29681->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (781)), operand_29681->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), operand_29681->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_30072
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30072 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_30072->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_30072->mRoutineName.reader_identifierRepresentation ()), operand_30072->mFormalArgumentList, operand_30072->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (792))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_30709
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_30709 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_30709->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_30709->mFunctionName.reader_identifierRepresentation ()), operand_30709->mFormalArgumentList, operand_30709->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_30709->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (814)), operand_30709->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (809)), operand_30709->mFormalArgumentList, operand_30709->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (818))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_31332
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_31332 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_31332->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_31332->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31332->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_31332->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (832)), operand_31332->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (827)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_31332->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (836))) ;
  }
  return var_cas_outImplementation ;
}
