...
//                    november 10th, 2010, at 15h37'33"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_" ;
result << operand_1839->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_457->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
  "\n" ;
}
result << "//---------------------------------------------------------------------------*\n"
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_4972 = GGS_uint (2U) ;
if (indentation_4972.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_4972.uintValue ()) ;
}
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_5011 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_5011 = NULL ;
while (((operand_5011 = enumerator_5011.nextObject ()))) {
macroValidPointer (operand_5011) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5011->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_5011->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5476 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5476 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5476 = enumerator_5476.nextObject ()))) {
macroValidPointer (operand_5476) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5476->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) const {\n" ;
const GGS_uint indentation_6327 = GGS_uint (2U) ;
if (indentation_6327.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6327.uintValue ()) ;
}
...
result << " COMMA_THERE) ;\n"
  "if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_5966 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5966 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_6163 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6163 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6163 = enumerator_6163.nextObject ()))) {
macroValidPointer (operand_6163) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
result << " = p->mAttribute_" ;
result << operand_6163->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_6367 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_6367 = NULL ;
while (((operand_6367 = enumerator_6367.nextObject ()))) {
macroValidPointer (operand_6367) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_6367->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_6603 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6603 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6603->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_7421 = GGS_uint (2U) ;
if (indentation_7421.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_7421.uintValue ()) ;
}
result << "const char * kRemoveErrorMessage = " ;
result << operand_6367->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7257 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7257 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
result << " = p->mAttribute_" ;
result << operand_7257->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7666 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7666 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7666->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7966 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7966 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
GGS_typedAttributeList::cEnumerator enumerator_8246 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8246 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8246 = enumerator_8246.nextObject ()))) {
macroValidPointer (operand_8246) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_8246->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_8246->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string & inKey,\n"
  "                                               " ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_8246->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_9245 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9245 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9245 = enumerator_9245.nextObject ()))) {
macroValidPointer (operand_9245) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_9245->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_9245->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_9245->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_10185 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_10185 = NULL ;
while (((operand_10185 = enumerator_10185.nextObject ()))) {
macroValidPointer (operand_10185) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_10185->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_10185->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_10185->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << "::current_lkey (void) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11766 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11766 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11766 = enumerator_11766.nextObject ()))) {
macroValidPointer (operand_11766) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11766->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11766->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
