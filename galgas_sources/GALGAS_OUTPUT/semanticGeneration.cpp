...
result << " (LOCATION_ARGS) {\n"
  ...
  "  switch (mEnumValue) {\n" ;
GGS_enumMessageAssociationSortedListForGeneration::cEnumerator enumerator_1076 (operand_761->mMessageAssociationList, true) ;
const GGS_enumMessageAssociationSortedListForGeneration::cElement * operand_1076 = NULL ;
while (((operand_1076 = enumerator_1076.nextObject ()))) {
macroValidPointer (operand_1076) ;
result << "  case kEnum_" ;
result << operand_1076->mConstantName.reader_identifierRepresentation () ;
result << ":\n"
  "    result = GALGAS_string::constructor_new (" ;
result << operand_1076->mMessage.reader_utf8Representation () ;
result << " COMMA_THERE) ;\n"
  "    break ;\n" ;
}
result << "  }\n"
...
GGS_enumMessageListForGeneration::cEnumerator enumerator_1357 (var_cas_ENUM_MESSAGE_LIST, true) ;
const GGS_enumMessageListForGeneration::cElement * operand_1357 = NULL ;
while (((operand_1357 = enumerator_1357.nextObject ()))) {
macroValidPointer (operand_1357) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_string * readerCall_" ;
result << operand_1357->mEnumMessageName.reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "const PMSInt32 /* inIndentation */) const {\n"
  "  const char * gEnumNameArray [" ;
result << var_cas_CONSTANT_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
result << "] = {" ;
GGS_stringlist::cEnumerator enumerator_2245 (var_cas_CONSTANT_LIST, true) ;
const GGS_stringlist::cElement * operand_2245 = NULL ;
while (((operand_2245 = enumerator_2245.nextObject ()))) {
macroValidPointer (operand_2245) ;
result << "\n"
  "    " ;
result << operand_2245->mValue.reader_utf8Representation () ;
...
result << "\n"
  ...
  "  ioString << \"<enum @" ;
result << var_cas_TYPE_NAME ;
result << ": \" << gEnumNameArray [mEnumValue] << \">\" ;\n"
  "}\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
