...
GGS_instanceMethodMap::cEnumerator enumerator_10508 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_10508 = NULL ;
while (((operand_10508 = enumerator_10508.nextObject ()))) {
macroValidPointer (operand_10508) ;
if (((operand_10508->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (254)))).operator_or ((operand_10508->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (254)))).boolValue ()) {
result << "public : void instanceMethodCall_" ;
result << operand_10508->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10717 (operand_10508->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10717 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10717 = enumerator_10717.nextObject ()))) {
macroValidPointer (operand_10717) ;
if ((operand_10717->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (257))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10717->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
}else if ((operand_10717->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (259))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10717->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
}else if ((operand_10717->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (261))).boolValue ()) {
result << "GALGASap_" ;
result << operand_10717->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
}else {
result << "GALGASap_" ;
result << operand_10717->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
}
if (enumerator_10717.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_10508->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10508->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_10508->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_8516 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_8516 = NULL ;
while (((operand_8516 = enumerator_8516.nextObject ()))) {
macroValidPointer (operand_8516) ;
if (((operand_8516->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (212)))).operator_or ((operand_8516->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (212)))).boolValue ()) {
result << "public : void instanceMethodCall_" ;
result << operand_8516->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_8725 (operand_8516->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_8725 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8725 = enumerator_8725.nextObject ()))) {
macroValidPointer (operand_8725) ;
if ((operand_8725->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (215))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8725->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
}else if ((operand_8725->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (217))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8725->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
}else if ((operand_8725->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).boolValue ()) {
result << "GALGASap_" ;
result << operand_8725->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
}else {
result << "GALGASap_" ;
result << operand_8725->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
}
if (enumerator_8725.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_8516->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_8516->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
}else if (operand_8516->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- Comparison\n"
...
GGS_nativeAttributeList::cEnumerator enumerator_11035 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_11035 = NULL ;
while (((operand_11035 = enumerator_11035.nextObject ()))) {
macroValidPointer (operand_11035) ;
result << "  private : " ;
if (operand_11035->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_11035->mCppClassName ;
result << " " ;
if (operand_11035->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_11035->mAttributeName ;
result << " ;\n" ;
if ((operand_11035->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if ((operand_11035->mIsConst).operator_not ().boolValue ()) {
...
result << operand_11035->mGetterName ;
result << " (void) { return " ;
result << operand_11035->mAttributeName ;
result << " ; }\n" ;
}else {
...
GGS_typedAttributeList::cEnumerator enumerator_11564 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11564 = NULL ;
while (((operand_11564 = enumerator_11564.nextObject ()))) {
macroValidPointer (operand_11564) ;
result << "  public : GALGASap_" ;
result << operand_11564->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) ;
result << " mAttribute_" ;
result << operand_11564->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (291)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (298)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_12596 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_12596 = NULL ;
while (((operand_12596 = enumerator_12596.nextObject ()))) {
macroValidPointer (operand_12596) ;
result << "  friend capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_12596->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_12596->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (310)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_13375 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_13375 = NULL ;
while (((operand_13375 = enumerator_13375.nextObject ()))) {
macroValidPointer (operand_13375) ;
result << "    public : GALGASap_" ;
result << operand_13375->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
result << " attribute_" ;
result << operand_13375->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_13742 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13742 = NULL ;
while (((operand_13742 = enumerator_13742.nextObject ()))) {
macroValidPointer (operand_13742) ;
result << "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_13742->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_13742->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (343)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
