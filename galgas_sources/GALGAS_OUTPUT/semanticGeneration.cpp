...
//                    september 26th, 2010, at 19h54'33"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_classMethodMap::cEnumerator enumerator_10182 (var_cas_CLASS_METHOD_MAP, true) ;
const GGS_classMethodMap::cElement * operand_10182 = NULL ;
while (((operand_10182 = enumerator_10182.nextObject ()))) {
macroValidPointer (operand_10182) ;
result << "  public : static void class_method_" ;
result << operand_10182->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_formalParameterSignature::cEnumerator enumerator_10289 (operand_10182->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_10289 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10289 = enumerator_10289.nextObject ()))) {
macroValidPointer (operand_10289) ;
if ((operand_10289->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (240))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10289->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
}else if ((operand_10289->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (242))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10289->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) ;
}else if ((operand_10289->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (244))).boolValue ()) {
result << "GALGAS_" ;
result << operand_10289->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
}else {
result << "GALGAS_" ;
result << operand_10289->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " inArgument" ;
...
if ((operand_10182->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_10182->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_11467 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_11467 = NULL ;
while (((operand_11467 = enumerator_11467.nextObject ()))) {
macroValidPointer (operand_11467) ;
if ((((operand_11467->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))).operator_or ((operand_11467->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (272))))).operator_or ((operand_11467->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (272)))).boolValue ()) {
result << "  public :" ;
if ((operand_11467->mInfo.mQualifier).operator_isEqual (GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (274))).boolValue ()) {
result << " VIRTUAL_IN_DEBUG " ;
}else {
result << " virtual " ;
}
result << "GALGAS_" ;
result << operand_11467->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (279)) ;
result << " reader_" ;
result << operand_11467->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11904 (operand_11467->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_11904 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11904 = enumerator_11904.nextObject ()))) {
macroValidPointer (operand_11904) ;
result << "const GALGAS_" ;
result << operand_11904->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (281)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (281)) ;
if (enumerator_11904.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_11467->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_11467->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (305)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (312)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
GGS_withAccessorMap::cEnumerator enumerator_13488 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_13488 = NULL ;
while (((operand_13488 = enumerator_13488.nextObject ()))) {
macroValidPointer (operand_13488) ;
result << "  friend cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_13488->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_13488->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (324)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_14587 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_14587 = NULL ;
while (((operand_14587 = enumerator_14587.nextObject ()))) {
macroValidPointer (operand_14587) ;
result << "  public : GALGAS_" ;
result << operand_14587->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (346)) ;
result << " current_" ;
result << operand_14587->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "} ;\n" ;
}else {
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_15049 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_15049 = NULL ;
while (((operand_15049 = enumerator_15049.nextObject ()))) {
macroValidPointer (operand_15049) ;
result << "cCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_15049->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_15049->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (361)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9028 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9028 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9028 = enumerator_9028.nextObject ()))) {
macroValidPointer (operand_9028) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9206 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9206 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_9206->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9499 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9499 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9499 = enumerator_9499.nextObject ()))) {
macroValidPointer (operand_9499) ;
result << "GALGAS_" ;
result << operand_9499->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9927 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9927 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9927 = enumerator_9927.nextObject ()))) {
macroValidPointer (operand_9927) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10105 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10105 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10105 = enumerator_10105.nextObject ()))) {
macroValidPointer (operand_10105) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
result << " = p->mAttribute_" ;
result << operand_10105->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12106 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12106 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_12106->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_12106->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_12106->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inOperand ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_13048->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (349)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGAS_" ;
result << operand_13048->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << " & inOperand2) {\n"
  ...
  "    if (inOperand1.mEnum < inOperand2.mEnum) {\n"
  "      result = kFirstOperandLowerThanSecond ;\n"
  "    }else if (inOperand1.mEnum > inOperand2.mEnum) {\n"
