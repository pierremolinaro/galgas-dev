  ...
  if (isBuilt) {
    ...
    if ((var_cas_TYPE_IDENTIFIER).operator_isEqual (GGS_string ("bool")).boolValue ()) {
      result << "//--------------------------------- Comparison constructor\n"
        "  public : GALGASap_bool (const enumGalgasComparison inComparisonKind,\n"
        "                          const PMSInt32 inComparisonResult\n"
        "                          COMMA_LOCATION_ARGS) ;\n" ;
    }else {
    }
...
result << "//--------------------------------- Comparison\n"
  "  public : static PMSInt32 objectCompare (const GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inOperand1,\n"
  "                                          const GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_nativeAttributeList::cEnumerator enumerator_19898 (var_cas_NATIVE_ATTRIBUTE_LIST, true) ;
const GGS_nativeAttributeList::cElement * operand_19898 = NULL ;
while (((operand_19898 = enumerator_19898.nextObject ()))) {
macroValidPointer (operand_19898) ;
result << "  private : " ;
if (operand_19898->mIsConst.boolValue ()) {
result << "const " ;
}else {
}
result << operand_19898->mCppClassName ;
result << " " ;
if (operand_19898->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_19898->mAttributeName ;
result << " ;\n" ;
if ((operand_19898->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_19898->mGetterName ;
...
GGS_typedAttributeList::cEnumerator enumerator_20285 (var_cas_PRIVATE_DATA_NUMBER_TYPED_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_20285 = NULL ;
while (((operand_20285 = enumerator_20285.nextObject ()))) {
macroValidPointer (operand_20285) ;
result << "  public : GALGASap_" ;
result << operand_20285->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) ;
result << " mAttribute_" ;
result << operand_20285->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
}
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_generateEnumerationHelperMethods (inLexique COMMA_SOURCE_FILE_AT_LINE (492)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
...
result << "//--------------------------------- Abstract method for comparing two sorted list elements\n"
  "  protected : virtual PMSInt32 compareSortedListElements (const capCollectionElement & inLeftAttributeList,\n"
...
GGS_withAccessorMap::cEnumerator enumerator_21293 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_21293 = NULL ;
while (((operand_21293 = enumerator_21293.nextObject ()))) {
macroValidPointer (operand_21293) ;
result << "  friend capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_21293->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_21293->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
GGS_enumerationDescriptorList::cEnumerator enumerator_22072 (var_cas_ENUMERATION_DESCRIPTOR_LIST, true) ;
const GGS_enumerationDescriptorList::cElement * operand_22072 = NULL ;
while (((operand_22072 = enumerator_22072.nextObject ()))) {
macroValidPointer (operand_22072) ;
result << "    public : GALGASap_" ;
result << operand_22072->mEnumeratedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) ;
result << " attribute_" ;
result << operand_22072->mEnumerationName.reader_identifierRepresentation () ;
result << " ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
GGS_readerMap::cEnumerator enumerator_22400 (var_cas_READER_MAP, true) ;
const GGS_readerMap::cElement * operand_22400 = NULL ;
while (((operand_22400 = enumerator_22400.nextObject ()))) {
macroValidPointer (operand_22400) ;
if ((operand_22400->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (542))).boolValue ()) {
result << "GALGASap_" ;
result << operand_22400->mInfo.mReturnedType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (543)) ;
result << " readerCall_" ;
result << operand_22400->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & inObject" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22648 (operand_22400->mInfo.mArgumentTypeList, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_22648 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22648 = enumerator_22648.nextObject ()))) {
macroValidPointer (operand_22648) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_22648->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (546)) ;
result << " & constinOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (546)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_22400->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
GGS_modifierMap::cEnumerator enumerator_23049 (var_cas_MODIFIER_MAP, true) ;
const GGS_modifierMap::cElement * operand_23049 = NULL ;
while (((operand_23049 = enumerator_23049.nextObject ()))) {
macroValidPointer (operand_23049) ;
if ((operand_23049->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (560))).boolValue ()) {
result << "void modifierCall_" ;
result << operand_23049->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_23233 (operand_23049->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_23233 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_23233 = enumerator_23233.nextObject ()))) {
macroValidPointer (operand_23233) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_23233->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23233->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (565)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)) ;
}else if ((operand_23233->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (566))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23233->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (567)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (567)) ;
}else if ((operand_23233->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (568))).boolValue ()) {
result << "GALGASap_" ;
result << operand_23233->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (569)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (569)) ;
}else {
result << "GALGASap_" ;
result << operand_23233->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (571)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (571)) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_23049->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n"
  "//--------------------------------- Instance Method Invocation\n" ;
GGS_instanceMethodMap::cEnumerator enumerator_24273 (var_cas_INSTANCE_METHOD_MAP, true) ;
const GGS_instanceMethodMap::cElement * operand_24273 = NULL ;
while (((operand_24273 = enumerator_24273.nextObject ()))) {
macroValidPointer (operand_24273) ;
if (((operand_24273->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (587)))).operator_or ((operand_24273->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (587)))).boolValue ()) {
result << "void instanceMethodCall_" ;
result << operand_24273->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_24511 (operand_24273->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_24511 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_24511 = enumerator_24511.nextObject ()))) {
macroValidPointer (operand_24511) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
if ((operand_24511->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (591))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24511->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (592)) ;
result << " constinArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (592)) ;
}else if ((operand_24511->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (593))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24511->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (594)) ;
result << " & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (594)) ;
}else if ((operand_24511->mFormalArgumentPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (595))).boolValue ()) {
result << "GALGASap_" ;
result << operand_24511->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) ;
}else {
result << "GALGASap_" ;
result << operand_24511->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) ;
result << " inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_24273->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_25585 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_25585 = NULL ;
while (((operand_25585 = enumerator_25585.nextObject ()))) {
macroValidPointer (operand_25585) ;
result << "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_25585->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_25585->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (616)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_unifiedTypeMapProxyList::cEnumerator enumerator_26101 (var_cas_ADD_ASSIGN_ARGUMENT_LIST, true) ;
const GGS_unifiedTypeMapProxyList::cElement * operand_26101 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_26101 = enumerator_26101.nextObject ()))) {
macroValidPointer (operand_26101) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_26101->mType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (625)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (625)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
result << "\n" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (630)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- .= operator\n"
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (637)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- << and >> shift operators\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " left_shift_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (647)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_and (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (654)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- | operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_or (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (661)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ^ operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_xor (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (668)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- & operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_not (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (674)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ~ operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_tilde (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (680)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- . (concat) operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_concat (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (687)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- + operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " add_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (695)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- - operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " substract_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (703)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- * operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " multiply_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (711)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- / operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " divide_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (719)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- mod operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " modulo_operation (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (727)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- unary - operator\n"
  "GALGASap_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " operator_unary_minus (" ;
...
if (((var_cas_SUPPORTED_OPERATORS).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (734)))).operator_isNotEqual (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- ++, -- operators\n"
...
result << ") ;\n"
  ...
  "  public : virtual PMSInt32 compare (const cCollectionElement * inOperand) ;\n"
  "\n"
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1497 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1497 = NULL ;
while (((operand_1497 = enumerator_1497.nextObject ()))) {
macroValidPointer (operand_1497) ;
result << "GALGASap_" ;
result << operand_1497->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
result << " & in_" ;
result << operand_1497->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1497.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_1700 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1700 = NULL ;
while (((operand_1700 = enumerator_1700.nextObject ()))) {
macroValidPointer (operand_1700) ;
result << ",\n"
  "mAttribute_" ;
result << operand_1700->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_1700->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_2435 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2435 = NULL ;
while (((operand_2435 = enumerator_2435.nextObject ()))) {
macroValidPointer (operand_2435) ;
result << "mAttribute_" ;
result << operand_2435->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " *) inOperand ;\n"
  "  PMSInt32 result = 0 ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_2891 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2891 = NULL ;
while (((operand_2891 = enumerator_2891.nextObject ()))) {
macroValidPointer (operand_2891) ;
result << "  if (0 == result) {\n"
  "    result = GALGAS_" ;
result << operand_2891->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
result << "::objectCompare (mAttribute_" ;
result << operand_2891->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "] = {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3414 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "  & kTypeDescriptor_GALGAS_" ;
result << operand_3414->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4247 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4247 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4247 = enumerator_4247.nextObject ()))) {
macroValidPointer (operand_4247) ;
result << "GALGASap_" ;
result << operand_4247->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
if (enumerator_4247.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4627 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4627 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_4627.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_typedAttributeList::cEnumerator enumerator_5406 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5406 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_5406->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) ;
result << " inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5777 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5777 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5777 = enumerator_5777.nextObject ()))) {
macroValidPointer (operand_5777) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (152)) ;
if (enumerator_5777.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6123 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6123 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6123 = enumerator_6123.nextObject ()))) {
macroValidPointer (operand_6123) ;
result << "GALGASap_" ;
result << operand_6123->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
if (enumerator_6123.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_6332 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6332 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6332 = enumerator_6332.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6554 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6554 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_6554.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_6887 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6887 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6887 = enumerator_6887.nextObject ()))) {
macroValidPointer (operand_6887) ;
result << "GALGASap_" ;
result << operand_6887->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7320 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7320 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7320 = enumerator_7320.nextObject ()))) {
macroValidPointer (operand_7320) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7498 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7498 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_7498->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7796 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7796 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7796 = enumerator_7796.nextObject ()))) {
macroValidPointer (operand_7796) ;
result << "GALGASap_" ;
result << operand_7796->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8228 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8228 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8228 = enumerator_8228.nextObject ()))) {
macroValidPointer (operand_8228) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8406 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8406 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8406 = enumerator_8406.nextObject ()))) {
macroValidPointer (operand_8406) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ;
result << " = p->mAttribute_" ;
result << operand_8406->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "GALGASap_" ;
result << operand_8700->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9125 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9125 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257)) ;
result << " = p->mAttribute_" ;
result << operand_9303->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9596 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9596 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9596 = enumerator_9596.nextObject ()))) {
macroValidPointer (operand_9596) ;
result << "GALGASap_" ;
result << operand_9596->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10020 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10020 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10020 = enumerator_10020.nextObject ()))) {
macroValidPointer (operand_10020) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10198 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10198 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10198 = enumerator_10198.nextObject ()))) {
macroValidPointer (operand_10198) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) ;
result << " = p->mAttribute_" ;
result << operand_10198->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::insulate (ioResult COMMA_THERE) ;\n"
  ...
  "  }\n"
  "}\n" ;
GGS_typedAttributeList::cEnumerator enumerator_12705 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_12705 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_12705 = enumerator_12705.nextObject ()))) {
macroValidPointer (operand_12705) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_12705->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_12705->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (346)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_uint inIndex,\n"
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_12705->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inOperand ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_13651 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_13651 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_13651 = enumerator_13651.nextObject ()))) {
macroValidPointer (operand_13651) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_13651->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (361)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_13651->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_uint & inIndex,\n"
  "                                              " ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGASap_" ;
result << operand_13651->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring & inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_1540 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1540 = NULL ;
while (((operand_1540 = enumerator_1540.nextObject ()))) {
macroValidPointer (operand_1540) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_1540->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (35)) ;
result << " & in_" ;
result << operand_1540->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
}
result << ") :\n"
  "cCollectionElementForMap (inKey)" ;
...
result << ",\n"
  "mAttribute_" ;
result << operand_1737->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (in_" ;
result << operand_1737->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ")" ;
}
...
GGS_typedAttributeList::cEnumerator enumerator_2091 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2091 = NULL ;
while (((operand_2091 = enumerator_2091.nextObject ()))) {
macroValidPointer (operand_2091) ;
result << " && mAttribute_" ;
result << operand_2091->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
}
result << " ;\n"
  "}\n"
...
GGS_typedAttributeList::cEnumerator enumerator_2496 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_2496 = NULL ;
while (((operand_2496 = enumerator_2496.nextObject ()))) {
macroValidPointer (operand_2496) ;
result << ", mAttribute_" ;
result << operand_2496->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
}
result << ")) ;\n"
  "  return result ;\n"
  "}\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " *) inOperand ;\n"
  "  PMSInt32 result = GALGAS_lstring::objectCompare (mAttribute_lkey, operand->mAttribute_lkey) ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_3007 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3007 = NULL ;
while (((operand_3007 = enumerator_3007.nextObject ()))) {
macroValidPointer (operand_3007) ;
result << "  if (0 == result) {\n"
  "    result = GALGAS_" ;
result << operand_3007->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
result << "::objectCompare (mAttribute_" ;
result << operand_3007->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ", operand->mAttribute_" ;
result << operand_3007->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ") ;\n"
  "  }\n" ;
...
result << "::constructor_emptyMap (THERE) ;\n"
  ...
  "}\n"
  "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_5107 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_5107 = NULL ;
while (((operand_5107 = enumerator_5107.nextObject ()))) {
macroValidPointer (operand_5107) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_5107->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5345 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5345 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_5345->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5700 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5700 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " COMMA_HERE)) ;\n"
  "  capCollectionElement attributes (p) ;\n" ;
const GGS_uint indentation_6221 = GGS_uint (2U) ;
if (indentation_6221.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6221.uintValue ()) ;
}
result << "const utf32 kInsertErrorMessage [" ;
result << operand_5107->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (143)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
result << "] = " ;
result << operand_5107->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "const utf32 kShadowErrorMessage [" ;
result << operand_5107->mShadowErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (144)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (144)) ;
result << "] = " ;
result << operand_5107->mShadowErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_6260 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_6260 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_6260->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " [" ;
result << operand_6260->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (152)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (152)) ;
result << "] = " ;
result << operand_6260->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_6775->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_7568 = GGS_uint (2U) ;
if (indentation_7568.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_7568.uintValue ()) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7404 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7404 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
result << " = p->mAttribute_" ;
result << operand_7404->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_7608 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_7608 = NULL ;
while (((operand_7608 = enumerator_7608.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_7608->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7846 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7846 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_7846->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_8722 = GGS_uint (2U) ;
if (indentation_8722.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_8722.uintValue ()) ;
}
result << "const utf32 kRemoveErrorMessage [" ;
result << operand_7608->mErrorMessage.ggs_string ().reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (183)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
result << "] = " ;
result << operand_7608->mErrorMessage.ggs_string ().reader_utf32Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8558 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8558 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_8558->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_8973 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8973 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_8973->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_ATTRIBUTE_LIST.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (204)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204)) ;
result << "] = {inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_9252 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9252 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9252 = enumerator_9252.nextObject ()))) {
macroValidPointer (operand_9252) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_9404 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9404 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_9404->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_9404->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  GALGASap_" ;
result << operand_9404->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_10402 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10402 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10402 = enumerator_10402.nextObject ()))) {
macroValidPointer (operand_10402) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_10402->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_10402->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_10402->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_11306 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_11306 = NULL ;
while (((operand_11306 = enumerator_11306.nextObject ()))) {
macroValidPointer (operand_11306) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "capCollectionElement * readWriteAccessForWithInstruction_" ;
result << operand_11306->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_11306->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n"
...
if ((operand_11306->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (252))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << " *) ;\n" ;
GGS_sortDescriptorListForGeneration::cEnumerator enumerator_4542 (var_cas_SORT_ATTRIBUTE_LIST, true) ;
const GGS_sortDescriptorListForGeneration::cElement * operand_4542 = NULL ;
while (((operand_4542 = enumerator_4542.nextObject ()))) {
macroValidPointer (operand_4542) ;
result << "  if (result == 0) {\n"
  "    result = " ;
if (operand_4542->mAscendingOrder.boolValue ()) {
}else {
result << "- " ;
}
result << "GALGAS_" ;
result << operand_4542->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
result << "::objectCompare (p1->mAttribute_" ;
result << operand_4542->mAttributeName.reader_identifierRepresentation () ;
...
GGS_typedAttributeList::cEnumerator enumerator_5882 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5882 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5882 = enumerator_5882.nextObject ()))) {
macroValidPointer (operand_5882) ;
result << "GALGASap_" ;
result << operand_5882->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6274 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6274 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_6274.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " & ioResult" ;
GGS_typedAttributeList::cEnumerator enumerator_6633 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6633 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6633 = enumerator_6633.nextObject ()))) {
macroValidPointer (operand_6633) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGASap_" ;
result << operand_6633->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
result << " inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7011 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7011 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7011 = enumerator_7011.nextObject ()))) {
macroValidPointer (operand_7011) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (171)) ;
if (enumerator_7011.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8444 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8444 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8444 = enumerator_8444.nextObject ()))) {
macroValidPointer (operand_8444) ;
result << "GALGASap_" ;
result << operand_8444->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8898 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8898 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9076 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9076 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9076 = enumerator_9076.nextObject ()))) {
macroValidPointer (operand_9076) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ;
result << " = p->mAttribute_" ;
result << operand_9076->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9378 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9378 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9378 = enumerator_9378.nextObject ()))) {
macroValidPointer (operand_9378) ;
result << "GALGASap_" ;
result << operand_9378->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (234)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9832 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9832 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10010 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10010 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_10010->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10307 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10307 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10307 = enumerator_10307.nextObject ()))) {
macroValidPointer (operand_10307) ;
result << "GALGASap_" ;
result << operand_10307->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (259)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10758 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10758 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10936 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10936 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10936 = enumerator_10936.nextObject ()))) {
macroValidPointer (operand_10936) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (275)) ;
result << " = p->mAttribute_" ;
result << operand_10936->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_11233 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11233 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11233 = enumerator_11233.nextObject ()))) {
macroValidPointer (operand_11233) ;
result << "GALGASap_" ;
result << operand_11233->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (284)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptrNoVerif () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11684 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11684 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11684 = enumerator_11684.nextObject ()))) {
macroValidPointer (operand_11684) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (294)) ;
result << ".drop () ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11862 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11862 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11862 = enumerator_11862.nextObject ()))) {
macroValidPointer (operand_11862) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (300)) ;
result << " = p->mAttribute_" ;
result << operand_11862->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "  if (result == 0) {\n"
  "    result = GALGAS_" ;
result << operand_3624->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::drop (void) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4383 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4383 = NULL ;
while (((operand_4383 = enumerator_4383.nextObject ()))) {
macroValidPointer (operand_4383) ;
result << "  mAttribute_" ;
result << operand_4383->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".drop () ;\n" ;
}
result << "}\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_4761 (var_cas_ATTRIBUTE_LIST, true) ;
...
result << "mAttribute_" ;
result << operand_4761->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_4761.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_HERE)) ;\n"
...
GGS_typedAttributeList::cEnumerator enumerator_785 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_785 = NULL ;
while (((operand_785 = enumerator_785.nextObject ()))) {
macroValidPointer (operand_785) ;
result << "  if (0 == result) {\n"
  "    result = GALGAS_" ;
result << operand_785->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
result << "::objectCompare (inOperand1.ptr (HERE)->mAttribute_" ;
result << operand_785->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << " (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_1313 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1313 = NULL ;
while (((operand_1313 = enumerator_1313.nextObject ()))) {
macroValidPointer (operand_1313) ;
result << "GALGASap_" ;
result << operand_1313->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (29)) ;
result << " & constinAttribute_" ;
result << operand_1313->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1313.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << var_cas_SUPER_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_1670 (var_cas_INHERITED_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_1670 = NULL ;
while (((operand_1670 = enumerator_1670.nextObject ()))) {
macroValidPointer (operand_1670) ;
result << "constinAttribute_" ;
result << operand_1670->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_1670.hasNextObject ()) {
result << ", " ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_1896 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
...
result << "::constructor_new (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_3086 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3086 = NULL ;
while (((operand_3086 = enumerator_3086.nextObject ()))) {
macroValidPointer (operand_3086) ;
result << "GALGASap_" ;
result << operand_3086->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
result << " & inAttribute_" ;
result << operand_3086->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3086.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
}
...
result << " * result = NULL ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_3452 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3452 = NULL ;
while (((operand_3452 = enumerator_3452.nextObject ()))) {
macroValidPointer (operand_3452) ;
result << "inAttribute_" ;
result << operand_3452->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << ".isValid ()" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_3659 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_3659 = NULL ;
while (((operand_3659 = enumerator_3659.nextObject ()))) {
macroValidPointer (operand_3659) ;
result << "inAttribute_" ;
result << operand_3659->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
if (enumerator_3659.hasNextObject ()) {
result << ", " ;
}
}
result << " COMMA_THERE)) ;\n"
...
result << "const PMSInt32 /* inIndentation */) {\n"
  ...
  "           << typeDescriptor ()->mGalgasTypeName\n"
  "           << \":\" ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_4213 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4213 = NULL ;
while (((operand_4213 = enumerator_4213.nextObject ()))) {
macroValidPointer (operand_4213) ;
result << "//  mAttribute_" ;
result << operand_4213->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "->description (ioString, inIndentation + 1) ;\n" ;
if (enumerator_4213.hasNextObject ()) {
result << "  ioString << \", \" ;\n" ;
}
}
result << "  ioString << \">\" ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_new (" ;
GGS_typedAttributeList::cEnumerator enumerator_5045 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5045 = NULL ;
while (((operand_5045 = enumerator_5045.nextObject ()))) {
macroValidPointer (operand_5045) ;
result << "ioObject.ptr (HERE)->mAttribute_" ;
result << operand_5045->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_methodDefinitionListForGeneration::cEnumerator enumerator_5260 (var_cas_CONCRETE_METHOD_LIST, true) ;
const GGS_methodDefinitionListForGeneration::cElement * operand_5260 = NULL ;
while (((operand_5260 = enumerator_5260.nextObject ()))) {
macroValidPointer (operand_5260) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n" ;
result << function_generateProcedure (inLexique, (((GGS_string ("GALGAS_")).operator_concat (var_cas_TYPE_IDENTIFIER)).operator_concat (GGS_string ("::method_"))).operator_concat (operand_5260->mMethodName.ggs_string ().reader_identifierRepresentation ()), operand_5260->mSignature, operand_5260->mInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (138)) ;
}
GGS_typedAttributeList::cEnumerator enumerator_5681 (var_cas_CURRENT_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5681 = NULL ;
while (((operand_5681 = enumerator_5681.nextObject ()))) {
macroValidPointer (operand_5681) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGASap_" ;
result << operand_5681->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_5681->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (UNUSED_LOCATION_ARGS) {\n"
  "  return mAttribute_" ;
result << operand_5681->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
...
GGS_typedAttributeList::cEnumerator enumerator_6089 (var_cas_ALL_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6089 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_6089->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGASap_" ;
result << operand_6089->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ;
result << " inValue\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_UNUSED_LOCATION_ARGS) {\n"
  "  mAttribute_" ;
result << operand_6089->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inValue ;\n"
  "}\n"
  "\n" ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_14918
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_14918 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_15130
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15130 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_15130->mRoutineName, operand_15130->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_15456
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15456 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15456->mFunctionName, operand_15456->mFormalArgumentList, operand_15456->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (391))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_15823
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_15823 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_15823->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_15823->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (401))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_16210
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_16210 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeHeader (inLexique, operand_16210->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (409)), operand_16210->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (410)), operand_16210->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (411)), operand_16210->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (412)), operand_16210->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (413)), operand_16210->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (414)), operand_16210->mTypeIndex.reader_mInheritedTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (415)), operand_16210->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (416)), operand_16210->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (417)), operand_16210->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (418)), operand_16210->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (419)), operand_16210->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (420)), operand_16210->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (421)), operand_16210->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (422)), operand_16210->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (423)), operand_16210->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (424)), operand_16210->mTypeIndex.reader_mEnumConstantList (inLexique COMMA_SOURCE_FILE_AT_LINE (425)), operand_16210->mTypeIndex.reader_mPrivateDataMemberList (inLexique COMMA_SOURCE_FILE_AT_LINE (426)), operand_16210->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (427))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__genericTypeForGeneration__appendDeclaration (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_17165
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_17165 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_genericTypeHeader (inLexique, operand_17165->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (435)), operand_17165->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (436))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_17821
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassDeclaration (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_18034
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_18034 != NULL) {
const GGS_bool cond_18126 = (operand_18034->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (453))).operator_isEqual (GGS_string ("object")) ;
if (cond_18126.isBuiltAndTrue ()) {
var_cas_outHeader = GGS_string ("") ;
}else if (cond_18126.isBuiltAndFalse ()) {
const GGS_bool cond_18450 = ((operand_18034->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (455))).operator_and (function_autoBoxing (inLexique COMMA_SOURCE_FILE_AT_LINE (455)))).operator_isNotEqual (GGS_uint (0U)) ;
if (cond_18450.isBuiltAndTrue ()) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_autoBoxingClassHeader (inLexique, operand_18034->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (457)), operand_18034->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)), operand_18034->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (459)), operand_18034->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (460))) ;
}else if (cond_18450.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassHeader (inLexique, operand_18034->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (464)), operand_18034->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (465)), operand_18034->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (466)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (466)), operand_18034->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (467)), operand_18034->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (468))) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_19251
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19251 != NULL) {
...
category_reader__semanticTypeForGeneration__appendAutoPointerClassImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_19483
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_19483 != NULL) {
const GGS_bool cond_19591 = (operand_19483->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (486))).operator_isEqual (GGS_string ("object")) ;
if (cond_19591.isBuiltAndTrue ()) {
var_cas_outImplementation = GGS_string ("") ;
}else if (cond_19591.isBuiltAndFalse ()) {
const GGS_bool cond_19931 = ((operand_19483->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (488))).operator_and (function_autoBoxing (inLexique COMMA_SOURCE_FILE_AT_LINE (488)))).operator_isNotEqual (GGS_uint (0U)) ;
if (cond_19931.isBuiltAndTrue ()) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_autoBoxingClassImplementation (inLexique, operand_19483->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), operand_19483->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (491)), operand_19483->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (492)), operand_19483->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (493))) ;
}else if (cond_19931.isBuiltAndFalse ()) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_autoPointerClassImplementation (inLexique, operand_19483->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), operand_19483->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (498)), operand_19483->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (499)).reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), operand_19483->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (500)), operand_19483->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (501))) ;
}
}
  }
  return var_cas_outImplementation ;
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_20821
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_20821 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_21047
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21047 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_unifiedTypeImplementation (inLexique, operand_21047->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), operand_21047->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), operand_21047->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), operand_21047->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (524)), operand_21047->mTypeIndex.reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (525)), operand_21047->mTypeIndex.reader_mCurrentTypedAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), operand_21047->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), operand_21047->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (528)), operand_21047->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (529)), operand_21047->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (530)), operand_21047->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), operand_21047->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (532)), operand_21047->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (533)), operand_21047->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (534)), operand_21047->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (535))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__genericTypeForGeneration__appendTypeGenericImplementation (C_Compiler & inLexique,
                                const cPtr_genericTypeForGeneration * operand_21881
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_21881 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_genericTypeImplementation (inLexique, operand_21881->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), operand_21881->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), operand_21881->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (546))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_22584
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
...
category_reader__primitiveTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_22808
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_22808 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_predefinedTypeSpecificImplementation (inLexique, operand_22808->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (564)), operand_22808->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (565)), operand_22808->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), operand_22808->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (567)), operand_22808->mTypeIndex.reader_mNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (568))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listTypeForGeneration * operand_23314
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23314 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_23314->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (576)), operand_23314->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_23686
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_23686 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_23686->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (585)), operand_23686->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (586)), operand_23686->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapTypeForGeneration * operand_24128
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24128 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_24128->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (595)), operand_24128->mTypedAttributeList, operand_24128->mInsertMethodList, operand_24128->mSearchMethodList, operand_24128->mRemoveMethodList, operand_24128->mHasInsertOrReplaceModifier, operand_24128->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_24626
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_24626 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_24626->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (609)), operand_24626->mTypedAttributeList, operand_24626->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_structTypeForGeneration * operand_25028
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25028 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_25028->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (619)), operand_25028->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (620)), operand_25028->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_enumTypeForGeneration * operand_25421
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25421 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_25421->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (629)), operand_25421->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), operand_25421->mConstantList, operand_25421->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_25832
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_25832 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_25832->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (640)), operand_25832->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (641)), operand_25832->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (642)), operand_25832->mAssociatedMapTypedAttributeList, operand_25832->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_classTypeForGeneration * operand_26320
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26320 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_26320->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (652)), operand_26320->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (653)), ((operand_26320->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (654))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_26320->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (654)))), operand_26320->mTypedAttributeList, operand_26320->mAllTypedAttributeList, operand_26320->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_26320->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_26320->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)), operand_26320->mIsAbstract, operand_26320->mMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_26991
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_26991 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_26991->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_26991->mRoutineName.reader_identifierRepresentation ()), operand_26991->mFormalArgumentList, operand_26991->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (668))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_27628
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_27628 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_27628->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_27628->mFunctionName.reader_identifierRepresentation ()), operand_27628->mFormalArgumentList, operand_27628->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_27628->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (690)), operand_27628->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (685)), operand_27628->mFormalArgumentList, operand_27628->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (694))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_28251
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_28251 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_28251->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_28251->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_28251->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_28251->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (708)), operand_28251->mResultVariableCppName COMMA_SOURCE_FILE_AT_LINE (703)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_28251->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (712))) ;
  }
  return var_cas_outImplementation ;
}
