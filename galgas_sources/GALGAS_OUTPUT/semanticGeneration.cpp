...
GGS_string function_generateProcedure (C_CompilerEx & inLexique,
  ...
  const GGS_bool var_cas_generateCheckValid = GGS_bool (gOption_galgas_5F_cli_5F_options_generateCheckValidInstructions.reader_value ()) ;
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  const GGS_bool cond_2844 = (var_cas_inGenerateResetTemplateString).operator_not () ;
  if (cond_2844.isBuiltAndTrue ()) {
    var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (49))) ;
  }
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_2880 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_2880 = NULL ;
    while (((operand_2880 = enumerator_2880.nextObject ()))) {
      macroValidPointer (operand_2880) ;
      const GGS_bool cond_3037 = (operand_2880->mFormalArgumentPassingMode).operator_isNotEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (52))) ;
      if (cond_3037.isBuiltAndTrue ()) {
        var_cas_unusedVariableCppNameSet.addAssign_operation (operand_2880->mFormalArgumentCppName) ;
      }
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (59)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_3211 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_3211 = NULL ;
    while (((operand_3211 = enumerator_3211.nextObject ()))) {
      macroValidPointer (operand_3211) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_3211->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_3211->mInstruction (HERE), var_cas_generateCheckValid, var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (61)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (63)) ;
  ...
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_3568 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_3568 = NULL ;
    while (((operand_3568 = enumerator_3568.nextObject ()))) {
      macroValidPointer (operand_3568) ;
      switch (operand_3568->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        {
        var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (71))) ;
      ...
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        ...
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (75))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (77))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      ...
      const GGS_bool cond_4255 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_3568->mFormalArgumentCppName) ;
      if (cond_4255.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_4255.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_3568->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (85)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_4632 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
  if (cond_4632.isBuiltAndTrue ()) {
    ...
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (92))) ;
  }
  const GGS_bool cond_4872 = var_cas_inGenerateLocationArgs ;
  if (cond_4872.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("\n") ;
    var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (96)) ;
    var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
  }
  var_cas_outGeneratedCode.appendCString (")") ;
  const GGS_bool cond_4975 = var_cas_inProcedureIsConst ;
  if (cond_4975.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString (" const") ;
  }
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_5071 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_5071 = NULL ;
    while (((operand_5071 = enumerator_5071.nextObject ()))) {
      macroValidPointer (operand_5071) ;
      switch (operand_5071->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("  ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_5071->mFormalArgumentCppName) ;
  ...
  const GGS_bool cond_5526 = var_cas_inGenerateResetTemplateString ;
  if (cond_5526.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("  ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (116))) ;
...
GGS_string function_generateFunction (C_CompilerEx & inLexique,
  ...
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (142))) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_6665 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_6665 = NULL ;
    while (((operand_6665 = enumerator_6665.nextObject ()))) {
      macroValidPointer (operand_6665) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_6665->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  ...
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_6895 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_6895 = NULL ;
    while (((operand_6895 = enumerator_6895.nextObject ()))) {
      macroValidPointer (operand_6895) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_6895->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_6895->mInstruction (HERE), var_cas_generateCheckValid, var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (152)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (154)) ;
  const GGS_bool cond_7163 = var_cas_inIsStatic ;
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_7396 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_7396 = NULL ;
    while (((operand_7396 = enumerator_7396.nextObject ()))) {
      macroValidPointer (operand_7396) ;
      var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_7396->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (164))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_7644 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_7396->mFormalArgumentCppName) ;
      if (cond_7644.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_7396->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_7644.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_7396->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (171)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_8021 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (175))) ;
  if (cond_8021.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (176))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_8021.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (178))) ;
  }
  var_cas_outGeneratedCode.appendCString ("\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (181)) ;
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS)") ;
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  var_cas_outGeneratedCode.appendCString ("  GALGAS_") ;
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inResultTypeName.reader_identifierRepresentation ()) ;
...
GGS_string function_generateCategoryMethod (C_CompilerEx & inLexique,
  ...
  const GGS_bool var_cas_generateCheckValid = GGS_bool (gOption_galgas_5F_cli_5F_options_generateCheckValidInstructions.reader_value ()) ;
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (214))) ;
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_9664 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_9664 = NULL ;
    while (((operand_9664 = enumerator_9664.nextObject ()))) {
      macroValidPointer (operand_9664) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_9664->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (221)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_9894 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_9894 = NULL ;
    while (((operand_9894 = enumerator_9894.nextObject ()))) {
      macroValidPointer (operand_9894) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_9894->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_9894->mInstruction (HERE), var_cas_generateCheckValid, var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (223)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  ...
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  const GGS_bool cond_10436 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
  ...
  const GGS_bool var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (234))) ;
  const GGS_bool cond_10714 = var_cas_currentObjectIsUnused ;
  if (cond_10714.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
  }else if (cond_10714.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("inObject") ;
  }
  {
    GGS_formalParameterListForGeneration::cEnumerator enumerator_10798 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalParameterListForGeneration::cElement * operand_10798 = NULL ;
    while (((operand_10798 = enumerator_10798.nextObject ()))) {
      macroValidPointer (operand_10798) ;
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (243)) ;
      switch (operand_10798->mFormalArgumentPassingMode.enumValue ()) {
      case GGS_formalArgumentPassingModeAST::enum_argumentConstantIn:
        {
        var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10798->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (246))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentInOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10798->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (248))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentOut:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10798->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (250))) ;
        var_cas_outGeneratedCode.appendCString (" & ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::enum_argumentIn:
        {
        var_cas_outGeneratedCode.appendCString ("GALGAS_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10798->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
        var_cas_outGeneratedCode.appendCString (" ") ;
        }
        break ;
      case GGS_formalArgumentPassingModeAST::kNotBuilt:
      ...
      const GGS_bool cond_11576 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_10798->mFormalArgumentCppName) ;
      if (cond_11576.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_10798->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
  ...
  var_cas_outGeneratedCode.appendCString (",\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (262)) ;
  var_cas_outGeneratedCode.appendCString ("C_Compiler * ") ;
  const GGS_bool cond_11938 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (264))) ;
  if (cond_11938.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (265))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_11938.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
  }
  var_cas_outGeneratedCode.appendCString ("\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (270)) ;
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS") ;
  var_cas_outGeneratedCode.appendCString (") {\n") ;
  const GGS_bool cond_12705 = (var_cas_currentObjectIsUnused).operator_not () ;
  if (cond_12705.isBuiltAndTrue ()) {
    const GGS_bool cond_12385 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
    if (cond_12385.isBuiltAndTrue ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
    }else if (cond_12385.isBuiltAndFalse ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
GGS_string function_generateCategoryReader (C_CompilerEx & inLexique,
  ...
  var_cas_outGeneratedCode = GGS_string ("") ;
  GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (308))) ;
  var_cas_unusedVariableCppNameSet.addAssign_operation (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (309))) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_13890 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_13890 = NULL ;
    while (((operand_13890 = enumerator_13890.nextObject ()))) {
      macroValidPointer (operand_13890) ;
      var_cas_unusedVariableCppNameSet.addAssign_operation (operand_13890->mFormalArgumentCppName) ;
    }
  }
  GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
  GGS_string var_cas_routineBody = GGS_string ("") ;
  var_cas_routineBody.modifier_incIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (316)) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_14120 (var_cas_inInstructionList, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_14120 = NULL ;
    while (((operand_14120 = enumerator_14120.nextObject ()))) {
      macroValidPointer (operand_14120) ;
      { typeCategoryMethod__semanticInstructionForGeneration__generateInstruction method = findCategoryMethod__semanticInstructionForGeneration__generateInstruction (operand_14120->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_14120->mInstruction (HERE), var_cas_generateCheckValid, var_cas_temporaryVariableIndex, var_cas_unusedVariableCppNameSet, var_cas_routineBody COMMA_SOURCE_FILE_AT_LINE (318)) ;
        }
      }
    }
  }
  var_cas_routineBody.modifier_decIndentation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (320)) ;
  ...
  var_cas_outGeneratedCode.appendCString (" (") ;
  const GGS_uint  var_cas_colRef = var_cas_outGeneratedCode.reader_currentColumn () ;
  const GGS_bool cond_14738 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
  if (cond_14738.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
    var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
    var_cas_outGeneratedCode.appendCString (" * ") ;
  }else if (cond_14738.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("const cPtr_") ;
    var_cas_outGeneratedCode.dotAssign_operation (var_cas_inBaseClassName.reader_identifierRepresentation ()) ;
    var_cas_outGeneratedCode.appendCString (" * ") ;
  }
  const GGS_bool var_cas_currentObjectIsUnused = var_cas_unusedVariableCppNameSet.reader_hasKey (function_selfMarkName (inLexique COMMA_SOURCE_FILE_AT_LINE (330))) ;
  const GGS_bool cond_15016 = var_cas_currentObjectIsUnused ;
  if (cond_15016.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* inObject */") ;
  }else if (cond_15016.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.appendCString ("inObject") ;
  }
  var_cas_outGeneratedCode.appendCString (",\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (337)) ;
  {
    GGS_formalInputParameterListForGeneration::cEnumerator enumerator_15187 (var_cas_inFormalArgumentList, true) ;
    const GGS_formalInputParameterListForGeneration::cElement * operand_15187 = NULL ;
    while (((operand_15187 = enumerator_15187.nextObject ()))) {
      macroValidPointer (operand_15187) ;
      var_cas_outGeneratedCode.appendCString ("const GALGAS_") ;
      var_cas_outGeneratedCode.dotAssign_operation (operand_15187->mFormalArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (340))) ;
      var_cas_outGeneratedCode.appendCString (" & ") ;
      const GGS_bool cond_15435 = var_cas_unusedVariableCppNameSet.reader_hasKey (operand_15187->mFormalArgumentCppName) ;
      if (cond_15435.isBuiltAndTrue ()) {
        var_cas_outGeneratedCode.appendCString ("/* ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_15187->mFormalArgumentCppName) ;
        var_cas_outGeneratedCode.appendCString (" */") ;
      }else if (cond_15435.isBuiltAndFalse ()) {
        var_cas_outGeneratedCode.dotAssign_operation (operand_15187->mFormalArgumentCppName) ;
      }
      var_cas_outGeneratedCode.appendCString (",\n") ;
      var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (347)) ;
    }
  }
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inCompilerTypeName) ;
  var_cas_outGeneratedCode.appendCString (" * ") ;
  const GGS_bool cond_15812 = var_cas_unusedVariableCppNameSet.reader_hasKey (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (351))) ;
  if (cond_15812.isBuiltAndTrue ()) {
    var_cas_outGeneratedCode.appendCString ("/* ") ;
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (352))) ;
    var_cas_outGeneratedCode.appendCString (" */") ;
  }else if (cond_15812.isBuiltAndFalse ()) {
    var_cas_outGeneratedCode.dotAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (354))) ;
  }
  var_cas_outGeneratedCode.appendCString ("\n") ;
  var_cas_outGeneratedCode.modifier_appendSpacesUntilColumn (inLexique, var_cas_colRef COMMA_SOURCE_FILE_AT_LINE (357)) ;
  var_cas_outGeneratedCode.appendCString ("COMMA_UNUSED_LOCATION_ARGS)") ;
  var_cas_outGeneratedCode.appendCString (" {\n") ;
  var_cas_outGeneratedCode.appendCString ("  GALGAS_") ;
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inResultTypeName.reader_identifierRepresentation ()) ;
  ...
  var_cas_outGeneratedCode.dotAssign_operation (var_cas_inResultVariableCppName) ;
  var_cas_outGeneratedCode.appendCString (" ; // Returned variable\n") ;
  const GGS_bool cond_16774 = (var_cas_currentObjectIsUnused).operator_not () ;
  if (cond_16774.isBuiltAndTrue ()) {
    const GGS_bool cond_16454 = (var_cas_inBaseClassName).operator_isEqual (GGS_string ("")) ;
    if (cond_16454.isBuiltAndTrue ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = inObject ;\n") ;
    }else if (cond_16454.isBuiltAndFalse ()) {
      var_cas_outGeneratedCode.appendCString ("  const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
      var_cas_outGeneratedCode.appendCString (" * object = (const cPtr_") ;
      var_cas_outGeneratedCode.dotAssign_operation (var_cas_inClassName.reader_identifierRepresentation ()) ;
...
if ((var_cas_WITH_ACCESSOR_MAP.reader_count ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
result << "//--------------------------------- 'with' accessors\n" ;
GGS_withAccessorMap::cEnumerator enumerator_14785 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_14785 = NULL ;
...
result << operand_14785->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (346)).reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_14785->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) ;\n"
  "\n" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_4653 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4653 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4653 = enumerator_4653.nextObject ()))) {
macroValidPointer (operand_4653) ;
result << "const GALGAS_" ;
result << operand_4653->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " & inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
if (enumerator_4653.hasNextObject ()) {
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << " result ;\n"
  "  if (" ;
GGS_typedAttributeList::cEnumerator enumerator_4892 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4892 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4892 = enumerator_4892.nextObject ()))) {
macroValidPointer (operand_4892) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
result << ".isValid ()" ;
if (enumerator_4892.hasNextObject ()) {
result << " && " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5148 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5148 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5148 = enumerator_5148.nextObject ()))) {
macroValidPointer (operand_5148) ;
result << "inOperand" ;
...
result << "const GALGAS_" ;
result << operand_5599->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
result << " & in_" ;
result << operand_5599->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_5930 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5930 = NULL ;
while (((operand_5930 = enumerator_5930.nextObject ()))) {
macroValidPointer (operand_5930) ;
result << "in_" ;
result << operand_5930->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
...
result << "const GALGAS_" ;
result << operand_6220->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ;
result << " & inOperand" ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_6432 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6432 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6432 = enumerator_6432.nextObject ()))) {
macroValidPointer (operand_6432) ;
result << " && inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_6635 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6635 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6635 = enumerator_6635.nextObject ()))) {
macroValidPointer (operand_6635) ;
result << "inOperand" ;
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7034 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7034 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7034 = enumerator_7034.nextObject ()))) {
macroValidPointer (operand_7034) ;
result << "GALGAS_" ;
result << operand_7034->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
result << " inOperand" ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  "  if (isValid ()" ;
GGS_typedAttributeList::cEnumerator enumerator_7244 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7244 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7244 = enumerator_7244.nextObject ()))) {
macroValidPointer (operand_7244) ;
result << " && inOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (" ;
GGS_typedAttributeList::cEnumerator enumerator_7449 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7449 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7449 = enumerator_7449.nextObject ()))) {
macroValidPointer (operand_7449) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
if (enumerator_7449.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_7856 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7856 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7856 = enumerator_7856.nextObject ()))) {
macroValidPointer (operand_7856) ;
result << "GALGAS_" ;
result << operand_7856->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (229)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8280 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8280 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8280 = enumerator_8280.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8464 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8464 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << operand_8464->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8762 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8762 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8762 = enumerator_8762.nextObject ()))) {
macroValidPointer (operand_8762) ;
result << "GALGAS_" ;
result << operand_8762->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9185 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9185 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9369 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9369 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9369 = enumerator_9369.nextObject ()))) {
macroValidPointer (operand_9369) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) ;
result << " = p->mAttribute_" ;
result << operand_9369->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_first (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9663 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9663 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9663 = enumerator_9663.nextObject ()))) {
macroValidPointer (operand_9663) ;
result << "GALGAS_" ;
result << operand_9663->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (279)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10085 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10085 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10085 = enumerator_10085.nextObject ()))) {
macroValidPointer (operand_10085) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10269 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10269 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10269 = enumerator_10269.nextObject ()))) {
macroValidPointer (operand_10269) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (295)) ;
result << " = p->mAttribute_" ;
result << operand_10269->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "::method_last (" ;
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10562 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10562 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10562 = enumerator_10562.nextObject ()))) {
macroValidPointer (operand_10562) ;
result << "GALGAS_" ;
result << operand_10562->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (304)) ;
result << " & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (304)) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10983 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10983 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10983 = enumerator_10983.nextObject ()))) {
macroValidPointer (operand_10983) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11167 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11167 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11167 = enumerator_11167.nextObject ()))) {
macroValidPointer (operand_11167) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (320)) ;
result << " = p->mAttribute_" ;
result << operand_11167->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_13163->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_13163->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (368)) ;
result << " inOperand,\n"
  "                                              " ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_14107 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14107 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14107 = enumerator_14107.nextObject ()))) {
macroValidPointer (operand_14107) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_14107->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (383)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_14107->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "AtIndex (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_uint & inIndex,\n"
  "                                              " ;
...
result << " *) attributes.ptr () ;\n"
  "  GALGAS_" ;
result << operand_14107->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (388)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, cCollectionElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_15472 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_15472 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15472 = enumerator_15472.nextObject ()))) {
macroValidPointer (operand_15472) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_15472->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_15472->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (LOCATION_ARGS) const {\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_8556 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8556 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8556 = enumerator_8556.nextObject ()))) {
macroValidPointer (operand_8556) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ;
result << " = p->mAttribute_" ;
result << operand_8556->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_8858 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8858 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8858 = enumerator_8858.nextObject ()))) {
macroValidPointer (operand_8858) ;
result << "GALGAS_" ;
result << operand_8858->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9303 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9303 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9303 = enumerator_9303.nextObject ()))) {
macroValidPointer (operand_9303) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_9487 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9487 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_9487->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_9784 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9784 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9784 = enumerator_9784.nextObject ()))) {
macroValidPointer (operand_9784) ;
result << "GALGAS_" ;
result << operand_9784->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
result << " & outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_10416 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10416 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = p->mAttribute_" ;
result << operand_10416->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
GGS_typedAttributeList::cEnumerator enumerator_10713 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_10713 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_10713 = enumerator_10713.nextObject ()))) {
macroValidPointer (operand_10713) ;
result << "GALGAS_" ;
result << operand_10713->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (287)) ;
result << " & outOperand" ;
...
result << " *) attributes.ptr () ;\n"
  "  if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11161 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11161 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11161 = enumerator_11161.nextObject ()))) {
macroValidPointer (operand_11161) ;
result << "    outOperand" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11345 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11345 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11345 = enumerator_11345.nextObject ()))) {
macroValidPointer (operand_11345) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (303)) ;
result << " = p->mAttribute_" ;
result << operand_11345->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << "const bool inAscending) :\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11873 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11873 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11873 = enumerator_11873.nextObject ()))) {
macroValidPointer (operand_11873) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11873->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (318)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11873->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (LOCATION_ARGS) const {\n"
  "  const cSortedListElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "COMMA_LOCATION_ARGS) {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_934 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_934 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_934 = enumerator_934.nextObject ()))) {
macroValidPointer (operand_934) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_934->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (26)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_934->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler\n"
  "                                       " ;
...
result << "COMMA_LOCATION_ARGS) const {\n"
  "  GALGAS_" ;
result << operand_934->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (28)) ;
result << " result ;\n"
  "  const cMapElement_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
result << operand_934->mAttributeName.ggs_string ().reader_utf8Representation () ;
result << " COMMA_THERE) ;\n"
  "  if (NULL != p) {\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_1850 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_1850 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::constructor_" ;
result << operand_1850->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_" ;
result << var_cas_ASSOCIATED_MAP_TYPE_IDENTIFIER ;
...
result << " result ;\n"
  ...
  "  return result ;\n"
  "}\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_3909 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_3909 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_3909->mInsertMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4151 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4151 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_4151->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_4490 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_4490 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_4993 = GGS_uint (2U) ;
if (indentation_4993.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_4993.uintValue ()) ;
}
result << "const char * kInsertErrorMessage = " ;
result << operand_3909->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "const char * kShadowErrorMessage = " ;
result << operand_3909->mShadowErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_5032 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_5032 = NULL ;
while (((operand_5032 = enumerator_5032.nextObject ()))) {
macroValidPointer (operand_5032) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5032->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_5032->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_5509 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_5509 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_5509->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) const {\n" ;
const GGS_uint indentation_6400 = GGS_uint (2U) ;
if (indentation_6400.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_6400.uintValue ()) ;
}
...
result << "COMMA_THERE) ;\n"
  "if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_6039 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6039 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6039 = enumerator_6039.nextObject ()))) {
...
result << " = p->mAttribute_" ;
result << operand_6236->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_mapRemoveMethodListAST::cEnumerator enumerator_6440 (var_cas_REMOVE_METHOD_LIST, true) ;
const GGS_mapRemoveMethodListAST::cElement * operand_6440 = NULL ;
while (((operand_6440 = enumerator_6440.nextObject ()))) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_6440->mMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_6676 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_6676 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6676 = enumerator_6676.nextObject ()))) {
macroValidPointer (operand_6676) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_6676->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
result << " & outArgument" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
const GGS_uint indentation_7487 = GGS_uint (2U) ;
if (indentation_7487.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_7487.uintValue ()) ;
}
result << "const char * kRemoveErrorMessage = " ;
result << operand_6440->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "capCollectionElement attributes ;\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_7323 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7323 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7323 = enumerator_7323.nextObject ()))) {
macroValidPointer (operand_7323) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
result << " = p->mAttribute_" ;
result << operand_7323->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_7732 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_7732 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_7732->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (185)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_8032 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8032 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8032 = enumerator_8032.nextObject ()))) {
macroValidPointer (operand_8032) ;
result << ", inArgument" ;
...
GGS_typedAttributeList::cEnumerator enumerator_8312 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_8312 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8312 = enumerator_8312.nextObject ()))) {
macroValidPointer (operand_8312) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_8312->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_8312->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string & inKey,\n"
  "                                               " ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_8312->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (208)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_9311 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_9311 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_9311 = enumerator_9311.nextObject ()))) {
macroValidPointer (operand_9311) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_9311->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_9311->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_9311->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_10251 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_10251 = NULL ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_10251->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_10251->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_10251->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
...
result << "::current_lkey (LOCATION_ARGS) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_11846 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11846 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11846 = enumerator_11846.nextObject ()))) {
macroValidPointer (operand_11846) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_11846->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_11846->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (LOCATION_ARGS) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
...
//---------------------------------------------------------------------------*
//                                                                           *
// 'uniqueMapTypeHeader1' template of 'typeGenerationTemplate' filewrapper   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_string
template_filewrapper_typeGenerationTemplate_uniqueMapTypeHeader1 (C_CompilerEx & /* inLexique */,
                                const GGS_string& var_cas_TYPE_NAME,
                                const GGS_string& var_cas_TYPE_IDENTIFIER,
                                const GGS_typedAttributeList & var_cas_ATTRIBUTE_LIST,
                                const GGS_mapSearchMethodListAST & var_cas_SEARCH_METHOD_LIST) {
...
result << "//---------------------------------------------------------------------------*\n"
  "//                                                                           *\n"
  "//" ;
result << ((GGS_string ("@")).operator_concat (var_cas_TYPE_NAME)).operator_concat (GGS_string (" unique map")).reader_stringByLeftAndRightPadding (GGS_uint (75U), GGS_char (TO_UNICODE (' '))) ;
result << "*\n"
  "//                                                                           *\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << " ;\n"
  "\n" ;
GGS_mapSearchMethodListAST::cEnumerator enumerator_464 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_464 = NULL ;
while (((operand_464 = enumerator_464.nextObject ()))) {
macroValidPointer (operand_464) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "extern const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_464->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n"
  "\n" ;
}
result << "//---------------------------------------------------------------------------*\n"
...
//---------------------------------------------------------------------------*
//                                                                           *
// 'uniqueMapTypeHeader2' template of 'typeGenerationTemplate' filewrapper   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_string
template_filewrapper_typeGenerationTemplate_uniqueMapTypeHeader2 (C_CompilerEx & inLexique,
                                const GGS_string& var_cas_TYPE_NAME,
                                const GGS_string& var_cas_TYPE_IDENTIFIER,
                                const GGS_typedAttributeList & var_cas_ATTRIBUTE_LIST) {
  C_String result ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//'uniqueMapTypeSpecificImplementation' template of 'typeGenerationTemplate' filewrapper*
//                                                                           *
//---------------------------------------------------------------------------*

GGS_string
template_filewrapper_typeGenerationTemplate_uniqueMapTypeSpecificImplementation (C_CompilerEx & inLexique,
                                const GGS_string& var_cas_TYPE_IDENTIFIER,
                                const GGS_typedAttributeList & var_cas_ATTRIBUTE_LIST,
                                const GGS_insertMethodListAST & var_cas_INSERT_METHOD_LIST,
                                const GGS_mapSearchMethodListAST & var_cas_SEARCH_METHOD_LIST,
...
result << " result ;\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapAutomatonStateMap::cEnumerator enumerator_4164 (var_cas_MAP_AUTOMATON_STATE_MAP, true) ;
const GGS_mapAutomatonStateMap::cElement * operand_4164 = NULL ;
...
result << " ;\n"
  "#endif\n" ;
while (((operand_4164 = enumerator_4164.nextObject ()))) {
macroValidPointer (operand_4164) ;
result << "static const PMUInt32 kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_4164->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_4164->mInfo.mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
result << " ;\n" ;
}
}
result << "\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapAutomatonActionMap::cEnumerator enumerator_4747 (var_cas_MAP_AUTOMATON_ACTION_MAP, true) ;
const GGS_mapAutomatonActionMap::cElement * operand_4747 = NULL ;
if (enumerator_4747.hasCurrentObject ()) {
...
result << " ;\n" ;
while (((operand_4747 = enumerator_4747.nextObject ()))) {
macroValidPointer (operand_4747) ;
result << "static const PMUInt32 kMapAction_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_4747->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_4747->mInfo.mActionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
result << " ;\n" ;
}
}
result << "\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapStateSortedList::cEnumerator enumerator_5289 (var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST, true) ;
const GGS_mapStateSortedList::cElement * operand_5289 = NULL ;
if (enumerator_5289.hasCurrentObject ()) {
...
result << "] = {\n" ;
while (((operand_5289 = enumerator_5289.nextObject ()))) {
macroValidPointer (operand_5289) ;
result << "// State '" ;
result << operand_5289->mStateName ;
result << "', index " ;
result << operand_5289->mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
result << " \n" ;
GGS_mapStateTransitionSortedList::cEnumerator enumerator_5584 (operand_5289->mTransitionList, true) ;
const GGS_mapStateTransitionSortedList::cElement * operand_5584 = NULL ;
while (((operand_5584 = enumerator_5584.nextObject ()))) {
macroValidPointer (operand_5584) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_5584->mTargetStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_5584->mTargetStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
result << " */, " ;
switch (operand_5584->mTransitionMessageKind.enumValue ()) {
...
result << ", " ;
result << operand_5584->mTransitionMessage.reader_utf8Representation () ;
result << "}, // for action '" ;
result << operand_5584->mActionName ;
result << "', (index " ;
result << operand_5584->mActionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) ;
result << ")\n" ;
}
}
result << "} ;\n" ;
...
result << "\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n" ;
GGS_mapStateSortedList::cEnumerator enumerator_6386 (var_cas_MAP_AUTOMATON_DEFINITION_SORTEDLIST, true) ;
const GGS_mapStateSortedList::cElement * operand_6386 = NULL ;
if (enumerator_6386.hasCurrentObject ()) {
...
result << "  {" ;
switch (operand_6386->mStateMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_6386->mStateMessage.reader_utf8Representation () ;
result << "},// state '" ;
result << operand_6386->mStateName ;
result << "' (index " ;
result << operand_6386->mStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182)) ;
result << ")\n" ;
}
result << "} ;\n" ;
}
...
GGS_mapOverrideList::cEnumerator enumerator_8077 (var_cas_MAP_OVERRIDE_LIST, true) ;
const GGS_mapOverrideList::cElement * operand_8077 = NULL ;
while (((operand_8077 = enumerator_8077.nextObject ()))) {
macroValidPointer (operand_8077) ;
result << "//---------------------------------------------------------------------------*\n"
  "//" ;
result << ((GGS_string ("map override '")).operator_concat (operand_8077->mOverrideName)).operator_concat (GGS_string ("'")).reader_stringByLeftAndRightPadding (GGS_uint (75U), GGS_char (TO_UNICODE (' '))) ;
result << "*\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8077->mOverrideName.reader_identifierRepresentation () ;
result << " [" ;
result << operand_8077->mBranchBehaviourSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ;
result << "] = {\n" ;
GGS_branchBehaviourSortedListForMapOverride::cEnumerator enumerator_8623 (operand_8077->mBranchBehaviourSortedListForMapOverride, true) ;
const GGS_branchBehaviourSortedListForMapOverride::cElement * operand_8623 = NULL ;
while (((operand_8623 = enumerator_8623.nextObject ()))) {
macroValidPointer (operand_8623) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8623->mStartStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8623->mStartStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8623->mCurrentStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8623->mCurrentStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_8623->mFinalStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_8623->mFinalStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
result << " */, " ;
switch (operand_8623->mBehaviourMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_8623->mBehaviourMessage.reader_utf8Representation () ;
result << "},\n" ;
}
result << "} ;\n"
  "\n"
...
result << operand_8077->mOverrideName.reader_identifierRepresentation () ;
result << " [" ;
result << operand_8077->mBranchCombinationSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) ;
result << "] = {\n" ;
GGS_branchBehaviourSortedListForMapOverride::cEnumerator enumerator_9673 (operand_8077->mBranchCombinationSortedListForMapOverride, true) ;
const GGS_branchBehaviourSortedListForMapOverride::cElement * operand_9673 = NULL ;
while (((operand_9673 = enumerator_9673.nextObject ()))) {
macroValidPointer (operand_9673) ;
result << "  {kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9673->mStartStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9673->mStartStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9673->mCurrentStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9673->mCurrentStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) ;
result << " */, kMapState_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_9673->mFinalStateName.reader_identifierRepresentation () ;
result << " /* " ;
result << operand_9673->mFinalStateIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) ;
result << " */, " ;
switch (operand_9673->mBehaviourMessageKind.enumValue ()) {
case GGS_mapAutomatonMessageKind::kNotBuilt:
break ;
case GGS_mapAutomatonMessageKind::enum_noMessage:
result << "kMapAutomatonNoIssue" ;
...
result << ", " ;
result << operand_9673->mBehaviourMessage.reader_utf8Representation () ;
result << "},\n" ;
}
result << "} ;\n"
  "\n"
...
result << operand_8077->mOverrideName.reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << operand_8077->mOverrideName.reader_identifierRepresentation () ;
result << ", " ;
result << operand_8077->mBranchBehaviourSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
result << ",\n"
...
result << operand_8077->mOverrideName.reader_identifierRepresentation () ;
result << ", " ;
result << operand_8077->mBranchCombinationSortedListForMapOverride.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
result << ",\n"
  "                " ;
result << operand_8077->mOverrideName.reader_utf8Representation () ;
result << ",\n"
  "                inCompiler\n"
  "                COMMA_THERE) ;\n"
  "}\n"
...
result << "\n" ;
GGS_insertMethodListAST::cEnumerator enumerator_11212 (var_cas_INSERT_METHOD_LIST, true) ;
const GGS_insertMethodListAST::cElement * operand_11212 = NULL ;
while (((operand_11212 = enumerator_11212.nextObject ()))) {
macroValidPointer (operand_11212) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_" ;
result << operand_11212->mInsertMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_lstring inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_11454 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11454 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11454 = enumerator_11454.nextObject ()))) {
macroValidPointer (operand_11454) ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_11454->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
result << " inArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << " (inKey" ;
GGS_typedAttributeList::cEnumerator enumerator_11793 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_11793 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_11793 = enumerator_11793.nextObject ()))) {
macroValidPointer (operand_11793) ;
result << ", inArgument" ;
...
result << " COMMA_HERE)) ;\n"
  ...
  "  attributes.setPointer (p) ;\n"
  "  macroDetachSharedObject (p) ;\n" ;
const GGS_uint indentation_12549 = GGS_uint (2U) ;
if (indentation_12549.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_12549.uintValue ()) ;
}
result << "const char * kInsertErrorMessage = " ;
result << operand_11212->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "const char * kShadowErrorMessage = " ;
result << operand_11212->mShadowErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n" ;
if ((operand_11212->mInitialStateName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293))).operator_isEqual (GGS_string ("")).boolValue ()) {
...
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_11212->mInitialStateName.ggs_string ().reader_identifierRepresentation () ;
...
GGS_mapSearchMethodListAST::cEnumerator enumerator_12588 (var_cas_SEARCH_METHOD_LIST, true) ;
const GGS_mapSearchMethodListAST::cElement * operand_12588 = NULL ;
while (((operand_12588 = enumerator_12588.nextObject ()))) {
macroValidPointer (operand_12588) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const char * kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_12588->mSearchMethodName.ggs_string ().reader_identifierRepresentation () ;
result << " = " ;
result << operand_12588->mErrorMessage.ggs_string ().reader_utf8Representation () ;
result << " ;\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::" ;
if ((operand_12588->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (307))).operator_isEqual (GGS_string ("")).boolValue ()) {
result << "method_" ;
}else {
result << "modifier_" ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_" ;
result << operand_13156->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (314)) ;
result << " & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (314)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) " ;
if ((operand_12588->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (318))).operator_isEqual (GGS_string ("")).boolValue ()) {
result << "const " ;
}else {
}
result << "{\n" ;
const GGS_uint indentation_14458 = GGS_uint (2U) ;
if (indentation_14458.isBuilt ()) {
  result.incIndentation ((PMSInt32) indentation_14458.uintValue ()) ;
}
result << "const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
...
result.appendSpacesUntilColumn (columnMarker) ;
result << "inCompiler,\n" ;
if ((operand_12588->mActionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (325))).operator_isNotEqual (GGS_string ("")).boolValue ()) {
result.appendSpacesUntilColumn (columnMarker) ;
result << "kMapAction_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "_" ;
result << operand_12588->mActionName.ggs_string ().reader_identifierRepresentation () ;
result << ",\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
...
result << "COMMA_THERE) ;\n"
  "if (NULL == p) {\n" ;
GGS_typedAttributeList::cEnumerator enumerator_14097 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14097 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14097 = enumerator_14097.nextObject ()))) {
macroValidPointer (operand_14097) ;
result << "  outArgument" ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << ") ;\n" ;
GGS_typedAttributeList::cEnumerator enumerator_14294 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14294 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14294 = enumerator_14294.nextObject ()))) {
macroValidPointer (operand_14294) ;
result << "  outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342)) ;
result << " = p->mAttribute_" ;
result << operand_14294->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
GGS_typedAttributeList::cEnumerator enumerator_14493 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_14493 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14493 = enumerator_14493.nextObject ()))) {
macroValidPointer (operand_14493) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_14493->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (351)) ;
result << " GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::reader_" ;
result << operand_14493->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "const GALGAS_string & inKey,\n"
  "                                               " ;
...
result << " *) attributes ;\n"
  "  GALGAS_" ;
result << operand_14493->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (356)) ;
result << " result ;\n"
  "  if (NULL != p) {\n"
  "    macroValidSharedObject (p, const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
GGS_typedAttributeList::cEnumerator enumerator_15492 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_15492 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15492 = enumerator_15492.nextObject ()))) {
macroValidPointer (operand_15492) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "void GALGAS_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::modifier_set" ;
result << operand_15492->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ().reader_identifierRepresentation () ;
result << "ForKey (" ;
columnMarker = result.currentColumn () ;
result << "GALGAS_" ;
result << operand_15492->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (367)) ;
result << " inAttributeValue,\n"
  "                           " ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "GALGAS_string inKey,\n"
...
result << ") ;\n"
  "    p->mAttribute_" ;
result << operand_15492->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " = inAttributeValue ;\n"
  "  }\n"
  "}\n"
  "\n" ;
...
GGS_withAccessorMap::cEnumerator enumerator_16432 (var_cas_WITH_ACCESSOR_MAP, true) ;
const GGS_withAccessorMap::cElement * operand_16432 = NULL ;
while (((operand_16432 = enumerator_16432.nextObject ()))) {
macroValidPointer (operand_16432) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << var_cas_TYPE_IDENTIFIER ;
result << "::readWriteAccessForWithInstruction_" ;
result << operand_16432->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
columnMarker = result.currentColumn () ;
result << "C_Compiler * inCompiler,\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "const GALGAS_" ;
result << operand_16432->mInfo.mArgumentType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (383)) ;
result << " & inKey\n" ;
result.appendSpacesUntilColumn (columnMarker) ;
result << "COMMA_LOCATION_ARGS) {\n" ;
if ((operand_16432->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (385))).operator_isEqual (GGS_string ("hasKey")).boolValue ()) {
result << "  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;\n" ;
}else {
result << "  cMapElement * p = searchForReadWriteAttribute (inKey, inCompiler, kSearchErrorMessage_" ;
result << var_cas_TYPE_IDENTIFIER ;
...
result << "::current_lkey (LOCATION_ARGS) const {\n"
  ...
  "}\n"
  "\n" ;
GGS_typedAttributeList::cEnumerator enumerator_18027 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_typedAttributeList::cElement * operand_18027 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
result << operand_18027->mAttributeTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) ;
result << " cEnumerator_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << "::current_" ;
result << operand_18027->mAttributeName.ggs_string ().reader_identifierRepresentation () ;
result << " (LOCATION_ARGS) const {\n"
  "  const cMapElement_" ;
result << var_cas_TYPE_IDENTIFIER ;
result << " * p = (const cMapElement_" ;
...
category_reader__semanticDeclarationForGeneration__appendDeclaration1 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_28609
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28609 != NULL) {
...
category_reader__routinePrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_routinePrototypeDeclarationForGeneration * operand_28822
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_28822 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_routineDeclaration (inLexique, operand_28822->mRoutineName, operand_28822->mFormalArgumentList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__functionPrototypeDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_functionPrototypeDeclarationForGeneration * operand_29149
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29149 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_29149->mFunctionName, operand_29149->mFormalArgumentList, operand_29149->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (742))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_29517
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29517 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_functionDeclaration (inLexique, operand_29517->mFunctionName, GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_29517->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (752))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_29902
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_29902 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader1 (inLexique, operand_29902->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (760)), operand_29902->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)), ((operand_29902->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (762))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_29902->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (762)))), operand_29902->mAllTypedAttributeList, operand_29902->mIsAbstract) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_29902->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (767)), operand_29902->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (768)), operand_29902->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (769)), operand_29902->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (770)), operand_29902->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (771)), operand_29902->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (772)), operand_29902->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (773)), operand_29902->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (774)), operand_29902->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (775)), operand_29902->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (776)), operand_29902->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (777)), operand_29902->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (778)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_30847
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_30847 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader1 (inLexique, operand_30847->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (786)), operand_30847->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), operand_30847->mTypedAttributeList, operand_30847->mSearchMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_30847->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (792)), operand_30847->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (793)), operand_30847->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (794)), operand_30847->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (795)), operand_30847->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (796)), operand_30847->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (797)), operand_30847->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (798)), operand_30847->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (799)), operand_30847->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (800)), operand_30847->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), operand_30847->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (802)), operand_30847->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (803)))) ;
  }
  return var_cas_outHeader ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Category reader '@uniqueMapTypeForGeneration.appendDeclaration1'      *
//                                                                           *
//---------------------------------------------------------------------------*

static GGS_string
category_reader__uniqueMapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_uniqueMapTypeForGeneration * operand_31714
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_31714 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_uniqueMapTypeHeader1 (inLexique, operand_31714->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (811)), operand_31714->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (812)), operand_31714->mTypedAttributeList, operand_31714->mSearchMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_31714->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (817)), operand_31714->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (818)), operand_31714->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (819)), operand_31714->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), operand_31714->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (821)), operand_31714->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (822)), operand_31714->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (823)), operand_31714->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (824)), operand_31714->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (825)), operand_31714->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (826)), operand_31714->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (827)), operand_31714->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (828)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__structTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_32584
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_32584 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_structTypeHeader1 (inLexique, operand_32584->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (836)), operand_32584->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (837)), operand_32584->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_32584->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (841)), operand_32584->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (842)), operand_32584->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (843)), operand_32584->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), operand_32584->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (845)), operand_32584->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (846)), operand_32584->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (847)), operand_32584->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (848)), operand_32584->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (849)), operand_32584->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (850)), operand_32584->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (851)), operand_32584->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (852)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_33426
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_33426 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listTypeHeader1 (inLexique, operand_33426->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (860)), operand_33426->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (861)), operand_33426->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_33426->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (865)), operand_33426->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (866)), operand_33426->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), operand_33426->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (868)), operand_33426->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (869)), operand_33426->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (870)), operand_33426->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (871)), operand_33426->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (872)), operand_33426->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (873)), operand_33426->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (874)), operand_33426->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (875)), operand_33426->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (876)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__listmapTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_34269
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_34269 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_listmapTypeHeader1 (inLexique, operand_34269->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (884)), operand_34269->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (885))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_34269->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (888)), operand_34269->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (889)), operand_34269->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (890)), operand_34269->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (891)), operand_34269->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (892)), operand_34269->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (893)), operand_34269->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (894)), operand_34269->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (895)), operand_34269->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (896)), operand_34269->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (897)), operand_34269->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (898)), operand_34269->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (899)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__sortedListTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_35093
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35093 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_sortedlistTypeHeader1 (inLexique, operand_35093->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (907)), operand_35093->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (908)), operand_35093->mTypedAttributeList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_35093->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (912)), operand_35093->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (913)), operand_35093->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (914)), operand_35093->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (915)), operand_35093->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (916)), operand_35093->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (917)), operand_35093->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (918)), operand_35093->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (919)), operand_35093->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (920)), operand_35093->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (921)), operand_35093->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (922)), operand_35093->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (923)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__enumTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_35939
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_35939 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_enumTypeHeader1 (inLexique, operand_35939->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (931)), operand_35939->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (932)), operand_35939->mConstantList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_35939->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (936)), operand_35939->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (937)), operand_35939->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (938)), operand_35939->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (939)), operand_35939->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (940)), operand_35939->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (941)), operand_35939->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (942)), operand_35939->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (943)), operand_35939->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (944)), operand_35939->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (945)), operand_35939->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (946)), operand_35939->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (947)))) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapProxyTypeForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_36777
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_36777 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapProxyTypeHeader1 (inLexique, operand_36777->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (955)), operand_36777->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (956))) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_36777->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (959)), operand_36777->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (960)), operand_36777->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (961)), operand_36777->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (962)), operand_36777->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (963)), operand_36777->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (964)), operand_36777->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (965)), operand_36777->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (966)), operand_36777->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (967)), operand_36777->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (968)), operand_36777->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (969)), operand_36777->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (970)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_recursivlyEnumerateRegularFile (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_37748 (var_cas_inFilewrapperFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_37748 = NULL ;
while (((operand_37748 = enumerator_37748.nextObject ()))) {
  macroValidPointer (operand_37748) ;
var_cas_ioRegularFileIndexStringList.addAssign_operation (var_cas_ioRegularFileIndexStringList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (982))) ;
}
}
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_37889 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_37889 = NULL ;
while (((operand_37889 = enumerator_37889.nextObject ()))) {
  macroValidPointer (operand_37889) ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_37889->mInfo.mRegularFileMap,  operand_37889->mInfo.mDirectoryMap,  var_cas_ioRegularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (985)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_38196
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_38196 != NULL) {
GGS_stringlist  var_cas_regularFileIndexStringList = GGS_stringlist ::constructor_emptyList () ;
::routine_recursivlyEnumerateRegularFile (inLexique,  operand_38196->mFilewrapperFileMap,  operand_38196->mFilewrapperDirectoryMap,  var_cas_regularFileIndexStringList COMMA_SOURCE_FILE_AT_LINE (997)) ;
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_filewrapperDeclaration (inLexique, var_cas_regularFileIndexStringList, operand_38196->mFilewrapperName) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_38620 (operand_38196->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_38620 = NULL ;
while (((operand_38620 = enumerator_38620.nextObject ()))) {
  macroValidPointer (operand_38620) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateDeclaration (inLexique, operand_38196->mFilewrapperName, operand_38620->mFilewrapperTemplateName, operand_38620->mFilewrapperTemplateFormalInputParameters)) ;
}
}
  }
  return var_cas_outHeader ;
...
category_reader__abstractCategoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_39014
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_39014 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodDeclaration (inLexique, operand_39014->mTypeName, operand_39014->mAbstractCategoryMethodName, operand_39014->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryMethodForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_39395
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_39395 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodDeclaration (inLexique, operand_39395->mTypeName, operand_39395->mCategoryMethodName, operand_39395->mCategoryMethodFormalParameterList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_39760
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_39760 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderDeclaration (inLexique, operand_39760->mTypeName, operand_39760->mAbstractCategoryReaderName, operand_39760->mAbstractCategoryReaderFormalParameterList, operand_39760->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__categoryReaderForGeneration__appendDeclaration1 (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_40158
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_40158 != NULL) {
var_cas_outHeader = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderDeclaration (inLexique, operand_40158->mTypeName, operand_40158->mCategoryReaderName, operand_40158->mCategoryReaderFormalParameterList, operand_40158->mResultType) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendDeclaration2 (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_40840,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_40840 != NULL) {
var_cas_outHeader = GGS_string ("") ;
  }
  return var_cas_outHeader ;
}
...
category_reader__mapTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_41071,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_41071 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_mapTypeHeader2 (inLexique, operand_41071->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)), operand_41071->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1077)), operand_41071->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Category reader '@uniqueMapTypeForGeneration.appendDeclaration2'      *
//                                                                           *
//---------------------------------------------------------------------------*

static GGS_string
category_reader__uniqueMapTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_uniqueMapTypeForGeneration * operand_41450,
                                const GGS_string  /* var_cas_inOutputDirectory */
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_41450 != NULL) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_uniqueMapTypeHeader2 (inLexique, operand_41450->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1088)), operand_41450->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1089)), operand_41450->mTypedAttributeList) ;
  }
  return var_cas_outHeader ;
}
...
category_reader__classTypeForGeneration__appendDeclaration2 (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_41831,
                                const GGS_string  var_cas_inOutputDirectory
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_41831 != NULL) {
const GGS_bool cond_43027 = operand_41831->mGenerateHeaderInSeparateFile ;
if (cond_43027.isBuiltAndTrue ()) {
const GGS_string var_cas_part1 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_41831->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)), operand_41831->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1102)), ((operand_41831->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1103))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_41831->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)))), operand_41831->mTypedAttributeList, operand_41831->mAllTypedAttributeList, operand_41831->mIsAbstract, operand_41831->mAbstractMethodList, operand_41831->mMethodList) ;
const GGS_string var_cas_part2 = template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_41831->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1111)), operand_41831->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1112)), ((operand_41831->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1113))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_41831->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1113)))), operand_41831->mTypedAttributeList, operand_41831->mAllTypedAttributeList, operand_41831->mIsAbstract, operand_41831->mAbstractMethodList, operand_41831->mMethodList) ;
const GGS_string var_cas_headerFileName = ((GGS_string ("separateHeaderFor_")).operator_concat (operand_41831->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1120)))).operator_concat (GGS_string (".h")) ;
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, var_cas_headerFileName, GGS_string ("//"), GGS_string ("\n"
  ...
  "\n"), var_cas_part2 COMMA_SOURCE_FILE_AT_LINE (1121)) ;
var_cas_outHeader = ((GGS_string ("#include \"")).operator_concat (var_cas_headerFileName)).operator_concat (GGS_string ("\"\n"
  "\n")) ;
}else if (cond_43027.isBuiltAndFalse ()) {
var_cas_outHeader = template_filewrapper_typeGenerationTemplate_classTypeHeader2part1 (inLexique, operand_41831->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)), operand_41831->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1134)), ((operand_41831->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1135))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_41831->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)))), operand_41831->mTypedAttributeList, operand_41831->mAllTypedAttributeList, operand_41831->mIsAbstract, operand_41831->mAbstractMethodList, operand_41831->mMethodList) ;
var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_classTypeHeader2part2 (inLexique, operand_41831->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)), operand_41831->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1144)), ((operand_41831->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1145))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_41831->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)))), operand_41831->mTypedAttributeList, operand_41831->mAllTypedAttributeList, operand_41831->mIsAbstract, operand_41831->mAbstractMethodList, operand_41831->mMethodList)) ;
}
  }
  return var_cas_outHeader ;
}
...
category_reader__semanticDeclarationForGeneration__appendTypeGenericImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_44317
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44317 != NULL) {
...
category_reader__semanticTypeForGeneration__appendTypeGenericImplementation (C_CompilerEx & inLexique,
                                const cPtr_semanticTypeForGeneration * operand_44543
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_44543 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_genericTypeImplementation (inLexique, operand_44543->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1170)), operand_44543->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1171)), operand_44543->mTypeIndex.reader_mSuperType (inLexique COMMA_SOURCE_FILE_AT_LINE (1172)), operand_44543->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1173))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__semanticDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_45274
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45274 != NULL) {
var_cas_outImplementation = GGS_string ("") ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listmapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listmapTypeForGeneration * operand_45496
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45496 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listmapTypeSpecificImplementation (inLexique, operand_45496->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1193)), operand_45496->mAssociatedListTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1194)), operand_45496->mAssociatedListTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapTypeForGeneration * operand_45997
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_45997 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapTypeSpecificImplementation (inLexique, operand_45997->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1204)), operand_45997->mTypedAttributeList, operand_45997->mInsertMethodList, operand_45997->mSearchMethodList, operand_45997->mRemoveMethodList, operand_45997->mHasInsertOrReplaceModifier, operand_45997->mWithAccessorMap) ;
  }
  return var_cas_outImplementation ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//Category reader '@uniqueMapTypeForGeneration.appendSpecificImplementation' *
//                                                                           *
//---------------------------------------------------------------------------*

static GGS_string
category_reader__uniqueMapTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_uniqueMapTypeForGeneration * operand_46549
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_46549 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_uniqueMapTypeSpecificImplementation (inLexique, operand_46549->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1219)), operand_46549->mTypedAttributeList, operand_46549->mInsertMethodList, operand_46549->mSearchMethodList, operand_46549->mWithAccessorMap, operand_46549->mMapAutomatonStateMap, operand_46549->mMapAutomatonActionMap, operand_46549->mMapStateSortedList, operand_46549->mMapOverrideList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__sortedListTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_sortedListTypeForGeneration * operand_47160
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47160 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_sortedlistTypeSpecificImplementation (inLexique, operand_47160->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1236)), operand_47160->mTypedAttributeList, operand_47160->mSortDescriptorList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__enumTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_enumTypeForGeneration * operand_47623
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_47623 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_enumTypeSpecificImplementation (inLexique, operand_47623->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)), operand_47623->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)), operand_47623->mConstantList, operand_47623->mEnumMessageList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__mapProxyTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_mapProxyTypeForGeneration * operand_48090
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48090 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_mapProxyTypeSpecificImplementation (inLexique, operand_48090->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1259)), operand_48090->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)), operand_48090->mAssociatedMapTypeProxy.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1261)), operand_48090->mAssociatedMapTypedAttributeList, operand_48090->mSearchMethodList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__classTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_classTypeForGeneration * operand_48638
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_48638 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_classTypeSpecificImplementation (inLexique, operand_48638->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)), operand_48638->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1273)), ((operand_48638->mSuperClass.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1274))).isBuiltAndTrue () ? (GGS_string ("")) : (operand_48638->mSuperClass.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)))), operand_48638->mTypedAttributeList, operand_48638->mAllTypedAttributeList, operand_48638->mAllTypedAttributeList.reader_subListWithRange (inLexique, GGS_uint (0U), operand_48638->mAllTypedAttributeList.reader_length ().substract_operation (inLexique, operand_48638->mTypedAttributeList.reader_length () COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)), operand_48638->mIsAbstract, operand_48638->mAbstractMethodList, operand_48638->mMethodList, operand_48638->mInstanceMethodMap) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__structTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_structTypeForGeneration * operand_49398
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49398 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_structTypeSpecificImplementation (inLexique, operand_49398->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1290)), operand_49398->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)), operand_49398->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__listTypeForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_listTypeForGeneration * operand_49849
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_49849 != NULL) {
var_cas_outImplementation = template_filewrapper_typeGenerationTemplate_listTypeSpecificImplementation (inLexique, operand_49849->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)), operand_49849->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1302)), operand_49849->mTypedAttributeList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__routineImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_routineImplementationForGeneration * operand_50309
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_50309 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_routineImplementation (inLexique, operand_50309->mRoutineName, function_generateProcedure (inLexique, (GGS_string ("routine_")).operator_concat (operand_50309->mRoutineName.reader_identifierRepresentation ()), operand_50309->mFormalArgumentList, operand_50309->mRoutineInstructionList, GGS_bool (false), GGS_string ("C_Compiler"), GGS_bool (true), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1313))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__functionImplementationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_functionImplementationForGeneration * operand_51028
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51028 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_functionImplementation (inLexique, operand_51028->mFunctionName, function_generateFunction (inLexique, (GGS_string ("function_")).operator_concat (operand_51028->mFunctionName.reader_identifierRepresentation ()), operand_51028->mFormalArgumentList, operand_51028->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_51028->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1336)), operand_51028->mResultVariableCppName, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1331)), operand_51028->mFormalArgumentList, operand_51028->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1341))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__onceFunctionDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationForGeneration * operand_51763
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_51763 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_onceFunctionImplementation (inLexique, operand_51763->mFunctionName, function_generateFunction (inLexique, (GGS_string ("onceFunction_")).operator_concat (operand_51763->mFunctionName.reader_identifierRepresentation ()), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_51763->mFunctionInstructionList, GGS_string ("C_Compiler"), operand_51763->mReturnType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)), operand_51763->mResultVariableCppName, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1351)), GGS_formalInputParameterListForGeneration ::constructor_emptyList (), operand_51763->mReturnType.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (1361))) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryMethodForGeneration * operand_52558
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_52558 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryMethodImplementation (inLexique, operand_52558->mTypeName, operand_52558->mAbstractCategoryMethodName, operand_52558->mAbstractCategoryMethodFormalParameterList) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryMethodForGeneration * operand_53051
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_53051 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_53051->mTypeName, GGS_string (""), operand_53051->mCategoryMethodName, operand_53051->mCategoryMethodFormalParameterList, operand_53051->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1380)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryMethodImplementation (inLexique, operand_53051->mTypeName, operand_53051->mCategoryMethodName, operand_53051->mCategoryMethodFormalParameterList, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overridingCategoryMethodForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overridingCategoryMethodForGeneration * operand_53750
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_53750 != NULL) {
const GGS_string var_cas_methodImplementation = function_generateCategoryMethod (inLexique, operand_53750->mTypeName, operand_53750->mBaseTypeName, operand_53750->mCategoryMethodName, operand_53750->mCategoryMethodFormalParameterList, operand_53750->mSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1399)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryMethodImplementation (inLexique, operand_53750->mTypeName, operand_53750->mCategoryMethodName, var_cas_methodImplementation) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__abstractCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_abstractCategoryReaderForGeneration * operand_54438
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_54438 != NULL) {
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_abstractCategoryReaderImplementation (inLexique, operand_54438->mTypeName, operand_54438->mAbstractCategoryReaderName, operand_54438->mAbstractCategoryReaderFormalParameterList, operand_54438->mResultType) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__categoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_categoryReaderForGeneration * operand_54948
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_54948 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_54948->mTypeName, GGS_string (""), operand_54948->mCategoryReaderName, operand_54948->mCategoryReaderFormalParameterList, operand_54948->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_54948->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1436)), operand_54948->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1429)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_categoryReaderImplementation (inLexique, operand_54948->mTypeName, operand_54948->mCategoryReaderName, operand_54948->mCategoryReaderFormalParameterList, operand_54948->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
category_reader__overrideCategoryReaderForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_overrideCategoryReaderForGeneration * operand_55722
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_55722 != NULL) {
const GGS_string var_cas_categoryReaderCode = function_generateCategoryReader (inLexique, operand_55722->mTypeName, operand_55722->mBaseTypeName, operand_55722->mOverridingCategoryReaderName, operand_55722->mOverridingCategoryReaderFormalParameterList, operand_55722->mSemanticInstructionListForGeneration, GGS_string ("C_Compiler"), operand_55722->mResultType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1459)), operand_55722->mResultVarCppName COMMA_SOURCE_FILE_AT_LINE (1452)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_overridingCategoryReaderImplementation (inLexique, operand_55722->mTypeName, operand_55722->mOverridingCategoryReaderName, operand_55722->mResultType, var_cas_categoryReaderCode) ;
  }
  return var_cas_outImplementation ;
}
...
void routine_generateWrapperContents (C_CompilerEx & inLexique,
  ...
  #endif
{
GGS_wrapperFileMap::cEnumerator enumerator_56764 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_56764 = NULL ;
while (((operand_56764 = enumerator_56764.nextObject ()))) {
  macroValidPointer (operand_56764) ;
const GGS_string var_cas_contents = GGS_string::constructor_stringWithContentsOfFile (inLexique, operand_56764->mInfo.mAbsoluteFilePath COMMA_SOURCE_FILE_AT_LINE (1482)) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_56764->mKey) ;
var_cas_ioImplementation.appendCString ("'\n"
  "\n"
"const char * gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_56764->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1485))) ;
...
var_cas_ioImplementation.dotAssign_operation (operand_56764->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1488))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_56764->mKey.ggs_string ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (operand_56764->mKey.ggs_string ().reader_pathExtension ().reader_utf8Representation ()) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperFileContent_") ;
var_cas_ioImplementation.dotAssign_operation (operand_56764->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1492))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
...
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_57606 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_57606 = NULL ;
while (((operand_57606 = enumerator_57606.nextObject ()))) {
  macroValidPointer (operand_57606) ;
::routine_generateWrapperContents (inLexique,  var_cas_inFilewrapperName,  operand_57606->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1499)),  operand_57606->mInfo.mWrapperDirectoryIndex,  operand_57606->mInfo.mRegularFileMap,  operand_57606->mInfo.mDirectoryMap,  var_cas_ioImplementation COMMA_SOURCE_FILE_AT_LINE (1497)) ;
}
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1509))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1510)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1510))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperFileMap::cEnumerator enumerator_58194 (var_cas_inFilewrapperRegularFileMap, true) ;
const GGS_wrapperFileMap::cElement * operand_58194 = NULL ;
while (((operand_58194 = enumerator_58194.nextObject ()))) {
  macroValidPointer (operand_58194) ;
var_cas_ioImplementation.appendCString ("  & gWrapperFile_") ;
var_cas_ioImplementation.dotAssign_operation (operand_58194->mInfo.mWrapperFileIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1512))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1519))) ;
var_cas_ioImplementation.appendCString (" [") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1520)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1520))) ;
var_cas_ioImplementation.appendCString ("] = {\n") ;
{
GGS_wrapperDirectoryMap::cEnumerator enumerator_58805 (var_cas_inFilewrapperDirectoryMap, true) ;
const GGS_wrapperDirectoryMap::cElement * operand_58805 = NULL ;
while (((operand_58805 = enumerator_58805.nextObject ()))) {
  macroValidPointer (operand_58805) ;
var_cas_ioImplementation.appendCString ("  & gWrapperDirectory_") ;
var_cas_ioImplementation.dotAssign_operation (operand_58805->mInfo.mWrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (",\n") ;
}
...
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1528))) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString (" (\n"
"  ") ;
...
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperRegularFileMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1531))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllFiles_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1532))) ;
var_cas_ioImplementation.appendCString (",\n"
"  ") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryMap.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1533))) ;
var_cas_ioImplementation.appendCString (",\n"
"  gWrapperAllDirectories_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperName.reader_identifierRepresentation ()) ;
var_cas_ioImplementation.appendCString ("_") ;
var_cas_ioImplementation.dotAssign_operation (var_cas_inFilewrapperDirectoryIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1534))) ;
var_cas_ioImplementation.appendCString ("\n"
") ;\n"
  "\n") ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__filewrapperDeclarationForGeneration__appendSpecificImplementation (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationForGeneration * operand_59920
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outImplementation ;
  if (operand_59920 != NULL) {
GGS_string var_cas_filewrapperImplementation = GGS_string ("") ;
::routine_generateWrapperContents (inLexique,  operand_59920->mFilewrapperName,  GGS_string (""),  GGS_uint (0U),  operand_59920->mFilewrapperFileMap,  operand_59920->mFilewrapperDirectoryMap,  var_cas_filewrapperImplementation COMMA_SOURCE_FILE_AT_LINE (1542)) ;
var_cas_outImplementation = template_filewrapper_semanticComponentGenerationTemplate_filewrapperImplementation (inLexique, operand_59920->mFilewrapperName, var_cas_filewrapperImplementation) ;
{
GGS_filewrapperTemplateListForGeneration::cEnumerator enumerator_60379 (operand_59920->mFilewrapperTemplateListForGeneration, true) ;
const GGS_filewrapperTemplateListForGeneration::cElement * operand_60379 = NULL ;
while (((operand_60379 = enumerator_60379.nextObject ()))) {
  macroValidPointer (operand_60379) ;
GGS_string var_cas_generatedCodeForInstructionList = GGS_string ("") ;
GGS_uint  var_cas_temporaryVariableIndex = GGS_uint (0U) ;
GGS_stringset  var_cas_unusedVariableCppNameSet = GGS_stringset ::constructor_emptySet () ;
var_cas_unusedVariableCppNameSet.addAssign_operation (function_compilerCppName (inLexique COMMA_SOURCE_FILE_AT_LINE (1560))) ;
{
GGS_formalInputParameterListForGeneration::cEnumerator enumerator_60684 (operand_60379->mFilewrapperTemplateFormalInputParameters, true) ;
const GGS_formalInputParameterListForGeneration::cElement * operand_60684 = NULL ;
while (((operand_60684 = enumerator_60684.nextObject ()))) {
  macroValidPointer (operand_60684) ;
var_cas_unusedVariableCppNameSet.addAssign_operation (operand_60684->mFormalArgumentCppName) ;
}
}
GGS_bool var_cas_useColumnMarker = GGS_bool (false) ;
::routine_templateCodeGenerationForListInstruction (inLexique,  operand_60379->mTemplateInstructionListForGeneration,  var_cas_generatedCodeForInstructionList,  var_cas_temporaryVariableIndex,  var_cas_unusedVariableCppNameSet,  var_cas_useColumnMarker COMMA_SOURCE_FILE_AT_LINE (1565)) ;
var_cas_outImplementation.dotAssign_operation (template_filewrapper_semanticComponentGenerationTemplate_filewrapperTemplateImplementation (inLexique, operand_59920->mFilewrapperName, operand_60379->mFilewrapperTemplateName, operand_60379->mFilewrapperTemplateFormalInputParameters, var_cas_unusedVariableCppNameSet, var_cas_useColumnMarker, var_cas_generatedCodeForInstructionList)) ;
}
}
  }
  return var_cas_outImplementation ;
...
static void prologueRoutineFor_semanticGeneration (void) {
  ...
  enterCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 ((typeCategoryReader__semanticDeclarationForGeneration__appendDeclaration1) category_reader__uniqueMapTypeForGeneration__appendDeclaration1, gClassInfoFor__uniqueMapTypeForGeneration.slotID ()) ;
  ...
  enterCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 ((typeCategoryReader__semanticDeclarationForGeneration__appendDeclaration2) category_reader__uniqueMapTypeForGeneration__appendDeclaration2, gClassInfoFor__uniqueMapTypeForGeneration.slotID ()) ;
  ...
  enterCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation ((typeCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation) category_reader__uniqueMapTypeForGeneration__appendSpecificImplementation, gClassInfoFor__uniqueMapTypeForGeneration.slotID ()) ;
