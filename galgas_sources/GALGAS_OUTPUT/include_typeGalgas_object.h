//---------------------------------------------------------------------------*
//                                                                           *
//                    File 'include_typeGalgas_object.h'                     *
//                 Generated by version GALGAS_BETA_VERSION                  *
//                     november 14th, 2009, at 19h0'40"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 abstract class 'cPtr_typeGalgas_object'                   *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_typeGalgas_object : public cPtr_AC_galgasType {
...
//--- Constructor
  public : cPtr_typeGalgas_object (LOCATION_ARGS) ;

//--- Declaring a protected virtual destructor enables the compiler to raise
//    an error if a direct delete is performed; only the static method
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_typeGalgas_object (void) {}
  #endif
