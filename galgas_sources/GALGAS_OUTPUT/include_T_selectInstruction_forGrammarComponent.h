...
//    C_GGS_Object::detachPointer may invoke delete.
    ...
    protected : virtual ~cPtr_T_selectInstruction_forGrammarComponent (void) {}
  #endif

//--- Attributes
  public : GGS_L_branchList_ForGrammarComponent  mSelectBranchList ;
