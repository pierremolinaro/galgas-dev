...
void routine_compileSyntaxComponentGalgas_33_ (const class GALGAS_string constinArgument0,
                                               const class GALGAS_galgas_33_SyntaxComponentListAST_2E_element constinArgument1,
                                               const class GALGAS_semanticContext constinArgument2,
                                               class GALGAS_parsedSyntaxComponentMap & ioArgument3,
