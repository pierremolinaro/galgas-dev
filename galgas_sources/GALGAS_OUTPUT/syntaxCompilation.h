...
void routine_compileSyntaxComponentFromAST (const GALGAS_lstring constinArgument0,
                                            const GALGAS_string constinArgument1,
                                            const GALGAS_galgas_33_SyntaxComponentListAST_2E_element constinArgument2,
...
void routine_compileSyntaxComponentFromSourceFile (const GALGAS_lstring constinArgument0,
                                                   const GALGAS_string constinArgument1,
...
void routine_compileSyntaxComponentGalgas_33_ (const GALGAS_string constinArgument0,
                                               const GALGAS_galgas_33_SyntaxComponentListAST_2E_element constinArgument1,
                                               const GALGAS_semanticContext constinArgument2,
                                               GALGAS_parsedSyntaxComponentMap & ioArgument3,
