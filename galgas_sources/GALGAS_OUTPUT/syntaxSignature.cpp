...
GALGAS_semanticInstructionListForGeneration function_syntaxSignatureOfInstructionList (const GALGAS_string & constinArgument_inPosfix,
  ...
  result_semanticInstructionListForGeneration = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (42)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticInstructionListForGeneration enumerator_2406 (constinArgument_inInstructionList, true) ;
  //--- simple foreach instruction
  while (enumerator_2406.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_appendSyntaxSignature ((const cPtr_semanticInstructionForGeneration *) enumerator_2406.current_mInstruction (HERE).ptr (), constinArgument_inPosfix, result_semanticInstructionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (44)) ;
...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticInstructionListForGeneration enumerator_7388 (constinArgument_inReferenceSignature, true) ;
  cEnumerator_semanticInstructionListForGeneration enumerator_7423 (constinArgument_inTestedSignature, true) ;
  //--- complex foreach instruction
  bool bool_0 = result_bool.isValidAndTrue () ;
  if (enumerator_7388.hasCurrentObject () && enumerator_7423.hasCurrentObject () && bool_0) {
    while (enumerator_7388.hasCurrentObject () && enumerator_7423.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      result_bool = callCategoryReader_compareSyntaxInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_7388.current_mInstruction (HERE).ptr (), enumerator_7423.current_mInstruction (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
      enumerator_7388.gotoNextObject () ;
      enumerator_7423.gotoNextObject () ;
      if (enumerator_7388.hasCurrentObject () && enumerator_7423.hasCurrentObject ()) {
        bool_0 = result_bool.isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = result_bool.operator_and (GALGAS_bool (kIsStrictInf, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (177)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (177)))) COMMA_SOURCE_FILE_AT_LINE (177)).boolEnum () ;
  if (kBoolTrue == test_1) {
    ...
    if (var_instruction.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
        GALGAS_syntaxInstructionForGeneration cast_7813_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_7813_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (181)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }else{
        //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = result_bool.operator_and (GALGAS_bool (kIsStrictSup, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (187)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (187)))) COMMA_SOURCE_FILE_AT_LINE (187)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      ...
      if (var_instruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
          GALGAS_syntaxInstructionForGeneration cast_8478_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (cast_8478_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (194)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (194)) ;
        }else{
          //-------- @errorInstructionForGeneration
...
static void categoryMethod_repeatInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_4013 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_4013.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4013.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (87)), enumerator_4013.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (86)) ;
...
static void categoryMethod_selectInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_4868 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
  //--- simple foreach instruction
  while (enumerator_4868.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4868.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)), enumerator_4868.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (110)) ;
...
static void categoryMethod_parseRewindInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_location joker_5631_0 ; // Joker input parameter
  object->mAttribute_mListOfSemanticInstructionListForGeneration.method_first (var_instructionList, joker_5631_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
  //-------- END @methodCallInstructionForGeneration
...
static GALGAS_bool categoryReader_terminalCheckInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_terminalCheckInstructionForGeneration) {
      GALGAS_terminalCheckInstructionForGeneration cast_9052_si ((cPtr_terminalCheckInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (kIsEqual, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (211)).objectCompare (cast_9052_si.reader_mTerminalName (SOURCE_FILE_AT_LINE (211)).reader_string (SOURCE_FILE_AT_LINE (211)))) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = result_bool.operator_not (SOURCE_FILE_AT_LINE (212)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_9052_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (213)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_9368_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (cast_9368_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (218)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (218)) ;
      //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = result_bool.operator_not (SOURCE_FILE_AT_LINE (226)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_nonterminalInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_nonterminalInstructionForGeneration) {
      GALGAS_nonterminalInstructionForGeneration cast_10086_si ((cPtr_nonterminalInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (kIsEqual, object->mAttribute_mNonterminalName.objectCompare (cast_10086_si.reader_mNonterminalName (SOURCE_FILE_AT_LINE (241)))) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = result_bool.operator_not (SOURCE_FILE_AT_LINE (242)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_10086_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (243)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_10401_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (cast_10401_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (248)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (248)) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (false) ;
    }else{
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = result_bool.operator_not (SOURCE_FILE_AT_LINE (256)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_repeatInstructionForGeneration) {
      GALGAS_repeatInstructionForGeneration cast_11120_si ((cPtr_repeatInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11120_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (271)), cast_11120_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (271)), inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = result_bool.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (272)).objectCompare (cast_11120_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (272)).reader_length (SOURCE_FILE_AT_LINE (272)))) COMMA_SOURCE_FILE_AT_LINE (272)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_11120_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (273)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (275)).reader_string (SOURCE_FILE_AT_LINE (275)) COMMA_SOURCE_FILE_AT_LINE (275)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (cast_11120_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (277)).reader_length (SOURCE_FILE_AT_LINE (277)).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (273)) ;
        //-------- @assignmentInstructionForGeneration
        result_bool = GALGAS_bool (false) ;
      }
      //-------- @foreachInstructionForGeneration
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11827 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11893 (cast_11120_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (281)), true) ;
      //--- complex foreach instruction
      bool bool_1 = result_bool.isValidAndTrue () ;
      if (enumerator_11827.hasCurrentObject () && enumerator_11893.hasCurrentObject () && bool_1) {
        while (enumerator_11827.hasCurrentObject () && enumerator_11893.hasCurrentObject () && bool_1) {
          //-------- @assignmentInstructionForGeneration
          result_bool = function_compareSyntaxSignature (enumerator_11827.current_mInstructionList (HERE), enumerator_11893.current_mInstructionList (HERE), enumerator_11893.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
          enumerator_11827.gotoNextObject () ;
          enumerator_11893.gotoNextObject () ;
          if (enumerator_11827.hasCurrentObject () && enumerator_11893.hasCurrentObject ()) {
            bool_1 = result_bool.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_12096_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (cast_12096_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (285)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (285)) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (false) ;
    }else{
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = result_bool.operator_not (SOURCE_FILE_AT_LINE (293)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_selectInstructionForGeneration) {
      GALGAS_selectInstructionForGeneration cast_12782_si ((cPtr_selectInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (true) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = result_bool.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (309)).objectCompare (cast_12782_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (309)).reader_length (SOURCE_FILE_AT_LINE (309)))) COMMA_SOURCE_FILE_AT_LINE (309)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_12782_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (310)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (312)).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (cast_12782_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (314)).reader_length (SOURCE_FILE_AT_LINE (314)).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (310)) ;
        //-------- @assignmentInstructionForGeneration
        result_bool = GALGAS_bool (false) ;
      }
      //-------- @foreachInstructionForGeneration
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13375 (object->mAttribute_mListOfSemanticInstructionListForGeneration, true) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13441 (cast_12782_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (318)), true) ;
      //--- complex foreach instruction
      bool bool_1 = result_bool.isValidAndTrue () ;
      if (enumerator_13375.hasCurrentObject () && enumerator_13441.hasCurrentObject () && bool_1) {
        while (enumerator_13375.hasCurrentObject () && enumerator_13441.hasCurrentObject () && bool_1) {
          //-------- @assignmentInstructionForGeneration
          result_bool = function_compareSyntaxSignature (enumerator_13375.current_mInstructionList (HERE), enumerator_13441.current_mInstructionList (HERE), enumerator_13441.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
          enumerator_13375.gotoNextObject () ;
          enumerator_13441.gotoNextObject () ;
          if (enumerator_13375.hasCurrentObject () && enumerator_13441.hasCurrentObject ()) {
            bool_1 = result_bool.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_13644_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (cast_13644_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (322)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (322)) ;
      //-------- @assignmentInstructionForGeneration
      result_bool = GALGAS_bool (false) ;
    }else{
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = result_bool.operator_not (SOURCE_FILE_AT_LINE (330)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @errorInstructionForGeneration
