...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (var_instruction.isValid ()) {
      if (var_instruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
        GALGAS_syntaxInstructionForGeneration cast_7816_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
        inCompiler->emitSemanticError (cast_7816_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (181)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_instruction.isValid ()) {
        if (var_instruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
          GALGAS_syntaxInstructionForGeneration cast_8479_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
          inCompiler->emitSemanticError (cast_8479_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (194)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (194)) ;
        }else{
...
static GALGAS_object functionWithGenericHeader_compareSyntaxSignature (C_Compiler * inCompiler,
  ...
  const GALGAS_semanticInstructionListForGeneration operand0 = GALGAS_semanticInstructionListForGeneration::extractObject (inEffectiveParameterArray.objectAtIndex (0 COMMA_HERE),
                                                                                                                           inCompiler,
                                                                                                                           inErrorLocation,
                                                                                                                           GALGAS_string ("operand 0 is not an @semanticInstructionListForGeneration")
                                                                                                                           COMMA_THERE) ;
  const GALGAS_semanticInstructionListForGeneration operand1 = GALGAS_semanticInstructionListForGeneration::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE),
                                                                                                                           inCompiler,
                                                                                                                           inErrorLocation,
  ...
  const GALGAS_location operand2 = GALGAS_location::extractObject (inEffectiveParameterArray.objectAtIndex (2 COMMA_HERE),
                                                                   inCompiler,
                                                                   inErrorLocation,
                                                                   GALGAS_string ("operand 2 is not an @location")
                                                                   COMMA_THERE) ;
...
static GALGAS_bool categoryReader_terminalCheckInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_terminalCheckInstructionForGeneration) {
      GALGAS_terminalCheckInstructionForGeneration cast_9051_si ((cPtr_terminalCheckInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (211)).objectCompare (cast_9051_si.reader_mTerminalName (SOURCE_FILE_AT_LINE (211)).reader_string (SOURCE_FILE_AT_LINE (211)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (212)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_9051_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (213)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
    }else if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
      GALGAS_syntaxInstructionForGeneration cast_9366_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_9366_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (218)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (218)) ;
...
static GALGAS_bool categoryReader_nonterminalInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_nonterminalInstructionForGeneration) {
      GALGAS_nonterminalInstructionForGeneration cast_10082_si ((cPtr_nonterminalInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mNonterminalName.objectCompare (cast_10082_si.reader_mNonterminalName (SOURCE_FILE_AT_LINE (241)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (242)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_10082_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (243)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }
    }else if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
      GALGAS_syntaxInstructionForGeneration cast_10396_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_10396_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (248)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (248)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_repeatInstructionForGeneration) {
      GALGAS_repeatInstructionForGeneration cast_11113_si ((cPtr_repeatInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11113_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (271)), cast_11113_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (271)), inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (272)).objectCompare (cast_11113_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (272)).reader_length (SOURCE_FILE_AT_LINE (272)))) COMMA_SOURCE_FILE_AT_LINE (272)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_11113_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (273)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (275)).reader_string (SOURCE_FILE_AT_LINE (275)) COMMA_SOURCE_FILE_AT_LINE (275)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (cast_11113_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (277)).reader_length (SOURCE_FILE_AT_LINE (277)).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (273)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11819 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11885 (cast_11113_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (281)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_11819.hasCurrentObject () && enumerator_11885.hasCurrentObject () && bool_1) {
        while (enumerator_11819.hasCurrentObject () && enumerator_11885.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_11819.current_mInstructionList (HERE), enumerator_11885.current_mInstructionList (HERE), enumerator_11885.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
          enumerator_11819.gotoNextObject () ;
          enumerator_11885.gotoNextObject () ;
          if (enumerator_11819.hasCurrentObject () && enumerator_11885.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
      GALGAS_syntaxInstructionForGeneration cast_12088_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_12088_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (285)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (285)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_selectInstructionForGeneration) {
      GALGAS_selectInstructionForGeneration cast_12772_si ((cPtr_selectInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (true) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (309)).objectCompare (cast_12772_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (309)).reader_length (SOURCE_FILE_AT_LINE (309)))) COMMA_SOURCE_FILE_AT_LINE (309)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_12772_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (310)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (312)).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (cast_12772_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (314)).reader_length (SOURCE_FILE_AT_LINE (314)).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (310)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13364 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13430 (cast_12772_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (318)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_13364.hasCurrentObject () && enumerator_13430.hasCurrentObject () && bool_1) {
        while (enumerator_13364.hasCurrentObject () && enumerator_13430.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_13364.current_mInstructionList (HERE), enumerator_13430.current_mInstructionList (HERE), enumerator_13430.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
          enumerator_13364.gotoNextObject () ;
          enumerator_13430.gotoNextObject () ;
          if (enumerator_13364.hasCurrentObject () && enumerator_13430.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_syntaxInstructionForGeneration) {
      GALGAS_syntaxInstructionForGeneration cast_13633_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_13633_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (322)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (322)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
