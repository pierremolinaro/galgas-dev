...
GALGAS_semanticInstructionListForGeneration function_syntaxSignatureOfInstructionList (const GALGAS_string & constinArgument_inPosfix,
  ...
  cEnumerator_semanticInstructionListForGeneration enumerator_2403 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_2403.hasCurrentObject ()) {
    callCategoryMethod_appendSyntaxSignature ((const cPtr_semanticInstructionForGeneration *) enumerator_2403.current_mInstruction (HERE).ptr (), constinArgument_inPosfix, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (44)) ;
...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  cEnumerator_semanticInstructionListForGeneration enumerator_7408 (constinArgument_inReferenceSignature, kEnumeration_up) ;
  cEnumerator_semanticInstructionListForGeneration enumerator_7434 (constinArgument_inTestedSignature, kEnumeration_up) ;
  bool bool_0 = result_outOk.isValidAndTrue () ;
  if (enumerator_7408.hasCurrentObject () && enumerator_7434.hasCurrentObject () && bool_0) {
    while (enumerator_7408.hasCurrentObject () && enumerator_7434.hasCurrentObject () && bool_0) {
      result_outOk = callCategoryReader_compareSyntaxInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_7408.current_mInstruction (HERE).ptr (), enumerator_7434.current_mInstruction (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) ;
      enumerator_7408.gotoNextObject () ;
      enumerator_7434.gotoNextObject () ;
      if (enumerator_7408.hasCurrentObject () && enumerator_7434.hasCurrentObject ()) {
        bool_0 = result_outOk.isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_1 = result_outOk.operator_and (GALGAS_bool (kIsStrictInf, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (178)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (178)))) COMMA_SOURCE_FILE_AT_LINE (178)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_semanticInstructionForGeneration var_instruction = constinArgument_inTestedSignature.reader_mInstructionAtIndex (constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (179)), inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) ;
    if (var_instruction.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
        GALGAS_syntaxInstructionForGeneration cast_7825_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
        inCompiler->emitSemanticError (cast_7825_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (182)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }else{
        inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }
    }
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_2 = result_outOk.operator_and (GALGAS_bool (kIsStrictSup, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (188)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (188)))) COMMA_SOURCE_FILE_AT_LINE (188)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("syntax signature error, missing instruction; this branch has less syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (189)) ;
      GALGAS_semanticInstructionForGeneration var_instruction = constinArgument_inReferenceSignature.reader_mInstructionAtIndex (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (192)), inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
      if (var_instruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
          GALGAS_syntaxInstructionForGeneration cast_8488_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
          inCompiler->emitSemanticError (cast_8488_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (195)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (195)) ;
        }else{
          inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (199)) ;
        }
      }
    }
  }
...
static void categoryMethod_repeatInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_semanticInstructionListForGeneration var_repeated_5F_instructionList = function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, object->mAttribute_m_5F_repeated_5F_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (84)) ;
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (85)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_4041 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_4041.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4041.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (88)), enumerator_4041.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (87)) ;
    enumerator_4041.gotoNextObject () ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_repeatInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mSyntaxComponentName, object->mAttribute_mChoiceIndex, var_repeated_5F_instructionList, object->mAttribute_mEndOfRepeatedInstructions, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_selectInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_listOfSemanticInstructionListForGeneration var_listOfSemanticInstructionListForGeneration = GALGAS_listOfSemanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (109)) ;
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_4896 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_4896.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4896.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)), enumerator_4896.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (111)) ;
    enumerator_4896.gotoNextObject () ;
  }
  ioArgument_ioInstructionListForGeneration.addAssign_operation (GALGAS_selectInstructionForGeneration::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mSyntaxComponentName, object->mAttribute_mChoiceIndex, var_listOfSemanticInstructionListForGeneration COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_location joker_5661_0 ; // Joker input parameter
  object->mAttribute_mListOfSemanticInstructionListForGeneration.method_first (var_instructionList, joker_5661_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  ioArgument_ioInstructionListForGeneration.dotAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  ioArgument_ioInstructionListForGeneration.dotAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) COMMA_SOURCE_FILE_AT_LINE (141)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_parseWhenInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  ioArgument_ioInstructionListForGeneration.dotAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, object->mAttribute_mInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_bool categoryReader_terminalCheckInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_terminalCheckInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_terminalCheckInstructionForGeneration cast_9060_si ((cPtr_terminalCheckInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (212)).objectCompare (cast_9060_si.reader_mTerminalName (SOURCE_FILE_AT_LINE (212)).reader_string (SOURCE_FILE_AT_LINE (212)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (213)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_9060_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (214)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (214)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_9375_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_9375_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (219)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (224)) ;
      result_outOk = GALGAS_bool (false) ;
    }
  }
  const enumGalgasBool test_1 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (227)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (228)) ;
  }
//---
  return result_outOk ;
}
...
static GALGAS_bool categoryReader_nonterminalInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_nonterminalInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_nonterminalInstructionForGeneration cast_10091_si ((cPtr_nonterminalInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mNonterminalName.objectCompare (cast_10091_si.reader_mNonterminalName (SOURCE_FILE_AT_LINE (242)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (243)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_10091_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (244)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (245)) COMMA_SOURCE_FILE_AT_LINE (244)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      ...
      inCompiler->emitSemanticError (cast_10405_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (249)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (249)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (254)) ;
      result_outOk = GALGAS_bool (false) ;
    }
  }
  const enumGalgasBool test_1 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (257)).boolEnum () ;
  if (kBoolTrue == test_1) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (258)) ;
  }
//---
  return result_outOk ;
}
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_repeatInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_repeatInstructionForGeneration cast_11122_si ((cPtr_repeatInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11122_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (272)), cast_11122_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (272)), inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (273)).objectCompare (cast_11122_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (273)).reader_length (SOURCE_FILE_AT_LINE (273)))) COMMA_SOURCE_FILE_AT_LINE (273)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_11122_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (274)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (276)).reader_string (SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (275)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (cast_11122_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (278)).reader_length (SOURCE_FILE_AT_LINE (278)).reader_string (SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (274)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11817 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11874 (cast_11122_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (282)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_11817.hasCurrentObject () && enumerator_11874.hasCurrentObject () && bool_1) {
        while (enumerator_11817.hasCurrentObject () && enumerator_11874.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_11817.current_mInstructionList (HERE), enumerator_11874.current_mInstructionList (HERE), enumerator_11874.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
          enumerator_11817.gotoNextObject () ;
          enumerator_11874.gotoNextObject () ;
          if (enumerator_11817.hasCurrentObject () && enumerator_11874.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_12079_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_12079_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (286)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (286)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (291)) ;
      result_outOk = GALGAS_bool (false) ;
    }
  }
  const enumGalgasBool test_2 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (294)).boolEnum () ;
  if (kBoolTrue == test_2) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (295)) ;
  }
//---
  return result_outOk ;
}
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_selectInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_selectInstructionForGeneration cast_12763_si ((cPtr_selectInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (true) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (310)).objectCompare (cast_12763_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (310)).reader_length (SOURCE_FILE_AT_LINE (310)))) COMMA_SOURCE_FILE_AT_LINE (310)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_12763_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (311)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (313)).reader_string (SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (cast_12763_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (315)).reader_length (SOURCE_FILE_AT_LINE (315)).reader_string (SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13344 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13401 (cast_12763_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (319)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_13344.hasCurrentObject () && enumerator_13401.hasCurrentObject () && bool_1) {
        while (enumerator_13344.hasCurrentObject () && enumerator_13401.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_13344.current_mInstructionList (HERE), enumerator_13401.current_mInstructionList (HERE), enumerator_13401.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
          enumerator_13344.gotoNextObject () ;
          enumerator_13401.gotoNextObject () ;
          if (enumerator_13344.hasCurrentObject () && enumerator_13401.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_13606_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_13606_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (323)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (323)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (328)) ;
      result_outOk = GALGAS_bool (false) ;
    }
  }
  const enumGalgasBool test_2 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (331)).boolEnum () ;
  if (kBoolTrue == test_2) {
    inCompiler->emitSemanticError (object->mAttribute_mInstructionLocation, GALGAS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (332)) ;
  }
//---
  return result_outOk ;
}
