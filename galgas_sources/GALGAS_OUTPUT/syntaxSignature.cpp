...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  const GALGAS_bool test_1 (result_bool.operator_and (GALGAS_bool (kIsStrictInf, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (167)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (167)))) COMMA_SOURCE_FILE_AT_LINE (167))) ;
  if (test_1.isValidAndTrue ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (result_bool.operator_and (GALGAS_bool (kIsStrictSup, constinArgument_inReferenceSignature.reader_length (SOURCE_FILE_AT_LINE (177)).objectCompare (constinArgument_inTestedSignature.reader_length (SOURCE_FILE_AT_LINE (177)))) COMMA_SOURCE_FILE_AT_LINE (177))) ;
...
static GALGAS_bool categoryReader_terminalCheckInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_terminalCheckInstructionForGeneration) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_0 (result_bool.operator_not (SOURCE_FILE_AT_LINE (202))) ;
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (result_bool.operator_not (SOURCE_FILE_AT_LINE (216))) ;
  if (test_1.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_nonterminalInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_nonterminalInstructionForGeneration) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_0 (result_bool.operator_not (SOURCE_FILE_AT_LINE (232))) ;
      if (test_0.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (result_bool.operator_not (SOURCE_FILE_AT_LINE (246))) ;
  if (test_1.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_repeatInstructionForGeneration) {
      ...
      if (enumerator_11499.hasCurrentObject () && enumerator_11565.hasCurrentObject () && bool_1) {
        while (enumerator_11499.hasCurrentObject () && enumerator_11565.hasCurrentObject () && bool_1) {
          //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_2 (result_bool.operator_not (SOURCE_FILE_AT_LINE (283))) ;
  if (test_2.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (constinArgument_inTestedInstruction.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_selectInstructionForGeneration) {
      ...
      result_bool = GALGAS_bool (true) ;
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_0 (result_bool.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (299)).objectCompare (cast_12454_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (299)).reader_length (SOURCE_FILE_AT_LINE (299)))) COMMA_SOURCE_FILE_AT_LINE (299))) ;
      if (test_0.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
      ...
      //--- complex foreach instruction
      bool bool_1 = result_bool.isValidAndTrue () ;
      if (enumerator_13047.hasCurrentObject () && enumerator_13113.hasCurrentObject () && bool_1) {
        while (enumerator_13047.hasCurrentObject () && enumerator_13113.hasCurrentObject () && bool_1) {
          //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_2 (result_bool.operator_not (SOURCE_FILE_AT_LINE (320))) ;
  if (test_2.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
