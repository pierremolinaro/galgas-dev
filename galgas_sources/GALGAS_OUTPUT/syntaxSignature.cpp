...
GALGAS_semanticInstructionListForGeneration function_syntaxSignatureOfInstructionList (const GALGAS_string & constinArgument_inPosfix,
  ...
  result_outResult = GALGAS_semanticInstructionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (41)) ;
  ...
  while (enumerator_2367.hasCurrentObject ()) {
    callCategoryMethod_appendSyntaxSignature ((const cPtr_semanticInstructionForGeneration *) enumerator_2367.current_mInstruction (HERE).ptr (), constinArgument_inPosfix, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (43)) ;
...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  if (enumerator_7543.hasCurrentObject () && enumerator_7569.hasCurrentObject () && bool_0) {
    while (enumerator_7543.hasCurrentObject () && enumerator_7569.hasCurrentObject () && bool_0) {
      result_outOk = callCategoryReader_compareSyntaxInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_7543.current_mInstruction (HERE).ptr (), enumerator_7569.current_mInstruction (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (177)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (var_instruction.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
        ...
        inCompiler->emitSemanticError (cast_7960_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (183)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (183)) ;
      }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_instruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
          ...
          inCompiler->emitSemanticError (cast_8623_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (196)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (196)) ;
        }else{
...
static void categoryMethod_repeatInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_4176.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4176.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (89)), enumerator_4176.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (88)) ;
...
static void categoryMethod_selectInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_5031.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_5031.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)), enumerator_5031.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (112)) ;
...
static void categoryMethod_parseRewindInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  object->mAttribute_mListOfSemanticInstructionListForGeneration.method_first (var_instructionList, joker_5796_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_repeatInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      ...
      result_outOk = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11257_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (273)), cast_11257_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (273)), inCompiler COMMA_SOURCE_FILE_AT_LINE (273)) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (274)).objectCompare (cast_11257_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (274)).reader_length (SOURCE_FILE_AT_LINE (274)))) COMMA_SOURCE_FILE_AT_LINE (274)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_11257_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (275)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (277)).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (277)).operator_concat (cast_11257_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (279)).reader_length (SOURCE_FILE_AT_LINE (279)).reader_string (SOURCE_FILE_AT_LINE (279)) COMMA_SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (275)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      ...
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_12009 (cast_11257_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (283)), kEnumeration_up) ;
      ...
      if (enumerator_11952.hasCurrentObject () && enumerator_12009.hasCurrentObject () && bool_1) {
        while (enumerator_11952.hasCurrentObject () && enumerator_12009.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_11952.current_mInstructionList (HERE), enumerator_12009.current_mInstructionList (HERE), enumerator_12009.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
      ...
      inCompiler->emitSemanticError (cast_12214_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (287)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (287)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_selectInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      ...
      result_outOk = GALGAS_bool (true) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (311)).objectCompare (cast_12898_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (311)).reader_length (SOURCE_FILE_AT_LINE (311)))) COMMA_SOURCE_FILE_AT_LINE (311)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_12898_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (312)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (314)).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (cast_12898_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (316)).reader_length (SOURCE_FILE_AT_LINE (316)).reader_string (SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (312)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      ...
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13536 (cast_12898_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (320)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_13479.hasCurrentObject () && enumerator_13536.hasCurrentObject () && bool_1) {
        while (enumerator_13479.hasCurrentObject () && enumerator_13536.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_13479.current_mInstructionList (HERE), enumerator_13536.current_mInstructionList (HERE), enumerator_13536.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (321)) ;
      ...
      inCompiler->emitSemanticError (cast_13741_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (324)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (324)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
