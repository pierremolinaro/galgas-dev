...
//                    december 25th, 2013, at 15h34'35"                      *
//                                                                             *
//-----------------------------------------------------------------------------*
...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  cEnumerator_semanticInstructionListForGeneration enumerator_7413 (constinArgument_inReferenceSignature, kEnumeration_up) ;
  cEnumerator_semanticInstructionListForGeneration enumerator_7439 (constinArgument_inTestedSignature, kEnumeration_up) ;
  bool bool_0 = result_outOk.isValidAndTrue () ;
  if (enumerator_7413.hasCurrentObject () && enumerator_7439.hasCurrentObject () && bool_0) {
    while (enumerator_7413.hasCurrentObject () && enumerator_7439.hasCurrentObject () && bool_0) {
      result_outOk = callCategoryReader_compareSyntaxInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_7413.current_mInstruction (HERE).ptr (), enumerator_7439.current_mInstruction (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)) ;
      enumerator_7413.gotoNextObject () ;
      enumerator_7439.gotoNextObject () ;
      if (enumerator_7413.hasCurrentObject () && enumerator_7439.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_1) {
    ...
    if (var_instruction.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
        GALGAS_syntaxInstructionForGeneration cast_7830_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
        inCompiler->emitSemanticError (cast_7830_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (182)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_instruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
          GALGAS_syntaxInstructionForGeneration cast_8493_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
          inCompiler->emitSemanticError (cast_8493_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (195)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (195)) ;
        }else{
...
static void categoryMethod_repeatInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  while (enumerator_4046.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4046.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (88)), enumerator_4046.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (87)) ;
...
static void categoryMethod_selectInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  cEnumerator_listOfSemanticInstructionListForGeneration enumerator_4901 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
  while (enumerator_4901.hasCurrentObject ()) {
    var_listOfSemanticInstructionListForGeneration.addAssign_operation (function_syntaxSignatureOfInstructionList (constinArgument_inPosfix, enumerator_4901.current_mInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)), enumerator_4901.current_mEndOfInstructionList (HERE) COMMA_SOURCE_FILE_AT_LINE (111)) ;
...
static void categoryMethod_parseRewindInstructionForGeneration_appendSyntaxSignature (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  GALGAS_location joker_5666_0 ; // Joker input parameter
  object->mAttribute_mListOfSemanticInstructionListForGeneration.method_first (var_instructionList, joker_5666_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
...
static GALGAS_bool categoryReader_terminalCheckInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_terminalCheckInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_terminalCheckInstructionForGeneration cast_9065_si ((cPtr_terminalCheckInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (212)).objectCompare (cast_9065_si.reader_mTerminalName (SOURCE_FILE_AT_LINE (212)).reader_string (SOURCE_FILE_AT_LINE (212)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (213)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_9065_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (214)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (214)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_9380_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_9380_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (219)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '$").operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("$' terminal check") COMMA_SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_repeatInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_repeatInstructionForGeneration cast_11127_si ((cPtr_repeatInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11127_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (272)), cast_11127_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (272)), inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (273)).objectCompare (cast_11127_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (273)).reader_length (SOURCE_FILE_AT_LINE (273)))) COMMA_SOURCE_FILE_AT_LINE (273)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_11127_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (274)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (276)).reader_string (SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (275)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (cast_11127_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (278)).reader_length (SOURCE_FILE_AT_LINE (278)).reader_string (SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (274)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11822 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11879 (cast_11127_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (282)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_11822.hasCurrentObject () && enumerator_11879.hasCurrentObject () && bool_1) {
        while (enumerator_11822.hasCurrentObject () && enumerator_11879.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_11822.current_mInstructionList (HERE), enumerator_11879.current_mInstructionList (HERE), enumerator_11879.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (283)) ;
          enumerator_11822.gotoNextObject () ;
          enumerator_11879.gotoNextObject () ;
          if (enumerator_11822.hasCurrentObject () && enumerator_11879.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_12084_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_12084_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (286)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (286)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_selectInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_selectInstructionForGeneration cast_12768_si ((cPtr_selectInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (true) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (310)).objectCompare (cast_12768_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (310)).reader_length (SOURCE_FILE_AT_LINE (310)))) COMMA_SOURCE_FILE_AT_LINE (310)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_12768_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (311)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (313)).reader_string (SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (cast_12768_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (315)).reader_length (SOURCE_FILE_AT_LINE (315)).reader_string (SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13349 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13406 (cast_12768_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (319)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_13349.hasCurrentObject () && enumerator_13406.hasCurrentObject () && bool_1) {
        while (enumerator_13349.hasCurrentObject () && enumerator_13406.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_13349.current_mInstructionList (HERE), enumerator_13406.current_mInstructionList (HERE), enumerator_13406.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
          enumerator_13349.gotoNextObject () ;
          enumerator_13406.gotoNextObject () ;
          if (enumerator_13349.hasCurrentObject () && enumerator_13406.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_13611_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_13611_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (323)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (323)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
