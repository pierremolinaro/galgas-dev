...
//---------------------------------------------------------------------------*
//                                                                           *
//Category method '@parseRewindInstructionForGeneration.appendSyntaxSignature'*
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__parseRewindInstructionForGeneration__appendSyntaxSignature (C_CompilerEx & inLexique,
  ...
  if (operand_5385 != NULL) {
    ...
    GGS_location  automatic_var_5592_0 ;
    if (operand_5385->mListOfSemanticInstructionListForGeneration.isBuilt ()) {
      operand_5385->mListOfSemanticInstructionListForGeneration (HERE)->method_first (inLexique, var_cas_instructionList, automatic_var_5592_0 COMMA_SOURCE_FILE_AT_LINE (126)) ;
    }
...
category_method__parseLoopInstructionForGeneration__appendSyntaxSignature (C_CompilerEx & inLexique,
                                ...
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5850 != NULL) {
    var_cas_ioInstructionListForGeneration.dotAssign_operation (function_syntaxSignatureOfInstructionList (inLexique, operand_5850->mInstructionList COMMA_SOURCE_FILE_AT_LINE (135))) ;
  }
}
...
category_method__parseWhenInstructionForGeneration__appendSyntaxSignature (C_CompilerEx & inLexique,
                                ...
                                GGS_semanticInstructionListForGeneration  & var_cas_ioInstructionListForGeneration
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6182 != NULL) {
    var_cas_ioInstructionListForGeneration.dotAssign_operation (function_syntaxSignatureOfInstructionList (inLexique, operand_6182->mInstructionList COMMA_SOURCE_FILE_AT_LINE (143))) ;
  }
}
...
GGS_bool function_compareSyntaxSignature (C_CompilerEx & inLexique,
  ...
  var_cas_outOk = GGS_bool (true) ;
  {
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_7265 (var_cas_inReferenceSignature, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_7265 = NULL ;
    GGS_semanticInstructionListForGeneration::cEnumerator enumerator_7300 (var_cas_inTestedSignature, true) ;
    const GGS_semanticInstructionListForGeneration::cElement * operand_7300 = NULL ;
    while (((operand_7265 = enumerator_7265.nextObject ()))
        && ((operand_7300 = enumerator_7300.nextObject ()))
        && (var_cas_outOk.isBuiltAndTrue ())) {
      macroValidPointer (operand_7265) ;
      macroValidPointer (operand_7300) ;
      var_cas_outOk = (findCategoryReader__semanticInstructionForGeneration__compareSyntaxInstruction (operand_7265->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_7265->mInstruction.getPtr (), operand_7300->mInstruction COMMA_SOURCE_FILE_AT_LINE (169))) ;
    }
  }
  const GGS_bool cond_7950 = (var_cas_outOk).operator_and ((var_cas_inReferenceSignature.reader_length ()).operator_strictInf (var_cas_inTestedSignature.reader_length ())) ;
  if (cond_7950.isBuiltAndTrue ()) {
    ...
    { const GGS_semanticInstructionForGeneration _var_7935 = var_cas_instruction ; // CAST instruction
      if (_var_7935.getPtr () != NULL) {
        macroValidPointer (_var_7935.getPtr ()) ;
        if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_7935.getPtr ()) != NULL) {
          const GGS_syntaxInstructionForGeneration var_cas_si (_var_7935.getPtr ()) ;
  ...
  }else if (cond_7950.isBuiltAndFalse ()) {
    const GGS_bool cond_8604 = (var_cas_outOk).operator_and ((var_cas_inReferenceSignature.reader_length ()).operator_strictSup (var_cas_inTestedSignature.reader_length ())) ;
    if (cond_8604.isBuiltAndTrue ()) {
      ...
      { const GGS_semanticInstructionForGeneration _var_8591 = var_cas_instruction ; // CAST instruction
        if (_var_8591.getPtr () != NULL) {
          macroValidPointer (_var_8591.getPtr ()) ;
          if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_8591.getPtr ()) != NULL) {
            const GGS_syntaxInstructionForGeneration var_cas_si (_var_8591.getPtr ()) ;
...
category_reader__terminalCheckInstructionForGeneration__compareSyntaxInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_8784 != NULL) {
    { const GGS_semanticInstructionForGeneration _var_9528 = var_cas_inTestedInstruction ; // CAST instruction
      if (_var_9528.getPtr () != NULL) {
        macroValidPointer (_var_9528.getPtr ()) ;
        if (typeid (cPtr_terminalCheckInstructionForGeneration) == typeid (* (_var_9528.getPtr ()))) {
          const GGS_terminalCheckInstructionForGeneration var_cas_si (_var_9528.getPtr ()) ;
          var_cas_outOk = (operand_8784->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))).operator_isEqual (var_cas_si.reader_mTerminalName (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205))) ;
          const GGS_bool cond_9206 = (var_cas_outOk).operator_not () ;
          if (cond_9206.isBuiltAndTrue ()) {
            var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("syntax signature error; the expected syntax instruction here is the '$")).operator_concat (operand_8784->mTerminalName)).operator_concat (GGS_string ("$' terminal check")) COMMA_SOURCE_FILE_AT_LINE (210)) ;
          }
        }else if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_9528.getPtr ()) != NULL) {
          const GGS_syntaxInstructionForGeneration var_cas_si (_var_9528.getPtr ()) ;
          var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (212)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("syntax signature error; the expected syntax instruction here is the '$")).operator_concat (operand_8784->mTerminalName)).operator_concat (GGS_string ("$' terminal check")) COMMA_SOURCE_FILE_AT_LINE (215)) ;
          var_cas_outOk = GGS_bool (false) ;
        }else{
          operand_8784->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (218)) ;
          var_cas_outOk = GGS_bool (false) ;
        }
      }
    }
    const GGS_bool cond_9642 = (var_cas_outOk).operator_not () ;
    if (cond_9642.isBuiltAndTrue ()) {
      operand_8784->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (224)) ;
    }
  }
  return var_cas_outOk ;
}
...
category_reader__nonterminalInstructionForGeneration__compareSyntaxInstruction (C_CompilerEx & inLexique,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_bool var_cas_outOk ;
  if (operand_9820 != NULL) {
    { const GGS_semanticInstructionForGeneration _var_10572 = var_cas_inTestedInstruction ; // CAST instruction
      if (_var_10572.getPtr () != NULL) {
        macroValidPointer (_var_10572.getPtr ()) ;
        if (typeid (cPtr_nonterminalInstructionForGeneration) == typeid (* (_var_10572.getPtr ()))) {
          const GGS_nonterminalInstructionForGeneration var_cas_si (_var_10572.getPtr ()) ;
          var_cas_outOk = (operand_9820->mNonterminalName).operator_isEqual (var_cas_si.reader_mNonterminalName (inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
          const GGS_bool cond_10239 = (var_cas_outOk).operator_not () ;
          if (cond_10239.isBuiltAndTrue ()) {
            var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (237)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("syntax signature error; the expected syntax instruction here is the '<")).operator_concat (operand_9820->mNonterminalName)).operator_concat (GGS_string (">' nonterminal invocation")) COMMA_SOURCE_FILE_AT_LINE (240)) ;
          }
        }else if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_10572.getPtr ()) != NULL) {
          const GGS_syntaxInstructionForGeneration var_cas_si (_var_10572.getPtr ()) ;
          var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (242)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("syntax signature error; the expected syntax instruction here is the '<")).operator_concat (operand_9820->mNonterminalName)).operator_concat (GGS_string (">' nonterminal invocation")) COMMA_SOURCE_FILE_AT_LINE (245)) ;
          var_cas_outOk = GGS_bool (false) ;
        }else{
          operand_9820->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (248)) ;
          var_cas_outOk = GGS_bool (false) ;
        }
      }
    }
    const GGS_bool cond_10686 = (var_cas_outOk).operator_not () ;
    if (cond_10686.isBuiltAndTrue ()) {
      operand_9820->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (254)) ;
    }
  }
  return var_cas_outOk ;
}
...
category_reader__repeatInstructionForGeneration__compareSyntaxInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_10859 != NULL) {
    { const GGS_semanticInstructionForGeneration _var_12234 = var_cas_inTestedInstruction ; // CAST instruction
      if (_var_12234.getPtr () != NULL) {
        macroValidPointer (_var_12234.getPtr ()) ;
        if (typeid (cPtr_repeatInstructionForGeneration) == typeid (* (_var_12234.getPtr ()))) {
          const GGS_repeatInstructionForGeneration var_cas_si (_var_12234.getPtr ()) ;
          var_cas_outOk = function_compareSyntaxSignature (inLexique, operand_10859->m_repeated_instructionList, var_cas_si.reader_m_repeated_instructionList (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), var_cas_si.reader_mEndOfRepeatedInstructions (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)) ;
          const GGS_bool cond_11643 = (var_cas_outOk).operator_and ((operand_10859->mListOfSemanticInstructionListForGeneration.reader_length ()).operator_isNotEqual (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_length ())) ;
          if (cond_11643.isBuiltAndTrue ()) {
            var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (267)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("syntax signature error; the reference 'repeat' instruction has ")).operator_concat (operand_10859->mListOfSemanticInstructionListForGeneration.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269)))).operator_concat (GGS_string (" 'while' branche(s), but this instruction has "))).operator_concat (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (271)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271))) COMMA_SOURCE_FILE_AT_LINE (273)) ;
            var_cas_outOk = GGS_bool (false) ;
          }
          {
            GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_11704 (operand_10859->mListOfSemanticInstructionListForGeneration, true) ;
            const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_11704 = NULL ;
            GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_11723 (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (275)), true) ;
            const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_11723 = NULL ;
            while (((operand_11704 = enumerator_11704.nextObject ()))
                && ((operand_11723 = enumerator_11723.nextObject ()))
                && (var_cas_outOk.isBuiltAndTrue ())) {
              macroValidPointer (operand_11704) ;
              macroValidPointer (operand_11723) ;
              var_cas_outOk = function_compareSyntaxSignature (inLexique, operand_11704->mInstructionList, operand_11723->mInstructionList, operand_11723->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (276)) ;
            }
          }
        }else if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_12234.getPtr ()) != NULL) {
          const GGS_syntaxInstructionForGeneration var_cas_si (_var_12234.getPtr ()) ;
          ...
          operand_10859->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (285)) ;
          var_cas_outOk = GGS_bool (false) ;
        }
      }
    }
    const GGS_bool cond_12348 = (var_cas_outOk).operator_not () ;
    if (cond_12348.isBuiltAndTrue ()) {
      operand_10859->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (291)) ;
    }
  }
  return var_cas_outOk ;
}
...
category_reader__selectInstructionForGeneration__compareSyntaxInstruction (C_CompilerEx & inLexique,
  ...
  if (operand_12521 != NULL) {
    { const GGS_semanticInstructionForGeneration _var_13782 = var_cas_inTestedInstruction ; // CAST instruction
      if (_var_13782.getPtr () != NULL) {
        macroValidPointer (_var_13782.getPtr ()) ;
        if (typeid (cPtr_selectInstructionForGeneration) == typeid (* (_var_13782.getPtr ()))) {
          const GGS_selectInstructionForGeneration var_cas_si (_var_13782.getPtr ()) ;
          var_cas_outOk = GGS_bool (true) ;
          const GGS_bool cond_13191 = (var_cas_outOk).operator_and ((operand_12521->mListOfSemanticInstructionListForGeneration.reader_length ()).operator_isNotEqual (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (303)).reader_length ())) ;
          if (cond_13191.isBuiltAndTrue ()) {
            var_cas_si.reader_mInstructionLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (304)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("syntax signature error; the reference 'select' instruction has ")).operator_concat (operand_12521->mListOfSemanticInstructionListForGeneration.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (306)))).operator_concat (GGS_string (" 'while' branche(s), but this instruction has "))).operator_concat (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (308)).reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (308))) COMMA_SOURCE_FILE_AT_LINE (310)) ;
            var_cas_outOk = GGS_bool (false) ;
          }
          {
            GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_13252 (operand_12521->mListOfSemanticInstructionListForGeneration, true) ;
            const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_13252 = NULL ;
            GGS_listOfSemanticInstructionListForGeneration::cEnumerator enumerator_13271 (var_cas_si.reader_mListOfSemanticInstructionListForGeneration (inLexique COMMA_SOURCE_FILE_AT_LINE (312)), true) ;
            const GGS_listOfSemanticInstructionListForGeneration::cElement * operand_13271 = NULL ;
            while (((operand_13252 = enumerator_13252.nextObject ()))
                && ((operand_13271 = enumerator_13271.nextObject ()))
                && (var_cas_outOk.isBuiltAndTrue ())) {
              macroValidPointer (operand_13252) ;
              macroValidPointer (operand_13271) ;
              var_cas_outOk = function_compareSyntaxSignature (inLexique, operand_13252->mInstructionList, operand_13271->mInstructionList, operand_13271->mEndOfInstructionList COMMA_SOURCE_FILE_AT_LINE (313)) ;
            }
          }
        }else if (dynamic_cast <cPtr_syntaxInstructionForGeneration *> (_var_13782.getPtr ()) != NULL) {
          const GGS_syntaxInstructionForGeneration var_cas_si (_var_13782.getPtr ()) ;
          ...
          operand_12521->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error") COMMA_SOURCE_FILE_AT_LINE (322)) ;
          var_cas_outOk = GGS_bool (false) ;
        }
      }
    }
    const GGS_bool cond_13896 = (var_cas_outOk).operator_not () ;
    if (cond_13896.isBuiltAndTrue ()) {
      operand_12521->mInstructionLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("reference syntax instruction is here") COMMA_SOURCE_FILE_AT_LINE (328)) ;
    }
  }
  return var_cas_outOk ;
}
...
static void prologueRoutineFor_syntaxSignature (void) {
  ...
  enterCategoryMethod__semanticInstructionForGeneration__appendSyntaxSignature ((typeCategoryMethod__semanticInstructionForGeneration__appendSyntaxSignature) category_method__parseRewindInstructionForGeneration__appendSyntaxSignature, gClassInfoFor__parseRewindInstructionForGeneration.slotID ()) ;
