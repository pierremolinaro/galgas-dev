...
GALGAS_bool function_compareSyntaxSignature (const GALGAS_semanticInstructionListForGeneration & constinArgument_inReferenceSignature,
  ...
  cEnumerator_semanticInstructionListForGeneration enumerator_7383 (constinArgument_inReferenceSignature, kEnumeration_up) ;
  cEnumerator_semanticInstructionListForGeneration enumerator_7409 (constinArgument_inTestedSignature, kEnumeration_up) ;
  bool bool_0 = result_outOk.isValidAndTrue () ;
  if (enumerator_7383.hasCurrentObject () && enumerator_7409.hasCurrentObject () && bool_0) {
    while (enumerator_7383.hasCurrentObject () && enumerator_7409.hasCurrentObject () && bool_0) {
      result_outOk = callCategoryReader_compareSyntaxInstruction ((const cPtr_semanticInstructionForGeneration *) enumerator_7383.current_mInstruction (HERE).ptr (), enumerator_7409.current_mInstruction (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (175)) ;
      enumerator_7383.gotoNextObject () ;
      enumerator_7409.gotoNextObject () ;
      if (enumerator_7383.hasCurrentObject () && enumerator_7409.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_1) {
    ...
    if (var_instruction.isValid ()) {
      if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
        GALGAS_syntaxInstructionForGeneration cast_7798_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
        inCompiler->emitSemanticError (cast_7798_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (181)), GALGAS_string ("syntax signature error, exceeding instruction; this branch has more syntax instructions than reference branch") COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_instruction.isValid ()) {
        if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (var_instruction.ptr ())) {
          GALGAS_syntaxInstructionForGeneration cast_8461_si ((cPtr_syntaxInstructionForGeneration *) var_instruction.ptr ()) ;
          inCompiler->emitSemanticError (cast_8461_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (194)), GALGAS_string ("this is the syntax instruction in reference branch that corresponds to the first missing instruction") COMMA_SOURCE_FILE_AT_LINE (194)) ;
        }else{
...
static GALGAS_bool categoryReader_nonterminalInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_nonterminalInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_nonterminalInstructionForGeneration cast_10064_si ((cPtr_nonterminalInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (kIsEqual, object->mAttribute_mNonterminalName.objectCompare (cast_10064_si.reader_mNonterminalName (SOURCE_FILE_AT_LINE (241)))) ;
      const enumGalgasBool test_0 = result_outOk.operator_not (SOURCE_FILE_AT_LINE (242)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_10064_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (243)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_10378_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_10378_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (248)), GALGAS_string ("syntax signature error; the expected syntax instruction here is the '<").operator_concat (object->mAttribute_mNonterminalName COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string (">' nonterminal invocation") COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (248)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_repeatInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_repeatInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_repeatInstructionForGeneration cast_11095_si ((cPtr_repeatInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = function_compareSyntaxSignature (object->mAttribute_m_5F_repeated_5F_instructionList, cast_11095_si.reader_m_5F_repeated_5F_instructionList (SOURCE_FILE_AT_LINE (271)), cast_11095_si.reader_mEndOfRepeatedInstructions (SOURCE_FILE_AT_LINE (271)), inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (272)).objectCompare (cast_11095_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (272)).reader_length (SOURCE_FILE_AT_LINE (272)))) COMMA_SOURCE_FILE_AT_LINE (272)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_11095_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (273)), GALGAS_string ("syntax signature error; the reference 'repeat' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (275)).reader_string (SOURCE_FILE_AT_LINE (275)) COMMA_SOURCE_FILE_AT_LINE (275)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (276)).operator_concat (cast_11095_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (277)).reader_length (SOURCE_FILE_AT_LINE (277)).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (273)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11792 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_11849 (cast_11095_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (281)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_11792.hasCurrentObject () && enumerator_11849.hasCurrentObject () && bool_1) {
        while (enumerator_11792.hasCurrentObject () && enumerator_11849.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_11792.current_mInstructionList (HERE), enumerator_11849.current_mInstructionList (HERE), enumerator_11849.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
          enumerator_11792.gotoNextObject () ;
          enumerator_11849.gotoNextObject () ;
          if (enumerator_11792.hasCurrentObject () && enumerator_11849.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_12052_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_12052_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (285)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'repeat' instruction") COMMA_SOURCE_FILE_AT_LINE (285)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
...
static GALGAS_bool categoryReader_selectInstructionForGeneration_compareSyntaxInstruction (const cPtr_semanticInstructionForGeneration * inObject,
  ...
  if (constinArgument_inTestedInstruction.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_selectInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_selectInstructionForGeneration cast_12736_si ((cPtr_selectInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      result_outOk = GALGAS_bool (true) ;
      const enumGalgasBool test_0 = result_outOk.operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (309)).objectCompare (cast_12736_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (309)).reader_length (SOURCE_FILE_AT_LINE (309)))) COMMA_SOURCE_FILE_AT_LINE (309)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (cast_12736_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (310)), GALGAS_string ("syntax signature error; the reference 'select' instruction has ").operator_concat (object->mAttribute_mListOfSemanticInstructionListForGeneration.reader_length (SOURCE_FILE_AT_LINE (312)).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)).operator_concat (GALGAS_string (" 'while' branche(s), but this instruction has ") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (cast_12736_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (314)).reader_length (SOURCE_FILE_AT_LINE (314)).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (310)) ;
        result_outOk = GALGAS_bool (false) ;
      }
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13319 (object->mAttribute_mListOfSemanticInstructionListForGeneration, kEnumeration_up) ;
      cEnumerator_listOfSemanticInstructionListForGeneration enumerator_13376 (cast_12736_si.reader_mListOfSemanticInstructionListForGeneration (SOURCE_FILE_AT_LINE (318)), kEnumeration_up) ;
      bool bool_1 = result_outOk.isValidAndTrue () ;
      if (enumerator_13319.hasCurrentObject () && enumerator_13376.hasCurrentObject () && bool_1) {
        while (enumerator_13319.hasCurrentObject () && enumerator_13376.hasCurrentObject () && bool_1) {
          result_outOk = function_compareSyntaxSignature (enumerator_13319.current_mInstructionList (HERE), enumerator_13376.current_mInstructionList (HERE), enumerator_13376.current_mEndOfInstructionList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
          enumerator_13319.gotoNextObject () ;
          enumerator_13376.gotoNextObject () ;
          if (enumerator_13319.hasCurrentObject () && enumerator_13376.hasCurrentObject ()) {
            bool_1 = result_outOk.isValidAndTrue () ;
          }
        }
      }
    }else if (NULL != dynamic_cast <const cPtr_syntaxInstructionForGeneration *> (constinArgument_inTestedInstruction.ptr ())) {
      GALGAS_syntaxInstructionForGeneration cast_13579_si ((cPtr_syntaxInstructionForGeneration *) constinArgument_inTestedInstruction.ptr ()) ;
      inCompiler->emitSemanticError (cast_13579_si.reader_mInstructionLocation (SOURCE_FILE_AT_LINE (322)), GALGAS_string ("syntax signature error; the expected syntax instruction here is a 'select' instruction") COMMA_SOURCE_FILE_AT_LINE (322)) ;
      result_outOk = GALGAS_bool (false) ;
    }else{
