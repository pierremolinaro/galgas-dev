...
void routine_buildGalgas_33_GrammarComponentMapForSemanticAnalysis (const GALGAS_galgas_33_GrammarComponentListAST constinArgument_inGrammarComponentList,
                                                                    ...
                                                                    C_Compiler * inCompiler
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_galgas_33_GrammarComponentListAST enumerator_15915 (constinArgument_inGrammarComponentList, kEnumeration_up) ;
  while (enumerator_15915.hasCurrentObject ()) {
    ...
    cEnumerator_nonTerminalLabelListAST enumerator_16037 (enumerator_15915.current_mStartSymbolLabelList (HERE), kEnumeration_up) ;
    while (enumerator_16037.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_16166 (enumerator_16037.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      while (enumerator_16166.hasCurrentObject ()) {
        var_formalArgumentList.addAssign_operation (GALGAS_unifiedTypeMapProxy::constructor_searchKey (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_16166.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 335)), enumerator_16166.current_mFormalArgumentPassingMode (HERE), enumerator_16166.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 334)) ;
        enumerator_16166.gotoNextObject () ;
      }
      {
      var_grammarLabelMap.modifier_insertKey (enumerator_16037.current_mLabelName (HERE), var_formalArgumentList, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 340)) ;
      }
      enumerator_16037.gotoNextObject () ;
    }
    {
    ioArgument_ioSemanticContext.mAttribute_mGrammarMap.modifier_insertGrammar (enumerator_15915.current_mGrammarComponentName (HERE), var_grammarLabelMap, enumerator_15915.current_mHasIndexing (HERE).mAttribute_bool, enumerator_15915.current_mHasTranslateFeature (HERE), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 346)) ;
    }
...
void routine_buildGalgas_33_SemanticContext (const GALGAS_string constinArgument_inProjectSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_17602 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_17602.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_17602.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 371)) ;
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_18755 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 392)), kEnumeration_up) ;
    while (enumerator_18755.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_18755.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_18755.current_mValue (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 393))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 393)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 393))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 393)) ;
    ...
    GALGAS_lstringlist joker_19112_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (outArgument_outSortedSemanticDeclarationListAST, joker_19112_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 397)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_19507 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_19507.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_19507.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 406))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 406))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 406)) ;
      ...
      cEnumerator_semanticDeclarationListAST enumerator_20335 (outArgument_outSortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_20335.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_20335.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 426)) ;
...
void routine_buildGalgas_33_OptionComponentMapForSemanticAnalysis (const GALGAS_galgas_33_OptionComponentListAST constinArgument_inOptionComponentList,
  ...
  cEnumerator_galgas_33_OptionComponentListAST enumerator_21321 (constinArgument_inOptionComponentList, kEnumeration_up) ;
  while (enumerator_21321.hasCurrentObject ()) {
    ...
    cEnumerator_commandLineOptionListAST enumerator_21569 (enumerator_21321.current_mOptions (HERE), kEnumeration_up) ;
    while (enumerator_21569.hasCurrentObject ()) {
      const enumGalgasBool test_0 = var_optionNameSet.reader_hasKey (enumerator_21569.current_mOptionInternalName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 454)) COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 454)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_location location_1 (enumerator_21569.current_mOptionInternalName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").add_operation (enumerator_21569.current_mOptionInternalName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 455)), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 455)).add_operation (GALGAS_string ("' command line option has been already declared"), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 455))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 455)) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionTypeName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 456)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
          var_boolOptionMap.modifier_insertKey (enumerator_21569.current_mOptionInternalName (HERE), enumerator_21569.current_mOptionInvocationLetter (HERE).reader_char (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 459)), enumerator_21569.current_mOptionInvocationString (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 460)), enumerator_21569.current_mOptionComment (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 461)), GALGAS_string ("false"), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 457)) ;
          }
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_21569.current_mOptionDefaultValueKind (HERE).objectCompare (GALGAS_optionDefaultValueEnumAST::constructor_noDefaultValue (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 464)))).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (enumerator_21569.current_mOptionDefaultValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionTypeName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 467)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
          if (kBoolTrue == test_5) {
            {
            GALGAS_string temp_6 ;
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionDefaultValue (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 473)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_7) {
              temp_6 = GALGAS_string ("0") ;
            }else if (kBoolFalse == test_7) {
              temp_6 = enumerator_21569.current_mOptionDefaultValue (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 473)) ;
            }
            var_uintOptionMap.modifier_insertKey (enumerator_21569.current_mOptionInternalName (HERE), enumerator_21569.current_mOptionInvocationLetter (HERE).reader_char (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 470)), enumerator_21569.current_mOptionInvocationString (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 471)), enumerator_21569.current_mOptionComment (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 472)), temp_6, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 468)) ;
            }
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionDefaultValueKind (HERE).objectCompare (GALGAS_optionDefaultValueEnumAST::constructor_stringDefaultValue (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 475)))).boolEnum () ;
            if (kBoolTrue == test_8) {
              GALGAS_location location_9 (enumerator_21569.current_mOptionDefaultValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionTypeName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 478)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
            if (kBoolTrue == test_10) {
              {
              var_stringOptionMap.modifier_insertKey (enumerator_21569.current_mOptionInternalName (HERE), enumerator_21569.current_mOptionInvocationLetter (HERE).reader_char (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 481)), enumerator_21569.current_mOptionInvocationString (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 482)), enumerator_21569.current_mOptionComment (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 483)), enumerator_21569.current_mOptionDefaultValue (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 484)), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 479)) ;
              }
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_21569.current_mOptionDefaultValueKind (HERE).objectCompare (GALGAS_optionDefaultValueEnumAST::constructor_unsignedDefaultValue (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 486)))).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_location location_12 (enumerator_21569.current_mOptionDefaultValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              GALGAS_location location_13 (enumerator_21569.current_mOptionTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_optionNameSet.addAssign_operation (enumerator_21569.current_mOptionInternalName (HERE).reader_string (SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 492))  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 492)) ;
      enumerator_21569.gotoNextObject () ;
    }
    {
    outArgument_outOptionComponentMapForSemanticAnalysis.modifier_insertKey (enumerator_21321.current_mOptionComponentName (HERE), GALGAS_bool (false), var_boolOptionMap, var_uintOptionMap, var_stringOptionMap, inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 494)) ;
    }
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator__32_stringlist enumerator_24006 (var_optionNameList, kEnumeration_up) ;
    while (enumerator_24006.hasCurrentObject ()) {
      {
      var_boolOptionMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_24006.current_mValue_31_ (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 508)), GALGAS_application::constructor_boolOptionInvocationLetter (enumerator_24006.current_mValue_30_ (HERE), enumerator_24006.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 509)), GALGAS_application::constructor_boolOptionInvocationString (enumerator_24006.current_mValue_30_ (HERE), enumerator_24006.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 510)), GALGAS_application::constructor_boolOptionCommentString (enumerator_24006.current_mValue_30_ (HERE), enumerator_24006.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 511)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 507)) ;
      }
      enumerator_24006.gotoNextObject () ;
    }
    ...
    cEnumerator__32_stringlist enumerator_24482 (var_optionNameList, kEnumeration_up) ;
    while (enumerator_24482.hasCurrentObject ()) {
      {
      var_uintOptionMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_24482.current_mValue_31_ (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 520)), GALGAS_application::constructor_uintOptionInvocationLetter (enumerator_24482.current_mValue_30_ (HERE), enumerator_24482.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 521)), GALGAS_application::constructor_uintOptionInvocationString (enumerator_24482.current_mValue_30_ (HERE), enumerator_24482.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 522)), GALGAS_application::constructor_uintOptionCommentString (enumerator_24482.current_mValue_30_ (HERE), enumerator_24482.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 523)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 519)) ;
      }
    ...
    cEnumerator__32_stringlist enumerator_24962 (var_optionNameList, kEnumeration_up) ;
    while (enumerator_24962.hasCurrentObject ()) {
      {
      var_stringOptionMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_24962.current_mValue_31_ (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 532)), GALGAS_application::constructor_stringOptionInvocationLetter (enumerator_24962.current_mValue_30_ (HERE), enumerator_24962.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 533)), GALGAS_application::constructor_stringOptionInvocationString (enumerator_24962.current_mValue_30_ (HERE), enumerator_24962.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 534)), GALGAS_application::constructor_stringOptionCommentString (enumerator_24962.current_mValue_30_ (HERE), enumerator_24962.current_mValue_31_ (HERE)  COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 535)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("galgas3SemanticDeclarationCompilation.gSemantics", 531)) ;
      }
