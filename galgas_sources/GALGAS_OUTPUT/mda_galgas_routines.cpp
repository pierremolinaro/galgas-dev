...
void routine_performProjectGlobalCheckings (C_Compiler & _inLexique,
  ...
  var_cas_semanticDeclarationList = GGS_semanticDeclarationList ::constructor_emptyList (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_4190 = (GGS_parsedSemanticsComponentMap::cElement *) enumerator_4190.nextObject ()))) {
      ...
      var_cas_semanticDeclarationList = (var_cas_semanticDeclarationList)._operator_concat (operand_4190->mInfo.mRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
    }
  }
