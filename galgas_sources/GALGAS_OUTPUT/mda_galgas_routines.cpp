...
kFunction_descriptor_outputDirectoryTEMP ("outputDirectoryTEMP",
                              (void *) function_outputDirectoryTEMP,
...
GGS_string function_outputDirectoryTEMP (C_Compiler & inLexique,
...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  if (cond_3457.isBuiltAndTrue ()) {
    var_cas_outOuputDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_targetFileListMap ("targetFileListMap") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sourceFileMap ("sourceFileMap") ;
...
const char * gWrapperFileContent_0_fileListTemplateFileWrapper = // 2007 bytes
  "#---------------------------------------------------------------*\n"
  "\n"
  "#--- Lib PM directory\n"
  ...
  "      LIB_PM_PATH := ../../libpm\n"
  "    else\n"
  "      $(error Cannot find libpm: neither ../libpm nor ../../libpm exist)\n"
  "      LIB_PM_PATH :=\n"
  "    endif\n"
  "  endif\n"
  "endif\n"
