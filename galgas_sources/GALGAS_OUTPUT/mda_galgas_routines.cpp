...
void routine_performProjectGlobalCheckings (C_Compiler & _inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_3277 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (58)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_3277 = NULL ;
    while (((operand_3277 = enumerator_3277.nextObject ()))) {
      macroValidPointer (operand_3277) ;
      var_cas_semanticDeclarationList._dotAssign_operation (operand_3277->mInfo.mRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (59)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (59))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (63)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_3960 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (70)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_3960 = NULL ;
      while (((operand_3960 = enumerator_3960.nextObject ()))) {
        macroValidPointer (operand_3960) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
