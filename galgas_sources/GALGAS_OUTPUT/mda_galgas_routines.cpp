...
//---------------------------------------------------------------------------*
//                                                                           *
//              Implementation of function "outputDirectory34                *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_string function_outputDirectory (C_Compiler & _inLexique,
...
//---------------------------------------------------------------------------*
//                                                                           *
//       Implementation of routine "checkCategoryDefinitionForClass34        *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_checkCategoryDefinitionForClass (C_Compiler & _inLexique,
  ...
  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (_inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (63)) ;
  {
      ...
      { const GGS_ACGalgasType _var_3942 = var_cas_t ; // CAST instruction
        if (_var_3942.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_classGalgasType *> (_var_3942.getPtr ()) != NULL) {
            ...
            var_cas_isAbstract = var_cas_classType.reader_mIsAbstract (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
          }else{
            var_cas_descendantClassName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '@"))._operator_concat (var_cas_descendantClassName))._operator_concat (GGS_string (true, "' type should be a class")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
            var_cas_isAbstract._drop () ;
          }
        }
      }
      GGS_overridingCategoryMethodList  var_cas_overridingMethods ;
      var_cas_overridingMethods = var_cas_inOverridingCategoryMethodListMap.reader_listForKey (_inLexique, var_cas_descendantClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//        Implementation of routine "performProjectGlobalCheckings34         *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_performProjectGlobalCheckings (C_Compiler & _inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_5248 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (104)), true) ;
    ...
    while (((operand_5248 = enumerator_5248.nextObject ()))) {
      ...
      var_cas_semanticDeclarationList._dotAssign_operation (operand_5248->mInfo.mRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (105)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (109)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_5950 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)), true) ;
      ...
      while (((operand_5950 = enumerator_5950.nextObject ()))) {
        ...
        var_cas_abstractCategoryMethodListMap._dotAssign_operation (operand_5950->mInfo.mRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)).reader_mAbstractCategoryMethodListMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (117))) ;
        var_cas_overridingCategoryMethodListMap._dotAssign_operation (operand_5950->mInfo.mRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)).reader_mOverridingCategoryMethodListMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (118))) ;
      }
    }
    GGS_descendantClassListMap var_cas_descendantClassListMap ;
