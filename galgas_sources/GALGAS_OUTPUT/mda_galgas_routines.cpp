...
//                    september 28th, 2009, at 16h10'3"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_checkCategoryMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (78)) ;
  {
    ...
    while (((operand_4005 = enumerator_4005.nextObject ()))) {
      ...
      var_cas_overridingMethods = var_cas_inOverridingCategoryMethodListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (88)) COMMA_SOURCE_FILE_AT_LINE (88)) ;
...
void routine_checkCategoryReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  #endif
  GGS_classIndexList  var_cas_descendantClasses ;
  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (120)) ;
  {
    ...
    while (((operand_5843 = enumerator_5843.nextObject ()))) {
      ...
      GGS_overridingCategoryReaderList  var_cas_overridingReaders ;
      var_cas_overridingReaders = var_cas_inOverridingCategoryReaderListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)) ;
      GGS_bool var_cas_found ;
      var_cas_found = GGS_bool (false) ;
      {
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
    {
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_abstractCategoryReaderListMap var_cas_abstractCategoryReaderListMap ;
    var_cas_abstractCategoryReaderListMap = GGS_abstractCategoryReaderListMap::constructor_emptyMap () ;
    GGS_categoryReaderListMap var_cas_categoryReaderListMap ;
    var_cas_categoryReaderListMap = GGS_categoryReaderListMap::constructor_emptyMap () ;
    GGS_overridingCategoryReaderListMap var_cas_overridingCategoryReaderListMap ;
    var_cas_overridingCategoryReaderListMap = GGS_overridingCategoryReaderListMap::constructor_emptyMap () ;
    {
    ...
    GGS_descendantClassListMap var_cas_descendantClassListMap ;
    var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
    {
