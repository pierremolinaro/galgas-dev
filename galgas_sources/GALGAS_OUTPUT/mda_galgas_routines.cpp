...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_outOuputDirectory ;
  if (((var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (61))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
