...
void routine_checkCategoryDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_classIndexList::cEnumerator enumerator_3999 (var_cas_descendantClasses, true) ;
    const GGS_classIndexList::cElement * operand_3999 = NULL ;
    while (((operand_3999 = enumerator_3999.nextObject ()))) {
      ...
      const GGS_typeMapIndex  _temp_4081 = operand_3999->mClassMapindex ;
      if (_temp_4081.isBuilt ()) {
        _temp_4081 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (80)) ;
      }
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_4358 = var_cas_t ; // CAST instruction
        if (_var_4358.getPtr () != NULL) {
          macroValidPointer (_var_4358.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_4358.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_4358.getPtr ()) ;
      ...
      {
        GGS_overridingCategoryMethodList::cEnumerator enumerator_4556 (var_cas_overridingMethods, true) ;
        const GGS_overridingCategoryMethodList::cElement * operand_4556 = NULL ;
        while (((operand_4556 = enumerator_4556.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_4556) ;
          var_cas_found = (var_cas_inAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (operand_4556->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))) ;
        }
      }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_5664 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (119)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_5664 = NULL ;
    while (((operand_5664 = enumerator_5664.nextObject ()))) {
      macroValidPointer (operand_5664) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_5664->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (120)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (120))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (124)) ;
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_6366 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (131)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_6366 = NULL ;
      while (((operand_6366 = enumerator_6366.nextObject ()))) {
        macroValidPointer (operand_6366) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_6366->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (132)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (132))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_6366->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (133)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (133))) ;
      }
    }
    GGS_descendantClassListMap var_cas_descendantClassListMap ;
    var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
    {
      GGS_abstractCategoryMethodListMap::cEnumerator enumerator_6792 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_6792.hasCurrentObject ()) {
        {
          GGS_abstractCategoryMethodList::cEnumerator enumerator_6816 (enumerator_6792._object (HERE), true) ;
          const GGS_abstractCategoryMethodList::cElement * operand_6816 = NULL ;
          while (((operand_6816 = enumerator_6816.nextObject ()))) {
            macroValidPointer (operand_6816) ;
            ::routine_checkCategoryDefinitionForClass (inLexique,  enumerator_6792._key (HERE),  enumerator_6792._key (HERE),  operand_6816->mAbstractCategoryMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (138)) ;
          }
        }
        enumerator_6792.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
