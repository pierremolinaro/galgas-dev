...
void routine_getOutputDirectory (C_Compiler & _inLexique,
  ...
  #endif
  var_cas_outOuputDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (46)) ;
...
void routine_performProjectGlobalCheckings (C_Compiler & _inLexique,
  ...
  var_cas_semanticDeclarationList = GGS_semanticDeclarationList ::constructor_emptyList (_inLexique COMMA_HERE) ;
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_4145 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (87)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_4145 = NULL ;
    while (((operand_4145 = (GGS_parsedSemanticsComponentMap::cElement *) enumerator_4145.nextObject ()))) {
      macroValidPointer (operand_4145) ;
      var_cas_semanticDeclarationList = (var_cas_semanticDeclarationList)._operator_concat (operand_4145->mInfo.mRoot.reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (88))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (91)) ;
  #ifdef DEBUG_TRACE_ENABLED
