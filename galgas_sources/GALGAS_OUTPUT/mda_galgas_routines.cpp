...
void routine_performProjectGlobalCheckings (C_Compiler & _inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_4190 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (88)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_4190 = NULL ;
    while (((operand_4190 = (GGS_parsedSemanticsComponentMap::cElement *) enumerator_4190.nextObject ()))) {
      macroValidPointer (operand_4190) ;
      var_cas_semanticDeclarationList = (var_cas_semanticDeclarationList)._operator_concat (operand_4190->mInfo.mRoot.reader_mSemanticDeclarations (_inLexique COMMA_SOURCE_FILE_AT_LINE (89)).reader_mSemanticDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (_inLexique,  var_cas_semanticDeclarationList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (92)) ;
  #ifdef DEBUG_TRACE_ENABLED
