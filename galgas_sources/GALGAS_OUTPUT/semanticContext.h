...
//--- Readers
  ...
  reader_mOrderedSemanticDeclarationListAST (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mOrderedSemanticDeclarationListAST ;
  }
...
//--- Attributes
  ...
  public : GGS_semanticDeclarationListAST  mOrderedSemanticDeclarationListAST ;
} ;
