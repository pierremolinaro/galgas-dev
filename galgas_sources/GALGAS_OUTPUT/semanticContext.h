...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_unifiedTypeMapProxy   & _mResultTypeIndex (LOCATION_ARGS) const ;
  } ;
} ;
...
void routine_buildSemanticContext (C_Compiler &,
                                ...
                                const GGS_optionComponentMapForSemanticAnalysis  ,
                                const GGS_location  ,
...
class e_functionMap {
  ...
  public : GGS_unifiedTypeMapProxy  mResultTypeIndex ;
