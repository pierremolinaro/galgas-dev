  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1239.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_26) {
        ...
        GALGAS_uint index_10409_ (0) ;
        if (enumerator_1239.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10409 (enumerator_1239.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10409.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10409.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10479_ (0) ;
            if (enumerator_10409.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10479 (enumerator_10409.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10479.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10479.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10479.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)).stringValue () ;
                result << " " ;
                result << enumerator_10479.current_mFormalArgumentName (HERE).stringValue () ;
                index_10479_.increment () ;
                enumerator_10479.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_10409_.increment () ;
