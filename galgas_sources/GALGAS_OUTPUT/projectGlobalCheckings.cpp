    ...
    while (enumerator_1301.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_19) {
        ...
        if (enumerator_1301.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_unifiedTypeMapProxyList enumerator_6695 (enumerator_1301.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6695.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6695.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (153)), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1301.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_6925 (enumerator_1301.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_6925.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6925.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).stringValue () ;
            result << " " ;
            result << enumerator_6925.current_mEnumerationName (HERE).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_22) {
        ...
        GALGAS_uint index_7389_ (0) ;
        if (enumerator_1301.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7389 (enumerator_1301.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7389.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7389.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7446_ (0) ;
            if (enumerator_7389.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyList enumerator_7446 (enumerator_7389.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7446.hasCurrentObject ()) {
                result << " \?" ;
                result << function_linkForType (enumerator_7446.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (173)), inCompiler COMMA_SOURCE_FILE_AT_LINE (173)).stringValue () ;
                index_7446_.increment () ;
                enumerator_7446.gotoNextObject () ;
              }
            }
            result << "<br>" ;
            index_7389_.increment () ;
      ...
      if (kBoolTrue == test_23) {
        ...
        if (enumerator_1301.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7658 (enumerator_1301.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7658.hasCurrentObject ()) {
            switch (enumerator_7658.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7658.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>reader</b> " ;
            result << enumerator_7658.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8075_ (0) ;
            if (enumerator_7658.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyList enumerator_8075 (enumerator_7658.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8075.hasCurrentObject ()) {
                result << " \?" ;
                result << function_linkForType (enumerator_8075.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (196)), inCompiler COMMA_SOURCE_FILE_AT_LINE (196)).stringValue () ;
                index_8075_.increment () ;
                enumerator_8075.gotoNextObject () ;
              }
            }
            result << " -&gt; " ;
            result << function_linkForType (enumerator_7658.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_24) {
        ...
        if (enumerator_1301.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8363 (enumerator_1301.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8363.hasCurrentObject ()) {
            switch (enumerator_8363.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8363.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            if (enumerator_8363.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_8778 (enumerator_8363.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_8778.hasCurrentObject ()) {
                switch (enumerator_8778.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_8778.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (226)), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).stringValue () ;
      ...
      if (kBoolTrue == test_25) {
        ...
        if (enumerator_1301.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9229 (enumerator_1301.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9229.hasCurrentObject ()) {
            switch (enumerator_9229.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9229.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>modifier</b> " ;
            result << enumerator_9229.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9646_ (0) ;
            if (enumerator_9229.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9646 (enumerator_9229.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9646.hasCurrentObject ()) {
                switch (enumerator_9646.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9646.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (256)), inCompiler COMMA_SOURCE_FILE_AT_LINE (256)).stringValue () ;
      ...
      if (kBoolTrue == test_26) {
        ...
        if (enumerator_1301.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10128 (enumerator_1301.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10128.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10128.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10183_ (0) ;
            if (enumerator_10128.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10183 (enumerator_10128.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10183.hasCurrentObject ()) {
                switch (enumerator_10183.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10183.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (274)), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)).stringValue () ;
                index_10183_.increment () ;
