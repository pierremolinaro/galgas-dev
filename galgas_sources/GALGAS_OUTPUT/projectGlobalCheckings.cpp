...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_bool joker_35139_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_35139_0, inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 732)) ;
  }else if (kBoolFalse == test_2) {
    {
...
GALGAS_string filewrapperTemplate_typeDumpGenerationTemplate_typeDump (C_Compiler * inCompiler,
  ...
  if (in_FIRST_5F_LETTER_5F_SET.isValid ()) {
    ...
    while (enumerator_1067.hasCurrentObject ()) {
      ...
      result << enumerator_1067.current_key (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 59)).reader_uint (SOURCE_FILE ("typeDump.html.gTemplate", 59)).reader_string (SOURCE_FILE ("typeDump.html.gTemplate", 59)).stringValue () ;
      result << "\">" ;
  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1275.hasCurrentObject ()) {
      ...
      result << "</a></td></tr>\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_0 = enumerator_1275.current_mIsConcrete (HERE).operator_not (SOURCE_FILE ("typeDump.html.gTemplate", 73)).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "abstract " ;
      }else if (kBoolFalse == test_0) {
      }
      ...
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_1 = enumerator_1275.current_mSuperType (HERE).reader_isNull (SOURCE_FILE ("typeDump.html.gTemplate", 90)).operator_not (SOURCE_FILE ("typeDump.html.gTemplate", 90)).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "<tr class=\"result_line\"><td>Superclass</td><td>" ;
        result << function_linkForType (enumerator_1275.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 91)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 91)).stringValue () ;
        result << "</td></tr>" ;
      ...
      result << "\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 95)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 95)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "addition: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 96)).stringValue () ;
        result << " + " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 96)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 96)).stringValue () ;
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 98)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 98)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "substraction: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 99)).stringValue () ;
        result << " - " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 99)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 99)).stringValue () ;
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 101)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 101)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "multiplication: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 102)).stringValue () ;
        result << " * " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 102)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 102)).stringValue () ;
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 104)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 104)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "division: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 105)).stringValue () ;
        result << " / " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 105)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 105)).stringValue () ;
      ...
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 107)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 107)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        result << "modulo: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 108)).stringValue () ;
        result << " <b>mod</b> " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 108)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 108)).stringValue () ;
      ...
      const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 110)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 110)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        result << "left shift: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 111)).stringValue () ;
        result << " &lt;&lt; " ;
        ...
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 112)).stringValue () ;
        result << " &gt;&gt; " ;
      ...
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 114)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 114)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_8) {
        result << "unary +: + " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 115)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 115)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_8) {
      }
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 117)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 117)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        result << "unary -: - " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 118)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 118)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_9) {
      }
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 120)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 120)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_10) {
        result << "bit wise negation: ~ " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 121)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 121)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_10) {
      }
      const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 123)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 123)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        result << "boolean and: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 124)).stringValue () ;
        result << " &amp; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 124)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 124)).stringValue () ;
      ...
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 126)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 126)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_12) {
        result << "inclusive or: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 127)).stringValue () ;
        result << " | " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 127)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 127)).stringValue () ;
      ...
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 129)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 129)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_13) {
        result << "exclusive or: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 130)).stringValue () ;
        result << " ^ " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 130)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 130)).stringValue () ;
      ...
      const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 132)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 132)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_14) {
        result << "boolean negation: <b>not</b> " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 133)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 133)).stringValue () ;
        result << "<br><br>" ;
      ...
      result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 135)).stringValue () ;
      result << " == " ;
      result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 135)).stringValue () ;
      result << " &rarr; " ;
      ...
      result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 136)).stringValue () ;
      result << " != " ;
      result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 136)).stringValue () ;
      result << " &rarr; " ;
      result << function_linkForType (GALGAS_string ("bool"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 136)).stringValue () ;
      result << "<br><br>" ;
      const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 137)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 137)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_15) {
        result << "lower than test: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 138)).stringValue () ;
        result << " &lt; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 138)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 139)).stringValue () ;
        result << " &lt;= " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 139)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 140)).stringValue () ;
        result << " &gt; " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 140)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 141)).stringValue () ;
        result << " &gt;= " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 141)).stringValue () ;
        result << " &rarr; " ;
      ...
      if (kBoolTrue == test_16) {
        ...
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 144)).stringValue () ;
        result << " += " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 144)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_16) {
      }
      const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_1275.current_mHandledOperatorFlags (HERE).operator_and (function_incDecOperator (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 146)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 146)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_17) {
        result << "incrementation instruction: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 147)).stringValue () ;
        result << " ++<br><br>decrementation instruction: " ;
        result << function_linkForType (enumerator_1275.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 148)).stringValue () ;
        result << " --<br><br>" ;
      }else if (kBoolFalse == test_17) {
      }
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_18 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mAddAssignOperatorArguments (HERE).reader_length (SOURCE_FILE ("typeDump.html.gTemplate", 153)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        ...
        if (enumerator_1275.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          ...
          while (enumerator_6552.hasCurrentObject ()) {
            ...
            if (kBoolTrue == test_19) {
              result << enumerator_6552.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 156)).stringValue () ;
            }else if (kBoolFalse == test_19) {
            }
            result << "</span>" ;
            result << function_linkForType (enumerator_6552.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 157)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 157)).stringValue () ;
            result << " " ;
      ...
      const enumGalgasBool test_20 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mEnumerationDescriptor (HERE).reader_length (SOURCE_FILE ("typeDump.html.gTemplate", 161)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1275.current_mEnumerationDescriptor (HERE).isValid ()) {
          ...
          while (enumerator_6919.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6919.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 164)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 164)).stringValue () ;
            result << " " ;
      ...
      const enumGalgasBool test_21 = enumerator_1275.current_mTypeForEnumeratedElement (HERE).reader_isNull (SOURCE_FILE ("typeDump.html.gTemplate", 168)).operator_not (SOURCE_FILE ("typeDump.html.gTemplate", 168)).boolEnum () ;
      if (kBoolTrue == test_21) {
        result << "<tr class=\"result_line\"><td><b>for</b> enumeration type</td><td>" ;
        result << function_linkForType (enumerator_1275.current_mTypeForEnumeratedElement (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 169)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 169)).stringValue () ;
        result << "</td></tr>" ;
      }else if (kBoolFalse == test_21) {
      }
      const enumGalgasBool test_22 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mConstructorMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 172)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_22) {
        ...
        if (enumerator_1275.current_mConstructorMap (HERE).isValid ()) {
          ...
          while (enumerator_7350.hasCurrentObject ()) {
            ...
            if (enumerator_7350.current_mArgumentTypeList (HERE).isValid ()) {
              ...
              while (enumerator_7423.hasCurrentObject ()) {
                ...
                if (kBoolTrue == test_23) {
                  result << enumerator_7423.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)).stringValue () ;
                }else if (kBoolFalse == test_23) {
                }
                result << function_linkForType (enumerator_7423.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 179)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 179)).stringValue () ;
                result << "</span> " ;
            ...
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7350.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 181)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 181)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_24 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mReaderMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 185)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_24) {
        ...
        if (enumerator_1275.current_mReaderMap (HERE).isValid ()) {
          ...
          while (enumerator_7856.hasCurrentObject ()) {
            ...
            if (enumerator_7856.current_mArgumentTypeList (HERE).isValid ()) {
              ...
              while (enumerator_8260.hasCurrentObject ()) {
                ...
                if (kBoolTrue == test_25) {
                  result << enumerator_8260.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 203)).stringValue () ;
                }else if (kBoolFalse == test_25) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_8260.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 204)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 204)).stringValue () ;
                result << " " ;
            ...
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7856.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 206)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 206)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_26 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 211)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
            ...
            if (enumerator_8723.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_9124.hasCurrentObject ()) {
                ...
                if (kBoolTrue == test_27) {
                  result << enumerator_9124.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 235)).stringValue () ;
                }else if (kBoolFalse == test_27) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_9124.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 236)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 236)).stringValue () ;
                result << " " ;
      ...
      const enumGalgasBool test_28 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mModifierMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 243)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
            ...
            if (enumerator_9798.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_10199.hasCurrentObject ()) {
                ...
                if (kBoolTrue == test_29) {
                  result << enumerator_10199.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 267)).stringValue () ;
                }else if (kBoolFalse == test_29) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_10199.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 268)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 268)).stringValue () ;
                result << " " ;
      ...
      const enumGalgasBool test_30 = GALGAS_bool (kIsStrictSup, enumerator_1275.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 275)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
            ...
            if (enumerator_10882.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_10966.hasCurrentObject ()) {
                ...
                if (kBoolTrue == test_31) {
                  result << enumerator_10966.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 287)).stringValue () ;
                }else if (kBoolFalse == test_31) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_10966.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 288)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 288)).stringValue () ;
                result << " " ;
