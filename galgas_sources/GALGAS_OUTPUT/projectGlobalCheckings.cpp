...
GALGAS_string function_outputDirectory (const GALGAS_lstring & constinArgument_inSourceFile,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inSourceFile.mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (365)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result_outOuputDirectory = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (366)) ;
    result_outOuputDirectory.dotAssign_operation (GALGAS_string ("/GALGAS_OUTPUT") COMMA_SOURCE_FILE_AT_LINE (367)) ;
...
void routine_checkCategoryModifierDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (383)) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_20453 (var_descendantClasses, kEnumeration_up) ;
  while (enumerator_20453.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_20453.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
    GALGAS_lstringlist var_overridingMethods = constinArgument_inOverridingCategoryMethodListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (386)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_20687 (var_overridingMethods, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (388)).isValidAndTrue () ;
    if (enumerator_20687.hasCurrentObject () && bool_0) {
      while (enumerator_20687.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (389)).objectCompare (enumerator_20687.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (389)))) ;
        enumerator_20687.gotoNextObject () ;
        if (enumerator_20687.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (388)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (391)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_20453.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (392)).operator_not (SOURCE_FILE_AT_LINE (392)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryModifierDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (395)), constinArgument_inAbstractCategoryModifierName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryMethodListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
        }
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category method '").operator_concat (constinArgument_inAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (402)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (402)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (402)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (403)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string ("' does not implement this method") COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (402)) ;
      }
    }
...
void routine_checkCategoryMethodDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (420)) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_22051 (var_descendantClasses, kEnumeration_up) ;
  while (enumerator_22051.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_22051.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) ;
    GALGAS_lstringlist var_overridingMethods = constinArgument_inOverridingCategoryMethodListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_22285 (var_overridingMethods, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (425)).isValidAndTrue () ;
    if (enumerator_22285.hasCurrentObject () && bool_0) {
      while (enumerator_22285.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (426)).objectCompare (enumerator_22285.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (426)))) ;
        enumerator_22285.gotoNextObject () ;
        if (enumerator_22285.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (425)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (428)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_22051.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (429)).operator_not (SOURCE_FILE_AT_LINE (429)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryMethodDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (432)), constinArgument_inAbstractCategoryMethodName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryMethodListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
        }
      }else if (kBoolFalse == test_2) {
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category method '").operator_concat (constinArgument_inAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (439)) COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (439)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (GALGAS_string ("' does not implement this method") COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (439)) ;
      }
    }
...
void routine_checkCategoryReaderDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (457)) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_23639 (var_descendantClasses, kEnumeration_up) ;
  while (enumerator_23639.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_23639.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
    GALGAS_lstringlist var_overridingReaders = constinArgument_inOverridingCategoryReaderListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (460)) COMMA_SOURCE_FILE_AT_LINE (460)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_23867 (var_overridingReaders, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (462)).isValidAndTrue () ;
    if (enumerator_23867.hasCurrentObject () && bool_0) {
      while (enumerator_23867.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (463)).objectCompare (enumerator_23867.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (463)))) ;
        enumerator_23867.gotoNextObject () ;
        if (enumerator_23867.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (462)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (465)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_23639.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (466)).operator_not (SOURCE_FILE_AT_LINE (466)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryReaderDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (469)), constinArgument_inAbstractCategoryReaderName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryReaderListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
        }
      }else if (kBoolFalse == test_2) {
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category reader '").operator_concat (constinArgument_inAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (477)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string ("' does not implement this reader") COMMA_SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
      }
    }
...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_semanticDeclarationListAST var_semanticDeclarationList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (491)) ;
  {
  routine_appendPredefinedTypesASTs (var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (493)) ;
  }
  cEnumerator_parsedSemanticsComponentMap enumerator_25202 (constinArgument_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (SOURCE_FILE_AT_LINE (495)), kEnumeration_up) ;
  while (enumerator_25202.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25202.current_mSemanticComponentRoot (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)) ;
    enumerator_25202.gotoNextObject () ;
  }
  cEnumerator_parsedSyntaxComponentMap enumerator_25366 (constinArgument_inParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (498)), kEnumeration_up) ;
  while (enumerator_25366.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25366.current_mSyntaxComponentRoot (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (499)) COMMA_SOURCE_FILE_AT_LINE (499)) ;
    enumerator_25366.gotoNextObject () ;
  }
  cEnumerator_parsedProgramComponentMap enumerator_25529 (constinArgument_inParsedComponentStruct.reader_mParsedProgramComponentMap (SOURCE_FILE_AT_LINE (501)), kEnumeration_up) ;
  while (enumerator_25529.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25529.current_mProgramComponentAST (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502)) ;
    enumerator_25529.gotoNextObject () ;
  }
  GALGAS_semanticContext var_semanticContext ;
  {
  routine_buildSemanticContext (GALGAS_string::makeEmptyString (), var_semanticDeclarationList, constinArgument_inEndOfSourceFile, var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (505)) ;
  }
  GALGAS_descendantClassListMap var_descendantClassListMap = GALGAS_descendantClassListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (513)) ;
  cEnumerator_unifiedTypeMap enumerator_25989 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
  while (enumerator_25989.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_25989.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (515)).operator_not (SOURCE_FILE_AT_LINE (515)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_descendantClassListMap.addAssign_operation (enumerator_25989.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (517)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (var_semanticContext.mAttribute_mTypeMap, enumerator_25989.current_lkey (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (518)) COMMA_SOURCE_FILE_AT_LINE (516)) ;
    }
    enumerator_25989.gotoNextObject () ;
  }
  GALGAS_genericCategoryMethodListMap var_abstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (523)) ;
  GALGAS_genericCategoryMethodListMap var_categoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (524)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (525)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (526)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (527)) ;
  GALGAS_genericCategoryMethodListMap var_categoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (528)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (529)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (530)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (531)) ;
  GALGAS_genericCategoryMethodListMap var_categoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (532)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (533)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (534)) ;
  cEnumerator_semanticDeclarationListAST enumerator_27191 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_27191.hasCurrentObject ()) {
    callCategoryMethod_buildCategoryListMaps ((const cPtr_semanticDeclarationAST *) enumerator_27191.current_mSemanticDeclaration (HERE).ptr (), var_abstractCategoryModifierListMap, var_categoryModifierListMap, var_overridingCategoryModifierListMap, var_overridingAbstractCategoryModifierListMap, var_abstractCategoryMethodListMap, var_categoryMethodListMap, var_overridingCategoryMethodListMap, var_overridingAbstractCategoryMethodListMap, var_abstractCategoryReaderListMap, var_categoryReaderListMap, var_overridingCategoryReaderListMap, var_overridingAbstractCategoryReaderListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (536)) ;
    enumerator_27191.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (552)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    cEnumerator_genericCategoryMethodListMap enumerator_27918 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_27918.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (555)) ;
      cEnumerator_lstringlist enumerator_28019 (enumerator_27918.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28019.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28019.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
        }
        enumerator_28019.gotoNextObject () ;
      }
      enumerator_27918.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28221 (var_categoryModifierListMap, kEnumeration_up) ;
    while (enumerator_28221.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (562)) ;
      cEnumerator_lstringlist enumerator_28322 (enumerator_28221.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28322.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28322.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
        }
        enumerator_28322.gotoNextObject () ;
      }
      enumerator_28221.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28540 (var_overridingCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_28540.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (569)) ;
      cEnumerator_lstringlist enumerator_28641 (enumerator_28540.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28641.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28641.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
        }
        enumerator_28641.gotoNextObject () ;
      }
      enumerator_28540.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28874 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_28874.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (576)) ;
      cEnumerator_lstringlist enumerator_28975 (enumerator_28874.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28975.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28975.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
        }
        enumerator_28975.gotoNextObject () ;
      }
      enumerator_28874.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_29237 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_29237.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_29260 (enumerator_29237.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_29260.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29237.current_key (HERE), enumerator_29237.current_key (HERE), enumerator_29260.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
        }
        enumerator_29260.gotoNextObject () ;
      }
      enumerator_29237.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_29711 (var_overridingAbstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_29711.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_29734 (enumerator_29711.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_29734.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29711.current_key (HERE), enumerator_29711.current_key (HERE), enumerator_29734.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
        }
        enumerator_29734.gotoNextObject () ;
      }
      enumerator_29711.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30112 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30112.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (609)) ;
      cEnumerator_lstringlist enumerator_30209 (enumerator_30112.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30209.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30209.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (611)) ;
        }
        enumerator_30209.gotoNextObject () ;
      }
      enumerator_30112.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30405 (var_categoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30405.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (616)) ;
      cEnumerator_lstringlist enumerator_30502 (enumerator_30405.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30502.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30502.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
        }
        enumerator_30502.gotoNextObject () ;
      }
      enumerator_30405.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30714 (var_overridingCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30714.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (623)) ;
      cEnumerator_lstringlist enumerator_30811 (enumerator_30714.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30811.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30811.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
        }
        enumerator_30811.gotoNextObject () ;
      }
      enumerator_30714.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31040 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31040.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (630)) ;
      cEnumerator_lstringlist enumerator_31137 (enumerator_31040.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31137.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_31137.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (632)) ;
        }
        enumerator_31137.gotoNextObject () ;
      }
      enumerator_31040.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31391 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31391.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_31414 (enumerator_31391.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31414.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31391.current_key (HERE), enumerator_31391.current_key (HERE), enumerator_31414.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (638)) ;
        }
        enumerator_31414.gotoNextObject () ;
      }
      enumerator_31391.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31844 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31844.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_31867 (enumerator_31844.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31867.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31844.current_key (HERE), enumerator_31844.current_key (HERE), enumerator_31867.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (651)) ;
        }
        enumerator_31867.gotoNextObject () ;
      }
      enumerator_31844.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_32395 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_32395.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (666)) ;
      cEnumerator_lstringlist enumerator_32492 (enumerator_32395.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_32492.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32492.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) ;
        }
        enumerator_32492.gotoNextObject () ;
      }
      enumerator_32395.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_32688 (var_categoryReaderListMap, kEnumeration_up) ;
    while (enumerator_32688.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (673)) ;
      cEnumerator_lstringlist enumerator_32785 (enumerator_32688.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_32785.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32785.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
        }
        enumerator_32785.gotoNextObject () ;
      }
      enumerator_32688.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_32997 (var_overridingCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_32997.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (680)) ;
      cEnumerator_lstringlist enumerator_33094 (enumerator_32997.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33094.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_33094.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (682)) ;
        }
        enumerator_33094.gotoNextObject () ;
      }
      enumerator_32997.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_33321 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_33321.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_33344 (enumerator_33321.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33344.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33321.current_key (HERE), enumerator_33321.current_key (HERE), enumerator_33344.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (688)) ;
        }
        enumerator_33344.gotoNextObject () ;
      }
      enumerator_33321.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_33747 (var_overridingAbstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_33747.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_33770 (enumerator_33747.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33770.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33747.current_key (HERE), enumerator_33747.current_key (HERE), enumerator_33770.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (701)) ;
        }
  ...
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".html") COMMA_SOURCE_FILE_AT_LINE (713)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_stringset var_firstLetterSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (715)) ;
    cEnumerator_unifiedTypeMap enumerator_34316 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_34316.hasCurrentObject ()) {
      var_firstLetterSet.addAssign_operation (enumerator_34316.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (717)).reader_string (SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
      enumerator_34316.gotoNextObject () ;
    }
    ...
    cEnumerator_unifiedTypeMap enumerator_34521 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_34521.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter.objectCompare (enumerator_34521.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (722)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_currentFirstLetter = enumerator_34521.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
        var_tableOfTypeString.dotAssign_operation (GALGAS_string ("<br><a name=\"").operator_concat (var_currentFirstLetter.reader_uint (SOURCE_FILE_AT_LINE (724)).reader_string (SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (GALGAS_string ("\"><b>") COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (var_currentFirstLetter.reader_string (SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (GALGAS_string ("</b></a><br>") COMMA_SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (724)) ;
      }
      var_tableOfTypeString.dotAssign_operation (function_linkForType (enumerator_34521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (726)).operator_concat (GALGAS_string ("<br>") COMMA_SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)) ;
      enumerator_34521.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFilePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (729)), var_semanticContext.mAttribute_mTypeMap, var_firstLetterSet, var_tableOfTypeString COMMA_SOURCE_FILE_AT_LINE (728))) ;
    GALGAS_bool joker_35206_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_35206_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (734)) ;
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
    }
  }
}
...
GALGAS_string function_linkForType (const GALGAS_string & constinArgument_inTypeName,
  ...
  result_outResult = GALGAS_string ("<a class=\"header_link\" href=\"#").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (760)).operator_concat (GALGAS_string ("\">@") COMMA_SOURCE_FILE_AT_LINE (760)).operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (760)).operator_concat (GALGAS_string ("</a>") COMMA_SOURCE_FILE_AT_LINE (760)) ;
//---
