...
GALGAS_string filewrapperTemplate_typeDumpGenerationTemplate_typeDump (C_Compiler * inCompiler,
  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1239.hasCurrentObject ()) {
      ...
      const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_plusEqualOperatorWithExpression (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 142)) COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 142)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      if (kBoolTrue == test_19) {
        ...
        GALGAS_uint index_6808_ (0) ;
        if (enumerator_1239.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_functionSignature enumerator_6808 (enumerator_1239.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6808.hasCurrentObject ()) {
            result << "\?" ;
            const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_6808.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_20) {
              result << enumerator_6808.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 155)).stringValue () ;
            }else if (kBoolFalse == test_20) {
            }
            result << function_linkForType (enumerator_6808.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 155)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 155)).stringValue () ;
            result << " " ;
            result << enumerator_6808.current_mFormalArgumentName (HERE).stringValue () ;
            result << "<br><br>" ;
            index_6808_.increment () ;
      ...
      const enumGalgasBool test_21 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mEnumerationDescriptor (HERE).reader_length (SOURCE_FILE ("typeDump.html.gTemplate", 159)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_21) {
        ...
        if (enumerator_1239.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_7146 (enumerator_1239.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_7146.hasCurrentObject ()) {
            result << function_linkForType (enumerator_7146.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 162)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 162)).stringValue () ;
            result << " " ;
            result << enumerator_7146.current_mEnumerationName (HERE).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_22 = enumerator_1239.current_mTypeForEnumeratedElement (HERE).reader_isNull (SOURCE_FILE ("typeDump.html.gTemplate", 166)).operator_not (SOURCE_FILE ("typeDump.html.gTemplate", 166)).boolEnum () ;
      ...
      const enumGalgasBool test_23 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mConstructorMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 170)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_23) {
        ...
        if (enumerator_1239.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7579 (enumerator_1239.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7579.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7579.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7651_ (0) ;
            if (enumerator_7579.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_functionSignature enumerator_7651 (enumerator_7579.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7651.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                const enumGalgasBool test_24 = GALGAS_bool (kIsNotEqual, enumerator_7651.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_24) {
                  result << enumerator_7651.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 176)).stringValue () ;
                }else if (kBoolFalse == test_24) {
                }
                result << function_linkForType (enumerator_7651.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 176)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 176)).stringValue () ;
                result << " " ;
                result << enumerator_7651.current_mFormalArgumentName (HERE).stringValue () ;
                index_7651_.increment () ;
                enumerator_7651.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7579.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_25 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mReaderMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 182)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_25) {
        ...
        if (enumerator_1239.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_8044 (enumerator_1239.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_8044.hasCurrentObject ()) {
            switch (enumerator_8044.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_8044.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>getter</b> " ;
            result << enumerator_8044.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8447_ (0) ;
            if (enumerator_8044.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_functionSignature enumerator_8447 (enumerator_8044.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8447.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                const enumGalgasBool test_26 = GALGAS_bool (kIsNotEqual, enumerator_8447.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_26) {
                  result << enumerator_8447.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)).stringValue () ;
                }else if (kBoolFalse == test_26) {
                }
                result << function_linkForType (enumerator_8447.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)).stringValue () ;
                result << " " ;
                result << enumerator_8447.current_mFormalArgumentName (HERE).stringValue () ;
                index_8447_.increment () ;
                enumerator_8447.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_8044.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 202)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 202)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_27 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 207)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_27) {
        result << "<tr class=\"result_line\"><td>Methods</td><td>" ;
        GALGAS_uint index_8870_ (0) ;
        if (enumerator_1239.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8870 (enumerator_1239.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8870.hasCurrentObject ()) {
            switch (enumerator_8870.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8870.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8870.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9270_ (0) ;
            if (enumerator_8870.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9270 (enumerator_8870.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9270.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9270.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_9270.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)).stringValue () ;
                result << " " ;
                result << enumerator_9270.current_mFormalArgumentName (HERE).stringValue () ;
                index_9270_.increment () ;
                enumerator_9270.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_8870_.increment () ;
      ...
      const enumGalgasBool test_28 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mModifierMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 238)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_28) {
        ...
        if (enumerator_1239.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9761 (enumerator_1239.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9761.hasCurrentObject ()) {
            switch (enumerator_9761.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9761.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>setter</b> " ;
            result << enumerator_9761.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10161_ (0) ;
            if (enumerator_9761.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10161 (enumerator_9761.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10161.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10161.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10161.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)).stringValue () ;
                result << " " ;
                result << enumerator_10161.current_mFormalArgumentName (HERE).stringValue () ;
      ...
      const enumGalgasBool test_29 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE ("typeDump.html.gTemplate", 269)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_29) {
        ...
        if (enumerator_1239.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10661 (enumerator_1239.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10661.hasCurrentObject ()) {
            result << "<b>proc</b> @" ;
            result << enumerator_1239.current_lkey (HERE).mAttribute_string.stringValue () ;
            result << " " ;
            result << enumerator_10661.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10745_ (0) ;
            if (enumerator_10661.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10745 (enumerator_10661.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10745.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10745.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10745.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)).stringValue () ;
                result << " " ;
                result << enumerator_10745.current_mFormalArgumentName (HERE).stringValue () ;
                index_10745_.increment () ;
