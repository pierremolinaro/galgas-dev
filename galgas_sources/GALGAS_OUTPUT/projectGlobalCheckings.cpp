...
GALGAS_string function_outputDirectory (const GALGAS_lstring & constinArgument_inSourceFile,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inSourceFile.mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (366)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result_outOuputDirectory = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (367)) ;
    result_outOuputDirectory.dotAssign_operation (GALGAS_string ("/GALGAS_OUTPUT") COMMA_SOURCE_FILE_AT_LINE (368)) ;
...
void routine_checkCategoryModifierDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (384)) ;
  ...
  while (enumerator_20460.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_20460.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (386)) ;
    GALGAS_lstringlist var_overridingMethods = constinArgument_inOverridingCategoryMethodListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (387)) COMMA_SOURCE_FILE_AT_LINE (387)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_20694 (var_overridingMethods, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (389)).isValidAndTrue () ;
    if (enumerator_20694.hasCurrentObject () && bool_0) {
      while (enumerator_20694.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (390)).objectCompare (enumerator_20694.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (390)))) ;
        enumerator_20694.gotoNextObject () ;
        if (enumerator_20694.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (389)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (392)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_20460.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (393)).operator_not (SOURCE_FILE_AT_LINE (393)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryModifierDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (396)), constinArgument_inAbstractCategoryModifierName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryMethodListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) ;
        }
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category method '").operator_concat (constinArgument_inAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (403)) COMMA_SOURCE_FILE_AT_LINE (403)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (403)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (403)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string ("' does not implement this method") COMMA_SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (403)) ;
      }
    }
...
void routine_checkCategoryMethodDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (421)) ;
  ...
  while (enumerator_22052.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_22052.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (423)) ;
    GALGAS_lstringlist var_overridingMethods = constinArgument_inOverridingCategoryMethodListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (424)) COMMA_SOURCE_FILE_AT_LINE (424)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_22286 (var_overridingMethods, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (426)).isValidAndTrue () ;
    if (enumerator_22286.hasCurrentObject () && bool_0) {
      while (enumerator_22286.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (427)).objectCompare (enumerator_22286.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (427)))) ;
        enumerator_22286.gotoNextObject () ;
        if (enumerator_22286.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (426)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (429)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_22052.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (430)).operator_not (SOURCE_FILE_AT_LINE (430)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryMethodDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (433)), constinArgument_inAbstractCategoryMethodName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryMethodListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (431)) ;
        }
      }else if (kBoolFalse == test_2) {
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category method '").operator_concat (constinArgument_inAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (441)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (442)) COMMA_SOURCE_FILE_AT_LINE (442)).operator_concat (GALGAS_string ("' does not implement this method") COMMA_SOURCE_FILE_AT_LINE (442)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
      }
    }
...
void routine_checkCategoryReaderDefinitionForClass (const GALGAS_string constinArgument_inClassNameForErrorSignaling,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList var_descendantClasses = constinArgument_inDescendantClassListMap.reader_listForKey (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (458)) ;
  ...
  while (enumerator_23634.hasCurrentObject ()) {
    GALGAS_lstring var_descendantClassName = enumerator_23634.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
    GALGAS_lstringlist var_overridingReaders = constinArgument_inOverridingCategoryReaderListMap.reader_listForKey (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (461)) COMMA_SOURCE_FILE_AT_LINE (461)) ;
    GALGAS_bool var_found = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_23862 (var_overridingReaders, kEnumeration_up) ;
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (463)).isValidAndTrue () ;
    if (enumerator_23862.hasCurrentObject () && bool_0) {
      while (enumerator_23862.hasCurrentObject () && bool_0) {
        var_found = GALGAS_bool (kIsEqual, constinArgument_inAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (464)).objectCompare (enumerator_23862.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (464)))) ;
        enumerator_23862.gotoNextObject () ;
        if (enumerator_23862.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (463)).isValidAndTrue () ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (466)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = enumerator_23634.current_mType (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (467)).operator_not (SOURCE_FILE_AT_LINE (467)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        routine_checkCategoryReaderDefinitionForClass (constinArgument_inClassNameForErrorSignaling, var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (470)), constinArgument_inAbstractCategoryReaderName, constinArgument_inDescendantClassListMap, constinArgument_inOverridingCategoryReaderListMap, constinArgument_inUnifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
        }
      }else if (kBoolFalse == test_2) {
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("an abstract category reader '").operator_concat (constinArgument_inAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (477)) COMMA_SOURCE_FILE_AT_LINE (477)).operator_concat (GALGAS_string ("' is defined for abstract class '@") COMMA_SOURCE_FILE_AT_LINE (477)).operator_concat (constinArgument_inClassNameForErrorSignaling COMMA_SOURCE_FILE_AT_LINE (477)).operator_concat (GALGAS_string ("', but concrete descendant class '@") COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (var_descendantClassName.reader_string (SOURCE_FILE_AT_LINE (479)) COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (GALGAS_string ("' does not implement this reader") COMMA_SOURCE_FILE_AT_LINE (479)) COMMA_SOURCE_FILE_AT_LINE (477)) ;
      }
    }
...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  cEnumerator_parsedSemanticsComponentMap enumerator_25197 (constinArgument_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (SOURCE_FILE_AT_LINE (496)), kEnumeration_up) ;
  while (enumerator_25197.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25197.current_mSemanticComponentRoot (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (497)) COMMA_SOURCE_FILE_AT_LINE (497)) ;
    enumerator_25197.gotoNextObject () ;
  }
  cEnumerator_parsedSyntaxComponentMap enumerator_25361 (constinArgument_inParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (499)), kEnumeration_up) ;
  while (enumerator_25361.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25361.current_mSyntaxComponentRoot (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (500)) COMMA_SOURCE_FILE_AT_LINE (500)) ;
    enumerator_25361.gotoNextObject () ;
  }
  cEnumerator_parsedProgramComponentMap enumerator_25524 (constinArgument_inParsedComponentStruct.reader_mParsedProgramComponentMap (SOURCE_FILE_AT_LINE (502)), kEnumeration_up) ;
  while (enumerator_25524.hasCurrentObject ()) {
    var_semanticDeclarationList.dotAssign_operation (enumerator_25524.current_mProgramComponentAST (HERE).reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)) ;
    enumerator_25524.gotoNextObject () ;
  }
  GALGAS_semanticContext var_semanticContext ;
  {
  routine_buildSemanticContext (GALGAS_string::makeEmptyString (), var_semanticDeclarationList, constinArgument_inEndOfSourceFile, var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
  }
  GALGAS_descendantClassListMap var_descendantClassListMap = GALGAS_descendantClassListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (514)) ;
  ...
  while (enumerator_25984.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_25984.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (516)).operator_not (SOURCE_FILE_AT_LINE (516)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_descendantClassListMap.addAssign_operation (enumerator_25984.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (518)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (var_semanticContext.mAttribute_mTypeMap, enumerator_25984.current_lkey (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (519)) COMMA_SOURCE_FILE_AT_LINE (517)) ;
    }
    enumerator_25984.gotoNextObject () ;
  }
  GALGAS_genericCategoryMethodListMap var_abstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (524)) ;
  GALGAS_genericCategoryMethodListMap var_categoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (525)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (526)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (527)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (528)) ;
  GALGAS_genericCategoryMethodListMap var_categoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (529)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (530)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (531)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (532)) ;
  GALGAS_genericCategoryMethodListMap var_categoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (533)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (534)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (535)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_27913.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (556)) ;
      ...
      while (enumerator_28014.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28014.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
        }
    ...
    while (enumerator_28216.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (563)) ;
      ...
      while (enumerator_28317.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28317.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
        }
    ...
    while (enumerator_28535.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (570)) ;
      ...
      while (enumerator_28636.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28636.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (572)) ;
        }
    ...
    while (enumerator_28869.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (577)) ;
      ...
      while (enumerator_28970.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28970.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
        }
    ...
    while (enumerator_29232.hasCurrentObject ()) {
      ...
      while (enumerator_29255.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29232.current_key (HERE), enumerator_29232.current_key (HERE), enumerator_29255.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (585)) ;
        }
    ...
    while (enumerator_29706.hasCurrentObject ()) {
      ...
      while (enumerator_29729.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29706.current_key (HERE), enumerator_29706.current_key (HERE), enumerator_29729.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
    ...
    while (enumerator_30107.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (610)) ;
      ...
      while (enumerator_30204.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30204.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (612)) ;
        }
    ...
    while (enumerator_30400.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (617)) ;
      ...
      while (enumerator_30497.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30497.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) ;
        }
    ...
    while (enumerator_30709.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (624)) ;
      ...
      while (enumerator_30806.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30806.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (626)) ;
        }
    ...
    while (enumerator_31035.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (631)) ;
      ...
      while (enumerator_31132.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_31132.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (633)) ;
        }
    ...
    while (enumerator_31386.hasCurrentObject ()) {
      ...
      while (enumerator_31409.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31386.current_key (HERE), enumerator_31386.current_key (HERE), enumerator_31409.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (639)) ;
        }
    ...
    while (enumerator_31839.hasCurrentObject ()) {
      ...
      while (enumerator_31862.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31839.current_key (HERE), enumerator_31839.current_key (HERE), enumerator_31862.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (652)) ;
        }
    ...
    while (enumerator_32390.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (667)) ;
      ...
      while (enumerator_32487.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32487.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) ;
        }
    ...
    while (enumerator_32683.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (674)) ;
      ...
      while (enumerator_32780.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32780.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (676)) ;
        }
    ...
    while (enumerator_32992.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (681)) ;
      ...
      while (enumerator_33089.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_33089.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
        }
    ...
    while (enumerator_33316.hasCurrentObject ()) {
      ...
      while (enumerator_33339.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33316.current_key (HERE), enumerator_33316.current_key (HERE), enumerator_33339.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (689)) ;
        }
    ...
    while (enumerator_33742.hasCurrentObject ()) {
      ...
      while (enumerator_33765.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33742.current_key (HERE), enumerator_33742.current_key (HERE), enumerator_33765.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
        }
  ...
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".html") COMMA_SOURCE_FILE_AT_LINE (714)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_stringset var_firstLetterSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (716)) ;
    ...
    while (enumerator_34311.hasCurrentObject ()) {
      var_firstLetterSet.addAssign_operation (enumerator_34311.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (718)).reader_string (SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)) ;
    ...
    while (enumerator_34516.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter.objectCompare (enumerator_34516.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (723)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_currentFirstLetter = enumerator_34516.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (724)) ;
        var_tableOfTypeString.dotAssign_operation (GALGAS_string ("<br><a name=\"").operator_concat (var_currentFirstLetter.reader_uint (SOURCE_FILE_AT_LINE (725)).reader_string (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string ("\"><b>") COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (var_currentFirstLetter.reader_string (SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)).operator_concat (GALGAS_string ("</b></a><br>") COMMA_SOURCE_FILE_AT_LINE (725)) COMMA_SOURCE_FILE_AT_LINE (725)) ;
      }
      var_tableOfTypeString.dotAssign_operation (function_linkForType (enumerator_34516.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (727)).operator_concat (GALGAS_string ("<br>") COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)) ;
      enumerator_34516.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFilePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (730)), var_semanticContext.mAttribute_mTypeMap, var_firstLetterSet, var_tableOfTypeString COMMA_SOURCE_FILE_AT_LINE (729))) ;
    GALGAS_bool joker_35201_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_35201_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (735)) ;
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
    }
  }
}
...
void routine_performGalgas_33_ProjectGlobalCheckings (const GALGAS_semanticContext constinArgument_inSemanticContext,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_descendantClassListMap var_descendantClassListMap = GALGAS_descendantClassListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (770)) ;
  cEnumerator_unifiedTypeMap enumerator_36635 (constinArgument_inSemanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
  while (enumerator_36635.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_36635.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (772)).operator_not (SOURCE_FILE_AT_LINE (772)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_descendantClassListMap.addAssign_operation (enumerator_36635.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (774)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_36635.current_lkey (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (775)) COMMA_SOURCE_FILE_AT_LINE (773)) ;
    }
    enumerator_36635.gotoNextObject () ;
  }
  GALGAS_genericCategoryMethodListMap var_abstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (780)) ;
  GALGAS_genericCategoryMethodListMap var_categoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (781)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (782)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (783)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (784)) ;
  GALGAS_genericCategoryMethodListMap var_categoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (785)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (786)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (787)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (788)) ;
  GALGAS_genericCategoryMethodListMap var_categoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (789)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (790)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (791)) ;
  cEnumerator_semanticDeclarationListAST enumerator_37841 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_37841.hasCurrentObject ()) {
    callCategoryMethod_buildCategoryListMaps ((const cPtr_semanticDeclarationAST *) enumerator_37841.current_mSemanticDeclaration (HERE).ptr (), var_abstractCategoryModifierListMap, var_categoryModifierListMap, var_overridingCategoryModifierListMap, var_overridingAbstractCategoryModifierListMap, var_abstractCategoryMethodListMap, var_categoryMethodListMap, var_overridingCategoryMethodListMap, var_overridingAbstractCategoryMethodListMap, var_abstractCategoryReaderListMap, var_categoryReaderListMap, var_overridingCategoryReaderListMap, var_overridingAbstractCategoryReaderListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) ;
    enumerator_37841.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (809)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    cEnumerator_genericCategoryMethodListMap enumerator_38568 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_38568.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (812)) ;
      cEnumerator_lstringlist enumerator_38669 (enumerator_38568.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_38669.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_38669.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (814)) ;
        }
        enumerator_38669.gotoNextObject () ;
      }
      enumerator_38568.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_38871 (var_categoryModifierListMap, kEnumeration_up) ;
    while (enumerator_38871.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (819)) ;
      cEnumerator_lstringlist enumerator_38972 (enumerator_38871.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_38972.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_38972.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (821)) ;
        }
        enumerator_38972.gotoNextObject () ;
      }
      enumerator_38871.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_39190 (var_overridingCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_39190.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (826)) ;
      cEnumerator_lstringlist enumerator_39291 (enumerator_39190.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_39291.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_39291.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
        }
        enumerator_39291.gotoNextObject () ;
      }
      enumerator_39190.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_39524 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_39524.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (833)) ;
      cEnumerator_lstringlist enumerator_39625 (enumerator_39524.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_39625.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_39625.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
        }
        enumerator_39625.gotoNextObject () ;
      }
      enumerator_39524.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_39887 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_39887.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_39910 (enumerator_39887.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_39910.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_39887.current_key (HERE), enumerator_39887.current_key (HERE), enumerator_39910.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) ;
        }
        enumerator_39910.gotoNextObject () ;
      }
      enumerator_39887.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_40363 (var_overridingAbstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_40363.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_40386 (enumerator_40363.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_40386.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_40363.current_key (HERE), enumerator_40363.current_key (HERE), enumerator_40386.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) ;
        }
        enumerator_40386.gotoNextObject () ;
      }
      enumerator_40363.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_40766 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_40766.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (866)) ;
      cEnumerator_lstringlist enumerator_40863 (enumerator_40766.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_40863.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_40863.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (868)) ;
        }
        enumerator_40863.gotoNextObject () ;
      }
      enumerator_40766.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_41059 (var_categoryMethodListMap, kEnumeration_up) ;
    while (enumerator_41059.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (873)) ;
      cEnumerator_lstringlist enumerator_41156 (enumerator_41059.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_41156.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41156.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (875)) ;
        }
        enumerator_41156.gotoNextObject () ;
      }
      enumerator_41059.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_41368 (var_overridingCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_41368.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (880)) ;
      cEnumerator_lstringlist enumerator_41465 (enumerator_41368.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_41465.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41465.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
        }
        enumerator_41465.gotoNextObject () ;
      }
      enumerator_41368.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_41694 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_41694.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (887)) ;
      cEnumerator_lstringlist enumerator_41791 (enumerator_41694.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_41791.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41791.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
        }
        enumerator_41791.gotoNextObject () ;
      }
      enumerator_41694.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_42045 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_42045.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_42068 (enumerator_42045.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_42068.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_42045.current_key (HERE), enumerator_42045.current_key (HERE), enumerator_42068.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (895)) ;
        }
        enumerator_42068.gotoNextObject () ;
      }
      enumerator_42045.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_42500 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_42500.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_42523 (enumerator_42500.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_42523.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_42500.current_key (HERE), enumerator_42500.current_key (HERE), enumerator_42523.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
        }
        enumerator_42523.gotoNextObject () ;
      }
      enumerator_42500.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_43053 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_43053.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (923)) ;
      cEnumerator_lstringlist enumerator_43150 (enumerator_43053.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_43150.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43150.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) ;
        }
        enumerator_43150.gotoNextObject () ;
      }
      enumerator_43053.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_43346 (var_categoryReaderListMap, kEnumeration_up) ;
    while (enumerator_43346.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (930)) ;
      cEnumerator_lstringlist enumerator_43443 (enumerator_43346.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_43443.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43443.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (932)) ;
        }
        enumerator_43443.gotoNextObject () ;
      }
      enumerator_43346.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_43655 (var_overridingCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_43655.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (937)) ;
      cEnumerator_lstringlist enumerator_43752 (enumerator_43655.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_43752.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43752.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
        }
        enumerator_43752.gotoNextObject () ;
      }
      enumerator_43655.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_43979 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_43979.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_44002 (enumerator_43979.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_44002.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_43979.current_key (HERE), enumerator_43979.current_key (HERE), enumerator_44002.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
        }
        enumerator_44002.gotoNextObject () ;
      }
      enumerator_43979.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_44407 (var_overridingAbstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_44407.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_44430 (enumerator_44407.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_44430.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_44407.current_key (HERE), enumerator_44407.current_key (HERE), enumerator_44430.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (958)) ;
        }
        enumerator_44430.gotoNextObject () ;
      }
      enumerator_44407.gotoNextObject () ;
    }
  }
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".html") COMMA_SOURCE_FILE_AT_LINE (970)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_stringset var_firstLetterSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (972)) ;
    cEnumerator_unifiedTypeMap enumerator_44980 (constinArgument_inSemanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_44980.hasCurrentObject ()) {
      var_firstLetterSet.addAssign_operation (enumerator_44980.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (974)).reader_string (SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (974)) ;
      enumerator_44980.gotoNextObject () ;
    }
    GALGAS_string var_tableOfTypeString = GALGAS_string::makeEmptyString () ;
    GALGAS_char var_currentFirstLetter = GALGAS_char (TO_UNICODE (32)) ;
    cEnumerator_unifiedTypeMap enumerator_45187 (constinArgument_inSemanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_45187.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter.objectCompare (enumerator_45187.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (979)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_currentFirstLetter = enumerator_45187.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (980)) ;
        var_tableOfTypeString.dotAssign_operation (GALGAS_string ("<br><a name=\"").operator_concat (var_currentFirstLetter.reader_uint (SOURCE_FILE_AT_LINE (981)).reader_string (SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)).operator_concat (GALGAS_string ("\"><b>") COMMA_SOURCE_FILE_AT_LINE (981)).operator_concat (var_currentFirstLetter.reader_string (SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)).operator_concat (GALGAS_string ("</b></a><br>") COMMA_SOURCE_FILE_AT_LINE (981)) COMMA_SOURCE_FILE_AT_LINE (981)) ;
      }
      var_tableOfTypeString.dotAssign_operation (function_linkForType (enumerator_45187.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)).operator_concat (GALGAS_string ("<br>") COMMA_SOURCE_FILE_AT_LINE (983)) COMMA_SOURCE_FILE_AT_LINE (983)) ;
      enumerator_45187.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFilePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (986)), constinArgument_inSemanticContext.mAttribute_mTypeMap, var_firstLetterSet, var_tableOfTypeString COMMA_SOURCE_FILE_AT_LINE (985))) ;
    GALGAS_bool joker_45874_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_45874_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (991)) ;
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (993)) ;
    }
  }
}
...
GALGAS_string filewrapperTemplate_typeDumpGenerationTemplate_typeDump (C_Compiler * inCompiler,
  ...
  if (in_FIRST_5F_LETTER_5F_SET.isValid ()) {
    ...
    while (enumerator_1033.hasCurrentObject ()) {
      ...
      result << enumerator_1033.current_key (HERE).reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (55)).reader_uint (SOURCE_FILE_AT_LINE (55)).reader_string (SOURCE_FILE_AT_LINE (55)).stringValue () ;
      result << "\">" ;
  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1239.hasCurrentObject ()) {
      ...
      result << "</a></td></tr>\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_0 = enumerator_1239.current_mIsConcrete (HERE).operator_not (SOURCE_FILE_AT_LINE (69)).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "abstract " ;
      }else if (kBoolFalse == test_0) {
      }
      ...
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_1 = enumerator_1239.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (84)).operator_not (SOURCE_FILE_AT_LINE (84)).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "<tr class=\"result_line\"><td>Superclass</td><td>" ;
        result << function_linkForType (enumerator_1239.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (85)), inCompiler COMMA_SOURCE_FILE_AT_LINE (85)).stringValue () ;
        result << "</td></tr>" ;
      ...
      result << "\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "addition: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
        result << " + " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "substraction: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
        result << " - " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "multiplication: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
        result << " * " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "division: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
        result << " / " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
      ...
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        result << "modulo: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << " <b>mod</b> " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
      ...
      const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        result << "left shift: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).stringValue () ;
        result << " &lt;&lt; " ;
        ...
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)).stringValue () ;
        result << " &gt;&gt; " ;
      ...
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_8) {
        result << "unary +: + " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_8) {
      }
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        result << "unary -: - " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_9) {
      }
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_10) {
        result << "bit wise negation: ~ " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_10) {
      }
      const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        result << "boolean and: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
        result << " &amp; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
      ...
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) COMMA_SOURCE_FILE_AT_LINE (120)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_12) {
        result << "inclusive or: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
        result << " | " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
      ...
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_13) {
        result << "exclusive or: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
        result << " ^ " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
      ...
      const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_14) {
        result << "boolean negation: <b>not</b> " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)).stringValue () ;
        result << "<br><br>" ;
      ...
      result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)).stringValue () ;
      result << " == " ;
      result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)).stringValue () ;
      result << " &rarr; " ;
      ...
      result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " != " ;
      result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " &rarr; " ;
      result << function_linkForType (GALGAS_string ("bool"), inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << "<br><br>" ;
      const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_15) {
        result << "lower than test: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << " &lt; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)).stringValue () ;
        result << " &lt;= " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).stringValue () ;
        result << " &gt; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)).stringValue () ;
        result << " &gt;= " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)).stringValue () ;
        result << " &rarr; " ;
      ...
      const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_16) {
        result << "concatenation: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
        result << " . " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
      ...
      const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_17) {
        result << "appending instruction: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)).stringValue () ;
        result << " .= " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)).stringValue () ;
        result << "<br><br>" ;
      }else if (kBoolFalse == test_17) {
      }
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_1239.current_mHandledOperatorFlags (HERE).operator_and (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_18) {
        result << "incrementation instruction: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)).stringValue () ;
        result << " ++<br><br>decrementation instruction: " ;
        result << function_linkForType (enumerator_1239.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)).stringValue () ;
        result << " --<br><br>" ;
      }else if (kBoolFalse == test_18) {
      }
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_19 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mAddAssignOperatorArguments (HERE).reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_19) {
        ...
        if (enumerator_1239.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          ...
          while (enumerator_6734.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6734.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (153)), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)).stringValue () ;
            result << " " ;
      ...
      const enumGalgasBool test_20 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mEnumerationDescriptor (HERE).reader_length (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1239.current_mEnumerationDescriptor (HERE).isValid ()) {
          ...
          while (enumerator_6984.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6984.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).stringValue () ;
            result << " " ;
      ...
      const enumGalgasBool test_21 = enumerator_1239.current_mTypeForEnumeratedElement (HERE).reader_isNull (SOURCE_FILE_AT_LINE (164)).operator_not (SOURCE_FILE_AT_LINE (164)).boolEnum () ;
      if (kBoolTrue == test_21) {
        result << "<tr class=\"result_line\"><td><b>for</b> enumeration type</td><td>" ;
        result << function_linkForType (enumerator_1239.current_mTypeForEnumeratedElement (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)), inCompiler COMMA_SOURCE_FILE_AT_LINE (165)).stringValue () ;
        result << "</td></tr>" ;
      }else if (kBoolFalse == test_21) {
      }
      const enumGalgasBool test_22 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mConstructorMap (HERE).reader_count (SOURCE_FILE_AT_LINE (168)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_7417.hasCurrentObject ()) {
            ...
            if (enumerator_7417.current_mArgumentTypeList (HERE).isValid ()) {
              ...
              while (enumerator_7489.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_7489.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (174)), inCompiler COMMA_SOURCE_FILE_AT_LINE (174)).stringValue () ;
                result << " " ;
            ...
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7417.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_23 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mReaderMap (HERE).reader_count (SOURCE_FILE_AT_LINE (180)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_7796.hasCurrentObject ()) {
            ...
            if (enumerator_7796.current_mArgumentTypeList (HERE).isValid ()) {
              ...
              while (enumerator_8198.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_8198.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).stringValue () ;
                result << " " ;
            ...
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7796.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_24 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_8536.hasCurrentObject ()) {
            ...
            if (enumerator_8536.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_8935.hasCurrentObject ()) {
                ...
                result << function_linkForType (enumerator_8935.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (229)), inCompiler COMMA_SOURCE_FILE_AT_LINE (229)).stringValue () ;
                result << " " ;
      ...
      const enumGalgasBool test_25 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mModifierMap (HERE).reader_count (SOURCE_FILE_AT_LINE (236)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_9428.hasCurrentObject ()) {
            ...
            if (enumerator_9428.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_9829.hasCurrentObject ()) {
                ...
                result << function_linkForType (enumerator_9829.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (260)), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)).stringValue () ;
                result << " " ;
      ...
      const enumGalgasBool test_26 = GALGAS_bool (kIsStrictSup, enumerator_1239.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (267)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          while (enumerator_10336.hasCurrentObject ()) {
            ...
            if (enumerator_10336.current_mParameterList (HERE).isValid ()) {
              ...
              while (enumerator_10406.hasCurrentObject ()) {
                ...
                result << function_linkForType (enumerator_10406.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (279)), inCompiler COMMA_SOURCE_FILE_AT_LINE (279)).stringValue () ;
                result << " " ;
