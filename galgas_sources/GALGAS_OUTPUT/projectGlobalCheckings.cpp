...
void routine_dumpTypes (const GALGAS_unifiedTypeMap constinArgument0,
                        const GALGAS_string constinArgument1,
                        C_Compiler * inCompiler
                        COMMA_LOCATION_ARGS) ;
...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".txt") COMMA_SOURCE_FILE_AT_LINE (715)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    routine_dumpTypes (var_semanticContext.mAttribute_mTypeMap, var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) ;
    }
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
  }
}
...
void routine_dumpTypes (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                        const GALGAS_string constinArgument_inTypeDumpFilePath,
                        C_Compiler * inCompiler
                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_typeDumpString = constinArgument_inUnifiedTypeMap.reader_count (SOURCE_FILE_AT_LINE (729)).reader_string (SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string (" types.\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (729)) ;
  cEnumerator_unifiedTypeMap enumerator_34675 (constinArgument_inUnifiedTypeMap, kEnumeration_up) ;
  while (enumerator_34675.hasCurrentObject ()) {
    var_typeDumpString.dotAssign_operation (GALGAS_string ("TYPE --------- @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (731)) COMMA_SOURCE_FILE_AT_LINE (731)).operator_concat (GALGAS_string (" ------------\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (731)) COMMA_SOURCE_FILE_AT_LINE (731)) ;
    var_typeDumpString.dotAssign_operation (GALGAS_string ("Kind: ") COMMA_SOURCE_FILE_AT_LINE (733)) ;
    const enumGalgasBool test_0 = enumerator_34675.current_mIsConcrete (HERE).operator_not (SOURCE_FILE_AT_LINE (734)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract ") COMMA_SOURCE_FILE_AT_LINE (735)) ;
    }
    if (enumerator_34675.current_mTypeKindEnum (HERE).isValid ()) {
      switch (enumerator_34675.current_mTypeKindEnum (HERE).enumValue ()) {
      case GALGAS_typeKindEnum::kNotBuilt:
        break ;
      case GALGAS_typeKindEnum::kEnum_classType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("class") COMMA_SOURCE_FILE_AT_LINE (738)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_enumType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("enum") COMMA_SOURCE_FILE_AT_LINE (739)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_listType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("list") COMMA_SOURCE_FILE_AT_LINE (740)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_sortedListType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("sorted list") COMMA_SOURCE_FILE_AT_LINE (741)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_mapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("map") COMMA_SOURCE_FILE_AT_LINE (742)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_uniqueMapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("unique map") COMMA_SOURCE_FILE_AT_LINE (743)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_mapProxyType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("map proxy") COMMA_SOURCE_FILE_AT_LINE (744)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_listMapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("list map") COMMA_SOURCE_FILE_AT_LINE (745)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_structType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("struct") COMMA_SOURCE_FILE_AT_LINE (746)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_graphType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("graph") COMMA_SOURCE_FILE_AT_LINE (747)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_predefinedType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("predefined type") COMMA_SOURCE_FILE_AT_LINE (748)) ;
        } break ;
      }
    }
    var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (750)) ;
    const enumGalgasBool test_1 = enumerator_34675.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (751)).operator_not (SOURCE_FILE_AT_LINE (751)).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Superclass: @").operator_concat (enumerator_34675.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)) ;
    }
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (757)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  addition: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string (" + @") COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)) ;
    }
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  substraction: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (GALGAS_string (" - @") COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)) ;
    }
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  multiplication: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string (" * @") COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)) ;
    }
    const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (766)) COMMA_SOURCE_FILE_AT_LINE (766)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_5) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  division: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string (" / @") COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)) ;
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (769)) COMMA_SOURCE_FILE_AT_LINE (769)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  modulo: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (770)) COMMA_SOURCE_FILE_AT_LINE (770)).operator_concat (GALGAS_string (" mod @") COMMA_SOURCE_FILE_AT_LINE (770)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (770)) COMMA_SOURCE_FILE_AT_LINE (770)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (770)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (770)) COMMA_SOURCE_FILE_AT_LINE (770)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (770)) COMMA_SOURCE_FILE_AT_LINE (770)) ;
    }
    const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (772)) COMMA_SOURCE_FILE_AT_LINE (772)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_7) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  left shift: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)).operator_concat (GALGAS_string (" << @uint -> @") COMMA_SOURCE_FILE_AT_LINE (773)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)) ;
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  right shift: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string (" >> @uint -> @") COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) ;
    }
    const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (776)) COMMA_SOURCE_FILE_AT_LINE (776)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  unary +: + @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (777)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) ;
    }
    const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (779)) COMMA_SOURCE_FILE_AT_LINE (779)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_9) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  unary -: - @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (780)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) ;
    }
    const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (782)) COMMA_SOURCE_FILE_AT_LINE (782)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  bit wise negation: ~ @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (783)) COMMA_SOURCE_FILE_AT_LINE (783)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (783)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (783)) COMMA_SOURCE_FILE_AT_LINE (783)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (783)) COMMA_SOURCE_FILE_AT_LINE (783)) ;
    }
    const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) COMMA_SOURCE_FILE_AT_LINE (785)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_11) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  boolean and: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (GALGAS_string (" & @") COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)) ;
    }
    const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) COMMA_SOURCE_FILE_AT_LINE (788)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_12) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  inclusive or: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (GALGAS_string (" | @") COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (789)) COMMA_SOURCE_FILE_AT_LINE (789)) ;
    }
    const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (791)) COMMA_SOURCE_FILE_AT_LINE (791)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_13) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  exclusive or: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (GALGAS_string (" ^ @") COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)) ;
    }
    const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (794)) COMMA_SOURCE_FILE_AT_LINE (794)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_14) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  boolean negation: not @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (795)) COMMA_SOURCE_FILE_AT_LINE (795)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (795)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (795)) COMMA_SOURCE_FILE_AT_LINE (795)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (795)) COMMA_SOURCE_FILE_AT_LINE (795)) ;
    }
    var_typeDumpString.dotAssign_operation (GALGAS_string ("  equality test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)).operator_concat (GALGAS_string (" == @") COMMA_SOURCE_FILE_AT_LINE (797)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (797)) COMMA_SOURCE_FILE_AT_LINE (797)) ;
    var_typeDumpString.dotAssign_operation (GALGAS_string ("  inequality test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (798)) COMMA_SOURCE_FILE_AT_LINE (798)).operator_concat (GALGAS_string (" != @") COMMA_SOURCE_FILE_AT_LINE (798)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (798)) COMMA_SOURCE_FILE_AT_LINE (798)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (798)) COMMA_SOURCE_FILE_AT_LINE (798)) ;
    const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (799)) COMMA_SOURCE_FILE_AT_LINE (799)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_15) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  lower than test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)).operator_concat (GALGAS_string (" < @") COMMA_SOURCE_FILE_AT_LINE (800)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)) ;
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  lower or equal test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (801)) COMMA_SOURCE_FILE_AT_LINE (801)).operator_concat (GALGAS_string (" <= @") COMMA_SOURCE_FILE_AT_LINE (801)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (801)) COMMA_SOURCE_FILE_AT_LINE (801)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (801)) COMMA_SOURCE_FILE_AT_LINE (801)) ;
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  greater than test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (802)) COMMA_SOURCE_FILE_AT_LINE (802)).operator_concat (GALGAS_string (" > @") COMMA_SOURCE_FILE_AT_LINE (802)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (802)) COMMA_SOURCE_FILE_AT_LINE (802)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (802)) COMMA_SOURCE_FILE_AT_LINE (802)) ;
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  greater or equal test: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (GALGAS_string (" >= @") COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (GALGAS_string (" -> @bool\n") COMMA_SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)) ;
    }
    const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (805)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_16) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  concatenation: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string (" . @") COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string (" -> @") COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)) ;
    }
    const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_17) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  appending instruction: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (GALGAS_string (" .= @") COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)) ;
    }
    const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_34675.current_mHandledOperatorFlags (HERE).operator_and (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) COMMA_SOURCE_FILE_AT_LINE (811)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_18) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  incrementation instruction: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (812)) COMMA_SOURCE_FILE_AT_LINE (812)).operator_concat (GALGAS_string (" ++\n") COMMA_SOURCE_FILE_AT_LINE (812)) COMMA_SOURCE_FILE_AT_LINE (812)) ;
      var_typeDumpString.dotAssign_operation (GALGAS_string ("  decrementation instruction: @").operator_concat (enumerator_34675.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (813)) COMMA_SOURCE_FILE_AT_LINE (813)).operator_concat (GALGAS_string (" --\n") COMMA_SOURCE_FILE_AT_LINE (813)) COMMA_SOURCE_FILE_AT_LINE (813)) ;
    }
    var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (815)) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_39646 (enumerator_34675.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
    const bool bool_19 = true ;
    if (enumerator_39646.hasCurrentObject () && bool_19) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("+= instruction arguments:\n") COMMA_SOURCE_FILE_AT_LINE (819)) ;
      while (enumerator_39646.hasCurrentObject () && bool_19) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  @").operator_concat (enumerator_39646.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (821)) COMMA_SOURCE_FILE_AT_LINE (821)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (821)) COMMA_SOURCE_FILE_AT_LINE (821)) ;
        enumerator_39646.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (823)) ;
    }
    cEnumerator_enumerationDescriptorList enumerator_39902 (enumerator_34675.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
    const bool bool_20 = true ;
    if (enumerator_39902.hasCurrentObject () && bool_20) {
      ...
      while (enumerator_39902.hasCurrentObject () && bool_20) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  @").operator_concat (enumerator_39902.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (830)) COMMA_SOURCE_FILE_AT_LINE (830)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (830)).operator_concat (enumerator_39902.current_mEnumerationName (HERE) COMMA_SOURCE_FILE_AT_LINE (830)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (830)) COMMA_SOURCE_FILE_AT_LINE (830)) ;
        enumerator_39902.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (832)) ;
    }
    const enumGalgasBool test_21 = enumerator_34675.current_mTypeForEnumeratedElement (HERE).reader_isNull (SOURCE_FILE_AT_LINE (835)).operator_not (SOURCE_FILE_AT_LINE (835)).boolEnum () ;
    if (kBoolTrue == test_21) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("for instruction enumeration type: @").operator_concat (enumerator_34675.current_mTypeForEnumeratedElement (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("\n"
        "\n") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
    }
    cEnumerator_constructorMap enumerator_40400 (enumerator_34675.current_mConstructorMap (HERE), kEnumeration_up) ;
    const bool bool_22 = true ;
    if (enumerator_40400.hasCurrentObject () && bool_22) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Constructors:\n") COMMA_SOURCE_FILE_AT_LINE (841)) ;
      while (enumerator_40400.hasCurrentObject () && bool_22) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  constructor ").operator_concat (enumerator_40400.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_40536 (enumerator_40400.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_40536.hasCurrentObject ()) {
          var_typeDumpString.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_40536.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (845)) COMMA_SOURCE_FILE_AT_LINE (845)) COMMA_SOURCE_FILE_AT_LINE (845)) ;
          enumerator_40536.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_40400.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (847)) COMMA_SOURCE_FILE_AT_LINE (847)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (847)) COMMA_SOURCE_FILE_AT_LINE (847)) ;
        enumerator_40400.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (849)) ;
    }
    cEnumerator_readerMap enumerator_40782 (enumerator_34675.current_mReaderMap (HERE), kEnumeration_up) ;
    const bool bool_23 = true ;
    if (enumerator_40782.hasCurrentObject () && bool_23) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Readers:\n") COMMA_SOURCE_FILE_AT_LINE (854)) ;
      while (enumerator_40782.hasCurrentObject () && bool_23) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (856)) ;
        if (enumerator_40782.current_mKind (HERE).isValid ()) {
          switch (enumerator_40782.current_mKind (HERE).enumValue ()) {
          case GALGAS_methodKind::kNotBuilt:
            break ;
          case GALGAS_methodKind::kEnum_definedAsMember: {
            } break ;
          case GALGAS_methodKind::kEnum_definedAsCategory: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("(category) ") COMMA_SOURCE_FILE_AT_LINE (859)) ;
            } break ;
          }
        }
        if (enumerator_40782.current_mQualifier (HERE).isValid ()) {
          switch (enumerator_40782.current_mQualifier (HERE).enumValue ()) {
          case GALGAS_methodQualifier::kNotBuilt:
            break ;
          case GALGAS_methodQualifier::kEnum_isAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract ") COMMA_SOURCE_FILE_AT_LINE (862)) ;
            } break ;
          ...
          case GALGAS_methodQualifier::kEnum_isOverriding: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("override ") COMMA_SOURCE_FILE_AT_LINE (866)) ;
            } break ;
          case GALGAS_methodQualifier::kEnum_isOverridingAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract override ") COMMA_SOURCE_FILE_AT_LINE (867)) ;
            } break ;
          }
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string ("reader ").operator_concat (enumerator_40782.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_41373 (enumerator_40782.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_41373.hasCurrentObject ()) {
          var_typeDumpString.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_41373.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) ;
          enumerator_41373.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_40782.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)) ;
        enumerator_40782.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (875)) ;
    }
    cEnumerator_instanceMethodMap enumerator_41627 (enumerator_34675.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
    const bool bool_24 = true ;
    if (enumerator_41627.hasCurrentObject () && bool_24) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Methods:\n") COMMA_SOURCE_FILE_AT_LINE (880)) ;
      while (enumerator_41627.hasCurrentObject () && bool_24) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (882)) ;
        if (enumerator_41627.current_mKind (HERE).isValid ()) {
          switch (enumerator_41627.current_mKind (HERE).enumValue ()) {
          case GALGAS_methodKind::kNotBuilt:
            break ;
          case GALGAS_methodKind::kEnum_definedAsMember: {
            } break ;
          case GALGAS_methodKind::kEnum_definedAsCategory: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("(category) ") COMMA_SOURCE_FILE_AT_LINE (885)) ;
            } break ;
          }
        }
        if (enumerator_41627.current_mQualifier (HERE).isValid ()) {
          switch (enumerator_41627.current_mQualifier (HERE).enumValue ()) {
          case GALGAS_methodQualifier::kNotBuilt:
            break ;
          case GALGAS_methodQualifier::kEnum_isAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract ") COMMA_SOURCE_FILE_AT_LINE (888)) ;
            } break ;
          case GALGAS_methodQualifier::kEnum_isBasic: {
            } break ;
          case GALGAS_methodQualifier::kEnum_isBasicFinal: {
          ...
          case GALGAS_methodQualifier::kEnum_isOverriding: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("override ") COMMA_SOURCE_FILE_AT_LINE (892)) ;
            } break ;
          case GALGAS_methodQualifier::kEnum_isOverridingAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract override ") COMMA_SOURCE_FILE_AT_LINE (893)) ;
            } break ;
          }
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string ("method ").operator_concat (enumerator_41627.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (895)) COMMA_SOURCE_FILE_AT_LINE (895)) COMMA_SOURCE_FILE_AT_LINE (895)) ;
        cEnumerator_formalParameterSignature enumerator_42215 (enumerator_41627.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_42215.hasCurrentObject ()) {
          if (enumerator_42215.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_42215.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (898)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (899)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (900)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (901)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_42215.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (903)) COMMA_SOURCE_FILE_AT_LINE (903)) COMMA_SOURCE_FILE_AT_LINE (903)) ;
          enumerator_42215.gotoNextObject () ;
        }
    ...
    cEnumerator_modifierMap enumerator_42746 (enumerator_34675.current_mModifierMap (HERE), kEnumeration_up) ;
    const bool bool_25 = true ;
    if (enumerator_42746.hasCurrentObject () && bool_25) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Modifiers:\n") COMMA_SOURCE_FILE_AT_LINE (912)) ;
      while (enumerator_42746.hasCurrentObject () && bool_25) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  ") COMMA_SOURCE_FILE_AT_LINE (914)) ;
        if (enumerator_42746.current_mKind (HERE).isValid ()) {
          switch (enumerator_42746.current_mKind (HERE).enumValue ()) {
          case GALGAS_methodKind::kNotBuilt:
            break ;
          case GALGAS_methodKind::kEnum_definedAsMember: {
            } break ;
          case GALGAS_methodKind::kEnum_definedAsCategory: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("(category) ") COMMA_SOURCE_FILE_AT_LINE (917)) ;
            } break ;
          }
        }
        if (enumerator_42746.current_mQualifier (HERE).isValid ()) {
          switch (enumerator_42746.current_mQualifier (HERE).enumValue ()) {
          case GALGAS_methodQualifier::kNotBuilt:
            break ;
          case GALGAS_methodQualifier::kEnum_isAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract ") COMMA_SOURCE_FILE_AT_LINE (920)) ;
            } break ;
          case GALGAS_methodQualifier::kEnum_isBasic: {
            } break ;
          case GALGAS_methodQualifier::kEnum_isBasicFinal: {
          ...
          case GALGAS_methodQualifier::kEnum_isOverriding: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("override ") COMMA_SOURCE_FILE_AT_LINE (924)) ;
            } break ;
          case GALGAS_methodQualifier::kEnum_isOverridingAbstract: {
            var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract override ") COMMA_SOURCE_FILE_AT_LINE (925)) ;
            } break ;
          }
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string ("modifier ").operator_concat (enumerator_42746.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)) ;
        cEnumerator_formalParameterSignature enumerator_43338 (enumerator_42746.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_43338.hasCurrentObject ()) {
          if (enumerator_43338.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_43338.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (930)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (931)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (932)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (933)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_43338.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (935)) COMMA_SOURCE_FILE_AT_LINE (935)) COMMA_SOURCE_FILE_AT_LINE (935)) ;
          enumerator_43338.gotoNextObject () ;
        }
    ...
    cEnumerator_classMethodMap enumerator_43876 (enumerator_34675.current_mClassMethodMap (HERE), kEnumeration_up) ;
    const bool bool_26 = true ;
    if (enumerator_43876.hasCurrentObject () && bool_26) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Class methods:\n") COMMA_SOURCE_FILE_AT_LINE (944)) ;
      while (enumerator_43876.hasCurrentObject () && bool_26) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  class method ").operator_concat (enumerator_43876.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)) ;
        cEnumerator_formalParameterSignature enumerator_44011 (enumerator_43876.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_44011.hasCurrentObject ()) {
          if (enumerator_44011.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_44011.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (949)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (950)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (951)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (952)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_44011.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (954)) COMMA_SOURCE_FILE_AT_LINE (954)) COMMA_SOURCE_FILE_AT_LINE (954)) ;
          enumerator_44011.gotoNextObject () ;
        }
  ...
  GALGAS_bool joker_44590_0 ; // Joker input parameter
  var_typeDumpString.method_writeToFileWhenDifferentContents (constinArgument_inTypeDumpFilePath, joker_44590_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
}
