...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_14478 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_14478 = NULL ;
    while (((operand_14478 = enumerator_14478.nextObject ()))) {
      macroValidPointer (operand_14478) ;
      const GGS_bool cond_14682 = (operand_14478->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (314))).operator_not () ;
      if (cond_14682.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_14478->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (316)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_14478->mKey COMMA_SOURCE_FILE_AT_LINE (317))) ;
      }
    }
  }
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_15148 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (328)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_15148 = NULL ;
    while (((operand_15148 = enumerator_15148.nextObject ()))) {
      macroValidPointer (operand_15148) ;
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_15218 (operand_15148->mInfo.mRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (329)), true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_15218 = NULL ;
        while (((operand_15218 = enumerator_15218.nextObject ()))) {
          macroValidPointer (operand_15218) ;
          { typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps method = findCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps (operand_15218->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_15218->mSemanticDeclaration (HERE), var_cas_abstractMultiMethodListMap, var_cas_multiMethodListMap, var_cas_overridingMultiMethodListMap, var_cas_abstractMultiReaderListMap, var_cas_multiReaderListMap, var_cas_overridingMultiReaderListMap COMMA_SOURCE_FILE_AT_LINE (330)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_18379 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (341))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_18379.isBuiltAndTrue ()) {
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_15730 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_15730.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_15821 (enumerator_15730._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_15821 = NULL ;
          while (((operand_15821 = enumerator_15821.nextObject ()))) {
            macroValidPointer (operand_15821) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_15821->mValue COMMA_SOURCE_FILE_AT_LINE (346)) ;
          }
        }
        enumerator_15730.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16008 (var_cas_multiMethodListMap, true) ;
      while (enumerator_16008.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_16099 (enumerator_16008._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16099 = NULL ;
          while (((operand_16099 = enumerator_16099.nextObject ()))) {
            macroValidPointer (operand_16099) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16099->mValue COMMA_SOURCE_FILE_AT_LINE (353)) ;
          }
        }
        enumerator_16008.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16302 (var_cas_overridingMultiMethodListMap, true) ;
      while (enumerator_16302.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_16393 (enumerator_16302._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16393 = NULL ;
          while (((operand_16393 = enumerator_16393.nextObject ()))) {
            macroValidPointer (operand_16393) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16393->mValue COMMA_SOURCE_FILE_AT_LINE (360)) ;
          }
        }
        enumerator_16302.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16680 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_16680.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_16703 (enumerator_16680._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16703 = NULL ;
          while (((operand_16703 = enumerator_16703.nextObject ()))) {
            macroValidPointer (operand_16703) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_16680._key (HERE),  enumerator_16680._key (HERE),  operand_16703->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (368)) ;
          }
        }
        enumerator_16680.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17216 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_17216.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_17307 (enumerator_17216._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17307 = NULL ;
          while (((operand_17307 = enumerator_17307.nextObject ()))) {
            macroValidPointer (operand_17307) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17307->mValue COMMA_SOURCE_FILE_AT_LINE (385)) ;
          }
        }
        enumerator_17216.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17494 (var_cas_multiReaderListMap, true) ;
      while (enumerator_17494.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_17585 (enumerator_17494._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17585 = NULL ;
          while (((operand_17585 = enumerator_17585.nextObject ()))) {
            macroValidPointer (operand_17585) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17585->mValue COMMA_SOURCE_FILE_AT_LINE (392)) ;
          }
        }
        enumerator_17494.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17788 (var_cas_overridingMultiReaderListMap, true) ;
      while (enumerator_17788.hasCurrentObject ()) {
        ...
        {
          GGS_lstringlist::cEnumerator enumerator_17879 (enumerator_17788._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17879 = NULL ;
          while (((operand_17879 = enumerator_17879.nextObject ()))) {
            macroValidPointer (operand_17879) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17879->mValue COMMA_SOURCE_FILE_AT_LINE (399)) ;
          }
        }
        enumerator_17788.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_18097 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_18097.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_18120 (enumerator_18097._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_18120 = NULL ;
          while (((operand_18120 = enumerator_18120.nextObject ()))) {
            macroValidPointer (operand_18120) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_18097._key (HERE),  enumerator_18097._key (HERE),  operand_18120->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (405)) ;
          }
        }
        enumerator_18097.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
