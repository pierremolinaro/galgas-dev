...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  GGS_descendantClassListMap var_cas_descendantClassListMap = GGS_descendantClassListMap::constructor_emptyMap () ;
  {
    ...
    while (((operand_9486 = enumerator_9486.nextObject ()))) {
      ...
      const GGS_bool cond_9723 = (operand_9486->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (193))).operator_not () ;
      if (cond_9723.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_9486->mInfo.mSuperType.reader_keyString (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), operand_9486->mKey COMMA_SOURCE_FILE_AT_LINE (196))) ;
      }
    }
  }
  const GGS_bool cond_13880 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13880.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_10043 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_10043 = NULL ;
      while (((operand_10043 = enumerator_10043.nextObject ()))) {
        macroValidPointer (operand_10043) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_10043->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
        var_cas_categoryMethodListMap.dotAssign_operation (operand_10043->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_mCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_10043->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (208))) ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_10529 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_10529.hasCurrentObject ()) {
        ...
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_10603 (enumerator_10529._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_10603 = NULL ;
          while (((operand_10603 = enumerator_10603.nextObject ()))) {
            macroValidPointer (operand_10603) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10603->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (214)) ;
          }
        }
        enumerator_10529.next () ;
      }
    }
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_10811 (var_cas_categoryMethodListMap, true) ;
      while (enumerator_10811.hasCurrentObject ()) {
        ...
        {
          GGS_multiMethodListAST::cEnumerator enumerator_10885 (enumerator_10811._object (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_10885 = NULL ;
          while (((operand_10885 = enumerator_10885.nextObject ()))) {
            macroValidPointer (operand_10885) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10885->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (221)) ;
          }
        }
        enumerator_10811.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_11101 (var_cas_overridingCategoryMethodListMap, true) ;
      while (enumerator_11101.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_11175 (enumerator_11101._object (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_11175 = NULL ;
          while (((operand_11175 = enumerator_11175.nextObject ()))) {
            macroValidPointer (operand_11175) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_11175->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
        }
        enumerator_11101.next () ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_11494 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_11494.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_11518 (enumerator_11494._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_11518 = NULL ;
          while (((operand_11518 = enumerator_11518.nextObject ()))) {
            macroValidPointer (operand_11518) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_11494._key (HERE),  enumerator_11494._key (HERE),  operand_11518->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap,  var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (236)) ;
          }
        }
        enumerator_11494.next () ;
      }
    }
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12202 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_12202 = NULL ;
      while (((operand_12202 = enumerator_12202.nextObject ()))) {
        macroValidPointer (operand_12202) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_12202->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_12202->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (255)).reader_mCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_12202->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (256)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_12688 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_12688.hasCurrentObject ()) {
        ...
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_12762 (enumerator_12688._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_12762 = NULL ;
          while (((operand_12762 = enumerator_12762.nextObject ()))) {
            macroValidPointer (operand_12762) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12762->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (262)) ;
          }
        }
        enumerator_12688.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_12970 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_12970.hasCurrentObject ()) {
        ...
        {
          GGS_multiReaderListAST::cEnumerator enumerator_13044 (enumerator_12970._object (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_13044 = NULL ;
          while (((operand_13044 = enumerator_13044.nextObject ()))) {
            macroValidPointer (operand_13044) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13044->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (269)) ;
          }
        }
        enumerator_12970.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_13260 (var_cas_overridingCategoryReaderListMap, true) ;
      while (enumerator_13260.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_13334 (enumerator_13260._object (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_13334 = NULL ;
          while (((operand_13334 = enumerator_13334.nextObject ()))) {
            macroValidPointer (operand_13334) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13334->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (276)) ;
          }
        }
        enumerator_13260.next () ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_13575 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_13575.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_13599 (enumerator_13575._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_13599 = NULL ;
          while (((operand_13599 = enumerator_13599.nextObject ()))) {
            macroValidPointer (operand_13599) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_13575._key (HERE),  enumerator_13575._key (HERE),  operand_13599->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap,  var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (282)) ;
          }
        }
        enumerator_13575.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
