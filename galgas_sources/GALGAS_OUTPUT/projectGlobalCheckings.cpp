...
void routine_performGalgas_33_ProjectGlobalCheckings (const GALGAS_semanticContext constinArgument_inSemanticContext,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_descendantClassListMap var_descendantClassListMap = GALGAS_descendantClassListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 770)) ;
  ...
  while (enumerator_36635.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_36635.current_mSuperType (HERE).reader_isNull (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 772)).operator_not (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 772)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_descendantClassListMap.addAssign_operation (enumerator_36635.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 774)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_36635.current_lkey (HERE), inCompiler  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 775))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 773)) ;
    }
    enumerator_36635.gotoNextObject () ;
  }
  GALGAS_genericCategoryMethodListMap var_abstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 780)) ;
  GALGAS_genericCategoryMethodListMap var_categoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 781)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 782)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 783)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 784)) ;
  GALGAS_genericCategoryMethodListMap var_categoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 785)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 786)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 787)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 788)) ;
  GALGAS_genericCategoryMethodListMap var_categoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 789)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 790)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 791)) ;
  ...
  while (enumerator_37841.hasCurrentObject ()) {
    callCategoryMethod_buildCategoryListMaps ((const cPtr_semanticDeclarationAST *) enumerator_37841.current_mSemanticDeclaration (HERE).ptr (), var_abstractCategoryModifierListMap, var_categoryModifierListMap, var_overridingCategoryModifierListMap, var_overridingAbstractCategoryModifierListMap, var_abstractCategoryMethodListMap, var_categoryMethodListMap, var_overridingCategoryMethodListMap, var_overridingAbstractCategoryMethodListMap, var_abstractCategoryReaderListMap, var_categoryReaderListMap, var_overridingCategoryReaderListMap, var_overridingAbstractCategoryReaderListMap, inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 793)) ;
    enumerator_37841.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 809)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_38568.hasCurrentObject ()) {
      ...
      while (enumerator_38669.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_38669.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 814)) ;
        }
    ...
    while (enumerator_38871.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 819)) ;
      ...
      while (enumerator_38972.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_38972.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 821)) ;
        }
    ...
    while (enumerator_39190.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 826)) ;
      ...
      while (enumerator_39291.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_39291.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 828)) ;
        }
    ...
    while (enumerator_39524.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 833)) ;
      ...
      while (enumerator_39625.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_39625.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 835)) ;
        }
    ...
    while (enumerator_40766.hasCurrentObject ()) {
      ...
      while (enumerator_40863.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_40863.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 868)) ;
        }
    ...
    while (enumerator_41059.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 873)) ;
      ...
      while (enumerator_41156.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41156.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 875)) ;
        }
    ...
    while (enumerator_41368.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 880)) ;
      ...
      while (enumerator_41465.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41465.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 882)) ;
        }
    ...
    while (enumerator_41694.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 887)) ;
      ...
      while (enumerator_41791.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_41791.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 889)) ;
        }
    ...
    while (enumerator_42045.hasCurrentObject ()) {
      ...
      while (enumerator_42068.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_42045.current_key (HERE), enumerator_42045.current_key (HERE), enumerator_42068.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 895)) ;
        }
    ...
    while (enumerator_42500.hasCurrentObject ()) {
      ...
      while (enumerator_42523.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_42500.current_key (HERE), enumerator_42500.current_key (HERE), enumerator_42523.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, constinArgument_inSemanticContext.mAttribute_mTypeMap, inCompiler  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 908)) ;
        }
    ...
    while (enumerator_43053.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 923)) ;
      ...
      while (enumerator_43150.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43150.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 925)) ;
        }
    ...
    while (enumerator_43346.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 930)) ;
      ...
      while (enumerator_43443.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43443.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 932)) ;
        }
    ...
    while (enumerator_43655.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 937)) ;
      ...
      while (enumerator_43752.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_43752.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 939)) ;
        }
  ...
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".html")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 970)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_galgas_5F_cli_5F_options_outputHTMLTypeListFile.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_stringset var_firstLetterSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 972)) ;
    ...
    while (enumerator_44980.hasCurrentObject ()) {
      var_firstLetterSet.addAssign_operation (enumerator_44980.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 974)).reader_string (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 974))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 974)) ;
    ...
    while (enumerator_45187.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter.objectCompare (enumerator_45187.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 979)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_currentFirstLetter = enumerator_45187.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 980)) ;
        var_tableOfTypeString.dotAssign_operation (GALGAS_string ("<br><a name=\"").operator_concat (var_currentFirstLetter.reader_uint (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981)).reader_string (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981)).operator_concat (GALGAS_string ("\"><b>")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981)).operator_concat (var_currentFirstLetter.reader_string (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981)).operator_concat (GALGAS_string ("</b></a><br>")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 981)) ;
      }
      var_tableOfTypeString.dotAssign_operation (function_linkForType (enumerator_45187.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 983)).operator_concat (GALGAS_string ("<br>")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 983))  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 983)) ;
      enumerator_45187.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFilePath.reader_lastPathComponent (SOURCE_FILE ("projectGlobalCheckings.gSemantics", 986)), constinArgument_inSemanticContext.mAttribute_mTypeMap, var_firstLetterSet, var_tableOfTypeString COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 985))) ;
    GALGAS_bool joker_45874_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_45874_0, inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 991)) ;
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 993)) ;
    }
  }
}
...
GALGAS_string function_linkForType (const GALGAS_string & constinArgument_inTypeName,
  ...
  result_outResult = GALGAS_string ("<a class=\"header_link\" href=\"#").operator_concat (constinArgument_inTypeName  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 1018)).operator_concat (GALGAS_string ("\">@")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 1018)).operator_concat (constinArgument_inTypeName  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 1018)).operator_concat (GALGAS_string ("</a>")  COMMA_SOURCE_FILE ("projectGlobalCheckings.gSemantics", 1018)) ;
//---
