  ...
  const GGS_unifiedTypeMapProxyList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (99)) ;
  {
    ...
    while (((operand_5328 = enumerator_5328.nextObject ()))) {
      ...
      if (cond_6643.isBuiltAndTrue ()) {
        ...
        GGS_unifiedTypeMapProxy  automatic_var_5835_0 ;
        GGS_typeKindEnum automatic_var_5835_1 ;
        GGS_typedAttributeList  automatic_var_5835_2 ;
        GGS_attributeMap  automatic_var_5835_3 ;
        GGS_typedAttributeList  automatic_var_5835_4 ;
        GGS_constructorMap  automatic_var_5835_5 ;
        GGS_readerMap  automatic_var_5835_6 ;
        GGS_modifierMap  automatic_var_5835_7 ;
        GGS_instanceMethodMap  automatic_var_5835_8 ;
        GGS_classMethodMap  automatic_var_5835_9 ;
        GGS_enumerationDescriptorList  automatic_var_5835_10 ;
        GGS_uint  automatic_var_5835_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_5835_12 ;
        GGS_unifiedTypeMapProxyList  automatic_var_5835_13 ;
        GGS_nativeAttributeList  automatic_var_5835_14 ;
        GGS_lstringlist  automatic_var_5835_15 ;
        GGS_typedAttributeList  automatic_var_5835_16 ;
        GGS_mapSearchMethodListAST  automatic_var_5835_17 ;
        GGS_mapSearchMethodListAST  automatic_var_5835_18 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_5835_0, automatic_var_5835_1, automatic_var_5835_2, automatic_var_5835_3, automatic_var_5835_4, automatic_var_5835_5, automatic_var_5835_6, automatic_var_5835_7, automatic_var_5835_8, automatic_var_5835_9, automatic_var_5835_10, automatic_var_5835_11, automatic_var_5835_12, automatic_var_5835_13, automatic_var_5835_14, automatic_var_5835_15, automatic_var_5835_16, automatic_var_5835_17, automatic_var_5835_18 COMMA_SOURCE_FILE_AT_LINE (109)) ;
        }
...
void routine_checkMultiReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_7206 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_7206 = NULL ;
    while (((operand_7206 = enumerator_7206.nextObject ()))) {
      ...
      if (cond_8512.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_7701_0 ;
        GGS_typeKindEnum automatic_var_7701_1 ;
        GGS_typedAttributeList  automatic_var_7701_2 ;
        GGS_attributeMap  automatic_var_7701_3 ;
        GGS_typedAttributeList  automatic_var_7701_4 ;
        GGS_constructorMap  automatic_var_7701_5 ;
        GGS_readerMap  automatic_var_7701_6 ;
        GGS_modifierMap  automatic_var_7701_7 ;
        GGS_instanceMethodMap  automatic_var_7701_8 ;
        GGS_classMethodMap  automatic_var_7701_9 ;
        GGS_enumerationDescriptorList  automatic_var_7701_10 ;
        GGS_uint  automatic_var_7701_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_7701_12 ;
        GGS_unifiedTypeMapProxyList  automatic_var_7701_13 ;
        GGS_nativeAttributeList  automatic_var_7701_14 ;
        GGS_lstringlist  automatic_var_7701_15 ;
        GGS_typedAttributeList  automatic_var_7701_16 ;
        GGS_mapSearchMethodListAST  automatic_var_7701_17 ;
        GGS_mapSearchMethodListAST  automatic_var_7701_18 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_7701_0, automatic_var_7701_1, automatic_var_7701_2, automatic_var_7701_3, automatic_var_7701_4, automatic_var_7701_5, automatic_var_7701_6, automatic_var_7701_7, automatic_var_7701_8, automatic_var_7701_9, automatic_var_7701_10, automatic_var_7701_11, automatic_var_7701_12, automatic_var_7701_13, automatic_var_7701_14, automatic_var_7701_15, automatic_var_7701_16, automatic_var_7701_17, automatic_var_7701_18 COMMA_SOURCE_FILE_AT_LINE (149)) ;
        }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_9555 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_9555 = NULL ;
    while (((operand_9555 = enumerator_9555.nextObject ()))) {
      macroValidPointer (operand_9555) ;
      const GGS_bool cond_9776 = (operand_9555->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_not () ;
      if (cond_9776.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_9555->mInfo.mSuperType.reader_keyString (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_9555->mKey COMMA_SOURCE_FILE_AT_LINE (197))) ;
      }
    }
  }
  const GGS_bool cond_13931 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13931.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_10096 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_10096 = NULL ;
      while (((operand_10096 = enumerator_10096.nextObject ()))) {
        macroValidPointer (operand_10096) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_10096->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
        var_cas_categoryMethodListMap.dotAssign_operation (operand_10096->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_mCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (208))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_10096->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (209)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (209))) ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_10582 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_10582.hasCurrentObject ()) {
        ...
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_10656 (enumerator_10582._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_10656 = NULL ;
          while (((operand_10656 = enumerator_10656.nextObject ()))) {
            macroValidPointer (operand_10656) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10656->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (215)) ;
          }
        }
        enumerator_10582.next () ;
      }
    }
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_10864 (var_cas_categoryMethodListMap, true) ;
      while (enumerator_10864.hasCurrentObject ()) {
        ...
        {
          GGS_multiMethodListAST::cEnumerator enumerator_10938 (enumerator_10864._object (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_10938 = NULL ;
          while (((operand_10938 = enumerator_10938.nextObject ()))) {
            macroValidPointer (operand_10938) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10938->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (222)) ;
          }
        }
        enumerator_10864.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_11154 (var_cas_overridingCategoryMethodListMap, true) ;
      while (enumerator_11154.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_11228 (enumerator_11154._object (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_11228 = NULL ;
          while (((operand_11228 = enumerator_11228.nextObject ()))) {
            macroValidPointer (operand_11228) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_11228->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (229)) ;
          }
        }
        enumerator_11154.next () ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_11547 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_11547.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_11571 (enumerator_11547._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_11571 = NULL ;
          while (((operand_11571 = enumerator_11571.nextObject ()))) {
            macroValidPointer (operand_11571) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_11547._key (HERE),  enumerator_11547._key (HERE),  operand_11571->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (237)) ;
          }
        }
        enumerator_11547.next () ;
      }
    }
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12254 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_12254 = NULL ;
      while (((operand_12254 = enumerator_12254.nextObject ()))) {
        macroValidPointer (operand_12254) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_12254->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (255)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_12254->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (256)).reader_mCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_12254->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (257)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (257))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_12740 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_12740.hasCurrentObject ()) {
        ...
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_12814 (enumerator_12740._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_12814 = NULL ;
          while (((operand_12814 = enumerator_12814.nextObject ()))) {
            macroValidPointer (operand_12814) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12814->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (263)) ;
          }
        }
        enumerator_12740.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_13022 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_13022.hasCurrentObject ()) {
        ...
        {
          GGS_multiReaderListAST::cEnumerator enumerator_13096 (enumerator_13022._object (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_13096 = NULL ;
          while (((operand_13096 = enumerator_13096.nextObject ()))) {
            macroValidPointer (operand_13096) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13096->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (270)) ;
          }
        }
        enumerator_13022.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_13312 (var_cas_overridingCategoryReaderListMap, true) ;
      while (enumerator_13312.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_13386 (enumerator_13312._object (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_13386 = NULL ;
          while (((operand_13386 = enumerator_13386.nextObject ()))) {
            macroValidPointer (operand_13386) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13386->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (277)) ;
          }
        }
        enumerator_13312.next () ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_13627 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_13627.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_13651 (enumerator_13627._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_13651 = NULL ;
          while (((operand_13651 = enumerator_13651.nextObject ()))) {
            macroValidPointer (operand_13651) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_13627._key (HERE),  enumerator_13627._key (HERE),  operand_13651->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (283)) ;
          }
        }
        enumerator_13627.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
