...
//                    november 28th, 2013, at 21h19'21"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_bool joker_35219_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_35219_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
  }else if (kBoolFalse == test_2) {
    {
