...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9831 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
...
void routine_checkMultiMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_10416 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_10416 = NULL ;
    while (((operand_10416 = enumerator_10416.nextObject ()))) {
      macroValidPointer (operand_10416) ;
      const GGS_lstring  var_cas_descendantClassName = operand_10416->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
      ...
      {
        GGS_lstringlist::cEnumerator enumerator_10647 (var_cas_overridingMethods, true) ;
        ...
        while (((operand_10647 = enumerator_10647.nextObject ()))
          ...
          var_cas_found = (var_cas_inAbstractMultiMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (operand_10647->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))) ;
        }
      }
      const GGS_bool cond_11671 = (var_cas_found).operator_not () ;
      if (cond_11671.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_10875_0 ;
        GGS_typeKindEnum automatic_var_10875_1 ;
        GGS_typedAttributeList  automatic_var_10875_2 ;
        GGS_attributeMap  automatic_var_10875_3 ;
        GGS_typedAttributeList  automatic_var_10875_4 ;
        GGS_constructorMap  automatic_var_10875_5 ;
        GGS_readerMap  automatic_var_10875_6 ;
        GGS_modifierMap  automatic_var_10875_7 ;
        GGS_instanceMethodMap  automatic_var_10875_8 ;
        GGS_classMethodMap  automatic_var_10875_9 ;
        GGS_enumerationDescriptorList  automatic_var_10875_10 ;
        GGS_uint  automatic_var_10875_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_10875_12 ;
        GGS_nativeAttributeList  automatic_var_10875_13 ;
        GGS_stringset  automatic_var_10875_14 ;
        GGS_lstringlist  automatic_var_10875_15 ;
        GGS_typedAttributeList  automatic_var_10875_16 ;
        GGS_mapSearchMethodListAST  automatic_var_10875_17 ;
        GGS_mapSearchMethodListAST  automatic_var_10875_18 ;
        GGS_withAccessorMap  automatic_var_10875_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_10875_0, automatic_var_10875_1, automatic_var_10875_2, automatic_var_10875_3, automatic_var_10875_4, automatic_var_10875_5, automatic_var_10875_6, automatic_var_10875_7, automatic_var_10875_8, automatic_var_10875_9, automatic_var_10875_10, automatic_var_10875_11, automatic_var_10875_12, automatic_var_10875_13, automatic_var_10875_14, automatic_var_10875_15, automatic_var_10875_16, automatic_var_10875_17, automatic_var_10875_18, automatic_var_10875_19 COMMA_SOURCE_FILE_AT_LINE (229)) ;
        }
        const GGS_bool cond_11362 = (var_cas_isConcrete).operator_not () ;
        if (cond_11362.isBuiltAndTrue ()) {
        ...
        }else if (cond_11362.isBuiltAndFalse ()) {
...
void routine_checkMultiReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12222 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_12222 = NULL ;
    while (((operand_12222 = enumerator_12222.nextObject ()))) {
      macroValidPointer (operand_12222) ;
      GGS_lstring  var_cas_descendantClassName = operand_12222->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
      ...
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_12447 (var_cas_overridingReaders, true) ;
        const GGS_lstringlist::cElement * operand_12447 = NULL ;
        while (((operand_12447 = enumerator_12447.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_12447) ;
          var_cas_found = (var_cas_inAbstractMultiReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isEqual (operand_12447->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))) ;
        }
      }
      const GGS_bool cond_13474 = (var_cas_found).operator_not () ;
      if (cond_13474.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_12675_0 ;
        GGS_typeKindEnum automatic_var_12675_1 ;
        GGS_typedAttributeList  automatic_var_12675_2 ;
        GGS_attributeMap  automatic_var_12675_3 ;
        GGS_typedAttributeList  automatic_var_12675_4 ;
        GGS_constructorMap  automatic_var_12675_5 ;
        GGS_readerMap  automatic_var_12675_6 ;
        GGS_modifierMap  automatic_var_12675_7 ;
        GGS_instanceMethodMap  automatic_var_12675_8 ;
        GGS_classMethodMap  automatic_var_12675_9 ;
        GGS_enumerationDescriptorList  automatic_var_12675_10 ;
        GGS_uint  automatic_var_12675_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_12675_12 ;
        GGS_nativeAttributeList  automatic_var_12675_13 ;
        GGS_stringset  automatic_var_12675_14 ;
        GGS_lstringlist  automatic_var_12675_15 ;
        GGS_typedAttributeList  automatic_var_12675_16 ;
        GGS_mapSearchMethodListAST  automatic_var_12675_17 ;
        GGS_mapSearchMethodListAST  automatic_var_12675_18 ;
        GGS_withAccessorMap  automatic_var_12675_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_12675_0, automatic_var_12675_1, automatic_var_12675_2, automatic_var_12675_3, automatic_var_12675_4, automatic_var_12675_5, automatic_var_12675_6, automatic_var_12675_7, automatic_var_12675_8, automatic_var_12675_9, automatic_var_12675_10, automatic_var_12675_11, automatic_var_12675_12, automatic_var_12675_13, automatic_var_12675_14, automatic_var_12675_15, automatic_var_12675_16, automatic_var_12675_17, automatic_var_12675_18, automatic_var_12675_19 COMMA_SOURCE_FILE_AT_LINE (269)) ;
        }
        const GGS_bool cond_13162 = (var_cas_isConcrete).operator_not () ;
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_13935 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (299)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_13935 = NULL ;
    while (((operand_13935 = enumerator_13935.nextObject ()))) {
      macroValidPointer (operand_13935) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_13935->mInfo.mRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
    }
  }
  ...
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_14434 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_14434 = NULL ;
    while (((operand_14434 = enumerator_14434.nextObject ()))) {
      macroValidPointer (operand_14434) ;
      const GGS_bool cond_14638 = (operand_14434->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (313))).operator_not () ;
      if (cond_14638.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_14434->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (315)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_14434->mKey COMMA_SOURCE_FILE_AT_LINE (316))) ;
      }
    }
  }
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_15104 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (327)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_15104 = NULL ;
    while (((operand_15104 = enumerator_15104.nextObject ()))) {
      macroValidPointer (operand_15104) ;
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_15174 (operand_15104->mInfo.mRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (328)), true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_15174 = NULL ;
        while (((operand_15174 = enumerator_15174.nextObject ()))) {
          macroValidPointer (operand_15174) ;
          { typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps method = findCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps (operand_15174->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_15174->mSemanticDeclaration (HERE), var_cas_abstractMultiMethodListMap, var_cas_multiMethodListMap, var_cas_overridingMultiMethodListMap, var_cas_abstractMultiReaderListMap, var_cas_multiReaderListMap, var_cas_overridingMultiReaderListMap COMMA_SOURCE_FILE_AT_LINE (329)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_18227 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_18227.isBuiltAndTrue ()) {
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_15686 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_15686.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (343)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_15759 (enumerator_15686._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_15759 = NULL ;
          while (((operand_15759 = enumerator_15759.nextObject ()))) {
            macroValidPointer (operand_15759) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_15759->mValue COMMA_SOURCE_FILE_AT_LINE (345)) ;
          }
        }
        enumerator_15686.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_15946 (var_cas_multiMethodListMap, true) ;
      while (enumerator_15946.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_16019 (enumerator_15946._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16019 = NULL ;
          while (((operand_16019 = enumerator_16019.nextObject ()))) {
            macroValidPointer (operand_16019) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16019->mValue COMMA_SOURCE_FILE_AT_LINE (352)) ;
          }
        }
        enumerator_15946.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16222 (var_cas_overridingMultiMethodListMap, true) ;
      while (enumerator_16222.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_16295 (enumerator_16222._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16295 = NULL ;
          while (((operand_16295 = enumerator_16295.nextObject ()))) {
            macroValidPointer (operand_16295) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16295->mValue COMMA_SOURCE_FILE_AT_LINE (359)) ;
          }
        }
        enumerator_16222.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16582 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_16582.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_16605 (enumerator_16582._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16605 = NULL ;
          while (((operand_16605 = enumerator_16605.nextObject ()))) {
            macroValidPointer (operand_16605) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_16582._key (HERE),  enumerator_16582._key (HERE),  operand_16605->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (367)) ;
          }
        }
        enumerator_16582.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17118 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_17118.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (382)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17191 (enumerator_17118._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17191 = NULL ;
          while (((operand_17191 = enumerator_17191.nextObject ()))) {
            macroValidPointer (operand_17191) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17191->mValue COMMA_SOURCE_FILE_AT_LINE (384)) ;
          }
        }
        enumerator_17118.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17378 (var_cas_multiReaderListMap, true) ;
      while (enumerator_17378.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (389)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17451 (enumerator_17378._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17451 = NULL ;
          while (((operand_17451 = enumerator_17451.nextObject ()))) {
            macroValidPointer (operand_17451) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17451->mValue COMMA_SOURCE_FILE_AT_LINE (391)) ;
          }
        }
        enumerator_17378.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17654 (var_cas_overridingMultiReaderListMap, true) ;
      while (enumerator_17654.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (396)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17727 (enumerator_17654._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17727 = NULL ;
          while (((operand_17727 = enumerator_17727.nextObject ()))) {
            macroValidPointer (operand_17727) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17727->mValue COMMA_SOURCE_FILE_AT_LINE (398)) ;
          }
        }
        enumerator_17654.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17945 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_17945.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_17968 (enumerator_17945._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17968 = NULL ;
          while (((operand_17968 = enumerator_17968.nextObject ()))) {
            macroValidPointer (operand_17968) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_17945._key (HERE),  enumerator_17945._key (HERE),  operand_17968->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (404)) ;
          }
        }
        enumerator_17945.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
