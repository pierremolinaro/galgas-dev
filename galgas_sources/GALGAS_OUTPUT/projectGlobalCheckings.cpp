    ...
    while (enumerator_1301.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1301.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_6946 (enumerator_1301.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_6946.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6946.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).stringValue () ;
            result << " " ;
            result << enumerator_6946.current_mEnumerationName (HERE).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_22) {
        ...
        if (enumerator_1301.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7410 (enumerator_1301.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7410.hasCurrentObject ()) {
            ...
            if (enumerator_7410.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_7467 (enumerator_7410.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7467.hasCurrentObject ()) {
                result << " \?" ;
                result << function_linkForType (enumerator_7467.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (173)), inCompiler COMMA_SOURCE_FILE_AT_LINE (173)).stringValue () ;
                index_7467_.increment () ;
                enumerator_7467.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7410.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (175)), inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).stringValue () ;
            result << "<br>" ;
      ...
      const enumGalgasBool test_23 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mReaderMap (HERE).reader_count (SOURCE_FILE_AT_LINE (179)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_23) {
        result << "<tr class=\"result_line\"><td>Readers</td><td>" ;
        GALGAS_uint index_7725_ (0) ;
        if (enumerator_1301.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7725 (enumerator_1301.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7725.hasCurrentObject ()) {
            switch (enumerator_7725.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7725.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>reader</b> " ;
            result << enumerator_7725.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8142_ (0) ;
            if (enumerator_7725.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_8142 (enumerator_7725.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8142.hasCurrentObject ()) {
                result << " \?" ;
                result << function_linkForType (enumerator_8142.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (196)), inCompiler COMMA_SOURCE_FILE_AT_LINE (196)).stringValue () ;
                index_8142_.increment () ;
                enumerator_8142.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7725.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).stringValue () ;
            result << "<br>" ;
            index_7725_.increment () ;
      ...
      const enumGalgasBool test_24 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (203)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_24) {
        ...
        if (enumerator_1301.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8431 (enumerator_1301.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8431.hasCurrentObject ()) {
            switch (enumerator_8431.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8431.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8431.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8846_ (0) ;
            if (enumerator_8431.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_8846 (enumerator_8431.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_8846.hasCurrentObject ()) {
                switch (enumerator_8846.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_8846.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (226)), inCompiler COMMA_SOURCE_FILE_AT_LINE (226)).stringValue () ;
                result << " " ;
                result << enumerator_8846.current_mFormalArgumentName (HERE).stringValue () ;
                index_8846_.increment () ;
      ...
      const enumGalgasBool test_25 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mModifierMap (HERE).reader_count (SOURCE_FILE_AT_LINE (233)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_25) {
        ...
        if (enumerator_1301.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9322 (enumerator_1301.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9322.hasCurrentObject ()) {
            switch (enumerator_9322.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9322.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>modifier</b> " ;
            result << enumerator_9322.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9739_ (0) ;
            if (enumerator_9322.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9739 (enumerator_9322.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9739.hasCurrentObject ()) {
                switch (enumerator_9739.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9739.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (256)), inCompiler COMMA_SOURCE_FILE_AT_LINE (256)).stringValue () ;
                result << " " ;
                result << enumerator_9739.current_mFormalArgumentName (HERE).stringValue () ;
      ...
      const enumGalgasBool test_26 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (263)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_26) {
        ...
        if (enumerator_1301.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10246 (enumerator_1301.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10246.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10246.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10301_ (0) ;
            if (enumerator_10246.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10301 (enumerator_10246.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10301.hasCurrentObject ()) {
                switch (enumerator_10301.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10301.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (274)), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)).stringValue () ;
                result << " " ;
                result << enumerator_10301.current_mFormalArgumentName (HERE).stringValue () ;
                index_10301_.increment () ;
