...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  {
  routine_buildSemanticContext (GALGAS_string::makeEmptyString (), var_semanticDeclarationList, constinArgument_inEndOfSourceFile, var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
  }
  GALGAS_descendantClassListMap var_descendantClassListMap = GALGAS_descendantClassListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (516)) ;
  cEnumerator_unifiedTypeMap enumerator_26023 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
  while (enumerator_26023.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_26023.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (518)).operator_not (SOURCE_FILE_AT_LINE (518)).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_descendantClassListMap.addAssign_operation (enumerator_26023.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (520)), GALGAS_unifiedTypeMapProxy::constructor_searchKey (var_semanticContext.mAttribute_mTypeMap, enumerator_26023.current_lkey (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (519)) ;
    }
    enumerator_26023.gotoNextObject () ;
  }
  GALGAS_genericCategoryMethodListMap var_abstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (526)) ;
  GALGAS_genericCategoryMethodListMap var_categoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (527)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (528)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryMethodListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (529)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (530)) ;
  GALGAS_genericCategoryMethodListMap var_categoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (531)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (532)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryReaderListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (533)) ;
  GALGAS_genericCategoryMethodListMap var_abstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (534)) ;
  GALGAS_genericCategoryMethodListMap var_categoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (535)) ;
  GALGAS_genericCategoryMethodListMap var_overridingCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (536)) ;
  GALGAS_genericCategoryMethodListMap var_overridingAbstractCategoryModifierListMap = GALGAS_genericCategoryMethodListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (537)) ;
  cEnumerator_semanticDeclarationListAST enumerator_27225 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_27225.hasCurrentObject ()) {
    callCategoryMethod_buildCategoryListMaps ((const cPtr_semanticDeclarationAST *) enumerator_27225.current_mSemanticDeclaration (HERE).ptr (), var_abstractCategoryModifierListMap, var_categoryModifierListMap, var_overridingCategoryModifierListMap, var_overridingAbstractCategoryModifierListMap, var_abstractCategoryMethodListMap, var_categoryMethodListMap, var_overridingCategoryMethodListMap, var_overridingAbstractCategoryMethodListMap, var_abstractCategoryReaderListMap, var_categoryReaderListMap, var_overridingCategoryReaderListMap, var_overridingAbstractCategoryReaderListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
    enumerator_27225.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (555)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    cEnumerator_genericCategoryMethodListMap enumerator_27952 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_27952.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (558)) ;
      cEnumerator_lstringlist enumerator_28053 (enumerator_27952.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28053.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28053.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
        }
        enumerator_28053.gotoNextObject () ;
      }
      enumerator_27952.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28255 (var_categoryModifierListMap, kEnumeration_up) ;
    while (enumerator_28255.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (565)) ;
      cEnumerator_lstringlist enumerator_28356 (enumerator_28255.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28356.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28356.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
        }
        enumerator_28356.gotoNextObject () ;
      }
      enumerator_28255.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28574 (var_overridingCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_28574.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (572)) ;
      cEnumerator_lstringlist enumerator_28675 (enumerator_28574.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_28675.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_28675.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
        }
        enumerator_28675.gotoNextObject () ;
      }
      enumerator_28574.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_28908 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_28908.hasCurrentObject ()) {
      GALGAS_categoryModifierMapForGlobalCheckings var_categoryModifierMap = GALGAS_categoryModifierMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (579)) ;
      cEnumerator_lstringlist enumerator_29009 (enumerator_28908.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_29009.hasCurrentObject ()) {
        {
        var_categoryModifierMap.modifier_insertKey (enumerator_29009.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
        }
        enumerator_29009.gotoNextObject () ;
      }
      enumerator_28908.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_29271 (var_abstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_29271.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_29294 (enumerator_29271.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_29294.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29271.current_key (HERE), enumerator_29271.current_key (HERE), enumerator_29294.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
        }
        enumerator_29294.gotoNextObject () ;
      }
      enumerator_29271.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_29745 (var_overridingAbstractCategoryModifierListMap, kEnumeration_up) ;
    while (enumerator_29745.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_29768 (enumerator_29745.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_29768.hasCurrentObject ()) {
        {
        routine_checkCategoryModifierDefinitionForClass (enumerator_29745.current_key (HERE), enumerator_29745.current_key (HERE), enumerator_29768.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryModifierListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
        }
        enumerator_29768.gotoNextObject () ;
      }
      enumerator_29745.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30146 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30146.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (612)) ;
      cEnumerator_lstringlist enumerator_30243 (enumerator_30146.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30243.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30243.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) ;
        }
        enumerator_30243.gotoNextObject () ;
      }
      enumerator_30146.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30439 (var_categoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30439.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (619)) ;
      cEnumerator_lstringlist enumerator_30536 (enumerator_30439.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30536.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30536.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (621)) ;
        }
        enumerator_30536.gotoNextObject () ;
      }
      enumerator_30439.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_30748 (var_overridingCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_30748.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (626)) ;
      cEnumerator_lstringlist enumerator_30845 (enumerator_30748.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_30845.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_30845.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
        }
        enumerator_30845.gotoNextObject () ;
      }
      enumerator_30748.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31074 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31074.hasCurrentObject ()) {
      GALGAS_categoryMethodMapForGlobalCheckings var_categoryMethodMap = GALGAS_categoryMethodMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (633)) ;
      cEnumerator_lstringlist enumerator_31171 (enumerator_31074.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31171.hasCurrentObject ()) {
        {
        var_categoryMethodMap.modifier_insertKey (enumerator_31171.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (635)) ;
        }
        enumerator_31171.gotoNextObject () ;
      }
      enumerator_31074.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31425 (var_abstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31425.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_31448 (enumerator_31425.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31448.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31425.current_key (HERE), enumerator_31425.current_key (HERE), enumerator_31448.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
        }
        enumerator_31448.gotoNextObject () ;
      }
      enumerator_31425.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_31878 (var_overridingAbstractCategoryMethodListMap, kEnumeration_up) ;
    while (enumerator_31878.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_31901 (enumerator_31878.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_31901.hasCurrentObject ()) {
        {
        routine_checkCategoryMethodDefinitionForClass (enumerator_31878.current_key (HERE), enumerator_31878.current_key (HERE), enumerator_31901.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryMethodListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (654)) ;
        }
        enumerator_31901.gotoNextObject () ;
      }
      enumerator_31878.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_32429 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_32429.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (669)) ;
      cEnumerator_lstringlist enumerator_32526 (enumerator_32429.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_32526.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32526.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) ;
        }
        enumerator_32526.gotoNextObject () ;
      }
      enumerator_32429.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_32722 (var_categoryReaderListMap, kEnumeration_up) ;
    while (enumerator_32722.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (676)) ;
      cEnumerator_lstringlist enumerator_32819 (enumerator_32722.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_32819.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_32819.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (678)) ;
        }
        enumerator_32819.gotoNextObject () ;
      }
      enumerator_32722.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_33031 (var_overridingCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_33031.hasCurrentObject ()) {
      GALGAS_categoryReaderMapForGlobalCheckings var_CategoryReaderMap = GALGAS_categoryReaderMapForGlobalCheckings::constructor_emptyMap (SOURCE_FILE_AT_LINE (683)) ;
      cEnumerator_lstringlist enumerator_33128 (enumerator_33031.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33128.hasCurrentObject ()) {
        {
        var_CategoryReaderMap.modifier_insertKey (enumerator_33128.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) ;
        }
        enumerator_33128.gotoNextObject () ;
      }
      enumerator_33031.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_33355 (var_abstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_33355.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_33378 (enumerator_33355.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33378.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33355.current_key (HERE), enumerator_33355.current_key (HERE), enumerator_33378.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (691)) ;
        }
        enumerator_33378.gotoNextObject () ;
      }
      enumerator_33355.gotoNextObject () ;
    }
    cEnumerator_genericCategoryMethodListMap enumerator_33781 (var_overridingAbstractCategoryReaderListMap, kEnumeration_up) ;
    while (enumerator_33781.hasCurrentObject ()) {
      cEnumerator_lstringlist enumerator_33804 (enumerator_33781.current_mList (HERE), kEnumeration_up) ;
      while (enumerator_33804.hasCurrentObject ()) {
        {
        routine_checkCategoryReaderDefinitionForClass (enumerator_33781.current_key (HERE), enumerator_33781.current_key (HERE), enumerator_33804.current_mValue (HERE), var_descendantClassListMap, var_overridingCategoryReaderListMap, var_semanticContext.mAttribute_mTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (704)) ;
        }
        enumerator_33804.gotoNextObject () ;
      }
      enumerator_33781.gotoNextObject () ;
    }
  }
  GALGAS_string var_typeDumpString = var_semanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (716)).reader_string (SOURCE_FILE_AT_LINE (716)).operator_concat (GALGAS_string (" types.\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (716)) ;
  cEnumerator_unifiedTypeMap enumerator_34254 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
  while (enumerator_34254.hasCurrentObject ()) {
    var_typeDumpString.dotAssign_operation (GALGAS_string ("TYPE --------- @").operator_concat (enumerator_34254.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (GALGAS_string (" ------------\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)) ;
    var_typeDumpString.dotAssign_operation (GALGAS_string ("Kind: ") COMMA_SOURCE_FILE_AT_LINE (720)) ;
    const enumGalgasBool test_2 = enumerator_34254.current_mIsConcrete (HERE).operator_not (SOURCE_FILE_AT_LINE (721)).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("abstract ") COMMA_SOURCE_FILE_AT_LINE (722)) ;
    }
    if (enumerator_34254.current_mTypeKindEnum (HERE).isValid ()) {
      switch (enumerator_34254.current_mTypeKindEnum (HERE).enumValue ()) {
      case GALGAS_typeKindEnum::kNotBuilt:
        break ;
      case GALGAS_typeKindEnum::kEnum_classType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("class") COMMA_SOURCE_FILE_AT_LINE (725)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_enumType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("enum") COMMA_SOURCE_FILE_AT_LINE (726)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_listType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("list") COMMA_SOURCE_FILE_AT_LINE (727)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_sortedListType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("sorted list") COMMA_SOURCE_FILE_AT_LINE (728)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_mapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("map") COMMA_SOURCE_FILE_AT_LINE (729)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_uniqueMapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("unique map") COMMA_SOURCE_FILE_AT_LINE (730)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_mapProxyType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("map proxy") COMMA_SOURCE_FILE_AT_LINE (731)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_listMapType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("list map") COMMA_SOURCE_FILE_AT_LINE (732)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_structType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("struct") COMMA_SOURCE_FILE_AT_LINE (733)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_graphType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("graph") COMMA_SOURCE_FILE_AT_LINE (734)) ;
        } break ;
      case GALGAS_typeKindEnum::kEnum_predefinedType: {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("predefined type") COMMA_SOURCE_FILE_AT_LINE (735)) ;
        } break ;
      }
    }
    var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (737)) ;
    const enumGalgasBool test_3 = enumerator_34254.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (738)).operator_not (SOURCE_FILE_AT_LINE (738)).boolEnum () ;
    if (kBoolTrue == test_3) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Superclass: @").operator_concat (enumerator_34254.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)) ;
    }
    var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (741)) ;
    cEnumerator_constructorMap enumerator_35347 (enumerator_34254.current_mConstructorMap (HERE), kEnumeration_up) ;
    const bool bool_4 = true ;
    if (enumerator_35347.hasCurrentObject () && bool_4) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Constructors:\n") COMMA_SOURCE_FILE_AT_LINE (745)) ;
      while (enumerator_35347.hasCurrentObject () && bool_4) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  constructor ").operator_concat (enumerator_35347.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_35483 (enumerator_35347.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_35483.hasCurrentObject ()) {
          var_typeDumpString.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_35483.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (749)) ;
          enumerator_35483.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_35347.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (751)) COMMA_SOURCE_FILE_AT_LINE (751)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (751)) COMMA_SOURCE_FILE_AT_LINE (751)) ;
        enumerator_35347.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (753)) ;
    }
    cEnumerator_readerMap enumerator_35729 (enumerator_34254.current_mReaderMap (HERE), kEnumeration_up) ;
    const bool bool_5 = true ;
    if (enumerator_35729.hasCurrentObject () && bool_5) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Readers:\n") COMMA_SOURCE_FILE_AT_LINE (758)) ;
      while (enumerator_35729.hasCurrentObject () && bool_5) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  reader ").operator_concat (enumerator_35729.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)) COMMA_SOURCE_FILE_AT_LINE (760)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_35855 (enumerator_35729.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_35855.hasCurrentObject ()) {
          var_typeDumpString.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_35855.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) COMMA_SOURCE_FILE_AT_LINE (762)) COMMA_SOURCE_FILE_AT_LINE (762)) ;
          enumerator_35855.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_35729.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_SOURCE_FILE_AT_LINE (764)) ;
        enumerator_35729.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (766)) ;
    }
    cEnumerator_instanceMethodMap enumerator_36109 (enumerator_34254.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
    const bool bool_6 = true ;
    if (enumerator_36109.hasCurrentObject () && bool_6) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Methods:\n") COMMA_SOURCE_FILE_AT_LINE (771)) ;
      while (enumerator_36109.hasCurrentObject () && bool_6) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  method ").operator_concat (enumerator_36109.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)) COMMA_SOURCE_FILE_AT_LINE (773)) ;
        cEnumerator_formalParameterSignature enumerator_36232 (enumerator_36109.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_36232.hasCurrentObject ()) {
          if (enumerator_36232.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_36232.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (776)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (777)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (778)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (779)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_36232.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (781)) COMMA_SOURCE_FILE_AT_LINE (781)) COMMA_SOURCE_FILE_AT_LINE (781)) ;
          enumerator_36232.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (783)) ;
        enumerator_36109.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (785)) ;
    }
    cEnumerator_modifierMap enumerator_36763 (enumerator_34254.current_mModifierMap (HERE), kEnumeration_up) ;
    const bool bool_7 = true ;
    if (enumerator_36763.hasCurrentObject () && bool_7) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Modifiers:\n") COMMA_SOURCE_FILE_AT_LINE (790)) ;
      while (enumerator_36763.hasCurrentObject () && bool_7) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  modifier ").operator_concat (enumerator_36763.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)) ;
        cEnumerator_formalParameterSignature enumerator_36890 (enumerator_36763.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_36890.hasCurrentObject ()) {
          if (enumerator_36890.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_36890.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (795)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (796)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (797)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (798)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_36890.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)) ;
          enumerator_36890.gotoNextObject () ;
        }
        var_typeDumpString.dotAssign_operation (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (802)) ;
        enumerator_36763.gotoNextObject () ;
      }
      var_typeDumpString.dotAssign_operation (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (804)) ;
    }
    cEnumerator_instanceMethodMap enumerator_37431 (enumerator_34254.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
    const bool bool_8 = true ;
    if (enumerator_37431.hasCurrentObject () && bool_8) {
      var_typeDumpString.dotAssign_operation (GALGAS_string ("Class methods:\n") COMMA_SOURCE_FILE_AT_LINE (809)) ;
      while (enumerator_37431.hasCurrentObject () && bool_8) {
        var_typeDumpString.dotAssign_operation (GALGAS_string ("  class method ").operator_concat (enumerator_37431.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (811)) COMMA_SOURCE_FILE_AT_LINE (811)) COMMA_SOURCE_FILE_AT_LINE (811)) ;
        cEnumerator_formalParameterSignature enumerator_37566 (enumerator_37431.current_mParameterList (HERE), kEnumeration_up) ;
        while (enumerator_37566.hasCurrentObject ()) {
          if (enumerator_37566.current_mFormalArgumentPassingMode (HERE).isValid ()) {
            switch (enumerator_37566.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
            case GALGAS_formalArgumentPassingModeAST::kNotBuilt:
              break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?\?") COMMA_SOURCE_FILE_AT_LINE (814)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?") COMMA_SOURCE_FILE_AT_LINE (815)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" \?!") COMMA_SOURCE_FILE_AT_LINE (816)) ;
              } break ;
            case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
              var_typeDumpString.dotAssign_operation (GALGAS_string (" !") COMMA_SOURCE_FILE_AT_LINE (817)) ;
              } break ;
            }
          }
          var_typeDumpString.dotAssign_operation (GALGAS_string ("@").operator_concat (enumerator_37566.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (819)) COMMA_SOURCE_FILE_AT_LINE (819)) COMMA_SOURCE_FILE_AT_LINE (819)) ;
    ...
    enumerator_34254.gotoNextObject () ;
  }
  GALGAS_string var_typeDumpFilePath = constinArgument_inProjectSourceFilePath.operator_concat (GALGAS_string (".txt") COMMA_SOURCE_FILE_AT_LINE (827)) ;
  GALGAS_bool joker_38214_0 ; // Joker input parameter
  var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_38214_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
}
