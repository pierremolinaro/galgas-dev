    ...
    while (enumerator_1301.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_25) {
        ...
        if (enumerator_1301.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9297 (enumerator_1301.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9297.hasCurrentObject ()) {
            switch (enumerator_9297.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9297.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>modifier</b> " ;
            result << enumerator_9297.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9714_ (0) ;
            if (enumerator_9297.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9714 (enumerator_9297.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9714.hasCurrentObject ()) {
                switch (enumerator_9714.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9714.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (256)), inCompiler COMMA_SOURCE_FILE_AT_LINE (256)).stringValue () ;
      ...
      if (kBoolTrue == test_26) {
        ...
        GALGAS_uint index_10196_ (0) ;
        if (enumerator_1301.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10196 (enumerator_1301.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10196.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10196.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10251_ (0) ;
            if (enumerator_10196.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10251 (enumerator_10196.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10251.hasCurrentObject ()) {
                switch (enumerator_10251.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10251.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (274)), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)).stringValue () ;
                index_10251_.increment () ;
                enumerator_10251.gotoNextObject () ;
              }
            }
            result << "<br>" ;
            index_10196_.increment () ;
