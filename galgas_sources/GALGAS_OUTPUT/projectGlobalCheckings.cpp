    ...
    while (enumerator_1275.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_18) {
        ...
        if (enumerator_1275.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_functionSignature enumerator_6606 (enumerator_1275.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6606.hasCurrentObject ()) {
            result << "<span class=\"selecteur\">\?" ;
            const enumGalgasBool test_19 = GALGAS_bool (kIsNotEqual, enumerator_6606.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_19) {
              result << enumerator_6606.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 156)).stringValue () ;
            }else if (kBoolFalse == test_19) {
            }
            result << "</span>" ;
            result << function_linkForType (enumerator_6606.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 157)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 157)).stringValue () ;
            result << " " ;
            result << enumerator_6606.current_mFormalArgumentName (HERE).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1275.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_6976 (enumerator_1275.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_6976.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6976.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 164)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 164)).stringValue () ;
            result << " " ;
            result << enumerator_6976.current_mEnumerationName (HERE).stringValue () ;
            result << "<br>" ;
      ...
      if (kBoolTrue == test_22) {
        ...
        if (enumerator_1275.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7407 (enumerator_1275.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7407.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7407.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7481_ (0) ;
            if (enumerator_7407.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_functionSignature enumerator_7481 (enumerator_7407.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7481.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; <span class=\"selecteur\">\?" ;
                const enumGalgasBool test_23 = GALGAS_bool (kIsNotEqual, enumerator_7481.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_23) {
                  result << enumerator_7481.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)).stringValue () ;
                }else if (kBoolFalse == test_23) {
                }
                result << function_linkForType (enumerator_7481.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 179)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 179)).stringValue () ;
                result << "</span> " ;
                result << enumerator_7481.current_mFormalArgumentName (HERE).stringValue () ;
                index_7481_.increment () ;
                enumerator_7481.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7407.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 181)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 181)).stringValue () ;
            result << "<br><br>" ;
      ...
      if (kBoolTrue == test_24) {
        ...
        GALGAS_uint index_7916_ (0) ;
        if (enumerator_1275.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7916 (enumerator_1275.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7916.hasCurrentObject ()) {
            switch (enumerator_7916.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7916.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>getter</b> " ;
            result << enumerator_7916.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8321_ (0) ;
            if (enumerator_7916.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_functionSignature enumerator_8321 (enumerator_7916.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8321.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?<span class=\"selecteur\">" ;
                const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_8321.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_25) {
                  result << enumerator_8321.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 203)).stringValue () ;
                }else if (kBoolFalse == test_25) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_8321.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 204)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 204)).stringValue () ;
                result << " " ;
                result << enumerator_8321.current_mFormalArgumentName (HERE).stringValue () ;
                index_8321_.increment () ;
                enumerator_8321.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7916.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 206)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 206)).stringValue () ;
            result << "<br><br>" ;
            index_7916_.increment () ;
      ...
      if (kBoolTrue == test_26) {
        ...
        if (enumerator_1275.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8786 (enumerator_1275.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8786.hasCurrentObject ()) {
            switch (enumerator_8786.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8786.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8786.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9188_ (0) ;
            if (enumerator_8786.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9188 (enumerator_8786.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9188.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9188.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, enumerator_9188.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_27) {
                  result << enumerator_9188.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 235)).stringValue () ;
                }else if (kBoolFalse == test_27) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_9188.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 236)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 236)).stringValue () ;
                result << " " ;
                result << enumerator_9188.current_mFormalArgumentName (HERE).stringValue () ;
      ...
      if (kBoolTrue == test_28) {
        ...
        GALGAS_uint index_9864_ (0) ;
        if (enumerator_1275.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9864 (enumerator_1275.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9864.hasCurrentObject ()) {
            switch (enumerator_9864.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9864.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>setter</b> " ;
            result << enumerator_9864.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10266_ (0) ;
            if (enumerator_9864.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10266 (enumerator_9864.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10266.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10266.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " <span class=\"selecteur\">\?" ;
                ...
                const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, enumerator_10266.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_29) {
                  result << enumerator_10266.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 267)).stringValue () ;
                }else if (kBoolFalse == test_29) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_10266.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 268)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 268)).stringValue () ;
                result << " " ;
                result << enumerator_10266.current_mFormalArgumentName (HERE).stringValue () ;
                index_10266_.increment () ;
                enumerator_10266.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_9864_.increment () ;
      ...
      if (kBoolTrue == test_30) {
        ...
        GALGAS_uint index_10951_ (0) ;
        if (enumerator_1275.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10951 (enumerator_1275.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10951.hasCurrentObject ()) {
            result << "<b>proc</b> @" ;
            result << enumerator_1275.current_lkey (HERE).mAttribute_string.stringValue () ;
            result << " " ;
            result << enumerator_10951.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_11037_ (0) ;
            if (enumerator_10951.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_11037 (enumerator_10951.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_11037.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_11037.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " <span class=\"selecteur\">\?" ;
                ...
                const enumGalgasBool test_31 = GALGAS_bool (kIsNotEqual, enumerator_11037.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_31) {
                  result << enumerator_11037.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 287)).stringValue () ;
                }else if (kBoolFalse == test_31) {
                }
                result << "</span>" ;
                result << function_linkForType (enumerator_11037.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 288)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 288)).stringValue () ;
                result << " " ;
                result << enumerator_11037.current_mFormalArgumentName (HERE).stringValue () ;
                index_11037_.increment () ;
                enumerator_11037.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_10951_.increment () ;
