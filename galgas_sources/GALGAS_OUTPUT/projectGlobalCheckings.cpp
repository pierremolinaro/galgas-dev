  ...
  const GGS_unifiedTypeMapProxyList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (139)) ;
  {
    ...
    while (((operand_7207 = enumerator_7207.nextObject ()))) {
      ...
      if (cond_8514.isBuiltAndTrue ()) {
        ...
        GGS_stringset  automatic_var_7703_14 ;
        GGS_lstringlist  automatic_var_7703_15 ;
        GGS_typedAttributeList  automatic_var_7703_16 ;
        GGS_mapSearchMethodListAST  automatic_var_7703_17 ;
        GGS_mapSearchMethodListAST  automatic_var_7703_18 ;
        GGS_withAccessorMap  automatic_var_7703_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_7703_0, automatic_var_7703_1, automatic_var_7703_2, automatic_var_7703_3, automatic_var_7703_4, automatic_var_7703_5, automatic_var_7703_6, automatic_var_7703_7, automatic_var_7703_8, automatic_var_7703_9, automatic_var_7703_10, automatic_var_7703_11, automatic_var_7703_12, automatic_var_7703_13, automatic_var_7703_14, automatic_var_7703_15, automatic_var_7703_16, automatic_var_7703_17, automatic_var_7703_18, automatic_var_7703_19 COMMA_SOURCE_FILE_AT_LINE (149)) ;
        }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13865 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13865.isBuiltAndTrue ()) {
    ...
    }
    {
      ...
      while (enumerator_10524.hasCurrentObject ()) {
        ...
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_10597 (enumerator_10524._mList (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_10597 = NULL ;
          while (((operand_10597 = enumerator_10597.nextObject ()))) {
            macroValidPointer (operand_10597) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10597->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (214)) ;
          }
        }
    ...
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_10805 (var_cas_categoryMethodListMap, true) ;
      while (enumerator_10805.hasCurrentObject ()) {
        ...
        {
          GGS_multiMethodListAST::cEnumerator enumerator_10878 (enumerator_10805._mList (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_10878 = NULL ;
          while (((operand_10878 = enumerator_10878.nextObject ()))) {
            macroValidPointer (operand_10878) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10878->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (221)) ;
          }
        }
        enumerator_10805.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_11094 (var_cas_overridingCategoryMethodListMap, true) ;
      while (enumerator_11094.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_11167 (enumerator_11094._mList (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_11167 = NULL ;
          while (((operand_11167 = enumerator_11167.nextObject ()))) {
            macroValidPointer (operand_11167) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_11167->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
        }
        enumerator_11094.next () ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_11486 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_11486.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_11509 (enumerator_11486._mList (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_11509 = NULL ;
          while (((operand_11509 = enumerator_11509.nextObject ()))) {
            macroValidPointer (operand_11509) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_11486._key (HERE),  enumerator_11486._key (HERE),  operand_11509->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (236)) ;
          }
        }
        enumerator_11486.next () ;
      }
    }
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12192 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_12192 = NULL ;
      while (((operand_12192 = enumerator_12192.nextObject ()))) {
        macroValidPointer (operand_12192) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_12192->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_12192->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (255)).reader_mCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_12192->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (256)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_12678 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_12678.hasCurrentObject ()) {
        ...
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_12751 (enumerator_12678._mList (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_12751 = NULL ;
          while (((operand_12751 = enumerator_12751.nextObject ()))) {
            macroValidPointer (operand_12751) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12751->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (262)) ;
          }
        }
        enumerator_12678.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_12959 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_12959.hasCurrentObject ()) {
        ...
        {
          GGS_multiReaderListAST::cEnumerator enumerator_13032 (enumerator_12959._mList (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_13032 = NULL ;
          while (((operand_13032 = enumerator_13032.nextObject ()))) {
            macroValidPointer (operand_13032) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13032->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (269)) ;
          }
        }
        enumerator_12959.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_13248 (var_cas_overridingCategoryReaderListMap, true) ;
      while (enumerator_13248.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_13321 (enumerator_13248._mList (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_13321 = NULL ;
          while (((operand_13321 = enumerator_13321.nextObject ()))) {
            macroValidPointer (operand_13321) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13321->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (276)) ;
          }
        }
        enumerator_13248.next () ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_13562 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_13562.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_13585 (enumerator_13562._mList (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_13585 = NULL ;
          while (((operand_13585 = enumerator_13585.nextObject ()))) {
            macroValidPointer (operand_13585) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_13562._key (HERE),  enumerator_13562._key (HERE),  operand_13585->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (282)) ;
          }
        }
        enumerator_13562.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
