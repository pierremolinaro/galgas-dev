  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1239.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_23) {
        ...
        if (enumerator_1239.current_mReaderMap (HERE).isValid ()) {
          ...
          while (enumerator_7870.hasCurrentObject ()) {
            ...
            GALGAS_uint index_8272_ (0) ;
            if (enumerator_7870.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_8272 (enumerator_7870.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8272.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_8272.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)).stringValue () ;
                result << " " ;
                result << enumerator_8272.current_mFormalParameterName (HERE).stringValue () ;
                index_8272_.increment () ;
      ...
      if (kBoolTrue == test_24) {
        ...
        GALGAS_uint index_8610_ (0) ;
        if (enumerator_1239.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8610 (enumerator_1239.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8610.hasCurrentObject ()) {
            switch (enumerator_8610.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8610.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8610.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9009_ (0) ;
            if (enumerator_8610.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9009 (enumerator_8610.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9009.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9009.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_9009.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)).stringValue () ;
                result << " " ;
                result << enumerator_9009.current_mFormalArgumentName (HERE).stringValue () ;
                index_9009_.increment () ;
                enumerator_9009.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_8610_.increment () ;
      ...
      if (kBoolTrue == test_25) {
        ...
        if (enumerator_1239.current_mModifierMap (HERE).isValid ()) {
          ...
          while (enumerator_9502.hasCurrentObject ()) {
            ...
            GALGAS_uint index_9903_ (0) ;
            if (enumerator_9502.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9903 (enumerator_9502.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9903.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9903.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9903.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)).stringValue () ;
                result << " " ;
                result << enumerator_9903.current_mFormalArgumentName (HERE).stringValue () ;
                index_9903_.increment () ;
      ...
      if (kBoolTrue == test_26) {
        ...
        GALGAS_uint index_10410_ (0) ;
        if (enumerator_1239.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10410 (enumerator_1239.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10410.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10410.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10480_ (0) ;
            if (enumerator_10410.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10480 (enumerator_10410.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10480.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10480.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10480.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)).stringValue () ;
                result << " " ;
                result << enumerator_10480.current_mFormalArgumentName (HERE).stringValue () ;
                index_10480_.increment () ;
                enumerator_10480.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_10410_.increment () ;
