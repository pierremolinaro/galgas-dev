...
internalSubListWithRange (GGS_multiMethodListAST & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mMultiMethodName, ptr->mCategoryFormalParameterList) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
internalSubListWithRange (GGS_overridingMultiMethodListAST & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mOverridingMultiMethodMethodName, ptr->mOverridingCategoryFormalParameterList) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
category_method__semanticDeclarationAST__buildMultiMethodListMaps (C_Compiler &,
                                const cPtr_semanticDeclarationAST * operand_4951,
...
//---------------------------------------------------------------------------*
//                                                                           *
//    Category method '@abstracMultiMethodAST.buildMultiMethodListMaps'      *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__abstracMultiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_abstracMultiMethodAST * operand_5314,
                                GGS_abstractMultiMethodListMapAST & var_cas_ioAbstractMultiMethodListMapAST,
                                GGS_multiMethodListMapAST & /* var_cas_ioMultiMethodListMap */,
                                GGS_overridingMultiMethodListMapAST & /* var_cas_ioOverridingMultiMethodListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5314 != NULL) {
    var_cas_ioAbstractMultiMethodListMapAST.addAssign_operation (operand_5314->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (106)), operand_5314->mAbstractMultiMethodName, operand_5314->mAbstractCategoryFormalParameterList) ;
  }
}

//---------------------------------------------------------------------------*
//                                                                           *
//        Category method '@multiMethodAST.buildMultiMethodListMaps'         *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__multiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_multiMethodAST * operand_5800,
                                GGS_abstractMultiMethodListMapAST & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_multiMethodListMapAST & var_cas_ioMultiMethodListMap,
                                GGS_overridingMultiMethodListMapAST & /* var_cas_ioOverridingMultiMethodListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5800 != NULL) {
    var_cas_ioMultiMethodListMap.addAssign_operation (operand_5800->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120)), operand_5800->mMultiMethodName, operand_5800->mCategoryFormalParameterList) ;
  }
}

//---------------------------------------------------------------------------*
//                                                                           *
//   Category method '@overridingMultiMethodAST.buildMultiMethodListMaps'    *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__overridingMultiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_overridingMultiMethodAST * operand_6269,
                                GGS_abstractMultiMethodListMapAST & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_multiMethodListMapAST & /* var_cas_ioMultiMethodListMap */,
                                GGS_overridingMultiMethodListMapAST & var_cas_ioOverridingMultiMethodListMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6269 != NULL) {
    var_cas_ioOverridingMultiMethodListMap.addAssign_operation (operand_6269->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134)), operand_6269->mOverridingMultiMethodMethodName, operand_6269->mOverridingCategoryFormalParameterList) ;
  }
}
...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8581 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (177))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_8581.isBuiltAndTrue ()) {
  ...
  }else if (cond_8581.isBuiltAndFalse ()) {
...
void routine_checkMultiMethodDefinitionForClass (C_Compiler & inLexique,
                                ...
                                const GGS_overridingMultiMethodListMapAST  var_cas_inOverridingMultiMethodListMap,
                                const GGS_unifiedTypeMap   var_cas_inUnifiedTypeMap
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_checkMultiMethodDefinitionForClass at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  const GGS_unifiedTypeMapProxyList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (195)) ;
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_9172 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_9172 = NULL ;
    while (((operand_9172 = enumerator_9172.nextObject ()))) {
      macroValidPointer (operand_9172) ;
      const GGS_lstring  var_cas_descendantClassName = operand_9172->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (197)) ;
      GGS_overridingMultiMethodListAST  var_cas_overridingMethods = var_cas_inOverridingMultiMethodListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiMethodListAST::cEnumerator enumerator_9420 (var_cas_overridingMethods, true) ;
        const GGS_overridingMultiMethodListAST::cElement * operand_9420 = NULL ;
        while (((operand_9420 = enumerator_9420.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_9420) ;
          var_cas_found = (var_cas_inAbstractMultiMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (operand_9420->mOverridingMultiMethodMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (201))) ;
        }
      }
      const GGS_bool cond_10470 = (var_cas_found).operator_not () ;
      if (cond_10470.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_9674_0 ;
        GGS_typeKindEnum automatic_var_9674_1 ;
        GGS_typedAttributeList  automatic_var_9674_2 ;
        GGS_attributeMap  automatic_var_9674_3 ;
        GGS_typedAttributeList  automatic_var_9674_4 ;
        GGS_constructorMap  automatic_var_9674_5 ;
        GGS_readerMap  automatic_var_9674_6 ;
        GGS_modifierMap  automatic_var_9674_7 ;
        GGS_instanceMethodMap  automatic_var_9674_8 ;
        GGS_classMethodMap  automatic_var_9674_9 ;
        GGS_enumerationDescriptorList  automatic_var_9674_10 ;
        GGS_uint  automatic_var_9674_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_9674_12 ;
        GGS_nativeAttributeList  automatic_var_9674_13 ;
        GGS_stringset  automatic_var_9674_14 ;
        GGS_lstringlist  automatic_var_9674_15 ;
        GGS_typedAttributeList  automatic_var_9674_16 ;
        GGS_mapSearchMethodListAST  automatic_var_9674_17 ;
        GGS_mapSearchMethodListAST  automatic_var_9674_18 ;
        GGS_withAccessorMap  automatic_var_9674_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_9674_0, automatic_var_9674_1, automatic_var_9674_2, automatic_var_9674_3, automatic_var_9674_4, automatic_var_9674_5, automatic_var_9674_6, automatic_var_9674_7, automatic_var_9674_8, automatic_var_9674_9, automatic_var_9674_10, automatic_var_9674_11, automatic_var_9674_12, automatic_var_9674_13, automatic_var_9674_14, automatic_var_9674_15, automatic_var_9674_16, automatic_var_9674_17, automatic_var_9674_18, automatic_var_9674_19 COMMA_SOURCE_FILE_AT_LINE (205)) ;
        }
        const GGS_bool cond_10161 = (var_cas_isConcrete).operator_not () ;
        if (cond_10161.isBuiltAndTrue ()) {
          ::routine_checkMultiMethodDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)),  var_cas_inAbstractMultiMethodName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingMultiMethodListMap,  var_cas_inUnifiedTypeMap COMMA_SOURCE_FILE_AT_LINE (208)) ;
        }else if (cond_10161.isBuiltAndFalse ()) {
          var_cas_inAbstractMultiMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract multi method '")).operator_concat (var_cas_inAbstractMultiMethodName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this method")) COMMA_SOURCE_FILE_AT_LINE (220)) ;
        }
      }
    }
  }
...
void routine_checkMultiReaderDefinitionForClass (C_Compiler & inLexique,
                                ...
                                const GGS_descendantClassListMap  var_cas_inDescendantClassListMap,
                                const GGS_overridingMultiReaderListMapAST  var_cas_inOverridingMultiReaderListMap,
                                const GGS_unifiedTypeMap   var_cas_inUnifiedTypeMap
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_checkMultiReaderDefinitionForClass at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  const GGS_unifiedTypeMapProxyList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (235)) ;
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_11027 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_11027 = NULL ;
    while (((operand_11027 = enumerator_11027.nextObject ()))) {
      macroValidPointer (operand_11027) ;
      GGS_lstring  var_cas_descendantClassName = operand_11027->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
      GGS_overridingMultiReaderListAST  var_cas_overridingReaders = var_cas_inOverridingMultiReaderListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (238)) COMMA_SOURCE_FILE_AT_LINE (238)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiReaderListAST::cEnumerator enumerator_11269 (var_cas_overridingReaders, true) ;
        const GGS_overridingMultiReaderListAST::cElement * operand_11269 = NULL ;
        while (((operand_11269 = enumerator_11269.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_11269) ;
          var_cas_found = (var_cas_inAbstractMultiReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241))).operator_isEqual (operand_11269->mOverridingMultiReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241))) ;
        }
      }
      const GGS_bool cond_12316 = (var_cas_found).operator_not () ;
      if (cond_12316.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_11517_0 ;
        GGS_typeKindEnum automatic_var_11517_1 ;
        GGS_typedAttributeList  automatic_var_11517_2 ;
        GGS_attributeMap  automatic_var_11517_3 ;
        GGS_typedAttributeList  automatic_var_11517_4 ;
        GGS_constructorMap  automatic_var_11517_5 ;
        GGS_readerMap  automatic_var_11517_6 ;
        GGS_modifierMap  automatic_var_11517_7 ;
        GGS_instanceMethodMap  automatic_var_11517_8 ;
        GGS_classMethodMap  automatic_var_11517_9 ;
        GGS_enumerationDescriptorList  automatic_var_11517_10 ;
        GGS_uint  automatic_var_11517_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_11517_12 ;
        GGS_nativeAttributeList  automatic_var_11517_13 ;
        GGS_stringset  automatic_var_11517_14 ;
        GGS_lstringlist  automatic_var_11517_15 ;
        GGS_typedAttributeList  automatic_var_11517_16 ;
        GGS_mapSearchMethodListAST  automatic_var_11517_17 ;
        GGS_mapSearchMethodListAST  automatic_var_11517_18 ;
        GGS_withAccessorMap  automatic_var_11517_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_11517_0, automatic_var_11517_1, automatic_var_11517_2, automatic_var_11517_3, automatic_var_11517_4, automatic_var_11517_5, automatic_var_11517_6, automatic_var_11517_7, automatic_var_11517_8, automatic_var_11517_9, automatic_var_11517_10, automatic_var_11517_11, automatic_var_11517_12, automatic_var_11517_13, automatic_var_11517_14, automatic_var_11517_15, automatic_var_11517_16, automatic_var_11517_17, automatic_var_11517_18, automatic_var_11517_19 COMMA_SOURCE_FILE_AT_LINE (245)) ;
        }
        const GGS_bool cond_12004 = (var_cas_isConcrete).operator_not () ;
        if (cond_12004.isBuiltAndTrue ()) {
          ::routine_checkMultiReaderDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (250)),  var_cas_inAbstractMultiReaderName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingMultiReaderListMap,  var_cas_inUnifiedTypeMap COMMA_SOURCE_FILE_AT_LINE (248)) ;
        }else if (cond_12004.isBuiltAndFalse ()) {
          var_cas_inAbstractMultiReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract category reader '")).operator_concat (var_cas_inAbstractMultiReaderName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this reader")) COMMA_SOURCE_FILE_AT_LINE (260)) ;
        }
      }
    }
  }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_semanticDeclarationList COMMA_SOURCE_FILE_AT_LINE (273)) ;
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12777 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (275)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_12777 = NULL ;
    while (((operand_12777 = enumerator_12777.nextObject ()))) {
      macroValidPointer (operand_12777) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_12777->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (276))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (280)) ;
  GGS_descendantClassListMap var_cas_descendantClassListMap = GGS_descendantClassListMap::constructor_emptyMap () ;
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_13300 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_13300 = NULL ;
    while (((operand_13300 = enumerator_13300.nextObject ()))) {
      macroValidPointer (operand_13300) ;
      const GGS_bool cond_13504 = (operand_13300->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_not () ;
      if (cond_13504.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_13300->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_13300->mKey COMMA_SOURCE_FILE_AT_LINE (292))) ;
      }
    }
  }
  GGS_abstractMultiMethodListMapAST var_cas_abstractMultiMethodListMap = GGS_abstractMultiMethodListMapAST::constructor_emptyMap () ;
  GGS_multiMethodListMapAST var_cas_multiMethodListMap = GGS_multiMethodListMapAST::constructor_emptyMap () ;
  GGS_overridingMultiMethodListMapAST var_cas_overridingMultiMethodListMap = GGS_overridingMultiMethodListMapAST::constructor_emptyMap () ;
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_13776 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (300)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_13776 = NULL ;
    while (((operand_13776 = enumerator_13776.nextObject ()))) {
      macroValidPointer (operand_13776) ;
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_13846 (operand_13776->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (301)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (301)), true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_13846 = NULL ;
        while (((operand_13846 = enumerator_13846.nextObject ()))) {
          macroValidPointer (operand_13846) ;
          { typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps method = findCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps (operand_13846->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_13846->mSemanticDeclaration (HERE), var_cas_abstractMultiMethodListMap, var_cas_multiMethodListMap, var_cas_overridingMultiMethodListMap COMMA_SOURCE_FILE_AT_LINE (302)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_17570 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (310))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_17570.isBuiltAndTrue ()) {
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_14277 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_14277.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) ;
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_14350 (enumerator_14277._mList (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_14350 = NULL ;
          while (((operand_14350 = enumerator_14350.nextObject ()))) {
            macroValidPointer (operand_14350) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_14350->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (315)) ;
          }
        }
        enumerator_14277.next () ;
      }
    }
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_14555 (var_cas_multiMethodListMap, true) ;
      while (enumerator_14555.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (320)) ;
        {
          GGS_multiMethodListAST::cEnumerator enumerator_14628 (enumerator_14555._mList (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_14628 = NULL ;
          while (((operand_14628 = enumerator_14628.nextObject ()))) {
            macroValidPointer (operand_14628) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_14628->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (322)) ;
          }
        }
        enumerator_14555.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_14841 (var_cas_overridingMultiMethodListMap, true) ;
      while (enumerator_14841.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (327)) ;
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_14914 (enumerator_14841._mList (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_14914 = NULL ;
          while (((operand_14914 = enumerator_14914.nextObject ()))) {
            macroValidPointer (operand_14914) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_14914->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (329)) ;
          }
        }
    ...
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_15227 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_15227.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_15250 (enumerator_15227._mList (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_15250 = NULL ;
          while (((operand_15250 = enumerator_15250.nextObject ()))) {
            macroValidPointer (operand_15250) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_15227._key (HERE),  enumerator_15227._key (HERE),  operand_15250->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingMultiMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (337)) ;
          }
        }
        enumerator_15227.next () ;
      }
    }
    GGS_abstractMultiReaderListMapAST var_cas_abstractMultiReaderListMap = GGS_abstractMultiReaderListMapAST::constructor_emptyMap () ;
    GGS_multiReaderListMapAST var_cas_categoryReaderListMap = GGS_multiReaderListMapAST::constructor_emptyMap () ;
    GGS_overridingMultiReaderListMapAST var_cas_overridingMultiReaderListMap = GGS_overridingMultiReaderListMapAST::constructor_emptyMap () ;
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_15924 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (354)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_15924 = NULL ;
      while (((operand_15924 = enumerator_15924.nextObject ()))) {
        macroValidPointer (operand_15924) ;
        var_cas_abstractMultiReaderListMap.dotAssign_operation (operand_15924->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (355)).reader_mAbstractMultiReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (355))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_15924->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (356)).reader_mMultiReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (356))) ;
        var_cas_overridingMultiReaderListMap.dotAssign_operation (operand_15924->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (357)).reader_mOverridingMultiReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_16392 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_16392.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (361)) ;
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_16465 (enumerator_16392._mList (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_16465 = NULL ;
          while (((operand_16465 = enumerator_16465.nextObject ()))) {
            macroValidPointer (operand_16465) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_16465->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (363)) ;
          }
        }
        enumerator_16392.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_16673 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_16673.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (368)) ;
        {
          GGS_multiReaderListAST::cEnumerator enumerator_16746 (enumerator_16673._mList (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_16746 = NULL ;
          while (((operand_16746 = enumerator_16746.nextObject ()))) {
            macroValidPointer (operand_16746) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_16746->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (370)) ;
          }
        }
        enumerator_16673.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_16959 (var_cas_overridingMultiReaderListMap, true) ;
      while (enumerator_16959.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_17032 (enumerator_16959._mList (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_17032 = NULL ;
          while (((operand_17032 = enumerator_17032.nextObject ()))) {
            macroValidPointer (operand_17032) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17032->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (377)) ;
          }
        }
        enumerator_16959.next () ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_17270 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_17270.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_17293 (enumerator_17270._mList (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_17293 = NULL ;
          while (((operand_17293 = enumerator_17293.nextObject ()))) {
            macroValidPointer (operand_17293) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_17270._key (HERE),  enumerator_17270._key (HERE),  operand_17293->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingMultiReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (383)) ;
          }
        }
        enumerator_17270.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
static void prologueRoutineFor_projectGlobalCheckings (void) {
  ...
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__abstracMultiMethodAST__buildMultiMethodListMaps, gClassInfoFor__abstracMultiMethodAST.slotID ()) ;
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__multiMethodAST__buildMultiMethodListMaps, gClassInfoFor__multiMethodAST.slotID ()) ;
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__overridingMultiMethodAST__buildMultiMethodListMaps, gClassInfoFor__overridingMultiMethodAST.slotID ()) ;
}
