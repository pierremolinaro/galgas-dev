...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_9500 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_9500 = NULL ;
    while (((operand_9500 = enumerator_9500.nextObject ()))) {
      macroValidPointer (operand_9500) ;
      const GGS_bool cond_9721 = (operand_9500->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (193))).operator_not () ;
      if (cond_9721.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_9500->mInfo.mSuperType.reader_keyString (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_9500->mKey COMMA_SOURCE_FILE_AT_LINE (196))) ;
      }
    }
  }
  const GGS_bool cond_13876 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13876.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_10041 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_10041 = NULL ;
      while (((operand_10041 = enumerator_10041.nextObject ()))) {
        macroValidPointer (operand_10041) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_10041->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
        var_cas_categoryMethodListMap.dotAssign_operation (operand_10041->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_mCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (207))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_10041->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (208))) ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_10527 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_10527.hasCurrentObject ()) {
        ...
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_10601 (enumerator_10527._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_10601 = NULL ;
          while (((operand_10601 = enumerator_10601.nextObject ()))) {
            macroValidPointer (operand_10601) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10601->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (214)) ;
          }
        }
        enumerator_10527.next () ;
      }
    }
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_10809 (var_cas_categoryMethodListMap, true) ;
      while (enumerator_10809.hasCurrentObject ()) {
        ...
        {
          GGS_multiMethodListAST::cEnumerator enumerator_10883 (enumerator_10809._object (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_10883 = NULL ;
          while (((operand_10883 = enumerator_10883.nextObject ()))) {
            macroValidPointer (operand_10883) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10883->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (221)) ;
          }
        }
        enumerator_10809.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_11099 (var_cas_overridingCategoryMethodListMap, true) ;
      while (enumerator_11099.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_11173 (enumerator_11099._object (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_11173 = NULL ;
          while (((operand_11173 = enumerator_11173.nextObject ()))) {
            macroValidPointer (operand_11173) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_11173->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (228)) ;
          }
        }
        enumerator_11099.next () ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_11492 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_11492.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_11516 (enumerator_11492._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_11516 = NULL ;
          while (((operand_11516 = enumerator_11516.nextObject ()))) {
            macroValidPointer (operand_11516) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_11492._key (HERE),  enumerator_11492._key (HERE),  operand_11516->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (236)) ;
          }
        }
        enumerator_11492.next () ;
      }
    }
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12199 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_12199 = NULL ;
      while (((operand_12199 = enumerator_12199.nextObject ()))) {
        macroValidPointer (operand_12199) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_12199->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_12199->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (255)).reader_mCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_12199->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (256)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_12685 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_12685.hasCurrentObject ()) {
        ...
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_12759 (enumerator_12685._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_12759 = NULL ;
          while (((operand_12759 = enumerator_12759.nextObject ()))) {
            macroValidPointer (operand_12759) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12759->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (262)) ;
          }
        }
        enumerator_12685.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_12967 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_12967.hasCurrentObject ()) {
        ...
        {
          GGS_multiReaderListAST::cEnumerator enumerator_13041 (enumerator_12967._object (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_13041 = NULL ;
          while (((operand_13041 = enumerator_13041.nextObject ()))) {
            macroValidPointer (operand_13041) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13041->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (269)) ;
          }
        }
        enumerator_12967.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_13257 (var_cas_overridingCategoryReaderListMap, true) ;
      while (enumerator_13257.hasCurrentObject ()) {
        ...
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_13331 (enumerator_13257._object (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_13331 = NULL ;
          while (((operand_13331 = enumerator_13331.nextObject ()))) {
            macroValidPointer (operand_13331) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13331->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (276)) ;
          }
        }
    ...
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_13572 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_13572.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_13596 (enumerator_13572._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_13596 = NULL ;
          while (((operand_13596 = enumerator_13596.nextObject ()))) {
            macroValidPointer (operand_13596) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_13572._key (HERE),  enumerator_13572._key (HERE),  operand_13596->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (282)) ;
          }
        }
