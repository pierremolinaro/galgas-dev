    ...
    while (enumerator_1239.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_19) {
        ...
        if (enumerator_1239.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_6808 (enumerator_1239.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6808.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6808.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 155)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 155)).stringValue () ;
            result << " " ;
            result << enumerator_6808.current_mFormalParameterName (HERE).stringValue () ;
            result << "<br><br>" ;
      ...
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1239.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_7058 (enumerator_1239.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_7058.hasCurrentObject ()) {
            result << function_linkForType (enumerator_7058.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 162)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 162)).stringValue () ;
            result << " " ;
            result << enumerator_7058.current_mEnumerationName (HERE).stringValue () ;
            result << "<br><br>" ;
      ...
      if (kBoolTrue == test_22) {
        ...
        GALGAS_uint index_7491_ (0) ;
        if (enumerator_1239.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7491 (enumerator_1239.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7491.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7491.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7563_ (0) ;
            if (enumerator_7491.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_7563 (enumerator_7491.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7563.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_7563.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 176)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 176)).stringValue () ;
                result << " " ;
                result << enumerator_7563.current_mFormalParameterName (HERE).stringValue () ;
                index_7563_.increment () ;
                enumerator_7563.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7491.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 178)).stringValue () ;
            result << "<br><br>" ;
            index_7491_.increment () ;
      ...
      if (kBoolTrue == test_23) {
        ...
        if (enumerator_1239.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7870 (enumerator_1239.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7870.hasCurrentObject ()) {
            switch (enumerator_7870.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7870.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>getter</b> " ;
            result << enumerator_7870.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8273_ (0) ;
            if (enumerator_7870.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_8273 (enumerator_7870.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8273.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_8273.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 200)).stringValue () ;
                result << " " ;
                result << enumerator_8273.current_mFormalParameterName (HERE).stringValue () ;
                index_8273_.increment () ;
                enumerator_8273.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7870.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 202)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 202)).stringValue () ;
            result << "<br><br>" ;
      ...
      if (kBoolTrue == test_24) {
        ...
        GALGAS_uint index_8611_ (0) ;
        if (enumerator_1239.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8611 (enumerator_1239.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8611.hasCurrentObject ()) {
            switch (enumerator_8611.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8611.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8611.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9011_ (0) ;
            if (enumerator_8611.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9011 (enumerator_8611.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9011.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9011.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_9011.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 231)).stringValue () ;
                result << " " ;
                result << enumerator_9011.current_mFormalArgumentName (HERE).stringValue () ;
                index_9011_.increment () ;
                enumerator_9011.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_8611_.increment () ;
      ...
      if (kBoolTrue == test_25) {
        ...
        GALGAS_uint index_9502_ (0) ;
        if (enumerator_1239.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9502 (enumerator_1239.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9502.hasCurrentObject ()) {
            switch (enumerator_9502.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9502.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>setter</b> " ;
            result << enumerator_9502.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9902_ (0) ;
            if (enumerator_9502.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9902 (enumerator_9502.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9902.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9902.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9902.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 262)).stringValue () ;
                result << " " ;
                result << enumerator_9902.current_mFormalArgumentName (HERE).stringValue () ;
                index_9902_.increment () ;
                enumerator_9902.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_9502_.increment () ;
      ...
      if (kBoolTrue == test_26) {
        ...
        if (enumerator_1239.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10402 (enumerator_1239.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10402.hasCurrentObject ()) {
            result << "<b>proc</b> @" ;
            result << enumerator_1239.current_lkey (HERE).mAttribute_string.stringValue () ;
            result << " " ;
            result << enumerator_10402.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10486_ (0) ;
            if (enumerator_10402.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10486 (enumerator_10402.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10486.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10486.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10486.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)), inCompiler COMMA_SOURCE_FILE ("typeDump.html.gTemplate", 281)).stringValue () ;
                result << " " ;
                result << enumerator_10486.current_mFormalArgumentName (HERE).stringValue () ;
                index_10486_.increment () ;
