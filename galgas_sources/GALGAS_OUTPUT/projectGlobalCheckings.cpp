...
void routine_performProjectGlobalCheckings (const GALGAS_parsedComponentStruct constinArgument_inParsedComponentStruct,
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_unifiedTypeMap enumerator_34331 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_34331.hasCurrentObject ()) {
      var_firstLetterSet.addAssign_operation (enumerator_34331.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)).reader_string (SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (719)) ;
    ...
    cEnumerator_unifiedTypeMap enumerator_34535 (var_semanticContext.mAttribute_mTypeMap, kEnumeration_up) ;
    while (enumerator_34535.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter.objectCompare (enumerator_34535.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (724)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        var_currentFirstLetter = enumerator_34535.current_lkey (HERE).mAttribute_string.reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
      ...
      var_tableOfTypeString.dotAssign_operation (function_linkForType (enumerator_34535.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (GALGAS_string ("<br>") COMMA_SOURCE_FILE_AT_LINE (728)) COMMA_SOURCE_FILE_AT_LINE (728)) ;
      enumerator_34535.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString = GALGAS_string (filewrapperTemplate_typeDumpGenerationTemplate_typeDump (inCompiler, constinArgument_inProjectSourceFilePath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (732)), var_semanticContext.mAttribute_mTypeMap, var_firstLetterSet, var_tableOfTypeString COMMA_SOURCE_FILE_AT_LINE (731))) ;
    GALGAS_bool joker_35254_0 ; // Joker input parameter
    var_typeDumpString.method_writeToFileWhenDifferentContents (var_typeDumpFilePath, joker_35254_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
  }else if (kBoolFalse == test_2) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath, inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
    }
  }
}
...
GALGAS_string filewrapperTemplate_typeDumpGenerationTemplate_typeDump (C_Compiler * inCompiler,
  ...
  if (in_FIRST_5F_LETTER_5F_SET.isValid ()) {
    ...
    while (enumerator_1067.hasCurrentObject ()) {
      ...
      result << enumerator_1067.current_key (HERE).reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (55)).reader_uint (SOURCE_FILE_AT_LINE (55)).reader_string (SOURCE_FILE_AT_LINE (55)).stringValue () ;
      result << "\">" ;
  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    cEnumerator_unifiedTypeMap enumerator_1301 (in_UNIFIED_5F_TYPE_5F_MAP, kEnumeration_up) ;
    while (enumerator_1301.hasCurrentObject ()) {
      result << "\n"
        "<tr><td colspan=\"2\" class=\"result_title\"><a name=\"" ;
      result << enumerator_1301.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\">@" ;
      result << enumerator_1301.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "</a></td></tr>\n"
        "\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_0 = enumerator_1301.current_mIsConcrete (HERE).operator_not (SOURCE_FILE_AT_LINE (69)).boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "abstract " ;
      }else if (kBoolFalse == test_0) {
      }
      switch (enumerator_1301.current_mTypeKindEnum (HERE).enumValue ()) {
      ...
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_1 = enumerator_1301.current_mSuperType (HERE).reader_isNull (SOURCE_FILE_AT_LINE (84)).operator_not (SOURCE_FILE_AT_LINE (84)).boolEnum () ;
      if (kBoolTrue == test_1) {
        result << "<tr class=\"result_line\"><td>Superclass</td><td>" ;
        result << function_linkForType (enumerator_1301.current_mSuperType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (85)), inCompiler COMMA_SOURCE_FILE_AT_LINE (85)).stringValue () ;
        result << "</td></tr>" ;
      ...
      result << "\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "addition: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
        result << " + " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)).stringValue () ;
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "substraction: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
        result << " - " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)).stringValue () ;
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "multiplication: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
        result << " * " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)).stringValue () ;
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "division: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
        result << " / " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)).stringValue () ;
      ...
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        result << "modulo: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << " <b>mod</b> " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (102)).stringValue () ;
      ...
      const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        result << "left shift: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).stringValue () ;
        result << " &lt;&lt; " ;
        result << function_linkForType (GALGAS_string ("uint"), inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (105)).stringValue () ;
        result << "<br>right shift: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)).stringValue () ;
        result << " &gt;&gt; " ;
      ...
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_8) {
        result << "unary +: + " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)).stringValue () ;
        result << "<br>" ;
      }else if (kBoolFalse == test_8) {
      }
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        result << "unary -: - " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)).stringValue () ;
        result << "<br>" ;
      }else if (kBoolFalse == test_9) {
      }
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_10) {
        result << "bit wise negation: ~ " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)).stringValue () ;
        result << "<br>" ;
      }else if (kBoolFalse == test_10) {
      }
      const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        result << "boolean and: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
        result << " &amp; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)).stringValue () ;
      ...
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) COMMA_SOURCE_FILE_AT_LINE (120)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_12) {
        result << "inclusive or: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
        result << " | " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)).stringValue () ;
      ...
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_13) {
        result << "exclusive or: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
        result << " ^ " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)).stringValue () ;
      ...
      const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_14) {
        result << "boolean negation: <b>not</b> " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)).stringValue () ;
        result << "<br>" ;
      ...
      result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)).stringValue () ;
      result << " == " ;
      result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)).stringValue () ;
      result << " &rarr; " ;
      ...
      result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " != " ;
      result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << " &rarr; " ;
      result << function_linkForType (GALGAS_string ("bool"), inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).stringValue () ;
      result << "<br>" ;
      const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_15) {
        result << "lower than test: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << " &lt; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)).stringValue () ;
        result << " &lt;= " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (133)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).stringValue () ;
        result << " &gt; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).stringValue () ;
        result << " &rarr; " ;
        ...
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)).stringValue () ;
        result << " &gt;= " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)).stringValue () ;
        result << " &rarr; " ;
      ...
      const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_16) {
        result << "concatenation: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
        result << " . " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
        result << " &rarr; " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).stringValue () ;
      ...
      const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_17) {
        result << "appending instruction: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)).stringValue () ;
        result << " .= " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)).stringValue () ;
        result << "<br>" ;
      }else if (kBoolFalse == test_17) {
      }
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_1301.current_mHandledOperatorFlags (HERE).operator_and (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_18) {
        result << "incrementation instruction: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)).stringValue () ;
        result << " ++<br>decrementation instruction: " ;
        result << function_linkForType (enumerator_1301.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)).stringValue () ;
        result << " --<br>" ;
      }else if (kBoolFalse == test_18) {
      }
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_19 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mAddAssignOperatorArguments (HERE).reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_19) {
        result << "<tr class=\"result_line\"><td>+= instruction arguments</td><td>" ;
        GALGAS_uint index_6716_ (0) ;
        if (enumerator_1301.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_6716 (enumerator_1301.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6716.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6716.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (153)), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)).stringValue () ;
            result << " " ;
            result << enumerator_6716.current_mFormalParameterName (HERE).stringValue () ;
            result << "<br>" ;
      ...
      const enumGalgasBool test_20 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mEnumerationDescriptor (HERE).reader_length (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_20) {
        result << "<tr class=\"result_line\"><td><b>foreach</b> constants</td><td>" ;
        GALGAS_uint index_6973_ (0) ;
        if (enumerator_1301.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_6973 (enumerator_1301.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_6973.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6973.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).stringValue () ;
            result << " " ;
            result << enumerator_6973.current_mEnumerationName (HERE).stringValue () ;
            result << "<br>" ;
            index_6973_.increment () ;
      ...
      const enumGalgasBool test_21 = enumerator_1301.current_mTypeForEnumeratedElement (HERE).reader_isNull (SOURCE_FILE_AT_LINE (164)).operator_not (SOURCE_FILE_AT_LINE (164)).boolEnum () ;
      if (kBoolTrue == test_21) {
        result << "<tr class=\"result_line\"><td><b>for</b> enumeration type</td><td>" ;
        result << function_linkForType (enumerator_1301.current_mTypeForEnumeratedElement (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)), inCompiler COMMA_SOURCE_FILE_AT_LINE (165)).stringValue () ;
        result << "</td></tr>" ;
      }else if (kBoolFalse == test_21) {
      }
      const enumGalgasBool test_22 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mConstructorMap (HERE).reader_count (SOURCE_FILE_AT_LINE (168)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_22) {
        result << "<tr class=\"result_line\"><td>Constructors</td><td>" ;
        GALGAS_uint index_7437_ (0) ;
        if (enumerator_1301.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7437 (enumerator_1301.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7437.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7437.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7531_ (0) ;
            if (enumerator_7437.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_7531 (enumerator_7437.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7531.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_7531.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (174)), inCompiler COMMA_SOURCE_FILE_AT_LINE (174)).stringValue () ;
                result << " " ;
                result << enumerator_7531.current_mFormalParameterName (HERE).stringValue () ;
                index_7531_.increment () ;
                enumerator_7531.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7437.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
            result << "<br>" ;
            index_7437_.increment () ;
            enumerator_7437.gotoNextObject () ;
          }
        }
      }else if (kBoolFalse == test_22) {
      }
      const enumGalgasBool test_23 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mReaderMap (HERE).reader_count (SOURCE_FILE_AT_LINE (180)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_23) {
        result << "<tr class=\"result_line\"><td>Readers</td><td>" ;
        GALGAS_uint index_7815_ (0) ;
        if (enumerator_1301.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7815 (enumerator_1301.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7815.hasCurrentObject ()) {
            switch (enumerator_7815.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7815.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>reader</b> " ;
            result << enumerator_7815.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8269_ (0) ;
            if (enumerator_7815.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_8269 (enumerator_7815.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8269.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_8269.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).stringValue () ;
                result << " " ;
                result << enumerator_8269.current_mFormalParameterName (HERE).stringValue () ;
                index_8269_.increment () ;
                enumerator_8269.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7815.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)).stringValue () ;
            result << "<br>" ;
      ...
      const enumGalgasBool test_24 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_24) {
        result << "<tr class=\"result_line\"><td>Methods</td><td>" ;
        GALGAS_uint index_8584_ (0) ;
        if (enumerator_1301.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8584 (enumerator_1301.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8584.hasCurrentObject ()) {
            switch (enumerator_8584.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8584.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8584.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9036_ (0) ;
            if (enumerator_8584.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9036 (enumerator_8584.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9036.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9036.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_9036.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (229)), inCompiler COMMA_SOURCE_FILE_AT_LINE (229)).stringValue () ;
                result << " " ;
                result << enumerator_9036.current_mFormalArgumentName (HERE).stringValue () ;
                index_9036_.increment () ;
                enumerator_9036.gotoNextObject () ;
              }
            }
            result << "<br>" ;
            index_8584_.increment () ;
      ...
      const enumGalgasBool test_25 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mModifierMap (HERE).reader_count (SOURCE_FILE_AT_LINE (236)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_25) {
        result << "<tr class=\"result_line\"><td>Modifiers</td><td>" ;
        GALGAS_uint index_9512_ (0) ;
        if (enumerator_1301.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9512 (enumerator_1301.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9512.hasCurrentObject ()) {
            switch (enumerator_9512.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9512.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>modifier</b> " ;
            result << enumerator_9512.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9966_ (0) ;
            if (enumerator_9512.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9966 (enumerator_9512.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9966.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9966.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_9966.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (260)), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)).stringValue () ;
                result << " " ;
                result << enumerator_9966.current_mFormalArgumentName (HERE).stringValue () ;
                index_9966_.increment () ;
                enumerator_9966.gotoNextObject () ;
              }
            }
            result << "<br>" ;
            index_9512_.increment () ;
      ...
      const enumGalgasBool test_26 = GALGAS_bool (kIsStrictSup, enumerator_1301.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (267)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_26) {
        result << "<tr class=\"result_line\"><td>Class methods</td><td>" ;
        GALGAS_uint index_10473_ (0) ;
        if (enumerator_1301.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10473 (enumerator_1301.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10473.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10473.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10565_ (0) ;
            if (enumerator_10473.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10565 (enumerator_10473.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10565.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10565.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10565.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (279)), inCompiler COMMA_SOURCE_FILE_AT_LINE (279)).stringValue () ;
                result << " " ;
                result << enumerator_10565.current_mFormalArgumentName (HERE).stringValue () ;
                index_10565_.increment () ;
                enumerator_10565.gotoNextObject () ;
              }
            }
            result << "<br>" ;
            index_10473_.increment () ;
...
GALGAS_string function_linkForType (const GALGAS_string & constinArgument_inTypeName,
  ...
  result_outResult = GALGAS_string ("<a class=\"header_link\" href=\"#").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string ("\">@") COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (763)).operator_concat (GALGAS_string ("</a>") COMMA_SOURCE_FILE_AT_LINE (763)) ;
//---
