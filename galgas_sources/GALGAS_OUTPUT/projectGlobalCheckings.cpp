...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4621 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (78))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_4621.isBuiltAndTrue ()) {
  ...
  }else if (cond_4621.isBuiltAndFalse ()) {
...
void routine_checkMultiMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  #endif
  const GGS_unifiedTypeMapIndexList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (96)) ;
  {
    GGS_unifiedTypeMapIndexList::cEnumerator enumerator_5218 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapIndexList::cElement * operand_5218 = NULL ;
    while (((operand_5218 = enumerator_5218.nextObject ()))) {
      macroValidPointer (operand_5218) ;
      const GGS_lstring  var_cas_descendantClassName = operand_5218->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
      GGS_overridingMultiMethodListAST  var_cas_overridingMethods = var_cas_inOverridingCategoryMethodListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiMethodListAST::cEnumerator enumerator_5468 (var_cas_overridingMethods, true) ;
        const GGS_overridingMultiMethodListAST::cElement * operand_5468 = NULL ;
        while (((operand_5468 = enumerator_5468.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_5468) ;
          var_cas_found = (var_cas_inAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102))).operator_isEqual (operand_5468->mOverridingMultiMethodMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102))) ;
        }
      }
      const GGS_bool cond_6533 = (var_cas_found).operator_not () ;
      if (cond_6533.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapIndex  automatic_var_5725_0 ;
        GGS_typeKindEnum automatic_var_5725_1 ;
        GGS_typedAttributeList  automatic_var_5725_2 ;
        GGS_typedAttributeList  automatic_var_5725_3 ;
        GGS_constructorMap  automatic_var_5725_4 ;
        GGS_readerMap  automatic_var_5725_5 ;
        GGS_modifierMap  automatic_var_5725_6 ;
        GGS_instanceMethodMap  automatic_var_5725_7 ;
        GGS_classMethodMap  automatic_var_5725_8 ;
        GGS_enumerationDescriptorList  automatic_var_5725_9 ;
        GGS_uint  automatic_var_5725_10 ;
        GGS_unifiedTypeMapIndexList  automatic_var_5725_11 ;
        GGS_unifiedTypeMapIndexList  automatic_var_5725_12 ;
        GGS_nativeAttributeList  automatic_var_5725_13 ;
        const GGS_unifiedTypeMap  temp_5686 = var_cas_inUnifiedTypeMap ;
        if (temp_5686.isBuilt ()) {
          temp_5686 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_5725_0, automatic_var_5725_1, automatic_var_5725_2, automatic_var_5725_3, automatic_var_5725_4, automatic_var_5725_5, automatic_var_5725_6, automatic_var_5725_7, automatic_var_5725_8, automatic_var_5725_9, automatic_var_5725_10, automatic_var_5725_11, automatic_var_5725_12, automatic_var_5725_13 COMMA_SOURCE_FILE_AT_LINE (106)) ;
        }
        const GGS_bool cond_6218 = (var_cas_isConcrete).operator_not () ;
        if (cond_6218.isBuiltAndTrue ()) {
          ::routine_checkMultiMethodDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)),  var_cas_inAbstractCategoryMethodName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingCategoryMethodListMap,  var_cas_inUnifiedTypeMap COMMA_SOURCE_FILE_AT_LINE (109)) ;
        }else if (cond_6218.isBuiltAndFalse ()) {
          var_cas_inAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract multi method '")).operator_concat (var_cas_inAbstractCategoryMethodName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this method")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
        }
      }
    }
  }
...
void routine_checkMultiReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  #endif
  const GGS_unifiedTypeMapIndexList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (136)) ;
  {
    GGS_unifiedTypeMapIndexList::cEnumerator enumerator_7096 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapIndexList::cElement * operand_7096 = NULL ;
    while (((operand_7096 = enumerator_7096.nextObject ()))) {
      macroValidPointer (operand_7096) ;
      GGS_lstring  var_cas_descendantClassName = operand_7096->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (138)) ;
      GGS_overridingMultiReaderListAST  var_cas_overridingReaders = var_cas_inOverridingCategoryReaderListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiReaderListAST::cEnumerator enumerator_7340 (var_cas_overridingReaders, true) ;
        const GGS_overridingMultiReaderListAST::cElement * operand_7340 = NULL ;
        while (((operand_7340 = enumerator_7340.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_7340) ;
          var_cas_found = (var_cas_inAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_isEqual (operand_7340->mOverridingMultiReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))) ;
        }
      }
      const GGS_bool cond_8402 = (var_cas_found).operator_not () ;
      if (cond_8402.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapIndex  automatic_var_7591_0 ;
        GGS_typeKindEnum automatic_var_7591_1 ;
        GGS_typedAttributeList  automatic_var_7591_2 ;
        GGS_typedAttributeList  automatic_var_7591_3 ;
        GGS_constructorMap  automatic_var_7591_4 ;
        GGS_readerMap  automatic_var_7591_5 ;
        GGS_modifierMap  automatic_var_7591_6 ;
        GGS_instanceMethodMap  automatic_var_7591_7 ;
        GGS_classMethodMap  automatic_var_7591_8 ;
        GGS_enumerationDescriptorList  automatic_var_7591_9 ;
        GGS_uint  automatic_var_7591_10 ;
        GGS_unifiedTypeMapIndexList  automatic_var_7591_11 ;
        GGS_unifiedTypeMapIndexList  automatic_var_7591_12 ;
        GGS_nativeAttributeList  automatic_var_7591_13 ;
        const GGS_unifiedTypeMap  temp_7552 = var_cas_inUnifiedTypeMap ;
        if (temp_7552.isBuilt ()) {
          temp_7552 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_7591_0, automatic_var_7591_1, automatic_var_7591_2, automatic_var_7591_3, automatic_var_7591_4, automatic_var_7591_5, automatic_var_7591_6, automatic_var_7591_7, automatic_var_7591_8, automatic_var_7591_9, automatic_var_7591_10, automatic_var_7591_11, automatic_var_7591_12, automatic_var_7591_13 COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }
        const GGS_bool cond_8084 = (var_cas_isConcrete).operator_not () ;
        if (cond_8084.isBuiltAndTrue ()) {
          ::routine_checkMultiReaderDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151)),  var_cas_inAbstractCategoryReaderName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingCategoryReaderListMap,  var_cas_inUnifiedTypeMap COMMA_SOURCE_FILE_AT_LINE (149)) ;
        }else if (cond_8084.isBuiltAndFalse ()) {
          var_cas_inAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract category reader '")).operator_concat (var_cas_inAbstractCategoryReaderName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this reader")) COMMA_SOURCE_FILE_AT_LINE (161)) ;
        }
      }
    }
  }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_semanticDeclarationList COMMA_SOURCE_FILE_AT_LINE (174)) ;
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_8863 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (176)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_8863 = NULL ;
    while (((operand_8863 = enumerator_8863.nextObject ()))) {
      macroValidPointer (operand_8863) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_8863->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (177)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (177))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (181)) ;
  GGS_descendantClassListMap var_cas_descendantClassListMap = GGS_descendantClassListMap::constructor_emptyMap () ;
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_9376 (var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), true) ;
    const GGS_unifiedTypeMap::cElement * operand_9376 = NULL ;
    while (((operand_9376 = enumerator_9376.nextObject ()))) {
      macroValidPointer (operand_9376) ;
      const GGS_bool cond_9616 = (operand_9376->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (190))).operator_not () ;
      if (cond_9616.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_9376->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), GGS_unifiedTypeMapIndex ::constructor_searchKey (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_9376->mKey COMMA_SOURCE_FILE_AT_LINE (193))) ;
      }
    }
  }
  const GGS_bool cond_13773 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_13773.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_9936 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_9936 = NULL ;
      while (((operand_9936 = enumerator_9936.nextObject ()))) {
        macroValidPointer (operand_9936) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_9936->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (203)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (203))) ;
        var_cas_categoryMethodListMap.dotAssign_operation (operand_9936->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (204)).reader_mCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (204))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_9936->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (205))) ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_10422 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_10422.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_10496 (enumerator_10422._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_10496 = NULL ;
          while (((operand_10496 = enumerator_10496.nextObject ()))) {
            macroValidPointer (operand_10496) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10496->mAbstractMultiMethodName COMMA_SOURCE_FILE_AT_LINE (211)) ;
          }
        }
        enumerator_10422.next () ;
      }
    }
    {
      GGS_multiMethodListMapAST::cEnumerator enumerator_10704 (var_cas_categoryMethodListMap, true) ;
      while (enumerator_10704.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (216)) ;
        {
          GGS_multiMethodListAST::cEnumerator enumerator_10778 (enumerator_10704._object (HERE), true) ;
          const GGS_multiMethodListAST::cElement * operand_10778 = NULL ;
          while (((operand_10778 = enumerator_10778.nextObject ()))) {
            macroValidPointer (operand_10778) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_10778->mMultiMethodName COMMA_SOURCE_FILE_AT_LINE (218)) ;
          }
        }
        enumerator_10704.next () ;
      }
    }
    {
      GGS_overridingMultiMethodListMapAST::cEnumerator enumerator_10994 (var_cas_overridingCategoryMethodListMap, true) ;
      while (enumerator_10994.hasCurrentObject ()) {
        GGS_multiMethodMap  var_cas_multiMethodMap = GGS_multiMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ;
        {
          GGS_overridingMultiMethodListAST::cEnumerator enumerator_11068 (enumerator_10994._object (HERE), true) ;
          const GGS_overridingMultiMethodListAST::cElement * operand_11068 = NULL ;
          while (((operand_11068 = enumerator_11068.nextObject ()))) {
            macroValidPointer (operand_11068) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_11068->mOverridingMultiMethodMethodName COMMA_SOURCE_FILE_AT_LINE (225)) ;
          }
        }
        enumerator_10994.next () ;
      }
    }
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_11387 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_11387.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_11411 (enumerator_11387._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_11411 = NULL ;
          while (((operand_11411 = enumerator_11411.nextObject ()))) {
            macroValidPointer (operand_11411) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_11387._key (HERE),  enumerator_11387._key (HERE),  operand_11411->mAbstractMultiMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap,  var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (233)) ;
          }
        }
        enumerator_11387.next () ;
      }
    }
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_12095 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (250)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_12095 = NULL ;
      while (((operand_12095 = enumerator_12095.nextObject ()))) {
        macroValidPointer (operand_12095) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_12095->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (251)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (251))) ;
        var_cas_categoryReaderListMap.dotAssign_operation (operand_12095->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (252)).reader_mCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (252))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_12095->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (253)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (253))) ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_12581 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_12581.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (257)) ;
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_12655 (enumerator_12581._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_12655 = NULL ;
          while (((operand_12655 = enumerator_12655.nextObject ()))) {
            macroValidPointer (operand_12655) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12655->mAbstractMultiReaderName COMMA_SOURCE_FILE_AT_LINE (259)) ;
          }
        }
        enumerator_12581.next () ;
      }
    }
    {
      GGS_multiReaderListMapAST::cEnumerator enumerator_12863 (var_cas_categoryReaderListMap, true) ;
      while (enumerator_12863.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (264)) ;
        {
          GGS_multiReaderListAST::cEnumerator enumerator_12937 (enumerator_12863._object (HERE), true) ;
          const GGS_multiReaderListAST::cElement * operand_12937 = NULL ;
          while (((operand_12937 = enumerator_12937.nextObject ()))) {
            macroValidPointer (operand_12937) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_12937->mMultiReaderName COMMA_SOURCE_FILE_AT_LINE (266)) ;
          }
        }
        enumerator_12863.next () ;
      }
    }
    {
      GGS_overridingMultiReaderListMapAST::cEnumerator enumerator_13153 (var_cas_overridingCategoryReaderListMap, true) ;
      while (enumerator_13153.hasCurrentObject ()) {
        GGS_multiReaderMap  var_cas_multiReaderMap = GGS_multiReaderMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
        {
          GGS_overridingMultiReaderListAST::cEnumerator enumerator_13227 (enumerator_13153._object (HERE), true) ;
          const GGS_overridingMultiReaderListAST::cElement * operand_13227 = NULL ;
          while (((operand_13227 = enumerator_13227.nextObject ()))) {
            macroValidPointer (operand_13227) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_13227->mOverridingMultiReaderName COMMA_SOURCE_FILE_AT_LINE (273)) ;
          }
        }
        enumerator_13153.next () ;
      }
    }
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_13468 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_13468.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_13492 (enumerator_13468._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_13492 = NULL ;
          while (((operand_13492 = enumerator_13492.nextObject ()))) {
            macroValidPointer (operand_13492) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_13468._key (HERE),  enumerator_13468._key (HERE),  operand_13492->mAbstractMultiReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap,  var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) COMMA_SOURCE_FILE_AT_LINE (279)) ;
          }
        }
        enumerator_13468.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
