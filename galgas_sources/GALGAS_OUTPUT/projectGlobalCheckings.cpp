  ...
  if (in_UNIFIED_5F_TYPE_5F_MAP.isValid ()) {
    ...
    while (enumerator_1247.hasCurrentObject ()) {
      ...
      result << "\n"
        ...
        "  <td>\n"
        "    " ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result << "addition: " ;
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "substraction: " ;
      ...
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "division: " ;
      ...
      const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        result << "modulo: " ;
      ...
      const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_7) {
        result << "left shift: " ;
      ...
      const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_unaryPlusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_8) {
        result << "unary +: + " ;
      ...
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        result << "unary -: - " ;
      ...
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) COMMA_SOURCE_FILE_AT_LINE (120)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) COMMA_SOURCE_FILE_AT_LINE (126)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      result << "<br><br>" ;
      const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_1247.current_mHandledOperatorFlags (HERE).operator_and (function_incDecOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      ...
      result << "\n"
        "</td></tr>\n" ;
      const enumGalgasBool test_19 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mAddAssignOperatorArguments (HERE).reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_19) {
        ...
        if (enumerator_1247.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_6806 (enumerator_1247.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
          while (enumerator_6806.hasCurrentObject ()) {
            result << function_linkForType (enumerator_6806.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (153)), inCompiler COMMA_SOURCE_FILE_AT_LINE (153)).stringValue () ;
            result << " " ;
            result << enumerator_6806.current_mFormalParameterName (HERE).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_20 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mEnumerationDescriptor (HERE).reader_length (SOURCE_FILE_AT_LINE (157)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_20) {
        ...
        if (enumerator_1247.current_mEnumerationDescriptor (HERE).isValid ()) {
          cEnumerator_enumerationDescriptorList enumerator_7067 (enumerator_1247.current_mEnumerationDescriptor (HERE), kEnumeration_up) ;
          while (enumerator_7067.hasCurrentObject ()) {
            result << function_linkForType (enumerator_7067.current_mEnumeratedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (160)), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)).stringValue () ;
            result << " " ;
            result << enumerator_7067.current_mEnumerationName (HERE).stringValue () ;
            result << "<br><br>" ;
      ...
      const enumGalgasBool test_22 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mConstructorMap (HERE).reader_count (SOURCE_FILE_AT_LINE (168)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_22) {
        result << "<tr class=\"result_line\"><td>Constructors</td><td>" ;
        GALGAS_uint index_7514_ (0) ;
        if (enumerator_1247.current_mConstructorMap (HERE).isValid ()) {
          cEnumerator_constructorMap enumerator_7514 (enumerator_1247.current_mConstructorMap (HERE), kEnumeration_up) ;
          while (enumerator_7514.hasCurrentObject ()) {
            result << "<b>constructor</b> " ;
            result << enumerator_7514.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_7586_ (0) ;
            if (enumerator_7514.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_7586 (enumerator_7514.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_7586.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_7586.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (174)), inCompiler COMMA_SOURCE_FILE_AT_LINE (174)).stringValue () ;
                result << " " ;
                result << enumerator_7586.current_mFormalParameterName (HERE).stringValue () ;
                index_7586_.increment () ;
                enumerator_7586.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7514.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (176)), inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).stringValue () ;
            result << "<br><br>" ;
            index_7514_.increment () ;
            enumerator_7514.gotoNextObject () ;
          }
        }
      }else if (kBoolFalse == test_22) {
      }
      const enumGalgasBool test_23 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mReaderMap (HERE).reader_count (SOURCE_FILE_AT_LINE (180)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_23) {
        result << "<tr class=\"result_line\"><td>Readers</td><td>" ;
        GALGAS_uint index_7912_ (0) ;
        if (enumerator_1247.current_mReaderMap (HERE).isValid ()) {
          cEnumerator_readerMap enumerator_7912 (enumerator_1247.current_mReaderMap (HERE), kEnumeration_up) ;
          while (enumerator_7912.hasCurrentObject ()) {
            switch (enumerator_7912.current_mKind (HERE).enumValue ()) {
            ...
            switch (enumerator_7912.current_mQualifier (HERE).enumValue ()) {
            ...
            result << "<b>reader</b> " ;
            result << enumerator_7912.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_8328_ (0) ;
            if (enumerator_7912.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_8328 (enumerator_7912.current_mArgumentTypeList (HERE), kEnumeration_up) ;
              while (enumerator_8328.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp; \?" ;
                result << function_linkForType (enumerator_8328.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (198)).stringValue () ;
                result << " " ;
                result << enumerator_8328.current_mFormalParameterName (HERE).stringValue () ;
                index_8328_.increment () ;
                enumerator_8328.gotoNextObject () ;
              }
            }
            result << " &rarr; " ;
            result << function_linkForType (enumerator_7912.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)).stringValue () ;
            result << "<br><br>" ;
            index_7912_.increment () ;
      ...
      const enumGalgasBool test_24 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mInstanceMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (205)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_24) {
        result << "<tr class=\"result_line\"><td>Methods</td><td>" ;
        GALGAS_uint index_8685_ (0) ;
        if (enumerator_1247.current_mInstanceMethodMap (HERE).isValid ()) {
          cEnumerator_instanceMethodMap enumerator_8685 (enumerator_1247.current_mInstanceMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_8685.hasCurrentObject ()) {
            switch (enumerator_8685.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_8685.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>method</b> " ;
            result << enumerator_8685.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_9098_ (0) ;
            if (enumerator_8685.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_9098 (enumerator_8685.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_9098.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_9098.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                ...
                result << function_linkForType (enumerator_9098.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (229)), inCompiler COMMA_SOURCE_FILE_AT_LINE (229)).stringValue () ;
                result << " " ;
                result << enumerator_9098.current_mFormalArgumentName (HERE).stringValue () ;
                index_9098_.increment () ;
                enumerator_9098.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_8685_.increment () ;
      ...
      const enumGalgasBool test_25 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mModifierMap (HERE).reader_count (SOURCE_FILE_AT_LINE (236)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_25) {
        result << "<tr class=\"result_line\"><td>Modifiers</td><td>" ;
        GALGAS_uint index_9617_ (0) ;
        if (enumerator_1247.current_mModifierMap (HERE).isValid ()) {
          cEnumerator_modifierMap enumerator_9617 (enumerator_1247.current_mModifierMap (HERE), kEnumeration_up) ;
          while (enumerator_9617.hasCurrentObject ()) {
            switch (enumerator_9617.current_mKind (HERE).enumValue ()) {
            case GALGAS_methodKind::kNotBuilt :
            break ;
            case GALGAS_methodKind::kEnum_definedAsMember : {
            } break ;
            ...
            switch (enumerator_9617.current_mQualifier (HERE).enumValue ()) {
            case GALGAS_methodQualifier::kNotBuilt :
            break ;
            case GALGAS_methodQualifier::kEnum_isAbstract : {
              result << "<b>abstract</b> " ;
            ...
            result << "<b>modifier</b> " ;
            result << enumerator_9617.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10032_ (0) ;
            if (enumerator_9617.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10032 (enumerator_9617.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10032.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10032.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10032.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (260)), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)).stringValue () ;
                result << " " ;
                result << enumerator_10032.current_mFormalArgumentName (HERE).stringValue () ;
                index_10032_.increment () ;
                enumerator_10032.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_9617_.increment () ;
      ...
      const enumGalgasBool test_26 = GALGAS_bool (kIsStrictSup, enumerator_1247.current_mClassMethodMap (HERE).reader_count (SOURCE_FILE_AT_LINE (267)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_26) {
        result << "<tr class=\"result_line\"><td>Class methods</td><td>" ;
        GALGAS_uint index_10565_ (0) ;
        if (enumerator_1247.current_mClassMethodMap (HERE).isValid ()) {
          cEnumerator_classMethodMap enumerator_10565 (enumerator_1247.current_mClassMethodMap (HERE), kEnumeration_up) ;
          while (enumerator_10565.hasCurrentObject ()) {
            result << "<b>class method</b> " ;
            result << enumerator_10565.current_lkey (HERE).mAttribute_string.stringValue () ;
            GALGAS_uint index_10635_ (0) ;
            if (enumerator_10565.current_mParameterList (HERE).isValid ()) {
              cEnumerator_formalParameterSignature enumerator_10635 (enumerator_10565.current_mParameterList (HERE), kEnumeration_up) ;
              while (enumerator_10635.hasCurrentObject ()) {
                result << "<br>&nbsp;&nbsp;&nbsp;&nbsp;" ;
                switch (enumerator_10635.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
                case GALGAS_formalArgumentPassingModeAST::kNotBuilt :
                break ;
                case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn : {
                  result << " \?\?" ;
                ...
                result << function_linkForType (enumerator_10635.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (279)), inCompiler COMMA_SOURCE_FILE_AT_LINE (279)).stringValue () ;
                result << " " ;
                result << enumerator_10635.current_mFormalArgumentName (HERE).stringValue () ;
                index_10635_.increment () ;
                enumerator_10635.gotoNextObject () ;
              }
            }
            result << "<br><br>" ;
            index_10565_.increment () ;
