    ...
    while (enumerator_1301.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_19) {
        ...
        if (enumerator_1301.current_mAddAssignOperatorArguments (HERE).isValid ()) {
          cEnumerator_unifiedTypeMapProxyList enumerator_6716 (enumerator_1301.current_mAddAssignOperatorArguments (HERE), kEnumeration_up) ;
        ...
        if (enumerator_1301.current_mConstructorMap (HERE).isValid ()) {
          ...
          while (enumerator_7410.hasCurrentObject ()) {
            ...
            if (enumerator_7410.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyList enumerator_7467 (enumerator_7410.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        ...
        if (enumerator_1301.current_mReaderMap (HERE).isValid ()) {
          ...
          while (enumerator_7725.hasCurrentObject ()) {
            ...
            if (enumerator_7725.current_mArgumentTypeList (HERE).isValid ()) {
              cEnumerator_unifiedTypeMapProxyList enumerator_8142 (enumerator_7725.current_mArgumentTypeList (HERE), kEnumeration_up) ;
