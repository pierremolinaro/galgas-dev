...
category_method__abstracMultiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_abstracMultiMethodAST * operand_4221,
                                GGS_genericMultiMethodListMap & var_cas_ioAbstractMultiMethodListMapAST,
                                GGS_genericMultiMethodListMap & /* var_cas_ioMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiReaderListMap */,
                                ...
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiReaderListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4221 != NULL) {
    var_cas_ioAbstractMultiMethodListMapAST.addAssign_operation (operand_4221->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (79)), operand_4221->mAbstractMultiMethodName) ;
  }
}
...
category_method__multiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_multiMethodAST * operand_4854,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_genericMultiMethodListMap & var_cas_ioMultiMethodListMap,
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiReaderListMap */,
                                ...
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiReaderListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_4854 != NULL) {
    var_cas_ioMultiMethodListMap.addAssign_operation (operand_4854->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (95)), operand_4854->mMultiMethodName) ;
  }
}
...
category_method__overridingMultiMethodAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_overridingMultiMethodAST * operand_5478,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & var_cas_ioOverridingMultiMethodListMap,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiReaderListMap */,
                                ...
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiReaderListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_5478 != NULL) {
    var_cas_ioOverridingMultiMethodListMap.addAssign_operation (operand_5478->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)), operand_5478->mOverridingMultiMethodMethodName) ;
  }
}

//---------------------------------------------------------------------------*
//                                                                           *
//    Category method '@abstractMultiReaderAST.buildMultiMethodListMaps'     *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__abstractMultiReaderAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_abstractMultiReaderAST * operand_6126,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & var_cas_ioAbstractMultiReaderListMap,
  ...
  if (operand_6126 != NULL) {
    var_cas_ioAbstractMultiReaderListMap.addAssign_operation (operand_6126->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)), operand_6126->mAbstractMultiReaderName) ;
  }
}

//---------------------------------------------------------------------------*
//                                                                           *
//        Category method '@multiReaderAST.buildMultiMethodListMaps'         *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__multiReaderAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_multiReaderAST * operand_6756,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiReaderListMap */,
                                ...
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiReaderListMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6756 != NULL) {
    var_cas_ioMultiReaderListMap.addAssign_operation (operand_6756->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), operand_6756->mMultiReaderName) ;
  }
}

//---------------------------------------------------------------------------*
//                                                                           *
//   Category method '@overridingMultiReaderAST.buildMultiMethodListMaps'    *
//                                                                           *
//---------------------------------------------------------------------------*

static void
category_method__overridingMultiReaderAST__buildMultiMethodListMaps (C_Compiler & inLexique,
                                const cPtr_overridingMultiReaderAST * operand_7380,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiMethodListMapAST */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioOverridingMultiMethodListMap */,
                                GGS_genericMultiMethodListMap & /* var_cas_ioAbstractMultiReaderListMap */,
                                ...
                                GGS_genericMultiMethodListMap & var_cas_ioOverridingMultiReaderListMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7380 != NULL) {
    var_cas_ioOverridingMultiReaderListMap.addAssign_operation (operand_7380->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), operand_7380->mOverridingMultiReaderName) ;
  }
}
...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9867 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (201))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_9867.isBuiltAndTrue ()) {
  ...
  }else if (cond_9867.isBuiltAndFalse ()) {
...
void routine_checkMultiMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_10452 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_10452 = NULL ;
    while (((operand_10452 = enumerator_10452.nextObject ()))) {
      macroValidPointer (operand_10452) ;
      const GGS_lstring  var_cas_descendantClassName = operand_10452->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (221)) ;
      ...
      {
        GGS_lstringlist::cEnumerator enumerator_10683 (var_cas_overridingMethods, true) ;
        const GGS_lstringlist::cElement * operand_10683 = NULL ;
        while (((operand_10683 = enumerator_10683.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_10683) ;
          var_cas_found = (var_cas_inAbstractMultiMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))).operator_isEqual (operand_10683->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (225))) ;
        }
      }
      const GGS_bool cond_11707 = (var_cas_found).operator_not () ;
      if (cond_11707.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_10911_0 ;
        GGS_typeKindEnum automatic_var_10911_1 ;
        GGS_typedAttributeList  automatic_var_10911_2 ;
        GGS_attributeMap  automatic_var_10911_3 ;
        GGS_typedAttributeList  automatic_var_10911_4 ;
        GGS_constructorMap  automatic_var_10911_5 ;
        GGS_readerMap  automatic_var_10911_6 ;
        GGS_modifierMap  automatic_var_10911_7 ;
        GGS_instanceMethodMap  automatic_var_10911_8 ;
        GGS_classMethodMap  automatic_var_10911_9 ;
        GGS_enumerationDescriptorList  automatic_var_10911_10 ;
        GGS_uint  automatic_var_10911_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_10911_12 ;
        GGS_nativeAttributeList  automatic_var_10911_13 ;
        GGS_stringset  automatic_var_10911_14 ;
        GGS_lstringlist  automatic_var_10911_15 ;
        GGS_typedAttributeList  automatic_var_10911_16 ;
        GGS_mapSearchMethodListAST  automatic_var_10911_17 ;
        GGS_mapSearchMethodListAST  automatic_var_10911_18 ;
        GGS_withAccessorMap  automatic_var_10911_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_10911_0, automatic_var_10911_1, automatic_var_10911_2, automatic_var_10911_3, automatic_var_10911_4, automatic_var_10911_5, automatic_var_10911_6, automatic_var_10911_7, automatic_var_10911_8, automatic_var_10911_9, automatic_var_10911_10, automatic_var_10911_11, automatic_var_10911_12, automatic_var_10911_13, automatic_var_10911_14, automatic_var_10911_15, automatic_var_10911_16, automatic_var_10911_17, automatic_var_10911_18, automatic_var_10911_19 COMMA_SOURCE_FILE_AT_LINE (229)) ;
        }
        const GGS_bool cond_11398 = (var_cas_isConcrete).operator_not () ;
        if (cond_11398.isBuiltAndTrue ()) {
        ...
        }else if (cond_11398.isBuiltAndFalse ()) {
...
void routine_checkMultiReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_12258 (var_cas_descendantClasses, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_12258 = NULL ;
    while (((operand_12258 = enumerator_12258.nextObject ()))) {
      macroValidPointer (operand_12258) ;
      GGS_lstring  var_cas_descendantClassName = operand_12258->mType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
      ...
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_12483 (var_cas_overridingReaders, true) ;
        const GGS_lstringlist::cElement * operand_12483 = NULL ;
        while (((operand_12483 = enumerator_12483.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_12483) ;
          var_cas_found = (var_cas_inAbstractMultiReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isEqual (operand_12483->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))) ;
        }
      }
      const GGS_bool cond_13510 = (var_cas_found).operator_not () ;
      if (cond_13510.isBuiltAndTrue ()) {
        GGS_bool var_cas_isConcrete ;
        GGS_unifiedTypeMapProxy  automatic_var_12711_0 ;
        GGS_typeKindEnum automatic_var_12711_1 ;
        GGS_typedAttributeList  automatic_var_12711_2 ;
        GGS_attributeMap  automatic_var_12711_3 ;
        GGS_typedAttributeList  automatic_var_12711_4 ;
        GGS_constructorMap  automatic_var_12711_5 ;
        GGS_readerMap  automatic_var_12711_6 ;
        GGS_modifierMap  automatic_var_12711_7 ;
        GGS_instanceMethodMap  automatic_var_12711_8 ;
        GGS_classMethodMap  automatic_var_12711_9 ;
        GGS_enumerationDescriptorList  automatic_var_12711_10 ;
        GGS_uint  automatic_var_12711_11 ;
        GGS_unifiedTypeMapProxyList  automatic_var_12711_12 ;
        GGS_nativeAttributeList  automatic_var_12711_13 ;
        GGS_stringset  automatic_var_12711_14 ;
        GGS_lstringlist  automatic_var_12711_15 ;
        GGS_typedAttributeList  automatic_var_12711_16 ;
        GGS_mapSearchMethodListAST  automatic_var_12711_17 ;
        GGS_mapSearchMethodListAST  automatic_var_12711_18 ;
        GGS_withAccessorMap  automatic_var_12711_19 ;
        if (var_cas_inUnifiedTypeMap.isBuilt ()) {
          var_cas_inUnifiedTypeMap (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_isConcrete, automatic_var_12711_0, automatic_var_12711_1, automatic_var_12711_2, automatic_var_12711_3, automatic_var_12711_4, automatic_var_12711_5, automatic_var_12711_6, automatic_var_12711_7, automatic_var_12711_8, automatic_var_12711_9, automatic_var_12711_10, automatic_var_12711_11, automatic_var_12711_12, automatic_var_12711_13, automatic_var_12711_14, automatic_var_12711_15, automatic_var_12711_16, automatic_var_12711_17, automatic_var_12711_18, automatic_var_12711_19 COMMA_SOURCE_FILE_AT_LINE (269)) ;
        }
        const GGS_bool cond_13198 = (var_cas_isConcrete).operator_not () ;
        if (cond_13198.isBuiltAndTrue ()) {
        ...
        }else if (cond_13198.isBuiltAndFalse ()) {
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_13971 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (299)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_13971 = NULL ;
    while (((operand_13971 = enumerator_13971.nextObject ()))) {
      macroValidPointer (operand_13971) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_13971->mInfo.mRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (300))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (304)) ;
  GGS_descendantClassListMap var_cas_descendantClassListMap = GGS_descendantClassListMap::constructor_emptyMap () ;
  {
    GGS_unifiedTypeMap::cEnumerator enumerator_14470 (var_cas_semanticContext.mTypeMap, true) ;
    const GGS_unifiedTypeMap::cElement * operand_14470 = NULL ;
    while (((operand_14470 = enumerator_14470.nextObject ()))) {
      macroValidPointer (operand_14470) ;
      const GGS_bool cond_14674 = (operand_14470->mInfo.mSuperType.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (313))).operator_not () ;
      if (cond_14674.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_14470->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (315)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.mTypeMap, operand_14470->mKey COMMA_SOURCE_FILE_AT_LINE (316))) ;
      }
    }
  }
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_15140 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (327)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_15140 = NULL ;
    while (((operand_15140 = enumerator_15140.nextObject ()))) {
      macroValidPointer (operand_15140) ;
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_15210 (operand_15140->mInfo.mRoot.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (328)), true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_15210 = NULL ;
        while (((operand_15210 = enumerator_15210.nextObject ()))) {
          macroValidPointer (operand_15210) ;
          { typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps method = findCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps (operand_15210->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_15210->mSemanticDeclaration (HERE), var_cas_abstractMultiMethodListMap, var_cas_multiMethodListMap, var_cas_overridingMultiMethodListMap, var_cas_abstractMultiReaderListMap, var_cas_multiReaderListMap, var_cas_overridingMultiReaderListMap COMMA_SOURCE_FILE_AT_LINE (329)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_18371 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (340))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_18371.isBuiltAndTrue ()) {
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_15722 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_15722.hasCurrentObject ()) {
        GGS_multiMethodMapForGlobalCheckings  var_cas_multiMethodMap = GGS_multiMethodMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (343)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_15813 (enumerator_15722._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_15813 = NULL ;
          while (((operand_15813 = enumerator_15813.nextObject ()))) {
            macroValidPointer (operand_15813) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_15813->mValue COMMA_SOURCE_FILE_AT_LINE (345)) ;
          }
        }
        enumerator_15722.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16000 (var_cas_multiMethodListMap, true) ;
      while (enumerator_16000.hasCurrentObject ()) {
        GGS_multiMethodMapForGlobalCheckings  var_cas_multiMethodMap = GGS_multiMethodMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (350)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_16091 (enumerator_16000._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16091 = NULL ;
          while (((operand_16091 = enumerator_16091.nextObject ()))) {
            macroValidPointer (operand_16091) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16091->mValue COMMA_SOURCE_FILE_AT_LINE (352)) ;
          }
        }
        enumerator_16000.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16294 (var_cas_overridingMultiMethodListMap, true) ;
      while (enumerator_16294.hasCurrentObject ()) {
        GGS_multiMethodMapForGlobalCheckings  var_cas_multiMethodMap = GGS_multiMethodMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_16385 (enumerator_16294._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16385 = NULL ;
          while (((operand_16385 = enumerator_16385.nextObject ()))) {
            macroValidPointer (operand_16385) ;
            var_cas_multiMethodMap.modifier_insertKey (inLexique, operand_16385->mValue COMMA_SOURCE_FILE_AT_LINE (359)) ;
          }
        }
        enumerator_16294.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_16672 (var_cas_abstractMultiMethodListMap, true) ;
      while (enumerator_16672.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_16695 (enumerator_16672._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_16695 = NULL ;
          while (((operand_16695 = enumerator_16695.nextObject ()))) {
            macroValidPointer (operand_16695) ;
            ::routine_checkMultiMethodDefinitionForClass (inLexique,  enumerator_16672._key (HERE),  enumerator_16672._key (HERE),  operand_16695->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiMethodListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (367)) ;
          }
        }
        enumerator_16672.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17208 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_17208.hasCurrentObject ()) {
        GGS_multiReaderMapForGlobalCheckings  var_cas_multiReaderMap = GGS_multiReaderMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (382)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17299 (enumerator_17208._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17299 = NULL ;
          while (((operand_17299 = enumerator_17299.nextObject ()))) {
            macroValidPointer (operand_17299) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17299->mValue COMMA_SOURCE_FILE_AT_LINE (384)) ;
          }
        }
        enumerator_17208.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17486 (var_cas_multiReaderListMap, true) ;
      while (enumerator_17486.hasCurrentObject ()) {
        GGS_multiReaderMapForGlobalCheckings  var_cas_multiReaderMap = GGS_multiReaderMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (389)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17577 (enumerator_17486._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17577 = NULL ;
          while (((operand_17577 = enumerator_17577.nextObject ()))) {
            macroValidPointer (operand_17577) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17577->mValue COMMA_SOURCE_FILE_AT_LINE (391)) ;
          }
        }
        enumerator_17486.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_17780 (var_cas_overridingMultiReaderListMap, true) ;
      while (enumerator_17780.hasCurrentObject ()) {
        GGS_multiReaderMapForGlobalCheckings  var_cas_multiReaderMap = GGS_multiReaderMapForGlobalCheckings ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (396)) ;
        {
          GGS_lstringlist::cEnumerator enumerator_17871 (enumerator_17780._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_17871 = NULL ;
          while (((operand_17871 = enumerator_17871.nextObject ()))) {
            macroValidPointer (operand_17871) ;
            var_cas_multiReaderMap.modifier_insertKey (inLexique, operand_17871->mValue COMMA_SOURCE_FILE_AT_LINE (398)) ;
          }
        }
        enumerator_17780.next () ;
      }
    }
    {
      GGS_genericMultiMethodListMap::cEnumerator enumerator_18089 (var_cas_abstractMultiReaderListMap, true) ;
      while (enumerator_18089.hasCurrentObject ()) {
        {
          GGS_lstringlist::cEnumerator enumerator_18112 (enumerator_18089._mList (HERE), true) ;
          const GGS_lstringlist::cElement * operand_18112 = NULL ;
          while (((operand_18112 = enumerator_18112.nextObject ()))) {
            macroValidPointer (operand_18112) ;
            ::routine_checkMultiReaderDefinitionForClass (inLexique,  enumerator_18089._key (HERE),  enumerator_18089._key (HERE),  operand_18112->mValue,  var_cas_descendantClassListMap,  var_cas_overridingMultiReaderListMap,  var_cas_semanticContext.mTypeMap COMMA_SOURCE_FILE_AT_LINE (404)) ;
          }
        }
        enumerator_18089.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
static void prologueRoutineFor_projectGlobalCheckings (void) {
  ...
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__abstractMultiReaderAST__buildMultiMethodListMaps, gClassInfoFor__abstractMultiReaderAST.slotID ()) ;
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__multiReaderAST__buildMultiMethodListMaps, gClassInfoFor__multiReaderAST.slotID ()) ;
  enterCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps ((typeCategoryMethod__semanticDeclarationAST__buildMultiMethodListMaps) category_method__overridingMultiReaderAST__buildMultiMethodListMaps, gClassInfoFor__overridingMultiReaderAST.slotID ()) ;
}
