  ...
  GGS_descendantClassListMap var_cas_descendantClassListMap = GGS_descendantClassListMap::constructor_emptyMap () ;
  {
    ...
    while (((operand_9486 = enumerator_9486.nextObject ()))) {
      ...
      if (cond_9726.isBuiltAndTrue ()) {
        var_cas_descendantClassListMap.addAssign_operation (operand_9486->mInfo.mSuperType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (195)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), operand_9486->mKey COMMA_SOURCE_FILE_AT_LINE (196))) ;
      }
    }
  }
