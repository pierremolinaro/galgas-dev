...
#ifndef typeBoolOption_DEFINED
#define typeBoolOption_DEFINED
...
/* class GGG_typeBoolOption : public GGG_typeExpression {
  private : typedef GGG_typeExpression inherited ;
  public : GGG_typeBoolOption (const GGS_lstring & ,
                                const GGS_lstring &  COMMA_LOCATION_ARGS) ;
} ; */
