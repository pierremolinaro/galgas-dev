...
cCollectionElement_projectSourceList * GALGAS_projectSourceList::makeElement (const GALGAS_sourceFileKind & in_mSourceKind,
                                                                              const GALGAS_lstring & in_mFilePath
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_projectSourceList * result = NULL ;
  macroMyNew (result, cCollectionElement_projectSourceList (in_mSourceKind,
