...
class cCollectionElement_projectSourceList : public cCollectionElement {
  public : GALGAS_projectSourceList_3A_element mObject ;
...
GALGAS_projectSourceList_3A_element cEnumerator_projectSourceList::current (LOCATION_ARGS) const {
...
class cCollectionElement_qualifiedFeatureList : public cCollectionElement {
  public : GALGAS_qualifiedFeatureList_3A_element mObject ;
...
GALGAS_qualifiedFeatureList_3A_element cEnumerator_qualifiedFeatureList::current (LOCATION_ARGS) const {
