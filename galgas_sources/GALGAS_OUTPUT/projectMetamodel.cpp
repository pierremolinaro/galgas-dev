...
GALGAS_projectSourceList_3A_element::GALGAS_projectSourceList_3A_element (void) :
...
GALGAS_projectSourceList_3A_element::GALGAS_projectSourceList_3A_element (const GALGAS_sourceFileKind & inOperand0,
                                                                          const GALGAS_lstring & inOperand1) :
...
/* GALGAS_projectSourceList_3A_element & GALGAS_projectSourceList_3A_element::operator = (const GALGAS_projectSourceList_3A_element & inOperand) {
  mAttribute_mSourceKind = inOperand.mAttribute_mSourceKind ;
  mAttribute_mFilePath = inOperand.mAttribute_mFilePath ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_projectSourceList_3A_element GALGAS_projectSourceList_3A_element::constructor_new (const GALGAS_sourceFileKind & inOperand0,
                                                                                          const GALGAS_lstring & inOperand1 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_projectSourceList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_projectSourceList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_projectSourceList_3A_element::objectCompare (const GALGAS_projectSourceList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_projectSourceList_3A_element::isValid (void) const {
  return mAttribute_mSourceKind.isValid () && mAttribute_mFilePath.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_projectSourceList_3A_element::drop (void) {
...
void GALGAS_projectSourceList_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_sourceFileKind GALGAS_projectSourceList_3A_element::reader_mSourceKind (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSourceKind ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_projectSourceList_3A_element::reader_mFilePath (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_projectSourceList_3A_element ("projectSourceList:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_projectSourceList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_projectSourceList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_projectSourceList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_projectSourceList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_projectSourceList_3A_element GALGAS_projectSourceList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_projectSourceList_3A_element result ;
  const GALGAS_projectSourceList_3A_element * p = (const GALGAS_projectSourceList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_projectSourceList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_qualifiedFeatureList_3A_element::GALGAS_qualifiedFeatureList_3A_element (void) :
...
GALGAS_qualifiedFeatureList_3A_element::GALGAS_qualifiedFeatureList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_lstring & inOperand1) :
...
/* GALGAS_qualifiedFeatureList_3A_element & GALGAS_qualifiedFeatureList_3A_element::operator = (const GALGAS_qualifiedFeatureList_3A_element & inOperand) {
  mAttribute_mFeatureName = inOperand.mAttribute_mFeatureName ;
  mAttribute_mFeatureValue = inOperand.mAttribute_mFeatureValue ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_qualifiedFeatureList_3A_element GALGAS_qualifiedFeatureList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                const GALGAS_lstring & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_qualifiedFeatureList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_qualifiedFeatureList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_qualifiedFeatureList_3A_element::objectCompare (const GALGAS_qualifiedFeatureList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_qualifiedFeatureList_3A_element::isValid (void) const {
  return mAttribute_mFeatureName.isValid () && mAttribute_mFeatureValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_qualifiedFeatureList_3A_element::drop (void) {
...
void GALGAS_qualifiedFeatureList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_qualifiedFeatureList_3A_element::reader_mFeatureName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFeatureName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_qualifiedFeatureList_3A_element::reader_mFeatureValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_qualifiedFeatureList_3A_element ("qualifiedFeatureList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_qualifiedFeatureList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_qualifiedFeatureList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_qualifiedFeatureList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_qualifiedFeatureList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_qualifiedFeatureList_3A_element GALGAS_qualifiedFeatureList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_qualifiedFeatureList_3A_element result ;
  const GALGAS_qualifiedFeatureList_3A_element * p = (const GALGAS_qualifiedFeatureList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_qualifiedFeatureList_3A_element *> (p)) {
      result = *p ;
    }else{
