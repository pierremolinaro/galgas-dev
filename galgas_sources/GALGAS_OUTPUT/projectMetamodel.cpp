...
GALGAS_qualifiedFeatureList GALGAS_qualifiedFeatureList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                  const GALGAS_uint & inLength,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) const {
...
void GALGAS_qualifiedFeatureList::modifier_setMFeatureNameAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_qualifiedFeatureList * p = (cCollectionElement_qualifiedFeatureList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_qualifiedFeatureList) ;
    p->mAttribute_mFeatureName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_qualifiedFeatureList::modifier_setMFeatureValueAtIndex (GALGAS_lstring inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_qualifiedFeatureList * p = (cCollectionElement_qualifiedFeatureList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_qualifiedFeatureList) ;
    p->mAttribute_mFeatureValue = inOperand ;
  }
}
...
//mAttribute_mQualifiedFeatureList (inSource.mAttribute_mQualifiedFeatureList),
