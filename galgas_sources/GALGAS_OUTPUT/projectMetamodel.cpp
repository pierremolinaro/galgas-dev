...
GALGAS_projectSourceList_2E_element GALGAS_projectSourceList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_projectSourceList_2E_element (GALGAS_sourceFileKind::constructor_externSourceFile (HERE),
                                              GALGAS_lstring::constructor_default (HERE)) ;
}
...
GALGAS_qualifiedFeatureList_2E_element GALGAS_qualifiedFeatureList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_qualifiedFeatureList_2E_element (GALGAS_lstring::constructor_default (HERE),
                                                 GALGAS_lstring::constructor_default (HERE)) ;
}
