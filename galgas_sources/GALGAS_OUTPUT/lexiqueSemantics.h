...
//--- Readers
  ...
  reader_mStringInExplicitRuleSet (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
    return mStringInExplicitRuleSet ;
  }
...
//--- Attributes
  ...
  public : GGS_stringset  mStringInExplicitRuleSet ;
} ;
