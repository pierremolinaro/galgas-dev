...
//--- Constructor 'emptyList'
  ...
  public : static GGS_terminalList constructor_listWithValue (const GGS_lstring & argument_0,
                                const GGS_lexicalTypeList & argument_1) ;
//--- Get sublist
  protected : void
...
//--------------------------------- Direct Read Access
  ...
  public : GGS_lexicalTypeList 
  reader_mArgumentTypeListAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Direct Write Access
  ...
  modifier_setMTerminalNameAtIndex (C_Compiler & inLexique,
                              ...
                              COMMA_LOCATION_ARGS) const ;
  public : void
  modifier_setMArgumentTypeListAtIndex (C_Compiler & inLexique,
                              const GGS_lexicalTypeList  & inObject,
                              const GGS_uint & inIndex
                              COMMA_LOCATION_ARGS) const ;
