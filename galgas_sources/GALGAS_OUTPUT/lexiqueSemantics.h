...
//--- Modifiers "set'Value'ForKey"
  public : void modifier_setMessageIsUsedForKey (C_Compiler & inLexique,
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_bool  & _messageIsUsed (LOCATION_ARGS) const ;
  } ;
} ;
...
//--- Galgas 'new' destructor
  public : static GGS_lexiqueAnalysisContext constructor_new (const GGS_lexicalMessageMap & argument_0,
