...
public : void modifier_setMTypeNameForKey (C_Compiler & inLexique,                        const GGS_string& inValue,
...
//--- Modifiers "set'Value'ForKey"
public : void modifier_setMArgumentTypeListForKey (C_Compiler & inLexique,                        const GGS_stringlist & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
