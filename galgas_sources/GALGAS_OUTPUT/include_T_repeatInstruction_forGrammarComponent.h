//---------------------------------------------------------------------------*
//                                                                           *
//         File 'include_T_repeatInstruction_forGrammarComponent.h'          *
...
#ifndef T_repeatInstruction_forGrammarComponent_DEFINED
#define T_repeatInstruction_forGrammarComponent_DEFINED
...
class GGG_T_repeatInstruction_forGrammarComponent : public GGG_AC_instruction_ForGrammar {
  private : typedef GGG_AC_instruction_ForGrammar inherited ;
  public : GGG_T_repeatInstruction_forGrammarComponent (const GGS_location & ,
                                const GGS_L_branchList_ForGrammarComponent & ,
                                const GGS_uint &  COMMA_LOCATION_ARGS) ;
} ;
