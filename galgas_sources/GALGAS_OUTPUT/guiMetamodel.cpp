...
sint32 GGS_guiComponentRoot::gClassIDCounter = -1 ;

//---------------------------------------------------------------------------*

sint32 GGS_guiComponentRoot::getClassID (const char * /* inClassName */) {
...
const sint32 GGS_guiComponentRoot::kClassID = GGS_guiComponentRoot::getClassID ("GGS_guiComponentRoot") ;
