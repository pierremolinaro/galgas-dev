...
uint32 _metamodel_index_for_guiMetamodel (void) {
...
uint32 cPtr_guiAttribute::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_guiAttribute::_metamodelClassID (void) const {
  return 0 ;
}
...
uint32 cPtr_guiLabel::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_guiLabel::_metamodelClassID (void) const {
  return 1 ;
}
...
uint32 cPtr_guiComponentRoot::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_guiComponentRoot::_metamodelClassID (void) const {
  return 2 ;
}
