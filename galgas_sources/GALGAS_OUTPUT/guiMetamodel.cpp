...
/* const */ GGS_location  & GGS_guiLabelList::cEnumerator::_mLocation (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mLocation ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@guiComponentRoot:"
           ...
           << mImportedOptionList.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
