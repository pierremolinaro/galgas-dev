...
uint32 cPtr_guiAttribute::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_guiLabel::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_guiComponentRoot::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
