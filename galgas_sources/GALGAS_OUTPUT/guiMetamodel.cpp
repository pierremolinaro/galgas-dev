...
reader_description (C_Compiler & inLexique
  ...
  return _description (inLexique, "@guiSimpleAttributeList", inIndentation COMMA_THERE) ;
}
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@guiCompoundAttributeList", inIndentation COMMA_THERE) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLexiqueFileName.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mSimpleAttributes.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mCompoundAttributes.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@withLexiqueList", inIndentation COMMA_THERE) ;
}
...
/* const */ GGS_lstring  & GGS_withLexiqueList::cEnumerator::_mLexiqueFileName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mLexiqueFileName ;
}
...
/* const */ GGS_guiSimpleAttributeList  & GGS_withLexiqueList::cEnumerator::_mSimpleAttributes (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mSimpleAttributes ;
}
...
/* const */ GGS_guiCompoundAttributeList  & GGS_withLexiqueList::cEnumerator::_mCompoundAttributes (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mCompoundAttributes ;
}
...
mGlobalSimpleAttributeList (argument_2),
mWithLexiqueList (argument_3) {
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@guiComponentRoot:"
           ...
           << mGlobalSimpleAttributeList.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mWithLexiqueList.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
cPtr__AC_galgas_class * cPtr_guiComponentRoot::makeClone (void) const {
  ...
  macroMyNew (result, cPtr_guiComponentRoot (mGUIName, mGUIClass, mGlobalSimpleAttributeList, mWithLexiqueList COMMA_HERE)) ;
  return result ;
}
