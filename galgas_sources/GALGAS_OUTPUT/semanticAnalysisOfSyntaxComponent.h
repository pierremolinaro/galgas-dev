...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument0,
                                          const GALGAS_bool constinArgument1,
                                          const GALGAS_syntaxInstructionList constinArgument2,
                                          const GALGAS_analysisContext constinArgument3,
                                          const GALGAS_terminalMap constinArgument4,
                                          const GALGAS_string constinArgument5,
