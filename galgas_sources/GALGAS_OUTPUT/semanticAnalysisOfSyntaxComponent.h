...
class GGS_ruleIndexMap ;
class GGS_nonterminalDeclarationMap ;
...
class elementOf_GGS_ruleIndexMap ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_ruleIndexMap ;

//---------------------------------------------------------------------------*

class GGS_ruleIndexMap : public AC_GGS_map {
//--- Element Class
  public : typedef elementOf_GGS_ruleIndexMap cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_ruleIndexMap & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_ruleIndexMap & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_ruleIndexMap castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_ruleIndexMap * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_ruleIndexMap * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_ruleIndexMap constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;

//--- 'mapWithKeyAndValue' constructor
  public : static GGS_ruleIndexMap constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey
,
...
//--- Internal method for searching for an element
  protected : void searchElement (C_Compiler & inLexique,
                                  ...
                                  COMMA_LOCATION_ARGS) const ;
  public : virtual GGS_string reader_description (const PMSInt32 inIndentation = 0) const ;
  public : static GGS_ruleIndexMap constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_ruleIndexMap & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_ruleIndexMap reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Map Enumerator
  public : class cEnumerator : public cAbstractMapEnumerator {
  //--- Constructors
    public : inline cEnumerator (const GGS_ruleIndexMap & inMap,
                                 const bool inAscending) :
    cAbstractMapEnumerator (inMap, inAscending) {
    }
    public : inline cEnumerator (const GGS_ruleIndexMap & inMap) :
...
class elementOf_GGS_nonterminalDeclarationMap ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_nonterminalDeclarationMap ;

//---------------------------------------------------------------------------*

class GGS_nonterminalDeclarationMap : public AC_GGS_map {
//--- Element Class
  public : typedef elementOf_GGS_nonterminalDeclarationMap cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_nonterminalDeclarationMap & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_nonterminalDeclarationMap & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_nonterminalDeclarationMap castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_nonterminalDeclarationMap * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_nonterminalDeclarationMap * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_nonterminalDeclarationMap constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;

//--- 'mapWithKeyAndValue' constructor
  public : static GGS_nonterminalDeclarationMap constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey
,
...
//--- Internal method for searching for an element
  protected : void searchElement (C_Compiler & inLexique,
                                  ...
                                  COMMA_LOCATION_ARGS) const ;
  public : virtual GGS_string reader_description (const PMSInt32 inIndentation = 0) const ;
  public : static GGS_nonterminalDeclarationMap constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_nonterminalDeclarationMap & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_nonterminalDeclarationMap reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Map Enumerator
  public : class cEnumerator : public cAbstractMapEnumerator {
  //--- Constructors
    public : inline cEnumerator (const GGS_nonterminalDeclarationMap & inMap,
                                 const bool inAscending) :
    cAbstractMapEnumerator (inMap, inAscending) {
    }
    public : inline cEnumerator (const GGS_nonterminalDeclarationMap & inMap) :
...
//--------------------------------- Direct Read Access
  ...
  public : GGS_nonterminalLabelMap 
...
//--- Readers
  ...
  public : GGS_nonterminalDeclarationMap  reader_mNonterminalDeclarationMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
...
void routine_enterNonterminalNonTerminalInMapAndCheck (C_Compiler &,
                                ...
                                const GGS_bool ,
                                GGS_nonterminalDeclarationMap  & COMMA_LOCATION_ARGS) ;
...
void routine_buildContextFromRuleHeadersAndNonterminalDeclarations (C_Compiler &,
                                const GGS_nonterminalDeclarationListAST  ,
...
class e_ruleIndexMap {
  ...
  public : e_ruleIndexMap (void) ;
} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_ruleIndexMap : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_ruleIndexMap (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_ruleIndexMap & inInfo,
                                     const PMUInt32 inInitialState = 0) ;
//--- Get pointers
  public : inline elementOf_GGS_ruleIndexMap * nextObject (void) const { return (elementOf_GGS_ruleIndexMap *) mNextItem ; }
  public : inline elementOf_GGS_ruleIndexMap * infObject (void) const { return (elementOf_GGS_ruleIndexMap *) mInfPtr ; }
  public : inline elementOf_GGS_ruleIndexMap * supObject (void) const { return (elementOf_GGS_ruleIndexMap *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_ruleIndexMap mInfo ;
//--- Method for 'description' reader
  public : void appendForMapDescription (const PMSInt32 inElementIndex,
                                         C_String & ioString,
                                         const PMSInt32 inIndentation) const ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//               Element of map '@nonterminalDeclarationMap'                 *
//                                                                           *
//---------------------------------------------------------------------------*
...
class e_nonterminalDeclarationMap {
  ...
  public : e_nonterminalDeclarationMap (void) ;
} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_nonterminalDeclarationMap : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_nonterminalDeclarationMap (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_nonterminalDeclarationMap & inInfo,
                                     const PMUInt32 inInitialState = 0) ;
//--- Get pointers
  public : inline elementOf_GGS_nonterminalDeclarationMap * nextObject (void) const { return (elementOf_GGS_nonterminalDeclarationMap *) mNextItem ; }
  public : inline elementOf_GGS_nonterminalDeclarationMap * infObject (void) const { return (elementOf_GGS_nonterminalDeclarationMap *) mInfPtr ; }
  public : inline elementOf_GGS_nonterminalDeclarationMap * supObject (void) const { return (elementOf_GGS_nonterminalDeclarationMap *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_nonterminalDeclarationMap mInfo ;
//--- Method for 'description' reader
  public : void appendForMapDescription (const PMSInt32 inElementIndex,
                                         C_String & ioString,
                                         const PMSInt32 inIndentation) const ;
...
//--- Constructor
  public : cPtr_syntaxDeclarationForGeneration (const GGS_string& ,
                                const GGS_string& ,
                                const GGS_nonterminalDeclarationMap & ,
...
//--- Attributes
  ...
  public : GGS_nonterminalDeclarationMap  mNonterminalDeclarationMap ;
