...
void routine_analyzeSyntaxInstructionList (const GALGAS_analysisContext constinArgument0,
                                           ...
                                           const GALGAS_terminalMap constinArgument2,
                                           const GALGAS_string constinArgument3,
                                           const GALGAS_nonterminalMap constinArgument4,
                                           const GALGAS_string constinArgument5,
                                           const GALGAS_syntaxInstructionList constinArgument6,
                                           const GALGAS_location constinArgument7,
                                           const GALGAS_stringset constinArgument8,
                                           GALGAS_variableMap & ioArgument9,
...
void routine_semanticAnalysisOfRuleLabel (const GALGAS_formalParameterListAST constinArgument0,
                                          ...
                                          const GALGAS_string constinArgument5,
                                          const GALGAS_nonterminalMap constinArgument6,
                                          const GALGAS_string constinArgument7,
                                          const GALGAS_location constinArgument8,
                                          const GALGAS_stringset constinArgument9,
                                          GALGAS_uint & ioArgument10,
                                          GALGAS_formalParameterListForGeneration & outArgument11,
                                          GALGAS_formalParameterSignature & outArgument12,
                                          GALGAS_semanticInstructionListForGeneration & outArgument13,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) ;
...
void routine_semanticAnalysisOfSyntaxComponent (const GALGAS_nonterminalDeclarationListAST constinArgument0,
                                                ...
                                                GALGAS_syntaxDeclarationForGeneration & outArgument10,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) ;
...
typedef void (*categoryMethodSignature_syntaxInstructionAST_analyzeSyntaxInstruction) (const cPtr_syntaxInstructionAST * inObject,
                                                                                       ...
                                                                                       GALGAS_semanticInstructionListForGeneration & ioArgument7,
...
typedef void (*categoryMethodSignature_abstractInputParameter_analyzeInputParameter) (const cPtr_abstractInputParameter * inObject,
                                                                                      const GALGAS_analysisContext constinArgument0,
                                                                                      const GALGAS_lexicalTypeEnum constinArgument1,
                                                                                      const GALGAS_string constinArgument2,
                                                                                      GALGAS_terminalCheckAssignementList & ioArgument3,
...
typedef void (*categoryMethodSignature_abstractGrammarInstructionSyntaxDirectedTranslationResult_analyzeSDT) (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
                                                                                                              const GALGAS_analysisContext constinArgument0,
                                                                                                              const GALGAS_bool constinArgument1,
...
typedef void (*categoryMethodSignature_abstractGrammarInstructionSyntaxDirectedTranslationResult_generateCode) (const cPtr_abstractGrammarInstructionSyntaxDirectedTranslationResult * inObject,
