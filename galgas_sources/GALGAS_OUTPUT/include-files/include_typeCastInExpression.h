//---------------------------------------------------------------------------*
//                                                                           *
//                  File 'include_typeCastInExpression.h'                    *
...
class cPtr_typeCastInExpression : public cPtr_typeExpression {
...
//--- Constructor
  public : cPtr_typeCastInExpression (const GGS_typeExpression & ,
                                const GGS_bool& ,
                                const GGS_lstring & ,
...
//--- Attributes
  public : GGS_typeExpression  mCastedExpression ;
  public : GGS_bool mCheckForKindOfClass ;
  public : GGS_lstring  mCastTypeName ;
