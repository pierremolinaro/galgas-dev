//---------------------------------------------------------------------------*
//                                                                           *
//           File 'include_selectInstructionForGrammarAnalysis.h'            *
...
//---------------------------------------------------------------------------*
//                                                                           *
//        abstract class 'cPtr_selectInstructionForGrammarAnalysis'          *
//                                                                           *
//---------------------------------------------------------------------------*
...
//--- Constructor
  public : cPtr_selectInstructionForGrammarAnalysis (const GGS_location & ,
                                const GGS_branchListForGrammarAnalysis & ,
                                const GGS_uint & 
                                COMMA_LOCATION_ARGS) ;

//--- Attributes
  public : GGS_branchListForGrammarAnalysis  mSelectBranchList ;
