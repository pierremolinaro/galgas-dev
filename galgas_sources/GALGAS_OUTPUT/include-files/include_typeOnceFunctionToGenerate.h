//---------------------------------------------------------------------------*
//                                                                           *
//               File 'include_typeOnceFunctionToGenerate.h'                 *
...
//---------------------------------------------------------------------------*
//                                                                           *
//             abstract class 'cPtr_typeOnceFunctionToGenerate'              *
//                                                                           *
//---------------------------------------------------------------------------*

class cPtr_typeOnceFunctionToGenerate : public cPtr_typeEntityToGenerate {
...
//--- Constructor
  public : cPtr_typeOnceFunctionToGenerate (const GGS_lstring & ,
...
//--- Attributes
  ...
  public : GGS_typeCplusPlusName  mReturnedVar ;
