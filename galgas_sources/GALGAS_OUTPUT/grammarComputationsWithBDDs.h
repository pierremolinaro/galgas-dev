...
//--- 'nonterminalsWithOneElementProduction' relation
  ...
  public : GGS_string2list reader_nonterminalsWithOneElementProductionStringValueList (C_Compiler & inLexique
                                    COMMA_LOCATION_ARGS) const ;
...
//--- 'nonterminalsWithTwoElementProduction' relation
  ...
  public : GGS_string3list reader_nonterminalsWithTwoElementProductionStringValueList (C_Compiler & inLexique
                                    COMMA_LOCATION_ARGS) const ;
