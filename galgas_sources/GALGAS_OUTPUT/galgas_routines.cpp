...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_outOuputDirectory ;
  const GGS_bool cond_3453 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (61))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_3453.isBuiltAndTrue ()) {
    var_cas_outOuputDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent () ;
    var_cas_outOuputDirectory.appendCString ("/GALGAS_OUTPUT") ;
  }else if (cond_3453.isBuiltAndFalse ()) {
...
void routine_checkCategoryMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_classIndexList::cEnumerator enumerator_4001 (var_cas_descendantClasses, true) ;
    const GGS_classIndexList::cElement * operand_4001 = NULL ;
    while (((operand_4001 = enumerator_4001.nextObject ()))) {
      ...
      const GGS_typeMapIndex  temp_4083 = operand_4001->mClassMapindex ;
      if (temp_4083.isBuilt ()) {
        temp_4083 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (80)) ;
      }
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_4360 = var_cas_t ; // CAST instruction
        if (_var_4360.getPtr () != NULL) {
          macroValidPointer (_var_4360.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_4360.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_4360.getPtr ()) ;
      ...
      {
        GGS_overridingCategoryMethodList::cEnumerator enumerator_4558 (var_cas_overridingMethods, true) ;
        const GGS_overridingCategoryMethodList::cElement * operand_4558 = NULL ;
        while (((operand_4558 = enumerator_4558.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_4558) ;
          var_cas_found = (var_cas_inAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (operand_4558->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))) ;
        }
      }
      const GGS_bool cond_5325 = (var_cas_found).operator_not () ;
      if (cond_5325.isBuiltAndTrue ()) {
        const GGS_bool cond_5007 = var_cas_isAbstract ;
...
void routine_checkCategoryReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  {
    GGS_classIndexList::cEnumerator enumerator_5839 (var_cas_descendantClasses, true) ;
    const GGS_classIndexList::cElement * operand_5839 = NULL ;
    while (((operand_5839 = enumerator_5839.nextObject ()))) {
      macroValidPointer (operand_5839) ;
      GGS_lstring  var_cas_descendantClassName ;
      GGS_ACGalgasType  var_cas_t ;
      const GGS_typeMapIndex  temp_5921 = operand_5839->mClassMapindex ;
      if (temp_5921.isBuilt ()) {
        temp_5921 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (122)) ;
      }
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_6198 = var_cas_t ; // CAST instruction
        if (_var_6198.getPtr () != NULL) {
          macroValidPointer (_var_6198.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_6198.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_6198.getPtr ()) ;
      ...
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingCategoryReaderList::cEnumerator enumerator_6396 (var_cas_overridingReaders, true) ;
        const GGS_overridingCategoryReaderList::cElement * operand_6396 = NULL ;
        while (((operand_6396 = enumerator_6396.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_6396) ;
          var_cas_found = (var_cas_inAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133))).operator_isEqual (operand_6396->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133))) ;
        }
      }
      const GGS_bool cond_7163 = (var_cas_found).operator_not () ;
      if (cond_7163.isBuiltAndTrue ()) {
        const GGS_bool cond_6845 = var_cas_isAbstract ;
        ...
        }else if (cond_6845.isBuiltAndFalse ()) {
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7510 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (161)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_7510 = NULL ;
    while (((operand_7510 = enumerator_7510.nextObject ()))) {
      macroValidPointer (operand_7510) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_7510->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (162)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (162))) ;
    }
  }
  ...
  const GGS_bool cond_8911 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8911.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_8212 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (173)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_8212 = NULL ;
      while (((operand_8212 = enumerator_8212.nextObject ()))) {
        macroValidPointer (operand_8212) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_8212->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (174)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_8212->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (175)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (175))) ;
      }
    }
    ...
    {
      GGS_abstractCategoryMethodListMap::cEnumerator enumerator_8638 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_8638.hasCurrentObject ()) {
        {
          GGS_abstractCategoryMethodList::cEnumerator enumerator_8662 (enumerator_8638._object (HERE), true) ;
          const GGS_abstractCategoryMethodList::cElement * operand_8662 = NULL ;
          while (((operand_8662 = enumerator_8662.nextObject ()))) {
            macroValidPointer (operand_8662) ;
            ::routine_checkCategoryMethodDefinitionForClass (inLexique,  enumerator_8638._key (HERE),  enumerator_8638._key (HERE),  operand_8662->mAbstractCategoryMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (180)) ;
          }
        }
        enumerator_8638.next () ;
      }
    }
  }
  const GGS_bool cond_10003 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10003.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_9304 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_9304 = NULL ;
      while (((operand_9304 = enumerator_9304.nextObject ()))) {
        macroValidPointer (operand_9304) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_9304->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (197))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_9304->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (198)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (198))) ;
      }
    }
    ...
    {
      GGS_abstractCategoryReaderListMap::cEnumerator enumerator_9730 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_9730.hasCurrentObject ()) {
        {
          GGS_abstractCategoryReaderList::cEnumerator enumerator_9754 (enumerator_9730._object (HERE), true) ;
          const GGS_abstractCategoryReaderList::cElement * operand_9754 = NULL ;
          while (((operand_9754 = enumerator_9754.nextObject ()))) {
            macroValidPointer (operand_9754) ;
            ::routine_checkCategoryReaderDefinitionForClass (inLexique,  enumerator_9730._key (HERE),  enumerator_9730._key (HERE),  operand_9754->mAbstractCategoryReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap COMMA_SOURCE_FILE_AT_LINE (203)) ;
          }
        }
        enumerator_9730.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
