...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8541 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8541.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7842 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (163)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_7842 = NULL ;
      while (((operand_7842 = enumerator_7842.nextObject ()))) {
        macroValidPointer (operand_7842) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_7842->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (164))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_7842->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (165)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (165))) ;
      }
    }
    ...
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_8268 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_8268.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_8292 (enumerator_8268._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_8292 = NULL ;
          while (((operand_8292 = enumerator_8292.nextObject ()))) {
            macroValidPointer (operand_8292) ;
            ::routine_checkCategoryMethodDefinitionForClass (inLexique,  enumerator_8268._key (HERE),  enumerator_8268._key (HERE),  operand_8292->mAbstractCategoryMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (170)) ;
          }
        }
        enumerator_8268.next () ;
      }
    }
  }
  const GGS_bool cond_9633 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9633.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_8934 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_8934 = NULL ;
      while (((operand_8934 = enumerator_8934.nextObject ()))) {
        macroValidPointer (operand_8934) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_8934->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (187))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_8934->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (188))) ;
      }
    }
    ...
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_9360 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_9360.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_9384 (enumerator_9360._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_9384 = NULL ;
          while (((operand_9384 = enumerator_9384.nextObject ()))) {
            macroValidPointer (operand_9384) ;
            ::routine_checkCategoryReaderDefinitionForClass (inLexique,  enumerator_9360._key (HERE),  enumerator_9360._key (HERE),  operand_9384->mAbstractCategoryReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap COMMA_SOURCE_FILE_AT_LINE (193)) ;
          }
        }
        enumerator_9360.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
