...
void routine_checkCategoryMethodDefinitionForClass (C_Compiler & inLexique,
  ...
  GGS_classIndexList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (66)) ;
  {
    ...
    while (((operand_3626 = enumerator_3626.nextObject ()))) {
      ...
      const GGS_typeMapIndex  temp_3708 = operand_3626->mClassMapindex ;
      if (temp_3708.isBuilt ()) {
        temp_3708 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (68)) ;
      }
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_3985 = var_cas_t ; // CAST instruction
        if (_var_3985.getPtr () != NULL) {
          macroValidPointer (_var_3985.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_3985.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_3985.getPtr ()) ;
            var_cas_isAbstract = var_cas_classType.reader_mIsAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
          }else{
            var_cas_descendantClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' type should be a class")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
            var_cas_isAbstract.drop () ;
          }
        }
      }
      GGS_overridingMultiMethodListAST  var_cas_overridingMethods = var_cas_inOverridingCategoryMethodListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiMethodListAST::cEnumerator enumerator_4183 (var_cas_overridingMethods, true) ;
        const GGS_overridingMultiMethodListAST::cElement * operand_4183 = NULL ;
        while (((operand_4183 = enumerator_4183.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_4183) ;
          var_cas_found = (var_cas_inAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (79))).operator_isEqual (operand_4183->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (79))) ;
        }
      }
      const GGS_bool cond_4950 = (var_cas_found).operator_not () ;
      if (cond_4950.isBuiltAndTrue ()) {
        const GGS_bool cond_4632 = var_cas_isAbstract ;
        if (cond_4632.isBuiltAndTrue ()) {
          ::routine_checkCategoryMethodDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85)),  var_cas_inAbstractCategoryMethodName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (83)) ;
        }else if (cond_4632.isBuiltAndFalse ()) {
          var_cas_inAbstractCategoryMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract category method '")).operator_concat (var_cas_inAbstractCategoryMethodName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this method")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
        }
      }
    }
  }
...
void routine_checkCategoryReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  #endif
  GGS_classIndexList  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (108)) ;
  {
    GGS_classIndexList::cEnumerator enumerator_5464 (var_cas_descendantClasses, true) ;
    const GGS_classIndexList::cElement * operand_5464 = NULL ;
    while (((operand_5464 = enumerator_5464.nextObject ()))) {
      macroValidPointer (operand_5464) ;
      GGS_lstring  var_cas_descendantClassName ;
      GGS_ACGalgasType  var_cas_t ;
      const GGS_typeMapIndex  temp_5546 = operand_5464->mClassMapindex ;
      if (temp_5546.isBuilt ()) {
        temp_5546 (HERE)->method_searchKey (inLexique, var_cas_descendantClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (110)) ;
      }
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_5823 = var_cas_t ; // CAST instruction
        if (_var_5823.getPtr () != NULL) {
          macroValidPointer (_var_5823.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_5823.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_5823.getPtr ()) ;
            var_cas_isAbstract = var_cas_classType.reader_mIsAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (114)) ;
          }else{
            var_cas_descendantClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' type should be a class")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
            var_cas_isAbstract.drop () ;
          }
        }
      }
      GGS_overridingMultiReaderListAST  var_cas_overridingReaders = var_cas_inOverridingCategoryReaderListMap.reader_listForKey (inLexique, var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)) ;
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiReaderListAST::cEnumerator enumerator_6021 (var_cas_overridingReaders, true) ;
        const GGS_overridingMultiReaderListAST::cElement * operand_6021 = NULL ;
        while (((operand_6021 = enumerator_6021.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_6021) ;
          var_cas_found = (var_cas_inAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).operator_isEqual (operand_6021->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121))) ;
        }
      }
      const GGS_bool cond_6788 = (var_cas_found).operator_not () ;
      if (cond_6788.isBuiltAndTrue ()) {
        const GGS_bool cond_6470 = var_cas_isAbstract ;
        if (cond_6470.isBuiltAndTrue ()) {
          ::routine_checkCategoryReaderDefinitionForClass (inLexique,  var_cas_inClassNameForErrorSignaling,  var_cas_descendantClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)),  var_cas_inAbstractCategoryReaderName,  var_cas_inDescendantClassListMap,  var_cas_inOverridingCategoryReaderListMap COMMA_SOURCE_FILE_AT_LINE (125)) ;
        }else if (cond_6470.isBuiltAndFalse ()) {
          var_cas_inAbstractCategoryReaderName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("an abstract category reader '")).operator_concat (var_cas_inAbstractCategoryReaderName)).operator_concat (GGS_string ("' is defined for abstract class '@"))).operator_concat (var_cas_inClassNameForErrorSignaling)).operator_concat (GGS_string ("', but concrete descendant class '@"))).operator_concat (var_cas_descendantClassName)).operator_concat (GGS_string ("' does not implement this reader")) COMMA_SOURCE_FILE_AT_LINE (136)) ;
        }
      }
    }
  }
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7138 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (149)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_7138 = NULL ;
    while (((operand_7138 = enumerator_7138.nextObject ()))) {
      macroValidPointer (operand_7138) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_7138->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (150)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (150))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (154)) ;
  const GGS_bool cond_8539 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8539.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7840 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (161)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_7840 = NULL ;
      while (((operand_7840 = enumerator_7840.nextObject ()))) {
        macroValidPointer (operand_7840) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_7840->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (162)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (162))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_7840->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (163)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (163))) ;
      }
    }
    GGS_descendantClassListMap var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) ;
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_8266 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_8266.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_8290 (enumerator_8266._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_8290 = NULL ;
          while (((operand_8290 = enumerator_8290.nextObject ()))) {
            macroValidPointer (operand_8290) ;
            ::routine_checkCategoryMethodDefinitionForClass (inLexique,  enumerator_8266._key (HERE),  enumerator_8266._key (HERE),  operand_8290->mAbstractCategoryMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (168)) ;
          }
        }
        enumerator_8266.next () ;
      }
    }
  }
  const GGS_bool cond_9631 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9631.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_8932 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (184)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_8932 = NULL ;
      while (((operand_8932 = enumerator_8932.nextObject ()))) {
        macroValidPointer (operand_8932) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_8932->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (185)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_8932->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (186))) ;
      }
    }
    GGS_descendantClassListMap var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_9358 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_9358.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_9382 (enumerator_9358._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_9382 = NULL ;
          while (((operand_9382 = enumerator_9382.nextObject ()))) {
            macroValidPointer (operand_9382) ;
            ::routine_checkCategoryReaderDefinitionForClass (inLexique,  enumerator_9358._key (HERE),  enumerator_9358._key (HERE),  operand_9382->mAbstractCategoryReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap COMMA_SOURCE_FILE_AT_LINE (191)) ;
          }
        }
        enumerator_9358.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
