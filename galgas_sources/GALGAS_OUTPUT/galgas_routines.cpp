...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7155 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (150)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_7155 = NULL ;
    while (((operand_7155 = enumerator_7155.nextObject ()))) {
      macroValidPointer (operand_7155) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_7155->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (151)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (151))) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
