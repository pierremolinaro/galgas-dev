...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3003 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (48))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_3003.isBuiltAndTrue ()) {
  ...
  }else if (cond_3003.isBuiltAndFalse ()) {
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_semanticDeclarationList COMMA_SOURCE_FILE_AT_LINE (150)) ;
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7259 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (152)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_7259 = NULL ;
    while (((operand_7259 = enumerator_7259.nextObject ()))) {
      macroValidPointer (operand_7259) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_7259->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (153)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (153))) ;
    }
  }
  GGS_semanticContext var_cas_semanticContext ;
  ::routine_buildSemanticContext (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (157)) ;
  const GGS_bool cond_8713 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (164))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8713.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7970 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (168)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_7970 = NULL ;
      while (((operand_7970 = enumerator_7970.nextObject ()))) {
        macroValidPointer (operand_7970) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_7970->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (169)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (169))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_7970->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (170)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (170))) ;
      }
    }
    GGS_descendantClassListMap var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
    inLexique.printMessage (C_String ("LOGGING descendantClassListMap: ") + var_cas_descendantClassListMap.reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (173)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
