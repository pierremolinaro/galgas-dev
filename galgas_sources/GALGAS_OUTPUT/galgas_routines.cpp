...
GGS_string function_outputDirectory (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3082 = (var_cas_inSourceFile.ggs_string ().reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (49))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_3082.isBuiltAndTrue ()) {
  ...
  }else if (cond_3082.isBuiltAndFalse ()) {
...
void routine_checkCategoryMethodDefinitionForClass (C_Compiler & inLexique,
                                ...
                                const GGS_descendantClassListMapEX  var_cas_inDescendantClassListMap,
  ...
  #endif
  GGS_classIndexListEX  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (66)) ;
  {
    GGS_classIndexListEX::cEnumerator enumerator_3634 (var_cas_descendantClasses, true) ;
    const GGS_classIndexListEX::cElement * operand_3634 = NULL ;
    while (((operand_3634 = enumerator_3634.nextObject ()))) {
      macroValidPointer (operand_3634) ;
      GGS_lstring  var_cas_descendantClassName = operand_3634->mClassMapindex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
      GGS_ACGalgasType  var_cas_t = operand_3634->mClassMapindex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_3994 = var_cas_t ; // CAST instruction
        if (_var_3994.getPtr () != NULL) {
          macroValidPointer (_var_3994.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_3994.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_3994.getPtr ()) ;
      ...
      {
        GGS_overridingMultiMethodListAST::cEnumerator enumerator_4192 (var_cas_overridingMethods, true) ;
        const GGS_overridingMultiMethodListAST::cElement * operand_4192 = NULL ;
        while (((operand_4192 = enumerator_4192.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_4192) ;
          var_cas_found = (var_cas_inAbstractCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (80))).operator_isEqual (operand_4192->mOverridingCategoryMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (80))) ;
        }
      }
      const GGS_bool cond_4959 = (var_cas_found).operator_not () ;
      if (cond_4959.isBuiltAndTrue ()) {
        const GGS_bool cond_4641 = var_cas_isAbstract ;
        if (cond_4641.isBuiltAndTrue ()) {
        ...
        }else if (cond_4641.isBuiltAndFalse ()) {
...
void routine_checkCategoryReaderDefinitionForClass (C_Compiler & inLexique,
  ...
  #endif
  GGS_classIndexListEX  var_cas_descendantClasses = var_cas_inDescendantClassListMap.reader_listForKey (inLexique, var_cas_inClassName COMMA_SOURCE_FILE_AT_LINE (109)) ;
  {
    GGS_classIndexListEX::cEnumerator enumerator_5477 (var_cas_descendantClasses, true) ;
    const GGS_classIndexListEX::cElement * operand_5477 = NULL ;
    while (((operand_5477 = enumerator_5477.nextObject ()))) {
      macroValidPointer (operand_5477) ;
      GGS_lstring  var_cas_descendantClassName = operand_5477->mClassMapindex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) ;
      GGS_ACGalgasType  var_cas_t = operand_5477->mClassMapindex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (112)) ;
      GGS_bool var_cas_isAbstract ;
      { const GGS_ACGalgasType _var_5837 = var_cas_t ; // CAST instruction
        if (_var_5837.getPtr () != NULL) {
          macroValidPointer (_var_5837.getPtr ()) ;
          if (dynamic_cast <cPtr_classGalgasType *> (_var_5837.getPtr ()) != NULL) {
            const GGS_classGalgasType var_cas_classType (_var_5837.getPtr ()) ;
      ...
      GGS_bool var_cas_found = GGS_bool (false) ;
      {
        GGS_overridingMultiReaderListAST::cEnumerator enumerator_6035 (var_cas_overridingReaders, true) ;
        const GGS_overridingMultiReaderListAST::cElement * operand_6035 = NULL ;
        while (((operand_6035 = enumerator_6035.nextObject ()))
            && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
          macroValidPointer (operand_6035) ;
          var_cas_found = (var_cas_inAbstractCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (123))).operator_isEqual (operand_6035->mOverridingCategoryReaderName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (123))) ;
        }
      }
      const GGS_bool cond_6802 = (var_cas_found).operator_not () ;
      if (cond_6802.isBuiltAndTrue ()) {
        const GGS_bool cond_6484 = var_cas_isAbstract ;
        if (cond_6484.isBuiltAndTrue ()) {
        ...
        }else if (cond_6484.isBuiltAndFalse ()) {
...
void routine_performProjectGlobalCheckings (C_Compiler & inLexique,
  ...
  {
    GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7152 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (151)), true) ;
    const GGS_parsedSemanticsComponentMap::cElement * operand_7152 = NULL ;
    while (((operand_7152 = enumerator_7152.nextObject ()))) {
      macroValidPointer (operand_7152) ;
      var_cas_semanticDeclarationList.dotAssign_operation (operand_7152->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (152)).reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (152))) ;
    }
  }
  GGS_semanticContextEX var_cas_semanticContext ;
  ::routine_buildSemanticContextEX (inLexique,  var_cas_semanticDeclarationList,  var_cas_inEndOfSourceFile,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (156)) ;
  const GGS_bool cond_8559 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8559.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_7858 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (163)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_7858 = NULL ;
      while (((operand_7858 = enumerator_7858.nextObject ()))) {
        macroValidPointer (operand_7858) ;
        var_cas_abstractCategoryMethodListMap.dotAssign_operation (operand_7858->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (164)).reader_mAbstractCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (164))) ;
        var_cas_overridingCategoryMethodListMap.dotAssign_operation (operand_7858->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (165)).reader_mOverridingCategoryMethodListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (165))) ;
      }
    }
    GGS_descendantClassListMapEX var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
    {
      GGS_abstractMultiMethodListMapAST::cEnumerator enumerator_8286 (var_cas_abstractCategoryMethodListMap, true) ;
      while (enumerator_8286.hasCurrentObject ()) {
        {
          GGS_abstracMultiMethodListAST::cEnumerator enumerator_8310 (enumerator_8286._object (HERE), true) ;
          const GGS_abstracMultiMethodListAST::cElement * operand_8310 = NULL ;
          while (((operand_8310 = enumerator_8310.nextObject ()))) {
            macroValidPointer (operand_8310) ;
            ::routine_checkCategoryMethodDefinitionForClass (inLexique,  enumerator_8286._key (HERE),  enumerator_8286._key (HERE),  operand_8310->mAbstractCategoryMethodName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryMethodListMap COMMA_SOURCE_FILE_AT_LINE (170)) ;
          }
        }
        enumerator_8286.next () ;
      }
    }
  }
  const GGS_bool cond_9653 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9653.isBuiltAndTrue ()) {
    ...
    {
      GGS_parsedSemanticsComponentMap::cEnumerator enumerator_8952 (var_cas_inParsedComponentStruct.reader_mParsedSemanticsComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), true) ;
      const GGS_parsedSemanticsComponentMap::cElement * operand_8952 = NULL ;
      while (((operand_8952 = enumerator_8952.nextObject ()))) {
        macroValidPointer (operand_8952) ;
        var_cas_abstractCategoryReaderListMap.dotAssign_operation (operand_8952->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_mAbstractCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (187))) ;
        var_cas_overridingCategoryReaderListMap.dotAssign_operation (operand_8952->mInfo.mRoot.reader_mSemanticDeclarations (inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_mOverridingCategoryReaderListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (188))) ;
      }
    }
    GGS_descendantClassListMapEX var_cas_descendantClassListMap = var_cas_semanticContext.reader_mDescendantClassListMap (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
    {
      GGS_abstractMultiReaderListMapAST::cEnumerator enumerator_9380 (var_cas_abstractCategoryReaderListMap, true) ;
      while (enumerator_9380.hasCurrentObject ()) {
        {
          GGS_abstractMultiReaderListAST::cEnumerator enumerator_9404 (enumerator_9380._object (HERE), true) ;
          const GGS_abstractMultiReaderListAST::cElement * operand_9404 = NULL ;
          while (((operand_9404 = enumerator_9404.nextObject ()))) {
            macroValidPointer (operand_9404) ;
            ::routine_checkCategoryReaderDefinitionForClass (inLexique,  enumerator_9380._key (HERE),  enumerator_9380._key (HERE),  operand_9404->mAbstractCategoryReaderName,  var_cas_descendantClassListMap,  var_cas_overridingCategoryReaderListMap COMMA_SOURCE_FILE_AT_LINE (193)) ;
          }
        }
        enumerator_9380.next () ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
