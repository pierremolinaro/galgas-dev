...
pr_grammar_component_start_symbol_grammarModelBuilder_40_6_ (galgas_scanner & _inLexique) {
  ...
  GGS_grammarLabelList  var_cas_mLabels ;
  var_cas_mLabels = GGS_grammarLabelList::constructor_emptyList (_inLexique COMMA_HERE) ;
...
pr_grammar_start_symbol_label_grammarModelBuilder_87_6_ (galgas_scanner & _inLexique,
  ...
  GGS_startSymbolLabelFormalParameterList  var_cas_mFormalParameters ;
  var_cas_mFormalParameters = GGS_startSymbolLabelFormalParameterList::constructor_emptyList (_inLexique COMMA_HERE) ;
