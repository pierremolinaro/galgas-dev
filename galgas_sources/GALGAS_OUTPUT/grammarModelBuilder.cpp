...
void grammarModelBuilder::rule_grammarModelBuilder_grammar_5F_component_5F_start_5F_symbol_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_grammar_5F_start_5F_symbol_5F_label_ (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (90)), var_cas_mLabelList) ;
        ...
        case 2 : {
          ...
          switch (select_grammarModelBuilder_4 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_3673 = var_cas_startSymbolHasParseLabel ;
              if (cond_3673.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'parse' label has been already declared") COMMA_SOURCE_FILE_AT_LINE (101)) ;
              }
    ...
    while (syntaxRepeat_7) {
      switch (select_grammarModelBuilder_7 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_4888 = var_cas_argumentNameSet.reader_hasKey (var_cas_argumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (147))) ;
          if (cond_4888.isBuiltAndTrue ()) {
            var_cas_argumentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("there is already an argument named '")).operator_concat (var_cas_argumentName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (149)) ;
          }
          var_cas_argumentNameSet.addAssign_operation (var_cas_argumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (150))) ;
          } break ;
        default :
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (169)), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (190)), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (211)), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i5_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (228)), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
