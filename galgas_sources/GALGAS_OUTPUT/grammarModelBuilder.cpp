...
grammarModelBuilder::
pr_grammar_component_start_symbol_grammarModelBuilder_40_6_ (galgas_scanner & _inLexique) {
...
grammarModelBuilder::
pr_grammar_start_symbol_label_grammarModelBuilder_87_6_ (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_grammarModelBuilder_3 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_argumentNameSet.reader_hasKey (_inLexique, var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94))).isBuiltAndTrue ()) {
            var_cas_argumentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "there is already an argument named '"))._operator_concat (var_cas_argumentName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
          }
...
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_109_6_ (galgas_scanner & _inLexique,
...
GGS_startSymbolLabelFormalParameter grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_122_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName) {
  GGS_formalArgumentPassingMode var_cas_mFormalAgumentPassingMode ;
  GGS_lstring  var_cas_mTypeName ;
...
GGS_startSymbolLabelFormalParameter grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_135_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName) {
  GGS_formalArgumentPassingMode var_cas_mFormalAgumentPassingMode ;
  GGS_lstring  var_cas_mTypeName ;
...
GGS_startSymbolLabelFormalParameter grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_148_6_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName) {
  GGS_formalArgumentPassingMode var_cas_mFormalAgumentPassingMode ;
  GGS_lstring  var_cas_mTypeName ;
