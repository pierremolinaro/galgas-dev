...
pr_grammar_component_start_symbol_grammarModelBuilder_40_6_ (galgas_scanner & _inLexique) {
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_mLabels._addModel (nt_grammar_start_symbol_label_ (_inLexique, var_cas_labelName)) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_grammarModelBuilder_3 (_inLexique)) {
        case 2 : {
          ...
          var_cas_mFormalParameters._addModel (nt_label_formal_parameter_ (_inLexique, var_cas_argumentName)) ;
