...
void grammarModelBuilder::
pr_grammar_start_symbol_label_grammarModelBuilder_115_4_ (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_grammarModelBuilder_5 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_argumentNameSet.reader_hasKey (_inLexique, var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) COMMA_SOURCE_FILE_AT_LINE (125))).isBuiltAndTrue ()) {
            var_cas_argumentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "there is already an argument named '"))._operator_concat (var_cas_argumentName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
          }
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_155_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_175_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_195_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
