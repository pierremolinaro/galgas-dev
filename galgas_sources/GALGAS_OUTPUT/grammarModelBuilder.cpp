...
pr_grammar_component_start_symbol_grammarModelBuilder_48_37_ (galgas_scanner & inLexique,
  ...
  GGS_grammarLabelList  var_cas_mLabelList = GGS_grammarLabelList ::constructor_emptyList () ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outGrammarComponentRoot = GGS_grammarComponentRoot ::constructor_new (inLexique, var_cas_mGrammarName, var_cas_mGrammarClass, var_cas_syntaxComponents, var_cas_mStartSymbol, var_cas_mLabelList, var_cas_mUnusedNonterminalList COMMA_HERE) ;
}
...
void grammarModelBuilder::
pr_grammar_start_symbol_label_grammarModelBuilder_125_33_ (galgas_scanner & inLexique,
  ...
  GGS_startSymbolLabelFormalParameterList  var_cas_mFormalParameterList = GGS_startSymbolLabelFormalParameterList ::constructor_emptyList () ;
    ...
    while (syntaxRepeat_6) {
      switch (select_repeat_grammarModelBuilder_6 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_4518 = var_cas_argumentNameSet.reader_hasKey (inLexique, var_cas_argumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)) ;
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_145_29_ (galgas_scanner & inLexique,
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_165_29_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_185_29_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_205_29_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
