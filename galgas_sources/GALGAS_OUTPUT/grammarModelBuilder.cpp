...
//                    november 14th, 2010, at 21h30'20"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void cParser_grammarModelBuilder::rule_grammarModelBuilder_grammar_5F_component_5F_start_5F_symbol_i0_ (GALGAS_grammarComponentAST & outArgument_outGrammarComponentRoot,
  ...
  nt_grammar_5F_start_5F_symbol_5F_label_ (GALGAS_lstring::constructor_new (GALGAS_string (""), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (88)), var_mLabelList, inCompiler) ;
  //-------- @repeatInstructionForGeneration
  ...
  while (repeatFlag_2) {
    ...
    case 2: {
      ...
      case 2: {
        ...
        if (var_startSymbolHasParseLabel.isValidAndTrue ()) {
...
void cParser_grammarModelBuilder::rule_grammarModelBuilder_grammar_5F_start_5F_symbol_5F_label_i1_ (const GALGAS_lstring constinArgument_inLabelName,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      //-------- @ifInstructionForGeneration
      if (var_argumentNameSet.reader_hasKey (var_argumentName.reader_string (SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (var_argumentName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("there is already an argument named '").operator_concat (var_argumentName.reader_string (SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }
      //-------- @addAssignInstructionForGeneration
