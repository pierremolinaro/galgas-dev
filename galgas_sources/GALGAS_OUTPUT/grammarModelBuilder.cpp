...
grammarModelBuilder::
pr_grammar_component_start_symbol_grammarModelBuilder_48_4_ (galgas_scanner & _inLexique,
...
void grammarModelBuilder::
grammarModelBuilder::
pr_grammar_start_symbol_label_grammarModelBuilder_104_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_3) {
      switch (select_repeat_grammarModelBuilder_3 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_argumentNameSet.reader_hasKey (_inLexique, var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (114)) COMMA_SOURCE_FILE_AT_LINE (114))).isBuiltAndTrue ()) {
            var_cas_argumentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "there is already an argument named '"))._operator_concat (var_cas_argumentName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
          }
          var_cas_argumentNameSet._addAssign_operation (var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117))) ;
          } break ;
        default :
  ...
  var_cas_ioLabelList._addAssign_operation (var_cas_inLabelName, var_cas_mFormalParameterList, var_cas_mMetamodelName) ;
}
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_131_4_ (galgas_scanner & _inLexique,
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_151_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_171_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_191_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
