...
void grammarModelBuilder::rule_grammarModelBuilder_grammar_5F_component_5F_start_5F_symbol_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_grammar_5F_start_5F_symbol_5F_label_ (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), var_cas_mLabelList) ;
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_HERE), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
...
void grammarModelBuilder::rule_grammarModelBuilder_label_5F_formal_5F_parameter_i5_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_outArgumentName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioStartSymbolLabelFormalParameterList.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE), var_cas_mTypeName, var_cas_outArgumentName, GGS_bool (false)) ;
}
