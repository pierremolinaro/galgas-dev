...
pr_grammar_component_start_symbol_grammarModelBuilder_47_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_mUnusedNonterminalList = GGS_lstringlist ::constructor_emptyList (_inLexique COMMA_HERE) ;
...
void grammarModelBuilder::
grammarModelBuilder::
pr_grammar_start_symbol_label_grammarModelBuilder_117_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_grammarModelBuilder_5 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_argumentNameSet.reader_hasKey (_inLexique, var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (127)) COMMA_SOURCE_FILE_AT_LINE (127))).isBuiltAndTrue ()) {
            var_cas_argumentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "there is already an argument named '"))._operator_concat (var_cas_argumentName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
          }
          var_cas_argumentNameSet._addAssign_operation (var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (130))) ;
          } break ;
        default :
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_137_4_ (galgas_scanner & _inLexique,
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_157_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_177_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
...
void grammarModelBuilder::
grammarModelBuilder::
pr_label_formal_parameter_grammarModelBuilder_197_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_outArgumentName,
                                GGS_startSymbolLabelFormalParameterList  &var_cas_ioStartSymbolLabelFormalParameterList) {
