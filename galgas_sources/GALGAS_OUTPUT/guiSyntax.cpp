    ...
    while (syntaxRepeat_0) {
      switch (select_guiSyntax_0 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
          GGS_lstring  var_cas_mValue = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (50)) ;
          { bool syntaxRepeat_1 = true ;
            while (syntaxRepeat_1) {
                GGS_lstring  var_cas_value ;
                inLexique.assignFromAttribute_tokenString (var_cas_value) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                var_cas_mValue = GGS_lstring ::constructor_new (inLexique, (var_cas_mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53))).operator_concat (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53))), var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) COMMA_SOURCE_FILE_AT_LINE (53)) ;
                ...
                while (syntaxRepeat_3) {
                  switch (select_guiSyntax_3 (inLexique)) {
                    ...
                    case 3 : {
                      ...
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_HERE) ;
                      GGS_lstring  var_cas_value = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (88)) ;
                      { bool syntaxRepeat_5 = true ;
                        while (syntaxRepeat_5) {
                            GGS_lstring  var_cas_v ;
                            inLexique.assignFromAttribute_tokenString (var_cas_v) ;
                            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                            var_cas_value = GGS_lstring ::constructor_new (inLexique, (var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_concat (var_cas_v.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))), var_cas_v.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
