...
class expression_parser {
  ...
  protected : void pr_factor_expression_parser_1495_4_ (galgas_scanner &,
                                const GGS_M_semanticsEntitiesForUse  ,
                                const GGS_M_optionComponents  ,
                                const GGS_M_filewrappers  ,
                                GGS_typeVariablesMap  &,
  ...
  protected : void pr_factor_expression_parser_1495_4_parse (galgas_scanner & _inLexique) ;

  protected : void pr_read_access_expression_parser_1634_4_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_typeCplusPlusName  &,
                                GGS_AC_galgasType  &,
                                GGS_typeVariablesMap  &) ;

  protected : void pr_read_access_expression_parser_1634_4_parse (galgas_scanner & _inLexique) ;

  protected : void pr_read_access_expression_parser_1650_4_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_typeCplusPlusName  &,
                                GGS_AC_galgasType  &,
                                GGS_typeVariablesMap  &) ;

  protected : void pr_read_access_expression_parser_1650_4_parse (galgas_scanner & _inLexique) ;

  protected : void pr_output_expression_list_expression_parser_1672_4_ (galgas_scanner &,
                                GGS_typeExpressionList  &,
                                const GGS_typeListeAttributsSemantiques  ,
                                const GGS_M_semanticsEntitiesForUse  ,
                                const GGS_M_optionComponents  ,
  ...
  protected : void pr_output_expression_list_expression_parser_1672_4_parse (galgas_scanner & _inLexique) ;

  protected : void pr_parse_effective_input_parameters_list_expression_parser_1719_4_ (galgas_scanner &,
                                GGS_typeVariablesMap  &,
                                GGS_typeListeAttributsSemantiques  ,
                                GGS_location  ,
                                GGS_localConstantBuildStyleEnum ,
  ...
  protected : void pr_parse_effective_input_parameters_list_expression_parser_1719_4_parse (galgas_scanner & _inLexique) ;
