...
class expression_parser {
  ...
  protected : void pr_read_access_expression_parser_1667_18_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_typeCplusPlusName  &,
                                GGS_AC_galgasType  &,
                                GGS_typeVariablesMap  &) ;

  protected : void pr_read_access_expression_parser_1667_18_parse (galgas_scanner & _inLexique) ;

  protected : void pr_read_access_expression_parser_1683_18_ (galgas_scanner &,
                                GGS_lstring  &,
                                GGS_typeCplusPlusName  &,
                                GGS_AC_galgasType  &,
                                GGS_typeVariablesMap  &) ;

  protected : void pr_read_access_expression_parser_1683_18_parse (galgas_scanner & _inLexique) ;

  protected : void pr_output_expression_list_expression_parser_1705_29_ (galgas_scanner &,
                                GGS_typeExpressionList  &,
                                const GGS_typeListeAttributsSemantiques  ,
                                const GGS_M_semanticsEntitiesForUse  ,
                                const GGS_M_optionComponents  ,
  ...
  protected : void pr_output_expression_list_expression_parser_1705_29_parse (galgas_scanner & _inLexique) ;

  protected : void pr_parse_effective_input_parameters_list_expression_parser_1752_44_ (galgas_scanner &,
                                GGS_typeVariablesMap  &,
                                GGS_typeListeAttributsSemantiques  ,
                                GGS_location  ,
                                GGS_localConstantBuildStyleEnum ,
  ...
  protected : void pr_parse_effective_input_parameters_list_expression_parser_1752_44_parse (galgas_scanner & _inLexique) ;
