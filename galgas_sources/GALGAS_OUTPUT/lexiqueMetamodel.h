...
//--- Constructor 'emptyList'
  public : static GGS_lexicalActualArgumentList constructor_emptyList (void) ;
  public : static GGS_lexicalActualArgumentList constructor_listWithValue (const GGS_lexicalActualArgument & argument_0) ;
//--- Get sublist
  protected : void
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_Compiler & _inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_lexicalActualArgumentList inOperand) ;
