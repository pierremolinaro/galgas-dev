...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_classDeclaration (mIsAbstract, mClassTypeName, mSuperClassName, mAttributeList, mAbstractMethodList, mOverridenMethodList, mMethodList, mMessageList COMMA_HERE)) ;
  return _p ;
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_6 = _p->mMethodList ;
    _out_7 = _p->mMessageList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mSortedListTypeName ;
    _out_1 = _p->mAttributeList ;
    _out_2 = _p->mSortDescriptorList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
