...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_formalParameter (mFormalParameterPassingMode, mFormalParameterTypeName, mFormalParameterName COMMA_HERE)) ;
  return _p ;
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_classDeclaration (mIsAbstract, mClassTypeName, mSuperClassName, mAttributeList, mAbstractMethodList COMMA_HERE)) ;
  return _p ;
}
