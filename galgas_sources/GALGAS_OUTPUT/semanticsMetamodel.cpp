...
sint32 cPtr_structuredTypeAttribute::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_structuredTypeAttribute::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_structuredTypeAttribute::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 1 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_structuredTypeAttribute::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "structuredTypeAttribute" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
