...
GGS_attributeInCollectionList::GGS_attributeInCollectionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_mapMethodList::GGS_mapMethodList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_abstractMethodDefinitionList::GGS_abstractMethodDefinitionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_overridenMethodDefinitionList::GGS_overridenMethodDefinitionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_methodDefinitionList::GGS_methodDefinitionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_classMessageDefinitionList::GGS_classMessageDefinitionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_sortedListSortDescriptorList::GGS_sortedListSortDescriptorList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumMessageAssociationList::GGS_enumMessageAssociationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumMessageList::GGS_enumMessageList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumModifierCaseList::GGS_enumModifierCaseList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumModifierList::GGS_enumModifierList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumMethodCaseList::GGS_enumMethodCaseList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumMethodList::GGS_enumMethodList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumOperatorCaseList::GGS_enumOperatorCaseList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_enumOperatorList::GGS_enumOperatorList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_filewrapperTemplateList::GGS_filewrapperTemplateList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
mAbstractCategoryMethodMap (argument_3),
mEndOfSourceFile (argument_4) {
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mSemanticsComponentName._operator_isEqual (_p->mSemanticsComponentName).boolValue ()
         ...
         && mAbstractCategoryMethodMap._operator_isEqual (_p->mAbstractCategoryMethodMap).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@semanticsComponentRoot:"
           ...
           << mAbstractCategoryMethodMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
GGS_abstractCategoryMethodMap GGS_semanticsComponentRoot::
reader_mAbstractCategoryMethodMap (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_abstractCategoryMethodMap  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_semanticsComponentRoot *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_semanticsComponentRoot *) mPointer)->mAbstractCategoryMethodMap ;
  }
  return result ;
}
