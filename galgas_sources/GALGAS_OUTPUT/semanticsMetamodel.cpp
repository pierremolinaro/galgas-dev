...
uint32 cPtr_methodDefinition::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_sortedListSortDescriptor::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_sortedListDeclaration::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
cPtr_actionDeclaration::
cPtr_actionDeclaration (const GGS_lstring & argument_0,
                                const GGS_formalParameters & argument_1
                                COMMA_LOCATION_ARGS) :
cPtr_semanticDeclaration (THERE),
...
bool cPtr_actionDeclaration::
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_actionDeclaration * _p = dynamic_cast <const cPtr_actionDeclaration *> (inOperand) ;
    macroValidPointer (_p) ;
...
void cPtr_actionDeclaration::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @actionDeclaration" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
uint32 cPtr_actionDeclaration::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}

//---------------------------------------------------------------------------*

uint32 cPtr_actionDeclaration::_metamodelClassID (void) const {
  return 17 ;
}

//---------------------------------------------------------------------------*

cPtr_actionDeclaration * cPtr_actionDeclaration::
_cloneObject (void) const {
  cPtr_actionDeclaration * _p = NULL ;
  macroMyNew (_p, cPtr_actionDeclaration (mActionName, mFormalParameters COMMA_HERE)) ;
  return _p ;
}
...
void GGS_actionDeclarationList::
_internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_formalParameters & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
...
void GGS_actionDeclarationList::
_addAssign_operation (const GGS_actionDeclaration & inElement) {
  if (_isBuilt () && inElement._isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (((cPtr_actionDeclaration *) inElement.getPtr ())->mActionName,
                                ((cPtr_actionDeclaration *) inElement.getPtr ())->mFormalParameters) ;
  }
}

//---------------------------------------------------------------------------*

GGS_actionDeclarationList GGS_actionDeclarationList::
_operator_concat (const GGS_actionDeclarationList & inOperand) const {
  GGS_actionDeclarationList result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
    }else{
      ...
      if (inOperand.count () > 0) {
        result._insulateList () ;
        cPtr_actionDeclaration * p = inOperand.firstObject () ;
        while (p != NULL) {
          macroValidPointer (p) ;
...
GGS_string GGS_actionDeclarationList::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@actionDeclarationList", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

void GGS_actionDeclarationList::
_addModel (const GGS_actionDeclaration & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_actionDeclaration::constructor_new (_inLexique,
       _p->mActionName,
       _p->mFormalParameters) ;
  }else{
    outElement._drop_operation () ;
...
GGS_actionDeclaration GGS_actionDeclaration::
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_lstring & argument_0,
                 const GGS_formalParameters & argument_1
                                COMMA_LOCATION_ARGS) {
  GGS_actionDeclaration result ;
  macroMyNew (result.mPointer, cPtr_actionDeclaration (argument_0,
                                argument_1 COMMA_THERE)) ;
  return result ;
}
...
GGS_lstring  GGS_actionDeclaration::
reader_mActionName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_actionDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_actionDeclaration *) mPointer)->mActionName ;
  }
  return result ;
}
...
GGS_formalParameters  GGS_actionDeclaration::
reader_mFormalParameters (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_formalParameters   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_actionDeclaration *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_actionDeclaration *) mPointer)->mFormalParameters ;
  }
  return result ;
}
...
const char * GGS_actionDeclaration::actualTypeName (void) const {
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_actionDeclaration * GGS_actionDeclaration::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
