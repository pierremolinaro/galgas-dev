...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mAlternateMethodName.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
internalSubListWithRange (GGS_mapMethodList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mMethodName, ptr->mAlternateMethodName, ptr->mErrorMessage, ptr->mShadowErrorMessage) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
/* const */ GGS_lstring  & GGS_mapMethodList::cEnumerator::_mAlternateMethodName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mAlternateMethodName ;
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mOptionComponentRoot.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
constructor_new (const GGS_parsedSemanticsComponentMap & argument_0,
  ...
  result.mParsedOptionComponentMap = argument_2 ;
  return result ;
}
...
reader_description (C_Compiler & inLexique
  ...
  if (isBuilt ()) {
    ...
    _s << mParsedLexiqueComponentMap.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mParsedOptionComponentMap " ;
    _s << mParsedOptionComponentMap.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
