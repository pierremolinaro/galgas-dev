...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59114 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59133 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_59114 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59114) ;
    cPtr_typeGalgas_uint * operand_59133 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59133) ;
    if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_59114 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59114) ;
      cPtr_typeGalgas_sint * operand_59133 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59133) ;
      if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_59114 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59114) ;
        cPtr_typeGalgas_char * operand_59133 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59133) ;
        if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_59114 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59114) ;
          cPtr_typeGalgas_string * operand_59133 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59133) ;
          if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_59114 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59114) ;
            cPtr_typeGalgas_bool * operand_59133 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59133) ;
            if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_59114 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59114) ;
              cPtr_typeGalgas_double * operand_59133 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59133) ;
              if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_59114 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59114) ;
                cPtr_typeGalgas_lbool * operand_59133 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59133) ;
                if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_59114 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59114) ;
                  cPtr_typeGalgas_lchar * operand_59133 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59133) ;
                  if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_59114 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59114) ;
                    cPtr_typeGalgas_luint * operand_59133 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59133) ;
                    if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_59114 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59114) ;
                      cPtr_typeGalgas_lsint * operand_59133 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59133) ;
                      if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_59114 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59114) ;
                        cPtr_typeGalgas_ldouble * operand_59133 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59133) ;
                        if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_59114 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59114) ;
                          cPtr_typeGalgas_lstring * operand_59133 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59133) ;
                          if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_59114 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59114) ;
                            cPtr_typeGalgas_location * operand_59133 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59133) ;
                            if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_59114 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59114) ;
                              cPtr_typeGalgasUndefinedListType * operand_59133 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59133) ;
                              if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                                if (((operand_59114->mListTypeName.reader_value ()) != (operand_59133->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59114->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59133->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_59114 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59114) ;
                                cPtr_typeGalgasUndefinedMapType * operand_59133 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59133) ;
                                if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                                  if (((operand_59114->mMapTypeName.reader_value ()) != (operand_59133->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59114->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59133->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_59114 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59114) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_59133 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59133) ;
                                  if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                                    if (((operand_59114->mClassTypeName.reader_value ()) != (operand_59133->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59114->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59133->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_59114 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59114) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_59133 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59133) ;
                                    if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                                      if (((operand_59114->mGalgasClassName.reader_value ()) != (operand_59133->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59114->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59133->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_59114 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59114) ;
                                      cPtr_typeGalgas_enum * operand_59133 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59133) ;
                                      if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                                        if (((operand_59114->mEnumTypeName.reader_value ()) != (operand_59133->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59114->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59133->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    while ((operand_62881 != NULL) && (operand_62969 != NULL)) {
      ...
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62881->mType,  operand_62969->mType,  var_cas_ouSignalerErreur) ;
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_72337 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72337) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_72337->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_72948 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72948) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_72948->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73286 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73286) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73286->mMessagesMap ;
