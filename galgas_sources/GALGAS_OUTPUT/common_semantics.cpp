...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34522 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34602 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34522 != NULL) && (operand_34602 != NULL)) {
      macroValidPointer (operand_34522) ;
      macroValidPointer (operand_34602) ;
      if (((operand_34522->mFormalArgumentPassingMode) != (operand_34602->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34602->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34522->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34522->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34522->mGalgasTypeName.reader_value ()) != (operand_34602->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34602->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34522->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34602->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34522 = operand_34522->nextObject () ;
      operand_34602 = operand_34602->nextObject () ;
    }
  }
}
...
sint32 GGS_transitionStatusMap::element_type::compareKeys (void * inKey) const {
  MF_Assert (reinterpret_cast <GGS_lstring *> (inKey) != NULL, "Dynamic cast error", 0, 0) ;
  GGS_lstring * key = (GGS_lstring *) inKey ;
  return mKey.compare_key_for_map (* key) ;
}
...
GGS_bool GGS_transitionStatusMap::reader_hasKey (const GGS_lstring & inKey) const {
  return GGS_bool (isBuilt (), internal_has_key ((void *) & inKey)) ;
}
...
void insertKey_transitionStatusMap (C_Lexique & lexique_var_,
                                GGS_transitionStatusMap & ioMap,
                                const GGS_lstring & inKey,
                                const GGS_lastStateEnum& inParameter0,
                                const GGS_L_stringList & inParameter1,
                                GGS_luint * outIndex) {
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  var_cas_outForeachList.addAssign_operation (mKeyType, GGS_lstring::constructor_new (GGS_string (true, "\?\?\?"), GGS_location (lexique_var_))) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_53637 = mNonExternAttributesList.firstObject () ;
  while ((operand_53637 != NULL)) {
    macroValidPointer (operand_53637) ;
    var_cas_outForeachList.addAssign_operation (operand_53637->mAttributType, operand_53637->aNomAttribut) ;
    operand_53637 = operand_53637->nextObject () ;
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60247 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_60266 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_60247 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60247) ;
    cPtr_typeGalgas_uint * operand_60266 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60266) ;
    if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_60247 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60247) ;
      cPtr_typeGalgas_sint * operand_60266 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60266) ;
      if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_60247 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60247) ;
        cPtr_typeGalgas_char * operand_60266 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60266) ;
        if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_60247 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60247) ;
          cPtr_typeGalgas_string * operand_60266 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60266) ;
          if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_60247 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60247) ;
            cPtr_typeGalgas_bool * operand_60266 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60266) ;
            if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_60247 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60247) ;
              cPtr_typeGalgas_double * operand_60266 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60266) ;
              if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_60247 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60247) ;
                cPtr_typeGalgas_lbool * operand_60266 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60266) ;
                if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_60247 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60247) ;
                  cPtr_typeGalgas_lchar * operand_60266 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60266) ;
                  if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_60247 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60247) ;
                    cPtr_typeGalgas_luint * operand_60266 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60266) ;
                    if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_60247 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60247) ;
                      cPtr_typeGalgas_lsint * operand_60266 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60266) ;
                      if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_60247 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60247) ;
                        cPtr_typeGalgas_ldouble * operand_60266 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60266) ;
                        if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_60247 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60247) ;
                          cPtr_typeGalgas_lstring * operand_60266 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60266) ;
                          if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_60247 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60247) ;
                            cPtr_typeGalgas_location * operand_60266 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60266) ;
                            if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_60247 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60247) ;
                              cPtr_typeGalgasUndefinedListType * operand_60266 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60266) ;
                              if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                                if (((operand_60247->mListTypeName.reader_value ()) != (operand_60266->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60247->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60266->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_60247 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60247) ;
                                cPtr_typeGalgasUndefinedMapType * operand_60266 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60266) ;
                                if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                                  if (((operand_60247->mMapTypeName.reader_value ()) != (operand_60266->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60247->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60266->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_60247 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60247) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_60266 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60266) ;
                                  if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                                    if (((operand_60247->mClassTypeName.reader_value ()) != (operand_60266->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60247->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60266->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_60247 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60247) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_60266 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60266) ;
                                    if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                                      if (((operand_60247->mGalgasClassName.reader_value ()) != (operand_60266->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60247->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60266->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_60247 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60247) ;
                                      cPtr_typeGalgas_enum * operand_60266 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60266) ;
                                      if ((operand_60247 != NULL) && (operand_60266 != NULL)) {
                                        if (((operand_60247->mEnumTypeName.reader_value ()) != (operand_60266->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60247->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60266->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_64014 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64102 = var_cas_signatureTestee.firstObject () ;
    while ((operand_64014 != NULL) && (operand_64102 != NULL)) {
      macroValidPointer (operand_64014) ;
      macroValidPointer (operand_64102) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_64014->mType,  operand_64102->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_64014->mFormalArgumentPassingMode) != (operand_64102->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64102->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64102->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_64014 = operand_64014->nextObject () ;
      operand_64102 = operand_64102->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_73669 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73669) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_73669->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_74280 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74280) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74280->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74618 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74618) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74618->mMessagesMap ;
