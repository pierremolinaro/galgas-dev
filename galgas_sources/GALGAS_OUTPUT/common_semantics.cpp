...
void routine_checkSignature_ForGrammarComponent (C_lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_33758 = var_cas_inFormalReferenceSignature.getFirstItem () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_33838 = var_cas_inFormalTestedSignature.getFirstItem () ;
    while ((operand_33758 != NULL) && (operand_33838 != NULL)) {
      macroValidPointer (operand_33758) ;
      macroValidPointer (operand_33838) ;
      if (((operand_33758->mFormalArgumentPassingMode) != (operand_33838->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_33838->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_33758->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_33758->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_33758->mGalgasTypeName.reader_value ()) != (operand_33838->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_33838->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_33758->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_33838->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_33758 = operand_33758->getNextItem () ;
      operand_33838 = operand_33838->getNextItem () ;
    }
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_57953 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_57972 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_57953 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_57953) ;
    cPtr_typeGalgas_uint * operand_57972 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_57972) ;
    if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_57953 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_57953) ;
      cPtr_typeGalgas_sint * operand_57972 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_57972) ;
      if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_57953 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_57953) ;
        cPtr_typeGalgas_char * operand_57972 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_57972) ;
        if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_57953 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_57953) ;
          cPtr_typeGalgas_string * operand_57972 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_57972) ;
          if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_57953 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_57953) ;
            cPtr_typeGalgas_bool * operand_57972 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_57972) ;
            if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
            }else{
              cPtr_typeGalgas_dfloat * operand_57953 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_57953) ;
              cPtr_typeGalgas_dfloat * operand_57972 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_57972) ;
              if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_57953 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_57953) ;
                cPtr_typeGalgas_lbool * operand_57972 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_57972) ;
                if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_57953 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_57953) ;
                  cPtr_typeGalgas_lchar * operand_57972 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_57972) ;
                  if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_57953 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_57953) ;
                    cPtr_typeGalgas_luint * operand_57972 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_57972) ;
                    if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_57953 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_57953) ;
                      cPtr_typeGalgas_lsint * operand_57972 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_57972) ;
                      if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldfloat * operand_57953 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_57953) ;
                        cPtr_typeGalgas_ldfloat * operand_57972 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_57972) ;
                        if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_57953 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_57953) ;
                          cPtr_typeGalgas_lstring * operand_57972 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_57972) ;
                          if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_57953 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_57953) ;
                            cPtr_typeGalgas_location * operand_57972 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_57972) ;
                            if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_57953 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_57953) ;
                              cPtr_typeGalgasUndefinedListType * operand_57972 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_57972) ;
                              if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                                if (((operand_57953->mListTypeName.reader_value ()) != (operand_57972->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_57953->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_57972->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_57953 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_57953) ;
                                cPtr_typeGalgasUndefinedMapType * operand_57972 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_57972) ;
                                if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                                  if (((operand_57953->mMapTypeName.reader_value ()) != (operand_57972->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_57953->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_57972->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_57953 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_57953) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_57972 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_57972) ;
                                  if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                                    if (((operand_57953->mClassTypeName.reader_value ()) != (operand_57972->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_57953->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_57972->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_57953 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_57953) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_57972 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_57972) ;
                                    if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                                      if (((operand_57953->mGalgasClassName.reader_value ()) != (operand_57972->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_57953->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_57972->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_57953 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_57953) ;
                                      cPtr_typeGalgas_enum * operand_57972 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_57972) ;
                                      if ((operand_57953 != NULL) && (operand_57972 != NULL)) {
                                        if (((operand_57953->mEnumTypeName.reader_value ()) != (operand_57972->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_57953->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_57972->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_61720 = var_cas_signatureReference.getFirstItem () ;
    GGS_L_signature::element_type * operand_61808 = var_cas_signatureTestee.getFirstItem () ;
    while ((operand_61720 != NULL) && (operand_61808 != NULL)) {
      macroValidPointer (operand_61720) ;
      macroValidPointer (operand_61808) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_61720->mType,  operand_61808->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_61720->mFormalArgumentPassingMode) != (operand_61808->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_61808->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_61808->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_61720 = operand_61720->getNextItem () ;
      operand_61808 = operand_61808->getNextItem () ;
    }
  }
}
...
void routine_handleReaderCall (C_lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_71176 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_71176) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_71176->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_71788 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_71788) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_71788->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_72126 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72126) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_72126->mMessagesMap ;
