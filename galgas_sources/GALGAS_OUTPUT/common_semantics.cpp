...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_36657 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_36756 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_36657 != NULL)
        && (operand_36756 != NULL)) {
      macroValidPointer (operand_36657) ;
      macroValidPointer (operand_36756) ;
      if (((operand_36657->mFormalArgumentPassingMode) != (operand_36756->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_36756->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_36657->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_36657->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_36657->mGalgasTypeName.reader_value ()) != (operand_36756->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_36756->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_36657->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_36756->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_36657 = operand_36657->nextObject () ;
      operand_36756 = operand_36756->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53876 = mNonExternAttributesList.firstObject () ;
  while ((operand_53876 != NULL)) {
    macroValidPointer (operand_53876) ;
    var_cas_outForeachList.addAssign_operation (operand_53876->mAttributType, operand_53876->aNomAttribut) ;
    operand_53876 = operand_53876->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60414 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_60433 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_60414 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60414) ;
    cPtr_typeGalgas_stringset * operand_60433 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60433) ;
    if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_60414 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60414) ;
      cPtr_typeGalgas_uint * operand_60433 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60433) ;
      if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_60414 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60414) ;
        cPtr_typeGalgas_sint * operand_60433 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60433) ;
        if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_60414 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60414) ;
          cPtr_typeGalgas_char * operand_60433 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60433) ;
          if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_60414 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60414) ;
            cPtr_typeGalgas_string * operand_60433 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60433) ;
            if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_60414 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60414) ;
              cPtr_typeGalgas_bool * operand_60433 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60433) ;
              if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_60414 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60414) ;
                cPtr_typeGalgas_double * operand_60433 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60433) ;
                if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_60414 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60414) ;
                  cPtr_typeGalgas_lbool * operand_60433 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60433) ;
                  if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_60414 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60414) ;
                    cPtr_typeGalgas_lchar * operand_60433 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60433) ;
                    if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_60414 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60414) ;
                      cPtr_typeGalgas_luint * operand_60433 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60433) ;
                      if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_60414 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60414) ;
                        cPtr_typeGalgas_lsint * operand_60433 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60433) ;
                        if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_60414 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60414) ;
                          cPtr_typeGalgas_ldouble * operand_60433 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60433) ;
                          if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_60414 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60414) ;
                            cPtr_typeGalgas_lstring * operand_60433 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60433) ;
                            if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_60414 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60414) ;
                              cPtr_typeGalgas_location * operand_60433 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60433) ;
                              if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_60414 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60414) ;
                                cPtr_typeGalgasUndefinedListType * operand_60433 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60433) ;
                                if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                                  if (((operand_60414->mListTypeName.reader_value ()) != (operand_60433->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60414->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60433->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_60414 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60414) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_60433 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60433) ;
                                  if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                                    if (((operand_60414->mMapTypeName.reader_value ()) != (operand_60433->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60414->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60433->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_60414 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60414) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_60433 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60433) ;
                                    if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                                      if (((operand_60414->mClassTypeName.reader_value ()) != (operand_60433->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60414->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60433->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_60414 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60414) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_60433 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60433) ;
                                      if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                                        if (((operand_60414->mGalgasClassName.reader_value ()) != (operand_60433->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60414->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60433->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_60414 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60414) ;
                                        cPtr_typeGalgas_enum * operand_60433 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60433) ;
                                        if ((operand_60414 != NULL) && (operand_60433 != NULL)) {
                                          if (((operand_60414->mEnumTypeName.reader_value ()) != (operand_60433->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60414->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60433->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_64215 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64314 = var_cas_signatureTestee.firstObject () ;
    while ((operand_64215 != NULL)
        && (operand_64314 != NULL)) {
      macroValidPointer (operand_64215) ;
      macroValidPointer (operand_64314) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_64215->mType,  operand_64314->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_64215->mFormalArgumentPassingMode) != (operand_64314->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64314->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64314->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_64215 = operand_64215->nextObject () ;
      operand_64314 = operand_64314->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_75806 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_75806) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_75806->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_76139 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_76139) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_76139->mMessagesMap ;
      GGS_L_lstringList  var_cas_76304 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_76304) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
