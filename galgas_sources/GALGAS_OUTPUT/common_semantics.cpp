...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mString ;
  }else{
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mString ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_L_signature::
_internalAppendItem (const GGS_formalArgumentPassingMode& argument_0,
                    const GGS_lstring & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mFormalArgumentPassingMode,
                                p->mGalgasTypeName) ;
        p = p->mNextItem ;
      }
    }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mFormalArgumentPassingMode ;
    _out_1 = _mRoot->mFirstItem->mGalgasTypeName ;
  }else{
    _out_0._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mFormalArgumentPassingMode ;
    _out_1 = _mRoot->mLastItem->mGalgasTypeName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mTypeName) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mTypeName ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mTypeName ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAttributeList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mEnumConstantesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mExternTypeConstructorMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mReaderMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mModifierMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAddAssignFormalInputArgumentList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mIsAbstract.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSuperClasses.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAttributeList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mMessageMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_acceptAssignmentFromHere (C_Lexique & _inLexique,
  ...
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "assignment from 'here' is not allowed for variables of this type") SOURCE_FILE_AT_LINE (414)) ;
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be enumerated by in 'foreach' instruction") SOURCE_FILE_AT_LINE (424)) ;
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (434)) ;
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_inReaderName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader instruction") SOURCE_FILE_AT_LINE (445)) ;
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (453)) ;
...
method_handleMinusAssignOperatorCall (C_Lexique & _inLexique,
  ...
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '-=' operator") SOURCE_FILE_AT_LINE (463)) ;
...
method_handleAddAssignOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation,
                                GGS_typeListeAttributsSemantiques & var_cas_outParametersList COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (474)) ;
  var_cas_outParametersList._drop_operation () ;
}
...
method_handleIncrementOperatorCall (C_Lexique & _inLexique,
  ...
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (482)) ;
}
...
method_handleDecrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '--' operator") SOURCE_FILE_AT_LINE (490)) ;
}
...
method_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & _inLexique COMMA_UNUSED_LOCATION_ARGS) {
  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (496)) ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mPathElement) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mPathElement ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mPathElement ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
void GGS_L_ListOfPropertyPathes::
_internalAppendItem (const GGS_L_propertyPath & argument_0,
                    const GGS_location & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mPath ;
    _out_1 = _mRoot->mFirstItem->mEndOfPathLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mPath ;
    _out_1 = _mRoot->mLastItem->mEndOfPathLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mKind.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mRelationVariableMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mVariable.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mVariableIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mVariableMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mDomainName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mParameter,
                                p->mParameterIndex,
                                p->mDomainVariable) ;
        p = p->mNextItem ;
      }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mParameter ;
    _out_1 = _mRoot->mFirstItem->mParameterIndex ;
    _out_2 = _mRoot->mFirstItem->mDomainVariable ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mParameter ;
    _out_1 = _mRoot->mLastItem->mParameterIndex ;
    _out_2 = _mRoot->mLastItem->mDomainVariable ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mPath.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mOperationIsAnd.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Element of list '@constrainedPropertyList'                 *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_constrainedPropertyList::
elementOf_GGS_constrainedPropertyList (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1):
mNextItem (NULL),
mPropertyTypeName (argument_0),
mPropertyName (argument_1) {
}

//---------------------------------------------------------------------------*

void elementOf_GGS_constrainedPropertyList::
appendForListDescription (C_Lexique & _inLexique,
                          C_String & ioString,
                          const sint32 inIndentation
                          COMMA_LOCATION_ARGS) const {
  ioString << "[" ;
  ioString << mPropertyTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << mPropertyName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     List '@constrainedPropertyList'                       *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_constrainedPropertyList::cRootList::cRootList (void):
mFirstItem (NULL),
mLastItem (NULL),
mListLength (0),
mCountReference (1) {
...
GGS_constrainedPropertyList::GGS_constrainedPropertyList (void) { // Default Constructor
  _mRoot = NULL ;
}

//---------------------------------------------------------------------------*

GGS_constrainedPropertyList::~GGS_constrainedPropertyList (void) {
  _drop_operation () ;
}

//---------------------------------------------------------------------------*

GGS_constrainedPropertyList::
GGS_constrainedPropertyList (const GGS_constrainedPropertyList & inSource) {
  _mRoot = inSource._mRoot ;
  if (_mRoot != NULL) {
    macroValidPointer (_mRoot) ;
    _mRoot->mCountReference ++ ;
...
void GGS_constrainedPropertyList::
operator = (const GGS_constrainedPropertyList & inSource) {
  if (this != & inSource) {
    _drop_operation () ;
    _mRoot = inSource._mRoot ;
    if (_mRoot != NULL) {
...
GGS_constrainedPropertyList::element_type * GGS_constrainedPropertyList::
firstObject (void) const {
  return (_mRoot == NULL) ? NULL : _mRoot->mFirstItem ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mPropertyTypeName,
                                p->mPropertyName) ;
        p = p->mNextItem ;
      }
    }
...
GGS_constrainedPropertyList  GGS_constrainedPropertyList::
constructor_emptyList (C_Lexique & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constrainedPropertyList result ;
  macroMyNew (result._mRoot, cRootList) ;
  return result ;
}
...
sint32 GGS_constrainedPropertyList::
count (void) const {
  return (_mRoot == NULL) ? 0 : _mRoot->mListLength ;
}
...
GGS_string GGS_constrainedPropertyList::
reader_description (C_Lexique & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  C_String s ;
  s << "<list @constrainedPropertyList" ;
  if (_isBuilt ()) {
    s << " " << _mRoot->mListLength << " object" << ((_mRoot->mListLength > 1) ? "s " : " ") ;
    element_type * p = _mRoot->mFirstItem ;
    sint32 elementIndex = 0 ;
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mPropertyTypeName ;
    _out_1 = _mRoot->mFirstItem->mPropertyName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mPropertyTypeName ;
    _out_1 = _mRoot->mLastItem->mPropertyName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
GGS_uint GGS_constrainedPropertyList::
reader_length (C_Lexique & /* inLexique */
               COMMA_UNUSED_LOCATION_ARGS) const {
  return GGS_uint (_mRoot != NULL,
                   (_mRoot == NULL) ? 0 : (uint32) _mRoot->mListLength) ;
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mEntityPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mSuperEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mSuperClassSet.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mIsImplicitlyDefined.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mConstrainedAttributePropertyToImplementList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.mConstrainedParameterPropertyToImplementList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_bool&  inParameter5,
               const GGS_constrainedPropertyList &  inParameter6,
               const GGS_constrainedPropertyList &  inParameter7,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  sint32 index = - 1 ;
  if (_isBuilt ()
   ...
   && inKey._isBuilt ()) {
    ...
    info.mSuperClassSet = inParameter4 ;
    info.mIsImplicitlyDefined = inParameter5 ;
    info.mConstrainedAttributePropertyToImplementList = inParameter6 ;
    info.mConstrainedParameterPropertyToImplementList = inParameter7 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mSharedMapRoot->_mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_bool  & outParameter5,
               GGS_constrainedPropertyList   & outParameter6,
               GGS_constrainedPropertyList   & outParameter7,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  element_type * node = NULL  ;
  if (_isBuilt () && inKey._isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter4 = node->mInfo.mSuperClassSet ;
    outParameter5 = node->mInfo.mIsImplicitlyDefined ;
    outParameter6 = node->mInfo.mConstrainedAttributePropertyToImplementList ;
    outParameter7 = node->mInfo.mConstrainedParameterPropertyToImplementList ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_entityToImplementMap::method_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_bool  & outParameter5,
                                GGS_constrainedPropertyList   & outParameter6,
                                GGS_constrainedPropertyList   & outParameter7 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
...
method_insertKey (C_Lexique & _inLexique,
                                ...
                                const GGS_bool& inParameter5,
                                const GGS_constrainedPropertyList & inParameter6,
                                const GGS_constrainedPropertyList & inParameter7 COMMA_LOCATION_ARGS) {
  insertElement (_inLexique,
...
method_getTypeName (C_Lexique & _inLexique,
  ...
  var_cas_outTypeName = mEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (715)) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAllPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mIsAbstract.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mEntityPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSuperEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSuperEntitiesSet.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
constructor_new (C_Lexique & /* inLexique */,
  ...
  macroMyNew (_ptr, cPtr_typeGalgas_singleEntity (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
                                argument_4,
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = ((GGS_string (true, "_listOf_")) + (mEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (728)))) ;
}
...
void GGS_typeListeAttributsSemantiques::
_internalAppendItem (const GGS_AC_galgasType & argument_0,
                    const GGS_lstring & argument_1) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
                                argument_1)) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mAttributType,
                                p->aNomAttribut) ;
        p = p->mNextItem ;
      }
    }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mAttributType ;
    _out_1 = _mRoot->mFirstItem->aNomAttribut ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mAttributType ;
    _out_1 = _mRoot->mLastItem->aNomAttribut ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mType ;
    _out_1 = _mRoot->mFirstItem->mEndOfExpressionLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mType ;
    _out_1 = _mRoot->mLastItem->mEndOfExpressionLocation ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mType ;
    _out_1 = _mRoot->mFirstItem->mFormalArgumentPassingMode ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mType ;
    _out_1 = _mRoot->mLastItem->mFormalArgumentPassingMode ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
  }
...
void GGS_L_stringList::
_internalAppendItem (const GGS_string& argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mErrorMessageElement) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mErrorMessageElement ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mErrorMessageElement ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (869))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (871))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (875)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (907))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (909))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (913)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (945))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (981))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (985)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1062))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1068)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1078))) == (GGS_string (true, "setString"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1081))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1087)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1110))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1118)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1128))) == (GGS_string (true, "setChar"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1131))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1137)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1160))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1168)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1178))) == (GGS_string (true, "setBool"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1181))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1187)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1209))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1217)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1227))) == (GGS_string (true, "setUint"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1230))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1236)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1258))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1266)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1276))) == (GGS_string (true, "setUint64"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1279))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1285)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1307))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1315)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1325))) == (GGS_string (true, "setSint"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1328))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1334)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1356))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1364)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1374))) == (GGS_string (true, "setSint64"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1377))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1383)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1405))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1413)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1423))) == (GGS_string (true, "setDouble"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1426))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1432)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1458))) == (GGS_string (true, "emptySet"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1460))) == (GGS_string (true, "setWithString"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outAccessorTypesList._addAssign_operation (var_cas_t, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1464))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptySet' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (1466)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1468)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1537)) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mGalgasClassName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mConstructorMap._isBuilt ()) {
    mConstructorMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1581)) ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifiersMap._isBuilt ()) {
    mModifiersMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1590)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReadersInInstructionMap._isBuilt ()) {
    mReadersInInstructionMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1599)) ;
  }
}
...
method_handleAddAssignOperatorCall (C_Lexique & _inLexique,
  ...
  if (((! (mAcceptAddAssignOperatorCall))).isBuiltAndTrue ()) {
    inherited::method_handleAddAssignOperatorCall (_inLexique, var_cas_inErrorLocation, var_cas_outParametersList SOURCE_FILE_AT_LINE (1608)) ;
  }else{
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mConstructorMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mModifiersMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mReadersInInstructionMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAcceptAddAssignOperatorCall.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAddAssignOperatorCallTypeList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
void GGS_M_terminalSymbolsMapForUse::method_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_typeListeAttributsSemantiques   & outParameter0 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mGrammarAltMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1726))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1726)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1727))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1728)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1728))) > (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1728)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1729))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1730)) ;
  }else{
    GGS_L_signature::element_type * operand_68411 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_68510 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_68411 != NULL)
        && (operand_68510 != NULL)) {
      macroValidPointer (operand_68411) ;
      macroValidPointer (operand_68510) ;
      if (((operand_68411->mFormalArgumentPassingMode) != (operand_68510->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        operand_68510->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_68411->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1734))))) + (GGS_string (true, ", and ")))) + (operand_68411->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1735))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1736)) ;
      }
      if (((operand_68411->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1737))) != (operand_68510->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1737)))).isBuiltAndTrue ()) {
        operand_68510->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_68411->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1738))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_68510->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1738))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1739)) ;
      }
      operand_68411 = operand_68411->nextObject () ;
      operand_68510 = operand_68510->nextObject () ;
    }
  }
}
...
void GGS_L_ruleSyntaxSignature::
_internalAppendItem (const GGS_AC_instruction_ForGrammar & argument_0) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0)) ;
  if (nouvelElement != NULL) {
    macroValidPointer (nouvelElement) ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mInstruction) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mInstruction ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mInstruction ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mLeftNonterminalSymbol,
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mLeftNonterminalSymbol ;
    _out_1 = _mRoot->mFirstItem->mLeftNonterminalSymbolIndex ;
    _out_2 = _mRoot->mFirstItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mLeftNonterminalSymbol ;
    _out_1 = _mRoot->mLastItem->mLeftNonterminalSymbolIndex ;
    _out_2 = _mRoot->mLastItem->mInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mStartLocation.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mTerminalSymbolName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mTerminalSymbolIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mNonterminalSymbolName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mNonterminalSymbolIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSelectList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAddedNonterminalmSymbolIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mRepeatList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mAddedNonterminalmSymbolIndex.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
void GGS_L_syntaxComponents_ForGrammar::
_internalAppendItem (const GGS_M_nonTerminalSymbolsForGrammar & argument_0,
                    const GGS_L_productionRules_ForGrammarComponent & argument_1,
                    const GGS_lstring & argument_2) {
  element_type * nouvelElement = (element_type *) NULL ;
  macroMyNew (nouvelElement, element_type (argument_0,
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mNonterminalSymbolsMap,
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mNonterminalSymbolsMap ;
    _out_1 = _mRoot->mFirstItem->mProductionRulesList ;
    _out_2 = _mRoot->mFirstItem->mSyntaxComponentName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mNonterminalSymbolsMap ;
    _out_1 = _mRoot->mLastItem->mProductionRulesList ;
    _out_2 = _mRoot->mLastItem->mSyntaxComponentName ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->aIdentificateur) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->aIdentificateur ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->aIdentificateur ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mMethodName,
                                p->mErrorMessage,
                                p->mIsGetIndexMethod,
                                p->mShadowErrorMessage) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mMethodName ;
    _out_1 = _mRoot->mFirstItem->mErrorMessage ;
    _out_2 = _mRoot->mFirstItem->mIsGetIndexMethod ;
    _out_3 = _mRoot->mFirstItem->mShadowErrorMessage ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mMethodName ;
    _out_1 = _mRoot->mLastItem->mErrorMessage ;
    _out_2 = _mRoot->mLastItem->mIsGetIndexMethod ;
    _out_3 = _mRoot->mLastItem->mShadowErrorMessage ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1984)) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mListTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2020))) != (GGS_string (true, "first"))) & ((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2020))) != (GGS_string (true, "last"))))).isBuiltAndTrue ()) {
    var_cas_inReaderName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "a list accepts only 'first' and 'last' readers") SOURCE_FILE_AT_LINE (2022)) ;
  }
  var_cas_outReaderSignature = mSignature ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2039))) == (GGS_string (true, "emptyList"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2041))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyList' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2043)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2045)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2075)) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mMapTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifierMethodMap._isBuilt ()) {
    mModifierMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (2111)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMethodMap._isBuilt ()) {
    mReaderMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (2121)) ;
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_86745 = mNonExternAttributesList.firstObject () ;
  while ((operand_86745 != NULL)) {
    macroValidPointer (operand_86745) ;
    var_cas_outForeachList._addAssign_operation (operand_86745->mAttributType, operand_86745->aNomAttribut) ;
    operand_86745 = operand_86745->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2146))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2148))) == (GGS_string (true, "mapWithMapToOverride"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2151))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2153)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2155)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mModifierMethodMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mReaderMethodMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2172)) ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mClassTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
cPtr_typeGalgasNewClassType::cPtr_typeGalgasNewClassType (const GGS_lstring & argument_0,
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mSuperClassMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2213)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2223)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2223))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2227)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mNonExternAttributesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mClassIsAbstract.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << aDefType.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << aListeArgumentsFormels.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2306))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2312))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2318)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2323)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2333))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2339))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2345)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2351)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << mElementTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ; ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2384)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2392)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_97574 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_97593 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_97574 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_97574) ;
    cPtr_typeGalgas_stringset * operand_97593 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_97593) ;
    if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_97574 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_97574) ;
      cPtr_typeGalgas_uint * operand_97593 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_97593) ;
      if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_97574 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_97574) ;
        cPtr_typeGalgas_sint * operand_97593 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_97593) ;
        if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_97574 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_97574) ;
          cPtr_typeGalgas_uint64 * operand_97593 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_97593) ;
          if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_97574 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_97574) ;
            cPtr_typeGalgas_sint64 * operand_97593 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_97593) ;
            if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_97574 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_97574) ;
              cPtr_typeGalgas_char * operand_97593 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_97593) ;
              if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_97574 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_97574) ;
                cPtr_typeGalgas_string * operand_97593 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_97593) ;
                if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_97574 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_97574) ;
                  cPtr_typeGalgas_bool * operand_97593 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_97593) ;
                  if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_97574 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_97574) ;
                    cPtr_typeGalgas_double * operand_97593 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_97593) ;
                    if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_97574 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_97574) ;
                      cPtr_typeGalgas_lbool * operand_97593 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_97593) ;
                      if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_97574 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_97574) ;
                        cPtr_typeGalgas_lchar * operand_97593 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_97593) ;
                        if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_97574 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_97574) ;
                          cPtr_typeGalgas_luint * operand_97593 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_97593) ;
                          if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_97574 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_97574) ;
                            cPtr_typeGalgas_lsint * operand_97593 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_97593) ;
                            if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_97574 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_97574) ;
                              cPtr_typeGalgas_luint64 * operand_97593 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_97593) ;
                              if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_97574 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_97574) ;
                                cPtr_typeGalgas_lsint64 * operand_97593 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_97593) ;
                                if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_97574 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_97574) ;
                                  cPtr_typeGalgas_ldouble * operand_97593 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_97593) ;
                                  if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_97574 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_97574) ;
                                    cPtr_typeGalgas_lstring * operand_97593 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_97593) ;
                                    if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_97574 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_97574) ;
                                      cPtr_typeGalgas_location * operand_97593 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_97593) ;
                                      if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_97574 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_97574) ;
                                        cPtr_typeGalgasUndefinedListType * operand_97593 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_97593) ;
                                        if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                          if (((operand_97574->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2432))) != (operand_97593->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2432)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_97574->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2433))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_97593->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2434))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2435)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_97574 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_97574) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_97593 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_97593) ;
                                          if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                            if (((operand_97574->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2438))) != (operand_97593->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2438)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_97574->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2439))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_97593->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2440))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2441)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_97574 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97574) ;
                                            cPtr_typeGalgasClassType * operand_97593 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_97593) ;
                                            if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_97574->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2445))) == (operand_97593->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2445))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_97593->mAncestorClassesMap.reader_hasKey (_inLexique, operand_97574->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2447)) SOURCE_FILE_AT_LINE (2447)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_97574->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2450))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_97593->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2451))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2452)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_97574 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97574) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_97593 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97593) ;
                                              if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                                if (((operand_97574->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2455))) != (operand_97593->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2455)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_97574->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2456))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_97593->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2457))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2458)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_97574 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_97574) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_97593 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_97593) ;
                                                if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                                  if (((operand_97574->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2462))) != (operand_97593->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2462)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_97574->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2463))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_97593->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2464))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2465)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_97574 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_97574) ;
                                                  cPtr_typeGalgas_enum * operand_97593 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_97593) ;
                                                  if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                                    if (((operand_97574->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2469))) != (operand_97593->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2469)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_97574->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2470))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_97593->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2471))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2472)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_97574 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_97574) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_97593 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_97593) ;
                                                    if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                                      if (((operand_97574->mEntityName) != (operand_97593->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_97574->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_97593->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2479)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_97574 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_97574) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_97593 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_97593) ;
                                                      if ((operand_97574 != NULL) && (operand_97593 != NULL)) {
                                                        if (((operand_97574->mMapTypeName) != (operand_97593->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_97574->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_97593->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2486)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2489))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2489)))) SOURCE_FILE_AT_LINE (2490)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2504))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2504)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2506)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2506))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2506)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2508)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_102993 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_103092 = var_cas_signatureTestee.firstObject () ;
    while ((operand_102993 != NULL)
        && (operand_103092 != NULL)) {
      macroValidPointer (operand_102993) ;
      macroValidPointer (operand_103092) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_102993->mType,  operand_103092->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2512)) ;
      if (((operand_102993->mFormalArgumentPassingMode) != (operand_103092->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_103092->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2518))) + (GGS_string (true, " is not compatible with ")))) + (operand_103092->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2519)))) SOURCE_FILE_AT_LINE (2520)) ;
      }
      operand_102993 = operand_102993->nextObject () ;
      operand_103092 = operand_103092->nextObject () ;
    }
  }
}
...
appendForListDescription (C_Lexique & _inLexique,
                          ...
                          COMMA_LOCATION_ARGS) const {
  ioString << "[" ;
  ioString << aAttributAxiome.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "]" ;
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->aAttributAxiome) ;
        p = p->mNextItem ;
      }
    }
  }
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->aAttributAxiome ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->aAttributAxiome ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
_insulateList (void) {
  if (_mRoot != NULL) {
    ...
    if (_mRoot->mCountReference > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        _internalAppendItem (p->mGrammarPostfix,
                                p->mGrammarName,
...
method_first (C_Lexique & _inLexique,
              ...
              GGS_typeListeAttributsAxiome & _out_3,
              GGS_lstring & _out_4,
              GGS_lstring & _out_5,
              GGS_lstring & _out_6,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mGrammarPostfix ;
    _out_1 = _mRoot->mFirstItem->mGrammarName ;
    _out_2 = _mRoot->mFirstItem->mStartSymbolSignature ;
    _out_3 = _mRoot->mFirstItem->mStartSymbolAttributesList ;
    _out_4 = _mRoot->mFirstItem->mLexiqueClassName ;
    _out_5 = _mRoot->mFirstItem->mReturnedMetamodelName ;
    _out_6 = _mRoot->mFirstItem->mReturnedRootEntityName ;
    _out_7 = _mRoot->mFirstItem->mConstraintsForMetamodel ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mGrammarPostfix ;
    _out_1 = _mRoot->mLastItem->mGrammarName ;
    _out_2 = _mRoot->mLastItem->mStartSymbolSignature ;
    _out_3 = _mRoot->mLastItem->mStartSymbolAttributesList ;
    _out_4 = _mRoot->mLastItem->mLexiqueClassName ;
    _out_5 = _mRoot->mLastItem->mReturnedMetamodelName ;
    _out_6 = _mRoot->mLastItem->mReturnedRootEntityName ;
    _out_7 = _mRoot->mLastItem->mConstraintsForMetamodel ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
GGS_L_nibAndClassList::cRootList::cRootList (void):
mFirstItem (NULL),
mLastItem (NULL),
mListLength (0),
mCountReference (1) {
...
GGS_L_nibAndClassList::GGS_L_nibAndClassList (void) { // Default Constructor
  _mRoot = NULL ;
}

//---------------------------------------------------------------------------*

GGS_L_nibAndClassList::~GGS_L_nibAndClassList (void) {
  _drop_operation () ;
}
...
GGS_L_nibAndClassList (const GGS_L_nibAndClassList & inSource) {
  _mRoot = inSource._mRoot ;
  if (_mRoot != NULL) {
    macroValidPointer (_mRoot) ;
    _mRoot->mCountReference ++ ;
...
operator = (const GGS_L_nibAndClassList & inSource) {
  if (this != & inSource) {
    _drop_operation () ;
    _mRoot = inSource._mRoot ;
    if (_mRoot != NULL) {
...
GGS_L_nibAndClassList::element_type * GGS_L_nibAndClassList::
firstObject (void) const {
  return (_mRoot == NULL) ? NULL : _mRoot->mFirstItem ;
}
...
method_first (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mFirstItem->mValue ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_last (C_Lexique & _inLexique,
  ...
  if (_ok) {
    _out_0 = _mRoot->mLastItem->mValue ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
GGS_uint GGS_L_nibAndClassList::
reader_length (C_Lexique & /* inLexique */
               COMMA_UNUSED_LOCATION_ARGS) const {
  return GGS_uint (_mRoot != NULL,
                   (_mRoot == NULL) ? 0 : (uint32) _mRoot->mListLength) ;
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2662))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2668))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2671))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2674))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2677))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2680))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2683))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2686))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2689))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2697)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2699))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2705)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2707))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2710))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2713))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2716))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2722)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2724))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2727))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2730))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2733))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2741))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2744))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2747))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2750))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2756)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2758))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2761))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2764))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2767))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2773)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2775))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2778))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lstring type is deprecated; use 'string' instead") SOURCE_FILE_AT_LINE (2779)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2782))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2785))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2791)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2793))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2796))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lchar type  is deprecated; use 'char' instead") SOURCE_FILE_AT_LINE (2797)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2800))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2803))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2809)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2811))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2814))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lbool type  is deprecated; use 'bool' instead") SOURCE_FILE_AT_LINE (2815)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2818))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2824)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2826))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2829))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' of @luint type  reader is deprecated; use 'uint' instead") SOURCE_FILE_AT_LINE (2830)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2833))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2836))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2842)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2844))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2847))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2850))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2856)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2858))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2861))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lsint type  is deprecated; use 'sint' instead") SOURCE_FILE_AT_LINE (2862)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2865))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2868))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2871))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2877)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2879))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2882))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2885))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2888))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2894)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2896))) == (GGS_string (true, "double"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2899))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @ldouble type  is deprecated; use 'double' instead") SOURCE_FILE_AT_LINE (2900)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2903))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2906))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2909))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2915)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2917))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2923)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2925))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2930))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2933))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2939)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2941))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList._addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2946))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2952)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_126447 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_126447) ; 
        if (operand_126447->mMessagesMap._isBuilt ()) {
          operand_126447->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2954)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_126726 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_126726) ; 
        GGS_L_lstringList  var_cas_126838 ;
        if (operand_126726->mMessagesMap._isBuilt ()) {
          operand_126726->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_126838 SOURCE_FILE_AT_LINE (2958)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2965)) ;
        var_cas_outAccessorTypesList._drop_operation () ;
        var_cas_outReturnedType._drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2992)) SOURCE_FILE_AT_LINE (2992))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_128637 ;
    GGS_M_semanticsEntitiesForUse  var_cas_128646 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_128637, var_cas_128646 SOURCE_FILE_AT_LINE (2999)) ;
    }
    ...
    GGS_stringset::element_type * operand_128891 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_128891 != NULL)) {
      macroValidPointer (operand_128891) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_128891->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (3013)) ;
      operand_128891 = operand_128891->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_129256 = var_cas_modelMap.firstObject () ;
    while ((operand_129256 != NULL)) {
      macroValidPointer (operand_129256) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_129256->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3024)) SOURCE_FILE_AT_LINE (3024))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_129256->mKey, operand_129256->mInfo.mType SOURCE_FILE_AT_LINE (3025)) ;
      }
      operand_129256 = operand_129256->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_129470 = var_cas_actionMap.firstObject () ;
    while ((operand_129470 != NULL)) {
      macroValidPointer (operand_129470) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_129470->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3030)) SOURCE_FILE_AT_LINE (3030))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_129470->mKey, operand_129470->mInfo.mSignature, operand_129470->mInfo.mIsExtern SOURCE_FILE_AT_LINE (3031)) ;
      }
      operand_129470 = operand_129470->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents._addAssign_operation (var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3035))) ;
  }
}
...
void routine_computeRepresentativeEntityName (C_Lexique & _inLexique,
  ...
  GGS_uint _variant_130649 = var_cas_inMetamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (3049))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (3049)) ;
  GGS_bool _condition_130649 (_variant_130649._isBuilt (), true) ;
  while (_condition_130649.isBuiltAndTrue ()) {
    if (_variant_130649.uintValue () == 0) {
      _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (3058)) ;
      _condition_130649 = GGS_bool (true, false) ;
    }else{
      _variant_130649._decrement_operation (_inLexique COMMA_HERE) ;
      _condition_130649 = (((var_cas_outRepresentativeEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3050))) == (GGS_string (true, ""))) & ((var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3050))) != (GGS_string (true, ""))))  ;
      if (_condition_130649.isBuiltAndTrue ()) {
        if ((var_cas_inConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3051)) SOURCE_FILE_AT_LINE (3051))).isBuiltAndTrue ()) {
          var_cas_outRepresentativeEntityName = var_cas_searchedEntity ;
        }else{
          GGS_lstring  var_cas_superEntity ;
          GGS_entityPropertyMap  var_cas_130564 ;
          GGS_bool var_cas_130567 ;
          GGS_entityPropertyMap  var_cas_130570 ;
          GGS_stringset  var_cas_130586 ;
          GGS_bool var_cas_130589 ;
          GGS_constrainedPropertyList  var_cas_130592 ;
          GGS_constrainedPropertyList  var_cas_130595 ;
          if (var_cas_inMetamodelEntityMap._isBuilt ()) {
            var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_searchedEntity, var_cas_130564, var_cas_130567, var_cas_130570, var_cas_superEntity, var_cas_130586, var_cas_130589, var_cas_130592, var_cas_130595 SOURCE_FILE_AT_LINE (3055)) ;
          }
