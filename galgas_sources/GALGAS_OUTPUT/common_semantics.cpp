...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_47390 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_47489 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_47390 != NULL)
        && (operand_47489 != NULL)) {
      macroValidPointer (operand_47390) ;
      macroValidPointer (operand_47489) ;
      if (((operand_47390->mFormalArgumentPassingMode) != (operand_47489->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_47489->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_47390->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_47390->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_47390->mGalgasTypeName.reader_value ()) != (operand_47489->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_47489->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_47390->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_47489->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_47390 = operand_47390->nextObject () ;
      operand_47489 = operand_47489->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_64597 = mNonExternAttributesList.firstObject () ;
  while ((operand_64597 != NULL)) {
    macroValidPointer (operand_64597) ;
    var_cas_outForeachList.addAssign_operation (operand_64597->mAttributType, operand_64597->aNomAttribut) ;
    operand_64597 = operand_64597->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_70370 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_70389 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_70370 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_70370) ;
    cPtr_typeGalgas_stringset * operand_70389 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_70389) ;
    if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_70370 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_70370) ;
      cPtr_typeGalgas_uint * operand_70389 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_70389) ;
      if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_70370 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_70370) ;
        cPtr_typeGalgas_sint * operand_70389 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_70389) ;
        if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_70370 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_70370) ;
          cPtr_typeGalgas_char * operand_70389 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_70389) ;
          if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_70370 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_70370) ;
            cPtr_typeGalgas_string * operand_70389 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_70389) ;
            if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_70370 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_70370) ;
              cPtr_typeGalgas_bool * operand_70389 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_70389) ;
              if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_70370 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_70370) ;
                cPtr_typeGalgas_double * operand_70389 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_70389) ;
                if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_70370 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_70370) ;
                  cPtr_typeGalgas_lbool * operand_70389 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_70389) ;
                  if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_70370 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_70370) ;
                    cPtr_typeGalgas_lchar * operand_70389 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_70389) ;
                    if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_70370 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_70370) ;
                      cPtr_typeGalgas_luint * operand_70389 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_70389) ;
                      if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_70370 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_70370) ;
                        cPtr_typeGalgas_lsint * operand_70389 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_70389) ;
                        if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_70370 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_70370) ;
                          cPtr_typeGalgas_ldouble * operand_70389 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_70389) ;
                          if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_70370 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_70370) ;
                            cPtr_typeGalgas_lstring * operand_70389 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_70389) ;
                            if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_70370 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_70370) ;
                              cPtr_typeGalgas_location * operand_70389 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_70389) ;
                              if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_70370 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_70370) ;
                                cPtr_typeGalgasUndefinedListType * operand_70389 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_70389) ;
                                if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                                  if (((operand_70370->mListTypeName.reader_value ()) != (operand_70389->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_70370->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_70389->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_70370 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_70370) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_70389 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_70389) ;
                                  if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                                    if (((operand_70370->mMapTypeName.reader_value ()) != (operand_70389->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_70370->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_70389->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_70370 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_70370) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_70389 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_70389) ;
                                    if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                                      if (((operand_70370->mClassTypeName.reader_value ()) != (operand_70389->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_70370->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_70389->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_70370 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_70370) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_70389 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_70389) ;
                                      if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                                        if (((operand_70370->mGalgasClassName.reader_value ()) != (operand_70389->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_70370->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_70389->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_70370 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_70370) ;
                                        cPtr_typeGalgas_enum * operand_70389 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_70389) ;
                                        if ((operand_70370 != NULL) && (operand_70389 != NULL)) {
                                          if (((operand_70370->mEnumTypeName.reader_value ()) != (operand_70389->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_70370->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_70389->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_74175 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_74274 = var_cas_signatureTestee.firstObject () ;
    while ((operand_74175 != NULL)
        && (operand_74274 != NULL)) {
      macroValidPointer (operand_74175) ;
      macroValidPointer (operand_74274) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_74175->mType,  operand_74274->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_74175->mFormalArgumentPassingMode) != (operand_74274->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_74274->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_74274->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_74175 = operand_74175->nextObject () ;
      operand_74274 = operand_74274->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_86185 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_86185) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_86185->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_86518 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_86518) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_86518->mMessagesMap ;
      GGS_L_lstringList  var_cas_86683 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_86683) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_88216 ;
    GGS_M_semanticsEntitiesForUse  var_cas_88219 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedOptionsComponents, var_cas_88216, var_cas_88219) ;
    GGS_stringset::element_type * operand_88320 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_88320 != NULL)) {
      macroValidPointer (operand_88320) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_88320->mKey, GGS_location (lexique_var_))) ;
      operand_88320 = operand_88320->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_88604 = var_cas_modelMap.firstObject () ;
    while ((operand_88604 != NULL)) {
      macroValidPointer (operand_88604) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_88604->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_88604->mKey, operand_88604->mInfo.mType) ;
      }
      operand_88604 = operand_88604->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_88817 = var_cas_actionMap.firstObject () ;
    while ((operand_88817 != NULL)) {
      macroValidPointer (operand_88817) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_88817->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_88817->mKey, operand_88817->mInfo.mSignature, operand_88817->mInfo.mIsExtern) ;
      }
      operand_88817 = operand_88817->nextObject () ;
    }
