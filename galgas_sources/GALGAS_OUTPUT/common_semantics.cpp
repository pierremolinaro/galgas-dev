...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_46925 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_47024 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_46925 != NULL)
        && (operand_47024 != NULL)) {
      macroValidPointer (operand_46925) ;
      macroValidPointer (operand_47024) ;
      if (((operand_46925->mFormalArgumentPassingMode) != (operand_47024->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_47024->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_46925->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_46925->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_46925->mGalgasTypeName.reader_value ()) != (operand_47024->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_47024->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_46925->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_47024->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_46925 = operand_46925->nextObject () ;
      operand_47024 = operand_47024->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_64132 = mNonExternAttributesList.firstObject () ;
  while ((operand_64132 != NULL)) {
    macroValidPointer (operand_64132) ;
    var_cas_outForeachList.addAssign_operation (operand_64132->mAttributType, operand_64132->aNomAttribut) ;
    operand_64132 = operand_64132->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_69905 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_69924 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_69905 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_69905) ;
    cPtr_typeGalgas_stringset * operand_69924 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_69924) ;
    if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_69905 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_69905) ;
      cPtr_typeGalgas_uint * operand_69924 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_69924) ;
      if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_69905 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_69905) ;
        cPtr_typeGalgas_sint * operand_69924 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_69924) ;
        if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_69905 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_69905) ;
          cPtr_typeGalgas_char * operand_69924 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_69924) ;
          if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_69905 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_69905) ;
            cPtr_typeGalgas_string * operand_69924 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_69924) ;
            if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_69905 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_69905) ;
              cPtr_typeGalgas_bool * operand_69924 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_69924) ;
              if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_69905 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_69905) ;
                cPtr_typeGalgas_double * operand_69924 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_69924) ;
                if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_69905 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_69905) ;
                  cPtr_typeGalgas_lbool * operand_69924 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_69924) ;
                  if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_69905 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_69905) ;
                    cPtr_typeGalgas_lchar * operand_69924 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_69924) ;
                    if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_69905 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_69905) ;
                      cPtr_typeGalgas_luint * operand_69924 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_69924) ;
                      if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_69905 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_69905) ;
                        cPtr_typeGalgas_lsint * operand_69924 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_69924) ;
                        if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_69905 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_69905) ;
                          cPtr_typeGalgas_ldouble * operand_69924 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_69924) ;
                          if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_69905 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_69905) ;
                            cPtr_typeGalgas_lstring * operand_69924 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_69924) ;
                            if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_69905 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_69905) ;
                              cPtr_typeGalgas_location * operand_69924 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_69924) ;
                              if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_69905 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_69905) ;
                                cPtr_typeGalgasUndefinedListType * operand_69924 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_69924) ;
                                if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                                  if (((operand_69905->mListTypeName.reader_value ()) != (operand_69924->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_69905->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_69924->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_69905 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_69905) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_69924 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_69924) ;
                                  if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                                    if (((operand_69905->mMapTypeName.reader_value ()) != (operand_69924->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_69905->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_69924->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_69905 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_69905) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_69924 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_69924) ;
                                    if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                                      if (((operand_69905->mClassTypeName.reader_value ()) != (operand_69924->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_69905->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_69924->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_69905 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_69905) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_69924 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_69924) ;
                                      if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                                        if (((operand_69905->mGalgasClassName.reader_value ()) != (operand_69924->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_69905->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_69924->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_69905 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_69905) ;
                                        cPtr_typeGalgas_enum * operand_69924 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_69924) ;
                                        if ((operand_69905 != NULL) && (operand_69924 != NULL)) {
                                          if (((operand_69905->mEnumTypeName.reader_value ()) != (operand_69924->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_69905->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_69924->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_73710 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_73809 = var_cas_signatureTestee.firstObject () ;
    while ((operand_73710 != NULL)
        && (operand_73809 != NULL)) {
      macroValidPointer (operand_73710) ;
      macroValidPointer (operand_73809) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_73710->mType,  operand_73809->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_73710->mFormalArgumentPassingMode) != (operand_73809->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_73809->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_73809->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_73710 = operand_73710->nextObject () ;
      operand_73809 = operand_73809->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_85720 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_85720) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_85720->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_86053 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_86053) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_86053->mMessagesMap ;
      GGS_L_lstringList  var_cas_86218 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_86218) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_87751 ;
    GGS_M_semanticsEntitiesForUse  var_cas_87754 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedOptionsComponents, var_cas_87751, var_cas_87754) ;
    GGS_stringset::element_type * operand_87855 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_87855 != NULL)) {
      macroValidPointer (operand_87855) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_87855->mKey, GGS_location (lexique_var_))) ;
      operand_87855 = operand_87855->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_88139 = var_cas_modelMap.firstObject () ;
    while ((operand_88139 != NULL)) {
      macroValidPointer (operand_88139) ;
      var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_88139->mKey, operand_88139->mInfo.mType) ;
      operand_88139 = operand_88139->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_88283 = var_cas_actionMap.firstObject () ;
    while ((operand_88283 != NULL)) {
      macroValidPointer (operand_88283) ;
      var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_88283->mKey, operand_88283->mInfo.mSignature, operand_88283->mInfo.mIsExtern) ;
      operand_88283 = operand_88283->nextObject () ;
    }
