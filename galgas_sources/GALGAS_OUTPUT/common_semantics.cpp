...
//---------------------------------------------------------------------------*
  ...
  cPtr_BoolModel * GGS_BoolModel::
    ...
    macroMyNew (ptr_, cPtr_BoolModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_CharModel * GGS_CharModel::
    ...
    macroMyNew (ptr_, cPtr_CharModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_UIntModel * GGS_UIntModel::
    ...
    macroMyNew (ptr_, cPtr_UIntModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_SIntModel * GGS_SIntModel::
    ...
    macroMyNew (ptr_, cPtr_SIntModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_DoubleModel * GGS_DoubleModel::
    ...
    macroMyNew (ptr_, cPtr_DoubleModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_StringModel * GGS_StringModel::
    ...
    macroMyNew (ptr_, cPtr_StringModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LBoolModel * GGS_LBoolModel::
    ...
    macroMyNew (ptr_, cPtr_LBoolModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LCharModel * GGS_LCharModel::
    ...
    macroMyNew (ptr_, cPtr_LCharModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LUIntModel * GGS_LUIntModel::
    ...
    macroMyNew (ptr_, cPtr_LUIntModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LSIntModel * GGS_LSIntModel::
    ...
    macroMyNew (ptr_, cPtr_LSIntModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LDoubleModel * GGS_LDoubleModel::
    ...
    macroMyNew (ptr_, cPtr_LDoubleModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LStringModel * GGS_LStringModel::
    ...
    macroMyNew (ptr_, cPtr_LStringModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_StringsetModel * GGS_StringsetModel::
    ...
    macroMyNew (ptr_, cPtr_StringsetModel ()) ;
    return ptr_ ;
  }
#endif
...
//---------------------------------------------------------------------------*
  ...
  cPtr_LocationModel * GGS_LocationModel::
    ...
    macroMyNew (ptr_, cPtr_LocationModel ()) ;
    return ptr_ ;
  }
#endif
...
cPtr_ListModel::cPtr_ListModel (const GGS_typeListModel & argument_0)
...
//---------------------------------------------------------------------------*
  ...
  cPtr_ListModel * GGS_ListModel::
    constructor_new (const GGS_typeListModel & argument_0) {
...
cPtr_MapModel::cPtr_MapModel (const GGS_typeListModel & argument_0)
:mAttributeList (argument_0) {
}
...
//---------------------------------------------------------------------------*
  ...
  cPtr_MapModel * GGS_MapModel::
    ...
    macroMyNew (ptr_, cPtr_MapModel (argument_0)) ;
    return ptr_ ;
  }
#endif
...
GGS_enumConstantMap GGS_enumConstantMap::constructor_empty (void) {
...
GGS_enumMessageMap GGS_enumMessageMap::constructor_empty (void) {
...
GGS_constructorMap GGS_constructorMap::constructor_empty (void) {
...
GGS_readerMap GGS_readerMap::constructor_empty (void) {
...
GGS_modifierMap GGS_modifierMap::constructor_empty (void) {
...
GGS_classMessageMap GGS_classMessageMap::constructor_empty (void) {
...
GGS_ActionMap GGS_ActionMap::constructor_empty (void) {
...
cPtr_typeEntiteRoutine::cPtr_typeEntiteRoutine (const GGS_L_EXsignature & argument_0)
...
//---------------------------------------------------------------------------*
  ...
  cPtr_typeEntiteRoutine * GGS_typeEntiteRoutine::
    constructor_new (const GGS_L_EXsignature & argument_0) {
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
        ...
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
        var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
      }else{
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    while ((operand_88322 != NULL)) {
      ...
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_88322->mKey, GGS_location (lexique_var_))) ;
