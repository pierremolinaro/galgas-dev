...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34820 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34919 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34820 != NULL)
        && (operand_34919 != NULL)) {
      macroValidPointer (operand_34820) ;
      macroValidPointer (operand_34919) ;
      if (((operand_34820->mFormalArgumentPassingMode) != (operand_34919->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34919->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34820->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34820->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34820->mGalgasTypeName.reader_value ()) != (operand_34919->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34919->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34820->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34919->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34820 = operand_34820->nextObject () ;
      operand_34919 = operand_34919->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_52525 = mNonExternAttributesList.firstObject () ;
  while ((operand_52525 != NULL)) {
    macroValidPointer (operand_52525) ;
    var_cas_outForeachList.addAssign_operation (operand_52525->mAttributType, operand_52525->aNomAttribut) ;
    operand_52525 = operand_52525->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59079 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59098 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_stringset * operand_59079 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59079) ;
    cPtr_typeGalgas_stringset * operand_59098 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59098) ;
    if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_59079 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59079) ;
      cPtr_typeGalgas_uint * operand_59098 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59098) ;
      if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_59079 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59079) ;
        cPtr_typeGalgas_sint * operand_59098 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59098) ;
        if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_59079 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59079) ;
          cPtr_typeGalgas_char * operand_59098 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59098) ;
          if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_59079 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59079) ;
            cPtr_typeGalgas_string * operand_59098 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59098) ;
            if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_59079 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59079) ;
              cPtr_typeGalgas_bool * operand_59098 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59098) ;
              if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_59079 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59079) ;
                cPtr_typeGalgas_double * operand_59098 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59098) ;
                if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_59079 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59079) ;
                  cPtr_typeGalgas_lbool * operand_59098 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59098) ;
                  if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_59079 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59079) ;
                    cPtr_typeGalgas_lchar * operand_59098 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59098) ;
                    if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_59079 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59079) ;
                      cPtr_typeGalgas_luint * operand_59098 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59098) ;
                      if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_59079 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59079) ;
                        cPtr_typeGalgas_lsint * operand_59098 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59098) ;
                        if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_59079 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59079) ;
                          cPtr_typeGalgas_ldouble * operand_59098 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59098) ;
                          if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_59079 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59079) ;
                            cPtr_typeGalgas_lstring * operand_59098 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59098) ;
                            if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_59079 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59079) ;
                              cPtr_typeGalgas_location * operand_59098 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59098) ;
                              if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_59079 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59079) ;
                                cPtr_typeGalgasUndefinedListType * operand_59098 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59098) ;
                                if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                                  if (((operand_59079->mListTypeName.reader_value ()) != (operand_59098->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59079->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59098->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_59079 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59079) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_59098 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59098) ;
                                  if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                                    if (((operand_59079->mMapTypeName.reader_value ()) != (operand_59098->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59079->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59098->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_59079 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59079) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_59098 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59098) ;
                                    if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                                      if (((operand_59079->mClassTypeName.reader_value ()) != (operand_59098->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59079->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59098->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_59079 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59079) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_59098 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59098) ;
                                      if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                                        if (((operand_59079->mGalgasClassName.reader_value ()) != (operand_59098->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59079->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59098->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_59079 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59079) ;
                                        cPtr_typeGalgas_enum * operand_59098 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59098) ;
                                        if ((operand_59079 != NULL) && (operand_59098 != NULL)) {
                                          if (((operand_59079->mEnumTypeName.reader_value ()) != (operand_59098->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59079->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59098->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_62880 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_62979 = var_cas_signatureTestee.firstObject () ;
    while ((operand_62880 != NULL)
        && (operand_62979 != NULL)) {
      macroValidPointer (operand_62880) ;
      macroValidPointer (operand_62979) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62880->mType,  operand_62979->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_62880->mFormalArgumentPassingMode) != (operand_62979->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_62979->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_62979->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_62880 = operand_62880->nextObject () ;
      operand_62979 = operand_62979->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_73695 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73695) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73695->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74028 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74028) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74028->mMessagesMap ;
      GGS_L_lstringList  var_cas_74193 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_74193) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
