...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_49242 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_49341 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_49242 != NULL)
        && (operand_49341 != NULL)) {
      macroValidPointer (operand_49242) ;
      macroValidPointer (operand_49341) ;
      if (((operand_49242->mFormalArgumentPassingMode) != (operand_49341->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_49341->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_49242->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_49242->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_49242->mGalgasTypeName.reader_value ()) != (operand_49341->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_49341->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_49242->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_49341->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_49242 = operand_49242->nextObject () ;
      operand_49341 = operand_49341->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66486 = mNonExternAttributesList.firstObject () ;
  while ((operand_66486 != NULL)) {
    macroValidPointer (operand_66486) ;
    var_cas_outForeachList.addAssign_operation (operand_66486->mAttributType, operand_66486->aNomAttribut) ;
    operand_66486 = operand_66486->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72259 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72278 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72259 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72259) ;
    cPtr_typeGalgas_stringset * operand_72278 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72278) ;
    if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72259 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72259) ;
      cPtr_typeGalgas_uint * operand_72278 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72278) ;
      if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72259 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72259) ;
        cPtr_typeGalgas_sint * operand_72278 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72278) ;
        if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72259 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72259) ;
          cPtr_typeGalgas_char * operand_72278 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72278) ;
          if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72259 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72259) ;
            cPtr_typeGalgas_string * operand_72278 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72278) ;
            if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72259 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72259) ;
              cPtr_typeGalgas_bool * operand_72278 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72278) ;
              if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72259 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72259) ;
                cPtr_typeGalgas_double * operand_72278 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72278) ;
                if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72259 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72259) ;
                  cPtr_typeGalgas_lbool * operand_72278 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72278) ;
                  if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72259 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72259) ;
                    cPtr_typeGalgas_lchar * operand_72278 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72278) ;
                    if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72259 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72259) ;
                      cPtr_typeGalgas_luint * operand_72278 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72278) ;
                      if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72259 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72259) ;
                        cPtr_typeGalgas_lsint * operand_72278 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72278) ;
                        if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72259 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72259) ;
                          cPtr_typeGalgas_ldouble * operand_72278 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72278) ;
                          if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72259 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72259) ;
                            cPtr_typeGalgas_lstring * operand_72278 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72278) ;
                            if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72259 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72259) ;
                              cPtr_typeGalgas_location * operand_72278 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72278) ;
                              if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72259 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72259) ;
                                cPtr_typeGalgasUndefinedListType * operand_72278 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72278) ;
                                if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                                  if (((operand_72259->mListTypeName.reader_value ()) != (operand_72278->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72259->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72278->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72259 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72259) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72278 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72278) ;
                                  if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                                    if (((operand_72259->mMapTypeName.reader_value ()) != (operand_72278->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72259->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72278->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72259 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72259) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72278 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72278) ;
                                    if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                                      if (((operand_72259->mClassTypeName.reader_value ()) != (operand_72278->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72259->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72278->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72259 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72259) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72278 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72278) ;
                                      if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                                        if (((operand_72259->mGalgasClassName.reader_value ()) != (operand_72278->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72259->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72278->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72259 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72259) ;
                                        cPtr_typeGalgas_enum * operand_72278 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72278) ;
                                        if ((operand_72259 != NULL) && (operand_72278 != NULL)) {
                                          if (((operand_72259->mEnumTypeName.reader_value ()) != (operand_72278->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72259->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72278->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_76064 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_76163 = var_cas_signatureTestee.firstObject () ;
    while ((operand_76064 != NULL)
        && (operand_76163 != NULL)) {
      macroValidPointer (operand_76064) ;
      macroValidPointer (operand_76163) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_76064->mType,  operand_76163->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_76064->mFormalArgumentPassingMode) != (operand_76163->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_76163->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_76163->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_76064 = operand_76064->nextObject () ;
      operand_76163 = operand_76163->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_89352 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89352) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89352->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_89695 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89695) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89695->mMessagesMap ;
        GGS_L_lstringList  var_cas_89864 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_89864) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_91660 ;
    GGS_M_semanticsEntitiesForUse  var_cas_91669 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_91660, var_cas_91669) ;
    ...
    GGS_stringset::element_type * operand_91914 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_91914 != NULL)) {
      macroValidPointer (operand_91914) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_91914->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_91914 = operand_91914->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_92279 = var_cas_modelMap.firstObject () ;
    while ((operand_92279 != NULL)) {
      macroValidPointer (operand_92279) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_92279->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_92279->mKey, operand_92279->mInfo.mType) ;
      }
      operand_92279 = operand_92279->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_92492 = var_cas_actionMap.firstObject () ;
    while ((operand_92492 != NULL)) {
      macroValidPointer (operand_92492) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_92492->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_92492->mKey, operand_92492->mInfo.mSignature, operand_92492->mInfo.mIsExtern) ;
      }
      operand_92492 = operand_92492->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_93234 ;
    GGS_bool var_cas_93237 ;
    GGS_entityPropertyMap  var_cas_93240 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_93234, var_cas_93237, var_cas_93240, var_cas_superEntityName) ;
