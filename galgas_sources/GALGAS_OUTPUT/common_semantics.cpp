...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_47392 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_47491 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_47392 != NULL)
        && (operand_47491 != NULL)) {
      macroValidPointer (operand_47392) ;
      macroValidPointer (operand_47491) ;
      if (((operand_47392->mFormalArgumentPassingMode) != (operand_47491->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_47491->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_47392->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_47392->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_47392->mGalgasTypeName.reader_value ()) != (operand_47491->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_47491->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_47392->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_47491->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_47392 = operand_47392->nextObject () ;
      operand_47491 = operand_47491->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_64599 = mNonExternAttributesList.firstObject () ;
  while ((operand_64599 != NULL)) {
    macroValidPointer (operand_64599) ;
    var_cas_outForeachList.addAssign_operation (operand_64599->mAttributType, operand_64599->aNomAttribut) ;
    operand_64599 = operand_64599->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_70372 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_70391 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_70372 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_70372) ;
    cPtr_typeGalgas_stringset * operand_70391 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_70391) ;
    if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_70372 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_70372) ;
      cPtr_typeGalgas_uint * operand_70391 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_70391) ;
      if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_70372 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_70372) ;
        cPtr_typeGalgas_sint * operand_70391 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_70391) ;
        if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_70372 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_70372) ;
          cPtr_typeGalgas_char * operand_70391 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_70391) ;
          if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_70372 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_70372) ;
            cPtr_typeGalgas_string * operand_70391 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_70391) ;
            if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_70372 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_70372) ;
              cPtr_typeGalgas_bool * operand_70391 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_70391) ;
              if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_70372 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_70372) ;
                cPtr_typeGalgas_double * operand_70391 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_70391) ;
                if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_70372 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_70372) ;
                  cPtr_typeGalgas_lbool * operand_70391 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_70391) ;
                  if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_70372 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_70372) ;
                    cPtr_typeGalgas_lchar * operand_70391 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_70391) ;
                    if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_70372 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_70372) ;
                      cPtr_typeGalgas_luint * operand_70391 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_70391) ;
                      if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_70372 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_70372) ;
                        cPtr_typeGalgas_lsint * operand_70391 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_70391) ;
                        if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_70372 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_70372) ;
                          cPtr_typeGalgas_ldouble * operand_70391 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_70391) ;
                          if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_70372 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_70372) ;
                            cPtr_typeGalgas_lstring * operand_70391 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_70391) ;
                            if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_70372 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_70372) ;
                              cPtr_typeGalgas_location * operand_70391 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_70391) ;
                              if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_70372 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_70372) ;
                                cPtr_typeGalgasUndefinedListType * operand_70391 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_70391) ;
                                if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                                  if (((operand_70372->mListTypeName.reader_value ()) != (operand_70391->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_70372->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_70391->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_70372 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_70372) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_70391 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_70391) ;
                                  if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                                    if (((operand_70372->mMapTypeName.reader_value ()) != (operand_70391->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_70372->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_70391->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_70372 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_70372) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_70391 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_70391) ;
                                    if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                                      if (((operand_70372->mClassTypeName.reader_value ()) != (operand_70391->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_70372->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_70391->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_70372 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_70372) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_70391 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_70391) ;
                                      if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                                        if (((operand_70372->mGalgasClassName.reader_value ()) != (operand_70391->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_70372->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_70391->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_70372 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_70372) ;
                                        cPtr_typeGalgas_enum * operand_70391 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_70391) ;
                                        if ((operand_70372 != NULL) && (operand_70391 != NULL)) {
                                          if (((operand_70372->mEnumTypeName.reader_value ()) != (operand_70391->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_70372->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_70391->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_74177 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_74276 = var_cas_signatureTestee.firstObject () ;
    while ((operand_74177 != NULL)
        && (operand_74276 != NULL)) {
      macroValidPointer (operand_74177) ;
      macroValidPointer (operand_74276) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_74177->mType,  operand_74276->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_74177->mFormalArgumentPassingMode) != (operand_74276->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_74276->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_74276->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_74177 = operand_74177->nextObject () ;
      operand_74276 = operand_74276->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_86187 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_86187) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_86187->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_86520 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_86520) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_86520->mMessagesMap ;
      GGS_L_lstringList  var_cas_86685 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_86685) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_88218 ;
    GGS_M_semanticsEntitiesForUse  var_cas_88221 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedOptionsComponents, var_cas_88218, var_cas_88221) ;
    GGS_stringset::element_type * operand_88322 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_88322 != NULL)) {
      macroValidPointer (operand_88322) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_88322->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_88322 = operand_88322->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_88606 = var_cas_modelMap.firstObject () ;
    while ((operand_88606 != NULL)) {
      macroValidPointer (operand_88606) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_88606->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_88606->mKey, operand_88606->mInfo.mType) ;
      }
      operand_88606 = operand_88606->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_88819 = var_cas_actionMap.firstObject () ;
    while ((operand_88819 != NULL)) {
      macroValidPointer (operand_88819) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_88819->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_88819->mKey, operand_88819->mInfo.mSignature, operand_88819->mInfo.mIsExtern) ;
      }
      operand_88819 = operand_88819->nextObject () ;
    }
