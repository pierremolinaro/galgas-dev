...
methode_acceptAssignmentFromHere (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "assignment from 'here' is not allowed for variables of this type") SOURCE_FILE_AT_LINE (376)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type cannot be enumerated by in 'foreach' instruction") SOURCE_FILE_AT_LINE (386)) ;
}
...
methode_acceptToBeKeyForMap (C_Lexique & lexique_var_) {
    GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this type cannot be a key for map") SOURCE_FILE_AT_LINE (391)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
    ...
    var_cas_inModifierName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (400)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
    ...
    var_cas_inReaderName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader instruction") SOURCE_FILE_AT_LINE (410)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
    ...
    var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (418)) ;
}
...
methode_handleAddAssignOperatorCall (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (429)) ;
}
...
methode_handleIncrementOperatorCall (C_Lexique & lexique_var_,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (437)) ;
}
...
methode_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & lexique_var_) {
    GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (443)) ;
}
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << "->" ;
  ioString << mInfo.mTypeName.reader_description () ;
  ioString << mInfo.mIsMap.reader_description () ;
  ioString << "]" ;
}
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mContextParameterList.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_contextParameterMap::reader_description (void) const {
  C_String s ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     Element of list '@insertionList'                      *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_insertionList::
elementOf_GGS_insertionList (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_lstring & argument_2) {
  mNextItem = (elementOf_GGS_insertionList *) NULL ;
  mInsertedAttributeName = argument_0 ;
  mMapName = argument_1 ;
  mIndexName = argument_2 ;
}

//---------------------------------------------------------------------------*

void elementOf_GGS_insertionList::
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mInsertedAttributeName.reader_description () ;
  ioString << mMapName.reader_description () ;
  ioString << mIndexName.reader_description () ;
  ioString << "]" ;
}
...
GGS_insertionList
::GGS_insertionList (void) { // Default Constructor
  mFirstItem = (element_type *) NULL ;
  mLastItem = (element_type *) NULL ;
  mListLength = 0 ;
  mCountReference = (sint32 *) NULL ;
...
#ifndef DO_NOT_GENERATE_CHECKINGS
  GGS_insertionList
::GGS_insertionList (UNUSED_LOCATION_ARGS) {
    mFirstItem = (element_type *) NULL ;
    mLastItem = (element_type *) NULL ;
    mListLength = 0 ;
    mCountReference = (sint32 *) NULL ;
...
GGS_insertionList::~GGS_insertionList (void) {
  emptyList () ;
}

//---------------------------------------------------------------------------*

GGS_insertionList::GGS_insertionList (const GGS_insertionList & source) { // Copy constructor
  mFirstItem = (element_type *) NULL ;
  mLastItem = (element_type *) NULL ;
  mListLength = 0 ;
  mCountReference = (sint32 *) NULL ;
...
void GGS_insertionList
::operator = (const GGS_insertionList & source) { // Assignment operator
  if (this != & source) {
    emptyList () ;
    mFirstItem = source.mFirstItem ;
    mLastItem = source.mLastItem ;
...
::insulateList (void) {
  if (mCountReference != NULL) {
    ...
    if ((*mCountReference) > 1) {
      ...
      while (p != NULL) {
        macroValidPointer (p) ;
        internalAppendItem (p->mInsertedAttributeName,
                                p->mMapName,
                                p->mIndexName) ;
        p = p->mNextItem ;
      }
...
GGS_insertionList  GGS_insertionList::
constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_insertionList result ;
  macroMyNew (result.mCountReference, sint32 (1)) ;
  return result ;
}
...
GGS_string GGS_insertionList::reader_description (void) const {
  C_String s ;
  s << "<list @insertionList" ;
  if (isBuilt ()) {
    s << mListLength << " object" << ((mListLength > 1) ? "s " : " ") ;
    element_type * p = mFirstItem ;
    while (p != NULL) {
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mSuperEntityName.reader_description () ;
  ioString << mInfo.mEntityPropertiesMap.reader_description () ;
  ioString << mInfo.mContextPropertyMap.reader_description () ;
  ioString << mInfo.mMapPropertyMap.reader_description () ;
  ioString << mInfo.mContextParameterMap.reader_description () ;
  ioString << mInfo.mInsertionList.reader_description () ;
...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_relationMap &  inParameter2,
               const GGS_lstring &  inParameter3,
               const GGS_entityPropertyMap &  inParameter4,
               const GGS_contextPropertyMap &  inParameter5,
               const GGS_mapPropertyMap &  inParameter6,
               const GGS_contextParameterMap &  inParameter7,
               const GGS_insertionList &  inParameter8,
               const GGS_indexMap &  inParameter9,
               const GGS_fetchedPropertyMap &  inParameter10,
               const GGS_stringset &  inParameter11,
               const GGS_location &  inParameter12,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mAllRelationMap = inParameter2 ;
    info.mSuperEntityName = inParameter3 ;
    info.mEntityPropertiesMap = inParameter4 ;
    info.mContextPropertyMap = inParameter5 ;
    info.mMapPropertyMap = inParameter6 ;
    info.mContextParameterMap = inParameter7 ;
    info.mInsertionList = inParameter8 ;
    info.mIndexMap = inParameter9 ;
    info.mFetchedPropertyMap = inParameter10 ;
    info.mDescendantEntitySet = inParameter11 ;
    info.mEndOfConstraintLocation = inParameter12 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_relationMap   & outParameter2,
               GGS_lstring   & outParameter3,
               GGS_entityPropertyMap   & outParameter4,
               GGS_contextPropertyMap   & outParameter5,
               GGS_mapPropertyMap   & outParameter6,
               GGS_contextParameterMap   & outParameter7,
               GGS_insertionList   & outParameter8,
               GGS_indexMap   & outParameter9,
               GGS_fetchedPropertyMap   & outParameter10,
               GGS_stringset   & outParameter11,
               GGS_location   & outParameter12,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mAllRelationMap ;
    outParameter3 = node->mInfo.mSuperEntityName ;
    outParameter4 = node->mInfo.mEntityPropertiesMap ;
    outParameter5 = node->mInfo.mContextPropertyMap ;
    outParameter6 = node->mInfo.mMapPropertyMap ;
    outParameter7 = node->mInfo.mContextParameterMap ;
    outParameter8 = node->mInfo.mInsertionList ;
    outParameter9 = node->mInfo.mIndexMap ;
    outParameter10 = node->mInfo.mFetchedPropertyMap ;
    outParameter11 = node->mInfo.mDescendantEntitySet ;
    outParameter12 = node->mInfo.mEndOfConstraintLocation ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_constrainedEntityMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_fetchedPropertyMap   & outParameter10,
                                GGS_stringset   & outParameter11,
                                GGS_location   & outParameter12 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
                 "no constraint has beeb defined for the '@%K' entity",
                 inKey,
                 outParameter0,
                 outParameter1,
                 outParameter2,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_fetchedPropertyMap & inParameter10,
                                const GGS_stringset & inParameter11,
                                const GGS_location & inParameter12 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (883)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (968)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1003)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1034)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1065)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1100)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1135)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1166)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1277)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1286)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1295)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1425)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1427)) ;
  }else{
    GGS_L_signature::element_type * operand_56843 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_56942 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_56843 != NULL)
        && (operand_56942 != NULL)) {
      macroValidPointer (operand_56843) ;
      macroValidPointer (operand_56942) ;
      if (((operand_56843->mFormalArgumentPassingMode) != (operand_56942->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_56942->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_56843->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_56843->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1433)) ;
      }
      if (((operand_56843->mGalgasTypeName.reader_value ()) != (operand_56942->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_56942->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_56843->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_56942->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1436)) ;
      }
      operand_56843 = operand_56843->nextObject () ;
      operand_56942 = operand_56942->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1751)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1815)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_74741 = mNonExternAttributesList.firstObject () ;
  while ((operand_74741 != NULL)) {
    macroValidPointer (operand_74741) ;
    var_cas_outForeachList.addAssign_operation (operand_74741->mAttributType, operand_74741->aNomAttribut) ;
    operand_74741 = operand_74741->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1842)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1890)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1901)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1910)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1914)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1973)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_80514 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_80533 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_80514 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_80514) ;
    cPtr_typeGalgas_stringset * operand_80533 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_80533) ;
    if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_80514 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_80514) ;
      cPtr_typeGalgas_uint * operand_80533 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_80533) ;
      if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_80514 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_80514) ;
        cPtr_typeGalgas_sint * operand_80533 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_80533) ;
        if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_80514 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_80514) ;
          cPtr_typeGalgas_char * operand_80533 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_80533) ;
          if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_80514 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_80514) ;
            cPtr_typeGalgas_string * operand_80533 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_80533) ;
            if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_80514 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_80514) ;
              cPtr_typeGalgas_bool * operand_80533 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_80533) ;
              if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_80514 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_80514) ;
                cPtr_typeGalgas_double * operand_80533 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_80533) ;
                if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_80514 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_80514) ;
                  cPtr_typeGalgas_lbool * operand_80533 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_80533) ;
                  if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_80514 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_80514) ;
                    cPtr_typeGalgas_lchar * operand_80533 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_80533) ;
                    if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_80514 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_80514) ;
                      cPtr_typeGalgas_luint * operand_80533 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_80533) ;
                      if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_80514 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_80514) ;
                        cPtr_typeGalgas_lsint * operand_80533 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_80533) ;
                        if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_80514 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_80514) ;
                          cPtr_typeGalgas_ldouble * operand_80533 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_80533) ;
                          if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_80514 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_80514) ;
                            cPtr_typeGalgas_lstring * operand_80533 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_80533) ;
                            if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_80514 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_80514) ;
                              cPtr_typeGalgas_location * operand_80533 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_80533) ;
                              if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_80514 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_80514) ;
                                cPtr_typeGalgasUndefinedListType * operand_80533 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_80533) ;
                                if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                                  if (((operand_80514->mListTypeName.reader_value ()) != (operand_80533->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_80514->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_80533->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2010)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_80514 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_80514) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_80533 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_80533) ;
                                  if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                                    if (((operand_80514->mMapTypeName.reader_value ()) != (operand_80533->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_80514->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_80533->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2016)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_80514 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_80514) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_80533 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_80533) ;
                                    if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                                      if (((operand_80514->mClassTypeName.reader_value ()) != (operand_80533->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_80514->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_80533->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2022)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_80514 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_80514) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_80533 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_80533) ;
                                      if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                                        if (((operand_80514->mGalgasClassName.reader_value ()) != (operand_80533->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_80514->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_80533->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2029)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_80514 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_80514) ;
                                        cPtr_typeGalgas_enum * operand_80533 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_80533) ;
                                        if ((operand_80514 != NULL) && (operand_80533 != NULL)) {
                                          if (((operand_80514->mEnumTypeName.reader_value ()) != (operand_80533->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_80514->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_80533->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2036)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (2040)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2056)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2058)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_84319 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_84418 = var_cas_signatureTestee.firstObject () ;
    while ((operand_84319 != NULL)
        && (operand_84418 != NULL)) {
      macroValidPointer (operand_84319) ;
      macroValidPointer (operand_84418) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_84319->mType,  operand_84418->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2062)) ;
      if (((operand_84319->mFormalArgumentPassingMode) != (operand_84418->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_84418->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_84418->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2065)) ;
      }
      operand_84319 = operand_84319->nextObject () ;
      operand_84418 = operand_84418->nextObject () ;
    }
  }
}
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mSemanticsEntitiesMap.reader_description () ;
  ioString << mInfo.mEntityMap.reader_description () ;
  ioString << mInfo.mMultiReferencedEntities.reader_description () ;
  ioString << "]" ;
}
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mMetamodel.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_M_constraintComponents::reader_description (void) const {
  C_String s ;
...
appendForListDescription (C_String & ioString) const {
  ...
  ioString << mConstraintsForMetamodel.reader_description () ;
  ioString << "]" ;
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2232)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2240)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2251)) ;
        }
        ...
        }else if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2265)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2279)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2304)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2321)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2338)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2346)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2365)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2378)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_100773 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100773) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100773->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2382)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_101116 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_101116) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_101116->mMessagesMap ;
        GGS_L_lstringList  var_cas_101285 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_101285 SOURCE_FILE_AT_LINE (2387)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2393)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_103081 ;
    GGS_M_semanticsEntitiesForUse  var_cas_103090 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_103081, var_cas_103090 SOURCE_FILE_AT_LINE (2428)) ;
    ...
    GGS_stringset::element_type * operand_103335 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_103335 != NULL)) {
      macroValidPointer (operand_103335) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_103335->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2442)) ;
      operand_103335 = operand_103335->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_103700 = var_cas_modelMap.firstObject () ;
    while ((operand_103700 != NULL)) {
      macroValidPointer (operand_103700) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_103700->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_103700->mKey, operand_103700->mInfo.mType SOURCE_FILE_AT_LINE (2454)) ;
      }
      operand_103700 = operand_103700->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103913 = var_cas_actionMap.firstObject () ;
    while ((operand_103913 != NULL)) {
      macroValidPointer (operand_103913) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_103913->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_103913->mKey, operand_103913->mInfo.mSignature, operand_103913->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2460)) ;
      }
      operand_103913 = operand_103913->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_104716 ;
    GGS_bool var_cas_104719 ;
    GGS_entityPropertyMap  var_cas_104722 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_104716, var_cas_104719, var_cas_104722, var_cas_superEntityName SOURCE_FILE_AT_LINE (2478)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2479)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_105460 = var_cas_inPath.firstObject () ;
  while ((operand_105460 != NULL)) {
    macroValidPointer (operand_105460) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_105460->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_105460->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2505)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_105460->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2511)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_106250 ;
      GGS_entityPropertyMap  var_cas_106253 ;
      GGS_lstring  var_cas_106256 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106250, var_cas_106253, var_cas_106256 SOURCE_FILE_AT_LINE (2516)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_105460->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2519)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_106622 ;
          GGS_lstring  var_cas_106625 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_106622, var_cas_106625 SOURCE_FILE_AT_LINE (2523)) ;
          GGS_bool var_cas_106694 ;
          GGS_entityPropertyMap  var_cas_106697 ;
          GGS_lstring  var_cas_106700 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_106694, var_cas_106697, var_cas_106700 SOURCE_FILE_AT_LINE (2524)) ;
        }else{
          GGS_bool var_cas_106781 ;
          GGS_entityPropertyMap  var_cas_106784 ;
          GGS_lstring  var_cas_106787 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106781, var_cas_106784, var_cas_106787 SOURCE_FILE_AT_LINE (2526)) ;
        }
      }
    }
    operand_105460 = operand_105460->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & lexique_var_,
                                GGS_entityToImplementMap  & var_cas_ioEntityMap,
                                GGS_lstring   var_cas_inEntityName,
                                GGS_stringset  & var_cas_ioDescendantEntitySet COMMA_UNUSED_LOCATION_ARGS) {
  GGS_entityToImplementMap::element_type * operand_107102 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_107102 != NULL)) {
    macroValidPointer (operand_107102) ;
    if (((((operand_107102->mInfo.mSuperEntityName.reader_value ()) == (var_cas_inEntityName.reader_value ())) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (var_cas_inEntityName.reader_value ())))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_107102->mKey.reader_value ()) ;
      ::routine_computeDescendantSet (lexique_var_,  var_cas_ioEntityMap,  operand_107102->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2543)) ;
    }
    operand_107102 = operand_107102->nextObject () ;
  }
}
