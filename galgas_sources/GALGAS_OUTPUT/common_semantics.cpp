...
//---------------------------------------------------------------------------*
//                                                                           *
//                   class map 'constraintToImplementMap'                    *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_constraintToImplementMap::
elementOf_GGS_constraintToImplementMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
void elementOf_GGS_constraintToImplementMap::
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
...
AC_galgas_map_element * GGS_constraintToImplementMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_constraintToImplementMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  e_constraintToImplementMap * info = (e_constraintToImplementMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_constraintToImplementMap GGS_constraintToImplementMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_constraintToImplementMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_constraintToImplementMap::internalInsertForDuplication (AC_galgas_map_element * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void GGS_constraintToImplementMap::
insertElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_constraintToImplementMap info  ;
    info.mRelationMap = inParameter0 ;
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mRelationMap ;
...
void GGS_constraintToImplementMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_relationMap   & outParameter0,
                                GGS_lstring   & outParameter1,
                                GGS_entityPropertyMap   & outParameter2 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_relationMap & inParameter0,
                                const GGS_lstring & inParameter1,
                                const GGS_entityPropertyMap & inParameter2 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
GGS_string GGS_constraintToImplementMap::reader_description (void) const {
  C_String s ;
  s << "<map @constraintToImplementMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
    element_type * p = firstObject () ;
    while (p != NULL) {
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (853)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (938)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (973)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1004)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1035)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1070)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1105)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1136)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1247)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1256)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1265)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1395)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1397)) ;
  }else{
    GGS_L_signature::element_type * operand_55820 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_55919 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_55820 != NULL)
        && (operand_55919 != NULL)) {
      macroValidPointer (operand_55820) ;
      macroValidPointer (operand_55919) ;
      if (((operand_55820->mFormalArgumentPassingMode) != (operand_55919->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_55919->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_55820->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_55820->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1403)) ;
      }
      if (((operand_55820->mGalgasTypeName.reader_value ()) != (operand_55919->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_55919->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_55820->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_55919->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1406)) ;
      }
      operand_55820 = operand_55820->nextObject () ;
      operand_55919 = operand_55919->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1721)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1785)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_73718 = mNonExternAttributesList.firstObject () ;
  while ((operand_73718 != NULL)) {
    macroValidPointer (operand_73718) ;
    var_cas_outForeachList.addAssign_operation (operand_73718->mAttributType, operand_73718->aNomAttribut) ;
    operand_73718 = operand_73718->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1812)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1860)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1871)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1880)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1884)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1943)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79491 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79510 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79491 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79491) ;
    cPtr_typeGalgas_stringset * operand_79510 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79510) ;
    if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79491 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79491) ;
      cPtr_typeGalgas_uint * operand_79510 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79510) ;
      if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79491 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79491) ;
        cPtr_typeGalgas_sint * operand_79510 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79510) ;
        if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79491 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79491) ;
          cPtr_typeGalgas_char * operand_79510 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79510) ;
          if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79491 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79491) ;
            cPtr_typeGalgas_string * operand_79510 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79510) ;
            if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79491 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79491) ;
              cPtr_typeGalgas_bool * operand_79510 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79510) ;
              if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79491 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79491) ;
                cPtr_typeGalgas_double * operand_79510 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79510) ;
                if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79491 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79491) ;
                  cPtr_typeGalgas_lbool * operand_79510 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79510) ;
                  if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79491 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79491) ;
                    cPtr_typeGalgas_lchar * operand_79510 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79510) ;
                    if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79491 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79491) ;
                      cPtr_typeGalgas_luint * operand_79510 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79510) ;
                      if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79491 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79491) ;
                        cPtr_typeGalgas_lsint * operand_79510 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79510) ;
                        if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79491 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79491) ;
                          cPtr_typeGalgas_ldouble * operand_79510 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79510) ;
                          if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79491 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79491) ;
                            cPtr_typeGalgas_lstring * operand_79510 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79510) ;
                            if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79491 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79491) ;
                              cPtr_typeGalgas_location * operand_79510 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79510) ;
                              if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79491 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79491) ;
                                cPtr_typeGalgasUndefinedListType * operand_79510 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79510) ;
                                if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                                  if (((operand_79491->mListTypeName.reader_value ()) != (operand_79510->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79491->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79510->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1980)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79491 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79491) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79510 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79510) ;
                                  if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                                    if (((operand_79491->mMapTypeName.reader_value ()) != (operand_79510->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79491->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79510->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1986)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79491 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79491) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79510 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79510) ;
                                    if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                                      if (((operand_79491->mClassTypeName.reader_value ()) != (operand_79510->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79491->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79510->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1992)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79491 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79491) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79510 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79510) ;
                                      if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                                        if (((operand_79491->mGalgasClassName.reader_value ()) != (operand_79510->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79491->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79510->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1999)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79491 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79491) ;
                                        cPtr_typeGalgas_enum * operand_79510 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79510) ;
                                        if ((operand_79491 != NULL) && (operand_79510 != NULL)) {
                                          if (((operand_79491->mEnumTypeName.reader_value ()) != (operand_79510->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79491->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79510->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2006)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (2010)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2026)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2028)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_83296 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83395 = var_cas_signatureTestee.firstObject () ;
    while ((operand_83296 != NULL)
        && (operand_83395 != NULL)) {
      macroValidPointer (operand_83296) ;
      macroValidPointer (operand_83395) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_83296->mType,  operand_83395->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2032)) ;
      if (((operand_83296->mFormalArgumentPassingMode) != (operand_83395->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_83395->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_83395->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2035)) ;
      }
      operand_83296 = operand_83296->nextObject () ;
      operand_83395 = operand_83395->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2202)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2210)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2235)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2252)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2294)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2311)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2319)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2351)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_99924 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_99924) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_99924->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2355)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100267 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100267) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100267->mMessagesMap ;
        GGS_L_lstringList  var_cas_100436 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_100436 SOURCE_FILE_AT_LINE (2360)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2366)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102232 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102241 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102232, var_cas_102241 SOURCE_FILE_AT_LINE (2401)) ;
    ...
    GGS_stringset::element_type * operand_102486 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_102486 != NULL)) {
      macroValidPointer (operand_102486) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_102486->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2415)) ;
      operand_102486 = operand_102486->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_102851 = var_cas_modelMap.firstObject () ;
    while ((operand_102851 != NULL)) {
      macroValidPointer (operand_102851) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_102851->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_102851->mKey, operand_102851->mInfo.mType SOURCE_FILE_AT_LINE (2427)) ;
      }
      operand_102851 = operand_102851->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103064 = var_cas_actionMap.firstObject () ;
    while ((operand_103064 != NULL)) {
      macroValidPointer (operand_103064) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_103064->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_103064->mKey, operand_103064->mInfo.mSignature, operand_103064->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2433)) ;
      }
      operand_103064 = operand_103064->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_103867 ;
    GGS_bool var_cas_103870 ;
    GGS_entityPropertyMap  var_cas_103873 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_103867, var_cas_103870, var_cas_103873, var_cas_superEntityName SOURCE_FILE_AT_LINE (2451)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2452)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_104611 = var_cas_inPath.firstObject () ;
  while ((operand_104611 != NULL)) {
    macroValidPointer (operand_104611) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_104611->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_104611->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2478)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_104611->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2484)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_105401 ;
      GGS_entityPropertyMap  var_cas_105404 ;
      GGS_lstring  var_cas_105407 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105401, var_cas_105404, var_cas_105407 SOURCE_FILE_AT_LINE (2489)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_104611->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2492)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_105773 ;
          GGS_lstring  var_cas_105776 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_105773, var_cas_105776 SOURCE_FILE_AT_LINE (2496)) ;
          GGS_bool var_cas_105845 ;
          GGS_entityPropertyMap  var_cas_105848 ;
          GGS_lstring  var_cas_105851 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_105845, var_cas_105848, var_cas_105851 SOURCE_FILE_AT_LINE (2497)) ;
        }else{
          GGS_bool var_cas_105932 ;
          GGS_entityPropertyMap  var_cas_105935 ;
          GGS_lstring  var_cas_105938 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105932, var_cas_105935, var_cas_105938 SOURCE_FILE_AT_LINE (2499)) ;
        }
      }
    }
    operand_104611 = operand_104611->nextObject () ;
  }
}
