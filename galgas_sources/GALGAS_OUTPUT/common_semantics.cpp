...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (820)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (905)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (940)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1037)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1072)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1214)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1223)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1232)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1361)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1363)) ;
  }else{
    GGS_L_signature::element_type * operand_54408 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_54507 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_54408 != NULL)
        && (operand_54507 != NULL)) {
      macroValidPointer (operand_54408) ;
      macroValidPointer (operand_54507) ;
      if (((operand_54408->mFormalArgumentPassingMode) != (operand_54507->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_54507->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_54408->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_54408->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1369)) ;
      }
      if (((operand_54408->mGalgasTypeName.reader_value ()) != (operand_54507->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_54507->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_54408->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_54507->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1372)) ;
      }
      operand_54408 = operand_54408->nextObject () ;
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1687)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1751)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_72306 = mNonExternAttributesList.firstObject () ;
  while ((operand_72306 != NULL)) {
    macroValidPointer (operand_72306) ;
    var_cas_outForeachList.addAssign_operation (operand_72306->mAttributType, operand_72306->aNomAttribut) ;
    operand_72306 = operand_72306->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1778)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1826)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1837)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1846)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1850)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1909)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_78079 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_78098 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_78079 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78079) ;
    cPtr_typeGalgas_stringset * operand_78098 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78098) ;
    if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_78079 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78079) ;
      cPtr_typeGalgas_uint * operand_78098 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78098) ;
      if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_78079 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78079) ;
        cPtr_typeGalgas_sint * operand_78098 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78098) ;
        if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_78079 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78079) ;
          cPtr_typeGalgas_char * operand_78098 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78098) ;
          if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_78079 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78079) ;
            cPtr_typeGalgas_string * operand_78098 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78098) ;
            if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_78079 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78079) ;
              cPtr_typeGalgas_bool * operand_78098 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78098) ;
              if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_78079 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78079) ;
                cPtr_typeGalgas_double * operand_78098 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78098) ;
                if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_78079 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78079) ;
                  cPtr_typeGalgas_lbool * operand_78098 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78098) ;
                  if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_78079 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78079) ;
                    cPtr_typeGalgas_lchar * operand_78098 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78098) ;
                    if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_78079 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78079) ;
                      cPtr_typeGalgas_luint * operand_78098 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78098) ;
                      if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_78079 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78079) ;
                        cPtr_typeGalgas_lsint * operand_78098 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78098) ;
                        if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_78079 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78079) ;
                          cPtr_typeGalgas_ldouble * operand_78098 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78098) ;
                          if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_78079 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78079) ;
                            cPtr_typeGalgas_lstring * operand_78098 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78098) ;
                            if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_78079 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78079) ;
                              cPtr_typeGalgas_location * operand_78098 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78098) ;
                              if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_78079 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78079) ;
                                cPtr_typeGalgasUndefinedListType * operand_78098 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78098) ;
                                if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                                  if (((operand_78079->mListTypeName.reader_value ()) != (operand_78098->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_78079->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_78098->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1946)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_78079 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78079) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_78098 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78098) ;
                                  if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                                    if (((operand_78079->mMapTypeName.reader_value ()) != (operand_78098->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_78079->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_78098->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1952)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_78079 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78079) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_78098 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78098) ;
                                    if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                                      if (((operand_78079->mClassTypeName.reader_value ()) != (operand_78098->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_78079->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_78098->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1958)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_78079 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78079) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_78098 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78098) ;
                                      if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                                        if (((operand_78079->mGalgasClassName.reader_value ()) != (operand_78098->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_78079->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_78098->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1965)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_78079 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78079) ;
                                        cPtr_typeGalgas_enum * operand_78098 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78098) ;
                                        if ((operand_78079 != NULL) && (operand_78098 != NULL)) {
                                          if (((operand_78079->mEnumTypeName.reader_value ()) != (operand_78098->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_78079->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_78098->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1972)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1976)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1992)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1994)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_81884 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_81983 = var_cas_signatureTestee.firstObject () ;
    while ((operand_81884 != NULL)
        && (operand_81983 != NULL)) {
      macroValidPointer (operand_81884) ;
      macroValidPointer (operand_81983) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_81884->mType,  operand_81983->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1998)) ;
      if (((operand_81884->mFormalArgumentPassingMode) != (operand_81983->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_81983->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_81983->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2001)) ;
      }
      operand_81884 = operand_81884->nextObject () ;
      operand_81983 = operand_81983->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2165)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2176)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2201)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2212)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2226)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2248)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2267)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2280)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_96523 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96523) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96523->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2284)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_96866 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96866) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96866->mMessagesMap ;
        GGS_L_lstringList  var_cas_97035 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_97035 SOURCE_FILE_AT_LINE (2289)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2295)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_98831 ;
    GGS_M_semanticsEntitiesForUse  var_cas_98840 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_98831, var_cas_98840 SOURCE_FILE_AT_LINE (2330)) ;
    ...
    GGS_stringset::element_type * operand_99085 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_99085 != NULL)) {
      macroValidPointer (operand_99085) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_99085->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2344)) ;
      operand_99085 = operand_99085->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_99450 = var_cas_modelMap.firstObject () ;
    while ((operand_99450 != NULL)) {
      macroValidPointer (operand_99450) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_99450->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_99450->mKey, operand_99450->mInfo.mType SOURCE_FILE_AT_LINE (2356)) ;
      }
      operand_99450 = operand_99450->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_99663 = var_cas_actionMap.firstObject () ;
    while ((operand_99663 != NULL)) {
      macroValidPointer (operand_99663) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_99663->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_99663->mKey, operand_99663->mInfo.mSignature, operand_99663->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2362)) ;
      }
      operand_99663 = operand_99663->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_100466 ;
    GGS_bool var_cas_100469 ;
    GGS_entityPropertyMap  var_cas_100472 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_100466, var_cas_100469, var_cas_100472, var_cas_superEntityName SOURCE_FILE_AT_LINE (2380)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2381)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_101210 = var_cas_inPath.firstObject () ;
  while ((operand_101210 != NULL)) {
    macroValidPointer (operand_101210) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_101210->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_101210->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2407)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_101210->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2413)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_102000 ;
      GGS_entityPropertyMap  var_cas_102003 ;
      GGS_lstring  var_cas_102006 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102000, var_cas_102003, var_cas_102006 SOURCE_FILE_AT_LINE (2418)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_101210->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2421)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_102372 ;
          GGS_lstring  var_cas_102375 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_102372, var_cas_102375 SOURCE_FILE_AT_LINE (2425)) ;
          GGS_bool var_cas_102444 ;
          GGS_entityPropertyMap  var_cas_102447 ;
          GGS_lstring  var_cas_102450 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_102444, var_cas_102447, var_cas_102450 SOURCE_FILE_AT_LINE (2426)) ;
        }else{
          GGS_bool var_cas_102531 ;
          GGS_entityPropertyMap  var_cas_102534 ;
          GGS_lstring  var_cas_102537 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102531, var_cas_102534, var_cas_102537 SOURCE_FILE_AT_LINE (2428)) ;
        }
      }
    }
    operand_101210 = operand_101210->nextObject () ;
  }
}
