...
methode_acceptAssignmentFromHere (C_Lexique & _inLexique,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "assignment from 'here' is not allowed for variables of this type") SOURCE_FILE_AT_LINE (376)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be enumerated by in 'foreach' instruction") SOURCE_FILE_AT_LINE (386)) ;
}
...
methode_acceptToBeKeyForMap (C_Lexique & _inLexique) {
    GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this type cannot be a key for map") SOURCE_FILE_AT_LINE (391)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
    ...
    var_cas_inModifierName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (400)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
    ...
    var_cas_inReaderName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader instruction") SOURCE_FILE_AT_LINE (410)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
    ...
    var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (418)) ;
}
...
methode_handleAddAssignOperatorCall (C_Lexique & _inLexique,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (429)) ;
}
...
methode_handleIncrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (437)) ;
}
...
methode_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & _inLexique) {
    GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (443)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (817)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (902)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (937)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (968)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (999)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1034)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1069)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1100)) ;
  }
}
...
void GGS_typeTableMethodes::methode_insertAbstract (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                const GGS_L_EXsignature &  inParameter0 COMMA_LOCATION_ARGS) {
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  insertAbstract (_inLexique, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

void GGS_typeTableMethodes::methode_insertAbstractGetIndex (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_EXsignature &  inParameter0 COMMA_LOCATION_ARGS) {
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertAbstract (_inLexique, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}

//---------------------------------------------------------------------------*

void GGS_typeTableMethodes::methode_insertNotAbstract (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                const GGS_L_EXsignature &  inParameter0 COMMA_LOCATION_ARGS) {
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  insertNotAbstract (_inLexique, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

void GGS_typeTableMethodes::methode_insertNotAbstractGetIndex (C_Lexique & _inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_EXsignature &  inParameter0 COMMA_LOCATION_ARGS) {
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertNotAbstract (_inLexique, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_constructorMap.methode_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1211)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1220)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1229)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1359)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1361)) ;
  }else{
    GGS_L_signature::element_type * operand_54507 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_54606 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_54507 != NULL)
        && (operand_54606 != NULL)) {
      macroValidPointer (operand_54507) ;
      macroValidPointer (operand_54606) ;
      if (((operand_54507->mFormalArgumentPassingMode) != (operand_54606->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_54606->mGalgasTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_54507->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_54507->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1367)) ;
      }
      if (((operand_54507->mGalgasTypeName.reader_value ()) != (operand_54606->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_54606->mGalgasTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_54507->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_54606->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1370)) ;
      }
      operand_54507 = operand_54507->nextObject () ;
      operand_54606 = operand_54606->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1685)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1749)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_72403 = mNonExternAttributesList.firstObject () ;
  while ((operand_72403 != NULL)) {
    macroValidPointer (operand_72403) ;
    var_cas_outForeachList.addAssign_operation (operand_72403->mAttributType, operand_72403->aNomAttribut) ;
    operand_72403 = operand_72403->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1776)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & _inLexique) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1824)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1835)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1844)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1848)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_enumConstantesMap.methode_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1907)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_78176 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_78195 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_78176 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78176) ;
    cPtr_typeGalgas_stringset * operand_78195 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78195) ;
    if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_78176 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78176) ;
      cPtr_typeGalgas_uint * operand_78195 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78195) ;
      if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_78176 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78176) ;
        cPtr_typeGalgas_sint * operand_78195 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78195) ;
        if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_78176 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78176) ;
          cPtr_typeGalgas_char * operand_78195 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78195) ;
          if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_78176 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78176) ;
            cPtr_typeGalgas_string * operand_78195 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78195) ;
            if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_78176 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78176) ;
              cPtr_typeGalgas_bool * operand_78195 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78195) ;
              if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_78176 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78176) ;
                cPtr_typeGalgas_double * operand_78195 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78195) ;
                if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_78176 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78176) ;
                  cPtr_typeGalgas_lbool * operand_78195 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78195) ;
                  if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_78176 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78176) ;
                    cPtr_typeGalgas_lchar * operand_78195 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78195) ;
                    if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_78176 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78176) ;
                      cPtr_typeGalgas_luint * operand_78195 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78195) ;
                      if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_78176 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78176) ;
                        cPtr_typeGalgas_lsint * operand_78195 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78195) ;
                        if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_78176 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78176) ;
                          cPtr_typeGalgas_ldouble * operand_78195 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78195) ;
                          if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_78176 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78176) ;
                            cPtr_typeGalgas_lstring * operand_78195 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78195) ;
                            if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_78176 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78176) ;
                              cPtr_typeGalgas_location * operand_78195 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78195) ;
                              if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_78176 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78176) ;
                                cPtr_typeGalgasUndefinedListType * operand_78195 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78195) ;
                                if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                                  if (((operand_78176->mListTypeName.reader_value ()) != (operand_78195->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_78176->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_78195->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1944)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_78176 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78176) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_78195 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78195) ;
                                  if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                                    if (((operand_78176->mMapTypeName.reader_value ()) != (operand_78195->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_78176->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_78195->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1950)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_78176 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78176) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_78195 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78195) ;
                                    if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                                      if (((operand_78176->mClassTypeName.reader_value ()) != (operand_78195->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_78176->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_78195->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1956)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_78176 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78176) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_78195 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78195) ;
                                      if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                                        if (((operand_78176->mGalgasClassName.reader_value ()) != (operand_78195->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_78176->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_78195->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1963)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_78176 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78176) ;
                                        cPtr_typeGalgas_enum * operand_78195 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78195) ;
                                        if ((operand_78176 != NULL) && (operand_78195 != NULL)) {
                                          if (((operand_78176->mEnumTypeName.reader_value ()) != (operand_78195->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_78176->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_78195->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1970)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1974)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1990)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1992)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_81981 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_82080 = var_cas_signatureTestee.firstObject () ;
    while ((operand_81981 != NULL)
        && (operand_82080 != NULL)) {
      macroValidPointer (operand_81981) ;
      macroValidPointer (operand_82080) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_81981->mType,  operand_82080->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1996)) ;
      if (((operand_81981->mFormalArgumentPassingMode) != (operand_82080->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, ((((operand_82080->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_82080->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (1999)) ;
      }
      operand_81981 = operand_81981->nextObject () ;
      operand_82080 = operand_82080->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2166)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2174)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2185)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2199)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2213)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2224)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2238)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2255)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2272)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2280)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2296)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2309)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_98248 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_98248) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_98248->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2313)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_98591 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_98591) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_98591->mMessagesMap ;
        GGS_L_lstringList  var_cas_98760 ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_98760 SOURCE_FILE_AT_LINE (2318)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2324)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_100556 ;
    GGS_M_semanticsEntitiesForUse  var_cas_100565 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_100556, var_cas_100565 SOURCE_FILE_AT_LINE (2359)) ;
    ...
    GGS_stringset::element_type * operand_100810 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_100810 != NULL)) {
      macroValidPointer (operand_100810) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_100810->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2373)) ;
      operand_100810 = operand_100810->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_101175 = var_cas_modelMap.firstObject () ;
    while ((operand_101175 != NULL)) {
      macroValidPointer (operand_101175) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_101175->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (_inLexique, operand_101175->mKey, operand_101175->mInfo.mType SOURCE_FILE_AT_LINE (2385)) ;
      }
      operand_101175 = operand_101175->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_101388 = var_cas_actionMap.firstObject () ;
    while ((operand_101388 != NULL)) {
      macroValidPointer (operand_101388) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_101388->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (_inLexique, operand_101388->mKey, operand_101388->mInfo.mSignature, operand_101388->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2391)) ;
      }
      operand_101388 = operand_101388->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_102191 ;
    GGS_bool var_cas_102194 ;
    GGS_entityPropertyMap  var_cas_102197 ;
    var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_102191, var_cas_102194, var_cas_102197, var_cas_superEntityName SOURCE_FILE_AT_LINE (2409)) ;
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2410)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_102935 = var_cas_inPath.firstObject () ;
  while ((operand_102935 != NULL)) {
    macroValidPointer (operand_102935) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_102935->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_102935->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2436)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_102935->mPathElement.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2442)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_103725 ;
      GGS_entityPropertyMap  var_cas_103728 ;
      GGS_lstring  var_cas_103731 ;
      var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_103725, var_cas_103728, var_cas_103731 SOURCE_FILE_AT_LINE (2447)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (_inLexique, operand_102935->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2450)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_104097 ;
          GGS_lstring  var_cas_104100 ;
          var_cas_ioMapEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_104097, var_cas_104100 SOURCE_FILE_AT_LINE (2454)) ;
          GGS_bool var_cas_104169 ;
          GGS_entityPropertyMap  var_cas_104172 ;
          GGS_lstring  var_cas_104175 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_104169, var_cas_104172, var_cas_104175 SOURCE_FILE_AT_LINE (2455)) ;
        }else{
          GGS_bool var_cas_104256 ;
          GGS_entityPropertyMap  var_cas_104259 ;
          GGS_lstring  var_cas_104262 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_104256, var_cas_104259, var_cas_104262 SOURCE_FILE_AT_LINE (2457)) ;
        }
      }
    }
    operand_102935 = operand_102935->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_104577 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_104577 != NULL)) {
    macroValidPointer (operand_104577) ;
    if (((((operand_104577->mInfo.mSuperEntityName.reader_value ()) == (var_cas_inEntityName.reader_value ())) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (var_cas_inEntityName.reader_value ())))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_104577->mKey.reader_value ()) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_104577->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2474)) ;
    }
    operand_104577 = operand_104577->nextObject () ;
  }
}
