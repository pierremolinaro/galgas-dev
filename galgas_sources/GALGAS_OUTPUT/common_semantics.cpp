...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34275 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34374 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34275 != NULL)
        && (operand_34374 != NULL)) {
      macroValidPointer (operand_34275) ;
      macroValidPointer (operand_34374) ;
      if (((operand_34275->mFormalArgumentPassingMode) != (operand_34374->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34374->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34275->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34275->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34275->mGalgasTypeName.reader_value ()) != (operand_34374->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34374->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34275->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34374->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34275 = operand_34275->nextObject () ;
      operand_34374 = operand_34374->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53919 = mNonExternAttributesList.firstObject () ;
  while ((operand_53919 != NULL)) {
    macroValidPointer (operand_53919) ;
    var_cas_outForeachList.addAssign_operation (operand_53919->mAttributType, operand_53919->aNomAttribut) ;
    operand_53919 = operand_53919->nextObject () ;
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60469 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_60488 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_60469 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60469) ;
    cPtr_typeGalgas_uint * operand_60488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60488) ;
    if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_60469 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60469) ;
      cPtr_typeGalgas_sint * operand_60488 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60488) ;
      if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_60469 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60469) ;
        cPtr_typeGalgas_char * operand_60488 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60488) ;
        if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_60469 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60469) ;
          cPtr_typeGalgas_string * operand_60488 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60488) ;
          if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_60469 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60469) ;
            cPtr_typeGalgas_bool * operand_60488 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60488) ;
            if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_60469 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60469) ;
              cPtr_typeGalgas_double * operand_60488 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60488) ;
              if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_60469 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60469) ;
                cPtr_typeGalgas_lbool * operand_60488 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60488) ;
                if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_60469 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60469) ;
                  cPtr_typeGalgas_lchar * operand_60488 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60488) ;
                  if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_60469 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60469) ;
                    cPtr_typeGalgas_luint * operand_60488 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60488) ;
                    if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_60469 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60469) ;
                      cPtr_typeGalgas_lsint * operand_60488 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60488) ;
                      if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_60469 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60469) ;
                        cPtr_typeGalgas_ldouble * operand_60488 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60488) ;
                        if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_60469 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60469) ;
                          cPtr_typeGalgas_lstring * operand_60488 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60488) ;
                          if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_60469 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60469) ;
                            cPtr_typeGalgas_location * operand_60488 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60488) ;
                            if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_60469 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60469) ;
                              cPtr_typeGalgasUndefinedListType * operand_60488 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60488) ;
                              if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                                if (((operand_60469->mListTypeName.reader_value ()) != (operand_60488->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60469->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60488->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_60469 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60469) ;
                                cPtr_typeGalgasUndefinedMapType * operand_60488 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60488) ;
                                if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                                  if (((operand_60469->mMapTypeName.reader_value ()) != (operand_60488->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60469->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60488->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_60469 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60469) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_60488 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60488) ;
                                  if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                                    if (((operand_60469->mClassTypeName.reader_value ()) != (operand_60488->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60469->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60488->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_60469 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60469) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_60488 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60488) ;
                                    if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                                      if (((operand_60469->mGalgasClassName.reader_value ()) != (operand_60488->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60469->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60488->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_60469 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60469) ;
                                      cPtr_typeGalgas_enum * operand_60488 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60488) ;
                                      if ((operand_60469 != NULL) && (operand_60488 != NULL)) {
                                        if (((operand_60469->mEnumTypeName.reader_value ()) != (operand_60488->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60469->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60488->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_64209 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64308 = var_cas_signatureTestee.firstObject () ;
    while ((operand_64209 != NULL)
        && (operand_64308 != NULL)) {
      macroValidPointer (operand_64209) ;
      macroValidPointer (operand_64308) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_64209->mType,  operand_64308->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_64209->mFormalArgumentPassingMode) != (operand_64308->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64308->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64308->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_64209 = operand_64209->nextObject () ;
      operand_64308 = operand_64308->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_74422 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74422) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74422->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74755 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74755) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74755->mMessagesMap ;
      GGS_L_lstringList  var_cas_74920 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_74920) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
