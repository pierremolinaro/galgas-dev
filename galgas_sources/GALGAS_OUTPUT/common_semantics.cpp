...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1941)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap.isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1949)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79822 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79841 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79822 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79822) ;
    cPtr_typeGalgas_stringset * operand_79841 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79841) ;
    if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79822 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79822) ;
      cPtr_typeGalgas_uint * operand_79841 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79841) ;
      if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79822 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79822) ;
        cPtr_typeGalgas_sint * operand_79841 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79841) ;
        if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79822 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79822) ;
          cPtr_typeGalgas_char * operand_79841 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79841) ;
          if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79822 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79822) ;
            cPtr_typeGalgas_string * operand_79841 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79841) ;
            if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79822 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79822) ;
              cPtr_typeGalgas_bool * operand_79841 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79841) ;
              if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79822 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79822) ;
                cPtr_typeGalgas_double * operand_79841 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79841) ;
                if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79822 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79822) ;
                  cPtr_typeGalgas_lbool * operand_79841 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79841) ;
                  if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79822 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79822) ;
                    cPtr_typeGalgas_lchar * operand_79841 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79841) ;
                    if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79822 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79822) ;
                      cPtr_typeGalgas_luint * operand_79841 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79841) ;
                      if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79822 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79822) ;
                        cPtr_typeGalgas_lsint * operand_79841 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79841) ;
                        if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79822 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79822) ;
                          cPtr_typeGalgas_ldouble * operand_79841 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79841) ;
                          if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79822 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79822) ;
                            cPtr_typeGalgas_lstring * operand_79841 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79841) ;
                            if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79822 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79822) ;
                              cPtr_typeGalgas_location * operand_79841 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79841) ;
                              if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79822 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79822) ;
                                cPtr_typeGalgasUndefinedListType * operand_79841 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79841) ;
                                if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                                  if (((operand_79822->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1984))) != (operand_79841->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1984)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79822->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1985))))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79841->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1986))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1986)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79822 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79822) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79841 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79841) ;
                                  if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                                    if (((operand_79822->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1990))) != (operand_79841->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1990)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79822->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1991))))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79841->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1992))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1992)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79822 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79822) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79841 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79841) ;
                                    if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                                      if (((operand_79822->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1996))) != (operand_79841->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1996)))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79822->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1997))))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79841->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1998))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1998)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79822 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79822) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79841 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79841) ;
                                      if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                                        if (((operand_79822->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2003))) != (operand_79841->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2003)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79822->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2004))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79841->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2005))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2005)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79822 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79822) ;
                                        cPtr_typeGalgas_enum * operand_79841 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79841) ;
                                        if ((operand_79822 != NULL) && (operand_79841 != NULL)) {
                                          if (((operand_79822->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2010))) != (operand_79841->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2010)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79822->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2011))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79841->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2012))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2012)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2016))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2016)))) SOURCE_FILE_AT_LINE (2016)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2031))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2031)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2032)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2033))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2033)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2034)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_83627 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83726 = var_cas_signatureTestee.firstObject () ;
    while ((operand_83627 != NULL)
        && (operand_83726 != NULL)) {
      macroValidPointer (operand_83627) ;
      macroValidPointer (operand_83726) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_83627->mType,  operand_83726->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2038)) ;
      if (((operand_83627->mFormalArgumentPassingMode) != (operand_83726->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_83726->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2040))) + (GGS_string (true, " is not compatible with ")))) + (operand_83726->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2041)))) SOURCE_FILE_AT_LINE (2041)) ;
      }
      operand_83627 = operand_83627->nextObject () ;
      operand_83726 = operand_83726->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2174))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2180))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2183))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2186))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2189))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2192))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2195))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2198))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2201))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2208)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2211))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2216)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2219))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2222))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2227)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2230))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2233))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2238)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2241))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2244))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2247))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2252)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2255))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2258))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2261))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2266)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2269))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2272))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2277)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2280))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2283))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2286))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2291)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2294))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2297))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2300))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2303))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2308)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2311))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2314))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2317))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2320))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2325)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2328))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2333)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2336))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2341))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2344))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2352))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2357))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2362)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_100565 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100565) ; 
        if (operand_100565->mMessagesMap.isBuilt ()) {
          operand_100565->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2365)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100844 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100844) ; 
        GGS_L_lstringList  var_cas_100956 ;
        if (operand_100844->mMessagesMap.isBuilt ()) {
          operand_100844->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_100956 SOURCE_FILE_AT_LINE (2369)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2375)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2403)) SOURCE_FILE_AT_LINE (2403))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102754 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102763 ;
    if (var_cas_ioSemanticsComponentsMap.isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102754, var_cas_102763 SOURCE_FILE_AT_LINE (2410)) ;
    }
    ...
    GGS_stringset::element_type * operand_103008 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_103008 != NULL)) {
      macroValidPointer (operand_103008) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_103008->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2424)) ;
      operand_103008 = operand_103008->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_103373 = var_cas_modelMap.firstObject () ;
    while ((operand_103373 != NULL)) {
      macroValidPointer (operand_103373) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_103373->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2435)) SOURCE_FILE_AT_LINE (2435))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_103373->mKey, operand_103373->mInfo.mType SOURCE_FILE_AT_LINE (2436)) ;
      }
      operand_103373 = operand_103373->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103586 = var_cas_actionMap.firstObject () ;
    while ((operand_103586 != NULL)) {
      macroValidPointer (operand_103586) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_103586->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2441)) SOURCE_FILE_AT_LINE (2441))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_103586->mKey, operand_103586->mInfo.mSignature, operand_103586->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2442)) ;
      }
      operand_103586 = operand_103586->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents.addAssign_operation (var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2446))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2457))) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2457)) SOURCE_FILE_AT_LINE (2457))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2458))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_104387 ;
    GGS_bool var_cas_104390 ;
    GGS_entityPropertyMap  var_cas_104393 ;
    if (var_cas_ioEntityMap.isBuilt ()) {
      var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_104387, var_cas_104390, var_cas_104393, var_cas_superEntityName SOURCE_FILE_AT_LINE (2460)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2461)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_105131 = var_cas_inPath.firstObject () ;
  while ((operand_105131 != NULL)) {
    macroValidPointer (operand_105131) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_105131->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2482)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2482)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_105131->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2485)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2487)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2491)) SOURCE_FILE_AT_LINE (2491))))).isBuiltAndTrue ()) {
          operand_105131->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2493))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2493)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_105922 ;
      GGS_entityPropertyMap  var_cas_105925 ;
      GGS_lstring  var_cas_105928 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_105922, var_cas_105925, var_cas_105928 SOURCE_FILE_AT_LINE (2498)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap.isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_105131->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2501)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2503)) SOURCE_FILE_AT_LINE (2503))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_106290 ;
          GGS_lstring  var_cas_106293 ;
          if (var_cas_ioMapEntityMap.isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_106290, var_cas_106293 SOURCE_FILE_AT_LINE (2505)) ;
          }
          GGS_bool var_cas_106360 ;
          GGS_entityPropertyMap  var_cas_106363 ;
          GGS_lstring  var_cas_106366 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_106360, var_cas_106363, var_cas_106366 SOURCE_FILE_AT_LINE (2506)) ;
          }
        }else{
          GGS_bool var_cas_106445 ;
          GGS_entityPropertyMap  var_cas_106448 ;
          GGS_lstring  var_cas_106451 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_106445, var_cas_106448, var_cas_106451 SOURCE_FILE_AT_LINE (2508)) ;
          }
        }
      }
    }
    operand_105131 = operand_105131->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_106766 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_106766 != NULL)) {
    macroValidPointer (operand_106766) ;
    if (((((operand_106766->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2523))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2523)))) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2523)) SOURCE_FILE_AT_LINE (2523))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_106766->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2524))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_106766->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2525)) ;
    }
    operand_106766 = operand_106766->nextObject () ;
  }
}
