...
void GGS_M_externClassesDirectories::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the extern class '%K' has been already declared in %L",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_41472 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_41571 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_41472 != NULL)
        && (operand_41571 != NULL)) {
      macroValidPointer (operand_41472) ;
      macroValidPointer (operand_41571) ;
      if (((operand_41472->mFormalArgumentPassingMode) != (operand_41571->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_41571->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_41472->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_41472->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_41472->mGalgasTypeName.reader_value ()) != (operand_41571->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_41571->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_41472->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_41571->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_41472 = operand_41472->nextObject () ;
      operand_41571 = operand_41571->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_58679 = mNonExternAttributesList.firstObject () ;
  while ((operand_58679 != NULL)) {
    macroValidPointer (operand_58679) ;
    var_cas_outForeachList.addAssign_operation (operand_58679->mAttributType, operand_58679->aNomAttribut) ;
    operand_58679 = operand_58679->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_64452 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_64471 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_64452 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_64452) ;
    cPtr_typeGalgas_stringset * operand_64471 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_64471) ;
    if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_64452 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_64452) ;
      cPtr_typeGalgas_uint * operand_64471 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_64471) ;
      if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_64452 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_64452) ;
        cPtr_typeGalgas_sint * operand_64471 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_64471) ;
        if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_64452 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_64452) ;
          cPtr_typeGalgas_char * operand_64471 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_64471) ;
          if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_64452 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_64452) ;
            cPtr_typeGalgas_string * operand_64471 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_64471) ;
            if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_64452 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_64452) ;
              cPtr_typeGalgas_bool * operand_64471 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_64471) ;
              if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_64452 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_64452) ;
                cPtr_typeGalgas_double * operand_64471 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_64471) ;
                if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_64452 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_64452) ;
                  cPtr_typeGalgas_lbool * operand_64471 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_64471) ;
                  if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_64452 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_64452) ;
                    cPtr_typeGalgas_lchar * operand_64471 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_64471) ;
                    if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_64452 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_64452) ;
                      cPtr_typeGalgas_luint * operand_64471 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_64471) ;
                      if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_64452 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_64452) ;
                        cPtr_typeGalgas_lsint * operand_64471 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_64471) ;
                        if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_64452 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_64452) ;
                          cPtr_typeGalgas_ldouble * operand_64471 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_64471) ;
                          if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_64452 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_64452) ;
                            cPtr_typeGalgas_lstring * operand_64471 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_64471) ;
                            if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_64452 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_64452) ;
                              cPtr_typeGalgas_location * operand_64471 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_64471) ;
                              if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_64452 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_64452) ;
                                cPtr_typeGalgasUndefinedListType * operand_64471 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_64471) ;
                                if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                                  if (((operand_64452->mListTypeName.reader_value ()) != (operand_64471->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_64452->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_64471->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_64452 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_64452) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_64471 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_64471) ;
                                  if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                                    if (((operand_64452->mMapTypeName.reader_value ()) != (operand_64471->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_64452->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_64471->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_64452 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_64452) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_64471 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_64471) ;
                                    if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                                      if (((operand_64452->mClassTypeName.reader_value ()) != (operand_64471->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_64452->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_64471->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_64452 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_64452) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_64471 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_64471) ;
                                      if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                                        if (((operand_64452->mGalgasClassName.reader_value ()) != (operand_64471->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_64452->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_64471->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_64452 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_64452) ;
                                        cPtr_typeGalgas_enum * operand_64471 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_64471) ;
                                        if ((operand_64452 != NULL) && (operand_64471 != NULL)) {
                                          if (((operand_64452->mEnumTypeName.reader_value ()) != (operand_64471->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_64452->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_64471->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_68257 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_68356 = var_cas_signatureTestee.firstObject () ;
    while ((operand_68257 != NULL)
        && (operand_68356 != NULL)) {
      macroValidPointer (operand_68257) ;
      macroValidPointer (operand_68356) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_68257->mType,  operand_68356->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_68257->mFormalArgumentPassingMode) != (operand_68356->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_68356->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_68356->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_68257 = operand_68257->nextObject () ;
      operand_68356 = operand_68356->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_80267 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_80267) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_80267->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_80600 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_80600) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_80600->mMessagesMap ;
      GGS_L_lstringList  var_cas_80765 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_80765) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
