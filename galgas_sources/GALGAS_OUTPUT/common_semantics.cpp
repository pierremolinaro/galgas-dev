...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34487 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34586 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34487 != NULL)
        && (operand_34586 != NULL)) {
      macroValidPointer (operand_34487) ;
      macroValidPointer (operand_34586) ;
      if (((operand_34487->mFormalArgumentPassingMode) != (operand_34586->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34586->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34487->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34487->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34487->mGalgasTypeName.reader_value ()) != (operand_34586->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34586->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34487->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34586->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34487 = operand_34487->nextObject () ;
      operand_34586 = operand_34586->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53621 = mNonExternAttributesList.firstObject () ;
  while ((operand_53621 != NULL)) {
    macroValidPointer (operand_53621) ;
    var_cas_outForeachList.addAssign_operation (operand_53621->mAttributType, operand_53621->aNomAttribut) ;
    operand_53621 = operand_53621->nextObject () ;
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60231 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_60250 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_60231 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60231) ;
    cPtr_typeGalgas_uint * operand_60250 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60250) ;
    if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_60231 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60231) ;
      cPtr_typeGalgas_sint * operand_60250 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60250) ;
      if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_60231 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60231) ;
        cPtr_typeGalgas_char * operand_60250 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60250) ;
        if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_60231 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60231) ;
          cPtr_typeGalgas_string * operand_60250 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60250) ;
          if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_60231 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60231) ;
            cPtr_typeGalgas_bool * operand_60250 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60250) ;
            if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_60231 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60231) ;
              cPtr_typeGalgas_double * operand_60250 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60250) ;
              if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_60231 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60231) ;
                cPtr_typeGalgas_lbool * operand_60250 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60250) ;
                if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_60231 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60231) ;
                  cPtr_typeGalgas_lchar * operand_60250 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60250) ;
                  if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_60231 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60231) ;
                    cPtr_typeGalgas_luint * operand_60250 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60250) ;
                    if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_60231 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60231) ;
                      cPtr_typeGalgas_lsint * operand_60250 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60250) ;
                      if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_60231 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60231) ;
                        cPtr_typeGalgas_ldouble * operand_60250 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60250) ;
                        if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_60231 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60231) ;
                          cPtr_typeGalgas_lstring * operand_60250 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60250) ;
                          if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_60231 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60231) ;
                            cPtr_typeGalgas_location * operand_60250 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60250) ;
                            if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_60231 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60231) ;
                              cPtr_typeGalgasUndefinedListType * operand_60250 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60250) ;
                              if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                                if (((operand_60231->mListTypeName.reader_value ()) != (operand_60250->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60231->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60250->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_60231 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60231) ;
                                cPtr_typeGalgasUndefinedMapType * operand_60250 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60250) ;
                                if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                                  if (((operand_60231->mMapTypeName.reader_value ()) != (operand_60250->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60231->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60250->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_60231 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60231) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_60250 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60250) ;
                                  if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                                    if (((operand_60231->mClassTypeName.reader_value ()) != (operand_60250->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60231->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60250->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_60231 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60231) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_60250 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60250) ;
                                    if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                                      if (((operand_60231->mGalgasClassName.reader_value ()) != (operand_60250->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60231->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60250->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_60231 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60231) ;
                                      cPtr_typeGalgas_enum * operand_60250 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60250) ;
                                      if ((operand_60231 != NULL) && (operand_60250 != NULL)) {
                                        if (((operand_60231->mEnumTypeName.reader_value ()) != (operand_60250->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60231->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60250->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_63971 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64070 = var_cas_signatureTestee.firstObject () ;
    while ((operand_63971 != NULL)
        && (operand_64070 != NULL)) {
      macroValidPointer (operand_63971) ;
      macroValidPointer (operand_64070) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_63971->mType,  operand_64070->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_63971->mFormalArgumentPassingMode) != (operand_64070->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64070->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64070->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_63971 = operand_63971->nextObject () ;
      operand_64070 = operand_64070->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_73637 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73637) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_73637->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_74248 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74248) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74248->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74586 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74586) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74586->mMessagesMap ;
