...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66514 = mNonExternAttributesList.firstObject () ;
  while ((operand_66514 != NULL)) {
    macroValidPointer (operand_66514) ;
    var_cas_outForeachList.addAssign_operation (operand_66514->mAttributType, operand_66514->aNomAttribut) ;
    operand_66514 = operand_66514->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72287 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72306 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72287 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72287) ;
    cPtr_typeGalgas_stringset * operand_72306 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72306) ;
    if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72287 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72287) ;
      cPtr_typeGalgas_uint * operand_72306 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72306) ;
      if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72287 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72287) ;
        cPtr_typeGalgas_sint * operand_72306 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72306) ;
        if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72287 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72287) ;
          cPtr_typeGalgas_char * operand_72306 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72306) ;
          if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72287 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72287) ;
            cPtr_typeGalgas_string * operand_72306 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72306) ;
            if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72287 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72287) ;
              cPtr_typeGalgas_bool * operand_72306 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72306) ;
              if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72287 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72287) ;
                cPtr_typeGalgas_double * operand_72306 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72306) ;
                if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72287 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72287) ;
                  cPtr_typeGalgas_lbool * operand_72306 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72306) ;
                  if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72287 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72287) ;
                    cPtr_typeGalgas_lchar * operand_72306 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72306) ;
                    if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72287 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72287) ;
                      cPtr_typeGalgas_luint * operand_72306 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72306) ;
                      if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72287 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72287) ;
                        cPtr_typeGalgas_lsint * operand_72306 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72306) ;
                        if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72287 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72287) ;
                          cPtr_typeGalgas_ldouble * operand_72306 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72306) ;
                          if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72287 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72287) ;
                            cPtr_typeGalgas_lstring * operand_72306 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72306) ;
                            if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72287 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72287) ;
                              cPtr_typeGalgas_location * operand_72306 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72306) ;
                              if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72287 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72287) ;
                                cPtr_typeGalgasUndefinedListType * operand_72306 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72306) ;
                                if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                                  if (((operand_72287->mListTypeName.reader_value ()) != (operand_72306->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72287->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72306->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72287 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72287) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72306 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72306) ;
                                  if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                                    if (((operand_72287->mMapTypeName.reader_value ()) != (operand_72306->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72287->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72306->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72287 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72287) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72306 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72306) ;
                                    if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                                      if (((operand_72287->mClassTypeName.reader_value ()) != (operand_72306->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72287->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72306->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72287 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72287) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72306 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72306) ;
                                      if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                                        if (((operand_72287->mGalgasClassName.reader_value ()) != (operand_72306->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72287->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72306->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72287 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72287) ;
                                        cPtr_typeGalgas_enum * operand_72306 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72306) ;
                                        if ((operand_72287 != NULL) && (operand_72306 != NULL)) {
                                          if (((operand_72287->mEnumTypeName.reader_value ()) != (operand_72306->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72287->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72306->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_76092 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_76191 = var_cas_signatureTestee.firstObject () ;
    while ((operand_76092 != NULL)
        && (operand_76191 != NULL)) {
      macroValidPointer (operand_76092) ;
      macroValidPointer (operand_76191) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_76092->mType,  operand_76191->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_76092->mFormalArgumentPassingMode) != (operand_76191->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_76191->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_76191->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_76092 = operand_76092->nextObject () ;
      operand_76191 = operand_76191->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_89380 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89380) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89380->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_89723 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89723) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89723->mMessagesMap ;
        GGS_L_lstringList  var_cas_89892 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_89892) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_91688 ;
    GGS_M_semanticsEntitiesForUse  var_cas_91697 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_91688, var_cas_91697) ;
    ...
    GGS_stringset::element_type * operand_91942 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_91942 != NULL)) {
      macroValidPointer (operand_91942) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_91942->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_91942 = operand_91942->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_92307 = var_cas_modelMap.firstObject () ;
    while ((operand_92307 != NULL)) {
      macroValidPointer (operand_92307) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_92307->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_92307->mKey, operand_92307->mInfo.mType) ;
      }
      operand_92307 = operand_92307->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_92520 = var_cas_actionMap.firstObject () ;
    while ((operand_92520 != NULL)) {
      macroValidPointer (operand_92520) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_92520->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_92520->mKey, operand_92520->mInfo.mSignature, operand_92520->mInfo.mIsExtern) ;
      }
      operand_92520 = operand_92520->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_93262 ;
    GGS_bool var_cas_93265 ;
    GGS_entityPropertyMap  var_cas_93268 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_93262, var_cas_93265, var_cas_93268, var_cas_superEntityName) ;
