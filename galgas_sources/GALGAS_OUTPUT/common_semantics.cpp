...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2164)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2174)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2174))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2178)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2257))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2263))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2269)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2274)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2284))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2290))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2296)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2302)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2335)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2343)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_95774 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_95793 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_95774 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_95774) ;
    cPtr_typeGalgas_stringset * operand_95793 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_95793) ;
    if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_95774 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_95774) ;
      cPtr_typeGalgas_uint * operand_95793 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_95793) ;
      if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_95774 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_95774) ;
        cPtr_typeGalgas_sint * operand_95793 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_95793) ;
        if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_95774 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_95774) ;
          cPtr_typeGalgas_uint64 * operand_95793 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_95793) ;
          if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_95774 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_95774) ;
            cPtr_typeGalgas_sint64 * operand_95793 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_95793) ;
            if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_95774 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_95774) ;
              cPtr_typeGalgas_char * operand_95793 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_95793) ;
              if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_95774 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_95774) ;
                cPtr_typeGalgas_string * operand_95793 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_95793) ;
                if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_95774 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_95774) ;
                  cPtr_typeGalgas_bool * operand_95793 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_95793) ;
                  if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_95774 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_95774) ;
                    cPtr_typeGalgas_double * operand_95793 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_95793) ;
                    if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_95774 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_95774) ;
                      cPtr_typeGalgas_lbool * operand_95793 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_95793) ;
                      if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_95774 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_95774) ;
                        cPtr_typeGalgas_lchar * operand_95793 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_95793) ;
                        if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_95774 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_95774) ;
                          cPtr_typeGalgas_luint * operand_95793 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_95793) ;
                          if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_95774 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_95774) ;
                            cPtr_typeGalgas_lsint * operand_95793 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_95793) ;
                            if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_95774 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_95774) ;
                              cPtr_typeGalgas_luint64 * operand_95793 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_95793) ;
                              if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_95774 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_95774) ;
                                cPtr_typeGalgas_lsint64 * operand_95793 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_95793) ;
                                if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_95774 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_95774) ;
                                  cPtr_typeGalgas_ldouble * operand_95793 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_95793) ;
                                  if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_95774 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_95774) ;
                                    cPtr_typeGalgas_lstring * operand_95793 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_95793) ;
                                    if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_95774 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_95774) ;
                                      cPtr_typeGalgas_location * operand_95793 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_95793) ;
                                      if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_95774 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_95774) ;
                                        cPtr_typeGalgasUndefinedListType * operand_95793 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_95793) ;
                                        if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                          if (((operand_95774->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2383))) != (operand_95793->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2383)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_95774->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2384))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_95793->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2385))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2386)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_95774 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_95774) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_95793 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_95793) ;
                                          if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                            if (((operand_95774->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2389))) != (operand_95793->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2389)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_95774->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2390))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_95793->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2391))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2392)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_95774 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_95774) ;
                                            cPtr_typeGalgasClassType * operand_95793 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_95793) ;
                                            if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_95774->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2396))) == (operand_95793->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2396))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_95793->mAncestorClassesMap.reader_hasKey (_inLexique, operand_95774->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398)) SOURCE_FILE_AT_LINE (2398)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_95774->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2401))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_95793->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2402))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2403)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_95774 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_95774) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_95793 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_95793) ;
                                              if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                                if (((operand_95774->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2406))) != (operand_95793->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2406)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_95774->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2407))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_95793->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2408))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2409)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_95774 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_95774) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_95793 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_95793) ;
                                                if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                                  if (((operand_95774->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2413))) != (operand_95793->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2413)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_95774->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_95793->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2416)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_95774 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_95774) ;
                                                  cPtr_typeGalgas_enum * operand_95793 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_95793) ;
                                                  if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                                    if (((operand_95774->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2420))) != (operand_95793->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2420)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_95774->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_95793->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2422))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2423)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_95774 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_95774) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_95793 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_95793) ;
                                                    if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                                      if (((operand_95774->mEntityName) != (operand_95793->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_95774->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_95793->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2430)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_95774 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_95774) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_95793 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_95793) ;
                                                      if ((operand_95774 != NULL) && (operand_95793 != NULL)) {
                                                        if (((operand_95774->mMapTypeName) != (operand_95793->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_95774->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_95793->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2437)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2440))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2440)))) SOURCE_FILE_AT_LINE (2441)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2455))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2455)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2457)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2457))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2457)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2459)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_101193 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_101292 = var_cas_signatureTestee.firstObject () ;
    while ((operand_101193 != NULL)
        && (operand_101292 != NULL)) {
      macroValidPointer (operand_101193) ;
      macroValidPointer (operand_101292) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_101193->mType,  operand_101292->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2463)) ;
      if (((operand_101193->mFormalArgumentPassingMode) != (operand_101292->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_101292->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2469))) + (GGS_string (true, " is not compatible with ")))) + (operand_101292->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2470)))) SOURCE_FILE_AT_LINE (2471)) ;
      }
      operand_101193 = operand_101193->nextObject () ;
      operand_101292 = operand_101292->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2603))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2609))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2612))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2615))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2618))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2621))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2624))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2627))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2630))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2638)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2640))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2648))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2651))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2654))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2657))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2663)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2665))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2668))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2671))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2674))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2682))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2685))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2688))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2691))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2699))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2702))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2705))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2708))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2714)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2716))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2719))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lstring type is deprecated; use 'string' instead") SOURCE_FILE_AT_LINE (2720)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2723))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2726))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2732)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2734))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2737))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lchar type  is deprecated; use 'char' instead") SOURCE_FILE_AT_LINE (2738)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2741))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2744))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2750)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2752))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2755))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lbool type  is deprecated; use 'bool' instead") SOURCE_FILE_AT_LINE (2756)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2759))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2765)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2767))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2770))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' of @luint type  reader is deprecated; use 'uint' instead") SOURCE_FILE_AT_LINE (2771)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2774))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2777))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2783)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2785))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2788))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2791))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2797)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2799))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2802))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lsint type  is deprecated; use 'sint' instead") SOURCE_FILE_AT_LINE (2803)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2806))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2809))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2812))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2818)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2820))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2823))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2826))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2829))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2835)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2837))) == (GGS_string (true, "double"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2840))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @ldouble type  is deprecated; use 'double' instead") SOURCE_FILE_AT_LINE (2841)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2844))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2858))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2864)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2866))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2871))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2874))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2880)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2882))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList._addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2887))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2893)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_124207 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_124207) ; 
        if (operand_124207->mMessagesMap._isBuilt ()) {
          operand_124207->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2895)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_124486 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_124486) ; 
        GGS_L_lstringList  var_cas_124598 ;
        if (operand_124486->mMessagesMap._isBuilt ()) {
          operand_124486->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_124598 SOURCE_FILE_AT_LINE (2899)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2906)) ;
        var_cas_outAccessorTypesList._drop_operation () ;
        var_cas_outReturnedType._drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2933)) SOURCE_FILE_AT_LINE (2933))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_126397 ;
    GGS_M_semanticsEntitiesForUse  var_cas_126406 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_126397, var_cas_126406 SOURCE_FILE_AT_LINE (2940)) ;
    }
    ...
    GGS_stringset::element_type * operand_126651 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_126651 != NULL)) {
      macroValidPointer (operand_126651) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_126651->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2954)) ;
      operand_126651 = operand_126651->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_127016 = var_cas_modelMap.firstObject () ;
    while ((operand_127016 != NULL)) {
      macroValidPointer (operand_127016) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_127016->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2965)) SOURCE_FILE_AT_LINE (2965))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_127016->mKey, operand_127016->mInfo.mType SOURCE_FILE_AT_LINE (2966)) ;
      }
      operand_127016 = operand_127016->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_127230 = var_cas_actionMap.firstObject () ;
    while ((operand_127230 != NULL)) {
      macroValidPointer (operand_127230) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_127230->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2971)) SOURCE_FILE_AT_LINE (2971))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_127230->mKey, operand_127230->mInfo.mSignature, operand_127230->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2972)) ;
      }
      operand_127230 = operand_127230->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents._addAssign_operation (var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2976))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2987))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2988)) SOURCE_FILE_AT_LINE (2988))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2989)) SOURCE_FILE_AT_LINE (2989))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet._addAssign_operation (var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2990))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_128095 ;
    GGS_bool var_cas_128098 ;
    GGS_entityPropertyMap  var_cas_128101 ;
    if (var_cas_inEntityMap._isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_128095, var_cas_128098, var_cas_128101, var_cas_superEntityName SOURCE_FILE_AT_LINE (2992)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_inEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2993)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_128838 = var_cas_inPath.firstObject () ;
  while ((operand_128838 != NULL)) {
    macroValidPointer (operand_128838) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_128838->mPathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (3014)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (3014)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_128838->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (3017)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (3019)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3023)) SOURCE_FILE_AT_LINE (3023))))).isBuiltAndTrue ()) {
        operand_128838->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3025))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (3026)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_129631 ;
      GGS_entityPropertyMap  var_cas_129634 ;
      GGS_lstring  var_cas_129637 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_129631, var_cas_129634, var_cas_129637 SOURCE_FILE_AT_LINE (3030)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap._isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_128838->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (3033)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3035)) SOURCE_FILE_AT_LINE (3035))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_130000 ;
          GGS_lstring  var_cas_130003 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_130000, var_cas_130003 SOURCE_FILE_AT_LINE (3037)) ;
          }
          GGS_bool var_cas_130070 ;
          GGS_entityPropertyMap  var_cas_130073 ;
          GGS_lstring  var_cas_130076 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_130070, var_cas_130073, var_cas_130076 SOURCE_FILE_AT_LINE (3038)) ;
          }
        }else{
          GGS_bool var_cas_130155 ;
          GGS_entityPropertyMap  var_cas_130158 ;
          GGS_lstring  var_cas_130161 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130155, var_cas_130158, var_cas_130161 SOURCE_FILE_AT_LINE (3040)) ;
          }
        }
      }
    }
    operand_128838 = operand_128838->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_130476 = var_cas_inEntityMap.firstObject () ;
  while ((operand_130476 != NULL)) {
    macroValidPointer (operand_130476) ;
    if (((((operand_130476->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3055))) == (var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3055)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3055)) SOURCE_FILE_AT_LINE (3055))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet._addAssign_operation (operand_130476->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3056))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_130476->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (3057)) ;
    }
    operand_130476 = operand_130476->nextObject () ;
  }
}
