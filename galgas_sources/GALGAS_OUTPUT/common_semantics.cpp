...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_50010 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_50109 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_50010 != NULL)
        && (operand_50109 != NULL)) {
      macroValidPointer (operand_50010) ;
      macroValidPointer (operand_50109) ;
      if (((operand_50010->mFormalArgumentPassingMode) != (operand_50109->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_50109->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_50010->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_50010->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_50010->mGalgasTypeName.reader_value ()) != (operand_50109->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_50109->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_50010->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_50109->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_50010 = operand_50010->nextObject () ;
      operand_50109 = operand_50109->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_67908 = mNonExternAttributesList.firstObject () ;
  while ((operand_67908 != NULL)) {
    macroValidPointer (operand_67908) ;
    var_cas_outForeachList.addAssign_operation (operand_67908->mAttributType, operand_67908->aNomAttribut) ;
    operand_67908 = operand_67908->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_73681 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_73700 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_73681 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_73681) ;
    cPtr_typeGalgas_stringset * operand_73700 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_73700) ;
    if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_73681 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_73681) ;
      cPtr_typeGalgas_uint * operand_73700 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_73700) ;
      if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_73681 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_73681) ;
        cPtr_typeGalgas_sint * operand_73700 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_73700) ;
        if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_73681 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_73681) ;
          cPtr_typeGalgas_char * operand_73700 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_73700) ;
          if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_73681 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_73681) ;
            cPtr_typeGalgas_string * operand_73700 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_73700) ;
            if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_73681 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_73681) ;
              cPtr_typeGalgas_bool * operand_73700 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_73700) ;
              if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_73681 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_73681) ;
                cPtr_typeGalgas_double * operand_73700 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_73700) ;
                if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_73681 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_73681) ;
                  cPtr_typeGalgas_lbool * operand_73700 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_73700) ;
                  if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_73681 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_73681) ;
                    cPtr_typeGalgas_lchar * operand_73700 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_73700) ;
                    if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_73681 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_73681) ;
                      cPtr_typeGalgas_luint * operand_73700 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_73700) ;
                      if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_73681 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_73681) ;
                        cPtr_typeGalgas_lsint * operand_73700 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_73700) ;
                        if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_73681 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_73681) ;
                          cPtr_typeGalgas_ldouble * operand_73700 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_73700) ;
                          if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_73681 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_73681) ;
                            cPtr_typeGalgas_lstring * operand_73700 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_73700) ;
                            if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_73681 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_73681) ;
                              cPtr_typeGalgas_location * operand_73700 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_73700) ;
                              if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_73681 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_73681) ;
                                cPtr_typeGalgasUndefinedListType * operand_73700 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_73700) ;
                                if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                                  if (((operand_73681->mListTypeName.reader_value ()) != (operand_73700->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_73681->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_73700->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_73681 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_73681) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_73700 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_73700) ;
                                  if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                                    if (((operand_73681->mMapTypeName.reader_value ()) != (operand_73700->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_73681->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_73700->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_73681 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_73681) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_73700 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_73700) ;
                                    if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                                      if (((operand_73681->mClassTypeName.reader_value ()) != (operand_73700->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_73681->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_73700->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_73681 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_73681) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_73700 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_73700) ;
                                      if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                                        if (((operand_73681->mGalgasClassName.reader_value ()) != (operand_73700->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_73681->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_73700->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_73681 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_73681) ;
                                        cPtr_typeGalgas_enum * operand_73700 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_73700) ;
                                        if ((operand_73681 != NULL) && (operand_73700 != NULL)) {
                                          if (((operand_73681->mEnumTypeName.reader_value ()) != (operand_73700->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_73681->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_73700->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_77486 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_77585 = var_cas_signatureTestee.firstObject () ;
    while ((operand_77486 != NULL)
        && (operand_77585 != NULL)) {
      macroValidPointer (operand_77486) ;
      macroValidPointer (operand_77585) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_77486->mType,  operand_77585->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_77486->mFormalArgumentPassingMode) != (operand_77585->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_77585->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_77585->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_77486 = operand_77486->nextObject () ;
      operand_77585 = operand_77585->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_91916 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_91916) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_91916->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_92259 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92259) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92259->mMessagesMap ;
        GGS_L_lstringList  var_cas_92428 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_92428) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_94224 ;
    GGS_M_semanticsEntitiesForUse  var_cas_94233 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_94224, var_cas_94233) ;
    ...
    GGS_stringset::element_type * operand_94478 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_94478 != NULL)) {
      macroValidPointer (operand_94478) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_94478->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_94478 = operand_94478->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_94843 = var_cas_modelMap.firstObject () ;
    while ((operand_94843 != NULL)) {
      macroValidPointer (operand_94843) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_94843->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_94843->mKey, operand_94843->mInfo.mType) ;
      }
      operand_94843 = operand_94843->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_95056 = var_cas_actionMap.firstObject () ;
    while ((operand_95056 != NULL)) {
      macroValidPointer (operand_95056) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_95056->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_95056->mKey, operand_95056->mInfo.mSignature, operand_95056->mInfo.mIsExtern) ;
      }
      operand_95056 = operand_95056->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_95798 ;
    GGS_bool var_cas_95801 ;
    GGS_entityPropertyMap  var_cas_95804 ;
    GGS_mapPropertyMap  var_cas_95824 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_95798, var_cas_95801, var_cas_95804, var_cas_superEntityName, var_cas_95824) ;
