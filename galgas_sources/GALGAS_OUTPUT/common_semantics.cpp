...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mContextAttributes.reader_description () ;
...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_contextPropertyMap &  inParameter6,
               GGS_luint * outIndex) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    ...
    info.mContextAttributes = inParameter5 ;
    info.mAllContextAttributes = inParameter6 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_contextPropertyMap   & outParameter6,
               GGS_luint * outIndex) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
    AC_galgas_map_element * p = internal_search (inKey) ;
  ...
  if (node == NULL) {
    ...
    outParameter5 = node->mInfo.mContextAttributes ;
    outParameter6 = node->mInfo.mAllContextAttributes ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_50471 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_50570 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_50471 != NULL)
        && (operand_50570 != NULL)) {
      macroValidPointer (operand_50471) ;
      macroValidPointer (operand_50570) ;
      if (((operand_50471->mFormalArgumentPassingMode) != (operand_50570->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_50570->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_50471->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_50471->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_50471->mGalgasTypeName.reader_value ()) != (operand_50570->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_50570->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_50471->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_50570->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_50471 = operand_50471->nextObject () ;
      operand_50570 = operand_50570->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_68369 = mNonExternAttributesList.firstObject () ;
  while ((operand_68369 != NULL)) {
    macroValidPointer (operand_68369) ;
    var_cas_outForeachList.addAssign_operation (operand_68369->mAttributType, operand_68369->aNomAttribut) ;
    operand_68369 = operand_68369->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_74142 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_74161 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_74142 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_74142) ;
    cPtr_typeGalgas_stringset * operand_74161 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_74161) ;
    if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_74142 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_74142) ;
      cPtr_typeGalgas_uint * operand_74161 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_74161) ;
      if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_74142 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_74142) ;
        cPtr_typeGalgas_sint * operand_74161 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_74161) ;
        if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_74142 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_74142) ;
          cPtr_typeGalgas_char * operand_74161 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_74161) ;
          if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_74142 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_74142) ;
            cPtr_typeGalgas_string * operand_74161 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_74161) ;
            if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_74142 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_74142) ;
              cPtr_typeGalgas_bool * operand_74161 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_74161) ;
              if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_74142 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_74142) ;
                cPtr_typeGalgas_double * operand_74161 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_74161) ;
                if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_74142 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_74142) ;
                  cPtr_typeGalgas_lbool * operand_74161 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_74161) ;
                  if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_74142 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_74142) ;
                    cPtr_typeGalgas_lchar * operand_74161 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_74161) ;
                    if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_74142 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_74142) ;
                      cPtr_typeGalgas_luint * operand_74161 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_74161) ;
                      if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_74142 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_74142) ;
                        cPtr_typeGalgas_lsint * operand_74161 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_74161) ;
                        if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_74142 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_74142) ;
                          cPtr_typeGalgas_ldouble * operand_74161 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_74161) ;
                          if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_74142 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_74142) ;
                            cPtr_typeGalgas_lstring * operand_74161 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_74161) ;
                            if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_74142 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_74142) ;
                              cPtr_typeGalgas_location * operand_74161 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_74161) ;
                              if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_74142 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_74142) ;
                                cPtr_typeGalgasUndefinedListType * operand_74161 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_74161) ;
                                if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                                  if (((operand_74142->mListTypeName.reader_value ()) != (operand_74161->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_74142->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_74161->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_74142 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_74142) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_74161 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_74161) ;
                                  if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                                    if (((operand_74142->mMapTypeName.reader_value ()) != (operand_74161->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_74142->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_74161->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_74142 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_74142) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_74161 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_74161) ;
                                    if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                                      if (((operand_74142->mClassTypeName.reader_value ()) != (operand_74161->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_74142->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_74161->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_74142 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_74142) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_74161 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_74161) ;
                                      if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                                        if (((operand_74142->mGalgasClassName.reader_value ()) != (operand_74161->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_74142->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_74161->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_74142 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_74142) ;
                                        cPtr_typeGalgas_enum * operand_74161 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_74161) ;
                                        if ((operand_74142 != NULL) && (operand_74161 != NULL)) {
                                          if (((operand_74142->mEnumTypeName.reader_value ()) != (operand_74161->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_74142->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_74161->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_77947 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_78046 = var_cas_signatureTestee.firstObject () ;
    while ((operand_77947 != NULL)
        && (operand_78046 != NULL)) {
      macroValidPointer (operand_77947) ;
      macroValidPointer (operand_78046) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_77947->mType,  operand_78046->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_77947->mFormalArgumentPassingMode) != (operand_78046->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_78046->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_78046->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_77947 = operand_77947->nextObject () ;
      operand_78046 = operand_78046->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_92377 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92377) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92377->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_92720 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92720) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92720->mMessagesMap ;
        GGS_L_lstringList  var_cas_92889 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_92889) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_94685 ;
    GGS_M_semanticsEntitiesForUse  var_cas_94694 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_94685, var_cas_94694) ;
    ...
    GGS_stringset::element_type * operand_94939 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_94939 != NULL)) {
      macroValidPointer (operand_94939) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_94939->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_94939 = operand_94939->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_95304 = var_cas_modelMap.firstObject () ;
    while ((operand_95304 != NULL)) {
      macroValidPointer (operand_95304) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_95304->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_95304->mKey, operand_95304->mInfo.mType) ;
      }
      operand_95304 = operand_95304->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_95517 = var_cas_actionMap.firstObject () ;
    while ((operand_95517 != NULL)) {
      macroValidPointer (operand_95517) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_95517->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_95517->mKey, operand_95517->mInfo.mSignature, operand_95517->mInfo.mIsExtern) ;
      }
      operand_95517 = operand_95517->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ()))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_96320 ;
    GGS_bool var_cas_96323 ;
    GGS_entityPropertyMap  var_cas_96326 ;
    GGS_mapPropertyMap  var_cas_96346 ;
    GGS_contextPropertyMap  var_cas_96349 ;
    GGS_contextPropertyMap  var_cas_96352 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_96320, var_cas_96323, var_cas_96326, var_cas_superEntityName, var_cas_96346, var_cas_96349, var_cas_96352) ;
