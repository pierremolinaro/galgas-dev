...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2109))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2111))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2113)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2115)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2132)) ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2173)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2183)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2183))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2187)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2266))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2272))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2278)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2283)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2293))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2299))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2305)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2311)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2344)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2352)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_96040 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_96059 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_96040 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96040) ;
    cPtr_typeGalgas_stringset * operand_96059 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96059) ;
    if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_96040 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96040) ;
      cPtr_typeGalgas_uint * operand_96059 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96059) ;
      if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_96040 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96040) ;
        cPtr_typeGalgas_sint * operand_96059 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96059) ;
        if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_96040 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96040) ;
          cPtr_typeGalgas_uint64 * operand_96059 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96059) ;
          if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_96040 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96040) ;
            cPtr_typeGalgas_sint64 * operand_96059 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96059) ;
            if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_96040 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96040) ;
              cPtr_typeGalgas_char * operand_96059 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96059) ;
              if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_96040 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96040) ;
                cPtr_typeGalgas_string * operand_96059 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96059) ;
                if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_96040 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96040) ;
                  cPtr_typeGalgas_bool * operand_96059 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96059) ;
                  if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_96040 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96040) ;
                    cPtr_typeGalgas_double * operand_96059 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96059) ;
                    if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_96040 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96040) ;
                      cPtr_typeGalgas_lbool * operand_96059 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96059) ;
                      if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_96040 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96040) ;
                        cPtr_typeGalgas_lchar * operand_96059 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96059) ;
                        if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_96040 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96040) ;
                          cPtr_typeGalgas_luint * operand_96059 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96059) ;
                          if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_96040 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96040) ;
                            cPtr_typeGalgas_lsint * operand_96059 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96059) ;
                            if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_96040 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96040) ;
                              cPtr_typeGalgas_luint64 * operand_96059 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96059) ;
                              if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_96040 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96040) ;
                                cPtr_typeGalgas_lsint64 * operand_96059 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96059) ;
                                if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_96040 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96040) ;
                                  cPtr_typeGalgas_ldouble * operand_96059 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96059) ;
                                  if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_96040 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96040) ;
                                    cPtr_typeGalgas_lstring * operand_96059 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96059) ;
                                    if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_96040 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96040) ;
                                      cPtr_typeGalgas_location * operand_96059 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96059) ;
                                      if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_96040 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96040) ;
                                        cPtr_typeGalgasUndefinedListType * operand_96059 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96059) ;
                                        if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                          if (((operand_96040->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2392))) != (operand_96059->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2392)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_96040->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2393))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_96059->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2394))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2395)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_96040 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96040) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_96059 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96059) ;
                                          if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                            if (((operand_96040->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398))) != (operand_96059->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_96040->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2399))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_96059->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2400))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2401)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_96040 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96040) ;
                                            cPtr_typeGalgasClassType * operand_96059 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_96059) ;
                                            if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_96040->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2405))) == (operand_96059->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2405))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_96059->mAncestorClassesMap.reader_hasKey (_inLexique, operand_96040->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2407)) SOURCE_FILE_AT_LINE (2407)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96040->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2410))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96059->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2411))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2412)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_96040 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96040) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_96059 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96059) ;
                                              if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                                if (((operand_96040->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415))) != (operand_96059->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96040->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2416))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96059->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2417))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2418)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_96040 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96040) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_96059 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96059) ;
                                                if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                                  if (((operand_96040->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2422))) != (operand_96059->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2422)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_96040->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2423))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_96059->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2424))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2425)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_96040 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96040) ;
                                                  cPtr_typeGalgas_enum * operand_96059 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96059) ;
                                                  if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                                    if (((operand_96040->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2429))) != (operand_96059->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2429)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_96040->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2430))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_96059->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2431))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2432)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_96040 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96040) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_96059 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96059) ;
                                                    if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                                      if (((operand_96040->mEntityName) != (operand_96059->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_96040->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_96059->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2439)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96040 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96040) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96059 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96059) ;
                                                      if ((operand_96040 != NULL) && (operand_96059 != NULL)) {
                                                        if (((operand_96040->mMapTypeName) != (operand_96059->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_96040->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_96059->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2446)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2449))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2449)))) SOURCE_FILE_AT_LINE (2450)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2464))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2464)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2466)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2466))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2466)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2468)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_101459 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_101558 = var_cas_signatureTestee.firstObject () ;
    while ((operand_101459 != NULL)
        && (operand_101558 != NULL)) {
      macroValidPointer (operand_101459) ;
      macroValidPointer (operand_101558) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_101459->mType,  operand_101558->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2472)) ;
      if (((operand_101459->mFormalArgumentPassingMode) != (operand_101558->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_101558->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2478))) + (GGS_string (true, " is not compatible with ")))) + (operand_101558->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2479)))) SOURCE_FILE_AT_LINE (2480)) ;
      }
      operand_101459 = operand_101459->nextObject () ;
      operand_101558 = operand_101558->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2623))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2629))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2632))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2635))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2638))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2641))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2644))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2647))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2650))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2658)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2660))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2666)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2668))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2671))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2674))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2677))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2683)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2685))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2688))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2691))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2694))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2700)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2702))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2705))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2708))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2711))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2717)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2719))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2722))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2725))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2728))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2734)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2736))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2739))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lstring type is deprecated; use 'string' instead") SOURCE_FILE_AT_LINE (2740)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2743))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2746))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2752)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2754))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2757))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lchar type  is deprecated; use 'char' instead") SOURCE_FILE_AT_LINE (2758)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2761))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2764))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2770)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2772))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2775))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lbool type  is deprecated; use 'bool' instead") SOURCE_FILE_AT_LINE (2776)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2779))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2785)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2787))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2790))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' of @luint type  reader is deprecated; use 'uint' instead") SOURCE_FILE_AT_LINE (2791)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2794))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2797))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2803)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2805))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2808))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2811))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2817)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2819))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2822))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lsint type  is deprecated; use 'sint' instead") SOURCE_FILE_AT_LINE (2823)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2826))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2829))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2832))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2838)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2840))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2843))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2846))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2849))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2855)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2857))) == (GGS_string (true, "double"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2860))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @ldouble type  is deprecated; use 'double' instead") SOURCE_FILE_AT_LINE (2861)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2864))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2867))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2870))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2876)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2878))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2884)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2886))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2891))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2894))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2902))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList._addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2907))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2913)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_124932 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_124932) ; 
        if (operand_124932->mMessagesMap._isBuilt ()) {
          operand_124932->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2915)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_125211 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125211) ; 
        GGS_L_lstringList  var_cas_125323 ;
        if (operand_125211->mMessagesMap._isBuilt ()) {
          operand_125211->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_125323 SOURCE_FILE_AT_LINE (2919)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2926)) ;
        var_cas_outAccessorTypesList._drop_operation () ;
        var_cas_outReturnedType._drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2953)) SOURCE_FILE_AT_LINE (2953))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_127122 ;
    GGS_M_semanticsEntitiesForUse  var_cas_127131 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_127122, var_cas_127131 SOURCE_FILE_AT_LINE (2960)) ;
    }
    ...
    GGS_stringset::element_type * operand_127376 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_127376 != NULL)) {
      macroValidPointer (operand_127376) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_127376->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2974)) ;
      operand_127376 = operand_127376->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_127741 = var_cas_modelMap.firstObject () ;
    while ((operand_127741 != NULL)) {
      macroValidPointer (operand_127741) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_127741->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2985)) SOURCE_FILE_AT_LINE (2985))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_127741->mKey, operand_127741->mInfo.mType SOURCE_FILE_AT_LINE (2986)) ;
      }
      operand_127741 = operand_127741->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_127955 = var_cas_actionMap.firstObject () ;
    while ((operand_127955 != NULL)) {
      macroValidPointer (operand_127955) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_127955->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2991)) SOURCE_FILE_AT_LINE (2991))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_127955->mKey, operand_127955->mInfo.mSignature, operand_127955->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2992)) ;
      }
      operand_127955 = operand_127955->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents._addAssign_operation (var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2996))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3007))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3008)) SOURCE_FILE_AT_LINE (3008))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3009)) SOURCE_FILE_AT_LINE (3009))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet._addAssign_operation (var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3010))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_128820 ;
    GGS_bool var_cas_128823 ;
    GGS_entityPropertyMap  var_cas_128826 ;
    if (var_cas_inEntityMap._isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_128820, var_cas_128823, var_cas_128826, var_cas_superEntityName SOURCE_FILE_AT_LINE (3012)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_inEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (3013)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_129563 = var_cas_inPath.firstObject () ;
  while ((operand_129563 != NULL)) {
    macroValidPointer (operand_129563) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_129563->mPathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (3034)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (3034)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_129563->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (3037)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (3039)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3043)) SOURCE_FILE_AT_LINE (3043))))).isBuiltAndTrue ()) {
        operand_129563->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3045))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (3046)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_130356 ;
      GGS_entityPropertyMap  var_cas_130359 ;
      GGS_lstring  var_cas_130362 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130356, var_cas_130359, var_cas_130362 SOURCE_FILE_AT_LINE (3050)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap._isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_129563->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (3053)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3055)) SOURCE_FILE_AT_LINE (3055))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_130725 ;
          GGS_lstring  var_cas_130728 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_130725, var_cas_130728 SOURCE_FILE_AT_LINE (3057)) ;
          }
          GGS_bool var_cas_130795 ;
          GGS_entityPropertyMap  var_cas_130798 ;
          GGS_lstring  var_cas_130801 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_130795, var_cas_130798, var_cas_130801 SOURCE_FILE_AT_LINE (3058)) ;
          }
        }else{
          GGS_bool var_cas_130880 ;
          GGS_entityPropertyMap  var_cas_130883 ;
          GGS_lstring  var_cas_130886 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130880, var_cas_130883, var_cas_130886 SOURCE_FILE_AT_LINE (3060)) ;
          }
        }
      }
    }
    operand_129563 = operand_129563->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_131201 = var_cas_inEntityMap.firstObject () ;
  while ((operand_131201 != NULL)) {
    macroValidPointer (operand_131201) ;
    if (((((operand_131201->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3075))) == (var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3075)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3075)) SOURCE_FILE_AT_LINE (3075))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet._addAssign_operation (operand_131201->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3076))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_131201->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (3077)) ;
    }
    operand_131201 = operand_131201->nextObject () ;
  }
}
