...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_lstring &  inParameter1,
               const GGS_entityPropertyMap &  inParameter2,
               const GGS_contextPropertyMap &  inParameter3,
               const GGS_mapPropertyMap &  inParameter4,
               const GGS_contextParameterMap &  inParameter5,
               const GGS_insertionList &  inParameter6,
               const GGS_indexMap &  inParameter7,
               const GGS_fetchedPropertyMap &  inParameter8,
               const GGS_stringset &  inParameter9,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mAllRelationMap = inParameter0 ;
    info.mSuperEntityName = inParameter1 ;
    info.mEntityPropertiesMap = inParameter2 ;
    info.mContextPropertyMap = inParameter3 ;
    info.mMapPropertyMap = inParameter4 ;
    info.mContextParameterMap = inParameter5 ;
    info.mInsertionList = inParameter6 ;
    info.mIndexMap = inParameter7 ;
    info.mFetchedPropertyMap = inParameter8 ;
    info.mDescendantEntitySet = inParameter9 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_lstring   & outParameter1,
               GGS_entityPropertyMap   & outParameter2,
               GGS_contextPropertyMap   & outParameter3,
               GGS_mapPropertyMap   & outParameter4,
               GGS_contextParameterMap   & outParameter5,
               GGS_insertionList   & outParameter6,
               GGS_indexMap   & outParameter7,
               GGS_fetchedPropertyMap   & outParameter8,
               GGS_stringset   & outParameter9,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mAllRelationMap ;
    outParameter1 = node->mInfo.mSuperEntityName ;
    outParameter2 = node->mInfo.mEntityPropertiesMap ;
    outParameter3 = node->mInfo.mContextPropertyMap ;
    outParameter4 = node->mInfo.mMapPropertyMap ;
    outParameter5 = node->mInfo.mContextParameterMap ;
    outParameter6 = node->mInfo.mInsertionList ;
    outParameter7 = node->mInfo.mIndexMap ;
    outParameter8 = node->mInfo.mFetchedPropertyMap ;
    outParameter9 = node->mInfo.mDescendantEntitySet ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_constrainedEntityMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_indexMap   & outParameter7,
                                GGS_fetchedPropertyMap   & outParameter8,
                                GGS_stringset   & outParameter9 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_indexMap & inParameter7,
                                const GGS_fetchedPropertyMap & inParameter8,
                                const GGS_stringset & inParameter9 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (865)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (950)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (985)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1016)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1047)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1082)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1117)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1148)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1259)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1268)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1277)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1407)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1409)) ;
  }else{
    GGS_L_signature::element_type * operand_56116 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_56215 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_56116 != NULL)
        && (operand_56215 != NULL)) {
      macroValidPointer (operand_56116) ;
      macroValidPointer (operand_56215) ;
      if (((operand_56116->mFormalArgumentPassingMode) != (operand_56215->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_56215->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_56116->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_56116->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1415)) ;
      }
      if (((operand_56116->mGalgasTypeName.reader_value ()) != (operand_56215->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_56215->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_56116->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_56215->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1418)) ;
      }
      operand_56116 = operand_56116->nextObject () ;
      operand_56215 = operand_56215->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1733)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1797)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_74014 = mNonExternAttributesList.firstObject () ;
  while ((operand_74014 != NULL)) {
    macroValidPointer (operand_74014) ;
    var_cas_outForeachList.addAssign_operation (operand_74014->mAttributType, operand_74014->aNomAttribut) ;
    operand_74014 = operand_74014->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1824)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1872)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1883)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1892)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1896)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1955)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79787 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79806 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79787 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79787) ;
    cPtr_typeGalgas_stringset * operand_79806 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79806) ;
    if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79787 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79787) ;
      cPtr_typeGalgas_uint * operand_79806 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79806) ;
      if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79787 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79787) ;
        cPtr_typeGalgas_sint * operand_79806 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79806) ;
        if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79787 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79787) ;
          cPtr_typeGalgas_char * operand_79806 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79806) ;
          if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79787 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79787) ;
            cPtr_typeGalgas_string * operand_79806 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79806) ;
            if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79787 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79787) ;
              cPtr_typeGalgas_bool * operand_79806 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79806) ;
              if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79787 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79787) ;
                cPtr_typeGalgas_double * operand_79806 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79806) ;
                if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79787 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79787) ;
                  cPtr_typeGalgas_lbool * operand_79806 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79806) ;
                  if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79787 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79787) ;
                    cPtr_typeGalgas_lchar * operand_79806 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79806) ;
                    if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79787 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79787) ;
                      cPtr_typeGalgas_luint * operand_79806 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79806) ;
                      if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79787 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79787) ;
                        cPtr_typeGalgas_lsint * operand_79806 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79806) ;
                        if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79787 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79787) ;
                          cPtr_typeGalgas_ldouble * operand_79806 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79806) ;
                          if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79787 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79787) ;
                            cPtr_typeGalgas_lstring * operand_79806 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79806) ;
                            if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79787 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79787) ;
                              cPtr_typeGalgas_location * operand_79806 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79806) ;
                              if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79787 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79787) ;
                                cPtr_typeGalgasUndefinedListType * operand_79806 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79806) ;
                                if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                                  if (((operand_79787->mListTypeName.reader_value ()) != (operand_79806->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79787->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79806->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1992)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79787 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79787) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79806 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79806) ;
                                  if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                                    if (((operand_79787->mMapTypeName.reader_value ()) != (operand_79806->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79787->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79806->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1998)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79787 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79787) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79806 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79806) ;
                                    if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                                      if (((operand_79787->mClassTypeName.reader_value ()) != (operand_79806->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79787->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79806->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2004)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79787 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79787) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79806 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79806) ;
                                      if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                                        if (((operand_79787->mGalgasClassName.reader_value ()) != (operand_79806->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79787->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79806->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2011)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79787 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79787) ;
                                        cPtr_typeGalgas_enum * operand_79806 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79806) ;
                                        if ((operand_79787 != NULL) && (operand_79806 != NULL)) {
                                          if (((operand_79787->mEnumTypeName.reader_value ()) != (operand_79806->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79787->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79806->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2018)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (2022)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2038)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2040)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_83592 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83691 = var_cas_signatureTestee.firstObject () ;
    while ((operand_83592 != NULL)
        && (operand_83691 != NULL)) {
      macroValidPointer (operand_83592) ;
      macroValidPointer (operand_83691) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_83592->mType,  operand_83691->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2044)) ;
      if (((operand_83592->mFormalArgumentPassingMode) != (operand_83691->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_83691->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_83691->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2047)) ;
      }
      operand_83592 = operand_83592->nextObject () ;
      operand_83691 = operand_83691->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2214)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2233)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2247)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2264)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2289)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2306)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2323)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2331)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2350)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2363)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_100220 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100220) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100220->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2367)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100563 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100563) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100563->mMessagesMap ;
        GGS_L_lstringList  var_cas_100732 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_100732 SOURCE_FILE_AT_LINE (2372)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2378)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102528 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102537 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102528, var_cas_102537 SOURCE_FILE_AT_LINE (2413)) ;
    ...
    GGS_stringset::element_type * operand_102782 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_102782 != NULL)) {
      macroValidPointer (operand_102782) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_102782->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2427)) ;
      operand_102782 = operand_102782->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_103147 = var_cas_modelMap.firstObject () ;
    while ((operand_103147 != NULL)) {
      macroValidPointer (operand_103147) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_103147->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_103147->mKey, operand_103147->mInfo.mType SOURCE_FILE_AT_LINE (2439)) ;
      }
      operand_103147 = operand_103147->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103360 = var_cas_actionMap.firstObject () ;
    while ((operand_103360 != NULL)) {
      macroValidPointer (operand_103360) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_103360->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_103360->mKey, operand_103360->mInfo.mSignature, operand_103360->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2445)) ;
      }
      operand_103360 = operand_103360->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_104163 ;
    GGS_bool var_cas_104166 ;
    GGS_entityPropertyMap  var_cas_104169 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_104163, var_cas_104166, var_cas_104169, var_cas_superEntityName SOURCE_FILE_AT_LINE (2463)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2464)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_104907 = var_cas_inPath.firstObject () ;
  while ((operand_104907 != NULL)) {
    macroValidPointer (operand_104907) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_104907->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_104907->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2490)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_104907->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2496)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_105697 ;
      GGS_entityPropertyMap  var_cas_105700 ;
      GGS_lstring  var_cas_105703 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105697, var_cas_105700, var_cas_105703 SOURCE_FILE_AT_LINE (2501)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_104907->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2504)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_106069 ;
          GGS_lstring  var_cas_106072 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_106069, var_cas_106072 SOURCE_FILE_AT_LINE (2508)) ;
          GGS_bool var_cas_106141 ;
          GGS_entityPropertyMap  var_cas_106144 ;
          GGS_lstring  var_cas_106147 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_106141, var_cas_106144, var_cas_106147 SOURCE_FILE_AT_LINE (2509)) ;
        }else{
          GGS_bool var_cas_106228 ;
          GGS_entityPropertyMap  var_cas_106231 ;
          GGS_lstring  var_cas_106234 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106228, var_cas_106231, var_cas_106234 SOURCE_FILE_AT_LINE (2511)) ;
        }
      }
    }
    operand_104907 = operand_104907->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & lexique_var_,
  ...
  GGS_entityToImplementMap::element_type * operand_106549 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_106549 != NULL)) {
    macroValidPointer (operand_106549) ;
    if (((((operand_106549->mInfo.mSuperEntityName.reader_value ()) == (var_cas_inEntityName.reader_value ())) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (var_cas_inEntityName.reader_value ())))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_106549->mKey.reader_value ()) ;
      ::routine_computeDescendantSet (lexique_var_,  var_cas_ioEntityMap,  operand_106549->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2528)) ;
    }
    operand_106549 = operand_106549->nextObject () ;
  }
}
