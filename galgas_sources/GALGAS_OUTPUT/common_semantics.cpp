...
GGS_string GGS_L_lstringList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_signature::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
  s << "<list @L_signature" ;
  if (isBuilt ()) {
    s << " " << mListLength << " object" << ((mListLength > 1) ? "s " : " ") ;
...
GGS_string GGS_typeListModel::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
methode_acceptAssignmentFromHere (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "assignment from 'here' is not allowed for variables of this type") SOURCE_FILE_AT_LINE (376)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_acceptForeachInstruction (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inErrorLocation,
                                GGS_typeListeAttributsSemantiques & /* var_cas_outForeachList */,
                                GGS_localConstantBuildStyleEnum& /* var_cas_outStyle */) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be enumerated by in 'foreach' instruction") SOURCE_FILE_AT_LINE (386)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_acceptToBeKeyForMap (C_Lexique & _inLexique) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this type cannot be a key for map") SOURCE_FILE_AT_LINE (391)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleModifierCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & /* var_cas_outModifierSignature */) {
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (400)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & /* var_cas_outReaderSignature */) {
    var_cas_inReaderName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader instruction") SOURCE_FILE_AT_LINE (410)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & /* var_cas_outAccessorTypesList */) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (418)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleMinusAssignOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation,
                                GGS_typeListeAttributsSemantiques & /* var_cas_outParametersList */) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '-=' operator") SOURCE_FILE_AT_LINE (428)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleAddAssignOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation,
                                GGS_typeListeAttributsSemantiques & /* var_cas_outParametersList */,
                                GGS_bool& /* var_cas_outAccept_uint_assignment */) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (440)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleIncrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (448)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_handleDecrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '--' operator") SOURCE_FILE_AT_LINE (456)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & _inLexique) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (462)) ;
}

//---------------------------------------------------------------------------*

void cPtr_AC_galgasType::
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & /* _inLexique */) {
}
...
GGS_string GGS_L_propertyPath::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_ListOfPropertyPathes::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_contextParameterMap GGS_contextParameterMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_contextParameterMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
...
GGS_insertionMap GGS_insertionMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
appendForMapDescription (C_Lexique & _inLexique, C_String & ioString COMMA_LOCATION_ARGS) const {
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE) ;
  ioString << "->" ;
  ioString << mInfo.mMapReferenceName.reader_description  (_inLexique COMMA_THERE) ;
  ioString << "]" ;
}
...
GGS_indexMap GGS_indexMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_indexMap result ;
  macroMyNew (result.mSharedMapRoot, cMapRoot) ;
  return result ;
}
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_indexMap info  ;
    info.mMapReferenceName = inParameter0 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mSharedMapRoot->mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mMapReferenceName ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_indexMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
                 "there is no '%K' index",
...
methode_insertKey (C_Lexique & _inLexique,
                                ...
                                const GGS_lstring & inParameter0 COMMA_LOCATION_ARGS) {
  insertElement (_inLexique,
                 "the index '%K' is already defined in %L",
                 inKey,
                 inParameter0,
                 NULL
                 COMMA_THERE) ;
...
GGS_relationVarMap GGS_relationVarMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_relationVarMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
void GGS_relationVarMap::methode_searchKeyAndGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_lstring   & outParameter0 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
elementOf_GGS_metamodelRelationParameterList (const GGS_lstring & argument_0,
  ...
  mNextItem = (elementOf_GGS_metamodelRelationParameterList *) NULL ;
...
::GGS_metamodelRelationParameterList (void) { // Default Constructor
  mFirstItem = (element_type *) NULL ;
  mLastItem = (element_type *) NULL ;
  mListLength = 0 ;
  mCountReference = (sint32 *) NULL ;
...
GGS_metamodelRelationParameterList::GGS_metamodelRelationParameterList (const GGS_metamodelRelationParameterList & source) { // Copy constructor
  mFirstItem = (element_type *) NULL ;
  mLastItem = (element_type *) NULL ;
  mListLength = 0 ;
  mCountReference = (sint32 *) NULL ;
...
::operator = (const GGS_metamodelRelationParameterList & source) { // Assignment operator
  if (this != & source) {
    emptyList () ;
    mFirstItem = source.mFirstItem ;
    mLastItem = source.mLastItem ;
...
GGS_string GGS_metamodelRelationParameterList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_relationMap GGS_relationMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_relationMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_relationVarMap   & outParameter0,
...
GGS_mapEntityMap GGS_mapEntityMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_mapEntityMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0,
                                GGS_lstring   & outParameter1,
...
GGS_mapAndEntityUniqueMap GGS_mapAndEntityUniqueMap::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_mapAndEntityUniqueMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (673)) ;
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = ((GGS_string (true, "_listOf_")) + (mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (686)))) ;
}
...
GGS_string GGS_typeListeAttributsSemantiques::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_typeTypesList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_EXsignature::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_actualParametersSignature::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_stringList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
  s << "<list @L_stringList" ;
  if (isBuilt ()) {
    s << " " << mListLength << " object" << ((mListLength > 1) ? "s " : " ") ;
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (827))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (829))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (832)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (865))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (868)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (946))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_string::constructor_new (HERE) ;
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_location::constructor_new (HERE) ;
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (953)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (981))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (988)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1012))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1019)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1043))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1050)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1078))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1085)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1113))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1120)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1148))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1151)) ;
  }
}
...
methode_handleAddAssignOperatorCall (C_Lexique & _inLexique,
  ...
  GGS_AC_galgasType  var_cas_t ;
  var_cas_t = GGS_typeGalgas_string::constructor_new (HERE) ;
  var_cas_outParametersList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  var_cas_outForeachList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, "mKey"), GGS_location (_inLexique) COMMA_HERE)) ;
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1223)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_constructorMap.methode_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1268)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1277)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1286)) ;
}
...
methode_handleAddAssignOperatorCall (C_Lexique & _inLexique,
  ...
  if (((! (mAcceptAddAssignOperatorCall))).isBuiltAndTrue ()) {
    inherited::methode_handleAddAssignOperatorCall (_inLexique, var_cas_inErrorLocation, var_cas_outParametersList, var_cas_outAccept_uint_assignment) ;
  }else{
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1415))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1415)))).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1416))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1416)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1417))) > (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1417)))).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1418))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1418)) ;
  }else{
    GGS_L_signature::element_type * operand_56179 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_56278 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_56179 != NULL)
        && (operand_56278 != NULL)) {
      macroValidPointer (operand_56179) ;
      macroValidPointer (operand_56278) ;
      if (((operand_56179->mFormalArgumentPassingMode) != (operand_56278->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_56278->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_56179->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1423))))) + (GGS_string (true, ", and ")))) + (operand_56179->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1424))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1424)) ;
      }
      if (((operand_56179->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1426))) != (operand_56278->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1426)))).isBuiltAndTrue ()) {
          operand_56278->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_56179->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1427))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_56278->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1427))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1427)) ;
      }
      operand_56179 = operand_56179->nextObject () ;
      operand_56278 = operand_56278->nextObject () ;
    }
  }
}
...
GGS_string GGS_L_ruleSyntaxSignature::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_productionRules_ForGrammarComponent::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_branchList_ForGrammarComponent::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_syntaxComponents_ForGrammar::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_identifiers::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_insertOrSearchMethodList::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1672)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1714))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1717)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1748)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1781)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  var_cas_outForeachList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  var_cas_outForeachList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, "\?\?\?"), GGS_location (_inLexique) COMMA_HERE)) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_73383 = mNonExternAttributesList.firstObject () ;
  while ((operand_73383 != NULL)) {
    macroValidPointer (operand_73383) ;
    var_cas_outForeachList.addAssign_operation (operand_73383->mAttributType, operand_73383->aNomAttribut) ;
    operand_73383 = operand_73383->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1805))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1808)) ;
  }
}
...
mMethodMap.reader_description  (_inLexique COMMA_THERE) ;
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1826)) ;
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & _inLexique) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1856)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  GGS_typeTableMethodes  var_cas_methodMap ;
  var_cas_methodMap = mReaderMap ;
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1867)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1876)) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1877))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1880)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1930)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_enumConstantesMap.methode_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1939)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79151 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79170 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79151 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79151) ;
    cPtr_typeGalgas_stringset * operand_79170 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79170) ;
    if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79151 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79151) ;
      cPtr_typeGalgas_uint * operand_79170 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79170) ;
      if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79151 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79151) ;
        cPtr_typeGalgas_sint * operand_79170 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79170) ;
        if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79151 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79151) ;
          cPtr_typeGalgas_char * operand_79170 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79170) ;
          if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79151 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79151) ;
            cPtr_typeGalgas_string * operand_79170 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79170) ;
            if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79151 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79151) ;
              cPtr_typeGalgas_bool * operand_79170 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79170) ;
              if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79151 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79151) ;
                cPtr_typeGalgas_double * operand_79170 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79170) ;
                if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79151 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79151) ;
                  cPtr_typeGalgas_lbool * operand_79170 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79170) ;
                  if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79151 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79151) ;
                    cPtr_typeGalgas_lchar * operand_79170 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79170) ;
                    if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79151 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79151) ;
                      cPtr_typeGalgas_luint * operand_79170 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79170) ;
                      if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79151 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79151) ;
                        cPtr_typeGalgas_lsint * operand_79170 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79170) ;
                        if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79151 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79151) ;
                          cPtr_typeGalgas_ldouble * operand_79170 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79170) ;
                          if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79151 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79151) ;
                            cPtr_typeGalgas_lstring * operand_79170 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79170) ;
                            if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79151 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79151) ;
                              cPtr_typeGalgas_location * operand_79170 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79170) ;
                              if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79151 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79151) ;
                                cPtr_typeGalgasUndefinedListType * operand_79170 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79170) ;
                                if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                                  if (((operand_79151->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1974))) != (operand_79170->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1974)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79151->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1975))))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79170->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1976))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1976)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79151 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79151) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79170 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79170) ;
                                  if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                                    if (((operand_79151->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1980))) != (operand_79170->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1980)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79151->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1981))))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79170->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1982))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1982)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79151 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79151) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79170 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79170) ;
                                    if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                                      if (((operand_79151->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1986))) != (operand_79170->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1986)))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79151->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1987))))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79170->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1988))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1988)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79151 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79151) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79170 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79170) ;
                                      if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                                        if (((operand_79151->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1993))) != (operand_79170->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1993)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79151->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1994))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79170->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1995))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1995)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79151 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79151) ;
                                        cPtr_typeGalgas_enum * operand_79170 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79170) ;
                                        if ((operand_79151 != NULL) && (operand_79170 != NULL)) {
                                          if (((operand_79151->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2000))) != (operand_79170->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2000)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79151->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2001))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79170->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2002))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2002)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2006))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2006)))) SOURCE_FILE_AT_LINE (2006)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
                                ...
                                GGS_location   var_cas_ouSignalerErreur COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2021))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2021)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2022)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2023))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2023)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2024)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_82956 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83055 = var_cas_signatureTestee.firstObject () ;
    while ((operand_82956 != NULL)
        && (operand_83055 != NULL)) {
      macroValidPointer (operand_82956) ;
      macroValidPointer (operand_83055) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_82956->mType,  operand_83055->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2028)) ;
      if (((operand_82956->mFormalArgumentPassingMode) != (operand_83055->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_83055->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2030))) + (GGS_string (true, " is not compatible with ")))) + (operand_83055->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2031)))) SOURCE_FILE_AT_LINE (2031)) ;
      }
      operand_82956 = operand_82956->nextObject () ;
      operand_83055 = operand_83055->nextObject () ;
    }
  }
}
...
void GGS_M_metamodelsComponents::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_M_semanticsEntitiesForUse   & outParameter1,
                                GGS_entityToImplementMap   & outParameter2,
                                GGS_stringset   & outParameter3 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
GGS_M_constraintComponents GGS_M_constraintComponents::constructor_empty (UNUSED_LOCATION_ARGS) {
...
void GGS_M_constraintComponents::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
GGS_string GGS_typeListeAttributsAxiome::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
GGS_string GGS_L_grammarDescriptorForProgram::reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const {
  C_String s ;
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2164))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2170))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2173))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2176))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2179))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2182))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2185))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2188))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2191))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2198)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2201))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2206)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2209))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2212))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2217)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2220))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2223))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2228)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2231))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2234))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2237))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2242)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2245))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2248))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2251))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2256)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2259))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2262))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2267)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2270))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2273))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2276))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2281)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2284))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2287))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2290))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2293))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2298)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2301))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2304))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2307))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2310))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2315)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2318))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2323)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2326))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2331))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2334))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2339)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2342))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2347))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2352)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_99738 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_99738) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_99738->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2356)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100081 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100081) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100081->mMessagesMap ;
        GGS_L_lstringList  var_cas_100250 ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_100250 SOURCE_FILE_AT_LINE (2361)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2367)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2395)) SOURCE_FILE_AT_LINE (2395))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102046 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102055 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102046, var_cas_102055 SOURCE_FILE_AT_LINE (2402)) ;
    ...
    GGS_stringset::element_type * operand_102300 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_102300 != NULL)) {
      macroValidPointer (operand_102300) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_102300->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2416)) ;
      operand_102300 = operand_102300->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_102665 = var_cas_modelMap.firstObject () ;
    while ((operand_102665 != NULL)) {
      macroValidPointer (operand_102665) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_102665->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2427)) SOURCE_FILE_AT_LINE (2427))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (_inLexique, operand_102665->mKey, operand_102665->mInfo.mType SOURCE_FILE_AT_LINE (2428)) ;
      }
      operand_102665 = operand_102665->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_102878 = var_cas_actionMap.firstObject () ;
    while ((operand_102878 != NULL)) {
      macroValidPointer (operand_102878) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_102878->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2433)) SOURCE_FILE_AT_LINE (2433))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (_inLexique, operand_102878->mKey, operand_102878->mInfo.mSignature, operand_102878->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2434)) ;
      }
      operand_102878 = operand_102878->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents.addAssign_operation (var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2438))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2449))) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2449)) SOURCE_FILE_AT_LINE (2449))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2450))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_103681 ;
    GGS_bool var_cas_103684 ;
    GGS_entityPropertyMap  var_cas_103687 ;
    var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_103681, var_cas_103684, var_cas_103687, var_cas_superEntityName SOURCE_FILE_AT_LINE (2452)) ;
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2453)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
  GGS_L_propertyPath::element_type * operand_104425 = var_cas_inPath.firstObject () ;
  while ((operand_104425 != NULL)) {
    macroValidPointer (operand_104425) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_104425->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2474)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2474)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_104425->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2477)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2479)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2483)) SOURCE_FILE_AT_LINE (2483))))).isBuiltAndTrue ()) {
          operand_104425->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2485))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2485)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_105215 ;
      GGS_entityPropertyMap  var_cas_105218 ;
      GGS_lstring  var_cas_105221 ;
      var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_105215, var_cas_105218, var_cas_105221 SOURCE_FILE_AT_LINE (2490)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (_inLexique, operand_104425->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2493)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2495)) SOURCE_FILE_AT_LINE (2495))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_105587 ;
          GGS_lstring  var_cas_105590 ;
          var_cas_ioMapEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_105587, var_cas_105590 SOURCE_FILE_AT_LINE (2497)) ;
          GGS_bool var_cas_105659 ;
          GGS_entityPropertyMap  var_cas_105662 ;
          GGS_lstring  var_cas_105665 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_105659, var_cas_105662, var_cas_105665 SOURCE_FILE_AT_LINE (2498)) ;
        }else{
          GGS_bool var_cas_105746 ;
          GGS_entityPropertyMap  var_cas_105749 ;
          GGS_lstring  var_cas_105752 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_105746, var_cas_105749, var_cas_105752 SOURCE_FILE_AT_LINE (2500)) ;
        }
      }
    }
    operand_104425 = operand_104425->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_106067 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_106067 != NULL)) {
    macroValidPointer (operand_106067) ;
    if (((((operand_106067->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2515))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2515)))) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2515)) SOURCE_FILE_AT_LINE (2515))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_106067->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2516))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_106067->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2517)) ;
    }
    operand_106067 = operand_106067->nextObject () ;
  }
}
