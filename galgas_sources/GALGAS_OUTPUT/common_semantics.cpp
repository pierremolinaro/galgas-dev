...
void GGS_constrainedEntityMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_insertionList   & outParameter6,
                                GGS_indexMap   & outParameter7,
                                GGS_fetchedPropertyMap   & outParameter8 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_insertionList & inParameter6,
                                const GGS_indexMap & inParameter7,
                                const GGS_fetchedPropertyMap & inParameter8 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (864)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (984)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1015)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1116)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1147)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1258)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1267)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1276)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1406)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1408)) ;
  }else{
    GGS_L_signature::element_type * operand_56080 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_56179 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_56080 != NULL)
        && (operand_56179 != NULL)) {
      macroValidPointer (operand_56080) ;
      macroValidPointer (operand_56179) ;
      if (((operand_56080->mFormalArgumentPassingMode) != (operand_56179->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_56179->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_56080->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_56080->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1414)) ;
      }
      if (((operand_56080->mGalgasTypeName.reader_value ()) != (operand_56179->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_56179->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_56080->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_56179->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1417)) ;
      }
      operand_56080 = operand_56080->nextObject () ;
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1732)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1796)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_73978 = mNonExternAttributesList.firstObject () ;
  while ((operand_73978 != NULL)) {
    macroValidPointer (operand_73978) ;
    var_cas_outForeachList.addAssign_operation (operand_73978->mAttributType, operand_73978->aNomAttribut) ;
    operand_73978 = operand_73978->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1823)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1871)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1882)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1891)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1895)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1954)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79751 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79770 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79751 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79751) ;
    cPtr_typeGalgas_stringset * operand_79770 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79770) ;
    if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79751 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79751) ;
      cPtr_typeGalgas_uint * operand_79770 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79770) ;
      if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79751 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79751) ;
        cPtr_typeGalgas_sint * operand_79770 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79770) ;
        if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79751 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79751) ;
          cPtr_typeGalgas_char * operand_79770 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79770) ;
          if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79751 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79751) ;
            cPtr_typeGalgas_string * operand_79770 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79770) ;
            if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79751 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79751) ;
              cPtr_typeGalgas_bool * operand_79770 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79770) ;
              if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79751 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79751) ;
                cPtr_typeGalgas_double * operand_79770 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79770) ;
                if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79751 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79751) ;
                  cPtr_typeGalgas_lbool * operand_79770 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79770) ;
                  if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79751 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79751) ;
                    cPtr_typeGalgas_lchar * operand_79770 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79770) ;
                    if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79751 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79751) ;
                      cPtr_typeGalgas_luint * operand_79770 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79770) ;
                      if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79751 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79751) ;
                        cPtr_typeGalgas_lsint * operand_79770 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79770) ;
                        if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79751 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79751) ;
                          cPtr_typeGalgas_ldouble * operand_79770 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79770) ;
                          if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79751 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79751) ;
                            cPtr_typeGalgas_lstring * operand_79770 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79770) ;
                            if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79751 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79751) ;
                              cPtr_typeGalgas_location * operand_79770 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79770) ;
                              if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79751 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79751) ;
                                cPtr_typeGalgasUndefinedListType * operand_79770 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79770) ;
                                if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                                  if (((operand_79751->mListTypeName.reader_value ()) != (operand_79770->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79751->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79770->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1991)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79751 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79751) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79770 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79770) ;
                                  if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                                    if (((operand_79751->mMapTypeName.reader_value ()) != (operand_79770->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79751->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79770->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1997)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79751 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79751) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79770 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79770) ;
                                    if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                                      if (((operand_79751->mClassTypeName.reader_value ()) != (operand_79770->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79751->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79770->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2003)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79751 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79751) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79770 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79770) ;
                                      if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                                        if (((operand_79751->mGalgasClassName.reader_value ()) != (operand_79770->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79751->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79770->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2010)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79751 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79751) ;
                                        cPtr_typeGalgas_enum * operand_79770 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79770) ;
                                        if ((operand_79751 != NULL) && (operand_79770 != NULL)) {
                                          if (((operand_79751->mEnumTypeName.reader_value ()) != (operand_79770->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79751->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79770->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2017)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (2021)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2037)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2039)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_83556 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83655 = var_cas_signatureTestee.firstObject () ;
    while ((operand_83556 != NULL)
        && (operand_83655 != NULL)) {
      macroValidPointer (operand_83556) ;
      macroValidPointer (operand_83655) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_83556->mType,  operand_83655->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2043)) ;
      if (((operand_83556->mFormalArgumentPassingMode) != (operand_83655->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_83655->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_83655->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2046)) ;
      }
      operand_83556 = operand_83556->nextObject () ;
      operand_83655 = operand_83655->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2213)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2221)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2246)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2263)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2274)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2305)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2322)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2330)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2349)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2362)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_100184 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100184) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100184->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2366)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100527 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100527) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100527->mMessagesMap ;
        GGS_L_lstringList  var_cas_100696 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_100696 SOURCE_FILE_AT_LINE (2371)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2377)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102492 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102501 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102492, var_cas_102501 SOURCE_FILE_AT_LINE (2412)) ;
    ...
    GGS_stringset::element_type * operand_102746 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_102746 != NULL)) {
      macroValidPointer (operand_102746) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_102746->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2426)) ;
      operand_102746 = operand_102746->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_103111 = var_cas_modelMap.firstObject () ;
    while ((operand_103111 != NULL)) {
      macroValidPointer (operand_103111) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_103111->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_103111->mKey, operand_103111->mInfo.mType SOURCE_FILE_AT_LINE (2438)) ;
      }
      operand_103111 = operand_103111->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103324 = var_cas_actionMap.firstObject () ;
    while ((operand_103324 != NULL)) {
      macroValidPointer (operand_103324) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_103324->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_103324->mKey, operand_103324->mInfo.mSignature, operand_103324->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2444)) ;
      }
      operand_103324 = operand_103324->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_104127 ;
    GGS_bool var_cas_104130 ;
    GGS_entityPropertyMap  var_cas_104133 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_104127, var_cas_104130, var_cas_104133, var_cas_superEntityName SOURCE_FILE_AT_LINE (2462)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2463)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_104871 = var_cas_inPath.firstObject () ;
  while ((operand_104871 != NULL)) {
    macroValidPointer (operand_104871) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_104871->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_104871->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2489)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_104871->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2495)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_105661 ;
      GGS_entityPropertyMap  var_cas_105664 ;
      GGS_lstring  var_cas_105667 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105661, var_cas_105664, var_cas_105667 SOURCE_FILE_AT_LINE (2500)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_104871->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2503)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_106033 ;
          GGS_lstring  var_cas_106036 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_106033, var_cas_106036 SOURCE_FILE_AT_LINE (2507)) ;
          GGS_bool var_cas_106105 ;
          GGS_entityPropertyMap  var_cas_106108 ;
          GGS_lstring  var_cas_106111 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_106105, var_cas_106108, var_cas_106111 SOURCE_FILE_AT_LINE (2508)) ;
        }else{
          GGS_bool var_cas_106192 ;
          GGS_entityPropertyMap  var_cas_106195 ;
          GGS_lstring  var_cas_106198 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106192, var_cas_106195, var_cas_106198 SOURCE_FILE_AT_LINE (2510)) ;
        }
      }
    }
    operand_104871 = operand_104871->nextObject () ;
  }
}
