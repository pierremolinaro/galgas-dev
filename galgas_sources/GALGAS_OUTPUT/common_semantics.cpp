...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53940 = mNonExternAttributesList.firstObject () ;
  while ((operand_53940 != NULL)) {
    macroValidPointer (operand_53940) ;
    var_cas_outForeachList.addAssign_operation (operand_53940->mAttributType, operand_53940->aNomAttribut) ;
    operand_53940 = operand_53940->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60478 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_60497 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_60478 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60478) ;
    cPtr_typeGalgas_stringset * operand_60497 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60497) ;
    if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_60478 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60478) ;
      cPtr_typeGalgas_uint * operand_60497 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60497) ;
      if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_60478 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60478) ;
        cPtr_typeGalgas_sint * operand_60497 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60497) ;
        if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_60478 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60478) ;
          cPtr_typeGalgas_char * operand_60497 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60497) ;
          if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_60478 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60478) ;
            cPtr_typeGalgas_string * operand_60497 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60497) ;
            if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_60478 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60478) ;
              cPtr_typeGalgas_bool * operand_60497 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60497) ;
              if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_60478 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60478) ;
                cPtr_typeGalgas_double * operand_60497 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60497) ;
                if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_60478 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60478) ;
                  cPtr_typeGalgas_lbool * operand_60497 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60497) ;
                  if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_60478 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60478) ;
                    cPtr_typeGalgas_lchar * operand_60497 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60497) ;
                    if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_60478 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60478) ;
                      cPtr_typeGalgas_luint * operand_60497 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60497) ;
                      if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_60478 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60478) ;
                        cPtr_typeGalgas_lsint * operand_60497 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60497) ;
                        if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_60478 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60478) ;
                          cPtr_typeGalgas_ldouble * operand_60497 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60497) ;
                          if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_60478 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60478) ;
                            cPtr_typeGalgas_lstring * operand_60497 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60497) ;
                            if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_60478 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60478) ;
                              cPtr_typeGalgas_location * operand_60497 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60497) ;
                              if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_60478 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60478) ;
                                cPtr_typeGalgasUndefinedListType * operand_60497 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60497) ;
                                if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                                  if (((operand_60478->mListTypeName.reader_value ()) != (operand_60497->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60478->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60497->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_60478 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60478) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_60497 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60497) ;
                                  if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                                    if (((operand_60478->mMapTypeName.reader_value ()) != (operand_60497->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60478->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60497->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_60478 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60478) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_60497 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60497) ;
                                    if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                                      if (((operand_60478->mClassTypeName.reader_value ()) != (operand_60497->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60478->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60497->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_60478 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60478) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_60497 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60497) ;
                                      if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                                        if (((operand_60478->mGalgasClassName.reader_value ()) != (operand_60497->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60478->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60497->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_60478 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60478) ;
                                        cPtr_typeGalgas_enum * operand_60497 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60497) ;
                                        if ((operand_60478 != NULL) && (operand_60497 != NULL)) {
                                          if (((operand_60478->mEnumTypeName.reader_value ()) != (operand_60497->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60478->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60497->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_64279 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64378 = var_cas_signatureTestee.firstObject () ;
    while ((operand_64279 != NULL)
        && (operand_64378 != NULL)) {
      macroValidPointer (operand_64279) ;
      macroValidPointer (operand_64378) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_64279->mType,  operand_64378->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_64279->mFormalArgumentPassingMode) != (operand_64378->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64378->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64378->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_64279 = operand_64279->nextObject () ;
      operand_64378 = operand_64378->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_75870 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_75870) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_75870->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_76203 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_76203) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_76203->mMessagesMap ;
      GGS_L_lstringList  var_cas_76368 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_76368) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
