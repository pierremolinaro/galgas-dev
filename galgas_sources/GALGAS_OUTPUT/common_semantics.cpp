...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (851)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (936)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (971)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1002)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1033)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1068)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1103)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1134)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1245)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1254)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1263)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1393)) ;
    ...
    GGS_L_signature::element_type * operand_55732 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_55831 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_55732 != NULL)
        && (operand_55831 != NULL)) {
      macroValidPointer (operand_55732) ;
      macroValidPointer (operand_55831) ;
      if (((operand_55732->mFormalArgumentPassingMode) != (operand_55831->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_55831->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_55732->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_55732->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1401)) ;
      }
      if (((operand_55732->mGalgasTypeName.reader_value ()) != (operand_55831->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_55831->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_55732->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_55831->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1404)) ;
      }
      operand_55732 = operand_55732->nextObject () ;
      operand_55831 = operand_55831->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1719)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1783)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_73630 = mNonExternAttributesList.firstObject () ;
  while ((operand_73630 != NULL)) {
    macroValidPointer (operand_73630) ;
    var_cas_outForeachList.addAssign_operation (operand_73630->mAttributType, operand_73630->aNomAttribut) ;
    operand_73630 = operand_73630->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1810)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1858)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1869)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1878)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1882)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1941)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_79403 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_79422 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_79403 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79403) ;
    cPtr_typeGalgas_stringset * operand_79422 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_79422) ;
    if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_79403 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79403) ;
      cPtr_typeGalgas_uint * operand_79422 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_79422) ;
      if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_79403 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79403) ;
        cPtr_typeGalgas_sint * operand_79422 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_79422) ;
        if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_79403 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79403) ;
          cPtr_typeGalgas_char * operand_79422 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_79422) ;
          if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_79403 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79403) ;
            cPtr_typeGalgas_string * operand_79422 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_79422) ;
            if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_79403 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79403) ;
              cPtr_typeGalgas_bool * operand_79422 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_79422) ;
              if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_79403 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79403) ;
                cPtr_typeGalgas_double * operand_79422 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_79422) ;
                if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_79403 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79403) ;
                  cPtr_typeGalgas_lbool * operand_79422 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_79422) ;
                  if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_79403 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79403) ;
                    cPtr_typeGalgas_lchar * operand_79422 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_79422) ;
                    if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_79403 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79403) ;
                      cPtr_typeGalgas_luint * operand_79422 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_79422) ;
                      if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_79403 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79403) ;
                        cPtr_typeGalgas_lsint * operand_79422 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_79422) ;
                        if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_79403 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79403) ;
                          cPtr_typeGalgas_ldouble * operand_79422 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_79422) ;
                          if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_79403 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79403) ;
                            cPtr_typeGalgas_lstring * operand_79422 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_79422) ;
                            if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_79403 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79403) ;
                              cPtr_typeGalgas_location * operand_79422 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_79422) ;
                              if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_79403 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79403) ;
                                cPtr_typeGalgasUndefinedListType * operand_79422 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_79422) ;
                                if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                                  if (((operand_79403->mListTypeName.reader_value ()) != (operand_79422->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_79403->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_79422->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1978)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_79403 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79403) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_79422 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_79422) ;
                                  if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                                    if (((operand_79403->mMapTypeName.reader_value ()) != (operand_79422->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_79403->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_79422->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1984)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_79403 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79403) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_79422 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_79422) ;
                                    if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                                      if (((operand_79403->mClassTypeName.reader_value ()) != (operand_79422->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_79403->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_79422->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1990)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_79403 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79403) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_79422 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_79422) ;
                                      if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                                        if (((operand_79403->mGalgasClassName.reader_value ()) != (operand_79422->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_79403->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_79422->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1997)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_79403 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79403) ;
                                        cPtr_typeGalgas_enum * operand_79422 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_79422) ;
                                        if ((operand_79403 != NULL) && (operand_79422 != NULL)) {
                                          if (((operand_79403->mEnumTypeName.reader_value ()) != (operand_79422->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_79403->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_79422->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2004)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (2008)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2024)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2026)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_83208 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_83307 = var_cas_signatureTestee.firstObject () ;
    while ((operand_83208 != NULL)
        && (operand_83307 != NULL)) {
      macroValidPointer (operand_83208) ;
      macroValidPointer (operand_83307) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_83208->mType,  operand_83307->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2030)) ;
      if (((operand_83208->mFormalArgumentPassingMode) != (operand_83307->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_83307->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_83307->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2033)) ;
      }
      operand_83208 = operand_83208->nextObject () ;
      operand_83307 = operand_83307->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2199)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2207)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2249)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2260)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2291)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2308)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2316)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2335)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2348)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_99792 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_99792) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_99792->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2352)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_100135 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100135) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100135->mMessagesMap ;
        GGS_L_lstringList  var_cas_100304 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_100304 SOURCE_FILE_AT_LINE (2357)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2363)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_102100 ;
    GGS_M_semanticsEntitiesForUse  var_cas_102109 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_102100, var_cas_102109 SOURCE_FILE_AT_LINE (2398)) ;
    ...
    GGS_stringset::element_type * operand_102354 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_102354 != NULL)) {
      macroValidPointer (operand_102354) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_102354->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2412)) ;
      operand_102354 = operand_102354->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_102719 = var_cas_modelMap.firstObject () ;
    while ((operand_102719 != NULL)) {
      macroValidPointer (operand_102719) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_102719->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_102719->mKey, operand_102719->mInfo.mType SOURCE_FILE_AT_LINE (2424)) ;
      }
      operand_102719 = operand_102719->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_102932 = var_cas_actionMap.firstObject () ;
    while ((operand_102932 != NULL)) {
      macroValidPointer (operand_102932) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_102932->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_102932->mKey, operand_102932->mInfo.mSignature, operand_102932->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2430)) ;
      }
      operand_102932 = operand_102932->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_103735 ;
    GGS_bool var_cas_103738 ;
    GGS_entityPropertyMap  var_cas_103741 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_103735, var_cas_103738, var_cas_103741, var_cas_superEntityName SOURCE_FILE_AT_LINE (2448)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2449)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_104479 = var_cas_inPath.firstObject () ;
  while ((operand_104479 != NULL)) {
    macroValidPointer (operand_104479) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_104479->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_104479->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2475)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_104479->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2481)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_105269 ;
      GGS_entityPropertyMap  var_cas_105272 ;
      GGS_lstring  var_cas_105275 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105269, var_cas_105272, var_cas_105275 SOURCE_FILE_AT_LINE (2486)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_104479->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2489)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_105641 ;
          GGS_lstring  var_cas_105644 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_105641, var_cas_105644 SOURCE_FILE_AT_LINE (2493)) ;
          GGS_bool var_cas_105713 ;
          GGS_entityPropertyMap  var_cas_105716 ;
          GGS_lstring  var_cas_105719 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_105713, var_cas_105716, var_cas_105719 SOURCE_FILE_AT_LINE (2494)) ;
        }else{
          GGS_bool var_cas_105800 ;
          GGS_entityPropertyMap  var_cas_105803 ;
          GGS_lstring  var_cas_105806 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_105800, var_cas_105803, var_cas_105806 SOURCE_FILE_AT_LINE (2496)) ;
        }
      }
    }
    operand_104479 = operand_104479->nextObject () ;
  }
}
