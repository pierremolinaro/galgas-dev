...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_49270 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_49369 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_49270 != NULL)
        && (operand_49369 != NULL)) {
      macroValidPointer (operand_49270) ;
      macroValidPointer (operand_49369) ;
      if (((operand_49270->mFormalArgumentPassingMode) != (operand_49369->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_49369->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_49270->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_49270->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_49270->mGalgasTypeName.reader_value ()) != (operand_49369->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_49369->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_49270->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_49369->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_49270 = operand_49270->nextObject () ;
      operand_49369 = operand_49369->nextObject () ;
    }
  }
}
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mReturnedMetamodelName = inParameter2 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mReturnedMetamodelName ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66550 = mNonExternAttributesList.firstObject () ;
  while ((operand_66550 != NULL)) {
    macroValidPointer (operand_66550) ;
    var_cas_outForeachList.addAssign_operation (operand_66550->mAttributType, operand_66550->aNomAttribut) ;
    operand_66550 = operand_66550->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72323 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72342 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72323 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72323) ;
    cPtr_typeGalgas_stringset * operand_72342 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72342) ;
    if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72323 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72323) ;
      cPtr_typeGalgas_uint * operand_72342 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72342) ;
      if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72323 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72323) ;
        cPtr_typeGalgas_sint * operand_72342 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72342) ;
        if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72323 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72323) ;
          cPtr_typeGalgas_char * operand_72342 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72342) ;
          if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72323 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72323) ;
            cPtr_typeGalgas_string * operand_72342 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72342) ;
            if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72323 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72323) ;
              cPtr_typeGalgas_bool * operand_72342 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72342) ;
              if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72323 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72323) ;
                cPtr_typeGalgas_double * operand_72342 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72342) ;
                if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72323 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72323) ;
                  cPtr_typeGalgas_lbool * operand_72342 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72342) ;
                  if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72323 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72323) ;
                    cPtr_typeGalgas_lchar * operand_72342 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72342) ;
                    if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72323 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72323) ;
                      cPtr_typeGalgas_luint * operand_72342 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72342) ;
                      if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72323 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72323) ;
                        cPtr_typeGalgas_lsint * operand_72342 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72342) ;
                        if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72323 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72323) ;
                          cPtr_typeGalgas_ldouble * operand_72342 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72342) ;
                          if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72323 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72323) ;
                            cPtr_typeGalgas_lstring * operand_72342 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72342) ;
                            if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72323 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72323) ;
                              cPtr_typeGalgas_location * operand_72342 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72342) ;
                              if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72323 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72323) ;
                                cPtr_typeGalgasUndefinedListType * operand_72342 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72342) ;
                                if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                                  if (((operand_72323->mListTypeName.reader_value ()) != (operand_72342->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72323->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72342->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72323 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72323) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72342 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72342) ;
                                  if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                                    if (((operand_72323->mMapTypeName.reader_value ()) != (operand_72342->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72323->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72342->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72323 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72323) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72342 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72342) ;
                                    if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                                      if (((operand_72323->mClassTypeName.reader_value ()) != (operand_72342->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72323->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72342->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72323 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72323) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72342 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72342) ;
                                      if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                                        if (((operand_72323->mGalgasClassName.reader_value ()) != (operand_72342->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72323->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72342->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72323 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72323) ;
                                        cPtr_typeGalgas_enum * operand_72342 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72342) ;
                                        if ((operand_72323 != NULL) && (operand_72342 != NULL)) {
                                          if (((operand_72323->mEnumTypeName.reader_value ()) != (operand_72342->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72323->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72342->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_76128 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_76227 = var_cas_signatureTestee.firstObject () ;
    while ((operand_76128 != NULL)
        && (operand_76227 != NULL)) {
      macroValidPointer (operand_76128) ;
      macroValidPointer (operand_76227) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_76128->mType,  operand_76227->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_76128->mFormalArgumentPassingMode) != (operand_76227->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_76227->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_76227->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_76128 = operand_76128->nextObject () ;
      operand_76227 = operand_76227->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_89416 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89416) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89416->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_89759 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_89759) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_89759->mMessagesMap ;
        GGS_L_lstringList  var_cas_89928 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_89928) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_91724 ;
    GGS_M_semanticsEntitiesForUse  var_cas_91733 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_91724, var_cas_91733) ;
    ...
    GGS_stringset::element_type * operand_91978 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_91978 != NULL)) {
      macroValidPointer (operand_91978) ;
      ...
      operand_91978 = operand_91978->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_92343 = var_cas_modelMap.firstObject () ;
    while ((operand_92343 != NULL)) {
      macroValidPointer (operand_92343) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_92343->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_92343->mKey, operand_92343->mInfo.mType) ;
      }
      operand_92343 = operand_92343->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_92556 = var_cas_actionMap.firstObject () ;
    while ((operand_92556 != NULL)) {
      macroValidPointer (operand_92556) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_92556->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_92556->mKey, operand_92556->mInfo.mSignature, operand_92556->mInfo.mIsExtern) ;
      }
      operand_92556 = operand_92556->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value ()) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_93298 ;
    GGS_bool var_cas_93301 ;
    GGS_entityPropertyMap  var_cas_93304 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_93298, var_cas_93301, var_cas_93304, var_cas_superEntityName) ;
