...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34317 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34416 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34317 != NULL)
        && (operand_34416 != NULL)) {
      macroValidPointer (operand_34317) ;
      macroValidPointer (operand_34416) ;
      if (((operand_34317->mFormalArgumentPassingMode) != (operand_34416->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34416->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34317->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34317->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34317->mGalgasTypeName.reader_value ()) != (operand_34416->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34416->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34317->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34416->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34317 = operand_34317->nextObject () ;
      operand_34416 = operand_34416->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53263 = mNonExternAttributesList.firstObject () ;
  while ((operand_53263 != NULL)) {
    macroValidPointer (operand_53263) ;
    var_cas_outForeachList.addAssign_operation (operand_53263->mAttributType, operand_53263->aNomAttribut) ;
    operand_53263 = operand_53263->nextObject () ;
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59822 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59841 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_59822 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59822) ;
    cPtr_typeGalgas_uint * operand_59841 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59841) ;
    if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_59822 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59822) ;
      cPtr_typeGalgas_sint * operand_59841 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59841) ;
      if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_59822 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59822) ;
        cPtr_typeGalgas_char * operand_59841 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59841) ;
        if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_59822 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59822) ;
          cPtr_typeGalgas_string * operand_59841 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59841) ;
          if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_59822 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59822) ;
            cPtr_typeGalgas_bool * operand_59841 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59841) ;
            if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_59822 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59822) ;
              cPtr_typeGalgas_double * operand_59841 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59841) ;
              if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_59822 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59822) ;
                cPtr_typeGalgas_lbool * operand_59841 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59841) ;
                if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_59822 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59822) ;
                  cPtr_typeGalgas_lchar * operand_59841 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59841) ;
                  if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_59822 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59822) ;
                    cPtr_typeGalgas_luint * operand_59841 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59841) ;
                    if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_59822 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59822) ;
                      cPtr_typeGalgas_lsint * operand_59841 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59841) ;
                      if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_59822 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59822) ;
                        cPtr_typeGalgas_ldouble * operand_59841 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59841) ;
                        if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_59822 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59822) ;
                          cPtr_typeGalgas_lstring * operand_59841 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59841) ;
                          if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_59822 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59822) ;
                            cPtr_typeGalgas_location * operand_59841 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59841) ;
                            if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_59822 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59822) ;
                              cPtr_typeGalgasUndefinedListType * operand_59841 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59841) ;
                              if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                                if (((operand_59822->mListTypeName.reader_value ()) != (operand_59841->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59822->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59841->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_59822 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59822) ;
                                cPtr_typeGalgasUndefinedMapType * operand_59841 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59841) ;
                                if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                                  if (((operand_59822->mMapTypeName.reader_value ()) != (operand_59841->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59822->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59841->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_59822 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59822) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_59841 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59841) ;
                                  if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                                    if (((operand_59822->mClassTypeName.reader_value ()) != (operand_59841->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59822->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59841->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_59822 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59822) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_59841 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59841) ;
                                    if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                                      if (((operand_59822->mGalgasClassName.reader_value ()) != (operand_59841->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59822->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59841->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_59822 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59822) ;
                                      cPtr_typeGalgas_enum * operand_59841 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59841) ;
                                      if ((operand_59822 != NULL) && (operand_59841 != NULL)) {
                                        if (((operand_59822->mEnumTypeName.reader_value ()) != (operand_59841->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59822->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59841->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_63562 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_63661 = var_cas_signatureTestee.firstObject () ;
    while ((operand_63562 != NULL)
        && (operand_63661 != NULL)) {
      macroValidPointer (operand_63562) ;
      macroValidPointer (operand_63661) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_63562->mType,  operand_63661->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_63562->mFormalArgumentPassingMode) != (operand_63661->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_63661->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_63661->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_63562 = operand_63562->nextObject () ;
      operand_63661 = operand_63661->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_73775 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73775) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73775->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74113 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74113) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74113->mMessagesMap ;
