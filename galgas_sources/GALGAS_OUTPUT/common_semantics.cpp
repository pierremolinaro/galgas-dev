...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/developpements/mes_prgms/galgas/galgas_sources/common_semantics.ggs" ;
...
methode_acceptAssignmentFromHere (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "assignment from 'here' is not allowed for variables of this type") SOURCE_FILE_AT_LINE (366)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type cannot be enumerated by in 'foreach' instruction") SOURCE_FILE_AT_LINE (376)) ;
}
...
methode_acceptToBeKeyForMap (C_Lexique & lexique_var_) {
    GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this type cannot be a key for map") SOURCE_FILE_AT_LINE (381)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
    ...
    var_cas_inModifierName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (390)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
    ...
    var_cas_inReaderName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader instruction") SOURCE_FILE_AT_LINE (400)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
    ...
    var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (408)) ;
}
...
methode_handleAddAssignOperatorCall (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (419)) ;
}
...
methode_handleIncrementOperatorCall (C_Lexique & lexique_var_,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (427)) ;
}
...
methode_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & lexique_var_) {
    GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (433)) ;
}
...
void GGS_entityPropertyMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_metamodelPropertyKind  & outParameter0,
                                GGS_lstring   & outParameter1,
                                GGS_L_ListOfPropertyPathes   & outParameter2 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_metamodelPropertyKind& inParameter0,
                                const GGS_lstring & inParameter1,
                                const GGS_L_ListOfPropertyPathes & inParameter2 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mMapAttributeName.reader_description () ;
  ioString << mInfo.mIndexName.reader_description () ;
  ioString << "]" ;
}
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mMapAttributeName = inParameter2 ;
    info.mIndexName = inParameter3 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mMapAttributeName ;
    outParameter3 = node->mInfo.mIndexName ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
GGS_string GGS_insertionMap::reader_description (void) const {
  C_String s ;
  s << "<map @insertionMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mMapReferenceName.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_indexMap::reader_description (void) const {
  C_String s ;
  s << "<map @indexMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     class map 'insertedPropertyMap'                       *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_insertedPropertyMap::
elementOf_GGS_insertedPropertyMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
void elementOf_GGS_insertedPropertyMap::
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mMaps.reader_description () ;
  ioString << "]" ;
}

//---------------------------------------------------------------------------*

AC_galgas_map_element * GGS_insertedPropertyMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_insertedPropertyMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  e_insertedPropertyMap * info = (e_insertedPropertyMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_insertedPropertyMap GGS_insertedPropertyMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_insertedPropertyMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_insertedPropertyMap::internalInsertForDuplication (AC_galgas_map_element * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_insertedPropertyMap info  ;
    info.mMaps = inParameter0 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mMaps ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
methode_insertKey (C_Lexique & lexique_var_,
  ...
  insertElement (lexique_var_,
                 "the '%K' inserted attribute has been already declared in %L",
                 inKey,
                 inParameter0,
                 NULL
                 COMMA_THERE) ;
...
GGS_string GGS_insertedPropertyMap::reader_description (void) const {
  C_String s ;
  s << "<map @insertedPropertyMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
    element_type * p = firstObject () ;
    while (p != NULL) {
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mDomainVariableName.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_relationVarMap::reader_description (void) const {
  C_String s ;
...
void cPtr_metamodelRelationAnd::appendForDescription (C_String & ioString) const {
...
void cPtr_metamodelRelationOr::appendForDescription (C_String & ioString) const {
...
void cPtr_metamodelRelationNot::appendForDescription (C_String & ioString) const {
...
void cPtr_metamodelRelationTrue::appendForDescription (C_String & ioString) const {
...
void cPtr_metamodelRelationFalse::appendForDescription (C_String & ioString) const {
...
void cPtr_metamodelRelationPrimary::appendForDescription (C_String & ioString) const {
  ioString << "->@metamodelRelationPrimary:" ;
mRelationVariableMap.reader_description () ;
mVariable.reader_description () ;
mVariableIndex.reader_description () ;
mVariableMap.reader_description () ;
mDomainName.reader_description () ;
}
...
appendForListDescription (C_String & ioString) const {
  ioString << "[" ;
  ioString << mParameter.reader_description () ;
  ioString << mParameterIndex.reader_description () ;
  ioString << mDomainVariable.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_metamodelRelationParameterList::reader_description (void) const {
  C_String s ;
...
void cPtr_metamodelRelationDo::appendForDescription (C_String & ioString) const {
  ioString << "->@metamodelRelationDo:" ;
mRelationVariableMap.reader_description () ;
mParameterList.reader_description () ;
mPath.reader_description () ;
mOperationIsAnd.reader_description () ;
}
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mRelationVarMap.reader_description () ;
  ioString << mInfo.mExpression.reader_description () ;
  ioString << "]" ;
}
...
GGS_string GGS_relationMap::reader_description (void) const {
  C_String s ;
  s << "<map @relationMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
appendForMapDescription (C_String & ioString) const {
  ioString << "["
           << mKey.reader_description () ;
  ioString << "->" ;
  ioString << mInfo.mElementEntityName.reader_description () ;
...
GGS_string GGS_mapEntityMap::reader_description (void) const {
  C_String s ;
  s << "<map @mapEntityMap " ;
  if (isBuilt ()) {
    s << count () << " object" << ((count () > 1) ? "s " : " ") ;
...
GGS_string GGS_mapAndEntityUniqueMap::reader_description (void) const {
  C_String s ;
...
appendForMapDescription (C_String & ioString) const {
  ...
  ioString << mInfo.mInsertedPropertyMap.reader_description () ;
  ioString << mInfo.mAllInsertedPropertyMap.reader_description () ;
  ioString << mInfo.mRelationMap.reader_description () ;
  ioString << mInfo.mAllRelationMap.reader_description () ;
  ioString << mInfo.mIndexMap.reader_description () ;
  ioString << mInfo.mAllIndexMap.reader_description () ;
  ioString << "]" ;
}
...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_lstring &  inParameter3,
               const GGS_contextPropertyMap &  inParameter4,
               const GGS_fetchedPropertyMap &  inParameter5,
               const GGS_fetchedPropertyMap &  inParameter6,
               const GGS_insertedPropertyMap &  inParameter7,
               const GGS_insertedPropertyMap &  inParameter8,
               const GGS_relationMap &  inParameter9,
               const GGS_relationMap &  inParameter10,
               const GGS_indexMap &  inParameter11,
               const GGS_indexMap &  inParameter12,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mAllContextAttributes = inParameter4 ;
    info.mFetchedPropertyMap = inParameter5 ;
    info.mAllFetchedPropertyMap = inParameter6 ;
    info.mInsertedPropertyMap = inParameter7 ;
    info.mAllInsertedPropertyMap = inParameter8 ;
    info.mRelationMap = inParameter9 ;
    info.mAllRelationMap = inParameter10 ;
    info.mIndexMap = inParameter11 ;
    info.mAllIndexMap = inParameter12 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_lstring   & outParameter3,
               GGS_contextPropertyMap   & outParameter4,
               GGS_fetchedPropertyMap   & outParameter5,
               GGS_fetchedPropertyMap   & outParameter6,
               GGS_insertedPropertyMap   & outParameter7,
               GGS_insertedPropertyMap   & outParameter8,
               GGS_relationMap   & outParameter9,
               GGS_relationMap   & outParameter10,
               GGS_indexMap   & outParameter11,
               GGS_indexMap   & outParameter12,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter11.drop_operation () ;
    outParameter12.drop_operation () ;
    if (outIndex != NULL) {
      outIndex->drop_operation () ;
     }
  }else{
    ...
    outParameter4 = node->mInfo.mAllContextAttributes ;
    outParameter5 = node->mInfo.mFetchedPropertyMap ;
    outParameter6 = node->mInfo.mAllFetchedPropertyMap ;
    outParameter7 = node->mInfo.mInsertedPropertyMap ;
    outParameter8 = node->mInfo.mAllInsertedPropertyMap ;
    outParameter9 = node->mInfo.mRelationMap ;
    outParameter10 = node->mInfo.mAllRelationMap ;
    outParameter11 = node->mInfo.mIndexMap ;
    outParameter12 = node->mInfo.mAllIndexMap ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_entityToImplementMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_relationMap   & outParameter10,
                                GGS_indexMap   & outParameter11,
                                GGS_indexMap   & outParameter12 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_relationMap & inParameter10,
                                const GGS_indexMap & inParameter11,
                                const GGS_indexMap & inParameter12 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (831)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (916)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (951)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (982)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1013)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1048)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1083)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1114)) ;
  }
}
...
void GGS_typeTableMethodes::methode_searchKey (C_Lexique & inLexique,
  ...
  GGS_typeTableMethodes::element_type * info = searchKey (inLexique, inKey, inKey, "there is no reader named '%'" COMMA_THERE) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
  }else{
...
void GGS_typeTableMethodes::methode_searchForOverride (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_L_EXsignature   & outParameter0 COMMA_LOCATION_ARGS) {
  GGS_typeTableMethodes::element_type * info = searchForOverride (inLexique, inKey, inKey, "the reader '%' cannot be overriden : it is not declared in superclass" COMMA_THERE) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
  }else{
    outParameter0 = info->mInfo.aListeTypesParametres ;
...
void GGS_typeTableMethodes::methode_insertAbstract (C_Lexique & lexique_var_,
  ...
  insertAbstract (lexique_var_, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
}
...
void GGS_typeTableMethodes::methode_insertAbstractGetIndex (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertAbstract (lexique_var_, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_typeTableMethodes::methode_insertNotAbstract (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  insertNotAbstract (lexique_var_, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
}
...
void GGS_typeTableMethodes::methode_insertNotAbstractGetIndex (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertNotAbstract (lexique_var_, info, inKey, inKey, "a reader named '%' is already declared" COMMA_THERE) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1225)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1234)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1243)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
                                ...
                                const GGS_location  & var_cas_inEndOfListLocation COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1372)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1374)) ;
  }else{
    GGS_L_signature::element_type * operand_54838 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_54937 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_54838 != NULL)
        && (operand_54937 != NULL)) {
      macroValidPointer (operand_54838) ;
      macroValidPointer (operand_54937) ;
      if (((operand_54838->mFormalArgumentPassingMode) != (operand_54937->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_54937->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_54838->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_54838->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1380)) ;
      }
      if (((operand_54838->mGalgasTypeName.reader_value ()) != (operand_54937->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_54937->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_54838->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_54937->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1383)) ;
      }
      operand_54838 = operand_54838->nextObject () ;
      operand_54937 = operand_54937->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1698)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1762)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_72736 = mNonExternAttributesList.firstObject () ;
  while ((operand_72736 != NULL)) {
    macroValidPointer (operand_72736) ;
    var_cas_outForeachList.addAssign_operation (operand_72736->mAttributType, operand_72736->aNomAttribut) ;
    operand_72736 = operand_72736->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1789)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1837)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1848)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1857)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1861)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1920)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_78509 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_78528 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_78509 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78509) ;
    cPtr_typeGalgas_stringset * operand_78528 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78528) ;
    if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_78509 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78509) ;
      cPtr_typeGalgas_uint * operand_78528 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78528) ;
      if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_78509 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78509) ;
        cPtr_typeGalgas_sint * operand_78528 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78528) ;
        if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_78509 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78509) ;
          cPtr_typeGalgas_char * operand_78528 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78528) ;
          if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_78509 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78509) ;
            cPtr_typeGalgas_string * operand_78528 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78528) ;
            if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_78509 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78509) ;
              cPtr_typeGalgas_bool * operand_78528 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78528) ;
              if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_78509 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78509) ;
                cPtr_typeGalgas_double * operand_78528 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78528) ;
                if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_78509 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78509) ;
                  cPtr_typeGalgas_lbool * operand_78528 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78528) ;
                  if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_78509 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78509) ;
                    cPtr_typeGalgas_lchar * operand_78528 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78528) ;
                    if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_78509 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78509) ;
                      cPtr_typeGalgas_luint * operand_78528 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78528) ;
                      if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_78509 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78509) ;
                        cPtr_typeGalgas_lsint * operand_78528 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78528) ;
                        if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_78509 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78509) ;
                          cPtr_typeGalgas_ldouble * operand_78528 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78528) ;
                          if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_78509 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78509) ;
                            cPtr_typeGalgas_lstring * operand_78528 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78528) ;
                            if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_78509 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78509) ;
                              cPtr_typeGalgas_location * operand_78528 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78528) ;
                              if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_78509 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78509) ;
                                cPtr_typeGalgasUndefinedListType * operand_78528 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78528) ;
                                if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                                  if (((operand_78509->mListTypeName.reader_value ()) != (operand_78528->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_78509->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_78528->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1957)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_78509 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78509) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_78528 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78528) ;
                                  if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                                    if (((operand_78509->mMapTypeName.reader_value ()) != (operand_78528->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_78509->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_78528->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1963)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_78509 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78509) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_78528 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78528) ;
                                    if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                                      if (((operand_78509->mClassTypeName.reader_value ()) != (operand_78528->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_78509->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_78528->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1969)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_78509 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78509) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_78528 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78528) ;
                                      if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                                        if (((operand_78509->mGalgasClassName.reader_value ()) != (operand_78528->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_78509->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_78528->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1976)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_78509 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78509) ;
                                        cPtr_typeGalgas_enum * operand_78528 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78528) ;
                                        if ((operand_78509 != NULL) && (operand_78528 != NULL)) {
                                          if (((operand_78509->mEnumTypeName.reader_value ()) != (operand_78528->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_78509->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_78528->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1983)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1987)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2003)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2005)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_82314 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_82413 = var_cas_signatureTestee.firstObject () ;
    while ((operand_82314 != NULL)
        && (operand_82413 != NULL)) {
      macroValidPointer (operand_82314) ;
      macroValidPointer (operand_82413) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_82314->mType,  operand_82413->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2009)) ;
      if (((operand_82314->mFormalArgumentPassingMode) != (operand_82413->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_82413->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_82413->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2012)) ;
      }
      operand_82314 = operand_82314->nextObject () ;
      operand_82413 = operand_82413->nextObject () ;
    }
  }
}
...
void GGS_M_metamodelsComponents::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0,
                                GGS_M_semanticsEntitiesForUse   & outParameter1 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0,
                                const GGS_M_semanticsEntitiesForUse & inParameter1 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2164)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2175)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2186)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2200)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2211)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2222)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2236)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2250)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2258)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2277)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2290)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_96932 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96932) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96932->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2294)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_97275 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_97275) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_97275->mMessagesMap ;
        GGS_L_lstringList  var_cas_97444 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_97444 SOURCE_FILE_AT_LINE (2299)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2305)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_99240 ;
    GGS_M_semanticsEntitiesForUse  var_cas_99249 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_99240, var_cas_99249 SOURCE_FILE_AT_LINE (2340)) ;
    ...
    GGS_stringset::element_type * operand_99494 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_99494 != NULL)) {
      macroValidPointer (operand_99494) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_99494->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2354)) ;
      operand_99494 = operand_99494->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_99859 = var_cas_modelMap.firstObject () ;
    while ((operand_99859 != NULL)) {
      macroValidPointer (operand_99859) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_99859->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_99859->mKey, operand_99859->mInfo.mType SOURCE_FILE_AT_LINE (2366)) ;
      }
      operand_99859 = operand_99859->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_100072 = var_cas_actionMap.firstObject () ;
    while ((operand_100072 != NULL)) {
      macroValidPointer (operand_100072) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_100072->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_100072->mKey, operand_100072->mInfo.mSignature, operand_100072->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2372)) ;
      }
      operand_100072 = operand_100072->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_100875 ;
    GGS_bool var_cas_100878 ;
    GGS_entityPropertyMap  var_cas_100881 ;
    GGS_contextPropertyMap  var_cas_100901 ;
    GGS_fetchedPropertyMap  var_cas_100904 ;
    GGS_fetchedPropertyMap  var_cas_100907 ;
    GGS_insertedPropertyMap  var_cas_100910 ;
    GGS_insertedPropertyMap  var_cas_100913 ;
    GGS_relationMap  var_cas_100916 ;
    GGS_relationMap  var_cas_100919 ;
    GGS_indexMap  var_cas_100922 ;
    GGS_indexMap  var_cas_100925 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_100875, var_cas_100878, var_cas_100881, var_cas_superEntityName, var_cas_100901, var_cas_100904, var_cas_100907, var_cas_100910, var_cas_100913, var_cas_100916, var_cas_100919, var_cas_100922, var_cas_100925 SOURCE_FILE_AT_LINE (2390)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2391)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
                                GGS_entityToImplementMap  & var_cas_ioEntityMap,
  ...
  GGS_L_propertyPath::element_type * operand_101646 = var_cas_inPath.firstObject () ;
  while ((operand_101646 != NULL)) {
    macroValidPointer (operand_101646) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_101646->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_101646->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2417)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_101646->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2423)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_102436 ;
      GGS_entityPropertyMap  var_cas_102439 ;
      GGS_lstring  var_cas_102442 ;
      GGS_contextPropertyMap  var_cas_102445 ;
      GGS_fetchedPropertyMap  var_cas_102448 ;
      GGS_fetchedPropertyMap  var_cas_102451 ;
      GGS_insertedPropertyMap  var_cas_102454 ;
      GGS_insertedPropertyMap  var_cas_102457 ;
      GGS_relationMap  var_cas_102460 ;
      GGS_relationMap  var_cas_102463 ;
      GGS_indexMap  var_cas_102466 ;
      GGS_indexMap  var_cas_102469 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102436, var_cas_102439, var_cas_102442, var_cas_102445, var_cas_102448, var_cas_102451, var_cas_102454, var_cas_102457, var_cas_102460, var_cas_102463, var_cas_102466, var_cas_102469 SOURCE_FILE_AT_LINE (2428)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_102598 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_101646->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_102598 SOURCE_FILE_AT_LINE (2431)) ;
      if (((var_cas_outKind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))).isBuiltAndTrue ()) {
        GGS_lstring  var_cas_elementEntity ;
        GGS_lstring  var_cas_102766 ;
        GGS_lstring  var_cas_102769 ;
        var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_102766, var_cas_102769 SOURCE_FILE_AT_LINE (2434)) ;
        GGS_bool var_cas_102836 ;
        GGS_entityPropertyMap  var_cas_102839 ;
        GGS_lstring  var_cas_102842 ;
        GGS_contextPropertyMap  var_cas_102845 ;
        GGS_fetchedPropertyMap  var_cas_102848 ;
        GGS_fetchedPropertyMap  var_cas_102851 ;
        GGS_insertedPropertyMap  var_cas_102854 ;
        GGS_insertedPropertyMap  var_cas_102857 ;
        GGS_relationMap  var_cas_102860 ;
        GGS_relationMap  var_cas_102863 ;
        GGS_indexMap  var_cas_102866 ;
        GGS_indexMap  var_cas_102869 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_102836, var_cas_102839, var_cas_102842, var_cas_102845, var_cas_102848, var_cas_102851, var_cas_102854, var_cas_102857, var_cas_102860, var_cas_102863, var_cas_102866, var_cas_102869 SOURCE_FILE_AT_LINE (2435)) ;
      }else if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_103112 ;
          GGS_lstring  var_cas_103115 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_103112, var_cas_103115 SOURCE_FILE_AT_LINE (2439)) ;
          GGS_bool var_cas_103184 ;
          GGS_entityPropertyMap  var_cas_103187 ;
          GGS_lstring  var_cas_103190 ;
          GGS_contextPropertyMap  var_cas_103193 ;
          GGS_fetchedPropertyMap  var_cas_103196 ;
          GGS_fetchedPropertyMap  var_cas_103199 ;
          GGS_insertedPropertyMap  var_cas_103202 ;
          GGS_insertedPropertyMap  var_cas_103205 ;
          GGS_relationMap  var_cas_103208 ;
          GGS_relationMap  var_cas_103211 ;
          GGS_indexMap  var_cas_103214 ;
          GGS_indexMap  var_cas_103217 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_103184, var_cas_103187, var_cas_103190, var_cas_103193, var_cas_103196, var_cas_103199, var_cas_103202, var_cas_103205, var_cas_103208, var_cas_103211, var_cas_103214, var_cas_103217 SOURCE_FILE_AT_LINE (2440)) ;
        }else{
          GGS_bool var_cas_103298 ;
          GGS_entityPropertyMap  var_cas_103301 ;
          GGS_lstring  var_cas_103304 ;
          GGS_contextPropertyMap  var_cas_103307 ;
          GGS_fetchedPropertyMap  var_cas_103310 ;
          GGS_fetchedPropertyMap  var_cas_103313 ;
          GGS_insertedPropertyMap  var_cas_103316 ;
          GGS_insertedPropertyMap  var_cas_103319 ;
          GGS_relationMap  var_cas_103322 ;
          GGS_relationMap  var_cas_103325 ;
          GGS_indexMap  var_cas_103328 ;
          GGS_indexMap  var_cas_103331 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_103298, var_cas_103301, var_cas_103304, var_cas_103307, var_cas_103310, var_cas_103313, var_cas_103316, var_cas_103319, var_cas_103322, var_cas_103325, var_cas_103328, var_cas_103331 SOURCE_FILE_AT_LINE (2442)) ;
        }
      }
    }
    operand_101646 = operand_101646->nextObject () ;
  }
}
