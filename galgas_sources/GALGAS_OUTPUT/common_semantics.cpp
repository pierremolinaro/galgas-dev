...
methode_handleAddAssignOperatorCall (C_Lexique & _inLexique,
    ...
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '+=' operator") SOURCE_FILE_AT_LINE (429)) ;
}
...
methode_handleIncrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '++' operator") SOURCE_FILE_AT_LINE (437)) ;
}
...
methode_handleDecrementOperatorCall (C_Lexique & _inLexique,
                                GGS_location  var_cas_inErrorLocation) {
    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support call of '--' operator") SOURCE_FILE_AT_LINE (445)) ;
}
...
methode_checkAbilityToBeSilentlyConvertedToLocation (C_Lexique & _inLexique) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type cannot be silently converted to @location value") SOURCE_FILE_AT_LINE (451)) ;
}
...
methode_getTypeName (C_Lexique & _inLexique,
  ...
  var_cas_outTypeName = mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (662)) ;
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = ((GGS_string (true, "_listOf_")) + (mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (675)))) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (816))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (818))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (821)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (854))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (857)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (935))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (942)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (970))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (977)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1001))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1008)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1032))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1039)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1067))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1074)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1102))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1109)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1137))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1140)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1201)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_constructorMap.methode_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1246)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1255)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1264)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1393))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1393)))).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1394))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1394)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1395))) > (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1395)))).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1396))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1396)) ;
  }else{
    GGS_L_signature::element_type * operand_55469 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_55568 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_55469 != NULL)
        && (operand_55568 != NULL)) {
      macroValidPointer (operand_55469) ;
      macroValidPointer (operand_55568) ;
      if (((operand_55469->mFormalArgumentPassingMode) != (operand_55568->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_55568->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_55469->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1401))))) + (GGS_string (true, ", and ")))) + (operand_55469->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1402))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1402)) ;
      }
      if (((operand_55469->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1404))) != (operand_55568->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1404)))).isBuiltAndTrue ()) {
          operand_55568->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_55469->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1405))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_55568->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1405))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1405)) ;
      }
      operand_55469 = operand_55469->nextObject () ;
      operand_55568 = operand_55568->nextObject () ;
    }
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1650)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1692))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1695)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1726)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1759)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_72673 = mNonExternAttributesList.firstObject () ;
  while ((operand_72673 != NULL)) {
    macroValidPointer (operand_72673) ;
    var_cas_outForeachList.addAssign_operation (operand_72673->mAttributType, operand_72673->aNomAttribut) ;
    operand_72673 = operand_72673->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1783))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1786)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1804)) ;
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & _inLexique) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1834)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1845)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1854)) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1855))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
      var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1858)) ;
  }
}
...
methode_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName) {
  var_cas_outTypeName = mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1908)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_enumConstantesMap.methode_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1917)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_78441 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_78460 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_78441 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78441) ;
    cPtr_typeGalgas_stringset * operand_78460 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78460) ;
    if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_78441 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78441) ;
      cPtr_typeGalgas_uint * operand_78460 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78460) ;
      if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_78441 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78441) ;
        cPtr_typeGalgas_sint * operand_78460 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78460) ;
        if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_78441 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78441) ;
          cPtr_typeGalgas_char * operand_78460 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78460) ;
          if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_78441 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78441) ;
            cPtr_typeGalgas_string * operand_78460 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78460) ;
            if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_78441 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78441) ;
              cPtr_typeGalgas_bool * operand_78460 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78460) ;
              if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_78441 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78441) ;
                cPtr_typeGalgas_double * operand_78460 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78460) ;
                if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_78441 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78441) ;
                  cPtr_typeGalgas_lbool * operand_78460 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78460) ;
                  if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_78441 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78441) ;
                    cPtr_typeGalgas_lchar * operand_78460 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78460) ;
                    if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_78441 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78441) ;
                      cPtr_typeGalgas_luint * operand_78460 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78460) ;
                      if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_78441 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78441) ;
                        cPtr_typeGalgas_lsint * operand_78460 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78460) ;
                        if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_78441 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78441) ;
                          cPtr_typeGalgas_ldouble * operand_78460 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78460) ;
                          if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_78441 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78441) ;
                            cPtr_typeGalgas_lstring * operand_78460 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78460) ;
                            if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_78441 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78441) ;
                              cPtr_typeGalgas_location * operand_78460 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78460) ;
                              if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_78441 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78441) ;
                                cPtr_typeGalgasUndefinedListType * operand_78460 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78460) ;
                                if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                                  if (((operand_78441->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1952))) != (operand_78460->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1952)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_78441->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1953))))) + (GGS_string (true, "', I have got the list type '")))) + (operand_78460->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1954))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1954)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_78441 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78441) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_78460 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78460) ;
                                  if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                                    if (((operand_78441->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1958))) != (operand_78460->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1958)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_78441->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1959))))) + (GGS_string (true, "', I have got the map type '")))) + (operand_78460->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1960))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1960)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_78441 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78441) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_78460 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78460) ;
                                    if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                                      if (((operand_78441->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1964))) != (operand_78460->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1964)))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_78441->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1965))))) + (GGS_string (true, "', I have got the class type '")))) + (operand_78460->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1966))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1966)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_78441 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78441) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_78460 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78460) ;
                                      if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                                        if (((operand_78441->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1971))) != (operand_78460->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1971)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_78441->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1972))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_78460->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1973))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1973)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_78441 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78441) ;
                                        cPtr_typeGalgas_enum * operand_78460 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78460) ;
                                        if ((operand_78441 != NULL) && (operand_78460 != NULL)) {
                                          if (((operand_78441->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1978))) != (operand_78460->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1978)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_78441->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1979))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_78460->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1980))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1980)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (1984))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (1984)))) SOURCE_FILE_AT_LINE (1984)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (1999))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (1999)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2000)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2001))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2001)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2002)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_82246 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_82345 = var_cas_signatureTestee.firstObject () ;
    while ((operand_82246 != NULL)
        && (operand_82345 != NULL)) {
      macroValidPointer (operand_82246) ;
      macroValidPointer (operand_82345) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_82246->mType,  operand_82345->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2006)) ;
      if (((operand_82246->mFormalArgumentPassingMode) != (operand_82345->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_82345->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2008))) + (GGS_string (true, " is not compatible with ")))) + (operand_82345->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2009)))) SOURCE_FILE_AT_LINE (2009)) ;
      }
      operand_82246 = operand_82246->nextObject () ;
      operand_82345 = operand_82345->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2142))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2148))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2151))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2154))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2157))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2160))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2163))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2166))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2169))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2176)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2179))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2184)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2187))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2190))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2195)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2198))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2201))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2209))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2212))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2215))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2220)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2223))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2226))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2229))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2234)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2237))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2240))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2245)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2248))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2251))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2254))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2259)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2262))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2265))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2268))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2271))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2276)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2279))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2282))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2285))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2288))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2293)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2296))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2301)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2304))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2309))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2312))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2317)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2320))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2325))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2330)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_99028 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_99028) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_99028->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2334)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_99371 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_99371) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_99371->mMessagesMap ;
        GGS_L_lstringList  var_cas_99540 ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_99540 SOURCE_FILE_AT_LINE (2339)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2345)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2373)) SOURCE_FILE_AT_LINE (2373))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_101336 ;
    GGS_M_semanticsEntitiesForUse  var_cas_101345 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_101336, var_cas_101345 SOURCE_FILE_AT_LINE (2380)) ;
    ...
    GGS_stringset::element_type * operand_101590 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_101590 != NULL)) {
      macroValidPointer (operand_101590) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_101590->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2394)) ;
      operand_101590 = operand_101590->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_101955 = var_cas_modelMap.firstObject () ;
    while ((operand_101955 != NULL)) {
      macroValidPointer (operand_101955) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_101955->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2405)) SOURCE_FILE_AT_LINE (2405))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (_inLexique, operand_101955->mKey, operand_101955->mInfo.mType SOURCE_FILE_AT_LINE (2406)) ;
      }
      operand_101955 = operand_101955->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_102168 = var_cas_actionMap.firstObject () ;
    while ((operand_102168 != NULL)) {
      macroValidPointer (operand_102168) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_102168->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2411)) SOURCE_FILE_AT_LINE (2411))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (_inLexique, operand_102168->mKey, operand_102168->mInfo.mSignature, operand_102168->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2412)) ;
      }
      operand_102168 = operand_102168->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents.addAssign_operation (var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2416))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2427))) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2427)) SOURCE_FILE_AT_LINE (2427))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2428))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_102971 ;
    GGS_bool var_cas_102974 ;
    GGS_entityPropertyMap  var_cas_102977 ;
    var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_102971, var_cas_102974, var_cas_102977, var_cas_superEntityName SOURCE_FILE_AT_LINE (2430)) ;
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2431)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_103715 = var_cas_inPath.firstObject () ;
  while ((operand_103715 != NULL)) {
    macroValidPointer (operand_103715) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_103715->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2452)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2452)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_103715->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2455)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2457)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2461)) SOURCE_FILE_AT_LINE (2461))))).isBuiltAndTrue ()) {
          operand_103715->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2463))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2463)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_104505 ;
      GGS_entityPropertyMap  var_cas_104508 ;
      GGS_lstring  var_cas_104511 ;
      var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_104505, var_cas_104508, var_cas_104511 SOURCE_FILE_AT_LINE (2468)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (_inLexique, operand_103715->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2471)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2473)) SOURCE_FILE_AT_LINE (2473))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_104877 ;
          GGS_lstring  var_cas_104880 ;
          var_cas_ioMapEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_104877, var_cas_104880 SOURCE_FILE_AT_LINE (2475)) ;
          GGS_bool var_cas_104949 ;
          GGS_entityPropertyMap  var_cas_104952 ;
          GGS_lstring  var_cas_104955 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_104949, var_cas_104952, var_cas_104955 SOURCE_FILE_AT_LINE (2476)) ;
        }else{
          GGS_bool var_cas_105036 ;
          GGS_entityPropertyMap  var_cas_105039 ;
          GGS_lstring  var_cas_105042 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_105036, var_cas_105039, var_cas_105042 SOURCE_FILE_AT_LINE (2478)) ;
        }
      }
    }
    operand_103715 = operand_103715->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_105357 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_105357 != NULL)) {
    macroValidPointer (operand_105357) ;
    if (((((operand_105357->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2493))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2493)))) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2493)) SOURCE_FILE_AT_LINE (2493))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_105357->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2494))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_105357->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2495)) ;
    }
    operand_105357 = operand_105357->nextObject () ;
  }
}
