...
GGS_BoolModel::
GGS_BoolModel (const GGS_BoolModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_CharModel::
GGS_CharModel (const GGS_CharModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_UIntModel::
GGS_UIntModel (const GGS_UIntModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_SIntModel::
GGS_SIntModel (const GGS_SIntModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_UInt64Model::
GGS_UInt64Model (const GGS_UInt64Model & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_SInt64Model::
GGS_SInt64Model (const GGS_SInt64Model & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_DoubleModel::
GGS_DoubleModel (const GGS_DoubleModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_StringModel::
GGS_StringModel (const GGS_StringModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LBoolModel::
GGS_LBoolModel (const GGS_LBoolModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LCharModel::
GGS_LCharModel (const GGS_LCharModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LUIntModel::
GGS_LUIntModel (const GGS_LUIntModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LSIntModel::
GGS_LSIntModel (const GGS_LSIntModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LUInt64Model::
GGS_LUInt64Model (const GGS_LUInt64Model & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LSInt64Model::
GGS_LSInt64Model (const GGS_LSInt64Model & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LDoubleModel::
GGS_LDoubleModel (const GGS_LDoubleModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LStringModel::
GGS_LStringModel (const GGS_LStringModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_StringsetModel::
GGS_StringsetModel (const GGS_StringsetModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_LocationModel::
GGS_LocationModel (const GGS_LocationModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_ListModel::
GGS_ListModel (const GGS_ListModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_MapModel::
GGS_MapModel (const GGS_MapModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_EnumModel::
GGS_EnumModel (const GGS_EnumModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_ExternTypeModel::
GGS_ExternTypeModel (const GGS_ExternTypeModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_ClassModel::
GGS_ClassModel (const GGS_ClassModel & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationAnd::
GGS_metamodelRelationAnd (const GGS_metamodelRelationAnd & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationOr::
GGS_metamodelRelationOr (const GGS_metamodelRelationOr & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationNot::
GGS_metamodelRelationNot (const GGS_metamodelRelationNot & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationTrue::
GGS_metamodelRelationTrue (const GGS_metamodelRelationTrue & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationFalse::
GGS_metamodelRelationFalse (const GGS_metamodelRelationFalse & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationPrimary::
GGS_metamodelRelationPrimary (const GGS_metamodelRelationPrimary & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_metamodelRelationDo::
GGS_metamodelRelationDo (const GGS_metamodelRelationDo & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
  ...
  var_cas_outTypeName = mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (698)) ;
}
...
GGS_typeGalgas_singleEntity::
GGS_typeGalgas_singleEntity (const GGS_typeGalgas_singleEntity & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = ((GGS_string (true, "_listOf_")) + (mEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (711)))) ;
}
...
GGS_typeGalgas_multipleEntity::
GGS_typeGalgas_multipleEntity (const GGS_typeGalgas_multipleEntity & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_jokerInParameterList::
GGS_typeGalgas_jokerInParameterList (const GGS_typeGalgas_jokerInParameterList & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_bool::
GGS_typeGalgas_bool (const GGS_typeGalgas_bool & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_string::
GGS_typeGalgas_string (const GGS_typeGalgas_string & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (852))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (854))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (858)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_sint::
GGS_typeGalgas_sint (const GGS_typeGalgas_sint & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (890))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (892))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (896)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_sint64::
GGS_typeGalgas_sint64 (const GGS_typeGalgas_sint64 & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (928))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (932)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_uint::
GGS_typeGalgas_uint (const GGS_typeGalgas_uint & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (964))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (968)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_uint64::
GGS_typeGalgas_uint64 (const GGS_typeGalgas_uint64 & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_char::
GGS_typeGalgas_char (const GGS_typeGalgas_char & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_double::
GGS_typeGalgas_double (const GGS_typeGalgas_double & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_location::
GGS_typeGalgas_location (const GGS_typeGalgas_location & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1045))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1053)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_lstring::
GGS_typeGalgas_lstring (const GGS_typeGalgas_lstring & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1080))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1088)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_lchar::
GGS_typeGalgas_lchar (const GGS_typeGalgas_lchar & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1111))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1119)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_lbool::
GGS_typeGalgas_lbool (const GGS_typeGalgas_lbool & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1142))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1150)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_luint::
GGS_typeGalgas_luint (const GGS_typeGalgas_luint & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1177))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1185)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_luint64::
GGS_typeGalgas_luint64 (const GGS_typeGalgas_luint64 & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1212))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1220)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_lsint::
GGS_typeGalgas_lsint (const GGS_typeGalgas_lsint & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1247))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1255)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_lsint64::
GGS_typeGalgas_lsint64 (const GGS_typeGalgas_lsint64 & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1282))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1290)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_ldouble::
GGS_typeGalgas_ldouble (const GGS_typeGalgas_ldouble & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1317))) == (GGS_string (true, "emptySet"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1319))) == (GGS_string (true, "setWithString"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1323))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptySet' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (1325)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1327)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgas_stringset::
GGS_typeGalgas_stringset (const GGS_typeGalgas_stringset & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1396)) ;
}
...
GGS_typeGalgasUndefinedExternType::
GGS_typeGalgasUndefinedExternType (const GGS_typeGalgasUndefinedExternType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mConstructorMap.isBuilt ()) {
    mConstructorMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1440)) ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifiersMap.isBuilt ()) {
    mModifiersMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1449)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReadersInInstructionMap.isBuilt ()) {
    mReadersInInstructionMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1458)) ;
  }
}
...
method_handleAddAssignOperatorCall (C_Lexique & _inLexique,
  ...
  if (((! (mAcceptAddAssignOperatorCall))).isBuiltAndTrue ()) {
    inherited::method_handleAddAssignOperatorCall (_inLexique, var_cas_inErrorLocation, var_cas_outParametersList SOURCE_FILE_AT_LINE (1467)) ;
  }else{
...
GGS_typeGalgasExternType::
GGS_typeGalgasExternType (const GGS_typeGalgasExternType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_C_grammarForSemantics::
GGS_C_grammarForSemantics (const GGS_C_grammarForSemantics & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1585))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1585)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1586))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1587)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1587))) > (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1587)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1588))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1589)) ;
  }else{
    GGS_L_signature::element_type * operand_62351 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_62450 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_62351 != NULL)
        && (operand_62450 != NULL)) {
      macroValidPointer (operand_62351) ;
      macroValidPointer (operand_62450) ;
      if (((operand_62351->mFormalArgumentPassingMode) != (operand_62450->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        operand_62450->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_62351->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1593))))) + (GGS_string (true, ", and ")))) + (operand_62351->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1594))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1595)) ;
      }
      if (((operand_62351->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1596))) != (operand_62450->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1596)))).isBuiltAndTrue ()) {
        operand_62450->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_62351->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1597))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_62450->mGalgasTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1597))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1598)) ;
      }
      operand_62351 = operand_62351->nextObject () ;
      operand_62450 = operand_62450->nextObject () ;
    }
  }
}
...
GGS_T_terminalInstruction_forGrammarComponent::
GGS_T_terminalInstruction_forGrammarComponent (const GGS_T_terminalInstruction_forGrammarComponent & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_T_nonterminalInstruction_forGrammarComponent::
GGS_T_nonterminalInstruction_forGrammarComponent (const GGS_T_nonterminalInstruction_forGrammarComponent & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_T_selectInstruction_forGrammarComponent::
GGS_T_selectInstruction_forGrammarComponent (const GGS_T_selectInstruction_forGrammarComponent & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_T_repeatInstruction_forGrammarComponent::
GGS_T_repeatInstruction_forGrammarComponent (const GGS_T_repeatInstruction_forGrammarComponent & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1842)) ;
}
...
GGS_typeGalgasUndefinedListType::
GGS_typeGalgasUndefinedListType (const GGS_typeGalgasUndefinedListType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1882))) == (GGS_string (true, "emptyList"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1884))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyList' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (1886)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1888)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgasListType::
GGS_typeGalgasListType (const GGS_typeGalgasListType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1918)) ;
}
...
GGS_typeGalgasUndefinedMapType::
GGS_typeGalgasUndefinedMapType (const GGS_typeGalgasUndefinedMapType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifierMethodMap.isBuilt ()) {
    mModifierMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1954)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMethodMap.isBuilt ()) {
    mReaderMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1964)) ;
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_80127 = mNonExternAttributesList.firstObject () ;
  while ((operand_80127 != NULL)) {
    macroValidPointer (operand_80127) ;
    var_cas_outForeachList.addAssign_operation (operand_80127->mAttributType, operand_80127->aNomAttribut) ;
    operand_80127 = operand_80127->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1989))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1991))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (1993)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1995)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgasMapType::
GGS_typeGalgasMapType (const GGS_typeGalgasMapType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2012)) ;
}
...
GGS_typeGalgasUndefinedClassType::
GGS_typeGalgasUndefinedClassType (const GGS_typeGalgasUndefinedClassType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap.isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2045)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2055)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2055))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2059)) ;
    var_cas_outAccessorTypesList.drop_operation () ;
  }
}
...
GGS_typeGalgasClassType::
GGS_typeGalgasClassType (const GGS_typeGalgasClassType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeEntiteType::
GGS_typeEntiteType (const GGS_typeEntiteType & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeEntiteRoutine::
GGS_typeEntiteRoutine (const GGS_typeEntiteRoutine & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_entityInInstruction::
GGS_typeGalgas_entityInInstruction (const GGS_typeGalgas_entityInInstruction & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
GGS_typeGalgas_mapIndexInInstruction::
GGS_typeGalgas_mapIndexInInstruction (const GGS_typeGalgas_mapIndexInInstruction & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2138))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    ...
    var_cas_outModifierSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2144))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2150)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2155)) ;
    var_cas_outModifierSignature.drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2165))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2171))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2177)) COMMA_HERE) ;
    var_cas_outReaderSignature.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2183)) ;
    var_cas_outReaderSignature.drop_operation () ;
  }
}
...
GGS_typeGalgas_mapEntityInInstruction::
GGS_typeGalgas_mapEntityInInstruction (const GGS_typeGalgas_mapEntityInInstruction & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2216)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap.isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2224)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
GGS_typeGalgas_enum::
GGS_typeGalgas_enum (const GGS_typeGalgas_enum & inSource) {
  macroAttachPointer (mPointer, inSource.mPointer) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_90452 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_90471 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_90452 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_90452) ;
    cPtr_typeGalgas_stringset * operand_90471 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_90471) ;
    if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_90452 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_90452) ;
      cPtr_typeGalgas_uint * operand_90471 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_90471) ;
      if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_90452 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_90452) ;
        cPtr_typeGalgas_sint * operand_90471 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_90471) ;
        if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_90452 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_90452) ;
          cPtr_typeGalgas_uint64 * operand_90471 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_90471) ;
          if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_90452 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_90452) ;
            cPtr_typeGalgas_sint64 * operand_90471 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_90471) ;
            if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_90452 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_90452) ;
              cPtr_typeGalgas_char * operand_90471 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_90471) ;
              if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_90452 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_90452) ;
                cPtr_typeGalgas_string * operand_90471 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_90471) ;
                if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_90452 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_90452) ;
                  cPtr_typeGalgas_bool * operand_90471 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_90471) ;
                  if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_90452 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_90452) ;
                    cPtr_typeGalgas_double * operand_90471 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_90471) ;
                    if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_90452 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_90452) ;
                      cPtr_typeGalgas_lbool * operand_90471 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_90471) ;
                      if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_90452 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_90452) ;
                        cPtr_typeGalgas_lchar * operand_90471 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_90471) ;
                        if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_90452 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_90452) ;
                          cPtr_typeGalgas_luint * operand_90471 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_90471) ;
                          if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_90452 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_90452) ;
                            cPtr_typeGalgas_lsint * operand_90471 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_90471) ;
                            if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_90452 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_90452) ;
                              cPtr_typeGalgas_luint64 * operand_90471 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_90471) ;
                              if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_90452 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_90452) ;
                                cPtr_typeGalgas_lsint64 * operand_90471 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_90471) ;
                                if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_90452 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_90452) ;
                                  cPtr_typeGalgas_ldouble * operand_90471 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_90471) ;
                                  if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_90452 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_90452) ;
                                    cPtr_typeGalgas_lstring * operand_90471 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_90471) ;
                                    if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_90452 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_90452) ;
                                      cPtr_typeGalgas_location * operand_90471 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_90471) ;
                                      if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_90452 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_90452) ;
                                        cPtr_typeGalgasUndefinedListType * operand_90471 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_90471) ;
                                        if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                          if (((operand_90452->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2264))) != (operand_90471->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2264)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_90452->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2265))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_90471->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2266))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2267)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_90452 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_90452) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_90471 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_90471) ;
                                          if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                            if (((operand_90452->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2270))) != (operand_90471->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2270)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_90452->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2271))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_90471->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2272))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2273)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_90452 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_90452) ;
                                            cPtr_typeGalgasClassType * operand_90471 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_90471) ;
                                            if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2277))) == (operand_90471->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2277))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_90471->mAncestorClassesMap.reader_hasKey (_inLexique, operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2279)) SOURCE_FILE_AT_LINE (2279)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2282))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_90471->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2283))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2284)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_90452 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_90452) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_90471 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_90471) ;
                                              if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                                GGS_bool var_cas_accept ;
                                                var_cas_accept = (operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2287))) != (operand_90471->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2287))) ;
                                                if (((operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2288))) != (operand_90471->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2288)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_90452->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2289))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_90471->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2290))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2291)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_90452 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_90452) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_90471 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_90471) ;
                                                if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                                  if (((operand_90452->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2295))) != (operand_90471->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2295)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_90452->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2296))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_90471->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2297))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2298)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_90452 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_90452) ;
                                                  cPtr_typeGalgas_enum * operand_90471 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_90471) ;
                                                  if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                                    if (((operand_90452->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2302))) != (operand_90471->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2302)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_90452->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2303))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_90471->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2304))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2305)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_90452 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_90452) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_90471 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_90471) ;
                                                    if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                                      if (((operand_90452->mEntityName) != (operand_90471->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_90452->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_90471->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2312)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_90452 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_90452) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_90471 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_90471) ;
                                                      if ((operand_90452 != NULL) && (operand_90471 != NULL)) {
                                                        if (((operand_90452->mMapTypeName) != (operand_90471->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_90452->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_90471->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2319)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2322))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2322)))) SOURCE_FILE_AT_LINE (2323)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2337))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2337)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2339)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2339))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2339)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2341)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_95911 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_96010 = var_cas_signatureTestee.firstObject () ;
    while ((operand_95911 != NULL)
        && (operand_96010 != NULL)) {
      macroValidPointer (operand_95911) ;
      macroValidPointer (operand_96010) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_95911->mType,  operand_96010->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2345)) ;
      if (((operand_95911->mFormalArgumentPassingMode) != (operand_96010->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_96010->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2351))) + (GGS_string (true, " is not compatible with ")))) + (operand_96010->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2352)))) SOURCE_FILE_AT_LINE (2353)) ;
      }
      operand_95911 = operand_95911->nextObject () ;
      operand_96010 = operand_96010->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2485))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2491))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2494))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2497))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2500))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2503))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2506))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2509))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2512))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2520)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2522))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2528)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2530))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2533))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2536))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2539))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2545)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2547))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2550))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2553))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2564))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2567))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2570))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2573))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2579)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2581))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2584))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2587))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2590))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2596)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2598))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2601))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2604))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2610)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2612))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2615))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2618))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2624)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2626))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2629))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2635)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2637))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2640))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2643))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2649)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2651))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2654))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2657))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2665))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2668))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2671))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2674))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2682))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2685))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2688))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2691))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2699))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2702))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2705))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2708))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2716))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2722)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2724))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2729))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2732))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2738)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2740))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2745))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        cPtr_typeGalgasClassType * operand_117008 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_117008) ; 
        if (operand_117008->mMessagesMap.isBuilt ()) {
          operand_117008->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2753)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_117287 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_117287) ; 
        GGS_L_lstringList  var_cas_117399 ;
        if (operand_117287->mMessagesMap.isBuilt ()) {
          operand_117287->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_117399 SOURCE_FILE_AT_LINE (2757)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2764)) ;
        var_cas_outAccessorTypesList.drop_operation () ;
        var_cas_outReturnedType.drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2791)) SOURCE_FILE_AT_LINE (2791))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_119197 ;
    GGS_M_semanticsEntitiesForUse  var_cas_119206 ;
    if (var_cas_ioSemanticsComponentsMap.isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_119197, var_cas_119206 SOURCE_FILE_AT_LINE (2798)) ;
    }
    ...
    GGS_stringset::element_type * operand_119451 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_119451 != NULL)) {
      macroValidPointer (operand_119451) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_119451->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2812)) ;
      operand_119451 = operand_119451->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_119816 = var_cas_modelMap.firstObject () ;
    while ((operand_119816 != NULL)) {
      macroValidPointer (operand_119816) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_119816->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2823)) SOURCE_FILE_AT_LINE (2823))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_119816->mKey, operand_119816->mInfo.mType SOURCE_FILE_AT_LINE (2824)) ;
      }
      operand_119816 = operand_119816->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_120029 = var_cas_actionMap.firstObject () ;
    while ((operand_120029 != NULL)) {
      macroValidPointer (operand_120029) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_120029->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2829)) SOURCE_FILE_AT_LINE (2829))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_120029->mKey, operand_120029->mInfo.mSignature, operand_120029->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2830)) ;
      }
      operand_120029 = operand_120029->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents.addAssign_operation (var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2834))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2845))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2846)) SOURCE_FILE_AT_LINE (2846))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2847)) SOURCE_FILE_AT_LINE (2847))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2848))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_120888 ;
    GGS_bool var_cas_120891 ;
    GGS_entityPropertyMap  var_cas_120894 ;
    if (var_cas_inEntityMap.isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_120888, var_cas_120891, var_cas_120894, var_cas_superEntityName SOURCE_FILE_AT_LINE (2850)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_inEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2851)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_121631 = var_cas_inPath.firstObject () ;
  while ((operand_121631 != NULL)) {
    macroValidPointer (operand_121631) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_121631->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2872)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2872)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_121631->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2875)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2877)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2881)) SOURCE_FILE_AT_LINE (2881))))).isBuiltAndTrue ()) {
        operand_121631->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2883))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2884)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_122421 ;
      GGS_entityPropertyMap  var_cas_122424 ;
      GGS_lstring  var_cas_122427 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_122421, var_cas_122424, var_cas_122427 SOURCE_FILE_AT_LINE (2888)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap.isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_121631->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2891)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2893)) SOURCE_FILE_AT_LINE (2893))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_122789 ;
          GGS_lstring  var_cas_122792 ;
          if (var_cas_ioMapEntityMap.isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_122789, var_cas_122792 SOURCE_FILE_AT_LINE (2895)) ;
          }
          GGS_bool var_cas_122859 ;
          GGS_entityPropertyMap  var_cas_122862 ;
          GGS_lstring  var_cas_122865 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_122859, var_cas_122862, var_cas_122865 SOURCE_FILE_AT_LINE (2896)) ;
          }
        }else{
          GGS_bool var_cas_122944 ;
          GGS_entityPropertyMap  var_cas_122947 ;
          GGS_lstring  var_cas_122950 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_122944, var_cas_122947, var_cas_122950 SOURCE_FILE_AT_LINE (2898)) ;
          }
        }
      }
    }
    operand_121631 = operand_121631->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_123265 = var_cas_inEntityMap.firstObject () ;
  while ((operand_123265 != NULL)) {
    macroValidPointer (operand_123265) ;
    if (((((operand_123265->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2913))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2913)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2913)) SOURCE_FILE_AT_LINE (2913))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_123265->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2914))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_123265->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2915)) ;
    }
    operand_123265 = operand_123265->nextObject () ;
  }
}
