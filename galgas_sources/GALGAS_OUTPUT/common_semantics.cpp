...
appendForMapDescription (C_Lexique & _inLexique, C_String & ioString COMMA_LOCATION_ARGS) const {
  ...
  ioString << mInfo.mSuperClassSet.reader_description  (_inLexique COMMA_THERE) ;
  ioString << "]" ;
}
...
method_getTypeName (C_Lexique & _inLexique,
  ...
  var_cas_outTypeName = mEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (694)) ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = ((GGS_string (true, "_listOf_")) + (mEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (707)))) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (848))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (850))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (854)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (886))) == (GGS_string (true, "min"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (888))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (892)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (924))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (928)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (960))) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (964)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1041))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1047)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1057))) == (GGS_string (true, "setString"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1060))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1066)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1089))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1107))) == (GGS_string (true, "setChar"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1110))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1116)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1139))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1147)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1157))) == (GGS_string (true, "setBool"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1160))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1166)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1188))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1196)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1206))) == (GGS_string (true, "setUint"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1209))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1215)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1237))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1245)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1255))) == (GGS_string (true, "setUint64"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1258))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1264)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1286))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1304))) == (GGS_string (true, "setSint"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1307))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1313)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1335))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1343)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1353))) == (GGS_string (true, "setSint64"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1356))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1362)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1384))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1392)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1402))) == (GGS_string (true, "setDouble"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1405))) == (GGS_string (true, "setLocation"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentIn (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support modifier call") SOURCE_FILE_AT_LINE (1411)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1437))) == (GGS_string (true, "emptySet"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1439))) == (GGS_string (true, "setWithString"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outAccessorTypesList._addAssign_operation (var_cas_t, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1443))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptySet' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (1445)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1447)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1516)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mConstructorMap._isBuilt ()) {
    mConstructorMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1560)) ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifiersMap._isBuilt ()) {
    mModifiersMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1569)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReadersInInstructionMap._isBuilt ()) {
    mReadersInInstructionMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1578)) ;
  }
}
...
method_handleAddAssignOperatorCall (C_Lexique & _inLexique,
  ...
  if (((! (mAcceptAddAssignOperatorCall))).isBuiltAndTrue ()) {
    inherited::method_handleAddAssignOperatorCall (_inLexique, var_cas_inErrorLocation, var_cas_outParametersList SOURCE_FILE_AT_LINE (1587)) ;
  }else{
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1705))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1705)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1706))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1707)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1707))) > (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1707)))).isBuiltAndTrue ()) {
    var_cas_inFormalTestedLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString (_inLexique SOURCE_FILE_AT_LINE (1708))))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1709)) ;
  }else{
    GGS_L_signature::element_type * operand_67702 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_67801 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_67702 != NULL)
        && (operand_67801 != NULL)) {
      macroValidPointer (operand_67702) ;
      macroValidPointer (operand_67801) ;
      if (((operand_67702->mFormalArgumentPassingMode) != (operand_67801->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        operand_67801->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_67702->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1713))))) + (GGS_string (true, ", and ")))) + (operand_67702->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1714))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1715)) ;
      }
      if (((operand_67702->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1716))) != (operand_67801->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1716)))).isBuiltAndTrue ()) {
        operand_67801->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_67702->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1717))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_67801->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1717))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1718)) ;
      }
      operand_67702 = operand_67702->nextObject () ;
      operand_67801 = operand_67801->nextObject () ;
    }
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1963)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2003))) == (GGS_string (true, "emptyList"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2005))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyList' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2007)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2009)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2039)) ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifierMethodMap._isBuilt ()) {
    mModifierMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (2075)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMethodMap._isBuilt ()) {
    mReaderMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (2085)) ;
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_85518 = mNonExternAttributesList.firstObject () ;
  while ((operand_85518 != NULL)) {
    macroValidPointer (operand_85518) ;
    var_cas_outForeachList._addAssign_operation (operand_85518->mAttributType, operand_85518->aNomAttribut) ;
    operand_85518 = operand_85518->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2110))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2112))) == (GGS_string (true, "mapWithMapToOverride"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2115))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2117)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2119)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2136)) ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2177)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2187)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2187))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2191)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2270))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2276))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2282)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2287)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2297))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2303))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2309)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2315)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2348)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2356)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_96347 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_96366 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_96347 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96347) ;
    cPtr_typeGalgas_stringset * operand_96366 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96366) ;
    if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_96347 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96347) ;
      cPtr_typeGalgas_uint * operand_96366 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96366) ;
      if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_96347 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96347) ;
        cPtr_typeGalgas_sint * operand_96366 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96366) ;
        if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_96347 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96347) ;
          cPtr_typeGalgas_uint64 * operand_96366 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96366) ;
          if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_96347 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96347) ;
            cPtr_typeGalgas_sint64 * operand_96366 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96366) ;
            if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_96347 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96347) ;
              cPtr_typeGalgas_char * operand_96366 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96366) ;
              if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_96347 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96347) ;
                cPtr_typeGalgas_string * operand_96366 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96366) ;
                if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_96347 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96347) ;
                  cPtr_typeGalgas_bool * operand_96366 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96366) ;
                  if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_96347 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96347) ;
                    cPtr_typeGalgas_double * operand_96366 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96366) ;
                    if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_96347 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96347) ;
                      cPtr_typeGalgas_lbool * operand_96366 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96366) ;
                      if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_96347 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96347) ;
                        cPtr_typeGalgas_lchar * operand_96366 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96366) ;
                        if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_96347 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96347) ;
                          cPtr_typeGalgas_luint * operand_96366 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96366) ;
                          if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_96347 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96347) ;
                            cPtr_typeGalgas_lsint * operand_96366 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96366) ;
                            if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_96347 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96347) ;
                              cPtr_typeGalgas_luint64 * operand_96366 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96366) ;
                              if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_96347 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96347) ;
                                cPtr_typeGalgas_lsint64 * operand_96366 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96366) ;
                                if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_96347 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96347) ;
                                  cPtr_typeGalgas_ldouble * operand_96366 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96366) ;
                                  if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_96347 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96347) ;
                                    cPtr_typeGalgas_lstring * operand_96366 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96366) ;
                                    if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_96347 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96347) ;
                                      cPtr_typeGalgas_location * operand_96366 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96366) ;
                                      if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_96347 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96347) ;
                                        cPtr_typeGalgasUndefinedListType * operand_96366 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96366) ;
                                        if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                          if (((operand_96347->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2396))) != (operand_96366->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2396)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_96347->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2397))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_96366->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2399)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_96347 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96347) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_96366 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96366) ;
                                          if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                            if (((operand_96347->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2402))) != (operand_96366->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2402)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_96347->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2403))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_96366->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2404))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2405)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_96347 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96347) ;
                                            cPtr_typeGalgasClassType * operand_96366 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_96366) ;
                                            if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_96347->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2409))) == (operand_96366->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2409))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_96366->mAncestorClassesMap.reader_hasKey (_inLexique, operand_96347->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2411)) SOURCE_FILE_AT_LINE (2411)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96347->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96366->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2416)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_96347 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96347) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_96366 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96366) ;
                                              if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                                if (((operand_96347->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2419))) != (operand_96366->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2419)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96347->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2420))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96366->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2422)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_96347 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96347) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_96366 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96366) ;
                                                if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                                  if (((operand_96347->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2426))) != (operand_96366->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2426)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_96347->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2427))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_96366->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2428))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2429)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_96347 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96347) ;
                                                  cPtr_typeGalgas_enum * operand_96366 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96366) ;
                                                  if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                                    if (((operand_96347->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2433))) != (operand_96366->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2433)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_96347->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2434))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_96366->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2435))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2436)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_96347 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96347) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_96366 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96366) ;
                                                    if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                                      if (((operand_96347->mEntityName) != (operand_96366->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_96347->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_96366->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2443)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96347 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96347) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96366 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96366) ;
                                                      if ((operand_96347 != NULL) && (operand_96366 != NULL)) {
                                                        if (((operand_96347->mMapTypeName) != (operand_96366->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_96347->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_96366->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2450)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2453))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2453)))) SOURCE_FILE_AT_LINE (2454)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2468))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2468)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2470)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2470))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2470)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2472)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_101766 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_101865 = var_cas_signatureTestee.firstObject () ;
    while ((operand_101766 != NULL)
        && (operand_101865 != NULL)) {
      macroValidPointer (operand_101766) ;
      macroValidPointer (operand_101865) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_101766->mType,  operand_101865->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2476)) ;
      if (((operand_101766->mFormalArgumentPassingMode) != (operand_101865->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_101865->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2482))) + (GGS_string (true, " is not compatible with ")))) + (operand_101865->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2483)))) SOURCE_FILE_AT_LINE (2484)) ;
      }
      operand_101766 = operand_101766->nextObject () ;
      operand_101865 = operand_101865->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2626))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_125220 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125220) ; 
        if (operand_125220->mMessagesMap._isBuilt ()) {
          operand_125220->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2918)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_125499 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125499) ; 
        GGS_L_lstringList  var_cas_125611 ;
        if (operand_125499->mMessagesMap._isBuilt ()) {
          operand_125499->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_125611 SOURCE_FILE_AT_LINE (2922)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2956)) SOURCE_FILE_AT_LINE (2956))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_127410 ;
    GGS_M_semanticsEntitiesForUse  var_cas_127419 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_127410, var_cas_127419 SOURCE_FILE_AT_LINE (2963)) ;
    }
    ...
    GGS_stringset::element_type * operand_127664 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_127664 != NULL)) {
      macroValidPointer (operand_127664) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_127664->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2977)) ;
      operand_127664 = operand_127664->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_128029 = var_cas_modelMap.firstObject () ;
    while ((operand_128029 != NULL)) {
      macroValidPointer (operand_128029) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_128029->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2988)) SOURCE_FILE_AT_LINE (2988))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_128029->mKey, operand_128029->mInfo.mType SOURCE_FILE_AT_LINE (2989)) ;
      }
      operand_128029 = operand_128029->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_128243 = var_cas_actionMap.firstObject () ;
    while ((operand_128243 != NULL)) {
      macroValidPointer (operand_128243) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_128243->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2994)) SOURCE_FILE_AT_LINE (2994))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_128243->mKey, operand_128243->mInfo.mSignature, operand_128243->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2995)) ;
      }
      operand_128243 = operand_128243->nextObject () ;
    }
...
void routine_computeRepresentativeEntityName (C_Lexique & _inLexique,
  ...
  GGS_uint _variant_129413 = var_cas_inMetamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (3013))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (3013)) ;
  GGS_bool _condition_129413 (_variant_129413._isBuilt (), true) ;
  while (_condition_129413.isBuiltAndTrue ()) {
    if (_variant_129413.uintValue () == 0) {
      _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (3022)) ;
      _condition_129413 = GGS_bool (true, false) ;
    }else{
      _variant_129413._decrement_operation (_inLexique COMMA_HERE) ;
      _condition_129413 = (((var_cas_outRepresentativeEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3014))) == (GGS_string (true, ""))) & ((var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3014))) != (GGS_string (true, ""))))  ;
      if (_condition_129413.isBuiltAndTrue ()) {
        if ((var_cas_inConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3015)) SOURCE_FILE_AT_LINE (3015))).isBuiltAndTrue ()) {
          var_cas_outRepresentativeEntityName = var_cas_searchedEntity ;
        }else{
          GGS_lstring  var_cas_superEntity ;
          GGS_entityPropertyMap  var_cas_129337 ;
          GGS_bool var_cas_129340 ;
          GGS_entityPropertyMap  var_cas_129343 ;
          GGS_stringset  var_cas_129359 ;
          if (var_cas_inMetamodelEntityMap._isBuilt ()) {
            var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_searchedEntity, var_cas_129337, var_cas_129340, var_cas_129343, var_cas_superEntity, var_cas_129359 SOURCE_FILE_AT_LINE (3019)) ;
          }
