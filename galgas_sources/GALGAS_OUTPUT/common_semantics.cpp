...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_50332 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_50431 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_50332 != NULL)
        && (operand_50431 != NULL)) {
      macroValidPointer (operand_50332) ;
      macroValidPointer (operand_50431) ;
      if (((operand_50332->mFormalArgumentPassingMode) != (operand_50431->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_50431->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_50332->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_50332->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_50332->mGalgasTypeName.reader_value ()) != (operand_50431->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_50431->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_50332->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_50431->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_50332 = operand_50332->nextObject () ;
      operand_50431 = operand_50431->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_68230 = mNonExternAttributesList.firstObject () ;
  while ((operand_68230 != NULL)) {
    macroValidPointer (operand_68230) ;
    var_cas_outForeachList.addAssign_operation (operand_68230->mAttributType, operand_68230->aNomAttribut) ;
    operand_68230 = operand_68230->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_74003 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_74022 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_74003 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_74003) ;
    cPtr_typeGalgas_stringset * operand_74022 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_74022) ;
    if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_74003 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_74003) ;
      cPtr_typeGalgas_uint * operand_74022 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_74022) ;
      if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_74003 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_74003) ;
        cPtr_typeGalgas_sint * operand_74022 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_74022) ;
        if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_74003 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_74003) ;
          cPtr_typeGalgas_char * operand_74022 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_74022) ;
          if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_74003 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_74003) ;
            cPtr_typeGalgas_string * operand_74022 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_74022) ;
            if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_74003 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_74003) ;
              cPtr_typeGalgas_bool * operand_74022 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_74022) ;
              if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_74003 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_74003) ;
                cPtr_typeGalgas_double * operand_74022 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_74022) ;
                if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_74003 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_74003) ;
                  cPtr_typeGalgas_lbool * operand_74022 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_74022) ;
                  if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_74003 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_74003) ;
                    cPtr_typeGalgas_lchar * operand_74022 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_74022) ;
                    if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_74003 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_74003) ;
                      cPtr_typeGalgas_luint * operand_74022 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_74022) ;
                      if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_74003 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_74003) ;
                        cPtr_typeGalgas_lsint * operand_74022 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_74022) ;
                        if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_74003 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_74003) ;
                          cPtr_typeGalgas_ldouble * operand_74022 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_74022) ;
                          if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_74003 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_74003) ;
                            cPtr_typeGalgas_lstring * operand_74022 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_74022) ;
                            if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_74003 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_74003) ;
                              cPtr_typeGalgas_location * operand_74022 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_74022) ;
                              if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_74003 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_74003) ;
                                cPtr_typeGalgasUndefinedListType * operand_74022 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_74022) ;
                                if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                                  if (((operand_74003->mListTypeName.reader_value ()) != (operand_74022->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_74003->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_74022->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_74003 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_74003) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_74022 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_74022) ;
                                  if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                                    if (((operand_74003->mMapTypeName.reader_value ()) != (operand_74022->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_74003->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_74022->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_74003 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_74003) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_74022 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_74022) ;
                                    if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                                      if (((operand_74003->mClassTypeName.reader_value ()) != (operand_74022->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_74003->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_74022->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_74003 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_74003) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_74022 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_74022) ;
                                      if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                                        if (((operand_74003->mGalgasClassName.reader_value ()) != (operand_74022->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_74003->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_74022->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_74003 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_74003) ;
                                        cPtr_typeGalgas_enum * operand_74022 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_74022) ;
                                        if ((operand_74003 != NULL) && (operand_74022 != NULL)) {
                                          if (((operand_74003->mEnumTypeName.reader_value ()) != (operand_74022->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_74003->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_74022->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_77808 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_77907 = var_cas_signatureTestee.firstObject () ;
    while ((operand_77808 != NULL)
        && (operand_77907 != NULL)) {
      macroValidPointer (operand_77808) ;
      macroValidPointer (operand_77907) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_77808->mType,  operand_77907->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_77808->mFormalArgumentPassingMode) != (operand_77907->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_77907->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_77907->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_77808 = operand_77808->nextObject () ;
      operand_77907 = operand_77907->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_92238 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92238) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92238->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_92581 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92581) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92581->mMessagesMap ;
        GGS_L_lstringList  var_cas_92750 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_92750) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_94546 ;
    GGS_M_semanticsEntitiesForUse  var_cas_94555 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_94546, var_cas_94555) ;
    ...
    GGS_stringset::element_type * operand_94800 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_94800 != NULL)) {
      macroValidPointer (operand_94800) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_94800->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_94800 = operand_94800->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_95165 = var_cas_modelMap.firstObject () ;
    while ((operand_95165 != NULL)) {
      macroValidPointer (operand_95165) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_95165->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_95165->mKey, operand_95165->mInfo.mType) ;
      }
      operand_95165 = operand_95165->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_95378 = var_cas_actionMap.firstObject () ;
    while ((operand_95378 != NULL)) {
      macroValidPointer (operand_95378) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_95378->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_95378->mKey, operand_95378->mInfo.mSignature, operand_95378->mInfo.mIsExtern) ;
      }
      operand_95378 = operand_95378->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_96120 ;
    GGS_bool var_cas_96123 ;
    GGS_entityPropertyMap  var_cas_96126 ;
    GGS_mapPropertyMap  var_cas_96146 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_96120, var_cas_96123, var_cas_96126, var_cas_superEntityName, var_cas_96146) ;
