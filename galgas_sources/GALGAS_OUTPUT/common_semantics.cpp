...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "common_semantics.cpp" ;
...
void GGS_entityToImplementMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_contextPropertyMap   & outParameter4,
                                GGS_fetchedPropertyMap   & outParameter5,
                                GGS_fetchedPropertyMap   & outParameter6 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_contextPropertyMap & inParameter4,
                                const GGS_fetchedPropertyMap & inParameter5,
                                const GGS_fetchedPropertyMap & inParameter6 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (781)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (866)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (901)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (932)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (963)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (998)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1064)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1175)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1184)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1193)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1322)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1324)) ;
  }else{
    GGS_L_signature::element_type * operand_53096 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_53195 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_53096 != NULL)
        && (operand_53195 != NULL)) {
      macroValidPointer (operand_53096) ;
      macroValidPointer (operand_53195) ;
      if (((operand_53096->mFormalArgumentPassingMode) != (operand_53195->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_53195->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_53096->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_53096->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1330)) ;
      }
      if (((operand_53096->mGalgasTypeName.reader_value ()) != (operand_53195->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_53195->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_53096->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_53195->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1333)) ;
      }
      operand_53096 = operand_53096->nextObject () ;
      operand_53195 = operand_53195->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1648)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1712)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_70994 = mNonExternAttributesList.firstObject () ;
  while ((operand_70994 != NULL)) {
    macroValidPointer (operand_70994) ;
    var_cas_outForeachList.addAssign_operation (operand_70994->mAttributType, operand_70994->aNomAttribut) ;
    operand_70994 = operand_70994->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1739)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1787)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1798)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1807)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1811)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1870)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_76767 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_76786 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_76767 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_76767) ;
    cPtr_typeGalgas_stringset * operand_76786 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_76786) ;
    if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_76767 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_76767) ;
      cPtr_typeGalgas_uint * operand_76786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_76786) ;
      if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_76767 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_76767) ;
        cPtr_typeGalgas_sint * operand_76786 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_76786) ;
        if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_76767 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_76767) ;
          cPtr_typeGalgas_char * operand_76786 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_76786) ;
          if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_76767 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_76767) ;
            cPtr_typeGalgas_string * operand_76786 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_76786) ;
            if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_76767 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_76767) ;
              cPtr_typeGalgas_bool * operand_76786 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_76786) ;
              if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_76767 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_76767) ;
                cPtr_typeGalgas_double * operand_76786 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_76786) ;
                if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_76767 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_76767) ;
                  cPtr_typeGalgas_lbool * operand_76786 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_76786) ;
                  if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_76767 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_76767) ;
                    cPtr_typeGalgas_lchar * operand_76786 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_76786) ;
                    if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_76767 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_76767) ;
                      cPtr_typeGalgas_luint * operand_76786 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_76786) ;
                      if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_76767 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_76767) ;
                        cPtr_typeGalgas_lsint * operand_76786 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_76786) ;
                        if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_76767 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_76767) ;
                          cPtr_typeGalgas_ldouble * operand_76786 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_76786) ;
                          if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_76767 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_76767) ;
                            cPtr_typeGalgas_lstring * operand_76786 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_76786) ;
                            if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_76767 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_76767) ;
                              cPtr_typeGalgas_location * operand_76786 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_76786) ;
                              if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_76767 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_76767) ;
                                cPtr_typeGalgasUndefinedListType * operand_76786 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_76786) ;
                                if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                                  if (((operand_76767->mListTypeName.reader_value ()) != (operand_76786->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_76767->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_76786->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1907)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_76767 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_76767) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_76786 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_76786) ;
                                  if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                                    if (((operand_76767->mMapTypeName.reader_value ()) != (operand_76786->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_76767->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_76786->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1913)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_76767 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_76767) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_76786 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_76786) ;
                                    if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                                      if (((operand_76767->mClassTypeName.reader_value ()) != (operand_76786->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_76767->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_76786->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1919)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_76767 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_76767) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_76786 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_76786) ;
                                      if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                                        if (((operand_76767->mGalgasClassName.reader_value ()) != (operand_76786->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_76767->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_76786->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1926)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_76767 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_76767) ;
                                        cPtr_typeGalgas_enum * operand_76786 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_76786) ;
                                        if ((operand_76767 != NULL) && (operand_76786 != NULL)) {
                                          if (((operand_76767->mEnumTypeName.reader_value ()) != (operand_76786->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_76767->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_76786->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1933)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1937)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1953)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1955)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_80572 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_80671 = var_cas_signatureTestee.firstObject () ;
    while ((operand_80572 != NULL)
        && (operand_80671 != NULL)) {
      macroValidPointer (operand_80572) ;
      macroValidPointer (operand_80671) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_80572->mType,  operand_80671->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1959)) ;
      if (((operand_80572->mFormalArgumentPassingMode) != (operand_80671->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_80671->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_80671->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (1962)) ;
      }
      operand_80572 = operand_80572->nextObject () ;
      operand_80671 = operand_80671->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2114)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2125)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2136)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2150)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2161)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2172)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2208)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2227)) ;
        }
        ...
        cPtr_typeGalgasClassType * operand_95190 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95190) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95190->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2244)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_95533 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95533) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95533->mMessagesMap ;
        GGS_L_lstringList  var_cas_95702 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_95702 SOURCE_FILE_AT_LINE (2249)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2255)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_97498 ;
    GGS_M_semanticsEntitiesForUse  var_cas_97507 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_97498, var_cas_97507 SOURCE_FILE_AT_LINE (2290)) ;
    ...
    GGS_stringset::element_type * operand_97752 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_97752 != NULL)) {
      macroValidPointer (operand_97752) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_97752->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2304)) ;
      operand_97752 = operand_97752->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_98117 = var_cas_modelMap.firstObject () ;
    while ((operand_98117 != NULL)) {
      macroValidPointer (operand_98117) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_98117->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_98117->mKey, operand_98117->mInfo.mType SOURCE_FILE_AT_LINE (2316)) ;
      }
      operand_98117 = operand_98117->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_98330 = var_cas_actionMap.firstObject () ;
    while ((operand_98330 != NULL)) {
      macroValidPointer (operand_98330) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_98330->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_98330->mKey, operand_98330->mInfo.mSignature, operand_98330->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2322)) ;
      }
      operand_98330 = operand_98330->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_99133 ;
    GGS_bool var_cas_99136 ;
    GGS_entityPropertyMap  var_cas_99139 ;
    GGS_contextPropertyMap  var_cas_99159 ;
    GGS_fetchedPropertyMap  var_cas_99162 ;
    GGS_fetchedPropertyMap  var_cas_99165 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_99133, var_cas_99136, var_cas_99139, var_cas_superEntityName, var_cas_99159, var_cas_99162, var_cas_99165 SOURCE_FILE_AT_LINE (2340)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2341)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_99853 = var_cas_inPath.firstObject () ;
  while ((operand_99853 != NULL)) {
    macroValidPointer (operand_99853) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_99853->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_99853->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2366)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_99853->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2372)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_100643 ;
      GGS_entityPropertyMap  var_cas_100646 ;
      GGS_lstring  var_cas_100649 ;
      GGS_contextPropertyMap  var_cas_100652 ;
      GGS_fetchedPropertyMap  var_cas_100655 ;
      GGS_fetchedPropertyMap  var_cas_100658 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_100643, var_cas_100646, var_cas_100649, var_cas_100652, var_cas_100655, var_cas_100658 SOURCE_FILE_AT_LINE (2377)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_100787 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_99853->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_100787 SOURCE_FILE_AT_LINE (2380)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        GGS_bool var_cas_100921 ;
        GGS_entityPropertyMap  var_cas_100924 ;
        GGS_lstring  var_cas_100927 ;
        GGS_contextPropertyMap  var_cas_100930 ;
        GGS_fetchedPropertyMap  var_cas_100933 ;
        GGS_fetchedPropertyMap  var_cas_100936 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_100921, var_cas_100924, var_cas_100927, var_cas_100930, var_cas_100933, var_cas_100936 SOURCE_FILE_AT_LINE (2382)) ;
      }
    }
    operand_99853 = operand_99853->nextObject () ;
  }
}
