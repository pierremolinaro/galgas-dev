...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_constructorMap.methode_searchKey (_inLexique, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1206)) ;
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1215)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1224)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1354)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inFormalTestedLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "too much formal parameters (from prototype in ")) + (var_cas_inFormalReferenceLocation.reader_locationString ()))) + (GGS_string (true, ")"))) SOURCE_FILE_AT_LINE (1356)) ;
  }else{
    GGS_L_signature::element_type * operand_54230 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_54329 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_54230 != NULL)
        && (operand_54329 != NULL)) {
      macroValidPointer (operand_54230) ;
      macroValidPointer (operand_54329) ;
      if (((operand_54230->mFormalArgumentPassingMode) != (operand_54329->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_54329->mGalgasTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_54230->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_54230->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1362)) ;
      }
      if (((operand_54230->mGalgasTypeName.reader_value ()) != (operand_54329->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_54329->mGalgasTypeName.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_54230->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_54329->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1365)) ;
      }
      operand_54230 = operand_54230->nextObject () ;
      operand_54329 = operand_54329->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1655)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1719)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_71432 = mNonExternAttributesList.firstObject () ;
  while ((operand_71432 != NULL)) {
    macroValidPointer (operand_71432) ;
    var_cas_outForeachList.addAssign_operation (operand_71432->mAttributType, operand_71432->aNomAttribut) ;
    operand_71432 = operand_71432->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1746)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & _inLexique) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1794)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  var_cas_methodMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1805)) ;
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1814)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1818)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & _inLexique,
  ...
  var_cas_enumConstantesMap.methode_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1877)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_77200 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_77219 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_77200 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77200) ;
    cPtr_typeGalgas_stringset * operand_77219 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77219) ;
    if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_77200 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77200) ;
      cPtr_typeGalgas_uint * operand_77219 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77219) ;
      if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_77200 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77200) ;
        cPtr_typeGalgas_sint * operand_77219 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77219) ;
        if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_77200 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77200) ;
          cPtr_typeGalgas_char * operand_77219 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77219) ;
          if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_77200 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77200) ;
            cPtr_typeGalgas_string * operand_77219 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77219) ;
            if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_77200 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77200) ;
              cPtr_typeGalgas_bool * operand_77219 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77219) ;
              if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_77200 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77200) ;
                cPtr_typeGalgas_double * operand_77219 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77219) ;
                if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_77200 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77200) ;
                  cPtr_typeGalgas_lbool * operand_77219 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77219) ;
                  if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_77200 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77200) ;
                    cPtr_typeGalgas_lchar * operand_77219 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77219) ;
                    if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_77200 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77200) ;
                      cPtr_typeGalgas_luint * operand_77219 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77219) ;
                      if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_77200 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77200) ;
                        cPtr_typeGalgas_lsint * operand_77219 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77219) ;
                        if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_77200 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77200) ;
                          cPtr_typeGalgas_ldouble * operand_77219 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77219) ;
                          if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_77200 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77200) ;
                            cPtr_typeGalgas_lstring * operand_77219 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77219) ;
                            if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_77200 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77200) ;
                              cPtr_typeGalgas_location * operand_77219 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77219) ;
                              if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_77200 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77200) ;
                                cPtr_typeGalgasUndefinedListType * operand_77219 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77219) ;
                                if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                                  if (((operand_77200->mListTypeName.reader_value ()) != (operand_77219->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_77200->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_77219->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1914)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_77200 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77200) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_77219 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77219) ;
                                  if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                                    if (((operand_77200->mMapTypeName.reader_value ()) != (operand_77219->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_77200->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_77219->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1920)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_77200 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77200) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_77219 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77219) ;
                                    if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                                      if (((operand_77200->mClassTypeName.reader_value ()) != (operand_77219->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_77200->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_77219->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1926)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_77200 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77200) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_77219 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77219) ;
                                      if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                                        if (((operand_77200->mGalgasClassName.reader_value ()) != (operand_77219->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_77200->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_77219->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1933)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_77200 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77200) ;
                                        cPtr_typeGalgas_enum * operand_77219 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77219) ;
                                        if ((operand_77200 != NULL) && (operand_77219 != NULL)) {
                                          if (((operand_77200->mEnumTypeName.reader_value ()) != (operand_77219->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_77200->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_77219->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1940)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1944)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1960)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1962)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_81005 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_81104 = var_cas_signatureTestee.firstObject () ;
    while ((operand_81005 != NULL)
        && (operand_81104 != NULL)) {
      macroValidPointer (operand_81005) ;
      macroValidPointer (operand_81104) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_81005->mType,  operand_81104->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1966)) ;
      if (((operand_81005->mFormalArgumentPassingMode) != (operand_81104->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (_inLexique, ((((operand_81104->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_81104->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (1969)) ;
      }
      operand_81005 = operand_81005->nextObject () ;
      operand_81104 = operand_81104->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2136)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2144)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2155)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2169)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2183)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2194)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2208)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2225)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2242)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2250)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2266)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2279)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_97272 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_97272) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_97272->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2283)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_97615 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_97615) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_97615->mMessagesMap ;
        GGS_L_lstringList  var_cas_97784 ;
        var_cas_messagesMap.methode_searchKey (_inLexique, var_cas_inMethodName, var_cas_97784 SOURCE_FILE_AT_LINE (2288)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2294)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_99580 ;
    GGS_M_semanticsEntitiesForUse  var_cas_99589 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_99580, var_cas_99589 SOURCE_FILE_AT_LINE (2329)) ;
    ...
    GGS_stringset::element_type * operand_99834 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_99834 != NULL)) {
      macroValidPointer (operand_99834) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_99834->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2343)) ;
      operand_99834 = operand_99834->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_100199 = var_cas_modelMap.firstObject () ;
    while ((operand_100199 != NULL)) {
      macroValidPointer (operand_100199) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_100199->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (_inLexique, operand_100199->mKey, operand_100199->mInfo.mType SOURCE_FILE_AT_LINE (2355)) ;
      }
      operand_100199 = operand_100199->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_100412 = var_cas_actionMap.firstObject () ;
    while ((operand_100412 != NULL)) {
      macroValidPointer (operand_100412) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_100412->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (_inLexique, operand_100412->mKey, operand_100412->mInfo.mSignature, operand_100412->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2361)) ;
      }
      operand_100412 = operand_100412->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_101215 ;
    GGS_bool var_cas_101218 ;
    GGS_entityPropertyMap  var_cas_101221 ;
    var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_101215, var_cas_101218, var_cas_101221, var_cas_superEntityName SOURCE_FILE_AT_LINE (2379)) ;
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2380)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_101959 = var_cas_inPath.firstObject () ;
  while ((operand_101959 != NULL)) {
    macroValidPointer (operand_101959) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_101959->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_101959->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2406)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_101959->mPathElement.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2412)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_102749 ;
      GGS_entityPropertyMap  var_cas_102752 ;
      GGS_lstring  var_cas_102755 ;
      var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_102749, var_cas_102752, var_cas_102755 SOURCE_FILE_AT_LINE (2417)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (_inLexique, operand_101959->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2420)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_103121 ;
          GGS_lstring  var_cas_103124 ;
          var_cas_ioMapEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_103121, var_cas_103124 SOURCE_FILE_AT_LINE (2424)) ;
          GGS_bool var_cas_103193 ;
          GGS_entityPropertyMap  var_cas_103196 ;
          GGS_lstring  var_cas_103199 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_103193, var_cas_103196, var_cas_103199 SOURCE_FILE_AT_LINE (2425)) ;
        }else{
          GGS_bool var_cas_103280 ;
          GGS_entityPropertyMap  var_cas_103283 ;
          GGS_lstring  var_cas_103286 ;
          var_cas_ioEntityMap.methode_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_103280, var_cas_103283, var_cas_103286 SOURCE_FILE_AT_LINE (2427)) ;
        }
      }
    }
    operand_101959 = operand_101959->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_103601 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_103601 != NULL)) {
    macroValidPointer (operand_103601) ;
    if (((((operand_103601->mInfo.mSuperEntityName.reader_value ()) == (var_cas_inEntityName.reader_value ())) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (var_cas_inEntityName.reader_value ())))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_103601->mKey.reader_value ()) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_103601->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2444)) ;
    }
    operand_103601 = operand_103601->nextObject () ;
  }
}
