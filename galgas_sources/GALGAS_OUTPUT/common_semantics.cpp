...
void routine_checkSignature_ForGrammarComponent (C_Lexique & _inLexique,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1704))) < (var_cas_inFormalTestedSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (1704)))).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_67654 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_67753 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_67654 != NULL)
        && (operand_67753 != NULL)) {
      macroValidPointer (operand_67654) ;
      macroValidPointer (operand_67753) ;
      if (((operand_67654->mFormalArgumentPassingMode) != (operand_67753->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        operand_67753->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "Prototype has ")) + (operand_67654->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1712))))) + (GGS_string (true, ", and ")))) + (operand_67654->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (1713))))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1714)) ;
      }
      if (((operand_67654->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1715))) != (operand_67753->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1715)))).isBuiltAndTrue ()) {
        operand_67753->mGalgasTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_67654->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1716))))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_67753->mGalgasTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1716))))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1717)) ;
      }
      operand_67654 = operand_67654->nextObject () ;
      operand_67753 = operand_67753->nextObject () ;
    }
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_85438 = mNonExternAttributesList.firstObject () ;
  while ((operand_85438 != NULL)) {
    macroValidPointer (operand_85438) ;
    var_cas_outForeachList._addAssign_operation (operand_85438->mAttributType, operand_85438->aNomAttribut) ;
    operand_85438 = operand_85438->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_95989 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_96008 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_95989 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_95989) ;
    cPtr_typeGalgas_stringset * operand_96008 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96008) ;
    if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_95989 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_95989) ;
      cPtr_typeGalgas_uint * operand_96008 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96008) ;
      if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_95989 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_95989) ;
        cPtr_typeGalgas_sint * operand_96008 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96008) ;
        if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_95989 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_95989) ;
          cPtr_typeGalgas_uint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96008) ;
          if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_95989 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_95989) ;
            cPtr_typeGalgas_sint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96008) ;
            if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_95989 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_95989) ;
              cPtr_typeGalgas_char * operand_96008 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96008) ;
              if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_95989 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_95989) ;
                cPtr_typeGalgas_string * operand_96008 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96008) ;
                if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_95989 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_95989) ;
                  cPtr_typeGalgas_bool * operand_96008 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96008) ;
                  if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_95989 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_95989) ;
                    cPtr_typeGalgas_double * operand_96008 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96008) ;
                    if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_95989 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_95989) ;
                      cPtr_typeGalgas_lbool * operand_96008 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96008) ;
                      if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_95989 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_95989) ;
                        cPtr_typeGalgas_lchar * operand_96008 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96008) ;
                        if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_95989 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_95989) ;
                          cPtr_typeGalgas_luint * operand_96008 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96008) ;
                          if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_95989 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_95989) ;
                            cPtr_typeGalgas_lsint * operand_96008 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96008) ;
                            if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_95989 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_95989) ;
                              cPtr_typeGalgas_luint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96008) ;
                              if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_95989 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_95989) ;
                                cPtr_typeGalgas_lsint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96008) ;
                                if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_95989 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_95989) ;
                                  cPtr_typeGalgas_ldouble * operand_96008 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96008) ;
                                  if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_95989 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_95989) ;
                                    cPtr_typeGalgas_lstring * operand_96008 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96008) ;
                                    if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_95989 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_95989) ;
                                      cPtr_typeGalgas_location * operand_96008 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96008) ;
                                      if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_95989 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_95989) ;
                                        cPtr_typeGalgasUndefinedListType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96008) ;
                                        if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                          if (((operand_95989->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2391))) != (operand_96008->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2391)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_95989->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2392))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_96008->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2393))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2394)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_95989 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_95989) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96008) ;
                                          if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                            if (((operand_95989->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2397))) != (operand_96008->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2397)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_95989->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_96008->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2399))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2400)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_95989 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_95989) ;
                                            cPtr_typeGalgasClassType * operand_96008 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_96008) ;
                                            if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_95989->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2404))) == (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2404))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_96008->mAncestorClassesMap.reader_hasKey (_inLexique, operand_95989->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2406)) SOURCE_FILE_AT_LINE (2406)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_95989->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2409))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2410))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2411)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_95989 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_95989) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96008) ;
                                              if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                                if (((operand_95989->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414))) != (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_95989->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2416))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2417)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_95989 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_95989) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96008) ;
                                                if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                                  if (((operand_95989->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421))) != (operand_96008->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_95989->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2422))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_96008->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2423))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2424)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_95989 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_95989) ;
                                                  cPtr_typeGalgas_enum * operand_96008 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96008) ;
                                                  if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                                    if (((operand_95989->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2428))) != (operand_96008->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2428)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_95989->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2429))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_96008->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2430))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2431)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_95989 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_95989) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_96008 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96008) ;
                                                    if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                                      if (((operand_95989->mEntityName) != (operand_96008->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_95989->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_96008->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2438)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_95989 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_95989) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96008 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96008) ;
                                                      if ((operand_95989 != NULL) && (operand_96008 != NULL)) {
                                                        if (((operand_95989->mMapTypeName) != (operand_96008->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_95989->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_96008->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2445)) ;
                                                        }
                                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2463))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2463)))).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_101408 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_101507 = var_cas_signatureTestee.firstObject () ;
    while ((operand_101408 != NULL)
        && (operand_101507 != NULL)) {
      macroValidPointer (operand_101408) ;
      macroValidPointer (operand_101507) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_101408->mType,  operand_101507->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2471)) ;
      if (((operand_101408->mFormalArgumentPassingMode) != (operand_101507->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_101507->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2477))) + (GGS_string (true, " is not compatible with ")))) + (operand_101507->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2478)))) SOURCE_FILE_AT_LINE (2479)) ;
      }
      operand_101408 = operand_101408->nextObject () ;
      operand_101507 = operand_101507->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2622))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_124881 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_124881) ; 
        if (operand_124881->mMessagesMap._isBuilt ()) {
          operand_124881->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2914)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_125160 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125160) ; 
        GGS_L_lstringList  var_cas_125272 ;
        if (operand_125160->mMessagesMap._isBuilt ()) {
          operand_125160->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_125272 SOURCE_FILE_AT_LINE (2918)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2952)) SOURCE_FILE_AT_LINE (2952))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_127071 ;
    GGS_M_semanticsEntitiesForUse  var_cas_127080 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_127071, var_cas_127080 SOURCE_FILE_AT_LINE (2959)) ;
    }
    ...
    GGS_stringset::element_type * operand_127325 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_127325 != NULL)) {
      macroValidPointer (operand_127325) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_127325->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2973)) ;
      operand_127325 = operand_127325->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_127690 = var_cas_modelMap.firstObject () ;
    while ((operand_127690 != NULL)) {
      macroValidPointer (operand_127690) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_127690->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2984)) SOURCE_FILE_AT_LINE (2984))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_127690->mKey, operand_127690->mInfo.mType SOURCE_FILE_AT_LINE (2985)) ;
      }
      operand_127690 = operand_127690->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_127904 = var_cas_actionMap.firstObject () ;
    while ((operand_127904 != NULL)) {
      macroValidPointer (operand_127904) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_127904->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2990)) SOURCE_FILE_AT_LINE (2990))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_127904->mKey, operand_127904->mInfo.mSignature, operand_127904->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2991)) ;
      }
      operand_127904 = operand_127904->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3006))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3007)) SOURCE_FILE_AT_LINE (3007))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3008)) SOURCE_FILE_AT_LINE (3008))))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_128769 ;
    GGS_bool var_cas_128772 ;
    GGS_entityPropertyMap  var_cas_128775 ;
    if (var_cas_inEntityMap._isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_128769, var_cas_128772, var_cas_128775, var_cas_superEntityName SOURCE_FILE_AT_LINE (3011)) ;
    }
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_129512 = var_cas_inPath.firstObject () ;
  while ((operand_129512 != NULL)) {
    macroValidPointer (operand_129512) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_129512->mPathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (3033)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (3033)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_129512->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (3036)) COMMA_HERE) ;
      ...
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3042)) SOURCE_FILE_AT_LINE (3042))))).isBuiltAndTrue ()) {
        operand_129512->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3044))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (3045)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_130305 ;
      GGS_entityPropertyMap  var_cas_130308 ;
      GGS_lstring  var_cas_130311 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130305, var_cas_130308, var_cas_130311 SOURCE_FILE_AT_LINE (3049)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap._isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_129512->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (3052)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3054)) SOURCE_FILE_AT_LINE (3054))).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_130674 ;
          GGS_lstring  var_cas_130677 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_130674, var_cas_130677 SOURCE_FILE_AT_LINE (3056)) ;
          }
          GGS_bool var_cas_130744 ;
          GGS_entityPropertyMap  var_cas_130747 ;
          GGS_lstring  var_cas_130750 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_130744, var_cas_130747, var_cas_130750 SOURCE_FILE_AT_LINE (3057)) ;
          }
        }else{
          GGS_bool var_cas_130829 ;
          GGS_entityPropertyMap  var_cas_130832 ;
          GGS_lstring  var_cas_130835 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130829, var_cas_130832, var_cas_130835 SOURCE_FILE_AT_LINE (3059)) ;
          }
        }
      }
    }
    operand_129512 = operand_129512->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_131150 = var_cas_inEntityMap.firstObject () ;
  while ((operand_131150 != NULL)) {
    macroValidPointer (operand_131150) ;
    if (((((operand_131150->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074))) == (var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074)) SOURCE_FILE_AT_LINE (3074))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet._addAssign_operation (operand_131150->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3075))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_131150->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (3076)) ;
    }
    operand_131150 = operand_131150->nextObject () ;
  }
}
