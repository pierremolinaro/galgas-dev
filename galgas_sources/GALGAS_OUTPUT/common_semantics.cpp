...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_40507 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_40606 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_40507 != NULL)
        && (operand_40606 != NULL)) {
      macroValidPointer (operand_40507) ;
      macroValidPointer (operand_40606) ;
      if (((operand_40507->mFormalArgumentPassingMode) != (operand_40606->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_40606->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_40507->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_40507->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_40507->mGalgasTypeName.reader_value ()) != (operand_40606->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_40606->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_40507->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_40606->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_40507 = operand_40507->nextObject () ;
      operand_40606 = operand_40606->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_57714 = mNonExternAttributesList.firstObject () ;
  while ((operand_57714 != NULL)) {
    macroValidPointer (operand_57714) ;
    var_cas_outForeachList.addAssign_operation (operand_57714->mAttributType, operand_57714->aNomAttribut) ;
    operand_57714 = operand_57714->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_63487 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_63506 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_63487 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_63487) ;
    cPtr_typeGalgas_stringset * operand_63506 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_63506) ;
    if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_63487 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_63487) ;
      cPtr_typeGalgas_uint * operand_63506 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_63506) ;
      if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_63487 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_63487) ;
        cPtr_typeGalgas_sint * operand_63506 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_63506) ;
        if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_63487 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_63487) ;
          cPtr_typeGalgas_char * operand_63506 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_63506) ;
          if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_63487 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_63487) ;
            cPtr_typeGalgas_string * operand_63506 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_63506) ;
            if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_63487 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_63487) ;
              cPtr_typeGalgas_bool * operand_63506 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_63506) ;
              if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_63487 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_63487) ;
                cPtr_typeGalgas_double * operand_63506 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_63506) ;
                if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_63487 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_63487) ;
                  cPtr_typeGalgas_lbool * operand_63506 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_63506) ;
                  if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_63487 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_63487) ;
                    cPtr_typeGalgas_lchar * operand_63506 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_63506) ;
                    if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_63487 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_63487) ;
                      cPtr_typeGalgas_luint * operand_63506 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_63506) ;
                      if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_63487 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_63487) ;
                        cPtr_typeGalgas_lsint * operand_63506 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_63506) ;
                        if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_63487 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_63487) ;
                          cPtr_typeGalgas_ldouble * operand_63506 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_63506) ;
                          if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_63487 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_63487) ;
                            cPtr_typeGalgas_lstring * operand_63506 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_63506) ;
                            if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_63487 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_63487) ;
                              cPtr_typeGalgas_location * operand_63506 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_63506) ;
                              if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_63487 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_63487) ;
                                cPtr_typeGalgasUndefinedListType * operand_63506 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_63506) ;
                                if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                                  if (((operand_63487->mListTypeName.reader_value ()) != (operand_63506->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_63487->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_63506->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_63487 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_63487) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_63506 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_63506) ;
                                  if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                                    if (((operand_63487->mMapTypeName.reader_value ()) != (operand_63506->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_63487->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_63506->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_63487 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_63487) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_63506 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_63506) ;
                                    if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                                      if (((operand_63487->mClassTypeName.reader_value ()) != (operand_63506->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_63487->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_63506->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_63487 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_63487) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_63506 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_63506) ;
                                      if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                                        if (((operand_63487->mGalgasClassName.reader_value ()) != (operand_63506->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_63487->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_63506->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_63487 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_63487) ;
                                        cPtr_typeGalgas_enum * operand_63506 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_63506) ;
                                        if ((operand_63487 != NULL) && (operand_63506 != NULL)) {
                                          if (((operand_63487->mEnumTypeName.reader_value ()) != (operand_63506->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_63487->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_63506->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_67292 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_67391 = var_cas_signatureTestee.firstObject () ;
    while ((operand_67292 != NULL)
        && (operand_67391 != NULL)) {
      macroValidPointer (operand_67292) ;
      macroValidPointer (operand_67391) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_67292->mType,  operand_67391->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_67292->mFormalArgumentPassingMode) != (operand_67391->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_67391->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_67391->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_67292 = operand_67292->nextObject () ;
      operand_67391 = operand_67391->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_78883 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_78883) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_78883->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_79216 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_79216) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_79216->mMessagesMap ;
      GGS_L_lstringList  var_cas_79381 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_79381) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
