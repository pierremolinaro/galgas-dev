...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34793 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34892 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34793 != NULL)
        && (operand_34892 != NULL)) {
      macroValidPointer (operand_34793) ;
      macroValidPointer (operand_34892) ;
      if (((operand_34793->mFormalArgumentPassingMode) != (operand_34892->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34892->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34793->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34793->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34793->mGalgasTypeName.reader_value ()) != (operand_34892->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34892->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34793->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34892->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34793 = operand_34793->nextObject () ;
      operand_34892 = operand_34892->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_52489 = mNonExternAttributesList.firstObject () ;
  while ((operand_52489 != NULL)) {
    macroValidPointer (operand_52489) ;
    var_cas_outForeachList.addAssign_operation (operand_52489->mAttributType, operand_52489->aNomAttribut) ;
    operand_52489 = operand_52489->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59043 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59062 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_stringset * operand_59043 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59043) ;
    cPtr_typeGalgas_stringset * operand_59062 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59062) ;
    if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_59043 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59043) ;
      cPtr_typeGalgas_uint * operand_59062 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59062) ;
      if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_59043 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59043) ;
        cPtr_typeGalgas_sint * operand_59062 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59062) ;
        if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_59043 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59043) ;
          cPtr_typeGalgas_char * operand_59062 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59062) ;
          if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_59043 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59043) ;
            cPtr_typeGalgas_string * operand_59062 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59062) ;
            if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_59043 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59043) ;
              cPtr_typeGalgas_bool * operand_59062 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59062) ;
              if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_59043 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59043) ;
                cPtr_typeGalgas_double * operand_59062 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59062) ;
                if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_59043 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59043) ;
                  cPtr_typeGalgas_lbool * operand_59062 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59062) ;
                  if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_59043 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59043) ;
                    cPtr_typeGalgas_lchar * operand_59062 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59062) ;
                    if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_59043 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59043) ;
                      cPtr_typeGalgas_luint * operand_59062 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59062) ;
                      if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_59043 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59043) ;
                        cPtr_typeGalgas_lsint * operand_59062 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59062) ;
                        if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_59043 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59043) ;
                          cPtr_typeGalgas_ldouble * operand_59062 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59062) ;
                          if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_59043 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59043) ;
                            cPtr_typeGalgas_lstring * operand_59062 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59062) ;
                            if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_59043 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59043) ;
                              cPtr_typeGalgas_location * operand_59062 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59062) ;
                              if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_59043 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59043) ;
                                cPtr_typeGalgasUndefinedListType * operand_59062 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59062) ;
                                if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                                  if (((operand_59043->mListTypeName.reader_value ()) != (operand_59062->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59043->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59062->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_59043 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59043) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_59062 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59062) ;
                                  if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                                    if (((operand_59043->mMapTypeName.reader_value ()) != (operand_59062->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59043->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59062->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_59043 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59043) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_59062 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59062) ;
                                    if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                                      if (((operand_59043->mClassTypeName.reader_value ()) != (operand_59062->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59043->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59062->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_59043 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59043) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_59062 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59062) ;
                                      if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                                        if (((operand_59043->mGalgasClassName.reader_value ()) != (operand_59062->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59043->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59062->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_59043 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59043) ;
                                        cPtr_typeGalgas_enum * operand_59062 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59062) ;
                                        if ((operand_59043 != NULL) && (operand_59062 != NULL)) {
                                          if (((operand_59043->mEnumTypeName.reader_value ()) != (operand_59062->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59043->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59062->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_62844 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_62943 = var_cas_signatureTestee.firstObject () ;
    while ((operand_62844 != NULL)
        && (operand_62943 != NULL)) {
      macroValidPointer (operand_62844) ;
      macroValidPointer (operand_62943) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62844->mType,  operand_62943->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_62844->mFormalArgumentPassingMode) != (operand_62943->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_62943->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_62943->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_62844 = operand_62844->nextObject () ;
      operand_62943 = operand_62943->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_73659 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73659) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73659->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73992 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73992) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73992->mMessagesMap ;
      GGS_L_lstringList  var_cas_74157 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_74157) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
