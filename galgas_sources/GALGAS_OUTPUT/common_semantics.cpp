...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34185 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34265 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34185 != NULL) && (operand_34265 != NULL)) {
      macroValidPointer (operand_34185) ;
      macroValidPointer (operand_34265) ;
      if (((operand_34185->mFormalArgumentPassingMode) != (operand_34265->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34265->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34185->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34185->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34185->mGalgasTypeName.reader_value ()) != (operand_34265->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34265->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34185->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34265->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34185 = operand_34185->nextObject () ;
      operand_34265 = operand_34265->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59115 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59134 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_59115 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59115) ;
    cPtr_typeGalgas_uint * operand_59134 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59134) ;
    if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_59115 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59115) ;
      cPtr_typeGalgas_sint * operand_59134 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59134) ;
      if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_59115 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59115) ;
        cPtr_typeGalgas_char * operand_59134 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59134) ;
        if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_59115 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59115) ;
          cPtr_typeGalgas_string * operand_59134 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59134) ;
          if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_59115 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59115) ;
            cPtr_typeGalgas_bool * operand_59134 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59134) ;
            if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
            }else{
              cPtr_typeGalgas_double * operand_59115 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59115) ;
              cPtr_typeGalgas_double * operand_59134 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59134) ;
              if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_59115 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59115) ;
                cPtr_typeGalgas_lbool * operand_59134 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59134) ;
                if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_59115 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59115) ;
                  cPtr_typeGalgas_lchar * operand_59134 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59134) ;
                  if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_59115 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59115) ;
                    cPtr_typeGalgas_luint * operand_59134 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59134) ;
                    if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_59115 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59115) ;
                      cPtr_typeGalgas_lsint * operand_59134 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59134) ;
                      if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldouble * operand_59115 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59115) ;
                        cPtr_typeGalgas_ldouble * operand_59134 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59134) ;
                        if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_59115 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59115) ;
                          cPtr_typeGalgas_lstring * operand_59134 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59134) ;
                          if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_59115 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59115) ;
                            cPtr_typeGalgas_location * operand_59134 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59134) ;
                            if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_59115 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59115) ;
                              cPtr_typeGalgasUndefinedListType * operand_59134 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59134) ;
                              if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                                if (((operand_59115->mListTypeName.reader_value ()) != (operand_59134->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59115->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59134->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_59115 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59115) ;
                                cPtr_typeGalgasUndefinedMapType * operand_59134 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59134) ;
                                if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                                  if (((operand_59115->mMapTypeName.reader_value ()) != (operand_59134->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59115->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59134->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_59115 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59115) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_59134 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59134) ;
                                  if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                                    if (((operand_59115->mClassTypeName.reader_value ()) != (operand_59134->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59115->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59134->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_59115 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59115) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_59134 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59134) ;
                                    if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                                      if (((operand_59115->mGalgasClassName.reader_value ()) != (operand_59134->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59115->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59134->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_59115 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59115) ;
                                      cPtr_typeGalgas_enum * operand_59134 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59134) ;
                                      if ((operand_59115 != NULL) && (operand_59134 != NULL)) {
                                        if (((operand_59115->mEnumTypeName.reader_value ()) != (operand_59134->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59115->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59134->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_62882 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_62970 = var_cas_signatureTestee.firstObject () ;
    while ((operand_62882 != NULL) && (operand_62970 != NULL)) {
      macroValidPointer (operand_62882) ;
      macroValidPointer (operand_62970) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62882->mType,  operand_62970->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_62882->mFormalArgumentPassingMode) != (operand_62970->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_62970->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_62970->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_62882 = operand_62882->nextObject () ;
      operand_62970 = operand_62970->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_72537 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72537) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_72537->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_73148 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73148) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73148->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73486 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73486) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73486->mMessagesMap ;
