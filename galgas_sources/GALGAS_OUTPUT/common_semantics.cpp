...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2152))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2152)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2154)) ;
    ...
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2156)) ;
  }else{
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2332))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2338)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2340))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2349)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2351))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2360)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2362))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2374)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2376))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2388)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2390))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2399)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2401))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2413)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2415))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2430)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2432))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2447)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2449))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2455)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2457))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2471)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2473))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2484)) ;
          var_cas_outAccessorTypesList.drop_operation () ;
          var_cas_outReturnedType.drop_operation () ;
        }
        ...
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2497)) ;
        var_cas_outAccessorTypesList.drop_operation () ;
        var_cas_outReturnedType.drop_operation () ;
      }
    }
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2578))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2579)) SOURCE_FILE_AT_LINE (2579))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2580)) SOURCE_FILE_AT_LINE (2580))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2581))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_109913 ;
    GGS_bool var_cas_109916 ;
    GGS_entityPropertyMap  var_cas_109919 ;
    if (var_cas_inEntityMap.isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_109913, var_cas_109916, var_cas_109919, var_cas_superEntityName SOURCE_FILE_AT_LINE (2583)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_inEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2584)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_110656 = var_cas_inPath.firstObject () ;
  while ((operand_110656 != NULL)) {
    macroValidPointer (operand_110656) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_110656->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2605)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2605)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_110656->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2608)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2610)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2614)) SOURCE_FILE_AT_LINE (2614))))).isBuiltAndTrue ()) {
        operand_110656->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2616))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2617)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_111446 ;
      GGS_entityPropertyMap  var_cas_111449 ;
      GGS_lstring  var_cas_111452 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_111446, var_cas_111449, var_cas_111452 SOURCE_FILE_AT_LINE (2621)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap.isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_110656->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2624)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2626)) SOURCE_FILE_AT_LINE (2626))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_111814 ;
          GGS_lstring  var_cas_111817 ;
          if (var_cas_ioMapEntityMap.isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_111814, var_cas_111817 SOURCE_FILE_AT_LINE (2628)) ;
          }
          GGS_bool var_cas_111884 ;
          GGS_entityPropertyMap  var_cas_111887 ;
          GGS_lstring  var_cas_111890 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_111884, var_cas_111887, var_cas_111890 SOURCE_FILE_AT_LINE (2629)) ;
          }
        }else{
          GGS_bool var_cas_111969 ;
          GGS_entityPropertyMap  var_cas_111972 ;
          GGS_lstring  var_cas_111975 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_111969, var_cas_111972, var_cas_111975 SOURCE_FILE_AT_LINE (2631)) ;
          }
        }
      }
    }
    operand_110656 = operand_110656->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_112290 = var_cas_inEntityMap.firstObject () ;
  while ((operand_112290 != NULL)) {
    macroValidPointer (operand_112290) ;
    if (((((operand_112290->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2646))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2646)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2646)) SOURCE_FILE_AT_LINE (2646))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_112290->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2647))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_112290->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2648)) ;
    }
    operand_112290 = operand_112290->nextObject () ;
  }
}
