...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1996)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap.isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2004)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_81885 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_81904 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_81885 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_81885) ;
    cPtr_typeGalgas_stringset * operand_81904 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_81904) ;
    if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_81885 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_81885) ;
      cPtr_typeGalgas_uint * operand_81904 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_81904) ;
      if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_81885 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_81885) ;
        cPtr_typeGalgas_sint * operand_81904 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_81904) ;
        if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_81885 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_81885) ;
          cPtr_typeGalgas_char * operand_81904 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_81904) ;
          if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_81885 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_81885) ;
            cPtr_typeGalgas_string * operand_81904 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_81904) ;
            if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_81885 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_81885) ;
              cPtr_typeGalgas_bool * operand_81904 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_81904) ;
              if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_81885 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_81885) ;
                cPtr_typeGalgas_double * operand_81904 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_81904) ;
                if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_81885 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_81885) ;
                  cPtr_typeGalgas_lbool * operand_81904 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_81904) ;
                  if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_81885 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_81885) ;
                    cPtr_typeGalgas_lchar * operand_81904 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_81904) ;
                    if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_81885 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_81885) ;
                      cPtr_typeGalgas_luint * operand_81904 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_81904) ;
                      if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_81885 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_81885) ;
                        cPtr_typeGalgas_lsint * operand_81904 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_81904) ;
                        if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_81885 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_81885) ;
                          cPtr_typeGalgas_ldouble * operand_81904 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_81904) ;
                          if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_81885 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_81885) ;
                            cPtr_typeGalgas_lstring * operand_81904 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_81904) ;
                            if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_81885 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_81885) ;
                              cPtr_typeGalgas_location * operand_81904 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_81904) ;
                              if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_81885 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_81885) ;
                                cPtr_typeGalgasUndefinedListType * operand_81904 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_81904) ;
                                if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                  if (((operand_81885->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2039))) != (operand_81904->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2039)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_81885->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2040))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_81904->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2041))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2041)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_81885 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_81885) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_81904 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_81904) ;
                                  if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                    if (((operand_81885->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2045))) != (operand_81904->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2045)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_81885->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2046))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_81904->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2047))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2047)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_81885 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_81885) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_81904 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_81904) ;
                                    if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                      if (((operand_81885->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2051))) != (operand_81904->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2051)))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_81885->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2052))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_81904->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2053))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2053)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_81885 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_81885) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_81904 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_81904) ;
                                      if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                        if (((operand_81885->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2058))) != (operand_81904->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2058)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_81885->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2059))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_81904->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2060))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2060)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_81885 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_81885) ;
                                        cPtr_typeGalgas_enum * operand_81904 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_81904) ;
                                        if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                          if (((operand_81885->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2065))) != (operand_81904->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2065)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_81885->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2066))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_81904->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2067))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2067)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_entityInInstruction * operand_81885 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_81885) ;
                                          cPtr_typeGalgas_entityInInstruction * operand_81904 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_81904) ;
                                          if ((operand_81885 != NULL) && (operand_81904 != NULL)) {
                                            if (((operand_81885->mEntityName) != (operand_81904->mEntityName)).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_81885->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_81904->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2074)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2078))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2078)))) SOURCE_FILE_AT_LINE (2078)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2093))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2093)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2094)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2095))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2095)))).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2096)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_86076 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_86175 = var_cas_signatureTestee.firstObject () ;
    while ((operand_86076 != NULL)
        && (operand_86175 != NULL)) {
      macroValidPointer (operand_86076) ;
      macroValidPointer (operand_86175) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_86076->mType,  operand_86175->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2100)) ;
      if (((operand_86076->mFormalArgumentPassingMode) != (operand_86175->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_86175->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2102))) + (GGS_string (true, " is not compatible with ")))) + (operand_86175->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2103)))) SOURCE_FILE_AT_LINE (2103)) ;
      }
      operand_86076 = operand_86076->nextObject () ;
      operand_86175 = operand_86175->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2236))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2242))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2245))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2248))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2251))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2254))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2257))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2260))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2263))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2270)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2273))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2278)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2281))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2284))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2289)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2292))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2295))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2300)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2303))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2306))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2309))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2314)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2317))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2320))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2323))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2328)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2331))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2334))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2342))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2345))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2348))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2353)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2356))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2359))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2362))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2365))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2370)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2373))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2376))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        ...
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2390))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2395)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2398))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2403))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2406))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2411)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2414))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2419))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
            var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2424)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_103014 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_103014) ; 
        if (operand_103014->mMessagesMap.isBuilt ()) {
          operand_103014->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2427)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_103293 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_103293) ; 
        GGS_L_lstringList  var_cas_103405 ;
        if (operand_103293->mMessagesMap.isBuilt ()) {
          operand_103293->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_103405 SOURCE_FILE_AT_LINE (2431)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2437)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2465)) SOURCE_FILE_AT_LINE (2465))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_105203 ;
    GGS_M_semanticsEntitiesForUse  var_cas_105212 ;
    if (var_cas_ioSemanticsComponentsMap.isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_105203, var_cas_105212 SOURCE_FILE_AT_LINE (2472)) ;
    }
    ...
    GGS_stringset::element_type * operand_105457 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_105457 != NULL)) {
      macroValidPointer (operand_105457) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_105457->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2486)) ;
      operand_105457 = operand_105457->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_105822 = var_cas_modelMap.firstObject () ;
    while ((operand_105822 != NULL)) {
      macroValidPointer (operand_105822) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_105822->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2497)) SOURCE_FILE_AT_LINE (2497))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_105822->mKey, operand_105822->mInfo.mType SOURCE_FILE_AT_LINE (2498)) ;
      }
      operand_105822 = operand_105822->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_106035 = var_cas_actionMap.firstObject () ;
    while ((operand_106035 != NULL)) {
      macroValidPointer (operand_106035) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_106035->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2503)) SOURCE_FILE_AT_LINE (2503))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_106035->mKey, operand_106035->mInfo.mSignature, operand_106035->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2504)) ;
      }
      operand_106035 = operand_106035->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents.addAssign_operation (var_cas_inSemanticsComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2508))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2519))) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2519)) SOURCE_FILE_AT_LINE (2519))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet.addAssign_operation (var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2520))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_106836 ;
    GGS_bool var_cas_106839 ;
    GGS_entityPropertyMap  var_cas_106842 ;
    if (var_cas_ioEntityMap.isBuilt ()) {
      var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_106836, var_cas_106839, var_cas_106842, var_cas_superEntityName SOURCE_FILE_AT_LINE (2522)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2523)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_107580 = var_cas_inPath.firstObject () ;
  while ((operand_107580 != NULL)) {
    macroValidPointer (operand_107580) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_107580->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2544)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2544)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_107580->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2547)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2549)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2553)) SOURCE_FILE_AT_LINE (2553))))).isBuiltAndTrue ()) {
          operand_107580->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2555))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2555)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_108371 ;
      GGS_entityPropertyMap  var_cas_108374 ;
      GGS_lstring  var_cas_108377 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_108371, var_cas_108374, var_cas_108377 SOURCE_FILE_AT_LINE (2560)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap.isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_107580->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2563)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2565)) SOURCE_FILE_AT_LINE (2565))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_108739 ;
          GGS_lstring  var_cas_108742 ;
          if (var_cas_ioMapEntityMap.isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_108739, var_cas_108742 SOURCE_FILE_AT_LINE (2567)) ;
          }
          GGS_bool var_cas_108809 ;
          GGS_entityPropertyMap  var_cas_108812 ;
          GGS_lstring  var_cas_108815 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_108809, var_cas_108812, var_cas_108815 SOURCE_FILE_AT_LINE (2568)) ;
          }
        }else{
          GGS_bool var_cas_108894 ;
          GGS_entityPropertyMap  var_cas_108897 ;
          GGS_lstring  var_cas_108900 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_108894, var_cas_108897, var_cas_108900 SOURCE_FILE_AT_LINE (2570)) ;
          }
        }
      }
    }
    operand_107580 = operand_107580->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_109215 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_109215 != NULL)) {
    macroValidPointer (operand_109215) ;
    if (((((operand_109215->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2585))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2585)))) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2585)) SOURCE_FILE_AT_LINE (2585))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_109215->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2586))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_109215->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2587)) ;
    }
    operand_109215 = operand_109215->nextObject () ;
  }
}
