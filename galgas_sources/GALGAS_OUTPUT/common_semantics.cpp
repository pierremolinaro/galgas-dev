...
void GGS_fetchedPropertyMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_lstring   & outParameter1,
                                GGS_L_propertyPath   & outParameter2,
                                GGS_location   & outParameter3 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (799)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (884)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (919)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (981)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1051)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1193)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1202)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1211)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1340)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1342)) ;
  }else{
    GGS_L_signature::element_type * operand_53850 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_53949 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_53850 != NULL)
        && (operand_53949 != NULL)) {
      macroValidPointer (operand_53850) ;
      macroValidPointer (operand_53949) ;
      if (((operand_53850->mFormalArgumentPassingMode) != (operand_53949->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_53949->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_53850->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_53850->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1348)) ;
      }
      if (((operand_53850->mGalgasTypeName.reader_value ()) != (operand_53949->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_53949->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_53850->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_53949->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1351)) ;
      }
      operand_53850 = operand_53850->nextObject () ;
      operand_53949 = operand_53949->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1666)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1730)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_71748 = mNonExternAttributesList.firstObject () ;
  while ((operand_71748 != NULL)) {
    macroValidPointer (operand_71748) ;
    var_cas_outForeachList.addAssign_operation (operand_71748->mAttributType, operand_71748->aNomAttribut) ;
    operand_71748 = operand_71748->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1757)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1805)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1816)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1825)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1829)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1888)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_77521 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_77540 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_77521 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77521) ;
    cPtr_typeGalgas_stringset * operand_77540 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77540) ;
    if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_77521 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77521) ;
      cPtr_typeGalgas_uint * operand_77540 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77540) ;
      if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_77521 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77521) ;
        cPtr_typeGalgas_sint * operand_77540 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77540) ;
        if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_77521 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77521) ;
          cPtr_typeGalgas_char * operand_77540 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77540) ;
          if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_77521 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77521) ;
            cPtr_typeGalgas_string * operand_77540 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77540) ;
            if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_77521 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77521) ;
              cPtr_typeGalgas_bool * operand_77540 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77540) ;
              if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_77521 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77521) ;
                cPtr_typeGalgas_double * operand_77540 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77540) ;
                if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_77521 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77521) ;
                  cPtr_typeGalgas_lbool * operand_77540 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77540) ;
                  if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_77521 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77521) ;
                    cPtr_typeGalgas_lchar * operand_77540 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77540) ;
                    if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_77521 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77521) ;
                      cPtr_typeGalgas_luint * operand_77540 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77540) ;
                      if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_77521 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77521) ;
                        cPtr_typeGalgas_lsint * operand_77540 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77540) ;
                        if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_77521 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77521) ;
                          cPtr_typeGalgas_ldouble * operand_77540 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77540) ;
                          if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_77521 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77521) ;
                            cPtr_typeGalgas_lstring * operand_77540 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77540) ;
                            if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_77521 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77521) ;
                              cPtr_typeGalgas_location * operand_77540 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77540) ;
                              if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_77521 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77521) ;
                                cPtr_typeGalgasUndefinedListType * operand_77540 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77540) ;
                                if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                                  if (((operand_77521->mListTypeName.reader_value ()) != (operand_77540->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_77521->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_77540->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1925)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_77521 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77521) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_77540 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77540) ;
                                  if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                                    if (((operand_77521->mMapTypeName.reader_value ()) != (operand_77540->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_77521->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_77540->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1931)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_77521 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77521) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_77540 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77540) ;
                                    if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                                      if (((operand_77521->mClassTypeName.reader_value ()) != (operand_77540->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_77521->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_77540->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1937)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_77521 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77521) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_77540 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77540) ;
                                      if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                                        if (((operand_77521->mGalgasClassName.reader_value ()) != (operand_77540->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_77521->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_77540->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1944)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_77521 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77521) ;
                                        cPtr_typeGalgas_enum * operand_77540 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77540) ;
                                        if ((operand_77521 != NULL) && (operand_77540 != NULL)) {
                                          if (((operand_77521->mEnumTypeName.reader_value ()) != (operand_77540->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_77521->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_77540->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1951)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1955)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1971)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1973)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_81326 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_81425 = var_cas_signatureTestee.firstObject () ;
    while ((operand_81326 != NULL)
        && (operand_81425 != NULL)) {
      macroValidPointer (operand_81326) ;
      macroValidPointer (operand_81425) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_81326->mType,  operand_81425->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1977)) ;
      if (((operand_81326->mFormalArgumentPassingMode) != (operand_81425->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_81425->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_81425->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (1980)) ;
      }
      operand_81326 = operand_81326->nextObject () ;
      operand_81425 = operand_81425->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2132)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2143)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2154)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2168)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2179)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2190)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2204)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2218)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2226)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2245)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2258)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_95944 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95944) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95944->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2262)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_96287 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96287) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96287->mMessagesMap ;
        GGS_L_lstringList  var_cas_96456 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_96456 SOURCE_FILE_AT_LINE (2267)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2273)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_98252 ;
    GGS_M_semanticsEntitiesForUse  var_cas_98261 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_98252, var_cas_98261 SOURCE_FILE_AT_LINE (2308)) ;
    ...
    GGS_stringset::element_type * operand_98506 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_98506 != NULL)) {
      macroValidPointer (operand_98506) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_98506->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2322)) ;
      operand_98506 = operand_98506->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_98871 = var_cas_modelMap.firstObject () ;
    while ((operand_98871 != NULL)) {
      macroValidPointer (operand_98871) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_98871->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_98871->mKey, operand_98871->mInfo.mType SOURCE_FILE_AT_LINE (2334)) ;
      }
      operand_98871 = operand_98871->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_99084 = var_cas_actionMap.firstObject () ;
    while ((operand_99084 != NULL)) {
      macroValidPointer (operand_99084) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_99084->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_99084->mKey, operand_99084->mInfo.mSignature, operand_99084->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2340)) ;
      }
      operand_99084 = operand_99084->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_99887 ;
    GGS_bool var_cas_99890 ;
    GGS_entityPropertyMap  var_cas_99893 ;
    GGS_contextPropertyMap  var_cas_99913 ;
    GGS_fetchedPropertyMap  var_cas_99916 ;
    GGS_fetchedPropertyMap  var_cas_99919 ;
    GGS_insertedPropertyMap  var_cas_99922 ;
    GGS_insertedPropertyMap  var_cas_99925 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_99887, var_cas_99890, var_cas_99893, var_cas_superEntityName, var_cas_99913, var_cas_99916, var_cas_99919, var_cas_99922, var_cas_99925 SOURCE_FILE_AT_LINE (2358)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2359)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_100646 = var_cas_inPath.firstObject () ;
  while ((operand_100646 != NULL)) {
    macroValidPointer (operand_100646) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_100646->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_100646->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2385)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_100646->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2391)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_101436 ;
      GGS_entityPropertyMap  var_cas_101439 ;
      GGS_lstring  var_cas_101442 ;
      GGS_contextPropertyMap  var_cas_101445 ;
      GGS_fetchedPropertyMap  var_cas_101448 ;
      GGS_fetchedPropertyMap  var_cas_101451 ;
      GGS_insertedPropertyMap  var_cas_101454 ;
      GGS_insertedPropertyMap  var_cas_101457 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_101436, var_cas_101439, var_cas_101442, var_cas_101445, var_cas_101448, var_cas_101451, var_cas_101454, var_cas_101457 SOURCE_FILE_AT_LINE (2396)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_101586 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_100646->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_101586 SOURCE_FILE_AT_LINE (2399)) ;
      if (((var_cas_outKind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))).isBuiltAndTrue ()) {
        ...
        GGS_lstring  var_cas_101754 ;
        GGS_lstring  var_cas_101757 ;
        var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_101754, var_cas_101757 SOURCE_FILE_AT_LINE (2402)) ;
        GGS_bool var_cas_101824 ;
        GGS_entityPropertyMap  var_cas_101827 ;
        GGS_lstring  var_cas_101830 ;
        GGS_contextPropertyMap  var_cas_101833 ;
        GGS_fetchedPropertyMap  var_cas_101836 ;
        GGS_fetchedPropertyMap  var_cas_101839 ;
        GGS_insertedPropertyMap  var_cas_101842 ;
        GGS_insertedPropertyMap  var_cas_101845 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_101824, var_cas_101827, var_cas_101830, var_cas_101833, var_cas_101836, var_cas_101839, var_cas_101842, var_cas_101845 SOURCE_FILE_AT_LINE (2403)) ;
        ...
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_102088 ;
          GGS_lstring  var_cas_102091 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_102088, var_cas_102091 SOURCE_FILE_AT_LINE (2407)) ;
          GGS_bool var_cas_102160 ;
          GGS_entityPropertyMap  var_cas_102163 ;
          GGS_lstring  var_cas_102166 ;
          GGS_contextPropertyMap  var_cas_102169 ;
          GGS_fetchedPropertyMap  var_cas_102172 ;
          GGS_fetchedPropertyMap  var_cas_102175 ;
          GGS_insertedPropertyMap  var_cas_102178 ;
          GGS_insertedPropertyMap  var_cas_102181 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_102160, var_cas_102163, var_cas_102166, var_cas_102169, var_cas_102172, var_cas_102175, var_cas_102178, var_cas_102181 SOURCE_FILE_AT_LINE (2408)) ;
        }else{
          GGS_bool var_cas_102262 ;
          GGS_entityPropertyMap  var_cas_102265 ;
          GGS_lstring  var_cas_102268 ;
          GGS_contextPropertyMap  var_cas_102271 ;
          GGS_fetchedPropertyMap  var_cas_102274 ;
          GGS_fetchedPropertyMap  var_cas_102277 ;
          GGS_insertedPropertyMap  var_cas_102280 ;
          GGS_insertedPropertyMap  var_cas_102283 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102262, var_cas_102265, var_cas_102268, var_cas_102271, var_cas_102274, var_cas_102277, var_cas_102280, var_cas_102283 SOURCE_FILE_AT_LINE (2410)) ;
        }
      }
    }
    operand_100646 = operand_100646->nextObject () ;
  }
}
