...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_67168 = mNonExternAttributesList.firstObject () ;
  while ((operand_67168 != NULL)) {
    macroValidPointer (operand_67168) ;
    var_cas_outForeachList.addAssign_operation (operand_67168->mAttributType, operand_67168->aNomAttribut) ;
    operand_67168 = operand_67168->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72941 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72960 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72941 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72941) ;
    cPtr_typeGalgas_stringset * operand_72960 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72960) ;
    if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72941 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72941) ;
      cPtr_typeGalgas_uint * operand_72960 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72960) ;
      if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72941 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72941) ;
        cPtr_typeGalgas_sint * operand_72960 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72960) ;
        if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72941 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72941) ;
          cPtr_typeGalgas_char * operand_72960 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72960) ;
          if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72941 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72941) ;
            cPtr_typeGalgas_string * operand_72960 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72960) ;
            if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72941 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72941) ;
              cPtr_typeGalgas_bool * operand_72960 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72960) ;
              if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72941 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72941) ;
                cPtr_typeGalgas_double * operand_72960 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72960) ;
                if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72941 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72941) ;
                  cPtr_typeGalgas_lbool * operand_72960 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72960) ;
                  if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72941 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72941) ;
                    cPtr_typeGalgas_lchar * operand_72960 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72960) ;
                    if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72941 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72941) ;
                      cPtr_typeGalgas_luint * operand_72960 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72960) ;
                      if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72941 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72941) ;
                        cPtr_typeGalgas_lsint * operand_72960 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72960) ;
                        if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72941 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72941) ;
                          cPtr_typeGalgas_ldouble * operand_72960 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72960) ;
                          if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72941 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72941) ;
                            cPtr_typeGalgas_lstring * operand_72960 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72960) ;
                            if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72941 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72941) ;
                              cPtr_typeGalgas_location * operand_72960 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72960) ;
                              if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72941 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72941) ;
                                cPtr_typeGalgasUndefinedListType * operand_72960 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72960) ;
                                if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                                  if (((operand_72941->mListTypeName.reader_value ()) != (operand_72960->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72941->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72960->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72941 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72941) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72960 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72960) ;
                                  if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                                    if (((operand_72941->mMapTypeName.reader_value ()) != (operand_72960->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72941->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72960->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72941 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72941) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72960 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72960) ;
                                    if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                                      if (((operand_72941->mClassTypeName.reader_value ()) != (operand_72960->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72941->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72960->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72941 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72941) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72960 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72960) ;
                                      if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                                        if (((operand_72941->mGalgasClassName.reader_value ()) != (operand_72960->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72941->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72960->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72941 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72941) ;
                                        cPtr_typeGalgas_enum * operand_72960 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72960) ;
                                        if ((operand_72941 != NULL) && (operand_72960 != NULL)) {
                                          if (((operand_72941->mEnumTypeName.reader_value ()) != (operand_72960->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72941->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72960->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_76746 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_76845 = var_cas_signatureTestee.firstObject () ;
    while ((operand_76746 != NULL)
        && (operand_76845 != NULL)) {
      macroValidPointer (operand_76746) ;
      macroValidPointer (operand_76845) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_76746->mType,  operand_76845->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_76746->mFormalArgumentPassingMode) != (operand_76845->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_76845->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_76845->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_76746 = operand_76746->nextObject () ;
      operand_76845 = operand_76845->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_91176 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_91176) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_91176->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_91519 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_91519) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_91519->mMessagesMap ;
        GGS_L_lstringList  var_cas_91688 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_91688) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_93484 ;
    GGS_M_semanticsEntitiesForUse  var_cas_93493 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_93484, var_cas_93493) ;
    ...
    GGS_stringset::element_type * operand_93738 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_93738 != NULL)) {
      macroValidPointer (operand_93738) ;
      ...
      operand_93738 = operand_93738->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_94103 = var_cas_modelMap.firstObject () ;
    while ((operand_94103 != NULL)) {
      macroValidPointer (operand_94103) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_94103->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_94103->mKey, operand_94103->mInfo.mType) ;
      }
      operand_94103 = operand_94103->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_94316 = var_cas_actionMap.firstObject () ;
    while ((operand_94316 != NULL)) {
      macroValidPointer (operand_94316) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_94316->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_94316->mKey, operand_94316->mInfo.mSignature, operand_94316->mInfo.mIsExtern) ;
      }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_95058 ;
    GGS_bool var_cas_95061 ;
    GGS_entityPropertyMap  var_cas_95064 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_95058, var_cas_95061, var_cas_95064, var_cas_superEntityName) ;
