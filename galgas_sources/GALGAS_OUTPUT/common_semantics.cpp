...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_72338 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72338) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_72338->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_72949 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_72949) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_72949->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73287 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73287) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73287->mMessagesMap ;
