...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
    ...
    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type cannot appear in 'foreach' instruction")) ;
}
...
void GGS_M_accessors_map::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_signature   & outParameter0,
                                GGS_AC_galgasType   & outParameter1) {
...
void GGS_M_accessors_map::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_signature & inParameter0,
                                const GGS_AC_galgasType & inParameter1) {
...
bool cPtr_typeGalgas_double::isBuilt (void) const {
  return true ;
}
...
bool cPtr_typeGalgas_ldouble::isBuilt (void) const {
  return true ;
}
...
bool cPtr_typeGalgas_stringset::isBuilt (void) const {
  return true ;
}
...
methode_handleAddAssignOperatorCall (C_Lexique & lexique_var_,
  ...
  var_cas_outAccept_luint_assignment = GGS_bool (true, true) ;
}
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeTableMethodes::element_type * info = searchKey (inLexique, inKey, inKey, errorMessage_0) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
  }else{
...
//---------------------------------------------------------------------------*
  ...
  GGS_typeTableMethodes::element_type * info = searchForOverride (inLexique, inKey, inKey, errorMessage_0) ;
  if (info == NULL) {
    outParameter0.drop_operation () ;
  }else{
    outParameter0 = info->mInfo.aListeTypesParametres ;
...
void GGS_typeTableMethodes::methode_insertAbstract (C_Lexique & lexique_var_,
  ...
  insertAbstract (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeTableMethodes::methode_insertAbstractGetIndex (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertAbstract (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
...
void GGS_typeTableMethodes::methode_insertNotAbstract (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  insertNotAbstract (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
}
...
void GGS_typeTableMethodes::methode_insertNotAbstractGetIndex (C_Lexique & lexique_var_,
  ...
  e_typeTableMethodes info ;
  info.aListeTypesParametres = inParameter0 ;
  const sint32 index = insertNotAbstract (lexique_var_, info, inKey, inKey, kErrorMessage_0) ;
  outIndex = GGS_luint (GGS_uint (index >= 0, (uint32) index), inKey) ;
}
...
void GGS_M_externTypeConstructorMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_typeListeAttributsSemantiques   & outParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_M_externTypeConstructorMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_typeListeAttributsSemantiques & inParameter0) {
  const char * kErrorMessage [] = {"the '",
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_constructorMap.isBuilt ()) {
...
void GGS_M_terminalSymbolsMapForUse::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_typeListeAttributsSemantiques   & outParameter0) {
  const char * kErrorMessage [] = {"the terminal symbol '$",
...
void GGS_M_terminalSymbolsMapForUse::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_typeListeAttributsSemantiques & inParameter0) {
  const char * kErrorMessage [] = {"the terminal symbol '$",
...
void GGS_M_lexiqueComponents::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_terminalSymbolsMapForUse   & outParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_M_lexiqueComponents::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_terminalSymbolsMapForUse & inParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_typeTableEnAvant::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_AC_galgasType   & outParameter0) {
  const char * kErrorMessage [] = {"the type '",
...
void GGS_typeTableEnAvant::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_galgasType & inParameter0) {
  const char * kErrorMessage [] = {"the type '",
...
void GGS_M_nonterminalSymbolAlts::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_signature   & outParameter0) {
  const char * kErrorMessage [] = {"the label '",
...
void GGS_M_nonterminalSymbolAlts::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_signature & inParameter0) {
  const char * kErrorMessage [] = {"the label '",
...
void GGS_M_externClassesDirectories::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_lstring   & outParameter0) {
  const char * kErrorMessage [] = {"the extern class '",
...
void GGS_M_externClassesDirectories::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_lstring & inParameter0) {
  const char * kErrorMessage [] = {"the extern class '",
...
void GGS_M_semanticsEntitiesForUse::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_AC_semanticsEntity   & outParameter0) {
  const char * kErrorMessage [] = {"there is no semantics entity named '",
...
void GGS_M_semanticsEntitiesForUse::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_semanticsEntity & inParameter0) {
  const char * kErrorMessage [] = {"a semantics entity named '",
...
void GGS_M_typesForGrammarComponent::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_AC_typeForGrammarComponent   & outParameter0) {
  const char * kErrorMessage [] = {"the '@",
...
void GGS_M_typesForGrammarComponent::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_typeForGrammarComponent & inParameter0) {
  const char * kErrorMessage [] = {"the '@",
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_36226 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_36325 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_36226 != NULL)
        && (operand_36325 != NULL)) {
      macroValidPointer (operand_36226) ;
      macroValidPointer (operand_36325) ;
      if (((operand_36226->mFormalArgumentPassingMode) != (operand_36325->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_36325->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_36226->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_36226->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_36226->mGalgasTypeName.reader_value ()) != (operand_36325->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_36325->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_36226->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_36325->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_36226 = operand_36226->nextObject () ;
      operand_36325 = operand_36325->nextObject () ;
    }
  }
}
...
void GGS_L_grammarsMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_nonterminalSymbolAlts   & outParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_L_grammarsMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_nonterminalSymbolAlts & inParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_M_nonterminalSymbolAltsForGrammar::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_signature_ForGrammarComponent   & outParameter0) {
  const char * kErrorMessage [] = {"the rules label '",
...
void GGS_M_nonterminalSymbolAltsForGrammar::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_signature_ForGrammarComponent & inParameter0) {
  const char * kErrorMessage [] = {"the rules label '",
...
void GGS_M_nonTerminalSymbolsForGrammar::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_nonterminalSymbolAltsForGrammar & inParameter0) {
  const char * kErrorMessage [] = {"internal insert error",
...
void GGS_M_syntaxComponents::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_nonTerminalSymbolsForGrammar   & outParameter0,
                                GGS_L_productionRules_ForGrammarComponent   & outParameter1,
...
void GGS_M_syntaxComponents::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_nonTerminalSymbolsForGrammar & inParameter0,
                                const GGS_L_productionRules_ForGrammarComponent & inParameter1,
...
void GGS_typeSuperClassesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the class '",
                                   "",
...
void GGS_typeClassInheritedMessagesMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the message '",
                                   "",
...
void GGS_typeClassInheritedMessagesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the message '",
                                   "",
...
void GGS_typeSemanticAttributesMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_AC_galgasType   & outParameter0) {
  const char * kErrorMessage [] = {"there is no attribut named '",
...
void GGS_typeSemanticAttributesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_galgasType & inParameter0) {
  const char * kErrorMessage [] = {"an attribut named '",
...
//---------------------------------------------------------------------------*
//                                                                           *
//                  Class element of list 'lastStateList'                    *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_lastStateList::element_type::
element_type (const GGS_lstring & argument_0,
...
GGS_transitionStatusMap::element_type::
element_type (const GGS_lstring & inKey,
              const sint32 inIndex,
...
void GGS_transitionStatusMap::methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_lastStateEnum& inParameter0,
                                const GGS_L_stringList & inParameter1) {
  const char * kErrorMessage [] = {"a transition named '",
                                   "",
                                   "' is already declared",
                                   NULL} ;
  insertElement (lexique_var_,
...
void GGS_transitionStatusMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_lastStateEnum& inParameter0,
                                const GGS_L_stringList & inParameter1) {
...
insertElement (C_Lexique & inLexique,
               ...
               const GGS_lastStateList &  inParameter2,
               const GGS_transitionStatusMap &  inParameter3,
               GGS_luint * outIndex) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()
                 && inParameter0.isBuilt ()
    ...
    info.mFirstState = inParameter1 ;
    info.mLastStateList = inParameter2 ;
    info.mTransitionStatusMap = inParameter3 ;
    bool extension = false ; // Unused here
    internalInsert (inKey, (void *) & info, mRoot, extension, index) ;
    if (index < 0) {
      C_String keyString ;
...
searchElement (C_Lexique & inLexique,
               ...
               GGS_lastStateList   & outParameter2,
               GGS_transitionStatusMap   & outParameter3,
               GGS_luint * outIndex) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
    AC_galgas_map_element * p = internal_search (inKey) ;
  ...
  if (node == NULL) {
    ...
    outParameter1 = node->mInfo.mFirstState ;
    outParameter2 = node->mInfo.mLastStateList ;
    outParameter3 = node->mInfo.mTransitionStatusMap ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_typeTableMethodesInsererChercher::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_L_stringList   & outParameter0,
                                GGS_string  & outParameter1,
                                GGS_lastStateList   & outParameter2,
...
void GGS_typeTableMethodesInsererChercher::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_stringList   & outParameter0,
                                GGS_string  & outParameter1,
...
void GGS_typeTableMethodesInsererChercher::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_L_stringList & inParameter0,
                                const GGS_string& inParameter1,
                                const GGS_lastStateList & inParameter2,
...
void GGS_typeTableMethodesInsererChercher::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_stringList & inParameter0,
                                const GGS_string& inParameter1,
...
void GGS_typeTableBlocsDeTable::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_signature   & outParameter0,
                                GGS_L_signature   & outParameter1) {
...
void GGS_typeTableBlocsDeTable::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_signature & inParameter0,
                                const GGS_L_signature & inParameter1) {
...
void GGS_mapMethodMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_L_signature   & outParameter0) {
  const char * kErrorMessage [] = {"there is no insert nor search method named '",
                                   "",
                                   "'",
                                   NULL} ;
  searchElement (inLexique,
...
void GGS_mapMethodMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_signature   & outParameter0) {
  const char * kErrorMessage [] = {"there is no insert nor search method named '",
...
void GGS_mapMethodMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_L_signature & inParameter0) {
  const char * kErrorMessage [] = {"an insert or a search method named '",
                                   "",
                                   "' is already declared",
                                   NULL} ;
  insertElement (lexique_var_,
...
void GGS_mapMethodMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_signature & inParameter0) {
  const char * kErrorMessage [] = {"an insert or a search method named '",
...
cPtr_typeGalgasMapType::cPtr_typeGalgasMapType (const GGS_lstring & argument_0,
                                ...
                                const GGS_mapMethodMap & argument_5)
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  var_cas_outForeachList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
  var_cas_outForeachList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, "\?\?\?"), GGS_location (lexique_var_))) ;
  GGS_typeListeAttributsSemantiques::element_type * operand_54261 = mNonExternAttributesList.firstObject () ;
  while ((operand_54261 != NULL)) {
    macroValidPointer (operand_54261) ;
    var_cas_outForeachList.addAssign_operation (operand_54261->mAttributType, operand_54261->aNomAttribut) ;
    operand_54261 = operand_54261->nextObject () ;
  }
}
...
void GGS_typeTableUtilisationsSemantiques::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"--- internal error ---",
                                   NULL} ;
...
void GGS_typeEnumConstantesMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_typeEnumConstantesMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex) {
  const char * kErrorMessage [] = {"the '",
                                   "",
...
void GGS_typeEnumMessageMap::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_L_lstringList   & outParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void GGS_typeEnumMessageMap::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_L_lstringList & inParameter0) {
  const char * kErrorMessage [] = {"the '",
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_60810 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_60829 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_stringset * operand_60810 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60810) ;
    cPtr_typeGalgas_stringset * operand_60829 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_60829) ;
    if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_60810 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60810) ;
      cPtr_typeGalgas_uint * operand_60829 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_60829) ;
      if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_60810 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60810) ;
        cPtr_typeGalgas_sint * operand_60829 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_60829) ;
        if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_60810 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60810) ;
          cPtr_typeGalgas_char * operand_60829 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_60829) ;
          if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_60810 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60810) ;
            cPtr_typeGalgas_string * operand_60829 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_60829) ;
            if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_60810 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60810) ;
              cPtr_typeGalgas_bool * operand_60829 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_60829) ;
              if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_60810 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60810) ;
                cPtr_typeGalgas_double * operand_60829 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_60829) ;
                if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_60810 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60810) ;
                  cPtr_typeGalgas_lbool * operand_60829 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_60829) ;
                  if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_60810 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60810) ;
                    cPtr_typeGalgas_lchar * operand_60829 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_60829) ;
                    if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_60810 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60810) ;
                      cPtr_typeGalgas_luint * operand_60829 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_60829) ;
                      if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_60810 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60810) ;
                        cPtr_typeGalgas_lsint * operand_60829 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_60829) ;
                        if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_60810 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60810) ;
                          cPtr_typeGalgas_ldouble * operand_60829 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_60829) ;
                          if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_60810 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60810) ;
                            cPtr_typeGalgas_lstring * operand_60829 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_60829) ;
                            if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_60810 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60810) ;
                              cPtr_typeGalgas_location * operand_60829 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_60829) ;
                              if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_60810 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60810) ;
                                cPtr_typeGalgasUndefinedListType * operand_60829 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_60829) ;
                                if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                                  if (((operand_60810->mListTypeName.reader_value ()) != (operand_60829->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_60810->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_60829->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_60810 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60810) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_60829 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_60829) ;
                                  if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                                    if (((operand_60810->mMapTypeName.reader_value ()) != (operand_60829->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_60810->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_60829->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_60810 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60810) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_60829 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_60829) ;
                                    if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                                      if (((operand_60810->mClassTypeName.reader_value ()) != (operand_60829->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_60810->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_60829->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_60810 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60810) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_60829 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_60829) ;
                                      if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                                        if (((operand_60810->mGalgasClassName.reader_value ()) != (operand_60829->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_60810->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_60829->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_60810 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60810) ;
                                        cPtr_typeGalgas_enum * operand_60829 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_60829) ;
                                        if ((operand_60810 != NULL) && (operand_60829 != NULL)) {
                                          if (((operand_60810->mEnumTypeName.reader_value ()) != (operand_60829->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_60810->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_60829->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_64611 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_64710 = var_cas_signatureTestee.firstObject () ;
    while ((operand_64611 != NULL)
        && (operand_64710 != NULL)) {
      macroValidPointer (operand_64611) ;
      macroValidPointer (operand_64710) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_64611->mType,  operand_64710->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_64611->mFormalArgumentPassingMode) != (operand_64710->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_64710->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_64710->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_64611 = operand_64611->nextObject () ;
      operand_64710 = operand_64710->nextObject () ;
    }
  }
}
...
void GGS_M_cli_options::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_lchar   & outParameter0,
                                GGS_lstring   & outParameter1,
...
void GGS_M_cli_options::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_lchar & inParameter0,
                                const GGS_lstring & inParameter1,
...
void GGS_M_optionComponents::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_cli_options   & outParameter0,
                                GGS_M_cli_options   & outParameter1) {
...
void GGS_M_optionComponents::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_cli_options & inParameter0,
                                const GGS_M_cli_options & inParameter1) {
...
void GGS_M_semanticsComponents::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_semanticsEntitiesForUse   & outParameter0,
                                GGS_M_optionComponents   & outParameter1) {
...
void GGS_M_semanticsComponents::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_semanticsEntitiesForUse & inParameter0,
                                const GGS_M_optionComponents & inParameter1) {
...
void GGS_M_grammarComponents::methode_searchKeyGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                GGS_M_nonterminalSymbolAltsForGrammar   & outParameter0,
                                GGS_lstring   & outParameter1,
...
void GGS_M_grammarComponents::methode_insertKeyGetIndex (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_M_nonterminalSymbolAltsForGrammar & inParameter0,
                                const GGS_lstring & inParameter1,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        ...
        var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      }else if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "index"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        GGS_AC_galgasType  var_cas_keyType ;
        var_cas_keyType = GGS_typeGalgas_string::constructor_new () ;
        var_cas_outAccessorTypesList.addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_luint::constructor_new () ;
      }else if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new () ;
      }else{
      ...
      cPtr_typeGalgasClassType * operand_75745 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_75745) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_75745->mMessagesMap ;
      if (var_cas_messagesMap.isBuilt ()) {
      ...
      cPtr_typeGalgas_enum * operand_76078 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_76078) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_76078->mMessagesMap ;
      GGS_L_lstringList  var_cas_76243 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_76243) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
