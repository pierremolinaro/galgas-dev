...
insertElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
               const GGS_L_propertyPath &  inParameter0,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  sint32 index = - 1 ;
  if (isBuilt () && inKey.isBuilt ()) {
...
searchElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
               GGS_L_propertyPath   & outParameter0,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  element_type * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mPath ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_relationVarMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_L_propertyPath   & outParameter0 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_L_propertyPath & inParameter0 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
cPtr_metamodelRelationPrimary::cPtr_metamodelRelationPrimary (const GGS_lstring & argument_0,
                                const GGS_luint & argument_1,
                                const GGS_L_propertyPath & argument_2 COMMA_LOCATION_ARGS)
:cPtr_metamodelRelationExpression (THERE),
mVariable (argument_0),
mVariableIndex (argument_1),
mPath (argument_2) {
}
...
void GGS_entityToImplementMap::methode_searchKey (C_Lexique & inLexique,
                                ...
                                GGS_fetchedPropertyMap   & outParameter6,
                                GGS_insertedPropertyMap   & outParameter7,
                                GGS_insertedPropertyMap   & outParameter8 COMMA_LOCATION_ARGS) {
  searchElement (inLexique,
...
methode_insertKey (C_Lexique & lexique_var_,
                                ...
                                const GGS_fetchedPropertyMap & inParameter6,
                                const GGS_insertedPropertyMap & inParameter7,
                                const GGS_insertedPropertyMap & inParameter8 COMMA_LOCATION_ARGS) {
  insertElement (lexique_var_,
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (798)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (918)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1050)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1192)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1201)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1210)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1339)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1341)) ;
  }else{
    GGS_L_signature::element_type * operand_53822 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_53921 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_53822 != NULL)
        && (operand_53921 != NULL)) {
      macroValidPointer (operand_53822) ;
      macroValidPointer (operand_53921) ;
      if (((operand_53822->mFormalArgumentPassingMode) != (operand_53921->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_53921->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_53822->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_53822->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1347)) ;
      }
      if (((operand_53822->mGalgasTypeName.reader_value ()) != (operand_53921->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_53921->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_53822->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_53921->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1350)) ;
      }
      operand_53822 = operand_53822->nextObject () ;
      operand_53921 = operand_53921->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1665)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1729)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_71720 = mNonExternAttributesList.firstObject () ;
  while ((operand_71720 != NULL)) {
    macroValidPointer (operand_71720) ;
    var_cas_outForeachList.addAssign_operation (operand_71720->mAttributType, operand_71720->aNomAttribut) ;
    operand_71720 = operand_71720->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1756)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1804)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1815)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1824)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1828)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1887)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_77493 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_77512 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_77493 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77493) ;
    cPtr_typeGalgas_stringset * operand_77512 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_77512) ;
    if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_77493 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77493) ;
      cPtr_typeGalgas_uint * operand_77512 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_77512) ;
      if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_77493 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77493) ;
        cPtr_typeGalgas_sint * operand_77512 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_77512) ;
        if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_77493 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77493) ;
          cPtr_typeGalgas_char * operand_77512 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_77512) ;
          if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_77493 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77493) ;
            cPtr_typeGalgas_string * operand_77512 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_77512) ;
            if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_77493 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77493) ;
              cPtr_typeGalgas_bool * operand_77512 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_77512) ;
              if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_77493 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77493) ;
                cPtr_typeGalgas_double * operand_77512 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_77512) ;
                if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_77493 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77493) ;
                  cPtr_typeGalgas_lbool * operand_77512 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_77512) ;
                  if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_77493 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77493) ;
                    cPtr_typeGalgas_lchar * operand_77512 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_77512) ;
                    if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_77493 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77493) ;
                      cPtr_typeGalgas_luint * operand_77512 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_77512) ;
                      if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_77493 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77493) ;
                        cPtr_typeGalgas_lsint * operand_77512 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_77512) ;
                        if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_77493 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77493) ;
                          cPtr_typeGalgas_ldouble * operand_77512 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_77512) ;
                          if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_77493 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77493) ;
                            cPtr_typeGalgas_lstring * operand_77512 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_77512) ;
                            if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_77493 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77493) ;
                              cPtr_typeGalgas_location * operand_77512 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_77512) ;
                              if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_77493 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77493) ;
                                cPtr_typeGalgasUndefinedListType * operand_77512 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_77512) ;
                                if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                                  if (((operand_77493->mListTypeName.reader_value ()) != (operand_77512->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_77493->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_77512->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1924)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_77493 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77493) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_77512 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_77512) ;
                                  if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                                    if (((operand_77493->mMapTypeName.reader_value ()) != (operand_77512->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_77493->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_77512->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1930)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_77493 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77493) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_77512 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_77512) ;
                                    if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                                      if (((operand_77493->mClassTypeName.reader_value ()) != (operand_77512->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_77493->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_77512->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1936)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_77493 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77493) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_77512 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_77512) ;
                                      if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                                        if (((operand_77493->mGalgasClassName.reader_value ()) != (operand_77512->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_77493->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_77512->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1943)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_77493 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77493) ;
                                        cPtr_typeGalgas_enum * operand_77512 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_77512) ;
                                        if ((operand_77493 != NULL) && (operand_77512 != NULL)) {
                                          if (((operand_77493->mEnumTypeName.reader_value ()) != (operand_77512->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_77493->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_77512->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1950)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1954)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (1970)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (1972)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_81298 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_81397 = var_cas_signatureTestee.firstObject () ;
    while ((operand_81298 != NULL)
        && (operand_81397 != NULL)) {
      macroValidPointer (operand_81298) ;
      macroValidPointer (operand_81397) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_81298->mType,  operand_81397->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (1976)) ;
      if (((operand_81298->mFormalArgumentPassingMode) != (operand_81397->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_81397->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_81397->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (1979)) ;
      }
      operand_81298 = operand_81298->nextObject () ;
      operand_81397 = operand_81397->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2131)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2142)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2153)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2167)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2178)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2189)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2203)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2217)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2225)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2244)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2257)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_95916 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95916) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95916->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2261)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_96259 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96259) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96259->mMessagesMap ;
        GGS_L_lstringList  var_cas_96428 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_96428 SOURCE_FILE_AT_LINE (2266)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2272)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_98224 ;
    GGS_M_semanticsEntitiesForUse  var_cas_98233 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_98224, var_cas_98233 SOURCE_FILE_AT_LINE (2307)) ;
    ...
    GGS_stringset::element_type * operand_98478 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_98478 != NULL)) {
      macroValidPointer (operand_98478) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_98478->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2321)) ;
      operand_98478 = operand_98478->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_98843 = var_cas_modelMap.firstObject () ;
    while ((operand_98843 != NULL)) {
      macroValidPointer (operand_98843) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_98843->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_98843->mKey, operand_98843->mInfo.mType SOURCE_FILE_AT_LINE (2333)) ;
      }
      operand_98843 = operand_98843->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_99056 = var_cas_actionMap.firstObject () ;
    while ((operand_99056 != NULL)) {
      macroValidPointer (operand_99056) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_99056->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_99056->mKey, operand_99056->mInfo.mSignature, operand_99056->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2339)) ;
      }
      operand_99056 = operand_99056->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_99859 ;
    GGS_bool var_cas_99862 ;
    GGS_entityPropertyMap  var_cas_99865 ;
    GGS_contextPropertyMap  var_cas_99885 ;
    GGS_fetchedPropertyMap  var_cas_99888 ;
    GGS_fetchedPropertyMap  var_cas_99891 ;
    GGS_insertedPropertyMap  var_cas_99894 ;
    GGS_insertedPropertyMap  var_cas_99897 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_99859, var_cas_99862, var_cas_99865, var_cas_superEntityName, var_cas_99885, var_cas_99888, var_cas_99891, var_cas_99894, var_cas_99897 SOURCE_FILE_AT_LINE (2357)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2358)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_100618 = var_cas_inPath.firstObject () ;
  while ((operand_100618 != NULL)) {
    macroValidPointer (operand_100618) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_100618->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_100618->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2384)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_100618->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2390)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_101408 ;
      GGS_entityPropertyMap  var_cas_101411 ;
      GGS_lstring  var_cas_101414 ;
      GGS_contextPropertyMap  var_cas_101417 ;
      GGS_fetchedPropertyMap  var_cas_101420 ;
      GGS_fetchedPropertyMap  var_cas_101423 ;
      GGS_insertedPropertyMap  var_cas_101426 ;
      GGS_insertedPropertyMap  var_cas_101429 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_101408, var_cas_101411, var_cas_101414, var_cas_101417, var_cas_101420, var_cas_101423, var_cas_101426, var_cas_101429 SOURCE_FILE_AT_LINE (2395)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_101558 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_100618->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_101558 SOURCE_FILE_AT_LINE (2398)) ;
      if (((var_cas_outKind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))).isBuiltAndTrue ()) {
        ...
        GGS_lstring  var_cas_101726 ;
        GGS_lstring  var_cas_101729 ;
        var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_101726, var_cas_101729 SOURCE_FILE_AT_LINE (2401)) ;
        GGS_bool var_cas_101796 ;
        GGS_entityPropertyMap  var_cas_101799 ;
        GGS_lstring  var_cas_101802 ;
        GGS_contextPropertyMap  var_cas_101805 ;
        GGS_fetchedPropertyMap  var_cas_101808 ;
        GGS_fetchedPropertyMap  var_cas_101811 ;
        GGS_insertedPropertyMap  var_cas_101814 ;
        GGS_insertedPropertyMap  var_cas_101817 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_101796, var_cas_101799, var_cas_101802, var_cas_101805, var_cas_101808, var_cas_101811, var_cas_101814, var_cas_101817 SOURCE_FILE_AT_LINE (2402)) ;
        ...
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_102060 ;
          GGS_lstring  var_cas_102063 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_102060, var_cas_102063 SOURCE_FILE_AT_LINE (2406)) ;
          GGS_bool var_cas_102132 ;
          GGS_entityPropertyMap  var_cas_102135 ;
          GGS_lstring  var_cas_102138 ;
          GGS_contextPropertyMap  var_cas_102141 ;
          GGS_fetchedPropertyMap  var_cas_102144 ;
          GGS_fetchedPropertyMap  var_cas_102147 ;
          GGS_insertedPropertyMap  var_cas_102150 ;
          GGS_insertedPropertyMap  var_cas_102153 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_102132, var_cas_102135, var_cas_102138, var_cas_102141, var_cas_102144, var_cas_102147, var_cas_102150, var_cas_102153 SOURCE_FILE_AT_LINE (2407)) ;
        }else{
          GGS_bool var_cas_102234 ;
          GGS_entityPropertyMap  var_cas_102237 ;
          GGS_lstring  var_cas_102240 ;
          GGS_contextPropertyMap  var_cas_102243 ;
          GGS_fetchedPropertyMap  var_cas_102246 ;
          GGS_fetchedPropertyMap  var_cas_102249 ;
          GGS_insertedPropertyMap  var_cas_102252 ;
          GGS_insertedPropertyMap  var_cas_102255 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102234, var_cas_102237, var_cas_102240, var_cas_102243, var_cas_102246, var_cas_102249, var_cas_102252, var_cas_102255 SOURCE_FILE_AT_LINE (2409)) ;
        }
      }
    }
    operand_100618 = operand_100618->nextObject () ;
  }
}
