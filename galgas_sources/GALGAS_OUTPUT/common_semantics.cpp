...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2578))) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2578)) SOURCE_FILE_AT_LINE (2578))))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_109855 ;
    GGS_bool var_cas_109858 ;
    GGS_entityPropertyMap  var_cas_109861 ;
    if (var_cas_ioEntityMap.isBuilt ()) {
      var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_109855, var_cas_109858, var_cas_109861, var_cas_superEntityName SOURCE_FILE_AT_LINE (2581)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2582)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_110599 = var_cas_inPath.firstObject () ;
  while ((operand_110599 != NULL)) {
    macroValidPointer (operand_110599) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_110599->mPathElement.reader_value (_inLexique SOURCE_FILE_AT_LINE (2603)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (2603)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_110599->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (2606)) COMMA_HERE) ;
      ...
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2612)) SOURCE_FILE_AT_LINE (2612))))).isBuiltAndTrue ()) {
          operand_110599->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2614))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2614)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_111390 ;
      GGS_entityPropertyMap  var_cas_111393 ;
      GGS_lstring  var_cas_111396 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_111390, var_cas_111393, var_cas_111396 SOURCE_FILE_AT_LINE (2619)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap.isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_110599->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2622)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2624)) SOURCE_FILE_AT_LINE (2624))).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_111758 ;
          GGS_lstring  var_cas_111761 ;
          if (var_cas_ioMapEntityMap.isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_111758, var_cas_111761 SOURCE_FILE_AT_LINE (2626)) ;
          }
          GGS_bool var_cas_111828 ;
          GGS_entityPropertyMap  var_cas_111831 ;
          GGS_lstring  var_cas_111834 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_111828, var_cas_111831, var_cas_111834 SOURCE_FILE_AT_LINE (2627)) ;
          }
        }else{
          GGS_bool var_cas_111913 ;
          GGS_entityPropertyMap  var_cas_111916 ;
          GGS_lstring  var_cas_111919 ;
          if (var_cas_ioEntityMap.isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_111913, var_cas_111916, var_cas_111919 SOURCE_FILE_AT_LINE (2629)) ;
          }
        }
      }
    }
    operand_110599 = operand_110599->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_112234 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_112234 != NULL)) {
    macroValidPointer (operand_112234) ;
    if (((((operand_112234->mInfo.mSuperEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2644))) == (var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2644)))) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_value (_inLexique SOURCE_FILE_AT_LINE (2644)) SOURCE_FILE_AT_LINE (2644))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_112234->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (2645))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_ioEntityMap,  operand_112234->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2646)) ;
    }
    operand_112234 = operand_112234->nextObject () ;
  }
}
