        ...
        if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
          ...
          if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
            ...
            if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
              ...
              cPtr_typeGalgas_dfloat * operand_59114 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_59114) ;
              cPtr_typeGalgas_dfloat * operand_59133 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_59133) ;
              if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
              }else{
                  ...
                  if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                    ...
                    if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                      ...
                      if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                        ...
                        cPtr_typeGalgas_ldfloat * operand_59114 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_59114) ;
                        cPtr_typeGalgas_ldfloat * operand_59133 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_59133) ;
                        if ((operand_59114 != NULL) && (operand_59133 != NULL)) {
                        }else{
