...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34773 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34872 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34773 != NULL)
        && (operand_34872 != NULL)) {
      macroValidPointer (operand_34773) ;
      macroValidPointer (operand_34872) ;
      if (((operand_34773->mFormalArgumentPassingMode) != (operand_34872->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34872->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34773->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34773->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34773->mGalgasTypeName.reader_value ()) != (operand_34872->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34872->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34773->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34872->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34773 = operand_34773->nextObject () ;
      operand_34872 = operand_34872->nextObject () ;
    }
  }
}
...
void GGS_M_nonterminalSymbolAltsForGrammar::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_L_signature_ForGrammarComponent   & outParameter0) {
  const char * kErrorMessage [] = {"the rule label '",
                                   "",
                                   "' is not declared",
                                   NULL} ;
  searchElement (inLexique,
...
//---------------------------------------------------------------------------*
//                                                                           *
//             Class element of list 'insertOrSearchMethodList'              *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_insertOrSearchMethodList::element_type::
element_type (const GGS_lstring & argument_0,
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_52130 = mNonExternAttributesList.firstObject () ;
  while ((operand_52130 != NULL)) {
    macroValidPointer (operand_52130) ;
    var_cas_outForeachList.addAssign_operation (operand_52130->mAttributType, operand_52130->aNomAttribut) ;
    operand_52130 = operand_52130->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_58684 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_58703 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_stringset * operand_58684 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_58684) ;
    cPtr_typeGalgas_stringset * operand_58703 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_58703) ;
    if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_58684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_58684) ;
      cPtr_typeGalgas_uint * operand_58703 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_58703) ;
      if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_58684 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_58684) ;
        cPtr_typeGalgas_sint * operand_58703 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_58703) ;
        if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_58684 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_58684) ;
          cPtr_typeGalgas_char * operand_58703 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_58703) ;
          if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_58684 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_58684) ;
            cPtr_typeGalgas_string * operand_58703 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_58703) ;
            if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_58684 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_58684) ;
              cPtr_typeGalgas_bool * operand_58703 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_58703) ;
              if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_58684 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_58684) ;
                cPtr_typeGalgas_double * operand_58703 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_58703) ;
                if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_58684 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_58684) ;
                  cPtr_typeGalgas_lbool * operand_58703 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_58703) ;
                  if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_58684 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_58684) ;
                    cPtr_typeGalgas_lchar * operand_58703 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_58703) ;
                    if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_58684 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_58684) ;
                      cPtr_typeGalgas_luint * operand_58703 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_58703) ;
                      if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_58684 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_58684) ;
                        cPtr_typeGalgas_lsint * operand_58703 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_58703) ;
                        if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_58684 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_58684) ;
                          cPtr_typeGalgas_ldouble * operand_58703 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_58703) ;
                          if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_58684 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_58684) ;
                            cPtr_typeGalgas_lstring * operand_58703 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_58703) ;
                            if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_58684 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_58684) ;
                              cPtr_typeGalgas_location * operand_58703 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_58703) ;
                              if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_58684 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_58684) ;
                                cPtr_typeGalgasUndefinedListType * operand_58703 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_58703) ;
                                if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                                  if (((operand_58684->mListTypeName.reader_value ()) != (operand_58703->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_58684->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_58703->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_58684 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_58684) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_58703 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_58703) ;
                                  if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                                    if (((operand_58684->mMapTypeName.reader_value ()) != (operand_58703->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_58684->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_58703->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_58684 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_58684) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_58703 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_58703) ;
                                    if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                                      if (((operand_58684->mClassTypeName.reader_value ()) != (operand_58703->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_58684->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_58703->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_58684 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_58684) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_58703 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_58703) ;
                                      if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                                        if (((operand_58684->mGalgasClassName.reader_value ()) != (operand_58703->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_58684->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_58703->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_58684 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_58684) ;
                                        cPtr_typeGalgas_enum * operand_58703 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_58703) ;
                                        if ((operand_58684 != NULL) && (operand_58703 != NULL)) {
                                          if (((operand_58684->mEnumTypeName.reader_value ()) != (operand_58703->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_58684->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_58703->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_62485 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_62584 = var_cas_signatureTestee.firstObject () ;
    while ((operand_62485 != NULL)
        && (operand_62584 != NULL)) {
      macroValidPointer (operand_62485) ;
      macroValidPointer (operand_62584) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62485->mType,  operand_62584->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_62485->mFormalArgumentPassingMode) != (operand_62584->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_62584->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_62584->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_62485 = operand_62485->nextObject () ;
      operand_62584 = operand_62584->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_73300 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73300) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73300->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73633 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73633) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73633->mMessagesMap ;
      GGS_L_lstringList  var_cas_73798 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_73798) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
