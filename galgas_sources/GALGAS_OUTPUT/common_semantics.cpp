...
/* GGG_bool GGG_metamodelPropertyKind::
operator == (const GGG_metamodelPropertyKind inOperand) const {
  return GGG_bool (isBuilt () && inOperand.isBuilt (),
                   mValue == inOperand.mValue) ;
} */
...
AC_galgas_map_elementEx * GGS_entityPropertyMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_entityPropertyMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_entityToImplementMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_entityToImplementMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
cPtr_typeGalgas_entity::cPtr_typeGalgas_entity (const GGS_lstring & argument_0,
...
const char * cPtr_typeGalgas_entity::message_messageGalgasType (void) const {
  return "an entity" ;
}

const char * cPtr_typeGalgas_entity::static_string_message_messageGalgasType (void) {
  return "an entity" ;
}
...
#ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
  cPtr_typeGalgas_entity * GGS_typeGalgas_entity::
    constructor_new (const GGS_lstring & argument_0,
                                const GGS_entityPropertyMap & argument_1,
                                const GGS_bool& argument_2,
                                const GGS_entityPropertyMap & argument_3,
                                const GGS_lstring & argument_4 COMMA_LOCATION_ARGS) {
    cPtr_typeGalgas_entity * ptr_ = (cPtr_typeGalgas_entity *) NULL ;
    macroMyNew (ptr_, cPtr_typeGalgas_entity (argument_0,
                                argument_1,
                                argument_2,
                                argument_3,
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_48797 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_48896 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_48797 != NULL)
        && (operand_48896 != NULL)) {
      macroValidPointer (operand_48797) ;
      macroValidPointer (operand_48896) ;
      if (((operand_48797->mFormalArgumentPassingMode) != (operand_48896->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_48896->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_48797->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_48797->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_48797->mGalgasTypeName.reader_value ()) != (operand_48896->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_48896->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_48797->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_48896->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_48797 = operand_48797->nextObject () ;
      operand_48896 = operand_48896->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66004 = mNonExternAttributesList.firstObject () ;
  while ((operand_66004 != NULL)) {
    macroValidPointer (operand_66004) ;
    var_cas_outForeachList.addAssign_operation (operand_66004->mAttributType, operand_66004->aNomAttribut) ;
    operand_66004 = operand_66004->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_71777 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_71796 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_71777 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_71777) ;
    cPtr_typeGalgas_stringset * operand_71796 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_71796) ;
    if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_71777 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_71777) ;
      cPtr_typeGalgas_uint * operand_71796 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_71796) ;
      if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_71777 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_71777) ;
        cPtr_typeGalgas_sint * operand_71796 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_71796) ;
        if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_71777 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_71777) ;
          cPtr_typeGalgas_char * operand_71796 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_71796) ;
          if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_71777 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_71777) ;
            cPtr_typeGalgas_string * operand_71796 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_71796) ;
            if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_71777 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_71777) ;
              cPtr_typeGalgas_bool * operand_71796 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_71796) ;
              if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_71777 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_71777) ;
                cPtr_typeGalgas_double * operand_71796 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_71796) ;
                if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_71777 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_71777) ;
                  cPtr_typeGalgas_lbool * operand_71796 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_71796) ;
                  if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_71777 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_71777) ;
                    cPtr_typeGalgas_lchar * operand_71796 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_71796) ;
                    if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_71777 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_71777) ;
                      cPtr_typeGalgas_luint * operand_71796 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_71796) ;
                      if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_71777 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_71777) ;
                        cPtr_typeGalgas_lsint * operand_71796 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_71796) ;
                        if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_71777 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_71777) ;
                          cPtr_typeGalgas_ldouble * operand_71796 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_71796) ;
                          if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_71777 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_71777) ;
                            cPtr_typeGalgas_lstring * operand_71796 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_71796) ;
                            if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_71777 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_71777) ;
                              cPtr_typeGalgas_location * operand_71796 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_71796) ;
                              if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_71777 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_71777) ;
                                cPtr_typeGalgasUndefinedListType * operand_71796 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_71796) ;
                                if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                                  if (((operand_71777->mListTypeName.reader_value ()) != (operand_71796->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_71777->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_71796->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_71777 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_71777) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_71796 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_71796) ;
                                  if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                                    if (((operand_71777->mMapTypeName.reader_value ()) != (operand_71796->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_71777->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_71796->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_71777 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_71777) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_71796 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_71796) ;
                                    if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                                      if (((operand_71777->mClassTypeName.reader_value ()) != (operand_71796->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_71777->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_71796->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_71777 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_71777) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_71796 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_71796) ;
                                      if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                                        if (((operand_71777->mGalgasClassName.reader_value ()) != (operand_71796->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_71777->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_71796->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_71777 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_71777) ;
                                        cPtr_typeGalgas_enum * operand_71796 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_71796) ;
                                        if ((operand_71777 != NULL) && (operand_71796 != NULL)) {
                                          if (((operand_71777->mEnumTypeName.reader_value ()) != (operand_71796->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_71777->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_71796->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_75582 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_75681 = var_cas_signatureTestee.firstObject () ;
    while ((operand_75582 != NULL)
        && (operand_75681 != NULL)) {
      macroValidPointer (operand_75582) ;
      macroValidPointer (operand_75681) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_75582->mType,  operand_75681->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_75582->mFormalArgumentPassingMode) != (operand_75681->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_75681->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_75681->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_75582 = operand_75582->nextObject () ;
      operand_75681 = operand_75681->nextObject () ;
    }
  }
}
...
AC_galgas_map_elementEx * GGS_M_metamodelsComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_metamodelsComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_88384 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_88384) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_88384->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_88717 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_88717) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_88717->mMessagesMap ;
      GGS_L_lstringList  var_cas_88882 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_88882) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_stringset  var_cas_90382 ;
    GGS_M_optionComponents  var_cas_90424 ;
    GGS_M_semanticsEntitiesForUse  var_cas_90433 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_90382, var_cas_importedOptionsComponents, var_cas_90424, var_cas_90433) ;
    GGS_stringset::element_type * operand_90534 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_90534 != NULL)) {
      macroValidPointer (operand_90534) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_90534->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_90534 = operand_90534->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_90818 = var_cas_modelMap.firstObject () ;
    while ((operand_90818 != NULL)) {
      macroValidPointer (operand_90818) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_90818->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_90818->mKey, operand_90818->mInfo.mType) ;
      }
      operand_90818 = operand_90818->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_91031 = var_cas_actionMap.firstObject () ;
    while ((operand_91031 != NULL)) {
      macroValidPointer (operand_91031) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_91031->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_91031->mKey, operand_91031->mInfo.mSignature, operand_91031->mInfo.mIsExtern) ;
      }
      operand_91031 = operand_91031->nextObject () ;
    }
