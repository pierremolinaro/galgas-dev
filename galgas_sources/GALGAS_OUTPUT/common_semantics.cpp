...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_49977 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_50076 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_49977 != NULL)
        && (operand_50076 != NULL)) {
      macroValidPointer (operand_49977) ;
      macroValidPointer (operand_50076) ;
      if (((operand_49977->mFormalArgumentPassingMode) != (operand_50076->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_50076->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_49977->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_49977->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_49977->mGalgasTypeName.reader_value ()) != (operand_50076->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_50076->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_49977->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_50076->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_49977 = operand_49977->nextObject () ;
      operand_50076 = operand_50076->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_67875 = mNonExternAttributesList.firstObject () ;
  while ((operand_67875 != NULL)) {
    macroValidPointer (operand_67875) ;
    var_cas_outForeachList.addAssign_operation (operand_67875->mAttributType, operand_67875->aNomAttribut) ;
    operand_67875 = operand_67875->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_73648 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_73667 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_73648 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_73648) ;
    cPtr_typeGalgas_stringset * operand_73667 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_73667) ;
    if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_73648 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_73648) ;
      cPtr_typeGalgas_uint * operand_73667 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_73667) ;
      if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_73648 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_73648) ;
        cPtr_typeGalgas_sint * operand_73667 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_73667) ;
        if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_73648 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_73648) ;
          cPtr_typeGalgas_char * operand_73667 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_73667) ;
          if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_73648 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_73648) ;
            cPtr_typeGalgas_string * operand_73667 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_73667) ;
            if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_73648 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_73648) ;
              cPtr_typeGalgas_bool * operand_73667 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_73667) ;
              if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_73648 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_73648) ;
                cPtr_typeGalgas_double * operand_73667 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_73667) ;
                if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_73648 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_73648) ;
                  cPtr_typeGalgas_lbool * operand_73667 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_73667) ;
                  if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_73648 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_73648) ;
                    cPtr_typeGalgas_lchar * operand_73667 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_73667) ;
                    if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_73648 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_73648) ;
                      cPtr_typeGalgas_luint * operand_73667 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_73667) ;
                      if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_73648 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_73648) ;
                        cPtr_typeGalgas_lsint * operand_73667 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_73667) ;
                        if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_73648 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_73648) ;
                          cPtr_typeGalgas_ldouble * operand_73667 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_73667) ;
                          if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_73648 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_73648) ;
                            cPtr_typeGalgas_lstring * operand_73667 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_73667) ;
                            if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_73648 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_73648) ;
                              cPtr_typeGalgas_location * operand_73667 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_73667) ;
                              if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_73648 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_73648) ;
                                cPtr_typeGalgasUndefinedListType * operand_73667 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_73667) ;
                                if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                                  if (((operand_73648->mListTypeName.reader_value ()) != (operand_73667->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_73648->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_73667->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_73648 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_73648) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_73667 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_73667) ;
                                  if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                                    if (((operand_73648->mMapTypeName.reader_value ()) != (operand_73667->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_73648->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_73667->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_73648 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_73648) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_73667 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_73667) ;
                                    if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                                      if (((operand_73648->mClassTypeName.reader_value ()) != (operand_73667->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_73648->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_73667->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_73648 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_73648) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_73667 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_73667) ;
                                      if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                                        if (((operand_73648->mGalgasClassName.reader_value ()) != (operand_73667->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_73648->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_73667->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_73648 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_73648) ;
                                        cPtr_typeGalgas_enum * operand_73667 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_73667) ;
                                        if ((operand_73648 != NULL) && (operand_73667 != NULL)) {
                                          if (((operand_73648->mEnumTypeName.reader_value ()) != (operand_73667->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_73648->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_73667->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_77453 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_77552 = var_cas_signatureTestee.firstObject () ;
    while ((operand_77453 != NULL)
        && (operand_77552 != NULL)) {
      macroValidPointer (operand_77453) ;
      macroValidPointer (operand_77552) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_77453->mType,  operand_77552->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_77453->mFormalArgumentPassingMode) != (operand_77552->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_77552->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_77552->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_77453 = operand_77453->nextObject () ;
      operand_77552 = operand_77552->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_91883 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_91883) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_91883->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_92226 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_92226) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_92226->mMessagesMap ;
        GGS_L_lstringList  var_cas_92395 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_92395) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_94191 ;
    GGS_M_semanticsEntitiesForUse  var_cas_94200 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_94191, var_cas_94200) ;
    ...
    GGS_stringset::element_type * operand_94445 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_94445 != NULL)) {
      macroValidPointer (operand_94445) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_94445->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_94445 = operand_94445->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_94810 = var_cas_modelMap.firstObject () ;
    while ((operand_94810 != NULL)) {
      macroValidPointer (operand_94810) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_94810->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_94810->mKey, operand_94810->mInfo.mType) ;
      }
      operand_94810 = operand_94810->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_95023 = var_cas_actionMap.firstObject () ;
    while ((operand_95023 != NULL)) {
      macroValidPointer (operand_95023) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_95023->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_95023->mKey, operand_95023->mInfo.mSignature, operand_95023->mInfo.mIsExtern) ;
      }
      operand_95023 = operand_95023->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_95765 ;
    GGS_bool var_cas_95768 ;
    GGS_entityPropertyMap  var_cas_95771 ;
    GGS_mapPropertyMap  var_cas_95791 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_95765, var_cas_95768, var_cas_95771, var_cas_superEntityName, var_cas_95791) ;
