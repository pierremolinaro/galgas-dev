...
void GGS_relationVarMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_L_propertyPath & inParameter0) {
  insertElement (lexique_var_,
...
void GGS_relationMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_relationVarMap & inParameter0,
                                const GGS_metamodelRelationExpression & inParameter1) {
  insertElement (lexique_var_,
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_52963 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_53062 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_52963 != NULL)
        && (operand_53062 != NULL)) {
      macroValidPointer (operand_52963) ;
      macroValidPointer (operand_53062) ;
      if (((operand_52963->mFormalArgumentPassingMode) != (operand_53062->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_53062->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_52963->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_52963->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_52963->mGalgasTypeName.reader_value ()) != (operand_53062->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_53062->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_52963->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_53062->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_52963 = operand_52963->nextObject () ;
      operand_53062 = operand_53062->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_70861 = mNonExternAttributesList.firstObject () ;
  while ((operand_70861 != NULL)) {
    macroValidPointer (operand_70861) ;
    var_cas_outForeachList.addAssign_operation (operand_70861->mAttributType, operand_70861->aNomAttribut) ;
    operand_70861 = operand_70861->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_76634 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_76653 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_76634 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_76634) ;
    cPtr_typeGalgas_stringset * operand_76653 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_76653) ;
    if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_76634 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_76634) ;
      cPtr_typeGalgas_uint * operand_76653 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_76653) ;
      if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_76634 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_76634) ;
        cPtr_typeGalgas_sint * operand_76653 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_76653) ;
        if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_76634 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_76634) ;
          cPtr_typeGalgas_char * operand_76653 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_76653) ;
          if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_76634 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_76634) ;
            cPtr_typeGalgas_string * operand_76653 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_76653) ;
            if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_76634 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_76634) ;
              cPtr_typeGalgas_bool * operand_76653 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_76653) ;
              if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_76634 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_76634) ;
                cPtr_typeGalgas_double * operand_76653 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_76653) ;
                if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_76634 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_76634) ;
                  cPtr_typeGalgas_lbool * operand_76653 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_76653) ;
                  if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_76634 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_76634) ;
                    cPtr_typeGalgas_lchar * operand_76653 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_76653) ;
                    if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_76634 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_76634) ;
                      cPtr_typeGalgas_luint * operand_76653 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_76653) ;
                      if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_76634 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_76634) ;
                        cPtr_typeGalgas_lsint * operand_76653 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_76653) ;
                        if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_76634 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_76634) ;
                          cPtr_typeGalgas_ldouble * operand_76653 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_76653) ;
                          if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_76634 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_76634) ;
                            cPtr_typeGalgas_lstring * operand_76653 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_76653) ;
                            if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_76634 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_76634) ;
                              cPtr_typeGalgas_location * operand_76653 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_76653) ;
                              if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_76634 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_76634) ;
                                cPtr_typeGalgasUndefinedListType * operand_76653 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_76653) ;
                                if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                                  if (((operand_76634->mListTypeName.reader_value ()) != (operand_76653->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_76634->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_76653->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_76634 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_76634) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_76653 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_76653) ;
                                  if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                                    if (((operand_76634->mMapTypeName.reader_value ()) != (operand_76653->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_76634->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_76653->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_76634 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_76634) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_76653 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_76653) ;
                                    if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                                      if (((operand_76634->mClassTypeName.reader_value ()) != (operand_76653->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_76634->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_76653->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_76634 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_76634) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_76653 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_76653) ;
                                      if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                                        if (((operand_76634->mGalgasClassName.reader_value ()) != (operand_76653->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_76634->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_76653->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_76634 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_76634) ;
                                        cPtr_typeGalgas_enum * operand_76653 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_76653) ;
                                        if ((operand_76634 != NULL) && (operand_76653 != NULL)) {
                                          if (((operand_76634->mEnumTypeName.reader_value ()) != (operand_76653->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_76634->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_76653->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_80439 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_80538 = var_cas_signatureTestee.firstObject () ;
    while ((operand_80439 != NULL)
        && (operand_80538 != NULL)) {
      macroValidPointer (operand_80439) ;
      macroValidPointer (operand_80538) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_80439->mType,  operand_80538->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_80439->mFormalArgumentPassingMode) != (operand_80538->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_80538->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_80538->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_80439 = operand_80439->nextObject () ;
      operand_80538 = operand_80538->nextObject () ;
    }
  }
}
  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_95057 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95057) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95057->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_95400 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_95400) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_95400->mMessagesMap ;
        GGS_L_lstringList  var_cas_95569 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_95569) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_97365 ;
    GGS_M_semanticsEntitiesForUse  var_cas_97374 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_97365, var_cas_97374) ;
    ...
    GGS_stringset::element_type * operand_97619 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_97619 != NULL)) {
      macroValidPointer (operand_97619) ;
      ...
      operand_97619 = operand_97619->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_97984 = var_cas_modelMap.firstObject () ;
    while ((operand_97984 != NULL)) {
      macroValidPointer (operand_97984) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_97984->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_97984->mKey, operand_97984->mInfo.mType) ;
      }
      operand_97984 = operand_97984->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_98197 = var_cas_actionMap.firstObject () ;
    while ((operand_98197 != NULL)) {
      macroValidPointer (operand_98197) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_98197->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_98197->mKey, operand_98197->mInfo.mSignature, operand_98197->mInfo.mIsExtern) ;
      }
      operand_98197 = operand_98197->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ()))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_99000 ;
    GGS_bool var_cas_99003 ;
    GGS_entityPropertyMap  var_cas_99006 ;
    GGS_mapPropertyMap  var_cas_99026 ;
    GGS_contextPropertyMap  var_cas_99029 ;
    GGS_fetchedPropertyMap  var_cas_99032 ;
    GGS_fetchedPropertyMap  var_cas_99035 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_99000, var_cas_99003, var_cas_99006, var_cas_superEntityName, var_cas_99026, var_cas_99029, var_cas_99032, var_cas_99035) ;
...
void routine_checkPath (C_Lexique & lexique_var_,
                                ...
                                GGS_lstring  & var_cas_outLastEntityTypeName) {
  ...
  GGS_L_propertyPath::element_type * operand_99723 = var_cas_inPath.firstObject () ;
  while ((operand_99723 != NULL)) {
    macroValidPointer (operand_99723) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_99723->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_99723->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet) ;
      if (((! var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ()))).isBuiltAndTrue ()) {
          operand_99723->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity")))) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_100513 ;
      GGS_entityPropertyMap  var_cas_100516 ;
      GGS_lstring  var_cas_100519 ;
      GGS_mapPropertyMap  var_cas_100522 ;
      GGS_contextPropertyMap  var_cas_100525 ;
      GGS_fetchedPropertyMap  var_cas_100528 ;
      GGS_fetchedPropertyMap  var_cas_100531 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_100513, var_cas_100516, var_cas_100519, var_cas_100522, var_cas_100525, var_cas_100528, var_cas_100531) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_100660 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_99723->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_100660) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        GGS_bool var_cas_100794 ;
        GGS_entityPropertyMap  var_cas_100797 ;
        GGS_lstring  var_cas_100800 ;
        GGS_mapPropertyMap  var_cas_100803 ;
        GGS_contextPropertyMap  var_cas_100806 ;
        GGS_fetchedPropertyMap  var_cas_100809 ;
        GGS_fetchedPropertyMap  var_cas_100812 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_100794, var_cas_100797, var_cas_100800, var_cas_100803, var_cas_100806, var_cas_100809, var_cas_100812) ;
      }
    }
    operand_99723 = operand_99723->nextObject () ;
  }
}
