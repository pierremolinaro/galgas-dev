...
//                    november 16th, 2005, at 15h15'57"                      *
//                                                                           *
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_34783 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_34882 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_34783 != NULL)
        && (operand_34882 != NULL)) {
      macroValidPointer (operand_34783) ;
      macroValidPointer (operand_34882) ;
      if (((operand_34783->mFormalArgumentPassingMode) != (operand_34882->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_34882->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_34783->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_34783->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_34783->mGalgasTypeName.reader_value ()) != (operand_34882->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_34882->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_34783->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_34882->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_34783 = operand_34783->nextObject () ;
      operand_34882 = operand_34882->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_52140 = mNonExternAttributesList.firstObject () ;
  while ((operand_52140 != NULL)) {
    macroValidPointer (operand_52140) ;
    var_cas_outForeachList.addAssign_operation (operand_52140->mAttributType, operand_52140->aNomAttribut) ;
    operand_52140 = operand_52140->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_58694 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_58713 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_58694 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_58694) ;
    cPtr_typeGalgas_stringset * operand_58713 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_58713) ;
    if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_58694 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_58694) ;
      cPtr_typeGalgas_uint * operand_58713 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_58713) ;
      if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_58694 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_58694) ;
        cPtr_typeGalgas_sint * operand_58713 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_58713) ;
        if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_58694 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_58694) ;
          cPtr_typeGalgas_char * operand_58713 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_58713) ;
          if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_58694 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_58694) ;
            cPtr_typeGalgas_string * operand_58713 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_58713) ;
            if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_58694 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_58694) ;
              cPtr_typeGalgas_bool * operand_58713 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_58713) ;
              if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_58694 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_58694) ;
                cPtr_typeGalgas_double * operand_58713 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_58713) ;
                if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_58694 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_58694) ;
                  cPtr_typeGalgas_lbool * operand_58713 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_58713) ;
                  if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_58694 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_58694) ;
                    cPtr_typeGalgas_lchar * operand_58713 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_58713) ;
                    if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_58694 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_58694) ;
                      cPtr_typeGalgas_luint * operand_58713 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_58713) ;
                      if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_58694 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_58694) ;
                        cPtr_typeGalgas_lsint * operand_58713 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_58713) ;
                        if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_58694 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_58694) ;
                          cPtr_typeGalgas_ldouble * operand_58713 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_58713) ;
                          if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_58694 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_58694) ;
                            cPtr_typeGalgas_lstring * operand_58713 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_58713) ;
                            if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_58694 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_58694) ;
                              cPtr_typeGalgas_location * operand_58713 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_58713) ;
                              if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_58694 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_58694) ;
                                cPtr_typeGalgasUndefinedListType * operand_58713 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_58713) ;
                                if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                                  if (((operand_58694->mListTypeName.reader_value ()) != (operand_58713->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_58694->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_58713->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_58694 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_58694) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_58713 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_58713) ;
                                  if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                                    if (((operand_58694->mMapTypeName.reader_value ()) != (operand_58713->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_58694->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_58713->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_58694 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_58694) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_58713 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_58713) ;
                                    if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                                      if (((operand_58694->mClassTypeName.reader_value ()) != (operand_58713->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_58694->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_58713->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_58694 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_58694) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_58713 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_58713) ;
                                      if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                                        if (((operand_58694->mGalgasClassName.reader_value ()) != (operand_58713->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_58694->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_58713->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_58694 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_58694) ;
                                        cPtr_typeGalgas_enum * operand_58713 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_58713) ;
                                        if ((operand_58694 != NULL) && (operand_58713 != NULL)) {
                                          if (((operand_58694->mEnumTypeName.reader_value ()) != (operand_58713->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_58694->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_58713->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_62495 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_62594 = var_cas_signatureTestee.firstObject () ;
    while ((operand_62495 != NULL)
        && (operand_62594 != NULL)) {
      macroValidPointer (operand_62495) ;
      macroValidPointer (operand_62594) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_62495->mType,  operand_62594->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_62495->mFormalArgumentPassingMode) != (operand_62594->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_62594->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_62594->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_62495 = operand_62495->nextObject () ;
      operand_62594 = operand_62594->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_73310 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73310) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73310->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_73643 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_73643) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_73643->mMessagesMap ;
      GGS_L_lstringList  var_cas_73808 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_73808) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
