  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_93022 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_93022) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_93022->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_93365 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_93365) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_93365->mMessagesMap ;
        GGS_L_lstringList  var_cas_93534 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_93534) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_95330 ;
    GGS_M_semanticsEntitiesForUse  var_cas_95339 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_95330, var_cas_95339) ;
    ...
    GGS_stringset::element_type * operand_95584 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_95584 != NULL)) {
      macroValidPointer (operand_95584) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_95584->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_95584 = operand_95584->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_95949 = var_cas_modelMap.firstObject () ;
    while ((operand_95949 != NULL)) {
      macroValidPointer (operand_95949) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_95949->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_95949->mKey, operand_95949->mInfo.mType) ;
      }
      operand_95949 = operand_95949->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_96162 = var_cas_actionMap.firstObject () ;
    while ((operand_96162 != NULL)) {
      macroValidPointer (operand_96162) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_96162->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_96162->mKey, operand_96162->mInfo.mSignature, operand_96162->mInfo.mIsExtern) ;
      }
      operand_96162 = operand_96162->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ()))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_96965 ;
    GGS_bool var_cas_96968 ;
    GGS_entityPropertyMap  var_cas_96971 ;
    GGS_mapPropertyMap  var_cas_96991 ;
    GGS_contextPropertyMap  var_cas_96994 ;
    GGS_fetchedPropertyMap  var_cas_96997 ;
    GGS_fetchedPropertyMap  var_cas_97000 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_96965, var_cas_96968, var_cas_96971, var_cas_superEntityName, var_cas_96991, var_cas_96994, var_cas_96997, var_cas_97000) ;
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_97688 = var_cas_inPath.firstObject () ;
  while ((operand_97688 != NULL)) {
    macroValidPointer (operand_97688) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_97688->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_97688->mPathElement.reader_location () COMMA_HERE) ;
      ...
      if (((! var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ()))).isBuiltAndTrue ()) {
          operand_97688->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity")))) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_98478 ;
      GGS_entityPropertyMap  var_cas_98481 ;
      GGS_lstring  var_cas_98484 ;
      GGS_mapPropertyMap  var_cas_98487 ;
      GGS_contextPropertyMap  var_cas_98490 ;
      GGS_fetchedPropertyMap  var_cas_98493 ;
      GGS_fetchedPropertyMap  var_cas_98496 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_98478, var_cas_98481, var_cas_98484, var_cas_98487, var_cas_98490, var_cas_98493, var_cas_98496) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_98625 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_97688->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_98625) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        GGS_bool var_cas_98759 ;
        GGS_entityPropertyMap  var_cas_98762 ;
        GGS_lstring  var_cas_98765 ;
        GGS_mapPropertyMap  var_cas_98768 ;
        GGS_contextPropertyMap  var_cas_98771 ;
        GGS_fetchedPropertyMap  var_cas_98774 ;
        GGS_fetchedPropertyMap  var_cas_98777 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_98759, var_cas_98762, var_cas_98765, var_cas_98768, var_cas_98771, var_cas_98774, var_cas_98777) ;
      }
    }
    operand_97688 = operand_97688->nextObject () ;
  }
}
