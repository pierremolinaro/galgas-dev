...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mFormalInputArgumentList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mReaderFormalArgumentList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mModifierFormalArgumentList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mType.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mIsExtern.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mKind.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "->" ;
  ioString << mInfo.mTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mIsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mContextParameterList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mIndexName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mDomainVariableName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mRelationVarMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mExpression.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mElementEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mInsertErrorMessage.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSearchErrorMessage.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << mInfo.mIsAbstract.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mEntityPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSuperEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSuperClassSet.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mIsImplicitlyDefined.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mConstrainedAttributePropertyToImplementList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mConstrainedParameterPropertyToImplementList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForDescription (C_Lexique & _inLexique,
  ...
  ioString << "->@typeGalgas_singleEntity:"
           ...
           << mAllPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mIsAbstract.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mEntityPropertiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mSuperEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << mSuperEntitiesSet.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mAccessorSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mReturnedType.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.aListeTypesParametres.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.aListeDesAttributs.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mTerminalSymbolMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mFormalParametersList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mReturnedEntity.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.aDefEntite.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mStartSymbolParametersMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mNonterminalSymbolParametersMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mNonterminalSymbolsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mProductionRulesList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mLexiqueComponentName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mReturnedEntityName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mReturnedMetamodelName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2024))) == (GGS_string (true, "emptyList"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2026))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyList' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2028)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2030)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.aSignatureDebut.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.aSignatureFin.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2060)) ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mMethodSignature.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifierMethodMap._isBuilt ()) {
    mModifierMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (2096)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMethodMap._isBuilt ()) {
    mReaderMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (2106)) ;
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_86227 = mNonExternAttributesList.firstObject () ;
  while ((operand_86227 != NULL)) {
    macroValidPointer (operand_86227) ;
    var_cas_outForeachList._addAssign_operation (operand_86227->mAttributType, operand_86227->aNomAttribut) ;
    operand_86227 = operand_86227->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2131))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2133))) == (GGS_string (true, "mapWithMapToOverride"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2136))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2138)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2140)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2157)) ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2198)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2208)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2208))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2212)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2291))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2297))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2303)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2308)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2318))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2324))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2330)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2336)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mMessageStringList.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2369)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2377)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_97056 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_97075 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_97056 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_97056) ;
    cPtr_typeGalgas_stringset * operand_97075 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_97075) ;
    if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_97056 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_97056) ;
      cPtr_typeGalgas_uint * operand_97075 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_97075) ;
      if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_97056 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_97056) ;
        cPtr_typeGalgas_sint * operand_97075 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_97075) ;
        if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_97056 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_97056) ;
          cPtr_typeGalgas_uint64 * operand_97075 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_97075) ;
          if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_97056 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_97056) ;
            cPtr_typeGalgas_sint64 * operand_97075 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_97075) ;
            if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_97056 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_97056) ;
              cPtr_typeGalgas_char * operand_97075 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_97075) ;
              if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_97056 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_97056) ;
                cPtr_typeGalgas_string * operand_97075 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_97075) ;
                if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_97056 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_97056) ;
                  cPtr_typeGalgas_bool * operand_97075 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_97075) ;
                  if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_97056 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_97056) ;
                    cPtr_typeGalgas_double * operand_97075 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_97075) ;
                    if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_97056 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_97056) ;
                      cPtr_typeGalgas_lbool * operand_97075 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_97075) ;
                      if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_97056 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_97056) ;
                        cPtr_typeGalgas_lchar * operand_97075 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_97075) ;
                        if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_97056 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_97056) ;
                          cPtr_typeGalgas_luint * operand_97075 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_97075) ;
                          if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_97056 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_97056) ;
                            cPtr_typeGalgas_lsint * operand_97075 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_97075) ;
                            if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_97056 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_97056) ;
                              cPtr_typeGalgas_luint64 * operand_97075 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_97075) ;
                              if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_97056 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_97056) ;
                                cPtr_typeGalgas_lsint64 * operand_97075 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_97075) ;
                                if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_97056 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_97056) ;
                                  cPtr_typeGalgas_ldouble * operand_97075 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_97075) ;
                                  if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_97056 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_97056) ;
                                    cPtr_typeGalgas_lstring * operand_97075 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_97075) ;
                                    if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_97056 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_97056) ;
                                      cPtr_typeGalgas_location * operand_97075 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_97075) ;
                                      if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_97056 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_97056) ;
                                        cPtr_typeGalgasUndefinedListType * operand_97075 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_97075) ;
                                        if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                          if (((operand_97056->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2417))) != (operand_97075->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2417)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_97056->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2418))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_97075->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2419))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2420)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_97056 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_97056) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_97075 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_97075) ;
                                          if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                            if (((operand_97056->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2423))) != (operand_97075->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2423)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_97056->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2424))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_97075->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2425))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2426)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_97056 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97056) ;
                                            cPtr_typeGalgasClassType * operand_97075 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_97075) ;
                                            if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_97056->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2430))) == (operand_97075->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2430))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_97075->mAncestorClassesMap.reader_hasKey (_inLexique, operand_97056->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2432)) SOURCE_FILE_AT_LINE (2432)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_97056->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2435))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_97075->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2436))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2437)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_97056 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97056) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_97075 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_97075) ;
                                              if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                                if (((operand_97056->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2440))) != (operand_97075->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2440)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_97056->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2441))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_97075->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2442))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2443)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_97056 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_97056) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_97075 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_97075) ;
                                                if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                                  if (((operand_97056->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2447))) != (operand_97075->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2447)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_97056->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2448))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_97075->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2449))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2450)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_97056 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_97056) ;
                                                  cPtr_typeGalgas_enum * operand_97075 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_97075) ;
                                                  if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                                    if (((operand_97056->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2454))) != (operand_97075->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2454)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_97056->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2455))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_97075->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2456))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2457)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_97056 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_97056) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_97075 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_97075) ;
                                                    if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                                      if (((operand_97056->mEntityName) != (operand_97075->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_97056->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_97075->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2464)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_97056 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_97056) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_97075 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_97075) ;
                                                      if ((operand_97056 != NULL) && (operand_97075 != NULL)) {
                                                        if (((operand_97056->mMapTypeName) != (operand_97075->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_97056->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_97075->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2471)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2474))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2474)))) SOURCE_FILE_AT_LINE (2475)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2489))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2489)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2491)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2491))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2491)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2493)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_102475 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_102574 = var_cas_signatureTestee.firstObject () ;
    while ((operand_102475 != NULL)
        && (operand_102574 != NULL)) {
      macroValidPointer (operand_102475) ;
      macroValidPointer (operand_102574) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_102475->mType,  operand_102574->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2497)) ;
      if (((operand_102475->mFormalArgumentPassingMode) != (operand_102574->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_102574->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2503))) + (GGS_string (true, " is not compatible with ")))) + (operand_102574->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2504)))) SOURCE_FILE_AT_LINE (2505)) ;
      }
      operand_102475 = operand_102475->nextObject () ;
      operand_102574 = operand_102574->nextObject () ;
    }
  }
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << mInfo.mDefaultValue.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mBoolOptionsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mUintOptionsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mStringOptionsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "->" ;
  ioString << mInfo.mNonterminalSymbolParametersMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mLexiqueName.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mOptionsMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mModelMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mActionMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mImportedSemanticsComponents.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mImportedMetamodelComponents.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mImportedOptionsComponents.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mOptionsComponents.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSemanticsEntitiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mRootEntity.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mSemanticsEntitiesMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mEntityMap.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << mInfo.mMultiReferencedEntities.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
appendForMapDescription (C_Lexique & _inLexique,
  ...
  ioString << "["
           << mKey.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "->" ;
  ioString << mInfo.mMetamodel.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "]" ;
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2647))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2653))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2656))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2659))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2662))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2665))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2668))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2671))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2674))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2682)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2684))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2690)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2692))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2695))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2698))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2701))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2707)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2709))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2712))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2715))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2718))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2724)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2726))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2729))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2732))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2735))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2741)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2743))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2746))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2749))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2752))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2758)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2760))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2763))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lstring type is deprecated; use 'string' instead") SOURCE_FILE_AT_LINE (2764)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2767))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2770))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2776)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2778))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2781))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lchar type  is deprecated; use 'char' instead") SOURCE_FILE_AT_LINE (2782)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2785))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2788))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2794)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2796))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2799))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lbool type  is deprecated; use 'bool' instead") SOURCE_FILE_AT_LINE (2800)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2803))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2811))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2814))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' of @luint type  reader is deprecated; use 'uint' instead") SOURCE_FILE_AT_LINE (2815)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2818))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2821))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2827)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2829))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2832))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2835))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2841)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2843))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2846))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lsint type  is deprecated; use 'sint' instead") SOURCE_FILE_AT_LINE (2847)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2850))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2853))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2856))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2862)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2864))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2867))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2870))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2873))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2879)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2881))) == (GGS_string (true, "double"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2884))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @ldouble type  is deprecated; use 'double' instead") SOURCE_FILE_AT_LINE (2885)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2888))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2891))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2894))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2900)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2902))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2908)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2910))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2915))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2918))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2924)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2926))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList._addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2931))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2937)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_125929 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125929) ; 
        if (operand_125929->mMessagesMap._isBuilt ()) {
          operand_125929->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2939)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_126208 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_126208) ; 
        GGS_L_lstringList  var_cas_126320 ;
        if (operand_126208->mMessagesMap._isBuilt ()) {
          operand_126208->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_126320 SOURCE_FILE_AT_LINE (2943)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2950)) ;
        var_cas_outAccessorTypesList._drop_operation () ;
        var_cas_outReturnedType._drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2977)) SOURCE_FILE_AT_LINE (2977))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_128119 ;
    GGS_M_semanticsEntitiesForUse  var_cas_128128 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_128119, var_cas_128128 SOURCE_FILE_AT_LINE (2984)) ;
    }
    ...
    GGS_stringset::element_type * operand_128373 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_128373 != NULL)) {
      macroValidPointer (operand_128373) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_128373->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2998)) ;
      operand_128373 = operand_128373->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_128738 = var_cas_modelMap.firstObject () ;
    while ((operand_128738 != NULL)) {
      macroValidPointer (operand_128738) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_128738->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3009)) SOURCE_FILE_AT_LINE (3009))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_128738->mKey, operand_128738->mInfo.mType SOURCE_FILE_AT_LINE (3010)) ;
      }
      operand_128738 = operand_128738->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_128952 = var_cas_actionMap.firstObject () ;
    while ((operand_128952 != NULL)) {
      macroValidPointer (operand_128952) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_128952->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3015)) SOURCE_FILE_AT_LINE (3015))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_128952->mKey, operand_128952->mInfo.mSignature, operand_128952->mInfo.mIsExtern SOURCE_FILE_AT_LINE (3016)) ;
      }
      operand_128952 = operand_128952->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents._addAssign_operation (var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3020))) ;
  }
}
...
void routine_computeRepresentativeEntityName (C_Lexique & _inLexique,
  ...
  GGS_uint _variant_130131 = var_cas_inMetamodelEntityMap.reader_count (_inLexique SOURCE_FILE_AT_LINE (3034))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (3034)) ;
  GGS_bool _condition_130131 (_variant_130131._isBuilt (), true) ;
  while (_condition_130131.isBuiltAndTrue ()) {
    if (_variant_130131.uintValue () == 0) {
      _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (3043)) ;
      _condition_130131 = GGS_bool (true, false) ;
    }else{
      _variant_130131._decrement_operation (_inLexique COMMA_HERE) ;
      _condition_130131 = (((var_cas_outRepresentativeEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3035))) == (GGS_string (true, ""))) & ((var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3035))) != (GGS_string (true, ""))))  ;
      if (_condition_130131.isBuiltAndTrue ()) {
        if ((var_cas_inConstrainedEntityMap.reader_hasKey (_inLexique, var_cas_searchedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (3036)) SOURCE_FILE_AT_LINE (3036))).isBuiltAndTrue ()) {
          var_cas_outRepresentativeEntityName = var_cas_searchedEntity ;
        }else{
          GGS_lstring  var_cas_superEntity ;
          GGS_entityPropertyMap  var_cas_130046 ;
          GGS_bool var_cas_130049 ;
          GGS_entityPropertyMap  var_cas_130052 ;
          GGS_stringset  var_cas_130068 ;
          GGS_bool var_cas_130071 ;
          GGS_constrainedPropertyList  var_cas_130074 ;
          GGS_constrainedPropertyList  var_cas_130077 ;
          if (var_cas_inMetamodelEntityMap._isBuilt ()) {
            var_cas_inMetamodelEntityMap (HERE)->method_searchKey (_inLexique, var_cas_searchedEntity, var_cas_130046, var_cas_130049, var_cas_130052, var_cas_superEntity, var_cas_130068, var_cas_130071, var_cas_130074, var_cas_130077 SOURCE_FILE_AT_LINE (3040)) ;
          }
