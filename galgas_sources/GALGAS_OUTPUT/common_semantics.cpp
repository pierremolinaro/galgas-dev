...
void routine_checkSignature_ForGrammarComponent (C_lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_33372 = var_cas_inFormalReferenceSignature.getFirstItem () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_33452 = var_cas_inFormalTestedSignature.getFirstItem () ;
    while ((operand_33372 != NULL) && (operand_33452 != NULL)) {
      macroValidPointer (operand_33372) ;
      macroValidPointer (operand_33452) ;
      if (((operand_33372->mFormalArgumentPassingMode) != (operand_33452->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_33452->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_33372->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_33372->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_33372->mGalgasTypeName.reader_value ()) != (operand_33452->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_33452->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_33372->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_33452->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_33372 = operand_33372->getNextItem () ;
      operand_33452 = operand_33452->getNextItem () ;
    }
  }
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_57567 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_57586 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_uint * operand_57567 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_57567) ;
    cPtr_typeGalgas_uint * operand_57586 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_57586) ;
    if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
    }else{
      cPtr_typeGalgas_sint * operand_57567 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_57567) ;
      cPtr_typeGalgas_sint * operand_57586 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_57586) ;
      if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_57567 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_57567) ;
        cPtr_typeGalgas_char * operand_57586 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_57586) ;
        if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
        }else{
          cPtr_typeGalgas_string * operand_57567 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_57567) ;
          cPtr_typeGalgas_string * operand_57586 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_57586) ;
          if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
          }else{
            cPtr_typeGalgas_bool * operand_57567 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_57567) ;
            cPtr_typeGalgas_bool * operand_57586 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_57586) ;
            if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
            }else{
              cPtr_typeGalgas_dfloat * operand_57567 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_57567) ;
              cPtr_typeGalgas_dfloat * operand_57586 = dynamic_cast <cPtr_typeGalgas_dfloat *> (ptr_57586) ;
              if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
              }else{
                cPtr_typeGalgas_lbool * operand_57567 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_57567) ;
                cPtr_typeGalgas_lbool * operand_57586 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_57586) ;
                if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                }else{
                  cPtr_typeGalgas_lchar * operand_57567 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_57567) ;
                  cPtr_typeGalgas_lchar * operand_57586 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_57586) ;
                  if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                  }else{
                    cPtr_typeGalgas_luint * operand_57567 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_57567) ;
                    cPtr_typeGalgas_luint * operand_57586 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_57586) ;
                    if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lsint * operand_57567 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_57567) ;
                      cPtr_typeGalgas_lsint * operand_57586 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_57586) ;
                      if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                      }else{
                        cPtr_typeGalgas_ldfloat * operand_57567 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_57567) ;
                        cPtr_typeGalgas_ldfloat * operand_57586 = dynamic_cast <cPtr_typeGalgas_ldfloat *> (ptr_57586) ;
                        if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lstring * operand_57567 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_57567) ;
                          cPtr_typeGalgas_lstring * operand_57586 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_57586) ;
                          if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                          }else{
                            cPtr_typeGalgas_location * operand_57567 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_57567) ;
                            cPtr_typeGalgas_location * operand_57586 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_57586) ;
                            if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                            }else{
                              cPtr_typeGalgasUndefinedListType * operand_57567 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_57567) ;
                              cPtr_typeGalgasUndefinedListType * operand_57586 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_57586) ;
                              if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                                if (((operand_57567->mListTypeName.reader_value ()) != (operand_57586->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                    var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_57567->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_57586->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                }
                              }else{
                                cPtr_typeGalgasUndefinedMapType * operand_57567 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_57567) ;
                                cPtr_typeGalgasUndefinedMapType * operand_57586 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_57586) ;
                                if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                                  if (((operand_57567->mMapTypeName.reader_value ()) != (operand_57586->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_57567->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_57586->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedClassType * operand_57567 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_57567) ;
                                  cPtr_typeGalgasUndefinedClassType * operand_57586 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_57586) ;
                                  if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                                    if (((operand_57567->mClassTypeName.reader_value ()) != (operand_57586->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_57567->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_57586->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedExternType * operand_57567 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_57567) ;
                                    cPtr_typeGalgasUndefinedExternType * operand_57586 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_57586) ;
                                    if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                                      if (((operand_57567->mGalgasClassName.reader_value ()) != (operand_57586->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_57567->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_57586->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgas_enum * operand_57567 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_57567) ;
                                      cPtr_typeGalgas_enum * operand_57586 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_57586) ;
                                      if ((operand_57567 != NULL) && (operand_57586 != NULL)) {
                                        if (((operand_57567->mEnumTypeName.reader_value ()) != (operand_57586->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_57567->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_57586->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
...
void routine_verifierCompatibiliteSignatures (C_lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_61334 = var_cas_signatureReference.getFirstItem () ;
    GGS_L_signature::element_type * operand_61422 = var_cas_signatureTestee.getFirstItem () ;
    while ((operand_61334 != NULL) && (operand_61422 != NULL)) {
      macroValidPointer (operand_61334) ;
      macroValidPointer (operand_61422) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_61334->mType,  operand_61422->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_61334->mFormalArgumentPassingMode) != (operand_61422->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_61422->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_61422->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_61334 = operand_61334->getNextItem () ;
      operand_61422 = operand_61422->getNextItem () ;
    }
  }
}
...
void routine_handleReaderCall (C_lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasMapType * operand_70790 = dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_70790) ; 
      if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
        var_cas_outAccessorTypesList.addAssign_operation (operand_70790->mKeyType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_))) ;
        var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new () ;
      ...
      cPtr_typeGalgasClassType * operand_71402 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_71402) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_71402->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_71740 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_71740) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_71740->mMessagesMap ;
