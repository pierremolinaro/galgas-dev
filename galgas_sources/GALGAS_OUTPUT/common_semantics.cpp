...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_36610 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_36709 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_36610 != NULL)
        && (operand_36709 != NULL)) {
      macroValidPointer (operand_36610) ;
      macroValidPointer (operand_36709) ;
      if (((operand_36610->mFormalArgumentPassingMode) != (operand_36709->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_36709->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_36610->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_36610->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_36610->mGalgasTypeName.reader_value ()) != (operand_36709->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_36709->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_36610->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_36709->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_36610 = operand_36610->nextObject () ;
      operand_36709 = operand_36709->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_53829 = mNonExternAttributesList.firstObject () ;
  while ((operand_53829 != NULL)) {
    macroValidPointer (operand_53829) ;
    var_cas_outForeachList.addAssign_operation (operand_53829->mAttributType, operand_53829->aNomAttribut) ;
    operand_53829 = operand_53829->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59873 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_59892 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_59873 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59873) ;
    cPtr_typeGalgas_stringset * operand_59892 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59892) ;
    if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_59873 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59873) ;
      cPtr_typeGalgas_uint * operand_59892 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59892) ;
      if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_59873 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59873) ;
        cPtr_typeGalgas_sint * operand_59892 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59892) ;
        if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_59873 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59873) ;
          cPtr_typeGalgas_char * operand_59892 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59892) ;
          if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_59873 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59873) ;
            cPtr_typeGalgas_string * operand_59892 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59892) ;
            if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_59873 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59873) ;
              cPtr_typeGalgas_bool * operand_59892 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59892) ;
              if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_59873 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59873) ;
                cPtr_typeGalgas_double * operand_59892 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59892) ;
                if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_59873 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59873) ;
                  cPtr_typeGalgas_lbool * operand_59892 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59892) ;
                  if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_59873 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59873) ;
                    cPtr_typeGalgas_lchar * operand_59892 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59892) ;
                    if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_59873 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59873) ;
                      cPtr_typeGalgas_luint * operand_59892 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59892) ;
                      if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_59873 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59873) ;
                        cPtr_typeGalgas_lsint * operand_59892 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59892) ;
                        if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_59873 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59873) ;
                          cPtr_typeGalgas_ldouble * operand_59892 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59892) ;
                          if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_59873 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59873) ;
                            cPtr_typeGalgas_lstring * operand_59892 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59892) ;
                            if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_59873 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59873) ;
                              cPtr_typeGalgas_location * operand_59892 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59892) ;
                              if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_59873 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59873) ;
                                cPtr_typeGalgasUndefinedListType * operand_59892 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59892) ;
                                if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                                  if (((operand_59873->mListTypeName.reader_value ()) != (operand_59892->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59873->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59892->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_59873 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59873) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_59892 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59892) ;
                                  if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                                    if (((operand_59873->mMapTypeName.reader_value ()) != (operand_59892->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59873->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59892->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_59873 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59873) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_59892 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59892) ;
                                    if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                                      if (((operand_59873->mClassTypeName.reader_value ()) != (operand_59892->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59873->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59892->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_59873 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59873) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_59892 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59892) ;
                                      if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                                        if (((operand_59873->mGalgasClassName.reader_value ()) != (operand_59892->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59873->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59892->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_59873 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59873) ;
                                        cPtr_typeGalgas_enum * operand_59892 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59892) ;
                                        if ((operand_59873 != NULL) && (operand_59892 != NULL)) {
                                          if (((operand_59873->mEnumTypeName.reader_value ()) != (operand_59892->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59873->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59892->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_63674 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_63773 = var_cas_signatureTestee.firstObject () ;
    while ((operand_63674 != NULL)
        && (operand_63773 != NULL)) {
      macroValidPointer (operand_63674) ;
      macroValidPointer (operand_63773) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_63674->mType,  operand_63773->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_63674->mFormalArgumentPassingMode) != (operand_63773->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_63773->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_63773->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_63674 = operand_63674->nextObject () ;
      operand_63773 = operand_63773->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_75265 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_75265) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_75265->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_75598 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_75598) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_75598->mMessagesMap ;
      GGS_L_lstringList  var_cas_75763 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_75763) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
