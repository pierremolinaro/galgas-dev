...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1961)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2001))) == (GGS_string (true, "emptyList"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2003))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyList' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2005)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2007)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2037)) ;
}
...
method_handleModifierCall (C_Lexique & _inLexique,
  ...
  if (mModifierMethodMap._isBuilt ()) {
    mModifierMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (2073)) ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMethodMap._isBuilt ()) {
    mReaderMethodMap (HERE)->method_searchKey (_inLexique, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (2083)) ;
  }
}
...
method_acceptForeachInstruction (C_Lexique & _inLexique,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_85457 = mNonExternAttributesList.firstObject () ;
  while ((operand_85457 != NULL)) {
    macroValidPointer (operand_85457) ;
    var_cas_outForeachList._addAssign_operation (operand_85457->mAttributType, operand_85457->aNomAttribut) ;
    operand_85457 = operand_85457->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
                                GGS_lstring  var_cas_inClassMethodName,
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2108))) == (GGS_string (true, "emptyMap"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2110))) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.3.0 and later, use 'emptyMap' constructor instead of 'empty' constructor") SOURCE_FILE_AT_LINE (2112)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2114)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2131)) ;
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
  ...
  if (mReaderMap._isBuilt ()) {
    mReaderMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (2172)) ;
  }
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (2182)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }else if (((var_cas_inClassMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2182))) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
  }else{
    var_cas_inClassMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (2186)) ;
    var_cas_outAccessorTypesList._drop_operation () ;
  }
}
...
method_handleModifierCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inModifierName,
                                GGS_L_EXsignature & var_cas_outModifierSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2265))) == (GGS_string (true, "insertKey"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    ...
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
  }else if (((var_cas_inModifierName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2271))) == (GGS_string (true, "insertKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outModifierSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outModifierSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inModifiedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2277)) COMMA_HERE) ;
    ...
    var_cas_inModifierName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type only accept 'insertKey' and 'insertKey' modifier calls") SOURCE_FILE_AT_LINE (2282)) ;
    var_cas_outModifierSignature._drop_operation () ;
  }
}
...
method_handleReaderInstructionCall (C_Lexique & _inLexique,
                                ...
                                GGS_lstring  var_cas_inReaderName,
                                GGS_L_EXsignature & var_cas_outReaderSignature COMMA_UNUSED_LOCATION_ARGS) {
  if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2292))) == (GGS_string (true, "searchKey"))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_inReaderName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2298))) == (GGS_string (true, "searchKeyAndGetIndex"))).isBuiltAndTrue ()) {
    var_cas_outReaderSignature = GGS_L_EXsignature::constructor_emptyList (_inLexique COMMA_HERE) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentConstantIn (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_entityInInstruction::constructor_new (_inLexique, mElementTypeName COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
    var_cas_t = GGS_typeGalgas_mapIndexInInstruction::constructor_new (_inLexique, var_cas_inReadObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2304)) COMMA_HERE) ;
    var_cas_outReaderSignature._addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentOut (_inLexique COMMA_HERE)) ;
  }else{
    var_cas_inReadObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type  only accept 'searchKey'  'searchKeyAndGetIndex' reader calls") SOURCE_FILE_AT_LINE (2310)) ;
    var_cas_outReaderSignature._drop_operation () ;
  }
}
...
method_getTypeName (C_Lexique & _inLexique,
                                GGS_string& var_cas_outTypeName COMMA_UNUSED_LOCATION_ARGS) {
  var_cas_outTypeName = mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2343)) ;
}
...
method_handleConstructorCall (C_Lexique & _inLexique,
  ...
  if (mEnumConstantesMap._isBuilt ()) {
    mEnumConstantesMap (HERE)->method_searchKey (_inLexique, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (2351)) ;
  }
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_inFormalType._isBuilt () && var_cas_inEffectiveType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_96008 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_96027 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_96008 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96008) ;
    cPtr_typeGalgas_stringset * operand_96027 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_96027) ;
    if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_96008 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96008) ;
      cPtr_typeGalgas_uint * operand_96027 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_96027) ;
      if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_96008 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96008) ;
        cPtr_typeGalgas_sint * operand_96027 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_96027) ;
        if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
        }else{
          cPtr_typeGalgas_uint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96008) ;
          cPtr_typeGalgas_uint64 * operand_96027 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_96027) ;
          if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
          }else{
            cPtr_typeGalgas_sint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96008) ;
            cPtr_typeGalgas_sint64 * operand_96027 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_96027) ;
            if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
            }else{
              cPtr_typeGalgas_char * operand_96008 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96008) ;
              cPtr_typeGalgas_char * operand_96027 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_96027) ;
              if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
              }else{
                cPtr_typeGalgas_string * operand_96008 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96008) ;
                cPtr_typeGalgas_string * operand_96027 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_96027) ;
                if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                }else{
                  cPtr_typeGalgas_bool * operand_96008 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96008) ;
                  cPtr_typeGalgas_bool * operand_96027 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_96027) ;
                  if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_96008 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96008) ;
                    cPtr_typeGalgas_double * operand_96027 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_96027) ;
                    if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lbool * operand_96008 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96008) ;
                      cPtr_typeGalgas_lbool * operand_96027 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_96027) ;
                      if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lchar * operand_96008 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96008) ;
                        cPtr_typeGalgas_lchar * operand_96027 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_96027) ;
                        if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                        }else{
                          cPtr_typeGalgas_luint * operand_96008 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96008) ;
                          cPtr_typeGalgas_luint * operand_96027 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_96027) ;
                          if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lsint * operand_96008 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96008) ;
                            cPtr_typeGalgas_lsint * operand_96027 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_96027) ;
                            if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                            }else{
                              cPtr_typeGalgas_luint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96008) ;
                              cPtr_typeGalgas_luint64 * operand_96027 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_96027) ;
                              if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                              }else{
                                cPtr_typeGalgas_lsint64 * operand_96008 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96008) ;
                                cPtr_typeGalgas_lsint64 * operand_96027 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_96027) ;
                                if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_ldouble * operand_96008 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96008) ;
                                  cPtr_typeGalgas_ldouble * operand_96027 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_96027) ;
                                  if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_lstring * operand_96008 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96008) ;
                                    cPtr_typeGalgas_lstring * operand_96027 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_96027) ;
                                    if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_location * operand_96008 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96008) ;
                                      cPtr_typeGalgas_location * operand_96027 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_96027) ;
                                      if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                      }else{
                                        cPtr_typeGalgasUndefinedListType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96008) ;
                                        cPtr_typeGalgasUndefinedListType * operand_96027 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_96027) ;
                                        if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                          if (((operand_96008->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2391))) != (operand_96027->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2391)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the list type '@")) + (operand_96008->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2392))))) + (GGS_string (true, "', I have got the list type '@")))) + (operand_96027->mListTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2393))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2394)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgasUndefinedMapType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96008) ;
                                          cPtr_typeGalgasUndefinedMapType * operand_96027 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_96027) ;
                                          if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                            if (((operand_96008->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2397))) != (operand_96027->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2397)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the map type '@")) + (operand_96008->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2398))))) + (GGS_string (true, "', I have got the map type '@")))) + (operand_96027->mMapTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2399))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2400)) ;
                                            }
                                          }else{
                                            cPtr_typeGalgasUndefinedClassType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96008) ;
                                            cPtr_typeGalgasClassType * operand_96027 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_96027) ;
                                            if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                              GGS_bool var_cas_accept ;
                                              var_cas_accept = (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2404))) == (operand_96027->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2404))) ;
                                              if (((((! (var_cas_accept))) & (var_cas_inAcceptPolymorphism))).isBuiltAndTrue ()) {
                                                var_cas_accept = operand_96027->mAncestorClassesMap.reader_hasKey (_inLexique, operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2406)) SOURCE_FILE_AT_LINE (2406)) ;
                                              }
                                              if (((! (var_cas_accept))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2409))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96027->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2410))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2411)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedClassType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96008) ;
                                              cPtr_typeGalgasUndefinedClassType * operand_96027 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_96027) ;
                                              if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                                if (((operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414))) != (operand_96027->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2414)))).isBuiltAndTrue ()) {
                                                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting the class type '@")) + (operand_96008->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2415))))) + (GGS_string (true, "', I have got the class type '@")))) + (operand_96027->mClassTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2416))))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (2417)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedExternType * operand_96008 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96008) ;
                                                cPtr_typeGalgasUndefinedExternType * operand_96027 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_96027) ;
                                                if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                                  if (((operand_96008->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421))) != (operand_96027->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2421)))).isBuiltAndTrue ()) {
                                                    var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '@")) + (operand_96008->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2422))))) + (GGS_string (true, "' type variable, and I got an extern '@")))) + (operand_96027->mGalgasClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2423))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2424)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgas_enum * operand_96008 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96008) ;
                                                  cPtr_typeGalgas_enum * operand_96027 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_96027) ;
                                                  if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                                    if (((operand_96008->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2428))) != (operand_96027->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2428)))).isBuiltAndTrue ()) {
                                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '@")) + (operand_96008->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2429))))) + (GGS_string (true, "' type variable, and I got an enum '@")))) + (operand_96027->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2430))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (2431)) ;
                                                    }
                                                  }else{
                                                    cPtr_typeGalgas_entityInInstruction * operand_96008 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96008) ;
                                                    cPtr_typeGalgas_entityInInstruction * operand_96027 = dynamic_cast <cPtr_typeGalgas_entityInInstruction *> (ptr_96027) ;
                                                    if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                                      if (((operand_96008->mEntityName) != (operand_96027->mEntityName)).isBuiltAndTrue ()) {
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an entity instance of  '@")) + (operand_96008->mEntityName))) + (GGS_string (true, "' type variable, and I got an entity instance of type '@")))) + (operand_96027->mEntityName))) + (GGS_string (true, "'"))) SOURCE_FILE_AT_LINE (2438)) ;
                                                      }
                                                    }else{
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96008 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96008) ;
                                                      cPtr_typeGalgas_mapIndexInInstruction * operand_96027 = dynamic_cast <cPtr_typeGalgas_mapIndexInInstruction *> (ptr_96027) ;
                                                      if ((operand_96008 != NULL) && (operand_96027 != NULL)) {
                                                        if (((operand_96008->mMapTypeName) != (operand_96027->mMapTypeName)).isBuiltAndTrue ()) {
                                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a map index of  '")) + (operand_96008->mMapTypeName))) + (GGS_string (true, "' map property, and I got a map index of '")))) + (operand_96027->mMapTypeName))) + (GGS_string (true, "' map property"))) SOURCE_FILE_AT_LINE (2445)) ;
                                                        }
                                                      }else{
                                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_inFormalType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2448))) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (2448)))) SOURCE_FILE_AT_LINE (2449)) ;
                                                      }
                                                    }
                                                  }
                                                }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2463))) < (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2463)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2465)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (2465))) > (var_cas_signatureTestee.reader_length (_inLexique SOURCE_FILE_AT_LINE (2465)))).isBuiltAndTrue ()) {
    var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2467)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_101427 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_101526 = var_cas_signatureTestee.firstObject () ;
    while ((operand_101427 != NULL)
        && (operand_101526 != NULL)) {
      macroValidPointer (operand_101427) ;
      macroValidPointer (operand_101526) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_101427->mType,  operand_101526->mType,  var_cas_ouSignalerErreur,  GGS_bool (true, false) SOURCE_FILE_AT_LINE (2471)) ;
      if (((operand_101427->mFormalArgumentPassingMode) != (operand_101526->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
        var_cas_ouSignalerErreur.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_101526->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2477))) + (GGS_string (true, " is not compatible with ")))) + (operand_101526->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (2478)))) SOURCE_FILE_AT_LINE (2479)) ;
      }
      operand_101427 = operand_101427->nextObject () ;
      operand_101526 = operand_101526->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & _inLexique,
  ...
  if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2622))) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType._isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2628))) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2631))) == (GGS_string (true, "pathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2634))) == (GGS_string (true, "lastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2637))) == (GGS_string (true, "stringByDeletingPathExtension"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2640))) == (GGS_string (true, "stringByCapitalizingFirstCharacter"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2643))) == (GGS_string (true, "firstCharacterOrNul"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2646))) == (GGS_string (true, "stringByDeletingLastPathComponent"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2649))) == (GGS_string (true, "stringByReplacingStringByString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2657)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_location *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2659))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2665)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2667))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2670))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2673))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2676))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
        ...
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2684))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2687))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2690))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2693))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2699)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2701))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2704))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2707))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2710))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2716)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2718))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2721))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2724))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2727))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2733)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lstring *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2735))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2738))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lstring type is deprecated; use 'string' instead") SOURCE_FILE_AT_LINE (2739)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2742))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2745))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2751)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lchar *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2753))) == (GGS_string (true, "char"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2756))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lchar type  is deprecated; use 'char' instead") SOURCE_FILE_AT_LINE (2757)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_char::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2760))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2763))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2769)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lbool *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2771))) == (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2774))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lbool type  is deprecated; use 'bool' instead") SOURCE_FILE_AT_LINE (2775)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2778))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2784)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2786))) == (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2789))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' of @luint type  reader is deprecated; use 'uint' instead") SOURCE_FILE_AT_LINE (2790)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2793))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2796))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2802)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_luint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2804))) == (GGS_string (true, "uint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2807))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2810))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2816)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2818))) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2821))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @lsint type  is deprecated; use 'sint' instead") SOURCE_FILE_AT_LINE (2822)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2825))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2828))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2831))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2837)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_lsint64 *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2839))) == (GGS_string (true, "sint64"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_sint64::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2842))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2845))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2848))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2854)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_ldouble *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2856))) == (GGS_string (true, "double"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2859))) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "in GALGAS 1.4.1 and later, the 'value' reader of @ldouble type  is deprecated; use 'double' instead") SOURCE_FILE_AT_LINE (2860)) ;
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_double::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2863))) == (GGS_string (true, "string"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2866))) == (GGS_string (true, "location"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2869))) == (GGS_string (true, "locationString"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2875)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasListType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2877))) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2883)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasMapType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2885))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          ...
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2890))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2893))) == (GGS_string (true, "allKeys"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2899)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgas_stringset *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2901))) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          GGS_AC_galgasType  var_cas_keyType ;
          var_cas_keyType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          var_cas_outAccessorTypesList._addAssign_operation (var_cas_keyType, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
          var_cas_outReturnedType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
        }else if (((var_cas_inMethodName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2906))) == (GGS_string (true, "count"))).isBuiltAndTrue ()) {
          var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
        }else{
          var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2912)) ;
          var_cas_outAccessorTypesList._drop_operation () ;
          var_cas_outReturnedType._drop_operation () ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_124900 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_124900) ; 
        if (operand_124900->mMessagesMap._isBuilt ()) {
          operand_124900->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName SOURCE_FILE_AT_LINE (2914)) ;
        }
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_125179 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_125179) ; 
        GGS_L_lstringList  var_cas_125291 ;
        if (operand_125179->mMessagesMap._isBuilt ()) {
          operand_125179->mMessagesMap (HERE)->method_searchKey (_inLexique, var_cas_inMethodName, var_cas_125291 SOURCE_FILE_AT_LINE (2918)) ;
        }
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_emptyList (_inLexique COMMA_HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
      }else{ // Else part
        var_cas_inMethodName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2925)) ;
        var_cas_outAccessorTypesList._drop_operation () ;
        var_cas_outReturnedType._drop_operation () ;
      }
    }
...
void routine_importSemanticsComponent (C_Lexique & _inLexique,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (_inLexique, var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2952)) SOURCE_FILE_AT_LINE (2952))))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_127090 ;
    GGS_M_semanticsEntitiesForUse  var_cas_127099 ;
    if (var_cas_ioSemanticsComponentsMap._isBuilt ()) {
      var_cas_ioSemanticsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_127090, var_cas_127099 SOURCE_FILE_AT_LINE (2959)) ;
    }
    ...
    GGS_stringset::element_type * operand_127344 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_127344 != NULL)) {
      macroValidPointer (operand_127344) ;
      ::routine_importSemanticsComponent (_inLexique,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (_inLexique, operand_127344->mKey, GGS_location (_inLexique) COMMA_HERE) SOURCE_FILE_AT_LINE (2973)) ;
      operand_127344 = operand_127344->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_127709 = var_cas_modelMap.firstObject () ;
    while ((operand_127709 != NULL)) {
      macroValidPointer (operand_127709) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (_inLexique, operand_127709->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2984)) SOURCE_FILE_AT_LINE (2984))))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.method_insertKey (_inLexique, operand_127709->mKey, operand_127709->mInfo.mType SOURCE_FILE_AT_LINE (2985)) ;
      }
      operand_127709 = operand_127709->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_127923 = var_cas_actionMap.firstObject () ;
    while ((operand_127923 != NULL)) {
      macroValidPointer (operand_127923) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (_inLexique, operand_127923->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (2990)) SOURCE_FILE_AT_LINE (2990))))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.method_insertKey (_inLexique, operand_127923->mKey, operand_127923->mInfo.mSignature, operand_127923->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2991)) ;
      }
      operand_127923 = operand_127923->nextObject () ;
    }
    var_cas_ioAlreadyImportedSemanticsComponents._addAssign_operation (var_cas_inSemanticsComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (2995))) ;
  }
}
...
void routine_buildSuperEntitySet (C_Lexique & _inLexique,
  ...
  if (((((((var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3006))) != (GGS_string (true, ""))) & (var_cas_inEntityMap.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3007)) SOURCE_FILE_AT_LINE (3007))))) & ((! (var_cas_ioSuperEntitySet.reader_hasKey (_inLexique, var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3008)) SOURCE_FILE_AT_LINE (3008))))))).isBuiltAndTrue ()) {
    var_cas_ioSuperEntitySet._addAssign_operation (var_cas_inSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3009))) ;
    GGS_lstring  var_cas_superEntityName ;
    GGS_entityPropertyMap  var_cas_128788 ;
    GGS_bool var_cas_128791 ;
    GGS_entityPropertyMap  var_cas_128794 ;
    if (var_cas_inEntityMap._isBuilt ()) {
      var_cas_inEntityMap (HERE)->method_searchKey (_inLexique, var_cas_inSuperEntityName, var_cas_128788, var_cas_128791, var_cas_128794, var_cas_superEntityName SOURCE_FILE_AT_LINE (3011)) ;
    }
    ::routine_buildSuperEntitySet (_inLexique,  var_cas_inEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (3012)) ;
  }
}
...
void routine_checkPath (C_Lexique & _inLexique,
  ...
  GGS_L_propertyPath::element_type * operand_129531 = var_cas_inPath.firstObject () ;
  while ((operand_129531 != NULL)) {
    macroValidPointer (operand_129531) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_129531->mPathElement.reader_string (_inLexique SOURCE_FILE_AT_LINE (3033)).reader_pathExtension (_inLexique SOURCE_FILE_AT_LINE (3033)) ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (_inLexique, var_cas_entityTypeName, operand_129531->mPathElement.reader_location (_inLexique SOURCE_FILE_AT_LINE (3036)) COMMA_HERE) ;
      ::routine_buildSuperEntitySet (_inLexique,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (3038)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3042)) SOURCE_FILE_AT_LINE (3042))))).isBuiltAndTrue ()) {
        operand_129531->mPathElement.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3044))))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (3045)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE) ;
      GGS_bool var_cas_130324 ;
      GGS_entityPropertyMap  var_cas_130327 ;
      GGS_lstring  var_cas_130330 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130324, var_cas_130327, var_cas_130330 SOURCE_FILE_AT_LINE (3049)) ;
      }
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      if (var_cas_currentMap._isBuilt ()) {
        var_cas_currentMap (HERE)->method_searchKey (_inLexique, operand_129531->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (3052)) ;
      }
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (_inLexique, var_cas_outTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3054)) SOURCE_FILE_AT_LINE (3054))).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_130693 ;
          GGS_lstring  var_cas_130696 ;
          if (var_cas_ioMapEntityMap._isBuilt ()) {
            var_cas_ioMapEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_elementEntity, var_cas_130693, var_cas_130696 SOURCE_FILE_AT_LINE (3056)) ;
          }
          GGS_bool var_cas_130763 ;
          GGS_entityPropertyMap  var_cas_130766 ;
          GGS_lstring  var_cas_130769 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_elementEntity, var_cas_currentMap, var_cas_130763, var_cas_130766, var_cas_130769 SOURCE_FILE_AT_LINE (3057)) ;
          }
        }else{
          GGS_bool var_cas_130848 ;
          GGS_entityPropertyMap  var_cas_130851 ;
          GGS_lstring  var_cas_130854 ;
          if (var_cas_ioEntityMap._isBuilt ()) {
            var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_outTypeName, var_cas_currentMap, var_cas_130848, var_cas_130851, var_cas_130854 SOURCE_FILE_AT_LINE (3059)) ;
          }
        }
      }
    }
    operand_129531 = operand_129531->nextObject () ;
  }
}
...
void routine_computeDescendantSet (C_Lexique & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_131169 = var_cas_inEntityMap.firstObject () ;
  while ((operand_131169 != NULL)) {
    macroValidPointer (operand_131169) ;
    if (((((operand_131169->mInfo.mSuperEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074))) == (var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074)))) & ((! (var_cas_ioDescendantEntitySet.reader_hasKey (_inLexique, var_cas_inEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (3074)) SOURCE_FILE_AT_LINE (3074))))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet._addAssign_operation (operand_131169->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (3075))) ;
      ::routine_computeDescendantSet (_inLexique,  var_cas_inEntityMap,  operand_131169->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (3076)) ;
    }
    operand_131169 = operand_131169->nextObject () ;
  }
}
