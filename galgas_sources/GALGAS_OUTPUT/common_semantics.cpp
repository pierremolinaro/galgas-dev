...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_49061 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_49160 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_49061 != NULL)
        && (operand_49160 != NULL)) {
      macroValidPointer (operand_49061) ;
      macroValidPointer (operand_49160) ;
      if (((operand_49061->mFormalArgumentPassingMode) != (operand_49160->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_49160->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_49061->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_49061->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_49061->mGalgasTypeName.reader_value ()) != (operand_49160->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_49160->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_49061->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_49160->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_49061 = operand_49061->nextObject () ;
      operand_49160 = operand_49160->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66268 = mNonExternAttributesList.firstObject () ;
  while ((operand_66268 != NULL)) {
    macroValidPointer (operand_66268) ;
    var_cas_outForeachList.addAssign_operation (operand_66268->mAttributType, operand_66268->aNomAttribut) ;
    operand_66268 = operand_66268->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72041 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72060 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72041 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72041) ;
    cPtr_typeGalgas_stringset * operand_72060 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72060) ;
    if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72041 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72041) ;
      cPtr_typeGalgas_uint * operand_72060 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72060) ;
      if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72041 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72041) ;
        cPtr_typeGalgas_sint * operand_72060 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72060) ;
        if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72041 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72041) ;
          cPtr_typeGalgas_char * operand_72060 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72060) ;
          if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72041 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72041) ;
            cPtr_typeGalgas_string * operand_72060 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72060) ;
            if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72041 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72041) ;
              cPtr_typeGalgas_bool * operand_72060 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72060) ;
              if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72041 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72041) ;
                cPtr_typeGalgas_double * operand_72060 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72060) ;
                if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72041 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72041) ;
                  cPtr_typeGalgas_lbool * operand_72060 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72060) ;
                  if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72041 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72041) ;
                    cPtr_typeGalgas_lchar * operand_72060 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72060) ;
                    if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72041 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72041) ;
                      cPtr_typeGalgas_luint * operand_72060 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72060) ;
                      if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72041 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72041) ;
                        cPtr_typeGalgas_lsint * operand_72060 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72060) ;
                        if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72041 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72041) ;
                          cPtr_typeGalgas_ldouble * operand_72060 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72060) ;
                          if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72041 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72041) ;
                            cPtr_typeGalgas_lstring * operand_72060 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72060) ;
                            if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72041 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72041) ;
                              cPtr_typeGalgas_location * operand_72060 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72060) ;
                              if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72041 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72041) ;
                                cPtr_typeGalgasUndefinedListType * operand_72060 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72060) ;
                                if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                                  if (((operand_72041->mListTypeName.reader_value ()) != (operand_72060->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72041->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72060->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72041 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72041) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72060 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72060) ;
                                  if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                                    if (((operand_72041->mMapTypeName.reader_value ()) != (operand_72060->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72041->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72060->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72041 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72041) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72060 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72060) ;
                                    if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                                      if (((operand_72041->mClassTypeName.reader_value ()) != (operand_72060->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72041->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72060->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72041 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72041) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72060 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72060) ;
                                      if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                                        if (((operand_72041->mGalgasClassName.reader_value ()) != (operand_72060->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72041->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72060->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72041 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72041) ;
                                        cPtr_typeGalgas_enum * operand_72060 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72060) ;
                                        if ((operand_72041 != NULL) && (operand_72060 != NULL)) {
                                          if (((operand_72041->mEnumTypeName.reader_value ()) != (operand_72060->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72041->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72060->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_75846 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_75945 = var_cas_signatureTestee.firstObject () ;
    while ((operand_75846 != NULL)
        && (operand_75945 != NULL)) {
      macroValidPointer (operand_75846) ;
      macroValidPointer (operand_75945) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_75846->mType,  operand_75945->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_75846->mFormalArgumentPassingMode) != (operand_75945->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_75945->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_75945->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_75846 = operand_75846->nextObject () ;
      operand_75945 = operand_75945->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_87856 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_87856) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_87856->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_88189 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_88189) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_88189->mMessagesMap ;
      GGS_L_lstringList  var_cas_88354 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_88354) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_89887 ;
    GGS_M_semanticsEntitiesForUse  var_cas_89890 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedOptionsComponents, var_cas_89887, var_cas_89890) ;
    GGS_stringset::element_type * operand_89991 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_89991 != NULL)) {
      macroValidPointer (operand_89991) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_89991->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_89991 = operand_89991->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_90275 = var_cas_modelMap.firstObject () ;
    while ((operand_90275 != NULL)) {
      macroValidPointer (operand_90275) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_90275->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_90275->mKey, operand_90275->mInfo.mType) ;
      }
      operand_90275 = operand_90275->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_90488 = var_cas_actionMap.firstObject () ;
    while ((operand_90488 != NULL)) {
      macroValidPointer (operand_90488) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_90488->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_90488->mKey, operand_90488->mInfo.mSignature, operand_90488->mInfo.mIsExtern) ;
      }
      operand_90488 = operand_90488->nextObject () ;
    }
