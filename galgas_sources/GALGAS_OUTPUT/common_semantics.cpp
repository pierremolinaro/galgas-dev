  ...
  if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "description"))).isBuiltAndTrue ()) {
    ...
    if (var_cas_inReceiverType.isBuilt ()) {
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        ...
        cPtr_typeGalgasClassType * operand_100770 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_100770) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_100770->mMessagesMap ;
        ...
        cPtr_typeGalgas_enum * operand_101113 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_101113) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_101113->mMessagesMap ;
        GGS_L_lstringList  var_cas_101282 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_101282 SOURCE_FILE_AT_LINE (2387)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_103078 ;
    GGS_M_semanticsEntitiesForUse  var_cas_103087 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_103078, var_cas_103087 SOURCE_FILE_AT_LINE (2428)) ;
    ...
    GGS_stringset::element_type * operand_103332 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_103332 != NULL)) {
      macroValidPointer (operand_103332) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_103332->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2442)) ;
      operand_103332 = operand_103332->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_103697 = var_cas_modelMap.firstObject () ;
    while ((operand_103697 != NULL)) {
      macroValidPointer (operand_103697) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_103697->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_103697->mKey, operand_103697->mInfo.mType SOURCE_FILE_AT_LINE (2454)) ;
      }
      operand_103697 = operand_103697->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_103910 = var_cas_actionMap.firstObject () ;
    while ((operand_103910 != NULL)) {
      macroValidPointer (operand_103910) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_103910->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_103910->mKey, operand_103910->mInfo.mSignature, operand_103910->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2460)) ;
      }
      operand_103910 = operand_103910->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_104713 ;
    GGS_bool var_cas_104716 ;
    GGS_entityPropertyMap  var_cas_104719 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_104713, var_cas_104716, var_cas_104719, var_cas_superEntityName SOURCE_FILE_AT_LINE (2478)) ;
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_105457 = var_cas_inPath.firstObject () ;
  while ((operand_105457 != NULL)) {
    macroValidPointer (operand_105457) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_105457->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_105457->mPathElement.reader_location () COMMA_HERE) ;
      ...
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_105457->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2511)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_106247 ;
      GGS_entityPropertyMap  var_cas_106250 ;
      GGS_lstring  var_cas_106253 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106247, var_cas_106250, var_cas_106253 SOURCE_FILE_AT_LINE (2516)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_105457->mPathElement, var_cas_outKind, var_cas_outTypeName SOURCE_FILE_AT_LINE (2519)) ;
      if (((var_cas_outKind) != (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          ...
          GGS_lstring  var_cas_106619 ;
          GGS_lstring  var_cas_106622 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_106619, var_cas_106622 SOURCE_FILE_AT_LINE (2523)) ;
          GGS_bool var_cas_106691 ;
          GGS_entityPropertyMap  var_cas_106694 ;
          GGS_lstring  var_cas_106697 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_106691, var_cas_106694, var_cas_106697 SOURCE_FILE_AT_LINE (2524)) ;
        }else{
          GGS_bool var_cas_106778 ;
          GGS_entityPropertyMap  var_cas_106781 ;
          GGS_lstring  var_cas_106784 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_106778, var_cas_106781, var_cas_106784 SOURCE_FILE_AT_LINE (2526)) ;
        }
      }
    }
...
void routine_computeDescendantSet (C_Lexique & lexique_var_,
  ...
  GGS_entityToImplementMap::element_type * operand_107099 = var_cas_ioEntityMap.firstObject () ;
  while ((operand_107099 != NULL)) {
    macroValidPointer (operand_107099) ;
    if (((((operand_107099->mInfo.mSuperEntityName.reader_value ()) == (var_cas_inEntityName.reader_value ())) && ((! (var_cas_ioDescendantEntitySet.reader_hasKey (var_cas_inEntityName.reader_value ())))))).isBuiltAndTrue ()) {
      var_cas_ioDescendantEntitySet.addAssign_operation (operand_107099->mKey.reader_value ()) ;
      ::routine_computeDescendantSet (lexique_var_,  var_cas_ioEntityMap,  operand_107099->mKey,  var_cas_ioDescendantEntitySet SOURCE_FILE_AT_LINE (2543)) ;
    }
    operand_107099 = operand_107099->nextObject () ;
  }
}
