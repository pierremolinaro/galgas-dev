...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "max"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (829)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (914)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (949)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (980)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1011)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1046)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "new"))).isBuiltAndTrue ()) {
    ...
    var_cas_outAccessorTypesList.addAssign_operation (var_cas_t, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1081)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1112)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_constructorMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName, var_cas_outAccessorTypesList SOURCE_FILE_AT_LINE (1223)) ;
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1232)) ;
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inReaderName, var_cas_outReaderSignature SOURCE_FILE_AT_LINE (1241)) ;
}
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much formal parameters") SOURCE_FILE_AT_LINE (1370)) ;
  }else if (((var_cas_inFormalReferenceSignature.reader_length ()) > (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
      var_cas_inEndOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more formal parameters missing") SOURCE_FILE_AT_LINE (1372)) ;
  }else{
    GGS_L_signature::element_type * operand_54781 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_54880 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_54781 != NULL)
        && (operand_54880 != NULL)) {
      macroValidPointer (operand_54781) ;
      macroValidPointer (operand_54880) ;
      if (((operand_54781->mFormalArgumentPassingMode) != (operand_54880->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_54880->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_54781->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_54781->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found"))) SOURCE_FILE_AT_LINE (1378)) ;
      }
      if (((operand_54781->mGalgasTypeName.reader_value ()) != (operand_54880->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_54880->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_54781->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_54880->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (1381)) ;
      }
      operand_54781 = operand_54781->nextObject () ;
      operand_54880 = operand_54880->nextObject () ;
    }
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1696)) ;
  }
}
...
methode_handleModifierCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inModifierName, var_cas_outModifierSignature SOURCE_FILE_AT_LINE (1760)) ;
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_72679 = mNonExternAttributesList.firstObject () ;
  while ((operand_72679 != NULL)) {
    macroValidPointer (operand_72679) ;
    var_cas_outForeachList.addAssign_operation (operand_72679->mAttributType, operand_72679->aNomAttribut) ;
    operand_72679 = operand_72679->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inClassMethodName.reader_value ()) == (GGS_string (true, "empty"))).isBuiltAndTrue ()) {
    var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1787)) ;
  }
}
...
methode_typeCanBeUsedInObjectDeclaration (C_Lexique & lexique_var_) {
  if (((! (mClassIsAbstract))).isBuiltAndTrue ()) {
      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "non abstract class object cannot be declared (only instancied by 'new')") SOURCE_FILE_AT_LINE (1835)) ;
  }
}
...
methode_handleReaderInstructionCall (C_Lexique & lexique_var_,
  ...
  var_cas_methodMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_outMethodSignature SOURCE_FILE_AT_LINE (1846)) ;
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
                                ...
                                GGS_typeListeAttributsSemantiques & var_cas_outAccessorTypesList) {
  if ((mClassIsAbstract).isBuiltAndTrue ()) {
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "an abstract class cannot be instancied") SOURCE_FILE_AT_LINE (1855)) ;
    ...
    var_cas_outAccessorTypesList = mNonExternAttributesList ;
      ...
      var_cas_inClassMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "This constructor is not defined") SOURCE_FILE_AT_LINE (1859)) ;
  }
}
...
methode_handleConstructorCall (C_Lexique & lexique_var_,
  ...
  var_cas_enumConstantesMap.methode_searchKey (lexique_var_, var_cas_inClassMethodName SOURCE_FILE_AT_LINE (1918)) ;
  var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_78452 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_78471 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_78452 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78452) ;
    cPtr_typeGalgas_stringset * operand_78471 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_78471) ;
    if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_78452 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78452) ;
      cPtr_typeGalgas_uint * operand_78471 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_78471) ;
      if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_78452 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78452) ;
        cPtr_typeGalgas_sint * operand_78471 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_78471) ;
        if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_78452 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78452) ;
          cPtr_typeGalgas_char * operand_78471 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_78471) ;
          if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_78452 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78452) ;
            cPtr_typeGalgas_string * operand_78471 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_78471) ;
            if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_78452 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78452) ;
              cPtr_typeGalgas_bool * operand_78471 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_78471) ;
              if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_78452 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78452) ;
                cPtr_typeGalgas_double * operand_78471 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_78471) ;
                if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_78452 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78452) ;
                  cPtr_typeGalgas_lbool * operand_78471 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_78471) ;
                  if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_78452 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78452) ;
                    cPtr_typeGalgas_lchar * operand_78471 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_78471) ;
                    if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_78452 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78452) ;
                      cPtr_typeGalgas_luint * operand_78471 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_78471) ;
                      if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_78452 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78452) ;
                        cPtr_typeGalgas_lsint * operand_78471 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_78471) ;
                        if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_78452 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78452) ;
                          cPtr_typeGalgas_ldouble * operand_78471 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_78471) ;
                          if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_78452 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78452) ;
                            cPtr_typeGalgas_lstring * operand_78471 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_78471) ;
                            if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_78452 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78452) ;
                              cPtr_typeGalgas_location * operand_78471 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_78471) ;
                              if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_78452 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78452) ;
                                cPtr_typeGalgasUndefinedListType * operand_78471 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_78471) ;
                                if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                                  if (((operand_78452->mListTypeName.reader_value ()) != (operand_78471->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_78452->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_78471->mListTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1955)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_78452 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78452) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_78471 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_78471) ;
                                  if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                                    if (((operand_78452->mMapTypeName.reader_value ()) != (operand_78471->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_78452->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_78471->mMapTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1961)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_78452 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78452) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_78471 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_78471) ;
                                    if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                                      if (((operand_78452->mClassTypeName.reader_value ()) != (operand_78471->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_78452->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_78471->mClassTypeName.reader_value ()))) + (GGS_string (true, "\""))) SOURCE_FILE_AT_LINE (1967)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_78452 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78452) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_78471 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_78471) ;
                                      if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                                        if (((operand_78452->mGalgasClassName.reader_value ()) != (operand_78471->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_78452->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_78471->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1974)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_78452 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78452) ;
                                        cPtr_typeGalgas_enum * operand_78471 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_78471) ;
                                        if ((operand_78452 != NULL) && (operand_78471 != NULL)) {
                                          if (((operand_78452->mEnumTypeName.reader_value ()) != (operand_78471->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_78452->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_78471->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (1981)) ;
                                          }
                                        }else{
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((var_cas_inFormalType.reader_messageGalgasType ()) + (GGS_string (true, " is not compatible with ")))) + (var_cas_inEffectiveType.reader_messageGalgasType ())) SOURCE_FILE_AT_LINE (1985)) ;
                                        }
                                      }
                                    }
                                  }
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "there are too much parameters") SOURCE_FILE_AT_LINE (2001)) ;
  }else if (((var_cas_signatureReference.reader_length ()) > (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
      var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (2003)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_82257 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_82356 = var_cas_signatureTestee.firstObject () ;
    while ((operand_82257 != NULL)
        && (operand_82356 != NULL)) {
      macroValidPointer (operand_82257) ;
      macroValidPointer (operand_82356) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_82257->mType,  operand_82356->mType,  var_cas_ouSignalerErreur SOURCE_FILE_AT_LINE (2007)) ;
      if (((operand_82257->mFormalArgumentPassingMode) != (operand_82356->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_82356->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_82356->mFormalArgumentPassingMode.reader_formalArgumentMessage ())) SOURCE_FILE_AT_LINE (2010)) ;
      }
      operand_82257 = operand_82257->nextObject () ;
      operand_82356 = operand_82356->nextObject () ;
    }
  }
}
      ...
      if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "fileExists"))).isBuiltAndTrue ()) {
          ...
          var_cas_outAccessorTypesList.addAssign_operation (var_cas_outReturnedType, GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE)) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2162)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "sint"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2173)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2184)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2198)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2209)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2220)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2234)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "value"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_location::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2248)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "length"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "list supports only 'length' reader call") SOURCE_FILE_AT_LINE (2256)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_stringset::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2275)) ;
        }
        ...
        if (((var_cas_inMethodName.reader_value ()) == (GGS_string (true, "hasKey"))).isBuiltAndTrue ()) {
          ...
          var_cas_outReturnedType = GGS_typeGalgas_uint::constructor_new (HERE) ;
            ...
            var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "this reader is not defined") SOURCE_FILE_AT_LINE (2288)) ;
        }
      }else if (dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgasClassType * operand_96875 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_96875) ; 
        GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_96875->mMessagesMap ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName SOURCE_FILE_AT_LINE (2292)) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      }else if (dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) != NULL) {
        cPtr_typeGalgas_enum * operand_97218 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
        macroValidPointer (operand_97218) ; 
        GGS_typeEnumMessageMap  var_cas_messagesMap ;
        var_cas_messagesMap = operand_97218->mMessagesMap ;
        GGS_L_lstringList  var_cas_97387 ;
        var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_97387 SOURCE_FILE_AT_LINE (2297)) ;
        var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
        var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
      }else{ // Else part
          var_cas_inMethodName.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "variables of this type do not support reader call") SOURCE_FILE_AT_LINE (2303)) ;
      }
    }
  }
}
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! (var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ())))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_99183 ;
    GGS_M_semanticsEntitiesForUse  var_cas_99192 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedMetamodelComponents, var_cas_importedOptionsComponents, var_cas_99183, var_cas_99192 SOURCE_FILE_AT_LINE (2338)) ;
    ...
    GGS_stringset::element_type * operand_99437 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_99437 != NULL)) {
      macroValidPointer (operand_99437) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioMetamodelComponentMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  var_cas_ioAlreadyImportedMetamodelComponents,  GGS_lstring::constructor_new (operand_99437->mKey, GGS_location (lexique_var_) COMMA_HERE) SOURCE_FILE_AT_LINE (2352)) ;
      operand_99437 = operand_99437->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_99802 = var_cas_modelMap.firstObject () ;
    while ((operand_99802 != NULL)) {
      macroValidPointer (operand_99802) ;
      if (((! (var_cas_ioModelMap.reader_hasKey (operand_99802->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_99802->mKey, operand_99802->mInfo.mType SOURCE_FILE_AT_LINE (2364)) ;
      }
      operand_99802 = operand_99802->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_100015 = var_cas_actionMap.firstObject () ;
    while ((operand_100015 != NULL)) {
      macroValidPointer (operand_100015) ;
      if (((! (var_cas_ioActionMap.reader_hasKey (operand_100015->mKey.reader_value ())))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_100015->mKey, operand_100015->mInfo.mSignature, operand_100015->mInfo.mIsExtern SOURCE_FILE_AT_LINE (2370)) ;
      }
      operand_100015 = operand_100015->nextObject () ;
    }
...
void routine_buildSuperEntitySet (C_Lexique & lexique_var_,
  ...
  if (((((var_cas_inSuperEntityName.reader_value ()) != (GGS_string (true, ""))) && ((! (var_cas_ioSuperEntitySet.reader_hasKey (var_cas_inSuperEntityName.reader_value ())))))).isBuiltAndTrue ()) {
    ...
    GGS_entityPropertyMap  var_cas_100818 ;
    GGS_bool var_cas_100821 ;
    GGS_entityPropertyMap  var_cas_100824 ;
    GGS_contextPropertyMap  var_cas_100844 ;
    GGS_fetchedPropertyMap  var_cas_100847 ;
    GGS_fetchedPropertyMap  var_cas_100850 ;
    GGS_insertedPropertyMap  var_cas_100853 ;
    GGS_insertedPropertyMap  var_cas_100856 ;
    GGS_relationMap  var_cas_100859 ;
    GGS_relationMap  var_cas_100862 ;
    GGS_indexMap  var_cas_100865 ;
    GGS_indexMap  var_cas_100868 ;
    var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_inSuperEntityName, var_cas_100818, var_cas_100821, var_cas_100824, var_cas_superEntityName, var_cas_100844, var_cas_100847, var_cas_100850, var_cas_100853, var_cas_100856, var_cas_100859, var_cas_100862, var_cas_100865, var_cas_100868 SOURCE_FILE_AT_LINE (2388)) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_superEntityName,  var_cas_ioSuperEntitySet SOURCE_FILE_AT_LINE (2389)) ;
  }
}
...
void routine_checkPath (C_Lexique & lexique_var_,
  ...
  GGS_L_propertyPath::element_type * operand_101589 = var_cas_inPath.firstObject () ;
  while ((operand_101589 != NULL)) {
    macroValidPointer (operand_101589) ;
    GGS_string var_cas_entityTypeName ;
    var_cas_entityTypeName = operand_101589->mPathElement.reader_value ().reader_pathExtension () ;
    if (((var_cas_entityTypeName) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      var_cas_actualEntityName = GGS_lstring::constructor_new (var_cas_entityTypeName, operand_101589->mPathElement.reader_location () COMMA_HERE) ;
      ::routine_buildSuperEntitySet (lexique_var_,  var_cas_ioEntityMap,  var_cas_actualEntityName,  var_cas_superEntitySet SOURCE_FILE_AT_LINE (2415)) ;
      if (((! (var_cas_superEntitySet.reader_hasKey (var_cas_outTypeName.reader_value ())))).isBuiltAndTrue ()) {
          operand_101589->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, ((((GGS_string (true, "this entity is not a descendant of '@")) + (var_cas_outTypeName.reader_value ()))) + (GGS_string (true, "' entity"))) SOURCE_FILE_AT_LINE (2421)) ;
      }
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      var_cas_outTypeName = var_cas_actualEntityName ;
      var_cas_outKind = GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE) ;
      GGS_bool var_cas_102379 ;
      GGS_entityPropertyMap  var_cas_102382 ;
      GGS_lstring  var_cas_102385 ;
      GGS_contextPropertyMap  var_cas_102388 ;
      GGS_fetchedPropertyMap  var_cas_102391 ;
      GGS_fetchedPropertyMap  var_cas_102394 ;
      GGS_insertedPropertyMap  var_cas_102397 ;
      GGS_insertedPropertyMap  var_cas_102400 ;
      GGS_relationMap  var_cas_102403 ;
      GGS_relationMap  var_cas_102406 ;
      GGS_indexMap  var_cas_102409 ;
      GGS_indexMap  var_cas_102412 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_102379, var_cas_102382, var_cas_102385, var_cas_102388, var_cas_102391, var_cas_102394, var_cas_102397, var_cas_102400, var_cas_102403, var_cas_102406, var_cas_102409, var_cas_102412 SOURCE_FILE_AT_LINE (2426)) ;
    }else{
      var_cas_outLastEntityTypeName = var_cas_outTypeName ;
      GGS_L_ListOfPropertyPathes  var_cas_102541 ;
      var_cas_currentMap.methode_searchKey (lexique_var_, operand_101589->mPathElement, var_cas_outKind, var_cas_outTypeName, var_cas_102541 SOURCE_FILE_AT_LINE (2429)) ;
      if (((var_cas_outKind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))).isBuiltAndTrue ()) {
        ...
        GGS_lstring  var_cas_102709 ;
        GGS_lstring  var_cas_102712 ;
        var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_102709, var_cas_102712 SOURCE_FILE_AT_LINE (2432)) ;
        GGS_bool var_cas_102779 ;
        GGS_entityPropertyMap  var_cas_102782 ;
        GGS_lstring  var_cas_102785 ;
        GGS_contextPropertyMap  var_cas_102788 ;
        GGS_fetchedPropertyMap  var_cas_102791 ;
        GGS_fetchedPropertyMap  var_cas_102794 ;
        GGS_insertedPropertyMap  var_cas_102797 ;
        GGS_insertedPropertyMap  var_cas_102800 ;
        GGS_relationMap  var_cas_102803 ;
        GGS_relationMap  var_cas_102806 ;
        GGS_indexMap  var_cas_102809 ;
        GGS_indexMap  var_cas_102812 ;
        var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_102779, var_cas_102782, var_cas_102785, var_cas_102788, var_cas_102791, var_cas_102794, var_cas_102797, var_cas_102800, var_cas_102803, var_cas_102806, var_cas_102809, var_cas_102812 SOURCE_FILE_AT_LINE (2433)) ;
        ...
        if ((var_cas_ioMapEntityMap.reader_hasKey (var_cas_outTypeName.reader_value ())).isBuiltAndTrue ()) {
          GGS_lstring  var_cas_elementEntity ;
          GGS_lstring  var_cas_103055 ;
          GGS_lstring  var_cas_103058 ;
          var_cas_ioMapEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_elementEntity, var_cas_103055, var_cas_103058 SOURCE_FILE_AT_LINE (2437)) ;
          GGS_bool var_cas_103127 ;
          GGS_entityPropertyMap  var_cas_103130 ;
          GGS_lstring  var_cas_103133 ;
          GGS_contextPropertyMap  var_cas_103136 ;
          GGS_fetchedPropertyMap  var_cas_103139 ;
          GGS_fetchedPropertyMap  var_cas_103142 ;
          GGS_insertedPropertyMap  var_cas_103145 ;
          GGS_insertedPropertyMap  var_cas_103148 ;
          GGS_relationMap  var_cas_103151 ;
          GGS_relationMap  var_cas_103154 ;
          GGS_indexMap  var_cas_103157 ;
          GGS_indexMap  var_cas_103160 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_elementEntity, var_cas_currentMap, var_cas_103127, var_cas_103130, var_cas_103133, var_cas_103136, var_cas_103139, var_cas_103142, var_cas_103145, var_cas_103148, var_cas_103151, var_cas_103154, var_cas_103157, var_cas_103160 SOURCE_FILE_AT_LINE (2438)) ;
        }else{
          GGS_bool var_cas_103241 ;
          GGS_entityPropertyMap  var_cas_103244 ;
          GGS_lstring  var_cas_103247 ;
          GGS_contextPropertyMap  var_cas_103250 ;
          GGS_fetchedPropertyMap  var_cas_103253 ;
          GGS_fetchedPropertyMap  var_cas_103256 ;
          GGS_insertedPropertyMap  var_cas_103259 ;
          GGS_insertedPropertyMap  var_cas_103262 ;
          GGS_relationMap  var_cas_103265 ;
          GGS_relationMap  var_cas_103268 ;
          GGS_indexMap  var_cas_103271 ;
          GGS_indexMap  var_cas_103274 ;
          var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_outTypeName, var_cas_currentMap, var_cas_103241, var_cas_103244, var_cas_103247, var_cas_103250, var_cas_103253, var_cas_103256, var_cas_103259, var_cas_103262, var_cas_103265, var_cas_103268, var_cas_103271, var_cas_103274 SOURCE_FILE_AT_LINE (2440)) ;
        }
      }
    }
    operand_101589 = operand_101589->nextObject () ;
  }
}
