...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature_ForGrammarComponent::element_type * operand_35107 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature_ForGrammarComponent::element_type * operand_35206 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_35107 != NULL)
        && (operand_35206 != NULL)) {
      macroValidPointer (operand_35107) ;
      macroValidPointer (operand_35206) ;
      if (((operand_35107->mFormalArgumentPassingMode) != (operand_35206->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_35206->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_35107->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_35107->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_35107->mGalgasTypeName.reader_value ()) != (operand_35206->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_35206->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_35107->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_35206->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_35107 = operand_35107->nextObject () ;
      operand_35206 = operand_35206->nextObject () ;
    }
  }
}
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_52991 = mNonExternAttributesList.firstObject () ;
  while ((operand_52991 != NULL)) {
    macroValidPointer (operand_52991) ;
    var_cas_outForeachList.addAssign_operation (operand_52991->mAttributType, operand_52991->aNomAttribut) ;
    operand_52991 = operand_52991->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle () ;
}
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_59613 = var_cas_inFormalType () ;
    cPtr_AC_galgasType * ptr_59632 = var_cas_inEffectiveType () ;
    cPtr_typeGalgas_stringset * operand_59613 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59613) ;
    cPtr_typeGalgas_stringset * operand_59632 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_59632) ;
    if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_59613 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59613) ;
      cPtr_typeGalgas_uint * operand_59632 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_59632) ;
      if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_59613 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59613) ;
        cPtr_typeGalgas_sint * operand_59632 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_59632) ;
        if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_59613 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59613) ;
          cPtr_typeGalgas_char * operand_59632 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_59632) ;
          if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_59613 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59613) ;
            cPtr_typeGalgas_string * operand_59632 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_59632) ;
            if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_59613 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59613) ;
              cPtr_typeGalgas_bool * operand_59632 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_59632) ;
              if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_59613 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59613) ;
                cPtr_typeGalgas_double * operand_59632 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_59632) ;
                if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_59613 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59613) ;
                  cPtr_typeGalgas_lbool * operand_59632 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_59632) ;
                  if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_59613 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59613) ;
                    cPtr_typeGalgas_lchar * operand_59632 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_59632) ;
                    if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_59613 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59613) ;
                      cPtr_typeGalgas_luint * operand_59632 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_59632) ;
                      if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_59613 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59613) ;
                        cPtr_typeGalgas_lsint * operand_59632 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_59632) ;
                        if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_59613 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59613) ;
                          cPtr_typeGalgas_ldouble * operand_59632 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_59632) ;
                          if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_59613 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59613) ;
                            cPtr_typeGalgas_lstring * operand_59632 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_59632) ;
                            if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_59613 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59613) ;
                              cPtr_typeGalgas_location * operand_59632 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_59632) ;
                              if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_59613 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59613) ;
                                cPtr_typeGalgasUndefinedListType * operand_59632 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_59632) ;
                                if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                                  if (((operand_59613->mListTypeName.reader_value ()) != (operand_59632->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_59613->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_59632->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_59613 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59613) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_59632 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_59632) ;
                                  if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                                    if (((operand_59613->mMapTypeName.reader_value ()) != (operand_59632->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_59613->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_59632->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_59613 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59613) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_59632 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_59632) ;
                                    if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                                      if (((operand_59613->mClassTypeName.reader_value ()) != (operand_59632->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_59613->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_59632->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_59613 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59613) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_59632 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_59632) ;
                                      if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                                        if (((operand_59613->mGalgasClassName.reader_value ()) != (operand_59632->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_59613->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_59632->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_59613 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59613) ;
                                        cPtr_typeGalgas_enum * operand_59632 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_59632) ;
                                        if ((operand_59613 != NULL) && (operand_59632 != NULL)) {
                                          if (((operand_59613->mEnumTypeName.reader_value ()) != (operand_59632->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_59613->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_59632->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_63414 = var_cas_signatureReference.firstObject () ;
    GGS_L_signature::element_type * operand_63513 = var_cas_signatureTestee.firstObject () ;
    while ((operand_63414 != NULL)
        && (operand_63513 != NULL)) {
      macroValidPointer (operand_63414) ;
      macroValidPointer (operand_63513) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_63414->mType,  operand_63513->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_63414->mFormalArgumentPassingMode) != (operand_63513->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_63513->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_63513->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_63414 = operand_63414->nextObject () ;
      operand_63513 = operand_63513->nextObject () ;
    }
  }
}
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_74547 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74547) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74547->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_74880 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_74880) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_74880->mMessagesMap ;
      GGS_L_lstringList  var_cas_75045 ;
      if (var_cas_messagesMap.isBuilt ()) {
        var_cas_messagesMap ()->methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_75045) ;
      }
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty () ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new () ;
    }else{ // Else part
