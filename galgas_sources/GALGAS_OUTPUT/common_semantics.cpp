...
/* GGG_bool GGG_actualParametersPassingMode::
operator == (const GGG_actualParametersPassingMode inOperand) const {
...
/* GGG_string * GGG_actualParametersPassingMode::
...
/* GGG_bool GGG_formalArgumentPassingMode::
operator == (const GGG_formalArgumentPassingMode inOperand) const {
  return GGG_bool (isBuilt () && inOperand.isBuilt (),
                   mValue == inOperand.mValue) ;
} */
...
/* GGG_string * GGG_formalArgumentPassingMode::
...
/* elementOf_GGG_L_signature::
elementOf_GGG_L_signature (const GGG_formalArgumentPassingMode &argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_signature *) NULL ;
  mFormalArgumentPassingMode = argument_0 ;
  mGalgasTypeName = argument_1 ;
  retain (mGalgasTypeName COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_signature::
~elementOf_GGG_L_signature (void) {
  macroRelease (mGalgasTypeName, this) ;
}*/
...
/* elementOf_GGG_typeListModel::
elementOf_GGG_typeListModel (const GGG_lstring  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListModel *) NULL ;
  mTypeName = argument_0 ;
  retain (mTypeName COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListModel::
~elementOf_GGG_typeListModel (void) {
  macroRelease (mTypeName, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_enumConstantMap::
...
void GGS_enumConstantMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
...
AC_galgas_map_elementEx * GGS_enumMessageMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_enumMessageMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_constructorMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_constructorMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_readerMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_readerMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_modifierMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_modifierMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_classMessageMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_classMessageMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_ModelMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_ModelMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_ActionMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_ActionMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* GGG_bool GGG_localConstantBuildStyleEnum::
operator == (const GGG_localConstantBuildStyleEnum inOperand) const {
  return GGG_bool (isBuilt () && inOperand.isBuilt (),
                   mValue == inOperand.mValue) ;
} */
...
//---------------------------------------------------------------------------*
//                                                                           *
//                class map 'entityAttributeAndReferenceMap'                 *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_entityAttributeAndReferenceMap::
elementOf_GGS_entityAttributeAndReferenceMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
AC_galgas_map_elementEx * GGS_entityAttributeAndReferenceMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_entityAttributeAndReferenceMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_elementEx * p = NULL ;
  e_entityAttributeAndReferenceMap * info = (e_entityAttributeAndReferenceMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_entityAttributeAndReferenceMap GGS_entityAttributeAndReferenceMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_entityAttributeAndReferenceMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_entityAttributeAndReferenceMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void GGS_entityAttributeAndReferenceMap::
insertElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
               GGS_luint * outIndex) {
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_entityAttributeAndReferenceMap info  ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
void GGS_entityAttributeAndReferenceMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey) {
  searchElement (inLexique,
                 "the '%K' attribute or reference is not declared",
                 inKey,
                 NULL) ;
}
...
void GGS_entityAttributeAndReferenceMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey) {
  insertElement (lexique_var_,
                 "the '%K' attribute or reference has been already declared in %L",
                 inKey,
                 NULL) ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      class map 'entityAttributeMap'                       *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_entityAttributeMap::
elementOf_GGS_entityAttributeMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
AC_galgas_map_elementEx * GGS_entityAttributeMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_entityAttributeMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_elementEx * p = NULL ;
  e_entityAttributeMap * info = (e_entityAttributeMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_entityAttributeMap GGS_entityAttributeMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_entityAttributeMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_entityAttributeMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void GGS_entityAttributeMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0) {
  searchElement (inLexique,
...
void GGS_entityAttributeMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the '%K' attribute has been already declared in %L",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                   class map 'entitySingleReferenceMap'                    *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_entitySingleReferenceMap::
elementOf_GGS_entitySingleReferenceMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
AC_galgas_map_elementEx * GGS_entitySingleReferenceMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_entitySingleReferenceMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_elementEx * p = NULL ;
  e_entitySingleReferenceMap * info = (e_entitySingleReferenceMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_entitySingleReferenceMap GGS_entitySingleReferenceMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_entitySingleReferenceMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_entitySingleReferenceMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void GGS_entitySingleReferenceMap::
insertElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
               const GGS_lstring &  inParameter0,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_entitySingleReferenceMap info  ;
    info.mSingleReferenceType = inParameter0 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mSingleReferenceType ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_entitySingleReferenceMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0) {
  searchElement (inLexique,
                 "the '%K' single reference is not declared",
                 inKey,
                 outParameter0,
                 NULL) ;
}
...
void GGS_entitySingleReferenceMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the '%K' single reference has been already declared in %L",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                  class map 'entityMultipleReferenceMap'                   *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_entityMultipleReferenceMap::
elementOf_GGS_entityMultipleReferenceMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
AC_galgas_map_elementEx * GGS_entityMultipleReferenceMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_entityMultipleReferenceMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_elementEx * p = NULL ;
  e_entityMultipleReferenceMap * info = (e_entityMultipleReferenceMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_entityMultipleReferenceMap GGS_entityMultipleReferenceMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_entityMultipleReferenceMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_entityMultipleReferenceMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void GGS_entityMultipleReferenceMap::
insertElement (C_Lexique & inLexique,
               const char * inErrorMessage,
               const GGS_lstring & inKey,
               const GGS_lstring &  inParameter0,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_entityMultipleReferenceMap info  ;
    info.mMultipleReferenceType = inParameter0 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mMultipleReferenceType ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_entityMultipleReferenceMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_lstring   & outParameter0) {
  searchElement (inLexique,
                 "the '%K' multiple reference is not declared",
                 inKey,
                 outParameter0,
                 NULL) ;
}
...
void GGS_entityMultipleReferenceMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_lstring & inParameter0) {
  insertElement (lexique_var_,
                 "the '%K' multiple reference has been already declared in %L",
                 inKey,
                 inParameter0,
                 NULL) ;
}
...
elementOf_GGS_entityMap::
elementOf_GGS_entityMap (const GGS_lstring & inKey,
              const sint32 inIndex,
...
AC_galgas_map_elementEx * GGS_entityMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_entityMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_elementEx * p = NULL ;
  e_entityMap * info = (e_entityMap *) inInfo ;
  macroMyNew (p, element_type (inKey, count (), * info)) ;
  return p ;
}
...
GGS_entityMap GGS_entityMap::constructor_empty (UNUSED_LOCATION_ARGS) {
  GGS_entityMap result ;
  macroMyNew (result.mReferenceCountPtr, sint32 (1)) ;
  return result ;
}
...
void GGS_entityMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    insulateMap () ;
    e_entityMap info  ;
    info.mIsAbstract = inParameter0 ;
    info.mSuperEntityName = inParameter1 ;
    info.mEntityAttributeMap = inParameter2 ;
    info.mSingleReferenceMap = inParameter3 ;
    info.mMultipleReferenceMap = inParameter4 ;
    info.mAllAttributeAndReferenceMap = inParameter5 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter0 = node->mInfo.mIsAbstract ;
    outParameter1 = node->mInfo.mSuperEntityName ;
    outParameter2 = node->mInfo.mEntityAttributeMap ;
    outParameter3 = node->mInfo.mSingleReferenceMap ;
    outParameter4 = node->mInfo.mMultipleReferenceMap ;
    outParameter5 = node->mInfo.mAllAttributeAndReferenceMap ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void GGS_entityMap::methode_searchKey (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_bool  & outParameter0,
                                GGS_lstring   & outParameter1,
                                GGS_entityAttributeMap   & outParameter2,
...
void GGS_entityMap::methode_insertKey (C_Lexique & lexique_var_,
                                const GGS_lstring & inKey,
                                const GGS_bool& inParameter0,
                                const GGS_lstring & inParameter1,
                                const GGS_entityAttributeMap & inParameter2,
...
/* elementOf_GGG_typeListeAttributsSemantiques::
elementOf_GGG_typeListeAttributsSemantiques (const GGG_AC_galgasType  *argument_0,
                                const GGG_lstring  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeListeAttributsSemantiques *) NULL ;
  mAttributType = argument_0 ;
  retain (mAttributType COMMA_HERE) ;
  aNomAttribut = argument_1 ;
  retain (aNomAttribut COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeListeAttributsSemantiques::
~elementOf_GGG_typeListeAttributsSemantiques (void) {
  macroRelease (mAttributType, this) ;
  macroRelease (aNomAttribut, this) ;
}*/
...
/* elementOf_GGG_typeTypesList::
elementOf_GGG_typeTypesList (const GGG_AC_galgasType  *argument_0,
                                const GGG_location  *argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_typeTypesList *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
  mEndOfExpressionLocation = argument_1 ;
  retain (mEndOfExpressionLocation COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_typeTypesList::
~elementOf_GGG_typeTypesList (void) {
  macroRelease (mType, this) ;
  macroRelease (mEndOfExpressionLocation, this) ;
}*/
...
/* elementOf_GGG_L_EXsignature::
elementOf_GGG_L_EXsignature (const GGG_AC_galgasType  *argument_0,
                                const GGG_formalArgumentPassingMode &argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_EXsignature *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
...
/* elementOf_GGG_L_EXsignature::
~elementOf_GGG_L_EXsignature (void) {
  macroRelease (mType, this) ;
}*/
...
/* elementOf_GGG_L_actualParametersSignature::
elementOf_GGG_L_actualParametersSignature (const GGG_AC_galgasType  *argument_0,
                                const GGG_actualParametersPassingMode &argument_1 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_actualParametersSignature *) NULL ;
  mType = argument_0 ;
  retain (mType COMMA_HERE) ;
  mFormalArgumentPassingMode = argument_1 ;
} */
...
/* elementOf_GGG_L_actualParametersSignature::
~elementOf_GGG_L_actualParametersSignature (void) {
  macroRelease (mType, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_M_accessors_map::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_accessors_map::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* elementOf_GGG_L_stringList::
elementOf_GGG_L_stringList (const GGG_string *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_stringList *) NULL ;
  mErrorMessageElement = argument_0 ;
  retain (mErrorMessageElement COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_stringList::
~elementOf_GGG_L_stringList (void) {
  macroRelease (mErrorMessageElement, this) ;
}*/
...
/* elementOf_GGG_L_lstringList::
elementOf_GGG_L_lstringList (const GGG_lstring  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_lstringList *) NULL ;
  mString = argument_0 ;
  retain (mString COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_lstringList::
~elementOf_GGG_L_lstringList (void) {
  macroRelease (mString, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_M_externTypeConstructorMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_externTypeConstructorMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_terminalSymbolsMapForUse::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_terminalSymbolsMapForUse::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_lexiqueComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_lexiqueComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeTableEnAvant::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableEnAvant::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_nonterminalSymbolAlts::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_nonterminalSymbolAlts::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_semanticsEntitiesForUse::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_semanticsEntitiesForUse::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_typesForGrammarComponent::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_typesForGrammarComponent::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void routine_checkSignature_ForGrammarComponent (C_Lexique & lexique_var_,
  ...
  if (((var_cas_inFormalReferenceSignature.reader_length ()) < (var_cas_inFormalTestedSignature.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_signature::element_type * operand_49098 = var_cas_inFormalReferenceSignature.firstObject () ;
    GGS_L_signature::element_type * operand_49197 = var_cas_inFormalTestedSignature.firstObject () ;
    while ((operand_49098 != NULL)
        && (operand_49197 != NULL)) {
      macroValidPointer (operand_49098) ;
      macroValidPointer (operand_49197) ;
      if (((operand_49098->mFormalArgumentPassingMode) != (operand_49197->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          operand_49197->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "Prototype has ")) + (operand_49098->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, ", and ")))) + (operand_49098->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) + (GGS_string (true, " has been found")))) ;
      }
      if (((operand_49098->mGalgasTypeName.reader_value ()) != (operand_49197->mGalgasTypeName.reader_value ())).isBuiltAndTrue ()) {
          operand_49197->mGalgasTypeName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the '@")) + (operand_49098->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type, I have got the '@")))) + (operand_49197->mGalgasTypeName.reader_value ()))) + (GGS_string (true, "' type")))) ;
      }
      operand_49098 = operand_49098->nextObject () ;
      operand_49197 = operand_49197->nextObject () ;
    }
  }
}
...
/* elementOf_GGG_L_ruleSyntaxSignature::
elementOf_GGG_L_ruleSyntaxSignature (const GGG_AC_instruction_ForGrammar  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_ruleSyntaxSignature *) NULL ;
  mInstruction = argument_0 ;
  retain (mInstruction COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_ruleSyntaxSignature::
~elementOf_GGG_L_ruleSyntaxSignature (void) {
  macroRelease (mInstruction, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_L_grammarsMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_L_grammarsMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_nonterminalSymbolAltsForGrammar::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_nonterminalSymbolAltsForGrammar::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* elementOf_GGG_L_productionRules_ForGrammarComponent::
elementOf_GGG_L_productionRules_ForGrammarComponent (const GGG_lstring  *argument_0,
                                const GGG_uint  &argument_1,
                                const GGG_L_ruleSyntaxSignature  *argument_2 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_productionRules_ForGrammarComponent *) NULL ;
  mLeftNonterminalSymbol = argument_0 ;
  retain (mLeftNonterminalSymbol COMMA_HERE) ;
...
/* elementOf_GGG_L_productionRules_ForGrammarComponent::
~elementOf_GGG_L_productionRules_ForGrammarComponent (void) {
  macroRelease (mLeftNonterminalSymbol, this) ;
...
AC_galgas_map_elementEx * GGS_M_nonTerminalSymbolsForGrammar::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_nonTerminalSymbolsForGrammar::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_syntaxComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_syntaxComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* elementOf_GGG_L_branchList_ForGrammarComponent::
elementOf_GGG_L_branchList_ForGrammarComponent (const GGG_L_ruleSyntaxSignature  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_branchList_ForGrammarComponent *) NULL ;
...
/* elementOf_GGG_L_branchList_ForGrammarComponent::
~elementOf_GGG_L_branchList_ForGrammarComponent (void) {
  macroRelease (mInstructionsList, this) ;
}*/
...
/* elementOf_GGG_L_syntaxComponents_ForGrammar::
elementOf_GGG_L_syntaxComponents_ForGrammar (const GGG_M_nonTerminalSymbolsForGrammar  *argument_0,
                                const GGG_L_productionRules_ForGrammarComponent  *argument_1,
                                const GGG_lstring  *argument_2 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_syntaxComponents_ForGrammar *) NULL ;
  mNonterminalSymbolsMap = argument_0 ;
  retain (mNonterminalSymbolsMap COMMA_HERE) ;
  mProductionRulesList = argument_1 ;
  retain (mProductionRulesList COMMA_HERE) ;
  mSyntaxComponentName = argument_2 ;
  retain (mSyntaxComponentName COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_syntaxComponents_ForGrammar::
~elementOf_GGG_L_syntaxComponents_ForGrammar (void) {
  macroRelease (mNonterminalSymbolsMap, this) ;
  macroRelease (mProductionRulesList, this) ;
  macroRelease (mSyntaxComponentName, this) ;
}*/
...
/* elementOf_GGG_L_identifiers::
elementOf_GGG_L_identifiers (const GGG_lstring  *argument_0 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_L_identifiers *) NULL ;
  aIdentificateur = argument_0 ;
  retain (aIdentificateur COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_L_identifiers::
~elementOf_GGG_L_identifiers (void) {
  macroRelease (aIdentificateur, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_typeSuperClassesMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeSuperClassesMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeClassInheritedMessagesMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeClassInheritedMessagesMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_typeSemanticAttributesMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeSemanticAttributesMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* GGG_bool GGG_lastStateEnum::
operator == (const GGG_lastStateEnum inOperand) const {
  return GGG_bool (isBuilt () && inOperand.isBuilt (),
                   mValue == inOperand.mValue) ;
} */
...
/* elementOf_GGG_lastStateList::
elementOf_GGG_lastStateList (const GGG_lstring  *argument_0,
                                const GGG_lastStateEnum &argument_1,
                                const GGG_L_stringList  *argument_2 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_lastStateList *) NULL ;
  mLastState = argument_0 ;
  retain (mLastState COMMA_HERE) ;
  mStatus = argument_1 ;
  mMessageList = argument_2 ;
  retain (mMessageList COMMA_HERE) ;
} */

//---------------------------------------------------------------------------*

/* elementOf_GGG_lastStateList::
~elementOf_GGG_lastStateList (void) {
  macroRelease (mLastState, this) ;
  macroRelease (mMessageList, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_transitionStatusMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_transitionStatusMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
/* elementOf_GGG_insertOrSearchMethodList::
elementOf_GGG_insertOrSearchMethodList (const GGG_lstring  *argument_0,
                                const GGG_string *argument_1,
                                const GGG_string *argument_2,
                                const GGG_lastStateList  *argument_3,
                                const GGG_transitionStatusMap  *argument_4,
                                const GGG_bool &argument_5 COMMA_LOCATION_ARGS)
:C_GGS_Object (THERE) {
  mNextItem = (elementOf_GGG_insertOrSearchMethodList *) NULL ;
  mMethodName = argument_0 ;
  retain (mMethodName COMMA_HERE) ;
  mErrorMessage = argument_1 ;
  retain (mErrorMessage COMMA_HERE) ;
  mFirstState = argument_2 ;
  retain (mFirstState COMMA_HERE) ;
  mLastStateList = argument_3 ;
  retain (mLastStateList COMMA_HERE) ;
  mTransitionStatusMap = argument_4 ;
  retain (mTransitionStatusMap COMMA_HERE) ;
...
/* elementOf_GGG_insertOrSearchMethodList::
~elementOf_GGG_insertOrSearchMethodList (void) {
  macroRelease (mMethodName, this) ;
  macroRelease (mErrorMessage, this) ;
  macroRelease (mFirstState, this) ;
  macroRelease (mLastStateList, this) ;
  macroRelease (mTransitionStatusMap, this) ;
}*/
...
AC_galgas_map_elementEx * GGS_typeTableBlocsDeTable::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeTableBlocsDeTable::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_mapMethodMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_mapMethodMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
methode_acceptForeachInstruction (C_Lexique & lexique_var_,
  ...
  GGS_typeListeAttributsSemantiques::element_type * operand_66305 = mNonExternAttributesList.firstObject () ;
  while ((operand_66305 != NULL)) {
    macroValidPointer (operand_66305) ;
    var_cas_outForeachList.addAssign_operation (operand_66305->mAttributType, operand_66305->aNomAttribut) ;
    operand_66305 = operand_66305->nextObject () ;
  }
  var_cas_outStyle = GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (HERE) ;
}
...
AC_galgas_map_elementEx * GGS_typeEnumMessageMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_typeEnumMessageMap::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
void routine_verifierCompatibiliteTypesSemantiques (C_Lexique & lexique_var_,
  ...
  if (var_cas_inFormalType.isBuilt () && var_cas_inEffectiveType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_72078 = var_cas_inFormalType (HERE) ;
    cPtr_AC_galgasType * ptr_72097 = var_cas_inEffectiveType (HERE) ;
    cPtr_typeGalgas_stringset * operand_72078 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72078) ;
    cPtr_typeGalgas_stringset * operand_72097 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_72097) ;
    if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_72078 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72078) ;
      cPtr_typeGalgas_uint * operand_72097 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_72097) ;
      if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_72078 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72078) ;
        cPtr_typeGalgas_sint * operand_72097 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_72097) ;
        if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_72078 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72078) ;
          cPtr_typeGalgas_char * operand_72097 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_72097) ;
          if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_72078 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72078) ;
            cPtr_typeGalgas_string * operand_72097 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_72097) ;
            if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_72078 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72078) ;
              cPtr_typeGalgas_bool * operand_72097 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_72097) ;
              if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_72078 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72078) ;
                cPtr_typeGalgas_double * operand_72097 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_72097) ;
                if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                }else{
                  cPtr_typeGalgas_lbool * operand_72078 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72078) ;
                  cPtr_typeGalgas_lbool * operand_72097 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_72097) ;
                  if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                  }else{
                    cPtr_typeGalgas_lchar * operand_72078 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72078) ;
                    cPtr_typeGalgas_lchar * operand_72097 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_72097) ;
                    if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                    }else{
                      cPtr_typeGalgas_luint * operand_72078 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72078) ;
                      cPtr_typeGalgas_luint * operand_72097 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_72097) ;
                      if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lsint * operand_72078 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72078) ;
                        cPtr_typeGalgas_lsint * operand_72097 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_72097) ;
                        if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                        }else{
                          cPtr_typeGalgas_ldouble * operand_72078 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72078) ;
                          cPtr_typeGalgas_ldouble * operand_72097 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_72097) ;
                          if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_72078 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72078) ;
                            cPtr_typeGalgas_lstring * operand_72097 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_72097) ;
                            if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                            }else{
                              cPtr_typeGalgas_location * operand_72078 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72078) ;
                              cPtr_typeGalgas_location * operand_72097 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_72097) ;
                              if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedListType * operand_72078 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72078) ;
                                cPtr_typeGalgasUndefinedListType * operand_72097 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_72097) ;
                                if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                                  if (((operand_72078->mListTypeName.reader_value ()) != (operand_72097->mListTypeName.reader_value ())).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the list type '")) + (operand_72078->mListTypeName.reader_value ()))) + (GGS_string (true, "', I have got the list type '")))) + (operand_72097->mListTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedMapType * operand_72078 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72078) ;
                                  cPtr_typeGalgasUndefinedMapType * operand_72097 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_72097) ;
                                  if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                                    if (((operand_72078->mMapTypeName.reader_value ()) != (operand_72097->mMapTypeName.reader_value ())).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the map type '")) + (operand_72078->mMapTypeName.reader_value ()))) + (GGS_string (true, "', I have got the map type '")))) + (operand_72097->mMapTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasUndefinedClassType * operand_72078 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72078) ;
                                    cPtr_typeGalgasUndefinedClassType * operand_72097 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_72097) ;
                                    if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                                      if (((operand_72078->mClassTypeName.reader_value ()) != (operand_72097->mClassTypeName.reader_value ())).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting the class type '")) + (operand_72078->mClassTypeName.reader_value ()))) + (GGS_string (true, "', I have got the class type '")))) + (operand_72097->mClassTypeName.reader_value ()))) + (GGS_string (true, "\"")))) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedExternType * operand_72078 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72078) ;
                                      cPtr_typeGalgasUndefinedExternType * operand_72097 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_72097) ;
                                      if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                                        if (((operand_72078->mGalgasClassName.reader_value ()) != (operand_72097->mGalgasClassName.reader_value ())).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_72078->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_72097->mGalgasClassName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                        }
                                      }else{
                                        cPtr_typeGalgas_enum * operand_72078 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72078) ;
                                        cPtr_typeGalgas_enum * operand_72097 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_72097) ;
                                        if ((operand_72078 != NULL) && (operand_72097 != NULL)) {
                                          if (((operand_72078->mEnumTypeName.reader_value ()) != (operand_72097->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_72078->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_72097->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' type variable")))) ;
                                          }
                                        }else{
...
void routine_verifierCompatibiliteSignatures (C_Lexique & lexique_var_,
  ...
  if (((var_cas_signatureReference.reader_length ()) < (var_cas_signatureTestee.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_L_EXsignature::element_type * operand_75883 = var_cas_signatureReference.firstObject () ;
    GGS_L_EXsignature::element_type * operand_75982 = var_cas_signatureTestee.firstObject () ;
    while ((operand_75883 != NULL)
        && (operand_75982 != NULL)) {
      macroValidPointer (operand_75883) ;
      macroValidPointer (operand_75982) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_75883->mType,  operand_75982->mType,  var_cas_ouSignalerErreur) ;
      if (((operand_75883->mFormalArgumentPassingMode) != (operand_75982->mFormalArgumentPassingMode)).isBuiltAndTrue ()) {
          var_cas_ouSignalerErreur.reader_location ().signalGGSSemanticError (lexique_var_, ((((operand_75982->mFormalArgumentPassingMode.reader_formalArgumentMessage ()) + (GGS_string (true, " is not compatible with ")))) + (operand_75982->mFormalArgumentPassingMode.reader_formalArgumentMessage ()))) ;
      }
      operand_75883 = operand_75883->nextObject () ;
      operand_75982 = operand_75982->nextObject () ;
    }
  }
}
...
AC_galgas_map_elementEx * GGS_M_cli_options::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_cli_options::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_optionComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_optionComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_grammarComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_grammarComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
AC_galgas_map_elementEx * GGS_M_semanticsComponents::
new_element (const GGS_lstring & inKey, void * inInfo) {
...
void GGS_M_semanticsComponents::internalInsertForDuplication (AC_galgas_map_elementEx * inPtr) {
  MF_Assert (reinterpret_cast <element_type *> (inPtr) != NULL, "Dynamic cast error", 0, 0) ;
  element_type * p = (element_type *) inPtr ;
  bool extension = false ; // Unused here
  sint32 index = -1 ; // Unused here
...
insertElement (C_Lexique & inLexique,
  ...
  if (isBuilt () && inKey.isBuilt ()) {
    ...
    info.mImportedOptionsComponents = inParameter3 ;
    info.mOptionsComponents = inParameter4 ;
    info.mSemanticsEntitiesMap = inParameter5 ;
    bool extension = false ; // Unused here
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, mRoot, extension, index, existingKeyLocation) ;
    if (index < 0) {
...
searchElement (C_Lexique & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter3 = node->mInfo.mImportedOptionsComponents ;
    outParameter4 = node->mInfo.mOptionsComponents ;
    outParameter5 = node->mInfo.mSemanticsEntitiesMap ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (uint32) node->mIndex), inKey) ;
    }
  }
...
void routine_handleReaderCall (C_Lexique & lexique_var_,
  ...
  if (var_cas_inReceiverType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_string *> (var_cas_inReceiverType.getPtr ()) != NULL) {
      ...
      cPtr_typeGalgasClassType * operand_87893 = dynamic_cast <cPtr_typeGalgasClassType *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_87893) ; 
      GGS_typeClassInheritedMessagesMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_87893->mMessagesMap ;
      ...
      cPtr_typeGalgas_enum * operand_88226 = dynamic_cast <cPtr_typeGalgas_enum *> (var_cas_inReceiverType.getPtr ()) ;
      macroValidPointer (operand_88226) ; 
      GGS_typeEnumMessageMap  var_cas_messagesMap ;
      var_cas_messagesMap = operand_88226->mMessagesMap ;
      GGS_L_lstringList  var_cas_88391 ;
      var_cas_messagesMap.methode_searchKey (lexique_var_, var_cas_inMethodName, var_cas_88391) ;
      var_cas_outAccessorTypesList = GGS_typeListeAttributsSemantiques::constructor_empty (HERE) ;
      var_cas_outReturnedType = GGS_typeGalgas_string::constructor_new (HERE) ;
    }else{ // Else part
...
void routine_importSemanticsComponent (C_Lexique & lexique_var_,
  ...
  if (((! var_cas_ioAlreadyImportedSemanticsComponents.reader_hasKey (var_cas_inSemanticsComponentName.reader_value ()))).isBuiltAndTrue ()) {
    ...
    GGS_M_optionComponents  var_cas_89924 ;
    GGS_M_semanticsEntitiesForUse  var_cas_89927 ;
    var_cas_ioSemanticsComponentsMap.methode_searchKey (lexique_var_, var_cas_inSemanticsComponentName, var_cas_modelMap, var_cas_actionMap, var_cas_importedSemanticsComponents, var_cas_importedOptionsComponents, var_cas_89924, var_cas_89927) ;
    GGS_stringset::element_type * operand_90028 = var_cas_importedSemanticsComponents.firstObject () ;
    while ((operand_90028 != NULL)) {
      macroValidPointer (operand_90028) ;
      ::routine_importSemanticsComponent (lexique_var_,  var_cas_ioSemanticsComponentsMap,  var_cas_ioModelMap,  var_cas_ioActionMap,  var_cas_ioAlreadyImportedSemanticsComponents,  GGS_lstring::constructor_new (operand_90028->mKey, GGS_location (lexique_var_) COMMA_HERE)) ;
      operand_90028 = operand_90028->nextObject () ;
    }
    GGS_ModelMap::element_type * operand_90312 = var_cas_modelMap.firstObject () ;
    while ((operand_90312 != NULL)) {
      macroValidPointer (operand_90312) ;
      if (((! var_cas_ioModelMap.reader_hasKey (operand_90312->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioModelMap.methode_insertKey (lexique_var_, operand_90312->mKey, operand_90312->mInfo.mType) ;
      }
      operand_90312 = operand_90312->nextObject () ;
    }
    GGS_ActionMap::element_type * operand_90525 = var_cas_actionMap.firstObject () ;
    while ((operand_90525 != NULL)) {
      macroValidPointer (operand_90525) ;
      if (((! var_cas_ioActionMap.reader_hasKey (operand_90525->mKey.reader_value ()))).isBuiltAndTrue ()) {
        var_cas_ioActionMap.methode_insertKey (lexique_var_, operand_90525->mKey, operand_90525->mInfo.mSignature, operand_90525->mInfo.mIsExtern) ;
      }
      operand_90525 = operand_90525->nextObject () ;
    }
