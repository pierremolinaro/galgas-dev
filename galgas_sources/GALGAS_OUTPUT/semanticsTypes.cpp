...
insertElement (C_Compiler & inLexique,
               ...
               const GGS_unifiedTypeMapProxyList & inParameter12,
               ...
               const GGS_mapMethodListAST & inParameter17,
               const GGS_mapMethodListAST & inParameter18,
                GGS_luint * outIndex
                COMMA_LOCATION_ARGS) {
  PMSInt32 elementID = - 1 ;
  if (isBuilt ()
...
searchElement (C_Compiler & inLexique,
               ...
               GGS_unifiedTypeMapProxyList   & outParameter12,
               ...
               GGS_mapMethodListAST   & outParameter17,
               GGS_mapMethodListAST   & outParameter18,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  cElement * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_typedAttributeList   & outParameter16,
                                GGS_mapMethodListAST   & outParameter17,
                                GGS_mapMethodListAST   & outParameter18 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
                  kSearchMessage_searchKey,
                  inKey,
                  outParameter0,
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_typedAttributeList & inParameter16,
                                const GGS_mapMethodListAST & inParameter17,
                                const GGS_mapMethodListAST & inParameter18 COMMA_LOCATION_ARGS) {
  insertElement (inLexique,
                 0,
                 kInsertMessage_insertKey,
                 inKey,
...
/* const */ GGS_mapMethodListAST  & GGS_unifiedTypeMap::cEnumerator::_mMapSearchMethodList (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mMapSearchMethodList ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_mapMethodListAST  & GGS_unifiedTypeMap::cEnumerator::_mMapProxySearchConstructorList (LOCATION_ARGS) const {
...
GGS_mapMethodListAST  GGS_unifiedTypeMapProxy::reader_mMapSearchMethodList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
...
GGS_mapMethodListAST  GGS_unifiedTypeMapProxy::reader_mMapProxySearchConstructorList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_mapMethodListAST  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
category_method__predefinedTypeAST__getSuperType (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_14900,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_unifiedTypeMapProxy  & var_cas_outSuperType
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14900 != NULL) {
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_string ("root"), var_cas_outSuperType COMMA_SOURCE_FILE_AT_LINE (321)) ;
  }
}
...
category_method__predefinedTypeAST__getConstructorMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_15244,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_constructorMap  & var_cas_outConstructorMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15244 != NULL) {
    var_cas_outConstructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (330)) ;
  }
}
...
category_method__predefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_15511,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_readerMap  & var_cas_outReaderMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15511 != NULL) {
    var_cas_outReaderMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (339)) ;
  }
}
...
category_method__predefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_15760,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_modifierMap  & var_cas_outModifierMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15760 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (348)) ;
  }
}
...
category_method__predefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16023,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16023 != NULL) {
    var_cas_outInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
}
...
category_method__predefinedTypeAST__getClassMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16307,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_classMethodMap  & var_cas_outClassMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16307 != NULL) {
    var_cas_outClassMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) ;
  }
}
...
category_reader__predefinedTypeAST__getSupportedOperatorFlags (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_16587
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__predefinedTypeAST__getAddAssignArgumentList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_16794,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
...
category_method__predefinedTypeAST__getMinusAssignArgumentList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17130,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_unifiedTypeMapProxyList  & var_cas_outAddAssignArgumentList
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__predefinedTypeAST__getNativeAttributeList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17774
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_nativeAttributeList  var_cas_outNativeAttributeList ;
  if (operand_17774 != NULL) {
...
category_method__predefinedTypeAST__getEnumerationList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_18360,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_enumerationDescriptorList  & var_cas_outEnumerationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18360 != NULL) {
