...
class cCollectionElement_unifiedTypeMapProxyList : public cCollectionElement {
  public : GALGAS_unifiedTypeMapProxyList_3A_element mObject ;
...
void cCollectionElement_unifiedTypeMapProxyList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
void GALGAS_unifiedTypeMapProxyList::modifier_prependValue (GALGAS_unifiedTypeMapProxy inOperand0
                                                            COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_unifiedTypeMapProxyList (inOperand0 COMMA_THERE)) ;
...
GALGAS_unifiedTypeMapProxyList_3A_element cEnumerator_unifiedTypeMapProxyList::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_unifiedTypeMapProxyList) ;
  return p->mObject ;
}
...
GALGAS_unifiedTypeMapProxyList GALGAS_unifiedTypeMapProxyList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_unifiedTypeMapProxyList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "unifiedTypeMapProxyList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
cMapElement_constructorMap::cMapElement_constructorMap (const GALGAS_lstring & inKey,
                                                        const GALGAS_unifiedTypeMapProxyList & in_mArgumentTypeList,
...
void cMapElement_constructorMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_constructorMap GALGAS_constructorMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_constructorMap result ;
...
void GALGAS_constructorMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_constructorMap) ;
...
GALGAS_unifiedTypeMapProxyList GALGAS_constructorMap::reader_mArgumentTypeListForKey (const GALGAS_string & inKey,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
...
void GALGAS_constructorMap::modifier_setMArgumentTypeListForKey (GALGAS_unifiedTypeMapProxyList inAttributeValue,
                                                                 GALGAS_string inKey,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
...
GALGAS_constructorMap_3A_element cEnumerator_constructorMap::current (LOCATION_ARGS) const {
  const cMapElement_constructorMap * p = (const cMapElement_constructorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_constructorMap) ;
  return GALGAS_constructorMap_3A_element (p->mAttribute_lkey, p->mAttribute_mArgumentTypeList, p->mAttribute_mHasCompilerArgument, p->mAttribute_mReturnedType) ;
}
...
GALGAS_unifiedTypeMapProxyList cEnumerator_constructorMap::current_mArgumentTypeList (LOCATION_ARGS) const {
  const cMapElement_constructorMap * p = (const cMapElement_constructorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_constructorMap) ;
...
GALGAS_constructorMap GALGAS_constructorMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_constructorMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "constructorMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_methodQualifier GALGAS_methodQualifier::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_methodQualifier *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "methodQualifier", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_methodKind GALGAS_methodKind::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_methodKind *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "methodKind", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_readerMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mKind" ":" ;
...
GALGAS_readerMap GALGAS_readerMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_readerMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_readerMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_readerMap) ;
...
GALGAS_unifiedTypeMapProxyList GALGAS_readerMap::reader_mArgumentTypeListForKey (const GALGAS_string & inKey,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_readerMap * p = (const cMapElement_readerMap *) attributes ;
...
void GALGAS_readerMap::modifier_setMArgumentTypeListForKey (GALGAS_unifiedTypeMapProxyList inAttributeValue,
                                                            GALGAS_string inKey,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_readerMap_3A_element cEnumerator_readerMap::current (LOCATION_ARGS) const {
  const cMapElement_readerMap * p = (const cMapElement_readerMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_readerMap) ;
  return GALGAS_readerMap_3A_element (p->mAttribute_lkey, p->mAttribute_mKind, p->mAttribute_mArgumentTypeList, p->mAttribute_mDeclarationLocation, p->mAttribute_mHasCompilerArgument, p->mAttribute_mReturnedType, p->mAttribute_mQualifier, p->mAttribute_mErrorMessage) ;
}
...
GALGAS_unifiedTypeMapProxyList cEnumerator_readerMap::current_mArgumentTypeList (LOCATION_ARGS) const {
  const cMapElement_readerMap * p = (const cMapElement_readerMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_readerMap) ;
  return p->mAttribute_mArgumentTypeList ;
}
...
GALGAS_readerMap GALGAS_readerMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_readerMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "readerMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
class cCollectionElement_formalParameterSignature : public cCollectionElement {
  public : GALGAS_formalParameterSignature_3A_element mObject ;
...
cCollectionElement_formalParameterSignature::cCollectionElement_formalParameterSignature (const GALGAS_unifiedTypeMapProxy & in_mFormalArgumentType,
                                                                                          ...
                                                                                          COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mFormalArgumentType, in_mFormalArgumentPassingMode) {
}
...
cCollectionElement * cCollectionElement_formalParameterSignature::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_formalParameterSignature (mObject.mAttribute_mFormalArgumentType, mObject.mAttribute_mFormalArgumentPassingMode COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

void cCollectionElement_formalParameterSignature::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_formalParameterSignature GALGAS_formalParameterSignature::constructor_listWithValue (const GALGAS_unifiedTypeMapProxy & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_formalParameterSignature::makeAttributesFromObjects (attributes, inOperand0, inOperand1 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_formalParameterSignature::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_formalParameterSignature (in_mFormalArgumentType,
                                                              in_mFormalArgumentPassingMode COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_formalParameterSignature::addAssign_operation (const GALGAS_unifiedTypeMapProxy & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_formalParameterSignature (inOperand0, inOperand1 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_formalParameterSignature::modifier_prependValue (GALGAS_unifiedTypeMapProxy inOperand0,
                                                             GALGAS_formalArgumentPassingModeAST inOperand1
                                                             COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_formalParameterSignature (inOperand0, inOperand1 COMMA_THERE)) ;
...
GALGAS_formalParameterSignature_3A_element cEnumerator_formalParameterSignature::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_formalParameterSignature) ;
  return p->mObject ;
}
...
GALGAS_formalParameterSignature GALGAS_formalParameterSignature::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_formalParameterSignature *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "formalParameterSignature", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_modifierMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mKind" ":" ;
  mAttribute_mKind.description (ioString, inIndentation) ;
...
GALGAS_modifierMap GALGAS_modifierMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_modifierMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_modifierMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_modifierMap) ;
    outArgument0 = p->mAttribute_mKind ;
...
GALGAS_modifierMap_3A_element cEnumerator_modifierMap::current (LOCATION_ARGS) const {
  const cMapElement_modifierMap * p = (const cMapElement_modifierMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_modifierMap) ;
  return GALGAS_modifierMap_3A_element (p->mAttribute_lkey, p->mAttribute_mKind, p->mAttribute_mParameterList, p->mAttribute_mHasCompilerArgument, p->mAttribute_mQualifier, p->mAttribute_mErrorMessage) ;
}
...
GALGAS_modifierMap GALGAS_modifierMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_modifierMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "modifierMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_instanceMethodMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mKind" ":" ;
  mAttribute_mKind.description (ioString, inIndentation) ;
...
GALGAS_instanceMethodMap GALGAS_instanceMethodMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_instanceMethodMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_instanceMethodMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_instanceMethodMap) ;
    outArgument0 = p->mAttribute_mKind ;
    outArgument1 = p->mAttribute_mParameterList ;
    outArgument2 = p->mAttribute_mDeclarationLocation ;
    outArgument3 = p->mAttribute_mHasCompilerArgument ;
...
GALGAS_instanceMethodMap_3A_element cEnumerator_instanceMethodMap::current (LOCATION_ARGS) const {
  const cMapElement_instanceMethodMap * p = (const cMapElement_instanceMethodMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_instanceMethodMap) ;
  return GALGAS_instanceMethodMap_3A_element (p->mAttribute_lkey, p->mAttribute_mKind, p->mAttribute_mParameterList, p->mAttribute_mDeclarationLocation, p->mAttribute_mHasCompilerArgument, p->mAttribute_mQualifier, p->mAttribute_mErrorMessage) ;
}
...
GALGAS_instanceMethodMap GALGAS_instanceMethodMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instanceMethodMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "instanceMethodMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_classMethodMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mParameterList" ":" ;
  mAttribute_mParameterList.description (ioString, inIndentation) ;
...
GALGAS_classMethodMap GALGAS_classMethodMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_classMethodMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_classMethodMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_classMethodMap) ;
...
GALGAS_classMethodMap_3A_element cEnumerator_classMethodMap::current (LOCATION_ARGS) const {
  const cMapElement_classMethodMap * p = (const cMapElement_classMethodMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_classMethodMap) ;
  return GALGAS_classMethodMap_3A_element (p->mAttribute_lkey, p->mAttribute_mParameterList, p->mAttribute_mHasCompilerArgument) ;
}
...
GALGAS_classMethodMap GALGAS_classMethodMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classMethodMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "classMethodMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_withAccessorMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_withAccessorMap GALGAS_withAccessorMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_withAccessorMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_withAccessorMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_withAccessorMap) ;
...
GALGAS_withAccessorMap_3A_element cEnumerator_withAccessorMap::current (LOCATION_ARGS) const {
  const cMapElement_withAccessorMap * p = (const cMapElement_withAccessorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_withAccessorMap) ;
  return GALGAS_withAccessorMap_3A_element (p->mAttribute_lkey, p->mAttribute_mArgumentType) ;
}
...
GALGAS_withAccessorMap GALGAS_withAccessorMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_withAccessorMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "withAccessorMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
class cCollectionElement_enumerationDescriptorList : public cCollectionElement {
  public : GALGAS_enumerationDescriptorList_3A_element mObject ;
...
void cCollectionElement_enumerationDescriptorList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void GALGAS_enumerationDescriptorList::modifier_prependValue (GALGAS_unifiedTypeMapProxy inOperand0,
...
GALGAS_enumerationDescriptorList_3A_element cEnumerator_enumerationDescriptorList::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cCollectionElement_enumerationDescriptorList) ;
  return p->mObject ;
}
...
GALGAS_enumerationDescriptorList GALGAS_enumerationDescriptorList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumerationDescriptorList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumerationDescriptorList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
class cCollectionElement_typedAttributeList : public cCollectionElement {
  public : GALGAS_typedAttributeList_3A_element mObject ;
...
void cCollectionElement_typedAttributeList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void GALGAS_typedAttributeList::modifier_prependValue (GALGAS_unifiedTypeMapProxy inOperand0,
...
GALGAS_typedAttributeList_3A_element cEnumerator_typedAttributeList::current (LOCATION_ARGS) const {
  const cCollectionElement_typedAttributeList * p = (const cCollectionElement_typedAttributeList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_typedAttributeList) ;
  return p->mObject ;
}
...
GALGAS_typedAttributeList GALGAS_typedAttributeList::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_typedAttributeList *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "typedAttributeList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_predefinedTypeKindEnum GALGAS_predefinedTypeKindEnum::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_predefinedTypeKindEnum *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "predefinedTypeKindEnum", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_typeKindEnum GALGAS_typeKindEnum::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_typeKindEnum *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "typeKindEnum", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static GALGAS_uint onceFunction_binaryAddOperator (C_Compiler * /* inCompiler */
  ...
  result_outMask = GALGAS_uint ((PMUInt32) 1U) ;
//---
...
static GALGAS_uint onceFunction_binarySubOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (249)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryMulOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 2U) COMMA_SOURCE_FILE_AT_LINE (250)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryDivOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 3U) COMMA_SOURCE_FILE_AT_LINE (251)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryModOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 4U) COMMA_SOURCE_FILE_AT_LINE (252)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryShiftOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 5U) COMMA_SOURCE_FILE_AT_LINE (253)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryPlusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 6U) COMMA_SOURCE_FILE_AT_LINE (254)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryMinusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (255)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryTildeOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 8U) COMMA_SOURCE_FILE_AT_LINE (256)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_incDecOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (257)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryAndOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 10U) COMMA_SOURCE_FILE_AT_LINE (259)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryOrOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 11U) COMMA_SOURCE_FILE_AT_LINE (260)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryXorOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 12U) COMMA_SOURCE_FILE_AT_LINE (261)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryNotOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 13U) COMMA_SOURCE_FILE_AT_LINE (262)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryConcatOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 14U) COMMA_SOURCE_FILE_AT_LINE (264)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_dotAssignOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (265)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_isComparable (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 16U) COMMA_SOURCE_FILE_AT_LINE (266)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateEnumerationHelperMethods (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 28U) COMMA_SOURCE_FILE_AT_LINE (268)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_doNotGenererateObjectCompare (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 29U) COMMA_SOURCE_FILE_AT_LINE (269)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateDescriptionReaderUtilityMethod (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 30U) COMMA_SOURCE_FILE_AT_LINE (270)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateCopyConstructorAndAssignmentOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_outMask ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outMask = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 31U) COMMA_SOURCE_FILE_AT_LINE (271)) ;
//---
  return result_outMask ;
}
...
void cMapElement_attributeMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_attributeMap GALGAS_attributeMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_attributeMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
void GALGAS_attributeMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    macroValidSharedObject (p, const cMapElement_attributeMap) ;
...
GALGAS_attributeMap_3A_element cEnumerator_attributeMap::current (LOCATION_ARGS) const {
  const cMapElement_attributeMap * p = (const cMapElement_attributeMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_attributeMap) ;
  return GALGAS_attributeMap_3A_element (p->mAttribute_lkey, p->mAttribute_mAttributeType) ;
}
...
GALGAS_attributeMap GALGAS_attributeMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_attributeMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "attributeMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
cMapElement_unifiedTypeMap::cMapElement_unifiedTypeMap (const GALGAS_lstring & inKey,
                                                        ...
                                                        const GALGAS_unifiedTypeMapProxyList & in_mAddAssignOperatorArguments,
...
cMapElement * cMapElement_unifiedTypeMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_unifiedTypeMap (mAttribute_lkey, mAttribute_mIsConcrete, mAttribute_mSuperType, mAttribute_mTypeKindEnum, mAttribute_mAllTypedAttributeList, mAttribute_mAttributeMap, mAttribute_mCurrentTypedAttributeList, mAttribute_mConstructorMap, mAttribute_mReaderMap, mAttribute_mModifierMap, mAttribute_mInstanceMethodMap, mAttribute_mClassMethodMap, mAttribute_mEnumerationDescriptor, mAttribute_mEnumeratorVariants, mAttribute_mHandledOperatorFlags, mAttribute_mAddAssignOperatorArguments, mAttribute_mEnumConstantSet, mAttribute_mEnumConstantList, mAttribute_mMapSearchMethodList, mAttribute_mMapProxySearchConstructorList, mAttribute_mWithAccessorMap, mAttribute_mGenerateHeaderInSeparateFile, mAttribute_mTypeForEnumeratedElement COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_unifiedTypeMap::modifier_insertKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_typeKindEnum inArgument2,
                                                GALGAS_typedAttributeList inArgument3,
                                                GALGAS_attributeMap inArgument4,
                                                GALGAS_typedAttributeList inArgument5,
                                                GALGAS_constructorMap inArgument6,
                                                GALGAS_readerMap inArgument7,
                                                GALGAS_modifierMap inArgument8,
                                                GALGAS_instanceMethodMap inArgument9,
                                                GALGAS_classMethodMap inArgument10,
                                                GALGAS_enumerationDescriptorList inArgument11,
                                                GALGAS_stringlist inArgument12,
                                                GALGAS_uint inArgument13,
                                                GALGAS_unifiedTypeMapProxyList inArgument14,
                                                GALGAS_stringset inArgument15,
                                                GALGAS_lstringlist inArgument16,
                                                GALGAS_mapSearchMethodListAST inArgument17,
                                                GALGAS_mapSearchMethodListAST inArgument18,
                                                GALGAS_withAccessorMap inArgument19,
                                                GALGAS_bool inArgument20,
                                                GALGAS_unifiedTypeMapProxy inArgument21,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) {
...
void GALGAS_unifiedTypeMap::method_searchKey (GALGAS_lstring inKey,
                                              ...
                                              GALGAS_typeKindEnum & outArgument2,
                                              GALGAS_typedAttributeList & outArgument3,
                                              GALGAS_attributeMap & outArgument4,
                                              GALGAS_typedAttributeList & outArgument5,
                                              GALGAS_constructorMap & outArgument6,
                                              GALGAS_readerMap & outArgument7,
                                              GALGAS_modifierMap & outArgument8,
                                              GALGAS_instanceMethodMap & outArgument9,
                                              GALGAS_classMethodMap & outArgument10,
                                              GALGAS_enumerationDescriptorList & outArgument11,
                                              GALGAS_stringlist & outArgument12,
                                              GALGAS_uint & outArgument13,
                                              GALGAS_unifiedTypeMapProxyList & outArgument14,
                                              GALGAS_stringset & outArgument15,
                                              GALGAS_lstringlist & outArgument16,
                                              GALGAS_mapSearchMethodListAST & outArgument17,
                                              GALGAS_mapSearchMethodListAST & outArgument18,
                                              GALGAS_withAccessorMap & outArgument19,
                                              GALGAS_bool & outArgument20,
                                              GALGAS_unifiedTypeMapProxy & outArgument21,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument0 = p->mAttribute_mIsConcrete ;
    outArgument1 = p->mAttribute_mSuperType ;
    outArgument2 = p->mAttribute_mTypeKindEnum ;
    outArgument3 = p->mAttribute_mAllTypedAttributeList ;
    outArgument4 = p->mAttribute_mAttributeMap ;
    outArgument5 = p->mAttribute_mCurrentTypedAttributeList ;
    outArgument6 = p->mAttribute_mConstructorMap ;
    outArgument7 = p->mAttribute_mReaderMap ;
    outArgument8 = p->mAttribute_mModifierMap ;
    outArgument9 = p->mAttribute_mInstanceMethodMap ;
    outArgument10 = p->mAttribute_mClassMethodMap ;
    outArgument11 = p->mAttribute_mEnumerationDescriptor ;
    outArgument12 = p->mAttribute_mEnumeratorVariants ;
    outArgument13 = p->mAttribute_mHandledOperatorFlags ;
    outArgument14 = p->mAttribute_mAddAssignOperatorArguments ;
    outArgument15 = p->mAttribute_mEnumConstantSet ;
    outArgument16 = p->mAttribute_mEnumConstantList ;
    outArgument17 = p->mAttribute_mMapSearchMethodList ;
    outArgument18 = p->mAttribute_mMapProxySearchConstructorList ;
    outArgument19 = p->mAttribute_mWithAccessorMap ;
...
GALGAS_unifiedTypeMapProxyList GALGAS_unifiedTypeMap::reader_mAddAssignOperatorArgumentsForKey (const GALGAS_string & inKey,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_unifiedTypeMap * p = (const cMapElement_unifiedTypeMap *) attributes ;
...
void GALGAS_unifiedTypeMap::modifier_setMAddAssignOperatorArgumentsForKey (GALGAS_unifiedTypeMapProxyList inAttributeValue,
                                                                           GALGAS_string inKey,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_unifiedTypeMapProxyList cEnumerator_unifiedTypeMap::current_mAddAssignOperatorArguments (LOCATION_ARGS) const {
  const cMapElement_unifiedTypeMap * p = (const cMapElement_unifiedTypeMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_unifiedTypeMap) ;
...
GALGAS_unifiedTypeMap GALGAS_unifiedTypeMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_unifiedTypeMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "unifiedTypeMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (GALGAS_unifiedTypeMap & ioMap,
                                                                GALGAS_string inKey,
...
GALGAS_unifiedTypeMapProxyList GALGAS_unifiedTypeMapProxy::reader_mAddAssignOperatorArguments (C_Compiler * inCompiler
                                                                                               COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMapProxyList result ;
...
GALGAS_unifiedTypeMapProxy GALGAS_unifiedTypeMapProxy::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_unifiedTypeMapProxy *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "unifiedTypeMapProxy", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_semanticDeclarationAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_predefinedTypeAST) ;
}
...
GALGAS_string GALGAS_predefinedTypeAST::reader_mPredefinedTypeName (UNUSED_LOCATION_ARGS) const {
  ...
  if (NULL != mObjectPtr) {
    ...
    macroValidSharedObject (p, const cPtr_predefinedTypeAST) ;
...
cPtr_predefinedTypeAST::cPtr_predefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
...
GALGAS_predefinedTypeAST GALGAS_predefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_predefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "predefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_applicationPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_applicationPredefinedTypeAST) ;
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_applicationPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_applicationPredefinedTypeAST GALGAS_applicationPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
  ...
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_applicationPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_applicationPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_applicationPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
...
cPtr_applicationPredefinedTypeAST::cPtr_applicationPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                      const GALGAS_string & in_mPredefinedTypeName,
                                                                      const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                      COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
}
...
GALGAS_applicationPredefinedTypeAST GALGAS_applicationPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_applicationPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "applicationPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_binarysetPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_binarysetPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_binarysetPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_binarysetPredefinedTypeAST GALGAS_binarysetPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                      const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                      const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_binarysetPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_binarysetPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_binarysetPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_binarysetPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_binarysetPredefinedTypeAST::cPtr_binarysetPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                  const GALGAS_string & in_mPredefinedTypeName,
                                                                  const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                  COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_binarysetPredefinedTypeAST GALGAS_binarysetPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_binarysetPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "binarysetPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_boolPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_boolPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_boolPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_boolPredefinedTypeAST GALGAS_boolPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_boolPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_boolPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_boolPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_boolPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_boolPredefinedTypeAST::cPtr_boolPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_boolPredefinedTypeAST GALGAS_boolPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_boolPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "boolPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_charPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_charPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_charPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_charPredefinedTypeAST GALGAS_charPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_charPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_charPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_charPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_charPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_charPredefinedTypeAST::cPtr_charPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_charPredefinedTypeAST GALGAS_charPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_charPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "charPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_dataPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_dataPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_dataPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_dataPredefinedTypeAST GALGAS_dataPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_dataPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_dataPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_dataPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_dataPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_dataPredefinedTypeAST::cPtr_dataPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_dataPredefinedTypeAST GALGAS_dataPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_dataPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "dataPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_doublePredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_doublePredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_doublePredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_doublePredefinedTypeAST GALGAS_doublePredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_doublePredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_doublePredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_doublePredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_doublePredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_doublePredefinedTypeAST::cPtr_doublePredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                            const GALGAS_string & in_mPredefinedTypeName,
                                                            const GALGAS_predefinedTypeKindEnum & in_mKind
                                                            COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_doublePredefinedTypeAST GALGAS_doublePredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_doublePredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "doublePredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_filewrapperPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_filewrapperPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_filewrapperPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_filewrapperPredefinedTypeAST GALGAS_filewrapperPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                          const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                          const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_filewrapperPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_filewrapperPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_filewrapperPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_filewrapperPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_filewrapperPredefinedTypeAST::cPtr_filewrapperPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                      const GALGAS_string & in_mPredefinedTypeName,
                                                                      const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                      COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_filewrapperPredefinedTypeAST GALGAS_filewrapperPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_filewrapperPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "filewrapperPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_functionPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_functionPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_functionPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_functionPredefinedTypeAST GALGAS_functionPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                    const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                    const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_functionPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_functionPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_functionPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_functionPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_functionPredefinedTypeAST::cPtr_functionPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                const GALGAS_string & in_mPredefinedTypeName,
                                                                const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_functionPredefinedTypeAST GALGAS_functionPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_functionPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "functionPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_locationPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_locationPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_locationPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_locationPredefinedTypeAST GALGAS_locationPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                    const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                    const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_locationPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_locationPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_locationPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_locationPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_locationPredefinedTypeAST::cPtr_locationPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                const GALGAS_string & in_mPredefinedTypeName,
                                                                const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_locationPredefinedTypeAST GALGAS_locationPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_locationPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "locationPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_objectPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_objectPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_objectPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_objectPredefinedTypeAST GALGAS_objectPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_objectPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_objectPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_objectPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_objectPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_objectPredefinedTypeAST::cPtr_objectPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                            const GALGAS_string & in_mPredefinedTypeName,
                                                            const GALGAS_predefinedTypeKindEnum & in_mKind
                                                            COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_objectPredefinedTypeAST GALGAS_objectPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_objectPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "objectPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_sint_36__34_PredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_sint_36__34_PredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_sint_36__34_PredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_sint_36__34_PredefinedTypeAST GALGAS_sint_36__34_PredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_sint_36__34_PredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_sint_36__34_PredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_sint_36__34_PredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_sint_36__34_PredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_sint_36__34_PredefinedTypeAST::cPtr_sint_36__34_PredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_sint_36__34_PredefinedTypeAST GALGAS_sint_36__34_PredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_sint_36__34_PredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "sint64PredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_sintPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_sintPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_sintPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_sintPredefinedTypeAST GALGAS_sintPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_sintPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_sintPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_sintPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_sintPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_sintPredefinedTypeAST::cPtr_sintPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_sintPredefinedTypeAST GALGAS_sintPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_sintPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "sintPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_stringPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_stringPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_stringPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_stringPredefinedTypeAST GALGAS_stringPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_stringPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_stringPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_stringPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_stringPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_stringPredefinedTypeAST::cPtr_stringPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                            const GALGAS_string & in_mPredefinedTypeName,
                                                            const GALGAS_predefinedTypeKindEnum & in_mKind
                                                            COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_stringPredefinedTypeAST GALGAS_stringPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_stringPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "stringPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_stringsetPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_stringsetPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_stringsetPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_stringsetPredefinedTypeAST GALGAS_stringsetPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                      const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                      const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_stringsetPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_stringsetPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_stringsetPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_stringsetPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_stringsetPredefinedTypeAST::cPtr_stringsetPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                  const GALGAS_string & in_mPredefinedTypeName,
                                                                  const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                  COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_stringsetPredefinedTypeAST GALGAS_stringsetPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_stringsetPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "stringsetPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_typePredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_typePredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_typePredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_typePredefinedTypeAST GALGAS_typePredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_typePredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_typePredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_typePredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_typePredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_typePredefinedTypeAST::cPtr_typePredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_typePredefinedTypeAST GALGAS_typePredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_typePredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "typePredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_uint_36__34_PredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_uint_36__34_PredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_uint_36__34_PredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_uint_36__34_PredefinedTypeAST GALGAS_uint_36__34_PredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_uint_36__34_PredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_uint_36__34_PredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_uint_36__34_PredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_uint_36__34_PredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_uint_36__34_PredefinedTypeAST::cPtr_uint_36__34_PredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_uint_36__34_PredefinedTypeAST GALGAS_uint_36__34_PredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_uint_36__34_PredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "uint64PredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_uintPredefinedTypeAST::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_uintPredefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsGlobal.objectCompare (p->mAttribute_mIsGlobal) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_uintPredefinedTypeAST) ;
}

//---------------------------------------------------------------------------*

GALGAS_uintPredefinedTypeAST GALGAS_uintPredefinedTypeAST::constructor_new (const GALGAS_bool & inAttribute_mIsGlobal,
                                                                            const GALGAS_string & inAttribute_mPredefinedTypeName,
                                                                            const GALGAS_predefinedTypeKindEnum & inAttribute_mKind
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_uintPredefinedTypeAST result ;
  if (inAttribute_mIsGlobal.isValid () && inAttribute_mPredefinedTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_uintPredefinedTypeAST (inAttribute_mIsGlobal, inAttribute_mPredefinedTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_uintPredefinedTypeAST::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_uintPredefinedTypeAST (p->mAttribute_mIsGlobal, p->mAttribute_mPredefinedTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
cPtr_uintPredefinedTypeAST::cPtr_uintPredefinedTypeAST (const GALGAS_bool & in_mIsGlobal,
                                                        const GALGAS_string & in_mPredefinedTypeName,
                                                        const GALGAS_predefinedTypeKindEnum & in_mKind
                                                        COMMA_LOCATION_ARGS) :
cPtr_predefinedTypeAST (in_mIsGlobal, in_mPredefinedTypeName, in_mKind COMMA_THERE) {
...
GALGAS_uintPredefinedTypeAST GALGAS_uintPredefinedTypeAST::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_uintPredefinedTypeAST *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "uintPredefinedTypeAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void callCategoryMethod_getConstructorMap (const cPtr_predefinedTypeAST * inObject,
  ...
  if (NULL != inObject) {
    macroValidSharedObject (inObject, const cPtr_predefinedTypeAST) ;
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (372)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (381)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (390)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (399)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (408)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_uint categoryReader_predefinedTypeAST_getSupportedOperatorFlags (const cPtr_predefinedTypeAST * /* inObject */,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outFlags = GALGAS_uint ((PMUInt32) 0U) ;
//---
...
void callCategoryMethod_getAddAssignArgumentList (const cPtr_predefinedTypeAST * inObject,
                                                  GALGAS_unifiedTypeMap & io_ioUnifiedTypeMap,
                                                  GALGAS_unifiedTypeMapProxyList & out_outAddAssignArgumentList,
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) {
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (425)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (440)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationVariant = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (441)) ;
  //-------- @assignmentInstructionForGeneration
...
GALGAS_unifiedTypeMapProxyList_3A_element::GALGAS_unifiedTypeMapProxyList_3A_element (void) :
mAttribute_mType () {
}
...
GALGAS_unifiedTypeMapProxyList_3A_element::GALGAS_unifiedTypeMapProxyList_3A_element (const GALGAS_unifiedTypeMapProxy & inOperand0) :
mAttribute_mType (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_unifiedTypeMapProxyList_3A_element & GALGAS_unifiedTypeMapProxyList_3A_element::operator = (const GALGAS_unifiedTypeMapProxyList_3A_element & inOperand) {
...
GALGAS_unifiedTypeMapProxyList_3A_element GALGAS_unifiedTypeMapProxyList_3A_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0 
                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_unifiedTypeMapProxyList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_unifiedTypeMapProxyList_3A_element::objectCompare (const GALGAS_unifiedTypeMapProxyList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_unifiedTypeMapProxyList_3A_element::isValid (void) const {
  return mAttribute_mType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_unifiedTypeMapProxyList_3A_element::drop (void) {
  mAttribute_mType.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_unifiedTypeMapProxyList_3A_element::description (C_String & ioString,
                                                             const PMSInt32 inIndentation) const {
...
GALGAS_unifiedTypeMapProxy GALGAS_unifiedTypeMapProxyList_3A_element::reader_mType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_unifiedTypeMapProxyList_3A_element ("unifiedTypeMapProxyList:element",
                                                           NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_unifiedTypeMapProxyList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_unifiedTypeMapProxyList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_unifiedTypeMapProxyList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_unifiedTypeMapProxyList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_unifiedTypeMapProxyList_3A_element GALGAS_unifiedTypeMapProxyList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                    C_Compiler * inCompiler,
                                                                                                    const GALGAS_location & inErrorLocation
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_unifiedTypeMapProxyList_3A_element result ;
  const GALGAS_unifiedTypeMapProxyList_3A_element * p = (const GALGAS_unifiedTypeMapProxyList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_unifiedTypeMapProxyList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "unifiedTypeMapProxyList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_constructorMap_3A_element::GALGAS_constructorMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_constructorMap_3A_element::GALGAS_constructorMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_constructorMap_3A_element & GALGAS_constructorMap_3A_element::operator = (const GALGAS_constructorMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mArgumentTypeList = inOperand.mAttribute_mArgumentTypeList ;
  mAttribute_mHasCompilerArgument = inOperand.mAttribute_mHasCompilerArgument ;
  mAttribute_mReturnedType = inOperand.mAttribute_mReturnedType ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_constructorMap_3A_element GALGAS_constructorMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_unifiedTypeMapProxyList & inOperand1,
                                                                                    const GALGAS_bool & inOperand2,
                                                                                    const GALGAS_unifiedTypeMapProxy & inOperand3 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_constructorMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_constructorMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_constructorMap_3A_element::objectCompare (const GALGAS_constructorMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_constructorMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mArgumentTypeList.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mReturnedType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_constructorMap_3A_element::drop (void) {
...
void GALGAS_constructorMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_constructorMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxyList GALGAS_constructorMap_3A_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mArgumentTypeList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_constructorMap_3A_element::reader_mHasCompilerArgument (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasCompilerArgument ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxy GALGAS_constructorMap_3A_element::reader_mReturnedType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_constructorMap_3A_element ("constructorMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_constructorMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_constructorMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_constructorMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_constructorMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_constructorMap_3A_element GALGAS_constructorMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_constructorMap_3A_element result ;
  const GALGAS_constructorMap_3A_element * p = (const GALGAS_constructorMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_constructorMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "constructorMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_readerMap_3A_element::GALGAS_readerMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mKind (),
mAttribute_mArgumentTypeList (),
...
GALGAS_readerMap_3A_element::GALGAS_readerMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_readerMap_3A_element & GALGAS_readerMap_3A_element::operator = (const GALGAS_readerMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mKind = inOperand.mAttribute_mKind ;
  mAttribute_mArgumentTypeList = inOperand.mAttribute_mArgumentTypeList ;
  mAttribute_mDeclarationLocation = inOperand.mAttribute_mDeclarationLocation ;
  mAttribute_mHasCompilerArgument = inOperand.mAttribute_mHasCompilerArgument ;
  mAttribute_mReturnedType = inOperand.mAttribute_mReturnedType ;
  mAttribute_mQualifier = inOperand.mAttribute_mQualifier ;
  mAttribute_mErrorMessage = inOperand.mAttribute_mErrorMessage ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_readerMap_3A_element GALGAS_readerMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_methodKind & inOperand1,
                                                                          const GALGAS_unifiedTypeMapProxyList & inOperand2,
                                                                          const GALGAS_location & inOperand3,
                                                                          const GALGAS_bool & inOperand4,
                                                                          ...
                                                                          const GALGAS_string & inOperand7 
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_readerMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_readerMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_readerMap_3A_element::objectCompare (const GALGAS_readerMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_readerMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mKind.isValid () && mAttribute_mArgumentTypeList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mReturnedType.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_readerMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_readerMap_3A_element::description (C_String & ioString,
                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_readerMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_methodKind GALGAS_readerMap_3A_element::reader_mKind (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mKind ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxyList GALGAS_readerMap_3A_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mArgumentTypeList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_readerMap_3A_element::reader_mDeclarationLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeclarationLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_readerMap_3A_element::reader_mHasCompilerArgument (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasCompilerArgument ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxy GALGAS_readerMap_3A_element::reader_mReturnedType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedType ;
}

//---------------------------------------------------------------------------*

GALGAS_methodQualifier GALGAS_readerMap_3A_element::reader_mQualifier (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mQualifier ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_readerMap_3A_element::reader_mErrorMessage (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_readerMap_3A_element ("readerMap:element",
                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_readerMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_readerMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_readerMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_readerMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_readerMap_3A_element GALGAS_readerMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler,
                                                                        const GALGAS_location & inErrorLocation
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_readerMap_3A_element result ;
  const GALGAS_readerMap_3A_element * p = (const GALGAS_readerMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_readerMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "readerMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_formalParameterSignature_3A_element::GALGAS_formalParameterSignature_3A_element (void) :
...
GALGAS_formalParameterSignature_3A_element::GALGAS_formalParameterSignature_3A_element (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                        const GALGAS_formalArgumentPassingModeAST & inOperand1) :
...
/* GALGAS_formalParameterSignature_3A_element & GALGAS_formalParameterSignature_3A_element::operator = (const GALGAS_formalParameterSignature_3A_element & inOperand) {
  mAttribute_mFormalArgumentType = inOperand.mAttribute_mFormalArgumentType ;
  mAttribute_mFormalArgumentPassingMode = inOperand.mAttribute_mFormalArgumentPassingMode ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature_3A_element GALGAS_formalParameterSignature_3A_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                                        const GALGAS_formalArgumentPassingModeAST & inOperand1 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_formalParameterSignature_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_formalParameterSignature_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_formalParameterSignature_3A_element::objectCompare (const GALGAS_formalParameterSignature_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_formalParameterSignature_3A_element::isValid (void) const {
  return mAttribute_mFormalArgumentType.isValid () && mAttribute_mFormalArgumentPassingMode.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_formalParameterSignature_3A_element::drop (void) {
...
void GALGAS_formalParameterSignature_3A_element::description (C_String & ioString,
                                                              const PMSInt32 inIndentation) const {
...
GALGAS_unifiedTypeMapProxy GALGAS_formalParameterSignature_3A_element::reader_mFormalArgumentType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFormalArgumentType ;
}

//---------------------------------------------------------------------------*

GALGAS_formalArgumentPassingModeAST GALGAS_formalParameterSignature_3A_element::reader_mFormalArgumentPassingMode (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_formalParameterSignature_3A_element ("formalParameterSignature:element",
                                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_formalParameterSignature_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_formalParameterSignature_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_formalParameterSignature_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_formalParameterSignature_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_formalParameterSignature_3A_element GALGAS_formalParameterSignature_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                      C_Compiler * inCompiler,
                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_formalParameterSignature_3A_element result ;
  const GALGAS_formalParameterSignature_3A_element * p = (const GALGAS_formalParameterSignature_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_formalParameterSignature_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "formalParameterSignature:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_modifierMap_3A_element::GALGAS_modifierMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mKind (),
...
GALGAS_modifierMap_3A_element::GALGAS_modifierMap_3A_element (const GALGAS_lstring & inOperand0,
                                                              const GALGAS_methodKind & inOperand1,
...
/* GALGAS_modifierMap_3A_element & GALGAS_modifierMap_3A_element::operator = (const GALGAS_modifierMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mKind = inOperand.mAttribute_mKind ;
  mAttribute_mParameterList = inOperand.mAttribute_mParameterList ;
  mAttribute_mHasCompilerArgument = inOperand.mAttribute_mHasCompilerArgument ;
  mAttribute_mQualifier = inOperand.mAttribute_mQualifier ;
  mAttribute_mErrorMessage = inOperand.mAttribute_mErrorMessage ;
  return *this ;
...
GALGAS_modifierMap_3A_element GALGAS_modifierMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_methodKind & inOperand1,
                                                                              const GALGAS_formalParameterSignature & inOperand2,
                                                                              const GALGAS_bool & inOperand3,
                                                                              const GALGAS_methodQualifier & inOperand4,
                                                                              const GALGAS_string & inOperand5 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_modifierMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result = GALGAS_modifierMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_modifierMap_3A_element::objectCompare (const GALGAS_modifierMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_modifierMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mKind.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_modifierMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mKind.drop () ;
...
void GALGAS_modifierMap_3A_element::description (C_String & ioString,
                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_modifierMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_methodKind GALGAS_modifierMap_3A_element::reader_mKind (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mKind ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature GALGAS_modifierMap_3A_element::reader_mParameterList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mParameterList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_modifierMap_3A_element::reader_mHasCompilerArgument (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasCompilerArgument ;
}

//---------------------------------------------------------------------------*

GALGAS_methodQualifier GALGAS_modifierMap_3A_element::reader_mQualifier (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mQualifier ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_modifierMap_3A_element::reader_mErrorMessage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mErrorMessage ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_modifierMap_3A_element ("modifierMap:element",
                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_modifierMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_modifierMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_modifierMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_modifierMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_modifierMap_3A_element GALGAS_modifierMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler,
                                                                            const GALGAS_location & inErrorLocation
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_modifierMap_3A_element result ;
  const GALGAS_modifierMap_3A_element * p = (const GALGAS_modifierMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_modifierMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "modifierMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_instanceMethodMap_3A_element::GALGAS_instanceMethodMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mKind (),
mAttribute_mParameterList (),
mAttribute_mDeclarationLocation (),
...
GALGAS_instanceMethodMap_3A_element::GALGAS_instanceMethodMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_methodKind & inOperand1,
                                                                          const GALGAS_formalParameterSignature & inOperand2,
                                                                          const GALGAS_location & inOperand3,
                                                                          const GALGAS_bool & inOperand4,
...
/* GALGAS_instanceMethodMap_3A_element & GALGAS_instanceMethodMap_3A_element::operator = (const GALGAS_instanceMethodMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mKind = inOperand.mAttribute_mKind ;
  mAttribute_mParameterList = inOperand.mAttribute_mParameterList ;
  mAttribute_mDeclarationLocation = inOperand.mAttribute_mDeclarationLocation ;
...
GALGAS_instanceMethodMap_3A_element GALGAS_instanceMethodMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_methodKind & inOperand1,
                                                                                          const GALGAS_formalParameterSignature & inOperand2,
                                                                                          const GALGAS_location & inOperand3,
                                                                                          const GALGAS_bool & inOperand4,
                                                                                          ...
                                                                                          const GALGAS_string & inOperand6 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_instanceMethodMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_instanceMethodMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_instanceMethodMap_3A_element::objectCompare (const GALGAS_instanceMethodMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_instanceMethodMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mKind.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_instanceMethodMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mKind.drop () ;
  mAttribute_mParameterList.drop () ;
  mAttribute_mDeclarationLocation.drop () ;
...
void GALGAS_instanceMethodMap_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_instanceMethodMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_methodKind GALGAS_instanceMethodMap_3A_element::reader_mKind (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mKind ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature GALGAS_instanceMethodMap_3A_element::reader_mParameterList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mParameterList ;
}

//---------------------------------------------------------------------------*

GALGAS_location GALGAS_instanceMethodMap_3A_element::reader_mDeclarationLocation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDeclarationLocation ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_instanceMethodMap_3A_element::reader_mHasCompilerArgument (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasCompilerArgument ;
}

//---------------------------------------------------------------------------*

GALGAS_methodQualifier GALGAS_instanceMethodMap_3A_element::reader_mQualifier (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mQualifier ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_instanceMethodMap_3A_element::reader_mErrorMessage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mErrorMessage ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_instanceMethodMap_3A_element ("instanceMethodMap:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_instanceMethodMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_instanceMethodMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_instanceMethodMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_instanceMethodMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_instanceMethodMap_3A_element GALGAS_instanceMethodMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_instanceMethodMap_3A_element result ;
  const GALGAS_instanceMethodMap_3A_element * p = (const GALGAS_instanceMethodMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_instanceMethodMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "instanceMethodMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_classMethodMap_3A_element::GALGAS_classMethodMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mParameterList (),
mAttribute_mHasCompilerArgument () {
}
...
GALGAS_classMethodMap_3A_element::GALGAS_classMethodMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_classMethodMap_3A_element & GALGAS_classMethodMap_3A_element::operator = (const GALGAS_classMethodMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mParameterList = inOperand.mAttribute_mParameterList ;
  mAttribute_mHasCompilerArgument = inOperand.mAttribute_mHasCompilerArgument ;
  return *this ;
...
GALGAS_classMethodMap_3A_element GALGAS_classMethodMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_formalParameterSignature & inOperand1,
                                                                                    const GALGAS_bool & inOperand2 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classMethodMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_classMethodMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_classMethodMap_3A_element::objectCompare (const GALGAS_classMethodMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_classMethodMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mHasCompilerArgument.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_classMethodMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mParameterList.drop () ;
  mAttribute_mHasCompilerArgument.drop () ;
}
...
void GALGAS_classMethodMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_classMethodMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_formalParameterSignature GALGAS_classMethodMap_3A_element::reader_mParameterList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mParameterList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_classMethodMap_3A_element::reader_mHasCompilerArgument (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasCompilerArgument ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_classMethodMap_3A_element ("classMethodMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_classMethodMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_classMethodMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_classMethodMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_classMethodMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_classMethodMap_3A_element GALGAS_classMethodMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_classMethodMap_3A_element result ;
  const GALGAS_classMethodMap_3A_element * p = (const GALGAS_classMethodMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classMethodMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "classMethodMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_withAccessorMap_3A_element::GALGAS_withAccessorMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_withAccessorMap_3A_element::GALGAS_withAccessorMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_withAccessorMap_3A_element & GALGAS_withAccessorMap_3A_element::operator = (const GALGAS_withAccessorMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mArgumentType = inOperand.mAttribute_mArgumentType ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_withAccessorMap_3A_element GALGAS_withAccessorMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_unifiedTypeMapProxy & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_withAccessorMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_withAccessorMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_withAccessorMap_3A_element::objectCompare (const GALGAS_withAccessorMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_withAccessorMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mArgumentType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_withAccessorMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_withAccessorMap_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_withAccessorMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxy GALGAS_withAccessorMap_3A_element::reader_mArgumentType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_withAccessorMap_3A_element ("withAccessorMap:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_withAccessorMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_withAccessorMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_withAccessorMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_withAccessorMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_withAccessorMap_3A_element GALGAS_withAccessorMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_withAccessorMap_3A_element result ;
  const GALGAS_withAccessorMap_3A_element * p = (const GALGAS_withAccessorMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_withAccessorMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "withAccessorMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumerationDescriptorList_3A_element::GALGAS_enumerationDescriptorList_3A_element (void) :
...
GALGAS_enumerationDescriptorList_3A_element::GALGAS_enumerationDescriptorList_3A_element (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                          const GALGAS_string & inOperand1) :
...
/* GALGAS_enumerationDescriptorList_3A_element & GALGAS_enumerationDescriptorList_3A_element::operator = (const GALGAS_enumerationDescriptorList_3A_element & inOperand) {
  mAttribute_mEnumeratedType = inOperand.mAttribute_mEnumeratedType ;
  mAttribute_mEnumerationName = inOperand.mAttribute_mEnumerationName ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_enumerationDescriptorList_3A_element GALGAS_enumerationDescriptorList_3A_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                                          const GALGAS_string & inOperand1 
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_enumerationDescriptorList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_enumerationDescriptorList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_enumerationDescriptorList_3A_element::objectCompare (const GALGAS_enumerationDescriptorList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_enumerationDescriptorList_3A_element::isValid (void) const {
  return mAttribute_mEnumeratedType.isValid () && mAttribute_mEnumerationName.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_enumerationDescriptorList_3A_element::drop (void) {
...
void GALGAS_enumerationDescriptorList_3A_element::description (C_String & ioString,
                                                               const PMSInt32 inIndentation) const {
...
GALGAS_unifiedTypeMapProxy GALGAS_enumerationDescriptorList_3A_element::reader_mEnumeratedType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEnumeratedType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_enumerationDescriptorList_3A_element::reader_mEnumerationName (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_enumerationDescriptorList_3A_element ("enumerationDescriptorList:element",
                                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_enumerationDescriptorList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_enumerationDescriptorList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_enumerationDescriptorList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_enumerationDescriptorList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_enumerationDescriptorList_3A_element GALGAS_enumerationDescriptorList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                        C_Compiler * inCompiler,
                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_enumerationDescriptorList_3A_element result ;
  const GALGAS_enumerationDescriptorList_3A_element * p = (const GALGAS_enumerationDescriptorList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumerationDescriptorList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "enumerationDescriptorList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_typedAttributeList_3A_element::GALGAS_typedAttributeList_3A_element (void) :
...
GALGAS_typedAttributeList_3A_element::GALGAS_typedAttributeList_3A_element (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                            const GALGAS_lstring & inOperand1,
                                                                            const GALGAS_bool & inOperand2,
                                                                            const GALGAS_bool & inOperand3) :
...
/* GALGAS_typedAttributeList_3A_element & GALGAS_typedAttributeList_3A_element::operator = (const GALGAS_typedAttributeList_3A_element & inOperand) {
  mAttribute_mAttributeTypeProxy = inOperand.mAttribute_mAttributeTypeProxy ;
  mAttribute_mAttributeName = inOperand.mAttribute_mAttributeName ;
  mAttribute_mHasSetter = inOperand.mAttribute_mHasSetter ;
  mAttribute_mHasGetter = inOperand.mAttribute_mHasGetter ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_typedAttributeList_3A_element GALGAS_typedAttributeList_3A_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                            const GALGAS_lstring & inOperand1,
                                                                                            const GALGAS_bool & inOperand2,
                                                                                            const GALGAS_bool & inOperand3 
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_typedAttributeList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_typedAttributeList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_typedAttributeList_3A_element::objectCompare (const GALGAS_typedAttributeList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_typedAttributeList_3A_element::isValid (void) const {
...
void GALGAS_typedAttributeList_3A_element::drop (void) {
...
void GALGAS_typedAttributeList_3A_element::description (C_String & ioString,
                                                        const PMSInt32 inIndentation) const {
...
GALGAS_unifiedTypeMapProxy GALGAS_typedAttributeList_3A_element::reader_mAttributeTypeProxy (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeTypeProxy ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_typedAttributeList_3A_element::reader_mAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_typedAttributeList_3A_element::reader_mHasSetter (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHasSetter ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_typedAttributeList_3A_element::reader_mHasGetter (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_typedAttributeList_3A_element ("typedAttributeList:element",
                                                      NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_typedAttributeList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_typedAttributeList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_typedAttributeList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_typedAttributeList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_typedAttributeList_3A_element GALGAS_typedAttributeList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                          C_Compiler * inCompiler,
                                                                                          const GALGAS_location & inErrorLocation
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_typedAttributeList_3A_element result ;
  const GALGAS_typedAttributeList_3A_element * p = (const GALGAS_typedAttributeList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_typedAttributeList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "typedAttributeList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_attributeMap_3A_element::GALGAS_attributeMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_attributeMap_3A_element::GALGAS_attributeMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                const GALGAS_unifiedTypeMapProxy & inOperand1) :
mAttribute_lkey (inOperand0),
...
/* GALGAS_attributeMap_3A_element & GALGAS_attributeMap_3A_element::operator = (const GALGAS_attributeMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mAttributeType = inOperand.mAttribute_mAttributeType ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_attributeMap_3A_element GALGAS_attributeMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_unifiedTypeMapProxy & inOperand1 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_attributeMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_attributeMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_attributeMap_3A_element::objectCompare (const GALGAS_attributeMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_attributeMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAttributeType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_attributeMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_attributeMap_3A_element::description (C_String & ioString,
                                                  const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_attributeMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxy GALGAS_attributeMap_3A_element::reader_mAttributeType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_attributeMap_3A_element ("attributeMap:element",
                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_attributeMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_attributeMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_attributeMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_attributeMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_attributeMap_3A_element GALGAS_attributeMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_attributeMap_3A_element result ;
  const GALGAS_attributeMap_3A_element * p = (const GALGAS_attributeMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_attributeMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "attributeMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
