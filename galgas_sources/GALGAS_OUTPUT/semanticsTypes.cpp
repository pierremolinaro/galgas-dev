...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  temp_22679 = mIndexOfMapType ;
  if (temp_22679.isBuilt ()) {
    temp_22679 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (491)) ;
  }
  { const GGS_ACGalgasType _var_22933 = var_cas_t ; // CAST instruction
    if (_var_22933.getPtr () != NULL) {
      macroValidPointer (_var_22933.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_22933.getPtr ()) != NULL) {
      }else{
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_28906 = var_cas_typeMap ;
    if (temp_28906.isBuilt ()) {
      temp_28906 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (616)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29177 = var_cas_typeMap ;
    if (temp_29177.isBuilt ()) {
      temp_29177 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (623)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29447 = var_cas_typeMap ;
    if (temp_29447.isBuilt ()) {
      temp_29447 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (630)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29715 = var_cas_typeMap ;
    if (temp_29715.isBuilt ()) {
      temp_29715 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (637)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_objectlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_29983 = var_cas_typeMap ;
    if (temp_29983.isBuilt ()) {
      temp_29983 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("objectlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (644)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_30255 = var_cas_typeMap ;
    if (temp_30255.isBuilt ()) {
      temp_30255 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (651)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
