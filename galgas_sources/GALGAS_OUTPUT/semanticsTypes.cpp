...
//-----------------------------------------------------------------------------*
//                                                                             *
//                      Once function 'dotEqualOperator'                       *
//                                                                             *
//-----------------------------------------------------------------------------*

static GALGAS_uint onceFunction_dotEqualOperator (C_Compiler * /* inCompiler */
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
...
static bool gOnceFunctionResultAvailable_dotEqualOperator = false ;
static GALGAS_uint gOnceFunctionResult_dotEqualOperator ;

//-----------------------------------------------------------------------------*

GALGAS_uint function_dotEqualOperator (class C_Compiler * inCompiler
              COMMA_LOCATION_ARGS) {
  if (! gOnceFunctionResultAvailable_dotEqualOperator) {
    gOnceFunctionResult_dotEqualOperator = onceFunction_dotEqualOperator (inCompiler COMMA_THERE) ;
    gOnceFunctionResultAvailable_dotEqualOperator = true ;
  }
  return gOnceFunctionResult_dotEqualOperator ;
}

//-----------------------------------------------------------------------------*

static void releaseOnceFunctionResult_dotEqualOperator (void) {
  gOnceFunctionResult_dotEqualOperator.drop () ;
}

//-----------------------------------------------------------------------------*

C_PrologueEpilogue gEpilogueForOnceFunction_dotEqualOperator (NULL,
                                                              releaseOnceFunctionResult_dotEqualOperator) ;

//-----------------------------------------------------------------------------*
//  Function introspection                                                     *
//-----------------------------------------------------------------------------*

static const C_galgas_type_descriptor * functionArgs_dotEqualOperator [1] = {
  NULL
} ;

//-----------------------------------------------------------------------------*

static GALGAS_object functionWithGenericHeader_dotEqualOperator (C_Compiler * inCompiler,
                                                                 const cObjectArray & /* inEffectiveParameterArray */,
                                                                 const GALGAS_location & /* inErrorLocation */
                                                                 COMMA_LOCATION_ARGS) {
  return function_dotEqualOperator (inCompiler COMMA_THERE).reader_object (THERE) ;
}

//-----------------------------------------------------------------------------*

C_galgas_function_descriptor functionDescriptor_dotEqualOperator ("dotEqualOperator",
                                                                  functionWithGenericHeader_dotEqualOperator,
                                                                  & kTypeDescriptor_GALGAS_uint,
                                                                  0,
                                                                  functionArgs_dotEqualOperator) ;

//-----------------------------------------------------------------------------*
//                                                                             *
//                      Once function 'plusEgalOperator'                       *
//                                                                             *
//-----------------------------------------------------------------------------*

static GALGAS_uint onceFunction_plusEgalOperator (C_Compiler * /* inCompiler */
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
...
static bool gOnceFunctionResultAvailable_plusEgalOperator = false ;
static GALGAS_uint gOnceFunctionResult_plusEgalOperator ;

//-----------------------------------------------------------------------------*

GALGAS_uint function_plusEgalOperator (class C_Compiler * inCompiler
              COMMA_LOCATION_ARGS) {
  if (! gOnceFunctionResultAvailable_plusEgalOperator) {
    gOnceFunctionResult_plusEgalOperator = onceFunction_plusEgalOperator (inCompiler COMMA_THERE) ;
    gOnceFunctionResultAvailable_plusEgalOperator = true ;
  }
  return gOnceFunctionResult_plusEgalOperator ;
}

//-----------------------------------------------------------------------------*

static void releaseOnceFunctionResult_plusEgalOperator (void) {
  gOnceFunctionResult_plusEgalOperator.drop () ;
}

//-----------------------------------------------------------------------------*

C_PrologueEpilogue gEpilogueForOnceFunction_plusEgalOperator (NULL,
                                                              releaseOnceFunctionResult_plusEgalOperator) ;

//-----------------------------------------------------------------------------*
//  Function introspection                                                     *
//-----------------------------------------------------------------------------*

static const C_galgas_type_descriptor * functionArgs_plusEgalOperator [1] = {
  NULL
} ;

//-----------------------------------------------------------------------------*

static GALGAS_object functionWithGenericHeader_plusEgalOperator (C_Compiler * inCompiler,
                                                                 const cObjectArray & /* inEffectiveParameterArray */,
                                                                 const GALGAS_location & /* inErrorLocation */
                                                                 COMMA_LOCATION_ARGS) {
  return function_plusEgalOperator (inCompiler COMMA_THERE).reader_object (THERE) ;
}

//-----------------------------------------------------------------------------*

C_galgas_function_descriptor functionDescriptor_plusEgalOperator ("plusEgalOperator",
                                                                  functionWithGenericHeader_plusEgalOperator,
                                                                  & kTypeDescriptor_GALGAS_uint,
                                                                  0,
                                                                  functionArgs_plusEgalOperator) ;
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid ()) {
    uint32_t variant_15523 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).uintValue () ;
    bool loop_15523 = true ;
    while (loop_15523) {
      loop_15523 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid () ;
      if (loop_15523) {
        loop_15523 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).boolValue () ;
      }
      if (loop_15523 && (0 == variant_15523)) {
        loop_15523 = false ;
