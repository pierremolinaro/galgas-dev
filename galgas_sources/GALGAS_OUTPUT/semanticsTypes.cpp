...
GGS_lstringlist  GGS_unifiedTypeMapIndex::reader_mEnumConstantList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
...
GGS_typedAttributeList  GGS_unifiedTypeMapIndex::reader_mPrivateDataMemberList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_typedAttributeList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
category_method__predefinedTypeAST__getSuperType (C_Compiler & inLexique,
  ...
  if (operand_14550 != NULL) {
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("root"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_ioUnifiedTypeMap, var_cas_outSuperType COMMA_SOURCE_FILE_AT_LINE (318)) ;
  }
}
