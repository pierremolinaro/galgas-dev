...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).isValid ()) {
    uint32_t variant_15372 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).uintValue () ;
    bool loop_15372 = true ;
    while (loop_15372) {
      loop_15372 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 335)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).isValid () ;
      if (loop_15372) {
        loop_15372 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 335)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 335)).boolValue () ;
      }
