...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_methodMap ("methodMap", false, NULL) ;

//---------------------------------------------------------------------------*

elementOf_GGS_methodMap::
elementOf_GGS_methodMap (const GGS_lstring & inKey,
              const PMSInt32 inIndex,
              const e_methodMap & inInfo) :
AC_galgas_map_element (inKey, inIndex),
mInfo (inInfo) {
}
...
bool elementOf_GGS_methodMap::
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  const elementOf_GGS_methodMap * ptr = dynamic_cast <const elementOf_GGS_methodMap *> (inOperand) ;
  macroValidPointer (ptr) ;
  return (mInfo.mParameterList.operator_isEqual (ptr->mInfo.mParameterList)).boolValue ()
           && (mInfo.mHasCompilerArgument.operator_isEqual (ptr->mInfo.mHasCompilerArgument)).boolValue () ;
}
...
AC_galgas_map_element * GGS_methodMap::
new_element (const GGS_lstring & inKey, void * inInfo) {
  MF_Assert (reinterpret_cast <e_methodMap *> (inInfo) != NULL, "Dynamic cast error", 0, 0) ;
  AC_galgas_map_element * p = NULL ;
  e_methodMap * info = (e_methodMap *) inInfo ;
  macroMyNew (p, cElement (inKey, nextIndex (), * info)) ;
  return p ;
}
...
GGS_methodMap GGS_methodMap::
constructor_emptyMap (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
  GGS_methodMap result ;
  macroMyNew (result.mSharedMapRoot, cMapRoot) ;
  return result ;
}
...
GGS_bool GGS_methodMap::
operator_isEqual (const GGS_methodMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), isEqualToMap (inOperand)) ;
}
...
GGS_bool GGS_methodMap::
operator_isNotEqual (const GGS_methodMap & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToMap (inOperand)) ;
}
...
const utf32 GGS_methodMap::kSearchMessage_searchKey [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
const utf32 GGS_methodMap::kInsertMessage_insertKey [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
GGS_methodMap GGS_methodMap::
constructor_mapWithMapToOverride (C_Compiler & /* inLexique */,
                                  const GGS_methodMap & inMapToOverride
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GGS_methodMap result ; // Not Built
  if (inMapToOverride.mSharedMapRoot != NULL) {
    macroValidPointer (inMapToOverride.mSharedMapRoot) ;
    macroMyNew (result.mSharedMapRoot, cMapRoot) ;
    result.mSharedMapRoot->mNextMap = inMapToOverride.mSharedMapRoot ;
...
/* const */ GGS_formalParameterSignature  & GGS_methodMap::cEnumerator::_mParameterList (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mParameterList ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_bool & GGS_methodMap::cEnumerator::_mHasCompilerArgument (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mHasCompilerArgument ;
}

//---------------------------------------------------------------------------*

GGS_object GGS_methodMap::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_methodMap * p = NULL ;
    macroMyNew (p, GGS_methodMap (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_methodMap GGS_methodMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_methodMap result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_methodMap * p = dynamic_cast <const GGS_methodMap *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_methodMap, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_methodMap::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_methodMap ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Element of list '@enumeratedItemsWithForeachInstruction'          *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_enumeratedItemsWithForeachInstruction::
elementOf_GGS_enumeratedItemsWithForeachInstruction (const GGS_unifiedTypeMapIndex & argument_0,
...
bool elementOf_GGS_enumeratedItemsWithForeachInstruction::
isEqualToObject (const cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_enumeratedItemsWithForeachInstruction * ptr = dynamic_cast <const elementOf_GGS_enumeratedItemsWithForeachInstruction *> (inOperand) ;
    macroValidPointer (ptr) ;
...
void elementOf_GGS_enumeratedItemsWithForeachInstruction::
appendForDescription (C_String & ioString,
                      const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_enumeratedItemsWithForeachInstruction ("enumeratedItemsWithForeachInstruction", false, NULL) ;

//---------------------------------------------------------------------------*

void GGS_enumeratedItemsWithForeachInstruction::
internalAppendValues (const GGS_unifiedTypeMapIndex & argument_0,
                    const GGS_string& argument_1
                    COMMA_LOCATION_ARGS) {
  cElement * newElement = (cElement *) NULL ;
...
GGS_enumeratedItemsWithForeachInstruction GGS_enumeratedItemsWithForeachInstruction::
operator_concat (const GGS_enumeratedItemsWithForeachInstruction & inOperand) const {
  GGS_enumeratedItemsWithForeachInstruction result = * this ;
  result.dotAssign_operation (inOperand) ;
  return result ;
}
...
void GGS_enumeratedItemsWithForeachInstruction::
dotAssign_operation (const GGS_enumeratedItemsWithForeachInstruction inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      * this = inOperand ;
    }else{
      if (inOperand.count () > 0) {
        insulateList () ;
        elementOf_GGS_enumeratedItemsWithForeachInstruction * p = inOperand.firstObject () ;
        while (p != NULL) {
          macroValidPointer (p) ;
...
GGS_enumeratedItemsWithForeachInstruction  GGS_enumeratedItemsWithForeachInstruction::
constructor_emptyList (void) {
  GGS_enumeratedItemsWithForeachInstruction result ;
  result.alloc () ;
  return result ;
}
...
void GGS_enumeratedItemsWithForeachInstruction::
internalSubListWithRange (GGS_enumeratedItemsWithForeachInstruction & ioList,
                          const PMSInt32 inFirstIndex,
                          const PMSInt32 inCount) const {
  ioList.alloc () ;
  if (inCount > 0) {
...
GGS_string GGS_enumeratedItemsWithForeachInstruction::
reader_description (const PMSInt32 inIndentation) const {
  return performDescription ("@enumeratedItemsWithForeachInstruction", inIndentation) ;
}
...
GGS_unifiedTypeMapIndex  GGS_enumeratedItemsWithForeachInstruction::
...
/* const */ GGS_unifiedTypeMapIndex  & GGS_enumeratedItemsWithForeachInstruction::cEnumerator::_mEnumeratedType (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
/* const */ GGS_string & GGS_enumeratedItemsWithForeachInstruction::cEnumerator::_mEnumerationName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_object GGS_enumeratedItemsWithForeachInstruction::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_enumeratedItemsWithForeachInstruction * p = NULL ;
    macroMyNew (p, GGS_enumeratedItemsWithForeachInstruction (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_enumeratedItemsWithForeachInstruction GGS_enumeratedItemsWithForeachInstruction::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_enumeratedItemsWithForeachInstruction result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_enumeratedItemsWithForeachInstruction * p = dynamic_cast <const GGS_enumeratedItemsWithForeachInstruction *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_enumeratedItemsWithForeachInstruction, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_enumeratedItemsWithForeachInstruction::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_enumeratedItemsWithForeachInstruction ;
}
...
mMethodMap (),
mClassMethodMap (),
mEnumeratedItemsWithForeachInstruction () {
}
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mIsAbstract.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mMethodMap.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mEnumeratedItemsWithForeachInstruction.reader_description (inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  macroValidPointer (ptr) ;
  return (mInfo.mIsAbstract.operator_isEqual (ptr->mInfo.mIsAbstract)).boolValue ()
           ...
           && (mInfo.mMethodMap.operator_isEqual (ptr->mInfo.mMethodMap)).boolValue ()
           && (mInfo.mClassMethodMap.operator_isEqual (ptr->mInfo.mClassMethodMap)).boolValue ()
           && (mInfo.mEnumeratedItemsWithForeachInstruction.operator_isEqual (ptr->mInfo.mEnumeratedItemsWithForeachInstruction)).boolValue () ;
}
...
insertElement (C_Compiler & inLexique,
                ...
                const GGS_constructorMap & inParameter2,
                const GGS_readerMap & inParameter3,
                const GGS_modifierMap & inParameter4,
                const GGS_methodMap & inParameter5,
                const GGS_classMethodMap & inParameter6,
                const GGS_enumeratedItemsWithForeachInstruction & inParameter7,
                GGS_luint * outIndex
                COMMA_LOCATION_ARGS) {
  PMSInt32 elementID = - 1 ;
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    ...
    info.mConstructorMap = inParameter2 ;
    info.mReaderMap = inParameter3 ;
    info.mModifierMap = inParameter4 ;
    info.mMethodMap = inParameter5 ;
    info.mClassMethodMap = inParameter6 ;
    info.mEnumeratedItemsWithForeachInstruction = inParameter7 ;
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, elementID, existingKeyLocation) ;
    if (elementID < 0) {
      emitInsertMapSemanticErrorMessage (inLexique, inKey, inErrorMessage, existingKeyLocation COMMA_THERE) ;
...
searchElement (C_Compiler & inLexique,
               ...
               GGS_constructorMap   & outParameter2,
               GGS_readerMap   & outParameter3,
               GGS_modifierMap   & outParameter4,
               GGS_methodMap   & outParameter5,
               GGS_classMethodMap   & outParameter6,
               GGS_enumeratedItemsWithForeachInstruction   & outParameter7,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  cElement * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter2 = node->mInfo.mConstructorMap ;
    outParameter3 = node->mInfo.mReaderMap ;
    outParameter4 = node->mInfo.mModifierMap ;
    outParameter5 = node->mInfo.mMethodMap ;
    outParameter6 = node->mInfo.mClassMethodMap ;
    outParameter7 = node->mInfo.mEnumeratedItemsWithForeachInstruction ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (PMUInt32) node->mID), inKey) ;
    }
  }
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_methodMap   & outParameter5,
                                GGS_classMethodMap   & outParameter6,
                                GGS_enumeratedItemsWithForeachInstruction   & outParameter7 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
                  kSearchMessage_searchKey,
                  inKey,
                  outParameter0,
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_methodMap & inParameter5,
                                const GGS_classMethodMap & inParameter6,
                                const GGS_enumeratedItemsWithForeachInstruction & inParameter7 COMMA_LOCATION_ARGS) {
  insertElement (inLexique,
                 kInsertMessage_insertKey,
                 inKey,
                 inParameter0,
...
/* const */ GGS_bool & GGS_unifiedTypeMap::cEnumerator::_mIsAbstract (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mIsAbstract ;
}
...
/* const */ GGS_methodMap  & GGS_unifiedTypeMap::cEnumerator::_mMethodMap (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mMethodMap ;
}
...
/* const */ GGS_enumeratedItemsWithForeachInstruction  & GGS_unifiedTypeMap::cEnumerator::_mEnumeratedItemsWithForeachInstruction (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mEnumeratedItemsWithForeachInstruction ;
}
...
GGS_bool GGS_unifiedTypeMapIndex::reader_mIsAbstract (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_bool result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_methodMap  GGS_unifiedTypeMapIndex::reader_mMethodMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_methodMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_enumeratedItemsWithForeachInstruction  GGS_unifiedTypeMapIndex::reader_mEnumeratedItemsWithForeachInstruction (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_enumeratedItemsWithForeachInstruction  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
  ...
  case kRegular :
    if (mIndex.retrieve () == NULL) {
      ...
      MF_Assert (reinterpret_cast <const elementOf_GGS_unifiedTypeMap *> (mIndex.retrieve ()) != NULL, "Dynamic cast error", 0, 0) ;
      const elementOf_GGS_unifiedTypeMap * p = (const elementOf_GGS_unifiedTypeMap *) mIndex.retrieve () ;
      result = p->mInfo.mEnumeratedItemsWithForeachInstruction ;
    }
    break ;
  }
  return result ;
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  var_cas_inTypeCount COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_classPath = mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (473)) ;
  GGS_stringset  var_cas_superClassSet = GGS_stringset ::constructor_setWithString (mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (474))) ;
  ...
  GGS_uint _variant_23531 = var_cas_inTypeCount ;
  GGS_bool _condition_23531 (_variant_23531.isBuilt (), true) ;
  while (_condition_23531.isBuiltAndTrue ()) {
    _condition_23531 = ((var_cas_superClassIndex.reader_isRegular (inLexique COMMA_SOURCE_FILE_AT_LINE (479))).operator_and (var_cas_ok)).operator_and ((var_cas_circularityError).operator_not ()) ;
    if (_condition_23531.isBuiltAndTrue ()) {
      if (_variant_23531.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (499)) ;
        _condition_23531 = GGS_bool (false) ;
      }else{
        _variant_23531.decrement_operation (inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superClassName = var_cas_superClassIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
        GGS_ACGalgasType  var_cas_t = var_cas_superClassIndex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (482)) ;
        var_cas_circularityError = var_cas_superClassSet.reader_hasKey (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (484))) ;
        var_cas_superClassSet.addAssign_operation (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (485))) ;
        var_cas_classPath.appendCString (".") ;
        var_cas_classPath.dotAssign_operation (var_cas_superClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (486))) ;
        GGS_typeMapIndex  var_cas_superSuperClassIndex ;
        { const GGS_ACGalgasType _var_23468 = var_cas_t ; // CAST instruction
          if (_var_23468.getPtr () != NULL) {
            macroValidPointer (_var_23468.getPtr ()) ;
            if (dynamic_cast <cPtr_classGalgasType *> (_var_23468.getPtr ()) != NULL) {
              const GGS_classGalgasType var_cas_kClassType (_var_23468.getPtr ()) ;
              var_cas_superSuperClassIndex = var_cas_kClassType.reader_mSuperClassIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (491)) ;
            }else{
              mClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this class inherits from @")).operator_concat (var_cas_superClassName)).operator_concat (GGS_string (", but @"))).operator_concat (var_cas_superClassName)).operator_concat (GGS_string (" is not a class")) COMMA_SOURCE_FILE_AT_LINE (497)) ;
  ...
  const GGS_bool cond_23778 = var_cas_circularityError ;
  if (cond_23778.isBuiltAndTrue ()) {
    mClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("inheritance circularity for class '")).operator_concat (mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (504)))).operator_concat (GGS_string ("': "))).operator_concat (var_cas_classPath.reader_stringByReplacingStringByString (inLexique, GGS_string ("."), GGS_string (" extends ") COMMA_SOURCE_FILE_AT_LINE (505))) COMMA_SOURCE_FILE_AT_LINE (506)) ;
  }
}
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  /* var_cas_inTypeCount */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring  var_cas_listTypeName = mAssociatedListTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (533)) ;
  GGS_ACGalgasType  var_cas_t = mAssociatedListTypeIndex.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
  { const GGS_ACGalgasType _var_25293 = var_cas_t ; // CAST instruction
    if (_var_25293.getPtr () != NULL) {
      macroValidPointer (_var_25293.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_25293.getPtr ()) != NULL) {
      }else{
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
                                GGS_uint  /* var_cas_inTypeCount */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring  var_cas_mapTypeName = mIndexOfMapType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (616)) ;
  GGS_ACGalgasType  var_cas_t = mIndexOfMapType.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (617)) ;
  { const GGS_ACGalgasType _var_28642 = var_cas_t ; // CAST instruction
    if (_var_28642.getPtr () != NULL) {
      macroValidPointer (_var_28642.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_28642.getPtr ()) != NULL) {
      }else{
...
void routine_addTypeList (C_Compiler & inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inElementTypeName, GGS_location (inLexique) COMMA_HERE), var_cas_ioTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (668)) ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (inLexique, var_cas_lstringlist, GGS_listGalgasType ::constructor_new (inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (671)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_typeMap  function_constructPrimitiveTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_typeMap  var_cas_outTypeMap ;
    ...
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_HERE), GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (679)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_HERE), GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (680)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_HERE), GGS_boolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (681)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_HERE), GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (682)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint"), GGS_location (inLexique) COMMA_HERE), GGS_sintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (683)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64"), GGS_location (inLexique) COMMA_HERE), GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (684)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint64"), GGS_location (inLexique) COMMA_HERE), GGS_sint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (685)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("double"), GGS_location (inLexique) COMMA_HERE), GGS_doubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (686)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_HERE), GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (687)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_HERE), GGS_lcharGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (688)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_HERE), GGS_lboolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (689)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_HERE), GGS_luintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (690)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_HERE), GGS_lsintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (691)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_HERE), GGS_luint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (692)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_HERE), GGS_lsint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (693)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_HERE), GGS_ldoubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (694)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("binaryset"), GGS_location (inLexique) COMMA_HERE), GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (695)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringset"), GGS_location (inLexique) COMMA_HERE), GGS_stringsetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (696)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_HERE), GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (697)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("data"), GGS_location (inLexique) COMMA_HERE), GGS_dataGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (698)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("type"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (699)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("function"), GGS_location (inLexique) COMMA_HERE), GGS_functionGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (700)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("object"), GGS_location (inLexique) COMMA_HERE), GGS_objectGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (701)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_typeMap  function_constructBuiltinTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_constructBuiltinTypeMap) {
    ...
    #endif
  GGS_typeMap  var_cas_outTypeMap ;
    var_cas_outTypeMap = function_constructPrimitiveTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (707)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("lstring"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (709)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("string"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (711)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("type"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (713)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint64"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (715)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("luint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (717)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (719)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("function"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (721)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("object"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (723)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (741)) ;
    const GGS_typeMap  temp_34615 = var_cas_typeMap ;
    if (temp_34615.isBuilt ()) {
      temp_34615 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (742)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_stringlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (748)) ;
    const GGS_typeMap  temp_34886 = var_cas_typeMap ;
    if (temp_34886.isBuilt ()) {
      temp_34886 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (749)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_uint64list_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (755)) ;
    const GGS_typeMap  temp_35156 = var_cas_typeMap ;
    if (temp_35156.isBuilt ()) {
      temp_35156 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (756)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_typelist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (762)) ;
    const GGS_typeMap  temp_35424 = var_cas_typeMap ;
    if (temp_35424.isBuilt ()) {
      temp_35424 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (763)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_objectlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_objectlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (769)) ;
    const GGS_typeMap  temp_35692 = var_cas_typeMap ;
    if (temp_35692.isBuilt ()) {
      temp_35692 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("objectlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (770)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_functionlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (776)) ;
    const GGS_typeMap  temp_35964 = var_cas_typeMap ;
    if (temp_35964.isBuilt ()) {
      temp_35964 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (777)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
