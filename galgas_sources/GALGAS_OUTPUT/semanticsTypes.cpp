...
//                                         september 25th, 2014, at 11h55'14"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid ()) {
    uint32_t variant_15267 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).uintValue () ;
    bool loop_15267 = true ;
    while (loop_15267) {
      loop_15267 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid () ;
      if (loop_15267) {
        loop_15267 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).boolValue () ;
      }
