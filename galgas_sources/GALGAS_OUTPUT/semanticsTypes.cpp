...
//-----------------------------------------------------------------------------*
//                                                                             *
//               Once function 'plusEqualOperatorWithFieldList'                *
//                                                                             *
//-----------------------------------------------------------------------------*

static GALGAS_uint onceFunction_plusEqualOperatorWithFieldList (C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
...
static bool gOnceFunctionResultAvailable_plusEqualOperatorWithFieldList = false ;
static GALGAS_uint gOnceFunctionResult_plusEqualOperatorWithFieldList ;

//-----------------------------------------------------------------------------*

GALGAS_uint function_plusEqualOperatorWithFieldList (class C_Compiler * inCompiler
              COMMA_LOCATION_ARGS) {
  if (! gOnceFunctionResultAvailable_plusEqualOperatorWithFieldList) {
    gOnceFunctionResult_plusEqualOperatorWithFieldList = onceFunction_plusEqualOperatorWithFieldList (inCompiler COMMA_THERE) ;
    gOnceFunctionResultAvailable_plusEqualOperatorWithFieldList = true ;
  }
  return gOnceFunctionResult_plusEqualOperatorWithFieldList ;
}

//-----------------------------------------------------------------------------*

static void releaseOnceFunctionResult_plusEqualOperatorWithFieldList (void) {
  gOnceFunctionResult_plusEqualOperatorWithFieldList.drop () ;
}

//-----------------------------------------------------------------------------*

C_PrologueEpilogue gEpilogueForOnceFunction_plusEqualOperatorWithFieldList (NULL,
                                                                            releaseOnceFunctionResult_plusEqualOperatorWithFieldList) ;

//-----------------------------------------------------------------------------*
//  Function introspection                                                     *
//-----------------------------------------------------------------------------*

static const C_galgas_type_descriptor * functionArgs_plusEqualOperatorWithFieldList [1] = {
  NULL
} ;

//-----------------------------------------------------------------------------*

static GALGAS_object functionWithGenericHeader_plusEqualOperatorWithFieldList (C_Compiler * inCompiler,
                                                                               const cObjectArray & /* inEffectiveParameterArray */,
                                                                               const GALGAS_location & /* inErrorLocation */
                                                                               COMMA_LOCATION_ARGS) {
  return function_plusEqualOperatorWithFieldList (inCompiler COMMA_THERE).reader_object (THERE) ;
}

//-----------------------------------------------------------------------------*

C_galgas_function_descriptor functionDescriptor_plusEqualOperatorWithFieldList ("plusEqualOperatorWithFieldList",
                                                                                functionWithGenericHeader_plusEqualOperatorWithFieldList,
                                                                                & kTypeDescriptor_GALGAS_uint,
                                                                                0,
                                                                                functionArgs_plusEqualOperatorWithFieldList) ;
...
static GALGAS_uint onceFunction_isComparable (C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 17U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 272)) ;
//---
  return result_outMask ;
}
...
void GALGAS_unifiedTypeMap::method_searchKey (GALGAS_lstring inKey,
                                              ...
                                              GALGAS_withAccessorMap & outArgument21,
                                              GALGAS_bool & outArgument22,
                                              GALGAS_unifiedTypeMapProxy & outArgument23,
                                              GALGAS_string & outArgument24,
                                              GALGAS_string & outArgument25,
                                              GALGAS_headerKind & outArgument26,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument21 = p->mAttribute_mWithAccessorMap ;
    outArgument22 = p->mAttribute_mGenerateHeaderInSeparateFile ;
    outArgument23 = p->mAttribute_mTypeForEnumeratedElement ;
    outArgument24 = p->mAttribute_mDefaultConstructorName ;
    outArgument25 = p->mAttribute_mHeaderFileName ;
    outArgument26 = p->mAttribute_mHeaderKind ;
  }
}
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).isValid ()) {
    uint32_t variant_15678 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).uintValue () ;
    bool loop_15678 = true ;
    while (loop_15678) {
      loop_15678 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 341)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).isValid () ;
      if (loop_15678) {
        loop_15678 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 341)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 341)).boolValue () ;
      }
      if (loop_15678 && (0 == variant_15678)) {
        loop_15678 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticsTypes.gSemantics", 341)) ;
      }
      if (loop_15678) {
        variant_15678 -- ;
        result_outBaseType = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 342)) ;
      }
    }
  }
//---
...
void categoryMethod_addHeaderFileName (const GALGAS_unifiedTypeMapProxy inObject,
  ...
  const enumGalgasBool test_2 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 351)).operator_and (GALGAS_bool (kIsNotEqual, temp_1.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351)).objectCompare (GALGAS_headerKind::constructor_noHeader (SOURCE_FILE ("semanticsTypes.gSemantics", 351)))) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351)).boolEnum () ;
  if (kBoolTrue == test_2) {
    const GALGAS_unifiedTypeMapProxy temp_3 = inObject ;
    ioArgument_ioInclusions.addAssign_operation (temp_3.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 352))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 352)) ;
  }
}
...
void categoryMethod_addHeaderFileName_31_ (const GALGAS_unifiedTypeMapProxy inObject,
                                           ...
                                           COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_unifiedTypeMapProxy temp_0 = inObject ;
  const enumGalgasBool test_1 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 361)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 361)).boolEnum () ;
  if (kBoolTrue == test_1) {
    const GALGAS_unifiedTypeMapProxy temp_2 = inObject ;
    if (temp_2.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 362)).isValid ()) {
      switch (temp_2.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 362)).enumValue ()) {
      ...
      case GALGAS_headerKind::kEnum_oneHeader: {
        const GALGAS_unifiedTypeMapProxy temp_3 = inObject ;
        ioArgument_ioInclusions.addAssign_operation (temp_3.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 365))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 365)) ;
        } break ;
      case GALGAS_headerKind::kEnum_twoHeaders: {
        const GALGAS_unifiedTypeMapProxy temp_4 = inObject ;
        ioArgument_ioInclusions.addAssign_operation (temp_4.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 367)).operator_concat (GALGAS_string ("-1")  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 367))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 367)) ;
        } break ;
      }
    }
  }
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 425)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 434)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             C_Compiler * /* inCompiler */
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 443)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   C_Compiler * /* inCompiler */
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 452)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 461)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       C_Compiler * /* inCompiler */
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 478)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 493)) ;
  outArgument_outEnumerationVariant = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 494)) ;
