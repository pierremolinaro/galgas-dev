...
GGS_uint  function_isComparable (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (16U) COMMA_SOURCE_FILE_AT_LINE (219)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateSortedListComparisonMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (23U) COMMA_SOURCE_FILE_AT_LINE (221)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateEnumerationHelperMethods (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (222)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithAllAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (25U) COMMA_SOURCE_FILE_AT_LINE (223)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithCurrentAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (26U) COMMA_SOURCE_FILE_AT_LINE (224)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithNativeAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (27U) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_doNotGenererateObjectCompare (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (28U) COMMA_SOURCE_FILE_AT_LINE (226)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateDescriptionReaderUtilityMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (29U) COMMA_SOURCE_FILE_AT_LINE (227)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateNativeNewConstructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (30U) COMMA_SOURCE_FILE_AT_LINE (228)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateVirtualDestructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (31U) COMMA_SOURCE_FILE_AT_LINE (229)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_typedAttributeList   & outParameter16,
                                GGS_mapSearchMethodListAST   & outParameter17,
                                GGS_mapSearchMethodListAST   & outParameter18 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
                 0,
                 kSearchMessage_searchKey,
                 inKey,
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_typedAttributeList & inParameter16,
                                const GGS_mapSearchMethodListAST & inParameter17,
                                const GGS_mapSearchMethodListAST & inParameter18 COMMA_LOCATION_ARGS) {
  insertElement (inLexique,
                 0,
                 kInsertMessage_insertKey,
                 inKey,
...
category_method__predefinedTypeAST__getConstructorMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_15618,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
...
category_method__predefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_15885,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_readerMap  & var_cas_outReaderMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15885 != NULL) {
...
category_method__predefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16134,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_modifierMap  & var_cas_outModifierMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16134 != NULL) {
...
category_method__predefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16397,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16397 != NULL) {
...
category_method__predefinedTypeAST__getClassMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16681,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
...
category_reader__predefinedTypeAST__getSupportedOperatorFlags (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_16961
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_uint  var_cas_outFlags ;
  if (operand_16961 != NULL) {
...
category_method__predefinedTypeAST__getAddAssignArgumentList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17168,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_unifiedTypeMapProxyList  & var_cas_outAddAssignArgumentList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17168 != NULL) {
...
category_reader__predefinedTypeAST__getNativeAttributeList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17812
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_nativeAttributeList  var_cas_outNativeAttributeList ;
  if (operand_17812 != NULL) {
...
category_method__predefinedTypeAST__getEnumerationList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_18398,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
