...
//                                         september 27th, 2014, at 12h32'18"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_enumConstantList GALGAS_unifiedTypeMapProxy::reader_mEnumConstantList (C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  GALGAS_enumConstantList result ;
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).isValid ()) {
    uint32_t variant_15755 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).uintValue () ;
    bool loop_15755 = true ;
    while (loop_15755) {
      loop_15755 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 355)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).isValid () ;
      if (loop_15755) {
        loop_15755 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 355)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).boolValue () ;
      }
