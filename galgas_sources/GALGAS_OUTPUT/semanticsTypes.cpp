...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid ()) {
    uint32_t variant_15567 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).uintValue () ;
    bool loop_15567 = true ;
    while (loop_15567) {
      loop_15567 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid () ;
      if (loop_15567) {
        loop_15567 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).boolValue () ;
      }
      if (loop_15567 && (0 == variant_15567)) {
        loop_15567 = false ;
