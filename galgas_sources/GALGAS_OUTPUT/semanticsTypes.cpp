...
//                                         september 25th, 2014, at 15h20'42"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).isValid ()) {
    uint32_t variant_15592 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).uintValue () ;
    bool loop_15592 = true ;
    while (loop_15592) {
      loop_15592 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 349)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).isValid () ;
      if (loop_15592) {
        loop_15592 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 349)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).boolValue () ;
      }
      if (loop_15592 && (0 == variant_15592)) {
        loop_15592 = false ;
