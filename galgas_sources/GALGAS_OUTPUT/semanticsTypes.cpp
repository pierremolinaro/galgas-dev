...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).isValid ()) {
    uint32_t variant_15320 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).uintValue () ;
    bool loop_15320 = true ;
    while (loop_15320) {
      loop_15320 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 330)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).isValid () ;
      if (loop_15320) {
        loop_15320 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 330)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 330)).boolValue () ;
      }
      if (loop_15320 && (0 == variant_15320)) {
        loop_15320 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticsTypes.gSemantics", 330)) ;
      }
      if (loop_15320) {
        variant_15320 -- ;
        result_outBaseType = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 331)) ;
      }
    }
  }
//---
...
void categoryMethod_addHeaderFileName (const GALGAS_unifiedTypeMapProxy inObject,
                                       ...
                                       COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_unifiedTypeMapProxy temp_0 = inObject ;
  const enumGalgasBool test_1 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).boolEnum () ;
  if (kBoolTrue == test_1) {
    const GALGAS_unifiedTypeMapProxy temp_2 = inObject ;
    ioArgument_ioInclusions.addAssign_operation (temp_2.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 341))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 341)) ;
  }
}
...
void categoryMethod_addHeaderFileName_31_ (const GALGAS_unifiedTypeMapProxy inObject,
                                           ...
                                           COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_unifiedTypeMapProxy temp_0 = inObject ;
  const enumGalgasBool test_1 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 350)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 350)).boolEnum () ;
  if (kBoolTrue == test_1) {
    const GALGAS_unifiedTypeMapProxy temp_2 = inObject ;
    ioArgument_ioInclusions.addAssign_operation (temp_2.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351)).operator_concat (GALGAS_string ("-1")  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 351)) ;
  }
}
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 408)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 417)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             C_Compiler * /* inCompiler */
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 426)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   C_Compiler * /* inCompiler */
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 435)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 444)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       C_Compiler * /* inCompiler */
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 461)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 476)) ;
  outArgument_outEnumerationVariant = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 477)) ;
