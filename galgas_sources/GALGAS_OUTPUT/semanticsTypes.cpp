...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  temp_18610 = mAssociatedListTypeIndex ;
  if (temp_18610.isBuilt ()) {
    temp_18610 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (396)) ;
  }
  { const GGS_ACGalgasType _var_18879 = var_cas_t ; // CAST instruction
    if (_var_18879.getPtr () != NULL) {
      macroValidPointer (_var_18879.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_18879.getPtr ()) != NULL) {
      }else{
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  temp_21757 = mIndexOfMapType ;
  if (temp_21757.isBuilt ()) {
    temp_21757 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (472)) ;
  }
  { const GGS_ACGalgasType _var_22011 = var_cas_t ; // CAST instruction
    if (_var_22011.getPtr () != NULL) {
      macroValidPointer (_var_22011.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_22011.getPtr ()) != NULL) {
      }else{
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_27227 = var_cas_typeMap ;
    if (temp_27227.isBuilt ()) {
      temp_27227 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (583)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_27498 = var_cas_typeMap ;
    if (temp_27498.isBuilt ()) {
      temp_27498 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (590)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_27768 = var_cas_typeMap ;
    if (temp_27768.isBuilt ()) {
      temp_27768 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (597)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_28036 = var_cas_typeMap ;
    if (temp_28036.isBuilt ()) {
      temp_28036 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (604)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    ...
    const GGS_typeMap  temp_28306 = var_cas_typeMap ;
    if (temp_28306.isBuilt ()) {
      temp_28306 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (611)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
