...
insertElement (C_Compiler & inLexique,
                ...
                const GGS_constructorMap & inParameter3,
                const GGS_readerMap & inParameter4,
                const GGS_modifierMap & inParameter5,
                const GGS_instanceMethodMap & inParameter6,
                const GGS_classMethodMap & inParameter7,
                const GGS_enumeratedItemsWithForeachInstruction & inParameter8,
                GGS_luint * outIndex
                COMMA_LOCATION_ARGS) {
  PMSInt32 elementID = - 1 ;
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    ...
    info.mConstructorMap = inParameter3 ;
    info.mReaderMap = inParameter4 ;
    info.mModifierMap = inParameter5 ;
    info.mInstanceMethodMap = inParameter6 ;
    info.mClassMethodMap = inParameter7 ;
    info.mEnumeratedItemsWithForeachInstruction = inParameter8 ;
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, elementID, existingKeyLocation) ;
    if (elementID < 0) {
      emitInsertMapSemanticErrorMessage (inLexique, inKey, inErrorMessage, existingKeyLocation COMMA_THERE) ;
...
searchElement (C_Compiler & inLexique,
               ...
               GGS_constructorMap   & outParameter3,
               GGS_readerMap   & outParameter4,
               GGS_modifierMap   & outParameter5,
               GGS_instanceMethodMap   & outParameter6,
               GGS_classMethodMap   & outParameter7,
               GGS_enumeratedItemsWithForeachInstruction   & outParameter8,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  cElement * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter3 = node->mInfo.mConstructorMap ;
    outParameter4 = node->mInfo.mReaderMap ;
    outParameter5 = node->mInfo.mModifierMap ;
    outParameter6 = node->mInfo.mInstanceMethodMap ;
    outParameter7 = node->mInfo.mClassMethodMap ;
    outParameter8 = node->mInfo.mEnumeratedItemsWithForeachInstruction ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (PMUInt32) node->mID), inKey) ;
    }
  }
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_instanceMethodMap   & outParameter6,
                                GGS_classMethodMap   & outParameter7,
                                GGS_enumeratedItemsWithForeachInstruction   & outParameter8 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
                  kSearchMessage_searchKey,
                  inKey,
                  outParameter0,
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_instanceMethodMap & inParameter6,
                                const GGS_classMethodMap & inParameter7,
                                const GGS_enumeratedItemsWithForeachInstruction & inParameter8 COMMA_LOCATION_ARGS) {
  insertElement (inLexique,
                 kInsertMessage_insertKey,
                 inKey,
                 inParameter0,
