...
//                    september 24th, 2010, at 11h51'10"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_unifiedTypeMapProxyList GGS_unifiedTypeMapProxyList::castFromObject (C_Compiler & inLexique,
...
GGS_constructorMap GGS_constructorMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
...
GGS_methodQualifier GGS_methodQualifier::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
...
insertElement (C_Compiler & inLexique,
               ...
               const GGS_unifiedTypeMapProxy & inParameter3,
  ...
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    ...
    info.mReturnedType = inParameter3 ;
...
searchElement (C_Compiler & inLexique,
               ...
               GGS_unifiedTypeMapProxy   & outParameter3,
  ...
  if (node == NULL) {
    ...
    outParameter3 = node->mInfo.mReturnedType ;
...
GGS_readerMap GGS_readerMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_bool& inValue0,
                                             const GGS_unifiedTypeMapProxyList & inValue1,
                                             const GGS_bool& inValue2,
                                             const GGS_unifiedTypeMapProxy & inValue3,
...
GGS_modifierMap GGS_modifierMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
...
GGS_instanceMethodMap GGS_instanceMethodMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_bool& inValue0,
...
GGS_classMethodMap GGS_classMethodMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_formalParameterSignature & inValue0,
                                             const GGS_bool& inValue1
                                             COMMA_LOCATION_ARGS) {
...
GGS_withAccessorMap GGS_withAccessorMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_withAccessorMap result ;
...
GGS_withAccessorMap GGS_withAccessorMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
...
/* const */ GGS_unifiedTypeMapProxy  & GGS_typedAttributeList::cEnumerator::_mAttributeTypeIndex (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_predefinedTypeKindEnum GGS_predefinedTypeKindEnum::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = mCppClassName.operator_isEqual (ptr->mCppClassName).boolValue ()
         ...
         && mDefaultValue.operator_isEqual (ptr->mDefaultValue).boolValue ()
         && mIsConst.operator_isEqual (ptr->mIsConst).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_String & ioString,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDefaultValue.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIsConst.reader_description (inIndentation) ;
}
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_string p_5 = p->mDefaultValue ;
          GGS_bool p_6 = p->mIsConst ;
...
internalSubListWithRange (GGS_nativeAttributeList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mCppClassName, ptr->mIsPointer, ptr->mAttributeName, ptr->mUseReferenceForConstructor, ptr->mGetterName, ptr->mDefaultValue, ptr->mIsConst) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
GGS_bool GGS_nativeAttributeList::
reader_mIsConstAtIndex (C_Compiler & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_bool result ;
  if (isBuilt () && inIndex.isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
      result = object->mIsConst ;
    }
  }
  return result ;
}
...
void GGS_nativeAttributeList::
modifier_setMIsConstAtIndex (C_Compiler & inLexique,
                              const GGS_bool & inObject,
                              const GGS_uint & inIndex
                              COMMA_LOCATION_ARGS) const {
  if (isBuilt () && inIndex.isBuilt ()) {
...
/* const */ GGS_string & GGS_nativeAttributeList::cEnumerator::_mDefaultValue (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mDefaultValue ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_bool & GGS_nativeAttributeList::cEnumerator::_mIsConst (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mIsConst ;
}
...
GGS_uint  function_binarySubOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (242)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryMulOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (243)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryDivOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (3U) COMMA_SOURCE_FILE_AT_LINE (244)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryModOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (4U) COMMA_SOURCE_FILE_AT_LINE (245)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryShiftOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (5U) COMMA_SOURCE_FILE_AT_LINE (246)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_unaryPlusOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (6U) COMMA_SOURCE_FILE_AT_LINE (247)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_unaryMinusOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (7U) COMMA_SOURCE_FILE_AT_LINE (248)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_unaryTildeOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (249)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_incDecOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (9U) COMMA_SOURCE_FILE_AT_LINE (250)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryAndOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (10U) COMMA_SOURCE_FILE_AT_LINE (252)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryOrOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (11U) COMMA_SOURCE_FILE_AT_LINE (253)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryXorOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (12U) COMMA_SOURCE_FILE_AT_LINE (254)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_unaryNotOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (13U) COMMA_SOURCE_FILE_AT_LINE (255)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_binaryConcatOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (14U) COMMA_SOURCE_FILE_AT_LINE (257)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_dotAssignOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (15U) COMMA_SOURCE_FILE_AT_LINE (258)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Implementation of function "isComparable"                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_isComparable (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_isComparable at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (16U) COMMA_SOURCE_FILE_AT_LINE (259)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_isComparable (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of function "generateCopyConstructorAndAssignmentOperator"  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateCopyConstructorAndAssignmentOperator (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateCopyConstructorAndAssignmentOperator at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (19U) COMMA_SOURCE_FILE_AT_LINE (261)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_generateCopyConstructorAndAssignmentOperator (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 Implementation of function "autoBoxing"                   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_autoBoxing (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_autoBoxing at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (20U) COMMA_SOURCE_FILE_AT_LINE (263)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_autoBoxing\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_autoBoxing (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_autoBoxing (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_autoBoxing ("autoBoxing",
                              functionForGenericCall_autoBoxing,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of function "generateCppConstructorWithNativeAttributeListInAutoPointerClass"*
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateCppConstructorWithNativeAttributeListInAutoPointerClass (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateCppConstructorWithNativeAttributeListInAutoPointerClass at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (21U) COMMA_SOURCE_FILE_AT_LINE (264)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_generateCppConstructorWithNativeAttributeListInAutoPointerClass\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_generateCppConstructorWithNativeAttributeListInAutoPointerClass (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_generateCppConstructorWithNativeAttributeListInAutoPointerClass (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_generateCppConstructorWithNativeAttributeListInAutoPointerClass ("generateCppConstructorWithNativeAttributeListInAutoPointerClass",
                              functionForGenericCall_generateCppConstructorWithNativeAttributeListInAutoPointerClass,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//      Implementation of function "generateConstructorWithSelfObject"       *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateConstructorWithSelfObject (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateConstructorWithSelfObject at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (22U) COMMA_SOURCE_FILE_AT_LINE (265)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_generateConstructorWithSelfObject\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_generateConstructorWithSelfObject (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_generateConstructorWithSelfObject (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_generateConstructorWithSelfObject ("generateConstructorWithSelfObject",
                              functionForGenericCall_generateConstructorWithSelfObject,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Implementation of function "generateSortedListComparisonMethod"       *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateSortedListComparisonMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateSortedListComparisonMethod at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (23U) COMMA_SOURCE_FILE_AT_LINE (266)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_generateSortedListComparisonMethod\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_generateSortedListComparisonMethod (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_generateSortedListComparisonMethod (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_generateSortedListComparisonMethod ("generateSortedListComparisonMethod",
                              functionForGenericCall_generateSortedListComparisonMethod,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
GGS_uint  function_generateEnumerationHelperMethods (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (267)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
//---------------------------------------------------------------------------*
//                                                                           *
// Implementation of function "generateCppConstructorWithAllAttributeList"   *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateCppConstructorWithAllAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateCppConstructorWithAllAttributeList at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (25U) COMMA_SOURCE_FILE_AT_LINE (268)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_generateCppConstructorWithAllAttributeList\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_generateCppConstructorWithAllAttributeList (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_generateCppConstructorWithAllAttributeList (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_generateCppConstructorWithAllAttributeList ("generateCppConstructorWithAllAttributeList",
                              functionForGenericCall_generateCppConstructorWithAllAttributeList,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Implementation of function "generateCppConstructorWithCurrentAttributeList"*
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint  function_generateCppConstructorWithCurrentAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_generateCppConstructorWithCurrentAttributeList at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (26U) COMMA_SOURCE_FILE_AT_LINE (269)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_generateCppConstructorWithCurrentAttributeList\n") ;
  #endif
  return var_cas_outMask ;
}
...
static GGS_object functionForGenericCall_generateCppConstructorWithCurrentAttributeList (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_uint  result = function_generateCppConstructorWithCurrentAttributeList (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptorEX kFunction_descriptor_generateCppConstructorWithCurrentAttributeList ("generateCppConstructorWithCurrentAttributeList",
                              functionForGenericCall_generateCppConstructorWithCurrentAttributeList,
                              & kTypeDescriptor_GGS_uint ,
                              0,
                              NULL) ;
...
GGS_uint  function_generateCppConstructorWithNativeAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (27U) COMMA_SOURCE_FILE_AT_LINE (270)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_doNotGenererateObjectCompare (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (28U) COMMA_SOURCE_FILE_AT_LINE (271)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateDescriptionReaderUtilityMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (29U) COMMA_SOURCE_FILE_AT_LINE (272)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateNativeNewConstructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (30U) COMMA_SOURCE_FILE_AT_LINE (273)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateVirtualDestructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (31U) COMMA_SOURCE_FILE_AT_LINE (274)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_attributeMap GGS_attributeMap::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_attributeMap result ;
...
GGS_attributeMap GGS_attributeMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_unifiedTypeMapProxy & inValue0
                                             COMMA_LOCATION_ARGS) {
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mPrivateDataMemberList.reader_description (inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mIsConcrete.operator_isEqual (ptr->mInfo.mIsConcrete)).boolValue ()
           ...
           && (mInfo.mPrivateDataMemberList.operator_isEqual (ptr->mInfo.mPrivateDataMemberList)).boolValue ()
...
insertElement (C_Compiler & inLexique,
               ...
               const GGS_stringset & inParameter15,
               const GGS_lstringlist & inParameter16,
               const GGS_typedAttributeList & inParameter17,
               const GGS_mapSearchMethodListAST & inParameter18,
               const GGS_mapSearchMethodListAST & inParameter19,
               const GGS_withAccessorMap & inParameter20,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) {
  PMSInt32 elementID = - 1 ;
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    ...
    info.mEnumConstantSet = inParameter15 ;
    info.mEnumConstantList = inParameter16 ;
    info.mPrivateDataMemberList = inParameter17 ;
    info.mMapSearchMethodList = inParameter18 ;
    info.mMapProxySearchConstructorList = inParameter19 ;
    info.mWithAccessorMap = inParameter20 ;
    GGS_location existingKeyLocation ;
    internalInsert (inKey, (void *) & info, elementID, existingKeyLocation, true, inInitialState) ;
    if (elementID < 0) {
      emitInsertMapSemanticErrorMessage (inLexique, inKey, inErrorMessage, existingKeyLocation COMMA_THERE) ;
...
searchElement (C_Compiler & inLexique,
               ...
               GGS_stringset   & outParameter15,
               GGS_lstringlist   & outParameter16,
               GGS_typedAttributeList   & outParameter17,
               GGS_mapSearchMethodListAST   & outParameter18,
               GGS_mapSearchMethodListAST   & outParameter19,
               GGS_withAccessorMap   & outParameter20,
               GGS_luint * outIndex
               COMMA_LOCATION_ARGS) const {
  cElement * node = NULL  ;
  if (isBuilt () && inKey.isBuilt ()) {
  ...
  if (node == NULL) {
    ...
    outParameter15 = node->mInfo.mEnumConstantSet ;
    outParameter16 = node->mInfo.mEnumConstantList ;
    outParameter17 = node->mInfo.mPrivateDataMemberList ;
    outParameter18 = node->mInfo.mMapSearchMethodList ;
    outParameter19 = node->mInfo.mMapProxySearchConstructorList ;
    outParameter20 = node->mInfo.mWithAccessorMap ;
    if (outIndex != NULL) {
      * outIndex = GGS_luint (GGS_uint (true, (PMUInt32) node->mID), inKey) ;
    }
  }
...
method_searchKey (C_Compiler & inLexique,
                                ...
                                GGS_mapSearchMethodListAST   & outParameter18,
                                GGS_mapSearchMethodListAST   & outParameter19,
                                GGS_withAccessorMap   & outParameter20 COMMA_LOCATION_ARGS) const {
  searchElement (inLexique,
                 0,
                 kSearchMessage_searchKey,
                 inKey,
...
modifier_insertKey (C_Compiler & inLexique,
                                ...
                                const GGS_mapSearchMethodListAST & inParameter18,
                                const GGS_mapSearchMethodListAST & inParameter19,
                                const GGS_withAccessorMap & inParameter20 COMMA_LOCATION_ARGS) {
  insertElement (inLexique,
                 0,
                 kInsertMessage_insertKey,
                 inKey,
...
/* const */ GGS_typedAttributeList  & GGS_unifiedTypeMap::cEnumerator::_mPrivateDataMemberList (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mPrivateDataMemberList ;
}
...
GGS_unifiedTypeMap GGS_unifiedTypeMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_bool& inValue0,
                                             ...
                                             const GGS_stringset & inValue15,
                                             const GGS_lstringlist & inValue16,
                                             const GGS_typedAttributeList & inValue17,
                                             const GGS_mapSearchMethodListAST & inValue18,
                                             const GGS_mapSearchMethodListAST & inValue19,
                                             const GGS_withAccessorMap & inValue20
                                             COMMA_LOCATION_ARGS) {
...
GGS_unifiedTypeMapProxy GGS_unifiedTypeMapProxy::constructor_searchKey (C_Compiler & inLexique,
...
GGS_bool GGS_unifiedTypeMapProxy::reader_mIsConcrete (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_bool result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_unifiedTypeMapProxy  GGS_unifiedTypeMapProxy::reader_mSuperType (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_unifiedTypeMapProxy  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_typeKindEnum GGS_unifiedTypeMapProxy::reader_mTypeKindEnum (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_typeKindEnum result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_typedAttributeList  GGS_unifiedTypeMapProxy::reader_mInheritedTypedAttributeList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_typedAttributeList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_attributeMap  GGS_unifiedTypeMapProxy::reader_mAttributeMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_attributeMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_typedAttributeList  GGS_unifiedTypeMapProxy::reader_mCurrentTypedAttributeList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_typedAttributeList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_constructorMap  GGS_unifiedTypeMapProxy::reader_mConstructorMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_constructorMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_readerMap  GGS_unifiedTypeMapProxy::reader_mReaderMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_readerMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_modifierMap  GGS_unifiedTypeMapProxy::reader_mModifierMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_modifierMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_instanceMethodMap  GGS_unifiedTypeMapProxy::reader_mInstanceMethodMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_instanceMethodMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_classMethodMap  GGS_unifiedTypeMapProxy::reader_mClassMethodMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_classMethodMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_enumerationDescriptorList  GGS_unifiedTypeMapProxy::reader_mEnumerationDescriptor (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_enumerationDescriptorList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_uint  GGS_unifiedTypeMapProxy::reader_mHandledOperatorFlags (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_uint  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_unifiedTypeMapProxyList  GGS_unifiedTypeMapProxy::reader_mAddAssignOperatorArguments (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_unifiedTypeMapProxyList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_nativeAttributeList  GGS_unifiedTypeMapProxy::reader_mNativeAttributeList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_nativeAttributeList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_stringset  GGS_unifiedTypeMapProxy::reader_mEnumConstantSet (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
...
GGS_lstringlist  GGS_unifiedTypeMapProxy::reader_mEnumConstantList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
...
GGS_typedAttributeList  GGS_unifiedTypeMapProxy::reader_mPrivateDataMemberList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_typedAttributeList  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
  ...
  case kRegular :
    if (mIndex.retrieve () == NULL) {
      ...
      MF_Assert (reinterpret_cast <const elementOf_GGS_unifiedTypeMap *> (mIndex.retrieve ()) != NULL, "Dynamic cast error", 0, 0) ;
      const elementOf_GGS_unifiedTypeMap * p = (const elementOf_GGS_unifiedTypeMap *) mIndex.retrieve () ;
      result = p->mInfo.mPrivateDataMemberList ;
    }
    break ;
  }
  return result ;
...
GGS_mapSearchMethodListAST  GGS_unifiedTypeMapProxy::reader_mMapSearchMethodList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
...
GGS_mapSearchMethodListAST  GGS_unifiedTypeMapProxy::reader_mMapProxySearchConstructorList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_mapSearchMethodListAST  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_withAccessorMap  GGS_unifiedTypeMapProxy::reader_mWithAccessorMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const {
  GGS_withAccessorMap  result ;
  switch (mState) {
  case kNotBuilt :
    break ;
...
GGS_unifiedTypeMapProxy GGS_unifiedTypeMapProxy::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_unifiedTypeMapProxy result ;
...
cPtr_objectPredefinedTypeAST (LOCATION_ARGS)
:cPtr_semanticDeclarationAST (THERE) {
}
...
C_galgas_class_inspector _gInspectorFor_objectPredefinedTypeAST (& typeid (cPtr_objectPredefinedTypeAST), & typeid (cPtr_semanticDeclarationAST), "") ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_objectPredefinedTypeAST ("objectPredefinedTypeAST", true, & kTypeDescriptor_GGS_semanticDeclarationAST) ;
...
static cPtr_objectPredefinedTypeAST * gSingleton_objectPredefinedTypeAST = NULL ;
...
constructor_new (C_Compiler & /* inLexique */
                                COMMA_LOCATION_ARGS) {
  GGS_objectPredefinedTypeAST result ;
  if (NULL == gSingleton_objectPredefinedTypeAST) {
    macroMyNew (gSingleton_objectPredefinedTypeAST, cPtr_objectPredefinedTypeAST (THERE)) ;
    macroRetainObject (gSingleton_objectPredefinedTypeAST) ;
  }
  macroAssignObject (result.mPointer, gSingleton_objectPredefinedTypeAST) ;
  return result ;
}
...
C_galgasClassRunTimeInformationEX gClassInfoFor__objectPredefinedTypeAST ("objectPredefinedTypeAST", gClassInfoFor__semanticDeclarationAST, & kTypeDescriptor_GGS_objectPredefinedTypeAST) ;
...
static GGS_string
category_reader__predefinedTypeAST__getSuperTypeName (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17260
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outSuperTypeName ;
  if (operand_17260 != NULL) {
    var_cas_outSuperTypeName = GGS_string ("object") ;
  }
...
//---------------------------------------------------------------------------*
//                                                                           *
// Virtual Table for category reader '@predefinedTypeAST.getSuperTypeName'   *
//                                                                           *
//---------------------------------------------------------------------------*

static TC_UniqueArray <typeCategoryReader__predefinedTypeAST__getSuperTypeName> gDispatchTableForReader__predefinedTypeAST__getSuperTypeName ;
...
enterCategoryReader__predefinedTypeAST__getSuperTypeName (typeCategoryReader__predefinedTypeAST__getSuperTypeName inRoutine,
  ...
  gDispatchTableForReader__predefinedTypeAST__getSuperTypeName.forceObjectAtIndex (inClassID, inRoutine, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

static GGS_string
category_reader__predefinedTypeAST_defaultReader_getSuperTypeName (C_Compiler &,
...
findCategoryReader__predefinedTypeAST__getSuperTypeName (AC_galgasClassRunTimeInformationEX * inClassPtr) {
  typeCategoryReader__predefinedTypeAST__getSuperTypeName result = NULL ;
  if (inClassPtr->slotID () < gDispatchTableForReader__predefinedTypeAST__getSuperTypeName.count ()) {
    result = gDispatchTableForReader__predefinedTypeAST__getSuperTypeName (inClassPtr->slotID () COMMA_HERE) ;
  }
  if (NULL == result) {
    AC_galgasClassRunTimeInformationEX * superClassPtr = inClassPtr->superClassPtr () ;
    if (superClassPtr != NULL) {
      result = findCategoryReader__predefinedTypeAST__getSuperTypeName (superClassPtr) ;
      gDispatchTableForReader__predefinedTypeAST__getSuperTypeName.forceObjectAtIndex (inClassPtr->slotID (), result, NULL COMMA_HERE) ;
    }
  }
  if (NULL == result) {
    result = category_reader__predefinedTypeAST_defaultReader_getSuperTypeName ;
  }
  return result ;
}
...
category_method__predefinedTypeAST__getConstructorMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_17509,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_constructorMap  & var_cas_outConstructorMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17509 != NULL) {
    var_cas_outConstructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
}
...
category_method__predefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_17776,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_readerMap  & var_cas_outReaderMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17776 != NULL) {
    var_cas_outReaderMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (395)) ;
  }
}
...
category_method__predefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_18025,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_modifierMap  & var_cas_outModifierMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18025 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (404)) ;
  }
}
...
category_method__predefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_18288,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18288 != NULL) {
    var_cas_outInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) ;
  }
}
...
category_method__predefinedTypeAST__getClassMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_18572,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_classMethodMap  & var_cas_outClassMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18572 != NULL) {
    var_cas_outClassMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (422)) ;
  }
}
...
category_reader__predefinedTypeAST__getSupportedOperatorFlags (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_18852
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__predefinedTypeAST__getAddAssignArgumentList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_19059,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_unifiedTypeMapProxyList  & var_cas_outAddAssignArgumentList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19059 != NULL) {
...
category_reader__predefinedTypeAST__getNativeAttributeList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_19703
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__predefinedTypeAST__getEnumerationList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_20289,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
...
static void prologueRoutineFor_semanticsTypes (void) {
  enterCategoryReader__predefinedTypeAST__getSuperTypeName (category_reader__predefinedTypeAST__getSuperTypeName, gClassInfoFor__predefinedTypeAST.slotID ()) ;
...
static void epilogueRoutineFor_semanticsTypes (void) {
  macroReleaseObject (gSingleton_objectPredefinedTypeAST) ;
  gDispatchTableForReader__predefinedTypeAST__getSuperTypeName.free () ;
