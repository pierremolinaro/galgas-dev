...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).isValid ()) {
    uint32_t variant_15754 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).uintValue () ;
    bool loop_15754 = true ;
    while (loop_15754) {
      loop_15754 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 355)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).isValid () ;
      if (loop_15754) {
        loop_15754 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 355)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 355)).boolValue () ;
      }
