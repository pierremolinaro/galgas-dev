...
//                    november 15th, 2010, at 14h14'15"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
cCollectionElement * cCollectionElement_unifiedTypeMapProxyList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_unifiedTypeMapProxyList (mAttribute_mType COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cCollectionElement_unifiedTypeMapProxyList::compare (const cCollectionElement * inOperand) const {
...
cCollectionElement_unifiedTypeMapProxyList * GALGAS_unifiedTypeMapProxyList::makeElement (const GALGAS_unifiedTypeMapProxy & in_mType
                                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_unifiedTypeMapProxyList * result = NULL ;
  macroMyNew (result, cCollectionElement_unifiedTypeMapProxyList (in_mType COMMA_THERE)) ;
  return result ;
}
...
GALGAS_unifiedTypeMapProxyList GALGAS_unifiedTypeMapProxyList::reader_subListWithRange (const GALGAS_uint & inIndex,
...
void GALGAS_unifiedTypeMapProxyList::modifier_setMTypeAtIndex (GALGAS_unifiedTypeMapProxy inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_unifiedTypeMapProxyList * p = (cCollectionElement_unifiedTypeMapProxyList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_unifiedTypeMapProxyList) ;
...
enumComparisonResult cMapElement_constructorMap::compare (const cCollectionElement * inOperand) const {
...
enumComparisonResult GALGAS_methodQualifier::objectCompare (const GALGAS_methodQualifier & inOperand) const {
...
cMapElement_readerMap::cMapElement_readerMap (const GALGAS_lstring & inKey,
                                              ...
                                              COMMA_LOCATION_ARGS) :
cMapElement (inKey COMMA_THERE),
mAttribute_mIsCategory (in_mIsCategory),
mAttribute_mArgumentTypeList (in_mArgumentTypeList),
...
bool cMapElement_readerMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIsCategory.isValid () && mAttribute_mArgumentTypeList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mReturnedType.isValid () && mAttribute_mQualifier.isValid () ;
}
...
cMapElement * cMapElement_readerMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_readerMap (mAttribute_lkey, mAttribute_mIsCategory, mAttribute_mArgumentTypeList, mAttribute_mDeclarationLocation, mAttribute_mHasCompilerArgument, mAttribute_mReturnedType, mAttribute_mQualifier COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mIsCategory.description (ioString, inIndentation) ;
// mAttribute_mArgumentTypeList.description (ioString, inIndentation) ;
...
enumComparisonResult cMapElement_readerMap::compare (const cCollectionElement * inOperand) const {
  cMapElement_readerMap * operand = (cMapElement_readerMap *) inOperand ;
  enumComparisonResult result = mAttribute_lkey.objectCompare (operand->mAttribute_lkey) ;
  if (kOperandEqual == result) {
    result = mAttribute_mIsCategory.objectCompare (operand->mAttribute_mIsCategory) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mArgumentTypeList.objectCompare (operand->mAttribute_mArgumentTypeList) ;
  }
...
void GALGAS_readerMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_readerMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_readerMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument0 = p->mAttribute_mIsCategory ;
...
GALGAS_bool GALGAS_readerMap::reader_mIsCategoryForKey (const GALGAS_string & inKey,
                                                        C_Compiler * inCompiler
                                                        COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, const cMapElement_readerMap) ;
    result = p->mAttribute_mIsCategory ;
  }
  return result ;
}
...
void GALGAS_readerMap::modifier_setMIsCategoryForKey (GALGAS_bool inAttributeValue,
                                                      GALGAS_string inKey,
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    ...
    p->mAttribute_mIsCategory = inAttributeValue ;
  }
}
...
GALGAS_bool cEnumerator_readerMap::current_mIsCategory (LOCATION_ARGS) const {
  const cMapElement_readerMap * p = (const cMapElement_readerMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_readerMap) ;
  return p->mAttribute_mIsCategory ;
}
...
cCollectionElement * cCollectionElement_formalParameterSignature::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_formalParameterSignature (mAttribute_mFormalArgumentType, mAttribute_mFormalArgumentPassingMode COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mFormalArgumentType.description (ioString, inIndentation) ;
// mAttribute_mFormalArgumentPassingMode.description (ioString, inIndentation) ;
}

//---------------------------------------------------------------------------*

enumComparisonResult cCollectionElement_formalParameterSignature::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_formalParameterSignature * operand = (cCollectionElement_formalParameterSignature *) inOperand ;
  enumComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
    result = mAttribute_mFormalArgumentType.objectCompare (operand->mAttribute_mFormalArgumentType) ;
  }
  if (kOperandEqual == result) {
...
cCollectionElement_formalParameterSignature * GALGAS_formalParameterSignature::makeElement (const GALGAS_unifiedTypeMapProxy & in_mFormalArgumentType,
                                                                                            const GALGAS_formalArgumentPassingModeAST & in_mFormalArgumentPassingMode
                                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_formalParameterSignature * result = NULL ;
  macroMyNew (result, cCollectionElement_formalParameterSignature (in_mFormalArgumentType,
...
void GALGAS_formalParameterSignature::modifier_popFirst (GALGAS_unifiedTypeMapProxy & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mAttribute_mFormalArgumentType ;
    outOperand1 = p->mAttribute_mFormalArgumentPassingMode ;
  }
}
...
GALGAS_formalParameterSignature GALGAS_formalParameterSignature::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                          const GALGAS_uint & inLength,
                                                                                          C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) const {
...
void GALGAS_formalParameterSignature::modifier_setMFormalArgumentTypeAtIndex (GALGAS_unifiedTypeMapProxy inOperand,
                                                                              GALGAS_uint inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_formalParameterSignature * p = (cCollectionElement_formalParameterSignature *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_formalParameterSignature) ;
    p->mAttribute_mFormalArgumentType = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_formalParameterSignature::modifier_setMFormalArgumentPassingModeAtIndex (GALGAS_formalArgumentPassingModeAST inOperand,
                                                                                     GALGAS_uint inIndex,
                                                                                     C_Compiler * inCompiler
                                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_formalParameterSignature * p = (cCollectionElement_formalParameterSignature *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_unifiedTypeMapProxy cEnumerator_formalParameterSignature::current_mFormalArgumentType (LOCATION_ARGS) const {
  ...
  return p->mAttribute_mFormalArgumentType ;
}
...
bool cMapElement_modifierMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () ;
}
...
cMapElement * cMapElement_modifierMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_modifierMap (mAttribute_lkey, mAttribute_mParameterList, mAttribute_mHasCompilerArgument, mAttribute_mQualifier COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cMapElement_modifierMap::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_modifierMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_modifierMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_modifierMap::method_searchKey (GALGAS_lstring inKey,
                                           ...
                                           GALGAS_bool & outArgument1,
                                           GALGAS_methodQualifier & outArgument2,
                                           C_Compiler * inCompiler
                                           COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument1 = p->mAttribute_mHasCompilerArgument ;
    outArgument2 = p->mAttribute_mQualifier ;
  }
}
...
bool cMapElement_instanceMethodMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIsCategory.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () ;
}
...
cMapElement * cMapElement_instanceMethodMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_instanceMethodMap (mAttribute_lkey, mAttribute_mIsCategory, mAttribute_mParameterList, mAttribute_mDeclarationLocation, mAttribute_mHasCompilerArgument, mAttribute_mQualifier COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cMapElement_instanceMethodMap::compare (const cCollectionElement * inOperand) const {
...
void GALGAS_instanceMethodMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_instanceMethodMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_bool GALGAS_instanceMethodMap::reader_mIsCategoryForKey (const GALGAS_string & inKey,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
...
void GALGAS_instanceMethodMap::modifier_setMIsCategoryForKey (GALGAS_bool inAttributeValue,
                                                              GALGAS_string inKey,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_bool cEnumerator_instanceMethodMap::current_mIsCategory (LOCATION_ARGS) const {
...
enumComparisonResult cMapElement_classMethodMap::compare (const cCollectionElement * inOperand) const {
...
enumComparisonResult cMapElement_withAccessorMap::compare (const cCollectionElement * inOperand) const {
...
cCollectionElement_enumerationDescriptorList::cCollectionElement_enumerationDescriptorList (const GALGAS_unifiedTypeMapProxy & in_mEnumeratedType,
                                                                                            ...
                                                                                            COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mAttribute_mEnumeratedType (in_mEnumeratedType),
...
cCollectionElement * cCollectionElement_enumerationDescriptorList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_enumerationDescriptorList (mAttribute_mEnumeratedType, mAttribute_mEnumerationName COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mEnumeratedType.description (ioString, inIndentation) ;
// mAttribute_mEnumerationName.description (ioString, inIndentation) ;
}

//---------------------------------------------------------------------------*

enumComparisonResult cCollectionElement_enumerationDescriptorList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_enumerationDescriptorList * operand = (cCollectionElement_enumerationDescriptorList *) inOperand ;
  enumComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
    result = mAttribute_mEnumeratedType.objectCompare (operand->mAttribute_mEnumeratedType) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mEnumerationName.objectCompare (operand->mAttribute_mEnumerationName) ;
  }
  return result ;
}
...
cCollectionElement_enumerationDescriptorList * GALGAS_enumerationDescriptorList::makeElement (const GALGAS_unifiedTypeMapProxy & in_mEnumeratedType,
                                                                                              const GALGAS_string & in_mEnumerationName
                                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_enumerationDescriptorList * result = NULL ;
  macroMyNew (result, cCollectionElement_enumerationDescriptorList (in_mEnumeratedType,
...
void GALGAS_enumerationDescriptorList::modifier_popFirst (GALGAS_unifiedTypeMapProxy & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mAttribute_mEnumeratedType ;
    outOperand1 = p->mAttribute_mEnumerationName ;
  }
}
...
GALGAS_enumerationDescriptorList GALGAS_enumerationDescriptorList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                                            const GALGAS_uint & inLength,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
...
void GALGAS_enumerationDescriptorList::modifier_setMEnumeratedTypeAtIndex (GALGAS_unifiedTypeMapProxy inOperand,
                                                                           GALGAS_uint inIndex,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_enumerationDescriptorList * p = (cCollectionElement_enumerationDescriptorList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_enumerationDescriptorList) ;
    p->mAttribute_mEnumeratedType = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_enumerationDescriptorList::modifier_setMEnumerationNameAtIndex (GALGAS_string inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_enumerationDescriptorList * p = (cCollectionElement_enumerationDescriptorList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_enumerationDescriptorList) ;
    p->mAttribute_mEnumerationName = inOperand ;
  }
}
...
GALGAS_unifiedTypeMapProxy GALGAS_enumerationDescriptorList::reader_mEnumeratedTypeAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_enumerationDescriptorList) ;
    result = p->mAttribute_mEnumeratedType ;
  }
  return result ;
}
...
GALGAS_unifiedTypeMapProxy cEnumerator_enumerationDescriptorList::current_mEnumeratedType (LOCATION_ARGS) const {
  ...
  return p->mAttribute_mEnumeratedType ;
}
...
GALGAS_string cEnumerator_enumerationDescriptorList::current_mEnumerationName (LOCATION_ARGS) const {
  const cCollectionElement_enumerationDescriptorList * p = (const cCollectionElement_enumerationDescriptorList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_enumerationDescriptorList) ;
  return p->mAttribute_mEnumerationName ;
}
...
cCollectionElement_typedAttributeList::cCollectionElement_typedAttributeList (const GALGAS_unifiedTypeMapProxy & in_mAttributeTypeProxy,
                                                                              ...
                                                                              COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mAttribute_mAttributeTypeProxy (in_mAttributeTypeProxy),
mAttribute_mAttributeName (in_mAttributeName),
mAttribute_mHasSetter (in_mHasSetter),
mAttribute_mHasGetter (in_mHasGetter) {
}
...
cCollectionElement * cCollectionElement_typedAttributeList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_typedAttributeList (mAttribute_mAttributeTypeProxy, mAttribute_mAttributeName, mAttribute_mHasSetter, mAttribute_mHasGetter COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mAttributeTypeProxy.description (ioString, inIndentation) ;
// mAttribute_mAttributeName.description (ioString, inIndentation) ;
// mAttribute_mHasSetter.description (ioString, inIndentation) ;
// mAttribute_mHasGetter.description (ioString, inIndentation) ;
}

//---------------------------------------------------------------------------*

enumComparisonResult cCollectionElement_typedAttributeList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_typedAttributeList * operand = (cCollectionElement_typedAttributeList *) inOperand ;
  enumComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
    result = mAttribute_mAttributeTypeProxy.objectCompare (operand->mAttribute_mAttributeTypeProxy) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mAttributeName.objectCompare (operand->mAttribute_mAttributeName) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mHasSetter.objectCompare (operand->mAttribute_mHasSetter) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_mHasGetter.objectCompare (operand->mAttribute_mHasGetter) ;
  }
  return result ;
}
...
cCollectionElement_typedAttributeList * GALGAS_typedAttributeList::makeElement (const GALGAS_unifiedTypeMapProxy & in_mAttributeTypeProxy,
                                                                                const GALGAS_lstring & in_mAttributeName,
                                                                                const GALGAS_bool & in_mHasSetter,
                                                                                const GALGAS_bool & in_mHasGetter
                                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_typedAttributeList * result = NULL ;
  macroMyNew (result, cCollectionElement_typedAttributeList (in_mAttributeTypeProxy,
                                                                                in_mAttributeName,
                                                                                in_mHasSetter,
...
void GALGAS_typedAttributeList::modifier_popFirst (GALGAS_unifiedTypeMapProxy & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mAttribute_mAttributeTypeProxy ;
    outOperand1 = p->mAttribute_mAttributeName ;
    outOperand2 = p->mAttribute_mHasSetter ;
    outOperand3 = p->mAttribute_mHasGetter ;
  }
}
...
GALGAS_typedAttributeList GALGAS_typedAttributeList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                              const GALGAS_uint & inLength,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
...
void GALGAS_typedAttributeList::modifier_setMAttributeTypeProxyAtIndex (GALGAS_unifiedTypeMapProxy inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_typedAttributeList * p = (cCollectionElement_typedAttributeList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    p->mAttribute_mAttributeTypeProxy = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_typedAttributeList::modifier_setMAttributeNameAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_typedAttributeList * p = (cCollectionElement_typedAttributeList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_typedAttributeList::modifier_setMHasSetterAtIndex (GALGAS_bool inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_typedAttributeList * p = (cCollectionElement_typedAttributeList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    p->mAttribute_mHasSetter = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_typedAttributeList::modifier_setMHasGetterAtIndex (GALGAS_bool inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_typedAttributeList * p = (cCollectionElement_typedAttributeList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    p->mAttribute_mHasGetter = inOperand ;
  }
}
...
GALGAS_unifiedTypeMapProxy GALGAS_typedAttributeList::reader_mAttributeTypeProxyAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    result = p->mAttribute_mAttributeTypeProxy ;
  }
  return result ;
}
...
GALGAS_bool GALGAS_typedAttributeList::reader_mHasSetterAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    result = p->mAttribute_mHasSetter ;
  }
  return result ;
}
...
GALGAS_bool GALGAS_typedAttributeList::reader_mHasGetterAtIndex (const GALGAS_uint & inIndex,
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_typedAttributeList) ;
    result = p->mAttribute_mHasGetter ;
  }
  return result ;
}
...
GALGAS_unifiedTypeMapProxy cEnumerator_typedAttributeList::current_mAttributeTypeProxy (LOCATION_ARGS) const {
  ...
  return p->mAttribute_mAttributeTypeProxy ;
}
...
GALGAS_bool cEnumerator_typedAttributeList::current_mHasSetter (LOCATION_ARGS) const {
  const cCollectionElement_typedAttributeList * p = (const cCollectionElement_typedAttributeList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_typedAttributeList) ;
  return p->mAttribute_mHasSetter ;
}
...
GALGAS_bool cEnumerator_typedAttributeList::current_mHasGetter (LOCATION_ARGS) const {
  const cCollectionElement_typedAttributeList * p = (const cCollectionElement_typedAttributeList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_typedAttributeList) ;
  return p->mAttribute_mHasGetter ;
}
...
enumComparisonResult GALGAS_predefinedTypeKindEnum::objectCompare (const GALGAS_predefinedTypeKindEnum & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static const char * gEnumNameArrayFor_typeKindEnum_kind [11] = {
  "",
  "class",
  "enumeration",
  "list",
...
GALGAS_string GALGAS_typeKindEnum::reader_kind (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (isValid ()) {
    result = GALGAS_string (gEnumNameArrayFor_typeKindEnum_kind [mEnum]) ;
  }
  return result ;
}
...
static const char * gEnumNameArrayFor_typeKindEnum [11] = {
  "(not built)",
  "classType",
  "enumType",
  "listType",
...
enumComparisonResult GALGAS_typeKindEnum::objectCompare (const GALGAS_typeKindEnum & inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
static GALGAS_uint onceFunction_binaryAddOperator (C_Compiler * /* inCompiler */
  ...
  result_uint = GALGAS_uint ((PMUInt32) 1U) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binarySubOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (231)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryMulOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 2U) COMMA_SOURCE_FILE_AT_LINE (232)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryDivOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 3U) COMMA_SOURCE_FILE_AT_LINE (233)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryModOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 4U) COMMA_SOURCE_FILE_AT_LINE (234)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryShiftOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 5U) COMMA_SOURCE_FILE_AT_LINE (235)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryPlusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 6U) COMMA_SOURCE_FILE_AT_LINE (236)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryMinusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (237)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryTildeOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 8U) COMMA_SOURCE_FILE_AT_LINE (238)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_incDecOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (239)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryAndOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 10U) COMMA_SOURCE_FILE_AT_LINE (241)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryOrOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 11U) COMMA_SOURCE_FILE_AT_LINE (242)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryXorOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 12U) COMMA_SOURCE_FILE_AT_LINE (243)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryNotOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 13U) COMMA_SOURCE_FILE_AT_LINE (244)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryConcatOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 14U) COMMA_SOURCE_FILE_AT_LINE (246)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_dotAssignOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (247)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_isComparable (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 16U) COMMA_SOURCE_FILE_AT_LINE (248)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateEnumerationHelperMethods (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 28U) COMMA_SOURCE_FILE_AT_LINE (250)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_doNotGenererateObjectCompare (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 29U) COMMA_SOURCE_FILE_AT_LINE (251)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateDescriptionReaderUtilityMethod (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 30U) COMMA_SOURCE_FILE_AT_LINE (252)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateCopyConstructorAndAssignmentOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 31U) COMMA_SOURCE_FILE_AT_LINE (253)) ;
//---
  return result_uint ;
}
...
enumComparisonResult cMapElement_attributeMap::compare (const cCollectionElement * inOperand) const {
...
cMapElement * cMapElement_unifiedTypeMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_unifiedTypeMap (mAttribute_lkey, mAttribute_mIsConcrete, mAttribute_mSuperType, mAttribute_mTypeKindEnum, mAttribute_mAllTypedAttributeList, mAttribute_mAttributeMap, mAttribute_mCurrentTypedAttributeList, mAttribute_mConstructorMap, mAttribute_mReaderMap, mAttribute_mModifierMap, mAttribute_mInstanceMethodMap, mAttribute_mClassMethodMap, mAttribute_mEnumerationDescriptor, mAttribute_mHandledOperatorFlags, mAttribute_mAddAssignOperatorArguments, mAttribute_mEnumConstantSet, mAttribute_mEnumConstantList, mAttribute_mMapSearchMethodList, mAttribute_mMapProxySearchConstructorList, mAttribute_mWithAccessorMap, mAttribute_mGenerateHeaderInSeparateFile COMMA_HERE)) ;
  return result ;
}
...
enumComparisonResult cMapElement_unifiedTypeMap::compare (const cCollectionElement * inOperand) const {
...
/*GALGAS_unifiedTypeMap GALGAS_unifiedTypeMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap result ;
  overridenMap (result) ;
  return result ;
}*/
...
void GALGAS_unifiedTypeMap::method_searchKey (GALGAS_lstring inKey,
                                              ...
                                              GALGAS_uint & outArgument12,
                                              GALGAS_unifiedTypeMapProxyList & outArgument13,
                                              GALGAS_stringset & outArgument14,
                                              GALGAS_lstringlist & outArgument15,
                                              GALGAS_mapSearchMethodListAST & outArgument16,
                                              GALGAS_mapSearchMethodListAST & outArgument17,
                                              GALGAS_withAccessorMap & outArgument18,
                                              GALGAS_bool & outArgument19,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument12 = p->mAttribute_mHandledOperatorFlags ;
    outArgument13 = p->mAttribute_mAddAssignOperatorArguments ;
    outArgument14 = p->mAttribute_mEnumConstantSet ;
    outArgument15 = p->mAttribute_mEnumConstantList ;
    outArgument16 = p->mAttribute_mMapSearchMethodList ;
    outArgument17 = p->mAttribute_mMapProxySearchConstructorList ;
    outArgument18 = p->mAttribute_mWithAccessorMap ;
    outArgument19 = p->mAttribute_mGenerateHeaderInSeparateFile ;
  }
}
...
enumComparisonResult GALGAS_predefinedTypeAST::objectCompare (const GALGAS_predefinedTypeAST & inOperand) const {
  ...
  macroNullOrValidSharedObject (p, const cPtr_predefinedTypeAST) ;
  const cPtr_predefinedTypeAST * q = (const cPtr_predefinedTypeAST *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_predefinedTypeAST) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_mPredefinedTypeName.objectCompare (q->mAttribute_mPredefinedTypeName) ;
  }
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_applicationPredefinedTypeAST::objectCompare (const GALGAS_applicationPredefinedTypeAST & inOperand) const {
...
enumComparisonResult GALGAS_binarysetPredefinedTypeAST::objectCompare (const GALGAS_binarysetPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_boolPredefinedTypeAST::objectCompare (const GALGAS_boolPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_charPredefinedTypeAST::objectCompare (const GALGAS_charPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_dataPredefinedTypeAST::objectCompare (const GALGAS_dataPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_doublePredefinedTypeAST::objectCompare (const GALGAS_doublePredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_filewrapperPredefinedTypeAST::objectCompare (const GALGAS_filewrapperPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_functionPredefinedTypeAST::objectCompare (const GALGAS_functionPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_locationPredefinedTypeAST::objectCompare (const GALGAS_locationPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_objectPredefinedTypeAST::objectCompare (const GALGAS_objectPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_sint_36__34_PredefinedTypeAST::objectCompare (const GALGAS_sint_36__34_PredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_sintPredefinedTypeAST::objectCompare (const GALGAS_sintPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_stringPredefinedTypeAST::objectCompare (const GALGAS_stringPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_stringsetPredefinedTypeAST::objectCompare (const GALGAS_stringsetPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_typePredefinedTypeAST::objectCompare (const GALGAS_typePredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_uint_36__34_PredefinedTypeAST::objectCompare (const GALGAS_uint_36__34_PredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_uintPredefinedTypeAST::objectCompare (const GALGAS_uintPredefinedTypeAST & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (352)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (361)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (370)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (379)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (388)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (405)) ;
}
//---------------------------------------------------------------------------*
...
//--- Find method
  if (NULL != inObject) {
    ...
    f (inObject, io_ioUnifiedTypeMap, out_outEnumerationList, inCompiler COMMA_THERE) ;
  }
}
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (418)) ;
}
//---------------------------------------------------------------------------*
