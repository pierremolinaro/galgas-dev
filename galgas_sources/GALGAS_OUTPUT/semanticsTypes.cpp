...
GALGAS_unifiedTypeMap_2D_proxy categoryReader_baseType (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).isValid ()) {
    uint32_t variant_15576 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).uintValue () ;
    bool loop_15576 = true ;
    while (loop_15576) {
      loop_15576 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 349)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).isValid () ;
      if (loop_15576) {
        loop_15576 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 349)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 349)).boolValue () ;
      }
      if (loop_15576 && (0 == variant_15576)) {
        loop_15576 = false ;
