...
GGS_uint  function_generateCppConstructorWithNativeAttributeListInAutoPointerClass (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (21U) COMMA_SOURCE_FILE_AT_LINE (233)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateConstructorWithSelfObject (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (22U) COMMA_SOURCE_FILE_AT_LINE (234)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateSortedListComparisonMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (23U) COMMA_SOURCE_FILE_AT_LINE (235)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateEnumerationHelperMethods (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (236)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithAllAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (25U) COMMA_SOURCE_FILE_AT_LINE (237)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithCurrentAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (26U) COMMA_SOURCE_FILE_AT_LINE (238)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateCppConstructorWithNativeAttributeList (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (27U) COMMA_SOURCE_FILE_AT_LINE (239)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_doNotGenererateObjectCompare (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (28U) COMMA_SOURCE_FILE_AT_LINE (240)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateDescriptionReaderUtilityMethod (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (29U) COMMA_SOURCE_FILE_AT_LINE (241)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateNativeNewConstructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (30U) COMMA_SOURCE_FILE_AT_LINE (242)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_uint  function_generateVirtualDestructor (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  GGS_uint  var_cas_outMask ;
  var_cas_outMask = GGS_uint (1U).left_shift_operation (inLexique, GGS_uint (31U) COMMA_SOURCE_FILE_AT_LINE (243)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__predefinedTypeAST__getSuperTypeName (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_16211
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outSuperTypeName ;
  if (operand_16211 != NULL) {
...
category_method__predefinedTypeAST__getConstructorMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16460,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_constructorMap  & var_cas_outConstructorMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16460 != NULL) {
    var_cas_outConstructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
  }
}
...
category_method__predefinedTypeAST__getReaderMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16727,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_readerMap  & var_cas_outReaderMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16727 != NULL) {
    var_cas_outReaderMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (363)) ;
  }
}
...
category_method__predefinedTypeAST__getModifierMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_16976,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_modifierMap  & var_cas_outModifierMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16976 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (372)) ;
  }
}
...
category_method__predefinedTypeAST__getInstanceMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_17239,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_instanceMethodMap  & var_cas_outInstanceMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17239 != NULL) {
    var_cas_outInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (381)) ;
  }
}
...
category_method__predefinedTypeAST__getClassMethodMap (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_17523,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_classMethodMap  & var_cas_outClassMethodMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17523 != NULL) {
    var_cas_outClassMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
}
...
category_reader__predefinedTypeAST__getSupportedOperatorFlags (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_17803
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_uint  var_cas_outFlags ;
  if (operand_17803 != NULL) {
...
category_method__predefinedTypeAST__getAddAssignArgumentList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_18010,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_unifiedTypeMapProxyList  & var_cas_outAddAssignArgumentList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18010 != NULL) {
...
category_reader__predefinedTypeAST__getNativeAttributeList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_18654
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_nativeAttributeList  var_cas_outNativeAttributeList ;
  if (operand_18654 != NULL) {
...
category_method__predefinedTypeAST__getEnumerationList (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_19240,
                                GGS_unifiedTypeMap  & /* var_cas_ioUnifiedTypeMap */,
                                GGS_enumerationDescriptorList  & var_cas_outEnumerationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19240 != NULL) {
