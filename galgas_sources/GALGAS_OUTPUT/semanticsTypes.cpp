...
bool cMapElement_readerMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIsCategory.isValid () && mAttribute_mArgumentTypeList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mReturnedType.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}
...
cMapElement * cMapElement_readerMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_readerMap (mAttribute_lkey, mAttribute_mIsCategory, mAttribute_mArgumentTypeList, mAttribute_mDeclarationLocation, mAttribute_mHasCompilerArgument, mAttribute_mReturnedType, mAttribute_mQualifier, mAttribute_mErrorMessage COMMA_HERE)) ;
  return result ;
}
...
bool cMapElement_modifierMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}
...
cMapElement * cMapElement_modifierMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_modifierMap (mAttribute_lkey, mAttribute_mParameterList, mAttribute_mHasCompilerArgument, mAttribute_mQualifier, mAttribute_mErrorMessage COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_modifierMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_modifierMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_modifierMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument3 = p->mAttribute_mErrorMessage ;
  }
}
...
bool cMapElement_instanceMethodMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIsCategory.isValid () && mAttribute_mParameterList.isValid () && mAttribute_mDeclarationLocation.isValid () && mAttribute_mHasCompilerArgument.isValid () && mAttribute_mQualifier.isValid () && mAttribute_mErrorMessage.isValid () ;
}
...
cMapElement * cMapElement_instanceMethodMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_instanceMethodMap (mAttribute_lkey, mAttribute_mIsCategory, mAttribute_mParameterList, mAttribute_mDeclarationLocation, mAttribute_mHasCompilerArgument, mAttribute_mQualifier, mAttribute_mErrorMessage COMMA_HERE)) ;
  return result ;
}
...
static const char * gEnumNameArrayFor_typeKindEnum_kind [12] = {
  "",
  "class",
  "enumeration",
  "list",
...
static GALGAS_uint onceFunction_binarySubOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 1U) COMMA_SOURCE_FILE_AT_LINE (236)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryMulOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 2U) COMMA_SOURCE_FILE_AT_LINE (237)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryDivOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 3U) COMMA_SOURCE_FILE_AT_LINE (238)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryModOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 4U) COMMA_SOURCE_FILE_AT_LINE (239)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryShiftOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 5U) COMMA_SOURCE_FILE_AT_LINE (240)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryPlusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 6U) COMMA_SOURCE_FILE_AT_LINE (241)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryMinusOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 7U) COMMA_SOURCE_FILE_AT_LINE (242)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryTildeOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 8U) COMMA_SOURCE_FILE_AT_LINE (243)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_incDecOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 9U) COMMA_SOURCE_FILE_AT_LINE (244)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryAndOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 10U) COMMA_SOURCE_FILE_AT_LINE (246)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryOrOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 11U) COMMA_SOURCE_FILE_AT_LINE (247)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryXorOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 12U) COMMA_SOURCE_FILE_AT_LINE (248)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_unaryNotOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 13U) COMMA_SOURCE_FILE_AT_LINE (249)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_binaryConcatOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 14U) COMMA_SOURCE_FILE_AT_LINE (251)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_dotAssignOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 15U) COMMA_SOURCE_FILE_AT_LINE (252)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_isComparable (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 16U) COMMA_SOURCE_FILE_AT_LINE (253)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateEnumerationHelperMethods (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 28U) COMMA_SOURCE_FILE_AT_LINE (255)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_doNotGenererateObjectCompare (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 29U) COMMA_SOURCE_FILE_AT_LINE (256)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateDescriptionReaderUtilityMethod (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 30U) COMMA_SOURCE_FILE_AT_LINE (257)) ;
//---
  return result_uint ;
}
...
static GALGAS_uint onceFunction_generateCopyConstructorAndAssignmentOperator (C_Compiler * /* inCompiler */
  ...
  GALGAS_uint result_uint ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_uint = GALGAS_uint ((PMUInt32) 1U).left_shift_operation (GALGAS_uint ((PMUInt32) 31U) COMMA_SOURCE_FILE_AT_LINE (258)) ;
//---
  return result_uint ;
}
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (357)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (366)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (375)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (384)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (393)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (410)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @assignmentInstructionForGeneration
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (423)) ;
}
//---------------------------------------------------------------------------*
