...
GALGAS_unifiedTypeMapProxyList GALGAS_constructorMap_2E_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_unifiedTypeMapProxyList GALGAS_readerMap_2E_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mArgumentTypeList ;
}
...
GALGAS_formalParameterSignature_2E_element GALGAS_formalParameterSignature_2E_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_formalParameterSignature_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
