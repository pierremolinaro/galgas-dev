...
void GALGAS_constructorMap::addAssign_operation (const GALGAS_lstring & inKey,
                                                 const GALGAS_unifiedTypeMapProxyAndParameterList & inArgument0,
...
void GALGAS_readerMap::addAssign_operation (const GALGAS_lstring & inKey,
                                            ...
                                            const GALGAS_unifiedTypeMapProxyAndParameterList & inArgument1,
...
void GALGAS_withAccessorMap::addAssign_operation (const GALGAS_lstring & inKey,
  ...
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
  const char * kInsertErrorMessage = "@withAccessorMap insert error: '%K' already in map" ;
  const char * kShadowErrorMessage = "" ;
  performInsert (attributes, inCompiler, kInsertErrorMessage, kShadowErrorMessage COMMA_THERE) ;
}
...
cMapElement_withAccessorMap * GALGAS_withAccessorMap::readWriteAccessForWithInstruction (C_Compiler * inCompiler,
                                                                                         const GALGAS_string & inKey
                                                                                         COMMA_LOCATION_ARGS) {
  cMapElement_withAccessorMap * result = (cMapElement_withAccessorMap *) searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_withAccessorMap_2D_element cEnumerator_withAccessorMap::current (LOCATION_ARGS) const {
  const cMapElement_withAccessorMap * p = (const cMapElement_withAccessorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_withAccessorMap) ;
  return GALGAS_withAccessorMap_2D_element (p->mAttribute_lkey, p->mAttribute_mArgumentType) ;
}
...
static GALGAS_uint onceFunction_binarySubOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 1U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 254)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryMulOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 2U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 255)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryDivOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 3U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 256)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryModOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 4U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 257)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryShiftOperator (C_Compiler * /* inCompiler */
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 5U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 258)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryPlusOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 6U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 259)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryMinusOperator (C_Compiler * /* inCompiler */
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 7U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 260)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryTildeOperator (C_Compiler * /* inCompiler */
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 8U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 261)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_incDecOperator (C_Compiler * /* inCompiler */
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 9U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 262)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryAndOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 10U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 264)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryOrOperator (C_Compiler * /* inCompiler */
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 11U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 265)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryXorOperator (C_Compiler * /* inCompiler */
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 12U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 266)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_unaryNotOperator (C_Compiler * /* inCompiler */
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 13U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 267)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_binaryConcatOperator (C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 14U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 269)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_plusEqualOperatorWithExpression (C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 15U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 270)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_isComparable (C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 16U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 271)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_supportWithAccessor (C_Compiler * /* inCompiler */
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 26U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 273)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_plusEqualOperatorWithFieldListNeedsCompilerArg (C_Compiler * /* inCompiler */
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 27U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 274)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateEnumerationHelperMethods (C_Compiler * /* inCompiler */
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 28U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 275)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_doNotGenererateObjectCompare (C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 29U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 276)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateDescriptionReaderUtilityMethod (C_Compiler * /* inCompiler */
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 30U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 277)) ;
//---
  return result_outMask ;
}
...
static GALGAS_uint onceFunction_generateCopyConstructorAndAssignmentOperator (C_Compiler * /* inCompiler */
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint result_outMask ; // Returned variable
  result_outMask = GALGAS_uint ((uint32_t) 1U).left_shift_operation (GALGAS_uint ((uint32_t) 31U) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 278)) ;
//---
  return result_outMask ;
}
...
cMapElement_unifiedTypeMap::cMapElement_unifiedTypeMap (const GALGAS_lstring & inKey,
                                                        ...
                                                        const GALGAS_unifiedTypeMapProxyAndParameterList & in_mWithAccessorParameterList,
...
mAttribute_mWithAccessorParameterList (in_mWithAccessorParameterList),
...
void cMapElement_unifiedTypeMap::description (C_String & ioString, const int32_t inIndentation) const {
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mWithAccessorParameterList" ":" ;
  mAttribute_mWithAccessorParameterList.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
typeComparisonResult cMapElement_unifiedTypeMap::compare (const cCollectionElement * inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mWithAccessorParameterList.objectCompare (operand->mAttribute_mWithAccessorParameterList) ;
  }
  if (kOperandEqual == result) {
...
void GALGAS_unifiedTypeMap::modifier_insertKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_unifiedTypeMapProxyAndParameterList inArgument16,
                                                ...
                                                GALGAS_unifiedTypeMapProxyAndParameterList inArgument21,
                                                GALGAS_withAccessorMap inArgument22,
                                                GALGAS_bool inArgument23,
                                                GALGAS_unifiedTypeMapProxy inArgument24,
                                                GALGAS_string inArgument25,
                                                GALGAS_string inArgument26,
                                                GALGAS_headerKind inArgument27,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) {
...
void GALGAS_unifiedTypeMap::method_searchKey (GALGAS_lstring inKey,
                                              ...
                                              GALGAS_unifiedTypeMapProxyAndParameterList & outArgument16,
                                              ...
                                              GALGAS_unifiedTypeMapProxyAndParameterList & outArgument21,
                                              GALGAS_withAccessorMap & outArgument22,
                                              GALGAS_bool & outArgument23,
                                              GALGAS_unifiedTypeMapProxy & outArgument24,
                                              GALGAS_string & outArgument25,
                                              GALGAS_string & outArgument26,
                                              GALGAS_headerKind & outArgument27,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument21 = p->mAttribute_mWithAccessorParameterList ;
    outArgument22 = p->mAttribute_mWithAccessorMap ;
    outArgument23 = p->mAttribute_mGenerateHeaderInSeparateFile ;
    outArgument24 = p->mAttribute_mTypeForEnumeratedElement ;
    outArgument25 = p->mAttribute_mDefaultConstructorName ;
    outArgument26 = p->mAttribute_mHeaderFileName ;
    outArgument27 = p->mAttribute_mHeaderKind ;
  }
}
...
GALGAS_unifiedTypeMapProxyAndParameterList GALGAS_unifiedTypeMap::reader_mWithAccessorParameterListForKey (const GALGAS_string & inKey,
                                                                                                           C_Compiler * inCompiler
                                                                                                           COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_unifiedTypeMap * p = (const cMapElement_unifiedTypeMap *) attributes ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_unifiedTypeMap) ;
    result = p->mAttribute_mWithAccessorParameterList ;
  }
  return result ;
}
...
void GALGAS_unifiedTypeMap::modifier_setMWithAccessorParameterListForKey (GALGAS_unifiedTypeMapProxyAndParameterList inAttributeValue,
                                                                          GALGAS_string inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_unifiedTypeMap) ;
    p->mAttribute_mWithAccessorParameterList = inAttributeValue ;
  }
}
...
GALGAS_unifiedTypeMapProxyAndParameterList cEnumerator_unifiedTypeMap::current_mWithAccessorParameterList (LOCATION_ARGS) const {
  const cMapElement_unifiedTypeMap * p = (const cMapElement_unifiedTypeMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_unifiedTypeMap) ;
  return p->mAttribute_mWithAccessorParameterList ;
}
...
GALGAS_unifiedTypeMapProxyAndParameterList GALGAS_unifiedTypeMapProxy::reader_mWithAccessorParameterList (C_Compiler * inCompiler
                                                                                                          COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMapProxyAndParameterList result ;
  const cMapElement_unifiedTypeMap * p = (const cMapElement_unifiedTypeMap *) getAttributeListPointer (inCompiler, "mWithAccessorParameterList" COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_unifiedTypeMap) ;
    result = p->mAttribute_mWithAccessorParameterList;
  }
...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).isValid ()) {
    uint32_t variant_15832 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).uintValue () ;
    bool loop_15832 = true ;
    while (loop_15832) {
      loop_15832 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 342)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).isValid () ;
      if (loop_15832) {
        loop_15832 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 342)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 342)).boolValue () ;
      }
      if (loop_15832 && (0 == variant_15832)) {
        loop_15832 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticsTypes.gSemantics", 342)) ;
      }
      if (loop_15832) {
        variant_15832 -- ;
        result_outBaseType = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 343)) ;
      }
    }
  }
//---
...
void categoryMethod_addHeaderFileName (const GALGAS_unifiedTypeMapProxy inObject,
  ...
  const enumGalgasBool test_2 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 352)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 352)).operator_and (GALGAS_bool (kIsNotEqual, temp_1.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 352)).objectCompare (GALGAS_headerKind::constructor_noHeader (SOURCE_FILE ("semanticsTypes.gSemantics", 352)))) COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 352)).boolEnum () ;
  if (kBoolTrue == test_2) {
    const GALGAS_unifiedTypeMapProxy temp_3 = inObject ;
    ioArgument_ioInclusions.addAssign_operation (temp_3.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 353))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 353)) ;
  }
}
...
void categoryMethod_addHeaderFileName_31_ (const GALGAS_unifiedTypeMapProxy inObject,
                                           ...
                                           COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_unifiedTypeMapProxy temp_0 = inObject ;
  const enumGalgasBool test_1 = temp_0.reader_mIsPredefined (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 362)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 362)).boolEnum () ;
  if (kBoolTrue == test_1) {
    const GALGAS_unifiedTypeMapProxy temp_2 = inObject ;
    if (temp_2.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 363)).isValid ()) {
      switch (temp_2.reader_mHeaderKind (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 363)).enumValue ()) {
      ...
      case GALGAS_headerKind::kEnum_oneHeader: {
        const GALGAS_unifiedTypeMapProxy temp_3 = inObject ;
        ioArgument_ioInclusions.addAssign_operation (temp_3.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 366))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 366)) ;
        } break ;
      case GALGAS_headerKind::kEnum_twoHeaders: {
        const GALGAS_unifiedTypeMapProxy temp_4 = inObject ;
        ioArgument_ioInclusions.addAssign_operation (temp_4.reader_mHeaderFileName (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 368)).operator_concat (GALGAS_string ("-1")  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 368))  COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 368)) ;
        } break ;
      }
    }
  }
...
static void categoryMethod_predefinedTypeAST_getConstructorMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outConstructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 426)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getReaderMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                           ...
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outReaderMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 435)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getModifierMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                             ...
                                                             C_Compiler * /* inCompiler */
                                                             COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outModifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 444)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getInstanceMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                   ...
                                                                   C_Compiler * /* inCompiler */
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 453)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getClassMethodMap (const cPtr_predefinedTypeAST * /* inObject */,
                                                                ...
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outClassMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticsTypes.gSemantics", 462)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getAddAssignArgumentList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                       ...
                                                                       C_Compiler * /* inCompiler */
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outAddAssignArgumentList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 479)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_getEnumerationList (const cPtr_predefinedTypeAST * /* inObject */,
                                                                 ...
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outEnumerationList = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 494)) ;
  outArgument_outEnumerationVariant = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticsTypes.gSemantics", 495)) ;
...
GALGAS_string GALGAS_unifiedTypeMapProxyAndParameterList_2D_element::reader_mFormalParameterName (UNUSED_LOCATION_ARGS) const {
...
GALGAS_unifiedTypeMapProxyAndParameterList GALGAS_constructorMap_2D_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_unifiedTypeMapProxyAndParameterList GALGAS_readerMap_2D_element::reader_mArgumentTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mArgumentTypeList ;
}
...
GALGAS_formalParameterSignature_2D_element::GALGAS_formalParameterSignature_2D_element (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                        const GALGAS_formalArgumentPassingModeAST & inOperand1,
                                                                                        const GALGAS_string & inOperand2) :
...
GALGAS_formalParameterSignature_2D_element GALGAS_formalParameterSignature_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_formalParameterSignature_2D_element (GALGAS_unifiedTypeMapProxy::constructor_null (HERE),
...
GALGAS_formalParameterSignature_2D_element GALGAS_formalParameterSignature_2D_element::constructor_new (const GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                                                        const GALGAS_formalArgumentPassingModeAST & inOperand1,
                                                                                                        const GALGAS_string & inOperand2 
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_formalParameterSignature_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_formalParameterSignature_2D_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
GALGAS_withAccessorMap_2D_element::GALGAS_withAccessorMap_2D_element (void) :
mAttribute_lkey (),
...
GALGAS_withAccessorMap_2D_element::GALGAS_withAccessorMap_2D_element (const GALGAS_lstring & inOperand0,
...
GALGAS_withAccessorMap_2D_element GALGAS_withAccessorMap_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_withAccessorMap_2D_element (GALGAS_lstring::constructor_default (HERE),
                                            GALGAS_unifiedTypeMapProxy::constructor_null (HERE)) ;
}

//-----------------------------------------------------------------------------*

GALGAS_withAccessorMap_2D_element GALGAS_withAccessorMap_2D_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_unifiedTypeMapProxy & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_withAccessorMap_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_withAccessorMap_2D_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_withAccessorMap_2D_element::objectCompare (const GALGAS_withAccessorMap_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_withAccessorMap_2D_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mArgumentType.isValid () ;
}

//-----------------------------------------------------------------------------*

void GALGAS_withAccessorMap_2D_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_withAccessorMap_2D_element::description (C_String & ioString,
                                                     const int32_t inIndentation) const {
...
GALGAS_lstring GALGAS_withAccessorMap_2D_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//-----------------------------------------------------------------------------*

GALGAS_unifiedTypeMapProxy GALGAS_withAccessorMap_2D_element::reader_mArgumentType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_withAccessorMap_2D_element ("withAccessorMap-element",
                                                   NULL) ;

//-----------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_withAccessorMap_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_withAccessorMap_2D_element ;
}

//-----------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_withAccessorMap_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_withAccessorMap_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_withAccessorMap_2D_element GALGAS_withAccessorMap_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_withAccessorMap_2D_element result ;
  const GALGAS_withAccessorMap_2D_element * p = (const GALGAS_withAccessorMap_2D_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_withAccessorMap_2D_element *> (p)) {
      result = *p ;
    }else{
