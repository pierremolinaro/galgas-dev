...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid ()) {
    uint32_t variant_15618 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).uintValue () ;
    bool loop_15618 = true ;
    while (loop_15618) {
      loop_15618 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).isValid () ;
      if (loop_15618) {
        loop_15618 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 340)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 340)).boolValue () ;
      }
      if (loop_15618 && (0 == variant_15618)) {
        loop_15618 = false ;
