...
GALGAS_unifiedTypeMapProxy categoryReader_baseType (const GALGAS_unifiedTypeMapProxy & inObject,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).isValid ()) {
    uint32_t variant_15364 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).uintValue () ;
    bool loop_15364 = true ;
    while (loop_15364) {
      loop_15364 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 331)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).isValid () ;
      if (loop_15364) {
        loop_15364 = result_outBaseType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticsTypes.gSemantics", 331)).reader_isNull (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).operator_not (SOURCE_FILE ("semanticsTypes.gSemantics", 331)).boolValue () ;
      }
