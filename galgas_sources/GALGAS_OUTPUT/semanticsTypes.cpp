...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_uint _variant_17771 = var_cas_inTypeCount ;
  GGS_bool _condition_17771 (_variant_17771.isBuilt (), true) ;
  while (_condition_17771.isBuiltAndTrue ()) {
    _condition_17771 = ((var_cas_superClassIndex.reader_isRegular (inLexique COMMA_SOURCE_FILE_AT_LINE (349))).operator_and (var_cas_ok)).operator_and ((var_cas_circularityError).operator_not ()) ;
    if (_condition_17771.isBuiltAndTrue ()) {
      if (_variant_17771.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (370)) ;
        _condition_17771 = GGS_bool (false) ;
      }else{
        _variant_17771.decrement_operation (inLexique COMMA_HERE) ;
        GGS_lstring  var_cas_superClassName ;
        GGS_ACGalgasType  var_cas_t ;
        const GGS_typeMapIndex  temp_17026 = var_cas_superClassIndex ;
        if (temp_17026.isBuilt ()) {
          temp_17026 (HERE)->method_searchKey (inLexique, var_cas_superClassName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (353)) ;
        }
        ...
        { const GGS_ACGalgasType _var_17708 = var_cas_t ; // CAST instruction
          if (_var_17708.getPtr () != NULL) {
            macroValidPointer (_var_17708.getPtr ()) ;
            if (dynamic_cast <cPtr_classGalgasType *> (_var_17708.getPtr ()) != NULL) {
              const GGS_classGalgasType var_cas_kClassType (_var_17708.getPtr ()) ;
  ...
  const GGS_bool cond_18018 = var_cas_circularityError ;
  if (cond_18018.isBuiltAndTrue ()) {
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  temp_19254 = mAssociatedListTypeIndex ;
  if (temp_19254.isBuilt ()) {
    temp_19254 (HERE)->method_searchKey (inLexique, var_cas_listTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (406)) ;
  }
  { const GGS_ACGalgasType _var_19523 = var_cas_t ; // CAST instruction
    if (_var_19523.getPtr () != NULL) {
      macroValidPointer (_var_19523.getPtr ()) ;
      if (dynamic_cast <cPtr_listGalgasType *> (_var_19523.getPtr ()) != NULL) {
      }else{
...
method_checkTypeCrossReferences (C_Compiler & inLexique,
  ...
  GGS_ACGalgasType  var_cas_t ;
  const GGS_typeMapIndex  temp_22664 = mIndexOfMapType ;
  if (temp_22664.isBuilt ()) {
    temp_22664 (HERE)->method_searchKey (inLexique, var_cas_mapTypeName, var_cas_t COMMA_SOURCE_FILE_AT_LINE (491)) ;
  }
  { const GGS_ACGalgasType _var_22918 = var_cas_t ; // CAST instruction
    if (_var_22918.getPtr () != NULL) {
      macroValidPointer (_var_22918.getPtr ()) ;
      if (dynamic_cast <cPtr_mapType *> (_var_22918.getPtr ()) != NULL) {
      }else{
...
void routine_addTypeList (C_Compiler & inLexique,
  ...
  GGS_typeMapIndex::class_method_makeRegularIndex (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inElementTypeName, GGS_location (inLexique) COMMA_HERE), var_cas_ioTypeMap, var_cas_lstringIndex COMMA_SOURCE_FILE_AT_LINE (542)) ;
  ...
  var_cas_ioTypeMap.modifier_insertKey (inLexique, var_cas_lstringlist, GGS_listGalgasType ::constructor_new (inLexique, var_cas_lstringlist, var_cas_lstringAttribute COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (545)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_typeMap  function_constructPrimitiveTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_typeMap  var_cas_outTypeMap ;
    ...
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_HERE), GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (553)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_HERE), GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (554)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("bool"), GGS_location (inLexique) COMMA_HERE), GGS_boolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (555)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_HERE), GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (556)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint"), GGS_location (inLexique) COMMA_HERE), GGS_sintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (557)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64"), GGS_location (inLexique) COMMA_HERE), GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (558)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sint64"), GGS_location (inLexique) COMMA_HERE), GGS_sint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (559)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("double"), GGS_location (inLexique) COMMA_HERE), GGS_doubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (560)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_HERE), GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (561)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_HERE), GGS_lcharGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (562)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lbool"), GGS_location (inLexique) COMMA_HERE), GGS_lboolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (563)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_HERE), GGS_luintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint"), GGS_location (inLexique) COMMA_HERE), GGS_lsintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (565)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("luint64"), GGS_location (inLexique) COMMA_HERE), GGS_luint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (566)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lsint64"), GGS_location (inLexique) COMMA_HERE), GGS_lsint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (567)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ldouble"), GGS_location (inLexique) COMMA_HERE), GGS_ldoubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (568)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("binaryset"), GGS_location (inLexique) COMMA_HERE), GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (569)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringset"), GGS_location (inLexique) COMMA_HERE), GGS_stringsetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (570)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_HERE), GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (571)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("data"), GGS_location (inLexique) COMMA_HERE), GGS_dataGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (572)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("type"), GGS_location (inLexique) COMMA_HERE), GGS_typeGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (573)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("function"), GGS_location (inLexique) COMMA_HERE), GGS_functionGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (574)) ;
    var_cas_outTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("object"), GGS_location (inLexique) COMMA_HERE), GGS_objectGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (575)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_typeMap  function_constructBuiltinTypeMap (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_constructBuiltinTypeMap) {
    ...
    #endif
  GGS_typeMap  var_cas_outTypeMap ;
    var_cas_outTypeMap = function_constructPrimitiveTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("lstring"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (583)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("string"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (585)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("type"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (587)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint64"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (589)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("luint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (591)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("uint"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (593)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("function"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (595)) ;
    ::routine_addTypeList (inLexique,  GGS_string ("object"),  var_cas_outTypeMap COMMA_SOURCE_FILE_AT_LINE (597)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_lstringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (615)) ;
    const GGS_typeMap  temp_28891 = var_cas_typeMap ;
    if (temp_28891.isBuilt ()) {
      temp_28891 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("lstringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (616)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_stringlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_stringlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (622)) ;
    const GGS_typeMap  temp_29162 = var_cas_typeMap ;
    if (temp_29162.isBuilt ()) {
      temp_29162 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (623)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_uint64list_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_uint64list_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (629)) ;
    const GGS_typeMap  temp_29432 = var_cas_typeMap ;
    if (temp_29432.isBuilt ()) {
      temp_29432 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("uint64list"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (630)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_typelist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_typelist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (636)) ;
    const GGS_typeMap  temp_29700 = var_cas_typeMap ;
    if (temp_29700.isBuilt ()) {
      temp_29700 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("typelist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (637)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_objectlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_objectlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (643)) ;
    const GGS_typeMap  temp_29968 = var_cas_typeMap ;
    if (temp_29968.isBuilt ()) {
      temp_29968 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("objectlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (644)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
...
GGS_ACGalgasType  function_build_functionlist_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  if (! gCacheFlagForOnceFunction_build_functionlist_type) {
    ...
    #endif
  GGS_ACGalgasType  var_cas_outType ;
    const GGS_typeMap  var_cas_typeMap = function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (650)) ;
    const GGS_typeMap  temp_30240 = var_cas_typeMap ;
    if (temp_30240.isBuilt ()) {
      temp_30240 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("functionlist"), GGS_location (inLexique) COMMA_HERE), var_cas_outType COMMA_SOURCE_FILE_AT_LINE (651)) ;
    }
    #ifdef DEBUG_TRACE_ENABLED
