...
pr_program_component_start_symbol_programModelBuilder_45_37_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_semanticInstructionList  var_cas_mPrologueInstructionList = GGS_semanticInstructionList ::constructor_emptyList () ;
    ...
    while (syntaxRepeat_2) {
      switch (select_programModelBuilder_2 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_4074 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100))).operator_isNotEqual (GGS_string ("lstring")) ;
          if (cond_4074.isBuiltAndTrue ()) {
