...
pr_program_component_start_symbol_programModelBuilder_45_4_ (galgas_scanner & _inLexique) {
  GGS_semanticInstructions  var_cas_mEpilogueInstructionList ;
  ...
  GGS_semanticInstructions  var_cas_mPrologueInstructionList ;
  ...
  var_cas_mPrologueInstructionList = nt_semantic_instruction_list_ (_inLexique) ;
  ...
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
      switch (select_repeat_programModelBuilder_2 (_inLexique)) {
        case 2 : {
          var_cas_mProgramRules._addAssign_operation (nt_program_rule_ (_inLexique)) ;
          } break ;
        case 3 : {
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B) COMMA_HERE) ;
  var_cas_mEpilogueInstructionList = nt_semantic_instruction_list_ (_inLexique) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  GGS_programComponentRoot _entityInstance = GGS_programComponentRoot::constructor_new (_inLexique, var_cas_mProgramName, var_cas_mVersionString, var_cas_mPrologueInstructionList, var_cas_mEpilogueInstructionList, var_cas_mProgramRules, var_cas_mSemanticDeclarations COMMA_HERE) ;
...
programModelBuilder::
pr_program_rule_programModelBuilder_107_4_ (galgas_scanner & _inLexique) {
  ...
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the only type allowed here is '@lstring'") COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
