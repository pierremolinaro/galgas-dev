...
programModelBuilder::
pr_program_component_start_symbol_programModelBuilder_43_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_mPrologueInstructionList = GGS_semanticInstructionList ::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  var_cas_mProgramRules = GGS_programRuleList ::constructor_emptyList (_inLexique COMMA_HERE) ;
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_programModelBuilder_2 (_inLexique)) {
        ...
        case 3 : {
          ...
          var_cas_mSemanticDeclarations._addAssign_operation (var_cas_semanticDeclaration) ;
          } break ;
        default :
