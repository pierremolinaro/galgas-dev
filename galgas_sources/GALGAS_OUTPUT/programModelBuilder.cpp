...
pr_program_component_start_symbol_programModelBuilder_44_37_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_programModelBuilder_2 (inLexique)) {
        case 2 : {
          ...
          if (((var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99))).operator_isNotEqual (GGS_string ("lstring"))).isBuiltAndTrue ()) {
            var_cas_typeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the only type allowed here is '@lstring'") COMMA_SOURCE_FILE_AT_LINE (101)) ;
          }
