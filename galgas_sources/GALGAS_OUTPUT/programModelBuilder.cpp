    ...
    while (syntaxRepeat_2) {
      switch (select_programModelBuilder_2 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_4100 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99))).operator_isNotEqual (GGS_string ("lstring")) ;
          if (cond_4100.isBuiltAndTrue ()) {
