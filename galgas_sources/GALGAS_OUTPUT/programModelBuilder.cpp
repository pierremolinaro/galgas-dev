...
programModelBuilder::
pr_program_rule_programModelBuilder_104_4_ (galgas_scanner & _inLexique) {
  ...
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (113)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the only type allowed here is '@lstring'") COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
