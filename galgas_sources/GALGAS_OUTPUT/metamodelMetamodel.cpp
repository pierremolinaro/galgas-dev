...
sint32 cPtr_metamodelAttribute::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_metamodelAttribute::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_metamodelAttribute::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 2 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_metamodelAttribute::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "metamodelAttribute" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
