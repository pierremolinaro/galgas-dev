...
void GGS__list_metamodelComponentRoot::
_addAssign_operation (const GGS_metamodelComponentRoot & inObject) {
   _insulateList () ;
...
void GGS__list_metamodelEntity::
_addAssign_operation (const GGS_metamodelEntity & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_metamodelProperty::
_addAssign_operation (const GGS_metamodelProperty & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
void GGS__list_metamodelMultipleReference::
_addAssign_operation (const GGS_metamodelMultipleReference & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
