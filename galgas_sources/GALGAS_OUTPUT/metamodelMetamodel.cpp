...
uint32 cPtr_metamodelComponentRoot::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_metamodelEntity::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_metamodelAttribute::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_metamodelMultipleReference::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
