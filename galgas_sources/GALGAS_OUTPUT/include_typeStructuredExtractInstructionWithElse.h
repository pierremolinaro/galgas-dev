...
/* class GGG_typeStructuredExtractInstructionWithElse : public GGG_typeInstruction {
  private : typedef GGG_typeInstruction inherited ;
  public : GGG_typeStructuredExtractInstructionWithElse (const GGS_typeCplusPlusName & ,
                                const GGS_typeStructuredExtractCasesList & ,
                                const GGS_typeInstructionsList &  COMMA_LOCATION_ARGS) ;
} ; */
