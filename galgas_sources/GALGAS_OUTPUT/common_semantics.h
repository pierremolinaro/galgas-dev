...
//--- Comparison methods
  public : GGS_bool operator == (const GGS_M_treewalkingComponents & inOperand) const ;
  public : GGS_bool operator != (const GGS_M_treewalkingComponents & inOperand) const ;
...
//--- 'emptyMap' constructor
  public : static GGS_M_treewalkingComponents constructor_emptyMap (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
...
//--- Internal method for searching for an element
  ...
  public : GGS_string reader_description (C_Lexique & _inLexique
                                          COMMA_LOCATION_ARGS,
                                          const sint32 inIndentation = 0) const ;
  public : static GGS_M_treewalkingComponents constructor_mapWithMapToOverride (C_Lexique & inLexique,
                                            const GGS_M_treewalkingComponents & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_M_treewalkingComponents reader_overriddenMap (C_Lexique & inLexique
                                            COMMA_LOCATION_ARGS) const ;
} ;
...
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_labelForPopUpList & inOperand) const ;
  public : GGS_bool operator != (const GGS_labelForPopUpList & inOperand) const ;
//--- Constructor 'emptyList'
  public : static GGS_labelForPopUpList constructor_emptyList (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_labelForPopUpList constructor_listWithValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_uint & argument_1,
                                const GGS_lstring & argument_2,
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_lstring & argument_0,
                                ...
                                const GGS_uint & argument_3) ;
//--- Handling '.' GALGAS operator
  public : GGS_labelForPopUpList operator + (const GGS_labelForPopUpList & inOperand) const ;
  public : void modifier_prependValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_uint & argument_1,
                                const GGS_lstring & argument_2,
