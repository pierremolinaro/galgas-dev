...
class GGS_metamodelPropertyKind {
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_attributeProperty, enum_singleReferenceProperty, enum_multipleReferenceProperty, enum_mapProperty, enum_contextProperty} ;
...
class e_entityToImplementMap {
  ...
  public : GGS_contextPropertyMap  mContextAttributes ;
