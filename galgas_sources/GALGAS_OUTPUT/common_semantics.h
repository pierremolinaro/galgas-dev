...
class GGS_typeGalgas_bdd ;
class cPtr_typeGalgas_bdd ;
...
class GGS_typeGalgas_uint64list ;
class cPtr_typeGalgas_uint64list ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                    GALGAS class 'GGS_typeGalgas_bdd'                      *
//                                                                           *
//---------------------------------------------------------------------------*

class GGS_typeGalgas_bdd : public GGS_AC_galgasType {
//--- Default constructor
  public : GGS_typeGalgas_bdd (void) ;
//--- Copy constructor
  public : GGS_typeGalgas_bdd (const GGS_typeGalgas_bdd &) ;
//--- Virtual destructor
  public : virtual ~GGS_typeGalgas_bdd (void) ;
//--- 'new' constructor
  public : static GGS_typeGalgas_bdd constructor_new (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
//--- Assignment operator
  public : void operator = (const GGS_typeGalgas_bdd &) ;
//--- Comparison methods
  public : GGS_bool operator == (const GGS_typeGalgas_bdd & inOperand) const ;
  public : GGS_bool operator != (const GGS_typeGalgas_bdd & inOperand) const ;
//--- 'description' reader
  public : GGS_string reader_description (C_Lexique & _inLexique
                                          COMMA_LOCATION_ARGS,
...
//--- Readers
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : cPtr_typeGalgas_bdd * operator () (LOCATION_ARGS) const ;
  #else
    public : inline cPtr_typeGalgas_bdd * operator () (LOCATION_ARGS) const {
      return (cPtr_typeGalgas_bdd *) mPointer ;
    }
  #endif
//--- 'messageGalgasType' message
  public : GGS_string reader_messageGalgasType (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                 GALGAS class 'GGS_typeGalgas_uint64list'                  *
//                                                                           *
//---------------------------------------------------------------------------*

class GGS_typeGalgas_uint64list : public GGS_AC_galgasType {
//--- Default constructor
  public : GGS_typeGalgas_uint64list (void) ;
//--- Copy constructor
  public : GGS_typeGalgas_uint64list (const GGS_typeGalgas_uint64list &) ;
//--- Virtual destructor
  public : virtual ~GGS_typeGalgas_uint64list (void) ;
//--- 'new' constructor
  public : static GGS_typeGalgas_uint64list constructor_new (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
//--- Assignment operator
  public : void operator = (const GGS_typeGalgas_uint64list &) ;
//--- Comparison methods
  public : GGS_bool operator == (const GGS_typeGalgas_uint64list & inOperand) const ;
  public : GGS_bool operator != (const GGS_typeGalgas_uint64list & inOperand) const ;
//--- 'description' reader
  public : GGS_string reader_description (C_Lexique & _inLexique
                                          COMMA_LOCATION_ARGS,
...
//--- Readers
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : cPtr_typeGalgas_uint64list * operator () (LOCATION_ARGS) const ;
  #else
    public : inline cPtr_typeGalgas_uint64list * operator () (LOCATION_ARGS) const {
      return (cPtr_typeGalgas_uint64list *) mPointer ;
    }
  #endif
//--- 'messageGalgasType' message
  public : GGS_string reader_messageGalgasType (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const ;
...
#include "include_typeGalgas_bdd.h"
...
#include "include_typeGalgas_uint64list.h"
