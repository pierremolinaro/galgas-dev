...
class GGS_MapModel {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_MapModel * constructor_new (const GGS_typeListModel & argument_0) ;
  #else
    public : inline static cPtr_MapModel * constructor_new (const GGS_typeListModel & argument_0) {
      return new cPtr_MapModel(argument_0) ;
    }
  #endif
} ;
