...
class GGS_M_externClassesDirectories ;
...
class GGS_typeTableUtilisationsSemantiques ;
class GGS_typeEnumConstantesMap ;
...
class elementOf_GGS_attributeListModel ;

class GGS_attributeListModel {
  public : typedef elementOf_GGS_attributeListModel element_type ;
  ...
  public : GGS_attributeListModel (void) ; // Default Constructor
  public : GGS_attributeListModel (const GGS_attributeListModel &) ; // Copy constructor
  public : void operator = (const GGS_attributeListModel &) ; // Assignment operator
//--- Virtual destructor
  public : virtual ~GGS_attributeListModel (void) ;

//--- Constructor 'empty'
  public : static GGS_attributeListModel constructor_empty (void) ;
//--- Get first item
...
class elementOf_GGS_M_externClassesDirectories ;

class GGS_M_externClassesDirectories : public AC_galgas_map {
//--- Element Class
  public : typedef elementOf_GGS_M_externClassesDirectories element_type ;
//--- Get pointers
  public : inline element_type * rootObject (void) const { return (element_type *) mRoot ; }
  public : inline element_type * firstObject (void) const { return (element_type *) mFirstItem ; }
  public : inline element_type * lastObject (void) const { return (element_type *) mLastItem ; }
...
class elementOf_GGS_L_signature_ForGrammarComponent ;

class GGS_L_signature_ForGrammarComponent {
  public : typedef elementOf_GGS_L_signature_ForGrammarComponent element_type ;
  private : element_type * mFirstItem ;
  private : element_type * mLastItem ;
  private : sint32 mListLength ;
  public : inline sint32 count (void) const {
...
class elementOf_GGS_typeTableUtilisationsSemantiques ;

class GGS_typeTableUtilisationsSemantiques : public AC_galgas_map {
//--- Element Class
  public : typedef elementOf_GGS_typeTableUtilisationsSemantiques element_type ;
//--- Get pointers
  public : inline element_type * rootObject (void) const { return (element_type *) mRoot ; }
  public : inline element_type * firstObject (void) const { return (element_type *) mFirstItem ; }
  public : inline element_type * lastObject (void) const { return (element_type *) mLastItem ; }
...
class elementOf_GGS_typeEnumConstantesMap ;

class GGS_typeEnumConstantesMap : public AC_galgas_map {
//--- Element Class
  public : typedef elementOf_GGS_typeEnumConstantesMap element_type ;
//--- Get pointers
  public : inline element_type * rootObject (void) const { return (element_type *) mRoot ; }
  public : inline element_type * firstObject (void) const { return (element_type *) mFirstItem ; }
  public : inline element_type * lastObject (void) const { return (element_type *) mLastItem ; }
...
void check_KL_escapeCharacters (C_Lexique &,
                                GGS_lstring  ) ;

void check_K_escapeCharacters (C_Lexique &,
                                GGS_lstring  ) ;
...
class elementOf_GGS_attributeListModel {
  private : elementOf_GGS_attributeListModel * mNextItem ;
    public : GGS_lstring  mTypeName ;
    public : GGS_lstring  mAttributeName ;
  public : elementOf_GGS_attributeListModel (const GGS_lstring & ,
                                const GGS_lstring & ) ;

  public : inline elementOf_GGS_attributeListModel * nextObject (void) const { return mNextItem ; }
  private : elementOf_GGS_attributeListModel (const elementOf_GGS_attributeListModel &) ;
  private : void operator = (const elementOf_GGS_attributeListModel &) ;
  public : inline ~elementOf_GGS_attributeListModel (void) {}
  friend class GGS_attributeListModel ;
} ;
...
class GGS_ListModel {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_ListModel * constructor_new (const GGS_attributeListModel & argument_0) ;
  #else
    public : inline static cPtr_ListModel * constructor_new (const GGS_attributeListModel & argument_0) {
...
class elementOf_GGS_L_signature {
  ...
  public : elementOf_GGS_L_signature (const GGS_AC_galgasType & ,
...
//---------------------------------------------------------------------------*
//                                                                           *
//               Element of map '@M_externClassesDirectories'                *
//                                                                           *
//---------------------------------------------------------------------------*
...
class elementOf_GGS_M_externClassesDirectories : public AC_galgas_map_element {
  //--- Constructor
    public : elementOf_GGS_M_externClassesDirectories (const GGS_lstring & inKey,
                                      const sint32 inIndex,
                                      const e_M_externClassesDirectories & inInfo) ;
  //--- Get pointers
    public : inline elementOf_GGS_M_externClassesDirectories * nextObject (void) const { return (elementOf_GGS_M_externClassesDirectories *) mNextItem ; }
    public : inline elementOf_GGS_M_externClassesDirectories * infObject (void) const { return (elementOf_GGS_M_externClassesDirectories *) mInfPtr ; }
    public : inline elementOf_GGS_M_externClassesDirectories * supObject (void) const { return (elementOf_GGS_M_externClassesDirectories *) mSupPtr ; }
  //--- Data members
...
class elementOf_GGS_L_signature_ForGrammarComponent {
  private : elementOf_GGS_L_signature_ForGrammarComponent * mNextItem ;
    public : GGS_formalArgumentPassingMode mFormalArgumentPassingMode ;
    public : GGS_lstring  mGalgasTypeName ;
  public : elementOf_GGS_L_signature_ForGrammarComponent (const GGS_formalArgumentPassingMode& ,
                                const GGS_lstring & ) ;

  public : inline elementOf_GGS_L_signature_ForGrammarComponent * nextObject (void) const { return mNextItem ; }
  private : elementOf_GGS_L_signature_ForGrammarComponent (const elementOf_GGS_L_signature_ForGrammarComponent &) ;
  private : void operator = (const elementOf_GGS_L_signature_ForGrammarComponent &) ;
  public : inline ~elementOf_GGS_L_signature_ForGrammarComponent (void) {}
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Element of map '@typeTableUtilisationsSemantiques'             *
//                                                                           *
//---------------------------------------------------------------------------*
...
class elementOf_GGS_typeTableUtilisationsSemantiques : public AC_galgas_map_element {
  //--- Constructor
    public : elementOf_GGS_typeTableUtilisationsSemantiques (const GGS_lstring & inKey,
                                      const sint32 inIndex,
                                      const e_typeTableUtilisationsSemantiques & inInfo) ;
  //--- Get pointers
    public : inline elementOf_GGS_typeTableUtilisationsSemantiques * nextObject (void) const { return (elementOf_GGS_typeTableUtilisationsSemantiques *) mNextItem ; }
    public : inline elementOf_GGS_typeTableUtilisationsSemantiques * infObject (void) const { return (elementOf_GGS_typeTableUtilisationsSemantiques *) mInfPtr ; }
    public : inline elementOf_GGS_typeTableUtilisationsSemantiques * supObject (void) const { return (elementOf_GGS_typeTableUtilisationsSemantiques *) mSupPtr ; }
  //--- Data members
    public : e_typeTableUtilisationsSemantiques mInfo ;
} ;
//---------------------------------------------------------------------------*
//                                                                           *
//                 Element of map '@typeEnumConstantesMap'                   *
//                                                                           *
//---------------------------------------------------------------------------*
...
class elementOf_GGS_typeEnumConstantesMap : public AC_galgas_map_element {
  //--- Constructor
    public : elementOf_GGS_typeEnumConstantesMap (const GGS_lstring & inKey,
                                      const sint32 inIndex,
                                      const e_typeEnumConstantesMap & inInfo) ;
  //--- Get pointers
    public : inline elementOf_GGS_typeEnumConstantesMap * nextObject (void) const { return (elementOf_GGS_typeEnumConstantesMap *) mNextItem ; }
    public : inline elementOf_GGS_typeEnumConstantesMap * infObject (void) const { return (elementOf_GGS_typeEnumConstantesMap *) mInfPtr ; }
    public : inline elementOf_GGS_typeEnumConstantesMap * supObject (void) const { return (elementOf_GGS_typeEnumConstantesMap *) mSupPtr ; }
  //--- Data members
