...
class GGS_metamodelPropertyKind {
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_attributeProperty, enum_singleReferenceProperty, enum_multipleReferenceProperty, enum_mapProperty, enum_contextProperty, enum_fetchedProperty, enum_relationProperty} ;
...
//--- Construction from GALGAS constructor
  ...
  public : static inline GGS_metamodelPropertyKind constructor_mapProperty (UNUSED_LOCATION_ARGS) {
    return GGS_metamodelPropertyKind (enum_mapProperty) ;
  }
  public : static inline GGS_metamodelPropertyKind constructor_contextProperty (UNUSED_LOCATION_ARGS) {
    return GGS_metamodelPropertyKind (enum_contextProperty) ;
  }
  public : static inline GGS_metamodelPropertyKind constructor_fetchedProperty (UNUSED_LOCATION_ARGS) {
    return GGS_metamodelPropertyKind (enum_fetchedProperty) ;
  }
  public : static inline GGS_metamodelPropertyKind constructor_relationProperty (UNUSED_LOCATION_ARGS) {
    return GGS_metamodelPropertyKind (enum_relationProperty) ;
  }
...
void routine_generate_metamodel (C_Lexique &,
                                ...
                                GGS_stringset  ,
                                GGS_lstring  ,
                                GGS_mapEntityMap  & COMMA_LOCATION_ARGS) ;
...
class e_entityPropertyMap {
  ...
  public : GGS_lstring  mTypeName ;
  public : GGS_L_ListOfPropertyPathes  mPropertyOptionPathes ;
} ;
...
class GGS_metamodelRelationPrimary {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_metamodelRelationPrimary * constructor_new (const GGS_lstring & argument_0,
                                const GGS_luint & argument_1,
                                const GGS_L_propertyPath & argument_2 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_metamodelRelationPrimary * constructor_new (const GGS_lstring & argument_0,
                                const GGS_luint & argument_1,
                                const GGS_L_propertyPath & argument_2 COMMA_LOCATION_ARGS) {
...
class e_entityToImplementMap {
  ...
  public : GGS_contextPropertyMap  mAllContextAttributes ;
  public : GGS_fetchedPropertyMap  mFetchedPropertyMap ;
  public : GGS_fetchedPropertyMap  mAllFetchedPropertyMap ;
  public : GGS_insertedPropertyMap  mInsertedPropertyMap ;
  public : GGS_insertedPropertyMap  mAllInsertedPropertyMap ;
} ;
