...
//--- 'insertKeyAndGetID' Insert Modifier
  public : void modifier_insertKeyAndGetID (C_Compiler & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_entityPropertyMap &  inParameter0,
                                const GGS_bool&  inParameter1,
...
//--- Comparison Operators
  ...
  public : GGS_bool operator != (const GGS_L_stringList & inOperand) const ;
//--- Constructor 'emptyList'
  public : static GGS_L_stringList constructor_emptyList (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_L_stringList constructor_listWithValue (C_Compiler & _inLexique,
