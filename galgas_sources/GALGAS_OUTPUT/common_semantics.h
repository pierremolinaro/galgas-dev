...
class GGS_constrainedPropertyList ;
class GGS_indexMap ;
...
class elementOf_GGS_constrainedPropertyList ;

class GGS_constrainedPropertyList : public AC_galgas_list {
  public : typedef elementOf_GGS_constrainedPropertyList element_type ;
//--- Default Constructor
  public : GGS_constrainedPropertyList (void) ;
//--- Copy Constructor
  public : GGS_constrainedPropertyList (const GGS_constrainedPropertyList & inSource) ;
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_constrainedPropertyList & inOperand) const ;
  public : GGS_bool operator != (const GGS_constrainedPropertyList & inOperand) const ;
//--- Constructor 'emptyList'
  public : static GGS_constrainedPropertyList constructor_emptyList (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_constrainedPropertyList constructor_listWithValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) ;
//--- Get first object
...
//--- Operators () used for method call
  public : const GGS_constrainedPropertyList * operator () (UNUSED_LOCATION_ARGS) const { return this ;} 
//--- Method 'first'
  public : void method_first (C_Lexique & _inLexique,
                              GGS_lstring & _out_0,
                              GGS_lstring & _out_1
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1) ;
//--- Handling '.' GALGAS operator
  public : GGS_constrainedPropertyList operator + (const GGS_constrainedPropertyList & inOperand) const ;
  public : void method_prependValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1
                                COMMA_LOCATION_ARGS) ;
...
class elementOf_GGS_constrainedPropertyList : public AC_galgas_list::cListElement {
//--- Attributes
  public : GGS_lstring  mPropertyTypeName ;
  public : GGS_lstring  mPropertyName ;
//--- Constructor
  public : elementOf_GGS_constrainedPropertyList (const GGS_lstring & ,
                                const GGS_lstring & ) ;

//--- Access to next
  public : inline elementOf_GGS_constrainedPropertyList * nextObject (void) const { return (elementOf_GGS_constrainedPropertyList *) internalNextItem () ; }
//--- Access to previous
  public : inline elementOf_GGS_constrainedPropertyList * previousObject (void) const { return (elementOf_GGS_constrainedPropertyList *) internalPreviousItem () ; }
//--- Element comparison
  protected : bool isEqualToElement (const cListElement * inOperand) const ;
//--- Method used for description
  public : virtual void appendForListDescription (C_Lexique & _inLexique,
                                                  ...
                                                  const sint32 inIndentation
                                                  COMMA_LOCATION_ARGS) const ;
  friend class GGS_constrainedPropertyList ;
} ;
