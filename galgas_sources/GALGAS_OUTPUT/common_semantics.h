...
class elementOf_GGS_L_GUIAttributeList ;

class GGS_L_GUIAttributeList {
  public : typedef elementOf_GGS_L_GUIAttributeList element_type ;
//--- Embedded class for list root
  protected : class cRootList {
    public : element_type * mFirstItem ;
    public : element_type * mLastItem ;
...
//--- Private attribute
  private : cRootList * _mRoot ;
//--- Default Constructor
  public : GGS_L_GUIAttributeList (void) ;
//--- Copy Constructor
  public : GGS_L_GUIAttributeList (const GGS_L_GUIAttributeList & inSource) ;
//--- Assignment Operator
  public : void operator = (const GGS_L_GUIAttributeList & inSource) ;
//--- Destructor
  public : ~GGS_L_GUIAttributeList (void) ;

//--- Constructor 'emptyList'
  public : static GGS_L_GUIAttributeList constructor_emptyList (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
//--- Function 'count'
  public : sint32 count (void) const ;
//--- Reader 'description'
  public : GGS_string reader_description (C_Lexique & _inLexique COMMA_LOCATION_ARGS) const ;
...
class elementOf_GGS_L_GUIAttributeList {
  private : elementOf_GGS_L_GUIAttributeList * mNextItem ;
    public : GGS_lstring  mKey ;
    public : GGS_lstring  mValue ;
  public : elementOf_GGS_L_GUIAttributeList (const GGS_lstring & ,
                                const GGS_lstring & ) ;

  public : inline elementOf_GGS_L_GUIAttributeList * nextObject (void) const { return mNextItem ; }
  private : elementOf_GGS_L_GUIAttributeList (const elementOf_GGS_L_GUIAttributeList &) ;
  private : void operator = (const elementOf_GGS_L_GUIAttributeList &) ;
  public : inline ~elementOf_GGS_L_GUIAttributeList (void) {}
  public : void appendForListDescription (C_Lexique & _inLexique, C_String & ioString COMMA_LOCATION_ARGS) const ;
  friend class GGS_L_GUIAttributeList ;
} ;
