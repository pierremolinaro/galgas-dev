...
//--- 'empty' constructor
  public : static GGS_contextParameterMap constructor_empty (LOCATION_ARGS) ;
//--- Method used for duplicate a map
  protected : virtual void internalInsertForDuplication (AC_galgas_map_element * inPtr) ;
//--- 'insertKey' Insert Method
  public : void methode_insertKey (C_Lexique & inLexique,
...
//--- 'empty' constructor
  public : static GGS_mapPropertyMap constructor_empty (LOCATION_ARGS) ;
//--- Method used for duplicate a map
  protected : virtual void internalInsertForDuplication (AC_galgas_map_element * inPtr) ;
//--- 'insertKey' Insert Method
  public : void methode_insertKey (C_Lexique & inLexique,
...
class elementOf_GGS_insertionList ;

class GGS_insertionList {
  public : typedef elementOf_GGS_insertionList element_type ;
  private : element_type * mFirstItem ;
  private : element_type * mLastItem ;
  private : sint32 mListLength ;
  public : inline sint32 count (void) const {
  ...
  private : sint32 * mCountReference ;
  public : GGS_insertionList (void) ; // Default Constructor
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : GGS_insertionList (LOCATION_ARGS) ; // Constructor for debug mode
  #endif
  public : GGS_insertionList (const GGS_insertionList &) ; // Copy constructor
  public : void operator = (const GGS_insertionList &) ; // Assignment operator
//--- Virtual destructor
  public : virtual ~GGS_insertionList (void) ;

//--- Constructor 'empty'
  public : static GGS_insertionList constructor_empty (LOCATION_ARGS) ;
//--- Reader 'description'
  public : GGS_string reader_description (void) const ;
//--- Get first item
  public : inline element_type * firstObject (void) const { return mFirstItem ; }
...
//--- 'empty' constructor
  public : static GGS_M_constraintComponents constructor_empty (LOCATION_ARGS) ;
//--- Method used for duplicate a map
  protected : virtual void internalInsertForDuplication (AC_galgas_map_element * inPtr) ;
//--- 'insertKey' Insert Method
  public : void methode_insertKey (C_Lexique & inLexique,
...
class elementOf_GGS_insertionList {
  private : elementOf_GGS_insertionList * mNextItem ;
    public : GGS_lstring  mInsertedAttributeName ;
    public : GGS_lstring  mMapName ;
    public : GGS_lstring  mIndexName ;
  public : elementOf_GGS_insertionList (const GGS_lstring & ,
                                const GGS_lstring & ,
                                const GGS_lstring & ) ;

  public : inline elementOf_GGS_insertionList * nextObject (void) const { return mNextItem ; }
  private : elementOf_GGS_insertionList (const elementOf_GGS_insertionList &) ;
  private : void operator = (const elementOf_GGS_insertionList &) ;
  public : inline ~elementOf_GGS_insertionList (void) {}
  public : void appendForListDescription (C_String & ioString) const ;
  friend class GGS_insertionList ;
} ;
...
class e_constrainedEntityMap {
  ...
  public : GGS_lstring  mSuperEntityName ;
  public : GGS_entityPropertyMap  mEntityPropertiesMap ;
  public : GGS_contextPropertyMap  mContextPropertyMap ;
  public : GGS_mapPropertyMap  mMapPropertyMap ;
  public : GGS_contextParameterMap  mContextParameterMap ;
  public : GGS_insertionList  mInsertionList ;
  public : GGS_indexMap  mIndexMap ;
