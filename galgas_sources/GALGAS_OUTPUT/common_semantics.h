...
class GGS_typeListeAttributsAxiome : public AC_galgas_list {
...
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_typeListeAttributsAxiome & inOperand) const ;
  public : GGS_bool operator != (const GGS_typeListeAttributsAxiome & inOperand) const ;
//--- Constructor 'emptyList'
  public : static GGS_typeListeAttributsAxiome constructor_emptyList (C_Lexique & inLexique COMMA_LOCATION_ARGS) ;
  public : static GGS_typeListeAttributsAxiome constructor_listWithValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0
                                COMMA_LOCATION_ARGS) ;
//--- Get first object
  public : inline element_type * firstObject (void) const {
...
//--- Operators () used for method call
  public : const GGS_typeListeAttributsAxiome * operator () (UNUSED_LOCATION_ARGS) const { return this ;} 
//--- Method 'first'
  public : void method_first (C_Lexique & _inLexique,
                              GGS_lstring & _out_0
                              COMMA_LOCATION_ARGS) const ;
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_lstring & argument_0) ;
//--- Handling '.' GALGAS operator
  public : GGS_typeListeAttributsAxiome operator + (const GGS_typeListeAttributsAxiome & inOperand) const ;
  public : void method_prependValue (C_Lexique & _inLexique,
                                const GGS_lstring & argument_0
                                COMMA_LOCATION_ARGS) ;
//--- Internal Methods
...
class elementOf_GGS_typeListeAttributsAxiome : public AC_galgas_list::cListElement {
//--- Attributes
...
//--- Access to next
  public : inline elementOf_GGS_typeListeAttributsAxiome * nextObject (void) const { return (elementOf_GGS_typeListeAttributsAxiome *) internalNextItem () ; }
//--- Access to previous
  public : inline elementOf_GGS_typeListeAttributsAxiome * previousObject (void) const { return (elementOf_GGS_typeListeAttributsAxiome *) internalPreviousItem () ; }
//--- Element comparison
  protected : bool isEqualToElement (const cListElement * inOperand) const ;
//--- Method used for description
  public : virtual void appendForListDescription (C_Lexique & _inLexique,
