...
class GGS_sortedTypeList : public AC_galgas_sortedlist {
  public : typedef elementOf_GGS_sortedTypeList element_type ;
//--- Default Constructor
...
class GGS_typeList : public AC_galgas_list {
  public : typedef elementOf_GGS_typeList element_type ;
...
class GGS_sortDescriptorList : public AC_galgas_list {
  public : typedef elementOf_GGS_sortDescriptorList element_type ;
