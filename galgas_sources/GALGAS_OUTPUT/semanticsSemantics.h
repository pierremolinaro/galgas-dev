...
//--- Modifiers "set'Value'ForKey"
public : void modifier_setMTypeForKey (C_Compiler & inLexique,                        const GGS_ACGalgasType & inValue,
...
//--- Default constructor
  public : inline GGS_listmapGalgasType (void) : GGS_ACGalgasType () {}
...
//--- Modifiers "set'Value'ForKey"
public : void modifier_setMRoutineSignatureForKey (C_Compiler & inLexique,                        const GGS_signature & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
...
class GGS_descendantClassListMap : public AC_galgas_maplist {
//--- Node class
  public : class cElement : public cNode {
    public : cElement (const GGS_string & inKey) ;
    public : GGS_classIndexList object ;
 //--- Description
...
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_descendantClassListMap inOperand) ;
...
#include "include_listmapGalgasType.h"
...
//--- Galgas 'new' destructor
  public : static GGS_semanticContext constructor_new (const GGS_typeMap & argument_0,
                 ...
                 const GGS_descendantClassListMap& argument_2) ;
