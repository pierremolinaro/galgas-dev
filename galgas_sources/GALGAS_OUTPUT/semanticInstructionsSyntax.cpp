...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_28 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_bool cond_31526 = gOption_galgas_5F_cli_5F_options_newCodeGeneration.reader_value () ;
      if (cond_31526.isBuiltAndTrue ()) {
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i39_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_44 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_43979_0 ;
      nt_expression_ (inLexique, automatic_var_43979_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_44013_0 ;
      nt_expression_ (inLexique, automatic_var_44013_0) ;
      } break ;
    default :
      break ;
  }
