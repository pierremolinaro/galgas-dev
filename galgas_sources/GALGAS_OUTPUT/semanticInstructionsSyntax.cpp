...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioMatchEntryList.addAssign_operation (GGS_bool (false), var_cas_enumerationConstantName, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (964))) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_27 (inLexique)) {
    case 1 : {
      var_cas_localConstant = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (974)) ;
      } break ;
    case 2 : {
  ...
  switch (select_semanticInstructionsSyntax_28 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_bool cond_34946 = (GGS_bool (gOption_galgas_5F_cli_5F_options_legacyCodeGeneration.reader_value ())).operator_not () ;
      if (cond_34946.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("old style 'match' instruction") COMMA_SOURCE_FILE_AT_LINE (996)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
      } break ;
    default :
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_matchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_matchedExpressionNameList, var_cas_matchInstructionBranchList, var_cas_elseInstructionList, var_cas_endOf_match_instruction COMMA_SOURCE_FILE_AT_LINE (1067)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_instruction_5F_branch_i33_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_36 (inLexique)) {
    ...
    case 3 : {
      var_cas_mConstantVarName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1107)) ;
      var_cas_mConstantVarNameIsUnused = GGS_bool (true) ;
      } break ;
    default :
      break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i37_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_cast) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_structuredCastInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression, var_cas_mCastInstructionBranchList, var_cas_mElseOrDefault, var_cas_endOfInstructionLocation COMMA_SOURCE_FILE_AT_LINE (1181)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i38_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_addInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverName, var_cas_mStructAttributeList, var_cas_mExpressionList COMMA_SOURCE_FILE_AT_LINE (1211)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i39_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mSourceExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_appendInstructionAST ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_SOURCE_FILE_AT_LINE (1238)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i41_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_messageInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression COMMA_SOURCE_FILE_AT_LINE (1300)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i42_ (C_Lexique_galgas_5F_scanner & inLexique,
    ...
    while (syntaxRepeat_40) {
        switch (select_semanticInstructionsSyntax_41 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            var_cas_logList.addAssign_operation (var_cas_loggedVariableName, GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_loggedVariableName, GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1319))) ;
            } break ;
          case 2 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_logInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_logList COMMA_SOURCE_FILE_AT_LINE (1331)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i43_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_42 (inLexique)) {
    case 1 : {
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1350)) ;
      } break ;
    case 2 : {
  ...
  switch (select_semanticInstructionsSyntax_44 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_47399_0 ;
      nt_expression_ (inLexique, automatic_var_47399_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_47433_0 ;
      nt_expression_ (inLexique, automatic_var_47433_0) ;
      } break ;
    default :
      break ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_grammarInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mGrammarComponentName, var_cas_mLabelName, var_cas_mSourceExpression, var_cas_endOfSourceExpression, var_cas_sourceExpressionIsFile, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1375)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i44_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_switchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_switchExpression, var_cas_endOfSwitchExpression, var_cas_switchBranches, var_cas_endOfSwitchInstruction COMMA_SOURCE_FILE_AT_LINE (1418)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i45_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_typeMethodCallInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mTypeName, var_cas_mMethodName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1442)) ;
}
