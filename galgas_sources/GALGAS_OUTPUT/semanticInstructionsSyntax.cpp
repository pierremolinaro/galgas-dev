...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_1 (inLexique)) {
    case 1 : {
      var_cas_outInstruction = GGS_localVariableDeclarationAST ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (226)), var_cas_typeName, var_cas_variableName COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_outInstruction = GGS_localVariableDeclarationWithAssignmentAST ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (231)), var_cas_typeName, var_cas_variableName, var_cas_sourceExpression COMMA_HERE) ;
      } break ;
    case 3 : {
      ...
      var_cas_outInstruction = GGS_localVariableDeclarationWithInitializationAST ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (238)), var_cas_typeName, var_cas_variableName, var_cas_constructorName, var_cas_expressionList COMMA_HERE) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_2 (inLexique)) {
    case 1 : {
      ...
      GGS_semanticExpressionAST  var_cas_sourceExpression ;
      nt_expression_ (inLexique, var_cas_sourceExpression) ;
      var_cas_outInstruction = GGS_localConstantDeclarationWithSourceExpressionAST ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), var_cas_typeName, var_cas_variableName, var_cas_sourceExpression COMMA_HERE) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5B_) COMMA_HERE) ;
      GGS_lstring  var_cas_constructorName ;
      ...
      GGS_outSemanticExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outInstruction = GGS_localConstantDeclarationWithConstructorCallAST ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), var_cas_typeName, var_cas_variableName, var_cas_constructorName, var_cas_expressionList COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
      } break ;
    default :
      break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_assignmentInstructionAST ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_HERE) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_incrementInstructionAST ::constructor_new (inLexique, var_cas_mReceiverName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (315)), var_cas_mReceiverName, var_cas_mStructAttributeList COMMA_HERE) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_decrementInstructionAST ::constructor_new (inLexique, var_cas_mReceiverName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (335)), var_cas_mReceiverName, var_cas_mStructAttributeList COMMA_HERE) ;
}
        ...
        while (syntaxRepeat_8) {
          switch (select_semanticInstructionsSyntax_8 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (386)) ;
              const GGS_bool cond_15563 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
              if (cond_15563.isBuiltAndTrue ()) {
                var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (389)) ;
              }
              GGS_uint _variant_15690 = var_cas_n ;
              GGS_bool _condition_15690 (_variant_15690.isBuilt (), true) ;
              while (_condition_15690.isBuiltAndTrue ()) {
                _condition_15690 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_15690.isBuiltAndTrue ()) {
                  if (_variant_15690.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (394)) ;
                    _condition_15690 = GGS_bool (false) ;
                  }else{
                    _variant_15690.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_mElementList.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_HERE)) ;
                    var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (393)) ;
                  }
                }
              }
              } break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_actual_5F_parameter_5F_list_ (inLexique, var_cas_mActualParameterList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_routineCallInstructionAST ::constructor_new (inLexique, var_cas_mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (664)), var_cas_mRoutineName, var_cas_mActualParameterList COMMA_HERE) ;
}
    ...
    while (syntaxRepeat_24) {
      switch (select_semanticInstructionsSyntax_24 (inLexique)) {
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
          GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (753)) ;
          const GGS_bool cond_27696 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_27696.isBuiltAndTrue ()) {
            var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (756)) ;
          }
          GGS_uint _variant_27810 = var_cas_n ;
          GGS_bool _condition_27810 (_variant_27810.isBuilt (), true) ;
          while (_condition_27810.isBuiltAndTrue ()) {
            _condition_27810 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_27810.isBuiltAndTrue ()) {
              if (_variant_27810.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (761)) ;
                _condition_27810 = GGS_bool (false) ;
              }else{
                _variant_27810.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_HERE)) ;
                var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (760)) ;
              }
            }
          }
          } break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mSourceExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_appendInstructionAST ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1023)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_HERE) ;
}
    ...
    while (syntaxRepeat_36) {
        switch (select_semanticInstructionsSyntax_37 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            var_cas_logList.addAssign_operation (var_cas_loggedVariableName, GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_loggedVariableName COMMA_HERE)) ;
            } break ;
          case 2 : {
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i36_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_40 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_40468_0 ;
      nt_expression_ (inLexique, automatic_var_40468_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_40502_0 ;
      nt_expression_ (inLexique, automatic_var_40502_0) ;
      } break ;
    default :
      break ;
  }
