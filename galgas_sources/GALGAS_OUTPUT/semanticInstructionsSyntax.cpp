...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_22 (inLexique)) {
    case 1 : {
      var_cas_withPrefix = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (689)) ;
      } break ;
    case 2 : {
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioMatchEntryList.addAssign_operation (GGS_constantMatchEntryAST ::constructor_new (inLexique, var_cas_mConstantName COMMA_SOURCE_FILE_AT_LINE (744))) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_25 = true ;
    while (syntaxRepeat_25) {
      switch (select_semanticInstructionsSyntax_25 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
          var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (756))) ;
          } break ;
        case 3 : {
          GGS_luint  var_cas_count ;
          inLexique.assignFromAttribute_uint_33__32_value (var_cas_count) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
          GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (761)) ;
          const GGS_bool cond_27851 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_27851.isBuiltAndTrue ()) {
            var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (764)) ;
          }
          GGS_uint _variant_27965 = var_cas_n ;
          GGS_bool _condition_27965 (_variant_27965.isBuilt (), true) ;
          while (_condition_27965.isBuiltAndTrue ()) {
            _condition_27965 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_27965.isBuiltAndTrue ()) {
              if (_variant_27965.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (769)) ;
                _condition_27965 = GGS_bool (false) ;
              }else{
                _variant_27965.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (767))) ;
                var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (768)) ;
              }
            }
          }
          } break ;
        case 4 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_constantName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          GGS_foreachInstructionEnumeratedConstantAST  var_cas_c = GGS_foreachInstructionEnumeratedConstantAST ::constructor_new (inLexique, var_cas_typeName, var_cas_constantName COMMA_SOURCE_FILE_AT_LINE (775)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  var_cas_ioMatchEntryList.addAssign_operation (GGS_classMatchEntryAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mElements, var_cas_mEndsWithEllipsis COMMA_SOURCE_FILE_AT_LINE (786))) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_match) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_matchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mMatchedVariableNameList, var_cas_mMatchInstructionBranchList, var_cas_mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (848)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_instruction_5F_branch_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_32 (inLexique)) {
    ...
    case 3 : {
      var_cas_mConstantVarName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (887)) ;
      var_cas_mConstantVarNameIsUnused = GGS_bool (true) ;
      } break ;
    default :
      break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_else_5F_or_5F_default_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_semanticInstructionListAST  var_cas_mElseInstructionList ;
  nt_semantic_5F_instruction_5F_list_ (inLexique, var_cas_mElseInstructionList) ;
  var_cas_outElseOrDefault = GGS_elseForCastInstructionAST ::constructor_new (inLexique, var_cas_mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (913)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_else_5F_or_5F_default_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outElseOrDefault = GGS_defaultForCastInstructionAST ::constructor_new (inLexique, var_cas_mErrorLocationExpression COMMA_SOURCE_FILE_AT_LINE (923)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_cast) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_castInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression, var_cas_mCastInstructionBranchList, var_cas_mElseOrDefault COMMA_SOURCE_FILE_AT_LINE (944)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_addInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverName, var_cas_mStructAttributeList, var_cas_mExpressionList COMMA_SOURCE_FILE_AT_LINE (973)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_removeInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverName, var_cas_mStructAttributeList, var_cas_mExpression COMMA_SOURCE_FILE_AT_LINE (1003)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mSourceExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_appendInstructionAST ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1031)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_SOURCE_FILE_AT_LINE (1030)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i33_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_loop) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_loopInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mVariantExpression, var_cas_mFirstInstructions, var_cas_mLoopExpression, var_cas_mSecondInstructions COMMA_SOURCE_FILE_AT_LINE (1061)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i34_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_messageInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression COMMA_SOURCE_FILE_AT_LINE (1082)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i35_ (C_Lexique_galgas_5F_scanner & inLexique,
    ...
    while (syntaxRepeat_37) {
        switch (select_semanticInstructionsSyntax_38 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            var_cas_logList.addAssign_operation (var_cas_loggedVariableName, GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_loggedVariableName, GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1101))) ;
            } break ;
          case 2 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_logInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_logList COMMA_SOURCE_FILE_AT_LINE (1113)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i36_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_39 (inLexique)) {
    case 1 : {
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      } break ;
    case 2 : {
  ...
  switch (select_semanticInstructionsSyntax_41 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_40648_0 ;
      nt_expression_ (inLexique, automatic_var_40648_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_40682_0 ;
      nt_expression_ (inLexique, automatic_var_40682_0) ;
      } break ;
    default :
      break ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_grammarInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mGrammarComponentName, var_cas_mLabelName, var_cas_mSourceExpression, var_cas_sourceExpressionIsFile, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1156)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i37_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_switch) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_switchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_switchExpression, var_cas_switchBranches COMMA_SOURCE_FILE_AT_LINE (1196)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i38_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_typeMethodCallInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mTypeName, var_cas_mMethodName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1218)) ;
}
