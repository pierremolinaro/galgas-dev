        ...
        while (syntaxRepeat_8) {
          switch (select_semanticInstructionsSyntax_8 (inLexique)) {
            ...
            case 3 : {
              ...
              const GGS_bool cond_15557 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
              if (cond_15557.isBuiltAndTrue ()) {
              ...
              GGS_uint _variant_15684 = var_cas_n ;
              GGS_bool _condition_15684 (_variant_15684.isBuilt (), true) ;
              while (_condition_15684.isBuiltAndTrue ()) {
                _condition_15684 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_15684.isBuiltAndTrue ()) {
                  if (_variant_15684.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (394)) ;
                    _condition_15684 = GGS_bool (false) ;
                  }else{
                    _variant_15684.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_mElementList.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_HERE)) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_actual_5F_parameter_5F_list_ (inLexique, var_cas_mActualParameterList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_routineCallInstruction ::constructor_new (inLexique, var_cas_mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (664)), var_cas_mRoutineName, var_cas_mActualParameterList COMMA_HERE) ;
}
    ...
    while (syntaxRepeat_24) {
      switch (select_semanticInstructionsSyntax_24 (inLexique)) {
        ...
        case 3 : {
          ...
          const GGS_bool cond_27651 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_27651.isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_27765 = var_cas_n ;
          GGS_bool _condition_27765 (_variant_27765.isBuilt (), true) ;
          while (_condition_27765.isBuiltAndTrue ()) {
            _condition_27765 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_27765.isBuiltAndTrue ()) {
              if (_variant_27765.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (761)) ;
                _condition_27765 = GGS_bool (false) ;
              }else{
                _variant_27765.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_HERE)) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i36_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_40 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_40417_0 ;
      nt_expression_ (inLexique, automatic_var_40417_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_40451_0 ;
      nt_expression_ (inLexique, automatic_var_40451_0) ;
      } break ;
    default :
      break ;
  }
