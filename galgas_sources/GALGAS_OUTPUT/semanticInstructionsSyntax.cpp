...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_foreach_5F_enumerated_5F_object_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_9 (inLexique)) {
    case 1 : {
      ...
      var_cas_prefix = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (424)) ;
      } break ;
    case 2 : {
    ...
    case 3 : {
      var_cas_prefix = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (430)) ;
        ...
        while (syntaxRepeat_10) {
          switch (select_semanticInstructionsSyntax_10 (inLexique)) {
            case 2 : {
              ...
              var_cas_mElementList.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
              } break ;
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (440)) ;
              const GGS_bool cond_16788 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
              if (cond_16788.isBuiltAndTrue ()) {
                var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (443)) ;
              }
              GGS_uint _variant_16915 = var_cas_n ;
              GGS_bool _condition_16915 (_variant_16915.isBuilt (), true) ;
              while (_condition_16915.isBuiltAndTrue ()) {
                _condition_16915 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_16915.isBuiltAndTrue ()) {
                  if (_variant_16915.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (448)) ;
                    _condition_16915 = GGS_bool (false) ;
                  }else{
                    _variant_16915.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_mElementList.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (446))) ;
                    var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (447)) ;
                  }
                }
              }
              } break ;
            case 4 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
              GGS_foreachInstructionEnumeratedConstantAST  var_cas_c = GGS_foreachInstructionEnumeratedConstantAST ::constructor_new (inLexique, var_cas_typeName, var_cas_constantName COMMA_SOURCE_FILE_AT_LINE (454)) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_13 (inLexique)) {
    case 1 : {
      var_cas_mIndexVariableName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (487)) ;
      } break ;
    case 2 : {
  ...
  switch (select_semanticInstructionsSyntax_14 (inLexique)) {
    case 1 : {
      var_cas_mWhileExpression = GGS_trueExpressionAST ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (494)) ;
      } break ;
    case 2 : {
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_sendInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (550)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_if_5F_branch_i16_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outInstruction = GGS_ifInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_if_expression, var_cas_then_instructionList, var_cas_endOf_then_branchLocation, var_cas_else_instructionList, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (587)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i18_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_methodCallInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverExpression, var_cas_mMethodName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (623)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_modifierCallInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverName, var_cas_mReceiverStructAttributes, var_cas_mModifierName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (654)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_errorInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverExpression, var_cas_mErrorExpression, var_cas_mBuiltVariableList COMMA_SOURCE_FILE_AT_LINE (690)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_warningInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverExpression, var_cas_mWarningExpression COMMA_SOURCE_FILE_AT_LINE (713)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_actual_5F_parameter_5F_list_ (inLexique, var_cas_mActualParameterList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_routineCallInstructionAST ::constructor_new (inLexique, var_cas_mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (732)), var_cas_mRoutineName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (731)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_24 (inLexique)) {
    case 1 : {
      var_cas_withPrefix = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (768)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_prefixedby) COMMA_HERE) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioMatchEntryList.addAssign_operation (GGS_constantMatchEntryAST ::constructor_new (inLexique, var_cas_mConstantName COMMA_SOURCE_FILE_AT_LINE (811))) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_entry_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_26 = true ;
    while (syntaxRepeat_26) {
      switch (select_semanticInstructionsSyntax_26 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
          var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (823))) ;
          } break ;
        case 3 : {
          GGS_luint  var_cas_count ;
          inLexique.assignFromAttribute_uint_33__32_value (var_cas_count) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
          GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (828)) ;
          const GGS_bool cond_29572 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_29572.isBuiltAndTrue ()) {
            var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (831)) ;
          }
          GGS_uint _variant_29686 = var_cas_n ;
          GGS_bool _condition_29686 (_variant_29686.isBuilt (), true) ;
          while (_condition_29686.isBuiltAndTrue ()) {
            _condition_29686 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_29686.isBuiltAndTrue ()) {
              if (_variant_29686.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (836)) ;
                _condition_29686 = GGS_bool (false) ;
              }else{
                _variant_29686.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (834))) ;
                var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (835)) ;
              }
            }
          }
          } break ;
        case 4 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_constantName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          GGS_foreachInstructionEnumeratedConstantAST  var_cas_c = GGS_foreachInstructionEnumeratedConstantAST ::constructor_new (inLexique, var_cas_typeName, var_cas_constantName COMMA_SOURCE_FILE_AT_LINE (842)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  var_cas_ioMatchEntryList.addAssign_operation (GGS_classMatchEntryAST ::constructor_new (inLexique, var_cas_mClassName, var_cas_mElements, var_cas_mEndsWithEllipsis COMMA_SOURCE_FILE_AT_LINE (853))) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_match_5F_instruction_5F_branch_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_match) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_matchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mMatchedVariableNameList, var_cas_mMatchInstructionBranchList, var_cas_mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (915)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_instruction_5F_branch_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_33 (inLexique)) {
    ...
    case 3 : {
      var_cas_mConstantVarName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (954)) ;
      var_cas_mConstantVarNameIsUnused = GGS_bool (true) ;
      } break ;
    default :
      break ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_else_5F_or_5F_default_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_elseOrDefaultForCastInstructionAST  &var_cas_outElseOrDefault) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_else) COMMA_HERE) ;
  GGS_semanticInstructionListAST  var_cas_mElseInstructionList ;
  nt_semantic_5F_instruction_5F_list_ (inLexique, var_cas_mElseInstructionList) ;
  var_cas_outElseOrDefault = GGS_elseForCastInstructionAST ::constructor_new (inLexique, var_cas_mElseInstructionList COMMA_SOURCE_FILE_AT_LINE (980)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_cast_5F_else_5F_or_5F_default_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outElseOrDefault = GGS_defaultForCastInstructionAST ::constructor_new (inLexique, var_cas_mErrorLocationExpression COMMA_SOURCE_FILE_AT_LINE (990)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_cast) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_castInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression, var_cas_mCastInstructionBranchList, var_cas_mElseOrDefault COMMA_SOURCE_FILE_AT_LINE (1011)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_addInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverName, var_cas_mStructAttributeList, var_cas_mExpressionList COMMA_SOURCE_FILE_AT_LINE (1040)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i33_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mSourceExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_appendInstructionAST ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_SOURCE_FILE_AT_LINE (1067)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i34_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_loop) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_loopInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mVariantExpression, var_cas_mFirstInstructions, var_cas_mLoopExpression, var_cas_mSecondInstructions COMMA_SOURCE_FILE_AT_LINE (1098)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i35_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_expression_ (inLexique, var_cas_mExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_messageInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mExpression COMMA_SOURCE_FILE_AT_LINE (1119)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i36_ (C_Lexique_galgas_5F_scanner & inLexique,
    ...
    while (syntaxRepeat_37) {
        switch (select_semanticInstructionsSyntax_38 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
            var_cas_logList.addAssign_operation (var_cas_loggedVariableName, GGS_varInExpressionAST ::constructor_new (inLexique, var_cas_loggedVariableName, GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1138))) ;
            } break ;
          case 2 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_logInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_logList COMMA_SOURCE_FILE_AT_LINE (1150)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i37_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_39 (inLexique)) {
    case 1 : {
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1169)) ;
      } break ;
    case 2 : {
  ...
  switch (select_semanticInstructionsSyntax_41 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_41371_0 ;
      nt_expression_ (inLexique, automatic_var_41371_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_41405_0 ;
      nt_expression_ (inLexique, automatic_var_41405_0) ;
      } break ;
    default :
      break ;
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_grammarInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mGrammarComponentName, var_cas_mLabelName, var_cas_mSourceExpression, var_cas_sourceExpressionIsFile, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1193)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i38_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_switch) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_switchInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_switchExpression, var_cas_switchBranches COMMA_SOURCE_FILE_AT_LINE (1233)) ;
}
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i39_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_typeMethodCallInstructionAST ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mTypeName, var_cas_mMethodName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (1255)) ;
}
