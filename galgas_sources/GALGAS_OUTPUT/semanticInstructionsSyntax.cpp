    ...
    while (syntaxRepeat_24) {
      switch (select_semanticInstructionsSyntax_24 (inLexique)) {
        ...
        case 3 : {
          ...
          const GGS_bool cond_27660 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_27660.isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_27774 = var_cas_n ;
          GGS_bool _condition_27774 (_variant_27774.isBuilt (), true) ;
          while (_condition_27774.isBuiltAndTrue ()) {
            _condition_27774 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_27774.isBuiltAndTrue ()) {
              if (_variant_27774.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (761)) ;
                _condition_27774 = GGS_bool (false) ;
              }else{
                _variant_27774.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJokerAST ::constructor_new (inLexique COMMA_HERE)) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i36_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_40 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_40426_0 ;
      nt_expression_ (inLexique, automatic_var_40426_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_40460_0 ;
      nt_expression_ (inLexique, automatic_var_40460_0) ;
      } break ;
    default :
      break ;
  }
