...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_13 (inLexique)) {
    case 1 : {
      var_cas_mWhileExpression = GGS_trueExpressionAST ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (474)) ;
      } break ;
    case 2 : {
    ...
    while (syntaxRepeat_26) {
      switch (select_semanticInstructionsSyntax_26 (inLexique)) {
        ...
        case 3 : {
          ...
          const GGS_bool cond_28380 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_28380.isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_28494 = var_cas_n ;
          GGS_bool _condition_28494 (_variant_28494.isBuilt (), true) ;
          while (_condition_28494.isBuiltAndTrue ()) {
            _condition_28494 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_28494.isBuiltAndTrue ()) {
              if (_variant_28494.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (804)) ;
                _condition_28494 = GGS_bool (false) ;
              }else{
                _variant_28494.decrement_operation (inLexique COMMA_HERE) ;
...
void semanticInstructionsSyntax::rule_semanticInstructionsSyntax_semantic_5F_instruction_i35_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_semanticInstructionsSyntax_41 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_semanticExpressionAST  automatic_var_40179_0 ;
      nt_expression_ (inLexique, automatic_var_40179_0) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
      GGS_semanticExpressionAST  automatic_var_40213_0 ;
      nt_expression_ (inLexique, automatic_var_40213_0) ;
      } break ;
    default :
      break ;
  }
