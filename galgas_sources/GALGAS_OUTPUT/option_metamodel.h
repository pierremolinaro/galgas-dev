...
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_optionComponentRootList & inOperand) const ;
  public : GGS_bool operator != (const GGS_optionComponentRootList & inOperand) const ;
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_lstring & argument_0,
                                const GGS_commandLineOptionList & argument_1) ;
//--- Handling '.' GALGAS operator
  public : GGS_optionComponentRootList operator + (const GGS_optionComponentRootList & inOperand) const ;
...
//--- Readers
  ...
  public : GGS_string reader_mDefaultValue (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
//--- operator ()
  #ifndef DO_NOT_GENERATE_CHECKINGS
...
//--- Comparison Operators
  public : GGS_bool operator == (const GGS_commandLineOptionList & inOperand) const ;
  public : GGS_bool operator != (const GGS_commandLineOptionList & inOperand) const ;
//--- Constructor 'emptyList'
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_lstring & argument_0,
                                ...
                                const GGS_string& argument_5) ;
//--- Handling '.' GALGAS operator
  public : GGS_commandLineOptionList operator + (const GGS_commandLineOptionList & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & _inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_lchar & argument_2,
