...
void templateSyntax::rule_templateSyntax_factor_i9_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateTestComplementAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifCondition COMMA_SOURCE_FILE_AT_LINE (325)) ;
}
...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_24680 = (var_cas_s.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_24680.isBuiltAndTrue ()) {
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i28_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  { bool syntaxRepeat_21 = true ;
    while (syntaxRepeat_21) {
        ...
        ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (760)) ;
          ...
          while (syntaxRepeat_22) {
            switch (select_templateSyntax_22 (inLexique)) {
              case 2 : {
                ...
                ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (764)) ;
                } break ;
              default :
  ...
  switch (select_templateSyntax_23 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (775)) ;
        ...
        while (syntaxRepeat_24) {
          switch (select_templateSyntax_24 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (779)) ;
              } break ;
            default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_if) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionIfAST ::constructor_new (inLexique, var_cas_templateInstructionIfBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (785))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i29_ (C_Lexique_galgasTemplateScanner & inLexique,
    ...
    while (syntaxRepeat_25) {
      switch (select_templateSyntax_25 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__3A_) COMMA_HERE) ;
          GGS_templateInstructionListAST  var_cas_instructionList = GGS_templateInstructionListAST ::constructor_emptyList () ;
          ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (814)) ;
          { bool syntaxRepeat_27 = true ;
            while (syntaxRepeat_27) {
              switch (select_templateSyntax_27 (inLexique)) {
                case 2 : {
                  nt_template_5F_instruction_ (inLexique, var_cas_instructionList) ;
                  ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (818)) ;
                  } break ;
                default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_switch) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionSwitchAST ::constructor_new (inLexique, var_cas_switchExpression, var_cas_templateInstructionSwitchBranchList COMMA_SOURCE_FILE_AT_LINE (825))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_parser_5F_start_5F_symbol_i30_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (837)) ;
    ...
    while (syntaxRepeat_28) {
      switch (select_templateSyntax_28 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (843)) ;
          } break ;
        default :
