    ...
    while (syntaxRepeat_0) {
      switch (select_templateSyntax_0 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_templateConcatOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_outExpression, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (82)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_1) {
      switch (select_templateSyntax_1 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_templateOrOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (103)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightOperand ;
          nt_relation_5F_term_ (inLexique, var_cas_rightOperand) ;
          var_cas_outExpression = GGS_templateXorOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (110)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_2) {
      switch (select_templateSyntax_2 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_templateAndOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (131)) ;
          } break ;
        default :
...
void templateSyntax::rule_templateSyntax_relation_5F_factor_i3_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  switch (select_templateSyntax_3 (inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_outExpression = GGS_templateEqualTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (152)) ;
      } break ;
    case 3 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_templateExpressionAST  var_cas_rightExpression ;
      nt_simple_5F_expression_ (inLexique, var_cas_rightExpression) ;
      var_cas_outExpression = GGS_templateNonEqualTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (159)) ;
      } break ;
    case 4 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_templateExpressionAST  var_cas_rightExpression ;
      nt_simple_5F_expression_ (inLexique, var_cas_rightExpression) ;
      var_cas_outExpression = GGS_templateInfOrEqualTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (166)) ;
      } break ;
    case 5 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_templateExpressionAST  var_cas_rightExpression ;
      nt_simple_5F_expression_ (inLexique, var_cas_rightExpression) ;
      var_cas_outExpression = GGS_templateSupOrEqualTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (173)) ;
      } break ;
    case 6 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_templateExpressionAST  var_cas_rightExpression ;
      nt_simple_5F_expression_ (inLexique, var_cas_rightExpression) ;
      var_cas_outExpression = GGS_templateStrictSupTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (180)) ;
      } break ;
    case 7 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_templateExpressionAST  var_cas_rightExpression ;
      nt_simple_5F_expression_ (inLexique, var_cas_rightExpression) ;
      var_cas_outExpression = GGS_templateStrictInfTestAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (187)) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat_4) {
      switch (select_templateSyntax_4 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_templateLeftShiftOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (208)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightExpression ;
          nt_term_ (inLexique, var_cas_rightExpression) ;
          var_cas_outExpression = GGS_templateRightShiftOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (215)) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightExpression ;
          nt_term_ (inLexique, var_cas_rightExpression) ;
          var_cas_outExpression = GGS_templateAddOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (222)) ;
          } break ;
        case 5 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightExpression ;
          nt_term_ (inLexique, var_cas_rightExpression) ;
          var_cas_outExpression = GGS_templateSubOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (229)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_5) {
      switch (select_templateSyntax_5 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_templateMultiplyOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (250)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightExpression ;
          nt_factor_ (inLexique, var_cas_rightExpression) ;
          var_cas_outExpression = GGS_templateDivideOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (257)) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_templateExpressionAST  var_cas_rightExpression ;
          nt_factor_ (inLexique, var_cas_rightExpression) ;
          var_cas_outExpression = GGS_templateModuloOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (264)) ;
          } break ;
        default :
...
void templateSyntax::rule_templateSyntax_factor_i6_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateUnaryMinusOperationAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (281)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i7_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateVarInExpressionAST ::constructor_new (inLexique, var_cas_identifier, GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (294)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i9_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateTestComplementAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifCondition COMMA_SOURCE_FILE_AT_LINE (324)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i10_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_templateExpressionAST  var_cas_ifCondition ;
  nt_factor_ (inLexique, var_cas_ifCondition) ;
  var_cas_outExpression = GGS_templateLogicalNegateAST ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifCondition COMMA_SOURCE_FILE_AT_LINE (340)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i11_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateTrueBoolAST ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (353)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i12_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateFalseBoolAST ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (366)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i13_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralUIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (380)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i14_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralSIntExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (394)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i15_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralUInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (408)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i16_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralSInt64ExpressionAST ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (422)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i17_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralDoubleExpressionAST ::constructor_new (inLexique, var_cas_literalDouble COMMA_SOURCE_FILE_AT_LINE (436)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i18_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralCharExpressionAST ::constructor_new (inLexique, var_cas_literalChar COMMA_SOURCE_FILE_AT_LINE (449)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i19_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
        ...
        var_cas_literalStringList.addAssign_operation (var_cas_literalString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (465))) ;
  ...
  var_cas_outExpression = GGS_templateLiteralStringExpressionAST ::constructor_new (inLexique, var_cas_literalStringList, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (468)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i20_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  switch (select_templateSyntax_7 (inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_templateCategoryTemplateCallAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_templateName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (495)) ;
      } break ;
    case 2 : {
      ...
      GGS_templateExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_templateConstructorAST ::constructor_new (inLexique, var_cas_typeName, var_cas_constructorName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (505)) ;
      } break ;
    case 3 : {
      ...
      GGS_templateExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_templateFileWrapperTemplateCallAST ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_templateName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (517)) ;
      } break ;
    case 4 : {
      GGS_templateExpressionAST  var_cas_receiverExpression ;
      nt_expression_ (inLexique, var_cas_receiverExpression) ;
      ...
      GGS_templateExpressionListAST  var_cas_expressionList ;
      nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outExpression = GGS_templateReaderCallInExpressionAST ::constructor_new (inLexique, var_cas_receiverExpression, var_cas_readerName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (524)) ;
      } break ;
    case 5 : {
      ...
      switch (select_templateSyntax_8 (inLexique)) {
        case 1 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_templateOptionAccessAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (535)), var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (535)) ;
          } break ;
        case 2 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outExpression = GGS_templateOptionAccessAST ::constructor_new (inLexique, var_cas_optionComponentName, var_cas_optionName, var_cas_readerName COMMA_SOURCE_FILE_AT_LINE (541)) ;
          } break ;
        default :
          break ;
      }
...
void templateSyntax::rule_templateSyntax_factor_i21_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__5D_) COMMA_HERE) ;
  var_cas_outExpression = GGS_templateFunctionCallAST ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (562)) ;
}
...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_s = GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (593)) ;
  const GGS_bool cond_24643 = (var_cas_s.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_24643.isBuiltAndTrue ()) {
    var_cas_outResultingInstructionList.addAssign_operation (GGS_templateInstructionStringAST ::constructor_new (inLexique, var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (595)) COMMA_SOURCE_FILE_AT_LINE (595))) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i23_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_templateExpressionAST  var_cas_expression ;
  nt_expression_ (inLexique, var_cas_expression) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionExpressionAST ::constructor_new (inLexique, var_cas_expression, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (607))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i24_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionGetColumnLocationAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (616))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i25_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionGotoColumnLocationAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (625))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i26_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (639)) ;
    ...
    while (syntaxRepeat_10) {
      switch (select_templateSyntax_10 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (643)) ;
          } break ;
        default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_block) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateBlockInstructionAST ::constructor_new (inLexique, var_cas_expression, GGS_location (inLexique), var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (648))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i27_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  switch (select_templateSyntax_12 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_identifier) COMMA_HERE) ;
      var_cas_foreachPrefix = var_cas_prefixString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) ;
      } break ;
    default :
      break ;
  }
  ...
  switch (select_templateSyntax_13 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (686)) ;
        ...
        while (syntaxRepeat_14) {
          switch (select_templateSyntax_14 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (690)) ;
              } break ;
            default :
  ...
  switch (select_templateSyntax_15 (inLexique)) {
    case 1 : {
      var_cas_indexIdentifier = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (697)) ;
      } break ;
    case 2 : {
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (703)) ;
    ...
    while (syntaxRepeat_16) {
      switch (select_templateSyntax_16 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (707)) ;
          } break ;
        default :
  ...
  switch (select_templateSyntax_17 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (714)) ;
        ...
        while (syntaxRepeat_18) {
          switch (select_templateSyntax_18 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (718)) ;
              } break ;
            default :
  ...
  switch (select_templateSyntax_19 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (726)) ;
      { bool syntaxRepeat_20 = true ;
        while (syntaxRepeat_20) {
          switch (select_templateSyntax_20 (inLexique)) {
            case 2 : {
              nt_template_5F_instruction_ (inLexique, var_cas_beforeInstructionList) ;
              ::routine_enterTemplateString (inLexique,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (730)) ;
              } break ;
            default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_foreach) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionForeachAST ::constructor_new (inLexique, var_cas_ascending, var_cas_expression, var_cas_beforeInstructionList, var_cas_doInstructionList, var_cas_indexIdentifier, var_cas_betweenInstructionList, var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (736))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i28_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  { bool syntaxRepeat_21 = true ;
    while (syntaxRepeat_21) {
        ...
        ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (759)) ;
          ...
          while (syntaxRepeat_22) {
            switch (select_templateSyntax_22 (inLexique)) {
              case 2 : {
                ...
                ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (763)) ;
                } break ;
              default :
  ...
  switch (select_templateSyntax_23 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (774)) ;
        ...
        while (syntaxRepeat_24) {
          switch (select_templateSyntax_24 (inLexique)) {
            case 2 : {
              ...
              ::routine_enterTemplateString (inLexique,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (778)) ;
              } break ;
            default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_if) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionIfAST ::constructor_new (inLexique, var_cas_templateInstructionIfBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (784))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i29_ (C_Lexique_galgasTemplateScanner & inLexique,
    ...
    while (syntaxRepeat_25) {
      switch (select_templateSyntax_25 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken__3A_) COMMA_HERE) ;
          GGS_templateInstructionListAST  var_cas_instructionList = GGS_templateInstructionListAST ::constructor_emptyList () ;
          ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (813)) ;
          { bool syntaxRepeat_27 = true ;
            while (syntaxRepeat_27) {
              switch (select_templateSyntax_27 (inLexique)) {
                case 2 : {
                  nt_template_5F_instruction_ (inLexique, var_cas_instructionList) ;
                  ::routine_enterTemplateString (inLexique,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (817)) ;
                  } break ;
                default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgasTemplateScanner::kToken_switch) COMMA_HERE) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionSwitchAST ::constructor_new (inLexique, var_cas_switchExpression, var_cas_templateInstructionSwitchBranchList COMMA_SOURCE_FILE_AT_LINE (824))) ;
}
...
void templateSyntax::rule_templateSyntax_template_5F_parser_5F_start_5F_symbol_i30_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (836)) ;
    ...
    while (syntaxRepeat_28) {
      switch (select_templateSyntax_28 (inLexique)) {
        case 2 : {
          ...
          ::routine_enterTemplateString (inLexique,  var_cas_outResultingInstructionList COMMA_SOURCE_FILE_AT_LINE (842)) ;
          } break ;
        default :
