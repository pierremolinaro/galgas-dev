...
void templateSyntax::rule_templateSyntax_factor_i11_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateTrueBoolAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (353)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i12_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateFalseBoolAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) ;
}
...
void templateSyntax::rule_templateSyntax_factor_i19_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  var_cas_outExpression = GGS_templateLiteralStringExpressionAST ::constructor_new (inLexique, var_cas_literalStringList COMMA_SOURCE_FILE_AT_LINE (468)) ;
}
...
void routine_enterTemplateString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_24619 = (var_cas_s.ggs_string ().reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_24619.isBuiltAndTrue ()) {
...
void templateSyntax::rule_templateSyntax_template_5F_instruction_i23_ (C_Lexique_galgasTemplateScanner & inLexique,
  ...
  GGS_templateExpressionAST  var_cas_expression ;
  nt_expression_ (inLexique, var_cas_expression) ;
  var_cas_ioResultingInstructionList.addAssign_operation (GGS_templateInstructionExpressionAST ::constructor_new (inLexique, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (607))) ;
}
