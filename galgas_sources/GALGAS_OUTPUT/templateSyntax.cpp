...
//                    september 22th, 2011, at 11h37'53"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void cParser_templateSyntax::rule_templateSyntax_primary_i21_ (GALGAS_templateExpressionAST & outArgument_outExpression,
  ...
  case 5: {
    ...
    case 1: {
      ...
      //-------- @assignmentInstructionForGeneration
      outArgument_outExpression = GALGAS_templateOptionAccessAST::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string ("galgas_cli_options"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (510)), var_optionName, var_readerName COMMA_SOURCE_FILE_AT_LINE (510)) ;
    } break ;
    case 2: {
      //-------- @terminalCheckInstructionForGeneration
