...
cCollectionElement_lexicalTypeList * GALGAS_lexicalTypeList::makeElement (const GALGAS_lexicalTypeEnum & in_mLexicalType
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_lexicalTypeList * result = NULL ;
  macroMyNew (result, cCollectionElement_lexicalTypeList (in_mLexicalType COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_lexicalSentValueList * GALGAS_lexicalSentValueList::makeElement (const GALGAS_string & in_mLexicalAttributeName,
                                                                                    const GALGAS_lexicalTypeEnum & in_mLexicalType
                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_lexicalSentValueList * result = NULL ;
  macroMyNew (result, cCollectionElement_lexicalSentValueList (in_mLexicalAttributeName,
...
bool cCollectionElement_terminalList::isValid (void) const {
  return mAttribute_mTerminalName.isValid () && mAttribute_mSentAttributeList.isValid () && mAttribute_mSyntaxErrorMessage.isValid () && mAttribute_mIsEndOfTemplateMark.isValid () && mAttribute_mStyleIndex.isValid () ;
}
...
cCollectionElement * cCollectionElement_terminalList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_terminalList (mAttribute_mTerminalName, mAttribute_mSentAttributeList, mAttribute_mSyntaxErrorMessage, mAttribute_mIsEndOfTemplateMark, mAttribute_mStyleIndex COMMA_HERE)) ;
  return result ;
}
...
GALGAS_terminalList GALGAS_terminalList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result.createNewEmptyList (THERE) ;
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_terminalList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    result.addObject (attributes) ;
...
cCollectionElement_terminalList * GALGAS_terminalList::makeElement (const GALGAS_lstring & in_mTerminalName,
                                                                    const GALGAS_lexicalSentValueList & in_mSentAttributeList,
                                                                    const GALGAS_string & in_mSyntaxErrorMessage,
                                                                    const GALGAS_bool & in_mIsEndOfTemplateMark,
                                                                    const GALGAS_uint & in_mStyleIndex
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_terminalList * result = NULL ;
  macroMyNew (result, cCollectionElement_terminalList (in_mTerminalName,
...
void GALGAS_terminalList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand4 = p->mAttribute_mStyleIndex ;
  }
}
...
cCollectionElement_lexicalRoutineFormalArgumentList * GALGAS_lexicalRoutineFormalArgumentList::makeElement (const GALGAS_lexicalArgumentModeAST & in_mLexicalFormalArgumentMode,
                                                                                                            const GALGAS_lexicalTypeEnum & in_mLexicalFormalArgumentType,
                                                                                                            const GALGAS_string & in_mArgumentNameForComment
                                                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_lexicalRoutineFormalArgumentList * result = NULL ;
  macroMyNew (result, cCollectionElement_lexicalRoutineFormalArgumentList (in_mLexicalFormalArgumentMode,
...
cMapElement_lexicalRoutineMap::cMapElement_lexicalRoutineMap (const GALGAS_lstring & inKey,
                                                              ...
                                                              const GALGAS_string & in_mReplacementRoutineName,
...
mAttribute_mReplacementRoutineName (in_mReplacementRoutineName),
...
bool cMapElement_lexicalRoutineMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalRoutineFormalArgumentList.isValid () && mAttribute_mErrorMessageList.isValid () && mAttribute_mReplacementRoutineName.isValid () && mAttribute_mIsExtern.isValid () ;
}
...
cMapElement * cMapElement_lexicalRoutineMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_lexicalRoutineMap (mAttribute_lkey, mAttribute_mLexicalRoutineFormalArgumentList, mAttribute_mErrorMessageList, mAttribute_mReplacementRoutineName, mAttribute_mIsExtern COMMA_HERE)) ;
  return result ;
}
...
// mAttribute_mReplacementRoutineName.description (ioString, inIndentation) ;
...
enumComparisonResult cMapElement_lexicalRoutineMap::compare (const cCollectionElement * inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mReplacementRoutineName.objectCompare (operand->mAttribute_mReplacementRoutineName) ;
  }
  if (kOperandEqual == result) {
...
void GALGAS_lexicalRoutineMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_lexicalRoutineMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_lexicalRoutineMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument2 = p->mAttribute_mReplacementRoutineName ;
...
GALGAS_string GALGAS_lexicalRoutineMap::reader_mReplacementRoutineNameForKey (const GALGAS_string & inKey,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_lexicalRoutineMap * p = (const cMapElement_lexicalRoutineMap *) attributes ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, const cMapElement_lexicalRoutineMap) ;
    result = p->mAttribute_mReplacementRoutineName ;
  }
  return result ;
}
...
void GALGAS_lexicalRoutineMap::modifier_setMReplacementRoutineNameForKey (GALGAS_string inAttributeValue,
                                                                          GALGAS_string inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_lexicalRoutineMap) ;
    p->mAttribute_mReplacementRoutineName = inAttributeValue ;
  }
}
...
GALGAS_string cEnumerator_lexicalRoutineMap::current_mReplacementRoutineName (LOCATION_ARGS) const {
  const cMapElement_lexicalRoutineMap * p = (const cMapElement_lexicalRoutineMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalRoutineMap) ;
  return p->mAttribute_mReplacementRoutineName ;
}
...
cCollectionElement_lexicalFunctionFormalArgumentList * GALGAS_lexicalFunctionFormalArgumentList::makeElement (const GALGAS_lexicalTypeEnum & in_mLexicalType,
                                                                                                              const GALGAS_string & in_mArgumentNameForComment
                                                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_lexicalFunctionFormalArgumentList * result = NULL ;
  macroMyNew (result, cCollectionElement_lexicalFunctionFormalArgumentList (in_mLexicalType,
                                                                                                              in_mArgumentNameForComment COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_templateDelimitorList * GALGAS_templateDelimitorList::makeElement (const GALGAS_lstring & in_mStartString,
                                                                                      const GALGAS_lstring & in_mEndString,
                                                                                      const GALGAS_bool & in_mPreservesStartDelimiter
                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_templateDelimitorList * result = NULL ;
  macroMyNew (result, cCollectionElement_templateDelimitorList (in_mStartString,
                                                                                      in_mEndString,
...
GALGAS_lexiqueAnalysisContext GALGAS_lexiqueAnalysisContext::constructor_new (const GALGAS_lexicalRoutineMap & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_lexiqueAnalysisContext (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
bool GALGAS_lexiqueAnalysisContext::isValid (void) const {
  return mAttribute_mLexicalRoutineMessageMap.isValid () && mAttribute_mLexicalFunctionMap.isValid () && mAttribute_mLexicalMessageMap.isValid () && mAttribute_mTerminalMap.isValid () && mAttribute_mTerminalList.isValid () && mAttribute_mLexicalAttributeMap.isValid () && mAttribute_mLexicalTokenListMap.isValid () && mAttribute_mUnicodeStringToGenerate.isValid () && mAttribute_mTemplateDelimitorList.isValid () && mAttribute_mStyleMap.isValid () ;
}
