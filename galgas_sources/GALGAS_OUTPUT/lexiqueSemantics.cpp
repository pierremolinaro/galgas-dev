...
void GGS_lexicalAttributeMap::
modifier_setMTypeNameForKey (C_Compiler & inLexique,                        const GGS_string& inValue,
...
void GGS_terminalMap::
modifier_setMArgumentTypeListForKey (C_Compiler & inLexique,                        const GGS_stringlist & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
