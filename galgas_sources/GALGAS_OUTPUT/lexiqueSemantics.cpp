...
reader_lexicalTypeBaseName (C_CompilerEx & /* inLexique */
...
GGS_string GGS_lexicalTypeEnum::
reader_cppTypeName (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    "utf32",
    "double",
...
GGS_string GGS_lexicalTypeEnum::
reader_appendMethodName (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
...
GGS_string GGS_lexicalTypeEnum::
reader_appendArgumentOfMethod (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    " COMMA_HERE",
    "",
...
GGS_string GGS_lexicalTypeEnum::
reader_initialization (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    " = TO_UNICODE (0)",
    " = 0.0",
...
GGS_string GGS_lexicalTypeEnum::
reader_cocoaTypeName (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    "UInt32",
    "double",
...
GGS_string GGS_lexicalTypeEnum::
reader_cocoaInitializationCode (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    "0",
    "0.0",
...
GGS_string GGS_lexicalTypeEnum::
reader_cocoaResetPrefix (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    "",
    "",
...
GGS_string GGS_lexicalTypeEnum::
reader_cocoaReset (C_CompilerEx & /* inLexique */
                       COMMA_UNUSED_LOCATION_ARGS) const {
  const char * kMessages [8] = {"",
    " = 0",
    " = 0.0",
...
GGS_lexicalTypeEnum GGS_lexicalTypeEnum::castFromObject (C_CompilerEx & inLexique,
...
GGS_lexicalTypeList GGS_lexicalTypeList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalTypeList result ;
...
void GGS_lexicalTypeMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
GGS_lexicalTypeMap GGS_lexicalTypeMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalTypeMap result ;
...
GGS_lexicalTypeMap GGS_lexicalTypeMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lexicalTypeEnum& inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalTypeMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
void GGS_lexicalAttributeMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalAttributeMap GGS_lexicalAttributeMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalAttributeMap result ;
...
GGS_lexicalAttributeMap GGS_lexicalAttributeMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lexicalTypeEnum& inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalAttributeMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
elementOf_GGS_lexicalSentValueList (const GGS_string& argument_0,
                                ...
                                COMMA_LOCATION_ARGS) :
AC_GGS_list::cListElement (THERE),
mLexicalAttributeName (argument_0),
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLexicalAttributeName.operator_isEqual (ptr->mLexicalAttributeName).boolValue ()
...
appendForDescription (C_String & ioString,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLexicalAttributeName.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLexicalType.reader_description (inIndentation) ;
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_string p_0 = p->mLexicalAttributeName ;
...
insulateList (void) {
  if (isShared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      internalAppendValues (ptr->mLexicalAttributeName,
                                ptr->mLexicalType
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
...
internalSubListWithRange (GGS_lexicalSentValueList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (PMSInt32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList.addAssign_operation (ptr->mLexicalAttributeName, ptr->mLexicalType) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
method_first (C_CompilerEx & inLexique,
  ...
  if (ptr != NULL) {
    _out_0 = ptr->mLexicalAttributeName ;
...
reader_mLexicalAttributeNameAtIndex (C_CompilerEx & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  ...
  if (isBuilt () && inIndex.isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
      result = object->mLexicalAttributeName ;
    }
  }
  return result ;
}
...
modifier_setMLexicalAttributeNameAtIndex (C_CompilerEx & inLexique,
  ...
  if (isBuilt () && inIndex.isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
      object->mLexicalAttributeName = inObject ;
    }
  }
}
...
/* const */ GGS_string & GGS_lexicalSentValueList::cEnumerator::_mLexicalAttributeName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mLexicalAttributeName ;
}
...
GGS_lexicalSentValueList GGS_lexicalSentValueList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalSentValueList result ;
...
void GGS_terminalMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_terminalMap GGS_terminalMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_terminalMap result ;
...
GGS_terminalMap GGS_terminalMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lexicalSentValueList & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_terminalMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_terminalList GGS_terminalList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_terminalList result ;
...
void GGS_lexicalExplicitTokenListMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalExplicitTokenListMap GGS_lexicalExplicitTokenListMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalExplicitTokenListMap result ;
...
GGS_lexicalExplicitTokenListMap GGS_lexicalExplicitTokenListMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lstring & inValue0,
                                             const GGS_lstringlist & inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalExplicitTokenListMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_tokenSortedlist GGS_tokenSortedlist::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_tokenSortedlist result ;
...
void GGS_lexicalExplicitTokenListMapMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalExplicitTokenListMapMap GGS_lexicalExplicitTokenListMapMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalExplicitTokenListMapMap result ;
...
GGS_lexicalExplicitTokenListMapMap GGS_lexicalExplicitTokenListMapMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lexicalExplicitTokenListMap & inValue0,
                                             const GGS_tokenSortedlist & inValue1,
                                             const GGS_bool& inValue2
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalExplicitTokenListMapMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
void GGS_lexicalMessageMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalMessageMap GGS_lexicalMessageMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalMessageMap result ;
...
GGS_lexicalMessageMap GGS_lexicalMessageMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lstring & inValue0,
                                             const GGS_bool& inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalMessageMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
elementOf_GGS_lexicalRoutineFormalArgumentList (const GGS_lexicalArgumentModeAST& argument_0,
                                const GGS_lexicalTypeEnum& argument_1,
                                const GGS_string& argument_2
                                COMMA_LOCATION_ARGS) :
AC_GGS_list::cListElement (THERE),
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_lexicalArgumentModeAST p_0 = p->mLexicalFormalArgumentMode ;
...
GGS_lexicalArgumentModeAST GGS_lexicalRoutineFormalArgumentList::
...
/* const */ GGS_lexicalArgumentModeAST & GGS_lexicalRoutineFormalArgumentList::cEnumerator::_mLexicalFormalArgumentMode (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
...
GGS_lexicalRoutineFormalArgumentList GGS_lexicalRoutineFormalArgumentList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalRoutineFormalArgumentList result ;
...
void GGS_lexicalRoutineMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalRoutineMap GGS_lexicalRoutineMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalRoutineMap result ;
...
GGS_lexicalRoutineMap GGS_lexicalRoutineMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             ...
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalRoutineMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_lexicalFunctionFormalArgumentList GGS_lexicalFunctionFormalArgumentList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalFunctionFormalArgumentList result ;
...
void GGS_lexicalFunctionMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalFunctionMap GGS_lexicalFunctionMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalFunctionMap result ;
...
GGS_lexicalFunctionMap GGS_lexicalFunctionMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             ...
                                             const GGS_bool& inValue3
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalFunctionMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_templateDelimitorList GGS_templateDelimitorList::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_templateDelimitorList result ;
...
void GGS_styleMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_styleMap GGS_styleMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_styleMap result ;
...
GGS_styleMap GGS_styleMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lstring & inValue0,
                                             const GGS_uint & inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_styleMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
void GGS_lexicalTagMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_lexicalTagMap GGS_lexicalTagMap::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexicalTagMap result ;
...
GGS_lexicalTagMap GGS_lexicalTagMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey
                                             COMMA_LOCATION_ARGS) {
  GGS_lexicalTagMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_lexiqueAnalysisContext GGS_lexiqueAnalysisContext::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_lexiqueAnalysisContext result ;
