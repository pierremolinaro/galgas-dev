...
class cCollectionElement_lexicalTypeList : public cCollectionElement {
  public : GALGAS_lexicalTypeList_3A_element mObject ;
...
GALGAS_lexicalTypeList_3A_element cEnumerator_lexicalTypeList::current (LOCATION_ARGS) const {
...
GALGAS_lexicalTypeMap_3A_element cEnumerator_lexicalTypeMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalTypeMap * p = (const cMapElement_lexicalTypeMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalTypeMap) ;
  return GALGAS_lexicalTypeMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexicalType) ;
}
...
GALGAS_lexicalAttributeMap_3A_element cEnumerator_lexicalAttributeMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalAttributeMap * p = (const cMapElement_lexicalAttributeMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalAttributeMap) ;
  return GALGAS_lexicalAttributeMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexicalType) ;
}
...
class cCollectionElement_lexicalSentValueList : public cCollectionElement {
  public : GALGAS_lexicalSentValueList_3A_element mObject ;
...
GALGAS_lexicalSentValueList_3A_element cEnumerator_lexicalSentValueList::current (LOCATION_ARGS) const {
...
GALGAS_terminalMap_3A_element cEnumerator_terminalMap::current (LOCATION_ARGS) const {
  const cMapElement_terminalMap * p = (const cMapElement_terminalMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_terminalMap) ;
  return GALGAS_terminalMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSentAttributeList) ;
}
...
class cCollectionElement_terminalList : public cCollectionElement {
  public : GALGAS_terminalList_3A_element mObject ;
...
GALGAS_terminalList_3A_element cEnumerator_terminalList::current (LOCATION_ARGS) const {
...
GALGAS_lexicalExplicitTokenListMap_3A_element cEnumerator_lexicalExplicitTokenListMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalExplicitTokenListMap * p = (const cMapElement_lexicalExplicitTokenListMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalExplicitTokenListMap) ;
  return GALGAS_lexicalExplicitTokenListMap_3A_element (p->mAttribute_lkey, p->mAttribute_mTerminal, p->mAttribute_mFeatureList) ;
}
...
class cSortedListElement_tokenSortedlist : public cSortedListElement {
  public : GALGAS_tokenSortedlist_3A_element mObject ;
...
GALGAS_tokenSortedlist_3A_element cEnumerator_tokenSortedlist::current (LOCATION_ARGS) const {
...
GALGAS_lexicalExplicitTokenListMapMap_3A_element cEnumerator_lexicalExplicitTokenListMapMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_lexicalExplicitTokenListMapMap) ;
  return GALGAS_lexicalExplicitTokenListMapMap_3A_element (p->mAttribute_lkey, p->mAttribute_mExplicitTokenListMap, p->mAttribute_mTokenSortedList, p->mAttribute_mShouldBeGenerated) ;
}
...
GALGAS_lexicalMessageMap_3A_element cEnumerator_lexicalMessageMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalMessageMap * p = (const cMapElement_lexicalMessageMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalMessageMap) ;
  return GALGAS_lexicalMessageMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexicalMessage, p->mAttribute_mMessageIsUsed) ;
}
...
class cCollectionElement_lexicalRoutineFormalArgumentList : public cCollectionElement {
  public : GALGAS_lexicalRoutineFormalArgumentList_3A_element mObject ;
...
GALGAS_lexicalRoutineFormalArgumentList_3A_element cEnumerator_lexicalRoutineFormalArgumentList::current (LOCATION_ARGS) const {
...
GALGAS_lexicalRoutineMap_3A_element cEnumerator_lexicalRoutineMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalRoutineMap * p = (const cMapElement_lexicalRoutineMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalRoutineMap) ;
  return GALGAS_lexicalRoutineMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexicalRoutineFormalArgumentList, p->mAttribute_mErrorMessageList, p->mAttribute_mIsExtern) ;
}
...
class cCollectionElement_lexicalFunctionFormalArgumentList : public cCollectionElement {
  public : GALGAS_lexicalFunctionFormalArgumentList_3A_element mObject ;
...
GALGAS_lexicalFunctionFormalArgumentList_3A_element cEnumerator_lexicalFunctionFormalArgumentList::current (LOCATION_ARGS) const {
...
GALGAS_lexicalFunctionMap_3A_element cEnumerator_lexicalFunctionMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalFunctionMap * p = (const cMapElement_lexicalFunctionMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalFunctionMap) ;
  return GALGAS_lexicalFunctionMap_3A_element (p->mAttribute_lkey, p->mAttribute_mLexicalTypeList, p->mAttribute_mReturnedLexicalType, p->mAttribute_mReplacementFunctionName, p->mAttribute_mIsExtern) ;
}
...
class cCollectionElement_templateDelimitorList : public cCollectionElement {
  public : GALGAS_templateDelimitorList_3A_element mObject ;
...
GALGAS_templateDelimitorList_3A_element cEnumerator_templateDelimitorList::current (LOCATION_ARGS) const {
...
GALGAS_styleMap_3A_element cEnumerator_styleMap::current (LOCATION_ARGS) const {
  const cMapElement_styleMap * p = (const cMapElement_styleMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_styleMap) ;
  return GALGAS_styleMap_3A_element (p->mAttribute_lkey, p->mAttribute_mComment, p->mAttribute_mStyleIndex) ;
}
...
GALGAS_lexicalTagMap_3A_element cEnumerator_lexicalTagMap::current (LOCATION_ARGS) const {
  const cMapElement_lexicalTagMap * p = (const cMapElement_lexicalTagMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_lexicalTagMap) ;
  return GALGAS_lexicalTagMap_3A_element (p->mAttribute_lkey) ;
}
...
GALGAS_lexicalTypeList_3A_element::GALGAS_lexicalTypeList_3A_element (void) :
...
GALGAS_lexicalTypeList_3A_element::GALGAS_lexicalTypeList_3A_element (const GALGAS_lexicalTypeEnum & inOperand0) :
mAttribute_mLexicalType (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_lexicalTypeList_3A_element & GALGAS_lexicalTypeList_3A_element::operator = (const GALGAS_lexicalTypeList_3A_element & inOperand) {
  mAttribute_mLexicalType = inOperand.mAttribute_mLexicalType ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeList_3A_element GALGAS_lexicalTypeList_3A_element::constructor_new (const GALGAS_lexicalTypeEnum & inOperand0 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalTypeList_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_lexicalTypeList_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalTypeList_3A_element::objectCompare (const GALGAS_lexicalTypeList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_lexicalTypeList_3A_element::isValid (void) const {
  return mAttribute_mLexicalType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalTypeList_3A_element::drop (void) {
  mAttribute_mLexicalType.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalTypeList_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_lexicalTypeEnum GALGAS_lexicalTypeList_3A_element::reader_mLexicalType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalTypeList_3A_element ("lexicalTypeList:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalTypeList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalTypeList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalTypeList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalTypeList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalTypeList_3A_element GALGAS_lexicalTypeList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_lexicalTypeList_3A_element result ;
  const GALGAS_lexicalTypeList_3A_element * p = (const GALGAS_lexicalTypeList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalTypeList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalTypeList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalTypeMap_3A_element::GALGAS_lexicalTypeMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mLexicalType () {
}
...
GALGAS_lexicalTypeMap_3A_element::GALGAS_lexicalTypeMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                    const GALGAS_lexicalTypeEnum & inOperand1) :
...
/* GALGAS_lexicalTypeMap_3A_element & GALGAS_lexicalTypeMap_3A_element::operator = (const GALGAS_lexicalTypeMap_3A_element & inOperand) {
...
GALGAS_lexicalTypeMap_3A_element GALGAS_lexicalTypeMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_lexicalTypeEnum & inOperand1 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalTypeMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_lexicalTypeMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalTypeMap_3A_element::objectCompare (const GALGAS_lexicalTypeMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_lexicalTypeMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalTypeMap_3A_element::drop (void) {
...
void GALGAS_lexicalTypeMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalTypeMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeEnum GALGAS_lexicalTypeMap_3A_element::reader_mLexicalType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalType ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalTypeMap_3A_element ("lexicalTypeMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalTypeMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalTypeMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalTypeMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalTypeMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalTypeMap_3A_element GALGAS_lexicalTypeMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_lexicalTypeMap_3A_element result ;
  const GALGAS_lexicalTypeMap_3A_element * p = (const GALGAS_lexicalTypeMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalTypeMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalTypeMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalAttributeMap_3A_element::GALGAS_lexicalAttributeMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mLexicalType () {
}
...
GALGAS_lexicalAttributeMap_3A_element::GALGAS_lexicalAttributeMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_lexicalTypeEnum & inOperand1) :
mAttribute_lkey (inOperand0),
mAttribute_mLexicalType (inOperand1) {
}
...
/* GALGAS_lexicalAttributeMap_3A_element & GALGAS_lexicalAttributeMap_3A_element::operator = (const GALGAS_lexicalAttributeMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mLexicalType = inOperand.mAttribute_mLexicalType ;
  return *this ;
} */
...
GALGAS_lexicalAttributeMap_3A_element GALGAS_lexicalAttributeMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                              const GALGAS_lexicalTypeEnum & inOperand1 
                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalAttributeMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_lexicalAttributeMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalAttributeMap_3A_element::objectCompare (const GALGAS_lexicalAttributeMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalAttributeMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalAttributeMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mLexicalType.drop () ;
}
...
void GALGAS_lexicalAttributeMap_3A_element::description (C_String & ioString,
                                                         const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalAttributeMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeEnum GALGAS_lexicalAttributeMap_3A_element::reader_mLexicalType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalType ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalAttributeMap_3A_element ("lexicalAttributeMap:element",
                                                       NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalAttributeMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalAttributeMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalAttributeMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalAttributeMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalAttributeMap_3A_element GALGAS_lexicalAttributeMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                            C_Compiler * inCompiler,
                                                                                            const GALGAS_location & inErrorLocation
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_lexicalAttributeMap_3A_element result ;
  const GALGAS_lexicalAttributeMap_3A_element * p = (const GALGAS_lexicalAttributeMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalAttributeMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalAttributeMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalSentValueList_3A_element::GALGAS_lexicalSentValueList_3A_element (void) :
...
GALGAS_lexicalSentValueList_3A_element::GALGAS_lexicalSentValueList_3A_element (const GALGAS_string & inOperand0,
                                                                                const GALGAS_lexicalTypeEnum & inOperand1) :
...
/* GALGAS_lexicalSentValueList_3A_element & GALGAS_lexicalSentValueList_3A_element::operator = (const GALGAS_lexicalSentValueList_3A_element & inOperand) {
  mAttribute_mLexicalAttributeName = inOperand.mAttribute_mLexicalAttributeName ;
  mAttribute_mLexicalType = inOperand.mAttribute_mLexicalType ;
  return *this ;
} */
...
GALGAS_lexicalSentValueList_3A_element GALGAS_lexicalSentValueList_3A_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                const GALGAS_lexicalTypeEnum & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalSentValueList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_lexicalSentValueList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalSentValueList_3A_element::objectCompare (const GALGAS_lexicalSentValueList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_lexicalSentValueList_3A_element::isValid (void) const {
  return mAttribute_mLexicalAttributeName.isValid () && mAttribute_mLexicalType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalSentValueList_3A_element::drop (void) {
...
void GALGAS_lexicalSentValueList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_lexicalSentValueList_3A_element::reader_mLexicalAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalAttributeName ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeEnum GALGAS_lexicalSentValueList_3A_element::reader_mLexicalType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalType ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalSentValueList_3A_element ("lexicalSentValueList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalSentValueList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalSentValueList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalSentValueList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalSentValueList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalSentValueList_3A_element GALGAS_lexicalSentValueList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_lexicalSentValueList_3A_element result ;
  const GALGAS_lexicalSentValueList_3A_element * p = (const GALGAS_lexicalSentValueList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalSentValueList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalSentValueList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_terminalMap_3A_element::GALGAS_terminalMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_terminalMap_3A_element::GALGAS_terminalMap_3A_element (const GALGAS_lstring & inOperand0,
                                                              const GALGAS_lexicalSentValueList & inOperand1) :
mAttribute_lkey (inOperand0),
...
/* GALGAS_terminalMap_3A_element & GALGAS_terminalMap_3A_element::operator = (const GALGAS_terminalMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
...
GALGAS_terminalMap_3A_element GALGAS_terminalMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_lexicalSentValueList & inOperand1 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_terminalMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_terminalMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_terminalMap_3A_element::objectCompare (const GALGAS_terminalMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_terminalMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSentAttributeList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_terminalMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_terminalMap_3A_element::description (C_String & ioString,
                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_terminalMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalSentValueList GALGAS_terminalMap_3A_element::reader_mSentAttributeList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_terminalMap_3A_element ("terminalMap:element",
                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_terminalMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_terminalMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_terminalMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_terminalMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_terminalMap_3A_element GALGAS_terminalMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler,
                                                                            const GALGAS_location & inErrorLocation
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_terminalMap_3A_element result ;
  const GALGAS_terminalMap_3A_element * p = (const GALGAS_terminalMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_terminalMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "terminalMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_terminalList_3A_element::GALGAS_terminalList_3A_element (void) :
...
GALGAS_terminalList_3A_element::GALGAS_terminalList_3A_element (const GALGAS_lstring & inOperand0,
                                                                const GALGAS_lexicalSentValueList & inOperand1,
                                                                const GALGAS_string & inOperand2,
                                                                const GALGAS_bool & inOperand3,
                                                                const GALGAS_bool & inOperand4,
...
/* GALGAS_terminalList_3A_element & GALGAS_terminalList_3A_element::operator = (const GALGAS_terminalList_3A_element & inOperand) {
  mAttribute_mTerminalName = inOperand.mAttribute_mTerminalName ;
  mAttribute_mSentAttributeList = inOperand.mAttribute_mSentAttributeList ;
  mAttribute_mSyntaxErrorMessage = inOperand.mAttribute_mSyntaxErrorMessage ;
  mAttribute_mIsEndOfTemplateMark = inOperand.mAttribute_mIsEndOfTemplateMark ;
  mAttribute_mAtomicSelection = inOperand.mAttribute_mAtomicSelection ;
  mAttribute_mStyleIndex = inOperand.mAttribute_mStyleIndex ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_terminalList_3A_element GALGAS_terminalList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                const GALGAS_lexicalSentValueList & inOperand1,
                                                                                const GALGAS_string & inOperand2,
                                                                                const GALGAS_bool & inOperand3,
                                                                                const GALGAS_bool & inOperand4,
                                                                                const GALGAS_uint & inOperand5 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_terminalList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result = GALGAS_terminalList_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_terminalList_3A_element::objectCompare (const GALGAS_terminalList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_terminalList_3A_element::isValid (void) const {
...
void GALGAS_terminalList_3A_element::drop (void) {
...
void GALGAS_terminalList_3A_element::description (C_String & ioString,
                                                  const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_terminalList_3A_element::reader_mTerminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTerminalName ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalSentValueList GALGAS_terminalList_3A_element::reader_mSentAttributeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSentAttributeList ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_terminalList_3A_element::reader_mSyntaxErrorMessage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSyntaxErrorMessage ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_terminalList_3A_element::reader_mIsEndOfTemplateMark (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsEndOfTemplateMark ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_terminalList_3A_element::reader_mAtomicSelection (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAtomicSelection ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_terminalList_3A_element::reader_mStyleIndex (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_terminalList_3A_element ("terminalList:element",
                                                NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_terminalList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_terminalList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_terminalList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_terminalList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_terminalList_3A_element GALGAS_terminalList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                              C_Compiler * inCompiler,
                                                                              const GALGAS_location & inErrorLocation
                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_terminalList_3A_element result ;
  const GALGAS_terminalList_3A_element * p = (const GALGAS_terminalList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_terminalList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "terminalList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalExplicitTokenListMap_3A_element::GALGAS_lexicalExplicitTokenListMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_lexicalExplicitTokenListMap_3A_element::GALGAS_lexicalExplicitTokenListMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                                              const GALGAS_lstring & inOperand1,
...
/* GALGAS_lexicalExplicitTokenListMap_3A_element & GALGAS_lexicalExplicitTokenListMap_3A_element::operator = (const GALGAS_lexicalExplicitTokenListMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mTerminal = inOperand.mAttribute_mTerminal ;
...
GALGAS_lexicalExplicitTokenListMap_3A_element GALGAS_lexicalExplicitTokenListMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_lstring & inOperand1,
                                                                                                              const GALGAS_lstringlist & inOperand2 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalExplicitTokenListMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_lexicalExplicitTokenListMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalExplicitTokenListMap_3A_element::objectCompare (const GALGAS_lexicalExplicitTokenListMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalExplicitTokenListMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mTerminal.isValid () && mAttribute_mFeatureList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalExplicitTokenListMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_lexicalExplicitTokenListMap_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalExplicitTokenListMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_lexicalExplicitTokenListMap_3A_element::reader_mTerminal (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTerminal ;
}

//---------------------------------------------------------------------------*

GALGAS_lstringlist GALGAS_lexicalExplicitTokenListMap_3A_element::reader_mFeatureList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalExplicitTokenListMap_3A_element ("lexicalExplicitTokenListMap:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalExplicitTokenListMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalExplicitTokenListMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalExplicitTokenListMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalExplicitTokenListMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalExplicitTokenListMap_3A_element GALGAS_lexicalExplicitTokenListMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_lexicalExplicitTokenListMap_3A_element result ;
  const GALGAS_lexicalExplicitTokenListMap_3A_element * p = (const GALGAS_lexicalExplicitTokenListMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalExplicitTokenListMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalExplicitTokenListMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_tokenSortedlist_3A_element::GALGAS_tokenSortedlist_3A_element (void) :
mAttribute_mLength (),
mAttribute_mName (),
mAttribute_mTerminalName () {
}
...
GALGAS_tokenSortedlist_3A_element::GALGAS_tokenSortedlist_3A_element (const GALGAS_uint & inOperand0,
                                                                      const GALGAS_string & inOperand1,
                                                                      const GALGAS_string & inOperand2) :
...
/* GALGAS_tokenSortedlist_3A_element & GALGAS_tokenSortedlist_3A_element::operator = (const GALGAS_tokenSortedlist_3A_element & inOperand) {
  mAttribute_mLength = inOperand.mAttribute_mLength ;
...
GALGAS_tokenSortedlist_3A_element GALGAS_tokenSortedlist_3A_element::constructor_new (const GALGAS_uint & inOperand0,
                                                                                      const GALGAS_string & inOperand1,
                                                                                      const GALGAS_string & inOperand2 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_tokenSortedlist_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_tokenSortedlist_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_tokenSortedlist_3A_element::objectCompare (const GALGAS_tokenSortedlist_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_tokenSortedlist_3A_element::isValid (void) const {
  return mAttribute_mLength.isValid () && mAttribute_mName.isValid () && mAttribute_mTerminalName.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_tokenSortedlist_3A_element::drop (void) {
...
void GALGAS_tokenSortedlist_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_uint GALGAS_tokenSortedlist_3A_element::reader_mLength (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLength ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_tokenSortedlist_3A_element::reader_mName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_tokenSortedlist_3A_element::reader_mTerminalName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTerminalName ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_tokenSortedlist_3A_element ("tokenSortedlist:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_tokenSortedlist_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_tokenSortedlist_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_tokenSortedlist_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_tokenSortedlist_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_tokenSortedlist_3A_element GALGAS_tokenSortedlist_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_tokenSortedlist_3A_element result ;
  const GALGAS_tokenSortedlist_3A_element * p = (const GALGAS_tokenSortedlist_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_tokenSortedlist_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "tokenSortedlist:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalExplicitTokenListMapMap_3A_element::GALGAS_lexicalExplicitTokenListMapMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_lexicalExplicitTokenListMapMap_3A_element::GALGAS_lexicalExplicitTokenListMapMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_lexicalExplicitTokenListMapMap_3A_element & GALGAS_lexicalExplicitTokenListMapMap_3A_element::operator = (const GALGAS_lexicalExplicitTokenListMapMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mExplicitTokenListMap = inOperand.mAttribute_mExplicitTokenListMap ;
  mAttribute_mTokenSortedList = inOperand.mAttribute_mTokenSortedList ;
  mAttribute_mShouldBeGenerated = inOperand.mAttribute_mShouldBeGenerated ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_lexicalExplicitTokenListMapMap_3A_element GALGAS_lexicalExplicitTokenListMapMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                                    const GALGAS_lexicalExplicitTokenListMap & inOperand1,
                                                                                                                    const GALGAS_tokenSortedlist & inOperand2,
                                                                                                                    const GALGAS_bool & inOperand3 
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalExplicitTokenListMapMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_lexicalExplicitTokenListMapMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalExplicitTokenListMapMap_3A_element::objectCompare (const GALGAS_lexicalExplicitTokenListMapMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalExplicitTokenListMapMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mExplicitTokenListMap.isValid () && mAttribute_mTokenSortedList.isValid () && mAttribute_mShouldBeGenerated.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalExplicitTokenListMapMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_lexicalExplicitTokenListMapMap_3A_element::description (C_String & ioString,
                                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalExplicitTokenListMapMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalExplicitTokenListMap GALGAS_lexicalExplicitTokenListMapMap_3A_element::reader_mExplicitTokenListMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExplicitTokenListMap ;
}

//---------------------------------------------------------------------------*

GALGAS_tokenSortedlist GALGAS_lexicalExplicitTokenListMapMap_3A_element::reader_mTokenSortedList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTokenSortedList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_lexicalExplicitTokenListMapMap_3A_element::reader_mShouldBeGenerated (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalExplicitTokenListMapMap_3A_element ("lexicalExplicitTokenListMapMap:element",
                                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalExplicitTokenListMapMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalExplicitTokenListMapMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalExplicitTokenListMapMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalExplicitTokenListMapMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalExplicitTokenListMapMap_3A_element GALGAS_lexicalExplicitTokenListMapMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler,
                                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_lexicalExplicitTokenListMapMap_3A_element result ;
  const GALGAS_lexicalExplicitTokenListMapMap_3A_element * p = (const GALGAS_lexicalExplicitTokenListMapMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalExplicitTokenListMapMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalExplicitTokenListMapMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalMessageMap_3A_element::GALGAS_lexicalMessageMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_lexicalMessageMap_3A_element::GALGAS_lexicalMessageMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_lstring & inOperand1,
                                                                          const GALGAS_bool & inOperand2) :
mAttribute_lkey (inOperand0),
...
/* GALGAS_lexicalMessageMap_3A_element & GALGAS_lexicalMessageMap_3A_element::operator = (const GALGAS_lexicalMessageMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mLexicalMessage = inOperand.mAttribute_mLexicalMessage ;
  mAttribute_mMessageIsUsed = inOperand.mAttribute_mMessageIsUsed ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_lexicalMessageMap_3A_element GALGAS_lexicalMessageMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_lstring & inOperand1,
                                                                                          const GALGAS_bool & inOperand2 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalMessageMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_lexicalMessageMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalMessageMap_3A_element::objectCompare (const GALGAS_lexicalMessageMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalMessageMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalMessage.isValid () && mAttribute_mMessageIsUsed.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalMessageMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_lexicalMessageMap_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalMessageMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_lexicalMessageMap_3A_element::reader_mLexicalMessage (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalMessage ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_lexicalMessageMap_3A_element::reader_mMessageIsUsed (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalMessageMap_3A_element ("lexicalMessageMap:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalMessageMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalMessageMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalMessageMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalMessageMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalMessageMap_3A_element GALGAS_lexicalMessageMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_lexicalMessageMap_3A_element result ;
  const GALGAS_lexicalMessageMap_3A_element * p = (const GALGAS_lexicalMessageMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalMessageMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalMessageMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalRoutineFormalArgumentList_3A_element::GALGAS_lexicalRoutineFormalArgumentList_3A_element (void) :
...
GALGAS_lexicalRoutineFormalArgumentList_3A_element::GALGAS_lexicalRoutineFormalArgumentList_3A_element (const GALGAS_lexicalArgumentModeAST & inOperand0,
                                                                                                        const GALGAS_lexicalTypeEnum & inOperand1,
                                                                                                        const GALGAS_string & inOperand2) :
...
/* GALGAS_lexicalRoutineFormalArgumentList_3A_element & GALGAS_lexicalRoutineFormalArgumentList_3A_element::operator = (const GALGAS_lexicalRoutineFormalArgumentList_3A_element & inOperand) {
  mAttribute_mLexicalFormalArgumentMode = inOperand.mAttribute_mLexicalFormalArgumentMode ;
  mAttribute_mLexicalFormalArgumentType = inOperand.mAttribute_mLexicalFormalArgumentType ;
  mAttribute_mArgumentNameForComment = inOperand.mAttribute_mArgumentNameForComment ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_lexicalRoutineFormalArgumentList_3A_element GALGAS_lexicalRoutineFormalArgumentList_3A_element::constructor_new (const GALGAS_lexicalArgumentModeAST & inOperand0,
                                                                                                                        const GALGAS_lexicalTypeEnum & inOperand1,
                                                                                                                        const GALGAS_string & inOperand2 
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalRoutineFormalArgumentList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_lexicalRoutineFormalArgumentList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalRoutineFormalArgumentList_3A_element::objectCompare (const GALGAS_lexicalRoutineFormalArgumentList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_lexicalRoutineFormalArgumentList_3A_element::isValid (void) const {
...
void GALGAS_lexicalRoutineFormalArgumentList_3A_element::drop (void) {
...
void GALGAS_lexicalRoutineFormalArgumentList_3A_element::description (C_String & ioString,
                                                                      const PMSInt32 inIndentation) const {
...
GALGAS_lexicalArgumentModeAST GALGAS_lexicalRoutineFormalArgumentList_3A_element::reader_mLexicalFormalArgumentMode (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalFormalArgumentMode ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeEnum GALGAS_lexicalRoutineFormalArgumentList_3A_element::reader_mLexicalFormalArgumentType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalFormalArgumentType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_lexicalRoutineFormalArgumentList_3A_element::reader_mArgumentNameForComment (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalRoutineFormalArgumentList_3A_element ("lexicalRoutineFormalArgumentList:element",
                                                                    NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalRoutineFormalArgumentList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalRoutineFormalArgumentList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalRoutineFormalArgumentList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalRoutineFormalArgumentList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalRoutineFormalArgumentList_3A_element GALGAS_lexicalRoutineFormalArgumentList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                      C_Compiler * inCompiler,
                                                                                                                      const GALGAS_location & inErrorLocation
                                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_lexicalRoutineFormalArgumentList_3A_element result ;
  const GALGAS_lexicalRoutineFormalArgumentList_3A_element * p = (const GALGAS_lexicalRoutineFormalArgumentList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalRoutineFormalArgumentList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalRoutineFormalArgumentList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalRoutineMap_3A_element::GALGAS_lexicalRoutineMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_lexicalRoutineMap_3A_element::GALGAS_lexicalRoutineMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_lexicalRoutineMap_3A_element & GALGAS_lexicalRoutineMap_3A_element::operator = (const GALGAS_lexicalRoutineMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  ...
  mAttribute_mIsExtern = inOperand.mAttribute_mIsExtern ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_lexicalRoutineMap_3A_element GALGAS_lexicalRoutineMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                          const GALGAS_lexicalRoutineFormalArgumentList & inOperand1,
                                                                                          const GALGAS_stringlist & inOperand2,
                                                                                          const GALGAS_bool & inOperand3 
                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalRoutineMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_lexicalRoutineMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalRoutineMap_3A_element::objectCompare (const GALGAS_lexicalRoutineMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalRoutineMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalRoutineFormalArgumentList.isValid () && mAttribute_mErrorMessageList.isValid () && mAttribute_mIsExtern.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalRoutineMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_lexicalRoutineMap_3A_element::description (C_String & ioString,
                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalRoutineMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalRoutineFormalArgumentList GALGAS_lexicalRoutineMap_3A_element::reader_mLexicalRoutineFormalArgumentList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalRoutineFormalArgumentList ;
}

//---------------------------------------------------------------------------*

GALGAS_stringlist GALGAS_lexicalRoutineMap_3A_element::reader_mErrorMessageList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mErrorMessageList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_lexicalRoutineMap_3A_element::reader_mIsExtern (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalRoutineMap_3A_element ("lexicalRoutineMap:element",
                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalRoutineMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalRoutineMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalRoutineMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalRoutineMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalRoutineMap_3A_element GALGAS_lexicalRoutineMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                        C_Compiler * inCompiler,
                                                                                        const GALGAS_location & inErrorLocation
                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_lexicalRoutineMap_3A_element result ;
  const GALGAS_lexicalRoutineMap_3A_element * p = (const GALGAS_lexicalRoutineMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalRoutineMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalRoutineMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalFunctionFormalArgumentList_3A_element::GALGAS_lexicalFunctionFormalArgumentList_3A_element (void) :
mAttribute_mLexicalType (),
mAttribute_mArgumentNameForComment () {
}
...
GALGAS_lexicalFunctionFormalArgumentList_3A_element::GALGAS_lexicalFunctionFormalArgumentList_3A_element (const GALGAS_lexicalTypeEnum & inOperand0,
                                                                                                          const GALGAS_string & inOperand1) :
mAttribute_mLexicalType (inOperand0),
...
/* GALGAS_lexicalFunctionFormalArgumentList_3A_element & GALGAS_lexicalFunctionFormalArgumentList_3A_element::operator = (const GALGAS_lexicalFunctionFormalArgumentList_3A_element & inOperand) {
  mAttribute_mLexicalType = inOperand.mAttribute_mLexicalType ;
  mAttribute_mArgumentNameForComment = inOperand.mAttribute_mArgumentNameForComment ;
  return *this ;
} */
...
GALGAS_lexicalFunctionFormalArgumentList_3A_element GALGAS_lexicalFunctionFormalArgumentList_3A_element::constructor_new (const GALGAS_lexicalTypeEnum & inOperand0,
                                                                                                                          const GALGAS_string & inOperand1 
                                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalFunctionFormalArgumentList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_lexicalFunctionFormalArgumentList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalFunctionFormalArgumentList_3A_element::objectCompare (const GALGAS_lexicalFunctionFormalArgumentList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mLexicalType.objectCompare (inOperand.mAttribute_mLexicalType) ;
  }
...
bool GALGAS_lexicalFunctionFormalArgumentList_3A_element::isValid (void) const {
  return mAttribute_mLexicalType.isValid () && mAttribute_mArgumentNameForComment.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalFunctionFormalArgumentList_3A_element::drop (void) {
  mAttribute_mLexicalType.drop () ;
  mAttribute_mArgumentNameForComment.drop () ;
}
...
void GALGAS_lexicalFunctionFormalArgumentList_3A_element::description (C_String & ioString,
                                                                       const PMSInt32 inIndentation) const {
...
GALGAS_lexicalTypeEnum GALGAS_lexicalFunctionFormalArgumentList_3A_element::reader_mLexicalType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_lexicalFunctionFormalArgumentList_3A_element::reader_mArgumentNameForComment (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mArgumentNameForComment ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalFunctionFormalArgumentList_3A_element ("lexicalFunctionFormalArgumentList:element",
                                                                     NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalFunctionFormalArgumentList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalFunctionFormalArgumentList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalFunctionFormalArgumentList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalFunctionFormalArgumentList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalFunctionFormalArgumentList_3A_element GALGAS_lexicalFunctionFormalArgumentList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                        C_Compiler * inCompiler,
                                                                                                                        const GALGAS_location & inErrorLocation
                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_lexicalFunctionFormalArgumentList_3A_element result ;
  const GALGAS_lexicalFunctionFormalArgumentList_3A_element * p = (const GALGAS_lexicalFunctionFormalArgumentList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalFunctionFormalArgumentList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalFunctionFormalArgumentList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalFunctionMap_3A_element::GALGAS_lexicalFunctionMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_lexicalFunctionMap_3A_element::GALGAS_lexicalFunctionMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_lexicalFunctionMap_3A_element & GALGAS_lexicalFunctionMap_3A_element::operator = (const GALGAS_lexicalFunctionMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mLexicalTypeList = inOperand.mAttribute_mLexicalTypeList ;
  mAttribute_mReturnedLexicalType = inOperand.mAttribute_mReturnedLexicalType ;
  mAttribute_mReplacementFunctionName = inOperand.mAttribute_mReplacementFunctionName ;
  mAttribute_mIsExtern = inOperand.mAttribute_mIsExtern ;
  return *this ;
} */
...
GALGAS_lexicalFunctionMap_3A_element GALGAS_lexicalFunctionMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                            const GALGAS_lexicalFunctionFormalArgumentList & inOperand1,
                                                                                            const GALGAS_lexicalTypeEnum & inOperand2,
                                                                                            const GALGAS_string & inOperand3,
                                                                                            const GALGAS_bool & inOperand4 
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalFunctionMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_lexicalFunctionMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalFunctionMap_3A_element::objectCompare (const GALGAS_lexicalFunctionMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalFunctionMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mLexicalTypeList.isValid () && mAttribute_mReturnedLexicalType.isValid () && mAttribute_mReplacementFunctionName.isValid () && mAttribute_mIsExtern.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalFunctionMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_lexicalFunctionMap_3A_element::description (C_String & ioString,
                                                        const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalFunctionMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalFunctionFormalArgumentList GALGAS_lexicalFunctionMap_3A_element::reader_mLexicalTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLexicalTypeList ;
}

//---------------------------------------------------------------------------*

GALGAS_lexicalTypeEnum GALGAS_lexicalFunctionMap_3A_element::reader_mReturnedLexicalType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReturnedLexicalType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_lexicalFunctionMap_3A_element::reader_mReplacementFunctionName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mReplacementFunctionName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_lexicalFunctionMap_3A_element::reader_mIsExtern (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsExtern ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalFunctionMap_3A_element ("lexicalFunctionMap:element",
                                                      NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalFunctionMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalFunctionMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalFunctionMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalFunctionMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalFunctionMap_3A_element GALGAS_lexicalFunctionMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                          C_Compiler * inCompiler,
                                                                                          const GALGAS_location & inErrorLocation
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_lexicalFunctionMap_3A_element result ;
  const GALGAS_lexicalFunctionMap_3A_element * p = (const GALGAS_lexicalFunctionMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalFunctionMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalFunctionMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_templateDelimitorList_3A_element::GALGAS_templateDelimitorList_3A_element (void) :
...
GALGAS_templateDelimitorList_3A_element::GALGAS_templateDelimitorList_3A_element (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_lstring & inOperand1,
                                                                                  const GALGAS_bool & inOperand2) :
...
/* GALGAS_templateDelimitorList_3A_element & GALGAS_templateDelimitorList_3A_element::operator = (const GALGAS_templateDelimitorList_3A_element & inOperand) {
  mAttribute_mStartString = inOperand.mAttribute_mStartString ;
  mAttribute_mEndString = inOperand.mAttribute_mEndString ;
  mAttribute_mPreservesStartDelimiter = inOperand.mAttribute_mPreservesStartDelimiter ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_templateDelimitorList_3A_element GALGAS_templateDelimitorList_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_lstring & inOperand1,
                                                                                                  const GALGAS_bool & inOperand2 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_templateDelimitorList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_templateDelimitorList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_templateDelimitorList_3A_element::objectCompare (const GALGAS_templateDelimitorList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_templateDelimitorList_3A_element::isValid (void) const {
  return mAttribute_mStartString.isValid () && mAttribute_mEndString.isValid () && mAttribute_mPreservesStartDelimiter.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_templateDelimitorList_3A_element::drop (void) {
...
void GALGAS_templateDelimitorList_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_templateDelimitorList_3A_element::reader_mStartString (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStartString ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_templateDelimitorList_3A_element::reader_mEndString (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEndString ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_templateDelimitorList_3A_element::reader_mPreservesStartDelimiter (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_templateDelimitorList_3A_element ("templateDelimitorList:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_templateDelimitorList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_templateDelimitorList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_templateDelimitorList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_templateDelimitorList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_templateDelimitorList_3A_element GALGAS_templateDelimitorList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_templateDelimitorList_3A_element result ;
  const GALGAS_templateDelimitorList_3A_element * p = (const GALGAS_templateDelimitorList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_templateDelimitorList_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "templateDelimitorList:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_styleMap_3A_element::GALGAS_styleMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mComment (),
mAttribute_mStyleIndex () {
}
...
GALGAS_styleMap_3A_element::GALGAS_styleMap_3A_element (const GALGAS_lstring & inOperand0,
                                                        const GALGAS_lstring & inOperand1,
...
/* GALGAS_styleMap_3A_element & GALGAS_styleMap_3A_element::operator = (const GALGAS_styleMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
...
GALGAS_styleMap_3A_element GALGAS_styleMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                        const GALGAS_lstring & inOperand1,
                                                                        const GALGAS_uint & inOperand2 
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_styleMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_styleMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_styleMap_3A_element::objectCompare (const GALGAS_styleMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_styleMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mComment.isValid () && mAttribute_mStyleIndex.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_styleMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_styleMap_3A_element::description (C_String & ioString,
                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_styleMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_styleMap_3A_element::reader_mComment (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mComment ;
}

//---------------------------------------------------------------------------*

GALGAS_uint GALGAS_styleMap_3A_element::reader_mStyleIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStyleIndex ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_styleMap_3A_element ("styleMap:element",
                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_styleMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_styleMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_styleMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_styleMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_styleMap_3A_element GALGAS_styleMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                      C_Compiler * inCompiler,
                                                                      const GALGAS_location & inErrorLocation
                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_styleMap_3A_element result ;
  const GALGAS_styleMap_3A_element * p = (const GALGAS_styleMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_styleMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "styleMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_lexicalTagMap_3A_element::GALGAS_lexicalTagMap_3A_element (void) :
mAttribute_lkey () {
}
...
GALGAS_lexicalTagMap_3A_element::GALGAS_lexicalTagMap_3A_element (const GALGAS_lstring & inOperand0) :
mAttribute_lkey (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_lexicalTagMap_3A_element & GALGAS_lexicalTagMap_3A_element::operator = (const GALGAS_lexicalTagMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  return *this ;
} */
...
GALGAS_lexicalTagMap_3A_element GALGAS_lexicalTagMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lexicalTagMap_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_lexicalTagMap_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_lexicalTagMap_3A_element::objectCompare (const GALGAS_lexicalTagMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_lexicalTagMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalTagMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_lexicalTagMap_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_lexicalTagMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_lexicalTagMap_3A_element ("lexicalTagMap:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_lexicalTagMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_lexicalTagMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_lexicalTagMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_lexicalTagMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_lexicalTagMap_3A_element GALGAS_lexicalTagMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_lexicalTagMap_3A_element result ;
  const GALGAS_lexicalTagMap_3A_element * p = (const GALGAS_lexicalTagMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_lexicalTagMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "lexicalTagMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
