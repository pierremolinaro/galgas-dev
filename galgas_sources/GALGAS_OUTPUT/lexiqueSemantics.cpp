...
const C_galgas_type_reference kTypeReference_lexicalTypeEnum ("lexicalTypeEnum") ;
...
const C_galgas_type_reference kTypeReference_lexicalTypeList ("lexicalTypeList") ;
...
const C_galgas_type_reference kTypeReference_lexicalTypeMap ("lexicalTypeMap") ;
...
const C_galgas_type_reference kTypeReference_lexicalAttributeMap ("lexicalAttributeMap") ;
...
const C_galgas_type_reference kTypeReference_lexicalSentValueList ("lexicalSentValueList") ;
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@lexicalSentValueList", inIndentation COMMA_THERE) ;
}
...
const C_galgas_type_reference kTypeReference_terminalMap ("terminalMap") ;
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mSentAttributeList.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mTerminalName.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mIsEndOfTemplateMark.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mStyleIndex.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
const C_galgas_type_reference kTypeReference_terminalList ("terminalList") ;
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mTerminalName,
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@terminalList", inIndentation COMMA_THERE) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalExplicitTokenListMap ("lexicalExplicitTokenListMap") ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLength.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
const C_galgas_type_reference kTypeReference_tokenSortedlist ("tokenSortedlist") ;
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mLength,
                                ptr->mName,
                                ptr->mTerminalName) ;
      ptr = ptr->nextObject () ;
    }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@tokenSortedlist", inIndentation COMMA_THERE) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalExplicitTokenListMapMap ("lexicalExplicitTokenListMapMap") ;
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mTokenSortedList.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mShouldBeGenerated.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalMessageMap ("lexicalMessageMap") ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLexicalFormalArgumentMode.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mLexicalFormalArgumentType.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mArgumentNameForComment.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalRoutineFormalArgumentList ("lexicalRoutineFormalArgumentList") ;
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mLexicalFormalArgumentMode,
...
const C_galgas_type_reference kTypeReference_lexicalRoutineMap ("lexicalRoutineMap") ;
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mReplacementRoutineName.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mIsExtern.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalFunctionFormalArgumentList ("lexicalFunctionFormalArgumentList") ;
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@lexicalFunctionFormalArgumentList", inIndentation COMMA_THERE) ;
}
...
const C_galgas_type_reference kTypeReference_lexicalFunctionMap ("lexicalFunctionMap") ;
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mReplacementFunctionName.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mPreservesStartDelimiter.reader_description  (inLexique COMMA_THERE, inIndentation) ;
}
...
const C_galgas_type_reference kTypeReference_templateDelimitorList ("templateDelimitorList") ;
...
const C_galgas_type_reference kTypeReference_styleMap ("styleMap") ;
...
const C_galgas_type_reference kTypeReference_lexicalTagMap ("lexicalTagMap") ;
...
const C_galgas_type_reference kTypeReference_lexiqueAnalysisContext ("lexiqueAnalysisContext") ;
...
reader_description (C_Compiler & inLexique
  ...
  if (isBuilt ()) {
    ...
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mTerminalList " ;
    _s << mTerminalList.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    ...
    _s << mLexicalTokenListMap.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mUnicodeStringToGenerate " ;
    _s << mUnicodeStringToGenerate.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mTemplateDelimitorList " ;
    _s << mTemplateDelimitorList.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mStyleMap " ;
    _s << mStyleMap.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
