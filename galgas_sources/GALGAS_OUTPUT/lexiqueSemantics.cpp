...
internalSubListWithRange (GGS_terminalList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mTerminalName, ptr->mSentAttributeList, ptr->mSyntaxErrorMessage) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
bool GGS_lexiqueAnalysisContext::isBuilt (void) const {
  return mLexicalRoutineMessageMap.isBuilt ()
    ...
    && mStringInExplicitRuleSet.isBuilt () ;
}
...
operator_isEqual (const GGS_lexiqueAnalysisContext & inOperand) const {
  return mLexicalRoutineMessageMap.operator_isEqual (inOperand.mLexicalRoutineMessageMap)
    ...
    .operator_and (mStringInExplicitRuleSet.operator_isEqual (inOperand.mStringInExplicitRuleSet)) ;
}
...
operator_isNotEqual (const GGS_lexiqueAnalysisContext & inOperand) const {
  return mLexicalRoutineMessageMap.operator_isNotEqual (inOperand.mLexicalRoutineMessageMap)
    ...
    .operator_or (mStringInExplicitRuleSet.operator_isNotEqual (inOperand.mStringInExplicitRuleSet)) ;
}
...
constructor_new (const GGS_lexicalRoutineMap & argument_0,
  ...
  result.mLexicalTokenListMapMap = argument_6 ;
  result.mStringInExplicitRuleSet = argument_7 ;
  return result ;
}
...
reader_description (C_Compiler & inLexique
  ...
  if (isBuilt ()) {
    ...
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mStringInExplicitRuleSet " ;
    _s << mStringInExplicitRuleSet.reader_description (inLexique COMMA_THERE, inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
