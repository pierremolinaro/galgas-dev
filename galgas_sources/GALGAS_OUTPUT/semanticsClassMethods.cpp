...
void routine_enterClassMethodWithStringInputArgument (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (33)), var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (33)) ;
...
category_method__stringPredefinedTypeAST__getClassMethodMap (C_Compiler & inLexique,
  ...
  if (operand_2384 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (55)), var_cas_stringType COMMA_SOURCE_FILE_AT_LINE (55)) ;
    GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
