...
void routine_enterClassMethodWithStringInputArgument (C_Compiler & inLexique,
  ...
  var_cas_ioClassMethodMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_inClassMethodName, GGS_location (inLexique) COMMA_HERE), var_cas_argList, var_cas_inHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (36)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_classMethodMapFor_string (C_Compiler & inLexique,
  ...
  var_cas_argList.addAssign_operation (var_cas_stringType, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
  var_cas_argList.addAssign_operation (var_cas_stringType, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
  var_cas_outClassMethodMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("generateFile"), GGS_location (inLexique) COMMA_HERE), var_cas_argList, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (64)) ;
  #ifdef DEBUG_TRACE_ENABLED
