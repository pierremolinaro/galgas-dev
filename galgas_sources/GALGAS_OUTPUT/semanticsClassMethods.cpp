...
category_reader__locationGalgasType__classMethodMap (C_Compiler & inLexique,
                                const cPtr_locationGalgasType * operand_2102
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_2102 != NULL) {
...
category_reader__stringGalgasType__classMethodMap (C_Compiler & inLexique,
                                const cPtr_stringGalgasType * operand_3680
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_3680 != NULL) {
...
category_reader__mapindexType__classMethodMap (C_Compiler & inLexique,
                                const cPtr_mapindexType * operand_3903
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMapEXX  var_cas_outModifierMap ;
  if (operand_3903 != NULL) {
    var_cas_outModifierMap = GGS_modifierMapEXX ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_formalParameterSignatureEXX  var_cas_argList = GGS_formalParameterSignatureEXX ::constructor_emptyList () ;
    GGS_ACGalgasType  var_cas_tSelf = operand_3903 ;
    GGS_ACGalgasType  var_cas_t = operand_3903->mIndexOfMapType.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
    var_cas_argList.addAssign_operation (GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
