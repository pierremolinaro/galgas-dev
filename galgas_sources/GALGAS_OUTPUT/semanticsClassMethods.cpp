...
void routine_enterClassMethodWithStringInputArgument (C_CompilerEx & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_string ("string"), var_cas_argumentTypeIndex COMMA_SOURCE_FILE_AT_LINE (33)) ;
...
category_method__stringPredefinedTypeAST__getClassMethodMap (C_CompilerEx & inLexique,
  ...
  if (operand_2362 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_string ("string"), var_cas_stringType COMMA_SOURCE_FILE_AT_LINE (55)) ;
    GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
