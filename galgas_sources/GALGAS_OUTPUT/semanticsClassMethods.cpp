...
category_reader__stringGalgasType__classMethodMap (C_Compiler & inLexique,
                                const cPtr_stringGalgasType * operand_3635
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
...
category_reader__mapindexType__classMethodMap (C_Compiler & inLexique,
                                const cPtr_mapindexType * operand_3855
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_modifierMap  var_cas_outModifierMap ;
  if (operand_3855 != NULL) {
    var_cas_outModifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_ACGalgasType  var_cas_tSelf = operand_3855 ;
    GGS_ACGalgasType  var_cas_t ;
    GGS_lstring  automatic_var_4069_0 ;
    const GGS_typeMapIndex  temp_4062 = operand_3855->mIndexOfMapType ;
    if (temp_4062.isBuilt ()) {
      temp_4062 (HERE)->method_searchKey (inLexique, automatic_var_4069_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (77)) ;
    }
    var_cas_argList.addAssign_operation (GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE), GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)) ;
    var_cas_argList.addAssign_operation (var_cas_t, GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)) ;
    var_cas_argList.addAssign_operation (var_cas_tSelf, GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)) ;
