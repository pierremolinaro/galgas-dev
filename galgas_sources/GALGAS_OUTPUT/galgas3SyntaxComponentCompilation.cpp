//-----------------------------------------------------------------------------*
//                                                                             *
//                File 'galgas3SyntaxComponentCompilation.cpp'                 *
//                         Generated by version 2.6.0                          *
//                        july 6th, 2014, at 10h39'36"                         *
//                                                                             *
//-----------------------------------------------------------------------------*
...
#include "galgas3SyntaxComponentCompilation.h"
...
//-----------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "galgas3SyntaxComponentCompilation.gSemantics", line
...
static GALGAS_string categoryReader_galgas_33_SyntaxComponentAST_keyRepresentation (const cPtr_semanticDeclarationAST * inObject,
  ...
  result_outString = GALGAS_string ("syntax ").operator_concat (object->mAttribute_mSyntaxComponentName.reader_string (SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (57)) ;
//---
