...
//--- Current element access
  public : GALGAS_templateVariableMap_2E_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_templateVariableMap_2E_element constructor_new (const GALGAS_lstring & inOperand0,
