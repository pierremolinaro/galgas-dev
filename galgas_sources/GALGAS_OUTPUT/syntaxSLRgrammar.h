...
//------------------------------------- 'enum_message_declaration' non terminal
//--- 'parse' label
  public : virtual void nt_enum_5F_message_5F_declaration_parse (C_Lexique_galgas_5F_scanner * inCompiler) ;

//--- indexing
  public : virtual void nt_enum_5F_message_5F_declaration_indexing (C_Lexique_galgas_5F_scanner * inCompiler) ;
