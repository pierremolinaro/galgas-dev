...
//----------- '' label
  public : virtual void nt_local_5F_declaration_ (C_String & ioSyntaxDirectedTranslationResult,
                                                  C_Lexique_galgas_5F_scanner * inCompiler) ;

//------------------------------------- 'new_foreach_enumerated_object' non terminal
//--- 'parse' label
  public : virtual void nt_new_5F_foreach_5F_enumerated_5F_object_parse (C_String & ioSyntaxDirectedTranslationResult,
                                                                         C_Lexique_galgas_5F_scanner * inCompiler) ;
