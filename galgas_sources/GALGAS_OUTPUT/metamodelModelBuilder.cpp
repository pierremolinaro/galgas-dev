...
pr_entity_declaration_metamodelModelBuilder_119_6_ (galgas_scanner & _inLexique) {
  ...
  GGS_metamodelEntity _entityInstance = GGS_metamodelEntity::constructor_new (_inLexique, var_cas_mEntityNameList, var_cas_mSuperEntityName, var_cas_mIsAbstract, var_cas_mAttributes, var_cas_mMultipleReferences COMMA_HERE) ;
  return _entityInstance ;
}
...
metamodelModelBuilder::
pr_attribute_or_single_reference_declaration_metamodelModelBuilder_163_6_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_multiple_reference_declaration_metamodelModelBuilder_170_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inPropertyTypeName) {
  GGS_lstring  var_cas_mAttributeTypeName ;
  GGS_lstring  var_cas_mAttributeName ;
  ...
  switch (select_metamodelModelBuilder_13 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_mLowerBound = var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
      switch (select_metamodelModelBuilder_14 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_mLowerBound)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "multiplicity should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (182)) ;
          }
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          switch (select_metamodelModelBuilder_15 (_inLexique)) {
            case 1 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
              var_cas_mUpperBound = var_cas_upperBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
              if (((var_cas_mUpperBound)._operator_strictInf (var_cas_mLowerBound)).isBuiltAndTrue ()) {
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "upper bound should be greater or equal to lower bound") COMMA_SOURCE_FILE_AT_LINE (191)) ;
                ...
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "lower bound and upper bound should not to be both zero") COMMA_SOURCE_FILE_AT_LINE (193)) ;
              }
              } break ;
            case 2 : {
