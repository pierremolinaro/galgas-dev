      ...
      switch (select_repeat_metamodelModelBuilder_11 (_inLexique)) {
        case 2 : {
          ...
          switch (select_metamodelModelBuilder_12 (_inLexique)) {
            case 1 : {
              var_cas_mProperties._addModel (nt_attribute_or_single_reference_declaration_ (_inLexique, var_cas_propertyTypeName)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B) COMMA_HERE) ;
              var_cas_mProperties._addModel (nt_multiple_reference_declaration_ (_inLexique, var_cas_propertyTypeName)) ;
              } break ;
            default :
              break ;
          }
