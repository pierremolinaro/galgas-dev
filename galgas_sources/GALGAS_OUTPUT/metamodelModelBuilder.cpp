...
pr_metamodel_component_start_symbol_metamodelModelBuilder_38_6_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_component_importation_metamodelModelBuilder_98_6_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_entity_declaration_metamodelModelBuilder_124_6_ (galgas_scanner & _inLexique) {
...
metamodelModelBuilder::
pr_attribute_or_single_reference_declaration_metamodelModelBuilder_168_6_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_multiple_reference_declaration_metamodelModelBuilder_175_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inPropertyTypeName) {
  GGS_lstring  var_cas_mAttributeTypeName ;
  GGS_lstring  var_cas_mAttributeName ;
      ...
      switch (select_metamodelModelBuilder_14 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_mLowerBound)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "multiplicity should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (187)) ;
          }
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          switch (select_metamodelModelBuilder_15 (_inLexique)) {
            case 1 : {
              ...
              if (((var_cas_mUpperBound)._operator_strictInf (var_cas_mLowerBound)).isBuiltAndTrue ()) {
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "upper bound should be greater or equal to lower bound") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                ...
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "lower bound and upper bound should not to be both zero") COMMA_SOURCE_FILE_AT_LINE (198)) ;
              }
              } break ;
            case 2 : {
