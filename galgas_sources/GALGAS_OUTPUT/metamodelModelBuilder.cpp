...
pr_metamodel_component_start_symbol_metamodelModelBuilder_38_4_ (galgas_scanner & _inLexique,
  ...
  GGS__list_metamodelEntity  var_cas_mMetamodelEntities ;
  var_cas_mMetamodelEntities = GGS__list_metamodelEntity::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
      switch (select_repeat_metamodelModelBuilder_5 (_inLexique)) {
        case 2 : {
          var_cas_mMetamodelEntities._addAssign_operation (nt_entity_declaration_ (_inLexique)) ;
          } break ;
        case 3 : {
...
metamodelModelBuilder::
pr_component_importation_metamodelModelBuilder_98_4_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_entity_declaration_metamodelModelBuilder_124_4_ (galgas_scanner & _inLexique) {
  GGS_lstringlist  var_cas_mEntityNameList ;
  GGS_lstring  var_cas_mSuperEntityName ;
  GGS_bool var_cas_mIsAbstract ;
  GGS__list_metamodelProperty  var_cas_mProperties ;
  var_cas_mProperties = GGS__list_metamodelProperty::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  var_cas_mEntityNameList = GGS_lstringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  { bool syntaxRepeat_9 = true ;
    while (syntaxRepeat_9) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        var_cas_mEntityNameList._addAssign_operation (var_cas_entityName) ;
      switch (select_repeat_metamodelModelBuilder_9 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
        default :
  ...
  switch (select_metamodelModelBuilder_10 (_inLexique)) {
    case 1 : {
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_repeat_metamodelModelBuilder_11 (_inLexique)) {
        case 2 : {
          ...
          switch (select_metamodelModelBuilder_12 (_inLexique)) {
            case 1 : {
              var_cas_mProperties._addAssign_operation (nt_attribute_or_single_reference_declaration_ (_inLexique, var_cas_propertyTypeName)) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B) COMMA_HERE) ;
              var_cas_mProperties._addAssign_operation (nt_multiple_reference_declaration_ (_inLexique, var_cas_propertyTypeName)) ;
              } break ;
            default :
              break ;
          }
  ...
  GGS_metamodelEntity _entityInstance = GGS_metamodelEntity::constructor_new (_inLexique, var_cas_mEntityNameList, var_cas_mSuperEntityName, var_cas_mIsAbstract, var_cas_mProperties COMMA_HERE) ;
  return _entityInstance ;
}
...
GGS_metamodelProperty metamodelModelBuilder::
metamodelModelBuilder::
pr_attribute_or_single_reference_declaration_metamodelModelBuilder_168_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_metamodelProperty _entityInstance = GGS_metamodelProperty::constructor_new (_inLexique, var_cas_mAttributeTypeName, var_cas_mAttributeName COMMA_HERE) ;
  return _entityInstance ;
}
...
metamodelModelBuilder::
pr_multiple_reference_declaration_metamodelModelBuilder_175_4_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inPropertyTypeName) {
  GGS_lstring  var_cas_mAttributeTypeName ;
  GGS_lstring  var_cas_mAttributeName ;
  ...
  switch (select_metamodelModelBuilder_13 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_mLowerBound = var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (182)) ;
      switch (select_metamodelModelBuilder_14 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_mLowerBound)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "multiplicity should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (186)) ;
          }
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          switch (select_metamodelModelBuilder_15 (_inLexique)) {
            case 1 : {
              GGS_luint  var_cas_upperBound ;
              _inLexique._assignFromAttribute_uint32value (var_cas_upperBound) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
              var_cas_mUpperBound = var_cas_upperBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)) ;
              if (((var_cas_mUpperBound)._operator_strictInf (var_cas_mLowerBound)).isBuiltAndTrue ()) {
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "upper bound should be greater or equal to lower bound") COMMA_SOURCE_FILE_AT_LINE (195)) ;
                ...
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "lower bound and upper bound should not to be both zero") COMMA_SOURCE_FILE_AT_LINE (197)) ;
              }
              } break ;
            case 2 : {
