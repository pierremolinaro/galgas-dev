...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "metamodelModelBuilder.ggs", line
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
          ...
          switch (select_repeat_metamodelModelBuilder_1 (_inLexique)) {
            case 2 : {
...
metamodelModelBuilder::
pr_component_importation_metamodelModelBuilder_72_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      ...
      switch (select_repeat_metamodelModelBuilder_3 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
        default :
...
metamodelModelBuilder::
pr_entity_declaration_metamodelModelBuilder_86_6_ (galgas_scanner & _inLexique) {
  ...
  switch (select_metamodelModelBuilder_4 (_inLexique)) {
    case 1 : {
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  switch (select_metamodelModelBuilder_5 (_inLexique)) {
    case 1 : {
...
metamodelModelBuilder::
pr_attribute_or_single_reference_declaration_metamodelModelBuilder_123_6_ (galgas_scanner & _inLexique,
...
metamodelModelBuilder::
pr_multiple_reference_declaration_metamodelModelBuilder_130_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inPropertyTypeName) {
  GGS_lstring  var_cas_mAttributeTypeName ;
  GGS_lstring  var_cas_mAttributeName ;
