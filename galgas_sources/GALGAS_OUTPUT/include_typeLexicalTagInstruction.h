//---------------------------------------------------------------------------*
//                                                                           *
//                File 'include_typeLexicalTagInstruction.h'                 *
...
class cPtr_typeLexicalTagInstruction : public cPtr_typeInstructionLexicale {
...
//--- Constructor
  public : cPtr_typeLexicalTagInstruction (const GGS_lstring &  COMMA_LOCATION_ARGS) ;

//--- Declaring a protected virual destructor enables the compiler to raise
//    an error if a direct delete is performed; only the static method
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_typeLexicalTagInstruction (void) {}
  #endif
