...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 414)).method_searchKey (object->mAttribute_mListName, joker_16861_0, var_tokenSortedList, joker_16881_0, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 414)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
