...
static GALGAS_string categoryReader_lexicalFunctionInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_6201 (object->mAttribute_mFunctionActualArgumentList, true) ;
...
static GALGAS_string categoryReader_lexicalStructuredSendInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_string = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSendSearchListAST enumerator_9522 (object->mAttribute_mLexicalSendSearchList, true) ;
  //--- simple foreach instruction
...
static GALGAS_string categoryReader_lexicalRepeatInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_10835 (object->mAttribute_mRepeatedInstructionList, true) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalWhileBranchListAST enumerator_11011 (object->mAttribute_mLexicalWhileBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_11011.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_11274 (enumerator_11011.current_mWhileInstructionList (HERE), true) ;
    //--- simple foreach instruction
...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_string = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSelectBranchListAST enumerator_12115 (object->mAttribute_mLexicalSelectBranchList, true) ;
  //--- simple foreach instruction
  while (enumerator_12115.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_12380 (enumerator_12115.current_mSelectInstructionList (HERE), true) ;
    //--- simple foreach instruction
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_12810 (object->mAttribute_mDefaultInstructionList, true) ;
    //--- simple foreach instruction
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalRoutineCallActualArgumentListAST enumerator_13437 (object->mAttribute_mActualArgumentList, true) ;
  //--- simple foreach instruction
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  result_string = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_tokenSortedlist enumerator_16943 (var_tokenSortedList, false) ;
  //--- simple foreach instruction
  while (enumerator_16943.hasCurrentObject ()) {
    ...
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (enumerator_16943.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
    //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_17811 (object->mAttribute_mInstructionList, true) ;
  //--- simple foreach instruction
  while (enumerator_17811.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17811.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
