...
static GALGAS_string categoryReader_lexicalOrExpressionAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode = callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLeftOperand.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 38)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (" || ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 39)) ;
  result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mRightOperand.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 40))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 40)) ;
//---
...
static GALGAS_string categoryReader_lexicalCharacterIntervalMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (object->mAttribute_mLowerBound.reader_char (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 51)).reader_uint (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 51)).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 51))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 51)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (" toChar:")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 52)) ;
  result_outGeneratedCode.dotAssign_operation (object->mAttribute_mUpperBound.reader_char (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 53)).reader_uint (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 53)).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 53))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 53)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("]")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 54)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalStringMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("[self testForInputString:@").operator_concat (object->mAttribute_mString.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 63)).reader_utf_38_Representation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 63))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 63)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (" advance:YES]")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 64)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalStringNotMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (object->mAttribute_mString.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 74)).reader_utf_38_Representation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 74))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 74)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (" error:& scanningOk]")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 75)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalCharacterMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (object->mAttribute_mCharacter.reader_char (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 85)).reader_uint (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 85)).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 85))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 85)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("]")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 86)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalCharacterSetMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (object->mAttribute_mCharacterSetName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 96))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 96)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("]")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 97)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalAttributeInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mLexicalAttribute_").operator_concat (object->mAttribute_mAttributeName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 113))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 113)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalCharacterInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  result_outGeneratedCode = object->mAttribute_mCharacter.reader_char (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 121)).reader_uint (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 121)).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 121)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalUnsignedInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  result_outGeneratedCode = object->mAttribute_mUnsigned.reader_uint (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 129)).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 129)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalFunctionInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("scanner_cocoa_function_").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 145))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 145)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 145)) ;
  ...
  while (enumerator_6196.hasCurrentObject ()) {
    ...
    if (enumerator_6196.hasNextObject ()) {
      result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 148)) ;
    }
    enumerator_6196.gotoNextObject () ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (")")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 150)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalAttributeInputOutputArgumentAST_generateCocoaRoutineArgument (const cPtr_abstractLexicalRoutineActualArgumentAST * inObject,
  ...
  inArgument_inLexiqueAnalysisContext.reader_mLexicalAttributeMap (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 169)).method_searchKey (object->mAttribute_mAttributeName, var_lexicalType, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 169)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_lexicalType.objectCompare (GALGAS_lexicalTypeEnum::constructor_lexicalType_5F_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 171)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("& ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 172)) ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("mLexicalAttribute_").operator_concat (object->mAttribute_mAttributeName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 174))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 174))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 174)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalFormalInputArgumentAST_generateCocoaRoutineArgument (const cPtr_abstractLexicalRoutineActualArgumentAST * inObject,
  ...
  result_outGeneratedCode = callCategoryReader_generateCocoaRoutineOrFunctionArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) object->mAttribute_mRoutineOrFunctionFormalInputArgument.ptr (), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 183)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalSendTerminalByDefaultAST_generateCocoaDefaultSendCode (const cPtr_lexicalSendDefaultActionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mTokenCode = ").operator_concat (inArgument_inScannerClassName  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201)).operator_concat (GALGAS_string ("_1_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201)).operator_concat (object->mAttribute_mDefaultSentTerminal.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201)).reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 201)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalStructuredSendInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_9519.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (mTokenCode == 0) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 232)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  mTokenCode = search_into_").operator_concat (inArgument_inScannerClassName.reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)).operator_concat (enumerator_9519.current_mSearchListName (HERE).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)).operator_concat (GALGAS_string (" (mLexicalAttribute_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)).operator_concat (enumerator_9519.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 233)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 234)) ;
    enumerator_9519.gotoNextObject () ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (mTokenCode == 0) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 236)) ;
  ...
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 238)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalSimpleSendInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mTokenCode = ").operator_concat (inArgument_inScannerClassName  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248)).operator_concat (GALGAS_string ("_1_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248)).operator_concat (object->mAttribute_mSentTerminal.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248)).reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 248)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalRepeatInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  {
  result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 259)) ;
  }
  ...
  while (enumerator_11006.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (scanningOk && (")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 267)) ;
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_11006.current_mWhileExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 268))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 268)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 269)) ;
    {
    result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 270)) ;
    }
    ...
    while (enumerator_11271.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_11271.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 272))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 272)) ;
      enumerator_11271.gotoNextObject () ;
    }
    {
    result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 274)) ;
    }
    if (enumerator_11006.hasNextObject ()) {
      result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 276)) ;
    }
    enumerator_11006.gotoNextObject () ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n"
    "  mLoop = NO ;\n"
    "}\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 278)) ;
  {
  result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 281)) ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}while (mLoop && scanningOk) ;\n"
    "mLoop = YES ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 282)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_12110.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (scanningOk && (")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 297)) ;
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_12110.current_mSelectExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 298))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 298)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 299)) ;
    {
    result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 300)) ;
    }
    ...
    while (enumerator_12377.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12377.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 302))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 302)) ;
      enumerator_12377.gotoNextObject () ;
    }
    {
    result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 304)) ;
    }
    if (enumerator_12110.hasNextObject ()) {
      result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 306)) ;
    }
    enumerator_12110.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, object->mAttribute_mDefaultInstructionList.reader_length (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 309)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else{\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 310)) ;
    {
    result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 311)) ;
    }
    ...
    while (enumerator_12807.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12807.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 313))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 313)) ;
      enumerator_12807.gotoNextObject () ;
    }
    {
    result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 315)) ;
    }
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 317)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("scanner_cocoa_routine_").operator_concat (object->mAttribute_mRoutineName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 327))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 327)).operator_concat (GALGAS_string (" (& scanningOk")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 327)) ;
  ...
  while (enumerator_13434.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ").operator_concat (callCategoryReader_generateCocoaRoutineArgument ((const cPtr_abstractLexicalRoutineActualArgumentAST *) enumerator_13434.current_mLexicalRoutineActualArgument (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 329))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 329))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 329)) ;
    enumerator_13434.gotoNextObject () ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 331)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalDropInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mTokenCode = ").operator_concat (inArgument_inScannerClassName  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341)).operator_concat (GALGAS_string ("_1_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341)).operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341)).reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 341)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalTagInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("scanningPointStructForCocoa locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 371))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 371)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 371)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("[self saveScanningPoint: & locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 372))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 372)).operator_concat (GALGAS_string ("] ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 372))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 372)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalRewindInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("[self restoreScanningPoint: & locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 382))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 382)).operator_concat (GALGAS_string ("] ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 382)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("mTokenCode = ").operator_concat (inArgument_inScannerClassName  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383)).operator_concat (GALGAS_string ("_1_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383)).operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383)).reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 383)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_16861 ; // Joker input parameter
  GALGAS_bool joker_16881 ; // Joker input parameter
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 414)).method_searchKey (object->mAttribute_mListName, joker_16861, var_tokenSortedList, joker_16881, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 414)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  ...
  while (enumerator_16940.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (scanningOk && [self testForInputString:@")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 417)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16940.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 418))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 418)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (" advance:YES]) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 419)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  mTokenCode = ").operator_concat (inArgument_inScannerClassName  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420)).operator_concat (GALGAS_string ("_1_")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420)).operator_concat (enumerator_16940.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 420)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 421)) ;
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLexicalRuleExpression.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 433))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 433)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (")) {\n")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 434)) ;
  {
  result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 435)) ;
  }
  ...
  while (enumerator_17808.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17808.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 437))  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 437)) ;
    enumerator_17808.gotoNextObject () ;
  }
  {
  result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 439)) ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueCocoaGeneration.gSemantics", 440)) ;
//---
  return result_outGeneratedCode ;
}
