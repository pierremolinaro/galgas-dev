...
static GALGAS_string categoryReader_lexicalOrExpressionAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  result_string = callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLeftOperand.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (38)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (" || ") COMMA_SOURCE_FILE_AT_LINE (39)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mRightOperand.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)) ;
//---
...
static GALGAS_string categoryReader_lexicalCharacterIntervalMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self testForInputFromChar:") ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (object->mAttribute_mLowerBound.reader_char (SOURCE_FILE_AT_LINE (51)).reader_uint (SOURCE_FILE_AT_LINE (51)).reader_string (SOURCE_FILE_AT_LINE (51)) COMMA_SOURCE_FILE_AT_LINE (51)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (" toChar:") COMMA_SOURCE_FILE_AT_LINE (52)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (object->mAttribute_mUpperBound.reader_char (SOURCE_FILE_AT_LINE (53)).reader_uint (SOURCE_FILE_AT_LINE (53)).reader_string (SOURCE_FILE_AT_LINE (53)) COMMA_SOURCE_FILE_AT_LINE (53)) ;
  //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalStringMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self testForInputString:@").operator_concat (object->mAttribute_mString.reader_string (SOURCE_FILE_AT_LINE (63)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (" advance:YES]") COMMA_SOURCE_FILE_AT_LINE (64)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalStringNotMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self notTestForInputString:@") ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (object->mAttribute_mString.reader_string (SOURCE_FILE_AT_LINE (74)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (" error:& scanningOk]") COMMA_SOURCE_FILE_AT_LINE (75)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalCharacterMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self testForInputChar:") ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (object->mAttribute_mCharacter.reader_char (SOURCE_FILE_AT_LINE (85)).reader_uint (SOURCE_FILE_AT_LINE (85)).reader_string (SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (86)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalCharacterSetMatchAST_generateCocoaConditionCode (const cPtr_lexicalExpressionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self testForCharWithFunction:") ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (object->mAttribute_mCharacterSetName.reader_string (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalAttributeInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("mLexicalAttribute_").operator_concat (object->mAttribute_mAttributeName.reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalCharacterInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = object->mAttribute_mCharacter.reader_char (SOURCE_FILE_AT_LINE (121)).reader_uint (SOURCE_FILE_AT_LINE (121)).reader_string (SOURCE_FILE_AT_LINE (121)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalUnsignedInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = object->mAttribute_mUnsigned.reader_uint (SOURCE_FILE_AT_LINE (129)).reader_string (SOURCE_FILE_AT_LINE (129)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalCurrentCharacterInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * /* inObject */,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("mPreviousChar") ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalFunctionInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("scanner_cocoa_function_").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (145)) ;
  ...
  while (enumerator_6201.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaRoutineOrFunctionArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_6201.current_mLexicalActualInputArgument (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
    if (enumerator_6201.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (148)) ;
    }
    enumerator_6201.gotoNextObject () ;
  }
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (150)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalAttributeInputOutputArgumentAST_generateCocoaRoutineArgument (const cPtr_abstractLexicalRoutineActualArgumentAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("& ") COMMA_SOURCE_FILE_AT_LINE (172)) ;
  }
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("mLexicalAttribute_").operator_concat (object->mAttribute_mAttributeName.reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalFormalInputArgumentAST_generateCocoaRoutineArgument (const cPtr_abstractLexicalRoutineActualArgumentAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = callCategoryReader_generateCocoaRoutineOrFunctionArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) object->mAttribute_mRoutineOrFunctionFormalInputArgument.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (183)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalErrorByDefaultAST_generateCocoaDefaultSendCode (const cPtr_lexicalSendDefaultActionAST * /* inObject */,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("scanningOk = NO ;\n") ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalStructuredSendInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_9522.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("if (mTokenCode == 0) {\n") COMMA_SOURCE_FILE_AT_LINE (232)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("  mTokenCode = search_into_").operator_concat (inArgument_inScannerClassName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_9522.current_mSearchListName (HERE).reader_string (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string (" (mLexicalAttribute_") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_9522.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)) ;
    //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalRepeatInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_string.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (259)) ;
  ...
  while (enumerator_10835.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_10835.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
  ...
  while (enumerator_11011.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("if (scanningOk && (") COMMA_SOURCE_FILE_AT_LINE (267)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_11011.current_mWhileExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (268)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (269)) ;
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    ...
    while (enumerator_11274.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_11274.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) ;
      enumerator_11274.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) ;
    } //-------- END @typeMethodInstructionForGeneration
    if (enumerator_11011.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (GALGAS_string ("}else ") COMMA_SOURCE_FILE_AT_LINE (276)) ;
    }
  ...
  { //-------- @modifierCallInstructionForGeneration
  result_string.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("}while (mLoop && scanningOk) ;\n"
...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_12115.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("if (scanningOk && (") COMMA_SOURCE_FILE_AT_LINE (297)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_12115.current_mSelectExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) COMMA_SOURCE_FILE_AT_LINE (298)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (299)) ;
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    ...
    while (enumerator_12380.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12380.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
      enumerator_12380.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (304)) ;
    } //-------- END @typeMethodInstructionForGeneration
    if (enumerator_12115.hasNextObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (GALGAS_string ("}else ") COMMA_SOURCE_FILE_AT_LINE (306)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    ...
    while (enumerator_12810.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12810.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
      enumerator_12810.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    result_string.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("scanner_cocoa_routine_").operator_concat (object->mAttribute_mRoutineName.reader_string (SOURCE_FILE_AT_LINE (327)) COMMA_SOURCE_FILE_AT_LINE (327)).operator_concat (GALGAS_string (" (& scanningOk") COMMA_SOURCE_FILE_AT_LINE (327)) ;
  //-------- @foreachInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalTagInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("scanningPointStructForCocoa locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (371)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("[self saveScanningPoint: & locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string ("] ;\n") COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalRewindInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("[self restoreScanningPoint: & locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (GALGAS_string ("] ;\n") COMMA_SOURCE_FILE_AT_LINE (382)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("mTokenCode = ").operator_concat (inArgument_inScannerClassName COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string ("_1_") COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (383)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
//---
  return result_string ;
}
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  while (enumerator_16947.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("if (scanningOk && [self testForInputString:@") COMMA_SOURCE_FILE_AT_LINE (417)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (enumerator_16947.current_mName (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string (" advance:YES]) {\n") COMMA_SOURCE_FILE_AT_LINE (419)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("  mTokenCode = ").operator_concat (inArgument_inScannerClassName COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string ("_1_") COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (enumerator_16947.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("}else ") COMMA_SOURCE_FILE_AT_LINE (421)) ;
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_string = GALGAS_string ("if (scanningOk && (") ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLexicalRuleExpression.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) COMMA_SOURCE_FILE_AT_LINE (433)) ;
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string (")) {\n") COMMA_SOURCE_FILE_AT_LINE (434)) ;
  { //-------- @modifierCallInstructionForGeneration
  result_string.modifier_incIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  ...
  while (enumerator_17815.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17815.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
    enumerator_17815.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  result_string.modifier_decIndentation (GALGAS_uint ((PMUInt32) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @appendInstructionForGeneration
  result_string.dotAssign_operation (GALGAS_string ("}else ") COMMA_SOURCE_FILE_AT_LINE (440)) ;
//---
  return result_string ;
}
