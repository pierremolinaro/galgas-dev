...
static GALGAS_string categoryReader_lexicalFunctionInputArgumentAST_generateCocoaRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_6201 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_6201.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaRoutineOrFunctionArgument ((const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST *) enumerator_6201.current_mLexicalActualInputArgument (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
...
static GALGAS_string categoryReader_lexicalStructuredSendInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSendSearchListAST enumerator_9522 (object->mAttribute_mLexicalSendSearchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_9522.hasCurrentObject ()) {
    ...
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  mTokenCode = search_into_").operator_concat (inArgument_inScannerClassName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_9522.current_mSearchListName (HERE).reader_string (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string (" (mLexicalAttribute_") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_9522.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string (") ;\n") COMMA_SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (233)) ;
    //-------- @concatInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalRepeatInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_10835 (object->mAttribute_mRepeatedInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_10835.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_10835.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
    enumerator_10835.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalWhileBranchListAST enumerator_11011 (object->mAttribute_mLexicalWhileBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11011.hasCurrentObject ()) {
    ...
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_11011.current_mWhileExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (268)) ;
    //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_11274 (enumerator_11011.current_mWhileInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11274.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_11274.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) ;
...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalSelectBranchListAST enumerator_12115 (object->mAttribute_mLexicalSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12115.hasCurrentObject ()) {
    ...
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_12115.current_mSelectExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) COMMA_SOURCE_FILE_AT_LINE (298)) ;
    //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_12380 (enumerator_12115.current_mSelectInstructionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12380.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12380.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lexicalInstructionListAST enumerator_12810 (object->mAttribute_mDefaultInstructionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12810.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12810.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateCocoaInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalRoutineCallActualArgumentListAST enumerator_13437 (object->mAttribute_mActualArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13437.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ").operator_concat (callCategoryReader_generateCocoaRoutineArgument ((const cPtr_abstractLexicalRoutineActualArgumentAST *) enumerator_13437.current_mLexicalRoutineActualArgument (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (329)) COMMA_SOURCE_FILE_AT_LINE (329)) COMMA_SOURCE_FILE_AT_LINE (329)) ;
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lexicalExplicitTokenListMap joker_16862_0 ; // Joker input parameter
  GALGAS_bool joker_16882_0 ; // Joker input parameter
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE_AT_LINE (414)).method_searchKey (object->mAttribute_mListName, joker_16862_0, var_tokenSortedList, joker_16882_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (414)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_tokenSortedlist enumerator_16947 (var_tokenSortedList, kEnumeration_down) ;
  //--- simple foreach instruction
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCocoaCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lexicalInstructionListAST enumerator_17815 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17815.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateCocoaInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17815.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
