...
//--------------------------------- Element constructor used by listmap
  public : static void makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                  ...
                                                  const class GALGAS_string & in_mHTMLFileContents
                                                  COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_string reader_mHTMLFileContentsAtIndex (const class GALGAS_uint & constinOperand0,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : class GALGAS_string current_mHTMLFileContents (LOCATION_ARGS) const ;
//--- Current element access
  public : class GALGAS_grammarComponentGenerationList_2E_element current (LOCATION_ARGS) const ;
} ;
...
//-----------------------------------------------------------------------------*
//                                                                             *
//              @grammarComponentGenerationList_2E_element struct              *
//                                                                             *
//-----------------------------------------------------------------------------*

class GALGAS_grammarComponentGenerationList_2E_element : public AC_GALGAS_root {
//--------------------------------- Public data members
  ...
  public : GALGAS_string mAttribute_mHTMLFileContents ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_grammarComponentGenerationList_2E_element constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_grammarComponentGenerationList_2E_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_grammarComponentGenerationList_2E_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_grammarComponentGenerationList_2E_element (const GALGAS_string & in_mGrammarName,
...
//--------------------------------- Object extraction
  public : static GALGAS_grammarComponentGenerationList_2E_element extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_grammarComponentGenerationList_2E_element constructor_new (const class GALGAS_string & inOperand0,
                                                                                    const class GALGAS_string & inOperand1,
                                                                                    const class GALGAS_string & inOperand2,
                                                                                    const class GALGAS_string & inOperand3
                                                                                    COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_grammarComponentGenerationList_2E_element & inOperand) const ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_string reader_mHTMLFileContents (LOCATION_ARGS) const ;
...
} ; // End of GALGAS_grammarComponentGenerationList_2E_element class


//-----------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_grammarComponentGenerationList_2E_element ;
