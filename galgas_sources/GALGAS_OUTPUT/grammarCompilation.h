...
void routine_grammarAnalysisAndGeneration (const class GALGAS_stringset constinArgument0,
                                           ...
                                           const class GALGAS_terminalSymbolsMapForGrammarAnalysis constinArgument7,
                                           const class GALGAS_syntaxComponentListForGrammarAnalysis constinArgument8,
                                           const class GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis constinArgument9,
                                           const class GALGAS_string constinArgument10,
                                           const class GALGAS_string constinArgument11,
                                           const class GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis constinArgument12,
...
void routine_compileGrammarComponentGalgas_33_ (const class GALGAS_string constinArgument0,
                                                const class GALGAS_bool constinArgument1,
                                                const class GALGAS_galgas_33_GrammarComponentListAST_2E_element constinArgument2,
                                                const class GALGAS_parsedSyntaxComponentMap constinArgument3,
