...
//                    february 24th, 2008, at 18h29'44"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
class cli_options_parser {
  ...
  protected : void pr_galgas_component_cli_options_parser_66_4_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cli_options_parser_66_4_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_66_4_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_66_4_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_66_4_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_M_treewalkingComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_66_4_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
