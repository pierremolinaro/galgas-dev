...
//                    november 29th, 2006, at 14h55'53"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
class cli_options_parser {
  ...
  protected : void pr_galgas_component_cli_options_parser_63_24_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cli_options_parser_63_24_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_24_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_metamodelsComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_24_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_constraintComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_24_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_metamodelsComponents  &,
                                GGS_M_constraintComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_24_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
