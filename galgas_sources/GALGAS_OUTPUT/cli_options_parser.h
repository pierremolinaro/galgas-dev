...
class cli_options_parser {
  ...
  protected : void pr_galgas_component_cli_options_parser_59_24_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cli_options_parser_59_24_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_59_24_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_59_24_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_59_24_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_59_24_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_59_24_importMetamodels (galgas_scanner &,
                                GGS_M_metamodelsComponents  &) ;
