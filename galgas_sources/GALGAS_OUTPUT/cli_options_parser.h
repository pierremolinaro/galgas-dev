...
class cli_options_parser {
  ...
  protected : void pr_galgas_component_cli_options_parser_63_4_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cli_options_parser_63_4_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_4_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_galgas_component_cli_options_parser_63_4_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_EXsemanticContext &,
                                GGS_stringset  &) ;

  protected : void pr_galgas_component_cli_options_parser_63_4_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_galgas_component_cli_options_parser_63_4_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
