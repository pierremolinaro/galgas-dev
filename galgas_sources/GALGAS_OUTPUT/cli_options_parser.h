...
class cli_options_parser {
  ...
  protected : void pr_galgas_component_cli_options_parser_58_24_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_cli_options_parser_58_24_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_58_24_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_58_24_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_metamodelsComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_58_24_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &) ;

  protected : void pr_galgas_component_cli_options_parser_58_24_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;
