...
pr_galgas_component_cocoa_parser_101_23_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (165))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_M_grammarComponents::cEnumerator enumerator_6554 (var_cas_ioGrammarComponentsMap, true) ;
      const GGS_M_grammarComponents::cElement * operand_6554 = NULL ;
      while (((operand_6554 = enumerator_6554.nextObject ()))) {
        macroValidPointer (operand_6554) ;
        var_cas_grammarKey = operand_6554->mKey ;
      }
    }
    const GGS_M_grammarComponents  temp_6659 = var_cas_ioGrammarComponentsMap ;
    if (temp_6659.isBuilt ()) {
      temp_6659 (HERE)->method_searchKey (inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (170)) ;
    }
    ...
    const GGS_M_grammarComponents  temp_7126 = var_cas_ioGrammarComponentsMap ;
    if (temp_7126.isBuilt ()) {
      temp_7126 (HERE)->method_searchKey (inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  temp_7347 = var_cas_nonterminalSymbolParametersMap ;
  if (temp_7347.isBuilt ()) {
    temp_7347 (HERE)->method_searchKey (inLexique, var_cas_altName, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (189)) ;
  }
  ...
  switch (select_cocoa_parser_1 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  temp_7800 = var_cas_ioLexiqueMapForUse ;
      if (temp_7800.isBuilt ()) {
        temp_7800 (HERE)->method_searchKey (inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (205)) ;
      }
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_cocoa_parser_2 (inLexique)) {
        case 2 : {
          ...
          const GGS_M_terminalSymbolsMapForUse  temp_8380 = var_cas_terminalSymbolMap ;
          if (temp_8380.isBuilt ()) {
            temp_8380 (HERE)->method_searchKeyGetID (inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (222)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  temp_8538 = var_cas_terminalSymbolMap ;
          if (temp_8538.isBuilt ()) {
            temp_8538 (HERE)->method_searchKeyGetID (inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (227)) ;
          }
          var_cas_labelForPopUpList._addAssign_operation (var_cas_terminal1, var_cas_terminal1ID.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (230)), var_cas_terminal2, var_cas_terminal2ID.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (232))) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
          } break ;
        case 3 : {
          ...
          if (((var_cas_settingName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (253))).operator_isEqual (GGS_string ("nibAndMainClass"))).isBuiltAndTrue ()) {
            ...
            var_cas_settingName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("unkown key") COMMA_SOURCE_FILE_AT_LINE (268)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
          } break ;
        case 4 : {
          ...
          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("the 'with lexique' construct has no effect when 'gui' component file extension is '.ggs'") COMMA_SOURCE_FILE_AT_LINE (273)) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  ...
  if (var_cas_guiComponentName.isBuilt () &&
      ...
      var_cas_terminalSymbolMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (310)).isBuilt ()) {
    ::routine_generateCocoaComponent (inLexique,  var_cas_guiComponentName,  var_cas_guiKindName,  var_cas_nibAndClassList,  var_cas_textMacroList,  var_cas_blockComment,  var_cas_lexiqueClassName,  var_cas_optionsComponentsMap,  var_cas_labelForPopUpList,  var_cas_terminalSymbolMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (310)) COMMA_SOURCE_FILE_AT_LINE (301)) ;
  }
