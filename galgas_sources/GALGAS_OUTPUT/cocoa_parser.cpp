...
pr_galgas_component_cocoa_parser_105_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (166)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    const GGS_M_grammarComponents _var_6630 = var_cas_ioGrammarComponentsMap ;
    const GGS_M_grammarComponents::element_type * operand_6630 = _var_6630.firstObject () ;
    while ((operand_6630 != NULL)) {
      macroValidPointer (operand_6630) ;
      var_cas_grammarKey = operand_6630->mKey ;
      operand_6630 = operand_6630->nextObject () ;
    }
