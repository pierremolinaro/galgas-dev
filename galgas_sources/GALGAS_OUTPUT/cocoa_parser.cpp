...
pr_galgas_component_cocoa_parser_105_6_ (galgas_scanner & _inLexique,
  ...
  nt_parse_lexique_for_importing_ (_inLexique, GGS_lstring::constructor_new (_inLexique, ((var_cas_lexiqueClassName.reader_string (_inLexique SOURCE_FILE_AT_LINE (193))) + (GGS_string (true, ".ggs"))), var_cas_lexiqueClassName.reader_location (_inLexique SOURCE_FILE_AT_LINE (193)) COMMA_HERE), var_cas_ioLexiqueMapForUse) ;
  GGS_M_terminalSymbolsMapForUse  var_cas_terminalSymbolMap ;
  if (var_cas_ioLexiqueMapForUse._isBuilt ()) {
    var_cas_ioLexiqueMapForUse (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap SOURCE_FILE_AT_LINE (197)) ;
  }
      ...
      switch (select_repeat_cocoa_parser_1 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_terminalSymbolMap._isBuilt ()) {
            var_cas_terminalSymbolMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 SOURCE_FILE_AT_LINE (208)) ;
          }
          ...
          if (var_cas_terminalSymbolMap._isBuilt ()) {
            var_cas_terminalSymbolMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 SOURCE_FILE_AT_LINE (213)) ;
          }
          var_cas_labelForPopUpList._addAssign_operation (var_cas_terminal1, var_cas_terminal1ID.reader_uint (_inLexique SOURCE_FILE_AT_LINE (216)), var_cas_terminal2, var_cas_terminal2ID.reader_uint (_inLexique SOURCE_FILE_AT_LINE (218))) ;
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique SOURCE_FILE_AT_LINE (227))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
            var_cas_sourceExpression.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this string should not be empty") SOURCE_FILE_AT_LINE (229)) ;
          }
          if (((var_cas_targetName.reader_string (_inLexique SOURCE_FILE_AT_LINE (230))) == (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique SOURCE_FILE_AT_LINE (232))) == (GGS_string (true, "blockComment"))).isBuiltAndTrue ()) {
            if (((var_cas_blockComment) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this key is already defined") SOURCE_FILE_AT_LINE (235)) ;
            }else{
              var_cas_blockComment = var_cas_sourceExpression.reader_string (_inLexique SOURCE_FILE_AT_LINE (236)) ;
            }
          }else{
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") SOURCE_FILE_AT_LINE (240)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
