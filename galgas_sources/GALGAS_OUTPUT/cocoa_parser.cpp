...
pr_galgas_component_cocoa_parser_96_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_ioGrammarComponentsMap._isBuilt ()) {
    var_cas_ioGrammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (153)) ;
  }
  ...
  if (var_cas_nonterminalSymbolParametersMap._isBuilt ()) {
    var_cas_nonterminalSymbolParametersMap (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (160)) ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_cocoa_parser_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique SOURCE_FILE_AT_LINE (171))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
            var_cas_sourceExpression.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this string should not be empty") SOURCE_FILE_AT_LINE (173)) ;
          }
          if (((var_cas_targetName.reader_string (_inLexique SOURCE_FILE_AT_LINE (174))) == (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique SOURCE_FILE_AT_LINE (176))) == (GGS_string (true, "blockComment"))).isBuiltAndTrue ()) {
            if (((var_cas_blockComment) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this key is already defined") SOURCE_FILE_AT_LINE (179)) ;
            }else{
              var_cas_blockComment = var_cas_sourceExpression.reader_string (_inLexique SOURCE_FILE_AT_LINE (180)) ;
            }
          }else{
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") SOURCE_FILE_AT_LINE (184)) ;
          }
  ...
  if (var_cas_guiComponentName._isBuilt () &&
    ...
    ::routine_generateCocoaComponent (_inLexique,  var_cas_guiComponentName,  var_cas_guiKindName,  var_cas_nibAndClassList,  var_cas_blockComment,  var_cas_lexiqueClassName,  var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (188)) ;
  }
