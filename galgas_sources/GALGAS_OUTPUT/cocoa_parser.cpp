...
pr_galgas_component_cocoa_parser_111_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    enumerator_6921.reset () ;
    const GGS_M_grammarComponents  _temp_7038 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7038._isBuilt ()) {
      _temp_7038 (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (179)) ;
    }
    ...
    const GGS_M_grammarComponents  _temp_7505 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7505._isBuilt ()) {
      _temp_7505 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (190)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_7726 = var_cas_nonterminalSymbolParametersMap ;
  if (_temp_7726._isBuilt ()) {
    _temp_7726 (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (198)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  _temp_8182 = var_cas_ioLexiqueMapForUse ;
      if (_temp_8182._isBuilt ()) {
        _temp_8182 (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (214)) ;
      }
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8710 = var_cas_terminalSymbolMap ;
          if (_temp_8710._isBuilt ()) {
            _temp_8710 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (230)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8868 = var_cas_terminalSymbolMap ;
          if (_temp_8868._isBuilt ()) {
            _temp_8868 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (235)) ;
          }
