...
pr_galgas_component_cocoa_parser_111_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    if (var_cas_ioGrammarComponentsMap._isBuilt ()) {
      var_cas_ioGrammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (179)) ;
    }
    ...
    if (var_cas_ioGrammarComponentsMap._isBuilt ()) {
      var_cas_ioGrammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (190)) ;
    }
  }
  ...
  if (var_cas_nonterminalSymbolParametersMap._isBuilt ()) {
    var_cas_nonterminalSymbolParametersMap (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (198)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioLexiqueMapForUse._isBuilt ()) {
        var_cas_ioLexiqueMapForUse (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (214)) ;
      }
      ...
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_terminalSymbolMap._isBuilt ()) {
            var_cas_terminalSymbolMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (230)) ;
          }
          ...
          if (var_cas_terminalSymbolMap._isBuilt ()) {
            var_cas_terminalSymbolMap (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (235)) ;
          }
