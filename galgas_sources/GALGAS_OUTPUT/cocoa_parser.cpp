...
pr_galgas_component_cocoa_parser_105_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (166)))._operator_isEqual (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (166))).isBuiltAndTrue ()) {
    ...
    if (var_cas_ioGrammarComponentsMap._isBuilt (HERE)) {
  ...
  }else if (((var_cas_grammarName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177)))._operator_isEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (177))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((((GGS_string (true, "the grammar should be named in the header, as follows (replace xxx by actual grammar name):\n"))._operator_concat (_inLexique, GGS_string (true, "gui ") COMMA_SOURCE_FILE_AT_LINE (179)))._operator_concat (_inLexique, var_cas_guiComponentName COMMA_SOURCE_FILE_AT_LINE (179)))._operator_concat (_inLexique, GGS_string (true, "\"") COMMA_SOURCE_FILE_AT_LINE (179)))._operator_concat (_inLexique, var_cas_guiKindName COMMA_SOURCE_FILE_AT_LINE (179)))._operator_concat (_inLexique, GGS_string (true, "\" grammar xxx :") COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (181)) ;
  ...
  if (var_cas_nonterminalSymbolParametersMap._isBuilt (HERE)) {
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioLexiqueMapForUse._isBuilt (HERE)) {
    ...
    while (syntaxRepeat) {
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_lexiqueImported)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (216))).isBuiltAndTrue ()) {
          ...
          if (var_cas_terminalSymbolMap._isBuilt (HERE)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)))._operator_isEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (241))).isBuiltAndTrue ()) {
          ...
          if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)))._operator_isEqual (_inLexique, GGS_string (true, "nibAndMainClass") SOURCE_FILE_AT_LINE (244))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246)))._operator_isEqual (_inLexique, GGS_string (true, "blockComment") SOURCE_FILE_AT_LINE (246))).isBuiltAndTrue ()) {
            if (((var_cas_blockComment)._operator_isNotEqual (_inLexique, GGS_string (true, "") SOURCE_FILE_AT_LINE (247))).isBuiltAndTrue ()) {
  ...
  if (var_cas_guiComponentName._isBuilt (HERE) &&
      var_cas_guiKindName._isBuilt (HERE) &&
      var_cas_nibAndClassList._isBuilt (HERE) &&
      var_cas_blockComment._isBuilt (HERE) &&
      var_cas_lexiqueClassName._isBuilt (HERE) &&
      var_cas_optionsComponentsMap._isBuilt (HERE) &&
      var_cas_labelForPopUpList._isBuilt (HERE) &&
      var_cas_terminalSymbolMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))._isBuilt (HERE)) {
