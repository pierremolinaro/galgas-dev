...
pr_galgas_component_cocoa_parser_113_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_M_grammarComponents::cEnumerator enumerator_7023 (var_cas_ioGrammarComponentsMap, true) ;
      const GGS_M_grammarComponents::cElement * operand_7023 = NULL ;
      while (((operand_7023 = (GGS_M_grammarComponents::cElement *) enumerator_7023.nextObject ()))) {
        macroValidPointer (operand_7023) ;
        var_cas_grammarKey = operand_7023->mKey ;
      }
    }
    const GGS_M_grammarComponents  _temp_7141 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7141._isBuilt ()) {
      _temp_7141 (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
    ...
    const GGS_M_grammarComponents  _temp_7608 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7608._isBuilt ()) {
      _temp_7608 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (192)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_7829 = var_cas_nonterminalSymbolParametersMap ;
  if (_temp_7829._isBuilt ()) {
    _temp_7829 (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (200)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  _temp_8285 = var_cas_ioLexiqueMapForUse ;
      if (_temp_8285._isBuilt ()) {
        _temp_8285 (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (216)) ;
      }
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8813 = var_cas_terminalSymbolMap ;
          if (_temp_8813._isBuilt ()) {
            _temp_8813 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (232)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8971 = var_cas_terminalSymbolMap ;
          if (_temp_8971._isBuilt ()) {
            _temp_8971 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (237)) ;
          }
