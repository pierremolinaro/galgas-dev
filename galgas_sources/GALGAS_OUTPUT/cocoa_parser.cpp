...
pr_galgas_component_cocoa_parser_71_24_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_grammarComponentsMap._isBuilt ()) {
    var_cas_grammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (115)) ;
  }
  ...
  GGS_L_signature  var_cas_4756 ;
  GGS_lstring  var_cas_4759 ;
  if (var_cas_nonterminalSymbolParametersMap._isBuilt ()) {
    var_cas_nonterminalSymbolParametersMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_4756, var_cas_4759 SOURCE_FILE_AT_LINE (119)) ;
  }
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
  GGS_L_GUIAttributeList  var_cas_guiAttributeList ;
  var_cas_guiAttributeList = GGS_L_GUIAttributeList::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_stringset  var_cas_keySet ;
  var_cas_keySet = GGS_stringset::constructor_emptySet (_inLexique COMMA_HERE) ;
  var_cas_keySet._addAssign_operation (GGS_string (true, "nibAndMainClass")) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_cocoa_parser_1 (_inLexique)) {
        case 2 : {
          ...
          if (((! (var_cas_keySet.reader_hasKey (_inLexique, var_cas_targetName.reader_string (_inLexique SOURCE_FILE_AT_LINE (129)) SOURCE_FILE_AT_LINE (129))))).isBuiltAndTrue ()) {
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") SOURCE_FILE_AT_LINE (131)) ;
          }
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
          ...
          var_cas_guiAttributeList._addAssign_operation (var_cas_targetName, var_cas_sourceExpression) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  if (var_cas_guiComponentName._isBuilt () &&
      ...
      var_cas_guiAttributeList._isBuilt () &&
      var_cas_lexiqueClassName._isBuilt () &&
      var_cas_optionsComponentsMap._isBuilt ()) {
    ::routine_generateCocoaComponent (_inLexique,  var_cas_guiComponentName,  var_cas_guiKindName,  var_cas_cliToolName,  var_cas_guiAttributeList,  var_cas_lexiqueClassName,  var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (140)) ;
  }
