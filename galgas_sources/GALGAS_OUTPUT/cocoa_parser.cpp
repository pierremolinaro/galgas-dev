...
pr_galgas_component_cocoa_parser_113_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_M_grammarComponents::cEnumerator enumerator_7037 (var_cas_ioGrammarComponentsMap, true) ;
      const GGS_M_grammarComponents::cElement * operand_7037 = NULL ;
      while (((operand_7037 = (GGS_M_grammarComponents::cElement *) enumerator_7037.nextObject ()))) {
        macroValidPointer (operand_7037) ;
        var_cas_grammarKey = operand_7037->mKey ;
      }
    }
    const GGS_M_grammarComponents  _temp_7155 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7155._isBuilt ()) {
      _temp_7155 (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }else if (((var_cas_grammarName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((((GGS_string (true, "the grammar should be named in the header, as follows (replace xxx by actual grammar name):\n"))._operator_concat (GGS_string (true, "gui ")))._operator_concat (var_cas_guiComponentName))._operator_concat (GGS_string (true, "\"")))._operator_concat (var_cas_guiKindName))._operator_concat (GGS_string (true, "\" grammar xxx :")) COMMA_SOURCE_FILE_AT_LINE (190)) ;
    ...
    const GGS_M_grammarComponents  _temp_7622 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7622._isBuilt ()) {
      _temp_7622 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (192)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_7843 = var_cas_nonterminalSymbolParametersMap ;
  if (_temp_7843._isBuilt ()) {
    _temp_7843 (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (200)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  _temp_8299 = var_cas_ioLexiqueMapForUse ;
      if (_temp_8299._isBuilt ()) {
        _temp_8299 (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (216)) ;
      }
      ...
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_lexiqueImported)._operator_not ()).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the lexique should be imported by an import__ \"...\" statement.") COMMA_SOURCE_FILE_AT_LINE (227)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8827 = var_cas_terminalSymbolMap ;
          if (_temp_8827._isBuilt ()) {
            _temp_8827 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (232)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8985 = var_cas_terminalSymbolMap ;
          if (_temp_8985._isBuilt ()) {
            _temp_8985 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (237)) ;
          }
          var_cas_labelForPopUpList._addAssign_operation (var_cas_terminal1, var_cas_terminal1ID.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (240)), var_cas_terminal2, var_cas_terminal2ID.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (242))) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (251)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
          ...
          if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (254)))._operator_isEqual (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (256)))._operator_isEqual (GGS_string (true, "blockComment"))).isBuiltAndTrue ()) {
            if (((var_cas_blockComment)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this key is already defined") COMMA_SOURCE_FILE_AT_LINE (258)) ;
            }else{
              var_cas_blockComment = var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
            }
          }else{
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") COMMA_SOURCE_FILE_AT_LINE (263)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
