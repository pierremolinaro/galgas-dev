...
pr_galgas_component_cocoa_parser_105_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (166)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    GGS_M_grammarComponents::element_type * operand_6646 = var_cas_ioGrammarComponentsMap.firstObject () ;
    while ((operand_6646 != NULL)) {
      macroValidPointer (operand_6646) ;
      var_cas_grammarKey = operand_6646->mKey ;
      operand_6646 = operand_6646->nextObject () ;
    }
