...
pr_galgas_component_cocoa_parser_105_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (166)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    const GGS_M_grammarComponents _var_6623 = var_cas_ioGrammarComponentsMap ;
    GGS_M_grammarComponents::element_type * operand_6623 = _var_6623.firstObject () ;
    while ((operand_6623 != NULL)) {
      macroValidPointer (operand_6623) ;
      var_cas_grammarKey = operand_6623->mKey ;
      operand_6623 = operand_6623->nextObject () ;
    }
