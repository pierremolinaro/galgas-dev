...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (127)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
  if (((var_cas_guiComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (128)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_guiComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS 1.7.5 and later checks "
      "the component name ('"))._operator_concat (var_cas_guiComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (130))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_M_grammarComponents::cEnumerator enumerator_7427 (var_cas_ioGrammarComponentsMap, true) ;
      const GGS_M_grammarComponents::cElement * operand_7427 = NULL ;
      while (((operand_7427 = (GGS_M_grammarComponents::cElement *) enumerator_7427.nextObject ()))) {
        macroValidPointer (operand_7427) ;
        var_cas_grammarKey = operand_7427->mKey ;
      }
    }
    const GGS_M_grammarComponents  _temp_7545 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7545._isBuilt ()) {
      _temp_7545 (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (188)) ;
    }
  }else if (((var_cas_grammarName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((((GGS_string (true, "the grammar should be named in the header, as follows (replace xxx by actual grammar name):\n"))._operator_concat (GGS_string (true, "gui ")))._operator_concat (var_cas_guiComponentName))._operator_concat (GGS_string (true, "\"")))._operator_concat (var_cas_guiKindName))._operator_concat (GGS_string (true, "\" grammar xxx :")) COMMA_SOURCE_FILE_AT_LINE (197)) ;
    ...
    const GGS_M_grammarComponents  _temp_8012 = var_cas_ioGrammarComponentsMap ;
    if (_temp_8012._isBuilt ()) {
      _temp_8012 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (199)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_8233 = var_cas_nonterminalSymbolParametersMap ;
  if (_temp_8233._isBuilt ()) {
    _temp_8233 (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (207)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  _temp_8689 = var_cas_ioLexiqueMapForUse ;
      if (_temp_8689._isBuilt ()) {
        _temp_8689 (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (223)) ;
      }
      ...
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_lexiqueImported)._operator_not ()).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the lexique should be imported by an import__ \"...\" statement.") COMMA_SOURCE_FILE_AT_LINE (234)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_9217 = var_cas_terminalSymbolMap ;
          if (_temp_9217._isBuilt ()) {
            _temp_9217 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (239)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_9375 = var_cas_terminalSymbolMap ;
          if (_temp_9375._isBuilt ()) {
            _temp_9375 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (244)) ;
          }
          var_cas_labelForPopUpList._addAssign_operation (var_cas_terminal1, var_cas_terminal1ID.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)), var_cas_terminal2, var_cas_terminal2ID.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (249))) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
            var_cas_sourceExpression.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this string should not be empty") COMMA_SOURCE_FILE_AT_LINE (259)) ;
          }
          if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)))._operator_isEqual (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)))._operator_isEqual (GGS_string (true, "blockComment"))).isBuiltAndTrue ()) {
            if (((var_cas_blockComment)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this key is already defined") COMMA_SOURCE_FILE_AT_LINE (265)) ;
            }else{
              var_cas_blockComment = var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
            }
          }else{
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") COMMA_SOURCE_FILE_AT_LINE (270)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
...
void cocoa_parser::
cocoa_parser::
pr_galgas_component_cocoa_parser_113_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
