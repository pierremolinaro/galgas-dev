...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_guiComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (113)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_guiComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS 1.7.5 and later checks "
      "the component name ('"))._operator_concat (var_cas_guiComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (115))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_M_grammarComponents::cEnumerator enumerator_6517 (var_cas_ioGrammarComponentsMap, true) ;
      const GGS_M_grammarComponents::cElement * operand_6517 = NULL ;
      while (((operand_6517 = enumerator_6517.nextObject ()))) {
        macroValidPointer (operand_6517) ;
        var_cas_grammarKey = operand_6517->mKey ;
      }
    }
    const GGS_M_grammarComponents  _temp_6622 = var_cas_ioGrammarComponentsMap ;
    if (_temp_6622._isBuilt ()) {
      _temp_6622 (HERE)->method_searchKey (_inLexique, var_cas_grammarKey, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (169)) ;
    }
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((((GGS_string (true, "the grammar should be named in the header, as follows (replace xxx by actual grammar name):\n"))._operator_concat (GGS_string (true, "gui ")))._operator_concat (var_cas_guiComponentName))._operator_concat (GGS_string (true, "\"")))._operator_concat (var_cas_guiKindName))._operator_concat (GGS_string (true, "\" grammar xxx :")) COMMA_SOURCE_FILE_AT_LINE (179)) ;
    var_cas_nonterminalSymbolParametersMap._drop () ;
    var_cas_lexiqueClassName._drop () ;
    var_cas_optionsComponentsMap._drop () ;
  }else{
    const GGS_M_grammarComponents  _temp_7089 = var_cas_ioGrammarComponentsMap ;
    if (_temp_7089._isBuilt ()) {
      _temp_7089 (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (180)) ;
    }
  }
  ...
  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_7310 = var_cas_nonterminalSymbolParametersMap ;
  if (_temp_7310._isBuilt ()) {
    _temp_7310 (HERE)->method_searchKey (_inLexique, var_cas_altName, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (188)) ;
  }
  ...
  switch (select_cocoa_parser_1 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_lexiqueComponents  _temp_7763 = var_cas_ioLexiqueMapForUse ;
      if (_temp_7763._isBuilt ()) {
        _temp_7763 (HERE)->method_searchKey (_inLexique, var_cas_lexiqueClassName, var_cas_terminalSymbolMap COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
      ...
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_lexiqueImported)._operator_not ()).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the lexique should be imported by an import__ \"...\" statement.") COMMA_SOURCE_FILE_AT_LINE (216)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8296 = var_cas_terminalSymbolMap ;
          if (_temp_8296._isBuilt ()) {
            _temp_8296 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal1, var_cas_terminal1ID, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (220)) ;
          }
          ...
          const GGS_M_terminalSymbolsMapForUse  _temp_8454 = var_cas_terminalSymbolMap ;
          if (_temp_8454._isBuilt ()) {
            _temp_8454 (HERE)->method_searchKeyGetID (_inLexique, var_cas_terminal2, var_cas_terminal2ID, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (225)) ;
          }
        ...
        case 3 : {
          ...
          if (((var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (239)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
            var_cas_sourceExpression.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this string should not be empty") COMMA_SOURCE_FILE_AT_LINE (241)) ;
          }
          if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242)))._operator_isEqual (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            ...
            if (((var_cas_blockComment)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this key is already defined") COMMA_SOURCE_FILE_AT_LINE (247)) ;
            }else{
              var_cas_blockComment = var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)) ;
            }
          }else{
            var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unkown key") COMMA_SOURCE_FILE_AT_LINE (252)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void cocoa_parser::
pr_galgas_component_cocoa_parser_100_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_gui) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
