...
pr_galgas_component_cocoa_parser_105_6_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_ioGrammarComponentsMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (166))) == (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
  ...
  }else if (((var_cas_grammarName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (177))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((((GGS_string (true, "the grammar should be named in the header, as follows (replace xxx by actual grammar name):\n")) + (GGS_string (true, "gui ")))) + (var_cas_guiComponentName))) + (GGS_string (true, "\"")))) + (var_cas_guiKindName))) + (GGS_string (true, "\" grammar xxx :"))) COMMA_SOURCE_FILE_AT_LINE (181)) ;
    ...
    while (syntaxRepeat) {
      switch (select_repeat_cocoa_parser_2 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_sourceExpression.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (241))) == (GGS_string (true, ""))).isBuiltAndTrue ()) {
          ...
          if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (244))) == (GGS_string (true, "nibAndMainClass"))).isBuiltAndTrue ()) {
            var_cas_nibAndClassList._addAssign_operation (var_cas_sourceExpression) ;
          }else if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246))) == (GGS_string (true, "blockComment"))).isBuiltAndTrue ()) {
