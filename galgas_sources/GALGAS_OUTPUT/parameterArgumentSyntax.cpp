      ...
      switch (select_parameterArgumentSyntax_10 (inLexique)) {
        case 2 : {
          ...
          switch (select_parameterArgumentSyntax_11 (inLexique)) {
            case 1 : {
              var_cas_mActualParameterTypeName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (195)) ;
              } break ;
            case 2 : {
          ...
          switch (select_parameterArgumentSyntax_12 (inLexique)) {
            case 1 : {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              var_cas_mActualParameterName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (204)) ;
              } break ;
            default :
              break ;
          }
