    ...
    while (syntaxRepeat_3) {
      switch (select_parameterArgumentSyntax_3 (inLexique)) {
        case 2 : {
          ...
          switch (select_parameterArgumentSyntax_4 (inLexique)) {
            case 1 : {
              ...
              var_cas_outActualParameterList.addAssign_operation (GGS_inputJokerActualParameterAST ::constructor_new (inLexique, var_cas_qualifierLocation, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (98))) ;
              } break ;
            case 2 : {
              ...
              const GGS_bool cond_4866 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
              if (cond_4866.isBuiltAndTrue ()) {
                ...
                GGS_uint _variant_5032 = var_cas_n ;
                GGS_bool _condition_5032 (_variant_5032.isBuilt (), true) ;
                while (_condition_5032.isBuiltAndTrue ()) {
                  _condition_5032 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
                  if (_condition_5032.isBuiltAndTrue ()) {
                    if (_variant_5032.uintValue () == 0) {
                      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (111)) ;
                      _condition_5032 = GGS_bool (false) ;
                    }else{
                      _variant_5032.decrement_operation (inLexique COMMA_HERE) ;
                      var_cas_outActualParameterList.addAssign_operation (GGS_inputJokerActualParameterAST ::constructor_new (inLexique, var_cas_qualifierLocation, var_cas_n COMMA_SOURCE_FILE_AT_LINE (109))) ;
        ...
        case 3 : {
          ...
          var_cas_outActualParameterList.addAssign_operation (GGS_outputActualParameterAST ::constructor_new (inLexique, var_cas_qualifierLocation, var_cas_e, var_cas_endOfExpressionLocation COMMA_SOURCE_FILE_AT_LINE (120))) ;
          } break ;
        case 4 : {
          ...
          var_cas_outActualParameterList.addAssign_operation (GGS_outputInputActualParameterAST ::constructor_new (inLexique, var_cas_qualifierLocation, var_cas_outputInputActualParameterName, var_cas_structAttributeList COMMA_SOURCE_FILE_AT_LINE (137))) ;
          } break ;
        case 5 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3F_) COMMA_HERE) ;
          const GGS_location  var_cas_qualifierLocation = GGS_location (inLexique) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outActualParameterList.addAssign_operation (GGS_inputActualParameterAST ::constructor_new (inLexique, var_cas_qualifierLocation, var_cas_inputActualParameterName COMMA_SOURCE_FILE_AT_LINE (153))) ;
          } break ;
        default :
      ...
      switch (select_parameterArgumentSyntax_9 (inLexique)) {
        case 2 : {
          ...
          switch (select_parameterArgumentSyntax_10 (inLexique)) {
            case 1 : {
              var_cas_mActualParameterTypeName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (212)) ;
              } break ;
            case 2 : {
          ...
          switch (select_parameterArgumentSyntax_11 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              var_cas_mActualParameterName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (221)) ;
              } break ;
            default :
              break ;
          }
