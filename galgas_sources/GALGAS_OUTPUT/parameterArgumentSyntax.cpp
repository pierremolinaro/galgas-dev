        ...
        case 2 : {
          ...
          switch (select_parameterArgumentSyntax_1 (inLexique)) {
            case 1 : {
              ...
              var_cas_mFormalParameterPassingMode = GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_HERE) ;
              } break ;
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3F__3F_) COMMA_HERE) ;
              var_cas_mFormalParameterPassingMode = GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE) ;
              } break ;
            case 3 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3F__21_) COMMA_HERE) ;
              var_cas_mFormalParameterPassingMode = GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE) ;
              } break ;
            case 4 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__21_) COMMA_HERE) ;
              var_cas_mFormalParameterPassingMode = GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
    ...
    while (syntaxRepeat_3) {
      switch (select_parameterArgumentSyntax_3 (inLexique)) {
        case 2 : {
          ...
          switch (select_parameterArgumentSyntax_4 (inLexique)) {
            case 1 : {
              ...
              var_cas_outActualParameterList.addAssign_operation (GGS_inputJokerActualParameterAST ::constructor_new (inLexique COMMA_HERE)) ;
              } break ;
            case 2 : {
        ...
        case 3 : {
          ...
          var_cas_outActualParameterList.addAssign_operation (GGS_outputActualParameterAST ::constructor_new (inLexique, var_cas_e COMMA_HERE)) ;
          } break ;
        case 4 : {
          ...
          var_cas_outActualParameterList.addAssign_operation (GGS_outputInputActualParameterAST ::constructor_new (inLexique, var_cas_outputInputActualParameterName, var_cas_structAttributeList COMMA_HERE)) ;
          } break ;
        case 5 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3F_) COMMA_HERE) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          var_cas_outActualParameterList.addAssign_operation (GGS_inputActualParameterAST ::constructor_new (inLexique, var_cas_declarationTypeName, var_cas_inputActualParameterName COMMA_HERE)) ;
          } break ;
        default :
