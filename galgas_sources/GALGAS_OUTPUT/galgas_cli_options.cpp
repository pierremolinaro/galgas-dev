...
char galgas_cli_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [4] = {'H', 'p', 'g', '\0'} ;
...
const char * galgas_cli_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [4] = {"output-html-grammar-file",
    "parseonly",
    "generate_debug",
    ""} ;
...
const char * galgas_cli_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [4] = {"Output a HTML file for every grammar component",
...
sint32 galgas_cli_options::getStringOptionsCount (void) const {
  return 0 ;
}
