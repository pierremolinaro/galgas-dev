...
:mStringValue (1 COMMA_HERE) {
  ...
  mBoolOptionValues [3] = false ;
  mBoolOptionValues [4] = false ; // Extra unused entry
  mUintOptionValues [0] = 0 ;
  mUintOptionValues [1] = 0 ;
  mUintOptionValues [2] = 0 ; // Extra unused entry
}
...
char galgas_cli_options::getBoolOptionChar (const sint32 inIndex) const {
  const char kCharArray [5] = {'\0', '\0', '\0', '\0', '\0'} ;
...
const char * galgas_cli_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [5] = {"do-not-generate-xcode-project",
    "generate_debug",
...
const char * galgas_cli_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [5] = {"Prevent Generation of the corresponding Xcode project",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [5] = {"doNotGenerateXcodeProject",
    "generate_debug",
...
uint32 galgas_cli_options::getUintOptionValue (const sint32 inIndex) const {
  return ((inIndex >= 0) && (inIndex < 2)) ? mUintOptionValues [inIndex] : 0 ;
}
...
uint32 galgas_cli_options::getUintOptionDefaultValue (const sint32 inIndex) const {
  static const uint32 kDefaultValues [3] = {
  0,
  0,
  0} ;
  return ((inIndex >= 0) && (inIndex < 2)) ? kDefaultValues [inIndex] : 0 ;
}
...
const char * galgas_cli_options::getUintOptionString (const sint32 inIndex) const {
  static const char * kStringArray [3] = {"max-errors",
    "max-warnings",
    ""} ;
...
const char * galgas_cli_options::getUintOptionDescription (const sint32 inIndex) const {
  static const char * kDescriptionArray [3] = {"After after the given number of errors has been reached (by default: unlimited)",
...
uintOptionValueFromKeys (const char * inModuleName,
                         const char * inOptionName,
                         bool * outFound) const {
  static const char * kKeyArray [3] = {"max_errors",
    "max_warnings",
    ""} ;
  uint32 result = 0 ;
  bool found = strcmp (inModuleName, "galgas_cli_options") == 0 ;
...
getStringOptionString (const sint32 inIndex) const {
  static const char * kStringArray [2] = {"create-project",
    ""} ;
...
stringOptionValueFromKeys (const char * inModuleName,
                           const char * inOptionName,
                           bool * outFound) const {
  static const char * kKeyArray [2] = {"create_project",
    ""} ;
  C_String result ;
  bool found = strcmp (inModuleName, "galgas_cli_options") == 0 ;
  if (found) {
