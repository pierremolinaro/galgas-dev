...
const char * galgas_cli_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [5] = {"generate_debug",
    "xcode",
...
const char * galgas_cli_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [5] = {"Generate Debug Information on terminals and non-terminals symbols",
    "Updates an existing Xcode project",
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [5] = {"generate_debug",
