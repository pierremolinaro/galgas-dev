...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_rule_5F_declaration_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_mNonterminalName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_non_5F_terminal_5F_symbol) COMMA_HERE) ;
  GGS_lstring  var_cas_labelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (233)) ;
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_syntaxModelBuilder_7 (inLexique)) {
    case 1 : {
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (280)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string ("parse"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (283)) ;
      } break ;
    case 3 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (291)), var_cas_mNonterminalName, var_cas_mLabelName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (290)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_terminalCheckInstruction ::constructor_new (inLexique, var_cas_mTerminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_mTerminalName, var_cas_mActualInputParameterList COMMA_SOURCE_FILE_AT_LINE (309)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_repeat) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_repeatInstruction ::constructor_new (inLexique, var_cas_mRepeatInstructionLocation, var_cas_mRepeatedInstructionList, var_cas_endOf_repeated_instructions, var_cas_mRepeatBranchList, var_cas_endOf_repeat_instruction COMMA_SOURCE_FILE_AT_LINE (340)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_selectInstruction ::constructor_new (inLexique, var_cas_mSelectInstructionLocation, var_cas_mSelectBranchList, var_cas_endOf_select_instruction COMMA_SOURCE_FILE_AT_LINE (372)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseDoInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mParseDoBranchList, var_cas_endOfInstruction COMMA_SOURCE_FILE_AT_LINE (403)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_branchOfParseWhenInstruction_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outElseInstructionList.addAssign_operation (GGS_parseWhenInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_whenExpression, var_cas_endOfWhenExpression, var_cas_whenInstructionList, var_cas_elseInstructionList, var_cas_endOfElseInstructions COMMA_SOURCE_FILE_AT_LINE (441))) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseWhenInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_whenExpression, var_cas_endOfWhenExpression, var_cas_whenInstructionList, var_cas_elseInstructionList, var_cas_endOfElseInstructions COMMA_SOURCE_FILE_AT_LINE (470)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseLoopInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_variantExpression, var_cas_endOfVariantExpression, var_cas_whileExpression, var_cas_endOfWhileExpression, var_cas_instructionList, var_cas_endOfInstructionList COMMA_SOURCE_FILE_AT_LINE (504)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_blockInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverVariable, var_cas_mBlockMethodName, var_cas_mPrologActualParameterList, var_cas_mInstructionList, var_cas_mEpilogActualParameterList COMMA_SOURCE_FILE_AT_LINE (541)) ;
}
