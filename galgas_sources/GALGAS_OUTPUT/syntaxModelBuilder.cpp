...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_323_25_ (galgas_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_349_25_ (galgas_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_376_25_ (galgas_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
