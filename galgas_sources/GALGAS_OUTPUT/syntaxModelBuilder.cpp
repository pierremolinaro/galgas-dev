...
pr_syntax_component_start_symbol_syntaxModelBuilder_69_36_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_syntax) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outSyntaxComponentRoot = GGS_syntaxComponentRoot ::constructor_new (inLexique, var_cas_mSyntaxComponentName, var_cas_importedLexiqueReference, var_cas_mNonterminalDeclarationList, var_cas_mRuleList, var_cas_mSemanticDeclarations COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_nonterminal_label_declaration_syntaxModelBuilder_141_36_ (C_Lexique_galgas_5F_scanner & inLexique,
...
void syntaxModelBuilder::
pr_nonterminal_declaration_syntaxModelBuilder_152_30_ (C_Lexique_galgas_5F_scanner & inLexique,
        ...
        case 2 : {
          ...
          switch (select_syntaxModelBuilder_4 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_6745 = var_cas_mHasParseLabel ;
              if (cond_6745.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'parse' id already defined for this nonterminal") COMMA_SOURCE_FILE_AT_LINE (169)) ;
              }
...
void syntaxModelBuilder::
pr_syntax_rule_label_syntaxModelBuilder_194_24_ (C_Lexique_galgas_5F_scanner & inLexique,
                                const GGS_lstring  var_cas_inLabelName,
...
void syntaxModelBuilder::
pr_syntax_rule_declaration_syntaxModelBuilder_212_30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_mNonterminalName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_non_5F_terminal_5F_symbol) COMMA_HERE) ;
  GGS_lstring  var_cas_labelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
...
void syntaxModelBuilder::
pr_syntax_instruction_list_syntaxModelBuilder_238_30_ (C_Lexique_galgas_5F_scanner & inLexique,
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_258_25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (273)), var_cas_mNonterminalName, var_cas_mLabelName, var_cas_mActualParameterList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_286_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_terminalCheckInstruction ::constructor_new (inLexique, var_cas_mTerminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (292)), var_cas_mTerminalName, var_cas_mActualInputParameterList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_304_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_repeat) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_repeatInstruction ::constructor_new (inLexique, var_cas_mRepeatInstructionLocation, var_cas_mRepeatedInstructionList, var_cas_mRepeatBranchList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_333_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_selectInstruction ::constructor_new (inLexique, var_cas_mSelectInstructionLocation, var_cas_mSelectBranchList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_361_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseDoInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mParseDoBranchList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_390_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        GGS_semanticExpression  var_cas_whenExpression ;
  ...
  nt_syntax_instruction_list_ (inLexique, var_cas_elseInstructionList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseWhenInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_whenBranchList, var_cas_elseInstructionList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_423_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_loop) COMMA_HERE) ;
  GGS_semanticExpression  var_cas_variantExpression ;
  nt_expression_ (inLexique, var_cas_variantExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_while) COMMA_HERE) ;
  GGS_semanticExpression  var_cas_whileExpression ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseLoopInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_variantExpression, var_cas_whileExpression, var_cas_instructionList COMMA_HERE) ;
}
...
void syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_452_25_ (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_blockInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverVariable, var_cas_mBlockMethodName, var_cas_mPrologActualParameterList, var_cas_mInstructionList, var_cas_mEpilogActualParameterList COMMA_HERE) ;
}
