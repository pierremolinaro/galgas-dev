...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_nonterminal_declaration_syntaxModelBuilder_130_4_ (galgas_scanner & _inLexique,
          ...
          switch (select_syntaxModelBuilder_4 (_inLexique)) {
            ...
            case 2 : {
              ...
              if ((var_cas_mHasParseLabel).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the 'parse' id already defined for this nonterminal") COMMA_SOURCE_FILE_AT_LINE (146)) ;
              }
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_rule_label_syntaxModelBuilder_172_4_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inLabelName,
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_rule_declaration_syntaxModelBuilder_190_4_ (galgas_scanner & _inLexique,
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_list_syntaxModelBuilder_216_4_ (galgas_scanner & _inLexique,
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_236_4_ (galgas_scanner & _inLexique,
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_263_4_ (galgas_scanner & _inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
    ...
    while (syntaxRepeat_8) {
      switch (select_repeat_syntaxModelBuilder_8 (_inLexique)) {
        case 2 : {
          ...
          switch (select_syntaxModelBuilder_9 (_inLexique)) {
            case 1 : {
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_291_4_ (galgas_scanner & _inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_318_4_ (galgas_scanner & _inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
        ...
        nt_syntax_instruction_list_ (_inLexique, var_cas_instructionList) ;
        var_cas_mSelectBranchList._addAssign_operation (var_cas_instructionList) ;
      switch (select_repeat_syntaxModelBuilder_11 (_inLexique)) {
        case 2 : {
          } break ;
        default :
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_344_4_ (galgas_scanner & _inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
...
void syntaxModelBuilder::
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_371_4_ (galgas_scanner & _inLexique,
                                GGS_syntaxInstruction  &var_cas_outInstruction) {
