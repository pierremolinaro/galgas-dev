...
pr_syntax_instruction_syntaxModelBuilder_300_25_ (galgas_scanner & inLexique,
  ...
  GGS_location  var_cas_mRepeatInstructionLocation ;
  var_cas_mRepeatInstructionLocation = GGS_location (inLexique) ;
...
pr_syntax_instruction_syntaxModelBuilder_329_25_ (galgas_scanner & inLexique,
  ...
  GGS_location  var_cas_mSelectInstructionLocation ;
  var_cas_mSelectInstructionLocation = GGS_location (inLexique) ;
