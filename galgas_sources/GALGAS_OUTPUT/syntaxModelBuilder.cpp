...
syntaxModelBuilder::
pr_syntax_component_start_symbol_syntaxModelBuilder_54_6_ (galgas_scanner & _inLexique) {
  GGS_lstring  var_cas_mSyntaxComponentName ;
  GGS_nonterminalDeclarationList  var_cas_mNonterminalDeclarations ;
  var_cas_mNonterminalDeclarations = GGS_nonterminalDeclarationList::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_syntaxRuleList  var_cas_mRules ;
  var_cas_mRules = GGS_syntaxRuleList::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_semanticDeclarationList  var_cas_mSemanticDeclarations ;
  var_cas_mSemanticDeclarations = GGS_semanticDeclarationList::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_syntaxModelBuilder_2 (_inLexique)) {
        case 2 : {
          var_cas_mNonterminalDeclarations._addModel (nt_nonterminal_declaration_ (_inLexique)) ;
          } break ;
        case 3 : {
          var_cas_mRules._addModel (nt_syntax_rule_declaration_ (_inLexique)) ;
          } break ;
        case 4 : {
...
syntaxModelBuilder::
pr_nonterminal_label_declaration_syntaxModelBuilder_96_6_ (galgas_scanner & _inLexique,
...
syntaxModelBuilder::
pr_nonterminal_declaration_syntaxModelBuilder_109_6_ (galgas_scanner & _inLexique) {
  ...
  var_cas_mLabels._addModel (nt_nonterminal_label_declaration_ (_inLexique, GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE))) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        case 2 : {
          ...
          switch (select_syntaxModelBuilder_5 (_inLexique)) {
            case 1 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
              var_cas_mLabels._addModel (nt_nonterminal_label_declaration_ (_inLexique, var_cas_labelName)) ;
              } break ;
            case 2 : {
              ...
              if ((var_cas_mHasParseLabel).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the 'parse' id already defined for this nonterminal") COMMA_SOURCE_FILE_AT_LINE (125)) ;
              }
...
syntaxModelBuilder::
pr_syntax_rule_label_syntaxModelBuilder_134_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inLabelName) {
  GGS_lstring  var_cas_mLabelName ;
  GGS_formalParameters  var_cas_mFormalParameters ;
  GGS_lstring  var_cas_mReturnedEntityName ;
...
syntaxModelBuilder::
pr_syntax_rule_declaration_syntaxModelBuilder_155_6_ (galgas_scanner & _inLexique) {
  GGS_lstring  var_cas_mNonterminalName ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        var_cas_mLabelList._addModel (nt_syntax_rule_label_ (_inLexique, var_cas_labelName)) ;
...
syntaxModelBuilder::
pr_syntax_instruction_list_syntaxModelBuilder_172_6_ (galgas_scanner & _inLexique) {
  GGS_syntaxInstructionList  var_cas_mInstruction ;
  var_cas_mInstruction = GGS_syntaxInstructionList::constructor_emptyList (_inLexique COMMA_HERE) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_syntaxModelBuilder_9 (_inLexique)) {
        ...
        case 3 : {
          var_cas_mInstruction._addModel (nt_syntax_instruction_ (_inLexique)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_187_6_ (galgas_scanner & _inLexique) {
  GGS_lstring  var_cas_mNonterminalName ;
  GGS_lstring  var_cas_mLabelName ;
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_219_6_ (galgas_scanner & _inLexique) {
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_243_6_ (galgas_scanner & _inLexique) {
  GGS_syntaxInstructions  var_cas_mRepeatedInstructionList ;
  GGS_syntaxInstructionsList  var_cas_mRepeatBranchList ;
  var_cas_mRepeatBranchList = GGS_syntaxInstructionsList::constructor_emptyList (_inLexique COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_mRepeatBranchList._addModel (nt_syntax_instruction_list_ (_inLexique)) ;
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_262_6_ (galgas_scanner & _inLexique) {
  GGS_syntaxInstructionsList  var_cas_mSelectBranchList ;
  var_cas_mSelectBranchList = GGS_syntaxInstructionsList::constructor_emptyList (_inLexique COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_select) COMMA_HERE) ;
  var_cas_mSelectBranchList._addModel (nt_syntax_instruction_list_ (_inLexique)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_281_6_ (galgas_scanner & _inLexique) {
  GGS_syntaxInstructionsList  var_cas_mParseDoBranchList ;
  var_cas_mParseDoBranchList = GGS_syntaxInstructionsList::constructor_emptyList (_inLexique COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_do) COMMA_HERE) ;
  var_cas_mParseDoBranchList._addModel (nt_syntax_instruction_list_ (_inLexique)) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
...
syntaxModelBuilder::
pr_syntax_instruction_syntaxModelBuilder_301_6_ (galgas_scanner & _inLexique) {
