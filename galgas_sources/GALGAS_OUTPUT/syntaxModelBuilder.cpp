...
void syntaxModelBuilder::rule_syntaxModelBuilder_nonterminal_5F_declaration_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  nt_nonterminal_5F_label_5F_declaration_ (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (171)), var_cas_mLabels) ;
        ...
        case 2 : {
          ...
          switch (select_syntaxModelBuilder_4 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_7046 = var_cas_mHasParseLabel ;
              if (cond_7046.isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the 'parse' id already defined for this nonterminal") COMMA_SOURCE_FILE_AT_LINE (183)) ;
              }
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_rule_5F_declaration_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_mNonterminalName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_non_5F_terminal_5F_symbol) COMMA_HERE) ;
  GGS_lstring  var_cas_labelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (229)) ;
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_syntaxModelBuilder_7 (inLexique)) {
    case 1 : {
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (276)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
      var_cas_mLabelName = GGS_lstring ::constructor_new (inLexique, GGS_string ("parse"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (279)) ;
      } break ;
    case 3 : {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (287)), var_cas_mNonterminalName, var_cas_mLabelName, var_cas_mActualParameterList COMMA_SOURCE_FILE_AT_LINE (286)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_terminalCheckInstruction ::constructor_new (inLexique, var_cas_mTerminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (306)), var_cas_mTerminalName, var_cas_mActualInputParameterList COMMA_SOURCE_FILE_AT_LINE (305)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_repeat) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_repeatInstruction ::constructor_new (inLexique, var_cas_mRepeatInstructionLocation, var_cas_mRepeatedInstructionList, var_cas_mRepeatBranchList COMMA_SOURCE_FILE_AT_LINE (334)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_selectInstruction ::constructor_new (inLexique, var_cas_mSelectInstructionLocation, var_cas_mSelectBranchList COMMA_SOURCE_FILE_AT_LINE (363)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseDoInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mParseDoBranchList COMMA_SOURCE_FILE_AT_LINE (392)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseWhenInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_whenBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (424)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_parseLoopInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_variantExpression, var_cas_whileExpression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (452)) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_blockInstruction ::constructor_new (inLexique, var_cas_instructionLocation, var_cas_mReceiverVariable, var_cas_mBlockMethodName, var_cas_mPrologActualParameterList, var_cas_mInstructionList, var_cas_mEpilogActualParameterList COMMA_SOURCE_FILE_AT_LINE (486)) ;
}
