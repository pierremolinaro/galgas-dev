...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (271)), var_cas_mNonterminalName, var_cas_mLabelName, var_cas_mActualParameterList COMMA_HERE) ;
}
...
void syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_terminalCheckInstruction ::constructor_new (inLexique, var_cas_mTerminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (290)), var_cas_mTerminalName, var_cas_mActualInputParameterList COMMA_HERE) ;
}
