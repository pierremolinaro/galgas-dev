          ...
          switch (select_syntaxModelBuilder_4 (_inLexique)) {
            ...
            case 2 : {
              ...
              if ((var_cas_mHasParseLabel).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the 'parse' id already defined for this nonterminal") COMMA_SOURCE_FILE_AT_LINE (153)) ;
              }
