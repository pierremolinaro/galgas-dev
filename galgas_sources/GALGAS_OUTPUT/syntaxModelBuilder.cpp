...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_nonterminal_5F_declaration_i2_ (GALGAS_nonterminalDeclarationListAST & ioArgument_ioNonterminalDeclarationList,
  ...
  //-------- @nonterminalInstructionForGeneration
  nt_nonterminal_5F_label_5F_declaration_ (GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (165)), var_mLabels, inCompiler) ;
  //-------- @repeatInstructionForGeneration
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_rule_5F_declaration_i4_ (GALGAS_syntaxRuleListAST & ioArgument_ioRuleList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_labelName = GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (226)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i6_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 1: {
    //-------- @assignmentInstructionForGeneration
    var_mLabelName = GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (273)) ;
  } break ;
  case 2: {
    //-------- @terminalCheckInstructionForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i7_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  case 1: {
    //-------- @assignmentInstructionForGeneration
    var_indexName = GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE_AT_LINE (303)) ;
  } break ;
  case 2: {
    //-------- @terminalCheckInstructionForGeneration
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_SOURCE_FILE_AT_LINE (308)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstruction = GALGAS_terminalCheckInstruction::constructor_new (var_mTerminalName.reader_location (SOURCE_FILE_AT_LINE (310)), var_mTerminalName, var_mActualInputParameterList, var_indexName COMMA_SOURCE_FILE_AT_LINE (309)) ;
}
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i8_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_listOfSyntaxInstructionList var_mRepeatBranchList = GALGAS_listOfSyntaxInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (329)) ;
  //-------- @repeatInstructionForGeneration
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    //-------- @terminalCheckInstructionForGeneration
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_while) COMMA_SOURCE_FILE_AT_LINE (331)) ;
    //-------- @localVariableDeclarationForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i9_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  outArgument_outInstruction.drop () ; // Release 'out' argument
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_SOURCE_FILE_AT_LINE (357)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_location var_mSelectInstructionLocation = inCompiler->here () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_listOfSyntaxInstructionList var_mSelectBranchList = GALGAS_listOfSyntaxInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (359)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_syntaxInstructionList var_instructionList ;
  //-------- @nonterminalInstructionForGeneration
  nt_syntax_5F_instruction_5F_list_ (var_instructionList, inCompiler) ;
  //-------- @addAssignInstructionForGeneration
  var_mSelectBranchList.addAssign_operation (var_instructionList, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (362)) ;
  //-------- @repeatInstructionForGeneration
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    //-------- @terminalCheckInstructionForGeneration
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_or) COMMA_SOURCE_FILE_AT_LINE (364)) ;
    //-------- @nonterminalInstructionForGeneration
    nt_syntax_5F_instruction_5F_list_ (var_instructionList, inCompiler) ;
    //-------- @addAssignInstructionForGeneration
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_SOURCE_FILE_AT_LINE (371)) ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_SOURCE_FILE_AT_LINE (372)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstruction = GALGAS_selectInstruction::constructor_new (var_mSelectInstructionLocation, var_mSelectBranchList, var_endOf_5F_select_5F_instruction COMMA_SOURCE_FILE_AT_LINE (373)) ;
}
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i10_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  outArgument_outInstruction.drop () ; // Release 'out' argument
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (387)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_do) COMMA_SOURCE_FILE_AT_LINE (389)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  while (repeatFlag_0) {
    //-------- @terminalCheckInstructionForGeneration
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_rewind) COMMA_SOURCE_FILE_AT_LINE (395)) ;
    //-------- @nonterminalInstructionForGeneration
    nt_syntax_5F_instruction_5F_list_ (var_instructionList, inCompiler) ;
    //-------- @addAssignInstructionForGeneration
    var_mParseDoBranchList.addAssign_operation (var_instructionList, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (397)) ;
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_SOURCE_FILE_AT_LINE (400)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outInstruction = GALGAS_parseRewindInstruction::constructor_new (var_instructionLocation, var_mParseDoBranchList, var_endOfInstruction COMMA_SOURCE_FILE_AT_LINE (404)) ;
}
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_branchOfParseWhenInstruction_i11_ (GALGAS_syntaxInstructionList & outArgument_outElseInstructionList,
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_else) COMMA_SOURCE_FILE_AT_LINE (422)) ;
  //-------- @nonterminalInstructionForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_branchOfParseWhenInstruction_i12_ (GALGAS_syntaxInstructionList & outArgument_outElseInstructionList,
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_SOURCE_FILE_AT_LINE (434)) ;
  //-------- @localVariableDeclarationForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i13_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  outArgument_outInstruction.drop () ; // Release 'out' argument
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (457)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_when) COMMA_SOURCE_FILE_AT_LINE (459)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionAST var_whenExpression ;
  //-------- @nonterminalInstructionForGeneration
  nt_expression_ (var_whenExpression, inCompiler) ;
  ...
  GALGAS_location var_endOfWhenExpression = inCompiler->here () ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3A_) COMMA_SOURCE_FILE_AT_LINE (463)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_syntaxInstructionList var_whenInstructionList ;
  //-------- @nonterminalInstructionForGeneration
  nt_syntax_5F_instruction_5F_list_ (var_whenInstructionList, inCompiler) ;
  ...
  GALGAS_location var_endOfElseInstructions = inCompiler->here () ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_SOURCE_FILE_AT_LINE (471)) ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (472)) ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_SOURCE_FILE_AT_LINE (473)) ;
  //-------- @assignmentInstructionForGeneration
...
void cParser_syntaxModelBuilder::rule_syntaxModelBuilder_syntax_5F_instruction_i14_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  outArgument_outInstruction.drop () ; // Release 'out' argument
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (492)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_loop) COMMA_SOURCE_FILE_AT_LINE (494)) ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_while) COMMA_SOURCE_FILE_AT_LINE (498)) ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_do) COMMA_SOURCE_FILE_AT_LINE (502)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_syntaxInstructionList var_instructionList ;
  //-------- @nonterminalInstructionForGeneration
  nt_syntax_5F_instruction_5F_list_ (var_instructionList, inCompiler) ;
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_SOURCE_FILE_AT_LINE (505)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
