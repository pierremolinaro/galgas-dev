...
static const BOOL kEndOfScriptInTemplateArray_galgasTemplateScanner [147] = {
  NO /* identifier */,
  NO /* type_name */,
  NO /* literal_double */,
...
static const C_cocoa_lexique_table_entry ktable_for_galgasTemplateScanner_galgasKeyWordList [92] = {
  ...
  {@"reverse", galgasTemplateScanner_1_reverse},
...
static NSUInteger search_into_galgasTemplateScanner_galgasKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_galgasTemplateScanner_galgasKeyWordList, 92) ;
}
...
- (void) parseLexicalTokenForLexicalColoring {
  ...
  while ((mTokenCode == 0) && (mCurrentChar != '\0')) {
    ...
    if ((mMatchedTemplateDelimiterIndex >= 0) && ([[kTemplateDefinitionArray_galgasTemplateScanner objectAtIndex:mMatchedTemplateDelimiterIndex] startString].length > 0)) {
      const BOOL foundEndDelimitor = [self testForInputString:[[kTemplateDefinitionArray_galgasTemplateScanner objectAtIndex:mMatchedTemplateDelimiterIndex] endString] advance:YES] ;
...
- (NSUInteger) styleIndexForTerminal: (NSInteger) inTerminal {
  static const NSUInteger kTerminalSymbolStyles [148] = {0,
    ...
    1 /* galgasTemplateScanner_1_reverse */,
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [148] = {NO,
    ...
    YES /* galgasTemplateScanner_1_reverse */,
