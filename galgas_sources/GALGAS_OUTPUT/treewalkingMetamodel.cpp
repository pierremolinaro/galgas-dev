...
uint32 cPtr_treewalkingRule::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_treewalkingComponentRoot::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
...
uint32 cPtr_referenceCallInstruction::_metamodelIndex (void) const {
  return gMetamodelManager.mMetamodelIndex ;
}
