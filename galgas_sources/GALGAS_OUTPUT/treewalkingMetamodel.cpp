...
uint32 cPtr_treewalkingRule::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_treewalkingRule::_metamodelClassID (void) const {
  return 0 ;
}
...
uint32 cPtr_treewalkingComponentRoot::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_treewalkingComponentRoot::_metamodelClassID (void) const {
  return 1 ;
}
...
uint32 cPtr_referenceCallInstruction::_metamodelComponentIndex (void) const {
  return gMetamodelManager.mMetamodelComponentIndex ;
}
...
uint32 cPtr_referenceCallInstruction::_metamodelClassID (void) const {
  return 2 ;
}
