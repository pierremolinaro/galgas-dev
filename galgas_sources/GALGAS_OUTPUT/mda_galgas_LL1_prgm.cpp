      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (63)) ;
          }
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (71)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (71)) ;
            }
          }
          ...
          ::routine_compileOptionComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (89)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileMetamodelComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (99)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileLexiqueComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (109)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileSemanticsComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (119)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileSyntaxComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (129)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileGrammarComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (139)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileGuiComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (149)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileProgramComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (159)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_outputDirectory ;
          ::routine_getOutputDirectory (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (168)) ;
          ::routine_compileTreewalkingComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (169)) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_outputDirectory ;
          ::routine_getOutputDirectory (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (179)) ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (185)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (185)) ;
            }
          }
          const GGS_lstringlist _var_7915 = var_cas_fileList ;
          GGS_lstringlist::element_type * operand_7915 = _var_7915.firstObject () ;
          while ((operand_7915 != NULL)) {
            ...
            if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gTreewalking"))).isBuiltAndTrue ()) {
              ::routine_compileTreewalkingComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (195)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
              ::routine_compileSemanticsComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (197)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
              ::routine_compileLexiqueComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (199)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
              ::routine_compileSyntaxComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (201)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gMetamodel"))).isBuiltAndTrue ()) {
              ::routine_compileMetamodelComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (203)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
              ::routine_compileOptionComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (205)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
              ::routine_compileGrammarComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (207)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
              ::routine_compileProgramComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (209)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
              ::routine_compileGuiComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (211)) ;
            }else{
              operand_7915->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (214)) ;
            }
