...
//                    february 22th, 2008, at 15h17'31"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          GGS_lstringlist::cEnumerator enumerator_7914 (var_cas_fileList, true) ;
          const GGS_lstringlist::cElement * operand_7914 = NULL ;
          while (((operand_7914 = (GGS_lstringlist::cElement *) enumerator_7914.nextObject ()))) {
