    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (158)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (158)) ;
            }
          }
          GGS_typeMap  var_cas_typeMap ;
          _walk_throught_buildTypeMapForSemantics (_inLexique, var_cas_semanticsComponentRoot, var_cas_typeMap) ;
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (174)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (174)) ;
            }
          }
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (200)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (200)) ;
            }
          }
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (213)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (213)) ;
            }
          }
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            if (sourceFileName.fileExists ()) {
              ...
              try{
                ...
                var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (226)) ;
              }
              macroDetachPointer (scanner_, galgas_scanner) ;
            }else{
              C_String message ;
              message << "The '" << sourceFileName << "' file does not exist" ;
              var_cas_inSourceFile.signalSemanticError (_inLexique, message.cString () COMMA_SOURCE_FILE_AT_LINE (226)) ;
            }
          }
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
