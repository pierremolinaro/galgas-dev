      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (59)) ;
          }
          ...
          GGS_lstringlist::cEnumerator enumerator_7981 (var_cas_fileList, true) ;
          const GGS_lstringlist::cElement * operand_7981 = NULL ;
          while (((operand_7981 = (GGS_lstringlist::cElement *) enumerator_7981.nextObject ()))) {
            macroValidPointer (operand_7981) ;
            _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_7981->mValue))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (189)) ;
            GGS_string var_cas_extension ;
            var_cas_extension = operand_7981->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
            GGS_lstring  var_cas_fullFilePath ;
            var_cas_fullFilePath = GGS_lstring::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_7981->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192))), operand_7981->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_HERE) ;
            if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gTreewalking"))).isBuiltAndTrue ()) {
              ...
              operand_7981->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (214)) ;
            }
          }
          enumerator_7981.reset () ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
