      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (68)) ;
          }
          ...
          ::routine_compileOptionComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (98)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileMetamodelComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (108)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileLexiqueComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (118)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileSemanticsComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (128)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileSyntaxComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (138)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileGrammarComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (148)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileGuiComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (158)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileProgramComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (168)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          ::routine_compileTreewalkingComponentLL1 (_inLexique,  var_cas_inSourceFile,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (178)) ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
          ...
          GGS_lstringlist::cEnumerator enumerator_8331 (var_cas_fileList, true) ;
          const GGS_lstringlist::cElement * operand_8331 = NULL ;
          while (((operand_8331 = (GGS_lstringlist::cElement *) enumerator_8331.nextObject ()))) {
            macroValidPointer (operand_8331) ;
            _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_8331->mValue))._operator_concat (GGS_string (true, "'\n"
              "")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
            GGS_string var_cas_extension ;
            var_cas_extension = operand_8331->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
            GGS_lstring  var_cas_fullFilePath ;
            var_cas_fullFilePath = GGS_lstring::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (201)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_8331->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))), operand_8331->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)) COMMA_HERE) ;
            if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gTreewalking"))).isBuiltAndTrue ()) {
              ::routine_compileTreewalkingComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (204)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSemantics"))).isBuiltAndTrue ()) {
              ::routine_compileSemanticsComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (206)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gLexique"))).isBuiltAndTrue ()) {
              ::routine_compileLexiqueComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (208)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gSyntax"))).isBuiltAndTrue ()) {
              ::routine_compileSyntaxComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (210)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gMetamodel"))).isBuiltAndTrue ()) {
              ::routine_compileMetamodelComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (212)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gOption"))).isBuiltAndTrue ()) {
              ::routine_compileOptionComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (214)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGrammar"))).isBuiltAndTrue ()) {
              ::routine_compileGrammarComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (216)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gProgram"))).isBuiltAndTrue ()) {
              ::routine_compileProgramComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (218)) ;
            }else if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gGui"))).isBuiltAndTrue ()) {
              ::routine_compileGuiComponentLL1 (_inLexique,  var_cas_fullFilePath,  var_cas_outputDirectory COMMA_SOURCE_FILE_AT_LINE (220)) ;
            }else{
              operand_8331->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (223)) ;
            }
          }
          enumerator_8331.reset () ;
          if (verboseOptionOn) {
            co << "Analysis of '" << sourceFilesArray (i COMMA_HERE).lastPathComponent () << "' completed. " ;
            switch (_commonLexique->totalErrorCount ()) {
            case 0 :
...
mda_galgas_LL1_prgm_prologue (C_Compiler & _inLexique,
  ...
  var_cas_libpmPath = GGS_string (true, _inLexique.stringOptionValueFromKeys ("galgas_cli_options", "libpm" COMMA_SOURCE_FILE_AT_LINE (60))) ;
  ::routine_projectCreation (_inLexique,  var_cas_creationProjectName,  var_cas_libpmPath COMMA_SOURCE_FILE_AT_LINE (60)) ;
}
