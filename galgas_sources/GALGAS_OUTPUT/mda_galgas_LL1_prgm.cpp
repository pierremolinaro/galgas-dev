...
int mainForLIBPM  (const int argc, const char * argv []) {
  ...
  //--- Input/output parameters
    ...
    const char * extensions [] = {"ggs", "gOption", "gMetamodel", NULL} ;
    const char * helpMessages [] = {"a '.ggs' GALGAS source file", "a GALGAS option source file", "a GALGAS metamodel source file", NULL} ;
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (38)) ;
          }
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (47)) ;
            }
          ...
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (66)) ;
            }
            macroDetachPointer (scanner_, galgas_scanner) ;
          }
          ...
          _walk_throught_optionHeaderGeneration (_inLexique, var_cas_optionComponentRoot, var_cas_startDirectory, var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap) ;
          ...
          const GGS_lstring var_cas_inSourceFile (GGS_lstring::constructor_new (_inLexique, _source, _here COMMA_HERE)) ;
          GGS_string var_cas_startDirectory ;
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
          var_cas_startDirectory.writeString ("/GALGAS_OUTPUT_TEMP") ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (101)) ;
            }
            macroDetachPointer (scanner_, galgas_scanner) ;
          }
          if (verboseOptionOn || ((_inLexique.totalErrorCount () + _inLexique.totalWarningCount ()) > 0)) {
