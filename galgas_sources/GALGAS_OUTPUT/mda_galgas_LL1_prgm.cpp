    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          {
            GGS_lstringlist::cEnumerator enumerator_8272 (var_cas_fileList, true) ;
            const GGS_lstringlist::cElement * operand_8272 = NULL ;
            while (((operand_8272 = (GGS_lstringlist::cElement *) enumerator_8272.nextObject ()))) {
              macroValidPointer (operand_8272) ;
              _inLexique.printMessage (((GGS_string (true, "----- Compiling '"))._operator_concat (operand_8272->mValue))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
              GGS_string var_cas_extension ;
              var_cas_extension = operand_8272->mValue.ggs_string ().reader_pathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)) ;
              GGS_lstring  var_cas_fullFilePath ;
              var_cas_fullFilePath = GGS_lstring::constructor_new (_inLexique, ((var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (201)))._operator_concat (GGS_string (true, "/")))._operator_concat (operand_8272->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))), operand_8272->mValue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)) COMMA_HERE) ;
              if (((var_cas_extension)._operator_isEqual (GGS_string (true, "gTreewalking"))).isBuiltAndTrue ()) {
                ...
                operand_8272->mValue.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "unhandled extension") COMMA_SOURCE_FILE_AT_LINE (223)) ;
              }
            }
          }
          if (verboseOptionOn) {
