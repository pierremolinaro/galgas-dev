      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        ...
        if (fileExtension.compare ("ggs") == 0) {
          ...
          if (var_cas_inSourceFile._isBuilt ()) {
            ::routine_fixFileGenerationStartDirectory (_inLexique,  var_cas_inSourceFile COMMA_SOURCE_FILE_AT_LINE (36)) ;
          }
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (45)) ;
            }
          ...
          var_cas_startDirectory = var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (60)) ;
          ...
          { galgas_scanner * scanner_ = NULL ;
            ...
            try{
              ...
              var_cas_inSourceFile.signalSemanticError (_inLexique, inFileReadError.what () COMMA_SOURCE_FILE_AT_LINE (64)) ;
            }
            macroDetachPointer (scanner_, galgas_scanner) ;
          }
          ...
          _walk_throught_optionHeaderGeneration (_inLexique, var_cas_optionComponentRoot, var_cas_startDirectory, var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap) ;
