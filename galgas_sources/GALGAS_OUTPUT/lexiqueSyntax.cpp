...
void lexiqueSyntax::rule_lexiqueSyntax_template_5F_replacement_i2_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_lexiqueSyntax_5 (inLexique)) {
    ...
    case 2 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_replacementString) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
      var_cas_replacementFunction = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (182)) ;
      } break ;
    default :
      break ;
  }
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_implicit_5F_rule_i4_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioLexicalImplicitRuleList.addAssign_operation (GGS_lexicalImplicitRuleAST ::constructor_new (inLexique, var_cas_listName COMMA_SOURCE_FILE_AT_LINE (209))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_explicit_5F_rule_i5_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_rule) COMMA_HERE) ;
  var_cas_ioLexicalExplicitRuleList.addAssign_operation (GGS_lexicalExplicitRuleAST ::constructor_new (inLexique, var_cas_lexicalRuleExpression, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (225))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_send_5F_instruction_i7_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outInstruction = GGS_lexicalSimpleSendInstructionAST ::constructor_new (inLexique, var_cas_sentTerminal COMMA_SOURCE_FILE_AT_LINE (243)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_send_5F_instruction_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_lexiqueSyntax_8 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
      var_cas_lexicalSendDefaultAction = GGS_lexicalSendTerminalByDefaultAST ::constructor_new (inLexique, var_cas_defaultSentTerminal COMMA_SOURCE_FILE_AT_LINE (266)) ;
      } break ;
    case 2 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
      var_cas_lexicalSendDefaultAction = GGS_lexicalErrorByDefaultAST ::constructor_new (inLexique, var_cas_defaultErrorMessageName COMMA_SOURCE_FILE_AT_LINE (271)) ;
      } break ;
    default :
      break ;
  }
  var_cas_outInstruction = GGS_lexicalStructuredSendInstructionAST ::constructor_new (inLexique, var_cas_lexicalSendSearchList, var_cas_lexicalSendDefaultAction COMMA_SOURCE_FILE_AT_LINE (273)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_repeat) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_lexicalInstructionAST  var_cas_i = GGS_lexicalRepeatInstructionAST ::constructor_new (inLexique, var_cas_repeatedInstructionList, var_cas_lexicalWhileBranchList COMMA_SOURCE_FILE_AT_LINE (296)) ;
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_select) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_lexicalInstructionAST  var_cas_i = GGS_lexicalSelectInstructionAST ::constructor_new (inLexique, var_cas_lexicalWhileBranchList, var_cas_defaultInstructionList COMMA_SOURCE_FILE_AT_LINE (345)) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_i) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i12_ (C_Lexique_galgas_5F_scanner & inLexique,
    ...
    while (syntaxRepeat_15) {
      switch (select_lexiqueSyntax_15 (inLexique)) {
        case 2 : {
          ...
          var_cas_actualArgumentList.addAssign_operation (GGS_lexicalFormalInputArgumentAST ::constructor_new (inLexique, var_cas_passingModeLocation, var_cas_arg COMMA_SOURCE_FILE_AT_LINE (364))) ;
          } break ;
        case 3 : {
          ...
          inLexique.assignFromAttribute_tokenString (var_cas_attributeName) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
          GGS_lexicalAttributeInputOutputArgumentAST  var_cas_arg = GGS_lexicalAttributeInputOutputArgumentAST ::constructor_new (inLexique, var_cas_passingModeLocation, var_cas_attributeName COMMA_SOURCE_FILE_AT_LINE (369)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  GGS_lexicalInstructionAST  var_cas_i = GGS_lexicalRoutineInstructionAST ::constructor_new (inLexique, var_cas_actionName, var_cas_actualArgumentList, var_cas_errorMessageList COMMA_SOURCE_FILE_AT_LINE (385)) ;
  var_cas_ioInstructionList.addAssign_operation (var_cas_i) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_output_5F_effective_5F_argument_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outEffectiveArgument = GGS_lexicalCharacterInputArgumentAST ::constructor_new (inLexique, var_cas_character COMMA_SOURCE_FILE_AT_LINE (399)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_output_5F_effective_5F_argument_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outEffectiveArgument = GGS_lexicalUnsignedInputArgumentAST ::constructor_new (inLexique, var_cas_unsignedValue COMMA_SOURCE_FILE_AT_LINE (408)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_output_5F_effective_5F_argument_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outEffectiveArgument = GGS_lexicalCurrentCharacterInputArgumentAST ::constructor_new (inLexique, var_cas_currentLocation COMMA_SOURCE_FILE_AT_LINE (418)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_function_5F_call_5F_or_5F_attribute_i17_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outArgument = GGS_lexicalAttributeInputArgumentAST ::constructor_new (inLexique, var_cas_inIdf COMMA_SOURCE_FILE_AT_LINE (433)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_function_5F_call_5F_or_5F_attribute_i18_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outArgument = GGS_lexicalFunctionInputArgumentAST ::constructor_new (inLexique, var_cas_inIdf, var_cas_functionActualArgumentList COMMA_SOURCE_FILE_AT_LINE (449)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalErrorInstructionAST ::constructor_new (inLexique, var_cas_errorMessageName COMMA_SOURCE_FILE_AT_LINE (459))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalWarningInstructionAST ::constructor_new (inLexique, var_cas_warningMessageName COMMA_SOURCE_FILE_AT_LINE (468))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalDropInstructionAST ::constructor_new (inLexique, var_cas_terminalName COMMA_SOURCE_FILE_AT_LINE (478))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalTagInstructionAST ::constructor_new (inLexique, var_cas_tagName COMMA_SOURCE_FILE_AT_LINE (488))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_terminal) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalRewindInstructionAST ::constructor_new (inLexique, var_cas_tagName, var_cas_terminalName COMMA_SOURCE_FILE_AT_LINE (501))) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_instruction_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  var_cas_ioInstructionList.addAssign_operation (GGS_lexicalLogInstructionAST ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (509))) ;
}
    ...
    while (syntaxRepeat_19) {
      switch (select_lexiqueSyntax_19 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_lexicalOrExpressionAST ::constructor_new (inLexique, var_cas_outExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (527)) ;
          } break ;
        default :
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_factor_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
  var_cas_outExpression = GGS_lexicalStringMatchAST ::constructor_new (inLexique, var_cas_string COMMA_SOURCE_FILE_AT_LINE (536)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_factor_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_outExpression = GGS_lexicalStringNotMatchAST ::constructor_new (inLexique, var_cas_string, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (548)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_factor_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_lexiqueSyntax_20 (inLexique)) {
    case 1 : {
      var_cas_outExpression = GGS_lexicalCharacterMatchAST ::constructor_new (inLexique, var_cas_character COMMA_SOURCE_FILE_AT_LINE (557)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2D__3E_) COMMA_HERE) ;
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_char) COMMA_HERE) ;
      var_cas_outExpression = GGS_lexicalCharacterIntervalMatchAST ::constructor_new (inLexique, var_cas_character, var_cas_upperBound COMMA_SOURCE_FILE_AT_LINE (562)) ;
      } break ;
    default :
      break ;
  }
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_factor_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_outExpression = GGS_lexicalCharacterSetMatchAST ::constructor_new (inLexique, var_cas_characterSet COMMA_SOURCE_FILE_AT_LINE (570)) ;
}
...
void lexiqueSyntax::rule_lexiqueSyntax_lexical_5F_list_5F_declaration_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_lexiqueSyntax_22 (inLexique)) {
    ...
    case 2 : {
      var_cas_theStyle = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (596)) ;
      } break ;
    default :
      break ;
  }
...
void lexiqueSyntax::rule_lexiqueSyntax_terminal_5F_declaration_i34_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_lexiqueSyntax_27 (inLexique)) {
    ...
    case 2 : {
      var_cas_theStyle = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (663)) ;
      } break ;
    default :
      break ;
  }
            ...
            case 2 : {
              ...
              switch (select_lexiqueSyntax_32 (inLexique)) {
                case 1 : {
                  ...
                  var_cas_lexicalArgumentMode = GGS_lexicalArgumentModeAST::constructor_lexicalInputOutputMode (inLexique COMMA_SOURCE_FILE_AT_LINE (707)) ;
                  } break ;
                case 2 : {
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3F_) COMMA_HERE) ;
                  var_cas_lexicalArgumentMode = GGS_lexicalArgumentModeAST::constructor_lexicalInputMode (inLexique COMMA_SOURCE_FILE_AT_LINE (710)) ;
                  } break ;
                default :
                  break ;
              }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_34 = true ;
            while (syntaxRepeat_34) {
                ...
                inLexique.assignFromAttribute_tokenString (var_cas_errorMessageName) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                var_cas_errorMessageList.addAssign_operation (var_cas_errorMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (722))) ;
