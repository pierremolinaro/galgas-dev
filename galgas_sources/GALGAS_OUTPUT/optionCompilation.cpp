...
void routine_compileOptionComponent (C_Compiler & inLexique,
    ...
    while (((operand_5413 = enumerator_5413.nextObject ()))) {
      ...
      if (cond_5646.isBuiltAndTrue ()) {
        ...
        if (cond_6096.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_6081 = (operand_5413->mOptionDefaultValueKind).operator_isNotEqual (GGS_optionDefaultValueEnumAST::constructor_noDefaultValue (inLexique COMMA_HERE)) ;
          ...
          if (cond_6607.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_6592 = (operand_5413->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_stringDefaultValue (inLexique COMMA_HERE)) ;
            ...
            if (cond_7067.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_7053 = (operand_5413->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_unsignedDefaultValue (inLexique COMMA_HERE)) ;
  ...
  const GGS_bool cond_7841 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_8356 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_9445 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
