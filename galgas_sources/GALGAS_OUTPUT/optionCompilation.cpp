...
//---------------------------------------------------------------------------*
//                                                                           *
//           Implementation of routine "optionHeaderGeneration34             *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
//                                                                           *
//       Implementation of routine "optionImplementationGeneration34         *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Implementation of routine "compileOptionComponent34             *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileOptionComponent (C_Compiler & _inLexique,
  ...
  if (((var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (483)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS checks "
      "the component name ('"))._operator_concat (var_cas_componentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (485))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (487)) ;
  }
  GGS_string var_cas_baseName ;
  ...
  if (((var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (491)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (491)))._operator_isNotEqual (var_cas_baseName)).isBuiltAndTrue ()) {
    var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (492)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the component name is '"))._operator_concat (var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (493))))._operator_concat (GGS_string (true, "' should be the file base name '")))._operator_concat (var_cas_baseName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (495)) ;
  }
  ...
  var_cas_optionNameSet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_23755 = enumerator_23755.nextObject ()))) {
      ...
      if ((var_cas_optionNameSet.reader_hasKey (_inLexique, operand_23755->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (502))).isBuiltAndTrue ()) {
        operand_23755->mOptionInternalName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_23755->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (503))))._operator_concat (GGS_string (true, "' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (504)) ;
      }else if (((operand_23755->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (504)))._operator_isEqual (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
      ...
      }else if (((operand_23755->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (511)))._operator_isEqual (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
      ...
      }else if (((operand_23755->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (518)))._operator_isEqual (GGS_string (true, "string"))).isBuiltAndTrue ()) {
        ...
        operand_23755->mOptionTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the @bool, @uint or @string types are allowed here") COMMA_SOURCE_FILE_AT_LINE (527)) ;
      }
