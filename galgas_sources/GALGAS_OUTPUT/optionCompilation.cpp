...
void routine_parseOptionComponent (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension (), var_cas_inSourceFile.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_HERE) ;
  const GGS_bool cond_3721 = var_cas_ioParsedComponentStruct.reader_mParsedOptionComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (73)).reader_hasKey (var_cas_key.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
  if (cond_3721.isBuiltAndTrue ()) {
    const GGS_parsedOptionComponentMap  temp_3682 = var_cas_ioParsedComponentStruct.reader_mParsedOptionComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
    if (temp_3682.isBuilt ()) {
      temp_3682 (HERE)->method_searchKey (inLexique, var_cas_key, var_cas_outOptionComponentRoot COMMA_SOURCE_FILE_AT_LINE (74)) ;
    }
    ...
    var_cas_ioParsedComponentStruct.mParsedOptionComponentMap.modifier_insertKey (inLexique, var_cas_key, var_cas_outOptionComponentRoot COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileOptionComponent (C_Compiler & inLexique,
  ...
  ::routine_parseOptionComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_optionComponentRoot COMMA_SOURCE_FILE_AT_LINE (90)) ;
  GGS_lstring  var_cas_componentName = var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
  ...
  const GGS_bool cond_4810 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99))).operator_isNotEqual (var_cas_basename) ;
  if (cond_4810.isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be the same")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  GGS_string var_cas_baseName = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_5200 = (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (107)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (107))).operator_isNotEqual (var_cas_baseName) ;
  if (cond_5200.isBuiltAndTrue ()) {
    var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (108)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the component name is '")).operator_concat (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (109)))).operator_concat (GGS_string ("' should be the file base name '"))).operator_concat (var_cas_baseName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  ...
  {
    GGS_commandLineOptionListAST::cEnumerator enumerator_5453 (var_cas_optionComponentRoot.reader_mOptions (inLexique COMMA_SOURCE_FILE_AT_LINE (117)), true) ;
    const GGS_commandLineOptionListAST::cElement * operand_5453 = NULL ;
    while (((operand_5453 = enumerator_5453.nextObject ()))) {
      macroValidPointer (operand_5453) ;
      const GGS_bool cond_5686 = var_cas_optionNameSet.reader_hasKey (operand_5453->mOptionInternalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (118))) ;
      if (cond_5686.isBuiltAndTrue ()) {
        operand_5453->mOptionInternalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_5453->mOptionInternalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (119)))).operator_concat (GGS_string ("' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
      }else if (cond_5686.isBuiltAndFalse ()) {
        const GGS_bool cond_6136 = (operand_5453->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (120))).operator_isEqual (GGS_string ("bool")) ;
        if (cond_6136.isBuiltAndTrue ()) {
          var_cas_boolOptionMap.modifier_insertKey (inLexique, operand_5453->mOptionInternalName, operand_5453->mOptionInvocationLetter, operand_5453->mOptionInvocationString, operand_5453->mOptionComment, GGS_string ("false") COMMA_SOURCE_FILE_AT_LINE (121)) ;
          const GGS_bool cond_6121 = (operand_5453->mOptionDefaultValueKind).operator_isNotEqual (GGS_optionDefaultValueEnumAST::constructor_noDefaultValue (inLexique COMMA_HERE)) ;
          if (cond_6121.isBuiltAndTrue ()) {
            operand_5453->mOptionDefaultValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("an @bool option cannot have a default value (default value is allways false)") COMMA_SOURCE_FILE_AT_LINE (130)) ;
          }
        }else if (cond_6136.isBuiltAndFalse ()) {
          const GGS_bool cond_6647 = (operand_5453->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).operator_isEqual (GGS_string ("uint")) ;
          if (cond_6647.isBuiltAndTrue ()) {
            var_cas_uintOptionMap.modifier_insertKey (inLexique, operand_5453->mOptionInternalName, operand_5453->mOptionInvocationLetter, operand_5453->mOptionInvocationString, operand_5453->mOptionComment, (((operand_5453->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("0")) : (operand_5453->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (137)))) COMMA_SOURCE_FILE_AT_LINE (132)) ;
            const GGS_bool cond_6632 = (operand_5453->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_stringDefaultValue (inLexique COMMA_HERE)) ;
            if (cond_6632.isBuiltAndTrue ()) {
              operand_5453->mOptionDefaultValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("an @uint option default value cannot be an @string value") COMMA_SOURCE_FILE_AT_LINE (141)) ;
            }
          }else if (cond_6647.isBuiltAndFalse ()) {
            const GGS_bool cond_7107 = (operand_5453->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_isEqual (GGS_string ("string")) ;
            if (cond_7107.isBuiltAndTrue ()) {
              var_cas_stringOptionMap.modifier_insertKey (inLexique, operand_5453->mOptionInternalName, operand_5453->mOptionInvocationLetter, operand_5453->mOptionInvocationString, operand_5453->mOptionComment, operand_5453->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (143)) ;
              const GGS_bool cond_7093 = (operand_5453->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_unsignedDefaultValue (inLexique COMMA_HERE)) ;
              if (cond_7093.isBuiltAndTrue ()) {
                operand_5453->mOptionDefaultValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("an @string option default value cannot be an @uint value") COMMA_SOURCE_FILE_AT_LINE (152)) ;
              }
            }else if (cond_7107.isBuiltAndFalse ()) {
              operand_5453->mOptionTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the @bool, @uint or @string types are allowed here") COMMA_SOURCE_FILE_AT_LINE (155)) ;
            }
          }
        }
      }
      var_cas_optionNameSet.addAssign_operation (operand_5453->mOptionInternalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (156))) ;
    }
  }
  const GGS_bool cond_7881 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_7881.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (162)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (166)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166))), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (170)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap) COMMA_SOURCE_FILE_AT_LINE (160)) ;
  }
  const GGS_bool cond_8396 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8396.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (181)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionImplementation (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (185)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap), GGS_string ("\n"
      "\n"), GGS_string ("\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (179)) ;
  }
  const GGS_bool cond_8955 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8955.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (198)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_concat (GGS_string ("-cocoa.h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionHeaderCocoaZone2 (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (202)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionHeaderCocoaZone3 (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206))) COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }
  const GGS_bool cond_9485 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9485.isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (214)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).operator_concat (GGS_string ("-cocoa.m")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_optionGenerationTemplates_optionImplementationCocoa (inLexique, var_cas_optionComponentRoot.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (218)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)), var_cas_boolOptionMap, var_cas_uintOptionMap, var_cas_stringOptionMap), GGS_string ("\n"
      "\n"), GGS_string ("\n"
