...
void routine_compileOptionComponent (C_Compiler & _inLexique,
  ...
  var_cas_baseName = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (480)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (480)) ;
  if (((var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (481)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (481)))._operator_isNotEqual (var_cas_baseName)).isBuiltAndTrue ()) {
    var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (482)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the component name is '"))._operator_concat (var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (483))))._operator_concat (GGS_string (true, "' should be the file base name '")))._operator_concat (var_cas_baseName))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (484)) ;
  }
  ...
  {
    GGS_commandLineOptionList::cEnumerator enumerator_23273 (var_cas_optionComponentRoot.reader_mOptions (_inLexique COMMA_SOURCE_FILE_AT_LINE (491)), true) ;
    const GGS_commandLineOptionList::cElement * operand_23273 = NULL ;
    while (((operand_23273 = (GGS_commandLineOptionList::cElement *) enumerator_23273.nextObject ()))) {
      macroValidPointer (operand_23273) ;
      if ((var_cas_optionNameSet.reader_hasKey (_inLexique, operand_23273->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (492)) COMMA_SOURCE_FILE_AT_LINE (492))).isBuiltAndTrue ()) {
        operand_23273->mOptionInternalName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (operand_23273->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (493))))._operator_concat (GGS_string (true, "' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (493)) ;
      }else if (((operand_23273->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (494)))._operator_isEqual (GGS_string (true, "bool"))).isBuiltAndTrue ()) {
        var_cas_boolOptionMap.modifier_insertKey (_inLexique, operand_23273->mOptionInternalName, operand_23273->mOptionInvocationLetter, operand_23273->mOptionInvocationString, operand_23273->mOptionComment COMMA_SOURCE_FILE_AT_LINE (495)) ;
      }else if (((operand_23273->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)))._operator_isEqual (GGS_string (true, "uint"))).isBuiltAndTrue ()) {
        var_cas_uintOptionMap.modifier_insertKey (_inLexique, operand_23273->mOptionInternalName, operand_23273->mOptionInvocationLetter, operand_23273->mOptionInvocationString, operand_23273->mOptionComment COMMA_SOURCE_FILE_AT_LINE (502)) ;
      }else if (((operand_23273->mOptionTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)))._operator_isEqual (GGS_string (true, "string"))).isBuiltAndTrue ()) {
        var_cas_stringOptionMap.modifier_insertKey (_inLexique, operand_23273->mOptionInternalName, operand_23273->mOptionInvocationLetter, operand_23273->mOptionInvocationString, operand_23273->mOptionComment COMMA_SOURCE_FILE_AT_LINE (509)) ;
      }else{
        operand_23273->mOptionTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the @bool, @uint or @string types are allowed here") COMMA_SOURCE_FILE_AT_LINE (516)) ;
      }
      var_cas_optionNameSet._addAssign_operation (operand_23273->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (518))) ;
    }
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ::routine_optionHeaderGeneration (_inLexique,  var_cas_inOutputDirectory,  var_cas_optionComponentRoot.reader_mOptionComponentName (_inLexique COMMA_SOURCE_FILE_AT_LINE (524)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (524)),  var_cas_boolOptionMap,  var_cas_uintOptionMap,  var_cas_stringOptionMap COMMA_SOURCE_FILE_AT_LINE (521)) ;
  }
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
