...
template_filewrapper_optionGenerationTemplates_optionImplementationCocoa (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_commandLineOptionMap::cEnumerator enumerator_1188 (var_cas_UINT_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_1188 = NULL ;
    while (((operand_1188 = enumerator_1188.nextObject ()))) {
      ...
      result << "\n"
        "    identifier:@" ;
      result << operand_1188->mKey.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (28)) ;
      result << "\n"
        "    commandChar:" ;
      result << operand_1188->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (29)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (29)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (29)) ;
      result << "\n"
        "    commandString:@" ;
      result << operand_1188->mInfo.mOptionString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (30)) ;
      result << "\n"
        "    comment:@" ;
      result << operand_1188->mInfo.mComment.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
      result << "\n"
        "  ] ;\n"
        "  [ioUIntOptionArray addObject:option] ;\n"
        "  [option release] ;\n" ;
    }
    GGS_commandLineOptionMap::cEnumerator enumerator_1672 (var_cas_STRING_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_1672 = NULL ;
    while (((operand_1672 = enumerator_1672.nextObject ()))) {
      macroValidPointer (operand_1672) ;
      result << "  option = [[OC_GGS_CommandLineOption alloc]\n"
        "    initWithDomainName:@" ;
      result << var_cas_OPTION_COMPONENT_NAME.reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
      result << "\n"
        "    identifier:@" ;
      result << operand_1672->mKey.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (39)) ;
      result << "\n"
        "    commandChar:" ;
      result << operand_1672->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (40)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (40)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
      result << "\n"
        "    commandString:@" ;
      result << operand_1672->mInfo.mOptionString.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (41)) ;
      result << "\n"
        "    comment:@" ;
      result << operand_1672->mInfo.mComment.ggs_string ().reader_utf8Representation (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
      result << "\n"
        "  ] ;\n"
