...
template_filewrapper_optionGenerationTemplates_optionImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_commandLineOptionMap::cEnumerator enumerator_1870 (var_cas_UINT_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_1870 = NULL ;
    while (((operand_1870 = enumerator_1870.nextObject ()))) {
      macroValidPointer (operand_1870) ;
      result << "C_UIntCommandLineOption gOption_" ;
      result << var_cas_OPTION_COMPONENT_NAME.reader_identifierRepresentation () ;
      result << "_" ;
      result << operand_1870->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (\"" ;
      result << var_cas_OPTION_COMPONENT_NAME ;
      result << "\",\n"
        "                                         " ;
      result << operand_1870->mKey.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_1870->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (36)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (36)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
      result << ",\n"
        "                                         " ;
      result << operand_1870->mInfo.mOptionString.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_1870->mInfo.mComment.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_1870->mInfo.mDefaultValue ;
      result << ") ;\n"
        "\n" ;
    }
    result << "//---------------------------------------------------------------------------*\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_commandLineOptionMap::cEnumerator enumerator_2862 (var_cas_STRING_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_2862 = NULL ;
    while (((operand_2862 = enumerator_2862.nextObject ()))) {
      macroValidPointer (operand_2862) ;
      result << "C_StringCommandLineOption gOption_" ;
      result << var_cas_OPTION_COMPONENT_NAME.reader_identifierRepresentation () ;
      result << "_" ;
      result << operand_2862->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (\"" ;
      result << var_cas_OPTION_COMPONENT_NAME ;
      result << "\",\n"
        "                                         " ;
      result << operand_2862->mKey.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_2862->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (50)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (50)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
      result << ",\n"
        "                                         " ;
      result << operand_2862->mInfo.mOptionString.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_2862->mInfo.mComment.ggs_string ().reader_utf8Representation () ;
      result << ",\n"
        "                                         " ;
      result << operand_2862->mInfo.mDefaultValue.reader_utf8Representation () ;
      result << ") ;\n"
        "\n" ;
    }
    result << "//---------------------------------------------------------------------------*\n"
...
template_filewrapper_optionGenerationTemplates_optionImplementationCocoa (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_commandLineOptionMap::cEnumerator enumerator_1211 (var_cas_UINT_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_1211 = NULL ;
    while (((operand_1211 = enumerator_1211.nextObject ()))) {
      macroValidPointer (operand_1211) ;
      result << "  option = [[OC_GGS_CommandLineOption alloc]\n"
        "    initWithDomainName:@" ;
      result << var_cas_OPTION_COMPONENT_NAME.reader_utf8Representation () ;
      result << "\n"
        "    identifier:@" ;
      result << operand_1211->mKey.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    commandChar:" ;
      result << operand_1211->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (30)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (30)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (30)) ;
      result << "\n"
        "    commandString:@" ;
      result << operand_1211->mInfo.mOptionString.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    comment:@" ;
      result << operand_1211->mInfo.mComment.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    defaultValue:@" ;
      result << operand_1211->mInfo.mDefaultValue.reader_utf8Representation () ;
      result << "\n"
        "  ] ;\n"
        "  [ioUIntOptionArray addObject:option] ;\n"
        "  [option release] ;\n" ;
    }
    GGS_commandLineOptionMap::cEnumerator enumerator_1753 (var_cas_STRING_OPTION_MAP, true) ;
    const GGS_commandLineOptionMap::cElement * operand_1753 = NULL ;
    while (((operand_1753 = enumerator_1753.nextObject ()))) {
      ...
      result << "\n"
        "    identifier:@" ;
      result << operand_1753->mKey.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    commandChar:" ;
      result << operand_1753->mInfo.mOptionChar.reader_char (inLexique COMMA_SOURCE_FILE_AT_LINE (42)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (42)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
      result << "\n"
        "    commandString:@" ;
      result << operand_1753->mInfo.mOptionString.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    comment:@" ;
      result << operand_1753->mInfo.mComment.ggs_string ().reader_utf8Representation () ;
      result << "\n"
        "    defaultValue:@" ;
      result << operand_1753->mInfo.mDefaultValue.reader_utf8Representation () ;
      result << "\n"
        "  ] ;\n"
  ...
  GGS_stringset  var_cas_optionNameSet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_3663 = enumerator_3663.nextObject ()))) {
      ...
      if (cond_3898.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_4351 = (operand_3663->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (79))).operator_isEqual (GGS_string ("bool")) ;
        if (cond_4351.isBuiltAndTrue ()) {
          var_cas_outBoolOptionMap.modifier_insertKey (inLexique, operand_3663->mOptionInternalName, operand_3663->mOptionInvocationLetter, operand_3663->mOptionInvocationString, operand_3663->mOptionComment, GGS_string ("false") COMMA_SOURCE_FILE_AT_LINE (80)) ;
          const GGS_bool cond_4336 = (operand_3663->mOptionDefaultValueKind).operator_isNotEqual (GGS_optionDefaultValueEnumAST::constructor_noDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (87))) ;
          if (cond_4336.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_4865 = (operand_3663->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90))).operator_isEqual (GGS_string ("uint")) ;
          if (cond_4865.isBuiltAndTrue ()) {
            var_cas_outUIntOptionMap.modifier_insertKey (inLexique, operand_3663->mOptionInternalName, operand_3663->mOptionInvocationLetter, operand_3663->mOptionInvocationString, operand_3663->mOptionComment, (((operand_3663->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("0")) : (operand_3663->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)))) COMMA_SOURCE_FILE_AT_LINE (91)) ;
            const GGS_bool cond_4850 = (operand_3663->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_stringDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (98))) ;
            if (cond_4850.isBuiltAndTrue ()) {
          ...
          }else if (cond_4865.isBuiltAndFalse ()) {
            const GGS_bool cond_5328 = (operand_3663->mOptionTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101))).operator_isEqual (GGS_string ("string")) ;
            if (cond_5328.isBuiltAndTrue ()) {
              var_cas_outStringOptionMap.modifier_insertKey (inLexique, operand_3663->mOptionInternalName, operand_3663->mOptionInvocationLetter, operand_3663->mOptionInvocationString, operand_3663->mOptionComment, operand_3663->mOptionDefaultValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (102)) ;
              const GGS_bool cond_5314 = (operand_3663->mOptionDefaultValueKind).operator_isEqual (GGS_optionDefaultValueEnumAST::constructor_unsignedDefaultValue (inLexique COMMA_SOURCE_FILE_AT_LINE (109))) ;
              if (cond_5314.isBuiltAndTrue ()) {
            ...
            }else if (cond_5328.isBuiltAndFalse ()) {
...
void routine_parseOptionComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_6417 = var_cas_ioParsedComponentStruct.reader_mParsedOptionComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (132)).reader_hasKey (var_cas_outOptionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132))) ;
  if (cond_6417.isBuiltAndTrue ()) {
  ...
  }else if (cond_6417.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_6981 = (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).operator_isNotEqual (var_cas_basename) ;
    if (cond_6981.isBuiltAndTrue ()) {
    ...
    GGS_string var_cas_baseName = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
    const GGS_bool cond_7382 = (var_cas_optionComponentAST.reader_mOptionComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (148)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (148))).operator_isNotEqual (var_cas_baseName) ;
    if (cond_7382.isBuiltAndTrue ()) {
...
void routine_compileOptionComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_8909 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (186))).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_9378 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (205))).operator_isEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_9868 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9868.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_10352 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (238))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_10352.isBuiltAndTrue ()) {
