...
//                    november 27th, 2010, at 20h10'41"                      *
//                                                                           *
//---------------------------------------------------------------------------*
          ...
          if (GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (33)).reader_string (SOURCE_FILE_AT_LINE (33)).objectCompare (enumerator_391.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (33)))).isValidAndTrue ()) {
            ...
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_2237.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                if (GALGAS_bool (kIsEqual, enumerator_2237.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (42)))).isValidAndTrue ()) {
                  result << "const GALGAS_" ;
                  ...
                  if (GALGAS_bool (kIsEqual, enumerator_2237.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (44)))).isValidAndTrue ()) {
                    result << "GALGAS_" ;
                    ...
                    if (GALGAS_bool (kIsEqual, enumerator_2237.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (46)))).isValidAndTrue ()) {
                      result << "GALGAS_" ;
            ...
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_3369.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                if (GALGAS_bool (kIsEqual, enumerator_3369.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (57)))).isValidAndTrue ()) {
                  result << "const GALGAS_" ;
                  ...
                  if (GALGAS_bool (kIsEqual, enumerator_3369.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (59)))).isValidAndTrue ()) {
                    result << "GALGAS_" ;
                    ...
                    if (GALGAS_bool (kIsEqual, enumerator_3369.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (61)))).isValidAndTrue ()) {
                      result << "GALGAS_" ;
...
void routine_compileGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_hasIndexing = var_lexiqueComponentAST.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (571)).mAttribute_location.reader_isNowhere (SOURCE_FILE_AT_LINE (571)).operator_not (SOURCE_FILE_AT_LINE (571)) ;
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_8 (var_hasIndexing.operator_and (var_grammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (572))) ;
  if (test_8.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_9 (var_grammarComponentRoot.mAttribute_mHasIndexing.reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_10 (var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (574)).operator_and (var_grammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (574))) ;
    if (test_10.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (var_grammarComponentRoot.mAttribute_mGrammarName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, GALGAS_string ("the grammar does not enable indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)).operator_concat (GALGAS_string ("' does") COMMA_SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)) ;
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (581)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkLabelMap (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (584)).reader_location (SOURCE_FILE_AT_LINE (584)), var_grammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (585)), var_grammarComponentRoot.reader_mStartSymbolHasParseLabel (SOURCE_FILE_AT_LINE (586)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (587)).reader_string (SOURCE_FILE_AT_LINE (587)), inCompiler COMMA_SOURCE_FILE_AT_LINE (587)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (591)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_25775 (var_grammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (592)), true) ;
  //--- simple foreach instruction
  while (enumerator_25775.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_nonterminalIndex ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_25881_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_25775.current_mValue (HERE), var_nonterminalIndex, joker_25881_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (594)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_25775.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (595)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_25775.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (598)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26240 (var_nonTerminalMapForGrammarAnalysis, true) ;
  //--- simple foreach instruction
  while (enumerator_26240.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_26240.current_lkey (HERE), enumerator_26240.current_mNonTerminalIndex (HERE), enumerator_26240.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (600)) ;
    enumerator_26240.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  routine_grammarAnalysisAndGeneration (var_grammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (604)), var_grammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (605)), var_startSymbolIndex, var_lexiqueComponentName, var_grammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (608)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectoryForCppFiles, constinArgument_inOutputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_12 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (618)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_12.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (inCompiler, var_grammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (619))) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (inCompiler, var_lexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (623)), var_grammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (622))) ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectoryForCppFiles, var_grammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (631)).reader_string (SOURCE_FILE_AT_LINE (631)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (631)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
    } //-------- @routineCallInstructionForGeneration
  }
}
