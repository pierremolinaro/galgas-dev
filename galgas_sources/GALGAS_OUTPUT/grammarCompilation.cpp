...
template_filewrapper_grammarGenerationTemplate_grammarZone3Header (C_Compiler & inLexique,
  ...
  GGS_signatureForGrammarAnalysis::cEnumerator enumerator_3204 (operand_490->mInfo.mFormalParametersList, true) ;
  const GGS_signatureForGrammarAnalysis::cElement * operand_3204 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3204 = enumerator_3204.nextObject ()))) {
  macroValidPointer (operand_3204) ;
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  if ((operand_3204->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3204->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * const inArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }else if ((operand_3204->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (52))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3204->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * & ioArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
  }else if ((operand_3204->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (54))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3204->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * & outArgument" ;
...
result << "\n" ;
GGS_nonTerminalToAddList::cEnumerator enumerator_4205 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
const GGS_nonTerminalToAddList::cElement * operand_4205 = NULL ;
while (((operand_4205 = enumerator_4205.nextObject ()))) {
macroValidPointer (operand_4205) ;
result << "  public : virtual PMSInt32 select_" ;
result << operand_4205->mSyntaxComponentName.reader_identifierRepresentation () ;
result << "_" ;
result << operand_4205->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
result << " (C_Lexique_" ;
result << var_cas_LEXIQUE_IDENTIFIER ;
result << " &) ;\n" ;
if (enumerator_4205.hasNextObject ()) {
result << "\n" ;
}
}
result << "} ;\n"
