...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (C_Compiler * /* inCompiler */,
  ...
  result << in_GRAMMAR_5F_COMPONENT_5F_ROOT.mAttribute_mGrammarComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1)).stringValue () ;
  result << "_HAS_BEEN_DEFINED\n"
    "#define GRAMMAR_" ;
  result << in_GRAMMAR_5F_COMPONENT_5F_ROOT.mAttribute_mGrammarComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (2)).stringValue () ;
  result << "_HAS_BEEN_DEFINED\n"
    "\n"
    "//-----------------------------------------------------------------------------*\n"
    "\n" ;
  ...
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (6)).isValid ()) {
    cEnumerator_lstringlist enumerator_354 (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (6)), kEnumeration_up) ;
    while (enumerator_354.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_354.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (7)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (7)).stringValue () ;
      result << ".h\"\n" ;
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * inCompiler,
  ...
  result << "//-----------------------------------------------------------------------------*\n"
    "\n"
    "class cGrammar_" ;
  result << in_GRAMMAR_5F_COMPONENT_5F_ROOT.mAttribute_mGrammarComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (3)).stringValue () ;
  result << " : " ;
  columnMarker = result.currentColumn () ;
  GALGAS_uint index_233_ (0) ;
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (4)).isValid ()) {
    cEnumerator_lstringlist enumerator_233 (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (4)), kEnumeration_up) ;
    while (enumerator_233.hasCurrentObject ()) {
      result << "public cParser_" ;
      result << enumerator_233.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (5)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (5)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (5)).stringValue () ;
  ...
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    ...
    while (enumerator_383.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_1) {
        result << "//--- indexing\n"
          "  public : virtual void nt_" ;
        result << enumerator_383.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (22)).stringValue () ;
      ...
      if (enumerator_383.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        ...
        while (enumerator_1035.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_1035.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (25)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          result << enumerator_383.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (27)).stringValue () ;
          result << "_" ;
          result << enumerator_1035.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (27)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          ...
          if (enumerator_1035.current_mFormalParametersList (HERE).isValid ()) {
            ...
            while (enumerator_1284.hasCurrentObject ()) {
              const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1284.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (29)))).boolEnum () ;
              if (kBoolTrue == test_2) {
                result << "const GALGAS_" ;
                result << enumerator_1284.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (30)).stringValue () ;
                result << " inArgument" ;
                result << index_1284_IDX.reader_string (SOURCE_FILE_AT_LINE (30)).stringValue () ;
              }else if (kBoolFalse == test_2) {
                const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_1284.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (31)))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  result << "GALGAS_" ;
                  result << enumerator_1284.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_1284_IDX.reader_string (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                }else if (kBoolFalse == test_3) {
                  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_1284.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (33)))).boolEnum () ;
                  if (kBoolTrue == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1284.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (34)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_1284_IDX.reader_string (SOURCE_FILE_AT_LINE (34)).stringValue () ;
                  }else if (kBoolFalse == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1284.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (36)).stringValue () ;
                    result << " inArgument" ;
                    result << index_1284_IDX.reader_string (SOURCE_FILE_AT_LINE (36)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
          ...
          result << " * inCompiler) ;\n"
            "\n" ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (45)).reader_string (SOURCE_FILE_AT_LINE (45)).objectCompare (enumerator_383.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (45)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            result << "//--- Start symbol\n"
              "  public : static void _performSourceFileParsing_" ;
            result << enumerator_1035.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (47)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            ...
            if (enumerator_1035.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_2809.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_2809.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (55)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  result << "const GALGAS_" ;
                  result << enumerator_2809.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (56)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2809_IDX.reader_string (SOURCE_FILE_AT_LINE (56)).stringValue () ;
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_2809.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (57)))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    result << "GALGAS_" ;
                    result << enumerator_2809.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (58)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2809_IDX.reader_string (SOURCE_FILE_AT_LINE (58)).stringValue () ;
                  }else if (kBoolFalse == test_9) {
                    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_2809.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (59)))).boolEnum () ;
                    if (kBoolTrue == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2809.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2809_IDX.reader_string (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                    }else if (kBoolFalse == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2809.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2809_IDX.reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                    }
                  }
                }
            ...
            result << enumerator_1035.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (66)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            if (enumerator_1035.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_4078.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_4078.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (74)))).boolEnum () ;
                if (kBoolTrue == test_12) {
                  result << "const GALGAS_" ;
                  result << enumerator_4078.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (75)).stringValue () ;
                  result << " inArgument" ;
                  result << index_4078_IDX.reader_string (SOURCE_FILE_AT_LINE (75)).stringValue () ;
                }else if (kBoolFalse == test_12) {
                  const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_4078.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (76)))).boolEnum () ;
                  if (kBoolTrue == test_13) {
                    result << "GALGAS_" ;
                    result << enumerator_4078.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (77)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_4078_IDX.reader_string (SOURCE_FILE_AT_LINE (77)).stringValue () ;
                  }else if (kBoolFalse == test_13) {
                    const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_4078.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (78)))).boolEnum () ;
                    if (kBoolTrue == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4078.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (79)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_4078_IDX.reader_string (SOURCE_FILE_AT_LINE (79)).stringValue () ;
                    }else if (kBoolFalse == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4078.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
                      result << " inArgument" ;
                      result << index_4078_IDX.reader_string (SOURCE_FILE_AT_LINE (81)).stringValue () ;
                    }
                  }
                }
  ...
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_5312.hasCurrentObject ()) {
      ...
      result << enumerator_5312.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (96)).stringValue () ;
      result << "_" ;
      result << enumerator_5312.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (96)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_HeaderGalgas_33_ (C_Compiler * inCompiler,
  ...
  result << "//-----------------------------------------------------------------------------*\n"
    ...
    "\n"
    "class cGrammar_" ;
  result << in_GRAMMAR_5F_COMPONENT_5F_ROOT.mAttribute_mGrammarComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (9)).stringValue () ;
  result << " : " ;
  columnMarker = result.currentColumn () ;
  GALGAS_uint index_380_ (0) ;
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (10)).isValid ()) {
    cEnumerator_lstringlist enumerator_380 (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (10)), kEnumeration_up) ;
    while (enumerator_380.hasCurrentObject ()) {
      result << "public cParser_" ;
      result << enumerator_380.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (11)).stringValue () ;
  ...
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    ...
    while (enumerator_497.hasCurrentObject ()) {
      ...
      result << "' non terminal\n"
        "//--- 'parse' label\n"
        "  public : virtual void nt_" ;
      result << enumerator_497.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (20)).stringValue () ;
      result << "_parse (" ;
      columnMarker = result.currentColumn () ;
      const enumGalgasBool test_0 = in_GRAMMAR_5F_COMPONENT_5F_ROOT.mAttribute_mHasTranslateFeature.boolEnum () ;
      if (kBoolTrue == test_0) {
        result << "C_String & " ;
        result << function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (22)).stringValue () ;
        result << ",\n" ;
        result.appendSpacesUntilColumn (columnMarker) ;
      }else if (kBoolFalse == test_0) {
      }
      ...
      if (kBoolTrue == test_1) {
        result << "//--- indexing\n"
          "  public : virtual void nt_" ;
        result << enumerator_497.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (28)).stringValue () ;
        result << "_indexing (C_Lexique_" ;
        result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
        result << " * inCompiler) ;\n"
          "\n" ;
      ...
      if (enumerator_497.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        ...
        while (enumerator_1149.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_1149.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (31)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          result << enumerator_497.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (33)).stringValue () ;
          result << "_" ;
          result << enumerator_1149.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (33)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          ...
          if (enumerator_1149.current_mFormalParametersList (HERE).isValid ()) {
            ...
            while (enumerator_1398.hasCurrentObject ()) {
              const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1398.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (35)))).boolEnum () ;
              if (kBoolTrue == test_2) {
                result << "const GALGAS_" ;
                result << enumerator_1398.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (36)).stringValue () ;
                result << " inArgument" ;
                result << index_1398_IDX.reader_string (SOURCE_FILE_AT_LINE (36)).stringValue () ;
              }else if (kBoolFalse == test_2) {
                const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_1398.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (37)))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  result << "GALGAS_" ;
                  result << enumerator_1398.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (38)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_1398_IDX.reader_string (SOURCE_FILE_AT_LINE (38)).stringValue () ;
                }else if (kBoolFalse == test_3) {
                  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_1398.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (39)))).boolEnum () ;
                  if (kBoolTrue == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1398.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (40)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_1398_IDX.reader_string (SOURCE_FILE_AT_LINE (40)).stringValue () ;
                  }else if (kBoolFalse == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1398.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (42)).stringValue () ;
                    result << " inArgument" ;
                    result << index_1398_IDX.reader_string (SOURCE_FILE_AT_LINE (42)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
          ...
          if (kBoolTrue == test_5) {
            result << "C_String & " ;
            result << function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (47)).stringValue () ;
            result << ",\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
          }else if (kBoolFalse == test_5) {
          }
          ...
          result << " * inCompiler) ;\n"
            "\n" ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (51)).reader_string (SOURCE_FILE_AT_LINE (51)).objectCompare (enumerator_497.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (51)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            result << "//--- Start symbol\n"
              "  public : static void _performSourceFileParsing_" ;
            result << enumerator_1149.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (53)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            if (kBoolTrue == test_7) {
              result << "C_String & " ;
              result << function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (56)).stringValue () ;
              result << ",\n" ;
              result.appendSpacesUntilColumn (columnMarker) ;
            }else if (kBoolFalse == test_7) {
            }
            ...
            if (enumerator_1149.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_2923.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_2923.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (61)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  result << "const GALGAS_" ;
                  result << enumerator_2923.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2923_IDX.reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_2923.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (63)))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    result << "GALGAS_" ;
                    result << enumerator_2923.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2923_IDX.reader_string (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                  }else if (kBoolFalse == test_9) {
                    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_2923.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (65)))).boolEnum () ;
                    if (kBoolTrue == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2923.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2923_IDX.reader_string (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                    }else if (kBoolFalse == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2923.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (68)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2923_IDX.reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
                    }
                  }
                }
            ...
            result << "COMMA_LOCATION_ARGS) ;\n"
              "\n"
              "  public : static void _performSourceStringParsing_" ;
            result << enumerator_1149.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (72)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            if (kBoolTrue == test_11) {
              result << "C_String & " ;
              result << function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).stringValue () ;
              result << ",\n" ;
              result.appendSpacesUntilColumn (columnMarker) ;
            }else if (kBoolFalse == test_11) {
            }
            ...
            if (enumerator_1149.current_mFormalParametersList (HERE).isValid ()) {
              ...
              while (enumerator_4192.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_4192.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (80)))).boolEnum () ;
                if (kBoolTrue == test_12) {
                  result << "const GALGAS_" ;
                  result << enumerator_4192.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
                  result << " inArgument" ;
                  result << index_4192_IDX.reader_string (SOURCE_FILE_AT_LINE (81)).stringValue () ;
                }else if (kBoolFalse == test_12) {
                  const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_4192.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (82)))).boolEnum () ;
                  if (kBoolTrue == test_13) {
                    result << "GALGAS_" ;
                    result << enumerator_4192.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (83)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_4192_IDX.reader_string (SOURCE_FILE_AT_LINE (83)).stringValue () ;
                  }else if (kBoolFalse == test_13) {
                    const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_4192.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (84)))).boolEnum () ;
                    if (kBoolTrue == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4192.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (85)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_4192_IDX.reader_string (SOURCE_FILE_AT_LINE (85)).stringValue () ;
                    }else if (kBoolFalse == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4192.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (87)).stringValue () ;
                      result << " inArgument" ;
                      result << index_4192_IDX.reader_string (SOURCE_FILE_AT_LINE (87)).stringValue () ;
                    }
                  }
                }
      ...
      const enumGalgasBool test_15 = in_HAS_5F_INDEXING.operator_and (GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (94)).reader_string (SOURCE_FILE_AT_LINE (94)).objectCompare (enumerator_497.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (94)))) COMMA_SOURCE_FILE_AT_LINE (94)).boolEnum () ;
      if (kBoolTrue == test_15) {
        result << "//--- Start symbol indexing\n"
          "  public : static void performIndexing (" ;
        columnMarker = result.currentColumn () ;
  ...
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    ...
    while (enumerator_5426.hasCurrentObject ()) {
      result << "  public : virtual int32_t select_" ;
      result << enumerator_5426.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (102)).stringValue () ;
      result << "_" ;
      result << enumerator_5426.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (102)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (460)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (460)) ;
  ...
  if (NULL != objectArray_18617) {
    ...
    cGrammar_grammarLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_18781, constinArgument_inSourceFile, outArgument_outGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (464)) ;
    {
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_basename, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (466)), constinArgument_inSourceFile, outArgument_outGrammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (465)) ;
    }
  }
}
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectoryForHTMLFile = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (508)) ;
  GALGAS_lstring var_grammarComponentName = constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName ;
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (511)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (511)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_grammarComponentName.reader_string (SOURCE_FILE_AT_LINE (512)).objectCompare (var_basename)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (var_grammarComponentName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_grammarComponentName.reader_string (SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (514)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (514)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (515)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (513)) ;
  }
  GALGAS_terminalSymbolsMapForGrammarAnalysis var_actuallyUsedTerminalSymbolMap = GALGAS_terminalSymbolsMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (519)) ;
  GALGAS_nonTerminalSymbolMapForGrammarAnalysis var_nonTerminalMapForGrammarAnalysis = GALGAS_nonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (520)) ;
  GALGAS_string var_lexiqueComponentName = GALGAS_string::makeEmptyString () ;
  GALGAS_lstring var_lexiqueComponentPath = GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE_AT_LINE (522)) ;
  GALGAS_syntaxComponentListForGrammarAnalysis var_syntaxComponentListForGrammarAnalysis = GALGAS_syntaxComponentListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (523)) ;
  GALGAS_nonTerminalToAddList var_nonTerminalToAddList = GALGAS_nonTerminalToAddList::constructor_emptyList (SOURCE_FILE_AT_LINE (524)) ;
  GALGAS_uint var_addedNonTerminalCount = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_lstringlist enumerator_21984 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (526)), kEnumeration_up) ;
  while (enumerator_21984.hasCurrentObject ()) {
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_21984.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (528)).objectCompare (GALGAS_string ("gSyntax"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_21984.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("a syntax component file should have '.gSyntax' path extension") COMMA_SOURCE_FILE_AT_LINE (529)) ;
    }else if (kBoolFalse == test_2) {
      GALGAS_string var_syntaxComponentName = enumerator_21984.current_mValue (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (531)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (531)) ;
      GALGAS_galgas_33_SyntaxComponentListAST_2E_element var_syntaxComponentRoot ;
      const enumGalgasBool test_4 = ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (533)).reader_hasKey (var_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_lstring joker_22575_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (534)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (534)), joker_22575_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
      }else if (kBoolFalse == test_4) {
        GALGAS_string var_sourceFilePath = enumerator_21984.current_mValue (HERE).mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (536)) COMMA_SOURCE_FILE_AT_LINE (536)) ;
        GALGAS_lstring var_lSourceFilePath = GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_21984.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (537)) COMMA_SOURCE_FILE_AT_LINE (537)) ;
        var_syntaxComponentRoot.drop () ;
        C_String syntaxDirectedTranslationResult_22860 ;
        cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_22860, var_lSourceFilePath, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (538)) ;
        {
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_21984.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (539)) COMMA_SOURCE_FILE_AT_LINE (539)), var_lSourceFilePath, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
        }
      }
      const enumGalgasBool test_5 = constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_and (var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (542)) COMMA_SOURCE_FILE_AT_LINE (542)).boolEnum () ;
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("as '").operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (543)).operator_concat (GALGAS_string ("' grammar declares 'translate' feature, this syntax component should do so") COMMA_SOURCE_FILE_AT_LINE (543)) COMMA_SOURCE_FILE_AT_LINE (543)) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_7 = var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (544)) COMMA_SOURCE_FILE_AT_LINE (544)).boolEnum () ;
        if (kBoolTrue == test_7) {
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("as '").operator_concat (var_syntaxComponentRoot.mAttribute_mSyntaxComponentName.reader_string (SOURCE_FILE_AT_LINE (545)) COMMA_SOURCE_FILE_AT_LINE (545)).operator_concat (GALGAS_string ("' syntax component declares 'translate' feature, this grammar should do so") COMMA_SOURCE_FILE_AT_LINE (545)) COMMA_SOURCE_FILE_AT_LINE (545)) ;
        }
      }
      var_lexiqueComponentPath = var_syntaxComponentRoot.reader_mImportedLexiqueFilePath (SOURCE_FILE_AT_LINE (548)) ;
      GALGAS_string var_currentLexiqueName = var_lexiqueComponentPath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (549)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (549)) ;
      ...
      if (kBoolTrue == test_9) {
        ...
        if (kBoolTrue == test_10) {
          ...
          inCompiler->emitSemanticError (location_11, GALGAS_string ("this syntax component uses '").operator_concat (var_currentLexiqueName COMMA_SOURCE_FILE_AT_LINE (553)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '") COMMA_SOURCE_FILE_AT_LINE (554)).operator_concat (var_lexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (554)).operator_concat (GALGAS_string ("' lexique component (they should be the same)") COMMA_SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (553)) ;
        }
      }
      {
      routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mNonterminalDeclarationList (SOURCE_FILE_AT_LINE (560)), inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
      }
      {
      routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (565)), inCompiler COMMA_SOURCE_FILE_AT_LINE (563)) ;
      }
      {
      routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mSyntaxComponentName (SOURCE_FILE_AT_LINE (570)), var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (571)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
      }
      ...
      if (var_addedNonTerminalCount.isValid ()) {
        ...
        while (loop_25101) {
          loop_25101 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)))).isValid () ;
          if (loop_25101) {
            loop_25101 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)))).boolValue () ;
          }
          if (loop_25101 && (0 == variant_25101)) {
            loop_25101 = false ;
            inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (577)) ;
          }
          if (loop_25101) {
            variant_25101 -- ;
            var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i COMMA_SOURCE_FILE_AT_LINE (578)) ;
            var_i.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
          }
        }
      }
    }
  ...
  {
  routine_parseLexiqueComponent (GALGAS_lstring::constructor_new (var_lexiqueComponentPath.mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)), var_lexiqueComponentPath.reader_location (SOURCE_FILE_AT_LINE (586)) COMMA_SOURCE_FILE_AT_LINE (586)), ioArgument_ioParsedComponentStruct, var_lexiqueComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (585)) ;
  }
  GALGAS_bool var_hasIndexing = var_lexiqueComponentAST.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (590)).mAttribute_location.reader_isNowhere (SOURCE_FILE_AT_LINE (590)).operator_not (SOURCE_FILE_AT_LINE (590)) ;
  const enumGalgasBool test_12 = var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (591)) COMMA_SOURCE_FILE_AT_LINE (591)).boolEnum () ;
  if (kBoolTrue == test_12) {
    ...
    inCompiler->emitSemanticError (location_13, GALGAS_string ("the grammar does not enable indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592)).operator_concat (GALGAS_string ("' does") COMMA_SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592)) ;
  }else if (kBoolFalse == test_12) {
    const enumGalgasBool test_14 = var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (593)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (593)).boolEnum () ;
    if (kBoolTrue == test_14) {
      ...
      inCompiler->emitSemanticError (location_15, GALGAS_string ("the grammar enables indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (594)) COMMA_SOURCE_FILE_AT_LINE (594)).operator_concat (GALGAS_string ("' does not") COMMA_SOURCE_FILE_AT_LINE (594)) COMMA_SOURCE_FILE_AT_LINE (594)) ;
    }
  }
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap ;
  GALGAS_uint var_startSymbolIndex ;
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (600)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  {
  routine_checkLabelMap (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (603)).reader_location (SOURCE_FILE_AT_LINE (603)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (604)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (605)).reader_string (SOURCE_FILE_AT_LINE (605)), inCompiler COMMA_SOURCE_FILE_AT_LINE (605)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (609)) ;
  cEnumerator_lstringlist enumerator_27129 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (610)), kEnumeration_up) ;
  while (enumerator_27129.hasCurrentObject ()) {
    ...
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_27129.current_mValue (HERE), var_nonterminalIndex, joker_27237_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (612)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_27129.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
    }
    enumerator_27129.gotoNextObject () ;
  }
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (616)) ;
  ...
  while (enumerator_27594.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_27594.current_lkey (HERE), enumerator_27594.current_mNonTerminalIndex (HERE), enumerator_27594.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (618)) ;
  ...
  if (kBoolTrue == test_17) {
    temp_16 = function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (635)) ;
  }else if (kBoolFalse == test_17) {
    temp_16 = GALGAS_string::makeEmptyString () ;
  }
  routine_grammarAnalysisAndGeneration (GALGAS_bool (false), constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName, constinArgument_inGrammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (624)), var_startSymbolIndex, var_lexiqueComponentName, constinArgument_inGrammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (627)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectoryForCppFiles, var_outputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, temp_16, inCompiler COMMA_SOURCE_FILE_AT_LINE (621)) ;
  }
  const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (638)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_18) {
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (inCompiler, constinArgument_inGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (639))) ;
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (inCompiler, var_lexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (643)), constinArgument_inGrammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (642))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectoryForCppFiles, constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (651)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (649)) ;
    }
  }
}
...
void routine_compileGrammarComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  {
  routine_parseGrammarComponent (constinArgument_inSourceFile, ioArgument_ioParsedComponentStruct, var_grammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) ;
  }
  {
  routine_compileGrammarComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectoryForCppFiles, var_grammarComponentRoot, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) ;
  }
}
...
void routine_compileGrammarComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectoryForHTMLFile = constinArgument_inOutputDirectory.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (691)) ;
  GALGAS_terminalSymbolsMapForGrammarAnalysis var_actuallyUsedTerminalSymbolMap = GALGAS_terminalSymbolsMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (693)) ;
  GALGAS_nonTerminalSymbolMapForGrammarAnalysis var_nonTerminalMapForGrammarAnalysis = GALGAS_nonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (694)) ;
  GALGAS_lstring var_lexiqueComponentName = GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE_AT_LINE (695)) ;
  GALGAS_syntaxComponentListForGrammarAnalysis var_syntaxComponentListForGrammarAnalysis = GALGAS_syntaxComponentListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (696)) ;
  GALGAS_nonTerminalToAddList var_nonTerminalToAddList = GALGAS_nonTerminalToAddList::constructor_emptyList (SOURCE_FILE_AT_LINE (697)) ;
  GALGAS_uint var_addedNonTerminalCount = GALGAS_uint ((uint32_t) 0U) ;
  ...
  while (enumerator_31076.hasCurrentObject ()) {
    ...
    constinArgument_inParsedSyntaxComponentMap.method_searchKey (enumerator_31076.current_mValue (HERE), joker_31251_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
    const enumGalgasBool test_0 = constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_and (var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (704)) COMMA_SOURCE_FILE_AT_LINE (704)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (location_1, GALGAS_string ("as '").operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE_AT_LINE (705)) COMMA_SOURCE_FILE_AT_LINE (705)).operator_concat (GALGAS_string ("' grammar declares 'translate' feature, this syntax component should do so") COMMA_SOURCE_FILE_AT_LINE (705)) COMMA_SOURCE_FILE_AT_LINE (705)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_2 = var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (706)) COMMA_SOURCE_FILE_AT_LINE (706)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ...
        inCompiler->emitSemanticError (location_3, GALGAS_string ("as '").operator_concat (var_syntaxComponentRoot.mAttribute_mSyntaxComponentName.reader_string (SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)).operator_concat (GALGAS_string ("' syntax component declares 'translate' feature, this grammar should do so") COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
      }
    }
    ...
    if (kBoolTrue == test_4) {
      ...
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("this syntax component uses '").operator_concat (var_currentLexiqueName.reader_string (SOURCE_FILE_AT_LINE (714)) COMMA_SOURCE_FILE_AT_LINE (714)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '") COMMA_SOURCE_FILE_AT_LINE (715)).operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)).operator_concat (GALGAS_string ("' lexique component (they should be the same)") COMMA_SOURCE_FILE_AT_LINE (716)) COMMA_SOURCE_FILE_AT_LINE (714)) ;
      }
    }
    {
    routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mNonterminalDeclarationList (SOURCE_FILE_AT_LINE (721)), inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
    }
    {
    routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (726)), inCompiler COMMA_SOURCE_FILE_AT_LINE (724)) ;
    }
    {
    routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mSyntaxComponentName (SOURCE_FILE_AT_LINE (731)), var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (732)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (729)) ;
    }
    GALGAS_uint var_i = GALGAS_uint ((uint32_t) 0U) ;
    if (var_addedNonTerminalCount.isValid ()) {
      ...
      while (loop_33169) {
        loop_33169 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (738)))).isValid () ;
        if (loop_33169) {
          loop_33169 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (738)))).boolValue () ;
        }
        if (loop_33169 && (0 == variant_33169)) {
          loop_33169 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (738)) ;
        }
        if (loop_33169) {
          variant_33169 -- ;
          var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i COMMA_SOURCE_FILE_AT_LINE (739)) ;
          var_i.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
        }
      }
    }
    enumerator_31076.gotoNextObject () ;
  }
  GALGAS_stringset var_lexiqueComponentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (744)) ;
  ...
  constinArgument_inSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (var_lexiqueComponentName, joker_33610_0, joker_33646_0, var_inIndexingDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) ;
  GALGAS_bool var_hasIndexing = var_inIndexingDirectory.mAttribute_location.reader_isNowhere (SOURCE_FILE_AT_LINE (751)).operator_not (SOURCE_FILE_AT_LINE (751)) ;
  const enumGalgasBool test_7 = var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_location location_8 (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("the grammar does not enable indexing, but the '").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)).operator_concat (GALGAS_string ("' does") COMMA_SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)) ;
  }else if (kBoolFalse == test_7) {
    const enumGalgasBool test_9 = var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (754)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (754)).boolEnum () ;
    if (kBoolTrue == test_9) {
      ...
      inCompiler->emitSemanticError (location_10, GALGAS_string ("the grammar enables indexing, but the '").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string ("' does not") COMMA_SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)) ;
    }
  }
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap ;
  GALGAS_uint var_startSymbolIndex ;
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (761)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) ;
  {
  routine_checkLabelMap (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (764)).reader_location (SOURCE_FILE_AT_LINE (764)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (765)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (766)).reader_string (SOURCE_FILE_AT_LINE (766)), inCompiler COMMA_SOURCE_FILE_AT_LINE (766)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
  }
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (770)) ;
  cEnumerator_lstringlist enumerator_35090 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (771)), kEnumeration_up) ;
  while (enumerator_35090.hasCurrentObject ()) {
    ...
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_35090.current_mValue (HERE), var_nonterminalIndex, joker_35198_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (773)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_35090.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (774)) ;
    }
    enumerator_35090.gotoNextObject () ;
  }
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (777)) ;
  ...
  while (enumerator_35555.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_35555.current_lkey (HERE), enumerator_35555.current_mNonTerminalIndex (HERE), enumerator_35555.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (779)) ;
    enumerator_35555.gotoNextObject () ;
  }
  ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("grammar-").add_operation (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (782)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE_AT_LINE (782)) COMMA_SOURCE_FILE_AT_LINE (782)) ;
  {
  GALGAS_string temp_11 ;
  const enumGalgasBool test_12 = constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.boolEnum () ;
  if (kBoolTrue == test_12) {
    temp_11 = function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) ;
  }else if (kBoolFalse == test_12) {
    temp_11 = GALGAS_string::makeEmptyString () ;
  }
  routine_grammarAnalysisAndGeneration (GALGAS_bool (true), constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName, constinArgument_inGrammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (786)), var_startSymbolIndex, var_lexiqueComponentName.mAttribute_string, constinArgument_inGrammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (789)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectory, var_outputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, temp_11, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)) ;
  }
  const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (800)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_13) {
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_HeaderGalgas_33_ (inCompiler, constinArgument_inGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (801))) ;
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_HeaderGalgas_33_ (inCompiler, var_lexiqueComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (805)), constinArgument_inGrammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (804))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("grammar-").operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (813)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (813)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
    }
  }
}
