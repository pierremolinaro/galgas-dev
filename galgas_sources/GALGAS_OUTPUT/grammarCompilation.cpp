...
if (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (563)).isBuilt () &&
    var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (564)).isBuilt () &&
    var_cas_startSymbolIndex.isBuilt () &&
    var_cas_lexiqueComponentName.isBuilt () &&
    var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (567)).isBuilt () &&
  ...
  ::routine_grammarAnalysisAndGeneration (inLexique,  var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (563)),  var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (564)),  var_cas_startSymbolIndex,  var_cas_lexiqueComponentName,  var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (567)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_unusedNonTerminalSymbolsForGrammar,  var_cas_inOutputDirectoryForCppFiles,  var_cas_inOutputDirectoryForHTMLFile COMMA_SOURCE_FILE_AT_LINE (562)) ;
}
const GGS_bool cond_26139 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (576))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26139.isBuiltAndTrue ()) {
const GGS_bool cond_25478 = (var_cas_inGenerateGALGAS1Code).operator_not () ;
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (589)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (587)) ;
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (608)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (608))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (606)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
