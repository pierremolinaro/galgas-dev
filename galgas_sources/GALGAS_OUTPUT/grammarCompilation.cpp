...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  GGS_productionRuleListForGrammarAnalysis  var_cas_productionRulesList = GGS_productionRuleListForGrammarAnalysis ::constructor_emptyList () ;
  {
    ...
    while (((operand_15330 = enumerator_15330.nextObject ()))) {
      ...
      GGS_lstring  automatic_var_15729_0 ;
      GGS_formalParameterListAST  automatic_var_15729_1 ;
      GGS_location  automatic_var_15729_2 ;
      if (operand_15330->mLabelList.isBuilt ()) {
        operand_15330->mLabelList (HERE)->method_first (inLexique, automatic_var_15729_0, automatic_var_15729_1, automatic_var_15729_2, var_cas_parsedSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
...
template_filewrapper_grammarGenerationTemplate_grammarZone3Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_427 = enumerator_427.nextObject ()))) {
      ...
      while (((operand_490 = enumerator_490.nextObject ()))) {
        ...
        result << " * inCompiler" ;
        GGS_signatureForGrammarAnalysis::cEnumerator enumerator_693 (operand_490->mInfo.mFormalParametersList, true) ;
        const GGS_signatureForGrammarAnalysis::cElement * operand_693 = NULL ;
        { GGS_uint var_cas_IDX (true, 0) ;
      while (((operand_693 = enumerator_693.nextObject ()))) {
        macroValidPointer (operand_693) ;
        result << ",\n" ;
        result.appendSpacesUntilColumn (columnMarker) ;
        if ((operand_693->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (15))).boolValue ()) {
          result << "GALGAS_" ;
          result << operand_693->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " * const inArgument" ;
          result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
        }else if ((operand_693->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).boolValue ()) {
          result << "GALGAS_" ;
          result << operand_693->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " * & ioArgument" ;
          result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
        }else if ((operand_693->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (19))).boolValue ()) {
          result << "GALGAS_" ;
          result << operand_693->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " * & outArgument" ;
    ...
    if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).operator_isEqual (operand_427->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).boolValue ()) {
      ...
      result << "const C_String & inDependancyPath,\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      result << "GALGAS_string * inSentStringPtr,\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      result << "GALGAS_lstring * const inFileName" ;
      GGS_signatureForGrammarAnalysis::cEnumerator enumerator_2011 (operand_490->mInfo.mFormalParametersList, true) ;
      const GGS_signatureForGrammarAnalysis::cElement * operand_2011 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_2011 = enumerator_2011.nextObject ()))) {
      macroValidPointer (operand_2011) ;
      result << ",\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      if ((operand_2011->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (34))).boolValue ()) {
        result << "GALGAS_" ;
        result << operand_2011->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " * const inArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (35)) ;
      }else if ((operand_2011->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (36))).boolValue ()) {
        result << "GALGAS_" ;
        result << operand_2011->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " * & ioArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (37)) ;
      }else if ((operand_2011->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (38))).boolValue ()) {
        result << "GALGAS_" ;
        result << operand_2011->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " * & outArgument" ;
  ...
  result << "C_Compiler * inCompiler,\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  result << "GALGAS_string * const inSourceString" ;
  GGS_signatureForGrammarAnalysis::cEnumerator enumerator_3159 (operand_490->mInfo.mFormalParametersList, true) ;
  const GGS_signatureForGrammarAnalysis::cElement * operand_3159 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3159 = enumerator_3159.nextObject ()))) {
  macroValidPointer (operand_3159) ;
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  if ((operand_3159->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (49))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3159->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * const inArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (50)) ;
  }else if ((operand_3159->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (51))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3159->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * & ioArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) ;
  }else if ((operand_3159->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (53))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_3159->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " * & outArgument" ;
...
result << "\n" ;
GGS_nonTerminalToAddList::cEnumerator enumerator_4160 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
const GGS_nonTerminalToAddList::cElement * operand_4160 = NULL ;
while (((operand_4160 = enumerator_4160.nextObject ()))) {
macroValidPointer (operand_4160) ;
result << "  public : virtual PMSInt32 select_" ;
result << operand_4160->mSyntaxComponentName.reader_identifierRepresentation () ;
result << "_" ;
result << operand_4160->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
result << " (C_Lexique_" ;
result << var_cas_LEXIQUE_IDENTIFIER ;
result << " *) ;\n" ;
if (enumerator_4160.hasNextObject ()) {
result << "\n" ;
}
}
result << "} ;\n"
...
elementOf_GGS_parsedGrammarComponentMap * operand_18436 = (elementOf_GGS_parsedGrammarComponentMap *) var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.searchForReadWithInstruction (var_cas_basename) ;
if (NULL != operand_18436) {
var_cas_outGrammarComponentRoot = operand_18436->mInfo.mGrammarComponentRoot ;
}else{
...
const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_20007 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (481))).operator_isNotEqual (var_cas_basename) ;
if (cond_20007.isBuiltAndTrue ()) {
...
{
GGS_lstringlist::cEnumerator enumerator_20536 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), true) ;
const GGS_lstringlist::cElement * operand_20536 = NULL ;
while (((operand_20536 = enumerator_20536.nextObject ()))) {
  macroValidPointer (operand_20536) ;
const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
const GGS_bool cond_20840 = ((operand_20536->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20536->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
if (cond_20840.isBuiltAndTrue ()) {
operand_20536->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (498)) ;
}else if (cond_20840.isBuiltAndFalse ()) {
GGS_string var_cas_syntaxComponentName = operand_20536->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
GGS_syntaxComponentAST var_cas_syntaxComponentRoot ;
const GGS_bool cond_21231 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)).reader_hasKey (var_cas_syntaxComponentName) ;
if (cond_21231.isBuiltAndTrue ()) {
const GGS_parsedSyntaxComponentMap  temp_21153 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)) ;
if (temp_21153.isBuilt ()) {
  temp_21153 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (502)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (502)) ;
}
}else if (cond_21231.isBuiltAndFalse ()) {
GGS_string var_cas_sourceFilePath = operand_20536->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
const GGS_string _depExtension = GGS_string ("") ;
const GGS_string _depPath = GGS_string ("") ;
if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
  C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                ...
                                _depPath.string (),
                                NULL,
                                GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20536->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)),
                                var_cas_syntaxComponentRoot
                                COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20536->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (506)) ;
}
...
const GGS_bool cond_21900 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
if (cond_21900.isBuiltAndTrue ()) {
var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
}else if (cond_21900.isBuiltAndFalse ()) {
const GGS_bool cond_22195 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
if (cond_22195.isBuiltAndTrue ()) {
operand_20536->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (516)) ;
}
}
...
GGS_uint _variant_22902 = var_cas_addedNonTerminalCount ;
GGS_bool _condition_22902 (_variant_22902.isBuilt (), true) ;
while (_condition_22902.isBuiltAndTrue ()) {
  _condition_22902 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (532))) ;
  if (_condition_22902.isBuiltAndTrue ()) {
    if (_variant_22902.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (535)) ;
      _condition_22902 = GGS_bool (false) ;
    }else{
      _variant_22902.decrement_operation (inLexique COMMA_HERE) ;
...
{
GGS_lstringlist::cEnumerator enumerator_23803 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), true) ;
const GGS_lstringlist::cElement * operand_23803 = NULL ;
while (((operand_23803 = enumerator_23803.nextObject ()))) {
  macroValidPointer (operand_23803) ;
GGS_uint  var_cas_nonterminalIndex ;
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23957_0 ;
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23803->mValue, var_cas_nonterminalIndex, automatic_var_23957_0 COMMA_SOURCE_FILE_AT_LINE (555)) ;
}
var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23803->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (556)) ;
}
}
...
const GGS_bool cond_26033 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (573))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26033.isBuiltAndTrue ()) {
const GGS_bool cond_25372 = gOption_galgas_5F_cli_5F_options_newCodeGeneration.reader_value () ;
if (cond_25372.isBuiltAndTrue ()) {
...
}else if (cond_25372.isBuiltAndFalse ()) {
