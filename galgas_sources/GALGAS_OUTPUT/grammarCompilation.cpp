...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_syntaxRuleListForGrammar  var_cas_syntaxRuleListForGrammar = GGS_syntaxRuleListForGrammar ::constructor_emptyList () ;
  {
    ...
    while (((operand_23488 = enumerator_23488.nextObject ()))) {
      ...
      if (((operand_23488->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (593))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        ...
        GGS_string var_cas_syntaxComponentName = operand_23488->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (596)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (598)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (598))).isBuiltAndTrue ()) {
          ...
          GGS_string var_cas_sourceFilePath = operand_23488->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
  ...
  GGS_string var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (674))).operator_concat (GGS_string (".html")) ;
  ...
  GGS_uint  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (686)) ;
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_28055 = enumerator_28055.nextObject ()))) {
      ...
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_28055->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (699)) ;
      GGS_uintlist  var_cas_previousDerivationsIndexes = var_cas_productionIndexListMap.reader_listForKey (inLexique, operand_28055->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (700)) COMMA_SOURCE_FILE_AT_LINE (700)) ;
  ...
  GGS_binaryset var_cas_startSymbol = GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (750)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (750)) COMMA_HERE) ;
  GGS_binaryset var_cas_usefulSymbols = var_cas_elementaryUtility.reader_accessibleStates (inLexique, var_cas_startSymbol, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (751)) ;
  GGS_binaryset var_cas_allSymbols = GGS_binaryset::constructor_binarySetWithLowerOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (752)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_HERE) ;
  GGS_binaryset var_cas_unusefulSymbols = (var_cas_allSymbols).operator_and ((var_cas_usefulSymbols).operator_tilde ()) ;
  GGS_stringlist  var_cas_unusefulSymbolList = var_cas_unusefulSymbols.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (754)) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
  ...
  if (((var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (758))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = ((GGS_string ("the grammar contains ")).operator_concat (var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (759)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (759)))).operator_concat (GGS_string (" useless symbol(s): ")) ;
    {
