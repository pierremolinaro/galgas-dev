...
template_filewrapper_grammarGenerationTemplates_html (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_2449 = enumerator_2449.nextObject ()))) {
      ...
      result << "'</td><td><code>" ;
      GGS_syntaxInstructionList::cEnumerator enumerator_2668 (operand_2449->mSyntaxInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_2668 = NULL ;
      while (((operand_2668 = enumerator_2668.nextObject ()))) {
        macroValidPointer (operand_2668) ;
        result << (findCategoryReader__syntaxInstruction__htmlListing (operand_2668->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_2668->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (112))) ;
      }
      result << "</code></td></tr>" ;
    }
    result << "\n"
    ...
    result << var_cas_PURE_SYNTAX_RULE_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (123)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (123)) ;
    result << " BNF productions :</p>\n"
      "<table class=\"result\">\n" ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_3025 (var_cas_PURE_SYNTAX_RULE_LIST, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_3025 = NULL ;
    while (((operand_3025 = enumerator_3025.nextObject ()))) {
      macroValidPointer (operand_3025) ;
      result << "<tr class=\"result_line\"><td class=\"result_line\">rule <code>&lt;" ;
      result << operand_3025->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
      result << "&gt;</code><br>" ;
      result << operand_3025->mLeftNonTerminal.reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (127)) ;
      result << "'</td><td><code>" ;
      GGS_syntaxInstructionList::cEnumerator enumerator_3244 (operand_3025->mSyntaxInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_3244 = NULL ;
      while (((operand_3244 = enumerator_3244.nextObject ()))) {
        macroValidPointer (operand_3244) ;
        result << (findCategoryReader__syntaxInstruction__htmlListing (operand_3244->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_3244->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (130))) ;
      }
      result << "</code></td></tr>" ;
    }
    result << "\n"
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_14508 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_14508 = NULL ;
    while (((operand_14508 = enumerator_14508.nextObject ()))) {
      ...
      const GGS_syntaxRuleLabelList  temp_14650 = operand_14508->mLabelList ;
      if (temp_14650.isBuilt ()) {
        temp_14650 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (363)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ::routine_buildSyntaxInstructionList (inLexique,  var_cas_instructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (365)) ;
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (operand_14508->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildPureSyntaxInstructionList (C_Compiler & inLexique,
                                const GGS_lstring   var_cas_inCurrentLeftNonTerminal,
  ...
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_16008 (var_cas_inSyntaxInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_16008 = NULL ;
    while (((operand_16008 = enumerator_16008.nextObject ()))) {
      macroValidPointer (operand_16008) ;
      GGS_syntaxInstruction  var_cas_pureSyntaxInstruction ;
      const GGS_syntaxInstruction  temp_16103 = operand_16008->mInstruction ;
      if (temp_16103.isBuilt ()) {
        typeCategoryMethod__syntaxInstruction__buildPureSyntaxInstruction method = findCategoryMethod__syntaxInstruction__buildPureSyntaxInstruction (temp_16103.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_16103 (HERE), var_cas_inCurrentLeftNonTerminal, var_cas_ioPureSyntaxRuleListForGrammar, var_cas_pureSyntaxInstruction, var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (395)) ;
        }
      }
      var_cas_outPureSyntaxInstructionList.addAssign_operation (var_cas_pureSyntaxInstruction) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__semanticInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_semanticInstruction * operand_16634,
                                const GGS_lstring   /* var_cas_inCurrentLeftNonTerminal */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16634 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (416)) ;
    var_cas_outPureSyntaxInstruction.drop () ;
  }
}
...
category_method__nonterminalCallInstruction__buildPureSyntaxInstruction (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_17080,
                                const GGS_lstring   /* var_cas_inCurrentLeftNonTerminal */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17080 != NULL) {
    var_cas_outPureSyntaxInstruction = operand_17080 ;
  }
}
...
category_method__terminalCheckInstruction__buildPureSyntaxInstruction (C_Compiler &,
                                const cPtr_terminalCheckInstruction * operand_17482,
                                const GGS_lstring   /* var_cas_inCurrentLeftNonTerminal */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17482 != NULL) {
    var_cas_outPureSyntaxInstruction = operand_17482 ;
  }
}
...
category_method__repeatInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_17877,
                                const GGS_lstring   var_cas_inCurrentLeftNonTerminal,
                                GGS_syntaxRuleListForGrammar  & var_cas_ioPureSyntaxRuleListForGrammar,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & var_cas_ioAddedNonTerminalCount
  ...
  if (operand_17877 != NULL) {
    GGS_lstring  var_cas_selectRepeatAddedNonTerminal ;
    var_cas_selectRepeatAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, (((GGS_string ("select_repeat_")).operator_concat (var_cas_inCurrentLeftNonTerminal)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedNonTerminalCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (450))), var_cas_inCurrentLeftNonTerminal.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (451)) COMMA_HERE) ;
    var_cas_ioAddedNonTerminalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (453)) ;
    GGS_lstring  var_cas_repeatAddedNonTerminal ;
    var_cas_repeatAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, (((GGS_string ("repeat_")).operator_concat (var_cas_inCurrentLeftNonTerminal)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedNonTerminalCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (455))), var_cas_inCurrentLeftNonTerminal.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (456)) COMMA_HERE) ;
    var_cas_ioAddedNonTerminalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
    var_cas_outPureSyntaxInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_selectRepeatAddedNonTerminal, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE) ;
    GGS_syntaxInstructionList  var_cas_repeatedPureInstructionList ;
    ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inCurrentLeftNonTerminal,  operand_17877->mRepeatedInstructionList,  var_cas_repeatedPureInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (467)) ;
    var_cas_repeatedPureInstructionList.addAssign_operation (GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_repeatAddedNonTerminal, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE)) ;
    var_cas_ioPureSyntaxRuleListForGrammar.addAssign_operation (var_cas_selectRepeatAddedNonTerminal, var_cas_repeatedPureInstructionList) ;
    var_cas_ioPureSyntaxRuleListForGrammar.addAssign_operation (var_cas_repeatAddedNonTerminal, GGS_syntaxInstructionList ::constructor_emptyList ()) ;
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_19504 (operand_17877->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_19504 = NULL ;
      while (((operand_19504 = enumerator_19504.nextObject ()))) {
        macroValidPointer (operand_19504) ;
        GGS_syntaxInstructionList  var_cas_pureInstructionList ;
        ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inCurrentLeftNonTerminal,  operand_19504->mSyntaxInstructionList,  var_cas_pureInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (491)) ;
        ...
        var_cas_ioPureSyntaxRuleListForGrammar.addAssign_operation (var_cas_repeatAddedNonTerminal, var_cas_pureInstructionList) ;
      }
    }
  }
}
...
category_method__selectInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_20217,
                                const GGS_lstring   var_cas_inCurrentLeftNonTerminal,
                                GGS_syntaxRuleListForGrammar  & var_cas_ioPureSyntaxRuleListForGrammar,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & var_cas_ioAddedNonTerminalCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20217 != NULL) {
    GGS_lstring  var_cas_selectAddedNonTerminal ;
    var_cas_selectAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, (((GGS_string ("select_")).operator_concat (var_cas_inCurrentLeftNonTerminal)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedNonTerminalCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (519))), var_cas_inCurrentLeftNonTerminal.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (520)) COMMA_HERE) ;
    var_cas_ioAddedNonTerminalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (522)) ;
    var_cas_outPureSyntaxInstruction = GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_selectAddedNonTerminal, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE) ;
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_20803 (operand_20217->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_20803 = NULL ;
      while (((operand_20803 = enumerator_20803.nextObject ()))) {
        macroValidPointer (operand_20803) ;
        GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
        ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inCurrentLeftNonTerminal,  operand_20803->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (530)) ;
        var_cas_ioPureSyntaxRuleListForGrammar.addAssign_operation (var_cas_selectAddedNonTerminal, var_cas_pureSyntaxInstructionList) ;
      }
    }
  }
}
...
category_method__parseDoInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_21348,
                                const GGS_lstring   /* var_cas_inCurrentLeftNonTerminal */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21348 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (553)) ;
    var_cas_outPureSyntaxInstruction.drop () ;
  }
}
...
category_method__blockInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_21784,
                                const GGS_lstring   /* var_cas_inCurrentLeftNonTerminal */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstruction  & var_cas_outPureSyntaxInstruction,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21784 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (564)) ;
    var_cas_outPureSyntaxInstruction.drop () ;
  }
}
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (576)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (577)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (577)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (578))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (580)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (582)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23028 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (587)), true) ;
    const GGS_lstringlist::cElement * operand_23028 = NULL ;
    while (((operand_23028 = enumerator_23028.nextObject ()))) {
      macroValidPointer (operand_23028) ;
      if (((operand_23028->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (588))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_23028->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (590)) ;
      }else{
        GGS_string var_cas_syntaxComponentName ;
        var_cas_syntaxComponentName = operand_23028->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (591)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (591)) ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (593)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (593))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_23530 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (594)) ;
          if (temp_23530.isBuilt ()) {
            temp_23530 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (594)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath ;
          var_cas_sourceFilePath = operand_23028->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_23028->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (597)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (597)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_23028->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (598)) ;
        }
        GGS_string var_cas_currentLexiqueName ;
        var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (601)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (601)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (601)) ;
        if (((var_cas_lexiqueComponent).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_23028->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponent)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (608)) ;
        }
        GGS_nonTerminalMap  var_cas_nonTerminalMap ;
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMap,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (613)) COMMA_SOURCE_FILE_AT_LINE (611)) ;
        ::routine_buildRuleList (inLexique,  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (617)),  var_cas_syntaxRuleListForGrammar COMMA_SOURCE_FILE_AT_LINE (616)) ;
      }
    }
  }
  ...
  GGS_uint  var_cas_addedNonTerminalCount ;
  var_cas_addedNonTerminalCount = GGS_uint (0U) ;
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_25182 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_25182 = NULL ;
    while (((operand_25182 = enumerator_25182.nextObject ()))) {
      macroValidPointer (operand_25182) ;
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_25182->mLeftNonTerminal,  operand_25182->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (628)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_25182->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  var_cas_pureSyntaxRuleListForGrammar = (var_cas_pureSyntaxRuleListForGrammar).operator_concat (var_cas_addedPureSyntaxRuleListForGrammar) ;
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s ;
    var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (644)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar) ;
    GGS_string var_cas_htmlOutputFileName ;
    var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (648))).operator_concat (GGS_string (".html")) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_26036 = var_cas_s ;
    if (temp_26036.isBuilt ()) {
      temp_26036 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (649)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
