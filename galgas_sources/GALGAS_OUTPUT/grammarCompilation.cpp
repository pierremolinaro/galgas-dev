...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    ...
    var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (428)), var_cas_syntaxRuleListForGrammar) ;
    GGS_string var_cas_htmlOutputFileName ;
    var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (431))).operator_concat (GGS_string (".html")) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_18051 = var_cas_s ;
    if (temp_18051.isBuilt ()) {
      temp_18051 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (432)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
