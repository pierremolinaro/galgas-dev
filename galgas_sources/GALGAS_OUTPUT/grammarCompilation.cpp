...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_22477 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_22477 = NULL ;
    while (((operand_22477 = enumerator_22477.nextObject ()))) {
      macroValidPointer (operand_22477) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_22619 = operand_22477->mLabelList ;
      if (temp_22619.isBuilt ()) {
        temp_22619 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (570)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ::routine_buildSyntaxInstructionList (inLexique,  var_cas_instructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (572)) ;
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_22477->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (587)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (588)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (589))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (593)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23997 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (599)), true) ;
    const GGS_lstringlist::cElement * operand_23997 = NULL ;
    while (((operand_23997 = enumerator_23997.nextObject ()))) {
      macroValidPointer (operand_23997) ;
      if (((operand_23997->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (600))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_23997->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (602)) ;
      }else{
        GGS_string var_cas_syntaxComponentName = operand_23997->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (603)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (603)) ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (605)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (605))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_24499 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (606)) ;
          if (temp_24499.isBuilt ()) {
            temp_24499 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (606)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath = operand_23997->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (608)) COMMA_SOURCE_FILE_AT_LINE (608)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_23997->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (609)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (609)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_23997->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (610)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (610)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (613)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (613)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (613)) ;
        if (((var_cas_lexiqueComponent).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_23997->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponent)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (620)) ;
        }
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMap,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (624)) COMMA_SOURCE_FILE_AT_LINE (622)) ;
        ::routine_buildRuleList (inLexique,  var_cas_syntaxComponentName,  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (629)),  var_cas_syntaxRuleListForGrammar COMMA_SOURCE_FILE_AT_LINE (627)) ;
      }
    }
  }
  {
    GGS_lstringlist::cEnumerator enumerator_25987 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (635)), true) ;
    const GGS_lstringlist::cElement * operand_25987 = NULL ;
    while (((operand_25987 = enumerator_25987.nextObject ()))) {
      macroValidPointer (operand_25987) ;
      if (((var_cas_nonTerminalMap.reader_hasKey (inLexique, operand_25987->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636))).operator_not ()).isBuiltAndTrue ()) {
        operand_25987->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_25987->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (638)) ;
      }
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_26611 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_26611 = NULL ;
    while (((operand_26611 = enumerator_26611.nextObject ()))) {
      macroValidPointer (operand_26611) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_26611->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_26611->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_26611->mSyntaxComponentName,  operand_26611->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (652)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_26611->mSyntaxComponentName, operand_26611->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("  Building pure BNF productions... ")).operator_concat (var_cas_pureSyntaxRuleListForGrammar.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (685)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (685)))).operator_concat (GGS_string (" productions\n")) COMMA_SOURCE_FILE_AT_LINE (685)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all productions are differents...") COMMA_SOURCE_FILE_AT_LINE (690)) ;
  }
  GGS_string var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (692))).operator_concat (GGS_string (".html")) ;
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_28749 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_28749 = NULL ;
    while (((operand_28749 = enumerator_28749.nextObject ()))) {
      macroValidPointer (operand_28749) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28787 (operand_28749->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28787 = NULL ;
        while (((operand_28787 = enumerator_28787.nextObject ()))) {
          macroValidPointer (operand_28787) ;
          const GGS_syntaxInstruction  temp_28844 = operand_28787->mInstruction ;
          if (temp_28844.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_28844.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28844 (HERE), var_cas_terminalMap, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (701)) ;
            }
          }
        }
      }
  ...
  GGS_uint  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (704)) ;
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
      GGS_uint var_cas_idx (true, 0) ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_29094 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_29094 = NULL ;
    while (((operand_29094 = enumerator_29094.nextObject ()))) {
      macroValidPointer (operand_29094) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_29094->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (708)) COMMA_SOURCE_FILE_AT_LINE (708))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_29094->mLeftNonTerminal, var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (709)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (709)) COMMA_SOURCE_FILE_AT_LINE (709)) COMMA_SOURCE_FILE_AT_LINE (709)) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_29094->mLeftNonTerminal)).operator_concat (GGS_string (">"))) ;
      }
      if (((operand_29094->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (712))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
        var_cas_additionalNonTerminalSymbolsForPureBDDrules = var_cas_additionalNonTerminalSymbolsForPureBDDrules.add_operation (inLexique, operand_29094->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (713)) ;
      }
      GGS_uint64list  var_cas_rightDerivation = GGS_uint64list ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_29631 (operand_29094->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_29631 = NULL ;
        while (((operand_29631 = enumerator_29631.nextObject ()))) {
          macroValidPointer (operand_29631) ;
          const GGS_syntaxInstruction  temp_29691 = operand_29631->mInstruction ;
          if (temp_29691.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_29691.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_29691 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (717)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_29094->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (720)) COMMA_SOURCE_FILE_AT_LINE (720)) ;
      GGS_bool var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_30003 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_30003 = NULL ;
        while (((operand_30003 = enumerator_30003.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_30003) ;
          if (((operand_30003->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            var_cas_ok = GGS_bool (false) ;
            if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (725))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
              inLexique.printMessage (GGS_string (" error\n") COMMA_SOURCE_FILE_AT_LINE (726)) ;
            }
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_29094->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_30003->mProductionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (731)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (732)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_29094->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (740)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        GGS_uint  var_cas_leftTerminalIndex ;
        const GGS_vocabularyMap  temp_30954 = var_cas_nonterminalMap ;
        if (temp_30954.isBuilt ()) {
          temp_30954 (HERE)->method_searchKey (inLexique, operand_29094->mLeftNonTerminal, var_cas_leftTerminalIndex COMMA_SOURCE_FILE_AT_LINE (744)) ;
        }
        var_cas_productionListMap.addAssign_operation (operand_29094->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (745)), var_cas_leftTerminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (745)), var_cas_idx, var_cas_rightDerivation) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (748))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string (" ok\n") COMMA_SOURCE_FILE_AT_LINE (749)) ;
  }
  const GGS_uint  var_cas_terminalCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (752)) ;
  const GGS_uint  var_cas_vocabularyCount = var_cas_terminalCount.add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)).add_operation (inLexique, var_cas_additionalNonTerminalSymbolsForPureBDDrules COMMA_SOURCE_FILE_AT_LINE (753)) ;
  const GGS_uint  var_cas_startSymbolIndex = var_cas_terminalCount.add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (754)) COMMA_SOURCE_FILE_AT_LINE (754)).substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (754)) ;
  const GGS_uint  var_cas_bitCountForBDDs = var_cas_vocabularyCount.reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (755)) ;
  GGS_uint  var_cas_idx = GGS_uint (0U) ;
  GGS_uint _variant_31922 = var_cas_additionalNonTerminalSymbolsForPureBDDrules ;
  GGS_bool _condition_31922 (_variant_31922.isBuilt (), true) ;
  while (_condition_31922.isBuiltAndTrue ()) {
    _condition_31922 = (var_cas_idx).operator_strictInf (var_cas_additionalNonTerminalSymbolsForPureBDDrules) ;
    if (_condition_31922.isBuiltAndTrue ()) {
      if (_variant_31922.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (762)) ;
        _condition_31922 = GGS_bool (false) ;
      }else{
        _variant_31922.decrement_operation (inLexique COMMA_HERE) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (760)))).operator_concat (GGS_string (">"))) ;
        var_cas_idx.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (761)) ;
      }
    }
  }
  ...
  GGS_uint64  var_cas_addedNonTerminalIndex = var_cas_terminalCount.add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (768)) COMMA_SOURCE_FILE_AT_LINE (768)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (768)) ;
  {
    GGS_productionListMap::cEnumerator enumerator_32434 (var_cas_productionListMap, true) ;
    while (enumerator_32434.hasCurrentObject ()) {
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_32496 = var_cas_nonterminalMap ;
      if (temp_32496.isBuilt ()) {
        temp_32496 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_32434._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (771)) ;
      }
      {
        GGS_derivationList::cEnumerator enumerator_32563 (enumerator_32434._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_32563 = NULL ;
        while (((operand_32563 = enumerator_32563.nextObject ()))) {
          macroValidPointer (operand_32563) ;
          if (((operand_32563->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (773))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_nonTerminalsWithEmptyProduction = (var_cas_nonTerminalsWithEmptyProduction).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (775)) COMMA_HERE)) ;
          }else if (((operand_32563->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (777))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
            const GGS_uint64  var_cas_derivation0 = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (778)) ;
            var_cas_productionsWithSingleDerivation = (var_cas_productionsWithSingleDerivation).operator_or ((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (780)) COMMA_HERE)).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_derivation0 COMMA_HERE))) ;
          }else if (((operand_32563->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (783))).operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
            const GGS_uint64  var_cas_derivation0 = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (784)) ;
            const GGS_uint64  var_cas_derivation1 = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (785)) ;
            var_cas_productionsWithDoubleDerivation = (var_cas_productionsWithDoubleDerivation).operator_or (((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (787)), var_cas_bitCountForBDDs, var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (787)) COMMA_HERE)).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, var_cas_derivation0 COMMA_HERE))).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_derivation1 COMMA_HERE))) ;
          }else{
            GGS_uint64  var_cas_currentLeftNonTerminal = var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (792)) ;
            {
                GGS_uint var_cas_idx (true, 0) ;
              GGS_uint64list::cEnumerator enumerator_33959 (operand_32563->mDerivation, true) ;
              const GGS_uint64list::cElement * operand_33959 = NULL ;
              while (((operand_33959 = enumerator_33959.nextObject ()))) {
                macroValidPointer (operand_33959) ;
                if (((var_cas_idx).operator_strictInf (operand_32563->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (794)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (794)))).isBuiltAndTrue ()) {
                  const GGS_uint64  var_cas_derivation = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (795)) ;
                  var_cas_productionsWithDoubleDerivation = (var_cas_productionsWithDoubleDerivation).operator_or (((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_currentLeftNonTerminal COMMA_HERE)).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, var_cas_derivation COMMA_HERE))).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (799)), var_cas_bitCountForBDDs, var_cas_addedNonTerminalIndex COMMA_HERE))) ;
                  var_cas_currentLeftNonTerminal = var_cas_addedNonTerminalIndex ;
                  var_cas_addedNonTerminalIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (802)) ;
                }else if (((var_cas_idx).operator_isEqual (operand_32563->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (803)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (803)))).isBuiltAndTrue ()) {
                  const GGS_uint64  var_cas_derivation0 = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (804)) ;
                  const GGS_uint64  var_cas_derivation1 = operand_32563->mDerivation.reader_mValueAtIndex (inLexique, var_cas_idx.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (805)) ;
                  var_cas_productionsWithDoubleDerivation = (var_cas_productionsWithDoubleDerivation).operator_or (((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_currentLeftNonTerminal COMMA_HERE)).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, var_cas_derivation0 COMMA_HERE))).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (809)), var_cas_bitCountForBDDs, var_cas_derivation1 COMMA_HERE))) ;
                }
                var_cas_idx.mValue ++ ;
              }
            }
      ...
      enumerator_32434.next () ;
    }
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all non terminal symbols are useful...") COMMA_SOURCE_FILE_AT_LINE (818)) ;
  }
  GGS_binaryset var_cas_elementaryUtility = var_cas_productionsWithSingleDerivation ;
  var_cas_elementaryUtility = (var_cas_elementaryUtility).operator_or (var_cas_productionsWithDoubleDerivation.reader_existOnBitIndexAndBeyond (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (823)) COMMA_SOURCE_FILE_AT_LINE (823))) ;
  var_cas_elementaryUtility = (var_cas_elementaryUtility).operator_or (var_cas_productionsWithDoubleDerivation.reader_swap132 (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (824)).reader_existOnBitIndexAndBeyond (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824))) ;
  const GGS_binaryset var_cas_startSymbol = GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_startSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_HERE) ;
  const GGS_binaryset var_cas_usefulSymbols = var_cas_elementaryUtility.reader_accessibleStates (inLexique, var_cas_startSymbol, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (840)) ;
  const GGS_binaryset var_cas_allSymbols = GGS_binaryset::constructor_binarySetWithLowerOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (842)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_HERE) ;
  const GGS_binaryset var_cas_unusefulSymbols = (var_cas_allSymbols).operator_and ((var_cas_usefulSymbols).operator_tilde ()) ;
  GGS_binaryset var_cas_unusefulNonTerminals = (var_cas_unusefulSymbols).operator_and (GGS_binaryset::constructor_binarySetWithGreaterOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_terminalCount.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (844)) COMMA_HERE)) ;
  {
    GGS_lstringlist::cEnumerator enumerator_37406 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (845)), true) ;
    const GGS_lstringlist::cElement * operand_37406 = NULL ;
    while (((operand_37406 = enumerator_37406.nextObject ()))) {
      macroValidPointer (operand_37406) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_37518 = var_cas_nonterminalMap ;
      if (temp_37518.isBuilt ()) {
        temp_37518 (HERE)->method_searchKey (inLexique, operand_37406->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (847)) ;
      }
      var_cas_unusefulNonTerminals = (var_cas_unusefulNonTerminals).operator_and ((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (848)) COMMA_HERE)).operator_tilde ()) ;
    }
  }
  const GGS_stringlist  var_cas_unusefulNonTerminalList = var_cas_unusefulNonTerminals.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (850)) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (852))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string (" ok\n")) : (GGS_string (" warning\n"))) COMMA_SOURCE_FILE_AT_LINE (852)) ;
  }
  if (((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (854))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = ((((GGS_string ("the grammar contains ")).operator_concat (var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (856)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (856)))).operator_concat (GGS_string (" useless symbol"))).operator_concat ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (857))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (": ")) ;
    {
      GGS_stringlist::cEnumerator enumerator_38280 (var_cas_unusefulNonTerminalList, true) ;
      const GGS_stringlist::cElement * operand_38280 = enumerator_38280.nextObject () ;
      if ((operand_38280 != NULL)) {
        bool _foreach_loop_38280 ;
        do{
          macroValidPointer (operand_38280) ;
          var_cas_errorMessage.dotAssign_operation (operand_38280->mValue) ;
          operand_38280 = enumerator_38280.nextObject () ;
          _foreach_loop_38280 = ((operand_38280 != NULL)) ;
          if (_foreach_loop_38280) {
            var_cas_errorMessage.appendCString (", ") ;
          }
        }while (_foreach_loop_38280) ;
      }
    }
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (862)) ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_38548 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (865)), true) ;
    const GGS_lstringlist::cElement * operand_38548 = NULL ;
    while (((operand_38548 = enumerator_38548.nextObject ()))) {
      macroValidPointer (operand_38548) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_38660 = var_cas_nonterminalMap ;
      if (temp_38660.isBuilt ()) {
        temp_38660 (HERE)->method_searchKey (inLexique, operand_38548->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (867)) ;
      }
      if ((var_cas_usefulSymbols.reader_containsValue (inLexique, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (868)), GGS_uint (0U), var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (868))).isBuiltAndTrue ()) {
        operand_38548->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '<")).operator_concat (operand_38548->mValue)).operator_concat (GGS_string (">' non terminal is declared as unused, but it is actually useful")) COMMA_SOURCE_FILE_AT_LINE (869)) ;
      }
    }
  }
  GGS_binaryset var_cas_symbolsDirectlyDerivingInEmptyString = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
  {
    GGS_productionListMap::cEnumerator enumerator_39121 (var_cas_productionListMap, true) ;
    while (enumerator_39121.hasCurrentObject ()) {
      {
        GGS_derivationList::cEnumerator enumerator_39143 (enumerator_39121._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_39143 = NULL ;
        while (((operand_39143 = enumerator_39143.nextObject ()))) {
          macroValidPointer (operand_39143) ;
          if (((operand_39143->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (876))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_symbolsDirectlyDerivingInEmptyString = (var_cas_symbolsDirectlyDerivingInEmptyString).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, operand_39143->mLeftTerminalIndex COMMA_HERE)) ;
          }
        }
      }
      enumerator_39121.next () ;
    }
  }
  GGS_binaryset var_cas_elementaryFIRSTset = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
  {
    GGS_productionListMap::cEnumerator enumerator_39575 (var_cas_productionListMap, true) ;
    while (enumerator_39575.hasCurrentObject ()) {
      ...
      {
        GGS_derivationList::cEnumerator enumerator_39705 (enumerator_39575._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_39705 = NULL ;
        while (((operand_39705 = enumerator_39705.nextObject ()))) {
          macroValidPointer (operand_39705) ;
          if (((operand_39705->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (888))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_leftNonTerminalIndex = operand_39705->mLeftTerminalIndex ;
            GGS_uint64  var_cas_firstSymbol ;
            const GGS_uint64list  temp_39857 = operand_39705->mDerivation ;
            if (temp_39857.isBuilt ()) {
              temp_39857 (HERE)->method_first (inLexique, var_cas_firstSymbol COMMA_SOURCE_FILE_AT_LINE (891)) ;
            }
      ...
      enumerator_39575.next () ;
    }
  }
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    const GGS_stringlist  var_cas_listOfSymbolsDirectlyDerivingInEmptyString = var_cas_symbolsDirectlyDerivingInEmptyString.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (899)) ;
    GGS_string var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (901)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_vocabularyListForDisplaying, var_cas_terminalMap, var_cas_additionalNonTerminalSymbolsForPureBDDrules, var_cas_nonterminalMap, var_cas_bitCountForBDDs, var_cas_nonTerminalsWithEmptyProduction.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (909)), var_cas_productionsWithSingleDerivation.reader_relationStringListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (910)), var_cas_productionsWithDoubleDerivation.reader_tripleRelationStringListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (911)), var_cas_identicalDerivationErrorMessageList, var_cas_unusefulNonTerminalList, var_cas_listOfSymbolsDirectlyDerivingInEmptyString, var_cas_elementaryFIRSTset.reader_relationStringListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (915)), var_cas_elementaryFIRSTset.reader_valueCount (inLexique, var_cas_bitCountForBDDs.add_operation (inLexique, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (916)) COMMA_SOURCE_FILE_AT_LINE (916))) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_41599 = var_cas_s ;
    if (temp_41599.isBuilt ()) {
      temp_41599 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (918)) ;
    }
  }else{
  ...
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (926))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (930)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (935)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponent, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (924)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
