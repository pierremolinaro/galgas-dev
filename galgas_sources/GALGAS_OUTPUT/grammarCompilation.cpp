...
template_filewrapper_grammarGenerationTemplate_oldGrammarZone2Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_232 = enumerator_232.nextObject ()))) {
      ...
      result << "#include \"" ;
      result << operand_232->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (7)).reader_stringByDeletingPathExtension () ;
      result << ".h\"\n" ;
    }
    result << "\n" ;
  }
...
template_filewrapper_grammarGenerationTemplate_oldGrammarZone3Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_185 = enumerator_185.nextObject ()))) {
      ...
      result << "public " ;
      result << operand_185->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5)).reader_stringByDeletingPathExtension () ;
    ...
    result << " {\n" ;
    GGS_nonTerminalSymbolMapForGrammarAnalysis::cEnumerator enumerator_331 (var_cas_NON_TERMINAL_MAP, true) ;
    const GGS_nonTerminalSymbolMapForGrammarAnalysis::cElement * operand_331 = NULL ;
    while (((operand_331 = enumerator_331.nextObject ()))) {
      macroValidPointer (operand_331) ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_394 (operand_331->mInfo.mNonterminalSymbolParametersMap, true) ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_394 = NULL ;
      while (((operand_394 = enumerator_394.nextObject ()))) {
        macroValidPointer (operand_394) ;
        result << "  public : virtual void nt_" ;
        result << operand_331->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
        result << "_" ;
        result << operand_394->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
        result << " (" ;
        const GGS_string var_cas_COLUMN1 = GGS_string::stringWithColumnCount (result) ;
        result << var_cas_LEXIQUE_CLASS ;
        result << " &" ;
        GGS_signatureForGrammarAnalysis::cEnumerator enumerator_537 (operand_394->mInfo.mFormalParametersList, true) ;
        const GGS_signatureForGrammarAnalysis::cElement * operand_537 = NULL ;
        while (((operand_537 = enumerator_537.nextObject ()))) {
          macroValidPointer (operand_537) ;
          result << ",\n" ;
          result << var_cas_COLUMN1 ;
          result << operand_537->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
          result << "GGS_" ;
          result << operand_537->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
          result << operand_537->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
        }
        result << ") ;\n"
          "\n" ;
        if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (17)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).operator_isEqual (operand_331->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).boolValue ()) {
          result << "  public : static void _performSourceFileParsing_" ;
          result << operand_394->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
          result << " (" ;
          ...
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1239 (operand_394->mInfo.mFormalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_1239 = NULL ;
          while (((operand_1239 = enumerator_1239.nextObject ()))) {
            macroValidPointer (operand_1239) ;
            result << ",\n" ;
            result << var_cas_COLUMN2 ;
            result << operand_1239->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << "GGS_" ;
            result << operand_1239->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << operand_1239->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
          }
          result << "\n" ;
          result << var_cas_COLUMN2 ;
          ...
          result << operand_394->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (27)) ;
          result << " (" ;
          ...
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1791 (operand_394->mInfo.mFormalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_1791 = NULL ;
          while (((operand_1791 = enumerator_1791.nextObject ()))) {
            macroValidPointer (operand_1791) ;
            result << ",\n" ;
            result << var_cas_COLUMN3 ;
            result << operand_1791->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << "GGS_" ;
            result << operand_1791->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << operand_1791->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
          }
          result << "\n" ;
          result << var_cas_COLUMN3 ;
          result << "COMMA_LOCATION_ARGS) ;\n"
    ...
    GGS_nonTerminalToAddList::cEnumerator enumerator_2158 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
    const GGS_nonTerminalToAddList::cElement * operand_2158 = NULL ;
    while (((operand_2158 = enumerator_2158.nextObject ()))) {
      macroValidPointer (operand_2158) ;
      result << "  public : virtual PMSInt16 select_" ;
      result << operand_2158->mSyntaxComponentName ;
      result << "_" ;
      result << operand_2158->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
      result << " (" ;
      result << var_cas_LEXIQUE_CLASS ;
      result << " &) ;\n" ;
      if (enumerator_2158.hasNextObject ()) {
        result << "\n" ;
      }
    }
    result << "} ;\n"
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_lstring  var_cas_grammarComponentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (448)) ;
  ...
  const GGS_bool cond_18569 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (450))).operator_isNotEqual (var_cas_basename) ;
  if (cond_18569.isBuiltAndTrue ()) {
    var_cas_grammarComponentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (452)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (454)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19098 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (463)), true) ;
    const GGS_lstringlist::cElement * operand_19098 = NULL ;
    while (((operand_19098 = enumerator_19098.nextObject ()))) {
      macroValidPointer (operand_19098) ;
      const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
      const GGS_bool cond_19402 = ((operand_19098->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_19098->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_19402.isBuiltAndTrue ()) {
        operand_19098->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (467)) ;
      }else if (cond_19402.isBuiltAndFalse ()) {
        GGS_string var_cas_syntaxComponentName = operand_19098->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        const GGS_bool cond_19794 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_19794.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_19716 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) ;
          if (temp_19716.isBuilt ()) {
            temp_19716 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (471)) ;
          }
        }else if (cond_19794.isBuiltAndFalse ()) {
          GGS_string var_cas_sourceFilePath = operand_19098->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_19098->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (474)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_19098->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (475)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (475)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (478)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        ...
        if (cond_20463.isBuiltAndTrue ()) {
          ...
          if (cond_20758.isBuiltAndTrue ()) {
            operand_19098->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (485)) ;
          }
        }
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) COMMA_SOURCE_FILE_AT_LINE (487)) ;
        ::routine_buildRuleList (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mSyntaxComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (494)),  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (495)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_addedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (492)) ;
        ...
        while (_condition_21465.isBuiltAndTrue ()) {
          _condition_21465 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (501))) ;
          if (_condition_21465.isBuiltAndTrue ()) {
            if (_variant_21465.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (504)) ;
              ...
              var_cas_i.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (503)) ;
            }
          }
        }
      }
  ...
  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_21759 = var_cas_nonTerminalMapForGrammarAnalysis ;
  if (temp_21759.isBuilt ()) {
    temp_21759 (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (511)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (511)) ;
  }
  ::routine_checkLabelMap (inLexique,  var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (514)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (514)),  var_cas_grammarComponentRoot.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (515)),  var_cas_grammarComponentRoot.reader_mStartSymbolHasParseLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (516)),  var_cas_nonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (517)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (517)) COMMA_SOURCE_FILE_AT_LINE (517)),  var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (513)) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22366 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (522)), true) ;
    ...
    while (((operand_22366 = enumerator_22366.nextObject ()))) {
      ...
      const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_22490 = var_cas_nonTerminalMapForGrammarAnalysis ;
      if (temp_22490.isBuilt ()) {
        temp_22490 (HERE)->method_searchKey (inLexique, operand_22366->mValue, var_cas_nonterminalIndex, automatic_var_22520_0 COMMA_SOURCE_FILE_AT_LINE (524)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_22366->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (525)) ;
    }
  }
  if (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (529)).isBuilt () &&
      var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (530)).isBuilt () &&
      var_cas_startSymbolIndex.isBuilt () &&
      var_cas_lexiqueComponentName.isBuilt () &&
      var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (533)).isBuilt () &&
    ...
    ::routine_analyzeGrammar (inLexique,  var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (529)),  var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (530)),  var_cas_startSymbolIndex,  var_cas_lexiqueComponentName,  var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (533)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_unusedNonTerminalSymbolsForGrammar,  var_cas_inOutputDirectoryForCppFiles,  var_cas_inOutputDirectoryForHTMLFile COMMA_SOURCE_FILE_AT_LINE (528)) ;
  }
  const GGS_bool cond_23915 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_23915.isBuiltAndTrue ()) {
    const GGS_string var_cas_zone2 = template_filewrapper_grammarGenerationTemplate_oldGrammarZone2Header (inLexique, var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (544)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), var_cas_grammarComponentRoot) ;
    const GGS_string var_cas_zone3 = template_filewrapper_grammarGenerationTemplate_oldGrammarZone3Header (inLexique, var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (548)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (548)), var_cas_lexiqueComponentName, var_cas_grammarComponentRoot, var_cas_nonTerminalMapForGrammarAnalysis, var_cas_nonTerminalToAddList) ;
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (556)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (556))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), var_cas_zone2, GGS_string ("\n"
      "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (554)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
