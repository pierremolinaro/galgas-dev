...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
      ...
      if (enumerator_428.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        ...
        while (enumerator_922.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_4) {
            ...
            result << enumerator_922.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (44)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_lstring inFileName" ;
            GALGAS_uint index_2577_IDX (0) ;
            if (enumerator_922.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2577 (enumerator_922.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_2577.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2577.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (48)))).boolEnum () ;
                if (kBoolTrue == test_6) {
                  result << "const GALGAS_" ;
                  result << enumerator_2577.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2577_IDX.reader_string (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                }else if (kBoolFalse == test_6) {
                  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_2577.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (50)))).boolEnum () ;
                  if (kBoolTrue == test_7) {
                    result << "GALGAS_" ;
                    result << enumerator_2577.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2577_IDX.reader_string (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                  }else if (kBoolFalse == test_7) {
                    const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_2577.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (52)))).boolEnum () ;
                    if (kBoolTrue == test_8) {
                      result << "GALGAS_" ;
                      result << enumerator_2577.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (53)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2577_IDX.reader_string (SOURCE_FILE_AT_LINE (53)).stringValue () ;
                    }else if (kBoolFalse == test_8) {
                      result << "GALGAS_" ;
                      result << enumerator_2577.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (55)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2577_IDX.reader_string (SOURCE_FILE_AT_LINE (55)).stringValue () ;
                    }
                  }
                }
                index_2577_IDX.increment () ;
            ...
            result << enumerator_922.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (59)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_string inSourceString" ;
            GALGAS_uint index_3709_IDX (0) ;
            if (enumerator_922.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3709 (enumerator_922.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_3709.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_3709.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (63)))).boolEnum () ;
                if (kBoolTrue == test_9) {
                  result << "const GALGAS_" ;
                  result << enumerator_3709.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                  result << " inArgument" ;
                  result << index_3709_IDX.reader_string (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                }else if (kBoolFalse == test_9) {
                  const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_3709.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (65)))).boolEnum () ;
                  if (kBoolTrue == test_10) {
                    result << "GALGAS_" ;
                    result << enumerator_3709.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_3709_IDX.reader_string (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                  }else if (kBoolFalse == test_10) {
                    const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_3709.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (67)))).boolEnum () ;
                    if (kBoolTrue == test_11) {
                      result << "GALGAS_" ;
                      result << enumerator_3709.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (68)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_3709_IDX.reader_string (SOURCE_FILE_AT_LINE (68)).stringValue () ;
                    }else if (kBoolFalse == test_11) {
                      result << "GALGAS_" ;
                      result << enumerator_3709.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (70)).stringValue () ;
                      result << " inArgument" ;
                      result << index_3709_IDX.reader_string (SOURCE_FILE_AT_LINE (70)).stringValue () ;
                    }
                  }
                }
                index_3709_IDX.increment () ;
  ...
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4730 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_4730.hasCurrentObject ()) {
      result << "  public : virtual PMSInt32 select_" ;
      result << enumerator_4730.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (79)).stringValue () ;
      result << "_" ;
      result << enumerator_4730.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (79)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
