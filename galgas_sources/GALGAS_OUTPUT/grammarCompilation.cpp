    ...
    if (kBoolTrue == test_0) {
      ...
      while (enumerator_3474.hasCurrentObject () && enumerator_3498.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_6) {
          ...
          inCompiler->emitSemanticError (location_7, GALGAS_string (" this formal parameter is declared with ").operator_concat (enumerator_3498.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).reader_formalArgumentString (SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)).operator_concat (GALGAS_string (" passing mode, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (enumerator_2695.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (75)), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)).operator_concat (GALGAS_string (" is declared with ") COMMA_SOURCE_FILE_AT_LINE (76)).operator_concat (enumerator_3474.current_mFormalArgumentPassingMode (HERE).reader_formalArgumentString (SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)).operator_concat (GALGAS_string (" passing mode") COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (71)) ;
        }
        //-------- @ifInstructionForGeneration
