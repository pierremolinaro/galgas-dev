...
void routine_checkLabelMap (const GALGAS_location constinArgument_inNonTerminalLocation,
  ...
  while (enumerator_2679.hasCurrentObject ()) {
    var_labelStringSet.addAssign_operation (enumerator_2679.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (57)) ;
    GALGAS_signatureForGrammarAnalysis var_formalParametersList ;
    constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.method_searchKey (enumerator_2679.current_mLabelName (HERE), var_formalParametersList, inCompiler COMMA_SOURCE_FILE_AT_LINE (59)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_2679.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (60)).objectCompare (var_formalParametersList.reader_length (SOURCE_FILE_AT_LINE (60)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_2679.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (63)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_5, enumerator_2679.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (61)).reader_string (SOURCE_FILE_AT_LINE (61)).operator_concat (GALGAS_string (" formal parameter") COMMA_SOURCE_FILE_AT_LINE (61)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (62)).operator_concat (GALGAS_string (" declared here, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (enumerator_2679.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (65)), inCompiler COMMA_SOURCE_FILE_AT_LINE (65)).reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (64)).operator_concat (GALGAS_string (" names ") COMMA_SOURCE_FILE_AT_LINE (65)).operator_concat (var_formalParametersList.reader_length (SOURCE_FILE_AT_LINE (66)).reader_string (SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)).operator_concat (GALGAS_string (" parameter") COMMA_SOURCE_FILE_AT_LINE (66)).operator_concat (temp_3 COMMA_SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (61)) ;
      ...
      while (enumerator_3462.hasCurrentObject () && enumerator_3484.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_6) {
          ...
          inCompiler->emitSemanticError (location_7, GALGAS_string (" this formal parameter is declared with ").operator_concat (categoryReader_formalArgumentString (enumerator_3484.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (72)).operator_concat (GALGAS_string (" passing mode, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (73)).operator_concat (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (enumerator_2679.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (75)), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (GALGAS_string (" is declared with ") COMMA_SOURCE_FILE_AT_LINE (75)).operator_concat (categoryReader_formalArgumentString (enumerator_3462.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)).operator_concat (GALGAS_string (" passing mode") COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (71)) ;
        }
        const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, enumerator_3484.current_mGalgasTypeNameForGrammarAnalysis (HERE).reader_string (SOURCE_FILE_AT_LINE (78)).objectCompare (enumerator_3462.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (78)))).boolEnum () ;
        if (kBoolTrue == test_8) {
          ...
          inCompiler->emitSemanticError (location_9, GALGAS_string (" this formal parameter is declared of '@").operator_concat (enumerator_3484.current_mGalgasTypeNameForGrammarAnalysis (HERE).reader_string (SOURCE_FILE_AT_LINE (80)) COMMA_SOURCE_FILE_AT_LINE (80)).operator_concat (GALGAS_string ("' type, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (81)).operator_concat (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (enumerator_2679.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (83)), inCompiler COMMA_SOURCE_FILE_AT_LINE (83)).reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (82)).operator_concat (GALGAS_string (" is declared with '@") COMMA_SOURCE_FILE_AT_LINE (83)).operator_concat (enumerator_3462.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string ("' type") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (79)) ;
        }
  ...
  while (enumerator_4653.hasCurrentObject ()) {
    const enumGalgasBool test_10 = var_labelStringSet.reader_hasKey (enumerator_4653.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_not (SOURCE_FILE_AT_LINE (91)).boolEnum () ;
    if (kBoolTrue == test_10) {
      inCompiler->emitSemanticError (constinArgument_inNonTerminalLocation, GALGAS_string ("this non terminal does not declare the '").operator_concat (enumerator_4653.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string ("' label, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (constinArgument_inOriginalNonTerminalLocation.reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (93)).operator_concat (GALGAS_string (" does") COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (92)) ;
    }
...
void routine_handleNonTerminalDeclarations (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_nonterminalDeclarationListAST enumerator_5270 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_5270.hasCurrentObject ()) {
    ...
    cMapElement_nonTerminalSymbolMapForGrammarAnalysis * objectArray_5282 = (cMapElement_nonTerminalSymbolMapForGrammarAnalysis *) ioArgument_ioNonTerminalMapForGrammarAnalysis.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_5270.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
    if (NULL != objectArray_5282) {
        macroValidSharedObject (objectArray_5282, cMapElement_nonTerminalSymbolMapForGrammarAnalysis) ;
      {
      routine_checkLabelMap (enumerator_5270.current_mNonterminalName (HERE).reader_location (SOURCE_FILE_AT_LINE (109)), enumerator_5270.current_mLabels (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (enumerator_5270.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)), objectArray_5282->mAttribute_mNonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
      }
    }else{
      {
      ioArgument_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (enumerator_5270.current_mNonterminalName (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_count (SOURCE_FILE_AT_LINE (117)), function_transformLabelMap (enumerator_5270.current_mLabels (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (118)), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
      }
    }
...
void routine_handleNonTerminalDeclarationsFromRuleList (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_syntaxRuleListAST enumerator_6075 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_6075.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_6168 (enumerator_6075.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_6168.hasCurrentObject ()) {
      var_nonTerminalLabelListAST.addAssign_operation (enumerator_6168.current_mLabelName (HERE), enumerator_6168.current_mFormalArguments (HERE), enumerator_6168.current_mEndOfArgumentLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (133)) ;
      enumerator_6168.gotoNextObject () ;
    }
    // index 1: attribute 'mNonTerminalIndex', type @uint
    // index 2: attribute 'mNonterminalSymbolParametersMap', type @nonterminalSymbolLabelMapForGrammarAnalysis
    cMapElement_nonTerminalSymbolMapForGrammarAnalysis * objectArray_6318 = (cMapElement_nonTerminalSymbolMapForGrammarAnalysis *) ioArgument_ioNonTerminalMapForGrammarAnalysis.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_6075.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (139)) ;
    if (NULL != objectArray_6318) {
        macroValidSharedObject (objectArray_6318, cMapElement_nonTerminalSymbolMapForGrammarAnalysis) ;
      {
      routine_checkLabelMap (enumerator_6075.current_mNonterminalName (HERE).reader_location (SOURCE_FILE_AT_LINE (141)), var_nonTerminalLabelListAST, ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (enumerator_6075.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (143)), inCompiler COMMA_SOURCE_FILE_AT_LINE (143)), objectArray_6318->mAttribute_mNonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
      }
    }else{
      {
      ioArgument_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (enumerator_6075.current_mNonterminalName (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_count (SOURCE_FILE_AT_LINE (149)), function_transformLabelMap (var_nonTerminalLabelListAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (150)), inCompiler COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }
    }
...
void routine_transformInstructionList (const GALGAS_syntaxInstructionList constinArgument_inInstructionList,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_syntaxInstructionList enumerator_8272 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_8272.hasCurrentObject ()) {
    callCategoryMethod_transformInstruction ((const cPtr_syntaxInstructionAST *) enumerator_8272.current_mInstruction (HERE).ptr (), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, ioArgument_ioSyntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (187)) ;
...
void routine_buildRuleList (const GALGAS_nonTerminalSymbolMapForGrammarAnalysis constinArgument_inNonTerminalMapForGrammarAnalysis,
  ...
  cEnumerator_syntaxRuleListAST enumerator_14934 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_14934.hasCurrentObject ()) {
    ...
    constinArgument_inNonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_14934.current_mNonterminalName (HERE), var_nonTerminalIndex, var_nonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (374)) ;
    GALGAS_syntaxInstructionList var_parsedSyntaxInstructionList ;
    GALGAS_lstring joker_15296_0 ; // Joker input parameter
    GALGAS_formalParameterListAST joker_15299_0 ; // Joker input parameter
    GALGAS_location joker_15302_0 ; // Joker input parameter
    GALGAS_location joker_15334_0 ; // Joker input parameter
    enumerator_14934.current_mLabelList (HERE).method_first (joker_15296_0, joker_15299_0, joker_15302_0, var_parsedSyntaxInstructionList, joker_15334_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
    ...
    var_productionRulesList.addAssign_operation (enumerator_14934.current_mNonterminalName (HERE), var_nonTerminalIndex, var_instructionList, var_productionRulesList.reader_length (SOURCE_FILE_AT_LINE (391)) COMMA_SOURCE_FILE_AT_LINE (387)) ;
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  const cMapElement_parsedGrammarComponentMap * objectArray_17647 = (const cMapElement_parsedGrammarComponentMap *) ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.readAccessForWithInstruction_hasKey (var_basename) ;
  if (NULL != objectArray_17647) {
      macroValidSharedObject (objectArray_17647, cMapElement_parsedGrammarComponentMap) ;
    outArgument_outGrammarComponentRoot = objectArray_17647->mAttribute_mGrammarComponentRoot ;
  }else{
    {
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_20884 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (503)), kEnumeration_up) ;
  while (enumerator_20884.hasCurrentObject ()) {
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_20884.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (505)).objectCompare (GALGAS_string ("gSyntax"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_20884.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_string var_syntaxComponentName = enumerator_20884.current_mValue (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (508)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (508)) ;
      ...
      if (kBoolTrue == test_4) {
        GALGAS_lstring joker_21456_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (511)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (511)), joker_21456_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (511)) ;
      }else if (kBoolFalse == test_4) {
        GALGAS_string var_sourceFilePath = enumerator_20884.current_mValue (HERE).mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (513)) COMMA_SOURCE_FILE_AT_LINE (513)) ;
        GALGAS_lstring var_lSourceFilePath = GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_20884.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (514)) ;
        {
        ...
        {
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_20884.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (516)) COMMA_SOURCE_FILE_AT_LINE (516)), var_lSourceFilePath, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
        }
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_6) {
          GALGAS_location location_7 (enumerator_20884.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (var_addedNonTerminalCount.isValid ()) {
        uint32_t variant_23329 = var_addedNonTerminalCount.uintValue () ;
        bool loop_23329 = true ;
        while (loop_23329) {
          loop_23329 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (548)))).isValid () ;
          if (loop_23329) {
            loop_23329 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (548)))).boolValue () ;
          }
          if (loop_23329 && (0 == variant_23329)) {
            loop_23329 = false ;
  ...
  cEnumerator_lstringlist enumerator_25329 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (581)), kEnumeration_up) ;
  while (enumerator_25329.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_25437_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_25329.current_mValue (HERE), var_nonterminalIndex, joker_25437_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_25329.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
    }
  ...
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_25794 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_25794.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_25794.current_lkey (HERE), enumerator_25794.current_mNonTerminalIndex (HERE), enumerator_25794.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (589)) ;
...
static void categoryMethod_terminalCheckInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cMapElement_terminalSymbolsMapForGrammarAnalysis * objectArray_8925 = (cMapElement_terminalSymbolsMapForGrammarAnalysis *) ioArgument_ioActuallyUsedTerminalSymbolMap.readWriteAccessForWithInstruction_hasKey (inCompiler, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)) ;
  if (NULL != objectArray_8925) {
      macroValidSharedObject (objectArray_8925, cMapElement_terminalSymbolsMapForGrammarAnalysis) ;
    var_terminalSymbolIndex = objectArray_8925->mAttribute_mTerminalIndex ;
  }else{
...
static void categoryMethod_nonterminalCallInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_9895_0 ; // Joker input parameter
  constinArgument_inNonTerminalSymbolMap.method_searchKey (object->mAttribute_mNonterminalName, var_nonTerminalSymbolIndex, joker_9895_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
...
static void categoryMethod_repeatInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_10939 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_10939.hasCurrentObject ()) {
    ...
    {
    routine_transformInstructionList (enumerator_10939.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) ;
    }
...
static void categoryMethod_selectInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_12022 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_12022.hasCurrentObject ()) {
    ...
    {
    routine_transformInstructionList (enumerator_12022.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
    }
...
static void categoryMethod_parseRewindInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_location joker_13028_0 ; // Joker input parameter
  object->mAttribute_mParseRewindBranchList.method_first (var_syntaxInstructionList, joker_13028_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)) ;
  {
