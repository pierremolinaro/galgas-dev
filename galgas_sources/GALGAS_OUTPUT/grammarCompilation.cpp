...
template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " {\n" ;
    GGS_nonTerminalMap::cEnumerator enumerator_332 (var_cas_NON_TERMINAL_MAP, true) ;
    const GGS_nonTerminalMap::cElement * operand_332 = NULL ;
    while (((operand_332 = enumerator_332.nextObject ()))) {
      macroValidPointer (operand_332) ;
      GGS_nonTerminalLabelList::cEnumerator enumerator_353 (operand_332->mInfo.mLabels, true) ;
      const GGS_nonTerminalLabelList::cElement * operand_353 = NULL ;
      while (((operand_353 = enumerator_353.nextObject ()))) {
        macroValidPointer (operand_353) ;
        result << "  public : virtual void nt_" ;
        result << operand_332->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
        result << "_" ;
        result << operand_353->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
        result << " (" ;
        const GGS_string var_cas_COLUMN1 = GGS_string::stringWithColumnCount (result) ;
        result << var_cas_LEXIQUE_CLASS ;
        result << " &" ;
        GGS_formalParameterList::cEnumerator enumerator_489 (operand_353->mFormalParameters, true) ;
        const GGS_formalParameterList::cElement * operand_489 = NULL ;
        while (((operand_489 = enumerator_489.nextObject ()))) {
          macroValidPointer (operand_489) ;
          result << ",\n" ;
          result << var_cas_COLUMN1 ;
          result << operand_489->mFormalParameterPassingMode.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
          result << "GGS_" ;
          result << operand_489->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
          result << operand_489->mFormalParameterPassingMode.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (14)) ;
        }
        result << ") ;\n"
          "\n" ;
        if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (17)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).operator_isEqual (operand_332->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).boolValue ()) {
          result << "  public : static void _performSourceFileParsing_" ;
          result << operand_353->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (18)) ;
          result << " (" ;
          ...
          GGS_formalParameterList::cEnumerator enumerator_1134 (operand_353->mFormalParameters, true) ;
          const GGS_formalParameterList::cElement * operand_1134 = NULL ;
          while (((operand_1134 = enumerator_1134.nextObject ()))) {
            macroValidPointer (operand_1134) ;
            result << ",\n" ;
            result << var_cas_COLUMN2 ;
            result << operand_1134->mFormalParameterPassingMode.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << "GGS_" ;
            result << operand_1134->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << operand_1134->mFormalParameterPassingMode.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
          }
          result << "\n" ;
          result << var_cas_COLUMN2 ;
          ...
          result << operand_353->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (27)) ;
          result << " (" ;
          ...
          GGS_formalParameterList::cEnumerator enumerator_1634 (operand_353->mFormalParameters, true) ;
          const GGS_formalParameterList::cElement * operand_1634 = NULL ;
          while (((operand_1634 = enumerator_1634.nextObject ()))) {
            macroValidPointer (operand_1634) ;
            result << ",\n" ;
            result << var_cas_COLUMN3 ;
            result << operand_1634->mFormalParameterPassingMode.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << "GGS_" ;
            result << operand_1634->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << operand_1634->mFormalParameterPassingMode.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
          }
          result << "\n" ;
          result << var_cas_COLUMN3 ;
          result << "COMMA_LOCATION_ARGS) ;\n"
      ...
      if (operand_332->mInfo.mHasParseLabel.boolValue ()) {
        result << "  public : virtual void nt_" ;
        result << operand_332->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (37)) ;
        result << "_parse (" ;
        result << var_cas_LEXIQUE_CLASS ;
        result << " &) ;\n"
          "\n" ;
    ...
    GGS_stringlist::cEnumerator enumerator_2073 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
