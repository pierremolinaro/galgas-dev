...
//                    november 26th, 2010, at 19h46'22"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_checkLabelMap (const GALGAS_location constinArgument_inNonTerminalLocation,
  ...
  while (enumerator_2957.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, enumerator_2957.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (68)).objectCompare (var_formalParametersList.reader_length (SOURCE_FILE_AT_LINE (68))))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      if (GALGAS_bool (kIsStrictSup, enumerator_2957.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (71)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
      ...
      if (GALGAS_bool (kIsStrictSup, var_formalParametersList.reader_length (SOURCE_FILE_AT_LINE (75)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        temp_2 = GALGAS_string ("s") ;
      }else{
        temp_2 = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_location location_3 (enumerator_2957.current_mLabelName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, enumerator_2957.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (69)).reader_string (SOURCE_FILE_AT_LINE (69)).operator_concat (GALGAS_string (" formal parameter") COMMA_SOURCE_FILE_AT_LINE (70)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (71)).operator_concat (GALGAS_string (" declared here, but declaration at ") COMMA_SOURCE_FILE_AT_LINE (72)).operator_concat (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (enumerator_2957.current_mLabelName (HERE).reader_string (SOURCE_FILE_AT_LINE (73)), inCompiler COMMA_SOURCE_FILE_AT_LINE (73)).reader_locationString (inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)).operator_concat (GALGAS_string ("names ") COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (var_formalParametersList.reader_length (SOURCE_FILE_AT_LINE (74)).reader_string (SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (GALGAS_string ("parameter") COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (69)) ;
      ...
      while (enumerator_3736.hasCurrentObject () && enumerator_3760.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_4 (GALGAS_bool (kIsNotEqual, enumerator_3760.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (enumerator_3736.current_mFormalArgumentPassingMode (HERE)))) ;
        if (test_4.isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_3760.current_mGalgasTypeNameForGrammarAnalysis (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, enumerator_3760.current_mGalgasTypeNameForGrammarAnalysis (HERE).reader_string (SOURCE_FILE_AT_LINE (86)).objectCompare (enumerator_3736.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (86))))) ;
  ...
  if (test_8.isValidAndTrue ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_9 (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_hasKey (GALGAS_string ("parse") COMMA_SOURCE_FILE_AT_LINE (99)).operator_not (SOURCE_FILE_AT_LINE (99))) ;
  ...
  while (enumerator_5315.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_10 (var_labelStringSet.reader_hasKey (enumerator_5315.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_not (SOURCE_FILE_AT_LINE (108))) ;
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
        ...
        while (enumerator_511.hasCurrentObject ()) {
          ...
          if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
            ...
            while (enumerator_642.hasCurrentObject ()) {
              if (GALGAS_bool (kIsEqual, enumerator_642.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (15)))).isValidAndTrue ()) {
                ...
                if (GALGAS_bool (kIsEqual, enumerator_642.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (17)))).isValidAndTrue ()) {
                  result << "GALGAS_" ;
                  ...
                  if (GALGAS_bool (kIsEqual, enumerator_642.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (19)))).isValidAndTrue ()) {
                    result << "GALGAS_" ;
          ...
          if (GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (33)).reader_string (SOURCE_FILE_AT_LINE (33)).objectCompare (enumerator_391.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (33)))).isValidAndTrue ()) {
            result << "  public : static void _performSourceFileParsing_" ;
            result << enumerator_511.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (34)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_lstring inFileName" ;
            GALGAS_uint index_2063_IDX (0) ;
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2063 (enumerator_511.current_mFormalParametersList (HERE), true) ;
              while (enumerator_2063.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                if (GALGAS_bool (kIsEqual, enumerator_2063.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (38)))).isValidAndTrue ()) {
                  result << "const GALGAS_" ;
                  result << enumerator_2063.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (39)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2063_IDX.reader_string (SOURCE_FILE_AT_LINE (39)).stringValue () ;
                }else{
                  if (GALGAS_bool (kIsEqual, enumerator_2063.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (40)))).isValidAndTrue ()) {
                    result << "GALGAS_" ;
                    result << enumerator_2063.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (41)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2063_IDX.reader_string (SOURCE_FILE_AT_LINE (41)).stringValue () ;
                  }else{
                    if (GALGAS_bool (kIsEqual, enumerator_2063.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (42)))).isValidAndTrue ()) {
                      result << "GALGAS_" ;
                      result << enumerator_2063.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (43)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2063_IDX.reader_string (SOURCE_FILE_AT_LINE (43)).stringValue () ;
                    }else{
                      result << "GALGAS_" ;
                      result << enumerator_2063.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2063_IDX.reader_string (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                    }
                  }
                }
                index_2063_IDX.increment () ;
            ...
            result << enumerator_511.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (49)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_string inSourceString" ;
            GALGAS_uint index_3195_IDX (0) ;
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3195 (enumerator_511.current_mFormalParametersList (HERE), true) ;
              while (enumerator_3195.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                if (GALGAS_bool (kIsEqual, enumerator_3195.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (53)))).isValidAndTrue ()) {
                  result << "const GALGAS_" ;
                  result << enumerator_3195.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (54)).stringValue () ;
                  result << " inArgument" ;
                  result << index_3195_IDX.reader_string (SOURCE_FILE_AT_LINE (54)).stringValue () ;
                }else{
                  if (GALGAS_bool (kIsEqual, enumerator_3195.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (55)))).isValidAndTrue ()) {
                    result << "GALGAS_" ;
                    result << enumerator_3195.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (56)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_3195_IDX.reader_string (SOURCE_FILE_AT_LINE (56)).stringValue () ;
                  }else{
                    if (GALGAS_bool (kIsEqual, enumerator_3195.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (57)))).isValidAndTrue ()) {
                      result << "GALGAS_" ;
                      result << enumerator_3195.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (58)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_3195_IDX.reader_string (SOURCE_FILE_AT_LINE (58)).stringValue () ;
                    }else{
                      result << "GALGAS_" ;
                      result << enumerator_3195.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                      result << " inArgument" ;
                      result << index_3195_IDX.reader_string (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                    }
                  }
                }
                index_3195_IDX.increment () ;
  ...
  GALGAS_uint index_4216_ (0) ;
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4216 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, true) ;
    while (enumerator_4216.hasCurrentObject ()) {
      result << "  public : virtual PMSInt32 select_" ;
      result << enumerator_4216.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (69)).stringValue () ;
      result << "_" ;
      result << enumerator_4216.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (69)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (NULL != objectArray_18164) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_basename, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (456)), outArgument_outGrammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (455)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
...
void routine_compileGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_parseGrammarComponent (constinArgument_inSourceFile, ioArgument_ioParsedComponentStruct, var_grammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (496)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_lstring var_grammarComponentName = var_grammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (498)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_grammarComponentName.reader_string (SOURCE_FILE_AT_LINE (500)).objectCompare (var_basename))) ;
  if (test_0.isValidAndTrue ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_21380 (var_grammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (514)), true) ;
  //--- simple foreach instruction
  while (enumerator_21380.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsNotEqual, enumerator_21380.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (516)).objectCompare (GALGAS_string ("gSyntax")))) ;
    if (test_2.isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_4 (ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (521)).reader_hasKey (var_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (521))) ;
      if (test_4.isValidAndTrue ()) {
        //-------- @methodCallInstructionForGeneration
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (522)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (522)), var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (522)) ;
        //-------- END @methodCallInstructionForGeneration
        ...
        { //-------- @grammarInstructionWithSourceFileForGeneration
        cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_21380.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (525)) COMMA_SOURCE_FILE_AT_LINE (525)), var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (525)) ;
        } //-------- END @grammarInstructionWithSourceFileForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_21380.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)), var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (526)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
      //-------- @assignmentInstructionForGeneration
      var_lexiqueComponentPath = var_syntaxComponentRoot.reader_mImportedLexiqueFilePath (SOURCE_FILE_AT_LINE (529)) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_currentLexiqueName = var_lexiqueComponentPath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (530)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (530)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (test_5.isValidAndTrue ()) {
        ...
        if (test_6.isValidAndTrue ()) {
          ...
          inCompiler->emitSemanticError (location_7, GALGAS_string ("this syntax component uses '").operator_concat (var_currentLexiqueName COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '") COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (var_lexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (536)).operator_concat (GALGAS_string ("' lexique component (they should be the same)") COMMA_SOURCE_FILE_AT_LINE (536)) COMMA_SOURCE_FILE_AT_LINE (534)) ;
        }
      }
      { //-------- @routineCallInstructionForGeneration
      routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mNonterminalDeclarationList (SOURCE_FILE_AT_LINE (541)), inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (546)), inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mSyntaxComponentName (SOURCE_FILE_AT_LINE (551)), var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (552)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (549)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_uint var_i = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @loopInstructionForGeneration
      if (var_addedNonTerminalCount.isValid ()) {
        PMUInt32 variant_23758 = var_addedNonTerminalCount.uintValue () ;
        bool loop_23758 = true ;
        while (loop_23758) {
          loop_23758 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)))).isValid () ;
          if (loop_23758) {
            loop_23758 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)))).boolValue () ;
          }
          ...
          if (loop_23758) {
            variant_23758 -- ;
            //-------- @addAssignInstructionForGeneration
            var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i COMMA_SOURCE_FILE_AT_LINE (559)) ;
            //-------- @incrementInstructionForGeneration
            var_i.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
          }
        }
      }
    }
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_parseLexiqueComponent (GALGAS_lstring::constructor_new (var_lexiqueComponentPath.mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (567)) COMMA_SOURCE_FILE_AT_LINE (567)), var_lexiqueComponentPath.reader_location (SOURCE_FILE_AT_LINE (567)) COMMA_SOURCE_FILE_AT_LINE (567)), ioArgument_ioParsedComponentStruct, var_lexiqueComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_hasIndexing = GALGAS_bool (kIsStrictSup, var_lexiqueComponentAST.reader_mIndexingListAST (SOURCE_FILE_AT_LINE (571)).reader_length (SOURCE_FILE_AT_LINE (571)).objectCompare (GALGAS_uint ((PMUInt32) 0U))) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_uint var_startSymbolIndex ;
  //-------- @methodCallInstructionForGeneration
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (576)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (576)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkLabelMap (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (579)).reader_location (SOURCE_FILE_AT_LINE (579)), var_grammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (580)), var_grammarComponentRoot.reader_mStartSymbolHasParseLabel (SOURCE_FILE_AT_LINE (581)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (var_grammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (582)).reader_string (SOURCE_FILE_AT_LINE (582)), inCompiler COMMA_SOURCE_FILE_AT_LINE (582)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (586)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_25310 (var_grammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (587)), true) ;
  //--- simple foreach instruction
  while (enumerator_25310.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_nonterminalIndex ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_25416_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_25310.current_mValue (HERE), var_nonterminalIndex, joker_25416_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (589)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_25310.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_25310.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (593)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_25775 (var_nonTerminalMapForGrammarAnalysis, true) ;
  //--- simple foreach instruction
  while (enumerator_25775.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_25775.current_lkey (HERE), enumerator_25775.current_mNonTerminalIndex (HERE), enumerator_25775.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (595)) ;
    enumerator_25775.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  routine_grammarAnalysisAndGeneration (var_grammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (599)), var_grammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (600)), var_startSymbolIndex, var_lexiqueComponentName, var_grammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (603)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectoryForCppFiles, constinArgument_inOutputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_8 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (613)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_8.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (inCompiler, var_grammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (614))) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (inCompiler, var_lexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (618)), var_grammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (617))) ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectoryForCppFiles, var_grammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (626)).reader_string (SOURCE_FILE_AT_LINE (626)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (626)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (624)) ;
    } //-------- @routineCallInstructionForGeneration
  }
}
