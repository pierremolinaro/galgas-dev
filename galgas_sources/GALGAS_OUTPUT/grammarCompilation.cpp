...
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  function_transformLabelMap (C_Compiler & inLexique,
    ...
    while (((operand_2191 = enumerator_2191.nextObject ()))) {
      ...
      GGS_signatureForGrammarAnalysis  var_cas_formalParametersList = GGS_signatureForGrammarAnalysis ::constructor_emptyList () ;
      {
        ...
        while (((operand_2292 = enumerator_2292.nextObject ()))) {
          ...
          var_cas_formalParametersList.addAssign_operation (operand_2292->mFormalArgumentPassingMode, operand_2292->mFormalArgumentTypeName) ;
        }
      }
  ...
  const GGS_bool cond_2737 = var_cas_inHasParseLabel ;
  if (cond_2737.isBuiltAndTrue ()) {
...
void routine_checkLabelMap (C_Compiler & inLexique,
  ...
  {
    GGS_nonTerminalLabelList::cEnumerator enumerator_3158 (var_cas_inLabels, true) ;
    const GGS_nonTerminalLabelList::cElement * operand_3158 = NULL ;
    while (((operand_3158 = enumerator_3158.nextObject ()))) {
      macroValidPointer (operand_3158) ;
      var_cas_labelStringSet.addAssign_operation (operand_3158->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
      ...
      if (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_3158->mLabelName, var_cas_formalParametersList COMMA_SOURCE_FILE_AT_LINE (70)) ;
      }
      const GGS_bool cond_3899 = (operand_3158->mFormalParameters.reader_length ()).operator_isNotEqual (var_cas_formalParametersList.reader_length ()) ;
      if (cond_3899.isBuiltAndTrue ()) {
        operand_3158->mLabelName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((operand_3158->mFormalParameters.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72))).operator_concat (GGS_string (" formal parameter"))).operator_concat ((((operand_3158->mFormalParameters.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" declared here, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3158->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (76)))).operator_concat (GGS_string ("names "))).operator_concat (var_cas_formalParametersList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_formalParametersList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (79)) ;
      }else if (cond_3899.isBuiltAndFalse ()) {
        {
          GGS_formalParameterListAST::cEnumerator enumerator_3931 (operand_3158->mFormalParameters, true) ;
          const GGS_formalParameterListAST::cElement * operand_3931 = NULL ;
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_3953 (var_cas_formalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_3953 = NULL ;
          while (((operand_3931 = enumerator_3931.nextObject ()))
              && ((operand_3953 = enumerator_3953.nextObject ()))) {
            macroValidPointer (operand_3931) ;
            macroValidPointer (operand_3953) ;
            const GGS_bool cond_4513 = (operand_3953->mFormalArgumentPassingModeForGrammarAnalysis).operator_isNotEqual (operand_3931->mFormalArgumentPassingMode) ;
            if (cond_4513.isBuiltAndTrue ()) {
              operand_3953->mGalgasTypeNameForGrammarAnalysis.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string (" this formal parameter is declared with ")).operator_concat (operand_3953->mFormalArgumentPassingModeForGrammarAnalysis.reader_formalArgumentString (inLexique COMMA_SOURCE_FILE_AT_LINE (84)))).operator_concat (GGS_string (" passing mode, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3158->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (86)))).operator_concat (GGS_string (" is declared with "))).operator_concat (operand_3931->mFormalArgumentPassingMode.reader_formalArgumentString (inLexique COMMA_SOURCE_FILE_AT_LINE (87)))).operator_concat (GGS_string (" passing mode")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
            }
            const GGS_bool cond_5007 = (operand_3953->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))).operator_isNotEqual (operand_3931->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
            if (cond_5007.isBuiltAndTrue ()) {
              operand_3953->mGalgasTypeNameForGrammarAnalysis.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string (" this formal parameter is declared of '@")).operator_concat (operand_3953->mGalgasTypeNameForGrammarAnalysis)).operator_concat (GGS_string ("' type, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3158->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (94)))).operator_concat (GGS_string (" is declared with '@"))).operator_concat (operand_3931->mFormalArgumentTypeName)).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_5442 = var_cas_inHasParseLabel ;
  if (cond_5442.isBuiltAndTrue ()) {
    var_cas_labelStringSet.addAssign_operation (GGS_string ("parse")) ;
    const GGS_bool cond_5431 = (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_5431.isBuiltAndTrue ()) {
  ...
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_5508 (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_5508 = NULL ;
    while (((operand_5508 = enumerator_5508.nextObject ()))) {
      macroValidPointer (operand_5508) ;
      const GGS_bool cond_5780 = (var_cas_labelStringSet.reader_hasKey (operand_5508->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)))).operator_not () ;
      if (cond_5780.isBuiltAndTrue ()) {
        var_cas_inNonTerminalLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this non terminal does not declare the '")).operator_concat (operand_5508->mKey)).operator_concat (GGS_string ("' label, but declaration at "))).operator_concat (var_cas_inOriginalNonTerminalLocation.reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (114)))).operator_concat (GGS_string (" does")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_handleNonTerminalDeclarations (C_Compiler & inLexique,
                                ...
                                const GGS_nonterminalDeclarationList   var_cas_inNonterminalDeclarationList
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_handleNonTerminalDeclarations at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  {
    GGS_nonterminalDeclarationList::cEnumerator enumerator_6114 (var_cas_inNonterminalDeclarationList, true) ;
    const GGS_nonterminalDeclarationList::cElement * operand_6114 = NULL ;
    while (((operand_6114 = enumerator_6114.nextObject ()))) {
      macroValidPointer (operand_6114) ;
      elementOf_GGS_nonTerminalSymbolMapForGrammarAnalysis * operand_6163 = (elementOf_GGS_nonTerminalSymbolMapForGrammarAnalysis *) var_cas_ioNonTerminalMapForGrammarAnalysis.searchForReadWriteWithInstruction (operand_6114->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127))) ;
      if (NULL != operand_6163) {
        ::routine_checkLabelMap (inLexique,  operand_6114->mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (129)),  operand_6114->mLabels,  operand_6114->mHasParseLabel,  var_cas_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_6114->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)),  operand_6163->mInfo.mNonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (128)) ;
      }else{
        var_cas_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (inLexique, operand_6114->mNonterminalName, var_cas_ioNonTerminalMapForGrammarAnalysis.reader_count (), function_transformLabelMap (inLexique, operand_6114->mLabels, operand_6114->mHasParseLabel COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (136)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__semanticInstructionAST__transformInstruction (C_Compiler &,
                                const cPtr_semanticInstructionAST * operand_7369,
...
void routine_transformInstructionList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_8088 (var_cas_inInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_8088 = NULL ;
    while (((operand_8088 = enumerator_8088.nextObject ()))) {
      macroValidPointer (operand_8088) ;
      { typeCategoryMethod__syntaxInstructionAST__transformInstruction method = findCategoryMethod__syntaxInstructionAST__transformInstruction (operand_8088->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_8088->mInstruction (HERE), var_cas_ioActuallyUsedTerminalSymbolMap, var_cas_inNonTerminalSymbolMap, var_cas_ioAddedNonTerminalIndex, var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (176)) ;
        }
      }
    }
  }
...
category_method__terminalCheckInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_8444,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   /* var_cas_inNonTerminalSymbolMap */,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalIndex */,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8444 != NULL) {
    GGS_uint  var_cas_terminalSymbolIndex ;
    elementOf_GGS_terminalSymbolsMapForGrammarAnalysis * operand_8775 = (elementOf_GGS_terminalSymbolsMapForGrammarAnalysis *) var_cas_ioActuallyUsedTerminalSymbolMap.searchForReadWriteWithInstruction (operand_8444->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
    if (NULL != operand_8775) {
      var_cas_terminalSymbolIndex = operand_8775->mInfo.mTerminalIndex ;
    }else{
      var_cas_terminalSymbolIndex = var_cas_ioActuallyUsedTerminalSymbolMap.reader_count () ;
      var_cas_ioActuallyUsedTerminalSymbolMap.modifier_insertKey (inLexique, operand_8444->mTerminalName, var_cas_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (198)) ;
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_8444->mInstructionLocation, operand_8444->mTerminalName, var_cas_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (200))) ;
  }
}
...
category_method__nonterminalCallInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_9338 != NULL) {
    ...
    if (var_cas_inNonTerminalSymbolMap.isBuilt ()) {
      var_cas_inNonTerminalSymbolMap (HERE)->method_searchKey (inLexique, operand_9338->mNonterminalName, var_cas_nonTerminalSymbolIndex, automatic_var_9713_0 COMMA_SOURCE_FILE_AT_LINE (216)) ;
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_9338->mInstructionLocation, operand_9338->mNonterminalName, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (217))) ;
  }
}
...
category_method__repeatInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_10023,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_10023 != NULL) {
    ...
    ::routine_transformInstructionList (inLexique,  operand_10023->mRepeatedInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_repeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (236)) ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_10755 (operand_10023->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_10755 = NULL ;
      while (((operand_10755 = enumerator_10755.nextObject ()))) {
        macroValidPointer (operand_10755) ;
        ...
        ::routine_transformInstructionList (inLexique,  operand_10755->mSyntaxInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (247)) ;
        var_cas_repeatBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_repeatInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_10023->mInstructionLocation, var_cas_repeatBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (257))) ;
  }
}
...
category_method__selectInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_11404,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_11404 != NULL) {
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_11838 (operand_11404->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_11838 = NULL ;
      while (((operand_11838 = enumerator_11838.nextObject ()))) {
        macroValidPointer (operand_11838) ;
        GGS_syntaxInstructionListForGrammarAnalysis  var_cas_syntaxInstructionList = GGS_syntaxInstructionListForGrammarAnalysis ::constructor_emptyList () ;
        ::routine_transformInstructionList (inLexique,  operand_11838->mSyntaxInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (278)) ;
        var_cas_selectBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_selectInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_11404->mInstructionLocation, var_cas_selectBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (288))) ;
  }
}
...
category_method__parseDoInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_12488,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_12488 != NULL) {
    ...
    if (operand_12488->mParseDoBranchList.isBuilt ()) {
      operand_12488->mParseDoBranchList (HERE)->method_first (inLexique, var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__parseWhenInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_13174,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13174 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13174->mElseInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (323)) ;
  }
}
...
category_method__parseLoopInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_13755,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_13755 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13755->mDoInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (340)) ;
  }
}
...
category_method__blockInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_14330,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_14330 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_14330->mInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
}
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxRuleList::cEnumerator enumerator_15303 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_15303 = NULL ;
    while (((operand_15303 = enumerator_15303.nextObject ()))) {
      ...
      if (var_cas_inNonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_15303->mNonterminalName, var_cas_nonTerminalIndex, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      GGS_syntaxInstructionList  var_cas_parsedSyntaxInstructionList ;
      GGS_lstring  automatic_var_15699_0 ;
      GGS_formalParameterListAST  automatic_var_15699_1 ;
      if (operand_15303->mLabelList.isBuilt ()) {
        operand_15303->mLabelList (HERE)->method_first (inLexique, automatic_var_15699_0, automatic_var_15699_1, var_cas_parsedSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
      ...
      var_cas_productionRulesList.addAssign_operation (operand_15303->mNonterminalName, var_cas_nonTerminalIndex, var_cas_instructionList, var_cas_productionRulesList.reader_length ()) ;
    }
  }
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_18562 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (449))).operator_isNotEqual (var_cas_basename) ;
  ...
  GGS_terminalSymbolsMapForGrammarAnalysis  var_cas_actuallyUsedTerminalSymbolMap = GGS_terminalSymbolsMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (456)) ;
  GGS_nonTerminalSymbolMapForGrammarAnalysis  var_cas_nonTerminalMapForGrammarAnalysis = GGS_nonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (457)) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19091 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (462)), true) ;
    const GGS_lstringlist::cElement * operand_19091 = NULL ;
    while (((operand_19091 = enumerator_19091.nextObject ()))) {
      ...
      const GGS_bool cond_19395 = ((operand_19091->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_19091->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_19395.isBuiltAndTrue ()) {
        operand_19091->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (466)) ;
      }else if (cond_19395.isBuiltAndFalse ()) {
        GGS_string var_cas_syntaxComponentName = operand_19091->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        const GGS_bool cond_19787 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (469)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_19787.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_19709 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)) ;
          if (temp_19709.isBuilt ()) {
            temp_19709 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (470)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (470)) ;
          }
        }else if (cond_19787.isBuiltAndFalse ()) {
          GGS_string var_cas_sourceFilePath = operand_19091->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_19091->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (473)),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (473)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_19091->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (474)) ;
        }
        ...
        const GGS_bool cond_20457 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_20457.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_20457.isBuiltAndFalse ()) {
          const GGS_bool cond_20752 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
          if (cond_20752.isBuiltAndTrue ()) {
            operand_19091->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (484)) ;
          }
        }
        ...
        GGS_uint _variant_21459 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_21459 (_variant_21459.isBuilt (), true) ;
        while (_condition_21459.isBuiltAndTrue ()) {
          _condition_21459 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (500))) ;
          if (_condition_21459.isBuiltAndTrue ()) {
            if (_variant_21459.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (503)) ;
              _condition_21459 = GGS_bool (false) ;
            }else{
              _variant_21459.decrement_operation (inLexique COMMA_HERE) ;
  ...
  if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
    var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
  ...
  GGS_unusedNonTerminalSymbolMapForGrammarAnalysis  var_cas_unusedNonTerminalSymbolsForGrammar = GGS_unusedNonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)) ;
  {
    GGS_lstringlist::cEnumerator enumerator_22360 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), true) ;
    const GGS_lstringlist::cElement * operand_22360 = NULL ;
    while (((operand_22360 = enumerator_22360.nextObject ()))) {
      macroValidPointer (operand_22360) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_22514_0 ;
      if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_22360->mValue, var_cas_nonterminalIndex, automatic_var_22514_0 COMMA_SOURCE_FILE_AT_LINE (523)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_22360->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
  }
  ...
  const GGS_bool cond_23832 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (541))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_23832.isBuiltAndTrue ()) {
