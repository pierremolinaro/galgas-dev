...
const GGS_bool cond_26126 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (575))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26126.isBuiltAndTrue ()) {
const GGS_bool cond_25465 = (gOption_galgas_5F_cli_5F_options_legacyCodeGeneration.reader_value ()).operator_not () ;
if (cond_25465.isBuiltAndTrue ()) {
...
}else if (cond_25465.isBuiltAndFalse ()) {
