...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  if (((var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (549))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
  ...
  GGS_syntaxRuleListForGrammar  var_cas_syntaxRuleListForGrammar = GGS_syntaxRuleListForGrammar ::constructor_emptyList () ;
  {
    ...
    while (((operand_22176 = enumerator_22176.nextObject ()))) {
      ...
      if (((operand_22176->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (560))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (565)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (565))).isBuiltAndTrue ()) {
  ...
  GGS_uint  var_cas_addedRuleIndex = GGS_uint (0U) ;
  {
    ...
    while (((operand_24479 = enumerator_24479.nextObject ()))) {
      ...
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_24479->mSyntaxComponentName)).isBuiltAndTrue ()) {
  ...
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_26962 = enumerator_26962.nextObject ()))) {
      ...
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_26962->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (662)) COMMA_SOURCE_FILE_AT_LINE (662))).operator_not ()).isBuiltAndTrue ()) {
      ...
      if (((operand_26962->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (666))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
      ...
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_27497 (operand_26962->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_27497 = NULL ;
        while (((operand_27497 = enumerator_27497.nextObject ()))) {
          macroValidPointer (operand_27497) ;
          const GGS_syntaxInstruction  temp_27557 = operand_27497->mInstruction ;
          if (temp_27557.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_27557.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_27557 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (671)) ;
            }
          }
        }
      }
      ...
      {
        GGS_derivationList::cEnumerator enumerator_27869 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_27869 = NULL ;
        while (((operand_27869 = enumerator_27869.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_27869) ;
          if (((operand_27869->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            var_cas_ok = GGS_bool (false) ;
            if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (679))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
              inLexique.printMessage (GGS_string (" error\n") COMMA_SOURCE_FILE_AT_LINE (680)) ;
            }
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_26962->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_27869->mProductionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (685)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (686)))).operator_concat (GGS_string (" are identical")) ;
      ...
      if ((var_cas_ok).isBuiltAndTrue ()) {
        ...
        const GGS_vocabularyMap  temp_28820 = var_cas_nonterminalMap ;
        if (temp_28820.isBuilt ()) {
          temp_28820 (HERE)->method_searchKey (inLexique, operand_26962->mLeftNonTerminal, var_cas_leftTerminalIndex COMMA_SOURCE_FILE_AT_LINE (698)) ;
        }
  ...
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (702))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_29260 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (707)), true) ;
    const GGS_lstringlist::cElement * operand_29260 = NULL ;
    while (((operand_29260 = enumerator_29260.nextObject ()))) {
      macroValidPointer (operand_29260) ;
      elementOf_GGS_vocabularyMap * operand_29333 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, operand_29260->mValue, GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (708)) ;
      if (NULL != operand_29333) {
        var_cas_unusedNonterminalSymbolList.addAssign_operation (operand_29333->mInfo.mIndex) ;
      }else{
        operand_29260->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_29260->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (712)) ;
      }
    }
  }
  GGS_uint  var_cas_startSymbolIndex ;
  elementOf_GGS_vocabularyMap * operand_29663 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (716)), GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (716)) ;
  if (NULL != operand_29663) {
    var_cas_startSymbolIndex = operand_29663->mInfo.mIndex ;
  }else{
  ...
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    ...
    const GGS_string temp_40952 = var_cas_s ;
    if (temp_40952.isBuilt ()) {
      temp_40952 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (907)) ;
    }
  }else{
