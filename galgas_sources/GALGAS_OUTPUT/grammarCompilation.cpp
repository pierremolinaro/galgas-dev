...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_stringlist  var_cas_unusefulSymbolList ;
  var_cas_unusefulSymbolList = var_cas_unusefulSymbols.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (754)) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
  ...
  if (((var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (762))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_31957 (var_cas_unusefulSymbolList, true) ;
      const GGS_stringlist::cElement * operand_31957 = enumerator_31957.nextObject () ;
      if ((operand_31957 != NULL)) {
        bool _foreach_loop_31957 ;
        do{
          macroValidPointer (operand_31957) ;
          var_cas_errorMessage.dotAssign_operation (operand_31957->mValue) ;
          operand_31957 = enumerator_31957.nextObject () ;
          _foreach_loop_31957 = ((operand_31957 != NULL)) ;
          if (_foreach_loop_31957) {
            var_cas_errorMessage.appendCString (", ") ;
          }
        }while (_foreach_loop_31957) ;
      }
    }
  ...
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    ...
    const GGS_string temp_32535 = var_cas_s ;
    if (temp_32535.isBuilt ()) {
      temp_32535 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (781)) ;
    }
  }else{
