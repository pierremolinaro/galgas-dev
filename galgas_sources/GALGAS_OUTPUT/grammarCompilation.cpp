...
void routine_buildRuleList (const GALGAS_nonTerminalSymbolMapForGrammarAnalysis constinArgument_inNonTerminalMapForGrammarAnalysis,
  ...
  cEnumerator_syntaxRuleListAST enumerator_15412 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_15412.hasCurrentObject ()) {
    GALGAS_uint var_nonTerminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_nonterminalSymbolParametersMap ;
    constinArgument_inNonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_15412.current_mNonterminalName (HERE), var_nonTerminalIndex, var_nonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
    GALGAS_syntaxInstructionList var_parsedSyntaxInstructionList ;
    GALGAS_lstring joker_15774_0 ; // Joker input parameter
    GALGAS_formalParameterListAST joker_15777_0 ; // Joker input parameter
    GALGAS_location joker_15780_0 ; // Joker input parameter
    GALGAS_location joker_15812_0 ; // Joker input parameter
    enumerator_15412.current_mLabelList (HERE).method_first (joker_15774_0, joker_15777_0, joker_15780_0, var_parsedSyntaxInstructionList, joker_15812_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
    ...
    var_productionRulesList.addAssign_operation (enumerator_15412.current_mNonterminalName (HERE), var_nonTerminalIndex, var_instructionList, var_productionRulesList.reader_length (SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (398)) ;
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  const cMapElement_parsedGrammarComponentMap * objectArray_18125 = (const cMapElement_parsedGrammarComponentMap *) ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.readAccessForWithInstruction_hasKey (var_basename) ;
  if (NULL != objectArray_18125) {
      macroValidSharedObject (objectArray_18125, cMapElement_parsedGrammarComponentMap) ;
    outArgument_outGrammarComponentRoot = objectArray_18125->mAttribute_mGrammarComponentRoot ;
  }else{
    C_String syntaxDirectedTranslationResult_18289 ;
    cGrammar_grammarLL_31_grammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_18289, constinArgument_inSourceFile, outArgument_outGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (454)) ;
    {
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_21435 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (515)), kEnumeration_up) ;
  while (enumerator_21435.hasCurrentObject ()) {
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_21435.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (517)).objectCompare (GALGAS_string ("gSyntax"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_21435.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_string var_syntaxComponentName = enumerator_21435.current_mValue (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (520)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (520)) ;
      ...
      if (kBoolTrue == test_4) {
        GALGAS_lstring joker_22007_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (523)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (523)), joker_22007_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (523)) ;
      }else if (kBoolFalse == test_4) {
        GALGAS_string var_sourceFilePath = enumerator_21435.current_mValue (HERE).mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (525)) COMMA_SOURCE_FILE_AT_LINE (525)) ;
        GALGAS_lstring var_lSourceFilePath = GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_21435.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)) ;
        C_String syntaxDirectedTranslationResult_22292 ;
        cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_22292, var_lSourceFilePath, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (527)) ;
        {
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_21435.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (528)), var_lSourceFilePath, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
        }
      }
      ...
      if (kBoolTrue == test_9) {
        ...
        if (kBoolTrue == test_10) {
          GALGAS_location location_11 (enumerator_21435.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (var_addedNonTerminalCount.isValid ()) {
        uint32_t variant_24515 = var_addedNonTerminalCount.uintValue () ;
        bool loop_24515 = true ;
        while (loop_24515) {
          loop_24515 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)))).isValid () ;
          if (loop_24515) {
            loop_24515 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)))).boolValue () ;
          }
          if (loop_24515 && (0 == variant_24515)) {
            loop_24515 = false ;
  ...
  cEnumerator_lstringlist enumerator_26515 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (599)), kEnumeration_up) ;
  while (enumerator_26515.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_26623_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_26515.current_mValue (HERE), var_nonterminalIndex, joker_26623_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_26515.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
    }
  ...
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26980 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_26980.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_26980.current_lkey (HERE), enumerator_26980.current_mNonTerminalIndex (HERE), enumerator_26980.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (607)) ;
...
static void categoryMethod_terminalCheckInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cMapElement_terminalSymbolsMapForGrammarAnalysis * objectArray_9403 = (cMapElement_terminalSymbolsMapForGrammarAnalysis *) ioArgument_ioActuallyUsedTerminalSymbolMap.readWriteAccessForWithInstruction_hasKey (inCompiler, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (216)) COMMA_SOURCE_FILE_AT_LINE (216)) ;
  if (NULL != objectArray_9403) {
      macroValidSharedObject (objectArray_9403, cMapElement_terminalSymbolsMapForGrammarAnalysis) ;
    var_terminalSymbolIndex = objectArray_9403->mAttribute_mTerminalIndex ;
  }else{
...
static void categoryMethod_nonterminalCallInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_10373_0 ; // Joker input parameter
  constinArgument_inNonTerminalSymbolMap.method_searchKey (object->mAttribute_mNonterminalName, var_nonTerminalSymbolIndex, joker_10373_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
...
static void categoryMethod_repeatInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_11417 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_11417.hasCurrentObject ()) {
    ...
    {
    routine_transformInstructionList (enumerator_11417.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }
...
static void categoryMethod_selectInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cEnumerator_listOfSyntaxInstructionList enumerator_12500 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_12500.hasCurrentObject ()) {
    ...
    {
    routine_transformInstructionList (enumerator_12500.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
    }
...
static void categoryMethod_parseRewindInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_location joker_13506_0 ; // Joker input parameter
  object->mAttribute_mParseRewindBranchList.method_first (var_syntaxInstructionList, joker_13506_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (326)) ;
  {
