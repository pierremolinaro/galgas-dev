...
category_method__parseRewindInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseRewindInstruction * operand_12513,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12513 != NULL) {
    GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
    GGS_location  automatic_var_12867_0 ;
    if (operand_12513->mParseRewindBranchList.isBuilt ()) {
      operand_12513->mParseRewindBranchList (HERE)->method_first (inLexique, var_cas_syntaxInstructionList, automatic_var_12867_0 COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__parseWhenInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_13206,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13206 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13206->mElseInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (323)) ;
  }
}
...
category_method__parseLoopInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_13787,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13787 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13787->mDoInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (340)) ;
  }
}
...
category_method__blockInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_14362,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_14362 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_14362->mInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
}
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxRuleListAST::cEnumerator enumerator_15338 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleListAST::cElement * operand_15338 = NULL ;
    while (((operand_15338 = enumerator_15338.nextObject ()))) {
      ...
      if (var_cas_inNonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_15338->mNonterminalName, var_cas_nonTerminalIndex, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      GGS_syntaxInstructionList  var_cas_parsedSyntaxInstructionList ;
      GGS_lstring  automatic_var_15740_0 ;
      GGS_formalParameterListAST  automatic_var_15740_1 ;
      GGS_location  automatic_var_15740_2 ;
      GGS_location  automatic_var_15740_3 ;
      if (operand_15338->mLabelList.isBuilt ()) {
        operand_15338->mLabelList (HERE)->method_first (inLexique, automatic_var_15740_0, automatic_var_15740_1, automatic_var_15740_2, var_cas_parsedSyntaxInstructionList, automatic_var_15740_3 COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
      ...
      var_cas_productionRulesList.addAssign_operation (operand_15338->mNonterminalName, var_cas_nonTerminalIndex, var_cas_instructionList, var_cas_productionRulesList.reader_length ()) ;
    }
  }
...
template_filewrapper_grammarGenerationTemplate_grammarZone3Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " : " ;
    const GGS_string var_cas_COLUMN_CLASS_DECLARATION = GGS_string::stringWithColumnCount (result) ;
    GGS_lstringlist::cEnumerator enumerator_246 (var_cas_GRAMMAR_COMPONENT_ROOT.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (4)), true) ;
    const GGS_lstringlist::cElement * operand_246 = NULL ;
    while (((operand_246 = enumerator_246.nextObject ()))) {
      macroValidPointer (operand_246) ;
      result << "public cParser_" ;
      result << operand_246->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (5)).reader_stringByDeletingPathExtension ().reader_identifierRepresentation () ;
      if (enumerator_246.hasNextObject ()) {
        result << ",\n" ;
        result << var_cas_COLUMN_CLASS_DECLARATION ;
      }
    }
    result << " {\n" ;
    GGS_nonTerminalSymbolMapForGrammarAnalysis::cEnumerator enumerator_427 (var_cas_NON_TERMINAL_MAP, true) ;
    const GGS_nonTerminalSymbolMapForGrammarAnalysis::cElement * operand_427 = NULL ;
    while (((operand_427 = enumerator_427.nextObject ()))) {
      macroValidPointer (operand_427) ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_490 (operand_427->mInfo.mNonterminalSymbolParametersMap, true) ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_490 = NULL ;
      while (((operand_490 = enumerator_490.nextObject ()))) {
        macroValidPointer (operand_490) ;
        result << "  public : virtual void nt_" ;
        result << operand_427->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << "_" ;
        result << operand_490->mKey.ggs_string ().reader_identifierRepresentation () ;
        result << " (" ;
        columnMarker = result.currentColumn () ;
        GGS_signatureForGrammarAnalysis::cEnumerator enumerator_646 (operand_490->mInfo.mFormalParametersList, true) ;
        const GGS_signatureForGrammarAnalysis::cElement * operand_646 = NULL ;
        { GGS_uint var_cas_IDX (true, 0) ;
      while (((operand_646 = enumerator_646.nextObject ()))) {
        macroValidPointer (operand_646) ;
        if ((operand_646->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (14))).boolValue ()) {
          result << "GALGASap_" ;
          result << operand_646->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " const inArgument" ;
          result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (15)) ;
        }else if ((operand_646->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (16))).boolValue ()) {
          result << "GALGASap_" ;
          result << operand_646->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " & ioArgument" ;
          result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17)) ;
        }else if ((operand_646->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (18))).boolValue ()) {
          result << "GALGASap_" ;
          result << operand_646->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
          result << " & outArgument" ;
    ...
    result << " * inCompiler) ;\n"
      "\n" ;
    if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).operator_isEqual (operand_427->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).boolValue ()) {
      result << "  public : static void _performSourceFileParsing_" ;
      result << operand_490->mKey.ggs_string ().reader_identifierRepresentation () ;
      result << " (" ;
      columnMarker = result.currentColumn () ;
      result << "C_Compiler * inCompiler,\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      result << "GALGASap_lstring inFileName" ;
      GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1858 (operand_490->mInfo.mFormalParametersList, true) ;
      const GGS_signatureForGrammarAnalysis::cElement * operand_1858 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_1858 = enumerator_1858.nextObject ()))) {
      macroValidPointer (operand_1858) ;
      result << ",\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      if ((operand_1858->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (31))).boolValue ()) {
        result << "GALGASap_" ;
        result << operand_1858->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " const inArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
      }else if ((operand_1858->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (33))).boolValue ()) {
        result << "GALGASap_" ;
        result << operand_1858->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " & ioArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (34)) ;
      }else if ((operand_1858->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (35))).boolValue ()) {
        result << "GALGASap_" ;
        result << operand_1858->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " & outArgument" ;
  ...
  result << "C_Compiler * inCompiler,\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  result << "GALGASap_string inSourceString" ;
  GGS_signatureForGrammarAnalysis::cEnumerator enumerator_3000 (operand_490->mInfo.mFormalParametersList, true) ;
  const GGS_signatureForGrammarAnalysis::cElement * operand_3000 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3000 = enumerator_3000.nextObject ()))) {
  macroValidPointer (operand_3000) ;
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  if ((operand_3000->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (46))).boolValue ()) {
    result << "GALGASap_" ;
    result << operand_3000->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " const inArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
  }else if ((operand_3000->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (48))).boolValue ()) {
    result << "GALGASap_" ;
    result << operand_3000->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " & ioArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
  }else if ((operand_3000->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).boolValue ()) {
    result << "GALGASap_" ;
    result << operand_3000->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " & outArgument" ;
...
result << "\n" ;
GGS_nonTerminalToAddList::cEnumerator enumerator_4001 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
const GGS_nonTerminalToAddList::cElement * operand_4001 = NULL ;
while (((operand_4001 = enumerator_4001.nextObject ()))) {
macroValidPointer (operand_4001) ;
result << "  public : virtual PMSInt32 select_" ;
result << operand_4001->mSyntaxComponentName.reader_identifierRepresentation () ;
result << "_" ;
result << operand_4001->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
result << " (C_Lexique_" ;
result << var_cas_LEXIQUE_IDENTIFIER ;
result << " *) ;\n" ;
if (enumerator_4001.hasNextObject ()) {
result << "\n" ;
}
}
result << "} ;\n"
...
elementOf_GGS_parsedGrammarComponentMap * operand_18447 = (elementOf_GGS_parsedGrammarComponentMap *) var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.searchForReadWithInstruction (var_cas_basename) ;
if (NULL != operand_18447) {
var_cas_outGrammarComponentRoot = operand_18447->mInfo.mGrammarComponentRoot ;
}else{
...
var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_basename, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (458)), var_cas_outGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (457)) ;
}
  #ifdef DEBUG_TRACE_ENABLED
...
::routine_parseGrammarComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_grammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (477)) ;
const GGS_lstring  var_cas_grammarComponentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (479)) ;
const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_20018 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (481))).operator_isNotEqual (var_cas_basename) ;
if (cond_20018.isBuiltAndTrue ()) {
var_cas_grammarComponentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
  "the component name ('")).operator_concat (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (483)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (485)) ;
}
GGS_terminalSymbolsMapForGrammarAnalysis  var_cas_actuallyUsedTerminalSymbolMap = GGS_terminalSymbolsMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
GGS_nonTerminalSymbolMapForGrammarAnalysis  var_cas_nonTerminalMapForGrammarAnalysis = GGS_nonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (489)) ;
...
{
GGS_lstringlist::cEnumerator enumerator_20547 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), true) ;
const GGS_lstringlist::cElement * operand_20547 = NULL ;
while (((operand_20547 = enumerator_20547.nextObject ()))) {
  macroValidPointer (operand_20547) ;
const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
const GGS_bool cond_20851 = ((operand_20547->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20547->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
if (cond_20851.isBuiltAndTrue ()) {
operand_20547->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (498)) ;
}else if (cond_20851.isBuiltAndFalse ()) {
GGS_string var_cas_syntaxComponentName = operand_20547->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
GGS_syntaxComponentAST var_cas_syntaxComponentRoot ;
const GGS_bool cond_21242 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)).reader_hasKey (var_cas_syntaxComponentName) ;
if (cond_21242.isBuiltAndTrue ()) {
const GGS_parsedSyntaxComponentMap  temp_21164 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)) ;
if (temp_21164.isBuilt ()) {
  temp_21164 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (502)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (502)) ;
}
}else if (cond_21242.isBuiltAndFalse ()) {
GGS_string var_cas_sourceFilePath = operand_20547->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
const GGS_string _depExtension = GGS_string ("") ;
const GGS_string _depPath = GGS_string ("") ;
if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
  C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                ...
                                _depPath.string (),
                                NULL,
                                GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20547->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)),
                                var_cas_syntaxComponentRoot
                                COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20547->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (506)) ;
}
GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (509)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_21911 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
if (cond_21911.isBuiltAndTrue ()) {
var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
}else if (cond_21911.isBuiltAndFalse ()) {
const GGS_bool cond_22206 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
if (cond_22206.isBuiltAndTrue ()) {
operand_20547->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (516)) ;
}
}
::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (520)) COMMA_SOURCE_FILE_AT_LINE (518)) ;
::routine_buildRuleList (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mSyntaxComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (525)),  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (526)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_addedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (523)) ;
GGS_uint  var_cas_i = GGS_uint (0U) ;
GGS_uint _variant_22913 = var_cas_addedNonTerminalCount ;
GGS_bool _condition_22913 (_variant_22913.isBuilt (), true) ;
while (_condition_22913.isBuiltAndTrue ()) {
  _condition_22913 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (532))) ;
  if (_condition_22913.isBuiltAndTrue ()) {
    if (_variant_22913.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (535)) ;
      _condition_22913 = GGS_bool (false) ;
    }else{
      _variant_22913.decrement_operation (inLexique COMMA_HERE) ;
  var_cas_nonTerminalToAddList.addAssign_operation (var_cas_syntaxComponentName, var_cas_i) ;
  var_cas_i.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
    }
  }
}
}
...
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (542)) ;
}
::routine_checkLabelMap (inLexique,  var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (545)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (545)),  var_cas_grammarComponentRoot.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (546)),  var_cas_grammarComponentRoot.reader_mStartSymbolHasParseLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (547)),  var_cas_nonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (548)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (548)) COMMA_SOURCE_FILE_AT_LINE (548)),  var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (544)) ;
GGS_unusedNonTerminalSymbolMapForGrammarAnalysis  var_cas_unusedNonTerminalSymbolsForGrammar = GGS_unusedNonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (552)) ;
{
GGS_lstringlist::cEnumerator enumerator_23814 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), true) ;
const GGS_lstringlist::cElement * operand_23814 = NULL ;
while (((operand_23814 = enumerator_23814.nextObject ()))) {
  macroValidPointer (operand_23814) ;
GGS_uint  var_cas_nonterminalIndex ;
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23968_0 ;
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23814->mValue, var_cas_nonterminalIndex, automatic_var_23968_0 COMMA_SOURCE_FILE_AT_LINE (555)) ;
}
var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23814->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (556)) ;
}
}
if (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (560)).isBuilt () &&
    var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (561)).isBuilt () &&
    var_cas_startSymbolIndex.isBuilt () &&
    var_cas_lexiqueComponentName.isBuilt () &&
    var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (564)).isBuilt () &&
  ...
  ::routine_analyzeGrammar (inLexique,  var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (560)),  var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (561)),  var_cas_startSymbolIndex,  var_cas_lexiqueComponentName,  var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (564)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_unusedNonTerminalSymbolsForGrammar,  var_cas_inOutputDirectoryForCppFiles,  var_cas_inOutputDirectoryForHTMLFile COMMA_SOURCE_FILE_AT_LINE (559)) ;
}
const GGS_bool cond_26044 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (573))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26044.isBuiltAndTrue ()) {
const GGS_bool cond_25383 = gOption_galgas_5F_cli_5F_options_newCodeGeneration.reader_value () ;
if (cond_25383.isBuiltAndTrue ()) {
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (586)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (586))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (584)) ;
}else if (cond_25383.isBuiltAndFalse ()) {
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (605)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (605))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (603)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
