...
//                    february 10th, 2010, at 16h37'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  GGS_productionRuleListForGrammarAnalysis  var_cas_productionRulesList = GGS_productionRuleListForGrammarAnalysis ::constructor_emptyList () ;
  {
    ...
    while (((operand_15294 = enumerator_15294.nextObject ()))) {
      ...
      var_cas_productionRulesList.addAssign_operation (operand_15294->mNonterminalName, var_cas_nonTerminalIndex, var_cas_instructionList, var_cas_productionRulesList.reader_length ()) ;
    }
  }
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_bool cond_18553 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (449))).operator_isNotEqual (var_cas_basename) ;
  if (cond_18553.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_19082 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (462)), true) ;
    const GGS_lstringlist::cElement * operand_19082 = NULL ;
    while (((operand_19082 = enumerator_19082.nextObject ()))) {
      ...
      const GGS_bool cond_19386 = ((operand_19082->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_19082->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_19386.isBuiltAndTrue ()) {
        operand_19082->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (466)) ;
      }else if (cond_19386.isBuiltAndFalse ()) {
        GGS_string var_cas_syntaxComponentName = operand_19082->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        const GGS_bool cond_19778 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (469)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_19778.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_19700 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)) ;
          if (temp_19700.isBuilt ()) {
            temp_19700 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (470)) ;
          }
        }else if (cond_19778.isBuiltAndFalse ()) {
          GGS_string var_cas_sourceFilePath = operand_19082->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_19082->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (473)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_19082->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (474)) ;
        }
        ...
        const GGS_bool cond_20447 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_20447.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_20447.isBuiltAndFalse ()) {
          const GGS_bool cond_20742 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
          if (cond_20742.isBuiltAndTrue ()) {
            operand_19082->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (484)) ;
          }
        }
        ...
        GGS_uint _variant_21449 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_21449 (_variant_21449.isBuilt (), true) ;
        while (_condition_21449.isBuiltAndTrue ()) {
          _condition_21449 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (500))) ;
          if (_condition_21449.isBuiltAndTrue ()) {
            if (_variant_21449.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (503)) ;
              _condition_21449 = GGS_bool (false) ;
            }else{
              _variant_21449.decrement_operation (inLexique COMMA_HERE) ;
  ...
  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_21743 = var_cas_nonTerminalMapForGrammarAnalysis ;
  if (temp_21743.isBuilt ()) {
    temp_21743 (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22350 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), true) ;
    const GGS_lstringlist::cElement * operand_22350 = NULL ;
    while (((operand_22350 = enumerator_22350.nextObject ()))) {
      macroValidPointer (operand_22350) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_22504_0 ;
      const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_22474 = var_cas_nonTerminalMapForGrammarAnalysis ;
      if (temp_22474.isBuilt ()) {
        temp_22474 (HERE)->method_searchKey (inLexique, operand_22350->mValue, var_cas_nonterminalIndex, automatic_var_22504_0 COMMA_SOURCE_FILE_AT_LINE (523)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_22350->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
  }
  ...
  const GGS_bool cond_23822 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_23822.isBuiltAndTrue ()) {
