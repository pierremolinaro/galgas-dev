...
template_filewrapper_grammarGenerationTemplate_grammarZone3Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (26)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).operator_isEqual (operand_427->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (26))).boolValue ()) {
      ...
      GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1850 (operand_490->mInfo.mFormalParametersList, true) ;
      const GGS_signatureForGrammarAnalysis::cElement * operand_1850 = NULL ;
      { GGS_uint var_cas_IDX (true, 0) ;
    while (((operand_1850 = enumerator_1850.nextObject ()))) {
      macroValidPointer (operand_1850) ;
      result << ",\n" ;
      result.appendSpacesUntilColumn (columnMarker) ;
      if ((operand_1850->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (31))).boolValue ()) {
        result << "const GALGAS_" ;
        result << operand_1850->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " & inArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (32)) ;
      }else if ((operand_1850->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (33))).boolValue ()) {
        result << "GALGAS_" ;
        result << operand_1850->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " & ioArgument" ;
        result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (34)) ;
      }else if ((operand_1850->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (35))).boolValue ()) {
        result << "GALGAS_" ;
        result << operand_1850->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
        result << " & outArgument" ;
  ...
  GGS_signatureForGrammarAnalysis::cEnumerator enumerator_2984 (operand_490->mInfo.mFormalParametersList, true) ;
  const GGS_signatureForGrammarAnalysis::cElement * operand_2984 = NULL ;
  { GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2984 = enumerator_2984.nextObject ()))) {
  macroValidPointer (operand_2984) ;
  result << ",\n" ;
  result.appendSpacesUntilColumn (columnMarker) ;
  if ((operand_2984->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (46))).boolValue ()) {
    result << "const GALGAS_" ;
    result << operand_2984->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " & inArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47)) ;
  }else if ((operand_2984->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (48))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_2984->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " & ioArgument" ;
    result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (49)) ;
  }else if ((operand_2984->mFormalArgumentPassingModeForGrammarAnalysis).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).boolValue ()) {
    result << "GALGAS_" ;
    result << operand_2984->mGalgasTypeNameForGrammarAnalysis.ggs_string ().reader_identifierRepresentation () ;
    result << " & outArgument" ;
...
result << "\n" ;
GGS_nonTerminalToAddList::cEnumerator enumerator_3979 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
const GGS_nonTerminalToAddList::cElement * operand_3979 = NULL ;
while (((operand_3979 = enumerator_3979.nextObject ()))) {
macroValidPointer (operand_3979) ;
result << "  public : virtual PMSInt32 select_" ;
result << operand_3979->mSyntaxComponentName.reader_identifierRepresentation () ;
result << "_" ;
result << operand_3979->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
result << " (C_Lexique_" ;
result << var_cas_LEXIQUE_IDENTIFIER ;
result << " *) ;\n" ;
if (enumerator_3979.hasNextObject ()) {
result << "\n" ;
}
}
result << "} ;\n"
