...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
  ...
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    ...
    while (enumerator_375.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_0) {
        result << "//--- indexing\n"
          "  public : virtual void nt_" ;
        result << enumerator_375.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (18)).stringValue () ;
      ...
      if (enumerator_375.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_883 (enumerator_375.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
        while (enumerator_883.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_883.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (21)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          result << enumerator_375.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (23)).stringValue () ;
          result << "_" ;
          result << enumerator_883.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (23)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_1132_IDX (0) ;
          if (enumerator_883.current_mFormalParametersList (HERE).isValid ()) {
            cEnumerator_signatureForGrammarAnalysis enumerator_1132 (enumerator_883.current_mFormalParametersList (HERE), kEnumeration_up) ;
            while (enumerator_1132.hasCurrentObject ()) {
              const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_1132.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (25)))).boolEnum () ;
              if (kBoolTrue == test_1) {
                result << "const GALGAS_" ;
                result << enumerator_1132.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (26)).stringValue () ;
                result << " inArgument" ;
                result << index_1132_IDX.reader_string (SOURCE_FILE_AT_LINE (26)).stringValue () ;
              }else if (kBoolFalse == test_1) {
                const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1132.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (27)))).boolEnum () ;
                if (kBoolTrue == test_2) {
                  result << "GALGAS_" ;
                  result << enumerator_1132.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (28)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_1132_IDX.reader_string (SOURCE_FILE_AT_LINE (28)).stringValue () ;
                }else if (kBoolFalse == test_2) {
                  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_1132.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (29)))).boolEnum () ;
                  if (kBoolTrue == test_3) {
                    result << "GALGAS_" ;
                    result << enumerator_1132.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (30)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_1132_IDX.reader_string (SOURCE_FILE_AT_LINE (30)).stringValue () ;
                  }else if (kBoolFalse == test_3) {
                    result << "GALGAS_" ;
                    result << enumerator_1132.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                    result << " inArgument" ;
                    result << index_1132_IDX.reader_string (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
          ...
          result << " * inCompiler) ;\n"
            "\n" ;
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (38)).reader_string (SOURCE_FILE_AT_LINE (38)).objectCompare (enumerator_375.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (38)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            result << "//--- Start symbol\n"
              "  public : static void _performSourceFileParsing_" ;
            result << enumerator_883.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (40)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_lstring inFileName" ;
            GALGAS_uint index_2374_IDX (0) ;
            if (enumerator_883.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2374 (enumerator_883.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_2374.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_2374.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (44)))).boolEnum () ;
                if (kBoolTrue == test_5) {
                  result << "const GALGAS_" ;
                  result << enumerator_2374.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2374_IDX.reader_string (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                }else if (kBoolFalse == test_5) {
                  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2374.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (46)))).boolEnum () ;
                  if (kBoolTrue == test_6) {
                    result << "GALGAS_" ;
                    result << enumerator_2374.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (47)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2374_IDX.reader_string (SOURCE_FILE_AT_LINE (47)).stringValue () ;
                  }else if (kBoolFalse == test_6) {
                    const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_2374.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (48)))).boolEnum () ;
                    if (kBoolTrue == test_7) {
                      result << "GALGAS_" ;
                      result << enumerator_2374.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2374_IDX.reader_string (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                    }else if (kBoolFalse == test_7) {
                      result << "GALGAS_" ;
                      result << enumerator_2374.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2374_IDX.reader_string (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                    }
                  }
                }
                index_2374_IDX.increment () ;
            ...
            result << enumerator_883.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (55)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_string inSourceString" ;
            GALGAS_uint index_3495_IDX (0) ;
            if (enumerator_883.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3495 (enumerator_883.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_3495.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_3495.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (59)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  result << "const GALGAS_" ;
                  result << enumerator_3495.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                  result << " inArgument" ;
                  result << index_3495_IDX.reader_string (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_3495.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (61)))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    result << "GALGAS_" ;
                    result << enumerator_3495.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_3495_IDX.reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                  }else if (kBoolFalse == test_9) {
                    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_3495.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (63)))).boolEnum () ;
                    if (kBoolTrue == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_3495.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_3495_IDX.reader_string (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                    }else if (kBoolFalse == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_3495.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                      result << " inArgument" ;
                      result << index_3495_IDX.reader_string (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                    }
                  }
                }
                index_3495_IDX.increment () ;
      ...
      const enumGalgasBool test_11 = in_HAS_5F_INDEXING.operator_and (GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (73)).reader_string (SOURCE_FILE_AT_LINE (73)).objectCompare (enumerator_375.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (73)))) COMMA_SOURCE_FILE_AT_LINE (73)).boolEnum () ;
  ...
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4729 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_4729.hasCurrentObject ()) {
      result << "  public : virtual int32_t select_" ;
      result << enumerator_4729.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << "_" ;
      result << enumerator_4729.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
