...
class cCollectionElement_nonTerminalToAddList : public cCollectionElement {
  public : GALGAS_nonTerminalToAddList_3A_element mObject ;
...
GALGAS_nonTerminalToAddList_3A_element cEnumerator_nonTerminalToAddList::current (LOCATION_ARGS) const {
