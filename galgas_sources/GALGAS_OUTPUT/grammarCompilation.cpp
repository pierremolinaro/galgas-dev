...
template_filewrapper_grammarGenerationTemplates_html (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "</p>\n"
      ...
      "\n"
      "\n"
      "<p><a name=\"first_sets\"></a></p><table class=\"title\"><tr><td>\n"
      "FIRST set\n"
      "</td></tr></table>\n"
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_22119 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_22119 = NULL ;
    while (((operand_22119 = enumerator_22119.nextObject ()))) {
      macroValidPointer (operand_22119) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_22261 = operand_22119->mLabelList ;
      if (temp_22261.isBuilt ()) {
        temp_22261 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (563)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ...
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_22119->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (580)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (581)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23639 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), true) ;
    const GGS_lstringlist::cElement * operand_23639 = NULL ;
    while (((operand_23639 = enumerator_23639.nextObject ()))) {
      macroValidPointer (operand_23639) ;
      if (((operand_23639->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (593))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_23639->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (595)) ;
      }else{
        GGS_string var_cas_syntaxComponentName = operand_23639->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (596)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (596)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (598)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (598))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_24141 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (599)) ;
          if (temp_24141.isBuilt ()) {
            temp_24141 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (599)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath = operand_23639->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_23639->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (602)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_23639->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (603)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (603)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (606)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (606)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (606)) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_25629 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (628)), true) ;
    const GGS_lstringlist::cElement * operand_25629 = NULL ;
    while (((operand_25629 = enumerator_25629.nextObject ()))) {
      macroValidPointer (operand_25629) ;
      if (((var_cas_nonTerminalMap.reader_hasKey (inLexique, operand_25629->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629))).operator_not ()).isBuiltAndTrue ()) {
        operand_25629->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_25629->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (631)) ;
      }
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_26253 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_26253 = NULL ;
    while (((operand_26253 = enumerator_26253.nextObject ()))) {
      macroValidPointer (operand_26253) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_26253->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_26253->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_26253->mSyntaxComponentName,  operand_26253->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (645)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_26253->mSyntaxComponentName, operand_26253->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("  Building pure BNF productions... ")).operator_concat (var_cas_pureSyntaxRuleListForGrammar.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (678)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (678)))).operator_concat (GGS_string (" productions\n")) COMMA_SOURCE_FILE_AT_LINE (678)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all productions are differents...") COMMA_SOURCE_FILE_AT_LINE (683)) ;
  }
  GGS_string var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (685))).operator_concat (GGS_string (".html")) ;
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_28332 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_28332 = NULL ;
    while (((operand_28332 = enumerator_28332.nextObject ()))) {
      macroValidPointer (operand_28332) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28370 (operand_28332->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28370 = NULL ;
        while (((operand_28370 = enumerator_28370.nextObject ()))) {
          macroValidPointer (operand_28370) ;
          const GGS_syntaxInstruction  temp_28427 = operand_28370->mInstruction ;
          if (temp_28427.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_28427.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28427 (HERE), var_cas_terminalMap, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (693)) ;
            }
          }
        }
      }
  ...
  GGS_uint  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (696)) ;
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
      GGS_uint var_cas_idx (true, 0) ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_28677 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_28677 = NULL ;
    while (((operand_28677 = enumerator_28677.nextObject ()))) {
      macroValidPointer (operand_28677) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_28677->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (700)) COMMA_SOURCE_FILE_AT_LINE (700))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_28677->mLeftNonTerminal, var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (701)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (701)) COMMA_SOURCE_FILE_AT_LINE (701)) COMMA_SOURCE_FILE_AT_LINE (701)) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_28677->mLeftNonTerminal)).operator_concat (GGS_string (">"))) ;
      }
      GGS_uint64list  var_cas_rightDerivation = GGS_uint64list ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_29016 (operand_28677->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_29016 = NULL ;
        while (((operand_29016 = enumerator_29016.nextObject ()))) {
          macroValidPointer (operand_29016) ;
          const GGS_syntaxInstruction  temp_29076 = operand_29016->mInstruction ;
          if (temp_29076.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_29076.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_29076 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (706)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_28677->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (709)) COMMA_SOURCE_FILE_AT_LINE (709)) ;
      GGS_bool var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_29388 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_29388 = NULL ;
        while (((operand_29388 = enumerator_29388.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_29388) ;
          if (((operand_29388->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_28677->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_29388->mProductionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (720)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (721)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_28677->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (729)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        GGS_uint  var_cas_leftTerminalIndex ;
        const GGS_vocabularyMap  temp_30339 = var_cas_nonterminalMap ;
        if (temp_30339.isBuilt ()) {
          temp_30339 (HERE)->method_searchKey (inLexique, operand_28677->mLeftNonTerminal, var_cas_leftTerminalIndex COMMA_SOURCE_FILE_AT_LINE (733)) ;
        }
        var_cas_productionListMap.addAssign_operation (operand_28677->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), var_cas_leftTerminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), var_cas_idx, var_cas_rightDerivation) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  const GGS_uint  var_cas_terminalCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (737)) ;
  const GGS_uint  var_cas_vocabularyCount = var_cas_terminalCount.add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (738)) COMMA_SOURCE_FILE_AT_LINE (738)) ;
  const GGS_uint  var_cas_bitCountForBDDs = var_cas_vocabularyCount.reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (739)) ;
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (740))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string (" ok\n") COMMA_SOURCE_FILE_AT_LINE (741)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all non terminal symbols are useful...") COMMA_SOURCE_FILE_AT_LINE (745)) ;
  }
  GGS_binaryset var_cas_elementaryUtility = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
  {
    GGS_productionListMap::cEnumerator enumerator_31118 (var_cas_productionListMap, true) ;
    while (enumerator_31118.hasCurrentObject ()) {
      ...
      {
        GGS_derivationList::cEnumerator enumerator_31185 (enumerator_31118._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_31185 = NULL ;
        while (((operand_31185 = enumerator_31185.nextObject ()))) {
          macroValidPointer (operand_31185) ;
          {
            GGS_uint64list::cEnumerator enumerator_31214 (operand_31185->mDerivation, true) ;
            const GGS_uint64list::cElement * operand_31214 = NULL ;
            while (((operand_31214 = enumerator_31214.nextObject ()))) {
              macroValidPointer (operand_31214) ;
              var_cas_derivation = (var_cas_derivation).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, operand_31214->mValue COMMA_HERE)) ;
            }
          }
        }
      }
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_31435 = var_cas_nonterminalMap ;
      if (temp_31435.isBuilt ()) {
        temp_31435 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_31118._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (756)) ;
      }
      var_cas_derivation = (var_cas_derivation).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (757)) COMMA_HERE)) ;
      var_cas_elementaryUtility = (var_cas_elementaryUtility).operator_or (var_cas_derivation) ;
      enumerator_31118.next () ;
    }
  }
  const GGS_binaryset var_cas_startSymbol = GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (761)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_HERE) ;
  const GGS_binaryset var_cas_usefulSymbols = var_cas_elementaryUtility.reader_accessibleStates (inLexique, var_cas_startSymbol, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (762)) ;
  const GGS_binaryset var_cas_allSymbols = GGS_binaryset::constructor_binarySetWithLowerOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (764)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (764)) COMMA_HERE) ;
  const GGS_binaryset var_cas_unusefulSymbols = (var_cas_allSymbols).operator_and ((var_cas_usefulSymbols).operator_tilde ()) ;
  GGS_binaryset var_cas_unusefulNonTerminals = (var_cas_unusefulSymbols).operator_and (GGS_binaryset::constructor_binarySetWithGreaterOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_terminalCount.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (766)) COMMA_HERE)) ;
  {
    GGS_lstringlist::cEnumerator enumerator_32326 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (767)), true) ;
    const GGS_lstringlist::cElement * operand_32326 = NULL ;
    while (((operand_32326 = enumerator_32326.nextObject ()))) {
      macroValidPointer (operand_32326) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_32438 = var_cas_nonterminalMap ;
      if (temp_32438.isBuilt ()) {
        temp_32438 (HERE)->method_searchKey (inLexique, operand_32326->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (769)) ;
      }
      var_cas_unusefulNonTerminals = (var_cas_unusefulNonTerminals).operator_and ((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (770)) COMMA_HERE)).operator_tilde ()) ;
    }
  }
  const GGS_stringlist  var_cas_unusefulNonTerminalList = var_cas_unusefulNonTerminals.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (772)) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (774))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string (" ok\n")) : (GGS_string (" warning\n"))) COMMA_SOURCE_FILE_AT_LINE (774)) ;
  }
  if (((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (776))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = ((((GGS_string ("the grammar contains ")).operator_concat (var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (778)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (778)))).operator_concat (GGS_string (" useless symbol"))).operator_concat ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (779))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (": ")) ;
    {
      GGS_stringlist::cEnumerator enumerator_33200 (var_cas_unusefulNonTerminalList, true) ;
      const GGS_stringlist::cElement * operand_33200 = enumerator_33200.nextObject () ;
      if ((operand_33200 != NULL)) {
        bool _foreach_loop_33200 ;
        do{
          macroValidPointer (operand_33200) ;
          var_cas_errorMessage.dotAssign_operation (operand_33200->mValue) ;
          operand_33200 = enumerator_33200.nextObject () ;
          _foreach_loop_33200 = ((operand_33200 != NULL)) ;
          if (_foreach_loop_33200) {
            var_cas_errorMessage.appendCString (", ") ;
          }
        }while (_foreach_loop_33200) ;
      }
    }
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (784)) ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_33468 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), true) ;
    const GGS_lstringlist::cElement * operand_33468 = NULL ;
    while (((operand_33468 = enumerator_33468.nextObject ()))) {
      macroValidPointer (operand_33468) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_33580 = var_cas_nonterminalMap ;
      if (temp_33580.isBuilt ()) {
        temp_33580 (HERE)->method_searchKey (inLexique, operand_33468->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (789)) ;
      }
      if ((var_cas_usefulSymbols.reader_containsValue (inLexique, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (790)), GGS_uint (0U), var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (790))).isBuiltAndTrue ()) {
        operand_33468->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '<")).operator_concat (operand_33468->mValue)).operator_concat (GGS_string (">' non terminal is declared as unused, but it is actually useful")) COMMA_SOURCE_FILE_AT_LINE (791)) ;
      }
    }
  }
  GGS_binaryset var_cas_symbolsDirectlyDerivingInEmptyString = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
  {
    GGS_productionListMap::cEnumerator enumerator_34041 (var_cas_productionListMap, true) ;
    while (enumerator_34041.hasCurrentObject ()) {
      {
        GGS_derivationList::cEnumerator enumerator_34063 (enumerator_34041._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_34063 = NULL ;
        while (((operand_34063 = enumerator_34063.nextObject ()))) {
          macroValidPointer (operand_34063) ;
          if (((operand_34063->mDerivation.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (798))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
            var_cas_symbolsDirectlyDerivingInEmptyString = (var_cas_symbolsDirectlyDerivingInEmptyString).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, operand_34063->mLeftTerminalIndex COMMA_HERE)) ;
          }
        }
      }
      enumerator_34041.next () ;
    }
  }
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    const GGS_stringlist  var_cas_listOfSymbolsDirectlyDerivingInEmptyString = var_cas_symbolsDirectlyDerivingInEmptyString.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (806)) ;
    GGS_string var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (808)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_terminalMap, var_cas_nonterminalMap, var_cas_bitCountForBDDs, var_cas_identicalDerivationErrorMessageList, var_cas_unusefulNonTerminalList, var_cas_listOfSymbolsDirectlyDerivingInEmptyString) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_35051 = var_cas_s ;
    if (temp_35051.isBuilt ()) {
      temp_35051 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (818)) ;
    }
  }else{
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_htmlOutputFileName COMMA_SOURCE_FILE_AT_LINE (820)) ;
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (826))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (835)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponent, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (824)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
