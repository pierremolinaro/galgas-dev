...
elementOf_GGS_derivationList (const GGS_uintlist & argument_0
                                COMMA_LOCATION_ARGS) :
...
_internalAppendValues (const GGS_uintlist & argument_0
                    COMMA_LOCATION_ARGS) {
...
void GGS_derivationList::
_internalPrependValues (const GGS_uintlist & argument_0
                    COMMA_LOCATION_ARGS) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_THERE)) ;
    ...
    if (count () == 0) {
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_uintlist  p_0 = p->mDerivation ;
...
addAssign_operation (const GGS_string & inKey,
                      const GGS_uintlist & inAttribute0) {
...
void routine_handleNonTerminalDeclarations (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_nonterminalDeclarationList::cEnumerator enumerator_4328 (var_cas_inNonterminalDeclarationList, true) ;
    const GGS_nonterminalDeclarationList::cElement * operand_4328 = NULL ;
    while (((operand_4328 = enumerator_4328.nextObject ()))) {
      macroValidPointer (operand_4328) ;
      if ((var_cas_ioNonTerminalMap.reader_hasKey (inLexique, operand_4328->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85))).isBuiltAndTrue ()) {
        GGS_nonTerminalLabelList  var_cas_labels ;
        GGS_bool var_cas_hasParseLabel ;
        const GGS_nonTerminalMap  temp_4495 = var_cas_ioNonTerminalMap ;
        if (temp_4495.isBuilt ()) {
          temp_4495 (HERE)->method_searchKey (inLexique, operand_4328->mNonterminalName, var_cas_labels, var_cas_hasParseLabel COMMA_SOURCE_FILE_AT_LINE (88)) ;
        }
        if (((operand_4328->mHasParseLabel).operator_and ((var_cas_hasParseLabel).operator_not ())).isBuiltAndTrue ()) {
          operand_4328->mNonterminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this declaration has a 'parse' label, but declaration of the same non terminal in ")).operator_concat (var_cas_ioNonTerminalMap.reader_locationForKey (inLexique, operand_4328->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (96)))).operator_concat (GGS_string (" does not have a 'parse' label")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
        }else if ((((operand_4328->mHasParseLabel).operator_not ()).operator_and (var_cas_hasParseLabel)).isBuiltAndTrue ()) {
          operand_4328->mNonterminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this declaration has no 'parse' label, but declaration of the same non terminal in ")).operator_concat (var_cas_ioNonTerminalMap.reader_locationForKey (inLexique, operand_4328->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (100)))).operator_concat (GGS_string (" has a 'parse' label")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
        }
        if (((var_cas_labels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (104))).operator_isNotEqual (operand_4328->mLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (104)))).isBuiltAndTrue ()) {
          operand_4328->mNonterminalName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string ("this declaration names ")).operator_concat (operand_4328->mLabels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (106)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (106)))).operator_concat (GGS_string (" labels, but declaration of the same non terminal in "))).operator_concat (var_cas_ioNonTerminalMap.reader_locationForKey (inLexique, operand_4328->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (108)))).operator_concat (GGS_string (" names"))).operator_concat (var_cas_labels.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (110)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (110)))).operator_concat (GGS_string (" labels.")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
        }else{
          {
            GGS_nonTerminalLabelList::cEnumerator enumerator_5678 (operand_4328->mLabels, true) ;
            const GGS_nonTerminalLabelList::cElement * operand_5678 = NULL ;
            GGS_nonTerminalLabelList::cEnumerator enumerator_5686 (var_cas_labels, true) ;
            const GGS_nonTerminalLabelList::cElement * operand_5686 = NULL ;
            while (((operand_5678 = enumerator_5678.nextObject ()))
                && ((operand_5686 = enumerator_5686.nextObject ()))) {
              macroValidPointer (operand_5678) ;
              macroValidPointer (operand_5686) ;
              if (((operand_5678->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115))).operator_isNotEqual (operand_5686->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115)))).isBuiltAndTrue ()) {
                operand_5678->mLabelName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this label should be identical to the label '")).operator_concat (operand_5686->mLabelName)).operator_concat (GGS_string ("' declared in "))).operator_concat (operand_5686->mLabelName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (119)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (119))) COMMA_SOURCE_FILE_AT_LINE (121)) ;
              }
              {
                GGS_formalParameterList::cEnumerator enumerator_6063 (operand_5678->mFormalParameters, true) ;
                const GGS_formalParameterList::cElement * operand_6063 = NULL ;
                GGS_formalParameterList::cEnumerator enumerator_6081 (operand_5686->mFormalParameters, true) ;
                const GGS_formalParameterList::cElement * operand_6081 = NULL ;
                while (((operand_6063 = enumerator_6063.nextObject ()))
                    && ((operand_6081 = enumerator_6081.nextObject ()))) {
                  macroValidPointer (operand_6063) ;
                  macroValidPointer (operand_6081) ;
                  if (((operand_6063->mFormalParameterPassingMode).operator_isNotEqual (operand_6081->mFormalParameterPassingMode)).isBuiltAndTrue ()) {
                    operand_6063->mFormalParameterName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((((GGS_string ("the passing mode (")).operator_concat (operand_6063->mFormalParameterPassingMode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)))).operator_concat (GGS_string (") for this parameter should be identical to the passing mode ("))).operator_concat (operand_6081->mFormalParameterPassingMode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131)))).operator_concat (GGS_string (") of the parameter declared in"))).operator_concat (operand_5686->mLabelName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (133)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (133))) COMMA_SOURCE_FILE_AT_LINE (135)) ;
                  }
                  if (((operand_6063->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136))).operator_isNotEqual (operand_6081->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)))).isBuiltAndTrue ()) {
                    operand_6063->mFormalParameterTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("this type name should be identical to the '@")).operator_concat (operand_6081->mFormalParameterTypeName)).operator_concat (GGS_string ("' type name used in "))).operator_concat (operand_6081->mFormalParameterTypeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (140)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (140))) COMMA_SOURCE_FILE_AT_LINE (142)) ;
                  }
                }
              }
            }
        ...
        var_cas_ioNonTerminalMap.modifier_insertKey (inLexique, operand_4328->mNonterminalName, operand_4328->mLabels, operand_4328->mHasParseLabel COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildSyntaxInstructionList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_8394 (var_cas_inInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_8394 = NULL ;
    while (((operand_8394 = enumerator_8394.nextObject ()))) {
      macroValidPointer (operand_8394) ;
      const GGS_syntaxInstruction  temp_8442 = operand_8394->mInstruction ;
      if (temp_8442.isBuilt ()) {
        typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_8442.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_8442 (HERE), var_cas_outSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (176)) ;
        }
      }
    }
  }
...
category_method__semanticInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_semanticInstruction * operand_8802,
                                GGS_syntaxInstructionList  & /* var_cas_ioSyntaxInstructionList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8802 != NULL) {
  }
}
...
category_method__nonterminalCallInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_9026,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9026 != NULL) {
    var_cas_ioSyntaxInstructionList.addAssign_operation (operand_9026) ;
  }
}
...
category_method__terminalCheckInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_terminalCheckInstruction * operand_9278,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9278 != NULL) {
    var_cas_ioSyntaxInstructionList.addAssign_operation (operand_9278) ;
  }
}
...
category_method__repeatInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_9523,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9523 != NULL) {
    GGS_syntaxInstructionList  var_cas_repeatedInstructionList ;
    ::routine_buildSyntaxInstructionList (inLexique,  operand_9523->mRepeatedInstructionList,  var_cas_repeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (211)) ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_9799 (operand_9523->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_9799 = NULL ;
      while (((operand_9799 = enumerator_9799.nextObject ()))) {
        ...
        ::routine_buildSyntaxInstructionList (inLexique,  operand_9799->mSyntaxInstructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (215)) ;
        var_cas_repeatBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    GGS_repeatInstruction  var_cas_ri ;
    var_cas_ri = GGS_repeatInstruction ::constructor_new (inLexique, operand_9523->mRepeatInstructionLocation, var_cas_repeatedInstructionList, var_cas_repeatBranchList COMMA_HERE) ;
...
category_method__selectInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_10306,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10306 != NULL) {
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_10449 (operand_10306->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_10449 = NULL ;
      while (((operand_10449 = enumerator_10449.nextObject ()))) {
        macroValidPointer (operand_10449) ;
        GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
        ::routine_buildSyntaxInstructionList (inLexique,  operand_10449->mSyntaxInstructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (234)) ;
        var_cas_selectBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    GGS_selectInstruction  var_cas_si ;
    var_cas_si = GGS_selectInstruction ::constructor_new (inLexique, operand_10306->mSelectInstructionLocation, var_cas_selectBranchList COMMA_HERE) ;
...
category_method__parseDoInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_10928,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10928 != NULL) {
    GGS_syntaxInstructionList  var_cas_instructionList ;
    const GGS_listOfSyntaxInstructionList  temp_11052 = operand_10928->mParseDoBranchList ;
    if (temp_11052.isBuilt ()) {
      temp_11052 (HERE)->method_first (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (250)) ;
    }
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_11098 (var_cas_instructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_11098 = NULL ;
      while (((operand_11098 = enumerator_11098.nextObject ()))) {
        macroValidPointer (operand_11098) ;
        const GGS_syntaxInstruction  temp_11146 = operand_11098->mInstruction ;
        if (temp_11146.isBuilt ()) {
          typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_11146.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_11146 (HERE), var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (252)) ;
          }
        }
      }
    }
...
category_method__blockInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_11345,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11345 != NULL) {
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_11425 (operand_11345->mInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_11425 = NULL ;
      while (((operand_11425 = enumerator_11425.nextObject ()))) {
        macroValidPointer (operand_11425) ;
        const GGS_syntaxInstruction  temp_11473 = operand_11425->mInstruction ;
        if (temp_11473.isBuilt ()) {
          typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_11473.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_11473 (HERE), var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (262)) ;
          }
        }
      }
    }
...
category_reader__semanticInstruction__htmlListing (C_Compiler &,
                                const cPtr_semanticInstruction * operand_11969
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_11969 != NULL) {
...
category_reader__nonterminalCallInstruction__htmlListing (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_12165
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_12165 != NULL) {
    var_cas_outListing = ((GGS_string ("<span class=\"galgas_nonterminal\">&lt;")).operator_concat (operand_12165->mNonterminalName)).operator_concat (GGS_string ("&gt;</span>")) ;
  }
  return var_cas_outListing ;
}
...
category_reader__terminalCheckInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_12433
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_12433 != NULL) {
    var_cas_outListing = ((GGS_string ("<span class=\"galgas_terminal\">$")).operator_concat (operand_12433->mTerminalName.ggs_string ().reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (295)))).operator_concat (GGS_string ("$</span>")) ;
  }
  return var_cas_outListing ;
}
...
category_reader__repeatInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_12703
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_12703 != NULL) {
    ...
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_12916 (operand_12703->mRepeatedInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_12916 = NULL ;
      while (((operand_12916 = enumerator_12916.nextObject ()))) {
        macroValidPointer (operand_12916) ;
        var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_12916->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_12916->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (307)))) ;
      }
    }
    var_cas_outListing.appendCString ("</span>") ;
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_13038 (operand_12703->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_13038 = NULL ;
      while (((operand_13038 = enumerator_13038.nextObject ()))) {
        ...
        {
          GGS_syntaxInstructionList::cEnumerator enumerator_13205 (operand_13038->mSyntaxInstructionList, true) ;
          const GGS_syntaxInstructionList::cElement * operand_13205 = NULL ;
          while (((operand_13205 = enumerator_13205.nextObject ()))) {
            macroValidPointer (operand_13205) ;
            var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_13205->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_13205->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (314)))) ;
          }
        }
        var_cas_outListing.appendCString ("</span>") ;
      }
...
category_reader__selectInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_13544
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_13544 != NULL) {
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_13703 (operand_13544->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_13703 = enumerator_13703.nextObject () ;
      if ((operand_13703 != NULL)) {
        bool _foreach_loop_13703 ;
        do{
          macroValidPointer (operand_13703) ;
          var_cas_outListing.appendCString ("<span class=\"within_galgas_structure\">") ;
          {
            GGS_syntaxInstructionList::cEnumerator enumerator_13806 (operand_13703->mSyntaxInstructionList, true) ;
            const GGS_syntaxInstructionList::cElement * operand_13806 = NULL ;
            while (((operand_13806 = enumerator_13806.nextObject ()))) {
              macroValidPointer (operand_13806) ;
              var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_13806->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_13806->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (333)))) ;
            }
          }
          var_cas_outListing.appendCString ("</span>") ;
          operand_13703 = enumerator_13703.nextObject () ;
          _foreach_loop_13703 = ((operand_13703 != NULL)) ;
          if (_foreach_loop_13703) {
            var_cas_outListing.appendCString ("<span class=\"galgas_keyword\">or</span>") ;
          }
        }while (_foreach_loop_13703) ;
      }
    }
...
category_reader__parseDoInstruction__htmlListing (C_Compiler &,
                                const cPtr_parseDoInstruction * operand_14219
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_14219 != NULL) {
...
category_reader__blockInstruction__htmlListing (C_Compiler &,
                                const cPtr_blockInstruction * operand_14415
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
...
category_method__semanticInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_semanticInstruction * operand_14982,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_14982 != NULL) {
  }
}
...
category_method__nonterminalCallInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_15197,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15197 != NULL) {
  }
}
...
category_method__terminalCheckInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_15410,
                                GGS_vocabularyMap  & var_cas_ioVocabularyMap
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_15410 != NULL) {
    if (((var_cas_ioVocabularyMap.reader_hasKey (inLexique, operand_15410->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (386))).operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioVocabularyMap.modifier_insertKey (inLexique, operand_15410->mTerminalName, var_cas_ioVocabularyMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (387)) COMMA_SOURCE_FILE_AT_LINE (387)) ;
    }
  }
}
...
category_method__repeatInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_repeatInstruction * operand_15759,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__selectInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_selectInstruction * operand_15965,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__parseDoInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_parseDoInstruction * operand_16172,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16172 != NULL) {
  }
}
...
category_method__blockInstruction__enterTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_blockInstruction * operand_16377,
                                GGS_vocabularyMap  & /* var_cas_ioVocabularyMap */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__semanticInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_semanticInstruction * operand_17020,
...
category_method__nonterminalCallInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler & inLexique,
                                const cPtr_nonterminalCallInstruction * operand_17318,
                                GGS_vocabularyMap  & var_cas_ioNonTerminalMap,
                                const GGS_vocabularyMap   var_cas_inTerminalMap,
                                GGS_uintlist  & var_cas_ioRightDerivation
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17318 != NULL) {
    if (((var_cas_ioNonTerminalMap.reader_hasKey (inLexique, operand_17318->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445))).operator_not ()).isBuiltAndTrue ()) {
      var_cas_ioNonTerminalMap.modifier_insertKey (inLexique, operand_17318->mNonterminalName, var_cas_ioNonTerminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
    }
    GGS_uint  var_cas_nonterminalIndex ;
    const GGS_vocabularyMap  temp_17637 = var_cas_ioNonTerminalMap ;
    if (temp_17637.isBuilt ()) {
      temp_17637 (HERE)->method_searchKey (inLexique, operand_17318->mNonterminalName, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (449)) ;
    }
    var_cas_ioRightDerivation.addAssign_operation (var_cas_nonterminalIndex.add_operation (inLexique, var_cas_inTerminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (450)) COMMA_SOURCE_FILE_AT_LINE (450))) ;
  }
}
...
category_method__terminalCheckInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_17915,
                                GGS_vocabularyMap  & /* var_cas_ioNonTerminalMap */,
                                const GGS_vocabularyMap   var_cas_inTerminalMap,
                                GGS_uintlist  & var_cas_ioRightDerivation
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17915 != NULL) {
    ...
    const GGS_vocabularyMap  temp_18076 = var_cas_inTerminalMap ;
    if (temp_18076.isBuilt ()) {
      temp_18076 (HERE)->method_searchKey (inLexique, operand_17915->mTerminalName, var_cas_terminalIndex COMMA_SOURCE_FILE_AT_LINE (461)) ;
    }
...
category_method__repeatInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_repeatInstruction * operand_18314,
                                GGS_vocabularyMap  & /* var_cas_ioNonTerminalMap */,
                                const GGS_vocabularyMap   /* var_cas_ioTerminalMap */,
                                GGS_uintlist  & /* var_cas_ioRightDerivation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18314 != NULL) {
  }
}
...
category_method__selectInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_selectInstruction * operand_18603,
                                GGS_vocabularyMap  & /* var_cas_ioNonTerminalMap */,
                                const GGS_vocabularyMap   /* var_cas_ioTerminalMap */,
                                GGS_uintlist  & /* var_cas_ioRightDerivation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18603 != NULL) {
  }
}
...
category_method__parseDoInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_parseDoInstruction * operand_18893,
                                GGS_vocabularyMap  & /* var_cas_ioNonTerminalMap */,
                                const GGS_vocabularyMap   /* var_cas_ioTerminalMap */,
                                GGS_uintlist  & /* var_cas_ioRightDerivation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18893 != NULL) {
  }
}
...
category_method__blockInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler &,
                                const cPtr_blockInstruction * operand_19181,
                                GGS_vocabularyMap  & /* var_cas_ioNonTerminalMap */,
                                const GGS_vocabularyMap   /* var_cas_ioTerminalMap */,
                                GGS_uintlist  & /* var_cas_ioRightDerivation */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_21073 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_21073 = NULL ;
    while (((operand_21073 = enumerator_21073.nextObject ()))) {
      macroValidPointer (operand_21073) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_21215 = operand_21073->mLabelList ;
      if (temp_21215.isBuilt ()) {
        temp_21215 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (545)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ::routine_buildSyntaxInstructionList (inLexique,  var_cas_instructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (547)) ;
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_21073->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (563)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (563)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (566)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22483 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (574)), true) ;
    const GGS_lstringlist::cElement * operand_22483 = NULL ;
    while (((operand_22483 = enumerator_22483.nextObject ()))) {
      macroValidPointer (operand_22483) ;
      if (((operand_22483->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (575))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_22483->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (577)) ;
      }else{
        GGS_string var_cas_syntaxComponentName ;
        var_cas_syntaxComponentName = operand_22483->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (578)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (580)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (580))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_22985 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
          if (temp_22985.isBuilt ()) {
            temp_22985 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (581)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath ;
          var_cas_sourceFilePath = operand_22483->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (583)) COMMA_SOURCE_FILE_AT_LINE (583)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_22483->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (584)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_22483->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (585)) ;
        }
        GGS_string var_cas_currentLexiqueName ;
        var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (588)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (588)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
        if (((var_cas_lexiqueComponent).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_22483->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponent)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (595)) ;
        }
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMap,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (599)) COMMA_SOURCE_FILE_AT_LINE (597)) ;
        ::routine_buildRuleList (inLexique,  var_cas_syntaxComponentName,  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (604)),  var_cas_syntaxRuleListForGrammar COMMA_SOURCE_FILE_AT_LINE (602)) ;
      }
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_24770 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_24770 = NULL ;
    while (((operand_24770 = enumerator_24770.nextObject ()))) {
      macroValidPointer (operand_24770) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_24770->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_24770->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_24770->mSyntaxComponentName,  operand_24770->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (621)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_24770->mSyntaxComponentName, operand_24770->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (GGS_string (""), var_cas_addedRootNonTerminal, GGS_syntaxInstructionList ::constructor_listWithValue (GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (643)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE))) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("  Building pure BNF productions... ")).operator_concat (var_cas_pureSyntaxRuleListForGrammar.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (649)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (649)))).operator_concat (GGS_string (" productions\n")) COMMA_SOURCE_FILE_AT_LINE (649)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all productions are differents...") COMMA_SOURCE_FILE_AT_LINE (654)) ;
  }
  GGS_string var_cas_htmlOutputFileName ;
  var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (656))).operator_concat (GGS_string (".html")) ;
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_26646 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_26646 = NULL ;
    while (((operand_26646 = enumerator_26646.nextObject ()))) {
      macroValidPointer (operand_26646) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_26684 (operand_26646->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_26684 = NULL ;
        while (((operand_26684 = enumerator_26684.nextObject ()))) {
          macroValidPointer (operand_26684) ;
          const GGS_syntaxInstruction  temp_26741 = operand_26684->mInstruction ;
          if (temp_26741.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_26741.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_26741 (HERE), var_cas_terminalMap COMMA_SOURCE_FILE_AT_LINE (664)) ;
            }
          }
        }
      }
  ...
  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (667)) ;
  ...
  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
    ...
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_26961 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_26961 = NULL ;
    while (((operand_26961 = enumerator_26961.nextObject ()))) {
      macroValidPointer (operand_26961) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_26961->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_26961->mLeftNonTerminal, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)) ;
      }
      GGS_uintlist  var_cas_rightDerivation ;
      var_cas_rightDerivation = GGS_uintlist ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_27207 (operand_26961->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_27207 = NULL ;
        while (((operand_27207 = enumerator_27207.nextObject ()))) {
          macroValidPointer (operand_27207) ;
          const GGS_syntaxInstruction  temp_27267 = operand_27207->mInstruction ;
          if (temp_27267.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_27267.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_27267 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation COMMA_SOURCE_FILE_AT_LINE (676)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations ;
      var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_26961->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)) ;
      GGS_uintlist  var_cas_previousDerivationsIndexes ;
      var_cas_previousDerivationsIndexes = var_cas_productionIndexListMap.reader_listForKey (inLexique, operand_26961->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
      GGS_bool var_cas_ok ;
      var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_27658 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_27658 = NULL ;
        GGS_uintlist::cEnumerator enumerator_27686 (var_cas_previousDerivationsIndexes, true) ;
        const GGS_uintlist::cElement * operand_27686 = NULL ;
        while (((operand_27658 = enumerator_27658.nextObject ()))
            && ((operand_27686 = enumerator_27686.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_27658) ;
          macroValidPointer (operand_27686) ;
          if (((operand_27658->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            var_cas_ok = GGS_bool (false) ;
            if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (685))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
              inLexique.printMessage (GGS_string (" error\n") COMMA_SOURCE_FILE_AT_LINE (686)) ;
            }
            GGS_string var_cas_errorMessage ;
            var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_26961->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_27686->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (691)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (692)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_26961->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (700)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        var_cas_productionListMap.addAssign_operation (operand_26961->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (703)), var_cas_rightDerivation) ;
        var_cas_productionIndexListMap.addAssign_operation (operand_26961->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (704)), var_cas_idx) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  GGS_uint  var_cas_bitCountForBDDs ;
  var_cas_bitCountForBDDs = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (707)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)).reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (707)) ;
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (708))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string (" ok\n") COMMA_SOURCE_FILE_AT_LINE (709)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s ;
    var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_terminalMap, var_cas_nonterminalMap, var_cas_bitCountForBDDs, var_cas_identicalDerivationErrorMessageList) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_29402 = var_cas_s ;
    if (temp_29402.isBuilt ()) {
      temp_29402 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (722)) ;
    }
  }else{
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_htmlOutputFileName COMMA_SOURCE_FILE_AT_LINE (724)) ;
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (730))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (734)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (739)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponent, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (728)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
