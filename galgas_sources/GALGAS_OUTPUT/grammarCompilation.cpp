...
category_method__nonterminalCallInstruction__enterNonTerminalSymbolIntoVocabulary (C_Compiler & inLexique,
  ...
  if (operand_16515 != NULL) {
    if (((var_cas_ioNonTerminalMap.reader_hasKey (inLexique, operand_16515->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425))).operator_not ()).isBuiltAndTrue ()) {
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_21191 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_21191 = NULL ;
    while (((operand_21191 = enumerator_21191.nextObject ()))) {
      macroValidPointer (operand_21191) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_21333 = operand_21191->mLabelList ;
      if (temp_21333.isBuilt ()) {
        temp_21333 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (542)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ...
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_21191->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22755 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (571)), true) ;
    const GGS_lstringlist::cElement * operand_22755 = NULL ;
    while (((operand_22755 = enumerator_22755.nextObject ()))) {
      macroValidPointer (operand_22755) ;
      if (((operand_22755->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (572))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_22755->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (574)) ;
      }else{
        GGS_string var_cas_syntaxComponentName = operand_22755->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (575)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (575)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (577)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (577))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_23257 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
          if (temp_23257.isBuilt ()) {
            temp_23257 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (578)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath = operand_22755->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_22755->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (581)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_22755->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (582)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (582)) ;
        }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_25058 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_25058 = NULL ;
    while (((operand_25058 = enumerator_25058.nextObject ()))) {
      macroValidPointer (operand_25058) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_25058->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_25058->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_25058->mSyntaxComponentName,  operand_25058->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (618)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_25058->mSyntaxComponentName, operand_25058->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_27196 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_27196 = NULL ;
    while (((operand_27196 = enumerator_27196.nextObject ()))) {
      macroValidPointer (operand_27196) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_27234 (operand_27196->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_27234 = NULL ;
        while (((operand_27234 = enumerator_27234.nextObject ()))) {
          macroValidPointer (operand_27234) ;
          const GGS_syntaxInstruction  temp_27291 = operand_27234->mInstruction ;
          if (temp_27291.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_27291.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_27291 (HERE), var_cas_terminalMap, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (667)) ;
            }
          }
        }
      }
  ...
  {
      GGS_uint var_cas_idx (true, 0) ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_27541 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_27541 = NULL ;
    while (((operand_27541 = enumerator_27541.nextObject ()))) {
      macroValidPointer (operand_27541) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_27541->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_27541->mLeftNonTerminal, var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (675)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (675)) COMMA_SOURCE_FILE_AT_LINE (675)) COMMA_SOURCE_FILE_AT_LINE (675)) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_27541->mLeftNonTerminal)).operator_concat (GGS_string (">"))) ;
      }
      if (((operand_27541->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (678))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
        var_cas_additionalNonTerminalSymbolsForPureBDDrules = var_cas_additionalNonTerminalSymbolsForPureBDDrules.add_operation (inLexique, operand_27541->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (679)) ;
      }
      GGS_uintlist  var_cas_rightDerivation = GGS_uintlist ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28076 (operand_27541->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28076 = NULL ;
        while (((operand_28076 = enumerator_28076.nextObject ()))) {
          macroValidPointer (operand_28076) ;
          const GGS_syntaxInstruction  temp_28136 = operand_28076->mInstruction ;
          if (temp_28136.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_28136.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28136 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (683)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_27541->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)) ;
      GGS_bool var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_28448 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_28448 = NULL ;
        while (((operand_28448 = enumerator_28448.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_28448) ;
          if (((operand_28448->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            ...
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_27541->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_28448->mProductionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (697)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (698)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_27541->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (706)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        GGS_uint  var_cas_leftTerminalIndex ;
        const GGS_vocabularyMap  temp_29399 = var_cas_nonterminalMap ;
        if (temp_29399.isBuilt ()) {
          temp_29399 (HERE)->method_searchKey (inLexique, operand_27541->mLeftNonTerminal, var_cas_leftTerminalIndex COMMA_SOURCE_FILE_AT_LINE (710)) ;
        }
        var_cas_productionListMap.addAssign_operation (operand_27541->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (711)), var_cas_leftTerminalIndex, var_cas_idx, var_cas_rightDerivation) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_29839 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (719)), true) ;
    const GGS_lstringlist::cElement * operand_29839 = NULL ;
    while (((operand_29839 = enumerator_29839.nextObject ()))) {
      macroValidPointer (operand_29839) ;
      elementOf_GGS_vocabularyMap * operand_29912 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, operand_29839->mValue, GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (720)) ;
      if (NULL != operand_29912) {
        var_cas_unusedNonterminalSymbolList.addAssign_operation (operand_29912->mInfo.mIndex) ;
      }else{
        operand_29839->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_29839->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (724)) ;
      }
    }
  }
  GGS_uint  var_cas_startSymbolIndex ;
  elementOf_GGS_vocabularyMap * operand_30242 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (728)), GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (728)) ;
  if (NULL != operand_30242) {
    var_cas_startSymbolIndex = operand_30242->mInfo.mIndex ;
  }else{
  ...
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    ...
    const GGS_string temp_41498 = var_cas_s ;
    if (temp_41498.isBuilt ()) {
      temp_41498 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (918)) ;
    }
  }else{
