...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_HeaderGalgas_33_ (C_Compiler * inCompiler,
  ...
  result << " : " ;
  columnMarker = result.currentColumn () ;
  GALGAS_uint index_404_ (0) ;
  if (in_SYNTAX_5F_COMPONENTS.isValid ()) {
    cEnumerator_lstringlist enumerator_404 (in_SYNTAX_5F_COMPONENTS, kEnumeration_up) ;
    while (enumerator_404.hasCurrentObject ()) {
      result << "public cParser_" ;
      result << enumerator_404.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 11)).stringValue () ;
      if (enumerator_404.hasNextObject ()) {
        result << ",\n" ;
        result.appendSpacesUntilColumn (columnMarker) ;
      }
      index_404_.increment () ;
      enumerator_404.gotoNextObject () ;
    }
  }
  result << " {\n" ;
  GALGAS_uint index_522_ (0) ;
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_522 (in_NON_5F_TERMINAL_5F_MAP, kEnumeration_up) ;
    while (enumerator_522.hasCurrentObject ()) {
      result << "//------------------------------------- '" ;
      result << enumerator_522.current_lkey (HERE).reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 17)).stringValue () ;
      result << "' non terminal\n"
        "//--- 'parse' label\n"
        "  public : virtual void nt_" ;
      result << enumerator_522.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 20)).stringValue () ;
      result << "_parse (" ;
      columnMarker = result.currentColumn () ;
      ...
      if (kBoolTrue == test_1) {
        result << "//--- indexing\n"
          "  public : virtual void nt_" ;
        result << enumerator_522.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 28)).stringValue () ;
        result << "_indexing (C_Lexique_" ;
        result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
        result << " * inCompiler) ;\n"
          "\n" ;
      ...
      GALGAS_uint index_1153_ (0) ;
      if (enumerator_522.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_1153 (enumerator_522.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
        while (enumerator_1153.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_1153.current_lkey (HERE).reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 31)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          result << enumerator_522.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 33)).stringValue () ;
          result << "_" ;
          result << enumerator_1153.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 33)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_1404_IDX (0) ;
          if (enumerator_1153.current_mFormalParametersList (HERE).isValid ()) {
            cEnumerator_signatureForGrammarAnalysis enumerator_1404 (enumerator_1153.current_mFormalParametersList (HERE), kEnumeration_up) ;
            while (enumerator_1404.hasCurrentObject ()) {
              const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1404.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 35)))).boolEnum () ;
              if (kBoolTrue == test_2) {
                result << "const GALGAS_" ;
                result << enumerator_1404.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 36)).stringValue () ;
                result << " inArgument" ;
                result << index_1404_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 36)).stringValue () ;
              }else if (kBoolFalse == test_2) {
                const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_1404.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 37)))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  result << "GALGAS_" ;
                  result << enumerator_1404.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 38)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_1404_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 38)).stringValue () ;
                }else if (kBoolFalse == test_3) {
                  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_1404.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 39)))).boolEnum () ;
                  if (kBoolTrue == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1404.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 40)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_1404_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 40)).stringValue () ;
                  }else if (kBoolFalse == test_4) {
                    result << "GALGAS_" ;
                    result << enumerator_1404.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 42)).stringValue () ;
                    result << " inArgument" ;
                    result << index_1404_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 42)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
              result.appendSpacesUntilColumn (columnMarker) ;
              index_1404_IDX.increment () ;
          ...
          result << " * inCompiler) ;\n"
            "\n" ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, in_START_5F_SYMBOL_5F_NAME.objectCompare (enumerator_522.current_lkey (HERE).reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 51)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            result << "//--- Start symbol\n"
              "  public : static void _performSourceFileParsing_" ;
            result << enumerator_1153.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 53)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            result << "GALGAS_lstring inFileName" ;
            GALGAS_uint index_2852_IDX (0) ;
            if (enumerator_1153.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2852 (enumerator_1153.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_2852.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_2852.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 61)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  result << "const GALGAS_" ;
                  result << enumerator_2852.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 62)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2852_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 62)).stringValue () ;
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_2852.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 63)))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    result << "GALGAS_" ;
                    result << enumerator_2852.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 64)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2852_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 64)).stringValue () ;
                  }else if (kBoolFalse == test_9) {
                    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_2852.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 65)))).boolEnum () ;
                    if (kBoolTrue == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2852.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 66)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2852_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 66)).stringValue () ;
                    }else if (kBoolFalse == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_2852.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 68)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2852_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 68)).stringValue () ;
                    }
                  }
                }
                index_2852_IDX.increment () ;
                enumerator_2852.gotoNextObject () ;
              }
            }
            result << "\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "COMMA_LOCATION_ARGS) ;\n"
              "\n"
              "  public : static void _performSourceStringParsing_" ;
            result << enumerator_1153.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 72)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            if (enumerator_1153.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_4100 (enumerator_1153.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_4100.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_4100.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 80)))).boolEnum () ;
                if (kBoolTrue == test_12) {
                  result << "const GALGAS_" ;
                  result << enumerator_4100.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 81)).stringValue () ;
                  result << " inArgument" ;
                  result << index_4100_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 81)).stringValue () ;
                }else if (kBoolFalse == test_12) {
                  const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_4100.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 82)))).boolEnum () ;
                  if (kBoolTrue == test_13) {
                    result << "GALGAS_" ;
                    result << enumerator_4100.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 83)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_4100_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 83)).stringValue () ;
                  }else if (kBoolFalse == test_13) {
                    const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_4100.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 84)))).boolEnum () ;
                    if (kBoolTrue == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4100.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 85)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_4100_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 85)).stringValue () ;
                    }else if (kBoolFalse == test_14) {
                      result << "GALGAS_" ;
                      result << enumerator_4100.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 87)).stringValue () ;
                      result << " inArgument" ;
                      result << index_4100_IDX.reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 87)).stringValue () ;
                    }
                  }
                }
      ...
      const enumGalgasBool test_15 = in_HAS_5F_INDEXING.operator_and (GALGAS_bool (kIsEqual, in_START_5F_SYMBOL_5F_NAME.objectCompare (enumerator_522.current_lkey (HERE).reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 94)))) COMMA_SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 94)).boolEnum () ;
      if (kBoolTrue == test_15) {
        result << "//--- Start symbol indexing\n"
          "  public : static void performIndexing (" ;
        columnMarker = result.currentColumn () ;
      ...
      index_522_.increment () ;
      enumerator_522.gotoNextObject () ;
    }
  }
  GALGAS_uint index_5305_ (0) ;
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_5305 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_5305.hasCurrentObject ()) {
      result << "  public : virtual int32_t select_" ;
      result << enumerator_5305.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 102)).stringValue () ;
      result << "_" ;
      result << enumerator_5305.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE ("grammar-zone3-galgas3.h.gTemplate", 102)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  while (enumerator_22871.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_4) {
        GALGAS_lstring joker_23462_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE ("grammarCompilation.gSemantics", 529)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here ()  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 529)), joker_23462_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 529)) ;
      }else if (kBoolFalse == test_4) {
  ...
  while (enumerator_28016.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_28124_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_28016.current_mValue (HERE), var_nonterminalIndex, joker_28124_0, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 607)) ;
    {
  ...
  if (kBoolTrue == test_18) {
    GALGAS_bool joker_29735_0 ; // Joker input parameter
    var_grammarHTMLHelperContents.method_writeToFileWhenDifferentContents (var_HTMLFilePath, joker_29735_0, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 636)) ;
...
void routine_compileGrammarComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("*** Analyzing '").add_operation (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 715)), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 715)).add_operation (GALGAS_string ("' grammar\n"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 715))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 715)) ;
  }
  GALGAS_terminalSymbolsMapForGrammarAnalysis var_actuallyUsedTerminalSymbolMap = GALGAS_terminalSymbolsMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("grammarCompilation.gSemantics", 718)) ;
  GALGAS_nonTerminalSymbolMapForGrammarAnalysis var_nonTerminalMapForGrammarAnalysis = GALGAS_nonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("grammarCompilation.gSemantics", 719)) ;
  GALGAS_lstring var_lexiqueComponentName = GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("grammarCompilation.gSemantics", 720)) ;
  GALGAS_syntaxComponentListForGrammarAnalysis var_syntaxComponentListForGrammarAnalysis = GALGAS_syntaxComponentListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE ("grammarCompilation.gSemantics", 721)) ;
  GALGAS_nonTerminalToAddList var_nonTerminalToAddList = GALGAS_nonTerminalToAddList::constructor_emptyList (SOURCE_FILE ("grammarCompilation.gSemantics", 722)) ;
  GALGAS_uint var_addedNonTerminalCount = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_lstringlist enumerator_33081 (constinArgument_inGrammarComponentRoot.mAttribute_mSyntaxComponents, kEnumeration_up) ;
  while (enumerator_33081.hasCurrentObject ()) {
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    GALGAS_string var_syntaxComponentName = enumerator_33081.current_mValue (HERE).mAttribute_string ;
    ...
    constinArgument_inSemanticContext.mAttribute_mSyntaxComponentMapForSemanticAnalysis.method_searchKey (enumerator_33081.current_mValue (HERE), var_lexiqueName, var_nonterminalDeclarationList, var_ruleList, var_hasTranslateFeature, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 727)) ;
    const enumGalgasBool test_1 = constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_and (var_hasTranslateFeature.operator_not (SOURCE_FILE ("grammarCompilation.gSemantics", 735)) COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 735)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (enumerator_33081.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      const enumGalgasBool test_3 = var_hasTranslateFeature.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE ("grammarCompilation.gSemantics", 737)) COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 737)).boolEnum () ;
      if (kBoolTrue == test_3) {
    ...
    if (kBoolTrue == test_5) {
      ...
      if (kBoolTrue == test_6) {
        GALGAS_location location_7 (enumerator_33081.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_7, GALGAS_string ("this syntax component uses '").operator_concat (var_lexiqueName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 744))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 744)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 745)).operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 745))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 745)).operator_concat (GALGAS_string ("' lexique component (they should be the same)")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 746))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 744)) ;
      }
    }
    {
    routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_nonterminalDeclarationList, inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 749)) ;
    }
    {
    routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_ruleList, inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 754)) ;
    }
    {
    routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, enumerator_33081.current_mValue (HERE), var_ruleList, var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 759)) ;
    }
    GALGAS_uint var_i = GALGAS_uint ((uint32_t) 0U) ;
    if (var_addedNonTerminalCount.isValid ()) {
      uint32_t variant_34995 = var_addedNonTerminalCount.uintValue () ;
      bool loop_34995 = true ;
      while (loop_34995) {
        loop_34995 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 768)))).isValid () ;
        if (loop_34995) {
          loop_34995 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 768)))).boolValue () ;
        }
        if (loop_34995 && (0 == variant_34995)) {
          loop_34995 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("grammarCompilation.gSemantics", 768)) ;
        }
        if (loop_34995) {
          variant_34995 -- ;
          var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 769)) ;
          var_i.increment_operation (inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 770)) ;
        }
      }
    }
    enumerator_33081.gotoNextObject () ;
  }
  GALGAS_stringset var_lexiqueComponentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("grammarCompilation.gSemantics", 774)) ;
  GALGAS_lstring var_inIndexingDirectory ;
  GALGAS_terminalMap joker_35436_0 ; // Joker input parameter
  GALGAS_indexingListAST joker_35472_0 ; // Joker input parameter
  constinArgument_inSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (var_lexiqueComponentName, joker_35436_0, joker_35472_0, var_inIndexingDirectory, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 775)) ;
  GALGAS_bool var_hasIndexing = var_inIndexingDirectory.mAttribute_location.reader_isNowhere (SOURCE_FILE ("grammarCompilation.gSemantics", 781)).operator_not (SOURCE_FILE ("grammarCompilation.gSemantics", 781)) ;
  const enumGalgasBool test_8 = var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE ("grammarCompilation.gSemantics", 782)) COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 782)).boolEnum () ;
  if (kBoolTrue == test_8) {
    ...
    inCompiler->emitSemanticError (location_9, GALGAS_string ("the grammar does not enable indexing, but the '").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 783))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 783)).operator_concat (GALGAS_string ("' does")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 783))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 783)) ;
  }else if (kBoolFalse == test_8) {
    const enumGalgasBool test_10 = var_hasIndexing.operator_not (SOURCE_FILE ("grammarCompilation.gSemantics", 784)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 784)).boolEnum () ;
    if (kBoolTrue == test_10) {
      ...
      inCompiler->emitSemanticError (location_11, GALGAS_string ("the grammar enables indexing, but the '").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 785))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 785)).operator_concat (GALGAS_string ("' does not")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 785))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 785)) ;
    }
  }
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap ;
  GALGAS_uint var_startSymbolIndex ;
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE ("grammarCompilation.gSemantics", 791)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 791)) ;
  {
  routine_checkLabelMap (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE ("grammarCompilation.gSemantics", 794)).reader_location (SOURCE_FILE ("grammarCompilation.gSemantics", 794)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE ("grammarCompilation.gSemantics", 795)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE ("grammarCompilation.gSemantics", 796)).reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 796)), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 796)), var_startSymbolAltMap, inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 793)) ;
  }
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE ("grammarCompilation.gSemantics", 800)) ;
  cEnumerator_lstringlist enumerator_36916 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE ("grammarCompilation.gSemantics", 801)), kEnumeration_up) ;
  while (enumerator_36916.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_37024_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_36916.current_mValue (HERE), var_nonterminalIndex, joker_37024_0, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 803)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_36916.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 804)) ;
    }
    enumerator_36916.gotoNextObject () ;
  }
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE ("grammarCompilation.gSemantics", 807)) ;
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_37381 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_37381.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_37381.current_lkey (HERE), enumerator_37381.current_mNonTerminalIndex (HERE), enumerator_37381.current_mNonterminalSymbolParametersMap (HERE)  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 809)) ;
    enumerator_37381.gotoNextObject () ;
  }
  GALGAS_stringset var_implementationFileHeader = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("grammarCompilation.gSemantics", 814)) ;
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_37891 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_37891.hasCurrentObject ()) {
    cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_37940 (enumerator_37891.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
    while (enumerator_37940.hasCurrentObject ()) {
      cEnumerator_signatureForGrammarAnalysis enumerator_37981 (enumerator_37940.current_mFormalParametersList (HERE), kEnumeration_up) ;
      while (enumerator_37981.hasCurrentObject ()) {
        if (enumerator_37981.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).isValid ()) {
          switch (enumerator_37981.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).enumValue ()) {
          ...
          case GALGAS_formalArgumentPassingModeAST::kEnum_argumentIn: case GALGAS_formalArgumentPassingModeAST::kEnum_argumentConstantIn: {
            GALGAS_unifiedTypeMapProxy var_t = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inSemanticContext.mAttribute_mTypeMap, enumerator_37981.current_mGalgasTypeNameForGrammarAnalysis (HERE), inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 820)) ;
            categoryMethod_addHeaderFileName (var_t, var_implementationFileHeader, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 821)) ;
            } break ;
          case GALGAS_formalArgumentPassingModeAST::kEnum_argumentInOut: case GALGAS_formalArgumentPassingModeAST::kEnum_argumentOut: {
            } break ;
          }
        }
        enumerator_37981.gotoNextObject () ;
      }
      enumerator_37940.gotoNextObject () ;
    }
  ...
  if (kBoolTrue == test_12) {
    var_implementationFileHeader = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("grammarCompilation.gSemantics", 828)) ;
  }
  var_implementationFileHeader.addAssign_operation (GALGAS_string ("grammar-").operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 830))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 830))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 830)) ;
  var_implementationFileHeader.addAssign_operation (GALGAS_string ("lexique-").operator_concat (var_lexiqueComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 831))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 831))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 831)) ;
  GALGAS_string var_HTMLFilePath = constinArgument_inOutputDirectory.operator_concat (GALGAS_string ("/../helpers/")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 833)).operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.reader_string (SOURCE_FILE ("grammarCompilation.gSemantics", 833))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 833)).operator_concat (GALGAS_string (".html")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 833)) ;
  GALGAS_string var_grammarCppFile ;
  GALGAS_string var_grammarHTMLHelperContents ;
  {
  ...
  if (kBoolTrue == test_14) {
    temp_13 = function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 846)) ;
  }else if (kBoolFalse == test_14) {
    temp_13 = GALGAS_string::makeEmptyString () ;
  }
  routine_grammarAnalysisAndGeneration (var_implementationFileHeader, constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName, constinArgument_inGrammarComponentRoot.reader_mGrammarClass (SOURCE_FILE ("grammarCompilation.gSemantics", 837)), var_startSymbolIndex, var_lexiqueComponentName.mAttribute_string, var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, var_HTMLFilePath, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, temp_13, var_grammarCppFile, var_grammarHTMLHelperContents, inCompiler  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 834)) ;
  }
  GALGAS_string var_headerContents = GALGAS_string::makeEmptyString () ;
  const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("grammarCompilation.gSemantics", 852)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_15) {
    var_headerContents = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_HeaderGalgas_33_ (inCompiler, constinArgument_inGrammarComponentRoot COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 853))) ;
    var_headerContents.dotAssign_operation (GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_HeaderGalgas_33_ (inCompiler, var_lexiqueComponentName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("grammarCompilation.gSemantics", 857)), var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing, constinArgument_inGrammarComponentRoot.mAttribute_mStartSymbolName.mAttribute_string, constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature, constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string, constinArgument_inGrammarComponentRoot.mAttribute_mSyntaxComponents COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 856)))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 856)) ;
  }
  ...
  if (kBoolTrue == test_16) {
    GALGAS_bool joker_40418_0 ; // Joker input parameter
    var_grammarHTMLHelperContents.method_writeToFileWhenDifferentContents (var_HTMLFilePath, joker_40418_0, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 869)) ;
  }else if (kBoolFalse == test_16) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_HTMLFilePath, inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 871)) ;
    }
  }
  ioArgument_ioGrammarGenerationList.addAssign_operation (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string, var_headerContents, var_grammarCppFile  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 874)) ;
}
...
void routine_generateGrammarComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_grammarComponentGenerationList enumerator_41351 (constinArgument_inGrammarGenerationList, kEnumeration_up) ;
  while (enumerator_41351.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("grammarCompilation.gSemantics", 895)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioToolProductFileList.addAssign_operation (GALGAS_string ("grammar-").add_operation (enumerator_41351.current_mGrammarName (HERE), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 896)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 896))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 896)) ;
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("grammar-").add_operation (enumerator_41351.current_mGrammarName (HERE), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 897)).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 897))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 897)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("grammar-").add_operation (enumerator_41351.current_mGrammarName (HERE), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 900)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 900)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_41351.current_mCppFileContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 898)) ;
      }
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("grammarCompilation.gSemantics", 909)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      ioArgument_ioAllProductFileSet.addAssign_operation (GALGAS_string ("grammar-").add_operation (enumerator_41351.current_mGrammarName (HERE), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 910)).add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 910))  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 910)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("grammar-").operator_concat (enumerator_41351.current_mGrammarName (HERE)  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 913)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 913)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), enumerator_41351.current_mHeaderContents (HERE), GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("grammarCompilation.gSemantics", 911)) ;
      }
    }
