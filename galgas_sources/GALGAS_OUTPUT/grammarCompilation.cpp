...
//                    november 30th, 2010, at 17h34'46"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_8 (var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573))) ;
  if (test_8.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_10 (var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (575)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (575))) ;
    if (test_10.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_12 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (619)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
