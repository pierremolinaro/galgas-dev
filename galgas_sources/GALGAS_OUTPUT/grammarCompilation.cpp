...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  ::routine_checkLabelMap (inLexique,  var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (475)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (475)),  var_cas_grammarComponentRoot.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (476)),  GGS_bool (false),  var_cas_nonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (478)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (478)) COMMA_SOURCE_FILE_AT_LINE (478)),  var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (474)) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20599 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (483)), true) ;
    const GGS_lstringlist::cElement * operand_20599 = NULL ;
    while (((operand_20599 = enumerator_20599.nextObject ()))) {
      ...
      const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_20723 = var_cas_nonTerminalMapForGrammarAnalysis ;
      if (temp_20723.isBuilt ()) {
        temp_20723 (HERE)->method_searchKey (inLexique, operand_20599->mValue, var_cas_nonterminalIndex, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (485)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_20599->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (486)) ;
    }
  }
