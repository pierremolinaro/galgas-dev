...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_21424 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_21424 = NULL ;
    while (((operand_21424 = enumerator_21424.nextObject ()))) {
      ...
      const GGS_syntaxRuleLabelList  temp_21566 = operand_21424->mLabelList ;
      if (temp_21566.isBuilt ()) {
        temp_21566 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (545)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ...
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_21424->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_lstring  var_cas_grammarComponentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (562)) ;
  const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (563)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (563)) ;
  if (((var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_grammarComponentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (566)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22988 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (574)), true) ;
    const GGS_lstringlist::cElement * operand_22988 = NULL ;
    while (((operand_22988 = enumerator_22988.nextObject ()))) {
      macroValidPointer (operand_22988) ;
      if (((operand_22988->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (575))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_22988->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (577)) ;
      }else{
        GGS_string var_cas_syntaxComponentName = operand_22988->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (578)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (580)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (580))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_23490 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
          if (temp_23490.isBuilt ()) {
            temp_23490 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (581)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath = operand_22988->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (583)) COMMA_SOURCE_FILE_AT_LINE (583)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_22988->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (584)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_22988->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (585)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (585)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (588)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (588)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (588)) ;
        if (((var_cas_lexiqueComponentName).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_22988->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (595)) ;
        }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_25291 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_25291 = NULL ;
    while (((operand_25291 = enumerator_25291.nextObject ()))) {
      macroValidPointer (operand_25291) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_25291->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_25291->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_25291->mSyntaxComponentName,  operand_25291->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (621)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_25291->mSyntaxComponentName, operand_25291->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("  Building pure BNF productions... ")).operator_concat (var_cas_pureSyntaxRuleListForGrammar.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (654)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (654)))).operator_concat (GGS_string (" productions\n")) COMMA_SOURCE_FILE_AT_LINE (654)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all productions are differents...") COMMA_SOURCE_FILE_AT_LINE (659)) ;
  }
  GGS_string var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (661))).operator_concat (GGS_string (".html")) ;
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_27429 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_27429 = NULL ;
    while (((operand_27429 = enumerator_27429.nextObject ()))) {
      macroValidPointer (operand_27429) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_27467 (operand_27429->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_27467 = NULL ;
        while (((operand_27467 = enumerator_27467.nextObject ()))) {
          macroValidPointer (operand_27467) ;
          const GGS_syntaxInstruction  temp_27524 = operand_27467->mInstruction ;
          if (temp_27524.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_27524.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_27524 (HERE), var_cas_terminalMap, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (670)) ;
            }
          }
        }
      }
  ...
  GGS_uint  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (673)) ;
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
      GGS_uint var_cas_idx (true, 0) ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_27774 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_27774 = NULL ;
    while (((operand_27774 = enumerator_27774.nextObject ()))) {
      macroValidPointer (operand_27774) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_27774->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (677)) COMMA_SOURCE_FILE_AT_LINE (677))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_27774->mLeftNonTerminal, var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (678)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (678)) COMMA_SOURCE_FILE_AT_LINE (678)) COMMA_SOURCE_FILE_AT_LINE (678)) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_27774->mLeftNonTerminal)).operator_concat (GGS_string (">"))) ;
      }
      if (((operand_27774->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (681))).operator_strictSup (GGS_uint (2U))).isBuiltAndTrue ()) {
        var_cas_additionalNonTerminalSymbolsForPureBDDrules = var_cas_additionalNonTerminalSymbolsForPureBDDrules.add_operation (inLexique, operand_27774->mSyntaxInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)).substract_operation (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (682)) ;
      }
      GGS_uint64list  var_cas_rightDerivation = GGS_uint64list ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28311 (operand_27774->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28311 = NULL ;
        while (((operand_28311 = enumerator_28311.nextObject ()))) {
          macroValidPointer (operand_28311) ;
          const GGS_syntaxInstruction  temp_28371 = operand_28311->mInstruction ;
          if (temp_28371.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_28371.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28371 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (686)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_27774->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (689)) COMMA_SOURCE_FILE_AT_LINE (689)) ;
      GGS_bool var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_28683 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_28683 = NULL ;
        while (((operand_28683 = enumerator_28683.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_28683) ;
          if (((operand_28683->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            var_cas_ok = GGS_bool (false) ;
            if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (694))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
              inLexique.printMessage (GGS_string (" error\n") COMMA_SOURCE_FILE_AT_LINE (695)) ;
            }
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_27774->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_28683->mProductionIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (700)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (701)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_27774->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (709)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        GGS_uint  var_cas_leftTerminalIndex ;
        const GGS_vocabularyMap  temp_29634 = var_cas_nonterminalMap ;
        if (temp_29634.isBuilt ()) {
          temp_29634 (HERE)->method_searchKey (inLexique, operand_27774->mLeftNonTerminal, var_cas_leftTerminalIndex COMMA_SOURCE_FILE_AT_LINE (713)) ;
        }
        var_cas_productionListMap.addAssign_operation (operand_27774->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), var_cas_leftTerminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (714)), var_cas_idx, var_cas_rightDerivation) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (717))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_30083 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (722)), true) ;
    const GGS_lstringlist::cElement * operand_30083 = NULL ;
    while (((operand_30083 = enumerator_30083.nextObject ()))) {
      macroValidPointer (operand_30083) ;
      elementOf_GGS_vocabularyMap * operand_30156 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, operand_30083->mValue, GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (723)) ;
      if (NULL != operand_30156) {
        var_cas_unusedNonterminalSymbolList.addAssign_operation (operand_30156->mInfo.mIndex) ;
      }else{
        operand_30083->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_30083->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (727)) ;
      }
    }
  }
  GGS_uint  var_cas_startSymbolIndex ;
  elementOf_GGS_vocabularyMap * operand_30486 = (elementOf_GGS_vocabularyMap *) var_cas_nonterminalMap.searchForWithInstruction (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (731)), GGS_vocabularyMap::kSearchMessage_searchKey COMMA_SOURCE_FILE_AT_LINE (731)) ;
  if (NULL != operand_30486) {
    var_cas_startSymbolIndex = operand_30486->mInfo.mIndex ;
  }else{
    var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (734)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (734)))).operator_concat (GGS_string (">' non terminal is not declared by syntax components, it cannot be used as start symbol")) COMMA_SOURCE_FILE_AT_LINE (737)) ;
  ...
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (902)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_identicalDerivationErrorMessageList, var_cas_HTMLFileHeader, var_cas_HTMLFileContents) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_41742 = var_cas_s ;
    if (temp_41742.isBuilt ()) {
      temp_41742 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
  }else{
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_htmlOutputFileName COMMA_SOURCE_FILE_AT_LINE (923)) ;
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (929))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (938)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponentName, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (927)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
