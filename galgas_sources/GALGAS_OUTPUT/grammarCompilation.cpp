...
static GGS_object functionForGenericCall_transformLabelMap (C_Compiler & inLexique,
                           ...
                           COMMA_LOCATION_ARGS) {
  const GGS_nonTerminalLabelList  arg_0 = GGS_nonTerminalLabelList ::castFromObject (inLexique, inEffectiveParameterArray [0], inErrorLocation COMMA_THERE) ;
  const GGS_bool arg_1 = GGS_bool::castFromObject (inLexique, inEffectiveParameterArray [1], inErrorLocation COMMA_THERE) ;
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_addedNonTerminalCount = GGS_uint (0U) ;
  {
    ...
    while (((operand_17634 = enumerator_17634.nextObject ()))) {
      ...
      const GGS_bool cond_17870 = ((operand_17634->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_17634->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_17870.isBuiltAndTrue ()) {
        ...
        GGS_string var_cas_syntaxComponentName = operand_17634->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        const GGS_bool cond_18262 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (436)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_18262.isBuiltAndTrue ()) {
          ...
          GGS_string var_cas_sourceFilePath = operand_17634->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
        ...
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (444)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
