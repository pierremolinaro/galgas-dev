...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_HeaderGalgas_33_ (C_Compiler * /* inCompiler */,
  ...
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (6)).isValid ()) {
    ...
    while (enumerator_354.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_354.current_mValue (HERE).mAttribute_string.stringValue () ;
      result << ".h\"\n" ;
      index_354_.increment () ;
      enumerator_354.gotoNextObject () ;
    }
...
void routine_compileGrammarComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  ioArgument_ioToolProductFileList.addAssign_operation (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string.add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE_AT_LINE (782)) COMMA_SOURCE_FILE_AT_LINE (782)) ;
  {
  //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_13) {
    ...
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, constinArgument_inGrammarComponentRoot.mAttribute_mGrammarComponentName.mAttribute_string.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (813)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
