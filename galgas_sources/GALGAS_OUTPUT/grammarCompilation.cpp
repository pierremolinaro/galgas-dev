...
GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis function_transformLabelMap (const GALGAS_nonTerminalLabelListAST & constinArgument_inLabels,
  ...
  cEnumerator_nonTerminalLabelListAST enumerator_1985 (constinArgument_inLabels, kEnumeration_up) ;
  ...
  while (enumerator_1985.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_2088 (enumerator_1985.current_mFormalArgumentList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    ...
    result_outNonterminalSymbolLabelMapForGrammarAnalysis.modifier_insertKey (enumerator_1985.current_mLabelName (HERE), var_formalParametersList, inCompiler COMMA_SOURCE_FILE_AT_LINE (40)) ;
  ...
  if (kBoolTrue == test_0) {
    { //-------- @modifierCallInstructionForGeneration
    result_outNonterminalSymbolLabelMapForGrammarAnalysis.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("parse"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (47)), GALGAS_signatureForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (48)), inCompiler COMMA_SOURCE_FILE_AT_LINE (46)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
//---
...
void routine_checkLabelMap (const GALGAS_location constinArgument_inNonTerminalLocation,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonTerminalLabelListAST enumerator_2957 (constinArgument_inLabels, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_2957.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_3736 (enumerator_2957.current_mFormalArgumentList (HERE), kEnumeration_up) ;
      cEnumerator_signatureForGrammarAnalysis enumerator_3760 (var_formalParametersList, kEnumeration_up) ;
      //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_5315 (constinArgument_inNonterminalSymbolLabelMapForGrammarAnalysis, kEnumeration_up) ;
  //--- simple foreach instruction
...
void routine_handleNonTerminalDeclarations (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonterminalDeclarationListAST enumerator_5932 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
...
void routine_handleNonTerminalDeclarationsFromRuleList (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                                        ...
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_6777 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_6777.hasCurrentObject ()) {
    ...
    if (NULL != objectArray_6789) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_syntaxRuleLabelListAST enumerator_6966 (enumerator_6777.current_mLabelList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
...
void routine_transformInstructionList (const GALGAS_syntaxInstructionList constinArgument_inInstructionList,
                                       ...
                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxInstructionList enumerator_8770 (constinArgument_inInstructionList, kEnumeration_up) ;
  //--- simple foreach instruction
...
void routine_buildRuleList (const GALGAS_nonTerminalSymbolMapForGrammarAnalysis constinArgument_inNonTerminalMapForGrammarAnalysis,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_syntaxRuleListAST enumerator_15432 (constinArgument_inRuleList, kEnumeration_up) ;
  //--- simple foreach instruction
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
  ...
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_391 (in_NON_5F_TERMINAL_5F_MAP, kEnumeration_up) ;
    while (enumerator_391.hasCurrentObject ()) {
      ...
      if (enumerator_391.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_511 (enumerator_391.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
        while (enumerator_511.hasCurrentObject ()) {
          ...
          if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
            cEnumerator_signatureForGrammarAnalysis enumerator_642 (enumerator_511.current_mFormalParametersList (HERE), kEnumeration_up) ;
          ...
          if (kBoolTrue == test_4) {
            ...
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2237 (enumerator_511.current_mFormalParametersList (HERE), kEnumeration_up) ;
            ...
            if (enumerator_511.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3369 (enumerator_511.current_mFormalParametersList (HERE), kEnumeration_up) ;
  ...
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4390 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (451)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (451)) ;
  ...
  if (NULL != objectArray_18166) {
    ...
    cGrammar_grammarLL_31_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, outArgument_outGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (455)) ;
    } //-------- END @grammarInstructionWithSourceFileForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_basename, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (457)), constinArgument_inSourceFile, outArgument_outGrammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (456)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_21382 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (515)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_21382.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_21382.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (517)).objectCompare (GALGAS_string ("gSyntax"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_21382.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_syntaxComponentName = enumerator_21382.current_mValue (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (520)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (520)) ;
      //-------- @localVariableDeclarationForGeneration
      ...
      if (kBoolTrue == test_4) {
        //-------- @methodCallInstructionForGeneration
        GALGAS_lstring joker_21952_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (523)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (523)), joker_21952_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (523)) ;
        //-------- END @methodCallInstructionForGeneration
      }else if (kBoolFalse == test_4) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_sourceFilePath = enumerator_21382.current_mValue (HERE).mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (525)) COMMA_SOURCE_FILE_AT_LINE (525)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_lstring var_lSourceFilePath = GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_21382.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (526)) COMMA_SOURCE_FILE_AT_LINE (526)) ;
        { //-------- @grammarInstructionWithSourceFileForGeneration
        cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, var_lSourceFilePath, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (527)) ;
        } //-------- END @grammarInstructionWithSourceFileForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_21382.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (528)), var_lSourceFilePath, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
      //-------- @assignmentInstructionForGeneration
      var_lexiqueComponentPath = var_syntaxComponentRoot.reader_mImportedLexiqueFilePath (SOURCE_FILE_AT_LINE (531)) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_currentLexiqueName = var_lexiqueComponentPath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (532)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (532)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_6) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_7 (enumerator_21382.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, GALGAS_string ("this syntax component uses '").operator_concat (var_currentLexiqueName COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '") COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (var_lexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (538)).operator_concat (GALGAS_string ("' lexique component (they should be the same)") COMMA_SOURCE_FILE_AT_LINE (538)) COMMA_SOURCE_FILE_AT_LINE (536)) ;
        }
      }
      { //-------- @routineCallInstructionForGeneration
      routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mNonterminalDeclarationList (SOURCE_FILE_AT_LINE (543)), inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (548)), inCompiler COMMA_SOURCE_FILE_AT_LINE (546)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mSyntaxComponentName (SOURCE_FILE_AT_LINE (553)), var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (554)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_uint var_i = GALGAS_uint ((PMUInt32) 0U) ;
      //-------- @loopInstructionForGeneration
      if (var_addedNonTerminalCount.isValid ()) {
        PMUInt32 variant_23846 = var_addedNonTerminalCount.uintValue () ;
        bool loop_23846 = true ;
        while (loop_23846) {
          loop_23846 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)))).isValid () ;
          if (loop_23846) {
            loop_23846 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)))).boolValue () ;
          }
          if (loop_23846 && (0 == variant_23846)) {
            loop_23846 = false ;
          ...
          if (loop_23846) {
            variant_23846 -- ;
            //-------- @plusEqualnstructionForGeneration
            var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i COMMA_SOURCE_FILE_AT_LINE (561)) ;
            //-------- @incrementInstructionForGeneration
            var_i.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (562)) ;
          }
        }
      }
    }
    enumerator_21382.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_lexiqueComponentAST var_lexiqueComponentAST ;
  { //-------- @routineCallInstructionForGeneration
  routine_parseLexiqueComponent (GALGAS_lstring::constructor_new (var_lexiqueComponentPath.mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (569)), var_lexiqueComponentPath.reader_location (SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (569)), ioArgument_ioParsedComponentStruct, var_lexiqueComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (568)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_hasIndexing = var_lexiqueComponentAST.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (573)).mAttribute_location.reader_isNowhere (SOURCE_FILE_AT_LINE (573)).operator_not (SOURCE_FILE_AT_LINE (573)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_8 = var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (574)) COMMA_SOURCE_FILE_AT_LINE (574)).boolEnum () ;
  if (kBoolTrue == test_8) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_9, GALGAS_string ("the grammar enables indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)).operator_concat (GALGAS_string ("' does not") COMMA_SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)) ;
  }else if (kBoolFalse == test_8) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (576)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (576)).boolEnum () ;
    if (kBoolTrue == test_10) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (583)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkLabelMap (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (586)).reader_location (SOURCE_FILE_AT_LINE (586)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (587)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolHasParseLabel (SOURCE_FILE_AT_LINE (588)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (589)).reader_string (SOURCE_FILE_AT_LINE (589)), inCompiler COMMA_SOURCE_FILE_AT_LINE (589)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (585)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (593)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_25883 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (594)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25883.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_uint var_nonterminalIndex ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_25989_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_25883.current_mValue (HERE), var_nonterminalIndex, joker_25989_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_25883.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_25883.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (600)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26348 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26348.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_26348.current_lkey (HERE), enumerator_26348.current_mNonTerminalIndex (HERE), enumerator_26348.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (602)) ;
    enumerator_26348.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  routine_grammarAnalysisAndGeneration (constinArgument_inGrammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (606)), constinArgument_inGrammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (607)), var_startSymbolIndex, var_lexiqueComponentName, constinArgument_inGrammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (610)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectoryForCppFiles, var_outputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (605)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (620)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_12) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (inCompiler, constinArgument_inGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (621))) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (inCompiler, var_lexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (625)), constinArgument_inGrammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (624))) ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectoryForCppFiles, constinArgument_inGrammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (633)).reader_string (SOURCE_FILE_AT_LINE (633)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (633)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (631)) ;
    } //-------- @routineCallInstructionForGeneration
  }
}
...
void routine_compileGrammarComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_parseGrammarComponent (constinArgument_inSourceFile, ioArgument_ioParsedComponentStruct, var_grammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (651)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_compileGrammarComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectoryForCppFiles, var_grammarComponentRoot, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (653)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static void categoryMethod_repeatInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_11437 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_selectInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_listOfSyntaxInstructionList enumerator_12520 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
