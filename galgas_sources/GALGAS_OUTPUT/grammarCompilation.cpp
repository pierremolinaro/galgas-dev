...
void routine_handleNonTerminalDeclarations (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_nonterminalDeclarationListAST enumerator_5321 (constinArgument_inNonterminalDeclarationList, kEnumeration_up) ;
  while (enumerator_5321.hasCurrentObject ()) {
    ...
    cMapElement_nonTerminalSymbolMapForGrammarAnalysis * objectArray_5333 = (cMapElement_nonTerminalSymbolMapForGrammarAnalysis *) ioArgument_ioNonTerminalMapForGrammarAnalysis.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_5321.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)) ;
    if (NULL != objectArray_5333) {
        macroValidSharedObject (objectArray_5333, cMapElement_nonTerminalSymbolMapForGrammarAnalysis) ;
      {
      routine_checkLabelMap (enumerator_5321.current_mNonterminalName (HERE).reader_location (SOURCE_FILE_AT_LINE (110)), enumerator_5321.current_mLabels (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (enumerator_5321.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (112)), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)), objectArray_5333->mAttribute_mNonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
      }
    }else{
      {
      ioArgument_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (enumerator_5321.current_mNonterminalName (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_count (SOURCE_FILE_AT_LINE (118)), function_transformLabelMap (enumerator_5321.current_mLabels (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (119)), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
      }
    }
...
void routine_handleNonTerminalDeclarationsFromRuleList (GALGAS_nonTerminalSymbolMapForGrammarAnalysis & ioArgument_ioNonTerminalMapForGrammarAnalysis,
                                                        ...
                                                        C_Compiler * inCompiler
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_syntaxRuleListAST enumerator_6126 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_6126.hasCurrentObject ()) {
    ...
    cEnumerator_syntaxRuleLabelListAST enumerator_6219 (enumerator_6126.current_mLabelList (HERE), kEnumeration_up) ;
    while (enumerator_6219.hasCurrentObject ()) {
      var_nonTerminalLabelListAST.addAssign_operation (enumerator_6219.current_mLabelName (HERE), enumerator_6219.current_mFormalArguments (HERE), enumerator_6219.current_mEndOfArgumentLocation (HERE) COMMA_SOURCE_FILE_AT_LINE (134)) ;
      enumerator_6219.gotoNextObject () ;
    }
    // index 1: attribute 'mNonTerminalIndex', type @uint
    // index 2: attribute 'mNonterminalSymbolParametersMap', type @nonterminalSymbolLabelMapForGrammarAnalysis
    cMapElement_nonTerminalSymbolMapForGrammarAnalysis * objectArray_6369 = (cMapElement_nonTerminalSymbolMapForGrammarAnalysis *) ioArgument_ioNonTerminalMapForGrammarAnalysis.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_6126.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)) ;
    if (NULL != objectArray_6369) {
        macroValidSharedObject (objectArray_6369, cMapElement_nonTerminalSymbolMapForGrammarAnalysis) ;
      {
      routine_checkLabelMap (enumerator_6126.current_mNonterminalName (HERE).reader_location (SOURCE_FILE_AT_LINE (142)), var_nonTerminalLabelListAST, ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (enumerator_6126.current_mNonterminalName (HERE).reader_string (SOURCE_FILE_AT_LINE (144)), inCompiler COMMA_SOURCE_FILE_AT_LINE (144)), objectArray_6369->mAttribute_mNonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
      }
    }else{
      {
      ioArgument_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (enumerator_6126.current_mNonterminalName (HERE), ioArgument_ioNonTerminalMapForGrammarAnalysis.reader_count (SOURCE_FILE_AT_LINE (150)), function_transformLabelMap (var_nonTerminalLabelListAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (151)), inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
      }
    }
...
void routine_buildRuleList (const GALGAS_nonTerminalSymbolMapForGrammarAnalysis constinArgument_inNonTerminalMapForGrammarAnalysis,
                            ...
                            C_Compiler * inCompiler
                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_productionRuleListForGrammarAnalysis var_productionRulesList = GALGAS_productionRuleListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (371)) ;
  cEnumerator_syntaxRuleListAST enumerator_14985 (constinArgument_inRuleList, kEnumeration_up) ;
  while (enumerator_14985.hasCurrentObject ()) {
    ...
    constinArgument_inNonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_14985.current_mNonterminalName (HERE), var_nonTerminalIndex, var_nonterminalSymbolParametersMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) ;
    GALGAS_syntaxInstructionList var_parsedSyntaxInstructionList ;
    GALGAS_lstring joker_15347_0 ; // Joker input parameter
    GALGAS_formalParameterListAST joker_15350_0 ; // Joker input parameter
    GALGAS_location joker_15353_0 ; // Joker input parameter
    GALGAS_location joker_15385_0 ; // Joker input parameter
    enumerator_14985.current_mLabelList (HERE).method_first (joker_15347_0, joker_15350_0, joker_15353_0, var_parsedSyntaxInstructionList, joker_15385_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (377)) ;
    GALGAS_syntaxInstructionListForGrammarAnalysis var_instructionList = GALGAS_syntaxInstructionListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (379)) ;
    {
    routine_transformInstructionList (var_parsedSyntaxInstructionList, ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalMapForGrammarAnalysis, ioArgument_ioAddedNonTerminalCount, var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
    }
    var_productionRulesList.addAssign_operation (enumerator_14985.current_mNonterminalName (HERE), var_nonTerminalIndex, var_instructionList, var_productionRulesList.reader_length (SOURCE_FILE_AT_LINE (392)) COMMA_SOURCE_FILE_AT_LINE (388)) ;
    enumerator_14985.gotoNextObject () ;
  }
  ioArgument_ioSyntaxComponentListForGrammarAnalysis.addAssign_operation (var_productionRulesList, constinArgument_inSyntaxComponentName COMMA_SOURCE_FILE_AT_LINE (395)) ;
}
...
void routine_parseGrammarComponent (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (440)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (440)) ;
  const cMapElement_parsedGrammarComponentMap * objectArray_17698 = (const cMapElement_parsedGrammarComponentMap *) ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.readAccessForWithInstruction_hasKey (var_basename) ;
  if (NULL != objectArray_17698) {
      macroValidSharedObject (objectArray_17698, cMapElement_parsedGrammarComponentMap) ;
    outArgument_outGrammarComponentRoot = objectArray_17698->mAttribute_mGrammarComponentRoot ;
  }else{
    cGrammar_grammarLL_31_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, outArgument_outGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (444)) ;
    {
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedGrammarComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_basename, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (446)), constinArgument_inSourceFile, outArgument_outGrammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (445)) ;
    }
  }
}
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectoryForHTMLFile = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (487)) ;
  GALGAS_lstring var_grammarComponentName = constinArgument_inGrammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (489)) ;
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (490)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (490)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_grammarComponentName.reader_string (SOURCE_FILE_AT_LINE (491)).objectCompare (var_basename)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (var_grammarComponentName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_grammarComponentName.reader_string (SOURCE_FILE_AT_LINE (493)) COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (494)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (494)) COMMA_SOURCE_FILE_AT_LINE (492)) ;
  }
  GALGAS_terminalSymbolsMapForGrammarAnalysis var_actuallyUsedTerminalSymbolMap = GALGAS_terminalSymbolsMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (498)) ;
  GALGAS_nonTerminalSymbolMapForGrammarAnalysis var_nonTerminalMapForGrammarAnalysis = GALGAS_nonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (499)) ;
  GALGAS_string var_lexiqueComponentName = GALGAS_string::makeEmptyString () ;
  GALGAS_lstring var_lexiqueComponentPath = GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE_AT_LINE (501)) ;
  GALGAS_syntaxComponentListForGrammarAnalysis var_syntaxComponentListForGrammarAnalysis = GALGAS_syntaxComponentListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (502)) ;
  GALGAS_nonTerminalToAddList var_nonTerminalToAddList = GALGAS_nonTerminalToAddList::constructor_emptyList (SOURCE_FILE_AT_LINE (503)) ;
  GALGAS_uint var_addedNonTerminalCount = GALGAS_uint ((uint32_t) 0U) ;
  cEnumerator_lstringlist enumerator_21008 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (505)), kEnumeration_up) ;
  while (enumerator_21008.hasCurrentObject ()) {
    GALGAS_uint var_addedNonTerminalCountRef = var_addedNonTerminalCount ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_21008.current_mValue (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (507)).objectCompare (GALGAS_string ("gSyntax"))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_21008.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("a syntax component file should have '.gSyntax' path extension") COMMA_SOURCE_FILE_AT_LINE (508)) ;
    }else if (kBoolFalse == test_2) {
      GALGAS_string var_syntaxComponentName = enumerator_21008.current_mValue (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (510)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (510)) ;
      GALGAS_syntaxComponentAST var_syntaxComponentRoot ;
      const enumGalgasBool test_4 = ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (512)).reader_hasKey (var_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (512)).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_lstring joker_21580_0 ; // Joker input parameter
        ioArgument_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (SOURCE_FILE_AT_LINE (513)).method_searchKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (513)), joker_21580_0, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
      }else if (kBoolFalse == test_4) {
        GALGAS_string var_sourceFilePath = enumerator_21008.current_mValue (HERE).mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (515)) COMMA_SOURCE_FILE_AT_LINE (515)) ;
        GALGAS_lstring var_lSourceFilePath = GALGAS_lstring::constructor_new (var_sourceFilePath, enumerator_21008.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (516)) COMMA_SOURCE_FILE_AT_LINE (516)) ;
        cGrammar_syntaxSLRgrammar::_performSourceFileParsing_ (inCompiler, var_lSourceFilePath, var_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (517)) ;
        {
        ioArgument_ioParsedComponentStruct.mAttribute_mParsedSyntaxComponentMap.modifier_insertKey (GALGAS_lstring::constructor_new (var_syntaxComponentName, enumerator_21008.current_mValue (HERE).reader_location (SOURCE_FILE_AT_LINE (518)) COMMA_SOURCE_FILE_AT_LINE (518)), var_lSourceFilePath, var_syntaxComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (518)) ;
        }
      }
      const enumGalgasBool test_5 = constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_and (var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521)).boolEnum () ;
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("as '").operator_concat (constinArgument_inGrammarComponentRoot.mAttribute_mGrammarName.reader_string (SOURCE_FILE_AT_LINE (522)) COMMA_SOURCE_FILE_AT_LINE (522)).operator_concat (GALGAS_string ("' grammar declares 'translate' feature, this syntax component should do so") COMMA_SOURCE_FILE_AT_LINE (522)) COMMA_SOURCE_FILE_AT_LINE (522)) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_7 = var_syntaxComponentRoot.mAttribute_mHasTranslateFeature.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasTranslateFeature.operator_not (SOURCE_FILE_AT_LINE (523)) COMMA_SOURCE_FILE_AT_LINE (523)).boolEnum () ;
        if (kBoolTrue == test_7) {
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("as '").operator_concat (var_syntaxComponentRoot.mAttribute_mSyntaxComponentName.reader_string (SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (GALGAS_string ("' syntax component declares 'translate' feature, this grammar should do so") COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)) ;
        }
      }
      var_lexiqueComponentPath = var_syntaxComponentRoot.reader_mImportedLexiqueFilePath (SOURCE_FILE_AT_LINE (527)) ;
      GALGAS_string var_currentLexiqueName = var_lexiqueComponentPath.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (528)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (528)) ;
      ...
      if (kBoolTrue == test_9) {
        ...
        if (kBoolTrue == test_10) {
          GALGAS_location location_11 (enumerator_21008.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_11, GALGAS_string ("this syntax component uses '").operator_concat (var_currentLexiqueName COMMA_SOURCE_FILE_AT_LINE (532)).operator_concat (GALGAS_string ("' lexique component, but the first syntax component uses the '") COMMA_SOURCE_FILE_AT_LINE (533)).operator_concat (var_lexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (533)).operator_concat (GALGAS_string ("' lexique component (they should be the same)") COMMA_SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (532)) ;
        }
      }
      {
      routine_handleNonTerminalDeclarations (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mNonterminalDeclarationList (SOURCE_FILE_AT_LINE (539)), inCompiler COMMA_SOURCE_FILE_AT_LINE (537)) ;
      }
      {
      routine_handleNonTerminalDeclarationsFromRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (544)), inCompiler COMMA_SOURCE_FILE_AT_LINE (542)) ;
      }
      {
      routine_buildRuleList (var_nonTerminalMapForGrammarAnalysis, var_syntaxComponentRoot.reader_mSyntaxComponentName (SOURCE_FILE_AT_LINE (549)), var_syntaxComponentRoot.reader_mRuleList (SOURCE_FILE_AT_LINE (550)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_addedNonTerminalCount, inCompiler COMMA_SOURCE_FILE_AT_LINE (547)) ;
      }
      GALGAS_uint var_i = GALGAS_uint ((uint32_t) 0U) ;
      if (var_addedNonTerminalCount.isValid ()) {
        uint32_t variant_24088 = var_addedNonTerminalCount.uintValue () ;
        bool loop_24088 = true ;
        while (loop_24088) {
          loop_24088 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)))).isValid () ;
          if (loop_24088) {
            loop_24088 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (var_addedNonTerminalCount.substract_operation (var_addedNonTerminalCountRef, inCompiler COMMA_SOURCE_FILE_AT_LINE (556)))).boolValue () ;
          }
          if (loop_24088 && (0 == variant_24088)) {
            loop_24088 = false ;
            inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (556)) ;
          }
          if (loop_24088) {
            variant_24088 -- ;
            var_nonTerminalToAddList.addAssign_operation (var_syntaxComponentName, var_i COMMA_SOURCE_FILE_AT_LINE (557)) ;
            var_i.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
          }
        }
      }
    }
  ...
  {
  routine_parseLexiqueComponent (GALGAS_lstring::constructor_new (var_lexiqueComponentPath.mAttribute_string.reader_absolutePathFromPath (constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (565)) COMMA_SOURCE_FILE_AT_LINE (565)), var_lexiqueComponentPath.reader_location (SOURCE_FILE_AT_LINE (565)) COMMA_SOURCE_FILE_AT_LINE (565)), ioArgument_ioParsedComponentStruct, var_lexiqueComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
  }
  GALGAS_bool var_hasIndexing = var_lexiqueComponentAST.reader_mIndexingDirectory (SOURCE_FILE_AT_LINE (569)).mAttribute_location.reader_isNowhere (SOURCE_FILE_AT_LINE (569)).operator_not (SOURCE_FILE_AT_LINE (569)) ;
  const enumGalgasBool test_12 = var_hasIndexing.operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool.operator_not (SOURCE_FILE_AT_LINE (570)) COMMA_SOURCE_FILE_AT_LINE (570)).boolEnum () ;
  if (kBoolTrue == test_12) {
    ...
    inCompiler->emitSemanticError (location_13, GALGAS_string ("the grammar does not enable indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (571)) COMMA_SOURCE_FILE_AT_LINE (571)).operator_concat (GALGAS_string ("' does") COMMA_SOURCE_FILE_AT_LINE (571)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }else if (kBoolFalse == test_12) {
    const enumGalgasBool test_14 = var_hasIndexing.operator_not (SOURCE_FILE_AT_LINE (572)).operator_and (constinArgument_inGrammarComponentRoot.mAttribute_mHasIndexing.mAttribute_bool COMMA_SOURCE_FILE_AT_LINE (572)).boolEnum () ;
    if (kBoolTrue == test_14) {
      ...
      inCompiler->emitSemanticError (location_15, GALGAS_string ("the grammar enables indexing, but the '").operator_concat (var_lexiqueComponentAST.mAttribute_mLexiqueComponentName.reader_string (SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)).operator_concat (GALGAS_string ("' does not") COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) ;
    }
  }
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis var_startSymbolAltMap ;
  GALGAS_uint var_startSymbolIndex ;
  var_nonTerminalMapForGrammarAnalysis.method_searchKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (579)), var_startSymbolIndex, var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
  {
  routine_checkLabelMap (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (582)).reader_location (SOURCE_FILE_AT_LINE (582)), constinArgument_inGrammarComponentRoot.reader_mStartSymbolLabelList (SOURCE_FILE_AT_LINE (583)), var_nonTerminalMapForGrammarAnalysis.reader_locationForKey (constinArgument_inGrammarComponentRoot.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (584)).reader_string (SOURCE_FILE_AT_LINE (584)), inCompiler COMMA_SOURCE_FILE_AT_LINE (584)), var_startSymbolAltMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
  }
  GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis var_unusedNonTerminalSymbolsForGrammar = GALGAS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (588)) ;
  cEnumerator_lstringlist enumerator_26088 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (589)), kEnumeration_up) ;
  while (enumerator_26088.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_26196_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_26088.current_mValue (HERE), var_nonterminalIndex, joker_26196_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_26088.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (592)) ;
    }
    enumerator_26088.gotoNextObject () ;
  }
  GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis var_nonTerminalSymbolSortedListForGrammarAnalysis = GALGAS_nonTerminalSymbolSortedListForGrammarAnalysis::constructor_emptySortedList (SOURCE_FILE_AT_LINE (595)) ;
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26553 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_26553.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_26553.current_lkey (HERE), enumerator_26553.current_mNonTerminalIndex (HERE), enumerator_26553.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (597)) ;
  ...
  if (kBoolTrue == test_17) {
    temp_16 = function_syntaxDirectedTranslationResultVarName (inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
  }else if (kBoolFalse == test_17) {
    temp_16 = GALGAS_string::makeEmptyString () ;
  }
  routine_grammarAnalysisAndGeneration (constinArgument_inGrammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (601)), constinArgument_inGrammarComponentRoot.reader_mGrammarClass (SOURCE_FILE_AT_LINE (602)), var_startSymbolIndex, var_lexiqueComponentName, constinArgument_inGrammarComponentRoot.reader_mEndOfSourceText (SOURCE_FILE_AT_LINE (605)), var_actuallyUsedTerminalSymbolMap, var_syntaxComponentListForGrammarAnalysis, var_unusedNonTerminalSymbolsForGrammar, constinArgument_inOutputDirectoryForCppFiles, var_outputDirectoryForHTMLFile, var_nonTerminalSymbolSortedListForGrammarAnalysis, var_hasIndexing, temp_16, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  }
  const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (616)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_18) {
    GALGAS_string var_zone_32_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (inCompiler, constinArgument_inGrammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (617))) ;
    GALGAS_string var_zone_33_ = GALGAS_string (filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (inCompiler, var_lexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (621)), constinArgument_inGrammarComponentRoot, var_nonTerminalMapForGrammarAnalysis, var_nonTerminalToAddList, var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (620))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectoryForCppFiles, constinArgument_inGrammarComponentRoot.reader_mGrammarName (SOURCE_FILE_AT_LINE (629)).reader_string (SOURCE_FILE_AT_LINE (629)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (629)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_zone_32_, GALGAS_string ("\n"
      "\n"), var_zone_33_, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
    }
  }
}
...
void routine_compileGrammarComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  {
  routine_parseGrammarComponent (constinArgument_inSourceFile, ioArgument_ioParsedComponentStruct, var_grammarComponentRoot, inCompiler COMMA_SOURCE_FILE_AT_LINE (646)) ;
  }
  {
  routine_compileGrammarComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectoryForCppFiles, var_grammarComponentRoot, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (648)) ;
  }
}
...
static void categoryMethod_terminalCheckInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  cMapElement_terminalSymbolsMapForGrammarAnalysis * objectArray_8976 = (cMapElement_terminalSymbolsMapForGrammarAnalysis *) ioArgument_ioActuallyUsedTerminalSymbolMap.readWriteAccessForWithInstruction_hasKey (inCompiler, object->mAttribute_mTerminalName.reader_string (SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206)) ;
  if (NULL != objectArray_8976) {
      macroValidSharedObject (objectArray_8976, cMapElement_terminalSymbolsMapForGrammarAnalysis) ;
    var_terminalSymbolIndex = objectArray_8976->mAttribute_mTerminalIndex ;
  }else{
    var_terminalSymbolIndex = ioArgument_ioActuallyUsedTerminalSymbolMap.reader_count (SOURCE_FILE_AT_LINE (209)) ;
    {
    ioArgument_ioActuallyUsedTerminalSymbolMap.modifier_insertKey (object->mAttribute_mTerminalName, var_terminalSymbolIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (210)) ;
    }
  }
  ioArgument_ioSyntaxInstructionList.addAssign_operation (GALGAS_terminalInstructionForGrammarAnalysis::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mTerminalName, var_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_nonterminalCallInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_9946_0 ; // Joker input parameter
  constinArgument_inNonTerminalSymbolMap.method_searchKey (object->mAttribute_mNonterminalName, var_nonTerminalSymbolIndex, joker_9946_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
  ioArgument_ioSyntaxInstructionList.addAssign_operation (GALGAS_nonTerminalInstructionForGrammarAnalysis::constructor_new (object->mAttribute_mInstructionLocation, object->mAttribute_mNonterminalName, var_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_repeatInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  ioArgument_ioAddedNonTerminalIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (245)) ;
  GALGAS_syntaxInstructionListForGrammarAnalysis var_repeatedInstructionList = GALGAS_syntaxInstructionListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (247)) ;
  {
  routine_transformInstructionList (object->mAttribute_mRepeatedInstructionList, ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_repeatedInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (248)) ;
  }
  GALGAS_branchListForGrammarAnalysis var_repeatBranchList = GALGAS_branchListForGrammarAnalysis::constructor_listWithValue (var_repeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (255)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_10990 (object->mAttribute_mRepeatBranchList, kEnumeration_up) ;
  while (enumerator_10990.hasCurrentObject ()) {
    GALGAS_syntaxInstructionListForGrammarAnalysis var_syntaxInstructionList = GALGAS_syntaxInstructionListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (258)) ;
    {
    routine_transformInstructionList (enumerator_10990.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (259)) ;
    }
    var_repeatBranchList.addAssign_operation (var_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (266)) ;
    enumerator_10990.gotoNextObject () ;
  }
  ioArgument_ioSyntaxInstructionList.addAssign_operation (GALGAS_repeatInstructionForGrammarAnalysis::constructor_new (object->mAttribute_mInstructionLocation, var_repeatBranchList, var_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_selectInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_uint var_addedNonTerminalIndex = ioArgument_ioAddedNonTerminalIndex ;
  ioArgument_ioAddedNonTerminalIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (285)) ;
  GALGAS_branchListForGrammarAnalysis var_selectBranchList = GALGAS_branchListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (287)) ;
  cEnumerator_listOfSyntaxInstructionList enumerator_12073 (object->mAttribute_mSelectBranchList, kEnumeration_up) ;
  while (enumerator_12073.hasCurrentObject ()) {
    GALGAS_syntaxInstructionListForGrammarAnalysis var_syntaxInstructionList = GALGAS_syntaxInstructionListForGrammarAnalysis::constructor_emptyList (SOURCE_FILE_AT_LINE (289)) ;
    {
    routine_transformInstructionList (enumerator_12073.current_mSyntaxInstructionList (HERE), ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, var_syntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (290)) ;
    }
    var_selectBranchList.addAssign_operation (var_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (297)) ;
    enumerator_12073.gotoNextObject () ;
  }
  ioArgument_ioSyntaxInstructionList.addAssign_operation (GALGAS_selectInstructionForGrammarAnalysis::constructor_new (object->mAttribute_mInstructionLocation, var_selectBranchList, var_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseRewindInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  GALGAS_location joker_13079_0 ; // Joker input parameter
  object->mAttribute_mParseRewindBranchList.method_first (var_syntaxInstructionList, joker_13079_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (316)) ;
  {
  routine_transformInstructionList (var_syntaxInstructionList, ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, ioArgument_ioSyntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (318)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseWhenInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  {
  routine_transformInstructionList (object->mAttribute_mElseInstructionList, ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, ioArgument_ioSyntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_parseLoopInstruction_transformInstruction (const cPtr_syntaxInstructionAST * inObject,
  ...
  {
  routine_transformInstructionList (object->mAttribute_mDoInstructionList, ioArgument_ioActuallyUsedTerminalSymbolMap, constinArgument_inNonTerminalSymbolMap, ioArgument_ioAddedNonTerminalIndex, ioArgument_ioSyntaxInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (352)) ;
  }
}
//-----------------------------------------------------------------------------*
