...
void routine_parseGrammarComponent (C_Compiler & inLexique,
  ...
  elementOf_GGS_parsedGrammarComponentMap * operand_18069 = (elementOf_GGS_parsedGrammarComponentMap *) var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.searchForReadWithInstruction (var_cas_basename) ;
  if (NULL != operand_18069) {
    var_cas_outGrammarComponentRoot = operand_18069->mInfo.mGrammarComponentRoot ;
  }else{
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_19640 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (472))).operator_isNotEqual (var_cas_basename) ;
  if (cond_19640.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20169 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), true) ;
    const GGS_lstringlist::cElement * operand_20169 = NULL ;
    while (((operand_20169 = enumerator_20169.nextObject ()))) {
      macroValidPointer (operand_20169) ;
      const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
      const GGS_bool cond_20473 = ((operand_20169->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20169->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_20473.isBuiltAndTrue ()) {
        operand_20169->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }else if (cond_20473.isBuiltAndFalse ()) {
        GGS_string var_cas_syntaxComponentName = operand_20169->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentAST var_cas_syntaxComponentRoot ;
        const GGS_bool cond_20864 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_20864.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_20786 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
          if (temp_20786.isBuilt ()) {
            temp_20786 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (493)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (493)) ;
          }
        }else if (cond_20864.isBuiltAndFalse ()) {
          GGS_string var_cas_sourceFilePath = operand_20169->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20169->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (496)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20169->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (497)) COMMA_SOURCE_FILE_AT_LINE (497)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (497)) ;
        }
        ...
        const GGS_bool cond_21533 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_21533.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_21533.isBuiltAndFalse ()) {
          const GGS_bool cond_21828 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
          if (cond_21828.isBuiltAndTrue ()) {
            operand_20169->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (507)) ;
          }
        }
        ...
        GGS_uint _variant_22535 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_22535 (_variant_22535.isBuilt (), true) ;
        while (_condition_22535.isBuiltAndTrue ()) {
          _condition_22535 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (523))) ;
          if (_condition_22535.isBuiltAndTrue ()) {
            if (_variant_22535.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (526)) ;
              _condition_22535 = GGS_bool (false) ;
            }else{
              _variant_22535.decrement_operation (inLexique COMMA_HERE) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23436 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), true) ;
    const GGS_lstringlist::cElement * operand_23436 = NULL ;
    while (((operand_23436 = enumerator_23436.nextObject ()))) {
      macroValidPointer (operand_23436) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23590_0 ;
      if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23436->mValue, var_cas_nonterminalIndex, automatic_var_23590_0 COMMA_SOURCE_FILE_AT_LINE (546)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23436->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (547)) ;
    }
  }
  ...
  const GGS_bool cond_24908 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_24908.isBuiltAndTrue ()) {
