...
void routine_checkLabelMap (const GALGAS_location constinArgument_inNonTerminalLocation,
  ...
  while (enumerator_2692.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, enumerator_2692.current_mFormalArgumentList (HERE).reader_length (SOURCE_FILE_AT_LINE (63)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
      if (kBoolTrue == test_2) {
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_32_Header (C_Compiler * /* inCompiler */,
  ...
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (6)).isValid ()) {
    cEnumerator_lstringlist enumerator_336 (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (6)), kEnumeration_up) ;
    while (enumerator_336.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_336.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (7)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (7)).stringValue () ;
      result << ".h\"\n" ;
...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
  ...
  if (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (4)).isValid ()) {
    cEnumerator_lstringlist enumerator_223 (in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (4)), kEnumeration_up) ;
    while (enumerator_223.hasCurrentObject ()) {
      result << "public cParser_" ;
      result << enumerator_223.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (5)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (5)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (5)).stringValue () ;
  ...
  result << " {\n" ;
  GALGAS_uint index_381_ (0) ;
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_381 (in_NON_5F_TERMINAL_5F_MAP, kEnumeration_up) ;
    while (enumerator_381.hasCurrentObject ()) {
      result << "//------------------------------------- '" ;
      result << enumerator_381.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (11)).stringValue () ;
      result << "' non terminal\n"
        "//--- 'parse' label\n"
        "  public : virtual void nt_" ;
      result << enumerator_381.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (14)).stringValue () ;
      ...
      if (kBoolTrue == test_0) {
        result << "//--- indexing\n"
          "  public : virtual void nt_" ;
        result << enumerator_381.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (18)).stringValue () ;
      ...
      if (enumerator_381.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_892 (enumerator_381.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
        while (enumerator_892.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_892.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (21)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          result << enumerator_381.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (23)).stringValue () ;
          result << "_" ;
          result << enumerator_892.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (23)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_1141_IDX (0) ;
          if (enumerator_892.current_mFormalParametersList (HERE).isValid ()) {
            cEnumerator_signatureForGrammarAnalysis enumerator_1141 (enumerator_892.current_mFormalParametersList (HERE), kEnumeration_up) ;
            while (enumerator_1141.hasCurrentObject ()) {
              const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_1141.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (25)))).boolEnum () ;
              if (kBoolTrue == test_1) {
                result << "const GALGAS_" ;
                result << enumerator_1141.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (26)).stringValue () ;
                result << " inArgument" ;
                result << index_1141_IDX.reader_string (SOURCE_FILE_AT_LINE (26)).stringValue () ;
              }else if (kBoolFalse == test_1) {
                const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_1141.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (27)))).boolEnum () ;
                if (kBoolTrue == test_2) {
                  result << "GALGAS_" ;
                  result << enumerator_1141.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (28)).stringValue () ;
                  result << " & ioArgument" ;
                  result << index_1141_IDX.reader_string (SOURCE_FILE_AT_LINE (28)).stringValue () ;
                }else if (kBoolFalse == test_2) {
                  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_1141.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (29)))).boolEnum () ;
                  if (kBoolTrue == test_3) {
                    result << "GALGAS_" ;
                    result << enumerator_1141.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (30)).stringValue () ;
                    result << " & outArgument" ;
                    result << index_1141_IDX.reader_string (SOURCE_FILE_AT_LINE (30)).stringValue () ;
                  }else if (kBoolFalse == test_3) {
                    result << "GALGAS_" ;
                    result << enumerator_1141.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                    result << " inArgument" ;
                    result << index_1141_IDX.reader_string (SOURCE_FILE_AT_LINE (32)).stringValue () ;
                  }
                }
              }
              result << ",\n" ;
              result.appendSpacesUntilColumn (columnMarker) ;
              index_1141_IDX.increment () ;
          ...
          result << " * inCompiler) ;\n"
            "\n" ;
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (38)).reader_string (SOURCE_FILE_AT_LINE (38)).objectCompare (enumerator_381.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (38)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            result << "//--- Start symbol\n"
              "  public : static void _performSourceFileParsing_" ;
            result << enumerator_892.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (40)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_lstring inFileName" ;
            GALGAS_uint index_2394_IDX (0) ;
            if (enumerator_892.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2394 (enumerator_892.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_2394.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_2394.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (44)))).boolEnum () ;
                if (kBoolTrue == test_5) {
                  result << "const GALGAS_" ;
                  result << enumerator_2394.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                  result << " inArgument" ;
                  result << index_2394_IDX.reader_string (SOURCE_FILE_AT_LINE (45)).stringValue () ;
                }else if (kBoolFalse == test_5) {
                  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_2394.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (46)))).boolEnum () ;
                  if (kBoolTrue == test_6) {
                    result << "GALGAS_" ;
                    result << enumerator_2394.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (47)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_2394_IDX.reader_string (SOURCE_FILE_AT_LINE (47)).stringValue () ;
                  }else if (kBoolFalse == test_6) {
                    const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_2394.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (48)))).boolEnum () ;
                    if (kBoolTrue == test_7) {
                      result << "GALGAS_" ;
                      result << enumerator_2394.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_2394_IDX.reader_string (SOURCE_FILE_AT_LINE (49)).stringValue () ;
                    }else if (kBoolFalse == test_7) {
                      result << "GALGAS_" ;
                      result << enumerator_2394.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                      result << " inArgument" ;
                      result << index_2394_IDX.reader_string (SOURCE_FILE_AT_LINE (51)).stringValue () ;
                    }
                  }
                }
                index_2394_IDX.increment () ;
            ...
            result << enumerator_892.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (55)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << "GALGAS_string inSourceString" ;
            GALGAS_uint index_3526_IDX (0) ;
            if (enumerator_892.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3526 (enumerator_892.current_mFormalParametersList (HERE), kEnumeration_up) ;
              while (enumerator_3526.hasCurrentObject ()) {
                result << ",\n" ;
                result.appendSpacesUntilColumn (columnMarker) ;
                const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_3526.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (59)))).boolEnum () ;
                if (kBoolTrue == test_8) {
                  result << "const GALGAS_" ;
                  result << enumerator_3526.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                  result << " inArgument" ;
                  result << index_3526_IDX.reader_string (SOURCE_FILE_AT_LINE (60)).stringValue () ;
                }else if (kBoolFalse == test_8) {
                  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_3526.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (61)))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                    result << "GALGAS_" ;
                    result << enumerator_3526.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                    result << " & ioArgument" ;
                    result << index_3526_IDX.reader_string (SOURCE_FILE_AT_LINE (62)).stringValue () ;
                  }else if (kBoolFalse == test_9) {
                    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_3526.current_mFormalArgumentPassingModeForGrammarAnalysis (HERE).objectCompare (GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (63)))).boolEnum () ;
                    if (kBoolTrue == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_3526.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                      result << " & outArgument" ;
                      result << index_3526_IDX.reader_string (SOURCE_FILE_AT_LINE (64)).stringValue () ;
                    }else if (kBoolFalse == test_10) {
                      result << "GALGAS_" ;
                      result << enumerator_3526.current_mGalgasTypeNameForGrammarAnalysis (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                      result << " inArgument" ;
                      result << index_3526_IDX.reader_string (SOURCE_FILE_AT_LINE (66)).stringValue () ;
                    }
                  }
                }
                index_3526_IDX.increment () ;
      ...
      const enumGalgasBool test_11 = in_HAS_5F_INDEXING.operator_and (GALGAS_bool (kIsEqual, in_GRAMMAR_5F_COMPONENT_5F_ROOT.reader_mStartSymbolName (SOURCE_FILE_AT_LINE (73)).reader_string (SOURCE_FILE_AT_LINE (73)).objectCompare (enumerator_381.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (73)))) COMMA_SOURCE_FILE_AT_LINE (73)).boolEnum () ;
      ...
      index_381_.increment () ;
      enumerator_381.gotoNextObject () ;
    }
  }
  GALGAS_uint index_4793_ (0) ;
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4793 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_4793.hasCurrentObject ()) {
      result << "  public : virtual PMSInt32 select_" ;
      result << enumerator_4793.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << "_" ;
      result << enumerator_4793.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
      if (enumerator_4793.hasNextObject ()) {
        result << "\n" ;
      }
      index_4793_.increment () ;
  ...
  while (enumerator_20897.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      if (var_addedNonTerminalCount.isValid ()) {
        PMUInt32 variant_23342 = var_addedNonTerminalCount.uintValue () ;
