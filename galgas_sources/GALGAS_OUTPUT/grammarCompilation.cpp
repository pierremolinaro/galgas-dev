...
category_method__terminalCheckInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_8450 != NULL) {
    ...
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_8450->mStartLocation, operand_8450->mTerminalName, var_cas_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (200))) ;
  }
}
...
category_method__nonterminalCallInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_9338 != NULL) {
    ...
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_9338->mStartLocation, operand_9338->mNonterminalName, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (217))) ;
  }
}
...
category_method__repeatInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_10017 != NULL) {
    ...
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_repeatInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_10017->mStartLocation, var_cas_repeatBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (257))) ;
  }
}
...
category_method__selectInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_11392 != NULL) {
    ...
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_selectInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_11392->mStartLocation, var_cas_selectBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (288))) ;
  }
}
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
      ...
      if (cond_19377.isBuiltAndTrue ()) {
        ...
        if (cond_19769.isBuiltAndTrue ()) {
          ...
          if (temp_19691.isBuilt ()) {
            temp_19691 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (470)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (470)) ;
          }
          ...
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_19073->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (473)) COMMA_SOURCE_FILE_AT_LINE (473)),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (473)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_19073->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (474)) ;
        }
        ...
        const GGS_bool cond_20439 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_20439.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_20439.isBuiltAndFalse ()) {
          const GGS_bool cond_20734 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
          if (cond_20734.isBuiltAndTrue ()) {
        ...
        GGS_uint _variant_21441 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_21441 (_variant_21441.isBuilt (), true) ;
        while (_condition_21441.isBuiltAndTrue ()) {
          _condition_21441 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (500))) ;
          if (_condition_21441.isBuiltAndTrue ()) {
            if (_variant_21441.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (503)) ;
              _condition_21441 = GGS_bool (false) ;
            }else{
              _variant_21441.decrement_operation (inLexique COMMA_HERE) ;
  ...
  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_21735 = var_cas_nonTerminalMapForGrammarAnalysis ;
  if (temp_21735.isBuilt ()) {
    temp_21735 (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (510)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (510)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_22342 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (521)), true) ;
    const GGS_lstringlist::cElement * operand_22342 = NULL ;
    while (((operand_22342 = enumerator_22342.nextObject ()))) {
      macroValidPointer (operand_22342) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_22496_0 ;
      const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_22466 = var_cas_nonTerminalMapForGrammarAnalysis ;
      if (temp_22466.isBuilt ()) {
        temp_22466 (HERE)->method_searchKey (inLexique, operand_22342->mValue, var_cas_nonterminalIndex, automatic_var_22496_0 COMMA_SOURCE_FILE_AT_LINE (523)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_22342->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (524)) ;
    }
  }
  ...
  const GGS_bool cond_23814 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (541))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_23814.isBuiltAndTrue ()) {
