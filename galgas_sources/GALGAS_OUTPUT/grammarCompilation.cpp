...
template_filewrapper_grammarGenerationTemplate_oldGrammarZone3Header (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_347 = enumerator_347.nextObject ()))) {
      ...
      while (((operand_410 = enumerator_410.nextObject ()))) {
        ...
        if ((var_cas_GRAMMAR_COMPONENT_ROOT.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (17)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).operator_isEqual (operand_347->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).boolValue ()) {
          ...
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1283 (operand_410->mInfo.mFormalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_1283 = NULL ;
          while (((operand_1283 = enumerator_1283.nextObject ()))) {
            macroValidPointer (operand_1283) ;
            result << ",\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << operand_1283->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << "GGS_" ;
            result << operand_1283->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
            result << operand_1283->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) ;
          }
          result << "\n" ;
          result.appendSpacesUntilColumn (columnMarker) ;
          ...
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_1824 (operand_410->mInfo.mFormalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_1824 = NULL ;
          while (((operand_1824 = enumerator_1824.nextObject ()))) {
            macroValidPointer (operand_1824) ;
            result << ",\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            result << operand_1824->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation1ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << "GGS_" ;
            result << operand_1824->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
            result << operand_1824->mFormalArgumentPassingModeForGrammarAnalysis.reader_generation2ForFormalParameter (inLexique COMMA_SOURCE_FILE_AT_LINE (31)) ;
          }
          result << "\n" ;
          result.appendSpacesUntilColumn (columnMarker) ;
          result << "COMMA_LOCATION_ARGS) ;\n"
    ...
    GGS_nonTerminalToAddList::cEnumerator enumerator_2179 (var_cas_ADDED_NON_TERMINAL_LIST, true) ;
    const GGS_nonTerminalToAddList::cElement * operand_2179 = NULL ;
    while (((operand_2179 = enumerator_2179.nextObject ()))) {
      macroValidPointer (operand_2179) ;
      result << "  public : virtual PMSInt16 select_" ;
      result << operand_2179->mSyntaxComponentName.reader_identifierRepresentation () ;
      result << "_" ;
      result << operand_2179->mNonTerminalToAddCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (38)) ;
      result << " (C_Lexique_" ;
      result << var_cas_LEXIQUE_CLASS ;
      result << " &) ;\n" ;
      if (enumerator_2179.hasNextObject ()) {
        result << "\n" ;
      }
    }
    result << "} ;\n"
