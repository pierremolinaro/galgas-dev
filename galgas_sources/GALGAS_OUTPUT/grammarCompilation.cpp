...
//                    september 20th, 2009, at 16h6'18"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__nonterminalCallInstruction__buildSyntaxInstructionList (C_Compiler &,
  ...
  if (operand_6744 != NULL) {
    var_cas_ioSyntaxInstructionList._addAssign_operation (operand_6744) ;
  }
}
...
category_method__terminalCheckInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_terminalCheckInstruction * operand_6996,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_6996 != NULL) {
    var_cas_ioSyntaxInstructionList._addAssign_operation (operand_6996) ;
  }
}
...
category_method__repeatInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_repeatInstruction * operand_7241,
                                GGS_syntaxInstructionList  & /* var_cas_ioSyntaxInstructionList */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_method__selectInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_selectInstruction * operand_7456,
                                GGS_syntaxInstructionList  & /* var_cas_ioSyntaxInstructionList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7456 != NULL) {
  }
}
...
category_method__parseDoInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_parseDoInstruction * operand_7672,
                                GGS_syntaxInstructionList  & /* var_cas_ioSyntaxInstructionList */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_7672 != NULL) {
  }
}
...
category_method__blockInstruction__buildSyntaxInstructionList (C_Compiler &,
                                const cPtr_blockInstruction * operand_7886,
                                GGS_syntaxInstructionList  & /* var_cas_ioSyntaxInstructionList */
                                COMMA_UNUSED_LOCATION_ARGS) {
...
void routine_buildSyntaxInstructionList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_8579 (var_cas_inInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_8579 = NULL ;
    while (((operand_8579 = enumerator_8579.nextObject ()))) {
      macroValidPointer (operand_8579) ;
      const GGS_syntaxInstruction  temp_8627 = operand_8579->mInstruction ;
      if (temp_8627.isBuilt ()) {
        typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_8627.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_8627 (HERE), var_cas_outSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (196)) ;
        }
      }
    }
  }
...
void routine_handleRules (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_9156 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_9156 = NULL ;
    while (((operand_9156 = enumerator_9156.nextObject ()))) {
      ...
      const GGS_syntaxRuleLabelList  temp_9298 = operand_9156->mLabelList ;
      if (temp_9298.isBuilt ()) {
        temp_9298 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_10361 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (240)), true) ;
    const GGS_lstringlist::cElement * operand_10361 = NULL ;
    while (((operand_10361 = enumerator_10361.nextObject ()))) {
      macroValidPointer (operand_10361) ;
      if (((operand_10361->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (241))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_10361->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (243)) ;
      }else{
        GGS_string var_cas_syntaxComponentName ;
        var_cas_syntaxComponentName = operand_10361->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (246))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_10863 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
          if (temp_10863.isBuilt ()) {
            temp_10863 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (247)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath ;
          var_cas_sourceFilePath = operand_10361->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (249)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_10361->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (250)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_10361->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (251)) ;
        }
