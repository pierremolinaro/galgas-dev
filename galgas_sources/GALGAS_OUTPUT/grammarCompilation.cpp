...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_uint  var_cas_vocabularyCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (727)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)) ;
  const GGS_uint  var_cas_bitCountForBDDs = var_cas_vocabularyCount.reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (728)) ;
  ...
  {
    GGS_productionListMap::cEnumerator enumerator_30505 (var_cas_productionListMap, true) ;
    while (enumerator_30505.hasCurrentObject ()) {
      GGS_binaryset var_cas_derivation ;
      var_cas_derivation = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
      {
        GGS_derivationList::cEnumerator enumerator_30572 (enumerator_30505._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_30572 = NULL ;
        while (((operand_30572 = enumerator_30572.nextObject ()))) {
          macroValidPointer (operand_30572) ;
          {
            GGS_uint64list::cEnumerator enumerator_30601 (operand_30572->mDerivation, true) ;
            const GGS_uint64list::cElement * operand_30601 = NULL ;
            while (((operand_30601 = enumerator_30601.nextObject ()))) {
              macroValidPointer (operand_30601) ;
              var_cas_derivation = (var_cas_derivation).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, operand_30601->mValue COMMA_HERE)) ;
            }
          }
        }
      }
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_30822 = var_cas_nonterminalMap ;
      if (temp_30822.isBuilt ()) {
        temp_30822 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_30505._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (745)) ;
      }
  ...
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage ((((var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (756))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string (" ok\n")) : (GGS_string (" error\n"))) COMMA_SOURCE_FILE_AT_LINE (756)) ;
  }
  if (((var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (758))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage ;
    var_cas_errorMessage = ((GGS_string ("the grammar contains ")).operator_concat (var_cas_unusefulSymbolList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (759)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (759)))).operator_concat (GGS_string (" useless symbol(s): ")) ;
    {
      GGS_stringlist::cEnumerator enumerator_31934 (var_cas_unusefulSymbolList, true) ;
      const GGS_stringlist::cElement * operand_31934 = enumerator_31934.nextObject () ;
      if ((operand_31934 != NULL)) {
        bool _foreach_loop_31934 ;
        do{
          macroValidPointer (operand_31934) ;
          var_cas_errorMessage.dotAssign_operation (operand_31934->mValue) ;
          operand_31934 = enumerator_31934.nextObject () ;
          _foreach_loop_31934 = ((operand_31934 != NULL)) ;
          if (_foreach_loop_31934) {
            var_cas_errorMessage.appendCString (", ") ;
          }
        }while (_foreach_loop_31934) ;
      }
    }
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (765)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s ;
    var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (769)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_terminalMap, var_cas_nonterminalMap, var_cas_bitCountForBDDs, var_cas_identicalDerivationErrorMessageList) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_32512 = var_cas_s ;
    if (temp_32512.isBuilt ()) {
      temp_32512 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (777)) ;
    }
  }else{
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_htmlOutputFileName COMMA_SOURCE_FILE_AT_LINE (779)) ;
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (785))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (789)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (794)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponent, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (783)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
