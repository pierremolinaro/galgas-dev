...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_26510 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (599)), kEnumeration_up) ;
  while (enumerator_26510.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_26618_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_26510.current_mValue (HERE), var_nonterminalIndex, joker_26618_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_26510.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
    }
  ...
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26975 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_26975.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_26975.current_lkey (HERE), enumerator_26975.current_mNonTerminalIndex (HERE), enumerator_26975.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (607)) ;
