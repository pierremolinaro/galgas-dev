...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_21380 (constinArgument_inGrammarComponentRoot.reader_mSyntaxComponents (SOURCE_FILE_AT_LINE (514)), kEnumeration_up) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_25881 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (593)), kEnumeration_up) ;
  //--- simple foreach instruction
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_26346 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  //--- simple foreach instruction
