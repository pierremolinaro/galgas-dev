...
category_method__parseDoInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_12509 != NULL) {
    ...
    GGS_location  automatic_var_12859_0 ;
    if (operand_12509->mParseDoBranchList.isBuilt ()) {
      operand_12509->mParseDoBranchList (HERE)->method_first (inLexique, var_cas_syntaxInstructionList, automatic_var_12859_0 COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__parseWhenInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_13198,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13198 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13198->mElseInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (323)) ;
  }
}
...
category_method__parseLoopInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_13779,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_13779 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13779->mDoInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (340)) ;
  }
}
...
category_method__blockInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_14354,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_14354 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_14354->mInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
}
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxRuleListAST::cEnumerator enumerator_15330 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleListAST::cElement * operand_15330 = NULL ;
    while (((operand_15330 = enumerator_15330.nextObject ()))) {
      macroValidPointer (operand_15330) ;
      ...
      if (var_cas_inNonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_15330->mNonterminalName, var_cas_nonTerminalIndex, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      GGS_syntaxInstructionList  var_cas_parsedSyntaxInstructionList ;
      GGS_lstring  automatic_var_15732_0 ;
      GGS_formalParameterListAST  automatic_var_15732_1 ;
      GGS_location  automatic_var_15732_2 ;
      GGS_location  automatic_var_15732_3 ;
      if (operand_15330->mLabelList.isBuilt ()) {
        operand_15330->mLabelList (HERE)->method_first (inLexique, automatic_var_15732_0, automatic_var_15732_1, automatic_var_15732_2, var_cas_parsedSyntaxInstructionList, automatic_var_15732_3 COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
      ...
      var_cas_productionRulesList.addAssign_operation (operand_15330->mNonterminalName, var_cas_nonTerminalIndex, var_cas_instructionList, var_cas_productionRulesList.reader_length ()) ;
    }
  }
...
elementOf_GGS_parsedGrammarComponentMap * operand_18439 = (elementOf_GGS_parsedGrammarComponentMap *) var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.searchForReadWithInstruction (var_cas_basename) ;
if (NULL != operand_18439) {
var_cas_outGrammarComponentRoot = operand_18439->mInfo.mGrammarComponentRoot ;
}else{
...
const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_20010 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (481))).operator_isNotEqual (var_cas_basename) ;
...
{
GGS_lstringlist::cEnumerator enumerator_20539 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (494)), true) ;
const GGS_lstringlist::cElement * operand_20539 = NULL ;
while (((operand_20539 = enumerator_20539.nextObject ()))) {
  macroValidPointer (operand_20539) ;
const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
const GGS_bool cond_20843 = ((operand_20539->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20539->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
if (cond_20843.isBuiltAndTrue ()) {
operand_20539->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (498)) ;
}else if (cond_20843.isBuiltAndFalse ()) {
GGS_string var_cas_syntaxComponentName = operand_20539->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
GGS_syntaxComponentAST var_cas_syntaxComponentRoot ;
const GGS_bool cond_21234 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (501)).reader_hasKey (var_cas_syntaxComponentName) ;
if (cond_21234.isBuiltAndTrue ()) {
const GGS_parsedSyntaxComponentMap  temp_21156 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (502)) ;
if (temp_21156.isBuilt ()) {
  temp_21156 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (502)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (502)) ;
}
}else if (cond_21234.isBuiltAndFalse ()) {
GGS_string var_cas_sourceFilePath = operand_20539->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
const GGS_string _depExtension = GGS_string ("") ;
const GGS_string _depPath = GGS_string ("") ;
if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
  C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                ...
                                _depPath.string (),
                                NULL,
                                GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20539->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)),
                                var_cas_syntaxComponentRoot
                                COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20539->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (506)) ;
}
...
const GGS_bool cond_21903 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
if (cond_21903.isBuiltAndTrue ()) {
var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
}else if (cond_21903.isBuiltAndFalse ()) {
const GGS_bool cond_22198 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
if (cond_22198.isBuiltAndTrue ()) {
operand_20539->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (516)) ;
}
}
...
GGS_uint _variant_22905 = var_cas_addedNonTerminalCount ;
GGS_bool _condition_22905 (_variant_22905.isBuilt (), true) ;
while (_condition_22905.isBuiltAndTrue ()) {
  _condition_22905 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (532))) ;
  if (_condition_22905.isBuiltAndTrue ()) {
    if (_variant_22905.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (535)) ;
      _condition_22905 = GGS_bool (false) ;
    }else{
      _variant_22905.decrement_operation (inLexique COMMA_HERE) ;
...
{
GGS_lstringlist::cEnumerator enumerator_23806 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (553)), true) ;
const GGS_lstringlist::cElement * operand_23806 = NULL ;
while (((operand_23806 = enumerator_23806.nextObject ()))) {
  macroValidPointer (operand_23806) ;
GGS_uint  var_cas_nonterminalIndex ;
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23960_0 ;
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23806->mValue, var_cas_nonterminalIndex, automatic_var_23960_0 COMMA_SOURCE_FILE_AT_LINE (555)) ;
}
var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23806->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (556)) ;
}
}
...
const GGS_bool cond_26036 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (573))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26036.isBuiltAndTrue ()) {
const GGS_bool cond_25375 = gOption_galgas_5F_cli_5F_options_newCodeGeneration.reader_value () ;
if (cond_25375.isBuiltAndTrue ()) {
...
}else if (cond_25375.isBuiltAndFalse ()) {
