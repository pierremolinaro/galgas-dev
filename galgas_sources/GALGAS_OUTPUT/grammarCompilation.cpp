...
GALGAS_string filewrapperTemplate_grammarGenerationTemplate_grammarZone_33_Header (C_Compiler * /* inCompiler */,
  ...
  if (in_NON_5F_TERMINAL_5F_MAP.isValid ()) {
    ...
    while (enumerator_428.hasCurrentObject ()) {
      ...
      GALGAS_uint index_913_ (0) ;
      if (enumerator_428.current_mNonterminalSymbolParametersMap (HERE).isValid ()) {
        cEnumerator_nonterminalSymbolLabelMapForGrammarAnalysis enumerator_913 (enumerator_428.current_mNonterminalSymbolParametersMap (HERE), kEnumeration_up) ;
        while (enumerator_913.hasCurrentObject ()) {
          result << "//----------- '" ;
          result << enumerator_913.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (21)).stringValue () ;
          result << "' label\n"
            "  public : virtual void nt_" ;
          ...
          result << "_" ;
          result << enumerator_913.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (23)).stringValue () ;
          result << " (" ;
          columnMarker = result.currentColumn () ;
          GALGAS_uint index_1141_IDX (0) ;
          if (enumerator_913.current_mFormalParametersList (HERE).isValid ()) {
            cEnumerator_signatureForGrammarAnalysis enumerator_1141 (enumerator_913.current_mFormalParametersList (HERE), kEnumeration_up) ;
          ...
          if (kBoolTrue == test_4) {
            ...
            result << enumerator_913.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (40)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            ...
            if (enumerator_913.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_2394 (enumerator_913.current_mFormalParametersList (HERE), kEnumeration_up) ;
            ...
            result << enumerator_913.current_lkey (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (55)).stringValue () ;
            result << " (" ;
            columnMarker = result.currentColumn () ;
            result << "C_Compiler * inCompiler,\n" ;
            result.appendSpacesUntilColumn (columnMarker) ;
            ...
            if (enumerator_913.current_mFormalParametersList (HERE).isValid ()) {
              cEnumerator_signatureForGrammarAnalysis enumerator_3526 (enumerator_913.current_mFormalParametersList (HERE), kEnumeration_up) ;
  ...
  GALGAS_uint index_4832_ (0) ;
  if (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST.isValid ()) {
    cEnumerator_nonTerminalToAddList enumerator_4832 (in_ADDED_5F_NON_5F_TERMINAL_5F_LIST, kEnumeration_up) ;
    while (enumerator_4832.hasCurrentObject ()) {
      result << "  public : virtual PMSInt32 select_" ;
      result << enumerator_4832.current_mSyntaxComponentName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << "_" ;
      result << enumerator_4832.current_mNonTerminalToAddCount (HERE).reader_string (SOURCE_FILE_AT_LINE (81)).stringValue () ;
      result << " (C_Lexique_" ;
      result << in_LEXIQUE_5F_IDENTIFIER.stringValue () ;
      result << " *) ;\n" ;
      if (enumerator_4832.hasNextObject ()) {
        result << "\n" ;
      }
      index_4832_.increment () ;
...
void routine_compileGrammarComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_lstringlist enumerator_25345 (constinArgument_inGrammarComponentRoot.reader_mUnusedNonterminalList (SOURCE_FILE_AT_LINE (581)), kEnumeration_up) ;
  while (enumerator_25345.hasCurrentObject ()) {
    GALGAS_uint var_nonterminalIndex ;
    GALGAS_nonterminalSymbolLabelMapForGrammarAnalysis joker_25451_0 ; // Joker input parameter
    var_nonTerminalMapForGrammarAnalysis.method_searchKey (enumerator_25345.current_mValue (HERE), var_nonterminalIndex, joker_25451_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
    {
    var_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (enumerator_25345.current_mValue (HERE), var_nonterminalIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) ;
    }
  ...
  cEnumerator_nonTerminalSymbolMapForGrammarAnalysis enumerator_25810 (var_nonTerminalMapForGrammarAnalysis, kEnumeration_up) ;
  while (enumerator_25810.hasCurrentObject ()) {
    var_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (enumerator_25810.current_lkey (HERE), enumerator_25810.current_mNonTerminalIndex (HERE), enumerator_25810.current_mNonterminalSymbolParametersMap (HERE) COMMA_SOURCE_FILE_AT_LINE (589)) ;
