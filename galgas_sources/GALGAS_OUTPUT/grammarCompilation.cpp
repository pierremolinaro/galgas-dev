...
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  function_transformLabelMap (C_Compiler & inLexique,
  ...
  var_cas_outNonterminalSymbolLabelMapForGrammarAnalysis = GGS_nonterminalSymbolLabelMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (37)) ;
  {
    ...
    while (((operand_2191 = enumerator_2191.nextObject ()))) {
      ...
      {
        GGS_formalParameterListAST::cEnumerator enumerator_2294 (operand_2191->mFormalArgumentList, true) ;
        const GGS_formalParameterListAST::cElement * operand_2294 = NULL ;
        while (((operand_2294 = enumerator_2294.nextObject ()))) {
          macroValidPointer (operand_2294) ;
          var_cas_formalParametersList.addAssign_operation (operand_2294->mFormalArgumentPassingMode, operand_2294->mFormalArgumentTypeName) ;
        }
      }
...
void routine_checkLabelMap (C_Compiler & inLexique,
  ...
  GGS_stringset  var_cas_labelStringSet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_3160 = enumerator_3160.nextObject ()))) {
      ...
      const GGS_bool cond_3907 = (operand_3160->mFormalArgumentList.reader_length ()).operator_isNotEqual (var_cas_formalParametersList.reader_length ()) ;
      if (cond_3907.isBuiltAndTrue ()) {
        operand_3160->mLabelName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((operand_3160->mFormalArgumentList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72))).operator_concat (GGS_string (" formal parameter"))).operator_concat ((((operand_3160->mFormalArgumentList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (" declared here, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3160->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (76)))).operator_concat (GGS_string ("names "))).operator_concat (var_cas_formalParametersList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77)))).operator_concat (GGS_string ("parameter"))).operator_concat ((((var_cas_formalParametersList.reader_length ()).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string ("")))) COMMA_SOURCE_FILE_AT_LINE (79)) ;
      }else if (cond_3907.isBuiltAndFalse ()) {
        {
          GGS_formalParameterListAST::cEnumerator enumerator_3941 (operand_3160->mFormalArgumentList, true) ;
          const GGS_formalParameterListAST::cElement * operand_3941 = NULL ;
          GGS_signatureForGrammarAnalysis::cEnumerator enumerator_3963 (var_cas_formalParametersList, true) ;
          const GGS_signatureForGrammarAnalysis::cElement * operand_3963 = NULL ;
          while (((operand_3941 = enumerator_3941.nextObject ()))
              && ((operand_3963 = enumerator_3963.nextObject ()))) {
            macroValidPointer (operand_3941) ;
            macroValidPointer (operand_3963) ;
            const GGS_bool cond_4523 = (operand_3963->mFormalArgumentPassingModeForGrammarAnalysis).operator_isNotEqual (operand_3941->mFormalArgumentPassingMode) ;
            if (cond_4523.isBuiltAndTrue ()) {
              operand_3963->mGalgasTypeNameForGrammarAnalysis.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string (" this formal parameter is declared with ")).operator_concat (operand_3963->mFormalArgumentPassingModeForGrammarAnalysis.reader_formalArgumentString (inLexique COMMA_SOURCE_FILE_AT_LINE (84)))).operator_concat (GGS_string (" passing mode, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3160->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (86)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (86)))).operator_concat (GGS_string (" is declared with "))).operator_concat (operand_3941->mFormalArgumentPassingMode.reader_formalArgumentString (inLexique COMMA_SOURCE_FILE_AT_LINE (87)))).operator_concat (GGS_string (" passing mode")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
            }
            const GGS_bool cond_5017 = (operand_3963->mGalgasTypeNameForGrammarAnalysis.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))).operator_isNotEqual (operand_3941->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))) ;
            if (cond_5017.isBuiltAndTrue ()) {
              operand_3963->mGalgasTypeNameForGrammarAnalysis.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((GGS_string (" this formal parameter is declared of '@")).operator_concat (operand_3963->mGalgasTypeNameForGrammarAnalysis)).operator_concat (GGS_string ("' type, but declaration at "))).operator_concat (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_3160->mLabelName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (94)))).operator_concat (GGS_string (" is declared with '@"))).operator_concat (operand_3941->mFormalArgumentTypeName)).operator_concat (GGS_string ("' type")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_5452 = var_cas_inHasParseLabel ;
  if (cond_5452.isBuiltAndTrue ()) {
    var_cas_labelStringSet.addAssign_operation (GGS_string ("parse")) ;
    const GGS_bool cond_5441 = (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.reader_hasKey (GGS_string ("parse"))).operator_not () ;
    if (cond_5441.isBuiltAndTrue ()) {
  ...
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_5518 (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_5518 = NULL ;
    while (((operand_5518 = enumerator_5518.nextObject ()))) {
      macroValidPointer (operand_5518) ;
      const GGS_bool cond_5792 = (var_cas_labelStringSet.reader_hasKey (operand_5518->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)))).operator_not () ;
      if (cond_5792.isBuiltAndTrue ()) {
        var_cas_inNonTerminalLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this non terminal does not declare the '")).operator_concat (operand_5518->mKey)).operator_concat (GGS_string ("' label, but declaration at "))).operator_concat (var_cas_inOriginalNonTerminalLocation.reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (114)))).operator_concat (GGS_string (" does")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_handleNonTerminalDeclarations (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_nonterminalDeclarationList::cEnumerator enumerator_6126 (var_cas_inNonterminalDeclarationList, true) ;
    const GGS_nonterminalDeclarationList::cElement * operand_6126 = NULL ;
    while (((operand_6126 = enumerator_6126.nextObject ()))) {
      macroValidPointer (operand_6126) ;
      elementOf_GGS_nonTerminalSymbolMapForGrammarAnalysis * operand_6175 = (elementOf_GGS_nonTerminalSymbolMapForGrammarAnalysis *) var_cas_ioNonTerminalMapForGrammarAnalysis.searchForReadWriteWithInstruction (operand_6126->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127))) ;
      if (NULL != operand_6175) {
        ::routine_checkLabelMap (inLexique,  operand_6126->mNonterminalName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (129)),  operand_6126->mLabels,  operand_6126->mHasParseLabel,  var_cas_ioNonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, operand_6126->mNonterminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)),  operand_6175->mInfo.mNonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (128)) ;
      }else{
        var_cas_ioNonTerminalMapForGrammarAnalysis.modifier_insertKey (inLexique, operand_6126->mNonterminalName, var_cas_ioNonTerminalMapForGrammarAnalysis.reader_count (), function_transformLabelMap (inLexique, operand_6126->mLabels, operand_6126->mHasParseLabel COMMA_SOURCE_FILE_AT_LINE (139)) COMMA_SOURCE_FILE_AT_LINE (136)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__semanticInstructionAST__transformInstruction (C_Compiler &,
                                const cPtr_semanticInstructionAST * operand_7381,
...
void routine_transformInstructionList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_8100 (var_cas_inInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_8100 = NULL ;
    while (((operand_8100 = enumerator_8100.nextObject ()))) {
      macroValidPointer (operand_8100) ;
      { typeCategoryMethod__syntaxInstructionAST__transformInstruction method = findCategoryMethod__syntaxInstructionAST__transformInstruction (operand_8100->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_8100->mInstruction (HERE), var_cas_ioActuallyUsedTerminalSymbolMap, var_cas_inNonTerminalSymbolMap, var_cas_ioAddedNonTerminalIndex, var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (176)) ;
        }
      }
    }
  }
...
category_method__terminalCheckInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_8456,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   /* var_cas_inNonTerminalSymbolMap */,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalIndex */,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_8456 != NULL) {
    GGS_uint  var_cas_terminalSymbolIndex ;
    elementOf_GGS_terminalSymbolsMapForGrammarAnalysis * operand_8787 = (elementOf_GGS_terminalSymbolsMapForGrammarAnalysis *) var_cas_ioActuallyUsedTerminalSymbolMap.searchForReadWriteWithInstruction (operand_8456->mTerminalName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))) ;
    if (NULL != operand_8787) {
      var_cas_terminalSymbolIndex = operand_8787->mInfo.mTerminalIndex ;
    }else{
      var_cas_terminalSymbolIndex = var_cas_ioActuallyUsedTerminalSymbolMap.reader_count () ;
      var_cas_ioActuallyUsedTerminalSymbolMap.modifier_insertKey (inLexique, operand_8456->mTerminalName, var_cas_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (198)) ;
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_terminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_8456->mInstructionLocation, operand_8456->mTerminalName, var_cas_terminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (200))) ;
  }
}
...
category_method__nonterminalCallInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_nonterminalCallInstruction * operand_9350,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & /* var_cas_ioActuallyUsedTerminalSymbolMap */,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalIndex */,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_9350 != NULL) {
    ...
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_9725_0 ;
    if (var_cas_inNonTerminalSymbolMap.isBuilt ()) {
      var_cas_inNonTerminalSymbolMap (HERE)->method_searchKey (inLexique, operand_9350->mNonterminalName, var_cas_nonTerminalSymbolIndex, automatic_var_9725_0 COMMA_SOURCE_FILE_AT_LINE (216)) ;
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_nonTerminalInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_9350->mInstructionLocation, operand_9350->mNonterminalName, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (217))) ;
  }
}
...
category_method__repeatInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_10035,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_10035 != NULL) {
    ...
    ::routine_transformInstructionList (inLexique,  operand_10035->mRepeatedInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_repeatedInstructionList COMMA_SOURCE_FILE_AT_LINE (236)) ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_10767 (operand_10035->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_10767 = NULL ;
      while (((operand_10767 = enumerator_10767.nextObject ()))) {
        macroValidPointer (operand_10767) ;
        ...
        ::routine_transformInstructionList (inLexique,  operand_10767->mSyntaxInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (247)) ;
        var_cas_repeatBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_repeatInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_10035->mInstructionLocation, var_cas_repeatBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (257))) ;
  }
}
...
category_method__selectInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_11416,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_11416 != NULL) {
    const GGS_uint  var_cas_addedNonTerminalIndex = var_cas_ioAddedNonTerminalIndex ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_11850 (operand_11416->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_11850 = NULL ;
      while (((operand_11850 = enumerator_11850.nextObject ()))) {
        macroValidPointer (operand_11850) ;
        GGS_syntaxInstructionListForGrammarAnalysis  var_cas_syntaxInstructionList = GGS_syntaxInstructionListForGrammarAnalysis ::constructor_emptyList () ;
        ::routine_transformInstructionList (inLexique,  operand_11850->mSyntaxInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (278)) ;
        var_cas_selectBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    var_cas_ioSyntaxInstructionList.addAssign_operation (GGS_selectInstructionForGrammarAnalysis ::constructor_new (inLexique, operand_11416->mInstructionLocation, var_cas_selectBranchList, var_cas_addedNonTerminalIndex COMMA_SOURCE_FILE_AT_LINE (288))) ;
  }
}
...
category_method__parseDoInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_12500,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_12500 != NULL) {
    ...
    if (operand_12500->mParseDoBranchList.isBuilt ()) {
      operand_12500->mParseDoBranchList (HERE)->method_first (inLexique, var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
...
category_method__parseWhenInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseWhenInstruction * operand_13186,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_13186 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13186->mElseInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (323)) ;
  }
}
...
category_method__parseLoopInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_parseLoopInstruction * operand_13767,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13767 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_13767->mDoInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (340)) ;
  }
}
...
category_method__blockInstruction__transformInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_14342,
                                GGS_terminalSymbolsMapForGrammarAnalysis  & var_cas_ioActuallyUsedTerminalSymbolMap,
                                const GGS_nonTerminalSymbolMapForGrammarAnalysis   var_cas_inNonTerminalSymbolMap,
                                GGS_uint  & var_cas_ioAddedNonTerminalIndex,
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_ioSyntaxInstructionList
  ...
  if (operand_14342 != NULL) {
    ::routine_transformInstructionList (inLexique,  operand_14342->mInstructionList,  var_cas_ioActuallyUsedTerminalSymbolMap,  var_cas_inNonTerminalSymbolMap,  var_cas_ioAddedNonTerminalIndex,  var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (357)) ;
  }
}
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxRuleList::cEnumerator enumerator_15315 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_15315 = NULL ;
    while (((operand_15315 = enumerator_15315.nextObject ()))) {
      macroValidPointer (operand_15315) ;
      ...
      if (var_cas_inNonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_15315->mNonterminalName, var_cas_nonTerminalIndex, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      GGS_syntaxInstructionList  var_cas_parsedSyntaxInstructionList ;
      GGS_lstring  automatic_var_15711_0 ;
      GGS_formalParameterListAST  automatic_var_15711_1 ;
      if (operand_15315->mLabelList.isBuilt ()) {
        operand_15315->mLabelList (HERE)->method_first (inLexique, automatic_var_15711_0, automatic_var_15711_1, var_cas_parsedSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
      ...
      var_cas_productionRulesList.addAssign_operation (operand_15315->mNonterminalName, var_cas_nonTerminalIndex, var_cas_instructionList, var_cas_productionRulesList.reader_length ()) ;
    }
  }
...
void routine_parseGrammarComponent (C_Compiler & inLexique,
  ...
  elementOf_GGS_parsedGrammarComponentMap * operand_18051 = (elementOf_GGS_parsedGrammarComponentMap *) var_cas_ioParsedComponentStruct.mParsedGrammarComponentMap.searchForReadWithInstruction (var_cas_basename) ;
  if (NULL != operand_18051) {
    var_cas_outGrammarComponentRoot = operand_18051->mInfo.mGrammarComponentRoot ;
  }else{
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_19622 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (472))).operator_isNotEqual (var_cas_basename) ;
  if (cond_19622.isBuiltAndTrue ()) {
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_20151 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (485)), true) ;
    const GGS_lstringlist::cElement * operand_20151 = NULL ;
    while (((operand_20151 = enumerator_20151.nextObject ()))) {
      ...
      const GGS_bool cond_20455 = ((operand_20151->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20151->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
      if (cond_20455.isBuiltAndTrue ()) {
        operand_20151->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }else if (cond_20455.isBuiltAndFalse ()) {
        GGS_string var_cas_syntaxComponentName = operand_20151->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        const GGS_bool cond_20847 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_20847.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_20769 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
          if (temp_20769.isBuilt ()) {
            temp_20769 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (493)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (493)) ;
          }
        }else if (cond_20847.isBuiltAndFalse ()) {
          GGS_string var_cas_sourceFilePath = operand_20151->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20151->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (496)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20151->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (497)) COMMA_SOURCE_FILE_AT_LINE (497)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (497)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (500)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
        const GGS_bool cond_21517 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_21517.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_21517.isBuiltAndFalse ()) {
          const GGS_bool cond_21812 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
        ...
        GGS_uint _variant_22519 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_22519 (_variant_22519.isBuilt (), true) ;
        while (_condition_22519.isBuiltAndTrue ()) {
          _condition_22519 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (523))) ;
          if (_condition_22519.isBuiltAndTrue ()) {
            if (_variant_22519.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (526)) ;
              _condition_22519 = GGS_bool (false) ;
            }else{
              _variant_22519.decrement_operation (inLexique COMMA_HERE) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23420 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), true) ;
    const GGS_lstringlist::cElement * operand_23420 = NULL ;
    while (((operand_23420 = enumerator_23420.nextObject ()))) {
      macroValidPointer (operand_23420) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23574_0 ;
      if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23420->mValue, var_cas_nonterminalIndex, automatic_var_23574_0 COMMA_SOURCE_FILE_AT_LINE (546)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23420->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (547)) ;
    }
  }
  ...
  const GGS_bool cond_24892 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_24892.isBuiltAndTrue ()) {
