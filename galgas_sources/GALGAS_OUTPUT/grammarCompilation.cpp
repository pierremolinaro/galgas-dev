  ...
  GGS_stringset  var_cas_labelStringSet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_3160 = enumerator_3160.nextObject ()))) {
      ...
      if (var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonterminalSymbolLabelMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_3160->mLabelName, var_cas_formalParametersList COMMA_SOURCE_FILE_AT_LINE (70)) ;
      }
...
void routine_transformInstructionList (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_8094 = enumerator_8094.nextObject ()))) {
      ...
      { typeCategoryMethod__syntaxInstructionAST__transformInstruction method = findCategoryMethod__syntaxInstructionAST__transformInstruction (operand_8094->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_8094->mInstruction (HERE), var_cas_ioActuallyUsedTerminalSymbolMap, var_cas_inNonTerminalSymbolMap, var_cas_ioAddedNonTerminalIndex, var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (176)) ;
        }
      }
    }
  }
...
category_method__parseDoInstruction__transformInstruction (C_Compiler & inLexique,
  ...
  if (operand_12470 != NULL) {
    ...
    if (operand_12470->mParseDoBranchList.isBuilt ()) {
      operand_12470->mParseDoBranchList (HERE)->method_first (inLexique, var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (304)) ;
    }
  ...
  GGS_productionRuleListForGrammarAnalysis  var_cas_productionRulesList = GGS_productionRuleListForGrammarAnalysis ::constructor_emptyList () ;
  {
    ...
    while (((operand_15285 = enumerator_15285.nextObject ()))) {
      ...
      if (var_cas_inNonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_inNonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_15285->mNonterminalName, var_cas_nonTerminalIndex, var_cas_nonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }
      ...
      if (operand_15285->mLabelList.isBuilt ()) {
        operand_15285->mLabelList (HERE)->method_first (inLexique, automatic_var_15681_0, automatic_var_15681_1, var_cas_parsedSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_unusedNonTerminalSymbolMapForGrammarAnalysis  var_cas_unusedNonTerminalSymbolsForGrammar = GGS_unusedNonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (520)) ;
  {
    ...
    while (((operand_22342 = enumerator_22342.nextObject ()))) {
      ...
      if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_22342->mValue, var_cas_nonterminalIndex, automatic_var_22496_0 COMMA_SOURCE_FILE_AT_LINE (523)) ;
      }
