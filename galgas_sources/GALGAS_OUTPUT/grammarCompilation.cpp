...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_addedNonTerminalCount = GGS_uint (0U) ;
  {
    ...
    while (((operand_20151 = enumerator_20151.nextObject ()))) {
      ...
      if (cond_20455.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_20846 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)).reader_hasKey (var_cas_syntaxComponentName) ;
        if (cond_20846.isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_20768 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (493)) ;
          if (temp_20768.isBuilt ()) {
            temp_20768 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (493)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (493)) ;
          }
        }else if (cond_20846.isBuiltAndFalse ()) {
        ...
        const GGS_bool cond_21515 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
        if (cond_21515.isBuiltAndTrue ()) {
          var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
        }else if (cond_21515.isBuiltAndFalse ()) {
          const GGS_bool cond_21810 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
          if (cond_21810.isBuiltAndTrue ()) {
        ...
        GGS_uint _variant_22517 = var_cas_addedNonTerminalCount ;
        GGS_bool _condition_22517 (_variant_22517.isBuilt (), true) ;
        while (_condition_22517.isBuiltAndTrue ()) {
          _condition_22517 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (523))) ;
          if (_condition_22517.isBuiltAndTrue ()) {
            if (_variant_22517.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (526)) ;
              _condition_22517 = GGS_bool (false) ;
            }else{
              _variant_22517.decrement_operation (inLexique COMMA_HERE) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23418 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (544)), true) ;
    const GGS_lstringlist::cElement * operand_23418 = NULL ;
    while (((operand_23418 = enumerator_23418.nextObject ()))) {
      macroValidPointer (operand_23418) ;
      GGS_uint  var_cas_nonterminalIndex ;
      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_23572_0 ;
      if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
        var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23418->mValue, var_cas_nonterminalIndex, automatic_var_23572_0 COMMA_SOURCE_FILE_AT_LINE (546)) ;
      }
      var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23418->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (547)) ;
    }
  }
  ...
  const GGS_bool cond_24890 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (564))).operator_isEqual (GGS_uint (0U)) ;
