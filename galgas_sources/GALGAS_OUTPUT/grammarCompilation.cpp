...
category_method__repeatInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
  ...
  if (operand_9525 != NULL) {
    ...
    GGS_repeatInstruction  var_cas_ri = GGS_repeatInstruction ::constructor_new (inLexique, operand_9525->mRepeatInstructionLocation, var_cas_repeatedInstructionList, var_cas_repeatBranchList COMMA_HERE) ;
...
category_method__selectInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
  ...
  if (operand_10308 != NULL) {
    ...
    GGS_selectInstruction  var_cas_si = GGS_selectInstruction ::constructor_new (inLexique, operand_10308->mSelectInstructionLocation, var_cas_selectBranchList COMMA_HERE) ;
...
template_filewrapper_grammarGenerationTemplates_html (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << " ;</li>\n"
      "    <li>whole vocabulary : " ;
    result << var_cas_NON_TERMINAL_MAP.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (166)).add_operation (inLexique, var_cas_TERMINAL_MAP.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
    result << " elements, " ;
    result << var_cas_BIT_COUNT_FOR_BDDS.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
    result << " bits for BDDs.</li>\n"
      ...
      "<p></p>\n"
      "<p>" ;
    if ((var_cas_IDENTICAL_DERIVATION_ERROR_MESSAGE_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (177))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
      result << "<span class=\"success\">Ok : all productions are different.</span>" ;
    }else {
      if ((var_cas_IDENTICAL_DERIVATION_ERROR_MESSAGE_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (180))).operator_isEqual (GGS_uint (1U)).boolValue ()) {
        result << "<span class=\"error\">Error;<span> 1 collision has been detected:" ;
      }else {
        result << "<span class=\"error\">Error;<span> " ;
        result << var_cas_IDENTICAL_DERIVATION_ERROR_MESSAGE_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
        result << " collisions have been detected:" ;
      }
      result << "<ul>" ;
      GGS_stringlist::cEnumerator enumerator_5238 (var_cas_IDENTICAL_DERIVATION_ERROR_MESSAGE_LIST, true) ;
      const GGS_stringlist::cElement * operand_5238 = NULL ;
      while (((operand_5238 = enumerator_5238.nextObject ()))) {
        macroValidPointer (operand_5238) ;
        result << "<li>" ;
        result << operand_5238->mValue.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
        result << ";</li>" ;
      }
      result << "</ul>" ;
    }
    result << "</p>\n"
      ...
      "<p></p>\n"
      "<p>" ;
    if ((var_cas_USELESS_NON_TERMINAL_SYMBOL_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_isEqual (GGS_uint (0U)).boolValue ()) {
      result << "<span class=\"success\">All nonterminal symbols are useful.</span>" ;
    }else {
      result << "<span class=\"warning\">Warning: the grammar contains " ;
      result << var_cas_USELESS_NON_TERMINAL_SYMBOL_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
      result << " useless symbol" ;
      if ((var_cas_USELESS_NON_TERMINAL_SYMBOL_LIST.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_strictSup (GGS_uint (1U)).boolValue ()) {
        result << "s" ;
      }else {
      }
      result << ":</span><ul>" ;
      GGS_stringlist::cEnumerator enumerator_5842 (var_cas_USELESS_NON_TERMINAL_SYMBOL_LIST, true) ;
      const GGS_stringlist::cElement * operand_5842 = NULL ;
      while (((operand_5842 = enumerator_5842.nextObject ()))) {
        macroValidPointer (operand_5842) ;
        result << "<li><code>" ;
        result << operand_5842->mValue.reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
        result << "</code></li>" ;
      }
      result << "</ul>" ;
    }
    result << "</p>\n"
      ...
      "\n"
      "<table class=\"title\"><tr><td>Searching for nonterminal symbols deriving in empty string</td></tr></table>\n"
      "\n"
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_22128 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_22128 = NULL ;
    while (((operand_22128 = enumerator_22128.nextObject ()))) {
      macroValidPointer (operand_22128) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_22270 = operand_22128->mLabelList ;
      if (temp_22270.isBuilt ()) {
        temp_22270 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (564)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ::routine_buildSyntaxInstructionList (inLexique,  var_cas_instructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (566)) ;
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_22128->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
  GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (582)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (582)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (583))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (585)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (587)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23648 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (593)), true) ;
    const GGS_lstringlist::cElement * operand_23648 = NULL ;
    while (((operand_23648 = enumerator_23648.nextObject ()))) {
      macroValidPointer (operand_23648) ;
      if (((operand_23648->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (594))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_23648->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (596)) ;
      }else{
        GGS_string var_cas_syntaxComponentName = operand_23648->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (597)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (597)) ;
        GGS_syntaxComponentRoot  var_cas_syntaxComponentRoot ;
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (599)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (599))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_24150 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (600)) ;
          if (temp_24150.isBuilt ()) {
            temp_24150 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (600)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath = operand_23648->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_23648->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (603)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (603)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_23648->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (604)) ;
        }
        GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (607)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (607)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (607)) ;
        if (((var_cas_lexiqueComponent).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_23648->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponent)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (614)) ;
        }
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMap,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (618)) COMMA_SOURCE_FILE_AT_LINE (616)) ;
        ::routine_buildRuleList (inLexique,  var_cas_syntaxComponentName,  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (623)),  var_cas_syntaxRuleListForGrammar COMMA_SOURCE_FILE_AT_LINE (621)) ;
      }
    }
  }
  {
    GGS_lstringlist::cEnumerator enumerator_25638 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (629)), true) ;
    const GGS_lstringlist::cElement * operand_25638 = NULL ;
    while (((operand_25638 = enumerator_25638.nextObject ()))) {
      macroValidPointer (operand_25638) ;
      if (((var_cas_nonTerminalMap.reader_hasKey (inLexique, operand_25638->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (630)) COMMA_SOURCE_FILE_AT_LINE (630))).operator_not ()).isBuiltAndTrue ()) {
        operand_25638->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '<")).operator_concat (operand_25638->mValue)).operator_concat (GGS_string (">' non terminal is not declared by syntax components")) COMMA_SOURCE_FILE_AT_LINE (632)) ;
      }
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_26262 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_26262 = NULL ;
    while (((operand_26262 = enumerator_26262.nextObject ()))) {
      macroValidPointer (operand_26262) ;
      if (((var_cas_currentSyntaxComponentName).operator_isNotEqual (operand_26262->mSyntaxComponentName)).isBuiltAndTrue ()) {
        var_cas_currentSyntaxComponentName = operand_26262->mSyntaxComponentName ;
        var_cas_addedRuleIndex = GGS_uint (0U) ;
      }
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_26262->mSyntaxComponentName,  operand_26262->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalList,  var_cas_addedRuleIndex COMMA_SOURCE_FILE_AT_LINE (646)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_26262->mSyntaxComponentName, operand_26262->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  var_cas_pureSyntaxRuleListForGrammar.dotAssign_operation (var_cas_addedPureSyntaxRuleListForGrammar) ;
  GGS_lstring  var_cas_addedRootNonTerminal = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
  var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (GGS_string (""), var_cas_addedRootNonTerminal, GGS_syntaxInstructionList ::constructor_listWithValue (GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (668)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE))) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("  Building pure BNF productions... ")).operator_concat (var_cas_pureSyntaxRuleListForGrammar.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (674)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (674)))).operator_concat (GGS_string (" productions\n")) COMMA_SOURCE_FILE_AT_LINE (674)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all productions are differents...") COMMA_SOURCE_FILE_AT_LINE (679)) ;
  }
  GGS_string var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (681))).operator_concat (GGS_string (".html")) ;
  GGS_productionListMap var_cas_productionListMap = GGS_productionListMap::constructor_emptyMap () ;
  GGS_productionIndexListMap var_cas_productionIndexListMap = GGS_productionIndexListMap::constructor_emptyMap () ;
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_28197 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_28197 = NULL ;
    while (((operand_28197 = enumerator_28197.nextObject ()))) {
      macroValidPointer (operand_28197) ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28235 (operand_28197->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28235 = NULL ;
        while (((operand_28235 = enumerator_28235.nextObject ()))) {
          macroValidPointer (operand_28235) ;
          const GGS_syntaxInstruction  temp_28292 = operand_28235->mInstruction ;
          if (temp_28292.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterTerminalSymbolIntoVocabulary (temp_28292.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28292 (HERE), var_cas_terminalMap, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (690)) ;
            }
          }
        }
      }
  ...
  GGS_uint  var_cas_terminalSymbolCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (693)) ;
  GGS_vocabularyMap  var_cas_nonterminalMap = GGS_vocabularyMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  {
      GGS_uint var_cas_idx (true, 0) ;
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_28542 (var_cas_pureSyntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_28542 = NULL ;
    while (((operand_28542 = enumerator_28542.nextObject ()))) {
      macroValidPointer (operand_28542) ;
      if (((var_cas_nonterminalMap.reader_hasKey (inLexique, operand_28542->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (697)) COMMA_SOURCE_FILE_AT_LINE (697))).operator_not ()).isBuiltAndTrue ()) {
        var_cas_nonterminalMap.modifier_insertKey (inLexique, operand_28542->mLeftNonTerminal, var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (698)).add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (698)) COMMA_SOURCE_FILE_AT_LINE (698)) COMMA_SOURCE_FILE_AT_LINE (698)) ;
        var_cas_vocabularyListForDisplaying.addAssign_operation (((GGS_string ("<")).operator_concat (operand_28542->mLeftNonTerminal)).operator_concat (GGS_string (">"))) ;
      }
      GGS_uint64list  var_cas_rightDerivation = GGS_uint64list ::constructor_emptyList () ;
      {
        GGS_syntaxInstructionList::cEnumerator enumerator_28881 (operand_28542->mSyntaxInstructionList, true) ;
        const GGS_syntaxInstructionList::cElement * operand_28881 = NULL ;
        while (((operand_28881 = enumerator_28881.nextObject ()))) {
          macroValidPointer (operand_28881) ;
          const GGS_syntaxInstruction  temp_28941 = operand_28881->mInstruction ;
          if (temp_28941.isBuilt ()) {
            typeCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary method = findCategoryMethod__syntaxInstruction__enterNonTerminalSymbolIntoVocabulary (temp_28941.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_28941 (HERE), var_cas_nonterminalMap, var_cas_terminalMap, var_cas_rightDerivation, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (703)) ;
            }
          }
        }
      }
      GGS_derivationList  var_cas_previousDerivations = var_cas_productionListMap.reader_listForKey (inLexique, operand_28542->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (706)) COMMA_SOURCE_FILE_AT_LINE (706)) ;
      GGS_uintlist  var_cas_previousDerivationsIndexes = var_cas_productionIndexListMap.reader_listForKey (inLexique, operand_28542->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
      GGS_bool var_cas_ok = GGS_bool (true) ;
      {
        GGS_derivationList::cEnumerator enumerator_29362 (var_cas_previousDerivations, true) ;
        const GGS_derivationList::cElement * operand_29362 = NULL ;
        GGS_uintlist::cEnumerator enumerator_29390 (var_cas_previousDerivationsIndexes, true) ;
        const GGS_uintlist::cElement * operand_29390 = NULL ;
        while (((operand_29362 = enumerator_29362.nextObject ()))
            && ((operand_29390 = enumerator_29390.nextObject ()))
            && (var_cas_ok.isBuiltAndTrue ())) {
          macroValidPointer (operand_29362) ;
          macroValidPointer (operand_29390) ;
          if (((operand_29362->mDerivation).operator_isEqual (var_cas_rightDerivation)).isBuiltAndTrue ()) {
            var_cas_ok = GGS_bool (false) ;
            if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (712))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
              inLexique.printMessage (GGS_string (" error\n") COMMA_SOURCE_FILE_AT_LINE (713)) ;
            }
            GGS_string var_cas_errorMessage = ((((((GGS_string ("for <")).operator_concat (operand_28542->mLeftNonTerminal)).operator_concat (GGS_string ("> non terminal, productions "))).operator_concat (operand_29390->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (718)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_idx.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (719)))).operator_concat (GGS_string (" are identical")) ;
            ...
            operand_28542->mLeftNonTerminal.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (727)) ;
          }
        }
      }
      if ((var_cas_ok).isBuiltAndTrue ()) {
        var_cas_productionListMap.addAssign_operation (operand_28542->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (730)), var_cas_rightDerivation) ;
        var_cas_productionIndexListMap.addAssign_operation (operand_28542->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (731)), var_cas_idx) ;
      }
      var_cas_idx.mValue ++ ;
    }
  }
  const GGS_uint  var_cas_terminalCount = var_cas_terminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (734)) ;
  const GGS_uint  var_cas_vocabularyCount = var_cas_terminalCount.add_operation (inLexique, var_cas_nonterminalMap.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (735)) COMMA_SOURCE_FILE_AT_LINE (735)) ;
  const GGS_uint  var_cas_bitCountForBDDs = var_cas_vocabularyCount.reader_significantBitCount (inLexique COMMA_SOURCE_FILE_AT_LINE (736)) ;
  if (((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_identicalDerivationErrorMessageList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (737))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string (" ok\n") COMMA_SOURCE_FILE_AT_LINE (738)) ;
  }
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("  Checking all non terminal symbols are useful...") COMMA_SOURCE_FILE_AT_LINE (742)) ;
  }
  GGS_binaryset var_cas_elementaryUtility = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
  {
    GGS_productionListMap::cEnumerator enumerator_31039 (var_cas_productionListMap, true) ;
    while (enumerator_31039.hasCurrentObject ()) {
      GGS_binaryset var_cas_derivation = GGS_binaryset::constructor_emptyBinarySet (inLexique COMMA_HERE) ;
      {
        GGS_derivationList::cEnumerator enumerator_31106 (enumerator_31039._object (HERE), true) ;
        const GGS_derivationList::cElement * operand_31106 = NULL ;
        while (((operand_31106 = enumerator_31106.nextObject ()))) {
          macroValidPointer (operand_31106) ;
          {
            GGS_uint64list::cEnumerator enumerator_31135 (operand_31106->mDerivation, true) ;
            const GGS_uint64list::cElement * operand_31135 = NULL ;
            while (((operand_31135 = enumerator_31135.nextObject ()))) {
              macroValidPointer (operand_31135) ;
              var_cas_derivation = (var_cas_derivation).operator_or (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, var_cas_bitCountForBDDs, var_cas_bitCountForBDDs, operand_31135->mValue COMMA_HERE)) ;
            }
          }
        }
      }
      GGS_uint  var_cas_nonterminalIndex ;
      const GGS_vocabularyMap  temp_31356 = var_cas_nonterminalMap ;
      if (temp_31356.isBuilt ()) {
        temp_31356 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_31039._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (753)) ;
      }
      var_cas_derivation = (var_cas_derivation).operator_and (GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonterminalIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (754)) COMMA_HERE)) ;
      var_cas_elementaryUtility = (var_cas_elementaryUtility).operator_or (var_cas_derivation) ;
      enumerator_31039.next () ;
    }
  }
  const GGS_binaryset var_cas_startSymbol = GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (758)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_HERE) ;
  const GGS_binaryset var_cas_usefulSymbols = var_cas_elementaryUtility.reader_accessibleStates (inLexique, var_cas_startSymbol, var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (759)) ;
  const GGS_binaryset var_cas_allSymbols = GGS_binaryset::constructor_binarySetWithLowerOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_vocabularyCount.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (761)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_HERE) ;
  const GGS_binaryset var_cas_unusefulSymbols = (var_cas_allSymbols).operator_and ((var_cas_usefulSymbols).operator_tilde ()) ;
  GGS_binaryset var_cas_unusefulNonTerminals = (var_cas_unusefulSymbols).operator_and (GGS_binaryset::constructor_binarySetWithGreaterOrEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_terminalCount.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_HERE)) ;
  {
    GGS_lstringlist::cEnumerator enumerator_32247 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), true) ;
    const GGS_lstringlist::cElement * operand_32247 = NULL ;
    while (((operand_32247 = enumerator_32247.nextObject ()))) {
      macroValidPointer (operand_32247) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_32359 = var_cas_nonterminalMap ;
      if (temp_32359.isBuilt ()) {
        temp_32359 (HERE)->method_searchKey (inLexique, operand_32247->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (766)) ;
      }
      var_cas_unusefulNonTerminals = (var_cas_unusefulNonTerminals).operator_and ((GGS_binaryset::constructor_binarySetWithEqualToConstant (inLexique, GGS_uint (0U), var_cas_bitCountForBDDs, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (767)) COMMA_HERE)).operator_tilde ()) ;
    }
  }
  const GGS_stringlist  var_cas_unusefulNonTerminalList = var_cas_unusefulNonTerminals.reader_stringValueListWithNameList (inLexique, var_cas_bitCountForBDDs, var_cas_vocabularyListForDisplaying COMMA_SOURCE_FILE_AT_LINE (769)) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (771))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue () ? (GGS_string (" ok\n")) : (GGS_string (" warning\n"))) COMMA_SOURCE_FILE_AT_LINE (771)) ;
  }
  if (((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (773))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = ((((GGS_string ("the grammar contains ")).operator_concat (var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (775)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (775)))).operator_concat (GGS_string (" useless symbol"))).operator_concat ((((var_cas_unusefulNonTerminalList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (776))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue () ? (GGS_string ("s")) : (GGS_string (""))))).operator_concat (GGS_string (": ")) ;
    {
      GGS_stringlist::cEnumerator enumerator_33121 (var_cas_unusefulNonTerminalList, true) ;
      const GGS_stringlist::cElement * operand_33121 = enumerator_33121.nextObject () ;
      if ((operand_33121 != NULL)) {
        bool _foreach_loop_33121 ;
        do{
          macroValidPointer (operand_33121) ;
          var_cas_errorMessage.dotAssign_operation (operand_33121->mValue) ;
          operand_33121 = enumerator_33121.nextObject () ;
          _foreach_loop_33121 = ((operand_33121 != NULL)) ;
          if (_foreach_loop_33121) {
            var_cas_errorMessage.appendCString (", ") ;
          }
        }while (_foreach_loop_33121) ;
      }
    }
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (781)) ;
  }
  {
    GGS_lstringlist::cEnumerator enumerator_33389 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (784)), true) ;
    const GGS_lstringlist::cElement * operand_33389 = NULL ;
    while (((operand_33389 = enumerator_33389.nextObject ()))) {
      macroValidPointer (operand_33389) ;
      GGS_uint  var_cas_nonTerminalSymbolIndex ;
      const GGS_vocabularyMap  temp_33501 = var_cas_nonterminalMap ;
      if (temp_33501.isBuilt ()) {
        temp_33501 (HERE)->method_searchKey (inLexique, operand_33389->mValue, var_cas_nonTerminalSymbolIndex COMMA_SOURCE_FILE_AT_LINE (786)) ;
      }
      if ((var_cas_usefulSymbols.reader_containsValue (inLexique, var_cas_nonTerminalSymbolIndex.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (787)), GGS_uint (0U), var_cas_bitCountForBDDs COMMA_SOURCE_FILE_AT_LINE (787))).isBuiltAndTrue ()) {
        operand_33389->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("the '<")).operator_concat (operand_33389->mValue)).operator_concat (GGS_string (">' non terminal is declared as unused, but it is actually useful")) COMMA_SOURCE_FILE_AT_LINE (788)) ;
      }
    }
  }
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (794)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar, var_cas_terminalMap, var_cas_nonterminalMap, var_cas_bitCountForBDDs, var_cas_identicalDerivationErrorMessageList, var_cas_unusefulNonTerminalList) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_34254 = var_cas_s ;
    if (temp_34254.isBuilt ()) {
      temp_34254 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (803)) ;
    }
  }else{
    GGS_string::class_method_deleteFileIfExists (inLexique, var_cas_htmlOutputFileName COMMA_SOURCE_FILE_AT_LINE (805)) ;
  }
  if (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (811))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone2 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (815)), var_cas_grammarComponentRoot), GGS_string ("\n"
      "\n"), template_filewrapper_grammarGenerationTemplates_optionHeaderZone3 (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (820)), var_cas_grammarComponentRoot, var_cas_nonTerminalMap, var_cas_lexiqueComponent, var_cas_addedNonTerminalList) COMMA_SOURCE_FILE_AT_LINE (809)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
