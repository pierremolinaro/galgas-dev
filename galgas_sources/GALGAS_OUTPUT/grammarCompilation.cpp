...
void routine_compileGrammarComponent (C_CompilerEx & inLexique,
                                ...
                                const GGS_bool  var_cas_inGenerateGALGAS1Code,
                                GGS_parsedComponentStruct & var_cas_ioParsedComponentStruct
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
...
::routine_parseGrammarComponent (inLexique,  var_cas_inSourceFile,  var_cas_ioParsedComponentStruct,  var_cas_grammarComponentRoot COMMA_SOURCE_FILE_AT_LINE (480)) ;
const GGS_lstring  var_cas_grammarComponentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (482)) ;
const GGS_string var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_20125 = (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (484))).operator_isNotEqual (var_cas_basename) ;
if (cond_20125.isBuiltAndTrue ()) {
var_cas_grammarComponentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
  "the component name ('")).operator_concat (var_cas_grammarComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (486)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (488)) ;
}
GGS_terminalSymbolsMapForGrammarAnalysis  var_cas_actuallyUsedTerminalSymbolMap = GGS_terminalSymbolsMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (491)) ;
GGS_nonTerminalSymbolMapForGrammarAnalysis  var_cas_nonTerminalMapForGrammarAnalysis = GGS_nonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (492)) ;
...
{
GGS_lstringlist::cEnumerator enumerator_20654 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (497)), true) ;
const GGS_lstringlist::cElement * operand_20654 = NULL ;
while (((operand_20654 = enumerator_20654.nextObject ()))) {
  macroValidPointer (operand_20654) ;
const GGS_uint  var_cas_addedNonTerminalCountRef = var_cas_addedNonTerminalCount ;
const GGS_bool cond_20958 = ((operand_20654->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("gSyntax"))).operator_and ((operand_20654->mValue.ggs_string ().reader_pathExtension ()).operator_isNotEqual (GGS_string ("ggs"))) ;
if (cond_20958.isBuiltAndTrue ()) {
operand_20654->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.ggs' or '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (501)) ;
}else if (cond_20958.isBuiltAndFalse ()) {
GGS_string var_cas_syntaxComponentName = operand_20654->mValue.ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
GGS_syntaxComponentAST var_cas_syntaxComponentRoot ;
const GGS_bool cond_21349 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (504)).reader_hasKey (var_cas_syntaxComponentName) ;
if (cond_21349.isBuiltAndTrue ()) {
const GGS_parsedSyntaxComponentMap  temp_21271 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (505)) ;
if (temp_21271.isBuilt ()) {
  temp_21271 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (505)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (505)) ;
}
}else if (cond_21349.isBuiltAndFalse ()) {
GGS_string var_cas_sourceFilePath = operand_20654->mValue.ggs_string ().reader_absolutePathFromPath (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent ()) ;
const GGS_string _depExtension = GGS_string ("") ;
const GGS_string _depPath = GGS_string ("") ;
if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
  C_Grammar_syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                ...
                                _depPath.string (),
                                NULL,
                                GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_20654->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (508)) COMMA_SOURCE_FILE_AT_LINE (508)),
                                var_cas_syntaxComponentRoot
                                COMMA_SOURCE_FILE_AT_LINE (508)) ;
}
var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_20654->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (509)) COMMA_SOURCE_FILE_AT_LINE (509)), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (509)) ;
}
GGS_string var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (512)).ggs_string ().reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
const GGS_bool cond_22018 = (var_cas_lexiqueComponentName).operator_isEqual (GGS_string ("")) ;
if (cond_22018.isBuiltAndTrue ()) {
var_cas_lexiqueComponentName = var_cas_currentLexiqueName ;
}else if (cond_22018.isBuiltAndFalse ()) {
const GGS_bool cond_22313 = (var_cas_lexiqueComponentName).operator_isNotEqual (var_cas_currentLexiqueName) ;
if (cond_22313.isBuiltAndTrue ()) {
operand_20654->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponentName)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (519)) ;
}
}
::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (523)) COMMA_SOURCE_FILE_AT_LINE (521)) ;
::routine_buildRuleList (inLexique,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_syntaxComponentRoot.reader_mSyntaxComponentName (inLexique COMMA_SOURCE_FILE_AT_LINE (528)),  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (529)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_addedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (526)) ;
GGS_uint  var_cas_i = GGS_uint (0U) ;
GGS_uint _variant_23020 = var_cas_addedNonTerminalCount ;
GGS_bool _condition_23020 (_variant_23020.isBuilt (), true) ;
while (_condition_23020.isBuiltAndTrue ()) {
  _condition_23020 = (var_cas_i).operator_strictInf (var_cas_addedNonTerminalCount.substract_operation (inLexique, var_cas_addedNonTerminalCountRef COMMA_SOURCE_FILE_AT_LINE (535))) ;
  if (_condition_23020.isBuiltAndTrue ()) {
    if (_variant_23020.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (538)) ;
      _condition_23020 = GGS_bool (false) ;
    }else{
      _variant_23020.decrement_operation (inLexique COMMA_HERE) ;
  var_cas_nonTerminalToAddList.addAssign_operation (var_cas_syntaxComponentName, var_cas_i) ;
  var_cas_i.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (537)) ;
    }
  }
}
}
...
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (545)), var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (545)) ;
}
::routine_checkLabelMap (inLexique,  var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (548)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (548)),  var_cas_grammarComponentRoot.reader_mStartSymbolLabelList (inLexique COMMA_SOURCE_FILE_AT_LINE (549)),  var_cas_grammarComponentRoot.reader_mStartSymbolHasParseLabel (inLexique COMMA_SOURCE_FILE_AT_LINE (550)),  var_cas_nonTerminalMapForGrammarAnalysis.reader_locationForKey (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbolName (inLexique COMMA_SOURCE_FILE_AT_LINE (551)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (551)) COMMA_SOURCE_FILE_AT_LINE (551)),  var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (547)) ;
GGS_unusedNonTerminalSymbolMapForGrammarAnalysis  var_cas_unusedNonTerminalSymbolsForGrammar = GGS_unusedNonTerminalSymbolMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (555)) ;
{
GGS_lstringlist::cEnumerator enumerator_23921 (var_cas_grammarComponentRoot.reader_mUnusedNonterminalList (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), true) ;
const GGS_lstringlist::cElement * operand_23921 = NULL ;
while (((operand_23921 = enumerator_23921.nextObject ()))) {
  macroValidPointer (operand_23921) ;
GGS_uint  var_cas_nonterminalIndex ;
GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_24075_0 ;
if (var_cas_nonTerminalMapForGrammarAnalysis.isBuilt ()) {
  var_cas_nonTerminalMapForGrammarAnalysis (HERE)->method_searchKey (inLexique, operand_23921->mValue, var_cas_nonterminalIndex, automatic_var_24075_0 COMMA_SOURCE_FILE_AT_LINE (558)) ;
}
var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, operand_23921->mValue, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (559)) ;
}
}
GGS_nonTerminalSymbolSortedListForGrammarAnalysis  var_cas_nonTerminalSymbolSortedListForGrammarAnalysis = GGS_nonTerminalSymbolSortedListForGrammarAnalysis ::constructor_emptySortedList () ;
{
GGS_nonTerminalSymbolMapForGrammarAnalysis::cEnumerator enumerator_24430 (var_cas_nonTerminalMapForGrammarAnalysis, true) ;
const GGS_nonTerminalSymbolMapForGrammarAnalysis::cElement * operand_24430 = NULL ;
while (((operand_24430 = enumerator_24430.nextObject ()))) {
  macroValidPointer (operand_24430) ;
var_cas_nonTerminalSymbolSortedListForGrammarAnalysis.addAssign_operation (operand_24430->mKey, operand_24430->mInfo.mNonTerminalIndex, operand_24430->mInfo.mNonterminalSymbolParametersMap) ;
}
}
if (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (568)).isBuilt () &&
    var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (569)).isBuilt () &&
    var_cas_startSymbolIndex.isBuilt () &&
    var_cas_lexiqueComponentName.isBuilt () &&
    var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (572)).isBuilt () &&
    ...
    var_cas_nonTerminalSymbolSortedListForGrammarAnalysis.isBuilt ()) {
  ::routine_grammarAnalysisAndGeneration (inLexique,  var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (568)),  var_cas_grammarComponentRoot.reader_mGrammarClass (inLexique COMMA_SOURCE_FILE_AT_LINE (569)),  var_cas_startSymbolIndex,  var_cas_lexiqueComponentName,  var_cas_grammarComponentRoot.reader_mEndOfSourceText (inLexique COMMA_SOURCE_FILE_AT_LINE (572)),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentListForGrammarAnalysis,  var_cas_nonTerminalMapForGrammarAnalysis,  var_cas_unusedNonTerminalSymbolsForGrammar,  var_cas_inOutputDirectoryForCppFiles,  var_cas_inOutputDirectoryForHTMLFile,  var_cas_nonTerminalSymbolSortedListForGrammarAnalysis COMMA_SOURCE_FILE_AT_LINE (567)) ;
}
const GGS_bool cond_26578 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (582))).operator_isEqual (GGS_uint (0U)) ;
if (cond_26578.isBuiltAndTrue ()) {
const GGS_bool cond_25917 = (var_cas_inGenerateGALGAS1Code).operator_not () ;
if (cond_25917.isBuiltAndTrue ()) {
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (595)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (595))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (593)) ;
}else if (cond_25917.isBuiltAndFalse ()) {
...
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectoryForCppFiles, (var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (614)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (614))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_zone2, GGS_string ("\n"
  "\n"), var_cas_zone3 COMMA_SOURCE_FILE_AT_LINE (612)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
