...
category_method__repeatInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
  ...
  if (operand_8230 != NULL) {
    ...
    var_cas_ri = GGS_repeatInstruction ::constructor_new (inLexique, operand_8230->mRepeatInstructionLocation, var_cas_repeatedInstructionList, var_cas_repeatBranchList COMMA_HERE) ;
...
category_method__selectInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_9013,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9013 != NULL) {
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_9156 (operand_9013->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_9156 = NULL ;
      while (((operand_9156 = enumerator_9156.nextObject ()))) {
        macroValidPointer (operand_9156) ;
        GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
        ::routine_buildSyntaxInstructionList (inLexique,  operand_9156->mSyntaxInstructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (205)) ;
        var_cas_selectBranchList.addAssign_operation (var_cas_syntaxInstructionList) ;
      }
    }
    GGS_selectInstruction  var_cas_si ;
    var_cas_si = GGS_selectInstruction ::constructor_new (inLexique, operand_9013->mSelectInstructionLocation, var_cas_selectBranchList COMMA_HERE) ;
...
category_method__parseDoInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_9635,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_9635 != NULL) {
    GGS_syntaxInstructionList  var_cas_instructionList ;
    const GGS_listOfSyntaxInstructionList  temp_9759 = operand_9635->mParseDoBranchList ;
    if (temp_9759.isBuilt ()) {
      temp_9759 (HERE)->method_first (inLexique, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (221)) ;
    }
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_9805 (var_cas_instructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_9805 = NULL ;
      while (((operand_9805 = enumerator_9805.nextObject ()))) {
        macroValidPointer (operand_9805) ;
        const GGS_syntaxInstruction  temp_9853 = operand_9805->mInstruction ;
        if (temp_9853.isBuilt ()) {
          typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_9853.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_9853 (HERE), var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (223)) ;
          }
        }
      }
    }
...
category_method__blockInstruction__buildSyntaxInstructionList (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_10052,
                                GGS_syntaxInstructionList  & var_cas_ioSyntaxInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_10052 != NULL) {
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_10132 (operand_10052->mInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_10132 = NULL ;
      while (((operand_10132 = enumerator_10132.nextObject ()))) {
        macroValidPointer (operand_10132) ;
        const GGS_syntaxInstruction  temp_10180 = operand_10132->mInstruction ;
        if (temp_10180.isBuilt ()) {
          typeCategoryMethod__syntaxInstruction__buildSyntaxInstructionList method = findCategoryMethod__syntaxInstruction__buildSyntaxInstructionList (temp_10180.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_10180 (HERE), var_cas_ioSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (233)) ;
          }
        }
      }
    }
...
category_reader__semanticInstruction__htmlListing (C_Compiler &,
                                const cPtr_semanticInstruction * operand_10904
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_10904 != NULL) {
...
category_reader__nonterminalCallInstruction__htmlListing (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_11100
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_11100 != NULL) {
    var_cas_outListing = ((GGS_string ("<span class=\"galgas_nonterminal\">&lt;")).operator_concat (operand_11100->mNonterminalName)).operator_concat (GGS_string ("&gt;</span>")) ;
  }
  return var_cas_outListing ;
}
...
category_reader__terminalCheckInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_terminalCheckInstruction * operand_11368
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_11368 != NULL) {
    var_cas_outListing = ((GGS_string ("<span class=\"galgas_terminal\">$")).operator_concat (operand_11368->mTerminalName.ggs_string ().reader_HTMLRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (274)))).operator_concat (GGS_string ("$</span>")) ;
  }
  return var_cas_outListing ;
}
...
category_reader__repeatInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_11638
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_11638 != NULL) {
    ...
    {
      GGS_syntaxInstructionList::cEnumerator enumerator_11851 (operand_11638->mRepeatedInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_11851 = NULL ;
      while (((operand_11851 = enumerator_11851.nextObject ()))) {
        macroValidPointer (operand_11851) ;
        var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_11851->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_11851->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
      }
    }
    var_cas_outListing.appendCString ("</span>") ;
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_11973 (operand_11638->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_11973 = NULL ;
      while (((operand_11973 = enumerator_11973.nextObject ()))) {
        ...
        {
          GGS_syntaxInstructionList::cEnumerator enumerator_12140 (operand_11973->mSyntaxInstructionList, true) ;
          const GGS_syntaxInstructionList::cElement * operand_12140 = NULL ;
          while (((operand_12140 = enumerator_12140.nextObject ()))) {
            macroValidPointer (operand_12140) ;
            var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_12140->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_12140->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (293)))) ;
          }
        }
        var_cas_outListing.appendCString ("</span>") ;
      }
...
category_reader__selectInstruction__htmlListing (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_12479
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_12479 != NULL) {
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_12638 (operand_12479->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_12638 = enumerator_12638.nextObject () ;
      if ((operand_12638 != NULL)) {
        bool _foreach_loop_12638 ;
        do{
          macroValidPointer (operand_12638) ;
          var_cas_outListing.appendCString ("<span class=\"within_galgas_structure\">") ;
          {
            GGS_syntaxInstructionList::cEnumerator enumerator_12741 (operand_12638->mSyntaxInstructionList, true) ;
            const GGS_syntaxInstructionList::cElement * operand_12741 = NULL ;
            while (((operand_12741 = enumerator_12741.nextObject ()))) {
              macroValidPointer (operand_12741) ;
              var_cas_outListing.dotAssign_operation ((findCategoryReader__syntaxInstruction__htmlListing (operand_12741->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_12741->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (312)))) ;
            }
          }
          var_cas_outListing.appendCString ("</span>") ;
          operand_12638 = enumerator_12638.nextObject () ;
          _foreach_loop_12638 = ((operand_12638 != NULL)) ;
          if (_foreach_loop_12638) {
            var_cas_outListing.appendCString ("<span class=\"galgas_keyword\">or</span>") ;
          }
        }while (_foreach_loop_12638) ;
      }
    }
...
category_reader__parseDoInstruction__htmlListing (C_Compiler &,
                                const cPtr_parseDoInstruction * operand_13154
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_13154 != NULL) {
...
category_reader__blockInstruction__htmlListing (C_Compiler &,
                                const cPtr_blockInstruction * operand_13350
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outListing ;
  if (operand_13350 != NULL) {
...
template_filewrapper_grammarGenerationTemplates_html (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    while (((operand_3060 = enumerator_3060.nextObject ()))) {
      ...
      result << "<tr class=\"result_line\"><td class=\"result_line\">rule <code>&lt;" ;
      result << operand_3060->mLeftNonTerminal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << "&gt;</code><br>" ;
      result << operand_3060->mLeftNonTerminal.reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
      result << "</td><td><code>" ;
      GGS_syntaxInstructionList::cEnumerator enumerator_3284 (operand_3060->mSyntaxInstructionList, true) ;
      const GGS_syntaxInstructionList::cElement * operand_3284 = NULL ;
      while (((operand_3284 = enumerator_3284.nextObject ()))) {
        macroValidPointer (operand_3284) ;
        result << (findCategoryReader__syntaxInstruction__htmlListing (operand_3284->mInstruction (HERE)->galgasRTTI ()) (inLexique, operand_3284->mInstruction.getPtr () COMMA_SOURCE_FILE_AT_LINE (132))) ;
      }
      result << "</code></td></tr>" ;
    }
    result << "\n"
...
void routine_buildRuleList (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_syntaxRuleList::cEnumerator enumerator_14635 (var_cas_inRuleList, true) ;
    const GGS_syntaxRuleList::cElement * operand_14635 = NULL ;
    while (((operand_14635 = enumerator_14635.nextObject ()))) {
      macroValidPointer (operand_14635) ;
      GGS_syntaxInstructionList  var_cas_instructionList ;
      GGS_lstring  automatic_var_0 ;
      GGS_formalParameterList  automatic_var_1 ;
      const GGS_syntaxRuleLabelList  temp_14777 = operand_14635->mLabelList ;
      if (temp_14777.isBuilt ()) {
        temp_14777 (HERE)->method_first (inLexique, automatic_var_0, automatic_var_1, var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (367)) ;
      }
      GGS_syntaxInstructionList  var_cas_syntaxInstructionList ;
      ::routine_buildSyntaxInstructionList (inLexique,  var_cas_instructionList,  var_cas_syntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (369)) ;
      var_cas_ioSyntaxRuleListForGrammar.addAssign_operation (var_cas_inSyntaxComponentName, operand_14635->mNonterminalName, var_cas_syntaxInstructionList) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_buildPureSyntaxInstructionList (C_Compiler & inLexique,
  ...
  {
    GGS_syntaxInstructionList::cEnumerator enumerator_16150 (var_cas_inSyntaxInstructionList, true) ;
    const GGS_syntaxInstructionList::cElement * operand_16150 = NULL ;
    while (((operand_16150 = enumerator_16150.nextObject ()))) {
      macroValidPointer (operand_16150) ;
      const GGS_syntaxInstruction  temp_16198 = operand_16150->mInstruction ;
      if (temp_16198.isBuilt ()) {
        typeCategoryMethod__syntaxInstruction__buildPureSyntaxInstruction method = findCategoryMethod__syntaxInstruction__buildPureSyntaxInstruction (temp_16198.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_16198 (HERE), var_cas_inSyntaxComponent, var_cas_ioPureSyntaxRuleListForGrammar, var_cas_outPureSyntaxInstructionList, var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (398)) ;
        }
      }
    }
  }
...
category_method__semanticInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_semanticInstruction * operand_16669,
                                const GGS_string  /* var_cas_inSyntaxComponent */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstructionList  & /* var_cas_ioPureSyntaxInstructionList */,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16669 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (418)) ;
  }
}
...
category_method__nonterminalCallInstruction__buildPureSyntaxInstruction (C_Compiler &,
                                const cPtr_nonterminalCallInstruction * operand_17094,
                                const GGS_string  /* var_cas_inSyntaxComponent */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstructionList  & var_cas_ioPureSyntaxInstructionList,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17094 != NULL) {
    var_cas_ioPureSyntaxInstructionList.addAssign_operation (operand_17094) ;
  }
}
...
category_method__terminalCheckInstruction__buildPureSyntaxInstruction (C_Compiler &,
                                const cPtr_terminalCheckInstruction * operand_17500,
                                const GGS_string  /* var_cas_inSyntaxComponent */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstructionList  & var_cas_ioPureSyntaxInstructionList,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17500 != NULL) {
    var_cas_ioPureSyntaxInstructionList.addAssign_operation (operand_17500) ;
  }
}
...
category_method__repeatInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_repeatInstruction * operand_17899,
                                const GGS_string  var_cas_inSyntaxComponent,
                                GGS_syntaxRuleListForGrammar  & var_cas_ioPureSyntaxRuleListForGrammar,
                                GGS_syntaxInstructionList  & var_cas_ioPureSyntaxInstructionList,
                                GGS_uint  & var_cas_ioAddedNonTerminalCount
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17899 != NULL) {
    GGS_syntaxInstructionList  var_cas_repeatedPureInstructionList ;
    ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inSyntaxComponent,  operand_17899->mRepeatedInstructionList,  var_cas_repeatedPureInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (466)) ;
    GGS_lstring  var_cas_selectRepeatAddedNonTerminal ;
    var_cas_selectRepeatAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, (((GGS_string ("select_repeat_")).operator_concat (var_cas_inSyntaxComponent)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedNonTerminalCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (475))), operand_17899->mRepeatInstructionLocation COMMA_HERE) ;
    var_cas_ioAddedNonTerminalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (478)) ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_19669 (operand_17899->mRepeatBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_19669 = NULL ;
      while (((operand_19669 = enumerator_19669.nextObject ()))) {
        macroValidPointer (operand_19669) ;
        GGS_syntaxInstructionList  var_cas_pureInstructionList ;
        ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inSyntaxComponent,  operand_19669->mSyntaxInstructionList,  var_cas_pureInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (495)) ;
...
category_method__selectInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_selectInstruction * operand_20463,
                                const GGS_string  var_cas_inSyntaxComponent,
                                GGS_syntaxRuleListForGrammar  & var_cas_ioPureSyntaxRuleListForGrammar,
                                GGS_syntaxInstructionList  & var_cas_ioPureSyntaxInstructionList,
                                GGS_uint  & var_cas_ioAddedNonTerminalCount
  ...
  if (operand_20463 != NULL) {
    ...
    var_cas_selectAddedNonTerminal = GGS_lstring ::constructor_new (inLexique, (((GGS_string ("select_")).operator_concat (var_cas_inSyntaxComponent)).operator_concat (GGS_string ("_"))).operator_concat (var_cas_ioAddedNonTerminalCount.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (525))), operand_20463->mSelectInstructionLocation COMMA_HERE) ;
    var_cas_ioAddedNonTerminalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (528)) ;
    ...
    {
      GGS_listOfSyntaxInstructionList::cEnumerator enumerator_21037 (operand_20463->mSelectBranchList, true) ;
      const GGS_listOfSyntaxInstructionList::cElement * operand_21037 = NULL ;
      while (((operand_21037 = enumerator_21037.nextObject ()))) {
        ...
        ::routine_buildPureSyntaxInstructionList (inLexique,  var_cas_inSyntaxComponent,  operand_21037->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_ioPureSyntaxRuleListForGrammar,  var_cas_ioAddedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (536)) ;
...
category_method__parseDoInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_parseDoInstruction * operand_21600,
                                const GGS_string  /* var_cas_inSyntaxComponent */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstructionList  & /* var_cas_ioPureSyntaxInstructionList */,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21600 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (560)) ;
  }
}
...
category_method__blockInstruction__buildPureSyntaxInstruction (C_Compiler & inLexique,
                                const cPtr_blockInstruction * operand_22015,
                                const GGS_string  /* var_cas_inSyntaxComponent */,
                                GGS_syntaxRuleListForGrammar  & /* var_cas_ioPureSyntaxRuleListForGrammar */,
                                GGS_syntaxInstructionList  & /* var_cas_ioPureSyntaxInstructionList */,
                                GGS_uint  & /* var_cas_ioAddedNonTerminalCount */
  ...
  if (operand_22015 != NULL) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error (use debug tool)") COMMA_SOURCE_FILE_AT_LINE (571)) ;
  }
}
...
void routine_compileGrammarComponent (C_Compiler & inLexique,
  ...
  var_cas_componentName = var_cas_grammarComponentRoot.reader_mGrammarName (inLexique COMMA_SOURCE_FILE_AT_LINE (583)) ;
  GGS_string var_cas_basename ;
  var_cas_basename = var_cas_inSourceFile.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (584)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (584)) ;
  if (((var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (585))).operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_componentName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS checks "
      "the component name ('")).operator_concat (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (587)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (589)) ;
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_23238 (var_cas_grammarComponentRoot.reader_mSyntaxComponents (inLexique COMMA_SOURCE_FILE_AT_LINE (594)), true) ;
    const GGS_lstringlist::cElement * operand_23238 = NULL ;
    while (((operand_23238 = enumerator_23238.nextObject ()))) {
      macroValidPointer (operand_23238) ;
      if (((operand_23238->mValue.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (595))).operator_isNotEqual (GGS_string ("gSyntax"))).isBuiltAndTrue ()) {
        operand_23238->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("a syntax component file should have '.gSyntax' as path extension") COMMA_SOURCE_FILE_AT_LINE (597)) ;
      }else{
        GGS_string var_cas_syntaxComponentName ;
        var_cas_syntaxComponentName = operand_23238->mValue.ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (598)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) ;
        ...
        if ((var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (600)).reader_hasKey (inLexique, var_cas_syntaxComponentName COMMA_SOURCE_FILE_AT_LINE (600))).isBuiltAndTrue ()) {
          const GGS_parsedSyntaxComponentMap  temp_23740 = var_cas_ioParsedComponentStruct.reader_mParsedSyntaxComponentMap (inLexique COMMA_SOURCE_FILE_AT_LINE (601)) ;
          if (temp_23740.isBuilt ()) {
            temp_23740 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, GGS_location (inLexique) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (601)) ;
          }
        }else{
          GGS_string var_cas_sourceFilePath ;
          var_cas_sourceFilePath = operand_23238->mValue.ggs_string ().reader_absolutePathFromPath (inLexique, var_cas_inSourceFile.ggs_string ().reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (603)) COMMA_SOURCE_FILE_AT_LINE (603)) ;
          const GGS_string _depExtension = GGS_string ("") ;
          const GGS_string _depPath = GGS_string ("") ;
          if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
            syntaxSLRgrammar::_performSourceFileParsing_ (inLexique,
                                          ...
                                          _depPath.string (),
                                          NULL,
                                          GGS_lstring ::constructor_new (inLexique, var_cas_sourceFilePath, operand_23238->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) COMMA_HERE),
                                          var_cas_syntaxComponentRoot
                                          COMMA_SOURCE_FILE_AT_LINE (604)) ;
          }
          var_cas_ioParsedComponentStruct.mParsedSyntaxComponentMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_syntaxComponentName, operand_23238->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (605)) COMMA_HERE), var_cas_syntaxComponentRoot COMMA_SOURCE_FILE_AT_LINE (605)) ;
        }
        GGS_string var_cas_currentLexiqueName ;
        var_cas_currentLexiqueName = var_cas_syntaxComponentRoot.reader_mImportedLexiqueReference (inLexique COMMA_SOURCE_FILE_AT_LINE (608)).ggs_string ().reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (608)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (608)) ;
        if (((var_cas_lexiqueComponent).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          ...
          operand_23238->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("this syntax component uses '")).operator_concat (var_cas_currentLexiqueName)).operator_concat (GGS_string ("' lexique component, but the first syntax component uses the '"))).operator_concat (var_cas_lexiqueComponent)).operator_concat (GGS_string ("' lexique component (they should be the same)")) COMMA_SOURCE_FILE_AT_LINE (615)) ;
        }
        GGS_nonTerminalMap  var_cas_nonTerminalMap ;
        ::routine_handleNonTerminalDeclarations (inLexique,  var_cas_nonTerminalMap,  var_cas_syntaxComponentRoot.reader_mNonterminalDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (620)) COMMA_SOURCE_FILE_AT_LINE (618)) ;
        ::routine_buildRuleList (inLexique,  var_cas_syntaxComponentName,  var_cas_syntaxComponentRoot.reader_mRuleList (inLexique COMMA_SOURCE_FILE_AT_LINE (625)),  var_cas_syntaxRuleListForGrammar COMMA_SOURCE_FILE_AT_LINE (623)) ;
      }
    }
  }
  ...
  {
    GGS_syntaxRuleListForGrammar::cEnumerator enumerator_25476 (var_cas_syntaxRuleListForGrammar, true) ;
    const GGS_syntaxRuleListForGrammar::cElement * operand_25476 = NULL ;
    while (((operand_25476 = enumerator_25476.nextObject ()))) {
      macroValidPointer (operand_25476) ;
      GGS_syntaxInstructionList  var_cas_pureSyntaxInstructionList ;
      ::routine_buildPureSyntaxInstructionList (inLexique,  operand_25476->mSyntaxComponentName,  operand_25476->mSyntaxInstructionList,  var_cas_pureSyntaxInstructionList,  var_cas_addedPureSyntaxRuleListForGrammar,  var_cas_addedNonTerminalCount COMMA_SOURCE_FILE_AT_LINE (636)) ;
      var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (operand_25476->mSyntaxComponentName, operand_25476->mLeftNonTerminal, var_cas_pureSyntaxInstructionList) ;
    }
  }
  ...
  var_cas_pureSyntaxRuleListForGrammar.addAssign_operation (GGS_string (""), var_cas_addedRootNonTerminal, GGS_syntaxInstructionList ::constructor_listWithValue (GGS_nonterminalCallInstruction ::constructor_new (inLexique, var_cas_grammarComponentRoot.reader_mStartSymbol (inLexique COMMA_SOURCE_FILE_AT_LINE (657)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_actualParameterList ::constructor_emptyList () COMMA_HERE))) ;
  if ((gOption_galgas_5F_cli_5F_options_outputHTMLgrammarFile.value ()).isBuiltAndTrue ()) {
    GGS_string var_cas_s ;
    var_cas_s = template_filewrapper_grammarGenerationTemplates_html (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (666)), var_cas_syntaxRuleListForGrammar, var_cas_pureSyntaxRuleListForGrammar) ;
    GGS_string var_cas_htmlOutputFileName ;
    var_cas_htmlOutputFileName = (var_cas_inSourceFile.ggs_string ().reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (670))).operator_concat (GGS_string (".html")) ;
    GGS_bool automatic_var_2 ;
    const GGS_string temp_26819 = var_cas_s ;
    if (temp_26819.isBuilt ()) {
      temp_26819 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_htmlOutputFileName, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (671)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
