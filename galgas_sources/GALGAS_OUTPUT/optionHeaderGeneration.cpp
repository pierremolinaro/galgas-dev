//---------------------------------------------------------------------------*
//                                                                           *
//                    File 'optionHeaderGeneration.cpp'                      *
//         Generated by version GALGAS_BETA_VERSION (LL(1) grammar)          *
//                       june 26th, 2007, at 19h17'6"                        *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "optionHeaderGeneration.gTreewalking", line
...
_treewalking_routine_optionComponentRoot (C_Compiler & _inLexique,
  ...
  var_cas_generatedUserZone3.modifier_setCapacity (_inLexique, GGS_uint (true, 5000U) COMMA_SOURCE_FILE_AT_LINE (43)) ;
  ...
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inBoolOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (104))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (104)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (104))) ;
  var_cas_generatedUserZone3.writeString ("] ;\n"
  "  private : uint32 mUintOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inUIntOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (105)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (105))) ;
  var_cas_generatedUserZone3.writeString ("] ;\n"
  "  private : C_String mStringOptionValues [") ;
  var_cas_generatedUserZone3._dotAssign_operation (var_cas_inStringOptionMap.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (106))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (106)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (106))) ;
  var_cas_generatedUserZone3.writeString ("] ;\n"
