...
void routine_buildMapWithLocalConstants (C_Lexique & _inLexique,
  ...
  GGS_L_nameWithType::element_type * operand_28131 = var_cas_inLocalDeclarationsList.firstObject () ;
  GGS_typeListeAttributsSemantiques::element_type * operand_28220 = var_cas_inSemanticAttributsList.firstObject () ;
  while ((operand_28131 != NULL)
      && (operand_28220 != NULL)) {
    macroValidPointer (operand_28131) ;
    macroValidPointer (operand_28220) ;
    if (((operand_28131->mName.reader_value (_inLexique SOURCE_FILE_AT_LINE (676))) != (GGS_string (true, ""))).isBuiltAndTrue ()) {
      GGS_string var_cas_typeName ;
      if (operand_28220->mAttributType.isBuilt ()) {
        operand_28220->mAttributType (HERE)->method_getTypeName (_inLexique, var_cas_typeName SOURCE_FILE_AT_LINE (678)) ;
      }
      if (((operand_28131->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (679))) == (var_cas_typeName)).isBuiltAndTrue ()) {
        ...
        if (((((var_cas_inLocalConstantStyle) == (GGS_localConstantBuildStyleEnum::constructor_firstIsKeyOtherMapStyle (_inLexique COMMA_HERE))) && (var_cas_firstOne))).isBuiltAndTrue ()) {
          ...
          var_cas_cppName = GGS_typeOperandName::constructor_new (_inLexique, operand_28220->aNomAttribut, var_cas_inLocation, var_cas_mapStyle COMMA_HERE) ;
        }
        var_cas_ioVariablesMap.method_insertUsedConstInArgument (_inLexique, operand_28131->mName, operand_28220->mAttributType, var_cas_cppName SOURCE_FILE_AT_LINE (686)) ;
      }else{
          operand_28131->mType.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I have found the '@")) + (operand_28131->mType.reader_value (_inLexique SOURCE_FILE_AT_LINE (688))))) + (GGS_string (true, "' type, I was expected the '@")))) + (var_cas_typeName))) + (GGS_string (true, "' type"))) SOURCE_FILE_AT_LINE (689)) ;
      }
    }
    var_cas_firstOne = GGS_bool (true, false) ;
    operand_28131 = operand_28131->nextObject () ;
    operand_28220 = operand_28220->nextObject () ;
  }
  if (((((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (695))) < (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (695)))) && ((! (var_cas_inEllipsisFound))))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "one or more parameters missing: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (697)).reader_string (_inLexique SOURCE_FILE_AT_LINE (697))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (698)).reader_string (_inLexique SOURCE_FILE_AT_LINE (698))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (698)) ;
  }else if (((var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (699))) > (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (699)))).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "too much parameters: found ")) + (var_cas_inLocalDeclarationsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (701)).reader_string (_inLexique SOURCE_FILE_AT_LINE (701))))) + (GGS_string (true, " effective parameters, while ")))) + (var_cas_inSemanticAttributsList.reader_length (_inLexique SOURCE_FILE_AT_LINE (702)).reader_string (_inLexique SOURCE_FILE_AT_LINE (702))))) + (GGS_string (true, " are needed"))) SOURCE_FILE_AT_LINE (702)) ;
  }
}
...
void routine_checkAssignmentTypesCompatibility (C_Lexique & _inLexique,
  ...
  if (var_cas_targetType.isBuilt () && var_cas_sourceType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_30249 = var_cas_targetType (HERE) ;
    cPtr_AC_galgasType * ptr_30263 = var_cas_sourceType (HERE) ;
    cPtr_typeGalgas_stringset * operand_30249 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30249) ;
    cPtr_typeGalgas_stringset * operand_30263 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_30263) ;
    if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
    }else{
      cPtr_typeGalgas_uint * operand_30249 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30249) ;
      cPtr_typeGalgas_uint * operand_30263 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_30263) ;
      if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
      }else{
        cPtr_typeGalgas_sint * operand_30249 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30249) ;
        cPtr_typeGalgas_sint * operand_30263 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_30263) ;
        if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_30249 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30249) ;
          cPtr_typeGalgas_char * operand_30263 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_30263) ;
          if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
          }else{
            cPtr_typeGalgas_string * operand_30249 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30249) ;
            cPtr_typeGalgas_string * operand_30263 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_30263) ;
            if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
            }else{
              cPtr_typeGalgas_bool * operand_30249 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30249) ;
              cPtr_typeGalgas_bool * operand_30263 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_30263) ;
              if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
              }else{
                cPtr_typeGalgas_double * operand_30249 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30249) ;
                cPtr_typeGalgas_double * operand_30263 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_30263) ;
                if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                }else{
                  cPtr_typeGalgas_ldouble * operand_30249 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30249) ;
                  cPtr_typeGalgas_ldouble * operand_30263 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_30263) ;
                  if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                  }else{
                    cPtr_typeGalgas_location * operand_30249 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30249) ;
                    cPtr_typeGalgas_location * operand_30263 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_30263) ;
                    if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                    }else{
                      cPtr_typeGalgas_lchar * operand_30249 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30249) ;
                      cPtr_typeGalgas_lchar * operand_30263 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_30263) ;
                      if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                      }else{
                        cPtr_typeGalgas_luint * operand_30249 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30249) ;
                        cPtr_typeGalgas_luint * operand_30263 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_30263) ;
                        if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lsint * operand_30249 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30249) ;
                          cPtr_typeGalgas_lsint * operand_30263 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_30263) ;
                          if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                          }else{
                            cPtr_typeGalgas_lstring * operand_30249 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30249) ;
                            cPtr_typeGalgas_lstring * operand_30263 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_30263) ;
                            if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lbool * operand_30249 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30249) ;
                              cPtr_typeGalgas_lbool * operand_30263 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_30263) ;
                              if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                              }else{
                                cPtr_typeGalgasUndefinedExternType * operand_30249 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30249) ;
                                cPtr_typeGalgasUndefinedExternType * operand_30263 = dynamic_cast <cPtr_typeGalgasUndefinedExternType *> (ptr_30263) ;
                                if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                  if (((operand_30249->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (741))) != (operand_30263->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (741)))).isBuiltAndTrue ()) {
                                      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an extern variable of extern '")) + (operand_30249->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (742))))) + (GGS_string (true, "' type variable, and I got an extern '")))) + (operand_30263->mGalgasClassName.reader_value (_inLexique SOURCE_FILE_AT_LINE (743))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (743)) ;
                                  }
                                }else{
                                  cPtr_typeGalgasUndefinedListType * operand_30249 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30249) ;
                                  cPtr_typeGalgasUndefinedListType * operand_30263 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_30263) ;
                                  if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                    if (((operand_30249->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (747))) != (operand_30263->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (747)))).isBuiltAndTrue ()) {
                                        var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30249->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (748))))) + (GGS_string (true, "' list type variable, and I got a '")))) + (operand_30263->mListTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (749))))) + (GGS_string (true, "' list type variable"))) SOURCE_FILE_AT_LINE (749)) ;
                                    }
                                  }else{
                                    cPtr_typeGalgasClassType * operand_30249 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30249) ;
                                    cPtr_typeGalgasClassType * operand_30263 = dynamic_cast <cPtr_typeGalgasClassType *> (ptr_30263) ;
                                    if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                      if (((operand_30249->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (754))) == (operand_30263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (754)))).isBuiltAndTrue ()) {
                                      }else if (((! (operand_30263->mAncestorClassesMap.reader_hasKey (_inLexique, operand_30249->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (755)) SOURCE_FILE_AT_LINE (755))))).isBuiltAndTrue ()) {
                                          var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "The '")) + (operand_30263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (756))))) + (GGS_string (true, "' does not inherit from '")))) + (operand_30263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (757))))) + (GGS_string (true, "' class"))) SOURCE_FILE_AT_LINE (757)) ;
                                      }
                                    }else{
                                      cPtr_typeGalgasUndefinedClassType * operand_30249 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30249) ;
                                      cPtr_typeGalgasUndefinedClassType * operand_30263 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_30263) ;
                                      if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                        if (((operand_30249->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761))) != (operand_30263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (761)))).isBuiltAndTrue ()) {
                                            var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30249->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (762))))) + (GGS_string (true, "' class type variable, and I got a '")))) + (operand_30263->mClassTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (763))))) + (GGS_string (true, "' class type variable"))) SOURCE_FILE_AT_LINE (763)) ;
                                        }
                                      }else{
                                        cPtr_typeGalgasUndefinedMapType * operand_30249 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30249) ;
                                        cPtr_typeGalgasUndefinedMapType * operand_30263 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_30263) ;
                                        if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                          if (((operand_30249->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767))) != (operand_30263->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (767)))).isBuiltAndTrue ()) {
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting a '")) + (operand_30249->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (768))))) + (GGS_string (true, "' map type variable, and I got a '")))) + (operand_30263->mMapTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (769))))) + (GGS_string (true, "' map type variable"))) SOURCE_FILE_AT_LINE (770)) ;
                                          }
                                        }else{
                                          cPtr_typeGalgas_enum * operand_30249 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30249) ;
                                          cPtr_typeGalgas_enum * operand_30263 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_30263) ;
                                          if ((operand_30249 != NULL) && (operand_30263 != NULL)) {
                                            if (((operand_30249->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775))) != (operand_30263->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (775)))).isBuiltAndTrue ()) {
                                                var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "I was expecting an enum variable of  '")) + (operand_30249->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (776))))) + (GGS_string (true, "' type variable, and I got an enum '")))) + (operand_30263->mEnumTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (777))))) + (GGS_string (true, "' type variable"))) SOURCE_FILE_AT_LINE (778)) ;
                                            }
                                          }else{
                                              var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((var_cas_targetType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (781))) + (GGS_string (true, " cannot be assigned from ")))) + (var_cas_sourceType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (782)))) SOURCE_FILE_AT_LINE (782)) ;
                                          }
                                        }
                                      }
                                    }
...
void routine_verifierCompatibiliteTypes (C_Lexique & _inLexique,
  ...
  if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (798))) < (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (798)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more identifiers missing") SOURCE_FILE_AT_LINE (799)) ;
  }else if (((var_cas_t1.reader_length (_inLexique SOURCE_FILE_AT_LINE (800))) > (var_cas_t2.reader_length (_inLexique SOURCE_FILE_AT_LINE (800)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much identifiers") SOURCE_FILE_AT_LINE (801)) ;
  }else{
    GGS_typeSemanticsTypesList::element_type * operand_34696 = var_cas_t1.firstObject () ;
    GGS_typeListeAttributsSemantiques::element_type * operand_34781 = var_cas_t2.firstObject () ;
    while ((operand_34696 != NULL)
        && (operand_34781 != NULL)) {
      macroValidPointer (operand_34696) ;
      macroValidPointer (operand_34781) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_34696->mType,  operand_34781->mAttributType,  operand_34696->mGalgasVariableName.reader_location (_inLexique SOURCE_FILE_AT_LINE (805)) SOURCE_FILE_AT_LINE (805)) ;
      operand_34696 = operand_34696->nextObject () ;
      operand_34781 = operand_34781->nextObject () ;
    }
  }
}
...
void routine_verifierCompatibiliteArgEffectifsSignature (C_Lexique & _inLexique,
  ...
  if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (823))) > (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (823)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more arguments missing") SOURCE_FILE_AT_LINE (824)) ;
  }else if (((var_cas_signatureReference.reader_length (_inLexique SOURCE_FILE_AT_LINE (825))) < (var_cas_inEffectiveArgumentsSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (825)))).isBuiltAndTrue ()) {
      var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much arguments") SOURCE_FILE_AT_LINE (826)) ;
  }else{
    GGS_L_EXsignature::element_type * operand_36015 = var_cas_signatureReference.firstObject () ;
    GGS_L_actualParametersSignature::element_type * operand_36144 = var_cas_inEffectiveArgumentsSignature.firstObject () ;
    while ((operand_36015 != NULL)
        && (operand_36144 != NULL)) {
      macroValidPointer (operand_36015) ;
      macroValidPointer (operand_36144) ;
      if (operand_36015->mFormalArgumentPassingMode.isBuilt () && operand_36144->mFormalArgumentPassingMode.isBuilt ()) {
        if ((operand_36015->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentConstantIn) && (operand_36144->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
          ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36015->mType,  operand_36144->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (833)) ;
        }else{
          if ((operand_36015->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentIn) && (operand_36144->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOut)) {
            ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36015->mType,  operand_36144->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (835)) ;
          }else{
            if ((operand_36015->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentInOut) && (operand_36144->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterOutIn)) {
              ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36015->mType,  operand_36144->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (837)) ;
            }else{
              if ((operand_36015->mFormalArgumentPassingMode.enumValue () == GGS_formalArgumentPassingMode::enum_argumentOut) && (operand_36144->mFormalArgumentPassingMode.enumValue () == GGS_actualParametersPassingMode::enum_parameterIn)) {
                if (operand_36144->mType.isBuilt ()) {
                  if (dynamic_cast <cPtr_typeGalgas_jokerInParameterList *> (operand_36144->mType.getPtr ()) != NULL) {
                  }else{ // Else part
                    ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_36015->mType,  operand_36144->mType,  var_cas_inErrorLocation SOURCE_FILE_AT_LINE (842)) ;
                  }
                }
              }else{
                  var_cas_inErrorLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((operand_36144->mFormalArgumentPassingMode.reader_actualArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (845))) + (GGS_string (true, " is not compatible with ")))) + (operand_36015->mFormalArgumentPassingMode.reader_formalArgumentMessage (_inLexique SOURCE_FILE_AT_LINE (846)))) SOURCE_FILE_AT_LINE (846)) ;
              }
            }
          }
        }
      }
      operand_36015 = operand_36015->nextObject () ;
      operand_36144 = operand_36144->nextObject () ;
    }
    ...
    GGS_L_EXsignature::element_type * operand_37405 = var_cas_signatureReference.firstObject () ;
    GGS_typeExpressionList::element_type * operand_37473 = var_cas_expressionList.firstObject () ;
    while ((operand_37405 != NULL)
        && (operand_37473 != NULL)) {
      macroValidPointer (operand_37405) ;
      macroValidPointer (operand_37473) ;
      if (operand_37473->mExpression.isBuilt ()) {
        if (dynamic_cast <cPtr_typeJokerInExpression *> (operand_37473->mExpression.getPtr ()) != NULL) {
          cPtr_typeJokerInExpression * operand_37558 = dynamic_cast <cPtr_typeJokerInExpression *> (operand_37473->mExpression.getPtr ()) ;
          macroValidPointer (operand_37558) ; 
          GGS_typeCplusPlusName  var_cas_cppVarName ;
          var_cas_cppVarName = GGS_typeLocationAutomaticName::constructor_new (_inLexique, operand_37558->mLocation COMMA_HERE) ;
          ...
          var_cas_i = GGS_typeInstructionDeclarationVarLocale::constructor_new (_inLexique, var_cas_cppVarName, operand_37405->mType COMMA_HERE) ;
          var_cas_ioInstructionsList.addAssign_operation (var_cas_i) ;
        }else{ // Else part
          var_cas_ioExpressionList.addAssign_operation (operand_37473->mExpression) ;
        }
      }
      operand_37405 = operand_37405->nextObject () ;
      operand_37473 = operand_37473->nextObject () ;
    }
  }
}
...
method_verifierType (C_Lexique & _inLexique,
  ...
  ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  aTypeVarDest,  var_cas_typeArgumentFormel,  var_cas_positionErreur SOURCE_FILE_AT_LINE (897)) ;
...
void routine_enterBuiltinTypes (C_Lexique & _inLexique,
  ...
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1249)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1254)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1259)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1264)) ;
  ...
  var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
  var_cas_ioComponentSemanticsEntitiesMap.method_insertKey (_inLexique, var_cas_name, var_cas_e SOURCE_FILE_AT_LINE (1269)) ;
...
method_insertKey (C_Lexique & _inLexique,
  ...
  insertElement (_inLexique,
                 "the '%K' constraint attribute is already defined",
                 inKey,
                 inParameter0,
                 inParameter1,
                 NULL
...
void routine_displayConstraintDefinitionErrors (C_Lexique & _inLexique,
  ...
  var_cas_missingDefinition = var_cas_inFirstBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inCurrentBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1468)) ;
   ;
  GGS_stringset::element_type * operand_62742 = var_cas_missingDefinition.firstObject () ;
  while ((operand_62742 != NULL)) {
    macroValidPointer (operand_62742) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_62742->mKey))) + (GGS_string (true, "' property is initialized by first branch, but not by this one"))) SOURCE_FILE_AT_LINE (1470)) ;
    operand_62742 = operand_62742->nextObject () ;
  }
  GGS_stringset  var_cas_unexpectedDefinition ;
  var_cas_unexpectedDefinition = var_cas_inCurrentBranchconstraintDefinitionSet.substract_operation (_inLexique, var_cas_inFirstBranchconstraintDefinitionSet SOURCE_FILE_AT_LINE (1472)) ;
   ;
  GGS_stringset::element_type * operand_63039 = var_cas_unexpectedDefinition.firstObject () ;
  while ((operand_63039 != NULL)) {
    macroValidPointer (operand_63039) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63039->mKey))) + (GGS_string (true, "' property is not initialized by first branch, but by this one"))) SOURCE_FILE_AT_LINE (1474)) ;
    operand_63039 = operand_63039->nextObject () ;
  }
}
...
void routine_displayConstraintDefinitionErrorsNoElse (C_Lexique & _inLexique,
  ...
  GGS_stringset  var_cas_missingDefinition ;
  var_cas_missingDefinition = var_cas_inFirstBranchConstraintDefinitionSet.substract_operation (_inLexique, var_cas_inInheritedConstraintDefinitionSet SOURCE_FILE_AT_LINE (1484)) ;
   ;
  GGS_stringset::element_type * operand_63575 = var_cas_missingDefinition.firstObject () ;
  while ((operand_63575 != NULL)) {
    macroValidPointer (operand_63575) ;
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (operand_63575->mKey))) + (GGS_string (true, "' property is initialized by first branch, but there is no else branch"))) SOURCE_FILE_AT_LINE (1486)) ;
    operand_63575 = operand_63575->nextObject () ;
  }
}
